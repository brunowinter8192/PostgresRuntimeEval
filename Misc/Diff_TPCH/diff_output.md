diff -Nur --exclude=*.o --exclude=*.tbl --exclude=dbgen --exclude=qgen --exclude=.DS_Store ${THESIS_PATH}/TPC-H V3.0.1/dbgen/bm_utils.c ./TPC-H V3.0.1/dbgen/bm_utils.c
--- ${THESIS_PATH}/TPC-H V3.0.1/dbgen/bm_utils.c	2021-06-09 09:41:24
+++ ./TPC-H V3.0.1/dbgen/bm_utils.c	2025-09-25 00:25:32
@@ -67,9 +67,13 @@
 #endif            /* HP */
 #include <ctype.h>
 #include <math.h>
...
+#endif /* __APPLE__ */
 ...
 #include <sys/types.h>
 #include <sys/stat.h>
diff -Nur --exclude=*.o --exclude=*.tbl --exclude=dbgen --exclude=qgen --exclude=.DS_Store ${THESIS_PATH}/TPC-H V3.0.1/dbgen/makefile.suite ./TPC-H V3.0.1/dbgen/makefile.suite
--- ${THESIS_PATH}/TPC-H V3.0.1/dbgen/makefile.suite	2021-06-09 09:41:24
+++ ./TPC-H V3.0.1/dbgen/makefile.suite	2025-09-25 02:05:29
@@ -100,15 +100,15 @@
 ################
...
+WORKLOAD = TPCH 
 ...
 LDFLAGS = -O
diff -Nur --exclude=*.o --exclude=*.tbl --exclude=dbgen --exclude=qgen --exclude=.DS_Store ${THESIS_PATH}/TPC-H V3.0.1/dbgen/qgen.c ./TPC-H V3.0.1/dbgen/qgen.c
--- ${THESIS_PATH}/TPC-H V3.0.1/dbgen/qgen.c	2021-06-09 09:41:24
+++ ./TPC-H V3.0.1/dbgen/qgen.c	2025-09-25 15:59:20
@@ -28,6 +28,9 @@
 #define DECLARER
...
+    
     ...
     fflush(stdout);
     return;
diff -Nur --exclude=*.o --exclude=*.tbl --exclude=dbgen --exclude=qgen --exclude=.DS_Store ${THESIS_PATH}/TPC-H V3.0.1/dbgen/tpcd.h ./TPC-H V3.0.1/dbgen/tpcd.h
--- ${THESIS_PATH}/TPC-H V3.0.1/dbgen/tpcd.h	2021-06-09 09:41:24
+++ ./TPC-H V3.0.1/dbgen/tpcd.h	2025-09-25 00:21:31
@@ -49,6 +49,15 @@
 /*
...
+
 ...
 #define GEN_QUERY_PLAN  "EXPLAIN"
 #define START_TRAN      ""
diff -Nur --exclude=*.o --exclude=*.tbl --exclude=dbgen --exclude=qgen --exclude=.DS_Store ${THESIS_PATH}/TPC-H V3.0.1/dbgen/varsub.c ./TPC-H V3.0.1/dbgen/varsub.c
--- ${THESIS_PATH}/TPC-H V3.0.1/dbgen/varsub.c	2021-06-09 09:41:24
+++ ./TPC-H V3.0.1/dbgen/varsub.c	2025-09-25 00:37:47
@@ -40,9 +40,13 @@
 *
 */
 #include <stdio.h>
