...
INPUT_FILE = Path('${THESIS_PATH}/2025_2026/Operator-Level/Datasets/Baseline_SVM/operator_dataset_cleaned.csv')
OUTPUT_DIR = Path('${THESIS_PATH}/2025_2026/Hybrid/Konzept/csv')
