...
# From mapping_config.py: Pattern hash list
...
def export_pattern_datasets(pattern_datasets: dict, output_dir: str) -> None:
    ...
    for pattern_hash, dataframes in pattern_datasets.items():
        ...
        pattern_dir = baseline_dir / pattern_hash
...
if __name__ == '__main__':
    ...
    parser.add_argument("--output-dir", required=True, help="Output directory for pattern datasets")
