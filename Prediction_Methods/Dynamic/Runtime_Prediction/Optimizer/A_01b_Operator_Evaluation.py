...
from plot_config import DPI, TAB20_GREEN

TEMPLATES = ['Q1', 'Q3', 'Q4', 'Q5', 'Q6', 'Q7', 'Q8', 'Q9', 'Q10', 'Q12', 'Q13', 'Q14', 'Q18', 'Q19']


# ORCHESTRATOR
def operator_evaluation_workflow(predictions_dir: Path, output_dir: Path) -> None:
...
def create_plot(stats: pd.DataFrame, output_dir: Path) -> None:
    ...
    bars = ax.bar(x, values, color=TAB20_GREEN, alpha=0.85,
...
if __name__ == "__main__":
    ...
    operator_evaluation_workflow(Path(args.predictions_dir), Path(args.output_dir))
