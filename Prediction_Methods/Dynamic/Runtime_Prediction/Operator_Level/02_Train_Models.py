...
# From mapping_config.py: Get target types and target mapping
from mapping_config import TARGET_TYPES, TARGET_NAME_MAP

sys.path.insert(0, str(STATIC_OPERATOR_LEVEL / 'Runtime_Prediction'))
