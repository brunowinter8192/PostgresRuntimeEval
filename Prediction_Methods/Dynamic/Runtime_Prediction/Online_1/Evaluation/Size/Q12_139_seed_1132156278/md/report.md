...
**Test Query:** Q12_139_seed_1132156278
...
```
Node 24614 (Aggregate) - ROOT
  Node 24615 (Gather Merge)
    Node 24616 (Aggregate)
      Node 24617 (Sort)
        Node 24618 (Nested Loop)
          Node 24619 (Seq Scan) - LEAF
          Node 24620 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24614 | Aggregate | 987.91 | 919.06 | 7.0% | operator |
| 24615 | Gather Merge | 987.90 | 1111.84 | 12.5% | operator |
| 24616 | Aggregate | 966.26 | 895.30 | 7.3% | operator |
| 24617 | Sort | 965.58 | 1092.82 | 13.2% | operator |
| 24618 | Nested Loop | 964.65 | 1127.41 | 16.9% | operator |
| 24619 | Seq Scan | 829.43 | 745.19 | 10.2% | operator |
| 24620 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24619 (Seq Scan) - LEAF
...
### Step 2: Node 24620 (Index Scan) - LEAF
...
### Step 6: Node 24615 (Gather Merge)
...
### Step 7: Node 24614 (Aggregate) - ROOT
