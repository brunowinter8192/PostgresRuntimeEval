...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4951 | 4952, 4953, 4954, 4956, 4957, 4958 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4956 | 4951, 4952, 4953, 4954, 4957, 4958 |
...
|------|------|--------|-----------|-----|--------|
| 4951 | Limit | 1220.51 | 1151.18 | 5.7% | pattern |
| 4955 | Nested Loop | 1178.77 | 1193.41 | 1.2% | operator |
| 4956 | Hash Join | 210.68 | 242.55 | 15.1% | pattern |
| 4960 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4959 | Seq Scan | 27.45 | 38.54 | 40.4% | operator |
...
- **Consumes:** Nodes 4951, 4952, 4953, 4954, 4957, 4958
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47481
  - HashJoin_nt1=236285
...
- **Output:** st=122.15, rt=1193.41

### Step 5: Node 4951 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4952, 4953, 4954, 4956, 4957, 4958
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=315445
  - Aggregate_Outer_nt1=315445
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110529.4500
  - Aggregate_Outer_total_cost=114472.5100
  - Gather_Outer_np=0
