...
**Test Query:** Q4_76_seed_615302325
...
```
Node 6712 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6713 (Gather Merge) [consumed]
    Node 6714 (Sort) [consumed]
      Node 6715 (Aggregate) [consumed]
        Node 6716 (Nested Loop)
          Node 6717 (Seq Scan) - LEAF
          Node 6718 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6712 | 6713, 6714, 6715 |
...
|------|------|--------|-----------|-----|--------|
| 6712 | Aggregate | 1099.56 | 952.19 | 13.4% | pattern |
| 6716 | Nested Loop | 1093.31 | 1255.45 | 14.8% | operator |
| 6717 | Seq Scan | 164.12 | 154.66 | 5.8% | operator |
| 6718 | Index Scan | 0.07 | 11.10 | 16983.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6717 (Seq Scan) - LEAF
...
### Step 2: Node 6718 (Index Scan) - LEAF
