...
**Test Query:** Q19_77_seed_623506356
...
```
Node 32088 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 32089 (Gather) [consumed]
    Node 32090 (Aggregate) [consumed]
      Node 32091 (Hash Join) [consumed]
        Node 32092 (Seq Scan) - LEAF
        Node 32093 (Hash)
          Node 32094 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 32088 | 32089, 32090, 32091 |
...
|------|------|--------|-----------|-----|--------|
| 32088 | Aggregate | 853.77 | 829.28 | 2.9% | pattern |
| 32092 | Seq Scan | 784.53 | 743.46 | 5.2% | operator |
| 32093 | Hash | 46.62 | 8.29 | 82.2% | operator |
| 32094 | Seq Scan | 46.49 | 23.76 | 48.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 32094 (Seq Scan) - LEAF
...
### Step 2: Node 32092 (Seq Scan) - LEAF
...
### Step 4: Node 32088 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 32089, 32090, 32091
- **Input Features:**
