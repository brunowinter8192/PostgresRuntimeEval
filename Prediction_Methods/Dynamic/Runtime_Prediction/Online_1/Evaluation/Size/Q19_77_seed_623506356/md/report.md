...
```
Node 32088 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 32089 (Gather) [consumed]
    Node 32090 (Aggregate) [consumed]
      Node 32091 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 32088 | 32089, 32090 |
...
|------|------|--------|-----------|-----|--------|
| 32088 | Aggregate | 853.77 | 831.20 | 2.6% | pattern |
| 32091 | Hash Join | 833.75 | 766.06 | 8.1% | operator |
...
### Step 5: Node 32088 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 32089, 32090
- **Input Features:**
