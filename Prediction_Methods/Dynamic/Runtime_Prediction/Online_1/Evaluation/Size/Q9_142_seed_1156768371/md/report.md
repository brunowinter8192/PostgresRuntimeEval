...
**Test Query:** Q9_142_seed_1156768371
...
```
Node 17484 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 17485 (Aggregate) [consumed]
    Node 17486 (Gather)
      Node 17487 (Aggregate)
        Node 17488 (Nested Loop)
          Node 17489 (Hash Join) [PATTERN: bb930825]
            Node 17490 (Seq Scan) [consumed] - LEAF
            Node 17491 (Hash) [consumed]
              Node 17492 (Hash Join) [consumed]
                Node 17493 (Hash Join)
                  Node 17494 (Nested Loop)
                    Node 17495 (Seq Scan) - LEAF
                    Node 17496 (Index Scan) - LEAF
                  Node 17497 (Hash)
                    Node 17498 (Seq Scan) - LEAF
                Node 17499 (Hash)
                  Node 17500 (Seq Scan) - LEAF
          Node 17501 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17489 | 17484, 17485, 17490, 17491, 17492 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17484 | 17485, 17489, 17490, 17491, 17492 |
...
|------|------|--------|-----------|-----|--------|
| 17484 | Sort | 1215.15 | 1045.06 | 14.0% | pattern |
| 17486 | Gather | 1213.46 | 964.74 | 20.5% | operator |
| 17487 | Aggregate | 1194.99 | 1106.30 | 7.4% | operator |
| 17488 | Nested Loop | 1170.70 | 1252.17 | 7.0% | operator |
| 17489 | Hash Join | 991.81 | 134.80 | 86.4% | pattern |
| 17501 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17493 | Hash Join | 163.18 | 837.58 | 413.3% | operator |
| 17499 | Hash | 13.79 | 14.95 | 8.4% | operator |
| 17494 | Nested Loop | 156.08 | 1251.77 | 702.0% | operator |
| 17497 | Hash | 4.77 | 15.94 | 234.4% | operator |
| 17500 | Seq Scan | 13.78 | 2.94 | 78.7% | operator |
| 17495 | Seq Scan | 21.32 | 44.10 | 106.9% | operator |
| 17496 | Index Scan | 0.07 | -1.39 | 1951.3% | operator |
| 17498 | Seq Scan | 4.12 | 9.45 | 129.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 17495 (Seq Scan) - LEAF
...
### Step 2: Node 17496 (Index Scan) - LEAF
...
### Step 3: Node 17498 (Seq Scan) - LEAF
...
### Step 6: Node 17500 (Seq Scan) - LEAF
...
### Step 9: Node 17489 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17484, 17485, 17490, 17491, 17492
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17501 (Index Scan) - LEAF
...
### Step 11: Node 17488 (Nested Loop)
...
### Step 14: Node 17484 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17485, 17489, 17490, 17491, 17492
- **Input Features:**
