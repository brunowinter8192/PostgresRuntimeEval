...
**Test Query:** Q6_122_seed_992687751
...
```
Node 9997 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 9998 (Gather) [consumed]
    Node 9999 (Aggregate) [consumed]
      Node 10000 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 9997 | 9998, 9999 |
...
|------|------|--------|-----------|-----|--------|
| 9997 | Aggregate | 779.81 | 849.99 | 9.0% | pattern |
| 10000 | Seq Scan | 756.89 | 748.50 | 1.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10000 (Seq Scan) - LEAF
...
### Step 2: Node 9997 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 9998, 9999
- **Input Features:**
