...
**Test Query:** Q1_24_seed_188692713
...
```
Node 331 (Aggregate) - ROOT
  Node 332 (Gather Merge)
    Node 333 (Sort) [PATTERN: 1d35fb97]
      Node 334 (Aggregate) [consumed]
        Node 335 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 333 | 334 |
...
|------|------|--------|-----------|-----|--------|
| 331 | Aggregate | 944.98 | 1196.01 | 26.6% | operator |
| 332 | Gather Merge | 944.92 | 1165.94 | 23.4% | operator |
| 333 | Sort | 925.88 | 1200.99 | 29.7% | pattern |
| 335 | Seq Scan | 515.93 | 678.42 | 31.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 335 (Seq Scan) - LEAF
...
### Step 2: Node 333 (Sort) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Aggregate_Outer_total_cost=169290.9000
  - Sort_np=0
  - Sort_nt=6
  - Sort_nt1=6
  - Sort_nt2=0
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=169290.9800
  - Sort_total_cost=169291.0000
- **Output:** st=1196.89, rt=1200.99

### Step 3: Node 332 (Gather Merge)
...
### Step 4: Node 331 (Aggregate) - ROOT
