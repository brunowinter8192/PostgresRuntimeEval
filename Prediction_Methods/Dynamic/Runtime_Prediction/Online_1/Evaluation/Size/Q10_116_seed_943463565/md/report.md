...
**Test Query:** Q10_116_seed_943463565
...
```
Node 19591 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 19592 (Sort) [consumed]
    Node 19593 (Aggregate) [consumed]
      Node 19594 (Gather) [consumed]
        Node 19595 (Hash Join)
          Node 19596 (Hash Join) [PATTERN: 2e0f44ef]
            Node 19597 (Nested Loop) [consumed]
              Node 19598 (Seq Scan) - LEAF
              Node 19599 (Index Scan) - LEAF
            Node 19600 (Hash) [consumed]
              Node 19601 (Seq Scan) - LEAF
          Node 19602 (Hash)
            Node 19603 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19591 | 19592, 19593, 19594, 19596, 19597, 19600 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 19596 | 19591, 19592, 19593, 19594, 19597, 19600 |
...
|------|------|--------|-----------|-----|--------|
| 19591 | Limit | 1161.56 | 1199.47 | 3.3% | pattern |
| 19595 | Hash Join | 1115.86 | 1095.57 | 1.8% | operator |
| 19596 | Hash Join | 1112.96 | 1120.19 | 0.6% | pattern |
| 19602 | Hash | 0.01 | 15.71 | 120752.1% | operator |
| 19603 | Seq Scan | 0.01 | 6.98 | 69687.0% | operator |
| 19598 | Seq Scan | 162.22 | 159.74 | 1.5% | operator |
| 19599 | Index Scan | 0.06 | -0.52 | 922.6% | operator |
| 19601 | Seq Scan | 29.59 | 26.64 | 10.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 19598 (Seq Scan) - LEAF
...
### Step 2: Node 19599 (Index Scan) - LEAF
...
### Step 3: Node 19601 (Seq Scan) - LEAF
...
### Step 4: Node 19603 (Seq Scan) - LEAF
...
### Step 5: Node 19596 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 19591, 19592, 19593, 19594, 19597, 19600
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18257
  - HashJoin_nt1=18257
...
### Step 8: Node 19591 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19592, 19593, 19594, 19596, 19597, 19600
- **Input Features:**
