...
**Test Query:** Q14_120_seed_976279689
...
```
Node 26574 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26575 (Gather) [consumed]
    Node 26576 (Aggregate) [consumed]
      Node 26577 (Hash Join) [consumed]
        Node 26578 (Seq Scan) - LEAF
        Node 26579 (Hash)
          Node 26580 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26574 | 26575, 26576, 26577 |
...
|------|------|--------|-----------|-----|--------|
| 26574 | Aggregate | 836.88 | 857.14 | 2.4% | pattern |
| 26578 | Seq Scan | 765.59 | 758.50 | 0.9% | operator |
| 26579 | Hash | 41.23 | 9.38 | 77.3% | operator |
| 26580 | Seq Scan | 36.06 | 12.70 | 64.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26580 (Seq Scan) - LEAF
...
### Step 2: Node 26578 (Seq Scan) - LEAF
...
### Step 4: Node 26574 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26575, 26576, 26577
- **Input Features:**
