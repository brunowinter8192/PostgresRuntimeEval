...
```
Node 26574 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26575 (Gather) [consumed]
    Node 26576 (Aggregate) [consumed]
      Node 26577 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26574 | 26575, 26576 |
...
|------|------|--------|-----------|-----|--------|
| 26574 | Aggregate | 836.88 | 848.37 | 1.4% | pattern |
| 26577 | Hash Join | 814.88 | 807.66 | 0.9% | operator |
...
### Step 5: Node 26574 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26575, 26576
- **Input Features:**
