...
**Test Query:** Q9_73_seed_590690232
...
```
Node 18825 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18826 (Aggregate) [consumed]
    Node 18827 (Gather)
      Node 18828 (Aggregate)
        Node 18829 (Nested Loop)
          Node 18830 (Hash Join) [PATTERN: bb930825]
            Node 18831 (Seq Scan) [consumed] - LEAF
            Node 18832 (Hash) [consumed]
              Node 18833 (Hash Join) [consumed]
                Node 18834 (Hash Join)
                  Node 18835 (Nested Loop)
                    Node 18836 (Seq Scan) - LEAF
                    Node 18837 (Index Scan) - LEAF
                  Node 18838 (Hash)
                    Node 18839 (Seq Scan) - LEAF
                Node 18840 (Hash)
                  Node 18841 (Seq Scan) - LEAF
          Node 18842 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18830 | 18825, 18826, 18831, 18832, 18833 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18825 | 18826, 18830, 18831, 18832, 18833 |
...
|------|------|--------|-----------|-----|--------|
| 18825 | Sort | 1177.13 | 1045.59 | 11.2% | pattern |
| 18827 | Gather | 1175.86 | 964.55 | 18.0% | operator |
| 18828 | Aggregate | 1156.51 | 1085.45 | 6.1% | operator |
| 18829 | Nested Loop | 1131.91 | 1252.17 | 10.6% | operator |
| 18830 | Hash Join | 959.62 | 134.80 | 86.0% | pattern |
| 18842 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18834 | Hash Join | 157.10 | 837.63 | 433.2% | operator |
| 18840 | Hash | 13.70 | 14.95 | 9.1% | operator |
| 18835 | Nested Loop | 150.32 | 1251.77 | 732.7% | operator |
| 18838 | Hash | 4.45 | 15.94 | 258.0% | operator |
| 18841 | Seq Scan | 13.69 | 2.94 | 78.6% | operator |
| 18836 | Seq Scan | 19.69 | 43.96 | 123.2% | operator |
| 18837 | Index Scan | 0.07 | -1.39 | 2002.0% | operator |
| 18839 | Seq Scan | 3.85 | 9.45 | 145.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 18836 (Seq Scan) - LEAF
...
### Step 2: Node 18837 (Index Scan) - LEAF
...
### Step 3: Node 18839 (Seq Scan) - LEAF
...
### Step 6: Node 18841 (Seq Scan) - LEAF
...
### Step 9: Node 18830 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18825, 18826, 18831, 18832, 18833
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18842 (Index Scan) - LEAF
...
### Step 11: Node 18829 (Nested Loop)
...
### Step 14: Node 18825 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18826, 18830, 18831, 18832, 18833
- **Input Features:**
