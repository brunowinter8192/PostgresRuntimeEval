...
```
Node 18825 (Sort) - ROOT
  Node 18826 (Aggregate)
    Node 18827 (Gather)
      Node 18828 (Aggregate)
        Node 18829 (Nested Loop)
          Node 18830 (Hash Join)
            Node 18831 (Seq Scan) - LEAF
            Node 18832 (Hash)
              Node 18833 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 18825 | Sort | 1177.13 | 1119.81 | 4.9% | operator |
| 18826 | Aggregate | 1177.01 | 897.74 | 23.7% | operator |
...
| 18830 | Hash Join | 959.62 | 633.50 | 34.0% | operator |
| 18842 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18831 | Seq Scan | 693.00 | 509.93 | 26.4% | operator |
| 18832 | Hash | 173.41 | 48.03 | 72.3% | operator |
| 18833 | Hash Join | 171.40 | 924.48 | 439.4% | operator |
...
### Step 10: Node 18831 (Seq Scan) - LEAF
...
### Step 13: Node 18842 (Index Scan) - LEAF
...
### Step 14: Node 18829 (Nested Loop)
