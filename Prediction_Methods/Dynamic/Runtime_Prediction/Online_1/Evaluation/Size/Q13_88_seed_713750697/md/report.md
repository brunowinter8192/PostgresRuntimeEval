...
```
Node 26322 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26323 (Aggregate) [consumed]
    Node 26324 (Aggregate)
      Node 26325 (Hash Join) [PATTERN: 895c6e8c]
        Node 26326 (Seq Scan) [consumed] - LEAF
        Node 26327 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26322 | 26323, 26325, 26326, 26327 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26325 | 26322, 26323, 26326, 26327 |
...
|------|------|--------|-----------|-----|--------|
| 26322 | Sort | 956.49 | 1079.93 | 12.9% | pattern |
| 26324 | Aggregate | 950.38 | 999.55 | 5.2% | operator |
| 26325 | Hash Join | 732.81 | 470.31 | 35.8% | pattern |
...
### Step 2: Node 26325 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26322, 26323, 26326, 26327
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1484970
...
### Step 4: Node 26322 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26323, 26325, 26326, 26327
- **Input Features:**
