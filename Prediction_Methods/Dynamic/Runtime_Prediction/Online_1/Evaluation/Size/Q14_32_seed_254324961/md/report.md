...
```
Node 26945 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26946 (Gather) [consumed]
    Node 26947 (Aggregate) [consumed]
      Node 26948 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26945 | 26946, 26947, 26948 |
...
|------|------|--------|-----------|-----|--------|
| 26945 | Aggregate | 814.92 | 857.14 | 5.2% | pattern |
...
### Step 4: Node 26945 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26946, 26947, 26948
- **Input Features:**
