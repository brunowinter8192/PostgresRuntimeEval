...
**Test Query:** Q14_32_seed_254324961
...
```
Node 26945 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26946 (Gather) [consumed]
    Node 26947 (Aggregate) [consumed]
      Node 26948 (Hash Join)
        Node 26949 (Seq Scan) - LEAF
        Node 26950 (Hash)
          Node 26951 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26945 | 26946, 26947 |
...
|------|------|--------|-----------|-----|--------|
| 26945 | Aggregate | 814.92 | 848.38 | 4.1% | pattern |
| 26948 | Hash Join | 793.39 | 807.67 | 1.8% | operator |
| 26949 | Seq Scan | 742.16 | 758.51 | 2.2% | operator |
| 26950 | Hash | 43.44 | 9.38 | 78.4% | operator |
| 26951 | Seq Scan | 39.39 | 12.70 | 67.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26951 (Seq Scan) - LEAF
...
### Step 2: Node 26949 (Seq Scan) - LEAF
...
### Step 5: Node 26945 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26946, 26947
- **Input Features:**
