...
**Test Query:** Q14_56_seed_451221705
...
```
Node 27127 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27128 (Gather) [consumed]
    Node 27129 (Aggregate) [consumed]
      Node 27130 (Hash Join) [consumed]
        Node 27131 (Seq Scan) - LEAF
        Node 27132 (Hash)
          Node 27133 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27127 | 27128, 27129, 27130 |
...
|------|------|--------|-----------|-----|--------|
| 27127 | Aggregate | 751.20 | 857.14 | 14.1% | pattern |
| 27131 | Seq Scan | 679.27 | 758.50 | 11.7% | operator |
| 27132 | Hash | 42.42 | 9.38 | 77.9% | operator |
| 27133 | Seq Scan | 36.69 | 12.70 | 65.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27133 (Seq Scan) - LEAF
...
### Step 2: Node 27131 (Seq Scan) - LEAF
...
### Step 4: Node 27127 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27128, 27129, 27130
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=15541
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=64
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0001
  - Aggregate_Outer_startup_cost=136919.4100
  - Aggregate_Outer_total_cost=136919.4200
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=137919.9700
  - Aggregate_total_cost=137919.9900
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=137919.4100
  - Gather_Outer_total_cost=137919.9200
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=15541
  - HashJoin_Outer_nt1=15541
  ...
  - HashJoin_Outer_total_cost=136647.4400
