...
**Test Query:** Q13_38_seed_303549147
**Timestamp:** 2026-01-18 19:58:11
...
```
Node 25937 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25938 (Aggregate) [consumed]
    Node 25939 (Aggregate)
      Node 25940 (Hash Join) [PATTERN: 895c6e8c]
        Node 25941 (Seq Scan) [consumed] - LEAF
        Node 25942 (Hash) [consumed]
          Node 25943 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25937 | 25938, 25940, 25941, 25942 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25940 | 25937, 25938, 25941, 25942 |
...
|------|------|--------|-----------|-----|--------|
| 25937 | Sort | 895.74 | 1079.93 | 20.6% | pattern |
| 25939 | Aggregate | 889.96 | 999.35 | 12.3% | operator |
| 25940 | Hash Join | 684.66 | 470.31 | 31.3% | pattern |
| 25943 | Index Only Scan | 9.85 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25943 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25940 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25937, 25938, 25941, 25942
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1481964
...
### Step 4: Node 25937 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25938, 25940, 25941, 25942
- **Input Features:**
