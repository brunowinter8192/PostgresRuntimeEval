...
**Test Query:** Q12_57_seed_459425736
...
```
Node 25034 (Aggregate) - ROOT
  Node 25035 (Gather Merge)
    Node 25036 (Aggregate)
      Node 25037 (Sort)
        Node 25038 (Nested Loop)
          Node 25039 (Seq Scan) - LEAF
          Node 25040 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 25034 | Aggregate | 997.41 | 919.07 | 7.9% | operator |
| 25035 | Gather Merge | 997.39 | 1111.84 | 11.5% | operator |
| 25036 | Aggregate | 978.28 | 895.31 | 8.5% | operator |
| 25037 | Sort | 977.69 | 1092.81 | 11.8% | operator |
| 25038 | Nested Loop | 976.77 | 1127.41 | 15.4% | operator |
| 25039 | Seq Scan | 839.88 | 745.19 | 11.3% | operator |
| 25040 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25039 (Seq Scan) - LEAF
...
### Step 2: Node 25040 (Index Scan) - LEAF
...
### Step 6: Node 25035 (Gather Merge)
...
### Step 7: Node 25034 (Aggregate) - ROOT
