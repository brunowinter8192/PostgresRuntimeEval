...
**Test Query:** Q18_143_seed_1164972402
...
```
Node 29572 (Limit) - ROOT
  Node 29573 (Sort)
    Node 29574 (Aggregate)
      Node 29575 (Gather Merge)
        Node 29576 (Incremental Sort)
          Node 29577 (Nested Loop)
            Node 29578 (Merge Join)
              Node 29579 (Sort)
                Node 29580 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29581 (Seq Scan) [consumed] - LEAF
                  Node 29582 (Hash) [consumed]
                    Node 29583 (Aggregate)
                      Node 29584 (Index Scan) - LEAF
              Node 29585 (Sort)
                Node 29586 (Seq Scan) - LEAF
            Node 29587 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29580 | 29581, 29582 |
...
|------|------|--------|-----------|-----|--------|
| 29572 | Limit | 3047.69 | 1175.21 | 61.4% | operator |
| 29573 | Sort | 2931.70 | 1127.81 | 61.5% | operator |
| 29574 | Aggregate | 2931.66 | 1073.15 | 63.4% | operator |
| 29575 | Gather Merge | 2931.64 | 1073.95 | 63.4% | operator |
| 29576 | Incremental Sort | 2910.88 | 0.00 | 100.0% | operator |
| 29577 | Nested Loop | 2910.84 | 1111.34 | 61.8% | operator |
| 29578 | Merge Join | 2910.78 | 0.00 | 100.0% | operator |
| 29587 | Index Scan | 0.02 | 0.05 | 105.2% | operator |
| 29579 | Sort | 2840.34 | 1095.58 | 61.4% | operator |
| 29585 | Sort | 68.29 | 1074.66 | 1473.7% | operator |
| 29580 | Hash Join | 2840.32 | 471.07 | 83.4% | pattern |
| 29586 | Seq Scan | 55.27 | 18.25 | 67.0% | operator |
| 29583 | Aggregate | 2616.94 | 1073.15 | 59.0% | operator |
| 29584 | Index Scan | 2132.12 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29584 (Index Scan) - LEAF
...
### Step 3: Node 29580 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29581, 29582
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29586 (Seq Scan) - LEAF
...
### Step 7: Node 29578 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29587 (Index Scan) - LEAF
...
### Step 10: Node 29576 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29575 (Gather Merge)
