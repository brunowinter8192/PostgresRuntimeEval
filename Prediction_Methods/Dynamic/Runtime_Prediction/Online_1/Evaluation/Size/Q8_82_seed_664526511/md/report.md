...
```
Node 16191 (Aggregate) - ROOT
  Node 16192 (Gather Merge)
    Node 16193 (Sort)
          ...
          Node 16196 (Hash Join)
            Node 16197 (Nested Loop)
              Node 16198 (Hash Join)
                ...
                Node 16200 (Hash)
                  Node 16201 (Hash Join)
                    Node 16202 (Seq Scan) - LEAF
                    Node 16203 (Hash)
                      Node 16204 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 16191 | Aggregate | 1218.19 | 1195.83 | 1.8% | operator |
| 16192 | Gather Merge | 1217.74 | 1097.14 | 9.9% | operator |
...
| 16198 | Hash Join | 213.72 | 251.17 | 17.5% | operator |
...
| 16200 | Hash | 37.17 | 20.62 | 44.5% | operator |
| 16201 | Hash Join | 36.54 | 132.26 | 262.0% | operator |
| 16202 | Seq Scan | 35.13 | 23.03 | 34.4% | operator |
| 16203 | Hash | 0.09 | 23.66 | 27730.7% | operator |
| 16204 | Hash Join | 0.08 | 306.84 | 374090.2% | operator |
...
### Step 5: Node 16202 (Seq Scan) - LEAF
...
### Step 8: Node 16199 (Seq Scan) - LEAF
...
### Step 11: Node 16208 (Index Scan) - LEAF
...
### Step 12: Node 16210 (Seq Scan) - LEAF
...
### Step 13: Node 16197 (Nested Loop)
...
### Step 16: Node 16211 (Index Scan) - LEAF
...
### Step 17: Node 16213 (Seq Scan) - LEAF
...
### Step 18: Node 16195 (Nested Loop)
...
### Step 22: Node 16192 (Gather Merge)
...
- **Input Features:**
  ...
  - total_cost=71818.6000
- **Output:** st=1093.44, rt=1097.14

### Step 23: Node 16191 (Aggregate) - ROOT
