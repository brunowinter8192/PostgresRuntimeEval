...
```
Node 27064 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27065 (Gather) [consumed]
    Node 27066 (Aggregate) [consumed]
      Node 27067 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27064 | 27065, 27066, 27067 |
...
|------|------|--------|-----------|-----|--------|
| 27064 | Aggregate | 815.23 | 857.10 | 5.1% | pattern |
...
### Step 4: Node 27064 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27065, 27066, 27067
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=13226
  - HashJoin_Outer_nt1=13226
  ...
  - HashJoin_Outer_total_cost=136641.3600
- **Output:** st=850.73, rt=857.10
