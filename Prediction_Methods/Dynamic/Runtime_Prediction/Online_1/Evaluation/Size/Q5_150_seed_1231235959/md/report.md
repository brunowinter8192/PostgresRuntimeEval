...
```
Node 8001 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 8002 (Aggregate) [consumed]
    Node 8003 (Gather Merge) [consumed]
      Node 8004 (Aggregate)
        Node 8005 (Sort) [PATTERN: 3e2d5a00]
          Node 8006 (Hash Join) [consumed]
            Node 8007 (Nested Loop)
              Node 8008 (Hash Join)
                Node 8009 (Seq Scan) - LEAF
                Node 8010 (Hash) [PATTERN: 444761fb]
                  Node 8011 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 8010 | 8001, 8002, 8003, 8005, 8006, 8011, 8012, 8013, 8014 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 8001 | 8002, 8003, 8005, 8006, 8010, 8011, 8012, 8013, 8014 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 8005 | 8001, 8002, 8003, 8006, 8010, 8011, 8012, 8013, 8014 |
...
|------|------|--------|-----------|-----|--------|
| 8001 | Sort | 1059.75 | 2934.42 | 176.9% | pattern |
| 8004 | Aggregate | 1055.08 | 1128.78 | 7.0% | operator |
| 8005 | Sort | 1054.82 | 1835.92 | 74.1% | pattern |
| 8007 | Nested Loop | 1043.32 | 1188.42 | 13.9% | operator |
| 8019 | Hash | 2.96 | 18.67 | 531.9% | operator |
| 8008 | Hash Join | 208.22 | 253.07 | 21.5% | operator |
| 8018 | Index Scan | 0.07 | -0.22 | 401.4% | operator |
| 8020 | Seq Scan | 2.46 | 12.36 | 403.0% | operator |
| 8009 | Seq Scan | 164.82 | 159.81 | 3.0% | operator |
| 8010 | Hash | 30.28 | 46.85 | 54.7% | pattern |
| 8015 | Seq Scan | 0.02 | 11.81 | 73701.7% | operator |
| 8016 | Hash | 0.14 | 21.05 | 15046.2% | operator |
| 8017 | Seq Scan | 0.14 | 22.93 | 16762.7% | operator |
...
### Step 4: Node 8009 (Seq Scan) - LEAF
...
### Step 5: Node 8010 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 8001, 8002, 8003, 8005, 8006, 8011, 8012, 8013, 8014
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 8018 (Index Scan) - LEAF
...
### Step 8: Node 8020 (Seq Scan) - LEAF
...
### Step 11: Node 8005 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 8001, 8002, 8003, 8006, 8010, 8011, 8012, 8013, 8014
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 8001 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 8002, 8003, 8005, 8006, 8010, 8011, 8012, 8013, 8014
- **Input Features:**
