...
```
Node 10189 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10190 (Gather) [consumed]
    Node 10191 (Aggregate) [consumed]
      Node 10192 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10189 | 10190, 10191 |
...
|------|------|--------|-----------|-----|--------|
| 10189 | Aggregate | 771.40 | 850.07 | 10.2% | pattern |
| 10192 | Seq Scan | 751.54 | 748.54 | 0.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10192 (Seq Scan) - LEAF
...
### Step 2: Node 10189 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10190, 10191
- **Input Features:**
