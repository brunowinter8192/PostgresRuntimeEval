...
Node 166 (Aggregate) - ROOT
  Node 167 (Gather Merge)
    Node 168 (Sort) [PATTERN: 1d35fb97]
      Node 169 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 168 | 169 |
...
|------|------|--------|-----------|-----|--------|
| 166 | Aggregate | 928.17 | 1195.79 | 28.8% | operator |
| 167 | Gather Merge | 928.12 | 1165.88 | 25.6% | operator |
| 168 | Sort | 909.57 | 1200.13 | 31.9% | pattern |
...
### Step 2: Node 168 (Sort) - PATTERN ROOT
...
### Step 4: Node 166 (Aggregate) - ROOT
