...
**Test Query:** Q19_85_seed_689138604
...
```
Node 32151 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 32152 (Gather) [consumed]
    Node 32153 (Aggregate) [consumed]
      Node 32154 (Hash Join) [consumed]
        Node 32155 (Seq Scan) - LEAF
        Node 32156 (Hash)
          Node 32157 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 32151 | 32152, 32153, 32154 |
...
|------|------|--------|-----------|-----|--------|
| 32151 | Aggregate | 859.98 | 829.30 | 3.6% | pattern |
| 32155 | Seq Scan | 787.29 | 743.46 | 5.6% | operator |
| 32156 | Hash | 48.69 | 8.29 | 83.0% | operator |
| 32157 | Seq Scan | 48.55 | 23.76 | 51.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 32157 (Seq Scan) - LEAF
...
### Step 2: Node 32155 (Seq Scan) - LEAF
...
### Step 4: Node 32151 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 32152, 32153, 32154
- **Input Features:**
