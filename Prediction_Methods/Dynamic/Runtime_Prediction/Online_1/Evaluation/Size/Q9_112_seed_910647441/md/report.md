...
```
Node 16887 (Sort) - ROOT
  Node 16888 (Aggregate)
    Node 16889 (Gather)
      Node 16890 (Aggregate)
        Node 16891 (Nested Loop)
          Node 16892 (Hash Join)
            Node 16893 (Seq Scan) - LEAF
            Node 16894 (Hash)
              Node 16895 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 16887 | Sort | 1214.93 | 1119.21 | 7.9% | operator |
| 16888 | Aggregate | 1214.80 | 897.16 | 26.1% | operator |
...
| 16892 | Hash Join | 994.36 | 633.14 | 36.3% | operator |
| 16904 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 16893 | Seq Scan | 720.18 | 509.93 | 29.2% | operator |
| 16894 | Hash | 180.11 | 47.79 | 73.5% | operator |
| 16895 | Hash Join | 177.61 | 924.37 | 420.5% | operator |
...
### Step 10: Node 16893 (Seq Scan) - LEAF
...
### Step 13: Node 16904 (Index Scan) - LEAF
...
### Step 14: Node 16891 (Nested Loop)
