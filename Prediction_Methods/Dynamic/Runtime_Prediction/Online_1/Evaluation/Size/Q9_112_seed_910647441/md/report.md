...
**Test Query:** Q9_112_seed_910647441
...
```
Node 16887 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 16888 (Aggregate) [consumed]
    Node 16889 (Gather)
      Node 16890 (Aggregate)
        Node 16891 (Nested Loop)
          Node 16892 (Hash Join) [PATTERN: bb930825]
            Node 16893 (Seq Scan) [consumed] - LEAF
            Node 16894 (Hash) [consumed]
              Node 16895 (Hash Join) [consumed]
                Node 16896 (Hash Join)
                  Node 16897 (Nested Loop)
                    Node 16898 (Seq Scan) - LEAF
                    Node 16899 (Index Scan) - LEAF
                  Node 16900 (Hash)
                    Node 16901 (Seq Scan) - LEAF
                Node 16902 (Hash)
                  Node 16903 (Seq Scan) - LEAF
          Node 16904 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 16892 | 16887, 16888, 16893, 16894, 16895 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 16887 | 16888, 16892, 16893, 16894, 16895 |
...
|------|------|--------|-----------|-----|--------|
| 16887 | Sort | 1214.93 | 1045.06 | 14.0% | pattern |
| 16889 | Gather | 1213.64 | 964.74 | 20.5% | operator |
| 16890 | Aggregate | 1195.07 | 1106.30 | 7.4% | operator |
| 16891 | Nested Loop | 1170.49 | 1252.17 | 7.0% | operator |
| 16892 | Hash Join | 994.36 | 134.80 | 86.4% | pattern |
| 16904 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 16896 | Hash Join | 163.85 | 837.58 | 411.2% | operator |
| 16902 | Hash | 13.12 | 14.95 | 13.9% | operator |
| 16897 | Nested Loop | 158.15 | 1251.77 | 691.5% | operator |
| 16900 | Hash | 3.77 | 15.94 | 323.1% | operator |
| 16903 | Seq Scan | 13.11 | 2.94 | 77.6% | operator |
| 16898 | Seq Scan | 19.96 | 44.10 | 121.0% | operator |
| 16899 | Index Scan | 0.08 | -1.39 | 1926.9% | operator |
| 16901 | Seq Scan | 3.27 | 9.45 | 188.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 16898 (Seq Scan) - LEAF
...
### Step 2: Node 16899 (Index Scan) - LEAF
...
### Step 3: Node 16901 (Seq Scan) - LEAF
...
### Step 6: Node 16903 (Seq Scan) - LEAF
...
### Step 9: Node 16892 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 16887, 16888, 16893, 16894, 16895
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 16904 (Index Scan) - LEAF
...
### Step 11: Node 16891 (Nested Loop)
...
### Step 14: Node 16887 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 16888, 16892, 16893, 16894, 16895
- **Input Features:**
