...
**Test Query:** Q3_54_seed_434813643
...
```
Node 5341 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5342 (Sort) [consumed]
    Node 5343 (Aggregate) [consumed]
      Node 5344 (Gather) [consumed]
        Node 5345 (Nested Loop)
          Node 5346 (Hash Join) [PATTERN: 895c6e8c]
            Node 5347 (Seq Scan) [consumed] - LEAF
            Node 5348 (Hash) [consumed]
              Node 5349 (Seq Scan) - LEAF
          Node 5350 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5341 | 5342, 5343, 5344, 5346, 5347, 5348 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5346 | 5341, 5342, 5343, 5344, 5347, 5348 |
...
|------|------|--------|-----------|-----|--------|
| 5341 | Limit | 1200.64 | 1151.18 | 4.1% | pattern |
| 5345 | Nested Loop | 1162.89 | 1193.16 | 2.6% | operator |
| 5346 | Hash Join | 206.74 | 242.50 | 17.3% | pattern |
| 5350 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5349 | Seq Scan | 27.39 | 38.53 | 40.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5349 (Seq Scan) - LEAF
...
### Step 2: Node 5346 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5341, 5342, 5343, 5344, 5347, 5348
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47090
  - HashJoin_nt1=233978
  ...
  - HashJoin_total_cost=37337.0900
  - Hash_Inner_np=0
  - Hash_Inner_nt=12579
...
### Step 3: Node 5350 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=73041.7300
- **Output:** st=121.89, rt=1193.16

### Step 5: Node 5341 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5342, 5343, 5344, 5346, 5347, 5348
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=315800
  - Aggregate_Outer_nt1=315800
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110358.7300
  - Aggregate_Outer_total_cost=114306.2300
  - Gather_Outer_np=0
  - Gather_Outer_nt=315800
  - Gather_Outer_nt1=101871
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105621.7300
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=315800
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=121130.5500
  - Limit_total_cost=121130.5800
  - Sort_Outer_np=0
  - Sort_Outer_nt=315800
  - Sort_Outer_nt1=315800
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=121130.5500
  - Sort_Outer_total_cost=121920.0500
