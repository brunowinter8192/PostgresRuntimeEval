...
**Test Query:** Q3_34_seed_270733023
...
```
Node 5121 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5122 (Sort) [consumed]
    Node 5123 (Aggregate) [consumed]
      Node 5124 (Gather) [consumed]
        Node 5125 (Nested Loop)
          Node 5126 (Hash Join) [PATTERN: 895c6e8c]
            Node 5127 (Seq Scan) [consumed] - LEAF
            Node 5128 (Hash) [consumed]
              Node 5129 (Seq Scan) - LEAF
          Node 5130 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5121 | 5122, 5123, 5124, 5126, 5127, 5128 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5126 | 5121, 5122, 5123, 5124, 5127, 5128 |
...
|------|------|--------|-----------|-----|--------|
| 5121 | Limit | 1193.39 | 1151.18 | 3.5% | pattern |
| 5125 | Nested Loop | 1158.59 | 1193.44 | 3.0% | operator |
| 5126 | Hash Join | 208.46 | 242.55 | 16.4% | pattern |
| 5130 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5129 | Seq Scan | 28.78 | 38.53 | 33.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5129 (Seq Scan) - LEAF
...
### Step 2: Node 5126 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5121, 5122, 5123, 5124, 5127, 5128
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47516
  - HashJoin_nt1=236095
  ...
  - HashJoin_total_cost=37342.6500
  - Hash_Inner_np=0
  - Hash_Inner_nt=12579
...
- **Output:** st=29.71, rt=242.55

### Step 3: Node 5130 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=73286.8900
- **Output:** st=122.16, rt=1193.44

### Step 5: Node 5121 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5122, 5123, 5124, 5126, 5127, 5128
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=316176
  - Aggregate_Outer_nt1=316176
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110647.1300
  - Aggregate_Outer_total_cost=114599.3300
  - Gather_Outer_np=0
  - Gather_Outer_nt=316176
  - Gather_Outer_nt1=101992
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105904.4900
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=316176
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=121431.7800
  - Limit_total_cost=121431.8100
  - Sort_Outer_np=0
  - Sort_Outer_nt=316176
  - Sort_Outer_nt1=316176
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=121431.7800
  - Sort_Outer_total_cost=122222.2200
