...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5121 | 5122, 5123, 5124 |
...
| 5125 | Nested Loop | 1158.59 | 1193.35 | 3.0% | operator |
| 5126 | Hash Join | 208.46 | 231.01 | 10.8% | operator |
| 5130 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5127 | Seq Scan | 155.76 | 163.46 | 4.9% | operator |
| 5128 | Hash | 29.53 | 17.75 | 39.9% | operator |
...
### Step 2: Node 5127 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37342.6500
- **Output:** st=27.22, rt=231.01

### Step 5: Node 5130 (Index Scan) - LEAF
...
- **Output:** st=122.03, rt=1193.35

### Step 7: Node 5121 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5122, 5123, 5124
- **Input Features:**
