...
**Test Query:** Q18_19_seed_147672558
...
```
Node 29780 (Limit) - ROOT
  Node 29781 (Sort)
    Node 29782 (Aggregate)
      Node 29783 (Gather Merge)
        Node 29784 (Incremental Sort)
          Node 29785 (Nested Loop)
            Node 29786 (Merge Join)
              Node 29787 (Sort)
                Node 29788 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29789 (Seq Scan) [consumed] - LEAF
                  Node 29790 (Hash) [consumed]
                    Node 29791 (Aggregate)
                      Node 29792 (Index Scan) - LEAF
              Node 29793 (Sort)
                Node 29794 (Seq Scan) - LEAF
            Node 29795 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29788 | 29789, 29790 |
...
|------|------|--------|-----------|-----|--------|
| 29780 | Limit | 3038.75 | 1175.21 | 61.3% | operator |
| 29781 | Sort | 2924.46 | 1127.81 | 61.4% | operator |
| 29782 | Aggregate | 2924.41 | 1073.15 | 63.3% | operator |
| 29783 | Gather Merge | 2924.40 | 1073.95 | 63.3% | operator |
| 29784 | Incremental Sort | 2891.70 | 0.00 | 100.0% | operator |
| 29785 | Nested Loop | 2891.65 | 1111.34 | 61.6% | operator |
| 29786 | Merge Join | 2891.60 | 0.00 | 100.0% | operator |
| 29795 | Index Scan | 0.02 | 0.05 | 125.7% | operator |
| 29787 | Sort | 2841.95 | 1095.58 | 61.4% | operator |
| 29793 | Sort | 63.48 | 1074.66 | 1593.0% | operator |
| 29788 | Hash Join | 2841.94 | 471.07 | 83.4% | pattern |
| 29794 | Seq Scan | 52.50 | 18.25 | 65.2% | operator |
| 29791 | Aggregate | 2618.15 | 1073.15 | 59.0% | operator |
| 29792 | Index Scan | 2131.82 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29792 (Index Scan) - LEAF
...
### Step 3: Node 29788 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29789, 29790
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29794 (Seq Scan) - LEAF
...
### Step 7: Node 29786 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29795 (Index Scan) - LEAF
...
### Step 10: Node 29784 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29783 (Gather Merge)
