...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20306 | 20307, 20308, 20309, 20311, 20312, 20315 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 20311 | 20306, 20307, 20308, 20309, 20312, 20315 |
...
|------|------|--------|-----------|-----|--------|
| 20306 | Limit | 1157.65 | 1199.47 | 3.6% | pattern |
| 20310 | Hash Join | 1112.23 | 1095.40 | 1.5% | operator |
| 20311 | Hash Join | 1109.49 | 1120.19 | 1.0% | pattern |
| 20317 | Hash | 0.01 | 15.71 | 112119.8% | operator |
| 20318 | Seq Scan | 0.01 | 6.98 | 69687.0% | operator |
| 20313 | Seq Scan | 166.56 | 159.75 | 4.1% | operator |
| 20314 | Index Scan | 0.06 | -0.52 | 922.6% | operator |
| 20316 | Seq Scan | 28.52 | 26.64 | 6.6% | operator |
...
### Step 4: Node 20318 (Seq Scan) - LEAF
...
- **Consumes:** Nodes 20306, 20307, 20308, 20309, 20312, 20315
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=17639
  - HashJoin_nt1=17639
...
### Step 8: Node 20306 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20307, 20308, 20309, 20311, 20312, 20315
- **Input Features:**
