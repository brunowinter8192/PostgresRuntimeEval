    ...
    Node 20308 (Aggregate) [consumed]
      Node 20309 (Gather) [consumed]
        Node 20310 (Hash Join)
          Node 20311 (Hash Join)
            Node 20312 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20306 | 20307, 20308, 20309 |
...
| 20310 | Hash Join | 1112.23 | 1007.36 | 9.4% | operator |
| 20311 | Hash Join | 1109.49 | 1004.36 | 9.5% | operator |
| 20317 | Hash | 0.01 | 15.71 | 112119.8% | operator |
| 20312 | Nested Loop | 1061.36 | 1204.72 | 13.5% | operator |
| 20315 | Hash | 37.45 | 55.57 | 48.4% | operator |
...
### Step 6: Node 20318 (Seq Scan) - LEAF
...
### Step 10: Node 20306 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20307, 20308, 20309
- **Input Features:**
