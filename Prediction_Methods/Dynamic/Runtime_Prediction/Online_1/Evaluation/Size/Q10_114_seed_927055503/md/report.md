    ...
    Node 19567 (Aggregate) [consumed]
      Node 19568 (Gather) [consumed]
        Node 19569 (Hash Join)
          Node 19570 (Hash Join)
            Node 19571 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19565 | 19566, 19567, 19568 |
...
| 19569 | Hash Join | 1104.14 | 1007.10 | 8.8% | operator |
| 19570 | Hash Join | 1101.23 | 1003.93 | 8.8% | operator |
| 19576 | Hash | 0.01 | 15.71 | 112119.8% | operator |
| 19571 | Nested Loop | 1052.65 | 1204.88 | 14.5% | operator |
| 19574 | Hash | 38.22 | 55.57 | 45.4% | operator |
...
- **Output:** st=124.89, rt=1204.88

### Step 5: Node 19574 (Hash)
...
### Step 6: Node 19577 (Seq Scan) - LEAF
...
- **Output:** st=109.74, rt=1003.93

### Step 8: Node 19576 (Hash)
...
- **Output:** st=98.94, rt=1007.10

### Step 10: Node 19565 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19566, 19567, 19568
- **Input Features:**
