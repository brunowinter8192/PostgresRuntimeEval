...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4961 | 4962, 4963, 4964, 4966, 4967, 4968 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4966 | 4961, 4962, 4963, 4964, 4967, 4968 |
...
|------|------|--------|-----------|-----|--------|
| 4961 | Limit | 1204.57 | 1151.18 | 4.4% | pattern |
| 4965 | Nested Loop | 1168.24 | 1193.59 | 2.2% | operator |
| 4966 | Hash Join | 212.66 | 242.58 | 14.1% | pattern |
| 4970 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4969 | Seq Scan | 30.30 | 38.54 | 27.2% | operator |
...
- **Consumes:** Nodes 4961, 4962, 4963, 4964, 4967, 4968
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47747
  - HashJoin_nt1=237612
...
- **Output:** st=29.67, rt=242.58

### Step 3: Node 4970 (Index Scan) - LEAF
...
- **Output:** st=122.32, rt=1193.59

### Step 5: Node 4961 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4962, 4963, 4964, 4966, 4967, 4968
- **Input Features:**
