...
```
Node 14604 (Aggregate) - ROOT
  Node 14605 (Gather Merge)
    Node 14606 (Sort)
          ...
          Node 14609 (Hash Join)
            Node 14610 (Nested Loop)
              Node 14611 (Hash Join)
                ...
                Node 14613 (Hash)
                  Node 14614 (Hash Join)
                    Node 14615 (Seq Scan) - LEAF
                    Node 14616 (Hash)
                      Node 14617 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 14604 | Aggregate | 1233.79 | 1195.83 | 3.1% | operator |
| 14605 | Gather Merge | 1233.39 | 1097.19 | 11.0% | operator |
...
| 14611 | Hash Join | 214.13 | 251.17 | 17.3% | operator |
...
| 14613 | Hash | 36.58 | 20.62 | 43.6% | operator |
| 14614 | Hash Join | 35.86 | 132.26 | 268.8% | operator |
| 14615 | Seq Scan | 34.30 | 23.03 | 32.9% | operator |
| 14616 | Hash | 0.19 | 23.66 | 12220.9% | operator |
| 14617 | Hash Join | 0.19 | 306.84 | 163110.6% | operator |
...
### Step 5: Node 14615 (Seq Scan) - LEAF
...
### Step 8: Node 14612 (Seq Scan) - LEAF
...
### Step 11: Node 14621 (Index Scan) - LEAF
...
### Step 12: Node 14623 (Seq Scan) - LEAF
...
### Step 13: Node 14610 (Nested Loop)
...
### Step 16: Node 14624 (Index Scan) - LEAF
...
### Step 17: Node 14626 (Seq Scan) - LEAF
...
### Step 18: Node 14608 (Nested Loop)
...
### Step 22: Node 14605 (Gather Merge)
...
### Step 23: Node 14604 (Aggregate) - ROOT
