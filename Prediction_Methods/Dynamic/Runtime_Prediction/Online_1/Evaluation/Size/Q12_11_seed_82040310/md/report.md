...
**Test Query:** Q12_11_seed_82040310
...
```
Node 24467 (Aggregate) - ROOT
  Node 24468 (Gather Merge)
    Node 24469 (Aggregate)
      Node 24470 (Sort)
        Node 24471 (Nested Loop)
          Node 24472 (Seq Scan) - LEAF
          Node 24473 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24467 | Aggregate | 990.56 | 919.08 | 7.2% | operator |
| 24468 | Gather Merge | 990.55 | 1111.84 | 12.2% | operator |
| 24469 | Aggregate | 972.38 | 895.32 | 7.9% | operator |
| 24470 | Sort | 971.79 | 1092.80 | 12.5% | operator |
| 24471 | Nested Loop | 970.80 | 1127.41 | 16.1% | operator |
| 24472 | Seq Scan | 836.76 | 745.19 | 10.9% | operator |
| 24473 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24472 (Seq Scan) - LEAF
...
### Step 2: Node 24473 (Index Scan) - LEAF
...
### Step 6: Node 24468 (Gather Merge)
...
### Step 7: Node 24467 (Aggregate) - ROOT
