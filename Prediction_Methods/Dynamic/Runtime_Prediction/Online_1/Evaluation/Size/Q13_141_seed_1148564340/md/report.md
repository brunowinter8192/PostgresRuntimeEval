...
```
Node 25685 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25686 (Aggregate) [consumed]
    Node 25687 (Aggregate)
      Node 25688 (Hash Join) [PATTERN: 895c6e8c]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25685 | 25686, 25688, 25689, 25690 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25688 | 25685, 25686, 25689, 25690 |
...
|------|------|--------|-----------|-----|--------|
| 25685 | Sort | 894.23 | 1079.91 | 20.8% | pattern |
| 25687 | Aggregate | 888.13 | 998.54 | 12.4% | operator |
| 25688 | Hash Join | 680.98 | 470.31 | 30.9% | pattern |
| 25691 | Index Only Scan | 9.56 | 0.00 | 100.0% | operator |
...
### Step 2: Node 25688 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25685, 25686, 25689, 25690
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1469940
...
### Step 4: Node 25685 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25686, 25688, 25689, 25690
- **Input Features:**
