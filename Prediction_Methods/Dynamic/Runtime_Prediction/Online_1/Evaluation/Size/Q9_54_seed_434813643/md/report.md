...
```
Node 18444 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18445 (Aggregate) [consumed]
    Node 18446 (Gather)
      Node 18447 (Aggregate)
        Node 18448 (Nested Loop)
          Node 18449 (Hash Join) [PATTERN: bb930825]
            Node 18450 (Seq Scan) [consumed] - LEAF
            Node 18451 (Hash) [consumed]
              Node 18452 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18449 | 18444, 18445, 18450, 18451, 18452 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18444 | 18445, 18449, 18450, 18451, 18452 |
...
|------|------|--------|-----------|-----|--------|
| 18444 | Sort | 1190.41 | 1045.32 | 12.2% | pattern |
...
| 18449 | Hash Join | 972.32 | 134.80 | 86.1% | pattern |
...
### Step 9: Node 18449 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18444, 18445, 18450, 18451, 18452
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18461 (Index Scan) - LEAF
...
### Step 11: Node 18448 (Nested Loop)
...
### Step 14: Node 18444 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18445, 18449, 18450, 18451, 18452
- **Input Features:**
