...
**Test Query:** Q1_14_seed_106652403
...
```
Node 271 (Aggregate) - ROOT
  Node 272 (Gather Merge)
    Node 273 (Sort) [PATTERN: 1d35fb97]
      Node 274 (Aggregate) [consumed]
        Node 275 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 273 | 274 |
...
|------|------|--------|-----------|-----|--------|
| 271 | Aggregate | 988.90 | 1195.99 | 20.9% | operator |
| 272 | Gather Merge | 988.87 | 1165.94 | 17.9% | operator |
| 273 | Sort | 970.70 | 1200.90 | 23.7% | pattern |
| 275 | Seq Scan | 548.98 | 678.74 | 23.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 275 (Seq Scan) - LEAF
...
### Step 2: Node 273 (Sort) - PATTERN ROOT
...
### Step 4: Node 271 (Aggregate) - ROOT
