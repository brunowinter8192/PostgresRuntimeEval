...
**Test Query:** Q12_104_seed_845015193
...
```
Node 24348 (Aggregate) - ROOT
  Node 24349 (Gather Merge)
    Node 24350 (Aggregate)
      Node 24351 (Sort)
        Node 24352 (Nested Loop)
          Node 24353 (Seq Scan) - LEAF
          Node 24354 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24348 | Aggregate | 1006.92 | 919.06 | 8.7% | operator |
| 24349 | Gather Merge | 1006.89 | 1111.84 | 10.4% | operator |
| 24350 | Aggregate | 985.49 | 895.31 | 9.2% | operator |
| 24351 | Sort | 984.81 | 1092.81 | 11.0% | operator |
| 24352 | Nested Loop | 983.83 | 1127.41 | 14.6% | operator |
| 24353 | Seq Scan | 844.94 | 745.19 | 11.8% | operator |
| 24354 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24353 (Seq Scan) - LEAF
...
### Step 2: Node 24354 (Index Scan) - LEAF
...
### Step 6: Node 24349 (Gather Merge)
...
### Step 7: Node 24348 (Aggregate) - ROOT
