...
**Test Query:** Q10_95_seed_771178914
...
```
Node 21242 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 21243 (Sort) [consumed]
    Node 21244 (Aggregate) [consumed]
      Node 21245 (Gather) [consumed]
        Node 21246 (Hash Join)
          Node 21247 (Hash Join) [PATTERN: 2e0f44ef]
            Node 21248 (Nested Loop) [consumed]
              Node 21249 (Seq Scan) - LEAF
              Node 21250 (Index Scan) - LEAF
            Node 21251 (Hash) [consumed]
              Node 21252 (Seq Scan) - LEAF
          Node 21253 (Hash)
            Node 21254 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 21242 | 21243, 21244, 21245, 21247, 21248, 21251 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 21247 | 21242, 21243, 21244, 21245, 21248, 21251 |
...
|------|------|--------|-----------|-----|--------|
| 21242 | Limit | 1117.26 | 1199.47 | 7.4% | pattern |
| 21246 | Hash Join | 1071.64 | 1095.57 | 2.2% | operator |
| 21247 | Hash Join | 1068.75 | 1120.19 | 4.8% | pattern |
| 21253 | Hash | 0.01 | 15.71 | 104638.5% | operator |
| 21254 | Seq Scan | 0.01 | 6.98 | 58055.9% | operator |
| 21249 | Seq Scan | 160.16 | 159.74 | 0.3% | operator |
| 21250 | Index Scan | 0.06 | -0.52 | 963.7% | operator |
| 21252 | Seq Scan | 22.65 | 26.64 | 17.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 21249 (Seq Scan) - LEAF
...
### Step 2: Node 21250 (Index Scan) - LEAF
...
### Step 3: Node 21252 (Seq Scan) - LEAF
...
### Step 4: Node 21254 (Seq Scan) - LEAF
...
### Step 5: Node 21247 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 21242, 21243, 21244, 21245, 21248, 21251
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18240
  - HashJoin_nt1=18240
...
### Step 8: Node 21242 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 21243, 21244, 21245, 21247, 21248, 21251
- **Input Features:**
