...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19370 | 19371, 19372, 19373 |
...
| 19374 | Hash Join | 1070.51 | 1007.14 | 5.9% | operator |
| 19375 | Hash Join | 1067.56 | 1004.00 | 6.0% | operator |
| 19381 | Hash | 0.01 | 15.71 | 130823.1% | operator |
| 19376 | Nested Loop | 1025.86 | 1204.86 | 17.4% | operator |
| 19379 | Hash | 31.44 | 55.57 | 76.8% | operator |
...
### Step 6: Node 19382 (Seq Scan) - LEAF
...
### Step 10: Node 19370 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19371, 19372, 19373
- **Input Features:**
