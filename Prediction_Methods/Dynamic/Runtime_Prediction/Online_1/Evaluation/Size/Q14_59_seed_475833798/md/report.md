...
```
Node 27148 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27149 (Gather) [consumed]
    Node 27150 (Aggregate) [consumed]
      Node 27151 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27148 | 27149, 27150, 27151 |
...
|------|------|--------|-----------|-----|--------|
| 27148 | Aggregate | 825.14 | 857.12 | 3.9% | pattern |
...
### Step 4: Node 27148 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27149, 27150, 27151
- **Input Features:**
