        ...
        Node 29368 (Incremental Sort)
          Node 29369 (Nested Loop)
            Node 29370 (Merge Join)
              Node 29371 (Sort)
                Node 29372 (Hash Join)
                  Node 29373 (Seq Scan) - LEAF
                  Node 29374 (Hash)
...
| 29371 | Sort | 2870.22 | 1099.77 | 61.7% | operator |
| 29377 | Sort | 65.25 | 1074.66 | 1546.9% | operator |
| 29372 | Hash Join | 2870.21 | 686.33 | 76.1% | operator |
| 29378 | Seq Scan | 53.40 | 18.25 | 65.8% | operator |
| 29373 | Seq Scan | 197.67 | 170.37 | 13.8% | operator |
| 29374 | Hash | 2643.56 | 21.04 | 99.2% | operator |
...
### Step 3: Node 29373 (Seq Scan) - LEAF
...
### Step 6: Node 29378 (Seq Scan) - LEAF
...
### Step 9: Node 29370 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29379 (Index Scan) - LEAF
...
### Step 11: Node 29369 (Nested Loop)
...
### Step 12: Node 29368 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29367 (Gather Merge)
