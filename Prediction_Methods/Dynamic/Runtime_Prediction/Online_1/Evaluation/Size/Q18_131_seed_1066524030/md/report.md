...
**Test Query:** Q18_131_seed_1066524030
...
```
Node 29364 (Limit) - ROOT
  Node 29365 (Sort)
    Node 29366 (Aggregate)
      Node 29367 (Gather Merge)
        Node 29368 (Incremental Sort)
          Node 29369 (Nested Loop)
            Node 29370 (Merge Join)
              Node 29371 (Sort)
                Node 29372 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29373 (Seq Scan) [consumed] - LEAF
                  Node 29374 (Hash) [consumed]
                    Node 29375 (Aggregate)
                      Node 29376 (Index Scan) - LEAF
              Node 29377 (Sort)
                Node 29378 (Seq Scan) - LEAF
            Node 29379 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29372 | 29373, 29374 |
...
|------|------|--------|-----------|-----|--------|
| 29364 | Limit | 3082.55 | 1175.21 | 61.9% | operator |
| 29365 | Sort | 2960.90 | 1127.81 | 61.9% | operator |
| 29366 | Aggregate | 2960.86 | 1073.15 | 63.8% | operator |
| 29367 | Gather Merge | 2960.85 | 1073.95 | 63.7% | operator |
| 29368 | Incremental Sort | 2938.63 | 0.00 | 100.0% | operator |
| 29369 | Nested Loop | 2938.59 | 1111.34 | 62.2% | operator |
| 29370 | Merge Join | 2938.52 | 0.00 | 100.0% | operator |
| 29379 | Index Scan | 0.02 | 0.05 | 96.2% | operator |
| 29371 | Sort | 2870.22 | 1095.58 | 61.8% | operator |
| 29377 | Sort | 65.25 | 1074.66 | 1546.9% | operator |
| 29372 | Hash Join | 2870.21 | 471.07 | 83.6% | pattern |
| 29378 | Seq Scan | 53.40 | 18.25 | 65.8% | operator |
| 29375 | Aggregate | 2643.51 | 1073.15 | 59.4% | operator |
| 29376 | Index Scan | 2148.70 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29376 (Index Scan) - LEAF
...
### Step 3: Node 29372 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29373, 29374
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29378 (Seq Scan) - LEAF
...
### Step 7: Node 29370 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29379 (Index Scan) - LEAF
...
### Step 10: Node 29368 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29367 (Gather Merge)
