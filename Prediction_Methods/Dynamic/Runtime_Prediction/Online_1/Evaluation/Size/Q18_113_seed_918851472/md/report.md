...
**Test Query:** Q18_113_seed_918851472
...
```
Node 29044 (Limit) - ROOT
  Node 29045 (Sort)
    Node 29046 (Aggregate)
      Node 29047 (Gather Merge)
        Node 29048 (Incremental Sort)
          Node 29049 (Nested Loop)
            Node 29050 (Merge Join)
              Node 29051 (Sort)
                Node 29052 (Hash Join)
                  Node 29053 (Seq Scan) - LEAF
                  Node 29054 (Hash)
                    Node 29055 (Aggregate)
                      Node 29056 (Index Scan) - LEAF
              Node 29057 (Sort)
                Node 29058 (Seq Scan) - LEAF
            Node 29059 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 29044 | Limit | 3069.95 | 1175.21 | 61.7% | operator |
| 29045 | Sort | 2953.83 | 1127.81 | 61.8% | operator |
| 29046 | Aggregate | 2953.78 | 1073.15 | 63.7% | operator |
| 29047 | Gather Merge | 2953.76 | 1073.95 | 63.6% | operator |
| 29048 | Incremental Sort | 2919.61 | 0.00 | 100.0% | operator |
| 29049 | Nested Loop | 2919.56 | 1111.34 | 61.9% | operator |
| 29050 | Merge Join | 2919.51 | 0.00 | 100.0% | operator |
| 29059 | Index Scan | 0.02 | 0.05 | 137.6% | operator |
| 29051 | Sort | 2867.80 | 1099.77 | 61.7% | operator |
| 29057 | Sort | 66.10 | 1074.66 | 1525.8% | operator |
| 29052 | Hash Join | 2867.79 | 686.33 | 76.1% | operator |
| 29058 | Seq Scan | 54.50 | 18.25 | 66.5% | operator |
| 29053 | Seq Scan | 190.34 | 170.37 | 10.5% | operator |
| 29054 | Hash | 2646.28 | 21.04 | 99.2% | operator |
| 29055 | Aggregate | 2646.25 | 1073.15 | 59.4% | operator |
| 29056 | Index Scan | 2137.42 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29056 (Index Scan) - LEAF
...
### Step 3: Node 29053 (Seq Scan) - LEAF
...
### Step 6: Node 29058 (Seq Scan) - LEAF
...
### Step 9: Node 29050 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29059 (Index Scan) - LEAF
...
### Step 11: Node 29049 (Nested Loop)
...
### Step 12: Node 29048 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29047 (Gather Merge)
