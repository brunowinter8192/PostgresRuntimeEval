        ...
        Node 29048 (Incremental Sort)
          Node 29049 (Nested Loop)
            Node 29050 (Merge Join)
              Node 29051 (Sort)
                Node 29052 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29053 (Seq Scan) [consumed] - LEAF
                  Node 29054 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29052 | 29053, 29054 |
...
| 29051 | Sort | 2867.80 | 1095.58 | 61.8% | operator |
| 29057 | Sort | 66.10 | 1074.66 | 1525.8% | operator |
| 29052 | Hash Join | 2867.79 | 471.07 | 83.6% | pattern |
...
### Step 3: Node 29052 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29053, 29054
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29058 (Seq Scan) - LEAF
...
### Step 7: Node 29050 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29059 (Index Scan) - LEAF
...
### Step 10: Node 29048 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29047 (Gather Merge)
