...
Node 476 (Aggregate) - ROOT
  Node 477 (Gather Merge)
    Node 478 (Sort) [PATTERN: 1d35fb97]
      Node 479 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 478 | 479 |
...
|------|------|--------|-----------|-----|--------|
| 476 | Aggregate | 933.64 | 1195.90 | 28.1% | operator |
| 477 | Gather Merge | 933.59 | 1165.91 | 24.9% | operator |
| 478 | Sort | 914.02 | 1200.57 | 31.4% | pattern |
...
### Step 2: Node 478 (Sort) - PATTERN ROOT
...
### Step 4: Node 476 (Aggregate) - ROOT
