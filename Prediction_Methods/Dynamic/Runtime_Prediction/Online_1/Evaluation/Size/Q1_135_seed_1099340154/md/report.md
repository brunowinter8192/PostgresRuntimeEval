...
**Test Query:** Q1_135_seed_1099340154
...
```
Node 191 (Aggregate) - ROOT
  Node 192 (Gather Merge)
    Node 193 (Sort) [PATTERN: 1d35fb97]
      Node 194 (Aggregate) [consumed]
        Node 195 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 193 | 194 |
...
|------|------|--------|-----------|-----|--------|
| 191 | Aggregate | 892.93 | 1195.97 | 33.9% | operator |
| 192 | Gather Merge | 892.87 | 1165.93 | 30.6% | operator |
| 193 | Sort | 871.91 | 1200.82 | 37.7% | pattern |
| 195 | Seq Scan | 470.29 | 679.07 | 44.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 195 (Seq Scan) - LEAF
...
- **Output:** st=0.85, rt=679.07

### Step 2: Node 193 (Sort) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=169176.4300
  - Sort_total_cost=169176.4400
- **Output:** st=1196.72, rt=1200.82

### Step 3: Node 192 (Gather Merge)
...
### Step 4: Node 191 (Aggregate) - ROOT
