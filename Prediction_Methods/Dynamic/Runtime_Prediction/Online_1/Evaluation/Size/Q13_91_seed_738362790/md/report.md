...
**Test Query:** Q13_91_seed_738362790
...
```
Node 26350 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26351 (Aggregate) [consumed]
    Node 26352 (Aggregate)
      Node 26353 (Hash Join) [PATTERN: 895c6e8c]
        Node 26354 (Seq Scan) [consumed] - LEAF
        Node 26355 (Hash) [consumed]
          Node 26356 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26350 | 26351, 26353, 26354, 26355 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26353 | 26350, 26351, 26354, 26355 |
...
|------|------|--------|-----------|-----|--------|
| 26350 | Sort | 942.20 | 1079.94 | 14.6% | pattern |
| 26352 | Aggregate | 936.00 | 999.76 | 6.8% | operator |
| 26353 | Hash Join | 722.15 | 470.31 | 34.9% | pattern |
| 26356 | Index Only Scan | 9.98 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26356 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26353 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26350, 26351, 26354, 26355
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 26350 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26351, 26353, 26354, 26355
- **Input Features:**
