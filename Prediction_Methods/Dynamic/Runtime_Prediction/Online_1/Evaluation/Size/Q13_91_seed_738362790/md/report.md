...
```
Node 26350 (Sort) - ROOT
  Node 26351 (Aggregate)
    Node 26352 (Aggregate)
      Node 26353 (Hash Join)
        Node 26354 (Seq Scan) - LEAF
        Node 26355 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 26350 | Sort | 942.20 | 1081.93 | 14.8% | operator |
| 26351 | Aggregate | 942.18 | 1000.33 | 6.2% | operator |
| 26352 | Aggregate | 936.00 | 1014.39 | 8.4% | operator |
| 26353 | Hash Join | 722.15 | 787.83 | 9.1% | operator |
| 26354 | Seq Scan | 506.03 | 264.19 | 47.8% | operator |
| 26355 | Hash | 15.27 | 80.15 | 424.8% | operator |
...
### Step 2: Node 26354 (Seq Scan) - LEAF
