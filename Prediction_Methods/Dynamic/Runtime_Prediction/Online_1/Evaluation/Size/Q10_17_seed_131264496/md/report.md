...
**Test Query:** Q10_17_seed_131264496
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20124 | 20125, 20126, 20127, 20129, 20130, 20133 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 20129 | 20124, 20125, 20126, 20127, 20130, 20133 |
...
|------|------|--------|-----------|-----|--------|
| 20124 | Limit | 1137.67 | 1199.47 | 5.4% | pattern |
| 20128 | Hash Join | 1075.79 | 1095.58 | 1.8% | operator |
| 20129 | Hash Join | 1072.86 | 1120.19 | 4.4% | pattern |
| 20135 | Hash | 0.02 | 15.71 | 98092.3% | operator |
| 20136 | Seq Scan | 0.01 | 6.98 | 63342.8% | operator |
| 20131 | Seq Scan | 163.50 | 159.74 | 2.3% | operator |
| 20132 | Index Scan | 0.06 | -0.52 | 963.7% | operator |
| 20134 | Seq Scan | 28.13 | 26.64 | 5.3% | operator |
...
### Step 4: Node 20136 (Seq Scan) - LEAF
...
- **Consumes:** Nodes 20124, 20125, 20126, 20127, 20130, 20133
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18276
  - HashJoin_nt1=18276
...
### Step 8: Node 20124 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20125, 20126, 20127, 20129, 20130, 20133
- **Input Features:**
