    ...
    Node 20126 (Aggregate) [consumed]
      Node 20127 (Gather) [consumed]
        Node 20128 (Hash Join)
          Node 20129 (Hash Join)
            Node 20130 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20124 | 20125, 20126, 20127 |
...
| 20128 | Hash Join | 1075.79 | 1007.12 | 6.4% | operator |
| 20129 | Hash Join | 1072.86 | 1003.97 | 6.4% | operator |
| 20135 | Hash | 0.02 | 15.71 | 98092.3% | operator |
| 20130 | Nested Loop | 1027.28 | 1204.87 | 17.3% | operator |
| 20133 | Hash | 34.92 | 55.57 | 59.2% | operator |
...
### Step 6: Node 20136 (Seq Scan) - LEAF
...
### Step 10: Node 20124 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20125, 20126, 20127
- **Input Features:**
