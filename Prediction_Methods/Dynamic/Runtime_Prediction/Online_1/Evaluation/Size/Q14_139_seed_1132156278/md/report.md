...
```
Node 26714 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26715 (Gather) [consumed]
    Node 26716 (Aggregate) [consumed]
      Node 26717 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26714 | 26715, 26716, 26717 |
...
|------|------|--------|-----------|-----|--------|
| 26714 | Aggregate | 807.60 | 857.12 | 6.1% | pattern |
...
### Step 4: Node 26714 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26715, 26716, 26717
- **Input Features:**
