...
**Test Query:** Q18_147_seed_1197788526
**Timestamp:** 2026-01-18 20:21:42
...
```
Node 29636 (Limit) - ROOT
  Node 29637 (Sort)
    Node 29638 (Aggregate)
      Node 29639 (Gather Merge)
        Node 29640 (Incremental Sort)
          Node 29641 (Nested Loop)
            Node 29642 (Merge Join)
              Node 29643 (Sort)
                Node 29644 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29645 (Seq Scan) [consumed] - LEAF
                  Node 29646 (Hash) [consumed]
                    Node 29647 (Aggregate)
                      Node 29648 (Index Scan) - LEAF
              Node 29649 (Sort)
                Node 29650 (Seq Scan) - LEAF
            Node 29651 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29644 | 29645, 29646 |
...
|------|------|--------|-----------|-----|--------|
| 29636 | Limit | 3058.13 | 1175.21 | 61.6% | operator |
| 29637 | Sort | 2942.10 | 1127.81 | 61.7% | operator |
| 29638 | Aggregate | 2942.06 | 1073.15 | 63.5% | operator |
| 29639 | Gather Merge | 2942.04 | 1073.95 | 63.5% | operator |
| 29640 | Incremental Sort | 2921.23 | 0.00 | 100.0% | operator |
| 29641 | Nested Loop | 2921.18 | 1111.34 | 62.0% | operator |
| 29642 | Merge Join | 2921.12 | 0.00 | 100.0% | operator |
| 29651 | Index Scan | 0.02 | 0.05 | 125.7% | operator |
| 29643 | Sort | 2848.46 | 1095.58 | 61.5% | operator |
| 29649 | Sort | 68.77 | 1074.66 | 1462.7% | operator |
| 29644 | Hash Join | 2848.45 | 471.07 | 83.5% | pattern |
| 29650 | Seq Scan | 54.11 | 18.25 | 66.3% | operator |
| 29647 | Aggregate | 2622.68 | 1073.15 | 59.1% | operator |
| 29648 | Index Scan | 2119.98 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29648 (Index Scan) - LEAF
...
### Step 3: Node 29644 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29645, 29646
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29650 (Seq Scan) - LEAF
...
### Step 7: Node 29642 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29651 (Index Scan) - LEAF
...
### Step 10: Node 29640 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29639 (Gather Merge)
