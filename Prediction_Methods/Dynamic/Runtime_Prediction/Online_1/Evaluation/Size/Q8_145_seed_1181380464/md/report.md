...
```
Node 14328 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 14329 (Gather Merge) [consumed]
    Node 14330 (Sort)
          ...
          Node 14333 (Hash Join)
            Node 14334 (Nested Loop)
              Node 14335 (Hash Join)
                ...
                Node 14337 (Hash) [PATTERN: 444761fb]
                  Node 14338 (Hash Join) [consumed]
                    Node 14339 (Seq Scan) [consumed] - LEAF
                    Node 14340 (Hash) [consumed]
                      Node 14341 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 14337 | 14328, 14329, 14338, 14339, 14340, 14341 |
| Aggregate -> Gather Merge (Out | 2724c080 | 14328 | 14329, 14337, 14338, 14339, 14340, 14341 |
...
|------|------|--------|-----------|-----|--------|
| 14328 | Aggregate | 1225.59 | 1132.83 | 7.6% | pattern |
...
| 14335 | Hash Join | 208.31 | 251.67 | 20.8% | operator |
...
| 14337 | Hash | 31.52 | 43.51 | 38.1% | pattern |
...
### Step 4: Node 14336 (Seq Scan) - LEAF
...
### Step 5: Node 14337 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 14328, 14329, 14338, 14339, 14340, 14341
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 14345 (Index Scan) - LEAF
...
### Step 8: Node 14347 (Seq Scan) - LEAF
...
### Step 12: Node 14348 (Index Scan) - LEAF
...
### Step 13: Node 14350 (Seq Scan) - LEAF
...
### Step 14: Node 14332 (Nested Loop)
...
### Step 18: Node 14328 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 14329, 14337, 14338, 14339, 14340, 14341
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2422
