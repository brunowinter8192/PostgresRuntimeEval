...
**Test Query:** Q6_78_seed_631710387
...
```
Node 10401 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10402 (Gather) [consumed]
    Node 10403 (Aggregate) [consumed]
      Node 10404 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10401 | 10402, 10403 |
...
|------|------|--------|-----------|-----|--------|
| 10401 | Aggregate | 772.10 | 849.98 | 10.1% | pattern |
| 10404 | Seq Scan | 752.39 | 748.49 | 0.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10404 (Seq Scan) - LEAF
...
### Step 2: Node 10401 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10402, 10403
- **Input Features:**
