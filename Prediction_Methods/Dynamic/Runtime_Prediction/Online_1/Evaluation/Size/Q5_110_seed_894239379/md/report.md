...
|------|------|--------|-----------|-----|--------|
| 7121 | Sort | 1060.77 | 1098.95 | 3.6% | operator |
| 7122 | Aggregate | 1060.76 | 1032.62 | 2.7% | operator |
| 7123 | Gather Merge | 1060.75 | 1133.60 | 6.9% | operator |
| 7124 | Aggregate | 1056.39 | 985.96 | 6.7% | operator |
| 7125 | Sort | 1056.14 | 1068.16 | 1.1% | operator |
| 7126 | Hash Join | 1055.67 | 1131.95 | 7.2% | operator |
| 7127 | Nested Loop | 1041.34 | 1188.39 | 14.1% | operator |
| 7139 | Hash | 6.30 | 18.67 | 196.4% | operator |
| 7128 | Hash Join | 212.21 | 252.47 | 19.0% | operator |
| 7138 | Index Scan | 0.07 | -0.22 | 401.4% | operator |
| 7140 | Seq Scan | 5.79 | 12.36 | 113.5% | operator |
| 7129 | Seq Scan | 168.34 | 159.81 | 5.1% | operator |
| 7130 | Hash | 31.31 | 22.67 | 27.6% | operator |
| 7131 | Hash Join | 30.62 | 102.01 | 233.2% | operator |
| 7132 | Seq Scan | 29.19 | 24.28 | 16.8% | operator |
| 7133 | Hash | 0.07 | 21.93 | 29536.0% | operator |
| 7134 | Hash Join | 0.07 | 284.32 | 400355.4% | operator |
...
### Step 5: Node 7132 (Seq Scan) - LEAF
...
### Step 8: Node 7129 (Seq Scan) - LEAF
...
### Step 11: Node 7138 (Index Scan) - LEAF
...
### Step 12: Node 7140 (Seq Scan) - LEAF
...
- **Output:** st=100.23, rt=1188.39

### Step 14: Node 7139 (Hash)
...
- **Output:** st=100.35, rt=1131.95

### Step 16: Node 7125 (Sort)
...
- **Output:** st=976.32, rt=985.96

### Step 18: Node 7123 (Gather Merge)
...
- **Output:** st=1130.55, rt=1133.60

### Step 19: Node 7122 (Aggregate)
...
- **Output:** st=1048.72, rt=1032.62

### Step 20: Node 7121 (Sort) - ROOT
