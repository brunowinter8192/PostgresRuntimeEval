...
**Test Query:** Q5_110_seed_894239379
**Timestamp:** 2026-01-18 16:42:53
...
```
Node 7121 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 7122 (Aggregate) [consumed]
    Node 7123 (Gather Merge) [consumed]
      Node 7124 (Aggregate)
        Node 7125 (Sort) [PATTERN: 3e2d5a00]
          Node 7126 (Hash Join) [consumed]
            Node 7127 (Nested Loop)
              Node 7128 (Hash Join)
                Node 7129 (Seq Scan) - LEAF
                Node 7130 (Hash) [PATTERN: 444761fb]
                  Node 7131 (Hash Join) [consumed]
                    Node 7132 (Seq Scan) [consumed] - LEAF
                    Node 7133 (Hash) [consumed]
                      Node 7134 (Hash Join) [consumed]
                        Node 7135 (Seq Scan) - LEAF
                        Node 7136 (Hash)
                          Node 7137 (Seq Scan) - LEAF
              Node 7138 (Index Scan) - LEAF
            Node 7139 (Hash)
              Node 7140 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 7130 | 7121, 7122, 7123, 7125, 7126, 7131, 7132, 7133, 7134 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 7121 | 7122, 7123, 7125, 7126, 7130, 7131, 7132, 7133, 7134 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 7125 | 7121, 7122, 7123, 7126, 7130, 7131, 7132, 7133, 7134 |
...
|------|------|--------|-----------|-----|--------|
| 7121 | Sort | 1060.77 | 2934.42 | 176.6% | pattern |
| 7124 | Aggregate | 1056.39 | 1128.78 | 6.9% | operator |
| 7125 | Sort | 1056.14 | 1835.91 | 73.8% | pattern |
| 7127 | Nested Loop | 1041.34 | 1188.39 | 14.1% | operator |
| 7139 | Hash | 6.30 | 18.67 | 196.4% | operator |
| 7128 | Hash Join | 212.21 | 253.07 | 19.3% | operator |
| 7138 | Index Scan | 0.07 | -0.22 | 401.4% | operator |
| 7140 | Seq Scan | 5.79 | 12.36 | 113.5% | operator |
| 7129 | Seq Scan | 168.34 | 159.81 | 5.1% | operator |
| 7130 | Hash | 31.31 | 46.85 | 49.6% | pattern |
| 7135 | Seq Scan | 0.01 | 11.81 | 147503.4% | operator |
| 7136 | Hash | 0.06 | 21.05 | 37495.1% | operator |
| 7137 | Seq Scan | 0.05 | 22.93 | 42369.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 7137 (Seq Scan) - LEAF
...
### Step 2: Node 7135 (Seq Scan) - LEAF
...
### Step 4: Node 7129 (Seq Scan) - LEAF
...
### Step 5: Node 7130 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 7121, 7122, 7123, 7125, 7126, 7131, 7132, 7133, 7134
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 7138 (Index Scan) - LEAF
...
### Step 8: Node 7140 (Seq Scan) - LEAF
...
### Step 11: Node 7125 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 7121, 7122, 7123, 7126, 7130, 7131, 7132, 7133, 7134
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 7121 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 7122, 7123, 7125, 7126, 7130, 7131, 7132, 7133, 7134
- **Input Features:**
