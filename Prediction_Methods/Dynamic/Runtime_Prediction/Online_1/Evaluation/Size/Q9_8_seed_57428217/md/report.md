...
```
Node 19153 (Sort) - ROOT
  Node 19154 (Aggregate)
    Node 19155 (Gather)
      Node 19156 (Aggregate)
        Node 19157 (Nested Loop)
          Node 19158 (Hash Join)
            Node 19159 (Seq Scan) - LEAF
            Node 19160 (Hash)
              Node 19161 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 19153 | Sort | 1193.98 | 1118.92 | 6.3% | operator |
| 19154 | Aggregate | 1193.84 | 896.90 | 24.9% | operator |
...
| 19158 | Hash Join | 974.09 | 632.96 | 35.0% | operator |
| 19170 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 19159 | Seq Scan | 697.27 | 509.93 | 26.9% | operator |
| 19160 | Hash | 181.69 | 47.68 | 73.8% | operator |
| 19161 | Hash Join | 179.42 | 924.32 | 415.2% | operator |
...
### Step 10: Node 19159 (Seq Scan) - LEAF
...
### Step 13: Node 19170 (Index Scan) - LEAF
...
### Step 14: Node 19157 (Nested Loop)
