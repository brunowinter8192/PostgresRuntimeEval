...
```
Node 19153 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 19154 (Aggregate) [consumed]
    Node 19155 (Gather)
      Node 19156 (Aggregate)
        Node 19157 (Nested Loop)
          Node 19158 (Hash Join) [PATTERN: bb930825]
            Node 19159 (Seq Scan) [consumed] - LEAF
            Node 19160 (Hash) [consumed]
              Node 19161 (Hash Join) [consumed]
                Node 19162 (Hash Join)
                  Node 19163 (Nested Loop)
                    Node 19164 (Seq Scan) - LEAF
                    Node 19165 (Index Scan) - LEAF
                  Node 19166 (Hash)
                    Node 19167 (Seq Scan) - LEAF
                Node 19168 (Hash)
                  Node 19169 (Seq Scan) - LEAF
          Node 19170 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 19158 | 19153, 19154, 19159, 19160, 19161 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 19153 | 19154, 19158, 19159, 19160, 19161 |
...
|------|------|--------|-----------|-----|--------|
| 19153 | Sort | 1193.98 | 1044.79 | 12.5% | pattern |
| 19155 | Gather | 1192.62 | 964.87 | 19.1% | operator |
| 19156 | Aggregate | 1173.46 | 1117.47 | 4.8% | operator |
| 19157 | Nested Loop | 1148.08 | 1252.17 | 9.1% | operator |
| 19158 | Hash Join | 974.09 | 134.80 | 86.2% | pattern |
| 19170 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 19162 | Hash Join | 165.27 | 837.55 | 406.8% | operator |
| 19168 | Hash | 13.52 | 14.95 | 10.5% | operator |
| 19163 | Nested Loop | 158.17 | 1251.76 | 691.4% | operator |
| 19166 | Hash | 4.65 | 15.94 | 243.1% | operator |
| 19169 | Seq Scan | 13.51 | 2.94 | 78.3% | operator |
| 19164 | Seq Scan | 19.38 | 44.17 | 127.9% | operator |
| 19165 | Index Scan | 0.08 | -1.39 | 1926.9% | operator |
| 19167 | Seq Scan | 4.05 | 9.45 | 133.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 19164 (Seq Scan) - LEAF
...
### Step 2: Node 19165 (Index Scan) - LEAF
...
### Step 3: Node 19167 (Seq Scan) - LEAF
...
### Step 6: Node 19169 (Seq Scan) - LEAF
...
### Step 9: Node 19158 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 19153, 19154, 19159, 19160, 19161
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 19170 (Index Scan) - LEAF
...
### Step 11: Node 19157 (Nested Loop)
...
### Step 14: Node 19153 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 19154, 19158, 19159, 19160, 19161
- **Input Features:**
