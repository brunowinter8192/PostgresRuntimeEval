...
```
Node 27218 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27219 (Gather) [consumed]
    Node 27220 (Aggregate) [consumed]
      Node 27221 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27218 | 27219, 27220, 27221 |
...
|------|------|--------|-----------|-----|--------|
| 27218 | Aggregate | 821.30 | 857.11 | 4.4% | pattern |
...
### Step 4: Node 27218 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27219, 27220, 27221
- **Input Features:**
