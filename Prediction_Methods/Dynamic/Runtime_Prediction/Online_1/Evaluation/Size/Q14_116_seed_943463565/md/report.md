...
**Test Query:** Q14_116_seed_943463565
...
```
Node 26539 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26540 (Gather) [consumed]
    Node 26541 (Aggregate) [consumed]
      Node 26542 (Hash Join) [consumed]
        Node 26543 (Seq Scan) - LEAF
        Node 26544 (Hash)
          Node 26545 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26539 | 26540, 26541, 26542 |
...
|------|------|--------|-----------|-----|--------|
| 26539 | Aggregate | 828.14 | 857.13 | 3.5% | pattern |
| 26543 | Seq Scan | 756.04 | 758.49 | 0.3% | operator |
| 26544 | Hash | 41.74 | 9.38 | 77.5% | operator |
| 26545 | Seq Scan | 36.54 | 12.70 | 65.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26545 (Seq Scan) - LEAF
...
### Step 2: Node 26543 (Seq Scan) - LEAF
...
### Step 4: Node 26539 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26540, 26541, 26542
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=15403
  - HashJoin_Outer_nt1=15403
  ...
  - HashJoin_Outer_total_cost=136647.0700
