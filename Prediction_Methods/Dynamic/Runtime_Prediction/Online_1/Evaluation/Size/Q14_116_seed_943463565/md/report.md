...
```
Node 26539 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26540 (Gather) [consumed]
    Node 26541 (Aggregate) [consumed]
      Node 26542 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26539 | 26540, 26541 |
...
|------|------|--------|-----------|-----|--------|
| 26539 | Aggregate | 828.14 | 848.37 | 2.4% | pattern |
| 26542 | Hash Join | 805.82 | 807.65 | 0.2% | operator |
...
### Step 5: Node 26539 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26540, 26541
- **Input Features:**
