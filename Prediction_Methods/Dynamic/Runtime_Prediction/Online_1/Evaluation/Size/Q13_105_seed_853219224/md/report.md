...
```
Node 25405 (Sort) - ROOT
  Node 25406 (Aggregate)
    Node 25407 (Aggregate)
      Node 25408 (Hash Join)
        Node 25409 (Seq Scan) - LEAF
        Node 25410 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 25405 | Sort | 909.25 | 1081.93 | 19.0% | operator |
| 25406 | Aggregate | 909.23 | 1000.37 | 10.0% | operator |
| 25407 | Aggregate | 903.10 | 1013.56 | 12.2% | operator |
| 25408 | Hash Join | 686.15 | 787.83 | 14.8% | operator |
| 25409 | Seq Scan | 470.03 | 263.89 | 43.9% | operator |
| 25410 | Hash | 16.32 | 80.15 | 391.1% | operator |
...
### Step 2: Node 25409 (Seq Scan) - LEAF
