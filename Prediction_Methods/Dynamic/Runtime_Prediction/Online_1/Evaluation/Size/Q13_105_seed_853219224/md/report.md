...
**Test Query:** Q13_105_seed_853219224
...
```
Node 25405 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25406 (Aggregate) [consumed]
    Node 25407 (Aggregate)
      Node 25408 (Hash Join) [PATTERN: 895c6e8c]
        Node 25409 (Seq Scan) [consumed] - LEAF
        Node 25410 (Hash) [consumed]
          Node 25411 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25405 | 25406, 25408, 25409, 25410 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25408 | 25405, 25406, 25409, 25410 |
...
|------|------|--------|-----------|-----|--------|
| 25405 | Sort | 909.25 | 1079.92 | 18.8% | pattern |
| 25407 | Aggregate | 903.10 | 998.94 | 10.6% | operator |
| 25408 | Hash Join | 686.15 | 470.31 | 31.5% | pattern |
| 25411 | Index Only Scan | 10.62 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25411 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25408 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25405, 25406, 25409, 25410
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1475952
...
### Step 4: Node 25405 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25406, 25408, 25409, 25410
- **Input Features:**
