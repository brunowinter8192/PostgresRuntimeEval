...
**Test Query:** Q7_126_seed_1025503875
...
```
Node 11005 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 11006 (Gather Merge) [consumed]
    Node 11007 (Sort)
      Node 11008 (Hash Join)
        Node 11009 (Nested Loop)
          Node 11010 (Hash Join) [PATTERN: 895c6e8c]
            Node 11011 (Seq Scan) [consumed] - LEAF
            Node 11012 (Hash) [consumed]
              Node 11013 (Hash Join) [PATTERN: f4cb205a]
                Node 11014 (Seq Scan) [consumed] - LEAF
                Node 11015 (Hash) [consumed]
                  Node 11016 (Seq Scan) [consumed] - LEAF
          Node 11017 (Index Scan) - LEAF
        Node 11018 (Hash)
          Node 11019 (Hash Join) [PATTERN: f4cb205a]
            Node 11020 (Seq Scan) [consumed] - LEAF
            Node 11021 (Hash) [consumed]
              Node 11022 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 11013 | 11005, 11006, 11010, 11011, 11012, 11014, 11015, 11016, 11019, 11020, 11021, 11022 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 11019 | 11005, 11006, 11010, 11011, 11012, 11013, 11014, 11015, 11016, 11020, 11021, 11022 |
| Aggregate -> Gather Merge (Out | 2724c080 | 11005 | 11006, 11010, 11011, 11012, 11013, 11014, 11015, 11016, 11019, 11020, 11021, 11022 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 11010 | 11005, 11006, 11011, 11012, 11013, 11014, 11015, 11016, 11019, 11020, 11021, 11022 |
...
|------|------|--------|-----------|-----|--------|
| 11005 | Aggregate | 1214.59 | 1163.13 | 4.2% | pattern |
| 11007 | Sort | 1206.86 | 1109.16 | 8.1% | operator |
| 11008 | Hash Join | 1206.20 | 843.11 | 30.1% | operator |
| 11009 | Nested Loop | 1199.34 | 1215.99 | 1.4% | operator |
| 11018 | Hash | 2.91 | 27.74 | 853.4% | operator |
| 11010 | Hash Join | 218.57 | 304.89 | 39.5% | pattern |
| 11017 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 11019 | Hash Join | 2.86 | 429.36 | 14902.2% | pattern |
| 11013 | Hash Join | 36.29 | 429.38 | 1083.2% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11013 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 11005, 11006, 11010, 11011, 11012, 11014, 11015, 11016, 11019, 11020, 11021, 11022
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5000
  - HashJoin_nt1=62500
...
### Step 2: Node 11010 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 11005, 11006, 11011, 11012, 11013, 11014, 11015, 11016, 11019, 11020, 11021, 11022
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=38710
  - HashJoin_nt1=483871
...
### Step 3: Node 11017 (Index Scan) - LEAF
...
### Step 4: Node 11019 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 11005, 11006, 11010, 11011, 11012, 11013, 11014, 11015, 11016, 11020, 11021, 11022
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=800
  - HashJoin_nt1=10000
...
### Step 9: Node 11005 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 11006, 11010, 11011, 11012, 11013, 11014, 11015, 11016, 11019, 11020, 11021, 11022
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
