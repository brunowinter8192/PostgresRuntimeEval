...
```
Node 27043 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27044 (Gather) [consumed]
    Node 27045 (Aggregate) [consumed]
      Node 27046 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27043 | 27044, 27045, 27046 |
...
|------|------|--------|-----------|-----|--------|
| 27043 | Aggregate | 841.15 | 857.12 | 1.9% | pattern |
...
### Step 4: Node 27043 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27044, 27045, 27046
- **Input Features:**
