...
```
Node 9661 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 9662 (Aggregate) [consumed]
    Node 9663 (Gather Merge) [consumed]
      Node 9664 (Aggregate)
          ...
          Node 9666 (Hash Join) [consumed]
            Node 9667 (Nested Loop)
              Node 9668 (Hash Join)
                ...
                Node 9670 (Hash) [PATTERN: 444761fb]
                  Node 9671 (Hash Join) [consumed]
                    Node 9672 (Seq Scan) [consumed] - LEAF
                    Node 9673 (Hash) [consumed]
                      Node 9674 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 9670 | 9661, 9662, 9663, 9665, 9666, 9671, 9672, 9673, 9674 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 9661 | 9662, 9663, 9665, 9666, 9670, 9671, 9672, 9673, 9674 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 9665 | 9661, 9662, 9663, 9666, 9670, 9671, 9672, 9673, 9674 |
...
|------|------|--------|-----------|-----|--------|
| 9661 | Sort | 1055.67 | 2934.42 | 178.0% | pattern |
| 9664 | Aggregate | 1050.55 | 1128.79 | 7.4% | operator |
| 9665 | Sort | 1050.22 | 1835.90 | 74.8% | pattern |
| 9667 | Nested Loop | 1037.65 | 1188.37 | 14.5% | operator |
| 9679 | Hash | 4.03 | 18.67 | 362.8% | operator |
| 9668 | Hash Join | 217.82 | 253.07 | 16.2% | operator |
| 9678 | Index Scan | 0.07 | -0.22 | 409.9% | operator |
| 9680 | Seq Scan | 3.55 | 12.36 | 248.3% | operator |
| 9669 | Seq Scan | 167.80 | 159.81 | 4.8% | operator |
| 9670 | Hash | 37.44 | 46.85 | 25.1% | pattern |
...
### Step 4: Node 9669 (Seq Scan) - LEAF
...
### Step 5: Node 9670 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 9661, 9662, 9663, 9665, 9666, 9671, 9672, 9673, 9674
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 9678 (Index Scan) - LEAF
...
### Step 8: Node 9680 (Seq Scan) - LEAF
...
### Step 11: Node 9665 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 9661, 9662, 9663, 9666, 9670, 9671, 9672, 9673, 9674
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 9661 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 9662, 9663, 9665, 9666, 9670, 9671, 9672, 9673, 9674
- **Input Features:**
