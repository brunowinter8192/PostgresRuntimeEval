...
Node 716 (Aggregate) - ROOT
  Node 717 (Gather Merge)
    Node 718 (Sort) [PATTERN: 1d35fb97]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 718 | 719 |
...
|------|------|--------|-----------|-----|--------|
| 716 | Aggregate | 944.34 | 1195.89 | 26.6% | operator |
| 717 | Gather Merge | 944.31 | 1165.91 | 23.5% | operator |
| 718 | Sort | 928.65 | 1200.53 | 29.3% | pattern |
...
### Step 2: Node 718 (Sort) - PATTERN ROOT
...
### Step 4: Node 716 (Aggregate) - ROOT
