...
**Test Query:** Q12_114_seed_927055503
...
```
Node 24425 (Aggregate) - ROOT
  Node 24426 (Gather Merge)
    Node 24427 (Aggregate)
      Node 24428 (Sort)
        Node 24429 (Nested Loop)
          Node 24430 (Seq Scan) - LEAF
          Node 24431 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24425 | Aggregate | 1011.75 | 919.06 | 9.2% | operator |
| 24426 | Gather Merge | 1011.72 | 1111.84 | 9.9% | operator |
| 24427 | Aggregate | 991.51 | 895.30 | 9.7% | operator |
| 24428 | Sort | 990.73 | 1092.82 | 10.3% | operator |
| 24429 | Nested Loop | 989.78 | 1127.41 | 13.9% | operator |
| 24430 | Seq Scan | 853.21 | 745.19 | 12.7% | operator |
| 24431 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24430 (Seq Scan) - LEAF
...
### Step 2: Node 24431 (Index Scan) - LEAF
...
### Step 6: Node 24426 (Gather Merge)
...
### Step 7: Node 24425 (Aggregate) - ROOT
