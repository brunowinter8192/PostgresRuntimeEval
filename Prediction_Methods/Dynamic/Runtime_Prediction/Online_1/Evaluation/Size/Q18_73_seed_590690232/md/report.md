        ...
        Node 30744 (Incremental Sort)
          Node 30745 (Nested Loop)
            Node 30746 (Merge Join)
              Node 30747 (Sort)
                Node 30748 (Hash Join)
                  Node 30749 (Seq Scan) - LEAF
                  Node 30750 (Hash)
...
| 30747 | Sort | 2841.47 | 1099.77 | 61.3% | operator |
| 30753 | Sort | 64.78 | 1074.66 | 1558.9% | operator |
| 30748 | Hash Join | 2841.46 | 686.33 | 75.8% | operator |
| 30754 | Seq Scan | 52.98 | 18.25 | 65.6% | operator |
| 30749 | Seq Scan | 186.45 | 170.37 | 8.6% | operator |
| 30750 | Hash | 2627.22 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30749 (Seq Scan) - LEAF
...
### Step 6: Node 30754 (Seq Scan) - LEAF
...
### Step 9: Node 30746 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30755 (Index Scan) - LEAF
...
### Step 11: Node 30745 (Nested Loop)
...
### Step 12: Node 30744 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30743 (Gather Merge)
