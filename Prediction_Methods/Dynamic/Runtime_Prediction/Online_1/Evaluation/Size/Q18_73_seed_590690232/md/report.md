...
**Test Query:** Q18_73_seed_590690232
...
```
Node 30740 (Limit) - ROOT
  Node 30741 (Sort)
    Node 30742 (Aggregate)
      Node 30743 (Gather Merge)
        Node 30744 (Incremental Sort)
          Node 30745 (Nested Loop)
            Node 30746 (Merge Join)
              Node 30747 (Sort)
                Node 30748 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30749 (Seq Scan) [consumed] - LEAF
                  Node 30750 (Hash) [consumed]
                    Node 30751 (Aggregate)
                      Node 30752 (Index Scan) - LEAF
              Node 30753 (Sort)
                Node 30754 (Seq Scan) - LEAF
            Node 30755 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30748 | 30749, 30750 |
...
|------|------|--------|-----------|-----|--------|
| 30740 | Limit | 3051.79 | 1175.21 | 61.5% | operator |
| 30741 | Sort | 2929.70 | 1127.81 | 61.5% | operator |
| 30742 | Aggregate | 2929.66 | 1073.15 | 63.4% | operator |
| 30743 | Gather Merge | 2929.64 | 1073.95 | 63.3% | operator |
| 30744 | Incremental Sort | 2909.19 | 0.00 | 100.0% | operator |
| 30745 | Nested Loop | 2909.13 | 1111.34 | 61.8% | operator |
| 30746 | Merge Join | 2909.07 | 0.00 | 100.0% | operator |
| 30755 | Index Scan | 0.03 | 0.05 | 80.5% | operator |
| 30747 | Sort | 2841.47 | 1095.58 | 61.4% | operator |
| 30753 | Sort | 64.78 | 1074.66 | 1558.9% | operator |
| 30748 | Hash Join | 2841.46 | 471.07 | 83.4% | pattern |
| 30754 | Seq Scan | 52.98 | 18.25 | 65.6% | operator |
| 30751 | Aggregate | 2627.19 | 1073.15 | 59.2% | operator |
| 30752 | Index Scan | 2121.04 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30752 (Index Scan) - LEAF
...
### Step 3: Node 30748 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30749, 30750
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30754 (Seq Scan) - LEAF
...
### Step 7: Node 30746 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30755 (Index Scan) - LEAF
...
### Step 10: Node 30744 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30743 (Gather Merge)
