    ...
    Node 4373 (Aggregate) [consumed]
      Node 4374 (Gather) [consumed]
        Node 4375 (Nested Loop)
          Node 4376 (Hash Join) [PATTERN: 895c6e8c]
            Node 4377 (Seq Scan) [consumed] - LEAF
            Node 4378 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4371 | 4372, 4373, 4374, 4376, 4377, 4378 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4376 | 4371, 4372, 4373, 4374, 4377, 4378 |
...
| 4375 | Nested Loop | 1164.64 | 1192.68 | 2.4% | operator |
| 4376 | Hash Join | 208.76 | 242.41 | 16.1% | pattern |
...
### Step 2: Node 4376 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4371, 4372, 4373, 4374, 4377, 4378
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46344
  - HashJoin_nt1=232114
...
### Step 3: Node 4380 (Index Scan) - LEAF
...
- **Output:** st=121.44, rt=1192.68

### Step 5: Node 4371 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4372, 4373, 4374, 4376, 4377, 4378
- **Input Features:**
