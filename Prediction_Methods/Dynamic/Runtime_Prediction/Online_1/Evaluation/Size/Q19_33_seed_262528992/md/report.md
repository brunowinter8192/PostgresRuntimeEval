...
**Test Query:** Q19_33_seed_262528992
...
```
Node 31752 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31753 (Gather) [consumed]
    Node 31754 (Aggregate) [consumed]
      Node 31755 (Hash Join) [consumed]
        Node 31756 (Seq Scan) - LEAF
        Node 31757 (Hash)
          Node 31758 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31752 | 31753, 31754, 31755 |
...
|------|------|--------|-----------|-----|--------|
| 31752 | Aggregate | 841.42 | 829.29 | 1.4% | pattern |
| 31756 | Seq Scan | 773.29 | 743.46 | 3.9% | operator |
| 31757 | Hash | 45.11 | 8.29 | 81.6% | operator |
| 31758 | Seq Scan | 44.97 | 23.76 | 47.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31758 (Seq Scan) - LEAF
...
### Step 2: Node 31756 (Seq Scan) - LEAF
...
### Step 4: Node 31752 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31753, 31754, 31755
- **Input Features:**
