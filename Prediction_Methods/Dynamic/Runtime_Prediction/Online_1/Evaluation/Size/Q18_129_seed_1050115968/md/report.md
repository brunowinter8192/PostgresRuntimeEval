...
```
Node 29316 (Limit) - ROOT
  Node 29317 (Sort)
    Node 29318 (Aggregate)
      Node 29319 (Gather Merge)
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29324 | 29325, 29326 |
...
|------|------|--------|-----------|-----|--------|
| 29316 | Limit | 3046.27 | 1175.21 | 61.4% | operator |
| 29317 | Sort | 2927.76 | 1127.81 | 61.5% | operator |
| 29318 | Aggregate | 2927.72 | 1073.15 | 63.3% | operator |
| 29319 | Gather Merge | 2927.68 | 1073.95 | 63.3% | operator |
| 29320 | Incremental Sort | 2888.07 | 0.00 | 100.0% | operator |
| 29321 | Nested Loop | 2888.03 | 1111.34 | 61.5% | operator |
| 29322 | Merge Join | 2887.97 | 0.00 | 100.0% | operator |
| 29331 | Index Scan | 0.02 | 0.05 | 137.6% | operator |
| 29323 | Sort | 2837.18 | 1095.58 | 61.4% | operator |
| 29329 | Sort | 64.69 | 1074.66 | 1561.3% | operator |
| 29324 | Hash Join | 2837.16 | 471.07 | 83.4% | pattern |
| 29330 | Seq Scan | 53.02 | 18.25 | 65.6% | operator |
| 29327 | Aggregate | 2622.32 | 1073.15 | 59.1% | operator |
| 29328 | Index Scan | 2130.54 | 0.00 | 100.0% | operator |
...
### Step 10: Node 29320 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29319 (Gather Merge)
