...
```
Node 25797 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25798 (Aggregate) [consumed]
    Node 25799 (Aggregate)
      Node 25800 (Hash Join) [PATTERN: 895c6e8c]
        Node 25801 (Seq Scan) [consumed] - LEAF
        Node 25802 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25797 | 25798, 25800, 25801, 25802 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25800 | 25797, 25798, 25801, 25802 |
...
|------|------|--------|-----------|-----|--------|
| 25797 | Sort | 923.16 | 1079.94 | 17.0% | pattern |
| 25799 | Aggregate | 917.05 | 999.96 | 9.0% | operator |
| 25800 | Hash Join | 702.76 | 470.31 | 33.1% | pattern |
...
### Step 2: Node 25800 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25797, 25798, 25801, 25802
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1490982
  - HashJoin_nt1=1490982
  - HashJoin_nt2=150000
  ...
  - HashJoin_total_cost=53387.8600
  - Hash_Inner_np=0
...
- **Output:** st=908.25, rt=999.96

### Step 4: Node 25797 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25798, 25800, 25801, 25802
- **Input Features:**
  ...
  - Aggregate_Outer_startup_cost=64592.7700
  - Aggregate_Outer_total_cost=64594.7700
  - Sort_np=0
  - Sort_nt=200
  - Sort_nt1=200
  - Sort_nt2=0
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=64602.4100
  - Sort_total_cost=64602.9100
- **Output:** st=1078.71, rt=1079.94
