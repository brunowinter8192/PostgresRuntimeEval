...
```
Node 18101 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18102 (Aggregate) [consumed]
    Node 18103 (Gather)
      Node 18104 (Aggregate)
        Node 18105 (Nested Loop)
          Node 18106 (Hash Join) [PATTERN: bb930825]
            Node 18107 (Seq Scan) [consumed] - LEAF
            Node 18108 (Hash) [consumed]
              Node 18109 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18106 | 18101, 18102, 18107, 18108, 18109 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18101 | 18102, 18106, 18107, 18108, 18109 |
...
|------|------|--------|-----------|-----|--------|
| 18101 | Sort | 1210.95 | 1045.06 | 13.7% | pattern |
...
| 18106 | Hash Join | 995.25 | 134.80 | 86.5% | pattern |
...
### Step 9: Node 18106 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18101, 18102, 18107, 18108, 18109
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18118 (Index Scan) - LEAF
...
### Step 11: Node 18105 (Nested Loop)
...
### Step 14: Node 18101 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18102, 18106, 18107, 18108, 18109
- **Input Features:**
