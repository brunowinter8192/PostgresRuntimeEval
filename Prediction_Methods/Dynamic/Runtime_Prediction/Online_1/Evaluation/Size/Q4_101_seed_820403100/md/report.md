...
**Test Query:** Q4_101_seed_820403100
...
```
Node 5858 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 5859 (Gather Merge) [consumed]
    Node 5860 (Sort) [consumed]
      Node 5861 (Aggregate) [consumed]
        Node 5862 (Nested Loop)
          Node 5863 (Seq Scan) - LEAF
          Node 5864 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 5858 | 5859, 5860, 5861 |
...
|------|------|--------|-----------|-----|--------|
| 5858 | Aggregate | 1043.71 | 952.19 | 8.8% | pattern |
| 5862 | Nested Loop | 1035.45 | 1255.45 | 21.2% | operator |
| 5863 | Seq Scan | 167.28 | 154.66 | 7.5% | operator |
| 5864 | Index Scan | 0.06 | 11.10 | 18103.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5863 (Seq Scan) - LEAF
...
### Step 2: Node 5864 (Index Scan) - LEAF
