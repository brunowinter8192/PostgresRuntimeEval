...
**Test Query:** Q3_70_seed_566078139
...
```
Node 5521 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5522 (Sort) [consumed]
    Node 5523 (Aggregate) [consumed]
      Node 5524 (Gather) [consumed]
        Node 5525 (Nested Loop)
          Node 5526 (Hash Join) [PATTERN: 895c6e8c]
            Node 5527 (Seq Scan) [consumed] - LEAF
            Node 5528 (Hash) [consumed]
              Node 5529 (Seq Scan) - LEAF
          Node 5530 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5521 | 5522, 5523, 5524, 5526, 5527, 5528 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5526 | 5521, 5522, 5523, 5524, 5527, 5528 |
...
|------|------|--------|-----------|-----|--------|
| 5521 | Limit | 1217.35 | 1151.18 | 5.4% | pattern |
| 5525 | Nested Loop | 1181.46 | 1192.64 | 0.9% | operator |
| 5526 | Hash Join | 207.88 | 242.40 | 16.6% | pattern |
| 5530 | Index Scan | 0.03 | -0.52 | 2018.8% | operator |
| 5529 | Seq Scan | 28.95 | 38.60 | 33.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5529 (Seq Scan) - LEAF
...
### Step 2: Node 5526 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5521, 5522, 5523, 5524, 5527, 5528
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46283
  - HashJoin_nt1=233346
...
### Step 3: Node 5530 (Index Scan) - LEAF
...
### Step 5: Node 5521 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5522, 5523, 5524, 5526, 5527, 5528
- **Input Features:**
