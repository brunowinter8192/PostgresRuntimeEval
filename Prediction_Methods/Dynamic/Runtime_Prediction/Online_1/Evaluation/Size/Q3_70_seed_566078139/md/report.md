...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5521 | 5522, 5523, 5524 |
...
| 5525 | Nested Loop | 1181.46 | 1192.55 | 0.9% | operator |
| 5526 | Hash Join | 207.88 | 230.40 | 10.8% | operator |
| 5530 | Index Scan | 0.03 | -0.52 | 2018.8% | operator |
| 5527 | Seq Scan | 155.53 | 163.26 | 5.0% | operator |
| 5528 | Hash | 29.57 | 17.75 | 40.0% | operator |
...
### Step 2: Node 5527 (Seq Scan) - LEAF
...
### Step 5: Node 5530 (Index Scan) - LEAF
...
### Step 7: Node 5521 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5522, 5523, 5524
- **Input Features:**
