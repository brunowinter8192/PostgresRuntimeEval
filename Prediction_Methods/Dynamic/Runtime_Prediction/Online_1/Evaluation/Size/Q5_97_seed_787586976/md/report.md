...
**Test Query:** Q5_97_seed_787586976
...
```
Node 9821 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 9822 (Aggregate) [consumed]
    Node 9823 (Gather Merge) [consumed]
      Node 9824 (Aggregate)
        Node 9825 (Sort) [PATTERN: 3e2d5a00]
          Node 9826 (Hash Join) [consumed]
            Node 9827 (Nested Loop)
              Node 9828 (Hash Join)
                Node 9829 (Seq Scan) - LEAF
                Node 9830 (Hash) [PATTERN: 444761fb]
                  Node 9831 (Hash Join) [consumed]
                    Node 9832 (Seq Scan) [consumed] - LEAF
                    Node 9833 (Hash) [consumed]
                      Node 9834 (Hash Join) [consumed]
                        Node 9835 (Seq Scan) - LEAF
                        Node 9836 (Hash)
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 9830 | 9821, 9822, 9823, 9825, 9826, 9831, 9832, 9833, 9834 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 9821 | 9822, 9823, 9825, 9826, 9830, 9831, 9832, 9833, 9834 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 9825 | 9821, 9822, 9823, 9826, 9830, 9831, 9832, 9833, 9834 |
...
|------|------|--------|-----------|-----|--------|
| 9821 | Sort | 1082.00 | 2934.42 | 171.2% | pattern |
| 9824 | Aggregate | 1075.81 | 1128.78 | 4.9% | operator |
| 9825 | Sort | 1075.54 | 1835.92 | 70.7% | pattern |
| 9827 | Nested Loop | 1063.83 | 1188.42 | 11.7% | operator |
| 9839 | Hash | 2.83 | 18.67 | 560.5% | operator |
| 9828 | Hash Join | 219.37 | 253.07 | 15.4% | operator |
| 9838 | Index Scan | 0.07 | -0.22 | 397.3% | operator |
| 9840 | Seq Scan | 2.20 | 12.36 | 461.3% | operator |
| 9829 | Seq Scan | 167.74 | 159.81 | 4.7% | operator |
| 9830 | Hash | 37.08 | 46.85 | 26.4% | pattern |
| 9835 | Seq Scan | 0.01 | 11.81 | 84244.8% | operator |
| 9836 | Hash | 0.09 | 21.05 | 24380.5% | operator |
| 9837 | Seq Scan | 0.08 | 22.93 | 27867.5% | operator |
...
### Step 2: Node 9835 (Seq Scan) - LEAF
...
### Step 4: Node 9829 (Seq Scan) - LEAF
...
### Step 5: Node 9830 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 9821, 9822, 9823, 9825, 9826, 9831, 9832, 9833, 9834
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 9838 (Index Scan) - LEAF
...
### Step 8: Node 9840 (Seq Scan) - LEAF
...
### Step 11: Node 9825 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 9821, 9822, 9823, 9826, 9830, 9831, 9832, 9833, 9834
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 9821 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 9822, 9823, 9825, 9826, 9830, 9831, 9832, 9833, 9834
- **Input Features:**
