...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5111 | 5112, 5113, 5114 |
...
|------|------|--------|-----------|-----|--------|
| 5111 | Limit | 1166.07 | 1151.18 | 1.3% | pattern |
| 5115 | Nested Loop | 1129.41 | 1193.18 | 5.6% | operator |
| 5116 | Hash Join | 201.84 | 231.09 | 14.5% | operator |
| 5120 | Index Scan | 0.03 | -0.52 | 2172.3% | operator |
| 5117 | Seq Scan | 149.91 | 163.50 | 9.1% | operator |
| 5118 | Hash | 29.37 | 17.75 | 39.6% | operator |
| 5119 | Seq Scan | 28.77 | 38.57 | 34.1% | operator |
...
### Step 2: Node 5117 (Seq Scan) - LEAF
...
- **Output:** st=27.26, rt=231.09

### Step 5: Node 5120 (Index Scan) - LEAF
...
- **Output:** st=121.88, rt=1193.18

### Step 7: Node 5111 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5112, 5113, 5114
- **Input Features:**
