...
```
Node 17937 (Sort) - ROOT
  Node 17938 (Aggregate)
    Node 17939 (Gather)
      Node 17940 (Aggregate)
        Node 17941 (Nested Loop)
          Node 17942 (Hash Join)
            Node 17943 (Seq Scan) - LEAF
            Node 17944 (Hash)
              Node 17945 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 17937 | Sort | 1194.11 | 1120.12 | 6.2% | operator |
| 17938 | Aggregate | 1193.97 | 898.05 | 24.8% | operator |
...
| 17942 | Hash Join | 974.16 | 633.69 | 35.0% | operator |
| 17954 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17943 | Seq Scan | 701.71 | 509.93 | 27.3% | operator |
| 17944 | Hash | 178.50 | 48.14 | 73.0% | operator |
| 17945 | Hash Join | 176.54 | 924.53 | 423.7% | operator |
...
### Step 10: Node 17943 (Seq Scan) - LEAF
...
### Step 13: Node 17954 (Index Scan) - LEAF
...
### Step 14: Node 17941 (Nested Loop)
