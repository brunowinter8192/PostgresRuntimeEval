...
**Test Query:** Q9_29_seed_229712868
...
Node 17937 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 17938 (Aggregate) [consumed]
    Node 17939 (Gather)
      Node 17940 (Aggregate)
        Node 17941 (Nested Loop)
          Node 17942 (Hash Join) [PATTERN: bb930825]
            Node 17943 (Seq Scan) [consumed] - LEAF
            Node 17944 (Hash) [consumed]
              Node 17945 (Hash Join) [consumed]
                Node 17946 (Hash Join)
                  Node 17947 (Nested Loop)
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17942 | 17937, 17938, 17943, 17944, 17945 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17937 | 17938, 17942, 17943, 17944, 17945 |
...
|------|------|--------|-----------|-----|--------|
| 17937 | Sort | 1194.11 | 1045.86 | 12.4% | pattern |
| 17939 | Gather | 1192.84 | 964.48 | 19.1% | operator |
| 17940 | Aggregate | 1173.19 | 1075.81 | 8.3% | operator |
| 17941 | Nested Loop | 1148.62 | 1252.17 | 9.0% | operator |
| 17942 | Hash Join | 974.16 | 134.80 | 86.2% | pattern |
| 17954 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17946 | Hash Join | 162.34 | 837.66 | 416.0% | operator |
| 17952 | Hash | 13.57 | 14.95 | 10.1% | operator |
| 17947 | Nested Loop | 155.20 | 1251.77 | 706.6% | operator |
| 17950 | Hash | 4.77 | 15.94 | 234.3% | operator |
| 17953 | Seq Scan | 13.56 | 2.94 | 78.3% | operator |
| 17948 | Seq Scan | 19.49 | 43.89 | 125.2% | operator |
| 17949 | Index Scan | 0.07 | -1.39 | 1976.3% | operator |
| 17951 | Seq Scan | 4.09 | 9.45 | 130.7% | operator |
...
### Step 6: Node 17953 (Seq Scan) - LEAF
...
### Step 9: Node 17942 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17937, 17938, 17943, 17944, 17945
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17954 (Index Scan) - LEAF
...
### Step 11: Node 17941 (Nested Loop)
...
### Step 14: Node 17937 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17938, 17942, 17943, 17944, 17945
- **Input Features:**
