...
**Test Query:** Q13_58_seed_467629767
...
```
Node 26091 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26092 (Aggregate) [consumed]
    Node 26093 (Aggregate)
      Node 26094 (Hash Join) [PATTERN: 895c6e8c]
        Node 26095 (Seq Scan) [consumed] - LEAF
        Node 26096 (Hash) [consumed]
          Node 26097 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26091 | 26092, 26094, 26095, 26096 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26094 | 26091, 26092, 26095, 26096 |
...
|------|------|--------|-----------|-----|--------|
| 26091 | Sort | 916.37 | 1079.94 | 17.9% | pattern |
| 26093 | Aggregate | 910.36 | 999.76 | 9.8% | operator |
| 26094 | Hash Join | 705.23 | 470.31 | 33.3% | pattern |
| 26097 | Index Only Scan | 10.18 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26097 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26094 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26091, 26092, 26095, 26096
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 26091 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26092, 26094, 26095, 26096
- **Input Features:**
