...
```
Node 26091 (Sort) - ROOT
  Node 26092 (Aggregate)
    Node 26093 (Aggregate)
      Node 26094 (Hash Join)
        Node 26095 (Seq Scan) - LEAF
        Node 26096 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 26091 | Sort | 916.37 | 1081.93 | 18.1% | operator |
| 26092 | Aggregate | 916.35 | 1000.33 | 9.2% | operator |
| 26093 | Aggregate | 910.36 | 1014.39 | 11.4% | operator |
| 26094 | Hash Join | 705.23 | 787.83 | 11.7% | operator |
| 26095 | Seq Scan | 500.86 | 264.19 | 47.3% | operator |
| 26096 | Hash | 15.33 | 80.15 | 422.9% | operator |
...
### Step 2: Node 26095 (Seq Scan) - LEAF
