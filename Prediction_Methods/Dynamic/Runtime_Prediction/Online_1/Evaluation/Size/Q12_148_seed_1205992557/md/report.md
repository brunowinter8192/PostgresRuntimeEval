...
**Test Query:** Q12_148_seed_1205992557
**Timestamp:** 2025-12-21 17:57:26
...
```
Node 24684 (Aggregate) - ROOT
  Node 24685 (Gather Merge)
    Node 24686 (Aggregate)
      Node 24687 (Sort)
        Node 24688 (Nested Loop)
          Node 24689 (Seq Scan) - LEAF
          Node 24690 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24684 | Aggregate | 1011.53 | 919.06 | 9.1% | operator |
| 24685 | Gather Merge | 1011.51 | 1111.84 | 9.9% | operator |
| 24686 | Aggregate | 992.87 | 895.30 | 9.8% | operator |
| 24687 | Sort | 992.29 | 1092.82 | 10.1% | operator |
| 24688 | Nested Loop | 991.31 | 1127.41 | 13.7% | operator |
| 24689 | Seq Scan | 857.73 | 745.19 | 13.1% | operator |
| 24690 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24689 (Seq Scan) - LEAF
...
### Step 2: Node 24690 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - st2=0.1246
  - startup_cost=0.4300
  - total_cost=147179.1500
- **Output:** st=38.32, rt=1127.41

### Step 4: Node 24687 (Sort)
...
- **Input Features:**
  ...
  - st1=38.3243
  - st2=0.0000
  - startup_cost=147540.4500
  - total_cost=147554.9100
- **Output:** st=1092.40, rt=1092.82

### Step 5: Node 24686 (Aggregate)
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=147540.4500
  - total_cost=147656.1600
- **Output:** st=868.95, rt=895.30

### Step 6: Node 24685 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=868.9514
  - st2=0.0000
  - startup_cost=148540.5300
  - total_cost=148660.4500
- **Output:** st=1109.22, rt=1111.84

### Step 7: Node 24684 (Aggregate) - ROOT
