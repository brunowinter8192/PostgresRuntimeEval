...
```
Node 18588 (Sort) - ROOT
  Node 18589 (Aggregate)
    Node 18590 (Gather)
      Node 18591 (Aggregate)
        Node 18592 (Nested Loop)
          Node 18593 (Hash Join)
            Node 18594 (Seq Scan) - LEAF
            Node 18595 (Hash)
              Node 18596 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 18588 | Sort | 1161.88 | 1119.21 | 3.7% | operator |
| 18589 | Aggregate | 1161.75 | 897.16 | 22.8% | operator |
...
| 18593 | Hash Join | 948.14 | 633.14 | 33.2% | operator |
| 18605 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18594 | Seq Scan | 679.73 | 509.93 | 25.0% | operator |
| 18595 | Hash | 175.68 | 47.79 | 72.8% | operator |
| 18596 | Hash Join | 173.86 | 924.37 | 431.7% | operator |
...
### Step 10: Node 18594 (Seq Scan) - LEAF
...
### Step 13: Node 18605 (Index Scan) - LEAF
...
### Step 14: Node 18592 (Nested Loop)
