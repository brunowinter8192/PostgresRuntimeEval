...
**Test Query:** Q18_66_seed_533262015
...
```
Node 30612 (Limit) - ROOT
  Node 30613 (Sort)
    Node 30614 (Aggregate)
      Node 30615 (Gather Merge)
        Node 30616 (Incremental Sort)
          Node 30617 (Nested Loop)
            Node 30618 (Merge Join)
              Node 30619 (Sort)
                Node 30620 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30621 (Seq Scan) [consumed] - LEAF
                  Node 30622 (Hash) [consumed]
                    Node 30623 (Aggregate)
                      Node 30624 (Index Scan) - LEAF
              Node 30625 (Sort)
                Node 30626 (Seq Scan) - LEAF
            Node 30627 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30620 | 30621, 30622 |
...
|------|------|--------|-----------|-----|--------|
| 30612 | Limit | 3052.22 | 1175.21 | 61.5% | operator |
| 30613 | Sort | 2936.28 | 1127.81 | 61.6% | operator |
| 30614 | Aggregate | 2936.24 | 1073.15 | 63.5% | operator |
| 30615 | Gather Merge | 2936.21 | 1073.95 | 63.4% | operator |
| 30616 | Incremental Sort | 2897.30 | 0.00 | 100.0% | operator |
| 30617 | Nested Loop | 2897.24 | 1111.34 | 61.6% | operator |
| 30618 | Merge Join | 2897.17 | 0.00 | 100.0% | operator |
| 30627 | Index Scan | 0.03 | 0.05 | 50.5% | operator |
| 30619 | Sort | 2845.35 | 1095.58 | 61.5% | operator |
| 30625 | Sort | 66.13 | 1074.66 | 1525.1% | operator |
| 30620 | Hash Join | 2845.34 | 471.07 | 83.4% | pattern |
| 30626 | Seq Scan | 54.08 | 18.25 | 66.3% | operator |
| 30623 | Aggregate | 2618.53 | 1073.15 | 59.0% | operator |
| 30624 | Index Scan | 2126.89 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30624 (Index Scan) - LEAF
...
### Step 3: Node 30620 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30621, 30622
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30626 (Seq Scan) - LEAF
...
### Step 7: Node 30618 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30627 (Index Scan) - LEAF
...
### Step 10: Node 30616 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30615 (Gather Merge)
