        ...
        Node 30616 (Incremental Sort)
          Node 30617 (Nested Loop)
            Node 30618 (Merge Join)
              Node 30619 (Sort)
                Node 30620 (Hash Join)
                  Node 30621 (Seq Scan) - LEAF
                  Node 30622 (Hash)
...
| 30619 | Sort | 2845.35 | 1099.77 | 61.3% | operator |
| 30625 | Sort | 66.13 | 1074.66 | 1525.1% | operator |
| 30620 | Hash Join | 2845.34 | 686.33 | 75.9% | operator |
| 30626 | Seq Scan | 54.08 | 18.25 | 66.3% | operator |
| 30621 | Seq Scan | 197.84 | 170.37 | 13.9% | operator |
| 30622 | Hash | 2618.55 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30621 (Seq Scan) - LEAF
...
### Step 6: Node 30626 (Seq Scan) - LEAF
...
### Step 9: Node 30618 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30627 (Index Scan) - LEAF
...
### Step 11: Node 30617 (Nested Loop)
...
### Step 12: Node 30616 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30615 (Gather Merge)
