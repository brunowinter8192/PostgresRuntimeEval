...
```
Node 7521 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 7522 (Aggregate) [consumed]
    Node 7523 (Gather Merge) [consumed]
      Node 7524 (Aggregate)
        Node 7525 (Sort) [PATTERN: 3e2d5a00]
          Node 7526 (Hash Join) [consumed]
            Node 7527 (Nested Loop)
              Node 7528 (Hash Join)
                Node 7529 (Seq Scan) - LEAF
                Node 7530 (Hash) [PATTERN: 444761fb]
                  Node 7531 (Hash Join) [consumed]
                    Node 7532 (Seq Scan) [consumed] - LEAF
                    Node 7533 (Hash) [consumed]
                      Node 7534 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 7530 | 7521, 7522, 7523, 7525, 7526, 7531, 7532, 7533, 7534 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 7521 | 7522, 7523, 7525, 7526, 7530, 7531, 7532, 7533, 7534 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 7525 | 7521, 7522, 7523, 7526, 7530, 7531, 7532, 7533, 7534 |
...
|------|------|--------|-----------|-----|--------|
| 7521 | Sort | 1078.29 | 2934.42 | 172.1% | pattern |
| 7524 | Aggregate | 1071.84 | 1128.74 | 5.3% | operator |
| 7525 | Sort | 1071.59 | 1835.96 | 71.3% | pattern |
| 7527 | Nested Loop | 1060.76 | 1188.57 | 12.0% | operator |
| 7539 | Hash | 2.24 | 18.67 | 733.2% | operator |
| 7528 | Hash Join | 214.29 | 253.07 | 18.1% | operator |
| 7538 | Index Scan | 0.07 | -0.22 | 393.4% | operator |
| 7540 | Seq Scan | 1.75 | 12.36 | 608.3% | operator |
| 7529 | Seq Scan | 165.97 | 159.81 | 3.7% | operator |
| 7530 | Hash | 35.37 | 46.85 | 32.5% | pattern |
| 7535 | Seq Scan | 0.02 | 11.81 | 53574.0% | operator |
| 7536 | Hash | 0.17 | 21.05 | 12431.7% | operator |
| 7537 | Seq Scan | 0.17 | 22.93 | 13799.0% | operator |
...
### Step 4: Node 7529 (Seq Scan) - LEAF
...
### Step 5: Node 7530 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 7521, 7522, 7523, 7525, 7526, 7531, 7532, 7533, 7534
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 7538 (Index Scan) - LEAF
...
### Step 8: Node 7540 (Seq Scan) - LEAF
...
### Step 11: Node 7525 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 7521, 7522, 7523, 7526, 7530, 7531, 7532, 7533, 7534
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 7521 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 7522, 7523, 7525, 7526, 7530, 7531, 7532, 7533, 7534
- **Input Features:**
