...
```
Node 9921 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 9922 (Gather) [consumed]
    Node 9923 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 9921 | 9922, 9923 |
...
|------|------|--------|-----------|-----|--------|
| 9921 | Aggregate | 777.79 | 849.98 | 9.3% | pattern |
| 9924 | Seq Scan | 757.42 | 748.49 | 1.2% | operator |
...
### Step 2: Node 9921 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 9922, 9923
- **Input Features:**
