...
```
Node 16628 (Aggregate) - ROOT
  Node 16629 (Gather Merge)
    Node 16630 (Sort)
          ...
          Node 16633 (Hash Join)
            Node 16634 (Nested Loop)
              Node 16635 (Hash Join)
                ...
                Node 16637 (Hash)
                  Node 16638 (Hash Join)
                    Node 16639 (Seq Scan) - LEAF
                    Node 16640 (Hash)
                      Node 16641 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 16628 | Aggregate | 1237.91 | 1186.90 | 4.1% | operator |
| 16629 | Gather Merge | 1237.53 | 1097.15 | 11.3% | operator |
...
| 16635 | Hash Join | 217.50 | 251.17 | 15.5% | operator |
...
| 16637 | Hash | 37.82 | 20.62 | 45.5% | operator |
| 16638 | Hash Join | 37.23 | 132.26 | 255.2% | operator |
| 16639 | Seq Scan | 35.32 | 23.03 | 34.8% | operator |
| 16640 | Hash | 0.62 | 23.66 | 3709.4% | operator |
| 16641 | Hash Join | 0.62 | 306.84 | 49549.8% | operator |
...
### Step 5: Node 16639 (Seq Scan) - LEAF
...
### Step 8: Node 16636 (Seq Scan) - LEAF
...
### Step 11: Node 16645 (Index Scan) - LEAF
...
### Step 12: Node 16647 (Seq Scan) - LEAF
...
### Step 13: Node 16634 (Nested Loop)
...
### Step 16: Node 16648 (Index Scan) - LEAF
...
### Step 17: Node 16650 (Seq Scan) - LEAF
...
### Step 18: Node 16632 (Nested Loop)
...
### Step 22: Node 16629 (Gather Merge)
...
### Step 23: Node 16628 (Aggregate) - ROOT
