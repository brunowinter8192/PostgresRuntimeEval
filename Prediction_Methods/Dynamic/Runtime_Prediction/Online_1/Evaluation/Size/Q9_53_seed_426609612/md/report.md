...
```
Node 18426 (Sort) - ROOT
  Node 18427 (Aggregate)
    Node 18428 (Gather)
      Node 18429 (Aggregate)
        Node 18430 (Nested Loop)
          Node 18431 (Hash Join)
            Node 18432 (Seq Scan) - LEAF
            Node 18433 (Hash)
              Node 18434 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 18426 | Sort | 1202.02 | 1119.21 | 6.9% | operator |
| 18427 | Aggregate | 1201.90 | 897.16 | 25.4% | operator |
...
| 18431 | Hash Join | 986.25 | 633.14 | 35.8% | operator |
| 18443 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18432 | Seq Scan | 713.40 | 509.93 | 28.5% | operator |
| 18433 | Hash | 178.49 | 47.79 | 73.2% | operator |
| 18434 | Hash Join | 176.43 | 924.37 | 423.9% | operator |
...
### Step 10: Node 18432 (Seq Scan) - LEAF
...
### Step 13: Node 18443 (Index Scan) - LEAF
...
### Step 14: Node 18430 (Nested Loop)
