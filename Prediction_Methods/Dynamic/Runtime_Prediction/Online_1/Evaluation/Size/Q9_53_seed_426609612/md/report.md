...
**Test Query:** Q9_53_seed_426609612
...
```
Node 18426 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18427 (Aggregate) [consumed]
    Node 18428 (Gather)
      Node 18429 (Aggregate)
        Node 18430 (Nested Loop)
          Node 18431 (Hash Join) [PATTERN: bb930825]
            Node 18432 (Seq Scan) [consumed] - LEAF
            Node 18433 (Hash) [consumed]
              Node 18434 (Hash Join) [consumed]
                Node 18435 (Hash Join)
                  Node 18436 (Nested Loop)
                    Node 18437 (Seq Scan) - LEAF
                    Node 18438 (Index Scan) - LEAF
                  Node 18439 (Hash)
                    Node 18440 (Seq Scan) - LEAF
                Node 18441 (Hash)
                  Node 18442 (Seq Scan) - LEAF
          Node 18443 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18431 | 18426, 18427, 18432, 18433, 18434 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18426 | 18427, 18431, 18432, 18433, 18434 |
...
|------|------|--------|-----------|-----|--------|
| 18426 | Sort | 1202.02 | 1045.06 | 13.1% | pattern |
| 18428 | Gather | 1200.88 | 964.74 | 19.7% | operator |
| 18429 | Aggregate | 1179.70 | 1106.30 | 6.2% | operator |
| 18430 | Nested Loop | 1156.13 | 1252.17 | 8.3% | operator |
| 18431 | Hash Join | 986.25 | 134.80 | 86.3% | pattern |
| 18443 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18435 | Hash Join | 162.37 | 837.58 | 415.9% | operator |
| 18441 | Hash | 13.44 | 14.95 | 11.2% | operator |
| 18436 | Nested Loop | 156.09 | 1251.77 | 702.0% | operator |
| 18439 | Hash | 4.13 | 15.94 | 286.3% | operator |
| 18442 | Seq Scan | 13.43 | 2.94 | 78.1% | operator |
| 18437 | Seq Scan | 20.30 | 44.10 | 117.3% | operator |
| 18438 | Index Scan | 0.07 | -1.39 | 1951.3% | operator |
| 18440 | Seq Scan | 3.63 | 9.45 | 160.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 18437 (Seq Scan) - LEAF
...
### Step 2: Node 18438 (Index Scan) - LEAF
...
### Step 3: Node 18440 (Seq Scan) - LEAF
...
### Step 6: Node 18442 (Seq Scan) - LEAF
...
### Step 9: Node 18431 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18426, 18427, 18432, 18433, 18434
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18443 (Index Scan) - LEAF
...
### Step 11: Node 18430 (Nested Loop)
...
### Step 14: Node 18426 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18427, 18431, 18432, 18433, 18434
- **Input Features:**
