...
**Test Query:** Q18_125_seed_1017299844
...
```
Node 29252 (Limit) - ROOT
  Node 29253 (Sort)
    Node 29254 (Aggregate)
      Node 29255 (Gather Merge)
        Node 29256 (Incremental Sort)
          Node 29257 (Nested Loop)
            Node 29258 (Merge Join)
              Node 29259 (Sort)
                Node 29260 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29261 (Seq Scan) [consumed] - LEAF
                  Node 29262 (Hash) [consumed]
                    Node 29263 (Aggregate)
                      Node 29264 (Index Scan) - LEAF
              Node 29265 (Sort)
                Node 29266 (Seq Scan) - LEAF
            Node 29267 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29260 | 29261, 29262 |
...
|------|------|--------|-----------|-----|--------|
| 29252 | Limit | 3054.15 | 1175.21 | 61.5% | operator |
| 29253 | Sort | 2939.23 | 1127.81 | 61.6% | operator |
| 29254 | Aggregate | 2939.18 | 1073.15 | 63.5% | operator |
| 29255 | Gather Merge | 2939.16 | 1073.95 | 63.5% | operator |
| 29256 | Incremental Sort | 2918.16 | 0.00 | 100.0% | operator |
| 29257 | Nested Loop | 2918.11 | 1111.34 | 61.9% | operator |
| 29258 | Merge Join | 2918.03 | 0.00 | 100.0% | operator |
| 29267 | Index Scan | 0.03 | 0.05 | 45.6% | operator |
| 29259 | Sort | 2848.26 | 1095.58 | 61.5% | operator |
| 29265 | Sort | 67.38 | 1074.66 | 1495.0% | operator |
| 29260 | Hash Join | 2848.25 | 471.07 | 83.5% | pattern |
| 29266 | Seq Scan | 53.65 | 18.25 | 66.0% | operator |
| 29263 | Aggregate | 2627.48 | 1073.15 | 59.2% | operator |
| 29264 | Index Scan | 2127.89 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29264 (Index Scan) - LEAF
...
### Step 3: Node 29260 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29261, 29262
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29266 (Seq Scan) - LEAF
...
### Step 7: Node 29258 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29267 (Index Scan) - LEAF
...
### Step 10: Node 29256 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29255 (Gather Merge)
