...
```
Node 26917 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26918 (Gather) [consumed]
    Node 26919 (Aggregate) [consumed]
      Node 26920 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26917 | 26918, 26919 |
...
|------|------|--------|-----------|-----|--------|
| 26917 | Aggregate | 816.05 | 848.37 | 4.0% | pattern |
| 26920 | Hash Join | 795.25 | 807.66 | 1.6% | operator |
...
- **Input Features:**
  ...
  - total_cost=136647.3500
- **Output:** st=78.57, rt=807.66

### Step 5: Node 26917 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26918, 26919
- **Input Features:**
