...
**Test Query:** Q14_29_seed_229712868
...
```
Node 26917 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26918 (Gather) [consumed]
    Node 26919 (Aggregate) [consumed]
      Node 26920 (Hash Join) [consumed]
        Node 26921 (Seq Scan) - LEAF
        Node 26922 (Hash)
          Node 26923 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26917 | 26918, 26919, 26920 |
...
|------|------|--------|-----------|-----|--------|
| 26917 | Aggregate | 816.05 | 857.13 | 5.0% | pattern |
| 26921 | Seq Scan | 742.07 | 758.50 | 2.2% | operator |
| 26922 | Hash | 43.76 | 9.38 | 78.6% | operator |
| 26923 | Seq Scan | 38.61 | 12.70 | 67.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26923 (Seq Scan) - LEAF
...
### Step 2: Node 26921 (Seq Scan) - LEAF
...
### Step 4: Node 26917 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26918, 26919, 26920
- **Input Features:**
