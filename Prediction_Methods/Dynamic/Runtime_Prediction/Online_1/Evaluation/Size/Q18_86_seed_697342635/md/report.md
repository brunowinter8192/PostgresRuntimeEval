        ...
        Node 30968 (Incremental Sort)
          Node 30969 (Nested Loop)
            Node 30970 (Merge Join)
              Node 30971 (Sort)
                Node 30972 (Hash Join)
                  Node 30973 (Seq Scan) - LEAF
                  Node 30974 (Hash)
...
| 30971 | Sort | 2841.22 | 1099.77 | 61.3% | operator |
| 30977 | Sort | 66.03 | 1074.66 | 1527.6% | operator |
| 30972 | Hash Join | 2841.21 | 686.33 | 75.8% | operator |
| 30978 | Seq Scan | 54.11 | 18.25 | 66.3% | operator |
| 30973 | Seq Scan | 189.69 | 170.37 | 10.2% | operator |
| 30974 | Hash | 2620.80 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30973 (Seq Scan) - LEAF
...
### Step 6: Node 30978 (Seq Scan) - LEAF
...
### Step 9: Node 30970 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30979 (Index Scan) - LEAF
...
### Step 11: Node 30969 (Nested Loop)
...
### Step 12: Node 30968 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30967 (Gather Merge)
