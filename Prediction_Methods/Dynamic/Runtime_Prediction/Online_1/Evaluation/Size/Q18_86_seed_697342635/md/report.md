...
**Test Query:** Q18_86_seed_697342635
...
```
Node 30964 (Limit) - ROOT
  Node 30965 (Sort)
    Node 30966 (Aggregate)
      Node 30967 (Gather Merge)
        Node 30968 (Incremental Sort)
          Node 30969 (Nested Loop)
            Node 30970 (Merge Join)
              Node 30971 (Sort)
                Node 30972 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30973 (Seq Scan) [consumed] - LEAF
                  Node 30974 (Hash) [consumed]
                    Node 30975 (Aggregate)
                      Node 30976 (Index Scan) - LEAF
              Node 30977 (Sort)
                Node 30978 (Seq Scan) - LEAF
            Node 30979 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30972 | 30973, 30974 |
...
|------|------|--------|-----------|-----|--------|
| 30964 | Limit | 3044.12 | 1175.21 | 61.4% | operator |
| 30965 | Sort | 2927.66 | 1127.81 | 61.5% | operator |
| 30966 | Aggregate | 2927.62 | 1073.15 | 63.3% | operator |
| 30967 | Gather Merge | 2927.60 | 1073.95 | 63.3% | operator |
| 30968 | Incremental Sort | 2909.89 | 0.00 | 100.0% | operator |
| 30969 | Nested Loop | 2909.83 | 1111.34 | 61.8% | operator |
| 30970 | Merge Join | 2909.77 | 0.00 | 100.0% | operator |
| 30979 | Index Scan | 0.02 | 0.05 | 114.9% | operator |
| 30971 | Sort | 2841.22 | 1095.58 | 61.4% | operator |
| 30977 | Sort | 66.03 | 1074.66 | 1527.6% | operator |
| 30972 | Hash Join | 2841.21 | 471.07 | 83.4% | pattern |
| 30978 | Seq Scan | 54.11 | 18.25 | 66.3% | operator |
| 30975 | Aggregate | 2620.75 | 1073.15 | 59.1% | operator |
| 30976 | Index Scan | 2119.47 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30976 (Index Scan) - LEAF
...
### Step 3: Node 30972 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30973, 30974
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30978 (Seq Scan) - LEAF
...
### Step 7: Node 30970 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30979 (Index Scan) - LEAF
...
### Step 10: Node 30968 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30967 (Gather Merge)
