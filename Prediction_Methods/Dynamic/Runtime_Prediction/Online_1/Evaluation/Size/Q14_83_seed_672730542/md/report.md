...
```
Node 27337 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27338 (Gather) [consumed]
    Node 27339 (Aggregate) [consumed]
      Node 27340 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27337 | 27338, 27339, 27340 |
...
|------|------|--------|-----------|-----|--------|
| 27337 | Aggregate | 815.22 | 857.14 | 5.1% | pattern |
...
### Step 4: Node 27337 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27338, 27339, 27340
- **Input Features:**
