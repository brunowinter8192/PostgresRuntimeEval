...
**Test Query:** Q18_55_seed_443017674
...
```
Node 30420 (Limit) - ROOT
  Node 30421 (Sort)
    Node 30422 (Aggregate)
      Node 30423 (Gather Merge)
        Node 30424 (Incremental Sort)
          Node 30425 (Nested Loop)
            Node 30426 (Merge Join)
              Node 30427 (Sort)
                Node 30428 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30429 (Seq Scan) [consumed] - LEAF
                  Node 30430 (Hash) [consumed]
                    Node 30431 (Aggregate)
                      Node 30432 (Index Scan) - LEAF
              Node 30433 (Sort)
                Node 30434 (Seq Scan) - LEAF
            Node 30435 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30428 | 30429, 30430 |
...
|------|------|--------|-----------|-----|--------|
| 30420 | Limit | 3072.49 | 1175.21 | 61.8% | operator |
| 30421 | Sort | 2957.26 | 1127.81 | 61.9% | operator |
| 30422 | Aggregate | 2957.22 | 1073.15 | 63.7% | operator |
| 30423 | Gather Merge | 2957.20 | 1073.95 | 63.7% | operator |
| 30424 | Incremental Sort | 2937.77 | 0.00 | 100.0% | operator |
| 30425 | Nested Loop | 2937.72 | 1111.34 | 62.2% | operator |
| 30426 | Merge Join | 2937.66 | 0.00 | 100.0% | operator |
| 30435 | Index Scan | 0.02 | 0.05 | 114.9% | operator |
| 30427 | Sort | 2867.04 | 1095.58 | 61.8% | operator |
| 30433 | Sort | 67.78 | 1074.66 | 1485.4% | operator |
| 30428 | Hash Join | 2867.03 | 471.07 | 83.6% | pattern |
| 30434 | Seq Scan | 53.24 | 18.25 | 65.7% | operator |
| 30431 | Aggregate | 2641.27 | 1073.15 | 59.4% | operator |
| 30432 | Index Scan | 2135.39 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30432 (Index Scan) - LEAF
...
### Step 3: Node 30428 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30429, 30430
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30434 (Seq Scan) - LEAF
...
### Step 7: Node 30426 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30435 (Index Scan) - LEAF
...
### Step 10: Node 30424 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30423 (Gather Merge)
