        ...
        Node 30424 (Incremental Sort)
          Node 30425 (Nested Loop)
            Node 30426 (Merge Join)
              Node 30427 (Sort)
                Node 30428 (Hash Join)
                  Node 30429 (Seq Scan) - LEAF
                  Node 30430 (Hash)
...
| 30427 | Sort | 2867.04 | 1099.77 | 61.6% | operator |
| 30433 | Sort | 67.78 | 1074.66 | 1485.4% | operator |
| 30428 | Hash Join | 2867.03 | 686.33 | 76.1% | operator |
| 30434 | Seq Scan | 53.24 | 18.25 | 65.7% | operator |
| 30429 | Seq Scan | 195.97 | 170.37 | 13.1% | operator |
| 30430 | Hash | 2641.31 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30429 (Seq Scan) - LEAF
...
### Step 6: Node 30434 (Seq Scan) - LEAF
...
### Step 9: Node 30426 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30435 (Index Scan) - LEAF
...
### Step 11: Node 30425 (Nested Loop)
...
### Step 12: Node 30424 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30423 (Gather Merge)
