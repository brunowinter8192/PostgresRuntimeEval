...
**Test Query:** Q3_63_seed_508649922
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5441 | 5442, 5443, 5444, 5446, 5447, 5448 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5446 | 5441, 5442, 5443, 5444, 5447, 5448 |
...
|------|------|--------|-----------|-----|--------|
| 5441 | Limit | 1217.50 | 1151.18 | 5.4% | pattern |
| 5445 | Nested Loop | 1182.08 | 1193.22 | 0.9% | operator |
| 5446 | Hash Join | 209.78 | 242.51 | 15.6% | pattern |
| 5450 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5449 | Seq Scan | 29.09 | 38.57 | 32.6% | operator |
...
- **Consumes:** Nodes 5441, 5442, 5443, 5444, 5447, 5448
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47176
  - HashJoin_nt1=236285
...
### Step 3: Node 5450 (Index Scan) - LEAF
...
- **Output:** st=121.97, rt=1193.22

### Step 5: Node 5441 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5442, 5443, 5444, 5446, 5447, 5448
- **Input Features:**
