...
**Test Query:** Q14_79_seed_639914418
...
```
Node 27302 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27303 (Gather) [consumed]
    Node 27304 (Aggregate) [consumed]
      Node 27305 (Hash Join) [consumed]
        Node 27306 (Seq Scan) - LEAF
        Node 27307 (Hash)
          Node 27308 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27302 | 27303, 27304, 27305 |
...
|------|------|--------|-----------|-----|--------|
| 27302 | Aggregate | 804.60 | 857.14 | 6.5% | pattern |
| 27306 | Seq Scan | 731.68 | 758.50 | 3.7% | operator |
| 27307 | Hash | 41.98 | 9.38 | 77.7% | operator |
| 27308 | Seq Scan | 36.77 | 12.70 | 65.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27308 (Seq Scan) - LEAF
...
### Step 2: Node 27306 (Seq Scan) - LEAF
...
### Step 4: Node 27302 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27303, 27304, 27305
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=15692
  - HashJoin_Outer_nt1=15692
  ...
  - HashJoin_Outer_total_cost=136647.8300
