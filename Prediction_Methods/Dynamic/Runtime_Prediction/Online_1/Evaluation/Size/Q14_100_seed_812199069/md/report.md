...
```
Node 26420 (Aggregate) [PATTERN: a5f39f08] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26420 | 26421, 26422 |
...
|------|------|--------|-----------|-----|--------|
| 26420 | Aggregate | 783.52 | 848.37 | 8.3% | pattern |
| 26423 | Hash Join | 758.66 | 807.66 | 6.5% | operator |
...
### Step 5: Node 26420 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26421, 26422
- **Input Features:**
