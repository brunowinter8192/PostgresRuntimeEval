...
**Test Query:** Q14_100_seed_812199069
...
```
Node 26420 (Aggregate) [PATTERN: efde8b38] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26420 | 26421, 26422, 26423 |
...
|------|------|--------|-----------|-----|--------|
| 26420 | Aggregate | 783.52 | 857.14 | 9.4% | pattern |
| 26424 | Seq Scan | 708.36 | 758.50 | 7.1% | operator |
| 26425 | Hash | 41.96 | 9.38 | 77.6% | operator |
| 26426 | Seq Scan | 36.95 | 12.70 | 65.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26426 (Seq Scan) - LEAF
...
### Step 2: Node 26424 (Seq Scan) - LEAF
...
### Step 4: Node 26420 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26421, 26422, 26423
- **Input Features:**
