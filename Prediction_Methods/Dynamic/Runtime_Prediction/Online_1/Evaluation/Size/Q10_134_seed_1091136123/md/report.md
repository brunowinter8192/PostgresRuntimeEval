...
**Test Query:** Q10_134_seed_1091136123
...
```
Node 19851 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 19852 (Sort) [consumed]
    Node 19853 (Aggregate) [consumed]
      Node 19854 (Gather) [consumed]
        Node 19855 (Hash Join)
          Node 19856 (Hash Join) [PATTERN: 2e0f44ef]
            Node 19857 (Nested Loop) [consumed]
              Node 19858 (Seq Scan) - LEAF
              Node 19859 (Index Scan) - LEAF
            Node 19860 (Hash) [consumed]
              Node 19861 (Seq Scan) - LEAF
          Node 19862 (Hash)
            Node 19863 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19851 | 19852, 19853, 19854, 19856, 19857, 19860 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 19856 | 19851, 19852, 19853, 19854, 19857, 19860 |
...
|------|------|--------|-----------|-----|--------|
| 19851 | Limit | 1148.99 | 1199.47 | 4.4% | pattern |
| 19855 | Hash Join | 1104.45 | 1095.39 | 0.8% | operator |
| 19856 | Hash Join | 1101.27 | 1120.19 | 1.7% | pattern |
| 19862 | Hash | 0.02 | 15.71 | 98092.3% | operator |
| 19863 | Seq Scan | 0.01 | 6.98 | 63342.8% | operator |
| 19858 | Seq Scan | 164.90 | 159.75 | 3.1% | operator |
| 19859 | Index Scan | 0.06 | -0.52 | 922.6% | operator |
| 19861 | Seq Scan | 25.97 | 26.64 | 2.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 19858 (Seq Scan) - LEAF
...
### Step 2: Node 19859 (Index Scan) - LEAF
...
### Step 3: Node 19861 (Seq Scan) - LEAF
...
### Step 4: Node 19863 (Seq Scan) - LEAF
...
### Step 5: Node 19856 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 19851, 19852, 19853, 19854, 19857, 19860
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=17592
  - HashJoin_nt1=17592
...
### Step 8: Node 19851 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19852, 19853, 19854, 19856, 19857, 19860
- **Input Features:**
