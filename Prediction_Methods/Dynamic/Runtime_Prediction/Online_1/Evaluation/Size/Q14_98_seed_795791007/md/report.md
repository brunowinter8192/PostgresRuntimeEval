...
```
Node 27449 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27450 (Gather) [consumed]
    Node 27451 (Aggregate) [consumed]
      Node 27452 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27449 | 27450, 27451 |
...
|------|------|--------|-----------|-----|--------|
| 27449 | Aggregate | 820.39 | 848.37 | 3.4% | pattern |
| 27452 | Hash Join | 800.39 | 807.65 | 0.9% | operator |
...
### Step 5: Node 27449 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27450, 27451
- **Input Features:**
