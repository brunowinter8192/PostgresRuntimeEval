...
**Test Query:** Q14_98_seed_795791007
...
```
Node 27449 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27450 (Gather) [consumed]
    Node 27451 (Aggregate) [consumed]
      Node 27452 (Hash Join) [consumed]
        Node 27453 (Seq Scan) - LEAF
        Node 27454 (Hash)
          Node 27455 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27449 | 27450, 27451, 27452 |
...
|------|------|--------|-----------|-----|--------|
| 27449 | Aggregate | 820.39 | 857.13 | 4.5% | pattern |
| 27453 | Seq Scan | 748.51 | 758.49 | 1.3% | operator |
| 27454 | Hash | 44.21 | 9.38 | 78.8% | operator |
| 27455 | Seq Scan | 38.58 | 12.70 | 67.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27455 (Seq Scan) - LEAF
...
### Step 2: Node 27453 (Seq Scan) - LEAF
...
### Step 4: Node 27449 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27450, 27451, 27452
- **Input Features:**
