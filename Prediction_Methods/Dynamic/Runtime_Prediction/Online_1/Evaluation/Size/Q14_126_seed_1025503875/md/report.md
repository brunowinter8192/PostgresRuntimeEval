...
```
Node 26616 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26617 (Gather) [consumed]
    Node 26618 (Aggregate) [consumed]
      Node 26619 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26616 | 26617, 26618, 26619 |
...
|------|------|--------|-----------|-----|--------|
| 26616 | Aggregate | 850.09 | 857.14 | 0.8% | pattern |
...
### Step 4: Node 26616 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26617, 26618, 26619
- **Input Features:**
