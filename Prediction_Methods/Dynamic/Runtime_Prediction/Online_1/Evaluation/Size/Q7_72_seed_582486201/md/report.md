...
```
Node 12643 (Aggregate) - ROOT
  Node 12644 (Gather Merge)
    Node 12645 (Sort)
      Node 12646 (Hash Join)
        Node 12647 (Nested Loop)
          Node 12648 (Hash Join)
            Node 12649 (Seq Scan) - LEAF
            Node 12650 (Hash)
              Node 12651 (Hash Join)
                Node 12652 (Seq Scan) - LEAF
                Node 12653 (Hash)
                  Node 12654 (Seq Scan) - LEAF
          Node 12655 (Index Scan) - LEAF
        Node 12656 (Hash)
          Node 12657 (Hash Join)
            Node 12658 (Seq Scan) - LEAF
            Node 12659 (Hash)
              Node 12660 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12643 | Aggregate | 1200.22 | 1209.26 | 0.8% | operator |
| 12644 | Gather Merge | 1199.24 | 1142.98 | 4.7% | operator |
| 12645 | Sort | 1193.64 | 1109.13 | 7.1% | operator |
| 12646 | Hash Join | 1192.98 | 842.59 | 29.4% | operator |
| 12647 | Nested Loop | 1185.62 | 1216.16 | 2.6% | operator |
| 12656 | Hash | 3.50 | 17.53 | 401.6% | operator |
| 12648 | Hash Join | 214.93 | 384.47 | 78.9% | operator |
| 12655 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 12657 | Hash Join | 3.45 | 85.17 | 2371.0% | operator |
| 12649 | Seq Scan | 150.39 | 201.16 | 33.8% | operator |
| 12650 | Hash | 38.31 | 19.59 | 48.9% | operator |
| 12658 | Seq Scan | 3.10 | 11.47 | 270.4% | operator |
| 12659 | Hash | 0.02 | 16.89 | 105488.0% | operator |
| 12651 | Hash Join | 37.59 | 92.20 | 145.3% | operator |
| 12660 | Seq Scan | 0.01 | 45.79 | 381502.6% | operator |
| 12652 | Seq Scan | 36.41 | 21.86 | 40.0% | operator |
| 12653 | Hash | 0.01 | 16.89 | 112527.2% | operator |
| 12654 | Seq Scan | 0.01 | 45.79 | 457823.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12654 (Seq Scan) - LEAF
...
### Step 2: Node 12652 (Seq Scan) - LEAF
...
### Step 5: Node 12660 (Seq Scan) - LEAF
...
### Step 6: Node 12649 (Seq Scan) - LEAF
...
### Step 8: Node 12658 (Seq Scan) - LEAF
...
### Step 11: Node 12655 (Index Scan) - LEAF
...
### Step 13: Node 12647 (Nested Loop)
...
### Step 17: Node 12644 (Gather Merge)
...
### Step 18: Node 12643 (Aggregate) - ROOT
