...
**Test Query:** Q18_105_seed_853219224
...
```
Node 28900 (Limit) - ROOT
  Node 28901 (Sort)
    Node 28902 (Aggregate)
      Node 28903 (Gather Merge)
        Node 28904 (Incremental Sort)
          Node 28905 (Nested Loop)
            Node 28906 (Merge Join)
              Node 28907 (Sort)
                Node 28908 (Hash Join) [PATTERN: 895c6e8c]
                  Node 28909 (Seq Scan) [consumed] - LEAF
                  Node 28910 (Hash) [consumed]
                    Node 28911 (Aggregate)
                      Node 28912 (Index Scan) - LEAF
              Node 28913 (Sort)
                Node 28914 (Seq Scan) - LEAF
            Node 28915 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 28908 | 28909, 28910 |
...
|------|------|--------|-----------|-----|--------|
| 28900 | Limit | 3042.97 | 1175.21 | 61.4% | operator |
| 28901 | Sort | 2922.68 | 1127.81 | 61.4% | operator |
| 28902 | Aggregate | 2922.63 | 1073.15 | 63.3% | operator |
| 28903 | Gather Merge | 2922.62 | 1073.95 | 63.3% | operator |
| 28904 | Incremental Sort | 2887.34 | 0.00 | 100.0% | operator |
| 28905 | Nested Loop | 2887.29 | 1111.34 | 61.5% | operator |
| 28906 | Merge Join | 2887.24 | 0.00 | 100.0% | operator |
| 28915 | Index Scan | 0.02 | 0.05 | 150.8% | operator |
| 28907 | Sort | 2837.28 | 1095.58 | 61.4% | operator |
| 28913 | Sort | 63.72 | 1074.66 | 1586.6% | operator |
| 28908 | Hash Join | 2837.27 | 471.07 | 83.4% | pattern |
| 28914 | Seq Scan | 52.19 | 18.25 | 65.0% | operator |
| 28911 | Aggregate | 2610.05 | 1073.15 | 58.9% | operator |
| 28912 | Index Scan | 2112.43 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 28912 (Index Scan) - LEAF
...
### Step 3: Node 28908 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 28909, 28910
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 28914 (Seq Scan) - LEAF
...
### Step 7: Node 28906 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 28915 (Index Scan) - LEAF
...
### Step 10: Node 28904 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 28903 (Gather Merge)
