...
**Test Query:** Q7_131_seed_1066524030
...
```
Node 11113 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 11114 (Gather Merge) [consumed]
    Node 11115 (Sort)
      Node 11116 (Hash Join)
        Node 11117 (Nested Loop)
          Node 11118 (Hash Join) [PATTERN: 895c6e8c]
            Node 11119 (Seq Scan) [consumed] - LEAF
            Node 11120 (Hash) [consumed]
              Node 11121 (Hash Join) [PATTERN: f4cb205a]
                Node 11122 (Seq Scan) [consumed] - LEAF
                Node 11123 (Hash) [consumed]
                  Node 11124 (Seq Scan) [consumed] - LEAF
          Node 11125 (Index Scan) - LEAF
        Node 11126 (Hash)
          Node 11127 (Hash Join) [PATTERN: f4cb205a]
            Node 11128 (Seq Scan) [consumed] - LEAF
            Node 11129 (Hash) [consumed]
              Node 11130 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 11121 | 11113, 11114, 11118, 11119, 11120, 11122, 11123, 11124, 11127, 11128, 11129, 11130 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 11127 | 11113, 11114, 11118, 11119, 11120, 11121, 11122, 11123, 11124, 11128, 11129, 11130 |
| Aggregate -> Gather Merge (Out | 2724c080 | 11113 | 11114, 11118, 11119, 11120, 11121, 11122, 11123, 11124, 11127, 11128, 11129, 11130 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 11118 | 11113, 11114, 11119, 11120, 11121, 11122, 11123, 11124, 11127, 11128, 11129, 11130 |
...
|------|------|--------|-----------|-----|--------|
| 11113 | Aggregate | 1178.68 | 1163.13 | 1.3% | pattern |
| 11115 | Sort | 1171.12 | 1109.16 | 5.3% | operator |
| 11116 | Hash Join | 1170.50 | 843.11 | 28.0% | operator |
| 11117 | Nested Loop | 1163.80 | 1215.99 | 4.5% | operator |
| 11126 | Hash | 2.87 | 27.74 | 866.7% | operator |
| 11118 | Hash Join | 216.03 | 304.89 | 41.1% | pattern |
| 11125 | Index Scan | 0.03 | 0.96 | 3006.0% | operator |
| 11127 | Hash Join | 2.82 | 429.36 | 15114.8% | pattern |
| 11121 | Hash Join | 36.36 | 429.38 | 1081.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11121 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 11113, 11114, 11118, 11119, 11120, 11122, 11123, 11124, 11127, 11128, 11129, 11130
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5000
  - HashJoin_nt1=62500
...
### Step 2: Node 11118 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 11113, 11114, 11119, 11120, 11121, 11122, 11123, 11124, 11127, 11128, 11129, 11130
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=38710
  - HashJoin_nt1=483871
...
### Step 3: Node 11125 (Index Scan) - LEAF
...
### Step 4: Node 11127 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 11113, 11114, 11118, 11119, 11120, 11121, 11122, 11123, 11124, 11128, 11129, 11130
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=800
  - HashJoin_nt1=10000
...
### Step 9: Node 11113 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 11114, 11118, 11119, 11120, 11121, 11122, 11123, 11124, 11127, 11128, 11129, 11130
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
