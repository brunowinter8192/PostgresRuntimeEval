...
```
Node 7281 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 7282 (Aggregate) [consumed]
    Node 7283 (Gather Merge) [consumed]
      Node 7284 (Aggregate)
        Node 7285 (Sort) [PATTERN: 3e2d5a00]
          Node 7286 (Hash Join) [consumed]
            Node 7287 (Nested Loop)
              Node 7288 (Hash Join)
                Node 7289 (Seq Scan) - LEAF
                Node 7290 (Hash) [PATTERN: 444761fb]
                  Node 7291 (Hash Join) [consumed]
                    Node 7292 (Seq Scan) [consumed] - LEAF
                    Node 7293 (Hash) [consumed]
                      Node 7294 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 7290 | 7281, 7282, 7283, 7285, 7286, 7291, 7292, 7293, 7294 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 7281 | 7282, 7283, 7285, 7286, 7290, 7291, 7292, 7293, 7294 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 7285 | 7281, 7282, 7283, 7286, 7290, 7291, 7292, 7293, 7294 |
...
|------|------|--------|-----------|-----|--------|
| 7281 | Sort | 1057.52 | 2934.42 | 177.5% | pattern |
| 7284 | Aggregate | 1052.41 | 1128.78 | 7.3% | operator |
| 7285 | Sort | 1052.15 | 1835.91 | 74.5% | pattern |
| 7287 | Nested Loop | 1040.87 | 1188.39 | 14.2% | operator |
| 7299 | Hash | 2.73 | 18.67 | 584.2% | operator |
| 7288 | Hash Join | 215.00 | 253.07 | 17.7% | operator |
| 7298 | Index Scan | 0.07 | -0.22 | 405.6% | operator |
| 7300 | Seq Scan | 2.20 | 12.36 | 461.0% | operator |
| 7289 | Seq Scan | 167.22 | 159.81 | 4.4% | operator |
| 7290 | Hash | 35.00 | 46.85 | 33.9% | pattern |
| 7295 | Seq Scan | 0.01 | 11.81 | 131103.0% | operator |
| 7296 | Hash | 0.04 | 21.05 | 51249.4% | operator |
| 7297 | Seq Scan | 0.04 | 22.93 | 58703.4% | operator |
...
### Step 4: Node 7289 (Seq Scan) - LEAF
...
### Step 5: Node 7290 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 7281, 7282, 7283, 7285, 7286, 7291, 7292, 7293, 7294
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 7298 (Index Scan) - LEAF
...
### Step 8: Node 7300 (Seq Scan) - LEAF
...
### Step 11: Node 7285 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 7281, 7282, 7283, 7286, 7290, 7291, 7292, 7293, 7294
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 7281 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 7282, 7283, 7285, 7286, 7290, 7291, 7292, 7293, 7294
- **Input Features:**
