...
```
Node 6432 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6433 (Gather Merge) [consumed]
    Node 6434 (Sort) [consumed]
      Node 6435 (Aggregate) [consumed]
        Node 6436 (Nested Loop)
          Node 6437 (Seq Scan) - LEAF
          Node 6438 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6432 | 6433, 6434, 6435 |
...
|------|------|--------|-----------|-----|--------|
| 6432 | Aggregate | 1076.91 | 952.19 | 11.6% | pattern |
| 6436 | Nested Loop | 1070.05 | 1255.45 | 17.3% | operator |
| 6437 | Seq Scan | 167.03 | 154.66 | 7.4% | operator |
| 6438 | Index Scan | 0.06 | 11.10 | 17526.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6437 (Seq Scan) - LEAF
...
### Step 2: Node 6438 (Index Scan) - LEAF
