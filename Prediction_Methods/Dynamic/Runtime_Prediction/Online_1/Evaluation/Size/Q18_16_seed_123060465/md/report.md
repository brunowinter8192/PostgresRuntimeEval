...
**Test Query:** Q18_16_seed_123060465
...
```
Node 29732 (Limit) - ROOT
  Node 29733 (Sort)
    Node 29734 (Aggregate)
      Node 29735 (Gather Merge)
        Node 29736 (Incremental Sort)
          Node 29737 (Nested Loop)
            Node 29738 (Merge Join)
              Node 29739 (Sort)
                Node 29740 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29741 (Seq Scan) [consumed] - LEAF
                  Node 29742 (Hash) [consumed]
                    Node 29743 (Aggregate)
                      Node 29744 (Index Scan) - LEAF
              Node 29745 (Sort)
                Node 29746 (Seq Scan) - LEAF
            Node 29747 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29740 | 29741, 29742 |
...
|------|------|--------|-----------|-----|--------|
| 29732 | Limit | 3051.79 | 1175.21 | 61.5% | operator |
| 29733 | Sort | 2931.50 | 1127.81 | 61.5% | operator |
| 29734 | Aggregate | 2931.45 | 1073.15 | 63.4% | operator |
| 29735 | Gather Merge | 2931.43 | 1073.95 | 63.4% | operator |
| 29736 | Incremental Sort | 2896.66 | 0.00 | 100.0% | operator |
| 29737 | Nested Loop | 2896.61 | 1111.34 | 61.6% | operator |
| 29738 | Merge Join | 2896.55 | 0.00 | 100.0% | operator |
| 29747 | Index Scan | 0.02 | 0.05 | 125.7% | operator |
| 29739 | Sort | 2844.76 | 1095.58 | 61.5% | operator |
| 29745 | Sort | 66.12 | 1074.66 | 1525.3% | operator |
| 29740 | Hash Join | 2844.75 | 471.07 | 83.4% | pattern |
| 29746 | Seq Scan | 54.55 | 18.25 | 66.6% | operator |
| 29743 | Aggregate | 2608.96 | 1073.15 | 58.9% | operator |
| 29744 | Index Scan | 2115.88 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29744 (Index Scan) - LEAF
...
### Step 3: Node 29740 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29741, 29742
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29746 (Seq Scan) - LEAF
...
### Step 7: Node 29738 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29747 (Index Scan) - LEAF
...
### Step 10: Node 29736 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29735 (Gather Merge)
