...
**Test Query:** Q3_132_seed_1074728061
...
```
Node 4701 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 4702 (Sort) [consumed]
    Node 4703 (Aggregate) [consumed]
      Node 4704 (Gather) [consumed]
        Node 4705 (Nested Loop)
          Node 4706 (Hash Join) [PATTERN: 895c6e8c]
            Node 4707 (Seq Scan) [consumed] - LEAF
            Node 4708 (Hash) [consumed]
              Node 4709 (Seq Scan) - LEAF
          Node 4710 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4701 | 4702, 4703, 4704, 4706, 4707, 4708 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4706 | 4701, 4702, 4703, 4704, 4707, 4708 |
...
|------|------|--------|-----------|-----|--------|
| 4701 | Limit | 1176.59 | 1151.18 | 2.2% | pattern |
| 4705 | Nested Loop | 1141.48 | 1192.63 | 4.5% | operator |
| 4706 | Hash Join | 208.18 | 242.40 | 16.4% | pattern |
| 4710 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4709 | Seq Scan | 28.23 | 38.57 | 36.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4709 (Seq Scan) - LEAF
...
### Step 2: Node 4706 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4701, 4702, 4703, 4704, 4707, 4708
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46268
  - HashJoin_nt1=231734
...
### Step 3: Node 4710 (Index Scan) - LEAF
...
### Step 5: Node 4701 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4702, 4703, 4704, 4706, 4707, 4708
- **Input Features:**
