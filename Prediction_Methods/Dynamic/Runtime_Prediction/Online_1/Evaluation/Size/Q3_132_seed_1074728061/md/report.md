...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4701 | 4702, 4703, 4704 |
...
| 4705 | Nested Loop | 1141.48 | 1192.54 | 4.5% | operator |
| 4706 | Hash Join | 208.18 | 230.11 | 10.5% | operator |
| 4710 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4707 | Seq Scan | 156.69 | 163.15 | 4.1% | operator |
| 4708 | Hash | 28.80 | 17.75 | 38.4% | operator |
...
### Step 2: Node 4707 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37329.9500
- **Output:** st=27.10, rt=230.11

### Step 5: Node 4710 (Index Scan) - LEAF
...
- **Output:** st=121.24, rt=1192.54

### Step 7: Node 4701 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4702, 4703, 4704
- **Input Features:**
