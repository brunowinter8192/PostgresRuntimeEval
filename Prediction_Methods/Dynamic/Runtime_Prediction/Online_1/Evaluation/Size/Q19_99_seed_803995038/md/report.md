...
**Test Query:** Q19_99_seed_803995038
...
```
Node 32256 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 32257 (Gather) [consumed]
    Node 32258 (Aggregate) [consumed]
      Node 32259 (Hash Join) [consumed]
        Node 32260 (Seq Scan) - LEAF
        Node 32261 (Hash)
          Node 32262 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 32256 | 32257, 32258, 32259 |
...
|------|------|--------|-----------|-----|--------|
| 32256 | Aggregate | 863.94 | 829.33 | 4.0% | pattern |
| 32260 | Seq Scan | 798.37 | 743.46 | 6.9% | operator |
| 32261 | Hash | 44.73 | 8.29 | 81.5% | operator |
| 32262 | Seq Scan | 44.60 | 23.76 | 46.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 32262 (Seq Scan) - LEAF
...
### Step 2: Node 32260 (Seq Scan) - LEAF
...
### Step 4: Node 32256 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 32257, 32258, 32259
- **Input Features:**
  ...
  - Aggregate_Outer_startup_cost=156338.9500
  - Aggregate_Outer_total_cost=156338.9600
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=157339.4900
  - Aggregate_total_cost=157339.5000
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=157338.9500
  - Gather_Outer_total_cost=157339.4600
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=23
  - HashJoin_Outer_nt1=22573
  ...
  - HashJoin_Outer_total_cost=156338.7700
