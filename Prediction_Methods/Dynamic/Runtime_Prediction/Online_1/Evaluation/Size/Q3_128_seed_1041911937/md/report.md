    ...
    Node 4653 (Aggregate) [consumed]
      Node 4654 (Gather) [consumed]
        Node 4655 (Nested Loop)
          Node 4656 (Hash Join) [PATTERN: 895c6e8c]
            Node 4657 (Seq Scan) [consumed] - LEAF
            Node 4658 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4651 | 4652, 4653, 4654, 4656, 4657, 4658 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4656 | 4651, 4652, 4653, 4654, 4657, 4658 |
...
|------|------|--------|-----------|-----|--------|
| 4651 | Limit | 1192.69 | 1151.18 | 3.5% | pattern |
| 4655 | Nested Loop | 1158.07 | 1193.06 | 3.0% | operator |
| 4656 | Hash Join | 204.30 | 242.48 | 18.7% | pattern |
| 4660 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4659 | Seq Scan | 30.29 | 38.54 | 27.2% | operator |
...
### Step 2: Node 4656 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4651, 4652, 4653, 4654, 4657, 4658
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46938
  - HashJoin_nt1=233583
  ...
  - HashJoin_total_cost=37335.8000
  - Hash_Inner_np=0
  - Hash_Inner_nt=12559
...
- **Output:** st=29.76, rt=242.48

### Step 3: Node 4660 (Index Scan) - LEAF
...
- **Output:** st=121.80, rt=1193.06

### Step 5: Node 4651 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4652, 4653, 4654, 4656, 4657, 4658
- **Input Features:**
