...
**Test Query:** Q12_16_seed_123060465
...
```
Node 24719 (Aggregate) - ROOT
  Node 24720 (Gather Merge)
    Node 24721 (Aggregate)
      Node 24722 (Sort)
        Node 24723 (Nested Loop)
          Node 24724 (Seq Scan) - LEAF
          Node 24725 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24719 | Aggregate | 994.76 | 919.09 | 7.6% | operator |
| 24720 | Gather Merge | 994.74 | 1111.84 | 11.8% | operator |
| 24721 | Aggregate | 974.26 | 895.33 | 8.1% | operator |
| 24722 | Sort | 973.64 | 1092.79 | 12.2% | operator |
| 24723 | Nested Loop | 972.73 | 1127.41 | 15.9% | operator |
| 24724 | Seq Scan | 839.40 | 745.19 | 11.2% | operator |
| 24725 | Index Scan | 0.03 | 0.07 | 187.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24724 (Seq Scan) - LEAF
...
### Step 2: Node 24725 (Index Scan) - LEAF
...
### Step 6: Node 24720 (Gather Merge)
...
### Step 7: Node 24719 (Aggregate) - ROOT
