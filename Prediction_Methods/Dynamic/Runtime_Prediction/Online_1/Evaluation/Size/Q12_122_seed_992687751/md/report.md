...
**Test Query:** Q12_122_seed_992687751
**Timestamp:** 2026-01-18 19:48:20
...
```
Node 24488 (Aggregate) - ROOT
  Node 24489 (Gather Merge)
    Node 24490 (Aggregate)
      Node 24491 (Sort)
        Node 24492 (Nested Loop)
          Node 24493 (Seq Scan) - LEAF
          Node 24494 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24488 | Aggregate | 994.99 | 919.05 | 7.6% | operator |
| 24489 | Gather Merge | 994.97 | 1111.84 | 11.7% | operator |
| 24490 | Aggregate | 975.54 | 895.30 | 8.2% | operator |
| 24491 | Sort | 974.92 | 1092.82 | 12.1% | operator |
| 24492 | Nested Loop | 973.94 | 1127.41 | 15.8% | operator |
| 24493 | Seq Scan | 843.22 | 745.19 | 11.6% | operator |
| 24494 | Index Scan | 0.03 | 0.07 | 187.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24493 (Seq Scan) - LEAF
...
### Step 2: Node 24494 (Index Scan) - LEAF
...
### Step 6: Node 24489 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=868.9453
  - st2=0.0000
  - startup_cost=148549.3400
  - total_cost=148669.4500
- **Output:** st=1109.22, rt=1111.84

### Step 7: Node 24488 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=148549.3400
  - total_cost=148669.7800
- **Output:** st=903.58, rt=919.05
