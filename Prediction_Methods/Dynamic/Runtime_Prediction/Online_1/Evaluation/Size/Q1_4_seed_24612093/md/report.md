...
```
Node 471 (Aggregate) - ROOT
  Node 472 (Gather Merge)
    Node 473 (Sort) [PATTERN: 1d35fb97]
      Node 474 (Aggregate) [consumed]
        Node 475 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 473 | 474 |
...
|------|------|--------|-----------|-----|--------|
| 471 | Aggregate | 1079.46 | 1195.97 | 10.8% | operator |
| 472 | Gather Merge | 1079.40 | 1165.93 | 8.0% | operator |
| 473 | Sort | 1060.02 | 1200.82 | 13.3% | pattern |
| 475 | Seq Scan | 648.68 | 679.07 | 4.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 475 (Seq Scan) - LEAF
...
### Step 2: Node 473 (Sort) - PATTERN ROOT
...
### Step 4: Node 471 (Aggregate) - ROOT
