...
```
Node 8981 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 8982 (Aggregate) [consumed]
    Node 8983 (Gather Merge) [consumed]
      Node 8984 (Aggregate)
          ...
          Node 8986 (Hash Join) [consumed]
            Node 8987 (Nested Loop)
              Node 8988 (Hash Join)
                ...
                Node 8990 (Hash) [PATTERN: 444761fb]
                  Node 8991 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 8990 | 8981, 8982, 8983, 8985, 8986, 8991, 8992, 8993, 8994 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 8981 | 8982, 8983, 8985, 8986, 8990, 8991, 8992, 8993, 8994 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 8985 | 8981, 8982, 8983, 8986, 8990, 8991, 8992, 8993, 8994 |
...
|------|------|--------|-----------|-----|--------|
| 8981 | Sort | 1058.80 | 2934.42 | 177.1% | pattern |
| 8984 | Aggregate | 1052.90 | 1128.79 | 7.2% | operator |
| 8985 | Sort | 1052.63 | 1835.90 | 74.4% | pattern |
| 8987 | Nested Loop | 1041.57 | 1188.37 | 14.1% | operator |
| 8999 | Hash | 2.35 | 18.67 | 693.8% | operator |
| 8988 | Hash Join | 220.33 | 253.07 | 14.9% | operator |
| 8998 | Index Scan | 0.07 | -0.22 | 405.6% | operator |
| 9000 | Seq Scan | 1.75 | 12.36 | 604.6% | operator |
| 8989 | Seq Scan | 169.23 | 159.81 | 5.6% | operator |
| 8990 | Hash | 37.94 | 46.85 | 23.5% | pattern |
| 8995 | Seq Scan | 0.01 | 11.81 | 117982.7% | operator |
| 8996 | Hash | 0.06 | 21.05 | 37495.1% | operator |
| 8997 | Seq Scan | 0.05 | 22.93 | 42369.1% | operator |
...
### Step 4: Node 8989 (Seq Scan) - LEAF
...
### Step 5: Node 8990 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 8981, 8982, 8983, 8985, 8986, 8991, 8992, 8993, 8994
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 8998 (Index Scan) - LEAF
...
### Step 8: Node 9000 (Seq Scan) - LEAF
...
### Step 11: Node 8985 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 8981, 8982, 8983, 8986, 8990, 8991, 8992, 8993, 8994
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 8981 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 8982, 8983, 8985, 8986, 8990, 8991, 8992, 8993, 8994
- **Input Features:**
