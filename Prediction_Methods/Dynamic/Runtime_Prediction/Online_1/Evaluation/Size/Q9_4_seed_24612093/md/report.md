...
```
Node 18354 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18355 (Aggregate) [consumed]
    Node 18356 (Gather)
      Node 18357 (Aggregate)
        Node 18358 (Nested Loop)
          Node 18359 (Hash Join) [PATTERN: bb930825]
            Node 18360 (Seq Scan) [consumed] - LEAF
            Node 18361 (Hash) [consumed]
              Node 18362 (Hash Join) [consumed]
                Node 18363 (Hash Join)
                  Node 18364 (Nested Loop)
                    Node 18365 (Seq Scan) - LEAF
                    Node 18366 (Index Scan) - LEAF
                  Node 18367 (Hash)
                    Node 18368 (Seq Scan) - LEAF
                Node 18369 (Hash)
                  Node 18370 (Seq Scan) - LEAF
          Node 18371 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18359 | 18354, 18355, 18360, 18361, 18362 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18354 | 18355, 18359, 18360, 18361, 18362 |
...
|------|------|--------|-----------|-----|--------|
| 18354 | Sort | 1186.30 | 1045.59 | 11.9% | pattern |
| 18356 | Gather | 1185.36 | 964.55 | 18.6% | operator |
| 18357 | Aggregate | 1164.74 | 1085.45 | 6.8% | operator |
| 18358 | Nested Loop | 1139.88 | 1252.17 | 9.9% | operator |
| 18359 | Hash Join | 961.20 | 134.80 | 86.0% | pattern |
| 18371 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18363 | Hash Join | 155.36 | 837.63 | 439.2% | operator |
| 18369 | Hash | 13.35 | 14.95 | 12.0% | operator |
| 18364 | Nested Loop | 150.25 | 1251.77 | 733.1% | operator |
| 18367 | Hash | 2.79 | 15.94 | 470.5% | operator |
| 18370 | Seq Scan | 13.33 | 2.94 | 78.0% | operator |
| 18365 | Seq Scan | 20.66 | 43.96 | 112.7% | operator |
| 18366 | Index Scan | 0.07 | -1.39 | 2028.4% | operator |
| 18368 | Seq Scan | 2.22 | 9.45 | 326.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 18365 (Seq Scan) - LEAF
...
### Step 2: Node 18366 (Index Scan) - LEAF
...
### Step 3: Node 18368 (Seq Scan) - LEAF
...
### Step 6: Node 18370 (Seq Scan) - LEAF
...
### Step 9: Node 18359 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18354, 18355, 18360, 18361, 18362
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18371 (Index Scan) - LEAF
...
### Step 11: Node 18358 (Nested Loop)
...
### Step 14: Node 18354 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18355, 18359, 18360, 18361, 18362
- **Input Features:**
