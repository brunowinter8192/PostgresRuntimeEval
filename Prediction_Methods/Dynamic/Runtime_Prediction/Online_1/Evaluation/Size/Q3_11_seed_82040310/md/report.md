...
**Test Query:** Q3_11_seed_82040310
...
```
Node 4561 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 4562 (Sort) [consumed]
    Node 4563 (Aggregate) [consumed]
      Node 4564 (Gather) [consumed]
        Node 4565 (Nested Loop)
          Node 4566 (Hash Join) [PATTERN: 895c6e8c]
            Node 4567 (Seq Scan) [consumed] - LEAF
            Node 4568 (Hash) [consumed]
              Node 4569 (Seq Scan) - LEAF
          Node 4570 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4561 | 4562, 4563, 4564, 4566, 4567, 4568 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4566 | 4561, 4562, 4563, 4564, 4567, 4568 |
...
|------|------|--------|-----------|-----|--------|
| 4561 | Limit | 1236.65 | 1151.18 | 6.9% | pattern |
| 4565 | Nested Loop | 1201.44 | 1192.67 | 0.7% | operator |
| 4566 | Hash Join | 208.84 | 242.40 | 16.1% | pattern |
| 4570 | Index Scan | 0.03 | -0.52 | 2018.8% | operator |
| 4569 | Seq Scan | 28.91 | 38.60 | 33.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4569 (Seq Scan) - LEAF
...
### Step 2: Node 4566 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4561, 4562, 4563, 4564, 4567, 4568
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46330
  - HashJoin_nt1=233583
  ...
  - HashJoin_total_cost=37333.7800
  - Hash_Inner_np=0
  - Hash_Inner_nt=12397
...
- **Input Features:**
  ...
  - total_cost=72477.5000
- **Output:** st=121.45, rt=1192.67

### Step 5: Node 4561 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4562, 4563, 4564, 4566, 4567, 4568
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=311142
  - Aggregate_Outer_nt1=311142
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=109258.8300
  - Aggregate_Outer_total_cost=113148.1000
  - Gather_Outer_np=0
  - Gather_Outer_nt=311142
  - Gather_Outer_nt1=100368
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=104591.7000
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=311142
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=119871.7700
  - Limit_total_cost=119871.7900
  - Sort_Outer_np=0
  - Sort_Outer_nt=311142
  - Sort_Outer_nt1=311142
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=119871.7700
  - Sort_Outer_total_cost=120649.6200
