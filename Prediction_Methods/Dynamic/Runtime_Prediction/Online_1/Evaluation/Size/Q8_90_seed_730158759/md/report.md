...
```
Node 16398 (Aggregate) - ROOT
  Node 16399 (Gather Merge)
    Node 16400 (Sort)
          ...
          Node 16403 (Hash Join)
            Node 16404 (Nested Loop)
              Node 16405 (Hash Join)
                ...
                Node 16407 (Hash)
                  Node 16408 (Hash Join)
                    Node 16409 (Seq Scan) - LEAF
                    Node 16410 (Hash)
                      Node 16411 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 16398 | Aggregate | 1211.66 | 1191.06 | 1.7% | operator |
| 16399 | Gather Merge | 1211.28 | 1097.19 | 9.4% | operator |
...
| 16405 | Hash Join | 209.13 | 251.17 | 20.1% | operator |
...
| 16407 | Hash | 32.99 | 20.62 | 37.5% | operator |
| 16408 | Hash Join | 32.41 | 132.26 | 308.1% | operator |
| 16409 | Seq Scan | 30.85 | 23.03 | 25.3% | operator |
| 16410 | Hash | 0.24 | 23.66 | 9756.7% | operator |
| 16411 | Hash Join | 0.24 | 306.84 | 129366.6% | operator |
...
### Step 5: Node 16409 (Seq Scan) - LEAF
...
### Step 8: Node 16406 (Seq Scan) - LEAF
...
### Step 11: Node 16415 (Index Scan) - LEAF
...
### Step 12: Node 16417 (Seq Scan) - LEAF
...
### Step 13: Node 16404 (Nested Loop)
...
### Step 16: Node 16418 (Index Scan) - LEAF
...
### Step 17: Node 16420 (Seq Scan) - LEAF
...
### Step 18: Node 16402 (Nested Loop)
...
### Step 22: Node 16399 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1044.9436
  - st2=0.0000
  - startup_cost=71555.8000
  - total_cost=71846.4800
- **Output:** st=1093.48, rt=1097.19

### Step 23: Node 16398 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=71555.8000
  - total_cost=71943.7400
- **Output:** st=1162.06, rt=1191.06
