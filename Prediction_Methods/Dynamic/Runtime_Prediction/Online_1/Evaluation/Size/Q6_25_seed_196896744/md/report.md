...
**Test Query:** Q6_25_seed_196896744
...
```
Node 10169 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10170 (Gather) [consumed]
    Node 10171 (Aggregate) [consumed]
      Node 10172 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10169 | 10170, 10171 |
...
|------|------|--------|-----------|-----|--------|
| 10169 | Aggregate | 783.67 | 850.04 | 8.5% | pattern |
| 10172 | Seq Scan | 763.12 | 748.53 | 1.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10172 (Seq Scan) - LEAF
...
### Step 2: Node 10169 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10170, 10171
- **Input Features:**
