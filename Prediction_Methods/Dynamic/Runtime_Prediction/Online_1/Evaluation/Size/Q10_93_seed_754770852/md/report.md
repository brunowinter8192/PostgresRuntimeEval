    ...
    Node 21218 (Aggregate) [consumed]
      Node 21219 (Gather) [consumed]
        Node 21220 (Hash Join)
          Node 21221 (Hash Join)
            Node 21222 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 21216 | 21217, 21218, 21219 |
...
| 21220 | Hash Join | 1108.86 | 1007.29 | 9.2% | operator |
| 21221 | Hash Join | 1105.98 | 1004.25 | 9.2% | operator |
| 21227 | Hash | 0.01 | 15.71 | 104638.5% | operator |
| 21222 | Nested Loop | 1058.69 | 1204.76 | 13.8% | operator |
| 21225 | Hash | 36.99 | 55.57 | 50.2% | operator |
...
### Step 6: Node 21228 (Seq Scan) - LEAF
...
### Step 10: Node 21216 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 21217, 21218, 21219
- **Input Features:**
