        ...
        Node 30472 (Incremental Sort)
          Node 30473 (Nested Loop)
            Node 30474 (Merge Join)
              Node 30475 (Sort)
                Node 30476 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30477 (Seq Scan) [consumed] - LEAF
                  Node 30478 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30476 | 30477, 30478 |
...
| 30475 | Sort | 2870.03 | 1095.58 | 61.8% | operator |
| 30481 | Sort | 65.56 | 1074.66 | 1539.2% | operator |
| 30476 | Hash Join | 2870.01 | 471.07 | 83.6% | pattern |
...
### Step 3: Node 30476 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30477, 30478
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30482 (Seq Scan) - LEAF
...
### Step 7: Node 30474 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30483 (Index Scan) - LEAF
...
### Step 10: Node 30472 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30471 (Gather Merge)
