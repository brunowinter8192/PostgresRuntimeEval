...
**Test Query:** Q5_90_seed_730158759
...
```
Node 9681 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 9682 (Aggregate) [consumed]
    Node 9683 (Gather Merge) [consumed]
      Node 9684 (Aggregate)
        Node 9685 (Sort) [PATTERN: 3e2d5a00]
          Node 9686 (Hash Join) [consumed]
            Node 9687 (Nested Loop)
              Node 9688 (Hash Join)
                Node 9689 (Seq Scan) - LEAF
                Node 9690 (Hash) [PATTERN: 444761fb]
                  Node 9691 (Hash Join) [consumed]
                    Node 9692 (Seq Scan) [consumed] - LEAF
                    Node 9693 (Hash) [consumed]
                      Node 9694 (Hash Join) [consumed]
                        Node 9695 (Seq Scan) - LEAF
                        Node 9696 (Hash)
                          Node 9697 (Seq Scan) - LEAF
              Node 9698 (Index Scan) - LEAF
            Node 9699 (Hash)
              Node 9700 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 9690 | 9681, 9682, 9683, 9685, 9686, 9691, 9692, 9693, 9694 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 9681 | 9682, 9683, 9685, 9686, 9690, 9691, 9692, 9693, 9694 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 9685 | 9681, 9682, 9683, 9686, 9690, 9691, 9692, 9693, 9694 |
...
|------|------|--------|-----------|-----|--------|
| 9681 | Sort | 1069.79 | 2934.42 | 174.3% | pattern |
| 9684 | Aggregate | 1064.52 | 1128.79 | 6.0% | operator |
| 9685 | Sort | 1064.25 | 1835.90 | 72.5% | pattern |
| 9687 | Nested Loop | 1050.07 | 1188.37 | 13.2% | operator |
| 9699 | Hash | 5.46 | 18.67 | 242.3% | operator |
| 9688 | Hash Join | 216.58 | 253.07 | 16.9% | operator |
| 9698 | Index Scan | 0.07 | -0.22 | 405.6% | operator |
| 9700 | Seq Scan | 4.95 | 12.36 | 149.5% | operator |
| 9689 | Seq Scan | 169.90 | 159.81 | 5.9% | operator |
| 9690 | Hash | 33.51 | 46.85 | 39.8% | pattern |
| 9695 | Seq Scan | 0.01 | 11.81 | 147503.4% | operator |
| 9696 | Hash | 0.06 | 21.05 | 36198.7% | operator |
| 9697 | Seq Scan | 0.06 | 22.93 | 41597.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 9697 (Seq Scan) - LEAF
...
### Step 2: Node 9695 (Seq Scan) - LEAF
...
### Step 4: Node 9689 (Seq Scan) - LEAF
...
### Step 5: Node 9690 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 9681, 9682, 9683, 9685, 9686, 9691, 9692, 9693, 9694
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 9698 (Index Scan) - LEAF
...
### Step 8: Node 9700 (Seq Scan) - LEAF
...
### Step 11: Node 9685 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 9681, 9682, 9683, 9686, 9690, 9691, 9692, 9693, 9694
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 9681 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 9682, 9683, 9685, 9686, 9690, 9691, 9692, 9693, 9694
- **Input Features:**
