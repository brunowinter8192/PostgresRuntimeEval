...
Node 721 (Aggregate) - ROOT
  Node 722 (Gather Merge)
    Node 723 (Sort) [PATTERN: 1d35fb97]
      Node 724 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 723 | 724 |
...
|------|------|--------|-----------|-----|--------|
| 721 | Aggregate | 926.85 | 1195.86 | 29.0% | operator |
| 722 | Gather Merge | 926.79 | 1165.90 | 25.8% | operator |
| 723 | Sort | 908.52 | 1200.41 | 32.1% | pattern |
...
### Step 2: Node 723 (Sort) - PATTERN ROOT
...
### Step 4: Node 721 (Aggregate) - ROOT
