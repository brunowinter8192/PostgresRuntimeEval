...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4591 | 4592, 4593, 4594 |
...
| 4595 | Nested Loop | 1166.03 | 1193.11 | 2.3% | operator |
| 4596 | Hash Join | 211.64 | 230.97 | 9.1% | operator |
| 4600 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4597 | Seq Scan | 157.58 | 163.46 | 3.7% | operator |
| 4598 | Hash | 30.74 | 17.75 | 42.3% | operator |
...
### Step 2: Node 4597 (Seq Scan) - LEAF
...
- **Output:** st=27.24, rt=230.97

### Step 5: Node 4600 (Index Scan) - LEAF
...
- **Output:** st=121.80, rt=1193.11

### Step 7: Node 4591 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4592, 4593, 4594
- **Input Features:**
