...
**Test Query:** Q3_122_seed_992687751
...
```
Node 4591 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 4592 (Sort) [consumed]
    Node 4593 (Aggregate) [consumed]
      Node 4594 (Gather) [consumed]
        Node 4595 (Nested Loop)
          Node 4596 (Hash Join) [PATTERN: 895c6e8c]
            Node 4597 (Seq Scan) [consumed] - LEAF
            Node 4598 (Hash) [consumed]
              Node 4599 (Seq Scan) - LEAF
          Node 4600 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4591 | 4592, 4593, 4594, 4596, 4597, 4598 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4596 | 4591, 4592, 4593, 4594, 4597, 4598 |
...
|------|------|--------|-----------|-----|--------|
| 4591 | Limit | 1201.25 | 1151.18 | 4.2% | pattern |
| 4595 | Nested Loop | 1166.03 | 1193.19 | 2.3% | operator |
| 4596 | Hash Join | 211.64 | 242.50 | 14.6% | pattern |
| 4600 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4599 | Seq Scan | 29.73 | 38.57 | 29.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4599 (Seq Scan) - LEAF
...
### Step 2: Node 4596 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4591, 4592, 4593, 4594, 4597, 4598
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47139
  - HashJoin_nt1=236095
...
- **Output:** st=29.71, rt=242.50

### Step 3: Node 4600 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=73000.4600
- **Output:** st=121.94, rt=1193.19

### Step 5: Node 4591 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4592, 4593, 4594, 4596, 4597, 4598
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=313663
  - Aggregate_Outer_nt1=313663
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110071.7000
  - Aggregate_Outer_total_cost=113992.4900
  - Gather_Outer_np=0
  - Gather_Outer_nt=313663
  - Gather_Outer_nt1=101182
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105366.7600
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=313663
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=120770.6300
  - Limit_total_cost=120770.6600
  - Sort_Outer_np=0
  - Sort_Outer_nt=313663
  - Sort_Outer_nt1=313663
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=120770.6300
  - Sort_Outer_total_cost=121554.7900
