...
**Test Query:** Q3_23_seed_180488682
...
```
Node 5001 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5002 (Sort) [consumed]
    Node 5003 (Aggregate) [consumed]
      Node 5004 (Gather) [consumed]
        Node 5005 (Nested Loop)
          Node 5006 (Hash Join) [PATTERN: 895c6e8c]
            Node 5007 (Seq Scan) [consumed] - LEAF
            Node 5008 (Hash) [consumed]
              Node 5009 (Seq Scan) - LEAF
          Node 5010 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5001 | 5002, 5003, 5004, 5006, 5007, 5008 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5006 | 5001, 5002, 5003, 5004, 5007, 5008 |
...
|------|------|--------|-----------|-----|--------|
| 5001 | Limit | 1224.39 | 1151.18 | 6.0% | pattern |
| 5005 | Nested Loop | 1187.44 | 1193.00 | 0.5% | operator |
| 5006 | Hash Join | 210.88 | 242.47 | 15.0% | pattern |
| 5010 | Index Scan | 0.03 | -0.52 | 2018.8% | operator |
| 5009 | Seq Scan | 27.29 | 38.57 | 41.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5009 (Seq Scan) - LEAF
...
### Step 2: Node 5006 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5001, 5002, 5003, 5004, 5007, 5008
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46842
  - HashJoin_nt1=234610
...
### Step 3: Node 5010 (Index Scan) - LEAF
...
### Step 5: Node 5001 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5002, 5003, 5004, 5006, 5007, 5008
- **Input Features:**
