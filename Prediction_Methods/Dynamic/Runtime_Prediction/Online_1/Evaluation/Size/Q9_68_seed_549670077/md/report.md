...
```
Node 18715 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18716 (Aggregate) [consumed]
    Node 18717 (Gather)
      Node 18718 (Aggregate)
        Node 18719 (Nested Loop)
          Node 18720 (Hash Join) [PATTERN: bb930825]
            Node 18721 (Seq Scan) [consumed] - LEAF
            Node 18722 (Hash) [consumed]
              Node 18723 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18720 | 18715, 18716, 18721, 18722, 18723 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18715 | 18716, 18720, 18721, 18722, 18723 |
...
|------|------|--------|-----------|-----|--------|
| 18715 | Sort | 1191.53 | 1044.29 | 12.4% | pattern |
...
| 18720 | Hash Join | 971.90 | 134.80 | 86.1% | pattern |
...
### Step 9: Node 18720 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18715, 18716, 18721, 18722, 18723
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18732 (Index Scan) - LEAF
...
### Step 11: Node 18719 (Nested Loop)
...
### Step 14: Node 18715 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18716, 18720, 18721, 18722, 18723
- **Input Features:**
