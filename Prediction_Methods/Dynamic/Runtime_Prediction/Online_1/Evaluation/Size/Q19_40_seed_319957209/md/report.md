...
```
Node 31808 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31809 (Gather) [consumed]
    Node 31810 (Aggregate) [consumed]
      Node 31811 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31808 | 31809, 31810 |
...
|------|------|--------|-----------|-----|--------|
| 31808 | Aggregate | 836.35 | 831.20 | 0.6% | pattern |
| 31811 | Hash Join | 817.28 | 766.05 | 6.3% | operator |
...
### Step 5: Node 31808 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31809, 31810
- **Input Features:**
