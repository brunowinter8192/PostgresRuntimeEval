...
**Test Query:** Q19_40_seed_319957209
...
```
Node 31808 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31809 (Gather) [consumed]
    Node 31810 (Aggregate) [consumed]
      Node 31811 (Hash Join) [consumed]
        Node 31812 (Seq Scan) - LEAF
        Node 31813 (Hash)
          Node 31814 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31808 | 31809, 31810, 31811 |
...
|------|------|--------|-----------|-----|--------|
| 31808 | Aggregate | 836.35 | 829.29 | 0.8% | pattern |
| 31812 | Seq Scan | 770.84 | 743.46 | 3.6% | operator |
| 31813 | Hash | 44.51 | 8.29 | 81.4% | operator |
| 31814 | Seq Scan | 44.35 | 23.76 | 46.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31814 (Seq Scan) - LEAF
...
### Step 2: Node 31812 (Seq Scan) - LEAF
...
### Step 4: Node 31808 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31809, 31810, 31811
- **Input Features:**
