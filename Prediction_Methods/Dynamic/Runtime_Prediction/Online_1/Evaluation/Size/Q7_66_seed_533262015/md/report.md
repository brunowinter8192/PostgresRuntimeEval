...
```
Node 12517 (Aggregate) - ROOT
  Node 12518 (Gather Merge)
    Node 12519 (Sort)
      Node 12520 (Hash Join)
        Node 12521 (Nested Loop)
          Node 12522 (Hash Join)
            Node 12523 (Seq Scan) - LEAF
            Node 12524 (Hash)
              Node 12525 (Hash Join)
                Node 12526 (Seq Scan) - LEAF
                Node 12527 (Hash)
                  Node 12528 (Seq Scan) - LEAF
          Node 12529 (Index Scan) - LEAF
        Node 12530 (Hash)
          Node 12531 (Hash Join)
            Node 12532 (Seq Scan) - LEAF
            Node 12533 (Hash)
              Node 12534 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12517 | Aggregate | 1211.01 | 1209.26 | 0.1% | operator |
| 12518 | Gather Merge | 1209.90 | 1142.98 | 5.5% | operator |
| 12519 | Sort | 1203.78 | 1109.13 | 7.9% | operator |
| 12520 | Hash Join | 1203.11 | 842.59 | 30.0% | operator |
| 12521 | Nested Loop | 1196.60 | 1216.16 | 1.6% | operator |
| 12530 | Hash | 2.61 | 17.53 | 571.4% | operator |
| 12522 | Hash Join | 214.10 | 384.47 | 79.6% | operator |
| 12529 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 12531 | Hash Join | 2.56 | 85.17 | 3223.2% | operator |
| 12523 | Seq Scan | 152.13 | 201.16 | 32.2% | operator |
| 12524 | Hash | 37.18 | 19.59 | 47.3% | operator |
| 12532 | Seq Scan | 2.21 | 11.47 | 418.3% | operator |
| 12533 | Hash | 0.01 | 16.89 | 129854.5% | operator |
| 12525 | Hash Join | 35.80 | 92.20 | 157.6% | operator |
| 12534 | Seq Scan | 0.01 | 45.79 | 508703.5% | operator |
| 12526 | Seq Scan | 34.68 | 21.86 | 37.0% | operator |
| 12527 | Hash | 0.01 | 16.89 | 153482.6% | operator |
| 12528 | Seq Scan | 0.01 | 45.79 | 572303.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12528 (Seq Scan) - LEAF
...
### Step 2: Node 12526 (Seq Scan) - LEAF
...
### Step 5: Node 12534 (Seq Scan) - LEAF
...
### Step 6: Node 12523 (Seq Scan) - LEAF
...
### Step 8: Node 12532 (Seq Scan) - LEAF
...
### Step 11: Node 12529 (Index Scan) - LEAF
...
### Step 13: Node 12521 (Nested Loop)
...
### Step 17: Node 12518 (Gather Merge)
...
### Step 18: Node 12517 (Aggregate) - ROOT
