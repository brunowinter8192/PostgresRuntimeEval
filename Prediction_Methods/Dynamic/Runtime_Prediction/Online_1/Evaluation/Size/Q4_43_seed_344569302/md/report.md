...
**Test Query:** Q4_43_seed_344569302
...
```
Node 6460 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6461 (Gather Merge) [consumed]
    Node 6462 (Sort) [consumed]
      Node 6463 (Aggregate) [consumed]
        Node 6464 (Nested Loop)
          Node 6465 (Seq Scan) - LEAF
          Node 6466 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6460 | 6461, 6462, 6463 |
...
|------|------|--------|-----------|-----|--------|
| 6460 | Aggregate | 1047.48 | 952.19 | 9.1% | pattern |
| 6464 | Nested Loop | 1041.09 | 1255.45 | 20.6% | operator |
| 6465 | Seq Scan | 162.99 | 154.66 | 5.1% | operator |
| 6466 | Index Scan | 0.06 | 11.10 | 18103.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6465 (Seq Scan) - LEAF
...
### Step 2: Node 6466 (Index Scan) - LEAF
