...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4451 | 4452, 4453, 4454 |
...
| 4455 | Nested Loop | 1169.89 | 1192.63 | 1.9% | operator |
| 4456 | Hash Join | 208.86 | 230.52 | 10.4% | operator |
| 4460 | Index Scan | 0.03 | -0.52 | 2018.8% | operator |
| 4457 | Seq Scan | 156.52 | 163.31 | 4.3% | operator |
| 4458 | Hash | 29.70 | 17.75 | 40.2% | operator |
...
### Step 2: Node 4457 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37334.8100
- **Output:** st=27.19, rt=230.52

### Step 5: Node 4460 (Index Scan) - LEAF
...
- **Output:** st=121.35, rt=1192.63

### Step 7: Node 4451 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4452, 4453, 4454
- **Input Features:**
