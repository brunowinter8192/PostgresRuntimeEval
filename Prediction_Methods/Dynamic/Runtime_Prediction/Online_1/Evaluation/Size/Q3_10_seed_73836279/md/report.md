...
**Test Query:** Q3_10_seed_73836279
...
```
Node 4451 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 4452 (Sort) [consumed]
    Node 4453 (Aggregate) [consumed]
      Node 4454 (Gather) [consumed]
        Node 4455 (Nested Loop)
          Node 4456 (Hash Join) [PATTERN: 895c6e8c]
            Node 4457 (Seq Scan) [consumed] - LEAF
            Node 4458 (Hash) [consumed]
              Node 4459 (Seq Scan) - LEAF
          Node 4460 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4451 | 4452, 4453, 4454, 4456, 4457, 4458 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4456 | 4451, 4452, 4453, 4454, 4457, 4458 |
...
|------|------|--------|-----------|-----|--------|
| 4451 | Limit | 1208.36 | 1151.18 | 4.7% | pattern |
| 4455 | Nested Loop | 1169.89 | 1192.72 | 2.0% | operator |
| 4456 | Hash Join | 208.86 | 242.41 | 16.1% | pattern |
| 4460 | Index Scan | 0.03 | -0.52 | 2018.8% | operator |
| 4459 | Seq Scan | 29.05 | 38.60 | 32.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4459 (Seq Scan) - LEAF
...
### Step 2: Node 4456 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4451, 4452, 4453, 4454, 4457, 4458
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46409
  - HashJoin_nt1=233978
  ...
  - HashJoin_total_cost=37334.8100
  - Hash_Inner_np=0
  - Hash_Inner_nt=12397
...
### Step 3: Node 4460 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=72523.1000
- **Output:** st=121.50, rt=1192.72

### Step 5: Node 4451 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4452, 4453, 4454, 4456, 4457, 4458
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=311229
  - Aggregate_Outer_nt1=311229
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=109314.4400
  - Aggregate_Outer_total_cost=113204.8000
  - Gather_Outer_np=0
  - Gather_Outer_nt=311229
  - Gather_Outer_nt1=100396
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=104646.0000
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=311229
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=119930.3500
  - Limit_total_cost=119930.3700
  - Sort_Outer_np=0
  - Sort_Outer_nt=311229
  - Sort_Outer_nt1=311229
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=119930.3500
  - Sort_Outer_total_cost=120708.4200
