...
**Test Query:** Q3_85_seed_689138604
...
```
Node 5681 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5682 (Sort) [consumed]
    Node 5683 (Aggregate) [consumed]
      Node 5684 (Gather) [consumed]
        Node 5685 (Nested Loop)
          Node 5686 (Hash Join) [PATTERN: 895c6e8c]
            Node 5687 (Seq Scan) [consumed] - LEAF
            Node 5688 (Hash) [consumed]
              Node 5689 (Seq Scan) - LEAF
          Node 5690 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5681 | 5682, 5683, 5684, 5686, 5687, 5688 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5686 | 5681, 5682, 5683, 5684, 5687, 5688 |
...
|------|------|--------|-----------|-----|--------|
| 5681 | Limit | 1191.48 | 1151.18 | 3.4% | pattern |
| 5685 | Nested Loop | 1155.14 | 1193.05 | 3.3% | operator |
| 5686 | Hash Join | 212.18 | 242.48 | 14.3% | pattern |
| 5690 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5689 | Seq Scan | 31.22 | 38.53 | 23.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5689 (Seq Scan) - LEAF
...
### Step 2: Node 5686 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5681, 5682, 5683, 5684, 5687, 5688
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46915
  - HashJoin_nt1=233109
...
- **Input Features:**
  ...
  - total_cost=72940.9900
- **Output:** st=121.78, rt=1193.05

### Step 5: Node 5681 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5682, 5683, 5684, 5686, 5687, 5688
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=315627
  - Aggregate_Outer_nt1=315627
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110238.1000
  - Aggregate_Outer_total_cost=114183.4300
  - Gather_Outer_np=0
  - Gather_Outer_nt=315627
  - Gather_Outer_nt1=101815
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105503.6900
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=315627
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=121004.0200
  - Limit_total_cost=121004.0400
  - Sort_Outer_np=0
  - Sort_Outer_nt=315627
  - Sort_Outer_nt1=315627
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=121004.0200
  - Sort_Outer_total_cost=121793.0900
