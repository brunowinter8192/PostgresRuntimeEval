...
```
Node 14351 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 14352 (Gather Merge) [consumed]
    Node 14353 (Sort)
          ...
          Node 14356 (Hash Join)
            Node 14357 (Nested Loop)
              Node 14358 (Hash Join)
                ...
                Node 14360 (Hash) [PATTERN: 444761fb]
                  Node 14361 (Hash Join) [consumed]
                    Node 14362 (Seq Scan) [consumed] - LEAF
                    Node 14363 (Hash) [consumed]
                      Node 14364 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 14360 | 14351, 14352, 14361, 14362, 14363, 14364 |
| Aggregate -> Gather Merge (Out | 2724c080 | 14351 | 14352, 14360, 14361, 14362, 14363, 14364 |
...
|------|------|--------|-----------|-----|--------|
| 14351 | Aggregate | 1223.43 | 1133.65 | 7.3% | pattern |
...
| 14358 | Hash Join | 207.36 | 251.67 | 21.4% | operator |
...
| 14360 | Hash | 30.63 | 43.51 | 42.0% | pattern |
...
### Step 4: Node 14359 (Seq Scan) - LEAF
...
### Step 5: Node 14360 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 14351, 14352, 14361, 14362, 14363, 14364
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 14368 (Index Scan) - LEAF
...
### Step 8: Node 14370 (Seq Scan) - LEAF
...
### Step 12: Node 14371 (Index Scan) - LEAF
...
### Step 13: Node 14373 (Seq Scan) - LEAF
...
### Step 14: Node 14355 (Nested Loop)
...
### Step 18: Node 14351 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 14352, 14360, 14361, 14362, 14363, 14364
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2376
  - Aggregate_nt1=2376
