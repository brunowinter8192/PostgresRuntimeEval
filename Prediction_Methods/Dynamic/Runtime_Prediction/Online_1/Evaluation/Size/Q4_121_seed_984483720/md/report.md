...
**Test Query:** Q4_121_seed_984483720
...
```
Node 6012 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6013 (Gather Merge) [consumed]
    Node 6014 (Sort) [consumed]
      Node 6015 (Aggregate) [consumed]
        Node 6016 (Nested Loop)
          Node 6017 (Seq Scan) - LEAF
          Node 6018 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6012 | 6013, 6014, 6015 |
...
|------|------|--------|-----------|-----|--------|
| 6012 | Aggregate | 1071.58 | 952.19 | 11.1% | pattern |
| 6016 | Nested Loop | 1063.35 | 1255.45 | 18.1% | operator |
| 6017 | Seq Scan | 165.66 | 154.66 | 6.6% | operator |
| 6018 | Index Scan | 0.06 | 11.10 | 17810.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6017 (Seq Scan) - LEAF
...
### Step 2: Node 6018 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - Aggregate_startup_cost=67150.2600
  - Aggregate_total_cost=67152.1600
  ...
  - GatherMerge_Outer_startup_cost=67150.2600
  - GatherMerge_Outer_total_cost=67152.0400
  - Sort_Outer_np=0
  - Sort_Outer_nt=5
  - Sort_Outer_nt1=5
  - Sort_Outer_nt2=0
  ...
  - Sort_Outer_startup_cost=66150.2200
  - Sort_Outer_total_cost=66150.2300
