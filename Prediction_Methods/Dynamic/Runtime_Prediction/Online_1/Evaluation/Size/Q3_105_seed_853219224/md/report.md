...
**Test Query:** Q3_105_seed_853219224
...
```
Node 4401 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 4402 (Sort) [consumed]
    Node 4403 (Aggregate) [consumed]
      Node 4404 (Gather) [consumed]
        Node 4405 (Nested Loop)
          Node 4406 (Hash Join) [PATTERN: 895c6e8c]
            Node 4407 (Seq Scan) [consumed] - LEAF
            Node 4408 (Hash) [consumed]
              Node 4409 (Seq Scan) - LEAF
          Node 4410 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4401 | 4402, 4403, 4404, 4406, 4407, 4408 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4406 | 4401, 4402, 4403, 4404, 4407, 4408 |
...
|------|------|--------|-----------|-----|--------|
| 4401 | Limit | 1215.51 | 1151.18 | 5.3% | pattern |
| 4405 | Nested Loop | 1178.77 | 1193.56 | 1.3% | operator |
| 4406 | Hash Join | 208.74 | 242.58 | 16.2% | pattern |
| 4410 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4409 | Seq Scan | 28.73 | 38.53 | 34.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4409 (Seq Scan) - LEAF
...
### Step 2: Node 4406 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4401, 4402, 4403, 4404, 4407, 4408
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47707
  - HashJoin_nt1=237043
...
- **Input Features:**
  ...
  - total_cost=73396.8600
- **Output:** st=122.29, rt=1193.56

### Step 5: Node 4401 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4402, 4403, 4404, 4406, 4407, 4408
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=316102
  - Aggregate_Outer_nt1=316102
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110748.5900
  - Aggregate_Outer_total_cost=114699.8600
  - Gather_Outer_np=0
  - Gather_Outer_nt=316102
  - Gather_Outer_nt1=101968
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=106007.0600
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=316102
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=121530.7100
  - Limit_total_cost=121530.7400
  - Sort_Outer_np=0
  - Sort_Outer_nt=316102
  - Sort_Outer_nt1=316102
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=121530.7100
  - Sort_Outer_total_cost=122320.9700
