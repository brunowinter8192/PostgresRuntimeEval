...
```
Node 14052 (Aggregate) - ROOT
  Node 14053 (Gather Merge)
    Node 14054 (Sort)
          ...
          Node 14057 (Hash Join)
            Node 14058 (Nested Loop)
              Node 14059 (Hash Join)
                ...
                Node 14061 (Hash)
                  Node 14062 (Hash Join)
                    Node 14063 (Seq Scan) - LEAF
                    Node 14064 (Hash)
                      Node 14065 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 14052 | Aggregate | 1238.79 | 1186.72 | 4.2% | operator |
| 14053 | Gather Merge | 1238.36 | 1097.17 | 11.4% | operator |
...
| 14059 | Hash Join | 213.30 | 251.17 | 17.8% | operator |
...
| 14061 | Hash | 38.93 | 20.62 | 47.0% | operator |
| 14062 | Hash Join | 37.76 | 132.26 | 250.3% | operator |
| 14063 | Seq Scan | 36.23 | 23.03 | 36.4% | operator |
| 14064 | Hash | 0.21 | 23.66 | 11273.1% | operator |
| 14065 | Hash Join | 0.20 | 306.84 | 150309.8% | operator |
...
### Step 5: Node 14063 (Seq Scan) - LEAF
...
### Step 8: Node 14060 (Seq Scan) - LEAF
...
### Step 11: Node 14069 (Index Scan) - LEAF
...
### Step 12: Node 14071 (Seq Scan) - LEAF
...
### Step 13: Node 14058 (Nested Loop)
...
### Step 16: Node 14072 (Index Scan) - LEAF
...
### Step 17: Node 14074 (Seq Scan) - LEAF
...
### Step 18: Node 14056 (Nested Loop)
...
### Step 22: Node 14053 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1044.9447
  - st2=0.0000
  - startup_cost=71561.3700
  - total_cost=71857.6100
- **Output:** st=1093.47, rt=1097.17

### Step 23: Node 14052 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=71561.3700
  - total_cost=71955.8100
- **Output:** st=1159.88, rt=1186.72
