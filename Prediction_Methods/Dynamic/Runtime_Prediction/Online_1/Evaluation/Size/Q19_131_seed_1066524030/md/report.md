...
**Test Query:** Q19_131_seed_1066524030
...
```
Node 31458 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31459 (Gather) [consumed]
    Node 31460 (Aggregate) [consumed]
      Node 31461 (Hash Join) [consumed]
        Node 31462 (Seq Scan) - LEAF
        Node 31463 (Hash)
          Node 31464 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31458 | 31459, 31460, 31461 |
...
|------|------|--------|-----------|-----|--------|
| 31458 | Aggregate | 850.21 | 829.31 | 2.5% | pattern |
| 31462 | Seq Scan | 781.45 | 743.46 | 4.9% | operator |
| 31463 | Hash | 48.87 | 8.29 | 83.0% | operator |
| 31464 | Seq Scan | 48.68 | 23.76 | 51.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31464 (Seq Scan) - LEAF
...
### Step 2: Node 31462 (Seq Scan) - LEAF
...
### Step 4: Node 31458 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31459, 31460, 31461
- **Input Features:**
  ...
  - Aggregate_Outer_startup_cost=156338.9300
  - Aggregate_Outer_total_cost=156338.9400
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=157339.4700
  - Aggregate_total_cost=157339.4800
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=157338.9300
  - Gather_Outer_total_cost=157339.4400
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=23
  - HashJoin_Outer_nt1=22580
  ...
  - HashJoin_Outer_total_cost=156338.7500
- **Output:** st=824.26, rt=829.31
