...
**Test Query:** Q9_123_seed_1000891782
...
```
Node 17104 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 17105 (Aggregate) [consumed]
    Node 17106 (Gather)
      Node 17107 (Aggregate)
        Node 17108 (Nested Loop)
          Node 17109 (Hash Join) [PATTERN: bb930825]
            Node 17110 (Seq Scan) [consumed] - LEAF
            Node 17111 (Hash) [consumed]
              Node 17112 (Hash Join) [consumed]
                Node 17113 (Hash Join)
                  Node 17114 (Nested Loop)
                    Node 17115 (Seq Scan) - LEAF
                    Node 17116 (Index Scan) - LEAF
                  Node 17117 (Hash)
                    Node 17118 (Seq Scan) - LEAF
                Node 17119 (Hash)
                  Node 17120 (Seq Scan) - LEAF
          Node 17121 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17109 | 17104, 17105, 17110, 17111, 17112 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17104 | 17105, 17109, 17110, 17111, 17112 |
...
|------|------|--------|-----------|-----|--------|
| 17104 | Sort | 1183.06 | 1045.59 | 11.6% | pattern |
| 17106 | Gather | 1181.84 | 964.55 | 18.4% | operator |
| 17107 | Aggregate | 1162.71 | 1085.45 | 6.6% | operator |
| 17108 | Nested Loop | 1138.08 | 1252.17 | 10.0% | operator |
| 17109 | Hash Join | 967.71 | 134.80 | 86.1% | pattern |
| 17121 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17113 | Hash Join | 161.26 | 837.63 | 419.4% | operator |
| 17119 | Hash | 13.55 | 14.95 | 10.3% | operator |
| 17114 | Nested Loop | 154.52 | 1251.77 | 710.1% | operator |
| 17117 | Hash | 4.37 | 15.94 | 265.2% | operator |
| 17120 | Seq Scan | 13.54 | 2.94 | 78.3% | operator |
| 17115 | Seq Scan | 20.25 | 43.96 | 117.1% | operator |
| 17116 | Index Scan | 0.07 | -1.39 | 1976.3% | operator |
| 17118 | Seq Scan | 3.89 | 9.45 | 143.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 17115 (Seq Scan) - LEAF
...
### Step 2: Node 17116 (Index Scan) - LEAF
...
### Step 3: Node 17118 (Seq Scan) - LEAF
...
### Step 6: Node 17120 (Seq Scan) - LEAF
...
### Step 9: Node 17109 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17104, 17105, 17110, 17111, 17112
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17121 (Index Scan) - LEAF
...
### Step 11: Node 17108 (Nested Loop)
...
### Step 14: Node 17104 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17105, 17109, 17110, 17111, 17112
- **Input Features:**
