...
```
Node 17104 (Sort) - ROOT
  Node 17105 (Aggregate)
    Node 17106 (Gather)
      Node 17107 (Aggregate)
        Node 17108 (Nested Loop)
          Node 17109 (Hash Join)
            Node 17110 (Seq Scan) - LEAF
            Node 17111 (Hash)
              Node 17112 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 17104 | Sort | 1183.06 | 1119.81 | 5.3% | operator |
| 17105 | Aggregate | 1182.94 | 897.74 | 24.1% | operator |
...
| 17109 | Hash Join | 967.71 | 633.50 | 34.5% | operator |
| 17121 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17110 | Seq Scan | 696.14 | 509.93 | 26.7% | operator |
| 17111 | Hash | 177.68 | 48.03 | 73.0% | operator |
| 17112 | Hash Join | 175.44 | 924.48 | 426.9% | operator |
...
### Step 10: Node 17110 (Seq Scan) - LEAF
...
### Step 13: Node 17121 (Index Scan) - LEAF
...
### Step 14: Node 17108 (Nested Loop)
