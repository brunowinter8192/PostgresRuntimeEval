...
**Test Query:** Q5_106_seed_861423255
...
```
Node 7021 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 7022 (Aggregate) [consumed]
    Node 7023 (Gather Merge) [consumed]
      Node 7024 (Aggregate)
        Node 7025 (Sort) [PATTERN: 3e2d5a00]
          Node 7026 (Hash Join) [consumed]
            Node 7027 (Nested Loop)
              Node 7028 (Hash Join)
                Node 7029 (Seq Scan) - LEAF
                Node 7030 (Hash) [PATTERN: 444761fb]
                  Node 7031 (Hash Join) [consumed]
                    Node 7032 (Seq Scan) [consumed] - LEAF
                    Node 7033 (Hash) [consumed]
                      Node 7034 (Hash Join) [consumed]
                        Node 7035 (Seq Scan) - LEAF
                        Node 7036 (Hash)
                          Node 7037 (Seq Scan) - LEAF
              Node 7038 (Index Scan) - LEAF
            Node 7039 (Hash)
              Node 7040 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 7030 | 7021, 7022, 7023, 7025, 7026, 7031, 7032, 7033, 7034 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 7021 | 7022, 7023, 7025, 7026, 7030, 7031, 7032, 7033, 7034 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 7025 | 7021, 7022, 7023, 7026, 7030, 7031, 7032, 7033, 7034 |
...
|------|------|--------|-----------|-----|--------|
| 7021 | Sort | 1091.69 | 2934.42 | 168.8% | pattern |
| 7024 | Aggregate | 1086.55 | 1128.79 | 3.9% | operator |
| 7025 | Sort | 1086.27 | 1835.90 | 69.0% | pattern |
| 7027 | Nested Loop | 1072.26 | 1188.37 | 10.8% | operator |
| 7039 | Hash | 5.31 | 18.67 | 251.8% | operator |
| 7028 | Hash Join | 217.83 | 253.07 | 16.2% | operator |
| 7038 | Index Scan | 0.07 | -0.22 | 393.4% | operator |
| 7040 | Seq Scan | 4.78 | 12.36 | 158.5% | operator |
| 7029 | Seq Scan | 169.90 | 159.81 | 5.9% | operator |
| 7030 | Hash | 34.79 | 46.85 | 34.7% | pattern |
| 7035 | Seq Scan | 0.01 | 11.81 | 168589.6% | operator |
| 7036 | Hash | 0.06 | 21.05 | 36835.5% | operator |
| 7037 | Seq Scan | 0.05 | 22.93 | 42369.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 7037 (Seq Scan) - LEAF
...
### Step 2: Node 7035 (Seq Scan) - LEAF
...
### Step 4: Node 7029 (Seq Scan) - LEAF
...
### Step 5: Node 7030 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 7021, 7022, 7023, 7025, 7026, 7031, 7032, 7033, 7034
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 7038 (Index Scan) - LEAF
...
### Step 8: Node 7040 (Seq Scan) - LEAF
...
### Step 11: Node 7025 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 7021, 7022, 7023, 7026, 7030, 7031, 7032, 7033, 7034
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 7021 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 7022, 7023, 7025, 7026, 7030, 7031, 7032, 7033, 7034
- **Input Features:**
