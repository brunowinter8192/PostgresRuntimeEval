    ...
    Node 19983 (Aggregate) [consumed]
      Node 19984 (Gather) [consumed]
        Node 19985 (Hash Join)
          Node 19986 (Hash Join)
            Node 19987 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19981 | 19982, 19983, 19984 |
...
| 19985 | Hash Join | 1108.83 | 1007.08 | 9.2% | operator |
| 19986 | Hash Join | 1105.94 | 1003.90 | 9.2% | operator |
| 19992 | Hash | 0.01 | 15.71 | 130823.1% | operator |
| 19987 | Nested Loop | 1057.35 | 1204.89 | 14.0% | operator |
| 19990 | Hash | 37.88 | 55.57 | 46.7% | operator |
...
- **Output:** st=124.90, rt=1204.89

### Step 5: Node 19990 (Hash)
...
### Step 6: Node 19993 (Seq Scan) - LEAF
...
- **Output:** st=109.75, rt=1003.90

### Step 8: Node 19992 (Hash)
...
- **Output:** st=98.94, rt=1007.08

### Step 10: Node 19981 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19982, 19983, 19984
- **Input Features:**
