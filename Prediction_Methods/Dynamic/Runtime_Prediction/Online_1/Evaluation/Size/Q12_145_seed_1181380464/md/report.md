...
**Test Query:** Q12_145_seed_1181380464
...
```
Node 24663 (Aggregate) - ROOT
  Node 24664 (Gather Merge)
    Node 24665 (Aggregate)
      Node 24666 (Sort)
        Node 24667 (Nested Loop)
          Node 24668 (Seq Scan) - LEAF
          Node 24669 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24663 | Aggregate | 990.93 | 919.05 | 7.3% | operator |
| 24664 | Gather Merge | 990.92 | 1111.84 | 12.2% | operator |
| 24665 | Aggregate | 969.64 | 895.30 | 7.7% | operator |
| 24666 | Sort | 969.02 | 1092.82 | 12.8% | operator |
| 24667 | Nested Loop | 967.99 | 1127.41 | 16.5% | operator |
| 24668 | Seq Scan | 828.15 | 745.19 | 10.0% | operator |
| 24669 | Index Scan | 0.03 | 0.07 | 166.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24668 (Seq Scan) - LEAF
...
### Step 2: Node 24669 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=147555.1200
  - total_cost=147671.1300
- **Output:** st=868.94, rt=895.30

### Step 6: Node 24664 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=868.9413
  - st2=0.0000
  - startup_cost=148555.1900
  - total_cost=148675.4200
- **Output:** st=1109.22, rt=1111.84

### Step 7: Node 24663 (Aggregate) - ROOT
