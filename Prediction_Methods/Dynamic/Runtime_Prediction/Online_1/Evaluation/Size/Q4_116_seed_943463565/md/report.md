...
**Test Query:** Q4_116_seed_943463565
...
```
Node 5970 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 5971 (Gather Merge) [consumed]
    Node 5972 (Sort) [consumed]
      Node 5973 (Aggregate) [consumed]
        Node 5974 (Nested Loop)
          Node 5975 (Seq Scan) - LEAF
          Node 5976 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 5970 | 5971, 5972, 5973 |
...
|------|------|--------|-----------|-----|--------|
| 5970 | Aggregate | 1057.41 | 952.19 | 10.0% | pattern |
| 5974 | Nested Loop | 1050.23 | 1255.45 | 19.5% | operator |
| 5975 | Seq Scan | 162.79 | 154.66 | 5.0% | operator |
| 5976 | Index Scan | 0.06 | 11.10 | 17810.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5975 (Seq Scan) - LEAF
...
### Step 2: Node 5976 (Index Scan) - LEAF
