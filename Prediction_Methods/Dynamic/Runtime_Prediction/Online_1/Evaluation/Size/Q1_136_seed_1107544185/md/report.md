...
**Test Query:** Q1_136_seed_1107544185
...
```
Node 196 (Aggregate) - ROOT
  Node 197 (Gather Merge)
    Node 198 (Sort) [PATTERN: 1d35fb97]
      Node 199 (Aggregate) [consumed]
        Node 200 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 198 | 199 |
...
|------|------|--------|-----------|-----|--------|
| 196 | Aggregate | 1019.31 | 1195.94 | 17.3% | operator |
| 197 | Gather Merge | 1019.27 | 1165.92 | 14.4% | operator |
| 198 | Sort | 998.98 | 1200.71 | 20.2% | pattern |
| 200 | Seq Scan | 592.17 | 679.47 | 14.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 200 (Seq Scan) - LEAF
...
### Step 2: Node 198 (Sort) - PATTERN ROOT
...
### Step 4: Node 196 (Aggregate) - ROOT
