...
```
Node 26658 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26659 (Gather) [consumed]
    Node 26660 (Aggregate) [consumed]
      Node 26661 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26658 | 26659, 26660, 26661 |
...
|------|------|--------|-----------|-----|--------|
| 26658 | Aggregate | 811.90 | 857.14 | 5.6% | pattern |
...
### Step 4: Node 26658 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26659, 26660, 26661
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=15641
  - HashJoin_Outer_nt1=15641
  ...
  - HashJoin_Outer_total_cost=136647.7000
