    ...
    Node 4863 (Aggregate) [consumed]
      Node 4864 (Gather) [consumed]
        Node 4865 (Nested Loop)
          Node 4866 (Hash Join) [PATTERN: 895c6e8c]
            Node 4867 (Seq Scan) [consumed] - LEAF
            Node 4868 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4861 | 4862, 4863, 4864, 4866, 4867, 4868 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4866 | 4861, 4862, 4863, 4864, 4867, 4868 |
...
| 4865 | Nested Loop | 1231.04 | 1192.65 | 3.1% | operator |
| 4866 | Hash Join | 222.79 | 242.40 | 8.8% | pattern |
...
### Step 2: Node 4866 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4861, 4862, 4863, 4864, 4867, 4868
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46297
  - HashJoin_nt1=231734
  ...
  - HashJoin_total_cost=37330.0500
  - Hash_Inner_np=0
  - Hash_Inner_nt=12487
...
### Step 3: Node 4870 (Index Scan) - LEAF
...
- **Output:** st=121.41, rt=1192.65

### Step 5: Node 4861 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4862, 4863, 4864, 4866, 4867, 4868
- **Input Features:**
