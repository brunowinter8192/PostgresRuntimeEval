...
```
Node 31983 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31984 (Gather) [consumed]
    Node 31985 (Aggregate) [consumed]
      Node 31986 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31983 | 31984, 31985, 31986 |
...
|------|------|--------|-----------|-----|--------|
| 31983 | Aggregate | 854.03 | 829.26 | 2.9% | pattern |
...
### Step 4: Node 31983 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31984, 31985, 31986
- **Input Features:**
