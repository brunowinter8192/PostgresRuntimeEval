...
```
Node 26126 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26127 (Aggregate) [consumed]
    Node 26128 (Aggregate)
      Node 26129 (Hash Join) [PATTERN: 895c6e8c]
        Node 26130 (Seq Scan) [consumed] - LEAF
        Node 26131 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26126 | 26127, 26129, 26130, 26131 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26129 | 26126, 26127, 26130, 26131 |
...
|------|------|--------|-----------|-----|--------|
| 26126 | Sort | 904.47 | 1079.93 | 19.4% | pattern |
| 26128 | Aggregate | 898.41 | 999.35 | 11.2% | operator |
| 26129 | Hash Join | 690.61 | 470.31 | 31.9% | pattern |
...
### Step 2: Node 26129 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26126, 26127, 26130, 26131
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1481964
...
### Step 4: Node 26126 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26127, 26129, 26130, 26131
- **Input Features:**
