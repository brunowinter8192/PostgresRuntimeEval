...
**Test Query:** Q18_45_seed_360977364
...
```
Node 30244 (Limit) - ROOT
  Node 30245 (Sort)
    Node 30246 (Aggregate)
      Node 30247 (Gather Merge)
        Node 30248 (Incremental Sort)
          Node 30249 (Nested Loop)
            Node 30250 (Merge Join)
              Node 30251 (Sort)
                Node 30252 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30253 (Seq Scan) [consumed] - LEAF
                  Node 30254 (Hash) [consumed]
                    Node 30255 (Aggregate)
                      Node 30256 (Index Scan) - LEAF
              Node 30257 (Sort)
                Node 30258 (Seq Scan) - LEAF
            Node 30259 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30252 | 30253, 30254 |
...
|------|------|--------|-----------|-----|--------|
| 30244 | Limit | 3046.60 | 1175.21 | 61.4% | operator |
| 30245 | Sort | 2936.12 | 1127.81 | 61.6% | operator |
| 30246 | Aggregate | 2936.07 | 1073.15 | 63.4% | operator |
| 30247 | Gather Merge | 2936.05 | 1073.95 | 63.4% | operator |
| 30248 | Incremental Sort | 2901.92 | 0.00 | 100.0% | operator |
| 30249 | Nested Loop | 2901.87 | 1111.34 | 61.7% | operator |
| 30250 | Merge Join | 2901.82 | 0.00 | 100.0% | operator |
| 30259 | Index Scan | 0.02 | 0.05 | 125.7% | operator |
| 30251 | Sort | 2850.97 | 1095.58 | 61.6% | operator |
| 30257 | Sort | 64.98 | 1074.66 | 1553.7% | operator |
| 30252 | Hash Join | 2850.95 | 471.07 | 83.5% | pattern |
| 30258 | Seq Scan | 53.47 | 18.25 | 65.9% | operator |
| 30255 | Aggregate | 2616.03 | 1073.15 | 59.0% | operator |
| 30256 | Index Scan | 2126.23 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30256 (Index Scan) - LEAF
...
### Step 3: Node 30252 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30253, 30254
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30258 (Seq Scan) - LEAF
...
### Step 7: Node 30250 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30259 (Index Scan) - LEAF
...
### Step 10: Node 30248 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30247 (Gather Merge)
