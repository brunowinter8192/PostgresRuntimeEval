...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29484 | 29485, 29486 |
...
|------|------|--------|-----------|-----|--------|
| 29476 | Limit | 3040.96 | 1175.21 | 61.4% | operator |
| 29477 | Sort | 2925.24 | 1127.81 | 61.4% | operator |
| 29478 | Aggregate | 2925.19 | 1073.15 | 63.3% | operator |
| 29479 | Gather Merge | 2925.17 | 1073.95 | 63.3% | operator |
| 29480 | Incremental Sort | 2890.78 | 0.00 | 100.0% | operator |
| 29481 | Nested Loop | 2890.72 | 1111.34 | 61.6% | operator |
| 29482 | Merge Join | 2890.67 | 0.00 | 100.0% | operator |
| 29491 | Index Scan | 0.02 | 0.05 | 137.6% | operator |
| 29483 | Sort | 2839.37 | 1095.58 | 61.4% | operator |
| 29489 | Sort | 65.53 | 1074.66 | 1539.9% | operator |
| 29484 | Hash Join | 2839.36 | 471.07 | 83.4% | pattern |
| 29490 | Seq Scan | 54.22 | 18.25 | 66.3% | operator |
| 29487 | Aggregate | 2615.73 | 1073.15 | 59.0% | operator |
| 29488 | Index Scan | 2108.08 | 0.00 | 100.0% | operator |
...
### Step 4: Node 29490 (Seq Scan) - LEAF
...
### Step 7: Node 29482 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29491 (Index Scan) - LEAF
...
### Step 10: Node 29480 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29479 (Gather Merge)
