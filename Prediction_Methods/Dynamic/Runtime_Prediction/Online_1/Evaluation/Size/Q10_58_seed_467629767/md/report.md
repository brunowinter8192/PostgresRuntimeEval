    ...
    Node 20711 (Aggregate) [consumed]
      Node 20712 (Gather) [consumed]
        Node 20713 (Hash Join)
          Node 20714 (Hash Join)
            Node 20715 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20709 | 20710, 20711, 20712 |
...
| 20713 | Hash Join | 1115.55 | 1007.24 | 9.7% | operator |
| 20714 | Hash Join | 1112.68 | 1004.16 | 9.8% | operator |
| 20720 | Hash | 0.02 | 15.71 | 87182.1% | operator |
| 20715 | Nested Loop | 1061.08 | 1204.80 | 13.5% | operator |
| 20718 | Hash | 37.58 | 55.57 | 47.9% | operator |
...
### Step 6: Node 20721 (Seq Scan) - LEAF
...
### Step 10: Node 20709 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20710, 20711, 20712
- **Input Features:**
