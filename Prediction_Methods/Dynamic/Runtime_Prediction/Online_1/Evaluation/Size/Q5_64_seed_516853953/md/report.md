...
```
Node 9101 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 9102 (Aggregate) [consumed]
    Node 9103 (Gather Merge) [consumed]
      Node 9104 (Aggregate)
        Node 9105 (Sort) [PATTERN: 3e2d5a00]
          Node 9106 (Hash Join) [consumed]
            Node 9107 (Nested Loop)
              Node 9108 (Hash Join)
                Node 9109 (Seq Scan) - LEAF
                Node 9110 (Hash) [PATTERN: 444761fb]
                  Node 9111 (Hash Join) [consumed]
                    Node 9112 (Seq Scan) [consumed] - LEAF
                    Node 9113 (Hash) [consumed]
                      Node 9114 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 9110 | 9101, 9102, 9103, 9105, 9106, 9111, 9112, 9113, 9114 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 9101 | 9102, 9103, 9105, 9106, 9110, 9111, 9112, 9113, 9114 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 9105 | 9101, 9102, 9103, 9106, 9110, 9111, 9112, 9113, 9114 |
...
|------|------|--------|-----------|-----|--------|
| 9101 | Sort | 1052.03 | 2934.42 | 178.9% | pattern |
| 9104 | Aggregate | 1047.15 | 1128.76 | 7.8% | operator |
| 9105 | Sort | 1046.89 | 1835.93 | 75.4% | pattern |
| 9107 | Nested Loop | 1034.62 | 1188.47 | 14.9% | operator |
| 9119 | Hash | 3.60 | 18.67 | 418.5% | operator |
| 9108 | Hash Join | 218.76 | 253.07 | 15.7% | operator |
| 9118 | Index Scan | 0.07 | -0.22 | 405.6% | operator |
| 9120 | Seq Scan | 3.08 | 12.36 | 301.8% | operator |
| 9109 | Seq Scan | 168.50 | 159.81 | 5.2% | operator |
| 9110 | Hash | 36.77 | 46.85 | 27.4% | pattern |
| 9115 | Seq Scan | 0.01 | 11.81 | 147503.4% | operator |
| 9116 | Hash | 0.05 | 21.05 | 38887.5% | operator |
| 9117 | Seq Scan | 0.05 | 22.93 | 45766.7% | operator |
...
### Step 4: Node 9109 (Seq Scan) - LEAF
...
### Step 5: Node 9110 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 9101, 9102, 9103, 9105, 9106, 9111, 9112, 9113, 9114
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 9118 (Index Scan) - LEAF
...
### Step 8: Node 9120 (Seq Scan) - LEAF
...
### Step 11: Node 9105 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 9101, 9102, 9103, 9106, 9110, 9111, 9112, 9113, 9114
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 9101 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 9102, 9103, 9105, 9106, 9110, 9111, 9112, 9113, 9114
- **Input Features:**
