...
```
Node 25307 (Aggregate) - ROOT
  Node 25308 (Gather Merge)
    Node 25309 (Aggregate)
      Node 25310 (Sort)
        Node 25311 (Nested Loop)
          Node 25312 (Seq Scan) - LEAF
          Node 25313 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 25307 | Aggregate | 1003.31 | 919.06 | 8.4% | operator |
| 25308 | Gather Merge | 1003.30 | 1111.84 | 10.8% | operator |
| 25309 | Aggregate | 983.18 | 895.31 | 8.9% | operator |
| 25310 | Sort | 982.55 | 1092.81 | 11.2% | operator |
| 25311 | Nested Loop | 981.60 | 1127.41 | 14.9% | operator |
| 25312 | Seq Scan | 842.60 | 745.19 | 11.6% | operator |
| 25313 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25312 (Seq Scan) - LEAF
...
### Step 2: Node 25313 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - st2=0.1246
  - startup_cost=0.4300
  - total_cost=147171.4400
- **Output:** st=38.33, rt=1127.41

### Step 4: Node 25310 (Sort)
...
- **Input Features:**
  ...
  - st1=38.3253
  - st2=0.0000
  - startup_cost=147532.1100
  - total_cost=147546.5400
- **Output:** st=1092.40, rt=1092.81

### Step 5: Node 25309 (Aggregate)
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=147532.1100
  - total_cost=147647.6400
- **Output:** st=868.96, rt=895.31

### Step 6: Node 25308 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=868.9572
  - st2=0.0000
  - startup_cost=148532.1900
  - total_cost=148651.9300
- **Output:** st=1109.22, rt=1111.84

### Step 7: Node 25307 (Aggregate) - ROOT
