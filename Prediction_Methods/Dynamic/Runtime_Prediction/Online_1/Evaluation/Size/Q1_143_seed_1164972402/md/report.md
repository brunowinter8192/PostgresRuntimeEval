...
**Test Query:** Q1_143_seed_1164972402
...
```
Node 236 (Aggregate) - ROOT
  Node 237 (Gather Merge)
    Node 238 (Sort) [PATTERN: 1d35fb97]
      Node 239 (Aggregate) [consumed]
        Node 240 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 238 | 239 |
...
|------|------|--------|-----------|-----|--------|
| 236 | Aggregate | 938.55 | 1196.04 | 27.4% | operator |
| 237 | Gather Merge | 938.49 | 1165.95 | 24.2% | operator |
| 238 | Sort | 920.51 | 1201.08 | 30.5% | pattern |
| 240 | Seq Scan | 500.36 | 678.08 | 35.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 240 (Seq Scan) - LEAF
...
### Step 2: Node 238 (Sort) - PATTERN ROOT
...
### Step 4: Node 236 (Aggregate) - ROOT
