        ...
        Node 28936 (Incremental Sort)
          Node 28937 (Nested Loop)
            Node 28938 (Merge Join)
              Node 28939 (Sort)
                Node 28940 (Hash Join)
                  Node 28941 (Seq Scan) - LEAF
                  Node 28942 (Hash)
...
| 28939 | Sort | 2853.90 | 1099.77 | 61.5% | operator |
| 28945 | Sort | 69.24 | 1074.66 | 1452.1% | operator |
| 28940 | Hash Join | 2853.89 | 686.33 | 76.0% | operator |
| 28946 | Seq Scan | 56.39 | 18.25 | 67.6% | operator |
| 28941 | Seq Scan | 193.61 | 170.37 | 12.0% | operator |
| 28942 | Hash | 2631.78 | 21.04 | 99.2% | operator |
...
### Step 3: Node 28941 (Seq Scan) - LEAF
...
### Step 6: Node 28946 (Seq Scan) - LEAF
...
### Step 9: Node 28938 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 28947 (Index Scan) - LEAF
...
### Step 11: Node 28937 (Nested Loop)
...
### Step 12: Node 28936 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 28935 (Gather Merge)
