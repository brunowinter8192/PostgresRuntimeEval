...
**Test Query:** Q18_107_seed_869627286
...
```
Node 28932 (Limit) - ROOT
  Node 28933 (Sort)
    Node 28934 (Aggregate)
      Node 28935 (Gather Merge)
        Node 28936 (Incremental Sort)
          Node 28937 (Nested Loop)
            Node 28938 (Merge Join)
              Node 28939 (Sort)
                Node 28940 (Hash Join) [PATTERN: 895c6e8c]
                  Node 28941 (Seq Scan) [consumed] - LEAF
                  Node 28942 (Hash) [consumed]
                    Node 28943 (Aggregate)
                      Node 28944 (Index Scan) - LEAF
              Node 28945 (Sort)
                Node 28946 (Seq Scan) - LEAF
            Node 28947 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 28940 | 28941, 28942 |
...
|------|------|--------|-----------|-----|--------|
| 28932 | Limit | 3062.45 | 1175.21 | 61.6% | operator |
| 28933 | Sort | 2945.51 | 1127.81 | 61.7% | operator |
| 28934 | Aggregate | 2945.47 | 1073.15 | 63.6% | operator |
| 28935 | Gather Merge | 2945.43 | 1073.95 | 63.5% | operator |
| 28936 | Incremental Sort | 2908.14 | 0.00 | 100.0% | operator |
| 28937 | Nested Loop | 2908.09 | 1111.34 | 61.8% | operator |
| 28938 | Merge Join | 2908.03 | 0.00 | 100.0% | operator |
| 28947 | Index Scan | 0.02 | 0.05 | 114.9% | operator |
| 28939 | Sort | 2853.90 | 1095.58 | 61.6% | operator |
| 28945 | Sort | 69.24 | 1074.66 | 1452.1% | operator |
| 28940 | Hash Join | 2853.89 | 471.07 | 83.5% | pattern |
| 28946 | Seq Scan | 56.39 | 18.25 | 67.6% | operator |
| 28943 | Aggregate | 2631.74 | 1073.15 | 59.2% | operator |
| 28944 | Index Scan | 2125.52 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 28944 (Index Scan) - LEAF
...
### Step 3: Node 28940 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 28941, 28942
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 28946 (Seq Scan) - LEAF
...
### Step 7: Node 28938 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 28947 (Index Scan) - LEAF
...
### Step 10: Node 28936 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 28935 (Gather Merge)
