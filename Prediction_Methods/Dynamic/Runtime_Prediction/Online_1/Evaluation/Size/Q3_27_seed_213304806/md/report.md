    ...
    Node 5043 (Aggregate) [consumed]
      Node 5044 (Gather) [consumed]
        Node 5045 (Nested Loop)
          Node 5046 (Hash Join) [PATTERN: 895c6e8c]
            Node 5047 (Seq Scan) [consumed] - LEAF
            Node 5048 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5041 | 5042, 5043, 5044, 5046, 5047, 5048 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5046 | 5041, 5042, 5043, 5044, 5047, 5048 |
...
|------|------|--------|-----------|-----|--------|
| 5041 | Limit | 1195.24 | 1151.18 | 3.7% | pattern |
| 5045 | Nested Loop | 1158.14 | 1192.80 | 3.0% | operator |
| 5046 | Hash Join | 210.69 | 242.43 | 15.1% | pattern |
| 5050 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5049 | Seq Scan | 27.82 | 38.57 | 38.6% | operator |
...
### Step 2: Node 5046 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5041, 5042, 5043, 5044, 5047, 5048
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46525
  - HashJoin_nt1=232872
  ...
  - HashJoin_total_cost=37333.0400
  - Hash_Inner_np=0
  - Hash_Inner_nt=12487
...
### Step 3: Node 5050 (Index Scan) - LEAF
...
- **Output:** st=121.55, rt=1192.80

### Step 5: Node 5041 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5042, 5043, 5044, 5046, 5047, 5048
- **Input Features:**
