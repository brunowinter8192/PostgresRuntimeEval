...
```
Node 27407 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27408 (Gather) [consumed]
    Node 27409 (Aggregate) [consumed]
      Node 27410 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27407 | 27408, 27409, 27410 |
...
|------|------|--------|-----------|-----|--------|
| 27407 | Aggregate | 836.85 | 857.14 | 2.4% | pattern |
...
### Step 4: Node 27407 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27408, 27409, 27410
- **Input Features:**
