...
**Test Query:** Q1_18_seed_139468527
...
```
Node 296 (Aggregate) - ROOT
  Node 297 (Gather Merge)
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 298 | 299 |
...
|------|------|--------|-----------|-----|--------|
| 296 | Aggregate | 988.84 | 1195.88 | 20.9% | operator |
| 297 | Gather Merge | 988.79 | 1165.90 | 17.9% | operator |
| 298 | Sort | 968.62 | 1200.49 | 23.9% | pattern |
| 300 | Seq Scan | 563.47 | 680.30 | 20.7% | operator |
...
### Step 4: Node 296 (Aggregate) - ROOT
