...
**Test Query:** Q13_75_seed_607098294
...
```
Node 26224 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26225 (Aggregate) [consumed]
    Node 26226 (Aggregate)
      Node 26227 (Hash Join) [PATTERN: 895c6e8c]
        Node 26228 (Seq Scan) [consumed] - LEAF
        Node 26229 (Hash) [consumed]
          Node 26230 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26224 | 26225, 26227, 26228, 26229 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26227 | 26224, 26225, 26228, 26229 |
...
|------|------|--------|-----------|-----|--------|
| 26224 | Sort | 892.78 | 1079.94 | 21.0% | pattern |
| 26226 | Aggregate | 886.73 | 999.76 | 12.7% | operator |
| 26227 | Hash Join | 676.20 | 470.31 | 30.4% | pattern |
| 26230 | Index Only Scan | 10.22 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26230 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26227 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26224, 26225, 26228, 26229
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 26224 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26225, 26227, 26228, 26229
- **Input Features:**
