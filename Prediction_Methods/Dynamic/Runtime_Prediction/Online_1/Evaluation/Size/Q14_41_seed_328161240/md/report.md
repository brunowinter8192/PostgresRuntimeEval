...
**Test Query:** Q14_41_seed_328161240
...
```
Node 27015 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27016 (Gather) [consumed]
    Node 27017 (Aggregate) [consumed]
      Node 27018 (Hash Join) [consumed]
        Node 27019 (Seq Scan) - LEAF
        Node 27020 (Hash)
          Node 27021 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27015 | 27016, 27017, 27018 |
...
|------|------|--------|-----------|-----|--------|
| 27015 | Aggregate | 779.34 | 857.14 | 10.0% | pattern |
| 27019 | Seq Scan | 705.41 | 758.50 | 7.5% | operator |
| 27020 | Hash | 44.22 | 9.38 | 78.8% | operator |
| 27021 | Seq Scan | 38.40 | 12.70 | 66.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27021 (Seq Scan) - LEAF
...
### Step 2: Node 27019 (Seq Scan) - LEAF
...
### Step 4: Node 27015 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27016, 27017, 27018
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=15569
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=64
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0001
  - Aggregate_Outer_startup_cost=136919.9700
  - Aggregate_Outer_total_cost=136919.9800
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=137920.5400
  - Aggregate_total_cost=137920.5500
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=137919.9700
  - Gather_Outer_total_cost=137920.4800
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=15569
  - HashJoin_Outer_nt1=15569
  ...
  - HashJoin_Outer_total_cost=136647.5100
