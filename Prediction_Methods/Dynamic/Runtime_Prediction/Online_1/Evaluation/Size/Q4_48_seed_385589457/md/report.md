...
**Test Query:** Q4_48_seed_385589457
...
```
Node 6495 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6496 (Gather Merge) [consumed]
    Node 6497 (Sort) [consumed]
      Node 6498 (Aggregate) [consumed]
        Node 6499 (Nested Loop)
          Node 6500 (Seq Scan) - LEAF
          Node 6501 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6495 | 6496, 6497, 6498 |
...
|------|------|--------|-----------|-----|--------|
| 6495 | Aggregate | 1043.97 | 952.19 | 8.8% | pattern |
| 6499 | Nested Loop | 1037.22 | 1255.45 | 21.0% | operator |
| 6500 | Seq Scan | 164.91 | 154.66 | 6.2% | operator |
| 6501 | Index Scan | 0.06 | 11.10 | 18103.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6500 (Seq Scan) - LEAF
...
### Step 2: Node 6501 (Index Scan) - LEAF
