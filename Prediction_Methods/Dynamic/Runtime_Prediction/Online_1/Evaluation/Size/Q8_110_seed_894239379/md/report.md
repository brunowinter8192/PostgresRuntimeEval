...
```
Node 13454 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 13455 (Gather Merge) [consumed]
    Node 13456 (Sort)
          ...
          Node 13459 (Hash Join)
            Node 13460 (Nested Loop)
              Node 13461 (Hash Join)
                ...
                Node 13463 (Hash) [PATTERN: 444761fb]
                  Node 13464 (Hash Join) [consumed]
                    Node 13465 (Seq Scan) [consumed] - LEAF
                    Node 13466 (Hash) [consumed]
                      Node 13467 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 13463 | 13454, 13455, 13464, 13465, 13466, 13467 |
| Aggregate -> Gather Merge (Out | 2724c080 | 13454 | 13455, 13463, 13464, 13465, 13466, 13467 |
...
|------|------|--------|-----------|-----|--------|
| 13454 | Aggregate | 1229.57 | 1131.71 | 8.0% | pattern |
...
| 13461 | Hash Join | 210.20 | 251.67 | 19.7% | operator |
...
| 13463 | Hash | 35.78 | 43.51 | 21.6% | pattern |
...
### Step 4: Node 13462 (Seq Scan) - LEAF
...
### Step 5: Node 13463 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 13454, 13455, 13464, 13465, 13466, 13467
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 13471 (Index Scan) - LEAF
...
### Step 8: Node 13473 (Seq Scan) - LEAF
...
### Step 12: Node 13474 (Index Scan) - LEAF
...
### Step 13: Node 13476 (Seq Scan) - LEAF
...
### Step 14: Node 13458 (Nested Loop)
...
### Step 18: Node 13454 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 13455, 13463, 13464, 13465, 13466, 13467
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2444
