    ...
    Node 20230 (Aggregate) [consumed]
      Node 20231 (Gather) [consumed]
        Node 20232 (Hash Join)
          Node 20233 (Hash Join) [PATTERN: 2e0f44ef]
            Node 20234 (Nested Loop) [consumed]
              Node 20235 (Seq Scan) - LEAF
              Node 20236 (Index Scan) - LEAF
            Node 20237 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20228 | 20229, 20230, 20231, 20233, 20234, 20237 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 20233 | 20228, 20229, 20230, 20231, 20234, 20237 |
...
| 20232 | Hash Join | 1115.31 | 1095.44 | 1.8% | operator |
| 20233 | Hash Join | 1112.34 | 1120.19 | 0.7% | pattern |
...
### Step 4: Node 20240 (Seq Scan) - LEAF
...
### Step 5: Node 20233 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 20228, 20229, 20230, 20231, 20234, 20237
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=17761
  - HashJoin_nt1=17761
...
### Step 8: Node 20228 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20229, 20230, 20231, 20233, 20234, 20237
- **Input Features:**
