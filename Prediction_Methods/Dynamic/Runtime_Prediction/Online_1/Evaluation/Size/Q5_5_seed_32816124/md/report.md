...
```
Node 9001 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 9002 (Aggregate) [consumed]
    Node 9003 (Gather Merge) [consumed]
      Node 9004 (Aggregate)
        Node 9005 (Sort) [PATTERN: 3e2d5a00]
          Node 9006 (Hash Join) [consumed]
            Node 9007 (Nested Loop)
              Node 9008 (Hash Join)
                Node 9009 (Seq Scan) - LEAF
                Node 9010 (Hash) [PATTERN: 444761fb]
                  Node 9011 (Hash Join) [consumed]
                    Node 9012 (Seq Scan) [consumed] - LEAF
                    Node 9013 (Hash) [consumed]
                      Node 9014 (Hash Join) [consumed]
                        Node 9015 (Seq Scan) - LEAF
                        Node 9016 (Hash)
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 9010 | 9001, 9002, 9003, 9005, 9006, 9011, 9012, 9013, 9014 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 9001 | 9002, 9003, 9005, 9006, 9010, 9011, 9012, 9013, 9014 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 9005 | 9001, 9002, 9003, 9006, 9010, 9011, 9012, 9013, 9014 |
...
|------|------|--------|-----------|-----|--------|
| 9001 | Sort | 1097.65 | 2934.42 | 167.3% | pattern |
| 9004 | Aggregate | 1092.63 | 1128.76 | 3.3% | operator |
| 9005 | Sort | 1092.36 | 1835.93 | 68.1% | pattern |
| 9007 | Nested Loop | 1080.86 | 1188.47 | 10.0% | operator |
| 9019 | Hash | 2.97 | 18.67 | 527.8% | operator |
| 9008 | Hash Join | 214.84 | 253.07 | 17.8% | operator |
| 9018 | Index Scan | 0.08 | -0.22 | 385.7% | operator |
| 9020 | Seq Scan | 2.46 | 12.36 | 402.2% | operator |
| 9009 | Seq Scan | 165.05 | 159.81 | 3.2% | operator |
| 9010 | Hash | 37.21 | 46.85 | 25.9% | pattern |
| 9015 | Seq Scan | 0.01 | 11.81 | 131103.0% | operator |
| 9016 | Hash | 0.06 | 21.05 | 37495.1% | operator |
| 9017 | Seq Scan | 0.05 | 22.93 | 44002.6% | operator |
...
### Step 2: Node 9015 (Seq Scan) - LEAF
...
### Step 4: Node 9009 (Seq Scan) - LEAF
...
### Step 5: Node 9010 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 9001, 9002, 9003, 9005, 9006, 9011, 9012, 9013, 9014
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 9018 (Index Scan) - LEAF
...
### Step 8: Node 9020 (Seq Scan) - LEAF
...
### Step 11: Node 9005 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 9001, 9002, 9003, 9006, 9010, 9011, 9012, 9013, 9014
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 9001 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 9002, 9003, 9005, 9006, 9010, 9011, 9012, 9013, 9014
- **Input Features:**
