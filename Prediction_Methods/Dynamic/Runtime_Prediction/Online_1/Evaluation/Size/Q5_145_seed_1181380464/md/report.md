...
**Test Query:** Q5_145_seed_1181380464
...
```
Node 7881 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 7882 (Aggregate) [consumed]
    Node 7883 (Gather Merge) [consumed]
      Node 7884 (Aggregate)
        Node 7885 (Sort) [PATTERN: 3e2d5a00]
          Node 7886 (Hash Join) [consumed]
            Node 7887 (Nested Loop)
              Node 7888 (Hash Join)
                Node 7889 (Seq Scan) - LEAF
                Node 7890 (Hash) [PATTERN: 444761fb]
                  Node 7891 (Hash Join) [consumed]
                    Node 7892 (Seq Scan) [consumed] - LEAF
                    Node 7893 (Hash) [consumed]
                      Node 7894 (Hash Join) [consumed]
                        Node 7895 (Seq Scan) - LEAF
                        Node 7896 (Hash)
                          Node 7897 (Seq Scan) - LEAF
              Node 7898 (Index Scan) - LEAF
            Node 7899 (Hash)
              Node 7900 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 7890 | 7881, 7882, 7883, 7885, 7886, 7891, 7892, 7893, 7894 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 7881 | 7882, 7883, 7885, 7886, 7890, 7891, 7892, 7893, 7894 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 7885 | 7881, 7882, 7883, 7886, 7890, 7891, 7892, 7893, 7894 |
...
|------|------|--------|-----------|-----|--------|
| 7881 | Sort | 1080.67 | 2934.42 | 171.5% | pattern |
| 7884 | Aggregate | 1075.13 | 1128.79 | 5.0% | operator |
| 7885 | Sort | 1074.85 | 1835.90 | 70.8% | pattern |
| 7887 | Nested Loop | 1062.50 | 1188.37 | 11.8% | operator |
| 7899 | Hash | 3.47 | 18.67 | 438.5% | operator |
| 7888 | Hash Join | 216.50 | 253.07 | 16.9% | operator |
| 7898 | Index Scan | 0.07 | -0.22 | 397.3% | operator |
| 7900 | Seq Scan | 2.76 | 12.36 | 348.1% | operator |
| 7889 | Seq Scan | 166.29 | 159.81 | 3.9% | operator |
| 7890 | Hash | 37.03 | 46.85 | 26.5% | pattern |
| 7895 | Seq Scan | 0.01 | 11.81 | 107247.9% | operator |
| 7896 | Hash | 0.09 | 21.05 | 24668.5% | operator |
| 7897 | Seq Scan | 0.08 | 22.93 | 28212.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 7897 (Seq Scan) - LEAF
...
### Step 2: Node 7895 (Seq Scan) - LEAF
...
### Step 4: Node 7889 (Seq Scan) - LEAF
...
### Step 5: Node 7890 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 7881, 7882, 7883, 7885, 7886, 7891, 7892, 7893, 7894
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 7898 (Index Scan) - LEAF
...
### Step 8: Node 7900 (Seq Scan) - LEAF
...
### Step 11: Node 7885 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 7881, 7882, 7883, 7886, 7890, 7891, 7892, 7893, 7894
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 7881 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 7882, 7883, 7885, 7886, 7890, 7891, 7892, 7893, 7894
- **Input Features:**
