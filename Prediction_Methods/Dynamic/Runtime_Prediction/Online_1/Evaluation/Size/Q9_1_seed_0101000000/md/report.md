...
```
Node 17757 (Sort) - ROOT
  Node 17758 (Aggregate)
    Node 17759 (Gather)
      Node 17760 (Aggregate)
        Node 17761 (Nested Loop)
          Node 17762 (Hash Join)
            Node 17763 (Seq Scan) - LEAF
            Node 17764 (Hash)
              Node 17765 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 17757 | Sort | 1232.81 | 1119.21 | 9.2% | operator |
| 17758 | Aggregate | 1232.69 | 897.16 | 27.2% | operator |
...
| 17762 | Hash Join | 1003.40 | 633.14 | 36.9% | operator |
| 17774 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17763 | Seq Scan | 728.86 | 509.93 | 30.0% | operator |
| 17764 | Hash | 179.81 | 47.79 | 73.4% | operator |
| 17765 | Hash Join | 178.08 | 924.37 | 419.1% | operator |
...
### Step 10: Node 17763 (Seq Scan) - LEAF
...
### Step 13: Node 17774 (Index Scan) - LEAF
...
### Step 14: Node 17761 (Nested Loop)
