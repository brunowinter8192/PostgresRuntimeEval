...
**Test Query:** Q9_1_seed_0101000000
...
```
Node 17757 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 17758 (Aggregate) [consumed]
    Node 17759 (Gather)
      Node 17760 (Aggregate)
        Node 17761 (Nested Loop)
          Node 17762 (Hash Join) [PATTERN: bb930825]
            Node 17763 (Seq Scan) [consumed] - LEAF
            Node 17764 (Hash) [consumed]
              Node 17765 (Hash Join) [consumed]
                Node 17766 (Hash Join)
                  Node 17767 (Nested Loop)
                    Node 17768 (Seq Scan) - LEAF
                    Node 17769 (Index Scan) - LEAF
                  Node 17770 (Hash)
                    Node 17771 (Seq Scan) - LEAF
                Node 17772 (Hash)
                  Node 17773 (Seq Scan) - LEAF
          Node 17774 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17762 | 17757, 17758, 17763, 17764, 17765 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17757 | 17758, 17762, 17763, 17764, 17765 |
...
|------|------|--------|-----------|-----|--------|
| 17757 | Sort | 1232.81 | 1045.06 | 15.2% | pattern |
| 17759 | Gather | 1231.86 | 964.74 | 21.7% | operator |
| 17760 | Aggregate | 1207.75 | 1106.30 | 8.4% | operator |
| 17761 | Nested Loop | 1183.20 | 1252.17 | 5.8% | operator |
| 17762 | Hash Join | 1003.40 | 134.80 | 86.6% | pattern |
| 17774 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17766 | Hash Join | 163.66 | 837.58 | 411.8% | operator |
| 17772 | Hash | 13.78 | 14.95 | 8.5% | operator |
| 17767 | Nested Loop | 157.77 | 1251.77 | 693.4% | operator |
| 17770 | Hash | 3.48 | 15.94 | 358.5% | operator |
| 17773 | Seq Scan | 13.77 | 2.94 | 78.7% | operator |
| 17768 | Seq Scan | 20.76 | 44.10 | 112.4% | operator |
| 17769 | Index Scan | 0.08 | -1.39 | 1926.9% | operator |
| 17771 | Seq Scan | 2.97 | 9.45 | 217.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 17768 (Seq Scan) - LEAF
...
### Step 2: Node 17769 (Index Scan) - LEAF
...
### Step 3: Node 17771 (Seq Scan) - LEAF
...
### Step 6: Node 17773 (Seq Scan) - LEAF
...
### Step 9: Node 17762 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17757, 17758, 17763, 17764, 17765
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17774 (Index Scan) - LEAF
...
### Step 11: Node 17761 (Nested Loop)
...
### Step 14: Node 17757 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17758, 17762, 17763, 17764, 17765
- **Input Features:**
