...
```
Node 26140 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26141 (Aggregate) [consumed]
    Node 26142 (Aggregate)
      Node 26143 (Hash Join) [PATTERN: 895c6e8c]
        Node 26144 (Seq Scan) [consumed] - LEAF
        Node 26145 (Hash) [consumed]
          Node 26146 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26140 | 26141, 26143, 26144, 26145 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26143 | 26140, 26141, 26144, 26145 |
...
|------|------|--------|-----------|-----|--------|
| 26140 | Sort | 924.85 | 1079.93 | 16.8% | pattern |
| 26142 | Aggregate | 918.79 | 999.55 | 8.8% | operator |
| 26143 | Hash Join | 712.58 | 470.31 | 34.0% | pattern |
| 26146 | Index Only Scan | 11.19 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26146 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26143 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26140, 26141, 26144, 26145
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1484970
...
### Step 4: Node 26140 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26141, 26143, 26144, 26145
- **Input Features:**
