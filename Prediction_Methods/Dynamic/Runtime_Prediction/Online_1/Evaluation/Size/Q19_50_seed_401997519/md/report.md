...
```
Node 31885 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31886 (Gather) [consumed]
    Node 31887 (Aggregate) [consumed]
      Node 31888 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31885 | 31886, 31887 |
...
|------|------|--------|-----------|-----|--------|
| 31885 | Aggregate | 819.43 | 831.20 | 1.4% | pattern |
| 31888 | Hash Join | 799.03 | 766.06 | 4.1% | operator |
...
### Step 5: Node 31885 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31886, 31887
- **Input Features:**
