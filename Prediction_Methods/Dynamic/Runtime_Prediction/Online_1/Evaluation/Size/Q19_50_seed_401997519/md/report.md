...
**Test Query:** Q19_50_seed_401997519
...
```
Node 31885 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31886 (Gather) [consumed]
    Node 31887 (Aggregate) [consumed]
      Node 31888 (Hash Join) [consumed]
        Node 31889 (Seq Scan) - LEAF
        Node 31890 (Hash)
          Node 31891 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31885 | 31886, 31887, 31888 |
...
|------|------|--------|-----------|-----|--------|
| 31885 | Aggregate | 819.43 | 829.29 | 1.2% | pattern |
| 31889 | Seq Scan | 749.15 | 743.46 | 0.8% | operator |
| 31890 | Hash | 47.99 | 8.29 | 82.7% | operator |
| 31891 | Seq Scan | 47.86 | 23.76 | 50.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31891 (Seq Scan) - LEAF
...
### Step 2: Node 31889 (Seq Scan) - LEAF
...
### Step 4: Node 31885 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31886, 31887, 31888
- **Input Features:**
  ...
  - HashJoin_Outer_total_cost=156338.6000
