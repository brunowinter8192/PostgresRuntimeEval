...
```
Node 31535 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31536 (Gather) [consumed]
    Node 31537 (Aggregate) [consumed]
      Node 31538 (Hash Join) [consumed]
        Node 31539 (Seq Scan) - LEAF
        Node 31540 (Hash)
          Node 31541 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31535 | 31536, 31537, 31538 |
...
|------|------|--------|-----------|-----|--------|
| 31535 | Aggregate | 864.06 | 829.28 | 4.0% | pattern |
| 31539 | Seq Scan | 791.49 | 743.46 | 6.1% | operator |
| 31540 | Hash | 47.49 | 8.29 | 82.6% | operator |
| 31541 | Seq Scan | 47.33 | 23.76 | 49.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31541 (Seq Scan) - LEAF
...
### Step 2: Node 31539 (Seq Scan) - LEAF
...
### Step 4: Node 31535 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31536, 31537, 31538
- **Input Features:**
