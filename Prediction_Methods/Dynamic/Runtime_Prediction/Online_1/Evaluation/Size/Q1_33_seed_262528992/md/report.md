...
**Test Query:** Q1_33_seed_262528992
...
```
Node 381 (Aggregate) - ROOT
  Node 382 (Gather Merge)
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 383 | 384 |
...
|------|------|--------|-----------|-----|--------|
| 381 | Aggregate | 953.73 | 1195.75 | 25.4% | operator |
| 382 | Gather Merge | 953.70 | 1165.86 | 22.2% | operator |
| 383 | Sort | 934.27 | 1199.97 | 28.4% | pattern |
| 385 | Seq Scan | 519.99 | 682.29 | 31.2% | operator |
...
- **Input Features:**
  ...
  - Aggregate_Outer_total_cost=168601.2300
  - Sort_np=0
  - Sort_nt=6
  - Sort_nt1=6
  - Sort_nt2=0
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=168601.3100
  - Sort_total_cost=168601.3200
- **Output:** st=1195.87, rt=1199.97

### Step 3: Node 382 (Gather Merge)
...
### Step 4: Node 381 (Aggregate) - ROOT
