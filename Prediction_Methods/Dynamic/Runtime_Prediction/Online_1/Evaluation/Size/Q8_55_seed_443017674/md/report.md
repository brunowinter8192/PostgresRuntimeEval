...
**Test Query:** Q8_55_seed_443017674
...
Node 15501 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 15502 (Gather Merge) [consumed]
    Node 15503 (Sort)
      Node 15504 (Hash Join)
        Node 15505 (Nested Loop)
          Node 15506 (Hash Join)
            Node 15507 (Nested Loop)
              Node 15508 (Hash Join)
                Node 15509 (Seq Scan) - LEAF
                Node 15510 (Hash) [PATTERN: 444761fb]
                  Node 15511 (Hash Join) [consumed]
                    Node 15512 (Seq Scan) [consumed] - LEAF
                    Node 15513 (Hash) [consumed]
                      Node 15514 (Hash Join) [consumed]
                        Node 15515 (Seq Scan) - LEAF
                        Node 15516 (Hash)
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 15510 | 15501, 15502, 15511, 15512, 15513, 15514 |
| Aggregate -> Gather Merge (Out | 2724c080 | 15501 | 15502, 15510, 15511, 15512, 15513, 15514 |
...
|------|------|--------|-----------|-----|--------|
| 15501 | Aggregate | 1268.01 | 1133.67 | 10.6% | pattern |
| 15503 | Sort | 1261.41 | 1046.21 | 17.1% | operator |
| 15504 | Hash Join | 1261.17 | 785.61 | 37.7% | operator |
| 15505 | Nested Loop | 1260.09 | 1198.29 | 4.9% | operator |
| 15522 | Hash | 0.01 | 13.72 | 97929.2% | operator |
| 15506 | Hash Join | 1256.43 | 785.60 | 37.5% | operator |
| 15521 | Index Scan | 0.01 | 12.42 | 206958.1% | operator |
| 15523 | Seq Scan | 0.01 | 6.51 | 72255.1% | operator |
| 15507 | Nested Loop | 1212.33 | 1198.29 | 1.2% | operator |
| 15519 | Hash | 39.80 | 19.97 | 49.8% | operator |
| 15508 | Hash Join | 216.01 | 251.67 | 16.5% | operator |
| 15518 | Index Scan | 0.04 | 2.88 | 6599.7% | operator |
| 15520 | Seq Scan | 39.70 | 48.89 | 23.1% | operator |
| 15509 | Seq Scan | 162.42 | 159.67 | 1.7% | operator |
| 15510 | Hash | 36.10 | 43.51 | 20.5% | pattern |
| 15515 | Seq Scan | 0.01 | 12.22 | 122149.4% | operator |
| 15516 | Hash | 0.43 | 18.14 | 4159.2% | operator |
| 15517 | Seq Scan | 0.42 | 23.36 | 5436.1% | operator |
...
### Step 2: Node 15515 (Seq Scan) - LEAF
...
### Step 4: Node 15509 (Seq Scan) - LEAF
...
### Step 5: Node 15510 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 15501, 15502, 15511, 15512, 15513, 15514
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 15518 (Index Scan) - LEAF
...
### Step 8: Node 15520 (Seq Scan) - LEAF
...
### Step 12: Node 15521 (Index Scan) - LEAF
...
### Step 13: Node 15523 (Seq Scan) - LEAF
...
### Step 14: Node 15505 (Nested Loop)
...
### Step 18: Node 15501 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 15502, 15510, 15511, 15512, 15513, 15514
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2325
  - Aggregate_nt1=2325
