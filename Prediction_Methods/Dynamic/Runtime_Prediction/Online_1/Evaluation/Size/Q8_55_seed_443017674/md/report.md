...
```
Node 15501 (Aggregate) - ROOT
  Node 15502 (Gather Merge)
    Node 15503 (Sort)
          ...
          Node 15506 (Hash Join)
            Node 15507 (Nested Loop)
              Node 15508 (Hash Join)
                ...
                Node 15510 (Hash)
                  Node 15511 (Hash Join)
                    Node 15512 (Seq Scan) - LEAF
                    Node 15513 (Hash)
                      Node 15514 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 15501 | Aggregate | 1268.01 | 1195.83 | 5.7% | operator |
| 15502 | Gather Merge | 1267.58 | 1097.16 | 13.4% | operator |
...
| 15508 | Hash Join | 216.01 | 251.17 | 16.3% | operator |
...
| 15510 | Hash | 36.10 | 20.62 | 42.9% | operator |
| 15511 | Hash Join | 35.54 | 132.26 | 272.2% | operator |
| 15512 | Seq Scan | 33.83 | 23.03 | 31.9% | operator |
| 15513 | Hash | 0.44 | 23.66 | 5228.0% | operator |
| 15514 | Hash Join | 0.44 | 306.84 | 69319.9% | operator |
...
### Step 5: Node 15512 (Seq Scan) - LEAF
...
### Step 8: Node 15509 (Seq Scan) - LEAF
...
### Step 11: Node 15518 (Index Scan) - LEAF
...
### Step 12: Node 15520 (Seq Scan) - LEAF
...
### Step 13: Node 15507 (Nested Loop)
...
### Step 16: Node 15521 (Index Scan) - LEAF
...
### Step 17: Node 15523 (Seq Scan) - LEAF
...
### Step 18: Node 15505 (Nested Loop)
...
### Step 22: Node 15502 (Gather Merge)
...
### Step 23: Node 15501 (Aggregate) - ROOT
