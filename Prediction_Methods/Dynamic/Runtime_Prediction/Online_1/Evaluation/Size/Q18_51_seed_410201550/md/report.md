...
**Test Query:** Q18_51_seed_410201550
...
```
Node 30356 (Limit) - ROOT
  Node 30357 (Sort)
    Node 30358 (Aggregate)
      Node 30359 (Gather Merge)
        Node 30360 (Incremental Sort)
          Node 30361 (Nested Loop)
            Node 30362 (Merge Join)
              Node 30363 (Sort)
                Node 30364 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30365 (Seq Scan) [consumed] - LEAF
                  Node 30366 (Hash) [consumed]
                    Node 30367 (Aggregate)
                      Node 30368 (Index Scan) - LEAF
              Node 30369 (Sort)
                Node 30370 (Seq Scan) - LEAF
            Node 30371 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30364 | 30365, 30366 |
...
|------|------|--------|-----------|-----|--------|
| 30356 | Limit | 3103.33 | 1175.21 | 62.1% | operator |
| 30357 | Sort | 2991.98 | 1127.81 | 62.3% | operator |
| 30358 | Aggregate | 2991.93 | 1073.15 | 64.1% | operator |
| 30359 | Gather Merge | 2991.91 | 1073.95 | 64.1% | operator |
| 30360 | Incremental Sort | 2973.85 | 0.00 | 100.0% | operator |
| 30361 | Nested Loop | 2973.79 | 1111.34 | 62.6% | operator |
| 30362 | Merge Join | 2973.73 | 0.00 | 100.0% | operator |
| 30371 | Index Scan | 0.02 | 0.05 | 125.7% | operator |
| 30363 | Sort | 2906.51 | 1095.58 | 62.3% | operator |
| 30369 | Sort | 64.27 | 1074.66 | 1572.2% | operator |
| 30364 | Hash Join | 2906.50 | 471.07 | 83.8% | pattern |
| 30370 | Seq Scan | 52.25 | 18.25 | 65.1% | operator |
| 30367 | Aggregate | 2675.10 | 1073.15 | 59.9% | operator |
| 30368 | Index Scan | 2174.69 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30368 (Index Scan) - LEAF
...
### Step 3: Node 30364 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30365, 30366
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30370 (Seq Scan) - LEAF
...
### Step 7: Node 30362 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30371 (Index Scan) - LEAF
...
### Step 10: Node 30360 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30359 (Gather Merge)
