...
**Test Query:** Q9_24_seed_188692713
...
```
Node 17847 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 17848 (Aggregate) [consumed]
    Node 17849 (Gather)
      Node 17850 (Aggregate)
        Node 17851 (Nested Loop)
          Node 17852 (Hash Join) [PATTERN: bb930825]
            Node 17853 (Seq Scan) [consumed] - LEAF
            Node 17854 (Hash) [consumed]
              Node 17855 (Hash Join) [consumed]
                Node 17856 (Hash Join)
                  Node 17857 (Nested Loop)
                    Node 17858 (Seq Scan) - LEAF
                    Node 17859 (Index Scan) - LEAF
                  Node 17860 (Hash)
                    Node 17861 (Seq Scan) - LEAF
                Node 17862 (Hash)
                  Node 17863 (Seq Scan) - LEAF
          Node 17864 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17852 | 17847, 17848, 17853, 17854, 17855 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17847 | 17848, 17852, 17853, 17854, 17855 |
...
|------|------|--------|-----------|-----|--------|
| 17847 | Sort | 1173.25 | 1045.10 | 10.9% | pattern |
| 17849 | Gather | 1172.07 | 960.51 | 18.1% | operator |
| 17850 | Aggregate | 1153.11 | 1141.32 | 1.0% | operator |
| 17851 | Nested Loop | 1128.42 | 1252.17 | 11.0% | operator |
| 17852 | Hash Join | 956.15 | 134.80 | 85.9% | pattern |
| 17864 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17856 | Hash Join | 160.69 | 837.46 | 421.2% | operator |
| 17862 | Hash | 13.59 | 14.95 | 10.0% | operator |
| 17857 | Nested Loop | 153.35 | 1251.76 | 716.3% | operator |
| 17860 | Hash | 5.19 | 15.94 | 207.2% | operator |
| 17863 | Seq Scan | 13.58 | 2.94 | 78.4% | operator |
| 17858 | Seq Scan | 18.98 | 44.37 | 133.8% | operator |
| 17859 | Index Scan | 0.07 | -1.39 | 1976.3% | operator |
| 17861 | Seq Scan | 4.68 | 9.45 | 102.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 17858 (Seq Scan) - LEAF
...
### Step 2: Node 17859 (Index Scan) - LEAF
...
### Step 3: Node 17861 (Seq Scan) - LEAF
...
### Step 6: Node 17863 (Seq Scan) - LEAF
...
### Step 9: Node 17852 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17847, 17848, 17853, 17854, 17855
- **Input Features:**
  - HashJoin_Outer_np=0
  ...
  - HashJoin_Outer_total_cost=14329.5300
  - HashJoin_np=0
  - HashJoin_nt=57726
...
### Step 10: Node 17864 (Index Scan) - LEAF
...
### Step 11: Node 17851 (Nested Loop)
...
### Step 14: Node 17847 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17848, 17852, 17853, 17854, 17855
- **Input Features:**
