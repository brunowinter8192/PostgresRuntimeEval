...
**Test Query:** Q14_1_seed_0101000000
...
```
Node 26847 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26848 (Gather) [consumed]
    Node 26849 (Aggregate) [consumed]
      Node 26850 (Hash Join) [consumed]
        Node 26851 (Seq Scan) - LEAF
        Node 26852 (Hash)
          Node 26853 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26847 | 26848, 26849, 26850 |
...
|------|------|--------|-----------|-----|--------|
| 26847 | Aggregate | 847.21 | 857.11 | 1.2% | pattern |
| 26851 | Seq Scan | 767.36 | 758.45 | 1.2% | operator |
| 26852 | Hash | 47.29 | 9.38 | 80.2% | operator |
| 26853 | Seq Scan | 41.41 | 12.70 | 69.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26853 (Seq Scan) - LEAF
...
### Step 2: Node 26851 (Seq Scan) - LEAF
...
### Step 4: Node 26847 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26848, 26849, 26850
- **Input Features:**
