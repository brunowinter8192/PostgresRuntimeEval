...
**Test Query:** Q19_76_seed_615302325
...
```
Node 32081 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 32082 (Gather) [consumed]
    Node 32083 (Aggregate) [consumed]
      Node 32084 (Hash Join) [consumed]
        Node 32085 (Seq Scan) - LEAF
        Node 32086 (Hash)
          Node 32087 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 32081 | 32082, 32083, 32084 |
...
|------|------|--------|-----------|-----|--------|
| 32081 | Aggregate | 847.17 | 829.30 | 2.1% | pattern |
| 32085 | Seq Scan | 778.69 | 743.46 | 4.5% | operator |
| 32086 | Hash | 46.46 | 8.29 | 82.2% | operator |
| 32087 | Seq Scan | 46.33 | 23.76 | 48.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 32087 (Seq Scan) - LEAF
...
### Step 2: Node 32085 (Seq Scan) - LEAF
...
### Step 4: Node 32081 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 32082, 32083, 32084
- **Input Features:**
