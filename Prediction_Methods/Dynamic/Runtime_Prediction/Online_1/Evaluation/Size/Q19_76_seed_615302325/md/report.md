...
```
Node 32081 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 32082 (Gather) [consumed]
    Node 32083 (Aggregate) [consumed]
      Node 32084 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 32081 | 32082, 32083 |
...
|------|------|--------|-----------|-----|--------|
| 32081 | Aggregate | 847.17 | 831.20 | 1.9% | pattern |
| 32084 | Hash Join | 826.64 | 766.06 | 7.3% | operator |
...
### Step 5: Node 32081 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 32082, 32083
- **Input Features:**
