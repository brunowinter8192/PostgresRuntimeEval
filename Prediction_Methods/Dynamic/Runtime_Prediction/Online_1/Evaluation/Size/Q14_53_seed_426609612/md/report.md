...
**Test Query:** Q14_53_seed_426609612
...
```
Node 27106 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27107 (Gather) [consumed]
    Node 27108 (Aggregate) [consumed]
      Node 27109 (Hash Join) [consumed]
        Node 27110 (Seq Scan) - LEAF
        Node 27111 (Hash)
          Node 27112 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27106 | 27107, 27108, 27109 |
...
|------|------|--------|-----------|-----|--------|
| 27106 | Aggregate | 818.57 | 857.13 | 4.7% | pattern |
| 27110 | Seq Scan | 743.05 | 758.50 | 2.1% | operator |
| 27111 | Hash | 43.20 | 9.38 | 78.3% | operator |
| 27112 | Seq Scan | 37.48 | 12.70 | 66.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27112 (Seq Scan) - LEAF
...
### Step 2: Node 27110 (Seq Scan) - LEAF
...
### Step 4: Node 27106 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27107, 27108, 27109
- **Input Features:**
