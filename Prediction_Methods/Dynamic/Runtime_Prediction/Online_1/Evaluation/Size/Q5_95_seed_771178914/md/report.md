...
**Test Query:** Q5_95_seed_771178914
**Timestamp:** 2026-01-18 17:34:04
...
```
Node 9781 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 9782 (Aggregate) [consumed]
    Node 9783 (Gather Merge) [consumed]
      Node 9784 (Aggregate)
        Node 9785 (Sort) [PATTERN: 3e2d5a00]
          Node 9786 (Hash Join) [consumed]
            Node 9787 (Nested Loop)
              Node 9788 (Hash Join)
                Node 9789 (Seq Scan) - LEAF
                Node 9790 (Hash) [PATTERN: 444761fb]
                  Node 9791 (Hash Join) [consumed]
                    Node 9792 (Seq Scan) [consumed] - LEAF
                    Node 9793 (Hash) [consumed]
                      Node 9794 (Hash Join) [consumed]
                        Node 9795 (Seq Scan) - LEAF
                        Node 9796 (Hash)
                          Node 9797 (Seq Scan) - LEAF
              Node 9798 (Index Scan) - LEAF
            Node 9799 (Hash)
              Node 9800 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 9790 | 9781, 9782, 9783, 9785, 9786, 9791, 9792, 9793, 9794 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 9781 | 9782, 9783, 9785, 9786, 9790, 9791, 9792, 9793, 9794 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 9785 | 9781, 9782, 9783, 9786, 9790, 9791, 9792, 9793, 9794 |
...
|------|------|--------|-----------|-----|--------|
| 9781 | Sort | 1087.34 | 2934.42 | 169.9% | pattern |
| 9784 | Aggregate | 1082.24 | 1128.78 | 4.3% | operator |
| 9785 | Sort | 1081.98 | 1835.92 | 69.7% | pattern |
| 9787 | Nested Loop | 1069.91 | 1188.42 | 11.1% | operator |
| 9799 | Hash | 3.48 | 18.67 | 437.1% | operator |
| 9788 | Hash Join | 221.31 | 253.07 | 14.4% | operator |
| 9798 | Index Scan | 0.07 | -0.22 | 397.3% | operator |
| 9800 | Seq Scan | 2.92 | 12.36 | 323.0% | operator |
| 9789 | Seq Scan | 172.26 | 159.81 | 7.2% | operator |
| 9790 | Hash | 35.72 | 46.85 | 31.2% | pattern |
| 9795 | Seq Scan | 0.01 | 11.81 | 147503.4% | operator |
| 9796 | Hash | 0.14 | 21.05 | 15380.3% | operator |
| 9797 | Seq Scan | 0.13 | 22.93 | 17273.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 9797 (Seq Scan) - LEAF
...
### Step 2: Node 9795 (Seq Scan) - LEAF
...
### Step 4: Node 9789 (Seq Scan) - LEAF
...
### Step 5: Node 9790 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 9781, 9782, 9783, 9785, 9786, 9791, 9792, 9793, 9794
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 9798 (Index Scan) - LEAF
...
### Step 8: Node 9800 (Seq Scan) - LEAF
...
### Step 11: Node 9785 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 9781, 9782, 9783, 9786, 9790, 9791, 9792, 9793, 9794
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 9781 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 9782, 9783, 9785, 9786, 9790, 9791, 9792, 9793, 9794
- **Input Features:**
