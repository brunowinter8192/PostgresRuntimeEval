...
```
Node 13983 (Aggregate) - ROOT
  Node 13984 (Gather Merge)
    Node 13985 (Sort)
          ...
          Node 13988 (Hash Join)
            Node 13989 (Nested Loop)
              Node 13990 (Hash Join)
                ...
                Node 13992 (Hash)
                  Node 13993 (Hash Join)
                    Node 13994 (Seq Scan) - LEAF
                    Node 13995 (Hash)
                      Node 13996 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 13983 | Aggregate | 1179.06 | 1192.46 | 1.1% | operator |
| 13984 | Gather Merge | 1178.66 | 1097.17 | 6.9% | operator |
...
| 13990 | Hash Join | 207.52 | 251.17 | 21.0% | operator |
...
| 13992 | Hash | 31.57 | 20.62 | 34.7% | operator |
| 13993 | Hash Join | 30.96 | 132.26 | 327.2% | operator |
| 13994 | Seq Scan | 29.43 | 23.03 | 21.7% | operator |
| 13995 | Hash | 0.20 | 23.66 | 12031.3% | operator |
| 13996 | Hash Join | 0.19 | 306.84 | 159710.4% | operator |
...
### Step 5: Node 13994 (Seq Scan) - LEAF
...
### Step 8: Node 13991 (Seq Scan) - LEAF
...
### Step 11: Node 14000 (Index Scan) - LEAF
...
### Step 12: Node 14002 (Seq Scan) - LEAF
...
### Step 13: Node 13989 (Nested Loop)
...
### Step 16: Node 14003 (Index Scan) - LEAF
...
### Step 17: Node 14005 (Seq Scan) - LEAF
...
### Step 18: Node 13987 (Nested Loop)
...
### Step 22: Node 13984 (Gather Merge)
...
### Step 23: Node 13983 (Aggregate) - ROOT
