...
**Test Query:** Q19_37_seed_295345116
...
```
Node 31780 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31781 (Gather) [consumed]
    Node 31782 (Aggregate) [consumed]
      Node 31783 (Hash Join) [consumed]
        Node 31784 (Seq Scan) - LEAF
        Node 31785 (Hash)
          Node 31786 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31780 | 31781, 31782, 31783 |
...
|------|------|--------|-----------|-----|--------|
| 31780 | Aggregate | 852.08 | 829.30 | 2.7% | pattern |
| 31784 | Seq Scan | 783.40 | 743.46 | 5.1% | operator |
| 31785 | Hash | 47.08 | 8.29 | 82.4% | operator |
| 31786 | Seq Scan | 46.95 | 23.76 | 49.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31786 (Seq Scan) - LEAF
...
### Step 2: Node 31784 (Seq Scan) - LEAF
...
### Step 4: Node 31780 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31781, 31782, 31783
- **Input Features:**
