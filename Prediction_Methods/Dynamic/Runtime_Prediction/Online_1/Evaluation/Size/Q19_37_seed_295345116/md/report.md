...
```
Node 31780 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31781 (Gather) [consumed]
    Node 31782 (Aggregate) [consumed]
      Node 31783 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31780 | 31781, 31782 |
...
|------|------|--------|-----------|-----|--------|
| 31780 | Aggregate | 852.08 | 831.20 | 2.5% | pattern |
| 31783 | Hash Join | 832.39 | 766.06 | 8.0% | operator |
...
### Step 5: Node 31780 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31781, 31782
- **Input Features:**
