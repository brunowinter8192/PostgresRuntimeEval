...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5071 | 5072, 5073, 5074 |
...
| 5075 | Nested Loop | 1168.85 | 1193.26 | 2.1% | operator |
| 5076 | Hash Join | 207.56 | 231.20 | 11.4% | operator |
| 5080 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5077 | Seq Scan | 156.24 | 163.54 | 4.7% | operator |
| 5078 | Hash | 28.07 | 17.75 | 36.8% | operator |
...
### Step 2: Node 5077 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37344.3800
- **Output:** st=27.27, rt=231.20

### Step 5: Node 5080 (Index Scan) - LEAF
...
- **Output:** st=121.96, rt=1193.26

### Step 7: Node 5071 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5072, 5073, 5074
- **Input Features:**
