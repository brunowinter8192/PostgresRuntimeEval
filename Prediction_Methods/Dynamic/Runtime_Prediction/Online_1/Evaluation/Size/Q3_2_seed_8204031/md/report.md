...
```
Node 5071 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5072 (Sort) [consumed]
    Node 5073 (Aggregate) [consumed]
      Node 5074 (Gather) [consumed]
        Node 5075 (Nested Loop)
          Node 5076 (Hash Join) [PATTERN: 895c6e8c]
            Node 5077 (Seq Scan) [consumed] - LEAF
            Node 5078 (Hash) [consumed]
              Node 5079 (Seq Scan) - LEAF
          Node 5080 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5071 | 5072, 5073, 5074, 5076, 5077, 5078 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5076 | 5071, 5072, 5073, 5074, 5077, 5078 |
...
|------|------|--------|-----------|-----|--------|
| 5071 | Limit | 1207.78 | 1151.18 | 4.7% | pattern |
| 5075 | Nested Loop | 1168.85 | 1193.34 | 2.1% | operator |
| 5076 | Hash Join | 207.56 | 242.53 | 16.8% | pattern |
| 5080 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5079 | Seq Scan | 27.27 | 38.57 | 41.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5079 (Seq Scan) - LEAF
...
### Step 2: Node 5076 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5071, 5072, 5073, 5074, 5077, 5078
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47366
  - HashJoin_nt1=237233
  ...
  - HashJoin_total_cost=37344.3800
  - Hash_Inner_np=0
  - Hash_Inner_nt=12479
...
### Step 3: Node 5080 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=73131.1000
- **Output:** st=122.09, rt=1193.34

### Step 5: Node 5071 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5072, 5073, 5074, 5076, 5077, 5078
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=313560
  - Aggregate_Outer_nt1=313560
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110190.5000
  - Aggregate_Outer_total_cost=114110.0000
  - Gather_Outer_np=0
  - Gather_Outer_nt=313560
  - Gather_Outer_nt1=101148
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105487.1000
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=313560
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=120885.9200
  - Limit_total_cost=120885.9400
  - Sort_Outer_np=0
  - Sort_Outer_nt=313560
  - Sort_Outer_nt1=313560
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=120885.9200
  - Sort_Outer_total_cost=121669.8200
