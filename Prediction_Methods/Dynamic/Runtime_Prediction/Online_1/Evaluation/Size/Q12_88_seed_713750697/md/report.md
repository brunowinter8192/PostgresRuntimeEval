...
**Test Query:** Q12_88_seed_713750697
...
```
Node 25272 (Aggregate) - ROOT
  Node 25273 (Gather Merge)
    Node 25274 (Aggregate)
      Node 25275 (Sort)
        Node 25276 (Nested Loop)
          Node 25277 (Seq Scan) - LEAF
          Node 25278 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 25272 | Aggregate | 998.22 | 919.07 | 7.9% | operator |
| 25273 | Gather Merge | 998.19 | 1111.84 | 11.4% | operator |
| 25274 | Aggregate | 978.75 | 895.31 | 8.5% | operator |
| 25275 | Sort | 978.12 | 1092.81 | 11.7% | operator |
| 25276 | Nested Loop | 977.10 | 1127.41 | 15.4% | operator |
| 25277 | Seq Scan | 835.18 | 745.19 | 10.8% | operator |
| 25278 | Index Scan | 0.03 | 0.07 | 166.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25277 (Seq Scan) - LEAF
...
### Step 2: Node 25278 (Index Scan) - LEAF
...
### Step 6: Node 25273 (Gather Merge)
...
### Step 7: Node 25272 (Aggregate) - ROOT
