...
**Test Query:** Q5_125_seed_1017299844
...
```
Node 7441 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 7442 (Aggregate) [consumed]
    Node 7443 (Gather Merge) [consumed]
      Node 7444 (Aggregate)
        Node 7445 (Sort) [PATTERN: 3e2d5a00]
          Node 7446 (Hash Join) [consumed]
            Node 7447 (Nested Loop)
              Node 7448 (Hash Join)
                Node 7449 (Seq Scan) - LEAF
                Node 7450 (Hash) [PATTERN: 444761fb]
                  Node 7451 (Hash Join) [consumed]
                    Node 7452 (Seq Scan) [consumed] - LEAF
                    Node 7453 (Hash) [consumed]
                      Node 7454 (Hash Join) [consumed]
                        Node 7455 (Seq Scan) - LEAF
                        Node 7456 (Hash)
                          Node 7457 (Seq Scan) - LEAF
              Node 7458 (Index Scan) - LEAF
            Node 7459 (Hash)
              Node 7460 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 7450 | 7441, 7442, 7443, 7445, 7446, 7451, 7452, 7453, 7454 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 7441 | 7442, 7443, 7445, 7446, 7450, 7451, 7452, 7453, 7454 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 7445 | 7441, 7442, 7443, 7446, 7450, 7451, 7452, 7453, 7454 |
...
|------|------|--------|-----------|-----|--------|
| 7441 | Sort | 1060.13 | 2934.42 | 176.8% | pattern |
| 7444 | Aggregate | 1055.17 | 1128.74 | 7.0% | operator |
| 7445 | Sort | 1054.94 | 1835.96 | 74.0% | pattern |
| 7447 | Nested Loop | 1040.82 | 1188.57 | 14.2% | operator |
| 7459 | Hash | 5.54 | 18.67 | 237.0% | operator |
| 7448 | Hash Join | 209.69 | 253.07 | 20.7% | operator |
| 7458 | Index Scan | 0.07 | -0.22 | 401.4% | operator |
| 7460 | Seq Scan | 5.08 | 12.36 | 143.4% | operator |
| 7449 | Seq Scan | 166.97 | 159.81 | 4.3% | operator |
| 7450 | Hash | 30.14 | 46.85 | 55.5% | pattern |
| 7455 | Seq Scan | 0.01 | 11.81 | 147503.4% | operator |
| 7456 | Hash | 0.05 | 21.05 | 39623.1% | operator |
| 7457 | Seq Scan | 0.05 | 22.93 | 45766.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 7457 (Seq Scan) - LEAF
...
### Step 2: Node 7455 (Seq Scan) - LEAF
...
### Step 4: Node 7449 (Seq Scan) - LEAF
...
### Step 5: Node 7450 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 7441, 7442, 7443, 7445, 7446, 7451, 7452, 7453, 7454
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 7458 (Index Scan) - LEAF
...
### Step 8: Node 7460 (Seq Scan) - LEAF
...
### Step 11: Node 7445 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 7441, 7442, 7443, 7446, 7450, 7451, 7452, 7453, 7454
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 7441 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 7442, 7443, 7445, 7446, 7450, 7451, 7452, 7453, 7454
- **Input Features:**
