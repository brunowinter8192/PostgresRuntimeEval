    ...
    Node 17160 (Gather)
      Node 17161 (Aggregate)
        Node 17162 (Nested Loop)
          Node 17163 (Hash Join) [PATTERN: bb930825]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17163 | 17158, 17159, 17164, 17165, 17166 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17158 | 17159, 17163, 17164, 17165, 17166 |
...
|------|------|--------|-----------|-----|--------|
| 17158 | Sort | 1198.58 | 1045.32 | 12.8% | pattern |
...
| 17163 | Hash Join | 980.84 | 134.80 | 86.3% | pattern |
...
### Step 9: Node 17163 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17158, 17159, 17164, 17165, 17166
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17175 (Index Scan) - LEAF
...
### Step 11: Node 17162 (Nested Loop)
...
### Step 14: Node 17158 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17159, 17163, 17164, 17165, 17166
- **Input Features:**
