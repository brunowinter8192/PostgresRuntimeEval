...
**Test Query:** Q18_10_seed_73836279
...
```
Node 28980 (Limit) - ROOT
  Node 28981 (Sort)
    Node 28982 (Aggregate)
      Node 28983 (Gather Merge)
        Node 28984 (Incremental Sort)
          Node 28985 (Nested Loop)
            Node 28986 (Merge Join)
              Node 28987 (Sort)
                Node 28988 (Hash Join) [PATTERN: 895c6e8c]
                  Node 28989 (Seq Scan) [consumed] - LEAF
                  Node 28990 (Hash) [consumed]
                    Node 28991 (Aggregate)
                      Node 28992 (Index Scan) - LEAF
              Node 28993 (Sort)
                Node 28994 (Seq Scan) - LEAF
            Node 28995 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 28988 | 28989, 28990 |
...
|------|------|--------|-----------|-----|--------|
| 28980 | Limit | 3039.52 | 1175.21 | 61.3% | operator |
| 28981 | Sort | 2923.21 | 1127.81 | 61.4% | operator |
| 28982 | Aggregate | 2923.16 | 1073.15 | 63.3% | operator |
| 28983 | Gather Merge | 2923.13 | 1073.95 | 63.3% | operator |
| 28984 | Incremental Sort | 2886.23 | 0.00 | 100.0% | operator |
| 28985 | Nested Loop | 2886.18 | 1111.34 | 61.5% | operator |
| 28986 | Merge Join | 2886.12 | 0.00 | 100.0% | operator |
| 28995 | Index Scan | 0.02 | 0.05 | 105.2% | operator |
| 28987 | Sort | 2836.12 | 1095.58 | 61.4% | operator |
| 28993 | Sort | 63.49 | 1074.66 | 1592.6% | operator |
| 28988 | Hash Join | 2836.11 | 471.07 | 83.4% | pattern |
| 28994 | Seq Scan | 51.80 | 18.25 | 64.8% | operator |
| 28991 | Aggregate | 2598.52 | 1073.15 | 58.7% | operator |
| 28992 | Index Scan | 2127.01 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 28992 (Index Scan) - LEAF
...
### Step 3: Node 28988 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 28989, 28990
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 28994 (Seq Scan) - LEAF
...
### Step 7: Node 28986 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 28995 (Index Scan) - LEAF
...
### Step 10: Node 28984 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 28983 (Gather Merge)
