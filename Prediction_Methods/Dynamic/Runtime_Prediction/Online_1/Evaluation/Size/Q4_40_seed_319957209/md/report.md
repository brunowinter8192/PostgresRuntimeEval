...
**Test Query:** Q4_40_seed_319957209
**Timestamp:** 2026-01-18 16:36:15
...
```
Node 6439 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6440 (Gather Merge) [consumed]
    Node 6441 (Sort) [consumed]
      Node 6442 (Aggregate) [consumed]
        Node 6443 (Nested Loop)
          Node 6444 (Seq Scan) - LEAF
          Node 6445 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6439 | 6440, 6441, 6442 |
...
|------|------|--------|-----------|-----|--------|
| 6439 | Aggregate | 1122.51 | 952.19 | 15.2% | pattern |
| 6443 | Nested Loop | 1115.89 | 1255.45 | 12.5% | operator |
| 6444 | Seq Scan | 173.33 | 154.67 | 10.8% | operator |
| 6445 | Index Scan | 0.07 | 11.10 | 16724.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6444 (Seq Scan) - LEAF
...
### Step 2: Node 6445 (Index Scan) - LEAF
