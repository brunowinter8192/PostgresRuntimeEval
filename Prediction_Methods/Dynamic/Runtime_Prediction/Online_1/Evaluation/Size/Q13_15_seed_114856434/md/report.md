...
```
Node 25762 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25763 (Aggregate) [consumed]
    Node 25764 (Aggregate)
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25762 | 25763, 25765, 25766, 25767 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25765 | 25762, 25763, 25766, 25767 |
...
|------|------|--------|-----------|-----|--------|
| 25762 | Sort | 900.00 | 1079.92 | 20.0% | pattern |
| 25764 | Aggregate | 893.75 | 998.94 | 11.8% | operator |
| 25765 | Hash Join | 680.86 | 470.31 | 30.9% | pattern |
| 25768 | Index Only Scan | 9.60 | 0.00 | 100.0% | operator |
...
- **Consumes:** Nodes 25762, 25763, 25766, 25767
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1475952
...
### Step 4: Node 25762 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25763, 25765, 25766, 25767
- **Input Features:**
