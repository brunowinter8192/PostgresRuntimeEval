...
**Test Query:** Q4_115_seed_935259534
...
```
Node 5963 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 5964 (Gather Merge) [consumed]
    Node 5965 (Sort) [consumed]
      Node 5966 (Aggregate) [consumed]
        Node 5967 (Nested Loop)
          Node 5968 (Seq Scan) - LEAF
          Node 5969 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 5963 | 5964, 5965, 5966 |
...
|------|------|--------|-----------|-----|--------|
| 5963 | Aggregate | 1053.40 | 952.19 | 9.6% | pattern |
| 5967 | Nested Loop | 1046.68 | 1255.45 | 19.9% | operator |
| 5968 | Seq Scan | 163.59 | 154.67 | 5.5% | operator |
| 5969 | Index Scan | 0.06 | 11.10 | 17526.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5968 (Seq Scan) - LEAF
...
### Step 2: Node 5969 (Index Scan) - LEAF
