...
**Test Query:** Q19_72_seed_582486201
...
```
Node 32053 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 32054 (Gather) [consumed]
    Node 32055 (Aggregate) [consumed]
      Node 32056 (Hash Join) [consumed]
        Node 32057 (Seq Scan) - LEAF
        Node 32058 (Hash)
          Node 32059 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 32053 | 32054, 32055, 32056 |
...
|------|------|--------|-----------|-----|--------|
| 32053 | Aggregate | 853.74 | 829.30 | 2.9% | pattern |
| 32057 | Seq Scan | 785.50 | 743.46 | 5.4% | operator |
| 32058 | Hash | 44.51 | 8.29 | 81.4% | operator |
| 32059 | Seq Scan | 44.35 | 23.76 | 46.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 32059 (Seq Scan) - LEAF
...
### Step 2: Node 32057 (Seq Scan) - LEAF
...
### Step 4: Node 32053 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 32054, 32055, 32056
- **Input Features:**
  ...
  - Aggregate_startup_cost=157339.3200
  - Aggregate_total_cost=157339.3300
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - HashJoin_Outer_total_cost=156338.6100
