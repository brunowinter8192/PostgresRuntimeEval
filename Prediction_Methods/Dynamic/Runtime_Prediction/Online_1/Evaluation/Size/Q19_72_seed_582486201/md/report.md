...
```
Node 32053 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 32054 (Gather) [consumed]
    Node 32055 (Aggregate) [consumed]
      Node 32056 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 32053 | 32054, 32055 |
...
|------|------|--------|-----------|-----|--------|
| 32053 | Aggregate | 853.74 | 831.20 | 2.6% | pattern |
| 32056 | Hash Join | 832.90 | 766.06 | 8.0% | operator |
...
### Step 5: Node 32053 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 32054, 32055
- **Input Features:**
