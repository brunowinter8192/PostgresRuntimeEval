...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4851 | 4852, 4853, 4854 |
...
| 4855 | Nested Loop | 1160.06 | 1192.61 | 2.8% | operator |
| 4856 | Hash Join | 209.36 | 230.18 | 9.9% | operator |
| 4860 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4857 | Seq Scan | 154.22 | 163.18 | 5.8% | operator |
| 4858 | Hash | 33.15 | 17.75 | 46.5% | operator |
...
### Step 2: Node 4857 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37331.0500
- **Output:** st=27.11, rt=230.18

### Step 5: Node 4860 (Index Scan) - LEAF
...
- **Output:** st=121.31, rt=1192.61

### Step 7: Node 4851 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4852, 4853, 4854
- **Input Features:**
