...
**Test Query:** Q3_146_seed_1189584495
...
```
Node 4851 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 4852 (Sort) [consumed]
    Node 4853 (Aggregate) [consumed]
      Node 4854 (Gather) [consumed]
        Node 4855 (Nested Loop)
          Node 4856 (Hash Join) [PATTERN: 895c6e8c]
            Node 4857 (Seq Scan) [consumed] - LEAF
            Node 4858 (Hash) [consumed]
              Node 4859 (Seq Scan) - LEAF
          Node 4860 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4851 | 4852, 4853, 4854, 4856, 4857, 4858 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4856 | 4851, 4852, 4853, 4854, 4857, 4858 |
...
|------|------|--------|-----------|-----|--------|
| 4851 | Limit | 1197.61 | 1151.18 | 3.9% | pattern |
| 4855 | Nested Loop | 1160.06 | 1192.70 | 2.8% | operator |
| 4856 | Hash Join | 209.36 | 242.41 | 15.8% | pattern |
| 4860 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4859 | Seq Scan | 32.51 | 38.57 | 18.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4859 (Seq Scan) - LEAF
...
### Step 2: Node 4856 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4851, 4852, 4853, 4854, 4857, 4858
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46373
  - HashJoin_nt1=232114
  ...
  - HashJoin_total_cost=37331.0500
  - Hash_Inner_np=0
  - Hash_Inner_nt=12487
...
- **Output:** st=29.80, rt=242.41

### Step 3: Node 4860 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=72564.9400
- **Output:** st=121.46, rt=1192.70

### Step 5: Node 4851 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4852, 4853, 4854, 4856, 4857, 4858
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=313187
  - Aggregate_Outer_nt1=313187
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=109581.4400
  - Aggregate_Outer_total_cost=113496.2800
  - Gather_Outer_np=0
  - Gather_Outer_nt=313187
  - Gather_Outer_nt1=101028
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=104883.6400
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=313187
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=120264.1400
  - Limit_total_cost=120264.1600
  - Sort_Outer_np=0
  - Sort_Outer_nt=313187
  - Sort_Outer_nt1=313187
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=120264.1400
  - Sort_Outer_total_cost=121047.1000
