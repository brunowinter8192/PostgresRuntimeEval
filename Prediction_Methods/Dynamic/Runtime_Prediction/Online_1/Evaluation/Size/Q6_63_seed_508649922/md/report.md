...
**Test Query:** Q6_63_seed_508649922
...
```
Node 10337 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10338 (Gather) [consumed]
    Node 10339 (Aggregate) [consumed]
      Node 10340 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10337 | 10338, 10339 |
...
|------|------|--------|-----------|-----|--------|
| 10337 | Aggregate | 796.72 | 850.05 | 6.7% | pattern |
| 10340 | Seq Scan | 775.96 | 748.53 | 3.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10340 (Seq Scan) - LEAF
...
### Step 2: Node 10337 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10338, 10339
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=23662
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=32
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=139723.7800
  - Aggregate_Outer_total_cost=139723.7900
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=140724.3200
  - Aggregate_total_cost=140724.3300
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=140723.7800
  - Gather_Outer_total_cost=140724.2900
