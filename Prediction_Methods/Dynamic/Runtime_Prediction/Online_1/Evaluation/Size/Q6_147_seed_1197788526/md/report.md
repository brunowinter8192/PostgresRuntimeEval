...
**Test Query:** Q6_147_seed_1197788526
...
```
Node 10105 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10106 (Gather) [consumed]
    Node 10107 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10105 | 10106, 10107 |
...
|------|------|--------|-----------|-----|--------|
| 10105 | Aggregate | 787.93 | 850.07 | 7.9% | pattern |
| 10108 | Seq Scan | 767.64 | 748.54 | 2.5% | operator |
...
### Step 2: Node 10105 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10106, 10107
- **Input Features:**
