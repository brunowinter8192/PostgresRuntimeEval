...
**Test Query:** Q13_13_seed_98448372
...
```
Node 25671 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25672 (Aggregate) [consumed]
    Node 25673 (Aggregate)
      Node 25674 (Hash Join) [PATTERN: 895c6e8c]
        Node 25675 (Seq Scan) [consumed] - LEAF
        Node 25676 (Hash) [consumed]
          Node 25677 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25671 | 25672, 25674, 25675, 25676 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25674 | 25671, 25672, 25675, 25676 |
...
|------|------|--------|-----------|-----|--------|
| 25671 | Sort | 936.30 | 1079.94 | 15.3% | pattern |
| 25673 | Aggregate | 930.17 | 999.76 | 7.5% | operator |
| 25674 | Hash Join | 715.00 | 470.31 | 34.2% | pattern |
| 25677 | Index Only Scan | 10.37 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25677 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25674 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25671, 25672, 25675, 25676
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 25671 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25672, 25674, 25675, 25676
- **Input Features:**
