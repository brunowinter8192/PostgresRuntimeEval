...
```
Node 25671 (Sort) - ROOT
  Node 25672 (Aggregate)
    Node 25673 (Aggregate)
      Node 25674 (Hash Join)
        Node 25675 (Seq Scan) - LEAF
        Node 25676 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 25671 | Sort | 936.30 | 1081.93 | 15.6% | operator |
| 25672 | Aggregate | 936.27 | 1000.33 | 6.8% | operator |
| 25673 | Aggregate | 930.17 | 1014.39 | 9.1% | operator |
| 25674 | Hash Join | 715.00 | 787.83 | 10.2% | operator |
| 25675 | Seq Scan | 499.64 | 264.19 | 47.1% | operator |
| 25676 | Hash | 16.02 | 80.15 | 400.4% | operator |
...
### Step 2: Node 25675 (Seq Scan) - LEAF
