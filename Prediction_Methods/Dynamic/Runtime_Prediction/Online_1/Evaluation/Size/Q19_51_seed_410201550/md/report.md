...
**Test Query:** Q19_51_seed_410201550
**Timestamp:** 2026-01-18 20:36:23
...
```
Node 31892 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31893 (Gather) [consumed]
    Node 31894 (Aggregate) [consumed]
      Node 31895 (Hash Join) [consumed]
        Node 31896 (Seq Scan) - LEAF
        Node 31897 (Hash)
          Node 31898 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31892 | 31893, 31894, 31895 |
...
|------|------|--------|-----------|-----|--------|
| 31892 | Aggregate | 834.84 | 829.30 | 0.7% | pattern |
| 31896 | Seq Scan | 767.44 | 743.46 | 3.1% | operator |
| 31897 | Hash | 43.19 | 8.29 | 80.8% | operator |
| 31898 | Seq Scan | 43.04 | 23.76 | 44.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31898 (Seq Scan) - LEAF
...
### Step 2: Node 31896 (Seq Scan) - LEAF
...
### Step 4: Node 31892 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31893, 31894, 31895
- **Input Features:**
  ...
  - HashJoin_Outer_total_cost=156338.7100
