...
**Test Query:** Q13_8_seed_57428217
...
```
Node 26336 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26337 (Aggregate) [consumed]
    Node 26338 (Aggregate)
      Node 26339 (Hash Join) [PATTERN: 895c6e8c]
        Node 26340 (Seq Scan) [consumed] - LEAF
        Node 26341 (Hash) [consumed]
          Node 26342 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26336 | 26337, 26339, 26340, 26341 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26339 | 26336, 26337, 26340, 26341 |
...
|------|------|--------|-----------|-----|--------|
| 26336 | Sort | 856.89 | 1079.93 | 26.0% | pattern |
| 26338 | Aggregate | 850.72 | 999.15 | 17.4% | operator |
| 26339 | Hash Join | 665.09 | 470.31 | 29.3% | pattern |
| 26342 | Index Only Scan | 14.19 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26342 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26339 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26336, 26337, 26340, 26341
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1478958
...
### Step 4: Node 26336 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26337, 26339, 26340, 26341
- **Input Features:**
