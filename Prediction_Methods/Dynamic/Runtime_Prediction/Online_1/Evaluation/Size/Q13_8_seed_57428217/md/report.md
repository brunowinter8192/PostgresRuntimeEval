...
```
Node 26336 (Sort) - ROOT
  Node 26337 (Aggregate)
    Node 26338 (Aggregate)
      Node 26339 (Hash Join)
        Node 26340 (Seq Scan) - LEAF
        Node 26341 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 26336 | Sort | 856.89 | 1081.93 | 26.3% | operator |
| 26337 | Aggregate | 856.85 | 1000.36 | 16.7% | operator |
| 26338 | Aggregate | 850.72 | 1013.77 | 19.2% | operator |
| 26339 | Hash Join | 665.09 | 787.83 | 18.5% | operator |
| 26340 | Seq Scan | 475.68 | 263.97 | 44.5% | operator |
| 26341 | Hash | 23.27 | 80.15 | 244.5% | operator |
...
### Step 2: Node 26340 (Seq Scan) - LEAF
