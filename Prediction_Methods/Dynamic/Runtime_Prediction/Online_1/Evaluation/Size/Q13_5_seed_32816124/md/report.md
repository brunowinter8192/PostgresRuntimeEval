...
**Test Query:** Q13_5_seed_32816124
...
```
Node 26105 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26106 (Aggregate) [consumed]
    Node 26107 (Aggregate)
      Node 26108 (Hash Join) [PATTERN: 895c6e8c]
        Node 26109 (Seq Scan) [consumed] - LEAF
        Node 26110 (Hash) [consumed]
          Node 26111 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26105 | 26106, 26108, 26109, 26110 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26108 | 26105, 26106, 26109, 26110 |
...
|------|------|--------|-----------|-----|--------|
| 26105 | Sort | 898.99 | 1079.93 | 20.1% | pattern |
| 26107 | Aggregate | 892.95 | 999.35 | 11.9% | operator |
| 26108 | Hash Join | 684.80 | 470.31 | 31.3% | pattern |
| 26111 | Index Only Scan | 9.79 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26111 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26108 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26105, 26106, 26109, 26110
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1481964
...
### Step 4: Node 26105 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26106, 26108, 26109, 26110
- **Input Features:**
