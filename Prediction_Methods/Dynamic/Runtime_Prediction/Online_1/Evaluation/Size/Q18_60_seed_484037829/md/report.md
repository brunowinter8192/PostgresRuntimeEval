...
**Test Query:** Q18_60_seed_484037829
...
```
Node 30516 (Limit) - ROOT
  Node 30517 (Sort)
    Node 30518 (Aggregate)
      Node 30519 (Gather Merge)
        Node 30520 (Incremental Sort)
          Node 30521 (Nested Loop)
            Node 30522 (Merge Join)
              Node 30523 (Sort)
                Node 30524 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30525 (Seq Scan) [consumed] - LEAF
                  Node 30526 (Hash) [consumed]
                    Node 30527 (Aggregate)
                      Node 30528 (Index Scan) - LEAF
              Node 30529 (Sort)
                Node 30530 (Seq Scan) - LEAF
            Node 30531 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30524 | 30525, 30526 |
...
|------|------|--------|-----------|-----|--------|
| 30516 | Limit | 3005.82 | 1175.21 | 60.9% | operator |
| 30517 | Sort | 2892.06 | 1127.81 | 61.0% | operator |
| 30518 | Aggregate | 2892.02 | 1073.15 | 62.9% | operator |
| 30519 | Gather Merge | 2892.00 | 1073.95 | 62.9% | operator |
| 30520 | Incremental Sort | 2870.49 | 0.00 | 100.0% | operator |
| 30521 | Nested Loop | 2870.44 | 1111.34 | 61.3% | operator |
| 30522 | Merge Join | 2870.37 | 0.00 | 100.0% | operator |
| 30531 | Index Scan | 0.03 | 0.05 | 80.5% | operator |
| 30523 | Sort | 2800.54 | 1095.58 | 60.9% | operator |
| 30529 | Sort | 66.89 | 1074.66 | 1506.5% | operator |
| 30524 | Hash Join | 2800.53 | 471.07 | 83.2% | pattern |
| 30530 | Seq Scan | 54.06 | 18.25 | 66.2% | operator |
| 30527 | Aggregate | 2573.45 | 1073.15 | 58.3% | operator |
| 30528 | Index Scan | 2115.40 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30528 (Index Scan) - LEAF
...
### Step 3: Node 30524 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30525, 30526
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30530 (Seq Scan) - LEAF
...
### Step 7: Node 30522 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30531 (Index Scan) - LEAF
...
### Step 10: Node 30520 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30519 (Gather Merge)
