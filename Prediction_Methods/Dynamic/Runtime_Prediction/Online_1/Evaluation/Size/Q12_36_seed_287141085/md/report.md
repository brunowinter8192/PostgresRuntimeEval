...
```
Node 24873 (Aggregate) - ROOT
  Node 24874 (Gather Merge)
    Node 24875 (Aggregate)
      Node 24876 (Sort)
...
|------|------|--------|-----------|-----|--------|
| 24873 | Aggregate | 1003.03 | 919.05 | 8.4% | operator |
| 24874 | Gather Merge | 1003.02 | 1111.84 | 10.8% | operator |
| 24875 | Aggregate | 983.41 | 895.30 | 9.0% | operator |
| 24876 | Sort | 982.66 | 1092.82 | 11.2% | operator |
| 24877 | Nested Loop | 981.70 | 1127.41 | 14.8% | operator |
| 24878 | Seq Scan | 838.94 | 745.19 | 11.2% | operator |
| 24879 | Index Scan | 0.03 | 0.07 | 166.2% | operator |
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=147559.1100
  - total_cost=147675.2000
- **Output:** st=868.94, rt=895.30

### Step 6: Node 24874 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=868.9385
  - st2=0.0000
  - startup_cost=148559.1900
  - total_cost=148679.4900
- **Output:** st=1109.22, rt=1111.84

### Step 7: Node 24873 (Aggregate) - ROOT
