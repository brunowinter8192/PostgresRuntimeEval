...
```
Node 27169 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27170 (Gather) [consumed]
    Node 27171 (Aggregate) [consumed]
      Node 27172 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27169 | 27170, 27171, 27172 |
...
|------|------|--------|-----------|-----|--------|
| 27169 | Aggregate | 824.20 | 857.14 | 4.0% | pattern |
...
### Step 4: Node 27169 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27170, 27171, 27172
- **Input Features:**
