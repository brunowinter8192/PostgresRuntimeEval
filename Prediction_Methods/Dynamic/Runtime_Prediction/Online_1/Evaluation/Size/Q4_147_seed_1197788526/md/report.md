...
```
Node 6208 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6209 (Gather Merge) [consumed]
    Node 6210 (Sort) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6208 | 6209, 6210, 6211 |
...
|------|------|--------|-----------|-----|--------|
| 6208 | Aggregate | 1072.45 | 952.19 | 11.2% | pattern |
| 6212 | Nested Loop | 1063.52 | 1255.45 | 18.0% | operator |
| 6213 | Seq Scan | 165.80 | 154.66 | 6.7% | operator |
| 6214 | Index Scan | 0.06 | 11.10 | 17250.6% | operator |
...
- **Input Features:**
  ...
  - Aggregate_total_cost=66917.8100
  ...
  - GatherMerge_Outer_total_cost=66917.6800
  - Sort_Outer_np=0
  - Sort_Outer_nt=5
  - Sort_Outer_nt1=5
  - Sort_Outer_nt2=0
  ...
  - Sort_Outer_startup_cost=65915.8700
  - Sort_Outer_total_cost=65915.8800
