...
**Test Query:** Q12_4_seed_24612093
...
```
Node 24978 (Aggregate) - ROOT
  Node 24979 (Gather Merge)
    Node 24980 (Aggregate)
      Node 24981 (Sort)
        Node 24982 (Nested Loop)
          Node 24983 (Seq Scan) - LEAF
          Node 24984 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24978 | Aggregate | 990.10 | 919.06 | 7.2% | operator |
| 24979 | Gather Merge | 990.09 | 1111.84 | 12.3% | operator |
| 24980 | Aggregate | 970.90 | 895.30 | 7.8% | operator |
| 24981 | Sort | 970.26 | 1092.82 | 12.6% | operator |
| 24982 | Nested Loop | 969.22 | 1127.41 | 16.3% | operator |
| 24983 | Seq Scan | 837.80 | 745.19 | 11.1% | operator |
| 24984 | Index Scan | 0.03 | 0.07 | 187.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24983 (Seq Scan) - LEAF
...
### Step 2: Node 24984 (Index Scan) - LEAF
...
### Step 6: Node 24979 (Gather Merge)
...
### Step 7: Node 24978 (Aggregate) - ROOT
