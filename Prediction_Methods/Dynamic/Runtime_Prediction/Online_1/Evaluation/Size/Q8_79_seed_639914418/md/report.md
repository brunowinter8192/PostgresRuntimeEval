...
```
Node 16099 (Aggregate) - ROOT
  Node 16100 (Gather Merge)
    Node 16101 (Sort)
          ...
          Node 16104 (Hash Join)
            Node 16105 (Nested Loop)
              Node 16106 (Hash Join)
                ...
                Node 16108 (Hash)
                  Node 16109 (Hash Join)
                    Node 16110 (Seq Scan) - LEAF
                    Node 16111 (Hash)
                      Node 16112 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 16099 | Aggregate | 1201.52 | 1186.90 | 1.2% | operator |
| 16100 | Gather Merge | 1201.11 | 1097.15 | 8.7% | operator |
...
| 16106 | Hash Join | 207.09 | 251.17 | 21.3% | operator |
...
| 16108 | Hash | 33.49 | 20.62 | 38.4% | operator |
| 16109 | Hash Join | 32.92 | 132.26 | 301.8% | operator |
| 16110 | Seq Scan | 31.36 | 23.03 | 26.6% | operator |
| 16111 | Hash | 0.23 | 23.66 | 10275.5% | operator |
| 16112 | Hash Join | 0.20 | 306.84 | 149576.1% | operator |
...
### Step 5: Node 16110 (Seq Scan) - LEAF
...
### Step 8: Node 16107 (Seq Scan) - LEAF
...
### Step 11: Node 16116 (Index Scan) - LEAF
...
### Step 12: Node 16118 (Seq Scan) - LEAF
...
### Step 13: Node 16105 (Nested Loop)
...
### Step 16: Node 16119 (Index Scan) - LEAF
...
### Step 17: Node 16121 (Seq Scan) - LEAF
...
### Step 18: Node 16103 (Nested Loop)
...
### Step 22: Node 16100 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1044.9447
  - st2=0.0000
  - startup_cost=71561.0000
  - total_cost=71857.0100
- **Output:** st=1093.44, rt=1097.15

### Step 23: Node 16099 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=71561.0000
  - total_cost=71955.1700
- **Output:** st=1159.98, rt=1186.90
