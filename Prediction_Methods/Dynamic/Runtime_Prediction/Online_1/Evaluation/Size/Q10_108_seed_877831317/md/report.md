...
**Test Query:** Q10_108_seed_877831317
...
```
Node 19474 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 19475 (Sort) [consumed]
    Node 19476 (Aggregate) [consumed]
      Node 19477 (Gather) [consumed]
        Node 19478 (Hash Join)
          Node 19479 (Hash Join) [PATTERN: 2e0f44ef]
            Node 19480 (Nested Loop) [consumed]
              Node 19481 (Seq Scan) - LEAF
              Node 19482 (Index Scan) - LEAF
            Node 19483 (Hash) [consumed]
              Node 19484 (Seq Scan) - LEAF
          Node 19485 (Hash)
            Node 19486 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19474 | 19475, 19476, 19477, 19479, 19480, 19483 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 19479 | 19474, 19475, 19476, 19477, 19480, 19483 |
...
|------|------|--------|-----------|-----|--------|
| 19474 | Limit | 1160.37 | 1199.47 | 3.4% | pattern |
| 19478 | Hash Join | 1095.16 | 1095.46 | 0.0% | operator |
| 19479 | Hash Join | 1092.30 | 1120.19 | 2.6% | pattern |
| 19485 | Hash | 0.01 | 15.71 | 120752.1% | operator |
| 19486 | Seq Scan | 0.01 | 6.98 | 69687.0% | operator |
| 19481 | Seq Scan | 159.64 | 159.74 | 0.1% | operator |
| 19482 | Index Scan | 0.06 | -0.52 | 935.9% | operator |
| 19484 | Seq Scan | 27.55 | 26.64 | 3.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 19481 (Seq Scan) - LEAF
...
### Step 2: Node 19482 (Index Scan) - LEAF
...
### Step 3: Node 19484 (Seq Scan) - LEAF
...
### Step 4: Node 19486 (Seq Scan) - LEAF
...
### Step 5: Node 19479 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 19474, 19475, 19476, 19477, 19480, 19483
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=17827
  - HashJoin_nt1=17827
...
### Step 8: Node 19474 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19475, 19476, 19477, 19479, 19480, 19483
- **Input Features:**
