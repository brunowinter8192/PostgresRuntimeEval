...
Node 321 (Aggregate) - ROOT
  Node 322 (Gather Merge)
    Node 323 (Sort) [PATTERN: 1d35fb97]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 323 | 324 |
...
|------|------|--------|-----------|-----|--------|
| 321 | Aggregate | 937.30 | 1195.75 | 27.6% | operator |
| 322 | Gather Merge | 937.22 | 1165.86 | 24.4% | operator |
| 323 | Sort | 916.93 | 1199.97 | 30.9% | pattern |
| 325 | Seq Scan | 514.33 | 682.29 | 32.7% | operator |
...
### Step 2: Node 323 (Sort) - PATTERN ROOT
...
### Step 4: Node 321 (Aggregate) - ROOT
