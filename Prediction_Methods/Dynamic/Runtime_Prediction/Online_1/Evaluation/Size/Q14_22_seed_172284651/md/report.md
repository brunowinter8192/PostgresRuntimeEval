...
```
Node 26868 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26869 (Gather) [consumed]
    Node 26870 (Aggregate) [consumed]
      Node 26871 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26868 | 26869, 26870, 26871 |
...
|------|------|--------|-----------|-----|--------|
| 26868 | Aggregate | 826.67 | 857.11 | 3.7% | pattern |
...
### Step 4: Node 26868 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26869, 26870, 26871
- **Input Features:**
