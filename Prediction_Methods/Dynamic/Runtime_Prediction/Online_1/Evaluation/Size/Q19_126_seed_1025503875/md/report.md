...
**Test Query:** Q19_126_seed_1025503875
...
```
Node 31416 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31417 (Gather) [consumed]
    Node 31418 (Aggregate) [consumed]
      Node 31419 (Hash Join) [consumed]
        Node 31420 (Seq Scan) - LEAF
        Node 31421 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31416 | 31417, 31418, 31419 |
...
|------|------|--------|-----------|-----|--------|
| 31416 | Aggregate | 837.18 | 829.30 | 0.9% | pattern |
| 31420 | Seq Scan | 771.42 | 743.46 | 3.6% | operator |
| 31421 | Hash | 44.64 | 8.29 | 81.4% | operator |
| 31422 | Seq Scan | 44.53 | 23.76 | 46.6% | operator |
...
### Step 2: Node 31420 (Seq Scan) - LEAF
...
### Step 4: Node 31416 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31417, 31418, 31419
- **Input Features:**
