    ...
    Node 20919 (Aggregate) [consumed]
      Node 20920 (Gather) [consumed]
        Node 20921 (Hash Join)
          Node 20922 (Hash Join)
            Node 20923 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20917 | 20918, 20919, 20920 |
...
| 20921 | Hash Join | 1101.48 | 1007.19 | 8.6% | operator |
| 20922 | Hash Join | 1098.64 | 1004.09 | 8.6% | operator |
| 20928 | Hash | 0.01 | 15.71 | 112119.8% | operator |
| 20923 | Nested Loop | 1050.23 | 1204.83 | 14.7% | operator |
| 20926 | Hash | 38.14 | 55.57 | 45.7% | operator |
...
### Step 6: Node 20929 (Seq Scan) - LEAF
...
### Step 10: Node 20917 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20918, 20919, 20920
- **Input Features:**
