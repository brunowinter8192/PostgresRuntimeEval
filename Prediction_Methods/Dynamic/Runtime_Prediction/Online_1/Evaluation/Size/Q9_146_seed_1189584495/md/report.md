...
**Test Query:** Q9_146_seed_1189584495
...
```
Node 17556 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 17557 (Aggregate) [consumed]
    Node 17558 (Gather)
      Node 17559 (Aggregate)
        Node 17560 (Nested Loop)
          Node 17561 (Hash Join) [PATTERN: bb930825]
            Node 17562 (Seq Scan) [consumed] - LEAF
            Node 17563 (Hash) [consumed]
              Node 17564 (Hash Join) [consumed]
                Node 17565 (Hash Join)
                  Node 17566 (Nested Loop)
                    Node 17567 (Seq Scan) - LEAF
                    Node 17568 (Index Scan) - LEAF
                  Node 17569 (Hash)
                    Node 17570 (Seq Scan) - LEAF
                Node 17571 (Hash)
                  Node 17572 (Seq Scan) - LEAF
          Node 17573 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17561 | 17556, 17557, 17562, 17563, 17564 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17556 | 17557, 17561, 17562, 17563, 17564 |
...
|------|------|--------|-----------|-----|--------|
| 17556 | Sort | 1180.56 | 1046.01 | 11.4% | pattern |
| 17558 | Gather | 1179.63 | 955.76 | 19.0% | operator |
| 17559 | Aggregate | 1158.05 | 1141.46 | 1.4% | operator |
| 17560 | Nested Loop | 1134.29 | 1252.17 | 10.4% | operator |
| 17561 | Hash Join | 964.33 | 134.80 | 86.0% | pattern |
| 17573 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17565 | Hash Join | 153.95 | 837.43 | 444.0% | operator |
| 17571 | Hash | 13.65 | 14.95 | 9.5% | operator |
| 17566 | Nested Loop | 148.47 | 1251.76 | 743.1% | operator |
| 17569 | Hash | 3.30 | 15.94 | 383.6% | operator |
| 17572 | Seq Scan | 13.64 | 2.94 | 78.5% | operator |
| 17567 | Seq Scan | 19.94 | 44.44 | 122.9% | operator |
| 17568 | Index Scan | 0.07 | -1.39 | 2083.5% | operator |
| 17570 | Seq Scan | 2.83 | 9.45 | 234.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 17567 (Seq Scan) - LEAF
...
### Step 2: Node 17568 (Index Scan) - LEAF
...
### Step 3: Node 17570 (Seq Scan) - LEAF
...
### Step 6: Node 17572 (Seq Scan) - LEAF
...
### Step 9: Node 17561 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17556, 17557, 17562, 17563, 17564
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17573 (Index Scan) - LEAF
...
### Step 11: Node 17560 (Nested Loop)
...
### Step 14: Node 17556 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17557, 17561, 17562, 17563, 17564
- **Input Features:**
