...
**Test Query:** Q1_37_seed_295345116
...
```
Node 401 (Aggregate) - ROOT
  Node 402 (Gather Merge)
    Node 403 (Sort) [PATTERN: 1d35fb97]
      Node 404 (Aggregate) [consumed]
        Node 405 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 403 | 404 |
...
|------|------|--------|-----------|-----|--------|
| 401 | Aggregate | 940.89 | 1195.96 | 27.1% | operator |
| 402 | Gather Merge | 940.84 | 1165.93 | 23.9% | operator |
| 403 | Sort | 920.29 | 1200.78 | 30.5% | pattern |
| 405 | Seq Scan | 504.79 | 679.19 | 34.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 405 (Seq Scan) - LEAF
...
- **Output:** st=0.85, rt=679.19

### Step 2: Node 403 (Sort) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Aggregate_Outer_nt1=1187150
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=236
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=169153.2900
  - Aggregate_Outer_total_cost=169153.4200
  - Sort_np=0
  - Sort_nt=6
  - Sort_nt1=6
  - Sort_nt2=0
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=169153.5000
  - Sort_total_cost=169153.5200
- **Output:** st=1196.69, rt=1200.78

### Step 3: Node 402 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1196.6896
  - st2=0.0000
  - startup_cost=170153.5800
  - total_cost=170157.2100
- **Output:** st=1161.80, rt=1165.93

### Step 4: Node 401 (Aggregate) - ROOT
