...
**Test Query:** Q12_17_seed_131264496
...
```
Node 24726 (Aggregate) - ROOT
  Node 24727 (Gather Merge)
    Node 24728 (Aggregate)
      Node 24729 (Sort)
        Node 24730 (Nested Loop)
          Node 24731 (Seq Scan) - LEAF
          Node 24732 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24726 | Aggregate | 1043.34 | 919.05 | 11.9% | operator |
| 24727 | Gather Merge | 1043.26 | 1111.84 | 6.6% | operator |
| 24728 | Aggregate | 1022.71 | 895.30 | 12.5% | operator |
| 24729 | Sort | 1022.06 | 1092.82 | 6.9% | operator |
| 24730 | Nested Loop | 1021.14 | 1127.41 | 10.4% | operator |
| 24731 | Seq Scan | 884.64 | 745.19 | 15.8% | operator |
| 24732 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24731 (Seq Scan) - LEAF
...
### Step 2: Node 24732 (Index Scan) - LEAF
...
### Step 6: Node 24727 (Gather Merge)
...
### Step 7: Node 24726 (Aggregate) - ROOT
