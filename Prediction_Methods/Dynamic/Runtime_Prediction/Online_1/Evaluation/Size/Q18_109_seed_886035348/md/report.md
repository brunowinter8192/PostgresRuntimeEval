...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 28972 | 28973, 28974 |
...
|------|------|--------|-----------|-----|--------|
| 28964 | Limit | 3030.15 | 1175.21 | 61.2% | operator |
| 28965 | Sort | 2914.13 | 1127.81 | 61.3% | operator |
| 28966 | Aggregate | 2914.09 | 1073.15 | 63.2% | operator |
| 28967 | Gather Merge | 2914.08 | 1073.95 | 63.1% | operator |
| 28968 | Incremental Sort | 2880.21 | 0.00 | 100.0% | operator |
| 28969 | Nested Loop | 2880.15 | 1111.34 | 61.4% | operator |
| 28970 | Merge Join | 2880.10 | 0.00 | 100.0% | operator |
| 28979 | Index Scan | 0.02 | 0.05 | 125.7% | operator |
| 28971 | Sort | 2829.65 | 1095.58 | 61.3% | operator |
| 28977 | Sort | 64.72 | 1074.66 | 1560.4% | operator |
| 28972 | Hash Join | 2829.64 | 471.07 | 83.4% | pattern |
| 28978 | Seq Scan | 53.41 | 18.25 | 65.8% | operator |
| 28975 | Aggregate | 2612.39 | 1073.15 | 58.9% | operator |
| 28976 | Index Scan | 2116.01 | 0.00 | 100.0% | operator |
...
### Step 4: Node 28978 (Seq Scan) - LEAF
...
### Step 7: Node 28970 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 28979 (Index Scan) - LEAF
...
### Step 10: Node 28968 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 28967 (Gather Merge)
