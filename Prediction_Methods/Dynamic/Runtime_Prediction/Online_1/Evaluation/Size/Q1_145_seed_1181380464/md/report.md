...
**Test Query:** Q1_145_seed_1181380464
...
```
Node 246 (Aggregate) - ROOT
  Node 247 (Gather Merge)
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 248 | 249 |
...
|------|------|--------|-----------|-----|--------|
| 246 | Aggregate | 951.09 | 1195.99 | 25.7% | operator |
| 247 | Gather Merge | 951.01 | 1165.94 | 22.6% | operator |
| 248 | Sort | 932.17 | 1200.90 | 28.8% | pattern |
| 250 | Seq Scan | 504.79 | 678.74 | 34.5% | operator |
...
### Step 4: Node 246 (Aggregate) - ROOT
