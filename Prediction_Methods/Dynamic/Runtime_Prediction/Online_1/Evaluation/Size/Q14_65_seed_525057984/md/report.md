...
```
Node 27197 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27198 (Gather) [consumed]
    Node 27199 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27197 | 27198, 27199 |
...
|------|------|--------|-----------|-----|--------|
| 27197 | Aggregate | 821.63 | 848.37 | 3.3% | pattern |
| 27200 | Hash Join | 800.01 | 807.66 | 1.0% | operator |
| 27201 | Seq Scan | 746.58 | 758.50 | 1.6% | operator |
| 27202 | Hash | 45.38 | 9.38 | 79.3% | operator |
| 27203 | Seq Scan | 39.94 | 12.70 | 68.2% | operator |
...
### Step 5: Node 27197 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27198, 27199
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=15624
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=64
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0001
  - Aggregate_Outer_startup_cost=136921.0800
  - Aggregate_Outer_total_cost=136921.0900
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
