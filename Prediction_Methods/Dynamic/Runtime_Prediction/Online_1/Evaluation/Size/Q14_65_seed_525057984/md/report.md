...
```
Node 27197 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27198 (Gather) [consumed]
    Node 27199 (Aggregate) [consumed]
      Node 27200 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27197 | 27198, 27199, 27200 |
...
|------|------|--------|-----------|-----|--------|
| 27197 | Aggregate | 821.63 | 857.14 | 4.3% | pattern |
...
### Step 4: Node 27197 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27198, 27199, 27200
- **Input Features:**
