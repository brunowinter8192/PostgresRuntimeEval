...
**Test Query:** Q19_73_seed_590690232
...
```
Node 32060 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 32061 (Gather) [consumed]
    Node 32062 (Aggregate) [consumed]
      Node 32063 (Hash Join) [consumed]
        Node 32064 (Seq Scan) - LEAF
        Node 32065 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 32060 | 32061, 32062, 32063 |
...
|------|------|--------|-----------|-----|--------|
| 32060 | Aggregate | 869.33 | 829.30 | 4.6% | pattern |
| 32064 | Seq Scan | 795.84 | 743.46 | 6.6% | operator |
| 32065 | Hash | 45.96 | 8.29 | 82.0% | operator |
| 32066 | Seq Scan | 45.80 | 23.76 | 48.1% | operator |
...
### Step 2: Node 32064 (Seq Scan) - LEAF
...
### Step 4: Node 32060 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 32061, 32062, 32063
- **Input Features:**
