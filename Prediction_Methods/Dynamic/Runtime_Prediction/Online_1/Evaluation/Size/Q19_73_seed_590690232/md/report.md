...
```
Node 32060 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 32061 (Gather) [consumed]
    Node 32062 (Aggregate) [consumed]
      Node 32063 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 32060 | 32061, 32062 |
...
|------|------|--------|-----------|-----|--------|
| 32060 | Aggregate | 869.33 | 831.20 | 4.4% | pattern |
| 32063 | Hash Join | 844.70 | 766.06 | 9.3% | operator |
...
### Step 5: Node 32060 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 32061, 32062
- **Input Features:**
