...
**Test Query:** Q12_131_seed_1066524030
...
```
Node 24558 (Aggregate) - ROOT
  Node 24559 (Gather Merge)
    Node 24560 (Aggregate)
      Node 24561 (Sort)
        Node 24562 (Nested Loop)
          Node 24563 (Seq Scan) - LEAF
          Node 24564 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24558 | Aggregate | 999.56 | 919.05 | 8.1% | operator |
| 24559 | Gather Merge | 999.54 | 1111.84 | 11.2% | operator |
| 24560 | Aggregate | 980.77 | 895.30 | 8.7% | operator |
| 24561 | Sort | 980.11 | 1092.82 | 11.5% | operator |
| 24562 | Nested Loop | 979.15 | 1127.41 | 15.1% | operator |
| 24563 | Seq Scan | 843.77 | 745.19 | 11.7% | operator |
| 24564 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24563 (Seq Scan) - LEAF
...
### Step 2: Node 24564 (Index Scan) - LEAF
...
### Step 6: Node 24559 (Gather Merge)
...
### Step 7: Node 24558 (Aggregate) - ROOT
