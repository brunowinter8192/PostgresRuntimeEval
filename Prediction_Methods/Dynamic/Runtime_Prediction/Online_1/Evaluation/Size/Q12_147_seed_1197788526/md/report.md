...
**Test Query:** Q12_147_seed_1197788526
...
```
Node 24677 (Aggregate) - ROOT
  Node 24678 (Gather Merge)
    Node 24679 (Aggregate)
      Node 24680 (Sort)
        Node 24681 (Nested Loop)
          Node 24682 (Seq Scan) - LEAF
          Node 24683 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24677 | Aggregate | 1014.02 | 919.07 | 9.4% | operator |
| 24678 | Gather Merge | 1014.00 | 1111.84 | 9.6% | operator |
| 24679 | Aggregate | 992.54 | 895.31 | 9.8% | operator |
| 24680 | Sort | 991.96 | 1092.81 | 10.2% | operator |
| 24681 | Nested Loop | 991.06 | 1127.41 | 13.8% | operator |
| 24682 | Seq Scan | 855.83 | 745.19 | 12.9% | operator |
| 24683 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24682 (Seq Scan) - LEAF
...
### Step 2: Node 24683 (Index Scan) - LEAF
...
### Step 6: Node 24678 (Gather Merge)
...
### Step 7: Node 24677 (Aggregate) - ROOT
