...
**Test Query:** Q19_5_seed_32816124
...
```
Node 31955 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31956 (Gather) [consumed]
    Node 31957 (Aggregate) [consumed]
      Node 31958 (Hash Join) [consumed]
        Node 31959 (Seq Scan) - LEAF
        Node 31960 (Hash)
          Node 31961 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31955 | 31956, 31957, 31958 |
...
|------|------|--------|-----------|-----|--------|
| 31955 | Aggregate | 832.84 | 829.33 | 0.4% | pattern |
| 31959 | Seq Scan | 759.99 | 743.46 | 2.2% | operator |
| 31960 | Hash | 50.68 | 8.29 | 83.7% | operator |
| 31961 | Seq Scan | 50.54 | 23.76 | 53.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31961 (Seq Scan) - LEAF
...
### Step 2: Node 31959 (Seq Scan) - LEAF
...
### Step 4: Node 31955 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31956, 31957, 31958
- **Input Features:**
