...
```
Node 18498 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18499 (Aggregate) [consumed]
    Node 18500 (Gather)
      Node 18501 (Aggregate)
        Node 18502 (Nested Loop)
          Node 18503 (Hash Join) [PATTERN: bb930825]
            Node 18504 (Seq Scan) [consumed] - LEAF
            Node 18505 (Hash) [consumed]
              Node 18506 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18503 | 18498, 18499, 18504, 18505, 18506 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18498 | 18499, 18503, 18504, 18505, 18506 |
...
|------|------|--------|-----------|-----|--------|
| 18498 | Sort | 1183.61 | 1045.59 | 11.7% | pattern |
...
| 18503 | Hash Join | 960.33 | 134.80 | 86.0% | pattern |
...
### Step 9: Node 18503 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18498, 18499, 18504, 18505, 18506
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18515 (Index Scan) - LEAF
...
### Step 11: Node 18502 (Nested Loop)
...
### Step 14: Node 18498 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18499, 18503, 18504, 18505, 18506
- **Input Features:**
