...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5011 | 5012, 5013, 5014 |
...
| 5015 | Nested Loop | 1163.90 | 1193.11 | 2.5% | operator |
| 5016 | Hash Join | 210.65 | 230.65 | 9.5% | operator |
| 5020 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5017 | Seq Scan | 156.39 | 163.33 | 4.4% | operator |
| 5018 | Hash | 31.52 | 17.75 | 43.7% | operator |
...
### Step 2: Node 5017 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37337.9200
- **Output:** st=27.16, rt=230.65

### Step 5: Node 5020 (Index Scan) - LEAF
...
- **Output:** st=121.79, rt=1193.11

### Step 7: Node 5011 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5012, 5013, 5014
- **Input Features:**
