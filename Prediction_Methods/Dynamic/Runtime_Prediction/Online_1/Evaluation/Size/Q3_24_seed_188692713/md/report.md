...
**Test Query:** Q3_24_seed_188692713
...
```
Node 5011 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5012 (Sort) [consumed]
    Node 5013 (Aggregate) [consumed]
      Node 5014 (Gather) [consumed]
        Node 5015 (Nested Loop)
          Node 5016 (Hash Join) [PATTERN: 895c6e8c]
            Node 5017 (Seq Scan) [consumed] - LEAF
            Node 5018 (Hash) [consumed]
              Node 5019 (Seq Scan) - LEAF
          Node 5020 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5011 | 5012, 5013, 5014, 5016, 5017, 5018 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5016 | 5011, 5012, 5013, 5014, 5017, 5018 |
...
|------|------|--------|-----------|-----|--------|
| 5011 | Limit | 1200.71 | 1151.18 | 4.1% | pattern |
| 5015 | Nested Loop | 1163.90 | 1193.20 | 2.5% | operator |
| 5016 | Hash Join | 210.65 | 242.51 | 15.1% | pattern |
| 5020 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5019 | Seq Scan | 30.69 | 38.53 | 25.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5019 (Seq Scan) - LEAF
...
### Step 2: Node 5016 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5011, 5012, 5013, 5014, 5017, 5018
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47154
  - HashJoin_nt1=234294
  ...
  - HashJoin_total_cost=37337.9200
  - Hash_Inner_np=0
  - Hash_Inner_nt=12579
...
- **Output:** st=29.75, rt=242.51

### Step 3: Node 5020 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=73078.6300
- **Output:** st=121.93, rt=1193.20

### Step 5: Node 5011 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5012, 5013, 5014, 5016, 5017, 5018
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=315780
  - Aggregate_Outer_nt1=315780
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110393.3300
  - Aggregate_Outer_total_cost=114340.5800
  - Gather_Outer_np=0
  - Gather_Outer_nt=315780
  - Gather_Outer_nt1=101865
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105656.6300
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=315780
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=121164.4700
  - Limit_total_cost=121164.5000
  - Sort_Outer_np=0
  - Sort_Outer_nt=315780
  - Sort_Outer_nt1=315780
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=121164.4700
  - Sort_Outer_total_cost=121953.9200
