...
**Test Query:** Q12_101_seed_820403100
...
```
Node 24327 (Aggregate) - ROOT
  Node 24328 (Gather Merge)
    Node 24329 (Aggregate)
      Node 24330 (Sort)
        Node 24331 (Nested Loop)
          Node 24332 (Seq Scan) - LEAF
          Node 24333 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24327 | Aggregate | 1009.55 | 919.09 | 9.0% | operator |
| 24328 | Gather Merge | 1009.51 | 1111.84 | 10.1% | operator |
| 24329 | Aggregate | 990.29 | 895.33 | 9.6% | operator |
| 24330 | Sort | 989.46 | 1092.79 | 10.4% | operator |
| 24331 | Nested Loop | 988.56 | 1127.41 | 14.0% | operator |
| 24332 | Seq Scan | 855.86 | 745.19 | 12.9% | operator |
| 24333 | Index Scan | 0.03 | 0.07 | 187.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24332 (Seq Scan) - LEAF
...
### Step 2: Node 24333 (Index Scan) - LEAF
...
- **Output:** st=1092.38, rt=1092.79

### Step 5: Node 24329 (Aggregate)
...
- **Output:** st=868.99, rt=895.33

### Step 6: Node 24328 (Gather Merge)
...
### Step 7: Node 24327 (Aggregate) - ROOT
