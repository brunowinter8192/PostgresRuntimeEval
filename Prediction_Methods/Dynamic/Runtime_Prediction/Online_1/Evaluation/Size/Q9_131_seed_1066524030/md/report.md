...
**Test Query:** Q9_131_seed_1066524030
...
```
Node 17267 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 17268 (Aggregate) [consumed]
    Node 17269 (Gather)
      Node 17270 (Aggregate)
        Node 17271 (Nested Loop)
          Node 17272 (Hash Join) [PATTERN: bb930825]
            Node 17273 (Seq Scan) [consumed] - LEAF
            Node 17274 (Hash) [consumed]
              Node 17275 (Hash Join) [consumed]
                Node 17276 (Hash Join)
                  Node 17277 (Nested Loop)
                    Node 17278 (Seq Scan) - LEAF
                    Node 17279 (Index Scan) - LEAF
                  Node 17280 (Hash)
                    Node 17281 (Seq Scan) - LEAF
                Node 17282 (Hash)
                  Node 17283 (Seq Scan) - LEAF
          Node 17284 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17272 | 17267, 17268, 17273, 17274, 17275 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17267 | 17268, 17272, 17273, 17274, 17275 |
...
|------|------|--------|-----------|-----|--------|
| 17267 | Sort | 1189.25 | 1045.59 | 12.1% | pattern |
| 17269 | Gather | 1188.27 | 964.55 | 18.8% | operator |
| 17270 | Aggregate | 1168.73 | 1085.45 | 7.1% | operator |
| 17271 | Nested Loop | 1143.37 | 1252.17 | 9.5% | operator |
| 17272 | Hash Join | 973.13 | 134.80 | 86.1% | pattern |
| 17284 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17276 | Hash Join | 161.64 | 837.63 | 418.2% | operator |
| 17282 | Hash | 14.46 | 14.95 | 3.4% | operator |
| 17277 | Nested Loop | 156.46 | 1251.77 | 700.1% | operator |
| 17280 | Hash | 2.86 | 15.94 | 457.2% | operator |
| 17283 | Seq Scan | 14.44 | 2.94 | 79.7% | operator |
| 17278 | Seq Scan | 19.31 | 43.96 | 127.7% | operator |
| 17279 | Index Scan | 0.07 | -1.39 | 1951.3% | operator |
| 17281 | Seq Scan | 2.32 | 9.45 | 307.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 17278 (Seq Scan) - LEAF
...
### Step 2: Node 17279 (Index Scan) - LEAF
...
### Step 3: Node 17281 (Seq Scan) - LEAF
...
### Step 6: Node 17283 (Seq Scan) - LEAF
...
### Step 9: Node 17272 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17267, 17268, 17273, 17274, 17275
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17284 (Index Scan) - LEAF
...
### Step 11: Node 17271 (Nested Loop)
...
### Step 14: Node 17267 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17268, 17272, 17273, 17274, 17275
- **Input Features:**
