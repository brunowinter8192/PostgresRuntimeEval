...
```
Node 17267 (Sort) - ROOT
  Node 17268 (Aggregate)
    Node 17269 (Gather)
      Node 17270 (Aggregate)
        Node 17271 (Nested Loop)
          Node 17272 (Hash Join)
            Node 17273 (Seq Scan) - LEAF
            Node 17274 (Hash)
              Node 17275 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 17267 | Sort | 1189.25 | 1119.81 | 5.8% | operator |
| 17268 | Aggregate | 1189.12 | 897.74 | 24.5% | operator |
...
| 17272 | Hash Join | 973.13 | 633.50 | 34.9% | operator |
| 17284 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17273 | Seq Scan | 699.69 | 509.93 | 27.1% | operator |
| 17274 | Hash | 178.58 | 48.03 | 73.1% | operator |
| 17275 | Hash Join | 176.73 | 924.48 | 423.1% | operator |
...
### Step 10: Node 17273 (Seq Scan) - LEAF
...
### Step 13: Node 17284 (Index Scan) - LEAF
...
### Step 14: Node 17271 (Nested Loop)
