...
Node 26630 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26631 (Gather) [consumed]
    Node 26632 (Aggregate) [consumed]
      Node 26633 (Hash Join)
        Node 26634 (Seq Scan) - LEAF
        Node 26635 (Hash)
          Node 26636 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26630 | 26631, 26632 |
...
|------|------|--------|-----------|-----|--------|
| 26630 | Aggregate | 823.66 | 848.38 | 3.0% | pattern |
| 26633 | Hash Join | 799.15 | 807.67 | 1.1% | operator |
| 26634 | Seq Scan | 746.70 | 758.51 | 1.6% | operator |
| 26635 | Hash | 44.54 | 9.38 | 78.9% | operator |
| 26636 | Seq Scan | 39.42 | 12.70 | 67.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26636 (Seq Scan) - LEAF
...
### Step 2: Node 26634 (Seq Scan) - LEAF
...
### Step 5: Node 26630 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26631, 26632
- **Input Features:**
