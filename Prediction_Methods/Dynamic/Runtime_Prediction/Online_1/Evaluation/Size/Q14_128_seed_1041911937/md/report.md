...
```
Node 26630 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26631 (Gather) [consumed]
    Node 26632 (Aggregate) [consumed]
      Node 26633 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26630 | 26631, 26632, 26633 |
...
|------|------|--------|-----------|-----|--------|
| 26630 | Aggregate | 823.66 | 857.14 | 4.1% | pattern |
...
### Step 4: Node 26630 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26631, 26632, 26633
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=15762
  - HashJoin_Outer_nt1=15762
  ...
  - HashJoin_Outer_total_cost=136648.0200
