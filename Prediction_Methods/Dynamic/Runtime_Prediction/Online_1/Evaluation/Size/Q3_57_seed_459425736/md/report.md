...
**Test Query:** Q3_57_seed_459425736
...
```
Node 5371 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5372 (Sort) [consumed]
    Node 5373 (Aggregate) [consumed]
      Node 5374 (Gather) [consumed]
        Node 5375 (Nested Loop)
          Node 5376 (Hash Join) [PATTERN: 895c6e8c]
            Node 5377 (Seq Scan) [consumed] - LEAF
            Node 5378 (Hash) [consumed]
              Node 5379 (Seq Scan) - LEAF
          Node 5380 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5371 | 5372, 5373, 5374, 5376, 5377, 5378 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5376 | 5371, 5372, 5373, 5374, 5377, 5378 |
...
|------|------|--------|-----------|-----|--------|
| 5371 | Limit | 1207.52 | 1151.18 | 4.7% | pattern |
| 5375 | Nested Loop | 1168.97 | 1192.77 | 2.0% | operator |
| 5376 | Hash Join | 207.93 | 242.42 | 16.6% | pattern |
| 5380 | Index Scan | 0.03 | -0.52 | 2018.8% | operator |
| 5379 | Seq Scan | 27.15 | 38.57 | 42.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5379 (Seq Scan) - LEAF
...
### Step 2: Node 5376 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5371, 5372, 5373, 5374, 5377, 5378
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46487
  - HashJoin_nt1=232682
  ...
  - HashJoin_total_cost=37332.5400
  - Hash_Inner_np=0
  - Hash_Inner_nt=12487
...
- **Input Features:**
  ...
  - total_cost=72630.6300
- **Output:** st=121.53, rt=1192.77

### Step 5: Node 5371 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5372, 5373, 5374, 5376, 5377, 5378
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=313294
  - Aggregate_Outer_nt1=313294
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=109659.4400
  - Aggregate_Outer_total_cost=113575.6100
  - Gather_Outer_np=0
  - Gather_Outer_nt=313294
  - Gather_Outer_nt1=101063
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=104960.0300
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=313294
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=120345.7800
  - Limit_total_cost=120345.8100
  - Sort_Outer_np=0
  - Sort_Outer_nt=313294
  - Sort_Outer_nt1=313294
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=120345.7800
  - Sort_Outer_total_cost=121129.0200
