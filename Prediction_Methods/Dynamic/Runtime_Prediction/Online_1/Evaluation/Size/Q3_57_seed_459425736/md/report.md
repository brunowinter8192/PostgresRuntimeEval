...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5371 | 5372, 5373, 5374 |
...
| 5375 | Nested Loop | 1168.97 | 1192.68 | 2.0% | operator |
| 5376 | Hash Join | 207.93 | 230.30 | 10.8% | operator |
| 5380 | Index Scan | 0.03 | -0.52 | 2018.8% | operator |
| 5377 | Seq Scan | 157.41 | 163.22 | 3.7% | operator |
| 5378 | Hash | 27.86 | 17.75 | 36.3% | operator |
...
### Step 2: Node 5377 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37332.5400
- **Output:** st=27.13, rt=230.30

### Step 5: Node 5380 (Index Scan) - LEAF
...
- **Output:** st=121.38, rt=1192.68

### Step 7: Node 5371 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5372, 5373, 5374
- **Input Features:**
