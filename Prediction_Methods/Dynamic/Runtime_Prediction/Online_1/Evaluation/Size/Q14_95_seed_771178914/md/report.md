...
**Test Query:** Q14_95_seed_771178914
...
```
Node 27428 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27429 (Gather) [consumed]
    Node 27430 (Aggregate) [consumed]
      Node 27431 (Hash Join)
        Node 27432 (Seq Scan) - LEAF
        Node 27433 (Hash)
          Node 27434 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27428 | 27429, 27430 |
...
|------|------|--------|-----------|-----|--------|
| 27428 | Aggregate | 831.40 | 848.35 | 2.0% | pattern |
| 27431 | Hash Join | 809.99 | 807.63 | 0.3% | operator |
| 27432 | Seq Scan | 759.39 | 758.47 | 0.1% | operator |
| 27433 | Hash | 42.37 | 9.38 | 77.9% | operator |
| 27434 | Seq Scan | 37.75 | 12.70 | 66.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27434 (Seq Scan) - LEAF
...
### Step 2: Node 27432 (Seq Scan) - LEAF
...
### Step 5: Node 27428 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27429, 27430
- **Input Features:**
