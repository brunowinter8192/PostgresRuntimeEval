...
```
Node 27428 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27429 (Gather) [consumed]
    Node 27430 (Aggregate) [consumed]
      Node 27431 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27428 | 27429, 27430, 27431 |
...
|------|------|--------|-----------|-----|--------|
| 27428 | Aggregate | 831.40 | 857.12 | 3.1% | pattern |
...
### Step 4: Node 27428 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27429, 27430, 27431
- **Input Features:**
