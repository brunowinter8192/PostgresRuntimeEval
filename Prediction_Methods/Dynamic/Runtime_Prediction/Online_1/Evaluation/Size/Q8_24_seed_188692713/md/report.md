...
```
Node 14719 (Aggregate) - ROOT
  Node 14720 (Gather Merge)
    Node 14721 (Sort)
          ...
          Node 14724 (Hash Join)
            Node 14725 (Nested Loop)
              Node 14726 (Hash Join)
                ...
                Node 14728 (Hash)
                  Node 14729 (Hash Join)
                    Node 14730 (Seq Scan) - LEAF
                    Node 14731 (Hash)
                      Node 14732 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 14719 | Aggregate | 1245.20 | 1195.83 | 4.0% | operator |
| 14720 | Gather Merge | 1244.70 | 1097.18 | 11.9% | operator |
...
| 14726 | Hash Join | 218.74 | 251.17 | 14.8% | operator |
...
| 14728 | Hash | 34.85 | 20.62 | 40.9% | operator |
| 14729 | Hash Join | 34.13 | 132.26 | 287.5% | operator |
| 14730 | Seq Scan | 32.55 | 23.03 | 29.2% | operator |
| 14731 | Hash | 0.26 | 23.66 | 9069.0% | operator |
| 14732 | Hash Join | 0.26 | 306.84 | 120227.8% | operator |
...
### Step 5: Node 14730 (Seq Scan) - LEAF
...
### Step 8: Node 14727 (Seq Scan) - LEAF
...
### Step 11: Node 14736 (Index Scan) - LEAF
...
### Step 12: Node 14738 (Seq Scan) - LEAF
...
### Step 13: Node 14725 (Nested Loop)
...
### Step 16: Node 14739 (Index Scan) - LEAF
...
### Step 17: Node 14741 (Seq Scan) - LEAF
...
### Step 18: Node 14723 (Nested Loop)
...
### Step 22: Node 14720 (Gather Merge)
...
### Step 23: Node 14719 (Aggregate) - ROOT
