...
Node 536 (Aggregate) - ROOT
  Node 537 (Gather Merge)
    Node 538 (Sort) [PATTERN: 1d35fb97]
      Node 539 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 538 | 539 |
...
|------|------|--------|-----------|-----|--------|
| 536 | Aggregate | 936.28 | 1195.90 | 27.7% | operator |
| 537 | Gather Merge | 936.24 | 1165.91 | 24.5% | operator |
| 538 | Sort | 919.50 | 1200.55 | 30.6% | pattern |
...
### Step 2: Node 538 (Sort) - PATTERN ROOT
...
### Step 4: Node 536 (Aggregate) - ROOT
