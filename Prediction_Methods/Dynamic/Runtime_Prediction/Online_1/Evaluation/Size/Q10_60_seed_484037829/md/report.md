    ...
    Node 20750 (Aggregate) [consumed]
      Node 20751 (Gather) [consumed]
        Node 20752 (Hash Join)
          Node 20753 (Hash Join) [PATTERN: 2e0f44ef]
            Node 20754 (Nested Loop) [consumed]
              Node 20755 (Seq Scan) - LEAF
              Node 20756 (Index Scan) - LEAF
            Node 20757 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20748 | 20749, 20750, 20751, 20753, 20754, 20757 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 20753 | 20748, 20749, 20750, 20751, 20754, 20757 |
...
| 20752 | Hash Join | 1102.38 | 1095.48 | 0.6% | operator |
| 20753 | Hash Join | 1099.14 | 1120.19 | 1.9% | pattern |
...
### Step 4: Node 20760 (Seq Scan) - LEAF
...
### Step 5: Node 20753 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 20748, 20749, 20750, 20751, 20754, 20757
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=17935
  - HashJoin_nt1=17935
...
### Step 8: Node 20748 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20749, 20750, 20751, 20753, 20754, 20757
- **Input Features:**
