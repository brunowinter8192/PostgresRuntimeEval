...
**Test Query:** Q13_28_seed_221508837
...
```
Node 25860 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25861 (Aggregate) [consumed]
    Node 25862 (Aggregate)
      Node 25863 (Hash Join) [PATTERN: 895c6e8c]
        Node 25864 (Seq Scan) [consumed] - LEAF
        Node 25865 (Hash) [consumed]
          Node 25866 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25860 | 25861, 25863, 25864, 25865 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25863 | 25860, 25861, 25864, 25865 |
...
|------|------|--------|-----------|-----|--------|
| 25860 | Sort | 925.07 | 1079.93 | 16.7% | pattern |
| 25862 | Aggregate | 919.06 | 999.15 | 8.7% | operator |
| 25863 | Hash Join | 710.75 | 470.31 | 33.8% | pattern |
| 25866 | Index Only Scan | 10.47 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25866 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25863 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25860, 25861, 25864, 25865
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1478958
...
### Step 4: Node 25860 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25861, 25863, 25864, 25865
- **Input Features:**
