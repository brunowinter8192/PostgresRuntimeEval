...
**Test Query:** Q14_55_seed_443017674
...
```
Node 27120 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27121 (Gather) [consumed]
    Node 27122 (Aggregate) [consumed]
      Node 27123 (Hash Join) [consumed]
        Node 27124 (Seq Scan) - LEAF
        Node 27125 (Hash)
          Node 27126 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27120 | 27121, 27122, 27123 |
...
|------|------|--------|-----------|-----|--------|
| 27120 | Aggregate | 813.76 | 857.14 | 5.3% | pattern |
| 27124 | Seq Scan | 743.45 | 758.50 | 2.0% | operator |
| 27125 | Hash | 43.16 | 9.38 | 78.3% | operator |
| 27126 | Seq Scan | 37.49 | 12.70 | 66.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27126 (Seq Scan) - LEAF
...
### Step 2: Node 27124 (Seq Scan) - LEAF
...
### Step 4: Node 27120 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27121, 27122, 27123
- **Input Features:**
