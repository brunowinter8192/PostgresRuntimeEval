...
```
Node 27141 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27142 (Gather) [consumed]
    Node 27143 (Aggregate) [consumed]
      Node 27144 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27141 | 27142, 27143 |
...
|------|------|--------|-----------|-----|--------|
| 27141 | Aggregate | 839.11 | 848.36 | 1.1% | pattern |
| 27144 | Hash Join | 816.18 | 807.63 | 1.0% | operator |
...
### Step 5: Node 27141 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27142, 27143
- **Input Features:**
