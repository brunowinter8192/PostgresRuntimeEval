...
**Test Query:** Q14_58_seed_467629767
...
```
Node 27141 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27142 (Gather) [consumed]
    Node 27143 (Aggregate) [consumed]
      Node 27144 (Hash Join) [consumed]
        Node 27145 (Seq Scan) - LEAF
        Node 27146 (Hash)
          Node 27147 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27141 | 27142, 27143, 27144 |
...
|------|------|--------|-----------|-----|--------|
| 27141 | Aggregate | 839.11 | 857.12 | 2.1% | pattern |
| 27145 | Seq Scan | 764.22 | 758.47 | 0.8% | operator |
| 27146 | Hash | 44.30 | 9.38 | 78.8% | operator |
| 27147 | Seq Scan | 39.67 | 12.70 | 68.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27147 (Seq Scan) - LEAF
...
### Step 2: Node 27145 (Seq Scan) - LEAF
...
### Step 4: Node 27141 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27142, 27143, 27144
- **Input Features:**
