...
```
Node 12355 (Aggregate) - ROOT
  Node 12356 (Gather Merge)
    Node 12357 (Sort)
      Node 12358 (Hash Join)
        Node 12359 (Nested Loop)
          Node 12360 (Hash Join)
            Node 12361 (Seq Scan) - LEAF
            Node 12362 (Hash)
              Node 12363 (Hash Join)
                Node 12364 (Seq Scan) - LEAF
                Node 12365 (Hash)
                  Node 12366 (Seq Scan) - LEAF
          Node 12367 (Index Scan) - LEAF
        Node 12368 (Hash)
          Node 12369 (Hash Join)
            Node 12370 (Seq Scan) - LEAF
            Node 12371 (Hash)
              Node 12372 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12355 | Aggregate | 1197.21 | 1209.26 | 1.0% | operator |
| 12356 | Gather Merge | 1196.06 | 1142.98 | 4.4% | operator |
| 12357 | Sort | 1191.31 | 1109.13 | 6.9% | operator |
| 12358 | Hash Join | 1190.60 | 842.59 | 29.2% | operator |
| 12359 | Nested Loop | 1183.05 | 1216.16 | 2.8% | operator |
| 12368 | Hash | 3.73 | 17.53 | 369.6% | operator |
| 12360 | Hash Join | 213.07 | 384.47 | 80.4% | operator |
| 12367 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 12369 | Hash Join | 3.69 | 85.17 | 2208.3% | operator |
| 12361 | Seq Scan | 153.12 | 201.16 | 31.4% | operator |
| 12362 | Hash | 34.92 | 19.59 | 43.9% | operator |
| 12370 | Seq Scan | 3.38 | 11.47 | 239.7% | operator |
| 12371 | Hash | 0.01 | 16.89 | 112527.2% | operator |
| 12363 | Hash Join | 34.63 | 92.20 | 166.3% | operator |
| 12372 | Seq Scan | 0.01 | 45.79 | 381502.6% | operator |
| 12364 | Seq Scan | 33.47 | 21.86 | 34.7% | operator |
| 12365 | Hash | 0.01 | 16.89 | 168840.8% | operator |
| 12366 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12366 (Seq Scan) - LEAF
...
### Step 2: Node 12364 (Seq Scan) - LEAF
...
### Step 5: Node 12372 (Seq Scan) - LEAF
...
### Step 6: Node 12361 (Seq Scan) - LEAF
...
### Step 8: Node 12370 (Seq Scan) - LEAF
...
### Step 11: Node 12367 (Index Scan) - LEAF
...
### Step 13: Node 12359 (Nested Loop)
...
### Step 17: Node 12356 (Gather Merge)
...
### Step 18: Node 12355 (Aggregate) - ROOT
