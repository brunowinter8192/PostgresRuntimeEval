...
**Test Query:** Q4_126_seed_1025503875
...
```
Node 6047 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6048 (Gather Merge) [consumed]
    Node 6049 (Sort) [consumed]
      Node 6050 (Aggregate) [consumed]
        Node 6051 (Nested Loop)
          Node 6052 (Seq Scan) - LEAF
          Node 6053 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6047 | 6048, 6049, 6050 |
...
|------|------|--------|-----------|-----|--------|
| 6047 | Aggregate | 1034.66 | 952.19 | 8.0% | pattern |
| 6051 | Nested Loop | 1027.51 | 1255.45 | 22.2% | operator |
| 6052 | Seq Scan | 164.85 | 154.66 | 6.2% | operator |
| 6053 | Index Scan | 0.06 | 11.10 | 17810.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6052 (Seq Scan) - LEAF
...
### Step 2: Node 6053 (Index Scan) - LEAF
