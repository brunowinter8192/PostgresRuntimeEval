...
```
Node 14420 (Aggregate) - ROOT
  Node 14421 (Gather Merge)
    Node 14422 (Sort)
          ...
          Node 14425 (Hash Join)
            Node 14426 (Nested Loop)
              Node 14427 (Hash Join)
                ...
                Node 14429 (Hash)
                  Node 14430 (Hash Join)
                    Node 14431 (Seq Scan) - LEAF
                    Node 14432 (Hash)
                      Node 14433 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 14420 | Aggregate | 1262.49 | 1195.83 | 5.3% | operator |
| 14421 | Gather Merge | 1262.10 | 1097.12 | 13.1% | operator |
...
| 14427 | Hash Join | 217.63 | 251.17 | 15.4% | operator |
...
| 14429 | Hash | 37.52 | 20.62 | 45.1% | operator |
| 14430 | Hash Join | 36.95 | 132.26 | 258.0% | operator |
| 14431 | Seq Scan | 35.46 | 23.03 | 35.1% | operator |
| 14432 | Hash | 0.23 | 23.66 | 10321.2% | operator |
| 14433 | Hash Join | 0.23 | 306.84 | 136271.5% | operator |
...
### Step 5: Node 14431 (Seq Scan) - LEAF
...
### Step 8: Node 14428 (Seq Scan) - LEAF
...
### Step 11: Node 14437 (Index Scan) - LEAF
...
### Step 12: Node 14439 (Seq Scan) - LEAF
...
### Step 13: Node 14426 (Nested Loop)
...
### Step 16: Node 14440 (Index Scan) - LEAF
...
### Step 17: Node 14442 (Seq Scan) - LEAF
...
### Step 18: Node 14424 (Nested Loop)
...
### Step 22: Node 14421 (Gather Merge)
...
### Step 23: Node 14420 (Aggregate) - ROOT
