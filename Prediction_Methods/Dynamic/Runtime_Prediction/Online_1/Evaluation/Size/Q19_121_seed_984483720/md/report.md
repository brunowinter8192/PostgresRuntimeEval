...
```
Node 31381 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31382 (Gather) [consumed]
    Node 31383 (Aggregate) [consumed]
      Node 31384 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31381 | 31382, 31383, 31384 |
...
|------|------|--------|-----------|-----|--------|
| 31381 | Aggregate | 858.93 | 829.29 | 3.5% | pattern |
...
### Step 4: Node 31381 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31382, 31383, 31384
- **Input Features:**
