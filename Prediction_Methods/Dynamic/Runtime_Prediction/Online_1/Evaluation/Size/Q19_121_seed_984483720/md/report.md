...
**Test Query:** Q19_121_seed_984483720
...
```
Node 31381 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31382 (Gather) [consumed]
    Node 31383 (Aggregate) [consumed]
      Node 31384 (Hash Join)
        Node 31385 (Seq Scan) - LEAF
        Node 31386 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31381 | 31382, 31383 |
...
|------|------|--------|-----------|-----|--------|
| 31381 | Aggregate | 858.93 | 831.20 | 3.2% | pattern |
| 31384 | Hash Join | 840.57 | 766.05 | 8.9% | operator |
| 31385 | Seq Scan | 793.93 | 743.46 | 6.4% | operator |
| 31386 | Hash | 44.98 | 8.29 | 81.6% | operator |
| 31387 | Seq Scan | 44.91 | 23.76 | 47.1% | operator |
...
### Step 2: Node 31385 (Seq Scan) - LEAF
...
### Step 5: Node 31381 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31382, 31383
- **Input Features:**
