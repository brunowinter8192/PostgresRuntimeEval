...
```
Node 11293 (Aggregate) - ROOT
  Node 11294 (Gather Merge)
    Node 11295 (Sort)
      Node 11296 (Hash Join)
        Node 11297 (Nested Loop)
          Node 11298 (Hash Join)
            Node 11299 (Seq Scan) - LEAF
            Node 11300 (Hash)
              Node 11301 (Hash Join)
                Node 11302 (Seq Scan) - LEAF
                Node 11303 (Hash)
                  Node 11304 (Seq Scan) - LEAF
          Node 11305 (Index Scan) - LEAF
        Node 11306 (Hash)
          Node 11307 (Hash Join)
            Node 11308 (Seq Scan) - LEAF
            Node 11309 (Hash)
              Node 11310 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 11293 | Aggregate | 1216.99 | 1209.26 | 0.6% | operator |
| 11294 | Gather Merge | 1216.01 | 1142.98 | 6.0% | operator |
| 11295 | Sort | 1210.74 | 1109.13 | 8.4% | operator |
| 11296 | Hash Join | 1210.10 | 842.59 | 30.4% | operator |
| 11297 | Nested Loop | 1202.83 | 1216.16 | 1.1% | operator |
| 11306 | Hash | 3.58 | 17.53 | 389.9% | operator |
| 11298 | Hash Join | 213.54 | 384.47 | 80.0% | operator |
| 11305 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 11307 | Hash Join | 3.53 | 85.17 | 2312.2% | operator |
| 11299 | Seq Scan | 150.34 | 201.16 | 33.8% | operator |
| 11300 | Hash | 37.29 | 19.59 | 47.5% | operator |
| 11308 | Seq Scan | 3.20 | 11.47 | 258.8% | operator |
| 11309 | Hash | 0.01 | 16.89 | 112527.2% | operator |
| 11301 | Hash Join | 37.02 | 92.20 | 149.1% | operator |
| 11310 | Seq Scan | 0.01 | 45.79 | 416193.8% | operator |
| 11302 | Seq Scan | 35.94 | 21.86 | 39.2% | operator |
| 11303 | Hash | 0.01 | 16.89 | 168840.8% | operator |
| 11304 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11304 (Seq Scan) - LEAF
...
### Step 2: Node 11302 (Seq Scan) - LEAF
...
### Step 5: Node 11310 (Seq Scan) - LEAF
...
### Step 6: Node 11299 (Seq Scan) - LEAF
...
### Step 8: Node 11308 (Seq Scan) - LEAF
...
### Step 11: Node 11305 (Index Scan) - LEAF
...
### Step 13: Node 11297 (Nested Loop)
...
### Step 17: Node 11294 (Gather Merge)
...
### Step 18: Node 11293 (Aggregate) - ROOT
