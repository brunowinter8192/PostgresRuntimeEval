...
```
Node 11113 (Aggregate) - ROOT
  Node 11114 (Gather Merge)
    Node 11115 (Sort)
      Node 11116 (Hash Join)
        Node 11117 (Nested Loop)
          Node 11118 (Hash Join)
            Node 11119 (Seq Scan) - LEAF
            Node 11120 (Hash)
              Node 11121 (Hash Join)
                Node 11122 (Seq Scan) - LEAF
                Node 11123 (Hash)
                  Node 11124 (Seq Scan) - LEAF
          Node 11125 (Index Scan) - LEAF
        Node 11126 (Hash)
          Node 11127 (Hash Join)
            Node 11128 (Seq Scan) - LEAF
            Node 11129 (Hash)
              Node 11130 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 11113 | Aggregate | 1178.68 | 1209.26 | 2.6% | operator |
| 11114 | Gather Merge | 1177.59 | 1142.98 | 2.9% | operator |
| 11115 | Sort | 1171.12 | 1109.13 | 5.3% | operator |
| 11116 | Hash Join | 1170.50 | 842.59 | 28.0% | operator |
| 11117 | Nested Loop | 1163.80 | 1216.16 | 4.5% | operator |
| 11126 | Hash | 2.87 | 17.53 | 510.8% | operator |
| 11118 | Hash Join | 216.03 | 384.47 | 78.0% | operator |
| 11125 | Index Scan | 0.03 | 0.96 | 3006.0% | operator |
| 11127 | Hash Join | 2.82 | 85.17 | 2918.2% | operator |
| 11119 | Seq Scan | 153.98 | 201.16 | 30.6% | operator |
| 11120 | Hash | 36.96 | 19.59 | 47.0% | operator |
| 11128 | Seq Scan | 2.47 | 11.47 | 363.7% | operator |
| 11129 | Hash | 0.02 | 16.89 | 105488.0% | operator |
| 11121 | Hash Join | 36.36 | 92.20 | 153.6% | operator |
| 11130 | Seq Scan | 0.01 | 45.79 | 352148.6% | operator |
| 11122 | Seq Scan | 35.27 | 21.86 | 38.0% | operator |
| 11123 | Hash | 0.01 | 16.89 | 211076.0% | operator |
| 11124 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11124 (Seq Scan) - LEAF
...
### Step 2: Node 11122 (Seq Scan) - LEAF
...
### Step 5: Node 11130 (Seq Scan) - LEAF
...
### Step 6: Node 11119 (Seq Scan) - LEAF
...
### Step 8: Node 11128 (Seq Scan) - LEAF
...
### Step 11: Node 11125 (Index Scan) - LEAF
...
### Step 13: Node 11117 (Nested Loop)
...
### Step 17: Node 11114 (Gather Merge)
...
### Step 18: Node 11113 (Aggregate) - ROOT
