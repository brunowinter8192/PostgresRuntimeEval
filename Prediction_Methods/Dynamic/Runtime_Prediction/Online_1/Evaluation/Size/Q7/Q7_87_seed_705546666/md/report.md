...
```
Node 12931 (Aggregate) - ROOT
  Node 12932 (Gather Merge)
    Node 12933 (Sort)
      Node 12934 (Hash Join)
        Node 12935 (Nested Loop)
          Node 12936 (Hash Join)
            Node 12937 (Seq Scan) - LEAF
            Node 12938 (Hash)
              Node 12939 (Hash Join)
                Node 12940 (Seq Scan) - LEAF
                Node 12941 (Hash)
                  Node 12942 (Seq Scan) - LEAF
          Node 12943 (Index Scan) - LEAF
        Node 12944 (Hash)
          Node 12945 (Hash Join)
            Node 12946 (Seq Scan) - LEAF
            Node 12947 (Hash)
              Node 12948 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12931 | Aggregate | 1183.44 | 1209.26 | 2.2% | operator |
| 12932 | Gather Merge | 1182.41 | 1142.98 | 3.3% | operator |
| 12933 | Sort | 1177.08 | 1109.13 | 5.8% | operator |
| 12934 | Hash Join | 1176.44 | 842.59 | 28.4% | operator |
| 12935 | Nested Loop | 1169.51 | 1216.16 | 4.0% | operator |
| 12944 | Hash | 3.11 | 17.53 | 464.4% | operator |
| 12936 | Hash Join | 205.69 | 384.47 | 86.9% | operator |
| 12943 | Index Scan | 0.03 | 0.96 | 3006.0% | operator |
| 12945 | Hash Join | 3.06 | 85.17 | 2685.3% | operator |
| 12937 | Seq Scan | 149.21 | 201.16 | 34.8% | operator |
| 12938 | Hash | 31.59 | 19.59 | 38.0% | operator |
| 12946 | Seq Scan | 2.71 | 11.47 | 323.4% | operator |
| 12947 | Hash | 0.01 | 16.89 | 129854.5% | operator |
| 12939 | Hash Join | 31.05 | 92.20 | 196.9% | operator |
| 12948 | Seq Scan | 0.01 | 45.79 | 416193.8% | operator |
| 12940 | Seq Scan | 29.91 | 21.86 | 26.9% | operator |
| 12941 | Hash | 0.01 | 16.89 | 168840.8% | operator |
| 12942 | Seq Scan | 0.01 | 45.79 | 572303.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12942 (Seq Scan) - LEAF
...
### Step 2: Node 12940 (Seq Scan) - LEAF
...
### Step 5: Node 12948 (Seq Scan) - LEAF
...
### Step 6: Node 12937 (Seq Scan) - LEAF
...
### Step 8: Node 12946 (Seq Scan) - LEAF
...
### Step 11: Node 12943 (Index Scan) - LEAF
...
### Step 13: Node 12935 (Nested Loop)
...
### Step 17: Node 12932 (Gather Merge)
...
### Step 18: Node 12931 (Aggregate) - ROOT
