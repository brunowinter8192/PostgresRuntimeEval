...
```
Node 13129 (Aggregate) - ROOT
  Node 13130 (Gather Merge)
    Node 13131 (Sort)
      Node 13132 (Hash Join)
        Node 13133 (Nested Loop)
          Node 13134 (Hash Join)
            Node 13135 (Seq Scan) - LEAF
            Node 13136 (Hash)
              Node 13137 (Hash Join)
                Node 13138 (Seq Scan) - LEAF
                Node 13139 (Hash)
                  Node 13140 (Seq Scan) - LEAF
          Node 13141 (Index Scan) - LEAF
        Node 13142 (Hash)
          Node 13143 (Hash Join)
            Node 13144 (Seq Scan) - LEAF
            Node 13145 (Hash)
              Node 13146 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 13129 | Aggregate | 1185.19 | 1209.26 | 2.0% | operator |
| 13130 | Gather Merge | 1184.07 | 1142.98 | 3.5% | operator |
| 13131 | Sort | 1178.25 | 1109.13 | 5.9% | operator |
| 13132 | Hash Join | 1177.57 | 842.59 | 28.4% | operator |
| 13133 | Nested Loop | 1168.00 | 1216.16 | 4.1% | operator |
| 13142 | Hash | 5.70 | 17.53 | 207.7% | operator |
| 13134 | Hash Join | 211.60 | 384.47 | 81.7% | operator |
| 13141 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 13143 | Hash Join | 5.65 | 85.17 | 1407.0% | operator |
| 13135 | Seq Scan | 150.92 | 201.16 | 33.3% | operator |
| 13136 | Hash | 35.62 | 19.59 | 45.0% | operator |
| 13144 | Seq Scan | 5.32 | 11.47 | 115.7% | operator |
| 13145 | Hash | 0.02 | 16.89 | 99277.0% | operator |
| 13137 | Hash Join | 35.31 | 92.20 | 161.1% | operator |
| 13146 | Seq Scan | 0.01 | 45.79 | 416193.8% | operator |
| 13138 | Seq Scan | 34.14 | 21.86 | 36.0% | operator |
| 13139 | Hash | 0.01 | 16.89 | 168840.8% | operator |
| 13140 | Seq Scan | 0.01 | 45.79 | 572303.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 13140 (Seq Scan) - LEAF
...
### Step 2: Node 13138 (Seq Scan) - LEAF
...
### Step 5: Node 13146 (Seq Scan) - LEAF
...
### Step 6: Node 13135 (Seq Scan) - LEAF
...
### Step 8: Node 13144 (Seq Scan) - LEAF
...
### Step 11: Node 13141 (Index Scan) - LEAF
...
### Step 13: Node 13133 (Nested Loop)
...
### Step 17: Node 13130 (Gather Merge)
...
### Step 18: Node 13129 (Aggregate) - ROOT
