...
```
Node 12985 (Aggregate) - ROOT
  Node 12986 (Gather Merge)
    Node 12987 (Sort)
      Node 12988 (Hash Join)
        Node 12989 (Nested Loop)
          Node 12990 (Hash Join)
            Node 12991 (Seq Scan) - LEAF
            Node 12992 (Hash)
              Node 12993 (Hash Join)
                Node 12994 (Seq Scan) - LEAF
                Node 12995 (Hash)
                  Node 12996 (Seq Scan) - LEAF
          Node 12997 (Index Scan) - LEAF
        Node 12998 (Hash)
          Node 12999 (Hash Join)
            Node 13000 (Seq Scan) - LEAF
            Node 13001 (Hash)
              Node 13002 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12985 | Aggregate | 1176.61 | 1209.26 | 2.8% | operator |
| 12986 | Gather Merge | 1175.50 | 1142.98 | 2.8% | operator |
| 12987 | Sort | 1169.27 | 1109.13 | 5.1% | operator |
| 12988 | Hash Join | 1168.63 | 842.59 | 27.9% | operator |
| 12989 | Nested Loop | 1161.63 | 1216.16 | 4.7% | operator |
| 12998 | Hash | 3.19 | 17.53 | 449.0% | operator |
| 12990 | Hash Join | 210.10 | 384.47 | 83.0% | operator |
| 12997 | Index Scan | 0.03 | 0.96 | 3006.0% | operator |
| 12999 | Hash Join | 3.15 | 85.17 | 2607.4% | operator |
| 12991 | Seq Scan | 151.61 | 201.16 | 32.7% | operator |
| 12992 | Hash | 33.45 | 19.59 | 41.4% | operator |
| 13000 | Seq Scan | 2.81 | 11.47 | 308.9% | operator |
| 13001 | Hash | 0.01 | 16.89 | 112527.2% | operator |
| 12993 | Hash Join | 33.02 | 92.20 | 179.2% | operator |
| 13002 | Seq Scan | 0.01 | 45.79 | 457823.2% | operator |
| 12994 | Seq Scan | 31.93 | 21.86 | 31.5% | operator |
| 12995 | Hash | 0.01 | 16.89 | 153482.6% | operator |
| 12996 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12996 (Seq Scan) - LEAF
...
### Step 2: Node 12994 (Seq Scan) - LEAF
...
### Step 5: Node 13002 (Seq Scan) - LEAF
...
### Step 6: Node 12991 (Seq Scan) - LEAF
...
### Step 8: Node 13000 (Seq Scan) - LEAF
...
### Step 11: Node 12997 (Index Scan) - LEAF
...
### Step 13: Node 12989 (Nested Loop)
...
### Step 17: Node 12986 (Gather Merge)
...
### Step 18: Node 12985 (Aggregate) - ROOT
