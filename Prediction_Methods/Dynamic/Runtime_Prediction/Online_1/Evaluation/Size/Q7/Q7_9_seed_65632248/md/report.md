...
```
Node 13183 (Aggregate) - ROOT
  Node 13184 (Gather Merge)
    Node 13185 (Sort)
      Node 13186 (Hash Join)
        Node 13187 (Nested Loop)
          Node 13188 (Hash Join)
            Node 13189 (Seq Scan) - LEAF
            Node 13190 (Hash)
              Node 13191 (Hash Join)
                Node 13192 (Seq Scan) - LEAF
                Node 13193 (Hash)
                  Node 13194 (Seq Scan) - LEAF
          Node 13195 (Index Scan) - LEAF
        Node 13196 (Hash)
          Node 13197 (Hash Join)
            Node 13198 (Seq Scan) - LEAF
            Node 13199 (Hash)
              Node 13200 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 13183 | Aggregate | 1200.46 | 1209.26 | 0.7% | operator |
| 13184 | Gather Merge | 1199.43 | 1142.98 | 4.7% | operator |
| 13185 | Sort | 1194.34 | 1109.13 | 7.1% | operator |
| 13186 | Hash Join | 1193.70 | 842.59 | 29.4% | operator |
| 13187 | Nested Loop | 1186.26 | 1216.16 | 2.5% | operator |
| 13196 | Hash | 3.54 | 17.53 | 394.9% | operator |
| 13188 | Hash Join | 212.16 | 384.47 | 81.2% | operator |
| 13195 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 13197 | Hash Join | 3.50 | 85.17 | 2336.3% | operator |
| 13189 | Seq Scan | 152.12 | 201.16 | 32.2% | operator |
| 13190 | Hash | 34.56 | 19.59 | 43.3% | operator |
| 13198 | Seq Scan | 3.19 | 11.47 | 259.4% | operator |
| 13199 | Hash | 0.01 | 16.89 | 120572.0% | operator |
| 13191 | Hash Join | 34.18 | 92.20 | 169.8% | operator |
| 13200 | Seq Scan | 0.01 | 45.79 | 416193.8% | operator |
| 13192 | Seq Scan | 33.06 | 21.86 | 33.9% | operator |
| 13193 | Hash | 0.01 | 16.89 | 153482.6% | operator |
| 13194 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 13194 (Seq Scan) - LEAF
...
### Step 2: Node 13192 (Seq Scan) - LEAF
...
### Step 5: Node 13200 (Seq Scan) - LEAF
...
### Step 6: Node 13189 (Seq Scan) - LEAF
...
### Step 8: Node 13198 (Seq Scan) - LEAF
...
### Step 11: Node 13195 (Index Scan) - LEAF
...
### Step 13: Node 13187 (Nested Loop)
...
### Step 17: Node 13184 (Gather Merge)
...
### Step 18: Node 13183 (Aggregate) - ROOT
