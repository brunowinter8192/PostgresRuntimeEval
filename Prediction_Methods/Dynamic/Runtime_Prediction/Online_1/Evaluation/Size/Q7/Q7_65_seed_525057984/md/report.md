...
```
Node 12499 (Aggregate) - ROOT
  Node 12500 (Gather Merge)
    Node 12501 (Sort)
      Node 12502 (Hash Join)
        Node 12503 (Nested Loop)
          Node 12504 (Hash Join)
            Node 12505 (Seq Scan) - LEAF
            Node 12506 (Hash)
              Node 12507 (Hash Join)
                Node 12508 (Seq Scan) - LEAF
                Node 12509 (Hash)
                  Node 12510 (Seq Scan) - LEAF
          Node 12511 (Index Scan) - LEAF
        Node 12512 (Hash)
          Node 12513 (Hash Join)
            Node 12514 (Seq Scan) - LEAF
            Node 12515 (Hash)
              Node 12516 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12499 | Aggregate | 1204.78 | 1209.26 | 0.4% | operator |
| 12500 | Gather Merge | 1203.73 | 1142.98 | 5.0% | operator |
| 12501 | Sort | 1198.01 | 1109.13 | 7.4% | operator |
| 12502 | Hash Join | 1197.39 | 842.59 | 29.6% | operator |
| 12503 | Nested Loop | 1189.81 | 1216.16 | 2.2% | operator |
| 12512 | Hash | 3.65 | 17.53 | 380.3% | operator |
| 12504 | Hash Join | 217.19 | 384.47 | 77.0% | operator |
| 12511 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 12513 | Hash Join | 3.60 | 85.17 | 2266.6% | operator |
| 12505 | Seq Scan | 154.35 | 201.16 | 30.3% | operator |
| 12506 | Hash | 36.56 | 19.59 | 46.4% | operator |
| 12514 | Seq Scan | 3.24 | 11.47 | 254.3% | operator |
| 12515 | Hash | 0.02 | 16.89 | 105488.0% | operator |
| 12507 | Hash Join | 35.96 | 92.20 | 156.4% | operator |
| 12516 | Seq Scan | 0.01 | 45.79 | 352148.6% | operator |
| 12508 | Seq Scan | 34.84 | 21.86 | 37.3% | operator |
| 12509 | Hash | 0.01 | 16.89 | 140684.0% | operator |
| 12510 | Seq Scan | 0.01 | 45.79 | 508703.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12510 (Seq Scan) - LEAF
...
### Step 2: Node 12508 (Seq Scan) - LEAF
...
### Step 5: Node 12516 (Seq Scan) - LEAF
...
### Step 6: Node 12505 (Seq Scan) - LEAF
...
### Step 8: Node 12514 (Seq Scan) - LEAF
...
### Step 11: Node 12511 (Index Scan) - LEAF
...
### Step 13: Node 12503 (Nested Loop)
...
### Step 17: Node 12500 (Gather Merge)
...
### Step 18: Node 12499 (Aggregate) - ROOT
