...
```
Node 12607 (Aggregate) - ROOT
  Node 12608 (Gather Merge)
    Node 12609 (Sort)
      Node 12610 (Hash Join)
        Node 12611 (Nested Loop)
          Node 12612 (Hash Join)
            Node 12613 (Seq Scan) - LEAF
            Node 12614 (Hash)
              Node 12615 (Hash Join)
                Node 12616 (Seq Scan) - LEAF
                Node 12617 (Hash)
                  Node 12618 (Seq Scan) - LEAF
          Node 12619 (Index Scan) - LEAF
        Node 12620 (Hash)
          Node 12621 (Hash Join)
            Node 12622 (Seq Scan) - LEAF
            Node 12623 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 12607 | Aggregate | 1207.23 | 1209.26 | 0.2% | operator |
| 12608 | Gather Merge | 1206.22 | 1142.98 | 5.2% | operator |
| 12609 | Sort | 1201.31 | 1109.13 | 7.7% | operator |
| 12610 | Hash Join | 1200.71 | 842.59 | 29.8% | operator |
| 12611 | Nested Loop | 1193.33 | 1216.16 | 1.9% | operator |
| 12620 | Hash | 3.69 | 17.53 | 375.5% | operator |
| 12612 | Hash Join | 213.91 | 384.47 | 79.7% | operator |
| 12619 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 12621 | Hash Join | 3.64 | 85.17 | 2238.0% | operator |
| 12613 | Seq Scan | 151.34 | 201.16 | 32.9% | operator |
| 12614 | Hash | 36.99 | 19.59 | 47.0% | operator |
| 12622 | Seq Scan | 3.35 | 11.47 | 242.9% | operator |
| 12623 | Hash | 0.02 | 16.89 | 105488.0% | operator |
| 12615 | Hash Join | 36.60 | 92.20 | 151.9% | operator |
| 12624 | Seq Scan | 0.01 | 45.79 | 381502.6% | operator |
| 12616 | Seq Scan | 35.45 | 21.86 | 38.3% | operator |
| 12617 | Hash | 0.01 | 16.89 | 187612.0% | operator |
| 12618 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |
...
### Step 2: Node 12616 (Seq Scan) - LEAF
...
### Step 5: Node 12624 (Seq Scan) - LEAF
...
### Step 6: Node 12613 (Seq Scan) - LEAF
...
### Step 8: Node 12622 (Seq Scan) - LEAF
...
### Step 11: Node 12619 (Index Scan) - LEAF
...
### Step 13: Node 12611 (Nested Loop)
...
### Step 17: Node 12608 (Gather Merge)
...
### Step 18: Node 12607 (Aggregate) - ROOT
