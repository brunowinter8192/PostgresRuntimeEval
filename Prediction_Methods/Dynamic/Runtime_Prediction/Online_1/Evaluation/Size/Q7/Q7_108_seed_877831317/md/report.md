...
```
Node 10645 (Aggregate) - ROOT
  Node 10646 (Gather Merge)
    Node 10647 (Sort)
      Node 10648 (Hash Join)
        Node 10649 (Nested Loop)
          Node 10650 (Hash Join)
            Node 10651 (Seq Scan) - LEAF
            Node 10652 (Hash)
              Node 10653 (Hash Join)
                Node 10654 (Seq Scan) - LEAF
                Node 10655 (Hash)
                  Node 10656 (Seq Scan) - LEAF
          Node 10657 (Index Scan) - LEAF
        Node 10658 (Hash)
          Node 10659 (Hash Join)
            Node 10660 (Seq Scan) - LEAF
            Node 10661 (Hash)
              Node 10662 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 10645 | Aggregate | 1239.59 | 1209.26 | 2.4% | operator |
| 10646 | Gather Merge | 1238.55 | 1142.98 | 7.7% | operator |
| 10647 | Sort | 1233.03 | 1109.13 | 10.0% | operator |
| 10648 | Hash Join | 1232.42 | 842.59 | 31.6% | operator |
| 10649 | Nested Loop | 1225.62 | 1216.16 | 0.8% | operator |
| 10658 | Hash | 3.06 | 17.53 | 472.7% | operator |
| 10650 | Hash Join | 216.04 | 384.47 | 78.0% | operator |
| 10657 | Index Scan | 0.03 | 0.96 | 2731.9% | operator |
| 10659 | Hash Join | 3.01 | 85.17 | 2726.0% | operator |
| 10651 | Seq Scan | 154.46 | 201.16 | 30.2% | operator |
| 10652 | Hash | 36.65 | 19.59 | 46.5% | operator |
| 10660 | Seq Scan | 2.67 | 11.47 | 329.3% | operator |
| 10661 | Hash | 0.01 | 16.89 | 129854.5% | operator |
| 10653 | Hash Join | 36.21 | 92.20 | 154.6% | operator |
| 10662 | Seq Scan | 0.01 | 45.79 | 457823.2% | operator |
| 10654 | Seq Scan | 35.07 | 21.86 | 37.7% | operator |
| 10655 | Hash | 0.01 | 16.89 | 120572.0% | operator |
| 10656 | Seq Scan | 0.01 | 45.79 | 508703.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10656 (Seq Scan) - LEAF
...
### Step 2: Node 10654 (Seq Scan) - LEAF
...
### Step 5: Node 10662 (Seq Scan) - LEAF
...
### Step 6: Node 10651 (Seq Scan) - LEAF
...
### Step 8: Node 10660 (Seq Scan) - LEAF
...
### Step 11: Node 10657 (Index Scan) - LEAF
...
### Step 13: Node 10649 (Nested Loop)
...
### Step 17: Node 10646 (Gather Merge)
...
### Step 18: Node 10645 (Aggregate) - ROOT
