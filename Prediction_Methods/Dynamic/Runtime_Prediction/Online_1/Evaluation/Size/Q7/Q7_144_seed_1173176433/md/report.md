...
```
Node 11365 (Aggregate) - ROOT
  Node 11366 (Gather Merge)
    Node 11367 (Sort)
      Node 11368 (Hash Join)
        Node 11369 (Nested Loop)
          Node 11370 (Hash Join)
            Node 11371 (Seq Scan) - LEAF
            Node 11372 (Hash)
              Node 11373 (Hash Join)
                Node 11374 (Seq Scan) - LEAF
                Node 11375 (Hash)
                  Node 11376 (Seq Scan) - LEAF
          Node 11377 (Index Scan) - LEAF
        Node 11378 (Hash)
          Node 11379 (Hash Join)
            Node 11380 (Seq Scan) - LEAF
            Node 11381 (Hash)
              Node 11382 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 11365 | Aggregate | 1195.43 | 1209.26 | 1.2% | operator |
| 11366 | Gather Merge | 1194.20 | 1142.98 | 4.3% | operator |
| 11367 | Sort | 1188.75 | 1109.13 | 6.7% | operator |
| 11368 | Hash Join | 1188.09 | 842.59 | 29.1% | operator |
| 11369 | Nested Loop | 1180.74 | 1216.16 | 3.0% | operator |
| 11378 | Hash | 3.23 | 17.53 | 442.2% | operator |
| 11370 | Hash Join | 207.77 | 384.47 | 85.0% | operator |
| 11377 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 11379 | Hash Join | 3.19 | 85.17 | 2571.7% | operator |
| 11371 | Seq Scan | 147.29 | 201.16 | 36.6% | operator |
| 11372 | Hash | 34.15 | 19.59 | 42.6% | operator |
| 11380 | Seq Scan | 2.84 | 11.47 | 303.3% | operator |
| 11381 | Hash | 0.02 | 16.89 | 99277.0% | operator |
| 11373 | Hash Join | 33.74 | 92.20 | 173.2% | operator |
| 11382 | Seq Scan | 0.01 | 45.79 | 326988.0% | operator |
| 11374 | Seq Scan | 32.60 | 21.86 | 33.0% | operator |
| 11375 | Hash | 0.01 | 16.89 | 168840.8% | operator |
| 11376 | Seq Scan | 0.01 | 45.79 | 572303.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11376 (Seq Scan) - LEAF
...
### Step 2: Node 11374 (Seq Scan) - LEAF
...
### Step 5: Node 11382 (Seq Scan) - LEAF
...
### Step 6: Node 11371 (Seq Scan) - LEAF
...
### Step 8: Node 11380 (Seq Scan) - LEAF
...
### Step 11: Node 11377 (Index Scan) - LEAF
...
### Step 13: Node 11369 (Nested Loop)
...
### Step 17: Node 11366 (Gather Merge)
...
### Step 18: Node 11365 (Aggregate) - ROOT
