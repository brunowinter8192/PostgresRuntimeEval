...
```
Node 11689 (Aggregate) - ROOT
  Node 11690 (Gather Merge)
    Node 11691 (Sort)
      Node 11692 (Hash Join)
        Node 11693 (Nested Loop)
          Node 11694 (Hash Join)
            Node 11695 (Seq Scan) - LEAF
            Node 11696 (Hash)
              Node 11697 (Hash Join)
                Node 11698 (Seq Scan) - LEAF
                Node 11699 (Hash)
                  Node 11700 (Seq Scan) - LEAF
          Node 11701 (Index Scan) - LEAF
        Node 11702 (Hash)
          Node 11703 (Hash Join)
            Node 11704 (Seq Scan) - LEAF
            Node 11705 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 11689 | Aggregate | 1193.41 | 1209.26 | 1.3% | operator |
| 11690 | Gather Merge | 1192.18 | 1142.98 | 4.1% | operator |
| 11691 | Sort | 1186.48 | 1109.13 | 6.5% | operator |
| 11692 | Hash Join | 1185.81 | 842.59 | 28.9% | operator |
| 11693 | Nested Loop | 1177.93 | 1216.16 | 3.2% | operator |
| 11702 | Hash | 3.63 | 17.53 | 382.7% | operator |
| 11694 | Hash Join | 213.62 | 384.47 | 80.0% | operator |
| 11701 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 11703 | Hash Join | 3.57 | 85.17 | 2287.8% | operator |
| 11695 | Seq Scan | 152.31 | 201.16 | 32.1% | operator |
| 11696 | Hash | 35.41 | 19.59 | 44.7% | operator |
| 11704 | Seq Scan | 3.14 | 11.47 | 265.4% | operator |
| 11705 | Hash | 0.02 | 16.89 | 93756.0% | operator |
| 11697 | Hash Join | 34.45 | 92.20 | 167.7% | operator |
| 11706 | Seq Scan | 0.01 | 45.79 | 305182.1% | operator |
| 11698 | Seq Scan | 33.10 | 21.86 | 34.0% | operator |
| 11699 | Hash | 0.01 | 16.89 | 129854.5% | operator |
| 11700 | Seq Scan | 0.01 | 45.79 | 416193.8% | operator |
...
### Step 2: Node 11698 (Seq Scan) - LEAF
...
### Step 5: Node 11706 (Seq Scan) - LEAF
...
### Step 6: Node 11695 (Seq Scan) - LEAF
...
### Step 8: Node 11704 (Seq Scan) - LEAF
...
### Step 11: Node 11701 (Index Scan) - LEAF
...
### Step 13: Node 11693 (Nested Loop)
...
### Step 17: Node 11690 (Gather Merge)
...
### Step 18: Node 11689 (Aggregate) - ROOT
