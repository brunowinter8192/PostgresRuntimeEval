...
```
Node 12949 (Aggregate) - ROOT
  Node 12950 (Gather Merge)
    Node 12951 (Sort)
      Node 12952 (Hash Join)
        Node 12953 (Nested Loop)
          Node 12954 (Hash Join)
            Node 12955 (Seq Scan) - LEAF
            Node 12956 (Hash)
              Node 12957 (Hash Join)
                Node 12958 (Seq Scan) - LEAF
                Node 12959 (Hash)
                  Node 12960 (Seq Scan) - LEAF
          Node 12961 (Index Scan) - LEAF
        Node 12962 (Hash)
          Node 12963 (Hash Join)
            Node 12964 (Seq Scan) - LEAF
            Node 12965 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 12949 | Aggregate | 1199.30 | 1209.26 | 0.8% | operator |
| 12950 | Gather Merge | 1198.18 | 1142.98 | 4.6% | operator |
| 12951 | Sort | 1193.21 | 1109.13 | 7.0% | operator |
| 12952 | Hash Join | 1192.57 | 842.59 | 29.3% | operator |
| 12953 | Nested Loop | 1184.79 | 1216.16 | 2.6% | operator |
| 12962 | Hash | 3.86 | 17.53 | 353.8% | operator |
| 12954 | Hash Join | 212.26 | 384.47 | 81.1% | operator |
| 12961 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 12963 | Hash Join | 3.82 | 85.17 | 2130.3% | operator |
| 12955 | Seq Scan | 150.63 | 201.16 | 33.5% | operator |
| 12956 | Hash | 35.67 | 19.59 | 45.1% | operator |
| 12964 | Seq Scan | 3.49 | 11.47 | 228.3% | operator |
| 12965 | Hash | 0.02 | 16.89 | 88816.2% | operator |
| 12957 | Hash Join | 35.34 | 92.20 | 160.9% | operator |
| 12966 | Seq Scan | 0.01 | 45.79 | 326988.0% | operator |
| 12958 | Seq Scan | 34.22 | 21.86 | 36.1% | operator |
| 12959 | Hash | 0.01 | 16.89 | 168840.8% | operator |
| 12960 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |
...
### Step 2: Node 12958 (Seq Scan) - LEAF
...
### Step 5: Node 12966 (Seq Scan) - LEAF
...
### Step 6: Node 12955 (Seq Scan) - LEAF
...
### Step 8: Node 12964 (Seq Scan) - LEAF
...
### Step 11: Node 12961 (Index Scan) - LEAF
...
### Step 13: Node 12953 (Nested Loop)
...
### Step 17: Node 12950 (Gather Merge)
...
### Step 18: Node 12949 (Aggregate) - ROOT
