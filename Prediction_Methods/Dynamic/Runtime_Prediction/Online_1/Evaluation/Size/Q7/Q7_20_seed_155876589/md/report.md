...
```
Node 11617 (Aggregate) - ROOT
  Node 11618 (Gather Merge)
    Node 11619 (Sort)
      Node 11620 (Hash Join)
        Node 11621 (Nested Loop)
          Node 11622 (Hash Join)
            Node 11623 (Seq Scan) - LEAF
            Node 11624 (Hash)
              Node 11625 (Hash Join)
                Node 11626 (Seq Scan) - LEAF
                Node 11627 (Hash)
                  Node 11628 (Seq Scan) - LEAF
          Node 11629 (Index Scan) - LEAF
        Node 11630 (Hash)
          Node 11631 (Hash Join)
            Node 11632 (Seq Scan) - LEAF
            Node 11633 (Hash)
              Node 11634 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 11617 | Aggregate | 1216.34 | 1209.26 | 0.6% | operator |
| 11618 | Gather Merge | 1215.24 | 1142.98 | 5.9% | operator |
| 11619 | Sort | 1208.61 | 1109.13 | 8.2% | operator |
| 11620 | Hash Join | 1207.95 | 842.59 | 30.2% | operator |
| 11621 | Nested Loop | 1200.81 | 1216.16 | 1.3% | operator |
| 11630 | Hash | 3.29 | 17.53 | 432.3% | operator |
| 11622 | Hash Join | 213.71 | 384.47 | 79.9% | operator |
| 11629 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 11631 | Hash Join | 3.24 | 85.17 | 2527.2% | operator |
| 11623 | Seq Scan | 154.05 | 201.16 | 30.6% | operator |
| 11624 | Hash | 33.97 | 19.59 | 42.3% | operator |
| 11632 | Seq Scan | 2.90 | 11.47 | 295.3% | operator |
| 11633 | Hash | 0.01 | 16.89 | 129854.5% | operator |
| 11625 | Hash Join | 33.68 | 92.20 | 173.8% | operator |
| 11634 | Seq Scan | 0.01 | 45.79 | 457823.2% | operator |
| 11626 | Seq Scan | 32.54 | 21.86 | 32.8% | operator |
| 11627 | Hash | 0.01 | 16.89 | 168840.8% | operator |
| 11628 | Seq Scan | 0.01 | 45.79 | 572303.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11628 (Seq Scan) - LEAF
...
### Step 2: Node 11626 (Seq Scan) - LEAF
...
### Step 5: Node 11634 (Seq Scan) - LEAF
...
### Step 6: Node 11623 (Seq Scan) - LEAF
...
### Step 8: Node 11632 (Seq Scan) - LEAF
...
### Step 11: Node 11629 (Index Scan) - LEAF
...
### Step 13: Node 11621 (Nested Loop)
...
### Step 17: Node 11618 (Gather Merge)
...
### Step 18: Node 11617 (Aggregate) - ROOT
