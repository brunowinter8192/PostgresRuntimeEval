...
```
Node 10789 (Aggregate) - ROOT
  Node 10790 (Gather Merge)
    Node 10791 (Sort)
      Node 10792 (Hash Join)
        Node 10793 (Nested Loop)
          Node 10794 (Hash Join)
            Node 10795 (Seq Scan) - LEAF
            Node 10796 (Hash)
              Node 10797 (Hash Join)
                Node 10798 (Seq Scan) - LEAF
                Node 10799 (Hash)
                  Node 10800 (Seq Scan) - LEAF
          Node 10801 (Index Scan) - LEAF
        Node 10802 (Hash)
          Node 10803 (Hash Join)
            Node 10804 (Seq Scan) - LEAF
            Node 10805 (Hash)
              Node 10806 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 10789 | Aggregate | 1198.13 | 1209.26 | 0.9% | operator |
| 10790 | Gather Merge | 1197.03 | 1142.98 | 4.5% | operator |
| 10791 | Sort | 1191.21 | 1109.13 | 6.9% | operator |
| 10792 | Hash Join | 1190.58 | 842.59 | 29.2% | operator |
| 10793 | Nested Loop | 1181.95 | 1216.16 | 2.9% | operator |
| 10802 | Hash | 4.82 | 17.53 | 263.8% | operator |
| 10794 | Hash Join | 213.55 | 384.47 | 80.0% | operator |
| 10801 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 10803 | Hash Join | 4.77 | 85.17 | 1685.6% | operator |
| 10795 | Seq Scan | 152.85 | 201.16 | 31.6% | operator |
| 10796 | Hash | 34.61 | 19.59 | 43.4% | operator |
| 10804 | Seq Scan | 4.42 | 11.47 | 159.6% | operator |
| 10805 | Hash | 0.01 | 16.89 | 112527.2% | operator |
| 10797 | Hash Join | 34.37 | 92.20 | 168.3% | operator |
| 10806 | Seq Scan | 0.01 | 45.79 | 416193.8% | operator |
| 10798 | Seq Scan | 33.19 | 21.86 | 34.1% | operator |
| 10799 | Hash | 0.01 | 16.89 | 187612.0% | operator |
| 10800 | Seq Scan | 0.01 | 45.79 | 763105.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10800 (Seq Scan) - LEAF
...
### Step 2: Node 10798 (Seq Scan) - LEAF
...
### Step 5: Node 10806 (Seq Scan) - LEAF
...
### Step 6: Node 10795 (Seq Scan) - LEAF
...
### Step 8: Node 10804 (Seq Scan) - LEAF
...
### Step 11: Node 10801 (Index Scan) - LEAF
...
### Step 13: Node 10793 (Nested Loop)
...
### Step 17: Node 10790 (Gather Merge)
...
### Step 18: Node 10789 (Aggregate) - ROOT
