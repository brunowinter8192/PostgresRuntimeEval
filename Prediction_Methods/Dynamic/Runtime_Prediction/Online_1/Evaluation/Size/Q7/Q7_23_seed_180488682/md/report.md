...
```
Node 11671 (Aggregate) - ROOT
  Node 11672 (Gather Merge)
    Node 11673 (Sort)
      Node 11674 (Hash Join)
        Node 11675 (Nested Loop)
          Node 11676 (Hash Join)
            Node 11677 (Seq Scan) - LEAF
            Node 11678 (Hash)
              Node 11679 (Hash Join)
                Node 11680 (Seq Scan) - LEAF
                Node 11681 (Hash)
                  Node 11682 (Seq Scan) - LEAF
          Node 11683 (Index Scan) - LEAF
        Node 11684 (Hash)
          Node 11685 (Hash Join)
            Node 11686 (Seq Scan) - LEAF
            Node 11687 (Hash)
              Node 11688 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 11671 | Aggregate | 1172.24 | 1209.26 | 3.2% | operator |
| 11672 | Gather Merge | 1171.10 | 1142.98 | 2.4% | operator |
| 11673 | Sort | 1165.32 | 1109.13 | 4.8% | operator |
| 11674 | Hash Join | 1164.69 | 842.59 | 27.7% | operator |
| 11675 | Nested Loop | 1156.69 | 1216.16 | 5.1% | operator |
| 11684 | Hash | 4.01 | 17.53 | 337.5% | operator |
| 11676 | Hash Join | 211.28 | 384.47 | 82.0% | operator |
| 11683 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 11685 | Hash Join | 3.96 | 85.17 | 2049.2% | operator |
| 11677 | Seq Scan | 151.02 | 201.16 | 33.2% | operator |
| 11678 | Hash | 34.99 | 19.59 | 44.0% | operator |
| 11686 | Seq Scan | 3.63 | 11.47 | 215.6% | operator |
| 11687 | Hash | 0.02 | 16.89 | 105488.0% | operator |
| 11679 | Hash Join | 34.45 | 92.20 | 167.6% | operator |
| 11688 | Seq Scan | 0.01 | 45.79 | 381502.6% | operator |
| 11680 | Seq Scan | 33.30 | 21.86 | 34.4% | operator |
| 11681 | Hash | 0.01 | 16.89 | 187612.0% | operator |
| 11682 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11682 (Seq Scan) - LEAF
...
### Step 2: Node 11680 (Seq Scan) - LEAF
...
### Step 5: Node 11688 (Seq Scan) - LEAF
...
### Step 6: Node 11677 (Seq Scan) - LEAF
...
### Step 8: Node 11686 (Seq Scan) - LEAF
...
### Step 11: Node 11683 (Index Scan) - LEAF
...
### Step 13: Node 11675 (Nested Loop)
...
### Step 17: Node 11672 (Gather Merge)
...
### Step 18: Node 11671 (Aggregate) - ROOT
