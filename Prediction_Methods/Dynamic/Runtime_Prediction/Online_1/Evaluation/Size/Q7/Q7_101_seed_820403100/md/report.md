...
```
Node 10519 (Aggregate) - ROOT
  Node 10520 (Gather Merge)
    Node 10521 (Sort)
      Node 10522 (Hash Join)
        Node 10523 (Nested Loop)
          Node 10524 (Hash Join)
            Node 10525 (Seq Scan) - LEAF
            Node 10526 (Hash)
              Node 10527 (Hash Join)
                Node 10528 (Seq Scan) - LEAF
                Node 10529 (Hash)
                  Node 10530 (Seq Scan) - LEAF
          Node 10531 (Index Scan) - LEAF
        Node 10532 (Hash)
          Node 10533 (Hash Join)
            Node 10534 (Seq Scan) - LEAF
            Node 10535 (Hash)
              Node 10536 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 10519 | Aggregate | 1208.67 | 1209.26 | 0.0% | operator |
| 10520 | Gather Merge | 1207.47 | 1142.98 | 5.3% | operator |
| 10521 | Sort | 1201.04 | 1109.13 | 7.7% | operator |
| 10522 | Hash Join | 1200.39 | 842.59 | 29.8% | operator |
| 10523 | Nested Loop | 1191.05 | 1216.16 | 2.1% | operator |
| 10532 | Hash | 5.33 | 17.53 | 229.1% | operator |
| 10524 | Hash Join | 211.72 | 384.47 | 81.6% | operator |
| 10531 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 10533 | Hash Join | 5.29 | 85.17 | 1511.3% | operator |
| 10525 | Seq Scan | 150.19 | 201.16 | 33.9% | operator |
| 10526 | Hash | 34.82 | 19.59 | 43.7% | operator |
| 10534 | Seq Scan | 4.98 | 11.47 | 130.4% | operator |
| 10535 | Hash | 0.01 | 16.89 | 112527.2% | operator |
| 10527 | Hash Join | 31.97 | 92.20 | 188.4% | operator |
| 10536 | Seq Scan | 0.01 | 45.79 | 381502.6% | operator |
| 10528 | Seq Scan | 30.87 | 21.86 | 29.2% | operator |
| 10529 | Hash | 0.01 | 16.89 | 168840.8% | operator |
| 10530 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10530 (Seq Scan) - LEAF
...
### Step 2: Node 10528 (Seq Scan) - LEAF
...
### Step 5: Node 10536 (Seq Scan) - LEAF
...
### Step 6: Node 10525 (Seq Scan) - LEAF
...
### Step 8: Node 10534 (Seq Scan) - LEAF
...
### Step 11: Node 10531 (Index Scan) - LEAF
...
### Step 13: Node 10523 (Nested Loop)
...
### Step 17: Node 10520 (Gather Merge)
...
### Step 18: Node 10519 (Aggregate) - ROOT
