...
```
Node 12697 (Aggregate) - ROOT
  Node 12698 (Gather Merge)
    Node 12699 (Sort)
      Node 12700 (Hash Join)
        Node 12701 (Nested Loop)
          Node 12702 (Hash Join)
            Node 12703 (Seq Scan) - LEAF
            Node 12704 (Hash)
              Node 12705 (Hash Join)
                Node 12706 (Seq Scan) - LEAF
                Node 12707 (Hash)
                  Node 12708 (Seq Scan) - LEAF
          Node 12709 (Index Scan) - LEAF
        Node 12710 (Hash)
          Node 12711 (Hash Join)
            Node 12712 (Seq Scan) - LEAF
            Node 12713 (Hash)
              Node 12714 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12697 | Aggregate | 1195.86 | 1209.26 | 1.1% | operator |
| 12698 | Gather Merge | 1194.81 | 1142.98 | 4.3% | operator |
| 12699 | Sort | 1189.21 | 1109.13 | 6.7% | operator |
| 12700 | Hash Join | 1188.58 | 842.59 | 29.1% | operator |
| 12701 | Nested Loop | 1181.82 | 1216.16 | 2.9% | operator |
| 12710 | Hash | 2.96 | 17.53 | 492.0% | operator |
| 12702 | Hash Join | 211.25 | 384.47 | 82.0% | operator |
| 12709 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 12711 | Hash Join | 2.92 | 85.17 | 2820.9% | operator |
| 12703 | Seq Scan | 148.95 | 201.16 | 35.1% | operator |
| 12704 | Hash | 37.48 | 19.59 | 47.7% | operator |
| 12712 | Seq Scan | 2.59 | 11.47 | 343.4% | operator |
| 12713 | Hash | 0.01 | 16.89 | 129854.5% | operator |
| 12705 | Hash Join | 37.18 | 92.20 | 148.0% | operator |
| 12714 | Seq Scan | 0.01 | 45.79 | 457823.2% | operator |
| 12706 | Seq Scan | 36.06 | 21.86 | 39.4% | operator |
| 12707 | Hash | 0.01 | 16.89 | 168840.8% | operator |
| 12708 | Seq Scan | 0.01 | 45.79 | 572303.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12708 (Seq Scan) - LEAF
...
### Step 2: Node 12706 (Seq Scan) - LEAF
...
### Step 5: Node 12714 (Seq Scan) - LEAF
...
### Step 6: Node 12703 (Seq Scan) - LEAF
...
### Step 8: Node 12712 (Seq Scan) - LEAF
...
### Step 11: Node 12709 (Index Scan) - LEAF
...
### Step 13: Node 12701 (Nested Loop)
...
### Step 17: Node 12698 (Gather Merge)
...
### Step 18: Node 12697 (Aggregate) - ROOT
