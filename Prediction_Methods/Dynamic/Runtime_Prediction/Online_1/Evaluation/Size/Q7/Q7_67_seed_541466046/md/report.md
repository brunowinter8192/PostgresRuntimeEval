...
```
Node 12535 (Aggregate) - ROOT
  Node 12536 (Gather Merge)
    Node 12537 (Sort)
      Node 12538 (Hash Join)
        Node 12539 (Nested Loop)
          Node 12540 (Hash Join)
            Node 12541 (Seq Scan) - LEAF
            Node 12542 (Hash)
              Node 12543 (Hash Join)
                Node 12544 (Seq Scan) - LEAF
                Node 12545 (Hash)
                  Node 12546 (Seq Scan) - LEAF
          Node 12547 (Index Scan) - LEAF
        Node 12548 (Hash)
          Node 12549 (Hash Join)
            Node 12550 (Seq Scan) - LEAF
            Node 12551 (Hash)
              Node 12552 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12535 | Aggregate | 1194.57 | 1209.26 | 1.2% | operator |
| 12536 | Gather Merge | 1193.46 | 1142.98 | 4.2% | operator |
| 12537 | Sort | 1185.03 | 1109.13 | 6.4% | operator |
| 12538 | Hash Join | 1184.38 | 842.59 | 28.9% | operator |
| 12539 | Nested Loop | 1177.63 | 1216.16 | 3.3% | operator |
| 12548 | Hash | 2.94 | 17.53 | 495.9% | operator |
| 12540 | Hash Join | 210.52 | 384.47 | 82.6% | operator |
| 12547 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 12549 | Hash Join | 2.89 | 85.17 | 2843.1% | operator |
| 12541 | Seq Scan | 151.78 | 201.16 | 32.5% | operator |
| 12542 | Hash | 33.01 | 19.59 | 40.6% | operator |
| 12550 | Seq Scan | 2.55 | 11.47 | 350.2% | operator |
| 12551 | Hash | 0.01 | 16.89 | 129854.5% | operator |
| 12543 | Hash Join | 32.71 | 92.20 | 181.8% | operator |
| 12552 | Seq Scan | 0.01 | 45.79 | 457823.2% | operator |
| 12544 | Seq Scan | 31.61 | 21.86 | 30.9% | operator |
| 12545 | Hash | 0.01 | 16.89 | 168840.8% | operator |
| 12546 | Seq Scan | 0.01 | 45.79 | 763105.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12546 (Seq Scan) - LEAF
...
### Step 2: Node 12544 (Seq Scan) - LEAF
...
### Step 5: Node 12552 (Seq Scan) - LEAF
...
### Step 6: Node 12541 (Seq Scan) - LEAF
...
### Step 8: Node 12550 (Seq Scan) - LEAF
...
### Step 11: Node 12547 (Index Scan) - LEAF
...
### Step 13: Node 12539 (Nested Loop)
...
### Step 17: Node 12536 (Gather Merge)
...
### Step 18: Node 12535 (Aggregate) - ROOT
