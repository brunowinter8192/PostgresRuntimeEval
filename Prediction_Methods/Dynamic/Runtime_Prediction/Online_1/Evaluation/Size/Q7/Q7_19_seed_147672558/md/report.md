...
```
Node 11581 (Aggregate) - ROOT
  Node 11582 (Gather Merge)
    Node 11583 (Sort)
      Node 11584 (Hash Join)
        Node 11585 (Nested Loop)
          Node 11586 (Hash Join)
            Node 11587 (Seq Scan) - LEAF
            Node 11588 (Hash)
              Node 11589 (Hash Join)
                Node 11590 (Seq Scan) - LEAF
                Node 11591 (Hash)
                  Node 11592 (Seq Scan) - LEAF
          Node 11593 (Index Scan) - LEAF
        Node 11594 (Hash)
          Node 11595 (Hash Join)
            Node 11596 (Seq Scan) - LEAF
            Node 11597 (Hash)
              Node 11598 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 11581 | Aggregate | 1175.27 | 1209.26 | 2.9% | operator |
| 11582 | Gather Merge | 1173.99 | 1142.98 | 2.6% | operator |
| 11583 | Sort | 1168.14 | 1109.13 | 5.1% | operator |
| 11584 | Hash Join | 1167.49 | 842.59 | 27.8% | operator |
| 11585 | Nested Loop | 1160.25 | 1216.16 | 4.8% | operator |
| 11594 | Hash | 3.38 | 17.53 | 418.8% | operator |
| 11586 | Hash Join | 211.05 | 384.47 | 82.2% | operator |
| 11593 | Index Scan | 0.03 | 0.96 | 3006.0% | operator |
| 11595 | Hash Join | 3.33 | 85.17 | 2454.0% | operator |
| 11587 | Seq Scan | 148.34 | 201.16 | 35.6% | operator |
| 11588 | Hash | 36.55 | 19.59 | 46.4% | operator |
| 11596 | Seq Scan | 3.00 | 11.47 | 283.0% | operator |
| 11597 | Hash | 0.01 | 16.89 | 112527.2% | operator |
| 11589 | Hash Join | 36.17 | 92.20 | 154.9% | operator |
| 11598 | Seq Scan | 0.01 | 45.79 | 416193.8% | operator |
| 11590 | Seq Scan | 35.06 | 21.86 | 37.7% | operator |
| 11591 | Hash | 0.01 | 16.89 | 187612.0% | operator |
| 11592 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11592 (Seq Scan) - LEAF
...
### Step 2: Node 11590 (Seq Scan) - LEAF
...
### Step 5: Node 11598 (Seq Scan) - LEAF
...
### Step 6: Node 11587 (Seq Scan) - LEAF
...
### Step 8: Node 11596 (Seq Scan) - LEAF
...
### Step 11: Node 11593 (Index Scan) - LEAF
...
### Step 13: Node 11585 (Nested Loop)
...
### Step 17: Node 11582 (Gather Merge)
...
### Step 18: Node 11581 (Aggregate) - ROOT
