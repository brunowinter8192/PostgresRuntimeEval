...
```
Node 12913 (Aggregate) - ROOT
  Node 12914 (Gather Merge)
    Node 12915 (Sort)
      Node 12916 (Hash Join)
        Node 12917 (Nested Loop)
          Node 12918 (Hash Join)
            Node 12919 (Seq Scan) - LEAF
            Node 12920 (Hash)
              Node 12921 (Hash Join)
                Node 12922 (Seq Scan) - LEAF
                Node 12923 (Hash)
                  Node 12924 (Seq Scan) - LEAF
          Node 12925 (Index Scan) - LEAF
        Node 12926 (Hash)
          Node 12927 (Hash Join)
            Node 12928 (Seq Scan) - LEAF
            Node 12929 (Hash)
              Node 12930 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12913 | Aggregate | 1206.97 | 1209.26 | 0.2% | operator |
| 12914 | Gather Merge | 1205.99 | 1142.98 | 5.2% | operator |
| 12915 | Sort | 1199.22 | 1109.13 | 7.5% | operator |
| 12916 | Hash Join | 1198.62 | 842.59 | 29.7% | operator |
| 12917 | Nested Loop | 1191.94 | 1216.16 | 2.0% | operator |
| 12926 | Hash | 2.97 | 17.53 | 489.6% | operator |
| 12918 | Hash Join | 212.64 | 384.47 | 80.8% | operator |
| 12925 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 12927 | Hash Join | 2.92 | 85.17 | 2815.9% | operator |
| 12919 | Seq Scan | 150.09 | 201.16 | 34.0% | operator |
| 12920 | Hash | 37.06 | 19.59 | 47.1% | operator |
| 12928 | Seq Scan | 2.58 | 11.47 | 344.6% | operator |
| 12929 | Hash | 0.02 | 16.89 | 99277.0% | operator |
| 12921 | Hash Join | 36.73 | 92.20 | 151.0% | operator |
| 12930 | Seq Scan | 0.01 | 45.79 | 326988.0% | operator |
| 12922 | Seq Scan | 35.63 | 21.86 | 38.7% | operator |
| 12923 | Hash | 0.01 | 16.89 | 168840.8% | operator |
| 12924 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12924 (Seq Scan) - LEAF
...
### Step 2: Node 12922 (Seq Scan) - LEAF
...
### Step 5: Node 12930 (Seq Scan) - LEAF
...
### Step 6: Node 12919 (Seq Scan) - LEAF
...
### Step 8: Node 12928 (Seq Scan) - LEAF
...
### Step 11: Node 12925 (Index Scan) - LEAF
...
### Step 13: Node 12917 (Nested Loop)
...
### Step 17: Node 12914 (Gather Merge)
...
### Step 18: Node 12913 (Aggregate) - ROOT
