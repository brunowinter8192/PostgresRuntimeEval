...
```
Node 11473 (Aggregate) - ROOT
  Node 11474 (Gather Merge)
    Node 11475 (Sort)
      Node 11476 (Hash Join)
        Node 11477 (Nested Loop)
          Node 11478 (Hash Join)
            Node 11479 (Seq Scan) - LEAF
            Node 11480 (Hash)
              Node 11481 (Hash Join)
                Node 11482 (Seq Scan) - LEAF
                Node 11483 (Hash)
                  Node 11484 (Seq Scan) - LEAF
          Node 11485 (Index Scan) - LEAF
        Node 11486 (Hash)
          Node 11487 (Hash Join)
            Node 11488 (Seq Scan) - LEAF
            Node 11489 (Hash)
              Node 11490 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 11473 | Aggregate | 1193.52 | 1209.26 | 1.3% | operator |
| 11474 | Gather Merge | 1192.51 | 1142.98 | 4.2% | operator |
| 11475 | Sort | 1185.90 | 1109.13 | 6.5% | operator |
| 11476 | Hash Join | 1185.25 | 842.59 | 28.9% | operator |
| 11477 | Nested Loop | 1178.17 | 1216.16 | 3.2% | operator |
| 11486 | Hash | 2.39 | 17.53 | 633.8% | operator |
| 11478 | Hash Join | 214.37 | 384.47 | 79.4% | operator |
| 11485 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 11487 | Hash Join | 2.34 | 85.17 | 3543.1% | operator |
| 11479 | Seq Scan | 152.04 | 201.16 | 32.3% | operator |
| 11480 | Hash | 37.20 | 19.59 | 47.3% | operator |
| 11488 | Seq Scan | 2.01 | 11.47 | 470.7% | operator |
| 11489 | Hash | 0.01 | 16.89 | 140684.0% | operator |
| 11481 | Hash Join | 36.90 | 92.20 | 149.9% | operator |
| 11490 | Seq Scan | 0.01 | 45.79 | 508703.5% | operator |
| 11482 | Seq Scan | 35.76 | 21.86 | 38.9% | operator |
| 11483 | Hash | 0.01 | 16.89 | 153482.6% | operator |
| 11484 | Seq Scan | 0.01 | 45.79 | 572303.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11484 (Seq Scan) - LEAF
...
### Step 2: Node 11482 (Seq Scan) - LEAF
...
### Step 5: Node 11490 (Seq Scan) - LEAF
...
### Step 6: Node 11479 (Seq Scan) - LEAF
...
### Step 8: Node 11488 (Seq Scan) - LEAF
...
### Step 11: Node 11485 (Index Scan) - LEAF
...
### Step 13: Node 11477 (Nested Loop)
...
### Step 17: Node 11474 (Gather Merge)
...
### Step 18: Node 11473 (Aggregate) - ROOT
