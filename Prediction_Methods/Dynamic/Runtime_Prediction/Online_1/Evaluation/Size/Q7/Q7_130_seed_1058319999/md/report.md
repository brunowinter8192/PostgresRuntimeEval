...
```
Node 11095 (Aggregate) - ROOT
  Node 11096 (Gather Merge)
    Node 11097 (Sort)
      Node 11098 (Hash Join)
        Node 11099 (Nested Loop)
          Node 11100 (Hash Join)
            Node 11101 (Seq Scan) - LEAF
            Node 11102 (Hash)
              Node 11103 (Hash Join)
                Node 11104 (Seq Scan) - LEAF
                Node 11105 (Hash)
                  Node 11106 (Seq Scan) - LEAF
          Node 11107 (Index Scan) - LEAF
        Node 11108 (Hash)
          Node 11109 (Hash Join)
            Node 11110 (Seq Scan) - LEAF
            Node 11111 (Hash)
              Node 11112 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 11095 | Aggregate | 1188.61 | 1209.26 | 1.7% | operator |
| 11096 | Gather Merge | 1187.58 | 1142.98 | 3.8% | operator |
| 11097 | Sort | 1181.80 | 1109.13 | 6.1% | operator |
| 11098 | Hash Join | 1181.16 | 842.59 | 28.7% | operator |
| 11099 | Nested Loop | 1174.44 | 1216.16 | 3.6% | operator |
| 11108 | Hash | 3.01 | 17.53 | 481.6% | operator |
| 11100 | Hash Join | 216.39 | 384.47 | 77.7% | operator |
| 11107 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 11109 | Hash Join | 2.97 | 85.17 | 2766.9% | operator |
| 11101 | Seq Scan | 152.98 | 201.16 | 31.5% | operator |
| 11102 | Hash | 37.01 | 19.59 | 47.1% | operator |
| 11110 | Seq Scan | 2.67 | 11.47 | 330.4% | operator |
| 11111 | Hash | 0.01 | 16.89 | 120572.0% | operator |
| 11103 | Hash Join | 36.65 | 92.20 | 151.6% | operator |
| 11112 | Seq Scan | 0.01 | 45.79 | 381502.6% | operator |
| 11104 | Seq Scan | 35.57 | 21.86 | 38.6% | operator |
| 11105 | Hash | 0.01 | 16.89 | 187612.0% | operator |
| 11106 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11106 (Seq Scan) - LEAF
...
### Step 2: Node 11104 (Seq Scan) - LEAF
...
### Step 5: Node 11112 (Seq Scan) - LEAF
...
### Step 6: Node 11101 (Seq Scan) - LEAF
...
### Step 8: Node 11110 (Seq Scan) - LEAF
...
### Step 11: Node 11107 (Index Scan) - LEAF
...
### Step 13: Node 11099 (Nested Loop)
...
### Step 17: Node 11096 (Gather Merge)
...
### Step 18: Node 11095 (Aggregate) - ROOT
