...
```
Node 12391 (Aggregate) - ROOT
  Node 12392 (Gather Merge)
    Node 12393 (Sort)
      Node 12394 (Hash Join)
        Node 12395 (Nested Loop)
          Node 12396 (Hash Join)
            Node 12397 (Seq Scan) - LEAF
            Node 12398 (Hash)
              Node 12399 (Hash Join)
                Node 12400 (Seq Scan) - LEAF
                Node 12401 (Hash)
                  Node 12402 (Seq Scan) - LEAF
          Node 12403 (Index Scan) - LEAF
        Node 12404 (Hash)
          Node 12405 (Hash Join)
            Node 12406 (Seq Scan) - LEAF
            Node 12407 (Hash)
              Node 12408 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12391 | Aggregate | 1221.14 | 1209.26 | 1.0% | operator |
| 12392 | Gather Merge | 1220.04 | 1142.98 | 6.3% | operator |
| 12393 | Sort | 1214.56 | 1109.13 | 8.7% | operator |
| 12394 | Hash Join | 1213.89 | 842.59 | 30.6% | operator |
| 12395 | Nested Loop | 1207.29 | 1216.16 | 0.7% | operator |
| 12404 | Hash | 2.77 | 17.53 | 531.7% | operator |
| 12396 | Hash Join | 215.68 | 384.47 | 78.3% | operator |
| 12403 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 12405 | Hash Join | 2.73 | 85.17 | 3021.1% | operator |
| 12397 | Seq Scan | 153.67 | 201.16 | 30.9% | operator |
| 12398 | Hash | 36.06 | 19.59 | 45.7% | operator |
| 12406 | Seq Scan | 2.39 | 11.47 | 379.4% | operator |
| 12407 | Hash | 0.01 | 16.89 | 120572.0% | operator |
| 12399 | Hash Join | 35.73 | 92.20 | 158.0% | operator |
| 12408 | Seq Scan | 0.01 | 45.79 | 416193.8% | operator |
| 12400 | Seq Scan | 34.62 | 21.86 | 36.9% | operator |
| 12401 | Hash | 0.01 | 16.89 | 153482.6% | operator |
| 12402 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12402 (Seq Scan) - LEAF
...
### Step 2: Node 12400 (Seq Scan) - LEAF
...
### Step 5: Node 12408 (Seq Scan) - LEAF
...
### Step 6: Node 12397 (Seq Scan) - LEAF
...
### Step 8: Node 12406 (Seq Scan) - LEAF
...
### Step 11: Node 12403 (Index Scan) - LEAF
...
### Step 13: Node 12395 (Nested Loop)
...
### Step 17: Node 12392 (Gather Merge)
...
### Step 18: Node 12391 (Aggregate) - ROOT
