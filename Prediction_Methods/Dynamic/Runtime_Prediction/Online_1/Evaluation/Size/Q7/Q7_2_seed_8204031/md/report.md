...
```
Node 11797 (Aggregate) - ROOT
  Node 11798 (Gather Merge)
    Node 11799 (Sort)
      Node 11800 (Hash Join)
        Node 11801 (Nested Loop)
          Node 11802 (Hash Join)
            Node 11803 (Seq Scan) - LEAF
            Node 11804 (Hash)
              Node 11805 (Hash Join)
                Node 11806 (Seq Scan) - LEAF
                Node 11807 (Hash)
                  Node 11808 (Seq Scan) - LEAF
          Node 11809 (Index Scan) - LEAF
        Node 11810 (Hash)
          Node 11811 (Hash Join)
            Node 11812 (Seq Scan) - LEAF
            Node 11813 (Hash)
              Node 11814 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 11797 | Aggregate | 1198.32 | 1209.26 | 0.9% | operator |
| 11798 | Gather Merge | 1197.17 | 1142.98 | 4.5% | operator |
| 11799 | Sort | 1191.05 | 1109.13 | 6.9% | operator |
| 11800 | Hash Join | 1190.41 | 842.59 | 29.2% | operator |
| 11801 | Nested Loop | 1181.24 | 1216.16 | 3.0% | operator |
| 11810 | Hash | 5.36 | 17.53 | 227.1% | operator |
| 11802 | Hash Join | 214.43 | 384.47 | 79.3% | operator |
| 11809 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 11811 | Hash Join | 5.31 | 85.17 | 1503.4% | operator |
| 11803 | Seq Scan | 151.87 | 201.16 | 32.5% | operator |
| 11804 | Hash | 36.49 | 19.59 | 46.3% | operator |
| 11812 | Seq Scan | 4.97 | 11.47 | 130.8% | operator |
| 11813 | Hash | 0.01 | 16.89 | 112527.2% | operator |
| 11805 | Hash Join | 36.11 | 92.20 | 155.3% | operator |
| 11814 | Seq Scan | 0.01 | 45.79 | 416193.8% | operator |
| 11806 | Seq Scan | 35.01 | 21.86 | 37.6% | operator |
| 11807 | Hash | 0.01 | 16.89 | 187612.0% | operator |
| 11808 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11808 (Seq Scan) - LEAF
...
### Step 2: Node 11806 (Seq Scan) - LEAF
...
### Step 5: Node 11814 (Seq Scan) - LEAF
...
### Step 6: Node 11803 (Seq Scan) - LEAF
...
### Step 8: Node 11812 (Seq Scan) - LEAF
...
### Step 11: Node 11809 (Index Scan) - LEAF
...
### Step 13: Node 11801 (Nested Loop)
...
### Step 17: Node 11798 (Gather Merge)
...
### Step 18: Node 11797 (Aggregate) - ROOT
