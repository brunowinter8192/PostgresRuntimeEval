...
```
Node 11959 (Aggregate) - ROOT
  Node 11960 (Gather Merge)
    Node 11961 (Sort)
      Node 11962 (Hash Join)
        Node 11963 (Nested Loop)
          Node 11964 (Hash Join)
            Node 11965 (Seq Scan) - LEAF
            Node 11966 (Hash)
              Node 11967 (Hash Join)
                Node 11968 (Seq Scan) - LEAF
                Node 11969 (Hash)
                  Node 11970 (Seq Scan) - LEAF
          Node 11971 (Index Scan) - LEAF
        Node 11972 (Hash)
          Node 11973 (Hash Join)
            Node 11974 (Seq Scan) - LEAF
            Node 11975 (Hash)
              Node 11976 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 11959 | Aggregate | 1213.36 | 1209.26 | 0.3% | operator |
| 11960 | Gather Merge | 1212.27 | 1142.98 | 5.7% | operator |
| 11961 | Sort | 1205.99 | 1109.13 | 8.0% | operator |
| 11962 | Hash Join | 1205.38 | 842.59 | 30.1% | operator |
| 11963 | Nested Loop | 1199.53 | 1216.16 | 1.4% | operator |
| 11972 | Hash | 1.91 | 17.53 | 819.2% | operator |
| 11964 | Hash Join | 211.81 | 384.47 | 81.5% | operator |
| 11971 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 11973 | Hash Join | 1.86 | 85.17 | 4467.0% | operator |
| 11965 | Seq Scan | 150.68 | 201.16 | 33.5% | operator |
| 11966 | Hash | 34.71 | 19.59 | 43.6% | operator |
| 11974 | Seq Scan | 1.57 | 11.47 | 630.2% | operator |
| 11975 | Hash | 0.01 | 16.89 | 120572.0% | operator |
| 11967 | Hash Join | 34.44 | 92.20 | 167.7% | operator |
| 11976 | Seq Scan | 0.01 | 45.79 | 457823.2% | operator |
| 11968 | Seq Scan | 33.33 | 21.86 | 34.4% | operator |
| 11969 | Hash | 0.01 | 16.89 | 168840.8% | operator |
| 11970 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11970 (Seq Scan) - LEAF
...
### Step 2: Node 11968 (Seq Scan) - LEAF
...
### Step 5: Node 11976 (Seq Scan) - LEAF
...
### Step 6: Node 11965 (Seq Scan) - LEAF
...
### Step 8: Node 11974 (Seq Scan) - LEAF
...
### Step 11: Node 11971 (Index Scan) - LEAF
...
### Step 13: Node 11963 (Nested Loop)
...
### Step 17: Node 11960 (Gather Merge)
...
### Step 18: Node 11959 (Aggregate) - ROOT
