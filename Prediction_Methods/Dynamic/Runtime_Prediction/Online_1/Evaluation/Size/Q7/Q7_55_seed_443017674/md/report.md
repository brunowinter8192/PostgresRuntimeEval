...
```
Node 12301 (Aggregate) - ROOT
  Node 12302 (Gather Merge)
    Node 12303 (Sort)
      Node 12304 (Hash Join)
        Node 12305 (Nested Loop)
          Node 12306 (Hash Join)
            Node 12307 (Seq Scan) - LEAF
            Node 12308 (Hash)
              Node 12309 (Hash Join)
                Node 12310 (Seq Scan) - LEAF
                Node 12311 (Hash)
                  Node 12312 (Seq Scan) - LEAF
          Node 12313 (Index Scan) - LEAF
        Node 12314 (Hash)
          Node 12315 (Hash Join)
            Node 12316 (Seq Scan) - LEAF
            Node 12317 (Hash)
              Node 12318 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12301 | Aggregate | 1239.31 | 1209.26 | 2.4% | operator |
| 12302 | Gather Merge | 1238.29 | 1142.98 | 7.7% | operator |
| 12303 | Sort | 1232.11 | 1109.13 | 10.0% | operator |
| 12304 | Hash Join | 1231.46 | 842.59 | 31.6% | operator |
| 12305 | Nested Loop | 1224.39 | 1216.16 | 0.7% | operator |
| 12314 | Hash | 3.14 | 17.53 | 457.9% | operator |
| 12306 | Hash Join | 217.39 | 384.47 | 76.9% | operator |
| 12313 | Index Scan | 0.03 | 0.96 | 2731.9% | operator |
| 12315 | Hash Join | 3.10 | 85.17 | 2649.3% | operator |
| 12307 | Seq Scan | 154.52 | 201.16 | 30.2% | operator |
| 12308 | Hash | 37.26 | 19.59 | 47.4% | operator |
| 12316 | Seq Scan | 2.78 | 11.47 | 312.5% | operator |
| 12317 | Hash | 0.01 | 16.89 | 112527.2% | operator |
| 12309 | Hash Join | 36.38 | 92.20 | 153.4% | operator |
| 12318 | Seq Scan | 0.01 | 45.79 | 416193.8% | operator |
| 12310 | Seq Scan | 35.29 | 21.86 | 38.1% | operator |
| 12311 | Hash | 0.01 | 16.89 | 168840.8% | operator |
| 12312 | Seq Scan | 0.01 | 45.79 | 763105.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12312 (Seq Scan) - LEAF
...
### Step 2: Node 12310 (Seq Scan) - LEAF
...
### Step 5: Node 12318 (Seq Scan) - LEAF
...
### Step 6: Node 12307 (Seq Scan) - LEAF
...
### Step 8: Node 12316 (Seq Scan) - LEAF
...
### Step 11: Node 12313 (Index Scan) - LEAF
...
### Step 13: Node 12305 (Nested Loop)
...
### Step 17: Node 12302 (Gather Merge)
...
### Step 18: Node 12301 (Aggregate) - ROOT
