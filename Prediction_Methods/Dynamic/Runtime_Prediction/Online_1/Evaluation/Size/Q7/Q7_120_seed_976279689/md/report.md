...
```
Node 10897 (Aggregate) - ROOT
  Node 10898 (Gather Merge)
    Node 10899 (Sort)
      Node 10900 (Hash Join)
        Node 10901 (Nested Loop)
          Node 10902 (Hash Join)
            Node 10903 (Seq Scan) - LEAF
            Node 10904 (Hash)
              Node 10905 (Hash Join)
                Node 10906 (Seq Scan) - LEAF
                Node 10907 (Hash)
                  Node 10908 (Seq Scan) - LEAF
          Node 10909 (Index Scan) - LEAF
        Node 10910 (Hash)
          Node 10911 (Hash Join)
            Node 10912 (Seq Scan) - LEAF
            Node 10913 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 10897 | Aggregate | 1184.65 | 1209.26 | 2.1% | operator |
| 10898 | Gather Merge | 1183.62 | 1142.98 | 3.4% | operator |
| 10899 | Sort | 1177.49 | 1109.13 | 5.8% | operator |
| 10900 | Hash Join | 1176.85 | 842.59 | 28.4% | operator |
| 10901 | Nested Loop | 1170.37 | 1216.16 | 3.9% | operator |
| 10910 | Hash | 2.61 | 17.53 | 572.4% | operator |
| 10902 | Hash Join | 214.63 | 384.47 | 79.1% | operator |
| 10909 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 10911 | Hash Join | 2.56 | 85.17 | 3228.4% | operator |
| 10903 | Seq Scan | 150.58 | 201.16 | 33.6% | operator |
| 10904 | Hash | 38.29 | 19.59 | 48.8% | operator |
| 10912 | Seq Scan | 2.21 | 11.47 | 417.9% | operator |
| 10913 | Hash | 0.01 | 16.89 | 129854.5% | operator |
| 10905 | Hash Join | 37.94 | 92.20 | 143.0% | operator |
| 10914 | Seq Scan | 0.01 | 45.79 | 457823.2% | operator |
| 10906 | Seq Scan | 36.81 | 21.86 | 40.6% | operator |
| 10907 | Hash | 0.01 | 16.89 | 187612.0% | operator |
| 10908 | Seq Scan | 0.01 | 45.79 | 763105.3% | operator |
...
### Step 2: Node 10906 (Seq Scan) - LEAF
...
### Step 5: Node 10914 (Seq Scan) - LEAF
...
### Step 6: Node 10903 (Seq Scan) - LEAF
...
### Step 8: Node 10912 (Seq Scan) - LEAF
...
### Step 11: Node 10909 (Index Scan) - LEAF
...
### Step 13: Node 10901 (Nested Loop)
...
### Step 17: Node 10898 (Gather Merge)
...
### Step 18: Node 10897 (Aggregate) - ROOT
