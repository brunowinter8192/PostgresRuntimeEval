...
```
Node 10699 (Aggregate) - ROOT
  Node 10700 (Gather Merge)
    Node 10701 (Sort)
      Node 10702 (Hash Join)
        Node 10703 (Nested Loop)
          Node 10704 (Hash Join)
            Node 10705 (Seq Scan) - LEAF
            Node 10706 (Hash)
              Node 10707 (Hash Join)
                Node 10708 (Seq Scan) - LEAF
                Node 10709 (Hash)
                  Node 10710 (Seq Scan) - LEAF
          Node 10711 (Index Scan) - LEAF
        Node 10712 (Hash)
          Node 10713 (Hash Join)
            Node 10714 (Seq Scan) - LEAF
            Node 10715 (Hash)
              Node 10716 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 10699 | Aggregate | 1218.75 | 1209.26 | 0.8% | operator |
| 10700 | Gather Merge | 1217.76 | 1142.98 | 6.1% | operator |
| 10701 | Sort | 1212.23 | 1109.13 | 8.5% | operator |
| 10702 | Hash Join | 1211.59 | 842.59 | 30.5% | operator |
| 10703 | Nested Loop | 1204.72 | 1216.16 | 0.9% | operator |
| 10712 | Hash | 3.12 | 17.53 | 462.6% | operator |
| 10704 | Hash Join | 217.47 | 384.47 | 76.8% | operator |
| 10711 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 10713 | Hash Join | 3.07 | 85.17 | 2673.5% | operator |
| 10705 | Seq Scan | 154.48 | 201.16 | 30.2% | operator |
| 10706 | Hash | 37.46 | 19.59 | 47.7% | operator |
| 10714 | Seq Scan | 2.77 | 11.47 | 313.5% | operator |
| 10715 | Hash | 0.01 | 16.89 | 120572.0% | operator |
| 10707 | Hash Join | 37.18 | 92.20 | 148.0% | operator |
| 10716 | Seq Scan | 0.01 | 45.79 | 457823.2% | operator |
| 10708 | Seq Scan | 36.08 | 21.86 | 39.4% | operator |
| 10709 | Hash | 0.01 | 16.89 | 168840.8% | operator |
| 10710 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10710 (Seq Scan) - LEAF
...
### Step 2: Node 10708 (Seq Scan) - LEAF
...
### Step 5: Node 10716 (Seq Scan) - LEAF
...
### Step 6: Node 10705 (Seq Scan) - LEAF
...
### Step 8: Node 10714 (Seq Scan) - LEAF
...
### Step 11: Node 10711 (Index Scan) - LEAF
...
### Step 13: Node 10703 (Nested Loop)
...
### Step 17: Node 10700 (Gather Merge)
...
### Step 18: Node 10699 (Aggregate) - ROOT
