...
```
Node 11635 (Aggregate) - ROOT
  Node 11636 (Gather Merge)
    Node 11637 (Sort)
      Node 11638 (Hash Join)
        Node 11639 (Nested Loop)
          Node 11640 (Hash Join)
            Node 11641 (Seq Scan) - LEAF
            Node 11642 (Hash)
              Node 11643 (Hash Join)
                Node 11644 (Seq Scan) - LEAF
                Node 11645 (Hash)
                  Node 11646 (Seq Scan) - LEAF
          Node 11647 (Index Scan) - LEAF
        Node 11648 (Hash)
          Node 11649 (Hash Join)
            Node 11650 (Seq Scan) - LEAF
            Node 11651 (Hash)
              Node 11652 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 11635 | Aggregate | 1210.15 | 1209.26 | 0.1% | operator |
| 11636 | Gather Merge | 1207.13 | 1142.98 | 5.3% | operator |
| 11637 | Sort | 1203.66 | 1109.13 | 7.9% | operator |
| 11638 | Hash Join | 1203.09 | 842.59 | 30.0% | operator |
| 11639 | Nested Loop | 1196.28 | 1216.16 | 1.7% | operator |
| 11648 | Hash | 2.83 | 17.53 | 520.5% | operator |
| 11640 | Hash Join | 210.19 | 384.47 | 82.9% | operator |
| 11647 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 11649 | Hash Join | 2.78 | 85.17 | 2959.4% | operator |
| 11641 | Seq Scan | 149.54 | 201.16 | 34.5% | operator |
| 11642 | Hash | 34.37 | 19.59 | 43.0% | operator |
| 11650 | Seq Scan | 2.46 | 11.47 | 365.9% | operator |
| 11651 | Hash | 0.02 | 16.89 | 105488.0% | operator |
| 11643 | Hash Join | 34.10 | 92.20 | 170.4% | operator |
| 11652 | Seq Scan | 0.01 | 45.79 | 352148.6% | operator |
| 11644 | Seq Scan | 32.99 | 21.86 | 33.7% | operator |
| 11645 | Hash | 0.01 | 16.89 | 153482.6% | operator |
| 11646 | Seq Scan | 0.01 | 45.79 | 572303.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11646 (Seq Scan) - LEAF
...
### Step 2: Node 11644 (Seq Scan) - LEAF
...
### Step 5: Node 11652 (Seq Scan) - LEAF
...
### Step 6: Node 11641 (Seq Scan) - LEAF
...
### Step 8: Node 11650 (Seq Scan) - LEAF
...
### Step 11: Node 11647 (Index Scan) - LEAF
...
### Step 13: Node 11639 (Nested Loop)
...
### Step 17: Node 11636 (Gather Merge)
...
### Step 18: Node 11635 (Aggregate) - ROOT
