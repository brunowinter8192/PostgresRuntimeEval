...
```
Node 12661 (Aggregate) - ROOT
  Node 12662 (Gather Merge)
    Node 12663 (Sort)
      Node 12664 (Hash Join)
        Node 12665 (Nested Loop)
          Node 12666 (Hash Join)
            Node 12667 (Seq Scan) - LEAF
            Node 12668 (Hash)
              Node 12669 (Hash Join)
                Node 12670 (Seq Scan) - LEAF
                Node 12671 (Hash)
                  Node 12672 (Seq Scan) - LEAF
          Node 12673 (Index Scan) - LEAF
        Node 12674 (Hash)
          Node 12675 (Hash Join)
            Node 12676 (Seq Scan) - LEAF
            Node 12677 (Hash)
              Node 12678 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12661 | Aggregate | 1212.72 | 1209.26 | 0.3% | operator |
| 12662 | Gather Merge | 1210.44 | 1142.98 | 5.6% | operator |
| 12663 | Sort | 1203.61 | 1109.13 | 7.8% | operator |
| 12664 | Hash Join | 1202.98 | 842.59 | 30.0% | operator |
| 12665 | Nested Loop | 1196.49 | 1216.16 | 1.6% | operator |
| 12674 | Hash | 2.72 | 17.53 | 545.0% | operator |
| 12666 | Hash Join | 211.42 | 384.47 | 81.9% | operator |
| 12673 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 12675 | Hash Join | 2.67 | 85.17 | 3087.7% | operator |
| 12667 | Seq Scan | 150.93 | 201.16 | 33.3% | operator |
| 12668 | Hash | 34.27 | 19.59 | 42.8% | operator |
| 12676 | Seq Scan | 2.33 | 11.47 | 393.4% | operator |
| 12677 | Hash | 0.02 | 16.89 | 105488.0% | operator |
| 12669 | Hash Join | 33.78 | 92.20 | 173.0% | operator |
| 12678 | Seq Scan | 0.01 | 45.79 | 381502.6% | operator |
| 12670 | Seq Scan | 32.62 | 21.86 | 33.0% | operator |
| 12671 | Hash | 0.01 | 16.89 | 153482.6% | operator |
| 12672 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12672 (Seq Scan) - LEAF
...
### Step 2: Node 12670 (Seq Scan) - LEAF
...
### Step 5: Node 12678 (Seq Scan) - LEAF
...
### Step 6: Node 12667 (Seq Scan) - LEAF
...
### Step 8: Node 12676 (Seq Scan) - LEAF
...
### Step 11: Node 12673 (Index Scan) - LEAF
...
### Step 13: Node 12665 (Nested Loop)
...
### Step 17: Node 12662 (Gather Merge)
...
### Step 18: Node 12661 (Aggregate) - ROOT
