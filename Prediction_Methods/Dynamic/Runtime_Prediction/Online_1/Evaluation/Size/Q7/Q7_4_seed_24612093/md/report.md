...
```
Node 12193 (Aggregate) - ROOT
  Node 12194 (Gather Merge)
    Node 12195 (Sort)
      Node 12196 (Hash Join)
        Node 12197 (Nested Loop)
          Node 12198 (Hash Join)
            Node 12199 (Seq Scan) - LEAF
            Node 12200 (Hash)
              Node 12201 (Hash Join)
                Node 12202 (Seq Scan) - LEAF
                Node 12203 (Hash)
                  Node 12204 (Seq Scan) - LEAF
          Node 12205 (Index Scan) - LEAF
        Node 12206 (Hash)
          Node 12207 (Hash Join)
            Node 12208 (Seq Scan) - LEAF
            Node 12209 (Hash)
              Node 12210 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12193 | Aggregate | 1210.38 | 1209.26 | 0.1% | operator |
| 12194 | Gather Merge | 1209.22 | 1142.98 | 5.5% | operator |
| 12195 | Sort | 1203.64 | 1109.13 | 7.9% | operator |
| 12196 | Hash Join | 1203.00 | 842.59 | 30.0% | operator |
| 12197 | Nested Loop | 1195.37 | 1216.16 | 1.7% | operator |
| 12206 | Hash | 3.36 | 17.53 | 422.0% | operator |
| 12198 | Hash Join | 213.68 | 384.47 | 79.9% | operator |
| 12205 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 12207 | Hash Join | 3.31 | 85.17 | 2474.0% | operator |
| 12199 | Seq Scan | 151.04 | 201.16 | 33.2% | operator |
| 12200 | Hash | 36.73 | 19.59 | 46.7% | operator |
| 12208 | Seq Scan | 2.99 | 11.47 | 283.4% | operator |
| 12209 | Hash | 0.01 | 16.89 | 120572.0% | operator |
| 12201 | Hash Join | 36.47 | 92.20 | 152.8% | operator |
| 12210 | Seq Scan | 0.01 | 45.79 | 457823.2% | operator |
| 12202 | Seq Scan | 35.37 | 21.86 | 38.2% | operator |
| 12203 | Hash | 0.01 | 16.89 | 140684.0% | operator |
| 12204 | Seq Scan | 0.01 | 45.79 | 572303.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12204 (Seq Scan) - LEAF
...
### Step 2: Node 12202 (Seq Scan) - LEAF
...
### Step 5: Node 12210 (Seq Scan) - LEAF
...
### Step 6: Node 12199 (Seq Scan) - LEAF
...
### Step 8: Node 12208 (Seq Scan) - LEAF
...
### Step 11: Node 12205 (Index Scan) - LEAF
...
### Step 13: Node 12197 (Nested Loop)
...
### Step 17: Node 12194 (Gather Merge)
...
### Step 18: Node 12193 (Aggregate) - ROOT
