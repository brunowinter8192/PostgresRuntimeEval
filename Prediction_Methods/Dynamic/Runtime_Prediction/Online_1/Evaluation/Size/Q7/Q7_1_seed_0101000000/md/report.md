...
```
Node 11599 (Aggregate) - ROOT
  Node 11600 (Gather Merge)
    Node 11601 (Sort)
      Node 11602 (Hash Join)
        Node 11603 (Nested Loop)
          Node 11604 (Hash Join)
            Node 11605 (Seq Scan) - LEAF
            Node 11606 (Hash)
              Node 11607 (Hash Join)
                Node 11608 (Seq Scan) - LEAF
                Node 11609 (Hash)
                  Node 11610 (Seq Scan) - LEAF
          Node 11611 (Index Scan) - LEAF
        Node 11612 (Hash)
          Node 11613 (Hash Join)
            Node 11614 (Seq Scan) - LEAF
            Node 11615 (Hash)
              Node 11616 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 11599 | Aggregate | 1167.08 | 1209.26 | 3.6% | operator |
| 11600 | Gather Merge | 1166.08 | 1142.98 | 2.0% | operator |
| 11601 | Sort | 1160.36 | 1109.13 | 4.4% | operator |
| 11602 | Hash Join | 1159.77 | 842.59 | 27.3% | operator |
| 11603 | Nested Loop | 1152.99 | 1216.16 | 5.5% | operator |
| 11612 | Hash | 3.13 | 17.53 | 460.6% | operator |
| 11604 | Hash Join | 212.14 | 384.47 | 81.2% | operator |
| 11611 | Index Scan | 0.03 | 0.96 | 3006.0% | operator |
| 11613 | Hash Join | 3.08 | 85.17 | 2665.4% | operator |
| 11605 | Seq Scan | 150.78 | 201.16 | 33.4% | operator |
| 11606 | Hash | 34.28 | 19.59 | 42.8% | operator |
| 11614 | Seq Scan | 2.75 | 11.47 | 317.7% | operator |
| 11615 | Hash | 0.01 | 16.89 | 112527.2% | operator |
| 11607 | Hash Join | 32.33 | 92.20 | 185.2% | operator |
| 11616 | Seq Scan | 0.01 | 45.79 | 416193.8% | operator |
| 11608 | Seq Scan | 31.21 | 21.86 | 30.0% | operator |
| 11609 | Hash | 0.01 | 16.89 | 129854.5% | operator |
| 11610 | Seq Scan | 0.01 | 45.79 | 457823.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11610 (Seq Scan) - LEAF
...
### Step 2: Node 11608 (Seq Scan) - LEAF
...
### Step 5: Node 11616 (Seq Scan) - LEAF
...
### Step 6: Node 11605 (Seq Scan) - LEAF
...
### Step 8: Node 11614 (Seq Scan) - LEAF
...
### Step 11: Node 11611 (Index Scan) - LEAF
...
### Step 13: Node 11603 (Nested Loop)
...
### Step 17: Node 11600 (Gather Merge)
...
### Step 18: Node 11599 (Aggregate) - ROOT
