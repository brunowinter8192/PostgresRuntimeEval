...
```
Node 11419 (Aggregate) - ROOT
  Node 11420 (Gather Merge)
    Node 11421 (Sort)
      Node 11422 (Hash Join)
        Node 11423 (Nested Loop)
          Node 11424 (Hash Join)
            Node 11425 (Seq Scan) - LEAF
            Node 11426 (Hash)
              Node 11427 (Hash Join)
                Node 11428 (Seq Scan) - LEAF
                Node 11429 (Hash)
                  Node 11430 (Seq Scan) - LEAF
          Node 11431 (Index Scan) - LEAF
        Node 11432 (Hash)
          Node 11433 (Hash Join)
            Node 11434 (Seq Scan) - LEAF
            Node 11435 (Hash)
              Node 11436 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 11419 | Aggregate | 1186.84 | 1209.26 | 1.9% | operator |
| 11420 | Gather Merge | 1185.74 | 1142.98 | 3.6% | operator |
| 11421 | Sort | 1179.63 | 1109.13 | 6.0% | operator |
| 11422 | Hash Join | 1179.00 | 842.59 | 28.5% | operator |
| 11423 | Nested Loop | 1170.75 | 1216.16 | 3.9% | operator |
| 11432 | Hash | 4.61 | 17.53 | 280.7% | operator |
| 11424 | Hash Join | 214.13 | 384.47 | 79.6% | operator |
| 11431 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 11433 | Hash Join | 4.55 | 85.17 | 1770.3% | operator |
| 11425 | Seq Scan | 150.86 | 201.16 | 33.3% | operator |
| 11426 | Hash | 35.45 | 19.59 | 44.7% | operator |
| 11434 | Seq Scan | 4.20 | 11.47 | 173.1% | operator |
| 11435 | Hash | 0.02 | 16.89 | 99277.0% | operator |
| 11427 | Hash Join | 35.11 | 92.20 | 162.6% | operator |
| 11436 | Seq Scan | 0.01 | 45.79 | 352148.6% | operator |
| 11428 | Seq Scan | 33.91 | 21.86 | 35.5% | operator |
| 11429 | Hash | 0.01 | 16.89 | 168840.8% | operator |
| 11430 | Seq Scan | 0.01 | 45.79 | 763105.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11430 (Seq Scan) - LEAF
...
### Step 2: Node 11428 (Seq Scan) - LEAF
...
### Step 5: Node 11436 (Seq Scan) - LEAF
...
### Step 6: Node 11425 (Seq Scan) - LEAF
...
### Step 8: Node 11434 (Seq Scan) - LEAF
...
### Step 11: Node 11431 (Index Scan) - LEAF
...
### Step 13: Node 11423 (Nested Loop)
...
### Step 17: Node 11420 (Gather Merge)
...
### Step 18: Node 11419 (Aggregate) - ROOT
