...
```
Node 11923 (Aggregate) - ROOT
  Node 11924 (Gather Merge)
    Node 11925 (Sort)
      Node 11926 (Hash Join)
        Node 11927 (Nested Loop)
          Node 11928 (Hash Join)
            Node 11929 (Seq Scan) - LEAF
            Node 11930 (Hash)
              Node 11931 (Hash Join)
                Node 11932 (Seq Scan) - LEAF
                Node 11933 (Hash)
                  Node 11934 (Seq Scan) - LEAF
          Node 11935 (Index Scan) - LEAF
        Node 11936 (Hash)
          Node 11937 (Hash Join)
            Node 11938 (Seq Scan) - LEAF
            Node 11939 (Hash)
              Node 11940 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 11923 | Aggregate | 1207.97 | 1209.26 | 0.1% | operator |
| 11924 | Gather Merge | 1206.80 | 1142.98 | 5.3% | operator |
| 11925 | Sort | 1200.41 | 1109.13 | 7.6% | operator |
| 11926 | Hash Join | 1199.76 | 842.59 | 29.8% | operator |
| 11927 | Nested Loop | 1192.35 | 1216.16 | 2.0% | operator |
| 11936 | Hash | 3.33 | 17.53 | 425.8% | operator |
| 11928 | Hash Join | 211.75 | 384.47 | 81.6% | operator |
| 11935 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 11937 | Hash Join | 3.29 | 85.17 | 2492.8% | operator |
| 11929 | Seq Scan | 151.83 | 201.16 | 32.5% | operator |
| 11930 | Hash | 33.68 | 19.59 | 41.8% | operator |
| 11938 | Seq Scan | 2.97 | 11.47 | 286.6% | operator |
| 11939 | Hash | 0.01 | 16.89 | 129854.5% | operator |
| 11931 | Hash Join | 33.32 | 92.20 | 176.7% | operator |
| 11940 | Seq Scan | 0.01 | 45.79 | 457823.2% | operator |
| 11932 | Seq Scan | 32.22 | 21.86 | 32.2% | operator |
| 11933 | Hash | 0.01 | 16.89 | 211076.0% | operator |
| 11934 | Seq Scan | 0.01 | 45.79 | 763105.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11934 (Seq Scan) - LEAF
...
### Step 2: Node 11932 (Seq Scan) - LEAF
...
### Step 5: Node 11940 (Seq Scan) - LEAF
...
### Step 6: Node 11929 (Seq Scan) - LEAF
...
### Step 8: Node 11938 (Seq Scan) - LEAF
...
### Step 11: Node 11935 (Index Scan) - LEAF
...
### Step 13: Node 11927 (Nested Loop)
...
### Step 17: Node 11924 (Gather Merge)
...
### Step 18: Node 11923 (Aggregate) - ROOT
