...
```
Node 12571 (Aggregate) - ROOT
  Node 12572 (Gather Merge)
    Node 12573 (Sort)
      Node 12574 (Hash Join)
        Node 12575 (Nested Loop)
          Node 12576 (Hash Join)
            Node 12577 (Seq Scan) - LEAF
            Node 12578 (Hash)
              Node 12579 (Hash Join)
                Node 12580 (Seq Scan) - LEAF
                Node 12581 (Hash)
                  Node 12582 (Seq Scan) - LEAF
          Node 12583 (Index Scan) - LEAF
        Node 12584 (Hash)
          Node 12585 (Hash Join)
            Node 12586 (Seq Scan) - LEAF
            Node 12587 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 12571 | Aggregate | 1186.33 | 1209.26 | 1.9% | operator |
| 12572 | Gather Merge | 1185.20 | 1142.98 | 3.6% | operator |
| 12573 | Sort | 1179.26 | 1109.13 | 5.9% | operator |
| 12574 | Hash Join | 1178.58 | 842.59 | 28.5% | operator |
| 12575 | Nested Loop | 1170.72 | 1216.16 | 3.9% | operator |
| 12584 | Hash | 3.95 | 17.53 | 343.8% | operator |
| 12576 | Hash Join | 206.58 | 384.47 | 86.1% | operator |
| 12583 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 12585 | Hash Join | 3.90 | 85.17 | 2082.8% | operator |
| 12577 | Seq Scan | 148.65 | 201.16 | 35.3% | operator |
| 12578 | Hash | 31.93 | 19.59 | 38.6% | operator |
| 12586 | Seq Scan | 3.59 | 11.47 | 219.8% | operator |
| 12587 | Hash | 0.02 | 16.89 | 105488.0% | operator |
| 12579 | Hash Join | 31.59 | 92.20 | 191.9% | operator |
| 12588 | Seq Scan | 0.01 | 45.79 | 416193.8% | operator |
| 12580 | Seq Scan | 30.51 | 21.86 | 28.4% | operator |
| 12581 | Hash | 0.01 | 16.89 | 153482.6% | operator |
| 12582 | Seq Scan | 0.01 | 45.79 | 572303.9% | operator |
...
### Step 2: Node 12580 (Seq Scan) - LEAF
...
### Step 5: Node 12588 (Seq Scan) - LEAF
...
### Step 6: Node 12577 (Seq Scan) - LEAF
...
### Step 8: Node 12586 (Seq Scan) - LEAF
...
### Step 11: Node 12583 (Index Scan) - LEAF
...
### Step 13: Node 12575 (Nested Loop)
...
### Step 17: Node 12572 (Gather Merge)
...
### Step 18: Node 12571 (Aggregate) - ROOT
