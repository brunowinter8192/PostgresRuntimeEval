...
```
Node 11851 (Aggregate) - ROOT
  Node 11852 (Gather Merge)
    Node 11853 (Sort)
      Node 11854 (Hash Join)
        Node 11855 (Nested Loop)
          Node 11856 (Hash Join)
            Node 11857 (Seq Scan) - LEAF
            Node 11858 (Hash)
              Node 11859 (Hash Join)
                Node 11860 (Seq Scan) - LEAF
                Node 11861 (Hash)
                  Node 11862 (Seq Scan) - LEAF
          Node 11863 (Index Scan) - LEAF
        Node 11864 (Hash)
          Node 11865 (Hash Join)
            Node 11866 (Seq Scan) - LEAF
            Node 11867 (Hash)
              Node 11868 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 11851 | Aggregate | 1178.88 | 1209.26 | 2.6% | operator |
| 11852 | Gather Merge | 1177.82 | 1142.98 | 3.0% | operator |
| 11853 | Sort | 1169.68 | 1109.13 | 5.2% | operator |
| 11854 | Hash Join | 1169.06 | 842.59 | 27.9% | operator |
| 11855 | Nested Loop | 1162.63 | 1216.16 | 4.6% | operator |
| 11864 | Hash | 2.72 | 17.53 | 545.4% | operator |
| 11856 | Hash Join | 208.73 | 384.47 | 84.2% | operator |
| 11863 | Index Scan | 0.03 | 0.96 | 3006.0% | operator |
| 11865 | Hash Join | 2.68 | 85.17 | 3081.7% | operator |
| 11857 | Seq Scan | 149.51 | 201.16 | 34.5% | operator |
| 11858 | Hash | 33.31 | 19.59 | 41.2% | operator |
| 11866 | Seq Scan | 2.38 | 11.47 | 382.6% | operator |
| 11867 | Hash | 0.01 | 16.89 | 120572.0% | operator |
| 11859 | Hash Join | 32.90 | 92.20 | 180.2% | operator |
| 11868 | Seq Scan | 0.01 | 45.79 | 416193.8% | operator |
| 11860 | Seq Scan | 31.76 | 21.86 | 31.2% | operator |
| 11861 | Hash | 0.01 | 16.89 | 187612.0% | operator |
| 11862 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11862 (Seq Scan) - LEAF
...
### Step 2: Node 11860 (Seq Scan) - LEAF
...
### Step 5: Node 11868 (Seq Scan) - LEAF
...
### Step 6: Node 11857 (Seq Scan) - LEAF
...
### Step 8: Node 11866 (Seq Scan) - LEAF
...
### Step 11: Node 11863 (Index Scan) - LEAF
...
### Step 13: Node 11855 (Nested Loop)
...
### Step 17: Node 11852 (Gather Merge)
...
### Step 18: Node 11851 (Aggregate) - ROOT
