...
```
Node 12175 (Aggregate) - ROOT
  Node 12176 (Gather Merge)
    Node 12177 (Sort)
      Node 12178 (Hash Join)
        Node 12179 (Nested Loop)
          Node 12180 (Hash Join)
            Node 12181 (Seq Scan) - LEAF
            Node 12182 (Hash)
              Node 12183 (Hash Join)
                Node 12184 (Seq Scan) - LEAF
                Node 12185 (Hash)
                  Node 12186 (Seq Scan) - LEAF
          Node 12187 (Index Scan) - LEAF
        Node 12188 (Hash)
          Node 12189 (Hash Join)
            Node 12190 (Seq Scan) - LEAF
            Node 12191 (Hash)
              Node 12192 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12175 | Aggregate | 1190.70 | 1209.26 | 1.6% | operator |
| 12176 | Gather Merge | 1189.55 | 1142.98 | 3.9% | operator |
| 12177 | Sort | 1183.30 | 1109.13 | 6.3% | operator |
| 12178 | Hash Join | 1182.63 | 842.59 | 28.8% | operator |
| 12179 | Nested Loop | 1172.34 | 1216.16 | 3.7% | operator |
| 12188 | Hash | 6.43 | 17.53 | 172.6% | operator |
| 12180 | Hash Join | 210.92 | 384.47 | 82.3% | operator |
| 12187 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 12189 | Hash Join | 6.39 | 85.17 | 1233.6% | operator |
| 12181 | Seq Scan | 150.47 | 201.16 | 33.7% | operator |
| 12182 | Hash | 34.72 | 19.59 | 43.6% | operator |
| 12190 | Seq Scan | 6.09 | 11.47 | 88.4% | operator |
| 12191 | Hash | 0.01 | 16.89 | 129854.5% | operator |
| 12183 | Hash Join | 34.44 | 92.20 | 167.7% | operator |
| 12192 | Seq Scan | 0.01 | 45.79 | 457823.2% | operator |
| 12184 | Seq Scan | 33.35 | 21.86 | 34.5% | operator |
| 12185 | Hash | 0.01 | 16.89 | 168840.8% | operator |
| 12186 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12186 (Seq Scan) - LEAF
...
### Step 2: Node 12184 (Seq Scan) - LEAF
...
### Step 5: Node 12192 (Seq Scan) - LEAF
...
### Step 6: Node 12181 (Seq Scan) - LEAF
...
### Step 8: Node 12190 (Seq Scan) - LEAF
...
### Step 11: Node 12187 (Index Scan) - LEAF
...
### Step 13: Node 12179 (Nested Loop)
...
### Step 17: Node 12176 (Gather Merge)
...
### Step 18: Node 12175 (Aggregate) - ROOT
