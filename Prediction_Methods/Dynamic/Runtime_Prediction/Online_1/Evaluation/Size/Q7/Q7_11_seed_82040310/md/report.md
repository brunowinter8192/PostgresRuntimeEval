...
```
Node 10879 (Aggregate) - ROOT
  Node 10880 (Gather Merge)
    Node 10881 (Sort)
      Node 10882 (Hash Join)
        Node 10883 (Nested Loop)
          Node 10884 (Hash Join)
            Node 10885 (Seq Scan) - LEAF
            Node 10886 (Hash)
              Node 10887 (Hash Join)
                Node 10888 (Seq Scan) - LEAF
                Node 10889 (Hash)
                  Node 10890 (Seq Scan) - LEAF
          Node 10891 (Index Scan) - LEAF
        Node 10892 (Hash)
          Node 10893 (Hash Join)
            Node 10894 (Seq Scan) - LEAF
            Node 10895 (Hash)
              Node 10896 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 10879 | Aggregate | 1217.51 | 1209.26 | 0.7% | operator |
| 10880 | Gather Merge | 1216.49 | 1142.98 | 6.0% | operator |
| 10881 | Sort | 1210.73 | 1109.13 | 8.4% | operator |
| 10882 | Hash Join | 1210.09 | 842.59 | 30.4% | operator |
| 10883 | Nested Loop | 1202.29 | 1216.16 | 1.2% | operator |
| 10892 | Hash | 3.85 | 17.53 | 355.4% | operator |
| 10884 | Hash Join | 212.53 | 384.47 | 80.9% | operator |
| 10891 | Index Scan | 0.03 | 0.96 | 2731.9% | operator |
| 10893 | Hash Join | 3.80 | 85.17 | 2140.8% | operator |
| 10885 | Seq Scan | 151.81 | 201.16 | 32.5% | operator |
| 10886 | Hash | 34.92 | 19.59 | 43.9% | operator |
| 10894 | Seq Scan | 3.46 | 11.47 | 231.9% | operator |
| 10895 | Hash | 0.01 | 16.89 | 140684.0% | operator |
| 10887 | Hash Join | 34.65 | 92.20 | 166.1% | operator |
| 10896 | Seq Scan | 0.01 | 45.79 | 508703.5% | operator |
| 10888 | Seq Scan | 33.52 | 21.86 | 34.8% | operator |
| 10889 | Hash | 0.01 | 16.89 | 187612.0% | operator |
| 10890 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10890 (Seq Scan) - LEAF
...
### Step 2: Node 10888 (Seq Scan) - LEAF
...
### Step 5: Node 10896 (Seq Scan) - LEAF
...
### Step 6: Node 10885 (Seq Scan) - LEAF
...
### Step 8: Node 10894 (Seq Scan) - LEAF
...
### Step 11: Node 10891 (Index Scan) - LEAF
...
### Step 13: Node 10883 (Nested Loop)
...
### Step 17: Node 10880 (Gather Merge)
...
### Step 18: Node 10879 (Aggregate) - ROOT
