...
```
Node 11077 (Aggregate) - ROOT
  Node 11078 (Gather Merge)
    Node 11079 (Sort)
      Node 11080 (Hash Join)
        Node 11081 (Nested Loop)
          Node 11082 (Hash Join)
            Node 11083 (Seq Scan) - LEAF
            Node 11084 (Hash)
              Node 11085 (Hash Join)
                Node 11086 (Seq Scan) - LEAF
                Node 11087 (Hash)
                  Node 11088 (Seq Scan) - LEAF
          Node 11089 (Index Scan) - LEAF
        Node 11090 (Hash)
          Node 11091 (Hash Join)
            Node 11092 (Seq Scan) - LEAF
            Node 11093 (Hash)
              Node 11094 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 11077 | Aggregate | 1187.55 | 1209.26 | 1.8% | operator |
| 11078 | Gather Merge | 1186.55 | 1142.98 | 3.7% | operator |
| 11079 | Sort | 1181.82 | 1109.13 | 6.2% | operator |
| 11080 | Hash Join | 1181.20 | 842.59 | 28.7% | operator |
| 11081 | Nested Loop | 1173.39 | 1216.16 | 3.6% | operator |
| 11090 | Hash | 4.13 | 17.53 | 324.8% | operator |
| 11082 | Hash Join | 213.68 | 384.47 | 79.9% | operator |
| 11089 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 11091 | Hash Join | 4.08 | 85.17 | 1985.6% | operator |
| 11083 | Seq Scan | 152.94 | 201.16 | 31.5% | operator |
| 11084 | Hash | 35.21 | 19.59 | 44.4% | operator |
| 11092 | Seq Scan | 3.75 | 11.47 | 206.2% | operator |
| 11093 | Hash | 0.01 | 16.89 | 112527.2% | operator |
| 11085 | Hash Join | 34.10 | 92.20 | 170.4% | operator |
| 11094 | Seq Scan | 0.01 | 45.79 | 381502.6% | operator |
| 11086 | Seq Scan | 32.94 | 21.86 | 33.7% | operator |
| 11087 | Hash | 0.01 | 16.89 | 187612.0% | operator |
| 11088 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11088 (Seq Scan) - LEAF
...
### Step 2: Node 11086 (Seq Scan) - LEAF
...
### Step 5: Node 11094 (Seq Scan) - LEAF
...
### Step 6: Node 11083 (Seq Scan) - LEAF
...
### Step 8: Node 11092 (Seq Scan) - LEAF
...
### Step 11: Node 11089 (Index Scan) - LEAF
...
### Step 13: Node 11081 (Nested Loop)
...
### Step 17: Node 11078 (Gather Merge)
...
### Step 18: Node 11077 (Aggregate) - ROOT
