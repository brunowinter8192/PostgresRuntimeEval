...
```
Node 12103 (Aggregate) - ROOT
  Node 12104 (Gather Merge)
    Node 12105 (Sort)
      Node 12106 (Hash Join)
        Node 12107 (Nested Loop)
          Node 12108 (Hash Join)
            Node 12109 (Seq Scan) - LEAF
            Node 12110 (Hash)
              Node 12111 (Hash Join)
                Node 12112 (Seq Scan) - LEAF
                Node 12113 (Hash)
                  Node 12114 (Seq Scan) - LEAF
          Node 12115 (Index Scan) - LEAF
        Node 12116 (Hash)
          Node 12117 (Hash Join)
            Node 12118 (Seq Scan) - LEAF
            Node 12119 (Hash)
              Node 12120 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12103 | Aggregate | 1223.46 | 1209.26 | 1.2% | operator |
| 12104 | Gather Merge | 1222.49 | 1142.98 | 6.5% | operator |
| 12105 | Sort | 1216.40 | 1109.13 | 8.8% | operator |
| 12106 | Hash Join | 1215.76 | 842.59 | 30.7% | operator |
| 12107 | Nested Loop | 1206.94 | 1216.16 | 0.8% | operator |
| 12116 | Hash | 5.03 | 17.53 | 248.9% | operator |
| 12108 | Hash Join | 216.15 | 384.47 | 77.9% | operator |
| 12115 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 12117 | Hash Join | 4.98 | 85.17 | 1610.3% | operator |
| 12109 | Seq Scan | 151.57 | 201.16 | 32.7% | operator |
| 12110 | Hash | 38.71 | 19.59 | 49.4% | operator |
| 12118 | Seq Scan | 4.65 | 11.47 | 146.7% | operator |
| 12119 | Hash | 0.01 | 16.89 | 112527.2% | operator |
| 12111 | Hash Join | 38.36 | 92.20 | 140.4% | operator |
| 12120 | Seq Scan | 0.01 | 45.79 | 381502.6% | operator |
| 12112 | Seq Scan | 37.22 | 21.86 | 41.3% | operator |
| 12113 | Hash | 0.01 | 16.89 | 153482.6% | operator |
| 12114 | Seq Scan | 0.01 | 45.79 | 508703.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12114 (Seq Scan) - LEAF
...
### Step 2: Node 12112 (Seq Scan) - LEAF
...
### Step 5: Node 12120 (Seq Scan) - LEAF
...
### Step 6: Node 12109 (Seq Scan) - LEAF
...
### Step 8: Node 12118 (Seq Scan) - LEAF
...
### Step 11: Node 12115 (Index Scan) - LEAF
...
### Step 13: Node 12107 (Nested Loop)
...
### Step 17: Node 12104 (Gather Merge)
...
### Step 18: Node 12103 (Aggregate) - ROOT
