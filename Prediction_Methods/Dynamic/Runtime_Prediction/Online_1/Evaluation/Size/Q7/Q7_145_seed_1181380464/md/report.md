...
```
Node 11383 (Aggregate) - ROOT
  Node 11384 (Gather Merge)
    Node 11385 (Sort)
      Node 11386 (Hash Join)
        Node 11387 (Nested Loop)
          Node 11388 (Hash Join)
            Node 11389 (Seq Scan) - LEAF
            Node 11390 (Hash)
              Node 11391 (Hash Join)
                Node 11392 (Seq Scan) - LEAF
                Node 11393 (Hash)
                  Node 11394 (Seq Scan) - LEAF
          Node 11395 (Index Scan) - LEAF
        Node 11396 (Hash)
          Node 11397 (Hash Join)
            Node 11398 (Seq Scan) - LEAF
            Node 11399 (Hash)
              Node 11400 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 11383 | Aggregate | 1188.76 | 1209.26 | 1.7% | operator |
| 11384 | Gather Merge | 1187.78 | 1142.98 | 3.8% | operator |
| 11385 | Sort | 1182.85 | 1109.13 | 6.2% | operator |
| 11386 | Hash Join | 1182.24 | 842.59 | 28.7% | operator |
| 11387 | Nested Loop | 1175.33 | 1216.16 | 3.5% | operator |
| 11396 | Hash | 3.15 | 17.53 | 457.2% | operator |
| 11388 | Hash Join | 214.12 | 384.47 | 79.6% | operator |
| 11395 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 11397 | Hash Join | 3.10 | 85.17 | 2648.5% | operator |
| 11389 | Seq Scan | 152.45 | 201.16 | 32.0% | operator |
| 11390 | Hash | 36.26 | 19.59 | 46.0% | operator |
| 11398 | Seq Scan | 2.77 | 11.47 | 314.3% | operator |
| 11399 | Hash | 0.02 | 16.89 | 105488.0% | operator |
| 11391 | Hash Join | 35.84 | 92.20 | 157.2% | operator |
| 11400 | Seq Scan | 0.01 | 45.79 | 416193.8% | operator |
| 11392 | Seq Scan | 34.61 | 21.86 | 36.8% | operator |
| 11393 | Hash | 0.01 | 16.89 | 187612.0% | operator |
| 11394 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11394 (Seq Scan) - LEAF
...
### Step 2: Node 11392 (Seq Scan) - LEAF
...
### Step 5: Node 11400 (Seq Scan) - LEAF
...
### Step 6: Node 11389 (Seq Scan) - LEAF
...
### Step 8: Node 11398 (Seq Scan) - LEAF
...
### Step 11: Node 11395 (Index Scan) - LEAF
...
### Step 13: Node 11387 (Nested Loop)
...
### Step 17: Node 11384 (Gather Merge)
...
### Step 18: Node 11383 (Aggregate) - ROOT
