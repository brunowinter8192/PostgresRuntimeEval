...
```
Node 11527 (Aggregate) - ROOT
  Node 11528 (Gather Merge)
    Node 11529 (Sort)
      Node 11530 (Hash Join)
        Node 11531 (Nested Loop)
          Node 11532 (Hash Join)
            Node 11533 (Seq Scan) - LEAF
            Node 11534 (Hash)
              Node 11535 (Hash Join)
                Node 11536 (Seq Scan) - LEAF
                Node 11537 (Hash)
                  Node 11538 (Seq Scan) - LEAF
          Node 11539 (Index Scan) - LEAF
        Node 11540 (Hash)
          Node 11541 (Hash Join)
            Node 11542 (Seq Scan) - LEAF
            Node 11543 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 11527 | Aggregate | 1178.86 | 1209.26 | 2.6% | operator |
| 11528 | Gather Merge | 1177.77 | 1142.98 | 3.0% | operator |
| 11529 | Sort | 1169.05 | 1109.13 | 5.1% | operator |
| 11530 | Hash Join | 1168.45 | 842.59 | 27.9% | operator |
| 11531 | Nested Loop | 1161.73 | 1216.16 | 4.7% | operator |
| 11540 | Hash | 3.07 | 17.53 | 471.6% | operator |
| 11532 | Hash Join | 208.37 | 384.47 | 84.5% | operator |
| 11539 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 11541 | Hash Join | 3.02 | 85.17 | 2715.7% | operator |
| 11533 | Seq Scan | 147.79 | 201.16 | 36.1% | operator |
| 11534 | Hash | 35.52 | 19.59 | 44.8% | operator |
| 11542 | Seq Scan | 2.70 | 11.47 | 324.7% | operator |
| 11543 | Hash | 0.02 | 16.89 | 99277.0% | operator |
| 11535 | Hash Join | 35.24 | 92.20 | 161.6% | operator |
| 11544 | Seq Scan | 0.01 | 45.79 | 416193.8% | operator |
| 11536 | Seq Scan | 34.14 | 21.86 | 36.0% | operator |
| 11537 | Hash | 0.01 | 16.89 | 211076.0% | operator |
| 11538 | Seq Scan | 0.01 | 45.79 | 915746.3% | operator |
...
### Step 2: Node 11536 (Seq Scan) - LEAF
...
### Step 5: Node 11544 (Seq Scan) - LEAF
...
### Step 6: Node 11533 (Seq Scan) - LEAF
...
### Step 8: Node 11542 (Seq Scan) - LEAF
...
### Step 11: Node 11539 (Index Scan) - LEAF
...
### Step 13: Node 11531 (Nested Loop)
...
### Step 17: Node 11528 (Gather Merge)
...
### Step 18: Node 11527 (Aggregate) - ROOT
