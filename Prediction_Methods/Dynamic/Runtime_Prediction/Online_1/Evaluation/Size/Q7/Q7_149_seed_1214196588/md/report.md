...
```
Node 11455 (Aggregate) - ROOT
  Node 11456 (Gather Merge)
    Node 11457 (Sort)
      Node 11458 (Hash Join)
        Node 11459 (Nested Loop)
          Node 11460 (Hash Join)
            Node 11461 (Seq Scan) - LEAF
            Node 11462 (Hash)
              Node 11463 (Hash Join)
                Node 11464 (Seq Scan) - LEAF
                Node 11465 (Hash)
                  Node 11466 (Seq Scan) - LEAF
          Node 11467 (Index Scan) - LEAF
        Node 11468 (Hash)
          Node 11469 (Hash Join)
            Node 11470 (Seq Scan) - LEAF
            Node 11471 (Hash)
              Node 11472 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 11455 | Aggregate | 1211.85 | 1209.26 | 0.2% | operator |
| 11456 | Gather Merge | 1210.82 | 1142.98 | 5.6% | operator |
| 11457 | Sort | 1205.76 | 1109.13 | 8.0% | operator |
| 11458 | Hash Join | 1205.14 | 842.59 | 30.1% | operator |
| 11459 | Nested Loop | 1197.59 | 1216.16 | 1.6% | operator |
| 11468 | Hash | 3.86 | 17.53 | 354.4% | operator |
| 11460 | Hash Join | 215.10 | 384.47 | 78.7% | operator |
| 11467 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 11469 | Hash Join | 3.81 | 85.17 | 2135.0% | operator |
| 11461 | Seq Scan | 153.84 | 201.16 | 30.8% | operator |
| 11462 | Hash | 35.92 | 19.59 | 45.5% | operator |
| 11470 | Seq Scan | 3.50 | 11.47 | 227.6% | operator |
| 11471 | Hash | 0.01 | 16.89 | 120572.0% | operator |
| 11463 | Hash Join | 35.54 | 92.20 | 159.4% | operator |
| 11472 | Seq Scan | 0.01 | 45.79 | 416193.8% | operator |
| 11464 | Seq Scan | 34.38 | 21.86 | 36.4% | operator |
| 11465 | Hash | 0.01 | 16.89 | 168840.8% | operator |
| 11466 | Seq Scan | 0.01 | 45.79 | 763105.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11466 (Seq Scan) - LEAF
...
### Step 2: Node 11464 (Seq Scan) - LEAF
...
### Step 5: Node 11472 (Seq Scan) - LEAF
...
### Step 6: Node 11461 (Seq Scan) - LEAF
...
### Step 8: Node 11470 (Seq Scan) - LEAF
...
### Step 11: Node 11467 (Index Scan) - LEAF
...
### Step 13: Node 11459 (Nested Loop)
...
### Step 17: Node 11456 (Gather Merge)
...
### Step 18: Node 11455 (Aggregate) - ROOT
