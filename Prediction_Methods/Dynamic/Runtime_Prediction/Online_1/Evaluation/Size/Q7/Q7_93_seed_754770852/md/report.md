...
```
Node 13057 (Aggregate) - ROOT
  Node 13058 (Gather Merge)
    Node 13059 (Sort)
      Node 13060 (Hash Join)
        Node 13061 (Nested Loop)
          Node 13062 (Hash Join)
            Node 13063 (Seq Scan) - LEAF
            Node 13064 (Hash)
              Node 13065 (Hash Join)
                Node 13066 (Seq Scan) - LEAF
                Node 13067 (Hash)
                  Node 13068 (Seq Scan) - LEAF
          Node 13069 (Index Scan) - LEAF
        Node 13070 (Hash)
          Node 13071 (Hash Join)
            Node 13072 (Seq Scan) - LEAF
            Node 13073 (Hash)
              Node 13074 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 13057 | Aggregate | 1182.96 | 1209.26 | 2.2% | operator |
| 13058 | Gather Merge | 1181.91 | 1142.98 | 3.3% | operator |
| 13059 | Sort | 1175.94 | 1109.13 | 5.7% | operator |
| 13060 | Hash Join | 1175.30 | 842.59 | 28.3% | operator |
| 13061 | Nested Loop | 1169.15 | 1216.16 | 4.0% | operator |
| 13070 | Hash | 2.47 | 17.53 | 610.0% | operator |
| 13062 | Hash Join | 210.51 | 384.47 | 82.6% | operator |
| 13069 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 13071 | Hash Join | 2.42 | 85.17 | 3416.7% | operator |
| 13063 | Seq Scan | 148.92 | 201.16 | 35.1% | operator |
| 13064 | Hash | 35.37 | 19.59 | 44.6% | operator |
| 13072 | Seq Scan | 2.08 | 11.47 | 451.0% | operator |
| 13073 | Hash | 0.01 | 16.89 | 129854.5% | operator |
| 13065 | Hash Join | 35.01 | 92.20 | 163.3% | operator |
| 13074 | Seq Scan | 0.01 | 45.79 | 457823.2% | operator |
| 13066 | Seq Scan | 33.38 | 21.86 | 34.5% | operator |
| 13067 | Hash | 0.01 | 16.89 | 153482.6% | operator |
| 13068 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 13068 (Seq Scan) - LEAF
...
### Step 2: Node 13066 (Seq Scan) - LEAF
...
### Step 5: Node 13074 (Seq Scan) - LEAF
...
### Step 6: Node 13063 (Seq Scan) - LEAF
...
### Step 8: Node 13072 (Seq Scan) - LEAF
...
### Step 11: Node 13069 (Index Scan) - LEAF
...
### Step 13: Node 13061 (Nested Loop)
...
### Step 17: Node 13058 (Gather Merge)
...
### Step 18: Node 13057 (Aggregate) - ROOT
