...
```
Node 11185 (Aggregate) - ROOT
  Node 11186 (Gather Merge)
    Node 11187 (Sort)
      Node 11188 (Hash Join)
        Node 11189 (Nested Loop)
          Node 11190 (Hash Join)
            Node 11191 (Seq Scan) - LEAF
            Node 11192 (Hash)
              Node 11193 (Hash Join)
                Node 11194 (Seq Scan) - LEAF
                Node 11195 (Hash)
                  Node 11196 (Seq Scan) - LEAF
          Node 11197 (Index Scan) - LEAF
        Node 11198 (Hash)
          Node 11199 (Hash Join)
            Node 11200 (Seq Scan) - LEAF
            Node 11201 (Hash)
              Node 11202 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 11185 | Aggregate | 1178.25 | 1209.26 | 2.6% | operator |
| 11186 | Gather Merge | 1177.12 | 1142.98 | 2.9% | operator |
| 11187 | Sort | 1170.89 | 1109.13 | 5.3% | operator |
| 11188 | Hash Join | 1170.30 | 842.59 | 28.0% | operator |
| 11189 | Nested Loop | 1162.75 | 1216.16 | 4.6% | operator |
| 11198 | Hash | 3.66 | 17.53 | 378.7% | operator |
| 11190 | Hash Join | 214.33 | 384.47 | 79.4% | operator |
| 11197 | Index Scan | 0.03 | 0.96 | 3006.0% | operator |
| 11199 | Hash Join | 3.61 | 85.17 | 2262.0% | operator |
| 11191 | Seq Scan | 151.89 | 201.16 | 32.4% | operator |
| 11192 | Hash | 37.28 | 19.59 | 47.4% | operator |
| 11200 | Seq Scan | 3.27 | 11.47 | 251.0% | operator |
| 11201 | Hash | 0.02 | 16.89 | 80348.0% | operator |
| 11193 | Hash Join | 36.78 | 92.20 | 150.7% | operator |
| 11202 | Seq Scan | 0.02 | 45.79 | 269266.6% | operator |
| 11194 | Seq Scan | 35.66 | 21.86 | 38.7% | operator |
| 11195 | Hash | 0.01 | 16.89 | 129854.5% | operator |
| 11196 | Seq Scan | 0.01 | 45.79 | 457823.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11196 (Seq Scan) - LEAF
...
### Step 2: Node 11194 (Seq Scan) - LEAF
...
### Step 5: Node 11202 (Seq Scan) - LEAF
...
### Step 6: Node 11191 (Seq Scan) - LEAF
...
### Step 8: Node 11200 (Seq Scan) - LEAF
...
### Step 11: Node 11197 (Index Scan) - LEAF
...
### Step 13: Node 11189 (Nested Loop)
...
### Step 17: Node 11186 (Gather Merge)
...
### Step 18: Node 11185 (Aggregate) - ROOT
