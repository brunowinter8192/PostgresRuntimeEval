...
```
Node 11347 (Aggregate) - ROOT
  Node 11348 (Gather Merge)
    Node 11349 (Sort)
      Node 11350 (Hash Join)
        Node 11351 (Nested Loop)
          Node 11352 (Hash Join)
            Node 11353 (Seq Scan) - LEAF
            Node 11354 (Hash)
              Node 11355 (Hash Join)
                Node 11356 (Seq Scan) - LEAF
                Node 11357 (Hash)
                  Node 11358 (Seq Scan) - LEAF
          Node 11359 (Index Scan) - LEAF
        Node 11360 (Hash)
          Node 11361 (Hash Join)
            Node 11362 (Seq Scan) - LEAF
            Node 11363 (Hash)
              Node 11364 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 11347 | Aggregate | 1204.14 | 1209.26 | 0.4% | operator |
| 11348 | Gather Merge | 1203.07 | 1142.98 | 5.0% | operator |
| 11349 | Sort | 1197.48 | 1109.13 | 7.4% | operator |
| 11350 | Hash Join | 1196.87 | 842.59 | 29.6% | operator |
| 11351 | Nested Loop | 1189.46 | 1216.16 | 2.2% | operator |
| 11360 | Hash | 3.73 | 17.53 | 369.6% | operator |
| 11352 | Hash Join | 212.26 | 384.47 | 81.1% | operator |
| 11359 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 11361 | Hash Join | 3.69 | 85.17 | 2210.1% | operator |
| 11353 | Seq Scan | 148.47 | 201.16 | 35.5% | operator |
| 11354 | Hash | 37.19 | 19.59 | 47.3% | operator |
| 11362 | Seq Scan | 3.36 | 11.47 | 241.6% | operator |
| 11363 | Hash | 0.01 | 16.89 | 129854.5% | operator |
| 11355 | Hash Join | 36.84 | 92.20 | 150.3% | operator |
| 11364 | Seq Scan | 0.01 | 45.79 | 457823.2% | operator |
| 11356 | Seq Scan | 35.73 | 21.86 | 38.8% | operator |
| 11357 | Hash | 0.01 | 16.89 | 168840.8% | operator |
| 11358 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11358 (Seq Scan) - LEAF
...
### Step 2: Node 11356 (Seq Scan) - LEAF
...
### Step 5: Node 11364 (Seq Scan) - LEAF
...
### Step 6: Node 11353 (Seq Scan) - LEAF
...
### Step 8: Node 11362 (Seq Scan) - LEAF
...
### Step 11: Node 11359 (Index Scan) - LEAF
...
### Step 13: Node 11351 (Nested Loop)
...
### Step 17: Node 11348 (Gather Merge)
...
### Step 18: Node 11347 (Aggregate) - ROOT
