...
```
Node 12319 (Aggregate) - ROOT
  Node 12320 (Gather Merge)
    Node 12321 (Sort)
      Node 12322 (Hash Join)
        Node 12323 (Nested Loop)
          Node 12324 (Hash Join)
            Node 12325 (Seq Scan) - LEAF
            Node 12326 (Hash)
              Node 12327 (Hash Join)
                Node 12328 (Seq Scan) - LEAF
                Node 12329 (Hash)
                  Node 12330 (Seq Scan) - LEAF
          Node 12331 (Index Scan) - LEAF
        Node 12332 (Hash)
          Node 12333 (Hash Join)
            Node 12334 (Seq Scan) - LEAF
            Node 12335 (Hash)
              Node 12336 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12319 | Aggregate | 1202.35 | 1209.26 | 0.6% | operator |
| 12320 | Gather Merge | 1201.14 | 1142.98 | 4.8% | operator |
| 12321 | Sort | 1195.42 | 1109.13 | 7.2% | operator |
| 12322 | Hash Join | 1194.79 | 842.59 | 29.5% | operator |
| 12323 | Nested Loop | 1188.41 | 1216.16 | 2.3% | operator |
| 12332 | Hash | 2.49 | 17.53 | 604.9% | operator |
| 12324 | Hash Join | 213.43 | 384.47 | 80.1% | operator |
| 12331 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 12333 | Hash Join | 2.45 | 85.17 | 3382.2% | operator |
| 12325 | Seq Scan | 152.96 | 201.16 | 31.5% | operator |
| 12326 | Hash | 35.59 | 19.59 | 45.0% | operator |
| 12334 | Seq Scan | 2.13 | 11.47 | 438.8% | operator |
| 12335 | Hash | 0.02 | 16.89 | 84370.4% | operator |
| 12327 | Hash Join | 35.05 | 92.20 | 163.1% | operator |
| 12336 | Seq Scan | 0.02 | 45.79 | 286102.0% | operator |
| 12328 | Seq Scan | 33.95 | 21.86 | 35.6% | operator |
| 12329 | Hash | 0.01 | 16.89 | 187612.0% | operator |
| 12330 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12330 (Seq Scan) - LEAF
...
### Step 2: Node 12328 (Seq Scan) - LEAF
...
### Step 5: Node 12336 (Seq Scan) - LEAF
...
### Step 6: Node 12325 (Seq Scan) - LEAF
...
### Step 8: Node 12334 (Seq Scan) - LEAF
...
### Step 11: Node 12331 (Index Scan) - LEAF
...
### Step 13: Node 12323 (Nested Loop)
...
### Step 17: Node 12320 (Gather Merge)
...
### Step 18: Node 12319 (Aggregate) - ROOT
