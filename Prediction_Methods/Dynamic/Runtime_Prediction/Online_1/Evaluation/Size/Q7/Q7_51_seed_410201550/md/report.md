...
```
Node 12229 (Aggregate) - ROOT
  Node 12230 (Gather Merge)
    Node 12231 (Sort)
      Node 12232 (Hash Join)
        Node 12233 (Nested Loop)
          Node 12234 (Hash Join)
            Node 12235 (Seq Scan) - LEAF
            Node 12236 (Hash)
              Node 12237 (Hash Join)
                Node 12238 (Seq Scan) - LEAF
                Node 12239 (Hash)
                  Node 12240 (Seq Scan) - LEAF
          Node 12241 (Index Scan) - LEAF
        Node 12242 (Hash)
          Node 12243 (Hash Join)
            Node 12244 (Seq Scan) - LEAF
            Node 12245 (Hash)
              Node 12246 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12229 | Aggregate | 1202.06 | 1209.26 | 0.6% | operator |
| 12230 | Gather Merge | 1201.07 | 1142.98 | 4.8% | operator |
| 12231 | Sort | 1194.78 | 1109.13 | 7.2% | operator |
| 12232 | Hash Join | 1194.11 | 842.59 | 29.4% | operator |
| 12233 | Nested Loop | 1185.80 | 1216.16 | 2.6% | operator |
| 12242 | Hash | 4.63 | 17.53 | 278.7% | operator |
| 12234 | Hash Join | 216.20 | 384.47 | 77.8% | operator |
| 12241 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 12243 | Hash Join | 4.58 | 85.17 | 1760.1% | operator |
| 12235 | Seq Scan | 155.41 | 201.16 | 29.4% | operator |
| 12236 | Hash | 35.17 | 19.59 | 44.3% | operator |
| 12244 | Seq Scan | 4.26 | 11.47 | 169.5% | operator |
| 12245 | Hash | 0.01 | 16.89 | 112527.2% | operator |
| 12237 | Hash Join | 34.69 | 92.20 | 165.8% | operator |
| 12246 | Seq Scan | 0.01 | 45.79 | 381502.6% | operator |
| 12238 | Seq Scan | 33.58 | 21.86 | 34.9% | operator |
| 12239 | Hash | 0.01 | 16.89 | 112527.2% | operator |
| 12240 | Seq Scan | 0.01 | 45.79 | 381502.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12240 (Seq Scan) - LEAF
...
### Step 2: Node 12238 (Seq Scan) - LEAF
...
### Step 5: Node 12246 (Seq Scan) - LEAF
...
### Step 6: Node 12235 (Seq Scan) - LEAF
...
### Step 8: Node 12244 (Seq Scan) - LEAF
...
### Step 11: Node 12241 (Index Scan) - LEAF
...
### Step 13: Node 12233 (Nested Loop)
...
### Step 17: Node 12230 (Gather Merge)
...
### Step 18: Node 12229 (Aggregate) - ROOT
