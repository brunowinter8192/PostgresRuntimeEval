...
```
Node 11221 (Aggregate) - ROOT
  Node 11222 (Gather Merge)
    Node 11223 (Sort)
      Node 11224 (Hash Join)
        Node 11225 (Nested Loop)
          Node 11226 (Hash Join)
            Node 11227 (Seq Scan) - LEAF
            Node 11228 (Hash)
              Node 11229 (Hash Join)
                Node 11230 (Seq Scan) - LEAF
                Node 11231 (Hash)
                  Node 11232 (Seq Scan) - LEAF
          Node 11233 (Index Scan) - LEAF
        Node 11234 (Hash)
          Node 11235 (Hash Join)
            Node 11236 (Seq Scan) - LEAF
            Node 11237 (Hash)
              Node 11238 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 11221 | Aggregate | 1169.79 | 1209.26 | 3.4% | operator |
| 11222 | Gather Merge | 1168.65 | 1142.98 | 2.2% | operator |
| 11223 | Sort | 1163.13 | 1109.13 | 4.6% | operator |
| 11224 | Hash Join | 1162.52 | 842.59 | 27.5% | operator |
| 11225 | Nested Loop | 1156.10 | 1216.16 | 5.2% | operator |
| 11234 | Hash | 2.80 | 17.53 | 526.5% | operator |
| 11226 | Hash Join | 213.54 | 384.47 | 80.0% | operator |
| 11233 | Index Scan | 0.03 | 0.96 | 3006.0% | operator |
| 11235 | Hash Join | 2.75 | 85.17 | 2995.0% | operator |
| 11227 | Seq Scan | 151.57 | 201.16 | 32.7% | operator |
| 11228 | Hash | 31.43 | 19.59 | 37.7% | operator |
| 11236 | Seq Scan | 2.42 | 11.47 | 374.0% | operator |
| 11237 | Hash | 0.02 | 16.89 | 93756.0% | operator |
| 11229 | Hash Join | 30.97 | 92.20 | 197.7% | operator |
| 11238 | Seq Scan | 0.01 | 45.79 | 326988.0% | operator |
| 11230 | Seq Scan | 29.83 | 21.86 | 26.7% | operator |
| 11231 | Hash | 0.01 | 16.89 | 140684.0% | operator |
| 11232 | Seq Scan | 0.01 | 45.79 | 763105.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11232 (Seq Scan) - LEAF
...
### Step 2: Node 11230 (Seq Scan) - LEAF
...
### Step 5: Node 11238 (Seq Scan) - LEAF
...
### Step 6: Node 11227 (Seq Scan) - LEAF
...
### Step 8: Node 11236 (Seq Scan) - LEAF
...
### Step 11: Node 11233 (Index Scan) - LEAF
...
### Step 13: Node 11225 (Nested Loop)
...
### Step 17: Node 11222 (Gather Merge)
...
### Step 18: Node 11221 (Aggregate) - ROOT
