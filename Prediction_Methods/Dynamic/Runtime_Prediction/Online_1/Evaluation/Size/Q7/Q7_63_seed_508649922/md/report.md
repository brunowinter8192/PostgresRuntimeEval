...
```
Node 12463 (Aggregate) - ROOT
  Node 12464 (Gather Merge)
    Node 12465 (Sort)
      Node 12466 (Hash Join)
        Node 12467 (Nested Loop)
          Node 12468 (Hash Join)
            Node 12469 (Seq Scan) - LEAF
            Node 12470 (Hash)
              Node 12471 (Hash Join)
                Node 12472 (Seq Scan) - LEAF
                Node 12473 (Hash)
                  Node 12474 (Seq Scan) - LEAF
          Node 12475 (Index Scan) - LEAF
        Node 12476 (Hash)
          Node 12477 (Hash Join)
            Node 12478 (Seq Scan) - LEAF
            Node 12479 (Hash)
              Node 12480 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12463 | Aggregate | 1203.35 | 1209.26 | 0.5% | operator |
| 12464 | Gather Merge | 1202.25 | 1142.98 | 4.9% | operator |
| 12465 | Sort | 1193.61 | 1109.13 | 7.1% | operator |
| 12466 | Hash Join | 1193.01 | 842.59 | 29.4% | operator |
| 12467 | Nested Loop | 1185.04 | 1216.16 | 2.6% | operator |
| 12476 | Hash | 3.97 | 17.53 | 341.2% | operator |
| 12468 | Hash Join | 224.64 | 384.47 | 71.2% | operator |
| 12475 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 12477 | Hash Join | 3.93 | 85.17 | 2067.8% | operator |
| 12469 | Seq Scan | 158.08 | 201.16 | 27.3% | operator |
| 12470 | Hash | 36.20 | 19.59 | 45.9% | operator |
| 12478 | Seq Scan | 3.59 | 11.47 | 219.4% | operator |
| 12479 | Hash | 0.02 | 16.89 | 105488.0% | operator |
| 12471 | Hash Join | 35.90 | 92.20 | 156.8% | operator |
| 12480 | Seq Scan | 0.01 | 45.79 | 352148.6% | operator |
| 12472 | Seq Scan | 34.65 | 21.86 | 36.9% | operator |
| 12473 | Hash | 0.01 | 16.89 | 187612.0% | operator |
| 12474 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12474 (Seq Scan) - LEAF
...
### Step 2: Node 12472 (Seq Scan) - LEAF
...
### Step 5: Node 12480 (Seq Scan) - LEAF
...
### Step 6: Node 12469 (Seq Scan) - LEAF
...
### Step 8: Node 12478 (Seq Scan) - LEAF
...
### Step 11: Node 12475 (Index Scan) - LEAF
...
### Step 13: Node 12467 (Nested Loop)
...
### Step 17: Node 12464 (Gather Merge)
...
### Step 18: Node 12463 (Aggregate) - ROOT
