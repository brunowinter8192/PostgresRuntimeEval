...
```
Node 10573 (Aggregate) - ROOT
  Node 10574 (Gather Merge)
    Node 10575 (Sort)
      Node 10576 (Hash Join)
        Node 10577 (Nested Loop)
          Node 10578 (Hash Join)
            Node 10579 (Seq Scan) - LEAF
            Node 10580 (Hash)
              Node 10581 (Hash Join)
                Node 10582 (Seq Scan) - LEAF
                Node 10583 (Hash)
                  Node 10584 (Seq Scan) - LEAF
          Node 10585 (Index Scan) - LEAF
        Node 10586 (Hash)
          Node 10587 (Hash Join)
            Node 10588 (Seq Scan) - LEAF
            Node 10589 (Hash)
              Node 10590 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 10573 | Aggregate | 1188.49 | 1209.26 | 1.7% | operator |
| 10574 | Gather Merge | 1187.38 | 1142.98 | 3.7% | operator |
| 10575 | Sort | 1181.93 | 1109.13 | 6.2% | operator |
| 10576 | Hash Join | 1181.30 | 842.59 | 28.7% | operator |
| 10577 | Nested Loop | 1173.87 | 1216.16 | 3.6% | operator |
| 10586 | Hash | 3.73 | 17.53 | 370.3% | operator |
| 10578 | Hash Join | 209.88 | 384.47 | 83.2% | operator |
| 10585 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 10587 | Hash Join | 3.68 | 85.17 | 2217.0% | operator |
| 10579 | Seq Scan | 150.67 | 201.16 | 33.5% | operator |
| 10580 | Hash | 33.20 | 19.59 | 41.0% | operator |
| 10588 | Seq Scan | 3.33 | 11.47 | 244.0% | operator |
| 10589 | Hash | 0.02 | 16.89 | 88816.2% | operator |
| 10581 | Hash Join | 32.85 | 92.20 | 180.7% | operator |
| 10590 | Seq Scan | 0.01 | 45.79 | 352148.6% | operator |
| 10582 | Seq Scan | 30.92 | 21.86 | 29.3% | operator |
| 10583 | Hash | 0.01 | 16.89 | 153482.6% | operator |
| 10584 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10584 (Seq Scan) - LEAF
...
### Step 2: Node 10582 (Seq Scan) - LEAF
...
### Step 5: Node 10590 (Seq Scan) - LEAF
...
### Step 6: Node 10579 (Seq Scan) - LEAF
...
### Step 8: Node 10588 (Seq Scan) - LEAF
...
### Step 11: Node 10585 (Index Scan) - LEAF
...
### Step 13: Node 10577 (Nested Loop)
...
### Step 17: Node 10574 (Gather Merge)
...
### Step 18: Node 10573 (Aggregate) - ROOT
