...
```
Node 10627 (Aggregate) - ROOT
  Node 10628 (Gather Merge)
    Node 10629 (Sort)
      Node 10630 (Hash Join)
        Node 10631 (Nested Loop)
          Node 10632 (Hash Join)
            Node 10633 (Seq Scan) - LEAF
            Node 10634 (Hash)
              Node 10635 (Hash Join)
                Node 10636 (Seq Scan) - LEAF
                Node 10637 (Hash)
                  Node 10638 (Seq Scan) - LEAF
          Node 10639 (Index Scan) - LEAF
        Node 10640 (Hash)
          Node 10641 (Hash Join)
            Node 10642 (Seq Scan) - LEAF
            Node 10643 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 10627 | Aggregate | 1193.48 | 1209.26 | 1.3% | operator |
| 10628 | Gather Merge | 1192.36 | 1142.98 | 4.1% | operator |
| 10629 | Sort | 1186.51 | 1109.13 | 6.5% | operator |
| 10630 | Hash Join | 1185.90 | 842.59 | 28.9% | operator |
| 10631 | Nested Loop | 1178.93 | 1216.16 | 3.2% | operator |
| 10640 | Hash | 3.21 | 17.53 | 446.1% | operator |
| 10632 | Hash Join | 213.26 | 384.47 | 80.3% | operator |
| 10639 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 10641 | Hash Join | 3.16 | 85.17 | 2593.7% | operator |
| 10633 | Seq Scan | 150.33 | 201.16 | 33.8% | operator |
| 10634 | Hash | 37.92 | 19.59 | 48.3% | operator |
| 10642 | Seq Scan | 2.85 | 11.47 | 302.6% | operator |
| 10643 | Hash | 0.02 | 16.89 | 105488.0% | operator |
| 10635 | Hash Join | 37.51 | 92.20 | 145.8% | operator |
| 10644 | Seq Scan | 0.01 | 45.79 | 381502.6% | operator |
| 10636 | Seq Scan | 36.38 | 21.86 | 39.9% | operator |
| 10637 | Hash | 0.01 | 16.89 | 140684.0% | operator |
| 10638 | Seq Scan | 0.01 | 45.79 | 572303.9% | operator |
...
### Step 2: Node 10636 (Seq Scan) - LEAF
...
### Step 5: Node 10644 (Seq Scan) - LEAF
...
### Step 6: Node 10633 (Seq Scan) - LEAF
...
### Step 8: Node 10642 (Seq Scan) - LEAF
...
### Step 11: Node 10639 (Index Scan) - LEAF
...
### Step 13: Node 10631 (Nested Loop)
...
### Step 17: Node 10628 (Gather Merge)
...
### Step 18: Node 10627 (Aggregate) - ROOT
