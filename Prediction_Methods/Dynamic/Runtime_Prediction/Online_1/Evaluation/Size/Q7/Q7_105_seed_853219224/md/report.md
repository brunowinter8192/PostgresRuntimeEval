...
```
Node 10591 (Aggregate) - ROOT
  Node 10592 (Gather Merge)
    Node 10593 (Sort)
      Node 10594 (Hash Join)
        Node 10595 (Nested Loop)
          Node 10596 (Hash Join)
            Node 10597 (Seq Scan) - LEAF
            Node 10598 (Hash)
              Node 10599 (Hash Join)
                Node 10600 (Seq Scan) - LEAF
                Node 10601 (Hash)
                  Node 10602 (Seq Scan) - LEAF
          Node 10603 (Index Scan) - LEAF
        Node 10604 (Hash)
          Node 10605 (Hash Join)
            Node 10606 (Seq Scan) - LEAF
            Node 10607 (Hash)
              Node 10608 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 10591 | Aggregate | 1213.90 | 1209.26 | 0.4% | operator |
| 10592 | Gather Merge | 1212.94 | 1142.98 | 5.8% | operator |
| 10593 | Sort | 1207.03 | 1109.13 | 8.1% | operator |
| 10594 | Hash Join | 1206.41 | 842.59 | 30.2% | operator |
| 10595 | Nested Loop | 1199.89 | 1216.16 | 1.4% | operator |
| 10604 | Hash | 2.70 | 17.53 | 549.5% | operator |
| 10596 | Hash Join | 217.07 | 384.47 | 77.1% | operator |
| 10603 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 10605 | Hash Join | 2.66 | 85.17 | 3104.5% | operator |
| 10597 | Seq Scan | 154.42 | 201.16 | 30.3% | operator |
| 10598 | Hash | 35.66 | 19.59 | 45.1% | operator |
| 10606 | Seq Scan | 2.36 | 11.47 | 386.1% | operator |
| 10607 | Hash | 0.01 | 16.89 | 153482.6% | operator |
| 10599 | Hash Join | 34.91 | 92.20 | 164.1% | operator |
| 10608 | Seq Scan | 0.01 | 45.79 | 572303.9% | operator |
| 10600 | Seq Scan | 33.83 | 21.86 | 35.4% | operator |
| 10601 | Hash | 0.01 | 16.89 | 168840.8% | operator |
| 10602 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10602 (Seq Scan) - LEAF
...
### Step 2: Node 10600 (Seq Scan) - LEAF
...
### Step 5: Node 10608 (Seq Scan) - LEAF
...
### Step 6: Node 10597 (Seq Scan) - LEAF
...
### Step 8: Node 10606 (Seq Scan) - LEAF
...
### Step 11: Node 10603 (Index Scan) - LEAF
...
### Step 13: Node 10595 (Nested Loop)
...
### Step 17: Node 10592 (Gather Merge)
...
### Step 18: Node 10591 (Aggregate) - ROOT
