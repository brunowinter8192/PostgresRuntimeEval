...
```
Node 11761 (Aggregate) - ROOT
  Node 11762 (Gather Merge)
    Node 11763 (Sort)
      Node 11764 (Hash Join)
        Node 11765 (Nested Loop)
          Node 11766 (Hash Join)
            Node 11767 (Seq Scan) - LEAF
            Node 11768 (Hash)
              Node 11769 (Hash Join)
                Node 11770 (Seq Scan) - LEAF
                Node 11771 (Hash)
                  Node 11772 (Seq Scan) - LEAF
          Node 11773 (Index Scan) - LEAF
        Node 11774 (Hash)
          Node 11775 (Hash Join)
            Node 11776 (Seq Scan) - LEAF
            Node 11777 (Hash)
              Node 11778 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 11761 | Aggregate | 1206.47 | 1209.26 | 0.2% | operator |
| 11762 | Gather Merge | 1205.33 | 1142.98 | 5.2% | operator |
| 11763 | Sort | 1199.41 | 1109.13 | 7.5% | operator |
| 11764 | Hash Join | 1198.71 | 842.59 | 29.7% | operator |
| 11765 | Nested Loop | 1191.50 | 1216.16 | 2.1% | operator |
| 11774 | Hash | 3.46 | 17.53 | 406.5% | operator |
| 11766 | Hash Join | 214.62 | 384.47 | 79.1% | operator |
| 11773 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 11775 | Hash Join | 3.42 | 85.17 | 2393.4% | operator |
| 11767 | Seq Scan | 152.08 | 201.16 | 32.3% | operator |
| 11768 | Hash | 37.42 | 19.59 | 47.6% | operator |
| 11776 | Seq Scan | 3.09 | 11.47 | 271.7% | operator |
| 11777 | Hash | 0.01 | 16.89 | 129854.5% | operator |
| 11769 | Hash Join | 37.09 | 92.20 | 148.5% | operator |
| 11778 | Seq Scan | 0.01 | 45.79 | 457823.2% | operator |
| 11770 | Seq Scan | 35.96 | 21.86 | 39.2% | operator |
| 11771 | Hash | 0.01 | 16.89 | 187612.0% | operator |
| 11772 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11772 (Seq Scan) - LEAF
...
### Step 2: Node 11770 (Seq Scan) - LEAF
...
### Step 5: Node 11778 (Seq Scan) - LEAF
...
### Step 6: Node 11767 (Seq Scan) - LEAF
...
### Step 8: Node 11776 (Seq Scan) - LEAF
...
### Step 11: Node 11773 (Index Scan) - LEAF
...
### Step 13: Node 11765 (Nested Loop)
...
### Step 17: Node 11762 (Gather Merge)
...
### Step 18: Node 11761 (Aggregate) - ROOT
