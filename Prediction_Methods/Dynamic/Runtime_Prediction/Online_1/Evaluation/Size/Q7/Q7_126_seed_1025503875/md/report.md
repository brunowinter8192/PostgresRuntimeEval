...
```
Node 11005 (Aggregate) - ROOT
  Node 11006 (Gather Merge)
    Node 11007 (Sort)
      Node 11008 (Hash Join)
        Node 11009 (Nested Loop)
          Node 11010 (Hash Join)
            Node 11011 (Seq Scan) - LEAF
            Node 11012 (Hash)
              Node 11013 (Hash Join)
                Node 11014 (Seq Scan) - LEAF
                Node 11015 (Hash)
                  Node 11016 (Seq Scan) - LEAF
          Node 11017 (Index Scan) - LEAF
        Node 11018 (Hash)
          Node 11019 (Hash Join)
            Node 11020 (Seq Scan) - LEAF
            Node 11021 (Hash)
              Node 11022 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 11005 | Aggregate | 1214.59 | 1209.26 | 0.4% | operator |
| 11006 | Gather Merge | 1213.28 | 1142.98 | 5.8% | operator |
| 11007 | Sort | 1206.86 | 1109.13 | 8.1% | operator |
| 11008 | Hash Join | 1206.20 | 842.59 | 30.1% | operator |
| 11009 | Nested Loop | 1199.34 | 1216.16 | 1.4% | operator |
| 11018 | Hash | 2.91 | 17.53 | 502.4% | operator |
| 11010 | Hash Join | 218.57 | 384.47 | 75.9% | operator |
| 11017 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 11019 | Hash Join | 2.86 | 85.17 | 2876.0% | operator |
| 11011 | Seq Scan | 153.93 | 201.16 | 30.7% | operator |
| 11012 | Hash | 37.65 | 19.59 | 48.0% | operator |
| 11020 | Seq Scan | 2.51 | 11.47 | 356.3% | operator |
| 11021 | Hash | 0.01 | 16.89 | 120572.0% | operator |
| 11013 | Hash Join | 36.29 | 92.20 | 154.1% | operator |
| 11022 | Seq Scan | 0.01 | 45.79 | 416193.8% | operator |
| 11014 | Seq Scan | 35.20 | 21.86 | 37.9% | operator |
| 11015 | Hash | 0.01 | 16.89 | 187612.0% | operator |
| 11016 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11016 (Seq Scan) - LEAF
...
### Step 2: Node 11014 (Seq Scan) - LEAF
...
### Step 5: Node 11022 (Seq Scan) - LEAF
...
### Step 6: Node 11011 (Seq Scan) - LEAF
...
### Step 8: Node 11020 (Seq Scan) - LEAF
...
### Step 11: Node 11017 (Index Scan) - LEAF
...
### Step 13: Node 11009 (Nested Loop)
...
### Step 17: Node 11006 (Gather Merge)
...
### Step 18: Node 11005 (Aggregate) - ROOT
