...
```
Node 10681 (Aggregate) - ROOT
  Node 10682 (Gather Merge)
    Node 10683 (Sort)
      Node 10684 (Hash Join)
        Node 10685 (Nested Loop)
          Node 10686 (Hash Join)
            Node 10687 (Seq Scan) - LEAF
            Node 10688 (Hash)
              Node 10689 (Hash Join)
                Node 10690 (Seq Scan) - LEAF
                Node 10691 (Hash)
                  Node 10692 (Seq Scan) - LEAF
          Node 10693 (Index Scan) - LEAF
        Node 10694 (Hash)
          Node 10695 (Hash Join)
            Node 10696 (Seq Scan) - LEAF
            Node 10697 (Hash)
              Node 10698 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 10681 | Aggregate | 1194.39 | 1209.26 | 1.2% | operator |
| 10682 | Gather Merge | 1193.46 | 1142.98 | 4.2% | operator |
| 10683 | Sort | 1185.75 | 1109.13 | 6.5% | operator |
| 10684 | Hash Join | 1185.16 | 842.59 | 28.9% | operator |
| 10685 | Nested Loop | 1177.67 | 1216.16 | 3.3% | operator |
| 10694 | Hash | 3.81 | 17.53 | 359.7% | operator |
| 10686 | Hash Join | 215.60 | 384.47 | 78.3% | operator |
| 10693 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 10695 | Hash Join | 3.77 | 85.17 | 2158.7% | operator |
| 10687 | Seq Scan | 153.08 | 201.16 | 31.4% | operator |
| 10688 | Hash | 37.41 | 19.59 | 47.6% | operator |
| 10696 | Seq Scan | 3.44 | 11.47 | 233.3% | operator |
| 10697 | Hash | 0.01 | 16.89 | 129854.5% | operator |
| 10689 | Hash Join | 36.63 | 92.20 | 151.7% | operator |
| 10698 | Seq Scan | 0.01 | 45.79 | 416193.8% | operator |
| 10690 | Seq Scan | 35.46 | 21.86 | 38.4% | operator |
| 10691 | Hash | 0.01 | 16.89 | 168840.8% | operator |
| 10692 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10692 (Seq Scan) - LEAF
...
### Step 2: Node 10690 (Seq Scan) - LEAF
...
### Step 5: Node 10698 (Seq Scan) - LEAF
...
### Step 6: Node 10687 (Seq Scan) - LEAF
...
### Step 8: Node 10696 (Seq Scan) - LEAF
...
### Step 11: Node 10693 (Index Scan) - LEAF
...
### Step 13: Node 10685 (Nested Loop)
...
### Step 17: Node 10682 (Gather Merge)
...
### Step 18: Node 10681 (Aggregate) - ROOT
