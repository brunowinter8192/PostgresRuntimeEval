...
```
Node 12067 (Aggregate) - ROOT
  Node 12068 (Gather Merge)
    Node 12069 (Sort)
      Node 12070 (Hash Join)
        Node 12071 (Nested Loop)
          Node 12072 (Hash Join)
            Node 12073 (Seq Scan) - LEAF
            Node 12074 (Hash)
              Node 12075 (Hash Join)
                Node 12076 (Seq Scan) - LEAF
                Node 12077 (Hash)
                  Node 12078 (Seq Scan) - LEAF
          Node 12079 (Index Scan) - LEAF
        Node 12080 (Hash)
          Node 12081 (Hash Join)
            Node 12082 (Seq Scan) - LEAF
            Node 12083 (Hash)
              Node 12084 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12067 | Aggregate | 1182.81 | 1209.26 | 2.2% | operator |
| 12068 | Gather Merge | 1181.52 | 1142.98 | 3.3% | operator |
| 12069 | Sort | 1175.64 | 1109.13 | 5.7% | operator |
| 12070 | Hash Join | 1175.02 | 842.59 | 28.3% | operator |
| 12071 | Nested Loop | 1163.94 | 1216.16 | 4.5% | operator |
| 12080 | Hash | 7.29 | 17.53 | 140.5% | operator |
| 12072 | Hash Join | 212.51 | 384.47 | 80.9% | operator |
| 12079 | Index Scan | 0.03 | 0.96 | 3006.0% | operator |
| 12081 | Hash Join | 7.25 | 85.17 | 1075.1% | operator |
| 12073 | Seq Scan | 152.88 | 201.16 | 31.6% | operator |
| 12074 | Hash | 32.87 | 19.59 | 40.4% | operator |
| 12082 | Seq Scan | 6.92 | 11.47 | 65.7% | operator |
| 12083 | Hash | 0.01 | 16.89 | 120572.0% | operator |
| 12075 | Hash Join | 32.62 | 92.20 | 182.7% | operator |
| 12084 | Seq Scan | 0.01 | 45.79 | 457823.2% | operator |
| 12076 | Seq Scan | 31.44 | 21.86 | 30.5% | operator |
| 12077 | Hash | 0.01 | 16.89 | 168840.8% | operator |
| 12078 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12078 (Seq Scan) - LEAF
...
### Step 2: Node 12076 (Seq Scan) - LEAF
...
### Step 5: Node 12084 (Seq Scan) - LEAF
...
### Step 6: Node 12073 (Seq Scan) - LEAF
...
### Step 8: Node 12082 (Seq Scan) - LEAF
...
### Step 11: Node 12079 (Index Scan) - LEAF
...
### Step 13: Node 12071 (Nested Loop)
...
### Step 17: Node 12068 (Gather Merge)
...
### Step 18: Node 12067 (Aggregate) - ROOT
