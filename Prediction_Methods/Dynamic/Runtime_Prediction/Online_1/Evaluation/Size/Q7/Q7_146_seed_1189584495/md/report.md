...
```
Node 11401 (Aggregate) - ROOT
  Node 11402 (Gather Merge)
    Node 11403 (Sort)
      Node 11404 (Hash Join)
        Node 11405 (Nested Loop)
          Node 11406 (Hash Join)
            Node 11407 (Seq Scan) - LEAF
            Node 11408 (Hash)
              Node 11409 (Hash Join)
                Node 11410 (Seq Scan) - LEAF
                Node 11411 (Hash)
                  Node 11412 (Seq Scan) - LEAF
          Node 11413 (Index Scan) - LEAF
        Node 11414 (Hash)
          Node 11415 (Hash Join)
            Node 11416 (Seq Scan) - LEAF
            Node 11417 (Hash)
              Node 11418 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 11401 | Aggregate | 1182.95 | 1209.26 | 2.2% | operator |
| 11402 | Gather Merge | 1181.83 | 1142.98 | 3.3% | operator |
| 11403 | Sort | 1176.89 | 1109.13 | 5.8% | operator |
| 11404 | Hash Join | 1176.21 | 842.59 | 28.4% | operator |
| 11405 | Nested Loop | 1168.65 | 1216.16 | 4.1% | operator |
| 11414 | Hash | 3.68 | 17.53 | 376.4% | operator |
| 11406 | Hash Join | 212.55 | 384.47 | 80.9% | operator |
| 11413 | Index Scan | 0.03 | 0.96 | 3006.0% | operator |
| 11415 | Hash Join | 3.62 | 85.17 | 2250.3% | operator |
| 11407 | Seq Scan | 151.34 | 201.16 | 32.9% | operator |
| 11408 | Hash | 35.85 | 19.59 | 45.4% | operator |
| 11416 | Seq Scan | 2.85 | 11.47 | 302.6% | operator |
| 11417 | Hash | 0.02 | 16.89 | 105488.0% | operator |
| 11409 | Hash Join | 35.23 | 92.20 | 161.7% | operator |
| 11418 | Seq Scan | 0.01 | 45.79 | 381502.6% | operator |
| 11410 | Seq Scan | 34.12 | 21.86 | 35.9% | operator |
| 11411 | Hash | 0.01 | 16.89 | 168840.8% | operator |
| 11412 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11412 (Seq Scan) - LEAF
...
### Step 2: Node 11410 (Seq Scan) - LEAF
...
### Step 5: Node 11418 (Seq Scan) - LEAF
...
### Step 6: Node 11407 (Seq Scan) - LEAF
...
### Step 8: Node 11416 (Seq Scan) - LEAF
...
### Step 11: Node 11413 (Index Scan) - LEAF
...
### Step 13: Node 11405 (Nested Loop)
...
### Step 17: Node 11402 (Gather Merge)
...
### Step 18: Node 11401 (Aggregate) - ROOT
