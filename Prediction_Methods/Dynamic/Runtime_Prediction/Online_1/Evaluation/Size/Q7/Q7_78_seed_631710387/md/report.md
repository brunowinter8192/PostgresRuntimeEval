...
```
Node 12751 (Aggregate) - ROOT
  Node 12752 (Gather Merge)
    Node 12753 (Sort)
      Node 12754 (Hash Join)
        Node 12755 (Nested Loop)
          Node 12756 (Hash Join)
            Node 12757 (Seq Scan) - LEAF
            Node 12758 (Hash)
              Node 12759 (Hash Join)
                Node 12760 (Seq Scan) - LEAF
                Node 12761 (Hash)
                  Node 12762 (Seq Scan) - LEAF
          Node 12763 (Index Scan) - LEAF
        Node 12764 (Hash)
          Node 12765 (Hash Join)
            Node 12766 (Seq Scan) - LEAF
            Node 12767 (Hash)
              Node 12768 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12751 | Aggregate | 1221.62 | 1209.26 | 1.0% | operator |
| 12752 | Gather Merge | 1220.62 | 1142.98 | 6.4% | operator |
| 12753 | Sort | 1214.63 | 1109.13 | 8.7% | operator |
| 12754 | Hash Join | 1214.03 | 842.59 | 30.6% | operator |
| 12755 | Nested Loop | 1206.03 | 1216.16 | 0.8% | operator |
| 12764 | Hash | 4.10 | 17.53 | 327.8% | operator |
| 12756 | Hash Join | 217.14 | 384.47 | 77.1% | operator |
| 12763 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 12765 | Hash Join | 4.05 | 85.17 | 2000.5% | operator |
| 12757 | Seq Scan | 152.28 | 201.16 | 32.1% | operator |
| 12758 | Hash | 38.37 | 19.59 | 48.9% | operator |
| 12766 | Seq Scan | 3.73 | 11.47 | 207.5% | operator |
| 12767 | Hash | 0.02 | 16.89 | 105488.0% | operator |
| 12759 | Hash Join | 36.20 | 92.20 | 154.7% | operator |
| 12768 | Seq Scan | 0.01 | 45.79 | 381502.6% | operator |
| 12760 | Seq Scan | 35.02 | 21.86 | 37.6% | operator |
| 12761 | Hash | 0.01 | 16.89 | 187612.0% | operator |
| 12762 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12762 (Seq Scan) - LEAF
...
### Step 2: Node 12760 (Seq Scan) - LEAF
...
### Step 5: Node 12768 (Seq Scan) - LEAF
...
### Step 6: Node 12757 (Seq Scan) - LEAF
...
### Step 8: Node 12766 (Seq Scan) - LEAF
...
### Step 11: Node 12763 (Index Scan) - LEAF
...
### Step 13: Node 12755 (Nested Loop)
...
### Step 17: Node 12752 (Gather Merge)
...
### Step 18: Node 12751 (Aggregate) - ROOT
