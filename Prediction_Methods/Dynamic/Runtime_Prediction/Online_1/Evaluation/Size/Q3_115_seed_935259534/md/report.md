...
**Test Query:** Q3_115_seed_935259534
...
```
Node 4511 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 4512 (Sort) [consumed]
    Node 4513 (Aggregate) [consumed]
      Node 4514 (Gather) [consumed]
        Node 4515 (Nested Loop)
          Node 4516 (Hash Join) [PATTERN: 895c6e8c]
            Node 4517 (Seq Scan) [consumed] - LEAF
            Node 4518 (Hash) [consumed]
              Node 4519 (Seq Scan) - LEAF
          Node 4520 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4511 | 4512, 4513, 4514, 4516, 4517, 4518 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4516 | 4511, 4512, 4513, 4514, 4517, 4518 |
...
|------|------|--------|-----------|-----|--------|
| 4511 | Limit | 1234.36 | 1151.18 | 6.7% | pattern |
| 4515 | Nested Loop | 1198.14 | 1192.99 | 0.4% | operator |
| 4516 | Hash Join | 213.80 | 242.47 | 13.4% | pattern |
| 4520 | Index Scan | 0.03 | -0.52 | 2018.8% | operator |
| 4519 | Seq Scan | 31.05 | 38.53 | 24.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4519 (Seq Scan) - LEAF
...
### Step 2: Node 4516 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4511, 4512, 4513, 4514, 4517, 4518
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46830
  - HashJoin_nt1=232682
...
- **Output:** st=29.78, rt=242.47

### Step 3: Node 4520 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=72892.2200
- **Output:** st=121.73, rt=1192.99

### Step 5: Node 4511 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4512, 4513, 4514, 4516, 4517, 4518
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=315605
  - Aggregate_Outer_nt1=315605
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110186.7900
  - Aggregate_Outer_total_cost=114131.8600
  - Gather_Outer_np=0
  - Gather_Outer_nt=315605
  - Gather_Outer_nt1=101808
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105452.7200
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=315605
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=120951.9700
  - Limit_total_cost=120951.9900
  - Sort_Outer_np=0
  - Sort_Outer_nt=315605
  - Sort_Outer_nt1=315605
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=120951.9700
  - Sort_Outer_total_cost=121740.9800
