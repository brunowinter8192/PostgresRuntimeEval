...
```
Node 12895 (Aggregate) - ROOT
  Node 12896 (Gather Merge)
    Node 12897 (Sort)
      Node 12898 (Hash Join)
        Node 12899 (Nested Loop)
          Node 12900 (Hash Join)
            Node 12901 (Seq Scan) - LEAF
            Node 12902 (Hash)
              Node 12903 (Hash Join)
                Node 12904 (Seq Scan) - LEAF
                Node 12905 (Hash)
                  Node 12906 (Seq Scan) - LEAF
          Node 12907 (Index Scan) - LEAF
        Node 12908 (Hash)
          Node 12909 (Hash Join)
            Node 12910 (Seq Scan) - LEAF
            Node 12911 (Hash)
              Node 12912 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12895 | Aggregate | 1212.39 | 1209.26 | 0.3% | operator |
| 12896 | Gather Merge | 1211.19 | 1142.98 | 5.6% | operator |
| 12897 | Sort | 1205.93 | 1109.13 | 8.0% | operator |
| 12898 | Hash Join | 1205.28 | 842.59 | 30.1% | operator |
| 12899 | Nested Loop | 1198.23 | 1216.16 | 1.5% | operator |
| 12908 | Hash | 3.33 | 17.53 | 425.8% | operator |
| 12900 | Hash Join | 212.72 | 384.47 | 80.7% | operator |
| 12907 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 12909 | Hash Join | 3.29 | 85.17 | 2490.5% | operator |
| 12901 | Seq Scan | 151.26 | 201.16 | 33.0% | operator |
| 12902 | Hash | 34.13 | 19.59 | 42.6% | operator |
| 12910 | Seq Scan | 2.93 | 11.47 | 291.5% | operator |
| 12911 | Hash | 0.01 | 16.89 | 120572.0% | operator |
| 12903 | Hash Join | 33.80 | 92.20 | 172.8% | operator |
| 12912 | Seq Scan | 0.01 | 45.79 | 416193.8% | operator |
| 12904 | Seq Scan | 32.66 | 21.86 | 33.1% | operator |
| 12905 | Hash | 0.01 | 16.89 | 187612.0% | operator |
| 12906 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12906 (Seq Scan) - LEAF
...
### Step 2: Node 12904 (Seq Scan) - LEAF
...
### Step 5: Node 12912 (Seq Scan) - LEAF
...
### Step 6: Node 12901 (Seq Scan) - LEAF
...
### Step 8: Node 12910 (Seq Scan) - LEAF
...
### Step 11: Node 12907 (Index Scan) - LEAF
...
### Step 13: Node 12899 (Nested Loop)
...
### Step 17: Node 12896 (Gather Merge)
...
### Step 18: Node 12895 (Aggregate) - ROOT
