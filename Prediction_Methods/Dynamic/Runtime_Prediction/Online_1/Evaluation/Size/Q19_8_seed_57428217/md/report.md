...
**Test Query:** Q19_8_seed_57428217
...
```
Node 32186 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 32187 (Gather) [consumed]
    Node 32188 (Aggregate) [consumed]
      Node 32189 (Hash Join) [consumed]
        Node 32190 (Seq Scan) - LEAF
        Node 32191 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 32186 | 32187, 32188, 32189 |
...
|------|------|--------|-----------|-----|--------|
| 32186 | Aggregate | 830.44 | 829.28 | 0.1% | pattern |
| 32190 | Seq Scan | 762.64 | 743.46 | 2.5% | operator |
| 32191 | Hash | 44.71 | 8.29 | 81.5% | operator |
| 32192 | Seq Scan | 44.59 | 23.76 | 46.7% | operator |
...
### Step 2: Node 32190 (Seq Scan) - LEAF
...
### Step 4: Node 32186 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 32187, 32188, 32189
- **Input Features:**
