...
Node 341 (Aggregate) - ROOT
  Node 342 (Gather Merge)
    Node 343 (Sort) [PATTERN: 1d35fb97]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 343 | 344 |
...
|------|------|--------|-----------|-----|--------|
| 341 | Aggregate | 922.70 | 1195.96 | 29.6% | operator |
| 342 | Gather Merge | 922.64 | 1165.93 | 26.4% | operator |
| 343 | Sort | 901.86 | 1200.80 | 33.1% | pattern |
...
### Step 2: Node 343 (Sort) - PATTERN ROOT
...
### Step 4: Node 341 (Aggregate) - ROOT
