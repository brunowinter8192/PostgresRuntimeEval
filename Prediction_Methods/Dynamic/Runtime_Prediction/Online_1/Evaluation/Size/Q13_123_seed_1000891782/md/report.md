...
**Test Query:** Q13_123_seed_1000891782
...
```
Node 25545 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25546 (Aggregate) [consumed]
    Node 25547 (Aggregate)
      Node 25548 (Hash Join) [PATTERN: 895c6e8c]
        Node 25549 (Seq Scan) [consumed] - LEAF
        Node 25550 (Hash) [consumed]
          Node 25551 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25545 | 25546, 25548, 25549, 25550 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25548 | 25545, 25546, 25549, 25550 |
...
|------|------|--------|-----------|-----|--------|
| 25545 | Sort | 893.73 | 1079.94 | 20.8% | pattern |
| 25547 | Aggregate | 887.59 | 999.76 | 12.6% | operator |
| 25548 | Hash Join | 678.00 | 470.31 | 30.6% | pattern |
| 25551 | Index Only Scan | 11.29 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25551 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25548 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25545, 25546, 25549, 25550
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 25545 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25546, 25548, 25549, 25550
- **Input Features:**
