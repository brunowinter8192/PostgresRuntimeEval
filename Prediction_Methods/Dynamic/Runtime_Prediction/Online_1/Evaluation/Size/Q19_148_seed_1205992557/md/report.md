...
**Test Query:** Q19_148_seed_1205992557
...
```
Node 31584 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31585 (Gather) [consumed]
    Node 31586 (Aggregate) [consumed]
      Node 31587 (Hash Join) [consumed]
        Node 31588 (Seq Scan) - LEAF
        Node 31589 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31584 | 31585, 31586, 31587 |
...
|------|------|--------|-----------|-----|--------|
| 31584 | Aggregate | 864.59 | 829.35 | 4.1% | pattern |
| 31588 | Seq Scan | 794.92 | 743.46 | 6.5% | operator |
| 31589 | Hash | 48.75 | 8.29 | 83.0% | operator |
| 31590 | Seq Scan | 48.63 | 23.76 | 51.1% | operator |
...
### Step 2: Node 31588 (Seq Scan) - LEAF
...
### Step 4: Node 31584 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31585, 31586, 31587
- **Input Features:**
  ...
  - Aggregate_Outer_startup_cost=156338.8500
  - Aggregate_Outer_total_cost=156338.8600
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Gather_Outer_startup_cost=157338.8500
  - Gather_Outer_total_cost=157339.3600
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=23
  - HashJoin_Outer_nt1=22527
  - HashJoin_Outer_nt2=207
  - HashJoin_Outer_parallel_workers=0
  - HashJoin_Outer_plan_width=12
  - HashJoin_Outer_reltuples=0.0000
  - HashJoin_Outer_sel=0.0000
  - HashJoin_Outer_startup_cost=7672.2500
  - HashJoin_Outer_total_cost=156338.6800
