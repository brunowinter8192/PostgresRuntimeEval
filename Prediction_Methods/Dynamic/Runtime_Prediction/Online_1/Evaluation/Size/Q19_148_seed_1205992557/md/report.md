...
```
Node 31584 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31585 (Gather) [consumed]
    Node 31586 (Aggregate) [consumed]
      Node 31587 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31584 | 31585, 31586 |
...
|------|------|--------|-----------|-----|--------|
| 31584 | Aggregate | 864.59 | 831.20 | 3.9% | pattern |
| 31587 | Hash Join | 845.25 | 766.06 | 9.4% | operator |
...
- **Input Features:**
  ...
  - st1=7.8285
  - st2=8.2847
  - startup_cost=7672.2500
  - total_cost=156338.6800
- **Output:** st=60.26, rt=766.06

### Step 5: Node 31584 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31585, 31586
- **Input Features:**
