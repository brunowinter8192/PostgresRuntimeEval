...
```
Node 31269 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31270 (Gather) [consumed]
    Node 31271 (Aggregate) [consumed]
      Node 31272 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31269 | 31270, 31271, 31272 |
...
|------|------|--------|-----------|-----|--------|
| 31269 | Aggregate | 853.39 | 829.28 | 2.8% | pattern |
...
### Step 4: Node 31269 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31270, 31271, 31272
- **Input Features:**
