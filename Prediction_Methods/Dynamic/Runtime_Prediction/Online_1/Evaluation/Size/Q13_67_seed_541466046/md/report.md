...
```
Node 26161 (Sort) - ROOT
  Node 26162 (Aggregate)
    Node 26163 (Aggregate)
      Node 26164 (Hash Join)
        Node 26165 (Seq Scan) - LEAF
        Node 26166 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 26161 | Sort | 940.74 | 1081.93 | 15.0% | operator |
| 26162 | Aggregate | 940.73 | 1000.33 | 6.3% | operator |
| 26163 | Aggregate | 934.73 | 1014.39 | 8.5% | operator |
| 26164 | Hash Join | 720.61 | 787.83 | 9.3% | operator |
| 26165 | Seq Scan | 509.60 | 264.19 | 48.2% | operator |
| 26166 | Hash | 15.48 | 80.15 | 417.8% | operator |
...
### Step 2: Node 26165 (Seq Scan) - LEAF
