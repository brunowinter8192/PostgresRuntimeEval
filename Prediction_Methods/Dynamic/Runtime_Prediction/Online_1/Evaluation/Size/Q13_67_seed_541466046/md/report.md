...
**Test Query:** Q13_67_seed_541466046
...
```
Node 26161 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26162 (Aggregate) [consumed]
    Node 26163 (Aggregate)
      Node 26164 (Hash Join) [PATTERN: 895c6e8c]
        Node 26165 (Seq Scan) [consumed] - LEAF
        Node 26166 (Hash) [consumed]
          Node 26167 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26161 | 26162, 26164, 26165, 26166 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26164 | 26161, 26162, 26165, 26166 |
...
|------|------|--------|-----------|-----|--------|
| 26161 | Sort | 940.74 | 1079.94 | 14.8% | pattern |
| 26163 | Aggregate | 934.73 | 999.76 | 7.0% | operator |
| 26164 | Hash Join | 720.61 | 470.31 | 34.7% | pattern |
| 26167 | Index Only Scan | 10.29 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26167 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26164 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26161, 26162, 26165, 26166
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 26161 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26162, 26164, 26165, 26166
- **Input Features:**
