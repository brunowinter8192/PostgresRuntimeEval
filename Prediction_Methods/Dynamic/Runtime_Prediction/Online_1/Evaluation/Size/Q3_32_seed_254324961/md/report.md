...
**Test Query:** Q3_32_seed_254324961
...
```
Node 5101 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5102 (Sort) [consumed]
    Node 5103 (Aggregate) [consumed]
      Node 5104 (Gather) [consumed]
        Node 5105 (Nested Loop)
          Node 5106 (Hash Join) [PATTERN: 895c6e8c]
            Node 5107 (Seq Scan) [consumed] - LEAF
            Node 5108 (Hash) [consumed]
              Node 5109 (Seq Scan) - LEAF
          Node 5110 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5101 | 5102, 5103, 5104, 5106, 5107, 5108 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5106 | 5101, 5102, 5103, 5104, 5107, 5108 |
...
|------|------|--------|-----------|-----|--------|
| 5101 | Limit | 1183.89 | 1151.18 | 2.8% | pattern |
| 5105 | Nested Loop | 1146.94 | 1193.31 | 4.0% | operator |
| 5106 | Hash Join | 204.82 | 242.53 | 18.4% | pattern |
| 5110 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5109 | Seq Scan | 26.18 | 38.57 | 47.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5109 (Seq Scan) - LEAF
...
### Step 2: Node 5106 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5101, 5102, 5103, 5104, 5107, 5108
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47328
  - HashJoin_nt1=237043
  ...
  - HashJoin_total_cost=37343.8800
  - Hash_Inner_np=0
  - Hash_Inner_nt=12479
...
### Step 3: Node 5110 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=73109.2000
- **Output:** st=122.07, rt=1193.31

### Step 5: Node 5101 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5102, 5103, 5104, 5106, 5107, 5108
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=313591
  - Aggregate_Outer_nt1=313591
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110172.1700
  - Aggregate_Outer_total_cost=114092.0500
  - Gather_Outer_np=0
  - Gather_Outer_nt=313591
  - Gather_Outer_nt1=101158
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105468.3000
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=313591
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=120868.6400
  - Limit_total_cost=120868.6700
  - Sort_Outer_np=0
  - Sort_Outer_nt=313591
  - Sort_Outer_nt1=313591
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=120868.6400
  - Sort_Outer_total_cost=121652.6200
