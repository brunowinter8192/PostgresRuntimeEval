...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5101 | 5102, 5103, 5104 |
...
| 5105 | Nested Loop | 1146.94 | 1193.23 | 4.0% | operator |
| 5106 | Hash Join | 204.82 | 231.17 | 12.9% | operator |
| 5110 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5107 | Seq Scan | 154.71 | 163.52 | 5.7% | operator |
| 5108 | Hash | 26.92 | 17.75 | 34.1% | operator |
...
### Step 2: Node 5107 (Seq Scan) - LEAF
...
- **Output:** st=0.29, rt=163.52

### Step 3: Node 5108 (Hash)
...
- **Input Features:**
  ...
  - total_cost=37343.8800
- **Output:** st=27.27, rt=231.17

### Step 5: Node 5110 (Index Scan) - LEAF
...
- **Output:** st=121.93, rt=1193.23

### Step 7: Node 5101 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5102, 5103, 5104
- **Input Features:**
