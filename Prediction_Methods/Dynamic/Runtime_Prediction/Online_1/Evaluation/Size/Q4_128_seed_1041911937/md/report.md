...
```
Node 6061 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6062 (Gather Merge) [consumed]
    Node 6063 (Sort) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6061 | 6062, 6063, 6064 |
...
|------|------|--------|-----------|-----|--------|
| 6061 | Aggregate | 1054.60 | 952.19 | 9.7% | pattern |
| 6065 | Nested Loop | 1047.96 | 1255.45 | 19.8% | operator |
| 6066 | Seq Scan | 164.99 | 154.66 | 6.3% | operator |
| 6067 | Index Scan | 0.06 | 11.10 | 18103.9% | operator |
...
### Step 4: Node 6061 (Aggregate) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Sort_Outer_startup_cost=65940.0200
  - Sort_Outer_total_cost=65940.0400
