...
**Test Query:** Q6_47_seed_377385426
...
```
Node 10265 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10266 (Gather) [consumed]
    Node 10267 (Aggregate) [consumed]
      Node 10268 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10265 | 10266, 10267 |
...
|------|------|--------|-----------|-----|--------|
| 10265 | Aggregate | 774.92 | 849.99 | 9.7% | pattern |
| 10268 | Seq Scan | 753.93 | 748.50 | 0.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10268 (Seq Scan) - LEAF
...
### Step 2: Node 10265 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10266, 10267
- **Input Features:**
