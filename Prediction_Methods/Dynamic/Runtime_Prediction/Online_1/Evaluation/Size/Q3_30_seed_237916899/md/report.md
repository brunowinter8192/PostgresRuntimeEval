    ...
    Node 5083 (Aggregate) [consumed]
      Node 5084 (Gather) [consumed]
        Node 5085 (Nested Loop)
          Node 5086 (Hash Join) [PATTERN: 895c6e8c]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5081 | 5082, 5083, 5084, 5086, 5087, 5088 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5086 | 5081, 5082, 5083, 5084, 5087, 5088 |
...
|------|------|--------|-----------|-----|--------|
| 5081 | Limit | 1200.94 | 1151.18 | 4.1% | pattern |
| 5085 | Nested Loop | 1164.10 | 1192.44 | 2.4% | operator |
| 5086 | Hash Join | 207.67 | 242.36 | 16.7% | pattern |
| 5090 | Index Scan | 0.03 | -0.52 | 2018.8% | operator |
| 5089 | Seq Scan | 28.63 | 38.60 | 34.8% | operator |
...
### Step 2: Node 5086 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5081, 5082, 5083, 5084, 5087, 5088
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=45964
  - HashJoin_nt1=231734
...
- **Output:** st=29.82, rt=242.36

### Step 3: Node 5090 (Index Scan) - LEAF
...
- **Output:** st=121.22, rt=1192.44

### Step 5: Node 5081 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5082, 5083, 5084, 5086, 5087, 5088
- **Input Features:**
