...
**Test Query:** Q14_13_seed_98448372
...
```
Node 26721 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26722 (Gather) [consumed]
    Node 26723 (Aggregate) [consumed]
      Node 26724 (Hash Join) [consumed]
        Node 26725 (Seq Scan) - LEAF
        Node 26726 (Hash)
          Node 26727 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26721 | 26722, 26723, 26724 |
...
|------|------|--------|-----------|-----|--------|
| 26721 | Aggregate | 821.08 | 857.12 | 4.4% | pattern |
| 26725 | Seq Scan | 747.43 | 758.47 | 1.5% | operator |
| 26726 | Hash | 43.95 | 9.38 | 78.7% | operator |
| 26727 | Seq Scan | 37.99 | 12.70 | 66.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26727 (Seq Scan) - LEAF
...
### Step 2: Node 26725 (Seq Scan) - LEAF
...
### Step 4: Node 26721 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26722, 26723, 26724
- **Input Features:**
