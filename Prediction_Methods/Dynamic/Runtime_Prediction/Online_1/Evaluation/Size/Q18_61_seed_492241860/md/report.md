        ...
        Node 30536 (Incremental Sort)
          Node 30537 (Nested Loop)
            Node 30538 (Merge Join)
              Node 30539 (Sort)
                Node 30540 (Hash Join)
                  Node 30541 (Seq Scan) - LEAF
                  Node 30542 (Hash)
...
| 30539 | Sort | 2809.88 | 1099.77 | 60.9% | operator |
| 30545 | Sort | 66.05 | 1074.66 | 1527.0% | operator |
| 30540 | Hash Join | 2809.87 | 686.33 | 75.6% | operator |
| 30546 | Seq Scan | 52.90 | 18.25 | 65.5% | operator |
| 30541 | Seq Scan | 194.67 | 170.37 | 12.5% | operator |
| 30542 | Hash | 2587.94 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30541 (Seq Scan) - LEAF
...
### Step 6: Node 30546 (Seq Scan) - LEAF
...
### Step 9: Node 30538 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30547 (Index Scan) - LEAF
...
### Step 11: Node 30537 (Nested Loop)
...
### Step 12: Node 30536 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30535 (Gather Merge)
