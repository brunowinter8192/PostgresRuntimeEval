...
**Test Query:** Q18_61_seed_492241860
**Timestamp:** 2026-01-18 20:23:46
...
```
Node 30532 (Limit) - ROOT
  Node 30533 (Sort)
    Node 30534 (Aggregate)
      Node 30535 (Gather Merge)
        Node 30536 (Incremental Sort)
          Node 30537 (Nested Loop)
            Node 30538 (Merge Join)
              Node 30539 (Sort)
                Node 30540 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30541 (Seq Scan) [consumed] - LEAF
                  Node 30542 (Hash) [consumed]
                    Node 30543 (Aggregate)
                      Node 30544 (Index Scan) - LEAF
              Node 30545 (Sort)
                Node 30546 (Seq Scan) - LEAF
            Node 30547 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30540 | 30541, 30542 |
...
|------|------|--------|-----------|-----|--------|
| 30532 | Limit | 3018.73 | 1175.21 | 61.1% | operator |
| 30533 | Sort | 2899.17 | 1127.81 | 61.1% | operator |
| 30534 | Aggregate | 2899.12 | 1073.15 | 63.0% | operator |
| 30535 | Gather Merge | 2899.10 | 1073.95 | 63.0% | operator |
| 30536 | Incremental Sort | 2879.35 | 0.00 | 100.0% | operator |
| 30537 | Nested Loop | 2879.30 | 1111.34 | 61.4% | operator |
| 30538 | Merge Join | 2879.24 | 0.00 | 100.0% | operator |
| 30547 | Index Scan | 0.02 | 0.05 | 125.7% | operator |
| 30539 | Sort | 2809.88 | 1095.58 | 61.0% | operator |
| 30545 | Sort | 66.05 | 1074.66 | 1527.0% | operator |
| 30540 | Hash Join | 2809.87 | 471.07 | 83.2% | pattern |
| 30546 | Seq Scan | 52.90 | 18.25 | 65.5% | operator |
| 30543 | Aggregate | 2587.90 | 1073.15 | 58.5% | operator |
| 30544 | Index Scan | 2107.98 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30544 (Index Scan) - LEAF
...
### Step 3: Node 30540 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30541, 30542
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30546 (Seq Scan) - LEAF
...
### Step 7: Node 30538 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30547 (Index Scan) - LEAF
...
### Step 10: Node 30536 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30535 (Gather Merge)
