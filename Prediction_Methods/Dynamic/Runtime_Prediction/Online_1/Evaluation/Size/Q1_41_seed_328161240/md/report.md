...
**Test Query:** Q1_41_seed_328161240
...
```
Node 426 (Aggregate) - ROOT
  Node 427 (Gather Merge)
    Node 428 (Sort) [PATTERN: 1d35fb97]
      Node 429 (Aggregate) [consumed]
        Node 430 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 428 | 429 |
...
|------|------|--------|-----------|-----|--------|
| 426 | Aggregate | 990.64 | 1195.85 | 20.7% | operator |
| 427 | Gather Merge | 990.57 | 1165.89 | 17.7% | operator |
| 428 | Sort | 972.23 | 1200.35 | 23.5% | pattern |
| 430 | Seq Scan | 593.72 | 680.86 | 14.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 430 (Seq Scan) - LEAF
...
- **Output:** st=0.85, rt=680.86

### Step 2: Node 428 (Sort) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Aggregate_Outer_total_cost=168857.8500
  - Sort_np=0
  - Sort_nt=6
  - Sort_nt1=6
  - Sort_nt2=0
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=168857.9300
  - Sort_total_cost=168857.9400
- **Output:** st=1196.25, rt=1200.35

### Step 3: Node 427 (Gather Merge)
...
### Step 4: Node 426 (Aggregate) - ROOT
