...
**Test Query:** Q4_55_seed_443017674
...
```
Node 6551 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6552 (Gather Merge) [consumed]
    Node 6553 (Sort) [consumed]
      Node 6554 (Aggregate) [consumed]
        Node 6555 (Nested Loop)
          Node 6556 (Seq Scan) - LEAF
          Node 6557 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6551 | 6552, 6553, 6554 |
...
|------|------|--------|-----------|-----|--------|
| 6551 | Aggregate | 1051.08 | 952.19 | 9.4% | pattern |
| 6555 | Nested Loop | 1044.10 | 1255.45 | 20.2% | operator |
| 6556 | Seq Scan | 165.35 | 154.66 | 6.5% | operator |
| 6557 | Index Scan | 0.06 | 11.10 | 18103.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6556 (Seq Scan) - LEAF
...
### Step 2: Node 6557 (Index Scan) - LEAF
