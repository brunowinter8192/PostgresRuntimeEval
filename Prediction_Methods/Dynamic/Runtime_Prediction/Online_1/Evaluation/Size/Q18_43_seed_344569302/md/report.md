        ...
        Node 30216 (Incremental Sort)
          Node 30217 (Nested Loop)
            Node 30218 (Merge Join)
              Node 30219 (Sort)
                Node 30220 (Hash Join)
                  Node 30221 (Seq Scan) - LEAF
                  Node 30222 (Hash)
...
| 30219 | Sort | 2846.01 | 1099.77 | 61.4% | operator |
| 30225 | Sort | 66.43 | 1074.66 | 1517.8% | operator |
| 30220 | Hash Join | 2846.00 | 686.33 | 75.9% | operator |
| 30226 | Seq Scan | 54.70 | 18.25 | 66.6% | operator |
| 30221 | Seq Scan | 190.16 | 170.37 | 10.4% | operator |
| 30222 | Hash | 2625.20 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30221 (Seq Scan) - LEAF
...
### Step 6: Node 30226 (Seq Scan) - LEAF
...
### Step 9: Node 30218 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30227 (Index Scan) - LEAF
...
### Step 11: Node 30217 (Nested Loop)
...
### Step 12: Node 30216 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30215 (Gather Merge)
