...
**Test Query:** Q18_43_seed_344569302
...
```
Node 30212 (Limit) - ROOT
  Node 30213 (Sort)
    Node 30214 (Aggregate)
      Node 30215 (Gather Merge)
        Node 30216 (Incremental Sort)
          Node 30217 (Nested Loop)
            Node 30218 (Merge Join)
              Node 30219 (Sort)
                Node 30220 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30221 (Seq Scan) [consumed] - LEAF
                  Node 30222 (Hash) [consumed]
                    Node 30223 (Aggregate)
                      Node 30224 (Index Scan) - LEAF
              Node 30225 (Sort)
                Node 30226 (Seq Scan) - LEAF
            Node 30227 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30220 | 30221, 30222 |
...
|------|------|--------|-----------|-----|--------|
| 30212 | Limit | 3051.38 | 1175.21 | 61.5% | operator |
| 30213 | Sort | 2932.73 | 1127.81 | 61.5% | operator |
| 30214 | Aggregate | 2932.68 | 1073.15 | 63.4% | operator |
| 30215 | Gather Merge | 2932.67 | 1073.95 | 63.4% | operator |
| 30216 | Incremental Sort | 2915.25 | 0.00 | 100.0% | operator |
| 30217 | Nested Loop | 2915.21 | 1111.34 | 61.9% | operator |
| 30218 | Merge Join | 2915.14 | 0.00 | 100.0% | operator |
| 30227 | Index Scan | 0.02 | 0.05 | 105.2% | operator |
| 30219 | Sort | 2846.01 | 1095.58 | 61.5% | operator |
| 30225 | Sort | 66.43 | 1074.66 | 1517.8% | operator |
| 30220 | Hash Join | 2846.00 | 471.07 | 83.4% | pattern |
| 30226 | Seq Scan | 54.70 | 18.25 | 66.6% | operator |
| 30223 | Aggregate | 2625.16 | 1073.15 | 59.1% | operator |
| 30224 | Index Scan | 2120.67 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30224 (Index Scan) - LEAF
...
### Step 3: Node 30220 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30221, 30222
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30226 (Seq Scan) - LEAF
...
### Step 7: Node 30218 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30227 (Index Scan) - LEAF
...
### Step 10: Node 30216 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30215 (Gather Merge)
