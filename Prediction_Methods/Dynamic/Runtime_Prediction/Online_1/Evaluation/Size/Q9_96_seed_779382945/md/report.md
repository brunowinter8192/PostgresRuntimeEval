    ...
    Node 19282 (Gather)
      Node 19283 (Aggregate)
        Node 19284 (Nested Loop)
          Node 19285 (Hash Join) [PATTERN: bb930825]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 19285 | 19280, 19281, 19286, 19287, 19288 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 19280 | 19281, 19285, 19286, 19287, 19288 |
...
|------|------|--------|-----------|-----|--------|
| 19280 | Sort | 1204.29 | 1045.32 | 13.2% | pattern |
| 19282 | Gather | 1203.39 | 964.64 | 19.8% | operator |
| 19283 | Aggregate | 1183.68 | 1095.61 | 7.4% | operator |
| 19284 | Nested Loop | 1159.81 | 1252.17 | 8.0% | operator |
| 19285 | Hash Join | 985.00 | 134.80 | 86.3% | pattern |
| 19297 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 19289 | Hash Join | 158.60 | 837.61 | 428.1% | operator |
| 19295 | Hash | 12.70 | 14.95 | 17.7% | operator |
| 19290 | Nested Loop | 153.95 | 1251.77 | 713.1% | operator |
| 19293 | Hash | 2.35 | 15.94 | 576.9% | operator |
| 19296 | Seq Scan | 12.70 | 2.94 | 76.9% | operator |
| 19291 | Seq Scan | 19.16 | 44.03 | 129.8% | operator |
| 19292 | Index Scan | 0.07 | -1.39 | 1951.3% | operator |
| 19294 | Seq Scan | 1.83 | 9.45 | 416.4% | operator |
...
### Step 9: Node 19285 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 19280, 19281, 19286, 19287, 19288
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 11: Node 19284 (Nested Loop)
...
### Step 14: Node 19280 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 19281, 19285, 19286, 19287, 19288
- **Input Features:**
