...
```
Node 8181 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 8182 (Aggregate) [consumed]
    Node 8183 (Gather Merge) [consumed]
      Node 8184 (Aggregate)
          ...
          Node 8186 (Hash Join) [consumed]
            Node 8187 (Nested Loop)
              Node 8188 (Hash Join)
                ...
                Node 8190 (Hash) [PATTERN: 444761fb]
                  Node 8191 (Hash Join) [consumed]
                    Node 8192 (Seq Scan) [consumed] - LEAF
                    Node 8193 (Hash) [consumed]
                      Node 8194 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 8190 | 8181, 8182, 8183, 8185, 8186, 8191, 8192, 8193, 8194 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 8181 | 8182, 8183, 8185, 8186, 8190, 8191, 8192, 8193, 8194 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 8185 | 8181, 8182, 8183, 8186, 8190, 8191, 8192, 8193, 8194 |
...
|------|------|--------|-----------|-----|--------|
| 8181 | Sort | 1051.37 | 2934.42 | 179.1% | pattern |
| 8184 | Aggregate | 1046.37 | 1128.78 | 7.9% | operator |
| 8185 | Sort | 1046.10 | 1835.91 | 75.5% | pattern |
| 8187 | Nested Loop | 1032.65 | 1188.39 | 15.1% | operator |
| 8199 | Hash | 4.92 | 18.67 | 279.2% | operator |
| 8188 | Hash Join | 208.98 | 253.07 | 21.1% | operator |
| 8198 | Index Scan | 0.07 | -0.22 | 401.4% | operator |
| 8200 | Seq Scan | 4.38 | 12.36 | 182.1% | operator |
| 8189 | Seq Scan | 166.21 | 159.81 | 3.8% | operator |
| 8190 | Hash | 30.25 | 46.85 | 54.9% | pattern |
| 8195 | Seq Scan | 0.01 | 11.81 | 131103.0% | operator |
| 8196 | Hash | 0.14 | 21.05 | 14419.5% | operator |
| 8197 | Seq Scan | 0.14 | 22.93 | 16050.2% | operator |
...
### Step 4: Node 8189 (Seq Scan) - LEAF
...
### Step 5: Node 8190 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 8181, 8182, 8183, 8185, 8186, 8191, 8192, 8193, 8194
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 8198 (Index Scan) - LEAF
...
### Step 8: Node 8200 (Seq Scan) - LEAF
...
### Step 11: Node 8185 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 8181, 8182, 8183, 8186, 8190, 8191, 8192, 8193, 8194
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 8181 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 8182, 8183, 8185, 8186, 8190, 8191, 8192, 8193, 8194
- **Input Features:**
