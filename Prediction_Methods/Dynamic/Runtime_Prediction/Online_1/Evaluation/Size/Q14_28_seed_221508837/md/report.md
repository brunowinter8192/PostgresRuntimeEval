...
```
Node 26910 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26911 (Gather) [consumed]
    Node 26912 (Aggregate) [consumed]
      Node 26913 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26910 | 26911, 26912, 26913 |
...
|------|------|--------|-----------|-----|--------|
| 26910 | Aggregate | 830.76 | 857.13 | 3.2% | pattern |
...
### Step 4: Node 26910 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26911, 26912, 26913
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=15046
  - HashJoin_Outer_nt1=15046
  ...
  - HashJoin_Outer_total_cost=136646.1400
