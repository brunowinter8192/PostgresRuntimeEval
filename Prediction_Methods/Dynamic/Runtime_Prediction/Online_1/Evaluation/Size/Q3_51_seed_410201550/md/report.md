...
**Test Query:** Q3_51_seed_410201550
...
```
Node 5311 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5312 (Sort) [consumed]
    Node 5313 (Aggregate) [consumed]
      Node 5314 (Gather) [consumed]
        Node 5315 (Nested Loop)
          Node 5316 (Hash Join) [PATTERN: 895c6e8c]
            Node 5317 (Seq Scan) [consumed] - LEAF
            Node 5318 (Hash) [consumed]
              Node 5319 (Seq Scan) - LEAF
          Node 5320 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5311 | 5312, 5313, 5314, 5316, 5317, 5318 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5316 | 5311, 5312, 5313, 5314, 5317, 5318 |
...
|------|------|--------|-----------|-----|--------|
| 5311 | Limit | 1177.18 | 1151.18 | 2.2% | pattern |
| 5315 | Nested Loop | 1141.14 | 1192.85 | 4.5% | operator |
| 5316 | Hash Join | 208.19 | 242.44 | 16.4% | pattern |
| 5320 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5319 | Seq Scan | 28.29 | 38.60 | 36.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5319 (Seq Scan) - LEAF
...
### Step 2: Node 5316 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5311, 5312, 5313, 5314, 5317, 5318
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46613
  - HashJoin_nt1=235005
  ...
  - HashJoin_total_cost=37337.5100
  - Hash_Inner_np=0
  - Hash_Inner_nt=12397
...
### Step 3: Node 5320 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=72640.6000
- **Output:** st=121.63, rt=1192.85

### Step 5: Node 5311 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5312, 5313, 5314, 5316, 5317, 5318
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=311082
  - Aggregate_Outer_nt1=311082
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=109415.0300
  - Aggregate_Outer_total_cost=113303.5600
  - Gather_Outer_np=0
  - Gather_Outer_nt=311082
  - Gather_Outer_nt1=100349
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=104748.8000
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=311082
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=120025.9300
  - Limit_total_cost=120025.9500
  - Sort_Outer_np=0
  - Sort_Outer_nt=311082
  - Sort_Outer_nt1=311082
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=120025.9300
  - Sort_Outer_total_cost=120803.6300
