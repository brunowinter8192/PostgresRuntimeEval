...
**Test Query:** Q19_21_seed_164080620
...
```
Node 31661 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31662 (Gather) [consumed]
    Node 31663 (Aggregate) [consumed]
      Node 31664 (Hash Join) [consumed]
        Node 31665 (Seq Scan) - LEAF
        Node 31666 (Hash)
          Node 31667 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31661 | 31662, 31663, 31664 |
...
|------|------|--------|-----------|-----|--------|
| 31661 | Aggregate | 838.86 | 829.29 | 1.1% | pattern |
| 31665 | Seq Scan | 772.44 | 743.46 | 3.8% | operator |
| 31666 | Hash | 45.21 | 8.29 | 81.7% | operator |
| 31667 | Seq Scan | 45.13 | 23.76 | 47.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31667 (Seq Scan) - LEAF
...
### Step 2: Node 31665 (Seq Scan) - LEAF
...
### Step 4: Node 31661 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31662, 31663, 31664
- **Input Features:**
