...
```
Node 31661 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31662 (Gather) [consumed]
    Node 31663 (Aggregate) [consumed]
      Node 31664 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31661 | 31662, 31663 |
...
|------|------|--------|-----------|-----|--------|
| 31661 | Aggregate | 838.86 | 831.20 | 0.9% | pattern |
| 31664 | Hash Join | 819.33 | 766.06 | 6.5% | operator |
...
### Step 5: Node 31661 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31662, 31663
- **Input Features:**
