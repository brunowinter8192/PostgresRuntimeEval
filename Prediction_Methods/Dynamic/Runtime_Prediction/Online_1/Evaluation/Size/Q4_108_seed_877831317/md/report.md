...
**Test Query:** Q4_108_seed_877831317
...
```
Node 5907 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 5908 (Gather Merge) [consumed]
    Node 5909 (Sort) [consumed]
      Node 5910 (Aggregate) [consumed]
        Node 5911 (Nested Loop)
          Node 5912 (Seq Scan) - LEAF
          Node 5913 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 5907 | 5908, 5909, 5910 |
...
|------|------|--------|-----------|-----|--------|
| 5907 | Aggregate | 1050.04 | 952.19 | 9.3% | pattern |
| 5911 | Nested Loop | 1041.16 | 1255.45 | 20.6% | operator |
| 5912 | Seq Scan | 165.66 | 154.66 | 6.6% | operator |
| 5913 | Index Scan | 0.06 | 11.10 | 18103.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5912 (Seq Scan) - LEAF
...
### Step 2: Node 5913 (Index Scan) - LEAF
