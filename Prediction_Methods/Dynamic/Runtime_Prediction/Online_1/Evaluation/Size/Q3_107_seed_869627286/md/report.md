...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4421 | 4422, 4423, 4424 |
...
| 4425 | Nested Loop | 1163.81 | 1193.13 | 2.5% | operator |
| 4426 | Hash Join | 210.09 | 230.98 | 9.9% | operator |
| 4430 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4427 | Seq Scan | 156.70 | 163.46 | 4.3% | operator |
| 4428 | Hash | 28.40 | 17.75 | 37.5% | operator |
...
### Step 2: Node 4427 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37341.5000
- **Output:** st=27.24, rt=230.98

### Step 5: Node 4430 (Index Scan) - LEAF
...
- **Output:** st=121.82, rt=1193.13

### Step 7: Node 4421 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4422, 4423, 4424
- **Input Features:**
