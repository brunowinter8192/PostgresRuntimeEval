...
**Test Query:** Q3_107_seed_869627286
...
```
Node 4421 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 4422 (Sort) [consumed]
    Node 4423 (Aggregate) [consumed]
      Node 4424 (Gather) [consumed]
        Node 4425 (Nested Loop)
          Node 4426 (Hash Join) [PATTERN: 895c6e8c]
            Node 4427 (Seq Scan) [consumed] - LEAF
            Node 4428 (Hash) [consumed]
              Node 4429 (Seq Scan) - LEAF
          Node 4430 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4421 | 4422, 4423, 4424, 4426, 4427, 4428 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4426 | 4421, 4422, 4423, 4424, 4427, 4428 |
...
|------|------|--------|-----------|-----|--------|
| 4421 | Limit | 1199.28 | 1151.18 | 4.0% | pattern |
| 4425 | Nested Loop | 1163.81 | 1193.21 | 2.5% | operator |
| 4426 | Hash Join | 210.09 | 242.51 | 15.4% | pattern |
| 4430 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4429 | Seq Scan | 27.78 | 38.57 | 38.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4429 (Seq Scan) - LEAF
...
### Step 2: Node 4426 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4421, 4422, 4423, 4424, 4427, 4428
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47169
  - HashJoin_nt1=236095
...
- **Output:** st=29.71, rt=242.51

### Step 3: Node 4430 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=73023.2500
- **Output:** st=121.96, rt=1193.21

### Step 5: Node 4421 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4422, 4423, 4424, 4426, 4427, 4428
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=313863
  - Aggregate_Outer_nt1=313863
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110117.5000
  - Aggregate_Outer_total_cost=114040.7800
  - Gather_Outer_np=0
  - Gather_Outer_nt=313863
  - Gather_Outer_nt1=101246
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105409.5500
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=313863
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=120823.2500
  - Limit_total_cost=120823.2700
  - Sort_Outer_np=0
  - Sort_Outer_nt=313863
  - Sort_Outer_nt1=313863
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=120823.2500
  - Sort_Outer_total_cost=121607.9100
