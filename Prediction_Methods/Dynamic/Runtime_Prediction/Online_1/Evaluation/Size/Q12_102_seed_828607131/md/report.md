...
**Test Query:** Q12_102_seed_828607131
**Timestamp:** 2026-01-18 19:47:42
...
```
Node 24334 (Aggregate) - ROOT
  Node 24335 (Gather Merge)
    Node 24336 (Aggregate)
      Node 24337 (Sort)
        Node 24338 (Nested Loop)
          Node 24339 (Seq Scan) - LEAF
          Node 24340 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24334 | Aggregate | 987.81 | 919.04 | 7.0% | operator |
| 24335 | Gather Merge | 987.79 | 1111.84 | 12.6% | operator |
| 24336 | Aggregate | 969.12 | 895.29 | 7.6% | operator |
| 24337 | Sort | 968.55 | 1092.83 | 12.8% | operator |
| 24338 | Nested Loop | 967.57 | 1127.41 | 16.5% | operator |
| 24339 | Seq Scan | 833.96 | 745.20 | 10.6% | operator |
| 24340 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24339 (Seq Scan) - LEAF
...
### Step 2: Node 24340 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - st2=0.1246
  - startup_cost=0.4300
  - total_cost=147216.1000
- **Output:** st=38.32, rt=1127.41

### Step 4: Node 24337 (Sort)
...
- **Input Features:**
  ...
  - st1=38.3199
  - st2=0.0000
  - startup_cost=147580.2500
  - total_cost=147594.8100
- **Output:** st=1092.42, rt=1092.83

### Step 5: Node 24336 (Aggregate)
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=147580.2500
  - total_cost=147696.7800
- **Output:** st=868.92, rt=895.29

### Step 6: Node 24335 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=868.9239
  - st2=0.0000
  - startup_cost=148580.3300
  - total_cost=148701.0800
- **Output:** st=1109.22, rt=1111.84

### Step 7: Node 24334 (Aggregate) - ROOT
