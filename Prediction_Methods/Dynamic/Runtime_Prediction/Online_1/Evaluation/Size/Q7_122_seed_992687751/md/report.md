...
```
Node 10933 (Aggregate) - ROOT
  Node 10934 (Gather Merge)
    Node 10935 (Sort)
      Node 10936 (Hash Join)
        Node 10937 (Nested Loop)
          Node 10938 (Hash Join)
            Node 10939 (Seq Scan) - LEAF
            Node 10940 (Hash)
              Node 10941 (Hash Join)
                Node 10942 (Seq Scan) - LEAF
                Node 10943 (Hash)
                  Node 10944 (Seq Scan) - LEAF
          Node 10945 (Index Scan) - LEAF
        Node 10946 (Hash)
          Node 10947 (Hash Join)
            Node 10948 (Seq Scan) - LEAF
            Node 10949 (Hash)
              Node 10950 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 10933 | Aggregate | 1193.11 | 1209.26 | 1.4% | operator |
| 10934 | Gather Merge | 1192.11 | 1142.98 | 4.1% | operator |
| 10935 | Sort | 1185.88 | 1109.13 | 6.5% | operator |
| 10936 | Hash Join | 1185.22 | 842.59 | 28.9% | operator |
| 10937 | Nested Loop | 1178.89 | 1216.16 | 3.2% | operator |
| 10946 | Hash | 2.44 | 17.53 | 617.9% | operator |
| 10938 | Hash Join | 214.12 | 384.47 | 79.6% | operator |
| 10945 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 10947 | Hash Join | 2.39 | 85.17 | 3457.8% | operator |
| 10939 | Seq Scan | 151.88 | 201.16 | 32.4% | operator |
| 10940 | Hash | 36.75 | 19.59 | 46.7% | operator |
| 10948 | Seq Scan | 2.06 | 11.47 | 458.2% | operator |
| 10949 | Hash | 0.01 | 16.89 | 129854.5% | operator |
| 10941 | Hash Join | 36.36 | 92.20 | 153.6% | operator |
| 10950 | Seq Scan | 0.01 | 45.79 | 457823.2% | operator |
| 10942 | Seq Scan | 35.23 | 21.86 | 38.0% | operator |
| 10943 | Hash | 0.01 | 16.89 | 153482.6% | operator |
| 10944 | Seq Scan | 0.01 | 45.79 | 763105.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10944 (Seq Scan) - LEAF
...
### Step 2: Node 10942 (Seq Scan) - LEAF
...
### Step 5: Node 10950 (Seq Scan) - LEAF
...
### Step 6: Node 10939 (Seq Scan) - LEAF
...
### Step 8: Node 10948 (Seq Scan) - LEAF
...
### Step 11: Node 10945 (Index Scan) - LEAF
...
### Step 13: Node 10937 (Nested Loop)
...
### Step 17: Node 10934 (Gather Merge)
...
### Step 18: Node 10933 (Aggregate) - ROOT
