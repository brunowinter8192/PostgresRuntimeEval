        ...
        Node 29496 (Incremental Sort)
          Node 29497 (Nested Loop)
            Node 29498 (Merge Join)
              Node 29499 (Sort)
                Node 29500 (Hash Join)
                  Node 29501 (Seq Scan) - LEAF
                  Node 29502 (Hash)
...
| 29499 | Sort | 2814.91 | 1099.77 | 60.9% | operator |
| 29505 | Sort | 67.30 | 1074.66 | 1496.7% | operator |
| 29500 | Hash Join | 2814.90 | 686.33 | 75.6% | operator |
| 29506 | Seq Scan | 53.42 | 18.25 | 65.8% | operator |
| 29501 | Seq Scan | 186.13 | 170.37 | 8.5% | operator |
| 29502 | Hash | 2599.03 | 21.04 | 99.2% | operator |
...
### Step 3: Node 29501 (Seq Scan) - LEAF
...
### Step 6: Node 29506 (Seq Scan) - LEAF
...
### Step 9: Node 29498 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29507 (Index Scan) - LEAF
...
### Step 11: Node 29497 (Nested Loop)
...
### Step 12: Node 29496 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29495 (Gather Merge)
