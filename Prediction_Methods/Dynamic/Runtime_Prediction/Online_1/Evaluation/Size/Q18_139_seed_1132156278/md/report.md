...
**Test Query:** Q18_139_seed_1132156278
...
```
Node 29492 (Limit) - ROOT
  Node 29493 (Sort)
    Node 29494 (Aggregate)
      Node 29495 (Gather Merge)
        Node 29496 (Incremental Sort)
          Node 29497 (Nested Loop)
            Node 29498 (Merge Join)
              Node 29499 (Sort)
                Node 29500 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29501 (Seq Scan) [consumed] - LEAF
                  Node 29502 (Hash) [consumed]
                    Node 29503 (Aggregate)
                      Node 29504 (Index Scan) - LEAF
              Node 29505 (Sort)
                Node 29506 (Seq Scan) - LEAF
            Node 29507 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29500 | 29501, 29502 |
...
|------|------|--------|-----------|-----|--------|
| 29492 | Limit | 3015.72 | 1175.21 | 61.0% | operator |
| 29493 | Sort | 2904.22 | 1127.81 | 61.2% | operator |
| 29494 | Aggregate | 2904.17 | 1073.15 | 63.0% | operator |
| 29495 | Gather Merge | 2904.16 | 1073.95 | 63.0% | operator |
| 29496 | Incremental Sort | 2885.35 | 0.00 | 100.0% | operator |
| 29497 | Nested Loop | 2885.30 | 1111.34 | 61.5% | operator |
| 29498 | Merge Join | 2885.23 | 0.00 | 100.0% | operator |
| 29507 | Index Scan | 0.02 | 0.05 | 88.1% | operator |
| 29499 | Sort | 2814.91 | 1095.58 | 61.1% | operator |
| 29505 | Sort | 67.30 | 1074.66 | 1496.7% | operator |
| 29500 | Hash Join | 2814.90 | 471.07 | 83.3% | pattern |
| 29506 | Seq Scan | 53.42 | 18.25 | 65.8% | operator |
| 29503 | Aggregate | 2598.99 | 1073.15 | 58.7% | operator |
| 29504 | Index Scan | 2102.71 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29504 (Index Scan) - LEAF
...
### Step 3: Node 29500 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29501, 29502
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29506 (Seq Scan) - LEAF
...
### Step 7: Node 29498 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29507 (Index Scan) - LEAF
...
### Step 10: Node 29496 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29495 (Gather Merge)
