...
```
Node 31997 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31998 (Gather) [consumed]
    Node 31999 (Aggregate) [consumed]
      Node 32000 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31997 | 31998, 31999 |
...
|------|------|--------|-----------|-----|--------|
| 31997 | Aggregate | 837.10 | 831.20 | 0.7% | pattern |
| 32000 | Hash Join | 817.23 | 766.05 | 6.3% | operator |
...
- **Input Features:**
  ...
  - total_cost=156338.4500
- **Output:** st=60.26, rt=766.05

### Step 5: Node 31997 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31998, 31999
- **Input Features:**
