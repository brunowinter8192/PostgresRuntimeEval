...
**Test Query:** Q19_65_seed_525057984
...
```
Node 31997 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31998 (Gather) [consumed]
    Node 31999 (Aggregate) [consumed]
      Node 32000 (Hash Join) [consumed]
        Node 32001 (Seq Scan) - LEAF
        Node 32002 (Hash)
          Node 32003 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31997 | 31998, 31999, 32000 |
...
|------|------|--------|-----------|-----|--------|
| 31997 | Aggregate | 837.10 | 829.30 | 0.9% | pattern |
| 32001 | Seq Scan | 768.75 | 743.46 | 3.3% | operator |
| 32002 | Hash | 46.00 | 8.29 | 82.0% | operator |
| 32003 | Seq Scan | 45.87 | 23.76 | 48.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 32003 (Seq Scan) - LEAF
...
### Step 2: Node 32001 (Seq Scan) - LEAF
...
### Step 4: Node 31997 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31998, 31999, 32000
- **Input Features:**
  ...
  - HashJoin_Outer_total_cost=156338.4500
