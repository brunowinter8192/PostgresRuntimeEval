...
**Test Query:** Q6_17_seed_131264496
...
```
Node 10133 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10134 (Gather) [consumed]
    Node 10135 (Aggregate) [consumed]
      Node 10136 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10133 | 10134, 10135 |
...
|------|------|--------|-----------|-----|--------|
| 10133 | Aggregate | 824.33 | 849.98 | 3.1% | pattern |
| 10136 | Seq Scan | 804.44 | 748.49 | 7.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10136 (Seq Scan) - LEAF
...
### Step 2: Node 10133 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10134, 10135
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=22638
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=32
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=139718.6600
  - Aggregate_Outer_total_cost=139718.6700
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
