    ...
    Node 20646 (Aggregate) [consumed]
      Node 20647 (Gather) [consumed]
        Node 20648 (Hash Join)
          Node 20649 (Hash Join)
            Node 20650 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20644 | 20645, 20646, 20647 |
...
| 20648 | Hash Join | 1107.26 | 1007.21 | 9.0% | operator |
| 20649 | Hash Join | 1104.43 | 1004.12 | 9.1% | operator |
| 20655 | Hash | 0.01 | 15.71 | 112119.8% | operator |
| 20650 | Nested Loop | 1057.50 | 1204.81 | 13.9% | operator |
| 20653 | Hash | 36.25 | 55.57 | 53.3% | operator |
...
### Step 6: Node 20656 (Seq Scan) - LEAF
...
### Step 10: Node 20644 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20645, 20646, 20647
- **Input Features:**
