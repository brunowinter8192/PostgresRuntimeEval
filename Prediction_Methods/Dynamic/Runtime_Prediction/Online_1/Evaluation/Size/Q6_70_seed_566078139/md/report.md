...
**Test Query:** Q6_70_seed_566078139
...
```
Node 10369 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10370 (Gather) [consumed]
    Node 10371 (Aggregate) [consumed]
      Node 10372 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10369 | 10370, 10371 |
...
|------|------|--------|-----------|-----|--------|
| 10369 | Aggregate | 803.04 | 849.98 | 5.8% | pattern |
| 10372 | Seq Scan | 782.06 | 748.49 | 4.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10372 (Seq Scan) - LEAF
...
### Step 2: Node 10369 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10370, 10371
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=22651
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=32
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=139718.7300
  - Aggregate_Outer_total_cost=139718.7400
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=140719.2600
  - Aggregate_total_cost=140719.2700
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=140718.7300
  - Gather_Outer_total_cost=140719.2400
