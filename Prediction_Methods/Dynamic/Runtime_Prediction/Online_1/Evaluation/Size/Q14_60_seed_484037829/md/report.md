...
```
Node 27162 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27163 (Gather) [consumed]
    Node 27164 (Aggregate) [consumed]
      Node 27165 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27162 | 27163, 27164 |
...
|------|------|--------|-----------|-----|--------|
| 27162 | Aggregate | 837.08 | 848.37 | 1.3% | pattern |
| 27165 | Hash Join | 815.66 | 807.66 | 1.0% | operator |
...
### Step 5: Node 27162 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27163, 27164
- **Input Features:**
