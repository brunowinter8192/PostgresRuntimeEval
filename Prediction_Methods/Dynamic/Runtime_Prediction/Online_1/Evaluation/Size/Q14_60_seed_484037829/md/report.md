...
**Test Query:** Q14_60_seed_484037829
...
```
Node 27162 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27163 (Gather) [consumed]
    Node 27164 (Aggregate) [consumed]
      Node 27165 (Hash Join) [consumed]
        Node 27166 (Seq Scan) - LEAF
        Node 27167 (Hash)
          Node 27168 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27162 | 27163, 27164, 27165 |
...
|------|------|--------|-----------|-----|--------|
| 27162 | Aggregate | 837.08 | 857.13 | 2.4% | pattern |
| 27166 | Seq Scan | 766.22 | 758.50 | 1.0% | operator |
| 27167 | Hash | 41.71 | 9.38 | 77.5% | operator |
| 27168 | Seq Scan | 36.51 | 12.70 | 65.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27168 (Seq Scan) - LEAF
...
### Step 2: Node 27166 (Seq Scan) - LEAF
...
### Step 4: Node 27162 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27163, 27164, 27165
- **Input Features:**
