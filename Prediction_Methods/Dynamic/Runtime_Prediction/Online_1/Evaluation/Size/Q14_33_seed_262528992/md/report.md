...
```
Node 26952 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26953 (Gather) [consumed]
    Node 26954 (Aggregate) [consumed]
      Node 26955 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26952 | 26953, 26954, 26955 |
...
|------|------|--------|-----------|-----|--------|
| 26952 | Aggregate | 805.90 | 857.14 | 6.4% | pattern |
...
### Step 4: Node 26952 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26953, 26954, 26955
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=16090
  - HashJoin_Outer_nt1=16090
  ...
  - HashJoin_Outer_total_cost=136648.8800
