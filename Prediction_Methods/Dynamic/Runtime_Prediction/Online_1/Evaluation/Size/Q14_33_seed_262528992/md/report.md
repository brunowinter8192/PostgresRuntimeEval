...
**Test Query:** Q14_33_seed_262528992
**Timestamp:** 2025-12-21 18:16:09
...
```
Node 26952 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26953 (Gather) [consumed]
    Node 26954 (Aggregate) [consumed]
      Node 26955 (Hash Join)
        Node 26956 (Seq Scan) - LEAF
        Node 26957 (Hash)
          Node 26958 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26952 | 26953, 26954 |
...
|------|------|--------|-----------|-----|--------|
| 26952 | Aggregate | 805.90 | 848.39 | 5.3% | pattern |
| 26955 | Hash Join | 783.69 | 807.69 | 3.1% | operator |
| 26956 | Seq Scan | 732.14 | 758.52 | 3.6% | operator |
| 26957 | Hash | 42.77 | 9.38 | 78.1% | operator |
| 26958 | Seq Scan | 36.23 | 12.70 | 64.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26958 (Seq Scan) - LEAF
...
### Step 2: Node 26956 (Seq Scan) - LEAF
...
### Step 5: Node 26952 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26953, 26954
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=16090
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=64
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0001
  - Aggregate_Outer_startup_cost=136930.4600
  - Aggregate_Outer_total_cost=136930.4700
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
