...
```
Node 6313 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6314 (Gather Merge) [consumed]
    Node 6315 (Sort) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6313 | 6314, 6315, 6316 |
...
|------|------|--------|-----------|-----|--------|
| 6313 | Aggregate | 1057.45 | 952.19 | 10.0% | pattern |
| 6317 | Nested Loop | 1051.29 | 1255.45 | 19.4% | operator |
| 6318 | Seq Scan | 166.81 | 154.67 | 7.3% | operator |
| 6319 | Index Scan | 0.06 | 11.10 | 17810.3% | operator |
