...
**Test Query:** Q6_68_seed_549670077
...
```
Node 10357 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10358 (Gather) [consumed]
    Node 10359 (Aggregate) [consumed]
      Node 10360 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10357 | 10358, 10359 |
...
|------|------|--------|-----------|-----|--------|
| 10357 | Aggregate | 784.33 | 850.06 | 8.4% | pattern |
| 10360 | Seq Scan | 760.44 | 748.54 | 1.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10360 (Seq Scan) - LEAF
...
### Step 2: Node 10357 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10358, 10359
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=23802
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=32
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=139724.4800
  - Aggregate_Outer_total_cost=139724.4900
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=140725.0200
  - Aggregate_total_cost=140725.0300
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=140724.4800
  - Gather_Outer_total_cost=140724.9900
