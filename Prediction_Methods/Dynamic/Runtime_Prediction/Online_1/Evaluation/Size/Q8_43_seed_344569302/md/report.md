...
```
Node 15202 (Aggregate) - ROOT
  Node 15203 (Gather Merge)
    Node 15204 (Sort)
          ...
          Node 15207 (Hash Join)
            Node 15208 (Nested Loop)
              Node 15209 (Hash Join)
                ...
                Node 15211 (Hash)
                  Node 15212 (Hash Join)
                    Node 15213 (Seq Scan) - LEAF
                    Node 15214 (Hash)
                      Node 15215 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 15202 | Aggregate | 1214.91 | 1195.83 | 1.6% | operator |
| 15203 | Gather Merge | 1214.49 | 1097.17 | 9.7% | operator |
...
| 15209 | Hash Join | 211.06 | 251.17 | 19.0% | operator |
...
| 15211 | Hash | 33.93 | 20.62 | 39.2% | operator |
| 15212 | Hash Join | 33.20 | 132.26 | 298.4% | operator |
| 15213 | Seq Scan | 31.70 | 23.03 | 27.3% | operator |
| 15214 | Hash | 0.22 | 23.66 | 10652.8% | operator |
| 15215 | Hash Join | 0.22 | 306.84 | 141299.1% | operator |
...
### Step 5: Node 15213 (Seq Scan) - LEAF
...
### Step 8: Node 15210 (Seq Scan) - LEAF
...
### Step 11: Node 15219 (Index Scan) - LEAF
...
### Step 12: Node 15221 (Seq Scan) - LEAF
...
### Step 13: Node 15208 (Nested Loop)
...
### Step 16: Node 15222 (Index Scan) - LEAF
...
### Step 17: Node 15224 (Seq Scan) - LEAF
...
### Step 18: Node 15206 (Nested Loop)
...
### Step 22: Node 15203 (Gather Merge)
...
### Step 23: Node 15202 (Aggregate) - ROOT
