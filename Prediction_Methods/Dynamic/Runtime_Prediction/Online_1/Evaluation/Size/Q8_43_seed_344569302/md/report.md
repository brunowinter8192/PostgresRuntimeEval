...
**Test Query:** Q8_43_seed_344569302
...
```
Node 15202 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 15203 (Gather Merge) [consumed]
    Node 15204 (Sort)
      Node 15205 (Hash Join)
        Node 15206 (Nested Loop)
          Node 15207 (Hash Join)
            Node 15208 (Nested Loop)
              Node 15209 (Hash Join)
                Node 15210 (Seq Scan) - LEAF
                Node 15211 (Hash) [PATTERN: 444761fb]
                  Node 15212 (Hash Join) [consumed]
                    Node 15213 (Seq Scan) [consumed] - LEAF
                    Node 15214 (Hash) [consumed]
                      Node 15215 (Hash Join) [consumed]
                        Node 15216 (Seq Scan) - LEAF
                        Node 15217 (Hash)
                          Node 15218 (Seq Scan) - LEAF
              Node 15219 (Index Scan) - LEAF
            Node 15220 (Hash)
              Node 15221 (Seq Scan) - LEAF
          Node 15222 (Index Scan) - LEAF
        Node 15223 (Hash)
          Node 15224 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 15211 | 15202, 15203, 15212, 15213, 15214, 15215 |
| Aggregate -> Gather Merge (Out | 2724c080 | 15202 | 15203, 15211, 15212, 15213, 15214, 15215 |
...
|------|------|--------|-----------|-----|--------|
| 15202 | Aggregate | 1214.91 | 1133.67 | 6.7% | pattern |
| 15204 | Sort | 1208.66 | 1046.21 | 13.4% | operator |
| 15205 | Hash Join | 1208.40 | 785.61 | 35.0% | operator |
| 15206 | Nested Loop | 1208.08 | 1198.29 | 0.8% | operator |
| 15223 | Hash | 0.02 | 13.72 | 80629.9% | operator |
| 15207 | Hash Join | 1204.27 | 785.60 | 34.8% | operator |
| 15222 | Index Scan | 0.01 | 12.42 | 206958.1% | operator |
| 15224 | Seq Scan | 0.01 | 6.51 | 54166.4% | operator |
| 15208 | Nested Loop | 1161.04 | 1198.29 | 3.2% | operator |
| 15220 | Hash | 38.67 | 19.97 | 48.4% | operator |
| 15209 | Hash Join | 211.06 | 251.67 | 19.2% | operator |
| 15219 | Index Scan | 0.04 | 2.88 | 6759.2% | operator |
| 15221 | Seq Scan | 38.58 | 48.88 | 26.7% | operator |
| 15210 | Seq Scan | 158.44 | 159.67 | 0.8% | operator |
| 15211 | Hash | 33.93 | 43.51 | 28.2% | pattern |
| 15216 | Seq Scan | 0.01 | 12.22 | 152711.8% | operator |
| 15217 | Hash | 0.20 | 18.14 | 8882.3% | operator |
| 15218 | Seq Scan | 0.20 | 23.36 | 11639.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 15218 (Seq Scan) - LEAF
...
### Step 2: Node 15216 (Seq Scan) - LEAF
...
### Step 4: Node 15210 (Seq Scan) - LEAF
...
### Step 5: Node 15211 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 15202, 15203, 15212, 15213, 15214, 15215
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 15219 (Index Scan) - LEAF
...
### Step 8: Node 15221 (Seq Scan) - LEAF
...
### Step 12: Node 15222 (Index Scan) - LEAF
...
### Step 13: Node 15224 (Seq Scan) - LEAF
...
### Step 14: Node 15206 (Nested Loop)
...
### Step 18: Node 15202 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 15203, 15211, 15212, 15213, 15214, 15215
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2402
  - Aggregate_nt1=2402
