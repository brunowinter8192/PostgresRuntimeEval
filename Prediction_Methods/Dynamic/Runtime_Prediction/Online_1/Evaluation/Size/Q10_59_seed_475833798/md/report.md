...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20722 | 20723, 20724, 20725, 20727, 20728, 20731 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 20727 | 20722, 20723, 20724, 20725, 20728, 20731 |
...
|------|------|--------|-----------|-----|--------|
| 20722 | Limit | 1141.61 | 1199.47 | 5.1% | pattern |
| 20726 | Hash Join | 1096.19 | 1095.55 | 0.1% | operator |
| 20727 | Hash Join | 1093.27 | 1120.19 | 2.5% | pattern |
| 20733 | Hash | 0.01 | 15.71 | 120752.1% | operator |
| 20734 | Seq Scan | 0.01 | 6.98 | 77441.2% | operator |
| 20729 | Seq Scan | 159.80 | 159.74 | 0.0% | operator |
| 20730 | Index Scan | 0.06 | -0.52 | 935.9% | operator |
| 20732 | Seq Scan | 27.75 | 26.64 | 4.0% | operator |
...
- **Consumes:** Nodes 20722, 20723, 20724, 20725, 20728, 20731
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18186
  - HashJoin_nt1=18186
...
### Step 8: Node 20722 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20723, 20724, 20725, 20727, 20728, 20731
- **Input Features:**
