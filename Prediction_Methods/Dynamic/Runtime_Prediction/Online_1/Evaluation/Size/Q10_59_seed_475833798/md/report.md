    ...
    Node 20724 (Aggregate) [consumed]
      Node 20725 (Gather) [consumed]
        Node 20726 (Hash Join)
          Node 20727 (Hash Join)
            Node 20728 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20722 | 20723, 20724, 20725 |
...
| 20726 | Hash Join | 1096.19 | 1007.16 | 8.1% | operator |
| 20727 | Hash Join | 1093.27 | 1004.03 | 8.2% | operator |
| 20733 | Hash | 0.01 | 15.71 | 120752.1% | operator |
| 20728 | Nested Loop | 1044.47 | 1204.85 | 15.4% | operator |
| 20731 | Hash | 38.17 | 55.57 | 45.6% | operator |
...
### Step 6: Node 20734 (Seq Scan) - LEAF
...
### Step 10: Node 20722 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20723, 20724, 20725
- **Input Features:**
