...
```
Node 11779 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 11780 (Gather Merge) [consumed]
    Node 11781 (Sort)
      Node 11782 (Hash Join)
        Node 11783 (Nested Loop)
          Node 11784 (Hash Join) [PATTERN: 895c6e8c]
            Node 11785 (Seq Scan) [consumed] - LEAF
            Node 11786 (Hash) [consumed]
              Node 11787 (Hash Join) [PATTERN: f4cb205a]
                Node 11788 (Seq Scan) [consumed] - LEAF
                Node 11789 (Hash) [consumed]
                  Node 11790 (Seq Scan) [consumed] - LEAF
          Node 11791 (Index Scan) - LEAF
        Node 11792 (Hash)
          Node 11793 (Hash Join) [PATTERN: f4cb205a]
            Node 11794 (Seq Scan) [consumed] - LEAF
            Node 11795 (Hash) [consumed]
              Node 11796 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 11787 | 11779, 11780, 11784, 11785, 11786, 11788, 11789, 11790, 11793, 11794, 11795, 11796 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 11793 | 11779, 11780, 11784, 11785, 11786, 11787, 11788, 11789, 11790, 11794, 11795, 11796 |
| Aggregate -> Gather Merge (Out | 2724c080 | 11779 | 11780, 11784, 11785, 11786, 11787, 11788, 11789, 11790, 11793, 11794, 11795, 11796 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 11784 | 11779, 11780, 11785, 11786, 11787, 11788, 11789, 11790, 11793, 11794, 11795, 11796 |
...
|------|------|--------|-----------|-----|--------|
| 11779 | Aggregate | 1183.40 | 1163.13 | 1.7% | pattern |
| 11781 | Sort | 1177.02 | 1109.16 | 5.8% | operator |
| 11782 | Hash Join | 1176.42 | 843.11 | 28.3% | operator |
| 11783 | Nested Loop | 1169.54 | 1215.99 | 4.0% | operator |
| 11792 | Hash | 3.19 | 27.74 | 768.3% | operator |
| 11784 | Hash Join | 212.90 | 304.89 | 43.2% | pattern |
| 11791 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 11793 | Hash Join | 3.15 | 429.36 | 13521.9% | pattern |
| 11787 | Hash Join | 35.51 | 429.38 | 1109.3% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11787 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 11779, 11780, 11784, 11785, 11786, 11788, 11789, 11790, 11793, 11794, 11795, 11796
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5000
  - HashJoin_nt1=62500
...
### Step 2: Node 11784 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 11779, 11780, 11785, 11786, 11787, 11788, 11789, 11790, 11793, 11794, 11795, 11796
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=38710
  - HashJoin_nt1=483871
...
### Step 3: Node 11791 (Index Scan) - LEAF
...
### Step 4: Node 11793 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 11779, 11780, 11784, 11785, 11786, 11787, 11788, 11789, 11790, 11794, 11795, 11796
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=800
  - HashJoin_nt1=10000
...
### Step 9: Node 11779 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 11780, 11784, 11785, 11786, 11787, 11788, 11789, 11790, 11793, 11794, 11795, 11796
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
