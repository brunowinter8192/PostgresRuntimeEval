...
```
Node 14144 (Aggregate) - ROOT
  Node 14145 (Gather Merge)
    Node 14146 (Sort)
          ...
          Node 14149 (Hash Join)
            Node 14150 (Nested Loop)
              Node 14151 (Hash Join)
                ...
                Node 14153 (Hash)
                  Node 14154 (Hash Join)
                    Node 14155 (Seq Scan) - LEAF
                    Node 14156 (Hash)
                      Node 14157 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 14144 | Aggregate | 1204.71 | 1191.81 | 1.1% | operator |
| 14145 | Gather Merge | 1204.32 | 1097.16 | 8.9% | operator |
...
| 14151 | Hash Join | 216.18 | 251.17 | 16.2% | operator |
...
| 14153 | Hash | 38.91 | 20.62 | 47.0% | operator |
| 14154 | Hash Join | 38.27 | 132.26 | 245.6% | operator |
| 14155 | Seq Scan | 36.79 | 23.03 | 37.4% | operator |
| 14156 | Hash | 0.19 | 23.66 | 12618.3% | operator |
| 14157 | Hash Join | 0.18 | 306.84 | 168491.2% | operator |
...
### Step 5: Node 14155 (Seq Scan) - LEAF
...
### Step 8: Node 14152 (Seq Scan) - LEAF
...
### Step 11: Node 14161 (Index Scan) - LEAF
...
### Step 12: Node 14163 (Seq Scan) - LEAF
...
### Step 13: Node 14150 (Nested Loop)
...
### Step 16: Node 14164 (Index Scan) - LEAF
...
### Step 17: Node 14166 (Seq Scan) - LEAF
...
### Step 18: Node 14148 (Nested Loop)
...
### Step 22: Node 14145 (Gather Merge)
...
### Step 23: Node 14144 (Aggregate) - ROOT
