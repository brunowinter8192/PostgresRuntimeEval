...
```
Node 31626 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31627 (Gather) [consumed]
    Node 31628 (Aggregate) [consumed]
      Node 31629 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31626 | 31627, 31628 |
...
|------|------|--------|-----------|-----|--------|
| 31626 | Aggregate | 842.88 | 831.20 | 1.4% | pattern |
| 31629 | Hash Join | 822.87 | 766.05 | 6.9% | operator |
...
### Step 5: Node 31626 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31627, 31628
- **Input Features:**
