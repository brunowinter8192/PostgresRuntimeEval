...
**Test Query:** Q19_17_seed_131264496
...
```
Node 31626 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31627 (Gather) [consumed]
    Node 31628 (Aggregate) [consumed]
      Node 31629 (Hash Join) [consumed]
        Node 31630 (Seq Scan) - LEAF
        Node 31631 (Hash)
          Node 31632 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31626 | 31627, 31628, 31629 |
...
|------|------|--------|-----------|-----|--------|
| 31626 | Aggregate | 842.88 | 829.31 | 1.6% | pattern |
| 31630 | Seq Scan | 774.63 | 743.46 | 4.0% | operator |
| 31631 | Hash | 45.05 | 8.29 | 81.6% | operator |
| 31632 | Seq Scan | 44.89 | 23.76 | 47.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31632 (Seq Scan) - LEAF
...
### Step 2: Node 31630 (Seq Scan) - LEAF
...
### Step 4: Node 31626 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31627, 31628, 31629
- **Input Features:**
