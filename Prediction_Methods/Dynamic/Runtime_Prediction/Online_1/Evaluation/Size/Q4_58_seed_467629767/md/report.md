...
**Test Query:** Q4_58_seed_467629767
...
```
Node 6572 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6573 (Gather Merge) [consumed]
    Node 6574 (Sort) [consumed]
      Node 6575 (Aggregate) [consumed]
        Node 6576 (Nested Loop)
          Node 6577 (Seq Scan) - LEAF
          Node 6578 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6572 | 6573, 6574, 6575 |
...
|------|------|--------|-----------|-----|--------|
| 6572 | Aggregate | 1066.54 | 952.19 | 10.7% | pattern |
| 6576 | Nested Loop | 1059.60 | 1255.45 | 18.5% | operator |
| 6577 | Seq Scan | 166.87 | 154.66 | 7.3% | operator |
| 6578 | Index Scan | 0.06 | 11.10 | 17810.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6577 (Seq Scan) - LEAF
...
### Step 2: Node 6578 (Index Scan) - LEAF
