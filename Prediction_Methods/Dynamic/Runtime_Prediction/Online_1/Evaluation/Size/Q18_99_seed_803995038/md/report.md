        ...
        Node 31192 (Incremental Sort)
          Node 31193 (Nested Loop)
            Node 31194 (Merge Join)
              Node 31195 (Sort)
                Node 31196 (Hash Join)
                  Node 31197 (Seq Scan) - LEAF
                  Node 31198 (Hash)
...
| 31195 | Sort | 2827.27 | 1099.77 | 61.1% | operator |
| 31201 | Sort | 65.74 | 1074.66 | 1534.7% | operator |
| 31196 | Hash Join | 2827.26 | 686.33 | 75.7% | operator |
| 31202 | Seq Scan | 54.19 | 18.25 | 66.3% | operator |
| 31197 | Seq Scan | 193.87 | 170.37 | 12.1% | operator |
| 31198 | Hash | 2603.54 | 21.04 | 99.2% | operator |
...
### Step 3: Node 31197 (Seq Scan) - LEAF
...
### Step 6: Node 31202 (Seq Scan) - LEAF
...
### Step 9: Node 31194 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 31203 (Index Scan) - LEAF
...
### Step 11: Node 31193 (Nested Loop)
...
### Step 12: Node 31192 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 31191 (Gather Merge)
