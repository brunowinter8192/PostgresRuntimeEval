...
**Test Query:** Q18_99_seed_803995038
...
```
Node 31188 (Limit) - ROOT
  Node 31189 (Sort)
    Node 31190 (Aggregate)
      Node 31191 (Gather Merge)
        Node 31192 (Incremental Sort)
          Node 31193 (Nested Loop)
            Node 31194 (Merge Join)
              Node 31195 (Sort)
                Node 31196 (Hash Join) [PATTERN: 895c6e8c]
                  Node 31197 (Seq Scan) [consumed] - LEAF
                  Node 31198 (Hash) [consumed]
                    Node 31199 (Aggregate)
                      Node 31200 (Index Scan) - LEAF
              Node 31201 (Sort)
                Node 31202 (Seq Scan) - LEAF
            Node 31203 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 31196 | 31197, 31198 |
...
|------|------|--------|-----------|-----|--------|
| 31188 | Limit | 3022.54 | 1175.21 | 61.1% | operator |
| 31189 | Sort | 2913.25 | 1127.81 | 61.3% | operator |
| 31190 | Aggregate | 2913.20 | 1073.15 | 63.2% | operator |
| 31191 | Gather Merge | 2913.18 | 1073.95 | 63.1% | operator |
| 31192 | Incremental Sort | 2878.74 | 0.00 | 100.0% | operator |
| 31193 | Nested Loop | 2878.68 | 1111.34 | 61.4% | operator |
| 31194 | Merge Join | 2878.63 | 0.00 | 100.0% | operator |
| 31203 | Index Scan | 0.02 | 0.05 | 137.6% | operator |
| 31195 | Sort | 2827.27 | 1095.58 | 61.2% | operator |
| 31201 | Sort | 65.74 | 1074.66 | 1534.7% | operator |
| 31196 | Hash Join | 2827.26 | 471.07 | 83.3% | pattern |
| 31202 | Seq Scan | 54.19 | 18.25 | 66.3% | operator |
| 31199 | Aggregate | 2603.51 | 1073.15 | 58.8% | operator |
| 31200 | Index Scan | 2118.33 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31200 (Index Scan) - LEAF
...
### Step 3: Node 31196 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 31197, 31198
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 31202 (Seq Scan) - LEAF
...
### Step 7: Node 31194 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 31203 (Index Scan) - LEAF
...
### Step 10: Node 31192 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 31191 (Gather Merge)
