...
**Test Query:** Q4_61_seed_492241860
...
```
Node 6600 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6601 (Gather Merge) [consumed]
    Node 6602 (Sort) [consumed]
      Node 6603 (Aggregate) [consumed]
        Node 6604 (Nested Loop)
          Node 6605 (Seq Scan) - LEAF
          Node 6606 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6600 | 6601, 6602, 6603 |
...
|------|------|--------|-----------|-----|--------|
| 6600 | Aggregate | 1059.96 | 952.19 | 10.2% | pattern |
| 6604 | Nested Loop | 1052.79 | 1255.45 | 19.2% | operator |
| 6605 | Seq Scan | 161.45 | 154.66 | 4.2% | operator |
| 6606 | Index Scan | 0.06 | 11.10 | 17810.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6605 (Seq Scan) - LEAF
...
### Step 2: Node 6606 (Index Scan) - LEAF
