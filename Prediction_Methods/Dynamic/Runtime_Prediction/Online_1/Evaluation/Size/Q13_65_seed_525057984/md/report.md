...
**Test Query:** Q13_65_seed_525057984
...
```
Node 26147 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26148 (Aggregate) [consumed]
    Node 26149 (Aggregate)
      Node 26150 (Hash Join) [PATTERN: 895c6e8c]
        Node 26151 (Seq Scan) [consumed] - LEAF
        Node 26152 (Hash) [consumed]
          Node 26153 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26147 | 26148, 26150, 26151, 26152 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26150 | 26147, 26148, 26151, 26152 |
...
|------|------|--------|-----------|-----|--------|
| 26147 | Sort | 928.58 | 1079.93 | 16.3% | pattern |
| 26149 | Aggregate | 922.51 | 999.15 | 8.3% | operator |
| 26150 | Hash Join | 707.08 | 470.31 | 33.5% | pattern |
| 26153 | Index Only Scan | 10.76 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26153 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26150 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26147, 26148, 26151, 26152
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1478958
...
### Step 4: Node 26147 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26148, 26150, 26151, 26152
- **Input Features:**
