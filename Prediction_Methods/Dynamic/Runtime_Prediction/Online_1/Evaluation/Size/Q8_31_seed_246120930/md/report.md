          ...
          Node 14908 (Hash Join)
            Node 14909 (Nested Loop)
              Node 14910 (Hash Join)
                ...
                Node 14912 (Hash) [PATTERN: 444761fb]
                  Node 14913 (Hash Join) [consumed]
                    Node 14914 (Seq Scan) [consumed] - LEAF
                    Node 14915 (Hash) [consumed]
                      Node 14916 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 14912 | 14903, 14904, 14913, 14914, 14915, 14916 |
| Aggregate -> Gather Merge (Out | 2724c080 | 14903 | 14904, 14912, 14913, 14914, 14915, 14916 |
...
|------|------|--------|-----------|-----|--------|
| 14903 | Aggregate | 1216.31 | 1133.66 | 6.8% | pattern |
| 14905 | Sort | 1211.14 | 1046.21 | 13.6% | operator |
| 14906 | Hash Join | 1210.90 | 785.61 | 35.1% | operator |
| 14907 | Nested Loop | 1210.60 | 1198.29 | 1.0% | operator |
| 14924 | Hash | 0.01 | 13.72 | 91393.9% | operator |
| 14908 | Hash Join | 1206.84 | 785.60 | 34.9% | operator |
| 14923 | Index Scan | 0.01 | 12.42 | 206958.1% | operator |
| 14925 | Seq Scan | 0.01 | 6.51 | 59099.7% | operator |
| 14909 | Nested Loop | 1159.22 | 1198.29 | 3.4% | operator |
| 14921 | Hash | 43.14 | 19.97 | 53.7% | operator |
| 14910 | Hash Join | 216.82 | 251.67 | 16.1% | operator |
| 14920 | Index Scan | 0.04 | 2.88 | 6926.5% | operator |
| 14922 | Seq Scan | 43.03 | 48.89 | 13.6% | operator |
| 14911 | Seq Scan | 160.00 | 159.67 | 0.2% | operator |
| 14912 | Hash | 38.37 | 43.51 | 13.4% | pattern |
| 14917 | Seq Scan | 0.01 | 12.22 | 135732.7% | operator |
| 14918 | Hash | 0.21 | 18.14 | 8623.1% | operator |
| 14919 | Seq Scan | 0.20 | 23.36 | 11352.1% | operator |
...
### Step 4: Node 14911 (Seq Scan) - LEAF
...
### Step 5: Node 14912 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 14903, 14904, 14913, 14914, 14915, 14916
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 14920 (Index Scan) - LEAF
...
### Step 8: Node 14922 (Seq Scan) - LEAF
...
### Step 12: Node 14923 (Index Scan) - LEAF
...
### Step 13: Node 14925 (Seq Scan) - LEAF
...
### Step 14: Node 14907 (Nested Loop)
...
- **Input Features:**
  ...
  - st1=113.6207
  - st2=0.0000
  - startup_cost=70530.4600
  - total_cost=70532.2700
- **Output:** st=1044.94, rt=1046.21

### Step 18: Node 14903 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 14904, 14912, 14913, 14914, 14915, 14916
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2248
  - Aggregate_nt1=2248
  ...
  - Aggregate_total_cost=71886.3700
  - GatherMerge_Outer_np=0
  - GatherMerge_Outer_nt=2248
  - GatherMerge_Outer_nt1=725
  ...
  - GatherMerge_Outer_total_cost=71796.4500
