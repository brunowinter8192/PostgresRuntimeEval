...
**Test Query:** Q6_123_seed_1000891782
...
```
Node 10001 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10002 (Gather) [consumed]
    Node 10003 (Aggregate) [consumed]
      Node 10004 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10001 | 10002, 10003 |
...
|------|------|--------|-----------|-----|--------|
| 10001 | Aggregate | 752.82 | 849.98 | 12.9% | pattern |
| 10004 | Seq Scan | 732.58 | 748.49 | 2.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10004 (Seq Scan) - LEAF
...
### Step 2: Node 10001 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10002, 10003
- **Input Features:**
