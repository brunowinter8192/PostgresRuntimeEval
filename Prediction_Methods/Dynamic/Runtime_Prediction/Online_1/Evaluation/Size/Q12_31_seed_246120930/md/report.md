...
```
Node 24838 (Aggregate) - ROOT
  Node 24839 (Gather Merge)
    Node 24840 (Aggregate)
      Node 24841 (Sort)
...
|------|------|--------|-----------|-----|--------|
| 24838 | Aggregate | 985.36 | 919.06 | 6.7% | operator |
| 24839 | Gather Merge | 985.34 | 1111.84 | 12.8% | operator |
| 24840 | Aggregate | 967.74 | 895.31 | 7.5% | operator |
| 24841 | Sort | 967.10 | 1092.81 | 13.0% | operator |
| 24842 | Nested Loop | 966.20 | 1127.41 | 16.7% | operator |
| 24843 | Seq Scan | 826.71 | 745.19 | 9.9% | operator |
| 24844 | Index Scan | 0.03 | 0.07 | 166.2% | operator |
...
### Step 6: Node 24839 (Gather Merge)
...
### Step 7: Node 24838 (Aggregate) - ROOT
