...
**Test Query:** Q18_104_seed_845015193
...
```
Node 28884 (Limit) - ROOT
  Node 28885 (Sort)
    Node 28886 (Aggregate)
      Node 28887 (Gather Merge)
        Node 28888 (Incremental Sort)
          Node 28889 (Nested Loop)
            Node 28890 (Merge Join)
              Node 28891 (Sort)
                Node 28892 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 28884 | Limit | 3069.47 | 1175.21 | 61.7% | operator |
| 28885 | Sort | 2950.93 | 1127.81 | 61.8% | operator |
| 28886 | Aggregate | 2950.89 | 1073.15 | 63.6% | operator |
| 28887 | Gather Merge | 2950.88 | 1073.95 | 63.6% | operator |
| 28888 | Incremental Sort | 2931.48 | 0.00 | 100.0% | operator |
| 28889 | Nested Loop | 2931.43 | 1111.34 | 62.1% | operator |
| 28890 | Merge Join | 2931.36 | 0.00 | 100.0% | operator |
| 28899 | Index Scan | 0.02 | 0.05 | 88.1% | operator |
| 28891 | Sort | 2860.45 | 1099.77 | 61.6% | operator |
| 28897 | Sort | 68.05 | 1074.66 | 1479.1% | operator |
| 28892 | Hash Join | 2860.43 | 686.33 | 76.0% | operator |
| 28898 | Seq Scan | 55.24 | 18.25 | 67.0% | operator |
| 28893 | Seq Scan | 198.46 | 170.37 | 14.2% | operator |
| 28894 | Hash | 2632.27 | 21.04 | 99.2% | operator |
| 28895 | Aggregate | 2632.22 | 1073.15 | 59.2% | operator |
| 28896 | Index Scan | 2124.96 | 0.00 | 100.0% | operator |
...
### Step 3: Node 28893 (Seq Scan) - LEAF
...
### Step 6: Node 28898 (Seq Scan) - LEAF
...
### Step 9: Node 28890 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 28899 (Index Scan) - LEAF
...
### Step 11: Node 28889 (Nested Loop)
...
### Step 12: Node 28888 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 28887 (Gather Merge)
