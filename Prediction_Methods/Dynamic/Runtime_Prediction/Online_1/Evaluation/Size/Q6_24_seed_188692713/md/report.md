...
**Test Query:** Q6_24_seed_188692713
**Timestamp:** 2026-01-18 17:40:20
...
```
Node 10165 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10166 (Gather) [consumed]
    Node 10167 (Aggregate) [consumed]
      Node 10168 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10165 | 10166, 10167 |
...
|------|------|--------|-----------|-----|--------|
| 10165 | Aggregate | 798.90 | 850.06 | 6.4% | pattern |
| 10168 | Seq Scan | 778.76 | 748.54 | 3.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10168 (Seq Scan) - LEAF
...
### Step 2: Node 10165 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10166, 10167
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=23812
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=32
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=139724.5300
  - Aggregate_Outer_total_cost=139724.5400
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=140725.0700
  - Aggregate_total_cost=140725.0800
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=140724.5300
  - Gather_Outer_total_cost=140725.0400
- **Output:** st=844.46, rt=850.06
