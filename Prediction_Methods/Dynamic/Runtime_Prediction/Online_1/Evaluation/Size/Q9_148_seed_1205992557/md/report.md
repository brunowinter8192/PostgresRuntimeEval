...
```
Node 17592 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 17593 (Aggregate) [consumed]
    Node 17594 (Gather)
      Node 17595 (Aggregate)
        Node 17596 (Hash Join)
          Node 17597 (Seq Scan) - LEAF
          Node 17598 (Hash) [PATTERN: 444761fb]
            Node 17599 (Hash Join) [consumed]
              Node 17600 (Seq Scan) [consumed] - LEAF
              Node 17601 (Hash) [consumed]
                Node 17602 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 17598 | 17592, 17593, 17599, 17600, 17601, 17602 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17592 | 17593, 17598, 17599, 17600, 17601, 17602 |
...
|------|------|--------|-----------|-----|--------|
| 17592 | Sort | 1284.76 | 1063.03 | 17.3% | pattern |
| 17594 | Gather | 1284.00 | 962.11 | 25.1% | operator |
| 17595 | Aggregate | 1266.84 | 931.07 | 26.5% | operator |
| 17596 | Hash Join | 1239.42 | 568.57 | 54.1% | operator |
| 17597 | Seq Scan | 127.97 | 193.40 | 51.1% | operator |
| 17598 | Hash | 1048.57 | 35.69 | 96.6% | pattern |
...
### Step 9: Node 17597 (Seq Scan) - LEAF
...
### Step 10: Node 17598 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 17592, 17593, 17599, 17600, 17601, 17602
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 14: Node 17592 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17593, 17598, 17599, 17600, 17601, 17602
- **Input Features:**
