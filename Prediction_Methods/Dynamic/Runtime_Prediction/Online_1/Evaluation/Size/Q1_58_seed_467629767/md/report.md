...
Node 516 (Aggregate) - ROOT
  Node 517 (Gather Merge)
    Node 518 (Sort) [PATTERN: 1d35fb97]
      Node 519 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 518 | 519 |
...
|------|------|--------|-----------|-----|--------|
| 516 | Aggregate | 996.48 | 1195.98 | 20.0% | operator |
| 517 | Gather Merge | 996.44 | 1165.93 | 17.0% | operator |
| 518 | Sort | 980.58 | 1200.87 | 22.5% | pattern |
...
### Step 2: Node 518 (Sort) - PATTERN ROOT
...
### Step 4: Node 516 (Aggregate) - ROOT
