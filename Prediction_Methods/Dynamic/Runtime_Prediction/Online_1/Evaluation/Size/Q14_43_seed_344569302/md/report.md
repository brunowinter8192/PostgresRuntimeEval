...
**Test Query:** Q14_43_seed_344569302
...
```
Node 27029 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27030 (Gather) [consumed]
    Node 27031 (Aggregate) [consumed]
      Node 27032 (Hash Join) [consumed]
        Node 27033 (Seq Scan) - LEAF
        Node 27034 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27029 | 27030, 27031, 27032 |
...
|------|------|--------|-----------|-----|--------|
| 27029 | Aggregate | 802.19 | 857.12 | 6.8% | pattern |
| 27033 | Seq Scan | 731.80 | 758.47 | 3.6% | operator |
| 27034 | Hash | 41.87 | 9.38 | 77.6% | operator |
| 27035 | Seq Scan | 37.35 | 12.70 | 66.0% | operator |
...
### Step 2: Node 27033 (Seq Scan) - LEAF
...
### Step 4: Node 27029 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27030, 27031, 27032
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=14779
  - HashJoin_Outer_nt1=14779
  ...
  - HashJoin_Outer_total_cost=136645.4400
