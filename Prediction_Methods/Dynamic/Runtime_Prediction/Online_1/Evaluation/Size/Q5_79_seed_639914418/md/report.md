...
**Test Query:** Q5_79_seed_639914418
...
```
Node 9421 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 9422 (Aggregate) [consumed]
    Node 9423 (Gather Merge) [consumed]
      Node 9424 (Aggregate)
        Node 9425 (Sort) [PATTERN: 3e2d5a00]
          Node 9426 (Hash Join) [consumed]
            Node 9427 (Nested Loop)
              Node 9428 (Hash Join)
                Node 9429 (Seq Scan) - LEAF
                Node 9430 (Hash) [PATTERN: 444761fb]
                  Node 9431 (Hash Join) [consumed]
                    Node 9432 (Seq Scan) [consumed] - LEAF
                    Node 9433 (Hash) [consumed]
                      Node 9434 (Hash Join) [consumed]
                        Node 9435 (Seq Scan) - LEAF
                        Node 9436 (Hash)
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 9430 | 9421, 9422, 9423, 9425, 9426, 9431, 9432, 9433, 9434 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 9421 | 9422, 9423, 9425, 9426, 9430, 9431, 9432, 9433, 9434 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 9425 | 9421, 9422, 9423, 9426, 9430, 9431, 9432, 9433, 9434 |
...
|------|------|--------|-----------|-----|--------|
| 9421 | Sort | 1056.30 | 2934.42 | 177.8% | pattern |
| 9424 | Aggregate | 1052.07 | 1128.78 | 7.3% | operator |
| 9425 | Sort | 1051.82 | 1835.91 | 74.5% | pattern |
| 9427 | Nested Loop | 1039.14 | 1188.39 | 14.4% | operator |
| 9439 | Hash | 4.01 | 18.67 | 365.6% | operator |
| 9428 | Hash Join | 219.00 | 253.07 | 15.6% | operator |
| 9438 | Index Scan | 0.07 | -0.22 | 405.6% | operator |
| 9440 | Seq Scan | 3.48 | 12.36 | 255.3% | operator |
| 9429 | Seq Scan | 168.63 | 159.81 | 5.2% | operator |
| 9430 | Hash | 37.34 | 46.85 | 25.5% | pattern |
| 9435 | Seq Scan | 0.01 | 11.81 | 147503.4% | operator |
| 9436 | Hash | 0.07 | 21.05 | 27971.0% | operator |
| 9437 | Seq Scan | 0.07 | 22.93 | 32200.5% | operator |
...
### Step 2: Node 9435 (Seq Scan) - LEAF
...
### Step 4: Node 9429 (Seq Scan) - LEAF
...
### Step 5: Node 9430 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 9421, 9422, 9423, 9425, 9426, 9431, 9432, 9433, 9434
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 9438 (Index Scan) - LEAF
...
### Step 8: Node 9440 (Seq Scan) - LEAF
...
### Step 11: Node 9425 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 9421, 9422, 9423, 9426, 9430, 9431, 9432, 9433, 9434
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 9421 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 9422, 9423, 9425, 9426, 9430, 9431, 9432, 9433, 9434
- **Input Features:**
