...
**Test Query:** Q1_66_seed_533262015
...
```
Node 561 (Aggregate) - ROOT
  Node 562 (Gather Merge)
    Node 563 (Sort) [PATTERN: 1d35fb97]
      Node 564 (Aggregate) [consumed]
        Node 565 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 563 | 564 |
...
|------|------|--------|-----------|-----|--------|
| 561 | Aggregate | 998.18 | 1195.73 | 19.8% | operator |
| 562 | Gather Merge | 998.14 | 1165.86 | 16.8% | operator |
| 563 | Sort | 978.95 | 1199.92 | 22.6% | pattern |
| 565 | Seq Scan | 573.36 | 682.47 | 19.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 565 (Seq Scan) - LEAF
...
- **Output:** st=0.85, rt=682.47

### Step 2: Node 563 (Sort) - PATTERN ROOT
...
- **Output:** st=1195.82, rt=1199.92

### Step 3: Node 562 (Gather Merge)
...
### Step 4: Node 561 (Aggregate) - ROOT
