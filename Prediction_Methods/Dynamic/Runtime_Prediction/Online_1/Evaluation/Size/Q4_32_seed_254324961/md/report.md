...
**Test Query:** Q4_32_seed_254324961
...
```
Node 6376 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6377 (Gather Merge) [consumed]
    Node 6378 (Sort) [consumed]
      Node 6379 (Aggregate) [consumed]
        Node 6380 (Nested Loop)
          Node 6381 (Seq Scan) - LEAF
          Node 6382 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6376 | 6377, 6378, 6379 |
...
|------|------|--------|-----------|-----|--------|
| 6376 | Aggregate | 1069.14 | 952.19 | 10.9% | pattern |
| 6380 | Nested Loop | 1062.62 | 1255.45 | 18.1% | operator |
| 6381 | Seq Scan | 162.93 | 154.66 | 5.1% | operator |
| 6382 | Index Scan | 0.06 | 11.10 | 17526.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6381 (Seq Scan) - LEAF
...
### Step 2: Node 6382 (Index Scan) - LEAF
