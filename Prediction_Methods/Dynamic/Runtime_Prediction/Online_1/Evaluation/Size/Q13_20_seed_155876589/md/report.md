...
**Test Query:** Q13_20_seed_155876589
...
```
Node 25804 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25805 (Aggregate) [consumed]
    Node 25806 (Aggregate)
      Node 25807 (Hash Join) [PATTERN: 895c6e8c]
        Node 25808 (Seq Scan) [consumed] - LEAF
        Node 25809 (Hash) [consumed]
          Node 25810 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25804 | 25805, 25807, 25808, 25809 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25807 | 25804, 25805, 25808, 25809 |
...
|------|------|--------|-----------|-----|--------|
| 25804 | Sort | 919.69 | 1079.93 | 17.4% | pattern |
| 25806 | Aggregate | 913.62 | 999.15 | 9.4% | operator |
| 25807 | Hash Join | 698.48 | 470.31 | 32.7% | pattern |
| 25810 | Index Only Scan | 10.37 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25810 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25807 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25804, 25805, 25808, 25809
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1478958
...
### Step 4: Node 25804 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25805, 25807, 25808, 25809
- **Input Features:**
