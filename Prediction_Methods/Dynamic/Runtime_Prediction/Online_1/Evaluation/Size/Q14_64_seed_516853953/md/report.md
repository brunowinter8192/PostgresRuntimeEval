...
```
Node 27190 (Aggregate) [PATTERN: efde8b38] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27190 | 27191, 27192, 27193 |
...
|------|------|--------|-----------|-----|--------|
| 27190 | Aggregate | 791.02 | 857.14 | 8.4% | pattern |
| 27194 | Seq Scan | 717.02 | 758.51 | 5.8% | operator |
| 27195 | Hash | 44.02 | 9.38 | 78.7% | operator |
| 27196 | Seq Scan | 37.62 | 12.70 | 66.2% | operator |
...
### Step 4: Node 27190 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27191, 27192, 27193
- **Input Features:**
