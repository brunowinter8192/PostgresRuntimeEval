...
```
Node 18282 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18283 (Aggregate) [consumed]
    Node 18284 (Gather)
      Node 18285 (Aggregate)
        Node 18286 (Nested Loop)
          Node 18287 (Hash Join) [PATTERN: bb930825]
            Node 18288 (Seq Scan) [consumed] - LEAF
            Node 18289 (Hash) [consumed]
              Node 18290 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18287 | 18282, 18283, 18288, 18289, 18290 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18282 | 18283, 18287, 18288, 18289, 18290 |
...
|------|------|--------|-----------|-----|--------|
| 18282 | Sort | 1195.63 | 1045.32 | 12.6% | pattern |
...
| 18287 | Hash Join | 980.90 | 134.80 | 86.3% | pattern |
...
### Step 9: Node 18287 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18282, 18283, 18288, 18289, 18290
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18299 (Index Scan) - LEAF
...
### Step 11: Node 18286 (Nested Loop)
...
### Step 14: Node 18282 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18283, 18287, 18288, 18289, 18290
- **Input Features:**
