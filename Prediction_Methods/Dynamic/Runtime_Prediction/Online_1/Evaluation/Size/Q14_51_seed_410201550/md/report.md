...
**Test Query:** Q14_51_seed_410201550
...
```
Node 27092 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27093 (Gather) [consumed]
    Node 27094 (Aggregate) [consumed]
      Node 27095 (Hash Join)
        Node 27096 (Seq Scan) - LEAF
        Node 27097 (Hash)
          Node 27098 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27092 | 27093, 27094 |
...
|------|------|--------|-----------|-----|--------|
| 27092 | Aggregate | 808.95 | 848.37 | 4.9% | pattern |
| 27095 | Hash Join | 786.15 | 807.65 | 2.7% | operator |
| 27096 | Seq Scan | 735.96 | 758.49 | 3.1% | operator |
| 27097 | Hash | 42.22 | 9.38 | 77.8% | operator |
| 27098 | Seq Scan | 36.32 | 12.70 | 65.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27098 (Seq Scan) - LEAF
...
### Step 2: Node 27096 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=136647.0500
- **Output:** st=78.57, rt=807.65

### Step 5: Node 27092 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27093, 27094
- **Input Features:**
