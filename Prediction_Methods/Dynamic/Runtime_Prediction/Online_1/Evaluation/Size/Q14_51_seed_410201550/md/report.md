...
```
Node 27092 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27093 (Gather) [consumed]
    Node 27094 (Aggregate) [consumed]
      Node 27095 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27092 | 27093, 27094, 27095 |
...
|------|------|--------|-----------|-----|--------|
| 27092 | Aggregate | 808.95 | 857.13 | 6.0% | pattern |
...
### Step 4: Node 27092 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27093, 27094, 27095
- **Input Features:**
