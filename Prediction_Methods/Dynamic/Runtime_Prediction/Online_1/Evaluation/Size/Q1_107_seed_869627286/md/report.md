...
Node 36 (Aggregate) - ROOT
  Node 37 (Gather Merge)
    Node 38 (Sort) [PATTERN: 1d35fb97]
      Node 39 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 38 | 39 |
...
|------|------|--------|-----------|-----|--------|
| 36 | Aggregate | 949.56 | 1195.83 | 25.9% | operator |
| 37 | Gather Merge | 949.50 | 1165.89 | 22.8% | operator |
| 38 | Sort | 929.77 | 1200.28 | 29.1% | pattern |
...
### Step 2: Node 38 (Sort) - PATTERN ROOT
