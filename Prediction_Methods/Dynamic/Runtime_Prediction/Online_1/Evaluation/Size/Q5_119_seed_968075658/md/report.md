...
**Test Query:** Q5_119_seed_968075658
...
```
Node 7301 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 7302 (Aggregate) [consumed]
    Node 7303 (Gather Merge) [consumed]
      Node 7304 (Aggregate)
        Node 7305 (Sort) [PATTERN: 3e2d5a00]
          Node 7306 (Hash Join) [consumed]
            Node 7307 (Nested Loop)
              Node 7308 (Hash Join)
                Node 7309 (Seq Scan) - LEAF
                Node 7310 (Hash) [PATTERN: 444761fb]
                  Node 7311 (Hash Join) [consumed]
                    Node 7312 (Seq Scan) [consumed] - LEAF
                    Node 7313 (Hash) [consumed]
                      Node 7314 (Hash Join) [consumed]
                        Node 7315 (Seq Scan) - LEAF
                        Node 7316 (Hash)
                          Node 7317 (Seq Scan) - LEAF
              Node 7318 (Index Scan) - LEAF
            Node 7319 (Hash)
              Node 7320 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 7310 | 7301, 7302, 7303, 7305, 7306, 7311, 7312, 7313, 7314 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 7301 | 7302, 7303, 7305, 7306, 7310, 7311, 7312, 7313, 7314 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 7305 | 7301, 7302, 7303, 7306, 7310, 7311, 7312, 7313, 7314 |
...
|------|------|--------|-----------|-----|--------|
| 7301 | Sort | 1064.63 | 2934.42 | 175.6% | pattern |
| 7304 | Aggregate | 1060.09 | 1128.74 | 6.5% | operator |
| 7305 | Sort | 1059.81 | 1835.96 | 73.2% | pattern |
| 7307 | Nested Loop | 1047.54 | 1188.57 | 13.5% | operator |
| 7319 | Hash | 3.75 | 18.67 | 398.0% | operator |
| 7308 | Hash Join | 219.16 | 253.07 | 15.5% | operator |
| 7318 | Index Scan | 0.07 | -0.22 | 405.6% | operator |
| 7320 | Seq Scan | 3.24 | 12.36 | 281.8% | operator |
| 7309 | Seq Scan | 169.27 | 159.81 | 5.6% | operator |
| 7310 | Hash | 36.84 | 46.85 | 27.2% | pattern |
| 7315 | Seq Scan | 0.01 | 11.81 | 147503.4% | operator |
| 7316 | Hash | 0.26 | 21.05 | 7997.4% | operator |
| 7317 | Seq Scan | 0.26 | 22.93 | 8823.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 7317 (Seq Scan) - LEAF
...
### Step 2: Node 7315 (Seq Scan) - LEAF
...
### Step 4: Node 7309 (Seq Scan) - LEAF
...
### Step 5: Node 7310 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 7301, 7302, 7303, 7305, 7306, 7311, 7312, 7313, 7314
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 7318 (Index Scan) - LEAF
...
### Step 8: Node 7320 (Seq Scan) - LEAF
...
### Step 11: Node 7305 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 7301, 7302, 7303, 7306, 7310, 7311, 7312, 7313, 7314
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 7301 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 7302, 7303, 7305, 7306, 7310, 7311, 7312, 7313, 7314
- **Input Features:**
