...
**Test Query:** Q19_102_seed_828607131
...
```
Node 31234 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31235 (Gather) [consumed]
    Node 31236 (Aggregate) [consumed]
      Node 31237 (Hash Join) [consumed]
        Node 31238 (Seq Scan) - LEAF
        Node 31239 (Hash)
          Node 31240 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31234 | 31235, 31236, 31237 |
...
|------|------|--------|-----------|-----|--------|
| 31234 | Aggregate | 845.59 | 829.33 | 1.9% | pattern |
| 31238 | Seq Scan | 779.27 | 743.46 | 4.6% | operator |
| 31239 | Hash | 46.40 | 8.29 | 82.1% | operator |
| 31240 | Seq Scan | 46.23 | 23.76 | 48.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31240 (Seq Scan) - LEAF
...
### Step 2: Node 31238 (Seq Scan) - LEAF
...
### Step 4: Node 31234 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31235, 31236, 31237
- **Input Features:**
  ...
  - HashJoin_Outer_total_cost=156338.5300
