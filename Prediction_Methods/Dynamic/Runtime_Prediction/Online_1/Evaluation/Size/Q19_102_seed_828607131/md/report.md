...
```
Node 31234 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31235 (Gather) [consumed]
    Node 31236 (Aggregate) [consumed]
      Node 31237 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31234 | 31235, 31236 |
...
|------|------|--------|-----------|-----|--------|
| 31234 | Aggregate | 845.59 | 831.20 | 1.7% | pattern |
| 31237 | Hash Join | 827.57 | 766.06 | 7.4% | operator |
...
### Step 5: Node 31234 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31235, 31236
- **Input Features:**
