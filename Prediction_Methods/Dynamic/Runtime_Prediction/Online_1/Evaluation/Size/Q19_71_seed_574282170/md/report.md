...
```
Node 32046 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 32047 (Gather) [consumed]
    Node 32048 (Aggregate) [consumed]
      Node 32049 (Hash Join) [consumed]
        Node 32050 (Seq Scan) - LEAF
        Node 32051 (Hash)
          Node 32052 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 32046 | 32047, 32048, 32049 |
...
|------|------|--------|-----------|-----|--------|
| 32046 | Aggregate | 840.69 | 829.31 | 1.4% | pattern |
| 32050 | Seq Scan | 773.52 | 743.46 | 3.9% | operator |
| 32051 | Hash | 45.55 | 8.29 | 81.8% | operator |
| 32052 | Seq Scan | 45.40 | 23.76 | 47.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 32052 (Seq Scan) - LEAF
...
### Step 2: Node 32050 (Seq Scan) - LEAF
...
### Step 4: Node 32046 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 32047, 32048, 32049
- **Input Features:**
