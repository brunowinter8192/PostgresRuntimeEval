...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4831 | 4832, 4833, 4834, 4836, 4837, 4838 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4836 | 4831, 4832, 4833, 4834, 4837, 4838 |
...
| 4835 | Nested Loop | 1153.88 | 1193.02 | 3.4% | operator |
| 4836 | Hash Join | 205.64 | 242.48 | 17.9% | pattern |
...
- **Consumes:** Nodes 4831, 4832, 4833, 4834, 4837, 4838
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46868
  - HashJoin_nt1=232872
  ...
  - HashJoin_total_cost=37334.1900
  - Hash_Inner_np=0
  - Hash_Inner_nt=12579
...
- **Output:** st=29.78, rt=242.48

### Step 3: Node 4840 (Index Scan) - LEAF
...
- **Output:** st=121.75, rt=1193.02

### Step 5: Node 4831 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4832, 4833, 4834, 4836, 4837, 4838
- **Input Features:**
