...
Node 481 (Aggregate) - ROOT
  Node 482 (Gather Merge)
    Node 483 (Sort) [PATTERN: 1d35fb97]
      Node 484 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 483 | 484 |
...
|------|------|--------|-----------|-----|--------|
| 481 | Aggregate | 976.42 | 1195.87 | 22.5% | operator |
| 482 | Gather Merge | 976.38 | 1165.90 | 19.4% | operator |
| 483 | Sort | 957.16 | 1200.45 | 25.4% | pattern |
...
### Step 2: Node 483 (Sort) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=168930.1000
  - Sort_total_cost=168930.1100
- **Output:** st=1196.36, rt=1200.45

### Step 3: Node 482 (Gather Merge)
...
### Step 4: Node 481 (Aggregate) - ROOT
