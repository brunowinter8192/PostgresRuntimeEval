        ...
        Node 29096 (Incremental Sort)
          Node 29097 (Nested Loop)
            Node 29098 (Merge Join)
              Node 29099 (Sort)
                Node 29100 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29101 (Seq Scan) [consumed] - LEAF
                  Node 29102 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29100 | 29101, 29102 |
...
| 29099 | Sort | 2840.71 | 1095.58 | 61.4% | operator |
| 29105 | Sort | 71.75 | 1074.66 | 1397.9% | operator |
| 29100 | Hash Join | 2840.70 | 471.07 | 83.4% | pattern |
...
### Step 3: Node 29100 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29101, 29102
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29106 (Seq Scan) - LEAF
...
### Step 7: Node 29098 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29107 (Index Scan) - LEAF
...
### Step 10: Node 29096 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29095 (Gather Merge)
