...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5511 | 5512, 5513, 5514 |
...
| 5515 | Nested Loop | 1163.76 | 1193.08 | 2.5% | operator |
| 5516 | Hash Join | 208.66 | 230.90 | 10.7% | operator |
| 5520 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5517 | Seq Scan | 157.16 | 163.43 | 4.0% | operator |
| 5518 | Hash | 27.91 | 17.75 | 36.4% | operator |
...
### Step 2: Node 5517 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37340.5000
- **Output:** st=27.22, rt=230.90

### Step 5: Node 5520 (Index Scan) - LEAF
...
- **Output:** st=121.77, rt=1193.08

### Step 7: Node 5511 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5512, 5513, 5514
- **Input Features:**
