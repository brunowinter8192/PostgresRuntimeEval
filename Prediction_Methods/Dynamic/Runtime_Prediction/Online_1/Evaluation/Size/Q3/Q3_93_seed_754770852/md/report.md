...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5771 | 5772, 5773, 5774 |
...
| 5775 | Nested Loop | 1195.31 | 1193.08 | 0.2% | operator |
| 5776 | Hash Join | 207.27 | 230.94 | 11.4% | operator |
| 5780 | Index Scan | 0.03 | -0.52 | 2018.8% | operator |
| 5777 | Seq Scan | 155.78 | 163.44 | 4.9% | operator |
| 5778 | Hash | 28.61 | 17.75 | 38.0% | operator |
...
### Step 2: Node 5777 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37340.9000
- **Output:** st=27.23, rt=230.94

### Step 5: Node 5780 (Index Scan) - LEAF
...
- **Output:** st=121.78, rt=1193.08

### Step 7: Node 5771 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5772, 5773, 5774
- **Input Features:**
