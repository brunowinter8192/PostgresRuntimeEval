...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4971 | 4972, 4973, 4974 |
...
| 4975 | Nested Loop | 1161.63 | 1192.88 | 2.7% | operator |
| 4976 | Hash Join | 208.37 | 230.91 | 10.8% | operator |
| 4980 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4977 | Seq Scan | 156.21 | 163.44 | 4.6% | operator |
| 4978 | Hash | 29.69 | 17.75 | 40.2% | operator |
...
### Step 2: Node 4977 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37339.8700
- **Output:** st=27.25, rt=230.91

### Step 5: Node 4980 (Index Scan) - LEAF
...
- **Output:** st=121.60, rt=1192.88

### Step 7: Node 4971 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4972, 4973, 4974
- **Input Features:**
