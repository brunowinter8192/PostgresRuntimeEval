...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4741 | 4742, 4743, 4744 |
...
| 4745 | Nested Loop | 1164.71 | 1193.15 | 2.4% | operator |
| 4746 | Hash Join | 209.85 | 231.02 | 10.1% | operator |
| 4750 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4747 | Seq Scan | 155.58 | 163.47 | 5.1% | operator |
| 4748 | Hash | 30.20 | 17.75 | 41.2% | operator |
...
### Step 2: Node 4747 (Seq Scan) - LEAF
...
- **Output:** st=0.29, rt=163.47

### Step 3: Node 4748 (Hash)
...
- **Input Features:**
  ...
  - total_cost=37341.9900
- **Output:** st=27.24, rt=231.02

### Step 5: Node 4750 (Index Scan) - LEAF
...
- **Output:** st=121.85, rt=1193.15

### Step 7: Node 4741 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4742, 4743, 4744
- **Input Features:**
