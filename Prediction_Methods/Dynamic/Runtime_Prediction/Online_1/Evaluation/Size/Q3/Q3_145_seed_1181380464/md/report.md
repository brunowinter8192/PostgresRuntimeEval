...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4841 | 4842, 4843, 4844 |
...
| 4845 | Nested Loop | 1147.69 | 1192.88 | 3.9% | operator |
| 4846 | Hash Join | 206.54 | 230.29 | 11.5% | operator |
| 4850 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4847 | Seq Scan | 154.99 | 163.20 | 5.3% | operator |
| 4848 | Hash | 28.86 | 17.75 | 38.5% | operator |
...
### Step 2: Node 4847 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37333.1900
- **Output:** st=27.11, rt=230.29

### Step 5: Node 4850 (Index Scan) - LEAF
...
- **Output:** st=121.56, rt=1192.88

### Step 7: Node 4841 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4842, 4843, 4844
- **Input Features:**
