...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5411 | 5412, 5413, 5414 |
...
| 5415 | Nested Loop | 1178.30 | 1193.08 | 1.3% | operator |
| 5416 | Hash Join | 211.25 | 231.22 | 9.5% | operator |
| 5420 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5417 | Seq Scan | 156.33 | 163.55 | 4.6% | operator |
| 5418 | Hash | 30.84 | 17.75 | 42.5% | operator |
...
### Step 2: Node 5417 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37343.8500
- **Output:** st=27.29, rt=231.22

### Step 5: Node 5420 (Index Scan) - LEAF
...
- **Output:** st=121.80, rt=1193.08

### Step 7: Node 5411 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5412, 5413, 5414
- **Input Features:**
