...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5341 | 5342, 5343, 5344 |
...
| 5345 | Nested Loop | 1162.89 | 1193.07 | 2.6% | operator |
| 5346 | Hash Join | 206.74 | 230.58 | 11.5% | operator |
| 5350 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5347 | Seq Scan | 155.11 | 163.31 | 5.3% | operator |
| 5348 | Hash | 28.11 | 17.75 | 36.9% | operator |
...
### Step 2: Node 5347 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37337.0900
- **Output:** st=27.15, rt=230.58

### Step 5: Node 5350 (Index Scan) - LEAF
...
- **Output:** st=121.75, rt=1193.07

### Step 7: Node 5341 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5342, 5343, 5344
- **Input Features:**
