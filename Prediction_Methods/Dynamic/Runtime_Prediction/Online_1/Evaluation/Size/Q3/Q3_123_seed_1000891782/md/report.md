...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4601 | 4602, 4603, 4604 |
...
| 4605 | Nested Loop | 1154.33 | 1193.03 | 3.4% | operator |
| 4606 | Hash Join | 207.97 | 230.85 | 11.0% | operator |
| 4610 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4607 | Seq Scan | 155.39 | 163.41 | 5.2% | operator |
| 4608 | Hash | 29.06 | 17.75 | 38.9% | operator |
...
### Step 2: Node 4607 (Seq Scan) - LEAF
...
- **Output:** st=27.22, rt=230.85

### Step 5: Node 4610 (Index Scan) - LEAF
...
- **Output:** st=121.73, rt=1193.03

### Step 7: Node 4601 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4602, 4603, 4604
- **Input Features:**
