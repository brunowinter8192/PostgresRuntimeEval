...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5061 | 5062, 5063, 5064 |
...
| 5065 | Nested Loop | 1152.29 | 1192.78 | 3.5% | operator |
| 5066 | Hash Join | 210.15 | 230.21 | 9.5% | operator |
| 5070 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5067 | Seq Scan | 157.31 | 163.18 | 3.7% | operator |
| 5068 | Hash | 29.38 | 17.75 | 39.6% | operator |
...
### Step 2: Node 5067 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37331.9500
- **Output:** st=27.10, rt=230.21

### Step 5: Node 5070 (Index Scan) - LEAF
...
- **Output:** st=121.47, rt=1192.78

### Step 7: Node 5061 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5062, 5063, 5064
- **Input Features:**
