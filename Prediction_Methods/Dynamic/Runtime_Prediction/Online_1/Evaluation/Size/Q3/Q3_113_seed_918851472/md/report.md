...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4491 | 4492, 4493, 4494 |
...
| 4495 | Nested Loop | 1136.17 | 1192.81 | 5.0% | operator |
| 4496 | Hash Join | 207.83 | 230.52 | 10.9% | operator |
| 4500 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4497 | Seq Scan | 156.51 | 163.30 | 4.3% | operator |
| 4498 | Hash | 28.77 | 17.75 | 38.3% | operator |
...
### Step 2: Node 4497 (Seq Scan) - LEAF
...
### Step 5: Node 4500 (Index Scan) - LEAF
...
### Step 7: Node 4491 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4492, 4493, 4494
- **Input Features:**
