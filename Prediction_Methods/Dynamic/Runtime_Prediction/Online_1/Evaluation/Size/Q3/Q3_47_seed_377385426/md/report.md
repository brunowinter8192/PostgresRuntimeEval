...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5261 | 5262, 5263, 5264 |
...
| 5265 | Nested Loop | 1180.96 | 1193.23 | 1.0% | operator |
| 5266 | Hash Join | 216.38 | 231.13 | 6.8% | operator |
| 5270 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5267 | Seq Scan | 161.44 | 163.51 | 1.3% | operator |
| 5268 | Hash | 30.27 | 17.75 | 41.4% | operator |
...
### Step 2: Node 5267 (Seq Scan) - LEAF
...
### Step 5: Node 5270 (Index Scan) - LEAF
...
### Step 7: Node 5261 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5262, 5263, 5264
- **Input Features:**
