...
**Test Query:** Q3_75_seed_607098294
...
```
Node 5571 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5572 (Sort) [consumed]
    Node 5573 (Aggregate) [consumed]
      Node 5574 (Gather) [consumed]
        Node 5575 (Nested Loop)
          Node 5576 (Hash Join)
            Node 5577 (Seq Scan) - LEAF
            Node 5578 (Hash)
              Node 5579 (Seq Scan) - LEAF
          Node 5580 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5571 | 5572, 5573, 5574 |
...
|------|------|--------|-----------|-----|--------|
| 5571 | Limit | 1192.73 | 1151.18 | 3.5% | pattern |
| 5575 | Nested Loop | 1149.89 | 1193.50 | 3.8% | operator |
| 5576 | Hash Join | 207.92 | 231.24 | 11.2% | operator |
| 5580 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5577 | Seq Scan | 157.12 | 163.54 | 4.1% | operator |
| 5578 | Hash | 27.33 | 17.75 | 35.1% | operator |
| 5579 | Seq Scan | 26.42 | 38.53 | 45.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5579 (Seq Scan) - LEAF
...
### Step 2: Node 5577 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37345.6300
- **Output:** st=27.26, rt=231.24

### Step 5: Node 5580 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=73418.7000
- **Output:** st=122.18, rt=1193.50

### Step 7: Node 5571 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5572, 5573, 5574
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=316074
  - Aggregate_Outer_nt1=316074
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110767.2100
  - Aggregate_Outer_total_cost=114718.1300
  - Gather_Outer_np=0
  - Gather_Outer_nt=316074
  - Gather_Outer_nt1=101959
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=106026.1000
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=316074
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=121548.3800
  - Limit_total_cost=121548.4000
  - Sort_Outer_np=0
  - Sort_Outer_nt=316074
  - Sort_Outer_nt1=316074
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=121548.3800
  - Sort_Outer_total_cost=122338.5600
