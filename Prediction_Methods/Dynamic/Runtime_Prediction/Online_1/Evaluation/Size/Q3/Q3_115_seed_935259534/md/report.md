...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4511 | 4512, 4513, 4514 |
...
| 4515 | Nested Loop | 1198.14 | 1192.90 | 0.4% | operator |
| 4516 | Hash Join | 213.80 | 230.33 | 7.7% | operator |
| 4520 | Index Scan | 0.03 | -0.52 | 2018.8% | operator |
| 4517 | Seq Scan | 157.38 | 163.22 | 3.7% | operator |
| 4518 | Hash | 31.82 | 17.75 | 44.2% | operator |
...
### Step 2: Node 4517 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37333.6900
- **Output:** st=27.11, rt=230.33

### Step 5: Node 4520 (Index Scan) - LEAF
...
- **Output:** st=121.58, rt=1192.90

### Step 7: Node 4511 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4512, 4513, 4514
- **Input Features:**
