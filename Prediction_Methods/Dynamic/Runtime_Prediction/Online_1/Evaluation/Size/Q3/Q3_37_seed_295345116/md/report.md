...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5151 | 5152, 5153, 5154 |
...
| 5155 | Nested Loop | 1141.66 | 1192.95 | 4.5% | operator |
| 5156 | Hash Join | 199.77 | 230.71 | 15.5% | operator |
| 5160 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5157 | Seq Scan | 150.86 | 163.36 | 8.3% | operator |
| 5158 | Hash | 26.39 | 17.75 | 32.8% | operator |
...
### Step 2: Node 5157 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37338.0100
- **Output:** st=27.19, rt=230.71

### Step 5: Node 5160 (Index Scan) - LEAF
...
- **Output:** st=121.65, rt=1192.95

### Step 7: Node 5151 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5152, 5153, 5154
- **Input Features:**
