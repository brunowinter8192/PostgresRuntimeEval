...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5311 | 5312, 5313, 5314 |
...
| 5315 | Nested Loop | 1141.14 | 1192.77 | 4.5% | operator |
| 5316 | Hash Join | 208.19 | 230.73 | 10.8% | operator |
| 5320 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5317 | Seq Scan | 156.09 | 163.38 | 4.7% | operator |
| 5318 | Hash | 29.07 | 17.75 | 39.0% | operator |
...
### Step 2: Node 5317 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37337.5100
- **Output:** st=27.22, rt=230.73

### Step 5: Node 5320 (Index Scan) - LEAF
...
- **Output:** st=121.49, rt=1192.77

### Step 7: Node 5311 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5312, 5313, 5314
- **Input Features:**
