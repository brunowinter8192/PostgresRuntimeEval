...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5331 | 5332, 5333, 5334 |
...
| 5335 | Nested Loop | 1172.37 | 1192.87 | 1.7% | operator |
| 5336 | Hash Join | 213.17 | 230.61 | 8.2% | operator |
| 5340 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5337 | Seq Scan | 156.18 | 163.33 | 4.6% | operator |
| 5338 | Hash | 31.89 | 17.75 | 44.3% | operator |
...
### Step 2: Node 5337 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37336.6700
- **Output:** st=27.18, rt=230.61

### Step 5: Node 5340 (Index Scan) - LEAF
...
- **Output:** st=121.57, rt=1192.87

### Step 7: Node 5331 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5332, 5333, 5334
- **Input Features:**
