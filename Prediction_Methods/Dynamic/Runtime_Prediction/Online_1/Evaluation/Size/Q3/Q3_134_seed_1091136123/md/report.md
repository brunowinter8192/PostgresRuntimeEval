...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4721 | 4722, 4723, 4724 |
...
| 4725 | Nested Loop | 1174.12 | 1193.48 | 1.6% | operator |
| 4726 | Hash Join | 211.21 | 231.20 | 9.5% | operator |
| 4730 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4727 | Seq Scan | 157.28 | 163.52 | 4.0% | operator |
| 4728 | Hash | 31.13 | 17.75 | 43.0% | operator |
...
### Step 2: Node 4727 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37345.1300
- **Output:** st=27.25, rt=231.20

### Step 5: Node 4730 (Index Scan) - LEAF
...
- **Output:** st=122.15, rt=1193.48

### Step 7: Node 4721 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4722, 4723, 4724
- **Input Features:**
