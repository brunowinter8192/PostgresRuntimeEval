...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4931 | 4932, 4933, 4934 |
...
| 4935 | Nested Loop | 1142.86 | 1193.28 | 4.4% | operator |
| 4936 | Hash Join | 209.98 | 231.21 | 10.1% | operator |
| 4940 | Index Scan | 0.03 | -0.52 | 2172.3% | operator |
| 4937 | Seq Scan | 156.56 | 163.54 | 4.5% | operator |
| 4938 | Hash | 29.94 | 17.75 | 40.7% | operator |
...
### Step 2: Node 4937 (Seq Scan) - LEAF
...
### Step 5: Node 4940 (Index Scan) - LEAF
...
### Step 7: Node 4931 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4932, 4933, 4934
- **Input Features:**
