...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5651 | 5652, 5653, 5654 |
...
| 5655 | Nested Loop | 1162.11 | 1192.89 | 2.6% | operator |
| 5656 | Hash Join | 207.25 | 230.64 | 11.3% | operator |
| 5660 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5657 | Seq Scan | 154.59 | 163.34 | 5.7% | operator |
| 5658 | Hash | 29.55 | 17.75 | 40.0% | operator |
...
### Step 2: Node 5657 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37337.0800
- **Output:** st=27.19, rt=230.64

### Step 5: Node 5660 (Index Scan) - LEAF
...
### Step 7: Node 5651 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5652, 5653, 5654
- **Input Features:**
