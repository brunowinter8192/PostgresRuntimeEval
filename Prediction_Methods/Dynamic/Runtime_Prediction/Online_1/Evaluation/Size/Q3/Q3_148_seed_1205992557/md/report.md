...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4871 | 4872, 4873, 4874 |
...
| 4875 | Nested Loop | 1153.30 | 1193.45 | 3.5% | operator |
| 4876 | Hash Join | 207.75 | 231.23 | 11.3% | operator |
| 4880 | Index Scan | 0.03 | -0.52 | 2172.3% | operator |
| 4877 | Seq Scan | 154.64 | 163.54 | 5.8% | operator |
| 4878 | Hash | 29.50 | 17.75 | 39.9% | operator |
...
### Step 2: Node 4877 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37345.3800
- **Output:** st=27.26, rt=231.23

### Step 5: Node 4880 (Index Scan) - LEAF
...
- **Output:** st=122.13, rt=1193.45

### Step 7: Node 4871 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4872, 4873, 4874
- **Input Features:**
