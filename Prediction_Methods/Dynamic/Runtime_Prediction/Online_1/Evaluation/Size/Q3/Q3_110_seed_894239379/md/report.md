...
**Test Query:** Q3_110_seed_894239379
...
```
Node 4461 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 4462 (Sort) [consumed]
    Node 4463 (Aggregate) [consumed]
      Node 4464 (Gather) [consumed]
        Node 4465 (Nested Loop)
          Node 4466 (Hash Join)
            Node 4467 (Seq Scan) - LEAF
            Node 4468 (Hash)
              Node 4469 (Seq Scan) - LEAF
          Node 4470 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4461 | 4462, 4463, 4464 |
...
|------|------|--------|-----------|-----|--------|
| 4461 | Limit | 1189.73 | 1151.18 | 3.2% | pattern |
| 4465 | Nested Loop | 1152.79 | 1192.74 | 3.5% | operator |
| 4466 | Hash Join | 205.33 | 230.68 | 12.3% | operator |
| 4470 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4467 | Seq Scan | 153.86 | 163.36 | 6.2% | operator |
| 4468 | Hash | 29.10 | 17.75 | 39.0% | operator |
| 4469 | Seq Scan | 28.29 | 38.60 | 36.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4469 (Seq Scan) - LEAF
...
### Step 2: Node 4467 (Seq Scan) - LEAF
...
### Step 5: Node 4470 (Index Scan) - LEAF
...
### Step 7: Node 4461 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4462, 4463, 4464
- **Input Features:**
