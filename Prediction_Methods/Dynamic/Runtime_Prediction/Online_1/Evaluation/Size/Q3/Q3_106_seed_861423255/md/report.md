...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4411 | 4412, 4413, 4414 |
...
| 4415 | Nested Loop | 1172.62 | 1193.20 | 1.8% | operator |
| 4416 | Hash Join | 209.62 | 231.09 | 10.2% | operator |
| 4420 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4417 | Seq Scan | 159.84 | 163.50 | 2.3% | operator |
| 4418 | Hash | 26.88 | 17.75 | 34.0% | operator |
...
### Step 2: Node 4417 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37342.9900
- **Output:** st=27.25, rt=231.09

### Step 5: Node 4420 (Index Scan) - LEAF
...
- **Output:** st=121.90, rt=1193.20

### Step 7: Node 4411 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4412, 4413, 4414
- **Input Features:**
