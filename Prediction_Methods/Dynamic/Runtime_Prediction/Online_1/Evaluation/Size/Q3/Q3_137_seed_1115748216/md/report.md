...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4751 | 4752, 4753, 4754 |
...
| 4755 | Nested Loop | 1126.80 | 1193.10 | 5.9% | operator |
| 4756 | Hash Join | 206.72 | 230.94 | 11.7% | operator |
| 4760 | Index Scan | 0.03 | -0.52 | 2172.3% | operator |
| 4757 | Seq Scan | 154.52 | 163.44 | 5.8% | operator |
| 4758 | Hash | 30.15 | 17.75 | 41.1% | operator |
...
### Step 2: Node 4757 (Seq Scan) - LEAF
...
- **Output:** st=0.29, rt=163.44

### Step 3: Node 4758 (Hash)
...
- **Input Features:**
  ...
  - total_cost=37341.0000
- **Output:** st=27.23, rt=230.94

### Step 5: Node 4760 (Index Scan) - LEAF
...
- **Output:** st=121.80, rt=1193.10

### Step 7: Node 4751 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4752, 4753, 4754
- **Input Features:**
