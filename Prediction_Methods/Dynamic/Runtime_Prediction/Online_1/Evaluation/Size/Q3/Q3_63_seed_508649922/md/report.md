...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5441 | 5442, 5443, 5444 |
...
| 5445 | Nested Loop | 1182.08 | 1193.13 | 0.9% | operator |
| 5446 | Hash Join | 209.78 | 231.01 | 10.1% | operator |
| 5450 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5447 | Seq Scan | 157.05 | 163.47 | 4.1% | operator |
| 5448 | Hash | 29.85 | 17.75 | 40.5% | operator |
...
### Step 2: Node 5447 (Seq Scan) - LEAF
...
- **Output:** st=27.24, rt=231.01

### Step 5: Node 5450 (Index Scan) - LEAF
...
- **Output:** st=121.83, rt=1193.13

### Step 7: Node 5441 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5442, 5443, 5444
- **Input Features:**
