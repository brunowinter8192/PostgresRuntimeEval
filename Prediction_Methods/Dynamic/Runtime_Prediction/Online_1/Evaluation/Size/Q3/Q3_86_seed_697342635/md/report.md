...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5691 | 5692, 5693, 5694 |
...
| 5695 | Nested Loop | 1179.22 | 1192.68 | 1.1% | operator |
| 5696 | Hash Join | 211.41 | 230.30 | 8.9% | operator |
| 5700 | Index Scan | 0.03 | -0.52 | 2018.8% | operator |
| 5697 | Seq Scan | 157.74 | 163.22 | 3.5% | operator |
| 5698 | Hash | 30.51 | 17.75 | 41.8% | operator |
...
### Step 2: Node 5697 (Seq Scan) - LEAF
...
### Step 5: Node 5700 (Index Scan) - LEAF
...
### Step 7: Node 5691 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5692, 5693, 5694
- **Input Features:**
