...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4401 | 4402, 4403, 4404 |
...
| 4405 | Nested Loop | 1178.77 | 1193.48 | 1.2% | operator |
| 4406 | Hash Join | 208.74 | 231.20 | 10.8% | operator |
| 4410 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4407 | Seq Scan | 156.20 | 163.52 | 4.7% | operator |
| 4408 | Hash | 29.49 | 17.75 | 39.8% | operator |
...
### Step 2: Node 4407 (Seq Scan) - LEAF
...
### Step 5: Node 4410 (Index Scan) - LEAF
...
### Step 7: Node 4401 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4402, 4403, 4404
- **Input Features:**
