...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5191 | 5192, 5193, 5194 |
...
| 5195 | Nested Loop | 1138.84 | 1192.61 | 4.7% | operator |
| 5196 | Hash Join | 211.07 | 230.49 | 9.2% | operator |
| 5200 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5197 | Seq Scan | 159.05 | 163.30 | 2.7% | operator |
| 5198 | Hash | 28.79 | 17.75 | 38.4% | operator |
...
### Step 2: Node 5197 (Seq Scan) - LEAF
...
- **Output:** st=0.29, rt=163.30

### Step 3: Node 5198 (Hash)
...
- **Input Features:**
  ...
  - total_cost=37334.4000
- **Output:** st=27.18, rt=230.49

### Step 5: Node 5200 (Index Scan) - LEAF
...
- **Output:** st=121.33, rt=1192.61

### Step 7: Node 5191 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5192, 5193, 5194
- **Input Features:**
