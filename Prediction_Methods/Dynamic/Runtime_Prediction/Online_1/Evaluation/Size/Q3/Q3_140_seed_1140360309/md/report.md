...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4791 | 4792, 4793, 4794 |
...
| 4795 | Nested Loop | 1161.52 | 1192.70 | 2.7% | operator |
| 4796 | Hash Join | 210.25 | 230.62 | 9.7% | operator |
| 4800 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4797 | Seq Scan | 158.21 | 163.34 | 3.2% | operator |
| 4798 | Hash | 28.23 | 17.75 | 37.1% | operator |
...
### Step 2: Node 4797 (Seq Scan) - LEAF
...
- **Output:** st=27.20, rt=230.62

### Step 5: Node 4800 (Index Scan) - LEAF
...
- **Output:** st=121.42, rt=1192.70

### Step 7: Node 4791 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4792, 4793, 4794
- **Input Features:**
