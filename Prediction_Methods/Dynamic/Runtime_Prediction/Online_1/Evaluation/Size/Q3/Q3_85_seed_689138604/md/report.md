...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5681 | 5682, 5683, 5684 |
...
| 5685 | Nested Loop | 1155.14 | 1192.96 | 3.3% | operator |
| 5686 | Hash Join | 212.18 | 230.41 | 8.6% | operator |
| 5690 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5687 | Seq Scan | 157.19 | 163.25 | 3.9% | operator |
| 5688 | Hash | 31.92 | 17.75 | 44.4% | operator |
...
### Step 2: Node 5687 (Seq Scan) - LEAF
...
- **Output:** st=27.13, rt=230.41

### Step 5: Node 5690 (Index Scan) - LEAF
...
- **Output:** st=121.64, rt=1192.96

### Step 7: Node 5681 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5682, 5683, 5684
- **Input Features:**
