...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4671 | 4672, 4673, 4674 |
...
| 4675 | Nested Loop | 1156.27 | 1192.72 | 3.2% | operator |
| 4676 | Hash Join | 208.03 | 230.38 | 10.7% | operator |
| 4680 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4677 | Seq Scan | 155.52 | 163.25 | 5.0% | operator |
| 4678 | Hash | 29.64 | 17.75 | 40.1% | operator |
...
### Step 2: Node 4677 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37333.5600
- **Output:** st=27.14, rt=230.38

### Step 5: Node 4680 (Index Scan) - LEAF
...
- **Output:** st=121.42, rt=1192.72

### Step 7: Node 4671 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4672, 4673, 4674
- **Input Features:**
