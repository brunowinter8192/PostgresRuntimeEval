...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4891 | 4892, 4893, 4894 |
...
| 4895 | Nested Loop | 1167.30 | 1192.85 | 2.2% | operator |
| 4896 | Hash Join | 213.16 | 230.25 | 8.0% | operator |
| 4900 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4897 | Seq Scan | 160.44 | 163.19 | 1.7% | operator |
| 4898 | Hash | 29.72 | 17.75 | 40.3% | operator |
...
### Step 2: Node 4897 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37332.6900
- **Output:** st=27.10, rt=230.25

### Step 5: Node 4900 (Index Scan) - LEAF
...
- **Output:** st=121.53, rt=1192.85

### Step 7: Node 4891 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4892, 4893, 4894
- **Input Features:**
