...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4501 | 4502, 4503, 4504 |
...
| 4505 | Nested Loop | 1182.69 | 1192.99 | 0.9% | operator |
| 4506 | Hash Join | 209.21 | 230.46 | 10.2% | operator |
| 4510 | Index Scan | 0.03 | -0.52 | 2018.8% | operator |
| 4507 | Seq Scan | 155.24 | 163.26 | 5.2% | operator |
| 4508 | Hash | 30.17 | 17.75 | 41.2% | operator |
...
### Step 2: Node 4507 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37335.4300
- **Output:** st=27.13, rt=230.46

### Step 5: Node 4510 (Index Scan) - LEAF
...
- **Output:** st=121.67, rt=1192.99

### Step 7: Node 4501 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4502, 4503, 4504
- **Input Features:**
