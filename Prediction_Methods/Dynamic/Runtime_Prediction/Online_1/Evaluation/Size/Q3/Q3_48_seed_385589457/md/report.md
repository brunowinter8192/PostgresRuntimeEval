...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5271 | 5272, 5273, 5274 |
...
| 5275 | Nested Loop | 1146.27 | 1193.35 | 4.1% | operator |
| 5276 | Hash Join | 204.82 | 231.08 | 12.8% | operator |
| 5280 | Index Scan | 0.03 | -0.52 | 2172.3% | operator |
| 5277 | Seq Scan | 154.09 | 163.48 | 6.1% | operator |
| 5278 | Hash | 27.89 | 17.75 | 36.4% | operator |
...
### Step 2: Node 5277 (Seq Scan) - LEAF
...
- **Output:** st=27.24, rt=231.08

### Step 5: Node 5280 (Index Scan) - LEAF
...
### Step 7: Node 5271 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5272, 5273, 5274
- **Input Features:**
