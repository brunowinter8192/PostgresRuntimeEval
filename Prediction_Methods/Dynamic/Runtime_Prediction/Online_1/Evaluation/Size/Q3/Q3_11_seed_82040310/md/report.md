...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4561 | 4562, 4563, 4564 |
...
| 4565 | Nested Loop | 1201.44 | 1192.58 | 0.7% | operator |
| 4566 | Hash Join | 208.84 | 230.44 | 10.3% | operator |
| 4570 | Index Scan | 0.03 | -0.52 | 2018.8% | operator |
| 4567 | Seq Scan | 157.07 | 163.28 | 3.9% | operator |
| 4568 | Hash | 29.57 | 17.75 | 40.0% | operator |
...
### Step 2: Node 4567 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37333.7800
- **Output:** st=27.17, rt=230.44

### Step 5: Node 4570 (Index Scan) - LEAF
...
- **Output:** st=121.30, rt=1192.58

### Step 7: Node 4561 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4562, 4563, 4564
- **Input Features:**
