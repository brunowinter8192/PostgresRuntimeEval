...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5211 | 5212, 5213, 5214 |
...
| 5215 | Nested Loop | 1195.90 | 1192.66 | 0.3% | operator |
| 5216 | Hash Join | 213.85 | 230.29 | 7.7% | operator |
| 5220 | Index Scan | 0.03 | -0.52 | 2018.8% | operator |
| 5217 | Seq Scan | 159.02 | 163.22 | 2.6% | operator |
| 5218 | Hash | 32.02 | 17.75 | 44.6% | operator |
...
### Step 2: Node 5217 (Seq Scan) - LEAF
...
### Step 5: Node 5220 (Index Scan) - LEAF
...
### Step 7: Node 5211 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5212, 5213, 5214
- **Input Features:**
