...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5141 | 5142, 5143, 5144 |
...
| 5145 | Nested Loop | 1167.06 | 1193.02 | 2.2% | operator |
| 5146 | Hash Join | 211.47 | 230.81 | 9.1% | operator |
| 5150 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5147 | Seq Scan | 158.64 | 163.40 | 3.0% | operator |
| 5148 | Hash | 29.84 | 17.75 | 40.5% | operator |
...
### Step 2: Node 5147 (Seq Scan) - LEAF
...
- **Output:** st=0.29, rt=163.40

### Step 3: Node 5148 (Hash)
...
- **Output:** st=27.21, rt=230.81

### Step 5: Node 5150 (Index Scan) - LEAF
...
- **Output:** st=121.71, rt=1193.02

### Step 7: Node 5141 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5142, 5143, 5144
- **Input Features:**
