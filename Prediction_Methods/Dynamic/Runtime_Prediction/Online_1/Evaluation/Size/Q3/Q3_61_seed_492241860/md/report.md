...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5421 | 5422, 5423, 5424 |
...
| 5425 | Nested Loop | 1164.05 | 1193.03 | 2.5% | operator |
| 5426 | Hash Join | 208.51 | 231.14 | 10.9% | operator |
| 5430 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5427 | Seq Scan | 157.38 | 163.52 | 3.9% | operator |
| 5428 | Hash | 27.93 | 17.75 | 36.4% | operator |
...
### Step 2: Node 5427 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37342.8600
- **Output:** st=27.28, rt=231.14

### Step 5: Node 5430 (Index Scan) - LEAF
...
- **Output:** st=121.75, rt=1193.03

### Step 7: Node 5421 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5422, 5423, 5424
- **Input Features:**
