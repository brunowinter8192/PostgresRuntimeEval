...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5001 | 5002, 5003, 5004 |
...
| 5005 | Nested Loop | 1187.44 | 1192.91 | 0.5% | operator |
| 5006 | Hash Join | 210.88 | 230.68 | 9.4% | operator |
| 5010 | Index Scan | 0.03 | -0.52 | 2018.8% | operator |
| 5007 | Seq Scan | 159.91 | 163.35 | 2.2% | operator |
| 5008 | Hash | 27.95 | 17.75 | 36.5% | operator |
...
### Step 2: Node 5007 (Seq Scan) - LEAF
...
### Step 5: Node 5010 (Index Scan) - LEAF
...
### Step 7: Node 5001 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5002, 5003, 5004
- **Input Features:**
