...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5091 | 5092, 5093, 5094 |
...
| 5095 | Nested Loop | 1165.79 | 1193.08 | 2.3% | operator |
| 5096 | Hash Join | 209.12 | 231.22 | 10.6% | operator |
| 5100 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5097 | Seq Scan | 156.32 | 163.55 | 4.6% | operator |
| 5098 | Hash | 28.80 | 17.75 | 38.4% | operator |
...
### Step 2: Node 5097 (Seq Scan) - LEAF
...
### Step 5: Node 5100 (Index Scan) - LEAF
...
### Step 7: Node 5091 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5092, 5093, 5094
- **Input Features:**
