...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5591 | 5592, 5593, 5594 |
...
| 5595 | Nested Loop | 1152.45 | 1193.18 | 3.5% | operator |
| 5596 | Hash Join | 213.07 | 231.05 | 8.4% | operator |
| 5600 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5597 | Seq Scan | 157.29 | 163.48 | 3.9% | operator |
| 5598 | Hash | 31.78 | 17.75 | 44.2% | operator |
...
### Step 2: Node 5597 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37342.4900
- **Output:** st=27.25, rt=231.05

### Step 5: Node 5600 (Index Scan) - LEAF
...
- **Output:** st=121.87, rt=1193.18

### Step 7: Node 5591 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5592, 5593, 5594
- **Input Features:**
