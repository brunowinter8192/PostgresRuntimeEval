...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4941 | 4942, 4943, 4944 |
...
| 4945 | Nested Loop | 1160.27 | 1193.38 | 2.9% | operator |
| 4946 | Hash Join | 210.19 | 231.12 | 10.0% | operator |
| 4950 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4947 | Seq Scan | 156.93 | 163.50 | 4.2% | operator |
| 4948 | Hash | 30.24 | 17.75 | 41.3% | operator |
...
### Step 2: Node 4947 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37343.8900
- **Output:** st=27.24, rt=231.12

### Step 5: Node 4950 (Index Scan) - LEAF
...
- **Output:** st=122.06, rt=1193.38

### Step 7: Node 4941 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4942, 4943, 4944
- **Input Features:**
