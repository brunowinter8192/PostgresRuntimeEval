...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5281 | 5282, 5283, 5284 |
...
| 5285 | Nested Loop | 1165.33 | 1193.30 | 2.4% | operator |
| 5286 | Hash Join | 209.74 | 231.00 | 10.1% | operator |
| 5290 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5287 | Seq Scan | 156.73 | 163.46 | 4.3% | operator |
| 5288 | Hash | 29.50 | 17.75 | 39.9% | operator |
...
### Step 2: Node 5287 (Seq Scan) - LEAF
...
- **Output:** st=0.29, rt=163.46

### Step 3: Node 5288 (Hash)
...
- **Output:** st=27.22, rt=231.00

### Step 5: Node 5290 (Index Scan) - LEAF
...
- **Output:** st=121.98, rt=1193.30

### Step 7: Node 5281 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5282, 5283, 5284
- **Input Features:**
