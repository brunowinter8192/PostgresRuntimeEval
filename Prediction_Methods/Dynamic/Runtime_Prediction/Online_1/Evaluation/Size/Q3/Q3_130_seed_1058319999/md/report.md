...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4681 | 4682, 4683, 4684 |
...
| 4685 | Nested Loop | 1145.49 | 1192.47 | 4.1% | operator |
| 4686 | Hash Join | 207.67 | 230.27 | 10.9% | operator |
| 4690 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4687 | Seq Scan | 154.13 | 163.22 | 5.9% | operator |
| 4688 | Hash | 31.10 | 17.75 | 42.9% | operator |
...
### Step 2: Node 4687 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37331.4100
- **Output:** st=27.15, rt=230.27

### Step 5: Node 4690 (Index Scan) - LEAF
...
- **Output:** st=121.19, rt=1192.47

### Step 7: Node 4681 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4682, 4683, 4684
- **Input Features:**
