...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5381 | 5382, 5383, 5384 |
...
| 5385 | Nested Loop | 1159.99 | 1192.78 | 2.8% | operator |
| 5386 | Hash Join | 210.64 | 230.21 | 9.3% | operator |
| 5390 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5387 | Seq Scan | 157.82 | 163.18 | 3.4% | operator |
| 5388 | Hash | 30.40 | 17.75 | 41.6% | operator |
...
### Step 2: Node 5387 (Seq Scan) - LEAF
...
### Step 5: Node 5390 (Index Scan) - LEAF
...
### Step 7: Node 5381 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5382, 5383, 5384
- **Input Features:**
