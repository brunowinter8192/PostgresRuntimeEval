...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4471 | 4472, 4473, 4474 |
...
| 4475 | Nested Loop | 1151.79 | 1192.70 | 3.6% | operator |
| 4476 | Hash Join | 208.51 | 230.62 | 10.6% | operator |
| 4480 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4477 | Seq Scan | 156.19 | 163.34 | 4.6% | operator |
| 4478 | Hash | 29.67 | 17.75 | 40.2% | operator |
...
### Step 2: Node 4477 (Seq Scan) - LEAF
...
### Step 5: Node 4480 (Index Scan) - LEAF
...
### Step 7: Node 4471 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4472, 4473, 4474
- **Input Features:**
