...
**Test Query:** Q18_82_seed_664526511
...
```
Node 30900 (Limit) - ROOT
  Node 30901 (Sort)
    Node 30902 (Aggregate)
      Node 30903 (Gather Merge)
        Node 30904 (Incremental Sort)
          Node 30905 (Nested Loop)
            Node 30906 (Merge Join)
              Node 30907 (Sort)
                Node 30908 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30909 (Seq Scan) [consumed] - LEAF
                  Node 30910 (Hash) [consumed]
                    Node 30911 (Aggregate)
                      Node 30912 (Index Scan) - LEAF
              Node 30913 (Sort)
                Node 30914 (Seq Scan) - LEAF
            Node 30915 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30908 | 30909, 30910 |
...
|------|------|--------|-----------|-----|--------|
| 30900 | Limit | 3067.34 | 1175.21 | 61.7% | operator |
| 30901 | Sort | 2954.60 | 1127.81 | 61.8% | operator |
| 30902 | Aggregate | 2954.56 | 1073.15 | 63.7% | operator |
| 30903 | Gather Merge | 2954.55 | 1073.95 | 63.7% | operator |
| 30904 | Incremental Sort | 2920.75 | 0.00 | 100.0% | operator |
| 30905 | Nested Loop | 2920.70 | 1111.34 | 61.9% | operator |
| 30906 | Merge Join | 2920.65 | 0.00 | 100.0% | operator |
| 30915 | Index Scan | 0.02 | 0.05 | 137.6% | operator |
| 30907 | Sort | 2870.17 | 1095.58 | 61.8% | operator |
| 30913 | Sort | 64.40 | 1074.66 | 1568.6% | operator |
| 30908 | Hash Join | 2870.16 | 471.07 | 83.6% | pattern |
| 30914 | Seq Scan | 53.01 | 18.25 | 65.6% | operator |
| 30911 | Aggregate | 2638.92 | 1073.15 | 59.3% | operator |
| 30912 | Index Scan | 2127.42 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30912 (Index Scan) - LEAF
...
### Step 3: Node 30908 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30909, 30910
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30914 (Seq Scan) - LEAF
...
### Step 7: Node 30906 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30915 (Index Scan) - LEAF
...
### Step 10: Node 30904 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30903 (Gather Merge)
