...
**Test Query:** Q10_56_seed_451221705
...
```
Node 20683 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 20684 (Sort) [consumed]
    Node 20685 (Aggregate) [consumed]
      Node 20686 (Gather) [consumed]
        Node 20687 (Hash Join)
          Node 20688 (Hash Join) [PATTERN: 2e0f44ef]
            Node 20689 (Nested Loop) [consumed]
              Node 20690 (Seq Scan) - LEAF
              Node 20691 (Index Scan) - LEAF
            Node 20692 (Hash) [consumed]
              Node 20693 (Seq Scan) - LEAF
          Node 20694 (Hash)
            Node 20695 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20683 | 20684, 20685, 20686, 20688, 20689, 20692 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 20688 | 20683, 20684, 20685, 20686, 20689, 20692 |
...
|------|------|--------|-----------|-----|--------|
| 20683 | Limit | 1130.54 | 1199.47 | 6.1% | pattern |
| 20687 | Hash Join | 1079.62 | 1095.55 | 1.5% | operator |
| 20688 | Hash Join | 1076.68 | 1120.19 | 4.0% | pattern |
| 20694 | Hash | 0.02 | 15.71 | 78453.9% | operator |
| 20695 | Seq Scan | 0.02 | 6.98 | 43516.9% | operator |
| 20690 | Seq Scan | 159.75 | 159.74 | 0.0% | operator |
| 20691 | Index Scan | 0.06 | -0.52 | 949.6% | operator |
| 20693 | Seq Scan | 19.87 | 26.64 | 34.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 20690 (Seq Scan) - LEAF
...
### Step 2: Node 20691 (Index Scan) - LEAF
...
### Step 3: Node 20693 (Seq Scan) - LEAF
...
### Step 4: Node 20695 (Seq Scan) - LEAF
...
### Step 5: Node 20688 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 20683, 20684, 20685, 20686, 20689, 20692
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18184
  - HashJoin_nt1=18184
...
### Step 8: Node 20683 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20684, 20685, 20686, 20688, 20689, 20692
- **Input Features:**
