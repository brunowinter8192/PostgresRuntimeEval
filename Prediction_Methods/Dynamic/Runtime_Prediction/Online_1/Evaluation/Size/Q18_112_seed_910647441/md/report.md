        ...
        Node 29032 (Incremental Sort)
          Node 29033 (Nested Loop)
            Node 29034 (Merge Join)
              Node 29035 (Sort)
                Node 29036 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29037 (Seq Scan) [consumed] - LEAF
                  Node 29038 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29036 | 29037, 29038 |
...
| 29035 | Sort | 2805.69 | 1095.58 | 61.0% | operator |
| 29041 | Sort | 69.09 | 1074.66 | 1455.5% | operator |
| 29036 | Hash Join | 2805.68 | 471.07 | 83.2% | pattern |
...
### Step 3: Node 29036 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29037, 29038
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29042 (Seq Scan) - LEAF
...
### Step 7: Node 29034 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29043 (Index Scan) - LEAF
...
### Step 10: Node 29032 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29031 (Gather Merge)
