...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20800 | 20801, 20802, 20803, 20805, 20806, 20809 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 20805 | 20800, 20801, 20802, 20803, 20806, 20809 |
...
|------|------|--------|-----------|-----|--------|
| 20800 | Limit | 1166.99 | 1199.47 | 2.8% | pattern |
| 20804 | Hash Join | 1117.76 | 1095.51 | 2.0% | operator |
| 20805 | Hash Join | 1114.88 | 1120.19 | 0.5% | pattern |
| 20811 | Hash | 0.01 | 15.71 | 120752.1% | operator |
| 20812 | Seq Scan | 0.01 | 6.98 | 77441.2% | operator |
| 20807 | Seq Scan | 159.18 | 159.74 | 0.4% | operator |
| 20808 | Index Scan | 0.06 | -0.52 | 922.6% | operator |
| 20810 | Seq Scan | 29.16 | 26.64 | 8.6% | operator |
...
- **Consumes:** Nodes 20800, 20801, 20802, 20803, 20806, 20809
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18015
  - HashJoin_nt1=18015
...
### Step 8: Node 20800 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20801, 20802, 20803, 20805, 20806, 20809
- **Input Features:**
