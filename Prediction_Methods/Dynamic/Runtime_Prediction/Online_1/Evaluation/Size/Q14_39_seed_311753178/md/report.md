...
```
Node 26994 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26995 (Gather) [consumed]
    Node 26996 (Aggregate) [consumed]
      Node 26997 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26994 | 26995, 26996, 26997 |
...
|------|------|--------|-----------|-----|--------|
| 26994 | Aggregate | 814.55 | 857.10 | 5.2% | pattern |
...
### Step 4: Node 26994 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26995, 26996, 26997
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=13479
  - HashJoin_Outer_nt1=13479
  ...
  - HashJoin_Outer_total_cost=136642.0200
- **Output:** st=850.74, rt=857.10
