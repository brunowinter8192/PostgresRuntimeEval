...
**Test Query:** Q1_19_seed_147672558
...
```
Node 301 (Aggregate) - ROOT
  Node 302 (Gather Merge)
    Node 303 (Sort) [PATTERN: 1d35fb97]
      Node 304 (Aggregate) [consumed]
        Node 305 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 303 | 304 |
...
|------|------|--------|-----------|-----|--------|
| 301 | Aggregate | 972.36 | 1195.85 | 23.0% | operator |
| 302 | Gather Merge | 972.32 | 1165.90 | 19.9% | operator |
| 303 | Sort | 952.66 | 1200.37 | 26.0% | pattern |
| 305 | Seq Scan | 549.90 | 680.77 | 23.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 305 (Seq Scan) - LEAF
...
### Step 2: Node 303 (Sort) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Aggregate_Outer_nt1=1179164
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=236
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=168873.7800
  - Aggregate_Outer_total_cost=168873.9100
  - Sort_np=0
  - Sort_nt=6
  - Sort_nt1=6
  - Sort_nt2=0
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=168873.9900
  - Sort_total_cost=168874.0100
- **Output:** st=1196.27, rt=1200.37

### Step 3: Node 302 (Gather Merge)
...
- **Output:** st=1161.77, rt=1165.90

### Step 4: Node 301 (Aggregate) - ROOT
