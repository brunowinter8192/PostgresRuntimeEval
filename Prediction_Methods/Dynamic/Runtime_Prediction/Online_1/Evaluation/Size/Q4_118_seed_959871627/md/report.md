...
```
Node 5984 (Aggregate) [PATTERN: f8231c4d] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 5984 | 5985, 5986, 5987 |
...
|------|------|--------|-----------|-----|--------|
| 5984 | Aggregate | 1040.21 | 952.19 | 8.5% | pattern |
| 5988 | Nested Loop | 1033.29 | 1255.45 | 21.5% | operator |
| 5989 | Seq Scan | 164.08 | 154.66 | 5.7% | operator |
| 5990 | Index Scan | 0.06 | 11.10 | 18103.8% | operator |
...
### Step 4: Node 5984 (Aggregate) - PATTERN ROOT
