...
```
Node 18336 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18337 (Aggregate) [consumed]
    Node 18338 (Gather)
      Node 18339 (Aggregate)
        Node 18340 (Nested Loop)
          Node 18341 (Hash Join) [PATTERN: bb930825]
            Node 18342 (Seq Scan) [consumed] - LEAF
            Node 18343 (Hash) [consumed]
              Node 18344 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18341 | 18336, 18337, 18342, 18343, 18344 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18336 | 18337, 18341, 18342, 18343, 18344 |
...
|------|------|--------|-----------|-----|--------|
| 18336 | Sort | 1209.49 | 1045.32 | 13.6% | pattern |
...
| 18341 | Hash Join | 993.98 | 134.80 | 86.4% | pattern |
...
### Step 9: Node 18341 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18336, 18337, 18342, 18343, 18344
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18353 (Index Scan) - LEAF
...
### Step 11: Node 18340 (Nested Loop)
...
### Step 14: Node 18336 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18337, 18341, 18342, 18343, 18344
- **Input Features:**
