...
**Test Query:** Q9_49_seed_393793488
...
```
Node 18336 (Sort) - ROOT
  Node 18337 (Aggregate)
    Node 18338 (Gather)
      Node 18339 (Aggregate)
        Node 18340 (Nested Loop)
          Node 18341 (Hash Join)
            Node 18342 (Seq Scan) - LEAF
            Node 18343 (Hash)
              Node 18344 (Hash Join)
                Node 18345 (Hash Join)
                  Node 18346 (Nested Loop)
                    Node 18347 (Seq Scan) - LEAF
                    Node 18348 (Index Scan) - LEAF
                  Node 18349 (Hash)
                    Node 18350 (Seq Scan) - LEAF
                Node 18351 (Hash)
                  Node 18352 (Seq Scan) - LEAF
          Node 18353 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 18336 | Sort | 1209.49 | 1119.51 | 7.4% | operator |
| 18337 | Aggregate | 1209.37 | 897.44 | 25.8% | operator |
| 18338 | Gather | 1208.35 | 964.64 | 20.2% | operator |
| 18339 | Aggregate | 1188.60 | 1095.61 | 7.8% | operator |
| 18340 | Nested Loop | 1164.07 | 1252.17 | 7.6% | operator |
| 18341 | Hash Join | 993.98 | 633.32 | 36.3% | operator |
| 18353 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18342 | Seq Scan | 714.75 | 509.93 | 28.7% | operator |
| 18343 | Hash | 183.97 | 47.91 | 74.0% | operator |
| 18344 | Hash Join | 182.00 | 924.43 | 407.9% | operator |
| 18345 | Hash Join | 168.13 | 837.61 | 398.2% | operator |
| 18351 | Hash | 13.26 | 14.95 | 12.8% | operator |
| 18346 | Nested Loop | 161.20 | 1251.77 | 676.5% | operator |
| 18349 | Hash | 4.49 | 15.94 | 254.9% | operator |
| 18352 | Seq Scan | 13.25 | 2.94 | 77.8% | operator |
| 18347 | Seq Scan | 20.79 | 44.03 | 111.8% | operator |
| 18348 | Index Scan | 0.08 | -1.39 | 1903.2% | operator |
| 18350 | Seq Scan | 3.86 | 9.45 | 144.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 18347 (Seq Scan) - LEAF
...
### Step 2: Node 18348 (Index Scan) - LEAF
...
### Step 3: Node 18350 (Seq Scan) - LEAF
...
### Step 6: Node 18352 (Seq Scan) - LEAF
...
### Step 10: Node 18342 (Seq Scan) - LEAF
...
### Step 13: Node 18353 (Index Scan) - LEAF
...
### Step 14: Node 18340 (Nested Loop)
