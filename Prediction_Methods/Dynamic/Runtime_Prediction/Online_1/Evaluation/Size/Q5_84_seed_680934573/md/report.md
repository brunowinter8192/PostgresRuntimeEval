...
```
Node 9541 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 9542 (Aggregate) [consumed]
    Node 9543 (Gather Merge) [consumed]
      Node 9544 (Aggregate)
        Node 9545 (Sort) [PATTERN: 3e2d5a00]
          Node 9546 (Hash Join) [consumed]
            Node 9547 (Nested Loop)
              Node 9548 (Hash Join)
                Node 9549 (Seq Scan) - LEAF
                Node 9550 (Hash) [PATTERN: 444761fb]
                  Node 9551 (Hash Join) [consumed]
                    Node 9552 (Seq Scan) [consumed] - LEAF
                    Node 9553 (Hash) [consumed]
                      Node 9554 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 9550 | 9541, 9542, 9543, 9545, 9546, 9551, 9552, 9553, 9554 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 9541 | 9542, 9543, 9545, 9546, 9550, 9551, 9552, 9553, 9554 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 9545 | 9541, 9542, 9543, 9546, 9550, 9551, 9552, 9553, 9554 |
...
|------|------|--------|-----------|-----|--------|
| 9541 | Sort | 1063.84 | 2934.42 | 175.8% | pattern |
| 9544 | Aggregate | 1059.16 | 1128.74 | 6.6% | operator |
| 9545 | Sort | 1058.93 | 1835.96 | 73.4% | pattern |
| 9547 | Nested Loop | 1046.54 | 1188.57 | 13.6% | operator |
| 9559 | Hash | 3.90 | 18.67 | 379.2% | operator |
| 9548 | Hash Join | 218.19 | 253.07 | 16.0% | operator |
| 9558 | Index Scan | 0.07 | -0.22 | 401.4% | operator |
| 9560 | Seq Scan | 3.37 | 12.36 | 267.0% | operator |
| 9549 | Seq Scan | 167.33 | 159.81 | 4.5% | operator |
| 9550 | Hash | 37.95 | 46.85 | 23.4% | pattern |
| 9555 | Seq Scan | 0.01 | 11.81 | 147503.4% | operator |
| 9556 | Hash | 0.12 | 21.05 | 17156.8% | operator |
| 9557 | Seq Scan | 0.12 | 22.93 | 19011.1% | operator |
...
### Step 4: Node 9549 (Seq Scan) - LEAF
...
### Step 5: Node 9550 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 9541, 9542, 9543, 9545, 9546, 9551, 9552, 9553, 9554
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 9558 (Index Scan) - LEAF
...
### Step 8: Node 9560 (Seq Scan) - LEAF
...
### Step 11: Node 9545 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 9541, 9542, 9543, 9546, 9550, 9551, 9552, 9553, 9554
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 9541 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 9542, 9543, 9545, 9546, 9550, 9551, 9552, 9553, 9554
- **Input Features:**
