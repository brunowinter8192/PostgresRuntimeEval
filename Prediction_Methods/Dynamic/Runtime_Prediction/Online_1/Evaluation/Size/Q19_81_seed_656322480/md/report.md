...
```
Node 32123 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 32124 (Gather) [consumed]
    Node 32125 (Aggregate) [consumed]
      Node 32126 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 32123 | 32124, 32125, 32126 |
...
|------|------|--------|-----------|-----|--------|
| 32123 | Aggregate | 835.41 | 829.28 | 0.7% | pattern |
| 32127 | Seq Scan | 766.93 | 743.46 | 3.1% | operator |
| 32128 | Hash | 46.10 | 8.29 | 82.0% | operator |
| 32129 | Seq Scan | 45.96 | 23.76 | 48.3% | operator |
...
### Step 4: Node 32123 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 32124, 32125, 32126
- **Input Features:**
  ...
  - Aggregate_Outer_startup_cost=156338.5400
  - Aggregate_Outer_total_cost=156338.5500
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - HashJoin_Outer_total_cost=156338.3600
