...
```
Node 31724 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31725 (Gather) [consumed]
    Node 31726 (Aggregate) [consumed]
      Node 31727 (Hash Join) [consumed]
        Node 31728 (Seq Scan) - LEAF
        Node 31729 (Hash)
          Node 31730 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31724 | 31725, 31726, 31727 |
...
|------|------|--------|-----------|-----|--------|
| 31724 | Aggregate | 850.86 | 829.30 | 2.5% | pattern |
| 31728 | Seq Scan | 781.61 | 743.46 | 4.9% | operator |
| 31729 | Hash | 46.81 | 8.29 | 82.3% | operator |
| 31730 | Seq Scan | 46.66 | 23.76 | 49.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31730 (Seq Scan) - LEAF
...
### Step 2: Node 31728 (Seq Scan) - LEAF
...
### Step 4: Node 31724 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31725, 31726, 31727
- **Input Features:**
