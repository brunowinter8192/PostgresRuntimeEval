...
```
Node 31724 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31725 (Gather) [consumed]
    Node 31726 (Aggregate) [consumed]
      Node 31727 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31724 | 31725, 31726 |
...
|------|------|--------|-----------|-----|--------|
| 31724 | Aggregate | 850.86 | 831.20 | 2.3% | pattern |
| 31727 | Hash Join | 830.95 | 766.05 | 7.8% | operator |
...
### Step 5: Node 31724 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31725, 31726
- **Input Features:**
