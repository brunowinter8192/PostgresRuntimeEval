...
**Test Query:** Q18_81_seed_656322480
...
```
Node 30884 (Limit) - ROOT
  Node 30885 (Sort)
    Node 30886 (Aggregate)
      Node 30887 (Gather Merge)
        Node 30888 (Incremental Sort)
          Node 30889 (Nested Loop)
            Node 30890 (Merge Join)
              Node 30891 (Sort)
                Node 30892 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30893 (Seq Scan) [consumed] - LEAF
                  Node 30894 (Hash) [consumed]
                    Node 30895 (Aggregate)
                      Node 30896 (Index Scan) - LEAF
              Node 30897 (Sort)
                Node 30898 (Seq Scan) - LEAF
            Node 30899 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30892 | 30893, 30894 |
...
|------|------|--------|-----------|-----|--------|
| 30884 | Limit | 3055.82 | 1175.21 | 61.5% | operator |
| 30885 | Sort | 2937.62 | 1127.81 | 61.6% | operator |
| 30886 | Aggregate | 2937.58 | 1073.15 | 63.5% | operator |
| 30887 | Gather Merge | 2937.56 | 1073.95 | 63.4% | operator |
| 30888 | Incremental Sort | 2901.19 | 0.00 | 100.0% | operator |
| 30889 | Nested Loop | 2901.13 | 1111.34 | 61.7% | operator |
| 30890 | Merge Join | 2901.08 | 0.00 | 100.0% | operator |
| 30899 | Index Scan | 0.02 | 0.05 | 125.7% | operator |
| 30891 | Sort | 2849.45 | 1095.58 | 61.6% | operator |
| 30897 | Sort | 65.96 | 1074.66 | 1529.4% | operator |
| 30892 | Hash Join | 2849.44 | 471.07 | 83.5% | pattern |
| 30898 | Seq Scan | 52.86 | 18.25 | 65.5% | operator |
| 30895 | Aggregate | 2621.14 | 1073.15 | 59.1% | operator |
| 30896 | Index Scan | 2135.98 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30896 (Index Scan) - LEAF
...
### Step 3: Node 30892 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30893, 30894
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30898 (Seq Scan) - LEAF
...
### Step 7: Node 30890 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30899 (Index Scan) - LEAF
...
### Step 10: Node 30888 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30887 (Gather Merge)
