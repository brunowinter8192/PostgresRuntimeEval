        ...
        Node 30888 (Incremental Sort)
          Node 30889 (Nested Loop)
            Node 30890 (Merge Join)
              Node 30891 (Sort)
                Node 30892 (Hash Join)
                  Node 30893 (Seq Scan) - LEAF
                  Node 30894 (Hash)
...
| 30891 | Sort | 2849.45 | 1099.77 | 61.4% | operator |
| 30897 | Sort | 65.96 | 1074.66 | 1529.4% | operator |
| 30892 | Hash Join | 2849.44 | 686.33 | 75.9% | operator |
| 30898 | Seq Scan | 52.86 | 18.25 | 65.5% | operator |
| 30893 | Seq Scan | 198.94 | 170.37 | 14.4% | operator |
| 30894 | Hash | 2621.16 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30893 (Seq Scan) - LEAF
...
### Step 6: Node 30898 (Seq Scan) - LEAF
...
### Step 9: Node 30890 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30899 (Index Scan) - LEAF
...
### Step 11: Node 30889 (Nested Loop)
...
### Step 12: Node 30888 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30887 (Gather Merge)
