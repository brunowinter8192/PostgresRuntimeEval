...
```
Node 14397 (Aggregate) - ROOT
  Node 14398 (Gather Merge)
    Node 14399 (Sort)
          ...
          Node 14402 (Hash Join)
            Node 14403 (Nested Loop)
              Node 14404 (Hash Join)
                ...
                Node 14406 (Hash)
                  Node 14407 (Hash Join)
                    Node 14408 (Seq Scan) - LEAF
                    Node 14409 (Hash)
                      Node 14410 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 14397 | Aggregate | 1225.59 | 1178.29 | 3.9% | operator |
| 14398 | Gather Merge | 1225.17 | 1097.17 | 10.4% | operator |
...
| 14404 | Hash Join | 217.18 | 251.17 | 15.7% | operator |
...
| 14406 | Hash | 37.38 | 20.62 | 44.8% | operator |
| 14407 | Hash Join | 36.81 | 132.26 | 259.3% | operator |
| 14408 | Seq Scan | 35.40 | 23.03 | 34.9% | operator |
| 14409 | Hash | 0.14 | 23.66 | 16677.4% | operator |
| 14410 | Hash Join | 0.14 | 306.84 | 222244.9% | operator |
...
### Step 5: Node 14408 (Seq Scan) - LEAF
...
### Step 8: Node 14405 (Seq Scan) - LEAF
...
### Step 11: Node 14414 (Index Scan) - LEAF
...
### Step 12: Node 14416 (Seq Scan) - LEAF
...
### Step 13: Node 14403 (Nested Loop)
...
### Step 16: Node 14417 (Index Scan) - LEAF
...
### Step 17: Node 14419 (Seq Scan) - LEAF
...
### Step 18: Node 14401 (Nested Loop)
...
### Step 22: Node 14398 (Gather Merge)
...
- **Input Features:**
  ...
  - total_cost=71879.8100
- **Output:** st=1093.47, rt=1097.17

### Step 23: Node 14397 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=71572.5600
  - total_cost=71979.8700
- **Output:** st=1155.40, rt=1178.29
