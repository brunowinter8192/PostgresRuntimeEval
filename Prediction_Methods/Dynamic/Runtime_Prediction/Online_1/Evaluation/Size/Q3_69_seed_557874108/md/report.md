...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5501 | 5502, 5503, 5504 |
...
| 5505 | Nested Loop | 1157.09 | 1193.01 | 3.1% | operator |
| 5506 | Hash Join | 206.55 | 230.54 | 11.6% | operator |
| 5510 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5507 | Seq Scan | 154.62 | 163.30 | 5.6% | operator |
| 5508 | Hash | 29.14 | 17.75 | 39.1% | operator |
...
### Step 2: Node 5507 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37336.4200
- **Output:** st=27.15, rt=230.54

### Step 5: Node 5510 (Index Scan) - LEAF
...
- **Output:** st=121.69, rt=1193.01

### Step 7: Node 5501 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5502, 5503, 5504
- **Input Features:**
