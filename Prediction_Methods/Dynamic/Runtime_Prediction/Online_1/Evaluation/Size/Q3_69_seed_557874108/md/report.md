...
**Test Query:** Q3_69_seed_557874108
...
```
Node 5501 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5502 (Sort) [consumed]
    Node 5503 (Aggregate) [consumed]
      Node 5504 (Gather) [consumed]
        Node 5505 (Nested Loop)
          Node 5506 (Hash Join) [PATTERN: 895c6e8c]
            Node 5507 (Seq Scan) [consumed] - LEAF
            Node 5508 (Hash) [consumed]
              Node 5509 (Seq Scan) - LEAF
          Node 5510 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5501 | 5502, 5503, 5504, 5506, 5507, 5508 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5506 | 5501, 5502, 5503, 5504, 5507, 5508 |
...
|------|------|--------|-----------|-----|--------|
| 5501 | Limit | 1192.55 | 1151.18 | 3.5% | pattern |
| 5505 | Nested Loop | 1157.09 | 1193.09 | 3.1% | operator |
| 5506 | Hash Join | 206.55 | 242.49 | 17.4% | pattern |
| 5510 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5509 | Seq Scan | 28.46 | 38.54 | 35.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5509 (Seq Scan) - LEAF
...
### Step 2: Node 5506 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5501, 5502, 5503, 5504, 5507, 5508
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46985
  - HashJoin_nt1=233820
  ...
  - HashJoin_total_cost=37336.4200
  - Hash_Inner_np=0
  - Hash_Inner_nt=12559
...
- **Input Features:**
  ...
  - total_cost=72967.6700
- **Output:** st=121.83, rt=1193.09

### Step 5: Node 5501 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5502, 5503, 5504, 5506, 5507, 5508
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=315318
  - Aggregate_Outer_nt1=315318
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110229.2400
  - Aggregate_Outer_total_cost=114170.7100
  - Gather_Outer_np=0
  - Gather_Outer_nt=315318
  - Gather_Outer_nt1=101715
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105499.4700
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=315318
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=120984.6200
  - Limit_total_cost=120984.6500
  - Sort_Outer_np=0
  - Sort_Outer_nt=315318
  - Sort_Outer_nt1=315318
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=120984.6200
  - Sort_Outer_total_cost=121772.9200
