...
**Test Query:** Q18_74_seed_598894263
...
```
Node 30756 (Limit) - ROOT
  Node 30757 (Sort)
    Node 30758 (Aggregate)
      Node 30759 (Gather Merge)
        Node 30760 (Incremental Sort)
          Node 30761 (Nested Loop)
            Node 30762 (Merge Join)
              Node 30763 (Sort)
                Node 30764 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30765 (Seq Scan) [consumed] - LEAF
                  Node 30766 (Hash) [consumed]
                    Node 30767 (Aggregate)
                      Node 30768 (Index Scan) - LEAF
              Node 30769 (Sort)
                Node 30770 (Seq Scan) - LEAF
            Node 30771 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30764 | 30765, 30766 |
...
|------|------|--------|-----------|-----|--------|
| 30756 | Limit | 3079.19 | 1175.21 | 61.8% | operator |
| 30757 | Sort | 2960.70 | 1127.81 | 61.9% | operator |
| 30758 | Aggregate | 2960.66 | 1073.15 | 63.8% | operator |
| 30759 | Gather Merge | 2960.64 | 1073.95 | 63.7% | operator |
| 30760 | Incremental Sort | 2939.74 | 0.00 | 100.0% | operator |
| 30761 | Nested Loop | 2939.69 | 1111.34 | 62.2% | operator |
| 30762 | Merge Join | 2939.62 | 0.00 | 100.0% | operator |
| 30771 | Index Scan | 0.02 | 0.05 | 105.2% | operator |
| 30763 | Sort | 2871.38 | 1095.58 | 61.8% | operator |
| 30769 | Sort | 65.31 | 1074.66 | 1545.6% | operator |
| 30764 | Hash Join | 2871.37 | 471.07 | 83.6% | pattern |
| 30770 | Seq Scan | 53.22 | 18.25 | 65.7% | operator |
| 30767 | Aggregate | 2637.09 | 1073.15 | 59.3% | operator |
| 30768 | Index Scan | 2127.34 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30768 (Index Scan) - LEAF
...
### Step 3: Node 30764 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30765, 30766
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30770 (Seq Scan) - LEAF
...
### Step 7: Node 30762 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30771 (Index Scan) - LEAF
...
### Step 10: Node 30760 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30759 (Gather Merge)
