        ...
        Node 30760 (Incremental Sort)
          Node 30761 (Nested Loop)
            Node 30762 (Merge Join)
              Node 30763 (Sort)
                Node 30764 (Hash Join)
                  Node 30765 (Seq Scan) - LEAF
                  Node 30766 (Hash)
...
| 30763 | Sort | 2871.38 | 1099.77 | 61.7% | operator |
| 30769 | Sort | 65.31 | 1074.66 | 1545.6% | operator |
| 30764 | Hash Join | 2871.37 | 686.33 | 76.1% | operator |
| 30770 | Seq Scan | 53.22 | 18.25 | 65.7% | operator |
| 30765 | Seq Scan | 204.72 | 170.37 | 16.8% | operator |
| 30766 | Hash | 2637.14 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30765 (Seq Scan) - LEAF
...
### Step 6: Node 30770 (Seq Scan) - LEAF
...
### Step 9: Node 30762 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30771 (Index Scan) - LEAF
...
### Step 11: Node 30761 (Nested Loop)
...
### Step 12: Node 30760 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30759 (Gather Merge)
