...
**Test Query:** Q19_11_seed_82040310
...
```
Node 31367 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31368 (Gather) [consumed]
    Node 31369 (Aggregate) [consumed]
      Node 31370 (Hash Join) [consumed]
        Node 31371 (Seq Scan) - LEAF
        Node 31372 (Hash)
          Node 31373 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31367 | 31368, 31369, 31370 |
...
|------|------|--------|-----------|-----|--------|
| 31367 | Aggregate | 874.79 | 829.30 | 5.2% | pattern |
| 31371 | Seq Scan | 806.52 | 743.46 | 7.8% | operator |
| 31372 | Hash | 46.31 | 8.29 | 82.1% | operator |
| 31373 | Seq Scan | 46.20 | 23.76 | 48.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31373 (Seq Scan) - LEAF
...
### Step 2: Node 31371 (Seq Scan) - LEAF
...
### Step 4: Node 31367 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31368, 31369, 31370
- **Input Features:**
