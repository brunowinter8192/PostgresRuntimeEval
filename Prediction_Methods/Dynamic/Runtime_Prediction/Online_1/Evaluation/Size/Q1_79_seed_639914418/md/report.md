...
**Test Query:** Q1_79_seed_639914418
...
```
Node 631 (Aggregate) - ROOT
  Node 632 (Gather Merge)
    Node 633 (Sort) [PATTERN: 1d35fb97]
      Node 634 (Aggregate) [consumed]
        Node 635 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 633 | 634 |
...
|------|------|--------|-----------|-----|--------|
| 631 | Aggregate | 931.75 | 1196.00 | 28.4% | operator |
| 632 | Gather Merge | 931.71 | 1165.94 | 25.1% | operator |
| 633 | Sort | 915.15 | 1200.95 | 31.2% | pattern |
| 635 | Seq Scan | 492.41 | 678.55 | 37.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 635 (Seq Scan) - LEAF
...
- **Output:** st=0.85, rt=678.55

### Step 2: Node 633 (Sort) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Aggregate_Outer_nt1=1190423
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=236
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=169267.8400
  - Aggregate_Outer_total_cost=169267.9800
  - Sort_np=0
  - Sort_nt=6
  - Sort_nt1=6
  - Sort_nt2=0
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=169268.0600
  - Sort_total_cost=169268.0700
- **Output:** st=1196.86, rt=1200.95

### Step 3: Node 632 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1196.8597
  - st2=0.0000
  - startup_cost=170268.1300
  - total_cost=170271.7600
- **Output:** st=1161.82, rt=1165.94

### Step 4: Node 631 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=170268.1300
  - total_cost=170272.9000
- **Output:** st=1149.94, rt=1196.00
