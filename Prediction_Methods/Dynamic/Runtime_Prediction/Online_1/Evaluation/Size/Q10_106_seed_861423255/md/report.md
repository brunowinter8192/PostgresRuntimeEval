...
**Test Query:** Q10_106_seed_861423255
...
```
Node 19448 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 19449 (Sort) [consumed]
    Node 19450 (Aggregate) [consumed]
      Node 19451 (Gather) [consumed]
        Node 19452 (Hash Join)
          Node 19453 (Hash Join) [PATTERN: 2e0f44ef]
            Node 19454 (Nested Loop) [consumed]
              Node 19455 (Seq Scan) - LEAF
              Node 19456 (Index Scan) - LEAF
            Node 19457 (Hash) [consumed]
              Node 19458 (Seq Scan) - LEAF
          Node 19459 (Hash)
            Node 19460 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19448 | 19449, 19450, 19451, 19453, 19454, 19457 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 19453 | 19448, 19449, 19450, 19451, 19454, 19457 |
...
|------|------|--------|-----------|-----|--------|
| 19448 | Limit | 1184.10 | 1199.47 | 1.3% | pattern |
| 19452 | Hash Join | 1136.08 | 1095.58 | 3.6% | operator |
| 19453 | Hash Join | 1133.12 | 1120.19 | 1.1% | pattern |
| 19459 | Hash | 0.01 | 15.71 | 104638.5% | operator |
| 19460 | Seq Scan | 0.01 | 6.98 | 63342.8% | operator |
| 19455 | Seq Scan | 162.99 | 159.74 | 2.0% | operator |
| 19456 | Index Scan | 0.06 | -0.52 | 922.6% | operator |
| 19458 | Seq Scan | 25.90 | 26.64 | 2.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 19455 (Seq Scan) - LEAF
...
### Step 2: Node 19456 (Index Scan) - LEAF
...
### Step 3: Node 19458 (Seq Scan) - LEAF
...
### Step 4: Node 19460 (Seq Scan) - LEAF
...
### Step 5: Node 19453 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 19448, 19449, 19450, 19451, 19454, 19457
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18276
  - HashJoin_nt1=18276
  ...
  - HashJoin_total_cost=80894.5200
  - Hash_Inner_np=0
  - Hash_Inner_nt=62500
  ...
  - NestedLoop_Outer_nt=18276
  - NestedLoop_Outer_nt1=18465
  ...
  - NestedLoop_Outer_total_cost=75840.3000
- **Output:** st=51.86, rt=1120.19

### Step 6: Node 19459 (Hash)
...
- **Input Features:**
  ...
  - total_cost=80952.1900
- **Output:** st=54.22, rt=1095.58

### Step 8: Node 19448 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19449, 19450, 19451, 19453, 19454, 19457
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=56656
  - Aggregate_Outer_nt1=56656
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=280
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=88325.9900
  - Aggregate_Outer_total_cost=89034.1900
  - Gather_Outer_np=0
  - Gather_Outer_nt=56656
  - Gather_Outer_nt1=18276
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=87617.7900
  - Limit_np=0
  - Limit_nt=20
  - Limit_nt1=56656
  - Limit_nt2=0
  ...
  - Limit_sel=0.0004
  - Limit_startup_cost=90541.7900
  - Limit_total_cost=90541.8400
  - Sort_Outer_np=0
  - Sort_Outer_nt=56656
  - Sort_Outer_nt1=56656
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=280
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=90541.7900
  - Sort_Outer_total_cost=90683.4300
