...
**Test Query:** Q12_53_seed_426609612
...
```
Node 25006 (Aggregate) - ROOT
  Node 25007 (Gather Merge)
    Node 25008 (Aggregate)
      Node 25009 (Sort)
        Node 25010 (Nested Loop)
          Node 25011 (Seq Scan) - LEAF
          Node 25012 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 25006 | Aggregate | 1021.40 | 919.07 | 10.0% | operator |
| 25007 | Gather Merge | 1021.39 | 1111.84 | 8.9% | operator |
| 25008 | Aggregate | 998.36 | 895.31 | 10.3% | operator |
| 25009 | Sort | 997.72 | 1092.81 | 9.5% | operator |
| 25010 | Nested Loop | 996.74 | 1127.41 | 13.1% | operator |
| 25011 | Seq Scan | 853.84 | 745.19 | 12.7% | operator |
| 25012 | Index Scan | 0.03 | 0.07 | 166.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25011 (Seq Scan) - LEAF
...
### Step 2: Node 25012 (Index Scan) - LEAF
...
### Step 6: Node 25007 (Gather Merge)
...
### Step 7: Node 25006 (Aggregate) - ROOT
