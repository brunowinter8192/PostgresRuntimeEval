...
**Test Query:** Q1_147_seed_1197788526
...
```
Node 256 (Aggregate) - ROOT
  Node 257 (Gather Merge)
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 258 | 259 |
...
|------|------|--------|-----------|-----|--------|
| 256 | Aggregate | 954.45 | 1195.94 | 25.3% | operator |
| 257 | Gather Merge | 954.38 | 1165.92 | 22.2% | operator |
| 258 | Sort | 934.03 | 1200.71 | 28.6% | pattern |
| 260 | Seq Scan | 496.77 | 679.47 | 36.8% | operator |
...
### Step 4: Node 256 (Aggregate) - ROOT
