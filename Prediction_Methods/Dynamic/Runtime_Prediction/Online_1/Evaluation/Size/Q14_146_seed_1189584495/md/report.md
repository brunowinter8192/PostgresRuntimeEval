...
**Test Query:** Q14_146_seed_1189584495
...
```
Node 26770 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26771 (Gather) [consumed]
    Node 26772 (Aggregate) [consumed]
      Node 26773 (Hash Join) [consumed]
        Node 26774 (Seq Scan) - LEAF
        Node 26775 (Hash)
          Node 26776 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26770 | 26771, 26772, 26773 |
...
|------|------|--------|-----------|-----|--------|
| 26770 | Aggregate | 807.69 | 857.14 | 6.1% | pattern |
| 26774 | Seq Scan | 737.13 | 758.50 | 2.9% | operator |
| 26775 | Hash | 42.75 | 9.38 | 78.1% | operator |
| 26776 | Seq Scan | 39.13 | 12.70 | 67.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26776 (Seq Scan) - LEAF
...
### Step 2: Node 26774 (Seq Scan) - LEAF
...
### Step 4: Node 26770 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26771, 26772, 26773
- **Input Features:**
