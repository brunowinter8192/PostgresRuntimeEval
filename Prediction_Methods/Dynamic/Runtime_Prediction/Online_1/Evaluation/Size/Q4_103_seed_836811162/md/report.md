...
**Test Query:** Q4_103_seed_836811162
...
```
Node 5872 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 5873 (Gather Merge) [consumed]
    Node 5874 (Sort) [consumed]
      Node 5875 (Aggregate) [consumed]
        Node 5876 (Nested Loop)
          Node 5877 (Seq Scan) - LEAF
          Node 5878 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 5872 | 5873, 5874, 5875 |
...
|------|------|--------|-----------|-----|--------|
| 5872 | Aggregate | 1036.37 | 952.19 | 8.1% | pattern |
| 5876 | Nested Loop | 1030.01 | 1255.45 | 21.9% | operator |
| 5877 | Seq Scan | 165.19 | 154.66 | 6.4% | operator |
| 5878 | Index Scan | 0.06 | 11.10 | 17810.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5877 (Seq Scan) - LEAF
...
### Step 2: Node 5878 (Index Scan) - LEAF
