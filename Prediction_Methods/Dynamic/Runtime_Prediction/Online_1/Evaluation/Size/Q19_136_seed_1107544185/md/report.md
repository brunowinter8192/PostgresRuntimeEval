...
**Test Query:** Q19_136_seed_1107544185
...
```
Node 31493 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31494 (Gather) [consumed]
    Node 31495 (Aggregate) [consumed]
      Node 31496 (Hash Join) [consumed]
        Node 31497 (Seq Scan) - LEAF
        Node 31498 (Hash)
          Node 31499 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31493 | 31494, 31495, 31496 |
...
|------|------|--------|-----------|-----|--------|
| 31493 | Aggregate | 864.95 | 829.30 | 4.1% | pattern |
| 31497 | Seq Scan | 798.22 | 743.46 | 6.9% | operator |
| 31498 | Hash | 47.66 | 8.29 | 82.6% | operator |
| 31499 | Seq Scan | 47.57 | 23.76 | 50.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31499 (Seq Scan) - LEAF
...
### Step 2: Node 31497 (Seq Scan) - LEAF
...
### Step 4: Node 31493 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31494, 31495, 31496
- **Input Features:**
  ...
  - Aggregate_startup_cost=157339.3500
  - Aggregate_total_cost=157339.3600
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - HashJoin_Outer_total_cost=156338.6300
