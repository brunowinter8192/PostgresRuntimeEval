    ...
    Node 20984 (Aggregate) [consumed]
      Node 20985 (Gather) [consumed]
        Node 20986 (Hash Join)
          Node 20987 (Hash Join)
            Node 20988 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20982 | 20983, 20984, 20985 |
...
| 20986 | Hash Join | 1101.80 | 1007.16 | 8.6% | operator |
| 20987 | Hash Join | 1098.68 | 1004.03 | 8.6% | operator |
| 20993 | Hash | 0.01 | 15.71 | 104638.5% | operator |
| 20988 | Nested Loop | 1051.90 | 1204.85 | 14.5% | operator |
| 20991 | Hash | 36.24 | 55.57 | 53.4% | operator |
...
### Step 6: Node 20994 (Seq Scan) - LEAF
...
### Step 10: Node 20982 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20983, 20984, 20985
- **Input Features:**
