...
```
Node 14006 (Aggregate) - ROOT
  Node 14007 (Gather Merge)
    Node 14008 (Sort)
          ...
          Node 14011 (Hash Join)
            Node 14012 (Nested Loop)
              Node 14013 (Hash Join)
                ...
                Node 14015 (Hash)
                  Node 14016 (Hash Join)
                    Node 14017 (Seq Scan) - LEAF
                    Node 14018 (Hash)
                      Node 14019 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 14006 | Aggregate | 1204.22 | 1195.83 | 0.7% | operator |
| 14007 | Gather Merge | 1203.75 | 1097.13 | 8.9% | operator |
...
| 14013 | Hash Join | 207.11 | 251.17 | 21.3% | operator |
...
| 14015 | Hash | 32.86 | 20.62 | 37.3% | operator |
| 14016 | Hash Join | 32.00 | 132.26 | 313.4% | operator |
| 14017 | Seq Scan | 30.55 | 23.03 | 24.6% | operator |
| 14018 | Hash | 0.15 | 23.66 | 15670.7% | operator |
| 14019 | Hash Join | 0.15 | 306.84 | 210061.6% | operator |
...
### Step 5: Node 14017 (Seq Scan) - LEAF
...
### Step 8: Node 14014 (Seq Scan) - LEAF
...
### Step 11: Node 14023 (Index Scan) - LEAF
...
### Step 12: Node 14025 (Seq Scan) - LEAF
...
### Step 13: Node 14012 (Nested Loop)
...
### Step 16: Node 14026 (Index Scan) - LEAF
...
### Step 17: Node 14028 (Seq Scan) - LEAF
...
### Step 18: Node 14010 (Nested Loop)
...
### Step 22: Node 14007 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1044.9408
  - st2=0.0000
  - startup_cost=71542.7600
  - total_cost=71820.9000
- **Output:** st=1093.42, rt=1097.13

### Step 23: Node 14006 (Aggregate) - ROOT
