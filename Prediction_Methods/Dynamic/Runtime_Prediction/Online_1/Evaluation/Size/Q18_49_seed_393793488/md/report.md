...
**Test Query:** Q18_49_seed_393793488
...
```
Node 30308 (Limit) - ROOT
  Node 30309 (Sort)
    Node 30310 (Aggregate)
      Node 30311 (Gather Merge)
        Node 30312 (Incremental Sort)
          Node 30313 (Nested Loop)
            Node 30314 (Merge Join)
              Node 30315 (Sort)
                Node 30316 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30317 (Seq Scan) [consumed] - LEAF
                  Node 30318 (Hash) [consumed]
                    Node 30319 (Aggregate)
                      Node 30320 (Index Scan) - LEAF
              Node 30321 (Sort)
                Node 30322 (Seq Scan) - LEAF
            Node 30323 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30316 | 30317, 30318 |
...
|------|------|--------|-----------|-----|--------|
| 30308 | Limit | 3062.61 | 1175.21 | 61.6% | operator |
| 30309 | Sort | 2944.01 | 1127.81 | 61.7% | operator |
| 30310 | Aggregate | 2943.97 | 1073.15 | 63.5% | operator |
| 30311 | Gather Merge | 2943.95 | 1073.95 | 63.5% | operator |
| 30312 | Incremental Sort | 2923.41 | 0.00 | 100.0% | operator |
| 30313 | Nested Loop | 2923.36 | 1111.34 | 62.0% | operator |
| 30314 | Merge Join | 2923.30 | 0.00 | 100.0% | operator |
| 30323 | Index Scan | 0.02 | 0.05 | 88.1% | operator |
| 30315 | Sort | 2852.32 | 1095.58 | 61.6% | operator |
| 30321 | Sort | 66.28 | 1074.66 | 1521.3% | operator |
| 30316 | Hash Join | 2852.31 | 471.07 | 83.5% | pattern |
| 30322 | Seq Scan | 53.49 | 18.25 | 65.9% | operator |
| 30319 | Aggregate | 2628.05 | 1073.15 | 59.2% | operator |
| 30320 | Index Scan | 2137.59 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30320 (Index Scan) - LEAF
...
### Step 3: Node 30316 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30317, 30318
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30322 (Seq Scan) - LEAF
...
### Step 7: Node 30314 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30323 (Index Scan) - LEAF
...
### Step 10: Node 30312 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30311 (Gather Merge)
