        ...
        Node 30312 (Incremental Sort)
          Node 30313 (Nested Loop)
            Node 30314 (Merge Join)
              Node 30315 (Sort)
                Node 30316 (Hash Join)
                  Node 30317 (Seq Scan) - LEAF
                  Node 30318 (Hash)
...
| 30315 | Sort | 2852.32 | 1099.77 | 61.4% | operator |
| 30321 | Sort | 66.28 | 1074.66 | 1521.3% | operator |
| 30316 | Hash Join | 2852.31 | 686.33 | 75.9% | operator |
| 30322 | Seq Scan | 53.49 | 18.25 | 65.9% | operator |
| 30317 | Seq Scan | 194.29 | 170.37 | 12.3% | operator |
| 30318 | Hash | 2628.09 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30317 (Seq Scan) - LEAF
...
### Step 6: Node 30322 (Seq Scan) - LEAF
...
### Step 9: Node 30314 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30323 (Index Scan) - LEAF
...
### Step 11: Node 30313 (Nested Loop)
...
### Step 12: Node 30312 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30311 (Gather Merge)
