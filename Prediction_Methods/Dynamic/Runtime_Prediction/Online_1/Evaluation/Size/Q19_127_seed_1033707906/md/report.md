...
```
Node 31423 (Aggregate) [PATTERN: efde8b38] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31423 | 31424, 31425, 31426 |
...
|------|------|--------|-----------|-----|--------|
| 31423 | Aggregate | 811.00 | 829.28 | 2.3% | pattern |
| 31427 | Seq Scan | 744.29 | 743.46 | 0.1% | operator |
| 31428 | Hash | 46.31 | 8.29 | 82.1% | operator |
| 31429 | Seq Scan | 46.16 | 23.76 | 48.5% | operator |
...
### Step 4: Node 31423 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31424, 31425, 31426
- **Input Features:**
