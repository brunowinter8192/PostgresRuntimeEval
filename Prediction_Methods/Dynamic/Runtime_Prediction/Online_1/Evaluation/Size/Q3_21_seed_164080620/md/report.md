...
**Test Query:** Q3_21_seed_164080620
...
```
Node 4981 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 4982 (Sort) [consumed]
    Node 4983 (Aggregate) [consumed]
      Node 4984 (Gather) [consumed]
        Node 4985 (Nested Loop)
          Node 4986 (Hash Join) [PATTERN: 895c6e8c]
            Node 4987 (Seq Scan) [consumed] - LEAF
            Node 4988 (Hash) [consumed]
              Node 4989 (Seq Scan) - LEAF
          Node 4990 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4981 | 4982, 4983, 4984, 4986, 4987, 4988 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4986 | 4981, 4982, 4983, 4984, 4987, 4988 |
...
|------|------|--------|-----------|-----|--------|
| 4981 | Limit | 1180.37 | 1151.18 | 2.5% | pattern |
| 4985 | Nested Loop | 1142.90 | 1192.91 | 4.4% | operator |
| 4986 | Hash Join | 207.33 | 242.45 | 16.9% | pattern |
| 4990 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4989 | Seq Scan | 29.48 | 38.60 | 30.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4989 (Seq Scan) - LEAF
...
### Step 2: Node 4986 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4981, 4982, 4983, 4984, 4987, 4988
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46706
  - HashJoin_nt1=235479
...
### Step 3: Node 4990 (Index Scan) - LEAF
...
### Step 5: Node 4981 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4982, 4983, 4984, 4986, 4987, 4988
- **Input Features:**
