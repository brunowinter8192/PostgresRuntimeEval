...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4981 | 4982, 4983, 4984 |
...
| 4985 | Nested Loop | 1142.90 | 1192.83 | 4.4% | operator |
| 4986 | Hash Join | 207.33 | 230.82 | 11.3% | operator |
| 4990 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4987 | Seq Scan | 154.76 | 163.41 | 5.6% | operator |
| 4988 | Hash | 30.28 | 17.75 | 41.4% | operator |
...
### Step 2: Node 4987 (Seq Scan) - LEAF
...
### Step 5: Node 4990 (Index Scan) - LEAF
...
### Step 7: Node 4981 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4982, 4983, 4984
- **Input Features:**
