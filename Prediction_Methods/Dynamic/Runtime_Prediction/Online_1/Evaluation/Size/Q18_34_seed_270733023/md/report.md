...
**Test Query:** Q18_34_seed_270733023
...
```
Node 30052 (Limit) - ROOT
  Node 30053 (Sort)
    Node 30054 (Aggregate)
      Node 30055 (Gather Merge)
        Node 30056 (Incremental Sort)
          Node 30057 (Nested Loop)
            Node 30058 (Merge Join)
              Node 30059 (Sort)
                Node 30060 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30061 (Seq Scan) [consumed] - LEAF
                  Node 30062 (Hash) [consumed]
                    Node 30063 (Aggregate)
                      Node 30064 (Index Scan) - LEAF
              Node 30065 (Sort)
                Node 30066 (Seq Scan) - LEAF
            Node 30067 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30060 | 30061, 30062 |
...
|------|------|--------|-----------|-----|--------|
| 30052 | Limit | 3073.55 | 1175.21 | 61.8% | operator |
| 30053 | Sort | 2957.77 | 1127.81 | 61.9% | operator |
| 30054 | Aggregate | 2957.73 | 1073.15 | 63.7% | operator |
| 30055 | Gather Merge | 2957.71 | 1073.95 | 63.7% | operator |
| 30056 | Incremental Sort | 2937.39 | 0.00 | 100.0% | operator |
| 30057 | Nested Loop | 2937.34 | 1111.34 | 62.2% | operator |
| 30058 | Merge Join | 2937.28 | 0.00 | 100.0% | operator |
| 30067 | Index Scan | 0.02 | 0.05 | 96.2% | operator |
| 30059 | Sort | 2868.61 | 1095.58 | 61.8% | operator |
| 30065 | Sort | 65.53 | 1074.66 | 1539.9% | operator |
| 30060 | Hash Join | 2868.60 | 471.07 | 83.6% | pattern |
| 30066 | Seq Scan | 53.11 | 18.25 | 65.6% | operator |
| 30063 | Aggregate | 2637.04 | 1073.15 | 59.3% | operator |
| 30064 | Index Scan | 2151.08 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30064 (Index Scan) - LEAF
...
### Step 3: Node 30060 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30061, 30062
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30066 (Seq Scan) - LEAF
...
### Step 7: Node 30058 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30067 (Index Scan) - LEAF
...
### Step 10: Node 30056 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30055 (Gather Merge)
