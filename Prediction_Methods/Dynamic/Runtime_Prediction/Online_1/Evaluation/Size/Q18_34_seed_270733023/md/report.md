        ...
        Node 30056 (Incremental Sort)
          Node 30057 (Nested Loop)
            Node 30058 (Merge Join)
              Node 30059 (Sort)
                Node 30060 (Hash Join)
                  Node 30061 (Seq Scan) - LEAF
                  Node 30062 (Hash)
...
| 30059 | Sort | 2868.61 | 1099.77 | 61.7% | operator |
| 30065 | Sort | 65.53 | 1074.66 | 1539.9% | operator |
| 30060 | Hash Join | 2868.60 | 686.33 | 76.1% | operator |
| 30066 | Seq Scan | 53.11 | 18.25 | 65.6% | operator |
| 30061 | Seq Scan | 201.59 | 170.37 | 15.5% | operator |
| 30062 | Hash | 2637.10 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30061 (Seq Scan) - LEAF
...
### Step 6: Node 30066 (Seq Scan) - LEAF
...
### Step 9: Node 30058 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30067 (Index Scan) - LEAF
...
### Step 11: Node 30057 (Nested Loop)
...
### Step 12: Node 30056 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30055 (Gather Merge)
