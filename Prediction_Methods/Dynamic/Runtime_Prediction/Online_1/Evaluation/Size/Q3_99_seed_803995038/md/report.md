...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5831 | 5832, 5833, 5834 |
...
| 5835 | Nested Loop | 1160.06 | 1192.94 | 2.8% | operator |
| 5836 | Hash Join | 209.83 | 230.45 | 9.8% | operator |
| 5840 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5837 | Seq Scan | 156.58 | 163.26 | 4.3% | operator |
| 5838 | Hash | 29.96 | 17.75 | 40.8% | operator |
...
### Step 2: Node 5837 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37335.1800
- **Output:** st=27.14, rt=230.45

### Step 5: Node 5840 (Index Scan) - LEAF
...
- **Output:** st=121.62, rt=1192.94

### Step 7: Node 5831 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5832, 5833, 5834
- **Input Features:**
