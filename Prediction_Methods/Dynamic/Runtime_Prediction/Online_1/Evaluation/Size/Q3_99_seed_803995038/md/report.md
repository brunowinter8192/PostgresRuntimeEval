...
**Test Query:** Q3_99_seed_803995038
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5831 | 5832, 5833, 5834, 5836, 5837, 5838 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5836 | 5831, 5832, 5833, 5834, 5837, 5838 |
...
|------|------|--------|-----------|-----|--------|
| 5831 | Limit | 1200.19 | 1151.18 | 4.1% | pattern |
| 5835 | Nested Loop | 1160.06 | 1193.03 | 2.8% | operator |
| 5836 | Hash Join | 209.83 | 242.48 | 15.6% | pattern |
| 5840 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5839 | Seq Scan | 29.02 | 38.54 | 32.8% | operator |
...
- **Consumes:** Nodes 5831, 5832, 5833, 5834, 5837, 5838
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46890
  - HashJoin_nt1=233346
  ...
  - HashJoin_total_cost=37335.1800
  - Hash_Inner_np=0
  - Hash_Inner_nt=12559
...
- **Input Features:**
  ...
  - total_cost=72913.0300
- **Output:** st=121.77, rt=1193.03

### Step 5: Node 5831 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5832, 5833, 5834, 5836, 5837, 5838
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=315178
  - Aggregate_Outer_nt1=315178
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110158.5000
  - Aggregate_Outer_total_cost=114098.2200
  - Gather_Outer_np=0
  - Gather_Outer_nt=315178
  - Gather_Outer_nt1=101670
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105430.8300
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=315178
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=120909.1100
  - Limit_total_cost=120909.1300
  - Sort_Outer_np=0
  - Sort_Outer_nt=315178
  - Sort_Outer_nt1=315178
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=120909.1100
  - Sort_Outer_total_cost=121697.0500
