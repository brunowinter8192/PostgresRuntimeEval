...
**Test Query:** Q19_16_seed_123060465
...
```
Node 31619 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31620 (Gather) [consumed]
    Node 31621 (Aggregate) [consumed]
      Node 31622 (Hash Join) [consumed]
        Node 31623 (Seq Scan) - LEAF
        Node 31624 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31619 | 31620, 31621, 31622 |
...
|------|------|--------|-----------|-----|--------|
| 31619 | Aggregate | 829.61 | 829.29 | 0.0% | pattern |
| 31623 | Seq Scan | 758.33 | 743.46 | 2.0% | operator |
| 31624 | Hash | 46.55 | 8.29 | 82.2% | operator |
| 31625 | Seq Scan | 46.35 | 23.76 | 48.7% | operator |
...
### Step 2: Node 31623 (Seq Scan) - LEAF
...
### Step 4: Node 31619 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31620, 31621, 31622
- **Input Features:**
