...
**Test Query:** Q13_61_seed_492241860
...
```
Node 26119 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26120 (Aggregate) [consumed]
    Node 26121 (Aggregate)
      Node 26122 (Hash Join) [PATTERN: 895c6e8c]
        Node 26123 (Seq Scan) [consumed] - LEAF
        Node 26124 (Hash) [consumed]
          Node 26125 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26119 | 26120, 26122, 26123, 26124 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26122 | 26119, 26120, 26123, 26124 |
...
|------|------|--------|-----------|-----|--------|
| 26119 | Sort | 952.44 | 1079.93 | 13.4% | pattern |
| 26121 | Aggregate | 946.46 | 999.15 | 5.6% | operator |
| 26122 | Hash Join | 723.82 | 470.31 | 35.0% | pattern |
| 26125 | Index Only Scan | 9.93 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26125 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26122 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26119, 26120, 26123, 26124
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1478958
...
### Step 4: Node 26119 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26120, 26122, 26123, 26124
- **Input Features:**
