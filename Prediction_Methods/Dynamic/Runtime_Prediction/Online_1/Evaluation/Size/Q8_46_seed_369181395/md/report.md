...
**Test Query:** Q8_46_seed_369181395
...
```
Node 15271 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 15272 (Gather Merge) [consumed]
    Node 15273 (Sort)
      Node 15274 (Hash Join)
        Node 15275 (Nested Loop)
          Node 15276 (Hash Join)
            Node 15277 (Nested Loop)
              Node 15278 (Hash Join)
                Node 15279 (Seq Scan) - LEAF
                Node 15280 (Hash) [PATTERN: 444761fb]
                  Node 15281 (Hash Join) [consumed]
                    Node 15282 (Seq Scan) [consumed] - LEAF
                    Node 15283 (Hash) [consumed]
                      Node 15284 (Hash Join) [consumed]
                        Node 15285 (Seq Scan) - LEAF
                        Node 15286 (Hash)
                          Node 15287 (Seq Scan) - LEAF
              Node 15288 (Index Scan) - LEAF
            Node 15289 (Hash)
              Node 15290 (Seq Scan) - LEAF
          Node 15291 (Index Scan) - LEAF
        Node 15292 (Hash)
          Node 15293 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 15280 | 15271, 15272, 15281, 15282, 15283, 15284 |
| Aggregate -> Gather Merge (Out | 2724c080 | 15271 | 15272, 15280, 15281, 15282, 15283, 15284 |
...
|------|------|--------|-----------|-----|--------|
| 15271 | Aggregate | 1214.27 | 1133.68 | 6.6% | pattern |
| 15273 | Sort | 1209.23 | 1046.21 | 13.5% | operator |
| 15274 | Hash Join | 1208.92 | 785.61 | 35.0% | operator |
| 15275 | Nested Loop | 1208.53 | 1198.29 | 0.8% | operator |
| 15292 | Hash | 0.02 | 13.72 | 68520.4% | operator |
| 15276 | Hash Join | 1204.81 | 785.60 | 34.8% | operator |
| 15291 | Index Scan | 0.01 | 12.42 | 206958.1% | operator |
| 15293 | Seq Scan | 0.01 | 6.51 | 43313.1% | operator |
| 15277 | Nested Loop | 1161.89 | 1198.29 | 3.1% | operator |
| 15289 | Hash | 38.09 | 19.97 | 47.6% | operator |
| 15278 | Hash Join | 217.43 | 251.67 | 15.7% | operator |
| 15288 | Index Scan | 0.04 | 2.88 | 6926.5% | operator |
| 15290 | Seq Scan | 37.98 | 48.88 | 28.7% | operator |
| 15279 | Seq Scan | 162.59 | 159.67 | 1.8% | operator |
| 15280 | Hash | 36.30 | 43.51 | 19.9% | pattern |
| 15285 | Seq Scan | 0.01 | 12.22 | 87221.0% | operator |
| 15286 | Hash | 0.07 | 18.14 | 25455.1% | operator |
| 15287 | Seq Scan | 0.07 | 23.36 | 34769.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 15287 (Seq Scan) - LEAF
...
### Step 2: Node 15285 (Seq Scan) - LEAF
...
### Step 4: Node 15279 (Seq Scan) - LEAF
...
### Step 5: Node 15280 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 15271, 15272, 15281, 15282, 15283, 15284
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 15288 (Index Scan) - LEAF
...
### Step 8: Node 15290 (Seq Scan) - LEAF
...
### Step 12: Node 15291 (Index Scan) - LEAF
...
### Step 13: Node 15293 (Seq Scan) - LEAF
...
### Step 14: Node 15275 (Nested Loop)
...
### Step 18: Node 15271 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 15272, 15280, 15281, 15282, 15283, 15284
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2383
  - Aggregate_nt1=2383
