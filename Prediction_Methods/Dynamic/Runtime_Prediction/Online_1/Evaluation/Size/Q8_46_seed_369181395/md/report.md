...
```
Node 15271 (Aggregate) - ROOT
  Node 15272 (Gather Merge)
    Node 15273 (Sort)
          ...
          Node 15276 (Hash Join)
            Node 15277 (Nested Loop)
              Node 15278 (Hash Join)
                ...
                Node 15280 (Hash)
                  Node 15281 (Hash Join)
                    Node 15282 (Seq Scan) - LEAF
                    Node 15283 (Hash)
                      Node 15284 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 15271 | Aggregate | 1214.27 | 1195.83 | 1.5% | operator |
| 15272 | Gather Merge | 1213.76 | 1097.18 | 9.6% | operator |
...
| 15278 | Hash Join | 217.43 | 251.17 | 15.5% | operator |
...
| 15280 | Hash | 36.30 | 20.62 | 43.2% | operator |
| 15281 | Hash Join | 35.72 | 132.26 | 270.3% | operator |
| 15282 | Seq Scan | 34.34 | 23.03 | 32.9% | operator |
| 15283 | Hash | 0.10 | 23.66 | 24287.8% | operator |
| 15284 | Hash Join | 0.09 | 306.84 | 326321.2% | operator |
...
### Step 5: Node 15282 (Seq Scan) - LEAF
...
### Step 8: Node 15279 (Seq Scan) - LEAF
...
### Step 11: Node 15288 (Index Scan) - LEAF
...
### Step 12: Node 15290 (Seq Scan) - LEAF
...
### Step 13: Node 15277 (Nested Loop)
...
### Step 16: Node 15291 (Index Scan) - LEAF
...
### Step 17: Node 15293 (Seq Scan) - LEAF
...
### Step 18: Node 15275 (Nested Loop)
...
### Step 22: Node 15272 (Gather Merge)
...
### Step 23: Node 15271 (Aggregate) - ROOT
