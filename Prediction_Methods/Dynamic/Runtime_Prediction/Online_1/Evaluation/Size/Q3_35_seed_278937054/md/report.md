    ...
    Node 5133 (Aggregate) [consumed]
      Node 5134 (Gather) [consumed]
        Node 5135 (Nested Loop)
          Node 5136 (Hash Join) [PATTERN: 895c6e8c]
            Node 5137 (Seq Scan) [consumed] - LEAF
            Node 5138 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5131 | 5132, 5133, 5134, 5136, 5137, 5138 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5136 | 5131, 5132, 5133, 5134, 5137, 5138 |
...
|------|------|--------|-----------|-----|--------|
| 5131 | Limit | 1222.63 | 1151.18 | 5.8% | pattern |
| 5135 | Nested Loop | 1187.22 | 1193.39 | 0.5% | operator |
| 5136 | Hash Join | 210.88 | 242.54 | 15.0% | pattern |
| 5140 | Index Scan | 0.03 | -0.52 | 2018.8% | operator |
| 5139 | Seq Scan | 28.34 | 38.53 | 36.0% | operator |
...
### Step 2: Node 5136 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5131, 5132, 5133, 5134, 5137, 5138
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47440
  - HashJoin_nt1=235716
  ...
  - HashJoin_total_cost=37341.6500
  - Hash_Inner_np=0
  - Hash_Inner_nt=12579
...
### Step 3: Node 5140 (Index Scan) - LEAF
...
### Step 5: Node 5131 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5132, 5133, 5134, 5136, 5137, 5138
- **Input Features:**
