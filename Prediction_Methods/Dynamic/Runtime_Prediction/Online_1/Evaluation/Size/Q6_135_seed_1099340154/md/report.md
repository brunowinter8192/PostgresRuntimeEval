...
**Test Query:** Q6_135_seed_1099340154
...
```
Node 10053 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10054 (Gather) [consumed]
    Node 10055 (Aggregate) [consumed]
      Node 10056 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10053 | 10054, 10055 |
...
|------|------|--------|-----------|-----|--------|
| 10053 | Aggregate | 777.92 | 849.98 | 9.3% | pattern |
| 10056 | Seq Scan | 756.62 | 748.49 | 1.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10056 (Seq Scan) - LEAF
...
### Step 2: Node 10053 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10054, 10055
- **Input Features:**
