...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5241 | 5242, 5243, 5244 |
...
| 5245 | Nested Loop | 1144.13 | 1193.55 | 4.3% | operator |
| 5246 | Hash Join | 205.86 | 231.31 | 12.4% | operator |
| 5250 | Index Scan | 0.03 | -0.52 | 2172.3% | operator |
| 5247 | Seq Scan | 154.93 | 163.56 | 5.6% | operator |
| 5248 | Hash | 27.86 | 17.75 | 36.3% | operator |
...
### Step 2: Node 5247 (Seq Scan) - LEAF
...
- **Output:** st=0.29, rt=163.56

### Step 3: Node 5248 (Hash)
...
- **Input Features:**
  ...
  - total_cost=37346.6300
- **Output:** st=27.27, rt=231.31

### Step 5: Node 5250 (Index Scan) - LEAF
...
- **Output:** st=122.23, rt=1193.55

### Step 7: Node 5241 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5242, 5243, 5244
- **Input Features:**
