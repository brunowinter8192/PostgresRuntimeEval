...
**Test Query:** Q3_45_seed_360977364
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5241 | 5242, 5243, 5244, 5246, 5247, 5248 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5246 | 5241, 5242, 5243, 5244, 5247, 5248 |
...
|------|------|--------|-----------|-----|--------|
| 5241 | Limit | 1179.78 | 1151.18 | 2.4% | pattern |
| 5245 | Nested Loop | 1144.13 | 1193.63 | 4.3% | operator |
| 5246 | Hash Join | 205.86 | 242.59 | 17.8% | pattern |
| 5250 | Index Scan | 0.03 | -0.52 | 2172.3% | operator |
| 5249 | Seq Scan | 27.11 | 38.53 | 42.1% | operator |
...
- **Consumes:** Nodes 5241, 5242, 5243, 5244, 5247, 5248
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47822
  - HashJoin_nt1=237612
  ...
  - HashJoin_total_cost=37346.6300
  - Hash_Inner_np=0
  - Hash_Inner_nt=12579
...
- **Output:** st=29.67, rt=242.59

### Step 3: Node 5250 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=73463.1400
- **Output:** st=122.37, rt=1193.63

### Step 5: Node 5241 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5242, 5243, 5244, 5246, 5247, 5248
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=316012
  - Aggregate_Outer_nt1=316012
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110804.5200
  - Aggregate_Outer_total_cost=114754.6700
  - Gather_Outer_np=0
  - Gather_Outer_nt=316012
  - Gather_Outer_nt1=101939
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=106064.3400
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=316012
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=121583.5800
  - Limit_total_cost=121583.6000
  - Sort_Outer_np=0
  - Sort_Outer_nt=316012
  - Sort_Outer_nt1=316012
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=121583.5800
  - Sort_Outer_total_cost=122373.6100
