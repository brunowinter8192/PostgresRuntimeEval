...
**Test Query:** Q18_13_seed_98448372
...
```
Node 29508 (Limit) - ROOT
  Node 29509 (Sort)
    Node 29510 (Aggregate)
      Node 29511 (Gather Merge)
        Node 29512 (Incremental Sort)
          Node 29513 (Nested Loop)
            Node 29514 (Merge Join)
              Node 29515 (Sort)
                Node 29516 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29517 (Seq Scan) [consumed] - LEAF
                  Node 29518 (Hash) [consumed]
                    Node 29519 (Aggregate)
                      Node 29520 (Index Scan) - LEAF
              Node 29521 (Sort)
                Node 29522 (Seq Scan) - LEAF
            Node 29523 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29516 | 29517, 29518 |
...
|------|------|--------|-----------|-----|--------|
| 29508 | Limit | 3040.51 | 1175.21 | 61.3% | operator |
| 29509 | Sort | 2923.30 | 1127.81 | 61.4% | operator |
| 29510 | Aggregate | 2923.27 | 1073.15 | 63.3% | operator |
| 29511 | Gather Merge | 2923.25 | 1073.95 | 63.3% | operator |
| 29512 | Incremental Sort | 2902.91 | 0.00 | 100.0% | operator |
| 29513 | Nested Loop | 2902.87 | 1111.34 | 61.7% | operator |
| 29514 | Merge Join | 2902.82 | 0.00 | 100.0% | operator |
| 29523 | Index Scan | 0.02 | 0.05 | 125.7% | operator |
| 29515 | Sort | 2834.20 | 1095.58 | 61.3% | operator |
| 29521 | Sort | 65.60 | 1074.66 | 1538.1% | operator |
| 29516 | Hash Join | 2834.19 | 471.07 | 83.4% | pattern |
| 29522 | Seq Scan | 53.83 | 18.25 | 66.1% | operator |
| 29519 | Aggregate | 2605.89 | 1073.15 | 58.8% | operator |
| 29520 | Index Scan | 2107.66 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29520 (Index Scan) - LEAF
...
### Step 3: Node 29516 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29517, 29518
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29522 (Seq Scan) - LEAF
...
### Step 7: Node 29514 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29523 (Index Scan) - LEAF
...
### Step 10: Node 29512 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29511 (Gather Merge)
