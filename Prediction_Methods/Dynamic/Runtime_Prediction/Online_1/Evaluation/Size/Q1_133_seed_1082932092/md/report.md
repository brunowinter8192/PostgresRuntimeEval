...
Node 181 (Aggregate) - ROOT
  Node 182 (Gather Merge)
    Node 183 (Sort) [PATTERN: 1d35fb97]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 183 | 184 |
...
|------|------|--------|-----------|-----|--------|
| 181 | Aggregate | 923.90 | 1196.02 | 29.5% | operator |
| 182 | Gather Merge | 923.84 | 1165.94 | 26.2% | operator |
| 183 | Sort | 904.62 | 1201.00 | 32.8% | pattern |
...
### Step 2: Node 183 (Sort) - PATTERN ROOT
...
### Step 4: Node 181 (Aggregate) - ROOT
