...
```
Node 27358 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27359 (Gather) [consumed]
    Node 27360 (Aggregate) [consumed]
      Node 27361 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27358 | 27359, 27360, 27361 |
...
|------|------|--------|-----------|-----|--------|
| 27358 | Aggregate | 820.39 | 857.14 | 4.5% | pattern |
...
### Step 4: Node 27358 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27359, 27360, 27361
- **Input Features:**
