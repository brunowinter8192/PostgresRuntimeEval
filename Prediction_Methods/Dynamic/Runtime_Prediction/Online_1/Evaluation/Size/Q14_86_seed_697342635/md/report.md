...
**Test Query:** Q14_86_seed_697342635
...
```
Node 27358 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27359 (Gather) [consumed]
    Node 27360 (Aggregate) [consumed]
      Node 27361 (Hash Join)
        Node 27362 (Seq Scan) - LEAF
        Node 27363 (Hash)
          Node 27364 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27358 | 27359, 27360 |
...
|------|------|--------|-----------|-----|--------|
| 27358 | Aggregate | 820.39 | 848.37 | 3.4% | pattern |
| 27361 | Hash Join | 798.05 | 807.67 | 1.2% | operator |
| 27362 | Seq Scan | 742.07 | 758.50 | 2.2% | operator |
| 27363 | Hash | 47.90 | 9.38 | 80.4% | operator |
| 27364 | Seq Scan | 36.07 | 12.70 | 64.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27364 (Seq Scan) - LEAF
...
### Step 2: Node 27362 (Seq Scan) - LEAF
...
### Step 5: Node 27358 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27359, 27360
- **Input Features:**
