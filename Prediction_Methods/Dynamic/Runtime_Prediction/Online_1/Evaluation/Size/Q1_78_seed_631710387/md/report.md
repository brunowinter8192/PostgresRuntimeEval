...
**Test Query:** Q1_78_seed_631710387
...
```
Node 626 (Aggregate) - ROOT
  Node 627 (Gather Merge)
    Node 628 (Sort) [PATTERN: 1d35fb97]
      Node 629 (Aggregate) [consumed]
        Node 630 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 628 | 629 |
...
|------|------|--------|-----------|-----|--------|
| 626 | Aggregate | 928.88 | 1196.03 | 28.8% | operator |
| 627 | Gather Merge | 928.84 | 1165.95 | 25.5% | operator |
| 628 | Sort | 912.62 | 1201.03 | 31.6% | pattern |
| 630 | Seq Scan | 497.12 | 678.25 | 36.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 630 (Seq Scan) - LEAF
...
- **Output:** st=0.85, rt=678.25

### Step 2: Node 628 (Sort) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Aggregate_Outer_nt1=1191937
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=236
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=169320.8300
  - Aggregate_Outer_total_cost=169320.9700
  - Sort_np=0
  - Sort_nt=6
  - Sort_nt1=6
  - Sort_nt2=0
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=169321.0500
  - Sort_total_cost=169321.0600
- **Output:** st=1196.94, rt=1201.03

### Step 3: Node 627 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1196.9385
  - st2=0.0000
  - startup_cost=170321.1200
  - total_cost=170324.7500
- **Output:** st=1161.82, rt=1165.95

### Step 4: Node 626 (Aggregate) - ROOT
