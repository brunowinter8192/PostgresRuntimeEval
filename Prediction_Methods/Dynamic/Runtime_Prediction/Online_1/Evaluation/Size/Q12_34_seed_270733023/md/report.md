...
**Test Query:** Q12_34_seed_270733023
...
```
Node 24859 (Aggregate) - ROOT
  Node 24860 (Gather Merge)
    Node 24861 (Aggregate)
      Node 24862 (Sort)
        Node 24863 (Nested Loop)
          Node 24864 (Seq Scan) - LEAF
          Node 24865 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24859 | Aggregate | 993.06 | 919.07 | 7.5% | operator |
| 24860 | Gather Merge | 993.05 | 1111.84 | 12.0% | operator |
| 24861 | Aggregate | 974.08 | 895.31 | 8.1% | operator |
| 24862 | Sort | 973.47 | 1092.81 | 12.3% | operator |
| 24863 | Nested Loop | 972.49 | 1127.41 | 15.9% | operator |
| 24864 | Seq Scan | 841.87 | 745.19 | 11.5% | operator |
| 24865 | Index Scan | 0.03 | 0.07 | 187.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24864 (Seq Scan) - LEAF
...
### Step 2: Node 24865 (Index Scan) - LEAF
...
### Step 6: Node 24860 (Gather Merge)
...
### Step 7: Node 24859 (Aggregate) - ROOT
