...
**Test Query:** Q19_139_seed_1132156278
...
```
Node 31514 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31515 (Gather) [consumed]
    Node 31516 (Aggregate) [consumed]
      Node 31517 (Hash Join) [consumed]
        Node 31518 (Seq Scan) - LEAF
        Node 31519 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31514 | 31515, 31516, 31517 |
...
|------|------|--------|-----------|-----|--------|
| 31514 | Aggregate | 842.85 | 829.28 | 1.6% | pattern |
| 31518 | Seq Scan | 775.95 | 743.46 | 4.2% | operator |
| 31519 | Hash | 44.67 | 8.29 | 81.5% | operator |
| 31520 | Seq Scan | 44.53 | 23.76 | 46.6% | operator |
...
### Step 2: Node 31518 (Seq Scan) - LEAF
...
### Step 4: Node 31514 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31515, 31516, 31517
- **Input Features:**
