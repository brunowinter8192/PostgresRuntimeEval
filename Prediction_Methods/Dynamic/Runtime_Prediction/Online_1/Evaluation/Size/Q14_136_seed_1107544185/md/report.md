...
**Test Query:** Q14_136_seed_1107544185
...
```
Node 26693 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26694 (Gather) [consumed]
    Node 26695 (Aggregate) [consumed]
      Node 26696 (Hash Join) [consumed]
        Node 26697 (Seq Scan) - LEAF
        Node 26698 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26693 | 26694, 26695, 26696 |
...
|------|------|--------|-----------|-----|--------|
| 26693 | Aggregate | 813.69 | 857.15 | 5.3% | pattern |
| 26697 | Seq Scan | 743.92 | 758.52 | 2.0% | operator |
| 26698 | Hash | 40.70 | 9.38 | 77.0% | operator |
| 26699 | Seq Scan | 35.35 | 12.70 | 64.1% | operator |
...
### Step 2: Node 26697 (Seq Scan) - LEAF
...
### Step 4: Node 26693 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26694, 26695, 26696
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=16114
  - HashJoin_Outer_nt1=16114
  ...
  - HashJoin_Outer_total_cost=136648.9400
- **Output:** st=850.78, rt=857.15
