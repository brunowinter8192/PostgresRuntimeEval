...
```
Node 26693 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26694 (Gather) [consumed]
    Node 26695 (Aggregate) [consumed]
      Node 26696 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26693 | 26694, 26695 |
...
|------|------|--------|-----------|-----|--------|
| 26693 | Aggregate | 813.69 | 848.39 | 4.3% | pattern |
| 26696 | Hash Join | 792.84 | 807.69 | 1.9% | operator |
...
### Step 5: Node 26693 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26694, 26695
- **Input Features:**
