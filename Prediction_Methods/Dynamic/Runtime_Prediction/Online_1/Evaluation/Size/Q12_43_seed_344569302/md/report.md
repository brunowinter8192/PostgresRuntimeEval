...
**Test Query:** Q12_43_seed_344569302
...
```
Node 24929 (Aggregate) - ROOT
  Node 24930 (Gather Merge)
    Node 24931 (Aggregate)
      Node 24932 (Sort)
        Node 24933 (Nested Loop)
          Node 24934 (Seq Scan) - LEAF
          Node 24935 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24929 | Aggregate | 1003.08 | 919.06 | 8.4% | operator |
| 24930 | Gather Merge | 1003.06 | 1111.84 | 10.8% | operator |
| 24931 | Aggregate | 983.61 | 895.30 | 9.0% | operator |
| 24932 | Sort | 983.01 | 1092.82 | 11.2% | operator |
| 24933 | Nested Loop | 982.03 | 1127.41 | 14.8% | operator |
| 24934 | Seq Scan | 844.11 | 745.19 | 11.7% | operator |
| 24935 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24934 (Seq Scan) - LEAF
...
### Step 2: Node 24935 (Index Scan) - LEAF
...
### Step 6: Node 24930 (Gather Merge)
...
### Step 7: Node 24929 (Aggregate) - ROOT
