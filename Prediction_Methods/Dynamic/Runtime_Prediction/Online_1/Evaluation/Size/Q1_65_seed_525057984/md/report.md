...
**Test Query:** Q1_65_seed_525057984
...
```
Node 556 (Aggregate) - ROOT
  Node 557 (Gather Merge)
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 558 | 559 |
...
|------|------|--------|-----------|-----|--------|
| 556 | Aggregate | 929.34 | 1195.77 | 28.7% | operator |
| 557 | Gather Merge | 929.30 | 1165.87 | 25.5% | operator |
| 558 | Sort | 912.42 | 1200.06 | 31.5% | pattern |
| 560 | Seq Scan | 508.67 | 681.93 | 34.1% | operator |
...
- **Input Features:**
  ...
  - Aggregate_Outer_total_cost=168665.3800
  - Sort_np=0
  - Sort_nt=6
  - Sort_nt1=6
  - Sort_nt2=0
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=168665.4600
  - Sort_total_cost=168665.4800
- **Output:** st=1195.96, rt=1200.06

### Step 3: Node 557 (Gather Merge)
...
### Step 4: Node 556 (Aggregate) - ROOT
