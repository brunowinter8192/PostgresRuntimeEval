...
**Test Query:** Q13_60_seed_484037829
...
```
Node 26112 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26113 (Aggregate) [consumed]
    Node 26114 (Aggregate)
      Node 26115 (Hash Join) [PATTERN: 895c6e8c]
        Node 26116 (Seq Scan) [consumed] - LEAF
        Node 26117 (Hash) [consumed]
          Node 26118 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26112 | 26113, 26115, 26116, 26117 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26115 | 26112, 26113, 26116, 26117 |
...
|------|------|--------|-----------|-----|--------|
| 26112 | Sort | 891.29 | 1079.92 | 21.2% | pattern |
| 26114 | Aggregate | 885.26 | 998.94 | 12.8% | operator |
| 26115 | Hash Join | 675.83 | 470.31 | 30.4% | pattern |
| 26118 | Index Only Scan | 9.31 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26118 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26115 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26112, 26113, 26116, 26117
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1475952
...
### Step 4: Node 26112 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26113, 26115, 26116, 26117
- **Input Features:**
