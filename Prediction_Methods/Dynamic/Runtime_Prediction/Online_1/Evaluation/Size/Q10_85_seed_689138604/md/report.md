...
**Test Query:** Q10_85_seed_689138604
...
```
Node 21099 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 21100 (Sort) [consumed]
    Node 21101 (Aggregate) [consumed]
      Node 21102 (Gather) [consumed]
        Node 21103 (Hash Join)
          Node 21104 (Hash Join) [PATTERN: 2e0f44ef]
            Node 21105 (Nested Loop) [consumed]
              Node 21106 (Seq Scan) - LEAF
              Node 21107 (Index Scan) - LEAF
            Node 21108 (Hash) [consumed]
              Node 21109 (Seq Scan) - LEAF
          Node 21110 (Hash)
            Node 21111 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 21099 | 21100, 21101, 21102, 21104, 21105, 21108 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 21104 | 21099, 21100, 21101, 21102, 21105, 21108 |
...
|------|------|--------|-----------|-----|--------|
| 21099 | Limit | 1149.41 | 1199.47 | 4.4% | pattern |
| 21103 | Hash Join | 1104.01 | 1095.56 | 0.8% | operator |
| 21104 | Hash Join | 1101.11 | 1120.19 | 1.7% | pattern |
| 21110 | Hash | 0.02 | 15.71 | 82588.3% | operator |
| 21111 | Seq Scan | 0.01 | 6.98 | 49747.9% | operator |
| 21106 | Seq Scan | 163.10 | 159.74 | 2.1% | operator |
| 21107 | Index Scan | 0.06 | -0.52 | 922.6% | operator |
| 21109 | Seq Scan | 25.60 | 26.64 | 4.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 21106 (Seq Scan) - LEAF
...
### Step 2: Node 21107 (Index Scan) - LEAF
...
### Step 3: Node 21109 (Seq Scan) - LEAF
...
### Step 4: Node 21111 (Seq Scan) - LEAF
...
### Step 5: Node 21104 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 21099, 21100, 21101, 21102, 21105, 21108
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18231
  - HashJoin_nt1=18231
...
### Step 8: Node 21099 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 21100, 21101, 21102, 21104, 21105, 21108
- **Input Features:**
