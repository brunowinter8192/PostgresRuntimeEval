...
**Test Query:** Q3_48_seed_385589457
...
```
Node 5271 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5272 (Sort) [consumed]
    Node 5273 (Aggregate) [consumed]
      Node 5274 (Gather) [consumed]
        Node 5275 (Nested Loop)
          Node 5276 (Hash Join) [PATTERN: 895c6e8c]
            Node 5277 (Seq Scan) [consumed] - LEAF
            Node 5278 (Hash) [consumed]
              Node 5279 (Seq Scan) - LEAF
          Node 5280 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5271 | 5272, 5273, 5274, 5276, 5277, 5278 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5276 | 5271, 5272, 5273, 5274, 5277, 5278 |
...
|------|------|--------|-----------|-----|--------|
| 5271 | Limit | 1183.43 | 1151.18 | 2.7% | pattern |
| 5275 | Nested Loop | 1146.27 | 1193.44 | 4.1% | operator |
| 5276 | Hash Join | 204.82 | 242.55 | 18.4% | pattern |
| 5280 | Index Scan | 0.03 | -0.52 | 2172.3% | operator |
| 5279 | Seq Scan | 27.07 | 38.54 | 42.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5279 (Seq Scan) - LEAF
...
### Step 2: Node 5276 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5271, 5272, 5273, 5274, 5277, 5278
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47519
  - HashJoin_nt1=236474
  ...
  - HashJoin_total_cost=37343.3900
  - Hash_Inner_np=0
  - Hash_Inner_nt=12559
...
- **Input Features:**
  ...
  - total_cost=73275.1200
- **Output:** st=122.17, rt=1193.44

### Step 5: Node 5271 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5272, 5273, 5274, 5276, 5277, 5278
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=315510
  - Aggregate_Outer_nt1=315510
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110558.7700
  - Aggregate_Outer_total_cost=114502.6500
  - Gather_Outer_np=0
  - Gather_Outer_nt=315510
  - Gather_Outer_nt1=101777
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105826.1200
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=315510
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=121320.7100
  - Limit_total_cost=121320.7300
  - Sort_Outer_np=0
  - Sort_Outer_nt=315510
  - Sort_Outer_nt1=315510
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=121320.7100
  - Sort_Outer_total_cost=122109.4800
