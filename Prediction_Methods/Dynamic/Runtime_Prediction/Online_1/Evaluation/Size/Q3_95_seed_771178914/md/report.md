...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5791 | 5792, 5793, 5794, 5796, 5797, 5798 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5796 | 5791, 5792, 5793, 5794, 5797, 5798 |
...
| 5795 | Nested Loop | 1175.90 | 1193.29 | 1.5% | operator |
| 5796 | Hash Join | 210.29 | 242.53 | 15.3% | pattern |
...
- **Consumes:** Nodes 5791, 5792, 5793, 5794, 5797, 5798
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47297
  - HashJoin_nt1=235005
...
### Step 3: Node 5800 (Index Scan) - LEAF
...
### Step 5: Node 5791 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5792, 5793, 5794, 5796, 5797, 5798
- **Input Features:**
