...
```
Node 17014 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 17015 (Aggregate) [consumed]
    Node 17016 (Gather)
      Node 17017 (Aggregate)
        Node 17018 (Nested Loop)
          Node 17019 (Hash Join) [PATTERN: bb930825]
            Node 17020 (Seq Scan) [consumed] - LEAF
            Node 17021 (Hash) [consumed]
              Node 17022 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17019 | 17014, 17015, 17020, 17021, 17022 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17014 | 17015, 17019, 17020, 17021, 17022 |
...
|------|------|--------|-----------|-----|--------|
| 17014 | Sort | 1176.01 | 1044.79 | 11.2% | pattern |
...
| 17019 | Hash Join | 960.96 | 134.80 | 86.0% | pattern |
...
### Step 9: Node 17019 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17014, 17015, 17020, 17021, 17022
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17031 (Index Scan) - LEAF
...
### Step 11: Node 17018 (Nested Loop)
...
### Step 14: Node 17014 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17015, 17019, 17020, 17021, 17022
- **Input Features:**
