...
**Test Query:** Q12_41_seed_328161240
...
```
Node 24915 (Aggregate) - ROOT
  Node 24916 (Gather Merge)
    Node 24917 (Aggregate)
      Node 24918 (Sort)
        Node 24919 (Nested Loop)
          Node 24920 (Seq Scan) - LEAF
          Node 24921 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24915 | Aggregate | 989.53 | 919.05 | 7.1% | operator |
| 24916 | Gather Merge | 989.48 | 1111.84 | 12.4% | operator |
| 24917 | Aggregate | 970.39 | 895.30 | 7.7% | operator |
| 24918 | Sort | 969.76 | 1092.82 | 12.7% | operator |
| 24919 | Nested Loop | 968.82 | 1127.41 | 16.4% | operator |
| 24920 | Seq Scan | 834.68 | 745.19 | 10.7% | operator |
| 24921 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24920 (Seq Scan) - LEAF
...
### Step 2: Node 24921 (Index Scan) - LEAF
...
### Step 6: Node 24916 (Gather Merge)
...
### Step 7: Node 24915 (Aggregate) - ROOT
