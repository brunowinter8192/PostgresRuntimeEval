...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5461 | 5462, 5463, 5464 |
...
| 5465 | Nested Loop | 1165.13 | 1193.27 | 2.4% | operator |
| 5466 | Hash Join | 216.68 | 230.88 | 6.6% | operator |
| 5470 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5467 | Seq Scan | 162.38 | 163.41 | 0.6% | operator |
| 5468 | Hash | 31.23 | 17.75 | 43.2% | operator |
...
### Step 2: Node 5467 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37341.0300
- **Output:** st=27.20, rt=230.88

### Step 5: Node 5470 (Index Scan) - LEAF
...
- **Output:** st=121.95, rt=1193.27

### Step 7: Node 5461 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5462, 5463, 5464
- **Input Features:**
