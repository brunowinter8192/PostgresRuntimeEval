...
**Test Query:** Q3_65_seed_525057984
...
```
Node 5461 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5462 (Sort) [consumed]
    Node 5463 (Aggregate) [consumed]
      Node 5464 (Gather) [consumed]
        Node 5465 (Nested Loop)
          Node 5466 (Hash Join) [PATTERN: 895c6e8c]
            Node 5467 (Seq Scan) [consumed] - LEAF
            Node 5468 (Hash) [consumed]
              Node 5469 (Seq Scan) - LEAF
          Node 5470 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5461 | 5462, 5463, 5464, 5466, 5467, 5468 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5466 | 5461, 5462, 5463, 5464, 5467, 5468 |
...
|------|------|--------|-----------|-----|--------|
| 5461 | Limit | 1200.61 | 1151.18 | 4.1% | pattern |
| 5465 | Nested Loop | 1165.13 | 1193.36 | 2.4% | operator |
| 5466 | Hash Join | 216.68 | 242.54 | 11.9% | pattern |
| 5470 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5469 | Seq Scan | 30.45 | 38.53 | 26.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5469 (Seq Scan) - LEAF
...
### Step 2: Node 5466 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5461, 5462, 5463, 5464, 5467, 5468
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47393
  - HashJoin_nt1=235479
...
- **Output:** st=29.72, rt=242.54

### Step 3: Node 5470 (Index Scan) - LEAF
...
- **Output:** st=122.09, rt=1193.36

### Step 5: Node 5461 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5462, 5463, 5464, 5466, 5467, 5468
- **Input Features:**
