...
**Test Query:** Q12_61_seed_492241860
...
```
Node 25069 (Aggregate) - ROOT
  Node 25070 (Gather Merge)
    Node 25071 (Aggregate)
      Node 25072 (Sort)
        Node 25073 (Nested Loop)
          Node 25074 (Seq Scan) - LEAF
          Node 25075 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 25069 | Aggregate | 996.21 | 919.06 | 7.7% | operator |
| 25070 | Gather Merge | 996.18 | 1111.84 | 11.6% | operator |
| 25071 | Aggregate | 977.64 | 895.30 | 8.4% | operator |
| 25072 | Sort | 976.68 | 1092.82 | 11.9% | operator |
| 25073 | Nested Loop | 975.76 | 1127.41 | 15.5% | operator |
| 25074 | Seq Scan | 837.20 | 745.19 | 11.0% | operator |
| 25075 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25074 (Seq Scan) - LEAF
...
### Step 2: Node 25075 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - st2=0.1246
  - startup_cost=0.4300
  - total_cost=147180.3400
- **Output:** st=38.32, rt=1127.41

### Step 4: Node 25072 (Sort)
...
- **Input Features:**
  ...
  - st1=38.3242
  - st2=0.0000
  - startup_cost=147541.7000
  - total_cost=147556.1600
- **Output:** st=1092.40, rt=1092.82

### Step 5: Node 25071 (Aggregate)
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=147541.7000
  - total_cost=147657.4300
- **Output:** st=868.95, rt=895.30

### Step 6: Node 25070 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=868.9506
  - st2=0.0000
  - startup_cost=148541.7800
  - total_cost=148661.7300
- **Output:** st=1109.22, rt=1111.84

### Step 7: Node 25069 (Aggregate) - ROOT
