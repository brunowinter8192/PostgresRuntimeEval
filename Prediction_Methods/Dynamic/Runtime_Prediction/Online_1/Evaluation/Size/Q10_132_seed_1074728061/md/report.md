    ...
    Node 19827 (Aggregate) [consumed]
      Node 19828 (Gather) [consumed]
        Node 19829 (Hash Join)
          Node 19830 (Hash Join)
            Node 19831 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19825 | 19826, 19827, 19828 |
...
| 19829 | Hash Join | 1082.21 | 1007.24 | 6.9% | operator |
| 19830 | Hash Join | 1079.35 | 1004.16 | 7.0% | operator |
| 19836 | Hash | 0.02 | 15.71 | 92316.3% | operator |
| 19831 | Nested Loop | 1033.15 | 1204.80 | 16.6% | operator |
| 19834 | Hash | 35.31 | 55.57 | 57.4% | operator |
...
### Step 6: Node 19837 (Seq Scan) - LEAF
...
### Step 10: Node 19825 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19826, 19827, 19828
- **Input Features:**
