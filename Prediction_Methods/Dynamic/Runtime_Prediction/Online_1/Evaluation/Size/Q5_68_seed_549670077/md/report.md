...
**Test Query:** Q5_68_seed_549670077
...
```
Node 9181 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 9182 (Aggregate) [consumed]
    Node 9183 (Gather Merge) [consumed]
      Node 9184 (Aggregate)
        Node 9185 (Sort) [PATTERN: 3e2d5a00]
          Node 9186 (Hash Join) [consumed]
            Node 9187 (Nested Loop)
              Node 9188 (Hash Join)
                Node 9189 (Seq Scan) - LEAF
                Node 9190 (Hash) [PATTERN: 444761fb]
                  Node 9191 (Hash Join) [consumed]
                    Node 9192 (Seq Scan) [consumed] - LEAF
                    Node 9193 (Hash) [consumed]
                      Node 9194 (Hash Join) [consumed]
                        Node 9195 (Seq Scan) - LEAF
                        Node 9196 (Hash)
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 9190 | 9181, 9182, 9183, 9185, 9186, 9191, 9192, 9193, 9194 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 9181 | 9182, 9183, 9185, 9186, 9190, 9191, 9192, 9193, 9194 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 9185 | 9181, 9182, 9183, 9186, 9190, 9191, 9192, 9193, 9194 |
...
|------|------|--------|-----------|-----|--------|
| 9181 | Sort | 1137.45 | 2934.42 | 158.0% | pattern |
| 9184 | Aggregate | 1132.56 | 1128.76 | 0.3% | operator |
| 9185 | Sort | 1132.29 | 1835.93 | 62.1% | pattern |
| 9187 | Nested Loop | 1120.02 | 1188.47 | 6.1% | operator |
| 9199 | Hash | 3.65 | 18.67 | 411.5% | operator |
| 9188 | Hash Join | 224.49 | 253.07 | 12.7% | operator |
| 9198 | Index Scan | 0.08 | -0.22 | 378.5% | operator |
| 9200 | Seq Scan | 3.11 | 12.36 | 297.2% | operator |
| 9189 | Seq Scan | 171.34 | 159.81 | 6.7% | operator |
| 9190 | Hash | 40.22 | 46.85 | 16.5% | pattern |
| 9195 | Seq Scan | 0.01 | 11.81 | 147503.4% | operator |
| 9196 | Hash | 0.30 | 21.05 | 6802.7% | operator |
| 9197 | Seq Scan | 0.30 | 22.93 | 7493.8% | operator |
...
### Step 2: Node 9195 (Seq Scan) - LEAF
...
### Step 4: Node 9189 (Seq Scan) - LEAF
...
### Step 5: Node 9190 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 9181, 9182, 9183, 9185, 9186, 9191, 9192, 9193, 9194
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 9198 (Index Scan) - LEAF
...
### Step 8: Node 9200 (Seq Scan) - LEAF
...
### Step 11: Node 9185 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 9181, 9182, 9183, 9186, 9190, 9191, 9192, 9193, 9194
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 9181 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 9182, 9183, 9185, 9186, 9190, 9191, 9192, 9193, 9194
- **Input Features:**
