...
**Test Query:** Q5_131_seed_1066524030
...
```
Node 7581 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 7582 (Aggregate) [consumed]
    Node 7583 (Gather Merge) [consumed]
      Node 7584 (Aggregate)
        Node 7585 (Sort) [PATTERN: 3e2d5a00]
          Node 7586 (Hash Join) [consumed]
            Node 7587 (Nested Loop)
              Node 7588 (Hash Join)
                Node 7589 (Seq Scan) - LEAF
                Node 7590 (Hash) [PATTERN: 444761fb]
                  Node 7591 (Hash Join) [consumed]
                    Node 7592 (Seq Scan) [consumed] - LEAF
                    Node 7593 (Hash) [consumed]
                      Node 7594 (Hash Join) [consumed]
                        Node 7595 (Seq Scan) - LEAF
                        Node 7596 (Hash)
                          Node 7597 (Seq Scan) - LEAF
              Node 7598 (Index Scan) - LEAF
            Node 7599 (Hash)
              Node 7600 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 7590 | 7581, 7582, 7583, 7585, 7586, 7591, 7592, 7593, 7594 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 7581 | 7582, 7583, 7585, 7586, 7590, 7591, 7592, 7593, 7594 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 7585 | 7581, 7582, 7583, 7586, 7590, 7591, 7592, 7593, 7594 |
...
|------|------|--------|-----------|-----|--------|
| 7581 | Sort | 1078.86 | 2934.42 | 172.0% | pattern |
| 7584 | Aggregate | 1073.83 | 1128.74 | 5.1% | operator |
| 7585 | Sort | 1073.58 | 1835.96 | 71.0% | pattern |
| 7587 | Nested Loop | 1062.55 | 1188.57 | 11.9% | operator |
| 7599 | Hash | 2.31 | 18.67 | 709.0% | operator |
| 7588 | Hash Join | 217.00 | 253.07 | 16.6% | operator |
| 7598 | Index Scan | 0.07 | -0.22 | 397.3% | operator |
| 7600 | Seq Scan | 1.79 | 12.36 | 590.9% | operator |
| 7589 | Seq Scan | 169.48 | 159.81 | 5.7% | operator |
| 7590 | Hash | 33.51 | 46.85 | 39.8% | pattern |
| 7595 | Seq Scan | 0.09 | 11.81 | 13792.1% | operator |
| 7596 | Hash | 0.05 | 21.05 | 41180.9% | operator |
| 7597 | Seq Scan | 0.05 | 22.93 | 46702.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 7597 (Seq Scan) - LEAF
...
### Step 2: Node 7595 (Seq Scan) - LEAF
...
### Step 4: Node 7589 (Seq Scan) - LEAF
...
### Step 5: Node 7590 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 7581, 7582, 7583, 7585, 7586, 7591, 7592, 7593, 7594
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 7598 (Index Scan) - LEAF
...
### Step 8: Node 7600 (Seq Scan) - LEAF
...
### Step 11: Node 7585 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 7581, 7582, 7583, 7586, 7590, 7591, 7592, 7593, 7594
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 7581 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 7582, 7583, 7585, 7586, 7590, 7591, 7592, 7593, 7594
- **Input Features:**
