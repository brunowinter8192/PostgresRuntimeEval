...
**Test Query:** Q1_69_seed_557874108
...
```
Node 576 (Aggregate) - ROOT
  Node 577 (Gather Merge)
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 578 | 579 |
...
|------|------|--------|-----------|-----|--------|
| 576 | Aggregate | 953.38 | 1195.98 | 25.4% | operator |
| 577 | Gather Merge | 953.35 | 1165.93 | 22.3% | operator |
| 578 | Sort | 930.59 | 1200.87 | 29.0% | pattern |
| 580 | Seq Scan | 512.82 | 678.87 | 32.4% | operator |
...
### Step 4: Node 576 (Aggregate) - ROOT
