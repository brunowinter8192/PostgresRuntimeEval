    ...
    Node 20841 (Aggregate) [consumed]
      Node 20842 (Gather) [consumed]
        Node 20843 (Hash Join)
          Node 20844 (Hash Join)
            Node 20845 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20839 | 20840, 20841, 20842 |
...
| 20843 | Hash Join | 1095.36 | 1007.27 | 8.0% | operator |
| 20844 | Hash Join | 1092.35 | 1004.21 | 8.1% | operator |
| 20850 | Hash | 0.02 | 15.71 | 92316.3% | operator |
| 20845 | Nested Loop | 1044.54 | 1204.78 | 15.3% | operator |
| 20848 | Hash | 36.18 | 55.57 | 53.6% | operator |
...
### Step 6: Node 20851 (Seq Scan) - LEAF
...
### Step 10: Node 20839 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20840, 20841, 20842
- **Input Features:**
