...
```
Node 9261 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 9262 (Aggregate) [consumed]
    Node 9263 (Gather Merge) [consumed]
      Node 9264 (Aggregate)
        Node 9265 (Sort) [PATTERN: 3e2d5a00]
          Node 9266 (Hash Join) [consumed]
            Node 9267 (Nested Loop)
              Node 9268 (Hash Join)
                Node 9269 (Seq Scan) - LEAF
                Node 9270 (Hash) [PATTERN: 444761fb]
                  Node 9271 (Hash Join) [consumed]
                    Node 9272 (Seq Scan) [consumed] - LEAF
                    Node 9273 (Hash) [consumed]
                      Node 9274 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 9270 | 9261, 9262, 9263, 9265, 9266, 9271, 9272, 9273, 9274 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 9261 | 9262, 9263, 9265, 9266, 9270, 9271, 9272, 9273, 9274 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 9265 | 9261, 9262, 9263, 9266, 9270, 9271, 9272, 9273, 9274 |
...
|------|------|--------|-----------|-----|--------|
| 9261 | Sort | 1064.45 | 2934.42 | 175.7% | pattern |
| 9264 | Aggregate | 1058.95 | 1128.78 | 6.6% | operator |
| 9265 | Sort | 1058.70 | 1835.91 | 73.4% | pattern |
| 9267 | Nested Loop | 1047.16 | 1188.39 | 13.5% | operator |
| 9279 | Hash | 2.99 | 18.67 | 524.5% | operator |
| 9268 | Hash Join | 215.28 | 253.07 | 17.6% | operator |
| 9278 | Index Scan | 0.07 | -0.22 | 405.6% | operator |
| 9280 | Seq Scan | 2.47 | 12.36 | 400.2% | operator |
| 9269 | Seq Scan | 166.20 | 159.81 | 3.8% | operator |
| 9270 | Hash | 36.22 | 46.85 | 29.3% | pattern |
| 9275 | Seq Scan | 0.01 | 11.81 | 117982.7% | operator |
| 9276 | Hash | 0.09 | 21.05 | 24668.5% | operator |
| 9277 | Seq Scan | 0.08 | 22.93 | 27530.5% | operator |
...
### Step 4: Node 9269 (Seq Scan) - LEAF
...
### Step 5: Node 9270 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 9261, 9262, 9263, 9265, 9266, 9271, 9272, 9273, 9274
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 9278 (Index Scan) - LEAF
...
### Step 8: Node 9280 (Seq Scan) - LEAF
...
### Step 11: Node 9265 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 9261, 9262, 9263, 9266, 9270, 9271, 9272, 9273, 9274
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 9261 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 9262, 9263, 9265, 9266, 9270, 9271, 9272, 9273, 9274
- **Input Features:**
