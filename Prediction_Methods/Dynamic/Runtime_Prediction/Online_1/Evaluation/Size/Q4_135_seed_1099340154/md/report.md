...
**Test Query:** Q4_135_seed_1099340154
...
```
Node 6117 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6118 (Gather Merge) [consumed]
    Node 6119 (Sort) [consumed]
      Node 6120 (Aggregate) [consumed]
        Node 6121 (Nested Loop)
          Node 6122 (Seq Scan) - LEAF
          Node 6123 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6117 | 6118, 6119, 6120 |
...
|------|------|--------|-----------|-----|--------|
| 6117 | Aggregate | 1056.78 | 952.19 | 9.9% | pattern |
| 6121 | Nested Loop | 1049.45 | 1255.45 | 19.6% | operator |
| 6122 | Seq Scan | 160.42 | 154.67 | 3.6% | operator |
| 6123 | Index Scan | 0.06 | 11.10 | 17526.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6122 (Seq Scan) - LEAF
...
### Step 2: Node 6123 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - Aggregate_startup_cost=66570.7500
  - Aggregate_total_cost=66572.6500
  ...
  - GatherMerge_Outer_startup_cost=66570.7500
  - GatherMerge_Outer_total_cost=66572.5300
  - Sort_Outer_np=0
  - Sort_Outer_nt=5
  - Sort_Outer_nt1=5
  - Sort_Outer_nt2=0
  ...
  - Sort_Outer_startup_cost=65570.7100
  - Sort_Outer_total_cost=65570.7200
