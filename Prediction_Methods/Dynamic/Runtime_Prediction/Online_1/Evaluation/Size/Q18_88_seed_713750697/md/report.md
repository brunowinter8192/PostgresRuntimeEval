...
**Test Query:** Q18_88_seed_713750697
...
```
Node 30996 (Limit) - ROOT
  Node 30997 (Sort)
    Node 30998 (Aggregate)
      Node 30999 (Gather Merge)
        Node 31000 (Incremental Sort)
          Node 31001 (Nested Loop)
            Node 31002 (Merge Join)
              Node 31003 (Sort)
                Node 31004 (Hash Join) [PATTERN: 895c6e8c]
                  Node 31005 (Seq Scan) [consumed] - LEAF
                  Node 31006 (Hash) [consumed]
                    Node 31007 (Aggregate)
                      Node 31008 (Index Scan) - LEAF
              Node 31009 (Sort)
                Node 31010 (Seq Scan) - LEAF
            Node 31011 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 31004 | 31005, 31006 |
...
|------|------|--------|-----------|-----|--------|
| 30996 | Limit | 3031.28 | 1175.21 | 61.2% | operator |
| 30997 | Sort | 2911.89 | 1127.81 | 61.3% | operator |
| 30998 | Aggregate | 2911.85 | 1073.15 | 63.1% | operator |
| 30999 | Gather Merge | 2911.83 | 1073.95 | 63.1% | operator |
| 31000 | Incremental Sort | 2893.05 | 0.00 | 100.0% | operator |
| 31001 | Nested Loop | 2893.00 | 1111.34 | 61.6% | operator |
| 31002 | Merge Join | 2892.94 | 0.00 | 100.0% | operator |
| 31011 | Index Scan | 0.03 | 0.05 | 80.5% | operator |
| 31003 | Sort | 2826.14 | 1095.58 | 61.2% | operator |
| 31009 | Sort | 64.44 | 1074.66 | 1567.7% | operator |
| 31004 | Hash Join | 2826.10 | 471.07 | 83.3% | pattern |
| 31010 | Seq Scan | 53.13 | 18.25 | 65.7% | operator |
| 31007 | Aggregate | 2607.78 | 1073.15 | 58.8% | operator |
| 31008 | Index Scan | 2105.09 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31008 (Index Scan) - LEAF
...
### Step 3: Node 31004 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 31005, 31006
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 31010 (Seq Scan) - LEAF
...
### Step 7: Node 31002 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 31011 (Index Scan) - LEAF
...
### Step 10: Node 31000 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30999 (Gather Merge)
