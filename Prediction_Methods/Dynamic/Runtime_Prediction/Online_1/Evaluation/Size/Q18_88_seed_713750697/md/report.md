        ...
        Node 31000 (Incremental Sort)
          Node 31001 (Nested Loop)
            Node 31002 (Merge Join)
              Node 31003 (Sort)
                Node 31004 (Hash Join)
                  Node 31005 (Seq Scan) - LEAF
                  Node 31006 (Hash)
...
| 31003 | Sort | 2826.14 | 1099.77 | 61.1% | operator |
| 31009 | Sort | 64.44 | 1074.66 | 1567.7% | operator |
| 31004 | Hash Join | 2826.10 | 686.33 | 75.7% | operator |
| 31010 | Seq Scan | 53.13 | 18.25 | 65.7% | operator |
| 31005 | Seq Scan | 189.15 | 170.37 | 9.9% | operator |
| 31006 | Hash | 2607.85 | 21.04 | 99.2% | operator |
...
### Step 3: Node 31005 (Seq Scan) - LEAF
...
### Step 6: Node 31010 (Seq Scan) - LEAF
...
### Step 9: Node 31002 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 31011 (Index Scan) - LEAF
...
### Step 11: Node 31001 (Nested Loop)
...
### Step 12: Node 31000 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30999 (Gather Merge)
