    ...
    Node 16726 (Gather)
      Node 16727 (Aggregate)
        Node 16728 (Nested Loop)
          Node 16729 (Hash Join) [PATTERN: bb930825]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 16729 | 16724, 16725, 16730, 16731, 16732 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 16724 | 16725, 16729, 16730, 16731, 16732 |
...
|------|------|--------|-----------|-----|--------|
| 16724 | Sort | 1213.90 | 1049.52 | 13.5% | pattern |
| 16726 | Gather | 1212.66 | 941.00 | 22.4% | operator |
| 16727 | Aggregate | 1191.02 | 1141.96 | 4.1% | operator |
| 16728 | Nested Loop | 1166.51 | 1252.17 | 7.3% | operator |
| 16729 | Hash Join | 993.71 | 134.80 | 86.4% | pattern |
| 16741 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 16733 | Hash Join | 164.49 | 837.31 | 409.0% | operator |
| 16739 | Hash | 13.30 | 14.95 | 12.4% | operator |
| 16734 | Nested Loop | 158.08 | 1251.76 | 691.9% | operator |
| 16737 | Hash | 4.31 | 15.94 | 269.7% | operator |
| 16740 | Seq Scan | 13.28 | 2.94 | 77.9% | operator |
| 16735 | Seq Scan | 20.90 | 44.65 | 113.6% | operator |
| 16736 | Index Scan | 0.08 | -1.39 | 1926.9% | operator |
| 16738 | Seq Scan | 3.85 | 9.45 | 145.3% | operator |
...
### Step 9: Node 16729 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 16724, 16725, 16730, 16731, 16732
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 16741 (Index Scan) - LEAF
...
### Step 11: Node 16728 (Nested Loop)
...
### Step 14: Node 16724 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 16725, 16729, 16730, 16731, 16732
- **Input Features:**
