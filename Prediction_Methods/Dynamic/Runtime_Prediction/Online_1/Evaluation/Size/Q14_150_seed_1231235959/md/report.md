...
```
Node 26805 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26806 (Gather) [consumed]
    Node 26807 (Aggregate) [consumed]
      Node 26808 (Hash Join) [consumed]
        Node 26809 (Seq Scan) - LEAF
        Node 26810 (Hash)
          Node 26811 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26805 | 26806, 26807, 26808 |
...
|------|------|--------|-----------|-----|--------|
| 26805 | Aggregate | 831.59 | 857.13 | 3.1% | pattern |
| 26809 | Seq Scan | 754.71 | 758.49 | 0.5% | operator |
| 26810 | Hash | 47.31 | 9.38 | 80.2% | operator |
| 26811 | Seq Scan | 42.46 | 12.70 | 70.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26811 (Seq Scan) - LEAF
...
### Step 2: Node 26809 (Seq Scan) - LEAF
...
### Step 4: Node 26805 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26806, 26807, 26808
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=15280
  - HashJoin_Outer_nt1=15280
  ...
  - HashJoin_Outer_total_cost=136646.7500
