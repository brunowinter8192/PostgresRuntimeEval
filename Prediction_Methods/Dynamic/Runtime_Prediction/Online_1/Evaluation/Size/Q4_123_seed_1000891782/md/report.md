...
**Test Query:** Q4_123_seed_1000891782
...
```
Node 6026 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6027 (Gather Merge) [consumed]
    Node 6028 (Sort) [consumed]
      Node 6029 (Aggregate) [consumed]
        Node 6030 (Nested Loop)
          Node 6031 (Seq Scan) - LEAF
          Node 6032 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6026 | 6027, 6028, 6029 |
...
|------|------|--------|-----------|-----|--------|
| 6026 | Aggregate | 1047.85 | 952.19 | 9.1% | pattern |
| 6030 | Nested Loop | 1041.57 | 1255.45 | 20.5% | operator |
| 6031 | Seq Scan | 161.03 | 154.67 | 4.0% | operator |
| 6032 | Index Scan | 0.06 | 11.10 | 17526.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6031 (Seq Scan) - LEAF
...
### Step 2: Node 6032 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - Aggregate_startup_cost=66786.2400
  - Aggregate_total_cost=66788.1400
  ...
  - GatherMerge_Outer_startup_cost=66786.2400
  - GatherMerge_Outer_total_cost=66788.0200
  - Sort_Outer_np=0
  - Sort_Outer_nt=5
  - Sort_Outer_nt1=5
  - Sort_Outer_nt2=0
  ...
  - Sort_Outer_startup_cost=65786.2000
  - Sort_Outer_total_cost=65786.2100
