...
**Test Query:** Q14_54_seed_434813643
**Timestamp:** 2026-01-18 20:14:00
...
```
Node 27113 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27114 (Gather) [consumed]
    Node 27115 (Aggregate) [consumed]
      Node 27116 (Hash Join) [consumed]
        Node 27117 (Seq Scan) - LEAF
        Node 27118 (Hash)
          Node 27119 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27113 | 27114, 27115, 27116 |
...
|------|------|--------|-----------|-----|--------|
| 27113 | Aggregate | 819.30 | 857.13 | 4.6% | pattern |
| 27117 | Seq Scan | 745.55 | 758.48 | 1.7% | operator |
| 27118 | Hash | 41.45 | 9.38 | 77.4% | operator |
| 27119 | Seq Scan | 35.80 | 12.70 | 64.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27119 (Seq Scan) - LEAF
...
### Step 2: Node 27117 (Seq Scan) - LEAF
...
### Step 4: Node 27113 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27114, 27115, 27116
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=14968
  - HashJoin_Outer_nt1=14968
  ...
  - HashJoin_Outer_total_cost=136645.9300
