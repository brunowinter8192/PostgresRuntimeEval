...
**Test Query:** Q4_20_seed_155876589
**Timestamp:** 2025-12-21 14:58:14
...
```
Node 6285 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6286 (Gather Merge) [consumed]
    Node 6287 (Sort) [consumed]
      Node 6288 (Aggregate) [consumed]
        Node 6289 (Nested Loop)
          Node 6290 (Seq Scan) - LEAF
          Node 6291 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6285 | 6286, 6287, 6288 |
...
|------|------|--------|-----------|-----|--------|
| 6285 | Aggregate | 1070.37 | 952.19 | 11.0% | pattern |
| 6289 | Nested Loop | 1064.39 | 1255.45 | 18.0% | operator |
| 6290 | Seq Scan | 164.22 | 154.66 | 5.8% | operator |
| 6291 | Index Scan | 0.06 | 11.10 | 17525.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6290 (Seq Scan) - LEAF
...
### Step 2: Node 6291 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - Aggregate_startup_cost=67439.6400
  - Aggregate_total_cost=67441.5400
  ...
  - GatherMerge_Outer_startup_cost=67439.6400
  - GatherMerge_Outer_total_cost=67441.4100
  - Sort_Outer_np=0
  - Sort_Outer_nt=5
  - Sort_Outer_nt1=5
  - Sort_Outer_nt2=0
  ...
  - Sort_Outer_startup_cost=66439.6000
  - Sort_Outer_total_cost=66439.6100
