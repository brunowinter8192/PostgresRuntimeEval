        ...
        Node 29800 (Incremental Sort)
          Node 29801 (Nested Loop)
            Node 29802 (Merge Join)
              Node 29803 (Sort)
                Node 29804 (Hash Join)
                  Node 29805 (Seq Scan) - LEAF
                  Node 29806 (Hash)
...
| 29803 | Sort | 2854.96 | 1099.77 | 61.5% | operator |
| 29809 | Sort | 65.73 | 1074.66 | 1535.1% | operator |
| 29804 | Hash Join | 2854.95 | 686.33 | 76.0% | operator |
| 29810 | Seq Scan | 54.04 | 18.25 | 66.2% | operator |
| 29805 | Seq Scan | 187.17 | 170.37 | 9.0% | operator |
| 29806 | Hash | 2635.90 | 21.04 | 99.2% | operator |
...
### Step 3: Node 29805 (Seq Scan) - LEAF
...
### Step 6: Node 29810 (Seq Scan) - LEAF
...
### Step 9: Node 29802 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29811 (Index Scan) - LEAF
...
### Step 11: Node 29801 (Nested Loop)
...
### Step 12: Node 29800 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29799 (Gather Merge)
