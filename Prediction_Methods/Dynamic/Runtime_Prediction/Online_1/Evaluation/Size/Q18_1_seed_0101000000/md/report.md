...
**Test Query:** Q18_1_seed_0101000000
...
```
Node 29796 (Limit) - ROOT
  Node 29797 (Sort)
    Node 29798 (Aggregate)
      Node 29799 (Gather Merge)
        Node 29800 (Incremental Sort)
          Node 29801 (Nested Loop)
            Node 29802 (Merge Join)
              Node 29803 (Sort)
                Node 29804 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29805 (Seq Scan) [consumed] - LEAF
                  Node 29806 (Hash) [consumed]
                    Node 29807 (Aggregate)
                      Node 29808 (Index Scan) - LEAF
              Node 29809 (Sort)
                Node 29810 (Seq Scan) - LEAF
            Node 29811 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29804 | 29805, 29806 |
...
|------|------|--------|-----------|-----|--------|
| 29796 | Limit | 3055.21 | 1175.21 | 61.5% | operator |
| 29797 | Sort | 2944.73 | 1127.81 | 61.7% | operator |
| 29798 | Aggregate | 2944.69 | 1073.15 | 63.6% | operator |
| 29799 | Gather Merge | 2944.68 | 1073.95 | 63.5% | operator |
| 29800 | Incremental Sort | 2923.74 | 0.00 | 100.0% | operator |
| 29801 | Nested Loop | 2923.69 | 1111.34 | 62.0% | operator |
| 29802 | Merge Join | 2923.63 | 0.00 | 100.0% | operator |
| 29811 | Index Scan | 0.02 | 0.05 | 88.1% | operator |
| 29803 | Sort | 2854.96 | 1095.58 | 61.6% | operator |
| 29809 | Sort | 65.73 | 1074.66 | 1535.1% | operator |
| 29804 | Hash Join | 2854.95 | 471.07 | 83.5% | pattern |
| 29810 | Seq Scan | 54.04 | 18.25 | 66.2% | operator |
| 29807 | Aggregate | 2635.86 | 1073.15 | 59.3% | operator |
| 29808 | Index Scan | 2138.55 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29808 (Index Scan) - LEAF
...
### Step 3: Node 29804 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29805, 29806
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29810 (Seq Scan) - LEAF
...
### Step 7: Node 29802 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29811 (Index Scan) - LEAF
...
### Step 10: Node 29800 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29799 (Gather Merge)
