...
**Test Query:** Q3_74_seed_598894263
...
```
Node 5561 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5562 (Sort) [consumed]
    Node 5563 (Aggregate) [consumed]
      Node 5564 (Gather) [consumed]
        Node 5565 (Nested Loop)
          Node 5566 (Hash Join) [PATTERN: 895c6e8c]
            Node 5567 (Seq Scan) [consumed] - LEAF
            Node 5568 (Hash) [consumed]
              Node 5569 (Seq Scan) - LEAF
          Node 5570 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5561 | 5562, 5563, 5564, 5566, 5567, 5568 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5566 | 5561, 5562, 5563, 5564, 5567, 5568 |
...
|------|------|--------|-----------|-----|--------|
| 5561 | Limit | 1242.97 | 1151.18 | 7.4% | pattern |
| 5565 | Nested Loop | 1205.20 | 1192.87 | 1.0% | operator |
| 5566 | Hash Join | 210.89 | 242.45 | 15.0% | pattern |
| 5570 | Index Scan | 0.03 | -0.52 | 1950.2% | operator |
| 5569 | Seq Scan | 29.22 | 38.53 | 31.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5569 (Seq Scan) - LEAF
...
### Step 2: Node 5566 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5561, 5562, 5563, 5564, 5567, 5568
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46639
  - HashJoin_nt1=231734
  ...
  - HashJoin_total_cost=37331.2000
  - Hash_Inner_np=0
  - Hash_Inner_nt=12579
...
- **Output:** st=29.81, rt=242.45

### Step 3: Node 5570 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=72782.2600
- **Output:** st=121.61, rt=1192.87

### Step 5: Node 5561 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5562, 5563, 5564, 5566, 5567, 5568
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=315422
  - Aggregate_Outer_nt1=315422
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110055.7900
  - Aggregate_Outer_total_cost=113998.5600
  - Gather_Outer_np=0
  - Gather_Outer_nt=315422
  ...
  - Gather_Outer_total_cost=105324.4600
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=315422
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=120814.7200
  - Limit_total_cost=120814.7400
  - Sort_Outer_np=0
  - Sort_Outer_nt=315422
  - Sort_Outer_nt1=315422
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=120814.7200
  - Sort_Outer_total_cost=121603.2700
