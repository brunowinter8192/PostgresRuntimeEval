...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5561 | 5562, 5563, 5564 |
...
| 5565 | Nested Loop | 1205.20 | 1192.78 | 1.0% | operator |
| 5566 | Hash Join | 210.89 | 230.14 | 9.1% | operator |
| 5570 | Index Scan | 0.03 | -0.52 | 1950.2% | operator |
| 5567 | Seq Scan | 156.70 | 163.15 | 4.1% | operator |
| 5568 | Hash | 29.89 | 17.75 | 40.6% | operator |
...
### Step 2: Node 5567 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37331.2000
- **Output:** st=27.08, rt=230.14

### Step 5: Node 5570 (Index Scan) - LEAF
...
- **Output:** st=121.46, rt=1192.78

### Step 7: Node 5561 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5562, 5563, 5564
- **Input Features:**
