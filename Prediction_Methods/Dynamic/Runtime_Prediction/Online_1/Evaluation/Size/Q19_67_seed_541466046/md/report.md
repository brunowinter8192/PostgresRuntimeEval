...
```
Node 32011 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 32012 (Gather) [consumed]
    Node 32013 (Aggregate) [consumed]
      Node 32014 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 32011 | 32012, 32013 |
...
|------|------|--------|-----------|-----|--------|
| 32011 | Aggregate | 791.11 | 831.20 | 5.1% | pattern |
| 32014 | Hash Join | 770.94 | 766.06 | 0.6% | operator |
...
### Step 5: Node 32011 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 32012, 32013
- **Input Features:**
