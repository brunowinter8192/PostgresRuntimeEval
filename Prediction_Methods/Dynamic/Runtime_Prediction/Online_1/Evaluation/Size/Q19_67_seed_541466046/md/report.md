...
**Test Query:** Q19_67_seed_541466046
...
```
Node 32011 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 32012 (Gather) [consumed]
    Node 32013 (Aggregate) [consumed]
      Node 32014 (Hash Join) [consumed]
        Node 32015 (Seq Scan) - LEAF
        Node 32016 (Hash)
          Node 32017 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 32011 | 32012, 32013, 32014 |
...
|------|------|--------|-----------|-----|--------|
| 32011 | Aggregate | 791.11 | 829.30 | 4.8% | pattern |
| 32015 | Seq Scan | 721.98 | 743.46 | 3.0% | operator |
| 32016 | Hash | 46.80 | 8.29 | 82.3% | operator |
| 32017 | Seq Scan | 46.65 | 23.76 | 49.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 32017 (Seq Scan) - LEAF
...
### Step 2: Node 32015 (Seq Scan) - LEAF
...
### Step 4: Node 32011 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 32012, 32013, 32014
- **Input Features:**
