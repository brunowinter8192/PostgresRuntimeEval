        ...
        Node 31096 (Incremental Sort)
          Node 31097 (Nested Loop)
            Node 31098 (Merge Join)
              Node 31099 (Sort)
                Node 31100 (Hash Join)
                  Node 31101 (Seq Scan) - LEAF
                  Node 31102 (Hash)
...
| 31099 | Sort | 2825.25 | 1099.77 | 61.1% | operator |
| 31105 | Sort | 65.02 | 1074.66 | 1552.9% | operator |
| 31100 | Hash Join | 2825.24 | 686.33 | 75.7% | operator |
| 31106 | Seq Scan | 53.10 | 18.25 | 65.6% | operator |
| 31101 | Seq Scan | 182.14 | 170.37 | 6.5% | operator |
| 31102 | Hash | 2612.30 | 21.04 | 99.2% | operator |
...
### Step 3: Node 31101 (Seq Scan) - LEAF
...
### Step 6: Node 31106 (Seq Scan) - LEAF
...
### Step 9: Node 31098 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 31107 (Index Scan) - LEAF
...
### Step 11: Node 31097 (Nested Loop)
...
### Step 12: Node 31096 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 31095 (Gather Merge)
