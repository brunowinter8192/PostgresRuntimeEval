...
**Test Query:** Q18_93_seed_754770852
...
```
Node 31092 (Limit) - ROOT
  Node 31093 (Sort)
    Node 31094 (Aggregate)
      Node 31095 (Gather Merge)
        Node 31096 (Incremental Sort)
          Node 31097 (Nested Loop)
            Node 31098 (Merge Join)
              Node 31099 (Sort)
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 31100 | 31101, 31102 |
...
|------|------|--------|-----------|-----|--------|
| 31092 | Limit | 3035.33 | 1175.21 | 61.3% | operator |
| 31093 | Sort | 2916.36 | 1127.81 | 61.3% | operator |
| 31094 | Aggregate | 2916.30 | 1073.15 | 63.2% | operator |
| 31095 | Gather Merge | 2916.28 | 1073.95 | 63.2% | operator |
| 31096 | Incremental Sort | 2893.32 | 0.00 | 100.0% | operator |
| 31097 | Nested Loop | 2893.27 | 1111.34 | 61.6% | operator |
| 31098 | Merge Join | 2893.20 | 0.00 | 100.0% | operator |
| 31107 | Index Scan | 0.03 | 0.05 | 61.2% | operator |
| 31099 | Sort | 2825.25 | 1095.58 | 61.2% | operator |
| 31105 | Sort | 65.02 | 1074.66 | 1552.9% | operator |
| 31100 | Hash Join | 2825.24 | 471.07 | 83.3% | pattern |
| 31106 | Seq Scan | 53.10 | 18.25 | 65.6% | operator |
| 31103 | Aggregate | 2612.26 | 1073.15 | 58.9% | operator |
| 31104 | Index Scan | 2114.74 | 0.00 | 100.0% | operator |
...
### Step 4: Node 31106 (Seq Scan) - LEAF
...
### Step 7: Node 31098 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 31107 (Index Scan) - LEAF
...
### Step 10: Node 31096 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 31095 (Gather Merge)
