...
**Test Query:** Q14_110_seed_894239379
...
```
Node 26497 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26498 (Gather) [consumed]
    Node 26499 (Aggregate) [consumed]
      Node 26500 (Hash Join) [consumed]
        Node 26501 (Seq Scan) - LEAF
        Node 26502 (Hash)
          Node 26503 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26497 | 26498, 26499, 26500 |
...
|------|------|--------|-----------|-----|--------|
| 26497 | Aggregate | 828.34 | 857.14 | 3.5% | pattern |
| 26501 | Seq Scan | 756.36 | 758.50 | 0.3% | operator |
| 26502 | Hash | 42.20 | 9.38 | 77.8% | operator |
| 26503 | Seq Scan | 37.07 | 12.70 | 65.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26503 (Seq Scan) - LEAF
...
### Step 2: Node 26501 (Seq Scan) - LEAF
...
### Step 4: Node 26497 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26498, 26499, 26500
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=15624
  - HashJoin_Outer_nt1=15624
  ...
  - HashJoin_Outer_total_cost=136647.6500
