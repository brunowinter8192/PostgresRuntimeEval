...
```
Node 26497 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26498 (Gather) [consumed]
    Node 26499 (Aggregate) [consumed]
      Node 26500 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26497 | 26498, 26499 |
...
|------|------|--------|-----------|-----|--------|
| 26497 | Aggregate | 828.34 | 848.37 | 2.4% | pattern |
| 26500 | Hash Join | 806.16 | 807.66 | 0.2% | operator |
...
### Step 5: Node 26497 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26498, 26499
- **Input Features:**
