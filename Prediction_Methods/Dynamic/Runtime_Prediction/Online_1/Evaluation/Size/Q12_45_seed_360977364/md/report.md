...
**Test Query:** Q12_45_seed_360977364
...
```
Node 24943 (Aggregate) - ROOT
  Node 24944 (Gather Merge)
    Node 24945 (Aggregate)
      Node 24946 (Sort)
        Node 24947 (Nested Loop)
          Node 24948 (Seq Scan) - LEAF
          Node 24949 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24943 | Aggregate | 990.00 | 919.06 | 7.2% | operator |
| 24944 | Gather Merge | 989.99 | 1111.84 | 12.3% | operator |
| 24945 | Aggregate | 970.03 | 895.31 | 7.7% | operator |
| 24946 | Sort | 969.41 | 1092.81 | 12.7% | operator |
| 24947 | Nested Loop | 968.25 | 1127.41 | 16.4% | operator |
| 24948 | Seq Scan | 827.75 | 745.19 | 10.0% | operator |
| 24949 | Index Scan | 0.03 | 0.07 | 166.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24948 (Seq Scan) - LEAF
...
### Step 2: Node 24949 (Index Scan) - LEAF
...
### Step 6: Node 24944 (Gather Merge)
...
### Step 7: Node 24943 (Aggregate) - ROOT
