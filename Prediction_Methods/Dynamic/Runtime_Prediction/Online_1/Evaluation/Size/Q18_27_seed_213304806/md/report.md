...
```
Node 29924 (Limit) - ROOT
  Node 29925 (Sort)
    Node 29926 (Aggregate)
      Node 29927 (Gather Merge)
        Node 29928 (Incremental Sort)
          Node 29929 (Nested Loop)
            Node 29930 (Merge Join)
              Node 29931 (Sort)
                Node 29932 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29933 (Seq Scan) [consumed] - LEAF
                  Node 29934 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29932 | 29933, 29934 |
...
|------|------|--------|-----------|-----|--------|
| 29924 | Limit | 3043.82 | 1175.21 | 61.4% | operator |
| 29925 | Sort | 2931.66 | 1127.81 | 61.5% | operator |
| 29926 | Aggregate | 2931.61 | 1073.15 | 63.4% | operator |
| 29927 | Gather Merge | 2931.60 | 1073.95 | 63.4% | operator |
| 29928 | Incremental Sort | 2911.65 | 0.00 | 100.0% | operator |
| 29929 | Nested Loop | 2911.59 | 1111.34 | 61.8% | operator |
| 29930 | Merge Join | 2911.53 | 0.00 | 100.0% | operator |
| 29939 | Index Scan | 0.02 | 0.05 | 105.2% | operator |
| 29931 | Sort | 2838.57 | 1095.58 | 61.4% | operator |
| 29937 | Sort | 68.58 | 1074.66 | 1466.9% | operator |
| 29932 | Hash Join | 2838.56 | 471.07 | 83.4% | pattern |
| 29938 | Seq Scan | 55.06 | 18.25 | 66.9% | operator |
| 29935 | Aggregate | 2622.79 | 1073.15 | 59.1% | operator |
| 29936 | Index Scan | 2118.58 | 0.00 | 100.0% | operator |
...
### Step 3: Node 29932 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29933, 29934
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29938 (Seq Scan) - LEAF
...
### Step 7: Node 29930 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29939 (Index Scan) - LEAF
...
### Step 10: Node 29928 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29927 (Gather Merge)
