...
**Test Query:** Q12_70_seed_566078139
...
```
Node 25139 (Aggregate) - ROOT
  Node 25140 (Gather Merge)
    Node 25141 (Aggregate)
      Node 25142 (Sort)
        Node 25143 (Nested Loop)
          Node 25144 (Seq Scan) - LEAF
          Node 25145 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 25139 | Aggregate | 1017.67 | 919.07 | 9.7% | operator |
| 25140 | Gather Merge | 1017.64 | 1111.84 | 9.3% | operator |
| 25141 | Aggregate | 998.60 | 895.31 | 10.3% | operator |
| 25142 | Sort | 998.02 | 1092.81 | 9.5% | operator |
| 25143 | Nested Loop | 997.12 | 1127.41 | 13.1% | operator |
| 25144 | Seq Scan | 855.06 | 745.19 | 12.8% | operator |
| 25145 | Index Scan | 0.03 | 0.07 | 166.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25144 (Seq Scan) - LEAF
...
### Step 2: Node 25145 (Index Scan) - LEAF
...
### Step 6: Node 25140 (Gather Merge)
...
### Step 7: Node 25139 (Aggregate) - ROOT
