...
**Test Query:** Q12_38_seed_303549147
...
```
Node 24887 (Aggregate) - ROOT
  Node 24888 (Gather Merge)
    Node 24889 (Aggregate)
      Node 24890 (Sort)
        Node 24891 (Nested Loop)
          Node 24892 (Seq Scan) - LEAF
          Node 24893 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24887 | Aggregate | 1003.39 | 919.07 | 8.4% | operator |
| 24888 | Gather Merge | 1003.38 | 1111.84 | 10.8% | operator |
| 24889 | Aggregate | 985.30 | 895.31 | 9.1% | operator |
| 24890 | Sort | 984.66 | 1092.81 | 11.0% | operator |
| 24891 | Nested Loop | 983.70 | 1127.41 | 14.6% | operator |
| 24892 | Seq Scan | 848.25 | 745.19 | 12.1% | operator |
| 24893 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24892 (Seq Scan) - LEAF
...
### Step 2: Node 24893 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - st2=0.1246
  - startup_cost=0.4300
  - total_cost=147159.7100
- **Output:** st=38.33, rt=1127.41

### Step 4: Node 24890 (Sort)
...
- **Input Features:**
  ...
  - st1=38.3268
  - st2=0.0000
  - startup_cost=147519.4800
  - total_cost=147533.8800
- **Output:** st=1092.40, rt=1092.81

### Step 5: Node 24889 (Aggregate)
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=147519.4800
  - total_cost=147634.7500
- **Output:** st=868.97, rt=895.31

### Step 6: Node 24888 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=868.9659
  - st2=0.0000
  - startup_cost=148519.5600
  - total_cost=148639.0400
- **Output:** st=1109.22, rt=1111.84

### Step 7: Node 24887 (Aggregate) - ROOT
