...
```
Node 10477 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10478 (Gather) [consumed]
    Node 10479 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10477 | 10478, 10479 |
...
|------|------|--------|-----------|-----|--------|
| 10477 | Aggregate | 816.11 | 850.05 | 4.2% | pattern |
| 10480 | Seq Scan | 795.62 | 748.53 | 5.9% | operator |
...
### Step 2: Node 10477 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10478, 10479
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=23615
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=32
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=139723.5500
  - Aggregate_Outer_total_cost=139723.5600
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
