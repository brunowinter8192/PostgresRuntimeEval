...
```
Node 31591 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31592 (Gather) [consumed]
    Node 31593 (Aggregate) [consumed]
      Node 31594 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31591 | 31592, 31593 |
...
|------|------|--------|-----------|-----|--------|
| 31591 | Aggregate | 860.08 | 831.20 | 3.4% | pattern |
| 31594 | Hash Join | 839.64 | 766.06 | 8.8% | operator |
...
### Step 5: Node 31591 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31592, 31593
- **Input Features:**
