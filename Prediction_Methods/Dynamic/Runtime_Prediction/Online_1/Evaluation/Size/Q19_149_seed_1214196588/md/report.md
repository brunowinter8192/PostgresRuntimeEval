...
**Test Query:** Q19_149_seed_1214196588
...
```
Node 31591 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31592 (Gather) [consumed]
    Node 31593 (Aggregate) [consumed]
      Node 31594 (Hash Join) [consumed]
        Node 31595 (Seq Scan) - LEAF
        Node 31596 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31591 | 31592, 31593, 31594 |
...
|------|------|--------|-----------|-----|--------|
| 31591 | Aggregate | 860.08 | 829.29 | 3.6% | pattern |
| 31595 | Seq Scan | 792.80 | 743.46 | 6.2% | operator |
| 31596 | Hash | 44.59 | 8.29 | 81.4% | operator |
| 31597 | Seq Scan | 44.42 | 23.76 | 46.5% | operator |
...
### Step 2: Node 31595 (Seq Scan) - LEAF
...
### Step 4: Node 31591 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31592, 31593, 31594
- **Input Features:**
