...
```
Node 26511 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26512 (Gather) [consumed]
    Node 26513 (Aggregate) [consumed]
      Node 26514 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26511 | 26512, 26513, 26514 |
...
|------|------|--------|-----------|-----|--------|
| 26511 | Aggregate | 818.53 | 857.11 | 4.7% | pattern |
...
### Step 4: Node 26511 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26512, 26513, 26514
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=14320
  - HashJoin_Outer_nt1=14320
  ...
  - HashJoin_Outer_total_cost=136644.2300
