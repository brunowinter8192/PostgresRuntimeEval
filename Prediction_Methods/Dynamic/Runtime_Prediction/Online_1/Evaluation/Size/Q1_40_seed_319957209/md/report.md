...
**Test Query:** Q1_40_seed_319957209
...
```
Node 421 (Aggregate) - ROOT
  Node 422 (Gather Merge)
    Node 423 (Sort) [PATTERN: 1d35fb97]
      Node 424 (Aggregate) [consumed]
        Node 425 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 423 | 424 |
...
|------|------|--------|-----------|-----|--------|
| 421 | Aggregate | 942.71 | 1195.88 | 26.9% | operator |
| 422 | Gather Merge | 942.66 | 1165.90 | 23.7% | operator |
| 423 | Sort | 923.29 | 1200.47 | 30.0% | pattern |
| 425 | Seq Scan | 510.41 | 680.38 | 33.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 425 (Seq Scan) - LEAF
...
### Step 2: Node 423 (Sort) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Aggregate_Outer_total_cost=168943.3900
  - Sort_np=0
  - Sort_nt=6
  - Sort_nt1=6
  - Sort_nt2=0
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=168943.4700
  - Sort_total_cost=168943.4800
- **Output:** st=1196.38, rt=1200.47

### Step 3: Node 422 (Gather Merge)
...
### Step 4: Node 421 (Aggregate) - ROOT
