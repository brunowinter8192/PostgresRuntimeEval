...
**Test Query:** Q19_93_seed_754770852
...
```
Node 32214 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 32215 (Gather) [consumed]
    Node 32216 (Aggregate) [consumed]
      Node 32217 (Hash Join) [consumed]
        Node 32218 (Seq Scan) - LEAF
        Node 32219 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 32214 | 32215, 32216, 32217 |
...
|------|------|--------|-----------|-----|--------|
| 32214 | Aggregate | 770.51 | 829.29 | 7.6% | pattern |
| 32218 | Seq Scan | 701.12 | 743.46 | 6.0% | operator |
| 32219 | Hash | 48.62 | 8.29 | 83.0% | operator |
| 32220 | Seq Scan | 48.55 | 23.76 | 51.1% | operator |
...
### Step 2: Node 32218 (Seq Scan) - LEAF
...
### Step 4: Node 32214 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 32215, 32216, 32217
- **Input Features:**
