...
```
Node 32214 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 32215 (Gather) [consumed]
    Node 32216 (Aggregate) [consumed]
      Node 32217 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 32214 | 32215, 32216 |
...
|------|------|--------|-----------|-----|--------|
| 32214 | Aggregate | 770.51 | 831.20 | 7.9% | pattern |
| 32217 | Hash Join | 751.30 | 766.06 | 2.0% | operator |
...
### Step 5: Node 32214 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 32215, 32216
- **Input Features:**
