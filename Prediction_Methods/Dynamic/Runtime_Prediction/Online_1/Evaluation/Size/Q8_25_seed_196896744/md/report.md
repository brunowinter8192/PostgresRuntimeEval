...
```
Node 14742 (Aggregate) - ROOT
  Node 14743 (Gather Merge)
    Node 14744 (Sort)
          ...
          Node 14747 (Hash Join)
            Node 14748 (Nested Loop)
              Node 14749 (Hash Join)
                ...
                Node 14751 (Hash)
                  Node 14752 (Hash Join)
                    Node 14753 (Seq Scan) - LEAF
                    Node 14754 (Hash)
                      Node 14755 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 14742 | Aggregate | 1232.70 | 1195.83 | 3.0% | operator |
| 14743 | Gather Merge | 1232.23 | 1097.14 | 11.0% | operator |
...
| 14749 | Hash Join | 213.11 | 251.17 | 17.9% | operator |
...
| 14751 | Hash | 35.09 | 20.62 | 41.3% | operator |
| 14752 | Hash Join | 34.57 | 132.26 | 282.6% | operator |
| 14753 | Seq Scan | 33.20 | 23.03 | 30.6% | operator |
| 14754 | Hash | 0.08 | 23.66 | 29470.2% | operator |
| 14755 | Hash Join | 0.08 | 306.84 | 393279.4% | operator |
...
### Step 5: Node 14753 (Seq Scan) - LEAF
...
### Step 8: Node 14750 (Seq Scan) - LEAF
...
### Step 11: Node 14759 (Index Scan) - LEAF
...
### Step 12: Node 14761 (Seq Scan) - LEAF
...
### Step 13: Node 14748 (Nested Loop)
...
### Step 16: Node 14762 (Index Scan) - LEAF
...
### Step 17: Node 14764 (Seq Scan) - LEAF
...
### Step 18: Node 14746 (Nested Loop)
...
### Step 22: Node 14743 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1044.9403
  - st2=0.0000
  - startup_cost=71540.1600
  - total_cost=71815.6900
- **Output:** st=1093.43, rt=1097.14

### Step 23: Node 14742 (Aggregate) - ROOT
