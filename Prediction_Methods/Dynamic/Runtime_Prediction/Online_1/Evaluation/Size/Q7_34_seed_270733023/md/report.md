...
```
Node 11887 (Aggregate) - ROOT
  Node 11888 (Gather Merge)
    Node 11889 (Sort)
      Node 11890 (Hash Join)
        Node 11891 (Nested Loop)
          Node 11892 (Hash Join)
            Node 11893 (Seq Scan) - LEAF
            Node 11894 (Hash)
              Node 11895 (Hash Join)
                Node 11896 (Seq Scan) - LEAF
                Node 11897 (Hash)
                  Node 11898 (Seq Scan) - LEAF
          Node 11899 (Index Scan) - LEAF
        Node 11900 (Hash)
          Node 11901 (Hash Join)
            Node 11902 (Seq Scan) - LEAF
            Node 11903 (Hash)
              Node 11904 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 11887 | Aggregate | 1175.23 | 1209.26 | 2.9% | operator |
| 11888 | Gather Merge | 1174.15 | 1142.98 | 2.7% | operator |
| 11889 | Sort | 1168.51 | 1109.13 | 5.1% | operator |
| 11890 | Hash Join | 1167.87 | 842.59 | 27.9% | operator |
| 11891 | Nested Loop | 1161.11 | 1216.16 | 4.7% | operator |
| 11900 | Hash | 2.85 | 17.53 | 515.7% | operator |
| 11892 | Hash Join | 216.12 | 384.47 | 77.9% | operator |
| 11899 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 11901 | Hash Join | 2.79 | 85.17 | 2947.4% | operator |
| 11893 | Seq Scan | 154.22 | 201.16 | 30.4% | operator |
| 11894 | Hash | 36.83 | 19.59 | 46.8% | operator |
| 11902 | Seq Scan | 2.43 | 11.47 | 371.5% | operator |
| 11903 | Hash | 0.02 | 16.89 | 105488.0% | operator |
| 11895 | Hash Join | 36.45 | 92.20 | 153.0% | operator |
| 11904 | Seq Scan | 0.01 | 45.79 | 352148.6% | operator |
| 11896 | Seq Scan | 35.35 | 21.86 | 38.2% | operator |
| 11897 | Hash | 0.01 | 16.89 | 140684.0% | operator |
| 11898 | Seq Scan | 0.01 | 45.79 | 457823.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11898 (Seq Scan) - LEAF
...
### Step 2: Node 11896 (Seq Scan) - LEAF
...
### Step 5: Node 11904 (Seq Scan) - LEAF
...
### Step 6: Node 11893 (Seq Scan) - LEAF
...
### Step 8: Node 11902 (Seq Scan) - LEAF
...
### Step 11: Node 11899 (Index Scan) - LEAF
...
### Step 13: Node 11891 (Nested Loop)
...
### Step 17: Node 11888 (Gather Merge)
...
### Step 18: Node 11887 (Aggregate) - ROOT
