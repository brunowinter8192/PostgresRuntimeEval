...
**Test Query:** Q7_34_seed_270733023
...
```
Node 11887 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 11888 (Gather Merge) [consumed]
    Node 11889 (Sort)
      Node 11890 (Hash Join)
        Node 11891 (Nested Loop)
          Node 11892 (Hash Join) [PATTERN: 895c6e8c]
            Node 11893 (Seq Scan) [consumed] - LEAF
            Node 11894 (Hash) [consumed]
              Node 11895 (Hash Join) [PATTERN: f4cb205a]
                Node 11896 (Seq Scan) [consumed] - LEAF
                Node 11897 (Hash) [consumed]
                  Node 11898 (Seq Scan) [consumed] - LEAF
          Node 11899 (Index Scan) - LEAF
        Node 11900 (Hash)
          Node 11901 (Hash Join) [PATTERN: f4cb205a]
            Node 11902 (Seq Scan) [consumed] - LEAF
            Node 11903 (Hash) [consumed]
              Node 11904 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 11895 | 11887, 11888, 11892, 11893, 11894, 11896, 11897, 11898, 11901, 11902, 11903, 11904 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 11901 | 11887, 11888, 11892, 11893, 11894, 11895, 11896, 11897, 11898, 11902, 11903, 11904 |
| Aggregate -> Gather Merge (Out | 2724c080 | 11887 | 11888, 11892, 11893, 11894, 11895, 11896, 11897, 11898, 11901, 11902, 11903, 11904 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 11892 | 11887, 11888, 11893, 11894, 11895, 11896, 11897, 11898, 11901, 11902, 11903, 11904 |
...
|------|------|--------|-----------|-----|--------|
| 11887 | Aggregate | 1175.23 | 1163.13 | 1.0% | pattern |
| 11889 | Sort | 1168.51 | 1109.16 | 5.1% | operator |
| 11890 | Hash Join | 1167.87 | 843.11 | 27.8% | operator |
| 11891 | Nested Loop | 1161.11 | 1215.99 | 4.7% | operator |
| 11900 | Hash | 2.85 | 27.74 | 874.5% | operator |
| 11892 | Hash Join | 216.12 | 304.89 | 41.1% | pattern |
| 11899 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 11901 | Hash Join | 2.79 | 429.36 | 15261.8% | pattern |
| 11895 | Hash Join | 36.45 | 429.38 | 1078.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11895 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 11887, 11888, 11892, 11893, 11894, 11896, 11897, 11898, 11901, 11902, 11903, 11904
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5000
  - HashJoin_nt1=62500
...
### Step 2: Node 11892 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 11887, 11888, 11893, 11894, 11895, 11896, 11897, 11898, 11901, 11902, 11903, 11904
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=38710
  - HashJoin_nt1=483871
...
### Step 3: Node 11899 (Index Scan) - LEAF
...
### Step 4: Node 11901 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 11887, 11888, 11892, 11893, 11894, 11895, 11896, 11897, 11898, 11902, 11903, 11904
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=800
  - HashJoin_nt1=10000
...
### Step 9: Node 11887 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 11888, 11892, 11893, 11894, 11895, 11896, 11897, 11898, 11901, 11902, 11903, 11904
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
