...
**Test Query:** Q9_139_seed_1132156278
**Timestamp:** 2026-01-18 19:03:26
...
```
Node 17411 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 17412 (Aggregate) [consumed]
    Node 17413 (Gather)
      Node 17414 (Aggregate)
        Node 17415 (Nested Loop)
          Node 17416 (Hash Join) [PATTERN: bb930825]
            Node 17417 (Seq Scan) [consumed] - LEAF
            Node 17418 (Hash) [consumed]
              Node 17419 (Hash Join) [consumed]
                Node 17420 (Hash Join)
                  Node 17421 (Nested Loop)
                    Node 17422 (Seq Scan) - LEAF
                    Node 17423 (Index Scan) - LEAF
                  Node 17424 (Hash)
                    Node 17425 (Seq Scan) - LEAF
                Node 17426 (Hash)
                  Node 17427 (Seq Scan) - LEAF
          Node 17428 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17416 | 17411, 17412, 17417, 17418, 17419 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17411 | 17412, 17416, 17417, 17418, 17419 |
...
|------|------|--------|-----------|-----|--------|
| 17411 | Sort | 1218.38 | 1044.29 | 14.3% | pattern |
| 17413 | Gather | 1217.19 | 965.14 | 20.7% | operator |
| 17414 | Aggregate | 1199.19 | 1141.19 | 4.8% | operator |
| 17415 | Nested Loop | 1174.55 | 1252.17 | 6.6% | operator |
| 17416 | Hash Join | 996.86 | 134.80 | 86.5% | pattern |
| 17428 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17420 | Hash Join | 174.46 | 837.49 | 380.0% | operator |
| 17426 | Hash | 13.02 | 14.95 | 14.8% | operator |
| 17421 | Nested Loop | 167.15 | 1251.76 | 648.9% | operator |
| 17424 | Hash | 5.13 | 15.94 | 210.4% | operator |
| 17427 | Seq Scan | 13.01 | 2.94 | 77.4% | operator |
| 17422 | Seq Scan | 19.65 | 44.30 | 125.4% | operator |
| 17423 | Index Scan | 0.08 | -1.39 | 1814.1% | operator |
| 17425 | Seq Scan | 4.64 | 9.45 | 103.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 17422 (Seq Scan) - LEAF
...
### Step 2: Node 17423 (Index Scan) - LEAF
...
### Step 3: Node 17425 (Seq Scan) - LEAF
...
### Step 6: Node 17427 (Seq Scan) - LEAF
...
### Step 9: Node 17416 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17411, 17412, 17417, 17418, 17419
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17428 (Index Scan) - LEAF
...
### Step 11: Node 17415 (Nested Loop)
...
### Step 14: Node 17411 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17412, 17416, 17417, 17418, 17419
- **Input Features:**
