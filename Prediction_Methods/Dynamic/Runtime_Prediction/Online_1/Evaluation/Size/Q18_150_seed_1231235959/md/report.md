...
```
Node 29700 (Limit) - ROOT
  Node 29701 (Sort)
    Node 29702 (Aggregate)
      Node 29703 (Gather Merge)
        Node 29704 (Incremental Sort)
          Node 29705 (Nested Loop)
            Node 29706 (Merge Join)
              Node 29707 (Sort)
                Node 29708 (Hash Join)
                  Node 29709 (Seq Scan) - LEAF
                  Node 29710 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 29700 | Limit | 3075.10 | 1175.21 | 61.8% | operator |
| 29701 | Sort | 2959.09 | 1127.81 | 61.9% | operator |
| 29702 | Aggregate | 2959.05 | 1073.15 | 63.7% | operator |
| 29703 | Gather Merge | 2959.03 | 1073.95 | 63.7% | operator |
| 29704 | Incremental Sort | 2940.49 | 0.00 | 100.0% | operator |
| 29705 | Nested Loop | 2940.44 | 1111.34 | 62.2% | operator |
| 29706 | Merge Join | 2940.38 | 0.00 | 100.0% | operator |
| 29715 | Index Scan | 0.02 | 0.05 | 114.9% | operator |
| 29707 | Sort | 2873.37 | 1099.77 | 61.7% | operator |
| 29713 | Sort | 64.43 | 1074.66 | 1568.1% | operator |
| 29708 | Hash Join | 2873.36 | 686.33 | 76.1% | operator |
| 29714 | Seq Scan | 52.26 | 18.25 | 65.1% | operator |
| 29709 | Seq Scan | 196.40 | 170.37 | 13.3% | operator |
| 29710 | Hash | 2645.38 | 21.04 | 99.2% | operator |
| 29711 | Aggregate | 2645.34 | 1073.15 | 59.4% | operator |
| 29712 | Index Scan | 2128.73 | 0.00 | 100.0% | operator |
...
### Step 3: Node 29709 (Seq Scan) - LEAF
...
### Step 6: Node 29714 (Seq Scan) - LEAF
...
### Step 9: Node 29706 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29715 (Index Scan) - LEAF
...
### Step 11: Node 29705 (Nested Loop)
...
### Step 12: Node 29704 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29703 (Gather Merge)
