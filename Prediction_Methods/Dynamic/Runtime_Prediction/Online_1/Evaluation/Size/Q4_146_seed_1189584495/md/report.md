...
**Test Query:** Q4_146_seed_1189584495
...
```
Node 6201 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6202 (Gather Merge) [consumed]
    Node 6203 (Sort) [consumed]
      Node 6204 (Aggregate) [consumed]
        Node 6205 (Nested Loop)
          Node 6206 (Seq Scan) - LEAF
          Node 6207 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6201 | 6202, 6203, 6204 |
...
|------|------|--------|-----------|-----|--------|
| 6201 | Aggregate | 1073.31 | 952.19 | 11.3% | pattern |
| 6205 | Nested Loop | 1065.06 | 1255.45 | 17.9% | operator |
| 6206 | Seq Scan | 164.60 | 154.67 | 6.0% | operator |
| 6207 | Index Scan | 0.06 | 11.10 | 17526.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6206 (Seq Scan) - LEAF
...
### Step 2: Node 6207 (Index Scan) - LEAF
