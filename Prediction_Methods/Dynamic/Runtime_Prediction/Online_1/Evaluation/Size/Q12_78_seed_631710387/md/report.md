...
**Test Query:** Q12_78_seed_631710387
**Timestamp:** 2026-01-18 19:53:13
...
```
Node 25195 (Aggregate) - ROOT
  Node 25196 (Gather Merge)
    Node 25197 (Aggregate)
      Node 25198 (Sort)
        Node 25199 (Nested Loop)
          Node 25200 (Seq Scan) - LEAF
          Node 25201 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 25195 | Aggregate | 1031.90 | 919.06 | 10.9% | operator |
| 25196 | Gather Merge | 1031.89 | 1111.84 | 7.7% | operator |
| 25197 | Aggregate | 1013.10 | 895.31 | 11.6% | operator |
| 25198 | Sort | 1012.49 | 1092.81 | 7.9% | operator |
| 25199 | Nested Loop | 1011.39 | 1127.41 | 11.5% | operator |
| 25200 | Seq Scan | 860.63 | 745.19 | 13.4% | operator |
| 25201 | Index Scan | 0.03 | 0.07 | 147.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25200 (Seq Scan) - LEAF
...
### Step 2: Node 25201 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - st2=0.1246
  - startup_cost=0.4300
  - total_cost=147172.1500
- **Output:** st=38.33, rt=1127.41

### Step 4: Node 25198 (Sort)
...
- **Input Features:**
  ...
  - st1=38.3252
  - st2=0.0000
  - startup_cost=147532.8900
  - total_cost=147547.3300
- **Output:** st=1092.40, rt=1092.81

### Step 5: Node 25197 (Aggregate)
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=147532.8900
  - total_cost=147648.4400
- **Output:** st=868.96, rt=895.31

### Step 6: Node 25196 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=868.9566
  - st2=0.0000
  - startup_cost=148532.9700
  - total_cost=148652.7300
- **Output:** st=1109.22, rt=1111.84

### Step 7: Node 25195 (Aggregate) - ROOT
