...
```
Node 14972 (Aggregate) - ROOT
  Node 14973 (Gather Merge)
    Node 14974 (Sort)
          ...
          Node 14977 (Hash Join)
            Node 14978 (Nested Loop)
              Node 14979 (Hash Join)
                ...
                Node 14981 (Hash)
                  Node 14982 (Hash Join)
                    Node 14983 (Seq Scan) - LEAF
                    Node 14984 (Hash)
                      Node 14985 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 14972 | Aggregate | 1180.21 | 1194.14 | 1.2% | operator |
| 14973 | Gather Merge | 1179.80 | 1097.16 | 7.0% | operator |
...
| 14979 | Hash Join | 207.29 | 251.17 | 21.2% | operator |
...
| 14981 | Hash | 34.02 | 20.62 | 39.4% | operator |
| 14982 | Hash Join | 33.32 | 132.26 | 296.9% | operator |
| 14983 | Seq Scan | 31.83 | 23.03 | 27.6% | operator |
| 14984 | Hash | 0.17 | 23.66 | 14150.7% | operator |
| 14985 | Hash Join | 0.16 | 306.84 | 186995.1% | operator |
...
### Step 5: Node 14983 (Seq Scan) - LEAF
...
### Step 8: Node 14980 (Seq Scan) - LEAF
...
### Step 11: Node 14989 (Index Scan) - LEAF
...
### Step 12: Node 14991 (Seq Scan) - LEAF
...
### Step 13: Node 14978 (Nested Loop)
...
### Step 16: Node 14992 (Index Scan) - LEAF
...
### Step 17: Node 14994 (Seq Scan) - LEAF
...
### Step 18: Node 14976 (Nested Loop)
...
### Step 22: Node 14973 (Gather Merge)
...
### Step 23: Node 14972 (Aggregate) - ROOT
