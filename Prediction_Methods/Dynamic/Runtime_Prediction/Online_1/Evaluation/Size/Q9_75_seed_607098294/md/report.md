...
**Test Query:** Q9_75_seed_607098294
...
```
Node 18862 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18863 (Aggregate) [consumed]
    Node 18864 (Gather)
      Node 18865 (Aggregate)
        Node 18866 (Nested Loop)
          Node 18867 (Hash Join) [PATTERN: bb930825]
            Node 18868 (Seq Scan) [consumed] - LEAF
            Node 18869 (Hash) [consumed]
              Node 18870 (Hash Join) [consumed]
                Node 18871 (Hash Join)
                  Node 18872 (Nested Loop)
                    Node 18873 (Seq Scan) - LEAF
                    Node 18874 (Index Scan) - LEAF
                  Node 18875 (Hash)
                    Node 18876 (Seq Scan) - LEAF
                Node 18877 (Hash)
                  Node 18878 (Seq Scan) - LEAF
          Node 18879 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18867 | 18862, 18863, 18868, 18869, 18870 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18862 | 18863, 18867, 18868, 18869, 18870 |
...
|------|------|--------|-----------|-----|--------|
| 18862 | Sort | 1217.30 | 1045.10 | 14.1% | pattern |
| 18864 | Gather | 1216.18 | 960.51 | 21.0% | operator |
| 18865 | Aggregate | 1197.58 | 1141.32 | 4.7% | operator |
| 18866 | Nested Loop | 1174.05 | 1252.17 | 6.7% | operator |
| 18867 | Hash Join | 1002.33 | 134.80 | 86.6% | pattern |
| 18879 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18871 | Hash Join | 163.51 | 837.46 | 412.2% | operator |
| 18877 | Hash | 12.63 | 14.95 | 18.3% | operator |
| 18872 | Nested Loop | 157.92 | 1251.76 | 692.7% | operator |
| 18875 | Hash | 3.66 | 15.94 | 335.8% | operator |
| 18878 | Seq Scan | 12.62 | 2.94 | 76.7% | operator |
| 18873 | Seq Scan | 19.08 | 44.37 | 132.6% | operator |
| 18874 | Index Scan | 0.08 | -1.39 | 1926.9% | operator |
| 18876 | Seq Scan | 3.20 | 9.45 | 195.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 18873 (Seq Scan) - LEAF
...
### Step 2: Node 18874 (Index Scan) - LEAF
...
### Step 3: Node 18876 (Seq Scan) - LEAF
...
### Step 6: Node 18878 (Seq Scan) - LEAF
...
### Step 9: Node 18867 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18862, 18863, 18868, 18869, 18870
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18879 (Index Scan) - LEAF
...
### Step 11: Node 18866 (Nested Loop)
...
### Step 14: Node 18862 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18863, 18867, 18868, 18869, 18870
- **Input Features:**
