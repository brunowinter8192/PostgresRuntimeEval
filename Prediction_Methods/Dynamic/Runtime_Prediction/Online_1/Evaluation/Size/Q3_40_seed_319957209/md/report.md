...
**Test Query:** Q3_40_seed_319957209
...
```
Node 5191 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5192 (Sort) [consumed]
    Node 5193 (Aggregate) [consumed]
      Node 5194 (Gather) [consumed]
        Node 5195 (Nested Loop)
          Node 5196 (Hash Join) [PATTERN: 895c6e8c]
            Node 5197 (Seq Scan) [consumed] - LEAF
            Node 5198 (Hash) [consumed]
              Node 5199 (Seq Scan) - LEAF
          Node 5200 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5191 | 5192, 5193, 5194, 5196, 5197, 5198 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5196 | 5191, 5192, 5193, 5194, 5197, 5198 |
...
|------|------|--------|-----------|-----|--------|
| 5191 | Limit | 1176.68 | 1151.18 | 2.2% | pattern |
| 5195 | Nested Loop | 1138.84 | 1192.70 | 4.7% | operator |
| 5196 | Hash Join | 211.07 | 242.41 | 14.8% | pattern |
| 5200 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5199 | Seq Scan | 28.08 | 38.60 | 37.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5199 (Seq Scan) - LEAF
...
### Step 2: Node 5196 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5191, 5192, 5193, 5194, 5197, 5198
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46377
  - HashJoin_nt1=233820
  ...
  - HashJoin_total_cost=37334.4000
  - Hash_Inner_np=0
  - Hash_Inner_nt=12397
...
- **Output:** st=29.77, rt=242.41

### Step 3: Node 5200 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=72504.5600
- **Output:** st=121.48, rt=1192.70

### Step 5: Node 5191 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5192, 5193, 5194, 5196, 5197, 5198
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=311239
  - Aggregate_Outer_nt1=311239
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=109297.0500
  - Aggregate_Outer_total_cost=113187.5400
  - Gather_Outer_np=0
  - Gather_Outer_nt=311239
  - Gather_Outer_nt1=100400
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=104628.4600
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=311239
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=119913.3000
  - Limit_total_cost=119913.3200
  - Sort_Outer_np=0
  - Sort_Outer_nt=311239
  - Sort_Outer_nt1=311239
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=119913.3000
  - Sort_Outer_total_cost=120691.4000
