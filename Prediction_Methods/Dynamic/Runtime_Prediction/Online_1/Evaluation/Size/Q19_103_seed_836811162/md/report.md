...
**Test Query:** Q19_103_seed_836811162
...
```
Node 31241 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31242 (Gather) [consumed]
    Node 31243 (Aggregate) [consumed]
      Node 31244 (Hash Join) [consumed]
        Node 31245 (Seq Scan) - LEAF
        Node 31246 (Hash)
          Node 31247 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31241 | 31242, 31243, 31244 |
...
|------|------|--------|-----------|-----|--------|
| 31241 | Aggregate | 850.98 | 829.30 | 2.5% | pattern |
| 31245 | Seq Scan | 779.51 | 743.46 | 4.6% | operator |
| 31246 | Hash | 47.65 | 8.29 | 82.6% | operator |
| 31247 | Seq Scan | 47.54 | 23.76 | 50.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31247 (Seq Scan) - LEAF
...
### Step 2: Node 31245 (Seq Scan) - LEAF
...
### Step 4: Node 31241 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31242, 31243, 31244
- **Input Features:**
