...
```
Node 31241 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31242 (Gather) [consumed]
    Node 31243 (Aggregate) [consumed]
      Node 31244 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31241 | 31242, 31243 |
...
|------|------|--------|-----------|-----|--------|
| 31241 | Aggregate | 850.98 | 831.20 | 2.3% | pattern |
| 31244 | Hash Join | 829.22 | 766.06 | 7.6% | operator |
...
### Step 5: Node 31241 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31242, 31243
- **Input Features:**
