...
```
Node 26791 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26792 (Gather) [consumed]
    Node 26793 (Aggregate) [consumed]
      Node 26794 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26791 | 26792, 26793, 26794 |
...
|------|------|--------|-----------|-----|--------|
| 26791 | Aggregate | 810.15 | 857.12 | 5.8% | pattern |
...
### Step 4: Node 26791 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26792, 26793, 26794
- **Input Features:**
