...
```
Node 15386 (Aggregate) - ROOT
  Node 15387 (Gather Merge)
    Node 15388 (Sort)
          ...
          Node 15391 (Hash Join)
            Node 15392 (Nested Loop)
              Node 15393 (Hash Join)
                ...
                Node 15395 (Hash)
                  Node 15396 (Hash Join)
                    Node 15397 (Seq Scan) - LEAF
                    Node 15398 (Hash)
                      Node 15399 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 15386 | Aggregate | 1220.02 | 1184.88 | 2.9% | operator |
| 15387 | Gather Merge | 1219.60 | 1097.14 | 10.0% | operator |
...
| 15393 | Hash Join | 211.40 | 251.17 | 18.8% | operator |
...
| 15395 | Hash | 33.85 | 20.62 | 39.1% | operator |
| 15396 | Hash Join | 33.10 | 132.26 | 299.5% | operator |
| 15397 | Seq Scan | 31.59 | 23.03 | 27.1% | operator |
| 15398 | Hash | 0.20 | 23.66 | 11669.2% | operator |
| 15399 | Hash Join | 0.20 | 306.84 | 154867.7% | operator |
...
### Step 5: Node 15397 (Seq Scan) - LEAF
...
### Step 8: Node 15394 (Seq Scan) - LEAF
...
### Step 11: Node 15403 (Index Scan) - LEAF
...
### Step 12: Node 15405 (Seq Scan) - LEAF
...
### Step 13: Node 15392 (Nested Loop)
...
### Step 16: Node 15406 (Index Scan) - LEAF
...
### Step 17: Node 15408 (Seq Scan) - LEAF
...
### Step 18: Node 15390 (Nested Loop)
...
### Step 22: Node 15387 (Gather Merge)
...
### Step 23: Node 15386 (Aggregate) - ROOT
