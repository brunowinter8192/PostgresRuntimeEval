...
```
Node 18733 (Sort) - ROOT
  Node 18734 (Aggregate)
    Node 18735 (Gather)
      Node 18736 (Aggregate)
        Node 18737 (Hash Join)
          Node 18738 (Seq Scan) - LEAF
          Node 18739 (Hash)
            Node 18740 (Hash Join)
              Node 18741 (Seq Scan) - LEAF
              Node 18742 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 18733 | Sort | 1283.68 | 1119.70 | 12.8% | operator |
| 18734 | Aggregate | 1283.57 | 916.08 | 28.6% | operator |
| 18735 | Gather | 1282.79 | 962.11 | 25.0% | operator |
| 18736 | Aggregate | 1265.42 | 931.09 | 26.4% | operator |
| 18737 | Hash Join | 1237.21 | 569.62 | 54.0% | operator |
| 18738 | Seq Scan | 132.77 | 193.40 | 45.7% | operator |
| 18739 | Hash | 1042.50 | 110.13 | 89.4% | operator |
| 18740 | Hash Join | 1024.71 | 633.87 | 38.1% | operator |
| 18741 | Seq Scan | 695.11 | 509.93 | 26.6% | operator |
| 18742 | Hash | 213.45 | 48.26 | 77.4% | operator |
| 18743 | Hash Join | 210.82 | 924.58 | 338.6% | operator |
...
### Step 10: Node 18741 (Seq Scan) - LEAF
...
### Step 13: Node 18738 (Seq Scan) - LEAF
