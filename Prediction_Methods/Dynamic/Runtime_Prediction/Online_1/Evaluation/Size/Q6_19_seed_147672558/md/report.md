...
**Test Query:** Q6_19_seed_147672558
...
```
Node 10141 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10142 (Gather) [consumed]
    Node 10143 (Aggregate) [consumed]
      Node 10144 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10141 | 10142, 10143 |
...
|------|------|--------|-----------|-----|--------|
| 10141 | Aggregate | 806.94 | 850.05 | 5.3% | pattern |
| 10144 | Seq Scan | 787.06 | 748.53 | 4.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10144 (Seq Scan) - LEAF
...
### Step 2: Node 10141 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10142, 10143
- **Input Features:**
