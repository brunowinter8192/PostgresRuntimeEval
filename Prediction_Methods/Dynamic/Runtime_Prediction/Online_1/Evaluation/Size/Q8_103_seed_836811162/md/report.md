...
**Test Query:** Q8_103_seed_836811162
...
Node 13270 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 13271 (Gather Merge) [consumed]
    Node 13272 (Sort)
      Node 13273 (Hash Join)
        Node 13274 (Nested Loop)
          Node 13275 (Hash Join)
            Node 13276 (Nested Loop)
              Node 13277 (Hash Join)
                Node 13278 (Seq Scan) - LEAF
                Node 13279 (Hash) [PATTERN: 444761fb]
                  Node 13280 (Hash Join) [consumed]
                    Node 13281 (Seq Scan) [consumed] - LEAF
                    Node 13282 (Hash) [consumed]
                      Node 13283 (Hash Join) [consumed]
                        Node 13284 (Seq Scan) - LEAF
                        Node 13285 (Hash)
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 13279 | 13270, 13271, 13280, 13281, 13282, 13283 |
| Aggregate -> Gather Merge (Out | 2724c080 | 13270 | 13271, 13279, 13280, 13281, 13282, 13283 |
...
|------|------|--------|-----------|-----|--------|
| 13270 | Aggregate | 1212.07 | 1133.67 | 6.5% | pattern |
| 13272 | Sort | 1206.02 | 1046.21 | 13.3% | operator |
| 13273 | Hash Join | 1205.77 | 785.61 | 34.8% | operator |
| 13274 | Nested Loop | 1205.45 | 1198.29 | 0.6% | operator |
| 13291 | Hash | 0.02 | 13.72 | 85675.5% | operator |
| 13275 | Hash Join | 1201.59 | 785.60 | 34.6% | operator |
| 13290 | Index Scan | 0.01 | 12.42 | 206958.1% | operator |
| 13292 | Seq Scan | 0.01 | 6.51 | 65019.6% | operator |
| 13276 | Nested Loop | 1156.64 | 1198.29 | 3.6% | operator |
| 13288 | Hash | 40.67 | 19.97 | 50.9% | operator |
| 13277 | Hash Join | 217.54 | 251.67 | 15.7% | operator |
| 13287 | Index Scan | 0.04 | 2.88 | 6926.5% | operator |
| 13289 | Seq Scan | 40.61 | 48.89 | 20.4% | operator |
| 13278 | Seq Scan | 160.43 | 159.67 | 0.5% | operator |
| 13279 | Hash | 38.30 | 43.51 | 13.6% | pattern |
| 13284 | Seq Scan | 0.01 | 12.22 | 135732.7% | operator |
| 13285 | Hash | 0.20 | 18.14 | 8750.8% | operator |
| 13286 | Seq Scan | 0.20 | 23.36 | 11523.0% | operator |
...
### Step 2: Node 13284 (Seq Scan) - LEAF
...
### Step 4: Node 13278 (Seq Scan) - LEAF
...
### Step 5: Node 13279 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 13270, 13271, 13280, 13281, 13282, 13283
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 13287 (Index Scan) - LEAF
...
### Step 8: Node 13289 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - st1=186.0414
  - st2=19.9733
  - startup_cost=9919.6300
  - total_cost=70271.1000
- **Output:** st=113.62, rt=785.60

### Step 12: Node 13290 (Index Scan) - LEAF
...
### Step 13: Node 13292 (Seq Scan) - LEAF
...
### Step 14: Node 13274 (Nested Loop)
...
- **Input Features:**
  ...
  - total_cost=70491.9600
- **Output:** st=186.04, rt=1198.29

### Step 15: Node 13291 (Hash)
...
- **Input Features:**
  ...
  - st1=186.0414
  - st2=13.7224
  - startup_cost=9921.4700
  - total_cost=70497.5900
- **Output:** st=113.62, rt=785.61

### Step 17: Node 13272 (Sort)
...
- **Input Features:**
  ...
  - st1=113.6207
  - st2=0.0000
  - startup_cost=70532.3100
  - total_cost=70534.1300
- **Output:** st=1044.94, rt=1046.21

### Step 18: Node 13270 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 13271, 13279, 13280, 13281, 13282, 13283
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2263
  - Aggregate_nt1=2263
  ...
  - Aggregate_total_cost=71890.5900
  - GatherMerge_Outer_np=0
  - GatherMerge_Outer_nt=2263
  - GatherMerge_Outer_nt1=730
  ...
  - GatherMerge_Outer_total_cost=71800.0700
