...
Node 661 (Aggregate) - ROOT
  Node 662 (Gather Merge)
    Node 663 (Sort) [PATTERN: 1d35fb97]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 663 | 664 |
...
|------|------|--------|-----------|-----|--------|
| 661 | Aggregate | 944.38 | 1195.87 | 26.6% | operator |
| 662 | Gather Merge | 944.33 | 1165.90 | 23.5% | operator |
| 663 | Sort | 927.86 | 1200.43 | 29.4% | pattern |
...
### Step 2: Node 663 (Sort) - PATTERN ROOT
...
### Step 4: Node 661 (Aggregate) - ROOT
