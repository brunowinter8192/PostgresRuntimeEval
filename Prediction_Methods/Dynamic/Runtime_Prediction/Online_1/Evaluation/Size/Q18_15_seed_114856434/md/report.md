...
```
Node 29716 (Limit) - ROOT
  Node 29717 (Sort)
    Node 29718 (Aggregate)
      Node 29719 (Gather Merge)
        Node 29720 (Incremental Sort)
          Node 29721 (Nested Loop)
            Node 29722 (Merge Join)
              Node 29723 (Sort)
                Node 29724 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 29716 | Limit | 3063.79 | 1175.21 | 61.6% | operator |
| 29717 | Sort | 2948.11 | 1127.81 | 61.7% | operator |
| 29718 | Aggregate | 2948.06 | 1073.15 | 63.6% | operator |
| 29719 | Gather Merge | 2948.05 | 1073.95 | 63.6% | operator |
| 29720 | Incremental Sort | 2926.98 | 0.00 | 100.0% | operator |
| 29721 | Nested Loop | 2926.93 | 1111.34 | 62.0% | operator |
| 29722 | Merge Join | 2926.87 | 0.00 | 100.0% | operator |
| 29731 | Index Scan | 0.02 | 0.05 | 96.2% | operator |
| 29723 | Sort | 2857.03 | 1099.77 | 61.5% | operator |
| 29729 | Sort | 66.47 | 1074.66 | 1516.9% | operator |
| 29724 | Hash Join | 2857.02 | 686.33 | 76.0% | operator |
| 29730 | Seq Scan | 53.27 | 18.25 | 65.8% | operator |
| 29725 | Seq Scan | 203.16 | 170.37 | 16.1% | operator |
| 29726 | Hash | 2624.76 | 21.04 | 99.2% | operator |
| 29727 | Aggregate | 2624.73 | 1073.15 | 59.1% | operator |
| 29728 | Index Scan | 2121.68 | 0.00 | 100.0% | operator |
...
### Step 3: Node 29725 (Seq Scan) - LEAF
...
### Step 6: Node 29730 (Seq Scan) - LEAF
...
### Step 9: Node 29722 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29731 (Index Scan) - LEAF
...
### Step 11: Node 29721 (Nested Loop)
...
### Step 12: Node 29720 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29719 (Gather Merge)
