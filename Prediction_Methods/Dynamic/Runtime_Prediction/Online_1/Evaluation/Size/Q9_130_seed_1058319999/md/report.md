...
```
Node 17249 (Sort) - ROOT
  Node 17250 (Aggregate)
    Node 17251 (Gather)
      Node 17252 (Aggregate)
        Node 17253 (Nested Loop)
          Node 17254 (Hash Join)
            Node 17255 (Seq Scan) - LEAF
            Node 17256 (Hash)
              Node 17257 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 17249 | Sort | 1208.96 | 1119.51 | 7.4% | operator |
| 17250 | Aggregate | 1208.84 | 897.44 | 25.8% | operator |
...
| 17254 | Hash Join | 993.39 | 633.32 | 36.2% | operator |
| 17266 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17255 | Seq Scan | 716.71 | 509.93 | 28.9% | operator |
| 17256 | Hash | 179.81 | 47.91 | 73.4% | operator |
| 17257 | Hash Join | 177.87 | 924.43 | 419.7% | operator |
...
### Step 10: Node 17255 (Seq Scan) - LEAF
...
### Step 13: Node 17266 (Index Scan) - LEAF
...
### Step 14: Node 17253 (Nested Loop)
