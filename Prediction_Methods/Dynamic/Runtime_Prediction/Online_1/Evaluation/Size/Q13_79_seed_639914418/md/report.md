...
**Test Query:** Q13_79_seed_639914418
...
```
Node 26252 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26253 (Aggregate) [consumed]
    Node 26254 (Aggregate)
      Node 26255 (Hash Join) [PATTERN: 895c6e8c]
        Node 26256 (Seq Scan) [consumed] - LEAF
        Node 26257 (Hash) [consumed]
          Node 26258 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26252 | 26253, 26255, 26256, 26257 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26255 | 26252, 26253, 26256, 26257 |
...
|------|------|--------|-----------|-----|--------|
| 26252 | Sort | 929.03 | 1079.94 | 16.2% | pattern |
| 26254 | Aggregate | 922.96 | 999.76 | 8.3% | operator |
| 26255 | Hash Join | 716.65 | 470.31 | 34.4% | pattern |
| 26258 | Index Only Scan | 10.31 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26258 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26255 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26252, 26253, 26256, 26257
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 26252 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26253, 26255, 26256, 26257
- **Input Features:**
