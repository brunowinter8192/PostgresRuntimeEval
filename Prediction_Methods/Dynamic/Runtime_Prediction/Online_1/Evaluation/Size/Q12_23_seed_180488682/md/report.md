...
**Test Query:** Q12_23_seed_180488682
...
```
Node 24775 (Aggregate) - ROOT
  Node 24776 (Gather Merge)
    Node 24777 (Aggregate)
      Node 24778 (Sort)
        Node 24779 (Nested Loop)
          Node 24780 (Seq Scan) - LEAF
          Node 24781 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24775 | Aggregate | 1011.73 | 919.08 | 9.2% | operator |
| 24776 | Gather Merge | 1011.72 | 1111.84 | 9.9% | operator |
| 24777 | Aggregate | 990.98 | 895.32 | 9.7% | operator |
| 24778 | Sort | 990.25 | 1092.80 | 10.4% | operator |
| 24779 | Nested Loop | 989.25 | 1127.41 | 14.0% | operator |
| 24780 | Seq Scan | 845.34 | 745.19 | 11.8% | operator |
| 24781 | Index Scan | 0.03 | 0.07 | 156.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24780 (Seq Scan) - LEAF
...
### Step 2: Node 24781 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - st2=0.1246
  - startup_cost=0.4300
  - total_cost=147134.1500
- **Output:** st=38.33, rt=1127.41

### Step 4: Node 24778 (Sort)
...
- **Input Features:**
  ...
  - st1=38.3298
  - st2=0.0000
  - startup_cost=147491.9600
  - total_cost=147506.2900
- **Output:** st=1092.39, rt=1092.80

### Step 5: Node 24777 (Aggregate)
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=147491.9600
  - total_cost=147606.6700
- **Output:** st=868.98, rt=895.32

### Step 6: Node 24776 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=868.9850
  - st2=0.0000
  - startup_cost=148492.0400
  - total_cost=148610.9600
- **Output:** st=1109.22, rt=1111.84

### Step 7: Node 24775 (Aggregate) - ROOT
