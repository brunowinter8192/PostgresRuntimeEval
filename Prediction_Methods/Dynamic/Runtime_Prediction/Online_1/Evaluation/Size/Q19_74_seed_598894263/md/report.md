...
**Test Query:** Q19_74_seed_598894263
...
```
Node 32067 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 32068 (Gather) [consumed]
    Node 32069 (Aggregate) [consumed]
      Node 32070 (Hash Join) [consumed]
        Node 32071 (Seq Scan) - LEAF
        Node 32072 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 32067 | 32068, 32069, 32070 |
...
|------|------|--------|-----------|-----|--------|
| 32067 | Aggregate | 863.84 | 829.31 | 4.0% | pattern |
| 32071 | Seq Scan | 795.21 | 743.46 | 6.5% | operator |
| 32072 | Hash | 45.62 | 8.29 | 81.8% | operator |
| 32073 | Seq Scan | 45.35 | 23.76 | 47.6% | operator |
...
### Step 2: Node 32071 (Seq Scan) - LEAF
...
### Step 4: Node 32067 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 32068, 32069, 32070
- **Input Features:**
