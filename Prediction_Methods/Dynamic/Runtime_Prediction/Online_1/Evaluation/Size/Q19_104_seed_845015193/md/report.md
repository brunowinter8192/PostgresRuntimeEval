...
```
Node 31248 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31249 (Gather) [consumed]
    Node 31250 (Aggregate) [consumed]
      Node 31251 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31248 | 31249, 31250 |
...
|------|------|--------|-----------|-----|--------|
| 31248 | Aggregate | 827.40 | 831.20 | 0.5% | pattern |
| 31251 | Hash Join | 807.89 | 766.06 | 5.2% | operator |
...
### Step 5: Node 31248 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31249, 31250
- **Input Features:**
