...
**Test Query:** Q19_104_seed_845015193
...
```
Node 31248 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31249 (Gather) [consumed]
    Node 31250 (Aggregate) [consumed]
      Node 31251 (Hash Join) [consumed]
        Node 31252 (Seq Scan) - LEAF
        Node 31253 (Hash)
          Node 31254 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31248 | 31249, 31250, 31251 |
...
|------|------|--------|-----------|-----|--------|
| 31248 | Aggregate | 827.40 | 829.33 | 0.2% | pattern |
| 31252 | Seq Scan | 759.89 | 743.46 | 2.2% | operator |
| 31253 | Hash | 46.09 | 8.29 | 82.0% | operator |
| 31254 | Seq Scan | 45.94 | 23.76 | 48.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31254 (Seq Scan) - LEAF
...
### Step 2: Node 31252 (Seq Scan) - LEAF
...
### Step 4: Node 31248 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31249, 31250, 31251
- **Input Features:**
  ...
  - HashJoin_Outer_total_cost=156338.6200
