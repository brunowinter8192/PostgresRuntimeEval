...
```
Node 15547 (Aggregate) - ROOT
  Node 15548 (Gather Merge)
    Node 15549 (Sort)
          ...
          Node 15552 (Hash Join)
            Node 15553 (Nested Loop)
              Node 15554 (Hash Join)
                ...
                Node 15556 (Hash)
                  Node 15557 (Hash Join)
                    Node 15558 (Seq Scan) - LEAF
                    Node 15559 (Hash)
                      Node 15560 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 15547 | Aggregate | 1211.33 | 1191.81 | 1.6% | operator |
| 15548 | Gather Merge | 1210.93 | 1097.16 | 9.4% | operator |
...
| 15554 | Hash Join | 216.14 | 251.17 | 16.2% | operator |
...
| 15556 | Hash | 37.13 | 20.62 | 44.5% | operator |
| 15557 | Hash Join | 36.25 | 132.26 | 264.8% | operator |
| 15558 | Seq Scan | 34.81 | 23.03 | 33.8% | operator |
| 15559 | Hash | 0.18 | 23.66 | 12756.6% | operator |
| 15560 | Hash Join | 0.18 | 306.84 | 173253.6% | operator |
...
### Step 5: Node 15558 (Seq Scan) - LEAF
...
### Step 8: Node 15555 (Seq Scan) - LEAF
...
### Step 11: Node 15564 (Index Scan) - LEAF
...
### Step 12: Node 15566 (Seq Scan) - LEAF
...
### Step 13: Node 15553 (Nested Loop)
...
### Step 16: Node 15567 (Index Scan) - LEAF
...
### Step 17: Node 15569 (Seq Scan) - LEAF
...
### Step 18: Node 15551 (Nested Loop)
...
### Step 22: Node 15548 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1044.9433
  - st2=0.0000
  - startup_cost=71554.6800
  - total_cost=71844.4100
- **Output:** st=1093.45, rt=1097.16

### Step 23: Node 15547 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=71554.6800
  - total_cost=71941.5100
- **Output:** st=1162.42, rt=1191.81
