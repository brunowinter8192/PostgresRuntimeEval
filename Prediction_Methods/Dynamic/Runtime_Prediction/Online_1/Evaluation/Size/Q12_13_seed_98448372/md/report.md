...
**Test Query:** Q12_13_seed_98448372
...
```
Node 24621 (Aggregate) - ROOT
  Node 24622 (Gather Merge)
    Node 24623 (Aggregate)
      Node 24624 (Sort)
        Node 24625 (Nested Loop)
          Node 24626 (Seq Scan) - LEAF
          Node 24627 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24621 | Aggregate | 1032.47 | 919.06 | 11.0% | operator |
| 24622 | Gather Merge | 1032.46 | 1111.84 | 7.7% | operator |
| 24623 | Aggregate | 1014.25 | 895.30 | 11.7% | operator |
| 24624 | Sort | 1013.63 | 1092.82 | 7.8% | operator |
| 24625 | Nested Loop | 1012.76 | 1127.41 | 11.3% | operator |
| 24626 | Seq Scan | 879.91 | 745.19 | 15.3% | operator |
| 24627 | Index Scan | 0.03 | 0.07 | 187.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24626 (Seq Scan) - LEAF
...
### Step 2: Node 24627 (Index Scan) - LEAF
...
### Step 6: Node 24622 (Gather Merge)
...
### Step 7: Node 24621 (Aggregate) - ROOT
