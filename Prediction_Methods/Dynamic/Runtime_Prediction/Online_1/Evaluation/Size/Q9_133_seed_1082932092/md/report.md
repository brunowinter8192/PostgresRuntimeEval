    ...
    Node 17305 (Gather)
      Node 17306 (Aggregate)
        Node 17307 (Nested Loop)
          Node 17308 (Hash Join) [PATTERN: bb930825]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17308 | 17303, 17304, 17309, 17310, 17311 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17303 | 17304, 17308, 17309, 17310, 17311 |
...
|------|------|--------|-----------|-----|--------|
| 17303 | Sort | 1188.08 | 1045.86 | 12.0% | pattern |
| 17305 | Gather | 1187.28 | 964.48 | 18.8% | operator |
| 17306 | Aggregate | 1166.96 | 1075.81 | 7.8% | operator |
| 17307 | Nested Loop | 1142.22 | 1252.17 | 9.6% | operator |
| 17308 | Hash Join | 968.30 | 134.80 | 86.1% | pattern |
| 17320 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17312 | Hash Join | 156.10 | 837.66 | 436.6% | operator |
| 17318 | Hash | 12.92 | 14.95 | 15.7% | operator |
| 17313 | Nested Loop | 149.66 | 1251.77 | 736.4% | operator |
| 17316 | Hash | 4.19 | 15.94 | 280.7% | operator |
| 17319 | Seq Scan | 12.91 | 2.94 | 77.3% | operator |
| 17314 | Seq Scan | 20.11 | 43.89 | 118.3% | operator |
| 17315 | Index Scan | 0.07 | -1.39 | 2055.6% | operator |
| 17317 | Seq Scan | 3.58 | 9.45 | 163.5% | operator |
...
### Step 9: Node 17308 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17303, 17304, 17309, 17310, 17311
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 11: Node 17307 (Nested Loop)
...
### Step 14: Node 17303 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17304, 17308, 17309, 17310, 17311
- **Input Features:**
