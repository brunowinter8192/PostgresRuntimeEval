...
**Test Query:** Q6_97_seed_787586976
...
```
Node 10485 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10486 (Gather) [consumed]
    Node 10487 (Aggregate) [consumed]
      Node 10488 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10485 | 10486, 10487 |
...
|------|------|--------|-----------|-----|--------|
| 10485 | Aggregate | 787.14 | 849.98 | 8.0% | pattern |
| 10488 | Seq Scan | 766.87 | 748.49 | 2.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10488 (Seq Scan) - LEAF
...
### Step 2: Node 10485 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10486, 10487
- **Input Features:**
