...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4811 | 4812, 4813, 4814 |
...
| 4815 | Nested Loop | 1144.37 | 1192.81 | 4.2% | operator |
| 4816 | Hash Join | 207.63 | 230.52 | 11.0% | operator |
| 4820 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4817 | Seq Scan | 155.81 | 163.30 | 4.8% | operator |
| 4818 | Hash | 29.33 | 17.75 | 39.5% | operator |
...
### Step 2: Node 4817 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37335.4200
- **Output:** st=27.17, rt=230.52

### Step 5: Node 4820 (Index Scan) - LEAF
...
- **Output:** st=121.51, rt=1192.81

### Step 7: Node 4811 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4812, 4813, 4814
- **Input Features:**
