...
**Test Query:** Q3_142_seed_1156768371
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4811 | 4812, 4813, 4814, 4816, 4817, 4818 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4816 | 4811, 4812, 4813, 4814, 4817, 4818 |
...
|------|------|--------|-----------|-----|--------|
| 4811 | Limit | 1179.50 | 1151.18 | 2.4% | pattern |
| 4815 | Nested Loop | 1144.37 | 1192.90 | 4.2% | operator |
| 4816 | Hash Join | 207.63 | 242.45 | 16.8% | pattern |
| 4820 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4819 | Seq Scan | 28.70 | 38.57 | 34.4% | operator |
...
- **Consumes:** Nodes 4811, 4812, 4813, 4814, 4817, 4818
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46685
  - HashJoin_nt1=233820
...
- **Output:** st=29.76, rt=242.45

### Step 3: Node 4820 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=72739.1600
- **Output:** st=121.65, rt=1192.90

### Step 5: Node 4811 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4812, 4813, 4814, 4816, 4817, 4818
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=313300
  - Aggregate_Outer_nt1=313300
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=109768.6600
  - Aggregate_Outer_total_cost=113684.9100
  - Gather_Outer_np=0
  - Gather_Outer_nt=313300
  - Gather_Outer_nt1=101065
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105069.1600
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=313300
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=120455.2100
  - Limit_total_cost=120455.2400
  - Sort_Outer_np=0
  - Sort_Outer_nt=313300
  - Sort_Outer_nt1=313300
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=120455.2100
  - Sort_Outer_total_cost=121238.4600
