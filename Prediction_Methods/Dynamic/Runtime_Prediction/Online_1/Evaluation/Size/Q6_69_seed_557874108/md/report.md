...
**Test Query:** Q6_69_seed_557874108
...
```
Node 10361 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10362 (Gather) [consumed]
    Node 10363 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10361 | 10362, 10363 |
...
|------|------|--------|-----------|-----|--------|
| 10361 | Aggregate | 737.92 | 849.99 | 15.2% | pattern |
| 10364 | Seq Scan | 715.18 | 748.50 | 4.7% | operator |
...
### Step 2: Node 10361 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10362, 10363
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=22731
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=32
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=139719.1200
  - Aggregate_Outer_total_cost=139719.1400
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=140719.6600
  - Aggregate_total_cost=140719.6700
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=140719.1200
  - Gather_Outer_total_cost=140719.6400
