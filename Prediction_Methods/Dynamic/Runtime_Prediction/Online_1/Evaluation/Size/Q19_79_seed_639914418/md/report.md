...
```
Node 32102 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 32103 (Gather) [consumed]
    Node 32104 (Aggregate) [consumed]
      Node 32105 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 32102 | 32103, 32104 |
...
|------|------|--------|-----------|-----|--------|
| 32102 | Aggregate | 833.62 | 831.20 | 0.3% | pattern |
| 32105 | Hash Join | 812.42 | 766.05 | 5.7% | operator |
...
### Step 5: Node 32102 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 32103, 32104
- **Input Features:**
