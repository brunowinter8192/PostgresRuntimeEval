...
**Test Query:** Q19_79_seed_639914418
**Timestamp:** 2026-01-18 20:41:35
...
```
Node 32102 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 32103 (Gather) [consumed]
    Node 32104 (Aggregate) [consumed]
      Node 32105 (Hash Join) [consumed]
        Node 32106 (Seq Scan) - LEAF
        Node 32107 (Hash)
          Node 32108 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 32102 | 32103, 32104, 32105 |
...
|------|------|--------|-----------|-----|--------|
| 32102 | Aggregate | 833.62 | 829.31 | 0.5% | pattern |
| 32106 | Seq Scan | 762.64 | 743.46 | 2.5% | operator |
| 32107 | Hash | 48.16 | 8.29 | 82.8% | operator |
| 32108 | Seq Scan | 48.05 | 23.76 | 50.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 32108 (Seq Scan) - LEAF
...
### Step 2: Node 32106 (Seq Scan) - LEAF
...
### Step 4: Node 32102 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 32103, 32104, 32105
- **Input Features:**
  ...
  - Aggregate_Outer_startup_cost=156338.6100
  - Aggregate_Outer_total_cost=156338.6200
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=157339.1500
  - Aggregate_total_cost=157339.1600
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=157338.6100
  - Gather_Outer_total_cost=157339.1200
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=23
  - HashJoin_Outer_nt1=22449
  ...
  - HashJoin_Outer_total_cost=156338.4400
