...
**Test Query:** Q5_130_seed_1058319999
**Timestamp:** 2026-01-18 16:53:12
...
```
Node 7561 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 7562 (Aggregate) [consumed]
    Node 7563 (Gather Merge) [consumed]
      Node 7564 (Aggregate)
        Node 7565 (Sort) [PATTERN: 3e2d5a00]
          Node 7566 (Hash Join) [consumed]
            Node 7567 (Nested Loop)
              Node 7568 (Hash Join)
                Node 7569 (Seq Scan) - LEAF
                Node 7570 (Hash) [PATTERN: 444761fb]
                  Node 7571 (Hash Join) [consumed]
                    Node 7572 (Seq Scan) [consumed] - LEAF
                    Node 7573 (Hash) [consumed]
                      Node 7574 (Hash Join) [consumed]
                        Node 7575 (Seq Scan) - LEAF
                        Node 7576 (Hash)
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 7570 | 7561, 7562, 7563, 7565, 7566, 7571, 7572, 7573, 7574 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 7561 | 7562, 7563, 7565, 7566, 7570, 7571, 7572, 7573, 7574 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 7565 | 7561, 7562, 7563, 7566, 7570, 7571, 7572, 7573, 7574 |
...
|------|------|--------|-----------|-----|--------|
| 7561 | Sort | 1055.16 | 2934.42 | 178.1% | pattern |
| 7564 | Aggregate | 1051.06 | 1128.78 | 7.4% | operator |
| 7565 | Sort | 1050.80 | 1835.92 | 74.7% | pattern |
| 7567 | Nested Loop | 1038.70 | 1188.42 | 14.4% | operator |
| 7579 | Hash | 3.52 | 18.67 | 431.0% | operator |
| 7568 | Hash Join | 218.78 | 253.07 | 15.7% | operator |
| 7578 | Index Scan | 0.07 | -0.22 | 401.4% | operator |
| 7580 | Seq Scan | 3.00 | 12.36 | 311.4% | operator |
| 7569 | Seq Scan | 169.20 | 159.81 | 5.6% | operator |
| 7570 | Hash | 36.80 | 46.85 | 27.3% | pattern |
| 7575 | Seq Scan | 0.01 | 11.81 | 131103.0% | operator |
| 7576 | Hash | 0.05 | 21.05 | 38887.5% | operator |
| 7577 | Seq Scan | 0.05 | 22.93 | 43170.4% | operator |
...
### Step 2: Node 7575 (Seq Scan) - LEAF
...
### Step 4: Node 7569 (Seq Scan) - LEAF
...
### Step 5: Node 7570 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 7561, 7562, 7563, 7565, 7566, 7571, 7572, 7573, 7574
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 7578 (Index Scan) - LEAF
...
### Step 8: Node 7580 (Seq Scan) - LEAF
...
- **Output:** st=100.25, rt=1188.42

### Step 10: Node 7579 (Hash)
...
### Step 11: Node 7565 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 7561, 7562, 7563, 7566, 7570, 7571, 7572, 7573, 7574
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=2350
  - HashJoin_Outer_nt1=58750
  ...
  - HashJoin_Outer_total_cost=56784.6700
  - Sort_np=0
  - Sort_nt=2350
  - Sort_nt1=2350
  - Sort_nt2=0
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=56916.2500
  - Sort_total_cost=56922.1300
- **Output:** st=1835.90, rt=1835.92

### Step 12: Node 7564 (Aggregate)
...
- **Output:** st=1065.14, rt=1128.78

### Step 13: Node 7561 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 7562, 7563, 7565, 7566, 7570, 7571, 7572, 7573, 7574
- **Input Features:**
  ...
  - GatherMerge_Outer_startup_cost=57916.2900
  - GatherMerge_Outer_total_cost=57954.7900
  - Sort_np=0
  - Sort_nt=25
  - Sort_nt1=25
  - Sort_nt2=0
