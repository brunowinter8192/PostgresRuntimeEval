...
**Test Query:** Q9_78_seed_631710387
...
```
Node 18916 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18917 (Aggregate) [consumed]
    Node 18918 (Gather)
      Node 18919 (Aggregate)
        Node 18920 (Nested Loop)
          Node 18921 (Hash Join) [PATTERN: bb930825]
            Node 18922 (Seq Scan) [consumed] - LEAF
            Node 18923 (Hash) [consumed]
              Node 18924 (Hash Join) [consumed]
                Node 18925 (Hash Join)
                  Node 18926 (Nested Loop)
                    Node 18927 (Seq Scan) - LEAF
                    Node 18928 (Index Scan) - LEAF
                  Node 18929 (Hash)
                    Node 18930 (Seq Scan) - LEAF
                Node 18931 (Hash)
                  Node 18932 (Seq Scan) - LEAF
          Node 18933 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18921 | 18916, 18917, 18922, 18923, 18924 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18916 | 18917, 18921, 18922, 18923, 18924 |
...
|------|------|--------|-----------|-----|--------|
| 18916 | Sort | 1206.15 | 1044.54 | 13.4% | pattern |
| 18918 | Gather | 1204.85 | 965.01 | 19.9% | operator |
| 18919 | Aggregate | 1185.05 | 1129.15 | 4.7% | operator |
| 18920 | Nested Loop | 1161.10 | 1252.17 | 7.8% | operator |
| 18921 | Hash Join | 989.56 | 134.80 | 86.4% | pattern |
| 18933 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18925 | Hash Join | 164.87 | 837.52 | 408.0% | operator |
| 18931 | Hash | 13.17 | 14.95 | 13.5% | operator |
| 18926 | Nested Loop | 159.31 | 1251.76 | 685.8% | operator |
| 18929 | Hash | 3.19 | 15.94 | 400.5% | operator |
| 18932 | Seq Scan | 13.16 | 2.94 | 77.7% | operator |
| 18927 | Seq Scan | 21.04 | 44.23 | 110.2% | operator |
| 18928 | Index Scan | 0.08 | -1.39 | 1926.9% | operator |
| 18930 | Seq Scan | 2.63 | 9.45 | 259.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 18927 (Seq Scan) - LEAF
...
### Step 2: Node 18928 (Index Scan) - LEAF
...
### Step 3: Node 18930 (Seq Scan) - LEAF
...
### Step 6: Node 18932 (Seq Scan) - LEAF
...
### Step 9: Node 18921 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18916, 18917, 18922, 18923, 18924
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18933 (Index Scan) - LEAF
...
### Step 11: Node 18920 (Nested Loop)
...
### Step 14: Node 18916 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18917, 18921, 18922, 18923, 18924
- **Input Features:**
