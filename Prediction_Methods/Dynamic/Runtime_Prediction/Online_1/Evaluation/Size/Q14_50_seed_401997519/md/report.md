...
```
Node 27085 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27086 (Gather) [consumed]
    Node 27087 (Aggregate) [consumed]
      Node 27088 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27085 | 27086, 27087, 27088 |
...
|------|------|--------|-----------|-----|--------|
| 27085 | Aggregate | 812.99 | 857.14 | 5.4% | pattern |
...
### Step 4: Node 27085 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27086, 27087, 27088
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=15960
  - HashJoin_Outer_nt1=15960
  ...
  - HashJoin_Outer_total_cost=136648.5400
