...
**Test Query:** Q1_144_seed_1173176433
...
```
Node 241 (Aggregate) - ROOT
  Node 242 (Gather Merge)
    Node 243 (Sort) [PATTERN: 1d35fb97]
      Node 244 (Aggregate) [consumed]
        Node 245 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 243 | 244 |
...
|------|------|--------|-----------|-----|--------|
| 241 | Aggregate | 929.66 | 1196.01 | 28.7% | operator |
| 242 | Gather Merge | 929.59 | 1165.94 | 25.4% | operator |
| 243 | Sort | 910.59 | 1200.99 | 31.9% | pattern |
| 245 | Seq Scan | 491.71 | 678.42 | 38.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 245 (Seq Scan) - LEAF
...
### Step 2: Node 243 (Sort) - PATTERN ROOT
...
### Step 4: Node 241 (Aggregate) - ROOT
