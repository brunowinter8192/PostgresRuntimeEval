...
**Test Query:** Q13_55_seed_443017674
...
```
Node 26070 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26071 (Aggregate) [consumed]
    Node 26072 (Aggregate)
      Node 26073 (Hash Join) [PATTERN: 895c6e8c]
        Node 26074 (Seq Scan) [consumed] - LEAF
        Node 26075 (Hash) [consumed]
          Node 26076 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26070 | 26071, 26073, 26074, 26075 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26073 | 26070, 26071, 26074, 26075 |
...
|------|------|--------|-----------|-----|--------|
| 26070 | Sort | 908.78 | 1079.94 | 18.8% | pattern |
| 26072 | Aggregate | 902.84 | 999.76 | 10.7% | operator |
| 26073 | Hash Join | 699.86 | 470.31 | 32.8% | pattern |
| 26076 | Index Only Scan | 9.27 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26076 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26073 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26070, 26071, 26074, 26075
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 26070 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26071, 26073, 26074, 26075
- **Input Features:**
