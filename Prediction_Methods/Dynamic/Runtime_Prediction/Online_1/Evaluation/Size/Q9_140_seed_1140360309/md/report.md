...
**Test Query:** Q9_140_seed_1140360309
...
```
Node 17447 (Sort) - ROOT
  Node 17448 (Aggregate)
    Node 17449 (Gather)
      Node 17450 (Aggregate)
        Node 17451 (Nested Loop)
          Node 17452 (Hash Join)
            Node 17453 (Seq Scan) - LEAF
            Node 17454 (Hash)
              Node 17455 (Hash Join)
                Node 17456 (Hash Join)
                  Node 17457 (Nested Loop)
                    Node 17458 (Seq Scan) - LEAF
                    Node 17459 (Index Scan) - LEAF
                  Node 17460 (Hash)
                    Node 17461 (Seq Scan) - LEAF
                Node 17462 (Hash)
                  Node 17463 (Seq Scan) - LEAF
          Node 17464 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 17447 | Sort | 1213.72 | 1119.51 | 7.8% | operator |
| 17448 | Aggregate | 1213.60 | 897.44 | 26.1% | operator |
| 17449 | Gather | 1212.69 | 964.64 | 20.5% | operator |
| 17450 | Aggregate | 1191.12 | 1095.61 | 8.0% | operator |
| 17451 | Nested Loop | 1165.69 | 1252.17 | 7.4% | operator |
| 17452 | Hash Join | 986.35 | 633.32 | 35.8% | operator |
| 17464 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17453 | Seq Scan | 707.79 | 509.93 | 28.0% | operator |
| 17454 | Hash | 183.42 | 47.91 | 73.9% | operator |
| 17455 | Hash Join | 181.68 | 924.43 | 408.8% | operator |
| 17456 | Hash Join | 167.15 | 837.61 | 401.1% | operator |
| 17462 | Hash | 13.88 | 14.95 | 7.7% | operator |
| 17457 | Nested Loop | 160.02 | 1251.77 | 682.3% | operator |
| 17460 | Hash | 4.76 | 15.94 | 234.8% | operator |
| 17463 | Seq Scan | 13.87 | 2.94 | 78.8% | operator |
| 17458 | Seq Scan | 21.13 | 44.03 | 108.4% | operator |
| 17459 | Index Scan | 0.07 | -1.39 | 1951.3% | operator |
| 17461 | Seq Scan | 4.13 | 9.45 | 128.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 17458 (Seq Scan) - LEAF
...
### Step 2: Node 17459 (Index Scan) - LEAF
...
### Step 3: Node 17461 (Seq Scan) - LEAF
...
### Step 6: Node 17463 (Seq Scan) - LEAF
...
### Step 10: Node 17453 (Seq Scan) - LEAF
...
### Step 13: Node 17464 (Index Scan) - LEAF
...
### Step 14: Node 17451 (Nested Loop)
