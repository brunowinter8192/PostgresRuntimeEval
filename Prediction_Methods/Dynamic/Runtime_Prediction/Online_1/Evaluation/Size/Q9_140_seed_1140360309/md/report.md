...
```
Node 17447 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 17448 (Aggregate) [consumed]
    Node 17449 (Gather)
      Node 17450 (Aggregate)
        Node 17451 (Nested Loop)
          Node 17452 (Hash Join) [PATTERN: bb930825]
            Node 17453 (Seq Scan) [consumed] - LEAF
            Node 17454 (Hash) [consumed]
              Node 17455 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17452 | 17447, 17448, 17453, 17454, 17455 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17447 | 17448, 17452, 17453, 17454, 17455 |
...
|------|------|--------|-----------|-----|--------|
| 17447 | Sort | 1213.72 | 1045.32 | 13.9% | pattern |
...
| 17452 | Hash Join | 986.35 | 134.80 | 86.3% | pattern |
...
### Step 9: Node 17452 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17447, 17448, 17453, 17454, 17455
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17464 (Index Scan) - LEAF
...
### Step 11: Node 17451 (Nested Loop)
...
### Step 14: Node 17447 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17448, 17452, 17453, 17454, 17455
- **Input Features:**
