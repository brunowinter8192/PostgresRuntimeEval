...
**Test Query:** Q19_60_seed_484037829
...
```
Node 31962 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31963 (Gather) [consumed]
    Node 31964 (Aggregate) [consumed]
      Node 31965 (Hash Join) [consumed]
        Node 31966 (Seq Scan) - LEAF
        Node 31967 (Hash)
          Node 31968 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31962 | 31963, 31964, 31965 |
...
|------|------|--------|-----------|-----|--------|
| 31962 | Aggregate | 861.55 | 829.29 | 3.7% | pattern |
| 31966 | Seq Scan | 793.60 | 743.46 | 6.3% | operator |
| 31967 | Hash | 43.97 | 8.29 | 81.2% | operator |
| 31968 | Seq Scan | 43.85 | 23.76 | 45.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31968 (Seq Scan) - LEAF
...
### Step 2: Node 31966 (Seq Scan) - LEAF
...
### Step 4: Node 31962 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31963, 31964, 31965
- **Input Features:**
