...
**Test Query:** Q12_1_seed_0101000000
...
```
Node 24747 (Aggregate) - ROOT
  Node 24748 (Gather Merge)
    Node 24749 (Aggregate)
      Node 24750 (Sort)
        Node 24751 (Nested Loop)
          Node 24752 (Seq Scan) - LEAF
          Node 24753 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24747 | Aggregate | 1007.79 | 919.07 | 8.8% | operator |
| 24748 | Gather Merge | 1007.77 | 1111.84 | 10.3% | operator |
| 24749 | Aggregate | 990.08 | 895.31 | 9.6% | operator |
| 24750 | Sort | 989.46 | 1092.81 | 10.4% | operator |
| 24751 | Nested Loop | 988.52 | 1127.41 | 14.0% | operator |
| 24752 | Seq Scan | 850.46 | 745.19 | 12.4% | operator |
| 24753 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24752 (Seq Scan) - LEAF
...
### Step 2: Node 24753 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - st2=0.1246
  - startup_cost=0.4300
  - total_cost=147154.8200
- **Output:** st=38.33, rt=1127.41

### Step 4: Node 24750 (Sort)
...
- **Input Features:**
  ...
  - st1=38.3272
  - st2=0.0000
  - startup_cost=147514.2300
  - total_cost=147528.6200
- **Output:** st=1092.39, rt=1092.81

### Step 5: Node 24749 (Aggregate)
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=147514.2300
  - total_cost=147629.4000
- **Output:** st=868.97, rt=895.31

### Step 6: Node 24748 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=868.9696
  - st2=0.0000
  - startup_cost=148514.3100
  - total_cost=148633.7000
- **Output:** st=1109.22, rt=1111.84

### Step 7: Node 24747 (Aggregate) - ROOT
