...
```
Node 15363 (Aggregate) - ROOT
  Node 15364 (Gather Merge)
    Node 15365 (Sort)
          ...
          Node 15368 (Hash Join)
            Node 15369 (Nested Loop)
              Node 15370 (Hash Join)
                ...
                Node 15372 (Hash)
                  Node 15373 (Hash Join)
                    Node 15374 (Seq Scan) - LEAF
                    Node 15375 (Hash)
                      Node 15376 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 15363 | Aggregate | 1235.95 | 1181.34 | 4.4% | operator |
| 15364 | Gather Merge | 1235.51 | 1097.17 | 11.2% | operator |
...
| 15370 | Hash Join | 214.29 | 251.17 | 17.2% | operator |
...
| 15372 | Hash | 35.88 | 20.62 | 42.5% | operator |
| 15373 | Hash Join | 35.33 | 132.26 | 274.3% | operator |
| 15374 | Seq Scan | 33.95 | 23.03 | 32.2% | operator |
| 15375 | Hash | 0.09 | 23.66 | 27407.1% | operator |
| 15376 | Hash Join | 0.08 | 306.84 | 374090.2% | operator |
...
### Step 5: Node 15374 (Seq Scan) - LEAF
...
### Step 8: Node 15371 (Seq Scan) - LEAF
...
### Step 11: Node 15380 (Index Scan) - LEAF
...
### Step 12: Node 15382 (Seq Scan) - LEAF
...
### Step 13: Node 15369 (Nested Loop)
...
### Step 16: Node 15383 (Index Scan) - LEAF
...
### Step 17: Node 15385 (Seq Scan) - LEAF
...
### Step 18: Node 15367 (Nested Loop)
...
### Step 22: Node 15364 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1044.9462
  - st2=0.0000
  - startup_cost=71568.4500
  - total_cost=71871.6700
- **Output:** st=1093.46, rt=1097.17

### Step 23: Node 15363 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=71568.4500
  - total_cost=71971.0500
- **Output:** st=1157.06, rt=1181.34
