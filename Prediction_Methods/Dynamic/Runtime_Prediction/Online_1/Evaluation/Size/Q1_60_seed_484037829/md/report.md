...
**Test Query:** Q1_60_seed_484037829
...
```
Node 531 (Aggregate) - ROOT
  Node 532 (Gather Merge)
    Node 533 (Sort) [PATTERN: 1d35fb97]
      Node 534 (Aggregate) [consumed]
        Node 535 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 533 | 534 |
...
|------|------|--------|-----------|-----|--------|
| 531 | Aggregate | 999.48 | 1195.93 | 19.7% | operator |
| 532 | Gather Merge | 999.44 | 1165.92 | 16.7% | operator |
| 533 | Sort | 981.16 | 1200.67 | 22.4% | pattern |
| 535 | Seq Scan | 582.52 | 679.62 | 16.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 535 (Seq Scan) - LEAF
...
### Step 2: Node 533 (Sort) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Aggregate_Outer_nt1=1184968
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=236
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=169076.9200
  - Aggregate_Outer_total_cost=169077.0500
  - Sort_np=0
  - Sort_nt=6
  - Sort_nt1=6
  - Sort_nt2=0
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=169077.1300
  - Sort_total_cost=169077.1500
- **Output:** st=1196.58, rt=1200.67

### Step 3: Node 532 (Gather Merge)
...
### Step 4: Node 531 (Aggregate) - ROOT
