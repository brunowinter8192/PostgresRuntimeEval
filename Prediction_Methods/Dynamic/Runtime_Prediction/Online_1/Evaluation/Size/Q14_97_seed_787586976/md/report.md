...
**Test Query:** Q14_97_seed_787586976
...
```
Node 27442 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27443 (Gather) [consumed]
    Node 27444 (Aggregate) [consumed]
      Node 27445 (Hash Join) [consumed]
        Node 27446 (Seq Scan) - LEAF
        Node 27447 (Hash)
          Node 27448 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27442 | 27443, 27444, 27445 |
...
|------|------|--------|-----------|-----|--------|
| 27442 | Aggregate | 856.64 | 857.13 | 0.1% | pattern |
| 27446 | Seq Scan | 782.25 | 758.50 | 3.0% | operator |
| 27447 | Hash | 47.25 | 9.38 | 80.2% | operator |
| 27448 | Seq Scan | 42.70 | 12.70 | 70.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27448 (Seq Scan) - LEAF
...
### Step 2: Node 27446 (Seq Scan) - LEAF
...
### Step 4: Node 27442 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27443, 27444, 27445
- **Input Features:**
