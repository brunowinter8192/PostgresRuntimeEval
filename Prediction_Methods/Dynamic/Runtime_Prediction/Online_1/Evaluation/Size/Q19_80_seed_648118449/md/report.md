...
```
Node 32116 (Aggregate) [PATTERN: efde8b38] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 32116 | 32117, 32118, 32119 |
...
|------|------|--------|-----------|-----|--------|
| 32116 | Aggregate | 834.53 | 829.31 | 0.6% | pattern |
| 32120 | Seq Scan | 763.51 | 743.46 | 2.6% | operator |
| 32121 | Hash | 46.41 | 8.29 | 82.1% | operator |
| 32122 | Seq Scan | 46.27 | 23.76 | 48.6% | operator |
...
### Step 4: Node 32116 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 32117, 32118, 32119
- **Input Features:**
