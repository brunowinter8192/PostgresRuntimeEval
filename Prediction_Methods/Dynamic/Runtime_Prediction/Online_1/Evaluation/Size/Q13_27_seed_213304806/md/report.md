...
```
Node 25853 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25854 (Aggregate) [consumed]
    Node 25855 (Aggregate)
      Node 25856 (Hash Join) [PATTERN: 895c6e8c]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25853 | 25854, 25856, 25857, 25858 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25856 | 25853, 25854, 25857, 25858 |
...
|------|------|--------|-----------|-----|--------|
| 25853 | Sort | 899.00 | 1079.91 | 20.1% | pattern |
| 25855 | Aggregate | 892.91 | 998.54 | 11.8% | operator |
| 25856 | Hash Join | 680.36 | 470.31 | 30.9% | pattern |
| 25859 | Index Only Scan | 10.15 | 0.00 | 100.0% | operator |
...
### Step 2: Node 25856 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25853, 25854, 25857, 25858
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1469940
...
### Step 4: Node 25853 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25854, 25856, 25857, 25858
- **Input Features:**
