...
```
Node 27246 (Aggregate) [PATTERN: efde8b38] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27246 | 27247, 27248, 27249 |
...
|------|------|--------|-----------|-----|--------|
| 27246 | Aggregate | 830.86 | 857.13 | 3.2% | pattern |
| 27250 | Seq Scan | 755.04 | 758.49 | 0.5% | operator |
| 27251 | Hash | 45.26 | 9.38 | 79.3% | operator |
| 27252 | Seq Scan | 39.29 | 12.70 | 67.7% | operator |
...
### Step 4: Node 27246 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27247, 27248, 27249
- **Input Features:**
