...
Node 41 (Aggregate) - ROOT
  Node 42 (Gather Merge)
    Node 43 (Sort) [PATTERN: 1d35fb97]
      Node 44 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 43 | 44 |
...
|------|------|--------|-----------|-----|--------|
| 41 | Aggregate | 981.55 | 1195.80 | 21.8% | operator |
| 42 | Gather Merge | 981.47 | 1165.88 | 18.8% | operator |
| 43 | Sort | 962.54 | 1200.16 | 24.7% | pattern |
...
### Step 2: Node 43 (Sort) - PATTERN ROOT
