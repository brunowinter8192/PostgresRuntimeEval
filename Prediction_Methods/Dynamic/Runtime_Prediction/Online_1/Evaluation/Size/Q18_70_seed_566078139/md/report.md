...
**Test Query:** Q18_70_seed_566078139
...
```
Node 30692 (Limit) - ROOT
  Node 30693 (Sort)
    Node 30694 (Aggregate)
      Node 30695 (Gather Merge)
        Node 30696 (Incremental Sort)
          Node 30697 (Nested Loop)
            Node 30698 (Merge Join)
              Node 30699 (Sort)
                Node 30700 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30701 (Seq Scan) [consumed] - LEAF
                  Node 30702 (Hash) [consumed]
                    Node 30703 (Aggregate)
                      Node 30704 (Index Scan) - LEAF
              Node 30705 (Sort)
                Node 30706 (Seq Scan) - LEAF
            Node 30707 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30700 | 30701, 30702 |
...
|------|------|--------|-----------|-----|--------|
| 30692 | Limit | 3061.97 | 1175.21 | 61.6% | operator |
| 30693 | Sort | 2943.61 | 1127.81 | 61.7% | operator |
| 30694 | Aggregate | 2943.57 | 1073.15 | 63.5% | operator |
| 30695 | Gather Merge | 2943.55 | 1073.95 | 63.5% | operator |
| 30696 | Incremental Sort | 2921.98 | 0.00 | 100.0% | operator |
| 30697 | Nested Loop | 2921.92 | 1111.34 | 62.0% | operator |
| 30698 | Merge Join | 2921.86 | 0.00 | 100.0% | operator |
| 30707 | Index Scan | 0.02 | 0.05 | 114.9% | operator |
| 30699 | Sort | 2850.79 | 1095.58 | 61.6% | operator |
| 30705 | Sort | 68.12 | 1074.66 | 1477.6% | operator |
| 30700 | Hash Join | 2850.78 | 471.07 | 83.5% | pattern |
| 30706 | Seq Scan | 53.79 | 18.25 | 66.1% | operator |
| 30703 | Aggregate | 2622.80 | 1073.15 | 59.1% | operator |
| 30704 | Index Scan | 2124.47 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30704 (Index Scan) - LEAF
...
### Step 3: Node 30700 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30701, 30702
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30706 (Seq Scan) - LEAF
...
### Step 7: Node 30698 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30707 (Index Scan) - LEAF
...
### Step 10: Node 30696 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30695 (Gather Merge)
