...
**Test Query:** Q18_137_seed_1115748216
...
```
Node 29460 (Limit) - ROOT
  Node 29461 (Sort)
    Node 29462 (Aggregate)
      Node 29463 (Gather Merge)
        Node 29464 (Incremental Sort)
          Node 29465 (Nested Loop)
            Node 29466 (Merge Join)
              Node 29467 (Sort)
                Node 29468 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29469 (Seq Scan) [consumed] - LEAF
                  Node 29470 (Hash) [consumed]
                    Node 29471 (Aggregate)
                      Node 29472 (Index Scan) - LEAF
              Node 29473 (Sort)
                Node 29474 (Seq Scan) - LEAF
            Node 29475 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29468 | 29469, 29470 |
...
|------|------|--------|-----------|-----|--------|
| 29460 | Limit | 3037.61 | 1175.21 | 61.3% | operator |
| 29461 | Sort | 2919.08 | 1127.81 | 61.4% | operator |
| 29462 | Aggregate | 2919.04 | 1073.15 | 63.2% | operator |
| 29463 | Gather Merge | 2919.02 | 1073.95 | 63.2% | operator |
| 29464 | Incremental Sort | 2882.64 | 0.00 | 100.0% | operator |
| 29465 | Nested Loop | 2882.59 | 1111.34 | 61.4% | operator |
| 29466 | Merge Join | 2882.54 | 0.00 | 100.0% | operator |
| 29475 | Index Scan | 0.02 | 0.05 | 114.9% | operator |
| 29467 | Sort | 2832.34 | 1095.58 | 61.3% | operator |
| 29473 | Sort | 64.95 | 1074.66 | 1554.5% | operator |
| 29468 | Hash Join | 2832.33 | 471.07 | 83.4% | pattern |
| 29474 | Seq Scan | 53.97 | 18.25 | 66.2% | operator |
| 29471 | Aggregate | 2615.14 | 1073.15 | 59.0% | operator |
| 29472 | Index Scan | 2116.87 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29472 (Index Scan) - LEAF
...
### Step 3: Node 29468 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29469, 29470
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29474 (Seq Scan) - LEAF
...
### Step 7: Node 29466 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29475 (Index Scan) - LEAF
...
### Step 10: Node 29464 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29463 (Gather Merge)
