...
**Test Query:** Q4_85_seed_689138604
**Timestamp:** 2025-12-21 15:04:13
...
```
Node 6782 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6783 (Gather Merge) [consumed]
    Node 6784 (Sort) [consumed]
      Node 6785 (Aggregate) [consumed]
        Node 6786 (Nested Loop)
          Node 6787 (Seq Scan) - LEAF
          Node 6788 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6782 | 6783, 6784, 6785 |
...
|------|------|--------|-----------|-----|--------|
| 6782 | Aggregate | 1070.36 | 952.19 | 11.0% | pattern |
| 6786 | Nested Loop | 1063.96 | 1255.45 | 18.0% | operator |
| 6787 | Seq Scan | 172.61 | 154.66 | 10.4% | operator |
| 6788 | Index Scan | 0.06 | 11.10 | 17810.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6787 (Seq Scan) - LEAF
...
### Step 2: Node 6788 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - Aggregate_Outer_total_cost=66445.8900
  - Aggregate_np=0
  - Aggregate_nt=5
  - Aggregate_nt1=15
  - Aggregate_nt2=0
  ...
  - Aggregate_total_cost=67447.8800
  ...
  - GatherMerge_Outer_total_cost=67447.7600
  - Sort_Outer_np=0
  - Sort_Outer_nt=5
  - Sort_Outer_nt1=5
  - Sort_Outer_nt2=0
  ...
  - Sort_Outer_startup_cost=66445.9400
  - Sort_Outer_total_cost=66445.9600
