...
**Test Query:** Q12_8_seed_57428217
...
```
Node 25286 (Aggregate) - ROOT
  Node 25287 (Gather Merge)
    Node 25288 (Aggregate)
      Node 25289 (Sort)
        Node 25290 (Nested Loop)
          Node 25291 (Seq Scan) - LEAF
          Node 25292 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 25286 | Aggregate | 1002.95 | 919.06 | 8.4% | operator |
| 25287 | Gather Merge | 1002.94 | 1111.84 | 10.9% | operator |
| 25288 | Aggregate | 983.56 | 895.30 | 9.0% | operator |
| 25289 | Sort | 982.93 | 1092.82 | 11.2% | operator |
| 25290 | Nested Loop | 982.02 | 1127.41 | 14.8% | operator |
| 25291 | Seq Scan | 843.10 | 745.19 | 11.6% | operator |
| 25292 | Index Scan | 0.03 | 0.07 | 166.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25291 (Seq Scan) - LEAF
...
### Step 2: Node 25292 (Index Scan) - LEAF
...
### Step 6: Node 25287 (Gather Merge)
...
### Step 7: Node 25286 (Aggregate) - ROOT
