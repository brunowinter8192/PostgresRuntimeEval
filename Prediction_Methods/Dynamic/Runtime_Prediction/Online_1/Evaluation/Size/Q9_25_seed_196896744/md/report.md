...
**Test Query:** Q9_25_seed_196896744
...
```
Node 17865 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 17866 (Aggregate) [consumed]
    Node 17867 (Gather)
      Node 17868 (Aggregate)
        Node 17869 (Nested Loop)
          Node 17870 (Hash Join) [PATTERN: bb930825]
            Node 17871 (Seq Scan) [consumed] - LEAF
            Node 17872 (Hash) [consumed]
              Node 17873 (Hash Join) [consumed]
                Node 17874 (Hash Join)
                  Node 17875 (Nested Loop)
                    Node 17876 (Seq Scan) - LEAF
                    Node 17877 (Index Scan) - LEAF
                  Node 17878 (Hash)
                    Node 17879 (Seq Scan) - LEAF
                Node 17880 (Hash)
                  Node 17881 (Seq Scan) - LEAF
          Node 17882 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17870 | 17865, 17866, 17871, 17872, 17873 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17865 | 17866, 17870, 17871, 17872, 17873 |
...
|------|------|--------|-----------|-----|--------|
| 17865 | Sort | 1193.66 | 1045.59 | 12.4% | pattern |
| 17867 | Gather | 1192.75 | 964.55 | 19.1% | operator |
| 17868 | Aggregate | 1171.54 | 1085.45 | 7.3% | operator |
| 17869 | Nested Loop | 1147.45 | 1252.17 | 9.1% | operator |
| 17870 | Hash Join | 971.94 | 134.80 | 86.1% | pattern |
| 17882 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17874 | Hash Join | 160.64 | 837.63 | 421.4% | operator |
| 17880 | Hash | 13.47 | 14.95 | 11.0% | operator |
| 17875 | Nested Loop | 153.13 | 1251.77 | 717.5% | operator |
| 17878 | Hash | 5.02 | 15.94 | 217.7% | operator |
| 17881 | Seq Scan | 13.46 | 2.94 | 78.2% | operator |
| 17876 | Seq Scan | 19.40 | 43.96 | 126.6% | operator |
| 17877 | Index Scan | 0.07 | -1.39 | 1976.3% | operator |
| 17879 | Seq Scan | 4.29 | 9.45 | 120.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 17876 (Seq Scan) - LEAF
...
### Step 2: Node 17877 (Index Scan) - LEAF
...
### Step 3: Node 17879 (Seq Scan) - LEAF
...
### Step 6: Node 17881 (Seq Scan) - LEAF
...
### Step 9: Node 17870 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17865, 17866, 17871, 17872, 17873
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17882 (Index Scan) - LEAF
...
### Step 11: Node 17869 (Nested Loop)
...
### Step 14: Node 17865 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17866, 17870, 17871, 17872, 17873
- **Input Features:**
