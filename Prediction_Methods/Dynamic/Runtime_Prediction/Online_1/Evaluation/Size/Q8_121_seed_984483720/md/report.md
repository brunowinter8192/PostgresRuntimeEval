...
```
Node 13730 (Aggregate) - ROOT
  Node 13731 (Gather Merge)
    Node 13732 (Sort)
          ...
          Node 13735 (Hash Join)
            Node 13736 (Nested Loop)
              Node 13737 (Hash Join)
                ...
                Node 13739 (Hash)
                  Node 13740 (Hash Join)
                    Node 13741 (Seq Scan) - LEAF
                    Node 13742 (Hash)
                      Node 13743 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 13730 | Aggregate | 1226.27 | 1188.75 | 3.1% | operator |
| 13731 | Gather Merge | 1225.85 | 1097.18 | 10.5% | operator |
...
| 13737 | Hash Join | 211.72 | 251.17 | 18.6% | operator |
...
| 13739 | Hash | 36.11 | 20.62 | 42.9% | operator |
| 13740 | Hash Join | 35.47 | 132.26 | 272.9% | operator |
| 13741 | Seq Scan | 34.10 | 23.03 | 32.5% | operator |
| 13742 | Hash | 0.08 | 23.66 | 29844.5% | operator |
| 13743 | Hash Join | 0.08 | 306.84 | 403631.5% | operator |
...
### Step 5: Node 13741 (Seq Scan) - LEAF
...
### Step 8: Node 13738 (Seq Scan) - LEAF
...
### Step 11: Node 13747 (Index Scan) - LEAF
...
### Step 12: Node 13749 (Seq Scan) - LEAF
...
### Step 13: Node 13736 (Nested Loop)
...
### Step 16: Node 13750 (Index Scan) - LEAF
...
### Step 17: Node 13752 (Seq Scan) - LEAF
...
### Step 18: Node 13734 (Nested Loop)
...
### Step 22: Node 13731 (Gather Merge)
...
### Step 23: Node 13730 (Aggregate) - ROOT
