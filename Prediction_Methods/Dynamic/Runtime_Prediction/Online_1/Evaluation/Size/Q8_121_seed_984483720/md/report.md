...
**Test Query:** Q8_121_seed_984483720
...
Node 13730 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 13731 (Gather Merge) [consumed]
    Node 13732 (Sort)
      Node 13733 (Hash Join)
        Node 13734 (Nested Loop)
          Node 13735 (Hash Join)
            Node 13736 (Nested Loop)
              Node 13737 (Hash Join)
                Node 13738 (Seq Scan) - LEAF
                Node 13739 (Hash) [PATTERN: 444761fb]
                  Node 13740 (Hash Join) [consumed]
                    Node 13741 (Seq Scan) [consumed] - LEAF
                    Node 13742 (Hash) [consumed]
                      Node 13743 (Hash Join) [consumed]
                        Node 13744 (Seq Scan) - LEAF
                        Node 13745 (Hash)
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 13739 | 13730, 13731, 13740, 13741, 13742, 13743 |
| Aggregate -> Gather Merge (Out | 2724c080 | 13730 | 13731, 13739, 13740, 13741, 13742, 13743 |
...
|------|------|--------|-----------|-----|--------|
| 13730 | Aggregate | 1226.27 | 1129.87 | 7.9% | pattern |
| 13732 | Sort | 1221.00 | 1046.21 | 14.3% | operator |
| 13733 | Hash Join | 1220.76 | 785.61 | 35.6% | operator |
| 13734 | Nested Loop | 1220.21 | 1198.29 | 1.8% | operator |
| 13751 | Hash | 0.01 | 13.72 | 97929.2% | operator |
| 13735 | Hash Join | 1216.60 | 785.60 | 35.4% | operator |
| 13750 | Index Scan | 0.01 | 12.42 | 206958.1% | operator |
| 13752 | Seq Scan | 0.01 | 6.51 | 65019.6% | operator |
| 13736 | Nested Loop | 1171.05 | 1198.29 | 2.3% | operator |
| 13748 | Hash | 40.46 | 19.97 | 50.7% | operator |
| 13737 | Hash Join | 211.72 | 251.67 | 18.9% | operator |
| 13747 | Index Scan | 0.04 | 2.88 | 6759.2% | operator |
| 13749 | Seq Scan | 40.37 | 48.87 | 21.0% | operator |
| 13738 | Seq Scan | 158.03 | 159.67 | 1.0% | operator |
| 13739 | Hash | 36.11 | 43.51 | 20.5% | pattern |
| 13744 | Seq Scan | 0.01 | 12.22 | 122149.4% | operator |
| 13745 | Hash | 0.06 | 18.14 | 30652.8% | operator |
| 13746 | Seq Scan | 0.06 | 23.36 | 41618.2% | operator |
...
### Step 2: Node 13744 (Seq Scan) - LEAF
...
### Step 4: Node 13738 (Seq Scan) - LEAF
...
### Step 5: Node 13739 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 13730, 13731, 13740, 13741, 13742, 13743
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 13747 (Index Scan) - LEAF
...
### Step 8: Node 13749 (Seq Scan) - LEAF
...
### Step 12: Node 13750 (Index Scan) - LEAF
...
### Step 13: Node 13752 (Seq Scan) - LEAF
...
### Step 14: Node 13734 (Nested Loop)
...
- **Input Features:**
  ...
  - st1=113.6207
  - st2=0.0000
  - startup_cost=70558.7200
  - total_cost=70560.7200
- **Output:** st=1044.94, rt=1046.21

### Step 18: Node 13730 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 13731, 13739, 13740, 13741, 13742, 13743
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2482
  ...
  - Aggregate_total_cost=71950.1600
  - GatherMerge_Outer_np=0
  - GatherMerge_Outer_nt=2482
  - GatherMerge_Outer_nt1=801
  ...
  - GatherMerge_Outer_total_cost=71852.4000
- **Output:** st=1126.90, rt=1129.87
