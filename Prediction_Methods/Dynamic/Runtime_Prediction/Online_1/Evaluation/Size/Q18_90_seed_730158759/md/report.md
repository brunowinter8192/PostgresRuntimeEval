...
**Test Query:** Q18_90_seed_730158759
...
```
Node 31044 (Limit) - ROOT
  Node 31045 (Sort)
    Node 31046 (Aggregate)
      Node 31047 (Gather Merge)
        Node 31048 (Incremental Sort)
          Node 31049 (Nested Loop)
            Node 31050 (Merge Join)
              Node 31051 (Sort)
                Node 31052 (Hash Join) [PATTERN: 895c6e8c]
                  Node 31053 (Seq Scan) [consumed] - LEAF
                  Node 31054 (Hash) [consumed]
                    Node 31055 (Aggregate)
                      Node 31056 (Index Scan) - LEAF
              Node 31057 (Sort)
                Node 31058 (Seq Scan) - LEAF
            Node 31059 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 31052 | 31053, 31054 |
...
|------|------|--------|-----------|-----|--------|
| 31044 | Limit | 3045.31 | 1175.21 | 61.4% | operator |
| 31045 | Sort | 2926.41 | 1127.81 | 61.5% | operator |
| 31046 | Aggregate | 2926.36 | 1073.15 | 63.3% | operator |
| 31047 | Gather Merge | 2926.35 | 1073.95 | 63.3% | operator |
| 31048 | Incremental Sort | 2908.24 | 0.00 | 100.0% | operator |
| 31049 | Nested Loop | 2908.20 | 1111.34 | 61.8% | operator |
| 31050 | Merge Join | 2908.14 | 0.00 | 100.0% | operator |
| 31059 | Index Scan | 0.02 | 0.05 | 88.1% | operator |
| 31051 | Sort | 2839.37 | 1095.58 | 61.4% | operator |
| 31057 | Sort | 65.98 | 1074.66 | 1528.8% | operator |
| 31052 | Hash Join | 2839.36 | 471.07 | 83.4% | pattern |
| 31058 | Seq Scan | 53.21 | 18.25 | 65.7% | operator |
| 31055 | Aggregate | 2615.32 | 1073.15 | 59.0% | operator |
| 31056 | Index Scan | 2097.76 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31056 (Index Scan) - LEAF
...
### Step 3: Node 31052 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 31053, 31054
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 31058 (Seq Scan) - LEAF
...
### Step 7: Node 31050 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 31059 (Index Scan) - LEAF
...
### Step 10: Node 31048 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 31047 (Gather Merge)
