        ...
        Node 31048 (Incremental Sort)
          Node 31049 (Nested Loop)
            Node 31050 (Merge Join)
              Node 31051 (Sort)
                Node 31052 (Hash Join)
                  Node 31053 (Seq Scan) - LEAF
                  Node 31054 (Hash)
...
| 31051 | Sort | 2839.37 | 1099.77 | 61.3% | operator |
| 31057 | Sort | 65.98 | 1074.66 | 1528.8% | operator |
| 31052 | Hash Join | 2839.36 | 686.33 | 75.8% | operator |
| 31058 | Seq Scan | 53.21 | 18.25 | 65.7% | operator |
| 31053 | Seq Scan | 193.94 | 170.37 | 12.2% | operator |
| 31054 | Hash | 2615.36 | 21.04 | 99.2% | operator |
...
### Step 3: Node 31053 (Seq Scan) - LEAF
...
### Step 6: Node 31058 (Seq Scan) - LEAF
...
### Step 9: Node 31050 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 31059 (Index Scan) - LEAF
...
### Step 11: Node 31049 (Nested Loop)
...
### Step 12: Node 31048 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 31047 (Gather Merge)
