...
**Test Query:** Q5_100_seed_812199069
...
```
Node 6901 (Sort) [PATTERN: ddb1e0ca] - ROOT
          ...
          Node 6906 (Hash Join) [consumed]
            Node 6907 (Nested Loop)
              Node 6908 (Hash Join)
                ...
                Node 6910 (Hash) [PATTERN: 444761fb]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 6910 | 6901, 6902, 6903, 6905, 6906, 6911, 6912, 6913, 6914 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 6901 | 6902, 6903, 6905, 6906, 6910, 6911, 6912, 6913, 6914 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 6905 | 6901, 6902, 6903, 6906, 6910, 6911, 6912, 6913, 6914 |
...
|------|------|--------|-----------|-----|--------|
| 6901 | Sort | 1057.72 | 2934.42 | 177.4% | pattern |
| 6904 | Aggregate | 1052.30 | 1128.79 | 7.3% | operator |
| 6905 | Sort | 1052.05 | 1835.90 | 74.5% | pattern |
| 6907 | Nested Loop | 1040.91 | 1188.37 | 14.2% | operator |
| 6919 | Hash | 2.50 | 18.67 | 645.4% | operator |
| 6908 | Hash Join | 215.92 | 253.07 | 17.2% | operator |
| 6918 | Index Scan | 0.07 | -0.22 | 405.6% | operator |
| 6920 | Seq Scan | 1.98 | 12.36 | 524.5% | operator |
| 6909 | Seq Scan | 166.55 | 159.81 | 4.0% | operator |
| 6910 | Hash | 35.16 | 46.85 | 33.2% | pattern |
| 6915 | Seq Scan | 0.01 | 11.81 | 117982.7% | operator |
| 6916 | Hash | 0.22 | 21.05 | 9513.4% | operator |
| 6917 | Seq Scan | 0.22 | 22.93 | 10517.3% | operator |
...
### Step 2: Node 6915 (Seq Scan) - LEAF
...
### Step 4: Node 6909 (Seq Scan) - LEAF
...
### Step 5: Node 6910 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 6901, 6902, 6903, 6905, 6906, 6911, 6912, 6913, 6914
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 6918 (Index Scan) - LEAF
...
### Step 8: Node 6920 (Seq Scan) - LEAF
...
### Step 11: Node 6905 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 6901, 6902, 6903, 6906, 6910, 6911, 6912, 6913, 6914
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 6901 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 6902, 6903, 6905, 6906, 6910, 6911, 6912, 6913, 6914
- **Input Features:**
