...
**Test Query:** Q12_73_seed_590690232
...
```
Node 25160 (Aggregate) - ROOT
  Node 25161 (Gather Merge)
    Node 25162 (Aggregate)
      Node 25163 (Sort)
        Node 25164 (Nested Loop)
          Node 25165 (Seq Scan) - LEAF
          Node 25166 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 25160 | Aggregate | 989.73 | 919.06 | 7.1% | operator |
| 25161 | Gather Merge | 989.72 | 1111.84 | 12.3% | operator |
| 25162 | Aggregate | 969.98 | 895.30 | 7.7% | operator |
| 25163 | Sort | 969.35 | 1092.82 | 12.7% | operator |
| 25164 | Nested Loop | 968.42 | 1127.41 | 16.4% | operator |
| 25165 | Seq Scan | 832.65 | 745.19 | 10.5% | operator |
| 25166 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25165 (Seq Scan) - LEAF
...
### Step 2: Node 25166 (Index Scan) - LEAF
...
### Step 6: Node 25161 (Gather Merge)
...
### Step 7: Node 25160 (Aggregate) - ROOT
