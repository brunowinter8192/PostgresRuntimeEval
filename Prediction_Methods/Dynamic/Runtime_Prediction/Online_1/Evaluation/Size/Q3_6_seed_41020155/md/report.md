...
```
Node 5511 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5512 (Sort) [consumed]
    Node 5513 (Aggregate) [consumed]
      Node 5514 (Gather) [consumed]
        Node 5515 (Nested Loop)
          Node 5516 (Hash Join) [PATTERN: 895c6e8c]
            Node 5517 (Seq Scan) [consumed] - LEAF
            Node 5518 (Hash) [consumed]
              Node 5519 (Seq Scan) - LEAF
          Node 5520 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5511 | 5512, 5513, 5514, 5516, 5517, 5518 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5516 | 5511, 5512, 5513, 5514, 5517, 5518 |
...
|------|------|--------|-----------|-----|--------|
| 5511 | Limit | 1200.86 | 1151.18 | 4.1% | pattern |
| 5515 | Nested Loop | 1163.76 | 1193.16 | 2.5% | operator |
| 5516 | Hash Join | 208.66 | 242.50 | 16.2% | pattern |
| 5520 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5519 | Seq Scan | 27.18 | 38.57 | 41.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5519 (Seq Scan) - LEAF
...
### Step 2: Node 5516 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5511, 5512, 5513, 5514, 5517, 5518
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47093
  - HashJoin_nt1=235716
  ...
  - HashJoin_total_cost=37340.5000
  - Hash_Inner_np=0
  - Hash_Inner_nt=12487
...
- **Output:** st=29.72, rt=242.50

### Step 3: Node 5520 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=72979.4500
- **Output:** st=121.91, rt=1193.16

### Step 5: Node 5511 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5512, 5513, 5514, 5516, 5517, 5518
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=313730
  - Aggregate_Outer_nt1=313730
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110058.4000
  - Aggregate_Outer_total_cost=113980.0300
  - Gather_Outer_np=0
  - Gather_Outer_nt=313730
  - Gather_Outer_nt1=101203
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105352.4500
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=313730
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=120759.6200
  - Limit_total_cost=120759.6400
  - Sort_Outer_np=0
  - Sort_Outer_nt=313730
  - Sort_Outer_nt1=313730
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=120759.6200
  - Sort_Outer_total_cost=121543.9400
