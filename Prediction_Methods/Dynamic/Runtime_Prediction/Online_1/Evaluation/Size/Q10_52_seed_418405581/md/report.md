...
**Test Query:** Q10_52_seed_418405581
...
```
Node 20631 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 20632 (Sort) [consumed]
    Node 20633 (Aggregate) [consumed]
      Node 20634 (Gather) [consumed]
        Node 20635 (Hash Join)
          Node 20636 (Hash Join) [PATTERN: 2e0f44ef]
            Node 20637 (Nested Loop) [consumed]
              Node 20638 (Seq Scan) - LEAF
              Node 20639 (Index Scan) - LEAF
            Node 20640 (Hash) [consumed]
              Node 20641 (Seq Scan) - LEAF
          Node 20642 (Hash)
            Node 20643 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20631 | 20632, 20633, 20634, 20636, 20637, 20640 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 20636 | 20631, 20632, 20633, 20634, 20637, 20640 |
...
|------|------|--------|-----------|-----|--------|
| 20631 | Limit | 1164.35 | 1199.47 | 3.0% | pattern |
| 20635 | Hash Join | 1116.65 | 1095.70 | 1.9% | operator |
| 20636 | Hash Join | 1113.76 | 1120.19 | 0.6% | pattern |
| 20642 | Hash | 0.01 | 15.71 | 104638.5% | operator |
| 20643 | Seq Scan | 0.01 | 6.98 | 63342.8% | operator |
| 20638 | Seq Scan | 158.15 | 159.73 | 1.0% | operator |
| 20639 | Index Scan | 0.06 | -0.52 | 935.9% | operator |
| 20641 | Seq Scan | 34.05 | 26.64 | 21.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 20638 (Seq Scan) - LEAF
...
### Step 2: Node 20639 (Index Scan) - LEAF
...
### Step 3: Node 20641 (Seq Scan) - LEAF
...
### Step 4: Node 20643 (Seq Scan) - LEAF
...
### Step 5: Node 20636 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 20631, 20632, 20633, 20634, 20637, 20640
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18756
  - HashJoin_nt1=18756
...
- **Output:** st=54.27, rt=1095.70

### Step 8: Node 20631 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20632, 20633, 20634, 20636, 20637, 20640
- **Input Features:**
