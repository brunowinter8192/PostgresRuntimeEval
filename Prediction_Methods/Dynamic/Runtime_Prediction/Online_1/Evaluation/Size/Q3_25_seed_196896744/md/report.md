...
**Test Query:** Q3_25_seed_196896744
...
```
Node 5021 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5022 (Sort) [consumed]
    Node 5023 (Aggregate) [consumed]
      Node 5024 (Gather) [consumed]
        Node 5025 (Nested Loop)
          Node 5026 (Hash Join) [PATTERN: 895c6e8c]
            Node 5027 (Seq Scan) [consumed] - LEAF
            Node 5028 (Hash) [consumed]
              Node 5029 (Seq Scan) - LEAF
          Node 5030 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5021 | 5022, 5023, 5024, 5026, 5027, 5028 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5026 | 5021, 5022, 5023, 5024, 5027, 5028 |
...
|------|------|--------|-----------|-----|--------|
| 5021 | Limit | 1190.57 | 1151.18 | 3.3% | pattern |
| 5025 | Nested Loop | 1155.03 | 1193.16 | 3.3% | operator |
| 5026 | Hash Join | 211.79 | 242.50 | 14.5% | pattern |
| 5030 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5029 | Seq Scan | 31.24 | 38.53 | 23.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5029 (Seq Scan) - LEAF
...
### Step 2: Node 5026 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5021, 5022, 5023, 5024, 5027, 5028
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47090
  - HashJoin_nt1=233978
...
### Step 3: Node 5030 (Index Scan) - LEAF
...
### Step 5: Node 5021 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5022, 5023, 5024, 5026, 5027, 5028
- **Input Features:**
