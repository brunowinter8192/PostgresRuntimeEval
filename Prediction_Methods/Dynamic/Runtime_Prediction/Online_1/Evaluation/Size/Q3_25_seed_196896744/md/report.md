...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5021 | 5022, 5023, 5024 |
...
| 5025 | Nested Loop | 1155.03 | 1193.07 | 3.3% | operator |
| 5026 | Hash Join | 211.79 | 230.58 | 8.9% | operator |
| 5030 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5027 | Seq Scan | 156.53 | 163.31 | 4.3% | operator |
| 5028 | Hash | 31.99 | 17.75 | 44.5% | operator |
...
### Step 2: Node 5027 (Seq Scan) - LEAF
...
### Step 5: Node 5030 (Index Scan) - LEAF
...
### Step 7: Node 5021 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5022, 5023, 5024
- **Input Features:**
