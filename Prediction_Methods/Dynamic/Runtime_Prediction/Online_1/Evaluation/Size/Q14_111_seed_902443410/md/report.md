...
```
Node 26504 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26505 (Gather) [consumed]
    Node 26506 (Aggregate) [consumed]
      Node 26507 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26504 | 26505, 26506, 26507 |
...
|------|------|--------|-----------|-----|--------|
| 26504 | Aggregate | 821.06 | 857.14 | 4.4% | pattern |
...
### Step 4: Node 26504 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26505, 26506, 26507
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=15746
  - HashJoin_Outer_nt1=15746
  ...
  - HashJoin_Outer_total_cost=136647.9700
