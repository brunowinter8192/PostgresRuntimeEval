...
**Test Query:** Q18_40_seed_319957209
**Timestamp:** 2026-01-18 20:23:16
...
```
Node 30164 (Limit) - ROOT
  Node 30165 (Sort)
    Node 30166 (Aggregate)
      Node 30167 (Gather Merge)
        Node 30168 (Incremental Sort)
          Node 30169 (Nested Loop)
            Node 30170 (Merge Join)
              Node 30171 (Sort)
                Node 30172 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30173 (Seq Scan) [consumed] - LEAF
                  Node 30174 (Hash) [consumed]
                    Node 30175 (Aggregate)
                      Node 30176 (Index Scan) - LEAF
              Node 30177 (Sort)
                Node 30178 (Seq Scan) - LEAF
            Node 30179 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30172 | 30173, 30174 |
...
|------|------|--------|-----------|-----|--------|
| 30164 | Limit | 3026.23 | 1175.21 | 61.2% | operator |
| 30165 | Sort | 2911.77 | 1127.81 | 61.3% | operator |
| 30166 | Aggregate | 2911.73 | 1073.15 | 63.1% | operator |
| 30167 | Gather Merge | 2911.70 | 1073.95 | 63.1% | operator |
| 30168 | Incremental Sort | 2876.29 | 0.00 | 100.0% | operator |
| 30169 | Nested Loop | 2876.24 | 1111.34 | 61.4% | operator |
| 30170 | Merge Join | 2876.19 | 0.00 | 100.0% | operator |
| 30179 | Index Scan | 0.02 | 0.05 | 114.9% | operator |
| 30171 | Sort | 2826.51 | 1095.58 | 61.2% | operator |
| 30177 | Sort | 63.81 | 1074.66 | 1584.1% | operator |
| 30172 | Hash Join | 2826.49 | 471.07 | 83.3% | pattern |
| 30178 | Seq Scan | 52.66 | 18.25 | 65.4% | operator |
| 30175 | Aggregate | 2603.65 | 1073.15 | 58.8% | operator |
| 30176 | Index Scan | 2104.60 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30176 (Index Scan) - LEAF
...
### Step 3: Node 30172 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30173, 30174
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30178 (Seq Scan) - LEAF
...
### Step 7: Node 30170 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30179 (Index Scan) - LEAF
...
### Step 10: Node 30168 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30167 (Gather Merge)
