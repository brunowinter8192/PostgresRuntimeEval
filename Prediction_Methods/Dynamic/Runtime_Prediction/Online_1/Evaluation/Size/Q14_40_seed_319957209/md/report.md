...
```
Node 27008 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27009 (Gather) [consumed]
    Node 27010 (Aggregate) [consumed]
      Node 27011 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27008 | 27009, 27010, 27011 |
...
|------|------|--------|-----------|-----|--------|
| 27008 | Aggregate | 818.02 | 857.13 | 4.8% | pattern |
...
### Step 4: Node 27008 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27009, 27010, 27011
- **Input Features:**
