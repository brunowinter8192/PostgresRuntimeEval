...
**Test Query:** Q10_81_seed_656322480
...
```
Node 21047 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 21048 (Sort) [consumed]
    Node 21049 (Aggregate) [consumed]
      Node 21050 (Gather) [consumed]
        Node 21051 (Hash Join)
          Node 21052 (Hash Join) [PATTERN: 2e0f44ef]
            Node 21053 (Nested Loop) [consumed]
              Node 21054 (Seq Scan) - LEAF
              Node 21055 (Index Scan) - LEAF
            Node 21056 (Hash) [consumed]
              Node 21057 (Seq Scan) - LEAF
          Node 21058 (Hash)
            Node 21059 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 21047 | 21048, 21049, 21050, 21052, 21053, 21056 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 21052 | 21047, 21048, 21049, 21050, 21053, 21056 |
...
|------|------|--------|-----------|-----|--------|
| 21047 | Limit | 1152.88 | 1199.47 | 4.0% | pattern |
| 21051 | Hash Join | 1105.62 | 1095.70 | 0.9% | operator |
| 21052 | Hash Join | 1102.72 | 1120.19 | 1.6% | pattern |
| 21058 | Hash | 0.02 | 15.71 | 87182.1% | operator |
| 21059 | Seq Scan | 0.01 | 6.98 | 53582.3% | operator |
| 21054 | Seq Scan | 160.65 | 159.73 | 0.6% | operator |
| 21055 | Index Scan | 0.06 | -0.52 | 935.9% | operator |
| 21057 | Seq Scan | 23.34 | 26.64 | 14.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 21054 (Seq Scan) - LEAF
...
### Step 2: Node 21055 (Index Scan) - LEAF
...
### Step 3: Node 21057 (Seq Scan) - LEAF
...
### Step 4: Node 21059 (Seq Scan) - LEAF
...
### Step 5: Node 21052 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 21047, 21048, 21049, 21050, 21053, 21056
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18756
  - HashJoin_nt1=18756
...
### Step 8: Node 21047 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 21048, 21049, 21050, 21052, 21053, 21056
- **Input Features:**
