    ...
    Node 21049 (Aggregate) [consumed]
      Node 21050 (Gather) [consumed]
        Node 21051 (Hash Join)
          Node 21052 (Hash Join)
            Node 21053 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 21047 | 21048, 21049, 21050 |
...
| 21051 | Hash Join | 1105.62 | 1006.93 | 8.9% | operator |
| 21052 | Hash Join | 1102.72 | 1003.66 | 9.0% | operator |
| 21058 | Hash | 0.02 | 15.71 | 87182.1% | operator |
| 21053 | Nested Loop | 1059.35 | 1204.98 | 13.7% | operator |
| 21056 | Hash | 31.79 | 55.57 | 74.8% | operator |
...
### Step 6: Node 21059 (Seq Scan) - LEAF
...
### Step 10: Node 21047 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 21048, 21049, 21050
- **Input Features:**
