...
**Test Query:** Q3_124_seed_1009095813
...
```
Node 4611 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 4612 (Sort) [consumed]
    Node 4613 (Aggregate) [consumed]
      Node 4614 (Gather) [consumed]
        Node 4615 (Nested Loop)
          Node 4616 (Hash Join) [PATTERN: 895c6e8c]
            Node 4617 (Seq Scan) [consumed] - LEAF
            Node 4618 (Hash) [consumed]
              Node 4619 (Seq Scan) - LEAF
          Node 4620 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4611 | 4612, 4613, 4614, 4616, 4617, 4618 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4616 | 4611, 4612, 4613, 4614, 4617, 4618 |
...
|------|------|--------|-----------|-----|--------|
| 4611 | Limit | 1196.42 | 1151.18 | 3.8% | pattern |
| 4615 | Nested Loop | 1159.22 | 1193.29 | 2.9% | operator |
| 4616 | Hash Join | 207.09 | 242.53 | 17.1% | pattern |
| 4620 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4619 | Seq Scan | 29.26 | 38.53 | 31.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4619 (Seq Scan) - LEAF
...
### Step 2: Node 4616 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4611, 4612, 4613, 4614, 4617, 4618
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47297
  - HashJoin_nt1=235005
...
- **Output:** st=29.73, rt=242.53

### Step 3: Node 4620 (Index Scan) - LEAF
...
- **Output:** st=122.03, rt=1193.29

### Step 5: Node 4611 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4612, 4613, 4614, 4616, 4617, 4618
- **Input Features:**
