...
**Test Query:** Q14_4_seed_24612093
...
```
Node 27078 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27079 (Gather) [consumed]
    Node 27080 (Aggregate) [consumed]
      Node 27081 (Hash Join)
        Node 27082 (Seq Scan) - LEAF
        Node 27083 (Hash)
          Node 27084 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27078 | 27079, 27080 |
...
|------|------|--------|-----------|-----|--------|
| 27078 | Aggregate | 815.47 | 848.35 | 4.0% | pattern |
| 27081 | Hash Join | 793.58 | 807.62 | 1.8% | operator |
| 27082 | Seq Scan | 744.13 | 758.47 | 1.9% | operator |
| 27083 | Hash | 41.55 | 9.38 | 77.4% | operator |
| 27084 | Seq Scan | 36.71 | 12.70 | 65.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27084 (Seq Scan) - LEAF
...
### Step 2: Node 27082 (Seq Scan) - LEAF
...
### Step 5: Node 27078 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27079, 27080
- **Input Features:**
