...
```
Node 27078 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27079 (Gather) [consumed]
    Node 27080 (Aggregate) [consumed]
      Node 27081 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27078 | 27079, 27080, 27081 |
...
|------|------|--------|-----------|-----|--------|
| 27078 | Aggregate | 815.47 | 857.12 | 5.1% | pattern |
...
### Step 4: Node 27078 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27079, 27080, 27081
- **Input Features:**
