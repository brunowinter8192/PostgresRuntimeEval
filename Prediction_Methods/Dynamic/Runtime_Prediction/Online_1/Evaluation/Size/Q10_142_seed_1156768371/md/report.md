    ...
    Node 19970 (Aggregate) [consumed]
      Node 19971 (Gather) [consumed]
        Node 19972 (Hash Join)
          Node 19973 (Hash Join)
            Node 19974 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19968 | 19969, 19970, 19971 |
...
| 19972 | Hash Join | 1116.33 | 1007.32 | 9.8% | operator |
| 19973 | Hash Join | 1113.53 | 1004.29 | 9.8% | operator |
| 19979 | Hash | 0.02 | 15.71 | 98092.3% | operator |
| 19974 | Nested Loop | 1065.46 | 1204.75 | 13.1% | operator |
| 19977 | Hash | 37.28 | 55.57 | 49.1% | operator |
...
### Step 6: Node 19980 (Seq Scan) - LEAF
...
### Step 10: Node 19968 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19969, 19970, 19971
- **Input Features:**
