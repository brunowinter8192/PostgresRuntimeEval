...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5221 | 5222, 5223, 5224, 5226, 5227, 5228 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5226 | 5221, 5222, 5223, 5224, 5227, 5228 |
...
|------|------|--------|-----------|-----|--------|
| 5221 | Limit | 1203.96 | 1151.18 | 4.4% | pattern |
| 5225 | Nested Loop | 1167.78 | 1192.71 | 2.1% | operator |
| 5226 | Hash Join | 210.77 | 242.41 | 15.0% | pattern |
| 5230 | Index Scan | 0.03 | -0.52 | 2018.8% | operator |
| 5229 | Seq Scan | 29.80 | 38.57 | 29.4% | operator |
...
- **Consumes:** Nodes 5221, 5222, 5223, 5224, 5227, 5228
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46382
  - HashJoin_nt1=232303
  ...
  - HashJoin_total_cost=37331.4400
  - Hash_Inner_np=0
  - Hash_Inner_nt=12479
...
### Step 3: Node 5230 (Index Scan) - LEAF
...
- **Output:** st=121.46, rt=1192.71

### Step 5: Node 5221 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5222, 5223, 5224, 5226, 5227, 5228
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=313024
  - Aggregate_Outer_nt1=313024
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=109562.4700
  - Aggregate_Outer_total_cost=113475.2700
  - Gather_Outer_np=0
