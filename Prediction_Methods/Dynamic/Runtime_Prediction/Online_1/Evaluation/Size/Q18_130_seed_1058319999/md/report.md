...
**Test Query:** Q18_130_seed_1058319999
...
```
Node 29348 (Limit) - ROOT
  Node 29349 (Sort)
    Node 29350 (Aggregate)
      Node 29351 (Gather Merge)
        Node 29352 (Incremental Sort)
          Node 29353 (Nested Loop)
            Node 29354 (Merge Join)
              Node 29355 (Sort)
                Node 29356 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29357 (Seq Scan) [consumed] - LEAF
                  Node 29358 (Hash) [consumed]
                    Node 29359 (Aggregate)
                      Node 29360 (Index Scan) - LEAF
              Node 29361 (Sort)
                Node 29362 (Seq Scan) - LEAF
            Node 29363 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29356 | 29357, 29358 |
...
|------|------|--------|-----------|-----|--------|
| 29348 | Limit | 3035.64 | 1175.21 | 61.3% | operator |
| 29349 | Sort | 2924.51 | 1127.81 | 61.4% | operator |
| 29350 | Aggregate | 2924.47 | 1073.15 | 63.3% | operator |
| 29351 | Gather Merge | 2924.46 | 1073.95 | 63.3% | operator |
| 29352 | Incremental Sort | 2901.85 | 0.00 | 100.0% | operator |
| 29353 | Nested Loop | 2901.81 | 1111.34 | 61.7% | operator |
| 29354 | Merge Join | 2901.74 | 0.00 | 100.0% | operator |
| 29363 | Index Scan | 0.02 | 0.05 | 114.9% | operator |
| 29355 | Sort | 2834.99 | 1095.58 | 61.4% | operator |
| 29361 | Sort | 64.12 | 1074.66 | 1575.9% | operator |
| 29356 | Hash Join | 2834.97 | 471.07 | 83.4% | pattern |
| 29362 | Seq Scan | 52.40 | 18.25 | 65.2% | operator |
| 29359 | Aggregate | 2610.99 | 1073.15 | 58.9% | operator |
| 29360 | Index Scan | 2118.34 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29360 (Index Scan) - LEAF
...
### Step 3: Node 29356 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29357, 29358
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29362 (Seq Scan) - LEAF
...
### Step 7: Node 29354 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29363 (Index Scan) - LEAF
...
### Step 10: Node 29352 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29351 (Gather Merge)
