...
**Test Query:** Q5_12_seed_90244341
...
```
Node 7541 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 7542 (Aggregate) [consumed]
    Node 7543 (Gather Merge) [consumed]
      Node 7544 (Aggregate)
        Node 7545 (Sort) [PATTERN: 3e2d5a00]
          Node 7546 (Hash Join) [consumed]
            Node 7547 (Nested Loop)
              Node 7548 (Hash Join)
                Node 7549 (Seq Scan) - LEAF
                Node 7550 (Hash) [PATTERN: 444761fb]
                  Node 7551 (Hash Join) [consumed]
                    Node 7552 (Seq Scan) [consumed] - LEAF
                    Node 7553 (Hash) [consumed]
                      Node 7554 (Hash Join) [consumed]
                        Node 7555 (Seq Scan) - LEAF
                        Node 7556 (Hash)
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 7550 | 7541, 7542, 7543, 7545, 7546, 7551, 7552, 7553, 7554 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 7541 | 7542, 7543, 7545, 7546, 7550, 7551, 7552, 7553, 7554 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 7545 | 7541, 7542, 7543, 7546, 7550, 7551, 7552, 7553, 7554 |
...
|------|------|--------|-----------|-----|--------|
| 7541 | Sort | 1090.18 | 2934.42 | 169.2% | pattern |
| 7544 | Aggregate | 1083.63 | 1128.78 | 4.2% | operator |
| 7545 | Sort | 1083.39 | 1835.91 | 69.5% | pattern |
| 7547 | Nested Loop | 1071.90 | 1188.39 | 10.9% | operator |
| 7559 | Hash | 2.87 | 18.67 | 551.2% | operator |
| 7548 | Hash Join | 217.83 | 253.07 | 16.2% | operator |
| 7558 | Index Scan | 0.07 | -0.22 | 397.3% | operator |
| 7560 | Seq Scan | 2.37 | 12.36 | 421.7% | operator |
| 7549 | Seq Scan | 168.53 | 159.81 | 5.2% | operator |
| 7550 | Hash | 36.47 | 46.85 | 28.5% | pattern |
| 7555 | Seq Scan | 0.01 | 11.81 | 147503.4% | operator |
| 7556 | Hash | 0.14 | 21.05 | 15046.2% | operator |
| 7557 | Seq Scan | 0.14 | 22.93 | 16762.7% | operator |
...
### Step 2: Node 7555 (Seq Scan) - LEAF
...
### Step 4: Node 7549 (Seq Scan) - LEAF
...
### Step 5: Node 7550 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 7541, 7542, 7543, 7545, 7546, 7551, 7552, 7553, 7554
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 7558 (Index Scan) - LEAF
...
### Step 8: Node 7560 (Seq Scan) - LEAF
...
### Step 11: Node 7545 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 7541, 7542, 7543, 7546, 7550, 7551, 7552, 7553, 7554
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 7541 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 7542, 7543, 7545, 7546, 7550, 7551, 7552, 7553, 7554
- **Input Features:**
