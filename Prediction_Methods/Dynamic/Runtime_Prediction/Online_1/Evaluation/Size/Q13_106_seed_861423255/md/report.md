...
**Test Query:** Q13_106_seed_861423255
...
```
Node 25412 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25413 (Aggregate) [consumed]
    Node 25414 (Aggregate)
      Node 25415 (Hash Join) [PATTERN: 895c6e8c]
        Node 25416 (Seq Scan) [consumed] - LEAF
        Node 25417 (Hash) [consumed]
          Node 25418 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25412 | 25413, 25415, 25416, 25417 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25415 | 25412, 25413, 25416, 25417 |
...
|------|------|--------|-----------|-----|--------|
| 25412 | Sort | 906.93 | 1079.93 | 19.1% | pattern |
| 25414 | Aggregate | 900.81 | 999.15 | 10.9% | operator |
| 25415 | Hash Join | 698.75 | 470.31 | 32.7% | pattern |
| 25418 | Index Only Scan | 9.29 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25418 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25415 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25412, 25413, 25416, 25417
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1478958
...
### Step 4: Node 25412 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25413, 25415, 25416, 25417
- **Input Features:**
