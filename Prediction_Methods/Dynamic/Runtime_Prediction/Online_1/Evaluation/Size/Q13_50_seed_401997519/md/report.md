...
**Test Query:** Q13_50_seed_401997519
...
```
Node 26035 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26036 (Aggregate) [consumed]
    Node 26037 (Aggregate)
      Node 26038 (Hash Join) [PATTERN: 895c6e8c]
        Node 26039 (Seq Scan) [consumed] - LEAF
        Node 26040 (Hash) [consumed]
          Node 26041 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26035 | 26036, 26038, 26039, 26040 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26038 | 26035, 26036, 26039, 26040 |
...
|------|------|--------|-----------|-----|--------|
| 26035 | Sort | 893.79 | 1079.93 | 20.8% | pattern |
| 26037 | Aggregate | 887.88 | 999.35 | 12.6% | operator |
| 26038 | Hash Join | 683.08 | 470.31 | 31.1% | pattern |
| 26041 | Index Only Scan | 9.71 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26041 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26038 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26035, 26036, 26039, 26040
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1481964
...
### Step 4: Node 26035 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26036, 26038, 26039, 26040
- **Input Features:**
