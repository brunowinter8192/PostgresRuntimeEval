...
```
Node 26035 (Sort) - ROOT
  Node 26036 (Aggregate)
    Node 26037 (Aggregate)
      Node 26038 (Hash Join)
        Node 26039 (Seq Scan) - LEAF
        Node 26040 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 26035 | Sort | 893.79 | 1081.93 | 21.0% | operator |
| 26036 | Aggregate | 893.77 | 1000.35 | 11.9% | operator |
| 26037 | Aggregate | 887.88 | 1013.97 | 14.2% | operator |
| 26038 | Hash Join | 683.08 | 787.83 | 15.3% | operator |
| 26039 | Seq Scan | 477.76 | 264.04 | 44.7% | operator |
| 26040 | Hash | 15.88 | 80.15 | 404.8% | operator |
...
### Step 2: Node 26039 (Seq Scan) - LEAF
