...
**Test Query:** Q12_108_seed_877831317
...
```
Node 24376 (Aggregate) - ROOT
  Node 24377 (Gather Merge)
    Node 24378 (Aggregate)
      Node 24379 (Sort)
        Node 24380 (Nested Loop)
          Node 24381 (Seq Scan) - LEAF
          Node 24382 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24376 | Aggregate | 997.11 | 919.03 | 7.8% | operator |
| 24377 | Gather Merge | 997.10 | 1111.84 | 11.5% | operator |
| 24378 | Aggregate | 976.92 | 895.28 | 8.4% | operator |
| 24379 | Sort | 976.28 | 1092.83 | 11.9% | operator |
| 24380 | Nested Loop | 975.29 | 1127.42 | 15.6% | operator |
| 24381 | Seq Scan | 837.84 | 745.20 | 11.1% | operator |
| 24382 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24381 (Seq Scan) - LEAF
...
### Step 2: Node 24382 (Index Scan) - LEAF
...
### Step 6: Node 24377 (Gather Merge)
...
### Step 7: Node 24376 (Aggregate) - ROOT
