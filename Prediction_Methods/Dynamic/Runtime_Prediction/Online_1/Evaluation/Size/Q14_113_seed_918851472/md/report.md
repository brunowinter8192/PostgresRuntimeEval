...
**Test Query:** Q14_113_seed_918851472
...
```
Node 26518 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26519 (Gather) [consumed]
    Node 26520 (Aggregate) [consumed]
      Node 26521 (Hash Join) [consumed]
        Node 26522 (Seq Scan) - LEAF
        Node 26523 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26518 | 26519, 26520, 26521 |
...
|------|------|--------|-----------|-----|--------|
| 26518 | Aggregate | 815.42 | 857.11 | 5.1% | pattern |
| 26522 | Seq Scan | 739.14 | 758.45 | 2.6% | operator |
| 26523 | Hash | 43.25 | 9.38 | 78.3% | operator |
| 26524 | Seq Scan | 36.27 | 12.70 | 65.0% | operator |
...
### Step 2: Node 26522 (Seq Scan) - LEAF
...
### Step 4: Node 26518 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26519, 26520, 26521
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=14206
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=64
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0001
  - Aggregate_Outer_startup_cost=136892.5400
  - Aggregate_Outer_total_cost=136892.5500
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=14206
  - HashJoin_Outer_nt1=14206
  ...
  - HashJoin_Outer_total_cost=136643.9300
- **Output:** st=850.75, rt=857.11
