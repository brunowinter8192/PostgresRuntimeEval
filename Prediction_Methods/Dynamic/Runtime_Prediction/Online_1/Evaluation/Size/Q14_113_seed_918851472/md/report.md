...
```
Node 26518 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26519 (Gather) [consumed]
    Node 26520 (Aggregate) [consumed]
      Node 26521 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26518 | 26519, 26520 |
...
|------|------|--------|-----------|-----|--------|
| 26518 | Aggregate | 815.42 | 848.34 | 4.0% | pattern |
| 26521 | Hash Join | 790.58 | 807.60 | 2.2% | operator |
...
### Step 5: Node 26518 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26519, 26520
- **Input Features:**
