...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5251 | 5252, 5253, 5254, 5256, 5257, 5258 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5256 | 5251, 5252, 5253, 5254, 5257, 5258 |
...
|------|------|--------|-----------|-----|--------|
| 5251 | Limit | 1201.31 | 1151.18 | 4.2% | pattern |
| 5255 | Nested Loop | 1163.91 | 1193.36 | 2.5% | operator |
| 5256 | Hash Join | 210.86 | 242.54 | 15.0% | pattern |
| 5260 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5259 | Seq Scan | 30.38 | 38.57 | 27.0% | operator |
...
- **Consumes:** Nodes 5251, 5252, 5253, 5254, 5257, 5258
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47396
  - HashJoin_nt1=237233
  ...
  - HashJoin_total_cost=37344.4800
  - Hash_Inner_np=0
  - Hash_Inner_nt=12487
...
- **Output:** st=29.68, rt=242.54

### Step 3: Node 5260 (Index Scan) - LEAF
...
- **Output:** st=122.11, rt=1193.36

### Step 5: Node 5251 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5252, 5253, 5254, 5256, 5257, 5258
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=313759
  - Aggregate_Outer_nt1=313759
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110236.1500
  - Aggregate_Outer_total_cost=114158.1400
  - Gather_Outer_np=0
