    ...
    Node 17667 (Gather)
      Node 17668 (Aggregate)
        Node 17669 (Nested Loop)
          Node 17670 (Hash Join) [PATTERN: bb930825]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17670 | 17665, 17666, 17671, 17672, 17673 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17665 | 17666, 17670, 17671, 17672, 17673 |
...
|------|------|--------|-----------|-----|--------|
| 17665 | Sort | 1186.48 | 1045.32 | 11.9% | pattern |
| 17667 | Gather | 1185.30 | 964.64 | 18.6% | operator |
| 17668 | Aggregate | 1163.36 | 1095.61 | 5.8% | operator |
| 17669 | Nested Loop | 1138.62 | 1252.17 | 10.0% | operator |
| 17670 | Hash Join | 966.95 | 134.80 | 86.1% | pattern |
| 17682 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17674 | Hash Join | 161.53 | 837.61 | 418.6% | operator |
| 17680 | Hash | 13.29 | 14.95 | 12.5% | operator |
| 17675 | Nested Loop | 155.34 | 1251.77 | 705.8% | operator |
| 17678 | Hash | 3.84 | 15.94 | 315.4% | operator |
| 17681 | Seq Scan | 13.28 | 2.94 | 77.9% | operator |
| 17676 | Seq Scan | 20.92 | 44.03 | 110.5% | operator |
| 17677 | Index Scan | 0.07 | -1.39 | 1951.3% | operator |
| 17679 | Seq Scan | 3.26 | 9.45 | 190.0% | operator |
...
### Step 9: Node 17670 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17665, 17666, 17671, 17672, 17673
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 11: Node 17669 (Nested Loop)
...
### Step 14: Node 17665 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17666, 17670, 17671, 17672, 17673
- **Input Features:**
