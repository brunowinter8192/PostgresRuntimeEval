    ...
    Node 20204 (Aggregate) [consumed]
      Node 20205 (Gather) [consumed]
        Node 20206 (Hash Join)
          Node 20207 (Hash Join)
            Node 20208 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20202 | 20203, 20204, 20205 |
...
| 20206 | Hash Join | 1100.15 | 1006.93 | 8.5% | operator |
| 20207 | Hash Join | 1097.20 | 1003.66 | 8.5% | operator |
| 20213 | Hash | 0.03 | 15.71 | 56009.9% | operator |
| 20208 | Nested Loop | 1047.23 | 1204.98 | 15.1% | operator |
| 20211 | Hash | 38.82 | 55.57 | 43.1% | operator |
...
### Step 6: Node 20214 (Seq Scan) - LEAF
...
### Step 10: Node 20202 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20203, 20204, 20205
- **Input Features:**
