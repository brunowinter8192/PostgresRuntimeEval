...
**Test Query:** Q6_13_seed_98448372
...
```
Node 10073 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10074 (Gather) [consumed]
    Node 10075 (Aggregate) [consumed]
      Node 10076 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10073 | 10074, 10075 |
...
|------|------|--------|-----------|-----|--------|
| 10073 | Aggregate | 768.31 | 849.99 | 10.6% | pattern |
| 10076 | Seq Scan | 748.24 | 748.50 | 0.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10076 (Seq Scan) - LEAF
...
### Step 2: Node 10073 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10074, 10075
- **Input Features:**
