...
**Test Query:** Q13_136_seed_1107544185
...
```
Node 25643 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25644 (Aggregate) [consumed]
    Node 25645 (Aggregate)
      Node 25646 (Hash Join) [PATTERN: 895c6e8c]
        Node 25647 (Seq Scan) [consumed] - LEAF
        Node 25648 (Hash) [consumed]
          Node 25649 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25643 | 25644, 25646, 25647, 25648 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25646 | 25643, 25644, 25647, 25648 |
...
|------|------|--------|-----------|-----|--------|
| 25643 | Sort | 940.54 | 1079.94 | 14.8% | pattern |
| 25645 | Aggregate | 934.28 | 999.76 | 7.0% | operator |
| 25646 | Hash Join | 719.11 | 470.31 | 34.6% | pattern |
| 25649 | Index Only Scan | 10.95 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25649 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25646 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25643, 25644, 25647, 25648
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 25643 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25644, 25646, 25647, 25648
- **Input Features:**
