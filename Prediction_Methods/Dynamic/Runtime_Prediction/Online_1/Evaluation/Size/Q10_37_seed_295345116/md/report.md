...
**Test Query:** Q10_37_seed_295345116
    ...
    Node 20412 (Aggregate) [consumed]
      Node 20413 (Gather) [consumed]
        Node 20414 (Hash Join)
          Node 20415 (Hash Join)
            Node 20416 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20410 | 20411, 20412, 20413 |
...
|------|------|--------|-----------|-----|--------|
| 20410 | Limit | 1170.20 | 1199.47 | 2.5% | pattern |
| 20414 | Hash Join | 1120.78 | 1006.93 | 10.2% | operator |
| 20415 | Hash Join | 1117.83 | 1003.66 | 10.2% | operator |
| 20421 | Hash | 0.02 | 15.71 | 82588.3% | operator |
| 20416 | Nested Loop | 1070.35 | 1204.98 | 12.6% | operator |
| 20419 | Hash | 35.77 | 55.57 | 55.4% | operator |
| 20422 | Seq Scan | 0.01 | 6.98 | 53582.3% | operator |
| 20417 | Seq Scan | 160.16 | 159.73 | 0.3% | operator |
| 20418 | Index Scan | 0.06 | -0.52 | 922.6% | operator |
| 20420 | Seq Scan | 27.51 | 26.64 | 3.2% | operator |
...
### Step 6: Node 20422 (Seq Scan) - LEAF
...
### Step 10: Node 20410 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20411, 20412, 20413
- **Input Features:**
