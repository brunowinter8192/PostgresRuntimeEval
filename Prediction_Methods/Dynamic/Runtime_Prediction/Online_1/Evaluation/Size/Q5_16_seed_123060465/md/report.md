...
**Test Query:** Q5_16_seed_123060465
...
```
Node 8041 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 8042 (Aggregate) [consumed]
    Node 8043 (Gather Merge) [consumed]
      Node 8044 (Aggregate)
        Node 8045 (Sort) [PATTERN: 3e2d5a00]
          Node 8046 (Hash Join) [consumed]
            Node 8047 (Nested Loop)
              Node 8048 (Hash Join)
                Node 8049 (Seq Scan) - LEAF
                Node 8050 (Hash) [PATTERN: 444761fb]
                  Node 8051 (Hash Join) [consumed]
                    Node 8052 (Seq Scan) [consumed] - LEAF
                    Node 8053 (Hash) [consumed]
                      Node 8054 (Hash Join) [consumed]
                        Node 8055 (Seq Scan) - LEAF
                        Node 8056 (Hash)
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 8050 | 8041, 8042, 8043, 8045, 8046, 8051, 8052, 8053, 8054 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 8041 | 8042, 8043, 8045, 8046, 8050, 8051, 8052, 8053, 8054 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 8045 | 8041, 8042, 8043, 8046, 8050, 8051, 8052, 8053, 8054 |
...
|------|------|--------|-----------|-----|--------|
| 8041 | Sort | 1097.85 | 2934.42 | 167.3% | pattern |
| 8044 | Aggregate | 1092.60 | 1128.78 | 3.3% | operator |
| 8045 | Sort | 1092.35 | 1835.91 | 68.1% | pattern |
| 8047 | Nested Loop | 1078.05 | 1188.39 | 10.2% | operator |
| 8059 | Hash | 4.74 | 18.67 | 294.2% | operator |
| 8048 | Hash Join | 219.01 | 253.07 | 15.6% | operator |
| 8058 | Index Scan | 0.07 | -0.22 | 393.4% | operator |
| 8060 | Seq Scan | 4.19 | 12.36 | 195.3% | operator |
| 8049 | Seq Scan | 169.68 | 159.81 | 5.8% | operator |
| 8050 | Hash | 36.53 | 46.85 | 28.2% | pattern |
| 8055 | Seq Scan | 0.01 | 11.81 | 117982.7% | operator |
| 8056 | Hash | 0.16 | 21.05 | 13058.3% | operator |
| 8057 | Seq Scan | 0.16 | 22.93 | 14414.8% | operator |
...
### Step 2: Node 8055 (Seq Scan) - LEAF
...
### Step 4: Node 8049 (Seq Scan) - LEAF
...
### Step 5: Node 8050 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 8041, 8042, 8043, 8045, 8046, 8051, 8052, 8053, 8054
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 8058 (Index Scan) - LEAF
...
### Step 8: Node 8060 (Seq Scan) - LEAF
...
### Step 11: Node 8045 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 8041, 8042, 8043, 8046, 8050, 8051, 8052, 8053, 8054
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 8041 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 8042, 8043, 8045, 8046, 8050, 8051, 8052, 8053, 8054
- **Input Features:**
