...
```
Node 18228 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18229 (Aggregate) [consumed]
    Node 18230 (Gather)
      Node 18231 (Aggregate)
        Node 18232 (Nested Loop)
          Node 18233 (Hash Join) [PATTERN: bb930825]
            Node 18234 (Seq Scan) [consumed] - LEAF
            Node 18235 (Hash) [consumed]
              Node 18236 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18233 | 18228, 18229, 18234, 18235, 18236 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18228 | 18229, 18233, 18234, 18235, 18236 |
...
|------|------|--------|-----------|-----|--------|
| 18228 | Sort | 1185.22 | 1046.01 | 11.7% | pattern |
...
| 18233 | Hash Join | 967.74 | 134.80 | 86.1% | pattern |
...
### Step 9: Node 18233 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18228, 18229, 18234, 18235, 18236
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18245 (Index Scan) - LEAF
...
### Step 11: Node 18232 (Nested Loop)
...
### Step 14: Node 18228 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18229, 18233, 18234, 18235, 18236
- **Input Features:**
