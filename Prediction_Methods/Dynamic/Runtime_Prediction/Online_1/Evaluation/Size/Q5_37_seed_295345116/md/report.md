...
**Test Query:** Q5_37_seed_295345116
...
```
Node 8501 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 8502 (Aggregate) [consumed]
    Node 8503 (Gather Merge) [consumed]
      Node 8504 (Aggregate)
        Node 8505 (Sort) [PATTERN: 3e2d5a00]
          Node 8506 (Hash Join) [consumed]
            Node 8507 (Nested Loop)
              Node 8508 (Hash Join)
                Node 8509 (Seq Scan) - LEAF
                Node 8510 (Hash) [PATTERN: 444761fb]
                  Node 8511 (Hash Join) [consumed]
                    Node 8512 (Seq Scan) [consumed] - LEAF
                    Node 8513 (Hash) [consumed]
                      Node 8514 (Hash Join) [consumed]
                        Node 8515 (Seq Scan) - LEAF
                        Node 8516 (Hash)
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 8510 | 8501, 8502, 8503, 8505, 8506, 8511, 8512, 8513, 8514 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 8501 | 8502, 8503, 8505, 8506, 8510, 8511, 8512, 8513, 8514 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 8505 | 8501, 8502, 8503, 8506, 8510, 8511, 8512, 8513, 8514 |
...
|------|------|--------|-----------|-----|--------|
| 8501 | Sort | 1073.48 | 2934.42 | 173.4% | pattern |
| 8504 | Aggregate | 1068.38 | 1128.74 | 5.7% | operator |
| 8505 | Sort | 1068.12 | 1835.96 | 71.9% | pattern |
| 8507 | Nested Loop | 1056.37 | 1188.57 | 12.5% | operator |
| 8519 | Hash | 3.24 | 18.67 | 476.5% | operator |
| 8508 | Hash Join | 215.48 | 253.07 | 17.4% | operator |
| 8518 | Index Scan | 0.07 | -0.22 | 397.3% | operator |
| 8520 | Seq Scan | 2.71 | 12.36 | 356.4% | operator |
| 8509 | Seq Scan | 165.93 | 159.81 | 3.7% | operator |
| 8510 | Hash | 35.75 | 46.85 | 31.0% | pattern |
| 8515 | Seq Scan | 0.01 | 11.81 | 107247.9% | operator |
| 8516 | Hash | 0.11 | 21.05 | 19214.9% | operator |
| 8517 | Seq Scan | 0.10 | 22.93 | 21741.3% | operator |
...
### Step 2: Node 8515 (Seq Scan) - LEAF
...
### Step 4: Node 8509 (Seq Scan) - LEAF
...
### Step 5: Node 8510 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 8501, 8502, 8503, 8505, 8506, 8511, 8512, 8513, 8514
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 8518 (Index Scan) - LEAF
...
### Step 8: Node 8520 (Seq Scan) - LEAF
...
### Step 11: Node 8505 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 8501, 8502, 8503, 8506, 8510, 8511, 8512, 8513, 8514
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 8501 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 8502, 8503, 8505, 8506, 8510, 8511, 8512, 8513, 8514
- **Input Features:**
