...
```
Node 15110 (Aggregate) - ROOT
  Node 15111 (Gather Merge)
    Node 15112 (Sort)
          ...
          Node 15115 (Hash Join)
            Node 15116 (Nested Loop)
              Node 15117 (Hash Join)
                ...
                Node 15119 (Hash)
                  Node 15120 (Hash Join)
                    Node 15121 (Seq Scan) - LEAF
                    Node 15122 (Hash)
                      Node 15123 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 15110 | Aggregate | 1237.06 | 1194.89 | 3.4% | operator |
| 15111 | Gather Merge | 1236.68 | 1097.13 | 11.3% | operator |
...
| 15117 | Hash Join | 219.51 | 251.17 | 14.4% | operator |
...
| 15119 | Hash | 43.81 | 20.62 | 52.9% | operator |
| 15120 | Hash Join | 43.08 | 132.26 | 207.0% | operator |
| 15121 | Seq Scan | 41.46 | 23.03 | 44.5% | operator |
| 15122 | Hash | 0.16 | 23.66 | 14967.6% | operator |
| 15123 | Hash Join | 0.15 | 306.84 | 199144.1% | operator |
...
### Step 5: Node 15121 (Seq Scan) - LEAF
...
### Step 8: Node 15118 (Seq Scan) - LEAF
...
### Step 11: Node 15127 (Index Scan) - LEAF
...
### Step 12: Node 15129 (Seq Scan) - LEAF
...
### Step 13: Node 15116 (Nested Loop)
...
### Step 16: Node 15130 (Index Scan) - LEAF
...
### Step 17: Node 15132 (Seq Scan) - LEAF
...
### Step 18: Node 15114 (Nested Loop)
...
### Step 22: Node 15111 (Gather Merge)
...
- **Input Features:**
  ...
  - total_cost=71836.4000
- **Output:** st=1093.42, rt=1097.13

### Step 23: Node 15110 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=71550.5800
  - total_cost=71932.8400
- **Output:** st=1163.89, rt=1194.89
