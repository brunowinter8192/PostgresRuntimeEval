...
**Test Query:** Q19_28_seed_221508837
...
```
Node 31710 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31711 (Gather) [consumed]
    Node 31712 (Aggregate) [consumed]
      Node 31713 (Hash Join) [consumed]
        Node 31714 (Seq Scan) - LEAF
        Node 31715 (Hash)
          Node 31716 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31710 | 31711, 31712, 31713 |
...
|------|------|--------|-----------|-----|--------|
| 31710 | Aggregate | 857.19 | 829.30 | 3.3% | pattern |
| 31714 | Seq Scan | 787.18 | 743.46 | 5.6% | operator |
| 31715 | Hash | 45.66 | 8.29 | 81.9% | operator |
| 31716 | Seq Scan | 45.52 | 23.76 | 47.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31716 (Seq Scan) - LEAF
...
### Step 2: Node 31714 (Seq Scan) - LEAF
...
### Step 4: Node 31710 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31711, 31712, 31713
- **Input Features:**
  ...
  - HashJoin_Outer_total_cost=156338.7300
