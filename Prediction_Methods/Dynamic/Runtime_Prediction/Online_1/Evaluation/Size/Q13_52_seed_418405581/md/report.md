...
```
Node 26049 (Sort) - ROOT
  Node 26050 (Aggregate)
    Node 26051 (Aggregate)
      Node 26052 (Hash Join)
        Node 26053 (Seq Scan) - LEAF
        Node 26054 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 26049 | Sort | 942.39 | 1081.93 | 14.8% | operator |
| 26050 | Aggregate | 942.37 | 1000.34 | 6.2% | operator |
| 26051 | Aggregate | 936.34 | 1014.18 | 8.3% | operator |
| 26052 | Hash Join | 722.80 | 787.83 | 9.0% | operator |
| 26053 | Seq Scan | 504.52 | 264.12 | 47.7% | operator |
| 26054 | Hash | 19.76 | 80.15 | 305.5% | operator |
...
### Step 2: Node 26053 (Seq Scan) - LEAF
