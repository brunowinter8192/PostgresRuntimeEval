...
**Test Query:** Q13_52_seed_418405581
...
```
Node 26049 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26050 (Aggregate) [consumed]
    Node 26051 (Aggregate)
      Node 26052 (Hash Join) [PATTERN: 895c6e8c]
        Node 26053 (Seq Scan) [consumed] - LEAF
        Node 26054 (Hash) [consumed]
          Node 26055 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26049 | 26050, 26052, 26053, 26054 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26052 | 26049, 26050, 26053, 26054 |
...
|------|------|--------|-----------|-----|--------|
| 26049 | Sort | 942.39 | 1079.93 | 14.6% | pattern |
| 26051 | Aggregate | 936.34 | 999.55 | 6.8% | operator |
| 26052 | Hash Join | 722.80 | 470.31 | 34.9% | pattern |
| 26055 | Index Only Scan | 10.19 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26055 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26052 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26049, 26050, 26053, 26054
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1484970
...
### Step 4: Node 26049 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26050, 26052, 26053, 26054
- **Input Features:**
