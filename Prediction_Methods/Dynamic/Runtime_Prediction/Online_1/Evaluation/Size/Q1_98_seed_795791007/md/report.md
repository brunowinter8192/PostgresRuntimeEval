...
**Test Query:** Q1_98_seed_795791007
...
```
Node 736 (Aggregate) - ROOT
  Node 737 (Gather Merge)
    Node 738 (Sort) [PATTERN: 1d35fb97]
      Node 739 (Aggregate) [consumed]
        Node 740 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 738 | 739 |
...
|------|------|--------|-----------|-----|--------|
| 736 | Aggregate | 947.62 | 1195.77 | 26.2% | operator |
| 737 | Gather Merge | 947.58 | 1165.87 | 23.0% | operator |
| 738 | Sort | 928.10 | 1200.04 | 29.3% | pattern |
| 740 | Seq Scan | 516.91 | 682.02 | 31.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 740 (Seq Scan) - LEAF
...
### Step 2: Node 738 (Sort) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Aggregate_Outer_total_cost=168649.3500
  - Sort_np=0
  - Sort_nt=6
  - Sort_nt1=6
  - Sort_nt2=0
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=168649.4300
  - Sort_total_cost=168649.4500
- **Output:** st=1195.94, rt=1200.04

### Step 3: Node 737 (Gather Merge)
...
### Step 4: Node 736 (Aggregate) - ROOT
