...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5181 | 5182, 5183, 5184 |
...
| 5185 | Nested Loop | 1172.70 | 1193.21 | 1.7% | operator |
| 5186 | Hash Join | 205.75 | 231.13 | 12.3% | operator |
| 5190 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5187 | Seq Scan | 155.75 | 163.51 | 5.0% | operator |
| 5188 | Hash | 27.38 | 17.75 | 35.2% | operator |
...
### Step 2: Node 5187 (Seq Scan) - LEAF
...
- **Output:** st=0.29, rt=163.51

### Step 3: Node 5188 (Hash)
...
- **Input Features:**
  ...
  - total_cost=37343.3900
- **Output:** st=27.26, rt=231.13

### Step 5: Node 5190 (Index Scan) - LEAF
...
- **Output:** st=121.90, rt=1193.21

### Step 7: Node 5181 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5182, 5183, 5184
- **Input Features:**
