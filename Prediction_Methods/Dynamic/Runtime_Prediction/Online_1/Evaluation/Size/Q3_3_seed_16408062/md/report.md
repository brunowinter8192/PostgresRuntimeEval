...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5181 | 5182, 5183, 5184, 5186, 5187, 5188 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5186 | 5181, 5182, 5183, 5184, 5187, 5188 |
...
|------|------|--------|-----------|-----|--------|
| 5181 | Limit | 1210.48 | 1151.18 | 4.9% | pattern |
| 5185 | Nested Loop | 1172.70 | 1193.29 | 1.8% | operator |
| 5186 | Hash Join | 205.75 | 242.52 | 17.9% | pattern |
| 5190 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5189 | Seq Scan | 26.42 | 38.57 | 46.0% | operator |
...
- **Consumes:** Nodes 5181, 5182, 5183, 5184, 5187, 5188
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47290
  - HashJoin_nt1=236853
...
- **Output:** st=29.69, rt=242.52

### Step 3: Node 5190 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=73087.3000
- **Output:** st=122.04, rt=1193.29

### Step 5: Node 5181 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5182, 5183, 5184, 5186, 5187, 5188
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=313618
  - Aggregate_Outer_nt1=313618
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110153.3700
  - Aggregate_Outer_total_cost=114073.6000
  - Gather_Outer_np=0
  - Gather_Outer_nt=313618
  - Gather_Outer_nt1=101167
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105449.1000
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=313618
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=120850.7700
  - Limit_total_cost=120850.7900
  - Sort_Outer_np=0
  - Sort_Outer_nt=313618
  - Sort_Outer_nt1=313618
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=120850.7700
  - Sort_Outer_total_cost=121634.8100
