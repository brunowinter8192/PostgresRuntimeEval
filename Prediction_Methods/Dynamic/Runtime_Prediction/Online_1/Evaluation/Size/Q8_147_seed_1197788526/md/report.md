...
**Test Query:** Q8_147_seed_1197788526
...
```
Node 14374 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 14375 (Gather Merge) [consumed]
    Node 14376 (Sort)
      Node 14377 (Hash Join)
        Node 14378 (Nested Loop)
          Node 14379 (Hash Join)
            Node 14380 (Nested Loop)
              Node 14381 (Hash Join)
                Node 14382 (Seq Scan) - LEAF
                Node 14383 (Hash) [PATTERN: 444761fb]
                  Node 14384 (Hash Join) [consumed]
                    Node 14385 (Seq Scan) [consumed] - LEAF
                    Node 14386 (Hash) [consumed]
                      Node 14387 (Hash Join) [consumed]
                        Node 14388 (Seq Scan) - LEAF
                        Node 14389 (Hash)
                          Node 14390 (Seq Scan) - LEAF
              Node 14391 (Index Scan) - LEAF
            Node 14392 (Hash)
              Node 14393 (Seq Scan) - LEAF
          Node 14394 (Index Scan) - LEAF
        Node 14395 (Hash)
          Node 14396 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 14383 | 14374, 14375, 14384, 14385, 14386, 14387 |
| Aggregate -> Gather Merge (Out | 2724c080 | 14374 | 14375, 14383, 14384, 14385, 14386, 14387 |
...
|------|------|--------|-----------|-----|--------|
| 14374 | Aggregate | 1230.48 | 1131.48 | 8.0% | pattern |
| 14376 | Sort | 1225.22 | 1046.21 | 14.6% | operator |
| 14377 | Hash Join | 1225.00 | 785.61 | 35.9% | operator |
| 14378 | Nested Loop | 1224.69 | 1198.29 | 2.2% | operator |
| 14395 | Hash | 0.02 | 13.72 | 80629.9% | operator |
| 14379 | Hash Join | 1220.99 | 785.60 | 35.7% | operator |
| 14394 | Index Scan | 0.01 | 12.42 | 206958.1% | operator |
| 14396 | Seq Scan | 0.01 | 6.51 | 54166.4% | operator |
| 14380 | Nested Loop | 1175.81 | 1198.29 | 1.9% | operator |
| 14392 | Hash | 40.59 | 19.97 | 50.8% | operator |
| 14381 | Hash Join | 216.06 | 251.67 | 16.5% | operator |
| 14391 | Index Scan | 0.04 | 2.88 | 6759.2% | operator |
| 14393 | Seq Scan | 40.48 | 48.87 | 20.7% | operator |
| 14382 | Seq Scan | 159.76 | 159.67 | 0.1% | operator |
| 14383 | Hash | 37.85 | 43.51 | 15.0% | pattern |
| 14388 | Seq Scan | 0.01 | 12.22 | 81399.6% | operator |
| 14389 | Hash | 0.14 | 18.14 | 13143.9% | operator |
| 14390 | Seq Scan | 0.13 | 23.36 | 17465.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 14390 (Seq Scan) - LEAF
...
### Step 2: Node 14388 (Seq Scan) - LEAF
...
### Step 4: Node 14382 (Seq Scan) - LEAF
...
### Step 5: Node 14383 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 14374, 14375, 14384, 14385, 14386, 14387
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 14391 (Index Scan) - LEAF
...
### Step 8: Node 14393 (Seq Scan) - LEAF
...
### Step 12: Node 14394 (Index Scan) - LEAF
...
### Step 13: Node 14396 (Seq Scan) - LEAF
...
### Step 14: Node 14378 (Nested Loop)
...
### Step 18: Node 14374 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 14375, 14383, 14384, 14385, 14386, 14387
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2449
