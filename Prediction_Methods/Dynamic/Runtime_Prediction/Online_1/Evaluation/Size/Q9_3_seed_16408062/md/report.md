    ...
    Node 18157 (Gather)
      Node 18158 (Aggregate)
        Node 18159 (Hash Join)
          ...
          Node 18161 (Hash) [PATTERN: 444761fb]
            Node 18162 (Hash Join) [consumed]
              Node 18163 (Seq Scan) [consumed] - LEAF
              Node 18164 (Hash) [consumed]
                Node 18165 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 18161 | 18155, 18156, 18162, 18163, 18164, 18165 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18155 | 18156, 18161, 18162, 18163, 18164, 18165 |
...
|------|------|--------|-----------|-----|--------|
| 18155 | Sort | 1277.53 | 1063.12 | 16.8% | pattern |
| 18157 | Gather | 1276.67 | 962.19 | 24.6% | operator |
| 18158 | Aggregate | 1256.04 | 922.12 | 26.6% | operator |
| 18159 | Hash Join | 1227.70 | 571.38 | 53.5% | operator |
| 18160 | Seq Scan | 131.10 | 193.40 | 47.5% | operator |
| 18161 | Hash | 1034.31 | 35.69 | 96.5% | pattern |
| 18166 | Hash Join | 192.89 | 837.74 | 334.3% | operator |
| 18172 | Hash | 15.05 | 14.95 | 0.7% | operator |
| 18167 | Nested Loop | 187.29 | 1251.77 | 568.4% | operator |
| 18170 | Hash | 3.07 | 15.94 | 419.2% | operator |
| 18173 | Seq Scan | 15.04 | 2.94 | 80.5% | operator |
| 18168 | Seq Scan | 23.91 | 43.69 | 82.8% | operator |
| 18169 | Index Scan | 0.06 | -1.39 | 2414.2% | operator |
| 18171 | Seq Scan | 2.66 | 9.45 | 255.6% | operator |
...
### Step 9: Node 18160 (Seq Scan) - LEAF
...
### Step 10: Node 18161 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 18155, 18156, 18162, 18163, 18164, 18165
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 14: Node 18155 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18156, 18161, 18162, 18163, 18164, 18165
- **Input Features:**
