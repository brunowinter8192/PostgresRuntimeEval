...
**Test Query:** Q4_112_seed_910647441
...
```
Node 5942 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 5943 (Gather Merge) [consumed]
    Node 5944 (Sort) [consumed]
      Node 5945 (Aggregate) [consumed]
        Node 5946 (Nested Loop)
          Node 5947 (Seq Scan) - LEAF
          Node 5948 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 5942 | 5943, 5944, 5945 |
...
|------|------|--------|-----------|-----|--------|
| 5942 | Aggregate | 1048.73 | 952.19 | 9.2% | pattern |
| 5946 | Nested Loop | 1041.02 | 1255.45 | 20.6% | operator |
| 5947 | Seq Scan | 164.35 | 154.67 | 5.9% | operator |
| 5948 | Index Scan | 0.06 | 11.10 | 17810.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5947 (Seq Scan) - LEAF
...
### Step 2: Node 5948 (Index Scan) - LEAF
