...
**Test Query:** Q12_82_seed_664526511
...
```
Node 25230 (Aggregate) - ROOT
  Node 25231 (Gather Merge)
    Node 25232 (Aggregate)
      Node 25233 (Sort)
        Node 25234 (Nested Loop)
          Node 25235 (Seq Scan) - LEAF
          Node 25236 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 25230 | Aggregate | 1019.82 | 919.05 | 9.9% | operator |
| 25231 | Gather Merge | 1019.73 | 1111.84 | 9.0% | operator |
| 25232 | Aggregate | 999.41 | 895.30 | 10.4% | operator |
| 25233 | Sort | 998.77 | 1092.82 | 9.4% | operator |
| 25234 | Nested Loop | 997.73 | 1127.41 | 13.0% | operator |
| 25235 | Seq Scan | 854.22 | 745.19 | 12.8% | operator |
| 25236 | Index Scan | 0.03 | 0.07 | 166.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25235 (Seq Scan) - LEAF
...
### Step 2: Node 25236 (Index Scan) - LEAF
...
### Step 6: Node 25231 (Gather Merge)
...
### Step 7: Node 25230 (Aggregate) - ROOT
