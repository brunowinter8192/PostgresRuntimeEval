...
**Test Query:** Q13_25_seed_196896744
...
```
Node 25839 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25840 (Aggregate) [consumed]
    Node 25841 (Aggregate)
      Node 25842 (Hash Join) [PATTERN: 895c6e8c]
        Node 25843 (Seq Scan) [consumed] - LEAF
        Node 25844 (Hash) [consumed]
          Node 25845 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25839 | 25840, 25842, 25843, 25844 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25842 | 25839, 25840, 25843, 25844 |
...
|------|------|--------|-----------|-----|--------|
| 25839 | Sort | 908.08 | 1079.94 | 18.9% | pattern |
| 25841 | Aggregate | 901.87 | 999.76 | 10.9% | operator |
| 25842 | Hash Join | 705.43 | 470.31 | 33.3% | pattern |
| 25845 | Index Only Scan | 14.05 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25845 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25842 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25839, 25840, 25843, 25844
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 25839 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25840, 25842, 25843, 25844
- **Input Features:**
