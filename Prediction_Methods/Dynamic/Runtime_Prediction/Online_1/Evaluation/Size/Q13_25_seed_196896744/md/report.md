...
```
Node 25839 (Sort) - ROOT
  Node 25840 (Aggregate)
    Node 25841 (Aggregate)
      Node 25842 (Hash Join)
        Node 25843 (Seq Scan) - LEAF
        Node 25844 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 25839 | Sort | 908.08 | 1081.93 | 19.1% | operator |
| 25840 | Aggregate | 908.04 | 1000.33 | 10.2% | operator |
| 25841 | Aggregate | 901.87 | 1014.39 | 12.5% | operator |
| 25842 | Hash Join | 705.43 | 787.83 | 11.7% | operator |
| 25843 | Seq Scan | 503.38 | 264.19 | 47.5% | operator |
| 25844 | Hash | 23.12 | 80.15 | 246.6% | operator |
...
### Step 2: Node 25843 (Seq Scan) - LEAF
