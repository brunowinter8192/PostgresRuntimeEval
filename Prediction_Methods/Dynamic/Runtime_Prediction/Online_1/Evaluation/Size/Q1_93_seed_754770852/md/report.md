...
Node 711 (Aggregate) - ROOT
  Node 712 (Gather Merge)
    Node 713 (Sort) [PATTERN: 1d35fb97]
      Node 714 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 713 | 714 |
...
|------|------|--------|-----------|-----|--------|
| 711 | Aggregate | 941.77 | 1195.92 | 27.0% | operator |
| 712 | Gather Merge | 941.72 | 1165.92 | 23.8% | operator |
| 713 | Sort | 925.60 | 1200.63 | 29.7% | pattern |
...
### Step 2: Node 713 (Sort) - PATTERN ROOT
...
### Step 4: Node 711 (Aggregate) - ROOT
