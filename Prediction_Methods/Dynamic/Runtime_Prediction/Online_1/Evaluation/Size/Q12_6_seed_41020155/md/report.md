...
**Test Query:** Q12_6_seed_41020155
...
```
Node 25132 (Aggregate) - ROOT
  Node 25133 (Gather Merge)
    Node 25134 (Aggregate)
      Node 25135 (Sort)
        Node 25136 (Nested Loop)
          Node 25137 (Seq Scan) - LEAF
          Node 25138 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 25132 | Aggregate | 1002.57 | 919.07 | 8.3% | operator |
| 25133 | Gather Merge | 1002.56 | 1111.84 | 10.9% | operator |
| 25134 | Aggregate | 981.32 | 895.31 | 8.8% | operator |
| 25135 | Sort | 980.70 | 1092.81 | 11.4% | operator |
| 25136 | Nested Loop | 979.77 | 1127.41 | 15.1% | operator |
| 25137 | Seq Scan | 840.74 | 745.19 | 11.4% | operator |
| 25138 | Index Scan | 0.03 | 0.07 | 166.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25137 (Seq Scan) - LEAF
...
### Step 2: Node 25138 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - st2=0.1246
  - startup_cost=0.4300
  - total_cost=147157.7700
- **Output:** st=38.33, rt=1127.41

### Step 4: Node 25135 (Sort)
...
- **Input Features:**
  ...
  - st1=38.3270
  - st2=0.0000
  - startup_cost=147517.4000
  - total_cost=147531.7900
- **Output:** st=1092.39, rt=1092.81

### Step 5: Node 25134 (Aggregate)
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=147517.4000
  - total_cost=147632.6300
- **Output:** st=868.97, rt=895.31

### Step 6: Node 25133 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=868.9674
  - st2=0.0000
  - startup_cost=148517.4700
  - total_cost=148636.9200
- **Output:** st=1109.22, rt=1111.84

### Step 7: Node 25132 (Aggregate) - ROOT
