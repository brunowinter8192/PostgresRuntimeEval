...
```
Node 26966 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26967 (Gather) [consumed]
    Node 26968 (Aggregate) [consumed]
      Node 26969 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26966 | 26967, 26968, 26969 |
...
|------|------|--------|-----------|-----|--------|
| 26966 | Aggregate | 849.78 | 857.13 | 0.9% | pattern |
| 26970 | Seq Scan | 776.98 | 758.48 | 2.4% | operator |
| 26971 | Hash | 43.56 | 9.38 | 78.5% | operator |
| 26972 | Seq Scan | 36.41 | 12.70 | 65.1% | operator |
...
### Step 4: Node 26966 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26967, 26968, 26969
- **Input Features:**
