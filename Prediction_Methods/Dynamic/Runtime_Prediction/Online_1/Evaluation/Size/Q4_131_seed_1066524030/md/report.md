...
**Test Query:** Q4_131_seed_1066524030
**Timestamp:** 2026-01-18 16:30:46
...
```
Node 6089 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6090 (Gather Merge) [consumed]
    Node 6091 (Sort) [consumed]
      Node 6092 (Aggregate) [consumed]
        Node 6093 (Nested Loop)
          Node 6094 (Seq Scan) - LEAF
          Node 6095 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6089 | 6090, 6091, 6092 |
...
|------|------|--------|-----------|-----|--------|
| 6089 | Aggregate | 1065.54 | 952.19 | 10.6% | pattern |
| 6093 | Nested Loop | 1058.82 | 1255.45 | 18.6% | operator |
| 6094 | Seq Scan | 165.90 | 154.66 | 6.8% | operator |
| 6095 | Index Scan | 0.06 | 11.10 | 17810.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6094 (Seq Scan) - LEAF
...
### Step 2: Node 6095 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - Aggregate_startup_cost=66907.1900
  - Aggregate_total_cost=66909.0900
  ...
  - GatherMerge_Outer_startup_cost=66907.1900
  - GatherMerge_Outer_total_cost=66908.9600
  - Sort_Outer_np=0
  - Sort_Outer_nt=5
  - Sort_Outer_nt1=5
  - Sort_Outer_nt2=0
  ...
  - Sort_Outer_startup_cost=65907.1500
  - Sort_Outer_total_cost=65907.1600
