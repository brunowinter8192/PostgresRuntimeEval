    ...
    Node 4783 (Aggregate) [consumed]
      Node 4784 (Gather) [consumed]
        Node 4785 (Nested Loop)
          Node 4786 (Hash Join) [PATTERN: 895c6e8c]
            Node 4787 (Seq Scan) [consumed] - LEAF
            Node 4788 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4781 | 4782, 4783, 4784, 4786, 4787, 4788 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4786 | 4781, 4782, 4783, 4784, 4787, 4788 |
...
| 4785 | Nested Loop | 1170.06 | 1192.75 | 1.9% | operator |
| 4786 | Hash Join | 206.48 | 242.42 | 17.4% | pattern |
...
### Step 2: Node 4786 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4781, 4782, 4783, 4784, 4787, 4788
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46457
  - HashJoin_nt1=232682
...
### Step 3: Node 4790 (Index Scan) - LEAF
...
### Step 5: Node 4781 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4782, 4783, 4784, 4786, 4787, 4788
- **Input Features:**
