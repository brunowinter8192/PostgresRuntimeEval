...
**Test Query:** Q4_52_seed_418405581
**Timestamp:** 2026-01-18 16:37:40
...
```
Node 6530 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6531 (Gather Merge) [consumed]
    Node 6532 (Sort) [consumed]
      Node 6533 (Aggregate) [consumed]
        Node 6534 (Nested Loop)
          Node 6535 (Seq Scan) - LEAF
          Node 6536 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6530 | 6531, 6532, 6533 |
...
|------|------|--------|-----------|-----|--------|
| 6530 | Aggregate | 1065.34 | 952.19 | 10.6% | pattern |
| 6534 | Nested Loop | 1058.68 | 1255.45 | 18.6% | operator |
| 6535 | Seq Scan | 164.31 | 154.66 | 5.9% | operator |
| 6536 | Index Scan | 0.06 | 11.10 | 17810.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6535 (Seq Scan) - LEAF
...
### Step 2: Node 6536 (Index Scan) - LEAF
