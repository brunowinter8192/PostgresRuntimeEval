...
**Test Query:** Q5_101_seed_820403100
...
```
Node 6921 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 6922 (Aggregate) [consumed]
    Node 6923 (Gather Merge) [consumed]
      Node 6924 (Aggregate)
        Node 6925 (Sort) [PATTERN: 3e2d5a00]
          Node 6926 (Hash Join) [consumed]
            Node 6927 (Nested Loop)
              Node 6928 (Hash Join)
                Node 6929 (Seq Scan) - LEAF
                Node 6930 (Hash) [PATTERN: 444761fb]
                  Node 6931 (Hash Join) [consumed]
                    Node 6932 (Seq Scan) [consumed] - LEAF
                    Node 6933 (Hash) [consumed]
                      Node 6934 (Hash Join) [consumed]
                        Node 6935 (Seq Scan) - LEAF
                        Node 6936 (Hash)
                          Node 6937 (Seq Scan) - LEAF
              Node 6938 (Index Scan) - LEAF
            Node 6939 (Hash)
              Node 6940 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 6930 | 6921, 6922, 6923, 6925, 6926, 6931, 6932, 6933, 6934 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 6921 | 6922, 6923, 6925, 6926, 6930, 6931, 6932, 6933, 6934 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 6925 | 6921, 6922, 6923, 6926, 6930, 6931, 6932, 6933, 6934 |
...
|------|------|--------|-----------|-----|--------|
| 6921 | Sort | 1063.12 | 2934.42 | 176.0% | pattern |
| 6924 | Aggregate | 1058.02 | 1128.76 | 6.7% | operator |
| 6925 | Sort | 1057.76 | 1835.93 | 73.6% | pattern |
| 6927 | Nested Loop | 1045.55 | 1188.47 | 13.7% | operator |
| 6939 | Hash | 3.72 | 18.67 | 401.6% | operator |
| 6928 | Hash Join | 213.73 | 253.07 | 18.4% | operator |
| 6938 | Index Scan | 0.07 | -0.22 | 401.4% | operator |
| 6940 | Seq Scan | 3.23 | 12.36 | 282.9% | operator |
| 6929 | Seq Scan | 166.54 | 159.81 | 4.0% | operator |
| 6930 | Hash | 33.22 | 46.85 | 41.1% | pattern |
| 6935 | Seq Scan | 0.01 | 11.81 | 131103.0% | operator |
| 6936 | Hash | 0.06 | 21.05 | 37495.1% | operator |
| 6937 | Seq Scan | 0.05 | 22.93 | 42369.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6937 (Seq Scan) - LEAF
...
### Step 2: Node 6935 (Seq Scan) - LEAF
...
### Step 4: Node 6929 (Seq Scan) - LEAF
...
### Step 5: Node 6930 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 6921, 6922, 6923, 6925, 6926, 6931, 6932, 6933, 6934
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 6938 (Index Scan) - LEAF
...
### Step 8: Node 6940 (Seq Scan) - LEAF
...
### Step 11: Node 6925 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 6921, 6922, 6923, 6926, 6930, 6931, 6932, 6933, 6934
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 6921 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 6922, 6923, 6925, 6926, 6930, 6931, 6932, 6933, 6934
- **Input Features:**
