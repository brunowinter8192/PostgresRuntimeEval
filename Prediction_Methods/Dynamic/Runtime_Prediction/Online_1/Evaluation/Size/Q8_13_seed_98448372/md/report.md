...
**Test Query:** Q8_13_seed_98448372
...
```
Node 14190 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 14191 (Gather Merge) [consumed]
    Node 14192 (Sort)
      Node 14193 (Hash Join)
        Node 14194 (Nested Loop)
          Node 14195 (Hash Join)
            Node 14196 (Nested Loop)
              Node 14197 (Hash Join)
                Node 14198 (Seq Scan) - LEAF
                Node 14199 (Hash) [PATTERN: 444761fb]
                  Node 14200 (Hash Join) [consumed]
                    Node 14201 (Seq Scan) [consumed] - LEAF
                    Node 14202 (Hash) [consumed]
                      Node 14203 (Hash Join) [consumed]
                        Node 14204 (Seq Scan) - LEAF
                        Node 14205 (Hash)
                          Node 14206 (Seq Scan) - LEAF
              Node 14207 (Index Scan) - LEAF
            Node 14208 (Hash)
              Node 14209 (Seq Scan) - LEAF
          Node 14210 (Index Scan) - LEAF
        Node 14211 (Hash)
          Node 14212 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 14199 | 14190, 14191, 14200, 14201, 14202, 14203 |
| Aggregate -> Gather Merge (Out | 2724c080 | 14190 | 14191, 14199, 14200, 14201, 14202, 14203 |
...
|------|------|--------|-----------|-----|--------|
| 14190 | Aggregate | 1205.32 | 1133.68 | 5.9% | pattern |
| 14192 | Sort | 1197.97 | 1046.21 | 12.7% | operator |
| 14193 | Hash Join | 1197.74 | 785.61 | 34.4% | operator |
| 14194 | Nested Loop | 1197.45 | 1198.29 | 0.1% | operator |
| 14211 | Hash | 0.01 | 13.72 | 97929.2% | operator |
| 14195 | Hash Join | 1193.69 | 785.60 | 34.2% | operator |
| 14210 | Index Scan | 0.01 | 12.42 | 206958.1% | operator |
| 14212 | Seq Scan | 0.01 | 6.51 | 59099.7% | operator |
| 14196 | Nested Loop | 1149.40 | 1198.29 | 4.3% | operator |
| 14208 | Hash | 39.94 | 19.97 | 50.0% | operator |
| 14197 | Hash Join | 218.70 | 251.67 | 15.1% | operator |
| 14207 | Index Scan | 0.04 | 2.88 | 7102.1% | operator |
| 14209 | Seq Scan | 39.81 | 48.88 | 22.8% | operator |
| 14198 | Seq Scan | 162.19 | 159.67 | 1.6% | operator |
| 14199 | Hash | 37.97 | 43.51 | 14.6% | pattern |
| 14204 | Seq Scan | 0.01 | 12.22 | 93938.0% | operator |
| 14205 | Hash | 0.18 | 18.14 | 9760.9% | operator |
| 14206 | Seq Scan | 0.18 | 23.36 | 12807.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 14206 (Seq Scan) - LEAF
...
### Step 2: Node 14204 (Seq Scan) - LEAF
...
### Step 4: Node 14198 (Seq Scan) - LEAF
...
### Step 5: Node 14199 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 14190, 14191, 14200, 14201, 14202, 14203
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 14207 (Index Scan) - LEAF
...
### Step 8: Node 14209 (Seq Scan) - LEAF
...
### Step 12: Node 14210 (Index Scan) - LEAF
...
### Step 13: Node 14212 (Seq Scan) - LEAF
...
### Step 14: Node 14194 (Nested Loop)
...
### Step 18: Node 14190 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 14191, 14199, 14200, 14201, 14202, 14203
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2343
  - Aggregate_nt1=2343
