...
**Test Query:** Q6_85_seed_689138604
...
```
Node 10433 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10434 (Gather) [consumed]
    Node 10435 (Aggregate) [consumed]
      Node 10436 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10433 | 10434, 10435 |
...
|------|------|--------|-----------|-----|--------|
| 10433 | Aggregate | 834.73 | 850.04 | 1.8% | pattern |
| 10436 | Seq Scan | 814.92 | 748.53 | 8.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10436 (Seq Scan) - LEAF
...
### Step 2: Node 10433 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10434, 10435
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=23489
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=32
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=139722.9200
  - Aggregate_Outer_total_cost=139722.9300
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=140723.4500
  - Aggregate_total_cost=140723.4600
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=140722.9200
  - Gather_Outer_total_cost=140723.4300
