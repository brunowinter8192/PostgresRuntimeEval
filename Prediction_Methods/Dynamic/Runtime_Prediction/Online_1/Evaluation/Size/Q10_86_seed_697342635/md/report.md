    ...
    Node 21114 (Aggregate) [consumed]
      Node 21115 (Gather) [consumed]
        Node 21116 (Hash Join)
          Node 21117 (Hash Join)
            Node 21118 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 21112 | 21113, 21114, 21115 |
...
| 21116 | Hash Join | 1106.90 | 1007.13 | 9.0% | operator |
| 21117 | Hash Join | 1103.93 | 1003.98 | 9.1% | operator |
| 21123 | Hash | 0.02 | 15.71 | 92316.3% | operator |
| 21118 | Nested Loop | 1059.65 | 1204.86 | 13.7% | operator |
| 21121 | Hash | 33.27 | 55.57 | 67.0% | operator |
...
### Step 6: Node 21124 (Seq Scan) - LEAF
...
### Step 10: Node 21112 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 21113, 21114, 21115
- **Input Features:**
