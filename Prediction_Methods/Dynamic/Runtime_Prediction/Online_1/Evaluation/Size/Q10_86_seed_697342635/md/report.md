...
**Test Query:** Q10_86_seed_697342635
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 21112 | 21113, 21114, 21115, 21117, 21118, 21121 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 21117 | 21112, 21113, 21114, 21115, 21118, 21121 |
...
|------|------|--------|-----------|-----|--------|
| 21112 | Limit | 1151.79 | 1199.47 | 4.1% | pattern |
| 21116 | Hash Join | 1106.90 | 1095.57 | 1.0% | operator |
| 21117 | Hash Join | 1103.93 | 1120.19 | 1.5% | pattern |
| 21123 | Hash | 0.02 | 15.71 | 92316.3% | operator |
| 21124 | Seq Scan | 0.01 | 6.98 | 53582.3% | operator |
| 21119 | Seq Scan | 162.92 | 159.74 | 2.0% | operator |
| 21120 | Index Scan | 0.06 | -0.52 | 922.6% | operator |
| 21122 | Seq Scan | 24.98 | 26.64 | 6.7% | operator |
...
### Step 4: Node 21124 (Seq Scan) - LEAF
...
- **Consumes:** Nodes 21112, 21113, 21114, 21115, 21118, 21121
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18257
  - HashJoin_nt1=18257
...
### Step 8: Node 21112 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 21113, 21114, 21115, 21117, 21118, 21121
- **Input Features:**
