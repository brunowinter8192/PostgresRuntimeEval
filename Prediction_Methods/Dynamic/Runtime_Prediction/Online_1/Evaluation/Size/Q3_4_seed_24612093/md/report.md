...
```
Node 5291 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5292 (Sort) [consumed]
    Node 5293 (Aggregate) [consumed]
      Node 5294 (Gather) [consumed]
        Node 5295 (Nested Loop)
          Node 5296 (Hash Join) [PATTERN: 895c6e8c]
            Node 5297 (Seq Scan) [consumed] - LEAF
            Node 5298 (Hash) [consumed]
              Node 5299 (Seq Scan) - LEAF
          Node 5300 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5291 | 5292, 5293, 5294, 5296, 5297, 5298 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5296 | 5291, 5292, 5293, 5294, 5297, 5298 |
...
|------|------|--------|-----------|-----|--------|
| 5291 | Limit | 1214.85 | 1151.18 | 5.2% | pattern |
| 5295 | Nested Loop | 1178.43 | 1193.49 | 1.3% | operator |
| 5296 | Hash Join | 214.04 | 242.56 | 13.3% | pattern |
| 5300 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5299 | Seq Scan | 29.04 | 38.53 | 32.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5299 (Seq Scan) - LEAF
...
### Step 2: Node 5296 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5291, 5292, 5293, 5294, 5297, 5298
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47593
  - HashJoin_nt1=236474
  ...
  - HashJoin_total_cost=37343.6400
  - Hash_Inner_np=0
  - Hash_Inner_nt=12579
...
- **Output:** st=29.70, rt=242.56

### Step 3: Node 5300 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=73331.3300
- **Output:** st=122.22, rt=1193.49

### Step 5: Node 5291 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5292, 5293, 5294, 5296, 5297, 5298
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=316003
  - Aggregate_Outer_nt1=316003
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110671.6700
  - Aggregate_Outer_total_cost=114621.7100
  - Gather_Outer_np=0
  - Gather_Outer_nt=316003
  - Gather_Outer_nt1=101936
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105931.6300
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=316003
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=121450.4200
  - Limit_total_cost=121450.4500
  - Sort_Outer_np=0
  - Sort_Outer_nt=316003
  - Sort_Outer_nt1=316003
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=121450.4200
  - Sort_Outer_total_cost=122240.4300
