...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5291 | 5292, 5293, 5294 |
...
| 5295 | Nested Loop | 1178.43 | 1193.40 | 1.3% | operator |
| 5296 | Hash Join | 214.04 | 231.08 | 8.0% | operator |
| 5300 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5297 | Seq Scan | 160.58 | 163.48 | 1.8% | operator |
| 5298 | Hash | 29.79 | 17.75 | 40.4% | operator |
...
### Step 2: Node 5297 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37343.6400
- **Output:** st=27.23, rt=231.08

### Step 5: Node 5300 (Index Scan) - LEAF
...
- **Output:** st=122.08, rt=1193.40

### Step 7: Node 5291 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5292, 5293, 5294
- **Input Features:**
