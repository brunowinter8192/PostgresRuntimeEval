...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5551 | 5552, 5553, 5554, 5556, 5557, 5558 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5556 | 5551, 5552, 5553, 5554, 5557, 5558 |
...
| 5555 | Nested Loop | 1152.35 | 1192.68 | 3.5% | operator |
| 5556 | Hash Join | 211.37 | 242.41 | 14.7% | pattern |
...
- **Consumes:** Nodes 5551, 5552, 5553, 5554, 5557, 5558
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46344
  - HashJoin_nt1=232114
...
### Step 3: Node 5560 (Index Scan) - LEAF
...
### Step 5: Node 5551 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5552, 5553, 5554, 5556, 5557, 5558
- **Input Features:**
