...
```
Node 5914 (Aggregate) [PATTERN: f8231c4d] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 5914 | 5915, 5916, 5917 |
...
|------|------|--------|-----------|-----|--------|
| 5914 | Aggregate | 1056.09 | 952.19 | 9.8% | pattern |
| 5918 | Nested Loop | 1048.08 | 1255.45 | 19.8% | operator |
| 5919 | Seq Scan | 162.25 | 154.66 | 4.7% | operator |
| 5920 | Index Scan | 0.06 | 11.10 | 17810.2% | operator |
...
### Step 4: Node 5914 (Aggregate) - PATTERN ROOT
