...
**Test Query:** Q19_147_seed_1197788526
...
```
Node 31577 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31578 (Gather) [consumed]
    Node 31579 (Aggregate) [consumed]
      Node 31580 (Hash Join) [consumed]
        Node 31581 (Seq Scan) - LEAF
        Node 31582 (Hash)
          Node 31583 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31577 | 31578, 31579, 31580 |
...
|------|------|--------|-----------|-----|--------|
| 31577 | Aggregate | 860.21 | 829.33 | 3.6% | pattern |
| 31581 | Seq Scan | 788.27 | 743.46 | 5.7% | operator |
| 31582 | Hash | 45.30 | 8.29 | 81.7% | operator |
| 31583 | Seq Scan | 45.01 | 23.76 | 47.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31583 (Seq Scan) - LEAF
...
### Step 2: Node 31581 (Seq Scan) - LEAF
...
### Step 4: Node 31577 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31578, 31579, 31580
- **Input Features:**
  ...
  - Aggregate_Outer_startup_cost=156338.9700
  - Aggregate_Outer_total_cost=156338.9800
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=157339.5100
  - Aggregate_total_cost=157339.5200
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=157338.9700
  - Gather_Outer_total_cost=157339.4800
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=23
  - HashJoin_Outer_nt1=22587
  - HashJoin_Outer_nt2=204
  - HashJoin_Outer_parallel_workers=0
  - HashJoin_Outer_plan_width=12
  - HashJoin_Outer_reltuples=0.0000
  - HashJoin_Outer_sel=0.0000
  - HashJoin_Outer_startup_cost=7672.2200
  - HashJoin_Outer_total_cost=156338.8000
- **Output:** st=824.28, rt=829.33
