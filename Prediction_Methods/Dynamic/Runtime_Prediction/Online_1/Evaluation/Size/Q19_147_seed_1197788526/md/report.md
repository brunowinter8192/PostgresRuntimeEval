...
```
Node 31577 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31578 (Gather) [consumed]
    Node 31579 (Aggregate) [consumed]
      Node 31580 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31577 | 31578, 31579 |
...
|------|------|--------|-----------|-----|--------|
| 31577 | Aggregate | 860.21 | 831.20 | 3.4% | pattern |
| 31580 | Hash Join | 840.58 | 766.06 | 8.9% | operator |
...
- **Input Features:**
  ...
  - total_cost=156338.8000
- **Output:** st=60.26, rt=766.06

### Step 5: Node 31577 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31578, 31579
- **Input Features:**
