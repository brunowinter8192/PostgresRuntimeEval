...
```
Node 10445 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10446 (Gather) [consumed]
    Node 10447 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10445 | 10446, 10447 |
...
|------|------|--------|-----------|-----|--------|
| 10445 | Aggregate | 773.78 | 849.98 | 9.8% | pattern |
| 10448 | Seq Scan | 752.49 | 748.50 | 0.5% | operator |
...
### Step 2: Node 10445 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10446, 10447
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=22693
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=32
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=139718.9300
  - Aggregate_Outer_total_cost=139718.9500
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
