...
```
Node 31801 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31802 (Gather) [consumed]
    Node 31803 (Aggregate) [consumed]
      Node 31804 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31801 | 31802, 31803, 31804 |
...
|------|------|--------|-----------|-----|--------|
| 31801 | Aggregate | 826.03 | 829.29 | 0.4% | pattern |
...
### Step 4: Node 31801 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31802, 31803, 31804
- **Input Features:**
