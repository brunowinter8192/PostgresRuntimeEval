...
**Test Query:** Q19_3_seed_16408062
...
```
Node 31801 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31802 (Gather) [consumed]
    Node 31803 (Aggregate) [consumed]
      Node 31804 (Hash Join)
        Node 31805 (Seq Scan) - LEAF
        Node 31806 (Hash)
          Node 31807 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31801 | 31802, 31803 |
...
|------|------|--------|-----------|-----|--------|
| 31801 | Aggregate | 826.03 | 831.20 | 0.6% | pattern |
| 31804 | Hash Join | 805.01 | 766.05 | 4.8% | operator |
| 31805 | Seq Scan | 756.44 | 743.46 | 1.7% | operator |
| 31806 | Hash | 46.55 | 8.29 | 82.2% | operator |
| 31807 | Seq Scan | 46.44 | 23.76 | 48.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31807 (Seq Scan) - LEAF
...
### Step 2: Node 31805 (Seq Scan) - LEAF
...
### Step 5: Node 31801 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31802, 31803
- **Input Features:**
