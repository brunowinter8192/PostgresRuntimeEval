...
```
Node 9521 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 9522 (Aggregate) [consumed]
    Node 9523 (Gather Merge) [consumed]
      Node 9524 (Aggregate)
          ...
          Node 9526 (Hash Join) [consumed]
            Node 9527 (Nested Loop)
              Node 9528 (Hash Join)
                ...
                Node 9530 (Hash) [PATTERN: 444761fb]
                  Node 9531 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 9530 | 9521, 9522, 9523, 9525, 9526, 9531, 9532, 9533, 9534 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 9521 | 9522, 9523, 9525, 9526, 9530, 9531, 9532, 9533, 9534 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 9525 | 9521, 9522, 9523, 9526, 9530, 9531, 9532, 9533, 9534 |
...
|------|------|--------|-----------|-----|--------|
| 9521 | Sort | 1067.21 | 2934.42 | 175.0% | pattern |
| 9524 | Aggregate | 1062.25 | 1128.78 | 6.3% | operator |
| 9525 | Sort | 1062.00 | 1835.92 | 72.9% | pattern |
| 9527 | Nested Loop | 1050.17 | 1188.42 | 13.2% | operator |
| 9539 | Hash | 3.52 | 18.67 | 431.2% | operator |
| 9528 | Hash Join | 217.72 | 253.07 | 16.2% | operator |
| 9538 | Index Scan | 0.07 | -0.22 | 401.4% | operator |
| 9540 | Seq Scan | 3.00 | 12.36 | 312.7% | operator |
| 9529 | Seq Scan | 168.18 | 159.81 | 5.0% | operator |
| 9530 | Hash | 36.46 | 46.85 | 28.5% | pattern |
| 9535 | Seq Scan | 0.01 | 11.81 | 131103.0% | operator |
| 9536 | Hash | 0.07 | 21.05 | 28350.3% | operator |
| 9537 | Seq Scan | 0.07 | 22.93 | 32200.5% | operator |
...
### Step 4: Node 9529 (Seq Scan) - LEAF
...
### Step 5: Node 9530 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 9521, 9522, 9523, 9525, 9526, 9531, 9532, 9533, 9534
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 9538 (Index Scan) - LEAF
...
### Step 8: Node 9540 (Seq Scan) - LEAF
...
### Step 11: Node 9525 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 9521, 9522, 9523, 9526, 9530, 9531, 9532, 9533, 9534
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 9521 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 9522, 9523, 9525, 9526, 9530, 9531, 9532, 9533, 9534
- **Input Features:**
