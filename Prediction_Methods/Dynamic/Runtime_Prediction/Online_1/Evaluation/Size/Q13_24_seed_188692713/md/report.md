...
**Test Query:** Q13_24_seed_188692713
...
```
Node 25832 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25833 (Aggregate) [consumed]
    Node 25834 (Aggregate)
      Node 25835 (Hash Join) [PATTERN: 895c6e8c]
        Node 25836 (Seq Scan) [consumed] - LEAF
        Node 25837 (Hash) [consumed]
          Node 25838 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25832 | 25833, 25835, 25836, 25837 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25835 | 25832, 25833, 25836, 25837 |
...
|------|------|--------|-----------|-----|--------|
| 25832 | Sort | 885.41 | 1079.92 | 22.0% | pattern |
| 25834 | Aggregate | 879.33 | 998.94 | 13.6% | operator |
| 25835 | Hash Join | 671.69 | 470.31 | 30.0% | pattern |
| 25838 | Index Only Scan | 9.92 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25838 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25835 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25832, 25833, 25836, 25837
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1475952
...
### Step 4: Node 25832 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25833, 25835, 25836, 25837
- **Input Features:**
