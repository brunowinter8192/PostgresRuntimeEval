...
```
Node 8281 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 8282 (Aggregate) [consumed]
    Node 8283 (Gather Merge) [consumed]
      Node 8284 (Aggregate)
        Node 8285 (Sort) [PATTERN: 3e2d5a00]
          Node 8286 (Hash Join) [consumed]
            Node 8287 (Nested Loop)
              Node 8288 (Hash Join)
                Node 8289 (Seq Scan) - LEAF
                Node 8290 (Hash) [PATTERN: 444761fb]
                  Node 8291 (Hash Join) [consumed]
                    Node 8292 (Seq Scan) [consumed] - LEAF
                    Node 8293 (Hash) [consumed]
                      Node 8294 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 8290 | 8281, 8282, 8283, 8285, 8286, 8291, 8292, 8293, 8294 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 8281 | 8282, 8283, 8285, 8286, 8290, 8291, 8292, 8293, 8294 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 8285 | 8281, 8282, 8283, 8286, 8290, 8291, 8292, 8293, 8294 |
...
|------|------|--------|-----------|-----|--------|
| 8281 | Sort | 1085.22 | 2934.42 | 170.4% | pattern |
| 8284 | Aggregate | 1079.81 | 1128.74 | 4.5% | operator |
| 8285 | Sort | 1079.54 | 1835.96 | 70.1% | pattern |
| 8287 | Nested Loop | 1067.24 | 1188.57 | 11.4% | operator |
| 8299 | Hash | 3.65 | 18.67 | 411.8% | operator |
| 8288 | Hash Join | 212.86 | 253.07 | 18.9% | operator |
| 8298 | Index Scan | 0.07 | -0.22 | 401.4% | operator |
| 8300 | Seq Scan | 3.17 | 12.36 | 289.5% | operator |
| 8289 | Seq Scan | 166.19 | 159.81 | 3.8% | operator |
| 8290 | Hash | 33.84 | 46.85 | 38.5% | pattern |
| 8295 | Seq Scan | 0.01 | 11.81 | 168589.6% | operator |
| 8296 | Hash | 0.05 | 21.05 | 41180.9% | operator |
| 8297 | Seq Scan | 0.05 | 22.93 | 47677.8% | operator |
...
### Step 4: Node 8289 (Seq Scan) - LEAF
...
### Step 5: Node 8290 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 8281, 8282, 8283, 8285, 8286, 8291, 8292, 8293, 8294
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 8298 (Index Scan) - LEAF
...
### Step 8: Node 8300 (Seq Scan) - LEAF
...
### Step 11: Node 8285 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 8281, 8282, 8283, 8286, 8290, 8291, 8292, 8293, 8294
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 8281 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 8282, 8283, 8285, 8286, 8290, 8291, 8292, 8293, 8294
- **Input Features:**
