...
Node 406 (Aggregate) - ROOT
  Node 407 (Gather Merge)
    Node 408 (Sort) [PATTERN: 1d35fb97]
      Node 409 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 408 | 409 |
...
|------|------|--------|-----------|-----|--------|
| 406 | Aggregate | 946.54 | 1195.94 | 26.3% | operator |
| 407 | Gather Merge | 946.49 | 1165.92 | 23.2% | operator |
| 408 | Sort | 927.08 | 1200.69 | 29.5% | pattern |
...
### Step 2: Node 408 (Sort) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=169090.5000
  - Sort_total_cost=169090.5200
- **Output:** st=1196.60, rt=1200.69

### Step 3: Node 407 (Gather Merge)
...
### Step 4: Node 406 (Aggregate) - ROOT
