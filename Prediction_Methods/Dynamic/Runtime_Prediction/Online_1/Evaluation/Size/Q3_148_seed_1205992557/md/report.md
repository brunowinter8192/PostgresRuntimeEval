...
**Test Query:** Q3_148_seed_1205992557
**Timestamp:** 2026-01-18 16:13:01
...
```
Node 4871 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 4872 (Sort) [consumed]
    Node 4873 (Aggregate) [consumed]
      Node 4874 (Gather) [consumed]
        Node 4875 (Nested Loop)
          Node 4876 (Hash Join) [PATTERN: 895c6e8c]
            Node 4877 (Seq Scan) [consumed] - LEAF
            Node 4878 (Hash) [consumed]
              Node 4879 (Seq Scan) - LEAF
          Node 4880 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4871 | 4872, 4873, 4874, 4876, 4877, 4878 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4876 | 4871, 4872, 4873, 4874, 4877, 4878 |
...
|------|------|--------|-----------|-----|--------|
| 4871 | Limit | 1190.45 | 1151.18 | 3.3% | pattern |
| 4875 | Nested Loop | 1153.30 | 1193.54 | 3.5% | operator |
| 4876 | Hash Join | 207.75 | 242.57 | 16.8% | pattern |
| 4880 | Index Scan | 0.03 | -0.52 | 2172.3% | operator |
| 4879 | Seq Scan | 28.66 | 38.54 | 34.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4879 (Seq Scan) - LEAF
...
### Step 2: Node 4876 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4871, 4872, 4873, 4874, 4877, 4878
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47671
  - HashJoin_nt1=237233
  ...
  - HashJoin_sel=0.0000
  - HashJoin_startup_cost=4538.2400
  - HashJoin_total_cost=37345.3800
  - Hash_Inner_np=0
  - Hash_Inner_nt=12559
  - Hash_Inner_nt1=12559
  - Hash_Inner_nt2=0
...
- **Input Features:**
  ...
  - total_cost=73362.5400
- **Output:** st=122.27, rt=1193.54

### Step 5: Node 4871 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4872, 4873, 4874, 4876, 4877, 4878
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=315580
  - Aggregate_Outer_nt1=315580
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110654.2400
  - Aggregate_Outer_total_cost=114598.9900
  - Gather_Outer_np=0
  - Gather_Outer_nt=315580
  - Gather_Outer_nt1=101800
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105920.5400
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=315580
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=121418.5600
  - Limit_total_cost=121418.5800
  - Sort_Outer_np=0
  - Sort_Outer_nt=315580
  - Sort_Outer_nt1=315580
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=121418.5600
  - Sort_Outer_total_cost=122207.5100
