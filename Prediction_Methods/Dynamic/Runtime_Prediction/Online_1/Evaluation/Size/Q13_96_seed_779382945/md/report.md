...
**Test Query:** Q13_96_seed_779382945
...
```
Node 26385 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26386 (Aggregate) [consumed]
    Node 26387 (Aggregate)
      Node 26388 (Hash Join) [PATTERN: 895c6e8c]
        Node 26389 (Seq Scan) [consumed] - LEAF
        Node 26390 (Hash) [consumed]
          Node 26391 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26385 | 26386, 26388, 26389, 26390 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26388 | 26385, 26386, 26389, 26390 |
...
|------|------|--------|-----------|-----|--------|
| 26385 | Sort | 906.06 | 1079.91 | 19.2% | pattern |
| 26387 | Aggregate | 899.92 | 998.54 | 11.0% | operator |
| 26388 | Hash Join | 683.76 | 470.31 | 31.2% | pattern |
| 26391 | Index Only Scan | 11.31 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26391 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26388 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26385, 26386, 26389, 26390
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1469940
...
### Step 4: Node 26385 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26386, 26388, 26389, 26390
- **Input Features:**
