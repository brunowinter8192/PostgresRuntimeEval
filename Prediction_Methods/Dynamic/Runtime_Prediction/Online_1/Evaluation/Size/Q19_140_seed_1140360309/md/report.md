...
```
Node 31528 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31529 (Gather) [consumed]
    Node 31530 (Aggregate) [consumed]
      Node 31531 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31528 | 31529, 31530 |
...
|------|------|--------|-----------|-----|--------|
| 31528 | Aggregate | 821.88 | 831.20 | 1.1% | pattern |
| 31531 | Hash Join | 801.08 | 766.06 | 4.4% | operator |
...
### Step 5: Node 31528 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31529, 31530
- **Input Features:**
