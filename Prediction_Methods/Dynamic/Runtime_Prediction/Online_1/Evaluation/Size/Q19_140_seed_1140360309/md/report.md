...
**Test Query:** Q19_140_seed_1140360309
...
```
Node 31528 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31529 (Gather) [consumed]
    Node 31530 (Aggregate) [consumed]
      Node 31531 (Hash Join) [consumed]
        Node 31532 (Seq Scan) - LEAF
        Node 31533 (Hash)
          Node 31534 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31528 | 31529, 31530, 31531 |
...
|------|------|--------|-----------|-----|--------|
| 31528 | Aggregate | 821.88 | 829.31 | 0.9% | pattern |
| 31532 | Seq Scan | 752.96 | 743.46 | 1.3% | operator |
| 31533 | Hash | 46.03 | 8.29 | 82.0% | operator |
| 31534 | Seq Scan | 45.88 | 23.76 | 48.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31534 (Seq Scan) - LEAF
...
### Step 2: Node 31532 (Seq Scan) - LEAF
...
### Step 4: Node 31528 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31529, 31530, 31531
- **Input Features:**
