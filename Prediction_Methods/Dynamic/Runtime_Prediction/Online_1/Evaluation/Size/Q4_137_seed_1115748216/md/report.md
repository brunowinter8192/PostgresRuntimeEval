...
**Test Query:** Q4_137_seed_1115748216
...
```
Node 6131 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6132 (Gather Merge) [consumed]
    Node 6133 (Sort) [consumed]
      Node 6134 (Aggregate) [consumed]
        Node 6135 (Nested Loop)
          Node 6136 (Seq Scan) - LEAF
          Node 6137 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6131 | 6132, 6133, 6134 |
...
|------|------|--------|-----------|-----|--------|
| 6131 | Aggregate | 1057.08 | 952.19 | 9.9% | pattern |
| 6135 | Nested Loop | 1050.49 | 1255.45 | 19.5% | operator |
| 6136 | Seq Scan | 164.57 | 154.66 | 6.0% | operator |
| 6137 | Index Scan | 0.06 | 11.10 | 17810.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6136 (Seq Scan) - LEAF
...
### Step 2: Node 6137 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - Aggregate_startup_cost=67110.0500
  - Aggregate_total_cost=67111.9500
  ...
  - GatherMerge_Outer_startup_cost=67110.0500
  - GatherMerge_Outer_total_cost=67111.8300
  - Sort_Outer_np=0
  - Sort_Outer_nt=5
  - Sort_Outer_nt1=5
  - Sort_Outer_nt2=0
  ...
  - Sort_Outer_startup_cost=66110.0100
  - Sort_Outer_total_cost=66110.0200
