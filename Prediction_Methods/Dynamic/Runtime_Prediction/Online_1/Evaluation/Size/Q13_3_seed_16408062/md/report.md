...
**Test Query:** Q13_3_seed_16408062
...
```
Node 25951 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25952 (Aggregate) [consumed]
    Node 25953 (Aggregate)
      Node 25954 (Hash Join) [PATTERN: 895c6e8c]
        Node 25955 (Seq Scan) [consumed] - LEAF
        Node 25956 (Hash) [consumed]
          Node 25957 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25951 | 25952, 25954, 25955, 25956 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25954 | 25951, 25952, 25955, 25956 |
...
|------|------|--------|-----------|-----|--------|
| 25951 | Sort | 924.41 | 1079.92 | 16.8% | pattern |
| 25953 | Aggregate | 918.38 | 998.94 | 8.8% | operator |
| 25954 | Hash Join | 695.70 | 470.31 | 32.4% | pattern |
| 25957 | Index Only Scan | 9.60 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25957 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25954 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25951, 25952, 25955, 25956
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1475952
...
### Step 4: Node 25951 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25952, 25954, 25955, 25956
- **Input Features:**
