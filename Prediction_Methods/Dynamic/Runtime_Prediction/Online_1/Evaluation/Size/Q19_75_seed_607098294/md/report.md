...
**Test Query:** Q19_75_seed_607098294
...
```
Node 32074 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 32075 (Gather) [consumed]
    Node 32076 (Aggregate) [consumed]
      Node 32077 (Hash Join) [consumed]
        Node 32078 (Seq Scan) - LEAF
        Node 32079 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 32074 | 32075, 32076, 32077 |
...
|------|------|--------|-----------|-----|--------|
| 32074 | Aggregate | 846.39 | 829.28 | 2.0% | pattern |
| 32078 | Seq Scan | 781.18 | 743.46 | 4.8% | operator |
| 32079 | Hash | 44.51 | 8.29 | 81.4% | operator |
| 32080 | Seq Scan | 44.38 | 23.76 | 46.5% | operator |
...
### Step 2: Node 32078 (Seq Scan) - LEAF
...
### Step 4: Node 32074 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 32075, 32076, 32077
- **Input Features:**
