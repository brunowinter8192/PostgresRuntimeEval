...
```
Node 32074 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 32075 (Gather) [consumed]
    Node 32076 (Aggregate) [consumed]
      Node 32077 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 32074 | 32075, 32076 |
...
|------|------|--------|-----------|-----|--------|
| 32074 | Aggregate | 846.39 | 831.20 | 1.8% | pattern |
| 32077 | Hash Join | 827.55 | 766.05 | 7.4% | operator |
...
### Step 5: Node 32074 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 32075, 32076
- **Input Features:**
