...
```
Node 15708 (Aggregate) - ROOT
  Node 15709 (Gather Merge)
    Node 15710 (Sort)
          ...
          Node 15713 (Hash Join)
            Node 15714 (Nested Loop)
              Node 15715 (Hash Join)
                ...
                Node 15717 (Hash)
                  Node 15718 (Hash Join)
                    Node 15719 (Seq Scan) - LEAF
                    Node 15720 (Hash)
                      Node 15721 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 15708 | Aggregate | 1214.89 | 1195.17 | 1.6% | operator |
| 15709 | Gather Merge | 1214.52 | 1097.13 | 9.7% | operator |
...
| 15715 | Hash Join | 213.31 | 251.17 | 17.7% | operator |
...
| 15717 | Hash | 35.94 | 20.62 | 42.6% | operator |
| 15718 | Hash Join | 35.32 | 132.26 | 274.4% | operator |
| 15719 | Seq Scan | 33.75 | 23.03 | 31.8% | operator |
| 15720 | Hash | 0.21 | 23.66 | 10954.3% | operator |
| 15721 | Hash Join | 0.21 | 306.84 | 145319.9% | operator |
...
### Step 5: Node 15719 (Seq Scan) - LEAF
...
### Step 8: Node 15716 (Seq Scan) - LEAF
...
### Step 11: Node 15725 (Index Scan) - LEAF
...
### Step 12: Node 15727 (Seq Scan) - LEAF
...
### Step 13: Node 15714 (Nested Loop)
...
### Step 16: Node 15728 (Index Scan) - LEAF
...
### Step 17: Node 15730 (Seq Scan) - LEAF
...
### Step 18: Node 15712 (Nested Loop)
...
### Step 22: Node 15709 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1044.9424
  - st2=0.0000
  - startup_cost=71550.2100
  - total_cost=71835.6900
- **Output:** st=1093.42, rt=1097.13

### Step 23: Node 15708 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=71550.2100
  - total_cost=71932.0700
- **Output:** st=1164.02, rt=1195.17
