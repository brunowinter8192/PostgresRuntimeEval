...
**Test Query:** Q19_56_seed_451221705
...
```
Node 31927 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31928 (Gather) [consumed]
    Node 31929 (Aggregate) [consumed]
      Node 31930 (Hash Join) [consumed]
        Node 31931 (Seq Scan) - LEAF
        Node 31932 (Hash)
          Node 31933 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31927 | 31928, 31929, 31930 |
...
|------|------|--------|-----------|-----|--------|
| 31927 | Aggregate | 845.13 | 829.28 | 1.9% | pattern |
| 31931 | Seq Scan | 772.23 | 743.46 | 3.7% | operator |
| 31932 | Hash | 45.50 | 8.29 | 81.8% | operator |
| 31933 | Seq Scan | 45.36 | 23.76 | 47.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31933 (Seq Scan) - LEAF
...
### Step 2: Node 31931 (Seq Scan) - LEAF
...
### Step 4: Node 31927 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31928, 31929, 31930
- **Input Features:**
