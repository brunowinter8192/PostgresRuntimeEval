...
**Test Query:** Q4_36_seed_287141085
...
```
Node 6404 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6405 (Gather Merge) [consumed]
    Node 6406 (Sort) [consumed]
      Node 6407 (Aggregate) [consumed]
        Node 6408 (Nested Loop)
          Node 6409 (Seq Scan) - LEAF
          Node 6410 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6404 | 6405, 6406, 6407 |
...
|------|------|--------|-----------|-----|--------|
| 6404 | Aggregate | 1036.00 | 952.19 | 8.1% | pattern |
| 6408 | Nested Loop | 1029.35 | 1255.45 | 22.0% | operator |
| 6409 | Seq Scan | 164.41 | 154.66 | 5.9% | operator |
| 6410 | Index Scan | 0.06 | 11.10 | 18407.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6409 (Seq Scan) - LEAF
...
### Step 2: Node 6410 (Index Scan) - LEAF
