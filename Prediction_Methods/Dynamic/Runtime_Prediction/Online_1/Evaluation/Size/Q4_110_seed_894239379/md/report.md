...
**Test Query:** Q4_110_seed_894239379
...
```
Node 5928 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 5929 (Gather Merge) [consumed]
    Node 5930 (Sort) [consumed]
      Node 5931 (Aggregate) [consumed]
        Node 5932 (Nested Loop)
          Node 5933 (Seq Scan) - LEAF
          Node 5934 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 5928 | 5929, 5930, 5931 |
...
|------|------|--------|-----------|-----|--------|
| 5928 | Aggregate | 1056.69 | 952.19 | 9.9% | pattern |
| 5932 | Nested Loop | 1050.16 | 1255.45 | 19.5% | operator |
| 5933 | Seq Scan | 166.82 | 154.67 | 7.3% | operator |
| 5934 | Index Scan | 0.06 | 11.10 | 18103.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5933 (Seq Scan) - LEAF
...
### Step 2: Node 5934 (Index Scan) - LEAF
