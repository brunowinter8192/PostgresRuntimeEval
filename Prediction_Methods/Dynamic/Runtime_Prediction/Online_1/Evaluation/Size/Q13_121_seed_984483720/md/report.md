...
```
Node 25531 (Sort) - ROOT
  Node 25532 (Aggregate)
    Node 25533 (Aggregate)
      Node 25534 (Hash Join)
        Node 25535 (Seq Scan) - LEAF
        Node 25536 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 25531 | Sort | 935.85 | 1081.93 | 15.6% | operator |
| 25532 | Aggregate | 935.82 | 1000.34 | 6.9% | operator |
| 25533 | Aggregate | 929.73 | 1014.18 | 9.1% | operator |
| 25534 | Hash Join | 717.29 | 787.83 | 9.8% | operator |
| 25535 | Seq Scan | 503.68 | 264.12 | 47.6% | operator |
| 25536 | Hash | 15.81 | 80.15 | 406.8% | operator |
...
### Step 2: Node 25535 (Seq Scan) - LEAF
