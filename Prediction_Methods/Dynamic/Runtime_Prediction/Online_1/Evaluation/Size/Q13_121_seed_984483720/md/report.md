...
**Test Query:** Q13_121_seed_984483720
...
```
Node 25531 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25532 (Aggregate) [consumed]
    Node 25533 (Aggregate)
      Node 25534 (Hash Join) [PATTERN: 895c6e8c]
        Node 25535 (Seq Scan) [consumed] - LEAF
        Node 25536 (Hash) [consumed]
          Node 25537 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25531 | 25532, 25534, 25535, 25536 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25534 | 25531, 25532, 25535, 25536 |
...
|------|------|--------|-----------|-----|--------|
| 25531 | Sort | 935.85 | 1079.93 | 15.4% | pattern |
| 25533 | Aggregate | 929.73 | 999.55 | 7.5% | operator |
| 25534 | Hash Join | 717.29 | 470.31 | 34.4% | pattern |
| 25537 | Index Only Scan | 9.62 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25537 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25534 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25531, 25532, 25535, 25536
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1484970
...
### Step 4: Node 25531 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25532, 25534, 25535, 25536
- **Input Features:**
