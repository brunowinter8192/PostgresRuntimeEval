...
**Test Query:** Q1_115_seed_935259534
...
```
Node 81 (Aggregate) - ROOT
  Node 82 (Gather Merge)
    Node 83 (Sort)
      Node 84 (Aggregate)
        Node 85 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 81 | Aggregate | 950.14 | 1195.87 | 25.9% | operator |
| 82 | Gather Merge | 950.08 | 1165.59 | 22.7% | operator |
| 83 | Sort | 929.95 | 1182.06 | 27.1% | operator |
| 84 | Aggregate | 929.92 | 1112.99 | 19.7% | operator |
| 85 | Seq Scan | 512.25 | 679.78 | 32.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 85 (Seq Scan) - LEAF
