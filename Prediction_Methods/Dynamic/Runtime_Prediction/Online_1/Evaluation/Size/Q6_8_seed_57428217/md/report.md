...
```
Node 10453 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10454 (Gather) [consumed]
    Node 10455 (Aggregate) [consumed]
      Node 10456 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10453 | 10454, 10455 |
...
|------|------|--------|-----------|-----|--------|
| 10453 | Aggregate | 765.93 | 849.99 | 11.0% | pattern |
| 10456 | Seq Scan | 745.60 | 748.50 | 0.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10456 (Seq Scan) - LEAF
...
### Step 2: Node 10453 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10454, 10455
- **Input Features:**
