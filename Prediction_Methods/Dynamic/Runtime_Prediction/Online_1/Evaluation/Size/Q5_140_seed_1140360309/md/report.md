...
**Test Query:** Q5_140_seed_1140360309
...
```
Node 7781 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 7782 (Aggregate) [consumed]
    Node 7783 (Gather Merge) [consumed]
      Node 7784 (Aggregate)
        Node 7785 (Sort) [PATTERN: 3e2d5a00]
          Node 7786 (Hash Join) [consumed]
            Node 7787 (Nested Loop)
              Node 7788 (Hash Join)
                Node 7789 (Seq Scan) - LEAF
                Node 7790 (Hash) [PATTERN: 444761fb]
                  Node 7791 (Hash Join) [consumed]
                    Node 7792 (Seq Scan) [consumed] - LEAF
                    Node 7793 (Hash) [consumed]
                      Node 7794 (Hash Join) [consumed]
                        Node 7795 (Seq Scan) - LEAF
                        Node 7796 (Hash)
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 7790 | 7781, 7782, 7783, 7785, 7786, 7791, 7792, 7793, 7794 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 7781 | 7782, 7783, 7785, 7786, 7790, 7791, 7792, 7793, 7794 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 7785 | 7781, 7782, 7783, 7786, 7790, 7791, 7792, 7793, 7794 |
...
|------|------|--------|-----------|-----|--------|
| 7781 | Sort | 1074.56 | 2934.42 | 173.1% | pattern |
| 7784 | Aggregate | 1068.71 | 1128.78 | 5.6% | operator |
| 7785 | Sort | 1068.44 | 1835.92 | 71.8% | pattern |
| 7787 | Nested Loop | 1057.39 | 1188.42 | 12.4% | operator |
| 7799 | Hash | 2.45 | 18.67 | 660.9% | operator |
| 7788 | Hash Join | 212.15 | 253.07 | 19.3% | operator |
| 7798 | Index Scan | 0.07 | -0.22 | 397.3% | operator |
| 7800 | Seq Scan | 1.94 | 12.36 | 536.4% | operator |
| 7789 | Seq Scan | 166.72 | 159.81 | 4.1% | operator |
| 7790 | Hash | 32.66 | 46.85 | 43.5% | pattern |
| 7795 | Seq Scan | 0.01 | 11.81 | 117982.7% | operator |
| 7796 | Hash | 0.05 | 21.05 | 45667.9% | operator |
| 7797 | Seq Scan | 0.04 | 22.93 | 53233.3% | operator |
...
### Step 2: Node 7795 (Seq Scan) - LEAF
...
### Step 4: Node 7789 (Seq Scan) - LEAF
...
### Step 5: Node 7790 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 7781, 7782, 7783, 7785, 7786, 7791, 7792, 7793, 7794
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 7798 (Index Scan) - LEAF
...
### Step 8: Node 7800 (Seq Scan) - LEAF
...
### Step 11: Node 7785 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 7781, 7782, 7783, 7786, 7790, 7791, 7792, 7793, 7794
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 7781 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 7782, 7783, 7785, 7786, 7790, 7791, 7792, 7793, 7794
- **Input Features:**
