...
```
Node 12427 (Aggregate) - ROOT
  Node 12428 (Gather Merge)
    Node 12429 (Sort)
      Node 12430 (Hash Join)
        Node 12431 (Nested Loop)
          Node 12432 (Hash Join)
            Node 12433 (Seq Scan) - LEAF
            Node 12434 (Hash)
              Node 12435 (Hash Join)
                Node 12436 (Seq Scan) - LEAF
                Node 12437 (Hash)
                  Node 12438 (Seq Scan) - LEAF
          Node 12439 (Index Scan) - LEAF
        Node 12440 (Hash)
          Node 12441 (Hash Join)
            Node 12442 (Seq Scan) - LEAF
            Node 12443 (Hash)
              Node 12444 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12427 | Aggregate | 1196.51 | 1209.26 | 1.1% | operator |
| 12428 | Gather Merge | 1195.51 | 1142.98 | 4.4% | operator |
| 12429 | Sort | 1189.20 | 1109.13 | 6.7% | operator |
| 12430 | Hash Join | 1188.58 | 842.59 | 29.1% | operator |
| 12431 | Nested Loop | 1181.99 | 1216.16 | 2.9% | operator |
| 12440 | Hash | 2.86 | 17.53 | 512.3% | operator |
| 12432 | Hash Join | 211.32 | 384.47 | 81.9% | operator |
| 12439 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 12441 | Hash Join | 2.82 | 85.17 | 2918.2% | operator |
| 12433 | Seq Scan | 150.11 | 201.16 | 34.0% | operator |
| 12434 | Hash | 35.67 | 19.59 | 45.1% | operator |
| 12442 | Seq Scan | 2.50 | 11.47 | 359.2% | operator |
| 12443 | Hash | 0.01 | 16.89 | 120572.0% | operator |
| 12435 | Hash Join | 35.32 | 92.20 | 161.0% | operator |
| 12444 | Seq Scan | 0.01 | 45.79 | 416193.8% | operator |
| 12436 | Seq Scan | 34.21 | 21.86 | 36.1% | operator |
| 12437 | Hash | 0.01 | 16.89 | 187612.0% | operator |
| 12438 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12438 (Seq Scan) - LEAF
...
### Step 2: Node 12436 (Seq Scan) - LEAF
...
### Step 5: Node 12444 (Seq Scan) - LEAF
...
### Step 6: Node 12433 (Seq Scan) - LEAF
...
### Step 8: Node 12442 (Seq Scan) - LEAF
...
### Step 11: Node 12439 (Index Scan) - LEAF
...
### Step 13: Node 12431 (Nested Loop)
...
### Step 17: Node 12428 (Gather Merge)
...
### Step 18: Node 12427 (Aggregate) - ROOT
