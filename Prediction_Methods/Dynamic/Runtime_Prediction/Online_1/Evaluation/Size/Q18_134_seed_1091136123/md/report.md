        ...
        Node 29416 (Incremental Sort)
          Node 29417 (Nested Loop)
            Node 29418 (Merge Join)
              Node 29419 (Sort)
                Node 29420 (Hash Join)
                  Node 29421 (Seq Scan) - LEAF
                  Node 29422 (Hash)
...
| 29419 | Sort | 2830.95 | 1099.77 | 61.2% | operator |
| 29425 | Sort | 70.70 | 1074.66 | 1420.1% | operator |
| 29420 | Hash Join | 2830.94 | 686.33 | 75.8% | operator |
| 29426 | Seq Scan | 58.85 | 18.25 | 69.0% | operator |
| 29421 | Seq Scan | 187.55 | 170.37 | 9.2% | operator |
| 29422 | Hash | 2613.15 | 21.04 | 99.2% | operator |
...
### Step 3: Node 29421 (Seq Scan) - LEAF
...
### Step 6: Node 29426 (Seq Scan) - LEAF
...
### Step 9: Node 29418 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29427 (Index Scan) - LEAF
...
### Step 11: Node 29417 (Nested Loop)
...
### Step 12: Node 29416 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29415 (Gather Merge)
