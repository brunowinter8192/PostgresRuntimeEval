...
**Test Query:** Q18_134_seed_1091136123
...
```
Node 29412 (Limit) - ROOT
  Node 29413 (Sort)
    Node 29414 (Aggregate)
      Node 29415 (Gather Merge)
        Node 29416 (Incremental Sort)
          Node 29417 (Nested Loop)
            Node 29418 (Merge Join)
              Node 29419 (Sort)
                Node 29420 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29421 (Seq Scan) [consumed] - LEAF
                  Node 29422 (Hash) [consumed]
                    Node 29423 (Aggregate)
                      Node 29424 (Index Scan) - LEAF
              Node 29425 (Sort)
                Node 29426 (Seq Scan) - LEAF
            Node 29427 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29420 | 29421, 29422 |
...
|------|------|--------|-----------|-----|--------|
| 29412 | Limit | 3040.13 | 1175.21 | 61.3% | operator |
| 29413 | Sort | 2922.64 | 1127.81 | 61.4% | operator |
| 29414 | Aggregate | 2922.60 | 1073.15 | 63.3% | operator |
| 29415 | Gather Merge | 2922.58 | 1073.95 | 63.3% | operator |
| 29416 | Incremental Sort | 2904.49 | 0.00 | 100.0% | operator |
| 29417 | Nested Loop | 2904.44 | 1111.34 | 61.7% | operator |
| 29418 | Merge Join | 2904.37 | 0.00 | 100.0% | operator |
| 29427 | Index Scan | 0.03 | 0.05 | 80.5% | operator |
| 29419 | Sort | 2830.95 | 1095.58 | 61.3% | operator |
| 29425 | Sort | 70.70 | 1074.66 | 1420.1% | operator |
| 29420 | Hash Join | 2830.94 | 471.07 | 83.4% | pattern |
| 29426 | Seq Scan | 58.85 | 18.25 | 69.0% | operator |
| 29423 | Aggregate | 2613.11 | 1073.15 | 58.9% | operator |
| 29424 | Index Scan | 2145.04 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29424 (Index Scan) - LEAF
...
### Step 3: Node 29420 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29421, 29422
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29426 (Seq Scan) - LEAF
...
### Step 7: Node 29418 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29427 (Index Scan) - LEAF
...
### Step 10: Node 29416 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29415 (Gather Merge)
