...
```
Node 25727 (Sort) - ROOT
  Node 25728 (Aggregate)
    Node 25729 (Aggregate)
      Node 25730 (Hash Join)
        Node 25731 (Seq Scan) - LEAF
        Node 25732 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 25727 | Sort | 895.70 | 1081.93 | 20.8% | operator |
| 25728 | Aggregate | 895.69 | 1000.33 | 11.7% | operator |
| 25729 | Aggregate | 889.59 | 1014.39 | 14.0% | operator |
| 25730 | Hash Join | 681.43 | 787.83 | 15.6% | operator |
| 25731 | Seq Scan | 471.18 | 264.19 | 43.9% | operator |
| 25732 | Hash | 15.54 | 80.15 | 415.8% | operator |
...
### Step 2: Node 25731 (Seq Scan) - LEAF
