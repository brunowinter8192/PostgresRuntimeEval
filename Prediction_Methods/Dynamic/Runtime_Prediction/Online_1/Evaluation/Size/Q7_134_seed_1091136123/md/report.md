...
```
Node 11167 (Aggregate) - ROOT
  Node 11168 (Gather Merge)
    Node 11169 (Sort)
      Node 11170 (Hash Join)
        Node 11171 (Nested Loop)
          Node 11172 (Hash Join)
            Node 11173 (Seq Scan) - LEAF
            Node 11174 (Hash)
              Node 11175 (Hash Join)
                Node 11176 (Seq Scan) - LEAF
                Node 11177 (Hash)
                  Node 11178 (Seq Scan) - LEAF
          Node 11179 (Index Scan) - LEAF
        Node 11180 (Hash)
          Node 11181 (Hash Join)
            Node 11182 (Seq Scan) - LEAF
            Node 11183 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 11167 | Aggregate | 1187.05 | 1209.26 | 1.9% | operator |
| 11168 | Gather Merge | 1186.14 | 1142.98 | 3.6% | operator |
| 11169 | Sort | 1180.81 | 1109.13 | 6.1% | operator |
| 11170 | Hash Join | 1180.22 | 842.59 | 28.6% | operator |
| 11171 | Nested Loop | 1172.72 | 1216.16 | 3.7% | operator |
| 11180 | Hash | 3.86 | 17.53 | 353.8% | operator |
| 11172 | Hash Join | 209.16 | 384.47 | 83.8% | operator |
| 11179 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 11181 | Hash Join | 3.82 | 85.17 | 2129.7% | operator |
| 11173 | Seq Scan | 148.14 | 201.16 | 35.8% | operator |
| 11174 | Hash | 36.11 | 19.59 | 45.7% | operator |
| 11182 | Seq Scan | 3.49 | 11.47 | 228.7% | operator |
| 11183 | Hash | 0.01 | 16.89 | 120572.0% | operator |
| 11175 | Hash Join | 35.76 | 92.20 | 157.8% | operator |
| 11184 | Seq Scan | 0.01 | 45.79 | 416193.8% | operator |
| 11176 | Seq Scan | 34.63 | 21.86 | 36.9% | operator |
| 11177 | Hash | 0.01 | 16.89 | 153482.6% | operator |
| 11178 | Seq Scan | 0.01 | 45.79 | 572303.9% | operator |
...
### Step 2: Node 11176 (Seq Scan) - LEAF
...
### Step 5: Node 11184 (Seq Scan) - LEAF
...
### Step 6: Node 11173 (Seq Scan) - LEAF
...
### Step 8: Node 11182 (Seq Scan) - LEAF
...
### Step 11: Node 11179 (Index Scan) - LEAF
...
### Step 13: Node 11171 (Nested Loop)
...
### Step 17: Node 11168 (Gather Merge)
...
### Step 18: Node 11167 (Aggregate) - ROOT
