    ...
    Node 20217 (Aggregate) [consumed]
      Node 20218 (Gather) [consumed]
        Node 20219 (Hash Join)
          Node 20220 (Hash Join)
            Node 20221 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20215 | 20216, 20217, 20218 |
...
| 20219 | Hash Join | 1099.54 | 1007.27 | 8.4% | operator |
| 20220 | Hash Join | 1096.71 | 1004.21 | 8.4% | operator |
| 20226 | Hash | 0.02 | 15.71 | 92316.3% | operator |
| 20221 | Nested Loop | 1049.52 | 1204.78 | 14.8% | operator |
| 20224 | Hash | 36.93 | 55.57 | 50.5% | operator |
...
### Step 6: Node 20227 (Seq Scan) - LEAF
...
### Step 10: Node 20215 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20216, 20217, 20218
- **Input Features:**
