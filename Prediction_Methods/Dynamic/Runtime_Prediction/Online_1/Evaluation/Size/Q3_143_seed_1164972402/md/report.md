...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4821 | 4822, 4823, 4824 |
...
| 4825 | Nested Loop | 1175.57 | 1192.75 | 1.5% | operator |
| 4826 | Hash Join | 208.50 | 230.42 | 10.5% | operator |
| 4830 | Index Scan | 0.03 | -0.52 | 2018.8% | operator |
| 4827 | Seq Scan | 156.55 | 163.26 | 4.3% | operator |
| 4828 | Hash | 28.90 | 17.75 | 38.6% | operator |
...
### Step 2: Node 4827 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37334.1800
- **Output:** st=27.15, rt=230.42

### Step 5: Node 4830 (Index Scan) - LEAF
...
- **Output:** st=121.45, rt=1192.75

### Step 7: Node 4821 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4822, 4823, 4824
- **Input Features:**
