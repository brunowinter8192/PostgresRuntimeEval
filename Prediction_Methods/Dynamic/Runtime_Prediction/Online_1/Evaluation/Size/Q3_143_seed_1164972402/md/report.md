...
**Test Query:** Q3_143_seed_1164972402
...
```
Node 4821 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 4822 (Sort) [consumed]
    Node 4823 (Aggregate) [consumed]
      Node 4824 (Gather) [consumed]
        Node 4825 (Nested Loop)
          Node 4826 (Hash Join) [PATTERN: 895c6e8c]
            Node 4827 (Seq Scan) [consumed] - LEAF
            Node 4828 (Hash) [consumed]
              Node 4829 (Seq Scan) - LEAF
          Node 4830 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4821 | 4822, 4823, 4824, 4826, 4827, 4828 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4826 | 4821, 4822, 4823, 4824, 4827, 4828 |
...
|------|------|--------|-----------|-----|--------|
| 4821 | Limit | 1211.67 | 1151.18 | 5.0% | pattern |
| 4825 | Nested Loop | 1175.57 | 1192.84 | 1.5% | operator |
| 4826 | Hash Join | 208.50 | 242.44 | 16.3% | pattern |
| 4830 | Index Scan | 0.03 | -0.52 | 2018.8% | operator |
| 4829 | Seq Scan | 28.29 | 38.57 | 36.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4829 (Seq Scan) - LEAF
...
### Step 2: Node 4826 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4821, 4822, 4823, 4824, 4827, 4828
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46590
  - HashJoin_nt1=233346
  ...
  - HashJoin_total_cost=37334.1800
  - Hash_Inner_np=0
  - Hash_Inner_nt=12479
...
- **Output:** st=29.77, rt=242.44

### Step 3: Node 4830 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=72684.4000
- **Output:** st=121.60, rt=1192.84

### Step 5: Node 4821 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4822, 4823, 4824, 4826, 4827, 4828
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=313160
  - Aggregate_Outer_nt1=313160
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=109697.8000
  - Aggregate_Outer_total_cost=113612.3000
  - Gather_Outer_np=0
  - Gather_Outer_nt=313160
  - Gather_Outer_nt1=101019
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105000.4000
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=313160
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=120379.5800
  - Limit_total_cost=120379.6000
  - Sort_Outer_np=0
  - Sort_Outer_nt=313160
  - Sort_Outer_nt1=313160
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=120379.5800
  - Sort_Outer_total_cost=121162.4800
