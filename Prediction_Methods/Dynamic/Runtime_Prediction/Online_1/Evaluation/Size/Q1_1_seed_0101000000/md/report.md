...
**Test Query:** Q1_1_seed_0101000000
...
```
Node 306 (Aggregate) - ROOT
  Node 307 (Gather Merge)
    Node 308 (Sort) [PATTERN: 1d35fb97]
      Node 309 (Aggregate) [consumed]
        Node 310 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 308 | 309 |
...
|------|------|--------|-----------|-----|--------|
| 306 | Aggregate | 980.23 | 1195.87 | 22.0% | operator |
| 307 | Gather Merge | 980.18 | 1165.90 | 18.9% | operator |
| 308 | Sort | 960.71 | 1200.43 | 25.0% | pattern |
| 310 | Seq Scan | 574.87 | 680.53 | 18.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 310 (Seq Scan) - LEAF
...
### Step 2: Node 308 (Sort) - PATTERN ROOT
...
### Step 4: Node 306 (Aggregate) - ROOT
