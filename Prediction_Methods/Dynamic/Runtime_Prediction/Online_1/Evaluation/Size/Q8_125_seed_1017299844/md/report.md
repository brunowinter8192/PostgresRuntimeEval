...
```
Node 13822 (Aggregate) - ROOT
  Node 13823 (Gather Merge)
    Node 13824 (Sort)
          ...
          Node 13827 (Hash Join)
            Node 13828 (Nested Loop)
              Node 13829 (Hash Join)
                ...
                Node 13831 (Hash)
                  Node 13832 (Hash Join)
                    Node 13833 (Seq Scan) - LEAF
                    Node 13834 (Hash)
                      Node 13835 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 13822 | Aggregate | 1277.23 | 1194.14 | 6.5% | operator |
| 13823 | Gather Merge | 1276.81 | 1097.16 | 14.1% | operator |
...
| 13829 | Hash Join | 215.88 | 251.17 | 16.3% | operator |
...
| 13831 | Hash | 38.26 | 20.62 | 46.1% | operator |
| 13832 | Hash Join | 37.66 | 132.26 | 251.2% | operator |
| 13833 | Seq Scan | 36.10 | 23.03 | 36.2% | operator |
| 13834 | Hash | 0.23 | 23.66 | 9966.4% | operator |
| 13835 | Hash Join | 0.23 | 306.84 | 132729.4% | operator |
...
### Step 5: Node 13833 (Seq Scan) - LEAF
...
### Step 8: Node 13830 (Seq Scan) - LEAF
...
### Step 11: Node 13839 (Index Scan) - LEAF
...
### Step 12: Node 13841 (Seq Scan) - LEAF
...
### Step 13: Node 13828 (Nested Loop)
...
### Step 16: Node 13842 (Index Scan) - LEAF
...
### Step 17: Node 13844 (Seq Scan) - LEAF
...
### Step 18: Node 13826 (Nested Loop)
...
### Step 22: Node 13823 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1044.9427
  - st2=0.0000
  - startup_cost=71551.6900
  - total_cost=71838.4700
- **Output:** st=1093.45, rt=1097.16

### Step 23: Node 13822 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=71551.6900
  - total_cost=71935.0700
- **Output:** st=1163.54, rt=1194.14
