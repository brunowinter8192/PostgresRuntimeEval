        ...
        Node 30824 (Incremental Sort)
          Node 30825 (Nested Loop)
            Node 30826 (Merge Join)
              Node 30827 (Sort)
                Node 30828 (Hash Join)
                  Node 30829 (Seq Scan) - LEAF
                  Node 30830 (Hash)
...
| 30827 | Sort | 2845.09 | 1099.77 | 61.3% | operator |
| 30833 | Sort | 67.59 | 1074.66 | 1490.0% | operator |
| 30828 | Hash Join | 2845.08 | 686.33 | 75.9% | operator |
| 30834 | Seq Scan | 54.07 | 18.25 | 66.3% | operator |
| 30829 | Seq Scan | 191.22 | 170.37 | 10.9% | operator |
| 30830 | Hash | 2623.96 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30829 (Seq Scan) - LEAF
...
### Step 6: Node 30834 (Seq Scan) - LEAF
...
### Step 9: Node 30826 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30835 (Index Scan) - LEAF
...
### Step 11: Node 30825 (Nested Loop)
...
### Step 12: Node 30824 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30823 (Gather Merge)
