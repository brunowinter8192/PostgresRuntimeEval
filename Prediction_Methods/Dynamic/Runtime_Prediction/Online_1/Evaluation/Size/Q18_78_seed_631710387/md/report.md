...
**Test Query:** Q18_78_seed_631710387
...
```
Node 30820 (Limit) - ROOT
  Node 30821 (Sort)
    Node 30822 (Aggregate)
      Node 30823 (Gather Merge)
        Node 30824 (Incremental Sort)
          Node 30825 (Nested Loop)
            Node 30826 (Merge Join)
              Node 30827 (Sort)
                Node 30828 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30829 (Seq Scan) [consumed] - LEAF
                  Node 30830 (Hash) [consumed]
                    Node 30831 (Aggregate)
                      Node 30832 (Index Scan) - LEAF
              Node 30833 (Sort)
                Node 30834 (Seq Scan) - LEAF
            Node 30835 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30828 | 30829, 30830 |
...
|------|------|--------|-----------|-----|--------|
| 30820 | Limit | 3048.09 | 1175.21 | 61.4% | operator |
| 30821 | Sort | 2936.21 | 1127.81 | 61.6% | operator |
| 30822 | Aggregate | 2936.16 | 1073.15 | 63.5% | operator |
| 30823 | Gather Merge | 2936.15 | 1073.95 | 63.4% | operator |
| 30824 | Incremental Sort | 2917.00 | 0.00 | 100.0% | operator |
| 30825 | Nested Loop | 2916.94 | 1111.34 | 61.9% | operator |
| 30826 | Merge Join | 2916.88 | 0.00 | 100.0% | operator |
| 30835 | Index Scan | 0.02 | 0.05 | 96.2% | operator |
| 30827 | Sort | 2845.09 | 1095.58 | 61.5% | operator |
| 30833 | Sort | 67.59 | 1074.66 | 1490.0% | operator |
| 30828 | Hash Join | 2845.08 | 471.07 | 83.4% | pattern |
| 30834 | Seq Scan | 54.07 | 18.25 | 66.3% | operator |
| 30831 | Aggregate | 2623.91 | 1073.15 | 59.1% | operator |
| 30832 | Index Scan | 2123.99 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30832 (Index Scan) - LEAF
...
### Step 3: Node 30828 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30829, 30830
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30834 (Seq Scan) - LEAF
...
### Step 7: Node 30826 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30835 (Index Scan) - LEAF
...
### Step 10: Node 30824 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30823 (Gather Merge)
