...
**Test Query:** Q4_113_seed_918851472
...
```
Node 5949 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 5950 (Gather Merge) [consumed]
    Node 5951 (Sort) [consumed]
      Node 5952 (Aggregate) [consumed]
        Node 5953 (Nested Loop)
          Node 5954 (Seq Scan) - LEAF
          Node 5955 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 5949 | 5950, 5951, 5952 |
...
|------|------|--------|-----------|-----|--------|
| 5949 | Aggregate | 1076.94 | 952.19 | 11.6% | pattern |
| 5953 | Nested Loop | 1070.09 | 1255.45 | 17.3% | operator |
| 5954 | Seq Scan | 162.76 | 154.67 | 5.0% | operator |
| 5955 | Index Scan | 0.06 | 11.10 | 17526.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5954 (Seq Scan) - LEAF
...
### Step 2: Node 5955 (Index Scan) - LEAF
