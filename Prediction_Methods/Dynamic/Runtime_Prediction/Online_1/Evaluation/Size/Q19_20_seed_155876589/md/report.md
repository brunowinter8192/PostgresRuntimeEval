...
**Test Query:** Q19_20_seed_155876589
...
```
Node 31654 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31655 (Gather) [consumed]
    Node 31656 (Aggregate) [consumed]
      Node 31657 (Hash Join) [consumed]
        Node 31658 (Seq Scan) - LEAF
        Node 31659 (Hash)
          Node 31660 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31654 | 31655, 31656, 31657 |
...
|------|------|--------|-----------|-----|--------|
| 31654 | Aggregate | 837.68 | 829.30 | 1.0% | pattern |
| 31658 | Seq Scan | 767.71 | 743.46 | 3.2% | operator |
| 31659 | Hash | 47.20 | 8.29 | 82.4% | operator |
| 31660 | Seq Scan | 47.00 | 23.76 | 49.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31660 (Seq Scan) - LEAF
...
### Step 2: Node 31658 (Seq Scan) - LEAF
...
### Step 4: Node 31654 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31655, 31656, 31657
- **Input Features:**
