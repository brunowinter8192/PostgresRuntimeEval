...
**Test Query:** Q3_17_seed_131264496
...
```
Node 4931 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 4932 (Sort) [consumed]
    Node 4933 (Aggregate) [consumed]
      Node 4934 (Gather) [consumed]
        Node 4935 (Nested Loop)
          Node 4936 (Hash Join) [PATTERN: 895c6e8c]
            Node 4937 (Seq Scan) [consumed] - LEAF
            Node 4938 (Hash) [consumed]
              Node 4939 (Seq Scan) - LEAF
          Node 4940 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4931 | 4932, 4933, 4934, 4936, 4937, 4938 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4936 | 4931, 4932, 4933, 4934, 4937, 4938 |
...
|------|------|--------|-----------|-----|--------|
| 4931 | Limit | 1179.95 | 1151.18 | 2.4% | pattern |
| 4935 | Nested Loop | 1142.86 | 1193.36 | 4.4% | operator |
| 4936 | Hash Join | 209.98 | 242.54 | 15.5% | pattern |
| 4940 | Index Scan | 0.03 | -0.52 | 2172.3% | operator |
| 4939 | Seq Scan | 29.14 | 38.57 | 32.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4939 (Seq Scan) - LEAF
...
### Step 2: Node 4936 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4931, 4932, 4933, 4934, 4937, 4938
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47396
  - HashJoin_nt1=237233
...
### Step 3: Node 4940 (Index Scan) - LEAF
...
### Step 5: Node 4931 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4932, 4933, 4934, 4936, 4937, 4938
- **Input Features:**
