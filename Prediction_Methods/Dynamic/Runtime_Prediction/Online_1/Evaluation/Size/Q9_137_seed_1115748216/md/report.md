    ...
    Node 17377 (Gather)
      Node 17378 (Aggregate)
        Node 17379 (Nested Loop)
          Node 17380 (Hash Join) [PATTERN: bb930825]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17380 | 17375, 17376, 17381, 17382, 17383 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17375 | 17376, 17380, 17381, 17382, 17383 |
...
|------|------|--------|-----------|-----|--------|
| 17375 | Sort | 1170.05 | 1047.04 | 10.5% | pattern |
...
| 17380 | Hash Join | 956.13 | 134.80 | 85.9% | pattern |
...
### Step 9: Node 17380 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17375, 17376, 17381, 17382, 17383
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17392 (Index Scan) - LEAF
...
### Step 11: Node 17379 (Nested Loop)
...
### Step 14: Node 17375 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17376, 17380, 17381, 17382, 17383
- **Input Features:**
