...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4691 | 4692, 4693, 4694, 4696, 4697, 4698 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4696 | 4691, 4692, 4693, 4694, 4697, 4698 |
...
| 4695 | Nested Loop | 1162.98 | 1192.51 | 2.5% | operator |
| 4696 | Hash Join | 210.17 | 242.37 | 15.3% | pattern |
...
- **Consumes:** Nodes 4691, 4692, 4693, 4694, 4697, 4698
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46076
  - HashJoin_nt1=232303
  ...
  - HashJoin_total_cost=37330.4200
  - Hash_Inner_np=0
  - Hash_Inner_nt=12397
...
- **Output:** st=29.80, rt=242.37

### Step 3: Node 4700 (Index Scan) - LEAF
...
- **Output:** st=121.29, rt=1192.51

### Step 5: Node 4691 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4692, 4693, 4694, 4696, 4697, 4698
- **Input Features:**
