...
```
Node 16760 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 16761 (Aggregate) [consumed]
    Node 16762 (Gather)
      Node 16763 (Aggregate)
        Node 16764 (Nested Loop)
          Node 16765 (Hash Join) [PATTERN: bb930825]
            Node 16766 (Seq Scan) [consumed] - LEAF
            Node 16767 (Hash) [consumed]
              Node 16768 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 16765 | 16760, 16761, 16766, 16767, 16768 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 16760 | 16761, 16765, 16766, 16767, 16768 |
...
|------|------|--------|-----------|-----|--------|
| 16760 | Sort | 1192.07 | 1045.32 | 12.3% | pattern |
...
| 16765 | Hash Join | 973.16 | 134.80 | 86.1% | pattern |
...
### Step 9: Node 16765 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 16760, 16761, 16766, 16767, 16768
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 16777 (Index Scan) - LEAF
...
### Step 11: Node 16764 (Nested Loop)
...
### Step 14: Node 16760 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 16761, 16765, 16766, 16767, 16768
- **Input Features:**
