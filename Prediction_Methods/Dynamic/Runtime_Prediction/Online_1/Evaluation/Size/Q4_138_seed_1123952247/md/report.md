...
**Test Query:** Q4_138_seed_1123952247
...
```
Node 6138 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6139 (Gather Merge) [consumed]
    Node 6140 (Sort) [consumed]
      Node 6141 (Aggregate) [consumed]
        Node 6142 (Nested Loop)
          Node 6143 (Seq Scan) - LEAF
          Node 6144 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6138 | 6139, 6140, 6141 |
...
|------|------|--------|-----------|-----|--------|
| 6138 | Aggregate | 1043.20 | 952.19 | 8.7% | pattern |
| 6142 | Nested Loop | 1036.27 | 1255.45 | 21.2% | operator |
| 6143 | Seq Scan | 165.32 | 154.66 | 6.5% | operator |
| 6144 | Index Scan | 0.06 | 11.10 | 18103.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6143 (Seq Scan) - LEAF
...
### Step 2: Node 6144 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - Sort_Outer_startup_cost=66210.4500
  - Sort_Outer_total_cost=66210.4600
