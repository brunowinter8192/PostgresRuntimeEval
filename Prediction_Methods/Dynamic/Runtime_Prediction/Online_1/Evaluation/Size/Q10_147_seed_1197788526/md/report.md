...
**Test Query:** Q10_147_seed_1197788526
**Timestamp:** 2026-01-18 19:26:49
...
```
Node 20033 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 20034 (Sort) [consumed]
    Node 20035 (Aggregate) [consumed]
      Node 20036 (Gather) [consumed]
        Node 20037 (Hash Join)
          Node 20038 (Hash Join) [PATTERN: 2e0f44ef]
            Node 20039 (Nested Loop) [consumed]
              Node 20040 (Seq Scan) - LEAF
              Node 20041 (Index Scan) - LEAF
            Node 20042 (Hash) [consumed]
              Node 20043 (Seq Scan) - LEAF
          Node 20044 (Hash)
            Node 20045 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20033 | 20034, 20035, 20036, 20038, 20039, 20042 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 20038 | 20033, 20034, 20035, 20036, 20039, 20042 |
...
|------|------|--------|-----------|-----|--------|
| 20033 | Limit | 1110.22 | 1199.47 | 8.0% | pattern |
| 20037 | Hash Join | 1063.37 | 1095.50 | 3.0% | operator |
| 20038 | Hash Join | 1060.50 | 1120.19 | 5.6% | pattern |
| 20044 | Hash | 0.01 | 15.71 | 112119.8% | operator |
| 20045 | Seq Scan | 0.01 | 6.98 | 69687.0% | operator |
| 20040 | Seq Scan | 160.58 | 159.74 | 0.5% | operator |
| 20041 | Index Scan | 0.06 | -0.52 | 949.6% | operator |
| 20043 | Seq Scan | 23.92 | 26.64 | 11.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 20040 (Seq Scan) - LEAF
...
### Step 2: Node 20041 (Index Scan) - LEAF
...
### Step 3: Node 20043 (Seq Scan) - LEAF
...
### Step 4: Node 20045 (Seq Scan) - LEAF
...
### Step 5: Node 20038 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 20033, 20034, 20035, 20036, 20039, 20042
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=17978
  - HashJoin_nt1=17978
  ...
  - HashJoin_total_cost=80613.9400
  - Hash_Inner_np=0
  - Hash_Inner_nt=62500
  ...
  - NestedLoop_Outer_nt=17978
  - NestedLoop_Outer_nt1=18165
  ...
  - NestedLoop_Outer_total_cost=75560.5000
- **Output:** st=51.86, rt=1120.19

### Step 6: Node 20044 (Hash)
...
- **Input Features:**
  ...
  - total_cost=80670.6900
- **Output:** st=54.19, rt=1095.50

### Step 8: Node 20033 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20034, 20035, 20036, 20038, 20039, 20042
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=55733
  - Aggregate_Outer_nt1=55733
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=280
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=87940.6500
  - Aggregate_Outer_total_cost=88637.3200
  - Gather_Outer_np=0
  - Gather_Outer_nt=55733
  - Gather_Outer_nt1=17978
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=87243.9900
  - Limit_np=0
  - Limit_nt=20
  - Limit_nt1=55733
  - Limit_nt2=0
  ...
  - Limit_sel=0.0004
  - Limit_startup_cost=90120.3500
  - Limit_total_cost=90120.4000
  - Sort_Outer_np=0
  - Sort_Outer_nt=55733
  - Sort_Outer_nt1=55733
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=280
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=90120.3500
  - Sort_Outer_total_cost=90259.6800
