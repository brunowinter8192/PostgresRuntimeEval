...
**Test Query:** Q13_53_seed_426609612
**Timestamp:** 2026-01-18 19:59:47
...
```
Node 26056 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26057 (Aggregate) [consumed]
    Node 26058 (Aggregate)
      Node 26059 (Hash Join) [PATTERN: 895c6e8c]
        Node 26060 (Seq Scan) [consumed] - LEAF
        Node 26061 (Hash) [consumed]
          Node 26062 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26056 | 26057, 26059, 26060, 26061 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26059 | 26056, 26057, 26060, 26061 |
...
|------|------|--------|-----------|-----|--------|
| 26056 | Sort | 909.84 | 1079.93 | 18.7% | pattern |
| 26058 | Aggregate | 903.89 | 999.15 | 10.5% | operator |
| 26059 | Hash Join | 695.07 | 470.31 | 32.3% | pattern |
| 26062 | Index Only Scan | 10.10 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26062 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26059 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26056, 26057, 26060, 26061
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1478958
...
### Step 4: Node 26056 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26057, 26059, 26060, 26061
- **Input Features:**
