...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4771 | 4772, 4773, 4774, 4776, 4777, 4778 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4776 | 4771, 4772, 4773, 4774, 4777, 4778 |
...
|------|------|--------|-----------|-----|--------|
| 4771 | Limit | 1190.82 | 1151.18 | 3.3% | pattern |
| 4775 | Nested Loop | 1153.47 | 1193.25 | 3.4% | operator |
| 4776 | Hash Join | 205.15 | 242.52 | 18.2% | pattern |
| 4780 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4779 | Seq Scan | 28.50 | 38.54 | 35.2% | operator |
...
- **Consumes:** Nodes 4771, 4772, 4773, 4774, 4777, 4778
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47224
  - HashJoin_nt1=235005
  ...
  - HashJoin_total_cost=37339.5300
  - Hash_Inner_np=0
  - Hash_Inner_nt=12559
...
- **Output:** st=29.73, rt=242.52

### Step 3: Node 4780 (Index Scan) - LEAF
...
- **Output:** st=121.98, rt=1193.25

### Step 5: Node 4771 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4772, 4773, 4774, 4776, 4777, 4778
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=315159
  - Aggregate_Outer_nt1=315159
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110348.6700
  - Aggregate_Outer_total_cost=114288.1500
  - Gather_Outer_np=0
