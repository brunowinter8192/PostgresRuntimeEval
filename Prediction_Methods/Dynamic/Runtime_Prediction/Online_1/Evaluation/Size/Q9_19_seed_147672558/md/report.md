...
```
Node 17738 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 17739 (Aggregate) [consumed]
    Node 17740 (Gather)
      Node 17741 (Aggregate)
        Node 17742 (Hash Join)
          Node 17743 (Seq Scan) - LEAF
          Node 17744 (Hash) [PATTERN: 444761fb]
            Node 17745 (Hash Join) [consumed]
              Node 17746 (Seq Scan) [consumed] - LEAF
              Node 17747 (Hash) [consumed]
                Node 17748 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 17744 | 17738, 17739, 17745, 17746, 17747, 17748 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17738 | 17739, 17744, 17745, 17746, 17747, 17748 |
...
|------|------|--------|-----------|-----|--------|
| 17738 | Sort | 1238.74 | 1063.40 | 14.2% | pattern |
| 17740 | Gather | 1237.76 | 962.35 | 22.3% | operator |
| 17741 | Aggregate | 1220.02 | 902.72 | 26.0% | operator |
| 17742 | Hash Join | 1191.48 | 580.10 | 51.3% | operator |
| 17743 | Seq Scan | 129.36 | 193.40 | 49.5% | operator |
| 17744 | Hash | 1000.54 | 35.69 | 96.4% | pattern |
...
### Step 9: Node 17743 (Seq Scan) - LEAF
...
### Step 10: Node 17744 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 17738, 17739, 17745, 17746, 17747, 17748
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 14: Node 17738 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17739, 17744, 17745, 17746, 17747, 17748
- **Input Features:**
