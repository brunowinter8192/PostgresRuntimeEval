    ...
    Node 20334 (Aggregate) [consumed]
      Node 20335 (Gather) [consumed]
        Node 20336 (Hash Join)
          Node 20337 (Hash Join)
            Node 20338 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20332 | 20333, 20334, 20335 |
...
| 20336 | Hash Join | 1095.58 | 1007.38 | 8.1% | operator |
| 20337 | Hash Join | 1093.01 | 1004.38 | 8.1% | operator |
| 20343 | Hash | 0.01 | 15.71 | 112119.8% | operator |
| 20338 | Nested Loop | 1047.82 | 1204.71 | 15.0% | operator |
| 20341 | Hash | 35.23 | 55.57 | 57.7% | operator |
...
### Step 6: Node 20344 (Seq Scan) - LEAF
...
### Step 10: Node 20332 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20333, 20334, 20335
- **Input Features:**
