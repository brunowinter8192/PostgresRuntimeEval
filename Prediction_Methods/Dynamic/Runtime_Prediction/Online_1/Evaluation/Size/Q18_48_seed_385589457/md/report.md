...
**Test Query:** Q18_48_seed_385589457
...
```
Node 30292 (Limit) - ROOT
  Node 30293 (Sort)
    Node 30294 (Aggregate)
      Node 30295 (Gather Merge)
        Node 30296 (Incremental Sort)
          Node 30297 (Nested Loop)
            Node 30298 (Merge Join)
              Node 30299 (Sort)
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30300 | 30301, 30302 |
...
|------|------|--------|-----------|-----|--------|
| 30292 | Limit | 3037.07 | 1175.21 | 61.3% | operator |
| 30293 | Sort | 2924.94 | 1127.81 | 61.4% | operator |
| 30294 | Aggregate | 2924.91 | 1073.15 | 63.3% | operator |
| 30295 | Gather Merge | 2924.88 | 1073.95 | 63.3% | operator |
| 30296 | Incremental Sort | 2903.02 | 0.00 | 100.0% | operator |
| 30297 | Nested Loop | 2902.98 | 1111.34 | 61.7% | operator |
| 30298 | Merge Join | 2902.92 | 0.00 | 100.0% | operator |
| 30307 | Index Scan | 0.02 | 0.05 | 105.2% | operator |
| 30299 | Sort | 2833.17 | 1095.58 | 61.3% | operator |
| 30305 | Sort | 67.52 | 1074.66 | 1491.7% | operator |
| 30300 | Hash Join | 2833.16 | 471.07 | 83.4% | pattern |
| 30306 | Seq Scan | 53.52 | 18.25 | 65.9% | operator |
| 30303 | Aggregate | 2610.85 | 1073.15 | 58.9% | operator |
| 30304 | Index Scan | 2109.32 | 0.00 | 100.0% | operator |
...
### Step 4: Node 30306 (Seq Scan) - LEAF
...
### Step 7: Node 30298 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30307 (Index Scan) - LEAF
...
### Step 10: Node 30296 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30295 (Gather Merge)
