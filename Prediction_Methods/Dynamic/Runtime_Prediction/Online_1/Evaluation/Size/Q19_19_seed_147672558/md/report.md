...
```
Node 31640 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31641 (Gather) [consumed]
    Node 31642 (Aggregate) [consumed]
      Node 31643 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31640 | 31641, 31642 |
...
|------|------|--------|-----------|-----|--------|
| 31640 | Aggregate | 863.83 | 831.20 | 3.8% | pattern |
| 31643 | Hash Join | 836.71 | 766.06 | 8.4% | operator |
...
### Step 5: Node 31640 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31641, 31642
- **Input Features:**
