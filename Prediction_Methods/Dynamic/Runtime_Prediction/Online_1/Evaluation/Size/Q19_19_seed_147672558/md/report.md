...
**Test Query:** Q19_19_seed_147672558
...
```
Node 31640 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31641 (Gather) [consumed]
    Node 31642 (Aggregate) [consumed]
      Node 31643 (Hash Join) [consumed]
        Node 31644 (Seq Scan) - LEAF
        Node 31645 (Hash)
          Node 31646 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31640 | 31641, 31642, 31643 |
...
|------|------|--------|-----------|-----|--------|
| 31640 | Aggregate | 863.83 | 829.30 | 4.0% | pattern |
| 31644 | Seq Scan | 788.29 | 743.46 | 5.7% | operator |
| 31645 | Hash | 46.10 | 8.29 | 82.0% | operator |
| 31646 | Seq Scan | 46.02 | 23.76 | 48.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31646 (Seq Scan) - LEAF
...
### Step 2: Node 31644 (Seq Scan) - LEAF
...
### Step 4: Node 31640 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31641, 31642, 31643
- **Input Features:**
