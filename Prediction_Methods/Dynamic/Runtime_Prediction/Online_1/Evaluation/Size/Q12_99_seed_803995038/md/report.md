...
**Test Query:** Q12_99_seed_803995038
...
```
Node 25356 (Aggregate) - ROOT
  Node 25357 (Gather Merge)
    Node 25358 (Aggregate)
      Node 25359 (Sort)
        Node 25360 (Nested Loop)
          Node 25361 (Seq Scan) - LEAF
          Node 25362 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 25356 | Aggregate | 1009.28 | 919.05 | 8.9% | operator |
| 25357 | Gather Merge | 1009.25 | 1111.84 | 10.2% | operator |
| 25358 | Aggregate | 988.42 | 895.30 | 9.4% | operator |
| 25359 | Sort | 987.80 | 1092.82 | 10.6% | operator |
| 25360 | Nested Loop | 986.83 | 1127.41 | 14.2% | operator |
| 25361 | Seq Scan | 845.52 | 745.19 | 11.9% | operator |
| 25362 | Index Scan | 0.03 | 0.07 | 166.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25361 (Seq Scan) - LEAF
...
### Step 2: Node 25362 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - st2=0.1246
  - startup_cost=0.4300
  - total_cost=147194.4200
- **Output:** st=38.32, rt=1127.41

### Step 4: Node 25359 (Sort)
...
- **Input Features:**
  ...
  - st1=38.3225
  - st2=0.0000
  - startup_cost=147556.9000
  - total_cost=147571.4000
- **Output:** st=1092.41, rt=1092.82

### Step 5: Node 25358 (Aggregate)
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=147556.9000
  - total_cost=147672.9500
- **Output:** st=868.94, rt=895.30

### Step 6: Node 25357 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=868.9400
  - st2=0.0000
  - startup_cost=148556.9800
  - total_cost=148677.2400
- **Output:** st=1109.22, rt=1111.84

### Step 7: Node 25356 (Aggregate) - ROOT
