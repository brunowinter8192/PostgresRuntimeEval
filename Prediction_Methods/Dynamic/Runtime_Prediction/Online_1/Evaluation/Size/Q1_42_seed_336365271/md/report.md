...
**Test Query:** Q1_42_seed_336365271
...
```
Node 431 (Aggregate) - ROOT
  Node 432 (Gather Merge)
    Node 433 (Sort) [PATTERN: 1d35fb97]
      Node 434 (Aggregate) [consumed]
        Node 435 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 433 | 434 |
...
|------|------|--------|-----------|-----|--------|
| 431 | Aggregate | 937.03 | 1195.81 | 27.6% | operator |
| 432 | Gather Merge | 936.99 | 1165.88 | 24.4% | operator |
| 433 | Sort | 918.91 | 1200.20 | 30.6% | pattern |
| 435 | Seq Scan | 511.58 | 681.39 | 33.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 435 (Seq Scan) - LEAF
...
### Step 2: Node 433 (Sort) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Aggregate_Outer_nt1=1175956
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=236
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=168761.5000
  - Aggregate_Outer_total_cost=168761.6300
  - Sort_np=0
  - Sort_nt=6
  - Sort_nt1=6
  - Sort_nt2=0
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=168761.7100
  - Sort_total_cost=168761.7300
- **Output:** st=1196.11, rt=1200.20

### Step 3: Node 432 (Gather Merge)
...
### Step 4: Node 431 (Aggregate) - ROOT
