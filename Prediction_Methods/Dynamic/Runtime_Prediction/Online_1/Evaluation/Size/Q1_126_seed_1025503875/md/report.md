...
Node 141 (Aggregate) - ROOT
  Node 142 (Gather Merge)
    Node 143 (Sort) [PATTERN: 1d35fb97]
      Node 144 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 143 | 144 |
...
|------|------|--------|-----------|-----|--------|
| 141 | Aggregate | 996.02 | 1195.92 | 20.1% | operator |
| 142 | Gather Merge | 995.95 | 1165.91 | 17.1% | operator |
| 143 | Sort | 976.22 | 1200.61 | 23.0% | pattern |
...
### Step 2: Node 143 (Sort) - PATTERN ROOT
...
### Step 4: Node 141 (Aggregate) - ROOT
