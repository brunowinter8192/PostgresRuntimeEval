...
**Test Query:** Q8_120_seed_976279689
...
```
Node 13707 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 13708 (Gather Merge) [consumed]
    Node 13709 (Sort)
      Node 13710 (Hash Join)
        Node 13711 (Nested Loop)
          Node 13712 (Hash Join)
            Node 13713 (Nested Loop)
              Node 13714 (Hash Join)
                Node 13715 (Seq Scan) - LEAF
                Node 13716 (Hash) [PATTERN: 444761fb]
                  Node 13717 (Hash Join) [consumed]
                    Node 13718 (Seq Scan) [consumed] - LEAF
                    Node 13719 (Hash) [consumed]
                      Node 13720 (Hash Join) [consumed]
                        Node 13721 (Seq Scan) - LEAF
                        Node 13722 (Hash)
                          Node 13723 (Seq Scan) - LEAF
              Node 13724 (Index Scan) - LEAF
            Node 13725 (Hash)
              Node 13726 (Seq Scan) - LEAF
          Node 13727 (Index Scan) - LEAF
        Node 13728 (Hash)
          Node 13729 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 13716 | 13707, 13708, 13717, 13718, 13719, 13720 |
| Aggregate -> Gather Merge (Out | 2724c080 | 13707 | 13708, 13716, 13717, 13718, 13719, 13720 |
...
|------|------|--------|-----------|-----|--------|
| 13707 | Aggregate | 1202.52 | 1132.51 | 5.8% | pattern |
| 13709 | Sort | 1197.39 | 1046.21 | 12.6% | operator |
| 13710 | Hash Join | 1197.15 | 785.61 | 34.4% | operator |
| 13711 | Nested Loop | 1196.84 | 1198.29 | 0.1% | operator |
| 13728 | Hash | 0.01 | 13.72 | 105469.9% | operator |
| 13712 | Hash Join | 1192.87 | 785.60 | 34.1% | operator |
| 13727 | Index Scan | 0.01 | 12.42 | 206958.1% | operator |
| 13729 | Seq Scan | 0.01 | 6.51 | 72255.1% | operator |
| 13713 | Nested Loop | 1147.58 | 1198.29 | 4.4% | operator |
| 13725 | Hash | 40.83 | 19.97 | 51.1% | operator |
| 13714 | Hash Join | 211.62 | 251.67 | 18.9% | operator |
| 13724 | Index Scan | 0.04 | 2.88 | 6926.5% | operator |
| 13726 | Seq Scan | 40.69 | 48.87 | 20.1% | operator |
| 13715 | Seq Scan | 159.60 | 159.67 | 0.0% | operator |
| 13716 | Hash | 33.83 | 43.51 | 28.6% | pattern |
| 13721 | Seq Scan | 0.01 | 12.22 | 111035.8% | operator |
| 13722 | Hash | 0.17 | 18.14 | 10896.5% | operator |
| 13723 | Seq Scan | 0.16 | 23.36 | 14321.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 13723 (Seq Scan) - LEAF
...
### Step 2: Node 13721 (Seq Scan) - LEAF
...
### Step 4: Node 13715 (Seq Scan) - LEAF
...
### Step 5: Node 13716 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 13707, 13708, 13717, 13718, 13719, 13720
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 13724 (Index Scan) - LEAF
...
### Step 8: Node 13726 (Seq Scan) - LEAF
...
### Step 12: Node 13727 (Index Scan) - LEAF
...
### Step 13: Node 13729 (Seq Scan) - LEAF
...
### Step 14: Node 13711 (Nested Loop)
...
### Step 18: Node 13707 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 13708, 13716, 13717, 13718, 13719, 13720
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2429
