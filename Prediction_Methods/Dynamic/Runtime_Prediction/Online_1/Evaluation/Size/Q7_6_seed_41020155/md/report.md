...
```
Node 12589 (Aggregate) - ROOT
  Node 12590 (Gather Merge)
    Node 12591 (Sort)
      Node 12592 (Hash Join)
        Node 12593 (Nested Loop)
          Node 12594 (Hash Join)
            Node 12595 (Seq Scan) - LEAF
            Node 12596 (Hash)
              Node 12597 (Hash Join)
                Node 12598 (Seq Scan) - LEAF
                Node 12599 (Hash)
                  Node 12600 (Seq Scan) - LEAF
          Node 12601 (Index Scan) - LEAF
        Node 12602 (Hash)
          Node 12603 (Hash Join)
            Node 12604 (Seq Scan) - LEAF
            Node 12605 (Hash)
              Node 12606 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12589 | Aggregate | 1195.50 | 1209.26 | 1.2% | operator |
| 12590 | Gather Merge | 1194.45 | 1142.98 | 4.3% | operator |
| 12591 | Sort | 1188.39 | 1109.13 | 6.7% | operator |
| 12592 | Hash Join | 1187.77 | 842.59 | 29.1% | operator |
| 12593 | Nested Loop | 1180.73 | 1216.16 | 3.0% | operator |
| 12602 | Hash | 3.23 | 17.53 | 443.6% | operator |
| 12594 | Hash Join | 216.69 | 384.47 | 77.4% | operator |
| 12601 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 12603 | Hash Join | 3.17 | 85.17 | 2586.0% | operator |
| 12595 | Seq Scan | 154.11 | 201.16 | 30.5% | operator |
| 12596 | Hash | 37.08 | 19.59 | 47.2% | operator |
| 12604 | Seq Scan | 2.83 | 11.47 | 304.8% | operator |
| 12605 | Hash | 0.01 | 16.89 | 112527.2% | operator |
| 12597 | Hash Join | 36.00 | 92.20 | 156.1% | operator |
| 12606 | Seq Scan | 0.01 | 45.79 | 381502.6% | operator |
| 12598 | Seq Scan | 34.83 | 21.86 | 37.2% | operator |
| 12599 | Hash | 0.01 | 16.89 | 168840.8% | operator |
| 12600 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12600 (Seq Scan) - LEAF
...
### Step 2: Node 12598 (Seq Scan) - LEAF
...
### Step 5: Node 12606 (Seq Scan) - LEAF
...
### Step 6: Node 12595 (Seq Scan) - LEAF
...
### Step 8: Node 12604 (Seq Scan) - LEAF
...
### Step 11: Node 12601 (Index Scan) - LEAF
...
### Step 13: Node 12593 (Nested Loop)
...
### Step 17: Node 12590 (Gather Merge)
...
### Step 18: Node 12589 (Aggregate) - ROOT
