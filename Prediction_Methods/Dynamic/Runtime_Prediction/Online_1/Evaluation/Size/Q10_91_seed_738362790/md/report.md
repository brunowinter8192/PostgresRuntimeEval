...
**Test Query:** Q10_91_seed_738362790
**Timestamp:** 2026-01-18 19:45:30
...
```
Node 21190 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 21191 (Sort) [consumed]
    Node 21192 (Aggregate) [consumed]
      Node 21193 (Gather) [consumed]
        Node 21194 (Hash Join)
          Node 21195 (Hash Join) [PATTERN: 2e0f44ef]
            Node 21196 (Nested Loop) [consumed]
              Node 21197 (Seq Scan) - LEAF
              Node 21198 (Index Scan) - LEAF
            Node 21199 (Hash) [consumed]
              Node 21200 (Seq Scan) - LEAF
          Node 21201 (Hash)
            Node 21202 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 21190 | 21191, 21192, 21193, 21195, 21196, 21199 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 21195 | 21190, 21191, 21192, 21193, 21196, 21199 |
...
|------|------|--------|-----------|-----|--------|
| 21190 | Limit | 1142.03 | 1199.47 | 5.0% | pattern |
| 21194 | Hash Join | 1092.72 | 1095.58 | 0.3% | operator |
| 21195 | Hash Join | 1089.48 | 1120.19 | 2.8% | pattern |
| 21201 | Hash | 0.01 | 15.71 | 112119.8% | operator |
| 21202 | Seq Scan | 0.01 | 6.98 | 77441.2% | operator |
| 21197 | Seq Scan | 161.83 | 159.74 | 1.3% | operator |
| 21198 | Index Scan | 0.06 | -0.52 | 949.6% | operator |
| 21200 | Seq Scan | 23.77 | 26.64 | 12.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 21197 (Seq Scan) - LEAF
...
### Step 2: Node 21198 (Index Scan) - LEAF
...
### Step 3: Node 21200 (Seq Scan) - LEAF
...
### Step 4: Node 21202 (Seq Scan) - LEAF
...
### Step 5: Node 21195 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 21190, 21191, 21192, 21193, 21196, 21199
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18276
  - HashJoin_nt1=18276
...
### Step 8: Node 21190 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 21191, 21192, 21193, 21195, 21196, 21199
- **Input Features:**
