    ...
    Node 21192 (Aggregate) [consumed]
      Node 21193 (Gather) [consumed]
        Node 21194 (Hash Join)
          Node 21195 (Hash Join)
            Node 21196 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 21190 | 21191, 21192, 21193 |
...
| 21194 | Hash Join | 1092.72 | 1007.12 | 7.8% | operator |
| 21195 | Hash Join | 1089.48 | 1003.97 | 7.8% | operator |
| 21201 | Hash | 0.01 | 15.71 | 112119.8% | operator |
| 21196 | Nested Loop | 1040.45 | 1204.87 | 15.8% | operator |
| 21199 | Hash | 37.13 | 55.57 | 49.7% | operator |
...
### Step 6: Node 21202 (Seq Scan) - LEAF
...
### Step 10: Node 21190 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 21191, 21192, 21193
- **Input Features:**
