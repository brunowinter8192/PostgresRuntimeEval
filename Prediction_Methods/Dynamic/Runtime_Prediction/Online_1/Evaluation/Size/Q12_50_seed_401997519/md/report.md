...
**Test Query:** Q12_50_seed_401997519
...
```
Node 24985 (Aggregate) - ROOT
  Node 24986 (Gather Merge)
    Node 24987 (Aggregate)
      Node 24988 (Sort)
        Node 24989 (Nested Loop)
          Node 24990 (Seq Scan) - LEAF
          Node 24991 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24985 | Aggregate | 991.61 | 919.06 | 7.3% | operator |
| 24986 | Gather Merge | 991.59 | 1111.84 | 12.1% | operator |
| 24987 | Aggregate | 971.21 | 895.31 | 7.8% | operator |
| 24988 | Sort | 970.60 | 1092.81 | 12.6% | operator |
| 24989 | Nested Loop | 969.60 | 1127.41 | 16.3% | operator |
| 24990 | Seq Scan | 833.21 | 745.19 | 10.6% | operator |
| 24991 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24990 (Seq Scan) - LEAF
...
### Step 2: Node 24991 (Index Scan) - LEAF
...
### Step 6: Node 24986 (Gather Merge)
...
### Step 7: Node 24985 (Aggregate) - ROOT
