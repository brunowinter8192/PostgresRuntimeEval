...
**Test Query:** Q3_114_seed_927055503
...
```
Node 4501 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 4502 (Sort) [consumed]
    Node 4503 (Aggregate) [consumed]
      Node 4504 (Gather) [consumed]
        Node 4505 (Nested Loop)
          Node 4506 (Hash Join) [PATTERN: 895c6e8c]
            Node 4507 (Seq Scan) [consumed] - LEAF
            Node 4508 (Hash) [consumed]
              Node 4509 (Seq Scan) - LEAF
          Node 4510 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4501 | 4502, 4503, 4504, 4506, 4507, 4508 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4506 | 4501, 4502, 4503, 4504, 4507, 4508 |
...
|------|------|--------|-----------|-----|--------|
| 4501 | Limit | 1218.94 | 1151.18 | 5.6% | pattern |
| 4505 | Nested Loop | 1182.69 | 1193.08 | 0.9% | operator |
| 4506 | Hash Join | 209.21 | 242.49 | 15.9% | pattern |
| 4510 | Index Scan | 0.03 | -0.52 | 2018.8% | operator |
| 4509 | Seq Scan | 29.46 | 38.53 | 30.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4509 (Seq Scan) - LEAF
...
### Step 2: Node 4506 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4501, 4502, 4503, 4504, 4507, 4508
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46963
  - HashJoin_nt1=233346
...
- **Output:** st=29.77, rt=242.49

### Step 3: Node 4510 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=72968.6700
- **Output:** st=121.81, rt=1193.08

### Step 5: Node 4501 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4502, 4503, 4504, 4506, 4507, 4508
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=315671
  - Aggregate_Outer_nt1=315671
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110270.8300
  - Aggregate_Outer_total_cost=114216.7200
  - Gather_Outer_np=0
  - Gather_Outer_nt=315671
  - Gather_Outer_nt1=101829
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105535.7700
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=315671
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=121038.2600
  - Limit_total_cost=121038.2800
  - Sort_Outer_np=0
  - Sort_Outer_nt=315671
  - Sort_Outer_nt1=315671
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=121038.2600
  - Sort_Outer_total_cost=121827.4300
