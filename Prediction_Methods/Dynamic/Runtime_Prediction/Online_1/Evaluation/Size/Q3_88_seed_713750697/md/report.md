    ...
    Node 5713 (Aggregate) [consumed]
      Node 5714 (Gather) [consumed]
        Node 5715 (Nested Loop)
          Node 5716 (Hash Join) [PATTERN: 895c6e8c]
            Node 5717 (Seq Scan) [consumed] - LEAF
            Node 5718 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5711 | 5712, 5713, 5714, 5716, 5717, 5718 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5716 | 5711, 5712, 5713, 5714, 5717, 5718 |
...
| 5715 | Nested Loop | 1137.84 | 1192.85 | 4.8% | operator |
| 5716 | Hash Join | 205.93 | 242.44 | 17.7% | pattern |
...
### Step 2: Node 5716 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5711, 5712, 5713, 5714, 5717, 5718
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46604
  - HashJoin_nt1=231924
  ...
  - HashJoin_total_cost=37331.4500
  - Hash_Inner_np=0
  - Hash_Inner_nt=12559
...
- **Output:** st=29.80, rt=242.44

### Step 3: Node 5720 (Index Scan) - LEAF
...
- **Output:** st=121.59, rt=1192.85

### Step 5: Node 5711 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5712, 5713, 5714, 5716, 5717, 5718
- **Input Features:**
