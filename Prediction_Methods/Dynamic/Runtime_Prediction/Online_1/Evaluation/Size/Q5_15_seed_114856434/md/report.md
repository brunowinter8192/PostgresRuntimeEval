...
```
Node 8021 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 8022 (Aggregate) [consumed]
    Node 8023 (Gather Merge) [consumed]
      Node 8024 (Aggregate)
        Node 8025 (Sort) [PATTERN: 3e2d5a00]
          Node 8026 (Hash Join) [consumed]
            Node 8027 (Nested Loop)
              Node 8028 (Hash Join)
                Node 8029 (Seq Scan) - LEAF
                Node 8030 (Hash) [PATTERN: 444761fb]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 8030 | 8021, 8022, 8023, 8025, 8026, 8031, 8032, 8033, 8034 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 8021 | 8022, 8023, 8025, 8026, 8030, 8031, 8032, 8033, 8034 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 8025 | 8021, 8022, 8023, 8026, 8030, 8031, 8032, 8033, 8034 |
...
|------|------|--------|-----------|-----|--------|
| 8021 | Sort | 1088.03 | 2934.42 | 169.7% | pattern |
| 8024 | Aggregate | 1083.20 | 1128.76 | 4.2% | operator |
| 8025 | Sort | 1082.94 | 1835.93 | 69.5% | pattern |
| 8027 | Nested Loop | 1070.59 | 1188.47 | 11.0% | operator |
| 8039 | Hash | 3.50 | 18.67 | 434.2% | operator |
| 8028 | Hash Join | 218.98 | 253.07 | 15.6% | operator |
| 8038 | Index Scan | 0.07 | -0.22 | 397.3% | operator |
| 8040 | Seq Scan | 2.91 | 12.36 | 325.0% | operator |
| 8029 | Seq Scan | 166.42 | 159.81 | 4.0% | operator |
| 8030 | Hash | 38.35 | 46.85 | 22.2% | pattern |
| 8035 | Seq Scan | 0.01 | 11.81 | 147503.4% | operator |
| 8036 | Hash | 0.35 | 21.05 | 5984.8% | operator |
| 8037 | Seq Scan | 0.34 | 22.93 | 6566.7% | operator |
...
- **Consumes:** Nodes 8021, 8022, 8023, 8025, 8026, 8031, 8032, 8033, 8034
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 11: Node 8025 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 8021, 8022, 8023, 8026, 8030, 8031, 8032, 8033, 8034
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 8021 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 8022, 8023, 8025, 8026, 8030, 8031, 8032, 8033, 8034
- **Input Features:**
