...
**Test Query:** Q13_17_seed_131264496
**Timestamp:** 2026-01-18 19:57:25
...
```
Node 25776 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25777 (Aggregate) [consumed]
    Node 25778 (Aggregate)
      Node 25779 (Hash Join) [PATTERN: 895c6e8c]
        Node 25780 (Seq Scan) [consumed] - LEAF
        Node 25781 (Hash) [consumed]
          Node 25782 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25776 | 25777, 25779, 25780, 25781 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25779 | 25776, 25777, 25780, 25781 |
...
|------|------|--------|-----------|-----|--------|
| 25776 | Sort | 910.37 | 1079.93 | 18.6% | pattern |
| 25778 | Aggregate | 904.23 | 999.35 | 10.5% | operator |
| 25779 | Hash Join | 691.93 | 470.31 | 32.0% | pattern |
| 25782 | Index Only Scan | 9.30 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25782 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25779 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25776, 25777, 25780, 25781
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1481964
...
### Step 4: Node 25776 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25777, 25779, 25780, 25781
- **Input Features:**
