...
**Test Query:** Q13_66_seed_533262015
...
```
Node 26154 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26155 (Aggregate) [consumed]
    Node 26156 (Aggregate)
      Node 26157 (Hash Join) [PATTERN: 895c6e8c]
        Node 26158 (Seq Scan) [consumed] - LEAF
        Node 26159 (Hash) [consumed]
          Node 26160 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26154 | 26155, 26157, 26158, 26159 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26157 | 26154, 26155, 26158, 26159 |
...
|------|------|--------|-----------|-----|--------|
| 26154 | Sort | 886.42 | 1079.94 | 21.8% | pattern |
| 26156 | Aggregate | 880.35 | 999.76 | 13.6% | operator |
| 26157 | Hash Join | 670.96 | 470.31 | 29.9% | pattern |
| 26160 | Index Only Scan | 10.00 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26160 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26157 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26154, 26155, 26158, 26159
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 26154 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26155, 26157, 26158, 26159
- **Input Features:**
