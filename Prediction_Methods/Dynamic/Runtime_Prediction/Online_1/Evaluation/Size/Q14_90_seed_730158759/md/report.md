...
```
Node 27393 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27394 (Gather) [consumed]
    Node 27395 (Aggregate) [consumed]
      Node 27396 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27393 | 27394, 27395, 27396 |
...
|------|------|--------|-----------|-----|--------|
| 27393 | Aggregate | 836.53 | 857.12 | 2.5% | pattern |
...
### Step 4: Node 27393 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27394, 27395, 27396
- **Input Features:**
