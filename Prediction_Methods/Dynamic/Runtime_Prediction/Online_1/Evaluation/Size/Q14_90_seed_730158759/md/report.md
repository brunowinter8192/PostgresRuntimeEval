...
**Test Query:** Q14_90_seed_730158759
...
```
Node 27393 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27394 (Gather) [consumed]
    Node 27395 (Aggregate) [consumed]
      Node 27396 (Hash Join)
        Node 27397 (Seq Scan) - LEAF
        Node 27398 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27393 | 27394, 27395 |
...
|------|------|--------|-----------|-----|--------|
| 27393 | Aggregate | 836.53 | 848.35 | 1.4% | pattern |
| 27396 | Hash Join | 814.41 | 807.62 | 0.8% | operator |
| 27397 | Seq Scan | 763.50 | 758.47 | 0.7% | operator |
| 27398 | Hash | 43.67 | 9.38 | 78.5% | operator |
| 27399 | Seq Scan | 38.23 | 12.70 | 66.8% | operator |
...
### Step 2: Node 27397 (Seq Scan) - LEAF
...
### Step 5: Node 27393 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27394, 27395
- **Input Features:**
