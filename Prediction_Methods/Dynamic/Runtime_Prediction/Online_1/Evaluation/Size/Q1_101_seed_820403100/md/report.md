...
Node 6 (Aggregate) - ROOT
  Node 7 (Gather Merge)
    Node 8 (Sort) [PATTERN: 1d35fb97]
      Node 9 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 8 | 9 |
...
|------|------|--------|-----------|-----|--------|
| 6 | Aggregate | 941.67 | 1196.00 | 27.0% | operator |
| 7 | Gather Merge | 941.60 | 1165.94 | 23.8% | operator |
| 8 | Sort | 922.64 | 1200.94 | 30.2% | pattern |
...
### Step 2: Node 8 (Sort) - PATTERN ROOT
