...
```
Node 8361 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 8362 (Aggregate) [consumed]
    Node 8363 (Gather Merge) [consumed]
      Node 8364 (Aggregate)
        Node 8365 (Sort) [PATTERN: 3e2d5a00]
          Node 8366 (Hash Join) [consumed]
            Node 8367 (Nested Loop)
              Node 8368 (Hash Join)
                Node 8369 (Seq Scan) - LEAF
                Node 8370 (Hash) [PATTERN: 444761fb]
                  Node 8371 (Hash Join) [consumed]
                    Node 8372 (Seq Scan) [consumed] - LEAF
                    Node 8373 (Hash) [consumed]
                      Node 8374 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 8370 | 8361, 8362, 8363, 8365, 8366, 8371, 8372, 8373, 8374 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 8361 | 8362, 8363, 8365, 8366, 8370, 8371, 8372, 8373, 8374 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 8365 | 8361, 8362, 8363, 8366, 8370, 8371, 8372, 8373, 8374 |
...
|------|------|--------|-----------|-----|--------|
| 8361 | Sort | 1093.97 | 2934.42 | 168.2% | pattern |
| 8364 | Aggregate | 1088.95 | 1128.78 | 3.7% | operator |
| 8365 | Sort | 1088.68 | 1835.91 | 68.6% | pattern |
| 8367 | Nested Loop | 1074.57 | 1188.39 | 10.6% | operator |
| 8379 | Hash | 5.44 | 18.67 | 243.4% | operator |
| 8368 | Hash Join | 215.49 | 253.07 | 17.4% | operator |
| 8378 | Index Scan | 0.07 | -0.22 | 397.3% | operator |
| 8380 | Seq Scan | 4.88 | 12.36 | 153.3% | operator |
| 8369 | Seq Scan | 169.52 | 159.81 | 5.7% | operator |
| 8370 | Hash | 32.21 | 46.85 | 45.5% | pattern |
| 8375 | Seq Scan | 0.01 | 11.81 | 107247.9% | operator |
| 8376 | Hash | 0.05 | 21.05 | 38887.5% | operator |
| 8377 | Seq Scan | 0.05 | 22.93 | 44867.3% | operator |
...
### Step 4: Node 8369 (Seq Scan) - LEAF
...
### Step 5: Node 8370 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 8361, 8362, 8363, 8365, 8366, 8371, 8372, 8373, 8374
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 8378 (Index Scan) - LEAF
...
### Step 8: Node 8380 (Seq Scan) - LEAF
...
### Step 11: Node 8365 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 8361, 8362, 8363, 8366, 8370, 8371, 8372, 8373, 8374
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 8361 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 8362, 8363, 8365, 8366, 8370, 8371, 8372, 8373, 8374
- **Input Features:**
