...
```
Node 5886 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 5887 (Gather Merge) [consumed]
    Node 5888 (Sort) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 5886 | 5887, 5888, 5889 |
...
|------|------|--------|-----------|-----|--------|
| 5886 | Aggregate | 1072.49 | 952.19 | 11.2% | pattern |
| 5890 | Nested Loop | 1066.08 | 1255.45 | 17.8% | operator |
| 5891 | Seq Scan | 162.63 | 154.66 | 4.9% | operator |
| 5892 | Index Scan | 0.06 | 11.10 | 17526.0% | operator |
