...
**Test Query:** Q13_56_seed_451221705
...
```
Node 26077 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26078 (Aggregate) [consumed]
    Node 26079 (Aggregate)
      Node 26080 (Hash Join) [PATTERN: 895c6e8c]
        Node 26081 (Seq Scan) [consumed] - LEAF
        Node 26082 (Hash) [consumed]
          Node 26083 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26077 | 26078, 26080, 26081, 26082 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26080 | 26077, 26078, 26081, 26082 |
...
|------|------|--------|-----------|-----|--------|
| 26077 | Sort | 910.45 | 1079.93 | 18.6% | pattern |
| 26079 | Aggregate | 904.41 | 999.55 | 10.5% | operator |
| 26080 | Hash Join | 693.01 | 470.31 | 32.1% | pattern |
| 26083 | Index Only Scan | 9.69 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26083 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26080 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26077, 26078, 26081, 26082
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1484970
...
### Step 4: Node 26077 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26078, 26080, 26081, 26082
- **Input Features:**
