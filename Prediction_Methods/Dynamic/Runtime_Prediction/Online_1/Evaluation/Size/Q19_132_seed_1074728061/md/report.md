...
**Test Query:** Q19_132_seed_1074728061
...
```
Node 31465 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31466 (Gather) [consumed]
    Node 31467 (Aggregate) [consumed]
      Node 31468 (Hash Join) [consumed]
        Node 31469 (Seq Scan) - LEAF
        Node 31470 (Hash)
          Node 31471 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31465 | 31466, 31467, 31468 |
...
|------|------|--------|-----------|-----|--------|
| 31465 | Aggregate | 853.51 | 829.29 | 2.8% | pattern |
| 31469 | Seq Scan | 784.99 | 743.46 | 5.3% | operator |
| 31470 | Hash | 46.73 | 8.29 | 82.3% | operator |
| 31471 | Seq Scan | 46.57 | 23.76 | 49.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31471 (Seq Scan) - LEAF
...
### Step 2: Node 31469 (Seq Scan) - LEAF
...
### Step 4: Node 31465 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31466, 31467, 31468
- **Input Features:**
