...
```
Node 16513 (Aggregate) - ROOT
  Node 16514 (Gather Merge)
    Node 16515 (Sort)
          ...
          Node 16518 (Hash Join)
            Node 16519 (Nested Loop)
              Node 16520 (Hash Join)
                ...
                Node 16522 (Hash)
                  Node 16523 (Hash Join)
                    Node 16524 (Seq Scan) - LEAF
                    Node 16525 (Hash)
                      Node 16526 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 16513 | Aggregate | 1205.17 | 1192.27 | 1.1% | operator |
| 16514 | Gather Merge | 1204.75 | 1097.13 | 8.9% | operator |
...
| 16520 | Hash Join | 216.66 | 251.17 | 15.9% | operator |
...
| 16522 | Hash | 37.10 | 20.62 | 44.4% | operator |
| 16523 | Hash Join | 36.55 | 132.26 | 261.8% | operator |
| 16524 | Seq Scan | 34.98 | 23.03 | 34.2% | operator |
| 16525 | Hash | 0.22 | 23.66 | 10751.4% | operator |
| 16526 | Hash Join | 0.22 | 306.84 | 141953.7% | operator |
...
### Step 5: Node 16524 (Seq Scan) - LEAF
...
### Step 8: Node 16521 (Seq Scan) - LEAF
...
### Step 11: Node 16530 (Index Scan) - LEAF
...
### Step 12: Node 16532 (Seq Scan) - LEAF
...
### Step 13: Node 16519 (Nested Loop)
...
### Step 16: Node 16533 (Index Scan) - LEAF
...
### Step 17: Node 16535 (Seq Scan) - LEAF
...
### Step 18: Node 16517 (Nested Loop)
...
### Step 22: Node 16514 (Gather Merge)
...
### Step 23: Node 16513 (Aggregate) - ROOT
