...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4381 | 4382, 4383, 4384 |
...
| 4385 | Nested Loop | 1179.36 | 1192.54 | 1.1% | operator |
| 4386 | Hash Join | 208.21 | 230.11 | 10.5% | operator |
| 4390 | Index Scan | 0.03 | -0.52 | 2018.8% | operator |
| 4387 | Seq Scan | 156.33 | 163.15 | 4.4% | operator |
| 4388 | Hash | 29.44 | 17.75 | 39.7% | operator |
...
### Step 2: Node 4387 (Seq Scan) - LEAF
...
### Step 5: Node 4390 (Index Scan) - LEAF
...
### Step 7: Node 4381 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4382, 4383, 4384
- **Input Features:**
