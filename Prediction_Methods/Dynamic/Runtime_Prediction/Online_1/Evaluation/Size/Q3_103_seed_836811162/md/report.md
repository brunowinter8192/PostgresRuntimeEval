...
**Test Query:** Q3_103_seed_836811162
...
```
Node 4381 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 4382 (Sort) [consumed]
    Node 4383 (Aggregate) [consumed]
      Node 4384 (Gather) [consumed]
        Node 4385 (Nested Loop)
          Node 4386 (Hash Join) [PATTERN: 895c6e8c]
            Node 4387 (Seq Scan) [consumed] - LEAF
            Node 4388 (Hash) [consumed]
              Node 4389 (Seq Scan) - LEAF
          Node 4390 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4381 | 4382, 4383, 4384, 4386, 4387, 4388 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4386 | 4381, 4382, 4383, 4384, 4387, 4388 |
...
|------|------|--------|-----------|-----|--------|
| 4381 | Limit | 1215.09 | 1151.18 | 5.3% | pattern |
| 4385 | Nested Loop | 1179.36 | 1192.63 | 1.1% | operator |
| 4386 | Hash Join | 208.21 | 242.40 | 16.4% | pattern |
| 4390 | Index Scan | 0.03 | -0.52 | 2018.8% | operator |
| 4389 | Seq Scan | 28.87 | 38.57 | 33.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4389 (Seq Scan) - LEAF
...
### Step 2: Node 4386 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4381, 4382, 4383, 4384, 4387, 4388
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46268
  - HashJoin_nt1=231734
...
- **Output:** st=29.81, rt=242.40

### Step 3: Node 4390 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=72499.0000
- **Output:** st=121.39, rt=1192.63

### Step 5: Node 4381 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4382, 4383, 4384, 4386, 4387, 4388
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=312915
  - Aggregate_Outer_nt1=312915
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=109484.2300
  - Aggregate_Outer_total_cost=113395.6700
  - Gather_Outer_np=0
  - Gather_Outer_nt=312915
  - Gather_Outer_nt1=100940
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=104790.5000
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=312915
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=120157.6500
  - Limit_total_cost=120157.6700
  - Sort_Outer_np=0
  - Sort_Outer_nt=312915
  - Sort_Outer_nt1=312915
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=120157.6500
  - Sort_Outer_total_cost=120939.9300
