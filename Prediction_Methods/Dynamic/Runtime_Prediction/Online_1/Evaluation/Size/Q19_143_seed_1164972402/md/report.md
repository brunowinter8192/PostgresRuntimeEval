...
**Test Query:** Q19_143_seed_1164972402
...
```
Node 31549 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31550 (Gather) [consumed]
    Node 31551 (Aggregate) [consumed]
      Node 31552 (Hash Join) [consumed]
        Node 31553 (Seq Scan) - LEAF
        Node 31554 (Hash)
          Node 31555 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31549 | 31550, 31551, 31552 |
...
|------|------|--------|-----------|-----|--------|
| 31549 | Aggregate | 867.36 | 829.29 | 4.4% | pattern |
| 31553 | Seq Scan | 795.93 | 743.46 | 6.6% | operator |
| 31554 | Hash | 49.69 | 8.29 | 83.3% | operator |
| 31555 | Seq Scan | 49.56 | 23.76 | 52.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31555 (Seq Scan) - LEAF
...
### Step 2: Node 31553 (Seq Scan) - LEAF
...
### Step 4: Node 31549 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31550, 31551, 31552
- **Input Features:**
