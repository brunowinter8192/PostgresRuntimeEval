...
Node 691 (Aggregate) - ROOT
  Node 692 (Gather Merge)
    Node 693 (Sort) [PATTERN: 1d35fb97]
      Node 694 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 693 | 694 |
...
|------|------|--------|-----------|-----|--------|
| 691 | Aggregate | 948.25 | 1195.85 | 26.1% | operator |
| 692 | Gather Merge | 948.22 | 1165.90 | 23.0% | operator |
| 693 | Sort | 931.56 | 1200.37 | 28.9% | pattern |
...
### Step 2: Node 693 (Sort) - PATTERN ROOT
...
### Step 4: Node 691 (Aggregate) - ROOT
