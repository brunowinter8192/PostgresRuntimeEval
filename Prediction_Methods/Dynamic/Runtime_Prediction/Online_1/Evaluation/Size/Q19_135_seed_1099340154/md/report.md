...
```
Node 31486 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31487 (Gather) [consumed]
    Node 31488 (Aggregate) [consumed]
      Node 31489 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31486 | 31487, 31488 |
...
|------|------|--------|-----------|-----|--------|
| 31486 | Aggregate | 846.05 | 831.20 | 1.8% | pattern |
| 31489 | Hash Join | 826.14 | 766.06 | 7.3% | operator |
...
### Step 5: Node 31486 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31487, 31488
- **Input Features:**
