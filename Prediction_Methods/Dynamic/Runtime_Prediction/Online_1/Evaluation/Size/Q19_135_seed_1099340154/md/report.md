...
**Test Query:** Q19_135_seed_1099340154
...
```
Node 31486 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31487 (Gather) [consumed]
    Node 31488 (Aggregate) [consumed]
      Node 31489 (Hash Join) [consumed]
        Node 31490 (Seq Scan) - LEAF
        Node 31491 (Hash)
          Node 31492 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31486 | 31487, 31488, 31489 |
...
|------|------|--------|-----------|-----|--------|
| 31486 | Aggregate | 846.05 | 829.29 | 2.0% | pattern |
| 31490 | Seq Scan | 775.65 | 743.46 | 4.2% | operator |
| 31491 | Hash | 48.66 | 8.29 | 83.0% | operator |
| 31492 | Seq Scan | 48.52 | 23.76 | 51.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31492 (Seq Scan) - LEAF
...
### Step 2: Node 31490 (Seq Scan) - LEAF
...
### Step 4: Node 31486 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31487, 31488, 31489
- **Input Features:**
