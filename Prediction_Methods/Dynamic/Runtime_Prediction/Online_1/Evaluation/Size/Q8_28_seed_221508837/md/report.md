...
```
Node 14811 (Aggregate) - ROOT
  Node 14812 (Gather Merge)
    Node 14813 (Sort)
          ...
          Node 14816 (Hash Join)
            Node 14817 (Nested Loop)
              Node 14818 (Hash Join)
                ...
                Node 14820 (Hash)
                  Node 14821 (Hash Join)
                    Node 14822 (Seq Scan) - LEAF
                    Node 14823 (Hash)
                      Node 14824 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 14811 | Aggregate | 1193.90 | 1193.68 | 0.0% | operator |
| 14812 | Gather Merge | 1193.54 | 1097.19 | 8.1% | operator |
...
| 14818 | Hash Join | 207.56 | 251.17 | 21.0% | operator |
...
| 14820 | Hash | 31.23 | 20.62 | 34.0% | operator |
| 14821 | Hash Join | 30.50 | 132.26 | 333.6% | operator |
| 14822 | Seq Scan | 28.99 | 23.03 | 20.6% | operator |
| 14823 | Hash | 0.22 | 23.66 | 10851.9% | operator |
| 14824 | Hash Join | 0.21 | 306.84 | 143954.4% | operator |
...
### Step 5: Node 14822 (Seq Scan) - LEAF
...
### Step 8: Node 14819 (Seq Scan) - LEAF
...
### Step 11: Node 14828 (Index Scan) - LEAF
...
### Step 12: Node 14830 (Seq Scan) - LEAF
...
### Step 13: Node 14817 (Nested Loop)
...
### Step 16: Node 14831 (Index Scan) - LEAF
...
### Step 17: Node 14833 (Seq Scan) - LEAF
...
### Step 18: Node 14815 (Nested Loop)
...
### Step 22: Node 14812 (Gather Merge)
...
### Step 23: Node 14811 (Aggregate) - ROOT
