...
```
Node 29124 (Limit) - ROOT
  Node 29125 (Sort)
    Node 29126 (Aggregate)
      Node 29127 (Gather Merge)
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29132 | 29133, 29134 |
...
|------|------|--------|-----------|-----|--------|
| 29124 | Limit | 3037.43 | 1175.21 | 61.3% | operator |
| 29125 | Sort | 2925.96 | 1127.81 | 61.5% | operator |
| 29126 | Aggregate | 2925.92 | 1073.15 | 63.3% | operator |
| 29127 | Gather Merge | 2925.89 | 1073.95 | 63.3% | operator |
| 29128 | Incremental Sort | 2891.09 | 0.00 | 100.0% | operator |
| 29129 | Nested Loop | 2891.03 | 1111.34 | 61.6% | operator |
| 29130 | Merge Join | 2890.99 | 0.00 | 100.0% | operator |
| 29139 | Index Scan | 0.02 | 0.05 | 150.8% | operator |
| 29131 | Sort | 2841.38 | 1095.58 | 61.4% | operator |
| 29137 | Sort | 63.85 | 1074.66 | 1583.0% | operator |
| 29132 | Hash Join | 2841.37 | 471.07 | 83.4% | pattern |
| 29138 | Seq Scan | 52.94 | 18.25 | 65.5% | operator |
| 29135 | Aggregate | 2615.68 | 1073.15 | 59.0% | operator |
| 29136 | Index Scan | 2128.35 | 0.00 | 100.0% | operator |
...
### Step 10: Node 29128 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29127 (Gather Merge)
