...
```
Node 31822 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31823 (Gather) [consumed]
    Node 31824 (Aggregate) [consumed]
      Node 31825 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31822 | 31823, 31824, 31825 |
...
|------|------|--------|-----------|-----|--------|
| 31822 | Aggregate | 877.61 | 829.28 | 5.5% | pattern |
...
### Step 4: Node 31822 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31823, 31824, 31825
- **Input Features:**
