...
**Test Query:** Q9_107_seed_869627286
...
```
Node 16778 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 16779 (Aggregate) [consumed]
    Node 16780 (Gather)
      Node 16781 (Aggregate)
        Node 16782 (Nested Loop)
          Node 16783 (Hash Join) [PATTERN: bb930825]
            Node 16784 (Seq Scan) [consumed] - LEAF
            Node 16785 (Hash) [consumed]
              Node 16786 (Hash Join) [consumed]
                Node 16787 (Hash Join)
                  Node 16788 (Nested Loop)
                    Node 16789 (Seq Scan) - LEAF
                    Node 16790 (Index Scan) - LEAF
                  Node 16791 (Hash)
                    Node 16792 (Seq Scan) - LEAF
                Node 16793 (Hash)
                  Node 16794 (Seq Scan) - LEAF
          Node 16795 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 16783 | 16778, 16779, 16784, 16785, 16786 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 16778 | 16779, 16783, 16784, 16785, 16786 |
...
|------|------|--------|-----------|-----|--------|
| 16778 | Sort | 1164.49 | 1045.59 | 10.2% | pattern |
| 16780 | Gather | 1163.14 | 964.55 | 17.1% | operator |
| 16781 | Aggregate | 1145.63 | 1085.45 | 5.3% | operator |
| 16782 | Nested Loop | 1121.25 | 1252.17 | 11.7% | operator |
| 16783 | Hash Join | 952.51 | 134.80 | 85.8% | pattern |
| 16795 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 16787 | Hash Join | 161.06 | 837.63 | 420.1% | operator |
| 16793 | Hash | 13.09 | 14.95 | 14.2% | operator |
| 16788 | Nested Loop | 155.56 | 1251.77 | 704.7% | operator |
| 16791 | Hash | 3.47 | 15.94 | 359.9% | operator |
| 16794 | Seq Scan | 13.07 | 2.94 | 77.5% | operator |
| 16789 | Seq Scan | 19.02 | 43.96 | 131.1% | operator |
| 16790 | Index Scan | 0.07 | -1.39 | 1951.3% | operator |
| 16792 | Seq Scan | 2.95 | 9.45 | 220.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 16789 (Seq Scan) - LEAF
...
### Step 2: Node 16790 (Index Scan) - LEAF
...
### Step 3: Node 16792 (Seq Scan) - LEAF
...
### Step 6: Node 16794 (Seq Scan) - LEAF
...
### Step 9: Node 16783 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 16778, 16779, 16784, 16785, 16786
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 16795 (Index Scan) - LEAF
...
### Step 11: Node 16782 (Nested Loop)
...
### Step 14: Node 16778 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 16779, 16783, 16784, 16785, 16786
- **Input Features:**
