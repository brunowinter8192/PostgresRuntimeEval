...
```
Node 12985 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 12986 (Gather Merge) [consumed]
    Node 12987 (Sort)
      Node 12988 (Hash Join)
        Node 12989 (Nested Loop)
          Node 12990 (Hash Join) [PATTERN: 895c6e8c]
            Node 12991 (Seq Scan) [consumed] - LEAF
            Node 12992 (Hash) [consumed]
              Node 12993 (Hash Join) [PATTERN: f4cb205a]
                Node 12994 (Seq Scan) [consumed] - LEAF
                Node 12995 (Hash) [consumed]
                  Node 12996 (Seq Scan) [consumed] - LEAF
          Node 12997 (Index Scan) - LEAF
        Node 12998 (Hash)
          Node 12999 (Hash Join) [PATTERN: f4cb205a]
            Node 13000 (Seq Scan) [consumed] - LEAF
            Node 13001 (Hash) [consumed]
              Node 13002 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 12993 | 12985, 12986, 12990, 12991, 12992, 12994, 12995, 12996, 12999, 13000, 13001, 13002 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 12999 | 12985, 12986, 12990, 12991, 12992, 12993, 12994, 12995, 12996, 13000, 13001, 13002 |
| Aggregate -> Gather Merge (Out | 2724c080 | 12985 | 12986, 12990, 12991, 12992, 12993, 12994, 12995, 12996, 12999, 13000, 13001, 13002 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 12990 | 12985, 12986, 12991, 12992, 12993, 12994, 12995, 12996, 12999, 13000, 13001, 13002 |
...
|------|------|--------|-----------|-----|--------|
| 12985 | Aggregate | 1176.61 | 1163.13 | 1.1% | pattern |
| 12987 | Sort | 1169.27 | 1109.16 | 5.1% | operator |
| 12988 | Hash Join | 1168.63 | 843.11 | 27.9% | operator |
| 12989 | Nested Loop | 1161.63 | 1215.99 | 4.7% | operator |
| 12998 | Hash | 3.19 | 27.74 | 768.9% | operator |
| 12990 | Hash Join | 210.10 | 304.89 | 45.1% | pattern |
| 12997 | Index Scan | 0.03 | 0.96 | 3006.0% | operator |
| 12999 | Hash Join | 3.15 | 429.36 | 13547.9% | pattern |
| 12993 | Hash Join | 33.02 | 429.38 | 1200.3% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12993 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 12985, 12986, 12990, 12991, 12992, 12994, 12995, 12996, 12999, 13000, 13001, 13002
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5000
  - HashJoin_nt1=62500
...
### Step 2: Node 12990 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 12985, 12986, 12991, 12992, 12993, 12994, 12995, 12996, 12999, 13000, 13001, 13002
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=38710
  - HashJoin_nt1=483871
...
### Step 3: Node 12997 (Index Scan) - LEAF
...
### Step 4: Node 12999 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 12985, 12986, 12990, 12991, 12992, 12993, 12994, 12995, 12996, 13000, 13001, 13002
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=800
  - HashJoin_nt1=10000
...
### Step 9: Node 12985 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 12986, 12990, 12991, 12992, 12993, 12994, 12995, 12996, 12999, 13000, 13001, 13002
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
