...
**Test Query:** Q10_25_seed_196896744
**Timestamp:** 2026-01-18 19:29:31
...
```
Node 20241 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 20242 (Sort) [consumed]
    Node 20243 (Aggregate) [consumed]
      Node 20244 (Gather) [consumed]
        Node 20245 (Hash Join)
          Node 20246 (Hash Join) [PATTERN: 2e0f44ef]
            Node 20247 (Nested Loop) [consumed]
              Node 20248 (Seq Scan) - LEAF
              Node 20249 (Index Scan) - LEAF
            Node 20250 (Hash) [consumed]
              Node 20251 (Seq Scan) - LEAF
          Node 20252 (Hash)
            Node 20253 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20241 | 20242, 20243, 20244, 20246, 20247, 20250 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 20246 | 20241, 20242, 20243, 20244, 20247, 20250 |
...
|------|------|--------|-----------|-----|--------|
| 20241 | Limit | 1159.10 | 1199.47 | 3.5% | pattern |
| 20245 | Hash Join | 1108.63 | 1095.59 | 1.2% | operator |
| 20246 | Hash Join | 1105.72 | 1120.19 | 1.3% | pattern |
| 20252 | Hash | 0.02 | 15.71 | 78453.9% | operator |
| 20253 | Seq Scan | 0.01 | 6.98 | 46424.7% | operator |
| 20248 | Seq Scan | 162.01 | 159.74 | 1.4% | operator |
| 20249 | Index Scan | 0.06 | -0.52 | 922.6% | operator |
| 20251 | Seq Scan | 22.85 | 26.64 | 16.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 20248 (Seq Scan) - LEAF
...
### Step 2: Node 20249 (Index Scan) - LEAF
...
### Step 3: Node 20251 (Seq Scan) - LEAF
...
### Step 4: Node 20253 (Seq Scan) - LEAF
...
### Step 5: Node 20246 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 20241, 20242, 20243, 20244, 20247, 20250
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18337
  - HashJoin_nt1=18337
...
### Step 8: Node 20241 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20242, 20243, 20244, 20246, 20247, 20250
- **Input Features:**
