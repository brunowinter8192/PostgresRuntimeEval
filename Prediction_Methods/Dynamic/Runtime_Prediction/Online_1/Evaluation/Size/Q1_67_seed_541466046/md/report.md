...
**Test Query:** Q1_67_seed_541466046
...
```
Node 566 (Aggregate) - ROOT
  Node 567 (Gather Merge)
    Node 568 (Sort) [PATTERN: 1d35fb97]
      Node 569 (Aggregate) [consumed]
        Node 570 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 568 | 569 |
...
|------|------|--------|-----------|-----|--------|
| 566 | Aggregate | 961.08 | 1196.03 | 24.4% | operator |
| 567 | Gather Merge | 961.04 | 1165.95 | 21.3% | operator |
| 568 | Sort | 942.64 | 1201.05 | 27.4% | pattern |
| 570 | Seq Scan | 528.20 | 678.19 | 28.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 570 (Seq Scan) - LEAF
...
### Step 2: Node 568 (Sort) - PATTERN ROOT
...
### Step 4: Node 566 (Aggregate) - ROOT
