...
**Test Query:** Q4_145_seed_1181380464
...
```
Node 6194 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6195 (Gather Merge) [consumed]
    Node 6196 (Sort) [consumed]
      Node 6197 (Aggregate) [consumed]
        Node 6198 (Nested Loop)
          Node 6199 (Seq Scan) - LEAF
          Node 6200 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6194 | 6195, 6196, 6197 |
...
|------|------|--------|-----------|-----|--------|
| 6194 | Aggregate | 1053.48 | 952.19 | 9.6% | pattern |
| 6198 | Nested Loop | 1047.09 | 1255.45 | 19.9% | operator |
| 6199 | Seq Scan | 165.07 | 154.66 | 6.3% | operator |
| 6200 | Index Scan | 0.06 | 11.10 | 17810.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6199 (Seq Scan) - LEAF
...
### Step 2: Node 6200 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - Aggregate_Outer_startup_cost=66021.4800
  - Aggregate_Outer_total_cost=66021.5300
  - Aggregate_np=0
  - Aggregate_nt=5
  - Aggregate_nt1=15
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=67021.6300
  - Aggregate_total_cost=67023.5300
  ...
  - GatherMerge_Outer_startup_cost=67021.6300
  - GatherMerge_Outer_total_cost=67023.4100
  - Sort_Outer_np=0
  - Sort_Outer_nt=5
  - Sort_Outer_nt1=5
  - Sort_Outer_nt2=0
  ...
  - Sort_Outer_startup_cost=66021.5900
  - Sort_Outer_total_cost=66021.6100
