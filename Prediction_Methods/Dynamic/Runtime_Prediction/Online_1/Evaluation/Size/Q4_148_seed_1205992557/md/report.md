...
**Test Query:** Q4_148_seed_1205992557
...
```
Node 6215 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6216 (Gather Merge) [consumed]
    Node 6217 (Sort) [consumed]
      Node 6218 (Aggregate) [consumed]
        Node 6219 (Nested Loop)
          Node 6220 (Seq Scan) - LEAF
          Node 6221 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6215 | 6216, 6217, 6218 |
...
|------|------|--------|-----------|-----|--------|
| 6215 | Aggregate | 1051.38 | 952.19 | 9.4% | pattern |
| 6219 | Nested Loop | 1044.13 | 1255.45 | 20.2% | operator |
| 6220 | Seq Scan | 161.30 | 154.66 | 4.1% | operator |
| 6221 | Index Scan | 0.06 | 11.10 | 18103.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6220 (Seq Scan) - LEAF
...
### Step 2: Node 6221 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - Aggregate_total_cost=67283.9600
  ...
  - GatherMerge_Outer_total_cost=67283.8300
  - Sort_Outer_np=0
  - Sort_Outer_nt=5
  - Sort_Outer_nt1=5
  - Sort_Outer_nt2=0
  ...
  - Sort_Outer_startup_cost=66282.0200
  - Sort_Outer_total_cost=66282.0300
