...
```
Node 17231 (Sort) - ROOT
  Node 17232 (Aggregate)
    Node 17233 (Gather)
      Node 17234 (Aggregate)
        Node 17235 (Nested Loop)
          Node 17236 (Hash Join)
            Node 17237 (Seq Scan) - LEAF
            Node 17238 (Hash)
              Node 17239 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 17231 | Sort | 1192.48 | 1118.92 | 6.2% | operator |
| 17232 | Aggregate | 1192.37 | 896.90 | 24.8% | operator |
...
| 17236 | Hash Join | 971.07 | 632.96 | 34.8% | operator |
| 17248 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17237 | Seq Scan | 697.49 | 509.93 | 26.9% | operator |
| 17238 | Hash | 181.59 | 47.68 | 73.7% | operator |
| 17239 | Hash Join | 179.79 | 924.32 | 414.1% | operator |
...
### Step 10: Node 17237 (Seq Scan) - LEAF
...
### Step 13: Node 17248 (Index Scan) - LEAF
...
### Step 14: Node 17235 (Nested Loop)
