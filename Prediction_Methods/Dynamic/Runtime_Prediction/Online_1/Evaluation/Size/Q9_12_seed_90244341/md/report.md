...
**Test Query:** Q9_12_seed_90244341
...
```
Node 17231 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 17232 (Aggregate) [consumed]
    Node 17233 (Gather)
      Node 17234 (Aggregate)
        Node 17235 (Nested Loop)
          Node 17236 (Hash Join) [PATTERN: bb930825]
            Node 17237 (Seq Scan) [consumed] - LEAF
            Node 17238 (Hash) [consumed]
              Node 17239 (Hash Join) [consumed]
                Node 17240 (Hash Join)
                  Node 17241 (Nested Loop)
                    Node 17242 (Seq Scan) - LEAF
                    Node 17243 (Index Scan) - LEAF
                  Node 17244 (Hash)
                    Node 17245 (Seq Scan) - LEAF
                Node 17246 (Hash)
                  Node 17247 (Seq Scan) - LEAF
          Node 17248 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17236 | 17231, 17232, 17237, 17238, 17239 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17231 | 17232, 17236, 17237, 17238, 17239 |
...
|------|------|--------|-----------|-----|--------|
| 17231 | Sort | 1192.48 | 1044.79 | 12.4% | pattern |
| 17233 | Gather | 1191.75 | 964.87 | 19.0% | operator |
| 17234 | Aggregate | 1166.63 | 1117.47 | 4.2% | operator |
| 17235 | Nested Loop | 1142.71 | 1252.17 | 9.6% | operator |
| 17236 | Hash Join | 971.07 | 134.80 | 86.1% | pattern |
| 17248 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17240 | Hash Join | 166.01 | 837.55 | 404.5% | operator |
| 17246 | Hash | 13.15 | 14.95 | 13.6% | operator |
| 17241 | Nested Loop | 160.42 | 1251.76 | 680.3% | operator |
| 17244 | Hash | 3.31 | 15.94 | 382.3% | operator |
| 17247 | Seq Scan | 13.14 | 2.94 | 77.7% | operator |
| 17242 | Seq Scan | 19.50 | 44.17 | 126.5% | operator |
| 17243 | Index Scan | 0.08 | -1.39 | 1880.1% | operator |
| 17245 | Seq Scan | 2.71 | 9.45 | 248.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 17242 (Seq Scan) - LEAF
...
### Step 2: Node 17243 (Index Scan) - LEAF
...
### Step 3: Node 17245 (Seq Scan) - LEAF
...
### Step 6: Node 17247 (Seq Scan) - LEAF
...
### Step 9: Node 17236 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17231, 17232, 17237, 17238, 17239
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17248 (Index Scan) - LEAF
...
### Step 11: Node 17235 (Nested Loop)
...
### Step 14: Node 17231 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17232, 17236, 17237, 17238, 17239
- **Input Features:**
