...
**Test Query:** Q10_131_seed_1066524030
...
```
Node 19812 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 19813 (Sort) [consumed]
    Node 19814 (Aggregate) [consumed]
      Node 19815 (Gather) [consumed]
        Node 19816 (Hash Join)
          Node 19817 (Hash Join) [PATTERN: 2e0f44ef]
            Node 19818 (Nested Loop) [consumed]
              Node 19819 (Seq Scan) - LEAF
              Node 19820 (Index Scan) - LEAF
            Node 19821 (Hash) [consumed]
              Node 19822 (Seq Scan) - LEAF
          Node 19823 (Hash)
            Node 19824 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19812 | 19813, 19814, 19815, 19817, 19818, 19821 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 19817 | 19812, 19813, 19814, 19815, 19818, 19821 |
...
|------|------|--------|-----------|-----|--------|
| 19812 | Limit | 1136.60 | 1199.47 | 5.5% | pattern |
| 19816 | Hash Join | 1087.11 | 1095.53 | 0.8% | operator |
| 19817 | Hash Join | 1084.19 | 1120.19 | 3.3% | pattern |
| 19823 | Hash | 0.02 | 15.71 | 98092.3% | operator |
| 19824 | Seq Scan | 0.01 | 6.98 | 58055.9% | operator |
| 19819 | Seq Scan | 164.69 | 159.74 | 3.0% | operator |
| 19820 | Index Scan | 0.06 | -0.52 | 949.6% | operator |
| 19822 | Seq Scan | 26.44 | 26.64 | 0.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 19819 (Seq Scan) - LEAF
...
### Step 2: Node 19820 (Index Scan) - LEAF
...
### Step 3: Node 19822 (Seq Scan) - LEAF
...
### Step 4: Node 19824 (Seq Scan) - LEAF
...
### Step 5: Node 19817 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 19812, 19813, 19814, 19815, 19818, 19821
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18089
  - HashJoin_nt1=18089
  ...
  - HashJoin_total_cost=80717.4700
  - Hash_Inner_np=0
  - Hash_Inner_nt=62500
  ...
  - NestedLoop_Outer_nt=18089
  - NestedLoop_Outer_nt1=18276
  ...
  - NestedLoop_Outer_total_cost=75663.7400
- **Output:** st=51.86, rt=1120.19

### Step 6: Node 19823 (Hash)
...
- **Input Features:**
  ...
  - total_cost=80774.5700
- **Output:** st=54.21, rt=1095.53

### Step 8: Node 19812 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19813, 19814, 19815, 19817, 19818, 19821
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=56075
  - Aggregate_Outer_nt1=56075
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=280
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=88083.0100
  - Aggregate_Outer_total_cost=88783.9400
  - Gather_Outer_np=0
  - Gather_Outer_nt=56075
  - Gather_Outer_nt1=18089
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=87382.0700
  - Limit_np=0
  - Limit_nt=20
  - Limit_nt1=56075
  - Limit_nt2=0
  ...
  - Limit_sel=0.0004
  - Limit_startup_cost=90276.0800
  - Limit_total_cost=90276.1300
  - Sort_Outer_np=0
  - Sort_Outer_nt=56075
  - Sort_Outer_nt1=56075
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=280
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=90276.0800
  - Sort_Outer_total_cost=90416.2700
