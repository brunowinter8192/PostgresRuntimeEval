    ...
    Node 19814 (Aggregate) [consumed]
      Node 19815 (Gather) [consumed]
        Node 19816 (Hash Join)
          Node 19817 (Hash Join)
            Node 19818 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19812 | 19813, 19814, 19815 |
...
| 19816 | Hash Join | 1087.11 | 1007.19 | 7.4% | operator |
| 19817 | Hash Join | 1084.19 | 1004.09 | 7.4% | operator |
| 19823 | Hash | 0.02 | 15.71 | 98092.3% | operator |
| 19818 | Nested Loop | 1039.06 | 1204.83 | 16.0% | operator |
| 19821 | Hash | 34.58 | 55.57 | 60.7% | operator |
...
### Step 6: Node 19824 (Seq Scan) - LEAF
...
### Step 10: Node 19812 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19813, 19814, 19815
- **Input Features:**
