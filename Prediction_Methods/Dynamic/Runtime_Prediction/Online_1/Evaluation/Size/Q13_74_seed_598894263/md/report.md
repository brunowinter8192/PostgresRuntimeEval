...
**Test Query:** Q13_74_seed_598894263
...
```
Node 26217 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26218 (Aggregate) [consumed]
    Node 26219 (Aggregate)
      Node 26220 (Hash Join) [PATTERN: 895c6e8c]
        Node 26221 (Seq Scan) [consumed] - LEAF
        Node 26222 (Hash) [consumed]
          Node 26223 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26217 | 26218, 26220, 26221, 26222 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26220 | 26217, 26218, 26221, 26222 |
...
|------|------|--------|-----------|-----|--------|
| 26217 | Sort | 901.75 | 1079.93 | 19.8% | pattern |
| 26219 | Aggregate | 895.64 | 999.35 | 11.6% | operator |
| 26220 | Hash Join | 687.59 | 470.31 | 31.6% | pattern |
| 26223 | Index Only Scan | 9.74 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26223 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26220 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26217, 26218, 26221, 26222
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1481964
...
### Step 4: Node 26217 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26218, 26220, 26221, 26222
- **Input Features:**
