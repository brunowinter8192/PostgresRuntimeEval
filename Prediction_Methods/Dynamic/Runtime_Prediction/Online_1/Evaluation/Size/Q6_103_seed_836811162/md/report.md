...
**Test Query:** Q6_103_seed_836811162
...
```
Node 9913 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 9914 (Gather) [consumed]
    Node 9915 (Aggregate) [consumed]
      Node 9916 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 9913 | 9914, 9915 |
...
|------|------|--------|-----------|-----|--------|
| 9913 | Aggregate | 726.31 | 850.06 | 17.0% | pattern |
| 9916 | Seq Scan | 706.90 | 748.54 | 5.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 9916 (Seq Scan) - LEAF
...
### Step 2: Node 9913 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 9914, 9915
- **Input Features:**
