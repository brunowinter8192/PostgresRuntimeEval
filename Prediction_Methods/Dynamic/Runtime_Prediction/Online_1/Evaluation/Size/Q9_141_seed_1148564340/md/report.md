...
```
Node 17465 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 17466 (Aggregate) [consumed]
    Node 17467 (Gather)
      Node 17468 (Aggregate)
        Node 17469 (Hash Join)
          Node 17470 (Seq Scan) - LEAF
          Node 17471 (Hash) [PATTERN: 444761fb]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 17471 | 17465, 17466, 17472, 17473, 17474, 17475 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17465 | 17466, 17471, 17472, 17473, 17474, 17475 |
...
|------|------|--------|-----------|-----|--------|
| 17465 | Sort | 1267.52 | 1063.07 | 16.1% | pattern |
| 17467 | Gather | 1266.47 | 962.15 | 24.0% | operator |
| 17468 | Aggregate | 1246.81 | 926.41 | 25.7% | operator |
| 17469 | Hash Join | 1217.82 | 569.97 | 53.2% | operator |
| 17470 | Seq Scan | 128.24 | 193.40 | 50.8% | operator |
| 17471 | Hash | 1027.13 | 35.69 | 96.5% | pattern |
| 17476 | Hash Join | 188.01 | 837.71 | 345.6% | operator |
| 17482 | Hash | 15.04 | 14.95 | 0.6% | operator |
| 17477 | Nested Loop | 183.00 | 1251.77 | 584.0% | operator |
| 17480 | Hash | 2.51 | 15.94 | 535.6% | operator |
| 17483 | Seq Scan | 15.03 | 2.94 | 80.5% | operator |
| 17478 | Seq Scan | 26.21 | 43.76 | 66.9% | operator |
| 17479 | Index Scan | 0.06 | -1.39 | 2536.0% | operator |
| 17481 | Seq Scan | 2.06 | 9.45 | 359.2% | operator |
...
### Step 10: Node 17471 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 17465, 17466, 17472, 17473, 17474, 17475
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 14: Node 17465 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17466, 17471, 17472, 17473, 17474, 17475
- **Input Features:**
