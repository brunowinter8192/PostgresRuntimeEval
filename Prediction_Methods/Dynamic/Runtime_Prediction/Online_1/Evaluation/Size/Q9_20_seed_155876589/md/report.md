...
```
Node 17775 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 17776 (Aggregate) [consumed]
    Node 17777 (Gather)
      Node 17778 (Aggregate)
        Node 17779 (Nested Loop)
          Node 17780 (Hash Join) [PATTERN: bb930825]
            Node 17781 (Seq Scan) [consumed] - LEAF
            Node 17782 (Hash) [consumed]
              Node 17783 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17780 | 17775, 17776, 17781, 17782, 17783 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17775 | 17776, 17780, 17781, 17782, 17783 |
...
|------|------|--------|-----------|-----|--------|
| 17775 | Sort | 1193.90 | 1044.29 | 12.5% | pattern |
...
| 17780 | Hash Join | 975.94 | 134.80 | 86.2% | pattern |
...
### Step 9: Node 17780 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17775, 17776, 17781, 17782, 17783
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17792 (Index Scan) - LEAF
...
### Step 11: Node 17779 (Nested Loop)
...
### Step 14: Node 17775 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17776, 17780, 17781, 17782, 17783
- **Input Features:**
