        ...
        Node 30184 (Incremental Sort)
          Node 30185 (Nested Loop)
            Node 30186 (Merge Join)
              Node 30187 (Sort)
                Node 30188 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30189 (Seq Scan) [consumed] - LEAF
                  Node 30190 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30188 | 30189, 30190 |
...
| 30187 | Sort | 2842.27 | 1095.58 | 61.5% | operator |
| 30193 | Sort | 66.59 | 1074.66 | 1513.8% | operator |
| 30188 | Hash Join | 2842.26 | 471.07 | 83.4% | pattern |
...
### Step 3: Node 30188 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30189, 30190
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30194 (Seq Scan) - LEAF
...
### Step 7: Node 30186 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30195 (Index Scan) - LEAF
...
### Step 10: Node 30184 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30183 (Gather Merge)
