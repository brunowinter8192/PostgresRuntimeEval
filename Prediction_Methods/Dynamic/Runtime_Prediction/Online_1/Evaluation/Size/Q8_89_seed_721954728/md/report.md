...
**Test Query:** Q8_89_seed_721954728
...
Node 16352 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 16353 (Gather Merge) [consumed]
    Node 16354 (Sort)
      Node 16355 (Hash Join)
        Node 16356 (Nested Loop)
          Node 16357 (Hash Join)
            Node 16358 (Nested Loop)
              Node 16359 (Hash Join)
                Node 16360 (Seq Scan) - LEAF
                Node 16361 (Hash) [PATTERN: 444761fb]
                  Node 16362 (Hash Join) [consumed]
                    Node 16363 (Seq Scan) [consumed] - LEAF
                    Node 16364 (Hash) [consumed]
                      Node 16365 (Hash Join) [consumed]
                        Node 16366 (Seq Scan) - LEAF
                        Node 16367 (Hash)
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 16361 | 16352, 16353, 16362, 16363, 16364, 16365 |
| Aggregate -> Gather Merge (Out | 2724c080 | 16352 | 16353, 16361, 16362, 16363, 16364, 16365 |
...
|------|------|--------|-----------|-----|--------|
| 16352 | Aggregate | 1202.55 | 1130.01 | 6.0% | pattern |
| 16354 | Sort | 1198.06 | 1046.21 | 12.7% | operator |
| 16355 | Hash Join | 1197.81 | 785.61 | 34.4% | operator |
| 16356 | Nested Loop | 1197.49 | 1198.29 | 0.1% | operator |
| 16373 | Hash | 0.01 | 13.72 | 91393.9% | operator |
| 16357 | Hash Join | 1193.59 | 785.60 | 34.2% | operator |
| 16372 | Index Scan | 0.01 | 12.42 | 206958.1% | operator |
| 16374 | Seq Scan | 0.01 | 6.51 | 59099.7% | operator |
| 16358 | Nested Loop | 1151.28 | 1198.29 | 4.1% | operator |
| 16370 | Hash | 35.33 | 19.97 | 43.5% | operator |
| 16359 | Hash Join | 210.47 | 251.67 | 19.6% | operator |
| 16369 | Index Scan | 0.04 | 2.88 | 7102.1% | operator |
| 16371 | Seq Scan | 35.17 | 48.87 | 39.0% | operator |
| 16360 | Seq Scan | 160.34 | 159.67 | 0.4% | operator |
| 16361 | Hash | 31.62 | 43.51 | 37.6% | pattern |
| 16366 | Seq Scan | 0.01 | 12.22 | 122149.4% | operator |
| 16367 | Hash | 0.06 | 18.14 | 30652.8% | operator |
| 16368 | Seq Scan | 0.06 | 23.36 | 40886.3% | operator |
...
### Step 2: Node 16366 (Seq Scan) - LEAF
...
### Step 4: Node 16360 (Seq Scan) - LEAF
...
### Step 5: Node 16361 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 16352, 16353, 16362, 16363, 16364, 16365
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 16369 (Index Scan) - LEAF
...
### Step 8: Node 16371 (Seq Scan) - LEAF
...
### Step 12: Node 16372 (Index Scan) - LEAF
...
### Step 13: Node 16374 (Seq Scan) - LEAF
...
### Step 14: Node 16356 (Nested Loop)
...
### Step 18: Node 16352 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 16353, 16361, 16362, 16363, 16364, 16365
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2479
