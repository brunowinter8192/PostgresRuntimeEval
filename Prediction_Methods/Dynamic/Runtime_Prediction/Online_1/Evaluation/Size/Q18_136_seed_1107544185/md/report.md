        ...
        Node 29448 (Incremental Sort)
          Node 29449 (Nested Loop)
            Node 29450 (Merge Join)
              Node 29451 (Sort)
                Node 29452 (Hash Join)
                  Node 29453 (Seq Scan) - LEAF
                  Node 29454 (Hash)
...
| 29451 | Sort | 2844.71 | 1099.77 | 61.3% | operator |
| 29457 | Sort | 63.46 | 1074.66 | 1593.6% | operator |
| 29452 | Hash Join | 2844.70 | 686.33 | 75.9% | operator |
| 29458 | Seq Scan | 51.77 | 18.25 | 64.8% | operator |
| 29453 | Seq Scan | 195.05 | 170.37 | 12.7% | operator |
| 29454 | Hash | 2620.38 | 21.04 | 99.2% | operator |
...
### Step 3: Node 29453 (Seq Scan) - LEAF
...
### Step 6: Node 29458 (Seq Scan) - LEAF
...
### Step 9: Node 29450 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29459 (Index Scan) - LEAF
...
### Step 11: Node 29449 (Nested Loop)
...
### Step 12: Node 29448 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29447 (Gather Merge)
