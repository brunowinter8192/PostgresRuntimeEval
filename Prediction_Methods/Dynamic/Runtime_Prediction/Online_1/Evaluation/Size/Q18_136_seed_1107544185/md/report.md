...
**Test Query:** Q18_136_seed_1107544185
...
```
Node 29444 (Limit) - ROOT
  Node 29445 (Sort)
    Node 29446 (Aggregate)
      Node 29447 (Gather Merge)
        Node 29448 (Incremental Sort)
          Node 29449 (Nested Loop)
            Node 29450 (Merge Join)
              Node 29451 (Sort)
                Node 29452 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29453 (Seq Scan) [consumed] - LEAF
                  Node 29454 (Hash) [consumed]
                    Node 29455 (Aggregate)
                      Node 29456 (Index Scan) - LEAF
              Node 29457 (Sort)
                Node 29458 (Seq Scan) - LEAF
            Node 29459 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29452 | 29453, 29454 |
...
|------|------|--------|-----------|-----|--------|
| 29444 | Limit | 3045.83 | 1175.21 | 61.4% | operator |
| 29445 | Sort | 2931.85 | 1127.81 | 61.5% | operator |
| 29446 | Aggregate | 2931.81 | 1073.15 | 63.4% | operator |
| 29447 | Gather Merge | 2931.76 | 1073.95 | 63.4% | operator |
| 29448 | Incremental Sort | 2894.63 | 0.00 | 100.0% | operator |
| 29449 | Nested Loop | 2894.58 | 1111.34 | 61.6% | operator |
| 29450 | Merge Join | 2894.53 | 0.00 | 100.0% | operator |
| 29459 | Index Scan | 0.02 | 0.05 | 137.6% | operator |
| 29451 | Sort | 2844.71 | 1095.58 | 61.5% | operator |
| 29457 | Sort | 63.46 | 1074.66 | 1593.6% | operator |
| 29452 | Hash Join | 2844.70 | 471.07 | 83.4% | pattern |
| 29458 | Seq Scan | 51.77 | 18.25 | 64.8% | operator |
| 29455 | Aggregate | 2620.33 | 1073.15 | 59.0% | operator |
| 29456 | Index Scan | 2112.20 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29456 (Index Scan) - LEAF
...
### Step 3: Node 29452 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29453, 29454
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29458 (Seq Scan) - LEAF
...
### Step 7: Node 29450 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29459 (Index Scan) - LEAF
...
### Step 10: Node 29448 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29447 (Gather Merge)
