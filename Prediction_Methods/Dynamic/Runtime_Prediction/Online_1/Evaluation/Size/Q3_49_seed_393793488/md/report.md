...
**Test Query:** Q3_49_seed_393793488
...
```
Node 5281 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5282 (Sort) [consumed]
    Node 5283 (Aggregate) [consumed]
      Node 5284 (Gather) [consumed]
        Node 5285 (Nested Loop)
          Node 5286 (Hash Join) [PATTERN: 895c6e8c]
            Node 5287 (Seq Scan) [consumed] - LEAF
            Node 5288 (Hash) [consumed]
              Node 5289 (Seq Scan) - LEAF
          Node 5290 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5281 | 5282, 5283, 5284, 5286, 5287, 5288 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5286 | 5281, 5282, 5283, 5284, 5287, 5288 |
...
|------|------|--------|-----------|-----|--------|
| 5281 | Limit | 1199.69 | 1151.18 | 4.0% | pattern |
| 5285 | Nested Loop | 1165.33 | 1193.39 | 2.4% | operator |
| 5286 | Hash Join | 209.74 | 242.54 | 15.6% | pattern |
| 5290 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5289 | Seq Scan | 28.86 | 38.54 | 33.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5289 (Seq Scan) - LEAF
...
### Step 2: Node 5286 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5281, 5282, 5283, 5284, 5287, 5288
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47443
  - HashJoin_nt1=236095
...
### Step 3: Node 5290 (Index Scan) - LEAF
...
### Step 5: Node 5281 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5282, 5283, 5284, 5286, 5287, 5288
- **Input Features:**
