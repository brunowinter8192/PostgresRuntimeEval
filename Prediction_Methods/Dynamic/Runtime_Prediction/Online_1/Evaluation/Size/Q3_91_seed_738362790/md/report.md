...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5751 | 5752, 5753, 5754, 5756, 5757, 5758 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5756 | 5751, 5752, 5753, 5754, 5757, 5758 |
...
| 5755 | Nested Loop | 1140.32 | 1193.07 | 4.6% | operator |
| 5756 | Hash Join | 205.51 | 242.48 | 18.0% | pattern |
...
- **Consumes:** Nodes 5751, 5752, 5753, 5754, 5757, 5758
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46941
  - HashJoin_nt1=236664
  ...
  - HashJoin_total_cost=37341.8600
  - Hash_Inner_np=0
  - Hash_Inner_nt=12397
...
### Step 3: Node 5760 (Index Scan) - LEAF
...
- **Output:** st=121.84, rt=1193.07

### Step 5: Node 5751 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5752, 5753, 5754, 5756, 5757, 5758
- **Input Features:**
