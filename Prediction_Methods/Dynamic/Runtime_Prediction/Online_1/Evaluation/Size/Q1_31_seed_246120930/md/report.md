...
**Test Query:** Q1_31_seed_246120930
...
```
Node 371 (Aggregate) - ROOT
  Node 372 (Gather Merge)
    Node 373 (Sort) [PATTERN: 1d35fb97]
      Node 374 (Aggregate) [consumed]
        Node 375 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 373 | 374 |
...
|------|------|--------|-----------|-----|--------|
| 371 | Aggregate | 965.10 | 1195.81 | 23.9% | operator |
| 372 | Gather Merge | 965.04 | 1165.88 | 20.8% | operator |
| 373 | Sort | 945.51 | 1200.23 | 26.9% | pattern |
| 375 | Seq Scan | 523.45 | 681.30 | 30.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 375 (Seq Scan) - LEAF
...
### Step 2: Node 373 (Sort) - PATTERN ROOT
...
### Step 4: Node 371 (Aggregate) - ROOT
