...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5231 | 5232, 5233, 5234 |
...
| 5235 | Nested Loop | 1166.58 | 1192.81 | 2.2% | operator |
| 5236 | Hash Join | 210.95 | 230.18 | 9.1% | operator |
| 5240 | Index Scan | 0.03 | -0.52 | 2018.8% | operator |
| 5237 | Seq Scan | 158.79 | 163.16 | 2.8% | operator |
| 5238 | Hash | 28.93 | 17.75 | 38.7% | operator |
...
### Step 2: Node 5237 (Seq Scan) - LEAF
...
### Step 5: Node 5240 (Index Scan) - LEAF
...
### Step 7: Node 5231 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5232, 5233, 5234
- **Input Features:**
