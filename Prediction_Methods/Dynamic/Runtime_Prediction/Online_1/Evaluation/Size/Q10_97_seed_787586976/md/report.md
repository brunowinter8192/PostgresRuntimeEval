    ...
    Node 21270 (Aggregate) [consumed]
      Node 21271 (Gather) [consumed]
        Node 21272 (Hash Join)
          Node 21273 (Hash Join)
            Node 21274 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 21268 | 21269, 21270, 21271 |
...
| 21272 | Hash Join | 1111.71 | 1007.21 | 9.4% | operator |
| 21273 | Hash Join | 1108.82 | 1004.12 | 9.4% | operator |
| 21279 | Hash | 0.02 | 15.71 | 98092.3% | operator |
| 21274 | Nested Loop | 1063.96 | 1204.81 | 13.2% | operator |
| 21277 | Hash | 33.13 | 55.57 | 67.7% | operator |
...
### Step 6: Node 21280 (Seq Scan) - LEAF
...
### Step 10: Node 21268 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 21269, 21270, 21271
- **Input Features:**
