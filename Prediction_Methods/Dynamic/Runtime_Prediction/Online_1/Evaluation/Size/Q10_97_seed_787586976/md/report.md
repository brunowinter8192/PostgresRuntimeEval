...
**Test Query:** Q10_97_seed_787586976
...
```
Node 21268 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 21269 (Sort) [consumed]
    Node 21270 (Aggregate) [consumed]
      Node 21271 (Gather) [consumed]
        Node 21272 (Hash Join)
          Node 21273 (Hash Join) [PATTERN: 2e0f44ef]
            Node 21274 (Nested Loop) [consumed]
              Node 21275 (Seq Scan) - LEAF
              Node 21276 (Index Scan) - LEAF
            Node 21277 (Hash) [consumed]
              Node 21278 (Seq Scan) - LEAF
          Node 21279 (Hash)
            Node 21280 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 21268 | 21269, 21270, 21271, 21273, 21274, 21277 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 21273 | 21268, 21269, 21270, 21271, 21274, 21277 |
...
|------|------|--------|-----------|-----|--------|
| 21268 | Limit | 1165.73 | 1199.47 | 2.9% | pattern |
| 21272 | Hash Join | 1111.71 | 1095.51 | 1.5% | operator |
| 21273 | Hash Join | 1108.82 | 1120.19 | 1.0% | pattern |
| 21279 | Hash | 0.02 | 15.71 | 98092.3% | operator |
| 21280 | Seq Scan | 0.01 | 6.98 | 63342.8% | operator |
| 21275 | Seq Scan | 162.92 | 159.74 | 1.9% | operator |
| 21276 | Index Scan | 0.06 | -0.52 | 909.7% | operator |
| 21278 | Seq Scan | 25.04 | 26.64 | 6.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 21275 (Seq Scan) - LEAF
...
### Step 2: Node 21276 (Index Scan) - LEAF
...
### Step 3: Node 21278 (Seq Scan) - LEAF
...
### Step 4: Node 21280 (Seq Scan) - LEAF
...
### Step 5: Node 21273 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 21268, 21269, 21270, 21271, 21274, 21277
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18043
  - HashJoin_nt1=18043
...
### Step 8: Node 21268 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 21269, 21270, 21271, 21273, 21274, 21277
- **Input Features:**
