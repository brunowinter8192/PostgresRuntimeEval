    ...
    Node 16998 (Gather)
      Node 16999 (Aggregate)
        Node 17000 (Nested Loop)
          Node 17001 (Hash Join) [PATTERN: bb930825]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17001 | 16996, 16997, 17002, 17003, 17004 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 16996 | 16997, 17001, 17002, 17003, 17004 |
...
|------|------|--------|-----------|-----|--------|
| 16996 | Sort | 1243.15 | 1045.06 | 15.9% | pattern |
| 16998 | Gather | 1241.78 | 964.74 | 22.3% | operator |
| 16999 | Aggregate | 1223.57 | 1106.30 | 9.6% | operator |
| 17000 | Nested Loop | 1199.64 | 1252.17 | 4.4% | operator |
| 17001 | Hash Join | 1024.52 | 134.80 | 86.8% | pattern |
| 17013 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17005 | Hash Join | 177.33 | 837.58 | 372.3% | operator |
| 17011 | Hash | 13.45 | 14.95 | 11.1% | operator |
| 17006 | Nested Loop | 170.29 | 1251.77 | 635.1% | operator |
| 17009 | Hash | 4.57 | 15.94 | 249.1% | operator |
| 17012 | Seq Scan | 13.44 | 2.94 | 78.1% | operator |
| 17007 | Seq Scan | 21.15 | 44.10 | 108.5% | operator |
| 17008 | Index Scan | 0.08 | -1.39 | 1814.2% | operator |
| 17010 | Seq Scan | 4.03 | 9.45 | 134.6% | operator |
...
### Step 9: Node 17001 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 16996, 16997, 17002, 17003, 17004
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 11: Node 17000 (Nested Loop)
...
### Step 14: Node 16996 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 16997, 17001, 17002, 17003, 17004
- **Input Features:**
