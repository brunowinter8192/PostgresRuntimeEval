...
```
Node 26595 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26596 (Gather) [consumed]
    Node 26597 (Aggregate) [consumed]
      Node 26598 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26595 | 26596, 26597, 26598 |
...
|------|------|--------|-----------|-----|--------|
| 26595 | Aggregate | 804.03 | 857.12 | 6.6% | pattern |
...
### Step 4: Node 26595 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26596, 26597, 26598
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=14684
  - HashJoin_Outer_nt1=14684
  ...
  - HashJoin_Outer_total_cost=136645.1900
- **Output:** st=850.76, rt=857.12
