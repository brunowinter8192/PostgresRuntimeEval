...
**Test Query:** Q14_123_seed_1000891782
**Timestamp:** 2025-12-21 18:10:28
...
```
Node 26595 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26596 (Gather) [consumed]
    Node 26597 (Aggregate) [consumed]
      Node 26598 (Hash Join)
        Node 26599 (Seq Scan) - LEAF
        Node 26600 (Hash)
          Node 26601 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26595 | 26596, 26597 |
...
|------|------|--------|-----------|-----|--------|
| 26595 | Aggregate | 804.03 | 848.35 | 5.5% | pattern |
| 26598 | Hash Join | 782.75 | 807.62 | 3.2% | operator |
| 26599 | Seq Scan | 732.01 | 758.47 | 3.6% | operator |
| 26600 | Hash | 43.18 | 9.38 | 78.3% | operator |
| 26601 | Seq Scan | 35.73 | 12.70 | 64.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26601 (Seq Scan) - LEAF
...
### Step 2: Node 26599 (Seq Scan) - LEAF
...
- **Output:** st=6.82, rt=758.47

### Step 3: Node 26600 (Hash)
...
- **Input Features:**
  ...
  - total_cost=136645.1900
- **Output:** st=78.56, rt=807.62

### Step 5: Node 26595 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26596, 26597
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=14684
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=64
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0001
  - Aggregate_Outer_startup_cost=136902.1600
  - Aggregate_Outer_total_cost=136902.1700
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=137902.7300
  - Aggregate_total_cost=137902.7400
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=137902.1600
  - Gather_Outer_total_cost=137902.6700
- **Output:** st=842.85, rt=848.35
