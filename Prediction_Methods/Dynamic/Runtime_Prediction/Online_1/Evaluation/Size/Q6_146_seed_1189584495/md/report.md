...
```
Node 10101 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10102 (Gather) [consumed]
    Node 10103 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10101 | 10102, 10103 |
...
|------|------|--------|-----------|-----|--------|
| 10101 | Aggregate | 797.29 | 850.05 | 6.6% | pattern |
| 10104 | Seq Scan | 776.88 | 748.53 | 3.6% | operator |
...
### Step 2: Node 10101 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10102, 10103
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=23584
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=32
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=139723.3900
  - Aggregate_Outer_total_cost=139723.4000
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
