...
**Test Query:** Q13_97_seed_787586976
...
```
Node 26392 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26393 (Aggregate) [consumed]
    Node 26394 (Aggregate)
      Node 26395 (Hash Join) [PATTERN: 895c6e8c]
        Node 26396 (Seq Scan) [consumed] - LEAF
        Node 26397 (Hash) [consumed]
          Node 26398 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26392 | 26393, 26395, 26396, 26397 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26395 | 26392, 26393, 26396, 26397 |
...
|------|------|--------|-----------|-----|--------|
| 26392 | Sort | 933.52 | 1079.93 | 15.7% | pattern |
| 26394 | Aggregate | 927.29 | 999.55 | 7.8% | operator |
| 26395 | Hash Join | 716.78 | 470.31 | 34.4% | pattern |
| 26398 | Index Only Scan | 10.16 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26398 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26395 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26392, 26393, 26396, 26397
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1484970
...
### Step 4: Node 26392 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26393, 26395, 26396, 26397
- **Input Features:**
