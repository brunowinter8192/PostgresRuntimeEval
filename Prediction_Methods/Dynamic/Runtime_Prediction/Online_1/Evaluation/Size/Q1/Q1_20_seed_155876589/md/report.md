...
|------|------|--------|-----------|-----|--------|
| 311 | Aggregate | 1037.41 | 1195.77 | 15.3% | operator |
| 312 | Gather Merge | 1037.37 | 1165.57 | 12.4% | operator |
| 313 | Sort | 1016.68 | 1181.98 | 16.3% | operator |
| 314 | Aggregate | 1016.65 | 1112.69 | 9.4% | operator |
...
- **Input Features:**
  ...
  - st1=0.8483
  - st2=0.0000
  - startup_cost=168777.5300
  - total_cost=168777.6600
- **Output:** st=1037.38, rt=1112.69

### Step 3: Node 313 (Sort)
...
- **Input Features:**
  ...
  - st1=1037.3756
  - st2=0.0000
  - startup_cost=168777.7400
  - total_cost=168777.7600
- **Output:** st=1180.91, rt=1181.98

### Step 4: Node 312 (Gather Merge)
...
### Step 5: Node 311 (Aggregate) - ROOT
