...
**Test Query:** Q1_93_seed_754770852
...
```
Node 711 (Aggregate) - ROOT
  Node 712 (Gather Merge)
    Node 713 (Sort)
      Node 714 (Aggregate)
        Node 715 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 711 | Aggregate | 941.77 | 1195.87 | 27.0% | operator |
| 712 | Gather Merge | 941.72 | 1165.59 | 23.8% | operator |
| 713 | Sort | 925.60 | 1182.06 | 27.7% | operator |
| 714 | Aggregate | 925.58 | 1112.99 | 20.2% | operator |
| 715 | Seq Scan | 512.67 | 679.78 | 32.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 715 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - st1=0.8509
  - st2=0.0000
  - startup_cost=169050.1800
  - total_cost=169050.3100
- **Output:** st=1037.42, rt=1112.99

### Step 3: Node 713 (Sort)
...
- **Input Features:**
  ...
  - st1=1037.4171
  - st2=0.0000
  - startup_cost=169050.3900
  - total_cost=169050.4100
- **Output:** st=1180.99, rt=1182.06

### Step 4: Node 712 (Gather Merge)
...
### Step 5: Node 711 (Aggregate) - ROOT
