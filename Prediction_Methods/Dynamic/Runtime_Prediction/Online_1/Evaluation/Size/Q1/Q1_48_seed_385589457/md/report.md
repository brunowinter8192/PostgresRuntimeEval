...
|------|------|--------|-----------|-----|--------|
| 461 | Aggregate | 1001.62 | 1195.91 | 19.4% | operator |
| 462 | Gather Merge | 1001.56 | 1165.60 | 16.4% | operator |
| 463 | Sort | 982.31 | 1182.10 | 20.3% | operator |
| 464 | Aggregate | 982.27 | 1113.10 | 13.3% | operator |
...
- **Input Features:**
  ...
  - st1=0.8519
  - st2=0.0000
  - startup_cost=169153.2900
  - total_cost=169153.4200
- **Output:** st=1037.43, rt=1113.10

### Step 3: Node 463 (Sort)
...
- **Input Features:**
  ...
  - st1=1037.4328
  - st2=0.0000
  - startup_cost=169153.5000
  - total_cost=169153.5200
- **Output:** st=1181.03, rt=1182.10

### Step 4: Node 462 (Gather Merge)
...
### Step 5: Node 461 (Aggregate) - ROOT
