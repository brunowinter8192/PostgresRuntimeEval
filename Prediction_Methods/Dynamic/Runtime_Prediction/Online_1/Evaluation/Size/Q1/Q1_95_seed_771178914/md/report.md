...
**Test Query:** Q1_95_seed_771178914
...
```
Node 721 (Aggregate) - ROOT
  Node 722 (Gather Merge)
    Node 723 (Sort)
      Node 724 (Aggregate)
        Node 725 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 721 | Aggregate | 926.85 | 1195.82 | 29.0% | operator |
| 722 | Gather Merge | 926.79 | 1165.58 | 25.8% | operator |
| 723 | Sort | 908.52 | 1182.02 | 30.1% | operator |
| 724 | Aggregate | 908.49 | 1112.83 | 22.5% | operator |
| 725 | Seq Scan | 500.99 | 680.60 | 35.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 725 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - st1=0.8495
  - st2=0.0000
  - startup_cost=168903.1800
  - total_cost=168903.3100
- **Output:** st=1037.39, rt=1112.83

### Step 3: Node 723 (Sort)
...
- **Input Features:**
  ...
  - st1=1037.3947
  - st2=0.0000
  - startup_cost=168903.3900
  - total_cost=168903.4100
- **Output:** st=1180.95, rt=1182.02

### Step 4: Node 722 (Gather Merge)
...
### Step 5: Node 721 (Aggregate) - ROOT
