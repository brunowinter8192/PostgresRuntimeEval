...
|------|------|--------|-----------|-----|--------|
| 566 | Aggregate | 961.08 | 1195.98 | 24.4% | operator |
| 567 | Gather Merge | 961.04 | 1165.62 | 21.3% | operator |
| 568 | Sort | 942.64 | 1182.15 | 25.4% | operator |
| 569 | Aggregate | 942.62 | 1113.30 | 18.1% | operator |
...
- **Input Features:**
  ...
  - st1=0.8535
  - st2=0.0000
  - startup_cost=169330.8800
  - total_cost=169331.0100
- **Output:** st=1037.46, rt=1113.30

### Step 3: Node 568 (Sort)
...
- **Input Features:**
  ...
  - st1=1037.4601
  - st2=0.0000
  - startup_cost=169331.0900
  - total_cost=169331.1100
- **Output:** st=1181.08, rt=1182.15

### Step 4: Node 567 (Gather Merge)
...
### Step 5: Node 566 (Aggregate) - ROOT
