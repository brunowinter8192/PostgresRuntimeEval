...
|------|------|--------|-----------|-----|--------|
| 741 | Aggregate | 1005.63 | 1195.68 | 18.9% | operator |
| 742 | Gather Merge | 1005.60 | 1165.55 | 15.9% | operator |
| 743 | Sort | 988.99 | 1181.91 | 19.5% | operator |
| 744 | Aggregate | 988.97 | 1112.45 | 12.5% | operator |
...
- **Input Features:**
  ...
  - st1=0.8461
  - st2=0.0000
  - startup_cost=168553.0000
  - total_cost=168553.1400
- **Output:** st=1037.34, rt=1112.45

### Step 3: Node 743 (Sort)
...
- **Input Features:**
  ...
  - st1=1037.3418
  - st2=0.0000
  - startup_cost=168553.2200
  - total_cost=168553.2300
- **Output:** st=1180.85, rt=1181.91

### Step 4: Node 742 (Gather Merge)
...
### Step 5: Node 741 (Aggregate) - ROOT
