...
|------|------|--------|-----------|-----|--------|
| 196 | Aggregate | 1019.31 | 1195.90 | 17.3% | operator |
| 197 | Gather Merge | 1019.27 | 1165.60 | 14.4% | operator |
| 198 | Sort | 998.98 | 1182.08 | 18.3% | operator |
| 199 | Aggregate | 998.95 | 1113.05 | 11.4% | operator |
...
- **Input Features:**
  ...
  - st1=0.8514
  - st2=0.0000
  - startup_cost=169103.6600
  - total_cost=169103.7900
- **Output:** st=1037.43, rt=1113.05

### Step 3: Node 198 (Sort)
...
- **Input Features:**
  ...
  - st1=1037.4253
  - st2=0.0000
  - startup_cost=169103.8700
  - total_cost=169103.8900
- **Output:** st=1181.01, rt=1182.08

### Step 4: Node 197 (Gather Merge)
...
### Step 5: Node 196 (Aggregate) - ROOT
