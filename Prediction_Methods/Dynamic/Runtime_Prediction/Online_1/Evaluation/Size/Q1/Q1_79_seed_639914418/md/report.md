...
|------|------|--------|-----------|-----|--------|
| 631 | Aggregate | 931.75 | 1195.96 | 28.4% | operator |
| 632 | Gather Merge | 931.71 | 1165.61 | 25.1% | operator |
| 633 | Sort | 915.15 | 1182.13 | 29.2% | operator |
| 634 | Aggregate | 915.13 | 1113.23 | 21.6% | operator |
...
- **Input Features:**
  ...
  - st1=0.8529
  - st2=0.0000
  - startup_cost=169267.8400
  - total_cost=169267.9800
- **Output:** st=1037.45, rt=1113.23

### Step 3: Node 633 (Sort)
...
- **Input Features:**
  ...
  - st1=1037.4504
  - st2=0.0000
  - startup_cost=169268.0600
  - total_cost=169268.0700
- **Output:** st=1181.06, rt=1182.13

### Step 4: Node 632 (Gather Merge)
...
### Step 5: Node 631 (Aggregate) - ROOT
