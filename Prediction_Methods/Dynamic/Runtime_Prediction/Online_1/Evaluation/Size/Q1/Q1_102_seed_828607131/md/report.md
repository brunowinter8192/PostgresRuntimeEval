...
**Test Query:** Q1_102_seed_828607131
...
```
Node 11 (Aggregate) - ROOT
  Node 12 (Gather Merge)
    Node 13 (Sort)
      Node 14 (Aggregate)
        Node 15 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 11 | Aggregate | 944.86 | 1195.93 | 26.6% | operator |
| 12 | Gather Merge | 944.82 | 1165.60 | 23.4% | operator |
| 13 | Sort | 925.98 | 1182.11 | 27.7% | operator |
| 14 | Aggregate | 925.95 | 1113.14 | 20.2% | operator |
| 15 | Seq Scan | 517.35 | 679.00 | 31.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 15 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - st1=0.8522
  - st2=0.0000
  - startup_cost=169187.6600
  - total_cost=169187.7900
- **Output:** st=1037.44, rt=1113.14
...
- **Input Features:**
  ...
  - st1=1037.4381
  - st2=0.0000
  - startup_cost=169187.8700
  - total_cost=169187.8900
- **Output:** st=1181.04, rt=1182.11

### Step 4: Node 12 (Gather Merge)
