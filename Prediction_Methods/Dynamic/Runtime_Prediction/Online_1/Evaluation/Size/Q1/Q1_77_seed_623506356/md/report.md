...
|------|------|--------|-----------|-----|--------|
| 621 | Aggregate | 986.11 | 1195.69 | 21.3% | operator |
| 622 | Gather Merge | 986.07 | 1165.55 | 18.2% | operator |
| 623 | Sort | 970.68 | 1181.92 | 21.8% | operator |
| 624 | Aggregate | 970.66 | 1112.47 | 14.6% | operator |
...
- **Input Features:**
  ...
  - st1=0.8463
  - st2=0.0000
  - startup_cost=168569.0300
  - total_cost=168569.1700
- **Output:** st=1037.34, rt=1112.47

### Step 3: Node 623 (Sort)
...
- **Input Features:**
  ...
  - st1=1037.3442
  - st2=0.0000
  - startup_cost=168569.2500
  - total_cost=168569.2600
- **Output:** st=1180.85, rt=1181.92

### Step 4: Node 622 (Gather Merge)
...
### Step 5: Node 621 (Aggregate) - ROOT
