...
**Test Query:** Q4_34_seed_270733023
...
```
Node 6390 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6391 (Gather Merge) [consumed]
    Node 6392 (Sort) [consumed]
      Node 6393 (Aggregate) [consumed]
        Node 6394 (Nested Loop)
          Node 6395 (Seq Scan) - LEAF
          Node 6396 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6390 | 6391, 6392, 6393 |
...
|------|------|--------|-----------|-----|--------|
| 6390 | Aggregate | 1102.14 | 952.19 | 13.6% | pattern |
| 6394 | Nested Loop | 1095.59 | 1255.45 | 14.6% | operator |
| 6395 | Seq Scan | 170.11 | 154.66 | 9.1% | operator |
| 6396 | Index Scan | 0.06 | 11.10 | 17250.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6395 (Seq Scan) - LEAF
...
### Step 2: Node 6396 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - Aggregate_total_cost=67483.4400
  ...
  - GatherMerge_Outer_total_cost=67483.3200
  - Sort_Outer_np=0
  - Sort_Outer_nt=5
  - Sort_Outer_nt1=5
  - Sort_Outer_nt2=0
  ...
  - Sort_Outer_startup_cost=66481.5000
  - Sort_Outer_total_cost=66481.5200
