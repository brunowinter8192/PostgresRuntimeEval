...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5841 | 5842, 5843, 5844, 5846, 5847, 5848 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5846 | 5841, 5842, 5843, 5844, 5847, 5848 |
...
|------|------|--------|-----------|-----|--------|
| 5841 | Limit | 1237.56 | 1151.18 | 7.0% | pattern |
| 5845 | Nested Loop | 1199.83 | 1193.18 | 0.6% | operator |
| 5846 | Hash Join | 214.43 | 242.50 | 13.1% | pattern |
| 5850 | Index Scan | 0.03 | -0.52 | 2018.8% | operator |
| 5849 | Seq Scan | 28.32 | 38.54 | 36.1% | operator |
...
- **Consumes:** Nodes 5841, 5842, 5843, 5844, 5847, 5848
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47112
  - HashJoin_nt1=234452
...
### Step 3: Node 5850 (Index Scan) - LEAF
...
### Step 5: Node 5841 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5842, 5843, 5844, 5846, 5847, 5848
- **Input Features:**
