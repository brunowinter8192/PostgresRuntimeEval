...
Node 26 (Aggregate) - ROOT
  Node 27 (Gather Merge)
    Node 28 (Sort) [PATTERN: 1d35fb97]
      Node 29 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 28 | 29 |
...
|------|------|--------|-----------|-----|--------|
| 26 | Aggregate | 947.76 | 1195.89 | 26.2% | operator |
| 27 | Gather Merge | 947.70 | 1165.91 | 23.0% | operator |
| 28 | Sort | 924.53 | 1200.51 | 29.9% | pattern |
...
### Step 2: Node 28 (Sort) - PATTERN ROOT
