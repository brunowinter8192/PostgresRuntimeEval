...
```
Node 32179 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 32180 (Gather) [consumed]
    Node 32181 (Aggregate) [consumed]
      Node 32182 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 32179 | 32180, 32181 |
...
|------|------|--------|-----------|-----|--------|
| 32179 | Aggregate | 821.67 | 831.20 | 1.2% | pattern |
| 32182 | Hash Join | 801.79 | 766.05 | 4.5% | operator |
...
### Step 5: Node 32179 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 32180, 32181
- **Input Features:**
