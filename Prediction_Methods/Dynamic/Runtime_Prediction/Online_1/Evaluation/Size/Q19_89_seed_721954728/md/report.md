...
**Test Query:** Q19_89_seed_721954728
...
```
Node 32179 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 32180 (Gather) [consumed]
    Node 32181 (Aggregate) [consumed]
      Node 32182 (Hash Join) [consumed]
        Node 32183 (Seq Scan) - LEAF
        Node 32184 (Hash)
          Node 32185 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 32179 | 32180, 32181, 32182 |
...
|------|------|--------|-----------|-----|--------|
| 32179 | Aggregate | 821.67 | 829.28 | 0.9% | pattern |
| 32183 | Seq Scan | 754.24 | 743.46 | 1.4% | operator |
| 32184 | Hash | 45.34 | 8.29 | 81.7% | operator |
| 32185 | Seq Scan | 45.24 | 23.76 | 47.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 32185 (Seq Scan) - LEAF
...
### Step 2: Node 32183 (Seq Scan) - LEAF
...
### Step 4: Node 32179 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 32180, 32181, 32182
- **Input Features:**
  ...
  - HashJoin_Outer_total_cost=156338.4600
