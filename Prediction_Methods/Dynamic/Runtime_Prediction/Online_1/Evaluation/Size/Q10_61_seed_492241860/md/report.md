...
**Test Query:** Q10_61_seed_492241860
**Timestamp:** 2026-01-18 19:37:30
...
```
Node 20761 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 20762 (Sort) [consumed]
    Node 20763 (Aggregate) [consumed]
      Node 20764 (Gather) [consumed]
        Node 20765 (Hash Join)
          Node 20766 (Hash Join) [PATTERN: 2e0f44ef]
            Node 20767 (Nested Loop) [consumed]
              Node 20768 (Seq Scan) - LEAF
              Node 20769 (Index Scan) - LEAF
            Node 20770 (Hash) [consumed]
              Node 20771 (Seq Scan) - LEAF
          Node 20772 (Hash)
            Node 20773 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20761 | 20762, 20763, 20764, 20766, 20767, 20770 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 20766 | 20761, 20762, 20763, 20764, 20767, 20770 |
...
|------|------|--------|-----------|-----|--------|
| 20761 | Limit | 1146.38 | 1199.47 | 4.6% | pattern |
| 20765 | Hash Join | 1101.35 | 1095.40 | 0.5% | operator |
| 20766 | Hash Join | 1098.57 | 1120.19 | 2.0% | pattern |
| 20772 | Hash | 0.01 | 15.71 | 112119.8% | operator |
| 20773 | Seq Scan | 0.01 | 6.98 | 69687.0% | operator |
| 20768 | Seq Scan | 163.32 | 159.75 | 2.2% | operator |
| 20769 | Index Scan | 0.06 | -0.52 | 922.6% | operator |
| 20771 | Seq Scan | 22.54 | 26.64 | 18.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 20768 (Seq Scan) - LEAF
...
### Step 2: Node 20769 (Index Scan) - LEAF
...
### Step 3: Node 20771 (Seq Scan) - LEAF
...
### Step 4: Node 20773 (Seq Scan) - LEAF
...
### Step 5: Node 20766 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 20761, 20762, 20763, 20764, 20767, 20770
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=17639
  - HashJoin_nt1=17639
...
### Step 8: Node 20761 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20762, 20763, 20764, 20766, 20767, 20770
- **Input Features:**
