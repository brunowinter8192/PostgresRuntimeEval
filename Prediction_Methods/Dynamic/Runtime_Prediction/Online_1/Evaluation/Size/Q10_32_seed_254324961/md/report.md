    ...
    Node 20347 (Aggregate) [consumed]
      Node 20348 (Gather) [consumed]
        Node 20349 (Hash Join)
          Node 20350 (Hash Join)
            Node 20351 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20345 | 20346, 20347, 20348 |
...
| 20349 | Hash Join | 1080.68 | 1007.12 | 6.8% | operator |
| 20350 | Hash Join | 1077.81 | 1003.97 | 6.9% | operator |
| 20356 | Hash | 0.01 | 15.71 | 104638.5% | operator |
| 20351 | Nested Loop | 1031.74 | 1204.87 | 16.8% | operator |
| 20354 | Hash | 35.45 | 55.57 | 56.8% | operator |
...
- **Input Features:**
  ...
  - st2=0.0265
  - startup_cost=0.4300
  - total_cost=75840.3000
- **Output:** st=124.88, rt=1204.87

### Step 5: Node 20354 (Hash)
...
### Step 6: Node 20357 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=80894.5200
- **Output:** st=109.73, rt=1003.97

### Step 8: Node 20356 (Hash)
...
- **Output:** st=98.93, rt=1007.12

### Step 10: Node 20345 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20346, 20347, 20348
- **Input Features:**
