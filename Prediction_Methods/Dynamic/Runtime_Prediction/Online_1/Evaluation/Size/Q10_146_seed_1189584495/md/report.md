...
**Test Query:** Q10_146_seed_1189584495
...
```
Node 20020 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 20021 (Sort) [consumed]
    Node 20022 (Aggregate) [consumed]
      Node 20023 (Gather) [consumed]
        Node 20024 (Hash Join)
          Node 20025 (Hash Join) [PATTERN: 2e0f44ef]
            Node 20026 (Nested Loop) [consumed]
              Node 20027 (Seq Scan) - LEAF
              Node 20028 (Index Scan) - LEAF
            Node 20029 (Hash) [consumed]
              Node 20030 (Seq Scan) - LEAF
          Node 20031 (Hash)
            Node 20032 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20020 | 20021, 20022, 20023, 20025, 20026, 20029 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 20025 | 20020, 20021, 20022, 20023, 20026, 20029 |
...
|------|------|--------|-----------|-----|--------|
| 20020 | Limit | 1157.80 | 1199.47 | 3.6% | pattern |
| 20024 | Hash Join | 1106.81 | 1095.53 | 1.0% | operator |
| 20025 | Hash Join | 1103.92 | 1120.19 | 1.5% | pattern |
| 20031 | Hash | 0.02 | 15.71 | 98092.3% | operator |
| 20032 | Seq Scan | 0.01 | 6.98 | 58055.9% | operator |
| 20027 | Seq Scan | 162.04 | 159.74 | 1.4% | operator |
| 20028 | Index Scan | 0.06 | -0.52 | 935.9% | operator |
| 20030 | Seq Scan | 29.23 | 26.64 | 8.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 20027 (Seq Scan) - LEAF
...
### Step 2: Node 20028 (Index Scan) - LEAF
...
### Step 3: Node 20030 (Seq Scan) - LEAF
...
### Step 4: Node 20032 (Seq Scan) - LEAF
...
### Step 5: Node 20025 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 20020, 20021, 20022, 20023, 20026, 20029
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18089
  - HashJoin_nt1=18089
...
### Step 8: Node 20020 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20021, 20022, 20023, 20025, 20026, 20029
- **Input Features:**
