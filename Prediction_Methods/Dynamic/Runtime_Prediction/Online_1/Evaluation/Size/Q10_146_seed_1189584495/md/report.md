    ...
    Node 20022 (Aggregate) [consumed]
      Node 20023 (Gather) [consumed]
        Node 20024 (Hash Join)
          Node 20025 (Hash Join)
            Node 20026 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20020 | 20021, 20022, 20023 |
...
| 20024 | Hash Join | 1106.81 | 1007.19 | 9.0% | operator |
| 20025 | Hash Join | 1103.92 | 1004.09 | 9.0% | operator |
| 20031 | Hash | 0.02 | 15.71 | 98092.3% | operator |
| 20026 | Nested Loop | 1054.08 | 1204.83 | 14.3% | operator |
| 20029 | Hash | 37.68 | 55.57 | 47.5% | operator |
...
### Step 6: Node 20032 (Seq Scan) - LEAF
...
### Step 10: Node 20020 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20021, 20022, 20023
- **Input Features:**
