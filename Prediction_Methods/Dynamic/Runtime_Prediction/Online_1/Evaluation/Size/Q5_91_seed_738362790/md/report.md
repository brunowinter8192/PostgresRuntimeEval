...
**Test Query:** Q5_91_seed_738362790
...
```
Node 9701 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 9702 (Aggregate) [consumed]
    Node 9703 (Gather Merge) [consumed]
      Node 9704 (Aggregate)
        Node 9705 (Sort) [PATTERN: 3e2d5a00]
          Node 9706 (Hash Join) [consumed]
            Node 9707 (Nested Loop)
              Node 9708 (Hash Join)
                Node 9709 (Seq Scan) - LEAF
                Node 9710 (Hash) [PATTERN: 444761fb]
                  Node 9711 (Hash Join) [consumed]
                    Node 9712 (Seq Scan) [consumed] - LEAF
                    Node 9713 (Hash) [consumed]
                      Node 9714 (Hash Join) [consumed]
                        Node 9715 (Seq Scan) - LEAF
                        Node 9716 (Hash)
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 9710 | 9701, 9702, 9703, 9705, 9706, 9711, 9712, 9713, 9714 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 9701 | 9702, 9703, 9705, 9706, 9710, 9711, 9712, 9713, 9714 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 9705 | 9701, 9702, 9703, 9706, 9710, 9711, 9712, 9713, 9714 |
...
|------|------|--------|-----------|-----|--------|
| 9701 | Sort | 1082.99 | 2934.42 | 171.0% | pattern |
| 9704 | Aggregate | 1077.96 | 1128.78 | 4.7% | operator |
| 9705 | Sort | 1077.72 | 1835.92 | 70.4% | pattern |
| 9707 | Nested Loop | 1066.28 | 1188.42 | 11.5% | operator |
| 9719 | Hash | 2.91 | 18.67 | 540.7% | operator |
| 9708 | Hash Join | 220.31 | 253.07 | 14.9% | operator |
| 9718 | Index Scan | 0.07 | -0.22 | 397.3% | operator |
| 9720 | Seq Scan | 2.43 | 12.36 | 409.5% | operator |
| 9709 | Seq Scan | 168.13 | 159.81 | 4.9% | operator |
| 9710 | Hash | 39.48 | 46.85 | 18.7% | pattern |
| 9715 | Seq Scan | 0.01 | 11.81 | 131103.0% | operator |
| 9716 | Hash | 0.05 | 21.05 | 39623.1% | operator |
| 9717 | Seq Scan | 0.05 | 22.93 | 44867.3% | operator |
...
### Step 2: Node 9715 (Seq Scan) - LEAF
...
### Step 4: Node 9709 (Seq Scan) - LEAF
...
### Step 5: Node 9710 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 9701, 9702, 9703, 9705, 9706, 9711, 9712, 9713, 9714
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 9718 (Index Scan) - LEAF
...
### Step 8: Node 9720 (Seq Scan) - LEAF
...
### Step 11: Node 9705 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 9701, 9702, 9703, 9706, 9710, 9711, 9712, 9713, 9714
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 9701 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 9702, 9703, 9705, 9706, 9710, 9711, 9712, 9713, 9714
- **Input Features:**
