...
**Test Query:** Q9_38_seed_303549147
...
```
Node 18119 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18120 (Aggregate) [consumed]
    Node 18121 (Gather)
      Node 18122 (Aggregate)
        Node 18123 (Nested Loop)
          Node 18124 (Hash Join) [PATTERN: bb930825]
            Node 18125 (Seq Scan) [consumed] - LEAF
            Node 18126 (Hash) [consumed]
              Node 18127 (Hash Join) [consumed]
                Node 18128 (Hash Join)
                  Node 18129 (Nested Loop)
                    Node 18130 (Seq Scan) - LEAF
                    Node 18131 (Index Scan) - LEAF
                  Node 18132 (Hash)
                    Node 18133 (Seq Scan) - LEAF
                Node 18134 (Hash)
                  Node 18135 (Seq Scan) - LEAF
          Node 18136 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18124 | 18119, 18120, 18125, 18126, 18127 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18119 | 18120, 18124, 18125, 18126, 18127 |
...
|------|------|--------|-----------|-----|--------|
| 18119 | Sort | 1216.08 | 1044.79 | 14.1% | pattern |
| 18121 | Gather | 1215.14 | 964.87 | 20.6% | operator |
| 18122 | Aggregate | 1194.86 | 1117.47 | 6.5% | operator |
| 18123 | Nested Loop | 1170.00 | 1252.17 | 7.0% | operator |
| 18124 | Hash Join | 987.56 | 134.80 | 86.4% | pattern |
| 18136 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18128 | Hash Join | 166.60 | 837.55 | 402.7% | operator |
| 18134 | Hash | 12.99 | 14.95 | 15.1% | operator |
| 18129 | Nested Loop | 161.32 | 1251.76 | 675.9% | operator |
| 18132 | Hash | 3.23 | 15.94 | 392.9% | operator |
| 18135 | Seq Scan | 12.98 | 2.94 | 77.4% | operator |
| 18130 | Seq Scan | 19.73 | 44.17 | 123.8% | operator |
| 18131 | Index Scan | 0.08 | -1.39 | 1903.2% | operator |
| 18133 | Seq Scan | 2.77 | 9.45 | 241.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 18130 (Seq Scan) - LEAF
...
### Step 2: Node 18131 (Index Scan) - LEAF
...
### Step 3: Node 18133 (Seq Scan) - LEAF
...
### Step 6: Node 18135 (Seq Scan) - LEAF
...
### Step 9: Node 18124 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18119, 18120, 18125, 18126, 18127
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18136 (Index Scan) - LEAF
...
### Step 11: Node 18123 (Nested Loop)
...
### Step 14: Node 18119 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18120, 18124, 18125, 18126, 18127
- **Input Features:**
