...
```
Node 17919 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 17920 (Aggregate) [consumed]
    Node 17921 (Gather)
      Node 17922 (Aggregate)
        Node 17923 (Nested Loop)
          Node 17924 (Hash Join) [PATTERN: bb930825]
            Node 17925 (Seq Scan) [consumed] - LEAF
            Node 17926 (Hash) [consumed]
              Node 17927 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17924 | 17919, 17920, 17925, 17926, 17927 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17919 | 17920, 17924, 17925, 17926, 17927 |
...
|------|------|--------|-----------|-----|--------|
| 17919 | Sort | 1264.84 | 1047.04 | 17.2% | pattern |
...
| 17924 | Hash Join | 1034.42 | 134.80 | 87.0% | pattern |
...
### Step 9: Node 17924 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17919, 17920, 17925, 17926, 17927
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17936 (Index Scan) - LEAF
...
### Step 11: Node 17923 (Nested Loop)
...
### Step 14: Node 17919 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17920, 17924, 17925, 17926, 17927
- **Input Features:**
