...
**Test Query:** Q9_81_seed_656322480
...
```
Node 18989 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18990 (Aggregate) [consumed]
    Node 18991 (Gather)
      Node 18992 (Aggregate)
        Node 18993 (Nested Loop)
          Node 18994 (Hash Join) [PATTERN: bb930825]
            Node 18995 (Seq Scan) [consumed] - LEAF
            Node 18996 (Hash) [consumed]
              Node 18997 (Hash Join) [consumed]
                Node 18998 (Hash Join)
                  Node 18999 (Nested Loop)
                    Node 19000 (Seq Scan) - LEAF
                    Node 19001 (Index Scan) - LEAF
                  Node 19002 (Hash)
                    Node 19003 (Seq Scan) - LEAF
                Node 19004 (Hash)
                  Node 19005 (Seq Scan) - LEAF
          Node 19006 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18994 | 18989, 18990, 18995, 18996, 18997 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18989 | 18990, 18994, 18995, 18996, 18997 |
...
|------|------|--------|-----------|-----|--------|
| 18989 | Sort | 1200.96 | 1047.04 | 12.8% | pattern |
| 18991 | Gather | 1199.60 | 950.92 | 20.7% | operator |
| 18992 | Aggregate | 1181.45 | 1141.61 | 3.4% | operator |
| 18993 | Nested Loop | 1157.74 | 1252.17 | 8.2% | operator |
| 18994 | Hash Join | 984.71 | 134.80 | 86.3% | pattern |
| 19006 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18998 | Hash Join | 165.90 | 837.40 | 404.8% | operator |
| 19004 | Hash | 13.07 | 14.95 | 14.4% | operator |
| 18999 | Nested Loop | 159.18 | 1251.76 | 686.4% | operator |
| 19002 | Hash | 4.67 | 15.94 | 241.5% | operator |
| 19005 | Seq Scan | 13.05 | 2.94 | 77.5% | operator |
| 19000 | Seq Scan | 18.78 | 44.51 | 137.0% | operator |
| 19001 | Index Scan | 0.08 | -1.39 | 1903.2% | operator |
| 19003 | Seq Scan | 4.14 | 9.45 | 128.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 19000 (Seq Scan) - LEAF
...
### Step 2: Node 19001 (Index Scan) - LEAF
...
### Step 3: Node 19003 (Seq Scan) - LEAF
...
### Step 6: Node 19005 (Seq Scan) - LEAF
...
### Step 9: Node 18994 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18989, 18990, 18995, 18996, 18997
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=14697
  - HashJoin_Outer_nt1=14697
  ...
  - HashJoin_Outer_total_cost=14013.3900
  - HashJoin_np=0
  - HashJoin_nt=52919
...
### Step 10: Node 19006 (Index Scan) - LEAF
...
### Step 11: Node 18993 (Nested Loop)
...
### Step 14: Node 18989 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18990, 18994, 18995, 18996, 18997
- **Input Features:**
