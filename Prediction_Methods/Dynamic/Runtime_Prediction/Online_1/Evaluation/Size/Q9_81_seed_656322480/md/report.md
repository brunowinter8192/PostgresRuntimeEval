...
```
Node 18989 (Sort) - ROOT
  Node 18990 (Aggregate)
    Node 18991 (Gather)
      Node 18992 (Aggregate)
        Node 18993 (Nested Loop)
          Node 18994 (Hash Join)
            Node 18995 (Seq Scan) - LEAF
            Node 18996 (Hash)
              Node 18997 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 18989 | Sort | 1200.96 | 1116.97 | 7.0% | operator |
| 18990 | Aggregate | 1200.82 | 898.50 | 25.2% | operator |
...
| 18994 | Hash Join | 984.71 | 632.07 | 35.8% | operator |
| 19006 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18995 | Seq Scan | 708.42 | 509.93 | 28.0% | operator |
| 18996 | Hash | 181.59 | 47.12 | 74.1% | operator |
| 18997 | Hash Join | 179.60 | 924.03 | 414.5% | operator |
...
### Step 10: Node 18995 (Seq Scan) - LEAF
...
### Step 13: Node 19006 (Index Scan) - LEAF
...
### Step 14: Node 18993 (Nested Loop)
