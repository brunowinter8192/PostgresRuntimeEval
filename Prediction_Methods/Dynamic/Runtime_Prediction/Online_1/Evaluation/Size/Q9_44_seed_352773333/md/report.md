...
**Test Query:** Q9_44_seed_352773333
...
```
Node 18246 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18247 (Aggregate) [consumed]
    Node 18248 (Gather)
      Node 18249 (Aggregate)
        Node 18250 (Nested Loop)
          Node 18251 (Hash Join) [PATTERN: bb930825]
            Node 18252 (Seq Scan) [consumed] - LEAF
            Node 18253 (Hash) [consumed]
              Node 18254 (Hash Join) [consumed]
                Node 18255 (Hash Join)
                  Node 18256 (Nested Loop)
                    Node 18257 (Seq Scan) - LEAF
                    Node 18258 (Index Scan) - LEAF
                  Node 18259 (Hash)
                    Node 18260 (Seq Scan) - LEAF
                Node 18261 (Hash)
                  Node 18262 (Seq Scan) - LEAF
          Node 18263 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18251 | 18246, 18247, 18252, 18253, 18254 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18246 | 18247, 18251, 18252, 18253, 18254 |
...
|------|------|--------|-----------|-----|--------|
| 18246 | Sort | 1183.51 | 1044.79 | 11.7% | pattern |
| 18248 | Gather | 1182.07 | 964.87 | 18.4% | operator |
| 18249 | Aggregate | 1164.17 | 1117.47 | 4.0% | operator |
| 18250 | Nested Loop | 1139.46 | 1252.17 | 9.9% | operator |
| 18251 | Hash Join | 963.98 | 134.80 | 86.0% | pattern |
| 18263 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18255 | Hash Join | 157.78 | 837.55 | 430.8% | operator |
| 18261 | Hash | 13.58 | 14.95 | 10.1% | operator |
| 18256 | Nested Loop | 150.53 | 1251.76 | 731.5% | operator |
| 18259 | Hash | 4.96 | 15.94 | 221.7% | operator |
| 18262 | Seq Scan | 13.57 | 2.94 | 78.3% | operator |
| 18257 | Seq Scan | 19.56 | 44.17 | 125.8% | operator |
| 18258 | Index Scan | 0.07 | -1.39 | 2002.0% | operator |
| 18260 | Seq Scan | 4.33 | 9.45 | 117.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 18257 (Seq Scan) - LEAF
...
### Step 2: Node 18258 (Index Scan) - LEAF
...
### Step 3: Node 18260 (Seq Scan) - LEAF
...
### Step 6: Node 18262 (Seq Scan) - LEAF
...
### Step 9: Node 18251 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18246, 18247, 18252, 18253, 18254
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18263 (Index Scan) - LEAF
...
### Step 11: Node 18250 (Nested Loop)
...
### Step 14: Node 18246 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18247, 18251, 18252, 18253, 18254
- **Input Features:**
