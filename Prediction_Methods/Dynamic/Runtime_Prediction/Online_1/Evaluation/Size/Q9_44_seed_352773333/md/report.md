...
```
Node 18246 (Sort) - ROOT
  Node 18247 (Aggregate)
    Node 18248 (Gather)
      Node 18249 (Aggregate)
        Node 18250 (Nested Loop)
          Node 18251 (Hash Join)
            Node 18252 (Seq Scan) - LEAF
            Node 18253 (Hash)
              Node 18254 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 18246 | Sort | 1183.51 | 1118.92 | 5.5% | operator |
| 18247 | Aggregate | 1183.37 | 896.90 | 24.2% | operator |
...
| 18251 | Hash Join | 963.98 | 632.96 | 34.3% | operator |
| 18263 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18252 | Seq Scan | 694.28 | 509.93 | 26.6% | operator |
| 18253 | Hash | 174.00 | 47.68 | 72.6% | operator |
| 18254 | Hash Join | 171.99 | 924.32 | 437.4% | operator |
...
### Step 10: Node 18252 (Seq Scan) - LEAF
...
### Step 13: Node 18263 (Index Scan) - LEAF
...
### Step 14: Node 18250 (Nested Loop)
