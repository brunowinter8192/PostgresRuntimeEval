...
```
Node 12769 (Aggregate) - ROOT
  Node 12770 (Gather Merge)
    Node 12771 (Sort)
      Node 12772 (Hash Join)
        Node 12773 (Nested Loop)
          Node 12774 (Hash Join)
            Node 12775 (Seq Scan) - LEAF
            Node 12776 (Hash)
              Node 12777 (Hash Join)
                Node 12778 (Seq Scan) - LEAF
                Node 12779 (Hash)
                  Node 12780 (Seq Scan) - LEAF
          Node 12781 (Index Scan) - LEAF
        Node 12782 (Hash)
          Node 12783 (Hash Join)
            Node 12784 (Seq Scan) - LEAF
            Node 12785 (Hash)
              Node 12786 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12769 | Aggregate | 1210.95 | 1209.26 | 0.1% | operator |
| 12770 | Gather Merge | 1209.76 | 1142.98 | 5.5% | operator |
| 12771 | Sort | 1203.96 | 1109.13 | 7.9% | operator |
| 12772 | Hash Join | 1203.37 | 842.59 | 30.0% | operator |
| 12773 | Nested Loop | 1195.59 | 1216.16 | 1.7% | operator |
| 12782 | Hash | 3.85 | 17.53 | 355.6% | operator |
| 12774 | Hash Join | 213.41 | 384.47 | 80.2% | operator |
| 12781 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 12783 | Hash Join | 3.81 | 85.17 | 2137.3% | operator |
| 12775 | Seq Scan | 152.63 | 201.16 | 31.8% | operator |
| 12776 | Hash | 36.11 | 19.59 | 45.7% | operator |
| 12784 | Seq Scan | 3.50 | 11.47 | 227.6% | operator |
| 12785 | Hash | 0.01 | 16.89 | 112527.2% | operator |
| 12777 | Hash Join | 34.98 | 92.20 | 163.6% | operator |
| 12786 | Seq Scan | 0.01 | 45.79 | 381502.6% | operator |
| 12778 | Seq Scan | 33.79 | 21.86 | 35.3% | operator |
| 12779 | Hash | 0.01 | 16.89 | 187612.0% | operator |
| 12780 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12780 (Seq Scan) - LEAF
...
### Step 2: Node 12778 (Seq Scan) - LEAF
...
### Step 5: Node 12786 (Seq Scan) - LEAF
...
### Step 6: Node 12775 (Seq Scan) - LEAF
...
### Step 8: Node 12784 (Seq Scan) - LEAF
...
### Step 11: Node 12781 (Index Scan) - LEAF
...
### Step 13: Node 12773 (Nested Loop)
...
### Step 17: Node 12770 (Gather Merge)
...
### Step 18: Node 12769 (Aggregate) - ROOT
