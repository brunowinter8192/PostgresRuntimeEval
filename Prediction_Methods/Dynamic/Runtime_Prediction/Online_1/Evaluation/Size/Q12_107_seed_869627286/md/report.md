...
**Test Query:** Q12_107_seed_869627286
...
```
Node 24369 (Aggregate) - ROOT
  Node 24370 (Gather Merge)
    Node 24371 (Aggregate)
      Node 24372 (Sort)
        Node 24373 (Nested Loop)
          Node 24374 (Seq Scan) - LEAF
          Node 24375 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24369 | Aggregate | 988.90 | 919.06 | 7.1% | operator |
| 24370 | Gather Merge | 988.89 | 1111.84 | 12.4% | operator |
| 24371 | Aggregate | 968.58 | 895.31 | 7.6% | operator |
| 24372 | Sort | 967.93 | 1092.81 | 12.9% | operator |
| 24373 | Nested Loop | 966.97 | 1127.41 | 16.6% | operator |
| 24374 | Seq Scan | 825.43 | 745.19 | 9.7% | operator |
| 24375 | Index Scan | 0.03 | 0.07 | 166.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24374 (Seq Scan) - LEAF
...
### Step 2: Node 24375 (Index Scan) - LEAF
...
### Step 6: Node 24370 (Gather Merge)
...
### Step 7: Node 24369 (Aggregate) - ROOT
