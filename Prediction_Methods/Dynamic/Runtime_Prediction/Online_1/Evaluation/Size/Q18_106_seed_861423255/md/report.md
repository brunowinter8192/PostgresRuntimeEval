        ...
        Node 28920 (Incremental Sort)
          Node 28921 (Nested Loop)
            Node 28922 (Merge Join)
              Node 28923 (Sort)
                Node 28924 (Hash Join)
                  Node 28925 (Seq Scan) - LEAF
                  Node 28926 (Hash)
...
| 28923 | Sort | 2839.57 | 1099.77 | 61.3% | operator |
| 28929 | Sort | 68.53 | 1074.66 | 1468.2% | operator |
| 28924 | Hash Join | 2839.56 | 686.33 | 75.8% | operator |
| 28930 | Seq Scan | 55.04 | 18.25 | 66.8% | operator |
| 28925 | Seq Scan | 187.35 | 170.37 | 9.1% | operator |
| 28926 | Hash | 2621.35 | 21.04 | 99.2% | operator |
...
### Step 3: Node 28925 (Seq Scan) - LEAF
...
### Step 6: Node 28930 (Seq Scan) - LEAF
...
### Step 9: Node 28922 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 28931 (Index Scan) - LEAF
...
### Step 11: Node 28921 (Nested Loop)
...
### Step 12: Node 28920 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 28919 (Gather Merge)
