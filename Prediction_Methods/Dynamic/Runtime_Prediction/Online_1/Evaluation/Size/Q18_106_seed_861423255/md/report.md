...
**Test Query:** Q18_106_seed_861423255
...
```
Node 28916 (Limit) - ROOT
  Node 28917 (Sort)
    Node 28918 (Aggregate)
      Node 28919 (Gather Merge)
        Node 28920 (Incremental Sort)
          Node 28921 (Nested Loop)
            Node 28922 (Merge Join)
              Node 28923 (Sort)
                Node 28924 (Hash Join) [PATTERN: 895c6e8c]
                  Node 28925 (Seq Scan) [consumed] - LEAF
                  Node 28926 (Hash) [consumed]
                    Node 28927 (Aggregate)
                      Node 28928 (Index Scan) - LEAF
              Node 28929 (Sort)
                Node 28930 (Seq Scan) - LEAF
            Node 28931 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 28924 | 28925, 28926 |
...
|------|------|--------|-----------|-----|--------|
| 28916 | Limit | 3048.39 | 1175.21 | 61.4% | operator |
| 28917 | Sort | 2931.86 | 1127.81 | 61.5% | operator |
| 28918 | Aggregate | 2931.82 | 1073.15 | 63.4% | operator |
| 28919 | Gather Merge | 2931.80 | 1073.95 | 63.4% | operator |
| 28920 | Incremental Sort | 2911.54 | 0.00 | 100.0% | operator |
| 28921 | Nested Loop | 2911.48 | 1111.34 | 61.8% | operator |
| 28922 | Merge Join | 2911.43 | 0.00 | 100.0% | operator |
| 28931 | Index Scan | 0.02 | 0.05 | 114.9% | operator |
| 28923 | Sort | 2839.57 | 1095.58 | 61.4% | operator |
| 28929 | Sort | 68.53 | 1074.66 | 1468.2% | operator |
| 28924 | Hash Join | 2839.56 | 471.07 | 83.4% | pattern |
| 28930 | Seq Scan | 55.04 | 18.25 | 66.8% | operator |
| 28927 | Aggregate | 2621.32 | 1073.15 | 59.1% | operator |
| 28928 | Index Scan | 2126.76 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 28928 (Index Scan) - LEAF
...
### Step 3: Node 28924 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 28925, 28926
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 28930 (Seq Scan) - LEAF
...
### Step 7: Node 28922 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 28931 (Index Scan) - LEAF
...
### Step 10: Node 28920 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 28919 (Gather Merge)
