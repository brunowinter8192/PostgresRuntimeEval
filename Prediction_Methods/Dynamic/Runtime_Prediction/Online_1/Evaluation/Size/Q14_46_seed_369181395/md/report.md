...
**Test Query:** Q14_46_seed_369181395
**Timestamp:** 2025-12-21 18:17:35
...
```
Node 27050 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27051 (Gather) [consumed]
    Node 27052 (Aggregate) [consumed]
      Node 27053 (Hash Join)
        Node 27054 (Seq Scan) - LEAF
        Node 27055 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27050 | 27051, 27052 |
...
|------|------|--------|-----------|-----|--------|
| 27050 | Aggregate | 811.32 | 848.39 | 4.6% | pattern |
| 27053 | Hash Join | 789.45 | 807.69 | 2.3% | operator |
| 27054 | Seq Scan | 739.60 | 758.52 | 2.6% | operator |
| 27055 | Hash | 42.15 | 9.38 | 77.7% | operator |
| 27056 | Seq Scan | 36.52 | 12.70 | 65.2% | operator |
...
### Step 2: Node 27054 (Seq Scan) - LEAF
...
### Step 5: Node 27050 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27051, 27052
- **Input Features:**
