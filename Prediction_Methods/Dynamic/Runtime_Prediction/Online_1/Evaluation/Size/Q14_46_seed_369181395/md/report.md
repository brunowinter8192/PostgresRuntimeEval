...
```
Node 27050 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27051 (Gather) [consumed]
    Node 27052 (Aggregate) [consumed]
      Node 27053 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27050 | 27051, 27052, 27053 |
...
|------|------|--------|-----------|-----|--------|
| 27050 | Aggregate | 811.32 | 857.15 | 5.6% | pattern |
...
### Step 4: Node 27050 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27051, 27052, 27053
- **Input Features:**
