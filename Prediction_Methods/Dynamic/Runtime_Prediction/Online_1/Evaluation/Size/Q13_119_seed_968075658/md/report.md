...
**Test Query:** Q13_119_seed_968075658
**Timestamp:** 2026-01-18 19:55:05
...
```
Node 25510 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25511 (Aggregate) [consumed]
    Node 25512 (Aggregate)
      Node 25513 (Hash Join) [PATTERN: 895c6e8c]
        Node 25514 (Seq Scan) [consumed] - LEAF
        Node 25515 (Hash) [consumed]
          Node 25516 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25510 | 25511, 25513, 25514, 25515 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25513 | 25510, 25511, 25514, 25515 |
...
|------|------|--------|-----------|-----|--------|
| 25510 | Sort | 909.01 | 1079.93 | 18.8% | pattern |
| 25512 | Aggregate | 902.93 | 999.35 | 10.7% | operator |
| 25513 | Hash Join | 692.12 | 470.31 | 32.0% | pattern |
| 25516 | Index Only Scan | 9.84 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25516 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25513 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25510, 25511, 25514, 25515
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1481964
...
### Step 4: Node 25510 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25511, 25513, 25514, 25515
- **Input Features:**
