...
```
Node 9973 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 9974 (Gather) [consumed]
    Node 9975 (Aggregate) [consumed]
...
|------|------|--------|-----------|-----|--------|
| 9973 | Aggregate | 811.82 | 850.06 | 4.7% | pattern |
| 9976 | Seq Scan | 788.06 | 748.54 | 5.0% | operator |
...
### Step 2: Node 9973 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 9974, 9975
- **Input Features:**
