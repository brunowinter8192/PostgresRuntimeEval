...
**Test Query:** Q10_8_seed_57428217
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 21164 | 21165, 21166, 21167, 21169, 21170, 21173 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 21169 | 21164, 21165, 21166, 21167, 21170, 21173 |
...
|------|------|--------|-----------|-----|--------|
| 21164 | Limit | 1127.21 | 1199.47 | 6.4% | pattern |
| 21168 | Hash Join | 1085.44 | 1095.47 | 0.9% | operator |
| 21169 | Hash Join | 1082.65 | 1120.19 | 3.5% | pattern |
| 21175 | Hash | 0.01 | 15.71 | 130823.1% | operator |
| 21176 | Seq Scan | 0.01 | 6.98 | 77441.2% | operator |
| 21171 | Seq Scan | 161.45 | 159.74 | 1.1% | operator |
| 21172 | Index Scan | 0.06 | -0.52 | 922.6% | operator |
| 21174 | Seq Scan | 29.70 | 26.64 | 10.3% | operator |
...
### Step 4: Node 21176 (Seq Scan) - LEAF
...
- **Consumes:** Nodes 21164, 21165, 21166, 21167, 21170, 21173
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=17881
  - HashJoin_nt1=17881
...
### Step 8: Node 21164 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 21165, 21166, 21167, 21169, 21170, 21173
- **Input Features:**
