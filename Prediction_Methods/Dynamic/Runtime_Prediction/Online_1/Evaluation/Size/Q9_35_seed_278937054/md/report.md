...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18070 | 18065, 18066, 18071, 18072, 18073 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18065 | 18066, 18070, 18071, 18072, 18073 |
...
|------|------|--------|-----------|-----|--------|
| 18065 | Sort | 1163.70 | 1045.10 | 10.2% | pattern |
| 18067 | Gather | 1162.30 | 960.51 | 17.4% | operator |
| 18068 | Aggregate | 1143.18 | 1141.32 | 0.2% | operator |
| 18069 | Nested Loop | 1119.22 | 1252.17 | 11.9% | operator |
| 18070 | Hash Join | 944.29 | 134.80 | 85.7% | pattern |
| 18082 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18074 | Hash Join | 150.93 | 837.46 | 454.9% | operator |
| 18080 | Hash | 12.87 | 14.95 | 16.2% | operator |
| 18075 | Nested Loop | 144.66 | 1251.76 | 765.3% | operator |
| 18078 | Hash | 4.13 | 15.94 | 286.3% | operator |
| 18081 | Seq Scan | 12.86 | 2.94 | 77.2% | operator |
| 18076 | Seq Scan | 20.31 | 44.37 | 118.4% | operator |
| 18077 | Index Scan | 0.07 | -1.39 | 2112.3% | operator |
| 18079 | Seq Scan | 3.59 | 9.45 | 163.2% | operator |
...
### Step 6: Node 18081 (Seq Scan) - LEAF
...
### Step 9: Node 18070 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18065, 18066, 18071, 18072, 18073
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 11: Node 18069 (Nested Loop)
...
### Step 14: Node 18065 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18066, 18070, 18071, 18072, 18073
- **Input Features:**
