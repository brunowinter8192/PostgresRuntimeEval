...
```
Node 14213 (Aggregate) - ROOT
  Node 14214 (Gather Merge)
    Node 14215 (Sort)
          ...
          Node 14218 (Hash Join)
            Node 14219 (Nested Loop)
              Node 14220 (Hash Join)
                ...
                Node 14222 (Hash)
                  Node 14223 (Hash Join)
                    Node 14224 (Seq Scan) - LEAF
                    Node 14225 (Hash)
                      Node 14226 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 14213 | Aggregate | 1256.69 | 1193.49 | 5.0% | operator |
| 14214 | Gather Merge | 1256.30 | 1097.14 | 12.7% | operator |
...
| 14220 | Hash Join | 216.60 | 251.17 | 16.0% | operator |
...
| 14222 | Hash | 38.68 | 20.62 | 46.7% | operator |
| 14223 | Hash Join | 37.94 | 132.26 | 248.6% | operator |
| 14224 | Seq Scan | 36.31 | 23.03 | 36.6% | operator |
| 14225 | Hash | 0.29 | 23.66 | 8029.3% | operator |
| 14226 | Hash Join | 0.29 | 306.84 | 106071.6% | operator |
...
### Step 5: Node 14224 (Seq Scan) - LEAF
...
### Step 8: Node 14221 (Seq Scan) - LEAF
...
### Step 11: Node 14230 (Index Scan) - LEAF
...
### Step 12: Node 14232 (Seq Scan) - LEAF
...
### Step 13: Node 14219 (Nested Loop)
...
### Step 16: Node 14233 (Index Scan) - LEAF
...
### Step 17: Node 14235 (Seq Scan) - LEAF
...
### Step 18: Node 14217 (Nested Loop)
...
### Step 22: Node 14214 (Gather Merge)
...
### Step 23: Node 14213 (Aggregate) - ROOT
