...
**Test Query:** Q5_14_seed_106652403
...
```
Node 7981 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 7982 (Aggregate) [consumed]
    Node 7983 (Gather Merge) [consumed]
      Node 7984 (Aggregate)
        Node 7985 (Sort) [PATTERN: 3e2d5a00]
          Node 7986 (Hash Join) [consumed]
            Node 7987 (Nested Loop)
              Node 7988 (Hash Join)
                Node 7989 (Seq Scan) - LEAF
                Node 7990 (Hash) [PATTERN: 444761fb]
                  Node 7991 (Hash Join) [consumed]
                    Node 7992 (Seq Scan) [consumed] - LEAF
                    Node 7993 (Hash) [consumed]
                      Node 7994 (Hash Join) [consumed]
                        Node 7995 (Seq Scan) - LEAF
                        Node 7996 (Hash)
                          Node 7997 (Seq Scan) - LEAF
              Node 7998 (Index Scan) - LEAF
            Node 7999 (Hash)
              Node 8000 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 7990 | 7981, 7982, 7983, 7985, 7986, 7991, 7992, 7993, 7994 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 7981 | 7982, 7983, 7985, 7986, 7990, 7991, 7992, 7993, 7994 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 7985 | 7981, 7982, 7983, 7986, 7990, 7991, 7992, 7993, 7994 |
...
|------|------|--------|-----------|-----|--------|
| 7981 | Sort | 1069.50 | 2934.42 | 174.4% | pattern |
| 7984 | Aggregate | 1064.01 | 1128.78 | 6.1% | operator |
| 7985 | Sort | 1063.74 | 1835.91 | 72.6% | pattern |
| 7987 | Nested Loop | 1052.03 | 1188.39 | 13.0% | operator |
| 7999 | Hash | 3.18 | 18.67 | 486.6% | operator |
| 7988 | Hash Join | 216.96 | 253.07 | 16.6% | operator |
| 7998 | Index Scan | 0.07 | -0.22 | 401.4% | operator |
| 8000 | Seq Scan | 2.67 | 12.36 | 363.4% | operator |
| 7989 | Seq Scan | 168.00 | 159.81 | 4.9% | operator |
| 7990 | Hash | 36.11 | 46.85 | 29.7% | pattern |
| 7995 | Seq Scan | 0.01 | 11.81 | 168589.6% | operator |
| 7996 | Hash | 0.06 | 21.05 | 36198.7% | operator |
| 7997 | Seq Scan | 0.05 | 22.93 | 43170.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 7997 (Seq Scan) - LEAF
...
### Step 2: Node 7995 (Seq Scan) - LEAF
...
### Step 4: Node 7989 (Seq Scan) - LEAF
...
### Step 5: Node 7990 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 7981, 7982, 7983, 7985, 7986, 7991, 7992, 7993, 7994
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 7998 (Index Scan) - LEAF
...
### Step 8: Node 8000 (Seq Scan) - LEAF
...
### Step 11: Node 7985 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 7981, 7982, 7983, 7986, 7990, 7991, 7992, 7993, 7994
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 7981 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 7982, 7983, 7985, 7986, 7990, 7991, 7992, 7993, 7994
- **Input Features:**
