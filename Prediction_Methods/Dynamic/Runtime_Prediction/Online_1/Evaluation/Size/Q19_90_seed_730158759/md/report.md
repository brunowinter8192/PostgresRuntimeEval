...
```
Node 32193 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 32194 (Gather) [consumed]
    Node 32195 (Aggregate) [consumed]
      Node 32196 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 32193 | 32194, 32195 |
...
|------|------|--------|-----------|-----|--------|
| 32193 | Aggregate | 822.36 | 831.20 | 1.1% | pattern |
| 32196 | Hash Join | 802.14 | 766.06 | 4.5% | operator |
...
### Step 5: Node 32193 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 32194, 32195
- **Input Features:**
