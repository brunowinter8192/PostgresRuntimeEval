...
**Test Query:** Q19_90_seed_730158759
**Timestamp:** 2026-01-18 20:43:19
...
```
Node 32193 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 32194 (Gather) [consumed]
    Node 32195 (Aggregate) [consumed]
      Node 32196 (Hash Join) [consumed]
        Node 32197 (Seq Scan) - LEAF
        Node 32198 (Hash)
          Node 32199 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 32193 | 32194, 32195, 32196 |
...
|------|------|--------|-----------|-----|--------|
| 32193 | Aggregate | 822.36 | 829.31 | 0.8% | pattern |
| 32197 | Seq Scan | 753.89 | 743.46 | 1.4% | operator |
| 32198 | Hash | 46.29 | 8.29 | 82.1% | operator |
| 32199 | Seq Scan | 46.13 | 23.76 | 48.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 32199 (Seq Scan) - LEAF
...
### Step 2: Node 32197 (Seq Scan) - LEAF
...
### Step 4: Node 32193 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 32194, 32195, 32196
- **Input Features:**
