...
**Test Query:** Q14_81_seed_656322480
...
```
Node 27323 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27324 (Gather) [consumed]
    Node 27325 (Aggregate) [consumed]
      Node 27326 (Hash Join) [consumed]
        Node 27327 (Seq Scan) - LEAF
        Node 27328 (Hash)
          Node 27329 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27323 | 27324, 27325, 27326 |
...
|------|------|--------|-----------|-----|--------|
| 27323 | Aggregate | 814.30 | 857.13 | 5.3% | pattern |
| 27327 | Seq Scan | 741.23 | 758.49 | 2.3% | operator |
| 27328 | Hash | 44.91 | 9.38 | 79.1% | operator |
| 27329 | Seq Scan | 37.33 | 12.70 | 66.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27329 (Seq Scan) - LEAF
...
### Step 2: Node 27327 (Seq Scan) - LEAF
...
### Step 4: Node 27323 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27324, 27325, 27326
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=15230
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=64
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0001
  - Aggregate_Outer_startup_cost=136913.1500
  - Aggregate_Outer_total_cost=136913.1600
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=137913.7100
  - Aggregate_total_cost=137913.7300
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=137913.1500
  - Gather_Outer_total_cost=137913.6600
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=15230
  - HashJoin_Outer_nt1=15230
  ...
  - HashJoin_Outer_total_cost=136646.6200
