...
**Test Query:** Q1_46_seed_369181395
...
```
Node 451 (Aggregate) - ROOT
  Node 452 (Gather Merge)
    Node 453 (Sort)
      Node 454 (Aggregate)
        Node 455 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 451 | Aggregate | 939.55 | 1195.96 | 27.3% | operator |
| 452 | Gather Merge | 939.50 | 1165.61 | 24.1% | operator |
| 453 | Sort | 919.06 | 1182.13 | 28.6% | operator |
| 454 | Aggregate | 919.03 | 1113.24 | 21.1% | operator |
| 455 | Seq Scan | 530.23 | 678.48 | 28.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 455 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - st1=0.8530
  - st2=0.0000
  - startup_cost=169279.3200
  - total_cost=169279.4600
- **Output:** st=1037.45, rt=1113.24

### Step 3: Node 453 (Sort)
...
- **Input Features:**
  ...
  - st1=1037.4522
  - st2=0.0000
  - startup_cost=169279.5400
  - total_cost=169279.5500
- **Output:** st=1181.06, rt=1182.13

### Step 4: Node 452 (Gather Merge)
...
### Step 5: Node 451 (Aggregate) - ROOT
