...
Node 451 (Aggregate) - ROOT
  Node 452 (Gather Merge)
    Node 453 (Sort) [PATTERN: 1d35fb97]
      Node 454 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 453 | 454 |
...
|------|------|--------|-----------|-----|--------|
| 451 | Aggregate | 939.55 | 1196.01 | 27.3% | operator |
| 452 | Gather Merge | 939.50 | 1165.94 | 24.1% | operator |
| 453 | Sort | 919.06 | 1200.97 | 30.7% | pattern |
...
### Step 2: Node 453 (Sort) - PATTERN ROOT
...
### Step 4: Node 451 (Aggregate) - ROOT
