...
**Test Query:** Q1_20_seed_155876589
...
```
Node 311 (Aggregate) - ROOT
  Node 312 (Gather Merge)
    Node 313 (Sort) [PATTERN: 1d35fb97]
      Node 314 (Aggregate) [consumed]
        Node 315 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 313 | 314 |
...
|------|------|--------|-----------|-----|--------|
| 311 | Aggregate | 1037.41 | 1195.81 | 15.3% | operator |
| 312 | Gather Merge | 1037.37 | 1165.88 | 12.4% | operator |
| 313 | Sort | 1016.68 | 1200.23 | 18.1% | pattern |
| 315 | Seq Scan | 616.16 | 681.30 | 10.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 315 (Seq Scan) - LEAF
...
- **Output:** st=0.85, rt=681.30

### Step 2: Node 313 (Sort) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Aggregate_Outer_nt1=1176414
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=236
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=168777.5300
  - Aggregate_Outer_total_cost=168777.6600
  - Sort_np=0
  - Sort_nt=6
  - Sort_nt1=6
  - Sort_nt2=0
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=168777.7400
  - Sort_total_cost=168777.7600
- **Output:** st=1196.13, rt=1200.23

### Step 3: Node 312 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1196.1314
  - st2=0.0000
  - startup_cost=169777.8200
  - total_cost=169781.4500
- **Output:** st=1161.76, rt=1165.88

### Step 4: Node 311 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=169777.8200
  - total_cost=169782.5900
- **Output:** st=1149.88, rt=1195.81
