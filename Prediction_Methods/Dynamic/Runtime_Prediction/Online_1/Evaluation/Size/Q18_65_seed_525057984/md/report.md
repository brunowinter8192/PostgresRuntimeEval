        ...
        Node 30600 (Incremental Sort)
          Node 30601 (Nested Loop)
            Node 30602 (Merge Join)
              Node 30603 (Sort)
                Node 30604 (Hash Join)
                  Node 30605 (Seq Scan) - LEAF
                  Node 30606 (Hash)
...
| 30603 | Sort | 2856.70 | 1099.77 | 61.5% | operator |
| 30609 | Sort | 66.75 | 1074.66 | 1509.9% | operator |
| 30604 | Hash Join | 2856.68 | 686.33 | 76.0% | operator |
| 30610 | Seq Scan | 53.97 | 18.25 | 66.2% | operator |
| 30605 | Seq Scan | 193.74 | 170.37 | 12.1% | operator |
| 30606 | Hash | 2635.65 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30605 (Seq Scan) - LEAF
...
### Step 6: Node 30610 (Seq Scan) - LEAF
...
### Step 9: Node 30602 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30611 (Index Scan) - LEAF
...
### Step 11: Node 30601 (Nested Loop)
...
### Step 12: Node 30600 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30599 (Gather Merge)
