...
**Test Query:** Q18_65_seed_525057984
...
```
Node 30596 (Limit) - ROOT
  Node 30597 (Sort)
    Node 30598 (Aggregate)
      Node 30599 (Gather Merge)
        Node 30600 (Incremental Sort)
          Node 30601 (Nested Loop)
            Node 30602 (Merge Join)
              Node 30603 (Sort)
                Node 30604 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30605 (Seq Scan) [consumed] - LEAF
                  Node 30606 (Hash) [consumed]
                    Node 30607 (Aggregate)
                      Node 30608 (Index Scan) - LEAF
              Node 30609 (Sort)
                Node 30610 (Seq Scan) - LEAF
            Node 30611 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30604 | 30605, 30606 |
...
|------|------|--------|-----------|-----|--------|
| 30596 | Limit | 3063.84 | 1175.21 | 61.6% | operator |
| 30597 | Sort | 2945.86 | 1127.81 | 61.7% | operator |
| 30598 | Aggregate | 2945.82 | 1073.15 | 63.6% | operator |
| 30599 | Gather Merge | 2945.80 | 1073.95 | 63.5% | operator |
| 30600 | Incremental Sort | 2926.11 | 0.00 | 100.0% | operator |
| 30601 | Nested Loop | 2926.05 | 1111.34 | 62.0% | operator |
| 30602 | Merge Join | 2925.99 | 0.00 | 100.0% | operator |
| 30611 | Index Scan | 0.02 | 0.05 | 96.2% | operator |
| 30603 | Sort | 2856.70 | 1095.58 | 61.6% | operator |
| 30609 | Sort | 66.75 | 1074.66 | 1509.9% | operator |
| 30604 | Hash Join | 2856.68 | 471.07 | 83.5% | pattern |
| 30610 | Seq Scan | 53.97 | 18.25 | 66.2% | operator |
| 30607 | Aggregate | 2635.61 | 1073.15 | 59.3% | operator |
| 30608 | Index Scan | 2123.43 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30608 (Index Scan) - LEAF
...
### Step 3: Node 30604 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30605, 30606
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30610 (Seq Scan) - LEAF
...
### Step 7: Node 30602 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30611 (Index Scan) - LEAF
...
### Step 10: Node 30600 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30599 (Gather Merge)
