...
**Test Query:** Q13_114_seed_927055503
...
```
Node 25475 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25476 (Aggregate) [consumed]
    Node 25477 (Aggregate)
      Node 25478 (Hash Join) [PATTERN: 895c6e8c]
        Node 25479 (Seq Scan) [consumed] - LEAF
        Node 25480 (Hash) [consumed]
          Node 25481 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25475 | 25476, 25478, 25479, 25480 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25478 | 25475, 25476, 25479, 25480 |
...
|------|------|--------|-----------|-----|--------|
| 25475 | Sort | 907.24 | 1079.92 | 19.0% | pattern |
| 25477 | Aggregate | 901.08 | 998.94 | 10.9% | operator |
| 25478 | Hash Join | 686.67 | 470.31 | 31.5% | pattern |
| 25481 | Index Only Scan | 10.58 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25481 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25478 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25475, 25476, 25479, 25480
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1475952
...
### Step 4: Node 25475 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25476, 25478, 25479, 25480
- **Input Features:**
