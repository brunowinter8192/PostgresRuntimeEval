...
**Test Query:** Q5_143_seed_1164972402
...
```
Node 7841 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 7842 (Aggregate) [consumed]
    Node 7843 (Gather Merge) [consumed]
      Node 7844 (Aggregate)
        Node 7845 (Sort) [PATTERN: 3e2d5a00]
          Node 7846 (Hash Join) [consumed]
            Node 7847 (Nested Loop)
              Node 7848 (Hash Join)
                Node 7849 (Seq Scan) - LEAF
                Node 7850 (Hash) [PATTERN: 444761fb]
                  Node 7851 (Hash Join) [consumed]
                    Node 7852 (Seq Scan) [consumed] - LEAF
                    Node 7853 (Hash) [consumed]
                      Node 7854 (Hash Join) [consumed]
                        Node 7855 (Seq Scan) - LEAF
                        Node 7856 (Hash)
                          Node 7857 (Seq Scan) - LEAF
              Node 7858 (Index Scan) - LEAF
            Node 7859 (Hash)
              Node 7860 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 7850 | 7841, 7842, 7843, 7845, 7846, 7851, 7852, 7853, 7854 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 7841 | 7842, 7843, 7845, 7846, 7850, 7851, 7852, 7853, 7854 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 7845 | 7841, 7842, 7843, 7846, 7850, 7851, 7852, 7853, 7854 |
...
|------|------|--------|-----------|-----|--------|
| 7841 | Sort | 1044.07 | 2934.42 | 181.1% | pattern |
| 7844 | Aggregate | 1039.41 | 1128.79 | 8.6% | operator |
| 7845 | Sort | 1039.16 | 1835.90 | 76.7% | pattern |
| 7847 | Nested Loop | 1026.47 | 1188.37 | 15.8% | operator |
| 7859 | Hash | 4.18 | 18.67 | 346.5% | operator |
| 7848 | Hash Join | 215.28 | 253.07 | 17.6% | operator |
| 7858 | Index Scan | 0.07 | -0.22 | 409.9% | operator |
| 7860 | Seq Scan | 3.64 | 12.36 | 239.8% | operator |
| 7849 | Seq Scan | 165.27 | 159.81 | 3.3% | operator |
| 7850 | Hash | 37.22 | 46.85 | 25.9% | pattern |
| 7855 | Seq Scan | 0.01 | 11.81 | 147503.4% | operator |
| 7856 | Hash | 0.06 | 21.05 | 36835.5% | operator |
| 7857 | Seq Scan | 0.05 | 22.93 | 43170.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 7857 (Seq Scan) - LEAF
...
### Step 2: Node 7855 (Seq Scan) - LEAF
...
### Step 4: Node 7849 (Seq Scan) - LEAF
...
### Step 5: Node 7850 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 7841, 7842, 7843, 7845, 7846, 7851, 7852, 7853, 7854
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 7858 (Index Scan) - LEAF
...
### Step 8: Node 7860 (Seq Scan) - LEAF
...
### Step 11: Node 7845 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 7841, 7842, 7843, 7846, 7850, 7851, 7852, 7853, 7854
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 7841 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 7842, 7843, 7845, 7846, 7850, 7851, 7852, 7853, 7854
- **Input Features:**
