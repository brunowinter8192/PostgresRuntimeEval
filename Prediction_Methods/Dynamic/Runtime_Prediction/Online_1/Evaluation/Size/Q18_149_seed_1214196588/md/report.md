...
**Test Query:** Q18_149_seed_1214196588
...
```
Node 29668 (Limit) - ROOT
  Node 29669 (Sort)
    Node 29670 (Aggregate)
      Node 29671 (Gather Merge)
        Node 29672 (Incremental Sort)
          Node 29673 (Nested Loop)
            Node 29674 (Merge Join)
              Node 29675 (Sort)
                Node 29676 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29677 (Seq Scan) [consumed] - LEAF
                  Node 29678 (Hash) [consumed]
                    Node 29679 (Aggregate)
                      Node 29680 (Index Scan) - LEAF
              Node 29681 (Sort)
                Node 29682 (Seq Scan) - LEAF
            Node 29683 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29676 | 29677, 29678 |
...
|------|------|--------|-----------|-----|--------|
| 29668 | Limit | 3041.06 | 1175.21 | 61.4% | operator |
| 29669 | Sort | 2932.22 | 1127.81 | 61.5% | operator |
| 29670 | Aggregate | 2932.18 | 1073.15 | 63.4% | operator |
| 29671 | Gather Merge | 2932.15 | 1073.95 | 63.4% | operator |
| 29672 | Incremental Sort | 2913.75 | 0.00 | 100.0% | operator |
| 29673 | Nested Loop | 2913.71 | 1111.34 | 61.9% | operator |
| 29674 | Merge Join | 2913.65 | 0.00 | 100.0% | operator |
| 29683 | Index Scan | 0.02 | 0.05 | 114.9% | operator |
| 29675 | Sort | 2842.62 | 1095.58 | 61.5% | operator |
| 29681 | Sort | 67.94 | 1074.66 | 1481.7% | operator |
| 29676 | Hash Join | 2842.61 | 471.07 | 83.4% | pattern |
| 29682 | Seq Scan | 54.50 | 18.25 | 66.5% | operator |
| 29679 | Aggregate | 2626.70 | 1073.15 | 59.1% | operator |
| 29680 | Index Scan | 2120.38 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29680 (Index Scan) - LEAF
...
### Step 3: Node 29676 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29677, 29678
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29682 (Seq Scan) - LEAF
...
### Step 7: Node 29674 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29683 (Index Scan) - LEAF
...
### Step 10: Node 29672 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29671 (Gather Merge)
