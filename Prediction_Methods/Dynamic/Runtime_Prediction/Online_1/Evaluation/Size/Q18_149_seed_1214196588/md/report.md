        ...
        Node 29672 (Incremental Sort)
          Node 29673 (Nested Loop)
            Node 29674 (Merge Join)
              Node 29675 (Sort)
                Node 29676 (Hash Join)
                  Node 29677 (Seq Scan) - LEAF
                  Node 29678 (Hash)
...
| 29675 | Sort | 2842.62 | 1099.77 | 61.3% | operator |
| 29681 | Sort | 67.94 | 1074.66 | 1481.7% | operator |
| 29676 | Hash Join | 2842.61 | 686.33 | 75.9% | operator |
| 29682 | Seq Scan | 54.50 | 18.25 | 66.5% | operator |
| 29677 | Seq Scan | 184.53 | 170.37 | 7.7% | operator |
| 29678 | Hash | 2626.75 | 21.04 | 99.2% | operator |
...
### Step 3: Node 29677 (Seq Scan) - LEAF
...
### Step 6: Node 29682 (Seq Scan) - LEAF
...
### Step 9: Node 29674 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29683 (Index Scan) - LEAF
...
### Step 11: Node 29673 (Nested Loop)
...
### Step 12: Node 29672 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29671 (Gather Merge)
