...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 21021 | 21022, 21023, 21024, 21026, 21027, 21030 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 21026 | 21021, 21022, 21023, 21024, 21027, 21030 |
...
|------|------|--------|-----------|-----|--------|
| 21021 | Limit | 1132.21 | 1199.47 | 5.9% | pattern |
| 21025 | Hash Join | 1088.60 | 1095.57 | 0.6% | operator |
| 21026 | Hash Join | 1085.75 | 1120.19 | 3.2% | pattern |
| 21032 | Hash | 0.01 | 15.71 | 112119.8% | operator |
| 21033 | Seq Scan | 0.01 | 6.98 | 69687.0% | operator |
| 21028 | Seq Scan | 165.10 | 159.74 | 3.2% | operator |
| 21029 | Index Scan | 0.06 | -0.52 | 935.9% | operator |
| 21031 | Seq Scan | 27.82 | 26.64 | 4.2% | operator |
...
- **Consumes:** Nodes 21021, 21022, 21023, 21024, 21027, 21030
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18240
  - HashJoin_nt1=18240
...
### Step 8: Node 21021 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 21022, 21023, 21024, 21026, 21027, 21030
- **Input Features:**
