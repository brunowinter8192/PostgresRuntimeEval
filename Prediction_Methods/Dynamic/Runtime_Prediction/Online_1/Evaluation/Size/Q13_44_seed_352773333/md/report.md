...
**Test Query:** Q13_44_seed_352773333
...
```
Node 25986 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25987 (Aggregate) [consumed]
    Node 25988 (Aggregate)
      Node 25989 (Hash Join) [PATTERN: 895c6e8c]
        Node 25990 (Seq Scan) [consumed] - LEAF
        Node 25991 (Hash) [consumed]
          Node 25992 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25986 | 25987, 25989, 25990, 25991 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25989 | 25986, 25987, 25990, 25991 |
...
|------|------|--------|-----------|-----|--------|
| 25986 | Sort | 929.35 | 1079.93 | 16.2% | pattern |
| 25988 | Aggregate | 923.38 | 999.55 | 8.2% | operator |
| 25989 | Hash Join | 700.43 | 470.31 | 32.9% | pattern |
| 25992 | Index Only Scan | 9.77 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25992 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25989 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25986, 25987, 25990, 25991
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1484970
...
### Step 4: Node 25986 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25987, 25989, 25990, 25991
- **Input Features:**
