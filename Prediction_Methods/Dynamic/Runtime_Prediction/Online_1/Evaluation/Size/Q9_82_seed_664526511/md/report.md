...
**Test Query:** Q9_82_seed_664526511
...
```
Node 19007 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 19008 (Aggregate) [consumed]
    Node 19009 (Gather)
      Node 19010 (Aggregate)
        Node 19011 (Nested Loop)
          Node 19012 (Hash Join) [PATTERN: bb930825]
            Node 19013 (Seq Scan) [consumed] - LEAF
            Node 19014 (Hash) [consumed]
              Node 19015 (Hash Join) [consumed]
                Node 19016 (Hash Join)
                  Node 19017 (Nested Loop)
                    Node 19018 (Seq Scan) - LEAF
                    Node 19019 (Index Scan) - LEAF
                  Node 19020 (Hash)
                    Node 19021 (Seq Scan) - LEAF
                Node 19022 (Hash)
                  Node 19023 (Seq Scan) - LEAF
          Node 19024 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 19012 | 19007, 19008, 19013, 19014, 19015 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 19007 | 19008, 19012, 19013, 19014, 19015 |
...
|------|------|--------|-----------|-----|--------|
| 19007 | Sort | 1198.97 | 1044.54 | 12.9% | pattern |
| 19009 | Gather | 1197.47 | 965.01 | 19.4% | operator |
| 19010 | Aggregate | 1177.43 | 1129.15 | 4.1% | operator |
| 19011 | Nested Loop | 1151.91 | 1252.17 | 8.7% | operator |
| 19012 | Hash Join | 975.83 | 134.80 | 86.2% | pattern |
| 19024 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 19016 | Hash Join | 168.22 | 837.52 | 397.9% | operator |
| 19022 | Hash | 13.54 | 14.95 | 10.4% | operator |
| 19017 | Nested Loop | 161.67 | 1251.76 | 674.3% | operator |
| 19020 | Hash | 4.34 | 15.94 | 267.0% | operator |
| 19023 | Seq Scan | 13.53 | 2.94 | 78.3% | operator |
| 19018 | Seq Scan | 19.29 | 44.23 | 129.3% | operator |
| 19019 | Index Scan | 0.08 | -1.39 | 1903.2% | operator |
| 19021 | Seq Scan | 3.74 | 9.45 | 152.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 19018 (Seq Scan) - LEAF
...
### Step 2: Node 19019 (Index Scan) - LEAF
...
### Step 3: Node 19021 (Seq Scan) - LEAF
...
### Step 6: Node 19023 (Seq Scan) - LEAF
...
### Step 9: Node 19012 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 19007, 19008, 19013, 19014, 19015
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 19024 (Index Scan) - LEAF
...
### Step 11: Node 19011 (Nested Loop)
...
### Step 14: Node 19007 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 19008, 19012, 19013, 19014, 19015
- **Input Features:**
