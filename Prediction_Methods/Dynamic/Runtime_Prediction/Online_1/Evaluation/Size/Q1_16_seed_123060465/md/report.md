...
**Test Query:** Q1_16_seed_123060465
**Timestamp:** 2026-01-18 16:00:47
...
```
Node 286 (Aggregate) - ROOT
  Node 287 (Gather Merge)
    Node 288 (Sort) [PATTERN: 1d35fb97]
      Node 289 (Aggregate) [consumed]
        Node 290 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 288 | 289 |
...
|------|------|--------|-----------|-----|--------|
| 286 | Aggregate | 935.22 | 1195.94 | 27.9% | operator |
| 287 | Gather Merge | 935.16 | 1165.92 | 24.7% | operator |
| 288 | Sort | 914.95 | 1200.71 | 31.2% | pattern |
| 290 | Seq Scan | 499.14 | 679.47 | 36.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 290 (Seq Scan) - LEAF
...
- **Output:** st=0.85, rt=679.47

### Step 2: Node 288 (Sort) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Aggregate_Outer_total_cost=169103.7900
  - Sort_np=0
  - Sort_nt=6
  - Sort_nt1=6
  - Sort_nt2=0
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=169103.8700
  - Sort_total_cost=169103.8900
- **Output:** st=1196.62, rt=1200.71

### Step 3: Node 287 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1196.6159
  - st2=0.0000
  - startup_cost=170103.9500
  - total_cost=170107.5800
- **Output:** st=1161.80, rt=1165.92

### Step 4: Node 286 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=170103.9500
  - total_cost=170108.7200
- **Output:** st=1149.92, rt=1195.94
