...
```
Node 25783 (Sort) - ROOT
  Node 25784 (Aggregate)
    Node 25785 (Aggregate)
      Node 25786 (Hash Join)
        Node 25787 (Seq Scan) - LEAF
        Node 25788 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 25783 | Sort | 891.22 | 1081.93 | 21.4% | operator |
| 25784 | Aggregate | 891.20 | 1000.33 | 12.2% | operator |
| 25785 | Aggregate | 885.09 | 1014.39 | 14.6% | operator |
| 25786 | Hash Join | 672.87 | 787.83 | 17.1% | operator |
| 25787 | Seq Scan | 465.94 | 264.19 | 43.3% | operator |
| 25788 | Hash | 15.34 | 80.15 | 422.5% | operator |
...
### Step 2: Node 25787 (Seq Scan) - LEAF
