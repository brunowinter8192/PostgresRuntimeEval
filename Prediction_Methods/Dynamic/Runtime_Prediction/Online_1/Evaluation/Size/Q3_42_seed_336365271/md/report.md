...
**Test Query:** Q3_42_seed_336365271
...
```
Node 5211 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5212 (Sort) [consumed]
    Node 5213 (Aggregate) [consumed]
      Node 5214 (Gather) [consumed]
        Node 5215 (Nested Loop)
          Node 5216 (Hash Join) [PATTERN: 895c6e8c]
            Node 5217 (Seq Scan) [consumed] - LEAF
            Node 5218 (Hash) [consumed]
              Node 5219 (Seq Scan) - LEAF
          Node 5220 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5211 | 5212, 5213, 5214, 5216, 5217, 5218 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5216 | 5211, 5212, 5213, 5214, 5217, 5218 |
...
|------|------|--------|-----------|-----|--------|
| 5211 | Limit | 1231.19 | 1151.18 | 6.5% | pattern |
| 5215 | Nested Loop | 1195.90 | 1192.75 | 0.3% | operator |
| 5216 | Hash Join | 213.85 | 242.42 | 13.4% | pattern |
| 5220 | Index Scan | 0.03 | -0.52 | 2018.8% | operator |
| 5219 | Seq Scan | 31.33 | 38.57 | 23.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5219 (Seq Scan) - LEAF
...
### Step 2: Node 5216 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5211, 5212, 5213, 5214, 5217, 5218
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46457
  - HashJoin_nt1=232682
  ...
  - HashJoin_total_cost=37332.4400
  - Hash_Inner_np=0
  - Hash_Inner_nt=12479
...
### Step 3: Node 5220 (Index Scan) - LEAF
...
- **Output:** st=121.51, rt=1192.75

### Step 5: Node 5211 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5212, 5213, 5214, 5216, 5217, 5218
- **Input Features:**
