...
```
Node 5893 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 5894 (Gather Merge) [consumed]
    Node 5895 (Sort) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 5893 | 5894, 5895, 5896 |
...
|------|------|--------|-----------|-----|--------|
| 5893 | Aggregate | 1038.13 | 952.19 | 8.3% | pattern |
| 5897 | Nested Loop | 1031.34 | 1255.45 | 21.7% | operator |
| 5898 | Seq Scan | 160.82 | 154.66 | 3.8% | operator |
| 5899 | Index Scan | 0.06 | 11.10 | 18103.9% | operator |
