...
```
Node 26413 (Sort) - ROOT
  Node 26414 (Aggregate)
    Node 26415 (Aggregate)
      Node 26416 (Hash Join)
        Node 26417 (Seq Scan) - LEAF
        Node 26418 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 26413 | Sort | 910.84 | 1081.93 | 18.8% | operator |
| 26414 | Aggregate | 910.80 | 1000.33 | 9.8% | operator |
| 26415 | Aggregate | 904.69 | 1014.39 | 12.1% | operator |
| 26416 | Hash Join | 694.76 | 787.83 | 13.4% | operator |
| 26417 | Seq Scan | 482.79 | 264.19 | 45.3% | operator |
| 26418 | Hash | 14.92 | 80.15 | 437.2% | operator |
...
### Step 2: Node 26417 (Seq Scan) - LEAF
