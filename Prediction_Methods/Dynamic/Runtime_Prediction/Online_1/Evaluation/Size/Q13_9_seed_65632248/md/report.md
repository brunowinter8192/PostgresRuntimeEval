...
**Test Query:** Q13_9_seed_65632248
...
```
Node 26413 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26414 (Aggregate) [consumed]
    Node 26415 (Aggregate)
      Node 26416 (Hash Join) [PATTERN: 895c6e8c]
        Node 26417 (Seq Scan) [consumed] - LEAF
        Node 26418 (Hash) [consumed]
          Node 26419 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26413 | 26414, 26416, 26417, 26418 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26416 | 26413, 26414, 26417, 26418 |
...
|------|------|--------|-----------|-----|--------|
| 26413 | Sort | 910.84 | 1079.94 | 18.6% | pattern |
| 26415 | Aggregate | 904.69 | 999.76 | 10.5% | operator |
| 26416 | Hash Join | 694.76 | 470.31 | 32.3% | pattern |
| 26419 | Index Only Scan | 9.59 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26419 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26416 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26413, 26414, 26417, 26418
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 26413 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26414, 26416, 26417, 26418
- **Input Features:**
