...
**Test Query:** Q14_93_seed_754770852
...
```
Node 27414 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27415 (Gather) [consumed]
    Node 27416 (Aggregate) [consumed]
      Node 27417 (Hash Join)
        Node 27418 (Seq Scan) - LEAF
        Node 27419 (Hash)
          Node 27420 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27414 | 27415, 27416 |
...
|------|------|--------|-----------|-----|--------|
| 27414 | Aggregate | 825.49 | 848.32 | 2.8% | pattern |
| 27417 | Hash Join | 802.14 | 807.55 | 0.7% | operator |
| 27418 | Seq Scan | 752.43 | 758.41 | 0.8% | operator |
| 27419 | Hash | 42.40 | 9.38 | 77.9% | operator |
| 27420 | Seq Scan | 37.83 | 12.70 | 66.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27420 (Seq Scan) - LEAF
...
### Step 2: Node 27418 (Seq Scan) - LEAF
...
- **Output:** st=6.82, rt=758.41

### Step 3: Node 27419 (Hash)
...
- **Input Features:**
  ...
  - total_cost=136641.3600
- **Output:** st=78.54, rt=807.55

### Step 5: Node 27414 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27415, 27416
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=13226
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=64
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0001
  - Aggregate_Outer_startup_cost=136872.8200
  - Aggregate_Outer_total_cost=136872.8300
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=137873.3800
  - Aggregate_total_cost=137873.4000
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=137872.8200
  - Gather_Outer_total_cost=137873.3300
- **Output:** st=842.82, rt=848.32
