...
```
Node 27414 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27415 (Gather) [consumed]
    Node 27416 (Aggregate) [consumed]
      Node 27417 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27414 | 27415, 27416, 27417 |
...
|------|------|--------|-----------|-----|--------|
| 27414 | Aggregate | 825.49 | 857.10 | 3.8% | pattern |
...
### Step 4: Node 27414 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27415, 27416, 27417
- **Input Features:**
