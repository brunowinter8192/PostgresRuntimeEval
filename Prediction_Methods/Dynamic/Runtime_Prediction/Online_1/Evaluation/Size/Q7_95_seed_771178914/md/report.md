...
**Test Query:** Q7_95_seed_771178914
...
```
Node 13093 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 13094 (Gather Merge) [consumed]
    Node 13095 (Sort)
      Node 13096 (Hash Join)
        Node 13097 (Nested Loop)
          Node 13098 (Hash Join) [PATTERN: 895c6e8c]
            Node 13099 (Seq Scan) [consumed] - LEAF
            Node 13100 (Hash) [consumed]
              Node 13101 (Hash Join) [PATTERN: f4cb205a]
                Node 13102 (Seq Scan) [consumed] - LEAF
                Node 13103 (Hash) [consumed]
                  Node 13104 (Seq Scan) [consumed] - LEAF
          Node 13105 (Index Scan) - LEAF
        Node 13106 (Hash)
          Node 13107 (Hash Join) [PATTERN: f4cb205a]
            Node 13108 (Seq Scan) [consumed] - LEAF
            Node 13109 (Hash) [consumed]
              Node 13110 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 13101 | 13093, 13094, 13098, 13099, 13100, 13102, 13103, 13104, 13107, 13108, 13109, 13110 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 13107 | 13093, 13094, 13098, 13099, 13100, 13101, 13102, 13103, 13104, 13108, 13109, 13110 |
| Aggregate -> Gather Merge (Out | 2724c080 | 13093 | 13094, 13098, 13099, 13100, 13101, 13102, 13103, 13104, 13107, 13108, 13109, 13110 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 13098 | 13093, 13094, 13099, 13100, 13101, 13102, 13103, 13104, 13107, 13108, 13109, 13110 |
...
|------|------|--------|-----------|-----|--------|
| 13093 | Aggregate | 1192.47 | 1163.13 | 2.5% | pattern |
| 13095 | Sort | 1184.67 | 1109.16 | 6.4% | operator |
| 13096 | Hash Join | 1184.02 | 843.11 | 28.8% | operator |
| 13097 | Nested Loop | 1175.72 | 1215.99 | 3.4% | operator |
| 13106 | Hash | 4.54 | 27.74 | 511.1% | operator |
| 13098 | Hash Join | 210.81 | 304.89 | 44.6% | pattern |
| 13105 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 13107 | Hash Join | 4.49 | 429.36 | 9456.3% | pattern |
| 13101 | Hash Join | 35.47 | 429.38 | 1110.5% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 13101 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 13093, 13094, 13098, 13099, 13100, 13102, 13103, 13104, 13107, 13108, 13109, 13110
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5000
  - HashJoin_nt1=62500
...
### Step 2: Node 13098 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 13093, 13094, 13099, 13100, 13101, 13102, 13103, 13104, 13107, 13108, 13109, 13110
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=38710
  - HashJoin_nt1=483871
...
### Step 3: Node 13105 (Index Scan) - LEAF
...
### Step 4: Node 13107 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 13093, 13094, 13098, 13099, 13100, 13101, 13102, 13103, 13104, 13108, 13109, 13110
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=800
  - HashJoin_nt1=10000
...
### Step 9: Node 13093 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 13094, 13098, 13099, 13100, 13101, 13102, 13103, 13104, 13107, 13108, 13109, 13110
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
