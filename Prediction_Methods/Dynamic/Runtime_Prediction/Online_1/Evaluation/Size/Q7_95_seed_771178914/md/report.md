...
```
Node 13093 (Aggregate) - ROOT
  Node 13094 (Gather Merge)
    Node 13095 (Sort)
      Node 13096 (Hash Join)
        Node 13097 (Nested Loop)
          Node 13098 (Hash Join)
            Node 13099 (Seq Scan) - LEAF
            Node 13100 (Hash)
              Node 13101 (Hash Join)
                Node 13102 (Seq Scan) - LEAF
                Node 13103 (Hash)
                  Node 13104 (Seq Scan) - LEAF
          Node 13105 (Index Scan) - LEAF
        Node 13106 (Hash)
          Node 13107 (Hash Join)
            Node 13108 (Seq Scan) - LEAF
            Node 13109 (Hash)
              Node 13110 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 13093 | Aggregate | 1192.47 | 1209.26 | 1.4% | operator |
| 13094 | Gather Merge | 1191.29 | 1142.98 | 4.1% | operator |
| 13095 | Sort | 1184.67 | 1109.13 | 6.4% | operator |
| 13096 | Hash Join | 1184.02 | 842.59 | 28.8% | operator |
| 13097 | Nested Loop | 1175.72 | 1216.16 | 3.4% | operator |
| 13106 | Hash | 4.54 | 17.53 | 286.1% | operator |
| 13098 | Hash Join | 210.81 | 384.47 | 82.4% | operator |
| 13105 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 13107 | Hash Join | 4.49 | 85.17 | 1795.7% | operator |
| 13099 | Seq Scan | 149.37 | 201.16 | 34.7% | operator |
| 13100 | Hash | 35.82 | 19.59 | 45.3% | operator |
| 13108 | Seq Scan | 4.16 | 11.47 | 175.8% | operator |
| 13109 | Hash | 0.01 | 16.89 | 129854.5% | operator |
| 13101 | Hash Join | 35.47 | 92.20 | 159.9% | operator |
| 13110 | Seq Scan | 0.01 | 45.79 | 457823.2% | operator |
| 13102 | Seq Scan | 34.32 | 21.86 | 36.3% | operator |
| 13103 | Hash | 0.01 | 16.89 | 129854.5% | operator |
| 13104 | Seq Scan | 0.01 | 45.79 | 416193.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 13104 (Seq Scan) - LEAF
...
### Step 2: Node 13102 (Seq Scan) - LEAF
...
### Step 5: Node 13110 (Seq Scan) - LEAF
...
### Step 6: Node 13099 (Seq Scan) - LEAF
...
### Step 8: Node 13108 (Seq Scan) - LEAF
...
### Step 11: Node 13105 (Index Scan) - LEAF
...
### Step 13: Node 13097 (Nested Loop)
...
### Step 17: Node 13094 (Gather Merge)
...
### Step 18: Node 13093 (Aggregate) - ROOT
