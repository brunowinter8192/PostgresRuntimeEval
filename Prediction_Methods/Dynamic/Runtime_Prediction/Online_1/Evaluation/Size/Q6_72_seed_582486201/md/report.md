...
**Test Query:** Q6_72_seed_582486201
...
```
Node 10377 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10378 (Gather) [consumed]
    Node 10379 (Aggregate) [consumed]
      Node 10380 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10377 | 10378, 10379 |
...
|------|------|--------|-----------|-----|--------|
| 10377 | Aggregate | 796.16 | 850.04 | 6.8% | pattern |
| 10380 | Seq Scan | 774.95 | 748.53 | 3.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10380 (Seq Scan) - LEAF
...
### Step 2: Node 10377 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10378, 10379
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=23539
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=32
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=139723.1700
  - Aggregate_Outer_total_cost=139723.1800
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=140723.7000
  - Aggregate_total_cost=140723.7100
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=140723.1700
  - Gather_Outer_total_cost=140723.6800
- **Output:** st=844.44, rt=850.04
