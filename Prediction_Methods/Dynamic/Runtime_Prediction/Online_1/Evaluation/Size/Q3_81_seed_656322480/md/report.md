    ...
    Node 5643 (Aggregate) [consumed]
      Node 5644 (Gather) [consumed]
        Node 5645 (Nested Loop)
          Node 5646 (Hash Join) [PATTERN: 895c6e8c]
            Node 5647 (Seq Scan) [consumed] - LEAF
            Node 5648 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5641 | 5642, 5643, 5644, 5646, 5647, 5648 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5646 | 5641, 5642, 5643, 5644, 5647, 5648 |
...
| 5645 | Nested Loop | 1158.88 | 1192.82 | 2.9% | operator |
| 5646 | Hash Join | 207.71 | 242.43 | 16.7% | pattern |
...
### Step 2: Node 5646 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5641, 5642, 5643, 5644, 5647, 5648
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46565
  - HashJoin_nt1=234768
...
- **Output:** st=29.75, rt=242.43

### Step 3: Node 5650 (Index Scan) - LEAF
...
- **Output:** st=121.60, rt=1192.82

### Step 5: Node 5641 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5642, 5643, 5644, 5646, 5647, 5648
- **Input Features:**
