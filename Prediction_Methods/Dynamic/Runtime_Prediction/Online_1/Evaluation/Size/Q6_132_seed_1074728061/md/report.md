...
**Test Query:** Q6_132_seed_1074728061
...
```
Node 10041 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10042 (Gather) [consumed]
    Node 10043 (Aggregate) [consumed]
      Node 10044 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10041 | 10042, 10043 |
...
|------|------|--------|-----------|-----|--------|
| 10041 | Aggregate | 810.19 | 849.98 | 4.9% | pattern |
| 10044 | Seq Scan | 789.57 | 748.49 | 5.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10044 (Seq Scan) - LEAF
...
### Step 2: Node 10041 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10042, 10043
- **Input Features:**
