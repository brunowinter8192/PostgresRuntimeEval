...
```
Node 30036 (Limit) - ROOT
  Node 30037 (Sort)
    Node 30038 (Aggregate)
      Node 30039 (Gather Merge)
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30044 | 30045, 30046 |
...
|------|------|--------|-----------|-----|--------|
| 30036 | Limit | 3054.59 | 1175.21 | 61.5% | operator |
| 30037 | Sort | 2943.20 | 1127.81 | 61.7% | operator |
| 30038 | Aggregate | 2943.15 | 1073.15 | 63.5% | operator |
| 30039 | Gather Merge | 2943.13 | 1073.95 | 63.5% | operator |
| 30040 | Incremental Sort | 2922.34 | 0.00 | 100.0% | operator |
| 30041 | Nested Loop | 2922.30 | 1111.34 | 62.0% | operator |
| 30042 | Merge Join | 2922.20 | 0.00 | 100.0% | operator |
| 30051 | Index Scan | 0.04 | 0.05 | 18.8% | operator |
| 30043 | Sort | 2854.66 | 1095.58 | 61.6% | operator |
| 30049 | Sort | 65.22 | 1074.66 | 1547.7% | operator |
| 30044 | Hash Join | 2854.65 | 471.07 | 83.5% | pattern |
| 30050 | Seq Scan | 52.21 | 18.25 | 65.1% | operator |
| 30047 | Aggregate | 2643.82 | 1073.15 | 59.4% | operator |
| 30048 | Index Scan | 2146.90 | 0.00 | 100.0% | operator |
...
### Step 10: Node 30040 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30039 (Gather Merge)
