...
**Test Query:** Q4_100_seed_812199069
...
```
Node 5851 (Aggregate) [PATTERN: f8231c4d] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 5851 | 5852, 5853, 5854 |
...
|------|------|--------|-----------|-----|--------|
| 5851 | Aggregate | 1061.90 | 952.19 | 10.3% | pattern |
| 5855 | Nested Loop | 1055.34 | 1255.45 | 19.0% | operator |
| 5856 | Seq Scan | 165.09 | 154.66 | 6.3% | operator |
| 5857 | Index Scan | 0.06 | 11.10 | 17526.0% | operator |
...
### Step 4: Node 5851 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f8231c4d (Aggregate -> Gather Merge -> Sort -> Aggregate (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5852, 5853, 5854
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=5
  - Aggregate_Outer_nt1=14866
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=24
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0003
  - Aggregate_Outer_startup_cost=65870.8800
  - Aggregate_Outer_total_cost=65870.9300
  - Aggregate_np=0
  - Aggregate_nt=5
  - Aggregate_nt1=15
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=66871.0300
  - Aggregate_total_cost=66872.9300
  ...
  - GatherMerge_Outer_startup_cost=66871.0300
  - GatherMerge_Outer_total_cost=66872.8000
  - Sort_Outer_np=0
  - Sort_Outer_nt=5
  - Sort_Outer_nt1=5
  - Sort_Outer_nt2=0
  ...
  - Sort_Outer_startup_cost=65870.9900
  - Sort_Outer_total_cost=65871.0000
