...
```
Node 26707 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26708 (Gather) [consumed]
    Node 26709 (Aggregate) [consumed]
      Node 26710 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26707 | 26708, 26709, 26710 |
...
|------|------|--------|-----------|-----|--------|
| 26707 | Aggregate | 833.02 | 857.14 | 2.9% | pattern |
...
### Step 4: Node 26707 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26708, 26709, 26710
- **Input Features:**
