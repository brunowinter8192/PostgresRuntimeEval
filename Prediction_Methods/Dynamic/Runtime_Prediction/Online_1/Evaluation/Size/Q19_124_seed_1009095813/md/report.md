...
```
Node 31402 (Aggregate) [PATTERN: efde8b38] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31402 | 31403, 31404, 31405 |
...
|------|------|--------|-----------|-----|--------|
| 31402 | Aggregate | 848.21 | 829.31 | 2.2% | pattern |
| 31406 | Seq Scan | 775.85 | 743.46 | 4.2% | operator |
| 31407 | Hash | 50.59 | 8.29 | 83.6% | operator |
| 31408 | Seq Scan | 50.46 | 23.76 | 52.9% | operator |
...
### Step 4: Node 31402 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31403, 31404, 31405
- **Input Features:**
