...
**Test Query:** Q4_37_seed_295345116
...
```
Node 6411 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6412 (Gather Merge) [consumed]
    Node 6413 (Sort) [consumed]
      Node 6414 (Aggregate) [consumed]
        Node 6415 (Nested Loop)
          Node 6416 (Seq Scan) - LEAF
          Node 6417 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6411 | 6412, 6413, 6414 |
...
|------|------|--------|-----------|-----|--------|
| 6411 | Aggregate | 1035.01 | 952.19 | 8.0% | pattern |
| 6415 | Nested Loop | 1027.66 | 1255.45 | 22.2% | operator |
| 6416 | Seq Scan | 163.90 | 154.67 | 5.6% | operator |
| 6417 | Index Scan | 0.06 | 11.10 | 18407.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6416 (Seq Scan) - LEAF
...
### Step 2: Node 6417 (Index Scan) - LEAF
