...
**Test Query:** Q4_140_seed_1140360309
...
```
Node 6159 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6160 (Gather Merge) [consumed]
    Node 6161 (Sort) [consumed]
      Node 6162 (Aggregate) [consumed]
        Node 6163 (Nested Loop)
          Node 6164 (Seq Scan) - LEAF
          Node 6165 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6159 | 6160, 6161, 6162 |
...
|------|------|--------|-----------|-----|--------|
| 6159 | Aggregate | 1084.26 | 952.19 | 12.2% | pattern |
| 6163 | Nested Loop | 1077.71 | 1255.45 | 16.5% | operator |
| 6164 | Seq Scan | 169.04 | 154.66 | 8.5% | operator |
| 6165 | Index Scan | 0.06 | 11.10 | 17526.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6164 (Seq Scan) - LEAF
...
### Step 2: Node 6165 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - Sort_Outer_startup_cost=66113.2600
  - Sort_Outer_total_cost=66113.2700
