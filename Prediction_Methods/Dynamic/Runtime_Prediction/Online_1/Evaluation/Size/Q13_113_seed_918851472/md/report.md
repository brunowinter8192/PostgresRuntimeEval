...
```
Node 25468 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25469 (Aggregate) [consumed]
    Node 25470 (Aggregate)
      Node 25471 (Hash Join) [PATTERN: 895c6e8c]
        Node 25472 (Seq Scan) [consumed] - LEAF
        Node 25473 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25468 | 25469, 25471, 25472, 25473 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25471 | 25468, 25469, 25472, 25473 |
...
|------|------|--------|-----------|-----|--------|
| 25468 | Sort | 916.60 | 1079.93 | 17.8% | pattern |
| 25470 | Aggregate | 910.44 | 999.55 | 9.8% | operator |
| 25471 | Hash Join | 695.19 | 470.31 | 32.3% | pattern |
...
### Step 2: Node 25471 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25468, 25469, 25472, 25473
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1484970
...
### Step 4: Node 25468 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25469, 25471, 25472, 25473
- **Input Features:**
