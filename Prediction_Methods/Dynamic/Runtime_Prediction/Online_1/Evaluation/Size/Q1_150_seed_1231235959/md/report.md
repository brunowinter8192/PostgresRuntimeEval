...
Node 276 (Aggregate) - ROOT
  Node 277 (Gather Merge)
    Node 278 (Sort) [PATTERN: 1d35fb97]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 278 | 279 |
...
|------|------|--------|-----------|-----|--------|
| 276 | Aggregate | 932.49 | 1195.82 | 28.2% | operator |
| 277 | Gather Merge | 932.44 | 1165.89 | 25.0% | operator |
| 278 | Sort | 912.54 | 1200.25 | 31.5% | pattern |
...
### Step 2: Node 278 (Sort) - PATTERN ROOT
...
### Step 4: Node 276 (Aggregate) - ROOT
