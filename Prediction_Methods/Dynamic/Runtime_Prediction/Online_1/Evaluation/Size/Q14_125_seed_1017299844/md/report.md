...
**Test Query:** Q14_125_seed_1017299844
...
```
Node 26609 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26610 (Gather) [consumed]
    Node 26611 (Aggregate) [consumed]
      Node 26612 (Hash Join) [consumed]
        Node 26613 (Seq Scan) - LEAF
        Node 26614 (Hash)
          Node 26615 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26609 | 26610, 26611, 26612 |
...
|------|------|--------|-----------|-----|--------|
| 26609 | Aggregate | 858.11 | 857.13 | 0.1% | pattern |
| 26613 | Seq Scan | 781.13 | 758.49 | 2.9% | operator |
| 26614 | Hash | 45.15 | 9.38 | 79.2% | operator |
| 26615 | Seq Scan | 39.12 | 12.70 | 67.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26615 (Seq Scan) - LEAF
...
### Step 2: Node 26613 (Seq Scan) - LEAF
...
### Step 4: Node 26609 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26610, 26611, 26612
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=15275
  - HashJoin_Outer_nt1=15275
  ...
  - HashJoin_Outer_total_cost=136646.7400
