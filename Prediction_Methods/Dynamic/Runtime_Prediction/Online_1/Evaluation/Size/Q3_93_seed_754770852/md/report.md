...
**Test Query:** Q3_93_seed_754770852
...
```
Node 5771 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5772 (Sort) [consumed]
    Node 5773 (Aggregate) [consumed]
      Node 5774 (Gather) [consumed]
        Node 5775 (Nested Loop)
          Node 5776 (Hash Join) [PATTERN: 895c6e8c]
            Node 5777 (Seq Scan) [consumed] - LEAF
            Node 5778 (Hash) [consumed]
              Node 5779 (Seq Scan) - LEAF
          Node 5780 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5771 | 5772, 5773, 5774, 5776, 5777, 5778 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5776 | 5771, 5772, 5773, 5774, 5777, 5778 |
...
|------|------|--------|-----------|-----|--------|
| 5771 | Limit | 1230.14 | 1151.18 | 6.4% | pattern |
| 5775 | Nested Loop | 1195.31 | 1193.17 | 0.2% | operator |
| 5776 | Hash Join | 207.27 | 242.50 | 17.0% | pattern |
| 5780 | Index Scan | 0.03 | -0.52 | 2018.8% | operator |
| 5779 | Seq Scan | 28.05 | 38.57 | 37.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5779 (Seq Scan) - LEAF
...
### Step 2: Node 5776 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5771, 5772, 5773, 5774, 5777, 5778
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47101
  - HashJoin_nt1=235905
  ...
  - HashJoin_total_cost=37340.9000
  - Hash_Inner_np=0
  - Hash_Inner_nt=12479
...
### Step 3: Node 5780 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=72978.5600
- **Output:** st=121.92, rt=1193.17

### Step 5: Node 5771 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5772, 5773, 5774, 5776, 5777, 5778
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=313598
  - Aggregate_Outer_nt1=313598
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110042.3300
  - Aggregate_Outer_total_cost=113962.3000
  - Gather_Outer_np=0
  - Gather_Outer_nt=313598
  - Gather_Outer_nt1=101161
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105338.3600
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=313598
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=120739.0400
  - Limit_total_cost=120739.0700
  - Sort_Outer_np=0
  - Sort_Outer_nt=313598
  - Sort_Outer_nt1=313598
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=120739.0400
  - Sort_Outer_total_cost=121523.0400
