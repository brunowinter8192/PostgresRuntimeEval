...
**Test Query:** Q18_121_seed_984483720
...
```
Node 29188 (Limit) - ROOT
  Node 29189 (Sort)
    Node 29190 (Aggregate)
      Node 29191 (Gather Merge)
        Node 29192 (Incremental Sort)
          Node 29193 (Nested Loop)
            Node 29194 (Merge Join)
              Node 29195 (Sort)
                Node 29196 (Hash Join)
                  Node 29197 (Seq Scan) - LEAF
                  Node 29198 (Hash)
                    Node 29199 (Aggregate)
                      Node 29200 (Index Scan) - LEAF
              Node 29201 (Sort)
                Node 29202 (Seq Scan) - LEAF
            Node 29203 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 29188 | Limit | 3009.88 | 1175.21 | 61.0% | operator |
| 29189 | Sort | 2893.69 | 1127.81 | 61.0% | operator |
| 29190 | Aggregate | 2893.65 | 1073.15 | 62.9% | operator |
| 29191 | Gather Merge | 2893.64 | 1073.95 | 62.9% | operator |
| 29192 | Incremental Sort | 2869.94 | 0.00 | 100.0% | operator |
| 29193 | Nested Loop | 2869.90 | 1111.34 | 61.3% | operator |
| 29194 | Merge Join | 2869.84 | 0.00 | 100.0% | operator |
| 29203 | Index Scan | 0.02 | 0.05 | 125.7% | operator |
| 29195 | Sort | 2793.77 | 1099.77 | 60.6% | operator |
| 29201 | Sort | 72.62 | 1074.66 | 1379.9% | operator |
| 29196 | Hash Join | 2793.76 | 686.33 | 75.4% | operator |
| 29202 | Seq Scan | 58.84 | 18.25 | 69.0% | operator |
| 29197 | Seq Scan | 190.02 | 170.37 | 10.3% | operator |
| 29198 | Hash | 2574.94 | 21.04 | 99.2% | operator |
| 29199 | Aggregate | 2574.90 | 1073.15 | 58.3% | operator |
| 29200 | Index Scan | 2105.52 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29200 (Index Scan) - LEAF
...
### Step 3: Node 29197 (Seq Scan) - LEAF
...
### Step 6: Node 29202 (Seq Scan) - LEAF
...
### Step 9: Node 29194 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29203 (Index Scan) - LEAF
...
### Step 11: Node 29193 (Nested Loop)
...
### Step 12: Node 29192 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29191 (Gather Merge)
