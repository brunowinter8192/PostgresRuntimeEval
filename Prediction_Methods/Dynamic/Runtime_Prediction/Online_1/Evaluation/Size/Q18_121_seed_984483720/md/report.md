        ...
        Node 29192 (Incremental Sort)
          Node 29193 (Nested Loop)
            Node 29194 (Merge Join)
              Node 29195 (Sort)
                Node 29196 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29197 (Seq Scan) [consumed] - LEAF
                  Node 29198 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29196 | 29197, 29198 |
...
| 29195 | Sort | 2793.77 | 1095.58 | 60.8% | operator |
| 29201 | Sort | 72.62 | 1074.66 | 1379.9% | operator |
| 29196 | Hash Join | 2793.76 | 471.07 | 83.1% | pattern |
...
### Step 3: Node 29196 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29197, 29198
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29202 (Seq Scan) - LEAF
...
### Step 7: Node 29194 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29203 (Index Scan) - LEAF
...
### Step 10: Node 29192 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29191 (Gather Merge)
