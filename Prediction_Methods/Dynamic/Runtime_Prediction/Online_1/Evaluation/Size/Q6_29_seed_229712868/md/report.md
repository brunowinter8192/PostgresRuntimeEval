...
**Test Query:** Q6_29_seed_229712868
...
```
Node 10185 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10186 (Gather) [consumed]
    Node 10187 (Aggregate) [consumed]
      Node 10188 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10185 | 10186, 10187 |
...
|------|------|--------|-----------|-----|--------|
| 10185 | Aggregate | 786.00 | 850.05 | 8.1% | pattern |
| 10188 | Seq Scan | 765.73 | 748.53 | 2.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10188 (Seq Scan) - LEAF
...
### Step 2: Node 10185 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10186, 10187
- **Input Features:**
