...
**Test Query:** Q5_107_seed_869627286
...
```
Node 7041 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 7042 (Aggregate) [consumed]
    Node 7043 (Gather Merge) [consumed]
      Node 7044 (Aggregate)
        Node 7045 (Sort) [PATTERN: 3e2d5a00]
          Node 7046 (Hash Join) [consumed]
            Node 7047 (Nested Loop)
              Node 7048 (Hash Join)
                Node 7049 (Seq Scan) - LEAF
                Node 7050 (Hash) [PATTERN: 444761fb]
                  Node 7051 (Hash Join) [consumed]
                    Node 7052 (Seq Scan) [consumed] - LEAF
                    Node 7053 (Hash) [consumed]
                      Node 7054 (Hash Join) [consumed]
                        Node 7055 (Seq Scan) - LEAF
                        Node 7056 (Hash)
                          Node 7057 (Seq Scan) - LEAF
              Node 7058 (Index Scan) - LEAF
            Node 7059 (Hash)
              Node 7060 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 7050 | 7041, 7042, 7043, 7045, 7046, 7051, 7052, 7053, 7054 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 7041 | 7042, 7043, 7045, 7046, 7050, 7051, 7052, 7053, 7054 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 7045 | 7041, 7042, 7043, 7046, 7050, 7051, 7052, 7053, 7054 |
...
|------|------|--------|-----------|-----|--------|
| 7041 | Sort | 1043.18 | 2934.42 | 181.3% | pattern |
| 7044 | Aggregate | 1038.00 | 1128.76 | 8.7% | operator |
| 7045 | Sort | 1037.75 | 1835.93 | 76.9% | pattern |
| 7047 | Nested Loop | 1026.51 | 1188.47 | 15.8% | operator |
| 7059 | Hash | 2.73 | 18.67 | 584.9% | operator |
| 7048 | Hash Join | 208.15 | 253.07 | 21.6% | operator |
| 7058 | Index Scan | 0.07 | -0.22 | 405.6% | operator |
| 7060 | Seq Scan | 2.20 | 12.36 | 461.0% | operator |
| 7049 | Seq Scan | 163.90 | 159.81 | 2.5% | operator |
| 7050 | Hash | 31.62 | 46.85 | 48.1% | pattern |
| 7055 | Seq Scan | 0.01 | 11.81 | 147503.4% | operator |
| 7056 | Hash | 0.09 | 21.05 | 24099.1% | operator |
| 7057 | Seq Scan | 0.08 | 22.93 | 27201.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 7057 (Seq Scan) - LEAF
...
### Step 2: Node 7055 (Seq Scan) - LEAF
...
### Step 4: Node 7049 (Seq Scan) - LEAF
...
### Step 5: Node 7050 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 7041, 7042, 7043, 7045, 7046, 7051, 7052, 7053, 7054
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 7058 (Index Scan) - LEAF
...
### Step 8: Node 7060 (Seq Scan) - LEAF
...
### Step 11: Node 7045 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 7041, 7042, 7043, 7046, 7050, 7051, 7052, 7053, 7054
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 7041 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 7042, 7043, 7045, 7046, 7050, 7051, 7052, 7053, 7054
- **Input Features:**
