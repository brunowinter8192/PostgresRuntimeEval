...
**Test Query:** Q19_100_seed_812199069
...
```
Node 31220 (Aggregate) [PATTERN: efde8b38] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31220 | 31221, 31222, 31223 |
...
|------|------|--------|-----------|-----|--------|
| 31220 | Aggregate | 810.87 | 829.32 | 2.3% | pattern |
| 31224 | Seq Scan | 742.41 | 743.46 | 0.1% | operator |
| 31225 | Hash | 47.84 | 8.29 | 82.7% | operator |
| 31226 | Seq Scan | 47.75 | 23.76 | 50.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31226 (Seq Scan) - LEAF
...
### Step 2: Node 31224 (Seq Scan) - LEAF
...
### Step 4: Node 31220 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31221, 31222, 31223
- **Input Features:**
