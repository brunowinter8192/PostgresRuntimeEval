...
```
Node 31220 (Aggregate) [PATTERN: a5f39f08] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31220 | 31221, 31222 |
...
|------|------|--------|-----------|-----|--------|
| 31220 | Aggregate | 810.87 | 831.20 | 2.5% | pattern |
| 31223 | Hash Join | 792.36 | 766.06 | 3.3% | operator |
...
### Step 5: Node 31220 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31221, 31222
- **Input Features:**
