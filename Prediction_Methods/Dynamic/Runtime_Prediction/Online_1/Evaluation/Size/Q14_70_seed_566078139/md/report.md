...
```
Node 27239 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27240 (Gather) [consumed]
    Node 27241 (Aggregate) [consumed]
      Node 27242 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27239 | 27240, 27241, 27242 |
...
|------|------|--------|-----------|-----|--------|
| 27239 | Aggregate | 836.89 | 857.13 | 2.4% | pattern |
...
### Step 4: Node 27239 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27240, 27241, 27242
- **Input Features:**
