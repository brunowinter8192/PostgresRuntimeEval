...
**Test Query:** Q3_140_seed_1140360309
...
```
Node 4791 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 4792 (Sort) [consumed]
    Node 4793 (Aggregate) [consumed]
      Node 4794 (Gather) [consumed]
        Node 4795 (Nested Loop)
          Node 4796 (Hash Join) [PATTERN: 895c6e8c]
            Node 4797 (Seq Scan) [consumed] - LEAF
            Node 4798 (Hash) [consumed]
              Node 4799 (Seq Scan) - LEAF
          Node 4800 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4791 | 4792, 4793, 4794, 4796, 4797, 4798 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4796 | 4791, 4792, 4793, 4794, 4797, 4798 |
...
|------|------|--------|-----------|-----|--------|
| 4791 | Limit | 1198.90 | 1151.18 | 4.0% | pattern |
| 4795 | Nested Loop | 1161.52 | 1192.78 | 2.7% | operator |
| 4796 | Hash Join | 210.25 | 242.42 | 15.3% | pattern |
| 4800 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4799 | Seq Scan | 27.28 | 38.60 | 41.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4799 (Seq Scan) - LEAF
...
### Step 2: Node 4796 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4791, 4792, 4793, 4794, 4797, 4798
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46503
  - HashJoin_nt1=234452
...
- **Output:** st=29.75, rt=242.42

### Step 3: Node 4800 (Index Scan) - LEAF
...
- **Output:** st=121.56, rt=1192.78

### Step 5: Node 4791 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4792, 4793, 4794, 4796, 4797, 4798
- **Input Features:**
