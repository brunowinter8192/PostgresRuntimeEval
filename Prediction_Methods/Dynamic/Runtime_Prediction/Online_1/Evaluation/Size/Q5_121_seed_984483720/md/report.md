...
**Test Query:** Q5_121_seed_984483720
...
```
Node 7361 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 7362 (Aggregate) [consumed]
    Node 7363 (Gather Merge) [consumed]
      Node 7364 (Aggregate)
        Node 7365 (Sort) [PATTERN: 3e2d5a00]
          Node 7366 (Hash Join) [consumed]
            Node 7367 (Nested Loop)
              Node 7368 (Hash Join)
                Node 7369 (Seq Scan) - LEAF
                Node 7370 (Hash) [PATTERN: 444761fb]
                  Node 7371 (Hash Join) [consumed]
                    Node 7372 (Seq Scan) [consumed] - LEAF
                    Node 7373 (Hash) [consumed]
                      Node 7374 (Hash Join) [consumed]
                        Node 7375 (Seq Scan) - LEAF
                        Node 7376 (Hash)
                          Node 7377 (Seq Scan) - LEAF
              Node 7378 (Index Scan) - LEAF
            Node 7379 (Hash)
              Node 7380 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 7370 | 7361, 7362, 7363, 7365, 7366, 7371, 7372, 7373, 7374 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 7361 | 7362, 7363, 7365, 7366, 7370, 7371, 7372, 7373, 7374 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 7365 | 7361, 7362, 7363, 7366, 7370, 7371, 7372, 7373, 7374 |
...
|------|------|--------|-----------|-----|--------|
| 7361 | Sort | 1074.82 | 2934.42 | 173.0% | pattern |
| 7364 | Aggregate | 1069.58 | 1128.74 | 5.5% | operator |
| 7365 | Sort | 1069.33 | 1835.96 | 71.7% | pattern |
| 7367 | Nested Loop | 1057.32 | 1188.57 | 12.4% | operator |
| 7379 | Hash | 3.29 | 18.67 | 467.0% | operator |
| 7368 | Hash Join | 216.47 | 253.07 | 16.9% | operator |
| 7378 | Index Scan | 0.07 | -0.22 | 397.3% | operator |
| 7380 | Seq Scan | 2.60 | 12.36 | 375.5% | operator |
| 7369 | Seq Scan | 168.50 | 159.81 | 5.2% | operator |
| 7370 | Hash | 35.28 | 46.85 | 32.8% | pattern |
| 7375 | Seq Scan | 0.19 | 11.81 | 6181.0% | operator |
| 7376 | Hash | 0.06 | 21.05 | 36835.5% | operator |
| 7377 | Seq Scan | 0.06 | 22.93 | 41597.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 7377 (Seq Scan) - LEAF
...
### Step 2: Node 7375 (Seq Scan) - LEAF
...
### Step 4: Node 7369 (Seq Scan) - LEAF
...
### Step 5: Node 7370 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 7361, 7362, 7363, 7365, 7366, 7371, 7372, 7373, 7374
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 7378 (Index Scan) - LEAF
...
### Step 8: Node 7380 (Seq Scan) - LEAF
...
### Step 11: Node 7365 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 7361, 7362, 7363, 7366, 7370, 7371, 7372, 7373, 7374
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 7361 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 7362, 7363, 7365, 7366, 7370, 7371, 7372, 7373, 7374
- **Input Features:**
