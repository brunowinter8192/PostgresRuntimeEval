...
**Test Query:** Q12_98_seed_795791007
...
```
Node 25349 (Aggregate) - ROOT
  Node 25350 (Gather Merge)
    Node 25351 (Aggregate)
      Node 25352 (Sort)
        Node 25353 (Nested Loop)
          Node 25354 (Seq Scan) - LEAF
          Node 25355 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 25349 | Aggregate | 1005.46 | 919.06 | 8.6% | operator |
| 25350 | Gather Merge | 1005.45 | 1111.84 | 10.6% | operator |
| 25351 | Aggregate | 985.17 | 895.31 | 9.1% | operator |
| 25352 | Sort | 984.59 | 1092.81 | 11.0% | operator |
| 25353 | Nested Loop | 983.62 | 1127.41 | 14.6% | operator |
| 25354 | Seq Scan | 851.09 | 745.19 | 12.4% | operator |
| 25355 | Index Scan | 0.03 | 0.07 | 187.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25354 (Seq Scan) - LEAF
...
### Step 2: Node 25355 (Index Scan) - LEAF
...
### Step 6: Node 25350 (Gather Merge)
...
### Step 7: Node 25349 (Aggregate) - ROOT
