...
**Test Query:** Q14_115_seed_935259534
...
```
Node 26532 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26533 (Gather) [consumed]
    Node 26534 (Aggregate) [consumed]
      Node 26535 (Hash Join)
        Node 26536 (Seq Scan) - LEAF
        Node 26537 (Hash)
          Node 26538 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26532 | 26533, 26534 |
...
|------|------|--------|-----------|-----|--------|
| 26532 | Aggregate | 823.35 | 848.36 | 3.0% | pattern |
| 26535 | Hash Join | 800.34 | 807.63 | 0.9% | operator |
| 26536 | Seq Scan | 748.09 | 758.48 | 1.4% | operator |
| 26537 | Hash | 43.06 | 9.38 | 78.2% | operator |
| 26538 | Seq Scan | 37.52 | 12.70 | 66.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26538 (Seq Scan) - LEAF
...
### Step 2: Node 26536 (Seq Scan) - LEAF
...
- **Output:** st=6.82, rt=758.48

### Step 3: Node 26537 (Hash)
...
- **Input Features:**
  ...
  - total_cost=136645.8900
- **Output:** st=78.56, rt=807.63

### Step 5: Node 26532 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26533, 26534
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=14952
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=64
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0001
  - Aggregate_Outer_startup_cost=136907.5500
  - Aggregate_Outer_total_cost=136907.5600
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=137908.1200
  - Aggregate_total_cost=137908.1300
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=137907.5500
  - Gather_Outer_total_cost=137908.0600
