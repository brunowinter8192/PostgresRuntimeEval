...
```
Node 26532 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26533 (Gather) [consumed]
    Node 26534 (Aggregate) [consumed]
      Node 26535 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26532 | 26533, 26534, 26535 |
...
|------|------|--------|-----------|-----|--------|
| 26532 | Aggregate | 823.35 | 857.13 | 4.1% | pattern |
...
### Step 4: Node 26532 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26533, 26534, 26535
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=14952
  - HashJoin_Outer_nt1=14952
  ...
  - HashJoin_Outer_total_cost=136645.8900
