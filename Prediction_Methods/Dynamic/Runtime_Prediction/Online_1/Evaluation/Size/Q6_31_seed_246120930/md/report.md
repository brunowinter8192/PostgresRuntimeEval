...
**Test Query:** Q6_31_seed_246120930
...
```
Node 10197 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10198 (Gather) [consumed]
    Node 10199 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10197 | 10198, 10199 |
...
|------|------|--------|-----------|-----|--------|
| 10197 | Aggregate | 783.86 | 849.98 | 8.4% | pattern |
| 10200 | Seq Scan | 763.45 | 748.49 | 2.0% | operator |
...
### Step 2: Node 10197 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10198, 10199
- **Input Features:**
