...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4551 | 4552, 4553, 4554 |
...
| 4555 | Nested Loop | 1225.23 | 1193.45 | 2.6% | operator |
| 4556 | Hash Join | 218.08 | 231.23 | 6.0% | operator |
| 4560 | Index Scan | 0.03 | -0.52 | 2018.8% | operator |
| 4557 | Seq Scan | 165.21 | 163.54 | 1.0% | operator |
| 4558 | Hash | 29.85 | 17.75 | 40.6% | operator |
...
### Step 2: Node 4557 (Seq Scan) - LEAF
...
### Step 5: Node 4560 (Index Scan) - LEAF
...
### Step 7: Node 4551 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4552, 4553, 4554
- **Input Features:**
