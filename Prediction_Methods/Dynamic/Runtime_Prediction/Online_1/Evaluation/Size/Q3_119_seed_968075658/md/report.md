...
**Test Query:** Q3_119_seed_968075658
...
```
Node 4551 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 4552 (Sort) [consumed]
    Node 4553 (Aggregate) [consumed]
      Node 4554 (Gather) [consumed]
        Node 4555 (Nested Loop)
          Node 4556 (Hash Join) [PATTERN: 895c6e8c]
            Node 4557 (Seq Scan) [consumed] - LEAF
            Node 4558 (Hash) [consumed]
              Node 4559 (Seq Scan) - LEAF
          Node 4560 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4551 | 4552, 4553, 4554, 4556, 4557, 4558 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4556 | 4551, 4552, 4553, 4554, 4557, 4558 |
...
|------|------|--------|-----------|-----|--------|
| 4551 | Limit | 1263.22 | 1151.18 | 8.9% | pattern |
| 4555 | Nested Loop | 1225.23 | 1193.54 | 2.6% | operator |
| 4556 | Hash Join | 218.08 | 242.57 | 11.2% | pattern |
| 4560 | Index Scan | 0.03 | -0.52 | 2018.8% | operator |
| 4559 | Seq Scan | 29.15 | 38.54 | 32.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4559 (Seq Scan) - LEAF
...
### Step 2: Node 4556 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4551, 4552, 4553, 4554, 4557, 4558
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47671
  - HashJoin_nt1=237233
...
### Step 3: Node 4560 (Index Scan) - LEAF
...
### Step 5: Node 4551 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4552, 4553, 4554, 4556, 4557, 4558
- **Input Features:**
