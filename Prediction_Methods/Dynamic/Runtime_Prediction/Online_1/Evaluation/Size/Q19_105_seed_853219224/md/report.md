...
**Test Query:** Q19_105_seed_853219224
**Timestamp:** 2026-01-18 20:25:43
...
```
Node 31255 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31256 (Gather) [consumed]
    Node 31257 (Aggregate) [consumed]
      Node 31258 (Hash Join) [consumed]
        Node 31259 (Seq Scan) - LEAF
        Node 31260 (Hash)
          Node 31261 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31255 | 31256, 31257, 31258 |
...
|------|------|--------|-----------|-----|--------|
| 31255 | Aggregate | 910.11 | 829.30 | 8.9% | pattern |
| 31259 | Seq Scan | 840.41 | 743.46 | 11.5% | operator |
| 31260 | Hash | 48.36 | 8.29 | 82.9% | operator |
| 31261 | Seq Scan | 48.16 | 23.76 | 50.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31261 (Seq Scan) - LEAF
...
### Step 2: Node 31259 (Seq Scan) - LEAF
...
### Step 4: Node 31255 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31256, 31257, 31258
- **Input Features:**
  ...
  - Aggregate_Outer_startup_cost=156338.7600
  - Aggregate_Outer_total_cost=156338.7700
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=157339.2900
  - Aggregate_total_cost=157339.3000
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=157338.7600
  - Gather_Outer_total_cost=157339.2700
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=23
  - HashJoin_Outer_nt1=22514
  ...
  - HashJoin_Outer_total_cost=156338.5800
