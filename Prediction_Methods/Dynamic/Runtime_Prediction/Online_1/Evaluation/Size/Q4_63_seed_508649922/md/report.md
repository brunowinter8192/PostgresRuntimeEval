...
**Test Query:** Q4_63_seed_508649922
...
```
Node 6614 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6615 (Gather Merge) [consumed]
    Node 6616 (Sort) [consumed]
      Node 6617 (Aggregate) [consumed]
        Node 6618 (Nested Loop)
          Node 6619 (Seq Scan) - LEAF
          Node 6620 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6614 | 6615, 6616, 6617 |
...
|------|------|--------|-----------|-----|--------|
| 6614 | Aggregate | 1048.51 | 952.19 | 9.2% | pattern |
| 6618 | Nested Loop | 1041.44 | 1255.45 | 20.5% | operator |
| 6619 | Seq Scan | 162.89 | 154.66 | 5.1% | operator |
| 6620 | Index Scan | 0.06 | 11.10 | 18103.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6619 (Seq Scan) - LEAF
...
### Step 2: Node 6620 (Index Scan) - LEAF
