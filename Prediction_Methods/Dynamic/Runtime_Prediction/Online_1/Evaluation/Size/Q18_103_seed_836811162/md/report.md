        ...
        Node 28872 (Incremental Sort)
          Node 28873 (Nested Loop)
            Node 28874 (Merge Join)
              Node 28875 (Sort)
                Node 28876 (Hash Join)
                  Node 28877 (Seq Scan) - LEAF
                  Node 28878 (Hash)
...
| 28875 | Sort | 2851.94 | 1099.77 | 61.4% | operator |
| 28881 | Sort | 67.63 | 1074.66 | 1489.0% | operator |
| 28876 | Hash Join | 2851.92 | 686.33 | 75.9% | operator |
| 28882 | Seq Scan | 54.23 | 18.25 | 66.4% | operator |
| 28877 | Seq Scan | 185.63 | 170.37 | 8.2% | operator |
| 28878 | Hash | 2636.15 | 21.04 | 99.2% | operator |
...
### Step 3: Node 28877 (Seq Scan) - LEAF
...
### Step 6: Node 28882 (Seq Scan) - LEAF
...
### Step 9: Node 28874 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 28883 (Index Scan) - LEAF
...
### Step 11: Node 28873 (Nested Loop)
...
### Step 12: Node 28872 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 28871 (Gather Merge)
