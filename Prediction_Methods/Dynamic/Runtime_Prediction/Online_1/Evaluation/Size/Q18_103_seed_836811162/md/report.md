...
**Test Query:** Q18_103_seed_836811162
...
```
Node 28868 (Limit) - ROOT
  Node 28869 (Sort)
    Node 28870 (Aggregate)
      Node 28871 (Gather Merge)
        Node 28872 (Incremental Sort)
          Node 28873 (Nested Loop)
            Node 28874 (Merge Join)
              Node 28875 (Sort)
                Node 28876 (Hash Join) [PATTERN: 895c6e8c]
                  Node 28877 (Seq Scan) [consumed] - LEAF
                  Node 28878 (Hash) [consumed]
                    Node 28879 (Aggregate)
                      Node 28880 (Index Scan) - LEAF
              Node 28881 (Sort)
                Node 28882 (Seq Scan) - LEAF
            Node 28883 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 28876 | 28877, 28878 |
...
|------|------|--------|-----------|-----|--------|
| 28868 | Limit | 3062.50 | 1175.21 | 61.6% | operator |
| 28869 | Sort | 2943.02 | 1127.81 | 61.7% | operator |
| 28870 | Aggregate | 2942.97 | 1073.15 | 63.5% | operator |
| 28871 | Gather Merge | 2942.96 | 1073.95 | 63.5% | operator |
| 28872 | Incremental Sort | 2923.40 | 0.00 | 100.0% | operator |
| 28873 | Nested Loop | 2923.34 | 1111.34 | 62.0% | operator |
| 28874 | Merge Join | 2923.26 | 0.00 | 100.0% | operator |
| 28883 | Index Scan | 0.03 | 0.05 | 67.2% | operator |
| 28875 | Sort | 2851.94 | 1095.58 | 61.6% | operator |
| 28881 | Sort | 67.63 | 1074.66 | 1489.0% | operator |
| 28876 | Hash Join | 2851.92 | 471.07 | 83.5% | pattern |
| 28882 | Seq Scan | 54.23 | 18.25 | 66.4% | operator |
| 28879 | Aggregate | 2636.11 | 1073.15 | 59.3% | operator |
| 28880 | Index Scan | 2143.39 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 28880 (Index Scan) - LEAF
...
### Step 3: Node 28876 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 28877, 28878
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 28882 (Seq Scan) - LEAF
...
### Step 7: Node 28874 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 28883 (Index Scan) - LEAF
...
### Step 10: Node 28872 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 28871 (Gather Merge)
