...
```
Node 12013 (Aggregate) - ROOT
  Node 12014 (Gather Merge)
    Node 12015 (Sort)
      Node 12016 (Hash Join)
        Node 12017 (Nested Loop)
          Node 12018 (Hash Join)
            Node 12019 (Seq Scan) - LEAF
            Node 12020 (Hash)
              Node 12021 (Hash Join)
                Node 12022 (Seq Scan) - LEAF
                Node 12023 (Hash)
                  Node 12024 (Seq Scan) - LEAF
          Node 12025 (Index Scan) - LEAF
        Node 12026 (Hash)
          Node 12027 (Hash Join)
            Node 12028 (Seq Scan) - LEAF
            Node 12029 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 12013 | Aggregate | 1222.21 | 1209.26 | 1.1% | operator |
| 12014 | Gather Merge | 1221.08 | 1142.98 | 6.4% | operator |
| 12015 | Sort | 1214.93 | 1109.13 | 8.7% | operator |
| 12016 | Hash Join | 1214.30 | 842.59 | 30.6% | operator |
| 12017 | Nested Loop | 1206.81 | 1216.16 | 0.8% | operator |
| 12026 | Hash | 3.66 | 17.53 | 378.4% | operator |
| 12018 | Hash Join | 216.64 | 384.47 | 77.5% | operator |
| 12025 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 12027 | Hash Join | 3.62 | 85.17 | 2256.1% | operator |
| 12019 | Seq Scan | 155.63 | 201.16 | 29.3% | operator |
| 12020 | Hash | 35.50 | 19.59 | 44.8% | operator |
| 12028 | Seq Scan | 3.28 | 11.47 | 249.7% | operator |
| 12029 | Hash | 0.01 | 16.89 | 112527.2% | operator |
| 12021 | Hash Join | 35.23 | 92.20 | 161.7% | operator |
| 12030 | Seq Scan | 0.01 | 45.79 | 381502.6% | operator |
| 12022 | Seq Scan | 34.11 | 21.86 | 35.9% | operator |
| 12023 | Hash | 0.01 | 16.89 | 168840.8% | operator |
| 12024 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |
...
### Step 2: Node 12022 (Seq Scan) - LEAF
...
### Step 5: Node 12030 (Seq Scan) - LEAF
...
### Step 6: Node 12019 (Seq Scan) - LEAF
...
### Step 8: Node 12028 (Seq Scan) - LEAF
...
### Step 11: Node 12025 (Index Scan) - LEAF
...
### Step 13: Node 12017 (Nested Loop)
...
### Step 17: Node 12014 (Gather Merge)
...
### Step 18: Node 12013 (Aggregate) - ROOT
