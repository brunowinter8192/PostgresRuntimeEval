...
```
Node 13569 (Aggregate) - ROOT
  Node 13570 (Gather Merge)
    Node 13571 (Sort)
          ...
          Node 13574 (Hash Join)
            Node 13575 (Nested Loop)
              Node 13576 (Hash Join)
                ...
                Node 13578 (Hash)
                  Node 13579 (Hash Join)
                    Node 13580 (Seq Scan) - LEAF
                    Node 13581 (Hash)
                      Node 13582 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 13569 | Aggregate | 1183.85 | 1195.83 | 1.0% | operator |
| 13570 | Gather Merge | 1183.42 | 1097.15 | 7.3% | operator |
...
| 13576 | Hash Join | 209.95 | 251.17 | 19.6% | operator |
...
| 13578 | Hash | 33.70 | 20.62 | 38.8% | operator |
| 13579 | Hash Join | 32.90 | 132.26 | 302.0% | operator |
| 13580 | Seq Scan | 31.45 | 23.03 | 26.8% | operator |
| 13581 | Hash | 0.14 | 23.66 | 17042.1% | operator |
| 13582 | Hash Join | 0.14 | 306.84 | 227185.9% | operator |
...
### Step 5: Node 13580 (Seq Scan) - LEAF
...
### Step 8: Node 13577 (Seq Scan) - LEAF
...
### Step 11: Node 13586 (Index Scan) - LEAF
...
### Step 12: Node 13588 (Seq Scan) - LEAF
...
### Step 13: Node 13575 (Nested Loop)
...
### Step 16: Node 13589 (Index Scan) - LEAF
...
### Step 17: Node 13591 (Seq Scan) - LEAF
...
### Step 18: Node 13573 (Nested Loop)
...
### Step 22: Node 13570 (Gather Merge)
...
### Step 23: Node 13569 (Aggregate) - ROOT
