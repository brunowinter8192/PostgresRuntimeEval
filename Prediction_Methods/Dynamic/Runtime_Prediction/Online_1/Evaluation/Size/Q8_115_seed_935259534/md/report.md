...
**Test Query:** Q8_115_seed_935259534
...
Node 13569 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 13570 (Gather Merge) [consumed]
    Node 13571 (Sort)
      Node 13572 (Hash Join)
        Node 13573 (Nested Loop)
          Node 13574 (Hash Join)
            Node 13575 (Nested Loop)
              Node 13576 (Hash Join)
                Node 13577 (Seq Scan) - LEAF
                Node 13578 (Hash) [PATTERN: 444761fb]
                  Node 13579 (Hash Join) [consumed]
                    Node 13580 (Seq Scan) [consumed] - LEAF
                    Node 13581 (Hash) [consumed]
                      Node 13582 (Hash Join) [consumed]
                        Node 13583 (Seq Scan) - LEAF
                        Node 13584 (Hash)
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 13578 | 13569, 13570, 13579, 13580, 13581, 13582 |
| Aggregate -> Gather Merge (Out | 2724c080 | 13569 | 13570, 13578, 13579, 13580, 13581, 13582 |
...
|------|------|--------|-----------|-----|--------|
| 13569 | Aggregate | 1183.85 | 1133.66 | 4.2% | pattern |
| 13571 | Sort | 1178.46 | 1046.21 | 11.2% | operator |
| 13572 | Hash Join | 1178.23 | 785.61 | 33.3% | operator |
| 13573 | Nested Loop | 1177.93 | 1198.29 | 1.7% | operator |
| 13590 | Hash | 0.01 | 13.72 | 105469.9% | operator |
| 13574 | Hash Join | 1174.22 | 785.60 | 33.1% | operator |
| 13589 | Index Scan | 0.01 | 12.42 | 206958.1% | operator |
| 13591 | Seq Scan | 0.01 | 6.51 | 65019.6% | operator |
| 13575 | Nested Loop | 1134.00 | 1198.29 | 5.7% | operator |
| 13587 | Hash | 35.77 | 19.97 | 44.2% | operator |
| 13576 | Hash Join | 209.95 | 251.67 | 19.9% | operator |
| 13586 | Index Scan | 0.04 | 2.88 | 7102.1% | operator |
| 13588 | Seq Scan | 35.69 | 48.88 | 37.0% | operator |
| 13577 | Seq Scan | 157.83 | 159.67 | 1.2% | operator |
| 13578 | Hash | 33.70 | 43.51 | 29.1% | pattern |
| 13583 | Seq Scan | 0.01 | 12.22 | 135732.7% | operator |
| 13584 | Hash | 0.12 | 18.14 | 15147.2% | operator |
| 13585 | Seq Scan | 0.12 | 23.36 | 20039.8% | operator |
...
### Step 2: Node 13583 (Seq Scan) - LEAF
...
### Step 4: Node 13577 (Seq Scan) - LEAF
...
### Step 5: Node 13578 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 13569, 13570, 13579, 13580, 13581, 13582
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 13586 (Index Scan) - LEAF
...
### Step 8: Node 13588 (Seq Scan) - LEAF
...
### Step 12: Node 13589 (Index Scan) - LEAF
...
### Step 13: Node 13591 (Seq Scan) - LEAF
...
### Step 14: Node 13573 (Nested Loop)
...
### Step 18: Node 13569 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 13570, 13578, 13579, 13580, 13581, 13582
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2347
  - Aggregate_nt1=2347
