...
```
Node 11257 (Aggregate) - ROOT
  Node 11258 (Gather Merge)
    Node 11259 (Sort)
      Node 11260 (Hash Join)
        Node 11261 (Nested Loop)
          Node 11262 (Hash Join)
            Node 11263 (Seq Scan) - LEAF
            Node 11264 (Hash)
              Node 11265 (Hash Join)
                Node 11266 (Seq Scan) - LEAF
                Node 11267 (Hash)
                  Node 11268 (Seq Scan) - LEAF
          Node 11269 (Index Scan) - LEAF
        Node 11270 (Hash)
          Node 11271 (Hash Join)
            Node 11272 (Seq Scan) - LEAF
            Node 11273 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 11257 | Aggregate | 1216.16 | 1209.26 | 0.6% | operator |
| 11258 | Gather Merge | 1215.15 | 1142.98 | 5.9% | operator |
| 11259 | Sort | 1208.02 | 1109.13 | 8.2% | operator |
| 11260 | Hash Join | 1207.42 | 842.59 | 30.2% | operator |
| 11261 | Nested Loop | 1200.15 | 1216.16 | 1.3% | operator |
| 11270 | Hash | 3.53 | 17.53 | 396.0% | operator |
| 11262 | Hash Join | 213.52 | 384.47 | 80.1% | operator |
| 11269 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 11271 | Hash Join | 3.49 | 85.17 | 2339.8% | operator |
| 11263 | Seq Scan | 152.33 | 201.16 | 32.1% | operator |
| 11264 | Hash | 36.49 | 19.59 | 46.3% | operator |
| 11272 | Seq Scan | 3.13 | 11.47 | 266.1% | operator |
| 11273 | Hash | 0.01 | 16.89 | 112527.2% | operator |
| 11265 | Hash Join | 36.23 | 92.20 | 154.5% | operator |
| 11274 | Seq Scan | 0.01 | 45.79 | 381502.6% | operator |
| 11266 | Seq Scan | 35.11 | 21.86 | 37.7% | operator |
| 11267 | Hash | 0.01 | 16.89 | 187612.0% | operator |
| 11268 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |
...
### Step 2: Node 11266 (Seq Scan) - LEAF
...
### Step 5: Node 11274 (Seq Scan) - LEAF
...
### Step 6: Node 11263 (Seq Scan) - LEAF
...
### Step 8: Node 11272 (Seq Scan) - LEAF
...
### Step 11: Node 11269 (Index Scan) - LEAF
...
### Step 13: Node 11261 (Nested Loop)
...
### Step 17: Node 11258 (Gather Merge)
...
### Step 18: Node 11257 (Aggregate) - ROOT
