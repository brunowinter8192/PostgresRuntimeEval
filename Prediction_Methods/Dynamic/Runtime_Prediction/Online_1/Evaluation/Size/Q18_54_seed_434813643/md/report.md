...
**Test Query:** Q18_54_seed_434813643
...
```
Node 30404 (Limit) - ROOT
  Node 30405 (Sort)
    Node 30406 (Aggregate)
      Node 30407 (Gather Merge)
        Node 30408 (Incremental Sort)
          Node 30409 (Nested Loop)
            Node 30410 (Merge Join)
              Node 30411 (Sort)
                Node 30412 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30413 (Seq Scan) [consumed] - LEAF
                  Node 30414 (Hash) [consumed]
                    Node 30415 (Aggregate)
                      Node 30416 (Index Scan) - LEAF
              Node 30417 (Sort)
                Node 30418 (Seq Scan) - LEAF
            Node 30419 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30412 | 30413, 30414 |
...
|------|------|--------|-----------|-----|--------|
| 30404 | Limit | 3047.07 | 1175.21 | 61.4% | operator |
| 30405 | Sort | 2933.78 | 1127.81 | 61.6% | operator |
| 30406 | Aggregate | 2933.74 | 1073.15 | 63.4% | operator |
| 30407 | Gather Merge | 2933.72 | 1073.95 | 63.4% | operator |
| 30408 | Incremental Sort | 2913.88 | 0.00 | 100.0% | operator |
| 30409 | Nested Loop | 2913.83 | 1111.34 | 61.9% | operator |
| 30410 | Merge Join | 2913.76 | 0.00 | 100.0% | operator |
| 30419 | Index Scan | 0.03 | 0.05 | 61.2% | operator |
| 30411 | Sort | 2845.06 | 1095.58 | 61.5% | operator |
| 30417 | Sort | 65.76 | 1074.66 | 1534.3% | operator |
| 30412 | Hash Join | 2845.05 | 471.07 | 83.4% | pattern |
| 30418 | Seq Scan | 53.57 | 18.25 | 65.9% | operator |
| 30415 | Aggregate | 2621.55 | 1073.15 | 59.1% | operator |
| 30416 | Index Scan | 2120.40 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30416 (Index Scan) - LEAF
...
### Step 3: Node 30412 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30413, 30414
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30418 (Seq Scan) - LEAF
...
### Step 7: Node 30410 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30419 (Index Scan) - LEAF
...
### Step 10: Node 30408 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30407 (Gather Merge)
