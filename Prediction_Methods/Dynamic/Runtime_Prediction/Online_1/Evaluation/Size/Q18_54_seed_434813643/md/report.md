        ...
        Node 30408 (Incremental Sort)
          Node 30409 (Nested Loop)
            Node 30410 (Merge Join)
              Node 30411 (Sort)
                Node 30412 (Hash Join)
                  Node 30413 (Seq Scan) - LEAF
                  Node 30414 (Hash)
...
| 30411 | Sort | 2845.06 | 1099.77 | 61.3% | operator |
| 30417 | Sort | 65.76 | 1074.66 | 1534.3% | operator |
| 30412 | Hash Join | 2845.05 | 686.33 | 75.9% | operator |
| 30418 | Seq Scan | 53.57 | 18.25 | 65.9% | operator |
| 30413 | Seq Scan | 193.63 | 170.37 | 12.0% | operator |
| 30414 | Hash | 2621.59 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30413 (Seq Scan) - LEAF
...
### Step 6: Node 30418 (Seq Scan) - LEAF
...
### Step 9: Node 30410 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30419 (Index Scan) - LEAF
...
### Step 11: Node 30409 (Nested Loop)
...
### Step 12: Node 30408 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30407 (Gather Merge)
