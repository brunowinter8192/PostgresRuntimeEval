...
**Test Query:** Q1_52_seed_418405581
...
```
Node 486 (Aggregate) - ROOT
  Node 487 (Gather Merge)
    Node 488 (Sort) [PATTERN: 1d35fb97]
      Node 489 (Aggregate) [consumed]
        Node 490 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 488 | 489 |
...
|------|------|--------|-----------|-----|--------|
| 486 | Aggregate | 953.73 | 1195.85 | 25.4% | operator |
| 487 | Gather Merge | 953.70 | 1165.89 | 22.2% | operator |
| 488 | Sort | 936.10 | 1200.35 | 28.2% | pattern |
| 490 | Seq Scan | 526.03 | 680.86 | 29.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 490 (Seq Scan) - LEAF
...
### Step 2: Node 488 (Sort) - PATTERN ROOT
...
### Step 4: Node 486 (Aggregate) - ROOT
