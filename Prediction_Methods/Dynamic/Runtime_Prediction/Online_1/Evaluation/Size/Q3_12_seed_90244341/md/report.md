...
**Test Query:** Q3_12_seed_90244341
...
```
Node 4671 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 4672 (Sort) [consumed]
    Node 4673 (Aggregate) [consumed]
      Node 4674 (Gather) [consumed]
        Node 4675 (Nested Loop)
          Node 4676 (Hash Join) [PATTERN: 895c6e8c]
            Node 4677 (Seq Scan) [consumed] - LEAF
            Node 4678 (Hash) [consumed]
              Node 4679 (Seq Scan) - LEAF
          Node 4680 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4671 | 4672, 4673, 4674, 4676, 4677, 4678 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4676 | 4671, 4672, 4673, 4674, 4677, 4678 |
...
|------|------|--------|-----------|-----|--------|
| 4671 | Limit | 1191.92 | 1151.18 | 3.4% | pattern |
| 4675 | Nested Loop | 1156.27 | 1192.81 | 3.2% | operator |
| 4676 | Hash Join | 208.03 | 242.43 | 16.5% | pattern |
| 4680 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4679 | Seq Scan | 28.88 | 38.57 | 33.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4679 (Seq Scan) - LEAF
...
### Step 2: Node 4676 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4671, 4672, 4673, 4674, 4677, 4678
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46543
  - HashJoin_nt1=233109
  ...
  - HashJoin_total_cost=37333.5600
  - Hash_Inner_np=0
  - Hash_Inner_nt=12479
...
- **Output:** st=29.78, rt=242.43

### Step 3: Node 4680 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=72657.4100
- **Output:** st=121.57, rt=1192.81

### Step 5: Node 4671 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4672, 4673, 4674, 4676, 4677, 4678
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=313119
  - Aggregate_Outer_nt1=313119
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=109666.1000
  - Aggregate_Outer_total_cost=113580.0800
  - Gather_Outer_np=0
  - Gather_Outer_nt=313119
  - Gather_Outer_nt1=101006
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=104969.3100
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=313119
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=120346.4700
  - Limit_total_cost=120346.5000
  - Sort_Outer_np=0
  - Sort_Outer_nt=313119
  - Sort_Outer_nt1=313119
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=120346.4700
  - Sort_Outer_total_cost=121129.2700
