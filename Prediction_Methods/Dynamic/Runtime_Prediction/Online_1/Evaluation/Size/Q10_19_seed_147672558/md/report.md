    ...
    Node 20152 (Aggregate) [consumed]
      Node 20153 (Gather) [consumed]
        Node 20154 (Hash Join)
          Node 20155 (Hash Join)
            Node 20156 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20150 | 20151, 20152, 20153 |
...
| 20154 | Hash Join | 1096.32 | 1007.29 | 8.1% | operator |
| 20155 | Hash Join | 1093.43 | 1004.25 | 8.2% | operator |
| 20161 | Hash | 0.02 | 15.71 | 92316.3% | operator |
| 20156 | Nested Loop | 1049.57 | 1204.76 | 14.8% | operator |
| 20159 | Hash | 33.10 | 55.57 | 67.9% | operator |
...
### Step 6: Node 20162 (Seq Scan) - LEAF
...
### Step 10: Node 20150 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20151, 20152, 20153
- **Input Features:**
