...
**Test Query:** Q12_121_seed_984483720
...
```
Node 24481 (Aggregate) - ROOT
  Node 24482 (Gather Merge)
    Node 24483 (Aggregate)
      Node 24484 (Sort)
        Node 24485 (Nested Loop)
          Node 24486 (Seq Scan) - LEAF
          Node 24487 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24481 | Aggregate | 1000.25 | 919.06 | 8.1% | operator |
| 24482 | Gather Merge | 1000.19 | 1111.84 | 11.2% | operator |
| 24483 | Aggregate | 980.50 | 895.30 | 8.7% | operator |
| 24484 | Sort | 979.89 | 1092.82 | 11.5% | operator |
| 24485 | Nested Loop | 978.94 | 1127.41 | 15.2% | operator |
| 24486 | Seq Scan | 846.93 | 745.19 | 12.0% | operator |
| 24487 | Index Scan | 0.03 | 0.07 | 187.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24486 (Seq Scan) - LEAF
...
### Step 2: Node 24487 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - st2=0.1246
  - startup_cost=0.4300
  - total_cost=147178.5700
- **Output:** st=38.32, rt=1127.41

### Step 4: Node 24484 (Sort)
...
- **Input Features:**
  ...
  - st1=38.3245
  - st2=0.0000
  - startup_cost=147539.7900
  - total_cost=147554.2500
- **Output:** st=1092.40, rt=1092.82

### Step 5: Node 24483 (Aggregate)
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=147539.7900
  - total_cost=147655.4800
- **Output:** st=868.95, rt=895.30

### Step 6: Node 24482 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=868.9519
  - st2=0.0000
  - startup_cost=148539.8700
  - total_cost=148659.7800
- **Output:** st=1109.22, rt=1111.84

### Step 7: Node 24481 (Aggregate) - ROOT
