...
**Test Query:** Q3_125_seed_1017299844
...
```
Node 4621 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 4622 (Sort) [consumed]
    Node 4623 (Aggregate) [consumed]
      Node 4624 (Gather) [consumed]
        Node 4625 (Nested Loop)
          Node 4626 (Hash Join) [PATTERN: 895c6e8c]
            Node 4627 (Seq Scan) [consumed] - LEAF
            Node 4628 (Hash) [consumed]
              Node 4629 (Seq Scan) - LEAF
          Node 4630 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4621 | 4622, 4623, 4624, 4626, 4627, 4628 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4626 | 4621, 4622, 4623, 4624, 4627, 4628 |
...
|------|------|--------|-----------|-----|--------|
| 4621 | Limit | 1204.86 | 1151.18 | 4.5% | pattern |
| 4625 | Nested Loop | 1169.27 | 1193.24 | 2.1% | operator |
| 4626 | Hash Join | 210.19 | 242.52 | 15.4% | pattern |
| 4630 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4629 | Seq Scan | 27.78 | 38.53 | 38.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4629 (Seq Scan) - LEAF
...
### Step 2: Node 4626 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4621, 4622, 4623, 4624, 4627, 4628
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47217
  - HashJoin_nt1=234610
...
- **Output:** st=29.74, rt=242.52

### Step 3: Node 4630 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=73114.7900
- **Output:** st=121.97, rt=1193.24

### Step 5: Node 4621 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4622, 4623, 4624, 4626, 4627, 4628
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=315796
  - Aggregate_Outer_nt1=315796
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110431.3300
  - Aggregate_Outer_total_cost=114378.7800
  - Gather_Outer_np=0
  - Gather_Outer_nt=315796
  - Gather_Outer_nt1=101870
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105694.3900
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=315796
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=121203.0200
  - Limit_total_cost=121203.0400
  - Sort_Outer_np=0
  - Sort_Outer_nt=315796
  - Sort_Outer_nt1=315796
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=121203.0200
  - Sort_Outer_total_cost=121992.5100
