...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4621 | 4622, 4623, 4624 |
...
| 4625 | Nested Loop | 1169.27 | 1193.16 | 2.0% | operator |
| 4626 | Hash Join | 210.19 | 230.71 | 9.8% | operator |
| 4630 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4627 | Seq Scan | 157.89 | 163.35 | 3.5% | operator |
| 4628 | Hash | 28.45 | 17.75 | 37.6% | operator |
...
### Step 2: Node 4627 (Seq Scan) - LEAF
...
- **Output:** st=0.29, rt=163.35

### Step 3: Node 4628 (Hash)
...
- **Output:** st=27.17, rt=230.71

### Step 5: Node 4630 (Index Scan) - LEAF
...
- **Output:** st=121.83, rt=1193.16

### Step 7: Node 4621 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4622, 4623, 4624
- **Input Features:**
