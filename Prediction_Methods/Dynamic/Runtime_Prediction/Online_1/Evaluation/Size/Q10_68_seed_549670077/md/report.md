    ...
    Node 20854 (Aggregate) [consumed]
      Node 20855 (Gather) [consumed]
        Node 20856 (Hash Join)
          Node 20857 (Hash Join)
            Node 20858 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20852 | 20853, 20854, 20855 |
...
| 20856 | Hash Join | 1110.10 | 1007.21 | 9.3% | operator |
| 20857 | Hash Join | 1106.91 | 1004.12 | 9.3% | operator |
| 20863 | Hash | 0.02 | 15.71 | 87182.1% | operator |
| 20858 | Nested Loop | 1049.68 | 1204.81 | 14.8% | operator |
| 20861 | Hash | 44.56 | 55.57 | 24.7% | operator |
...
### Step 6: Node 20864 (Seq Scan) - LEAF
...
### Step 10: Node 20852 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20853, 20854, 20855
- **Input Features:**
