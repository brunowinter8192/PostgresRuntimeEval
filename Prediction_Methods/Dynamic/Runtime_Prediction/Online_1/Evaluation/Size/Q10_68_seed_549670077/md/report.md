...
**Test Query:** Q10_68_seed_549670077
...
```
Node 20852 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 20853 (Sort) [consumed]
    Node 20854 (Aggregate) [consumed]
      Node 20855 (Gather) [consumed]
        Node 20856 (Hash Join)
          Node 20857 (Hash Join) [PATTERN: 2e0f44ef]
            Node 20858 (Nested Loop) [consumed]
              Node 20859 (Seq Scan) - LEAF
              Node 20860 (Index Scan) - LEAF
            Node 20861 (Hash) [consumed]
              Node 20862 (Seq Scan) - LEAF
          Node 20863 (Hash)
            Node 20864 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20852 | 20853, 20854, 20855, 20857, 20858, 20861 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 20857 | 20852, 20853, 20854, 20855, 20858, 20861 |
...
|------|------|--------|-----------|-----|--------|
| 20852 | Limit | 1162.06 | 1199.47 | 3.2% | pattern |
| 20856 | Hash Join | 1110.10 | 1095.51 | 1.3% | operator |
| 20857 | Hash Join | 1106.91 | 1120.19 | 1.2% | pattern |
| 20863 | Hash | 0.02 | 15.71 | 87182.1% | operator |
| 20864 | Seq Scan | 0.01 | 6.98 | 53582.3% | operator |
| 20859 | Seq Scan | 160.95 | 159.74 | 0.7% | operator |
| 20860 | Index Scan | 0.06 | -0.52 | 922.6% | operator |
| 20862 | Seq Scan | 32.67 | 26.64 | 18.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 20859 (Seq Scan) - LEAF
...
### Step 2: Node 20860 (Index Scan) - LEAF
...
### Step 3: Node 20862 (Seq Scan) - LEAF
...
### Step 4: Node 20864 (Seq Scan) - LEAF
...
### Step 5: Node 20857 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 20852, 20853, 20854, 20855, 20858, 20861
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18043
  - HashJoin_nt1=18043
...
### Step 8: Node 20852 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20853, 20854, 20855, 20857, 20858, 20861
- **Input Features:**
