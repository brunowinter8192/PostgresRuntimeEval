...
```
Node 10537 (Aggregate) - ROOT
  Node 10538 (Gather Merge)
    Node 10539 (Sort)
      Node 10540 (Hash Join)
        Node 10541 (Nested Loop)
          Node 10542 (Hash Join)
            Node 10543 (Seq Scan) - LEAF
            Node 10544 (Hash)
              Node 10545 (Hash Join)
                Node 10546 (Seq Scan) - LEAF
                Node 10547 (Hash)
                  Node 10548 (Seq Scan) - LEAF
          Node 10549 (Index Scan) - LEAF
        Node 10550 (Hash)
          Node 10551 (Hash Join)
            Node 10552 (Seq Scan) - LEAF
            Node 10553 (Hash)
              Node 10554 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 10537 | Aggregate | 1173.41 | 1209.26 | 3.1% | operator |
| 10538 | Gather Merge | 1172.32 | 1142.98 | 2.5% | operator |
| 10539 | Sort | 1166.82 | 1109.13 | 4.9% | operator |
| 10540 | Hash Join | 1166.23 | 842.59 | 27.8% | operator |
| 10541 | Nested Loop | 1159.05 | 1216.16 | 4.9% | operator |
| 10550 | Hash | 3.34 | 17.53 | 425.5% | operator |
| 10542 | Hash Join | 210.63 | 384.47 | 82.5% | operator |
| 10549 | Index Scan | 0.03 | 0.96 | 3006.0% | operator |
| 10551 | Hash Join | 3.29 | 85.17 | 2487.3% | operator |
| 10543 | Seq Scan | 150.47 | 201.16 | 33.7% | operator |
| 10544 | Hash | 34.74 | 19.59 | 43.6% | operator |
| 10552 | Seq Scan | 2.98 | 11.47 | 285.2% | operator |
| 10553 | Hash | 0.02 | 16.89 | 105488.0% | operator |
| 10545 | Hash Join | 34.45 | 92.20 | 167.6% | operator |
| 10554 | Seq Scan | 0.01 | 45.79 | 352148.6% | operator |
| 10546 | Seq Scan | 33.33 | 21.86 | 34.4% | operator |
| 10547 | Hash | 0.01 | 16.89 | 168840.8% | operator |
| 10548 | Seq Scan | 0.01 | 45.79 | 763105.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10548 (Seq Scan) - LEAF
...
### Step 2: Node 10546 (Seq Scan) - LEAF
...
### Step 5: Node 10554 (Seq Scan) - LEAF
...
### Step 6: Node 10543 (Seq Scan) - LEAF
...
### Step 8: Node 10552 (Seq Scan) - LEAF
...
### Step 11: Node 10549 (Index Scan) - LEAF
...
### Step 13: Node 10541 (Nested Loop)
...
### Step 17: Node 10538 (Gather Merge)
...
### Step 18: Node 10537 (Aggregate) - ROOT
