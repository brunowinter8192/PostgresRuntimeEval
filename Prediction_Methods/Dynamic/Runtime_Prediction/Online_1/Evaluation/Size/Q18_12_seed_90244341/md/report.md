        ...
        Node 29336 (Incremental Sort)
          Node 29337 (Nested Loop)
            Node 29338 (Merge Join)
              Node 29339 (Sort)
                Node 29340 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29341 (Seq Scan) [consumed] - LEAF
                  Node 29342 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29340 | 29341, 29342 |
...
| 29339 | Sort | 2827.68 | 1095.58 | 61.3% | operator |
| 29345 | Sort | 66.11 | 1074.66 | 1525.7% | operator |
| 29340 | Hash Join | 2827.66 | 471.07 | 83.3% | pattern |
...
### Step 3: Node 29340 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29341, 29342
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29346 (Seq Scan) - LEAF
...
### Step 7: Node 29338 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29347 (Index Scan) - LEAF
...
### Step 10: Node 29336 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29335 (Gather Merge)
