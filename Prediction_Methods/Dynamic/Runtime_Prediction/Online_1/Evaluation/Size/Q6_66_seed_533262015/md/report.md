...
**Test Query:** Q6_66_seed_533262015
...
```
Node 10349 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10350 (Gather) [consumed]
    Node 10351 (Aggregate) [consumed]
      Node 10352 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10349 | 10350, 10351 |
...
|------|------|--------|-----------|-----|--------|
| 10349 | Aggregate | 790.86 | 849.99 | 7.5% | pattern |
| 10352 | Seq Scan | 770.92 | 748.50 | 2.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10352 (Seq Scan) - LEAF
...
### Step 2: Node 10349 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10350, 10351
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=22810
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=32
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=139719.5200
  - Aggregate_Outer_total_cost=139719.5300
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=140720.0600
  - Aggregate_total_cost=140720.0700
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=140719.5200
  - Gather_Outer_total_cost=140720.0300
