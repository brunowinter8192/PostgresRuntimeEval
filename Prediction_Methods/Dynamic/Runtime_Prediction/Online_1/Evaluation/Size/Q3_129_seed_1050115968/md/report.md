    ...
    Node 4663 (Aggregate) [consumed]
      Node 4664 (Gather) [consumed]
        Node 4665 (Nested Loop)
          Node 4666 (Hash Join) [PATTERN: 895c6e8c]
            Node 4667 (Seq Scan) [consumed] - LEAF
            Node 4668 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4661 | 4662, 4663, 4664, 4666, 4667, 4668 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4666 | 4661, 4662, 4663, 4664, 4667, 4668 |
...
|------|------|--------|-----------|-----|--------|
| 4661 | Limit | 1300.46 | 1151.18 | 11.5% | pattern |
| 4665 | Nested Loop | 1265.16 | 1193.00 | 5.7% | operator |
| 4666 | Hash Join | 226.36 | 242.47 | 7.1% | pattern |
| 4670 | Index Scan | 0.03 | -0.52 | 1950.2% | operator |
| 4669 | Seq Scan | 30.48 | 38.54 | 26.4% | operator |
...
### Step 2: Node 4666 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4661, 4662, 4663, 4664, 4667, 4668
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46842
  - HashJoin_nt1=233109
  ...
  - HashJoin_total_cost=37334.5600
  - Hash_Inner_np=0
  - Hash_Inner_nt=12559
...
### Step 3: Node 4670 (Index Scan) - LEAF
...
- **Output:** st=121.74, rt=1193.00

### Step 5: Node 4661 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4662, 4663, 4664, 4666, 4667, 4668
- **Input Features:**
