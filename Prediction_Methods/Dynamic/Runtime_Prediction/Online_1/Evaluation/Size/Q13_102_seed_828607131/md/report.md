...
**Test Query:** Q13_102_seed_828607131
...
```
Node 25384 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25385 (Aggregate) [consumed]
    Node 25386 (Aggregate)
      Node 25387 (Hash Join) [PATTERN: 895c6e8c]
        Node 25388 (Seq Scan) [consumed] - LEAF
        Node 25389 (Hash) [consumed]
          Node 25390 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25384 | 25385, 25387, 25388, 25389 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25387 | 25384, 25385, 25388, 25389 |
...
|------|------|--------|-----------|-----|--------|
| 25384 | Sort | 898.12 | 1079.94 | 20.2% | pattern |
| 25386 | Aggregate | 892.04 | 999.76 | 12.1% | operator |
| 25387 | Hash Join | 678.94 | 470.31 | 30.7% | pattern |
| 25390 | Index Only Scan | 10.53 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25390 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25387 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25384, 25385, 25388, 25389
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 25384 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25385, 25387, 25388, 25389
- **Input Features:**
