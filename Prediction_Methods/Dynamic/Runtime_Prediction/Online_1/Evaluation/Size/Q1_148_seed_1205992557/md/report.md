...
**Test Query:** Q1_148_seed_1205992557
...
```
Node 261 (Aggregate) - ROOT
  Node 262 (Gather Merge)
    Node 263 (Sort) [PATTERN: 1d35fb97]
      Node 264 (Aggregate) [consumed]
        Node 265 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 263 | 264 |
...
|------|------|--------|-----------|-----|--------|
| 261 | Aggregate | 996.59 | 1195.91 | 20.0% | operator |
| 262 | Gather Merge | 996.54 | 1165.91 | 17.0% | operator |
| 263 | Sort | 977.41 | 1200.59 | 22.8% | pattern |
| 265 | Seq Scan | 568.26 | 679.93 | 19.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 265 (Seq Scan) - LEAF
...
### Step 2: Node 263 (Sort) - PATTERN ROOT
...
### Step 4: Node 261 (Aggregate) - ROOT
