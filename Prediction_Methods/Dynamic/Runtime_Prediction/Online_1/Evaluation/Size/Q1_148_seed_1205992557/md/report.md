...
|------|------|--------|-----------|-----|--------|
| 261 | Aggregate | 996.59 | 1195.86 | 20.0% | operator |
| 262 | Gather Merge | 996.54 | 1165.59 | 17.0% | operator |
| 263 | Sort | 977.41 | 1182.06 | 20.9% | operator |
| 264 | Aggregate | 977.39 | 1112.96 | 13.9% | operator |
...
- **Input Features:**
  ...
  - st1=0.8507
  - st2=0.0000
  - startup_cost=169023.4700
  - total_cost=169023.6100
- **Output:** st=1037.41, rt=1112.96

### Step 3: Node 263 (Sort)
...
- **Input Features:**
  ...
  - st1=1037.4130
  - st2=0.0000
  - startup_cost=169023.6900
  - total_cost=169023.7000
- **Output:** st=1180.99, rt=1182.06

### Step 4: Node 262 (Gather Merge)
...
### Step 5: Node 261 (Aggregate) - ROOT
