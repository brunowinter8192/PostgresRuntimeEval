...
**Test Query:** Q6_107_seed_869627286
...
```
Node 9929 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 9930 (Gather) [consumed]
    Node 9931 (Aggregate) [consumed]
      Node 9932 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 9929 | 9930, 9931 |
...
|------|------|--------|-----------|-----|--------|
| 9929 | Aggregate | 769.40 | 850.05 | 10.5% | pattern |
| 9932 | Seq Scan | 749.75 | 748.53 | 0.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 9932 (Seq Scan) - LEAF
...
### Step 2: Node 9929 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 9930, 9931
- **Input Features:**
