...
**Test Query:** Q18_135_seed_1099340154
...
```
Node 29428 (Limit) - ROOT
  Node 29429 (Sort)
    Node 29430 (Aggregate)
      Node 29431 (Gather Merge)
        Node 29432 (Incremental Sort)
          Node 29433 (Nested Loop)
            Node 29434 (Merge Join)
              Node 29435 (Sort)
                Node 29436 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29437 (Seq Scan) [consumed] - LEAF
                  Node 29438 (Hash) [consumed]
                    Node 29439 (Aggregate)
                      Node 29440 (Index Scan) - LEAF
              Node 29441 (Sort)
                Node 29442 (Seq Scan) - LEAF
            Node 29443 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29436 | 29437, 29438 |
...
|------|------|--------|-----------|-----|--------|
| 29428 | Limit | 3127.69 | 1175.21 | 62.4% | operator |
| 29429 | Sort | 3011.95 | 1127.81 | 62.6% | operator |
| 29430 | Aggregate | 3011.90 | 1073.15 | 64.4% | operator |
| 29431 | Gather Merge | 3011.89 | 1073.95 | 64.3% | operator |
| 29432 | Incremental Sort | 2976.10 | 0.00 | 100.0% | operator |
| 29433 | Nested Loop | 2976.06 | 1111.34 | 62.7% | operator |
| 29434 | Merge Join | 2976.01 | 0.00 | 100.0% | operator |
| 29443 | Index Scan | 0.02 | 0.05 | 137.6% | operator |
| 29435 | Sort | 2922.15 | 1095.58 | 62.5% | operator |
| 29441 | Sort | 69.07 | 1074.66 | 1455.8% | operator |
| 29436 | Hash Join | 2922.14 | 471.07 | 83.9% | pattern |
| 29442 | Seq Scan | 57.05 | 18.25 | 68.0% | operator |
| 29439 | Aggregate | 2690.04 | 1073.15 | 60.1% | operator |
| 29440 | Index Scan | 2198.22 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29440 (Index Scan) - LEAF
...
### Step 3: Node 29436 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29437, 29438
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29442 (Seq Scan) - LEAF
...
### Step 7: Node 29434 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29443 (Index Scan) - LEAF
...
### Step 10: Node 29432 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29431 (Gather Merge)
