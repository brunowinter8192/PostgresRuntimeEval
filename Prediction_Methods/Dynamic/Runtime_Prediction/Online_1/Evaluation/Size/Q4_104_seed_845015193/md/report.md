...
**Test Query:** Q4_104_seed_845015193
...
```
Node 5879 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 5880 (Gather Merge) [consumed]
    Node 5881 (Sort) [consumed]
      Node 5882 (Aggregate) [consumed]
        Node 5883 (Nested Loop)
          Node 5884 (Seq Scan) - LEAF
          Node 5885 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 5879 | 5880, 5881, 5882 |
...
|------|------|--------|-----------|-----|--------|
| 5879 | Aggregate | 1033.36 | 952.19 | 7.9% | pattern |
| 5883 | Nested Loop | 1026.35 | 1255.45 | 22.3% | operator |
| 5884 | Seq Scan | 162.03 | 154.66 | 4.5% | operator |
| 5885 | Index Scan | 0.06 | 11.10 | 18407.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5884 (Seq Scan) - LEAF
...
### Step 2: Node 5885 (Index Scan) - LEAF
