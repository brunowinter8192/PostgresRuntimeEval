    ...
    Node 17994 (Gather)
      Node 17995 (Aggregate)
        Node 17996 (Nested Loop)
          Node 17997 (Hash Join) [PATTERN: bb930825]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17997 | 17992, 17993, 17998, 17999, 18000 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17992 | 17993, 17997, 17998, 17999, 18000 |
...
|------|------|--------|-----------|-----|--------|
| 17992 | Sort | 1184.63 | 1045.06 | 11.8% | pattern |
| 17994 | Gather | 1183.48 | 964.74 | 18.5% | operator |
| 17995 | Aggregate | 1163.41 | 1106.30 | 4.9% | operator |
| 17996 | Nested Loop | 1139.23 | 1252.17 | 9.9% | operator |
| 17997 | Hash Join | 971.10 | 134.80 | 86.1% | pattern |
| 18009 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18001 | Hash Join | 156.39 | 837.58 | 435.6% | operator |
| 18007 | Hash | 14.08 | 14.95 | 6.2% | operator |
| 18002 | Nested Loop | 148.64 | 1251.77 | 742.2% | operator |
| 18005 | Hash | 5.74 | 15.94 | 177.9% | operator |
| 18008 | Seq Scan | 14.06 | 2.94 | 79.1% | operator |
| 18003 | Seq Scan | 22.23 | 44.10 | 98.4% | operator |
| 18004 | Index Scan | 0.07 | -1.39 | 2083.5% | operator |
| 18006 | Seq Scan | 5.25 | 9.45 | 80.0% | operator |
...
### Step 9: Node 17997 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17992, 17993, 17998, 17999, 18000
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18009 (Index Scan) - LEAF
...
### Step 11: Node 17996 (Nested Loop)
...
### Step 14: Node 17992 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17993, 17997, 17998, 17999, 18000
- **Input Features:**
