...
**Test Query:** Q10_115_seed_935259534
...
```
Node 19578 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 19579 (Sort) [consumed]
    Node 19580 (Aggregate) [consumed]
      Node 19581 (Gather) [consumed]
        Node 19582 (Hash Join)
          Node 19583 (Hash Join) [PATTERN: 2e0f44ef]
            Node 19584 (Nested Loop) [consumed]
              Node 19585 (Seq Scan) - LEAF
              Node 19586 (Index Scan) - LEAF
            Node 19587 (Hash) [consumed]
              Node 19588 (Seq Scan) - LEAF
          Node 19589 (Hash)
            Node 19590 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19578 | 19579, 19580, 19581, 19583, 19584, 19587 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 19583 | 19578, 19579, 19580, 19581, 19584, 19587 |
...
|------|------|--------|-----------|-----|--------|
| 19578 | Limit | 1161.87 | 1199.47 | 3.2% | pattern |
| 19582 | Hash Join | 1108.30 | 1095.55 | 1.1% | operator |
| 19583 | Hash Join | 1105.41 | 1120.19 | 1.3% | pattern |
| 19589 | Hash | 0.01 | 15.71 | 104638.5% | operator |
| 19590 | Seq Scan | 0.01 | 6.98 | 63342.8% | operator |
| 19585 | Seq Scan | 162.83 | 159.74 | 1.9% | operator |
| 19586 | Index Scan | 0.06 | -0.52 | 935.9% | operator |
| 19588 | Seq Scan | 27.91 | 26.64 | 4.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 19585 (Seq Scan) - LEAF
...
### Step 2: Node 19586 (Index Scan) - LEAF
...
### Step 3: Node 19588 (Seq Scan) - LEAF
...
### Step 4: Node 19590 (Seq Scan) - LEAF
...
### Step 5: Node 19583 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 19578, 19579, 19580, 19581, 19584, 19587
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18184
  - HashJoin_nt1=18184
...
### Step 8: Node 19578 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19579, 19580, 19581, 19583, 19584, 19587
- **Input Features:**
