...
**Test Query:** Q19_35_seed_278937054
...
```
Node 31766 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31767 (Gather) [consumed]
    Node 31768 (Aggregate) [consumed]
      Node 31769 (Hash Join) [consumed]
        Node 31770 (Seq Scan) - LEAF
        Node 31771 (Hash)
          Node 31772 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31766 | 31767, 31768, 31769 |
...
|------|------|--------|-----------|-----|--------|
| 31766 | Aggregate | 858.27 | 829.30 | 3.4% | pattern |
| 31770 | Seq Scan | 787.04 | 743.46 | 5.5% | operator |
| 31771 | Hash | 47.07 | 8.29 | 82.4% | operator |
| 31772 | Seq Scan | 46.89 | 23.76 | 49.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31772 (Seq Scan) - LEAF
...
### Step 2: Node 31770 (Seq Scan) - LEAF
...
### Step 4: Node 31766 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31767, 31768, 31769
- **Input Features:**
