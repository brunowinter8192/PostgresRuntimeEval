...
```
Node 18752 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18753 (Aggregate) [consumed]
    Node 18754 (Gather)
      Node 18755 (Aggregate)
        Node 18756 (Nested Loop)
          Node 18757 (Hash Join) [PATTERN: bb930825]
            Node 18758 (Seq Scan) [consumed] - LEAF
            Node 18759 (Hash) [consumed]
              Node 18760 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18757 | 18752, 18753, 18758, 18759, 18760 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18752 | 18753, 18757, 18758, 18759, 18760 |
...
|------|------|--------|-----------|-----|--------|
| 18752 | Sort | 1199.79 | 1045.32 | 12.9% | pattern |
...
| 18757 | Hash Join | 979.55 | 134.80 | 86.2% | pattern |
...
### Step 9: Node 18757 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18752, 18753, 18758, 18759, 18760
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18769 (Index Scan) - LEAF
...
### Step 11: Node 18756 (Nested Loop)
...
### Step 14: Node 18752 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18753, 18757, 18758, 18759, 18760
- **Input Features:**
