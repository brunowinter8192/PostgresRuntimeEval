...
```
Node 18752 (Sort) - ROOT
  Node 18753 (Aggregate)
    Node 18754 (Gather)
      Node 18755 (Aggregate)
        Node 18756 (Nested Loop)
          Node 18757 (Hash Join)
            Node 18758 (Seq Scan) - LEAF
            Node 18759 (Hash)
              Node 18760 (Hash Join)
                Node 18761 (Hash Join)
                  Node 18762 (Nested Loop)
                    Node 18763 (Seq Scan) - LEAF
                    Node 18764 (Index Scan) - LEAF
                  Node 18765 (Hash)
                    Node 18766 (Seq Scan) - LEAF
                Node 18767 (Hash)
                  Node 18768 (Seq Scan) - LEAF
          Node 18769 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 18752 | Sort | 1199.79 | 1119.51 | 6.7% | operator |
| 18753 | Aggregate | 1199.65 | 897.44 | 25.2% | operator |
| 18754 | Gather | 1198.58 | 964.64 | 19.5% | operator |
| 18755 | Aggregate | 1179.86 | 1095.61 | 7.1% | operator |
| 18756 | Nested Loop | 1154.80 | 1252.17 | 8.4% | operator |
| 18757 | Hash Join | 979.55 | 633.32 | 35.3% | operator |
| 18769 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18758 | Seq Scan | 701.26 | 509.93 | 27.3% | operator |
| 18759 | Hash | 184.39 | 47.91 | 74.0% | operator |
| 18760 | Hash Join | 182.51 | 924.43 | 406.5% | operator |
| 18761 | Hash Join | 167.32 | 837.61 | 400.6% | operator |
| 18767 | Hash | 14.56 | 14.95 | 2.7% | operator |
| 18762 | Nested Loop | 161.83 | 1251.77 | 673.5% | operator |
| 18765 | Hash | 3.46 | 15.94 | 360.8% | operator |
| 18768 | Seq Scan | 14.54 | 2.94 | 79.8% | operator |
| 18763 | Seq Scan | 20.77 | 44.03 | 112.0% | operator |
| 18764 | Index Scan | 0.08 | -1.39 | 1903.2% | operator |
| 18766 | Seq Scan | 3.03 | 9.45 | 212.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 18763 (Seq Scan) - LEAF
...
### Step 2: Node 18764 (Index Scan) - LEAF
...
### Step 3: Node 18766 (Seq Scan) - LEAF
...
### Step 6: Node 18768 (Seq Scan) - LEAF
...
### Step 10: Node 18758 (Seq Scan) - LEAF
...
### Step 13: Node 18769 (Index Scan) - LEAF
...
### Step 14: Node 18756 (Nested Loop)
