...
```
Node 18679 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18680 (Aggregate) [consumed]
    Node 18681 (Gather)
      Node 18682 (Aggregate)
        Node 18683 (Nested Loop)
          Node 18684 (Hash Join) [PATTERN: bb930825]
            Node 18685 (Seq Scan) [consumed] - LEAF
            Node 18686 (Hash) [consumed]
              Node 18687 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18684 | 18679, 18680, 18685, 18686, 18687 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18679 | 18680, 18684, 18685, 18686, 18687 |
...
|------|------|--------|-----------|-----|--------|
| 18679 | Sort | 1191.38 | 1052.71 | 11.6% | pattern |
...
| 18684 | Hash Join | 973.91 | 134.80 | 86.2% | pattern |
...
### Step 9: Node 18684 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18679, 18680, 18685, 18686, 18687
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18696 (Index Scan) - LEAF
...
### Step 11: Node 18683 (Nested Loop)
...
### Step 14: Node 18679 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18680, 18684, 18685, 18686, 18687
- **Input Features:**
