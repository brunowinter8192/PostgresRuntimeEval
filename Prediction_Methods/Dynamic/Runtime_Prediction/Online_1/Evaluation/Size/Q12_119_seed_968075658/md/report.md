...
**Test Query:** Q12_119_seed_968075658
...
```
Node 24460 (Aggregate) - ROOT
  Node 24461 (Gather Merge)
    Node 24462 (Aggregate)
      Node 24463 (Sort)
        Node 24464 (Nested Loop)
          Node 24465 (Seq Scan) - LEAF
          Node 24466 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24460 | Aggregate | 1005.19 | 919.04 | 8.6% | operator |
| 24461 | Gather Merge | 1005.17 | 1111.84 | 10.6% | operator |
| 24462 | Aggregate | 984.73 | 895.29 | 9.1% | operator |
| 24463 | Sort | 984.12 | 1092.83 | 11.0% | operator |
| 24464 | Nested Loop | 983.16 | 1127.41 | 14.7% | operator |
| 24465 | Seq Scan | 843.88 | 745.20 | 11.7% | operator |
| 24466 | Index Scan | 0.03 | 0.07 | 166.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24465 (Seq Scan) - LEAF
...
### Step 2: Node 24466 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - st2=0.1246
  - startup_cost=0.4300
  - total_cost=147208.3800
- **Output:** st=38.32, rt=1127.41

### Step 4: Node 24463 (Sort)
...
- **Input Features:**
  ...
  - st1=38.3209
  - st2=0.0000
  - startup_cost=147571.9100
  - total_cost=147586.4500
- **Output:** st=1092.41, rt=1092.83

### Step 5: Node 24462 (Aggregate)
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=147571.9100
  - total_cost=147688.2600
- **Output:** st=868.93, rt=895.29

### Step 6: Node 24461 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=868.9297
  - st2=0.0000
  - startup_cost=148571.9900
  - total_cost=148692.5500
- **Output:** st=1109.22, rt=1111.84

### Step 7: Node 24460 (Aggregate) - ROOT
