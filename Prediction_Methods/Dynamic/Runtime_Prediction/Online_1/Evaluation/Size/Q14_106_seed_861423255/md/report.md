...
```
Node 26462 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26463 (Gather) [consumed]
    Node 26464 (Aggregate) [consumed]
      Node 26465 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26462 | 26463, 26464, 26465 |
...
|------|------|--------|-----------|-----|--------|
| 26462 | Aggregate | 814.07 | 857.14 | 5.3% | pattern |
...
### Step 4: Node 26462 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26463, 26464, 26465
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=15770
  - HashJoin_Outer_nt1=15770
  ...
  - HashJoin_Outer_total_cost=136648.0400
