...
**Test Query:** Q13_95_seed_771178914
**Timestamp:** 2026-01-18 20:02:07
...
```
Node 26378 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26379 (Aggregate) [consumed]
    Node 26380 (Aggregate)
      Node 26381 (Hash Join) [PATTERN: 895c6e8c]
        Node 26382 (Seq Scan) [consumed] - LEAF
        Node 26383 (Hash) [consumed]
          Node 26384 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26378 | 26379, 26381, 26382, 26383 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26381 | 26378, 26379, 26382, 26383 |
...
|------|------|--------|-----------|-----|--------|
| 26378 | Sort | 928.24 | 1079.93 | 16.3% | pattern |
| 26380 | Aggregate | 922.14 | 999.35 | 8.4% | operator |
| 26381 | Hash Join | 703.91 | 470.31 | 33.2% | pattern |
| 26384 | Index Only Scan | 11.18 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26384 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26381 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26378, 26379, 26382, 26383
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1481964
...
### Step 4: Node 26378 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26379, 26381, 26382, 26383
- **Input Features:**
