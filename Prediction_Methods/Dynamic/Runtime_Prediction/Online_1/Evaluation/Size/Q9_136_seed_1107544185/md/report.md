    ...
    Node 17359 (Gather)
      Node 17360 (Aggregate)
        Node 17361 (Nested Loop)
          Node 17362 (Hash Join) [PATTERN: bb930825]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17362 | 17357, 17358, 17363, 17364, 17365 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17357 | 17358, 17362, 17363, 17364, 17365 |
...
|------|------|--------|-----------|-----|--------|
| 17357 | Sort | 1188.39 | 1046.01 | 12.0% | pattern |
...
| 17362 | Hash Join | 966.68 | 134.80 | 86.1% | pattern |
...
### Step 9: Node 17362 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17357, 17358, 17363, 17364, 17365
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17374 (Index Scan) - LEAF
...
### Step 11: Node 17361 (Nested Loop)
...
### Step 14: Node 17357 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17358, 17362, 17363, 17364, 17365
- **Input Features:**
