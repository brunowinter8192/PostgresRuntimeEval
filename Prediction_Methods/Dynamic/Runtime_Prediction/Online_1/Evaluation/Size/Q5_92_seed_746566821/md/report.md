...
```
Node 9721 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 9722 (Aggregate) [consumed]
    Node 9723 (Gather Merge) [consumed]
      Node 9724 (Aggregate)
        Node 9725 (Sort) [PATTERN: 3e2d5a00]
          Node 9726 (Hash Join) [consumed]
            Node 9727 (Nested Loop)
              Node 9728 (Hash Join)
                Node 9729 (Seq Scan) - LEAF
                Node 9730 (Hash) [PATTERN: 444761fb]
                  Node 9731 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 9730 | 9721, 9722, 9723, 9725, 9726, 9731, 9732, 9733, 9734 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 9721 | 9722, 9723, 9725, 9726, 9730, 9731, 9732, 9733, 9734 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 9725 | 9721, 9722, 9723, 9726, 9730, 9731, 9732, 9733, 9734 |
...
|------|------|--------|-----------|-----|--------|
| 9721 | Sort | 1055.46 | 2934.42 | 178.0% | pattern |
| 9724 | Aggregate | 1050.71 | 1128.79 | 7.4% | operator |
| 9725 | Sort | 1050.45 | 1835.90 | 74.8% | pattern |
| 9727 | Nested Loop | 1038.23 | 1188.37 | 14.5% | operator |
| 9739 | Hash | 2.74 | 18.67 | 580.9% | operator |
| 9728 | Hash Join | 217.04 | 253.07 | 16.6% | operator |
| 9738 | Index Scan | 0.07 | -0.22 | 409.9% | operator |
| 9740 | Seq Scan | 2.22 | 12.36 | 456.5% | operator |
| 9729 | Seq Scan | 168.39 | 159.81 | 5.1% | operator |
| 9730 | Hash | 33.42 | 46.85 | 40.2% | pattern |
| 9735 | Seq Scan | 0.01 | 11.81 | 84244.8% | operator |
| 9736 | Hash | 0.34 | 21.05 | 6128.8% | operator |
| 9737 | Seq Scan | 0.33 | 22.93 | 6766.3% | operator |
...
### Step 4: Node 9729 (Seq Scan) - LEAF
...
### Step 5: Node 9730 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 9721, 9722, 9723, 9725, 9726, 9731, 9732, 9733, 9734
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 9738 (Index Scan) - LEAF
...
### Step 8: Node 9740 (Seq Scan) - LEAF
...
### Step 11: Node 9725 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 9721, 9722, 9723, 9726, 9730, 9731, 9732, 9733, 9734
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 9721 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 9722, 9723, 9725, 9726, 9730, 9731, 9732, 9733, 9734
- **Input Features:**
