...
**Test Query:** Q1_99_seed_803995038
...
```
Node 741 (Aggregate) - ROOT
  Node 742 (Gather Merge)
    Node 743 (Sort) [PATTERN: 1d35fb97]
      Node 744 (Aggregate) [consumed]
        Node 745 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 743 | 744 |
...
|------|------|--------|-----------|-----|--------|
| 741 | Aggregate | 1005.63 | 1195.73 | 18.9% | operator |
| 742 | Gather Merge | 1005.60 | 1165.86 | 15.9% | operator |
| 743 | Sort | 988.99 | 1199.90 | 21.3% | pattern |
| 745 | Seq Scan | 573.52 | 682.56 | 19.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 745 (Seq Scan) - LEAF
...
- **Output:** st=0.85, rt=682.56

### Step 2: Node 743 (Sort) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Aggregate_Outer_nt1=1169999
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=236
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=168553.0000
  - Aggregate_Outer_total_cost=168553.1400
  - Sort_np=0
  - Sort_nt=6
  - Sort_nt1=6
  - Sort_nt2=0
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=168553.2200
  - Sort_total_cost=168553.2300
- **Output:** st=1195.80, rt=1199.90

### Step 3: Node 742 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1195.7979
  - st2=0.0000
  - startup_cost=169553.2900
  - total_cost=169556.9200
- **Output:** st=1161.74, rt=1165.86

### Step 4: Node 741 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=169553.2900
  - total_cost=169558.0600
- **Output:** st=1149.86, rt=1195.73
