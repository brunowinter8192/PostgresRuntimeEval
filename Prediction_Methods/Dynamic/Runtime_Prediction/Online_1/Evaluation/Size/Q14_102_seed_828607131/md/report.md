...
**Test Query:** Q14_102_seed_828607131
...
```
Node 26434 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26435 (Gather) [consumed]
    Node 26436 (Aggregate) [consumed]
      Node 26437 (Hash Join) [consumed]
        Node 26438 (Seq Scan) - LEAF
        Node 26439 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26434 | 26435, 26436, 26437 |
...
|------|------|--------|-----------|-----|--------|
| 26434 | Aggregate | 808.69 | 857.11 | 6.0% | pattern |
| 26438 | Seq Scan | 738.55 | 758.44 | 2.7% | operator |
| 26439 | Hash | 42.10 | 9.38 | 77.7% | operator |
| 26440 | Seq Scan | 37.78 | 12.70 | 66.4% | operator |
...
### Step 2: Node 26438 (Seq Scan) - LEAF
...
### Step 4: Node 26434 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26435, 26436, 26437
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=13981
  - HashJoin_Outer_nt1=13981
  ...
  - HashJoin_Outer_total_cost=136643.3400
