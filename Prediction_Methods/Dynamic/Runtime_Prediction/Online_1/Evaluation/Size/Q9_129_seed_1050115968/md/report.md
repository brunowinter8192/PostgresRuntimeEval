...
```
Node 17212 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 17213 (Aggregate) [consumed]
    Node 17214 (Gather)
      Node 17215 (Aggregate)
        Node 17216 (Hash Join)
          Node 17217 (Seq Scan) - LEAF
          Node 17218 (Hash) [PATTERN: 444761fb]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 17218 | 17212, 17213, 17219, 17220, 17221, 17222 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17212 | 17213, 17218, 17219, 17220, 17221, 17222 |
...
|------|------|--------|-----------|-----|--------|
| 17212 | Sort | 1273.98 | 1063.12 | 16.6% | pattern |
| 17214 | Gather | 1272.78 | 962.19 | 24.4% | operator |
| 17215 | Aggregate | 1255.73 | 922.12 | 26.6% | operator |
| 17216 | Hash Join | 1227.72 | 571.38 | 53.5% | operator |
| 17217 | Seq Scan | 127.82 | 193.40 | 51.3% | operator |
| 17218 | Hash | 1037.26 | 35.69 | 96.6% | pattern |
| 17223 | Hash Join | 199.61 | 837.74 | 319.7% | operator |
| 17229 | Hash | 14.20 | 14.95 | 5.3% | operator |
| 17224 | Nested Loop | 192.94 | 1251.77 | 548.8% | operator |
| 17227 | Hash | 4.18 | 15.94 | 281.2% | operator |
| 17230 | Seq Scan | 14.19 | 2.94 | 79.3% | operator |
| 17225 | Seq Scan | 27.88 | 43.69 | 56.7% | operator |
| 17226 | Index Scan | 0.06 | -1.39 | 2376.2% | operator |
| 17228 | Seq Scan | 3.77 | 9.45 | 150.4% | operator |
...
### Step 10: Node 17218 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 17212, 17213, 17219, 17220, 17221, 17222
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 14: Node 17212 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17213, 17218, 17219, 17220, 17221, 17222
- **Input Features:**
