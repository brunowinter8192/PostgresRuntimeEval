...
**Test Query:** Q19_97_seed_787586976
...
```
Node 32242 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 32243 (Gather) [consumed]
    Node 32244 (Aggregate) [consumed]
      Node 32245 (Hash Join) [consumed]
        Node 32246 (Seq Scan) - LEAF
        Node 32247 (Hash)
          Node 32248 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 32242 | 32243, 32244, 32245 |
...
|------|------|--------|-----------|-----|--------|
| 32242 | Aggregate | 797.10 | 829.28 | 4.0% | pattern |
| 32246 | Seq Scan | 728.95 | 743.46 | 2.0% | operator |
| 32247 | Hash | 46.77 | 8.29 | 82.3% | operator |
| 32248 | Seq Scan | 46.67 | 23.76 | 49.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 32248 (Seq Scan) - LEAF
...
### Step 2: Node 32246 (Seq Scan) - LEAF
...
### Step 4: Node 32242 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 32243, 32244, 32245
- **Input Features:**
