...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4481 | 4482, 4483, 4484, 4486, 4487, 4488 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4486 | 4481, 4482, 4483, 4484, 4487, 4488 |
...
|------|------|--------|-----------|-----|--------|
| 4481 | Limit | 1224.56 | 1151.18 | 6.0% | pattern |
| 4485 | Nested Loop | 1186.74 | 1192.94 | 0.5% | operator |
| 4486 | Hash Join | 207.82 | 242.46 | 16.7% | pattern |
| 4490 | Index Scan | 0.03 | -0.52 | 2018.8% | operator |
| 4489 | Seq Scan | 27.44 | 38.57 | 40.5% | operator |
...
- **Consumes:** Nodes 4481, 4482, 4483, 4484, 4487, 4488
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46747
  - HashJoin_nt1=234136
  ...
  - HashJoin_total_cost=37336.2500
  - Hash_Inner_np=0
  - Hash_Inner_nt=12479
...
### Step 3: Node 4490 (Index Scan) - LEAF
...
### Step 5: Node 4481 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4482, 4483, 4484, 4486, 4487, 4488
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=313279
  - Aggregate_Outer_nt1=313279
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=109801.7300
  - Aggregate_Outer_total_cost=113717.7200
  - Gather_Outer_np=0
