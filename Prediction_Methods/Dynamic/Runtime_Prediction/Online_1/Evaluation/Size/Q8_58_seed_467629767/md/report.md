...
```
Node 15570 (Aggregate) - ROOT
  Node 15571 (Gather Merge)
    Node 15572 (Sort)
          ...
          Node 15575 (Hash Join)
            Node 15576 (Nested Loop)
              Node 15577 (Hash Join)
                ...
                Node 15579 (Hash)
                  Node 15580 (Hash Join)
                    Node 15581 (Seq Scan) - LEAF
                    Node 15582 (Hash)
                      Node 15583 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 15570 | Aggregate | 1208.42 | 1195.73 | 1.1% | operator |
| 15571 | Gather Merge | 1208.03 | 1097.12 | 9.2% | operator |
...
| 15577 | Hash Join | 223.44 | 251.17 | 12.4% | operator |
...
| 15579 | Hash | 43.49 | 20.62 | 52.6% | operator |
| 15580 | Hash Join | 42.80 | 132.26 | 209.0% | operator |
| 15581 | Seq Scan | 41.17 | 23.03 | 44.1% | operator |
| 15582 | Hash | 0.26 | 23.66 | 8998.5% | operator |
| 15583 | Hash Join | 0.26 | 306.84 | 119291.4% | operator |
...
### Step 5: Node 15581 (Seq Scan) - LEAF
...
### Step 8: Node 15578 (Seq Scan) - LEAF
...
### Step 11: Node 15587 (Index Scan) - LEAF
...
### Step 12: Node 15589 (Seq Scan) - LEAF
...
### Step 13: Node 15576 (Nested Loop)
...
### Step 16: Node 15590 (Index Scan) - LEAF
...
### Step 17: Node 15592 (Seq Scan) - LEAF
...
### Step 18: Node 15574 (Nested Loop)
...
### Step 22: Node 15571 (Gather Merge)
...
### Step 23: Node 15570 (Aggregate) - ROOT
