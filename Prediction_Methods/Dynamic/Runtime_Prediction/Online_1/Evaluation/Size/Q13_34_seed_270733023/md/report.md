...
**Test Query:** Q13_34_seed_270733023
...
```
Node 25909 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25910 (Aggregate) [consumed]
    Node 25911 (Aggregate)
      Node 25912 (Hash Join) [PATTERN: 895c6e8c]
        Node 25913 (Seq Scan) [consumed] - LEAF
        Node 25914 (Hash) [consumed]
          Node 25915 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25909 | 25910, 25912, 25913, 25914 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25912 | 25909, 25910, 25913, 25914 |
...
|------|------|--------|-----------|-----|--------|
| 25909 | Sort | 946.94 | 1079.94 | 14.0% | pattern |
| 25911 | Aggregate | 941.02 | 999.76 | 6.2% | operator |
| 25912 | Hash Join | 723.97 | 470.31 | 35.0% | pattern |
| 25915 | Index Only Scan | 9.88 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25915 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25912 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25909, 25910, 25913, 25914
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 25909 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25910, 25912, 25913, 25914
- **Input Features:**
