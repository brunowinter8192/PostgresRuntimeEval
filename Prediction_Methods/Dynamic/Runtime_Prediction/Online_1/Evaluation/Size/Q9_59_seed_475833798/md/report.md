    ...
    Node 18536 (Gather)
      Node 18537 (Aggregate)
        Node 18538 (Nested Loop)
          Node 18539 (Hash Join) [PATTERN: bb930825]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18539 | 18534, 18535, 18540, 18541, 18542 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18534 | 18535, 18539, 18540, 18541, 18542 |
...
|------|------|--------|-----------|-----|--------|
| 18534 | Sort | 1188.18 | 1045.32 | 12.0% | pattern |
...
| 18539 | Hash Join | 961.09 | 134.80 | 86.0% | pattern |
...
### Step 9: Node 18539 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18534, 18535, 18540, 18541, 18542
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 11: Node 18538 (Nested Loop)
...
### Step 14: Node 18534 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18535, 18539, 18540, 18541, 18542
- **Input Features:**
