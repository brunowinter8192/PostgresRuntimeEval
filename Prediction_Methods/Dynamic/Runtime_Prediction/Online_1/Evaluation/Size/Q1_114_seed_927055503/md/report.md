...
Node 76 (Aggregate) - ROOT
  Node 77 (Gather Merge)
    Node 78 (Sort) [PATTERN: 1d35fb97]
      Node 79 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 78 | 79 |
...
|------|------|--------|-----------|-----|--------|
| 76 | Aggregate | 955.82 | 1195.95 | 25.1% | operator |
| 77 | Gather Merge | 955.76 | 1165.92 | 22.0% | operator |
| 78 | Sort | 933.52 | 1200.73 | 28.6% | pattern |
...
### Step 2: Node 78 (Sort) - PATTERN ROOT
