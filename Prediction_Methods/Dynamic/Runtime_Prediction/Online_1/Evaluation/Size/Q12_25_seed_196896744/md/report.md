...
**Test Query:** Q12_25_seed_196896744
**Timestamp:** 2025-12-21 17:57:59
...
```
Node 24789 (Aggregate) - ROOT
  Node 24790 (Gather Merge)
    Node 24791 (Aggregate)
      Node 24792 (Sort)
        Node 24793 (Nested Loop)
          Node 24794 (Seq Scan) - LEAF
          Node 24795 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24789 | Aggregate | 968.52 | 919.06 | 5.1% | operator |
| 24790 | Gather Merge | 968.51 | 1111.84 | 14.8% | operator |
| 24791 | Aggregate | 949.46 | 895.30 | 5.7% | operator |
| 24792 | Sort | 948.83 | 1092.82 | 15.2% | operator |
| 24793 | Nested Loop | 947.81 | 1127.41 | 18.9% | operator |
| 24794 | Seq Scan | 815.39 | 745.19 | 8.6% | operator |
| 24795 | Index Scan | 0.03 | 0.07 | 187.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24794 (Seq Scan) - LEAF
...
### Step 2: Node 24795 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - st2=0.1246
  - startup_cost=0.4300
  - total_cost=147179.3200
- **Output:** st=38.32, rt=1127.41

### Step 4: Node 24792 (Sort)
...
- **Input Features:**
  ...
  - st1=38.3243
  - st2=0.0000
  - startup_cost=147540.6200
  - total_cost=147555.0800
- **Output:** st=1092.40, rt=1092.82

### Step 5: Node 24791 (Aggregate)
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=147540.6200
  - total_cost=147656.3300
- **Output:** st=868.95, rt=895.30

### Step 6: Node 24790 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=868.9513
  - st2=0.0000
  - startup_cost=148540.7000
  - total_cost=148660.6300
- **Output:** st=1109.22, rt=1111.84

### Step 7: Node 24789 (Aggregate) - ROOT
