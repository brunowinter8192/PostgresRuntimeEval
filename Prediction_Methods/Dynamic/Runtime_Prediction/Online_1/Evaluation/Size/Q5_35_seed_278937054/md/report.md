...
```
Node 8461 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 8462 (Aggregate) [consumed]
    Node 8463 (Gather Merge) [consumed]
      Node 8464 (Aggregate)
        Node 8465 (Sort) [PATTERN: 3e2d5a00]
          Node 8466 (Hash Join) [consumed]
            Node 8467 (Nested Loop)
              Node 8468 (Hash Join)
                Node 8469 (Seq Scan) - LEAF
                Node 8470 (Hash) [PATTERN: 444761fb]
                  Node 8471 (Hash Join) [consumed]
                    Node 8472 (Seq Scan) [consumed] - LEAF
                    Node 8473 (Hash) [consumed]
                      Node 8474 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 8470 | 8461, 8462, 8463, 8465, 8466, 8471, 8472, 8473, 8474 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 8461 | 8462, 8463, 8465, 8466, 8470, 8471, 8472, 8473, 8474 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 8465 | 8461, 8462, 8463, 8466, 8470, 8471, 8472, 8473, 8474 |
...
|------|------|--------|-----------|-----|--------|
| 8461 | Sort | 1075.76 | 2934.42 | 172.8% | pattern |
| 8464 | Aggregate | 1071.33 | 1128.74 | 5.4% | operator |
| 8465 | Sort | 1071.06 | 1835.96 | 71.4% | pattern |
| 8467 | Nested Loop | 1059.01 | 1188.57 | 12.2% | operator |
| 8479 | Hash | 3.53 | 18.67 | 428.5% | operator |
| 8468 | Hash Join | 216.72 | 253.07 | 16.8% | operator |
| 8478 | Index Scan | 0.07 | -0.22 | 397.3% | operator |
| 8480 | Seq Scan | 2.99 | 12.36 | 312.8% | operator |
| 8469 | Seq Scan | 165.80 | 159.81 | 3.6% | operator |
| 8470 | Hash | 37.03 | 46.85 | 26.5% | pattern |
| 8475 | Seq Scan | 0.01 | 11.81 | 147503.4% | operator |
| 8476 | Hash | 0.07 | 21.05 | 29552.4% | operator |
| 8477 | Seq Scan | 0.07 | 22.93 | 33625.5% | operator |
...
### Step 4: Node 8469 (Seq Scan) - LEAF
...
### Step 5: Node 8470 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 8461, 8462, 8463, 8465, 8466, 8471, 8472, 8473, 8474
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 8478 (Index Scan) - LEAF
...
### Step 8: Node 8480 (Seq Scan) - LEAF
...
### Step 11: Node 8465 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 8461, 8462, 8463, 8466, 8470, 8471, 8472, 8473, 8474
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 8461 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 8462, 8463, 8465, 8466, 8470, 8471, 8472, 8473, 8474
- **Input Features:**
