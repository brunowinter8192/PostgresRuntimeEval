...
**Test Query:** Q5_45_seed_360977364
...
```
Node 8681 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 8682 (Aggregate) [consumed]
    Node 8683 (Gather Merge) [consumed]
      Node 8684 (Aggregate)
        Node 8685 (Sort) [PATTERN: 3e2d5a00]
          Node 8686 (Hash Join) [consumed]
            Node 8687 (Nested Loop)
              Node 8688 (Hash Join)
                Node 8689 (Seq Scan) - LEAF
                Node 8690 (Hash) [PATTERN: 444761fb]
                  Node 8691 (Hash Join) [consumed]
                    Node 8692 (Seq Scan) [consumed] - LEAF
                    Node 8693 (Hash) [consumed]
                      Node 8694 (Hash Join) [consumed]
                        Node 8695 (Seq Scan) - LEAF
                        Node 8696 (Hash)
                          Node 8697 (Seq Scan) - LEAF
              Node 8698 (Index Scan) - LEAF
            Node 8699 (Hash)
              Node 8700 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 8690 | 8681, 8682, 8683, 8685, 8686, 8691, 8692, 8693, 8694 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 8681 | 8682, 8683, 8685, 8686, 8690, 8691, 8692, 8693, 8694 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 8685 | 8681, 8682, 8683, 8686, 8690, 8691, 8692, 8693, 8694 |
...
|------|------|--------|-----------|-----|--------|
| 8681 | Sort | 1077.83 | 2934.42 | 172.3% | pattern |
| 8684 | Aggregate | 1072.75 | 1128.79 | 5.2% | operator |
| 8685 | Sort | 1072.51 | 1835.90 | 71.2% | pattern |
| 8687 | Nested Loop | 1061.14 | 1188.37 | 12.0% | operator |
| 8699 | Hash | 2.76 | 18.67 | 575.8% | operator |
| 8688 | Hash Join | 219.10 | 253.07 | 15.5% | operator |
| 8698 | Index Scan | 0.07 | -0.22 | 397.3% | operator |
| 8700 | Seq Scan | 2.25 | 12.36 | 449.8% | operator |
| 8689 | Seq Scan | 170.00 | 159.81 | 6.0% | operator |
| 8690 | Hash | 34.69 | 46.85 | 35.1% | pattern |
| 8695 | Seq Scan | 0.01 | 11.81 | 131103.0% | operator |
| 8696 | Hash | 0.13 | 21.05 | 16477.4% | operator |
| 8697 | Seq Scan | 0.12 | 22.93 | 18394.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 8697 (Seq Scan) - LEAF
...
### Step 2: Node 8695 (Seq Scan) - LEAF
...
### Step 4: Node 8689 (Seq Scan) - LEAF
...
### Step 5: Node 8690 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 8681, 8682, 8683, 8685, 8686, 8691, 8692, 8693, 8694
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 8698 (Index Scan) - LEAF
...
### Step 8: Node 8700 (Seq Scan) - LEAF
...
### Step 11: Node 8685 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 8681, 8682, 8683, 8686, 8690, 8691, 8692, 8693, 8694
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 8681 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 8682, 8683, 8685, 8686, 8690, 8691, 8692, 8693, 8694
- **Input Features:**
