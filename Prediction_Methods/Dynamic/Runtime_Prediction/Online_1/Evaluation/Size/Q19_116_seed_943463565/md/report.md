...
```
Node 31339 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31340 (Gather) [consumed]
    Node 31341 (Aggregate) [consumed]
      Node 31342 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31339 | 31340, 31341 |
...
|------|------|--------|-----------|-----|--------|
| 31339 | Aggregate | 909.37 | 831.20 | 8.6% | pattern |
| 31342 | Hash Join | 890.13 | 766.05 | 13.9% | operator |
...
### Step 5: Node 31339 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31340, 31341
- **Input Features:**
