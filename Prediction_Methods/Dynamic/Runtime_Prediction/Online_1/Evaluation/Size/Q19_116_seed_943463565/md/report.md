...
**Test Query:** Q19_116_seed_943463565
...
```
Node 31339 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31340 (Gather) [consumed]
    Node 31341 (Aggregate) [consumed]
      Node 31342 (Hash Join) [consumed]
        Node 31343 (Seq Scan) - LEAF
        Node 31344 (Hash)
          Node 31345 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31339 | 31340, 31341, 31342 |
...
|------|------|--------|-----------|-----|--------|
| 31339 | Aggregate | 909.37 | 829.29 | 8.8% | pattern |
| 31343 | Seq Scan | 843.75 | 743.46 | 11.9% | operator |
| 31344 | Hash | 44.37 | 8.29 | 81.3% | operator |
| 31345 | Seq Scan | 44.22 | 23.76 | 46.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31345 (Seq Scan) - LEAF
...
### Step 2: Node 31343 (Seq Scan) - LEAF
...
### Step 4: Node 31339 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31340, 31341, 31342
- **Input Features:**
  ...
  - HashJoin_Outer_total_cost=156338.3900
