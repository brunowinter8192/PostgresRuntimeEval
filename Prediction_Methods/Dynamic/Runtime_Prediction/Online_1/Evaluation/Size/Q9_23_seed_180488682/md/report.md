...
```
Node 17829 (Sort) - ROOT
  Node 17830 (Aggregate)
    Node 17831 (Gather)
      Node 17832 (Aggregate)
        Node 17833 (Nested Loop)
          Node 17834 (Hash Join)
            Node 17835 (Seq Scan) - LEAF
            Node 17836 (Hash)
              Node 17837 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 17829 | Sort | 1191.50 | 1116.22 | 6.3% | operator |
| 17830 | Aggregate | 1191.37 | 901.35 | 24.3% | operator |
...
| 17834 | Hash Join | 967.91 | 631.63 | 34.7% | operator |
| 17846 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17835 | Seq Scan | 690.89 | 509.93 | 26.2% | operator |
| 17836 | Hash | 182.43 | 46.85 | 74.3% | operator |
| 17837 | Hash Join | 176.67 | 923.84 | 422.9% | operator |
...
### Step 10: Node 17835 (Seq Scan) - LEAF
...
### Step 13: Node 17846 (Index Scan) - LEAF
...
### Step 14: Node 17833 (Nested Loop)
