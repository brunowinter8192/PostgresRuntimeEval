...
**Test Query:** Q9_23_seed_180488682
...
```
Node 17829 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 17830 (Aggregate) [consumed]
    Node 17831 (Gather)
      Node 17832 (Aggregate)
        Node 17833 (Nested Loop)
          Node 17834 (Hash Join) [PATTERN: bb930825]
            Node 17835 (Seq Scan) [consumed] - LEAF
            Node 17836 (Hash) [consumed]
              Node 17837 (Hash Join) [consumed]
                Node 17838 (Hash Join)
                  Node 17839 (Nested Loop)
                    Node 17840 (Seq Scan) - LEAF
                    Node 17841 (Index Scan) - LEAF
                  Node 17842 (Hash)
                    Node 17843 (Seq Scan) - LEAF
                Node 17844 (Hash)
                  Node 17845 (Seq Scan) - LEAF
          Node 17846 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17834 | 17829, 17830, 17835, 17836, 17837 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17829 | 17830, 17834, 17835, 17836, 17837 |
...
|------|------|--------|-----------|-----|--------|
| 17829 | Sort | 1191.50 | 1049.52 | 11.9% | pattern |
| 17831 | Gather | 1190.13 | 941.00 | 20.9% | operator |
| 17832 | Aggregate | 1169.31 | 1141.96 | 2.3% | operator |
| 17833 | Nested Loop | 1145.01 | 1252.17 | 9.4% | operator |
| 17834 | Hash Join | 967.91 | 134.80 | 86.1% | pattern |
| 17846 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17838 | Hash Join | 161.98 | 837.31 | 416.9% | operator |
| 17844 | Hash | 14.09 | 14.95 | 6.1% | operator |
| 17839 | Nested Loop | 156.61 | 1251.76 | 699.3% | operator |
| 17842 | Hash | 3.28 | 15.94 | 385.8% | operator |
| 17845 | Seq Scan | 14.07 | 2.94 | 79.1% | operator |
| 17840 | Seq Scan | 19.24 | 44.65 | 132.1% | operator |
| 17841 | Index Scan | 0.08 | -1.39 | 1926.9% | operator |
| 17843 | Seq Scan | 2.74 | 9.45 | 244.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 17840 (Seq Scan) - LEAF
...
### Step 2: Node 17841 (Index Scan) - LEAF
...
### Step 3: Node 17843 (Seq Scan) - LEAF
...
### Step 6: Node 17845 (Seq Scan) - LEAF
...
### Step 9: Node 17834 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17829, 17830, 17835, 17836, 17837
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17846 (Index Scan) - LEAF
...
### Step 11: Node 17833 (Nested Loop)
...
### Step 14: Node 17829 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17830, 17834, 17835, 17836, 17837
- **Input Features:**
