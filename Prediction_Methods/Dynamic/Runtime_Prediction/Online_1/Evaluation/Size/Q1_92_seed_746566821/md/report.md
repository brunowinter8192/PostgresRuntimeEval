...
Node 706 (Aggregate) - ROOT
  Node 707 (Gather Merge)
    Node 708 (Sort) [PATTERN: 1d35fb97]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 708 | 709 |
...
|------|------|--------|-----------|-----|--------|
| 706 | Aggregate | 927.11 | 1195.95 | 29.0% | operator |
| 707 | Gather Merge | 927.06 | 1165.92 | 25.8% | operator |
| 708 | Sort | 910.08 | 1200.75 | 31.9% | pattern |
...
### Step 2: Node 708 (Sort) - PATTERN ROOT
...
### Step 4: Node 706 (Aggregate) - ROOT
