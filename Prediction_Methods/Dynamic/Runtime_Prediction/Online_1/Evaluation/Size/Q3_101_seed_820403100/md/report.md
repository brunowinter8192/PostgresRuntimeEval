    ...
    Node 4363 (Aggregate) [consumed]
      Node 4364 (Gather) [consumed]
        Node 4365 (Nested Loop)
          Node 4366 (Hash Join) [PATTERN: 895c6e8c]
            Node 4367 (Seq Scan) [consumed] - LEAF
            Node 4368 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4361 | 4362, 4363, 4364, 4366, 4367, 4368 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4366 | 4361, 4362, 4363, 4364, 4367, 4368 |
...
| 4365 | Nested Loop | 1149.55 | 1192.53 | 3.7% | operator |
| 4366 | Hash Join | 208.87 | 242.38 | 16.0% | pattern |
...
### Step 2: Node 4366 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4361, 4362, 4363, 4364, 4367, 4368
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46114
  - HashJoin_nt1=232493
...
- **Output:** st=29.80, rt=242.38

### Step 3: Node 4370 (Index Scan) - LEAF
...
- **Output:** st=121.31, rt=1192.53

### Step 5: Node 4361 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4362, 4363, 4364, 4366, 4367, 4368
- **Input Features:**
