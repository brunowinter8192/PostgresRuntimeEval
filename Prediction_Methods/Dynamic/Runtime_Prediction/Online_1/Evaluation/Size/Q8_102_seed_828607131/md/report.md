...
**Test Query:** Q8_102_seed_828607131
...
```
Node 13247 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 13248 (Gather Merge) [consumed]
    Node 13249 (Sort)
      Node 13250 (Hash Join)
        Node 13251 (Nested Loop)
          Node 13252 (Hash Join)
            Node 13253 (Nested Loop)
              Node 13254 (Hash Join)
                Node 13255 (Seq Scan) - LEAF
                Node 13256 (Hash) [PATTERN: 444761fb]
                  Node 13257 (Hash Join) [consumed]
                    Node 13258 (Seq Scan) [consumed] - LEAF
                    Node 13259 (Hash) [consumed]
                      Node 13260 (Hash Join) [consumed]
                        Node 13261 (Seq Scan) - LEAF
                        Node 13262 (Hash)
                          Node 13263 (Seq Scan) - LEAF
              Node 13264 (Index Scan) - LEAF
            Node 13265 (Hash)
              Node 13266 (Seq Scan) - LEAF
          Node 13267 (Index Scan) - LEAF
        Node 13268 (Hash)
          Node 13269 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 13256 | 13247, 13248, 13257, 13258, 13259, 13260 |
| Aggregate -> Gather Merge (Out | 2724c080 | 13247 | 13248, 13256, 13257, 13258, 13259, 13260 |
...
|------|------|--------|-----------|-----|--------|
| 13247 | Aggregate | 1200.03 | 1128.80 | 5.9% | pattern |
| 13249 | Sort | 1192.20 | 1046.21 | 12.2% | operator |
| 13250 | Hash Join | 1191.91 | 785.61 | 34.1% | operator |
| 13251 | Nested Loop | 1191.55 | 1198.29 | 0.6% | operator |
| 13268 | Hash | 0.02 | 13.72 | 57083.7% | operator |
| 13252 | Hash Join | 1187.53 | 785.60 | 33.8% | operator |
| 13267 | Index Scan | 0.01 | 12.42 | 206958.1% | operator |
| 13269 | Seq Scan | 0.02 | 6.51 | 38205.7% | operator |
| 13253 | Nested Loop | 1148.24 | 1198.29 | 4.4% | operator |
| 13265 | Hash | 34.80 | 19.97 | 42.6% | operator |
| 13254 | Hash Join | 206.30 | 251.67 | 22.0% | operator |
| 13264 | Index Scan | 0.04 | 2.88 | 7102.1% | operator |
| 13266 | Seq Scan | 34.68 | 48.87 | 40.9% | operator |
| 13255 | Seq Scan | 158.28 | 159.67 | 0.9% | operator |
| 13256 | Hash | 30.60 | 43.51 | 42.2% | pattern |
| 13261 | Seq Scan | 0.01 | 12.22 | 122149.4% | operator |
| 13262 | Hash | 2.08 | 18.14 | 773.6% | operator |
| 13263 | Seq Scan | 2.07 | 23.36 | 1028.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 13263 (Seq Scan) - LEAF
...
### Step 2: Node 13261 (Seq Scan) - LEAF
...
### Step 4: Node 13255 (Seq Scan) - LEAF
...
### Step 5: Node 13256 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 13247, 13248, 13257, 13258, 13259, 13260
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 13264 (Index Scan) - LEAF
...
### Step 8: Node 13266 (Seq Scan) - LEAF
...
### Step 12: Node 13267 (Index Scan) - LEAF
...
### Step 13: Node 13269 (Seq Scan) - LEAF
...
### Step 14: Node 13251 (Nested Loop)
...
### Step 18: Node 13247 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 13248, 13256, 13257, 13258, 13259, 13260
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2504
