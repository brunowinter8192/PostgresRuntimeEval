...
**Test Query:** Q8_42_seed_336365271
...
Node 15179 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 15180 (Gather Merge) [consumed]
    Node 15181 (Sort)
      Node 15182 (Hash Join)
        Node 15183 (Nested Loop)
          Node 15184 (Hash Join)
            Node 15185 (Nested Loop)
              Node 15186 (Hash Join)
                Node 15187 (Seq Scan) - LEAF
                Node 15188 (Hash) [PATTERN: 444761fb]
                  Node 15189 (Hash Join) [consumed]
                    Node 15190 (Seq Scan) [consumed] - LEAF
                    Node 15191 (Hash) [consumed]
                      Node 15192 (Hash Join) [consumed]
                        Node 15193 (Seq Scan) - LEAF
                        Node 15194 (Hash)
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 15188 | 15179, 15180, 15189, 15190, 15191, 15192 |
| Aggregate -> Gather Merge (Out | 2724c080 | 15179 | 15180, 15188, 15189, 15190, 15191, 15192 |
...
|------|------|--------|-----------|-----|--------|
| 15179 | Aggregate | 1258.83 | 1131.04 | 10.2% | pattern |
| 15181 | Sort | 1251.25 | 1046.21 | 16.4% | operator |
| 15182 | Hash Join | 1250.99 | 785.61 | 37.2% | operator |
| 15183 | Nested Loop | 1250.68 | 1198.29 | 4.2% | operator |
| 15200 | Hash | 0.01 | 13.72 | 105469.9% | operator |
| 15184 | Hash Join | 1246.53 | 785.60 | 37.0% | operator |
| 15199 | Index Scan | 0.01 | 12.42 | 206958.1% | operator |
| 15201 | Seq Scan | 0.01 | 6.51 | 65019.6% | operator |
| 15185 | Nested Loop | 1203.23 | 1198.29 | 0.4% | operator |
| 15197 | Hash | 38.75 | 19.97 | 48.5% | operator |
| 15186 | Hash Join | 217.49 | 251.67 | 15.7% | operator |
| 15196 | Index Scan | 0.04 | 2.88 | 6599.7% | operator |
| 15198 | Seq Scan | 38.65 | 48.87 | 26.4% | operator |
| 15187 | Seq Scan | 162.20 | 159.67 | 1.6% | operator |
| 15188 | Hash | 36.48 | 43.51 | 19.3% | pattern |
| 15193 | Seq Scan | 0.01 | 12.22 | 135732.7% | operator |
| 15194 | Hash | 0.14 | 18.14 | 13340.1% | operator |
| 15195 | Seq Scan | 0.13 | 23.36 | 17465.6% | operator |
...
### Step 2: Node 15193 (Seq Scan) - LEAF
...
### Step 4: Node 15187 (Seq Scan) - LEAF
...
### Step 5: Node 15188 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 15179, 15180, 15189, 15190, 15191, 15192
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 15196 (Index Scan) - LEAF
...
### Step 8: Node 15198 (Seq Scan) - LEAF
...
### Step 12: Node 15199 (Index Scan) - LEAF
...
### Step 13: Node 15201 (Seq Scan) - LEAF
...
### Step 14: Node 15183 (Nested Loop)
...
### Step 18: Node 15179 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 15180, 15188, 15189, 15190, 15191, 15192
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2458
