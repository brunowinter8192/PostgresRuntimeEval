...
```
Node 15179 (Aggregate) - ROOT
  Node 15180 (Gather Merge)
    Node 15181 (Sort)
          ...
          Node 15184 (Hash Join)
            Node 15185 (Nested Loop)
              Node 15186 (Hash Join)
                ...
                Node 15188 (Hash)
                  Node 15189 (Hash Join)
                    Node 15190 (Seq Scan) - LEAF
                    Node 15191 (Hash)
                      Node 15192 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 15179 | Aggregate | 1258.83 | 1190.97 | 5.4% | operator |
| 15180 | Gather Merge | 1258.37 | 1097.16 | 12.8% | operator |
...
| 15186 | Hash Join | 217.49 | 251.17 | 15.5% | operator |
...
| 15188 | Hash | 36.48 | 20.62 | 43.5% | operator |
| 15189 | Hash Join | 35.72 | 132.26 | 270.2% | operator |
| 15190 | Seq Scan | 34.25 | 23.03 | 32.8% | operator |
| 15191 | Hash | 0.15 | 23.66 | 15261.1% | operator |
| 15192 | Hash Join | 0.15 | 306.84 | 203102.6% | operator |
...
### Step 5: Node 15190 (Seq Scan) - LEAF
...
### Step 8: Node 15187 (Seq Scan) - LEAF
...
### Step 11: Node 15196 (Index Scan) - LEAF
...
### Step 12: Node 15198 (Seq Scan) - LEAF
...
### Step 13: Node 15185 (Nested Loop)
...
### Step 16: Node 15199 (Index Scan) - LEAF
...
### Step 17: Node 15201 (Seq Scan) - LEAF
...
### Step 18: Node 15183 (Nested Loop)
...
### Step 22: Node 15180 (Gather Merge)
...
### Step 23: Node 15179 (Aggregate) - ROOT
