...
**Test Query:** Q13_137_seed_1115748216
...
```
Node 25650 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25651 (Aggregate) [consumed]
    Node 25652 (Aggregate)
      Node 25653 (Hash Join) [PATTERN: 895c6e8c]
        Node 25654 (Seq Scan) [consumed] - LEAF
        Node 25655 (Hash) [consumed]
          Node 25656 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25650 | 25651, 25653, 25654, 25655 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25653 | 25650, 25651, 25654, 25655 |
...
|------|------|--------|-----------|-----|--------|
| 25650 | Sort | 902.56 | 1079.94 | 19.7% | pattern |
| 25652 | Aggregate | 896.50 | 999.76 | 11.5% | operator |
| 25653 | Hash Join | 688.72 | 470.31 | 31.7% | pattern |
| 25656 | Index Only Scan | 10.13 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25656 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25653 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25650, 25651, 25654, 25655
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 25650 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25651, 25653, 25654, 25655
- **Input Features:**
