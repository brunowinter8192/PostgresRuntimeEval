...
```
Node 24404 (Aggregate) - ROOT
  Node 24405 (Gather Merge)
...
|------|------|--------|-----------|-----|--------|
| 24404 | Aggregate | 990.31 | 919.05 | 7.2% | operator |
| 24405 | Gather Merge | 990.30 | 1111.84 | 12.3% | operator |
| 24406 | Aggregate | 968.92 | 895.30 | 7.6% | operator |
| 24407 | Sort | 968.29 | 1092.82 | 12.9% | operator |
| 24408 | Nested Loop | 966.91 | 1127.41 | 16.6% | operator |
| 24409 | Seq Scan | 835.05 | 745.19 | 10.8% | operator |
| 24410 | Index Scan | 0.03 | 0.07 | 187.5% | operator |
...
### Step 6: Node 24405 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=868.9391
  - st2=0.0000
  - startup_cost=148558.4000
  - total_cost=148678.6900
- **Output:** st=1109.22, rt=1111.84

### Step 7: Node 24404 (Aggregate) - ROOT
