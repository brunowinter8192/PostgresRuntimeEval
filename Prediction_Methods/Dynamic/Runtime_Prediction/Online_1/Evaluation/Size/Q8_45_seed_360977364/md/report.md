...
**Test Query:** Q8_45_seed_360977364
...
```
Node 15248 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 15249 (Gather Merge) [consumed]
    Node 15250 (Sort)
      Node 15251 (Hash Join)
        Node 15252 (Nested Loop)
          Node 15253 (Hash Join)
            Node 15254 (Nested Loop)
              Node 15255 (Hash Join)
                Node 15256 (Seq Scan) - LEAF
                Node 15257 (Hash) [PATTERN: 444761fb]
                  Node 15258 (Hash Join) [consumed]
                    Node 15259 (Seq Scan) [consumed] - LEAF
                    Node 15260 (Hash) [consumed]
                      Node 15261 (Hash Join) [consumed]
                        Node 15262 (Seq Scan) - LEAF
                        Node 15263 (Hash)
                          Node 15264 (Seq Scan) - LEAF
              Node 15265 (Index Scan) - LEAF
            Node 15266 (Hash)
              Node 15267 (Seq Scan) - LEAF
          Node 15268 (Index Scan) - LEAF
        Node 15269 (Hash)
          Node 15270 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 15257 | 15248, 15249, 15258, 15259, 15260, 15261 |
| Aggregate -> Gather Merge (Out | 2724c080 | 15248 | 15249, 15257, 15258, 15259, 15260, 15261 |
...
|------|------|--------|-----------|-----|--------|
| 15248 | Aggregate | 1207.99 | 1132.96 | 6.2% | pattern |
| 15250 | Sort | 1202.10 | 1046.21 | 13.0% | operator |
| 15251 | Hash Join | 1201.85 | 785.61 | 34.6% | operator |
| 15252 | Nested Loop | 1201.52 | 1198.29 | 0.3% | operator |
| 15269 | Hash | 0.01 | 13.72 | 105469.9% | operator |
| 15253 | Hash Join | 1197.70 | 785.60 | 34.4% | operator |
| 15268 | Index Scan | 0.01 | 12.42 | 206958.1% | operator |
| 15270 | Seq Scan | 0.01 | 6.51 | 65019.6% | operator |
| 15254 | Nested Loop | 1151.79 | 1198.29 | 4.0% | operator |
| 15266 | Hash | 41.42 | 19.97 | 51.8% | operator |
| 15255 | Hash Join | 216.84 | 251.67 | 16.1% | operator |
| 15265 | Index Scan | 0.04 | 2.88 | 7102.1% | operator |
| 15267 | Seq Scan | 41.35 | 48.87 | 18.2% | operator |
| 15256 | Seq Scan | 160.71 | 159.67 | 0.6% | operator |
| 15257 | Hash | 38.05 | 43.51 | 14.4% | pattern |
| 15262 | Seq Scan | 0.01 | 12.22 | 122149.4% | operator |
| 15263 | Hash | 0.19 | 18.14 | 9399.6% | operator |
| 15264 | Seq Scan | 0.19 | 23.36 | 12393.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 15264 (Seq Scan) - LEAF
...
### Step 2: Node 15262 (Seq Scan) - LEAF
...
### Step 4: Node 15256 (Seq Scan) - LEAF
...
### Step 5: Node 15257 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 15248, 15249, 15258, 15259, 15260, 15261
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 15265 (Index Scan) - LEAF
...
### Step 8: Node 15267 (Seq Scan) - LEAF
...
### Step 12: Node 15268 (Index Scan) - LEAF
...
### Step 13: Node 15270 (Seq Scan) - LEAF
...
### Step 14: Node 15252 (Nested Loop)
...
### Step 18: Node 15248 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 15249, 15257, 15258, 15259, 15260, 15261
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2420
