    ...
    Node 20477 (Aggregate) [consumed]
      Node 20478 (Gather) [consumed]
        Node 20479 (Hash Join)
          Node 20480 (Hash Join)
            Node 20481 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20475 | 20476, 20477, 20478 |
...
| 20479 | Hash Join | 1113.00 | 1007.16 | 9.5% | operator |
| 20480 | Hash Join | 1110.08 | 1004.03 | 9.6% | operator |
| 20486 | Hash | 0.01 | 15.71 | 104638.5% | operator |
| 20481 | Nested Loop | 1062.00 | 1204.85 | 13.5% | operator |
| 20484 | Hash | 36.43 | 55.57 | 52.5% | operator |
...
### Step 6: Node 20487 (Seq Scan) - LEAF
...
### Step 10: Node 20475 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20476, 20477, 20478
- **Input Features:**
