...
**Test Query:** Q13_41_seed_328161240
...
```
Node 25965 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25966 (Aggregate) [consumed]
    Node 25967 (Aggregate)
      Node 25968 (Hash Join) [PATTERN: 895c6e8c]
        Node 25969 (Seq Scan) [consumed] - LEAF
        Node 25970 (Hash) [consumed]
          Node 25971 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25965 | 25966, 25968, 25969, 25970 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25968 | 25965, 25966, 25969, 25970 |
...
|------|------|--------|-----------|-----|--------|
| 25965 | Sort | 903.52 | 1079.93 | 19.5% | pattern |
| 25967 | Aggregate | 897.59 | 999.15 | 11.3% | operator |
| 25968 | Hash Join | 687.36 | 470.31 | 31.6% | pattern |
| 25971 | Index Only Scan | 9.23 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25971 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25968 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25965, 25966, 25969, 25970
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1478958
...
### Step 4: Node 25965 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25966, 25968, 25969, 25970
- **Input Features:**
