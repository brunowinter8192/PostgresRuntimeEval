...
**Test Query:** Q8_144_seed_1173176433
...
Node 14305 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 14306 (Gather Merge) [consumed]
    Node 14307 (Sort)
      Node 14308 (Hash Join)
        Node 14309 (Nested Loop)
          Node 14310 (Hash Join)
            Node 14311 (Nested Loop)
              Node 14312 (Hash Join)
                Node 14313 (Seq Scan) - LEAF
                Node 14314 (Hash) [PATTERN: 444761fb]
                  Node 14315 (Hash Join) [consumed]
                    Node 14316 (Seq Scan) [consumed] - LEAF
                    Node 14317 (Hash) [consumed]
                      Node 14318 (Hash Join) [consumed]
                        Node 14319 (Seq Scan) - LEAF
                        Node 14320 (Hash)
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 14314 | 14305, 14306, 14315, 14316, 14317, 14318 |
| Aggregate -> Gather Merge (Out | 2724c080 | 14305 | 14306, 14314, 14315, 14316, 14317, 14318 |
...
|------|------|--------|-----------|-----|--------|
| 14305 | Aggregate | 1230.85 | 1131.48 | 8.1% | pattern |
| 14307 | Sort | 1224.97 | 1046.21 | 14.6% | operator |
| 14308 | Hash Join | 1224.74 | 785.61 | 35.9% | operator |
| 14309 | Nested Loop | 1224.43 | 1198.29 | 2.1% | operator |
| 14326 | Hash | 0.02 | 13.72 | 80629.9% | operator |
| 14310 | Hash Join | 1220.55 | 785.60 | 35.6% | operator |
| 14325 | Index Scan | 0.01 | 12.42 | 206958.1% | operator |
| 14327 | Seq Scan | 0.01 | 6.51 | 54166.4% | operator |
| 14311 | Nested Loop | 1175.15 | 1198.29 | 2.0% | operator |
| 14323 | Hash | 40.93 | 19.97 | 51.2% | operator |
| 14312 | Hash Join | 216.53 | 251.67 | 16.2% | operator |
| 14322 | Index Scan | 0.04 | 2.88 | 6759.2% | operator |
| 14324 | Seq Scan | 40.83 | 48.87 | 19.7% | operator |
| 14313 | Seq Scan | 160.73 | 159.67 | 0.7% | operator |
| 14314 | Hash | 36.36 | 43.51 | 19.7% | pattern |
| 14319 | Seq Scan | 0.01 | 12.22 | 135732.7% | operator |
| 14320 | Hash | 0.17 | 18.14 | 10636.2% | operator |
| 14321 | Seq Scan | 0.17 | 23.36 | 14058.9% | operator |
...
### Step 2: Node 14319 (Seq Scan) - LEAF
...
### Step 4: Node 14313 (Seq Scan) - LEAF
...
### Step 5: Node 14314 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 14305, 14306, 14315, 14316, 14317, 14318
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 14322 (Index Scan) - LEAF
...
### Step 8: Node 14324 (Seq Scan) - LEAF
...
### Step 12: Node 14325 (Index Scan) - LEAF
...
### Step 13: Node 14327 (Seq Scan) - LEAF
...
### Step 14: Node 14309 (Nested Loop)
...
### Step 18: Node 14305 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 14306, 14314, 14315, 14316, 14317, 14318
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2449
