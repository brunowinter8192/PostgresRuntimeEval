...
**Test Query:** Q14_130_seed_1058319999
...
```
Node 26651 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26652 (Gather) [consumed]
    Node 26653 (Aggregate) [consumed]
      Node 26654 (Hash Join) [consumed]
        Node 26655 (Seq Scan) - LEAF
        Node 26656 (Hash)
          Node 26657 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26651 | 26652, 26653, 26654 |
...
|------|------|--------|-----------|-----|--------|
| 26651 | Aggregate | 823.17 | 857.13 | 4.1% | pattern |
| 26655 | Seq Scan | 748.72 | 758.48 | 1.3% | operator |
| 26656 | Hash | 43.34 | 9.38 | 78.4% | operator |
| 26657 | Seq Scan | 36.66 | 12.70 | 65.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26657 (Seq Scan) - LEAF
...
### Step 2: Node 26655 (Seq Scan) - LEAF
...
### Step 4: Node 26651 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26652, 26653, 26654
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=15008
  - HashJoin_Outer_nt1=15008
  ...
  - HashJoin_Outer_total_cost=136646.0400
- **Output:** st=850.76, rt=857.13
