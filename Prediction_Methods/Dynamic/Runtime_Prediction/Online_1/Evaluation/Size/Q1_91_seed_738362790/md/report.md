...
**Test Query:** Q1_91_seed_738362790
...
```
Node 701 (Aggregate) - ROOT
  Node 702 (Gather Merge)
    Node 703 (Sort) [PATTERN: 1d35fb97]
      Node 704 (Aggregate) [consumed]
        Node 705 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 703 | 704 |
...
|------|------|--------|-----------|-----|--------|
| 701 | Aggregate | 948.95 | 1195.98 | 26.0% | operator |
| 702 | Gather Merge | 948.91 | 1165.93 | 22.9% | operator |
| 703 | Sort | 930.84 | 1200.85 | 29.0% | pattern |
| 705 | Seq Scan | 510.55 | 678.94 | 33.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 705 (Seq Scan) - LEAF
...
- **Output:** st=0.85, rt=678.94

### Step 2: Node 703 (Sort) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=169199.3200
  - Sort_total_cost=169199.3300
- **Output:** st=1196.76, rt=1200.85

### Step 3: Node 702 (Gather Merge)
...
### Step 4: Node 701 (Aggregate) - ROOT
