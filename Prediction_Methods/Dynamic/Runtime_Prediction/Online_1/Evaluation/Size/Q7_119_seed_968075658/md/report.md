...
```
Node 10861 (Aggregate) - ROOT
  Node 10862 (Gather Merge)
    Node 10863 (Sort)
      Node 10864 (Hash Join)
        Node 10865 (Nested Loop)
          Node 10866 (Hash Join)
            Node 10867 (Seq Scan) - LEAF
            Node 10868 (Hash)
              Node 10869 (Hash Join)
                Node 10870 (Seq Scan) - LEAF
                Node 10871 (Hash)
                  Node 10872 (Seq Scan) - LEAF
          Node 10873 (Index Scan) - LEAF
        Node 10874 (Hash)
          Node 10875 (Hash Join)
            Node 10876 (Seq Scan) - LEAF
            Node 10877 (Hash)
              Node 10878 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 10861 | Aggregate | 1205.63 | 1209.26 | 0.3% | operator |
| 10862 | Gather Merge | 1204.47 | 1142.98 | 5.1% | operator |
| 10863 | Sort | 1198.12 | 1109.13 | 7.4% | operator |
| 10864 | Hash Join | 1197.41 | 842.59 | 29.6% | operator |
| 10865 | Nested Loop | 1186.81 | 1216.16 | 2.5% | operator |
| 10874 | Hash | 6.69 | 17.53 | 162.1% | operator |
| 10866 | Hash Join | 212.58 | 384.47 | 80.9% | operator |
| 10873 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 10875 | Hash Join | 6.64 | 85.17 | 1182.9% | operator |
| 10867 | Seq Scan | 154.61 | 201.16 | 30.1% | operator |
| 10868 | Hash | 31.71 | 19.59 | 38.2% | operator |
| 10876 | Seq Scan | 6.30 | 11.47 | 82.1% | operator |
| 10877 | Hash | 0.01 | 16.89 | 129854.5% | operator |
| 10869 | Hash Join | 31.38 | 92.20 | 193.9% | operator |
| 10878 | Seq Scan | 0.01 | 45.79 | 457823.2% | operator |
| 10870 | Seq Scan | 30.26 | 21.86 | 27.8% | operator |
| 10871 | Hash | 0.01 | 16.89 | 140684.0% | operator |
| 10872 | Seq Scan | 0.01 | 45.79 | 572303.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10872 (Seq Scan) - LEAF
...
### Step 2: Node 10870 (Seq Scan) - LEAF
...
### Step 5: Node 10878 (Seq Scan) - LEAF
...
### Step 6: Node 10867 (Seq Scan) - LEAF
...
### Step 8: Node 10876 (Seq Scan) - LEAF
...
### Step 11: Node 10873 (Index Scan) - LEAF
...
### Step 13: Node 10865 (Nested Loop)
...
### Step 17: Node 10862 (Gather Merge)
...
### Step 18: Node 10861 (Aggregate) - ROOT
