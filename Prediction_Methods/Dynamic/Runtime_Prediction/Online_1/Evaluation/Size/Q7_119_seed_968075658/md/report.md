...
**Test Query:** Q7_119_seed_968075658
...
```
Node 10861 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 10862 (Gather Merge) [consumed]
    Node 10863 (Sort)
      Node 10864 (Hash Join)
        Node 10865 (Nested Loop)
          Node 10866 (Hash Join) [PATTERN: 895c6e8c]
            Node 10867 (Seq Scan) [consumed] - LEAF
            Node 10868 (Hash) [consumed]
              Node 10869 (Hash Join) [PATTERN: f4cb205a]
                Node 10870 (Seq Scan) [consumed] - LEAF
                Node 10871 (Hash) [consumed]
                  Node 10872 (Seq Scan) [consumed] - LEAF
          Node 10873 (Index Scan) - LEAF
        Node 10874 (Hash)
          Node 10875 (Hash Join) [PATTERN: f4cb205a]
            Node 10876 (Seq Scan) [consumed] - LEAF
            Node 10877 (Hash) [consumed]
              Node 10878 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 10869 | 10861, 10862, 10866, 10867, 10868, 10870, 10871, 10872, 10875, 10876, 10877, 10878 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 10875 | 10861, 10862, 10866, 10867, 10868, 10869, 10870, 10871, 10872, 10876, 10877, 10878 |
| Aggregate -> Gather Merge (Out | 2724c080 | 10861 | 10862, 10866, 10867, 10868, 10869, 10870, 10871, 10872, 10875, 10876, 10877, 10878 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 10866 | 10861, 10862, 10867, 10868, 10869, 10870, 10871, 10872, 10875, 10876, 10877, 10878 |
...
|------|------|--------|-----------|-----|--------|
| 10861 | Aggregate | 1205.63 | 1163.13 | 3.5% | pattern |
| 10863 | Sort | 1198.12 | 1109.16 | 7.4% | operator |
| 10864 | Hash Join | 1197.41 | 843.11 | 29.6% | operator |
| 10865 | Nested Loop | 1186.81 | 1215.99 | 2.5% | operator |
| 10874 | Hash | 6.69 | 27.74 | 314.8% | operator |
| 10866 | Hash Join | 212.58 | 304.89 | 43.4% | pattern |
| 10873 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 10875 | Hash Join | 6.64 | 429.36 | 6367.3% | pattern |
| 10869 | Hash Join | 31.38 | 429.38 | 1268.5% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10869 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 10861, 10862, 10866, 10867, 10868, 10870, 10871, 10872, 10875, 10876, 10877, 10878
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5000
  - HashJoin_nt1=62500
...
### Step 2: Node 10866 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 10861, 10862, 10867, 10868, 10869, 10870, 10871, 10872, 10875, 10876, 10877, 10878
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=38710
  - HashJoin_nt1=483871
...
### Step 3: Node 10873 (Index Scan) - LEAF
...
### Step 4: Node 10875 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 10861, 10862, 10866, 10867, 10868, 10869, 10870, 10871, 10872, 10876, 10877, 10878
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=800
  - HashJoin_nt1=10000
...
### Step 9: Node 10861 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 10862, 10866, 10867, 10868, 10869, 10870, 10871, 10872, 10875, 10876, 10877, 10878
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
