...
**Test Query:** Q1_139_seed_1132156278
...
```
Node 211 (Aggregate) - ROOT
  Node 212 (Gather Merge)
    Node 213 (Sort) [PATTERN: 1d35fb97]
      Node 214 (Aggregate) [consumed]
        Node 215 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 213 | 214 |
...
|------|------|--------|-----------|-----|--------|
| 211 | Aggregate | 1024.36 | 1195.85 | 16.7% | operator |
| 212 | Gather Merge | 1024.32 | 1165.90 | 13.8% | operator |
| 213 | Sort | 1004.18 | 1200.37 | 19.5% | pattern |
| 215 | Seq Scan | 556.33 | 680.77 | 22.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 215 (Seq Scan) - LEAF
...
### Step 2: Node 213 (Sort) - PATTERN ROOT
...
### Step 4: Node 211 (Aggregate) - ROOT
