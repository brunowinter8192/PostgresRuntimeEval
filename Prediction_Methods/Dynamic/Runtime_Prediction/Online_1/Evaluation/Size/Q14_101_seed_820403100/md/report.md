...
**Test Query:** Q14_101_seed_820403100
...
```
Node 26427 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26428 (Gather) [consumed]
    Node 26429 (Aggregate) [consumed]
      Node 26430 (Hash Join) [consumed]
        Node 26431 (Seq Scan) - LEAF
        Node 26432 (Hash)
          Node 26433 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26427 | 26428, 26429, 26430 |
...
|------|------|--------|-----------|-----|--------|
| 26427 | Aggregate | 823.69 | 857.14 | 4.1% | pattern |
| 26431 | Seq Scan | 750.98 | 758.50 | 1.0% | operator |
| 26432 | Hash | 43.87 | 9.38 | 78.6% | operator |
| 26433 | Seq Scan | 38.50 | 12.70 | 67.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26433 (Seq Scan) - LEAF
...
### Step 2: Node 26431 (Seq Scan) - LEAF
...
### Step 4: Node 26427 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26428, 26429, 26430
- **Input Features:**
