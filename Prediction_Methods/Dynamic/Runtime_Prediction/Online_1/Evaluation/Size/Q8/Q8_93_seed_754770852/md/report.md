...
```
Node 16467 (Aggregate) - ROOT
  Node 16468 (Gather Merge)
    Node 16469 (Sort)
          ...
          Node 16472 (Hash Join)
            Node 16473 (Nested Loop)
              Node 16474 (Hash Join)
                ...
                Node 16476 (Hash)
                  Node 16477 (Hash Join)
                    Node 16478 (Seq Scan) - LEAF
                    Node 16479 (Hash)
                      Node 16480 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 16467 | Aggregate | 1205.65 | 1194.99 | 0.9% | operator |
| 16468 | Gather Merge | 1205.25 | 1097.15 | 9.0% | operator |
...
| 16474 | Hash Join | 209.64 | 251.17 | 19.8% | operator |
...
| 16476 | Hash | 31.98 | 20.62 | 35.5% | operator |
| 16477 | Hash Join | 31.34 | 132.26 | 322.1% | operator |
| 16478 | Seq Scan | 29.78 | 23.03 | 22.7% | operator |
| 16479 | Hash | 0.23 | 23.66 | 10413.8% | operator |
| 16480 | Hash Join | 0.22 | 306.84 | 138114.4% | operator |
...
### Step 5: Node 16478 (Seq Scan) - LEAF
...
### Step 8: Node 16475 (Seq Scan) - LEAF
...
### Step 11: Node 16484 (Index Scan) - LEAF
...
### Step 12: Node 16486 (Seq Scan) - LEAF
...
### Step 13: Node 16473 (Nested Loop)
...
### Step 16: Node 16487 (Index Scan) - LEAF
...
### Step 17: Node 16489 (Seq Scan) - LEAF
...
### Step 18: Node 16471 (Nested Loop)
...
### Step 22: Node 16468 (Gather Merge)
...
### Step 23: Node 16467 (Aggregate) - ROOT
