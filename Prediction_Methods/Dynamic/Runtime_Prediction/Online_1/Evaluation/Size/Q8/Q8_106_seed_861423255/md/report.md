...
```
Node 13339 (Aggregate) - ROOT
  Node 13340 (Gather Merge)
    Node 13341 (Sort)
          ...
          Node 13344 (Hash Join)
            Node 13345 (Nested Loop)
              Node 13346 (Hash Join)
                ...
                Node 13348 (Hash)
                  Node 13349 (Hash Join)
                    Node 13350 (Seq Scan) - LEAF
                    Node 13351 (Hash)
                      Node 13352 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 13339 | Aggregate | 1180.90 | 1195.83 | 1.3% | operator |
| 13340 | Gather Merge | 1180.51 | 1097.14 | 7.1% | operator |
...
| 13346 | Hash Join | 204.48 | 251.17 | 22.8% | operator |
...
| 13348 | Hash | 29.36 | 20.62 | 29.8% | operator |
| 13349 | Hash Join | 28.70 | 132.26 | 360.8% | operator |
| 13350 | Seq Scan | 27.13 | 23.03 | 15.1% | operator |
| 13351 | Hash | 0.21 | 23.66 | 11164.8% | operator |
| 13352 | Hash Join | 0.21 | 306.84 | 148129.9% | operator |
...
### Step 5: Node 13350 (Seq Scan) - LEAF
...
### Step 8: Node 13347 (Seq Scan) - LEAF
...
### Step 11: Node 13356 (Index Scan) - LEAF
...
### Step 12: Node 13358 (Seq Scan) - LEAF
...
### Step 13: Node 13345 (Nested Loop)
...
### Step 16: Node 13359 (Index Scan) - LEAF
...
### Step 17: Node 13361 (Seq Scan) - LEAF
...
### Step 18: Node 13343 (Nested Loop)
...
### Step 22: Node 13340 (Gather Merge)
...
### Step 23: Node 13339 (Aggregate) - ROOT
