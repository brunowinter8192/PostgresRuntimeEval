...
```
Node 13937 (Aggregate) - ROOT
  Node 13938 (Gather Merge)
    Node 13939 (Sort)
          ...
          Node 13942 (Hash Join)
            Node 13943 (Nested Loop)
              Node 13944 (Hash Join)
                ...
                Node 13946 (Hash)
                  Node 13947 (Hash Join)
                    Node 13948 (Seq Scan) - LEAF
                    Node 13949 (Hash)
                      Node 13950 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 13937 | Aggregate | 1239.85 | 1194.99 | 3.6% | operator |
| 13938 | Gather Merge | 1239.43 | 1097.15 | 11.5% | operator |
...
| 13944 | Hash Join | 217.44 | 251.17 | 15.5% | operator |
...
| 13946 | Hash | 37.34 | 20.62 | 44.8% | operator |
| 13947 | Hash Join | 34.33 | 132.26 | 285.2% | operator |
| 13948 | Seq Scan | 31.64 | 23.03 | 27.2% | operator |
| 13949 | Hash | 1.40 | 23.66 | 1588.5% | operator |
| 13950 | Hash Join | 1.40 | 306.84 | 21832.5% | operator |
...
### Step 5: Node 13948 (Seq Scan) - LEAF
...
### Step 8: Node 13945 (Seq Scan) - LEAF
...
### Step 11: Node 13954 (Index Scan) - LEAF
...
### Step 12: Node 13956 (Seq Scan) - LEAF
...
### Step 13: Node 13943 (Nested Loop)
...
### Step 16: Node 13957 (Index Scan) - LEAF
...
### Step 17: Node 13959 (Seq Scan) - LEAF
...
### Step 18: Node 13941 (Nested Loop)
...
### Step 22: Node 13938 (Gather Merge)
...
### Step 23: Node 13937 (Aggregate) - ROOT
