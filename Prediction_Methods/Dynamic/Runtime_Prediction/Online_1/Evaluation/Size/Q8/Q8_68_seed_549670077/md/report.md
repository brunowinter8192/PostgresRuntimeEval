...
```
Node 15823 (Aggregate) - ROOT
  Node 15824 (Gather Merge)
    Node 15825 (Sort)
          ...
          Node 15828 (Hash Join)
            Node 15829 (Nested Loop)
              Node 15830 (Hash Join)
                ...
                Node 15832 (Hash)
                  Node 15833 (Hash Join)
                    Node 15834 (Seq Scan) - LEAF
                    Node 15835 (Hash)
                      Node 15836 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 15823 | Aggregate | 1218.34 | 1189.58 | 2.4% | operator |
| 15824 | Gather Merge | 1217.87 | 1097.17 | 9.9% | operator |
...
| 15830 | Hash Join | 214.06 | 251.17 | 17.3% | operator |
...
| 15832 | Hash | 36.56 | 20.62 | 43.6% | operator |
| 15833 | Hash Join | 35.89 | 132.26 | 268.5% | operator |
| 15834 | Seq Scan | 34.36 | 23.03 | 33.0% | operator |
| 15835 | Hash | 0.22 | 23.66 | 10751.4% | operator |
| 15836 | Hash Join | 0.21 | 306.84 | 142614.4% | operator |
...
### Step 5: Node 15834 (Seq Scan) - LEAF
...
### Step 8: Node 15831 (Seq Scan) - LEAF
...
### Step 11: Node 15840 (Index Scan) - LEAF
...
### Step 12: Node 15842 (Seq Scan) - LEAF
...
### Step 13: Node 15829 (Nested Loop)
...
### Step 16: Node 15843 (Index Scan) - LEAF
...
### Step 17: Node 15845 (Seq Scan) - LEAF
...
### Step 18: Node 15827 (Nested Loop)
...
### Step 22: Node 15824 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1044.9440
  - st2=0.0000
  - startup_cost=71557.6500
  - total_cost=71850.2200
- **Output:** st=1093.47, rt=1097.17

### Step 23: Node 15823 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=71557.6500
  - total_cost=71947.8000
- **Output:** st=1161.33, rt=1189.58
