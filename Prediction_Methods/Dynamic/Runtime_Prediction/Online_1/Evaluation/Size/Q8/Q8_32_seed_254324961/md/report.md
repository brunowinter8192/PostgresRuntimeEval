...
```
Node 14926 (Aggregate) - ROOT
  Node 14927 (Gather Merge)
    Node 14928 (Sort)
          ...
          Node 14931 (Hash Join)
            Node 14932 (Nested Loop)
              Node 14933 (Hash Join)
                ...
                Node 14935 (Hash)
                  Node 14936 (Hash Join)
                    Node 14937 (Seq Scan) - LEAF
                    Node 14938 (Hash)
                      Node 14939 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 14926 | Aggregate | 1252.31 | 1187.55 | 5.2% | operator |
| 14927 | Gather Merge | 1251.86 | 1097.17 | 12.4% | operator |
...
| 14933 | Hash Join | 212.49 | 251.17 | 18.2% | operator |
...
| 14935 | Hash | 33.51 | 20.62 | 38.5% | operator |
| 14936 | Hash Join | 32.95 | 132.26 | 301.4% | operator |
| 14937 | Seq Scan | 31.53 | 23.03 | 27.0% | operator |
| 14938 | Hash | 0.08 | 23.66 | 28401.3% | operator |
| 14939 | Hash Join | 0.08 | 306.84 | 388299.9% | operator |
...
### Step 5: Node 14937 (Seq Scan) - LEAF
...
### Step 8: Node 14934 (Seq Scan) - LEAF
...
### Step 11: Node 14943 (Index Scan) - LEAF
...
### Step 12: Node 14945 (Seq Scan) - LEAF
...
### Step 13: Node 14932 (Nested Loop)
...
### Step 16: Node 14946 (Index Scan) - LEAF
...
### Step 17: Node 14948 (Seq Scan) - LEAF
...
### Step 18: Node 14930 (Nested Loop)
...
### Step 22: Node 14927 (Gather Merge)
...
### Step 23: Node 14926 (Aggregate) - ROOT
