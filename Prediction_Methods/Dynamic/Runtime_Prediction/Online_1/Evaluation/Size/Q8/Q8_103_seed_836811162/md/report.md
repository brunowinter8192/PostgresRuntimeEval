...
```
Node 13270 (Aggregate) - ROOT
  Node 13271 (Gather Merge)
    Node 13272 (Sort)
          ...
          Node 13275 (Hash Join)
            Node 13276 (Nested Loop)
              Node 13277 (Hash Join)
                ...
                Node 13279 (Hash)
                  Node 13280 (Hash Join)
                    Node 13281 (Seq Scan) - LEAF
                    Node 13282 (Hash)
                      Node 13283 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 13270 | Aggregate | 1212.07 | 1195.83 | 1.3% | operator |
| 13271 | Gather Merge | 1211.64 | 1097.16 | 9.4% | operator |
...
| 13277 | Hash Join | 217.54 | 251.17 | 15.5% | operator |
...
| 13279 | Hash | 38.30 | 20.62 | 46.2% | operator |
| 13280 | Hash Join | 37.61 | 132.26 | 251.7% | operator |
| 13281 | Seq Scan | 36.05 | 23.03 | 36.1% | operator |
| 13282 | Hash | 0.22 | 23.66 | 10460.8% | operator |
| 13283 | Hash Join | 0.22 | 306.84 | 138114.4% | operator |
...
### Step 5: Node 13281 (Seq Scan) - LEAF
...
### Step 8: Node 13278 (Seq Scan) - LEAF
...
### Step 11: Node 13287 (Index Scan) - LEAF
...
### Step 12: Node 13289 (Seq Scan) - LEAF
...
### Step 13: Node 13276 (Nested Loop)
...
### Step 16: Node 13290 (Index Scan) - LEAF
...
### Step 17: Node 13292 (Seq Scan) - LEAF
...
### Step 18: Node 13274 (Nested Loop)
...
### Step 22: Node 13271 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1044.9387
  - st2=0.0000
  - startup_cost=71532.3500
  - total_cost=71800.0700
- **Output:** st=1093.45, rt=1097.16

### Step 23: Node 13270 (Aggregate) - ROOT
