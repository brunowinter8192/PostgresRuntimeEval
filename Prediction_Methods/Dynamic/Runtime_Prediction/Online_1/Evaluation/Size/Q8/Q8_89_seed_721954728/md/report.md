...
```
Node 16352 (Aggregate) - ROOT
  Node 16353 (Gather Merge)
    Node 16354 (Sort)
          ...
          Node 16357 (Hash Join)
            Node 16358 (Nested Loop)
              Node 16359 (Hash Join)
                ...
                Node 16361 (Hash)
                  Node 16362 (Hash Join)
                    Node 16363 (Seq Scan) - LEAF
                    Node 16364 (Hash)
                      Node 16365 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 16352 | Aggregate | 1202.55 | 1189.02 | 1.1% | operator |
| 16353 | Gather Merge | 1202.14 | 1097.18 | 8.7% | operator |
...
| 16359 | Hash Join | 210.47 | 251.17 | 19.3% | operator |
...
| 16361 | Hash | 31.62 | 20.62 | 34.8% | operator |
| 16362 | Hash Join | 31.06 | 132.26 | 325.8% | operator |
| 16363 | Seq Scan | 29.70 | 23.03 | 22.5% | operator |
| 16364 | Hash | 0.08 | 23.66 | 29470.2% | operator |
| 16365 | Hash Join | 0.08 | 306.84 | 398388.3% | operator |
...
### Step 5: Node 16363 (Seq Scan) - LEAF
...
### Step 8: Node 16360 (Seq Scan) - LEAF
...
### Step 11: Node 16369 (Index Scan) - LEAF
...
### Step 12: Node 16371 (Seq Scan) - LEAF
...
### Step 13: Node 16358 (Nested Loop)
...
### Step 16: Node 16372 (Index Scan) - LEAF
...
### Step 17: Node 16374 (Seq Scan) - LEAF
...
### Step 18: Node 16356 (Nested Loop)
...
### Step 22: Node 16353 (Gather Merge)
...
### Step 23: Node 16352 (Aggregate) - ROOT
