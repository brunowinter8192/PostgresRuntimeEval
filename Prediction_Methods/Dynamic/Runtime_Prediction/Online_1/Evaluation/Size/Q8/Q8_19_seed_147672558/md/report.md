...
```
Node 14581 (Aggregate) - ROOT
  Node 14582 (Gather Merge)
    Node 14583 (Sort)
          ...
          Node 14586 (Hash Join)
            Node 14587 (Nested Loop)
              Node 14588 (Hash Join)
                ...
                Node 14590 (Hash)
                  Node 14591 (Hash Join)
                    Node 14592 (Seq Scan) - LEAF
                    Node 14593 (Hash)
                      Node 14594 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 14581 | Aggregate | 1224.17 | 1195.83 | 2.3% | operator |
| 14582 | Gather Merge | 1223.73 | 1097.18 | 10.3% | operator |
...
| 14588 | Hash Join | 208.74 | 251.17 | 20.3% | operator |
...
| 14590 | Hash | 34.96 | 20.62 | 41.0% | operator |
| 14591 | Hash Join | 34.29 | 132.26 | 285.7% | operator |
| 14592 | Seq Scan | 30.50 | 23.03 | 24.5% | operator |
| 14593 | Hash | 2.50 | 23.66 | 844.7% | operator |
| 14594 | Hash Join | 2.50 | 306.84 | 12163.6% | operator |
...
### Step 5: Node 14592 (Seq Scan) - LEAF
...
### Step 8: Node 14589 (Seq Scan) - LEAF
...
### Step 11: Node 14598 (Index Scan) - LEAF
...
### Step 12: Node 14600 (Seq Scan) - LEAF
...
### Step 13: Node 14587 (Nested Loop)
...
### Step 16: Node 14601 (Index Scan) - LEAF
...
### Step 17: Node 14603 (Seq Scan) - LEAF
...
### Step 18: Node 14585 (Nested Loop)
...
### Step 22: Node 14582 (Gather Merge)
...
### Step 23: Node 14581 (Aggregate) - ROOT
