...
```
Node 13845 (Aggregate) - ROOT
  Node 13846 (Gather Merge)
    Node 13847 (Sort)
          ...
          Node 13850 (Hash Join)
            Node 13851 (Nested Loop)
              Node 13852 (Hash Join)
                ...
                Node 13854 (Hash)
                  Node 13855 (Hash Join)
                    Node 13856 (Seq Scan) - LEAF
                    Node 13857 (Hash)
                      Node 13858 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 13845 | Aggregate | 1233.70 | 1194.52 | 3.2% | operator |
| 13846 | Gather Merge | 1233.22 | 1097.18 | 11.0% | operator |
...
| 13852 | Hash Join | 216.22 | 251.17 | 16.2% | operator |
...
| 13854 | Hash | 36.20 | 20.62 | 43.1% | operator |
| 13855 | Hash Join | 35.53 | 132.26 | 272.3% | operator |
| 13856 | Seq Scan | 34.09 | 23.03 | 32.4% | operator |
| 13857 | Hash | 0.09 | 23.66 | 25066.1% | operator |
| 13858 | Hash Join | 0.09 | 306.84 | 337082.4% | operator |
...
### Step 5: Node 13856 (Seq Scan) - LEAF
...
### Step 8: Node 13853 (Seq Scan) - LEAF
...
### Step 11: Node 13862 (Index Scan) - LEAF
...
### Step 12: Node 13864 (Seq Scan) - LEAF
...
### Step 13: Node 13851 (Nested Loop)
...
### Step 16: Node 13865 (Index Scan) - LEAF
...
### Step 17: Node 13867 (Seq Scan) - LEAF
...
### Step 18: Node 13849 (Nested Loop)
...
### Step 22: Node 13846 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1044.9426
  - st2=0.0000
  - startup_cost=71551.3200
  - total_cost=71837.6200
- **Output:** st=1093.47, rt=1097.18

### Step 23: Node 13845 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=71551.3200
  - total_cost=71934.1400
- **Output:** st=1163.72, rt=1194.52
