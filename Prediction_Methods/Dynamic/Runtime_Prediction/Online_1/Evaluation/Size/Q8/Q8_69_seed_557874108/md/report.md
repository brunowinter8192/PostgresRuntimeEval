...
```
Node 15846 (Aggregate) - ROOT
  Node 15847 (Gather Merge)
    Node 15848 (Sort)
          ...
          Node 15851 (Hash Join)
            Node 15852 (Nested Loop)
              Node 15853 (Hash Join)
                ...
                Node 15855 (Hash)
                  Node 15856 (Hash Join)
                    Node 15857 (Seq Scan) - LEAF
                    Node 15858 (Hash)
                      Node 15859 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 15846 | Aggregate | 1209.69 | 1184.88 | 2.1% | operator |
| 15847 | Gather Merge | 1209.24 | 1097.14 | 9.3% | operator |
...
| 15853 | Hash Join | 204.57 | 251.17 | 22.8% | operator |
...
| 15855 | Hash | 32.33 | 20.62 | 36.2% | operator |
| 15856 | Hash Join | 31.69 | 132.26 | 317.4% | operator |
| 15857 | Seq Scan | 30.27 | 23.03 | 23.9% | operator |
| 15858 | Hash | 0.08 | 23.66 | 29844.5% | operator |
| 15859 | Hash Join | 0.08 | 306.84 | 403631.5% | operator |
...
### Step 5: Node 15857 (Seq Scan) - LEAF
...
### Step 8: Node 15854 (Seq Scan) - LEAF
...
### Step 11: Node 15863 (Index Scan) - LEAF
...
### Step 12: Node 15865 (Seq Scan) - LEAF
...
### Step 13: Node 15852 (Nested Loop)
...
### Step 16: Node 15866 (Index Scan) - LEAF
...
### Step 17: Node 15868 (Seq Scan) - LEAF
...
### Step 18: Node 15850 (Nested Loop)
...
### Step 22: Node 15847 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1044.9452
  - st2=0.0000
  - startup_cost=71563.6200
  - total_cost=71862.2200
- **Output:** st=1093.44, rt=1097.14

### Step 23: Node 15846 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=71563.6200
  - total_cost=71960.8200
- **Output:** st=1158.94, rt=1184.88
