...
```
Node 15455 (Aggregate) - ROOT
  Node 15456 (Gather Merge)
    Node 15457 (Sort)
          ...
          Node 15460 (Hash Join)
            Node 15461 (Nested Loop)
              Node 15462 (Hash Join)
                ...
                Node 15464 (Hash)
                  Node 15465 (Hash Join)
                    Node 15466 (Seq Scan) - LEAF
                    Node 15467 (Hash)
                      Node 15468 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 15455 | Aggregate | 1200.37 | 1188.19 | 1.0% | operator |
| 15456 | Gather Merge | 1199.93 | 1097.19 | 8.6% | operator |
...
| 15462 | Hash Join | 214.87 | 251.17 | 16.9% | operator |
...
| 15464 | Hash | 37.52 | 20.62 | 45.1% | operator |
| 15465 | Hash Join | 36.93 | 132.26 | 258.1% | operator |
| 15466 | Seq Scan | 35.42 | 23.03 | 35.0% | operator |
| 15467 | Hash | 0.22 | 23.66 | 10460.8% | operator |
| 15468 | Hash Join | 0.22 | 306.84 | 138739.8% | operator |
...
### Step 5: Node 15466 (Seq Scan) - LEAF
...
### Step 8: Node 15463 (Seq Scan) - LEAF
...
### Step 11: Node 15472 (Index Scan) - LEAF
...
### Step 12: Node 15474 (Seq Scan) - LEAF
...
### Step 13: Node 15461 (Nested Loop)
...
### Step 16: Node 15475 (Index Scan) - LEAF
...
### Step 17: Node 15477 (Seq Scan) - LEAF
...
### Step 18: Node 15459 (Nested Loop)
...
### Step 22: Node 15456 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1044.9444
  - st2=0.0000
  - startup_cost=71559.5100
  - total_cost=71853.8600
- **Output:** st=1093.48, rt=1097.19

### Step 23: Node 15455 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=71559.5100
  - total_cost=71951.7400
- **Output:** st=1160.63, rt=1188.19
