...
```
Node 14121 (Aggregate) - ROOT
  Node 14122 (Gather Merge)
    Node 14123 (Sort)
          ...
          Node 14126 (Hash Join)
            Node 14127 (Nested Loop)
              Node 14128 (Hash Join)
                ...
                Node 14130 (Hash)
                  Node 14131 (Hash Join)
                    Node 14132 (Seq Scan) - LEAF
                    Node 14133 (Hash)
                      Node 14134 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 14121 | Aggregate | 1225.22 | 1195.83 | 2.4% | operator |
| 14122 | Gather Merge | 1224.78 | 1097.16 | 10.4% | operator |
...
| 14128 | Hash Join | 213.01 | 251.17 | 17.9% | operator |
...
| 14130 | Hash | 36.20 | 20.62 | 43.1% | operator |
| 14131 | Hash Join | 35.30 | 132.26 | 274.6% | operator |
| 14132 | Seq Scan | 33.65 | 23.03 | 31.6% | operator |
| 14133 | Hash | 0.24 | 23.66 | 9756.7% | operator |
| 14134 | Hash Join | 0.24 | 306.84 | 129366.6% | operator |
...
### Step 5: Node 14132 (Seq Scan) - LEAF
...
### Step 8: Node 14129 (Seq Scan) - LEAF
...
### Step 11: Node 14138 (Index Scan) - LEAF
...
### Step 12: Node 14140 (Seq Scan) - LEAF
...
### Step 13: Node 14127 (Nested Loop)
...
### Step 16: Node 14141 (Index Scan) - LEAF
...
### Step 17: Node 14143 (Seq Scan) - LEAF
...
### Step 18: Node 14125 (Nested Loop)
...
### Step 22: Node 14122 (Gather Merge)
...
### Step 23: Node 14121 (Aggregate) - ROOT
