...
```
Node 15938 (Aggregate) - ROOT
  Node 15939 (Gather Merge)
    Node 15940 (Sort)
          ...
          Node 15943 (Hash Join)
            Node 15944 (Nested Loop)
              Node 15945 (Hash Join)
                ...
                Node 15947 (Hash)
                  Node 15948 (Hash Join)
                    Node 15949 (Seq Scan) - LEAF
                    Node 15950 (Hash)
                      Node 15951 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 15938 | Aggregate | 1218.51 | 1186.07 | 2.7% | operator |
| 15939 | Gather Merge | 1218.04 | 1097.16 | 9.9% | operator |
...
| 15945 | Hash Join | 209.95 | 251.17 | 19.6% | operator |
...
| 15947 | Hash | 34.82 | 20.62 | 40.8% | operator |
| 15948 | Hash Join | 32.32 | 132.26 | 309.2% | operator |
| 15949 | Seq Scan | 30.93 | 23.03 | 25.5% | operator |
| 15950 | Hash | 0.09 | 23.66 | 26782.0% | operator |
| 15951 | Hash Join | 0.09 | 306.84 | 356686.0% | operator |
...
### Step 5: Node 15949 (Seq Scan) - LEAF
...
### Step 8: Node 15946 (Seq Scan) - LEAF
...
### Step 11: Node 15955 (Index Scan) - LEAF
...
### Step 12: Node 15957 (Seq Scan) - LEAF
...
### Step 13: Node 15944 (Nested Loop)
...
### Step 16: Node 15958 (Index Scan) - LEAF
...
### Step 17: Node 15960 (Seq Scan) - LEAF
...
### Step 18: Node 15942 (Nested Loop)
...
### Step 22: Node 15939 (Gather Merge)
...
- **Input Features:**
  ...
  - total_cost=71859.1900
- **Output:** st=1093.45, rt=1097.16

### Step 23: Node 15938 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=71562.1200
  - total_cost=71957.5300
- **Output:** st=1159.55, rt=1186.07
