...
```
Node 14282 (Aggregate) - ROOT
  Node 14283 (Gather Merge)
    Node 14284 (Sort)
          ...
          Node 14287 (Hash Join)
            Node 14288 (Nested Loop)
              Node 14289 (Hash Join)
                ...
                Node 14291 (Hash)
                  Node 14292 (Hash Join)
                    Node 14293 (Seq Scan) - LEAF
                    Node 14294 (Hash)
                      Node 14295 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 14282 | Aggregate | 1232.05 | 1195.83 | 2.9% | operator |
| 14283 | Gather Merge | 1231.66 | 1097.15 | 10.9% | operator |
...
| 14289 | Hash Join | 216.88 | 251.17 | 15.8% | operator |
...
| 14291 | Hash | 39.39 | 20.62 | 47.7% | operator |
| 14292 | Hash Join | 38.84 | 132.26 | 240.5% | operator |
| 14293 | Seq Scan | 37.25 | 23.03 | 38.2% | operator |
| 14294 | Hash | 0.08 | 23.66 | 29105.1% | operator |
| 14295 | Hash Join | 0.08 | 306.84 | 393279.4% | operator |
...
### Step 5: Node 14293 (Seq Scan) - LEAF
...
### Step 8: Node 14290 (Seq Scan) - LEAF
...
### Step 11: Node 14299 (Index Scan) - LEAF
...
### Step 12: Node 14301 (Seq Scan) - LEAF
...
### Step 13: Node 14288 (Nested Loop)
...
### Step 16: Node 14302 (Index Scan) - LEAF
...
### Step 17: Node 14304 (Seq Scan) - LEAF
...
### Step 18: Node 14286 (Nested Loop)
...
### Step 22: Node 14283 (Gather Merge)
...
### Step 23: Node 14282 (Aggregate) - ROOT
