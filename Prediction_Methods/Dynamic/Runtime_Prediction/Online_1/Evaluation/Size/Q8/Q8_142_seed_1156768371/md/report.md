...
```
Node 14259 (Aggregate) - ROOT
  Node 14260 (Gather Merge)
    Node 14261 (Sort)
          ...
          Node 14264 (Hash Join)
            Node 14265 (Nested Loop)
              Node 14266 (Hash Join)
                ...
                Node 14268 (Hash)
                  Node 14269 (Hash Join)
                    Node 14270 (Seq Scan) - LEAF
                    Node 14271 (Hash)
                      Node 14272 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 14259 | Aggregate | 1228.32 | 1195.83 | 2.6% | operator |
| 14260 | Gather Merge | 1227.98 | 1097.18 | 10.7% | operator |
...
| 14266 | Hash Join | 216.47 | 251.17 | 16.0% | operator |
...
| 14268 | Hash | 37.68 | 20.62 | 45.3% | operator |
| 14269 | Hash Join | 37.06 | 132.26 | 256.9% | operator |
| 14270 | Seq Scan | 35.49 | 23.03 | 35.1% | operator |
| 14271 | Hash | 0.26 | 23.66 | 8963.6% | operator |
| 14272 | Hash Join | 0.26 | 306.84 | 118828.7% | operator |
...
### Step 5: Node 14270 (Seq Scan) - LEAF
...
### Step 8: Node 14267 (Seq Scan) - LEAF
...
### Step 11: Node 14276 (Index Scan) - LEAF
...
### Step 12: Node 14278 (Seq Scan) - LEAF
...
### Step 13: Node 14265 (Nested Loop)
...
### Step 16: Node 14279 (Index Scan) - LEAF
...
### Step 17: Node 14281 (Seq Scan) - LEAF
...
### Step 18: Node 14263 (Nested Loop)
...
### Step 22: Node 14260 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1044.9394
  - st2=0.0000
  - startup_cost=71535.7100
  - total_cost=71806.6300
- **Output:** st=1093.47, rt=1097.18

### Step 23: Node 14259 (Aggregate) - ROOT
