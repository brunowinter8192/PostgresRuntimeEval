...
```
Node 15616 (Aggregate) - ROOT
  Node 15617 (Gather Merge)
    Node 15618 (Sort)
          ...
          Node 15621 (Hash Join)
            Node 15622 (Nested Loop)
              Node 15623 (Hash Join)
                ...
                Node 15625 (Hash)
                  Node 15626 (Hash Join)
                    Node 15627 (Seq Scan) - LEAF
                    Node 15628 (Hash)
                      Node 15629 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 15616 | Aggregate | 1239.36 | 1190.04 | 4.0% | operator |
| 15617 | Gather Merge | 1238.94 | 1097.15 | 11.4% | operator |
...
| 15623 | Hash Join | 216.57 | 251.17 | 16.0% | operator |
...
| 15625 | Hash | 38.38 | 20.62 | 46.3% | operator |
| 15626 | Hash Join | 37.71 | 132.26 | 250.8% | operator |
| 15627 | Seq Scan | 36.12 | 23.03 | 36.2% | operator |
| 15628 | Hash | 0.23 | 23.66 | 10052.8% | operator |
| 15629 | Hash Join | 0.23 | 306.84 | 133306.9% | operator |
...
### Step 5: Node 15627 (Seq Scan) - LEAF
...
### Step 8: Node 15624 (Seq Scan) - LEAF
...
### Step 11: Node 15633 (Index Scan) - LEAF
...
### Step 12: Node 15635 (Seq Scan) - LEAF
...
### Step 13: Node 15622 (Nested Loop)
...
### Step 16: Node 15636 (Index Scan) - LEAF
...
### Step 17: Node 15638 (Seq Scan) - LEAF
...
### Step 18: Node 15620 (Nested Loop)
...
### Step 22: Node 15617 (Gather Merge)
...
### Step 23: Node 15616 (Aggregate) - ROOT
