...
```
Node 16375 (Aggregate) - ROOT
  Node 16376 (Gather Merge)
    Node 16377 (Sort)
          ...
          Node 16380 (Hash Join)
            Node 16381 (Nested Loop)
              Node 16382 (Hash Join)
                ...
                Node 16384 (Hash)
                  Node 16385 (Hash Join)
                    Node 16386 (Seq Scan) - LEAF
                    Node 16387 (Hash)
                      Node 16388 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 16375 | Aggregate | 1229.11 | 1193.86 | 2.9% | operator |
| 16376 | Gather Merge | 1228.66 | 1097.16 | 10.7% | operator |
...
| 16382 | Hash Join | 213.60 | 251.17 | 17.6% | operator |
...
| 16384 | Hash | 37.24 | 20.62 | 44.6% | operator |
| 16385 | Hash Join | 36.60 | 132.26 | 261.3% | operator |
| 16386 | Seq Scan | 35.09 | 23.03 | 34.4% | operator |
| 16387 | Hash | 0.23 | 23.66 | 10096.6% | operator |
| 16388 | Hash Join | 0.23 | 306.84 | 133889.5% | operator |
...
### Step 5: Node 16386 (Seq Scan) - LEAF
...
### Step 8: Node 16383 (Seq Scan) - LEAF
...
### Step 11: Node 16392 (Index Scan) - LEAF
...
### Step 12: Node 16394 (Seq Scan) - LEAF
...
### Step 13: Node 16381 (Nested Loop)
...
### Step 16: Node 16395 (Index Scan) - LEAF
...
### Step 17: Node 16397 (Seq Scan) - LEAF
...
### Step 18: Node 16379 (Nested Loop)
...
### Step 22: Node 16376 (Gather Merge)
...
### Step 23: Node 16375 (Aggregate) - ROOT
