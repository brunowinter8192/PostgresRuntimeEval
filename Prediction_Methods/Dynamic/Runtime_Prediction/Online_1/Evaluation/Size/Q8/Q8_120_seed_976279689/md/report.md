...
```
Node 13707 (Aggregate) - ROOT
  Node 13708 (Gather Merge)
    Node 13709 (Sort)
          ...
          Node 13712 (Hash Join)
            Node 13713 (Nested Loop)
              Node 13714 (Hash Join)
                ...
                Node 13716 (Hash)
                  Node 13717 (Hash Join)
                    Node 13718 (Seq Scan) - LEAF
                    Node 13719 (Hash)
                      Node 13720 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 13707 | Aggregate | 1202.52 | 1193.68 | 0.7% | operator |
| 13708 | Gather Merge | 1202.00 | 1097.19 | 8.7% | operator |
...
| 13714 | Hash Join | 211.62 | 251.17 | 18.7% | operator |
...
| 13716 | Hash | 33.83 | 20.62 | 39.1% | operator |
| 13717 | Hash Join | 32.98 | 132.26 | 301.0% | operator |
| 13718 | Seq Scan | 31.50 | 23.03 | 26.9% | operator |
| 13719 | Hash | 0.19 | 23.66 | 12550.3% | operator |
| 13720 | Hash Join | 0.18 | 306.84 | 166658.7% | operator |
...
### Step 5: Node 13718 (Seq Scan) - LEAF
...
### Step 8: Node 13715 (Seq Scan) - LEAF
...
### Step 11: Node 13724 (Index Scan) - LEAF
...
### Step 12: Node 13726 (Seq Scan) - LEAF
...
### Step 13: Node 13713 (Nested Loop)
...
### Step 16: Node 13727 (Index Scan) - LEAF
...
### Step 17: Node 13729 (Seq Scan) - LEAF
...
### Step 18: Node 13711 (Nested Loop)
...
### Step 22: Node 13708 (Gather Merge)
...
### Step 23: Node 13707 (Aggregate) - ROOT
