...
```
Node 14512 (Aggregate) - ROOT
  Node 14513 (Gather Merge)
    Node 14514 (Sort)
          ...
          Node 14517 (Hash Join)
            Node 14518 (Nested Loop)
              Node 14519 (Hash Join)
                ...
                Node 14521 (Hash)
                  Node 14522 (Hash Join)
                    Node 14523 (Seq Scan) - LEAF
                    Node 14524 (Hash)
                      Node 14525 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 14512 | Aggregate | 1217.10 | 1189.58 | 2.3% | operator |
| 14513 | Gather Merge | 1216.68 | 1097.17 | 9.8% | operator |
...
| 14519 | Hash Join | 213.06 | 251.17 | 17.9% | operator |
...
| 14521 | Hash | 36.98 | 20.62 | 44.2% | operator |
| 14522 | Hash Join | 36.27 | 132.26 | 264.6% | operator |
| 14523 | Seq Scan | 34.50 | 23.03 | 33.2% | operator |
| 14524 | Hash | 0.46 | 23.66 | 5087.7% | operator |
| 14525 | Hash Join | 0.45 | 306.84 | 67934.6% | operator |
...
### Step 5: Node 14523 (Seq Scan) - LEAF
...
### Step 8: Node 14520 (Seq Scan) - LEAF
...
### Step 11: Node 14529 (Index Scan) - LEAF
...
### Step 12: Node 14531 (Seq Scan) - LEAF
...
### Step 13: Node 14518 (Nested Loop)
...
### Step 16: Node 14532 (Index Scan) - LEAF
...
### Step 17: Node 14534 (Seq Scan) - LEAF
...
### Step 18: Node 14516 (Nested Loop)
...
### Step 22: Node 14513 (Gather Merge)
...
### Step 23: Node 14512 (Aggregate) - ROOT
