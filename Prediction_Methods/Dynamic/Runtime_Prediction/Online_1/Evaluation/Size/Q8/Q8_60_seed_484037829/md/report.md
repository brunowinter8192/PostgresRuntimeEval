...
```
Node 15639 (Aggregate) - ROOT
  Node 15640 (Gather Merge)
    Node 15641 (Sort)
          ...
          Node 15644 (Hash Join)
            Node 15645 (Nested Loop)
              Node 15646 (Hash Join)
                ...
                Node 15648 (Hash)
                  Node 15649 (Hash Join)
                    Node 15650 (Seq Scan) - LEAF
                    Node 15651 (Hash)
                      Node 15652 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 15639 | Aggregate | 1215.43 | 1195.83 | 1.6% | operator |
| 15640 | Gather Merge | 1215.06 | 1097.15 | 9.7% | operator |
...
| 15646 | Hash Join | 214.51 | 251.17 | 17.1% | operator |
...
| 15648 | Hash | 37.59 | 20.62 | 45.1% | operator |
| 15649 | Hash Join | 36.92 | 132.26 | 258.2% | operator |
| 15650 | Seq Scan | 35.42 | 23.03 | 35.0% | operator |
| 15651 | Hash | 0.20 | 23.66 | 11787.5% | operator |
| 15652 | Hash Join | 0.20 | 306.84 | 156449.0% | operator |
...
### Step 5: Node 15650 (Seq Scan) - LEAF
...
### Step 8: Node 15647 (Seq Scan) - LEAF
...
### Step 11: Node 15656 (Index Scan) - LEAF
...
### Step 12: Node 15658 (Seq Scan) - LEAF
...
### Step 13: Node 15645 (Nested Loop)
...
### Step 16: Node 15659 (Index Scan) - LEAF
...
### Step 17: Node 15661 (Seq Scan) - LEAF
...
### Step 18: Node 15643 (Nested Loop)
...
### Step 22: Node 15640 (Gather Merge)
...
### Step 23: Node 15639 (Aggregate) - ROOT
