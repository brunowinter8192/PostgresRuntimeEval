...
```
Node 15961 (Aggregate) - ROOT
  Node 15962 (Gather Merge)
    Node 15963 (Sort)
          ...
          Node 15966 (Hash Join)
            Node 15967 (Nested Loop)
              Node 15968 (Hash Join)
                ...
                Node 15970 (Hash)
                  Node 15971 (Hash Join)
                    Node 15972 (Seq Scan) - LEAF
                    Node 15973 (Hash)
                      Node 15974 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 15961 | Aggregate | 1212.58 | 1191.81 | 1.7% | operator |
| 15962 | Gather Merge | 1212.16 | 1097.16 | 9.5% | operator |
...
| 15968 | Hash Join | 215.81 | 251.17 | 16.4% | operator |
...
| 15970 | Hash | 35.66 | 20.62 | 42.2% | operator |
| 15971 | Hash Join | 35.06 | 132.26 | 277.2% | operator |
| 15972 | Seq Scan | 33.63 | 23.03 | 31.5% | operator |
| 15973 | Hash | 0.16 | 23.66 | 14324.5% | operator |
| 15974 | Hash Join | 0.16 | 306.84 | 191672.5% | operator |
...
### Step 5: Node 15972 (Seq Scan) - LEAF
...
### Step 8: Node 15969 (Seq Scan) - LEAF
...
### Step 11: Node 15978 (Index Scan) - LEAF
...
### Step 12: Node 15980 (Seq Scan) - LEAF
...
### Step 13: Node 15967 (Nested Loop)
...
### Step 16: Node 15981 (Index Scan) - LEAF
...
### Step 17: Node 15983 (Seq Scan) - LEAF
...
### Step 18: Node 15965 (Nested Loop)
...
### Step 22: Node 15962 (Gather Merge)
...
### Step 23: Node 15961 (Aggregate) - ROOT
