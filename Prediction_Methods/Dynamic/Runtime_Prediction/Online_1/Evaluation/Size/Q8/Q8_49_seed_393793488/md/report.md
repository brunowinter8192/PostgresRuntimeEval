...
```
Node 15340 (Aggregate) - ROOT
  Node 15341 (Gather Merge)
    Node 15342 (Sort)
          ...
          Node 15345 (Hash Join)
            Node 15346 (Nested Loop)
              Node 15347 (Hash Join)
                ...
                Node 15349 (Hash)
                  Node 15350 (Hash Join)
                    Node 15351 (Seq Scan) - LEAF
                    Node 15352 (Hash)
                      Node 15353 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 15340 | Aggregate | 1224.72 | 1195.83 | 2.4% | operator |
| 15341 | Gather Merge | 1224.25 | 1097.17 | 10.4% | operator |
...
| 15347 | Hash Join | 213.57 | 251.17 | 17.6% | operator |
...
| 15349 | Hash | 38.29 | 20.62 | 46.2% | operator |
| 15350 | Hash Join | 37.54 | 132.26 | 252.3% | operator |
| 15351 | Seq Scan | 35.98 | 23.03 | 36.0% | operator |
| 15352 | Hash | 0.22 | 23.66 | 10701.9% | operator |
| 15353 | Hash Join | 0.22 | 306.84 | 141953.7% | operator |
...
### Step 5: Node 15351 (Seq Scan) - LEAF
...
### Step 8: Node 15348 (Seq Scan) - LEAF
...
### Step 11: Node 15357 (Index Scan) - LEAF
...
### Step 12: Node 15359 (Seq Scan) - LEAF
...
### Step 13: Node 15346 (Nested Loop)
...
### Step 16: Node 15360 (Index Scan) - LEAF
...
### Step 17: Node 15362 (Seq Scan) - LEAF
...
### Step 18: Node 15344 (Nested Loop)
...
### Step 22: Node 15341 (Gather Merge)
...
### Step 23: Node 15340 (Aggregate) - ROOT
