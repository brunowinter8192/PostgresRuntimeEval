...
```
Node 14190 (Aggregate) - ROOT
  Node 14191 (Gather Merge)
    Node 14192 (Sort)
          ...
          Node 14195 (Hash Join)
            Node 14196 (Nested Loop)
              Node 14197 (Hash Join)
                ...
                Node 14199 (Hash)
                  Node 14200 (Hash Join)
                    Node 14201 (Seq Scan) - LEAF
                    Node 14202 (Hash)
                      Node 14203 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 14190 | Aggregate | 1205.32 | 1195.83 | 0.8% | operator |
| 14191 | Gather Merge | 1204.90 | 1097.17 | 8.9% | operator |
...
| 14197 | Hash Join | 218.70 | 251.17 | 14.8% | operator |
...
| 14199 | Hash | 37.97 | 20.62 | 45.7% | operator |
| 14200 | Hash Join | 37.31 | 132.26 | 254.5% | operator |
| 14201 | Seq Scan | 35.68 | 23.03 | 35.4% | operator |
| 14202 | Hash | 0.21 | 23.66 | 11111.4% | operator |
| 14203 | Hash Join | 0.21 | 306.84 | 147417.3% | operator |
...
### Step 5: Node 14201 (Seq Scan) - LEAF
...
### Step 8: Node 14198 (Seq Scan) - LEAF
...
### Step 11: Node 14207 (Index Scan) - LEAF
...
### Step 12: Node 14209 (Seq Scan) - LEAF
...
### Step 13: Node 14196 (Nested Loop)
...
### Step 16: Node 14210 (Index Scan) - LEAF
...
### Step 17: Node 14212 (Seq Scan) - LEAF
...
### Step 18: Node 14194 (Nested Loop)
...
### Step 22: Node 14191 (Gather Merge)
...
### Step 23: Node 14190 (Aggregate) - ROOT
