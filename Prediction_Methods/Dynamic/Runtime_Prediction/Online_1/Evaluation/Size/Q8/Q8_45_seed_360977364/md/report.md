...
```
Node 15248 (Aggregate) - ROOT
  Node 15249 (Gather Merge)
    Node 15250 (Sort)
          ...
          Node 15253 (Hash Join)
            Node 15254 (Nested Loop)
              Node 15255 (Hash Join)
                ...
                Node 15257 (Hash)
                  Node 15258 (Hash Join)
                    Node 15259 (Seq Scan) - LEAF
                    Node 15260 (Hash)
                      Node 15261 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 15248 | Aggregate | 1207.99 | 1194.52 | 1.1% | operator |
| 15249 | Gather Merge | 1207.55 | 1097.18 | 9.1% | operator |
...
| 15255 | Hash Join | 216.84 | 251.17 | 15.8% | operator |
...
| 15257 | Hash | 38.05 | 20.62 | 45.8% | operator |
| 15258 | Hash Join | 37.33 | 132.26 | 254.3% | operator |
| 15259 | Seq Scan | 35.78 | 23.03 | 35.6% | operator |
| 15260 | Hash | 0.21 | 23.66 | 11164.8% | operator |
| 15261 | Hash Join | 0.21 | 306.84 | 148129.9% | operator |
...
### Step 5: Node 15259 (Seq Scan) - LEAF
...
### Step 8: Node 15256 (Seq Scan) - LEAF
...
### Step 11: Node 15265 (Index Scan) - LEAF
...
### Step 12: Node 15267 (Seq Scan) - LEAF
...
### Step 13: Node 15254 (Nested Loop)
...
### Step 16: Node 15268 (Index Scan) - LEAF
...
### Step 17: Node 15270 (Seq Scan) - LEAF
...
### Step 18: Node 15252 (Nested Loop)
...
### Step 22: Node 15249 (Gather Merge)
...
### Step 23: Node 15248 (Aggregate) - ROOT
