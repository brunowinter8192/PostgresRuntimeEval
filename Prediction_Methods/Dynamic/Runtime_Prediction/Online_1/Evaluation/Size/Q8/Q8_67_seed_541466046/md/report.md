...
```
Node 15800 (Aggregate) - ROOT
  Node 15801 (Gather Merge)
    Node 15802 (Sort)
          ...
          Node 15805 (Hash Join)
            Node 15806 (Nested Loop)
              Node 15807 (Hash Join)
                ...
                Node 15809 (Hash)
                  Node 15810 (Hash Join)
                    Node 15811 (Seq Scan) - LEAF
                    Node 15812 (Hash)
                      Node 15813 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 15800 | Aggregate | 1206.17 | 1173.69 | 2.7% | operator |
| 15801 | Gather Merge | 1205.75 | 1097.19 | 9.0% | operator |
...
| 15807 | Hash Join | 214.21 | 251.17 | 17.3% | operator |
...
| 15809 | Hash | 36.88 | 20.62 | 44.1% | operator |
| 15810 | Hash Join | 36.21 | 132.26 | 265.3% | operator |
| 15811 | Seq Scan | 34.64 | 23.03 | 33.5% | operator |
| 15812 | Hash | 0.27 | 23.66 | 8793.3% | operator |
| 15813 | Hash Join | 0.26 | 306.84 | 117013.0% | operator |
...
### Step 5: Node 15811 (Seq Scan) - LEAF
...
### Step 8: Node 15808 (Seq Scan) - LEAF
...
### Step 11: Node 15817 (Index Scan) - LEAF
...
### Step 12: Node 15819 (Seq Scan) - LEAF
...
### Step 13: Node 15806 (Nested Loop)
...
### Step 16: Node 15820 (Index Scan) - LEAF
...
### Step 17: Node 15822 (Seq Scan) - LEAF
...
### Step 18: Node 15804 (Nested Loop)
...
### Step 22: Node 15801 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1044.9484
  - st2=0.0000
  - startup_cost=71578.8800
  - total_cost=71892.2800
- **Output:** st=1093.48, rt=1097.19

### Step 23: Node 15800 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=71578.8800
  - total_cost=71993.3800
- **Output:** st=1152.82, rt=1173.69
