...
```
Node 15777 (Aggregate) - ROOT
  Node 15778 (Gather Merge)
    Node 15779 (Sort)
          ...
          Node 15782 (Hash Join)
            Node 15783 (Nested Loop)
              Node 15784 (Hash Join)
                ...
                Node 15786 (Hash)
                  Node 15787 (Hash Join)
                    Node 15788 (Seq Scan) - LEAF
                    Node 15789 (Hash)
                      Node 15790 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 15777 | Aggregate | 1223.56 | 1188.75 | 2.8% | operator |
| 15778 | Gather Merge | 1223.12 | 1097.18 | 10.3% | operator |
...
| 15784 | Hash Join | 212.53 | 251.17 | 18.2% | operator |
...
| 15786 | Hash | 34.68 | 20.62 | 40.6% | operator |
| 15787 | Hash Join | 32.56 | 132.26 | 306.2% | operator |
| 15788 | Seq Scan | 31.09 | 23.03 | 25.9% | operator |
| 15789 | Hash | 0.10 | 23.66 | 22646.3% | operator |
| 15790 | Hash Join | 0.10 | 306.84 | 300719.6% | operator |
...
### Step 5: Node 15788 (Seq Scan) - LEAF
...
### Step 8: Node 15785 (Seq Scan) - LEAF
...
### Step 11: Node 15794 (Index Scan) - LEAF
...
### Step 12: Node 15796 (Seq Scan) - LEAF
...
### Step 13: Node 15783 (Nested Loop)
...
### Step 16: Node 15797 (Index Scan) - LEAF
...
### Step 17: Node 15799 (Seq Scan) - LEAF
...
### Step 18: Node 15781 (Nested Loop)
...
### Step 22: Node 15778 (Gather Merge)
...
- **Input Features:**
  ...
  - total_cost=71852.4000
- **Output:** st=1093.47, rt=1097.18

### Step 23: Node 15777 (Aggregate) - ROOT
