...
```
Node 16306 (Aggregate) - ROOT
  Node 16307 (Gather Merge)
    Node 16308 (Sort)
          ...
          Node 16311 (Hash Join)
            Node 16312 (Nested Loop)
              Node 16313 (Hash Join)
                ...
                Node 16315 (Hash)
                  Node 16316 (Hash Join)
                    Node 16317 (Seq Scan) - LEAF
                    Node 16318 (Hash)
                      Node 16319 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 16306 | Aggregate | 1232.99 | 1193.86 | 3.2% | operator |
| 16307 | Gather Merge | 1232.56 | 1097.16 | 11.0% | operator |
...
| 16313 | Hash Join | 212.23 | 251.17 | 18.3% | operator |
...
| 16315 | Hash | 35.56 | 20.62 | 42.0% | operator |
| 16316 | Hash Join | 34.83 | 132.26 | 279.7% | operator |
| 16317 | Seq Scan | 33.17 | 23.03 | 30.6% | operator |
| 16318 | Hash | 0.28 | 23.66 | 8440.1% | operator |
| 16319 | Hash Join | 0.27 | 306.84 | 112294.1% | operator |
...
### Step 5: Node 16317 (Seq Scan) - LEAF
...
### Step 8: Node 16314 (Seq Scan) - LEAF
...
### Step 11: Node 16323 (Index Scan) - LEAF
...
### Step 12: Node 16325 (Seq Scan) - LEAF
...
### Step 13: Node 16312 (Nested Loop)
...
### Step 16: Node 16326 (Index Scan) - LEAF
...
### Step 17: Node 16328 (Seq Scan) - LEAF
...
### Step 18: Node 16310 (Nested Loop)
...
### Step 22: Node 16307 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1044.9428
  - st2=0.0000
  - startup_cost=71552.0700
  - total_cost=71839.2000
- **Output:** st=1093.46, rt=1097.16

### Step 23: Node 16306 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=71552.0700
  - total_cost=71935.8600
- **Output:** st=1163.41, rt=1193.86
