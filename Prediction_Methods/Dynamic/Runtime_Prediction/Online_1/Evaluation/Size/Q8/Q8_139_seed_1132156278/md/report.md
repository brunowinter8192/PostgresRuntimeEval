...
```
Node 14167 (Aggregate) - ROOT
  Node 14168 (Gather Merge)
    Node 14169 (Sort)
          ...
          Node 14172 (Hash Join)
            Node 14173 (Nested Loop)
              Node 14174 (Hash Join)
                ...
                Node 14176 (Hash)
                  Node 14177 (Hash Join)
                    Node 14178 (Seq Scan) - LEAF
                    Node 14179 (Hash)
                      Node 14180 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 14167 | Aggregate | 1229.09 | 1195.73 | 2.7% | operator |
| 14168 | Gather Merge | 1228.71 | 1097.12 | 10.7% | operator |
...
| 14174 | Hash Join | 213.84 | 251.17 | 17.5% | operator |
...
| 14176 | Hash | 35.88 | 20.62 | 42.5% | operator |
| 14177 | Hash Join | 35.09 | 132.26 | 276.9% | operator |
| 14178 | Seq Scan | 33.58 | 23.03 | 31.4% | operator |
| 14179 | Hash | 0.23 | 23.66 | 10321.2% | operator |
| 14180 | Hash Join | 0.22 | 306.84 | 137494.6% | operator |
...
### Step 5: Node 14178 (Seq Scan) - LEAF
...
### Step 8: Node 14175 (Seq Scan) - LEAF
...
### Step 11: Node 14184 (Index Scan) - LEAF
...
### Step 12: Node 14186 (Seq Scan) - LEAF
...
### Step 13: Node 14173 (Nested Loop)
...
### Step 16: Node 14187 (Index Scan) - LEAF
...
### Step 17: Node 14189 (Seq Scan) - LEAF
...
### Step 18: Node 14171 (Nested Loop)
...
### Step 22: Node 14168 (Gather Merge)
...
### Step 23: Node 14167 (Aggregate) - ROOT
