...
```
Node 16605 (Aggregate) - ROOT
  Node 16606 (Gather Merge)
    Node 16607 (Sort)
          ...
          Node 16610 (Hash Join)
            Node 16611 (Nested Loop)
              Node 16612 (Hash Join)
                ...
                Node 16614 (Hash)
                  Node 16615 (Hash Join)
                    Node 16616 (Seq Scan) - LEAF
                    Node 16617 (Hash)
                      Node 16618 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 16605 | Aggregate | 1229.34 | 1193.02 | 3.0% | operator |
| 16606 | Gather Merge | 1228.91 | 1097.17 | 10.7% | operator |
...
| 16612 | Hash Join | 217.90 | 251.17 | 15.3% | operator |
...
| 16614 | Hash | 34.63 | 20.62 | 40.5% | operator |
| 16615 | Hash Join | 33.94 | 132.26 | 289.6% | operator |
| 16616 | Seq Scan | 32.37 | 23.03 | 28.9% | operator |
| 16617 | Hash | 0.24 | 23.66 | 9756.7% | operator |
| 16618 | Hash Join | 0.24 | 306.84 | 129915.2% | operator |
...
### Step 5: Node 16616 (Seq Scan) - LEAF
...
### Step 8: Node 16613 (Seq Scan) - LEAF
...
### Step 11: Node 16622 (Index Scan) - LEAF
...
### Step 12: Node 16624 (Seq Scan) - LEAF
...
### Step 13: Node 16611 (Nested Loop)
...
### Step 16: Node 16625 (Index Scan) - LEAF
...
### Step 17: Node 16627 (Seq Scan) - LEAF
...
### Step 18: Node 16609 (Nested Loop)
...
### Step 22: Node 16606 (Gather Merge)
...
- **Input Features:**
  ...
  - total_cost=71841.3800
- **Output:** st=1093.46, rt=1097.17

### Step 23: Node 16605 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=71553.1800
  - total_cost=71938.2200
- **Output:** st=1163.01, rt=1193.02
