...
```
Node 13960 (Aggregate) - ROOT
  Node 13961 (Gather Merge)
    Node 13962 (Sort)
          ...
          Node 13965 (Hash Join)
            Node 13966 (Nested Loop)
              Node 13967 (Hash Join)
                ...
                Node 13969 (Hash)
                  Node 13970 (Hash Join)
                    Node 13971 (Seq Scan) - LEAF
                    Node 13972 (Hash)
                      Node 13973 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 13960 | Aggregate | 1235.44 | 1195.83 | 3.2% | operator |
| 13961 | Gather Merge | 1235.00 | 1097.16 | 11.2% | operator |
...
| 13967 | Hash Join | 214.82 | 251.17 | 16.9% | operator |
...
| 13969 | Hash | 36.08 | 20.62 | 42.9% | operator |
| 13970 | Hash Join | 35.48 | 132.26 | 272.7% | operator |
| 13971 | Seq Scan | 34.08 | 23.03 | 32.4% | operator |
| 13972 | Hash | 0.09 | 23.66 | 27090.9% | operator |
| 13973 | Hash Join | 0.08 | 306.84 | 365180.9% | operator |
...
### Step 5: Node 13971 (Seq Scan) - LEAF
...
### Step 8: Node 13968 (Seq Scan) - LEAF
...
### Step 11: Node 13977 (Index Scan) - LEAF
...
### Step 12: Node 13979 (Seq Scan) - LEAF
...
### Step 13: Node 13966 (Nested Loop)
...
### Step 16: Node 13980 (Index Scan) - LEAF
...
### Step 17: Node 13982 (Seq Scan) - LEAF
...
### Step 18: Node 13964 (Nested Loop)
...
### Step 22: Node 13961 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1044.9418
  - st2=0.0000
  - startup_cost=71547.2400
  - total_cost=71829.6300
- **Output:** st=1093.45, rt=1097.16

### Step 23: Node 13960 (Aggregate) - ROOT
