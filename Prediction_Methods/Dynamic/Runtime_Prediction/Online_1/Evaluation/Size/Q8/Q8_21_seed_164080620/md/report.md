...
```
Node 14650 (Aggregate) - ROOT
  Node 14651 (Gather Merge)
    Node 14652 (Sort)
          ...
          Node 14655 (Hash Join)
            Node 14656 (Nested Loop)
              Node 14657 (Hash Join)
                ...
                Node 14659 (Hash)
                  Node 14660 (Hash Join)
                    Node 14661 (Seq Scan) - LEAF
                    Node 14662 (Hash)
                      Node 14663 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 14650 | Aggregate | 1224.07 | 1192.83 | 2.6% | operator |
| 14651 | Gather Merge | 1223.61 | 1097.13 | 10.3% | operator |
...
| 14657 | Hash Join | 211.46 | 251.17 | 18.8% | operator |
...
| 14659 | Hash | 35.65 | 20.62 | 42.2% | operator |
| 14660 | Hash Join | 34.98 | 132.26 | 278.1% | operator |
| 14661 | Seq Scan | 33.46 | 23.03 | 31.2% | operator |
| 14662 | Hash | 0.22 | 23.66 | 10701.9% | operator |
| 14663 | Hash Join | 0.22 | 306.84 | 141953.7% | operator |
...
### Step 5: Node 14661 (Seq Scan) - LEAF
...
### Step 8: Node 14658 (Seq Scan) - LEAF
...
### Step 11: Node 14667 (Index Scan) - LEAF
...
### Step 12: Node 14669 (Seq Scan) - LEAF
...
### Step 13: Node 14656 (Nested Loop)
...
### Step 16: Node 14670 (Index Scan) - LEAF
...
### Step 17: Node 14672 (Seq Scan) - LEAF
...
### Step 18: Node 14654 (Nested Loop)
...
### Step 22: Node 14651 (Gather Merge)
...
### Step 23: Node 14650 (Aggregate) - ROOT
