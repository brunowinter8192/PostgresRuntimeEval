...
```
Node 15869 (Aggregate) - ROOT
  Node 15870 (Gather Merge)
    Node 15871 (Sort)
          ...
          Node 15874 (Hash Join)
            Node 15875 (Nested Loop)
              Node 15876 (Hash Join)
                ...
                Node 15878 (Hash)
                  Node 15879 (Hash Join)
                    Node 15880 (Seq Scan) - LEAF
                    Node 15881 (Hash)
                      Node 15882 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 15869 | Aggregate | 1232.07 | 1195.83 | 2.9% | operator |
| 15870 | Gather Merge | 1231.71 | 1097.18 | 10.9% | operator |
...
| 15876 | Hash Join | 214.49 | 251.17 | 17.1% | operator |
...
| 15878 | Hash | 36.21 | 20.62 | 43.1% | operator |
| 15879 | Hash Join | 35.49 | 132.26 | 272.6% | operator |
| 15880 | Seq Scan | 34.00 | 23.03 | 32.3% | operator |
| 15881 | Hash | 0.16 | 23.66 | 14324.5% | operator |
| 15882 | Hash Join | 0.16 | 306.84 | 190481.3% | operator |
...
### Step 5: Node 15880 (Seq Scan) - LEAF
...
### Step 8: Node 15877 (Seq Scan) - LEAF
...
### Step 11: Node 15886 (Index Scan) - LEAF
...
### Step 12: Node 15888 (Seq Scan) - LEAF
...
### Step 13: Node 15875 (Nested Loop)
...
### Step 16: Node 15889 (Index Scan) - LEAF
...
### Step 17: Node 15891 (Seq Scan) - LEAF
...
### Step 18: Node 15873 (Nested Loop)
...
### Step 22: Node 15870 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1044.9401
  - st2=0.0000
  - startup_cost=71539.4200
  - total_cost=71814.0100
- **Output:** st=1093.47, rt=1097.18

### Step 23: Node 15869 (Aggregate) - ROOT
