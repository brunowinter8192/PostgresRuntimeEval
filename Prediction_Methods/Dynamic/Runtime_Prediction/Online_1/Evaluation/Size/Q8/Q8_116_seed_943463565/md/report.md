...
```
Node 13592 (Aggregate) - ROOT
  Node 13593 (Gather Merge)
    Node 13594 (Sort)
          ...
          Node 13597 (Hash Join)
            Node 13598 (Nested Loop)
              Node 13599 (Hash Join)
                ...
                Node 13601 (Hash)
                  Node 13602 (Hash Join)
                    Node 13603 (Seq Scan) - LEAF
                    Node 13604 (Hash)
                      Node 13605 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 13592 | Aggregate | 1256.21 | 1187.55 | 5.5% | operator |
| 13593 | Gather Merge | 1255.79 | 1097.17 | 12.6% | operator |
...
| 13599 | Hash Join | 211.42 | 251.17 | 18.8% | operator |
...
| 13601 | Hash | 31.12 | 20.62 | 33.8% | operator |
| 13602 | Hash Join | 30.52 | 132.26 | 333.4% | operator |
| 13603 | Seq Scan | 28.95 | 23.03 | 20.5% | operator |
| 13604 | Hash | 0.22 | 23.66 | 10652.8% | operator |
| 13605 | Hash Join | 0.22 | 306.84 | 141299.1% | operator |
...
### Step 5: Node 13603 (Seq Scan) - LEAF
...
### Step 8: Node 13600 (Seq Scan) - LEAF
...
### Step 11: Node 13609 (Index Scan) - LEAF
...
### Step 12: Node 13611 (Seq Scan) - LEAF
...
### Step 13: Node 13598 (Nested Loop)
...
### Step 16: Node 13612 (Index Scan) - LEAF
...
### Step 17: Node 13614 (Seq Scan) - LEAF
...
### Step 18: Node 13596 (Nested Loop)
...
### Step 22: Node 13593 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1044.9445
  - st2=0.0000
  - startup_cost=71560.2500
  - total_cost=71855.4300
- **Output:** st=1093.46, rt=1097.17

### Step 23: Node 13592 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=71560.2500
  - total_cost=71953.4500
- **Output:** st=1160.31, rt=1187.55
