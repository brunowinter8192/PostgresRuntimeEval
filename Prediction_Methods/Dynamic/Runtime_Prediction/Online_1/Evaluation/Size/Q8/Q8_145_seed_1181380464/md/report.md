...
**Test Query:** Q8_145_seed_1181380464
...
```
Node 14328 (Aggregate) - ROOT
  Node 14329 (Gather Merge)
    Node 14330 (Sort)
      Node 14331 (Hash Join)
        Node 14332 (Nested Loop)
          Node 14333 (Hash Join)
            Node 14334 (Nested Loop)
              Node 14335 (Hash Join)
                Node 14336 (Seq Scan) - LEAF
                Node 14337 (Hash)
                  Node 14338 (Hash Join)
                    Node 14339 (Seq Scan) - LEAF
                    Node 14340 (Hash)
                      Node 14341 (Hash Join)
                        Node 14342 (Seq Scan) - LEAF
                        Node 14343 (Hash)
                          Node 14344 (Seq Scan) - LEAF
              Node 14345 (Index Scan) - LEAF
            Node 14346 (Hash)
              Node 14347 (Seq Scan) - LEAF
          Node 14348 (Index Scan) - LEAF
        Node 14349 (Hash)
          Node 14350 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 14328 | Aggregate | 1225.59 | 1194.33 | 2.6% | operator |
| 14329 | Gather Merge | 1225.21 | 1097.14 | 10.5% | operator |
| 14330 | Sort | 1220.02 | 1046.21 | 14.2% | operator |
| 14331 | Hash Join | 1219.78 | 785.61 | 35.6% | operator |
| 14332 | Nested Loop | 1219.47 | 1198.29 | 1.7% | operator |
| 14349 | Hash | 0.02 | 13.72 | 85675.5% | operator |
| 14333 | Hash Join | 1215.70 | 785.60 | 35.4% | operator |
| 14348 | Index Scan | 0.01 | 12.42 | 206958.1% | operator |
| 14350 | Seq Scan | 0.01 | 6.51 | 54166.4% | operator |
| 14334 | Nested Loop | 1176.66 | 1198.29 | 1.8% | operator |
| 14346 | Hash | 34.61 | 19.97 | 42.3% | operator |
| 14335 | Hash Join | 208.31 | 251.17 | 20.6% | operator |
| 14345 | Index Scan | 0.04 | 2.88 | 6759.2% | operator |
| 14347 | Seq Scan | 34.55 | 48.87 | 41.5% | operator |
| 14336 | Seq Scan | 158.72 | 159.67 | 0.6% | operator |
| 14337 | Hash | 31.52 | 20.62 | 34.6% | operator |
| 14338 | Hash Join | 30.84 | 132.26 | 328.8% | operator |
| 14339 | Seq Scan | 29.25 | 23.03 | 21.3% | operator |
| 14340 | Hash | 0.21 | 23.66 | 11111.4% | operator |
| 14341 | Hash Join | 0.21 | 306.84 | 147417.3% | operator |
| 14342 | Seq Scan | 0.01 | 12.22 | 135732.7% | operator |
| 14343 | Hash | 0.19 | 18.14 | 9350.1% | operator |
| 14344 | Seq Scan | 0.19 | 23.36 | 12393.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 14344 (Seq Scan) - LEAF
...
### Step 2: Node 14342 (Seq Scan) - LEAF
...
### Step 5: Node 14339 (Seq Scan) - LEAF
...
### Step 8: Node 14336 (Seq Scan) - LEAF
...
### Step 11: Node 14345 (Index Scan) - LEAF
...
### Step 12: Node 14347 (Seq Scan) - LEAF
...
### Step 13: Node 14334 (Nested Loop)
...
### Step 16: Node 14348 (Index Scan) - LEAF
...
### Step 17: Node 14350 (Seq Scan) - LEAF
...
### Step 18: Node 14332 (Nested Loop)
...
### Step 22: Node 14329 (Gather Merge)
...
### Step 23: Node 14328 (Aggregate) - ROOT
