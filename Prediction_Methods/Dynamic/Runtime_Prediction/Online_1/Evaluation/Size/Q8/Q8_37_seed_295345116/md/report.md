...
```
Node 15041 (Aggregate) - ROOT
  Node 15042 (Gather Merge)
    Node 15043 (Sort)
          ...
          Node 15046 (Hash Join)
            Node 15047 (Nested Loop)
              Node 15048 (Hash Join)
                ...
                Node 15050 (Hash)
                  Node 15051 (Hash Join)
                    Node 15052 (Seq Scan) - LEAF
                    Node 15053 (Hash)
                      Node 15054 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 15041 | Aggregate | 1269.18 | 1189.76 | 6.3% | operator |
| 15042 | Gather Merge | 1268.79 | 1097.15 | 13.5% | operator |
...
| 15048 | Hash Join | 216.40 | 251.17 | 16.1% | operator |
...
| 15050 | Hash | 35.18 | 20.62 | 41.4% | operator |
| 15051 | Hash Join | 34.26 | 132.26 | 286.1% | operator |
| 15052 | Seq Scan | 32.76 | 23.03 | 29.7% | operator |
| 15053 | Hash | 0.17 | 23.66 | 13815.4% | operator |
| 15054 | Hash Join | 0.17 | 306.84 | 183634.1% | operator |
...
### Step 5: Node 15052 (Seq Scan) - LEAF
...
### Step 8: Node 15049 (Seq Scan) - LEAF
...
### Step 11: Node 15058 (Index Scan) - LEAF
...
### Step 12: Node 15060 (Seq Scan) - LEAF
...
### Step 13: Node 15047 (Nested Loop)
...
### Step 16: Node 15061 (Index Scan) - LEAF
...
### Step 17: Node 15063 (Seq Scan) - LEAF
...
### Step 18: Node 15045 (Nested Loop)
...
### Step 22: Node 15042 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1044.9439
  - st2=0.0000
  - startup_cost=71557.2800
  - total_cost=71849.6200
- **Output:** st=1093.44, rt=1097.15

### Step 23: Node 15041 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=71557.2800
  - total_cost=71947.1600
- **Output:** st=1161.42, rt=1189.76
