...
```
Node 14305 (Aggregate) - ROOT
  Node 14306 (Gather Merge)
    Node 14307 (Sort)
          ...
          Node 14310 (Hash Join)
            Node 14311 (Nested Loop)
              Node 14312 (Hash Join)
                ...
                Node 14314 (Hash)
                  Node 14315 (Hash Join)
                    Node 14316 (Seq Scan) - LEAF
                    Node 14317 (Hash)
                      Node 14318 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 14305 | Aggregate | 1230.85 | 1191.81 | 3.2% | operator |
| 14306 | Gather Merge | 1230.41 | 1097.16 | 10.8% | operator |
...
| 14312 | Hash Join | 216.53 | 251.17 | 16.0% | operator |
...
| 14314 | Hash | 36.36 | 20.62 | 43.3% | operator |
| 14315 | Hash Join | 35.60 | 132.26 | 271.6% | operator |
| 14316 | Seq Scan | 34.08 | 23.03 | 32.4% | operator |
| 14317 | Hash | 0.19 | 23.66 | 12550.3% | operator |
| 14318 | Hash Join | 0.18 | 306.84 | 166658.7% | operator |
...
### Step 5: Node 14316 (Seq Scan) - LEAF
...
### Step 8: Node 14313 (Seq Scan) - LEAF
...
### Step 11: Node 14322 (Index Scan) - LEAF
...
### Step 12: Node 14324 (Seq Scan) - LEAF
...
### Step 13: Node 14311 (Nested Loop)
...
### Step 16: Node 14325 (Index Scan) - LEAF
...
### Step 17: Node 14327 (Seq Scan) - LEAF
...
### Step 18: Node 14309 (Nested Loop)
...
### Step 22: Node 14306 (Gather Merge)
...
### Step 23: Node 14305 (Aggregate) - ROOT
