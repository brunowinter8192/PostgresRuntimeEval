...
```
Node 14374 (Aggregate) - ROOT
  Node 14375 (Gather Merge)
    Node 14376 (Sort)
          ...
          Node 14379 (Hash Join)
            Node 14380 (Nested Loop)
              Node 14381 (Hash Join)
                ...
                Node 14383 (Hash)
                  Node 14384 (Hash Join)
                    Node 14385 (Seq Scan) - LEAF
                    Node 14386 (Hash)
                      Node 14387 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 14374 | Aggregate | 1230.48 | 1191.81 | 3.1% | operator |
| 14375 | Gather Merge | 1230.10 | 1097.16 | 10.8% | operator |
...
| 14381 | Hash Join | 216.06 | 251.17 | 16.2% | operator |
...
| 14383 | Hash | 37.85 | 20.62 | 45.5% | operator |
| 14384 | Hash Join | 37.11 | 132.26 | 256.4% | operator |
| 14385 | Seq Scan | 35.43 | 23.03 | 35.0% | operator |
| 14386 | Hash | 0.17 | 23.66 | 14065.3% | operator |
| 14387 | Hash Join | 0.16 | 306.84 | 189304.9% | operator |
...
### Step 5: Node 14385 (Seq Scan) - LEAF
...
### Step 8: Node 14382 (Seq Scan) - LEAF
...
### Step 11: Node 14391 (Index Scan) - LEAF
...
### Step 12: Node 14393 (Seq Scan) - LEAF
...
### Step 13: Node 14380 (Nested Loop)
...
### Step 16: Node 14394 (Index Scan) - LEAF
...
### Step 17: Node 14396 (Seq Scan) - LEAF
...
### Step 18: Node 14378 (Nested Loop)
...
### Step 22: Node 14375 (Gather Merge)
...
### Step 23: Node 14374 (Aggregate) - ROOT
