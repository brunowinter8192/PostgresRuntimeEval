...
```
Node 13776 (Aggregate) - ROOT
  Node 13777 (Gather Merge)
    Node 13778 (Sort)
          ...
          Node 13781 (Hash Join)
            Node 13782 (Nested Loop)
              Node 13783 (Hash Join)
                ...
                Node 13785 (Hash)
                  Node 13786 (Hash Join)
                    Node 13787 (Seq Scan) - LEAF
                    Node 13788 (Hash)
                      Node 13789 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 13776 | Aggregate | 1212.34 | 1190.97 | 1.8% | operator |
| 13777 | Gather Merge | 1211.91 | 1097.16 | 9.5% | operator |
...
| 13783 | Hash Join | 214.01 | 251.17 | 17.4% | operator |
...
| 13785 | Hash | 35.77 | 20.62 | 42.4% | operator |
| 13786 | Hash Join | 34.92 | 132.26 | 278.8% | operator |
| 13787 | Seq Scan | 33.49 | 23.03 | 31.2% | operator |
| 13788 | Hash | 0.10 | 23.66 | 23795.1% | operator |
| 13789 | Hash Join | 0.10 | 306.84 | 322885.2% | operator |
...
### Step 5: Node 13787 (Seq Scan) - LEAF
...
### Step 8: Node 13784 (Seq Scan) - LEAF
...
### Step 11: Node 13793 (Index Scan) - LEAF
...
### Step 12: Node 13795 (Seq Scan) - LEAF
...
### Step 13: Node 13782 (Nested Loop)
...
### Step 16: Node 13796 (Index Scan) - LEAF
...
### Step 17: Node 13798 (Seq Scan) - LEAF
...
### Step 18: Node 13780 (Nested Loop)
...
### Step 22: Node 13777 (Gather Merge)
...
### Step 23: Node 13776 (Aggregate) - ROOT
