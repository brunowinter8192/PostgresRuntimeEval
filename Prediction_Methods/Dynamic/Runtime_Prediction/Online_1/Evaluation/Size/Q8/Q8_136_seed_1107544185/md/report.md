...
```
Node 14098 (Aggregate) - ROOT
  Node 14099 (Gather Merge)
    Node 14100 (Sort)
          ...
          Node 14103 (Hash Join)
            Node 14104 (Nested Loop)
              Node 14105 (Hash Join)
                ...
                Node 14107 (Hash)
                  Node 14108 (Hash Join)
                    Node 14109 (Seq Scan) - LEAF
                    Node 14110 (Hash)
                      Node 14111 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 14098 | Aggregate | 1210.06 | 1195.83 | 1.2% | operator |
| 14099 | Gather Merge | 1209.69 | 1097.16 | 9.3% | operator |
...
| 14105 | Hash Join | 212.07 | 251.17 | 18.4% | operator |
...
| 14107 | Hash | 34.98 | 20.62 | 41.1% | operator |
| 14108 | Hash Join | 33.62 | 132.26 | 293.4% | operator |
| 14109 | Seq Scan | 32.20 | 23.03 | 28.5% | operator |
| 14110 | Hash | 0.10 | 23.66 | 22646.3% | operator |
| 14111 | Hash Join | 0.10 | 306.84 | 306736.0% | operator |
...
### Step 5: Node 14109 (Seq Scan) - LEAF
...
### Step 8: Node 14106 (Seq Scan) - LEAF
...
### Step 11: Node 14115 (Index Scan) - LEAF
...
### Step 12: Node 14117 (Seq Scan) - LEAF
...
### Step 13: Node 14104 (Nested Loop)
...
### Step 16: Node 14118 (Index Scan) - LEAF
...
### Step 17: Node 14120 (Seq Scan) - LEAF
...
### Step 18: Node 14102 (Nested Loop)
...
### Step 22: Node 14099 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1044.9402
  - st2=0.0000
  - startup_cost=71539.8000
  - total_cost=71814.8600
- **Output:** st=1093.45, rt=1097.16

### Step 23: Node 14098 (Aggregate) - ROOT
