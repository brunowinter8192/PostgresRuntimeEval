...
```
Node 15984 (Aggregate) - ROOT
  Node 15985 (Gather Merge)
    Node 15986 (Sort)
          ...
          Node 15989 (Hash Join)
            Node 15990 (Nested Loop)
              Node 15991 (Hash Join)
                ...
                Node 15993 (Hash)
                  Node 15994 (Hash Join)
                    Node 15995 (Seq Scan) - LEAF
                    Node 15996 (Hash)
                      Node 15997 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 15984 | Aggregate | 1200.21 | 1189.02 | 0.9% | operator |
| 15985 | Gather Merge | 1199.72 | 1097.18 | 8.5% | operator |
...
| 15991 | Hash Join | 221.02 | 251.17 | 13.6% | operator |
...
| 15993 | Hash | 34.93 | 20.62 | 41.0% | operator |
| 15994 | Hash Join | 34.39 | 132.26 | 284.6% | operator |
| 15995 | Seq Scan | 32.96 | 23.03 | 30.1% | operator |
| 15996 | Hash | 0.16 | 23.66 | 14967.6% | operator |
| 15997 | Hash Join | 0.15 | 306.84 | 199144.1% | operator |
...
### Step 5: Node 15995 (Seq Scan) - LEAF
...
### Step 8: Node 15992 (Seq Scan) - LEAF
...
### Step 11: Node 16001 (Index Scan) - LEAF
...
### Step 12: Node 16003 (Seq Scan) - LEAF
...
### Step 13: Node 15990 (Nested Loop)
...
### Step 16: Node 16004 (Index Scan) - LEAF
...
### Step 17: Node 16006 (Seq Scan) - LEAF
...
### Step 18: Node 15988 (Nested Loop)
...
### Step 22: Node 15985 (Gather Merge)
...
### Step 23: Node 15984 (Aggregate) - ROOT
