...
```
Node 13247 (Aggregate) - ROOT
  Node 13248 (Gather Merge)
    Node 13249 (Sort)
          ...
          Node 13252 (Hash Join)
            Node 13253 (Nested Loop)
              Node 13254 (Hash Join)
                ...
                Node 13256 (Hash)
                  Node 13257 (Hash Join)
                    Node 13258 (Seq Scan) - LEAF
                    Node 13259 (Hash)
                      Node 13260 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 13247 | Aggregate | 1200.03 | 1186.72 | 1.1% | operator |
| 13248 | Gather Merge | 1199.62 | 1097.17 | 8.5% | operator |
...
| 13254 | Hash Join | 206.30 | 251.17 | 21.8% | operator |
...
| 13256 | Hash | 30.60 | 20.62 | 32.6% | operator |
| 13257 | Hash Join | 29.99 | 132.26 | 341.0% | operator |
| 13258 | Seq Scan | 26.40 | 23.03 | 12.8% | operator |
| 13259 | Hash | 2.10 | 23.66 | 1027.6% | operator |
| 13260 | Hash Join | 2.10 | 306.84 | 14546.1% | operator |
...
### Step 5: Node 13258 (Seq Scan) - LEAF
...
### Step 8: Node 13255 (Seq Scan) - LEAF
...
### Step 11: Node 13264 (Index Scan) - LEAF
...
### Step 12: Node 13266 (Seq Scan) - LEAF
...
### Step 13: Node 13253 (Nested Loop)
...
### Step 16: Node 13267 (Index Scan) - LEAF
...
### Step 17: Node 13269 (Seq Scan) - LEAF
...
### Step 18: Node 13251 (Nested Loop)
...
### Step 22: Node 13248 (Gather Merge)
...
### Step 23: Node 13247 (Aggregate) - ROOT
