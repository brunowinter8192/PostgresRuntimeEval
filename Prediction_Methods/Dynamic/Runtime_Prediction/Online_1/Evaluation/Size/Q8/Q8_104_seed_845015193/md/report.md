...
```
Node 13293 (Aggregate) - ROOT
  Node 13294 (Gather Merge)
    Node 13295 (Sort)
          ...
          Node 13298 (Hash Join)
            Node 13299 (Nested Loop)
              Node 13300 (Hash Join)
                ...
                Node 13302 (Hash)
                  Node 13303 (Hash Join)
                    Node 13304 (Seq Scan) - LEAF
                    Node 13305 (Hash)
                      Node 13306 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 13293 | Aggregate | 1206.31 | 1195.83 | 0.9% | operator |
| 13294 | Gather Merge | 1205.89 | 1097.17 | 9.0% | operator |
...
| 13300 | Hash Join | 210.31 | 251.17 | 19.4% | operator |
...
| 13302 | Hash | 34.03 | 20.62 | 39.4% | operator |
| 13303 | Hash Join | 33.51 | 132.26 | 294.7% | operator |
| 13304 | Seq Scan | 32.13 | 23.03 | 28.3% | operator |
| 13305 | Hash | 0.08 | 23.66 | 31026.5% | operator |
| 13306 | Hash Join | 0.07 | 306.84 | 414543.2% | operator |
...
### Step 5: Node 13304 (Seq Scan) - LEAF
...
### Step 8: Node 13301 (Seq Scan) - LEAF
...
### Step 11: Node 13310 (Index Scan) - LEAF
...
### Step 12: Node 13312 (Seq Scan) - LEAF
...
### Step 13: Node 13299 (Nested Loop)
...
### Step 16: Node 13313 (Index Scan) - LEAF
...
### Step 17: Node 13315 (Seq Scan) - LEAF
...
### Step 18: Node 13297 (Nested Loop)
...
### Step 22: Node 13294 (Gather Merge)
...
### Step 23: Node 13293 (Aggregate) - ROOT
