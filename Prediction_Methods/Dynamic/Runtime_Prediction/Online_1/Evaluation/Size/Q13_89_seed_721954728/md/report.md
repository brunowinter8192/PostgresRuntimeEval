...
```
Node 26329 (Sort) - ROOT
  Node 26330 (Aggregate)
    Node 26331 (Aggregate)
      Node 26332 (Hash Join)
        Node 26333 (Seq Scan) - LEAF
        Node 26334 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 26329 | Sort | 924.67 | 1081.93 | 17.0% | operator |
| 26330 | Aggregate | 924.64 | 1000.34 | 8.2% | operator |
| 26331 | Aggregate | 918.56 | 1014.18 | 10.4% | operator |
| 26332 | Hash Join | 699.90 | 787.83 | 12.6% | operator |
| 26333 | Seq Scan | 481.65 | 264.12 | 45.2% | operator |
| 26334 | Hash | 15.01 | 80.15 | 434.0% | operator |
...
### Step 2: Node 26333 (Seq Scan) - LEAF
