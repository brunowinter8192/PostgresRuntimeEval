...
**Test Query:** Q13_89_seed_721954728
...
```
Node 26329 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26330 (Aggregate) [consumed]
    Node 26331 (Aggregate)
      Node 26332 (Hash Join) [PATTERN: 895c6e8c]
        Node 26333 (Seq Scan) [consumed] - LEAF
        Node 26334 (Hash) [consumed]
          Node 26335 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26329 | 26330, 26332, 26333, 26334 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26332 | 26329, 26330, 26333, 26334 |
...
|------|------|--------|-----------|-----|--------|
| 26329 | Sort | 924.67 | 1079.93 | 16.8% | pattern |
| 26331 | Aggregate | 918.56 | 999.55 | 8.8% | operator |
| 26332 | Hash Join | 699.90 | 470.31 | 32.8% | pattern |
| 26335 | Index Only Scan | 9.58 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26335 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26332 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26329, 26330, 26333, 26334
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1484970
...
### Step 4: Node 26329 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26330, 26332, 26333, 26334
- **Input Features:**
