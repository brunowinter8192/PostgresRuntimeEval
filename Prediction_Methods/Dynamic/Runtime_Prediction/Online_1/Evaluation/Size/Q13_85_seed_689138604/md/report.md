...
**Test Query:** Q13_85_seed_689138604
...
```
Node 26301 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26302 (Aggregate) [consumed]
    Node 26303 (Aggregate)
      Node 26304 (Hash Join) [PATTERN: 895c6e8c]
        Node 26305 (Seq Scan) [consumed] - LEAF
        Node 26306 (Hash) [consumed]
          Node 26307 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26301 | 26302, 26304, 26305, 26306 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26304 | 26301, 26302, 26305, 26306 |
...
|------|------|--------|-----------|-----|--------|
| 26301 | Sort | 928.32 | 1079.93 | 16.3% | pattern |
| 26303 | Aggregate | 922.15 | 999.15 | 8.3% | operator |
| 26304 | Hash Join | 714.39 | 470.31 | 34.2% | pattern |
| 26307 | Index Only Scan | 9.58 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26307 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26304 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26301, 26302, 26305, 26306
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1478958
...
### Step 4: Node 26301 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26302, 26304, 26305, 26306
- **Input Features:**
