...
```
Node 25608 (Sort) - ROOT
  Node 25609 (Aggregate)
    Node 25610 (Aggregate)
      Node 25611 (Hash Join)
        Node 25612 (Seq Scan) - LEAF
        Node 25613 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 25608 | Sort | 915.48 | 1081.93 | 18.2% | operator |
| 25609 | Aggregate | 915.44 | 1000.36 | 9.3% | operator |
| 25610 | Aggregate | 909.35 | 1013.77 | 11.5% | operator |
| 25611 | Hash Join | 694.01 | 787.83 | 13.5% | operator |
| 25612 | Seq Scan | 478.39 | 263.97 | 44.8% | operator |
| 25613 | Hash | 17.27 | 80.15 | 364.1% | operator |
...
### Step 2: Node 25612 (Seq Scan) - LEAF
