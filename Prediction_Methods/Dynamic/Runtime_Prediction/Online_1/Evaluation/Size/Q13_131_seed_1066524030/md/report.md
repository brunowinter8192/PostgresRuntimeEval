...
**Test Query:** Q13_131_seed_1066524030
**Timestamp:** 2026-01-18 19:55:52
...
```
Node 25608 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25609 (Aggregate) [consumed]
    Node 25610 (Aggregate)
      Node 25611 (Hash Join) [PATTERN: 895c6e8c]
        Node 25612 (Seq Scan) [consumed] - LEAF
        Node 25613 (Hash) [consumed]
          Node 25614 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25608 | 25609, 25611, 25612, 25613 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25611 | 25608, 25609, 25612, 25613 |
...
|------|------|--------|-----------|-----|--------|
| 25608 | Sort | 915.48 | 1079.93 | 18.0% | pattern |
| 25610 | Aggregate | 909.35 | 999.15 | 9.9% | operator |
| 25611 | Hash Join | 694.01 | 470.31 | 32.2% | pattern |
| 25614 | Index Only Scan | 10.85 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25614 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25611 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25608, 25609, 25612, 25613
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1478958
...
- **Output:** st=908.31, rt=999.15

### Step 4: Node 25608 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25609, 25611, 25612, 25613
- **Input Features:**
