...
```
Node 26231 (Sort) - ROOT
  Node 26232 (Aggregate)
    Node 26233 (Aggregate)
      Node 26234 (Hash Join)
        Node 26235 (Seq Scan) - LEAF
        Node 26236 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 26231 | Sort | 967.67 | 1081.93 | 11.8% | operator |
| 26232 | Aggregate | 967.65 | 1000.34 | 3.4% | operator |
| 26233 | Aggregate | 961.76 | 1014.18 | 5.5% | operator |
| 26234 | Hash Join | 737.83 | 787.83 | 6.8% | operator |
| 26235 | Seq Scan | 513.06 | 264.12 | 48.5% | operator |
| 26236 | Hash | 16.05 | 80.15 | 399.2% | operator |
...
### Step 2: Node 26235 (Seq Scan) - LEAF
