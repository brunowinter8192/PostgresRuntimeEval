...
**Test Query:** Q13_76_seed_615302325
...
```
Node 26231 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26232 (Aggregate) [consumed]
    Node 26233 (Aggregate)
      Node 26234 (Hash Join) [PATTERN: 895c6e8c]
        Node 26235 (Seq Scan) [consumed] - LEAF
        Node 26236 (Hash) [consumed]
          Node 26237 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26231 | 26232, 26234, 26235, 26236 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26234 | 26231, 26232, 26235, 26236 |
...
|------|------|--------|-----------|-----|--------|
| 26231 | Sort | 967.67 | 1079.93 | 11.6% | pattern |
| 26233 | Aggregate | 961.76 | 999.55 | 3.9% | operator |
| 26234 | Hash Join | 737.83 | 470.31 | 36.3% | pattern |
| 26237 | Index Only Scan | 9.99 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26237 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26234 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26231, 26232, 26235, 26236
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1484970
...
### Step 4: Node 26231 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26232, 26234, 26235, 26236
- **Input Features:**
