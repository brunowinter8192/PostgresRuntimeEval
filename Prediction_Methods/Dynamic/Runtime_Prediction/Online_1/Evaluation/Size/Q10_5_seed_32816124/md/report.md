    ...
    Node 20737 (Aggregate) [consumed]
      Node 20738 (Gather) [consumed]
        Node 20739 (Hash Join)
          Node 20740 (Hash Join)
            Node 20741 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20735 | 20736, 20737, 20738 |
...
| 20739 | Hash Join | 1130.46 | 1007.22 | 10.9% | operator |
| 20740 | Hash Join | 1127.59 | 1004.13 | 10.9% | operator |
| 20746 | Hash | 0.01 | 15.71 | 104638.5% | operator |
| 20741 | Nested Loop | 1080.73 | 1204.81 | 11.5% | operator |
| 20744 | Hash | 36.03 | 55.57 | 54.2% | operator |
...
### Step 6: Node 20747 (Seq Scan) - LEAF
...
### Step 10: Node 20735 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20736, 20737, 20738
- **Input Features:**
