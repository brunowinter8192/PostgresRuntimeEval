...
**Test Query:** Q18_8_seed_57428217
...
```
Node 31028 (Limit) - ROOT
  Node 31029 (Sort)
    Node 31030 (Aggregate)
      Node 31031 (Gather Merge)
        Node 31032 (Incremental Sort)
          Node 31033 (Nested Loop)
            Node 31034 (Merge Join)
              Node 31035 (Sort)
                Node 31036 (Hash Join) [PATTERN: 895c6e8c]
                  Node 31037 (Seq Scan) [consumed] - LEAF
                  Node 31038 (Hash) [consumed]
                    Node 31039 (Aggregate)
                      Node 31040 (Index Scan) - LEAF
              Node 31041 (Sort)
                Node 31042 (Seq Scan) - LEAF
            Node 31043 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 31036 | 31037, 31038 |
...
|------|------|--------|-----------|-----|--------|
| 31028 | Limit | 3041.66 | 1175.21 | 61.4% | operator |
| 31029 | Sort | 2928.51 | 1127.81 | 61.5% | operator |
| 31030 | Aggregate | 2928.47 | 1073.15 | 63.4% | operator |
| 31031 | Gather Merge | 2928.46 | 1073.95 | 63.3% | operator |
| 31032 | Incremental Sort | 2906.26 | 0.00 | 100.0% | operator |
| 31033 | Nested Loop | 2906.21 | 1111.34 | 61.8% | operator |
| 31034 | Merge Join | 2906.14 | 0.00 | 100.0% | operator |
| 31043 | Index Scan | 0.02 | 0.05 | 105.2% | operator |
| 31035 | Sort | 2835.32 | 1095.58 | 61.4% | operator |
| 31041 | Sort | 67.07 | 1074.66 | 1502.3% | operator |
| 31036 | Hash Join | 2835.31 | 471.07 | 83.4% | pattern |
| 31042 | Seq Scan | 53.53 | 18.25 | 65.9% | operator |
| 31039 | Aggregate | 2612.58 | 1073.15 | 58.9% | operator |
| 31040 | Index Scan | 2114.16 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31040 (Index Scan) - LEAF
...
### Step 3: Node 31036 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 31037, 31038
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 31042 (Seq Scan) - LEAF
...
### Step 7: Node 31034 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 31043 (Index Scan) - LEAF
...
### Step 10: Node 31032 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 31031 (Gather Merge)
