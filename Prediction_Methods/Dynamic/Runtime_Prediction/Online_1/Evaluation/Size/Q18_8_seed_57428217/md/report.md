        ...
        Node 31032 (Incremental Sort)
          Node 31033 (Nested Loop)
            Node 31034 (Merge Join)
              Node 31035 (Sort)
                Node 31036 (Hash Join)
                  Node 31037 (Seq Scan) - LEAF
                  Node 31038 (Hash)
...
| 31035 | Sort | 2835.32 | 1099.77 | 61.2% | operator |
| 31041 | Sort | 67.07 | 1074.66 | 1502.3% | operator |
| 31036 | Hash Join | 2835.31 | 686.33 | 75.8% | operator |
| 31042 | Seq Scan | 53.53 | 18.25 | 65.9% | operator |
| 31037 | Seq Scan | 192.26 | 170.37 | 11.4% | operator |
| 31038 | Hash | 2612.61 | 21.04 | 99.2% | operator |
...
### Step 3: Node 31037 (Seq Scan) - LEAF
...
### Step 6: Node 31042 (Seq Scan) - LEAF
...
### Step 9: Node 31034 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 31043 (Index Scan) - LEAF
...
### Step 11: Node 31033 (Nested Loop)
...
### Step 12: Node 31032 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 31031 (Gather Merge)
