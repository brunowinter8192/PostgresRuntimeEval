...
**Test Query:** Q1_48_seed_385589457
...
```
Node 461 (Aggregate) - ROOT
  Node 462 (Gather Merge)
    Node 463 (Sort) [PATTERN: 1d35fb97]
      Node 464 (Aggregate) [consumed]
        Node 465 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 463 | 464 |
...
|------|------|--------|-----------|-----|--------|
| 461 | Aggregate | 1001.62 | 1195.96 | 19.4% | operator |
| 462 | Gather Merge | 1001.56 | 1165.93 | 16.4% | operator |
| 463 | Sort | 982.31 | 1200.78 | 22.2% | pattern |
| 465 | Seq Scan | 564.15 | 679.19 | 20.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 465 (Seq Scan) - LEAF
...
### Step 2: Node 463 (Sort) - PATTERN ROOT
...
### Step 4: Node 461 (Aggregate) - ROOT
