...
```
Node 6509 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6510 (Gather Merge) [consumed]
    Node 6511 (Sort) [consumed]
      Node 6512 (Aggregate) [consumed]
        Node 6513 (Nested Loop)
          Node 6514 (Seq Scan) - LEAF
          Node 6515 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6509 | 6510, 6511, 6512 |
...
|------|------|--------|-----------|-----|--------|
| 6509 | Aggregate | 1052.03 | 952.19 | 9.5% | pattern |
| 6513 | Nested Loop | 1045.55 | 1255.45 | 20.1% | operator |
| 6514 | Seq Scan | 166.39 | 154.66 | 7.0% | operator |
| 6515 | Index Scan | 0.06 | 11.10 | 18103.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6514 (Seq Scan) - LEAF
...
### Step 2: Node 6515 (Index Scan) - LEAF
