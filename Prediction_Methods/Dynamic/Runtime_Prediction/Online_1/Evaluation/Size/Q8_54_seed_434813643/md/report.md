...
**Test Query:** Q8_54_seed_434813643
...
```
Node 15478 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 15479 (Gather Merge) [consumed]
    Node 15480 (Sort)
      Node 15481 (Hash Join)
        Node 15482 (Nested Loop)
          Node 15483 (Hash Join)
            Node 15484 (Nested Loop)
              Node 15485 (Hash Join)
                Node 15486 (Seq Scan) - LEAF
                Node 15487 (Hash) [PATTERN: 444761fb]
                  Node 15488 (Hash Join) [consumed]
                    Node 15489 (Seq Scan) [consumed] - LEAF
                    Node 15490 (Hash) [consumed]
                      Node 15491 (Hash Join) [consumed]
                        Node 15492 (Seq Scan) - LEAF
                        Node 15493 (Hash)
                          Node 15494 (Seq Scan) - LEAF
              Node 15495 (Index Scan) - LEAF
            Node 15496 (Hash)
              Node 15497 (Seq Scan) - LEAF
          Node 15498 (Index Scan) - LEAF
        Node 15499 (Hash)
          Node 15500 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 15487 | 15478, 15479, 15488, 15489, 15490, 15491 |
| Aggregate -> Gather Merge (Out | 2724c080 | 15478 | 15479, 15487, 15488, 15489, 15490, 15491 |
...
|------|------|--------|-----------|-----|--------|
| 15478 | Aggregate | 1247.46 | 1128.46 | 9.5% | pattern |
| 15480 | Sort | 1240.41 | 1046.21 | 15.7% | operator |
| 15481 | Hash Join | 1240.13 | 785.61 | 36.7% | operator |
| 15482 | Nested Loop | 1239.81 | 1198.29 | 3.3% | operator |
| 15499 | Hash | 0.02 | 13.72 | 80629.9% | operator |
| 15483 | Hash Join | 1236.04 | 785.60 | 36.4% | operator |
| 15498 | Index Scan | 0.01 | 12.42 | 206958.1% | operator |
| 15500 | Seq Scan | 0.01 | 6.51 | 54166.4% | operator |
| 15484 | Nested Loop | 1190.49 | 1198.29 | 0.7% | operator |
| 15496 | Hash | 41.01 | 19.97 | 51.3% | operator |
| 15485 | Hash Join | 216.89 | 251.67 | 16.0% | operator |
| 15495 | Index Scan | 0.04 | 2.88 | 6759.2% | operator |
| 15497 | Seq Scan | 40.96 | 48.86 | 19.3% | operator |
| 15486 | Seq Scan | 161.62 | 159.67 | 1.2% | operator |
| 15487 | Hash | 36.09 | 43.51 | 20.6% | pattern |
| 15492 | Seq Scan | 0.01 | 12.22 | 174542.0% | operator |
| 15493 | Hash | 0.22 | 18.14 | 8000.1% | operator |
| 15494 | Seq Scan | 0.22 | 23.36 | 10471.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 15494 (Seq Scan) - LEAF
...
### Step 2: Node 15492 (Seq Scan) - LEAF
...
### Step 4: Node 15486 (Seq Scan) - LEAF
...
### Step 5: Node 15487 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 15478, 15479, 15488, 15489, 15490, 15491
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 15495 (Index Scan) - LEAF
...
### Step 8: Node 15497 (Seq Scan) - LEAF
...
### Step 12: Node 15498 (Index Scan) - LEAF
...
### Step 13: Node 15500 (Seq Scan) - LEAF
...
### Step 14: Node 15482 (Nested Loop)
...
### Step 18: Node 15478 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 15479, 15487, 15488, 15489, 15490, 15491
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2511
