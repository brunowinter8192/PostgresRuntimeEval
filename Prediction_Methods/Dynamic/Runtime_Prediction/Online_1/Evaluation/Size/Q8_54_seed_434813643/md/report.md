...
```
Node 15478 (Aggregate) - ROOT
  Node 15479 (Gather Merge)
    Node 15480 (Sort)
          ...
          Node 15483 (Hash Join)
            Node 15484 (Nested Loop)
              Node 15485 (Hash Join)
                ...
                Node 15487 (Hash)
                  Node 15488 (Hash Join)
                    Node 15489 (Seq Scan) - LEAF
                    Node 15490 (Hash)
                      Node 15491 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 15478 | Aggregate | 1247.46 | 1186.07 | 4.9% | operator |
| 15479 | Gather Merge | 1247.02 | 1097.16 | 12.0% | operator |
...
| 15485 | Hash Join | 216.89 | 251.17 | 15.8% | operator |
...
| 15487 | Hash | 36.09 | 20.62 | 42.9% | operator |
| 15488 | Hash Join | 34.97 | 132.26 | 278.2% | operator |
| 15489 | Seq Scan | 33.38 | 23.03 | 31.0% | operator |
| 15490 | Hash | 0.24 | 23.66 | 9756.7% | operator |
| 15491 | Hash Join | 0.24 | 306.84 | 128822.7% | operator |
...
### Step 5: Node 15489 (Seq Scan) - LEAF
...
### Step 8: Node 15486 (Seq Scan) - LEAF
...
### Step 11: Node 15495 (Index Scan) - LEAF
...
### Step 12: Node 15497 (Seq Scan) - LEAF
...
### Step 13: Node 15484 (Nested Loop)
...
### Step 16: Node 15498 (Index Scan) - LEAF
...
### Step 17: Node 15500 (Seq Scan) - LEAF
...
### Step 18: Node 15482 (Nested Loop)
...
### Step 22: Node 15479 (Gather Merge)
...
### Step 23: Node 15478 (Aggregate) - ROOT
