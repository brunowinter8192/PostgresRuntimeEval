...
```
Node 12967 (Aggregate) - ROOT
  Node 12968 (Gather Merge)
    Node 12969 (Sort)
      Node 12970 (Hash Join)
        Node 12971 (Nested Loop)
          Node 12972 (Hash Join)
            Node 12973 (Seq Scan) - LEAF
            Node 12974 (Hash)
              Node 12975 (Hash Join)
                Node 12976 (Seq Scan) - LEAF
                Node 12977 (Hash)
                  Node 12978 (Seq Scan) - LEAF
          Node 12979 (Index Scan) - LEAF
        Node 12980 (Hash)
          Node 12981 (Hash Join)
            Node 12982 (Seq Scan) - LEAF
            Node 12983 (Hash)
              Node 12984 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12967 | Aggregate | 1240.13 | 1209.26 | 2.5% | operator |
| 12968 | Gather Merge | 1238.97 | 1142.98 | 7.7% | operator |
| 12969 | Sort | 1232.91 | 1109.13 | 10.0% | operator |
| 12970 | Hash Join | 1232.18 | 842.59 | 31.6% | operator |
| 12971 | Nested Loop | 1225.33 | 1216.16 | 0.7% | operator |
| 12980 | Hash | 2.90 | 17.53 | 504.9% | operator |
| 12972 | Hash Join | 216.65 | 384.47 | 77.5% | operator |
| 12979 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 12981 | Hash Join | 2.85 | 85.17 | 2886.5% | operator |
| 12973 | Seq Scan | 154.84 | 201.16 | 29.9% | operator |
| 12974 | Hash | 35.96 | 19.59 | 45.5% | operator |
| 12982 | Seq Scan | 2.53 | 11.47 | 353.6% | operator |
| 12983 | Hash | 0.01 | 16.89 | 129854.5% | operator |
| 12975 | Hash Join | 35.62 | 92.20 | 158.8% | operator |
| 12984 | Seq Scan | 0.01 | 45.79 | 457823.2% | operator |
| 12976 | Seq Scan | 34.52 | 21.86 | 36.7% | operator |
| 12977 | Hash | 0.01 | 16.89 | 168840.8% | operator |
| 12978 | Seq Scan | 0.01 | 45.79 | 763105.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12978 (Seq Scan) - LEAF
...
### Step 2: Node 12976 (Seq Scan) - LEAF
...
### Step 5: Node 12984 (Seq Scan) - LEAF
...
### Step 6: Node 12973 (Seq Scan) - LEAF
...
### Step 8: Node 12982 (Seq Scan) - LEAF
...
### Step 11: Node 12979 (Index Scan) - LEAF
...
### Step 13: Node 12971 (Nested Loop)
...
### Step 17: Node 12968 (Gather Merge)
...
### Step 18: Node 12967 (Aggregate) - ROOT
