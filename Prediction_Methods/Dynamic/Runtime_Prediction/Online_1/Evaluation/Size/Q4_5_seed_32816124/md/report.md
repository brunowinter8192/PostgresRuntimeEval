...
```
Node 6586 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6587 (Gather Merge) [consumed]
    Node 6588 (Sort) [consumed]
      Node 6589 (Aggregate) [consumed]
        Node 6590 (Nested Loop)
          Node 6591 (Seq Scan) - LEAF
          Node 6592 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6586 | 6587, 6588, 6589 |
...
|------|------|--------|-----------|-----|--------|
| 6586 | Aggregate | 1062.92 | 952.19 | 10.4% | pattern |
| 6590 | Nested Loop | 1055.06 | 1255.45 | 19.0% | operator |
| 6591 | Seq Scan | 163.91 | 154.66 | 5.6% | operator |
| 6592 | Index Scan | 0.06 | 11.10 | 17810.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6591 (Seq Scan) - LEAF
...
### Step 2: Node 6592 (Index Scan) - LEAF
