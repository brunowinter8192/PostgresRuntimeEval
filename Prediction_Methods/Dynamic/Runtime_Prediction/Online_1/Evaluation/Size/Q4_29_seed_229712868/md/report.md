...
**Test Query:** Q4_29_seed_229712868
...
```
Node 6348 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6349 (Gather Merge) [consumed]
    Node 6350 (Sort) [consumed]
      Node 6351 (Aggregate) [consumed]
        Node 6352 (Nested Loop)
          Node 6353 (Seq Scan) - LEAF
          Node 6354 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6348 | 6349, 6350, 6351 |
...
|------|------|--------|-----------|-----|--------|
| 6348 | Aggregate | 1045.38 | 952.19 | 8.9% | pattern |
| 6352 | Nested Loop | 1037.03 | 1255.45 | 21.1% | operator |
| 6353 | Seq Scan | 163.87 | 154.67 | 5.6% | operator |
| 6354 | Index Scan | 0.06 | 11.10 | 18103.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6353 (Seq Scan) - LEAF
...
### Step 2: Node 6354 (Index Scan) - LEAF
