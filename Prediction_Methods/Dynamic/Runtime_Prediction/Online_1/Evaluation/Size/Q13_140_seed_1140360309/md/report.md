...
**Test Query:** Q13_140_seed_1140360309
...
```
Node 25678 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25679 (Aggregate) [consumed]
    Node 25680 (Aggregate)
      Node 25681 (Hash Join) [PATTERN: 895c6e8c]
        Node 25682 (Seq Scan) [consumed] - LEAF
        Node 25683 (Hash) [consumed]
          Node 25684 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25678 | 25679, 25681, 25682, 25683 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25681 | 25678, 25679, 25682, 25683 |
...
|------|------|--------|-----------|-----|--------|
| 25678 | Sort | 911.72 | 1079.93 | 18.4% | pattern |
| 25680 | Aggregate | 905.76 | 999.35 | 10.3% | operator |
| 25681 | Hash Join | 695.12 | 470.31 | 32.3% | pattern |
| 25684 | Index Only Scan | 12.13 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25684 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25681 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25678, 25679, 25682, 25683
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1481964
...
### Step 4: Node 25678 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25679, 25681, 25682, 25683
- **Input Features:**
