...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5601 | 5602, 5603, 5604, 5606, 5607, 5608 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5606 | 5601, 5602, 5603, 5604, 5607, 5608 |
...
|------|------|--------|-----------|-----|--------|
| 5601 | Limit | 1200.93 | 1151.18 | 4.1% | pattern |
| 5605 | Nested Loop | 1164.36 | 1193.39 | 2.5% | operator |
| 5606 | Hash Join | 208.46 | 242.54 | 16.3% | pattern |
| 5610 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5609 | Seq Scan | 29.95 | 38.54 | 28.7% | operator |
...
- **Consumes:** Nodes 5601, 5602, 5603, 5604, 5607, 5608
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47443
  - HashJoin_nt1=236095
  ...
  - HashJoin_total_cost=37342.4000
  - Hash_Inner_np=0
  - Hash_Inner_nt=12559
...
- **Output:** st=122.12, rt=1193.39

### Step 5: Node 5601 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5602, 5603, 5604, 5606, 5607, 5608
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=315685
  - Aggregate_Outer_nt1=315685
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110535.2000
  - Aggregate_Outer_total_cost=114481.2600
  - Gather_Outer_np=0
