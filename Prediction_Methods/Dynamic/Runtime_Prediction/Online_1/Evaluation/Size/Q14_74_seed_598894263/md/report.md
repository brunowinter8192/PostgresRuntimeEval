...
```
Node 27267 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27268 (Gather) [consumed]
    Node 27269 (Aggregate) [consumed]
      Node 27270 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27267 | 27268, 27269 |
...
|------|------|--------|-----------|-----|--------|
| 27267 | Aggregate | 859.01 | 848.38 | 1.2% | pattern |
| 27270 | Hash Join | 836.84 | 807.67 | 3.5% | operator |
...
### Step 5: Node 27267 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27268, 27269
- **Input Features:**
