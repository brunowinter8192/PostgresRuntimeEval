...
**Test Query:** Q6_99_seed_803995038
**Timestamp:** 2026-01-18 17:43:30
...
```
Node 10493 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10494 (Gather) [consumed]
    Node 10495 (Aggregate) [consumed]
      Node 10496 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10493 | 10494, 10495 |
...
|------|------|--------|-----------|-----|--------|
| 10493 | Aggregate | 787.18 | 850.05 | 8.0% | pattern |
| 10496 | Seq Scan | 763.45 | 748.53 | 2.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10496 (Seq Scan) - LEAF
...
### Step 2: Node 10493 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10494, 10495
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=23677
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=32
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=139723.8600
  - Aggregate_Outer_total_cost=139723.8700
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=140724.3900
  - Aggregate_total_cost=140724.4000
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=140723.8600
  - Gather_Outer_total_cost=140724.3700
- **Output:** st=844.45, rt=850.05
