...
**Test Query:** Q14_8_seed_57428217
...
```
Node 27386 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27387 (Gather) [consumed]
    Node 27388 (Aggregate) [consumed]
      Node 27389 (Hash Join) [consumed]
        Node 27390 (Seq Scan) - LEAF
        Node 27391 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27386 | 27387, 27388, 27389 |
...
|------|------|--------|-----------|-----|--------|
| 27386 | Aggregate | 815.32 | 857.13 | 5.1% | pattern |
| 27390 | Seq Scan | 739.55 | 758.50 | 2.6% | operator |
| 27391 | Hash | 43.37 | 9.38 | 78.4% | operator |
| 27392 | Seq Scan | 38.15 | 12.70 | 66.7% | operator |
...
### Step 2: Node 27390 (Seq Scan) - LEAF
...
### Step 4: Node 27386 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27387, 27388, 27389
- **Input Features:**
