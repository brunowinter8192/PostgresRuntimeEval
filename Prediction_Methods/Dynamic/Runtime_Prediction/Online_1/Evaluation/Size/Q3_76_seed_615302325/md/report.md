...
**Test Query:** Q3_76_seed_615302325
...
```
Node 5581 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5582 (Sort) [consumed]
    Node 5583 (Aggregate) [consumed]
      Node 5584 (Gather) [consumed]
        Node 5585 (Nested Loop)
          Node 5586 (Hash Join)
            Node 5587 (Seq Scan) - LEAF
            Node 5588 (Hash)
              Node 5589 (Seq Scan) - LEAF
          Node 5590 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5581 | 5582, 5583, 5584 |
...
|------|------|--------|-----------|-----|--------|
| 5581 | Limit | 1206.39 | 1151.18 | 4.6% | pattern |
| 5585 | Nested Loop | 1167.61 | 1193.23 | 2.2% | operator |
| 5586 | Hash Join | 208.41 | 231.13 | 10.9% | operator |
| 5590 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5587 | Seq Scan | 157.85 | 163.51 | 3.6% | operator |
| 5588 | Hash | 27.74 | 17.75 | 36.0% | operator |
| 5589 | Seq Scan | 27.12 | 38.57 | 42.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5589 (Seq Scan) - LEAF
...
### Step 2: Node 5587 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37343.4900
- **Output:** st=27.26, rt=231.13

### Step 5: Node 5590 (Index Scan) - LEAF
...
- **Output:** st=121.92, rt=1193.23

### Step 7: Node 5581 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5582, 5583, 5584
- **Input Features:**
