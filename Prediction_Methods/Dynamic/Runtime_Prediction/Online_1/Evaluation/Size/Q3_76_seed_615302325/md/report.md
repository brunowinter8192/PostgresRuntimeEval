    ...
    Node 5583 (Aggregate) [consumed]
      Node 5584 (Gather) [consumed]
        Node 5585 (Nested Loop)
          Node 5586 (Hash Join) [PATTERN: 895c6e8c]
            Node 5587 (Seq Scan) [consumed] - LEAF
            Node 5588 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5581 | 5582, 5583, 5584, 5586, 5587, 5588 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5586 | 5581, 5582, 5583, 5584, 5587, 5588 |
...
| 5585 | Nested Loop | 1167.61 | 1193.31 | 2.2% | operator |
| 5586 | Hash Join | 208.41 | 242.53 | 16.4% | pattern |
...
### Step 2: Node 5586 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5581, 5582, 5583, 5584, 5587, 5588
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47320
  - HashJoin_nt1=236853
...
### Step 3: Node 5590 (Index Scan) - LEAF
...
### Step 5: Node 5581 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5582, 5583, 5584, 5586, 5587, 5588
- **Input Features:**
