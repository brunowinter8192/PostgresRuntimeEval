...
**Test Query:** Q6_46_seed_369181395
...
```
Node 10261 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10262 (Gather) [consumed]
    Node 10263 (Aggregate) [consumed]
      Node 10264 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10261 | 10262, 10263 |
...
|------|------|--------|-----------|-----|--------|
| 10261 | Aggregate | 790.19 | 850.05 | 7.6% | pattern |
| 10264 | Seq Scan | 769.81 | 748.53 | 2.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10264 (Seq Scan) - LEAF
...
### Step 2: Node 10261 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10262, 10263
- **Input Features:**
