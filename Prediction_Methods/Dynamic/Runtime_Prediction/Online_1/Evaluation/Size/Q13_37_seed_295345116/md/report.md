...
**Test Query:** Q13_37_seed_295345116
...
```
Node 25930 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25931 (Aggregate) [consumed]
    Node 25932 (Aggregate)
      Node 25933 (Hash Join) [PATTERN: 895c6e8c]
        Node 25934 (Seq Scan) [consumed] - LEAF
        Node 25935 (Hash) [consumed]
          Node 25936 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25930 | 25931, 25933, 25934, 25935 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25933 | 25930, 25931, 25934, 25935 |
...
|------|------|--------|-----------|-----|--------|
| 25930 | Sort | 936.44 | 1079.94 | 15.3% | pattern |
| 25932 | Aggregate | 930.58 | 999.76 | 7.4% | operator |
| 25933 | Hash Join | 718.98 | 470.31 | 34.6% | pattern |
| 25936 | Index Only Scan | 10.23 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25936 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25933 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25930, 25931, 25934, 25935
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 25930 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25931, 25933, 25934, 25935
- **Input Features:**
