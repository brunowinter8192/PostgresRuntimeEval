...
```
Node 25930 (Sort) - ROOT
  Node 25931 (Aggregate)
    Node 25932 (Aggregate)
      Node 25933 (Hash Join)
        Node 25934 (Seq Scan) - LEAF
        Node 25935 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 25930 | Sort | 936.44 | 1081.93 | 15.5% | operator |
| 25931 | Aggregate | 936.42 | 1000.33 | 6.8% | operator |
| 25932 | Aggregate | 930.58 | 1014.39 | 9.0% | operator |
| 25933 | Hash Join | 718.98 | 787.83 | 9.6% | operator |
| 25934 | Seq Scan | 507.49 | 264.19 | 47.9% | operator |
| 25935 | Hash | 15.63 | 80.15 | 412.8% | operator |
...
### Step 2: Node 25934 (Seq Scan) - LEAF
