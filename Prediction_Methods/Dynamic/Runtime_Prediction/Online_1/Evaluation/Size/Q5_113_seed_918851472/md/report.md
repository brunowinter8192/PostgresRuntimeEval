...
**Test Query:** Q5_113_seed_918851472
...
```
Node 7181 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 7182 (Aggregate) [consumed]
    Node 7183 (Gather Merge) [consumed]
      Node 7184 (Aggregate)
        Node 7185 (Sort) [PATTERN: 3e2d5a00]
          Node 7186 (Hash Join) [consumed]
            Node 7187 (Nested Loop)
              Node 7188 (Hash Join)
                Node 7189 (Seq Scan) - LEAF
                Node 7190 (Hash) [PATTERN: 444761fb]
                  Node 7191 (Hash Join) [consumed]
                    Node 7192 (Seq Scan) [consumed] - LEAF
                    Node 7193 (Hash) [consumed]
                      Node 7194 (Hash Join) [consumed]
                        Node 7195 (Seq Scan) - LEAF
                        Node 7196 (Hash)
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 7190 | 7181, 7182, 7183, 7185, 7186, 7191, 7192, 7193, 7194 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 7181 | 7182, 7183, 7185, 7186, 7190, 7191, 7192, 7193, 7194 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 7185 | 7181, 7182, 7183, 7186, 7190, 7191, 7192, 7193, 7194 |
...
|------|------|--------|-----------|-----|--------|
| 7181 | Sort | 1066.64 | 2934.42 | 175.1% | pattern |
| 7184 | Aggregate | 1061.58 | 1128.76 | 6.3% | operator |
| 7185 | Sort | 1061.34 | 1835.93 | 73.0% | pattern |
| 7187 | Nested Loop | 1049.86 | 1188.47 | 13.2% | operator |
| 7199 | Hash | 2.85 | 18.67 | 554.0% | operator |
| 7188 | Hash Join | 217.57 | 253.07 | 16.3% | operator |
| 7198 | Index Scan | 0.07 | -0.22 | 401.4% | operator |
| 7200 | Seq Scan | 2.30 | 12.36 | 437.4% | operator |
| 7189 | Seq Scan | 168.82 | 159.81 | 5.3% | operator |
| 7190 | Hash | 36.07 | 46.85 | 29.9% | pattern |
| 7195 | Seq Scan | 0.02 | 11.81 | 51240.3% | operator |
| 7196 | Hash | 0.15 | 21.05 | 14029.7% | operator |
| 7197 | Seq Scan | 0.14 | 22.93 | 15716.1% | operator |
...
### Step 2: Node 7195 (Seq Scan) - LEAF
...
### Step 4: Node 7189 (Seq Scan) - LEAF
...
### Step 5: Node 7190 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 7181, 7182, 7183, 7185, 7186, 7191, 7192, 7193, 7194
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 7198 (Index Scan) - LEAF
...
### Step 8: Node 7200 (Seq Scan) - LEAF
...
### Step 11: Node 7185 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 7181, 7182, 7183, 7186, 7190, 7191, 7192, 7193, 7194
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 7181 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 7182, 7183, 7185, 7186, 7190, 7191, 7192, 7193, 7194
- **Input Features:**
