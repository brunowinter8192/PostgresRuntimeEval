...
**Test Query:** Q1_110_seed_894239379
...
```
Node 56 (Aggregate) - ROOT
  Node 57 (Gather Merge)
    Node 58 (Sort) [PATTERN: 1d35fb97]
      Node 59 (Aggregate) [consumed]
        Node 60 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 58 | 59 |
...
|------|------|--------|-----------|-----|--------|
| 56 | Aggregate | 909.79 | 1195.72 | 31.4% | operator |
| 57 | Gather Merge | 909.75 | 1165.86 | 28.2% | operator |
| 58 | Sort | 890.11 | 1199.87 | 34.8% | pattern |
| 60 | Seq Scan | 516.49 | 682.65 | 32.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 60 (Seq Scan) - LEAF
...
### Step 2: Node 58 (Sort) - PATTERN ROOT
