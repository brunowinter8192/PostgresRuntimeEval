...
```
Node 26973 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26974 (Gather) [consumed]
    Node 26975 (Aggregate) [consumed]
      Node 26976 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26973 | 26974, 26975, 26976 |
...
|------|------|--------|-----------|-----|--------|
| 26973 | Aggregate | 809.40 | 857.13 | 5.9% | pattern |
...
### Step 4: Node 26973 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26974, 26975, 26976
- **Input Features:**
