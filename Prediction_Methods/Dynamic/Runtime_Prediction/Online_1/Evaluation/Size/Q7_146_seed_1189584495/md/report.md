...
**Test Query:** Q7_146_seed_1189584495
...
```
Node 11401 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 11402 (Gather Merge) [consumed]
    Node 11403 (Sort)
      Node 11404 (Hash Join)
        Node 11405 (Nested Loop)
          Node 11406 (Hash Join) [PATTERN: 895c6e8c]
            Node 11407 (Seq Scan) [consumed] - LEAF
            Node 11408 (Hash) [consumed]
              Node 11409 (Hash Join) [PATTERN: f4cb205a]
                Node 11410 (Seq Scan) [consumed] - LEAF
                Node 11411 (Hash) [consumed]
                  Node 11412 (Seq Scan) [consumed] - LEAF
          Node 11413 (Index Scan) - LEAF
        Node 11414 (Hash)
          Node 11415 (Hash Join) [PATTERN: f4cb205a]
            Node 11416 (Seq Scan) [consumed] - LEAF
            Node 11417 (Hash) [consumed]
              Node 11418 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 11409 | 11401, 11402, 11406, 11407, 11408, 11410, 11411, 11412, 11415, 11416, 11417, 11418 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 11415 | 11401, 11402, 11406, 11407, 11408, 11409, 11410, 11411, 11412, 11416, 11417, 11418 |
| Aggregate -> Gather Merge (Out | 2724c080 | 11401 | 11402, 11406, 11407, 11408, 11409, 11410, 11411, 11412, 11415, 11416, 11417, 11418 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 11406 | 11401, 11402, 11407, 11408, 11409, 11410, 11411, 11412, 11415, 11416, 11417, 11418 |
...
|------|------|--------|-----------|-----|--------|
| 11401 | Aggregate | 1182.95 | 1163.13 | 1.7% | pattern |
| 11403 | Sort | 1176.89 | 1109.16 | 5.8% | operator |
| 11404 | Hash Join | 1176.21 | 843.11 | 28.3% | operator |
| 11405 | Nested Loop | 1168.65 | 1215.99 | 4.1% | operator |
| 11414 | Hash | 3.68 | 27.74 | 653.9% | operator |
| 11406 | Hash Join | 212.55 | 304.89 | 43.4% | pattern |
| 11413 | Index Scan | 0.03 | 0.96 | 3006.0% | operator |
| 11415 | Hash Join | 3.62 | 429.36 | 11747.8% | pattern |
| 11409 | Hash Join | 35.23 | 429.38 | 1118.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11409 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 11401, 11402, 11406, 11407, 11408, 11410, 11411, 11412, 11415, 11416, 11417, 11418
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5000
  - HashJoin_nt1=62500
...
### Step 2: Node 11406 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 11401, 11402, 11407, 11408, 11409, 11410, 11411, 11412, 11415, 11416, 11417, 11418
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=38710
  - HashJoin_nt1=483871
...
### Step 3: Node 11413 (Index Scan) - LEAF
...
### Step 4: Node 11415 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 11401, 11402, 11406, 11407, 11408, 11409, 11410, 11411, 11412, 11416, 11417, 11418
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=800
  - HashJoin_nt1=10000
...
### Step 9: Node 11401 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 11402, 11406, 11407, 11408, 11409, 11410, 11411, 11412, 11415, 11416, 11417, 11418
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
