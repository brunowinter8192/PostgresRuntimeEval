...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5321 | 5322, 5323, 5324, 5326, 5327, 5328 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5326 | 5321, 5322, 5323, 5324, 5327, 5328 |
...
|------|------|--------|-----------|-----|--------|
| 5321 | Limit | 1205.71 | 1151.18 | 4.5% | pattern |
| 5325 | Nested Loop | 1169.39 | 1193.00 | 2.0% | operator |
| 5326 | Hash Join | 209.25 | 242.47 | 15.9% | pattern |
| 5330 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5329 | Seq Scan | 31.02 | 38.57 | 24.3% | operator |
...
- **Consumes:** Nodes 5321, 5322, 5323, 5324, 5327, 5328
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46842
  - HashJoin_nt1=234610
  ...
  - HashJoin_total_cost=37337.5000
  - Hash_Inner_np=0
  - Hash_Inner_nt=12479
...
- **Output:** st=29.75, rt=242.47

### Step 3: Node 5330 (Index Scan) - LEAF
...
- **Output:** st=121.76, rt=1193.00

### Step 5: Node 5321 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5322, 5323, 5324, 5326, 5327, 5328
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=313286
  - Aggregate_Outer_nt1=313286
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=109857.2900
  - Aggregate_Outer_total_cost=113773.3700
  - Gather_Outer_np=0
