...
**Test Query:** Q13_30_seed_237916899
...
```
Node 25881 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25882 (Aggregate) [consumed]
    Node 25883 (Aggregate)
      Node 25884 (Hash Join) [PATTERN: 895c6e8c]
        Node 25885 (Seq Scan) [consumed] - LEAF
        Node 25886 (Hash) [consumed]
          Node 25887 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25881 | 25882, 25884, 25885, 25886 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25884 | 25881, 25882, 25885, 25886 |
...
|------|------|--------|-----------|-----|--------|
| 25881 | Sort | 884.55 | 1079.94 | 22.1% | pattern |
| 25883 | Aggregate | 878.57 | 999.76 | 13.8% | operator |
| 25884 | Hash Join | 673.39 | 470.31 | 30.2% | pattern |
| 25887 | Index Only Scan | 9.94 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25887 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25884 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25881, 25882, 25885, 25886
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 25881 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25882, 25884, 25885, 25886
- **Input Features:**
