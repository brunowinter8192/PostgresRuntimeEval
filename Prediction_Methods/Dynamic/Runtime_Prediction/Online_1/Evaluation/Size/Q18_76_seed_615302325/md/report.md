...
**Test Query:** Q18_76_seed_615302325
...
```
Node 30788 (Limit) - ROOT
  Node 30789 (Sort)
    Node 30790 (Aggregate)
      Node 30791 (Gather Merge)
        Node 30792 (Incremental Sort)
          Node 30793 (Nested Loop)
            Node 30794 (Merge Join)
              Node 30795 (Sort)
                Node 30796 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30797 (Seq Scan) [consumed] - LEAF
                  Node 30798 (Hash) [consumed]
                    Node 30799 (Aggregate)
                      Node 30800 (Index Scan) - LEAF
              Node 30801 (Sort)
                Node 30802 (Seq Scan) - LEAF
            Node 30803 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30796 | 30797, 30798 |
...
|------|------|--------|-----------|-----|--------|
| 30788 | Limit | 3060.84 | 1175.21 | 61.6% | operator |
| 30789 | Sort | 2946.50 | 1127.81 | 61.7% | operator |
| 30790 | Aggregate | 2946.46 | 1073.15 | 63.6% | operator |
| 30791 | Gather Merge | 2946.44 | 1073.95 | 63.6% | operator |
| 30792 | Incremental Sort | 2926.53 | 0.00 | 100.0% | operator |
| 30793 | Nested Loop | 2926.47 | 1111.34 | 62.0% | operator |
| 30794 | Merge Join | 2926.41 | 0.00 | 100.0% | operator |
| 30803 | Index Scan | 0.02 | 0.05 | 88.1% | operator |
| 30795 | Sort | 2857.64 | 1095.58 | 61.7% | operator |
| 30801 | Sort | 66.32 | 1074.66 | 1520.4% | operator |
| 30796 | Hash Join | 2857.63 | 471.07 | 83.5% | pattern |
| 30802 | Seq Scan | 54.47 | 18.25 | 66.5% | operator |
| 30799 | Aggregate | 2632.72 | 1073.15 | 59.2% | operator |
| 30800 | Index Scan | 2126.52 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30800 (Index Scan) - LEAF
...
### Step 3: Node 30796 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30797, 30798
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30802 (Seq Scan) - LEAF
...
### Step 7: Node 30794 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30803 (Index Scan) - LEAF
...
### Step 10: Node 30792 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30791 (Gather Merge)
