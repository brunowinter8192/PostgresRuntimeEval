        ...
        Node 30792 (Incremental Sort)
          Node 30793 (Nested Loop)
            Node 30794 (Merge Join)
              Node 30795 (Sort)
                Node 30796 (Hash Join)
                  Node 30797 (Seq Scan) - LEAF
                  Node 30798 (Hash)
...
| 30795 | Sort | 2857.64 | 1099.77 | 61.5% | operator |
| 30801 | Sort | 66.32 | 1074.66 | 1520.4% | operator |
| 30796 | Hash Join | 2857.63 | 686.33 | 76.0% | operator |
| 30802 | Seq Scan | 54.47 | 18.25 | 66.5% | operator |
| 30797 | Seq Scan | 195.30 | 170.37 | 12.8% | operator |
| 30798 | Hash | 2632.75 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30797 (Seq Scan) - LEAF
...
### Step 6: Node 30802 (Seq Scan) - LEAF
...
### Step 9: Node 30794 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30803 (Index Scan) - LEAF
...
### Step 11: Node 30793 (Nested Loop)
...
### Step 12: Node 30792 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30791 (Gather Merge)
