...
**Test Query:** Q6_110_seed_894239379
...
```
Node 9945 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 9946 (Gather) [consumed]
    Node 9947 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 9945 | 9946, 9947 |
...
|------|------|--------|-----------|-----|--------|
| 9945 | Aggregate | 823.01 | 849.99 | 3.3% | pattern |
| 9948 | Seq Scan | 800.16 | 748.50 | 6.5% | operator |
...
### Step 2: Node 9945 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 9946, 9947
- **Input Features:**
