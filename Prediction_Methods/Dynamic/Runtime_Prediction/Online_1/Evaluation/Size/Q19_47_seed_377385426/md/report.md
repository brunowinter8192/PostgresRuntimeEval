...
```
Node 31857 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31858 (Gather) [consumed]
    Node 31859 (Aggregate) [consumed]
      Node 31860 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31857 | 31858, 31859, 31860 |
...
|------|------|--------|-----------|-----|--------|
| 31857 | Aggregate | 881.74 | 829.29 | 5.9% | pattern |
...
### Step 4: Node 31857 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31858, 31859, 31860
- **Input Features:**
