...
**Test Query:** Q8_52_seed_418405581
...
```
Node 15432 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 15433 (Gather Merge) [consumed]
    Node 15434 (Sort)
      Node 15435 (Hash Join)
        Node 15436 (Nested Loop)
          Node 15437 (Hash Join)
            Node 15438 (Nested Loop)
              Node 15439 (Hash Join)
                Node 15440 (Seq Scan) - LEAF
                Node 15441 (Hash) [PATTERN: 444761fb]
                  Node 15442 (Hash Join) [consumed]
                    Node 15443 (Seq Scan) [consumed] - LEAF
                    Node 15444 (Hash) [consumed]
                      Node 15445 (Hash Join) [consumed]
                        Node 15446 (Seq Scan) - LEAF
                        Node 15447 (Hash)
                          Node 15448 (Seq Scan) - LEAF
              Node 15449 (Index Scan) - LEAF
            Node 15450 (Hash)
              Node 15451 (Seq Scan) - LEAF
          Node 15452 (Index Scan) - LEAF
        Node 15453 (Hash)
          Node 15454 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 15441 | 15432, 15433, 15442, 15443, 15444, 15445 |
| Aggregate -> Gather Merge (Out | 2724c080 | 15432 | 15433, 15441, 15442, 15443, 15444, 15445 |
...
|------|------|--------|-----------|-----|--------|
| 15432 | Aggregate | 1234.51 | 1131.48 | 8.3% | pattern |
| 15434 | Sort | 1228.86 | 1046.21 | 14.9% | operator |
| 15435 | Hash Join | 1228.57 | 785.61 | 36.1% | operator |
| 15436 | Nested Loop | 1228.20 | 1198.29 | 2.4% | operator |
| 15453 | Hash | 0.02 | 13.72 | 68520.4% | operator |
| 15437 | Hash Join | 1224.37 | 785.60 | 35.8% | operator |
| 15452 | Index Scan | 0.01 | 12.42 | 206958.1% | operator |
| 15454 | Seq Scan | 0.01 | 6.51 | 43313.1% | operator |
| 15438 | Nested Loop | 1180.55 | 1198.29 | 1.5% | operator |
| 15450 | Hash | 39.18 | 19.97 | 49.0% | operator |
| 15439 | Hash Join | 214.86 | 251.67 | 17.1% | operator |
| 15449 | Index Scan | 0.04 | 2.88 | 6759.2% | operator |
| 15451 | Seq Scan | 39.05 | 48.87 | 25.2% | operator |
| 15440 | Seq Scan | 159.49 | 159.67 | 0.1% | operator |
| 15441 | Hash | 36.52 | 43.51 | 19.1% | pattern |
| 15446 | Seq Scan | 0.01 | 12.22 | 81399.6% | operator |
| 15447 | Hash | 0.20 | 18.14 | 9204.7% | operator |
| 15448 | Seq Scan | 0.19 | 23.36 | 12131.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 15448 (Seq Scan) - LEAF
...
### Step 2: Node 15446 (Seq Scan) - LEAF
...
### Step 4: Node 15440 (Seq Scan) - LEAF
...
### Step 5: Node 15441 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 15432, 15433, 15442, 15443, 15444, 15445
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 15449 (Index Scan) - LEAF
...
### Step 8: Node 15451 (Seq Scan) - LEAF
...
### Step 12: Node 15452 (Index Scan) - LEAF
...
### Step 13: Node 15454 (Seq Scan) - LEAF
...
### Step 14: Node 15436 (Nested Loop)
...
### Step 18: Node 15432 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 15433, 15441, 15442, 15443, 15444, 15445
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2449
