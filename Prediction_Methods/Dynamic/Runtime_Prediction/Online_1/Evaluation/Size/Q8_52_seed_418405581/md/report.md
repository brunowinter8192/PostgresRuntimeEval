...
```
Node 15432 (Aggregate) - ROOT
  Node 15433 (Gather Merge)
    Node 15434 (Sort)
          ...
          Node 15437 (Hash Join)
            Node 15438 (Nested Loop)
              Node 15439 (Hash Join)
                ...
                Node 15441 (Hash)
                  Node 15442 (Hash Join)
                    Node 15443 (Seq Scan) - LEAF
                    Node 15444 (Hash)
                      Node 15445 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 15432 | Aggregate | 1234.51 | 1191.81 | 3.5% | operator |
| 15433 | Gather Merge | 1234.12 | 1097.16 | 11.1% | operator |
...
| 15439 | Hash Join | 214.86 | 251.17 | 16.9% | operator |
...
| 15441 | Hash | 36.52 | 20.62 | 43.6% | operator |
| 15442 | Hash Join | 35.86 | 132.26 | 268.8% | operator |
| 15443 | Seq Scan | 34.33 | 23.03 | 32.9% | operator |
| 15444 | Hash | 0.22 | 23.66 | 10555.9% | operator |
| 15445 | Hash Join | 0.22 | 306.84 | 140007.7% | operator |
...
### Step 5: Node 15443 (Seq Scan) - LEAF
...
### Step 8: Node 15440 (Seq Scan) - LEAF
...
### Step 11: Node 15449 (Index Scan) - LEAF
...
### Step 12: Node 15451 (Seq Scan) - LEAF
...
### Step 13: Node 15438 (Nested Loop)
...
### Step 16: Node 15452 (Index Scan) - LEAF
...
### Step 17: Node 15454 (Seq Scan) - LEAF
...
### Step 18: Node 15436 (Nested Loop)
...
### Step 22: Node 15433 (Gather Merge)
...
### Step 23: Node 15432 (Aggregate) - ROOT
