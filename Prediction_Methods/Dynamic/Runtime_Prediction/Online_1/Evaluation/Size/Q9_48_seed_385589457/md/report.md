...
**Test Query:** Q9_48_seed_385589457
...
```
Node 18318 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18319 (Aggregate) [consumed]
    Node 18320 (Gather)
      Node 18321 (Aggregate)
        Node 18322 (Nested Loop)
          Node 18323 (Hash Join) [PATTERN: bb930825]
            Node 18324 (Seq Scan) [consumed] - LEAF
            Node 18325 (Hash) [consumed]
              Node 18326 (Hash Join) [consumed]
                Node 18327 (Hash Join)
                  Node 18328 (Nested Loop)
                    Node 18329 (Seq Scan) - LEAF
                    Node 18330 (Index Scan) - LEAF
                  Node 18331 (Hash)
                    Node 18332 (Seq Scan) - LEAF
                Node 18333 (Hash)
                  Node 18334 (Seq Scan) - LEAF
          Node 18335 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18323 | 18318, 18319, 18324, 18325, 18326 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18318 | 18319, 18323, 18324, 18325, 18326 |
...
|------|------|--------|-----------|-----|--------|
| 18318 | Sort | 1204.80 | 1044.79 | 13.3% | pattern |
| 18320 | Gather | 1203.59 | 964.87 | 19.8% | operator |
| 18321 | Aggregate | 1182.65 | 1117.47 | 5.5% | operator |
| 18322 | Nested Loop | 1157.64 | 1252.17 | 8.2% | operator |
| 18323 | Hash Join | 984.94 | 134.80 | 86.3% | pattern |
| 18335 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18327 | Hash Join | 156.08 | 837.55 | 436.6% | operator |
| 18333 | Hash | 13.52 | 14.95 | 10.5% | operator |
| 18328 | Nested Loop | 149.99 | 1251.76 | 734.6% | operator |
| 18331 | Hash | 3.80 | 15.94 | 319.7% | operator |
| 18334 | Seq Scan | 13.51 | 2.94 | 78.3% | operator |
| 18329 | Seq Scan | 19.75 | 44.17 | 123.6% | operator |
| 18330 | Index Scan | 0.07 | -1.39 | 2028.4% | operator |
| 18332 | Seq Scan | 3.25 | 9.45 | 190.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 18329 (Seq Scan) - LEAF
...
### Step 2: Node 18330 (Index Scan) - LEAF
...
### Step 3: Node 18332 (Seq Scan) - LEAF
...
### Step 6: Node 18334 (Seq Scan) - LEAF
...
### Step 9: Node 18323 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18318, 18319, 18324, 18325, 18326
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18335 (Index Scan) - LEAF
...
### Step 11: Node 18322 (Nested Loop)
...
### Step 14: Node 18318 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18319, 18323, 18324, 18325, 18326
- **Input Features:**
