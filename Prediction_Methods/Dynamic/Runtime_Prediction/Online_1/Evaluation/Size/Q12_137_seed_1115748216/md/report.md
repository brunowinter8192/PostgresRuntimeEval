...
**Test Query:** Q12_137_seed_1115748216
...
```
Node 24600 (Aggregate) - ROOT
  Node 24601 (Gather Merge)
    Node 24602 (Aggregate)
      Node 24603 (Sort)
        Node 24604 (Nested Loop)
          Node 24605 (Seq Scan) - LEAF
          Node 24606 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24600 | Aggregate | 1002.89 | 919.06 | 8.4% | operator |
| 24601 | Gather Merge | 1002.87 | 1111.84 | 10.9% | operator |
| 24602 | Aggregate | 983.96 | 895.31 | 9.0% | operator |
| 24603 | Sort | 983.22 | 1092.81 | 11.1% | operator |
| 24604 | Nested Loop | 982.25 | 1127.41 | 14.8% | operator |
| 24605 | Seq Scan | 838.87 | 745.19 | 11.2% | operator |
| 24606 | Index Scan | 0.03 | 0.07 | 166.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24605 (Seq Scan) - LEAF
...
### Step 2: Node 24606 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - st2=0.1246
  - startup_cost=0.4300
  - total_cost=147172.9100
- **Output:** st=38.33, rt=1127.41

### Step 4: Node 24603 (Sort)
...
- **Input Features:**
  ...
  - st1=38.3251
  - st2=0.0000
  - startup_cost=147533.7200
  - total_cost=147548.1600
- **Output:** st=1092.40, rt=1092.81

### Step 5: Node 24602 (Aggregate)
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=147533.7200
  - total_cost=147649.2900
- **Output:** st=868.96, rt=895.31

### Step 6: Node 24601 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=868.9561
  - st2=0.0000
  - startup_cost=148533.8000
  - total_cost=148653.5800
- **Output:** st=1109.22, rt=1111.84

### Step 7: Node 24600 (Aggregate) - ROOT
