...
**Test Query:** Q14_25_seed_196896744
**Timestamp:** 2025-12-21 18:14:44
...
```
Node 26889 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26890 (Gather) [consumed]
    Node 26891 (Aggregate) [consumed]
      Node 26892 (Hash Join)
        Node 26893 (Seq Scan) - LEAF
        Node 26894 (Hash)
          Node 26895 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26889 | 26890, 26891 |
...
|------|------|--------|-----------|-----|--------|
| 26889 | Aggregate | 867.92 | 848.36 | 2.3% | pattern |
| 26892 | Hash Join | 846.14 | 807.63 | 4.6% | operator |
| 26893 | Seq Scan | 795.99 | 758.48 | 4.7% | operator |
| 26894 | Hash | 41.59 | 9.38 | 77.5% | operator |
| 26895 | Seq Scan | 34.83 | 12.70 | 63.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26895 (Seq Scan) - LEAF
...
### Step 2: Node 26893 (Seq Scan) - LEAF
...
### Step 5: Node 26889 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26890, 26891
- **Input Features:**
