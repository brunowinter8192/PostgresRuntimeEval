...
```
Node 26889 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26890 (Gather) [consumed]
    Node 26891 (Aggregate) [consumed]
      Node 26892 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26889 | 26890, 26891, 26892 |
...
|------|------|--------|-----------|-----|--------|
| 26889 | Aggregate | 867.92 | 857.13 | 1.2% | pattern |
...
### Step 4: Node 26889 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26890, 26891, 26892
- **Input Features:**
