    ...
    Node 19398 (Aggregate) [consumed]
      Node 19399 (Gather) [consumed]
        Node 19400 (Hash Join)
          Node 19401 (Hash Join)
            Node 19402 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19396 | 19397, 19398, 19399 |
...
| 19400 | Hash Join | 1079.60 | 1007.24 | 6.7% | operator |
| 19401 | Hash Join | 1076.56 | 1004.16 | 6.7% | operator |
| 19407 | Hash | 0.02 | 15.71 | 92316.3% | operator |
| 19402 | Nested Loop | 1031.17 | 1204.80 | 16.8% | operator |
| 19405 | Hash | 34.95 | 55.57 | 59.0% | operator |
...
### Step 6: Node 19408 (Seq Scan) - LEAF
...
### Step 10: Node 19396 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19397, 19398, 19399
- **Input Features:**
