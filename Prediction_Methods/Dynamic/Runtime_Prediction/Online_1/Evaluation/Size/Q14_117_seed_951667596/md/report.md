...
```
Node 26546 (Aggregate) [PATTERN: efde8b38] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26546 | 26547, 26548, 26549 |
...
|------|------|--------|-----------|-----|--------|
| 26546 | Aggregate | 799.83 | 857.14 | 7.2% | pattern |
| 26550 | Seq Scan | 727.63 | 758.50 | 4.2% | operator |
| 26551 | Hash | 42.76 | 9.38 | 78.1% | operator |
| 26552 | Seq Scan | 38.34 | 12.70 | 66.9% | operator |
...
### Step 4: Node 26546 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26547, 26548, 26549
- **Input Features:**
