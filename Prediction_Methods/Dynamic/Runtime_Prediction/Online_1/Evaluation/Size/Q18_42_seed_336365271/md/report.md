...
**Test Query:** Q18_42_seed_336365271
...
```
Node 30196 (Limit) - ROOT
  Node 30197 (Sort)
    Node 30198 (Aggregate)
      Node 30199 (Gather Merge)
        Node 30200 (Incremental Sort)
          Node 30201 (Nested Loop)
            Node 30202 (Merge Join)
              Node 30203 (Sort)
                Node 30204 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30205 (Seq Scan) [consumed] - LEAF
                  Node 30206 (Hash) [consumed]
                    Node 30207 (Aggregate)
                      Node 30208 (Index Scan) - LEAF
              Node 30209 (Sort)
                Node 30210 (Seq Scan) - LEAF
            Node 30211 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30204 | 30205, 30206 |
...
|------|------|--------|-----------|-----|--------|
| 30196 | Limit | 3025.94 | 1175.21 | 61.2% | operator |
| 30197 | Sort | 2908.99 | 1127.81 | 61.2% | operator |
| 30198 | Aggregate | 2908.94 | 1073.15 | 63.1% | operator |
| 30199 | Gather Merge | 2908.93 | 1073.95 | 63.1% | operator |
| 30200 | Incremental Sort | 2889.00 | 0.00 | 100.0% | operator |
| 30201 | Nested Loop | 2888.94 | 1111.34 | 61.5% | operator |
| 30202 | Merge Join | 2888.88 | 0.00 | 100.0% | operator |
| 30211 | Index Scan | 0.02 | 0.05 | 96.2% | operator |
| 30203 | Sort | 2819.95 | 1095.58 | 61.1% | operator |
| 30209 | Sort | 66.05 | 1074.66 | 1527.1% | operator |
| 30204 | Hash Join | 2819.94 | 471.07 | 83.3% | pattern |
| 30210 | Seq Scan | 54.26 | 18.25 | 66.4% | operator |
| 30207 | Aggregate | 2599.29 | 1073.15 | 58.7% | operator |
| 30208 | Index Scan | 2103.20 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30208 (Index Scan) - LEAF
...
### Step 3: Node 30204 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30205, 30206
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30210 (Seq Scan) - LEAF
...
### Step 7: Node 30202 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30211 (Index Scan) - LEAF
...
### Step 10: Node 30200 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30199 (Gather Merge)
