...
**Test Query:** Q19_113_seed_918851472
...
```
Node 31318 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31319 (Gather) [consumed]
    Node 31320 (Aggregate) [consumed]
      Node 31321 (Hash Join) [consumed]
        Node 31322 (Seq Scan) - LEAF
        Node 31323 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31318 | 31319, 31320, 31321 |
...
|------|------|--------|-----------|-----|--------|
| 31318 | Aggregate | 861.03 | 829.28 | 3.7% | pattern |
| 31322 | Seq Scan | 793.63 | 743.46 | 6.3% | operator |
| 31323 | Hash | 46.81 | 8.29 | 82.3% | operator |
| 31324 | Seq Scan | 46.69 | 23.76 | 49.1% | operator |
...
### Step 2: Node 31322 (Seq Scan) - LEAF
...
### Step 4: Node 31318 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31319, 31320, 31321
- **Input Features:**
