...
```
Node 10555 (Aggregate) - ROOT
  Node 10556 (Gather Merge)
    Node 10557 (Sort)
      Node 10558 (Hash Join)
        Node 10559 (Nested Loop)
          Node 10560 (Hash Join)
            Node 10561 (Seq Scan) - LEAF
            Node 10562 (Hash)
              Node 10563 (Hash Join)
                Node 10564 (Seq Scan) - LEAF
                Node 10565 (Hash)
                  Node 10566 (Seq Scan) - LEAF
          Node 10567 (Index Scan) - LEAF
        Node 10568 (Hash)
          Node 10569 (Hash Join)
            Node 10570 (Seq Scan) - LEAF
            Node 10571 (Hash)
              Node 10572 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 10555 | Aggregate | 1193.56 | 1209.26 | 1.3% | operator |
| 10556 | Gather Merge | 1192.43 | 1142.98 | 4.1% | operator |
| 10557 | Sort | 1185.89 | 1109.13 | 6.5% | operator |
| 10558 | Hash Join | 1185.25 | 842.59 | 28.9% | operator |
| 10559 | Nested Loop | 1175.89 | 1216.16 | 3.4% | operator |
| 10568 | Hash | 5.62 | 17.53 | 211.8% | operator |
| 10560 | Hash Join | 213.63 | 384.47 | 80.0% | operator |
| 10567 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 10569 | Hash Join | 5.58 | 85.17 | 1427.0% | operator |
| 10561 | Seq Scan | 152.71 | 201.16 | 31.7% | operator |
| 10562 | Hash | 35.67 | 19.59 | 45.1% | operator |
| 10570 | Seq Scan | 5.26 | 11.47 | 118.2% | operator |
| 10571 | Hash | 0.01 | 16.89 | 120572.0% | operator |
| 10563 | Hash Join | 33.16 | 92.20 | 178.1% | operator |
| 10572 | Seq Scan | 0.01 | 45.79 | 457823.2% | operator |
| 10564 | Seq Scan | 32.06 | 21.86 | 31.8% | operator |
| 10565 | Hash | 0.01 | 16.89 | 153482.6% | operator |
| 10566 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10566 (Seq Scan) - LEAF
...
### Step 2: Node 10564 (Seq Scan) - LEAF
...
### Step 5: Node 10572 (Seq Scan) - LEAF
...
### Step 6: Node 10561 (Seq Scan) - LEAF
...
### Step 8: Node 10570 (Seq Scan) - LEAF
...
### Step 11: Node 10567 (Index Scan) - LEAF
...
### Step 13: Node 10559 (Nested Loop)
...
### Step 17: Node 10556 (Gather Merge)
...
### Step 18: Node 10555 (Aggregate) - ROOT
