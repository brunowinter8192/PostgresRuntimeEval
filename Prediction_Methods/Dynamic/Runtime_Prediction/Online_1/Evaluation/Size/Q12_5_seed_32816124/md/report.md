...
**Test Query:** Q12_5_seed_32816124
...
```
Node 25055 (Aggregate) - ROOT
  Node 25056 (Gather Merge)
    Node 25057 (Aggregate)
      Node 25058 (Sort)
        Node 25059 (Nested Loop)
          Node 25060 (Seq Scan) - LEAF
          Node 25061 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 25055 | Aggregate | 1005.86 | 919.06 | 8.6% | operator |
| 25056 | Gather Merge | 1005.84 | 1111.84 | 10.5% | operator |
| 25057 | Aggregate | 985.97 | 895.31 | 9.2% | operator |
| 25058 | Sort | 985.35 | 1092.81 | 10.9% | operator |
| 25059 | Nested Loop | 984.37 | 1127.41 | 14.5% | operator |
| 25060 | Seq Scan | 847.04 | 745.19 | 12.0% | operator |
| 25061 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25060 (Seq Scan) - LEAF
...
### Step 2: Node 25061 (Index Scan) - LEAF
...
### Step 6: Node 25056 (Gather Merge)
...
### Step 7: Node 25055 (Aggregate) - ROOT
