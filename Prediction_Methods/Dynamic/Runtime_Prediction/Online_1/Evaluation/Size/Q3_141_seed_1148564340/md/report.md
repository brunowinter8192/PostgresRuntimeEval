...
**Test Query:** Q3_141_seed_1148564340
...
```
Node 4801 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 4802 (Sort) [consumed]
    Node 4803 (Aggregate) [consumed]
      Node 4804 (Gather) [consumed]
        Node 4805 (Nested Loop)
          Node 4806 (Hash Join) [PATTERN: 895c6e8c]
            Node 4807 (Seq Scan) [consumed] - LEAF
            Node 4808 (Hash) [consumed]
              Node 4809 (Seq Scan) - LEAF
          Node 4810 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4801 | 4802, 4803, 4804, 4806, 4807, 4808 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4806 | 4801, 4802, 4803, 4804, 4807, 4808 |
...
|------|------|--------|-----------|-----|--------|
| 4801 | Limit | 1221.45 | 1151.18 | 5.8% | pattern |
| 4805 | Nested Loop | 1184.30 | 1192.74 | 0.7% | operator |
| 4806 | Hash Join | 217.08 | 242.41 | 11.7% | pattern |
| 4810 | Index Scan | 0.03 | -0.52 | 2018.8% | operator |
| 4809 | Seq Scan | 34.23 | 38.60 | 12.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4809 (Seq Scan) - LEAF
...
### Step 2: Node 4806 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4801, 4802, 4803, 4804, 4807, 4808
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46440
  - HashJoin_nt1=234136
  ...
  - HashJoin_total_cost=37335.2300
  - Hash_Inner_np=0
  - Hash_Inner_nt=12397
...
- **Output:** st=29.76, rt=242.41

### Step 3: Node 4810 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=72540.8900
- **Output:** st=121.52, rt=1192.74

### Step 5: Node 4801 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4802, 4803, 4804, 4806, 4807, 4808
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=311219
  - Aggregate_Outer_nt1=311219
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=109331.0700
  - Aggregate_Outer_total_cost=113221.3100
  - Gather_Outer_np=0
  - Gather_Outer_nt=311219
  - Gather_Outer_nt1=100393
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=104662.7900
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=311219
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=119946.6400
  - Limit_total_cost=119946.6700
  - Sort_Outer_np=0
  - Sort_Outer_nt=311219
  - Sort_Outer_nt1=311219
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=119946.6400
  - Sort_Outer_total_cost=120724.6900
