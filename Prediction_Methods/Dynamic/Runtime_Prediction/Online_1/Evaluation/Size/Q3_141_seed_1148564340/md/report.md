...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4801 | 4802, 4803, 4804 |
...
| 4805 | Nested Loop | 1184.30 | 1192.66 | 0.7% | operator |
| 4806 | Hash Join | 217.08 | 230.55 | 6.2% | operator |
| 4810 | Index Scan | 0.03 | -0.52 | 2018.8% | operator |
| 4807 | Seq Scan | 159.49 | 163.32 | 2.4% | operator |
| 4808 | Hash | 34.85 | 17.75 | 49.1% | operator |
...
### Step 2: Node 4807 (Seq Scan) - LEAF
...
- **Output:** st=0.29, rt=163.32

### Step 3: Node 4808 (Hash)
...
- **Input Features:**
  ...
  - total_cost=37335.2300
- **Output:** st=27.19, rt=230.55

### Step 5: Node 4810 (Index Scan) - LEAF
...
- **Output:** st=121.37, rt=1192.66

### Step 7: Node 4801 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4802, 4803, 4804
- **Input Features:**
