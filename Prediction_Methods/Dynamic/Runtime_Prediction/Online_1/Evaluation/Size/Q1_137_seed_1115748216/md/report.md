...
**Test Query:** Q1_137_seed_1115748216
...
```
Node 201 (Aggregate) - ROOT
  Node 202 (Gather Merge)
    Node 203 (Sort) [PATTERN: 1d35fb97]
      Node 204 (Aggregate) [consumed]
        Node 205 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 203 | 204 |
...
|------|------|--------|-----------|-----|--------|
| 201 | Aggregate | 947.37 | 1195.92 | 26.2% | operator |
| 202 | Gather Merge | 947.32 | 1165.91 | 23.1% | operator |
| 203 | Sort | 929.88 | 1200.61 | 29.1% | pattern |
| 205 | Seq Scan | 515.86 | 679.85 | 31.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 205 (Seq Scan) - LEAF
...
### Step 2: Node 203 (Sort) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Aggregate_Outer_nt1=1183822
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=236
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=169036.8100
  - Aggregate_Outer_total_cost=169036.9400
  - Sort_np=0
  - Sort_nt=6
  - Sort_nt1=6
  - Sort_nt2=0
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=169037.0200
  - Sort_total_cost=169037.0400
- **Output:** st=1196.52, rt=1200.61

### Step 3: Node 202 (Gather Merge)
...
### Step 4: Node 201 (Aggregate) - ROOT
