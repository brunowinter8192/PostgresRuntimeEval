    ...
    Node 16816 (Gather)
      Node 16817 (Aggregate)
        Node 16818 (Nested Loop)
          Node 16819 (Hash Join) [PATTERN: bb930825]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 16819 | 16814, 16815, 16820, 16821, 16822 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 16814 | 16815, 16819, 16820, 16821, 16822 |
...
|------|------|--------|-----------|-----|--------|
| 16814 | Sort | 1253.92 | 1047.04 | 16.5% | pattern |
...
| 16819 | Hash Join | 1039.55 | 134.80 | 87.0% | pattern |
...
### Step 9: Node 16819 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 16814, 16815, 16820, 16821, 16822
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 11: Node 16818 (Nested Loop)
...
### Step 14: Node 16814 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 16815, 16819, 16820, 16821, 16822
- **Input Features:**
