...
**Test Query:** Q19_34_seed_270733023
**Timestamp:** 2026-01-18 20:34:36
...
```
Node 31759 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31760 (Gather) [consumed]
    Node 31761 (Aggregate) [consumed]
      Node 31762 (Hash Join) [consumed]
        Node 31763 (Seq Scan) - LEAF
        Node 31764 (Hash)
          Node 31765 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31759 | 31760, 31761, 31762 |
...
|------|------|--------|-----------|-----|--------|
| 31759 | Aggregate | 837.47 | 829.34 | 1.0% | pattern |
| 31763 | Seq Scan | 763.08 | 743.46 | 2.6% | operator |
| 31764 | Hash | 50.76 | 8.29 | 83.7% | operator |
| 31765 | Seq Scan | 50.64 | 23.76 | 53.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31765 (Seq Scan) - LEAF
...
### Step 2: Node 31763 (Seq Scan) - LEAF
...
### Step 4: Node 31759 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31760, 31761, 31762
- **Input Features:**
  ...
  - Aggregate_Outer_startup_cost=156338.8700
  - Aggregate_Outer_total_cost=156338.8800
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=157339.4100
  - Aggregate_total_cost=157339.4200
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=157338.8700
  - Gather_Outer_total_cost=157339.3800
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=23
  - HashJoin_Outer_nt1=22539
  - HashJoin_Outer_nt2=206
  - HashJoin_Outer_parallel_workers=0
  - HashJoin_Outer_plan_width=12
  - HashJoin_Outer_reltuples=0.0000
  - HashJoin_Outer_sel=0.0000
  - HashJoin_Outer_startup_cost=7672.2400
  - HashJoin_Outer_total_cost=156338.7000
- **Output:** st=824.29, rt=829.34
