...
```
Node 12841 (Aggregate) - ROOT
  Node 12842 (Gather Merge)
    Node 12843 (Sort)
      Node 12844 (Hash Join)
        Node 12845 (Nested Loop)
          Node 12846 (Hash Join)
            Node 12847 (Seq Scan) - LEAF
            Node 12848 (Hash)
              Node 12849 (Hash Join)
                Node 12850 (Seq Scan) - LEAF
                Node 12851 (Hash)
                  Node 12852 (Seq Scan) - LEAF
          Node 12853 (Index Scan) - LEAF
        Node 12854 (Hash)
          Node 12855 (Hash Join)
            Node 12856 (Seq Scan) - LEAF
            Node 12857 (Hash)
              Node 12858 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12841 | Aggregate | 1183.33 | 1209.26 | 2.2% | operator |
| 12842 | Gather Merge | 1182.25 | 1142.98 | 3.3% | operator |
| 12843 | Sort | 1176.77 | 1109.13 | 5.7% | operator |
| 12844 | Hash Join | 1176.17 | 842.59 | 28.4% | operator |
| 12845 | Nested Loop | 1169.59 | 1216.16 | 4.0% | operator |
| 12854 | Hash | 2.90 | 17.53 | 505.1% | operator |
| 12846 | Hash Join | 210.54 | 384.47 | 82.6% | operator |
| 12853 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 12855 | Hash Join | 2.85 | 85.17 | 2889.6% | operator |
| 12847 | Seq Scan | 150.92 | 201.16 | 33.3% | operator |
| 12848 | Hash | 30.82 | 19.59 | 36.4% | operator |
| 12856 | Seq Scan | 2.49 | 11.47 | 360.5% | operator |
| 12857 | Hash | 0.01 | 16.89 | 112527.2% | operator |
| 12849 | Hash Join | 30.01 | 92.20 | 207.2% | operator |
| 12858 | Seq Scan | 0.01 | 45.79 | 381502.6% | operator |
| 12850 | Seq Scan | 28.91 | 21.86 | 24.4% | operator |
| 12851 | Hash | 0.01 | 16.89 | 140684.0% | operator |
| 12852 | Seq Scan | 0.01 | 45.79 | 508703.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12852 (Seq Scan) - LEAF
...
### Step 2: Node 12850 (Seq Scan) - LEAF
...
### Step 5: Node 12858 (Seq Scan) - LEAF
...
### Step 6: Node 12847 (Seq Scan) - LEAF
...
### Step 8: Node 12856 (Seq Scan) - LEAF
...
### Step 11: Node 12853 (Index Scan) - LEAF
...
### Step 13: Node 12845 (Nested Loop)
...
### Step 17: Node 12842 (Gather Merge)
...
### Step 18: Node 12841 (Aggregate) - ROOT
