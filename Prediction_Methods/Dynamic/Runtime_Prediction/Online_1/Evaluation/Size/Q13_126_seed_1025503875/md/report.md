...
**Test Query:** Q13_126_seed_1025503875
...
```
Node 25566 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25567 (Aggregate) [consumed]
    Node 25568 (Aggregate)
      Node 25569 (Hash Join) [PATTERN: 895c6e8c]
        Node 25570 (Seq Scan) [consumed] - LEAF
        Node 25571 (Hash) [consumed]
          Node 25572 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25566 | 25567, 25569, 25570, 25571 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25569 | 25566, 25567, 25570, 25571 |
...
|------|------|--------|-----------|-----|--------|
| 25566 | Sort | 911.23 | 1079.92 | 18.5% | pattern |
| 25568 | Aggregate | 905.04 | 998.94 | 10.4% | operator |
| 25569 | Hash Join | 687.96 | 470.31 | 31.6% | pattern |
| 25572 | Index Only Scan | 10.12 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25572 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25569 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25566, 25567, 25570, 25571
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1475952
...
### Step 4: Node 25566 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25567, 25569, 25570, 25571
- **Input Features:**
