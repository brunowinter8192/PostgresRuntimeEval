...
**Test Query:** Q4_122_seed_992687751
**Timestamp:** 2026-01-18 16:29:25
...
```
Node 6019 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6020 (Gather Merge) [consumed]
    Node 6021 (Sort) [consumed]
      Node 6022 (Aggregate) [consumed]
        Node 6023 (Nested Loop)
          Node 6024 (Seq Scan) - LEAF
          Node 6025 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6019 | 6020, 6021, 6022 |
...
|------|------|--------|-----------|-----|--------|
| 6019 | Aggregate | 1096.11 | 952.19 | 13.1% | pattern |
| 6023 | Nested Loop | 1089.56 | 1255.45 | 15.2% | operator |
| 6024 | Seq Scan | 167.30 | 154.66 | 7.6% | operator |
| 6025 | Index Scan | 0.06 | 11.10 | 17250.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6024 (Seq Scan) - LEAF
...
### Step 2: Node 6025 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - Aggregate_Outer_total_cost=66518.2700
  - Aggregate_np=0
  - Aggregate_nt=5
  - Aggregate_nt1=15
  - Aggregate_nt2=0
  ...
  - Aggregate_total_cost=67520.2700
  ...
  - GatherMerge_Outer_total_cost=67520.1500
  - Sort_Outer_np=0
  - Sort_Outer_nt=5
  - Sort_Outer_nt1=5
  - Sort_Outer_nt2=0
  ...
  - Sort_Outer_startup_cost=66518.3300
  - Sort_Outer_total_cost=66518.3400
