...
```
Node 31976 (Aggregate) [PATTERN: efde8b38] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31976 | 31977, 31978, 31979 |
...
|------|------|--------|-----------|-----|--------|
| 31976 | Aggregate | 844.40 | 829.28 | 1.8% | pattern |
| 31980 | Seq Scan | 774.82 | 743.46 | 4.0% | operator |
| 31981 | Hash | 48.43 | 8.29 | 82.9% | operator |
| 31982 | Seq Scan | 48.34 | 23.76 | 50.8% | operator |
...
### Step 4: Node 31976 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31977, 31978, 31979
- **Input Features:**
