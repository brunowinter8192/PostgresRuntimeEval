...
**Test Query:** Q13_78_seed_631710387
...
```
Node 26245 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26246 (Aggregate) [consumed]
    Node 26247 (Aggregate)
      Node 26248 (Hash Join) [PATTERN: 895c6e8c]
        Node 26249 (Seq Scan) [consumed] - LEAF
        Node 26250 (Hash) [consumed]
          Node 26251 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26245 | 26246, 26248, 26249, 26250 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26248 | 26245, 26246, 26249, 26250 |
...
|------|------|--------|-----------|-----|--------|
| 26245 | Sort | 918.02 | 1079.94 | 17.6% | pattern |
| 26247 | Aggregate | 911.95 | 999.76 | 9.6% | operator |
| 26248 | Hash Join | 692.80 | 470.31 | 32.1% | pattern |
| 26251 | Index Only Scan | 9.96 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26251 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26248 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26245, 26246, 26249, 26250
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 26245 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26246, 26248, 26249, 26250
- **Input Features:**
