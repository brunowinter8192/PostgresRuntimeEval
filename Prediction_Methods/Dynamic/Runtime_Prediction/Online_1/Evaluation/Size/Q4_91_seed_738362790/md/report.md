...
**Test Query:** Q4_91_seed_738362790
...
```
Node 6831 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6832 (Gather Merge) [consumed]
    Node 6833 (Sort) [consumed]
      Node 6834 (Aggregate) [consumed]
        Node 6835 (Nested Loop)
          Node 6836 (Seq Scan) - LEAF
          Node 6837 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6831 | 6832, 6833, 6834 |
...
|------|------|--------|-----------|-----|--------|
| 6831 | Aggregate | 1052.94 | 952.19 | 9.6% | pattern |
| 6835 | Nested Loop | 1046.64 | 1255.45 | 20.0% | operator |
| 6836 | Seq Scan | 162.24 | 154.67 | 4.7% | operator |
| 6837 | Index Scan | 0.06 | 11.10 | 17526.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6836 (Seq Scan) - LEAF
...
### Step 2: Node 6837 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - Aggregate_startup_cost=66679.0300
  - Aggregate_total_cost=66680.9300
  ...
  - GatherMerge_Outer_startup_cost=66679.0300
  - GatherMerge_Outer_total_cost=66680.8100
  - Sort_Outer_np=0
  - Sort_Outer_nt=5
  - Sort_Outer_nt1=5
  - Sort_Outer_nt2=0
  ...
  - Sort_Outer_startup_cost=65678.9900
  - Sort_Outer_total_cost=65679.0100
