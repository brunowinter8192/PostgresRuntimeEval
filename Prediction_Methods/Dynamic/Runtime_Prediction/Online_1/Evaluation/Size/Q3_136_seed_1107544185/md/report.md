...
**Test Query:** Q3_136_seed_1107544185
...
```
Node 4741 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 4742 (Sort) [consumed]
    Node 4743 (Aggregate) [consumed]
      Node 4744 (Gather) [consumed]
        Node 4745 (Nested Loop)
          Node 4746 (Hash Join) [PATTERN: 895c6e8c]
            Node 4747 (Seq Scan) [consumed] - LEAF
            Node 4748 (Hash) [consumed]
              Node 4749 (Seq Scan) - LEAF
          Node 4750 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4741 | 4742, 4743, 4744, 4746, 4747, 4748 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4746 | 4741, 4742, 4743, 4744, 4747, 4748 |
...
|------|------|--------|-----------|-----|--------|
| 4741 | Limit | 1200.09 | 1151.18 | 4.1% | pattern |
| 4745 | Nested Loop | 1164.71 | 1193.24 | 2.4% | operator |
| 4746 | Hash Join | 209.85 | 242.51 | 15.6% | pattern |
| 4750 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4749 | Seq Scan | 29.36 | 38.57 | 31.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4749 (Seq Scan) - LEAF
...
### Step 2: Node 4746 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4741, 4742, 4743, 4744, 4747, 4748
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47206
  - HashJoin_nt1=236285
  ...
  - HashJoin_total_cost=37341.9900
  - Hash_Inner_np=0
  - Hash_Inner_nt=12487
...
### Step 3: Node 4750 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=73044.3900
- **Output:** st=121.99, rt=1193.24

### Step 5: Node 4741 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4742, 4743, 4744, 4746, 4747, 4748
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=313623
  - Aggregate_Outer_nt1=313623
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110111.0300
  - Aggregate_Outer_total_cost=114031.3200
  - Gather_Outer_np=0
  - Gather_Outer_nt=313623
  - Gather_Outer_nt1=101169
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105406.6900
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=313623
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=120808.6000
  - Limit_total_cost=120808.6300
  - Sort_Outer_np=0
  - Sort_Outer_nt=313623
  - Sort_Outer_nt1=313623
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=120808.6000
  - Sort_Outer_total_cost=121592.6600
