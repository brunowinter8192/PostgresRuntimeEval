...
```
Node 9321 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 9322 (Aggregate) [consumed]
    Node 9323 (Gather Merge) [consumed]
      Node 9324 (Aggregate)
        Node 9325 (Sort) [PATTERN: 3e2d5a00]
          Node 9326 (Hash Join) [consumed]
            Node 9327 (Nested Loop)
              Node 9328 (Hash Join)
                Node 9329 (Seq Scan) - LEAF
                Node 9330 (Hash) [PATTERN: 444761fb]
                  Node 9331 (Hash Join) [consumed]
                    Node 9332 (Seq Scan) [consumed] - LEAF
                    Node 9333 (Hash) [consumed]
                      Node 9334 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 9330 | 9321, 9322, 9323, 9325, 9326, 9331, 9332, 9333, 9334 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 9321 | 9322, 9323, 9325, 9326, 9330, 9331, 9332, 9333, 9334 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 9325 | 9321, 9322, 9323, 9326, 9330, 9331, 9332, 9333, 9334 |
...
|------|------|--------|-----------|-----|--------|
| 9321 | Sort | 1069.43 | 2934.42 | 174.4% | pattern |
| 9324 | Aggregate | 1063.14 | 1128.74 | 6.2% | operator |
| 9325 | Sort | 1062.90 | 1835.96 | 72.7% | pattern |
| 9327 | Nested Loop | 1051.33 | 1188.57 | 13.1% | operator |
| 9339 | Hash | 2.92 | 18.67 | 540.5% | operator |
| 9328 | Hash Join | 216.70 | 253.07 | 16.8% | operator |
| 9338 | Index Scan | 0.07 | -0.22 | 405.6% | operator |
| 9340 | Seq Scan | 2.32 | 12.36 | 432.7% | operator |
| 9329 | Seq Scan | 167.27 | 159.81 | 4.5% | operator |
| 9330 | Hash | 36.59 | 46.85 | 28.1% | pattern |
| 9335 | Seq Scan | 0.01 | 11.81 | 78621.8% | operator |
| 9336 | Hash | 0.16 | 21.05 | 13224.8% | operator |
| 9337 | Seq Scan | 0.15 | 22.93 | 15500.9% | operator |
...
### Step 4: Node 9329 (Seq Scan) - LEAF
...
### Step 5: Node 9330 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 9321, 9322, 9323, 9325, 9326, 9331, 9332, 9333, 9334
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 9338 (Index Scan) - LEAF
...
### Step 8: Node 9340 (Seq Scan) - LEAF
...
### Step 11: Node 9325 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 9321, 9322, 9323, 9326, 9330, 9331, 9332, 9333, 9334
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 9321 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 9322, 9323, 9325, 9326, 9330, 9331, 9332, 9333, 9334
- **Input Features:**
