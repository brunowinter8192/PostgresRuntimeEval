...
**Test Query:** Q1_55_seed_443017674
...
```
Node 501 (Aggregate) - ROOT
  Node 502 (Gather Merge)
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 503 | 504 |
...
|------|------|--------|-----------|-----|--------|
| 501 | Aggregate | 932.71 | 1195.74 | 28.2% | operator |
| 502 | Gather Merge | 932.67 | 1165.86 | 25.0% | operator |
| 503 | Sort | 916.39 | 1199.94 | 30.9% | pattern |
| 505 | Seq Scan | 509.21 | 682.38 | 34.0% | operator |
...
- **Input Features:**
  ...
  - Aggregate_Outer_total_cost=168585.2000
  - Sort_np=0
  - Sort_nt=6
  - Sort_nt1=6
  - Sort_nt2=0
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=168585.2800
  - Sort_total_cost=168585.2900
- **Output:** st=1195.85, rt=1199.94

### Step 3: Node 502 (Gather Merge)
...
### Step 4: Node 501 (Aggregate) - ROOT
