    ...
    Node 17323 (Gather)
      Node 17324 (Aggregate)
        Node 17325 (Nested Loop)
          Node 17326 (Hash Join) [PATTERN: bb930825]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17326 | 17321, 17322, 17327, 17328, 17329 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17321 | 17322, 17326, 17327, 17328, 17329 |
...
|------|------|--------|-----------|-----|--------|
| 17321 | Sort | 1196.26 | 1044.54 | 12.7% | pattern |
| 17323 | Gather | 1195.03 | 965.01 | 19.2% | operator |
| 17324 | Aggregate | 1173.50 | 1129.15 | 3.8% | operator |
| 17325 | Nested Loop | 1149.18 | 1252.17 | 9.0% | operator |
| 17326 | Hash Join | 975.18 | 134.80 | 86.2% | pattern |
| 17338 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17330 | Hash Join | 161.31 | 837.52 | 419.2% | operator |
| 17336 | Hash | 14.32 | 14.95 | 4.4% | operator |
| 17331 | Nested Loop | 156.72 | 1251.76 | 698.7% | operator |
| 17334 | Hash | 2.29 | 15.94 | 594.9% | operator |
| 17337 | Seq Scan | 14.31 | 2.94 | 79.5% | operator |
| 17332 | Seq Scan | 22.08 | 44.23 | 100.3% | operator |
| 17333 | Index Scan | 0.07 | -1.39 | 1976.3% | operator |
| 17335 | Seq Scan | 1.77 | 9.45 | 434.2% | operator |
...
### Step 9: Node 17326 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17321, 17322, 17327, 17328, 17329
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=17368
  - HashJoin_Outer_nt1=17368
  ...
  - HashJoin_Outer_total_cost=14640.8600
  - HashJoin_np=0
  - HashJoin_nt=62539
  ...
  - HashJoin_sel=0.0000
  - HashJoin_startup_cost=14901.3800
  - HashJoin_total_cost=148505.7300
  - Hash_Inner_np=0
  - Hash_Inner_nt=17368
  - Hash_Inner_nt1=17368
  - Hash_Inner_nt2=0
  - Hash_Inner_parallel_workers=0
  - Hash_Inner_plan_width=126
  - Hash_Inner_reltuples=0.0000
  - Hash_Inner_sel=1.0000
  - Hash_Inner_startup_cost=14640.8600
  - Hash_Inner_total_cost=14640.8600
...
### Step 10: Node 17338 (Index Scan) - LEAF
...
### Step 11: Node 17325 (Nested Loop)
...
- **Output:** st=1118.78, rt=1129.15

### Step 13: Node 17323 (Gather)
...
- **Output:** st=470.86, rt=965.01

### Step 14: Node 17321 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17322, 17326, 17327, 17328, 17329
- **Input Features:**
