    ...
    Node 20009 (Aggregate) [consumed]
      Node 20010 (Gather) [consumed]
        Node 20011 (Hash Join)
          Node 20012 (Hash Join)
            Node 20013 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20007 | 20008, 20009, 20010 |
...
| 20011 | Hash Join | 1111.21 | 1007.13 | 9.4% | operator |
| 20012 | Hash Join | 1107.59 | 1003.98 | 9.4% | operator |
| 20018 | Hash | 0.01 | 15.71 | 120752.1% | operator |
| 20013 | Nested Loop | 1059.43 | 1204.86 | 13.7% | operator |
| 20016 | Hash | 36.97 | 55.57 | 50.3% | operator |
...
### Step 6: Node 20019 (Seq Scan) - LEAF
...
### Step 10: Node 20007 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20008, 20009, 20010
- **Input Features:**
