...
```
Node 13385 (Aggregate) - ROOT
  Node 13386 (Gather Merge)
    Node 13387 (Sort)
          ...
          Node 13390 (Hash Join)
            Node 13391 (Nested Loop)
              Node 13392 (Hash Join)
                ...
                Node 13394 (Hash)
                  Node 13395 (Hash Join)
                    Node 13396 (Seq Scan) - LEAF
                    Node 13397 (Hash)
                      Node 13398 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 13385 | Aggregate | 1239.03 | 1193.68 | 3.7% | operator |
| 13386 | Gather Merge | 1238.64 | 1097.19 | 11.4% | operator |
...
| 13392 | Hash Join | 219.29 | 251.17 | 14.5% | operator |
...
| 13394 | Hash | 39.40 | 20.62 | 47.7% | operator |
| 13395 | Hash Join | 38.42 | 132.26 | 244.3% | operator |
| 13396 | Seq Scan | 36.70 | 23.03 | 37.2% | operator |
| 13397 | Hash | 0.40 | 23.66 | 5755.5% | operator |
| 13398 | Hash Join | 0.40 | 306.84 | 76227.4% | operator |
...
### Step 5: Node 13396 (Seq Scan) - LEAF
...
### Step 8: Node 13393 (Seq Scan) - LEAF
...
### Step 11: Node 13402 (Index Scan) - LEAF
...
### Step 12: Node 13404 (Seq Scan) - LEAF
...
### Step 13: Node 13391 (Nested Loop)
...
### Step 16: Node 13405 (Index Scan) - LEAF
...
### Step 17: Node 13407 (Seq Scan) - LEAF
...
### Step 18: Node 13389 (Nested Loop)
...
### Step 22: Node 13386 (Gather Merge)
...
### Step 23: Node 13385 (Aggregate) - ROOT
