...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 21086 | 21087, 21088, 21089, 21091, 21092, 21095 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 21091 | 21086, 21087, 21088, 21089, 21092, 21095 |
...
|------|------|--------|-----------|-----|--------|
| 21086 | Limit | 1172.87 | 1199.47 | 2.3% | pattern |
| 21090 | Hash Join | 1120.62 | 1095.60 | 2.2% | operator |
| 21091 | Hash Join | 1117.72 | 1120.19 | 0.2% | pattern |
| 21097 | Hash | 0.02 | 15.71 | 87182.1% | operator |
| 21098 | Seq Scan | 0.01 | 6.98 | 53582.3% | operator |
| 21093 | Seq Scan | 164.41 | 159.74 | 2.8% | operator |
| 21094 | Index Scan | 0.06 | -0.52 | 922.6% | operator |
| 21096 | Seq Scan | 24.27 | 26.64 | 9.8% | operator |
...
- **Consumes:** Nodes 21086, 21087, 21088, 21089, 21092, 21095
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18384
  - HashJoin_nt1=18384
...
### Step 8: Node 21086 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 21087, 21088, 21089, 21091, 21092, 21095
- **Input Features:**
