...
**Test Query:** Q18_36_seed_287141085
...
```
Node 30084 (Limit) - ROOT
  Node 30085 (Sort)
    Node 30086 (Aggregate)
      Node 30087 (Gather Merge)
        Node 30088 (Incremental Sort)
          Node 30089 (Nested Loop)
            Node 30090 (Merge Join)
              Node 30091 (Sort)
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30092 | 30093, 30094 |
...
|------|------|--------|-----------|-----|--------|
| 30084 | Limit | 3032.20 | 1175.21 | 61.2% | operator |
| 30085 | Sort | 2919.16 | 1127.81 | 61.4% | operator |
| 30086 | Aggregate | 2919.12 | 1073.15 | 63.2% | operator |
| 30087 | Gather Merge | 2919.10 | 1073.95 | 63.2% | operator |
| 30088 | Incremental Sort | 2897.44 | 0.00 | 100.0% | operator |
| 30089 | Nested Loop | 2897.38 | 1111.34 | 61.6% | operator |
| 30090 | Merge Join | 2897.32 | 0.00 | 100.0% | operator |
| 30099 | Index Scan | 0.02 | 0.05 | 88.1% | operator |
| 30091 | Sort | 2828.64 | 1095.58 | 61.3% | operator |
| 30097 | Sort | 65.92 | 1074.66 | 1530.3% | operator |
| 30092 | Hash Join | 2828.62 | 471.07 | 83.3% | pattern |
| 30098 | Seq Scan | 54.10 | 18.25 | 66.3% | operator |
| 30095 | Aggregate | 2602.62 | 1073.15 | 58.8% | operator |
| 30096 | Index Scan | 2100.04 | 0.00 | 100.0% | operator |
...
### Step 4: Node 30098 (Seq Scan) - LEAF
...
### Step 7: Node 30090 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30099 (Index Scan) - LEAF
...
### Step 10: Node 30088 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30087 (Gather Merge)
