...
**Test Query:** Q5_31_seed_246120930
...
```
Node 8381 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 8382 (Aggregate) [consumed]
    Node 8383 (Gather Merge) [consumed]
      Node 8384 (Aggregate)
        Node 8385 (Sort) [PATTERN: 3e2d5a00]
          Node 8386 (Hash Join) [consumed]
            Node 8387 (Nested Loop)
              Node 8388 (Hash Join)
                Node 8389 (Seq Scan) - LEAF
                Node 8390 (Hash) [PATTERN: 444761fb]
                  Node 8391 (Hash Join) [consumed]
                    Node 8392 (Seq Scan) [consumed] - LEAF
                    Node 8393 (Hash) [consumed]
                      Node 8394 (Hash Join) [consumed]
                        Node 8395 (Seq Scan) - LEAF
                        Node 8396 (Hash)
                          Node 8397 (Seq Scan) - LEAF
              Node 8398 (Index Scan) - LEAF
            Node 8399 (Hash)
              Node 8400 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 8390 | 8381, 8382, 8383, 8385, 8386, 8391, 8392, 8393, 8394 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 8381 | 8382, 8383, 8385, 8386, 8390, 8391, 8392, 8393, 8394 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 8385 | 8381, 8382, 8383, 8386, 8390, 8391, 8392, 8393, 8394 |
...
|------|------|--------|-----------|-----|--------|
| 8381 | Sort | 1074.79 | 2934.42 | 173.0% | pattern |
| 8384 | Aggregate | 1067.66 | 1128.74 | 5.7% | operator |
| 8385 | Sort | 1067.40 | 1835.96 | 72.0% | pattern |
| 8387 | Nested Loop | 1054.60 | 1188.57 | 12.7% | operator |
| 8399 | Hash | 4.26 | 18.67 | 338.3% | operator |
| 8388 | Hash Join | 216.83 | 253.07 | 16.7% | operator |
| 8398 | Index Scan | 0.07 | -0.22 | 401.4% | operator |
| 8400 | Seq Scan | 3.72 | 12.36 | 231.9% | operator |
| 8389 | Seq Scan | 168.09 | 159.81 | 4.9% | operator |
| 8390 | Hash | 34.87 | 46.85 | 34.4% | pattern |
| 8395 | Seq Scan | 0.01 | 11.81 | 117982.7% | operator |
| 8396 | Hash | 0.06 | 21.05 | 35583.5% | operator |
| 8397 | Seq Scan | 0.06 | 22.93 | 40852.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 8397 (Seq Scan) - LEAF
...
### Step 2: Node 8395 (Seq Scan) - LEAF
...
### Step 4: Node 8389 (Seq Scan) - LEAF
...
### Step 5: Node 8390 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 8381, 8382, 8383, 8385, 8386, 8391, 8392, 8393, 8394
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 8398 (Index Scan) - LEAF
...
### Step 8: Node 8400 (Seq Scan) - LEAF
...
### Step 11: Node 8385 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 8381, 8382, 8383, 8386, 8390, 8391, 8392, 8393, 8394
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 8381 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 8382, 8383, 8385, 8386, 8390, 8391, 8392, 8393, 8394
- **Input Features:**
