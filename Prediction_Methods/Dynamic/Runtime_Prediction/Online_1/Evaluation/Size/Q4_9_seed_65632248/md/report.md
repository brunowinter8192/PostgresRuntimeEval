...
```
Node 6894 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6895 (Gather Merge) [consumed]
    Node 6896 (Sort) [consumed]
      Node 6897 (Aggregate) [consumed]
        Node 6898 (Nested Loop)
          Node 6899 (Seq Scan) - LEAF
          Node 6900 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6894 | 6895, 6896, 6897 |
...
|------|------|--------|-----------|-----|--------|
| 6894 | Aggregate | 1085.45 | 952.19 | 12.3% | pattern |
| 6898 | Nested Loop | 1078.63 | 1255.45 | 16.4% | operator |
| 6899 | Seq Scan | 167.31 | 154.66 | 7.6% | operator |
| 6900 | Index Scan | 0.06 | 11.10 | 17526.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6899 (Seq Scan) - LEAF
...
### Step 2: Node 6900 (Index Scan) - LEAF
