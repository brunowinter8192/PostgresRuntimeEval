...
```
Node 6768 (Aggregate) [PATTERN: f8231c4d] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6768 | 6769, 6770, 6771 |
...
|------|------|--------|-----------|-----|--------|
| 6768 | Aggregate | 1061.99 | 952.19 | 10.3% | pattern |
| 6772 | Nested Loop | 1053.84 | 1255.45 | 19.1% | operator |
| 6773 | Seq Scan | 163.65 | 154.66 | 5.5% | operator |
| 6774 | Index Scan | 0.06 | 11.10 | 17810.2% | operator |
...
### Step 4: Node 6768 (Aggregate) - PATTERN ROOT
