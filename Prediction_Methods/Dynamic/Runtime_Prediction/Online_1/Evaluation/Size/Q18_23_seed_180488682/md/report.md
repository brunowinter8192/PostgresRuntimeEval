...
**Test Query:** Q18_23_seed_180488682
...
```
Node 29860 (Limit) - ROOT
  Node 29861 (Sort)
    Node 29862 (Aggregate)
      Node 29863 (Gather Merge)
        Node 29864 (Incremental Sort)
          Node 29865 (Nested Loop)
            Node 29866 (Merge Join)
              Node 29867 (Sort)
                Node 29868 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29869 (Seq Scan) [consumed] - LEAF
                  Node 29870 (Hash) [consumed]
                    Node 29871 (Aggregate)
                      Node 29872 (Index Scan) - LEAF
              Node 29873 (Sort)
                Node 29874 (Seq Scan) - LEAF
            Node 29875 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29868 | 29869, 29870 |
...
|------|------|--------|-----------|-----|--------|
| 29860 | Limit | 3047.00 | 1175.21 | 61.4% | operator |
| 29861 | Sort | 2928.76 | 1127.81 | 61.5% | operator |
| 29862 | Aggregate | 2928.72 | 1073.15 | 63.4% | operator |
| 29863 | Gather Merge | 2928.70 | 1073.95 | 63.3% | operator |
| 29864 | Incremental Sort | 2908.22 | 0.00 | 100.0% | operator |
| 29865 | Nested Loop | 2908.17 | 1111.34 | 61.8% | operator |
| 29866 | Merge Join | 2908.11 | 0.00 | 100.0% | operator |
| 29875 | Index Scan | 0.02 | 0.05 | 105.2% | operator |
| 29867 | Sort | 2838.78 | 1095.58 | 61.4% | operator |
| 29873 | Sort | 66.74 | 1074.66 | 1510.2% | operator |
| 29868 | Hash Join | 2838.77 | 471.07 | 83.4% | pattern |
| 29874 | Seq Scan | 55.34 | 18.25 | 67.0% | operator |
| 29871 | Aggregate | 2620.32 | 1073.15 | 59.0% | operator |
| 29872 | Index Scan | 2118.86 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29872 (Index Scan) - LEAF
...
### Step 3: Node 29868 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29869, 29870
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29874 (Seq Scan) - LEAF
...
### Step 7: Node 29866 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29875 (Index Scan) - LEAF
...
### Step 10: Node 29864 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29863 (Gather Merge)
