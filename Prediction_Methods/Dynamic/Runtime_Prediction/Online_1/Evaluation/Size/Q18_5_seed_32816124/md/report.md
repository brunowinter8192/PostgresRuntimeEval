        ...
        Node 30504 (Incremental Sort)
          Node 30505 (Nested Loop)
            Node 30506 (Merge Join)
              Node 30507 (Sort)
                Node 30508 (Hash Join)
                  Node 30509 (Seq Scan) - LEAF
                  Node 30510 (Hash)
...
| 30507 | Sort | 2868.88 | 1099.77 | 61.7% | operator |
| 30513 | Sort | 65.91 | 1074.66 | 1530.4% | operator |
| 30508 | Hash Join | 2868.87 | 686.33 | 76.1% | operator |
| 30514 | Seq Scan | 53.72 | 18.25 | 66.0% | operator |
| 30509 | Seq Scan | 197.06 | 170.37 | 13.5% | operator |
| 30510 | Hash | 2643.70 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30509 (Seq Scan) - LEAF
...
### Step 6: Node 30514 (Seq Scan) - LEAF
...
### Step 9: Node 30506 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30515 (Index Scan) - LEAF
...
### Step 11: Node 30505 (Nested Loop)
...
### Step 12: Node 30504 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30503 (Gather Merge)
