...
**Test Query:** Q18_5_seed_32816124
...
```
Node 30500 (Limit) - ROOT
  Node 30501 (Sort)
    Node 30502 (Aggregate)
      Node 30503 (Gather Merge)
        Node 30504 (Incremental Sort)
          Node 30505 (Nested Loop)
            Node 30506 (Merge Join)
              Node 30507 (Sort)
                Node 30508 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30509 (Seq Scan) [consumed] - LEAF
                  Node 30510 (Hash) [consumed]
                    Node 30511 (Aggregate)
                      Node 30512 (Index Scan) - LEAF
              Node 30513 (Sort)
                Node 30514 (Seq Scan) - LEAF
            Node 30515 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30508 | 30509, 30510 |
...
|------|------|--------|-----------|-----|--------|
| 30500 | Limit | 3070.02 | 1175.21 | 61.7% | operator |
| 30501 | Sort | 2958.64 | 1127.81 | 61.9% | operator |
| 30502 | Aggregate | 2958.60 | 1073.15 | 63.7% | operator |
| 30503 | Gather Merge | 2958.58 | 1073.95 | 63.7% | operator |
| 30504 | Incremental Sort | 2937.79 | 0.00 | 100.0% | operator |
| 30505 | Nested Loop | 2937.73 | 1111.34 | 62.2% | operator |
| 30506 | Merge Join | 2937.68 | 0.00 | 100.0% | operator |
| 30515 | Index Scan | 0.02 | 0.05 | 137.6% | operator |
| 30507 | Sort | 2868.88 | 1095.58 | 61.8% | operator |
| 30513 | Sort | 65.91 | 1074.66 | 1530.4% | operator |
| 30508 | Hash Join | 2868.87 | 471.07 | 83.6% | pattern |
| 30514 | Seq Scan | 53.72 | 18.25 | 66.0% | operator |
| 30511 | Aggregate | 2643.67 | 1073.15 | 59.4% | operator |
| 30512 | Index Scan | 2125.12 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30512 (Index Scan) - LEAF
...
### Step 3: Node 30508 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30509, 30510
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30514 (Seq Scan) - LEAF
...
### Step 7: Node 30506 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30515 (Index Scan) - LEAF
...
### Step 10: Node 30504 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30503 (Gather Merge)
