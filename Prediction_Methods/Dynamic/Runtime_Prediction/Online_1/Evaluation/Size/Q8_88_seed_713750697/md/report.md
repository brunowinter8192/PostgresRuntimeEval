...
```
Node 16329 (Aggregate) - ROOT
  Node 16330 (Gather Merge)
    Node 16331 (Sort)
          ...
          Node 16334 (Hash Join)
            Node 16335 (Nested Loop)
              Node 16336 (Hash Join)
                ...
                Node 16338 (Hash)
                  Node 16339 (Hash Join)
                    Node 16340 (Seq Scan) - LEAF
                    Node 16341 (Hash)
                      Node 16342 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 16329 | Aggregate | 1212.45 | 1189.39 | 1.9% | operator |
| 16330 | Gather Merge | 1211.97 | 1097.13 | 9.5% | operator |
...
| 16336 | Hash Join | 213.21 | 251.17 | 17.8% | operator |
...
| 16338 | Hash | 36.07 | 20.62 | 42.8% | operator |
| 16339 | Hash Join | 35.45 | 132.26 | 273.1% | operator |
| 16340 | Seq Scan | 33.93 | 23.03 | 32.1% | operator |
| 16341 | Hash | 0.18 | 23.66 | 12826.8% | operator |
| 16342 | Hash Join | 0.18 | 306.84 | 169422.6% | operator |
...
### Step 5: Node 16340 (Seq Scan) - LEAF
...
### Step 8: Node 16337 (Seq Scan) - LEAF
...
### Step 11: Node 16346 (Index Scan) - LEAF
...
### Step 12: Node 16348 (Seq Scan) - LEAF
...
### Step 13: Node 16335 (Nested Loop)
...
### Step 16: Node 16349 (Index Scan) - LEAF
...
### Step 17: Node 16351 (Seq Scan) - LEAF
...
### Step 18: Node 16333 (Nested Loop)
...
### Step 22: Node 16330 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1044.9440
  - st2=0.0000
  - startup_cost=71557.6600
  - total_cost=71850.4700
- **Output:** st=1093.42, rt=1097.13

### Step 23: Node 16329 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=71557.6600
  - total_cost=71948.0900
- **Output:** st=1161.23, rt=1189.39
