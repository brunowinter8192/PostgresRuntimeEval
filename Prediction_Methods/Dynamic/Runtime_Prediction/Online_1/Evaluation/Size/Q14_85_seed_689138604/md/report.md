...
**Test Query:** Q14_85_seed_689138604
...
```
Node 27351 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27352 (Gather) [consumed]
    Node 27353 (Aggregate) [consumed]
      Node 27354 (Hash Join) [consumed]
        Node 27355 (Seq Scan) - LEAF
        Node 27356 (Hash)
          Node 27357 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27351 | 27352, 27353, 27354 |
...
|------|------|--------|-----------|-----|--------|
| 27351 | Aggregate | 828.29 | 857.13 | 3.5% | pattern |
| 27355 | Seq Scan | 753.89 | 758.48 | 0.6% | operator |
| 27356 | Hash | 45.47 | 9.38 | 79.4% | operator |
| 27357 | Seq Scan | 38.64 | 12.70 | 67.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27357 (Seq Scan) - LEAF
...
### Step 2: Node 27355 (Seq Scan) - LEAF
...
### Step 4: Node 27351 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27352, 27353, 27354
- **Input Features:**
