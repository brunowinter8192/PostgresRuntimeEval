...
```
Node 27351 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27352 (Gather) [consumed]
    Node 27353 (Aggregate) [consumed]
      Node 27354 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27351 | 27352, 27353 |
...
|------|------|--------|-----------|-----|--------|
| 27351 | Aggregate | 828.29 | 848.36 | 2.4% | pattern |
| 27354 | Hash Join | 807.16 | 807.64 | 0.1% | operator |
...
### Step 5: Node 27351 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27352, 27353
- **Input Features:**
