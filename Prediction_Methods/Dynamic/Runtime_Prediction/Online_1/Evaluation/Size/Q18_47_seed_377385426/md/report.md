...
**Test Query:** Q18_47_seed_377385426
...
```
Node 30276 (Limit) - ROOT
  Node 30277 (Sort)
    Node 30278 (Aggregate)
      Node 30279 (Gather Merge)
        Node 30280 (Incremental Sort)
          Node 30281 (Nested Loop)
            Node 30282 (Merge Join)
              Node 30283 (Sort)
                Node 30284 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30285 (Seq Scan) [consumed] - LEAF
                  Node 30286 (Hash) [consumed]
                    Node 30287 (Aggregate)
                      Node 30288 (Index Scan) - LEAF
              Node 30289 (Sort)
                Node 30290 (Seq Scan) - LEAF
            Node 30291 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30284 | 30285, 30286 |
...
|------|------|--------|-----------|-----|--------|
| 30276 | Limit | 3057.58 | 1175.21 | 61.6% | operator |
| 30277 | Sort | 2939.63 | 1127.81 | 61.6% | operator |
| 30278 | Aggregate | 2939.59 | 1073.15 | 63.5% | operator |
| 30279 | Gather Merge | 2939.57 | 1073.95 | 63.5% | operator |
| 30280 | Incremental Sort | 2917.44 | 0.00 | 100.0% | operator |
| 30281 | Nested Loop | 2917.39 | 1111.34 | 61.9% | operator |
| 30282 | Merge Join | 2917.33 | 0.00 | 100.0% | operator |
| 30291 | Index Scan | 0.02 | 0.05 | 96.2% | operator |
| 30283 | Sort | 2847.89 | 1095.58 | 61.5% | operator |
| 30289 | Sort | 66.40 | 1074.66 | 1518.4% | operator |
| 30284 | Hash Join | 2847.88 | 471.07 | 83.5% | pattern |
| 30290 | Seq Scan | 54.19 | 18.25 | 66.3% | operator |
| 30287 | Aggregate | 2612.83 | 1073.15 | 58.9% | operator |
| 30288 | Index Scan | 2119.05 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30288 (Index Scan) - LEAF
...
### Step 3: Node 30284 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30285, 30286
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30290 (Seq Scan) - LEAF
...
### Step 7: Node 30282 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30291 (Index Scan) - LEAF
...
### Step 10: Node 30280 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30279 (Gather Merge)
