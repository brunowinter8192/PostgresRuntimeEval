        ...
        Node 30280 (Incremental Sort)
          Node 30281 (Nested Loop)
            Node 30282 (Merge Join)
              Node 30283 (Sort)
                Node 30284 (Hash Join)
                  Node 30285 (Seq Scan) - LEAF
                  Node 30286 (Hash)
...
| 30283 | Sort | 2847.89 | 1099.77 | 61.4% | operator |
| 30289 | Sort | 66.40 | 1074.66 | 1518.4% | operator |
| 30284 | Hash Join | 2847.88 | 686.33 | 75.9% | operator |
| 30290 | Seq Scan | 54.19 | 18.25 | 66.3% | operator |
| 30285 | Seq Scan | 203.65 | 170.37 | 16.3% | operator |
| 30286 | Hash | 2612.89 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30285 (Seq Scan) - LEAF
...
### Step 6: Node 30290 (Seq Scan) - LEAF
...
### Step 9: Node 30282 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30291 (Index Scan) - LEAF
...
### Step 11: Node 30281 (Nested Loop)
...
### Step 12: Node 30280 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30279 (Gather Merge)
