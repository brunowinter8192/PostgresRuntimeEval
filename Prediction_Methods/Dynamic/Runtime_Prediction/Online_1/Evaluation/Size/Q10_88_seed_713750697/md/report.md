    ...
    Node 21140 (Aggregate) [consumed]
      Node 21141 (Gather) [consumed]
        Node 21142 (Hash Join)
          Node 21143 (Hash Join)
            Node 21144 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 21138 | 21139, 21140, 21141 |
...
| 21142 | Hash Join | 1102.14 | 1007.24 | 8.6% | operator |
| 21143 | Hash Join | 1099.30 | 1004.16 | 8.7% | operator |
| 21149 | Hash | 0.01 | 15.71 | 112119.8% | operator |
| 21144 | Nested Loop | 1053.10 | 1204.80 | 14.4% | operator |
| 21147 | Hash | 35.86 | 55.57 | 55.0% | operator |
...
### Step 6: Node 21150 (Seq Scan) - LEAF
...
### Step 10: Node 21138 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 21139, 21140, 21141
- **Input Features:**
