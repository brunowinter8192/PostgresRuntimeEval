...
**Test Query:** Q10_88_seed_713750697
...
```
Node 21138 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 21139 (Sort) [consumed]
    Node 21140 (Aggregate) [consumed]
      Node 21141 (Gather) [consumed]
        Node 21142 (Hash Join)
          Node 21143 (Hash Join) [PATTERN: 2e0f44ef]
            Node 21144 (Nested Loop) [consumed]
              Node 21145 (Seq Scan) - LEAF
              Node 21146 (Index Scan) - LEAF
            Node 21147 (Hash) [consumed]
              Node 21148 (Seq Scan) - LEAF
          Node 21149 (Hash)
            Node 21150 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 21138 | 21139, 21140, 21141, 21143, 21144, 21147 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 21143 | 21138, 21139, 21140, 21141, 21144, 21147 |
...
|------|------|--------|-----------|-----|--------|
| 21138 | Limit | 1154.28 | 1199.47 | 3.9% | pattern |
| 21142 | Hash Join | 1102.14 | 1095.50 | 0.6% | operator |
| 21143 | Hash Join | 1099.30 | 1120.19 | 1.9% | pattern |
| 21149 | Hash | 0.01 | 15.71 | 112119.8% | operator |
| 21150 | Seq Scan | 0.01 | 6.98 | 69687.0% | operator |
| 21145 | Seq Scan | 161.81 | 159.74 | 1.3% | operator |
| 21146 | Index Scan | 0.06 | -0.52 | 922.6% | operator |
| 21148 | Seq Scan | 28.89 | 26.64 | 7.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 21145 (Seq Scan) - LEAF
...
### Step 2: Node 21146 (Index Scan) - LEAF
...
### Step 3: Node 21148 (Seq Scan) - LEAF
...
### Step 4: Node 21150 (Seq Scan) - LEAF
...
### Step 5: Node 21143 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 21138, 21139, 21140, 21141, 21144, 21147
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=17978
  - HashJoin_nt1=17978
...
### Step 8: Node 21138 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 21139, 21140, 21141, 21143, 21144, 21147
- **Input Features:**
