...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5781 | 5782, 5783, 5784 |
...
| 5785 | Nested Loop | 1149.91 | 1193.27 | 3.8% | operator |
| 5786 | Hash Join | 208.90 | 230.88 | 10.5% | operator |
| 5790 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5787 | Seq Scan | 156.38 | 163.41 | 4.5% | operator |
| 5788 | Hash | 29.43 | 17.75 | 39.7% | operator |
...
### Step 2: Node 5787 (Seq Scan) - LEAF
...
### Step 5: Node 5790 (Index Scan) - LEAF
...
### Step 7: Node 5781 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5782, 5783, 5784
- **Input Features:**
