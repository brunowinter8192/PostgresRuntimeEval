    ...
    Node 5783 (Aggregate) [consumed]
      Node 5784 (Gather) [consumed]
        Node 5785 (Nested Loop)
          Node 5786 (Hash Join) [PATTERN: 895c6e8c]
            Node 5787 (Seq Scan) [consumed] - LEAF
            Node 5788 (Hash) [consumed]
              Node 5789 (Seq Scan) - LEAF
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5781 | 5782, 5783, 5784, 5786, 5787, 5788 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5786 | 5781, 5782, 5783, 5784, 5787, 5788 |
...
|------|------|--------|-----------|-----|--------|
| 5781 | Limit | 1185.61 | 1151.18 | 2.9% | pattern |
| 5785 | Nested Loop | 1149.91 | 1193.36 | 3.8% | operator |
| 5786 | Hash Join | 208.90 | 242.54 | 16.1% | pattern |
| 5790 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5789 | Seq Scan | 28.72 | 38.53 | 34.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5789 (Seq Scan) - LEAF
...
### Step 2: Node 5786 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5781, 5782, 5783, 5784, 5787, 5788
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47393
  - HashJoin_nt1=235479
...
### Step 3: Node 5790 (Index Scan) - LEAF
...
### Step 5: Node 5781 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5782, 5783, 5784, 5786, 5787, 5788
- **Input Features:**
