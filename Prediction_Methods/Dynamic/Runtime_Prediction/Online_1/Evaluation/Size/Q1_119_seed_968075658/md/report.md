...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 103 | 104 |
...
|------|------|--------|-----------|-----|--------|
| 101 | Aggregate | 938.28 | 1195.79 | 27.4% | operator |
| 102 | Gather Merge | 938.21 | 1165.88 | 24.3% | operator |
| 103 | Sort | 918.14 | 1200.13 | 30.7% | pattern |
...
- **Input Features:**
  ...
  - Aggregate_Outer_total_cost=168713.5100
  - Sort_np=0
  - Sort_nt=6
  - Sort_nt1=6
  - Sort_nt2=0
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=168713.5900
  - Sort_total_cost=168713.6000
- **Output:** st=1196.04, rt=1200.13

### Step 3: Node 102 (Gather Merge)
...
### Step 4: Node 101 (Aggregate) - ROOT
