...
```
Node 16559 (Aggregate) - ROOT
  Node 16560 (Gather Merge)
    Node 16561 (Sort)
          ...
          Node 16564 (Hash Join)
            Node 16565 (Nested Loop)
              Node 16566 (Hash Join)
                ...
                Node 16568 (Hash)
                  Node 16569 (Hash Join)
                    Node 16570 (Seq Scan) - LEAF
                    Node 16571 (Hash)
                      Node 16572 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 16559 | Aggregate | 1259.58 | 1195.83 | 5.1% | operator |
| 16560 | Gather Merge | 1259.11 | 1097.16 | 12.9% | operator |
...
| 16566 | Hash Join | 216.15 | 251.17 | 16.2% | operator |
...
| 16568 | Hash | 41.70 | 20.62 | 50.6% | operator |
| 16569 | Hash Join | 41.04 | 132.26 | 222.2% | operator |
| 16570 | Seq Scan | 39.28 | 23.03 | 41.4% | operator |
| 16571 | Hash | 0.37 | 23.66 | 6293.5% | operator |
| 16572 | Hash Join | 0.37 | 306.84 | 83279.3% | operator |
...
### Step 5: Node 16570 (Seq Scan) - LEAF
...
### Step 8: Node 16567 (Seq Scan) - LEAF
...
### Step 11: Node 16576 (Index Scan) - LEAF
...
### Step 12: Node 16578 (Seq Scan) - LEAF
...
### Step 13: Node 16565 (Nested Loop)
...
### Step 16: Node 16579 (Index Scan) - LEAF
...
### Step 17: Node 16581 (Seq Scan) - LEAF
...
### Step 18: Node 16563 (Nested Loop)
...
### Step 22: Node 16560 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1044.9412
  - st2=0.0000
  - startup_cost=71544.6300
  - total_cost=71824.4300
- **Output:** st=1093.46, rt=1097.16

### Step 23: Node 16559 (Aggregate) - ROOT
