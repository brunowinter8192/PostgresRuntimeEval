...
**Test Query:** Q5_144_seed_1173176433
...
```
Node 7861 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 7862 (Aggregate) [consumed]
    Node 7863 (Gather Merge) [consumed]
      Node 7864 (Aggregate)
        Node 7865 (Sort) [PATTERN: 3e2d5a00]
          Node 7866 (Hash Join) [consumed]
            Node 7867 (Nested Loop)
              Node 7868 (Hash Join)
                Node 7869 (Seq Scan) - LEAF
                Node 7870 (Hash) [PATTERN: 444761fb]
                  Node 7871 (Hash Join) [consumed]
                    Node 7872 (Seq Scan) [consumed] - LEAF
                    Node 7873 (Hash) [consumed]
                      Node 7874 (Hash Join) [consumed]
                        Node 7875 (Seq Scan) - LEAF
                        Node 7876 (Hash)
                          Node 7877 (Seq Scan) - LEAF
              Node 7878 (Index Scan) - LEAF
            Node 7879 (Hash)
              Node 7880 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 7870 | 7861, 7862, 7863, 7865, 7866, 7871, 7872, 7873, 7874 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 7861 | 7862, 7863, 7865, 7866, 7870, 7871, 7872, 7873, 7874 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 7865 | 7861, 7862, 7863, 7866, 7870, 7871, 7872, 7873, 7874 |
...
|------|------|--------|-----------|-----|--------|
| 7861 | Sort | 1082.47 | 2934.42 | 171.1% | pattern |
| 7864 | Aggregate | 1077.48 | 1128.78 | 4.8% | operator |
| 7865 | Sort | 1077.24 | 1835.92 | 70.4% | pattern |
| 7867 | Nested Loop | 1064.21 | 1188.42 | 11.7% | operator |
| 7879 | Hash | 3.68 | 18.67 | 407.6% | operator |
| 7868 | Hash Join | 215.05 | 253.07 | 17.7% | operator |
| 7878 | Index Scan | 0.07 | -0.22 | 393.4% | operator |
| 7880 | Seq Scan | 3.17 | 12.36 | 290.1% | operator |
| 7869 | Seq Scan | 166.33 | 159.81 | 3.9% | operator |
| 7870 | Hash | 35.19 | 46.85 | 33.1% | pattern |
| 7875 | Seq Scan | 0.01 | 11.81 | 168589.6% | operator |
| 7876 | Hash | 0.09 | 21.05 | 23824.1% | operator |
| 7877 | Seq Scan | 0.09 | 22.93 | 26566.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 7877 (Seq Scan) - LEAF
...
### Step 2: Node 7875 (Seq Scan) - LEAF
...
### Step 4: Node 7869 (Seq Scan) - LEAF
...
### Step 5: Node 7870 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 7861, 7862, 7863, 7865, 7866, 7871, 7872, 7873, 7874
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 7878 (Index Scan) - LEAF
...
### Step 8: Node 7880 (Seq Scan) - LEAF
...
### Step 11: Node 7865 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 7861, 7862, 7863, 7866, 7870, 7871, 7872, 7873, 7874
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 7861 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 7862, 7863, 7865, 7866, 7870, 7871, 7872, 7873, 7874
- **Input Features:**
