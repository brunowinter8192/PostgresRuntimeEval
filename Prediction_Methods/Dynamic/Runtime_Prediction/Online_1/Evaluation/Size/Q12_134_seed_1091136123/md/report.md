...
**Test Query:** Q12_134_seed_1091136123
...
```
Node 24579 (Aggregate) - ROOT
  Node 24580 (Gather Merge)
    Node 24581 (Aggregate)
      Node 24582 (Sort)
        Node 24583 (Nested Loop)
          Node 24584 (Seq Scan) - LEAF
          Node 24585 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24579 | Aggregate | 1011.39 | 919.08 | 9.1% | operator |
| 24580 | Gather Merge | 1011.37 | 1111.84 | 9.9% | operator |
| 24581 | Aggregate | 990.36 | 895.32 | 9.6% | operator |
| 24582 | Sort | 989.72 | 1092.80 | 10.4% | operator |
| 24583 | Nested Loop | 988.75 | 1127.41 | 14.0% | operator |
| 24584 | Seq Scan | 844.09 | 745.19 | 11.7% | operator |
| 24585 | Index Scan | 0.03 | 0.07 | 156.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24584 (Seq Scan) - LEAF
...
### Step 2: Node 24585 (Index Scan) - LEAF
...
### Step 6: Node 24580 (Gather Merge)
...
### Step 7: Node 24579 (Aggregate) - ROOT
