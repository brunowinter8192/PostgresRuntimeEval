...
```
Node 17520 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 17521 (Aggregate) [consumed]
    Node 17522 (Gather)
      Node 17523 (Aggregate)
        Node 17524 (Nested Loop)
          Node 17525 (Hash Join) [PATTERN: bb930825]
            Node 17526 (Seq Scan) [consumed] - LEAF
            Node 17527 (Hash) [consumed]
              Node 17528 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17525 | 17520, 17521, 17526, 17527, 17528 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17520 | 17521, 17525, 17526, 17527, 17528 |
...
|------|------|--------|-----------|-----|--------|
| 17520 | Sort | 1191.56 | 1045.32 | 12.3% | pattern |
...
| 17525 | Hash Join | 973.20 | 134.80 | 86.1% | pattern |
...
### Step 9: Node 17525 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17520, 17521, 17526, 17527, 17528
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17537 (Index Scan) - LEAF
...
### Step 11: Node 17524 (Nested Loop)
...
### Step 14: Node 17520 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17521, 17525, 17526, 17527, 17528
- **Input Features:**
