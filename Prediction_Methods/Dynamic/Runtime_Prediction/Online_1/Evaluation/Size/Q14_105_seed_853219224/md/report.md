...
```
Node 26455 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26456 (Gather) [consumed]
    Node 26457 (Aggregate) [consumed]
      Node 26458 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26455 | 26456, 26457 |
...
|------|------|--------|-----------|-----|--------|
| 26455 | Aggregate | 796.50 | 848.37 | 6.5% | pattern |
| 26458 | Hash Join | 772.31 | 807.66 | 4.6% | operator |
...
### Step 5: Node 26455 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26456, 26457
- **Input Features:**
