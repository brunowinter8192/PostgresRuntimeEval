...
**Test Query:** Q14_105_seed_853219224
...
```
Node 26455 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26456 (Gather) [consumed]
    Node 26457 (Aggregate) [consumed]
      Node 26458 (Hash Join) [consumed]
        Node 26459 (Seq Scan) - LEAF
        Node 26460 (Hash)
          Node 26461 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26455 | 26456, 26457, 26458 |
...
|------|------|--------|-----------|-----|--------|
| 26455 | Aggregate | 796.50 | 857.13 | 7.6% | pattern |
| 26459 | Seq Scan | 719.33 | 758.50 | 5.4% | operator |
| 26460 | Hash | 44.32 | 9.38 | 78.8% | operator |
| 26461 | Seq Scan | 38.62 | 12.70 | 67.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26461 (Seq Scan) - LEAF
...
### Step 2: Node 26459 (Seq Scan) - LEAF
...
### Step 4: Node 26455 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26456, 26457, 26458
- **Input Features:**
