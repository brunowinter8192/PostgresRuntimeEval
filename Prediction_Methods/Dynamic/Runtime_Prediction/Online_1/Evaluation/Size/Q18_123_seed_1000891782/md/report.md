        ...
        Node 29224 (Incremental Sort)
          Node 29225 (Nested Loop)
            Node 29226 (Merge Join)
              Node 29227 (Sort)
                Node 29228 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29229 (Seq Scan) [consumed] - LEAF
                  Node 29230 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29228 | 29229, 29230 |
...
| 29227 | Sort | 2891.79 | 1095.58 | 62.1% | operator |
| 29233 | Sort | 63.91 | 1074.66 | 1581.4% | operator |
| 29228 | Hash Join | 2891.77 | 471.07 | 83.7% | pattern |
...
### Step 3: Node 29228 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29229, 29230
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29234 (Seq Scan) - LEAF
...
### Step 7: Node 29226 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29235 (Index Scan) - LEAF
...
### Step 10: Node 29224 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29223 (Gather Merge)
