...
|------|------|--------|-----------|-----|--------|
| 7001 | Sort | 1068.91 | 1098.95 | 2.8% | operator |
| 7002 | Aggregate | 1068.89 | 1032.58 | 3.4% | operator |
| 7003 | Gather Merge | 1068.88 | 1133.58 | 6.1% | operator |
| 7004 | Aggregate | 1063.27 | 985.91 | 7.3% | operator |
| 7005 | Sort | 1063.04 | 1068.17 | 0.5% | operator |
| 7006 | Hash Join | 1062.55 | 1131.88 | 6.5% | operator |
| 7007 | Nested Loop | 1050.64 | 1188.47 | 13.1% | operator |
| 7019 | Hash | 3.77 | 18.67 | 395.0% | operator |
| 7008 | Hash Join | 217.05 | 252.47 | 16.3% | operator |
| 7018 | Index Scan | 0.07 | -0.22 | 401.4% | operator |
| 7020 | Seq Scan | 3.23 | 12.36 | 283.2% | operator |
| 7009 | Seq Scan | 169.94 | 159.81 | 6.0% | operator |
| 7010 | Hash | 34.09 | 22.67 | 33.5% | operator |
| 7011 | Hash Join | 32.79 | 102.01 | 211.1% | operator |
| 7012 | Seq Scan | 31.32 | 24.28 | 22.5% | operator |
| 7013 | Hash | 0.07 | 21.93 | 30359.2% | operator |
| 7014 | Hash Join | 0.07 | 284.32 | 411962.8% | operator |
...
### Step 5: Node 7012 (Seq Scan) - LEAF
...
### Step 8: Node 7009 (Seq Scan) - LEAF
...
- **Output:** st=16.81, rt=252.47

### Step 11: Node 7018 (Index Scan) - LEAF
...
### Step 12: Node 7020 (Seq Scan) - LEAF
...
- **Output:** st=100.39, rt=1131.88

### Step 16: Node 7005 (Sort)
...
- **Output:** st=976.28, rt=985.91

### Step 18: Node 7003 (Gather Merge)
...
- **Output:** st=1130.54, rt=1133.58

### Step 19: Node 7002 (Aggregate)
...
- **Output:** st=1048.69, rt=1032.58

### Step 20: Node 7001 (Sort) - ROOT
