...
**Test Query:** Q18_85_seed_689138604
**Timestamp:** 2026-01-18 20:24:47
...
```
Node 30948 (Limit) - ROOT
  Node 30949 (Sort)
    Node 30950 (Aggregate)
      Node 30951 (Gather Merge)
        Node 30952 (Incremental Sort)
          Node 30953 (Nested Loop)
            Node 30954 (Merge Join)
              Node 30955 (Sort)
                Node 30956 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30957 (Seq Scan) [consumed] - LEAF
                  Node 30958 (Hash) [consumed]
                    Node 30959 (Aggregate)
                      Node 30960 (Index Scan) - LEAF
              Node 30961 (Sort)
                Node 30962 (Seq Scan) - LEAF
            Node 30963 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30956 | 30957, 30958 |
...
|------|------|--------|-----------|-----|--------|
| 30948 | Limit | 3069.84 | 1175.21 | 61.7% | operator |
| 30949 | Sort | 2957.83 | 1127.81 | 61.9% | operator |
| 30950 | Aggregate | 2957.79 | 1073.15 | 63.7% | operator |
| 30951 | Gather Merge | 2957.77 | 1073.95 | 63.7% | operator |
| 30952 | Incremental Sort | 2921.39 | 0.00 | 100.0% | operator |
| 30953 | Nested Loop | 2921.34 | 1111.34 | 62.0% | operator |
| 30954 | Merge Join | 2921.28 | 0.00 | 100.0% | operator |
| 30963 | Index Scan | 0.02 | 0.05 | 105.2% | operator |
| 30955 | Sort | 2870.84 | 1095.58 | 61.8% | operator |
| 30961 | Sort | 64.29 | 1074.66 | 1571.6% | operator |
| 30956 | Hash Join | 2870.82 | 471.07 | 83.6% | pattern |
| 30962 | Seq Scan | 51.51 | 18.25 | 64.6% | operator |
| 30959 | Aggregate | 2648.38 | 1073.15 | 59.5% | operator |
| 30960 | Index Scan | 2147.86 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30960 (Index Scan) - LEAF
...
### Step 3: Node 30956 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30957, 30958
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30962 (Seq Scan) - LEAF
...
### Step 7: Node 30954 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30963 (Index Scan) - LEAF
...
### Step 10: Node 30952 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30951 (Gather Merge)
