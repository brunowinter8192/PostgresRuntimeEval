...
```
Node 26637 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26638 (Gather) [consumed]
    Node 26639 (Aggregate) [consumed]
      Node 26640 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26637 | 26638, 26639, 26640 |
...
|------|------|--------|-----------|-----|--------|
| 26637 | Aggregate | 848.62 | 857.14 | 1.0% | pattern |
| 26641 | Seq Scan | 773.56 | 758.52 | 1.9% | operator |
| 26642 | Hash | 46.16 | 9.38 | 79.7% | operator |
| 26643 | Seq Scan | 40.78 | 12.70 | 68.8% | operator |
...
### Step 4: Node 26637 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26638, 26639, 26640
- **Input Features:**
