...
```
Node 12337 (Aggregate) - ROOT
  Node 12338 (Gather Merge)
    Node 12339 (Sort)
      Node 12340 (Hash Join)
        Node 12341 (Nested Loop)
          Node 12342 (Hash Join)
            Node 12343 (Seq Scan) - LEAF
            Node 12344 (Hash)
              Node 12345 (Hash Join)
                Node 12346 (Seq Scan) - LEAF
                Node 12347 (Hash)
                  Node 12348 (Seq Scan) - LEAF
          Node 12349 (Index Scan) - LEAF
        Node 12350 (Hash)
          Node 12351 (Hash Join)
            Node 12352 (Seq Scan) - LEAF
            Node 12353 (Hash)
              Node 12354 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12337 | Aggregate | 1215.22 | 1209.26 | 0.5% | operator |
| 12338 | Gather Merge | 1214.23 | 1142.98 | 5.9% | operator |
| 12339 | Sort | 1209.25 | 1109.13 | 8.3% | operator |
| 12340 | Hash Join | 1208.64 | 842.59 | 30.3% | operator |
| 12341 | Nested Loop | 1201.35 | 1216.16 | 1.2% | operator |
| 12350 | Hash | 3.62 | 17.53 | 384.3% | operator |
| 12342 | Hash Join | 222.58 | 384.47 | 72.7% | operator |
| 12349 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 12351 | Hash Join | 3.58 | 85.17 | 2279.8% | operator |
| 12343 | Seq Scan | 160.52 | 201.16 | 25.3% | operator |
| 12344 | Hash | 36.59 | 19.59 | 46.5% | operator |
| 12352 | Seq Scan | 3.26 | 11.47 | 252.2% | operator |
| 12353 | Hash | 0.01 | 16.89 | 112527.2% | operator |
| 12345 | Hash Join | 36.26 | 92.20 | 154.3% | operator |
| 12354 | Seq Scan | 0.01 | 45.79 | 381502.6% | operator |
| 12346 | Seq Scan | 35.13 | 21.86 | 37.8% | operator |
| 12347 | Hash | 0.01 | 16.89 | 168840.8% | operator |
| 12348 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12348 (Seq Scan) - LEAF
...
### Step 2: Node 12346 (Seq Scan) - LEAF
...
### Step 5: Node 12354 (Seq Scan) - LEAF
...
### Step 6: Node 12343 (Seq Scan) - LEAF
...
### Step 8: Node 12352 (Seq Scan) - LEAF
...
### Step 11: Node 12349 (Index Scan) - LEAF
...
### Step 13: Node 12341 (Nested Loop)
...
### Step 17: Node 12338 (Gather Merge)
...
### Step 18: Node 12337 (Aggregate) - ROOT
