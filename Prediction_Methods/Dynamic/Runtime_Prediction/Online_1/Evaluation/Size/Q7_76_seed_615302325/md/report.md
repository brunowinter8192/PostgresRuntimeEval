...
```
Node 12715 (Aggregate) - ROOT
  Node 12716 (Gather Merge)
    Node 12717 (Sort)
      Node 12718 (Hash Join)
        Node 12719 (Nested Loop)
          Node 12720 (Hash Join)
            Node 12721 (Seq Scan) - LEAF
            Node 12722 (Hash)
              Node 12723 (Hash Join)
                Node 12724 (Seq Scan) - LEAF
                Node 12725 (Hash)
                  Node 12726 (Seq Scan) - LEAF
          Node 12727 (Index Scan) - LEAF
        Node 12728 (Hash)
          Node 12729 (Hash Join)
            Node 12730 (Seq Scan) - LEAF
            Node 12731 (Hash)
              Node 12732 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12715 | Aggregate | 1254.17 | 1209.26 | 3.6% | operator |
| 12716 | Gather Merge | 1253.15 | 1142.98 | 8.8% | operator |
| 12717 | Sort | 1247.45 | 1109.13 | 11.1% | operator |
| 12718 | Hash Join | 1246.81 | 842.59 | 32.4% | operator |
| 12719 | Nested Loop | 1239.60 | 1216.16 | 1.9% | operator |
| 12728 | Hash | 3.31 | 17.53 | 430.1% | operator |
| 12720 | Hash Join | 217.80 | 384.47 | 76.5% | operator |
| 12727 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 12729 | Hash Join | 3.26 | 85.17 | 2514.3% | operator |
| 12721 | Seq Scan | 157.32 | 201.16 | 27.9% | operator |
| 12722 | Hash | 35.22 | 19.59 | 44.4% | operator |
| 12730 | Seq Scan | 2.93 | 11.47 | 291.0% | operator |
| 12731 | Hash | 0.01 | 16.89 | 112527.2% | operator |
| 12723 | Hash Join | 34.50 | 92.20 | 167.3% | operator |
| 12732 | Seq Scan | 0.01 | 45.79 | 416193.8% | operator |
| 12724 | Seq Scan | 33.38 | 21.86 | 34.5% | operator |
| 12725 | Hash | 0.01 | 16.89 | 153482.6% | operator |
| 12726 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12726 (Seq Scan) - LEAF
...
### Step 2: Node 12724 (Seq Scan) - LEAF
...
### Step 5: Node 12732 (Seq Scan) - LEAF
...
### Step 6: Node 12721 (Seq Scan) - LEAF
...
### Step 8: Node 12730 (Seq Scan) - LEAF
...
### Step 11: Node 12727 (Index Scan) - LEAF
...
### Step 13: Node 12719 (Nested Loop)
...
### Step 17: Node 12716 (Gather Merge)
...
### Step 18: Node 12715 (Aggregate) - ROOT
