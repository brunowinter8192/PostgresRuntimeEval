        ...
        Node 30264 (Incremental Sort)
          Node 30265 (Nested Loop)
            Node 30266 (Merge Join)
              Node 30267 (Sort)
                Node 30268 (Hash Join)
                  Node 30269 (Seq Scan) - LEAF
                  Node 30270 (Hash)
...
| 30267 | Sort | 2866.52 | 1099.77 | 61.6% | operator |
| 30273 | Sort | 65.63 | 1074.66 | 1537.4% | operator |
| 30268 | Hash Join | 2866.51 | 686.33 | 76.1% | operator |
| 30274 | Seq Scan | 52.20 | 18.25 | 65.0% | operator |
| 30269 | Seq Scan | 184.08 | 170.37 | 7.4% | operator |
| 30270 | Hash | 2652.20 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30269 (Seq Scan) - LEAF
...
### Step 6: Node 30274 (Seq Scan) - LEAF
...
### Step 9: Node 30266 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30275 (Index Scan) - LEAF
...
### Step 11: Node 30265 (Nested Loop)
...
### Step 12: Node 30264 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30263 (Gather Merge)
