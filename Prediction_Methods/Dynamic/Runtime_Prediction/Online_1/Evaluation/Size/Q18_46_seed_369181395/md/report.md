...
**Test Query:** Q18_46_seed_369181395
...
```
Node 30260 (Limit) - ROOT
  Node 30261 (Sort)
    Node 30262 (Aggregate)
      Node 30263 (Gather Merge)
        Node 30264 (Incremental Sort)
          Node 30265 (Nested Loop)
            Node 30266 (Merge Join)
              Node 30267 (Sort)
                Node 30268 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30269 (Seq Scan) [consumed] - LEAF
                  Node 30270 (Hash) [consumed]
                    Node 30271 (Aggregate)
                      Node 30272 (Index Scan) - LEAF
              Node 30273 (Sort)
                Node 30274 (Seq Scan) - LEAF
            Node 30275 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30268 | 30269, 30270 |
...
|------|------|--------|-----------|-----|--------|
| 30260 | Limit | 3070.50 | 1175.21 | 61.7% | operator |
| 30261 | Sort | 2956.25 | 1127.81 | 61.9% | operator |
| 30262 | Aggregate | 2956.19 | 1073.15 | 63.7% | operator |
| 30263 | Gather Merge | 2956.17 | 1073.95 | 63.7% | operator |
| 30264 | Incremental Sort | 2935.08 | 0.00 | 100.0% | operator |
| 30265 | Nested Loop | 2935.03 | 1111.34 | 62.1% | operator |
| 30266 | Merge Join | 2934.97 | 0.00 | 100.0% | operator |
| 30275 | Index Scan | 0.02 | 0.05 | 96.2% | operator |
| 30267 | Sort | 2866.52 | 1095.58 | 61.8% | operator |
| 30273 | Sort | 65.63 | 1074.66 | 1537.4% | operator |
| 30268 | Hash Join | 2866.51 | 471.07 | 83.6% | pattern |
| 30274 | Seq Scan | 52.20 | 18.25 | 65.0% | operator |
| 30271 | Aggregate | 2652.17 | 1073.15 | 59.5% | operator |
| 30272 | Index Scan | 2148.15 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30272 (Index Scan) - LEAF
...
### Step 3: Node 30268 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30269, 30270
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30274 (Seq Scan) - LEAF
...
### Step 7: Node 30266 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30275 (Index Scan) - LEAF
...
### Step 10: Node 30264 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30263 (Gather Merge)
