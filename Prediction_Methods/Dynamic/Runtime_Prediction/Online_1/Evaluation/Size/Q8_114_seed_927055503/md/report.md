...
```
Node 13546 (Aggregate) - ROOT
  Node 13547 (Gather Merge)
    Node 13548 (Sort)
          ...
          Node 13551 (Hash Join)
            Node 13552 (Nested Loop)
              Node 13553 (Hash Join)
                ...
                Node 13555 (Hash)
                  Node 13556 (Hash Join)
                    Node 13557 (Seq Scan) - LEAF
                    Node 13558 (Hash)
                      Node 13559 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 13546 | Aggregate | 1201.18 | 1188.93 | 1.0% | operator |
| 13547 | Gather Merge | 1200.72 | 1097.16 | 8.6% | operator |
...
| 13553 | Hash Join | 213.24 | 251.17 | 17.8% | operator |
...
| 13555 | Hash | 38.17 | 20.62 | 46.0% | operator |
| 13556 | Hash Join | 37.44 | 132.26 | 253.3% | operator |
| 13557 | Seq Scan | 35.70 | 23.03 | 35.5% | operator |
| 13558 | Hash | 0.31 | 23.66 | 7531.0% | operator |
| 13559 | Hash Join | 0.31 | 306.84 | 100173.2% | operator |
...
### Step 5: Node 13557 (Seq Scan) - LEAF
...
### Step 8: Node 13554 (Seq Scan) - LEAF
...
### Step 11: Node 13563 (Index Scan) - LEAF
...
### Step 12: Node 13565 (Seq Scan) - LEAF
...
### Step 13: Node 13552 (Nested Loop)
...
### Step 16: Node 13566 (Index Scan) - LEAF
...
### Step 17: Node 13568 (Seq Scan) - LEAF
...
### Step 18: Node 13550 (Nested Loop)
...
### Step 22: Node 13547 (Gather Merge)
...
### Step 23: Node 13546 (Aggregate) - ROOT
