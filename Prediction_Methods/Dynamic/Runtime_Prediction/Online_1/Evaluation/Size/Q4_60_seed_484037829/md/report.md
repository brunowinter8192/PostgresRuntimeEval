...
**Test Query:** Q4_60_seed_484037829
...
```
Node 6593 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6594 (Gather Merge) [consumed]
    Node 6595 (Sort) [consumed]
      Node 6596 (Aggregate) [consumed]
        Node 6597 (Nested Loop)
          Node 6598 (Seq Scan) - LEAF
          Node 6599 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6593 | 6594, 6595, 6596 |
...
|------|------|--------|-----------|-----|--------|
| 6593 | Aggregate | 1050.03 | 952.19 | 9.3% | pattern |
| 6597 | Nested Loop | 1042.29 | 1255.45 | 20.5% | operator |
| 6598 | Seq Scan | 164.31 | 154.66 | 5.9% | operator |
| 6599 | Index Scan | 0.06 | 11.10 | 18103.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6598 (Seq Scan) - LEAF
...
### Step 2: Node 6599 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - Aggregate_startup_cost=67288.4400
  - Aggregate_total_cost=67290.3400
  ...
  - GatherMerge_Outer_startup_cost=67288.4400
  - GatherMerge_Outer_total_cost=67290.2100
  - Sort_Outer_np=0
  - Sort_Outer_nt=5
  - Sort_Outer_nt1=5
  - Sort_Outer_nt2=0
  ...
  - Sort_Outer_startup_cost=66288.4000
  - Sort_Outer_total_cost=66288.4100
