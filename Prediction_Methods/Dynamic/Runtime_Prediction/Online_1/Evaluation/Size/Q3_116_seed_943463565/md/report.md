    ...
    Node 4523 (Aggregate) [consumed]
      Node 4524 (Gather) [consumed]
        Node 4525 (Nested Loop)
          Node 4526 (Hash Join) [PATTERN: 895c6e8c]
            Node 4527 (Seq Scan) [consumed] - LEAF
            Node 4528 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4521 | 4522, 4523, 4524, 4526, 4527, 4528 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4526 | 4521, 4522, 4523, 4524, 4527, 4528 |
...
| 4525 | Nested Loop | 1161.13 | 1192.72 | 2.7% | operator |
| 4526 | Hash Join | 208.82 | 242.42 | 16.1% | pattern |
...
### Step 2: Node 4526 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4521, 4522, 4523, 4524, 4527, 4528
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46411
  - HashJoin_nt1=232303
...
### Step 3: Node 4530 (Index Scan) - LEAF
...
### Step 5: Node 4521 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4522, 4523, 4524, 4526, 4527, 4528
- **Input Features:**
