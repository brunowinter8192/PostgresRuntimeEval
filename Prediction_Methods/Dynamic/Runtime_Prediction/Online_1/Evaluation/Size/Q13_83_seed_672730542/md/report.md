...
```
Node 26287 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26288 (Aggregate) [consumed]
    Node 26289 (Aggregate)
      Node 26290 (Hash Join) [PATTERN: 895c6e8c]
        Node 26291 (Seq Scan) [consumed] - LEAF
        Node 26292 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26287 | 26288, 26290, 26291, 26292 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26290 | 26287, 26288, 26291, 26292 |
...
|------|------|--------|-----------|-----|--------|
| 26287 | Sort | 902.09 | 1079.93 | 19.7% | pattern |
| 26289 | Aggregate | 896.07 | 999.35 | 11.5% | operator |
| 26290 | Hash Join | 690.74 | 470.31 | 31.9% | pattern |
| 26293 | Index Only Scan | 9.69 | 0.00 | 100.0% | operator |
...
### Step 2: Node 26290 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26287, 26288, 26291, 26292
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1481964
...
### Step 4: Node 26287 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26288, 26290, 26291, 26292
- **Input Features:**
