...
**Test Query:** Q18_72_seed_582486201
...
```
Node 30724 (Limit) - ROOT
  Node 30725 (Sort)
    Node 30726 (Aggregate)
      Node 30727 (Gather Merge)
        Node 30728 (Incremental Sort)
          Node 30729 (Nested Loop)
            Node 30730 (Merge Join)
              Node 30731 (Sort)
                Node 30732 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30733 (Seq Scan) [consumed] - LEAF
                  Node 30734 (Hash) [consumed]
                    Node 30735 (Aggregate)
                      Node 30736 (Index Scan) - LEAF
              Node 30737 (Sort)
                Node 30738 (Seq Scan) - LEAF
            Node 30739 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30732 | 30733, 30734 |
...
|------|------|--------|-----------|-----|--------|
| 30724 | Limit | 3093.05 | 1175.21 | 62.0% | operator |
| 30725 | Sort | 2977.97 | 1127.81 | 62.1% | operator |
| 30726 | Aggregate | 2977.93 | 1073.15 | 64.0% | operator |
| 30727 | Gather Merge | 2977.92 | 1073.95 | 63.9% | operator |
| 30728 | Incremental Sort | 2957.63 | 0.00 | 100.0% | operator |
| 30729 | Nested Loop | 2957.57 | 1111.34 | 62.4% | operator |
| 30730 | Merge Join | 2957.52 | 0.00 | 100.0% | operator |
| 30739 | Index Scan | 0.02 | 0.05 | 105.2% | operator |
| 30731 | Sort | 2889.11 | 1095.58 | 62.1% | operator |
| 30737 | Sort | 65.35 | 1074.66 | 1544.5% | operator |
| 30732 | Hash Join | 2889.10 | 471.07 | 83.7% | pattern |
| 30738 | Seq Scan | 53.16 | 18.25 | 65.7% | operator |
| 30735 | Aggregate | 2661.42 | 1073.15 | 59.7% | operator |
| 30736 | Index Scan | 2164.38 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30736 (Index Scan) - LEAF
...
### Step 3: Node 30732 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30733, 30734
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30738 (Seq Scan) - LEAF
...
### Step 7: Node 30730 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30739 (Index Scan) - LEAF
...
### Step 10: Node 30728 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30727 (Gather Merge)
