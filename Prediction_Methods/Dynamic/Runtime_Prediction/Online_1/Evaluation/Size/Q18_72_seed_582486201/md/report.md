        ...
        Node 30728 (Incremental Sort)
          Node 30729 (Nested Loop)
            Node 30730 (Merge Join)
              Node 30731 (Sort)
                Node 30732 (Hash Join)
                  Node 30733 (Seq Scan) - LEAF
                  Node 30734 (Hash)
...
| 30731 | Sort | 2889.11 | 1099.77 | 61.9% | operator |
| 30737 | Sort | 65.35 | 1074.66 | 1544.5% | operator |
| 30732 | Hash Join | 2889.10 | 686.33 | 76.2% | operator |
| 30738 | Seq Scan | 53.16 | 18.25 | 65.7% | operator |
| 30733 | Seq Scan | 198.88 | 170.37 | 14.3% | operator |
| 30734 | Hash | 2661.45 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30733 (Seq Scan) - LEAF
...
### Step 6: Node 30738 (Seq Scan) - LEAF
...
### Step 9: Node 30730 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30739 (Index Scan) - LEAF
...
### Step 11: Node 30729 (Nested Loop)
...
### Step 12: Node 30728 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30727 (Gather Merge)
