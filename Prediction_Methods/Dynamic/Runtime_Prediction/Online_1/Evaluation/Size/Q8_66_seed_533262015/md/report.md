...
**Test Query:** Q8_66_seed_533262015
...
```
Node 15777 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 15778 (Gather Merge) [consumed]
    Node 15779 (Sort)
      Node 15780 (Hash Join)
        Node 15781 (Nested Loop)
          Node 15782 (Hash Join)
            Node 15783 (Nested Loop)
              Node 15784 (Hash Join)
                Node 15785 (Seq Scan) - LEAF
                Node 15786 (Hash) [PATTERN: 444761fb]
                  Node 15787 (Hash Join) [consumed]
                    Node 15788 (Seq Scan) [consumed] - LEAF
                    Node 15789 (Hash) [consumed]
                      Node 15790 (Hash Join) [consumed]
                        Node 15791 (Seq Scan) - LEAF
                        Node 15792 (Hash)
                          Node 15793 (Seq Scan) - LEAF
              Node 15794 (Index Scan) - LEAF
            Node 15795 (Hash)
              Node 15796 (Seq Scan) - LEAF
          Node 15797 (Index Scan) - LEAF
        Node 15798 (Hash)
          Node 15799 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 15786 | 15777, 15778, 15787, 15788, 15789, 15790 |
| Aggregate -> Gather Merge (Out | 2724c080 | 15777 | 15778, 15786, 15787, 15788, 15789, 15790 |
...
|------|------|--------|-----------|-----|--------|
| 15777 | Aggregate | 1223.56 | 1129.87 | 7.7% | pattern |
| 15779 | Sort | 1217.83 | 1046.21 | 14.1% | operator |
| 15780 | Hash Join | 1217.59 | 785.61 | 35.5% | operator |
| 15781 | Nested Loop | 1217.27 | 1198.29 | 1.6% | operator |
| 15798 | Hash | 0.02 | 13.72 | 85675.5% | operator |
| 15782 | Hash Join | 1213.18 | 785.60 | 35.2% | operator |
| 15797 | Index Scan | 0.01 | 12.42 | 206958.1% | operator |
| 15799 | Seq Scan | 0.01 | 6.51 | 54166.4% | operator |
| 15783 | Nested Loop | 1170.43 | 1198.29 | 2.4% | operator |
| 15795 | Hash | 37.65 | 19.97 | 47.0% | operator |
| 15784 | Hash Join | 212.53 | 251.67 | 18.4% | operator |
| 15794 | Index Scan | 0.04 | 2.88 | 6759.2% | operator |
| 15796 | Seq Scan | 37.54 | 48.87 | 30.2% | operator |
| 15785 | Seq Scan | 159.37 | 159.67 | 0.2% | operator |
| 15786 | Hash | 34.68 | 43.51 | 25.5% | pattern |
| 15791 | Seq Scan | 0.01 | 12.22 | 101774.5% | operator |
| 15792 | Hash | 0.08 | 18.14 | 22027.0% | operator |
| 15793 | Seq Scan | 0.08 | 23.36 | 29472.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 15793 (Seq Scan) - LEAF
...
### Step 2: Node 15791 (Seq Scan) - LEAF
...
### Step 4: Node 15785 (Seq Scan) - LEAF
...
### Step 5: Node 15786 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 15777, 15778, 15787, 15788, 15789, 15790
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 15794 (Index Scan) - LEAF
...
### Step 8: Node 15796 (Seq Scan) - LEAF
...
### Step 12: Node 15797 (Index Scan) - LEAF
...
### Step 13: Node 15799 (Seq Scan) - LEAF
...
### Step 14: Node 15781 (Nested Loop)
...
### Step 18: Node 15777 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 15778, 15786, 15787, 15788, 15789, 15790
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2482
