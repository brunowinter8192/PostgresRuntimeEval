...
```
Node 9461 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 9462 (Aggregate) [consumed]
    Node 9463 (Gather Merge) [consumed]
      Node 9464 (Aggregate)
        Node 9465 (Sort) [PATTERN: 3e2d5a00]
          Node 9466 (Hash Join) [consumed]
            Node 9467 (Nested Loop)
              Node 9468 (Hash Join)
                Node 9469 (Seq Scan) - LEAF
                Node 9470 (Hash) [PATTERN: 444761fb]
                  Node 9471 (Hash Join) [consumed]
                    Node 9472 (Seq Scan) [consumed] - LEAF
                    Node 9473 (Hash) [consumed]
                      Node 9474 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 9470 | 9461, 9462, 9463, 9465, 9466, 9471, 9472, 9473, 9474 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 9461 | 9462, 9463, 9465, 9466, 9470, 9471, 9472, 9473, 9474 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 9465 | 9461, 9462, 9463, 9466, 9470, 9471, 9472, 9473, 9474 |
...
|------|------|--------|-----------|-----|--------|
| 9461 | Sort | 1082.16 | 2934.42 | 171.2% | pattern |
| 9464 | Aggregate | 1076.77 | 1128.74 | 4.8% | operator |
| 9465 | Sort | 1076.52 | 1835.96 | 70.5% | pattern |
| 9467 | Nested Loop | 1065.44 | 1188.57 | 11.6% | operator |
| 9479 | Hash | 2.62 | 18.67 | 612.1% | operator |
| 9468 | Hash Join | 207.93 | 253.07 | 21.7% | operator |
| 9478 | Index Scan | 0.07 | -0.22 | 393.4% | operator |
| 9480 | Seq Scan | 2.10 | 12.36 | 487.7% | operator |
| 9469 | Seq Scan | 162.60 | 159.81 | 1.7% | operator |
| 9470 | Hash | 32.24 | 46.85 | 45.3% | pattern |
| 9475 | Seq Scan | 0.01 | 11.81 | 147503.4% | operator |
| 9476 | Hash | 0.11 | 21.05 | 18531.2% | operator |
| 9477 | Seq Scan | 0.11 | 22.93 | 20748.5% | operator |
...
### Step 4: Node 9469 (Seq Scan) - LEAF
...
### Step 5: Node 9470 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 9461, 9462, 9463, 9465, 9466, 9471, 9472, 9473, 9474
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 9478 (Index Scan) - LEAF
...
### Step 8: Node 9480 (Seq Scan) - LEAF
...
### Step 11: Node 9465 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 9461, 9462, 9463, 9466, 9470, 9471, 9472, 9473, 9474
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 9461 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 9462, 9463, 9465, 9466, 9470, 9471, 9472, 9473, 9474
- **Input Features:**
