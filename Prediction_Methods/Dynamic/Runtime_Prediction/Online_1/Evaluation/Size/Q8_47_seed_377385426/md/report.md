...
```
Node 15294 (Aggregate) - ROOT
  Node 15295 (Gather Merge)
    Node 15296 (Sort)
          ...
          Node 15299 (Hash Join)
            Node 15300 (Nested Loop)
              Node 15301 (Hash Join)
                ...
                Node 15303 (Hash)
                  Node 15304 (Hash Join)
                    Node 15305 (Seq Scan) - LEAF
                    Node 15306 (Hash)
                      Node 15307 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 15294 | Aggregate | 1218.65 | 1195.83 | 1.9% | operator |
| 15295 | Gather Merge | 1218.28 | 1097.14 | 9.9% | operator |
...
| 15301 | Hash Join | 208.18 | 251.17 | 20.7% | operator |
...
| 15303 | Hash | 32.03 | 20.62 | 35.6% | operator |
| 15304 | Hash Join | 31.44 | 132.26 | 320.7% | operator |
| 15305 | Seq Scan | 29.83 | 23.03 | 22.8% | operator |
| 15306 | Hash | 0.25 | 23.66 | 9324.7% | operator |
| 15307 | Hash Join | 0.25 | 306.84 | 124125.1% | operator |
...
### Step 5: Node 15305 (Seq Scan) - LEAF
...
### Step 8: Node 15302 (Seq Scan) - LEAF
...
### Step 11: Node 15311 (Index Scan) - LEAF
...
### Step 12: Node 15313 (Seq Scan) - LEAF
...
### Step 13: Node 15300 (Nested Loop)
...
### Step 16: Node 15314 (Index Scan) - LEAF
...
### Step 17: Node 15316 (Seq Scan) - LEAF
...
### Step 18: Node 15298 (Nested Loop)
...
### Step 22: Node 15295 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1044.9419
  - st2=0.0000
  - startup_cost=71547.9700
  - total_cost=71831.2000
- **Output:** st=1093.43, rt=1097.14

### Step 23: Node 15294 (Aggregate) - ROOT
