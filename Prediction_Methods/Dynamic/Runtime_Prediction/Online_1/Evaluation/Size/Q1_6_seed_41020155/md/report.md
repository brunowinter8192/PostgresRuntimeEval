...
```
Node 581 (Aggregate) - ROOT
  Node 582 (Gather Merge)
    Node 583 (Sort) [PATTERN: 1d35fb97]
      Node 584 (Aggregate) [consumed]
        Node 585 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 583 | 584 |
...
|------|------|--------|-----------|-----|--------|
| 581 | Aggregate | 931.63 | 1195.92 | 28.4% | operator |
| 582 | Gather Merge | 931.59 | 1165.91 | 25.2% | operator |
| 583 | Sort | 915.04 | 1200.61 | 31.2% | pattern |
| 585 | Seq Scan | 519.27 | 679.85 | 30.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 585 (Seq Scan) - LEAF
...
### Step 2: Node 583 (Sort) - PATTERN ROOT
...
### Step 4: Node 581 (Aggregate) - ROOT
