...
```
Node 26553 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26554 (Gather) [consumed]
    Node 26555 (Aggregate) [consumed]
      Node 26556 (Hash Join) [consumed]
        Node 26557 (Seq Scan) - LEAF
        Node 26558 (Hash)
          Node 26559 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26553 | 26554, 26555, 26556 |
...
|------|------|--------|-----------|-----|--------|
| 26553 | Aggregate | 823.10 | 857.13 | 4.1% | pattern |
| 26557 | Seq Scan | 751.76 | 758.48 | 0.9% | operator |
| 26558 | Hash | 42.26 | 9.38 | 77.8% | operator |
| 26559 | Seq Scan | 36.73 | 12.70 | 65.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26559 (Seq Scan) - LEAF
...
### Step 2: Node 26557 (Seq Scan) - LEAF
...
### Step 4: Node 26553 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26554, 26555, 26556
- **Input Features:**
