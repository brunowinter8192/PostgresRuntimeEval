...
**Test Query:** Q18_18_seed_139468527
...
```
Node 29764 (Limit) - ROOT
  Node 29765 (Sort)
    Node 29766 (Aggregate)
      Node 29767 (Gather Merge)
        Node 29768 (Incremental Sort)
          Node 29769 (Nested Loop)
            Node 29770 (Merge Join)
              Node 29771 (Sort)
                Node 29772 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29773 (Seq Scan) [consumed] - LEAF
                  Node 29774 (Hash) [consumed]
                    Node 29775 (Aggregate)
                      Node 29776 (Index Scan) - LEAF
              Node 29777 (Sort)
                Node 29778 (Seq Scan) - LEAF
            Node 29779 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29772 | 29773, 29774 |
...
|------|------|--------|-----------|-----|--------|
| 29764 | Limit | 3039.05 | 1175.21 | 61.3% | operator |
| 29765 | Sort | 2922.15 | 1127.81 | 61.4% | operator |
| 29766 | Aggregate | 2922.11 | 1073.15 | 63.3% | operator |
| 29767 | Gather Merge | 2922.09 | 1073.95 | 63.2% | operator |
| 29768 | Incremental Sort | 2885.85 | 0.00 | 100.0% | operator |
| 29769 | Nested Loop | 2885.80 | 1111.34 | 61.5% | operator |
| 29770 | Merge Join | 2885.76 | 0.00 | 100.0% | operator |
| 29779 | Index Scan | 0.02 | 0.05 | 165.5% | operator |
| 29771 | Sort | 2829.84 | 1095.58 | 61.3% | operator |
| 29777 | Sort | 71.46 | 1074.66 | 1403.8% | operator |
| 29772 | Hash Join | 2829.82 | 471.07 | 83.4% | pattern |
| 29778 | Seq Scan | 59.31 | 18.25 | 69.2% | operator |
| 29775 | Aggregate | 2600.78 | 1073.15 | 58.7% | operator |
| 29776 | Index Scan | 2101.00 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29776 (Index Scan) - LEAF
...
### Step 3: Node 29772 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29773, 29774
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29778 (Seq Scan) - LEAF
...
### Step 7: Node 29770 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29779 (Index Scan) - LEAF
...
### Step 10: Node 29768 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29767 (Gather Merge)
