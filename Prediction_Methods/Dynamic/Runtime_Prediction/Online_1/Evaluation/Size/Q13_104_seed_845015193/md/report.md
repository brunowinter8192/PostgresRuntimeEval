...
**Test Query:** Q13_104_seed_845015193
...
```
Node 25398 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25399 (Aggregate) [consumed]
    Node 25400 (Aggregate)
      Node 25401 (Hash Join) [PATTERN: 895c6e8c]
        Node 25402 (Seq Scan) [consumed] - LEAF
        Node 25403 (Hash) [consumed]
          Node 25404 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25398 | 25399, 25401, 25402, 25403 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25401 | 25398, 25399, 25402, 25403 |
...
|------|------|--------|-----------|-----|--------|
| 25398 | Sort | 907.00 | 1079.94 | 19.1% | pattern |
| 25400 | Aggregate | 900.95 | 999.76 | 11.0% | operator |
| 25401 | Hash Join | 691.02 | 470.31 | 31.9% | pattern |
| 25404 | Index Only Scan | 9.59 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25404 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25401 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25398, 25399, 25402, 25403
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 25398 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25399, 25401, 25402, 25403
- **Input Features:**
