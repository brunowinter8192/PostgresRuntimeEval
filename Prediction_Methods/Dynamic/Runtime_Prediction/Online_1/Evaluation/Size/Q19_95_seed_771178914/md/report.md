...
**Test Query:** Q19_95_seed_771178914
...
```
Node 32228 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 32229 (Gather) [consumed]
    Node 32230 (Aggregate) [consumed]
      Node 32231 (Hash Join) [consumed]
        Node 32232 (Seq Scan) - LEAF
        Node 32233 (Hash)
          Node 32234 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 32228 | 32229, 32230, 32231 |
...
|------|------|--------|-----------|-----|--------|
| 32228 | Aggregate | 823.77 | 829.33 | 0.7% | pattern |
| 32232 | Seq Scan | 755.34 | 743.46 | 1.6% | operator |
| 32233 | Hash | 45.77 | 8.29 | 81.9% | operator |
| 32234 | Seq Scan | 45.61 | 23.76 | 47.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 32234 (Seq Scan) - LEAF
...
### Step 2: Node 32232 (Seq Scan) - LEAF
...
### Step 4: Node 32228 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 32229, 32230, 32231
- **Input Features:**
