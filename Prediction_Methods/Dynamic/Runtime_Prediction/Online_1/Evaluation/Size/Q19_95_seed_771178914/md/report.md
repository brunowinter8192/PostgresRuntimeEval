...
```
Node 32228 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 32229 (Gather) [consumed]
    Node 32230 (Aggregate) [consumed]
      Node 32231 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 32228 | 32229, 32230 |
...
|------|------|--------|-----------|-----|--------|
| 32228 | Aggregate | 823.77 | 831.20 | 0.9% | pattern |
| 32231 | Hash Join | 803.05 | 766.06 | 4.6% | operator |
...
### Step 5: Node 32228 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 32229, 32230
- **Input Features:**
