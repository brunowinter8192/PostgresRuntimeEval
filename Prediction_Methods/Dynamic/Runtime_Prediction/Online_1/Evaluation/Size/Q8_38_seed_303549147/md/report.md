...
```
Node 15064 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 15065 (Gather Merge) [consumed]
    Node 15066 (Sort)
          ...
          Node 15069 (Hash Join)
            Node 15070 (Nested Loop)
              Node 15071 (Hash Join)
                ...
                Node 15073 (Hash) [PATTERN: 444761fb]
                  Node 15074 (Hash Join) [consumed]
                    Node 15075 (Seq Scan) [consumed] - LEAF
                    Node 15076 (Hash) [consumed]
                      Node 15077 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 15073 | 15064, 15065, 15074, 15075, 15076, 15077 |
| Aggregate -> Gather Merge (Out | 2724c080 | 15064 | 15065, 15073, 15074, 15075, 15076, 15077 |
...
|------|------|--------|-----------|-----|--------|
| 15064 | Aggregate | 1218.46 | 1128.52 | 7.4% | pattern |
...
| 15071 | Hash Join | 211.18 | 251.67 | 19.2% | operator |
...
| 15073 | Hash | 34.04 | 43.51 | 27.8% | pattern |
...
### Step 4: Node 15072 (Seq Scan) - LEAF
...
### Step 5: Node 15073 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 15064, 15065, 15074, 15075, 15076, 15077
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 15081 (Index Scan) - LEAF
...
### Step 8: Node 15083 (Seq Scan) - LEAF
...
### Step 12: Node 15084 (Index Scan) - LEAF
...
### Step 13: Node 15086 (Seq Scan) - LEAF
...
### Step 14: Node 15068 (Nested Loop)
...
### Step 18: Node 15064 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 15065, 15073, 15074, 15075, 15076, 15077
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2510
  ...
  - Aggregate_sel=0.9586
  - Aggregate_startup_cost=71562.1200
  - Aggregate_total_cost=71957.3900
  - GatherMerge_Outer_np=0
  - GatherMerge_Outer_nt=2510
  ...
  - GatherMerge_Outer_total_cost=71859.0700
- **Output:** st=1125.57, rt=1128.52
