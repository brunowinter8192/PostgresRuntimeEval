    ...
    Node 4763 (Aggregate) [consumed]
      Node 4764 (Gather) [consumed]
        Node 4765 (Nested Loop)
          Node 4766 (Hash Join) [PATTERN: 895c6e8c]
            Node 4767 (Seq Scan) [consumed] - LEAF
            Node 4768 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4761 | 4762, 4763, 4764, 4766, 4767, 4768 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4766 | 4761, 4762, 4763, 4764, 4767, 4768 |
...
| 4765 | Nested Loop | 1217.94 | 1193.31 | 2.0% | operator |
| 4766 | Hash Join | 211.61 | 242.53 | 14.6% | pattern |
...
### Step 2: Node 4766 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4761, 4762, 4763, 4764, 4767, 4768
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47319
  - HashJoin_nt1=235479
  ...
  - HashJoin_total_cost=37340.7800
  - Hash_Inner_np=0
  - Hash_Inner_nt=12559
...
### Step 3: Node 4770 (Index Scan) - LEAF
...
- **Output:** st=122.04, rt=1193.31

### Step 5: Node 4761 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4762, 4763, 4764, 4766, 4767, 4768
- **Input Features:**
