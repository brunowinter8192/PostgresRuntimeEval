...
Node 651 (Aggregate) - ROOT
  Node 652 (Gather Merge)
    Node 653 (Sort) [PATTERN: 1d35fb97]
      Node 654 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 653 | 654 |
...
|------|------|--------|-----------|-----|--------|
| 651 | Aggregate | 975.26 | 1195.93 | 22.6% | operator |
| 652 | Gather Merge | 975.21 | 1165.92 | 19.6% | operator |
| 653 | Sort | 958.41 | 1200.65 | 25.3% | pattern |
...
### Step 2: Node 653 (Sort) - PATTERN ROOT
...
### Step 4: Node 651 (Aggregate) - ROOT
