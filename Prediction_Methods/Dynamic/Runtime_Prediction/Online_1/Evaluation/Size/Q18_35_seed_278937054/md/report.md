...
```
Node 30068 (Limit) - ROOT
  Node 30069 (Sort)
    Node 30070 (Aggregate)
      Node 30071 (Gather Merge)
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30076 | 30077, 30078 |
...
|------|------|--------|-----------|-----|--------|
| 30068 | Limit | 3022.57 | 1175.21 | 61.1% | operator |
| 30069 | Sort | 2907.98 | 1127.81 | 61.2% | operator |
| 30070 | Aggregate | 2907.94 | 1073.15 | 63.1% | operator |
| 30071 | Gather Merge | 2907.92 | 1073.95 | 63.1% | operator |
| 30072 | Incremental Sort | 2887.70 | 0.00 | 100.0% | operator |
| 30073 | Nested Loop | 2887.62 | 1111.34 | 61.5% | operator |
| 30074 | Merge Join | 2887.55 | 0.00 | 100.0% | operator |
| 30083 | Index Scan | 0.02 | 0.05 | 96.2% | operator |
| 30075 | Sort | 2813.63 | 1095.58 | 61.1% | operator |
| 30081 | Sort | 70.70 | 1074.66 | 1420.1% | operator |
| 30076 | Hash Join | 2813.62 | 471.07 | 83.3% | pattern |
| 30082 | Seq Scan | 57.97 | 18.25 | 68.5% | operator |
| 30079 | Aggregate | 2588.55 | 1073.15 | 58.5% | operator |
| 30080 | Index Scan | 2111.19 | 0.00 | 100.0% | operator |
...
### Step 10: Node 30072 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30071 (Gather Merge)
