...
**Test Query:** Q13_19_seed_147672558
...
```
Node 25790 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25791 (Aggregate) [consumed]
    Node 25792 (Aggregate)
      Node 25793 (Hash Join) [PATTERN: 895c6e8c]
        Node 25794 (Seq Scan) [consumed] - LEAF
        Node 25795 (Hash) [consumed]
          Node 25796 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25790 | 25791, 25793, 25794, 25795 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25793 | 25790, 25791, 25794, 25795 |
...
|------|------|--------|-----------|-----|--------|
| 25790 | Sort | 929.51 | 1079.93 | 16.2% | pattern |
| 25792 | Aggregate | 923.35 | 999.55 | 8.3% | operator |
| 25793 | Hash Join | 713.85 | 470.31 | 34.1% | pattern |
| 25796 | Index Only Scan | 10.27 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25796 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25793 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25790, 25791, 25794, 25795
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1484970
...
### Step 4: Node 25790 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25791, 25793, 25794, 25795
- **Input Features:**
