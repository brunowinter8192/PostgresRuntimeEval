...
```
Node 25790 (Sort) - ROOT
  Node 25791 (Aggregate)
    Node 25792 (Aggregate)
      Node 25793 (Hash Join)
        Node 25794 (Seq Scan) - LEAF
        Node 25795 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 25790 | Sort | 929.51 | 1081.93 | 16.4% | operator |
| 25791 | Aggregate | 929.49 | 1000.34 | 7.6% | operator |
| 25792 | Aggregate | 923.35 | 1014.18 | 9.8% | operator |
| 25793 | Hash Join | 713.85 | 787.83 | 10.4% | operator |
| 25794 | Seq Scan | 504.98 | 264.12 | 47.7% | operator |
| 25795 | Hash | 15.58 | 80.15 | 414.3% | operator |
...
### Step 2: Node 25794 (Seq Scan) - LEAF
