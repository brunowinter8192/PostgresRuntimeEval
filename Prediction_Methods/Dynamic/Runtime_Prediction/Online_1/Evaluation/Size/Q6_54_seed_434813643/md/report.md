...
**Test Query:** Q6_54_seed_434813643
...
```
Node 10297 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10298 (Gather) [consumed]
    Node 10299 (Aggregate) [consumed]
      Node 10300 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10297 | 10298, 10299 |
...
|------|------|--------|-----------|-----|--------|
| 10297 | Aggregate | 776.35 | 850.07 | 9.5% | pattern |
| 10300 | Seq Scan | 755.39 | 748.54 | 0.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10300 (Seq Scan) - LEAF
...
### Step 2: Node 10297 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10298, 10299
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=23866
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=32
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=139724.8000
  - Aggregate_Outer_total_cost=139724.8100
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=140725.3400
  - Aggregate_total_cost=140725.3500
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=140724.8000
  - Gather_Outer_total_cost=140725.3100
