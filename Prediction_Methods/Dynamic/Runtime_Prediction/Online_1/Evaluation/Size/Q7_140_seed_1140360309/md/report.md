...
**Test Query:** Q7_140_seed_1140360309
...
```
Node 11293 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 11294 (Gather Merge) [consumed]
    Node 11295 (Sort)
      Node 11296 (Hash Join)
        Node 11297 (Nested Loop)
          Node 11298 (Hash Join) [PATTERN: 895c6e8c]
            Node 11299 (Seq Scan) [consumed] - LEAF
            Node 11300 (Hash) [consumed]
              Node 11301 (Hash Join) [PATTERN: f4cb205a]
                Node 11302 (Seq Scan) [consumed] - LEAF
                Node 11303 (Hash) [consumed]
                  Node 11304 (Seq Scan) [consumed] - LEAF
          Node 11305 (Index Scan) - LEAF
        Node 11306 (Hash)
          Node 11307 (Hash Join) [PATTERN: f4cb205a]
            Node 11308 (Seq Scan) [consumed] - LEAF
            Node 11309 (Hash) [consumed]
              Node 11310 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 11301 | 11293, 11294, 11298, 11299, 11300, 11302, 11303, 11304, 11307, 11308, 11309, 11310 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 11307 | 11293, 11294, 11298, 11299, 11300, 11301, 11302, 11303, 11304, 11308, 11309, 11310 |
| Aggregate -> Gather Merge (Out | 2724c080 | 11293 | 11294, 11298, 11299, 11300, 11301, 11302, 11303, 11304, 11307, 11308, 11309, 11310 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 11298 | 11293, 11294, 11299, 11300, 11301, 11302, 11303, 11304, 11307, 11308, 11309, 11310 |
...
|------|------|--------|-----------|-----|--------|
| 11293 | Aggregate | 1216.99 | 1163.13 | 4.4% | pattern |
| 11295 | Sort | 1210.74 | 1109.16 | 8.4% | operator |
| 11296 | Hash Join | 1210.10 | 843.11 | 30.3% | operator |
| 11297 | Nested Loop | 1202.83 | 1215.99 | 1.1% | operator |
| 11306 | Hash | 3.58 | 27.74 | 675.4% | operator |
| 11298 | Hash Join | 213.54 | 304.89 | 42.8% | pattern |
| 11305 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 11307 | Hash Join | 3.53 | 429.36 | 12059.8% | pattern |
| 11301 | Hash Join | 37.02 | 429.38 | 1059.9% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11301 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 11293, 11294, 11298, 11299, 11300, 11302, 11303, 11304, 11307, 11308, 11309, 11310
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5000
  - HashJoin_nt1=62500
...
### Step 2: Node 11298 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 11293, 11294, 11299, 11300, 11301, 11302, 11303, 11304, 11307, 11308, 11309, 11310
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=38710
  - HashJoin_nt1=483871
...
### Step 3: Node 11305 (Index Scan) - LEAF
...
### Step 4: Node 11307 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 11293, 11294, 11298, 11299, 11300, 11301, 11302, 11303, 11304, 11308, 11309, 11310
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=800
  - HashJoin_nt1=10000
...
### Step 9: Node 11293 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 11294, 11298, 11299, 11300, 11301, 11302, 11303, 11304, 11307, 11308, 11309, 11310
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
