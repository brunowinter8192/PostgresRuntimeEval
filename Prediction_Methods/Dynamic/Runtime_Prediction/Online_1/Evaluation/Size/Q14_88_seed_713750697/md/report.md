...
**Test Query:** Q14_88_seed_713750697
...
```
Node 27372 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27373 (Gather) [consumed]
    Node 27374 (Aggregate) [consumed]
      Node 27375 (Hash Join) [consumed]
        Node 27376 (Seq Scan) - LEAF
        Node 27377 (Hash)
          Node 27378 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27372 | 27373, 27374, 27375 |
...
|------|------|--------|-----------|-----|--------|
| 27372 | Aggregate | 837.80 | 857.12 | 2.3% | pattern |
| 27376 | Seq Scan | 765.40 | 758.47 | 0.9% | operator |
| 27377 | Hash | 42.16 | 9.38 | 77.8% | operator |
| 27378 | Seq Scan | 36.51 | 12.70 | 65.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27378 (Seq Scan) - LEAF
...
### Step 2: Node 27376 (Seq Scan) - LEAF
...
### Step 4: Node 27372 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27373, 27374, 27375
- **Input Features:**
