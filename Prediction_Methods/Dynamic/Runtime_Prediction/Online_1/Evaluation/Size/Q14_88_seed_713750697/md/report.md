...
```
Node 27372 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27373 (Gather) [consumed]
    Node 27374 (Aggregate) [consumed]
      Node 27375 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27372 | 27373, 27374 |
...
|------|------|--------|-----------|-----|--------|
| 27372 | Aggregate | 837.80 | 848.35 | 1.3% | pattern |
| 27375 | Hash Join | 815.24 | 807.63 | 0.9% | operator |
...
### Step 5: Node 27372 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27373, 27374
- **Input Features:**
