    ...
    Node 20789 (Aggregate) [consumed]
      Node 20790 (Gather) [consumed]
        Node 20791 (Hash Join)
          Node 20792 (Hash Join)
            Node 20793 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20787 | 20788, 20789, 20790 |
...
| 20791 | Hash Join | 1110.18 | 1007.26 | 9.3% | operator |
| 20792 | Hash Join | 1107.25 | 1004.20 | 9.3% | operator |
| 20798 | Hash | 0.01 | 15.71 | 112119.8% | operator |
| 20793 | Nested Loop | 1058.29 | 1204.78 | 13.8% | operator |
| 20796 | Hash | 36.37 | 55.57 | 52.8% | operator |
...
### Step 6: Node 20799 (Seq Scan) - LEAF
...
### Step 10: Node 20787 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20788, 20789, 20790
- **Input Features:**
