...
**Test Query:** Q3_106_seed_861423255
...
```
Node 4411 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 4412 (Sort) [consumed]
    Node 4413 (Aggregate) [consumed]
      Node 4414 (Gather) [consumed]
        Node 4415 (Nested Loop)
          Node 4416 (Hash Join) [PATTERN: 895c6e8c]
            Node 4417 (Seq Scan) [consumed] - LEAF
            Node 4418 (Hash) [consumed]
              Node 4419 (Seq Scan) - LEAF
          Node 4420 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4411 | 4412, 4413, 4414, 4416, 4417, 4418 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4416 | 4411, 4412, 4413, 4414, 4417, 4418 |
...
|------|------|--------|-----------|-----|--------|
| 4411 | Limit | 1208.74 | 1151.18 | 4.8% | pattern |
| 4415 | Nested Loop | 1172.62 | 1193.29 | 1.8% | operator |
| 4416 | Hash Join | 209.62 | 242.52 | 15.7% | pattern |
| 4420 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4419 | Seq Scan | 26.31 | 38.57 | 46.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4419 (Seq Scan) - LEAF
...
### Step 2: Node 4416 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4411, 4412, 4413, 4414, 4417, 4418
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47282
  - HashJoin_nt1=236664
...
### Step 3: Node 4420 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=73088.1900
- **Output:** st=122.04, rt=1193.29

### Step 5: Node 4411 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4412, 4413, 4414, 4416, 4417, 4418
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=313754
  - Aggregate_Outer_nt1=313754
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110169.9000
  - Aggregate_Outer_total_cost=114091.8200
  - Gather_Outer_np=0
  - Gather_Outer_nt=313754
  - Gather_Outer_nt1=101211
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105463.5900
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=313754
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=120871.9300
  - Limit_total_cost=120871.9600
  - Sort_Outer_np=0
  - Sort_Outer_nt=313754
  - Sort_Outer_nt1=313754
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=120871.9300
  - Sort_Outer_total_cost=121656.3200
