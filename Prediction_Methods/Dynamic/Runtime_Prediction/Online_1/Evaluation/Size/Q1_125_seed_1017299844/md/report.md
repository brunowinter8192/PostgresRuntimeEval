...
Node 136 (Aggregate) - ROOT
  Node 137 (Gather Merge)
    Node 138 (Sort) [PATTERN: 1d35fb97]
      Node 139 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 138 | 139 |
...
|------|------|--------|-----------|-----|--------|
| 136 | Aggregate | 932.02 | 1195.95 | 28.3% | operator |
| 137 | Gather Merge | 931.94 | 1165.92 | 25.1% | operator |
| 138 | Sort | 911.10 | 1200.73 | 31.8% | pattern |
...
### Step 2: Node 138 (Sort) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Aggregate_Outer_nt1=1186114
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=236
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=169117.0300
  - Aggregate_Outer_total_cost=169117.1600
  - Sort_np=0
  - Sort_nt=6
  - Sort_nt1=6
  - Sort_nt2=0
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=169117.2400
  - Sort_total_cost=169117.2600
- **Output:** st=1196.64, rt=1200.73

### Step 3: Node 137 (Gather Merge)
...
### Step 4: Node 136 (Aggregate) - ROOT
