...
**Test Query:** Q1_88_seed_713750697
...
```
Node 681 (Aggregate) - ROOT
  Node 682 (Gather Merge)
    Node 683 (Sort) [PATTERN: 1d35fb97]
      Node 684 (Aggregate) [consumed]
        Node 685 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 683 | 684 |
...
|------|------|--------|-----------|-----|--------|
| 681 | Aggregate | 996.91 | 1195.73 | 19.9% | operator |
| 682 | Gather Merge | 996.88 | 1165.86 | 17.0% | operator |
| 683 | Sort | 979.94 | 1199.90 | 22.4% | pattern |
| 685 | Seq Scan | 571.60 | 682.56 | 19.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 685 (Seq Scan) - LEAF
...
### Step 2: Node 683 (Sort) - PATTERN ROOT
...
### Step 4: Node 681 (Aggregate) - ROOT
