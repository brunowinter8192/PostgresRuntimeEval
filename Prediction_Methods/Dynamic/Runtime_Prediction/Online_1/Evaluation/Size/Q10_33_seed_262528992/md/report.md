...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20358 | 20359, 20360, 20361, 20363, 20364, 20367 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 20363 | 20358, 20359, 20360, 20361, 20364, 20367 |
...
|------|------|--------|-----------|-----|--------|
| 20358 | Limit | 1139.07 | 1199.47 | 5.3% | pattern |
| 20362 | Hash Join | 1083.94 | 1095.48 | 1.1% | operator |
| 20363 | Hash Join | 1080.90 | 1120.19 | 3.6% | pattern |
| 20369 | Hash | 0.01 | 15.71 | 120752.1% | operator |
| 20370 | Seq Scan | 0.01 | 6.98 | 77441.2% | operator |
| 20365 | Seq Scan | 160.11 | 159.74 | 0.2% | operator |
| 20366 | Index Scan | 0.06 | -0.52 | 935.9% | operator |
| 20368 | Seq Scan | 25.17 | 26.64 | 5.8% | operator |
...
- **Consumes:** Nodes 20358, 20359, 20360, 20361, 20364, 20367
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=17901
  - HashJoin_nt1=17901
...
### Step 8: Node 20358 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20359, 20360, 20361, 20363, 20364, 20367
- **Input Features:**
