    ...
    Node 5533 (Aggregate) [consumed]
      Node 5534 (Gather) [consumed]
        Node 5535 (Nested Loop)
          Node 5536 (Hash Join) [PATTERN: 895c6e8c]
            Node 5537 (Seq Scan) [consumed] - LEAF
            Node 5538 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5531 | 5532, 5533, 5534, 5536, 5537, 5538 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5536 | 5531, 5532, 5533, 5534, 5537, 5538 |
...
|------|------|--------|-----------|-----|--------|
| 5531 | Limit | 1188.72 | 1151.18 | 3.2% | pattern |
| 5535 | Nested Loop | 1150.80 | 1192.58 | 3.6% | operator |
| 5536 | Hash Join | 206.25 | 242.38 | 17.5% | pattern |
| 5540 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5539 | Seq Scan | 28.54 | 38.60 | 35.3% | operator |
...
### Step 2: Node 5536 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5531, 5532, 5533, 5534, 5537, 5538
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46189
  - HashJoin_nt1=232872
  ...
  - HashJoin_total_cost=37331.9100
  - Hash_Inner_np=0
  - Hash_Inner_nt=12397
...
- **Output:** st=121.36, rt=1192.58

### Step 5: Node 5531 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5532, 5533, 5534, 5536, 5537, 5538
- **Input Features:**
