        ...
        Node 28856 (Incremental Sort)
          Node 28857 (Nested Loop)
            Node 28858 (Merge Join)
              Node 28859 (Sort)
                Node 28860 (Hash Join)
                  Node 28861 (Seq Scan) - LEAF
                  Node 28862 (Hash)
...
| 28859 | Sort | 2852.11 | 1099.77 | 61.4% | operator |
| 28865 | Sort | 64.20 | 1074.66 | 1573.8% | operator |
| 28860 | Hash Join | 2852.09 | 686.33 | 75.9% | operator |
| 28866 | Seq Scan | 51.90 | 18.25 | 64.8% | operator |
| 28861 | Seq Scan | 202.02 | 170.37 | 15.7% | operator |
| 28862 | Hash | 2621.70 | 21.04 | 99.2% | operator |
...
### Step 3: Node 28861 (Seq Scan) - LEAF
...
### Step 6: Node 28866 (Seq Scan) - LEAF
...
### Step 9: Node 28858 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 28867 (Index Scan) - LEAF
...
### Step 11: Node 28857 (Nested Loop)
...
### Step 12: Node 28856 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 28855 (Gather Merge)
