...
**Test Query:** Q18_102_seed_828607131
...
```
Node 28852 (Limit) - ROOT
  Node 28853 (Sort)
    Node 28854 (Aggregate)
      Node 28855 (Gather Merge)
        Node 28856 (Incremental Sort)
          Node 28857 (Nested Loop)
            Node 28858 (Merge Join)
              Node 28859 (Sort)
                Node 28860 (Hash Join) [PATTERN: 895c6e8c]
                  Node 28861 (Seq Scan) [consumed] - LEAF
                  Node 28862 (Hash) [consumed]
                    Node 28863 (Aggregate)
                      Node 28864 (Index Scan) - LEAF
              Node 28865 (Sort)
                Node 28866 (Seq Scan) - LEAF
            Node 28867 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 28860 | 28861, 28862 |
...
|------|------|--------|-----------|-----|--------|
| 28852 | Limit | 3059.25 | 1175.21 | 61.6% | operator |
| 28853 | Sort | 2940.16 | 1127.81 | 61.6% | operator |
| 28854 | Aggregate | 2940.12 | 1073.15 | 63.5% | operator |
| 28855 | Gather Merge | 2940.11 | 1073.95 | 63.5% | operator |
| 28856 | Incremental Sort | 2919.55 | 0.00 | 100.0% | operator |
| 28857 | Nested Loop | 2919.50 | 1111.34 | 61.9% | operator |
| 28858 | Merge Join | 2919.44 | 0.00 | 100.0% | operator |
| 28867 | Index Scan | 0.02 | 0.05 | 105.2% | operator |
| 28859 | Sort | 2852.11 | 1095.58 | 61.6% | operator |
| 28865 | Sort | 64.20 | 1074.66 | 1573.8% | operator |
| 28860 | Hash Join | 2852.09 | 471.07 | 83.5% | pattern |
| 28866 | Seq Scan | 51.90 | 18.25 | 64.8% | operator |
| 28863 | Aggregate | 2621.66 | 1073.15 | 59.1% | operator |
| 28864 | Index Scan | 2134.08 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 28864 (Index Scan) - LEAF
...
### Step 3: Node 28860 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 28861, 28862
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 28866 (Seq Scan) - LEAF
...
### Step 7: Node 28858 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 28867 (Index Scan) - LEAF
...
### Step 10: Node 28856 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 28855 (Gather Merge)
