...
```
Node 10915 (Aggregate) - ROOT
  Node 10916 (Gather Merge)
    Node 10917 (Sort)
      Node 10918 (Hash Join)
        Node 10919 (Nested Loop)
          Node 10920 (Hash Join)
            Node 10921 (Seq Scan) - LEAF
            Node 10922 (Hash)
              Node 10923 (Hash Join)
                Node 10924 (Seq Scan) - LEAF
                Node 10925 (Hash)
                  Node 10926 (Seq Scan) - LEAF
          Node 10927 (Index Scan) - LEAF
        Node 10928 (Hash)
          Node 10929 (Hash Join)
            Node 10930 (Seq Scan) - LEAF
            Node 10931 (Hash)
              Node 10932 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 10915 | Aggregate | 1198.38 | 1209.26 | 0.9% | operator |
| 10916 | Gather Merge | 1197.38 | 1142.98 | 4.5% | operator |
| 10917 | Sort | 1191.52 | 1109.13 | 6.9% | operator |
| 10918 | Hash Join | 1190.92 | 842.59 | 29.2% | operator |
| 10919 | Nested Loop | 1184.19 | 1216.16 | 2.7% | operator |
| 10928 | Hash | 3.13 | 17.53 | 460.8% | operator |
| 10920 | Hash Join | 212.97 | 384.47 | 80.5% | operator |
| 10927 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 10929 | Hash Join | 3.08 | 85.17 | 2664.5% | operator |
| 10921 | Seq Scan | 151.82 | 201.16 | 32.5% | operator |
| 10922 | Hash | 35.90 | 19.59 | 45.4% | operator |
| 10930 | Seq Scan | 2.68 | 11.47 | 327.9% | operator |
| 10931 | Hash | 0.08 | 16.89 | 21017.6% | operator |
| 10923 | Hash Join | 35.12 | 92.20 | 162.5% | operator |
| 10932 | Seq Scan | 0.08 | 45.79 | 59370.5% | operator |
| 10924 | Seq Scan | 33.99 | 21.86 | 35.7% | operator |
| 10925 | Hash | 0.01 | 16.89 | 187612.0% | operator |
| 10926 | Seq Scan | 0.01 | 45.79 | 763105.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10926 (Seq Scan) - LEAF
...
### Step 2: Node 10924 (Seq Scan) - LEAF
...
### Step 5: Node 10932 (Seq Scan) - LEAF
...
### Step 6: Node 10921 (Seq Scan) - LEAF
...
### Step 8: Node 10930 (Seq Scan) - LEAF
...
### Step 11: Node 10927 (Index Scan) - LEAF
...
### Step 13: Node 10919 (Nested Loop)
...
### Step 17: Node 10916 (Gather Merge)
...
### Step 18: Node 10915 (Aggregate) - ROOT
