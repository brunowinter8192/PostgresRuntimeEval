...
**Test Query:** Q13_130_seed_1058319999
...
```
Node 25601 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25602 (Aggregate) [consumed]
    Node 25603 (Aggregate)
      Node 25604 (Hash Join) [PATTERN: 895c6e8c]
        Node 25605 (Seq Scan) [consumed] - LEAF
        Node 25606 (Hash) [consumed]
          Node 25607 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25601 | 25602, 25604, 25605, 25606 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25604 | 25601, 25602, 25605, 25606 |
...
|------|------|--------|-----------|-----|--------|
| 25601 | Sort | 924.80 | 1079.93 | 16.8% | pattern |
| 25603 | Aggregate | 918.72 | 999.15 | 8.8% | operator |
| 25604 | Hash Join | 711.93 | 470.31 | 33.9% | pattern |
| 25607 | Index Only Scan | 9.94 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25607 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25604 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25601, 25602, 25605, 25606
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1478958
...
### Step 4: Node 25601 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25602, 25604, 25605, 25606
- **Input Features:**
