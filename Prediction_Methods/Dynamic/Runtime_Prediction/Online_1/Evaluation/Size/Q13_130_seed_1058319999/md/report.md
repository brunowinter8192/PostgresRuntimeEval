...
```
Node 25601 (Sort) - ROOT
  Node 25602 (Aggregate)
    Node 25603 (Aggregate)
      Node 25604 (Hash Join)
        Node 25605 (Seq Scan) - LEAF
        Node 25606 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 25601 | Sort | 924.80 | 1081.93 | 17.0% | operator |
| 25602 | Aggregate | 924.78 | 1000.36 | 8.2% | operator |
| 25603 | Aggregate | 918.72 | 1013.77 | 10.3% | operator |
| 25604 | Hash Join | 711.93 | 787.83 | 10.7% | operator |
| 25605 | Seq Scan | 504.31 | 263.97 | 47.7% | operator |
| 25606 | Hash | 15.28 | 80.15 | 424.7% | operator |
...
### Step 2: Node 25605 (Seq Scan) - LEAF
