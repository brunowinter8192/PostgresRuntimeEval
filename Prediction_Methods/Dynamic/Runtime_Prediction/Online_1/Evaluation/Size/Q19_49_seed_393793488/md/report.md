...
**Test Query:** Q19_49_seed_393793488
...
```
Node 31871 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31872 (Gather) [consumed]
    Node 31873 (Aggregate) [consumed]
      Node 31874 (Hash Join) [consumed]
        Node 31875 (Seq Scan) - LEAF
        Node 31876 (Hash)
          Node 31877 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31871 | 31872, 31873, 31874 |
...
|------|------|--------|-----------|-----|--------|
| 31871 | Aggregate | 842.59 | 829.28 | 1.6% | pattern |
| 31875 | Seq Scan | 774.23 | 743.46 | 4.0% | operator |
| 31876 | Hash | 45.67 | 8.29 | 81.9% | operator |
| 31877 | Seq Scan | 45.52 | 23.76 | 47.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31877 (Seq Scan) - LEAF
...
### Step 2: Node 31875 (Seq Scan) - LEAF
...
### Step 4: Node 31871 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31872, 31873, 31874
- **Input Features:**
  ...
  - HashJoin_Outer_total_cost=156338.4300
