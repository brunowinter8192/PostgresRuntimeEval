...
```
Node 26924 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26925 (Gather) [consumed]
    Node 26926 (Aggregate) [consumed]
      Node 26927 (Hash Join)
        Node 26928 (Seq Scan) - LEAF
        Node 26929 (Hash)
          Node 26930 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26924 | 26925, 26926 |
...
|------|------|--------|-----------|-----|--------|
| 26924 | Aggregate | 819.86 | 848.38 | 3.5% | pattern |
| 26927 | Hash Join | 797.87 | 807.67 | 1.2% | operator |
| 26928 | Seq Scan | 744.81 | 758.51 | 1.8% | operator |
| 26929 | Hash | 42.75 | 9.38 | 78.1% | operator |
| 26930 | Seq Scan | 37.04 | 12.70 | 65.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26930 (Seq Scan) - LEAF
...
### Step 2: Node 26928 (Seq Scan) - LEAF
...
### Step 5: Node 26924 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26925, 26926
- **Input Features:**
