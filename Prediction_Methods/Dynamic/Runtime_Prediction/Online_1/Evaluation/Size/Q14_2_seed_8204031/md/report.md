...
```
Node 26924 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26925 (Gather) [consumed]
    Node 26926 (Aggregate) [consumed]
      Node 26927 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26924 | 26925, 26926, 26927 |
...
|------|------|--------|-----------|-----|--------|
| 26924 | Aggregate | 819.86 | 857.14 | 4.5% | pattern |
...
### Step 4: Node 26924 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26925, 26926, 26927
- **Input Features:**
