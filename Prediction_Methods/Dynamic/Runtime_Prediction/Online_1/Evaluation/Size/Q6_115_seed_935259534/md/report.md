...
**Test Query:** Q6_115_seed_935259534
**Timestamp:** 2026-01-18 17:38:46
...
```
Node 9965 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 9966 (Gather) [consumed]
    Node 9967 (Aggregate) [consumed]
      Node 9968 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 9965 | 9966, 9967 |
...
|------|------|--------|-----------|-----|--------|
| 9965 | Aggregate | 787.68 | 850.07 | 7.9% | pattern |
| 9968 | Seq Scan | 767.18 | 748.54 | 2.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 9968 (Seq Scan) - LEAF
...
### Step 2: Node 9965 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 9966, 9967
- **Input Features:**
