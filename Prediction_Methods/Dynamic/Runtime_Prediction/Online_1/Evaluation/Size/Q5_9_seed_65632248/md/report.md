...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 9890 | 9881, 9882, 9883, 9885, 9886, 9891, 9892, 9893, 9894 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 9881 | 9882, 9883, 9885, 9886, 9890, 9891, 9892, 9893, 9894 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 9885 | 9881, 9882, 9883, 9886, 9890, 9891, 9892, 9893, 9894 |
...
|------|------|--------|-----------|-----|--------|
| 9881 | Sort | 1068.79 | 2934.42 | 174.6% | pattern |
| 9884 | Aggregate | 1063.53 | 1128.76 | 6.1% | operator |
| 9885 | Sort | 1063.28 | 1835.93 | 72.7% | pattern |
| 9887 | Nested Loop | 1051.11 | 1188.47 | 13.1% | operator |
| 9899 | Hash | 3.66 | 18.67 | 410.6% | operator |
| 9888 | Hash Join | 212.74 | 253.07 | 19.0% | operator |
| 9898 | Index Scan | 0.07 | -0.22 | 401.4% | operator |
| 9900 | Seq Scan | 3.12 | 12.36 | 296.6% | operator |
| 9889 | Seq Scan | 164.75 | 159.81 | 3.0% | operator |
| 9890 | Hash | 34.18 | 46.85 | 37.1% | pattern |
| 9895 | Seq Scan | 0.01 | 11.81 | 131103.0% | operator |
| 9896 | Hash | 0.06 | 21.05 | 37495.1% | operator |
| 9897 | Seq Scan | 0.05 | 22.93 | 43170.4% | operator |
...
### Step 2: Node 9895 (Seq Scan) - LEAF
...
### Step 4: Node 9889 (Seq Scan) - LEAF
...
### Step 5: Node 9890 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 9881, 9882, 9883, 9885, 9886, 9891, 9892, 9893, 9894
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 9898 (Index Scan) - LEAF
...
### Step 8: Node 9900 (Seq Scan) - LEAF
...
### Step 11: Node 9885 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 9881, 9882, 9883, 9886, 9890, 9891, 9892, 9893, 9894
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 9881 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 9882, 9883, 9885, 9886, 9890, 9891, 9892, 9893, 9894
- **Input Features:**
