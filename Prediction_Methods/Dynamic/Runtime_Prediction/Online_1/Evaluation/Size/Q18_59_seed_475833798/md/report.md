...
```
Node 30484 (Limit) - ROOT
  Node 30485 (Sort)
    Node 30486 (Aggregate)
      Node 30487 (Gather Merge)
        Node 30488 (Incremental Sort)
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30492 | 30493, 30494 |
...
|------|------|--------|-----------|-----|--------|
| 30484 | Limit | 3042.77 | 1175.21 | 61.4% | operator |
| 30485 | Sort | 2925.48 | 1127.81 | 61.4% | operator |
| 30486 | Aggregate | 2925.44 | 1073.15 | 63.3% | operator |
| 30487 | Gather Merge | 2925.42 | 1073.95 | 63.3% | operator |
| 30488 | Incremental Sort | 2889.46 | 0.00 | 100.0% | operator |
| 30489 | Nested Loop | 2889.40 | 1111.34 | 61.5% | operator |
| 30490 | Merge Join | 2889.36 | 0.00 | 100.0% | operator |
| 30499 | Index Scan | 0.02 | 0.05 | 165.5% | operator |
| 30491 | Sort | 2840.01 | 1095.58 | 61.4% | operator |
| 30497 | Sort | 63.61 | 1074.66 | 1589.5% | operator |
| 30492 | Hash Join | 2840.01 | 471.07 | 83.4% | pattern |
| 30498 | Seq Scan | 52.71 | 18.25 | 65.4% | operator |
| 30495 | Aggregate | 2616.26 | 1073.15 | 59.0% | operator |
| 30496 | Index Scan | 2090.93 | 0.00 | 100.0% | operator |
...
### Step 10: Node 30488 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30487 (Gather Merge)
