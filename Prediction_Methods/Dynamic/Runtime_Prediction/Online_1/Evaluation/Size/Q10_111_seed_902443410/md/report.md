...
```
Node 19526 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 19527 (Sort) [consumed]
    Node 19528 (Aggregate) [consumed]
      Node 19529 (Gather) [consumed]
        Node 19530 (Hash Join)
          Node 19531 (Hash Join)
            Node 19532 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19526 | 19527, 19528, 19529 |
...
|------|------|--------|-----------|-----|--------|
| 19526 | Limit | 1156.23 | 1199.47 | 3.7% | pattern |
| 19530 | Hash Join | 1101.85 | 1006.93 | 8.6% | operator |
| 19531 | Hash Join | 1098.96 | 1003.66 | 8.7% | operator |
| 19537 | Hash | 0.01 | 15.71 | 120752.1% | operator |
| 19532 | Nested Loop | 1051.81 | 1204.98 | 14.6% | operator |
| 19535 | Hash | 37.12 | 55.57 | 49.7% | operator |
| 19538 | Seq Scan | 0.01 | 6.98 | 77441.2% | operator |
| 19533 | Seq Scan | 160.23 | 159.73 | 0.3% | operator |
| 19534 | Index Scan | 0.06 | -0.52 | 935.9% | operator |
| 19536 | Seq Scan | 27.14 | 26.64 | 1.9% | operator |
...
- **Input Features:**
  ...
  - st2=0.0265
  - startup_cost=0.4300
  - total_cost=76293.8700
- **Output:** st=124.96, rt=1204.98

### Step 5: Node 19535 (Hash)
...
### Step 6: Node 19538 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=81349.3600
- **Output:** st=109.79, rt=1003.66

### Step 8: Node 19537 (Hash)
...
- **Output:** st=98.99, rt=1006.93

### Step 10: Node 19526 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19527, 19528, 19529
- **Input Features:**
