...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26084 | 26085, 26087, 26088, 26089 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26087 | 26084, 26085, 26088, 26089 |
...
|------|------|--------|-----------|-----|--------|
| 26084 | Sort | 902.81 | 1079.94 | 19.6% | pattern |
| 26086 | Aggregate | 896.84 | 999.76 | 11.5% | operator |
| 26087 | Hash Join | 682.56 | 470.31 | 31.1% | pattern |
| 26090 | Index Only Scan | 10.41 | 0.00 | 100.0% | operator |
...
- **Consumes:** Nodes 26084, 26085, 26088, 26089
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 26084 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26085, 26087, 26088, 26089
- **Input Features:**
