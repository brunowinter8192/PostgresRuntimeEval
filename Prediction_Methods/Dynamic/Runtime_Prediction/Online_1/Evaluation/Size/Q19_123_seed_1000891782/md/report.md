...
**Test Query:** Q19_123_seed_1000891782
...
```
Node 31395 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31396 (Gather) [consumed]
    Node 31397 (Aggregate) [consumed]
      Node 31398 (Hash Join) [consumed]
        Node 31399 (Seq Scan) - LEAF
        Node 31400 (Hash)
          Node 31401 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31395 | 31396, 31397, 31398 |
...
|------|------|--------|-----------|-----|--------|
| 31395 | Aggregate | 879.98 | 829.27 | 5.8% | pattern |
| 31399 | Seq Scan | 808.09 | 743.46 | 8.0% | operator |
| 31400 | Hash | 47.77 | 8.29 | 82.7% | operator |
| 31401 | Seq Scan | 47.59 | 23.76 | 50.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31401 (Seq Scan) - LEAF
...
### Step 2: Node 31399 (Seq Scan) - LEAF
...
### Step 4: Node 31395 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31396, 31397, 31398
- **Input Features:**
  ...
  - Aggregate_Outer_startup_cost=156338.6500
  - Aggregate_Outer_total_cost=156338.6600
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=157339.1900
  - Aggregate_total_cost=157339.2000
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=157338.6500
  - Gather_Outer_total_cost=157339.1600
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=23
  - HashJoin_Outer_nt1=22488
  - HashJoin_Outer_nt2=199
  - HashJoin_Outer_parallel_workers=0
  - HashJoin_Outer_plan_width=12
  - HashJoin_Outer_reltuples=0.0000
  - HashJoin_Outer_sel=0.0000
  - HashJoin_Outer_startup_cost=7672.1500
  - HashJoin_Outer_total_cost=156338.4800
- **Output:** st=824.22, rt=829.27
