...
**Test Query:** Q3_29_seed_229712868
...
```
Node 5061 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5062 (Sort) [consumed]
    Node 5063 (Aggregate) [consumed]
      Node 5064 (Gather) [consumed]
        Node 5065 (Nested Loop)
          Node 5066 (Hash Join) [PATTERN: 895c6e8c]
            Node 5067 (Seq Scan) [consumed] - LEAF
            Node 5068 (Hash) [consumed]
              Node 5069 (Seq Scan) - LEAF
          Node 5070 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5061 | 5062, 5063, 5064, 5066, 5067, 5068 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5066 | 5061, 5062, 5063, 5064, 5067, 5068 |
...
|------|------|--------|-----------|-----|--------|
| 5061 | Limit | 1191.91 | 1151.18 | 3.4% | pattern |
| 5065 | Nested Loop | 1152.29 | 1192.87 | 3.5% | operator |
| 5066 | Hash Join | 210.15 | 242.45 | 15.4% | pattern |
| 5070 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5069 | Seq Scan | 28.68 | 38.54 | 34.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5069 (Seq Scan) - LEAF
...
### Step 2: Node 5066 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5061, 5062, 5063, 5064, 5067, 5068
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46643
  - HashJoin_nt1=232114
...
### Step 3: Node 5070 (Index Scan) - LEAF
...
### Step 5: Node 5061 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5062, 5063, 5064, 5066, 5067, 5068
- **Input Features:**
