...
**Test Query:** Q13_135_seed_1099340154
...
```
Node 25636 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25637 (Aggregate) [consumed]
    Node 25638 (Aggregate)
      Node 25639 (Hash Join) [PATTERN: 895c6e8c]
        Node 25640 (Seq Scan) [consumed] - LEAF
        Node 25641 (Hash) [consumed]
          Node 25642 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25636 | 25637, 25639, 25640, 25641 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25639 | 25636, 25637, 25640, 25641 |
...
|------|------|--------|-----------|-----|--------|
| 25636 | Sort | 919.12 | 1079.94 | 17.5% | pattern |
| 25638 | Aggregate | 913.02 | 999.76 | 9.5% | operator |
| 25639 | Hash Join | 690.37 | 470.31 | 31.9% | pattern |
| 25642 | Index Only Scan | 10.83 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25642 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25639 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25636, 25637, 25640, 25641
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 25636 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25637, 25639, 25640, 25641
- **Input Features:**
