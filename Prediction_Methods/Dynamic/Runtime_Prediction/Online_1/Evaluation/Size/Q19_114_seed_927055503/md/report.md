...
```
Node 31325 (Aggregate) [PATTERN: a5f39f08] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31325 | 31326, 31327 |
...
|------|------|--------|-----------|-----|--------|
| 31325 | Aggregate | 846.23 | 831.24 | 1.8% | pattern |
| 31328 | Hash Join | 827.49 | 766.05 | 7.4% | operator |
...
### Step 5: Node 31325 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31326, 31327
- **Input Features:**
