...
```
Node 31325 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31326 (Gather) [consumed]
    Node 31327 (Aggregate) [consumed]
      Node 31328 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31325 | 31326, 31327, 31328 |
...
|------|------|--------|-----------|-----|--------|
| 31325 | Aggregate | 846.23 | 829.35 | 2.0% | pattern |
| 31329 | Seq Scan | 780.01 | 743.46 | 4.7% | operator |
| 31330 | Hash | 45.83 | 8.29 | 81.9% | operator |
| 31331 | Seq Scan | 45.76 | 23.76 | 48.1% | operator |
...
### Step 4: Node 31325 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31326, 31327, 31328
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=22
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=32
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0455
  - Aggregate_Outer_startup_cost=156338.5800
  - Aggregate_Outer_total_cost=156338.5900
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=22
  - HashJoin_Outer_nt1=22467
  - HashJoin_Outer_nt2=198
  - HashJoin_Outer_parallel_workers=0
  - HashJoin_Outer_plan_width=12
  - HashJoin_Outer_reltuples=0.0000
  - HashJoin_Outer_sel=0.0000
  - HashJoin_Outer_startup_cost=7672.1400
  - HashJoin_Outer_total_cost=156338.4100
- **Output:** st=824.30, rt=829.35
