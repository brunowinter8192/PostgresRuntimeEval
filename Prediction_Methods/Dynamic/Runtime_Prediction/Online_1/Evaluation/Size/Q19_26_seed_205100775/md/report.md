...
```
Node 31696 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31697 (Gather) [consumed]
    Node 31698 (Aggregate) [consumed]
      Node 31699 (Hash Join) [consumed]
        Node 31700 (Seq Scan) - LEAF
        Node 31701 (Hash)
          Node 31702 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31696 | 31697, 31698, 31699 |
...
|------|------|--------|-----------|-----|--------|
| 31696 | Aggregate | 847.54 | 829.30 | 2.2% | pattern |
| 31700 | Seq Scan | 777.53 | 743.46 | 4.4% | operator |
| 31701 | Hash | 47.64 | 8.29 | 82.6% | operator |
| 31702 | Seq Scan | 47.52 | 23.76 | 50.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31702 (Seq Scan) - LEAF
...
### Step 2: Node 31700 (Seq Scan) - LEAF
...
### Step 4: Node 31696 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31697, 31698, 31699
- **Input Features:**
  ...
  - HashJoin_Outer_total_cost=156338.6500
