...
```
Node 13224 (Aggregate) - ROOT
  Node 13225 (Gather Merge)
    Node 13226 (Sort)
          ...
          Node 13229 (Hash Join)
            Node 13230 (Nested Loop)
              Node 13231 (Hash Join)
                ...
                Node 13233 (Hash)
                  Node 13234 (Hash Join)
                    Node 13235 (Seq Scan) - LEAF
                    Node 13236 (Hash)
                      Node 13237 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 13224 | Aggregate | 1239.22 | 1195.83 | 3.5% | operator |
| 13225 | Gather Merge | 1238.82 | 1097.13 | 11.4% | operator |
...
| 13231 | Hash Join | 214.61 | 251.17 | 17.0% | operator |
...
| 13233 | Hash | 34.84 | 20.62 | 40.8% | operator |
| 13234 | Hash Join | 34.24 | 132.26 | 286.3% | operator |
| 13235 | Seq Scan | 32.68 | 23.03 | 29.5% | operator |
| 13236 | Hash | 0.23 | 23.66 | 10275.5% | operator |
| 13237 | Hash Join | 0.23 | 306.84 | 136271.5% | operator |
...
### Step 5: Node 13235 (Seq Scan) - LEAF
...
### Step 8: Node 13232 (Seq Scan) - LEAF
...
### Step 11: Node 13241 (Index Scan) - LEAF
...
### Step 12: Node 13243 (Seq Scan) - LEAF
...
### Step 13: Node 13230 (Nested Loop)
...
### Step 16: Node 13244 (Index Scan) - LEAF
...
### Step 17: Node 13246 (Seq Scan) - LEAF
...
### Step 18: Node 13228 (Nested Loop)
...
### Step 22: Node 13225 (Gather Merge)
...
- **Input Features:**
  ...
  - total_cost=71829.0200
- **Output:** st=1093.42, rt=1097.13

### Step 23: Node 13224 (Aggregate) - ROOT
