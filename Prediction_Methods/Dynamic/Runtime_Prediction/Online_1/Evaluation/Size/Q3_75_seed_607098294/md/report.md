    ...
    Node 5573 (Aggregate) [consumed]
      Node 5574 (Gather) [consumed]
        Node 5575 (Nested Loop)
          Node 5576 (Hash Join) [PATTERN: 895c6e8c]
            Node 5577 (Seq Scan) [consumed] - LEAF
            Node 5578 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5571 | 5572, 5573, 5574, 5576, 5577, 5578 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5576 | 5571, 5572, 5573, 5574, 5577, 5578 |
...
| 5575 | Nested Loop | 1149.89 | 1193.58 | 3.8% | operator |
| 5576 | Hash Join | 207.92 | 242.58 | 16.7% | pattern |
...
### Step 2: Node 5576 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5571, 5572, 5573, 5574, 5577, 5578
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47745
  - HashJoin_nt1=237233
  ...
  - HashJoin_total_cost=37345.6300
  - Hash_Inner_np=0
  - Hash_Inner_nt=12579
...
### Step 3: Node 5580 (Index Scan) - LEAF
...
- **Output:** st=122.31, rt=1193.58

### Step 5: Node 5571 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5572, 5573, 5574, 5576, 5577, 5578
- **Input Features:**
