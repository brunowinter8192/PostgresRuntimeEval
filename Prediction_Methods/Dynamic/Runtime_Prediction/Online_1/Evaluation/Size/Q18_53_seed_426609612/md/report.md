...
**Test Query:** Q18_53_seed_426609612
...
```
Node 30388 (Limit) - ROOT
  Node 30389 (Sort)
    Node 30390 (Aggregate)
      Node 30391 (Gather Merge)
        Node 30392 (Incremental Sort)
          Node 30393 (Nested Loop)
            Node 30394 (Merge Join)
              Node 30395 (Sort)
                Node 30396 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30397 (Seq Scan) [consumed] - LEAF
                  Node 30398 (Hash) [consumed]
                    Node 30399 (Aggregate)
                      Node 30400 (Index Scan) - LEAF
              Node 30401 (Sort)
                Node 30402 (Seq Scan) - LEAF
            Node 30403 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30396 | 30397, 30398 |
...
|------|------|--------|-----------|-----|--------|
| 30388 | Limit | 3044.25 | 1175.21 | 61.4% | operator |
| 30389 | Sort | 2926.87 | 1127.81 | 61.5% | operator |
| 30390 | Aggregate | 2926.83 | 1073.15 | 63.3% | operator |
| 30391 | Gather Merge | 2926.81 | 1073.95 | 63.3% | operator |
| 30392 | Incremental Sort | 2906.86 | 0.00 | 100.0% | operator |
| 30393 | Nested Loop | 2906.81 | 1111.34 | 61.8% | operator |
| 30394 | Merge Join | 2906.75 | 0.00 | 100.0% | operator |
| 30403 | Index Scan | 0.02 | 0.05 | 105.2% | operator |
| 30395 | Sort | 2837.32 | 1095.58 | 61.4% | operator |
| 30401 | Sort | 66.41 | 1074.66 | 1518.2% | operator |
| 30396 | Hash Join | 2837.30 | 471.07 | 83.4% | pattern |
| 30402 | Seq Scan | 53.59 | 18.25 | 65.9% | operator |
| 30399 | Aggregate | 2615.35 | 1073.15 | 59.0% | operator |
| 30400 | Index Scan | 2111.75 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30400 (Index Scan) - LEAF
...
### Step 3: Node 30396 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30397, 30398
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30402 (Seq Scan) - LEAF
...
### Step 7: Node 30394 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30403 (Index Scan) - LEAF
...
### Step 10: Node 30392 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30391 (Gather Merge)
