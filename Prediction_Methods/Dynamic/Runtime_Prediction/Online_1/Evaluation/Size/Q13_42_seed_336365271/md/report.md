...
**Test Query:** Q13_42_seed_336365271
...
```
Node 25972 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25973 (Aggregate) [consumed]
    Node 25974 (Aggregate)
      Node 25975 (Hash Join) [PATTERN: 895c6e8c]
        Node 25976 (Seq Scan) [consumed] - LEAF
        Node 25977 (Hash) [consumed]
          Node 25978 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25972 | 25973, 25975, 25976, 25977 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25975 | 25972, 25973, 25976, 25977 |
...
|------|------|--------|-----------|-----|--------|
| 25972 | Sort | 895.29 | 1079.94 | 20.6% | pattern |
| 25974 | Aggregate | 889.32 | 999.76 | 12.4% | operator |
| 25975 | Hash Join | 678.65 | 470.31 | 30.7% | pattern |
| 25978 | Index Only Scan | 10.24 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25978 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25975 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25972, 25973, 25976, 25977
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 25972 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25973, 25975, 25976, 25977
- **Input Features:**
