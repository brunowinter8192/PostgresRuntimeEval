...
**Test Query:** Q12_67_seed_541466046
...
```
Node 25111 (Aggregate) - ROOT
  Node 25112 (Gather Merge)
    Node 25113 (Aggregate)
      Node 25114 (Sort)
        Node 25115 (Nested Loop)
          Node 25116 (Seq Scan) - LEAF
          Node 25117 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 25111 | Aggregate | 997.75 | 919.08 | 7.9% | operator |
| 25112 | Gather Merge | 997.73 | 1111.84 | 11.4% | operator |
| 25113 | Aggregate | 975.95 | 895.32 | 8.3% | operator |
| 25114 | Sort | 975.34 | 1092.80 | 12.0% | operator |
| 25115 | Nested Loop | 974.41 | 1127.41 | 15.7% | operator |
| 25116 | Seq Scan | 837.52 | 745.19 | 11.0% | operator |
| 25117 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25116 (Seq Scan) - LEAF
...
### Step 2: Node 25117 (Index Scan) - LEAF
...
### Step 6: Node 25112 (Gather Merge)
...
### Step 7: Node 25111 (Aggregate) - ROOT
