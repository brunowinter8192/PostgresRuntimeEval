        ...
        Node 30376 (Incremental Sort)
          Node 30377 (Nested Loop)
            Node 30378 (Merge Join)
              Node 30379 (Sort)
                Node 30380 (Hash Join)
                  Node 30381 (Seq Scan) - LEAF
                  Node 30382 (Hash)
...
| 30379 | Sort | 2854.60 | 1099.77 | 61.5% | operator |
| 30385 | Sort | 66.76 | 1074.66 | 1509.6% | operator |
| 30380 | Hash Join | 2854.59 | 686.33 | 76.0% | operator |
| 30386 | Seq Scan | 54.68 | 18.25 | 66.6% | operator |
| 30381 | Seq Scan | 197.77 | 170.37 | 13.9% | operator |
| 30382 | Hash | 2628.57 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30381 (Seq Scan) - LEAF
...
### Step 6: Node 30386 (Seq Scan) - LEAF
...
### Step 9: Node 30378 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30387 (Index Scan) - LEAF
...
### Step 11: Node 30377 (Nested Loop)
...
### Step 12: Node 30376 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30375 (Gather Merge)
