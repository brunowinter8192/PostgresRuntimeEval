...
**Test Query:** Q18_52_seed_418405581
...
```
Node 30372 (Limit) - ROOT
  Node 30373 (Sort)
    Node 30374 (Aggregate)
      Node 30375 (Gather Merge)
        Node 30376 (Incremental Sort)
          Node 30377 (Nested Loop)
            Node 30378 (Merge Join)
              Node 30379 (Sort)
                Node 30380 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30381 (Seq Scan) [consumed] - LEAF
                  Node 30382 (Hash) [consumed]
                    Node 30383 (Aggregate)
                      Node 30384 (Index Scan) - LEAF
              Node 30385 (Sort)
                Node 30386 (Seq Scan) - LEAF
            Node 30387 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30380 | 30381, 30382 |
...
|------|------|--------|-----------|-----|--------|
| 30372 | Limit | 3063.92 | 1175.21 | 61.6% | operator |
| 30373 | Sort | 2943.67 | 1127.81 | 61.7% | operator |
| 30374 | Aggregate | 2943.62 | 1073.15 | 63.5% | operator |
| 30375 | Gather Merge | 2943.61 | 1073.95 | 63.5% | operator |
| 30376 | Incremental Sort | 2924.50 | 0.00 | 100.0% | operator |
| 30377 | Nested Loop | 2924.45 | 1111.34 | 62.0% | operator |
| 30378 | Merge Join | 2924.39 | 0.00 | 100.0% | operator |
| 30387 | Index Scan | 0.02 | 0.05 | 96.2% | operator |
| 30379 | Sort | 2854.60 | 1095.58 | 61.6% | operator |
| 30385 | Sort | 66.76 | 1074.66 | 1509.6% | operator |
| 30380 | Hash Join | 2854.59 | 471.07 | 83.5% | pattern |
| 30386 | Seq Scan | 54.68 | 18.25 | 66.6% | operator |
| 30383 | Aggregate | 2628.53 | 1073.15 | 59.2% | operator |
| 30384 | Index Scan | 2136.40 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30384 (Index Scan) - LEAF
...
### Step 3: Node 30380 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30381, 30382
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30386 (Seq Scan) - LEAF
...
### Step 7: Node 30378 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30387 (Index Scan) - LEAF
...
### Step 10: Node 30376 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30375 (Gather Merge)
