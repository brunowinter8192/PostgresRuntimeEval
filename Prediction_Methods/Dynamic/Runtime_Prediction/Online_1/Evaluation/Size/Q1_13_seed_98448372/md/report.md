...
**Test Query:** Q1_13_seed_98448372
...
```
Node 216 (Aggregate) - ROOT
  Node 217 (Gather Merge)
    Node 218 (Sort) [PATTERN: 1d35fb97]
      Node 219 (Aggregate) [consumed]
        Node 220 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 218 | 219 |
...
|------|------|--------|-----------|-----|--------|
| 216 | Aggregate | 934.41 | 1196.01 | 28.0% | operator |
| 217 | Gather Merge | 934.36 | 1165.94 | 24.8% | operator |
| 218 | Sort | 915.26 | 1200.99 | 31.2% | pattern |
| 220 | Seq Scan | 504.77 | 678.42 | 34.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 220 (Seq Scan) - LEAF
...
### Step 2: Node 218 (Sort) - PATTERN ROOT
...
### Step 4: Node 216 (Aggregate) - ROOT
