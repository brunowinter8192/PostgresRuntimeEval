...
**Test Query:** Q6_100_seed_812199069
...
```
Node 9901 (Aggregate) [PATTERN: a5f39f08] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 9901 | 9902, 9903 |
...
|------|------|--------|-----------|-----|--------|
| 9901 | Aggregate | 749.78 | 850.00 | 13.4% | pattern |
| 9904 | Seq Scan | 729.35 | 748.50 | 2.6% | operator |
...
### Step 2: Node 9901 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 9902, 9903
- **Input Features:**
