...
```
Node 7261 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 7262 (Aggregate) [consumed]
    Node 7263 (Gather Merge) [consumed]
      Node 7264 (Aggregate)
        Node 7265 (Sort) [PATTERN: 3e2d5a00]
          Node 7266 (Hash Join) [consumed]
            Node 7267 (Nested Loop)
              Node 7268 (Hash Join)
                Node 7269 (Seq Scan) - LEAF
                Node 7270 (Hash) [PATTERN: 444761fb]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 7270 | 7261, 7262, 7263, 7265, 7266, 7271, 7272, 7273, 7274 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 7261 | 7262, 7263, 7265, 7266, 7270, 7271, 7272, 7273, 7274 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 7265 | 7261, 7262, 7263, 7266, 7270, 7271, 7272, 7273, 7274 |
...
|------|------|--------|-----------|-----|--------|
| 7261 | Sort | 1068.38 | 2934.42 | 174.7% | pattern |
| 7264 | Aggregate | 1060.77 | 1128.76 | 6.4% | operator |
| 7265 | Sort | 1060.51 | 1835.93 | 73.1% | pattern |
| 7267 | Nested Loop | 1049.32 | 1188.47 | 13.3% | operator |
| 7279 | Hash | 2.65 | 18.67 | 604.0% | operator |
| 7268 | Hash Join | 216.37 | 253.07 | 17.0% | operator |
| 7278 | Index Scan | 0.07 | -0.22 | 405.6% | operator |
| 7280 | Seq Scan | 1.82 | 12.36 | 578.3% | operator |
| 7269 | Seq Scan | 166.06 | 159.81 | 3.8% | operator |
| 7270 | Hash | 37.85 | 46.85 | 23.8% | pattern |
| 7275 | Seq Scan | 0.01 | 11.81 | 131103.0% | operator |
| 7276 | Hash | 0.41 | 21.05 | 5034.9% | operator |
| 7277 | Seq Scan | 0.41 | 22.93 | 5520.9% | operator |
...
- **Consumes:** Nodes 7261, 7262, 7263, 7265, 7266, 7271, 7272, 7273, 7274
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 11: Node 7265 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 7261, 7262, 7263, 7266, 7270, 7271, 7272, 7273, 7274
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 7261 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 7262, 7263, 7265, 7266, 7270, 7271, 7272, 7273, 7274
- **Input Features:**
