...
**Test Query:** Q3_61_seed_492241860
...
```
Node 5421 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5422 (Sort) [consumed]
    Node 5423 (Aggregate) [consumed]
      Node 5424 (Gather) [consumed]
        Node 5425 (Nested Loop)
          Node 5426 (Hash Join) [PATTERN: 895c6e8c]
            Node 5427 (Seq Scan) [consumed] - LEAF
            Node 5428 (Hash) [consumed]
              Node 5429 (Seq Scan) - LEAF
          Node 5430 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5421 | 5422, 5423, 5424, 5426, 5427, 5428 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5426 | 5421, 5422, 5423, 5424, 5427, 5428 |
...
|------|------|--------|-----------|-----|--------|
| 5421 | Limit | 1200.55 | 1151.18 | 4.1% | pattern |
| 5425 | Nested Loop | 1164.05 | 1193.11 | 2.5% | operator |
| 5426 | Hash Join | 208.51 | 242.49 | 16.3% | pattern |
| 5430 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5429 | Seq Scan | 27.31 | 38.60 | 41.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5429 (Seq Scan) - LEAF
...
### Step 2: Node 5426 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5421, 5422, 5423, 5424, 5427, 5428
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47017
  - HashJoin_nt1=237043
  ...
  - HashJoin_total_cost=37342.8600
  - Hash_Inner_np=0
  - Hash_Inner_nt=12397
...
### Step 3: Node 5430 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=72873.1600
- **Output:** st=121.88, rt=1193.11

### Step 5: Node 5421 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5422, 5423, 5424, 5426, 5427, 5428
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=311528
  - Aggregate_Outer_nt1=311528
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=109698.8800
  - Aggregate_Outer_total_cost=113592.9800
  - Gather_Outer_np=0
  - Gather_Outer_nt=311528
  - Gather_Outer_nt1=100493
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105025.9600
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=311528
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=120324.9800
  - Limit_total_cost=120325.0100
  - Sort_Outer_np=0
  - Sort_Outer_nt=311528
  - Sort_Outer_nt1=311528
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=120324.9800
  - Sort_Outer_total_cost=121103.8000
