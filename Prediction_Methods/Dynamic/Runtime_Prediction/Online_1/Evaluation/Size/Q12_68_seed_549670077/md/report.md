...
**Test Query:** Q12_68_seed_549670077
...
```
Node 25118 (Aggregate) - ROOT
  Node 25119 (Gather Merge)
    Node 25120 (Aggregate)
      Node 25121 (Sort)
        Node 25122 (Nested Loop)
          Node 25123 (Seq Scan) - LEAF
          Node 25124 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 25118 | Aggregate | 998.21 | 919.08 | 7.9% | operator |
| 25119 | Gather Merge | 998.17 | 1111.84 | 11.4% | operator |
| 25120 | Aggregate | 978.18 | 895.33 | 8.5% | operator |
| 25121 | Sort | 977.57 | 1092.80 | 11.8% | operator |
| 25122 | Nested Loop | 975.79 | 1127.41 | 15.5% | operator |
| 25123 | Seq Scan | 835.35 | 745.19 | 10.8% | operator |
| 25124 | Index Scan | 0.03 | 0.07 | 166.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25123 (Seq Scan) - LEAF
...
### Step 2: Node 25124 (Index Scan) - LEAF
...
### Step 6: Node 25119 (Gather Merge)
...
### Step 7: Node 25118 (Aggregate) - ROOT
