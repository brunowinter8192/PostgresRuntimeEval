...
```
Node 17683 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 17684 (Aggregate) [consumed]
    Node 17685 (Gather)
      Node 17686 (Aggregate)
        Node 17687 (Nested Loop)
          Node 17688 (Hash Join) [PATTERN: bb930825]
            Node 17689 (Seq Scan) [consumed] - LEAF
            Node 17690 (Hash) [consumed]
              Node 17691 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17688 | 17683, 17684, 17689, 17690, 17691 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17683 | 17684, 17688, 17689, 17690, 17691 |
...
|------|------|--------|-----------|-----|--------|
| 17683 | Sort | 1183.56 | 1048.20 | 11.4% | pattern |
...
| 17688 | Hash Join | 973.17 | 134.80 | 86.1% | pattern |
...
### Step 9: Node 17688 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17683, 17684, 17689, 17690, 17691
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17700 (Index Scan) - LEAF
...
### Step 11: Node 17687 (Nested Loop)
...
### Step 14: Node 17683 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17684, 17688, 17689, 17690, 17691
- **Input Features:**
