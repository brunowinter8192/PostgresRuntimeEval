        ...
        Node 29176 (Incremental Sort)
          Node 29177 (Nested Loop)
            Node 29178 (Merge Join)
              Node 29179 (Sort)
                Node 29180 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29181 (Seq Scan) [consumed] - LEAF
                  Node 29182 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29180 | 29181, 29182 |
...
| 29179 | Sort | 2829.21 | 1095.58 | 61.3% | operator |
| 29185 | Sort | 64.81 | 1074.66 | 1558.2% | operator |
| 29180 | Hash Join | 2829.20 | 471.07 | 83.3% | pattern |
...
### Step 3: Node 29180 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29181, 29182
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29186 (Seq Scan) - LEAF
...
### Step 7: Node 29178 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29187 (Index Scan) - LEAF
...
### Step 10: Node 29176 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29175 (Gather Merge)
