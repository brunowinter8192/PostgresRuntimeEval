...
**Test Query:** Q1_76_seed_615302325
...
```
Node 616 (Aggregate) - ROOT
  Node 617 (Gather Merge)
    Node 618 (Sort) [PATTERN: 1d35fb97]
      Node 619 (Aggregate) [consumed]
        Node 620 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 618 | 619 |
...
|------|------|--------|-----------|-----|--------|
| 616 | Aggregate | 930.75 | 1195.77 | 28.5% | operator |
| 617 | Gather Merge | 930.70 | 1165.87 | 25.3% | operator |
| 618 | Sort | 911.78 | 1200.04 | 31.6% | pattern |
| 620 | Seq Scan | 507.96 | 682.02 | 34.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 620 (Seq Scan) - LEAF
...
### Step 2: Node 618 (Sort) - PATTERN ROOT
...
### Step 4: Node 616 (Aggregate) - ROOT
