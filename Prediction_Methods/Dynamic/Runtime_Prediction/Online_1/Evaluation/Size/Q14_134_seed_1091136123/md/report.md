...
```
Node 26679 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26680 (Gather) [consumed]
    Node 26681 (Aggregate) [consumed]
      Node 26682 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26679 | 26680, 26681, 26682 |
...
|------|------|--------|-----------|-----|--------|
| 26679 | Aggregate | 820.14 | 857.12 | 4.5% | pattern |
...
### Step 4: Node 26679 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26680, 26681, 26682
- **Input Features:**
