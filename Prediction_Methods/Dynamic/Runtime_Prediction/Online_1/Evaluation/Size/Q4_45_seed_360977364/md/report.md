...
**Test Query:** Q4_45_seed_360977364
...
```
Node 6474 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6475 (Gather Merge) [consumed]
    Node 6476 (Sort) [consumed]
      Node 6477 (Aggregate) [consumed]
        Node 6478 (Nested Loop)
          Node 6479 (Seq Scan) - LEAF
          Node 6480 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6474 | 6475, 6476, 6477 |
...
|------|------|--------|-----------|-----|--------|
| 6474 | Aggregate | 1066.42 | 952.19 | 10.7% | pattern |
| 6478 | Nested Loop | 1058.07 | 1255.45 | 18.7% | operator |
| 6479 | Seq Scan | 163.86 | 154.66 | 5.6% | operator |
| 6480 | Index Scan | 0.06 | 11.10 | 17810.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6479 (Seq Scan) - LEAF
...
### Step 2: Node 6480 (Index Scan) - LEAF
...
### Step 4: Node 6474 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f8231c4d (Aggregate -> Gather Merge -> Sort -> Aggregate (Outer) (Outer) (Outer))
- **Consumes:** Nodes 6475, 6476, 6477
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=5
  - Aggregate_Outer_nt1=15330
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=24
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0003
  - Aggregate_Outer_startup_cost=66325.7200
  - Aggregate_Outer_total_cost=66325.7700
  - Aggregate_np=0
  - Aggregate_nt=5
  - Aggregate_nt1=15
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=67325.8700
  - Aggregate_total_cost=67327.7700
  ...
  - GatherMerge_Outer_startup_cost=67325.8700
  - GatherMerge_Outer_total_cost=67327.6400
  - Sort_Outer_np=0
  - Sort_Outer_nt=5
  - Sort_Outer_nt1=5
  - Sort_Outer_nt2=0
  ...
  - Sort_Outer_startup_cost=66325.8300
  - Sort_Outer_total_cost=66325.8400
