...
```
Node 16421 (Aggregate) - ROOT
  Node 16422 (Gather Merge)
    Node 16423 (Sort)
          ...
          Node 16426 (Hash Join)
            Node 16427 (Nested Loop)
              Node 16428 (Hash Join)
                ...
                Node 16430 (Hash)
                  Node 16431 (Hash Join)
                    Node 16432 (Seq Scan) - LEAF
                    Node 16433 (Hash)
                      Node 16434 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 16421 | Aggregate | 1202.73 | 1194.14 | 0.7% | operator |
| 16422 | Gather Merge | 1202.25 | 1097.16 | 8.7% | operator |
...
| 16428 | Hash Join | 218.05 | 251.17 | 15.2% | operator |
...
| 16430 | Hash | 37.37 | 20.62 | 44.8% | operator |
| 16431 | Hash Join | 36.73 | 132.26 | 260.1% | operator |
| 16432 | Seq Scan | 35.21 | 23.03 | 34.6% | operator |
| 16433 | Hash | 0.25 | 23.66 | 9477.4% | operator |
| 16434 | Hash Join | 0.24 | 306.84 | 126169.9% | operator |
...
### Step 5: Node 16432 (Seq Scan) - LEAF
...
### Step 8: Node 16429 (Seq Scan) - LEAF
...
### Step 11: Node 16438 (Index Scan) - LEAF
...
### Step 12: Node 16440 (Seq Scan) - LEAF
...
### Step 13: Node 16427 (Nested Loop)
...
### Step 16: Node 16441 (Index Scan) - LEAF
...
### Step 17: Node 16443 (Seq Scan) - LEAF
...
### Step 18: Node 16425 (Nested Loop)
...
### Step 22: Node 16422 (Gather Merge)
...
### Step 23: Node 16421 (Aggregate) - ROOT
