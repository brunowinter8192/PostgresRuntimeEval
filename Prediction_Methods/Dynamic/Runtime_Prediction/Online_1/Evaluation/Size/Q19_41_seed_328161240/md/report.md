...
```
Node 31815 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31816 (Gather) [consumed]
    Node 31817 (Aggregate) [consumed]
      Node 31818 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31815 | 31816, 31817, 31818 |
...
|------|------|--------|-----------|-----|--------|
| 31815 | Aggregate | 846.40 | 829.29 | 2.0% | pattern |
...
### Step 4: Node 31815 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31816, 31817, 31818
- **Input Features:**
