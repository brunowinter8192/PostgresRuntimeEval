...
Node 416 (Aggregate) - ROOT
  Node 417 (Gather Merge)
    Node 418 (Sort) [PATTERN: 1d35fb97]
      Node 419 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 418 | 419 |
...
|------|------|--------|-----------|-----|--------|
| 416 | Aggregate | 986.75 | 1195.99 | 21.2% | operator |
| 417 | Gather Merge | 986.67 | 1165.94 | 18.2% | operator |
| 418 | Sort | 967.05 | 1200.90 | 24.2% | pattern |
...
### Step 2: Node 418 (Sort) - PATTERN ROOT
...
### Step 4: Node 416 (Aggregate) - ROOT
