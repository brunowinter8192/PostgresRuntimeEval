...
**Test Query:** Q6_86_seed_697342635
...
```
Node 10437 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10438 (Gather) [consumed]
    Node 10439 (Aggregate) [consumed]
      Node 10440 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10437 | 10438, 10439 |
...
|------|------|--------|-----------|-----|--------|
| 10437 | Aggregate | 821.42 | 850.05 | 3.5% | pattern |
| 10440 | Seq Scan | 799.74 | 748.53 | 6.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10440 (Seq Scan) - LEAF
...
### Step 2: Node 10437 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10438, 10439
- **Input Features:**
