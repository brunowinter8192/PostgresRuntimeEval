...
**Test Query:** Q6_120_seed_976279689
...
```
Node 9989 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 9990 (Gather) [consumed]
    Node 9991 (Aggregate) [consumed]
      Node 9992 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 9989 | 9990, 9991 |
...
|------|------|--------|-----------|-----|--------|
| 9989 | Aggregate | 791.39 | 850.07 | 7.4% | pattern |
| 9992 | Seq Scan | 767.19 | 748.54 | 2.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 9992 (Seq Scan) - LEAF
...
### Step 2: Node 9989 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 9990, 9991
- **Input Features:**
