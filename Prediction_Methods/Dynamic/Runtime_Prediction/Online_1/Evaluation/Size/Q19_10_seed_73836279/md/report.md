...
**Test Query:** Q19_10_seed_73836279
...
```
Node 31290 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31291 (Gather) [consumed]
    Node 31292 (Aggregate) [consumed]
      Node 31293 (Hash Join) [consumed]
        Node 31294 (Seq Scan) - LEAF
        Node 31295 (Hash)
          Node 31296 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31290 | 31291, 31292, 31293 |
...
|------|------|--------|-----------|-----|--------|
| 31290 | Aggregate | 818.85 | 829.30 | 1.3% | pattern |
| 31294 | Seq Scan | 746.14 | 743.46 | 0.4% | operator |
| 31295 | Hash | 48.38 | 8.29 | 82.9% | operator |
| 31296 | Seq Scan | 48.26 | 23.76 | 50.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31296 (Seq Scan) - LEAF
...
### Step 2: Node 31294 (Seq Scan) - LEAF
...
### Step 4: Node 31290 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31291, 31292, 31293
- **Input Features:**
