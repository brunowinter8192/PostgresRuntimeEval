...
**Test Query:** Q1_23_seed_180488682
...
```
Node 326 (Aggregate) - ROOT
  Node 327 (Gather Merge)
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 328 | 329 |
...
|------|------|--------|-----------|-----|--------|
| 326 | Aggregate | 1003.38 | 1196.04 | 19.2% | operator |
| 327 | Gather Merge | 1003.31 | 1165.95 | 16.2% | operator |
| 328 | Sort | 983.93 | 1201.08 | 22.1% | pattern |
| 330 | Seq Scan | 598.01 | 678.08 | 13.4% | operator |
...
- **Input Features:**
  ...
  - Aggregate_Outer_total_cost=169351.0300
  - Sort_np=0
  - Sort_nt=6
  - Sort_nt1=6
  - Sort_nt2=0
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=169351.1100
  - Sort_total_cost=169351.1300
- **Output:** st=1196.98, rt=1201.08

### Step 3: Node 327 (Gather Merge)
...
### Step 4: Node 326 (Aggregate) - ROOT
