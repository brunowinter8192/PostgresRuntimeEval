...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4631 | 4632, 4633, 4634 |
...
| 4635 | Nested Loop | 1157.80 | 1192.89 | 3.0% | operator |
| 4636 | Hash Join | 206.47 | 230.62 | 11.7% | operator |
| 4640 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4637 | Seq Scan | 154.73 | 163.33 | 5.6% | operator |
| 4638 | Hash | 28.89 | 17.75 | 38.6% | operator |
...
### Step 2: Node 4637 (Seq Scan) - LEAF
...
### Step 5: Node 4640 (Index Scan) - LEAF
...
### Step 7: Node 4631 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4632, 4633, 4634
- **Input Features:**
