          ...
          Node 15138 (Hash Join)
            Node 15139 (Nested Loop)
              Node 15140 (Hash Join)
                ...
                Node 15142 (Hash) [PATTERN: 444761fb]
                  Node 15143 (Hash Join) [consumed]
                    Node 15144 (Seq Scan) [consumed] - LEAF
                    Node 15145 (Hash) [consumed]
                      Node 15146 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 15142 | 15133, 15134, 15143, 15144, 15145, 15146 |
| Aggregate -> Gather Merge (Out | 2724c080 | 15133 | 15134, 15142, 15143, 15144, 15145, 15146 |
...
|------|------|--------|-----------|-----|--------|
| 15133 | Aggregate | 1218.56 | 1129.87 | 7.3% | pattern |
| 15135 | Sort | 1212.25 | 1046.21 | 13.7% | operator |
| 15136 | Hash Join | 1212.00 | 785.61 | 35.2% | operator |
| 15137 | Nested Loop | 1211.70 | 1198.29 | 1.1% | operator |
| 15154 | Hash | 0.01 | 13.72 | 105469.9% | operator |
| 15138 | Hash Join | 1207.68 | 785.60 | 34.9% | operator |
| 15153 | Index Scan | 0.01 | 12.42 | 206958.1% | operator |
| 15155 | Seq Scan | 0.01 | 6.51 | 72255.1% | operator |
| 15139 | Nested Loop | 1161.86 | 1198.29 | 3.1% | operator |
| 15151 | Hash | 41.39 | 19.97 | 51.8% | operator |
| 15140 | Hash Join | 212.85 | 251.67 | 18.2% | operator |
| 15150 | Index Scan | 0.04 | 2.88 | 6926.5% | operator |
| 15152 | Seq Scan | 41.33 | 48.87 | 18.2% | operator |
| 15141 | Seq Scan | 157.84 | 159.67 | 1.2% | operator |
| 15142 | Hash | 37.06 | 43.51 | 17.4% | pattern |
| 15147 | Seq Scan | 0.01 | 12.22 | 111035.8% | operator |
| 15148 | Hash | 0.24 | 18.14 | 7555.8% | operator |
| 15149 | Seq Scan | 0.23 | 23.36 | 9969.9% | operator |
...
### Step 4: Node 15141 (Seq Scan) - LEAF
...
### Step 5: Node 15142 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 15133, 15134, 15143, 15144, 15145, 15146
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 15150 (Index Scan) - LEAF
...
### Step 8: Node 15152 (Seq Scan) - LEAF
...
### Step 12: Node 15153 (Index Scan) - LEAF
...
### Step 13: Node 15155 (Seq Scan) - LEAF
...
### Step 14: Node 15137 (Nested Loop)
...
### Step 18: Node 15133 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 15134, 15142, 15143, 15144, 15145, 15146
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2482
