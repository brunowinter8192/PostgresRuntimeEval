...
```
Node 31647 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31648 (Gather) [consumed]
    Node 31649 (Aggregate) [consumed]
      Node 31650 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31647 | 31648, 31649 |
...
|------|------|--------|-----------|-----|--------|
| 31647 | Aggregate | 842.57 | 831.20 | 1.3% | pattern |
| 31650 | Hash Join | 819.31 | 766.06 | 6.5% | operator |
...
### Step 5: Node 31647 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31648, 31649
- **Input Features:**
