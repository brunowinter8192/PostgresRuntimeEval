...
**Test Query:** Q19_1_seed_0101000000
...
```
Node 31647 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31648 (Gather) [consumed]
    Node 31649 (Aggregate) [consumed]
      Node 31650 (Hash Join) [consumed]
        Node 31651 (Seq Scan) - LEAF
        Node 31652 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31647 | 31648, 31649, 31650 |
...
|------|------|--------|-----------|-----|--------|
| 31647 | Aggregate | 842.57 | 829.30 | 1.6% | pattern |
| 31651 | Seq Scan | 774.13 | 743.46 | 4.0% | operator |
| 31652 | Hash | 43.52 | 8.29 | 81.0% | operator |
| 31653 | Seq Scan | 43.36 | 23.76 | 45.2% | operator |
...
### Step 2: Node 31651 (Seq Scan) - LEAF
...
### Step 4: Node 31647 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31648, 31649, 31650
- **Input Features:**
