...
**Test Query:** Q4_13_seed_98448372
...
```
Node 6152 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6153 (Gather Merge) [consumed]
    Node 6154 (Sort) [consumed]
      Node 6155 (Aggregate) [consumed]
        Node 6156 (Nested Loop)
          Node 6157 (Seq Scan) - LEAF
          Node 6158 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6152 | 6153, 6154, 6155 |
...
|------|------|--------|-----------|-----|--------|
| 6152 | Aggregate | 1065.43 | 952.19 | 10.6% | pattern |
| 6156 | Nested Loop | 1059.08 | 1255.45 | 18.5% | operator |
| 6157 | Seq Scan | 163.14 | 154.66 | 5.2% | operator |
| 6158 | Index Scan | 0.06 | 11.10 | 17810.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6157 (Seq Scan) - LEAF
...
### Step 2: Node 6158 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - Aggregate_startup_cost=67147.1400
  - Aggregate_total_cost=67149.0400
  ...
  - GatherMerge_Outer_startup_cost=67147.1400
  - GatherMerge_Outer_total_cost=67148.9100
  - Sort_Outer_np=0
  - Sort_Outer_nt=5
  - Sort_Outer_nt1=5
  - Sort_Outer_nt2=0
  ...
  - Sort_Outer_startup_cost=66147.1000
  - Sort_Outer_total_cost=66147.1100
