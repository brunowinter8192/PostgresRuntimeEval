...
```
Node 29236 (Limit) - ROOT
  Node 29237 (Sort)
    Node 29238 (Aggregate)
      Node 29239 (Gather Merge)
        Node 29240 (Incremental Sort)
          Node 29241 (Nested Loop)
            Node 29242 (Merge Join)
              Node 29243 (Sort)
                Node 29244 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29245 (Seq Scan) [consumed] - LEAF
                  Node 29246 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29244 | 29245, 29246 |
...
|------|------|--------|-----------|-----|--------|
| 29236 | Limit | 3082.79 | 1175.21 | 61.9% | operator |
| 29237 | Sort | 2963.08 | 1127.81 | 61.9% | operator |
| 29238 | Aggregate | 2963.02 | 1073.15 | 63.8% | operator |
| 29239 | Gather Merge | 2963.00 | 1073.95 | 63.8% | operator |
| 29240 | Incremental Sort | 2939.68 | 0.00 | 100.0% | operator |
| 29241 | Nested Loop | 2939.63 | 1111.34 | 62.2% | operator |
| 29242 | Merge Join | 2939.57 | 0.00 | 100.0% | operator |
| 29251 | Index Scan | 0.02 | 0.05 | 88.1% | operator |
| 29243 | Sort | 2870.20 | 1095.58 | 61.8% | operator |
| 29249 | Sort | 66.42 | 1074.66 | 1517.9% | operator |
| 29244 | Hash Join | 2870.19 | 471.07 | 83.6% | pattern |
| 29250 | Seq Scan | 54.13 | 18.25 | 66.3% | operator |
| 29247 | Aggregate | 2648.93 | 1073.15 | 59.5% | operator |
| 29248 | Index Scan | 2144.13 | 0.00 | 100.0% | operator |
...
### Step 3: Node 29244 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29245, 29246
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29250 (Seq Scan) - LEAF
...
### Step 7: Node 29242 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29251 (Index Scan) - LEAF
...
### Step 10: Node 29240 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29239 (Gather Merge)
