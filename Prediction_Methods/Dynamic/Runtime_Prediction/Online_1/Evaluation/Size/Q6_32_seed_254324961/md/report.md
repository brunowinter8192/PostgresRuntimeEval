...
**Test Query:** Q6_32_seed_254324961
...
```
Node 10201 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10202 (Gather) [consumed]
    Node 10203 (Aggregate) [consumed]
      Node 10204 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10201 | 10202, 10203 |
...
|------|------|--------|-----------|-----|--------|
| 10201 | Aggregate | 810.44 | 850.06 | 4.9% | pattern |
| 10204 | Seq Scan | 789.82 | 748.54 | 5.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10204 (Seq Scan) - LEAF
...
### Step 2: Node 10201 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10202, 10203
- **Input Features:**
