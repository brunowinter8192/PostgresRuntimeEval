...
**Test Query:** Q14_143_seed_1164972402
...
```
Node 26749 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26750 (Gather) [consumed]
    Node 26751 (Aggregate) [consumed]
      Node 26752 (Hash Join) [consumed]
        Node 26753 (Seq Scan) - LEAF
        Node 26754 (Hash)
          Node 26755 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26749 | 26750, 26751, 26752 |
...
|------|------|--------|-----------|-----|--------|
| 26749 | Aggregate | 814.81 | 857.13 | 5.2% | pattern |
| 26753 | Seq Scan | 738.15 | 758.49 | 2.8% | operator |
| 26754 | Hash | 46.17 | 9.38 | 79.7% | operator |
| 26755 | Seq Scan | 40.79 | 12.70 | 68.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26755 (Seq Scan) - LEAF
...
### Step 2: Node 26753 (Seq Scan) - LEAF
...
### Step 4: Node 26749 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26750, 26751, 26752
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=15288
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=64
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0001
  - Aggregate_Outer_startup_cost=136914.3200
  - Aggregate_Outer_total_cost=136914.3300
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=137914.8800
  - Aggregate_total_cost=137914.9000
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=137914.3200
  - Gather_Outer_total_cost=137914.8300
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=15288
  - HashJoin_Outer_nt1=15288
  ...
  - HashJoin_Outer_total_cost=136646.7700
