...
**Test Query:** Q9_145_seed_1181380464
...
```
Node 17538 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 17539 (Aggregate) [consumed]
    Node 17540 (Gather)
      Node 17541 (Aggregate)
        Node 17542 (Nested Loop)
          Node 17543 (Hash Join) [PATTERN: bb930825]
            Node 17544 (Seq Scan) [consumed] - LEAF
            Node 17545 (Hash) [consumed]
              Node 17546 (Hash Join) [consumed]
                Node 17547 (Hash Join)
                  Node 17548 (Nested Loop)
                    Node 17549 (Seq Scan) - LEAF
                    Node 17550 (Index Scan) - LEAF
                  Node 17551 (Hash)
                    Node 17552 (Seq Scan) - LEAF
                Node 17553 (Hash)
                  Node 17554 (Seq Scan) - LEAF
          Node 17555 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17543 | 17538, 17539, 17544, 17545, 17546 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17538 | 17539, 17543, 17544, 17545, 17546 |
...
|------|------|--------|-----------|-----|--------|
| 17538 | Sort | 1172.92 | 1044.29 | 11.0% | pattern |
| 17540 | Gather | 1171.42 | 965.14 | 17.6% | operator |
| 17541 | Aggregate | 1152.72 | 1141.19 | 1.0% | operator |
| 17542 | Nested Loop | 1128.60 | 1252.17 | 10.9% | operator |
| 17543 | Hash Join | 955.43 | 134.80 | 85.9% | pattern |
| 17555 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17547 | Hash Join | 156.32 | 837.49 | 435.7% | operator |
| 17553 | Hash | 14.19 | 14.95 | 5.4% | operator |
| 17548 | Nested Loop | 150.68 | 1251.76 | 730.7% | operator |
| 17551 | Hash | 3.66 | 15.94 | 335.7% | operator |
| 17554 | Seq Scan | 14.17 | 2.94 | 79.3% | operator |
| 17549 | Seq Scan | 18.95 | 44.30 | 133.8% | operator |
| 17550 | Index Scan | 0.07 | -1.39 | 1976.3% | operator |
| 17552 | Seq Scan | 3.18 | 9.45 | 196.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 17549 (Seq Scan) - LEAF
...
### Step 2: Node 17550 (Index Scan) - LEAF
...
### Step 3: Node 17552 (Seq Scan) - LEAF
...
### Step 6: Node 17554 (Seq Scan) - LEAF
...
### Step 9: Node 17543 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17538, 17539, 17544, 17545, 17546
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17555 (Index Scan) - LEAF
...
### Step 11: Node 17542 (Nested Loop)
...
### Step 14: Node 17538 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17539, 17543, 17544, 17545, 17546
- **Input Features:**
