...
```
Node 17538 (Sort) - ROOT
  Node 17539 (Aggregate)
    Node 17540 (Gather)
      Node 17541 (Aggregate)
        Node 17542 (Nested Loop)
          Node 17543 (Hash Join)
            Node 17544 (Seq Scan) - LEAF
            Node 17545 (Hash)
              Node 17546 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 17538 | Sort | 1172.92 | 1118.33 | 4.7% | operator |
| 17539 | Aggregate | 1172.79 | 896.44 | 23.6% | operator |
...
| 17543 | Hash Join | 955.43 | 632.60 | 33.8% | operator |
| 17555 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17544 | Seq Scan | 689.24 | 509.93 | 26.0% | operator |
| 17545 | Hash | 173.26 | 47.45 | 72.6% | operator |
| 17546 | Hash Join | 171.13 | 924.21 | 440.1% | operator |
...
### Step 10: Node 17544 (Seq Scan) - LEAF
...
### Step 13: Node 17555 (Index Scan) - LEAF
...
### Step 14: Node 17542 (Nested Loop)
