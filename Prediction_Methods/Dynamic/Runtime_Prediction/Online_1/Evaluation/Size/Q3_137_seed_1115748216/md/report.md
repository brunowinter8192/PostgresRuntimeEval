...
**Test Query:** Q3_137_seed_1115748216
...
```
Node 4751 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 4752 (Sort) [consumed]
    Node 4753 (Aggregate) [consumed]
      Node 4754 (Gather) [consumed]
        Node 4755 (Nested Loop)
          Node 4756 (Hash Join) [PATTERN: 895c6e8c]
            Node 4757 (Seq Scan) [consumed] - LEAF
            Node 4758 (Hash) [consumed]
              Node 4759 (Seq Scan) - LEAF
          Node 4760 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4751 | 4752, 4753, 4754, 4756, 4757, 4758 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4756 | 4751, 4752, 4753, 4754, 4757, 4758 |
...
|------|------|--------|-----------|-----|--------|
| 4751 | Limit | 1162.57 | 1151.18 | 1.0% | pattern |
| 4755 | Nested Loop | 1126.80 | 1193.19 | 5.9% | operator |
| 4756 | Hash Join | 206.72 | 242.50 | 17.3% | pattern |
| 4760 | Index Scan | 0.03 | -0.52 | 2172.3% | operator |
| 4759 | Seq Scan | 29.31 | 38.57 | 31.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4759 (Seq Scan) - LEAF
...
### Step 2: Node 4756 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4751, 4752, 4753, 4754, 4757, 4758
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47131
  - HashJoin_nt1=235905
  ...
  - HashJoin_total_cost=37341.0000
  - Hash_Inner_np=0
  - Hash_Inner_nt=12487
...
### Step 3: Node 4760 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=73001.3600
- **Output:** st=121.94, rt=1193.19

### Step 5: Node 4751 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4752, 4753, 4754, 4756, 4757, 4758
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=313795
  - Aggregate_Outer_nt1=313795
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110087.7800
  - Aggregate_Outer_total_cost=114010.2200
  - Gather_Outer_np=0
  - Gather_Outer_nt=313795
  - Gather_Outer_nt1=101224
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105380.8600
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=313795
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=120791.2200
  - Limit_total_cost=120791.2400
  - Sort_Outer_np=0
  - Sort_Outer_nt=313795
  - Sort_Outer_nt1=313795
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=120791.2200
  - Sort_Outer_total_cost=121575.7000
