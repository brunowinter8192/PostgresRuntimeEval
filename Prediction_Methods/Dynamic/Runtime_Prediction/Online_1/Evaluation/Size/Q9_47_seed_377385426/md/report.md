...
**Test Query:** Q9_47_seed_377385426
...
```
Node 18300 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18301 (Aggregate) [consumed]
    Node 18302 (Gather)
      Node 18303 (Aggregate)
        Node 18304 (Nested Loop)
          Node 18305 (Hash Join) [PATTERN: bb930825]
            Node 18306 (Seq Scan) [consumed] - LEAF
            Node 18307 (Hash) [consumed]
              Node 18308 (Hash Join) [consumed]
                Node 18309 (Hash Join)
                  Node 18310 (Nested Loop)
                    Node 18311 (Seq Scan) - LEAF
                    Node 18312 (Index Scan) - LEAF
                  Node 18313 (Hash)
                    Node 18314 (Seq Scan) - LEAF
                Node 18315 (Hash)
                  Node 18316 (Seq Scan) - LEAF
          Node 18317 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18305 | 18300, 18301, 18306, 18307, 18308 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18300 | 18301, 18305, 18306, 18307, 18308 |
...
|------|------|--------|-----------|-----|--------|
| 18300 | Sort | 1227.15 | 1049.52 | 14.5% | pattern |
| 18302 | Gather | 1225.84 | 941.00 | 23.2% | operator |
| 18303 | Aggregate | 1207.54 | 1141.96 | 5.4% | operator |
| 18304 | Nested Loop | 1183.09 | 1252.17 | 5.8% | operator |
| 18305 | Hash Join | 1004.28 | 134.80 | 86.6% | pattern |
| 18317 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18309 | Hash Join | 169.24 | 837.31 | 394.8% | operator |
| 18315 | Hash | 13.70 | 14.95 | 9.1% | operator |
| 18310 | Nested Loop | 162.34 | 1251.76 | 671.1% | operator |
| 18313 | Hash | 4.60 | 15.94 | 246.8% | operator |
| 18316 | Seq Scan | 13.68 | 2.94 | 78.5% | operator |
| 18311 | Seq Scan | 20.47 | 44.65 | 118.1% | operator |
| 18312 | Index Scan | 0.08 | -1.39 | 1880.0% | operator |
| 18314 | Seq Scan | 4.00 | 9.45 | 136.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 18311 (Seq Scan) - LEAF
...
### Step 2: Node 18312 (Index Scan) - LEAF
...
### Step 3: Node 18314 (Seq Scan) - LEAF
...
### Step 6: Node 18316 (Seq Scan) - LEAF
...
### Step 9: Node 18305 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18300, 18301, 18306, 18307, 18308
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18317 (Index Scan) - LEAF
...
### Step 11: Node 18304 (Nested Loop)
...
### Step 14: Node 18300 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18301, 18305, 18306, 18307, 18308
- **Input Features:**
