...
**Test Query:** Q3_16_seed_123060465
...
```
Node 4921 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 4922 (Sort) [consumed]
    Node 4923 (Aggregate) [consumed]
      Node 4924 (Gather) [consumed]
        Node 4925 (Nested Loop)
          Node 4926 (Hash Join) [PATTERN: 895c6e8c]
            Node 4927 (Seq Scan) [consumed] - LEAF
            Node 4928 (Hash) [consumed]
              Node 4929 (Seq Scan) - LEAF
          Node 4930 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4921 | 4922, 4923, 4924, 4926, 4927, 4928 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4926 | 4921, 4922, 4923, 4924, 4927, 4928 |
...
|------|------|--------|-----------|-----|--------|
| 4921 | Limit | 1175.60 | 1151.18 | 2.1% | pattern |
| 4925 | Nested Loop | 1139.23 | 1193.41 | 4.8% | operator |
| 4926 | Hash Join | 205.00 | 242.54 | 18.3% | pattern |
| 4930 | Index Scan | 0.03 | -0.52 | 2172.3% | operator |
| 4929 | Seq Scan | 29.44 | 38.57 | 31.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4929 (Seq Scan) - LEAF
...
### Step 2: Node 4926 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4921, 4922, 4923, 4924, 4927, 4928
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47472
  - HashJoin_nt1=237612
  ...
  - HashJoin_total_cost=37345.4800
  - Hash_Inner_np=0
  - Hash_Inner_nt=12487
...
- **Input Features:**
  ...
  - total_cost=73197.6600
- **Output:** st=122.16, rt=1193.41

### Step 5: Node 4921 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4922, 4923, 4924, 4926, 4927, 4928
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=313699
  - Aggregate_Outer_nt1=313699
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110273.0500
  - Aggregate_Outer_total_cost=114194.2900
  - Gather_Outer_np=0
  - Gather_Outer_nt=313699
  - Gather_Outer_nt1=101193
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105567.5600
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=313699
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=120973.2100
  - Limit_total_cost=120973.2300
  - Sort_Outer_np=0
  - Sort_Outer_nt=313699
  - Sort_Outer_nt1=313699
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=120973.2100
  - Sort_Outer_total_cost=121757.4600
