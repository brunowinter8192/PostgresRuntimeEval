...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4921 | 4922, 4923, 4924 |
...
| 4925 | Nested Loop | 1139.23 | 1193.33 | 4.7% | operator |
| 4926 | Hash Join | 205.00 | 231.28 | 12.8% | operator |
| 4930 | Index Scan | 0.03 | -0.52 | 2172.3% | operator |
| 4927 | Seq Scan | 151.91 | 163.56 | 7.7% | operator |
| 4928 | Hash | 30.29 | 17.75 | 41.4% | operator |
...
### Step 2: Node 4927 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37345.4800
- **Output:** st=27.28, rt=231.28

### Step 5: Node 4930 (Index Scan) - LEAF
...
- **Output:** st=122.02, rt=1193.33

### Step 7: Node 4921 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4922, 4923, 4924
- **Input Features:**
