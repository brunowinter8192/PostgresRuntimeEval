...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25664 | 25665, 25667, 25668, 25669 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25667 | 25664, 25665, 25668, 25669 |
...
|------|------|--------|-----------|-----|--------|
| 25664 | Sort | 917.70 | 1079.93 | 17.7% | pattern |
| 25666 | Aggregate | 911.61 | 999.15 | 9.6% | operator |
| 25667 | Hash Join | 708.03 | 470.31 | 33.6% | pattern |
...
- **Consumes:** Nodes 25664, 25665, 25668, 25669
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1478958
...
### Step 4: Node 25664 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25665, 25667, 25668, 25669
- **Input Features:**
