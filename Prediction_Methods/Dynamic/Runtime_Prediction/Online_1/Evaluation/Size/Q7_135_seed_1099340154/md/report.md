...
**Test Query:** Q7_135_seed_1099340154
...
```
Node 11185 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 11186 (Gather Merge) [consumed]
    Node 11187 (Sort)
      Node 11188 (Hash Join)
        Node 11189 (Nested Loop)
          Node 11190 (Hash Join) [PATTERN: 895c6e8c]
            Node 11191 (Seq Scan) [consumed] - LEAF
            Node 11192 (Hash) [consumed]
              Node 11193 (Hash Join) [PATTERN: f4cb205a]
                Node 11194 (Seq Scan) [consumed] - LEAF
                Node 11195 (Hash) [consumed]
                  Node 11196 (Seq Scan) [consumed] - LEAF
          Node 11197 (Index Scan) - LEAF
        Node 11198 (Hash)
          Node 11199 (Hash Join) [PATTERN: f4cb205a]
            Node 11200 (Seq Scan) [consumed] - LEAF
            Node 11201 (Hash) [consumed]
              Node 11202 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 11193 | 11185, 11186, 11190, 11191, 11192, 11194, 11195, 11196, 11199, 11200, 11201, 11202 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 11199 | 11185, 11186, 11190, 11191, 11192, 11193, 11194, 11195, 11196, 11200, 11201, 11202 |
| Aggregate -> Gather Merge (Out | 2724c080 | 11185 | 11186, 11190, 11191, 11192, 11193, 11194, 11195, 11196, 11199, 11200, 11201, 11202 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 11190 | 11185, 11186, 11191, 11192, 11193, 11194, 11195, 11196, 11199, 11200, 11201, 11202 |
...
|------|------|--------|-----------|-----|--------|
| 11185 | Aggregate | 1178.25 | 1163.13 | 1.3% | pattern |
| 11187 | Sort | 1170.89 | 1109.16 | 5.3% | operator |
| 11188 | Hash Join | 1170.30 | 843.11 | 28.0% | operator |
| 11189 | Nested Loop | 1162.75 | 1215.99 | 4.6% | operator |
| 11198 | Hash | 3.66 | 27.74 | 657.6% | operator |
| 11190 | Hash Join | 214.33 | 304.89 | 42.3% | pattern |
| 11197 | Index Scan | 0.03 | 0.96 | 3006.0% | operator |
| 11199 | Hash Join | 3.61 | 429.36 | 11806.9% | pattern |
| 11193 | Hash Join | 36.78 | 429.38 | 1067.3% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11193 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 11185, 11186, 11190, 11191, 11192, 11194, 11195, 11196, 11199, 11200, 11201, 11202
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5000
  - HashJoin_nt1=62500
...
### Step 2: Node 11190 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 11185, 11186, 11191, 11192, 11193, 11194, 11195, 11196, 11199, 11200, 11201, 11202
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=38710
  - HashJoin_nt1=483871
...
### Step 3: Node 11197 (Index Scan) - LEAF
...
### Step 4: Node 11199 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 11185, 11186, 11190, 11191, 11192, 11193, 11194, 11195, 11196, 11200, 11201, 11202
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=800
  - HashJoin_nt1=10000
...
### Step 9: Node 11185 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 11186, 11190, 11191, 11192, 11193, 11194, 11195, 11196, 11199, 11200, 11201, 11202
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
