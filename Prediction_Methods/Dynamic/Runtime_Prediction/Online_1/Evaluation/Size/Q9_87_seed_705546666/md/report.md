...
```
Node 19098 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 19099 (Aggregate) [consumed]
    Node 19100 (Gather)
      Node 19101 (Aggregate)
        Node 19102 (Nested Loop)
          Node 19103 (Hash Join) [PATTERN: bb930825]
            Node 19104 (Seq Scan) [consumed] - LEAF
            Node 19105 (Hash) [consumed]
              Node 19106 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 19103 | 19098, 19099, 19104, 19105, 19106 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 19098 | 19099, 19103, 19104, 19105, 19106 |
...
|------|------|--------|-----------|-----|--------|
| 19098 | Sort | 1176.48 | 1047.04 | 11.0% | pattern |
...
| 19103 | Hash Join | 950.66 | 134.80 | 85.8% | pattern |
...
### Step 9: Node 19103 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 19098, 19099, 19104, 19105, 19106
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 19115 (Index Scan) - LEAF
...
### Step 11: Node 19102 (Nested Loop)
...
### Step 14: Node 19098 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 19099, 19103, 19104, 19105, 19106
- **Input Features:**
