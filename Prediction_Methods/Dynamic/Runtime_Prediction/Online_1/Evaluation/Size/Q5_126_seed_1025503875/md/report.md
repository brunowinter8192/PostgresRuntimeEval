...
**Test Query:** Q5_126_seed_1025503875
...
```
Node 7461 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 7462 (Aggregate) [consumed]
    Node 7463 (Gather Merge) [consumed]
      Node 7464 (Aggregate)
        Node 7465 (Sort) [PATTERN: 3e2d5a00]
          Node 7466 (Hash Join) [consumed]
            Node 7467 (Nested Loop)
              Node 7468 (Hash Join)
                Node 7469 (Seq Scan) - LEAF
                Node 7470 (Hash) [PATTERN: 444761fb]
                  Node 7471 (Hash Join) [consumed]
                    Node 7472 (Seq Scan) [consumed] - LEAF
                    Node 7473 (Hash) [consumed]
                      Node 7474 (Hash Join) [consumed]
                        Node 7475 (Seq Scan) - LEAF
                        Node 7476 (Hash)
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 7470 | 7461, 7462, 7463, 7465, 7466, 7471, 7472, 7473, 7474 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 7461 | 7462, 7463, 7465, 7466, 7470, 7471, 7472, 7473, 7474 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 7465 | 7461, 7462, 7463, 7466, 7470, 7471, 7472, 7473, 7474 |
...
|------|------|--------|-----------|-----|--------|
| 7461 | Sort | 1054.56 | 2934.42 | 178.3% | pattern |
| 7464 | Aggregate | 1049.67 | 1128.78 | 7.5% | operator |
| 7465 | Sort | 1049.42 | 1835.91 | 74.9% | pattern |
| 7467 | Nested Loop | 1036.72 | 1188.39 | 14.6% | operator |
| 7479 | Hash | 4.20 | 18.67 | 344.8% | operator |
| 7468 | Hash Join | 214.48 | 253.07 | 18.0% | operator |
| 7478 | Index Scan | 0.07 | -0.22 | 401.4% | operator |
| 7480 | Seq Scan | 3.68 | 12.36 | 236.0% | operator |
| 7469 | Seq Scan | 166.52 | 159.81 | 4.0% | operator |
| 7470 | Hash | 35.44 | 46.85 | 32.2% | pattern |
| 7475 | Seq Scan | 0.01 | 11.81 | 147503.4% | operator |
| 7476 | Hash | 0.06 | 21.05 | 35583.5% | operator |
| 7477 | Seq Scan | 0.06 | 22.93 | 41597.0% | operator |
...
### Step 2: Node 7475 (Seq Scan) - LEAF
...
### Step 4: Node 7469 (Seq Scan) - LEAF
...
### Step 5: Node 7470 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 7461, 7462, 7463, 7465, 7466, 7471, 7472, 7473, 7474
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 7478 (Index Scan) - LEAF
...
### Step 8: Node 7480 (Seq Scan) - LEAF
...
- **Output:** st=100.24, rt=1188.39

### Step 10: Node 7479 (Hash)
...
### Step 11: Node 7465 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 7461, 7462, 7463, 7466, 7470, 7471, 7472, 7473, 7474
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=2344
  - HashJoin_Outer_nt1=58597
  ...
  - HashJoin_Outer_total_cost=56760.4200
  - Sort_np=0
  - Sort_nt=2344
  - Sort_nt1=2344
  - Sort_nt2=0
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=56891.6200
  - Sort_total_cost=56897.4800
- **Output:** st=1835.89, rt=1835.91

### Step 12: Node 7464 (Aggregate)
...
- **Output:** st=1065.15, rt=1128.78

### Step 13: Node 7461 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 7462, 7463, 7465, 7466, 7470, 7471, 7472, 7473, 7474
- **Input Features:**
