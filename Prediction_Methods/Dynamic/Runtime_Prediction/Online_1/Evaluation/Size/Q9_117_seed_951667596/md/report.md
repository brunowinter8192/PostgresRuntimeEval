    ...
    Node 16980 (Gather)
      Node 16981 (Aggregate)
        Node 16982 (Nested Loop)
          Node 16983 (Hash Join) [PATTERN: bb930825]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 16983 | 16978, 16979, 16984, 16985, 16986 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 16978 | 16979, 16983, 16984, 16985, 16986 |
...
|------|------|--------|-----------|-----|--------|
| 16978 | Sort | 1172.38 | 1044.79 | 10.9% | pattern |
| 16980 | Gather | 1170.82 | 964.87 | 17.6% | operator |
| 16981 | Aggregate | 1152.15 | 1117.47 | 3.0% | operator |
| 16982 | Nested Loop | 1126.56 | 1252.17 | 11.2% | operator |
| 16983 | Hash Join | 951.17 | 134.80 | 85.8% | pattern |
| 16995 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 16987 | Hash Join | 170.82 | 837.55 | 390.3% | operator |
| 16993 | Hash | 12.72 | 14.95 | 17.5% | operator |
| 16988 | Nested Loop | 165.04 | 1251.76 | 658.5% | operator |
| 16991 | Hash | 3.56 | 15.94 | 347.1% | operator |
| 16994 | Seq Scan | 12.71 | 2.94 | 76.9% | operator |
| 16989 | Seq Scan | 21.07 | 44.17 | 109.7% | operator |
| 16990 | Index Scan | 0.08 | -1.39 | 1857.6% | operator |
| 16992 | Seq Scan | 2.98 | 9.45 | 216.4% | operator |
...
### Step 9: Node 16983 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 16978, 16979, 16984, 16985, 16986
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 11: Node 16982 (Nested Loop)
...
### Step 14: Node 16978 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 16979, 16983, 16984, 16985, 16986
- **Input Features:**
