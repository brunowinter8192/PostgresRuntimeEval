...
```
Node 10365 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10366 (Gather) [consumed]
    Node 10367 (Aggregate) [consumed]
      Node 10368 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10365 | 10366, 10367 |
...
|------|------|--------|-----------|-----|--------|
| 10365 | Aggregate | 836.92 | 850.06 | 1.6% | pattern |
| 10368 | Seq Scan | 816.08 | 748.54 | 8.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10368 (Seq Scan) - LEAF
...
### Step 2: Node 10365 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10366, 10367
- **Input Features:**
