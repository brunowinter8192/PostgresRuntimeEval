...
**Test Query:** Q4_31_seed_246120930
...
```
Node 6369 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6370 (Gather Merge) [consumed]
    Node 6371 (Sort) [consumed]
      Node 6372 (Aggregate) [consumed]
        Node 6373 (Nested Loop)
          Node 6374 (Seq Scan) - LEAF
          Node 6375 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6369 | 6370, 6371, 6372 |
...
|------|------|--------|-----------|-----|--------|
| 6369 | Aggregate | 1061.12 | 952.19 | 10.3% | pattern |
| 6373 | Nested Loop | 1054.62 | 1255.45 | 19.0% | operator |
| 6374 | Seq Scan | 163.66 | 154.66 | 5.5% | operator |
| 6375 | Index Scan | 0.06 | 11.10 | 17810.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6374 (Seq Scan) - LEAF
...
### Step 2: Node 6375 (Index Scan) - LEAF
