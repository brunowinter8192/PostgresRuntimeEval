...
**Test Query:** Q12_105_seed_853219224
...
```
Node 24355 (Aggregate) - ROOT
  Node 24356 (Gather Merge)
    Node 24357 (Aggregate)
      Node 24358 (Sort)
        Node 24359 (Nested Loop)
          Node 24360 (Seq Scan) - LEAF
          Node 24361 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24355 | Aggregate | 994.85 | 919.05 | 7.6% | operator |
| 24356 | Gather Merge | 994.82 | 1111.84 | 11.8% | operator |
| 24357 | Aggregate | 975.06 | 895.30 | 8.2% | operator |
| 24358 | Sort | 974.39 | 1092.82 | 12.2% | operator |
| 24359 | Nested Loop | 973.32 | 1127.41 | 15.8% | operator |
| 24360 | Seq Scan | 835.07 | 745.19 | 10.8% | operator |
| 24361 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24360 (Seq Scan) - LEAF
...
### Step 2: Node 24361 (Index Scan) - LEAF
...
### Step 6: Node 24356 (Gather Merge)
...
### Step 7: Node 24355 (Aggregate) - ROOT
