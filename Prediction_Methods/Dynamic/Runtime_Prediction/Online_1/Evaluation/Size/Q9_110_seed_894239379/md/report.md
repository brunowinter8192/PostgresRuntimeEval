...
**Test Query:** Q9_110_seed_894239379
...
Node 16850 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 16851 (Aggregate) [consumed]
    Node 16852 (Gather)
      Node 16853 (Aggregate)
        Node 16854 (Nested Loop)
          Node 16855 (Hash Join) [PATTERN: bb930825]
            Node 16856 (Seq Scan) [consumed] - LEAF
            Node 16857 (Hash) [consumed]
              Node 16858 (Hash Join) [consumed]
                Node 16859 (Hash Join)
                  Node 16860 (Nested Loop)
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 16855 | 16850, 16851, 16856, 16857, 16858 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 16850 | 16851, 16855, 16856, 16857, 16858 |
...
|------|------|--------|-----------|-----|--------|
| 16850 | Sort | 1208.76 | 1045.86 | 13.5% | pattern |
| 16852 | Gather | 1207.59 | 964.48 | 20.1% | operator |
| 16853 | Aggregate | 1189.16 | 1075.81 | 9.5% | operator |
| 16854 | Nested Loop | 1165.29 | 1252.17 | 7.5% | operator |
| 16855 | Hash Join | 994.04 | 134.80 | 86.4% | pattern |
| 16867 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 16859 | Hash Join | 168.35 | 837.66 | 397.6% | operator |
| 16865 | Hash | 12.99 | 14.95 | 15.1% | operator |
| 16860 | Nested Loop | 160.69 | 1251.77 | 679.0% | operator |
| 16863 | Hash | 5.67 | 15.94 | 181.1% | operator |
| 16866 | Seq Scan | 12.97 | 2.94 | 77.4% | operator |
| 16861 | Seq Scan | 19.52 | 43.89 | 124.9% | operator |
| 16862 | Index Scan | 0.08 | -1.39 | 1903.2% | operator |
| 16864 | Seq Scan | 5.17 | 9.45 | 82.9% | operator |
...
### Step 6: Node 16866 (Seq Scan) - LEAF
...
### Step 9: Node 16855 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 16850, 16851, 16856, 16857, 16858
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=20708
  - HashJoin_Outer_nt1=20708
  ...
  - HashJoin_Outer_total_cost=15400.7600
  - HashJoin_np=0
  - HashJoin_nt=74565
...
### Step 10: Node 16867 (Index Scan) - LEAF
...
### Step 11: Node 16854 (Nested Loop)
...
### Step 14: Node 16850 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 16851, 16855, 16856, 16857, 16858
- **Input Features:**
