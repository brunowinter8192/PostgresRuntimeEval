...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 98 | 99 |
...
|------|------|--------|-----------|-----|--------|
| 96 | Aggregate | 1008.96 | 1195.83 | 18.5% | operator |
| 97 | Gather Merge | 1008.89 | 1165.89 | 15.6% | operator |
| 98 | Sort | 988.71 | 1200.28 | 21.4% | pattern |
...
### Step 2: Node 98 (Sort) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=168809.8400
  - Sort_total_cost=168809.8500
- **Output:** st=1196.18, rt=1200.28

### Step 3: Node 97 (Gather Merge)
