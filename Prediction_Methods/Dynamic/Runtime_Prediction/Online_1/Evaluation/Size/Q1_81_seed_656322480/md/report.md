...
**Test Query:** Q1_81_seed_656322480
...
```
Node 646 (Aggregate) - ROOT
  Node 647 (Gather Merge)
    Node 648 (Sort) [PATTERN: 1d35fb97]
      Node 649 (Aggregate) [consumed]
        Node 650 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 648 | 649 |
...
|------|------|--------|-----------|-----|--------|
| 646 | Aggregate | 985.35 | 1195.96 | 21.4% | operator |
| 647 | Gather Merge | 985.29 | 1165.93 | 18.3% | operator |
| 648 | Sort | 969.15 | 1200.77 | 23.9% | pattern |
| 650 | Seq Scan | 573.20 | 679.26 | 18.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 650 (Seq Scan) - LEAF
...
### Step 2: Node 648 (Sort) - PATTERN ROOT
...
### Step 4: Node 646 (Aggregate) - ROOT
