...
```
Node 7621 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 7622 (Aggregate) [consumed]
    Node 7623 (Gather Merge) [consumed]
      Node 7624 (Aggregate)
          ...
          Node 7626 (Hash Join) [consumed]
            Node 7627 (Nested Loop)
              Node 7628 (Hash Join)
                ...
                Node 7630 (Hash) [PATTERN: 444761fb]
                  Node 7631 (Hash Join) [consumed]
                    Node 7632 (Seq Scan) [consumed] - LEAF
                    Node 7633 (Hash) [consumed]
                      Node 7634 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 7630 | 7621, 7622, 7623, 7625, 7626, 7631, 7632, 7633, 7634 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 7621 | 7622, 7623, 7625, 7626, 7630, 7631, 7632, 7633, 7634 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 7625 | 7621, 7622, 7623, 7626, 7630, 7631, 7632, 7633, 7634 |
...
|------|------|--------|-----------|-----|--------|
| 7621 | Sort | 1078.37 | 2934.42 | 172.1% | pattern |
| 7624 | Aggregate | 1073.12 | 1128.74 | 5.2% | operator |
| 7625 | Sort | 1072.87 | 1835.96 | 71.1% | pattern |
| 7627 | Nested Loop | 1059.73 | 1188.57 | 12.2% | operator |
| 7639 | Hash | 4.69 | 18.67 | 298.4% | operator |
| 7628 | Hash Join | 216.20 | 253.07 | 17.1% | operator |
| 7638 | Index Scan | 0.07 | -0.22 | 405.6% | operator |
| 7640 | Seq Scan | 4.18 | 12.36 | 195.6% | operator |
| 7629 | Seq Scan | 170.89 | 159.81 | 6.5% | operator |
| 7630 | Hash | 32.66 | 46.85 | 43.5% | pattern |
| 7635 | Seq Scan | 0.01 | 11.81 | 147503.4% | operator |
| 7636 | Hash | 0.06 | 21.05 | 37495.1% | operator |
| 7637 | Seq Scan | 0.05 | 22.93 | 42369.1% | operator |
...
### Step 4: Node 7629 (Seq Scan) - LEAF
...
### Step 5: Node 7630 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 7621, 7622, 7623, 7625, 7626, 7631, 7632, 7633, 7634
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 7638 (Index Scan) - LEAF
...
### Step 8: Node 7640 (Seq Scan) - LEAF
...
### Step 11: Node 7625 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 7621, 7622, 7623, 7626, 7630, 7631, 7632, 7633, 7634
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 7621 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 7622, 7623, 7625, 7626, 7630, 7631, 7632, 7633, 7634
- **Input Features:**
