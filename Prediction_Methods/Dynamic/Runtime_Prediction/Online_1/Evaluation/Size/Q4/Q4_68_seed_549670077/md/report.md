...
**Test Query:** Q4_68_seed_549670077
...
```
Node 6649 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6650 (Gather Merge) [consumed]
    Node 6651 (Sort) [consumed]
      Node 6652 (Aggregate) [consumed]
        Node 6653 (Nested Loop)
          Node 6654 (Seq Scan) - LEAF
          Node 6655 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6649 | 6650, 6651, 6652 |
...
|------|------|--------|-----------|-----|--------|
| 6649 | Aggregate | 1090.85 | 952.19 | 12.7% | pattern |
| 6653 | Nested Loop | 1083.98 | 1255.45 | 15.8% | operator |
| 6654 | Seq Scan | 167.93 | 154.67 | 7.9% | operator |
| 6655 | Index Scan | 0.07 | 11.10 | 16983.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6654 (Seq Scan) - LEAF
...
### Step 2: Node 6655 (Index Scan) - LEAF
