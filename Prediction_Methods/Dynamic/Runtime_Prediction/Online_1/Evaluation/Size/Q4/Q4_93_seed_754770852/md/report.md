...
**Test Query:** Q4_93_seed_754770852
...
```
Node 6845 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6846 (Gather Merge) [consumed]
    Node 6847 (Sort) [consumed]
      Node 6848 (Aggregate) [consumed]
        Node 6849 (Nested Loop)
          Node 6850 (Seq Scan) - LEAF
          Node 6851 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6845 | 6846, 6847, 6848 |
...
|------|------|--------|-----------|-----|--------|
| 6845 | Aggregate | 1100.83 | 952.19 | 13.5% | pattern |
| 6849 | Nested Loop | 1093.80 | 1255.45 | 14.8% | operator |
| 6850 | Seq Scan | 167.88 | 154.66 | 7.9% | operator |
| 6851 | Index Scan | 0.07 | 11.10 | 16983.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6850 (Seq Scan) - LEAF
...
### Step 2: Node 6851 (Index Scan) - LEAF
