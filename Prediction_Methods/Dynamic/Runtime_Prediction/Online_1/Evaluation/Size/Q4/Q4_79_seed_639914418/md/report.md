...
**Test Query:** Q4_79_seed_639914418
...
```
Node 6733 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6734 (Gather Merge) [consumed]
    Node 6735 (Sort) [consumed]
      Node 6736 (Aggregate) [consumed]
        Node 6737 (Nested Loop)
          Node 6738 (Seq Scan) - LEAF
          Node 6739 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6733 | 6734, 6735, 6736 |
...
|------|------|--------|-----------|-----|--------|
| 6733 | Aggregate | 1059.33 | 952.19 | 10.1% | pattern |
| 6737 | Nested Loop | 1052.35 | 1255.45 | 19.3% | operator |
| 6738 | Seq Scan | 165.32 | 154.66 | 6.4% | operator |
| 6739 | Index Scan | 0.06 | 11.10 | 17810.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6738 (Seq Scan) - LEAF
...
### Step 2: Node 6739 (Index Scan) - LEAF
