...
**Test Query:** Q4_67_seed_541466046
...
```
Node 6642 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6643 (Gather Merge) [consumed]
    Node 6644 (Sort) [consumed]
      Node 6645 (Aggregate) [consumed]
        Node 6646 (Nested Loop)
          Node 6647 (Seq Scan) - LEAF
          Node 6648 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6642 | 6643, 6644, 6645 |
...
|------|------|--------|-----------|-----|--------|
| 6642 | Aggregate | 1058.89 | 952.19 | 10.1% | pattern |
| 6646 | Nested Loop | 1052.43 | 1255.45 | 19.3% | operator |
| 6647 | Seq Scan | 163.99 | 154.66 | 5.7% | operator |
| 6648 | Index Scan | 0.06 | 11.10 | 17810.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6647 (Seq Scan) - LEAF
...
### Step 2: Node 6648 (Index Scan) - LEAF
