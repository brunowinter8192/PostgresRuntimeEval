...
**Test Query:** Q4_88_seed_713750697
...
```
Node 6803 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6804 (Gather Merge) [consumed]
    Node 6805 (Sort) [consumed]
      Node 6806 (Aggregate) [consumed]
        Node 6807 (Nested Loop)
          Node 6808 (Seq Scan) - LEAF
          Node 6809 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6803 | 6804, 6805, 6806 |
...
|------|------|--------|-----------|-----|--------|
| 6803 | Aggregate | 1121.38 | 952.19 | 15.1% | pattern |
| 6807 | Nested Loop | 1113.96 | 1255.45 | 12.7% | operator |
| 6808 | Seq Scan | 172.44 | 154.66 | 10.3% | operator |
| 6809 | Index Scan | 0.07 | 11.10 | 16724.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6808 (Seq Scan) - LEAF
...
### Step 2: Node 6809 (Index Scan) - LEAF
