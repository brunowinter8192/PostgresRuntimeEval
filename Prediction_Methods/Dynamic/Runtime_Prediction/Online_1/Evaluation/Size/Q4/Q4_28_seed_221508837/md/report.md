...
**Test Query:** Q4_28_seed_221508837
...
```
Node 6341 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6342 (Gather Merge) [consumed]
    Node 6343 (Sort) [consumed]
      Node 6344 (Aggregate) [consumed]
        Node 6345 (Nested Loop)
          Node 6346 (Seq Scan) - LEAF
          Node 6347 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6341 | 6342, 6343, 6344 |
...
|------|------|--------|-----------|-----|--------|
| 6341 | Aggregate | 1077.04 | 952.19 | 11.6% | pattern |
| 6345 | Nested Loop | 1068.82 | 1255.45 | 17.5% | operator |
| 6346 | Seq Scan | 167.59 | 154.66 | 7.7% | operator |
| 6347 | Index Scan | 0.06 | 11.10 | 17250.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6346 (Seq Scan) - LEAF
...
### Step 2: Node 6347 (Index Scan) - LEAF
