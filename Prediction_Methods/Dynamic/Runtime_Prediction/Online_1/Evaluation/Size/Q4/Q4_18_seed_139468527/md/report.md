...
**Test Query:** Q4_18_seed_139468527
...
```
Node 6264 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6265 (Gather Merge) [consumed]
    Node 6266 (Sort) [consumed]
      Node 6267 (Aggregate) [consumed]
        Node 6268 (Nested Loop)
          Node 6269 (Seq Scan) - LEAF
          Node 6270 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6264 | 6265, 6266, 6267 |
...
|------|------|--------|-----------|-----|--------|
| 6264 | Aggregate | 1052.84 | 952.19 | 9.6% | pattern |
| 6268 | Nested Loop | 1046.18 | 1255.45 | 20.0% | operator |
| 6269 | Seq Scan | 162.33 | 154.67 | 4.7% | operator |
| 6270 | Index Scan | 0.06 | 11.10 | 17526.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6269 (Seq Scan) - LEAF
...
### Step 2: Node 6270 (Index Scan) - LEAF
