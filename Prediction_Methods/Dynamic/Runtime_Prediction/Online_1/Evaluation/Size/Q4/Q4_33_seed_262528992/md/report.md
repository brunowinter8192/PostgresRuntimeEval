...
```
Node 6383 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6384 (Gather Merge) [consumed]
    Node 6385 (Sort) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6383 | 6384, 6385, 6386 |
...
|------|------|--------|-----------|-----|--------|
| 6383 | Aggregate | 1067.59 | 952.19 | 10.8% | pattern |
| 6387 | Nested Loop | 1060.72 | 1255.45 | 18.4% | operator |
| 6388 | Seq Scan | 165.52 | 154.66 | 6.6% | operator |
| 6389 | Index Scan | 0.06 | 11.10 | 17810.2% | operator |
...
### Step 4: Node 6383 (Aggregate) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Sort_Outer_startup_cost=65999.7500
  - Sort_Outer_total_cost=65999.7600
