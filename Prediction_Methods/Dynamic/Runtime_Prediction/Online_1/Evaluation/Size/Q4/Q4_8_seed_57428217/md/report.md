...
```
Node 6817 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6818 (Gather Merge) [consumed]
    Node 6819 (Sort) [consumed]
      Node 6820 (Aggregate) [consumed]
        Node 6821 (Nested Loop)
          Node 6822 (Seq Scan) - LEAF
          Node 6823 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6817 | 6818, 6819, 6820 |
...
|------|------|--------|-----------|-----|--------|
| 6817 | Aggregate | 1061.58 | 952.19 | 10.3% | pattern |
| 6821 | Nested Loop | 1054.72 | 1255.45 | 19.0% | operator |
| 6822 | Seq Scan | 164.25 | 154.66 | 5.8% | operator |
| 6823 | Index Scan | 0.06 | 11.10 | 17810.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6822 (Seq Scan) - LEAF
...
### Step 2: Node 6823 (Index Scan) - LEAF
