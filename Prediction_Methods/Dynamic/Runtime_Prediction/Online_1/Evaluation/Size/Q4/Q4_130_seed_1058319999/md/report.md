...
**Test Query:** Q4_130_seed_1058319999
**Timestamp:** 2025-12-21 14:55:53
...
```
Node 6082 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6083 (Gather Merge) [consumed]
    Node 6084 (Sort) [consumed]
      Node 6085 (Aggregate) [consumed]
        Node 6086 (Nested Loop)
          Node 6087 (Seq Scan) - LEAF
          Node 6088 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6082 | 6083, 6084, 6085 |
...
|------|------|--------|-----------|-----|--------|
| 6082 | Aggregate | 1046.43 | 952.19 | 9.0% | pattern |
| 6086 | Nested Loop | 1039.03 | 1255.45 | 20.8% | operator |
| 6087 | Seq Scan | 164.06 | 154.66 | 5.7% | operator |
| 6088 | Index Scan | 0.06 | 11.10 | 18103.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6087 (Seq Scan) - LEAF
...
### Step 2: Node 6088 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - Aggregate_startup_cost=67108.1800
  - Aggregate_total_cost=67110.0800
  ...
  - GatherMerge_Outer_startup_cost=67108.1800
  - GatherMerge_Outer_total_cost=67109.9500
  - Sort_Outer_np=0
  - Sort_Outer_nt=5
  - Sort_Outer_nt1=5
  - Sort_Outer_nt2=0
  ...
  - Sort_Outer_startup_cost=66108.1400
  - Sort_Outer_total_cost=66108.1500
