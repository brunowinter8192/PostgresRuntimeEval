...
**Test Query:** Q4_134_seed_1091136123
**Timestamp:** 2025-12-21 14:55:54
...
```
Node 6110 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6111 (Gather Merge) [consumed]
    Node 6112 (Sort) [consumed]
      Node 6113 (Aggregate) [consumed]
        Node 6114 (Nested Loop)
          Node 6115 (Seq Scan) - LEAF
          Node 6116 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6110 | 6111, 6112, 6113 |
...
|------|------|--------|-----------|-----|--------|
| 6110 | Aggregate | 1066.74 | 952.19 | 10.7% | pattern |
| 6114 | Nested Loop | 1059.38 | 1255.45 | 18.5% | operator |
| 6115 | Seq Scan | 164.06 | 154.66 | 5.7% | operator |
| 6116 | Index Scan | 0.06 | 11.10 | 17810.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6115 (Seq Scan) - LEAF
...
### Step 2: Node 6116 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - Aggregate_startup_cost=66884.9100
  - Aggregate_total_cost=66886.8100
  ...
  - GatherMerge_Outer_startup_cost=66884.9100
  - GatherMerge_Outer_total_cost=66886.6800
  - Sort_Outer_np=0
  - Sort_Outer_nt=5
  - Sort_Outer_nt1=5
  - Sort_Outer_nt2=0
  ...
  - Sort_Outer_startup_cost=65884.8700
  - Sort_Outer_total_cost=65884.8800
