...
**Test Query:** Q4_23_seed_180488682
...
```
Node 6306 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6307 (Gather Merge) [consumed]
    Node 6308 (Sort) [consumed]
      Node 6309 (Aggregate) [consumed]
        Node 6310 (Nested Loop)
          Node 6311 (Seq Scan) - LEAF
          Node 6312 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6306 | 6307, 6308, 6309 |
...
|------|------|--------|-----------|-----|--------|
| 6306 | Aggregate | 1056.44 | 952.19 | 9.9% | pattern |
| 6310 | Nested Loop | 1049.87 | 1255.45 | 19.6% | operator |
| 6311 | Seq Scan | 166.17 | 154.66 | 6.9% | operator |
| 6312 | Index Scan | 0.06 | 11.10 | 18103.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6311 (Seq Scan) - LEAF
...
### Step 2: Node 6312 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - Aggregate_startup_cost=67056.1500
  - Aggregate_total_cost=67058.0500
  ...
  - GatherMerge_Outer_startup_cost=67056.1500
  - GatherMerge_Outer_total_cost=67057.9200
  - Sort_Outer_np=0
  - Sort_Outer_nt=5
  - Sort_Outer_nt1=5
  - Sort_Outer_nt2=0
  ...
  - Sort_Outer_startup_cost=66056.1100
  - Sort_Outer_total_cost=66056.1200
