...
**Test Query:** Q4_77_seed_623506356
**Timestamp:** 2025-12-21 15:03:00
...
```
Node 6719 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6720 (Gather Merge) [consumed]
    Node 6721 (Sort) [consumed]
      Node 6722 (Aggregate) [consumed]
        Node 6723 (Nested Loop)
          Node 6724 (Seq Scan) - LEAF
          Node 6725 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6719 | 6720, 6721, 6722 |
...
|------|------|--------|-----------|-----|--------|
| 6719 | Aggregate | 1086.09 | 952.19 | 12.3% | pattern |
| 6723 | Nested Loop | 1079.81 | 1255.45 | 16.3% | operator |
| 6724 | Seq Scan | 165.39 | 154.66 | 6.5% | operator |
| 6725 | Index Scan | 0.06 | 11.10 | 17250.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6724 (Seq Scan) - LEAF
...
### Step 2: Node 6725 (Index Scan) - LEAF
