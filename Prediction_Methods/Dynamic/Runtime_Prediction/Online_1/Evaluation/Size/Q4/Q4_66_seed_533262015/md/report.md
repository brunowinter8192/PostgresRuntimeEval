...
**Test Query:** Q4_66_seed_533262015
...
```
Node 6635 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6636 (Gather Merge) [consumed]
    Node 6637 (Sort) [consumed]
      Node 6638 (Aggregate) [consumed]
        Node 6639 (Nested Loop)
          Node 6640 (Seq Scan) - LEAF
          Node 6641 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6635 | 6636, 6637, 6638 |
...
|------|------|--------|-----------|-----|--------|
| 6635 | Aggregate | 1062.57 | 952.19 | 10.4% | pattern |
| 6639 | Nested Loop | 1055.91 | 1255.45 | 18.9% | operator |
| 6640 | Seq Scan | 164.90 | 154.67 | 6.2% | operator |
| 6641 | Index Scan | 0.06 | 11.10 | 17810.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6640 (Seq Scan) - LEAF
...
### Step 2: Node 6641 (Index Scan) - LEAF
