...
**Test Query:** Q4_86_seed_697342635
...
```
Node 6789 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6790 (Gather Merge) [consumed]
    Node 6791 (Sort) [consumed]
      Node 6792 (Aggregate) [consumed]
        Node 6793 (Nested Loop)
          Node 6794 (Seq Scan) - LEAF
          Node 6795 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6789 | 6790, 6791, 6792 |
...
|------|------|--------|-----------|-----|--------|
| 6789 | Aggregate | 1053.56 | 952.19 | 9.6% | pattern |
| 6793 | Nested Loop | 1046.40 | 1255.45 | 20.0% | operator |
| 6794 | Seq Scan | 168.60 | 154.66 | 8.3% | operator |
| 6795 | Index Scan | 0.06 | 11.10 | 18103.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6794 (Seq Scan) - LEAF
...
### Step 2: Node 6795 (Index Scan) - LEAF
