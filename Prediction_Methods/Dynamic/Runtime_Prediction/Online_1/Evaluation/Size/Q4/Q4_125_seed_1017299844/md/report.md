...
**Test Query:** Q4_125_seed_1017299844
...
```
Node 6040 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6041 (Gather Merge) [consumed]
    Node 6042 (Sort) [consumed]
      Node 6043 (Aggregate) [consumed]
        Node 6044 (Nested Loop)
          Node 6045 (Seq Scan) - LEAF
          Node 6046 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6040 | 6041, 6042, 6043 |
...
|------|------|--------|-----------|-----|--------|
| 6040 | Aggregate | 1074.12 | 952.19 | 11.4% | pattern |
| 6044 | Nested Loop | 1065.52 | 1255.45 | 17.8% | operator |
| 6045 | Seq Scan | 161.94 | 154.66 | 4.5% | operator |
| 6046 | Index Scan | 0.06 | 11.10 | 17810.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6045 (Seq Scan) - LEAF
...
### Step 2: Node 6046 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - Aggregate_startup_cost=67019.0500
  - Aggregate_total_cost=67020.9500
  ...
  - GatherMerge_Outer_startup_cost=67019.0500
  - GatherMerge_Outer_total_cost=67020.8300
  - Sort_Outer_np=0
  - Sort_Outer_nt=5
  - Sort_Outer_nt1=5
  - Sort_Outer_nt2=0
  ...
  - Sort_Outer_startup_cost=66019.0100
  - Sort_Outer_total_cost=66019.0200
