...
**Test Query:** Q4_78_seed_631710387
...
```
Node 6726 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6727 (Gather Merge) [consumed]
    Node 6728 (Sort) [consumed]
      Node 6729 (Aggregate) [consumed]
        Node 6730 (Nested Loop)
          Node 6731 (Seq Scan) - LEAF
          Node 6732 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6726 | 6727, 6728, 6729 |
...
|------|------|--------|-----------|-----|--------|
| 6726 | Aggregate | 1051.61 | 952.19 | 9.5% | pattern |
| 6730 | Nested Loop | 1044.48 | 1255.45 | 20.2% | operator |
| 6731 | Seq Scan | 163.38 | 154.66 | 5.3% | operator |
| 6732 | Index Scan | 0.06 | 11.10 | 18103.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6731 (Seq Scan) - LEAF
...
### Step 2: Node 6732 (Index Scan) - LEAF
