...
**Test Query:** Q4_87_seed_705546666
...
```
Node 6796 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6797 (Gather Merge) [consumed]
    Node 6798 (Sort) [consumed]
      Node 6799 (Aggregate) [consumed]
        Node 6800 (Nested Loop)
          Node 6801 (Seq Scan) - LEAF
          Node 6802 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6796 | 6797, 6798, 6799 |
...
|------|------|--------|-----------|-----|--------|
| 6796 | Aggregate | 1068.76 | 952.19 | 10.9% | pattern |
| 6800 | Nested Loop | 1061.63 | 1255.45 | 18.3% | operator |
| 6801 | Seq Scan | 166.79 | 154.66 | 7.3% | operator |
| 6802 | Index Scan | 0.06 | 11.10 | 17810.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6801 (Seq Scan) - LEAF
...
### Step 2: Node 6802 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - Aggregate_total_cost=67045.6300
  ...
  - GatherMerge_Outer_total_cost=67045.5100
  - Sort_Outer_np=0
  - Sort_Outer_nt=5
  - Sort_Outer_nt1=5
  - Sort_Outer_nt2=0
  ...
  - Sort_Outer_startup_cost=66043.6900
  - Sort_Outer_total_cost=66043.7100
