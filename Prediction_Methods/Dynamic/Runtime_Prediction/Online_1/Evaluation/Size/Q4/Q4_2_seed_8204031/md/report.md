...
```
Node 6355 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6356 (Gather Merge) [consumed]
    Node 6357 (Sort) [consumed]
      Node 6358 (Aggregate) [consumed]
        Node 6359 (Nested Loop)
          Node 6360 (Seq Scan) - LEAF
          Node 6361 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6355 | 6356, 6357, 6358 |
...
|------|------|--------|-----------|-----|--------|
| 6355 | Aggregate | 1044.11 | 952.19 | 8.8% | pattern |
| 6359 | Nested Loop | 1036.96 | 1255.45 | 21.1% | operator |
| 6360 | Seq Scan | 163.57 | 154.66 | 5.4% | operator |
| 6361 | Index Scan | 0.06 | 11.10 | 18103.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6360 (Seq Scan) - LEAF
...
### Step 2: Node 6361 (Index Scan) - LEAF
