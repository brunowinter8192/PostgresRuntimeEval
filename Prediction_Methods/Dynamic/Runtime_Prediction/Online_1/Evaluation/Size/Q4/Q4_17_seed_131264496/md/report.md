...
**Test Query:** Q4_17_seed_131264496
...
```
Node 6257 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6258 (Gather Merge) [consumed]
    Node 6259 (Sort) [consumed]
      Node 6260 (Aggregate) [consumed]
        Node 6261 (Nested Loop)
          Node 6262 (Seq Scan) - LEAF
          Node 6263 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6257 | 6258, 6259, 6260 |
...
|------|------|--------|-----------|-----|--------|
| 6257 | Aggregate | 1069.27 | 952.19 | 10.9% | pattern |
| 6261 | Nested Loop | 1062.99 | 1255.45 | 18.1% | operator |
| 6262 | Seq Scan | 161.82 | 154.66 | 4.4% | operator |
| 6263 | Index Scan | 0.06 | 11.10 | 17810.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6262 (Seq Scan) - LEAF
...
### Step 2: Node 6263 (Index Scan) - LEAF
