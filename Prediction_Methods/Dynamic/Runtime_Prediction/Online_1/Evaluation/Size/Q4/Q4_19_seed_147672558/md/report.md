...
**Test Query:** Q4_19_seed_147672558
...
```
Node 6271 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6272 (Gather Merge) [consumed]
    Node 6273 (Sort) [consumed]
      Node 6274 (Aggregate) [consumed]
        Node 6275 (Nested Loop)
          Node 6276 (Seq Scan) - LEAF
          Node 6277 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6271 | 6272, 6273, 6274 |
...
|------|------|--------|-----------|-----|--------|
| 6271 | Aggregate | 1040.59 | 952.19 | 8.5% | pattern |
| 6275 | Nested Loop | 1033.49 | 1255.45 | 21.5% | operator |
| 6276 | Seq Scan | 161.43 | 154.66 | 4.2% | operator |
| 6277 | Index Scan | 0.06 | 11.10 | 18103.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6276 (Seq Scan) - LEAF
...
### Step 2: Node 6277 (Index Scan) - LEAF
