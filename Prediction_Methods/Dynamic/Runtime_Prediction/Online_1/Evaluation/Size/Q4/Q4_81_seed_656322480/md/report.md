...
```
Node 6754 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6755 (Gather Merge) [consumed]
    Node 6756 (Sort) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6754 | 6755, 6756, 6757 |
...
|------|------|--------|-----------|-----|--------|
| 6754 | Aggregate | 1070.94 | 952.19 | 11.1% | pattern |
| 6758 | Nested Loop | 1064.35 | 1255.45 | 18.0% | operator |
| 6759 | Seq Scan | 166.72 | 154.66 | 7.2% | operator |
| 6760 | Index Scan | 0.06 | 11.10 | 17810.3% | operator |
...
- **Input Features:**
  ...
  - Aggregate_total_cost=66907.1800
  ...
  - GatherMerge_Outer_total_cost=66907.0500
  - Sort_Outer_np=0
  - Sort_Outer_nt=5
  - Sort_Outer_nt1=5
  - Sort_Outer_nt2=0
  ...
  - Sort_Outer_startup_cost=65905.2400
  - Sort_Outer_total_cost=65905.2500
