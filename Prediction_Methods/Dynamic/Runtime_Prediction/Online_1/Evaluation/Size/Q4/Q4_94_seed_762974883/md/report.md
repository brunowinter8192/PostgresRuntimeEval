...
```
Node 6852 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6853 (Gather Merge) [consumed]
    Node 6854 (Sort) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6852 | 6853, 6854, 6855 |
...
|------|------|--------|-----------|-----|--------|
| 6852 | Aggregate | 1071.80 | 952.19 | 11.2% | pattern |
| 6856 | Nested Loop | 1063.20 | 1255.45 | 18.1% | operator |
| 6857 | Seq Scan | 161.89 | 154.66 | 4.5% | operator |
| 6858 | Index Scan | 0.06 | 11.10 | 17250.6% | operator |
...
### Step 4: Node 6852 (Aggregate) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Sort_Outer_startup_cost=65938.8200
  - Sort_Outer_total_cost=65938.8300
