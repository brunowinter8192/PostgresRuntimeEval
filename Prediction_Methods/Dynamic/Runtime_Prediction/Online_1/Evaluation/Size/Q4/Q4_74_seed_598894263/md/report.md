...
**Test Query:** Q4_74_seed_598894263
...
```
Node 6698 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6699 (Gather Merge) [consumed]
    Node 6700 (Sort) [consumed]
      Node 6701 (Aggregate) [consumed]
        Node 6702 (Nested Loop)
          Node 6703 (Seq Scan) - LEAF
          Node 6704 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6698 | 6699, 6700, 6701 |
...
|------|------|--------|-----------|-----|--------|
| 6698 | Aggregate | 1024.78 | 952.19 | 7.1% | pattern |
| 6702 | Nested Loop | 1018.81 | 1255.45 | 23.2% | operator |
| 6703 | Seq Scan | 161.67 | 154.66 | 4.3% | operator |
| 6704 | Index Scan | 0.06 | 11.10 | 18103.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6703 (Seq Scan) - LEAF
...
### Step 2: Node 6704 (Index Scan) - LEAF
