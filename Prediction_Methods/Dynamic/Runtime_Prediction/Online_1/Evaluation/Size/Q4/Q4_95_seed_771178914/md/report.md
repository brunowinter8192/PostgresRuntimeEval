...
**Test Query:** Q4_95_seed_771178914
...
```
Node 6859 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6860 (Gather Merge) [consumed]
    Node 6861 (Sort) [consumed]
      Node 6862 (Aggregate) [consumed]
        Node 6863 (Nested Loop)
          Node 6864 (Seq Scan) - LEAF
          Node 6865 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6859 | 6860, 6861, 6862 |
...
|------|------|--------|-----------|-----|--------|
| 6859 | Aggregate | 1051.39 | 952.19 | 9.4% | pattern |
| 6863 | Nested Loop | 1045.32 | 1255.45 | 20.1% | operator |
| 6864 | Seq Scan | 167.40 | 154.67 | 7.6% | operator |
| 6865 | Index Scan | 0.06 | 11.10 | 17810.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6864 (Seq Scan) - LEAF
...
### Step 2: Node 6865 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - Sort_Outer_startup_cost=65580.8100
  - Sort_Outer_total_cost=65580.8200
