...
**Test Query:** Q4_70_seed_566078139
...
```
Node 6670 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6671 (Gather Merge) [consumed]
    Node 6672 (Sort) [consumed]
      Node 6673 (Aggregate) [consumed]
        Node 6674 (Nested Loop)
          Node 6675 (Seq Scan) - LEAF
          Node 6676 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6670 | 6671, 6672, 6673 |
...
|------|------|--------|-----------|-----|--------|
| 6670 | Aggregate | 1029.03 | 952.19 | 7.5% | pattern |
| 6674 | Nested Loop | 1021.57 | 1255.45 | 22.9% | operator |
| 6675 | Seq Scan | 164.61 | 154.66 | 6.0% | operator |
| 6676 | Index Scan | 0.06 | 11.10 | 18407.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6675 (Seq Scan) - LEAF
...
### Step 2: Node 6676 (Index Scan) - LEAF
