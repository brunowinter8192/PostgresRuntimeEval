...
**Test Query:** Q4_90_seed_730158759
...
```
Node 6824 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6825 (Gather Merge) [consumed]
    Node 6826 (Sort) [consumed]
      Node 6827 (Aggregate) [consumed]
        Node 6828 (Nested Loop)
          Node 6829 (Seq Scan) - LEAF
          Node 6830 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6824 | 6825, 6826, 6827 |
...
|------|------|--------|-----------|-----|--------|
| 6824 | Aggregate | 1049.96 | 952.19 | 9.3% | pattern |
| 6828 | Nested Loop | 1040.07 | 1255.45 | 20.7% | operator |
| 6829 | Seq Scan | 161.70 | 154.66 | 4.4% | operator |
| 6830 | Index Scan | 0.06 | 11.10 | 18103.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6829 (Seq Scan) - LEAF
...
### Step 2: Node 6830 (Index Scan) - LEAF
