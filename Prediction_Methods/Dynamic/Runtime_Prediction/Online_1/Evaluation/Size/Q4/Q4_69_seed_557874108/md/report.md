...
**Test Query:** Q4_69_seed_557874108
...
```
Node 6656 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6657 (Gather Merge) [consumed]
    Node 6658 (Sort) [consumed]
      Node 6659 (Aggregate) [consumed]
        Node 6660 (Nested Loop)
          Node 6661 (Seq Scan) - LEAF
          Node 6662 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6656 | 6657, 6658, 6659 |
...
|------|------|--------|-----------|-----|--------|
| 6656 | Aggregate | 1091.02 | 952.19 | 12.7% | pattern |
| 6660 | Nested Loop | 1084.36 | 1255.45 | 15.8% | operator |
| 6661 | Seq Scan | 166.99 | 154.67 | 7.4% | operator |
| 6662 | Index Scan | 0.06 | 11.10 | 17250.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6661 (Seq Scan) - LEAF
...
### Step 2: Node 6662 (Index Scan) - LEAF
