...
**Test Query:** Q4_21_seed_164080620
...
```
Node 6292 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6293 (Gather Merge) [consumed]
    Node 6294 (Sort) [consumed]
      Node 6295 (Aggregate) [consumed]
        Node 6296 (Nested Loop)
          Node 6297 (Seq Scan) - LEAF
          Node 6298 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6292 | 6293, 6294, 6295 |
...
|------|------|--------|-----------|-----|--------|
| 6292 | Aggregate | 1044.66 | 952.19 | 8.9% | pattern |
| 6296 | Nested Loop | 1036.45 | 1255.45 | 21.1% | operator |
| 6297 | Seq Scan | 162.10 | 154.66 | 4.6% | operator |
| 6298 | Index Scan | 0.06 | 11.10 | 17810.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6297 (Seq Scan) - LEAF
...
### Step 2: Node 6298 (Index Scan) - LEAF
