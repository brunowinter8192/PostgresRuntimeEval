...
**Test Query:** Q12_12_seed_90244341
...
```
Node 24544 (Aggregate) - ROOT
  Node 24545 (Gather Merge)
    Node 24546 (Aggregate)
      Node 24547 (Sort)
        Node 24548 (Nested Loop)
          Node 24549 (Seq Scan) - LEAF
          Node 24550 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24544 | Aggregate | 1003.03 | 919.07 | 8.4% | operator |
| 24545 | Gather Merge | 1003.00 | 1111.84 | 10.9% | operator |
| 24546 | Aggregate | 980.42 | 895.31 | 8.7% | operator |
| 24547 | Sort | 979.82 | 1092.81 | 11.5% | operator |
| 24548 | Nested Loop | 978.85 | 1127.41 | 15.2% | operator |
| 24549 | Seq Scan | 846.88 | 745.19 | 12.0% | operator |
| 24550 | Index Scan | 0.03 | 0.07 | 187.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24549 (Seq Scan) - LEAF
...
### Step 2: Node 24550 (Index Scan) - LEAF
...
### Step 6: Node 24545 (Gather Merge)
...
### Step 7: Node 24544 (Aggregate) - ROOT
