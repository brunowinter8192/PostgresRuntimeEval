...
**Test Query:** Q1_140_seed_1140360309
...
```
Node 221 (Aggregate) - ROOT
  Node 222 (Gather Merge)
    Node 223 (Sort) [PATTERN: 1d35fb97]
      Node 224 (Aggregate) [consumed]
        Node 225 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 223 | 224 |
...
|------|------|--------|-----------|-----|--------|
| 221 | Aggregate | 901.01 | 1195.82 | 32.7% | operator |
| 222 | Gather Merge | 900.95 | 1165.89 | 29.4% | operator |
| 223 | Sort | 882.92 | 1200.25 | 35.9% | pattern |
| 225 | Seq Scan | 476.92 | 681.21 | 42.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 225 (Seq Scan) - LEAF
...
### Step 2: Node 223 (Sort) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=168793.7700
  - Sort_total_cost=168793.7900
- **Output:** st=1196.16, rt=1200.25

### Step 3: Node 222 (Gather Merge)
...
- **Output:** st=1161.76, rt=1165.89

### Step 4: Node 221 (Aggregate) - ROOT
