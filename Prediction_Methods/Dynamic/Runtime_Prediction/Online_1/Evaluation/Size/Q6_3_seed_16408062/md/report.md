...
```
Node 10233 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10234 (Gather) [consumed]
    Node 10235 (Aggregate) [consumed]
      Node 10236 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10233 | 10234, 10235 |
...
|------|------|--------|-----------|-----|--------|
| 10233 | Aggregate | 773.18 | 850.05 | 9.9% | pattern |
| 10236 | Seq Scan | 753.95 | 748.53 | 0.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10236 (Seq Scan) - LEAF
...
### Step 2: Node 10233 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10234, 10235
- **Input Features:**
