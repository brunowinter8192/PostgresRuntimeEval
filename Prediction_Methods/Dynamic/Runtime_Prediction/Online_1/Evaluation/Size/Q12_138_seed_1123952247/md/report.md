...
```
Node 24607 (Aggregate) - ROOT
  Node 24608 (Gather Merge)
    Node 24609 (Aggregate)
      Node 24610 (Sort)
...
|------|------|--------|-----------|-----|--------|
| 24607 | Aggregate | 997.17 | 919.06 | 7.8% | operator |
| 24608 | Gather Merge | 997.17 | 1111.84 | 11.5% | operator |
| 24609 | Aggregate | 977.84 | 895.30 | 8.4% | operator |
| 24610 | Sort | 977.23 | 1092.82 | 11.8% | operator |
| 24611 | Nested Loop | 976.29 | 1127.41 | 15.5% | operator |
| 24612 | Seq Scan | 844.54 | 745.19 | 11.8% | operator |
| 24613 | Index Scan | 0.03 | 0.07 | 187.5% | operator |
...
### Step 6: Node 24608 (Gather Merge)
...
### Step 7: Node 24607 (Aggregate) - ROOT
