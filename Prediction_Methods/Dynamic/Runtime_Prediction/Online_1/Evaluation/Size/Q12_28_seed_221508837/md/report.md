...
```
Node 24810 (Aggregate) - ROOT
  Node 24811 (Gather Merge)
    Node 24812 (Aggregate)
      Node 24813 (Sort)
...
|------|------|--------|-----------|-----|--------|
| 24810 | Aggregate | 996.90 | 919.06 | 7.8% | operator |
| 24811 | Gather Merge | 996.89 | 1111.84 | 11.5% | operator |
| 24812 | Aggregate | 976.44 | 895.30 | 8.3% | operator |
| 24813 | Sort | 975.76 | 1092.82 | 12.0% | operator |
| 24814 | Nested Loop | 974.78 | 1127.41 | 15.7% | operator |
| 24815 | Seq Scan | 838.22 | 745.19 | 11.1% | operator |
| 24816 | Index Scan | 0.03 | 0.07 | 176.5% | operator |
...
### Step 6: Node 24811 (Gather Merge)
...
### Step 7: Node 24810 (Aggregate) - ROOT
