...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5401 | 5402, 5403, 5404 |
...
| 5405 | Nested Loop | 1170.43 | 1193.35 | 2.0% | operator |
| 5406 | Hash Join | 208.06 | 231.01 | 11.0% | operator |
| 5410 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5407 | Seq Scan | 154.10 | 163.46 | 6.1% | operator |
| 5408 | Hash | 29.64 | 17.75 | 40.1% | operator |
...
### Step 2: Node 5407 (Seq Scan) - LEAF
...
### Step 5: Node 5410 (Index Scan) - LEAF
...
### Step 7: Node 5401 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5402, 5403, 5404
- **Input Features:**
