...
```
Node 5401 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5402 (Sort) [consumed]
    Node 5403 (Aggregate) [consumed]
      Node 5404 (Gather) [consumed]
        Node 5405 (Nested Loop)
          Node 5406 (Hash Join) [PATTERN: 895c6e8c]
            Node 5407 (Seq Scan) [consumed] - LEAF
            Node 5408 (Hash) [consumed]
              Node 5409 (Seq Scan) - LEAF
          Node 5410 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5401 | 5402, 5403, 5404, 5406, 5407, 5408 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5406 | 5401, 5402, 5403, 5404, 5407, 5408 |
...
|------|------|--------|-----------|-----|--------|
| 5401 | Limit | 1207.30 | 1151.18 | 4.6% | pattern |
| 5405 | Nested Loop | 1170.43 | 1193.44 | 2.0% | operator |
| 5406 | Hash Join | 208.06 | 242.55 | 16.6% | pattern |
| 5410 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5409 | Seq Scan | 28.85 | 38.53 | 33.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5409 (Seq Scan) - LEAF
...
### Step 2: Node 5406 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5401, 5402, 5403, 5404, 5407, 5408
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47516
  - HashJoin_nt1=236095
...
### Step 3: Node 5410 (Index Scan) - LEAF
...
### Step 5: Node 5401 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5402, 5403, 5404, 5406, 5407, 5408
- **Input Features:**
