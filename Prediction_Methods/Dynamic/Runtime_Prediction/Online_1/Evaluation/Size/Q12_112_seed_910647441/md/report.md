...
**Test Query:** Q12_112_seed_910647441
...
```
Node 24411 (Aggregate) - ROOT
  Node 24412 (Gather Merge)
    Node 24413 (Aggregate)
      Node 24414 (Sort)
        Node 24415 (Nested Loop)
          Node 24416 (Seq Scan) - LEAF
          Node 24417 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24411 | Aggregate | 1013.00 | 919.04 | 9.3% | operator |
| 24412 | Gather Merge | 1012.98 | 1111.84 | 9.8% | operator |
| 24413 | Aggregate | 994.39 | 895.29 | 10.0% | operator |
| 24414 | Sort | 993.74 | 1092.83 | 10.0% | operator |
| 24415 | Nested Loop | 992.73 | 1127.41 | 13.6% | operator |
| 24416 | Seq Scan | 854.02 | 745.20 | 12.7% | operator |
| 24417 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24416 (Seq Scan) - LEAF
...
### Step 2: Node 24417 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - st2=0.1246
  - startup_cost=0.4300
  - total_cost=147214.4500
- **Output:** st=38.32, rt=1127.41

### Step 4: Node 24414 (Sort)
...
- **Input Features:**
  ...
  - st1=38.3201
  - st2=0.0000
  - startup_cost=147578.4700
  - total_cost=147593.0200
- **Output:** st=1092.41, rt=1092.83

### Step 5: Node 24413 (Aggregate)
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=147578.4700
  - total_cost=147694.9600
- **Output:** st=868.93, rt=895.29

### Step 6: Node 24412 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=868.9251
  - st2=0.0000
  - startup_cost=148578.5500
  - total_cost=148699.2500
- **Output:** st=1109.22, rt=1111.84

### Step 7: Node 24411 (Aggregate) - ROOT
