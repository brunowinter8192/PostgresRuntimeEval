...
```
Node 10951 (Aggregate) - ROOT
  Node 10952 (Gather Merge)
    Node 10953 (Sort)
      Node 10954 (Hash Join)
        Node 10955 (Nested Loop)
          Node 10956 (Hash Join)
            Node 10957 (Seq Scan) - LEAF
            Node 10958 (Hash)
              Node 10959 (Hash Join)
                Node 10960 (Seq Scan) - LEAF
                Node 10961 (Hash)
                  Node 10962 (Seq Scan) - LEAF
          Node 10963 (Index Scan) - LEAF
        Node 10964 (Hash)
          Node 10965 (Hash Join)
            Node 10966 (Seq Scan) - LEAF
            Node 10967 (Hash)
              Node 10968 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 10951 | Aggregate | 1245.77 | 1209.26 | 2.9% | operator |
| 10952 | Gather Merge | 1244.66 | 1142.98 | 8.2% | operator |
| 10953 | Sort | 1238.16 | 1109.13 | 10.4% | operator |
| 10954 | Hash Join | 1236.99 | 842.59 | 31.9% | operator |
| 10955 | Nested Loop | 1231.01 | 1216.16 | 1.2% | operator |
| 10964 | Hash | 2.15 | 17.53 | 713.8% | operator |
| 10956 | Hash Join | 222.08 | 384.47 | 73.1% | operator |
| 10963 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 10965 | Hash Join | 2.12 | 85.17 | 3927.2% | operator |
| 10957 | Seq Scan | 159.12 | 201.16 | 26.4% | operator |
| 10958 | Hash | 35.94 | 19.59 | 45.5% | operator |
| 10966 | Seq Scan | 1.82 | 11.47 | 529.2% | operator |
| 10967 | Hash | 0.01 | 16.89 | 140684.0% | operator |
| 10959 | Hash Join | 35.68 | 92.20 | 158.4% | operator |
| 10968 | Seq Scan | 0.01 | 45.79 | 457823.2% | operator |
| 10960 | Seq Scan | 34.59 | 21.86 | 36.8% | operator |
| 10961 | Hash | 0.01 | 16.89 | 241244.0% | operator |
| 10962 | Seq Scan | 0.01 | 45.79 | 915746.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10962 (Seq Scan) - LEAF
...
### Step 2: Node 10960 (Seq Scan) - LEAF
...
### Step 5: Node 10968 (Seq Scan) - LEAF
...
### Step 6: Node 10957 (Seq Scan) - LEAF
...
### Step 8: Node 10966 (Seq Scan) - LEAF
...
### Step 11: Node 10963 (Index Scan) - LEAF
...
### Step 13: Node 10955 (Nested Loop)
...
### Step 17: Node 10952 (Gather Merge)
...
### Step 18: Node 10951 (Aggregate) - ROOT
