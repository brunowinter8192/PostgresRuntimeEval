...
**Test Query:** Q5_99_seed_803995038
...
```
Node 9861 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 9862 (Aggregate) [consumed]
    Node 9863 (Gather Merge) [consumed]
      Node 9864 (Aggregate)
        Node 9865 (Sort) [PATTERN: 3e2d5a00]
          Node 9866 (Hash Join) [consumed]
            Node 9867 (Nested Loop)
              Node 9868 (Hash Join)
                Node 9869 (Seq Scan) - LEAF
                Node 9870 (Hash) [PATTERN: 444761fb]
                  Node 9871 (Hash Join) [consumed]
                    Node 9872 (Seq Scan) [consumed] - LEAF
                    Node 9873 (Hash) [consumed]
                      Node 9874 (Hash Join) [consumed]
                        Node 9875 (Seq Scan) - LEAF
                        Node 9876 (Hash)
                          Node 9877 (Seq Scan) - LEAF
              Node 9878 (Index Scan) - LEAF
            Node 9879 (Hash)
              Node 9880 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 9870 | 9861, 9862, 9863, 9865, 9866, 9871, 9872, 9873, 9874 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 9861 | 9862, 9863, 9865, 9866, 9870, 9871, 9872, 9873, 9874 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 9865 | 9861, 9862, 9863, 9866, 9870, 9871, 9872, 9873, 9874 |
...
|------|------|--------|-----------|-----|--------|
| 9861 | Sort | 1071.93 | 2934.42 | 173.8% | pattern |
| 9864 | Aggregate | 1067.11 | 1128.78 | 5.8% | operator |
| 9865 | Sort | 1066.84 | 1835.92 | 72.1% | pattern |
| 9867 | Nested Loop | 1052.52 | 1188.42 | 12.9% | operator |
| 9879 | Hash | 5.68 | 18.67 | 228.8% | operator |
| 9868 | Hash Join | 215.75 | 253.07 | 17.3% | operator |
| 9878 | Index Scan | 0.07 | -0.22 | 397.3% | operator |
| 9880 | Seq Scan | 5.16 | 12.36 | 139.6% | operator |
| 9869 | Seq Scan | 167.90 | 159.81 | 4.8% | operator |
| 9870 | Hash | 34.55 | 46.85 | 35.6% | pattern |
| 9875 | Seq Scan | 0.01 | 11.81 | 131103.0% | operator |
| 9876 | Hash | 0.05 | 21.05 | 38887.5% | operator |
| 9877 | Seq Scan | 0.05 | 22.93 | 44002.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 9877 (Seq Scan) - LEAF
...
### Step 2: Node 9875 (Seq Scan) - LEAF
...
### Step 4: Node 9869 (Seq Scan) - LEAF
...
### Step 5: Node 9870 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 9861, 9862, 9863, 9865, 9866, 9871, 9872, 9873, 9874
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 9878 (Index Scan) - LEAF
...
### Step 8: Node 9880 (Seq Scan) - LEAF
...
### Step 11: Node 9865 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 9861, 9862, 9863, 9866, 9870, 9871, 9872, 9873, 9874
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 9861 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 9862, 9863, 9865, 9866, 9870, 9871, 9872, 9873, 9874
- **Input Features:**
