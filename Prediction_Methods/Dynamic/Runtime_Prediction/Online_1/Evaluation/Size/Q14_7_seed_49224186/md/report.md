...
```
Node 27309 (Aggregate) [PATTERN: efde8b38] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27309 | 27310, 27311, 27312 |
...
|------|------|--------|-----------|-----|--------|
| 27309 | Aggregate | 818.96 | 857.13 | 4.7% | pattern |
| 27313 | Seq Scan | 743.71 | 758.50 | 2.0% | operator |
| 27314 | Hash | 43.13 | 9.38 | 78.3% | operator |
| 27315 | Seq Scan | 38.55 | 12.70 | 67.0% | operator |
...
### Step 4: Node 27309 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27310, 27311, 27312
- **Input Features:**
