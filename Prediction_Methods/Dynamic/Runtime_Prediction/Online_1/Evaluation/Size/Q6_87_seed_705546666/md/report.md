...
**Test Query:** Q6_87_seed_705546666
...
```
Node 10441 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10442 (Gather) [consumed]
    Node 10443 (Aggregate) [consumed]
      Node 10444 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10441 | 10442, 10443 |
...
|------|------|--------|-----------|-----|--------|
| 10441 | Aggregate | 792.45 | 849.98 | 7.3% | pattern |
| 10444 | Seq Scan | 771.69 | 748.49 | 3.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10444 (Seq Scan) - LEAF
...
### Step 2: Node 10441 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10442, 10443
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=22678
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=32
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=139718.8600
  - Aggregate_Outer_total_cost=139718.8700
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=140719.4000
  - Aggregate_total_cost=140719.4100
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=140718.8600
  - Gather_Outer_total_cost=140719.3700
