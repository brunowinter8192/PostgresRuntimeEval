...
**Test Query:** Q10_135_seed_1099340154
...
```
Node 19864 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 19865 (Sort) [consumed]
    Node 19866 (Aggregate) [consumed]
      Node 19867 (Gather) [consumed]
        Node 19868 (Hash Join)
          Node 19869 (Hash Join) [PATTERN: 2e0f44ef]
            Node 19870 (Nested Loop) [consumed]
              Node 19871 (Seq Scan) - LEAF
              Node 19872 (Index Scan) - LEAF
            Node 19873 (Hash) [consumed]
              Node 19874 (Seq Scan) - LEAF
          Node 19875 (Hash)
            Node 19876 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19864 | 19865, 19866, 19867, 19869, 19870, 19873 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 19869 | 19864, 19865, 19866, 19867, 19870, 19873 |
...
|------|------|--------|-----------|-----|--------|
| 19864 | Limit | 1142.03 | 1199.47 | 5.0% | pattern |
| 19868 | Hash Join | 1091.90 | 1095.40 | 0.3% | operator |
| 19869 | Hash Join | 1089.11 | 1120.19 | 2.9% | pattern |
| 19875 | Hash | 0.01 | 15.71 | 112119.8% | operator |
| 19876 | Seq Scan | 0.01 | 6.98 | 69687.0% | operator |
| 19871 | Seq Scan | 163.86 | 159.75 | 2.5% | operator |
| 19872 | Index Scan | 0.06 | -0.52 | 935.8% | operator |
| 19874 | Seq Scan | 28.77 | 26.64 | 7.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 19871 (Seq Scan) - LEAF
...
### Step 2: Node 19872 (Index Scan) - LEAF
...
### Step 3: Node 19874 (Seq Scan) - LEAF
...
### Step 4: Node 19876 (Seq Scan) - LEAF
...
### Step 5: Node 19869 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 19864, 19865, 19866, 19867, 19870, 19873
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=17639
  - HashJoin_nt1=17639
  ...
  - NestedLoop_Outer_nt=17639
  - NestedLoop_Outer_nt1=17822
...
- **Output:** st=54.16, rt=1095.40

### Step 8: Node 19864 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19865, 19866, 19867, 19869, 19870, 19873
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=54682
  - Aggregate_Outer_nt1=54682
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=280
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=87497.5500
  - Aggregate_Outer_total_cost=88181.0700
  - Gather_Outer_np=0
