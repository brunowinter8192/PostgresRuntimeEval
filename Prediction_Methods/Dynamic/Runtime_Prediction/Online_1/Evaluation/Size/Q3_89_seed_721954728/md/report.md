...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5721 | 5722, 5723, 5724 |
...
| 5725 | Nested Loop | 1152.15 | 1193.50 | 3.6% | operator |
| 5726 | Hash Join | 211.14 | 231.31 | 9.6% | operator |
| 5730 | Index Scan | 0.03 | -0.52 | 2172.3% | operator |
| 5727 | Seq Scan | 154.79 | 163.56 | 5.7% | operator |
| 5728 | Hash | 30.17 | 17.75 | 41.2% | operator |
...
### Step 2: Node 5727 (Seq Scan) - LEAF
...
### Step 5: Node 5730 (Index Scan) - LEAF
...
- **Output:** st=122.19, rt=1193.50

### Step 7: Node 5721 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5722, 5723, 5724
- **Input Features:**
