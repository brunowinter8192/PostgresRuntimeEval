...
**Test Query:** Q3_89_seed_721954728
...
```
Node 5721 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5722 (Sort) [consumed]
    Node 5723 (Aggregate) [consumed]
      Node 5724 (Gather) [consumed]
        Node 5725 (Nested Loop)
          Node 5726 (Hash Join) [PATTERN: 895c6e8c]
            Node 5727 (Seq Scan) [consumed] - LEAF
            Node 5728 (Hash) [consumed]
              Node 5729 (Seq Scan) - LEAF
          Node 5730 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5721 | 5722, 5723, 5724, 5726, 5727, 5728 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5726 | 5721, 5722, 5723, 5724, 5727, 5728 |
...
|------|------|--------|-----------|-----|--------|
| 5721 | Limit | 1187.47 | 1151.18 | 3.1% | pattern |
| 5725 | Nested Loop | 1152.15 | 1193.59 | 3.6% | operator |
| 5726 | Hash Join | 211.14 | 242.58 | 14.9% | pattern |
| 5730 | Index Scan | 0.03 | -0.52 | 2172.3% | operator |
| 5729 | Seq Scan | 29.38 | 38.54 | 31.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5729 (Seq Scan) - LEAF
...
### Step 2: Node 5726 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5721, 5722, 5723, 5724, 5727, 5728
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47747
  - HashJoin_nt1=237612
...
### Step 3: Node 5730 (Index Scan) - LEAF
...
### Step 5: Node 5721 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5722, 5723, 5724, 5726, 5727, 5728
- **Input Features:**
