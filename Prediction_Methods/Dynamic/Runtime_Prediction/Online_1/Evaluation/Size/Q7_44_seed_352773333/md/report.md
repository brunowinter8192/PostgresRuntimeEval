...
```
Node 12085 (Aggregate) - ROOT
  Node 12086 (Gather Merge)
    Node 12087 (Sort)
      Node 12088 (Hash Join)
        Node 12089 (Nested Loop)
          Node 12090 (Hash Join)
            Node 12091 (Seq Scan) - LEAF
            Node 12092 (Hash)
              Node 12093 (Hash Join)
                Node 12094 (Seq Scan) - LEAF
                Node 12095 (Hash)
                  Node 12096 (Seq Scan) - LEAF
          Node 12097 (Index Scan) - LEAF
        Node 12098 (Hash)
          Node 12099 (Hash Join)
            Node 12100 (Seq Scan) - LEAF
            Node 12101 (Hash)
              Node 12102 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12085 | Aggregate | 1242.98 | 1209.26 | 2.7% | operator |
| 12086 | Gather Merge | 1241.97 | 1142.98 | 8.0% | operator |
| 12087 | Sort | 1235.76 | 1109.13 | 10.2% | operator |
| 12088 | Hash Join | 1235.08 | 842.59 | 31.8% | operator |
| 12089 | Nested Loop | 1227.85 | 1216.16 | 1.0% | operator |
| 12098 | Hash | 3.32 | 17.53 | 428.0% | operator |
| 12090 | Hash Join | 216.78 | 384.47 | 77.4% | operator |
| 12097 | Index Scan | 0.03 | 0.96 | 2731.9% | operator |
| 12099 | Hash Join | 3.27 | 85.17 | 2503.9% | operator |
| 12091 | Seq Scan | 156.22 | 201.16 | 28.8% | operator |
| 12092 | Hash | 34.96 | 19.59 | 44.0% | operator |
| 12100 | Seq Scan | 2.92 | 11.47 | 292.2% | operator |
| 12101 | Hash | 0.01 | 16.89 | 129854.5% | operator |
| 12093 | Hash Join | 34.69 | 92.20 | 165.8% | operator |
| 12102 | Seq Scan | 0.01 | 45.79 | 457823.2% | operator |
| 12094 | Seq Scan | 33.59 | 21.86 | 34.9% | operator |
| 12095 | Hash | 0.01 | 16.89 | 153482.6% | operator |
| 12096 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12096 (Seq Scan) - LEAF
...
### Step 2: Node 12094 (Seq Scan) - LEAF
...
### Step 5: Node 12102 (Seq Scan) - LEAF
...
### Step 6: Node 12091 (Seq Scan) - LEAF
...
### Step 8: Node 12100 (Seq Scan) - LEAF
...
### Step 11: Node 12097 (Index Scan) - LEAF
...
### Step 13: Node 12089 (Nested Loop)
...
### Step 17: Node 12086 (Gather Merge)
...
### Step 18: Node 12085 (Aggregate) - ROOT
