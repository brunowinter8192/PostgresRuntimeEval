...
**Test Query:** Q7_44_seed_352773333
...
```
Node 12085 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 12086 (Gather Merge) [consumed]
    Node 12087 (Sort)
      Node 12088 (Hash Join)
        Node 12089 (Nested Loop)
          Node 12090 (Hash Join) [PATTERN: 895c6e8c]
            Node 12091 (Seq Scan) [consumed] - LEAF
            Node 12092 (Hash) [consumed]
              Node 12093 (Hash Join) [PATTERN: f4cb205a]
                Node 12094 (Seq Scan) [consumed] - LEAF
                Node 12095 (Hash) [consumed]
                  Node 12096 (Seq Scan) [consumed] - LEAF
          Node 12097 (Index Scan) - LEAF
        Node 12098 (Hash)
          Node 12099 (Hash Join) [PATTERN: f4cb205a]
            Node 12100 (Seq Scan) [consumed] - LEAF
            Node 12101 (Hash) [consumed]
              Node 12102 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 12093 | 12085, 12086, 12090, 12091, 12092, 12094, 12095, 12096, 12099, 12100, 12101, 12102 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 12099 | 12085, 12086, 12090, 12091, 12092, 12093, 12094, 12095, 12096, 12100, 12101, 12102 |
| Aggregate -> Gather Merge (Out | 2724c080 | 12085 | 12086, 12090, 12091, 12092, 12093, 12094, 12095, 12096, 12099, 12100, 12101, 12102 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 12090 | 12085, 12086, 12091, 12092, 12093, 12094, 12095, 12096, 12099, 12100, 12101, 12102 |
...
|------|------|--------|-----------|-----|--------|
| 12085 | Aggregate | 1242.98 | 1163.13 | 6.4% | pattern |
| 12087 | Sort | 1235.76 | 1109.16 | 10.2% | operator |
| 12088 | Hash Join | 1235.08 | 843.11 | 31.7% | operator |
| 12089 | Nested Loop | 1227.85 | 1215.99 | 1.0% | operator |
| 12098 | Hash | 3.32 | 27.74 | 735.6% | operator |
| 12090 | Hash Join | 216.78 | 304.89 | 40.6% | pattern |
| 12097 | Index Scan | 0.03 | 0.96 | 2731.9% | operator |
| 12099 | Hash Join | 3.27 | 429.36 | 13026.3% | pattern |
| 12093 | Hash Join | 34.69 | 429.38 | 1137.7% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12093 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 12085, 12086, 12090, 12091, 12092, 12094, 12095, 12096, 12099, 12100, 12101, 12102
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5000
  - HashJoin_nt1=62500
...
### Step 2: Node 12090 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 12085, 12086, 12091, 12092, 12093, 12094, 12095, 12096, 12099, 12100, 12101, 12102
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=38710
  - HashJoin_nt1=483871
...
### Step 3: Node 12097 (Index Scan) - LEAF
...
### Step 4: Node 12099 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 12085, 12086, 12090, 12091, 12092, 12093, 12094, 12095, 12096, 12100, 12101, 12102
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=800
  - HashJoin_nt1=10000
...
### Step 9: Node 12085 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 12086, 12090, 12091, 12092, 12093, 12094, 12095, 12096, 12099, 12100, 12101, 12102
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
