...
**Test Query:** Q19_54_seed_434813643
...
```
Node 31913 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31914 (Gather) [consumed]
    Node 31915 (Aggregate) [consumed]
      Node 31916 (Hash Join) [consumed]
        Node 31917 (Seq Scan) - LEAF
        Node 31918 (Hash)
          Node 31919 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31913 | 31914, 31915, 31916 |
...
|------|------|--------|-----------|-----|--------|
| 31913 | Aggregate | 849.23 | 829.32 | 2.3% | pattern |
| 31917 | Seq Scan | 780.76 | 743.46 | 4.8% | operator |
| 31918 | Hash | 45.50 | 8.29 | 81.8% | operator |
| 31919 | Seq Scan | 45.36 | 23.76 | 47.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31919 (Seq Scan) - LEAF
...
### Step 2: Node 31917 (Seq Scan) - LEAF
...
### Step 4: Node 31913 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31914, 31915, 31916
- **Input Features:**
