...
```
Node 31913 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31914 (Gather) [consumed]
    Node 31915 (Aggregate) [consumed]
      Node 31916 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31913 | 31914, 31915 |
...
|------|------|--------|-----------|-----|--------|
| 31913 | Aggregate | 849.23 | 831.20 | 2.1% | pattern |
| 31916 | Hash Join | 828.42 | 766.06 | 7.5% | operator |
...
### Step 5: Node 31913 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31914, 31915
- **Input Features:**
