...
Node 19243 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 19244 (Aggregate) [consumed]
    Node 19245 (Gather)
      Node 19246 (Aggregate)
        Node 19247 (Hash Join)
          Node 19248 (Seq Scan) - LEAF
          Node 19249 (Hash) [PATTERN: 444761fb]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 19249 | 19243, 19244, 19250, 19251, 19252, 19253 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 19243 | 19244, 19249, 19250, 19251, 19252, 19253 |
...
|------|------|--------|-----------|-----|--------|
| 19243 | Sort | 1287.96 | 1063.03 | 17.5% | pattern |
| 19245 | Gather | 1286.93 | 962.11 | 25.2% | operator |
| 19246 | Aggregate | 1267.37 | 931.07 | 26.5% | operator |
| 19247 | Hash Join | 1238.03 | 568.57 | 54.1% | operator |
| 19248 | Seq Scan | 129.96 | 193.40 | 48.8% | operator |
| 19249 | Hash | 1041.70 | 35.69 | 96.6% | pattern |
| 19254 | Hash Join | 195.55 | 837.69 | 328.4% | operator |
| 19260 | Hash | 14.64 | 14.95 | 2.1% | operator |
| 19255 | Nested Loop | 188.65 | 1251.77 | 563.5% | operator |
| 19258 | Hash | 4.23 | 15.94 | 276.8% | operator |
| 19261 | Seq Scan | 14.62 | 2.94 | 79.9% | operator |
| 19256 | Seq Scan | 28.92 | 43.83 | 51.5% | operator |
| 19257 | Index Scan | 0.06 | -1.39 | 2535.9% | operator |
| 19259 | Seq Scan | 3.75 | 9.45 | 151.5% | operator |
...
### Step 10: Node 19249 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 19243, 19244, 19250, 19251, 19252, 19253
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 14: Node 19243 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 19244, 19249, 19250, 19251, 19252, 19253
- **Input Features:**
