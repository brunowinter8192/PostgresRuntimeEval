...
**Test Query:** Q9_18_seed_139468527
...
```
Node 17719 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 17720 (Aggregate) [consumed]
    Node 17721 (Gather)
      Node 17722 (Aggregate)
        Node 17723 (Hash Join)
          Node 17724 (Seq Scan) - LEAF
          Node 17725 (Hash) [PATTERN: 444761fb]
            Node 17726 (Hash Join) [consumed]
              Node 17727 (Seq Scan) [consumed] - LEAF
              Node 17728 (Hash) [consumed]
                Node 17729 (Hash Join) [consumed]
                  Node 17730 (Hash Join)
                    Node 17731 (Nested Loop)
                      Node 17732 (Seq Scan) - LEAF
                      Node 17733 (Index Scan) - LEAF
                    Node 17734 (Hash)
                      Node 17735 (Seq Scan) - LEAF
                  Node 17736 (Hash)
                    Node 17737 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 17725 | 17719, 17720, 17726, 17727, 17728, 17729 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17719 | 17720, 17725, 17726, 17727, 17728, 17729 |
...
|------|------|--------|-----------|-----|--------|
| 17719 | Sort | 1271.45 | 1063.07 | 16.4% | pattern |
| 17721 | Gather | 1270.31 | 962.15 | 24.3% | operator |
| 17722 | Aggregate | 1253.77 | 926.41 | 26.1% | operator |
| 17723 | Hash Join | 1224.27 | 569.97 | 53.4% | operator |
| 17724 | Seq Scan | 125.50 | 193.40 | 54.1% | operator |
| 17725 | Hash | 1036.58 | 35.69 | 96.6% | pattern |
| 17730 | Hash Join | 201.66 | 837.71 | 315.4% | operator |
| 17736 | Hash | 14.71 | 14.95 | 1.6% | operator |
| 17731 | Nested Loop | 193.22 | 1251.77 | 547.9% | operator |
| 17734 | Hash | 5.64 | 15.94 | 182.6% | operator |
| 17737 | Seq Scan | 14.70 | 2.94 | 80.0% | operator |
| 17732 | Seq Scan | 27.13 | 43.76 | 61.3% | operator |
| 17733 | Index Scan | 0.06 | -1.39 | 2414.2% | operator |
| 17735 | Seq Scan | 5.16 | 9.45 | 82.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 17732 (Seq Scan) - LEAF
...
### Step 2: Node 17733 (Index Scan) - LEAF
...
### Step 3: Node 17735 (Seq Scan) - LEAF
...
### Step 6: Node 17737 (Seq Scan) - LEAF
...
### Step 9: Node 17724 (Seq Scan) - LEAF
...
### Step 10: Node 17725 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 17719, 17720, 17726, 17727, 17728, 17729
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 14: Node 17719 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17720, 17725, 17726, 17727, 17728, 17729
- **Input Features:**
