...
```
Node 13753 (Aggregate) - ROOT
  Node 13754 (Gather Merge)
    Node 13755 (Sort)
          ...
          Node 13758 (Hash Join)
            Node 13759 (Nested Loop)
              Node 13760 (Hash Join)
                ...
                Node 13762 (Hash)
                  Node 13763 (Hash Join)
                    Node 13764 (Seq Scan) - LEAF
                    Node 13765 (Hash)
                      Node 13766 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 13753 | Aggregate | 1202.44 | 1180.35 | 1.8% | operator |
| 13754 | Gather Merge | 1202.02 | 1097.14 | 8.7% | operator |
...
| 13760 | Hash Join | 211.67 | 251.17 | 18.7% | operator |
...
| 13762 | Hash | 32.04 | 20.62 | 35.7% | operator |
| 13763 | Hash Join | 31.31 | 132.26 | 322.4% | operator |
| 13764 | Seq Scan | 29.90 | 23.03 | 23.0% | operator |
| 13765 | Hash | 0.09 | 23.66 | 27730.7% | operator |
| 13766 | Hash Join | 0.08 | 306.84 | 369581.9% | operator |
...
### Step 5: Node 13764 (Seq Scan) - LEAF
...
### Step 8: Node 13761 (Seq Scan) - LEAF
...
### Step 11: Node 13770 (Index Scan) - LEAF
...
### Step 12: Node 13772 (Seq Scan) - LEAF
...
### Step 13: Node 13759 (Nested Loop)
...
### Step 16: Node 13773 (Index Scan) - LEAF
...
### Step 17: Node 13775 (Seq Scan) - LEAF
...
### Step 18: Node 13757 (Nested Loop)
...
### Step 22: Node 13754 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1044.9465
  - st2=0.0000
  - startup_cost=71569.5700
  - total_cost=71874.0900
- **Output:** st=1093.43, rt=1097.14

### Step 23: Node 13753 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=71569.5700
  - total_cost=71973.6900
- **Output:** st=1156.53, rt=1180.35
