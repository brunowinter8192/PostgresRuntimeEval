...
```
Node 12553 (Aggregate) - ROOT
  Node 12554 (Gather Merge)
    Node 12555 (Sort)
      Node 12556 (Hash Join)
        Node 12557 (Nested Loop)
          Node 12558 (Hash Join)
            Node 12559 (Seq Scan) - LEAF
            Node 12560 (Hash)
              Node 12561 (Hash Join)
                Node 12562 (Seq Scan) - LEAF
                Node 12563 (Hash)
                  Node 12564 (Seq Scan) - LEAF
          Node 12565 (Index Scan) - LEAF
        Node 12566 (Hash)
          Node 12567 (Hash Join)
            Node 12568 (Seq Scan) - LEAF
            Node 12569 (Hash)
              Node 12570 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12553 | Aggregate | 1191.50 | 1209.26 | 1.5% | operator |
| 12554 | Gather Merge | 1190.46 | 1142.98 | 4.0% | operator |
| 12555 | Sort | 1184.64 | 1109.13 | 6.4% | operator |
| 12556 | Hash Join | 1184.01 | 842.59 | 28.8% | operator |
| 12557 | Nested Loop | 1176.95 | 1216.16 | 3.3% | operator |
| 12566 | Hash | 3.09 | 17.53 | 467.3% | operator |
| 12558 | Hash Join | 213.48 | 384.47 | 80.1% | operator |
| 12565 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 12567 | Hash Join | 3.02 | 85.17 | 2715.7% | operator |
| 12559 | Seq Scan | 151.24 | 201.16 | 33.0% | operator |
| 12560 | Hash | 36.73 | 19.59 | 46.7% | operator |
| 12568 | Seq Scan | 2.66 | 11.47 | 331.6% | operator |
| 12569 | Hash | 0.02 | 16.89 | 88816.2% | operator |
| 12561 | Hash Join | 36.27 | 92.20 | 154.2% | operator |
| 12570 | Seq Scan | 0.01 | 45.79 | 305182.1% | operator |
| 12562 | Seq Scan | 35.16 | 21.86 | 37.8% | operator |
| 12563 | Hash | 0.01 | 16.89 | 120572.0% | operator |
| 12564 | Seq Scan | 0.01 | 45.79 | 457823.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12564 (Seq Scan) - LEAF
...
### Step 2: Node 12562 (Seq Scan) - LEAF
...
### Step 5: Node 12570 (Seq Scan) - LEAF
...
### Step 6: Node 12559 (Seq Scan) - LEAF
...
### Step 8: Node 12568 (Seq Scan) - LEAF
...
### Step 11: Node 12565 (Index Scan) - LEAF
...
### Step 13: Node 12557 (Nested Loop)
...
### Step 17: Node 12554 (Gather Merge)
...
### Step 18: Node 12553 (Aggregate) - ROOT
