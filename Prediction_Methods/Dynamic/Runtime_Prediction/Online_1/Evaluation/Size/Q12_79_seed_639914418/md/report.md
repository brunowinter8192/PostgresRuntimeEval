...
```
Node 25202 (Aggregate) - ROOT
  Node 25203 (Gather Merge)
    Node 25204 (Aggregate)
      Node 25205 (Sort)
...
|------|------|--------|-----------|-----|--------|
| 25202 | Aggregate | 1000.45 | 919.08 | 8.1% | operator |
| 25203 | Gather Merge | 1000.44 | 1111.84 | 11.1% | operator |
| 25204 | Aggregate | 979.05 | 895.32 | 8.6% | operator |
| 25205 | Sort | 978.44 | 1092.80 | 11.7% | operator |
| 25206 | Nested Loop | 977.45 | 1127.41 | 15.3% | operator |
| 25207 | Seq Scan | 843.09 | 745.19 | 11.6% | operator |
| 25208 | Index Scan | 0.03 | 0.07 | 176.5% | operator |
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=147496.9600
  - total_cost=147611.7700
- **Output:** st=868.98, rt=895.32

### Step 6: Node 25203 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=868.9815
  - st2=0.0000
  - startup_cost=148497.0300
  - total_cost=148616.0600
- **Output:** st=1109.22, rt=1111.84

### Step 7: Node 25202 (Aggregate) - ROOT
