...
```
Node 27421 (Aggregate) [PATTERN: efde8b38] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27421 | 27422, 27423, 27424 |
...
|------|------|--------|-----------|-----|--------|
| 27421 | Aggregate | 849.73 | 857.12 | 0.9% | pattern |
...
### Step 4: Node 27421 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27422, 27423, 27424
- **Input Features:**
