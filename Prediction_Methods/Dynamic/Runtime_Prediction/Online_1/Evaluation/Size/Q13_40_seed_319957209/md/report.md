...
**Test Query:** Q13_40_seed_319957209
...
```
Node 25958 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25959 (Aggregate) [consumed]
    Node 25960 (Aggregate)
      Node 25961 (Hash Join) [PATTERN: 895c6e8c]
        Node 25962 (Seq Scan) [consumed] - LEAF
        Node 25963 (Hash) [consumed]
          Node 25964 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25958 | 25959, 25961, 25962, 25963 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25961 | 25958, 25959, 25962, 25963 |
...
|------|------|--------|-----------|-----|--------|
| 25958 | Sort | 945.00 | 1079.93 | 14.3% | pattern |
| 25960 | Aggregate | 938.86 | 999.15 | 6.4% | operator |
| 25961 | Hash Join | 720.79 | 470.31 | 34.8% | pattern |
| 25964 | Index Only Scan | 9.61 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25964 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25961 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25958, 25959, 25962, 25963
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1478958
...
### Step 4: Node 25958 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25959, 25961, 25962, 25963
- **Input Features:**
