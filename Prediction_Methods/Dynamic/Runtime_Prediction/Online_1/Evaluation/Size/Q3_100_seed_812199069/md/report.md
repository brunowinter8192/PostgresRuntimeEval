    ...
    Node 4353 (Aggregate) [consumed]
      Node 4354 (Gather) [consumed]
        Node 4355 (Nested Loop)
          Node 4356 (Hash Join) [PATTERN: 895c6e8c]
            Node 4357 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4351 | 4352, 4353, 4354, 4356, 4357, 4358 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4356 | 4351, 4352, 4353, 4354, 4357, 4358 |
...
| 4355 | Nested Loop | 1151.78 | 1192.58 | 3.5% | operator |
| 4356 | Hash Join | 206.74 | 242.38 | 17.2% | pattern |
...
### Step 2: Node 4356 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4351, 4352, 4353, 4354, 4357, 4358
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46189
  - HashJoin_nt1=232872
...
### Step 5: Node 4351 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4352, 4353, 4354, 4356, 4357, 4358
- **Input Features:**
