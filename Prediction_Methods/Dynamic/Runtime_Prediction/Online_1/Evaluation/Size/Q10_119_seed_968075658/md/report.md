    ...
    Node 19632 (Aggregate) [consumed]
      Node 19633 (Gather) [consumed]
        Node 19634 (Hash Join)
          Node 19635 (Hash Join)
            Node 19636 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19630 | 19631, 19632, 19633 |
...
| 19634 | Hash Join | 1109.59 | 1007.25 | 9.2% | operator |
| 19635 | Hash Join | 1106.37 | 1004.18 | 9.2% | operator |
| 19641 | Hash | 0.02 | 15.71 | 78453.9% | operator |
| 19636 | Nested Loop | 1059.70 | 1204.79 | 13.7% | operator |
| 19639 | Hash | 36.42 | 55.57 | 52.6% | operator |
...
### Step 6: Node 19642 (Seq Scan) - LEAF
...
### Step 10: Node 19630 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19631, 19632, 19633
- **Input Features:**
