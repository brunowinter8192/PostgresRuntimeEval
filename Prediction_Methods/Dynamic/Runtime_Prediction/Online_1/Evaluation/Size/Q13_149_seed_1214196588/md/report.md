...
**Test Query:** Q13_149_seed_1214196588
...
```
Node 25741 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25742 (Aggregate) [consumed]
    Node 25743 (Aggregate)
      Node 25744 (Hash Join) [PATTERN: 895c6e8c]
        Node 25745 (Seq Scan) [consumed] - LEAF
        Node 25746 (Hash) [consumed]
          Node 25747 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25741 | 25742, 25744, 25745, 25746 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25744 | 25741, 25742, 25745, 25746 |
...
|------|------|--------|-----------|-----|--------|
| 25741 | Sort | 967.70 | 1079.94 | 11.6% | pattern |
| 25743 | Aggregate | 961.03 | 999.76 | 4.0% | operator |
| 25744 | Hash Join | 721.63 | 470.31 | 34.8% | pattern |
| 25747 | Index Only Scan | 10.25 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25747 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25744 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25741, 25742, 25745, 25746
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 25741 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25742, 25744, 25745, 25746
- **Input Features:**
