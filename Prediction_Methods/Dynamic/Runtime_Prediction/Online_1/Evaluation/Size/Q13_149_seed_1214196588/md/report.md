...
```
Node 25741 (Sort) - ROOT
  Node 25742 (Aggregate)
    Node 25743 (Aggregate)
      Node 25744 (Hash Join)
        Node 25745 (Seq Scan) - LEAF
        Node 25746 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 25741 | Sort | 967.70 | 1081.93 | 11.8% | operator |
| 25742 | Aggregate | 967.68 | 1000.33 | 3.4% | operator |
| 25743 | Aggregate | 961.03 | 1014.39 | 5.6% | operator |
| 25744 | Hash Join | 721.63 | 787.83 | 9.2% | operator |
| 25745 | Seq Scan | 484.27 | 264.19 | 45.4% | operator |
| 25746 | Hash | 15.61 | 80.15 | 413.5% | operator |
...
### Step 2: Node 25745 (Seq Scan) - LEAF
