    ...
    Node 20555 (Aggregate) [consumed]
      Node 20556 (Gather) [consumed]
        Node 20557 (Hash Join)
          Node 20558 (Hash Join)
            Node 20559 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20553 | 20554, 20555, 20556 |
...
| 20557 | Hash Join | 1085.17 | 1007.12 | 7.2% | operator |
| 20558 | Hash Join | 1082.25 | 1003.97 | 7.2% | operator |
| 20564 | Hash | 0.01 | 15.71 | 120752.1% | operator |
| 20559 | Nested Loop | 1039.59 | 1204.87 | 15.9% | operator |
| 20562 | Hash | 31.93 | 55.57 | 74.0% | operator |
...
### Step 6: Node 20565 (Seq Scan) - LEAF
...
### Step 10: Node 20553 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20554, 20555, 20556
- **Input Features:**
