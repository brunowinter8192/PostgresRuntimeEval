...
**Test Query:** Q10_47_seed_377385426
**Timestamp:** 2026-01-18 19:34:47
...
```
Node 20553 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 20554 (Sort) [consumed]
    Node 20555 (Aggregate) [consumed]
      Node 20556 (Gather) [consumed]
        Node 20557 (Hash Join)
          Node 20558 (Hash Join) [PATTERN: 2e0f44ef]
            Node 20559 (Nested Loop) [consumed]
              Node 20560 (Seq Scan) - LEAF
              Node 20561 (Index Scan) - LEAF
            Node 20562 (Hash) [consumed]
              Node 20563 (Seq Scan) - LEAF
          Node 20564 (Hash)
            Node 20565 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20553 | 20554, 20555, 20556, 20558, 20559, 20562 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 20558 | 20553, 20554, 20555, 20556, 20559, 20562 |
...
|------|------|--------|-----------|-----|--------|
| 20553 | Limit | 1130.05 | 1199.47 | 6.1% | pattern |
| 20557 | Hash Join | 1085.17 | 1095.58 | 1.0% | operator |
| 20558 | Hash Join | 1082.25 | 1120.19 | 3.5% | pattern |
| 20564 | Hash | 0.01 | 15.71 | 120752.1% | operator |
| 20565 | Seq Scan | 0.01 | 6.98 | 77441.2% | operator |
| 20560 | Seq Scan | 160.67 | 159.74 | 0.6% | operator |
| 20561 | Index Scan | 0.06 | -0.52 | 949.6% | operator |
| 20563 | Seq Scan | 25.10 | 26.64 | 6.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 20560 (Seq Scan) - LEAF
...
### Step 2: Node 20561 (Index Scan) - LEAF
...
### Step 3: Node 20563 (Seq Scan) - LEAF
...
### Step 4: Node 20565 (Seq Scan) - LEAF
...
### Step 5: Node 20558 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 20553, 20554, 20555, 20556, 20559, 20562
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18276
  - HashJoin_nt1=18276
...
### Step 8: Node 20553 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20554, 20555, 20556, 20558, 20559, 20562
- **Input Features:**
