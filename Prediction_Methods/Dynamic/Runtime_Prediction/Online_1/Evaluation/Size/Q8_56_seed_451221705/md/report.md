...
**Test Query:** Q8_56_seed_451221705
...
Node 15524 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 15525 (Gather Merge) [consumed]
    Node 15526 (Sort)
      Node 15527 (Hash Join)
        Node 15528 (Nested Loop)
          Node 15529 (Hash Join)
            Node 15530 (Nested Loop)
              Node 15531 (Hash Join)
                Node 15532 (Seq Scan) - LEAF
                Node 15533 (Hash) [PATTERN: 444761fb]
                  Node 15534 (Hash Join) [consumed]
                    Node 15535 (Seq Scan) [consumed] - LEAF
                    Node 15536 (Hash) [consumed]
                      Node 15537 (Hash Join) [consumed]
                        Node 15538 (Seq Scan) - LEAF
                        Node 15539 (Hash)
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 15533 | 15524, 15525, 15534, 15535, 15536, 15537 |
| Aggregate -> Gather Merge (Out | 2724c080 | 15524 | 15525, 15533, 15534, 15535, 15536, 15537 |
...
|------|------|--------|-----------|-----|--------|
| 15524 | Aggregate | 1214.86 | 1133.67 | 6.7% | pattern |
| 15526 | Sort | 1209.59 | 1046.21 | 13.5% | operator |
| 15527 | Hash Join | 1209.34 | 785.61 | 35.0% | operator |
| 15528 | Nested Loop | 1209.02 | 1198.29 | 0.9% | operator |
| 15545 | Hash | 0.01 | 13.72 | 91393.9% | operator |
| 15529 | Hash Join | 1205.49 | 785.60 | 34.8% | operator |
| 15544 | Index Scan | 0.01 | 12.42 | 206958.1% | operator |
| 15546 | Seq Scan | 0.01 | 6.51 | 59099.7% | operator |
| 15530 | Nested Loop | 1161.67 | 1198.29 | 3.2% | operator |
| 15542 | Hash | 39.59 | 19.97 | 49.6% | operator |
| 15531 | Hash Join | 212.87 | 251.67 | 18.2% | operator |
| 15541 | Index Scan | 0.04 | 2.88 | 6759.2% | operator |
| 15543 | Seq Scan | 39.52 | 48.88 | 23.7% | operator |
| 15532 | Seq Scan | 157.97 | 159.67 | 1.1% | operator |
| 15533 | Hash | 36.29 | 43.51 | 19.9% | pattern |
| 15538 | Seq Scan | 0.02 | 12.22 | 58114.0% | operator |
| 15539 | Hash | 0.15 | 18.14 | 12327.5% | operator |
| 15540 | Seq Scan | 0.14 | 23.36 | 16468.9% | operator |
...
### Step 2: Node 15538 (Seq Scan) - LEAF
...
### Step 4: Node 15532 (Seq Scan) - LEAF
...
### Step 5: Node 15533 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 15524, 15525, 15534, 15535, 15536, 15537
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 15541 (Index Scan) - LEAF
...
### Step 8: Node 15543 (Seq Scan) - LEAF
...
### Step 12: Node 15544 (Index Scan) - LEAF
...
### Step 13: Node 15546 (Seq Scan) - LEAF
...
### Step 14: Node 15528 (Nested Loop)
...
### Step 18: Node 15524 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 15525, 15533, 15534, 15535, 15536, 15537
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2334
  - Aggregate_nt1=2334
