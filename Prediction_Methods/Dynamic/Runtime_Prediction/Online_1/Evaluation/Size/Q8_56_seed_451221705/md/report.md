...
```
Node 15524 (Aggregate) - ROOT
  Node 15525 (Gather Merge)
    Node 15526 (Sort)
          ...
          Node 15529 (Hash Join)
            Node 15530 (Nested Loop)
              Node 15531 (Hash Join)
                ...
                Node 15533 (Hash)
                  Node 15534 (Hash Join)
                    Node 15535 (Seq Scan) - LEAF
                    Node 15536 (Hash)
                      Node 15537 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 15524 | Aggregate | 1214.86 | 1195.83 | 1.6% | operator |
| 15525 | Gather Merge | 1214.42 | 1097.16 | 9.7% | operator |
...
| 15531 | Hash Join | 212.87 | 251.17 | 18.0% | operator |
...
| 15533 | Hash | 36.29 | 20.62 | 43.2% | operator |
| 15534 | Hash Join | 35.60 | 132.26 | 271.5% | operator |
| 15535 | Seq Scan | 34.09 | 23.03 | 32.4% | operator |
| 15536 | Hash | 0.18 | 23.66 | 13042.3% | operator |
| 15537 | Hash Join | 0.18 | 306.84 | 172279.7% | operator |
...
### Step 5: Node 15535 (Seq Scan) - LEAF
...
### Step 8: Node 15532 (Seq Scan) - LEAF
...
### Step 11: Node 15541 (Index Scan) - LEAF
...
### Step 12: Node 15543 (Seq Scan) - LEAF
...
### Step 13: Node 15530 (Nested Loop)
...
### Step 16: Node 15544 (Index Scan) - LEAF
...
### Step 17: Node 15546 (Seq Scan) - LEAF
...
### Step 18: Node 15528 (Nested Loop)
...
### Step 22: Node 15525 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1044.9405
  - st2=0.0000
  - startup_cost=71540.9100
  - total_cost=71817.0400
- **Output:** st=1093.46, rt=1097.16

### Step 23: Node 15524 (Aggregate) - ROOT
