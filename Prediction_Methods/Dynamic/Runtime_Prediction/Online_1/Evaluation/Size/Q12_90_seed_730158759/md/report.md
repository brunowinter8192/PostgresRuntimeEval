...
**Test Query:** Q12_90_seed_730158759
**Timestamp:** 2026-01-18 19:53:49
...
```
Node 25293 (Aggregate) - ROOT
  Node 25294 (Gather Merge)
    Node 25295 (Aggregate)
      Node 25296 (Sort)
        Node 25297 (Nested Loop)
          Node 25298 (Seq Scan) - LEAF
          Node 25299 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 25293 | Aggregate | 991.27 | 919.08 | 7.3% | operator |
| 25294 | Gather Merge | 991.25 | 1111.84 | 12.2% | operator |
| 25295 | Aggregate | 972.05 | 895.32 | 7.9% | operator |
| 25296 | Sort | 971.10 | 1092.80 | 12.5% | operator |
| 25297 | Nested Loop | 970.16 | 1127.41 | 16.2% | operator |
| 25298 | Seq Scan | 838.21 | 745.19 | 11.1% | operator |
| 25299 | Index Scan | 0.03 | 0.07 | 187.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25298 (Seq Scan) - LEAF
...
### Step 2: Node 25299 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - st2=0.1246
  - startup_cost=0.4300
  - total_cost=147143.2600
- **Output:** st=38.33, rt=1127.41

### Step 4: Node 25296 (Sort)
...
- **Input Features:**
  ...
  - st1=38.3287
  - st2=0.0000
  - startup_cost=147501.7800
  - total_cost=147516.1300
- **Output:** st=1092.39, rt=1092.80

### Step 5: Node 25295 (Aggregate)
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=147501.7800
  - total_cost=147616.6900
- **Output:** st=868.98, rt=895.32

### Step 6: Node 25294 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=868.9782
  - st2=0.0000
  - startup_cost=148501.8500
  - total_cost=148620.9800
- **Output:** st=1109.22, rt=1111.84

### Step 7: Node 25293 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=148501.8500
  - total_cost=148621.3100
- **Output:** st=903.61, rt=919.08
