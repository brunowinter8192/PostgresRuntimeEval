...
```
Node 18480 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18481 (Aggregate) [consumed]
    Node 18482 (Gather)
      Node 18483 (Aggregate)
        Node 18484 (Nested Loop)
          Node 18485 (Hash Join) [PATTERN: bb930825]
            Node 18486 (Seq Scan) [consumed] - LEAF
            Node 18487 (Hash) [consumed]
              Node 18488 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18485 | 18480, 18481, 18486, 18487, 18488 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18480 | 18481, 18485, 18486, 18487, 18488 |
...
|------|------|--------|-----------|-----|--------|
| 18480 | Sort | 1200.25 | 1047.04 | 12.8% | pattern |
...
| 18485 | Hash Join | 984.54 | 134.80 | 86.3% | pattern |
...
### Step 9: Node 18485 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18480, 18481, 18486, 18487, 18488
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18497 (Index Scan) - LEAF
...
### Step 11: Node 18484 (Nested Loop)
...
### Step 14: Node 18480 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18481, 18485, 18486, 18487, 18488
- **Input Features:**
