...
**Test Query:** Q7_143_seed_1164972402
...
```
Node 11347 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 11348 (Gather Merge) [consumed]
    Node 11349 (Sort)
      Node 11350 (Hash Join)
        Node 11351 (Nested Loop)
          Node 11352 (Hash Join) [PATTERN: 895c6e8c]
            Node 11353 (Seq Scan) [consumed] - LEAF
            Node 11354 (Hash) [consumed]
              Node 11355 (Hash Join) [PATTERN: f4cb205a]
                Node 11356 (Seq Scan) [consumed] - LEAF
                Node 11357 (Hash) [consumed]
                  Node 11358 (Seq Scan) [consumed] - LEAF
          Node 11359 (Index Scan) - LEAF
        Node 11360 (Hash)
          Node 11361 (Hash Join) [PATTERN: f4cb205a]
            Node 11362 (Seq Scan) [consumed] - LEAF
            Node 11363 (Hash) [consumed]
              Node 11364 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 11355 | 11347, 11348, 11352, 11353, 11354, 11356, 11357, 11358, 11361, 11362, 11363, 11364 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 11361 | 11347, 11348, 11352, 11353, 11354, 11355, 11356, 11357, 11358, 11362, 11363, 11364 |
| Aggregate -> Gather Merge (Out | 2724c080 | 11347 | 11348, 11352, 11353, 11354, 11355, 11356, 11357, 11358, 11361, 11362, 11363, 11364 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 11352 | 11347, 11348, 11353, 11354, 11355, 11356, 11357, 11358, 11361, 11362, 11363, 11364 |
...
|------|------|--------|-----------|-----|--------|
| 11347 | Aggregate | 1204.14 | 1163.13 | 3.4% | pattern |
| 11349 | Sort | 1197.48 | 1109.16 | 7.4% | operator |
| 11350 | Hash Join | 1196.87 | 843.11 | 29.6% | operator |
| 11351 | Nested Loop | 1189.46 | 1215.99 | 2.2% | operator |
| 11360 | Hash | 3.73 | 27.74 | 643.2% | operator |
| 11352 | Hash Join | 212.26 | 304.89 | 43.6% | pattern |
| 11359 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 11361 | Hash Join | 3.69 | 429.36 | 11545.3% | pattern |
| 11355 | Hash Join | 36.84 | 429.38 | 1065.7% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11355 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 11347, 11348, 11352, 11353, 11354, 11356, 11357, 11358, 11361, 11362, 11363, 11364
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5000
  - HashJoin_nt1=62500
...
### Step 2: Node 11352 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 11347, 11348, 11353, 11354, 11355, 11356, 11357, 11358, 11361, 11362, 11363, 11364
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=38710
  - HashJoin_nt1=483871
...
### Step 3: Node 11359 (Index Scan) - LEAF
...
### Step 4: Node 11361 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 11347, 11348, 11352, 11353, 11354, 11355, 11356, 11357, 11358, 11362, 11363, 11364
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=800
  - HashJoin_nt1=10000
...
### Step 9: Node 11347 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 11348, 11352, 11353, 11354, 11355, 11356, 11357, 11358, 11361, 11362, 11363, 11364
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
