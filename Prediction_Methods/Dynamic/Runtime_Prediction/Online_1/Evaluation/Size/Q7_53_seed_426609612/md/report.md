...
```
Node 12265 (Aggregate) - ROOT
  Node 12266 (Gather Merge)
    Node 12267 (Sort)
      Node 12268 (Hash Join)
        Node 12269 (Nested Loop)
          Node 12270 (Hash Join)
            Node 12271 (Seq Scan) - LEAF
            Node 12272 (Hash)
              Node 12273 (Hash Join)
                Node 12274 (Seq Scan) - LEAF
                Node 12275 (Hash)
                  Node 12276 (Seq Scan) - LEAF
          Node 12277 (Index Scan) - LEAF
        Node 12278 (Hash)
          Node 12279 (Hash Join)
            Node 12280 (Seq Scan) - LEAF
            Node 12281 (Hash)
              Node 12282 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12265 | Aggregate | 1198.30 | 1209.26 | 0.9% | operator |
| 12266 | Gather Merge | 1197.12 | 1142.98 | 4.5% | operator |
| 12267 | Sort | 1191.78 | 1109.13 | 6.9% | operator |
| 12268 | Hash Join | 1191.15 | 842.59 | 29.3% | operator |
| 12269 | Nested Loop | 1183.82 | 1216.16 | 2.7% | operator |
| 12278 | Hash | 3.44 | 17.53 | 410.2% | operator |
| 12270 | Hash Join | 214.48 | 384.47 | 79.3% | operator |
| 12277 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 12279 | Hash Join | 3.39 | 85.17 | 2411.0% | operator |
| 12271 | Seq Scan | 150.92 | 201.16 | 33.3% | operator |
| 12272 | Hash | 37.25 | 19.59 | 47.4% | operator |
| 12280 | Seq Scan | 3.06 | 11.47 | 275.0% | operator |
| 12281 | Hash | 0.02 | 16.89 | 99277.0% | operator |
| 12273 | Hash Join | 36.93 | 92.20 | 149.7% | operator |
| 12282 | Seq Scan | 0.01 | 45.79 | 352148.6% | operator |
| 12274 | Seq Scan | 35.83 | 21.86 | 39.0% | operator |
| 12275 | Hash | 0.01 | 16.89 | 168840.8% | operator |
| 12276 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12276 (Seq Scan) - LEAF
...
### Step 2: Node 12274 (Seq Scan) - LEAF
...
### Step 5: Node 12282 (Seq Scan) - LEAF
...
### Step 6: Node 12271 (Seq Scan) - LEAF
...
### Step 8: Node 12280 (Seq Scan) - LEAF
...
### Step 11: Node 12277 (Index Scan) - LEAF
...
### Step 13: Node 12269 (Nested Loop)
...
### Step 17: Node 12266 (Gather Merge)
...
### Step 18: Node 12265 (Aggregate) - ROOT
