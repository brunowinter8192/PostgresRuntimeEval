...
**Test Query:** Q7_53_seed_426609612
...
```
Node 12265 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 12266 (Gather Merge) [consumed]
    Node 12267 (Sort)
      Node 12268 (Hash Join)
        Node 12269 (Nested Loop)
          Node 12270 (Hash Join) [PATTERN: 895c6e8c]
            Node 12271 (Seq Scan) [consumed] - LEAF
            Node 12272 (Hash) [consumed]
              Node 12273 (Hash Join) [PATTERN: f4cb205a]
                Node 12274 (Seq Scan) [consumed] - LEAF
                Node 12275 (Hash) [consumed]
                  Node 12276 (Seq Scan) [consumed] - LEAF
          Node 12277 (Index Scan) - LEAF
        Node 12278 (Hash)
          Node 12279 (Hash Join) [PATTERN: f4cb205a]
            Node 12280 (Seq Scan) [consumed] - LEAF
            Node 12281 (Hash) [consumed]
              Node 12282 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 12273 | 12265, 12266, 12270, 12271, 12272, 12274, 12275, 12276, 12279, 12280, 12281, 12282 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 12279 | 12265, 12266, 12270, 12271, 12272, 12273, 12274, 12275, 12276, 12280, 12281, 12282 |
| Aggregate -> Gather Merge (Out | 2724c080 | 12265 | 12266, 12270, 12271, 12272, 12273, 12274, 12275, 12276, 12279, 12280, 12281, 12282 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 12270 | 12265, 12266, 12271, 12272, 12273, 12274, 12275, 12276, 12279, 12280, 12281, 12282 |
...
|------|------|--------|-----------|-----|--------|
| 12265 | Aggregate | 1198.30 | 1163.13 | 2.9% | pattern |
| 12267 | Sort | 1191.78 | 1109.16 | 6.9% | operator |
| 12268 | Hash Join | 1191.15 | 843.11 | 29.2% | operator |
| 12269 | Nested Loop | 1183.82 | 1215.99 | 2.7% | operator |
| 12278 | Hash | 3.44 | 27.74 | 707.4% | operator |
| 12270 | Hash Join | 214.48 | 304.89 | 42.2% | pattern |
| 12277 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 12279 | Hash Join | 3.39 | 429.36 | 12558.1% | pattern |
| 12273 | Hash Join | 36.93 | 429.38 | 1062.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12273 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 12265, 12266, 12270, 12271, 12272, 12274, 12275, 12276, 12279, 12280, 12281, 12282
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5000
  - HashJoin_nt1=62500
...
### Step 2: Node 12270 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 12265, 12266, 12271, 12272, 12273, 12274, 12275, 12276, 12279, 12280, 12281, 12282
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=38710
  - HashJoin_nt1=483871
...
### Step 3: Node 12277 (Index Scan) - LEAF
...
### Step 4: Node 12279 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 12265, 12266, 12270, 12271, 12272, 12273, 12274, 12275, 12276, 12280, 12281, 12282
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=800
  - HashJoin_nt1=10000
...
### Step 9: Node 12265 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 12266, 12270, 12271, 12272, 12273, 12274, 12275, 12276, 12279, 12280, 12281, 12282
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
