...
**Test Query:** Q7_51_seed_410201550
...
```
Node 12229 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 12230 (Gather Merge) [consumed]
    Node 12231 (Sort)
      Node 12232 (Hash Join)
        Node 12233 (Nested Loop)
          Node 12234 (Hash Join) [PATTERN: 895c6e8c]
            Node 12235 (Seq Scan) [consumed] - LEAF
            Node 12236 (Hash) [consumed]
              Node 12237 (Hash Join) [PATTERN: f4cb205a]
                Node 12238 (Seq Scan) [consumed] - LEAF
                Node 12239 (Hash) [consumed]
                  Node 12240 (Seq Scan) [consumed] - LEAF
          Node 12241 (Index Scan) - LEAF
        Node 12242 (Hash)
          Node 12243 (Hash Join) [PATTERN: f4cb205a]
            Node 12244 (Seq Scan) [consumed] - LEAF
            Node 12245 (Hash) [consumed]
              Node 12246 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 12237 | 12229, 12230, 12234, 12235, 12236, 12238, 12239, 12240, 12243, 12244, 12245, 12246 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 12243 | 12229, 12230, 12234, 12235, 12236, 12237, 12238, 12239, 12240, 12244, 12245, 12246 |
| Aggregate -> Gather Merge (Out | 2724c080 | 12229 | 12230, 12234, 12235, 12236, 12237, 12238, 12239, 12240, 12243, 12244, 12245, 12246 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 12234 | 12229, 12230, 12235, 12236, 12237, 12238, 12239, 12240, 12243, 12244, 12245, 12246 |
...
|------|------|--------|-----------|-----|--------|
| 12229 | Aggregate | 1202.06 | 1163.13 | 3.2% | pattern |
| 12231 | Sort | 1194.78 | 1109.16 | 7.2% | operator |
| 12232 | Hash Join | 1194.11 | 843.11 | 29.4% | operator |
| 12233 | Nested Loop | 1185.80 | 1215.99 | 2.5% | operator |
| 12242 | Hash | 4.63 | 27.74 | 499.3% | operator |
| 12234 | Hash Join | 216.20 | 304.89 | 41.0% | pattern |
| 12241 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 12243 | Hash Join | 4.58 | 429.36 | 9276.8% | pattern |
| 12237 | Hash Join | 34.69 | 429.38 | 1137.7% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12237 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 12229, 12230, 12234, 12235, 12236, 12238, 12239, 12240, 12243, 12244, 12245, 12246
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5000
  - HashJoin_nt1=62500
...
### Step 2: Node 12234 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 12229, 12230, 12235, 12236, 12237, 12238, 12239, 12240, 12243, 12244, 12245, 12246
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=38710
  - HashJoin_nt1=483871
...
### Step 3: Node 12241 (Index Scan) - LEAF
...
### Step 4: Node 12243 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 12229, 12230, 12234, 12235, 12236, 12237, 12238, 12239, 12240, 12244, 12245, 12246
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=800
  - HashJoin_nt1=10000
...
### Step 9: Node 12229 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 12230, 12234, 12235, 12236, 12237, 12238, 12239, 12240, 12243, 12244, 12245, 12246
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
