...
**Test Query:** Q18_28_seed_221508837
**Timestamp:** 2026-01-18 20:22:45
...
```
Node 29940 (Limit) - ROOT
  Node 29941 (Sort)
    Node 29942 (Aggregate)
      Node 29943 (Gather Merge)
        Node 29944 (Incremental Sort)
          Node 29945 (Nested Loop)
            Node 29946 (Merge Join)
              Node 29947 (Sort)
                Node 29948 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29949 (Seq Scan) [consumed] - LEAF
                  Node 29950 (Hash) [consumed]
                    Node 29951 (Aggregate)
                      Node 29952 (Index Scan) - LEAF
              Node 29953 (Sort)
                Node 29954 (Seq Scan) - LEAF
            Node 29955 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29948 | 29949, 29950 |
...
|------|------|--------|-----------|-----|--------|
| 29940 | Limit | 3064.82 | 1175.21 | 61.7% | operator |
| 29941 | Sort | 2950.45 | 1127.81 | 61.8% | operator |
| 29942 | Aggregate | 2950.41 | 1073.15 | 63.6% | operator |
| 29943 | Gather Merge | 2950.39 | 1073.95 | 63.6% | operator |
| 29944 | Incremental Sort | 2916.85 | 0.00 | 100.0% | operator |
| 29945 | Nested Loop | 2916.79 | 1111.34 | 61.9% | operator |
| 29946 | Merge Join | 2916.74 | 0.00 | 100.0% | operator |
| 29955 | Index Scan | 0.02 | 0.05 | 137.6% | operator |
| 29947 | Sort | 2866.92 | 1095.58 | 61.8% | operator |
| 29953 | Sort | 63.54 | 1074.66 | 1591.2% | operator |
| 29948 | Hash Join | 2866.91 | 471.07 | 83.6% | pattern |
| 29954 | Seq Scan | 52.24 | 18.25 | 65.1% | operator |
| 29951 | Aggregate | 2632.65 | 1073.15 | 59.2% | operator |
| 29952 | Index Scan | 2139.34 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29952 (Index Scan) - LEAF
...
### Step 3: Node 29948 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29949, 29950
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29954 (Seq Scan) - LEAF
...
### Step 7: Node 29946 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29955 (Index Scan) - LEAF
...
### Step 10: Node 29944 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29943 (Gather Merge)
