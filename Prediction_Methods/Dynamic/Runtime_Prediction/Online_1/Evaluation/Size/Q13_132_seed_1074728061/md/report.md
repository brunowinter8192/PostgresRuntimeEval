...
**Test Query:** Q13_132_seed_1074728061
...
```
Node 25615 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25616 (Aggregate) [consumed]
    Node 25617 (Aggregate)
      Node 25618 (Hash Join) [PATTERN: 895c6e8c]
        Node 25619 (Seq Scan) [consumed] - LEAF
        Node 25620 (Hash) [consumed]
          Node 25621 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25615 | 25616, 25618, 25619, 25620 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25618 | 25615, 25616, 25619, 25620 |
...
|------|------|--------|-----------|-----|--------|
| 25615 | Sort | 910.74 | 1079.94 | 18.6% | pattern |
| 25617 | Aggregate | 904.39 | 999.76 | 10.5% | operator |
| 25618 | Hash Join | 687.40 | 470.31 | 31.6% | pattern |
| 25621 | Index Only Scan | 10.22 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25621 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25618 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25615, 25616, 25619, 25620
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 25615 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25616, 25618, 25619, 25620
- **Input Features:**
