...
```
Node 18083 (Sort) - ROOT
  Node 18084 (Aggregate)
    Node 18085 (Gather)
      Node 18086 (Aggregate)
        Node 18087 (Nested Loop)
          Node 18088 (Hash Join)
            Node 18089 (Seq Scan) - LEAF
            Node 18090 (Hash)
              Node 18091 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 18083 | Sort | 1189.48 | 1118.92 | 5.9% | operator |
| 18084 | Aggregate | 1189.37 | 896.90 | 24.6% | operator |
...
| 18088 | Hash Join | 969.68 | 632.96 | 34.7% | operator |
| 18100 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18089 | Seq Scan | 700.03 | 509.93 | 27.2% | operator |
| 18090 | Hash | 173.50 | 47.68 | 72.5% | operator |
| 18091 | Hash Join | 171.73 | 924.32 | 438.2% | operator |
...
### Step 10: Node 18089 (Seq Scan) - LEAF
...
### Step 13: Node 18100 (Index Scan) - LEAF
...
### Step 14: Node 18087 (Nested Loop)
