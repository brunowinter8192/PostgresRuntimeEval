...
**Test Query:** Q9_36_seed_287141085
...
```
Node 18083 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18084 (Aggregate) [consumed]
    Node 18085 (Gather)
      Node 18086 (Aggregate)
        Node 18087 (Nested Loop)
          Node 18088 (Hash Join) [PATTERN: bb930825]
            Node 18089 (Seq Scan) [consumed] - LEAF
            Node 18090 (Hash) [consumed]
              Node 18091 (Hash Join) [consumed]
                Node 18092 (Hash Join)
                  Node 18093 (Nested Loop)
                    Node 18094 (Seq Scan) - LEAF
                    Node 18095 (Index Scan) - LEAF
                  Node 18096 (Hash)
                    Node 18097 (Seq Scan) - LEAF
                Node 18098 (Hash)
                  Node 18099 (Seq Scan) - LEAF
          Node 18100 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18088 | 18083, 18084, 18089, 18090, 18091 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18083 | 18084, 18088, 18089, 18090, 18091 |
...
|------|------|--------|-----------|-----|--------|
| 18083 | Sort | 1189.48 | 1044.79 | 12.2% | pattern |
| 18085 | Gather | 1188.39 | 964.87 | 18.8% | operator |
| 18086 | Aggregate | 1169.32 | 1117.47 | 4.4% | operator |
| 18087 | Nested Loop | 1144.29 | 1252.17 | 9.4% | operator |
| 18088 | Hash Join | 969.68 | 134.80 | 86.1% | pattern |
| 18100 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18092 | Hash Join | 158.25 | 837.55 | 429.3% | operator |
| 18098 | Hash | 12.85 | 14.95 | 16.3% | operator |
| 18093 | Nested Loop | 152.04 | 1251.76 | 723.3% | operator |
| 18096 | Hash | 3.96 | 15.94 | 302.4% | operator |
| 18099 | Seq Scan | 12.84 | 2.94 | 77.1% | operator |
| 18094 | Seq Scan | 19.89 | 44.17 | 122.1% | operator |
| 18095 | Index Scan | 0.07 | -1.39 | 2028.4% | operator |
| 18097 | Seq Scan | 3.45 | 9.45 | 173.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 18094 (Seq Scan) - LEAF
...
### Step 2: Node 18095 (Index Scan) - LEAF
...
### Step 3: Node 18097 (Seq Scan) - LEAF
...
### Step 6: Node 18099 (Seq Scan) - LEAF
...
### Step 9: Node 18088 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18083, 18084, 18089, 18090, 18091
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18100 (Index Scan) - LEAF
...
### Step 11: Node 18087 (Nested Loop)
...
### Step 14: Node 18083 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18084, 18088, 18089, 18090, 18091
- **Input Features:**
