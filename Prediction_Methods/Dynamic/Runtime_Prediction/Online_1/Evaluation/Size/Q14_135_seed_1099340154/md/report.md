...
```
Node 26686 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26687 (Gather) [consumed]
    Node 26688 (Aggregate) [consumed]
      Node 26689 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26686 | 26687, 26688, 26689 |
...
|------|------|--------|-----------|-----|--------|
| 26686 | Aggregate | 839.04 | 857.14 | 2.2% | pattern |
...
### Step 4: Node 26686 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26687, 26688, 26689
- **Input Features:**
