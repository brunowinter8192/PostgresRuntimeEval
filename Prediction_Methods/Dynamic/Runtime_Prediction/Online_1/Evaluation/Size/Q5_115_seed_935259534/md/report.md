...
**Test Query:** Q5_115_seed_935259534
...
```
Node 7221 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 7222 (Aggregate) [consumed]
    Node 7223 (Gather Merge) [consumed]
      Node 7224 (Aggregate)
        Node 7225 (Sort) [PATTERN: 3e2d5a00]
          Node 7226 (Hash Join) [consumed]
            Node 7227 (Nested Loop)
              Node 7228 (Hash Join)
                Node 7229 (Seq Scan) - LEAF
                Node 7230 (Hash) [PATTERN: 444761fb]
                  Node 7231 (Hash Join) [consumed]
                    Node 7232 (Seq Scan) [consumed] - LEAF
                    Node 7233 (Hash) [consumed]
                      Node 7234 (Hash Join) [consumed]
                        Node 7235 (Seq Scan) - LEAF
                        Node 7236 (Hash)
                          Node 7237 (Seq Scan) - LEAF
              Node 7238 (Index Scan) - LEAF
            Node 7239 (Hash)
              Node 7240 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 7230 | 7221, 7222, 7223, 7225, 7226, 7231, 7232, 7233, 7234 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 7221 | 7222, 7223, 7225, 7226, 7230, 7231, 7232, 7233, 7234 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 7225 | 7221, 7222, 7223, 7226, 7230, 7231, 7232, 7233, 7234 |
...
|------|------|--------|-----------|-----|--------|
| 7221 | Sort | 1049.40 | 2934.42 | 179.6% | pattern |
| 7224 | Aggregate | 1043.75 | 1128.76 | 8.1% | operator |
| 7225 | Sort | 1043.51 | 1835.93 | 75.9% | pattern |
| 7227 | Nested Loop | 1030.85 | 1188.47 | 15.3% | operator |
| 7239 | Hash | 4.05 | 18.67 | 360.7% | operator |
| 7228 | Hash Join | 211.76 | 253.07 | 19.5% | operator |
| 7238 | Index Scan | 0.07 | -0.22 | 409.9% | operator |
| 7240 | Seq Scan | 3.50 | 12.36 | 253.3% | operator |
| 7229 | Seq Scan | 165.83 | 159.81 | 3.6% | operator |
| 7230 | Hash | 32.52 | 46.85 | 44.1% | pattern |
| 7235 | Seq Scan | 0.01 | 11.81 | 131103.0% | operator |
| 7236 | Hash | 0.14 | 21.05 | 15380.3% | operator |
| 7237 | Seq Scan | 0.13 | 22.93 | 17143.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 7237 (Seq Scan) - LEAF
...
### Step 2: Node 7235 (Seq Scan) - LEAF
...
### Step 4: Node 7229 (Seq Scan) - LEAF
...
### Step 5: Node 7230 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 7221, 7222, 7223, 7225, 7226, 7231, 7232, 7233, 7234
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 7238 (Index Scan) - LEAF
...
### Step 8: Node 7240 (Seq Scan) - LEAF
...
### Step 11: Node 7225 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 7221, 7222, 7223, 7226, 7230, 7231, 7232, 7233, 7234
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 7221 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 7222, 7223, 7225, 7226, 7230, 7231, 7232, 7233, 7234
- **Input Features:**
