    ...
    Node 17613 (Gather)
      Node 17614 (Aggregate)
        Node 17615 (Nested Loop)
          Node 17616 (Hash Join) [PATTERN: bb930825]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17616 | 17611, 17612, 17617, 17618, 17619 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17611 | 17612, 17616, 17617, 17618, 17619 |
...
|------|------|--------|-----------|-----|--------|
| 17611 | Sort | 1181.35 | 1044.29 | 11.6% | pattern |
| 17613 | Gather | 1180.35 | 965.14 | 18.2% | operator |
| 17614 | Aggregate | 1161.01 | 1141.19 | 1.7% | operator |
| 17615 | Nested Loop | 1137.01 | 1252.17 | 10.1% | operator |
| 17616 | Hash Join | 968.31 | 134.80 | 86.1% | pattern |
| 17628 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17620 | Hash Join | 164.44 | 837.49 | 409.3% | operator |
| 17626 | Hash | 12.95 | 14.95 | 15.5% | operator |
| 17621 | Nested Loop | 155.60 | 1251.76 | 704.5% | operator |
| 17624 | Hash | 6.49 | 15.94 | 145.5% | operator |
| 17627 | Seq Scan | 12.94 | 2.94 | 77.3% | operator |
| 17622 | Seq Scan | 19.81 | 44.30 | 123.6% | operator |
| 17623 | Index Scan | 0.07 | -1.39 | 1976.3% | operator |
| 17625 | Seq Scan | 5.93 | 9.45 | 59.2% | operator |
...
### Step 9: Node 17616 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17611, 17612, 17617, 17618, 17619
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17628 (Index Scan) - LEAF
...
### Step 11: Node 17615 (Nested Loop)
...
### Step 14: Node 17611 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17612, 17616, 17617, 17618, 17619
- **Input Features:**
