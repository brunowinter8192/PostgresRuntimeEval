...
**Test Query:** Q6_52_seed_418405581
...
```
Node 10289 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10290 (Gather) [consumed]
    Node 10291 (Aggregate) [consumed]
      Node 10292 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10289 | 10290, 10291 |
...
|------|------|--------|-----------|-----|--------|
| 10289 | Aggregate | 785.57 | 849.98 | 8.2% | pattern |
| 10292 | Seq Scan | 766.11 | 748.49 | 2.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10292 (Seq Scan) - LEAF
...
### Step 2: Node 10289 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10290, 10291
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=22629
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=32
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=139718.6100
  - Aggregate_Outer_total_cost=139718.6200
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=140719.1500
  - Aggregate_total_cost=140719.1600
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=140718.6100
  - Gather_Outer_total_cost=140719.1200
