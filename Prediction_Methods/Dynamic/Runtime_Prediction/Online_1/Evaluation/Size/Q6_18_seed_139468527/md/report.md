...
**Test Query:** Q6_18_seed_139468527
...
```
Node 10137 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10138 (Gather) [consumed]
    Node 10139 (Aggregate) [consumed]
      Node 10140 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10137 | 10138, 10139 |
...
|------|------|--------|-----------|-----|--------|
| 10137 | Aggregate | 789.49 | 849.99 | 7.7% | pattern |
| 10140 | Seq Scan | 768.55 | 748.50 | 2.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10140 (Seq Scan) - LEAF
...
### Step 2: Node 10137 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10138, 10139
- **Input Features:**
