...
**Test Query:** Q19_101_seed_820403100
...
```
Node 31227 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31228 (Gather) [consumed]
    Node 31229 (Aggregate) [consumed]
      Node 31230 (Hash Join) [consumed]
        Node 31231 (Seq Scan) - LEAF
        Node 31232 (Hash)
          Node 31233 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31227 | 31228, 31229, 31230 |
...
|------|------|--------|-----------|-----|--------|
| 31227 | Aggregate | 860.02 | 829.30 | 3.6% | pattern |
| 31231 | Seq Scan | 790.35 | 743.46 | 5.9% | operator |
| 31232 | Hash | 47.52 | 8.29 | 82.6% | operator |
| 31233 | Seq Scan | 47.36 | 23.76 | 49.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31233 (Seq Scan) - LEAF
...
### Step 2: Node 31231 (Seq Scan) - LEAF
...
### Step 4: Node 31227 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31228, 31229, 31230
- **Input Features:**
