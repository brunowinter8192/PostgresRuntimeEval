...
```
Node 31140 (Limit) - ROOT
  Node 31141 (Sort)
    Node 31142 (Aggregate)
      Node 31143 (Gather Merge)
        Node 31144 (Incremental Sort)
          Node 31145 (Nested Loop)
            Node 31146 (Merge Join)
              Node 31147 (Sort)
                Node 31148 (Hash Join) [PATTERN: 895c6e8c]
                  Node 31149 (Seq Scan) [consumed] - LEAF
                  Node 31150 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 31148 | 31149, 31150 |
...
|------|------|--------|-----------|-----|--------|
| 31140 | Limit | 3053.10 | 1175.21 | 61.5% | operator |
| 31141 | Sort | 2943.41 | 1127.81 | 61.7% | operator |
| 31142 | Aggregate | 2943.37 | 1073.15 | 63.5% | operator |
| 31143 | Gather Merge | 2943.36 | 1073.95 | 63.5% | operator |
| 31144 | Incremental Sort | 2922.45 | 0.00 | 100.0% | operator |
| 31145 | Nested Loop | 2922.40 | 1111.34 | 62.0% | operator |
| 31146 | Merge Join | 2922.34 | 0.00 | 100.0% | operator |
| 31155 | Index Scan | 0.02 | 0.05 | 96.2% | operator |
| 31147 | Sort | 2854.44 | 1095.58 | 61.6% | operator |
| 31153 | Sort | 65.05 | 1074.66 | 1552.2% | operator |
| 31148 | Hash Join | 2854.43 | 471.07 | 83.5% | pattern |
| 31154 | Seq Scan | 53.32 | 18.25 | 65.8% | operator |
| 31151 | Aggregate | 2637.37 | 1073.15 | 59.3% | operator |
| 31152 | Index Scan | 2140.20 | 0.00 | 100.0% | operator |
...
### Step 3: Node 31148 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 31149, 31150
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 31154 (Seq Scan) - LEAF
...
### Step 7: Node 31146 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 31155 (Index Scan) - LEAF
...
### Step 10: Node 31144 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 31143 (Gather Merge)
