...
**Test Query:** Q4_38_seed_303549147
...
```
Node 6418 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6419 (Gather Merge) [consumed]
    Node 6420 (Sort) [consumed]
      Node 6421 (Aggregate) [consumed]
        Node 6422 (Nested Loop)
          Node 6423 (Seq Scan) - LEAF
          Node 6424 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6418 | 6419, 6420, 6421 |
...
|------|------|--------|-----------|-----|--------|
| 6418 | Aggregate | 1043.26 | 952.19 | 8.7% | pattern |
| 6422 | Nested Loop | 1036.50 | 1255.45 | 21.1% | operator |
| 6423 | Seq Scan | 163.12 | 154.66 | 5.2% | operator |
| 6424 | Index Scan | 0.06 | 11.10 | 18103.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6423 (Seq Scan) - LEAF
...
### Step 2: Node 6424 (Index Scan) - LEAF
