...
**Test Query:** Q4_89_seed_721954728
...
```
Node 6810 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6811 (Gather Merge) [consumed]
    Node 6812 (Sort) [consumed]
      Node 6813 (Aggregate) [consumed]
        Node 6814 (Nested Loop)
          Node 6815 (Seq Scan) - LEAF
          Node 6816 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6810 | 6811, 6812, 6813 |
...
|------|------|--------|-----------|-----|--------|
| 6810 | Aggregate | 1058.83 | 952.19 | 10.1% | pattern |
| 6814 | Nested Loop | 1052.47 | 1255.45 | 19.3% | operator |
| 6815 | Seq Scan | 162.61 | 154.66 | 4.9% | operator |
| 6816 | Index Scan | 0.06 | 11.10 | 17526.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6815 (Seq Scan) - LEAF
...
### Step 2: Node 6816 (Index Scan) - LEAF
