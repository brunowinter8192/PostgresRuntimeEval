...
**Test Query:** Q12_135_seed_1099340154
...
```
Node 24586 (Aggregate) - ROOT
  Node 24587 (Gather Merge)
    Node 24588 (Aggregate)
      Node 24589 (Sort)
        Node 24590 (Nested Loop)
          Node 24591 (Seq Scan) - LEAF
          Node 24592 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24586 | Aggregate | 1005.37 | 919.07 | 8.6% | operator |
| 24587 | Gather Merge | 1005.34 | 1111.84 | 10.6% | operator |
| 24588 | Aggregate | 986.31 | 895.31 | 9.2% | operator |
| 24589 | Sort | 985.68 | 1092.81 | 10.9% | operator |
| 24590 | Nested Loop | 984.75 | 1127.41 | 14.5% | operator |
| 24591 | Seq Scan | 850.99 | 745.19 | 12.4% | operator |
| 24592 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24591 (Seq Scan) - LEAF
...
### Step 2: Node 24592 (Index Scan) - LEAF
...
### Step 6: Node 24587 (Gather Merge)
...
### Step 7: Node 24586 (Aggregate) - ROOT
