...
```
Node 26672 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26673 (Gather) [consumed]
    Node 26674 (Aggregate) [consumed]
      Node 26675 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26672 | 26673, 26674, 26675 |
...
|------|------|--------|-----------|-----|--------|
| 26672 | Aggregate | 829.14 | 857.12 | 3.4% | pattern |
| 26676 | Seq Scan | 756.33 | 758.47 | 0.3% | operator |
| 26677 | Hash | 41.88 | 9.38 | 77.6% | operator |
| 26678 | Seq Scan | 37.67 | 12.70 | 66.3% | operator |
...
### Step 4: Node 26672 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26673, 26674, 26675
- **Input Features:**
