...
**Test Query:** Q12_54_seed_434813643
...
```
Node 25013 (Aggregate) - ROOT
  Node 25014 (Gather Merge)
    Node 25015 (Aggregate)
      Node 25016 (Sort)
        Node 25017 (Nested Loop)
          Node 25018 (Seq Scan) - LEAF
          Node 25019 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 25013 | Aggregate | 1008.46 | 919.05 | 8.9% | operator |
| 25014 | Gather Merge | 1008.44 | 1111.84 | 10.3% | operator |
| 25015 | Aggregate | 986.96 | 895.30 | 9.3% | operator |
| 25016 | Sort | 986.19 | 1092.82 | 10.8% | operator |
| 25017 | Nested Loop | 985.28 | 1127.41 | 14.4% | operator |
| 25018 | Seq Scan | 844.77 | 745.19 | 11.8% | operator |
| 25019 | Index Scan | 0.03 | 0.07 | 166.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25018 (Seq Scan) - LEAF
...
### Step 2: Node 25019 (Index Scan) - LEAF
...
### Step 6: Node 25014 (Gather Merge)
...
### Step 7: Node 25013 (Aggregate) - ROOT
