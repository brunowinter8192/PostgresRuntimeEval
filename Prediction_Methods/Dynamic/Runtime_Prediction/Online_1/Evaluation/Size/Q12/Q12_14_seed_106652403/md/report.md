...
**Test Query:** Q12_14_seed_106652403
...
```
Node 24698 (Aggregate) - ROOT
  Node 24699 (Gather Merge)
    Node 24700 (Aggregate)
      Node 24701 (Sort)
        Node 24702 (Nested Loop)
          Node 24703 (Seq Scan) - LEAF
          Node 24704 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24698 | Aggregate | 982.90 | 919.07 | 6.5% | operator |
| 24699 | Gather Merge | 982.88 | 1111.84 | 13.1% | operator |
| 24700 | Aggregate | 962.88 | 895.31 | 7.0% | operator |
| 24701 | Sort | 962.26 | 1092.81 | 13.6% | operator |
| 24702 | Nested Loop | 961.25 | 1127.41 | 17.3% | operator |
| 24703 | Seq Scan | 825.82 | 745.19 | 9.8% | operator |
| 24704 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24703 (Seq Scan) - LEAF
...
### Step 2: Node 24704 (Index Scan) - LEAF
...
### Step 6: Node 24699 (Gather Merge)
...
### Step 7: Node 24698 (Aggregate) - ROOT
