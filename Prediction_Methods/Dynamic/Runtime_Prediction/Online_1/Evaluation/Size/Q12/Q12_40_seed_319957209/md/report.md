...
**Test Query:** Q12_40_seed_319957209
...
```
Node 24908 (Aggregate) - ROOT
  Node 24909 (Gather Merge)
    Node 24910 (Aggregate)
      Node 24911 (Sort)
        Node 24912 (Nested Loop)
          Node 24913 (Seq Scan) - LEAF
          Node 24914 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24908 | Aggregate | 1000.62 | 919.05 | 8.2% | operator |
| 24909 | Gather Merge | 1000.60 | 1111.84 | 11.1% | operator |
| 24910 | Aggregate | 981.33 | 895.29 | 8.8% | operator |
| 24911 | Sort | 980.58 | 1092.82 | 11.4% | operator |
| 24912 | Nested Loop | 979.60 | 1127.41 | 15.1% | operator |
| 24913 | Seq Scan | 843.47 | 745.19 | 11.7% | operator |
| 24914 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24913 (Seq Scan) - LEAF
...
### Step 2: Node 24914 (Index Scan) - LEAF
...
### Step 6: Node 24909 (Gather Merge)
...
### Step 7: Node 24908 (Aggregate) - ROOT
