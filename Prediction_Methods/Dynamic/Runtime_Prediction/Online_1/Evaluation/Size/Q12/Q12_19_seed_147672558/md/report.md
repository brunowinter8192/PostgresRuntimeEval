...
**Test Query:** Q12_19_seed_147672558
...
```
Node 24740 (Aggregate) - ROOT
  Node 24741 (Gather Merge)
    Node 24742 (Aggregate)
      Node 24743 (Sort)
        Node 24744 (Nested Loop)
          Node 24745 (Seq Scan) - LEAF
          Node 24746 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24740 | Aggregate | 987.39 | 919.04 | 6.9% | operator |
| 24741 | Gather Merge | 987.38 | 1111.84 | 12.6% | operator |
| 24742 | Aggregate | 967.54 | 895.29 | 7.5% | operator |
| 24743 | Sort | 966.91 | 1092.83 | 13.0% | operator |
| 24744 | Nested Loop | 965.92 | 1127.41 | 16.7% | operator |
| 24745 | Seq Scan | 817.57 | 745.20 | 8.9% | operator |
| 24746 | Index Scan | 0.03 | 0.07 | 156.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24745 (Seq Scan) - LEAF
...
### Step 2: Node 24746 (Index Scan) - LEAF
...
### Step 6: Node 24741 (Gather Merge)
...
### Step 7: Node 24740 (Aggregate) - ROOT
