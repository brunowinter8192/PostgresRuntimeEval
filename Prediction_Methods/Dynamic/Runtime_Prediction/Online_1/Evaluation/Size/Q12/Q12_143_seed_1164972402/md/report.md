...
**Test Query:** Q12_143_seed_1164972402
...
```
Node 24649 (Aggregate) - ROOT
  Node 24650 (Gather Merge)
    Node 24651 (Aggregate)
      Node 24652 (Sort)
        Node 24653 (Nested Loop)
          Node 24654 (Seq Scan) - LEAF
          Node 24655 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24649 | Aggregate | 997.74 | 919.06 | 7.9% | operator |
| 24650 | Gather Merge | 997.70 | 1111.84 | 11.4% | operator |
| 24651 | Aggregate | 977.89 | 895.30 | 8.4% | operator |
| 24652 | Sort | 977.28 | 1092.82 | 11.8% | operator |
| 24653 | Nested Loop | 975.98 | 1127.41 | 15.5% | operator |
| 24654 | Seq Scan | 834.02 | 745.19 | 10.7% | operator |
| 24655 | Index Scan | 0.03 | 0.07 | 166.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24654 (Seq Scan) - LEAF
...
### Step 2: Node 24655 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - st2=0.1246
  - startup_cost=0.4300
  - total_cost=147186.5300
- **Output:** st=38.32, rt=1127.41

### Step 4: Node 24652 (Sort)
...
- **Input Features:**
  ...
  - st1=38.3235
  - st2=0.0000
  - startup_cost=147548.3900
  - total_cost=147562.8600
- **Output:** st=1092.40, rt=1092.82

### Step 5: Node 24651 (Aggregate)
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=147548.3900
  - total_cost=147664.2600
- **Output:** st=868.95, rt=895.30

### Step 6: Node 24650 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=868.9459
  - st2=0.0000
  - startup_cost=148548.4600
  - total_cost=148668.5500
- **Output:** st=1109.22, rt=1111.84

### Step 7: Node 24649 (Aggregate) - ROOT
