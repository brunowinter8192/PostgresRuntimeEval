...
**Test Query:** Q12_47_seed_377385426
...
```
Node 24957 (Aggregate) - ROOT
  Node 24958 (Gather Merge)
    Node 24959 (Aggregate)
      Node 24960 (Sort)
        Node 24961 (Nested Loop)
          Node 24962 (Seq Scan) - LEAF
          Node 24963 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24957 | Aggregate | 1010.19 | 919.06 | 9.0% | operator |
| 24958 | Gather Merge | 1010.11 | 1111.84 | 10.1% | operator |
| 24959 | Aggregate | 989.40 | 895.31 | 9.5% | operator |
| 24960 | Sort | 988.71 | 1092.81 | 10.5% | operator |
| 24961 | Nested Loop | 987.67 | 1127.41 | 14.1% | operator |
| 24962 | Seq Scan | 842.61 | 745.19 | 11.6% | operator |
| 24963 | Index Scan | 0.03 | 0.07 | 156.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24962 (Seq Scan) - LEAF
...
### Step 2: Node 24963 (Index Scan) - LEAF
...
### Step 6: Node 24958 (Gather Merge)
...
### Step 7: Node 24957 (Aggregate) - ROOT
