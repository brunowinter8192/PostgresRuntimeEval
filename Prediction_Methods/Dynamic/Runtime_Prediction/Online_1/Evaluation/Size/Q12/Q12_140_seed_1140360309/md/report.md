...
**Test Query:** Q12_140_seed_1140360309
...
```
Node 24628 (Aggregate) - ROOT
  Node 24629 (Gather Merge)
    Node 24630 (Aggregate)
      Node 24631 (Sort)
        Node 24632 (Nested Loop)
          Node 24633 (Seq Scan) - LEAF
          Node 24634 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24628 | Aggregate | 984.27 | 919.07 | 6.6% | operator |
| 24629 | Gather Merge | 984.26 | 1111.84 | 13.0% | operator |
| 24630 | Aggregate | 965.73 | 895.31 | 7.3% | operator |
| 24631 | Sort | 965.13 | 1092.81 | 13.2% | operator |
| 24632 | Nested Loop | 964.12 | 1127.41 | 16.9% | operator |
| 24633 | Seq Scan | 829.96 | 745.19 | 10.2% | operator |
| 24634 | Index Scan | 0.03 | 0.07 | 187.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24633 (Seq Scan) - LEAF
...
### Step 2: Node 24634 (Index Scan) - LEAF
...
### Step 6: Node 24629 (Gather Merge)
...
### Step 7: Node 24628 (Aggregate) - ROOT
