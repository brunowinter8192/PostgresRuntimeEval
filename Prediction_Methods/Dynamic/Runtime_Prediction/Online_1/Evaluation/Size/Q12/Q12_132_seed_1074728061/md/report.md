...
**Test Query:** Q12_132_seed_1074728061
...
```
Node 24565 (Aggregate) - ROOT
  Node 24566 (Gather Merge)
    Node 24567 (Aggregate)
      Node 24568 (Sort)
        Node 24569 (Nested Loop)
          Node 24570 (Seq Scan) - LEAF
          Node 24571 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24565 | Aggregate | 1006.25 | 919.04 | 8.7% | operator |
| 24566 | Gather Merge | 1006.24 | 1111.84 | 10.5% | operator |
| 24567 | Aggregate | 986.42 | 895.29 | 9.2% | operator |
| 24568 | Sort | 985.81 | 1092.83 | 10.9% | operator |
| 24569 | Nested Loop | 984.87 | 1127.41 | 14.5% | operator |
| 24570 | Seq Scan | 840.94 | 745.20 | 11.4% | operator |
| 24571 | Index Scan | 0.03 | 0.07 | 156.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24570 (Seq Scan) - LEAF
...
### Step 2: Node 24571 (Index Scan) - LEAF
...
### Step 6: Node 24566 (Gather Merge)
...
### Step 7: Node 24565 (Aggregate) - ROOT
