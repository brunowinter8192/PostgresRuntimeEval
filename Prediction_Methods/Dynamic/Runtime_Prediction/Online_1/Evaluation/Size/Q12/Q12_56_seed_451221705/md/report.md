...
**Test Query:** Q12_56_seed_451221705
**Timestamp:** 2025-12-21 17:59:43
...
```
Node 25027 (Aggregate) - ROOT
  Node 25028 (Gather Merge)
    Node 25029 (Aggregate)
      Node 25030 (Sort)
        Node 25031 (Nested Loop)
          Node 25032 (Seq Scan) - LEAF
          Node 25033 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 25027 | Aggregate | 1023.83 | 919.07 | 10.2% | operator |
| 25028 | Gather Merge | 1023.82 | 1111.84 | 8.6% | operator |
| 25029 | Aggregate | 1003.18 | 895.32 | 10.8% | operator |
| 25030 | Sort | 1002.54 | 1092.80 | 9.0% | operator |
| 25031 | Nested Loop | 1001.47 | 1127.41 | 12.6% | operator |
| 25032 | Seq Scan | 862.33 | 745.19 | 13.6% | operator |
| 25033 | Index Scan | 0.03 | 0.07 | 166.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25032 (Seq Scan) - LEAF
...
### Step 2: Node 25033 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - st2=0.1246
  - startup_cost=0.4300
  - total_cost=147148.7500
- **Output:** st=38.33, rt=1127.41

### Step 4: Node 25030 (Sort)
...
- **Input Features:**
  ...
  - st1=38.3281
  - st2=0.0000
  - startup_cost=147507.6800
  - total_cost=147522.0500
- **Output:** st=1092.39, rt=1092.80

### Step 5: Node 25029 (Aggregate)
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=147507.6800
  - total_cost=147622.7100
- **Output:** st=868.97, rt=895.32

### Step 6: Node 25028 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=868.9741
  - st2=0.0000
  - startup_cost=148507.7500
  - total_cost=148627.0000
- **Output:** st=1109.22, rt=1111.84

### Step 7: Node 25027 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=148507.7500
  - total_cost=148627.3300
- **Output:** st=903.61, rt=919.07
