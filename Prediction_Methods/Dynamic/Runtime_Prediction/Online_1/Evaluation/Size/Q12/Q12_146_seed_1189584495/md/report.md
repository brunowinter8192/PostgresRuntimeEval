...
**Test Query:** Q12_146_seed_1189584495
**Timestamp:** 2025-12-21 17:57:25
...
```
Node 24670 (Aggregate) - ROOT
  Node 24671 (Gather Merge)
    Node 24672 (Aggregate)
      Node 24673 (Sort)
        Node 24674 (Nested Loop)
          Node 24675 (Seq Scan) - LEAF
          Node 24676 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24670 | Aggregate | 1003.65 | 919.06 | 8.4% | operator |
| 24671 | Gather Merge | 1003.63 | 1111.84 | 10.8% | operator |
| 24672 | Aggregate | 983.77 | 895.31 | 9.0% | operator |
| 24673 | Sort | 983.13 | 1092.81 | 11.2% | operator |
| 24674 | Nested Loop | 982.03 | 1127.41 | 14.8% | operator |
| 24675 | Seq Scan | 844.14 | 745.19 | 11.7% | operator |
| 24676 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24675 (Seq Scan) - LEAF
...
### Step 2: Node 24676 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - st2=0.1246
  - startup_cost=0.4300
  - total_cost=147173.0400
- **Output:** st=38.33, rt=1127.41

### Step 4: Node 24673 (Sort)
...
- **Input Features:**
  ...
  - st1=38.3251
  - st2=0.0000
  - startup_cost=147533.8500
  - total_cost=147548.2800
- **Output:** st=1092.40, rt=1092.81

### Step 5: Node 24672 (Aggregate)
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=147533.8500
  - total_cost=147649.4200
- **Output:** st=868.96, rt=895.31

### Step 6: Node 24671 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=868.9560
  - st2=0.0000
  - startup_cost=148533.9200
  - total_cost=148653.7100
- **Output:** st=1109.22, rt=1111.84

### Step 7: Node 24670 (Aggregate) - ROOT
