...
**Test Query:** Q12_52_seed_418405581
...
```
Node 24999 (Aggregate) - ROOT
  Node 25000 (Gather Merge)
    Node 25001 (Aggregate)
      Node 25002 (Sort)
        Node 25003 (Nested Loop)
          Node 25004 (Seq Scan) - LEAF
          Node 25005 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24999 | Aggregate | 984.23 | 919.05 | 6.6% | operator |
| 25000 | Gather Merge | 984.22 | 1111.84 | 13.0% | operator |
| 25001 | Aggregate | 965.78 | 895.29 | 7.3% | operator |
| 25002 | Sort | 965.18 | 1092.82 | 13.2% | operator |
| 25003 | Nested Loop | 964.25 | 1127.41 | 16.9% | operator |
| 25004 | Seq Scan | 823.35 | 745.19 | 9.5% | operator |
| 25005 | Index Scan | 0.03 | 0.07 | 166.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25004 (Seq Scan) - LEAF
...
### Step 2: Node 25005 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - st2=0.1246
  - startup_cost=0.4300
  - total_cost=147200.0700
- **Output:** st=38.32, rt=1127.41

### Step 4: Node 25002 (Sort)
...
- **Input Features:**
  ...
  - st1=38.3218
  - st2=0.0000
  - startup_cost=147562.9700
  - total_cost=147577.4900
- **Output:** st=1092.41, rt=1092.82

### Step 5: Node 25001 (Aggregate)
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=147562.9700
  - total_cost=147679.1400
- **Output:** st=868.94, rt=895.29

### Step 6: Node 25000 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=868.9358
  - st2=0.0000
  - startup_cost=148563.0500
  - total_cost=148683.4400
- **Output:** st=1109.22, rt=1111.84

### Step 7: Node 24999 (Aggregate) - ROOT
