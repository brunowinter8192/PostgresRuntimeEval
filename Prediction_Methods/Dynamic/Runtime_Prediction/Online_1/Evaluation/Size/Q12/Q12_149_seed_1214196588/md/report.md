...
**Test Query:** Q12_149_seed_1214196588
...
```
Node 24691 (Aggregate) - ROOT
  Node 24692 (Gather Merge)
    Node 24693 (Aggregate)
      Node 24694 (Sort)
        Node 24695 (Nested Loop)
          Node 24696 (Seq Scan) - LEAF
          Node 24697 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24691 | Aggregate | 1000.17 | 919.07 | 8.1% | operator |
| 24692 | Gather Merge | 1000.14 | 1111.84 | 11.2% | operator |
| 24693 | Aggregate | 982.44 | 895.31 | 8.9% | operator |
| 24694 | Sort | 981.77 | 1092.81 | 11.3% | operator |
| 24695 | Nested Loop | 980.77 | 1127.41 | 15.0% | operator |
| 24696 | Seq Scan | 846.16 | 745.19 | 11.9% | operator |
| 24697 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24696 (Seq Scan) - LEAF
...
### Step 2: Node 24697 (Index Scan) - LEAF
...
### Step 6: Node 24692 (Gather Merge)
...
### Step 7: Node 24691 (Aggregate) - ROOT
