...
**Test Query:** Q12_18_seed_139468527
...
```
Node 24733 (Aggregate) - ROOT
  Node 24734 (Gather Merge)
    Node 24735 (Aggregate)
      Node 24736 (Sort)
        Node 24737 (Nested Loop)
          Node 24738 (Seq Scan) - LEAF
          Node 24739 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24733 | Aggregate | 991.35 | 919.04 | 7.3% | operator |
| 24734 | Gather Merge | 991.33 | 1111.84 | 12.2% | operator |
| 24735 | Aggregate | 971.66 | 895.29 | 7.9% | operator |
| 24736 | Sort | 971.06 | 1092.83 | 12.5% | operator |
| 24737 | Nested Loop | 970.16 | 1127.41 | 16.2% | operator |
| 24738 | Seq Scan | 825.97 | 745.20 | 9.8% | operator |
| 24739 | Index Scan | 0.03 | 0.07 | 166.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24738 (Seq Scan) - LEAF
...
### Step 2: Node 24739 (Index Scan) - LEAF
...
### Step 6: Node 24734 (Gather Merge)
...
### Step 7: Node 24733 (Aggregate) - ROOT
