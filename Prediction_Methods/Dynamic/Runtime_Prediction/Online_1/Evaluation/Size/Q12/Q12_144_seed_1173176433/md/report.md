...
**Test Query:** Q12_144_seed_1173176433
...
```
Node 24656 (Aggregate) - ROOT
  Node 24657 (Gather Merge)
    Node 24658 (Aggregate)
      Node 24659 (Sort)
        Node 24660 (Nested Loop)
          Node 24661 (Seq Scan) - LEAF
          Node 24662 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24656 | Aggregate | 1017.79 | 919.06 | 9.7% | operator |
| 24657 | Gather Merge | 1017.76 | 1111.84 | 9.2% | operator |
| 24658 | Aggregate | 997.27 | 895.31 | 10.2% | operator |
| 24659 | Sort | 996.65 | 1092.81 | 9.6% | operator |
| 24660 | Nested Loop | 995.72 | 1127.41 | 13.2% | operator |
| 24661 | Seq Scan | 842.85 | 745.19 | 11.6% | operator |
| 24662 | Index Scan | 0.03 | 0.07 | 147.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24661 (Seq Scan) - LEAF
...
### Step 2: Node 24662 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - st2=0.1246
  - startup_cost=0.4300
  - total_cost=147173.8400
- **Output:** st=38.32, rt=1127.41

### Step 4: Node 24659 (Sort)
...
- **Input Features:**
  ...
  - st1=38.3250
  - st2=0.0000
  - startup_cost=147534.7200
  - total_cost=147549.1600
- **Output:** st=1092.40, rt=1092.81

### Step 5: Node 24658 (Aggregate)
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=147534.7200
  - total_cost=147650.3100
- **Output:** st=868.96, rt=895.31

### Step 6: Node 24657 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=868.9554
  - st2=0.0000
  - startup_cost=148534.8000
  - total_cost=148654.6000
- **Output:** st=1109.22, rt=1111.84

### Step 7: Node 24656 (Aggregate) - ROOT
