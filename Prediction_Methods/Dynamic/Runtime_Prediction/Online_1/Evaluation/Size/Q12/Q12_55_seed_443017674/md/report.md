...
**Test Query:** Q12_55_seed_443017674
...
```
Node 25020 (Aggregate) - ROOT
  Node 25021 (Gather Merge)
    Node 25022 (Aggregate)
      Node 25023 (Sort)
        Node 25024 (Nested Loop)
          Node 25025 (Seq Scan) - LEAF
          Node 25026 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 25020 | Aggregate | 981.10 | 919.06 | 6.3% | operator |
| 25021 | Gather Merge | 981.08 | 1111.84 | 13.3% | operator |
| 25022 | Aggregate | 961.76 | 895.31 | 6.9% | operator |
| 25023 | Sort | 961.14 | 1092.81 | 13.7% | operator |
| 25024 | Nested Loop | 960.17 | 1127.41 | 17.4% | operator |
| 25025 | Seq Scan | 821.32 | 745.19 | 9.3% | operator |
| 25026 | Index Scan | 0.03 | 0.07 | 166.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25025 (Seq Scan) - LEAF
...
### Step 2: Node 25026 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=147536.6300
  - total_cost=147652.2600
- **Output:** st=868.95, rt=895.31

### Step 6: Node 25021 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=868.9541
  - st2=0.0000
  - startup_cost=148536.7100
  - total_cost=148656.5500
- **Output:** st=1109.22, rt=1111.84

### Step 7: Node 25020 (Aggregate) - ROOT
