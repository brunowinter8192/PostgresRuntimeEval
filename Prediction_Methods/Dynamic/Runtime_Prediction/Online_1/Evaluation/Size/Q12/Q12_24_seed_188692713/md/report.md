...
**Test Query:** Q12_24_seed_188692713
...
```
Node 24782 (Aggregate) - ROOT
  Node 24783 (Gather Merge)
    Node 24784 (Aggregate)
      Node 24785 (Sort)
        Node 24786 (Nested Loop)
          Node 24787 (Seq Scan) - LEAF
          Node 24788 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24782 | Aggregate | 1003.43 | 919.05 | 8.4% | operator |
| 24783 | Gather Merge | 1003.41 | 1111.84 | 10.8% | operator |
| 24784 | Aggregate | 984.54 | 895.30 | 9.1% | operator |
| 24785 | Sort | 983.93 | 1092.82 | 11.1% | operator |
| 24786 | Nested Loop | 983.02 | 1127.41 | 14.7% | operator |
| 24787 | Seq Scan | 838.39 | 745.19 | 11.1% | operator |
| 24788 | Index Scan | 0.03 | 0.07 | 156.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24787 (Seq Scan) - LEAF
...
### Step 2: Node 24788 (Index Scan) - LEAF
...
### Step 6: Node 24783 (Gather Merge)
...
### Step 7: Node 24782 (Aggregate) - ROOT
