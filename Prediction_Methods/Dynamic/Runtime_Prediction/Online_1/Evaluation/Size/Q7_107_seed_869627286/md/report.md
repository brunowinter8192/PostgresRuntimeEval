...
**Test Query:** Q7_107_seed_869627286
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 10635 | 10627, 10628, 10632, 10633, 10634, 10636, 10637, 10638, 10641, 10642, 10643, 10644 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 10641 | 10627, 10628, 10632, 10633, 10634, 10635, 10636, 10637, 10638, 10642, 10643, 10644 |
| Aggregate -> Gather Merge (Out | 2724c080 | 10627 | 10628, 10632, 10633, 10634, 10635, 10636, 10637, 10638, 10641, 10642, 10643, 10644 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 10632 | 10627, 10628, 10633, 10634, 10635, 10636, 10637, 10638, 10641, 10642, 10643, 10644 |
...
|------|------|--------|-----------|-----|--------|
| 10627 | Aggregate | 1193.48 | 1163.13 | 2.5% | pattern |
| 10629 | Sort | 1186.51 | 1109.16 | 6.5% | operator |
| 10630 | Hash Join | 1185.90 | 843.11 | 28.9% | operator |
| 10631 | Nested Loop | 1178.93 | 1215.99 | 3.1% | operator |
| 10640 | Hash | 3.21 | 27.74 | 764.3% | operator |
| 10632 | Hash Join | 213.26 | 304.89 | 43.0% | pattern |
| 10639 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 10641 | Hash Join | 3.16 | 429.36 | 13478.8% | pattern |
| 10635 | Hash Join | 37.51 | 429.38 | 1044.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10635 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 10627, 10628, 10632, 10633, 10634, 10636, 10637, 10638, 10641, 10642, 10643, 10644
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5000
  - HashJoin_nt1=62500
...
### Step 2: Node 10632 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 10627, 10628, 10633, 10634, 10635, 10636, 10637, 10638, 10641, 10642, 10643, 10644
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=38710
  - HashJoin_nt1=483871
...
### Step 3: Node 10639 (Index Scan) - LEAF
...
### Step 4: Node 10641 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 10627, 10628, 10632, 10633, 10634, 10635, 10636, 10637, 10638, 10642, 10643, 10644
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=800
  - HashJoin_nt1=10000
...
### Step 9: Node 10627 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 10628, 10632, 10633, 10634, 10635, 10636, 10637, 10638, 10641, 10642, 10643, 10644
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
