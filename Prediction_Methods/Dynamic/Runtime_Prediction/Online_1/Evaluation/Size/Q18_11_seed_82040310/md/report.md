        ...
        Node 29160 (Incremental Sort)
          Node 29161 (Nested Loop)
            Node 29162 (Merge Join)
              Node 29163 (Sort)
                Node 29164 (Hash Join)
                  Node 29165 (Seq Scan) - LEAF
                  Node 29166 (Hash)
...
| 29163 | Sort | 2816.20 | 1099.77 | 60.9% | operator |
| 29169 | Sort | 65.81 | 1074.66 | 1533.1% | operator |
| 29164 | Hash Join | 2816.17 | 686.33 | 75.6% | operator |
| 29170 | Seq Scan | 53.80 | 18.25 | 66.1% | operator |
| 29165 | Seq Scan | 197.12 | 170.37 | 13.6% | operator |
| 29166 | Hash | 2589.58 | 21.04 | 99.2% | operator |
...
### Step 3: Node 29165 (Seq Scan) - LEAF
...
### Step 6: Node 29170 (Seq Scan) - LEAF
...
### Step 9: Node 29162 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29171 (Index Scan) - LEAF
...
### Step 11: Node 29161 (Nested Loop)
...
### Step 12: Node 29160 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29159 (Gather Merge)
