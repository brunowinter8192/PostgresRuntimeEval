...
**Test Query:** Q18_11_seed_82040310
...
```
Node 29156 (Limit) - ROOT
  Node 29157 (Sort)
    Node 29158 (Aggregate)
      Node 29159 (Gather Merge)
        Node 29160 (Incremental Sort)
          Node 29161 (Nested Loop)
            Node 29162 (Merge Join)
              Node 29163 (Sort)
                Node 29164 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29165 (Seq Scan) [consumed] - LEAF
                  Node 29166 (Hash) [consumed]
                    Node 29167 (Aggregate)
                      Node 29168 (Index Scan) - LEAF
              Node 29169 (Sort)
                Node 29170 (Seq Scan) - LEAF
            Node 29171 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29164 | 29165, 29166 |
...
|------|------|--------|-----------|-----|--------|
| 29156 | Limit | 3025.54 | 1175.21 | 61.2% | operator |
| 29157 | Sort | 2909.25 | 1127.81 | 61.2% | operator |
| 29158 | Aggregate | 2909.21 | 1073.15 | 63.1% | operator |
| 29159 | Gather Merge | 2909.20 | 1073.95 | 63.1% | operator |
| 29160 | Incremental Sort | 2885.78 | 0.00 | 100.0% | operator |
| 29161 | Nested Loop | 2884.97 | 1111.34 | 61.5% | operator |
| 29162 | Merge Join | 2884.91 | 0.00 | 100.0% | operator |
| 29171 | Index Scan | 0.02 | 0.05 | 105.2% | operator |
| 29163 | Sort | 2816.20 | 1095.58 | 61.1% | operator |
| 29169 | Sort | 65.81 | 1074.66 | 1533.1% | operator |
| 29164 | Hash Join | 2816.17 | 471.07 | 83.3% | pattern |
| 29170 | Seq Scan | 53.80 | 18.25 | 66.1% | operator |
| 29167 | Aggregate | 2589.54 | 1073.15 | 58.6% | operator |
| 29168 | Index Scan | 2086.67 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29168 (Index Scan) - LEAF
...
### Step 3: Node 29164 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29165, 29166
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29170 (Seq Scan) - LEAF
...
### Step 7: Node 29162 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29171 (Index Scan) - LEAF
...
### Step 10: Node 29160 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29159 (Gather Merge)
