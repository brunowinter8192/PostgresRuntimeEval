...
```
Node 26735 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26736 (Gather) [consumed]
    Node 26737 (Aggregate) [consumed]
      Node 26738 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26735 | 26736, 26737, 26738 |
...
|------|------|--------|-----------|-----|--------|
| 26735 | Aggregate | 823.02 | 857.12 | 4.1% | pattern |
| 26739 | Seq Scan | 747.72 | 758.47 | 1.4% | operator |
| 26740 | Hash | 42.83 | 9.38 | 78.1% | operator |
| 26741 | Seq Scan | 37.33 | 12.70 | 66.0% | operator |
...
### Step 4: Node 26735 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26736, 26737, 26738
- **Input Features:**
