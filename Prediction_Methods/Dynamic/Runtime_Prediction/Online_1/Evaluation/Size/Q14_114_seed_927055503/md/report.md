...
```
Node 26525 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26526 (Gather) [consumed]
    Node 26527 (Aggregate) [consumed]
      Node 26528 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26525 | 26526, 26527 |
...
|------|------|--------|-----------|-----|--------|
| 26525 | Aggregate | 810.64 | 848.36 | 4.7% | pattern |
| 26528 | Hash Join | 788.63 | 807.64 | 2.4% | operator |
...
### Step 5: Node 26525 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26526, 26527
- **Input Features:**
