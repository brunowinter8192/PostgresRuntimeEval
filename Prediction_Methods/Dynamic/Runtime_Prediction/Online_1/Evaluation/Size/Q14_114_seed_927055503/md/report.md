...
**Test Query:** Q14_114_seed_927055503
...
```
Node 26525 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26526 (Gather) [consumed]
    Node 26527 (Aggregate) [consumed]
      Node 26528 (Hash Join) [consumed]
        Node 26529 (Seq Scan) - LEAF
        Node 26530 (Hash)
          Node 26531 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26525 | 26526, 26527, 26528 |
...
|------|------|--------|-----------|-----|--------|
| 26525 | Aggregate | 810.64 | 857.13 | 5.7% | pattern |
| 26529 | Seq Scan | 736.91 | 758.48 | 2.9% | operator |
| 26530 | Hash | 43.09 | 9.38 | 78.2% | operator |
| 26531 | Seq Scan | 38.36 | 12.70 | 66.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26531 (Seq Scan) - LEAF
...
### Step 2: Node 26529 (Seq Scan) - LEAF
...
### Step 4: Node 26525 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26526, 26527, 26528
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=15135
  - HashJoin_Outer_nt1=15135
  ...
  - HashJoin_Outer_total_cost=136646.3700
