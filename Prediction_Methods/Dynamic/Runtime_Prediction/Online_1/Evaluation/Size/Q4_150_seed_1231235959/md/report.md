...
```
Node 6236 (Aggregate) [PATTERN: f8231c4d] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6236 | 6237, 6238, 6239 |
...
|------|------|--------|-----------|-----|--------|
| 6236 | Aggregate | 1061.67 | 952.19 | 10.3% | pattern |
| 6240 | Nested Loop | 1055.50 | 1255.45 | 18.9% | operator |
| 6241 | Seq Scan | 165.68 | 154.66 | 6.7% | operator |
| 6242 | Index Scan | 0.06 | 11.10 | 17810.2% | operator |
...
### Step 4: Node 6236 (Aggregate) - PATTERN ROOT
