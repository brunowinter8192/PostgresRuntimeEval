...
**Test Query:** Q14_11_seed_82040310
...
```
Node 26567 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26568 (Gather) [consumed]
    Node 26569 (Aggregate) [consumed]
      Node 26570 (Hash Join) [consumed]
        Node 26571 (Seq Scan) - LEAF
        Node 26572 (Hash)
          Node 26573 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26567 | 26568, 26569, 26570 |
...
|------|------|--------|-----------|-----|--------|
| 26567 | Aggregate | 809.78 | 857.14 | 5.8% | pattern |
| 26571 | Seq Scan | 736.61 | 758.50 | 3.0% | operator |
| 26572 | Hash | 44.08 | 9.38 | 78.7% | operator |
| 26573 | Seq Scan | 38.66 | 12.70 | 67.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26573 (Seq Scan) - LEAF
...
### Step 2: Node 26571 (Seq Scan) - LEAF
...
### Step 4: Node 26567 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26568, 26569, 26570
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=15561
  - HashJoin_Outer_nt1=15561
  ...
  - HashJoin_Outer_total_cost=136647.4900
