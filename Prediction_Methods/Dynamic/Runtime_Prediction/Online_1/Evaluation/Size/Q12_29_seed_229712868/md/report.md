...
**Test Query:** Q12_29_seed_229712868
...
```
Node 24817 (Aggregate) - ROOT
  Node 24818 (Gather Merge)
    Node 24819 (Aggregate)
      Node 24820 (Sort)
        Node 24821 (Nested Loop)
          Node 24822 (Seq Scan) - LEAF
          Node 24823 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24817 | Aggregate | 1011.51 | 919.06 | 9.1% | operator |
| 24818 | Gather Merge | 1011.49 | 1111.84 | 9.9% | operator |
| 24819 | Aggregate | 990.79 | 895.30 | 9.6% | operator |
| 24820 | Sort | 990.16 | 1092.82 | 10.4% | operator |
| 24821 | Nested Loop | 989.21 | 1127.41 | 14.0% | operator |
| 24822 | Seq Scan | 855.72 | 745.19 | 12.9% | operator |
| 24823 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24822 (Seq Scan) - LEAF
...
### Step 2: Node 24823 (Index Scan) - LEAF
...
### Step 6: Node 24818 (Gather Merge)
...
### Step 7: Node 24817 (Aggregate) - ROOT
