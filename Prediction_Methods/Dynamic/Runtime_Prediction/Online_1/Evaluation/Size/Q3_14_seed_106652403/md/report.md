...
**Test Query:** Q3_14_seed_106652403
...
```
Node 4891 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 4892 (Sort) [consumed]
    Node 4893 (Aggregate) [consumed]
      Node 4894 (Gather) [consumed]
        Node 4895 (Nested Loop)
          Node 4896 (Hash Join) [PATTERN: 895c6e8c]
            Node 4897 (Seq Scan) [consumed] - LEAF
            Node 4898 (Hash) [consumed]
              Node 4899 (Seq Scan) - LEAF
          Node 4900 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4891 | 4892, 4893, 4894, 4896, 4897, 4898 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4896 | 4891, 4892, 4893, 4894, 4897, 4898 |
...
|------|------|--------|-----------|-----|--------|
| 4891 | Limit | 1203.64 | 1151.18 | 4.4% | pattern |
| 4895 | Nested Loop | 1167.30 | 1192.95 | 2.2% | operator |
| 4896 | Hash Join | 213.16 | 242.46 | 13.7% | pattern |
| 4900 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4899 | Seq Scan | 28.84 | 38.53 | 33.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4899 (Seq Scan) - LEAF
...
### Step 2: Node 4896 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4891, 4892, 4893, 4894, 4897, 4898
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46753
  - HashJoin_nt1=232303
  ...
  - HashJoin_total_cost=37332.6900
  - Hash_Inner_np=0
  - Hash_Inner_nt=12579
...
- **Input Features:**
  ...
  - total_cost=72847.7800
- **Output:** st=121.68, rt=1192.95

### Step 5: Node 4891 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4892, 4893, 4894, 4896, 4897, 4898
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=315532
  - Aggregate_Outer_nt1=315532
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110133.9600
  - Aggregate_Outer_total_cost=114078.1100
  - Gather_Outer_np=0
  - Gather_Outer_nt=315532
  - Gather_Outer_nt1=101785
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105400.9800
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=315532
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=120896.6500
  - Limit_total_cost=120896.6700
  - Sort_Outer_np=0
  - Sort_Outer_nt=315532
  - Sort_Outer_nt1=315532
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=120896.6500
  - Sort_Outer_total_cost=121685.4800
