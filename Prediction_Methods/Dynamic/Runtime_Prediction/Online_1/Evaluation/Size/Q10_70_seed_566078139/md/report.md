...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20891 | 20892, 20893, 20894, 20896, 20897, 20900 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 20896 | 20891, 20892, 20893, 20894, 20897, 20900 |
...
|------|------|--------|-----------|-----|--------|
| 20891 | Limit | 1168.10 | 1199.47 | 2.7% | pattern |
| 20895 | Hash Join | 1118.53 | 1095.56 | 2.1% | operator |
| 20896 | Hash Join | 1115.66 | 1120.19 | 0.4% | pattern |
| 20902 | Hash | 0.02 | 15.71 | 98092.3% | operator |
| 20903 | Seq Scan | 0.01 | 6.98 | 58055.9% | operator |
| 20898 | Seq Scan | 164.43 | 159.74 | 2.8% | operator |
| 20899 | Index Scan | 0.06 | -0.52 | 909.7% | operator |
| 20901 | Seq Scan | 24.22 | 26.64 | 10.0% | operator |
...
### Step 4: Node 20903 (Seq Scan) - LEAF
...
- **Consumes:** Nodes 20891, 20892, 20893, 20894, 20897, 20900
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18231
  - HashJoin_nt1=18231
...
### Step 8: Node 20891 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20892, 20893, 20894, 20896, 20897, 20900
- **Input Features:**
