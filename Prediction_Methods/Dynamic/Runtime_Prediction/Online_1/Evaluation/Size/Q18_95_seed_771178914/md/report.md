...
**Test Query:** Q18_95_seed_771178914
...
```
Node 31124 (Limit) - ROOT
  Node 31125 (Sort)
    Node 31126 (Aggregate)
      Node 31127 (Gather Merge)
        Node 31128 (Incremental Sort)
          Node 31129 (Nested Loop)
            Node 31130 (Merge Join)
              Node 31131 (Sort)
                Node 31132 (Hash Join) [PATTERN: 895c6e8c]
                  Node 31133 (Seq Scan) [consumed] - LEAF
                  Node 31134 (Hash) [consumed]
                    Node 31135 (Aggregate)
                      Node 31136 (Index Scan) - LEAF
              Node 31137 (Sort)
                Node 31138 (Seq Scan) - LEAF
            Node 31139 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 31132 | 31133, 31134 |
...
|------|------|--------|-----------|-----|--------|
| 31124 | Limit | 3081.81 | 1175.21 | 61.9% | operator |
| 31125 | Sort | 2970.81 | 1127.81 | 62.0% | operator |
| 31126 | Aggregate | 2970.77 | 1073.15 | 63.9% | operator |
| 31127 | Gather Merge | 2970.75 | 1073.95 | 63.8% | operator |
| 31128 | Incremental Sort | 2953.30 | 0.00 | 100.0% | operator |
| 31129 | Nested Loop | 2953.25 | 1111.34 | 62.4% | operator |
| 31130 | Merge Join | 2953.18 | 0.00 | 100.0% | operator |
| 31139 | Index Scan | 0.02 | 0.05 | 88.1% | operator |
| 31131 | Sort | 2880.63 | 1095.58 | 62.0% | operator |
| 31137 | Sort | 69.70 | 1074.66 | 1441.7% | operator |
| 31132 | Hash Join | 2880.62 | 471.07 | 83.6% | pattern |
| 31138 | Seq Scan | 57.52 | 18.25 | 68.3% | operator |
| 31135 | Aggregate | 2659.81 | 1073.15 | 59.7% | operator |
| 31136 | Index Scan | 2162.16 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31136 (Index Scan) - LEAF
...
### Step 3: Node 31132 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 31133, 31134
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 31138 (Seq Scan) - LEAF
...
### Step 7: Node 31130 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 31139 (Index Scan) - LEAF
...
### Step 10: Node 31128 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 31127 (Gather Merge)
