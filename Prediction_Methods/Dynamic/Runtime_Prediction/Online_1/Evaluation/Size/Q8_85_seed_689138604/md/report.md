          ...
          Node 16265 (Hash Join)
            Node 16266 (Nested Loop)
              Node 16267 (Hash Join)
                ...
                Node 16269 (Hash) [PATTERN: 444761fb]
                  Node 16270 (Hash Join) [consumed]
                    Node 16271 (Seq Scan) [consumed] - LEAF
                    Node 16272 (Hash) [consumed]
                      Node 16273 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 16269 | 16260, 16261, 16270, 16271, 16272, 16273 |
| Aggregate -> Gather Merge (Out | 2724c080 | 16260 | 16261, 16269, 16270, 16271, 16272, 16273 |
...
|------|------|--------|-----------|-----|--------|
| 16260 | Aggregate | 1238.83 | 1133.65 | 8.5% | pattern |
| 16262 | Sort | 1232.98 | 1046.21 | 15.1% | operator |
| 16263 | Hash Join | 1232.74 | 785.61 | 36.3% | operator |
| 16264 | Nested Loop | 1232.43 | 1198.29 | 2.8% | operator |
| 16281 | Hash | 0.02 | 13.72 | 85675.5% | operator |
| 16265 | Hash Join | 1228.64 | 785.60 | 36.1% | operator |
| 16280 | Index Scan | 0.01 | 12.42 | 206958.1% | operator |
| 16282 | Seq Scan | 0.01 | 6.51 | 54166.4% | operator |
| 16266 | Nested Loop | 1184.39 | 1198.29 | 1.2% | operator |
| 16278 | Hash | 39.71 | 19.97 | 49.7% | operator |
| 16267 | Hash Join | 218.50 | 251.67 | 15.2% | operator |
| 16277 | Index Scan | 0.04 | 2.88 | 6759.2% | operator |
| 16279 | Seq Scan | 39.61 | 48.88 | 23.4% | operator |
| 16268 | Seq Scan | 159.99 | 159.67 | 0.2% | operator |
| 16269 | Hash | 38.38 | 43.51 | 13.4% | pattern |
| 16274 | Seq Scan | 0.01 | 12.22 | 135732.7% | operator |
| 16275 | Hash | 0.14 | 18.14 | 13143.9% | operator |
| 16276 | Seq Scan | 0.13 | 23.36 | 17465.6% | operator |
...
### Step 4: Node 16268 (Seq Scan) - LEAF
...
### Step 5: Node 16269 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 16260, 16261, 16270, 16271, 16272, 16273
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 16277 (Index Scan) - LEAF
...
### Step 8: Node 16279 (Seq Scan) - LEAF
...
### Step 12: Node 16280 (Index Scan) - LEAF
...
### Step 13: Node 16282 (Seq Scan) - LEAF
...
### Step 14: Node 16264 (Nested Loop)
...
### Step 18: Node 16260 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 16261, 16269, 16270, 16271, 16272, 16273
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2376
  - Aggregate_nt1=2376
