...
```
Node 18952 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18953 (Aggregate) [consumed]
    Node 18954 (Gather)
      Node 18955 (Aggregate)
        Node 18956 (Hash Join)
          Node 18957 (Seq Scan) - LEAF
          Node 18958 (Hash) [PATTERN: 444761fb]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 18958 | 18952, 18953, 18959, 18960, 18961, 18962 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18952 | 18953, 18958, 18959, 18960, 18961, 18962 |
...
|------|------|--------|-----------|-----|--------|
| 18952 | Sort | 1284.67 | 1063.12 | 17.2% | pattern |
| 18954 | Gather | 1283.81 | 962.19 | 25.1% | operator |
| 18955 | Aggregate | 1265.75 | 922.12 | 27.1% | operator |
| 18956 | Hash Join | 1237.34 | 571.38 | 53.8% | operator |
| 18957 | Seq Scan | 130.84 | 193.40 | 47.8% | operator |
| 18958 | Hash | 1044.43 | 35.69 | 96.6% | pattern |
| 18963 | Hash Join | 195.40 | 837.74 | 328.7% | operator |
| 18969 | Hash | 14.63 | 14.95 | 2.2% | operator |
| 18964 | Nested Loop | 188.27 | 1251.77 | 564.9% | operator |
| 18967 | Hash | 4.45 | 15.94 | 258.5% | operator |
| 18970 | Seq Scan | 14.62 | 2.94 | 79.9% | operator |
| 18965 | Seq Scan | 26.32 | 43.69 | 66.0% | operator |
| 18966 | Index Scan | 0.06 | -1.39 | 2453.4% | operator |
| 18968 | Seq Scan | 3.95 | 9.45 | 139.2% | operator |
...
### Step 10: Node 18958 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 18952, 18953, 18959, 18960, 18961, 18962
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 14: Node 18952 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18953, 18958, 18959, 18960, 18961, 18962
- **Input Features:**
