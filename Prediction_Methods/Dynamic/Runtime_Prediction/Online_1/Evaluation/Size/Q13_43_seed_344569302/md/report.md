...
**Test Query:** Q13_43_seed_344569302
...
```
Node 25979 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25980 (Aggregate) [consumed]
    Node 25981 (Aggregate)
      Node 25982 (Hash Join) [PATTERN: 895c6e8c]
        Node 25983 (Seq Scan) [consumed] - LEAF
        Node 25984 (Hash) [consumed]
          Node 25985 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25979 | 25980, 25982, 25983, 25984 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25982 | 25979, 25980, 25983, 25984 |
...
|------|------|--------|-----------|-----|--------|
| 25979 | Sort | 900.61 | 1079.93 | 19.9% | pattern |
| 25981 | Aggregate | 894.67 | 999.55 | 11.7% | operator |
| 25982 | Hash Join | 696.62 | 470.31 | 32.5% | pattern |
| 25985 | Index Only Scan | 10.02 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25985 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25982 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25979, 25980, 25983, 25984
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1484970
...
### Step 4: Node 25979 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25980, 25982, 25983, 25984
- **Input Features:**
