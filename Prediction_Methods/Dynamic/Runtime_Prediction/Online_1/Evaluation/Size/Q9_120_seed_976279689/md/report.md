...
**Test Query:** Q9_120_seed_976279689
...
```
Node 17050 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 17051 (Aggregate) [consumed]
    Node 17052 (Gather)
      Node 17053 (Aggregate)
        Node 17054 (Nested Loop)
          Node 17055 (Hash Join) [PATTERN: bb930825]
            Node 17056 (Seq Scan) [consumed] - LEAF
            Node 17057 (Hash) [consumed]
              Node 17058 (Hash Join) [consumed]
                Node 17059 (Hash Join)
                  Node 17060 (Nested Loop)
                    Node 17061 (Seq Scan) - LEAF
                    Node 17062 (Index Scan) - LEAF
                  Node 17063 (Hash)
                    Node 17064 (Seq Scan) - LEAF
                Node 17065 (Hash)
                  Node 17066 (Seq Scan) - LEAF
          Node 17067 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17055 | 17050, 17051, 17056, 17057, 17058 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17050 | 17051, 17055, 17056, 17057, 17058 |
...
|------|------|--------|-----------|-----|--------|
| 17050 | Sort | 1198.58 | 1044.29 | 12.9% | pattern |
| 17052 | Gather | 1197.13 | 965.14 | 19.4% | operator |
| 17053 | Aggregate | 1178.53 | 1141.19 | 3.2% | operator |
| 17054 | Nested Loop | 1153.41 | 1252.17 | 8.6% | operator |
| 17055 | Hash Join | 972.92 | 134.80 | 86.1% | pattern |
| 17067 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17059 | Hash Join | 165.30 | 837.49 | 406.6% | operator |
| 17065 | Hash | 12.70 | 14.95 | 17.7% | operator |
| 17060 | Nested Loop | 160.08 | 1251.76 | 681.9% | operator |
| 17063 | Hash | 3.22 | 15.94 | 395.7% | operator |
| 17066 | Seq Scan | 12.69 | 2.94 | 76.8% | operator |
| 17061 | Seq Scan | 19.72 | 44.30 | 124.7% | operator |
| 17062 | Index Scan | 0.08 | -1.39 | 1926.9% | operator |
| 17064 | Seq Scan | 2.78 | 9.45 | 240.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 17061 (Seq Scan) - LEAF
...
### Step 2: Node 17062 (Index Scan) - LEAF
...
### Step 3: Node 17064 (Seq Scan) - LEAF
...
### Step 6: Node 17066 (Seq Scan) - LEAF
...
### Step 9: Node 17055 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17050, 17051, 17056, 17057, 17058
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17067 (Index Scan) - LEAF
...
### Step 11: Node 17054 (Nested Loop)
...
### Step 14: Node 17050 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17051, 17055, 17056, 17057, 17058
- **Input Features:**
