...
**Test Query:** Q1_63_seed_508649922
...
```
Node 546 (Aggregate) - ROOT
  Node 547 (Gather Merge)
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 548 | 549 |
...
|------|------|--------|-----------|-----|--------|
| 546 | Aggregate | 989.69 | 1195.84 | 20.8% | operator |
| 547 | Gather Merge | 989.65 | 1165.89 | 17.8% | operator |
| 548 | Sort | 973.32 | 1200.32 | 23.3% | pattern |
| 550 | Seq Scan | 594.04 | 680.95 | 14.6% | operator |
...
### Step 4: Node 546 (Aggregate) - ROOT
