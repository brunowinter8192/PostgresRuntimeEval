...
**Test Query:** Q6_113_seed_918851472
...
```
Node 9957 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 9958 (Gather) [consumed]
    Node 9959 (Aggregate) [consumed]
      Node 9960 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 9957 | 9958, 9959 |
...
|------|------|--------|-----------|-----|--------|
| 9957 | Aggregate | 812.63 | 849.99 | 4.6% | pattern |
| 9960 | Seq Scan | 789.01 | 748.50 | 5.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 9960 (Seq Scan) - LEAF
...
### Step 2: Node 9957 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 9958, 9959
- **Input Features:**
