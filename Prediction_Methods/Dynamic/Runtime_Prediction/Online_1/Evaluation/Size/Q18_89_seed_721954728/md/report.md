        ...
        Node 31016 (Incremental Sort)
          Node 31017 (Nested Loop)
            Node 31018 (Merge Join)
              Node 31019 (Sort)
                Node 31020 (Hash Join)
                  Node 31021 (Seq Scan) - LEAF
                  Node 31022 (Hash)
...
| 31019 | Sort | 2873.60 | 1099.77 | 61.7% | operator |
| 31025 | Sort | 72.38 | 1074.66 | 1384.8% | operator |
| 31020 | Hash Join | 2873.59 | 686.33 | 76.1% | operator |
| 31026 | Seq Scan | 61.06 | 18.25 | 70.1% | operator |
| 31021 | Seq Scan | 190.98 | 170.37 | 10.8% | operator |
| 31022 | Hash | 2652.07 | 21.04 | 99.2% | operator |
...
### Step 3: Node 31021 (Seq Scan) - LEAF
...
### Step 6: Node 31026 (Seq Scan) - LEAF
...
### Step 9: Node 31018 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 31027 (Index Scan) - LEAF
...
### Step 11: Node 31017 (Nested Loop)
...
### Step 12: Node 31016 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 31015 (Gather Merge)
