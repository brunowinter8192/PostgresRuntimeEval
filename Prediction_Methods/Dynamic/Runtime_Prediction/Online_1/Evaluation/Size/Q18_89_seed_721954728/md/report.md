...
**Test Query:** Q18_89_seed_721954728
...
```
Node 31012 (Limit) - ROOT
  Node 31013 (Sort)
    Node 31014 (Aggregate)
      Node 31015 (Gather Merge)
        Node 31016 (Incremental Sort)
          Node 31017 (Nested Loop)
            Node 31018 (Merge Join)
              Node 31019 (Sort)
                Node 31020 (Hash Join) [PATTERN: 895c6e8c]
                  Node 31021 (Seq Scan) [consumed] - LEAF
                  Node 31022 (Hash) [consumed]
                    Node 31023 (Aggregate)
                      Node 31024 (Index Scan) - LEAF
              Node 31025 (Sort)
                Node 31026 (Seq Scan) - LEAF
            Node 31027 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 31020 | 31021, 31022 |
...
|------|------|--------|-----------|-----|--------|
| 31012 | Limit | 3084.83 | 1175.21 | 61.9% | operator |
| 31013 | Sort | 2965.10 | 1127.81 | 62.0% | operator |
| 31014 | Aggregate | 2965.05 | 1073.15 | 63.8% | operator |
| 31015 | Gather Merge | 2965.04 | 1073.95 | 63.8% | operator |
| 31016 | Incremental Sort | 2930.07 | 0.00 | 100.0% | operator |
| 31017 | Nested Loop | 2930.02 | 1111.34 | 62.1% | operator |
| 31018 | Merge Join | 2929.97 | 0.00 | 100.0% | operator |
| 31027 | Index Scan | 0.02 | 0.05 | 114.9% | operator |
| 31019 | Sort | 2873.60 | 1095.58 | 61.9% | operator |
| 31025 | Sort | 72.38 | 1074.66 | 1384.8% | operator |
| 31020 | Hash Join | 2873.59 | 471.07 | 83.6% | pattern |
| 31026 | Seq Scan | 61.06 | 18.25 | 70.1% | operator |
| 31023 | Aggregate | 2652.04 | 1073.15 | 59.5% | operator |
| 31024 | Index Scan | 2140.99 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31024 (Index Scan) - LEAF
...
### Step 3: Node 31020 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 31021, 31022
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 31026 (Seq Scan) - LEAF
...
### Step 7: Node 31018 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 31027 (Index Scan) - LEAF
...
### Step 10: Node 31016 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 31015 (Gather Merge)
