...
```
Node 24824 (Aggregate) - ROOT
  Node 24825 (Gather Merge)
    Node 24826 (Aggregate)
      Node 24827 (Sort)
        Node 24828 (Nested Loop)
          Node 24829 (Seq Scan) - LEAF
          Node 24830 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24824 | Aggregate | 1012.45 | 919.06 | 9.2% | operator |
| 24825 | Gather Merge | 1012.43 | 1111.84 | 9.8% | operator |
| 24826 | Aggregate | 992.25 | 895.31 | 9.8% | operator |
| 24827 | Sort | 991.60 | 1092.81 | 10.2% | operator |
| 24828 | Nested Loop | 990.60 | 1127.41 | 13.8% | operator |
| 24829 | Seq Scan | 854.35 | 745.19 | 12.8% | operator |
| 24830 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24829 (Seq Scan) - LEAF
...
### Step 2: Node 24830 (Index Scan) - LEAF
...
### Step 6: Node 24825 (Gather Merge)
...
### Step 7: Node 24824 (Aggregate) - ROOT
