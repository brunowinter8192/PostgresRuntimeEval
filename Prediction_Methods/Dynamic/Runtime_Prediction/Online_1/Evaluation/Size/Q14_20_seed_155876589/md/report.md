...
**Test Query:** Q14_20_seed_155876589
...
```
Node 26854 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26855 (Gather) [consumed]
    Node 26856 (Aggregate) [consumed]
      Node 26857 (Hash Join) [consumed]
        Node 26858 (Seq Scan) - LEAF
        Node 26859 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26854 | 26855, 26856, 26857 |
...
|------|------|--------|-----------|-----|--------|
| 26854 | Aggregate | 835.78 | 857.13 | 2.6% | pattern |
| 26858 | Seq Scan | 754.83 | 758.49 | 0.5% | operator |
| 26859 | Hash | 49.98 | 9.38 | 81.2% | operator |
| 26860 | Seq Scan | 43.09 | 12.70 | 70.5% | operator |
...
### Step 2: Node 26858 (Seq Scan) - LEAF
...
### Step 4: Node 26854 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26855, 26856, 26857
- **Input Features:**
