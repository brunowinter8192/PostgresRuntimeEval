...
```
Node 25167 (Aggregate) - ROOT
  Node 25168 (Gather Merge)
    Node 25169 (Aggregate)
      Node 25170 (Sort)
...
|------|------|--------|-----------|-----|--------|
| 25167 | Aggregate | 1003.00 | 919.05 | 8.4% | operator |
| 25168 | Gather Merge | 1002.97 | 1111.84 | 10.9% | operator |
| 25169 | Aggregate | 982.77 | 895.30 | 8.9% | operator |
| 25170 | Sort | 982.15 | 1092.82 | 11.3% | operator |
| 25171 | Nested Loop | 981.21 | 1127.41 | 14.9% | operator |
| 25172 | Seq Scan | 839.95 | 745.19 | 11.3% | operator |
| 25173 | Index Scan | 0.03 | 0.07 | 166.2% | operator |
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=147556.4200
  - total_cost=147672.4500
- **Output:** st=868.94, rt=895.30

### Step 6: Node 25168 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=868.9404
  - st2=0.0000
  - startup_cost=148556.4900
  - total_cost=148676.7400
- **Output:** st=1109.22, rt=1111.84

### Step 7: Node 25167 (Aggregate) - ROOT
