...
**Test Query:** Q6_149_seed_1214196588
...
```
Node 10113 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10114 (Gather) [consumed]
    Node 10115 (Aggregate) [consumed]
      Node 10116 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10113 | 10114, 10115 |
...
|------|------|--------|-----------|-----|--------|
| 10113 | Aggregate | 809.30 | 849.99 | 5.0% | pattern |
| 10116 | Seq Scan | 786.48 | 748.50 | 4.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10116 (Seq Scan) - LEAF
...
### Step 2: Node 10113 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10114, 10115
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=22735
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=32
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=139719.1400
  - Aggregate_Outer_total_cost=139719.1500
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=140719.6800
  - Aggregate_total_cost=140719.6900
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=140719.1400
  - Gather_Outer_total_cost=140719.6500
