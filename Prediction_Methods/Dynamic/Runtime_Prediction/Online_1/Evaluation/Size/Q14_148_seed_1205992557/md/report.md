...
```
Node 26784 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26785 (Gather) [consumed]
    Node 26786 (Aggregate) [consumed]
      Node 26787 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26784 | 26785, 26786, 26787 |
...
|------|------|--------|-----------|-----|--------|
| 26784 | Aggregate | 821.88 | 857.12 | 4.3% | pattern |
...
### Step 4: Node 26784 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26785, 26786, 26787
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=14870
  - HashJoin_Outer_nt1=14870
  ...
  - HashJoin_Outer_total_cost=136645.6700
