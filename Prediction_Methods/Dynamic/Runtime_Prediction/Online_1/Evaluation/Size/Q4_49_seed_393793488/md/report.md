...
**Test Query:** Q4_49_seed_393793488
...
```
Node 6502 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6503 (Gather Merge) [consumed]
    Node 6504 (Sort) [consumed]
      Node 6505 (Aggregate) [consumed]
        Node 6506 (Nested Loop)
          Node 6507 (Seq Scan) - LEAF
          Node 6508 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6502 | 6503, 6504, 6505 |
...
|------|------|--------|-----------|-----|--------|
| 6502 | Aggregate | 1051.04 | 952.19 | 9.4% | pattern |
| 6506 | Nested Loop | 1044.66 | 1255.45 | 20.2% | operator |
| 6507 | Seq Scan | 163.85 | 154.66 | 5.6% | operator |
| 6508 | Index Scan | 0.06 | 11.10 | 18103.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6507 (Seq Scan) - LEAF
...
### Step 2: Node 6508 (Index Scan) - LEAF
