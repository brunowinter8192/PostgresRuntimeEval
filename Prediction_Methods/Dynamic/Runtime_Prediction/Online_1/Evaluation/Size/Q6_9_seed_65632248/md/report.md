...
```
Node 10497 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10498 (Gather) [consumed]
    Node 10499 (Aggregate) [consumed]
      Node 10500 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10497 | 10498, 10499 |
...
|------|------|--------|-----------|-----|--------|
| 10497 | Aggregate | 762.74 | 849.99 | 11.4% | pattern |
| 10500 | Seq Scan | 742.73 | 748.50 | 0.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10500 (Seq Scan) - LEAF
...
### Step 2: Node 10497 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10498, 10499
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=22720
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=32
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=139719.0700
  - Aggregate_Outer_total_cost=139719.0800
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=140719.6100
  - Aggregate_total_cost=140719.6200
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=140719.0700
  - Gather_Outer_total_cost=140719.5800
