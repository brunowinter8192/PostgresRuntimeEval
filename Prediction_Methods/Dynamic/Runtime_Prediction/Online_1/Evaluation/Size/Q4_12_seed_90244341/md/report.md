...
**Test Query:** Q4_12_seed_90244341
...
```
Node 6075 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6076 (Gather Merge) [consumed]
    Node 6077 (Sort) [consumed]
      Node 6078 (Aggregate) [consumed]
        Node 6079 (Nested Loop)
          Node 6080 (Seq Scan) - LEAF
          Node 6081 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6075 | 6076, 6077, 6078 |
...
|------|------|--------|-----------|-----|--------|
| 6075 | Aggregate | 1068.84 | 952.19 | 10.9% | pattern |
| 6079 | Nested Loop | 1060.87 | 1255.45 | 18.3% | operator |
| 6080 | Seq Scan | 168.03 | 154.66 | 8.0% | operator |
| 6081 | Index Scan | 0.06 | 11.10 | 17810.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6080 (Seq Scan) - LEAF
...
### Step 2: Node 6081 (Index Scan) - LEAF
