    ...
    Node 5433 (Aggregate) [consumed]
      Node 5434 (Gather) [consumed]
        Node 5435 (Nested Loop)
          Node 5436 (Hash Join) [PATTERN: 895c6e8c]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5431 | 5432, 5433, 5434, 5436, 5437, 5438 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5436 | 5431, 5432, 5433, 5434, 5437, 5438 |
...
|------|------|--------|-----------|-----|--------|
| 5431 | Limit | 1243.86 | 1151.18 | 7.5% | pattern |
| 5435 | Nested Loop | 1203.92 | 1193.27 | 0.9% | operator |
| 5436 | Hash Join | 209.15 | 242.52 | 16.0% | pattern |
| 5440 | Index Scan | 0.03 | -0.52 | 2018.8% | operator |
| 5439 | Seq Scan | 27.79 | 38.57 | 38.8% | operator |
...
### Step 2: Node 5436 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5431, 5432, 5433, 5434, 5437, 5438
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47252
  - HashJoin_nt1=236664
...
### Step 3: Node 5440 (Index Scan) - LEAF
...
- **Output:** st=122.02, rt=1193.27

### Step 5: Node 5431 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5432, 5433, 5434, 5436, 5437, 5438
- **Input Features:**
