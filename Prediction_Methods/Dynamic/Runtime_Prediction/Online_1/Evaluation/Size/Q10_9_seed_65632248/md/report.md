...
**Test Query:** Q10_9_seed_65632248
...
```
Node 21307 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 21308 (Sort) [consumed]
    Node 21309 (Aggregate) [consumed]
      Node 21310 (Gather) [consumed]
        Node 21311 (Hash Join)
          Node 21312 (Hash Join) [PATTERN: 2e0f44ef]
            Node 21313 (Nested Loop) [consumed]
              Node 21314 (Seq Scan) - LEAF
              Node 21315 (Index Scan) - LEAF
            Node 21316 (Hash) [consumed]
              Node 21317 (Seq Scan) - LEAF
          Node 21318 (Hash)
            Node 21319 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 21307 | 21308, 21309, 21310, 21312, 21313, 21316 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 21312 | 21307, 21308, 21309, 21310, 21313, 21316 |
...
|------|------|--------|-----------|-----|--------|
| 21307 | Limit | 1127.03 | 1199.47 | 6.4% | pattern |
| 21311 | Hash Join | 1078.13 | 1095.44 | 1.6% | operator |
| 21312 | Hash Join | 1075.25 | 1120.19 | 4.2% | pattern |
| 21318 | Hash | 0.01 | 15.71 | 120752.1% | operator |
| 21319 | Seq Scan | 0.01 | 6.98 | 77441.2% | operator |
| 21314 | Seq Scan | 162.36 | 159.75 | 1.6% | operator |
| 21315 | Index Scan | 0.06 | -0.52 | 935.8% | operator |
| 21317 | Seq Scan | 24.61 | 26.64 | 8.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 21314 (Seq Scan) - LEAF
...
### Step 2: Node 21315 (Index Scan) - LEAF
...
### Step 3: Node 21317 (Seq Scan) - LEAF
...
### Step 4: Node 21319 (Seq Scan) - LEAF
...
### Step 5: Node 21312 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 21307, 21308, 21309, 21310, 21313, 21316
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=17761
  - HashJoin_nt1=17761
...
### Step 8: Node 21307 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 21308, 21309, 21310, 21312, 21313, 21316
- **Input Features:**
