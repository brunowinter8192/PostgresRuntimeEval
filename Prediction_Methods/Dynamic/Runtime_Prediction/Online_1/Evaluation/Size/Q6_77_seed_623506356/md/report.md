...
**Test Query:** Q6_77_seed_623506356
**Timestamp:** 2026-01-18 17:42:24
...
```
Node 10397 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10398 (Gather) [consumed]
    Node 10399 (Aggregate) [consumed]
      Node 10400 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10397 | 10398, 10399 |
...
|------|------|--------|-----------|-----|--------|
| 10397 | Aggregate | 798.69 | 850.07 | 6.4% | pattern |
| 10400 | Seq Scan | 774.91 | 748.54 | 3.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10400 (Seq Scan) - LEAF
...
### Step 2: Node 10397 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10398, 10399
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=23852
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=32
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=139724.7300
  - Aggregate_Outer_total_cost=139724.7400
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=140725.2700
  - Aggregate_total_cost=140725.2800
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=140724.7300
  - Gather_Outer_total_cost=140725.2400
