...
```
Node 32263 (Aggregate) [PATTERN: efde8b38] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 32263 | 32264, 32265, 32266 |
...
|------|------|--------|-----------|-----|--------|
| 32263 | Aggregate | 839.80 | 829.28 | 1.3% | pattern |
...
### Step 4: Node 32263 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 32264, 32265, 32266
- **Input Features:**
