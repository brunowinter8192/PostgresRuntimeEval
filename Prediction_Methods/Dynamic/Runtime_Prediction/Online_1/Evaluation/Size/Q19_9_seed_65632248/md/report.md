...
**Test Query:** Q19_9_seed_65632248
...
```
Node 32263 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 32264 (Gather) [consumed]
    Node 32265 (Aggregate) [consumed]
      Node 32266 (Hash Join)
        Node 32267 (Seq Scan) - LEAF
        Node 32268 (Hash)
          Node 32269 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 32263 | 32264, 32265 |
...
|------|------|--------|-----------|-----|--------|
| 32263 | Aggregate | 839.80 | 831.20 | 1.0% | pattern |
| 32266 | Hash Join | 819.68 | 766.05 | 6.5% | operator |
| 32267 | Seq Scan | 772.16 | 743.46 | 3.7% | operator |
| 32268 | Hash | 45.34 | 8.29 | 81.7% | operator |
| 32269 | Seq Scan | 45.19 | 23.76 | 47.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 32269 (Seq Scan) - LEAF
...
### Step 2: Node 32267 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=156338.5200
- **Output:** st=60.26, rt=766.05

### Step 5: Node 32263 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 32264, 32265
- **Input Features:**
