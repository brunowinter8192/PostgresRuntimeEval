...
**Test Query:** Q14_121_seed_984483720
...
```
Node 26581 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26582 (Gather) [consumed]
    Node 26583 (Aggregate) [consumed]
      Node 26584 (Hash Join)
        Node 26585 (Seq Scan) - LEAF
        Node 26586 (Hash)
          Node 26587 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26581 | 26582, 26583 |
...
|------|------|--------|-----------|-----|--------|
| 26581 | Aggregate | 798.68 | 848.35 | 6.2% | pattern |
| 26584 | Hash Join | 777.36 | 807.62 | 3.9% | operator |
| 26585 | Seq Scan | 725.60 | 758.47 | 4.5% | operator |
| 26586 | Hash | 43.56 | 9.38 | 78.5% | operator |
| 26587 | Seq Scan | 38.40 | 12.70 | 66.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26587 (Seq Scan) - LEAF
...
### Step 2: Node 26585 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=136645.2900
- **Output:** st=78.56, rt=807.62

### Step 5: Node 26581 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26582, 26583
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=14724
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=64
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0001
  - Aggregate_Outer_startup_cost=136902.9700
  - Aggregate_Outer_total_cost=136902.9800
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=137903.5300
  - Aggregate_total_cost=137903.5500
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=137902.9700
  - Gather_Outer_total_cost=137903.4800
