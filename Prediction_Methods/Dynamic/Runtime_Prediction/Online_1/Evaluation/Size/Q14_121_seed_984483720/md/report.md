...
```
Node 26581 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26582 (Gather) [consumed]
    Node 26583 (Aggregate) [consumed]
      Node 26584 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26581 | 26582, 26583, 26584 |
...
|------|------|--------|-----------|-----|--------|
| 26581 | Aggregate | 798.68 | 857.12 | 7.3% | pattern |
...
### Step 4: Node 26581 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26582, 26583, 26584
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=14724
  - HashJoin_Outer_nt1=14724
  ...
  - HashJoin_Outer_total_cost=136645.2900
