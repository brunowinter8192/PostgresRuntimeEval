...
**Test Query:** Q1_103_seed_836811162
...
```
Node 16 (Aggregate) - ROOT
  Node 17 (Gather Merge)
    Node 18 (Sort) [PATTERN: 1d35fb97]
      Node 19 (Aggregate) [consumed]
        Node 20 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 18 | 19 |
...
|------|------|--------|-----------|-----|--------|
| 16 | Aggregate | 998.24 | 1195.95 | 19.8% | operator |
| 17 | Gather Merge | 998.17 | 1165.92 | 16.8% | operator |
| 18 | Sort | 979.03 | 1200.75 | 22.6% | pattern |
| 20 | Seq Scan | 573.00 | 679.32 | 18.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 20 (Seq Scan) - LEAF
...
### Step 2: Node 18 (Sort) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=169130.6100
  - Sort_total_cost=169130.6300
- **Output:** st=1196.66, rt=1200.75

### Step 3: Node 17 (Gather Merge)
