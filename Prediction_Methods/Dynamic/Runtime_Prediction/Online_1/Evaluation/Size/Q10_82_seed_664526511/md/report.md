...
**Test Query:** Q10_82_seed_664526511
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 21060 | 21061, 21062, 21063, 21065, 21066, 21069 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 21065 | 21060, 21061, 21062, 21063, 21066, 21069 |
...
|------|------|--------|-----------|-----|--------|
| 21060 | Limit | 1157.61 | 1199.47 | 3.6% | pattern |
| 21064 | Hash Join | 1110.45 | 1095.47 | 1.3% | operator |
| 21065 | Hash Join | 1107.60 | 1120.19 | 1.1% | pattern |
| 21071 | Hash | 0.02 | 15.71 | 92316.3% | operator |
| 21072 | Seq Scan | 0.01 | 6.98 | 58055.9% | operator |
| 21067 | Seq Scan | 166.89 | 159.74 | 4.3% | operator |
| 21068 | Index Scan | 0.06 | -0.52 | 909.7% | operator |
| 21070 | Seq Scan | 25.23 | 26.64 | 5.6% | operator |
...
### Step 4: Node 21072 (Seq Scan) - LEAF
...
- **Consumes:** Nodes 21060, 21061, 21062, 21063, 21066, 21069
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=17881
  - HashJoin_nt1=17881
...
### Step 8: Node 21060 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 21061, 21062, 21063, 21065, 21066, 21069
- **Input Features:**
