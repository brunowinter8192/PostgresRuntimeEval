...
```
Node 7141 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 7142 (Aggregate) [consumed]
    Node 7143 (Gather Merge) [consumed]
      Node 7144 (Aggregate)
        Node 7145 (Sort) [PATTERN: 3e2d5a00]
          Node 7146 (Hash Join) [consumed]
            Node 7147 (Nested Loop)
              Node 7148 (Hash Join)
                Node 7149 (Seq Scan) - LEAF
                Node 7150 (Hash) [PATTERN: 444761fb]
                  Node 7151 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 7150 | 7141, 7142, 7143, 7145, 7146, 7151, 7152, 7153, 7154 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 7141 | 7142, 7143, 7145, 7146, 7150, 7151, 7152, 7153, 7154 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 7145 | 7141, 7142, 7143, 7146, 7150, 7151, 7152, 7153, 7154 |
...
|------|------|--------|-----------|-----|--------|
| 7141 | Sort | 1114.51 | 2934.42 | 163.3% | pattern |
| 7144 | Aggregate | 1109.87 | 1128.76 | 1.7% | operator |
| 7145 | Sort | 1109.62 | 1835.93 | 65.5% | pattern |
| 7147 | Nested Loop | 1097.79 | 1188.47 | 8.3% | operator |
| 7159 | Hash | 3.26 | 18.67 | 473.4% | operator |
| 7148 | Hash Join | 219.83 | 253.07 | 15.1% | operator |
| 7158 | Index Scan | 0.08 | -0.22 | 385.7% | operator |
| 7160 | Seq Scan | 2.45 | 12.36 | 403.9% | operator |
| 7149 | Seq Scan | 175.18 | 159.81 | 8.8% | operator |
| 7150 | Hash | 31.59 | 46.85 | 48.3% | pattern |
| 7155 | Seq Scan | 0.01 | 11.81 | 90732.9% | operator |
| 7156 | Hash | 0.24 | 21.05 | 8528.4% | operator |
| 7157 | Seq Scan | 0.24 | 22.93 | 9455.6% | operator |
...
### Step 4: Node 7149 (Seq Scan) - LEAF
...
### Step 5: Node 7150 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 7141, 7142, 7143, 7145, 7146, 7151, 7152, 7153, 7154
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 7158 (Index Scan) - LEAF
...
### Step 8: Node 7160 (Seq Scan) - LEAF
...
### Step 11: Node 7145 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 7141, 7142, 7143, 7146, 7150, 7151, 7152, 7153, 7154
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 7141 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 7142, 7143, 7145, 7146, 7150, 7151, 7152, 7153, 7154
- **Input Features:**
