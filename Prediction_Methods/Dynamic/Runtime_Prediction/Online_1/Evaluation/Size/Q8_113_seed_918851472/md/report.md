...
```
Node 13523 (Aggregate) - ROOT
  Node 13524 (Gather Merge)
    Node 13525 (Sort)
          ...
          Node 13528 (Hash Join)
            Node 13529 (Nested Loop)
              Node 13530 (Hash Join)
                ...
                Node 13532 (Hash)
                  Node 13533 (Hash Join)
                    Node 13534 (Seq Scan) - LEAF
                    Node 13535 (Hash)
                      Node 13536 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 13523 | Aggregate | 1209.04 | 1179.36 | 2.5% | operator |
| 13524 | Gather Merge | 1208.60 | 1097.17 | 9.2% | operator |
...
| 13530 | Hash Join | 210.06 | 251.17 | 19.6% | operator |
...
| 13532 | Hash | 34.44 | 20.62 | 40.1% | operator |
| 13533 | Hash Join | 33.82 | 132.26 | 291.0% | operator |
| 13534 | Seq Scan | 32.39 | 23.03 | 28.9% | operator |
| 13535 | Hash | 0.09 | 23.66 | 25895.7% | operator |
| 13536 | Hash Join | 0.09 | 306.84 | 352585.0% | operator |
...
### Step 5: Node 13534 (Seq Scan) - LEAF
...
### Step 8: Node 13531 (Seq Scan) - LEAF
...
### Step 11: Node 13540 (Index Scan) - LEAF
...
### Step 12: Node 13542 (Seq Scan) - LEAF
...
### Step 13: Node 13529 (Nested Loop)
...
### Step 16: Node 13543 (Index Scan) - LEAF
...
### Step 17: Node 13545 (Seq Scan) - LEAF
...
### Step 18: Node 13527 (Nested Loop)
...
### Step 22: Node 13524 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1044.9468
  - st2=0.0000
  - startup_cost=71571.0600
  - total_cost=71876.8800
- **Output:** st=1093.46, rt=1097.17

### Step 23: Node 13523 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=71571.0600
  - total_cost=71976.7000
- **Output:** st=1155.99, rt=1179.36
