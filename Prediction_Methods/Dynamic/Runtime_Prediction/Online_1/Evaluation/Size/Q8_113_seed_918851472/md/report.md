...
**Test Query:** Q8_113_seed_918851472
...
Node 13523 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 13524 (Gather Merge) [consumed]
    Node 13525 (Sort)
      Node 13526 (Hash Join)
        Node 13527 (Nested Loop)
          Node 13528 (Hash Join)
            Node 13529 (Nested Loop)
              Node 13530 (Hash Join)
                Node 13531 (Seq Scan) - LEAF
                Node 13532 (Hash) [PATTERN: 444761fb]
                  Node 13533 (Hash Join) [consumed]
                    Node 13534 (Seq Scan) [consumed] - LEAF
                    Node 13535 (Hash) [consumed]
                      Node 13536 (Hash Join) [consumed]
                        Node 13537 (Seq Scan) - LEAF
                        Node 13538 (Hash)
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 13532 | 13523, 13524, 13533, 13534, 13535, 13536 |
| Aggregate -> Gather Merge (Out | 2724c080 | 13523 | 13524, 13532, 13533, 13534, 13535, 13536 |
...
|------|------|--------|-----------|-----|--------|
| 13523 | Aggregate | 1209.04 | 1125.05 | 6.9% | pattern |
| 13525 | Sort | 1203.66 | 1046.22 | 13.1% | operator |
| 13526 | Hash Join | 1203.41 | 785.61 | 34.7% | operator |
| 13527 | Nested Loop | 1203.06 | 1198.29 | 0.4% | operator |
| 13544 | Hash | 0.03 | 13.72 | 40265.0% | operator |
| 13528 | Hash Join | 1199.34 | 785.60 | 34.5% | operator |
| 13543 | Index Scan | 0.01 | 12.42 | 206958.1% | operator |
| 13545 | Seq Scan | 0.01 | 6.51 | 49992.0% | operator |
| 13529 | Nested Loop | 1152.45 | 1198.29 | 4.0% | operator |
| 13541 | Hash | 41.78 | 19.97 | 52.2% | operator |
| 13530 | Hash Join | 210.06 | 251.67 | 19.8% | operator |
| 13540 | Index Scan | 0.04 | 2.88 | 6926.5% | operator |
| 13542 | Seq Scan | 41.67 | 48.86 | 17.2% | operator |
| 13531 | Seq Scan | 157.53 | 159.67 | 1.4% | operator |
| 13532 | Hash | 34.44 | 43.51 | 26.4% | pattern |
| 13537 | Seq Scan | 0.01 | 12.22 | 93938.0% | operator |
| 13538 | Hash | 0.07 | 18.14 | 27814.1% | operator |
| 13539 | Seq Scan | 0.06 | 23.36 | 38198.7% | operator |
...
### Step 2: Node 13537 (Seq Scan) - LEAF
...
### Step 4: Node 13531 (Seq Scan) - LEAF
...
### Step 5: Node 13532 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 13523, 13524, 13533, 13534, 13535, 13536
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 13540 (Index Scan) - LEAF
...
### Step 8: Node 13542 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - st1=186.0414
  - st2=19.9671
  - startup_cost=9920.5500
  - total_cost=70272.0300
- **Output:** st=113.62, rt=785.60

### Step 12: Node 13543 (Index Scan) - LEAF
...
### Step 13: Node 13545 (Seq Scan) - LEAF
...
### Step 14: Node 13527 (Nested Loop)
...
- **Input Features:**
  ...
  - st1=113.6216
  - st2=0.1628
  - startup_cost=9920.8400
  - total_cost=70524.3500
- **Output:** st=186.04, rt=1198.29

### Step 15: Node 13544 (Hash)
...
- **Input Features:**
  ...
  - st1=186.0414
  - st2=13.7224
  - startup_cost=9922.4000
  - total_cost=70530.5600
- **Output:** st=113.62, rt=785.61

### Step 17: Node 13525 (Sort)
...
- **Input Features:**
  ...
  - st1=113.6207
  - st2=0.0000
  - startup_cost=70571.0200
  - total_cost=70573.1100
- **Output:** st=1044.95, rt=1046.22

### Step 18: Node 13523 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 13524, 13532, 13533, 13534, 13535, 13536
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2585
  ...
  - Aggregate_total_cost=71976.7000
  - GatherMerge_Outer_np=0
  - GatherMerge_Outer_nt=2585
  - GatherMerge_Outer_nt1=834
  ...
  - GatherMerge_Outer_total_cost=71876.8800
- **Output:** st=1122.12, rt=1125.05
