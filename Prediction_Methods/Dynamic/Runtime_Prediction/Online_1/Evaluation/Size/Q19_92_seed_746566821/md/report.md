...
```
Node 32207 (Aggregate) [PATTERN: efde8b38] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 32207 | 32208, 32209, 32210 |
...
|------|------|--------|-----------|-----|--------|
| 32207 | Aggregate | 851.56 | 829.30 | 2.6% | pattern |
...
### Step 4: Node 32207 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 32208, 32209, 32210
- **Input Features:**
