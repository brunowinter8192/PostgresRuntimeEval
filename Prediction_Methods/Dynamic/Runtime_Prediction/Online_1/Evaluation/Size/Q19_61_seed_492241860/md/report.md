...
**Test Query:** Q19_61_seed_492241860
...
```
Node 31969 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31970 (Gather) [consumed]
    Node 31971 (Aggregate) [consumed]
      Node 31972 (Hash Join) [consumed]
        Node 31973 (Seq Scan) - LEAF
        Node 31974 (Hash)
          Node 31975 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31969 | 31970, 31971, 31972 |
...
|------|------|--------|-----------|-----|--------|
| 31969 | Aggregate | 838.84 | 829.29 | 1.1% | pattern |
| 31973 | Seq Scan | 767.83 | 743.46 | 3.2% | operator |
| 31974 | Hash | 48.68 | 8.29 | 83.0% | operator |
| 31975 | Seq Scan | 48.52 | 23.76 | 51.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31975 (Seq Scan) - LEAF
...
### Step 2: Node 31973 (Seq Scan) - LEAF
...
### Step 4: Node 31969 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31970, 31971, 31972
- **Input Features:**
