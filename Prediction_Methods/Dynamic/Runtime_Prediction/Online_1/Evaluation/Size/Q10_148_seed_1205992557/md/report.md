    ...
    Node 20048 (Aggregate) [consumed]
      Node 20049 (Gather) [consumed]
        Node 20050 (Hash Join)
          Node 20051 (Hash Join)
            Node 20052 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20046 | 20047, 20048, 20049 |
...
| 20050 | Hash Join | 1092.33 | 1007.16 | 7.8% | operator |
| 20051 | Hash Join | 1089.43 | 1004.03 | 7.8% | operator |
| 20057 | Hash | 0.02 | 15.71 | 98092.3% | operator |
| 20052 | Nested Loop | 1044.90 | 1204.85 | 15.3% | operator |
| 20055 | Hash | 34.10 | 55.57 | 62.9% | operator |
...
### Step 6: Node 20058 (Seq Scan) - LEAF
...
### Step 10: Node 20046 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20047, 20048, 20049
- **Input Features:**
