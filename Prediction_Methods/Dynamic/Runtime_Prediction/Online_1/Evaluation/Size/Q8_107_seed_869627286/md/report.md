...
```
Node 13362 (Aggregate) - ROOT
  Node 13363 (Gather Merge)
    Node 13364 (Sort)
          ...
          Node 13367 (Hash Join)
            Node 13368 (Nested Loop)
              Node 13369 (Hash Join)
                ...
                Node 13371 (Hash)
                  Node 13372 (Hash Join)
                    Node 13373 (Seq Scan) - LEAF
                    Node 13374 (Hash)
                      Node 13375 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 13362 | Aggregate | 1237.39 | 1190.79 | 3.8% | operator |
| 13363 | Gather Merge | 1236.97 | 1097.19 | 11.3% | operator |
...
| 13369 | Hash Join | 220.33 | 251.17 | 14.0% | operator |
...
| 13371 | Hash | 39.28 | 20.62 | 47.5% | operator |
| 13372 | Hash Join | 38.68 | 132.26 | 241.9% | operator |
| 13373 | Seq Scan | 37.13 | 23.03 | 38.0% | operator |
| 13374 | Hash | 0.20 | 23.66 | 11669.2% | operator |
| 13375 | Hash Join | 0.20 | 306.84 | 154867.7% | operator |
...
### Step 5: Node 13373 (Seq Scan) - LEAF
...
### Step 8: Node 13370 (Seq Scan) - LEAF
...
### Step 11: Node 13379 (Index Scan) - LEAF
...
### Step 12: Node 13381 (Seq Scan) - LEAF
...
### Step 13: Node 13368 (Nested Loop)
...
### Step 16: Node 13382 (Index Scan) - LEAF
...
### Step 17: Node 13384 (Seq Scan) - LEAF
...
### Step 18: Node 13366 (Nested Loop)
...
### Step 22: Node 13363 (Gather Merge)
...
### Step 23: Node 13362 (Aggregate) - ROOT
