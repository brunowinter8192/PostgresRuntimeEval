...
**Test Query:** Q1_43_seed_344569302
...
```
Node 436 (Aggregate) - ROOT
  Node 437 (Gather Merge)
    Node 438 (Sort) [PATTERN: 1d35fb97]
      Node 439 (Aggregate) [consumed]
        Node 440 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 438 | 439 |
...
|------|------|--------|-----------|-----|--------|
| 436 | Aggregate | 1001.95 | 1195.78 | 19.3% | operator |
| 437 | Gather Merge | 1001.89 | 1165.87 | 16.4% | operator |
| 438 | Sort | 981.85 | 1200.09 | 22.2% | pattern |
| 440 | Seq Scan | 575.91 | 681.84 | 18.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 440 (Seq Scan) - LEAF
...
### Step 2: Node 438 (Sort) - PATTERN ROOT
...
### Step 4: Node 436 (Aggregate) - ROOT
