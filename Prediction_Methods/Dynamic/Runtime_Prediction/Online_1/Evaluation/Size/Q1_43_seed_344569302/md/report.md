...
|------|------|--------|-----------|-----|--------|
| 436 | Aggregate | 1001.95 | 1195.73 | 19.3% | operator |
| 437 | Gather Merge | 1001.89 | 1165.56 | 16.3% | operator |
| 438 | Sort | 981.85 | 1181.95 | 20.4% | operator |
| 439 | Aggregate | 981.81 | 1112.59 | 13.3% | operator |
...
- **Input Features:**
  ...
  - st1=0.8474
  - st2=0.0000
  - startup_cost=168681.3100
  - total_cost=168681.4500
- **Output:** st=1037.36, rt=1112.59

### Step 3: Node 438 (Sort)
...
- **Input Features:**
  ...
  - st1=1037.3611
  - st2=0.0000
  - startup_cost=168681.5300
  - total_cost=168681.5400
- **Output:** st=1180.88, rt=1181.95

### Step 4: Node 437 (Gather Merge)
...
### Step 5: Node 436 (Aggregate) - ROOT
