...
**Test Query:** Q6_112_seed_910647441
...
```
Node 9953 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 9954 (Gather) [consumed]
    Node 9955 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 9953 | 9954, 9955 |
...
|------|------|--------|-----------|-----|--------|
| 9953 | Aggregate | 801.20 | 850.06 | 6.1% | pattern |
| 9956 | Seq Scan | 776.24 | 748.54 | 3.6% | operator |
...
### Step 2: Node 9953 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 9954, 9955
- **Input Features:**
