    ...
    Node 21296 (Aggregate) [consumed]
      Node 21297 (Gather) [consumed]
        Node 21298 (Hash Join)
          Node 21299 (Hash Join)
            Node 21300 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 21294 | 21295, 21296, 21297 |
...
| 21298 | Hash Join | 1114.00 | 1007.10 | 9.6% | operator |
| 21299 | Hash Join | 1111.09 | 1003.93 | 9.6% | operator |
| 21305 | Hash | 0.01 | 15.71 | 104638.5% | operator |
| 21300 | Nested Loop | 1064.73 | 1204.88 | 13.2% | operator |
| 21303 | Hash | 35.94 | 55.57 | 54.6% | operator |
...
### Step 6: Node 21306 (Seq Scan) - LEAF
...
### Step 10: Node 21294 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 21295, 21296, 21297
- **Input Features:**
