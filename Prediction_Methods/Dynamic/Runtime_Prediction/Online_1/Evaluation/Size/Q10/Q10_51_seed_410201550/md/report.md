    ...
    Node 20620 (Aggregate) [consumed]
      Node 20621 (Gather) [consumed]
        Node 20622 (Hash Join)
          Node 20623 (Hash Join)
            Node 20624 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20618 | 20619, 20620, 20621 |
...
| 20622 | Hash Join | 1105.32 | 1007.14 | 8.9% | operator |
| 20623 | Hash Join | 1102.47 | 1003.99 | 8.9% | operator |
| 20629 | Hash | 0.01 | 15.71 | 104638.5% | operator |
| 20624 | Nested Loop | 1054.18 | 1204.86 | 14.3% | operator |
| 20627 | Hash | 37.35 | 55.57 | 48.8% | operator |
...
### Step 6: Node 20630 (Seq Scan) - LEAF
...
### Step 10: Node 20618 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20619, 20620, 20621
- **Input Features:**
