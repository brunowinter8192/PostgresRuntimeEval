    ...
    Node 20256 (Aggregate) [consumed]
      Node 20257 (Gather) [consumed]
        Node 20258 (Hash Join)
          Node 20259 (Hash Join)
            Node 20260 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20254 | 20255, 20256, 20257 |
...
| 20258 | Hash Join | 1097.77 | 1007.14 | 8.3% | operator |
| 20259 | Hash Join | 1094.87 | 1004.00 | 8.3% | operator |
| 20265 | Hash | 0.01 | 15.71 | 104638.5% | operator |
| 20260 | Nested Loop | 1050.31 | 1204.86 | 14.7% | operator |
| 20263 | Hash | 34.17 | 55.57 | 62.6% | operator |
...
### Step 6: Node 20266 (Seq Scan) - LEAF
...
### Step 10: Node 20254 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20255, 20256, 20257
- **Input Features:**
