    ...
    Node 20698 (Aggregate) [consumed]
      Node 20699 (Gather) [consumed]
        Node 20700 (Hash Join)
          Node 20701 (Hash Join)
            Node 20702 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20696 | 20697, 20698, 20699 |
...
| 20700 | Hash Join | 1080.65 | 1007.19 | 6.8% | operator |
| 20701 | Hash Join | 1077.67 | 1004.09 | 6.8% | operator |
| 20707 | Hash | 0.02 | 15.71 | 92316.3% | operator |
| 20702 | Nested Loop | 1031.89 | 1204.83 | 16.8% | operator |
| 20705 | Hash | 35.35 | 55.57 | 57.2% | operator |
...
### Step 6: Node 20708 (Seq Scan) - LEAF
...
### Step 10: Node 20696 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20697, 20698, 20699
- **Input Features:**
