    ...
    Node 19931 (Aggregate) [consumed]
      Node 19932 (Gather) [consumed]
        Node 19933 (Hash Join)
          Node 19934 (Hash Join)
            Node 19935 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19929 | 19930, 19931, 19932 |
...
| 19933 | Hash Join | 1109.10 | 1007.19 | 9.2% | operator |
| 19934 | Hash Join | 1106.18 | 1004.09 | 9.2% | operator |
| 19940 | Hash | 0.01 | 15.71 | 104638.5% | operator |
| 19935 | Nested Loop | 1055.70 | 1204.83 | 14.1% | operator |
| 19938 | Hash | 38.44 | 55.57 | 44.6% | operator |
...
### Step 6: Node 19941 (Seq Scan) - LEAF
...
### Step 10: Node 19929 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19930, 19931, 19932
- **Input Features:**
