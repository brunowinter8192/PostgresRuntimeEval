    ...
    Node 20282 (Aggregate) [consumed]
      Node 20283 (Gather) [consumed]
        Node 20284 (Hash Join)
          Node 20285 (Hash Join)
            Node 20286 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20280 | 20281, 20282, 20283 |
...
| 20284 | Hash Join | 1120.19 | 1007.19 | 10.1% | operator |
| 20285 | Hash Join | 1117.28 | 1004.09 | 10.1% | operator |
| 20291 | Hash | 0.01 | 15.71 | 112119.8% | operator |
| 20286 | Nested Loop | 1069.94 | 1204.83 | 12.6% | operator |
| 20289 | Hash | 35.52 | 55.57 | 56.5% | operator |
...
- **Input Features:**
  ...
  - st2=0.0265
  - startup_cost=0.4300
  - total_cost=75663.7400
- **Output:** st=124.85, rt=1204.83

### Step 5: Node 20289 (Hash)
...
### Step 6: Node 20292 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=80717.4700
- **Output:** st=109.71, rt=1004.09

### Step 8: Node 20291 (Hash)
...
- **Output:** st=98.91, rt=1007.19

### Step 10: Node 20280 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20281, 20282, 20283
- **Input Features:**
