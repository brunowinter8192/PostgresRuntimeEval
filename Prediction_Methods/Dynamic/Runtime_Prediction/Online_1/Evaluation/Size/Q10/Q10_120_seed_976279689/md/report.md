    ...
    Node 19658 (Aggregate) [consumed]
      Node 19659 (Gather) [consumed]
        Node 19660 (Hash Join)
          Node 19661 (Hash Join)
            Node 19662 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19656 | 19657, 19658, 19659 |
...
| 19660 | Hash Join | 1098.02 | 1007.36 | 8.3% | operator |
| 19661 | Hash Join | 1095.19 | 1004.36 | 8.3% | operator |
| 19667 | Hash | 0.02 | 15.71 | 68207.7% | operator |
| 19662 | Nested Loop | 1046.28 | 1204.72 | 15.1% | operator |
| 19665 | Hash | 38.23 | 55.57 | 45.4% | operator |
...
### Step 6: Node 19668 (Seq Scan) - LEAF
...
### Step 10: Node 19656 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19657, 19658, 19659
- **Input Features:**
