    ...
    Node 21010 (Aggregate) [consumed]
      Node 21011 (Gather) [consumed]
        Node 21012 (Hash Join)
          Node 21013 (Hash Join)
            Node 21014 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 21008 | 21009, 21010, 21011 |
...
| 21012 | Hash Join | 1087.58 | 1007.22 | 7.4% | operator |
| 21013 | Hash Join | 1084.67 | 1004.13 | 7.4% | operator |
| 21019 | Hash | 0.02 | 15.71 | 68207.7% | operator |
| 21014 | Nested Loop | 1038.79 | 1204.81 | 16.0% | operator |
| 21017 | Hash | 35.36 | 55.57 | 57.1% | operator |
...
### Step 6: Node 21020 (Seq Scan) - LEAF
...
### Step 10: Node 21008 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 21009, 21010, 21011
- **Input Features:**
