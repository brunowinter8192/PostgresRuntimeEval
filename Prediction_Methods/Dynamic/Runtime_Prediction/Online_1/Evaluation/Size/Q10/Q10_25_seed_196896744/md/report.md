    ...
    Node 20243 (Aggregate) [consumed]
      Node 20244 (Gather) [consumed]
        Node 20245 (Hash Join)
          Node 20246 (Hash Join)
            Node 20247 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20241 | 20242, 20243, 20244 |
...
| 20245 | Hash Join | 1108.63 | 1007.10 | 9.2% | operator |
| 20246 | Hash Join | 1105.72 | 1003.93 | 9.2% | operator |
| 20252 | Hash | 0.02 | 15.71 | 78453.9% | operator |
| 20247 | Nested Loop | 1062.62 | 1204.88 | 13.4% | operator |
| 20250 | Hash | 30.80 | 55.57 | 80.4% | operator |
...
### Step 6: Node 20253 (Seq Scan) - LEAF
...
### Step 10: Node 20241 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20242, 20243, 20244
- **Input Features:**
