    ...
    Node 19866 (Aggregate) [consumed]
      Node 19867 (Gather) [consumed]
        Node 19868 (Hash Join)
          Node 19869 (Hash Join)
            Node 19870 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19864 | 19865, 19866, 19867 |
...
| 19868 | Hash Join | 1091.90 | 1007.36 | 7.7% | operator |
| 19869 | Hash Join | 1089.11 | 1004.36 | 7.8% | operator |
| 19875 | Hash | 0.01 | 15.71 | 112119.8% | operator |
| 19870 | Nested Loop | 1040.92 | 1204.72 | 15.7% | operator |
| 19873 | Hash | 37.00 | 55.57 | 50.2% | operator |
...
### Step 6: Node 19876 (Seq Scan) - LEAF
...
### Step 10: Node 19864 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19865, 19866, 19867
- **Input Features:**
