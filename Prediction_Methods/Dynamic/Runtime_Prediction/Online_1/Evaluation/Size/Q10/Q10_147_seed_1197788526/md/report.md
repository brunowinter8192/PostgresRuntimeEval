    ...
    Node 20035 (Aggregate) [consumed]
      Node 20036 (Gather) [consumed]
        Node 20037 (Hash Join)
          Node 20038 (Hash Join)
            Node 20039 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20033 | 20034, 20035, 20036 |
...
| 20037 | Hash Join | 1063.37 | 1007.24 | 5.3% | operator |
| 20038 | Hash Join | 1060.50 | 1004.16 | 5.3% | operator |
| 20044 | Hash | 0.01 | 15.71 | 112119.8% | operator |
| 20039 | Nested Loop | 1019.04 | 1204.80 | 18.2% | operator |
| 20042 | Hash | 31.53 | 55.57 | 76.2% | operator |
...
- **Input Features:**
  ...
  - st2=0.0265
  - startup_cost=0.4300
  - total_cost=75560.5000
- **Output:** st=124.83, rt=1204.80

### Step 5: Node 20042 (Hash)
...
### Step 6: Node 20045 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=80613.9400
- **Output:** st=109.70, rt=1004.16

### Step 8: Node 20044 (Hash)
...
- **Output:** st=98.90, rt=1007.24

### Step 10: Node 20033 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20034, 20035, 20036
- **Input Features:**
