    ...
    Node 19476 (Aggregate) [consumed]
      Node 19477 (Gather) [consumed]
        Node 19478 (Hash Join)
          Node 19479 (Hash Join)
            Node 19480 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19474 | 19475, 19476, 19477 |
...
| 19478 | Hash Join | 1095.16 | 1007.29 | 8.0% | operator |
| 19479 | Hash Join | 1092.30 | 1004.25 | 8.1% | operator |
| 19485 | Hash | 0.01 | 15.71 | 120752.1% | operator |
| 19480 | Nested Loop | 1045.95 | 1204.76 | 15.2% | operator |
| 19483 | Hash | 35.98 | 55.57 | 54.4% | operator |
...
### Step 6: Node 19486 (Seq Scan) - LEAF
...
### Step 10: Node 19474 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19475, 19476, 19477
- **Input Features:**
