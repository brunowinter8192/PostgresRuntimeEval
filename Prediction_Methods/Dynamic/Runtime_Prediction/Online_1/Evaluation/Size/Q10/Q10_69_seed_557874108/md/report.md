    ...
    Node 20867 (Aggregate) [consumed]
      Node 20868 (Gather) [consumed]
        Node 20869 (Hash Join)
          Node 20870 (Hash Join)
            Node 20871 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20865 | 20866, 20867, 20868 |
...
| 20869 | Hash Join | 1110.48 | 1007.08 | 9.3% | operator |
| 20870 | Hash Join | 1107.53 | 1003.90 | 9.4% | operator |
| 20876 | Hash | 0.01 | 15.71 | 104638.5% | operator |
| 20871 | Nested Loop | 1057.45 | 1204.89 | 13.9% | operator |
| 20874 | Hash | 38.19 | 55.57 | 45.5% | operator |
...
### Step 6: Node 20877 (Seq Scan) - LEAF
...
### Step 10: Node 20865 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20866, 20867, 20868
- **Input Features:**
