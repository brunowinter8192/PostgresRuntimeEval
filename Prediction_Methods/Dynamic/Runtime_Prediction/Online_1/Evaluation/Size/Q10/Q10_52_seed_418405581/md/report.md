    ...
    Node 20633 (Aggregate) [consumed]
      Node 20634 (Gather) [consumed]
        Node 20635 (Hash Join)
          Node 20636 (Hash Join)
            Node 20637 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20631 | 20632, 20633, 20634 |
...
| 20635 | Hash Join | 1116.65 | 1006.93 | 9.8% | operator |
| 20636 | Hash Join | 1113.76 | 1003.66 | 9.9% | operator |
| 20642 | Hash | 0.01 | 15.71 | 104638.5% | operator |
| 20637 | Nested Loop | 1057.96 | 1204.98 | 13.9% | operator |
| 20640 | Hash | 42.23 | 55.57 | 31.6% | operator |
...
### Step 6: Node 20643 (Seq Scan) - LEAF
...
### Step 10: Node 20631 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20632, 20633, 20634
- **Input Features:**
