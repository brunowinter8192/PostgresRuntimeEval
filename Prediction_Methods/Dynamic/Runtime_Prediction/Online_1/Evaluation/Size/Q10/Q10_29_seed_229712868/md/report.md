    ...
    Node 20295 (Aggregate) [consumed]
      Node 20296 (Gather) [consumed]
        Node 20297 (Hash Join)
          Node 20298 (Hash Join)
            Node 20299 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20293 | 20294, 20295, 20296 |
...
| 20297 | Hash Join | 1104.47 | 1007.24 | 8.8% | operator |
| 20298 | Hash Join | 1101.58 | 1004.16 | 8.8% | operator |
| 20304 | Hash | 0.01 | 15.71 | 104638.5% | operator |
| 20299 | Nested Loop | 1055.30 | 1204.80 | 14.2% | operator |
| 20302 | Hash | 35.89 | 55.57 | 54.8% | operator |
...
### Step 6: Node 20305 (Seq Scan) - LEAF
...
### Step 10: Node 20293 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20294, 20295, 20296
- **Input Features:**
