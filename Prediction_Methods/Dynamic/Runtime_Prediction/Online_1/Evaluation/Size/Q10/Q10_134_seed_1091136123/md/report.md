    ...
    Node 19853 (Aggregate) [consumed]
      Node 19854 (Gather) [consumed]
        Node 19855 (Hash Join)
          Node 19856 (Hash Join)
            Node 19857 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19851 | 19852, 19853, 19854 |
...
| 19855 | Hash Join | 1104.45 | 1007.38 | 8.8% | operator |
| 19856 | Hash Join | 1101.27 | 1004.38 | 8.8% | operator |
| 19862 | Hash | 0.02 | 15.71 | 98092.3% | operator |
| 19857 | Nested Loop | 1054.37 | 1204.71 | 14.3% | operator |
| 19860 | Hash | 36.94 | 55.57 | 50.5% | operator |
...
### Step 6: Node 19863 (Seq Scan) - LEAF
...
### Step 10: Node 19851 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19852, 19853, 19854
- **Input Features:**
