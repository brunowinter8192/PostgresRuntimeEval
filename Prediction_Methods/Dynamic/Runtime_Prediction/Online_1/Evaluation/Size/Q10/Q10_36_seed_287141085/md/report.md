...
**Test Query:** Q10_36_seed_287141085
...
```
Node 20397 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 20398 (Sort) [consumed]
    Node 20399 (Aggregate) [consumed]
      Node 20400 (Gather) [consumed]
        Node 20401 (Hash Join)
          Node 20402 (Hash Join)
            Node 20403 (Nested Loop)
              Node 20404 (Seq Scan) - LEAF
              Node 20405 (Index Scan) - LEAF
            Node 20406 (Hash)
              Node 20407 (Seq Scan) - LEAF
          Node 20408 (Hash)
            Node 20409 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20397 | 20398, 20399, 20400 |
...
|------|------|--------|-----------|-----|--------|
| 20397 | Limit | 1244.67 | 1199.47 | 3.6% | pattern |
| 20401 | Hash Join | 1196.74 | 1007.14 | 15.8% | operator |
| 20402 | Hash Join | 1193.89 | 1003.99 | 15.9% | operator |
| 20408 | Hash | 0.01 | 15.71 | 120752.1% | operator |
| 20403 | Nested Loop | 1143.64 | 1204.86 | 5.4% | operator |
| 20406 | Hash | 37.46 | 55.57 | 48.3% | operator |
| 20409 | Seq Scan | 0.01 | 6.98 | 77441.2% | operator |
| 20404 | Seq Scan | 174.90 | 159.74 | 8.7% | operator |
| 20405 | Index Scan | 0.07 | -0.52 | 873.5% | operator |
| 20407 | Seq Scan | 29.22 | 26.64 | 8.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 20404 (Seq Scan) - LEAF
...
### Step 2: Node 20405 (Index Scan) - LEAF
...
### Step 3: Node 20407 (Seq Scan) - LEAF
...
### Step 6: Node 20409 (Seq Scan) - LEAF
...
### Step 10: Node 20397 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20398, 20399, 20400
- **Input Features:**
