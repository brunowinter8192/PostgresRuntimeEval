    ...
    Node 19502 (Aggregate) [consumed]
      Node 19503 (Gather) [consumed]
        Node 19504 (Hash Join)
          Node 19505 (Hash Join)
            Node 19506 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19500 | 19501, 19502, 19503 |
...
| 19504 | Hash Join | 1108.25 | 1007.08 | 9.1% | operator |
| 19505 | Hash Join | 1105.31 | 1003.90 | 9.2% | operator |
| 19511 | Hash | 0.01 | 15.71 | 104638.5% | operator |
| 19506 | Nested Loop | 1057.94 | 1204.89 | 13.9% | operator |
| 19509 | Hash | 36.29 | 55.57 | 53.1% | operator |
...
### Step 6: Node 19512 (Seq Scan) - LEAF
...
### Step 10: Node 19500 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19501, 19502, 19503
- **Input Features:**
