    ...
    Node 19437 (Aggregate) [consumed]
      Node 19438 (Gather) [consumed]
        Node 19439 (Hash Join)
          Node 19440 (Hash Join)
            Node 19441 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19435 | 19436, 19437, 19438 |
...
| 19439 | Hash Join | 1090.00 | 1007.36 | 7.6% | operator |
| 19440 | Hash Join | 1087.25 | 1004.36 | 7.6% | operator |
| 19446 | Hash | 0.02 | 15.71 | 92316.3% | operator |
| 19441 | Nested Loop | 1037.20 | 1204.72 | 16.2% | operator |
| 19444 | Hash | 37.44 | 55.57 | 48.4% | operator |
...
### Step 6: Node 19447 (Seq Scan) - LEAF
...
### Step 10: Node 19435 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19436, 19437, 19438
- **Input Features:**
