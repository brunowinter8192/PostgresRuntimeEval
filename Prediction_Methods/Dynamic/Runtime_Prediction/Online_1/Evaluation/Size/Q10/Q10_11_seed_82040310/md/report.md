    ...
    Node 19645 (Aggregate) [consumed]
      Node 19646 (Gather) [consumed]
        Node 19647 (Hash Join)
          Node 19648 (Hash Join)
            Node 19649 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19643 | 19644, 19645, 19646 |
...
| 19647 | Hash Join | 1097.63 | 1007.14 | 8.2% | operator |
| 19648 | Hash Join | 1094.78 | 1004.00 | 8.3% | operator |
| 19654 | Hash | 0.01 | 15.71 | 120752.1% | operator |
| 19649 | Nested Loop | 1049.85 | 1204.86 | 14.8% | operator |
| 19652 | Hash | 32.39 | 55.57 | 71.6% | operator |
...
### Step 6: Node 19655 (Seq Scan) - LEAF
...
### Step 10: Node 19643 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19644, 19645, 19646
- **Input Features:**
