    ...
    Node 20763 (Aggregate) [consumed]
      Node 20764 (Gather) [consumed]
        Node 20765 (Hash Join)
          Node 20766 (Hash Join)
            Node 20767 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20761 | 20762, 20763, 20764 |
...
| 20765 | Hash Join | 1101.35 | 1007.36 | 8.5% | operator |
| 20766 | Hash Join | 1098.57 | 1004.36 | 8.6% | operator |
| 20772 | Hash | 0.01 | 15.71 | 112119.8% | operator |
| 20767 | Nested Loop | 1050.55 | 1204.72 | 14.7% | operator |
| 20770 | Hash | 37.77 | 55.57 | 47.1% | operator |
...
### Step 6: Node 20773 (Seq Scan) - LEAF
...
### Step 10: Node 20761 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20762, 20763, 20764
- **Input Features:**
