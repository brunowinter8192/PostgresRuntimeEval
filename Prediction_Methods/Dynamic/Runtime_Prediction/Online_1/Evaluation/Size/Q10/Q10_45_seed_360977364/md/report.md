    ...
    Node 20529 (Aggregate) [consumed]
      Node 20530 (Gather) [consumed]
        Node 20531 (Hash Join)
          Node 20532 (Hash Join)
            Node 20533 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20527 | 20528, 20529, 20530 |
...
| 20531 | Hash Join | 1089.03 | 1007.25 | 7.5% | operator |
| 20532 | Hash Join | 1086.14 | 1004.18 | 7.5% | operator |
| 20538 | Hash | 0.02 | 15.71 | 98092.3% | operator |
| 20533 | Nested Loop | 1039.41 | 1204.79 | 15.9% | operator |
| 20536 | Hash | 35.34 | 55.57 | 57.3% | operator |
...
### Step 6: Node 20539 (Seq Scan) - LEAF
...
### Step 10: Node 20527 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20528, 20529, 20530
- **Input Features:**
