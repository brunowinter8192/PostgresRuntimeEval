    ...
    Node 20451 (Aggregate) [consumed]
      Node 20452 (Gather) [consumed]
        Node 20453 (Hash Join)
          Node 20454 (Hash Join)
            Node 20455 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20449 | 20450, 20451, 20452 |
...
| 20453 | Hash Join | 1109.59 | 1007.16 | 9.2% | operator |
| 20454 | Hash Join | 1106.68 | 1004.03 | 9.3% | operator |
| 20460 | Hash | 0.02 | 15.71 | 98092.3% | operator |
| 20455 | Nested Loop | 1061.66 | 1204.85 | 13.5% | operator |
| 20458 | Hash | 34.63 | 55.57 | 60.4% | operator |
...
### Step 6: Node 20461 (Seq Scan) - LEAF
...
### Step 10: Node 20449 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20450, 20451, 20452
- **Input Features:**
