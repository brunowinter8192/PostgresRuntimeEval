    ...
    Node 19879 (Aggregate) [consumed]
      Node 19880 (Gather) [consumed]
        Node 19881 (Hash Join)
          Node 19882 (Hash Join)
            Node 19883 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19877 | 19878, 19879, 19880 |
...
| 19881 | Hash Join | 1114.80 | 1007.16 | 9.7% | operator |
| 19882 | Hash Join | 1111.86 | 1004.03 | 9.7% | operator |
| 19888 | Hash | 0.02 | 15.71 | 92316.3% | operator |
| 19883 | Nested Loop | 1062.08 | 1204.85 | 13.4% | operator |
| 19886 | Hash | 37.19 | 55.57 | 49.4% | operator |
...
### Step 6: Node 19889 (Seq Scan) - LEAF
...
### Step 10: Node 19877 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19878, 19879, 19880
- **Input Features:**
