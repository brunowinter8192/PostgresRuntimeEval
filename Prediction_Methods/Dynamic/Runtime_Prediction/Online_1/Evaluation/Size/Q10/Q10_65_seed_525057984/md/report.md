    ...
    Node 20815 (Aggregate) [consumed]
      Node 20816 (Gather) [consumed]
        Node 20817 (Hash Join)
          Node 20818 (Hash Join)
            Node 20819 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20813 | 20814, 20815, 20816 |
...
| 20817 | Hash Join | 1097.89 | 1007.14 | 8.3% | operator |
| 20818 | Hash Join | 1094.96 | 1003.99 | 8.3% | operator |
| 20824 | Hash | 0.01 | 15.71 | 104638.5% | operator |
| 20819 | Nested Loop | 1049.36 | 1204.86 | 14.8% | operator |
| 20822 | Hash | 35.04 | 55.57 | 58.6% | operator |
...
### Step 6: Node 20825 (Seq Scan) - LEAF
...
### Step 10: Node 20813 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20814, 20815, 20816
- **Input Features:**
