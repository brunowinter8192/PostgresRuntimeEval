    ...
    Node 20958 (Aggregate) [consumed]
      Node 20959 (Gather) [consumed]
        Node 20960 (Hash Join)
          Node 20961 (Hash Join)
            Node 20962 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20956 | 20957, 20958, 20959 |
...
| 20960 | Hash Join | 1094.42 | 1007.38 | 8.0% | operator |
| 20961 | Hash Join | 1091.85 | 1004.38 | 8.0% | operator |
| 20967 | Hash | 0.01 | 15.71 | 104638.5% | operator |
| 20962 | Nested Loop | 1045.37 | 1204.71 | 15.2% | operator |
| 20965 | Hash | 36.43 | 55.57 | 52.5% | operator |
...
### Step 6: Node 20968 (Seq Scan) - LEAF
...
### Step 10: Node 20956 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20957, 20958, 20959
- **Input Features:**
