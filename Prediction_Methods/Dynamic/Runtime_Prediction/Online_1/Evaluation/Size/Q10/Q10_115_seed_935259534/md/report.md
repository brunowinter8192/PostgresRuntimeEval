    ...
    Node 19580 (Aggregate) [consumed]
      Node 19581 (Gather) [consumed]
        Node 19582 (Hash Join)
          Node 19583 (Hash Join)
            Node 19584 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19578 | 19579, 19580, 19581 |
...
| 19582 | Hash Join | 1108.30 | 1007.16 | 9.1% | operator |
| 19583 | Hash Join | 1105.41 | 1004.03 | 9.2% | operator |
| 19589 | Hash | 0.01 | 15.71 | 104638.5% | operator |
| 19584 | Nested Loop | 1056.31 | 1204.85 | 14.1% | operator |
| 19587 | Hash | 37.97 | 55.57 | 46.3% | operator |
...
### Step 6: Node 19590 (Seq Scan) - LEAF
...
### Step 10: Node 19578 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19579, 19580, 19581
- **Input Features:**
