    ...
    Node 20490 (Aggregate) [consumed]
      Node 20491 (Gather) [consumed]
        Node 20492 (Hash Join)
          Node 20493 (Hash Join)
            Node 20494 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20488 | 20489, 20490, 20491 |
...
| 20492 | Hash Join | 1128.05 | 1007.13 | 10.7% | operator |
| 20493 | Hash Join | 1125.03 | 1003.98 | 10.8% | operator |
| 20499 | Hash | 0.01 | 15.71 | 104638.5% | operator |
| 20494 | Nested Loop | 1077.37 | 1204.86 | 11.8% | operator |
| 20497 | Hash | 35.19 | 55.57 | 57.9% | operator |
...
### Step 6: Node 20500 (Seq Scan) - LEAF
...
### Step 10: Node 20488 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20489, 20490, 20491
- **Input Features:**
