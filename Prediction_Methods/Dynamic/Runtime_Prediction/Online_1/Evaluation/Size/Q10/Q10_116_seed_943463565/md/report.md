    ...
    Node 19593 (Aggregate) [consumed]
      Node 19594 (Gather) [consumed]
        Node 19595 (Hash Join)
          Node 19596 (Hash Join)
            Node 19597 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19591 | 19592, 19593, 19594 |
...
| 19595 | Hash Join | 1115.86 | 1007.13 | 9.7% | operator |
| 19596 | Hash Join | 1112.96 | 1003.98 | 9.8% | operator |
| 19602 | Hash | 0.01 | 15.71 | 120752.1% | operator |
| 19597 | Nested Loop | 1065.40 | 1204.86 | 13.1% | operator |
| 19600 | Hash | 36.69 | 55.57 | 51.4% | operator |
...
### Step 6: Node 19603 (Seq Scan) - LEAF
...
### Step 10: Node 19591 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19592, 19593, 19594
- **Input Features:**
