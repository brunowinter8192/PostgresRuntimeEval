    ...
    Node 19788 (Aggregate) [consumed]
      Node 19789 (Gather) [consumed]
        Node 19790 (Hash Join)
          Node 19791 (Hash Join)
            Node 19792 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19786 | 19787, 19788, 19789 |
...
| 19790 | Hash Join | 1108.27 | 1007.16 | 9.1% | operator |
| 19791 | Hash Join | 1105.39 | 1004.03 | 9.2% | operator |
| 19797 | Hash | 0.01 | 15.71 | 120752.1% | operator |
| 19792 | Nested Loop | 1057.90 | 1204.85 | 13.9% | operator |
| 19795 | Hash | 36.26 | 55.57 | 53.3% | operator |
...
### Step 6: Node 19798 (Seq Scan) - LEAF
...
### Step 10: Node 19786 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19787, 19788, 19789
- **Input Features:**
