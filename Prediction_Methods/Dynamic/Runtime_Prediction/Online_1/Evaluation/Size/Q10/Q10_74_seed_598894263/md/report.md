    ...
    Node 20945 (Aggregate) [consumed]
      Node 20946 (Gather) [consumed]
        Node 20947 (Hash Join)
          Node 20948 (Hash Join)
            Node 20949 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20943 | 20944, 20945, 20946 |
...
| 20947 | Hash Join | 1101.50 | 1007.16 | 8.6% | operator |
| 20948 | Hash Join | 1098.10 | 1004.03 | 8.6% | operator |
| 20954 | Hash | 0.02 | 15.71 | 82588.3% | operator |
| 20949 | Nested Loop | 1048.79 | 1204.85 | 14.9% | operator |
| 20952 | Hash | 38.19 | 55.57 | 45.5% | operator |
...
### Step 6: Node 20955 (Seq Scan) - LEAF
...
### Step 10: Node 20943 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20944, 20945, 20946
- **Input Features:**
