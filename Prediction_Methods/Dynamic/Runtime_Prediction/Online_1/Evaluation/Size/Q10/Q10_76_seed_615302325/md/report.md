    ...
    Node 20971 (Aggregate) [consumed]
      Node 20972 (Gather) [consumed]
        Node 20973 (Hash Join)
          Node 20974 (Hash Join)
            Node 20975 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20969 | 20970, 20971, 20972 |
...
| 20973 | Hash Join | 1125.57 | 1007.36 | 10.5% | operator |
| 20974 | Hash Join | 1122.66 | 1004.36 | 10.5% | operator |
| 20980 | Hash | 0.02 | 15.71 | 87182.1% | operator |
| 20975 | Nested Loop | 1074.71 | 1204.72 | 12.1% | operator |
| 20978 | Hash | 36.03 | 55.57 | 54.2% | operator |
...
### Step 6: Node 20981 (Seq Scan) - LEAF
...
### Step 10: Node 20969 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20970, 20971, 20972
- **Input Features:**
