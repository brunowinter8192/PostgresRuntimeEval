    ...
    Node 21244 (Aggregate) [consumed]
      Node 21245 (Gather) [consumed]
        Node 21246 (Hash Join)
          Node 21247 (Hash Join)
            Node 21248 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 21242 | 21243, 21244, 21245 |
...
| 21246 | Hash Join | 1071.64 | 1007.14 | 6.0% | operator |
| 21247 | Hash Join | 1068.75 | 1003.99 | 6.1% | operator |
| 21253 | Hash | 0.01 | 15.71 | 104638.5% | operator |
| 21248 | Nested Loop | 1027.68 | 1204.86 | 17.2% | operator |
| 21251 | Hash | 30.69 | 55.57 | 81.1% | operator |
...
### Step 6: Node 21254 (Seq Scan) - LEAF
...
### Step 10: Node 21242 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 21243, 21244, 21245
- **Input Features:**
