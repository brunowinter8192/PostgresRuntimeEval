    ...
    Node 20607 (Aggregate) [consumed]
      Node 20608 (Gather) [consumed]
        Node 20609 (Hash Join)
          Node 20610 (Hash Join)
            Node 20611 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20605 | 20606, 20607, 20608 |
...
| 20609 | Hash Join | 1073.38 | 1007.18 | 6.2% | operator |
| 20610 | Hash Join | 1070.48 | 1004.06 | 6.2% | operator |
| 20616 | Hash | 0.02 | 15.71 | 98092.3% | operator |
| 20611 | Nested Loop | 1027.61 | 1204.84 | 17.2% | operator |
| 20614 | Hash | 31.64 | 55.57 | 75.6% | operator |
...
- **Output:** st=124.86, rt=1204.84

### Step 5: Node 20614 (Hash)
...
### Step 6: Node 20617 (Seq Scan) - LEAF
...
- **Output:** st=109.72, rt=1004.06

### Step 8: Node 20616 (Hash)
...
- **Output:** st=98.92, rt=1007.18

### Step 10: Node 20605 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20606, 20607, 20608
- **Input Features:**
