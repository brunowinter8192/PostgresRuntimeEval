    ...
    Node 19944 (Aggregate) [consumed]
      Node 19945 (Gather) [consumed]
        Node 19946 (Hash Join)
          Node 19947 (Hash Join)
            Node 19948 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19942 | 19943, 19944, 19945 |
...
| 19946 | Hash Join | 1099.06 | 1007.14 | 8.4% | operator |
| 19947 | Hash Join | 1096.21 | 1003.99 | 8.4% | operator |
| 19953 | Hash | 0.02 | 15.71 | 98092.3% | operator |
| 19948 | Nested Loop | 1050.79 | 1204.86 | 14.7% | operator |
| 19951 | Hash | 34.92 | 55.57 | 59.1% | operator |
...
### Step 6: Node 19954 (Seq Scan) - LEAF
...
### Step 10: Node 19942 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19943, 19944, 19945
- **Input Features:**
