    ...
    Node 20516 (Aggregate) [consumed]
      Node 20517 (Gather) [consumed]
        Node 20518 (Hash Join)
          Node 20519 (Hash Join)
            Node 20520 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20514 | 20515, 20516, 20517 |
...
| 20518 | Hash Join | 1098.05 | 1007.24 | 8.3% | operator |
| 20519 | Hash Join | 1095.18 | 1004.16 | 8.3% | operator |
| 20525 | Hash | 0.01 | 15.71 | 104638.5% | operator |
| 20520 | Nested Loop | 1049.75 | 1204.80 | 14.8% | operator |
| 20523 | Hash | 35.21 | 55.57 | 57.8% | operator |
...
### Step 6: Node 20526 (Seq Scan) - LEAF
...
### Step 10: Node 20514 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20515, 20516, 20517
- **Input Features:**
