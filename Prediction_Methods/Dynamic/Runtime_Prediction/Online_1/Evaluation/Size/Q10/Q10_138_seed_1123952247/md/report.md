    ...
    Node 19905 (Aggregate) [consumed]
      Node 19906 (Gather) [consumed]
        Node 19907 (Hash Join)
          Node 19908 (Hash Join)
            Node 19909 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19903 | 19904, 19905, 19906 |
...
| 19907 | Hash Join | 1132.13 | 1007.22 | 11.0% | operator |
| 19908 | Hash Join | 1129.22 | 1004.13 | 11.1% | operator |
| 19914 | Hash | 0.01 | 15.71 | 142725.2% | operator |
| 19909 | Nested Loop | 1081.81 | 1204.81 | 11.4% | operator |
| 19912 | Hash | 36.10 | 55.57 | 53.9% | operator |
...
- **Output:** st=124.84, rt=1204.81

### Step 5: Node 19912 (Hash)
...
### Step 6: Node 19915 (Seq Scan) - LEAF
...
- **Output:** st=109.70, rt=1004.13

### Step 8: Node 19914 (Hash)
...
- **Output:** st=98.90, rt=1007.22

### Step 10: Node 19903 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19904, 19905, 19906
- **Input Features:**
