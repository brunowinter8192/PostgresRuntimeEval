    ...
    Node 20165 (Aggregate) [consumed]
      Node 20166 (Gather) [consumed]
        Node 20167 (Hash Join)
          Node 20168 (Hash Join)
            Node 20169 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20163 | 20164, 20165, 20166 |
...
| 20167 | Hash Join | 1091.95 | 1007.26 | 7.8% | operator |
| 20168 | Hash Join | 1089.10 | 1004.20 | 7.8% | operator |
| 20174 | Hash | 0.01 | 15.71 | 130823.1% | operator |
| 20169 | Nested Loop | 1042.34 | 1204.78 | 15.6% | operator |
| 20172 | Hash | 36.10 | 55.57 | 53.9% | operator |
...
### Step 6: Node 20175 (Seq Scan) - LEAF
...
### Step 10: Node 20163 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20164, 20165, 20166
- **Input Features:**
