    ...
    Node 20594 (Aggregate) [consumed]
      Node 20595 (Gather) [consumed]
        Node 20596 (Hash Join)
          Node 20597 (Hash Join)
            Node 20598 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20592 | 20593, 20594, 20595 |
...
| 20596 | Hash Join | 1092.59 | 1007.26 | 7.8% | operator |
| 20597 | Hash Join | 1089.16 | 1004.20 | 7.8% | operator |
| 20603 | Hash | 0.01 | 15.71 | 104638.5% | operator |
| 20598 | Nested Loop | 1040.14 | 1204.78 | 15.8% | operator |
| 20601 | Hash | 38.57 | 55.57 | 44.1% | operator |
...
### Step 6: Node 20604 (Seq Scan) - LEAF
...
### Step 10: Node 20592 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20593, 20594, 20595
- **Input Features:**
