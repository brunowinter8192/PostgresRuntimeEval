    ...
    Node 21257 (Aggregate) [consumed]
      Node 21258 (Gather) [consumed]
        Node 21259 (Hash Join)
          Node 21260 (Hash Join)
            Node 21261 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 21255 | 21256, 21257, 21258 |
...
|------|------|--------|-----------|-----|--------|
| 21255 | Limit | 1146.35 | 1199.47 | 4.6% | pattern |
| 21259 | Hash Join | 1089.40 | 1006.93 | 7.6% | operator |
| 21260 | Hash Join | 1086.49 | 1003.66 | 7.6% | operator |
| 21266 | Hash | 0.01 | 15.71 | 120752.1% | operator |
| 21261 | Nested Loop | 1040.26 | 1204.98 | 15.8% | operator |
| 21264 | Hash | 35.90 | 55.57 | 54.8% | operator |
| 21267 | Seq Scan | 0.01 | 6.98 | 69687.0% | operator |
| 21262 | Seq Scan | 160.44 | 159.73 | 0.4% | operator |
| 21263 | Index Scan | 0.06 | -0.52 | 949.6% | operator |
| 21265 | Seq Scan | 29.21 | 26.64 | 8.8% | operator |
...
### Step 6: Node 21267 (Seq Scan) - LEAF
...
### Step 10: Node 21255 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 21256, 21257, 21258
- **Input Features:**
