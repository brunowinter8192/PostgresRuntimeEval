    ...
    Node 20113 (Aggregate) [consumed]
      Node 20114 (Gather) [consumed]
        Node 20115 (Hash Join)
          Node 20116 (Hash Join)
            Node 20117 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20111 | 20112, 20113, 20114 |
...
| 20115 | Hash Join | 1099.74 | 1007.38 | 8.4% | operator |
| 20116 | Hash Join | 1097.21 | 1004.38 | 8.5% | operator |
| 20122 | Hash | 0.01 | 15.71 | 104638.5% | operator |
| 20117 | Nested Loop | 1050.08 | 1204.71 | 14.7% | operator |
| 20120 | Hash | 36.48 | 55.57 | 52.3% | operator |
...
### Step 6: Node 20123 (Seq Scan) - LEAF
...
### Step 10: Node 20111 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20112, 20113, 20114
- **Input Features:**
