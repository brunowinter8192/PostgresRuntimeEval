    ...
    Node 20672 (Aggregate) [consumed]
      Node 20673 (Gather) [consumed]
        Node 20674 (Hash Join)
          Node 20675 (Hash Join)
            Node 20676 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20670 | 20671, 20672, 20673 |
...
| 20674 | Hash Join | 1100.94 | 1007.10 | 8.5% | operator |
| 20675 | Hash Join | 1098.04 | 1003.93 | 8.6% | operator |
| 20681 | Hash | 0.02 | 15.71 | 74713.2% | operator |
| 20676 | Nested Loop | 1051.60 | 1204.88 | 14.6% | operator |
| 20679 | Hash | 35.83 | 55.57 | 55.1% | operator |
...
### Step 6: Node 20682 (Seq Scan) - LEAF
...
### Step 10: Node 20670 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20671, 20672, 20673
- **Input Features:**
