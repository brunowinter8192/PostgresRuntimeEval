    ...
    Node 19801 (Aggregate) [consumed]
      Node 19802 (Gather) [consumed]
        Node 19803 (Hash Join)
          Node 19804 (Hash Join)
            Node 19805 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19799 | 19800, 19801, 19802 |
...
| 19803 | Hash Join | 1107.14 | 1007.16 | 9.0% | operator |
| 19804 | Hash Join | 1104.29 | 1004.03 | 9.1% | operator |
| 19810 | Hash | 0.01 | 15.71 | 112119.8% | operator |
| 19805 | Nested Loop | 1059.61 | 1204.85 | 13.7% | operator |
| 19808 | Hash | 33.83 | 55.57 | 64.3% | operator |
...
### Step 6: Node 19811 (Seq Scan) - LEAF
...
### Step 10: Node 19799 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19800, 19801, 19802
- **Input Features:**
