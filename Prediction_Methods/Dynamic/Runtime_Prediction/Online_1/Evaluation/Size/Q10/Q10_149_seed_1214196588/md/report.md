    ...
    Node 20061 (Aggregate) [consumed]
      Node 20062 (Gather) [consumed]
        Node 20063 (Hash Join)
          Node 20064 (Hash Join)
            Node 20065 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20059 | 20060, 20061, 20062 |
...
| 20063 | Hash Join | 1095.76 | 1007.38 | 8.1% | operator |
| 20064 | Hash Join | 1093.27 | 1004.38 | 8.1% | operator |
| 20070 | Hash | 0.01 | 15.71 | 130823.1% | operator |
| 20065 | Nested Loop | 1044.70 | 1204.71 | 15.3% | operator |
| 20068 | Hash | 38.65 | 55.57 | 43.8% | operator |
...
- **Output:** st=124.77, rt=1204.71

### Step 5: Node 20068 (Hash)
...
### Step 6: Node 20071 (Seq Scan) - LEAF
...
- **Output:** st=109.66, rt=1004.38

### Step 8: Node 20070 (Hash)
...
- **Output:** st=98.85, rt=1007.38

### Step 10: Node 20059 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20060, 20061, 20062
- **Input Features:**
