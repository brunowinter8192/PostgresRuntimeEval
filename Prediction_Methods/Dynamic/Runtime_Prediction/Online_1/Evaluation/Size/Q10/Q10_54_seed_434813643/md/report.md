    ...
    Node 20659 (Aggregate) [consumed]
      Node 20660 (Gather) [consumed]
        Node 20661 (Hash Join)
          Node 20662 (Hash Join)
            Node 20663 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20657 | 20658, 20659, 20660 |
...
| 20661 | Hash Join | 1088.98 | 1007.08 | 7.5% | operator |
| 20662 | Hash Join | 1086.05 | 1003.90 | 7.6% | operator |
| 20668 | Hash | 0.01 | 15.71 | 112119.8% | operator |
| 20663 | Nested Loop | 1038.31 | 1204.89 | 16.0% | operator |
| 20666 | Hash | 37.27 | 55.57 | 49.1% | operator |
...
### Step 6: Node 20669 (Seq Scan) - LEAF
...
### Step 10: Node 20657 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20658, 20659, 20660
- **Input Features:**
