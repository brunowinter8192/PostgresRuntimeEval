    ...
    Node 19450 (Aggregate) [consumed]
      Node 19451 (Gather) [consumed]
        Node 19452 (Hash Join)
          Node 19453 (Hash Join)
            Node 19454 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19448 | 19449, 19450, 19451 |
...
| 19452 | Hash Join | 1136.08 | 1007.12 | 11.4% | operator |
| 19453 | Hash Join | 1133.12 | 1003.97 | 11.4% | operator |
| 19459 | Hash | 0.01 | 15.71 | 104638.5% | operator |
| 19454 | Nested Loop | 1080.53 | 1204.87 | 11.5% | operator |
| 19457 | Hash | 42.21 | 55.57 | 31.7% | operator |
...
### Step 6: Node 19460 (Seq Scan) - LEAF
...
### Step 10: Node 19448 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19449, 19450, 19451
- **Input Features:**
