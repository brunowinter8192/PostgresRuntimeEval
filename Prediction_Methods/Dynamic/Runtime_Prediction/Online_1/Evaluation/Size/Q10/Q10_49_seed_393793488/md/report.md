    ...
    Node 20581 (Aggregate) [consumed]
      Node 20582 (Gather) [consumed]
        Node 20583 (Hash Join)
          Node 20584 (Hash Join)
            Node 20585 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20579 | 20580, 20581, 20582 |
...
| 20583 | Hash Join | 1104.66 | 1007.22 | 8.8% | operator |
| 20584 | Hash Join | 1101.72 | 1004.13 | 8.9% | operator |
| 20590 | Hash | 0.02 | 15.71 | 98092.3% | operator |
| 20585 | Nested Loop | 1058.12 | 1204.81 | 13.9% | operator |
| 20588 | Hash | 32.89 | 55.57 | 69.0% | operator |
...
### Step 6: Node 20591 (Seq Scan) - LEAF
...
### Step 10: Node 20579 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20580, 20581, 20582
- **Input Features:**
