    ...
    Node 19892 (Aggregate) [consumed]
      Node 19893 (Gather) [consumed]
        Node 19894 (Hash Join)
          Node 19895 (Hash Join)
            Node 19896 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19890 | 19891, 19892, 19893 |
...
| 19894 | Hash Join | 1097.52 | 1007.29 | 8.2% | operator |
| 19895 | Hash Join | 1094.61 | 1004.25 | 8.3% | operator |
| 19901 | Hash | 0.02 | 15.71 | 71312.6% | operator |
| 19896 | Nested Loop | 1053.97 | 1204.76 | 14.3% | operator |
| 19899 | Hash | 30.01 | 55.57 | 85.2% | operator |
...
### Step 6: Node 19902 (Seq Scan) - LEAF
...
### Step 10: Node 19890 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19891, 19892, 19893
- **Input Features:**
