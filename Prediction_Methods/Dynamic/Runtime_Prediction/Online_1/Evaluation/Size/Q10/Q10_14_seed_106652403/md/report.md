    ...
    Node 20074 (Aggregate) [consumed]
      Node 20075 (Gather) [consumed]
        Node 20076 (Hash Join)
          Node 20077 (Hash Join)
            Node 20078 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20072 | 20073, 20074, 20075 |
...
| 20076 | Hash Join | 1104.81 | 1007.24 | 8.8% | operator |
| 20077 | Hash Join | 1101.90 | 1004.16 | 8.9% | operator |
| 20083 | Hash | 0.02 | 15.71 | 98092.3% | operator |
| 20078 | Nested Loop | 1054.70 | 1204.80 | 14.2% | operator |
| 20081 | Hash | 36.02 | 55.57 | 54.3% | operator |
...
### Step 6: Node 20084 (Seq Scan) - LEAF
...
### Step 10: Node 20072 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20073, 20074, 20075
- **Input Features:**
