    ...
    Node 21101 (Aggregate) [consumed]
      Node 21102 (Gather) [consumed]
        Node 21103 (Hash Join)
          Node 21104 (Hash Join)
            Node 21105 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 21099 | 21100, 21101, 21102 |
...
| 21103 | Hash Join | 1104.01 | 1007.14 | 8.8% | operator |
| 21104 | Hash Join | 1101.11 | 1004.00 | 8.8% | operator |
| 21110 | Hash | 0.02 | 15.71 | 82588.3% | operator |
| 21105 | Nested Loop | 1054.14 | 1204.86 | 14.3% | operator |
| 21108 | Hash | 35.16 | 55.57 | 58.0% | operator |
...
### Step 6: Node 21111 (Seq Scan) - LEAF
...
### Step 10: Node 21099 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 21100, 21101, 21102
- **Input Features:**
