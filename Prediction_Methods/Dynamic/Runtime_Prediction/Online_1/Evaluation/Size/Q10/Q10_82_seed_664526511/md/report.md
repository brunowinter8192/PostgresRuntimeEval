    ...
    Node 21062 (Aggregate) [consumed]
      Node 21063 (Gather) [consumed]
        Node 21064 (Hash Join)
          Node 21065 (Hash Join)
            Node 21066 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 21060 | 21061, 21062, 21063 |
...
| 21064 | Hash Join | 1110.45 | 1007.27 | 9.3% | operator |
| 21065 | Hash Join | 1107.60 | 1004.21 | 9.3% | operator |
| 21071 | Hash | 0.02 | 15.71 | 92316.3% | operator |
| 21066 | Nested Loop | 1061.55 | 1204.78 | 13.5% | operator |
| 21069 | Hash | 34.62 | 55.57 | 60.5% | operator |
...
### Step 6: Node 21072 (Seq Scan) - LEAF
...
### Step 10: Node 21060 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 21061, 21062, 21063
- **Input Features:**
