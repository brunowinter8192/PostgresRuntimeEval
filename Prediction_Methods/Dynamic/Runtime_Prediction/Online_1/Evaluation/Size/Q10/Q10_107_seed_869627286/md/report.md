    ...
    Node 19463 (Aggregate) [consumed]
      Node 19464 (Gather) [consumed]
        Node 19465 (Hash Join)
          Node 19466 (Hash Join)
            Node 19467 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19461 | 19462, 19463, 19464 |
...
| 19465 | Hash Join | 1093.53 | 1007.26 | 7.9% | operator |
| 19466 | Hash Join | 1090.56 | 1004.20 | 7.9% | operator |
| 19472 | Hash | 0.01 | 15.71 | 112119.8% | operator |
| 19467 | Nested Loop | 1044.56 | 1204.78 | 15.3% | operator |
| 19470 | Hash | 35.99 | 55.57 | 54.4% | operator |
...
### Step 6: Node 19473 (Seq Scan) - LEAF
...
### Step 10: Node 19461 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19462, 19463, 19464
- **Input Features:**
