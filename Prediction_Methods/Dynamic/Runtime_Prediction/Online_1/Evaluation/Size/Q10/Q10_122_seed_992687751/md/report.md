    ...
    Node 19684 (Aggregate) [consumed]
      Node 19685 (Gather) [consumed]
        Node 19686 (Hash Join)
          Node 19687 (Hash Join)
            Node 19688 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19682 | 19683, 19684, 19685 |
...
| 19686 | Hash Join | 1099.28 | 1007.26 | 8.4% | operator |
| 19687 | Hash Join | 1096.36 | 1004.20 | 8.4% | operator |
| 19693 | Hash | 0.02 | 15.71 | 87182.1% | operator |
| 19688 | Nested Loop | 1052.71 | 1204.78 | 14.4% | operator |
| 19691 | Hash | 33.40 | 55.57 | 66.4% | operator |
...
### Step 6: Node 19694 (Seq Scan) - LEAF
...
### Step 10: Node 19682 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19683, 19684, 19685
- **Input Features:**
