    ...
    Node 21166 (Aggregate) [consumed]
      Node 21167 (Gather) [consumed]
        Node 21168 (Hash Join)
          Node 21169 (Hash Join)
            Node 21170 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 21164 | 21165, 21166, 21167 |
...
| 21168 | Hash Join | 1085.44 | 1007.27 | 7.2% | operator |
| 21169 | Hash Join | 1082.65 | 1004.21 | 7.2% | operator |
| 21175 | Hash | 0.01 | 15.71 | 130823.1% | operator |
| 21170 | Nested Loop | 1034.67 | 1204.78 | 16.4% | operator |
| 21173 | Hash | 37.26 | 55.57 | 49.1% | operator |
...
### Step 6: Node 21176 (Seq Scan) - LEAF
...
### Step 10: Node 21164 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 21165, 21166, 21167
- **Input Features:**
