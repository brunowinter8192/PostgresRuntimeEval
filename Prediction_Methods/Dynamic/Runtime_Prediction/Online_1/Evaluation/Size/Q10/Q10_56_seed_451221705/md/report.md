    ...
    Node 20685 (Aggregate) [consumed]
      Node 20686 (Gather) [consumed]
        Node 20687 (Hash Join)
          Node 20688 (Hash Join)
            Node 20689 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20683 | 20684, 20685, 20686 |
...
| 20687 | Hash Join | 1079.62 | 1007.16 | 6.7% | operator |
| 20688 | Hash Join | 1076.68 | 1004.03 | 6.7% | operator |
| 20694 | Hash | 0.02 | 15.71 | 78453.9% | operator |
| 20689 | Nested Loop | 1031.59 | 1204.85 | 16.8% | operator |
| 20692 | Hash | 33.81 | 55.57 | 64.4% | operator |
...
### Step 6: Node 20695 (Seq Scan) - LEAF
...
### Step 10: Node 20683 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20684, 20685, 20686
- **Input Features:**
