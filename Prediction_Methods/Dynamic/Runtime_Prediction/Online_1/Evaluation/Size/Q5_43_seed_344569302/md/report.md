...
**Test Query:** Q5_43_seed_344569302
...
```
Node 8641 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 8642 (Aggregate) [consumed]
    Node 8643 (Gather Merge) [consumed]
      Node 8644 (Aggregate)
        Node 8645 (Sort) [PATTERN: 3e2d5a00]
          Node 8646 (Hash Join) [consumed]
            Node 8647 (Nested Loop)
              Node 8648 (Hash Join)
                Node 8649 (Seq Scan) - LEAF
                Node 8650 (Hash) [PATTERN: 444761fb]
                  Node 8651 (Hash Join) [consumed]
                    Node 8652 (Seq Scan) [consumed] - LEAF
                    Node 8653 (Hash) [consumed]
                      Node 8654 (Hash Join) [consumed]
                        Node 8655 (Seq Scan) - LEAF
                        Node 8656 (Hash)
                          Node 8657 (Seq Scan) - LEAF
              Node 8658 (Index Scan) - LEAF
            Node 8659 (Hash)
              Node 8660 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 8650 | 8641, 8642, 8643, 8645, 8646, 8651, 8652, 8653, 8654 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 8641 | 8642, 8643, 8645, 8646, 8650, 8651, 8652, 8653, 8654 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 8645 | 8641, 8642, 8643, 8646, 8650, 8651, 8652, 8653, 8654 |
...
|------|------|--------|-----------|-----|--------|
| 8641 | Sort | 1088.40 | 2934.42 | 169.6% | pattern |
| 8644 | Aggregate | 1083.69 | 1128.79 | 4.2% | operator |
| 8645 | Sort | 1083.43 | 1835.90 | 69.5% | pattern |
| 8647 | Nested Loop | 1071.48 | 1188.37 | 10.9% | operator |
| 8659 | Hash | 3.39 | 18.67 | 451.1% | operator |
| 8648 | Hash Join | 219.76 | 253.07 | 15.2% | operator |
| 8658 | Index Scan | 0.07 | -0.22 | 393.4% | operator |
| 8660 | Seq Scan | 2.89 | 12.36 | 327.4% | operator |
| 8649 | Seq Scan | 170.64 | 159.81 | 6.3% | operator |
| 8650 | Hash | 36.27 | 46.85 | 29.2% | pattern |
| 8655 | Seq Scan | 0.01 | 11.81 | 84244.8% | operator |
| 8656 | Hash | 0.11 | 21.05 | 19393.7% | operator |
| 8657 | Seq Scan | 0.10 | 22.93 | 21951.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 8657 (Seq Scan) - LEAF
...
### Step 2: Node 8655 (Seq Scan) - LEAF
...
### Step 4: Node 8649 (Seq Scan) - LEAF
...
### Step 5: Node 8650 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 8641, 8642, 8643, 8645, 8646, 8651, 8652, 8653, 8654
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 8658 (Index Scan) - LEAF
...
### Step 8: Node 8660 (Seq Scan) - LEAF
...
### Step 11: Node 8645 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 8641, 8642, 8643, 8646, 8650, 8651, 8652, 8653, 8654
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 8641 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 8642, 8643, 8645, 8646, 8650, 8651, 8652, 8653, 8654
- **Input Features:**
