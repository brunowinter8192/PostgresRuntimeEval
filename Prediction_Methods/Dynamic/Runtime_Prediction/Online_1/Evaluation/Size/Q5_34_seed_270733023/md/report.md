...
**Test Query:** Q5_34_seed_270733023
...
```
Node 8441 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 8442 (Aggregate) [consumed]
    Node 8443 (Gather Merge) [consumed]
      Node 8444 (Aggregate)
        Node 8445 (Sort) [PATTERN: 3e2d5a00]
          Node 8446 (Hash Join) [consumed]
            Node 8447 (Nested Loop)
              Node 8448 (Hash Join)
                Node 8449 (Seq Scan) - LEAF
                Node 8450 (Hash) [PATTERN: 444761fb]
                  Node 8451 (Hash Join) [consumed]
                    Node 8452 (Seq Scan) [consumed] - LEAF
                    Node 8453 (Hash) [consumed]
                      Node 8454 (Hash Join) [consumed]
                        Node 8455 (Seq Scan) - LEAF
                        Node 8456 (Hash)
                          Node 8457 (Seq Scan) - LEAF
              Node 8458 (Index Scan) - LEAF
            Node 8459 (Hash)
              Node 8460 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 8450 | 8441, 8442, 8443, 8445, 8446, 8451, 8452, 8453, 8454 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 8441 | 8442, 8443, 8445, 8446, 8450, 8451, 8452, 8453, 8454 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 8445 | 8441, 8442, 8443, 8446, 8450, 8451, 8452, 8453, 8454 |
...
|------|------|--------|-----------|-----|--------|
| 8441 | Sort | 1059.44 | 2934.42 | 177.0% | pattern |
| 8444 | Aggregate | 1054.42 | 1128.78 | 7.1% | operator |
| 8445 | Sort | 1054.17 | 1835.92 | 74.2% | pattern |
| 8447 | Nested Loop | 1042.57 | 1188.42 | 14.0% | operator |
| 8459 | Hash | 3.03 | 18.67 | 516.2% | operator |
| 8448 | Hash Join | 217.51 | 253.07 | 16.3% | operator |
| 8458 | Index Scan | 0.07 | -0.22 | 405.6% | operator |
| 8460 | Seq Scan | 2.47 | 12.36 | 399.6% | operator |
| 8449 | Seq Scan | 168.21 | 159.81 | 5.0% | operator |
| 8450 | Hash | 34.74 | 46.85 | 34.9% | pattern |
| 8455 | Seq Scan | 0.01 | 11.81 | 131103.0% | operator |
| 8456 | Hash | 0.13 | 21.05 | 15849.4% | operator |
| 8457 | Seq Scan | 0.13 | 22.93 | 17541.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 8457 (Seq Scan) - LEAF
...
### Step 2: Node 8455 (Seq Scan) - LEAF
...
### Step 4: Node 8449 (Seq Scan) - LEAF
...
### Step 5: Node 8450 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 8441, 8442, 8443, 8445, 8446, 8451, 8452, 8453, 8454
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 8458 (Index Scan) - LEAF
...
### Step 8: Node 8460 (Seq Scan) - LEAF
...
### Step 11: Node 8445 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 8441, 8442, 8443, 8446, 8450, 8451, 8452, 8453, 8454
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 8441 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 8442, 8443, 8445, 8446, 8450, 8451, 8452, 8453, 8454
- **Input Features:**
