...
**Test Query:** Q13_70_seed_566078139
...
```
Node 26189 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26190 (Aggregate) [consumed]
    Node 26191 (Aggregate)
      Node 26192 (Hash Join) [PATTERN: 895c6e8c]
        Node 26193 (Seq Scan) [consumed] - LEAF
        Node 26194 (Hash) [consumed]
          Node 26195 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26189 | 26190, 26192, 26193, 26194 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26192 | 26189, 26190, 26193, 26194 |
...
|------|------|--------|-----------|-----|--------|
| 26189 | Sort | 936.60 | 1079.94 | 15.3% | pattern |
| 26191 | Aggregate | 930.50 | 999.76 | 7.4% | operator |
| 26192 | Hash Join | 715.81 | 470.31 | 34.3% | pattern |
| 26195 | Index Only Scan | 9.75 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26195 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26192 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26189, 26190, 26193, 26194
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 26189 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26190, 26192, 26193, 26194
- **Input Features:**
