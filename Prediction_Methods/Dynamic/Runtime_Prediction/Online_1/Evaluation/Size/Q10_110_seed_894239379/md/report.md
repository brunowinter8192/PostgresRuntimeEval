...
**Test Query:** Q10_110_seed_894239379
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19513 | 19514, 19515, 19516, 19518, 19519, 19522 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 19518 | 19513, 19514, 19515, 19516, 19519, 19522 |
...
|------|------|--------|-----------|-----|--------|
| 19513 | Limit | 1153.77 | 1199.47 | 4.0% | pattern |
| 19517 | Hash Join | 1101.06 | 1095.57 | 0.5% | operator |
| 19518 | Hash Join | 1098.15 | 1120.19 | 2.0% | pattern |
| 19524 | Hash | 0.02 | 15.71 | 92316.3% | operator |
| 19525 | Seq Scan | 0.01 | 6.98 | 53582.3% | operator |
| 19520 | Seq Scan | 161.68 | 159.74 | 1.2% | operator |
| 19521 | Index Scan | 0.06 | -0.52 | 935.9% | operator |
| 19523 | Seq Scan | 25.29 | 26.64 | 5.4% | operator |
...
### Step 3: Node 19523 (Seq Scan) - LEAF
...
### Step 4: Node 19525 (Seq Scan) - LEAF
...
### Step 5: Node 19518 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 19513, 19514, 19515, 19516, 19519, 19522
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18240
  - HashJoin_nt1=18240
...
### Step 8: Node 19513 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19514, 19515, 19516, 19518, 19519, 19522
- **Input Features:**
