    ...
    Node 19515 (Aggregate) [consumed]
      Node 19516 (Gather) [consumed]
        Node 19517 (Hash Join)
          Node 19518 (Hash Join)
            Node 19519 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19513 | 19514, 19515, 19516 |
...
| 19517 | Hash Join | 1101.06 | 1007.14 | 8.5% | operator |
| 19518 | Hash Join | 1098.15 | 1003.99 | 8.6% | operator |
| 19524 | Hash | 0.02 | 15.71 | 92316.3% | operator |
| 19519 | Nested Loop | 1049.26 | 1204.86 | 14.8% | operator |
| 19522 | Hash | 37.79 | 55.57 | 47.0% | operator |
...
### Step 6: Node 19525 (Seq Scan) - LEAF
...
### Step 10: Node 19513 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19514, 19515, 19516
- **Input Features:**
