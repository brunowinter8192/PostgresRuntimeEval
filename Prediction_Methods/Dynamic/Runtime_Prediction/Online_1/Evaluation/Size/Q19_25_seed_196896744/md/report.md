...
**Test Query:** Q19_25_seed_196896744
...
```
Node 31689 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31690 (Gather) [consumed]
    Node 31691 (Aggregate) [consumed]
      Node 31692 (Hash Join) [consumed]
        Node 31693 (Seq Scan) - LEAF
        Node 31694 (Hash)
          Node 31695 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31689 | 31690, 31691, 31692 |
...
|------|------|--------|-----------|-----|--------|
| 31689 | Aggregate | 833.28 | 829.32 | 0.5% | pattern |
| 31693 | Seq Scan | 765.84 | 743.46 | 2.9% | operator |
| 31694 | Hash | 44.98 | 8.29 | 81.6% | operator |
| 31695 | Seq Scan | 44.84 | 23.76 | 47.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31695 (Seq Scan) - LEAF
...
### Step 2: Node 31693 (Seq Scan) - LEAF
...
### Step 4: Node 31689 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31690, 31691, 31692
- **Input Features:**
