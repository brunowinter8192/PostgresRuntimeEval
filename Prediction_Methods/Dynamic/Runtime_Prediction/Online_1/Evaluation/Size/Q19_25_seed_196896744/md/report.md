...
```
Node 31689 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31690 (Gather) [consumed]
    Node 31691 (Aggregate) [consumed]
      Node 31692 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31689 | 31690, 31691 |
...
|------|------|--------|-----------|-----|--------|
| 31689 | Aggregate | 833.28 | 831.20 | 0.3% | pattern |
| 31692 | Hash Join | 813.18 | 766.06 | 5.8% | operator |
...
### Step 5: Node 31689 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31690, 31691
- **Input Features:**
