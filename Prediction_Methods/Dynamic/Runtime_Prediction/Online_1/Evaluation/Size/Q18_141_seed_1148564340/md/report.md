...
```
Node 29540 (Limit) - ROOT
  Node 29541 (Sort)
    Node 29542 (Aggregate)
      Node 29543 (Gather Merge)
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29548 | 29549, 29550 |
...
|------|------|--------|-----------|-----|--------|
| 29540 | Limit | 3047.25 | 1175.21 | 61.4% | operator |
| 29541 | Sort | 2935.45 | 1127.81 | 61.6% | operator |
| 29542 | Aggregate | 2935.41 | 1073.15 | 63.4% | operator |
| 29543 | Gather Merge | 2935.39 | 1073.95 | 63.4% | operator |
| 29544 | Incremental Sort | 2899.29 | 0.00 | 100.0% | operator |
| 29545 | Nested Loop | 2899.23 | 1111.34 | 61.7% | operator |
| 29546 | Merge Join | 2899.19 | 0.00 | 100.0% | operator |
| 29555 | Index Scan | 0.02 | 0.05 | 182.1% | operator |
| 29547 | Sort | 2847.47 | 1095.58 | 61.5% | operator |
| 29553 | Sort | 67.49 | 1074.66 | 1492.3% | operator |
| 29548 | Hash Join | 2847.46 | 471.07 | 83.5% | pattern |
| 29554 | Seq Scan | 55.42 | 18.25 | 67.1% | operator |
| 29551 | Aggregate | 2626.92 | 1073.15 | 59.1% | operator |
| 29552 | Index Scan | 2114.32 | 0.00 | 100.0% | operator |
...
### Step 10: Node 29544 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29543 (Gather Merge)
