...
```
Node 31507 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31508 (Gather) [consumed]
    Node 31509 (Aggregate) [consumed]
      Node 31510 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31507 | 31508, 31509 |
...
|------|------|--------|-----------|-----|--------|
| 31507 | Aggregate | 844.26 | 831.20 | 1.5% | pattern |
| 31510 | Hash Join | 825.96 | 766.06 | 7.3% | operator |
...
- **Input Features:**
  ...
  - total_cost=156338.5400
- **Output:** st=60.26, rt=766.06

### Step 5: Node 31507 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31508, 31509
- **Input Features:**
