...
**Test Query:** Q19_138_seed_1123952247
...
```
Node 31507 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31508 (Gather) [consumed]
    Node 31509 (Aggregate) [consumed]
      Node 31510 (Hash Join) [consumed]
        Node 31511 (Seq Scan) - LEAF
        Node 31512 (Hash)
          Node 31513 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31507 | 31508, 31509, 31510 |
...
|------|------|--------|-----------|-----|--------|
| 31507 | Aggregate | 844.26 | 829.30 | 1.8% | pattern |
| 31511 | Seq Scan | 777.49 | 743.46 | 4.4% | operator |
| 31512 | Hash | 46.87 | 8.29 | 82.3% | operator |
| 31513 | Seq Scan | 46.78 | 23.76 | 49.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31513 (Seq Scan) - LEAF
...
### Step 2: Node 31511 (Seq Scan) - LEAF
...
### Step 4: Node 31507 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31508, 31509, 31510
- **Input Features:**
