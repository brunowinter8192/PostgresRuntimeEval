...
**Test Query:** Q18_38_seed_303549147
**Timestamp:** 2026-01-18 20:22:44
...
```
Node 30116 (Limit) - ROOT
  Node 30117 (Sort)
    Node 30118 (Aggregate)
      Node 30119 (Gather Merge)
        Node 30120 (Incremental Sort)
          Node 30121 (Nested Loop)
            Node 30122 (Merge Join)
              Node 30123 (Sort)
                Node 30124 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30125 (Seq Scan) [consumed] - LEAF
                  Node 30126 (Hash) [consumed]
                    Node 30127 (Aggregate)
                      Node 30128 (Index Scan) - LEAF
              Node 30129 (Sort)
                Node 30130 (Seq Scan) - LEAF
            Node 30131 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30124 | 30125, 30126 |
...
|------|------|--------|-----------|-----|--------|
| 30116 | Limit | 3078.47 | 1175.21 | 61.8% | operator |
| 30117 | Sort | 2960.24 | 1127.81 | 61.9% | operator |
| 30118 | Aggregate | 2960.20 | 1073.15 | 63.7% | operator |
| 30119 | Gather Merge | 2960.18 | 1073.95 | 63.7% | operator |
| 30120 | Incremental Sort | 2939.61 | 0.00 | 100.0% | operator |
| 30121 | Nested Loop | 2939.55 | 1111.34 | 62.2% | operator |
| 30122 | Merge Join | 2939.50 | 0.00 | 100.0% | operator |
| 30131 | Index Scan | 0.02 | 0.05 | 105.2% | operator |
| 30123 | Sort | 2868.36 | 1095.58 | 61.8% | operator |
| 30129 | Sort | 68.72 | 1074.66 | 1463.9% | operator |
| 30124 | Hash Join | 2868.34 | 471.07 | 83.6% | pattern |
| 30130 | Seq Scan | 54.58 | 18.25 | 66.6% | operator |
| 30127 | Aggregate | 2638.79 | 1073.15 | 59.3% | operator |
| 30128 | Index Scan | 2145.68 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30128 (Index Scan) - LEAF
...
### Step 3: Node 30124 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30125, 30126
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30130 (Seq Scan) - LEAF
...
### Step 7: Node 30122 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30131 (Index Scan) - LEAF
...
### Step 10: Node 30120 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30119 (Gather Merge)
