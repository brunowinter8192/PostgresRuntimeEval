...
**Test Query:** Q14_75_seed_607098294
...
```
Node 27274 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27275 (Gather) [consumed]
    Node 27276 (Aggregate) [consumed]
      Node 27277 (Hash Join)
        Node 27278 (Seq Scan) - LEAF
        Node 27279 (Hash)
          Node 27280 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27274 | 27275, 27276 |
...
|------|------|--------|-----------|-----|--------|
| 27274 | Aggregate | 805.71 | 848.33 | 5.3% | pattern |
| 27277 | Hash Join | 784.87 | 807.58 | 2.9% | operator |
| 27278 | Seq Scan | 731.90 | 758.43 | 3.6% | operator |
| 27279 | Hash | 45.48 | 9.38 | 79.4% | operator |
| 27280 | Seq Scan | 39.70 | 12.70 | 68.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27280 (Seq Scan) - LEAF
...
### Step 2: Node 27278 (Seq Scan) - LEAF
...
### Step 5: Node 27274 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27275, 27276
- **Input Features:**
