...
```
Node 27274 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27275 (Gather) [consumed]
    Node 27276 (Aggregate) [consumed]
      Node 27277 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27274 | 27275, 27276, 27277 |
...
|------|------|--------|-----------|-----|--------|
| 27274 | Aggregate | 805.71 | 857.11 | 6.4% | pattern |
...
### Step 4: Node 27274 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27275, 27276, 27277
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=13747
  - HashJoin_Outer_nt1=13747
  ...
  - HashJoin_Outer_total_cost=136642.7300
- **Output:** st=850.74, rt=857.11
