...
```
Node 25433 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25434 (Aggregate) [consumed]
    Node 25435 (Aggregate)
      Node 25436 (Hash Join) [PATTERN: 895c6e8c]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25433 | 25434, 25436, 25437, 25438 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25436 | 25433, 25434, 25437, 25438 |
...
|------|------|--------|-----------|-----|--------|
| 25433 | Sort | 934.07 | 1079.93 | 15.6% | pattern |
| 25435 | Aggregate | 927.94 | 999.55 | 7.7% | operator |
| 25436 | Hash Join | 722.61 | 470.31 | 34.9% | pattern |
| 25439 | Index Only Scan | 9.32 | 0.00 | 100.0% | operator |
...
### Step 2: Node 25436 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25433, 25434, 25437, 25438
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1484970
...
### Step 4: Node 25433 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25434, 25436, 25437, 25438
- **Input Features:**
