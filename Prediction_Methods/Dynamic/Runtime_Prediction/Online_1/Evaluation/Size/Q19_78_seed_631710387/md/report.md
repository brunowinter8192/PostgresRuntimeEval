...
```
Node 32095 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 32096 (Gather) [consumed]
    Node 32097 (Aggregate) [consumed]
      Node 32098 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 32095 | 32096, 32097 |
...
|------|------|--------|-----------|-----|--------|
| 32095 | Aggregate | 836.27 | 831.20 | 0.6% | pattern |
| 32098 | Hash Join | 816.26 | 766.06 | 6.2% | operator |
...
### Step 5: Node 32095 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 32096, 32097
- **Input Features:**
