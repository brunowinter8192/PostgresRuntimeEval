...
**Test Query:** Q19_78_seed_631710387
...
```
Node 32095 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 32096 (Gather) [consumed]
    Node 32097 (Aggregate) [consumed]
      Node 32098 (Hash Join) [consumed]
        Node 32099 (Seq Scan) - LEAF
        Node 32100 (Hash)
          Node 32101 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 32095 | 32096, 32097, 32098 |
...
|------|------|--------|-----------|-----|--------|
| 32095 | Aggregate | 836.27 | 829.29 | 0.8% | pattern |
| 32099 | Seq Scan | 770.23 | 743.46 | 3.5% | operator |
| 32100 | Hash | 44.25 | 8.29 | 81.3% | operator |
| 32101 | Seq Scan | 44.12 | 23.76 | 46.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 32101 (Seq Scan) - LEAF
...
### Step 2: Node 32099 (Seq Scan) - LEAF
...
### Step 4: Node 32095 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 32096, 32097, 32098
- **Input Features:**
