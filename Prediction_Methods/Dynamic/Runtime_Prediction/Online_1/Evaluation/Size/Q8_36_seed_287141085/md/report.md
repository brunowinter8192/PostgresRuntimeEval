...
```
Node 15018 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 15019 (Gather Merge) [consumed]
    Node 15020 (Sort)
          ...
          Node 15023 (Hash Join)
            Node 15024 (Nested Loop)
              Node 15025 (Hash Join)
                ...
                Node 15027 (Hash) [PATTERN: 444761fb]
                  Node 15028 (Hash Join) [consumed]
                    Node 15029 (Seq Scan) [consumed] - LEAF
                    Node 15030 (Hash) [consumed]
                      Node 15031 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 15027 | 15018, 15019, 15028, 15029, 15030, 15031 |
| Aggregate -> Gather Merge (Out | 2724c080 | 15018 | 15019, 15027, 15028, 15029, 15030, 15031 |
...
|------|------|--------|-----------|-----|--------|
| 15018 | Aggregate | 1251.27 | 1133.68 | 9.4% | pattern |
...
| 15025 | Hash Join | 215.01 | 251.67 | 17.1% | operator |
...
| 15027 | Hash | 32.45 | 43.51 | 34.1% | pattern |
...
### Step 4: Node 15026 (Seq Scan) - LEAF
...
### Step 5: Node 15027 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 15018, 15019, 15028, 15029, 15030, 15031
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 15035 (Index Scan) - LEAF
...
### Step 8: Node 15037 (Seq Scan) - LEAF
...
### Step 12: Node 15038 (Index Scan) - LEAF
...
### Step 13: Node 15040 (Seq Scan) - LEAF
...
### Step 14: Node 15022 (Nested Loop)
...
### Step 18: Node 15018 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 15019, 15027, 15028, 15029, 15030, 15031
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2358
  - Aggregate_nt1=2358
  ...
  - Aggregate_startup_cost=71543.8700
  - Aggregate_total_cost=71917.1600
  - GatherMerge_Outer_np=0
  - GatherMerge_Outer_nt=2358
  - GatherMerge_Outer_nt1=761
  ...
  - GatherMerge_Outer_startup_cost=71543.8700
  - GatherMerge_Outer_total_cost=71822.8400
