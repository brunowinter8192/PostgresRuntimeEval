...
**Test Query:** Q5_85_seed_689138604
...
```
Node 9561 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 9562 (Aggregate) [consumed]
    Node 9563 (Gather Merge) [consumed]
      Node 9564 (Aggregate)
        Node 9565 (Sort) [PATTERN: 3e2d5a00]
          Node 9566 (Hash Join) [consumed]
            Node 9567 (Nested Loop)
              Node 9568 (Hash Join)
                Node 9569 (Seq Scan) - LEAF
                Node 9570 (Hash) [PATTERN: 444761fb]
                  Node 9571 (Hash Join) [consumed]
                    Node 9572 (Seq Scan) [consumed] - LEAF
                    Node 9573 (Hash) [consumed]
                      Node 9574 (Hash Join) [consumed]
                        Node 9575 (Seq Scan) - LEAF
                        Node 9576 (Hash)
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 9570 | 9561, 9562, 9563, 9565, 9566, 9571, 9572, 9573, 9574 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 9561 | 9562, 9563, 9565, 9566, 9570, 9571, 9572, 9573, 9574 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 9565 | 9561, 9562, 9563, 9566, 9570, 9571, 9572, 9573, 9574 |
...
|------|------|--------|-----------|-----|--------|
| 9561 | Sort | 1072.15 | 2934.42 | 173.7% | pattern |
| 9564 | Aggregate | 1067.20 | 1128.78 | 5.8% | operator |
| 9565 | Sort | 1066.94 | 1835.92 | 72.1% | pattern |
| 9567 | Nested Loop | 1055.28 | 1188.42 | 12.6% | operator |
| 9579 | Hash | 3.14 | 18.67 | 495.0% | operator |
| 9568 | Hash Join | 211.89 | 253.07 | 19.4% | operator |
| 9578 | Index Scan | 0.07 | -0.22 | 393.4% | operator |
| 9580 | Seq Scan | 2.62 | 12.36 | 372.3% | operator |
| 9569 | Seq Scan | 166.49 | 159.81 | 4.0% | operator |
| 9570 | Hash | 31.89 | 46.85 | 46.9% | pattern |
| 9575 | Seq Scan | 0.01 | 11.81 | 107247.9% | operator |
| 9576 | Hash | 0.10 | 21.05 | 21165.9% | operator |
| 9577 | Seq Scan | 0.10 | 22.93 | 23542.6% | operator |
...
### Step 2: Node 9575 (Seq Scan) - LEAF
...
### Step 4: Node 9569 (Seq Scan) - LEAF
...
### Step 5: Node 9570 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 9561, 9562, 9563, 9565, 9566, 9571, 9572, 9573, 9574
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 9578 (Index Scan) - LEAF
...
### Step 8: Node 9580 (Seq Scan) - LEAF
...
### Step 11: Node 9565 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 9561, 9562, 9563, 9566, 9570, 9571, 9572, 9573, 9574
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 9561 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 9562, 9563, 9565, 9566, 9570, 9571, 9572, 9573, 9574
- **Input Features:**
