...
```
Node 31787 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31788 (Gather) [consumed]
    Node 31789 (Aggregate) [consumed]
      Node 31790 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31787 | 31788, 31789 |
...
|------|------|--------|-----------|-----|--------|
| 31787 | Aggregate | 845.03 | 831.20 | 1.6% | pattern |
| 31790 | Hash Join | 824.44 | 766.05 | 7.1% | operator |
...
### Step 5: Node 31787 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31788, 31789
- **Input Features:**
