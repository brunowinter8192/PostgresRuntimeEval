...
**Test Query:** Q19_38_seed_303549147
...
```
Node 31787 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31788 (Gather) [consumed]
    Node 31789 (Aggregate) [consumed]
      Node 31790 (Hash Join) [consumed]
        Node 31791 (Seq Scan) - LEAF
        Node 31792 (Hash)
          Node 31793 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31787 | 31788, 31789, 31790 |
...
|------|------|--------|-----------|-----|--------|
| 31787 | Aggregate | 845.03 | 829.28 | 1.9% | pattern |
| 31791 | Seq Scan | 778.42 | 743.46 | 4.5% | operator |
| 31792 | Hash | 44.50 | 8.29 | 81.4% | operator |
| 31793 | Seq Scan | 44.43 | 23.76 | 46.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31793 (Seq Scan) - LEAF
...
### Step 2: Node 31791 (Seq Scan) - LEAF
...
### Step 4: Node 31787 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31788, 31789, 31790
- **Input Features:**
