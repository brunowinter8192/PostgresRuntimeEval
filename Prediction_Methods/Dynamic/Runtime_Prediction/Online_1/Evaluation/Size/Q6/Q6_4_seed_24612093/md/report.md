...
```
Node 10277 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10278 (Gather) [consumed]
    Node 10279 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10277 | 10278, 10279 |
...
|------|------|--------|-----------|-----|--------|
| 10277 | Aggregate | 793.64 | 850.00 | 7.1% | pattern |
| 10280 | Seq Scan | 774.08 | 748.50 | 3.3% | operator |
...
### Step 2: Node 10277 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10278, 10279
- **Input Features:**
