...
**Test Query:** Q6_40_seed_319957209
...
```
Node 10237 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10238 (Gather) [consumed]
    Node 10239 (Aggregate) [consumed]
      Node 10240 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10237 | 10238, 10239 |
...
|------|------|--------|-----------|-----|--------|
| 10237 | Aggregate | 786.27 | 849.98 | 8.1% | pattern |
| 10240 | Seq Scan | 766.65 | 748.49 | 2.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10240 (Seq Scan) - LEAF
...
### Step 2: Node 10237 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10238, 10239
- **Input Features:**
