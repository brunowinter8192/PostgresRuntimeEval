...
**Test Query:** Q6_137_seed_1115748216
...
```
Node 10061 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10062 (Gather) [consumed]
    Node 10063 (Aggregate) [consumed]
      Node 10064 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10061 | 10062, 10063 |
...
|------|------|--------|-----------|-----|--------|
| 10061 | Aggregate | 813.75 | 850.06 | 4.5% | pattern |
| 10064 | Seq Scan | 794.55 | 748.54 | 5.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10064 (Seq Scan) - LEAF
...
### Step 2: Node 10061 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10062, 10063
- **Input Features:**
