...
**Test Query:** Q6_131_seed_1066524030
...
```
Node 10037 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10038 (Gather) [consumed]
    Node 10039 (Aggregate) [consumed]
      Node 10040 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10037 | 10038, 10039 |
...
|------|------|--------|-----------|-----|--------|
| 10037 | Aggregate | 794.15 | 849.99 | 7.0% | pattern |
| 10040 | Seq Scan | 774.74 | 748.50 | 3.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10040 (Seq Scan) - LEAF
...
### Step 2: Node 10037 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10038, 10039
- **Input Features:**
