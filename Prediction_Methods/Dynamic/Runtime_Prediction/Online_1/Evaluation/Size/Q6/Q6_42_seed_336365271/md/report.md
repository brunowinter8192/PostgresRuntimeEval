...
**Test Query:** Q6_42_seed_336365271
...
```
Node 10245 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10246 (Gather) [consumed]
    Node 10247 (Aggregate) [consumed]
      Node 10248 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10245 | 10246, 10247 |
...
|------|------|--------|-----------|-----|--------|
| 10245 | Aggregate | 800.62 | 850.05 | 6.2% | pattern |
| 10248 | Seq Scan | 779.23 | 748.53 | 3.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10248 (Seq Scan) - LEAF
...
### Step 2: Node 10245 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10246, 10247
- **Input Features:**
