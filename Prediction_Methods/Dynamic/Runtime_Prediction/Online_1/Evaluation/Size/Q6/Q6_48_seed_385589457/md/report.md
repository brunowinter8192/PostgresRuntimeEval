...
**Test Query:** Q6_48_seed_385589457
...
```
Node 10269 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10270 (Gather) [consumed]
    Node 10271 (Aggregate) [consumed]
      Node 10272 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10269 | 10270, 10271 |
...
|------|------|--------|-----------|-----|--------|
| 10269 | Aggregate | 798.03 | 849.98 | 6.5% | pattern |
| 10272 | Seq Scan | 776.52 | 748.49 | 3.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10272 (Seq Scan) - LEAF
...
### Step 2: Node 10269 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10270, 10271
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=22611
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=32
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=139718.5200
  - Aggregate_Outer_total_cost=139718.5400
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=140719.0600
  - Aggregate_total_cost=140719.0700
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=140718.5200
  - Gather_Outer_total_cost=140719.0400
