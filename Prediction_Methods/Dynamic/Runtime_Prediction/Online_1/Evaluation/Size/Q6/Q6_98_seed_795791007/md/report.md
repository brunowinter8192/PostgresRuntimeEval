...
**Test Query:** Q6_98_seed_795791007
...
```
Node 10489 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10490 (Gather) [consumed]
    Node 10491 (Aggregate) [consumed]
      Node 10492 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10489 | 10490, 10491 |
...
|------|------|--------|-----------|-----|--------|
| 10489 | Aggregate | 772.05 | 850.07 | 10.1% | pattern |
| 10492 | Seq Scan | 749.54 | 748.55 | 0.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10492 (Seq Scan) - LEAF
...
### Step 2: Node 10489 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10490, 10491
- **Input Features:**
