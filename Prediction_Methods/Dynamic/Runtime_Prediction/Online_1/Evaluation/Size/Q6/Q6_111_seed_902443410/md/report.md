...
**Test Query:** Q6_111_seed_902443410
...
```
Node 9949 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 9950 (Gather) [consumed]
    Node 9951 (Aggregate) [consumed]
      Node 9952 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 9949 | 9950, 9951 |
...
|------|------|--------|-----------|-----|--------|
| 9949 | Aggregate | 761.22 | 850.06 | 11.7% | pattern |
| 9952 | Seq Scan | 741.05 | 748.54 | 1.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 9952 (Seq Scan) - LEAF
...
### Step 2: Node 9949 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 9950, 9951
- **Input Features:**
