...
**Test Query:** Q6_142_seed_1156768371
...
```
Node 10085 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10086 (Gather) [consumed]
    Node 10087 (Aggregate) [consumed]
      Node 10088 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10085 | 10086, 10087 |
...
|------|------|--------|-----------|-----|--------|
| 10085 | Aggregate | 783.10 | 850.06 | 8.6% | pattern |
| 10088 | Seq Scan | 762.56 | 748.54 | 1.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10088 (Seq Scan) - LEAF
...
### Step 2: Node 10085 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10086, 10087
- **Input Features:**
