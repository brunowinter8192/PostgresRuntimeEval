...
**Test Query:** Q6_56_seed_451221705
...
```
Node 10305 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10306 (Gather) [consumed]
    Node 10307 (Aggregate) [consumed]
      Node 10308 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10305 | 10306, 10307 |
...
|------|------|--------|-----------|-----|--------|
| 10305 | Aggregate | 787.61 | 849.99 | 7.9% | pattern |
| 10308 | Seq Scan | 766.20 | 748.50 | 2.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10308 (Seq Scan) - LEAF
...
### Step 2: Node 10305 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10306, 10307
- **Input Features:**
