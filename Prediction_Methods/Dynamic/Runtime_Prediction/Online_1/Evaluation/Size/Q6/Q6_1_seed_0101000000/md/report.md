...
**Test Query:** Q6_1_seed_0101000000
...
```
Node 10145 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10146 (Gather) [consumed]
    Node 10147 (Aggregate) [consumed]
      Node 10148 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10145 | 10146, 10147 |
...
|------|------|--------|-----------|-----|--------|
| 10145 | Aggregate | 759.48 | 850.06 | 11.9% | pattern |
| 10148 | Seq Scan | 738.88 | 748.54 | 1.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10148 (Seq Scan) - LEAF
...
### Step 2: Node 10145 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10146, 10147
- **Input Features:**
