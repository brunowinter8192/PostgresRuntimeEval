...
**Test Query:** Q6_12_seed_90244341
...
```
Node 10029 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10030 (Gather) [consumed]
    Node 10031 (Aggregate) [consumed]
      Node 10032 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10029 | 10030, 10031 |
...
|------|------|--------|-----------|-----|--------|
| 10029 | Aggregate | 815.23 | 849.99 | 4.3% | pattern |
| 10032 | Seq Scan | 795.19 | 748.50 | 5.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10032 (Seq Scan) - LEAF
...
### Step 2: Node 10029 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10030, 10031
- **Input Features:**
