...
**Test Query:** Q6_34_seed_270733023
...
```
Node 10209 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10210 (Gather) [consumed]
    Node 10211 (Aggregate) [consumed]
      Node 10212 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10209 | 10210, 10211 |
...
|------|------|--------|-----------|-----|--------|
| 10209 | Aggregate | 816.10 | 849.98 | 4.2% | pattern |
| 10212 | Seq Scan | 796.50 | 748.49 | 6.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10212 (Seq Scan) - LEAF
...
### Step 2: Node 10209 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10210, 10211
- **Input Features:**
