...
**Test Query:** Q6_61_seed_492241860
...
```
Node 10329 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10330 (Gather) [consumed]
    Node 10331 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10329 | 10330, 10331 |
...
|------|------|--------|-----------|-----|--------|
| 10329 | Aggregate | 780.93 | 849.98 | 8.8% | pattern |
| 10332 | Seq Scan | 758.67 | 748.49 | 1.3% | operator |
...
### Step 2: Node 10329 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10330, 10331
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=22648
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=32
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=139718.7100
  - Aggregate_Outer_total_cost=139718.7200
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=140719.2500
  - Aggregate_total_cost=140719.2600
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=140718.7100
  - Gather_Outer_total_cost=140719.2200
