...
**Test Query:** Q6_148_seed_1205992557
...
```
Node 10109 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10110 (Gather) [consumed]
    Node 10111 (Aggregate) [consumed]
      Node 10112 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10109 | 10110, 10111 |
...
|------|------|--------|-----------|-----|--------|
| 10109 | Aggregate | 788.70 | 849.98 | 7.8% | pattern |
| 10112 | Seq Scan | 768.41 | 748.49 | 2.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10112 (Seq Scan) - LEAF
...
### Step 2: Node 10109 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10110, 10111
- **Input Features:**
