...
**Test Query:** Q6_58_seed_467629767
...
```
Node 10313 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10314 (Gather) [consumed]
    Node 10315 (Aggregate) [consumed]
      Node 10316 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10313 | 10314, 10315 |
...
|------|------|--------|-----------|-----|--------|
| 10313 | Aggregate | 805.89 | 850.05 | 5.5% | pattern |
| 10316 | Seq Scan | 785.94 | 748.53 | 4.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10316 (Seq Scan) - LEAF
...
### Step 2: Node 10313 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10314, 10315
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=23652
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=32
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=139723.7300
  - Aggregate_Outer_total_cost=139723.7400
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=140724.2700
  - Aggregate_total_cost=140724.2800
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=140723.7300
  - Gather_Outer_total_cost=140724.2400
