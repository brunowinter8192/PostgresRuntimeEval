...
**Test Query:** Q6_140_seed_1140360309
...
```
Node 10077 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10078 (Gather) [consumed]
    Node 10079 (Aggregate) [consumed]
      Node 10080 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10077 | 10078, 10079 |
...
|------|------|--------|-----------|-----|--------|
| 10077 | Aggregate | 809.33 | 849.97 | 5.0% | pattern |
| 10080 | Seq Scan | 786.59 | 748.49 | 4.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10080 (Seq Scan) - LEAF
...
### Step 2: Node 10077 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10078, 10079
- **Input Features:**
