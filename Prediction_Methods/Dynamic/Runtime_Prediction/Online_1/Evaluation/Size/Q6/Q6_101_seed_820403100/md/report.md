...
**Test Query:** Q6_101_seed_820403100
...
```
Node 9905 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 9906 (Gather) [consumed]
    Node 9907 (Aggregate) [consumed]
      Node 9908 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 9905 | 9906, 9907 |
...
|------|------|--------|-----------|-----|--------|
| 9905 | Aggregate | 833.77 | 849.99 | 1.9% | pattern |
| 9908 | Seq Scan | 812.62 | 748.50 | 7.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 9908 (Seq Scan) - LEAF
...
### Step 2: Node 9905 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 9906, 9907
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=22773
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=32
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=139719.3300
  - Aggregate_Outer_total_cost=139719.3500
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=140719.8700
  - Aggregate_total_cost=140719.8800
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=140719.3300
  - Gather_Outer_total_cost=140719.8500
