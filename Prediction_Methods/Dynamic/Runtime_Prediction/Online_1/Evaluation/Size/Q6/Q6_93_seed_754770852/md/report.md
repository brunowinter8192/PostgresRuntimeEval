...
**Test Query:** Q6_93_seed_754770852
...
```
Node 10469 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10470 (Gather) [consumed]
    Node 10471 (Aggregate) [consumed]
      Node 10472 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10469 | 10470, 10471 |
...
|------|------|--------|-----------|-----|--------|
| 10469 | Aggregate | 802.47 | 850.06 | 5.9% | pattern |
| 10472 | Seq Scan | 780.78 | 748.54 | 4.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10472 (Seq Scan) - LEAF
...
### Step 2: Node 10469 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10470, 10471
- **Input Features:**
