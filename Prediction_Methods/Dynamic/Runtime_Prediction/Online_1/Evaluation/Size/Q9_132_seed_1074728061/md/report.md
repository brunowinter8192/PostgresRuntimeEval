...
**Test Query:** Q9_132_seed_1074728061
...
```
Node 17285 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 17286 (Aggregate) [consumed]
    Node 17287 (Gather)
      Node 17288 (Aggregate)
        Node 17289 (Nested Loop)
          Node 17290 (Hash Join) [PATTERN: bb930825]
            Node 17291 (Seq Scan) [consumed] - LEAF
            Node 17292 (Hash) [consumed]
              Node 17293 (Hash Join) [consumed]
                Node 17294 (Hash Join)
                  Node 17295 (Nested Loop)
                    Node 17296 (Seq Scan) - LEAF
                    Node 17297 (Index Scan) - LEAF
                  Node 17298 (Hash)
                    Node 17299 (Seq Scan) - LEAF
                Node 17300 (Hash)
                  Node 17301 (Seq Scan) - LEAF
          Node 17302 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17290 | 17285, 17286, 17291, 17292, 17293 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17285 | 17286, 17290, 17291, 17292, 17293 |
...
|------|------|--------|-----------|-----|--------|
| 17285 | Sort | 1191.69 | 1045.59 | 12.3% | pattern |
| 17287 | Gather | 1190.51 | 964.55 | 19.0% | operator |
| 17288 | Aggregate | 1169.83 | 1085.45 | 7.2% | operator |
| 17289 | Nested Loop | 1145.51 | 1252.17 | 9.3% | operator |
| 17290 | Hash Join | 974.04 | 134.80 | 86.2% | pattern |
| 17302 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17294 | Hash Join | 164.14 | 837.63 | 410.3% | operator |
| 17300 | Hash | 12.96 | 14.95 | 15.3% | operator |
| 17295 | Nested Loop | 158.08 | 1251.77 | 691.9% | operator |
| 17298 | Hash | 3.88 | 15.94 | 311.1% | operator |
| 17301 | Seq Scan | 12.95 | 2.94 | 77.3% | operator |
| 17296 | Seq Scan | 20.01 | 43.96 | 119.7% | operator |
| 17297 | Index Scan | 0.08 | -1.39 | 1927.0% | operator |
| 17299 | Seq Scan | 3.36 | 9.45 | 180.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 17296 (Seq Scan) - LEAF
...
### Step 2: Node 17297 (Index Scan) - LEAF
...
### Step 3: Node 17299 (Seq Scan) - LEAF
...
### Step 6: Node 17301 (Seq Scan) - LEAF
...
### Step 9: Node 17290 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17285, 17286, 17291, 17292, 17293
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17302 (Index Scan) - LEAF
...
### Step 11: Node 17289 (Nested Loop)
...
### Step 14: Node 17285 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17286, 17290, 17291, 17292, 17293
- **Input Features:**
