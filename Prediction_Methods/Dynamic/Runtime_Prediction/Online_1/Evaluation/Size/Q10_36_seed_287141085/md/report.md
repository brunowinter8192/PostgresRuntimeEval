    ...
    Node 20399 (Aggregate) [consumed]
      Node 20400 (Gather) [consumed]
        Node 20401 (Hash Join)
          Node 20402 (Hash Join) [PATTERN: 2e0f44ef]
            Node 20403 (Nested Loop) [consumed]
              Node 20404 (Seq Scan) - LEAF
              Node 20405 (Index Scan) - LEAF
            Node 20406 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20397 | 20398, 20399, 20400, 20402, 20403, 20406 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 20402 | 20397, 20398, 20399, 20400, 20403, 20406 |
...
| 20401 | Hash Join | 1196.74 | 1095.57 | 8.5% | operator |
| 20402 | Hash Join | 1193.89 | 1120.19 | 6.2% | pattern |
...
### Step 4: Node 20409 (Seq Scan) - LEAF
...
### Step 5: Node 20402 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 20397, 20398, 20399, 20400, 20403, 20406
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18240
  - HashJoin_nt1=18240
...
### Step 8: Node 20397 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20398, 20399, 20400, 20402, 20403, 20406
- **Input Features:**
