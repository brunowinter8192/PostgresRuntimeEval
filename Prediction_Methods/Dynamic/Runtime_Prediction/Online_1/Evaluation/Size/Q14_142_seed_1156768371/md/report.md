...
**Test Query:** Q14_142_seed_1156768371
...
```
Node 26742 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26743 (Gather) [consumed]
    Node 26744 (Aggregate) [consumed]
      Node 26745 (Hash Join) [consumed]
        Node 26746 (Seq Scan) - LEAF
        Node 26747 (Hash)
          Node 26748 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26742 | 26743, 26744, 26745 |
...
|------|------|--------|-----------|-----|--------|
| 26742 | Aggregate | 827.80 | 857.13 | 3.5% | pattern |
| 26746 | Seq Scan | 751.93 | 758.50 | 0.9% | operator |
| 26747 | Hash | 42.72 | 9.38 | 78.0% | operator |
| 26748 | Seq Scan | 38.38 | 12.70 | 66.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26748 (Seq Scan) - LEAF
...
### Step 2: Node 26746 (Seq Scan) - LEAF
...
### Step 4: Node 26742 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26743, 26744, 26745
- **Input Features:**
