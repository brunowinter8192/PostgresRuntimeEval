...
**Test Query:** Q1_149_seed_1214196588
...
```
Node 266 (Aggregate) - ROOT
  Node 267 (Gather Merge)
    Node 268 (Sort) [PATTERN: 1d35fb97]
      Node 269 (Aggregate) [consumed]
        Node 270 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 268 | 269 |
...
|------|------|--------|-----------|-----|--------|
| 266 | Aggregate | 928.15 | 1195.88 | 28.8% | operator |
| 267 | Gather Merge | 928.10 | 1165.90 | 25.6% | operator |
| 268 | Sort | 904.76 | 1200.49 | 32.7% | pattern |
| 270 | Seq Scan | 504.44 | 680.30 | 34.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 270 (Seq Scan) - LEAF
...
### Step 2: Node 268 (Sort) - PATTERN ROOT
...
### Step 4: Node 266 (Aggregate) - ROOT
