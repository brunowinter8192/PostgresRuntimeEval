...
```
Node 27365 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27366 (Gather) [consumed]
    Node 27367 (Aggregate) [consumed]
      Node 27368 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27365 | 27366, 27367, 27368 |
...
|------|------|--------|-----------|-----|--------|
| 27365 | Aggregate | 816.38 | 857.14 | 5.0% | pattern |
...
### Step 4: Node 27365 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27366, 27367, 27368
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=15810
  - HashJoin_Outer_nt1=15810
  ...
  - HashJoin_Outer_total_cost=136648.1400
