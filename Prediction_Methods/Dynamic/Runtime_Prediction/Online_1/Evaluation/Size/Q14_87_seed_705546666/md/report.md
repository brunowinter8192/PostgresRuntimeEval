...
**Test Query:** Q14_87_seed_705546666
...
```
Node 27365 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27366 (Gather) [consumed]
    Node 27367 (Aggregate) [consumed]
      Node 27368 (Hash Join)
        Node 27369 (Seq Scan) - LEAF
        Node 27370 (Hash)
          Node 27371 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27365 | 27366, 27367 |
...
|------|------|--------|-----------|-----|--------|
| 27365 | Aggregate | 816.38 | 848.38 | 3.9% | pattern |
| 27368 | Hash Join | 791.59 | 807.67 | 2.0% | operator |
| 27369 | Seq Scan | 742.79 | 758.51 | 2.1% | operator |
| 27370 | Hash | 40.83 | 9.38 | 77.0% | operator |
| 27371 | Seq Scan | 35.35 | 12.70 | 64.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27371 (Seq Scan) - LEAF
...
### Step 2: Node 27369 (Seq Scan) - LEAF
...
### Step 5: Node 27365 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27366, 27367
- **Input Features:**
