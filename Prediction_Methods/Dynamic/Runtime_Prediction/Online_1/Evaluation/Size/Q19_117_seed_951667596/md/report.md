...
```
Node 31346 (Aggregate) [PATTERN: efde8b38] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31346 | 31347, 31348, 31349 |
...
|------|------|--------|-----------|-----|--------|
| 31346 | Aggregate | 832.92 | 829.29 | 0.4% | pattern |
| 31350 | Seq Scan | 765.18 | 743.46 | 2.8% | operator |
| 31351 | Hash | 45.46 | 8.29 | 81.8% | operator |
| 31352 | Seq Scan | 45.39 | 23.76 | 47.6% | operator |
...
### Step 4: Node 31346 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31347, 31348, 31349
- **Input Features:**
