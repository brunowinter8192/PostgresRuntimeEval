...
**Test Query:** Q5_88_seed_713750697
...
```
Node 9621 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 9622 (Aggregate) [consumed]
    Node 9623 (Gather Merge) [consumed]
      Node 9624 (Aggregate)
        Node 9625 (Sort) [PATTERN: 3e2d5a00]
          Node 9626 (Hash Join) [consumed]
            Node 9627 (Nested Loop)
              Node 9628 (Hash Join)
                Node 9629 (Seq Scan) - LEAF
                Node 9630 (Hash) [PATTERN: 444761fb]
                  Node 9631 (Hash Join) [consumed]
                    Node 9632 (Seq Scan) [consumed] - LEAF
                    Node 9633 (Hash) [consumed]
                      Node 9634 (Hash Join) [consumed]
                        Node 9635 (Seq Scan) - LEAF
                        Node 9636 (Hash)
                          Node 9637 (Seq Scan) - LEAF
              Node 9638 (Index Scan) - LEAF
            Node 9639 (Hash)
              Node 9640 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 9630 | 9621, 9622, 9623, 9625, 9626, 9631, 9632, 9633, 9634 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 9621 | 9622, 9623, 9625, 9626, 9630, 9631, 9632, 9633, 9634 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 9625 | 9621, 9622, 9623, 9626, 9630, 9631, 9632, 9633, 9634 |
...
|------|------|--------|-----------|-----|--------|
| 9621 | Sort | 1056.46 | 2934.42 | 177.8% | pattern |
| 9624 | Aggregate | 1050.20 | 1128.74 | 7.5% | operator |
| 9625 | Sort | 1049.44 | 1835.96 | 74.9% | pattern |
| 9627 | Nested Loop | 1037.86 | 1188.57 | 14.5% | operator |
| 9639 | Hash | 3.09 | 18.67 | 503.7% | operator |
| 9628 | Hash Join | 211.69 | 253.07 | 19.5% | operator |
| 9638 | Index Scan | 0.07 | -0.22 | 401.4% | operator |
| 9640 | Seq Scan | 2.43 | 12.36 | 408.6% | operator |
| 9629 | Seq Scan | 164.28 | 159.81 | 2.7% | operator |
| 9630 | Hash | 34.84 | 46.85 | 34.5% | pattern |
| 9635 | Seq Scan | 0.01 | 11.81 | 147503.4% | operator |
| 9636 | Hash | 0.08 | 21.05 | 25574.7% | operator |
| 9637 | Seq Scan | 0.08 | 22.93 | 28566.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 9637 (Seq Scan) - LEAF
...
### Step 2: Node 9635 (Seq Scan) - LEAF
...
### Step 4: Node 9629 (Seq Scan) - LEAF
...
### Step 5: Node 9630 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 9621, 9622, 9623, 9625, 9626, 9631, 9632, 9633, 9634
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 9638 (Index Scan) - LEAF
...
### Step 8: Node 9640 (Seq Scan) - LEAF
...
### Step 11: Node 9625 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 9621, 9622, 9623, 9626, 9630, 9631, 9632, 9633, 9634
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 9621 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 9622, 9623, 9625, 9626, 9630, 9631, 9632, 9633, 9634
- **Input Features:**
