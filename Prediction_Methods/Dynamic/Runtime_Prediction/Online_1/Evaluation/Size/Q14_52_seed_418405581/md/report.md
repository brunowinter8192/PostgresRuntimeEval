...
```
Node 27099 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27100 (Gather) [consumed]
    Node 27101 (Aggregate) [consumed]
      Node 27102 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27099 | 27100, 27101 |
...
|------|------|--------|-----------|-----|--------|
| 27099 | Aggregate | 803.99 | 848.37 | 5.5% | pattern |
| 27102 | Hash Join | 778.33 | 807.66 | 3.8% | operator |
...
### Step 5: Node 27099 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27100, 27101
- **Input Features:**
