...
**Test Query:** Q14_52_seed_418405581
...
```
Node 27099 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27100 (Gather) [consumed]
    Node 27101 (Aggregate) [consumed]
      Node 27102 (Hash Join) [consumed]
        Node 27103 (Seq Scan) - LEAF
        Node 27104 (Hash)
          Node 27105 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27099 | 27100, 27101, 27102 |
...
|------|------|--------|-----------|-----|--------|
| 27099 | Aggregate | 803.99 | 857.13 | 6.6% | pattern |
| 27103 | Seq Scan | 725.14 | 758.50 | 4.6% | operator |
| 27104 | Hash | 45.75 | 9.38 | 79.5% | operator |
| 27105 | Seq Scan | 39.45 | 12.70 | 67.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27105 (Seq Scan) - LEAF
...
### Step 2: Node 27103 (Seq Scan) - LEAF
...
### Step 4: Node 27099 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27100, 27101, 27102
- **Input Features:**
