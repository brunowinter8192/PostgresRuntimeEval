...
```
Node 16832 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 16833 (Aggregate) [consumed]
    Node 16834 (Gather)
      Node 16835 (Aggregate)
        Node 16836 (Nested Loop)
          Node 16837 (Hash Join) [PATTERN: bb930825]
            Node 16838 (Seq Scan) [consumed] - LEAF
            Node 16839 (Hash) [consumed]
              Node 16840 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 16837 | 16832, 16833, 16838, 16839, 16840 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 16832 | 16833, 16837, 16838, 16839, 16840 |
...
|------|------|--------|-----------|-----|--------|
| 16832 | Sort | 1192.77 | 1054.66 | 11.6% | pattern |
...
| 16837 | Hash Join | 976.94 | 134.80 | 86.2% | pattern |
...
### Step 9: Node 16837 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 16832, 16833, 16838, 16839, 16840
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 16849 (Index Scan) - LEAF
...
### Step 11: Node 16836 (Nested Loop)
...
### Step 14: Node 16832 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 16833, 16837, 16838, 16839, 16840
- **Input Features:**
