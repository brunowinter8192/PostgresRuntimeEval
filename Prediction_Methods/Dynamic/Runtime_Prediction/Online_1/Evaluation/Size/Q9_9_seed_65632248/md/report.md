...
```
Node 19352 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 19353 (Aggregate) [consumed]
    Node 19354 (Gather)
      Node 19355 (Aggregate)
        Node 19356 (Nested Loop)
          Node 19357 (Hash Join) [PATTERN: bb930825]
            Node 19358 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 19357 | 19352, 19353, 19358, 19359, 19360 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 19352 | 19353, 19357, 19358, 19359, 19360 |
...
|------|------|--------|-----------|-----|--------|
| 19352 | Sort | 1199.19 | 1045.06 | 12.9% | pattern |
...
| 19357 | Hash Join | 972.64 | 134.80 | 86.1% | pattern |
...
### Step 9: Node 19357 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 19352, 19353, 19358, 19359, 19360
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 19369 (Index Scan) - LEAF
...
### Step 11: Node 19356 (Nested Loop)
...
### Step 14: Node 19352 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 19353, 19357, 19358, 19359, 19360
- **Input Features:**
