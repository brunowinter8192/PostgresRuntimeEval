...
```
Node 27260 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27261 (Gather) [consumed]
    Node 27262 (Aggregate) [consumed]
      Node 27263 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27260 | 27261, 27262, 27263 |
...
|------|------|--------|-----------|-----|--------|
| 27260 | Aggregate | 832.18 | 857.13 | 3.0% | pattern |
...
### Step 4: Node 27260 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27261, 27262, 27263
- **Input Features:**
