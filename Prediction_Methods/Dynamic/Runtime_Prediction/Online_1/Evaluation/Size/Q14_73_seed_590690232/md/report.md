...
**Test Query:** Q14_73_seed_590690232
...
```
Node 27260 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27261 (Gather) [consumed]
    Node 27262 (Aggregate) [consumed]
      Node 27263 (Hash Join)
        Node 27264 (Seq Scan) - LEAF
        Node 27265 (Hash)
          Node 27266 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27260 | 27261, 27262 |
...
|------|------|--------|-----------|-----|--------|
| 27260 | Aggregate | 832.18 | 848.36 | 1.9% | pattern |
| 27263 | Hash Join | 808.41 | 807.64 | 0.1% | operator |
| 27264 | Seq Scan | 757.66 | 758.48 | 0.1% | operator |
| 27265 | Hash | 42.81 | 9.38 | 78.1% | operator |
| 27266 | Seq Scan | 38.78 | 12.70 | 67.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27266 (Seq Scan) - LEAF
...
### Step 2: Node 27264 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=136646.1400
- **Output:** st=78.56, rt=807.64

### Step 5: Node 27260 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27261, 27262
- **Input Features:**
