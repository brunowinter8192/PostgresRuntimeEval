...
```
Node 27225 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27226 (Gather) [consumed]
    Node 27227 (Aggregate) [consumed]
      Node 27228 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27225 | 27226, 27227, 27228 |
...
|------|------|--------|-----------|-----|--------|
| 27225 | Aggregate | 818.71 | 857.14 | 4.7% | pattern |
...
### Step 4: Node 27225 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27226, 27227, 27228
- **Input Features:**
