...
**Test Query:** Q14_19_seed_147672558
...
```
Node 26840 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26841 (Gather) [consumed]
    Node 26842 (Aggregate) [consumed]
      Node 26843 (Hash Join)
        Node 26844 (Seq Scan) - LEAF
        Node 26845 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26840 | 26841, 26842 |
...
|------|------|--------|-----------|-----|--------|
| 26840 | Aggregate | 808.06 | 848.38 | 5.0% | pattern |
| 26843 | Hash Join | 785.51 | 807.67 | 2.8% | operator |
| 26844 | Seq Scan | 736.76 | 758.51 | 3.0% | operator |
| 26845 | Hash | 40.90 | 9.38 | 77.1% | operator |
| 26846 | Seq Scan | 36.64 | 12.70 | 65.3% | operator |
...
### Step 2: Node 26844 (Seq Scan) - LEAF
...
### Step 5: Node 26840 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26841, 26842
- **Input Features:**
