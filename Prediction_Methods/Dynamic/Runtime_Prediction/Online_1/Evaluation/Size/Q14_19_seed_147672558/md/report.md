...
```
Node 26840 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26841 (Gather) [consumed]
    Node 26842 (Aggregate) [consumed]
      Node 26843 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26840 | 26841, 26842, 26843 |
...
|------|------|--------|-----------|-----|--------|
| 26840 | Aggregate | 808.06 | 857.14 | 6.1% | pattern |
...
### Step 4: Node 26840 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26841, 26842, 26843
- **Input Features:**
