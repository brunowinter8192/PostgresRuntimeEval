...
```
Node 32200 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 32201 (Gather) [consumed]
    Node 32202 (Aggregate) [consumed]
      Node 32203 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 32200 | 32201, 32202 |
...
|------|------|--------|-----------|-----|--------|
| 32200 | Aggregate | 862.44 | 831.20 | 3.6% | pattern |
| 32203 | Hash Join | 841.84 | 766.06 | 9.0% | operator |
...
### Step 5: Node 32200 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 32201, 32202
- **Input Features:**
