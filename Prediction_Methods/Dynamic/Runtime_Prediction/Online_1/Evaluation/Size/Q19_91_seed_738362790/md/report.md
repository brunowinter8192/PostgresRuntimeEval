...
**Test Query:** Q19_91_seed_738362790
...
```
Node 32200 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 32201 (Gather) [consumed]
    Node 32202 (Aggregate) [consumed]
      Node 32203 (Hash Join) [consumed]
        Node 32204 (Seq Scan) - LEAF
        Node 32205 (Hash)
          Node 32206 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 32200 | 32201, 32202, 32203 |
...
|------|------|--------|-----------|-----|--------|
| 32200 | Aggregate | 862.44 | 829.30 | 3.8% | pattern |
| 32204 | Seq Scan | 793.62 | 743.46 | 6.3% | operator |
| 32205 | Hash | 45.81 | 8.29 | 81.9% | operator |
| 32206 | Seq Scan | 45.66 | 23.76 | 48.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 32206 (Seq Scan) - LEAF
...
### Step 2: Node 32204 (Seq Scan) - LEAF
...
### Step 4: Node 32200 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 32201, 32202, 32203
- **Input Features:**
  ...
  - HashJoin_Outer_total_cost=156338.5600
