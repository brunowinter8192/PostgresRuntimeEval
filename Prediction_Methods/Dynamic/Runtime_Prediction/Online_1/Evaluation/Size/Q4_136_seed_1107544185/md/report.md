...
**Test Query:** Q4_136_seed_1107544185
...
```
Node 6124 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6125 (Gather Merge) [consumed]
    Node 6126 (Sort) [consumed]
      Node 6127 (Aggregate) [consumed]
        Node 6128 (Nested Loop)
          Node 6129 (Seq Scan) - LEAF
          Node 6130 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6124 | 6125, 6126, 6127 |
...
|------|------|--------|-----------|-----|--------|
| 6124 | Aggregate | 1059.89 | 952.19 | 10.2% | pattern |
| 6128 | Nested Loop | 1053.67 | 1255.45 | 19.1% | operator |
| 6129 | Seq Scan | 164.21 | 154.66 | 5.8% | operator |
| 6130 | Index Scan | 0.06 | 11.10 | 18103.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6129 (Seq Scan) - LEAF
...
### Step 2: Node 6130 (Index Scan) - LEAF
