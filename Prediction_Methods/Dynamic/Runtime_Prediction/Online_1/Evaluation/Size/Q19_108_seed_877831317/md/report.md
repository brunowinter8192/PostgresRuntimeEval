...
**Test Query:** Q19_108_seed_877831317
...
```
Node 31276 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31277 (Gather) [consumed]
    Node 31278 (Aggregate) [consumed]
      Node 31279 (Hash Join) [consumed]
        Node 31280 (Seq Scan) - LEAF
        Node 31281 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31276 | 31277, 31278, 31279 |
...
|------|------|--------|-----------|-----|--------|
| 31276 | Aggregate | 826.91 | 829.33 | 0.3% | pattern |
| 31280 | Seq Scan | 759.93 | 743.46 | 2.2% | operator |
| 31281 | Hash | 47.13 | 8.29 | 82.4% | operator |
| 31282 | Seq Scan | 46.97 | 23.76 | 49.4% | operator |
...
### Step 2: Node 31280 (Seq Scan) - LEAF
...
### Step 4: Node 31276 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31277, 31278, 31279
- **Input Features:**
