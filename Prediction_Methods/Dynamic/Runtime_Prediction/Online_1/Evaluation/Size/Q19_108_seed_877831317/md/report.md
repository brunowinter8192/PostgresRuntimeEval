...
```
Node 31276 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31277 (Gather) [consumed]
    Node 31278 (Aggregate) [consumed]
      Node 31279 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31276 | 31277, 31278 |
...
|------|------|--------|-----------|-----|--------|
| 31276 | Aggregate | 826.91 | 831.20 | 0.5% | pattern |
| 31279 | Hash Join | 808.96 | 766.06 | 5.3% | operator |
...
### Step 5: Node 31276 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31277, 31278
- **Input Features:**
