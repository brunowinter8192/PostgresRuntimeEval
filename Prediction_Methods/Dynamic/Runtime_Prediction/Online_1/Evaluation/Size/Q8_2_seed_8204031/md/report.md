...
```
Node 14857 (Aggregate) - ROOT
  Node 14858 (Gather Merge)
    Node 14859 (Sort)
          ...
          Node 14862 (Hash Join)
            Node 14863 (Nested Loop)
              Node 14864 (Hash Join)
                ...
                Node 14866 (Hash)
                  Node 14867 (Hash Join)
                    Node 14868 (Seq Scan) - LEAF
                    Node 14869 (Hash)
                      Node 14870 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 14857 | Aggregate | 1233.78 | 1195.83 | 3.1% | operator |
| 14858 | Gather Merge | 1233.30 | 1097.16 | 11.0% | operator |
...
| 14864 | Hash Join | 216.95 | 251.17 | 15.8% | operator |
...
| 14866 | Hash | 36.81 | 20.62 | 44.0% | operator |
| 14867 | Hash Join | 36.15 | 132.26 | 265.9% | operator |
| 14868 | Seq Scan | 34.56 | 23.03 | 33.4% | operator |
| 14869 | Hash | 0.23 | 23.66 | 10367.3% | operator |
| 14870 | Hash Join | 0.22 | 306.84 | 138114.4% | operator |
...
### Step 5: Node 14868 (Seq Scan) - LEAF
...
### Step 8: Node 14865 (Seq Scan) - LEAF
...
### Step 11: Node 14874 (Index Scan) - LEAF
...
### Step 12: Node 14876 (Seq Scan) - LEAF
...
### Step 13: Node 14863 (Nested Loop)
...
### Step 16: Node 14877 (Index Scan) - LEAF
...
### Step 17: Node 14879 (Seq Scan) - LEAF
...
### Step 18: Node 14861 (Nested Loop)
...
### Step 22: Node 14858 (Gather Merge)
...
### Step 23: Node 14857 (Aggregate) - ROOT
