        ...
        Node 31064 (Incremental Sort)
          Node 31065 (Nested Loop)
            Node 31066 (Merge Join)
              Node 31067 (Sort)
                Node 31068 (Hash Join)
                  Node 31069 (Seq Scan) - LEAF
                  Node 31070 (Hash)
...
| 31067 | Sort | 2856.11 | 1099.77 | 61.5% | operator |
| 31073 | Sort | 68.39 | 1074.66 | 1471.3% | operator |
| 31068 | Hash Join | 2856.11 | 686.33 | 76.0% | operator |
| 31074 | Seq Scan | 55.12 | 18.25 | 66.9% | operator |
| 31069 | Seq Scan | 197.80 | 170.37 | 13.9% | operator |
| 31070 | Hash | 2630.32 | 21.04 | 99.2% | operator |
...
### Step 3: Node 31069 (Seq Scan) - LEAF
...
### Step 6: Node 31074 (Seq Scan) - LEAF
...
### Step 9: Node 31066 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 31075 (Index Scan) - LEAF
...
### Step 11: Node 31065 (Nested Loop)
...
### Step 12: Node 31064 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 31063 (Gather Merge)
