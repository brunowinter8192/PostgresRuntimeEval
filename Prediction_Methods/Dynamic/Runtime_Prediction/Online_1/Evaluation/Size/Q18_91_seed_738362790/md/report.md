...
**Test Query:** Q18_91_seed_738362790
...
```
Node 31060 (Limit) - ROOT
  Node 31061 (Sort)
    Node 31062 (Aggregate)
      Node 31063 (Gather Merge)
        Node 31064 (Incremental Sort)
          Node 31065 (Nested Loop)
            Node 31066 (Merge Join)
              Node 31067 (Sort)
                Node 31068 (Hash Join) [PATTERN: 895c6e8c]
                  Node 31069 (Seq Scan) [consumed] - LEAF
                  Node 31070 (Hash) [consumed]
                    Node 31071 (Aggregate)
                      Node 31072 (Index Scan) - LEAF
              Node 31073 (Sort)
                Node 31074 (Seq Scan) - LEAF
            Node 31075 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 31068 | 31069, 31070 |
...
|------|------|--------|-----------|-----|--------|
| 31060 | Limit | 3060.14 | 1175.21 | 61.6% | operator |
| 31061 | Sort | 2948.44 | 1127.81 | 61.7% | operator |
| 31062 | Aggregate | 2948.39 | 1073.15 | 63.6% | operator |
| 31063 | Gather Merge | 2948.37 | 1073.95 | 63.6% | operator |
| 31064 | Incremental Sort | 2928.47 | 0.00 | 100.0% | operator |
| 31065 | Nested Loop | 2928.41 | 1111.34 | 62.0% | operator |
| 31066 | Merge Join | 2928.10 | 0.00 | 100.0% | operator |
| 31075 | Index Scan | 0.14 | 0.05 | 66.6% | operator |
| 31067 | Sort | 2856.11 | 1095.58 | 61.6% | operator |
| 31073 | Sort | 68.39 | 1074.66 | 1471.3% | operator |
| 31068 | Hash Join | 2856.11 | 471.07 | 83.5% | pattern |
| 31074 | Seq Scan | 55.12 | 18.25 | 66.9% | operator |
| 31071 | Aggregate | 2630.29 | 1073.15 | 59.2% | operator |
| 31072 | Index Scan | 2121.78 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31072 (Index Scan) - LEAF
...
### Step 3: Node 31068 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 31069, 31070
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 31074 (Seq Scan) - LEAF
...
### Step 7: Node 31066 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 31075 (Index Scan) - LEAF
...
### Step 10: Node 31064 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 31063 (Gather Merge)
