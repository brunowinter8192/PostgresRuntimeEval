...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4581 | 4582, 4583, 4584, 4586, 4587, 4588 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4586 | 4581, 4582, 4583, 4584, 4587, 4588 |
...
| 4585 | Nested Loop | 1165.15 | 1193.04 | 2.4% | operator |
| 4586 | Hash Join | 208.19 | 242.47 | 16.5% | pattern |
...
- **Consumes:** Nodes 4581, 4582, 4583, 4584, 4587, 4588
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46904
  - HashJoin_nt1=236474
  ...
  - HashJoin_total_cost=37341.3700
  - Hash_Inner_np=0
  - Hash_Inner_nt=12397
...
- **Output:** st=29.71, rt=242.47

### Step 3: Node 4590 (Index Scan) - LEAF
...
- **Output:** st=121.81, rt=1193.04

### Step 5: Node 4581 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4582, 4583, 4584, 4586, 4587, 4588
- **Input Features:**
