...
```
Node 26343 (Sort) - ROOT
  Node 26344 (Aggregate)
    Node 26345 (Aggregate)
      Node 26346 (Hash Join)
        Node 26347 (Seq Scan) - LEAF
        Node 26348 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 26343 | Sort | 944.10 | 1081.93 | 14.6% | operator |
| 26344 | Aggregate | 944.07 | 1000.33 | 6.0% | operator |
| 26345 | Aggregate | 938.16 | 1014.39 | 8.1% | operator |
| 26346 | Hash Join | 712.09 | 787.83 | 10.6% | operator |
| 26347 | Seq Scan | 481.91 | 264.19 | 45.2% | operator |
| 26348 | Hash | 17.37 | 80.15 | 361.4% | operator |
...
### Step 2: Node 26347 (Seq Scan) - LEAF
