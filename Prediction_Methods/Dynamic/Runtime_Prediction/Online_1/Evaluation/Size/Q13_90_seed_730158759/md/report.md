...
**Test Query:** Q13_90_seed_730158759
...
```
Node 26343 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26344 (Aggregate) [consumed]
    Node 26345 (Aggregate)
      Node 26346 (Hash Join) [PATTERN: 895c6e8c]
        Node 26347 (Seq Scan) [consumed] - LEAF
        Node 26348 (Hash) [consumed]
          Node 26349 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26343 | 26344, 26346, 26347, 26348 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26346 | 26343, 26344, 26347, 26348 |
...
|------|------|--------|-----------|-----|--------|
| 26343 | Sort | 944.10 | 1079.94 | 14.4% | pattern |
| 26345 | Aggregate | 938.16 | 999.76 | 6.6% | operator |
| 26346 | Hash Join | 712.09 | 470.31 | 34.0% | pattern |
| 26349 | Index Only Scan | 10.76 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26349 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26346 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26343, 26344, 26347, 26348
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 26343 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26344, 26346, 26347, 26348
- **Input Features:**
