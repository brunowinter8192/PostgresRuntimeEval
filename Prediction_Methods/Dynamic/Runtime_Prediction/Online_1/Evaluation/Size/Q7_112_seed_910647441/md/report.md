...
```
Node 10735 (Aggregate) - ROOT
  Node 10736 (Gather Merge)
    Node 10737 (Sort)
      Node 10738 (Hash Join)
        Node 10739 (Nested Loop)
          Node 10740 (Hash Join)
            Node 10741 (Seq Scan) - LEAF
            Node 10742 (Hash)
              Node 10743 (Hash Join)
                Node 10744 (Seq Scan) - LEAF
                Node 10745 (Hash)
                  Node 10746 (Seq Scan) - LEAF
          Node 10747 (Index Scan) - LEAF
        Node 10748 (Hash)
          Node 10749 (Hash Join)
            Node 10750 (Seq Scan) - LEAF
            Node 10751 (Hash)
              Node 10752 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 10735 | Aggregate | 1176.29 | 1209.26 | 2.8% | operator |
| 10736 | Gather Merge | 1175.38 | 1142.98 | 2.8% | operator |
| 10737 | Sort | 1168.42 | 1109.13 | 5.1% | operator |
| 10738 | Hash Join | 1167.83 | 842.59 | 27.9% | operator |
| 10739 | Nested Loop | 1161.08 | 1216.16 | 4.7% | operator |
| 10748 | Hash | 3.05 | 17.53 | 475.3% | operator |
| 10740 | Hash Join | 212.58 | 384.47 | 80.9% | operator |
| 10747 | Index Scan | 0.03 | 0.96 | 3006.0% | operator |
| 10749 | Hash Join | 3.01 | 85.17 | 2730.7% | operator |
| 10741 | Seq Scan | 149.92 | 201.16 | 34.2% | operator |
| 10742 | Hash | 37.20 | 19.59 | 47.3% | operator |
| 10750 | Seq Scan | 2.71 | 11.47 | 323.0% | operator |
| 10751 | Hash | 0.01 | 16.89 | 129854.5% | operator |
| 10743 | Hash Join | 36.84 | 92.20 | 150.3% | operator |
| 10752 | Seq Scan | 0.01 | 45.79 | 457823.2% | operator |
| 10744 | Seq Scan | 35.74 | 21.86 | 38.8% | operator |
| 10745 | Hash | 0.01 | 16.89 | 168840.8% | operator |
| 10746 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10746 (Seq Scan) - LEAF
...
### Step 2: Node 10744 (Seq Scan) - LEAF
...
### Step 5: Node 10752 (Seq Scan) - LEAF
...
### Step 6: Node 10741 (Seq Scan) - LEAF
...
### Step 8: Node 10750 (Seq Scan) - LEAF
...
### Step 11: Node 10747 (Index Scan) - LEAF
...
### Step 13: Node 10739 (Nested Loop)
...
### Step 17: Node 10736 (Gather Merge)
...
### Step 18: Node 10735 (Aggregate) - ROOT
