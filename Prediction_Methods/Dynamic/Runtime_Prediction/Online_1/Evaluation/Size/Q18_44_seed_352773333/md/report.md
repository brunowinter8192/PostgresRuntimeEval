...
**Test Query:** Q18_44_seed_352773333
...
```
Node 30228 (Limit) - ROOT
  Node 30229 (Sort)
    Node 30230 (Aggregate)
      Node 30231 (Gather Merge)
        Node 30232 (Incremental Sort)
          Node 30233 (Nested Loop)
            Node 30234 (Merge Join)
              Node 30235 (Sort)
                Node 30236 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30237 (Seq Scan) [consumed] - LEAF
                  Node 30238 (Hash) [consumed]
                    Node 30239 (Aggregate)
                      Node 30240 (Index Scan) - LEAF
              Node 30241 (Sort)
                Node 30242 (Seq Scan) - LEAF
            Node 30243 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30236 | 30237, 30238 |
...
|------|------|--------|-----------|-----|--------|
| 30228 | Limit | 3038.78 | 1175.21 | 61.3% | operator |
| 30229 | Sort | 2930.07 | 1127.81 | 61.5% | operator |
| 30230 | Aggregate | 2930.03 | 1073.15 | 63.4% | operator |
| 30231 | Gather Merge | 2930.01 | 1073.95 | 63.3% | operator |
| 30232 | Incremental Sort | 2906.44 | 0.00 | 100.0% | operator |
| 30233 | Nested Loop | 2906.39 | 1111.34 | 61.8% | operator |
| 30234 | Merge Join | 2906.33 | 0.00 | 100.0% | operator |
| 30243 | Index Scan | 0.02 | 0.05 | 125.7% | operator |
| 30235 | Sort | 2827.24 | 1095.58 | 61.2% | operator |
| 30241 | Sort | 75.17 | 1074.66 | 1329.7% | operator |
| 30236 | Hash Join | 2827.23 | 471.07 | 83.3% | pattern |
| 30242 | Seq Scan | 59.57 | 18.25 | 69.4% | operator |
| 30239 | Aggregate | 2605.82 | 1073.15 | 58.8% | operator |
| 30240 | Index Scan | 2146.18 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30240 (Index Scan) - LEAF
...
### Step 3: Node 30236 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30237, 30238
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30242 (Seq Scan) - LEAF
...
### Step 7: Node 30234 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30243 (Index Scan) - LEAF
...
### Step 10: Node 30232 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30231 (Gather Merge)
