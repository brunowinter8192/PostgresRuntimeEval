...
```
Node 6691 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6692 (Gather Merge) [consumed]
    Node 6693 (Sort) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6691 | 6692, 6693, 6694 |
...
|------|------|--------|-----------|-----|--------|
| 6691 | Aggregate | 1053.59 | 952.19 | 9.6% | pattern |
| 6695 | Nested Loop | 1046.99 | 1255.45 | 19.9% | operator |
| 6696 | Seq Scan | 164.32 | 154.67 | 5.9% | operator |
| 6697 | Index Scan | 0.06 | 11.10 | 17810.3% | operator |
