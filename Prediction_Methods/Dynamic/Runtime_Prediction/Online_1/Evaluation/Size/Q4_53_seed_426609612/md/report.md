...
**Test Query:** Q4_53_seed_426609612
...
```
Node 6537 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6538 (Gather Merge) [consumed]
    Node 6539 (Sort) [consumed]
      Node 6540 (Aggregate) [consumed]
        Node 6541 (Nested Loop)
          Node 6542 (Seq Scan) - LEAF
          Node 6543 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6537 | 6538, 6539, 6540 |
...
|------|------|--------|-----------|-----|--------|
| 6537 | Aggregate | 1039.24 | 952.19 | 8.4% | pattern |
| 6541 | Nested Loop | 1031.15 | 1255.45 | 21.8% | operator |
| 6542 | Seq Scan | 166.79 | 154.66 | 7.3% | operator |
| 6543 | Index Scan | 0.06 | 11.10 | 17810.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6542 (Seq Scan) - LEAF
...
### Step 2: Node 6543 (Index Scan) - LEAF
