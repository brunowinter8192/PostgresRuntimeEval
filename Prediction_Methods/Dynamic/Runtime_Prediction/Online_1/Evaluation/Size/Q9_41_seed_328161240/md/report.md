...
**Test Query:** Q9_41_seed_328161240
...
```
Node 18192 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18193 (Aggregate) [consumed]
    Node 18194 (Gather)
      Node 18195 (Aggregate)
        Node 18196 (Nested Loop)
          Node 18197 (Hash Join) [PATTERN: bb930825]
            Node 18198 (Seq Scan) [consumed] - LEAF
            Node 18199 (Hash) [consumed]
              Node 18200 (Hash Join) [consumed]
                Node 18201 (Hash Join)
                  Node 18202 (Nested Loop)
                    Node 18203 (Seq Scan) - LEAF
                    Node 18204 (Index Scan) - LEAF
                  Node 18205 (Hash)
                    Node 18206 (Seq Scan) - LEAF
                Node 18207 (Hash)
                  Node 18208 (Seq Scan) - LEAF
          Node 18209 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18197 | 18192, 18193, 18198, 18199, 18200 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18192 | 18193, 18197, 18198, 18199, 18200 |
...
|------|------|--------|-----------|-----|--------|
| 18192 | Sort | 1173.14 | 1044.29 | 11.0% | pattern |
| 18194 | Gather | 1171.99 | 965.14 | 17.6% | operator |
| 18195 | Aggregate | 1151.60 | 1141.19 | 0.9% | operator |
| 18196 | Nested Loop | 1126.39 | 1252.17 | 11.2% | operator |
| 18197 | Hash Join | 948.23 | 134.80 | 85.8% | pattern |
| 18209 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18201 | Hash Join | 158.21 | 837.49 | 429.4% | operator |
| 18207 | Hash | 13.71 | 14.95 | 9.1% | operator |
| 18202 | Nested Loop | 153.40 | 1251.76 | 716.0% | operator |
| 18205 | Hash | 2.60 | 15.94 | 512.9% | operator |
| 18208 | Seq Scan | 13.70 | 2.94 | 78.6% | operator |
| 18203 | Seq Scan | 19.53 | 44.30 | 126.9% | operator |
| 18204 | Index Scan | 0.07 | -1.39 | 2028.4% | operator |
| 18206 | Seq Scan | 2.10 | 9.45 | 350.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 18203 (Seq Scan) - LEAF
...
### Step 2: Node 18204 (Index Scan) - LEAF
...
### Step 3: Node 18206 (Seq Scan) - LEAF
...
### Step 6: Node 18208 (Seq Scan) - LEAF
...
### Step 9: Node 18197 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18192, 18193, 18198, 18199, 18200
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18209 (Index Scan) - LEAF
...
### Step 11: Node 18196 (Nested Loop)
...
### Step 14: Node 18192 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18193, 18197, 18198, 18199, 18200
- **Input Features:**
