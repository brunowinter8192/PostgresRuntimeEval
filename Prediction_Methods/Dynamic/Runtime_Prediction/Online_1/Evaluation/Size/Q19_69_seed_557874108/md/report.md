...
**Test Query:** Q19_69_seed_557874108
...
```
Node 32025 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 32026 (Gather) [consumed]
    Node 32027 (Aggregate) [consumed]
      Node 32028 (Hash Join) [consumed]
        Node 32029 (Seq Scan) - LEAF
        Node 32030 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 32025 | 32026, 32027, 32028 |
...
|------|------|--------|-----------|-----|--------|
| 32025 | Aggregate | 872.40 | 829.28 | 4.9% | pattern |
| 32029 | Seq Scan | 805.63 | 743.46 | 7.7% | operator |
| 32030 | Hash | 44.72 | 8.29 | 81.5% | operator |
| 32031 | Seq Scan | 44.54 | 23.76 | 46.7% | operator |
...
### Step 2: Node 32029 (Seq Scan) - LEAF
...
### Step 4: Node 32025 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 32026, 32027, 32028
- **Input Features:**
