...
```
Node 31437 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31438 (Gather) [consumed]
    Node 31439 (Aggregate) [consumed]
      Node 31440 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31437 | 31438, 31439, 31440 |
...
|------|------|--------|-----------|-----|--------|
| 31437 | Aggregate | 840.97 | 829.28 | 1.4% | pattern |
| 31441 | Seq Scan | 774.35 | 743.46 | 4.0% | operator |
| 31442 | Hash | 46.28 | 8.29 | 82.1% | operator |
| 31443 | Seq Scan | 46.15 | 23.76 | 48.5% | operator |
...
### Step 4: Node 31437 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31438, 31439, 31440
- **Input Features:**
