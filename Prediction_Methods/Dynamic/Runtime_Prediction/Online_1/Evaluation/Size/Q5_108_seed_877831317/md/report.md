...
**Test Query:** Q5_108_seed_877831317
...
```
Node 7061 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 7062 (Aggregate) [consumed]
    Node 7063 (Gather Merge) [consumed]
      Node 7064 (Aggregate)
        Node 7065 (Sort) [PATTERN: 3e2d5a00]
          Node 7066 (Hash Join) [consumed]
            Node 7067 (Nested Loop)
              Node 7068 (Hash Join)
                Node 7069 (Seq Scan) - LEAF
                Node 7070 (Hash) [PATTERN: 444761fb]
                  Node 7071 (Hash Join) [consumed]
                    Node 7072 (Seq Scan) [consumed] - LEAF
                    Node 7073 (Hash) [consumed]
                      Node 7074 (Hash Join) [consumed]
                        Node 7075 (Seq Scan) - LEAF
                        Node 7076 (Hash)
                          Node 7077 (Seq Scan) - LEAF
              Node 7078 (Index Scan) - LEAF
            Node 7079 (Hash)
              Node 7080 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 7070 | 7061, 7062, 7063, 7065, 7066, 7071, 7072, 7073, 7074 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 7061 | 7062, 7063, 7065, 7066, 7070, 7071, 7072, 7073, 7074 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 7065 | 7061, 7062, 7063, 7066, 7070, 7071, 7072, 7073, 7074 |
...
|------|------|--------|-----------|-----|--------|
| 7061 | Sort | 1088.92 | 2934.42 | 169.5% | pattern |
| 7064 | Aggregate | 1083.77 | 1128.79 | 4.2% | operator |
| 7065 | Sort | 1083.53 | 1835.90 | 69.4% | pattern |
| 7067 | Nested Loop | 1071.78 | 1188.37 | 10.9% | operator |
| 7079 | Hash | 3.03 | 18.67 | 517.0% | operator |
| 7068 | Hash Join | 219.53 | 253.07 | 15.3% | operator |
| 7078 | Index Scan | 0.07 | -0.22 | 393.4% | operator |
| 7080 | Seq Scan | 2.49 | 12.36 | 395.8% | operator |
| 7069 | Seq Scan | 169.37 | 159.81 | 5.6% | operator |
| 7070 | Hash | 36.57 | 46.85 | 28.1% | pattern |
| 7075 | Seq Scan | 0.01 | 11.81 | 131103.0% | operator |
| 7076 | Hash | 0.09 | 21.05 | 23035.4% | operator |
| 7077 | Seq Scan | 0.09 | 22.93 | 25960.6% | operator |
...
### Step 2: Node 7075 (Seq Scan) - LEAF
...
### Step 4: Node 7069 (Seq Scan) - LEAF
...
### Step 5: Node 7070 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 7061, 7062, 7063, 7065, 7066, 7071, 7072, 7073, 7074
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 7078 (Index Scan) - LEAF
...
### Step 8: Node 7080 (Seq Scan) - LEAF
...
### Step 11: Node 7065 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 7061, 7062, 7063, 7066, 7070, 7071, 7072, 7073, 7074
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 7061 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 7062, 7063, 7065, 7066, 7070, 7071, 7072, 7073, 7074
- **Input Features:**
