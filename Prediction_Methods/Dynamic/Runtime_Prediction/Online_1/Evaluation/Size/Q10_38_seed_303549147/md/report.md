    ...
    Node 20425 (Aggregate) [consumed]
      Node 20426 (Gather) [consumed]
        Node 20427 (Hash Join)
          Node 20428 (Hash Join)
            Node 20429 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20423 | 20424, 20425, 20426 |
...
| 20427 | Hash Join | 1098.88 | 1007.21 | 8.3% | operator |
| 20428 | Hash Join | 1096.00 | 1004.12 | 8.4% | operator |
| 20434 | Hash | 0.01 | 15.71 | 112119.8% | operator |
| 20429 | Nested Loop | 1049.54 | 1204.81 | 14.8% | operator |
| 20432 | Hash | 36.70 | 55.57 | 51.4% | operator |
...
### Step 6: Node 20435 (Seq Scan) - LEAF
...
### Step 10: Node 20423 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20424, 20425, 20426
- **Input Features:**
