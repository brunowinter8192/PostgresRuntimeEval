...
**Test Query:** Q9_40_seed_319957209
...
Node 18174 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18175 (Aggregate) [consumed]
    Node 18176 (Gather)
      Node 18177 (Aggregate)
        Node 18178 (Nested Loop)
          Node 18179 (Hash Join) [PATTERN: bb930825]
            Node 18180 (Seq Scan) [consumed] - LEAF
            Node 18181 (Hash) [consumed]
              Node 18182 (Hash Join) [consumed]
                Node 18183 (Hash Join)
                  Node 18184 (Nested Loop)
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18179 | 18174, 18175, 18180, 18181, 18182 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18174 | 18175, 18179, 18180, 18181, 18182 |
...
|------|------|--------|-----------|-----|--------|
| 18174 | Sort | 1180.11 | 1045.59 | 11.4% | pattern |
| 18176 | Gather | 1179.36 | 964.55 | 18.2% | operator |
| 18177 | Aggregate | 1157.92 | 1085.45 | 6.3% | operator |
| 18178 | Nested Loop | 1133.35 | 1252.17 | 10.5% | operator |
| 18179 | Hash Join | 958.66 | 134.80 | 85.9% | pattern |
| 18191 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18183 | Hash Join | 158.75 | 837.63 | 427.6% | operator |
| 18189 | Hash | 12.97 | 14.95 | 15.2% | operator |
| 18184 | Nested Loop | 154.54 | 1251.77 | 710.0% | operator |
| 18187 | Hash | 1.62 | 15.94 | 885.2% | operator |
| 18190 | Seq Scan | 12.96 | 2.94 | 77.3% | operator |
| 18185 | Seq Scan | 19.49 | 43.96 | 125.6% | operator |
| 18186 | Index Scan | 0.07 | -1.39 | 1976.3% | operator |
| 18188 | Seq Scan | 1.15 | 9.45 | 723.5% | operator |
...
### Step 6: Node 18190 (Seq Scan) - LEAF
...
### Step 9: Node 18179 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18174, 18175, 18180, 18181, 18182
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18191 (Index Scan) - LEAF
...
### Step 11: Node 18178 (Nested Loop)
...
### Step 14: Node 18174 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18175, 18179, 18180, 18181, 18182
- **Input Features:**
