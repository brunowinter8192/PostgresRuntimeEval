...
```
Node 32004 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 32005 (Gather) [consumed]
    Node 32006 (Aggregate) [consumed]
      Node 32007 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 32004 | 32005, 32006 |
...
|------|------|--------|-----------|-----|--------|
| 32004 | Aggregate | 831.59 | 831.20 | 0.0% | pattern |
| 32007 | Hash Join | 811.51 | 766.06 | 5.6% | operator |
...
- **Input Features:**
  ...
  - st1=7.8285
  - st2=8.2846
  - startup_cost=7672.1500
  - total_cost=156338.5800
- **Output:** st=60.26, rt=766.06

### Step 5: Node 32004 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 32005, 32006
- **Input Features:**
