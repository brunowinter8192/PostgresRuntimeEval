...
**Test Query:** Q19_66_seed_533262015
**Timestamp:** 2026-01-18 20:39:51
...
```
Node 32004 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 32005 (Gather) [consumed]
    Node 32006 (Aggregate) [consumed]
      Node 32007 (Hash Join) [consumed]
        Node 32008 (Seq Scan) - LEAF
        Node 32009 (Hash)
          Node 32010 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 32004 | 32005, 32006, 32007 |
...
|------|------|--------|-----------|-----|--------|
| 32004 | Aggregate | 831.59 | 829.27 | 0.3% | pattern |
| 32008 | Seq Scan | 764.55 | 743.46 | 2.8% | operator |
| 32009 | Hash | 44.95 | 8.29 | 81.6% | operator |
| 32010 | Seq Scan | 44.83 | 23.76 | 47.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 32010 (Seq Scan) - LEAF
...
### Step 2: Node 32008 (Seq Scan) - LEAF
...
### Step 4: Node 32004 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 32005, 32006, 32007
- **Input Features:**
  ...
  - Aggregate_Outer_startup_cost=156338.7500
  - Aggregate_Outer_total_cost=156338.7600
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Gather_Outer_startup_cost=157338.7500
  - Gather_Outer_total_cost=157339.2600
  - HashJoin_Outer_np=0
