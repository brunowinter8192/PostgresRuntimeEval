        ...
        Node 30008 (Incremental Sort)
          Node 30009 (Nested Loop)
            Node 30010 (Merge Join)
              Node 30011 (Sort)
                Node 30012 (Hash Join)
                  Node 30013 (Seq Scan) - LEAF
                  Node 30014 (Hash)
...
| 30011 | Sort | 2841.47 | 1099.77 | 61.3% | operator |
| 30017 | Sort | 65.57 | 1074.66 | 1539.0% | operator |
| 30012 | Hash Join | 2841.45 | 686.33 | 75.8% | operator |
| 30018 | Seq Scan | 53.51 | 18.25 | 65.9% | operator |
| 30013 | Seq Scan | 194.30 | 170.37 | 12.3% | operator |
| 30014 | Hash | 2618.49 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30013 (Seq Scan) - LEAF
...
### Step 6: Node 30018 (Seq Scan) - LEAF
...
### Step 9: Node 30010 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30019 (Index Scan) - LEAF
...
### Step 11: Node 30009 (Nested Loop)
...
### Step 12: Node 30008 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30007 (Gather Merge)
