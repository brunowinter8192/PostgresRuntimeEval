...
**Test Query:** Q18_31_seed_246120930
...
```
Node 30004 (Limit) - ROOT
  Node 30005 (Sort)
    Node 30006 (Aggregate)
      Node 30007 (Gather Merge)
        Node 30008 (Incremental Sort)
          Node 30009 (Nested Loop)
            Node 30010 (Merge Join)
              Node 30011 (Sort)
                Node 30012 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30013 (Seq Scan) [consumed] - LEAF
                  Node 30014 (Hash) [consumed]
                    Node 30015 (Aggregate)
                      Node 30016 (Index Scan) - LEAF
              Node 30017 (Sort)
                Node 30018 (Seq Scan) - LEAF
            Node 30019 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30012 | 30013, 30014 |
...
|------|------|--------|-----------|-----|--------|
| 30004 | Limit | 3046.83 | 1175.21 | 61.4% | operator |
| 30005 | Sort | 2929.66 | 1127.81 | 61.5% | operator |
| 30006 | Aggregate | 2929.62 | 1073.15 | 63.4% | operator |
| 30007 | Gather Merge | 2929.59 | 1073.95 | 63.3% | operator |
| 30008 | Incremental Sort | 2910.13 | 0.00 | 100.0% | operator |
| 30009 | Nested Loop | 2910.08 | 1111.34 | 61.8% | operator |
| 30010 | Merge Join | 2910.02 | 0.00 | 100.0% | operator |
| 30019 | Index Scan | 0.02 | 0.05 | 88.1% | operator |
| 30011 | Sort | 2841.47 | 1095.58 | 61.4% | operator |
| 30017 | Sort | 65.57 | 1074.66 | 1539.0% | operator |
| 30012 | Hash Join | 2841.45 | 471.07 | 83.4% | pattern |
| 30018 | Seq Scan | 53.51 | 18.25 | 65.9% | operator |
| 30015 | Aggregate | 2618.44 | 1073.15 | 59.0% | operator |
| 30016 | Index Scan | 2133.23 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30016 (Index Scan) - LEAF
...
### Step 3: Node 30012 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30013, 30014
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30018 (Seq Scan) - LEAF
...
### Step 7: Node 30010 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30019 (Index Scan) - LEAF
...
### Step 10: Node 30008 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30007 (Gather Merge)
