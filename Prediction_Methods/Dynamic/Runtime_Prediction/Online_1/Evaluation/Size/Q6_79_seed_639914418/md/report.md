...
**Test Query:** Q6_79_seed_639914418
...
```
Node 10405 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10406 (Gather) [consumed]
    Node 10407 (Aggregate) [consumed]
      Node 10408 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10405 | 10406, 10407 |
...
|------|------|--------|-----------|-----|--------|
| 10405 | Aggregate | 808.24 | 849.99 | 5.2% | pattern |
| 10408 | Seq Scan | 786.67 | 748.50 | 4.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10408 (Seq Scan) - LEAF
...
### Step 2: Node 10405 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10406, 10407
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=22783
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=32
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=139719.3900
  - Aggregate_Outer_total_cost=139719.4000
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=140719.9200
  - Aggregate_total_cost=140719.9300
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=140719.3900
  - Gather_Outer_total_cost=140719.9000
