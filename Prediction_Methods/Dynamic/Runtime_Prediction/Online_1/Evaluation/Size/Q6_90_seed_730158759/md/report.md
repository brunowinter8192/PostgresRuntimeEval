...
**Test Query:** Q6_90_seed_730158759
...
```
Node 10457 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10458 (Gather) [consumed]
    Node 10459 (Aggregate) [consumed]
      Node 10460 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10457 | 10458, 10459 |
...
|------|------|--------|-----------|-----|--------|
| 10457 | Aggregate | 833.50 | 850.07 | 2.0% | pattern |
| 10460 | Seq Scan | 813.84 | 748.54 | 8.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10460 (Seq Scan) - LEAF
...
### Step 2: Node 10457 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10458, 10459
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=23903
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=32
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=139724.9900
  - Aggregate_Outer_total_cost=139725.0000
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=140725.5200
  - Aggregate_total_cost=140725.5300
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=140724.9900
  - Gather_Outer_total_cost=140725.5000
