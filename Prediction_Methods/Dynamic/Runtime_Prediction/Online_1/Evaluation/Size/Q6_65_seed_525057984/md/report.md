...
**Test Query:** Q6_65_seed_525057984
...
```
Node 10345 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10346 (Gather) [consumed]
    Node 10347 (Aggregate) [consumed]
      Node 10348 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10345 | 10346, 10347 |
...
|------|------|--------|-----------|-----|--------|
| 10345 | Aggregate | 726.38 | 850.00 | 17.0% | pattern |
| 10348 | Seq Scan | 706.11 | 748.50 | 6.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10348 (Seq Scan) - LEAF
...
### Step 2: Node 10345 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10346, 10347
- **Input Features:**
