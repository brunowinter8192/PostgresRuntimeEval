    ...
    Node 20997 (Aggregate) [consumed]
      Node 20998 (Gather) [consumed]
        Node 20999 (Hash Join)
          Node 21000 (Hash Join) [PATTERN: 2e0f44ef]
            Node 21001 (Nested Loop) [consumed]
              Node 21002 (Seq Scan) - LEAF
              Node 21003 (Index Scan) - LEAF
            Node 21004 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20995 | 20996, 20997, 20998, 21000, 21001, 21004 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 21000 | 20995, 20996, 20997, 20998, 21001, 21004 |
...
| 20999 | Hash Join | 1095.45 | 1095.46 | 0.0% | operator |
| 21000 | Hash Join | 1092.60 | 1120.19 | 2.5% | pattern |
...
### Step 4: Node 21007 (Seq Scan) - LEAF
...
### Step 5: Node 21000 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 20995, 20996, 20997, 20998, 21001, 21004
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=17827
  - HashJoin_nt1=17827
...
### Step 8: Node 20995 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20996, 20997, 20998, 21000, 21001, 21004
- **Input Features:**
