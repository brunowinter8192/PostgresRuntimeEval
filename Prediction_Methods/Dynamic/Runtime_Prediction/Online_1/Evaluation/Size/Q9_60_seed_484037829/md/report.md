...
**Test Query:** Q9_60_seed_484037829
...
```
Node 18570 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18571 (Aggregate) [consumed]
    Node 18572 (Gather)
      Node 18573 (Aggregate)
        Node 18574 (Nested Loop)
          Node 18575 (Hash Join) [PATTERN: bb930825]
            Node 18576 (Seq Scan) [consumed] - LEAF
            Node 18577 (Hash) [consumed]
              Node 18578 (Hash Join) [consumed]
                Node 18579 (Hash Join)
                  Node 18580 (Nested Loop)
                    Node 18581 (Seq Scan) - LEAF
                    Node 18582 (Index Scan) - LEAF
                  Node 18583 (Hash)
                    Node 18584 (Seq Scan) - LEAF
                Node 18585 (Hash)
                  Node 18586 (Seq Scan) - LEAF
          Node 18587 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18575 | 18570, 18571, 18576, 18577, 18578 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18570 | 18571, 18575, 18576, 18577, 18578 |
...
|------|------|--------|-----------|-----|--------|
| 18570 | Sort | 1190.54 | 1044.54 | 12.3% | pattern |
| 18572 | Gather | 1189.14 | 965.01 | 18.8% | operator |
| 18573 | Aggregate | 1170.32 | 1129.15 | 3.5% | operator |
| 18574 | Nested Loop | 1145.32 | 1252.17 | 9.3% | operator |
| 18575 | Hash Join | 971.86 | 134.80 | 86.1% | pattern |
| 18587 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18579 | Hash Join | 166.70 | 837.52 | 402.4% | operator |
| 18585 | Hash | 12.97 | 14.95 | 15.2% | operator |
| 18580 | Nested Loop | 161.02 | 1251.76 | 677.4% | operator |
| 18583 | Hash | 3.32 | 15.94 | 379.7% | operator |
| 18586 | Seq Scan | 12.96 | 2.94 | 77.3% | operator |
| 18581 | Seq Scan | 19.45 | 44.23 | 127.4% | operator |
| 18582 | Index Scan | 0.08 | -1.39 | 1880.1% | operator |
| 18584 | Seq Scan | 2.75 | 9.45 | 243.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 18581 (Seq Scan) - LEAF
...
### Step 2: Node 18582 (Index Scan) - LEAF
...
### Step 3: Node 18584 (Seq Scan) - LEAF
...
### Step 6: Node 18586 (Seq Scan) - LEAF
...
### Step 9: Node 18575 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18570, 18571, 18576, 18577, 18578
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18587 (Index Scan) - LEAF
...
### Step 11: Node 18574 (Nested Loop)
...
### Step 14: Node 18570 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18571, 18575, 18576, 18577, 18578
- **Input Features:**
