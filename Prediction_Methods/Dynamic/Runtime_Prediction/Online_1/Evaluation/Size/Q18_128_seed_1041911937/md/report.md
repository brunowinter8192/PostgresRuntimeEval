...
```
Node 29300 (Limit) - ROOT
  Node 29301 (Sort)
    Node 29302 (Aggregate)
      Node 29303 (Gather Merge)
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29308 | 29309, 29310 |
...
|------|------|--------|-----------|-----|--------|
| 29300 | Limit | 3032.24 | 1175.21 | 61.2% | operator |
| 29301 | Sort | 2921.11 | 1127.81 | 61.4% | operator |
| 29302 | Aggregate | 2921.06 | 1073.15 | 63.3% | operator |
| 29303 | Gather Merge | 2921.05 | 1073.95 | 63.2% | operator |
| 29304 | Incremental Sort | 2902.59 | 0.00 | 100.0% | operator |
| 29305 | Nested Loop | 2902.54 | 1111.34 | 61.7% | operator |
| 29306 | Merge Join | 2902.48 | 0.00 | 100.0% | operator |
| 29315 | Index Scan | 0.02 | 0.05 | 88.1% | operator |
| 29307 | Sort | 2835.36 | 1095.58 | 61.4% | operator |
| 29313 | Sort | 64.45 | 1074.66 | 1567.3% | operator |
| 29308 | Hash Join | 2835.34 | 471.07 | 83.4% | pattern |
| 29314 | Seq Scan | 52.74 | 18.25 | 65.4% | operator |
| 29311 | Aggregate | 2606.21 | 1073.15 | 58.8% | operator |
| 29312 | Index Scan | 2101.12 | 0.00 | 100.0% | operator |
...
### Step 10: Node 29304 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29303 (Gather Merge)
