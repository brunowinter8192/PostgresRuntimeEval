    ...
    Node 21127 (Aggregate) [consumed]
      Node 21128 (Gather) [consumed]
        Node 21129 (Hash Join)
          Node 21130 (Hash Join)
            Node 21131 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 21125 | 21126, 21127, 21128 |
...
| 21129 | Hash Join | 1117.89 | 1007.19 | 9.9% | operator |
| 21130 | Hash Join | 1114.94 | 1004.09 | 9.9% | operator |
| 21136 | Hash | 0.01 | 15.71 | 104638.5% | operator |
| 21131 | Nested Loop | 1062.98 | 1204.83 | 13.3% | operator |
| 21134 | Hash | 38.78 | 55.57 | 43.3% | operator |
...
### Step 6: Node 21137 (Seq Scan) - LEAF
...
### Step 10: Node 21125 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 21126, 21127, 21128
- **Input Features:**
