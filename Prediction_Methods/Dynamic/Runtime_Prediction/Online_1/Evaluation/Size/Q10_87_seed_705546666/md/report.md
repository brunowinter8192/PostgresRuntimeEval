...
**Test Query:** Q10_87_seed_705546666
**Timestamp:** 2026-01-18 19:42:53
...
```
Node 21125 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 21126 (Sort) [consumed]
    Node 21127 (Aggregate) [consumed]
      Node 21128 (Gather) [consumed]
        Node 21129 (Hash Join)
          Node 21130 (Hash Join) [PATTERN: 2e0f44ef]
            Node 21131 (Nested Loop) [consumed]
              Node 21132 (Seq Scan) - LEAF
              Node 21133 (Index Scan) - LEAF
            Node 21134 (Hash) [consumed]
              Node 21135 (Seq Scan) - LEAF
          Node 21136 (Hash)
            Node 21137 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 21125 | 21126, 21127, 21128, 21130, 21131, 21134 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 21130 | 21125, 21126, 21127, 21128, 21131, 21134 |
...
|------|------|--------|-----------|-----|--------|
| 21125 | Limit | 1173.22 | 1199.47 | 2.2% | pattern |
| 21129 | Hash Join | 1117.89 | 1095.53 | 2.0% | operator |
| 21130 | Hash Join | 1114.94 | 1120.19 | 0.5% | pattern |
| 21136 | Hash | 0.01 | 15.71 | 104638.5% | operator |
| 21137 | Seq Scan | 0.01 | 6.98 | 69687.0% | operator |
| 21132 | Seq Scan | 161.77 | 159.74 | 1.3% | operator |
| 21133 | Index Scan | 0.06 | -0.52 | 922.6% | operator |
| 21135 | Seq Scan | 27.53 | 26.64 | 3.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 21132 (Seq Scan) - LEAF
...
### Step 2: Node 21133 (Index Scan) - LEAF
...
### Step 3: Node 21135 (Seq Scan) - LEAF
...
### Step 4: Node 21137 (Seq Scan) - LEAF
...
### Step 5: Node 21130 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 21125, 21126, 21127, 21128, 21131, 21134
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18089
  - HashJoin_nt1=18089
...
### Step 8: Node 21125 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 21126, 21127, 21128, 21130, 21131, 21134
- **Input Features:**
