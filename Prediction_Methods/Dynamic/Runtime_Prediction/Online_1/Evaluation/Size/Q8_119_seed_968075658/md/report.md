...
```
Node 13661 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 13662 (Gather Merge) [consumed]
    Node 13663 (Sort)
          ...
          Node 13666 (Hash Join)
            Node 13667 (Nested Loop)
              Node 13668 (Hash Join)
                ...
                Node 13670 (Hash) [PATTERN: 444761fb]
                  Node 13671 (Hash Join) [consumed]
                    Node 13672 (Seq Scan) [consumed] - LEAF
                    Node 13673 (Hash) [consumed]
                      Node 13674 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 13670 | 13661, 13662, 13671, 13672, 13673, 13674 |
| Aggregate -> Gather Merge (Out | 2724c080 | 13661 | 13662, 13670, 13671, 13672, 13673, 13674 |
...
|------|------|--------|-----------|-----|--------|
| 13661 | Aggregate | 1255.25 | 1127.42 | 10.2% | pattern |
...
| 13668 | Hash Join | 218.26 | 251.67 | 15.3% | operator |
...
| 13670 | Hash | 37.48 | 43.51 | 16.1% | pattern |
...
### Step 4: Node 13669 (Seq Scan) - LEAF
...
### Step 5: Node 13670 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 13661, 13662, 13671, 13672, 13673, 13674
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 13678 (Index Scan) - LEAF
...
### Step 8: Node 13680 (Seq Scan) - LEAF
...
### Step 12: Node 13681 (Index Scan) - LEAF
...
### Step 13: Node 13683 (Seq Scan) - LEAF
...
### Step 14: Node 13665 (Nested Loop)
...
### Step 18: Node 13661 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 13662, 13670, 13671, 13672, 13673, 13674
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2533
  ...
  - Aggregate_sel=0.9499
  - Aggregate_startup_cost=71564.7300
  - Aggregate_total_cost=71963.1800
  - GatherMerge_Outer_np=0
  - GatherMerge_Outer_nt=2533
  ...
  - GatherMerge_Outer_total_cost=71864.4000
- **Output:** st=1124.47, rt=1127.42
