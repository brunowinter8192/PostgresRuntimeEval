...
**Test Query:** Q3_18_seed_139468527
...
```
Node 4941 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 4942 (Sort) [consumed]
    Node 4943 (Aggregate) [consumed]
      Node 4944 (Gather) [consumed]
        Node 4945 (Nested Loop)
          Node 4946 (Hash Join) [PATTERN: 895c6e8c]
            Node 4947 (Seq Scan) [consumed] - LEAF
            Node 4948 (Hash) [consumed]
              Node 4949 (Seq Scan) - LEAF
          Node 4950 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4941 | 4942, 4943, 4944, 4946, 4947, 4948 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4946 | 4941, 4942, 4943, 4944, 4947, 4948 |
...
|------|------|--------|-----------|-----|--------|
| 4941 | Limit | 1196.78 | 1151.18 | 3.8% | pattern |
| 4945 | Nested Loop | 1160.27 | 1193.46 | 2.9% | operator |
| 4946 | Hash Join | 210.19 | 242.56 | 15.4% | pattern |
| 4950 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4949 | Seq Scan | 29.57 | 38.54 | 30.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4949 (Seq Scan) - LEAF
...
### Step 2: Node 4946 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4941, 4942, 4943, 4944, 4947, 4948
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47557
  - HashJoin_nt1=236664
  ...
  - HashJoin_total_cost=37343.8900
  - Hash_Inner_np=0
  - Hash_Inner_nt=12559
...
### Step 3: Node 4950 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=73296.9900
- **Output:** st=122.20, rt=1193.46

### Step 5: Node 4941 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4942, 4943, 4944, 4946, 4947, 4948
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=315575
  - Aggregate_Outer_nt1=315575
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110588.1100
  - Aggregate_Outer_total_cost=114532.8000
  - Gather_Outer_np=0
  - Gather_Outer_nt=315575
  - Gather_Outer_nt1=101798
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105854.4900
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=315575
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=121352.2600
  - Limit_total_cost=121352.2900
  - Sort_Outer_np=0
  - Sort_Outer_nt=315575
  - Sort_Outer_nt1=315575
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=121352.2600
  - Sort_Outer_total_cost=122141.2000
