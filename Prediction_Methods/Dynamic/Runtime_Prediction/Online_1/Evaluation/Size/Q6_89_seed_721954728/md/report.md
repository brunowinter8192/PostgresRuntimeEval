...
**Test Query:** Q6_89_seed_721954728
...
```
Node 10449 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10450 (Gather) [consumed]
    Node 10451 (Aggregate) [consumed]
      Node 10452 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10449 | 10450, 10451 |
...
|------|------|--------|-----------|-----|--------|
| 10449 | Aggregate | 800.72 | 850.05 | 6.2% | pattern |
| 10452 | Seq Scan | 779.28 | 748.53 | 3.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10452 (Seq Scan) - LEAF
...
### Step 2: Node 10449 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10450, 10451
- **Input Features:**
