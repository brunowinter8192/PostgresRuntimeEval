...
**Test Query:** Q1_34_seed_270733023
...
```
Node 386 (Aggregate) - ROOT
  Node 387 (Gather Merge)
    Node 388 (Sort) [PATTERN: 1d35fb97]
      Node 389 (Aggregate) [consumed]
        Node 390 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 388 | 389 |
...
|------|------|--------|-----------|-----|--------|
| 386 | Aggregate | 924.64 | 1196.03 | 29.4% | operator |
| 387 | Gather Merge | 924.59 | 1165.95 | 26.1% | operator |
| 388 | Sort | 904.41 | 1201.06 | 32.8% | pattern |
| 390 | Seq Scan | 479.51 | 678.14 | 41.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 390 (Seq Scan) - LEAF
...
### Step 2: Node 388 (Sort) - PATTERN ROOT
...
### Step 4: Node 386 (Aggregate) - ROOT
