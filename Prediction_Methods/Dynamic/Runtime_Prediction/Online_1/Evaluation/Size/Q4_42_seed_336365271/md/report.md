...
**Test Query:** Q4_42_seed_336365271
...
```
Node 6453 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6454 (Gather Merge) [consumed]
    Node 6455 (Sort) [consumed]
      Node 6456 (Aggregate) [consumed]
        Node 6457 (Nested Loop)
          Node 6458 (Seq Scan) - LEAF
          Node 6459 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6453 | 6454, 6455, 6456 |
...
|------|------|--------|-----------|-----|--------|
| 6453 | Aggregate | 1042.73 | 952.19 | 8.7% | pattern |
| 6457 | Nested Loop | 1036.11 | 1255.45 | 21.2% | operator |
| 6458 | Seq Scan | 164.51 | 154.67 | 6.0% | operator |
| 6459 | Index Scan | 0.06 | 11.10 | 17810.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6458 (Seq Scan) - LEAF
...
### Step 2: Node 6459 (Index Scan) - LEAF
