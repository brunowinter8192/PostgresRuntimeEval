...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 31164 | 31165, 31166 |
...
|------|------|--------|-----------|-----|--------|
| 31156 | Limit | 3062.19 | 1175.21 | 61.6% | operator |
| 31157 | Sort | 2946.30 | 1127.81 | 61.7% | operator |
| 31158 | Aggregate | 2946.25 | 1073.15 | 63.6% | operator |
| 31159 | Gather Merge | 2946.23 | 1073.95 | 63.5% | operator |
| 31160 | Incremental Sort | 2926.50 | 0.00 | 100.0% | operator |
| 31161 | Nested Loop | 2926.45 | 1111.34 | 62.0% | operator |
| 31162 | Merge Join | 2926.39 | 0.00 | 100.0% | operator |
| 31171 | Index Scan | 0.02 | 0.05 | 105.2% | operator |
| 31163 | Sort | 2855.38 | 1095.58 | 61.6% | operator |
| 31169 | Sort | 68.07 | 1074.66 | 1478.9% | operator |
| 31164 | Hash Join | 2855.37 | 471.07 | 83.5% | pattern |
| 31170 | Seq Scan | 54.24 | 18.25 | 66.4% | operator |
| 31167 | Aggregate | 2623.72 | 1073.15 | 59.1% | operator |
| 31168 | Index Scan | 2140.87 | 0.00 | 100.0% | operator |
...
### Step 3: Node 31164 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 31165, 31166
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 31170 (Seq Scan) - LEAF
...
### Step 7: Node 31162 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 31171 (Index Scan) - LEAF
...
### Step 10: Node 31160 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 31159 (Gather Merge)
