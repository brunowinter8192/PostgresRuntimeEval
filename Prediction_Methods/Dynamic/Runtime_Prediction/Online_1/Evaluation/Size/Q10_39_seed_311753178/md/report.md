...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20436 | 20437, 20438, 20439, 20441, 20442, 20445 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 20441 | 20436, 20437, 20438, 20439, 20442, 20445 |
...
|------|------|--------|-----------|-----|--------|
| 20436 | Limit | 1144.16 | 1199.47 | 4.8% | pattern |
| 20440 | Hash Join | 1094.28 | 1095.44 | 0.1% | operator |
| 20441 | Hash Join | 1091.48 | 1120.19 | 2.6% | pattern |
| 20447 | Hash | 0.01 | 15.71 | 120752.1% | operator |
| 20448 | Seq Scan | 0.01 | 6.98 | 69687.0% | operator |
| 20443 | Seq Scan | 161.42 | 159.75 | 1.0% | operator |
| 20444 | Index Scan | 0.06 | -0.52 | 922.6% | operator |
| 20446 | Seq Scan | 25.48 | 26.64 | 4.6% | operator |
...
- **Consumes:** Nodes 20436, 20437, 20438, 20439, 20442, 20445
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=17761
  - HashJoin_nt1=17761
...
### Step 8: Node 20436 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20437, 20438, 20439, 20441, 20442, 20445
- **Input Features:**
