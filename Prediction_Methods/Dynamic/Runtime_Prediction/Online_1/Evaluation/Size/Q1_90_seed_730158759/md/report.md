...
**Test Query:** Q1_90_seed_730158759
...
```
Node 696 (Aggregate) - ROOT
  Node 697 (Gather Merge)
    Node 698 (Sort) [PATTERN: 1d35fb97]
      Node 699 (Aggregate) [consumed]
        Node 700 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 698 | 699 |
...
|------|------|--------|-----------|-----|--------|
| 696 | Aggregate | 930.31 | 1196.00 | 28.6% | operator |
| 697 | Gather Merge | 930.26 | 1165.94 | 25.3% | operator |
| 698 | Sort | 908.27 | 1200.94 | 32.2% | pattern |
| 700 | Seq Scan | 496.49 | 678.61 | 36.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 700 (Seq Scan) - LEAF
...
### Step 2: Node 698 (Sort) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Aggregate_Outer_nt1=1190096
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=236
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=169256.4000
  - Aggregate_Outer_total_cost=169256.5300
  - Sort_np=0
  - Sort_nt=6
  - Sort_nt1=6
  - Sort_nt2=0
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=169256.6100
  - Sort_total_cost=169256.6300
- **Output:** st=1196.84, rt=1200.94

### Step 3: Node 697 (Gather Merge)
...
### Step 4: Node 696 (Aggregate) - ROOT
