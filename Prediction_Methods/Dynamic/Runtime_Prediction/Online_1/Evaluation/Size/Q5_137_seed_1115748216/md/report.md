...
**Test Query:** Q5_137_seed_1115748216
...
```
Node 7701 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 7702 (Aggregate) [consumed]
    Node 7703 (Gather Merge) [consumed]
      Node 7704 (Aggregate)
        Node 7705 (Sort) [PATTERN: 3e2d5a00]
          Node 7706 (Hash Join) [consumed]
            Node 7707 (Nested Loop)
              Node 7708 (Hash Join)
                Node 7709 (Seq Scan) - LEAF
                Node 7710 (Hash) [PATTERN: 444761fb]
                  Node 7711 (Hash Join) [consumed]
                    Node 7712 (Seq Scan) [consumed] - LEAF
                    Node 7713 (Hash) [consumed]
                      Node 7714 (Hash Join) [consumed]
                        Node 7715 (Seq Scan) - LEAF
                        Node 7716 (Hash)
                          Node 7717 (Seq Scan) - LEAF
              Node 7718 (Index Scan) - LEAF
            Node 7719 (Hash)
              Node 7720 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 7710 | 7701, 7702, 7703, 7705, 7706, 7711, 7712, 7713, 7714 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 7701 | 7702, 7703, 7705, 7706, 7710, 7711, 7712, 7713, 7714 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 7705 | 7701, 7702, 7703, 7706, 7710, 7711, 7712, 7713, 7714 |
...
|------|------|--------|-----------|-----|--------|
| 7701 | Sort | 1063.21 | 2934.42 | 176.0% | pattern |
| 7704 | Aggregate | 1058.19 | 1128.74 | 6.7% | operator |
| 7705 | Sort | 1057.95 | 1835.96 | 73.5% | pattern |
| 7707 | Nested Loop | 1044.73 | 1188.57 | 13.8% | operator |
| 7719 | Hash | 4.53 | 18.67 | 312.1% | operator |
| 7708 | Hash Join | 216.52 | 253.07 | 16.9% | operator |
| 7718 | Index Scan | 0.07 | -0.22 | 405.6% | operator |
| 7720 | Seq Scan | 3.94 | 12.36 | 213.3% | operator |
| 7709 | Seq Scan | 167.81 | 159.81 | 4.8% | operator |
| 7710 | Hash | 35.43 | 46.85 | 32.2% | pattern |
| 7715 | Seq Scan | 0.01 | 11.81 | 131103.0% | operator |
| 7716 | Hash | 0.06 | 21.05 | 34988.7% | operator |
| 7717 | Seq Scan | 0.06 | 22.93 | 40133.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 7717 (Seq Scan) - LEAF
...
### Step 2: Node 7715 (Seq Scan) - LEAF
...
### Step 4: Node 7709 (Seq Scan) - LEAF
...
### Step 5: Node 7710 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 7701, 7702, 7703, 7705, 7706, 7711, 7712, 7713, 7714
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 7718 (Index Scan) - LEAF
...
### Step 8: Node 7720 (Seq Scan) - LEAF
...
### Step 11: Node 7705 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 7701, 7702, 7703, 7706, 7710, 7711, 7712, 7713, 7714
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 7701 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 7702, 7703, 7705, 7706, 7710, 7711, 7712, 7713, 7714
- **Input Features:**
