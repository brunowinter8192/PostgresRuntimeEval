...
**Test Query:** Q1_11_seed_82040310
...
```
Node 106 (Aggregate) - ROOT
  Node 107 (Gather Merge)
    Node 108 (Sort) [PATTERN: 1d35fb97]
      Node 109 (Aggregate) [consumed]
        Node 110 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 108 | 109 |
...
|------|------|--------|-----------|-----|--------|
| 106 | Aggregate | 989.13 | 1195.75 | 20.9% | operator |
| 107 | Gather Merge | 989.09 | 1165.87 | 17.9% | operator |
| 108 | Sort | 966.87 | 1199.99 | 24.1% | pattern |
| 110 | Seq Scan | 591.60 | 682.20 | 15.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 110 (Seq Scan) - LEAF
...
### Step 2: Node 108 (Sort) - PATTERN ROOT
...
### Step 4: Node 106 (Aggregate) - ROOT
