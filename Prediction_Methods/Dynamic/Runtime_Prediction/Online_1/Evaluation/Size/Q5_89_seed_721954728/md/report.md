...
**Test Query:** Q5_89_seed_721954728
...
```
Node 9641 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 9642 (Aggregate) [consumed]
    Node 9643 (Gather Merge) [consumed]
      Node 9644 (Aggregate)
        Node 9645 (Sort) [PATTERN: 3e2d5a00]
          Node 9646 (Hash Join) [consumed]
            Node 9647 (Nested Loop)
              Node 9648 (Hash Join)
                Node 9649 (Seq Scan) - LEAF
                Node 9650 (Hash) [PATTERN: 444761fb]
                  Node 9651 (Hash Join) [consumed]
                    Node 9652 (Seq Scan) [consumed] - LEAF
                    Node 9653 (Hash) [consumed]
                      Node 9654 (Hash Join) [consumed]
                        Node 9655 (Seq Scan) - LEAF
                        Node 9656 (Hash)
                          Node 9657 (Seq Scan) - LEAF
              Node 9658 (Index Scan) - LEAF
            Node 9659 (Hash)
              Node 9660 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 9650 | 9641, 9642, 9643, 9645, 9646, 9651, 9652, 9653, 9654 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 9641 | 9642, 9643, 9645, 9646, 9650, 9651, 9652, 9653, 9654 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 9645 | 9641, 9642, 9643, 9646, 9650, 9651, 9652, 9653, 9654 |
...
|------|------|--------|-----------|-----|--------|
| 9641 | Sort | 1056.63 | 2934.42 | 177.7% | pattern |
| 9644 | Aggregate | 1051.74 | 1128.78 | 7.3% | operator |
| 9645 | Sort | 1051.46 | 1835.92 | 74.6% | pattern |
| 9647 | Nested Loop | 1039.36 | 1188.42 | 14.3% | operator |
| 9659 | Hash | 2.64 | 18.67 | 606.7% | operator |
| 9648 | Hash Join | 208.64 | 253.07 | 21.3% | operator |
| 9658 | Index Scan | 0.07 | -0.22 | 397.3% | operator |
| 9660 | Seq Scan | 2.10 | 12.36 | 487.7% | operator |
| 9649 | Seq Scan | 164.21 | 159.81 | 2.7% | operator |
| 9650 | Hash | 31.82 | 46.85 | 47.2% | pattern |
| 9655 | Seq Scan | 0.01 | 11.81 | 78621.8% | operator |
| 9656 | Hash | 0.08 | 21.05 | 25891.7% | operator |
| 9657 | Seq Scan | 0.08 | 22.93 | 29301.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 9657 (Seq Scan) - LEAF
...
### Step 2: Node 9655 (Seq Scan) - LEAF
...
### Step 4: Node 9649 (Seq Scan) - LEAF
...
### Step 5: Node 9650 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 9641, 9642, 9643, 9645, 9646, 9651, 9652, 9653, 9654
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 9658 (Index Scan) - LEAF
...
### Step 8: Node 9660 (Seq Scan) - LEAF
...
### Step 11: Node 9645 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 9641, 9642, 9643, 9646, 9650, 9651, 9652, 9653, 9654
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 9641 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 9642, 9643, 9645, 9646, 9650, 9651, 9652, 9653, 9654
- **Input Features:**
