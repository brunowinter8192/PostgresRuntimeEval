...
```
Node 26938 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26939 (Gather) [consumed]
    Node 26940 (Aggregate) [consumed]
      Node 26941 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26938 | 26939, 26940, 26941 |
...
|------|------|--------|-----------|-----|--------|
| 26938 | Aggregate | 835.65 | 857.12 | 2.6% | pattern |
...
### Step 4: Node 26938 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26939, 26940, 26941
- **Input Features:**
