...
**Test Query:** Q14_31_seed_246120930
...
```
Node 26938 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26939 (Gather) [consumed]
    Node 26940 (Aggregate) [consumed]
      Node 26941 (Hash Join)
        Node 26942 (Seq Scan) - LEAF
        Node 26943 (Hash)
          Node 26944 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26938 | 26939, 26940 |
...
|------|------|--------|-----------|-----|--------|
| 26938 | Aggregate | 835.65 | 848.35 | 1.5% | pattern |
| 26941 | Hash Join | 813.24 | 807.62 | 0.7% | operator |
| 26942 | Seq Scan | 760.02 | 758.47 | 0.2% | operator |
| 26943 | Hash | 45.34 | 9.38 | 79.3% | operator |
| 26944 | Seq Scan | 39.67 | 12.70 | 68.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26944 (Seq Scan) - LEAF
...
### Step 2: Node 26942 (Seq Scan) - LEAF
...
### Step 5: Node 26938 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26939, 26940
- **Input Features:**
