...
**Test Query:** Q4_50_seed_401997519
...
```
Node 6516 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6517 (Gather Merge) [consumed]
    Node 6518 (Sort) [consumed]
      Node 6519 (Aggregate) [consumed]
        Node 6520 (Nested Loop)
          Node 6521 (Seq Scan) - LEAF
          Node 6522 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6516 | 6517, 6518, 6519 |
...
|------|------|--------|-----------|-----|--------|
| 6516 | Aggregate | 1052.64 | 952.19 | 9.5% | pattern |
| 6520 | Nested Loop | 1044.83 | 1255.45 | 20.2% | operator |
| 6521 | Seq Scan | 163.51 | 154.67 | 5.4% | operator |
| 6522 | Index Scan | 0.06 | 11.10 | 17526.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6521 (Seq Scan) - LEAF
...
### Step 2: Node 6522 (Index Scan) - LEAF
