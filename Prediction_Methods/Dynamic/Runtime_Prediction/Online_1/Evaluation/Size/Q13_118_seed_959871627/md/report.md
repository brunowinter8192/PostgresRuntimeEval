...
**Test Query:** Q13_118_seed_959871627
...
```
Node 25503 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25504 (Aggregate) [consumed]
    Node 25505 (Aggregate)
      Node 25506 (Hash Join) [PATTERN: 895c6e8c]
        Node 25507 (Seq Scan) [consumed] - LEAF
        Node 25508 (Hash) [consumed]
          Node 25509 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25503 | 25504, 25506, 25507, 25508 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25506 | 25503, 25504, 25507, 25508 |
...
|------|------|--------|-----------|-----|--------|
| 25503 | Sort | 934.94 | 1079.93 | 15.5% | pattern |
| 25505 | Aggregate | 928.89 | 999.15 | 7.6% | operator |
| 25506 | Hash Join | 714.94 | 470.31 | 34.2% | pattern |
| 25509 | Index Only Scan | 9.46 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25509 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25506 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25503, 25504, 25507, 25508
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1478958
...
### Step 4: Node 25503 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25504, 25506, 25507, 25508
- **Input Features:**
