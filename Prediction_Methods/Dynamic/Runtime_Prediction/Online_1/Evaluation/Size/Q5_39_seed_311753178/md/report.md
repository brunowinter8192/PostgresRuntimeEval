...
```
Node 8541 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 8542 (Aggregate) [consumed]
    Node 8543 (Gather Merge) [consumed]
      Node 8544 (Aggregate)
        Node 8545 (Sort) [PATTERN: 3e2d5a00]
          Node 8546 (Hash Join) [consumed]
            Node 8547 (Nested Loop)
              Node 8548 (Hash Join)
                Node 8549 (Seq Scan) - LEAF
                Node 8550 (Hash) [PATTERN: 444761fb]
                  Node 8551 (Hash Join) [consumed]
                    Node 8552 (Seq Scan) [consumed] - LEAF
                    Node 8553 (Hash) [consumed]
                      Node 8554 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 8550 | 8541, 8542, 8543, 8545, 8546, 8551, 8552, 8553, 8554 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 8541 | 8542, 8543, 8545, 8546, 8550, 8551, 8552, 8553, 8554 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 8545 | 8541, 8542, 8543, 8546, 8550, 8551, 8552, 8553, 8554 |
...
|------|------|--------|-----------|-----|--------|
| 8541 | Sort | 1062.91 | 2934.42 | 176.1% | pattern |
| 8544 | Aggregate | 1058.07 | 1128.74 | 6.7% | operator |
| 8545 | Sort | 1057.83 | 1835.96 | 73.6% | pattern |
| 8547 | Nested Loop | 1045.42 | 1188.57 | 13.7% | operator |
| 8559 | Hash | 3.73 | 18.67 | 400.6% | operator |
| 8548 | Hash Join | 217.29 | 253.07 | 16.5% | operator |
| 8558 | Index Scan | 0.07 | -0.22 | 401.4% | operator |
| 8560 | Seq Scan | 3.22 | 12.36 | 284.3% | operator |
| 8549 | Seq Scan | 165.20 | 159.81 | 3.3% | operator |
| 8550 | Hash | 39.32 | 46.85 | 19.2% | pattern |
| 8555 | Seq Scan | 0.01 | 11.81 | 131103.0% | operator |
| 8556 | Hash | 0.15 | 21.05 | 14221.9% | operator |
| 8557 | Seq Scan | 0.14 | 22.93 | 15825.9% | operator |
...
### Step 4: Node 8549 (Seq Scan) - LEAF
...
### Step 5: Node 8550 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 8541, 8542, 8543, 8545, 8546, 8551, 8552, 8553, 8554
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 8558 (Index Scan) - LEAF
...
### Step 8: Node 8560 (Seq Scan) - LEAF
...
### Step 11: Node 8545 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 8541, 8542, 8543, 8546, 8550, 8551, 8552, 8553, 8554
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 8541 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 8542, 8543, 8545, 8546, 8550, 8551, 8552, 8553, 8554
- **Input Features:**
