...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4881 | 4882, 4883, 4884, 4886, 4887, 4888 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4886 | 4881, 4882, 4883, 4884, 4887, 4888 |
...
|------|------|--------|-----------|-----|--------|
| 4881 | Limit | 1206.91 | 1151.18 | 4.6% | pattern |
| 4885 | Nested Loop | 1172.60 | 1193.49 | 1.8% | operator |
| 4886 | Hash Join | 210.85 | 242.56 | 15.0% | pattern |
| 4890 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4889 | Seq Scan | 28.48 | 38.54 | 35.3% | operator |
...
- **Consumes:** Nodes 4881, 4882, 4883, 4884, 4887, 4888
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47595
  - HashJoin_nt1=236853
  ...
  - HashJoin_total_cost=37344.3900
  - Hash_Inner_np=0
  - Hash_Inner_nt=12559
...
- **Output:** st=29.69, rt=242.56

### Step 3: Node 4890 (Index Scan) - LEAF
...
- **Output:** st=122.22, rt=1193.49

### Step 5: Node 4881 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4882, 4883, 4884, 4886, 4887, 4888
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=315640
  - Aggregate_Outer_nt1=315640
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110617.4400
  - Aggregate_Outer_total_cost=114562.9400
  - Gather_Outer_np=0
