...
**Test Query:** Q6_73_seed_590690232
...
```
Node 10381 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10382 (Gather) [consumed]
    Node 10383 (Aggregate) [consumed]
      Node 10384 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10381 | 10382, 10383 |
...
|------|------|--------|-----------|-----|--------|
| 10381 | Aggregate | 773.59 | 850.06 | 9.9% | pattern |
| 10384 | Seq Scan | 749.59 | 748.54 | 0.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10384 (Seq Scan) - LEAF
...
### Step 2: Node 10381 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10382, 10383
- **Input Features:**
