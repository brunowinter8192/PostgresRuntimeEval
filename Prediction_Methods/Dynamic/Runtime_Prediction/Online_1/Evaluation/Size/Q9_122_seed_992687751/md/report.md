...
```
Node 17086 (Sort) - ROOT
  Node 17087 (Aggregate)
    Node 17088 (Gather)
      Node 17089 (Aggregate)
        Node 17090 (Nested Loop)
          Node 17091 (Hash Join)
            Node 17092 (Seq Scan) - LEAF
            Node 17093 (Hash)
              Node 17094 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 17086 | Sort | 1197.71 | 1119.21 | 6.6% | operator |
| 17087 | Aggregate | 1197.58 | 897.16 | 25.1% | operator |
...
| 17091 | Hash Join | 981.31 | 633.14 | 35.5% | operator |
| 17103 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17092 | Seq Scan | 695.00 | 509.93 | 26.6% | operator |
| 17093 | Hash | 191.87 | 47.79 | 75.1% | operator |
| 17094 | Hash Join | 189.85 | 924.37 | 386.9% | operator |
...
### Step 10: Node 17092 (Seq Scan) - LEAF
...
### Step 13: Node 17103 (Index Scan) - LEAF
...
### Step 14: Node 17090 (Nested Loop)
