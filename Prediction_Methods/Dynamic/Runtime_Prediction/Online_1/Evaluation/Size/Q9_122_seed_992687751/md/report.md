...
**Test Query:** Q9_122_seed_992687751
...
```
Node 17086 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 17087 (Aggregate) [consumed]
    Node 17088 (Gather)
      Node 17089 (Aggregate)
        Node 17090 (Nested Loop)
          Node 17091 (Hash Join) [PATTERN: bb930825]
            Node 17092 (Seq Scan) [consumed] - LEAF
            Node 17093 (Hash) [consumed]
              Node 17094 (Hash Join) [consumed]
                Node 17095 (Hash Join)
                  Node 17096 (Nested Loop)
                    Node 17097 (Seq Scan) - LEAF
                    Node 17098 (Index Scan) - LEAF
                  Node 17099 (Hash)
                    Node 17100 (Seq Scan) - LEAF
                Node 17101 (Hash)
                  Node 17102 (Seq Scan) - LEAF
          Node 17103 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17091 | 17086, 17087, 17092, 17093, 17094 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17086 | 17087, 17091, 17092, 17093, 17094 |
...
|------|------|--------|-----------|-----|--------|
| 17086 | Sort | 1197.71 | 1045.06 | 12.7% | pattern |
| 17088 | Gather | 1196.70 | 964.74 | 19.4% | operator |
| 17089 | Aggregate | 1178.35 | 1106.30 | 6.1% | operator |
| 17090 | Nested Loop | 1153.80 | 1252.17 | 8.5% | operator |
| 17091 | Hash Join | 981.31 | 134.80 | 86.3% | pattern |
| 17103 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17095 | Hash Join | 175.60 | 837.58 | 377.0% | operator |
| 17101 | Hash | 13.63 | 14.95 | 9.7% | operator |
| 17096 | Nested Loop | 169.52 | 1251.77 | 638.4% | operator |
| 17099 | Hash | 3.88 | 15.94 | 310.5% | operator |
| 17102 | Seq Scan | 13.62 | 2.94 | 78.4% | operator |
| 17097 | Seq Scan | 20.24 | 44.10 | 117.9% | operator |
| 17098 | Index Scan | 0.08 | -1.39 | 1793.3% | operator |
| 17100 | Seq Scan | 3.38 | 9.45 | 179.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 17097 (Seq Scan) - LEAF
...
### Step 2: Node 17098 (Index Scan) - LEAF
...
### Step 3: Node 17100 (Seq Scan) - LEAF
...
### Step 6: Node 17102 (Seq Scan) - LEAF
...
### Step 9: Node 17091 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17086, 17087, 17092, 17093, 17094
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17103 (Index Scan) - LEAF
...
### Step 11: Node 17090 (Nested Loop)
...
### Step 14: Node 17086 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17087, 17091, 17092, 17093, 17094
- **Input Features:**
