...
**Test Query:** Q7_98_seed_795791007
...
```
Node 13147 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 13148 (Gather Merge) [consumed]
    Node 13149 (Sort)
      Node 13150 (Hash Join)
        Node 13151 (Nested Loop)
          Node 13152 (Hash Join) [PATTERN: 895c6e8c]
            Node 13153 (Seq Scan) [consumed] - LEAF
            Node 13154 (Hash) [consumed]
              Node 13155 (Hash Join) [PATTERN: f4cb205a]
                Node 13156 (Seq Scan) [consumed] - LEAF
                Node 13157 (Hash) [consumed]
                  Node 13158 (Seq Scan) [consumed] - LEAF
          Node 13159 (Index Scan) - LEAF
        Node 13160 (Hash)
          Node 13161 (Hash Join) [PATTERN: f4cb205a]
            Node 13162 (Seq Scan) [consumed] - LEAF
            Node 13163 (Hash) [consumed]
              Node 13164 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 13155 | 13147, 13148, 13152, 13153, 13154, 13156, 13157, 13158, 13161, 13162, 13163, 13164 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 13161 | 13147, 13148, 13152, 13153, 13154, 13155, 13156, 13157, 13158, 13162, 13163, 13164 |
| Aggregate -> Gather Merge (Out | 2724c080 | 13147 | 13148, 13152, 13153, 13154, 13155, 13156, 13157, 13158, 13161, 13162, 13163, 13164 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 13152 | 13147, 13148, 13153, 13154, 13155, 13156, 13157, 13158, 13161, 13162, 13163, 13164 |
...
|------|------|--------|-----------|-----|--------|
| 13147 | Aggregate | 1236.74 | 1163.13 | 6.0% | pattern |
| 13149 | Sort | 1229.92 | 1109.16 | 9.8% | operator |
| 13150 | Hash Join | 1229.26 | 843.11 | 31.4% | operator |
| 13151 | Nested Loop | 1222.50 | 1215.99 | 0.5% | operator |
| 13160 | Hash | 2.82 | 27.74 | 884.5% | operator |
| 13152 | Hash Join | 220.64 | 304.89 | 38.2% | pattern |
| 13159 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 13161 | Hash Join | 2.77 | 429.36 | 15378.1% | pattern |
| 13155 | Hash Join | 35.48 | 429.38 | 1110.3% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 13155 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 13147, 13148, 13152, 13153, 13154, 13156, 13157, 13158, 13161, 13162, 13163, 13164
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5000
  - HashJoin_nt1=62500
...
### Step 2: Node 13152 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 13147, 13148, 13153, 13154, 13155, 13156, 13157, 13158, 13161, 13162, 13163, 13164
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=38710
  - HashJoin_nt1=483871
...
### Step 3: Node 13159 (Index Scan) - LEAF
...
### Step 4: Node 13161 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 13147, 13148, 13152, 13153, 13154, 13155, 13156, 13157, 13158, 13162, 13163, 13164
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=800
  - HashJoin_nt1=10000
...
### Step 9: Node 13147 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 13148, 13152, 13153, 13154, 13155, 13156, 13157, 13158, 13161, 13162, 13163, 13164
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
