...
```
Node 13147 (Aggregate) - ROOT
  Node 13148 (Gather Merge)
    Node 13149 (Sort)
      Node 13150 (Hash Join)
        Node 13151 (Nested Loop)
          Node 13152 (Hash Join)
            Node 13153 (Seq Scan) - LEAF
            Node 13154 (Hash)
              Node 13155 (Hash Join)
                Node 13156 (Seq Scan) - LEAF
                Node 13157 (Hash)
                  Node 13158 (Seq Scan) - LEAF
          Node 13159 (Index Scan) - LEAF
        Node 13160 (Hash)
          Node 13161 (Hash Join)
            Node 13162 (Seq Scan) - LEAF
            Node 13163 (Hash)
              Node 13164 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 13147 | Aggregate | 1236.74 | 1209.26 | 2.2% | operator |
| 13148 | Gather Merge | 1235.58 | 1142.98 | 7.5% | operator |
| 13149 | Sort | 1229.92 | 1109.13 | 9.8% | operator |
| 13150 | Hash Join | 1229.26 | 842.59 | 31.5% | operator |
| 13151 | Nested Loop | 1222.50 | 1216.16 | 0.5% | operator |
| 13160 | Hash | 2.82 | 17.53 | 522.1% | operator |
| 13152 | Hash Join | 220.64 | 384.47 | 74.3% | operator |
| 13159 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 13161 | Hash Join | 2.77 | 85.17 | 2970.5% | operator |
| 13153 | Seq Scan | 157.40 | 201.16 | 27.8% | operator |
| 13154 | Hash | 37.36 | 19.59 | 47.6% | operator |
| 13162 | Seq Scan | 2.44 | 11.47 | 370.5% | operator |
| 13163 | Hash | 0.01 | 16.89 | 120572.0% | operator |
| 13155 | Hash Join | 35.48 | 92.20 | 159.9% | operator |
| 13164 | Seq Scan | 0.01 | 45.79 | 457823.2% | operator |
| 13156 | Seq Scan | 34.30 | 21.86 | 36.3% | operator |
| 13157 | Hash | 0.01 | 16.89 | 140684.0% | operator |
| 13158 | Seq Scan | 0.01 | 45.79 | 457823.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 13158 (Seq Scan) - LEAF
...
### Step 2: Node 13156 (Seq Scan) - LEAF
...
### Step 5: Node 13164 (Seq Scan) - LEAF
...
### Step 6: Node 13153 (Seq Scan) - LEAF
...
### Step 8: Node 13162 (Seq Scan) - LEAF
...
### Step 11: Node 13159 (Index Scan) - LEAF
...
### Step 13: Node 13151 (Nested Loop)
...
### Step 17: Node 13148 (Gather Merge)
...
### Step 18: Node 13147 (Aggregate) - ROOT
