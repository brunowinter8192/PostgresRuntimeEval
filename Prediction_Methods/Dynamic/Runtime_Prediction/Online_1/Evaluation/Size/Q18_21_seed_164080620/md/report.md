...
**Test Query:** Q18_21_seed_164080620
...
```
Node 29828 (Limit) - ROOT
  Node 29829 (Sort)
    Node 29830 (Aggregate)
      Node 29831 (Gather Merge)
        Node 29832 (Incremental Sort)
          Node 29833 (Nested Loop)
            Node 29834 (Merge Join)
              Node 29835 (Sort)
                Node 29836 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29837 (Seq Scan) [consumed] - LEAF
                  Node 29838 (Hash) [consumed]
                    Node 29839 (Aggregate)
                      Node 29840 (Index Scan) - LEAF
              Node 29841 (Sort)
                Node 29842 (Seq Scan) - LEAF
            Node 29843 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29836 | 29837, 29838 |
...
|------|------|--------|-----------|-----|--------|
| 29828 | Limit | 3024.91 | 1175.21 | 61.1% | operator |
| 29829 | Sort | 2916.07 | 1127.81 | 61.3% | operator |
| 29830 | Aggregate | 2916.03 | 1073.15 | 63.2% | operator |
| 29831 | Gather Merge | 2916.01 | 1073.95 | 63.2% | operator |
| 29832 | Incremental Sort | 2897.23 | 0.00 | 100.0% | operator |
| 29833 | Nested Loop | 2897.18 | 1111.34 | 61.6% | operator |
| 29834 | Merge Join | 2897.11 | 0.00 | 100.0% | operator |
| 29843 | Index Scan | 0.03 | 0.05 | 80.5% | operator |
| 29835 | Sort | 2829.25 | 1095.58 | 61.3% | operator |
| 29841 | Sort | 65.08 | 1074.66 | 1551.3% | operator |
| 29836 | Hash Join | 2829.24 | 471.07 | 83.3% | pattern |
| 29842 | Seq Scan | 52.98 | 18.25 | 65.6% | operator |
| 29839 | Aggregate | 2600.71 | 1073.15 | 58.7% | operator |
| 29840 | Index Scan | 2107.14 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29840 (Index Scan) - LEAF
...
### Step 3: Node 29836 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29837, 29838
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29842 (Seq Scan) - LEAF
...
### Step 7: Node 29834 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29843 (Index Scan) - LEAF
...
### Step 10: Node 29832 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29831 (Gather Merge)
