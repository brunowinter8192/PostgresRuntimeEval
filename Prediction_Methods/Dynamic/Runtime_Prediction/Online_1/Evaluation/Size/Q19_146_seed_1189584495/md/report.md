...
```
Node 31570 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31571 (Gather) [consumed]
    Node 31572 (Aggregate) [consumed]
      Node 31573 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31570 | 31571, 31572 |
...
|------|------|--------|-----------|-----|--------|
| 31570 | Aggregate | 852.35 | 831.20 | 2.5% | pattern |
| 31573 | Hash Join | 832.42 | 766.05 | 8.0% | operator |
...
### Step 5: Node 31570 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31571, 31572
- **Input Features:**
