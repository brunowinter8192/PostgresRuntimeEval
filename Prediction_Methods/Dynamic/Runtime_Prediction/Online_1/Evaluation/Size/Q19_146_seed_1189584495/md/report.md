...
**Test Query:** Q19_146_seed_1189584495
**Timestamp:** 2026-01-18 20:31:04
...
```
Node 31570 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31571 (Gather) [consumed]
    Node 31572 (Aggregate) [consumed]
      Node 31573 (Hash Join) [consumed]
        Node 31574 (Seq Scan) - LEAF
        Node 31575 (Hash)
          Node 31576 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31570 | 31571, 31572, 31573 |
...
|------|------|--------|-----------|-----|--------|
| 31570 | Aggregate | 852.35 | 829.30 | 2.7% | pattern |
| 31574 | Seq Scan | 782.88 | 743.46 | 5.0% | operator |
| 31575 | Hash | 48.01 | 8.29 | 82.7% | operator |
| 31576 | Seq Scan | 47.92 | 23.76 | 50.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31576 (Seq Scan) - LEAF
...
### Step 2: Node 31574 (Seq Scan) - LEAF
...
### Step 4: Node 31570 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31571, 31572, 31573
- **Input Features:**
  ...
  - HashJoin_Outer_nt1=22486
  - HashJoin_Outer_nt2=202
  - HashJoin_Outer_parallel_workers=0
  - HashJoin_Outer_plan_width=12
  - HashJoin_Outer_reltuples=0.0000
  - HashJoin_Outer_sel=0.0000
  - HashJoin_Outer_startup_cost=7672.1900
  - HashJoin_Outer_total_cost=156338.5100
- **Output:** st=824.25, rt=829.30
