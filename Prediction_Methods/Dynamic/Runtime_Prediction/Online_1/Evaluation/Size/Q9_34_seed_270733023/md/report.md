...
**Test Query:** Q9_34_seed_270733023
...
```
Node 18047 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18048 (Aggregate) [consumed]
    Node 18049 (Gather)
      Node 18050 (Aggregate)
        Node 18051 (Nested Loop)
          Node 18052 (Hash Join) [PATTERN: bb930825]
            Node 18053 (Seq Scan) [consumed] - LEAF
            Node 18054 (Hash) [consumed]
              Node 18055 (Hash Join) [consumed]
                Node 18056 (Hash Join)
                  Node 18057 (Nested Loop)
                    Node 18058 (Seq Scan) - LEAF
                    Node 18059 (Index Scan) - LEAF
                  Node 18060 (Hash)
                    Node 18061 (Seq Scan) - LEAF
                Node 18062 (Hash)
                  Node 18063 (Seq Scan) - LEAF
          Node 18064 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18052 | 18047, 18048, 18053, 18054, 18055 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18047 | 18048, 18052, 18053, 18054, 18055 |
...
|------|------|--------|-----------|-----|--------|
| 18047 | Sort | 1206.19 | 1044.54 | 13.4% | pattern |
| 18049 | Gather | 1204.74 | 965.01 | 19.9% | operator |
| 18050 | Aggregate | 1185.51 | 1129.15 | 4.8% | operator |
| 18051 | Nested Loop | 1160.23 | 1252.17 | 7.9% | operator |
| 18052 | Hash Join | 982.77 | 134.80 | 86.3% | pattern |
| 18064 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18056 | Hash Join | 156.01 | 837.52 | 436.9% | operator |
| 18062 | Hash | 12.94 | 14.95 | 15.5% | operator |
| 18057 | Nested Loop | 150.26 | 1251.76 | 733.1% | operator |
| 18060 | Hash | 3.71 | 15.94 | 329.8% | operator |
| 18063 | Seq Scan | 12.93 | 2.94 | 77.3% | operator |
| 18058 | Seq Scan | 19.81 | 44.23 | 123.3% | operator |
| 18059 | Index Scan | 0.07 | -1.39 | 2028.4% | operator |
| 18061 | Seq Scan | 3.23 | 9.45 | 192.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 18058 (Seq Scan) - LEAF
...
### Step 2: Node 18059 (Index Scan) - LEAF
...
### Step 3: Node 18061 (Seq Scan) - LEAF
...
### Step 6: Node 18063 (Seq Scan) - LEAF
...
### Step 9: Node 18052 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18047, 18048, 18053, 18054, 18055
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18064 (Index Scan) - LEAF
...
### Step 11: Node 18051 (Nested Loop)
...
### Step 14: Node 18047 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18048, 18052, 18053, 18054, 18055
- **Input Features:**
