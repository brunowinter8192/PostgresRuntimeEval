...
**Test Query:** Q12_76_seed_615302325
...
```
Node 25181 (Aggregate) - ROOT
  Node 25182 (Gather Merge)
    Node 25183 (Aggregate)
      Node 25184 (Sort)
        Node 25185 (Nested Loop)
          Node 25186 (Seq Scan) - LEAF
          Node 25187 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 25181 | Aggregate | 981.97 | 919.06 | 6.4% | operator |
| 25182 | Gather Merge | 981.95 | 1111.84 | 13.2% | operator |
| 25183 | Aggregate | 961.86 | 895.30 | 6.9% | operator |
| 25184 | Sort | 961.04 | 1092.82 | 13.7% | operator |
| 25185 | Nested Loop | 960.07 | 1127.41 | 17.4% | operator |
| 25186 | Seq Scan | 820.79 | 745.19 | 9.2% | operator |
| 25187 | Index Scan | 0.03 | 0.07 | 166.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25186 (Seq Scan) - LEAF
...
### Step 2: Node 25187 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - st2=0.1246
  - startup_cost=0.4300
  - total_cost=147178.3900
- **Output:** st=38.32, rt=1127.41

### Step 4: Node 25184 (Sort)
...
- **Input Features:**
  ...
  - st1=38.3244
  - st2=0.0000
  - startup_cost=147539.6200
  - total_cost=147554.0700
- **Output:** st=1092.40, rt=1092.82

### Step 5: Node 25183 (Aggregate)
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=147539.6200
  - total_cost=147655.3100
- **Output:** st=868.95, rt=895.30

### Step 6: Node 25182 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=868.9520
  - st2=0.0000
  - startup_cost=148539.7000
  - total_cost=148659.6000
- **Output:** st=1109.22, rt=1111.84

### Step 7: Node 25181 (Aggregate) - ROOT
