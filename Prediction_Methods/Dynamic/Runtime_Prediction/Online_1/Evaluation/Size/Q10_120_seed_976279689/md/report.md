...
**Test Query:** Q10_120_seed_976279689
...
```
Node 19656 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 19657 (Sort) [consumed]
    Node 19658 (Aggregate) [consumed]
      Node 19659 (Gather) [consumed]
        Node 19660 (Hash Join)
          Node 19661 (Hash Join) [PATTERN: 2e0f44ef]
            Node 19662 (Nested Loop) [consumed]
              Node 19663 (Seq Scan) - LEAF
              Node 19664 (Index Scan) - LEAF
            Node 19665 (Hash) [consumed]
              Node 19666 (Seq Scan) - LEAF
          Node 19667 (Hash)
            Node 19668 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19656 | 19657, 19658, 19659, 19661, 19662, 19665 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 19661 | 19656, 19657, 19658, 19659, 19662, 19665 |
...
|------|------|--------|-----------|-----|--------|
| 19656 | Limit | 1147.59 | 1199.47 | 4.5% | pattern |
| 19660 | Hash Join | 1098.02 | 1095.40 | 0.2% | operator |
| 19661 | Hash Join | 1095.19 | 1120.19 | 2.3% | pattern |
| 19667 | Hash | 0.02 | 15.71 | 68207.7% | operator |
| 19668 | Seq Scan | 0.02 | 6.98 | 43516.9% | operator |
| 19663 | Seq Scan | 162.71 | 159.75 | 1.8% | operator |
| 19664 | Index Scan | 0.06 | -0.52 | 935.8% | operator |
| 19666 | Seq Scan | 25.71 | 26.64 | 3.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 19663 (Seq Scan) - LEAF
...
### Step 2: Node 19664 (Index Scan) - LEAF
...
### Step 3: Node 19666 (Seq Scan) - LEAF
...
### Step 4: Node 19668 (Seq Scan) - LEAF
...
### Step 5: Node 19661 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 19656, 19657, 19658, 19659, 19662, 19665
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=17639
  - HashJoin_nt1=17639
...
### Step 8: Node 19656 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19657, 19658, 19659, 19661, 19662, 19665
- **Input Features:**
