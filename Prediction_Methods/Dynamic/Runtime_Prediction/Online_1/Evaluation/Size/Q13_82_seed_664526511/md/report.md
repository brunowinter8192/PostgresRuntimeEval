...
**Test Query:** Q13_82_seed_664526511
...
```
Node 26280 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26281 (Aggregate) [consumed]
    Node 26282 (Aggregate)
      Node 26283 (Hash Join) [PATTERN: 895c6e8c]
        Node 26284 (Seq Scan) [consumed] - LEAF
        Node 26285 (Hash) [consumed]
          Node 26286 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26280 | 26281, 26283, 26284, 26285 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26283 | 26280, 26281, 26284, 26285 |
...
|------|------|--------|-----------|-----|--------|
| 26280 | Sort | 922.04 | 1079.94 | 17.1% | pattern |
| 26282 | Aggregate | 915.87 | 999.76 | 9.2% | operator |
| 26283 | Hash Join | 710.89 | 470.31 | 33.8% | pattern |
| 26286 | Index Only Scan | 10.02 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26286 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26283 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26280, 26281, 26284, 26285
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 26280 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26281, 26283, 26284, 26285
- **Input Features:**
