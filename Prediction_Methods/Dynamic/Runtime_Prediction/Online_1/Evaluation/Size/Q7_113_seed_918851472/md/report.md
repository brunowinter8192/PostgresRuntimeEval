...
```
Node 10753 (Aggregate) - ROOT
  Node 10754 (Gather Merge)
    Node 10755 (Sort)
      Node 10756 (Hash Join)
        Node 10757 (Nested Loop)
          Node 10758 (Hash Join)
            Node 10759 (Seq Scan) - LEAF
            Node 10760 (Hash)
              Node 10761 (Hash Join)
                Node 10762 (Seq Scan) - LEAF
                Node 10763 (Hash)
                  Node 10764 (Seq Scan) - LEAF
          Node 10765 (Index Scan) - LEAF
        Node 10766 (Hash)
          Node 10767 (Hash Join)
            Node 10768 (Seq Scan) - LEAF
            Node 10769 (Hash)
              Node 10770 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 10753 | Aggregate | 1203.55 | 1209.26 | 0.5% | operator |
| 10754 | Gather Merge | 1202.50 | 1142.98 | 4.9% | operator |
| 10755 | Sort | 1195.59 | 1109.13 | 7.2% | operator |
| 10756 | Hash Join | 1194.95 | 842.59 | 29.5% | operator |
| 10757 | Nested Loop | 1187.38 | 1216.16 | 2.4% | operator |
| 10766 | Hash | 3.81 | 17.53 | 359.7% | operator |
| 10758 | Hash Join | 215.16 | 384.47 | 78.7% | operator |
| 10765 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 10767 | Hash Join | 3.77 | 85.17 | 2161.1% | operator |
| 10759 | Seq Scan | 153.91 | 201.16 | 30.7% | operator |
| 10760 | Hash | 35.65 | 19.59 | 45.0% | operator |
| 10768 | Seq Scan | 3.45 | 11.47 | 232.4% | operator |
| 10769 | Hash | 0.02 | 16.89 | 105488.0% | operator |
| 10761 | Hash Join | 35.35 | 92.20 | 160.8% | operator |
| 10770 | Seq Scan | 0.01 | 45.79 | 381502.6% | operator |
| 10762 | Seq Scan | 34.22 | 21.86 | 36.1% | operator |
| 10763 | Hash | 0.01 | 16.89 | 168840.8% | operator |
| 10764 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10764 (Seq Scan) - LEAF
...
### Step 2: Node 10762 (Seq Scan) - LEAF
...
### Step 5: Node 10770 (Seq Scan) - LEAF
...
### Step 6: Node 10759 (Seq Scan) - LEAF
...
### Step 8: Node 10768 (Seq Scan) - LEAF
...
### Step 11: Node 10765 (Index Scan) - LEAF
...
### Step 13: Node 10757 (Nested Loop)
...
### Step 17: Node 10754 (Gather Merge)
...
### Step 18: Node 10753 (Aggregate) - ROOT
