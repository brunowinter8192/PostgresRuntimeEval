...
**Test Query:** Q1_122_seed_992687751
...
```
Node 121 (Aggregate) - ROOT
  Node 122 (Gather Merge)
    Node 123 (Sort) [PATTERN: 1d35fb97]
      Node 124 (Aggregate) [consumed]
        Node 125 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 123 | 124 |
...
|------|------|--------|-----------|-----|--------|
| 121 | Aggregate | 929.19 | 1196.02 | 28.7% | operator |
| 122 | Gather Merge | 929.10 | 1165.94 | 25.5% | operator |
| 123 | Sort | 908.50 | 1201.00 | 32.2% | pattern |
| 125 | Seq Scan | 507.99 | 678.36 | 33.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 125 (Seq Scan) - LEAF
...
### Step 2: Node 123 (Sort) - PATTERN ROOT
...
### Step 4: Node 121 (Aggregate) - ROOT
