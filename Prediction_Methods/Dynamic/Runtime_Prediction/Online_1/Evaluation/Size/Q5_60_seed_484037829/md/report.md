...
**Test Query:** Q5_60_seed_484037829
...
```
Node 9021 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 9022 (Aggregate) [consumed]
    Node 9023 (Gather Merge) [consumed]
      Node 9024 (Aggregate)
        Node 9025 (Sort) [PATTERN: 3e2d5a00]
          Node 9026 (Hash Join) [consumed]
            Node 9027 (Nested Loop)
              Node 9028 (Hash Join)
                Node 9029 (Seq Scan) - LEAF
                Node 9030 (Hash) [PATTERN: 444761fb]
                  Node 9031 (Hash Join) [consumed]
                    Node 9032 (Seq Scan) [consumed] - LEAF
                    Node 9033 (Hash) [consumed]
                      Node 9034 (Hash Join) [consumed]
                        Node 9035 (Seq Scan) - LEAF
                        Node 9036 (Hash)
                          Node 9037 (Seq Scan) - LEAF
              Node 9038 (Index Scan) - LEAF
            Node 9039 (Hash)
              Node 9040 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 9030 | 9021, 9022, 9023, 9025, 9026, 9031, 9032, 9033, 9034 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 9021 | 9022, 9023, 9025, 9026, 9030, 9031, 9032, 9033, 9034 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 9025 | 9021, 9022, 9023, 9026, 9030, 9031, 9032, 9033, 9034 |
...
|------|------|--------|-----------|-----|--------|
| 9021 | Sort | 1063.31 | 2934.42 | 176.0% | pattern |
| 9024 | Aggregate | 1058.17 | 1128.76 | 6.7% | operator |
| 9025 | Sort | 1057.93 | 1835.93 | 73.5% | pattern |
| 9027 | Nested Loop | 1046.74 | 1188.47 | 13.5% | operator |
| 9039 | Hash | 2.69 | 18.67 | 594.1% | operator |
| 9028 | Hash Join | 216.84 | 253.07 | 16.7% | operator |
| 9038 | Index Scan | 0.07 | -0.22 | 401.4% | operator |
| 9040 | Seq Scan | 2.17 | 12.36 | 468.3% | operator |
| 9029 | Seq Scan | 166.87 | 159.81 | 4.2% | operator |
| 9030 | Hash | 35.57 | 46.85 | 31.7% | pattern |
| 9035 | Seq Scan | 0.01 | 11.81 | 147503.4% | operator |
| 9036 | Hash | 0.11 | 21.05 | 19214.9% | operator |
| 9037 | Seq Scan | 0.11 | 22.93 | 21535.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 9037 (Seq Scan) - LEAF
...
### Step 2: Node 9035 (Seq Scan) - LEAF
...
### Step 4: Node 9029 (Seq Scan) - LEAF
...
### Step 5: Node 9030 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 9021, 9022, 9023, 9025, 9026, 9031, 9032, 9033, 9034
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 9038 (Index Scan) - LEAF
...
### Step 8: Node 9040 (Seq Scan) - LEAF
...
### Step 11: Node 9025 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 9021, 9022, 9023, 9026, 9030, 9031, 9032, 9033, 9034
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 9021 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 9022, 9023, 9025, 9026, 9030, 9031, 9032, 9033, 9034
- **Input Features:**
