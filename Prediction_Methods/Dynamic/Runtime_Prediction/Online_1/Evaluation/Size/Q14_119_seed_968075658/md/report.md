...
```
Node 26560 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26561 (Gather) [consumed]
    Node 26562 (Aggregate) [consumed]
      Node 26563 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26560 | 26561, 26562, 26563 |
...
|------|------|--------|-----------|-----|--------|
| 26560 | Aggregate | 792.65 | 857.14 | 8.1% | pattern |
...
### Step 4: Node 26560 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26561, 26562, 26563
- **Input Features:**
