...
**Test Query:** Q13_99_seed_803995038
...
```
Node 26406 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26407 (Aggregate) [consumed]
    Node 26408 (Aggregate)
      Node 26409 (Hash Join) [PATTERN: 895c6e8c]
        Node 26410 (Seq Scan) [consumed] - LEAF
        Node 26411 (Hash) [consumed]
          Node 26412 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26406 | 26407, 26409, 26410, 26411 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26409 | 26406, 26407, 26410, 26411 |
...
|------|------|--------|-----------|-----|--------|
| 26406 | Sort | 904.94 | 1079.94 | 19.3% | pattern |
| 26408 | Aggregate | 898.85 | 999.76 | 11.2% | operator |
| 26409 | Hash Join | 683.16 | 470.31 | 31.2% | pattern |
| 26412 | Index Only Scan | 9.68 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26412 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26409 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26406, 26407, 26410, 26411
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 26406 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26407, 26409, 26410, 26411
- **Input Features:**
