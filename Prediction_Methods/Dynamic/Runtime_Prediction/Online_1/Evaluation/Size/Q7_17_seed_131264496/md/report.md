...
```
Node 11545 (Aggregate) - ROOT
  Node 11546 (Gather Merge)
    Node 11547 (Sort)
      Node 11548 (Hash Join)
        Node 11549 (Nested Loop)
          Node 11550 (Hash Join)
            Node 11551 (Seq Scan) - LEAF
            Node 11552 (Hash)
              Node 11553 (Hash Join)
                Node 11554 (Seq Scan) - LEAF
                Node 11555 (Hash)
                  Node 11556 (Seq Scan) - LEAF
          Node 11557 (Index Scan) - LEAF
        Node 11558 (Hash)
          Node 11559 (Hash Join)
            Node 11560 (Seq Scan) - LEAF
            Node 11561 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 11545 | Aggregate | 1192.45 | 1209.26 | 1.4% | operator |
| 11546 | Gather Merge | 1191.29 | 1142.98 | 4.1% | operator |
| 11547 | Sort | 1186.16 | 1109.13 | 6.5% | operator |
| 11548 | Hash Join | 1185.49 | 842.59 | 28.9% | operator |
| 11549 | Nested Loop | 1178.33 | 1216.16 | 3.2% | operator |
| 11558 | Hash | 3.35 | 17.53 | 423.0% | operator |
| 11550 | Hash Join | 216.15 | 384.47 | 77.9% | operator |
| 11557 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 11559 | Hash Join | 3.31 | 85.17 | 2476.4% | operator |
| 11551 | Seq Scan | 152.46 | 201.16 | 31.9% | operator |
| 11552 | Hash | 37.75 | 19.59 | 48.1% | operator |
| 11560 | Seq Scan | 2.96 | 11.47 | 288.2% | operator |
| 11561 | Hash | 0.01 | 16.89 | 120572.0% | operator |
| 11553 | Hash Join | 36.43 | 92.20 | 153.1% | operator |
| 11562 | Seq Scan | 0.01 | 45.79 | 416193.8% | operator |
| 11554 | Seq Scan | 35.29 | 21.86 | 38.1% | operator |
| 11555 | Hash | 0.01 | 16.89 | 187612.0% | operator |
| 11556 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |
...
### Step 2: Node 11554 (Seq Scan) - LEAF
...
### Step 5: Node 11562 (Seq Scan) - LEAF
...
### Step 6: Node 11551 (Seq Scan) - LEAF
...
### Step 8: Node 11560 (Seq Scan) - LEAF
...
### Step 11: Node 11557 (Index Scan) - LEAF
...
### Step 13: Node 11549 (Nested Loop)
...
### Step 17: Node 11546 (Gather Merge)
...
### Step 18: Node 11545 (Aggregate) - ROOT
