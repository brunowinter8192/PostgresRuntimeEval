...
```
Node 18862 (Sort) - ROOT
  Node 18863 (Aggregate)
    Node 18864 (Gather)
      Node 18865 (Aggregate)
        Node 18866 (Nested Loop)
          Node 18867 (Hash Join)
            Node 18868 (Seq Scan) - LEAF
            Node 18869 (Hash)
              Node 18870 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 18862 | Sort | 1217.30 | 1117.85 | 8.2% | operator |
| 18863 | Aggregate | 1217.16 | 896.88 | 26.3% | operator |
...
| 18867 | Hash Join | 1002.33 | 632.42 | 36.9% | operator |
| 18879 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18868 | Seq Scan | 730.58 | 509.93 | 30.2% | operator |
| 18869 | Hash | 178.55 | 47.34 | 73.5% | operator |
| 18870 | Hash Join | 176.76 | 924.15 | 422.8% | operator |
...
### Step 10: Node 18868 (Seq Scan) - LEAF
...
### Step 13: Node 18879 (Index Scan) - LEAF
...
### Step 14: Node 18866 (Nested Loop)
