...
```
Node 17574 (Sort) - ROOT
  Node 17575 (Aggregate)
    Node 17576 (Gather)
      Node 17577 (Aggregate)
        Node 17578 (Nested Loop)
          Node 17579 (Hash Join)
            Node 17580 (Seq Scan) - LEAF
            Node 17581 (Hash)
              Node 17582 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 17574 | Sort | 1207.02 | 1115.66 | 7.6% | operator |
| 17575 | Aggregate | 1206.89 | 905.86 | 24.9% | operator |
...
| 17579 | Hash Join | 992.35 | 631.18 | 36.4% | operator |
| 17591 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17580 | Seq Scan | 713.29 | 509.93 | 28.5% | operator |
| 17581 | Hash | 184.39 | 46.59 | 74.7% | operator |
| 17582 | Hash Join | 178.39 | 923.64 | 417.8% | operator |
...
### Step 10: Node 17580 (Seq Scan) - LEAF
...
### Step 13: Node 17591 (Index Scan) - LEAF
...
### Step 14: Node 17578 (Nested Loop)
