...
```
Node 18916 (Sort) - ROOT
  Node 18917 (Aggregate)
    Node 18918 (Gather)
      Node 18919 (Aggregate)
        Node 18920 (Nested Loop)
          Node 18921 (Hash Join)
            Node 18922 (Seq Scan) - LEAF
            Node 18923 (Hash)
              Node 18924 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 18916 | Sort | 1206.15 | 1118.63 | 7.3% | operator |
| 18917 | Aggregate | 1205.99 | 896.66 | 25.6% | operator |
...
| 18921 | Hash Join | 989.56 | 632.78 | 36.1% | operator |
| 18933 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18922 | Seq Scan | 715.14 | 509.93 | 28.7% | operator |
| 18923 | Hash | 180.69 | 47.56 | 73.7% | operator |
| 18924 | Hash Join | 178.69 | 924.26 | 417.3% | operator |
...
### Step 10: Node 18922 (Seq Scan) - LEAF
...
### Step 13: Node 18933 (Index Scan) - LEAF
...
### Step 14: Node 18920 (Nested Loop)
