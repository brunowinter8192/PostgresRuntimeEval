...
**Test Query:** Q9_135_seed_1099340154
...
```
Node 17339 (Sort) - ROOT
  Node 17340 (Aggregate)
    Node 17341 (Gather)
      Node 17342 (Aggregate)
        Node 17343 (Nested Loop)
          Node 17344 (Hash Join)
            Node 17345 (Seq Scan) - LEAF
            Node 17346 (Hash)
              Node 17347 (Hash Join)
                Node 17348 (Hash Join)
                  Node 17349 (Nested Loop)
                    Node 17350 (Seq Scan) - LEAF
                    Node 17351 (Index Scan) - LEAF
                  Node 17352 (Hash)
                    Node 17353 (Seq Scan) - LEAF
                Node 17354 (Hash)
                  Node 17355 (Seq Scan) - LEAF
          Node 17356 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 17339 | Sort | 1179.60 | 1119.51 | 5.1% | operator |
| 17340 | Aggregate | 1179.46 | 897.44 | 23.9% | operator |
| 17341 | Gather | 1178.44 | 964.64 | 18.1% | operator |
| 17342 | Aggregate | 1159.87 | 1095.61 | 5.5% | operator |
| 17343 | Nested Loop | 1134.82 | 1252.17 | 10.3% | operator |
| 17344 | Hash Join | 961.68 | 633.32 | 34.1% | operator |
| 17356 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17345 | Seq Scan | 686.58 | 509.93 | 25.7% | operator |
| 17346 | Hash | 178.44 | 47.91 | 73.2% | operator |
| 17347 | Hash Join | 175.99 | 924.43 | 425.3% | operator |
| 17348 | Hash Join | 162.54 | 837.61 | 415.3% | operator |
| 17354 | Hash | 12.80 | 14.95 | 16.8% | operator |
| 17349 | Nested Loop | 156.94 | 1251.77 | 697.6% | operator |
| 17352 | Hash | 3.34 | 15.94 | 377.1% | operator |
| 17355 | Seq Scan | 12.79 | 2.94 | 77.0% | operator |
| 17350 | Seq Scan | 22.00 | 44.03 | 100.2% | operator |
| 17351 | Index Scan | 0.07 | -1.39 | 1976.3% | operator |
| 17353 | Seq Scan | 2.89 | 9.45 | 226.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 17350 (Seq Scan) - LEAF
...
### Step 2: Node 17351 (Index Scan) - LEAF
...
### Step 3: Node 17353 (Seq Scan) - LEAF
...
### Step 6: Node 17355 (Seq Scan) - LEAF
...
- **Output:** st=105.85, rt=924.43

### Step 10: Node 17345 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=15099.9700
- **Output:** st=47.91, rt=47.91

### Step 12: Node 17344 (Hash Join)
...
- **Output:** st=73.96, rt=633.32

### Step 13: Node 17356 (Index Scan) - LEAF
...
### Step 14: Node 17343 (Nested Loop)
...
- **Input Features:**
  ...
  - st1=471.4344
  - st2=0.0000
  - startup_cost=216801.1400
  - total_cost=217703.3900
- **Output:** st=893.75, rt=897.44

### Step 18: Node 17339 (Sort) - ROOT
