...
**Test Query:** Q9_54_seed_434813643
...
```
Node 18444 (Sort) - ROOT
  Node 18445 (Aggregate)
    Node 18446 (Gather)
      Node 18447 (Aggregate)
        Node 18448 (Nested Loop)
          Node 18449 (Hash Join)
            Node 18450 (Seq Scan) - LEAF
            Node 18451 (Hash)
              Node 18452 (Hash Join)
                Node 18453 (Hash Join)
                  Node 18454 (Nested Loop)
                    Node 18455 (Seq Scan) - LEAF
                    Node 18456 (Index Scan) - LEAF
                  Node 18457 (Hash)
                    Node 18458 (Seq Scan) - LEAF
                Node 18459 (Hash)
                  Node 18460 (Seq Scan) - LEAF
          Node 18461 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 18444 | Sort | 1190.41 | 1119.51 | 6.0% | operator |
| 18445 | Aggregate | 1190.27 | 897.44 | 24.6% | operator |
| 18446 | Gather | 1189.13 | 964.64 | 18.9% | operator |
| 18447 | Aggregate | 1170.06 | 1095.61 | 6.4% | operator |
| 18448 | Nested Loop | 1145.32 | 1252.17 | 9.3% | operator |
| 18449 | Hash Join | 972.32 | 633.32 | 34.9% | operator |
| 18461 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18450 | Seq Scan | 698.87 | 509.93 | 27.0% | operator |
| 18451 | Hash | 180.82 | 47.91 | 73.5% | operator |
| 18452 | Hash Join | 178.74 | 924.43 | 417.2% | operator |
| 18453 | Hash Join | 164.72 | 837.61 | 408.5% | operator |
| 18459 | Hash | 13.39 | 14.95 | 11.7% | operator |
| 18454 | Nested Loop | 158.97 | 1251.77 | 687.4% | operator |
| 18457 | Hash | 3.76 | 15.94 | 323.6% | operator |
| 18460 | Seq Scan | 13.38 | 2.94 | 78.0% | operator |
| 18455 | Seq Scan | 18.55 | 44.03 | 137.4% | operator |
| 18456 | Index Scan | 0.08 | -1.39 | 1903.2% | operator |
| 18458 | Seq Scan | 3.27 | 9.45 | 189.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 18455 (Seq Scan) - LEAF
...
### Step 2: Node 18456 (Index Scan) - LEAF
...
### Step 3: Node 18458 (Seq Scan) - LEAF
...
### Step 6: Node 18460 (Seq Scan) - LEAF
...
### Step 10: Node 18450 (Seq Scan) - LEAF
...
### Step 13: Node 18461 (Index Scan) - LEAF
...
### Step 14: Node 18448 (Nested Loop)
