...
```
Node 16706 (Sort) - ROOT
  Node 16707 (Aggregate)
    Node 16708 (Gather)
      Node 16709 (Aggregate)
        Node 16710 (Nested Loop)
          Node 16711 (Hash Join)
            Node 16712 (Seq Scan) - LEAF
            Node 16713 (Hash)
              Node 16714 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 16706 | Sort | 1189.79 | 1117.39 | 6.1% | operator |
| 16707 | Aggregate | 1189.64 | 897.56 | 24.6% | operator |
...
| 16711 | Hash Join | 973.75 | 632.25 | 35.1% | operator |
| 16723 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 16712 | Seq Scan | 701.96 | 509.93 | 27.4% | operator |
| 16713 | Hash | 178.38 | 47.23 | 73.5% | operator |
| 16714 | Hash Join | 176.32 | 924.09 | 424.1% | operator |
...
### Step 10: Node 16712 (Seq Scan) - LEAF
...
### Step 13: Node 16723 (Index Scan) - LEAF
...
### Step 14: Node 16710 (Nested Loop)
