...
```
Node 16941 (Sort) - ROOT
  Node 16942 (Aggregate)
    Node 16943 (Gather)
      Node 16944 (Aggregate)
        Node 16945 (Hash Join)
          Node 16946 (Seq Scan) - LEAF
          Node 16947 (Hash)
            Node 16948 (Hash Join)
              Node 16949 (Seq Scan) - LEAF
              Node 16950 (Hash)
                Node 16951 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 16941 | Sort | 1269.42 | 1119.70 | 11.8% | operator |
| 16942 | Aggregate | 1269.24 | 916.08 | 27.8% | operator |
| 16943 | Gather | 1268.16 | 962.11 | 24.1% | operator |
| 16944 | Aggregate | 1249.78 | 931.09 | 25.5% | operator |
| 16945 | Hash Join | 1221.10 | 569.62 | 53.4% | operator |
| 16946 | Seq Scan | 131.44 | 193.40 | 47.1% | operator |
| 16947 | Hash | 1025.05 | 110.13 | 89.3% | operator |
| 16948 | Hash Join | 1006.75 | 633.87 | 37.0% | operator |
| 16949 | Seq Scan | 676.67 | 509.93 | 24.6% | operator |
| 16950 | Hash | 212.39 | 48.26 | 77.3% | operator |
| 16951 | Hash Join | 209.94 | 924.58 | 340.4% | operator |
...
### Step 10: Node 16949 (Seq Scan) - LEAF
...
### Step 13: Node 16946 (Seq Scan) - LEAF
