...
```
Node 18119 (Sort) - ROOT
  Node 18120 (Aggregate)
    Node 18121 (Gather)
      Node 18122 (Aggregate)
        Node 18123 (Nested Loop)
          Node 18124 (Hash Join)
            Node 18125 (Seq Scan) - LEAF
            Node 18126 (Hash)
              Node 18127 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 18119 | Sort | 1216.08 | 1118.92 | 8.0% | operator |
| 18120 | Aggregate | 1215.96 | 896.90 | 26.2% | operator |
...
| 18124 | Hash Join | 987.56 | 632.96 | 35.9% | operator |
| 18136 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18125 | Seq Scan | 710.57 | 509.93 | 28.2% | operator |
| 18126 | Hash | 182.22 | 47.68 | 73.8% | operator |
| 18127 | Hash Join | 180.23 | 924.32 | 412.8% | operator |
...
### Step 10: Node 18125 (Seq Scan) - LEAF
...
### Step 13: Node 18136 (Index Scan) - LEAF
...
### Step 14: Node 18123 (Nested Loop)
