...
```
Node 18898 (Sort) - ROOT
  Node 18899 (Aggregate)
    Node 18900 (Gather)
      Node 18901 (Aggregate)
        Node 18902 (Nested Loop)
          Node 18903 (Hash Join)
            Node 18904 (Seq Scan) - LEAF
            Node 18905 (Hash)
              Node 18906 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 18898 | Sort | 1184.81 | 1117.39 | 5.7% | operator |
| 18899 | Aggregate | 1184.68 | 897.56 | 24.2% | operator |
...
| 18903 | Hash Join | 958.52 | 632.25 | 34.0% | operator |
| 18915 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18904 | Seq Scan | 684.05 | 509.93 | 25.5% | operator |
| 18905 | Hash | 178.09 | 47.23 | 73.5% | operator |
| 18906 | Hash Join | 176.06 | 924.09 | 424.9% | operator |
...
### Step 10: Node 18904 (Seq Scan) - LEAF
...
### Step 13: Node 18915 (Index Scan) - LEAF
...
### Step 14: Node 18902 (Nested Loop)
