...
**Test Query:** Q9_106_seed_861423255
...
```
Node 16760 (Sort) - ROOT
  Node 16761 (Aggregate)
    Node 16762 (Gather)
      Node 16763 (Aggregate)
        Node 16764 (Nested Loop)
          Node 16765 (Hash Join)
            Node 16766 (Seq Scan) - LEAF
            Node 16767 (Hash)
              Node 16768 (Hash Join)
                Node 16769 (Hash Join)
                  Node 16770 (Nested Loop)
                    Node 16771 (Seq Scan) - LEAF
                    Node 16772 (Index Scan) - LEAF
                  Node 16773 (Hash)
                    Node 16774 (Seq Scan) - LEAF
                Node 16775 (Hash)
                  Node 16776 (Seq Scan) - LEAF
          Node 16777 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 16760 | Sort | 1192.07 | 1119.51 | 6.1% | operator |
| 16761 | Aggregate | 1191.92 | 897.44 | 24.7% | operator |
| 16762 | Gather | 1190.84 | 964.64 | 19.0% | operator |
| 16763 | Aggregate | 1171.93 | 1095.61 | 6.5% | operator |
| 16764 | Nested Loop | 1147.27 | 1252.17 | 9.1% | operator |
| 16765 | Hash Join | 973.16 | 633.32 | 34.9% | operator |
| 16777 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 16766 | Seq Scan | 695.50 | 509.93 | 26.7% | operator |
| 16767 | Hash | 183.88 | 47.91 | 73.9% | operator |
| 16768 | Hash Join | 181.62 | 924.43 | 409.0% | operator |
| 16769 | Hash Join | 167.52 | 837.61 | 400.0% | operator |
| 16775 | Hash | 13.47 | 14.95 | 11.0% | operator |
| 16770 | Nested Loop | 160.58 | 1251.77 | 679.5% | operator |
| 16773 | Hash | 4.56 | 15.94 | 249.8% | operator |
| 16776 | Seq Scan | 13.46 | 2.94 | 78.2% | operator |
| 16771 | Seq Scan | 20.27 | 44.03 | 117.2% | operator |
| 16772 | Index Scan | 0.08 | -1.39 | 1926.9% | operator |
| 16774 | Seq Scan | 3.91 | 9.45 | 141.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 16771 (Seq Scan) - LEAF
...
### Step 2: Node 16772 (Index Scan) - LEAF
...
### Step 3: Node 16774 (Seq Scan) - LEAF
...
### Step 6: Node 16776 (Seq Scan) - LEAF
...
### Step 10: Node 16766 (Seq Scan) - LEAF
...
### Step 13: Node 16777 (Index Scan) - LEAF
...
### Step 14: Node 16764 (Nested Loop)
