...
```
Node 17050 (Sort) - ROOT
  Node 17051 (Aggregate)
    Node 17052 (Gather)
      Node 17053 (Aggregate)
        Node 17054 (Nested Loop)
          Node 17055 (Hash Join)
            Node 17056 (Seq Scan) - LEAF
            Node 17057 (Hash)
              Node 17058 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 17050 | Sort | 1198.58 | 1118.33 | 6.7% | operator |
| 17051 | Aggregate | 1198.41 | 896.44 | 25.2% | operator |
...
| 17055 | Hash Join | 972.92 | 632.60 | 35.0% | operator |
| 17067 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17056 | Seq Scan | 696.31 | 509.93 | 26.8% | operator |
| 17057 | Hash | 180.92 | 47.45 | 73.8% | operator |
| 17058 | Hash Join | 178.64 | 924.21 | 417.4% | operator |
...
### Step 10: Node 17056 (Seq Scan) - LEAF
...
### Step 13: Node 17067 (Index Scan) - LEAF
...
### Step 14: Node 17054 (Nested Loop)
