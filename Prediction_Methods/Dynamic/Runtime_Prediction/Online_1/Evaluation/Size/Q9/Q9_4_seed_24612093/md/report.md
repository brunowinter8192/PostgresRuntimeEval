...
```
Node 18354 (Sort) - ROOT
  Node 18355 (Aggregate)
    Node 18356 (Gather)
      Node 18357 (Aggregate)
        Node 18358 (Nested Loop)
          Node 18359 (Hash Join)
            Node 18360 (Seq Scan) - LEAF
            Node 18361 (Hash)
              Node 18362 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 18354 | Sort | 1186.30 | 1119.81 | 5.6% | operator |
| 18355 | Aggregate | 1186.15 | 897.74 | 24.3% | operator |
...
| 18359 | Hash Join | 961.20 | 633.50 | 34.1% | operator |
| 18371 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18360 | Seq Scan | 695.69 | 509.93 | 26.7% | operator |
| 18361 | Hash | 171.70 | 48.03 | 72.0% | operator |
| 18362 | Hash Join | 169.32 | 924.48 | 446.0% | operator |
...
### Step 10: Node 18360 (Seq Scan) - LEAF
...
### Step 13: Node 18371 (Index Scan) - LEAF
...
### Step 14: Node 18358 (Nested Loop)
