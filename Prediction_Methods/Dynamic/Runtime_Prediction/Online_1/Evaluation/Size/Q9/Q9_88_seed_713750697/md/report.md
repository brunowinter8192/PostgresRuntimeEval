...
```
Node 19116 (Sort) - ROOT
  Node 19117 (Aggregate)
    Node 19118 (Gather)
      Node 19119 (Aggregate)
        Node 19120 (Hash Join)
          Node 19121 (Seq Scan) - LEAF
          Node 19122 (Hash)
            Node 19123 (Hash Join)
              Node 19124 (Seq Scan) - LEAF
              Node 19125 (Hash)
                Node 19126 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 19116 | Sort | 1292.32 | 1119.81 | 13.3% | operator |
| 19117 | Aggregate | 1292.18 | 916.13 | 29.1% | operator |
| 19118 | Gather | 1291.23 | 962.19 | 25.5% | operator |
| 19119 | Aggregate | 1274.34 | 922.15 | 27.6% | operator |
| 19120 | Hash Join | 1245.02 | 572.47 | 54.0% | operator |
| 19121 | Seq Scan | 126.52 | 193.40 | 52.9% | operator |
| 19122 | Hash | 1054.58 | 111.27 | 89.4% | operator |
| 19123 | Hash Join | 1036.04 | 634.24 | 38.8% | operator |
| 19124 | Seq Scan | 698.15 | 509.93 | 27.0% | operator |
| 19125 | Hash | 219.19 | 48.50 | 77.9% | operator |
| 19126 | Hash Join | 216.80 | 924.68 | 326.5% | operator |
...
### Step 10: Node 19124 (Seq Scan) - LEAF
...
### Step 13: Node 19121 (Seq Scan) - LEAF
