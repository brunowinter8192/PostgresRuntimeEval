...
```
Node 18300 (Sort) - ROOT
  Node 18301 (Aggregate)
    Node 18302 (Gather)
      Node 18303 (Aggregate)
        Node 18304 (Nested Loop)
          Node 18305 (Hash Join)
            Node 18306 (Seq Scan) - LEAF
            Node 18307 (Hash)
              Node 18308 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 18300 | Sort | 1227.15 | 1116.22 | 9.0% | operator |
| 18301 | Aggregate | 1227.01 | 901.35 | 26.5% | operator |
...
| 18305 | Hash Join | 1004.28 | 631.63 | 37.1% | operator |
| 18317 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18306 | Seq Scan | 716.25 | 509.93 | 28.8% | operator |
| 18307 | Hash | 188.75 | 46.85 | 75.2% | operator |
| 18308 | Hash Join | 183.56 | 923.84 | 403.3% | operator |
...
### Step 10: Node 18306 (Seq Scan) - LEAF
...
### Step 13: Node 18317 (Index Scan) - LEAF
...
### Step 14: Node 18304 (Nested Loop)
