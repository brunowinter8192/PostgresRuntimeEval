...
```
Node 17719 (Sort) - ROOT
  Node 17720 (Aggregate)
    Node 17721 (Gather)
      Node 17722 (Aggregate)
        Node 17723 (Hash Join)
          Node 17724 (Seq Scan) - LEAF
          Node 17725 (Hash)
            Node 17726 (Hash Join)
              Node 17727 (Seq Scan) - LEAF
              Node 17728 (Hash)
                Node 17729 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 17719 | Sort | 1271.45 | 1119.76 | 11.9% | operator |
| 17720 | Aggregate | 1271.29 | 916.11 | 27.9% | operator |
| 17721 | Gather | 1270.31 | 962.15 | 24.3% | operator |
| 17722 | Aggregate | 1253.77 | 926.43 | 26.1% | operator |
| 17723 | Hash Join | 1224.27 | 571.03 | 53.4% | operator |
| 17724 | Seq Scan | 125.50 | 193.40 | 54.1% | operator |
| 17725 | Hash | 1036.58 | 110.70 | 89.3% | operator |
| 17726 | Hash Join | 1018.62 | 634.06 | 37.8% | operator |
| 17727 | Seq Scan | 680.76 | 509.93 | 25.1% | operator |
| 17728 | Hash | 220.74 | 48.38 | 78.1% | operator |
| 17729 | Hash Join | 217.26 | 924.63 | 325.6% | operator |
...
### Step 10: Node 17727 (Seq Scan) - LEAF
...
### Step 13: Node 17724 (Seq Scan) - LEAF
