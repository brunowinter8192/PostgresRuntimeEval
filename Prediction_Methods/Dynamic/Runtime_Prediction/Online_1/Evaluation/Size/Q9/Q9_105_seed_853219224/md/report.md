...
```
Node 16742 (Sort) - ROOT
  Node 16743 (Aggregate)
    Node 16744 (Gather)
      Node 16745 (Aggregate)
        Node 16746 (Nested Loop)
          Node 16747 (Hash Join)
            Node 16748 (Seq Scan) - LEAF
            Node 16749 (Hash)
              Node 16750 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 16742 | Sort | 1186.90 | 1117.85 | 5.8% | operator |
| 16743 | Aggregate | 1186.78 | 896.88 | 24.4% | operator |
...
| 16747 | Hash Join | 967.36 | 632.42 | 34.6% | operator |
| 16759 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 16748 | Seq Scan | 696.60 | 509.93 | 26.8% | operator |
| 16749 | Hash | 176.61 | 47.34 | 73.2% | operator |
| 16750 | Hash Join | 174.86 | 924.15 | 428.5% | operator |
...
### Step 10: Node 16748 (Seq Scan) - LEAF
...
### Step 13: Node 16759 (Index Scan) - LEAF
...
### Step 14: Node 16746 (Nested Loop)
