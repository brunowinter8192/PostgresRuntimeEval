...
```
Node 18047 (Sort) - ROOT
  Node 18048 (Aggregate)
    Node 18049 (Gather)
      Node 18050 (Aggregate)
        Node 18051 (Nested Loop)
          Node 18052 (Hash Join)
            Node 18053 (Seq Scan) - LEAF
            Node 18054 (Hash)
              Node 18055 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 18047 | Sort | 1206.19 | 1118.63 | 7.3% | operator |
| 18048 | Aggregate | 1206.05 | 896.66 | 25.7% | operator |
...
| 18052 | Hash Join | 982.77 | 632.78 | 35.6% | operator |
| 18064 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18053 | Seq Scan | 715.89 | 509.93 | 28.8% | operator |
| 18054 | Hash | 171.49 | 47.56 | 72.3% | operator |
| 18055 | Hash Join | 169.57 | 924.26 | 445.1% | operator |
...
### Step 10: Node 18053 (Seq Scan) - LEAF
...
### Step 13: Node 18064 (Index Scan) - LEAF
...
### Step 14: Node 18051 (Nested Loop)
