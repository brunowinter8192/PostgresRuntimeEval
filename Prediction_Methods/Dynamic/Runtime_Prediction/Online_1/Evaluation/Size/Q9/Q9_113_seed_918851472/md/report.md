...
```
Node 16905 (Sort) - ROOT
  Node 16906 (Aggregate)
    Node 16907 (Gather)
      Node 16908 (Aggregate)
        Node 16909 (Nested Loop)
          Node 16910 (Hash Join)
            Node 16911 (Seq Scan) - LEAF
            Node 16912 (Hash)
              Node 16913 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 16905 | Sort | 1192.34 | 1118.63 | 6.2% | operator |
| 16906 | Aggregate | 1192.21 | 896.66 | 24.8% | operator |
...
| 16910 | Hash Join | 976.29 | 632.78 | 35.2% | operator |
| 16922 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 16911 | Seq Scan | 700.14 | 509.93 | 27.2% | operator |
| 16912 | Hash | 182.69 | 47.56 | 74.0% | operator |
| 16913 | Hash Join | 180.58 | 924.26 | 411.8% | operator |
...
### Step 10: Node 16911 (Seq Scan) - LEAF
...
### Step 13: Node 16922 (Index Scan) - LEAF
...
### Step 14: Node 16909 (Nested Loop)
