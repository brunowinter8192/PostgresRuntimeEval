...
```
Node 19007 (Sort) - ROOT
  Node 19008 (Aggregate)
    Node 19009 (Gather)
      Node 19010 (Aggregate)
        Node 19011 (Nested Loop)
          Node 19012 (Hash Join)
            Node 19013 (Seq Scan) - LEAF
            Node 19014 (Hash)
              Node 19015 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 19007 | Sort | 1198.97 | 1118.63 | 6.7% | operator |
| 19008 | Aggregate | 1198.83 | 896.66 | 25.2% | operator |
...
| 19012 | Hash Join | 975.83 | 632.78 | 35.2% | operator |
| 19024 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 19013 | Seq Scan | 693.22 | 509.93 | 26.4% | operator |
| 19014 | Hash | 184.67 | 47.56 | 74.2% | operator |
| 19015 | Hash Join | 182.40 | 924.26 | 406.7% | operator |
...
### Step 10: Node 19013 (Seq Scan) - LEAF
...
### Step 13: Node 19024 (Index Scan) - LEAF
...
### Step 14: Node 19011 (Nested Loop)
