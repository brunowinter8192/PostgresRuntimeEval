...
```
Node 16850 (Sort) - ROOT
  Node 16851 (Aggregate)
    Node 16852 (Gather)
      Node 16853 (Aggregate)
        Node 16854 (Nested Loop)
          Node 16855 (Hash Join)
            Node 16856 (Seq Scan) - LEAF
            Node 16857 (Hash)
              Node 16858 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 16850 | Sort | 1208.76 | 1120.12 | 7.3% | operator |
| 16851 | Aggregate | 1208.62 | 898.05 | 25.7% | operator |
...
| 16855 | Hash Join | 994.04 | 633.69 | 36.3% | operator |
| 16867 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 16856 | Seq Scan | 713.66 | 509.93 | 28.5% | operator |
| 16857 | Hash | 183.56 | 48.14 | 73.8% | operator |
| 16858 | Hash Join | 181.97 | 924.53 | 408.1% | operator |
...
### Step 10: Node 16856 (Seq Scan) - LEAF
...
### Step 13: Node 16867 (Index Scan) - LEAF
...
### Step 14: Node 16854 (Nested Loop)
