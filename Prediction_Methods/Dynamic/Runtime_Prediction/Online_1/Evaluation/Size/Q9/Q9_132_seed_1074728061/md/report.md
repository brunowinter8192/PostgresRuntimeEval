...
```
Node 17285 (Sort) - ROOT
  Node 17286 (Aggregate)
    Node 17287 (Gather)
      Node 17288 (Aggregate)
        Node 17289 (Nested Loop)
          Node 17290 (Hash Join)
            Node 17291 (Seq Scan) - LEAF
            Node 17292 (Hash)
              Node 17293 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 17285 | Sort | 1191.69 | 1119.81 | 6.0% | operator |
| 17286 | Aggregate | 1191.57 | 897.74 | 24.7% | operator |
...
| 17290 | Hash Join | 974.04 | 633.50 | 35.0% | operator |
| 17302 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17291 | Seq Scan | 699.17 | 509.93 | 27.1% | operator |
| 17292 | Hash | 180.18 | 48.03 | 73.3% | operator |
| 17293 | Hash Join | 177.70 | 924.48 | 420.2% | operator |
...
### Step 10: Node 17291 (Seq Scan) - LEAF
...
### Step 13: Node 17302 (Index Scan) - LEAF
...
### Step 14: Node 17289 (Nested Loop)
