...
```
Node 17321 (Sort) - ROOT
  Node 17322 (Aggregate)
    Node 17323 (Gather)
...
|------|------|--------|-----------|-----|--------|
| 17321 | Sort | 1196.26 | 1118.63 | 6.5% | operator |
| 17322 | Aggregate | 1196.14 | 896.66 | 25.0% | operator |
...
| 17326 | Hash Join | 975.18 | 632.78 | 35.1% | operator |
| 17338 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17327 | Seq Scan | 702.19 | 509.93 | 27.4% | operator |
| 17328 | Hash | 178.60 | 47.56 | 73.4% | operator |
| 17329 | Hash Join | 176.25 | 924.26 | 424.4% | operator |
...
- **Input Features:**
  ...
  - st1=470.8585
  - st2=0.0000
  - startup_cost=212917.9000
  - total_cost=213820.1500
- **Output:** st=894.86, rt=896.66

### Step 18: Node 17321 (Sort) - ROOT
...
- **Input Features:**
  ...
  - st1=894.8584
  - st2=0.0000
  - startup_cost=218594.9400
  - total_cost=218745.3100
- **Output:** st=1117.89, rt=1118.63
