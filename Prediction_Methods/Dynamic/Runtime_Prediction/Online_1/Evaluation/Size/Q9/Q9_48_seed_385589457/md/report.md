...
```
Node 18318 (Sort) - ROOT
  Node 18319 (Aggregate)
    Node 18320 (Gather)
      Node 18321 (Aggregate)
        Node 18322 (Nested Loop)
          Node 18323 (Hash Join)
            Node 18324 (Seq Scan) - LEAF
            Node 18325 (Hash)
              Node 18326 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 18318 | Sort | 1204.80 | 1118.92 | 7.1% | operator |
| 18319 | Aggregate | 1204.65 | 896.90 | 25.5% | operator |
...
| 18323 | Hash Join | 984.94 | 632.96 | 35.7% | operator |
| 18335 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18324 | Seq Scan | 718.79 | 509.93 | 29.1% | operator |
| 18325 | Hash | 172.22 | 47.68 | 72.3% | operator |
| 18326 | Hash Join | 170.24 | 924.32 | 443.0% | operator |
...
### Step 10: Node 18324 (Seq Scan) - LEAF
...
### Step 13: Node 18335 (Index Scan) - LEAF
...
### Step 14: Node 18322 (Nested Loop)
