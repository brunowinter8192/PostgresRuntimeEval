...
```
Node 16796 (Sort) - ROOT
  Node 16797 (Aggregate)
    Node 16798 (Gather)
      Node 16799 (Aggregate)
        Node 16800 (Nested Loop)
          Node 16801 (Hash Join)
            Node 16802 (Seq Scan) - LEAF
            Node 16803 (Hash)
              Node 16804 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 16796 | Sort | 1206.86 | 1119.81 | 7.2% | operator |
| 16797 | Aggregate | 1206.74 | 897.74 | 25.6% | operator |
...
| 16801 | Hash Join | 990.13 | 633.50 | 36.0% | operator |
| 16813 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 16802 | Seq Scan | 709.76 | 509.93 | 28.2% | operator |
| 16803 | Hash | 185.45 | 48.03 | 74.1% | operator |
| 16804 | Hash Join | 182.37 | 924.48 | 406.9% | operator |
...
### Step 10: Node 16802 (Seq Scan) - LEAF
...
### Step 13: Node 16813 (Index Scan) - LEAF
...
### Step 14: Node 16800 (Nested Loop)
