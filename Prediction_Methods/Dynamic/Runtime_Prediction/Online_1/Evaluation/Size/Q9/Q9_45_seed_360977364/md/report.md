...
**Test Query:** Q9_45_seed_360977364
...
```
Node 18264 (Sort) - ROOT
  Node 18265 (Aggregate)
    Node 18266 (Gather)
      Node 18267 (Aggregate)
        Node 18268 (Nested Loop)
          Node 18269 (Hash Join)
            Node 18270 (Seq Scan) - LEAF
            Node 18271 (Hash)
              Node 18272 (Hash Join)
                Node 18273 (Hash Join)
                  Node 18274 (Nested Loop)
                    Node 18275 (Seq Scan) - LEAF
                    Node 18276 (Index Scan) - LEAF
                  Node 18277 (Hash)
                    Node 18278 (Seq Scan) - LEAF
                Node 18279 (Hash)
                  Node 18280 (Seq Scan) - LEAF
          Node 18281 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 18264 | Sort | 1194.07 | 1119.51 | 6.2% | operator |
| 18265 | Aggregate | 1193.92 | 897.44 | 24.8% | operator |
| 18266 | Gather | 1192.67 | 964.64 | 19.1% | operator |
| 18267 | Aggregate | 1172.04 | 1095.61 | 6.5% | operator |
| 18268 | Nested Loop | 1147.24 | 1252.17 | 9.1% | operator |
| 18269 | Hash Join | 973.96 | 633.32 | 35.0% | operator |
| 18281 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18270 | Seq Scan | 700.61 | 509.93 | 27.2% | operator |
| 18271 | Hash | 176.84 | 47.91 | 72.9% | operator |
| 18272 | Hash Join | 174.99 | 924.43 | 428.3% | operator |
| 18273 | Hash Join | 161.52 | 837.61 | 418.6% | operator |
| 18279 | Hash | 12.83 | 14.95 | 16.5% | operator |
| 18274 | Nested Loop | 156.41 | 1251.77 | 700.3% | operator |
| 18277 | Hash | 3.04 | 15.94 | 424.7% | operator |
| 18280 | Seq Scan | 12.82 | 2.94 | 77.1% | operator |
| 18275 | Seq Scan | 19.74 | 44.03 | 123.1% | operator |
| 18276 | Index Scan | 0.07 | -1.39 | 1951.3% | operator |
| 18278 | Seq Scan | 2.52 | 9.45 | 274.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 18275 (Seq Scan) - LEAF
...
### Step 2: Node 18276 (Index Scan) - LEAF
...
### Step 3: Node 18278 (Seq Scan) - LEAF
...
### Step 6: Node 18280 (Seq Scan) - LEAF
...
### Step 10: Node 18270 (Seq Scan) - LEAF
...
### Step 13: Node 18281 (Index Scan) - LEAF
...
### Step 14: Node 18268 (Nested Loop)
