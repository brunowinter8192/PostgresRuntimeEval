...
```
Node 18210 (Sort) - ROOT
  Node 18211 (Aggregate)
    Node 18212 (Gather)
      Node 18213 (Aggregate)
        Node 18214 (Nested Loop)
          Node 18215 (Hash Join)
            Node 18216 (Seq Scan) - LEAF
            Node 18217 (Hash)
              Node 18218 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 18210 | Sort | 1219.15 | 1119.81 | 8.1% | operator |
| 18211 | Aggregate | 1219.01 | 897.74 | 26.4% | operator |
...
| 18215 | Hash Join | 999.49 | 633.50 | 36.6% | operator |
| 18227 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18216 | Seq Scan | 722.07 | 509.93 | 29.4% | operator |
| 18217 | Hash | 182.41 | 48.03 | 73.7% | operator |
| 18218 | Hash Join | 180.71 | 924.48 | 411.6% | operator |
...
### Step 10: Node 18216 (Seq Scan) - LEAF
...
### Step 13: Node 18227 (Index Scan) - LEAF
...
### Step 14: Node 18214 (Nested Loop)
