...
```
Node 17847 (Sort) - ROOT
  Node 17848 (Aggregate)
    Node 17849 (Gather)
      Node 17850 (Aggregate)
        Node 17851 (Nested Loop)
          Node 17852 (Hash Join)
            Node 17853 (Seq Scan) - LEAF
            Node 17854 (Hash)
              Node 17855 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 17847 | Sort | 1173.25 | 1117.85 | 4.7% | operator |
| 17848 | Aggregate | 1173.09 | 896.88 | 23.5% | operator |
...
| 17852 | Hash Join | 956.15 | 632.42 | 33.9% | operator |
| 17864 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17853 | Seq Scan | 683.86 | 509.93 | 25.4% | operator |
| 17854 | Hash | 176.79 | 47.34 | 73.2% | operator |
| 17855 | Hash Join | 174.93 | 924.15 | 428.3% | operator |
...
### Step 10: Node 17853 (Seq Scan) - LEAF
...
### Step 13: Node 17864 (Index Scan) - LEAF
...
### Step 14: Node 17851 (Nested Loop)
