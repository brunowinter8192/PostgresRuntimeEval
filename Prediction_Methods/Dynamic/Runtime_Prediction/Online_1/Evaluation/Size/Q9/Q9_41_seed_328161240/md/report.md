...
```
Node 18192 (Sort) - ROOT
  Node 18193 (Aggregate)
    Node 18194 (Gather)
      Node 18195 (Aggregate)
        Node 18196 (Nested Loop)
          Node 18197 (Hash Join)
            Node 18198 (Seq Scan) - LEAF
            Node 18199 (Hash)
              Node 18200 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 18192 | Sort | 1173.14 | 1118.33 | 4.7% | operator |
| 18193 | Aggregate | 1173.01 | 896.44 | 23.6% | operator |
...
| 18197 | Hash Join | 948.23 | 632.60 | 33.3% | operator |
| 18209 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18198 | Seq Scan | 676.15 | 509.93 | 24.6% | operator |
| 18199 | Hash | 174.97 | 47.45 | 72.9% | operator |
| 18200 | Hash Join | 172.55 | 924.21 | 435.6% | operator |
...
### Step 10: Node 18198 (Seq Scan) - LEAF
...
### Step 13: Node 18209 (Index Scan) - LEAF
...
### Step 14: Node 18196 (Nested Loop)
