...
```
Node 18372 (Sort) - ROOT
  Node 18373 (Aggregate)
    Node 18374 (Gather)
      Node 18375 (Aggregate)
        Node 18376 (Nested Loop)
          Node 18377 (Hash Join)
            Node 18378 (Seq Scan) - LEAF
            Node 18379 (Hash)
              Node 18380 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 18372 | Sort | 1197.71 | 1119.81 | 6.5% | operator |
| 18373 | Aggregate | 1197.57 | 897.74 | 25.0% | operator |
...
| 18377 | Hash Join | 978.86 | 633.50 | 35.3% | operator |
| 18389 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18378 | Seq Scan | 700.15 | 509.93 | 27.2% | operator |
| 18379 | Hash | 185.10 | 48.03 | 74.1% | operator |
| 18380 | Hash Join | 183.14 | 924.48 | 404.8% | operator |
...
### Step 10: Node 18378 (Seq Scan) - LEAF
...
### Step 13: Node 18389 (Index Scan) - LEAF
...
### Step 14: Node 18376 (Nested Loop)
