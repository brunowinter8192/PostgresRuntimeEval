...
```
Node 19262 (Sort) - ROOT
  Node 19263 (Aggregate)
    Node 19264 (Gather)
      Node 19265 (Aggregate)
        Node 19266 (Nested Loop)
          Node 19267 (Hash Join)
            Node 19268 (Seq Scan) - LEAF
            Node 19269 (Hash)
              Node 19270 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 19262 | Sort | 1170.03 | 1116.22 | 4.6% | operator |
| 19263 | Aggregate | 1169.89 | 901.35 | 23.0% | operator |
...
| 19267 | Hash Join | 957.44 | 631.63 | 34.0% | operator |
| 19279 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 19268 | Seq Scan | 685.08 | 509.93 | 25.6% | operator |
| 19269 | Hash | 180.49 | 46.85 | 74.0% | operator |
| 19270 | Hash Join | 174.77 | 923.84 | 428.6% | operator |
...
### Step 10: Node 19268 (Seq Scan) - LEAF
...
### Step 13: Node 19279 (Index Scan) - LEAF
...
### Step 14: Node 19266 (Nested Loop)
