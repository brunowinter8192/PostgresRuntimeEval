...
```
Node 19171 (Sort) - ROOT
  Node 19172 (Aggregate)
    Node 19173 (Gather)
      Node 19174 (Aggregate)
        Node 19175 (Nested Loop)
          Node 19176 (Hash Join)
            Node 19177 (Seq Scan) - LEAF
            Node 19178 (Hash)
              Node 19179 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 19171 | Sort | 1229.63 | 1119.21 | 9.0% | operator |
| 19172 | Aggregate | 1229.50 | 897.16 | 27.0% | operator |
...
| 19176 | Hash Join | 1011.20 | 633.14 | 37.4% | operator |
| 19188 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 19177 | Seq Scan | 731.99 | 509.93 | 30.3% | operator |
| 19178 | Hash | 184.33 | 47.79 | 74.1% | operator |
| 19179 | Hash Join | 182.32 | 924.37 | 407.0% | operator |
...
### Step 10: Node 19177 (Seq Scan) - LEAF
...
### Step 13: Node 19188 (Index Scan) - LEAF
...
### Step 14: Node 19175 (Nested Loop)
