...
```
Node 17484 (Sort) - ROOT
  Node 17485 (Aggregate)
    Node 17486 (Gather)
      Node 17487 (Aggregate)
        Node 17488 (Nested Loop)
          Node 17489 (Hash Join)
            Node 17490 (Seq Scan) - LEAF
            Node 17491 (Hash)
              Node 17492 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 17484 | Sort | 1215.15 | 1119.21 | 7.9% | operator |
| 17485 | Aggregate | 1215.01 | 897.16 | 26.2% | operator |
...
| 17489 | Hash Join | 991.81 | 633.14 | 36.2% | operator |
| 17501 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17490 | Seq Scan | 718.89 | 509.93 | 29.1% | operator |
| 17491 | Hash | 179.58 | 47.79 | 73.4% | operator |
| 17492 | Hash Join | 177.61 | 924.37 | 420.5% | operator |
...
### Step 10: Node 17490 (Seq Scan) - LEAF
...
### Step 13: Node 17501 (Index Scan) - LEAF
...
### Step 14: Node 17488 (Nested Loop)
