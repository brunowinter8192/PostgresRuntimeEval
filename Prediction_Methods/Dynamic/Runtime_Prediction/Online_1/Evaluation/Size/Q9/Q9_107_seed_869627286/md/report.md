...
```
Node 16778 (Sort) - ROOT
  Node 16779 (Aggregate)
    Node 16780 (Gather)
      Node 16781 (Aggregate)
        Node 16782 (Nested Loop)
          Node 16783 (Hash Join)
            Node 16784 (Seq Scan) - LEAF
            Node 16785 (Hash)
              Node 16786 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 16778 | Sort | 1164.49 | 1119.81 | 3.8% | operator |
| 16779 | Aggregate | 1164.35 | 897.74 | 22.9% | operator |
...
| 16783 | Hash Join | 952.51 | 633.50 | 33.5% | operator |
| 16795 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 16784 | Seq Scan | 681.71 | 509.93 | 25.2% | operator |
| 16785 | Hash | 176.55 | 48.03 | 72.8% | operator |
| 16786 | Hash Join | 174.77 | 924.48 | 429.0% | operator |
...
### Step 10: Node 16784 (Seq Scan) - LEAF
...
### Step 13: Node 16795 (Index Scan) - LEAF
...
### Step 14: Node 16782 (Nested Loop)
