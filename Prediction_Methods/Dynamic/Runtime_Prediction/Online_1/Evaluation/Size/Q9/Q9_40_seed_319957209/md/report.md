...
```
Node 18174 (Sort) - ROOT
  Node 18175 (Aggregate)
    Node 18176 (Gather)
      Node 18177 (Aggregate)
        Node 18178 (Nested Loop)
          Node 18179 (Hash Join)
            Node 18180 (Seq Scan) - LEAF
            Node 18181 (Hash)
              Node 18182 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 18174 | Sort | 1180.11 | 1119.81 | 5.1% | operator |
| 18175 | Aggregate | 1179.99 | 897.74 | 23.9% | operator |
...
| 18179 | Hash Join | 958.66 | 633.50 | 33.9% | operator |
| 18191 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18180 | Seq Scan | 690.79 | 509.93 | 26.2% | operator |
| 18181 | Hash | 174.30 | 48.03 | 72.4% | operator |
| 18182 | Hash Join | 172.34 | 924.48 | 436.4% | operator |
...
### Step 10: Node 18180 (Seq Scan) - LEAF
...
### Step 13: Node 18191 (Index Scan) - LEAF
...
### Step 14: Node 18178 (Nested Loop)
