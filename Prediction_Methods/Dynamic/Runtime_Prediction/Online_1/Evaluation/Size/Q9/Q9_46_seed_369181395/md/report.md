...
**Test Query:** Q9_46_seed_369181395
...
```
Node 18282 (Sort) - ROOT
  Node 18283 (Aggregate)
    Node 18284 (Gather)
      Node 18285 (Aggregate)
        Node 18286 (Nested Loop)
          Node 18287 (Hash Join)
            Node 18288 (Seq Scan) - LEAF
            Node 18289 (Hash)
              Node 18290 (Hash Join)
                Node 18291 (Hash Join)
                  Node 18292 (Nested Loop)
                    Node 18293 (Seq Scan) - LEAF
                    Node 18294 (Index Scan) - LEAF
                  Node 18295 (Hash)
                    Node 18296 (Seq Scan) - LEAF
                Node 18297 (Hash)
                  Node 18298 (Seq Scan) - LEAF
          Node 18299 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 18282 | Sort | 1195.63 | 1119.51 | 6.4% | operator |
| 18283 | Aggregate | 1195.48 | 897.44 | 24.9% | operator |
| 18284 | Gather | 1194.47 | 964.64 | 19.2% | operator |
| 18285 | Aggregate | 1176.62 | 1095.61 | 6.9% | operator |
| 18286 | Nested Loop | 1152.19 | 1252.17 | 8.7% | operator |
| 18287 | Hash Join | 980.90 | 633.32 | 35.4% | operator |
| 18299 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18288 | Seq Scan | 707.93 | 509.93 | 28.0% | operator |
| 18289 | Hash | 179.87 | 47.91 | 73.4% | operator |
| 18290 | Hash Join | 177.85 | 924.43 | 419.8% | operator |
| 18291 | Hash Join | 164.21 | 837.61 | 410.1% | operator |
| 18297 | Hash | 12.96 | 14.95 | 15.4% | operator |
| 18292 | Nested Loop | 156.61 | 1251.77 | 699.3% | operator |
| 18295 | Hash | 5.63 | 15.94 | 183.1% | operator |
| 18298 | Seq Scan | 12.94 | 2.94 | 77.3% | operator |
| 18293 | Seq Scan | 19.34 | 44.03 | 127.7% | operator |
| 18294 | Index Scan | 0.07 | -1.39 | 1976.3% | operator |
| 18296 | Seq Scan | 5.13 | 9.45 | 84.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 18293 (Seq Scan) - LEAF
...
### Step 2: Node 18294 (Index Scan) - LEAF
...
### Step 3: Node 18296 (Seq Scan) - LEAF
...
### Step 6: Node 18298 (Seq Scan) - LEAF
...
### Step 10: Node 18288 (Seq Scan) - LEAF
...
### Step 13: Node 18299 (Index Scan) - LEAF
...
### Step 14: Node 18286 (Nested Loop)
