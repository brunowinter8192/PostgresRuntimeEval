...
```
Node 18697 (Sort) - ROOT
  Node 18698 (Aggregate)
    Node 18699 (Gather)
      Node 18700 (Aggregate)
        Node 18701 (Nested Loop)
          Node 18702 (Hash Join)
            Node 18703 (Seq Scan) - LEAF
            Node 18704 (Hash)
              Node 18705 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 18697 | Sort | 1196.21 | 1118.33 | 6.5% | operator |
| 18698 | Aggregate | 1196.08 | 896.44 | 25.1% | operator |
...
| 18702 | Hash Join | 977.87 | 632.60 | 35.3% | operator |
| 18714 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18703 | Seq Scan | 701.64 | 509.93 | 27.3% | operator |
| 18704 | Hash | 182.74 | 47.45 | 74.0% | operator |
| 18705 | Hash Join | 180.73 | 924.21 | 411.4% | operator |
...
### Step 10: Node 18703 (Seq Scan) - LEAF
...
### Step 13: Node 18714 (Index Scan) - LEAF
...
### Step 14: Node 18701 (Nested Loop)
