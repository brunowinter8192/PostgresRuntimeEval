...
```
Node 18570 (Sort) - ROOT
  Node 18571 (Aggregate)
    Node 18572 (Gather)
      Node 18573 (Aggregate)
        Node 18574 (Nested Loop)
          Node 18575 (Hash Join)
            Node 18576 (Seq Scan) - LEAF
            Node 18577 (Hash)
              Node 18578 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 18570 | Sort | 1190.54 | 1118.63 | 6.0% | operator |
| 18571 | Aggregate | 1190.39 | 896.66 | 24.7% | operator |
...
| 18575 | Hash Join | 971.86 | 632.78 | 34.9% | operator |
| 18587 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18576 | Seq Scan | 695.00 | 509.93 | 26.6% | operator |
| 18577 | Hash | 182.86 | 47.56 | 74.0% | operator |
| 18578 | Hash Join | 180.28 | 924.26 | 412.7% | operator |
...
### Step 10: Node 18576 (Seq Scan) - LEAF
...
### Step 13: Node 18587 (Index Scan) - LEAF
...
### Step 14: Node 18574 (Nested Loop)
