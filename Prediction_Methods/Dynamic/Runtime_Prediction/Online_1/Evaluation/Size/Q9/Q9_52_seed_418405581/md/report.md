...
```
Node 18408 (Sort) - ROOT
  Node 18409 (Aggregate)
    Node 18410 (Gather)
      Node 18411 (Aggregate)
        Node 18412 (Nested Loop)
          Node 18413 (Hash Join)
            Node 18414 (Seq Scan) - LEAF
            Node 18415 (Hash)
              Node 18416 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 18408 | Sort | 1200.78 | 1120.12 | 6.7% | operator |
| 18409 | Aggregate | 1200.65 | 898.05 | 25.2% | operator |
...
| 18413 | Hash Join | 975.42 | 633.69 | 35.0% | operator |
| 18425 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18414 | Seq Scan | 708.09 | 509.93 | 28.0% | operator |
| 18415 | Hash | 171.33 | 48.14 | 71.9% | operator |
| 18416 | Hash Join | 169.65 | 924.53 | 445.0% | operator |
...
### Step 10: Node 18414 (Seq Scan) - LEAF
...
### Step 13: Node 18425 (Index Scan) - LEAF
...
### Step 14: Node 18412 (Nested Loop)
