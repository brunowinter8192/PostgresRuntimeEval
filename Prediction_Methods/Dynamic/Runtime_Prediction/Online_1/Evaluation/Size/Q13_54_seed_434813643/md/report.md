...
**Test Query:** Q13_54_seed_434813643
...
```
Node 26063 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26064 (Aggregate) [consumed]
    Node 26065 (Aggregate)
      Node 26066 (Hash Join) [PATTERN: 895c6e8c]
        Node 26067 (Seq Scan) [consumed] - LEAF
        Node 26068 (Hash) [consumed]
          Node 26069 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26063 | 26064, 26066, 26067, 26068 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26066 | 26063, 26064, 26067, 26068 |
...
|------|------|--------|-----------|-----|--------|
| 26063 | Sort | 903.19 | 1079.94 | 19.6% | pattern |
| 26065 | Aggregate | 897.22 | 999.76 | 11.4% | operator |
| 26066 | Hash Join | 681.49 | 470.31 | 31.0% | pattern |
| 26069 | Index Only Scan | 10.71 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26069 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26066 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26063, 26064, 26067, 26068
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 26063 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26064, 26066, 26067, 26068
- **Input Features:**
