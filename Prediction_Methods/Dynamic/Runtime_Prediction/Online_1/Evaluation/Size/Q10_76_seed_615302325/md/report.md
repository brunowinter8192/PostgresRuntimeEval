...
**Test Query:** Q10_76_seed_615302325
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20969 | 20970, 20971, 20972, 20974, 20975, 20978 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 20974 | 20969, 20970, 20971, 20972, 20975, 20978 |
...
|------|------|--------|-----------|-----|--------|
| 20969 | Limit | 1170.28 | 1199.47 | 2.5% | pattern |
| 20973 | Hash Join | 1125.57 | 1095.40 | 2.7% | operator |
| 20974 | Hash Join | 1122.66 | 1120.19 | 0.2% | pattern |
| 20980 | Hash | 0.02 | 15.71 | 87182.1% | operator |
| 20981 | Seq Scan | 0.01 | 6.98 | 49747.9% | operator |
| 20976 | Seq Scan | 160.67 | 159.75 | 0.6% | operator |
| 20977 | Index Scan | 0.06 | -0.52 | 909.7% | operator |
| 20979 | Seq Scan | 28.10 | 26.64 | 5.2% | operator |
...
### Step 4: Node 20981 (Seq Scan) - LEAF
...
- **Consumes:** Nodes 20969, 20970, 20971, 20972, 20975, 20978
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=17639
  - HashJoin_nt1=17639
...
### Step 8: Node 20969 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20970, 20971, 20972, 20974, 20975, 20978
- **Input Features:**
