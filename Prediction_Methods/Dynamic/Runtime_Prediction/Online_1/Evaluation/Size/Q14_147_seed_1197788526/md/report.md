...
```
Node 26777 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26778 (Gather) [consumed]
    Node 26779 (Aggregate) [consumed]
      Node 26780 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26777 | 26778, 26779, 26780 |
...
|------|------|--------|-----------|-----|--------|
| 26777 | Aggregate | 809.25 | 857.14 | 5.9% | pattern |
...
### Step 4: Node 26777 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26778, 26779, 26780
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=15928
  - HashJoin_Outer_nt1=15928
  ...
  - HashJoin_Outer_total_cost=136648.4500
