...
**Test Query:** Q13_46_seed_369181395
...
```
Node 26000 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26001 (Aggregate) [consumed]
    Node 26002 (Aggregate)
      Node 26003 (Hash Join) [PATTERN: 895c6e8c]
        Node 26004 (Seq Scan) [consumed] - LEAF
        Node 26005 (Hash) [consumed]
          Node 26006 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26000 | 26001, 26003, 26004, 26005 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26003 | 26000, 26001, 26004, 26005 |
...
|------|------|--------|-----------|-----|--------|
| 26000 | Sort | 927.26 | 1079.94 | 16.5% | pattern |
| 26002 | Aggregate | 921.34 | 999.76 | 8.5% | operator |
| 26003 | Hash Join | 712.45 | 470.31 | 34.0% | pattern |
| 26006 | Index Only Scan | 10.16 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26006 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26003 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26000, 26001, 26004, 26005
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 26000 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26001, 26003, 26004, 26005
- **Input Features:**
