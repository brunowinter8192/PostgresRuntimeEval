...
**Test Query:** Q12_123_seed_1000891782
...
```
Node 24495 (Aggregate) - ROOT
  Node 24496 (Gather Merge)
    Node 24497 (Aggregate)
      Node 24498 (Sort)
        Node 24499 (Nested Loop)
          Node 24500 (Seq Scan) - LEAF
          Node 24501 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24495 | Aggregate | 1035.08 | 919.07 | 11.2% | operator |
| 24496 | Gather Merge | 1035.06 | 1111.84 | 7.4% | operator |
| 24497 | Aggregate | 1011.24 | 895.31 | 11.5% | operator |
| 24498 | Sort | 1010.64 | 1092.81 | 8.1% | operator |
| 24499 | Nested Loop | 1009.74 | 1127.41 | 11.7% | operator |
| 24500 | Seq Scan | 871.66 | 745.19 | 14.5% | operator |
| 24501 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24500 (Seq Scan) - LEAF
...
### Step 2: Node 24501 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - st2=0.1246
  - startup_cost=0.4300
  - total_cost=147157.9400
- **Output:** st=38.33, rt=1127.41

### Step 4: Node 24498 (Sort)
...
- **Input Features:**
  ...
  - st1=38.3270
  - st2=0.0000
  - startup_cost=147517.5700
  - total_cost=147531.9700
- **Output:** st=1092.39, rt=1092.81

### Step 5: Node 24497 (Aggregate)
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=147517.5700
  - total_cost=147632.8000
- **Output:** st=868.97, rt=895.31

### Step 6: Node 24496 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=868.9673
  - st2=0.0000
  - startup_cost=148517.6500
  - total_cost=148637.0900
- **Output:** st=1109.22, rt=1111.84

### Step 7: Node 24495 (Aggregate) - ROOT
