...
```
Node 31773 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31774 (Gather) [consumed]
    Node 31775 (Aggregate) [consumed]
      Node 31776 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31773 | 31774, 31775, 31776 |
...
|------|------|--------|-----------|-----|--------|
| 31773 | Aggregate | 845.04 | 829.29 | 1.9% | pattern |
...
### Step 4: Node 31773 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31774, 31775, 31776
- **Input Features:**
