...
**Test Query:** Q19_36_seed_287141085
...
```
Node 31773 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31774 (Gather) [consumed]
    Node 31775 (Aggregate) [consumed]
      Node 31776 (Hash Join)
        Node 31777 (Seq Scan) - LEAF
        Node 31778 (Hash)
          Node 31779 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31773 | 31774, 31775 |
...
|------|------|--------|-----------|-----|--------|
| 31773 | Aggregate | 845.04 | 831.20 | 1.6% | pattern |
| 31776 | Hash Join | 824.99 | 766.06 | 7.1% | operator |
| 31777 | Seq Scan | 773.54 | 743.46 | 3.9% | operator |
| 31778 | Hash | 47.47 | 8.29 | 82.5% | operator |
| 31779 | Seq Scan | 47.30 | 23.76 | 49.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31779 (Seq Scan) - LEAF
...
### Step 2: Node 31777 (Seq Scan) - LEAF
...
### Step 5: Node 31773 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31774, 31775
- **Input Features:**
