...
**Test Query:** Q10_99_seed_803995038
...
```
Node 21294 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 21295 (Sort) [consumed]
    Node 21296 (Aggregate) [consumed]
      Node 21297 (Gather) [consumed]
        Node 21298 (Hash Join)
          Node 21299 (Hash Join) [PATTERN: 2e0f44ef]
            Node 21300 (Nested Loop) [consumed]
              Node 21301 (Seq Scan) - LEAF
              Node 21302 (Index Scan) - LEAF
            Node 21303 (Hash) [consumed]
              Node 21304 (Seq Scan) - LEAF
          Node 21305 (Hash)
            Node 21306 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 21294 | 21295, 21296, 21297, 21299, 21300, 21303 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 21299 | 21294, 21295, 21296, 21297, 21300, 21303 |
...
|------|------|--------|-----------|-----|--------|
| 21294 | Limit | 1173.88 | 1199.47 | 2.2% | pattern |
| 21298 | Hash Join | 1114.00 | 1095.59 | 1.7% | operator |
| 21299 | Hash Join | 1111.09 | 1120.19 | 0.8% | pattern |
| 21305 | Hash | 0.01 | 15.71 | 104638.5% | operator |
| 21306 | Seq Scan | 0.01 | 6.98 | 63342.8% | operator |
| 21301 | Seq Scan | 160.26 | 159.74 | 0.3% | operator |
| 21302 | Index Scan | 0.06 | -0.52 | 922.6% | operator |
| 21304 | Seq Scan | 24.67 | 26.64 | 8.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 21301 (Seq Scan) - LEAF
...
### Step 2: Node 21302 (Index Scan) - LEAF
...
### Step 3: Node 21304 (Seq Scan) - LEAF
...
### Step 4: Node 21306 (Seq Scan) - LEAF
...
### Step 5: Node 21299 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 21294, 21295, 21296, 21297, 21300, 21303
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18337
  - HashJoin_nt1=18337
  ...
  - NestedLoop_Outer_nt=18337
  - NestedLoop_Outer_nt1=18527
...
- **Output:** st=54.23, rt=1095.59

### Step 8: Node 21294 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 21295, 21296, 21297, 21299, 21300, 21303
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=56845
  - Aggregate_Outer_nt1=56845
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=280
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=88406.0600
  - Aggregate_Outer_total_cost=89116.6200
  - Gather_Outer_np=0
