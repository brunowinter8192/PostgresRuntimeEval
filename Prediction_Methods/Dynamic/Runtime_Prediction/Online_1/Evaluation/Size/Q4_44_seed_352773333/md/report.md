...
**Test Query:** Q4_44_seed_352773333
...
```
Node 6467 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6468 (Gather Merge) [consumed]
    Node 6469 (Sort) [consumed]
      Node 6470 (Aggregate) [consumed]
        Node 6471 (Nested Loop)
          Node 6472 (Seq Scan) - LEAF
          Node 6473 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6467 | 6468, 6469, 6470 |
...
|------|------|--------|-----------|-----|--------|
| 6467 | Aggregate | 1043.64 | 952.19 | 8.8% | pattern |
| 6471 | Nested Loop | 1037.06 | 1255.45 | 21.1% | operator |
| 6472 | Seq Scan | 164.40 | 154.66 | 5.9% | operator |
| 6473 | Index Scan | 0.06 | 11.10 | 17810.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6472 (Seq Scan) - LEAF
...
### Step 2: Node 6473 (Index Scan) - LEAF
...
### Step 4: Node 6467 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f8231c4d (Aggregate -> Gather Merge -> Sort -> Aggregate (Outer) (Outer) (Outer))
- **Consumes:** Nodes 6468, 6469, 6470
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=5
  - Aggregate_Outer_nt1=14813
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=24
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0003
  - Aggregate_Outer_startup_cost=65818.9700
  - Aggregate_Outer_total_cost=65819.0200
  - Aggregate_np=0
  - Aggregate_nt=5
  - Aggregate_nt1=15
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=66819.1200
  - Aggregate_total_cost=66821.0200
  ...
  - GatherMerge_Outer_startup_cost=66819.1200
  - GatherMerge_Outer_total_cost=66820.8900
  - Sort_Outer_np=0
  - Sort_Outer_nt=5
  - Sort_Outer_nt1=5
  - Sort_Outer_nt2=0
  ...
  - Sort_Outer_startup_cost=65819.0800
  - Sort_Outer_total_cost=65819.0900
