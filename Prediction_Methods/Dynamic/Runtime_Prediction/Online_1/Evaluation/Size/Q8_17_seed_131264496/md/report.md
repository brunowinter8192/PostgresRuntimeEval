...
```
Node 14535 (Aggregate) - ROOT
  Node 14536 (Gather Merge)
    Node 14537 (Sort)
          ...
          Node 14540 (Hash Join)
            Node 14541 (Nested Loop)
              Node 14542 (Hash Join)
                ...
                Node 14544 (Hash)
                  Node 14545 (Hash Join)
                    Node 14546 (Seq Scan) - LEAF
                    Node 14547 (Hash)
                      Node 14548 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 14535 | Aggregate | 1249.60 | 1190.04 | 4.8% | operator |
| 14536 | Gather Merge | 1249.09 | 1097.15 | 12.2% | operator |
...
| 14542 | Hash Join | 217.06 | 251.17 | 15.7% | operator |
...
| 14544 | Hash | 38.96 | 20.62 | 47.1% | operator |
| 14545 | Hash Join | 38.19 | 132.26 | 246.4% | operator |
| 14546 | Seq Scan | 36.65 | 23.03 | 37.2% | operator |
| 14547 | Hash | 0.20 | 23.66 | 11496.1% | operator |
| 14548 | Hash Join | 0.20 | 306.84 | 152554.7% | operator |
...
### Step 5: Node 14546 (Seq Scan) - LEAF
...
### Step 8: Node 14543 (Seq Scan) - LEAF
...
### Step 11: Node 14552 (Index Scan) - LEAF
...
### Step 12: Node 14554 (Seq Scan) - LEAF
...
### Step 13: Node 14541 (Nested Loop)
...
### Step 16: Node 14555 (Index Scan) - LEAF
...
### Step 17: Node 14557 (Seq Scan) - LEAF
...
### Step 18: Node 14539 (Nested Loop)
...
### Step 22: Node 14536 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1044.9438
  - st2=0.0000
  - startup_cost=71556.9100
  - total_cost=71848.8900
- **Output:** st=1093.44, rt=1097.15

### Step 23: Node 14535 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=71556.9100
  - total_cost=71946.3700
- **Output:** st=1161.56, rt=1190.04
