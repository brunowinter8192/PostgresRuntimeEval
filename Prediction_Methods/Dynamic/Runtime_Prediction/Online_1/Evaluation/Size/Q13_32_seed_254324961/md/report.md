...
```
Node 25895 (Sort) - ROOT
  Node 25896 (Aggregate)
    Node 25897 (Aggregate)
      Node 25898 (Hash Join)
        Node 25899 (Seq Scan) - LEAF
        Node 25900 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 25895 | Sort | 899.00 | 1081.93 | 20.3% | operator |
| 25896 | Aggregate | 898.97 | 1000.34 | 11.3% | operator |
| 25897 | Aggregate | 892.98 | 1014.18 | 13.6% | operator |
| 25898 | Hash Join | 687.14 | 787.83 | 14.7% | operator |
| 25899 | Seq Scan | 478.82 | 264.12 | 44.8% | operator |
| 25900 | Hash | 18.63 | 80.15 | 330.2% | operator |
...
### Step 2: Node 25899 (Seq Scan) - LEAF
