...
**Test Query:** Q13_32_seed_254324961
...
```
Node 25895 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25896 (Aggregate) [consumed]
    Node 25897 (Aggregate)
      Node 25898 (Hash Join) [PATTERN: 895c6e8c]
        Node 25899 (Seq Scan) [consumed] - LEAF
        Node 25900 (Hash) [consumed]
          Node 25901 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25895 | 25896, 25898, 25899, 25900 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25898 | 25895, 25896, 25899, 25900 |
...
|------|------|--------|-----------|-----|--------|
| 25895 | Sort | 899.00 | 1079.93 | 20.1% | pattern |
| 25897 | Aggregate | 892.98 | 999.55 | 11.9% | operator |
| 25898 | Hash Join | 687.14 | 470.31 | 31.6% | pattern |
| 25901 | Index Only Scan | 11.37 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25901 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25898 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25895, 25896, 25899, 25900
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1484970
...
### Step 4: Node 25895 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25896, 25898, 25899, 25900
- **Input Features:**
