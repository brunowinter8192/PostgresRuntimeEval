    ...
    Node 20178 (Aggregate) [consumed]
      Node 20179 (Gather) [consumed]
        Node 20180 (Hash Join)
          Node 20181 (Hash Join)
            Node 20182 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20176 | 20177, 20178, 20179 |
...
| 20180 | Hash Join | 1081.85 | 1007.22 | 6.9% | operator |
| 20181 | Hash Join | 1078.95 | 1004.13 | 6.9% | operator |
| 20187 | Hash | 0.02 | 15.71 | 92316.3% | operator |
| 20182 | Nested Loop | 1035.73 | 1204.81 | 16.3% | operator |
| 20185 | Hash | 32.82 | 55.57 | 69.3% | operator |
...
### Step 6: Node 20188 (Seq Scan) - LEAF
...
### Step 10: Node 20176 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20177, 20178, 20179
- **Input Features:**
