...
**Test Query:** Q10_20_seed_155876589
...
```
Node 20176 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 20177 (Sort) [consumed]
    Node 20178 (Aggregate) [consumed]
      Node 20179 (Gather) [consumed]
        Node 20180 (Hash Join)
          Node 20181 (Hash Join) [PATTERN: 2e0f44ef]
            Node 20182 (Nested Loop) [consumed]
              Node 20183 (Seq Scan) - LEAF
              Node 20184 (Index Scan) - LEAF
            Node 20185 (Hash) [consumed]
              Node 20186 (Seq Scan) - LEAF
          Node 20187 (Hash)
            Node 20188 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20176 | 20177, 20178, 20179, 20181, 20182, 20185 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 20181 | 20176, 20177, 20178, 20179, 20182, 20185 |
...
|------|------|--------|-----------|-----|--------|
| 20176 | Limit | 1132.82 | 1199.47 | 5.9% | pattern |
| 20180 | Hash Join | 1081.85 | 1095.51 | 1.3% | operator |
| 20181 | Hash Join | 1078.95 | 1120.19 | 3.8% | pattern |
| 20187 | Hash | 0.02 | 15.71 | 92316.3% | operator |
| 20188 | Seq Scan | 0.01 | 6.98 | 58055.9% | operator |
| 20183 | Seq Scan | 159.26 | 159.74 | 0.3% | operator |
| 20184 | Index Scan | 0.06 | -0.52 | 949.6% | operator |
| 20186 | Seq Scan | 23.18 | 26.64 | 14.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 20183 (Seq Scan) - LEAF
...
### Step 2: Node 20184 (Index Scan) - LEAF
...
### Step 3: Node 20186 (Seq Scan) - LEAF
...
### Step 4: Node 20188 (Seq Scan) - LEAF
...
### Step 5: Node 20181 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 20176, 20177, 20178, 20179, 20182, 20185
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18015
  - HashJoin_nt1=18015
...
### Step 8: Node 20176 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20177, 20178, 20179, 20181, 20182, 20185
- **Input Features:**
