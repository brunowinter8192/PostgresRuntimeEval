...
```
Node 31304 (Aggregate) [PATTERN: efde8b38] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31304 | 31305, 31306, 31307 |
...
|------|------|--------|-----------|-----|--------|
| 31304 | Aggregate | 873.83 | 829.30 | 5.1% | pattern |
| 31308 | Seq Scan | 804.20 | 743.46 | 7.6% | operator |
| 31309 | Hash | 47.85 | 8.29 | 82.7% | operator |
| 31310 | Seq Scan | 47.70 | 23.76 | 50.2% | operator |
...
### Step 4: Node 31304 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31305, 31306, 31307
- **Input Features:**
