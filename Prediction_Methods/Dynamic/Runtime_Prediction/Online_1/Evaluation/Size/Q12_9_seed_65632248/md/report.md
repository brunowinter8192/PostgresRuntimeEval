...
**Test Query:** Q12_9_seed_65632248
...
```
Node 25363 (Aggregate) - ROOT
  Node 25364 (Gather Merge)
    Node 25365 (Aggregate)
      Node 25366 (Sort)
        Node 25367 (Nested Loop)
          Node 25368 (Seq Scan) - LEAF
          Node 25369 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 25363 | Aggregate | 992.15 | 919.06 | 7.4% | operator |
| 25364 | Gather Merge | 992.13 | 1111.84 | 12.1% | operator |
| 25365 | Aggregate | 973.13 | 895.31 | 8.0% | operator |
| 25366 | Sort | 972.49 | 1092.81 | 12.4% | operator |
| 25367 | Nested Loop | 971.58 | 1127.41 | 16.0% | operator |
| 25368 | Seq Scan | 829.70 | 745.19 | 10.2% | operator |
| 25369 | Index Scan | 0.03 | 0.07 | 166.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25368 (Seq Scan) - LEAF
...
### Step 2: Node 25369 (Index Scan) - LEAF
...
### Step 6: Node 25364 (Gather Merge)
...
### Step 7: Node 25363 (Aggregate) - ROOT
