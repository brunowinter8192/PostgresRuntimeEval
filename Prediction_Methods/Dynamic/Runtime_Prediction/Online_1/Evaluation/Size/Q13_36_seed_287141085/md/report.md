...
**Test Query:** Q13_36_seed_287141085
...
```
Node 25923 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25924 (Aggregate) [consumed]
    Node 25925 (Aggregate)
      Node 25926 (Hash Join) [PATTERN: 895c6e8c]
        Node 25927 (Seq Scan) [consumed] - LEAF
        Node 25928 (Hash) [consumed]
          Node 25929 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25923 | 25924, 25926, 25927, 25928 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25926 | 25923, 25924, 25927, 25928 |
...
|------|------|--------|-----------|-----|--------|
| 25923 | Sort | 922.54 | 1079.92 | 17.1% | pattern |
| 25925 | Aggregate | 916.53 | 998.94 | 9.0% | operator |
| 25926 | Hash Join | 694.21 | 470.31 | 32.3% | pattern |
| 25929 | Index Only Scan | 13.00 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25929 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25926 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25923, 25924, 25927, 25928
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1475952
...
### Step 4: Node 25923 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25924, 25926, 25927, 25928
- **Input Features:**
