...
**Test Query:** Q9_125_seed_1017299844
...
```
Node 17140 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 17141 (Aggregate) [consumed]
    Node 17142 (Gather)
      Node 17143 (Aggregate)
        Node 17144 (Nested Loop)
          Node 17145 (Hash Join) [PATTERN: bb930825]
            Node 17146 (Seq Scan) [consumed] - LEAF
            Node 17147 (Hash) [consumed]
              Node 17148 (Hash Join) [consumed]
                Node 17149 (Hash Join)
                  Node 17150 (Nested Loop)
                    Node 17151 (Seq Scan) - LEAF
                    Node 17152 (Index Scan) - LEAF
                  Node 17153 (Hash)
                    Node 17154 (Seq Scan) - LEAF
                Node 17155 (Hash)
                  Node 17156 (Seq Scan) - LEAF
          Node 17157 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17145 | 17140, 17141, 17146, 17147, 17148 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17140 | 17141, 17145, 17146, 17147, 17148 |
...
|------|------|--------|-----------|-----|--------|
| 17140 | Sort | 1197.43 | 1044.79 | 12.7% | pattern |
| 17142 | Gather | 1196.17 | 964.87 | 19.3% | operator |
| 17143 | Aggregate | 1178.49 | 1117.47 | 5.2% | operator |
| 17144 | Nested Loop | 1153.96 | 1252.17 | 8.5% | operator |
| 17145 | Hash Join | 981.84 | 134.80 | 86.3% | pattern |
| 17157 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17149 | Hash Join | 171.73 | 837.55 | 387.7% | operator |
| 17155 | Hash | 13.21 | 14.95 | 13.1% | operator |
| 17150 | Nested Loop | 164.75 | 1251.76 | 659.8% | operator |
| 17153 | Hash | 4.96 | 15.94 | 221.4% | operator |
| 17156 | Seq Scan | 13.20 | 2.94 | 77.8% | operator |
| 17151 | Seq Scan | 19.24 | 44.17 | 129.6% | operator |
| 17152 | Index Scan | 0.08 | -1.39 | 1814.2% | operator |
| 17154 | Seq Scan | 4.47 | 9.45 | 111.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 17151 (Seq Scan) - LEAF
...
### Step 2: Node 17152 (Index Scan) - LEAF
...
### Step 3: Node 17154 (Seq Scan) - LEAF
...
### Step 6: Node 17156 (Seq Scan) - LEAF
...
### Step 9: Node 17145 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17140, 17141, 17146, 17147, 17148
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17157 (Index Scan) - LEAF
...
### Step 11: Node 17144 (Nested Loop)
...
### Step 14: Node 17140 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17141, 17145, 17146, 17147, 17148
- **Input Features:**
