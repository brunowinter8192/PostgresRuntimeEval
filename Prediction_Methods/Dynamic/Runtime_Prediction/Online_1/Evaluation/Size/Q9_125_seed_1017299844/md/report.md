...
```
Node 17140 (Sort) - ROOT
  Node 17141 (Aggregate)
    Node 17142 (Gather)
      Node 17143 (Aggregate)
        Node 17144 (Nested Loop)
          Node 17145 (Hash Join)
            Node 17146 (Seq Scan) - LEAF
            Node 17147 (Hash)
              Node 17148 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 17140 | Sort | 1197.43 | 1118.92 | 6.6% | operator |
| 17141 | Aggregate | 1197.30 | 896.90 | 25.1% | operator |
...
| 17145 | Hash Join | 981.84 | 632.96 | 35.5% | operator |
| 17157 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17146 | Seq Scan | 699.66 | 509.93 | 27.1% | operator |
| 17147 | Hash | 187.69 | 47.68 | 74.6% | operator |
| 17148 | Hash Join | 185.55 | 924.32 | 398.2% | operator |
...
### Step 10: Node 17146 (Seq Scan) - LEAF
...
### Step 13: Node 17157 (Index Scan) - LEAF
...
### Step 14: Node 17144 (Nested Loop)
