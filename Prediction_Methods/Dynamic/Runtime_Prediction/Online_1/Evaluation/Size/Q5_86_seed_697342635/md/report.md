...
**Test Query:** Q5_86_seed_697342635
...
```
Node 9581 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 9582 (Aggregate) [consumed]
    Node 9583 (Gather Merge) [consumed]
      Node 9584 (Aggregate)
        Node 9585 (Sort) [PATTERN: 3e2d5a00]
          Node 9586 (Hash Join) [consumed]
            Node 9587 (Nested Loop)
              Node 9588 (Hash Join)
                Node 9589 (Seq Scan) - LEAF
                Node 9590 (Hash) [PATTERN: 444761fb]
                  Node 9591 (Hash Join) [consumed]
                    Node 9592 (Seq Scan) [consumed] - LEAF
                    Node 9593 (Hash) [consumed]
                      Node 9594 (Hash Join) [consumed]
                        Node 9595 (Seq Scan) - LEAF
                        Node 9596 (Hash)
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 9590 | 9581, 9582, 9583, 9585, 9586, 9591, 9592, 9593, 9594 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 9581 | 9582, 9583, 9585, 9586, 9590, 9591, 9592, 9593, 9594 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 9585 | 9581, 9582, 9583, 9586, 9590, 9591, 9592, 9593, 9594 |
...
|------|------|--------|-----------|-----|--------|
| 9581 | Sort | 1054.74 | 2934.42 | 178.2% | pattern |
| 9584 | Aggregate | 1049.98 | 1128.74 | 7.5% | operator |
| 9585 | Sort | 1049.69 | 1835.96 | 74.9% | pattern |
| 9587 | Nested Loop | 1036.70 | 1188.57 | 14.6% | operator |
| 9599 | Hash | 4.28 | 18.67 | 336.3% | operator |
| 9588 | Hash Join | 213.76 | 253.07 | 18.4% | operator |
| 9598 | Index Scan | 0.07 | -0.22 | 405.6% | operator |
| 9600 | Seq Scan | 3.73 | 12.36 | 230.9% | operator |
| 9589 | Seq Scan | 166.68 | 159.81 | 4.1% | operator |
| 9590 | Hash | 33.63 | 46.85 | 39.3% | pattern |
| 9595 | Seq Scan | 0.01 | 11.81 | 147503.4% | operator |
| 9596 | Hash | 0.05 | 21.05 | 45667.9% | operator |
| 9597 | Seq Scan | 0.04 | 22.93 | 53233.3% | operator |
...
### Step 2: Node 9595 (Seq Scan) - LEAF
...
### Step 4: Node 9589 (Seq Scan) - LEAF
...
### Step 5: Node 9590 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 9581, 9582, 9583, 9585, 9586, 9591, 9592, 9593, 9594
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 9598 (Index Scan) - LEAF
...
### Step 8: Node 9600 (Seq Scan) - LEAF
...
### Step 11: Node 9585 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 9581, 9582, 9583, 9586, 9590, 9591, 9592, 9593, 9594
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 9581 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 9582, 9583, 9585, 9586, 9590, 9591, 9592, 9593, 9594
- **Input Features:**
