...
```
Node 31353 (Aggregate) [PATTERN: efde8b38] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31353 | 31354, 31355, 31356 |
...
|------|------|--------|-----------|-----|--------|
| 31353 | Aggregate | 835.45 | 829.27 | 0.7% | pattern |
...
### Step 4: Node 31353 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31354, 31355, 31356
- **Input Features:**
