...
Node 441 (Aggregate) - ROOT
  Node 442 (Gather Merge)
    Node 443 (Sort) [PATTERN: 1d35fb97]
      Node 444 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 443 | 444 |
...
|------|------|--------|-----------|-----|--------|
| 441 | Aggregate | 930.47 | 1195.74 | 28.5% | operator |
| 442 | Gather Merge | 930.41 | 1165.86 | 25.3% | operator |
| 443 | Sort | 910.72 | 1199.94 | 31.8% | pattern |
...
### Step 2: Node 443 (Sort) - PATTERN ROOT
...
### Step 4: Node 441 (Aggregate) - ROOT
