...
**Test Query:** Q5_13_seed_98448372
...
```
Node 7761 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 7762 (Aggregate) [consumed]
    Node 7763 (Gather Merge) [consumed]
      Node 7764 (Aggregate)
        Node 7765 (Sort) [PATTERN: 3e2d5a00]
          Node 7766 (Hash Join) [consumed]
            Node 7767 (Nested Loop)
              Node 7768 (Hash Join)
                Node 7769 (Seq Scan) - LEAF
                Node 7770 (Hash) [PATTERN: 444761fb]
                  Node 7771 (Hash Join) [consumed]
                    Node 7772 (Seq Scan) [consumed] - LEAF
                    Node 7773 (Hash) [consumed]
                      Node 7774 (Hash Join) [consumed]
                        Node 7775 (Seq Scan) - LEAF
                        Node 7776 (Hash)
                          Node 7777 (Seq Scan) - LEAF
              Node 7778 (Index Scan) - LEAF
            Node 7779 (Hash)
              Node 7780 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 7770 | 7761, 7762, 7763, 7765, 7766, 7771, 7772, 7773, 7774 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 7761 | 7762, 7763, 7765, 7766, 7770, 7771, 7772, 7773, 7774 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 7765 | 7761, 7762, 7763, 7766, 7770, 7771, 7772, 7773, 7774 |
...
|------|------|--------|-----------|-----|--------|
| 7761 | Sort | 1044.24 | 2934.42 | 181.0% | pattern |
| 7764 | Aggregate | 1040.15 | 1128.76 | 8.5% | operator |
| 7765 | Sort | 1039.90 | 1835.93 | 76.5% | pattern |
| 7767 | Nested Loop | 1025.56 | 1188.47 | 15.9% | operator |
| 7779 | Hash | 5.76 | 18.67 | 224.0% | operator |
| 7768 | Hash Join | 206.68 | 253.07 | 22.4% | operator |
| 7778 | Index Scan | 0.07 | -0.22 | 409.9% | operator |
| 7780 | Seq Scan | 5.17 | 12.36 | 139.2% | operator |
| 7769 | Seq Scan | 164.82 | 159.81 | 3.0% | operator |
| 7770 | Hash | 28.87 | 46.85 | 62.3% | pattern |
| 7775 | Seq Scan | 0.01 | 11.81 | 147503.4% | operator |
| 7776 | Hash | 0.04 | 21.05 | 46685.0% | operator |
| 7777 | Seq Scan | 0.04 | 22.93 | 53233.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 7777 (Seq Scan) - LEAF
...
### Step 2: Node 7775 (Seq Scan) - LEAF
...
### Step 4: Node 7769 (Seq Scan) - LEAF
...
### Step 5: Node 7770 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 7761, 7762, 7763, 7765, 7766, 7771, 7772, 7773, 7774
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 7778 (Index Scan) - LEAF
...
### Step 8: Node 7780 (Seq Scan) - LEAF
...
### Step 11: Node 7765 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 7761, 7762, 7763, 7766, 7770, 7771, 7772, 7773, 7774
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 7761 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 7762, 7763, 7765, 7766, 7770, 7771, 7772, 7773, 7774
- **Input Features:**
