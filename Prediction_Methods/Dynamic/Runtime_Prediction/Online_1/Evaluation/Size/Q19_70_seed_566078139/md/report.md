...
**Test Query:** Q19_70_seed_566078139
...
```
Node 32039 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 32040 (Gather) [consumed]
    Node 32041 (Aggregate) [consumed]
      Node 32042 (Hash Join) [consumed]
        Node 32043 (Seq Scan) - LEAF
        Node 32044 (Hash)
          Node 32045 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 32039 | 32040, 32041, 32042 |
...
|------|------|--------|-----------|-----|--------|
| 32039 | Aggregate | 847.23 | 829.32 | 2.1% | pattern |
| 32043 | Seq Scan | 778.15 | 743.46 | 4.5% | operator |
| 32044 | Hash | 46.22 | 8.29 | 82.1% | operator |
| 32045 | Seq Scan | 46.05 | 23.76 | 48.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 32045 (Seq Scan) - LEAF
...
### Step 2: Node 32043 (Seq Scan) - LEAF
...
### Step 4: Node 32039 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 32040, 32041, 32042
- **Input Features:**
