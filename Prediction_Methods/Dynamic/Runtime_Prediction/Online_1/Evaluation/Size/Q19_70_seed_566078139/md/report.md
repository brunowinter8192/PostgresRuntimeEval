...
```
Node 32039 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 32040 (Gather) [consumed]
    Node 32041 (Aggregate) [consumed]
      Node 32042 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 32039 | 32040, 32041 |
...
|------|------|--------|-----------|-----|--------|
| 32039 | Aggregate | 847.23 | 831.20 | 1.9% | pattern |
| 32042 | Hash Join | 826.52 | 766.06 | 7.3% | operator |
...
### Step 5: Node 32039 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 32040, 32041
- **Input Features:**
