...
```
Node 8801 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 8802 (Aggregate) [consumed]
    Node 8803 (Gather Merge) [consumed]
      Node 8804 (Aggregate)
        Node 8805 (Sort) [PATTERN: 3e2d5a00]
          Node 8806 (Hash Join) [consumed]
            Node 8807 (Nested Loop)
              Node 8808 (Hash Join)
                Node 8809 (Seq Scan) - LEAF
                Node 8810 (Hash) [PATTERN: 444761fb]
                  Node 8811 (Hash Join) [consumed]
                    Node 8812 (Seq Scan) [consumed] - LEAF
                    Node 8813 (Hash) [consumed]
                      Node 8814 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 8810 | 8801, 8802, 8803, 8805, 8806, 8811, 8812, 8813, 8814 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 8801 | 8802, 8803, 8805, 8806, 8810, 8811, 8812, 8813, 8814 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 8805 | 8801, 8802, 8803, 8806, 8810, 8811, 8812, 8813, 8814 |
...
### Step 4: Node 8809 (Seq Scan) - LEAF
...
### Step 5: Node 8810 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 8801, 8802, 8803, 8805, 8806, 8811, 8812, 8813, 8814
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 8818 (Index Scan) - LEAF
...
### Step 8: Node 8820 (Seq Scan) - LEAF
...
### Step 11: Node 8805 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 8801, 8802, 8803, 8806, 8810, 8811, 8812, 8813, 8814
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 8801 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 8802, 8803, 8805, 8806, 8810, 8811, 8812, 8813, 8814
- **Input Features:**
