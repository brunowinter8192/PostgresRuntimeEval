...
**Test Query:** Q5_76_seed_615302325
**Timestamp:** 2026-01-18 17:23:57
...
```
Node 9361 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 9362 (Aggregate) [consumed]
    Node 9363 (Gather Merge) [consumed]
      Node 9364 (Aggregate)
        Node 9365 (Sort) [PATTERN: 3e2d5a00]
          Node 9366 (Hash Join) [consumed]
            Node 9367 (Nested Loop)
              Node 9368 (Hash Join)
                Node 9369 (Seq Scan) - LEAF
                Node 9370 (Hash) [PATTERN: 444761fb]
                  Node 9371 (Hash Join) [consumed]
                    Node 9372 (Seq Scan) [consumed] - LEAF
                    Node 9373 (Hash) [consumed]
                      Node 9374 (Hash Join) [consumed]
                        Node 9375 (Seq Scan) - LEAF
                        Node 9376 (Hash)
                          Node 9377 (Seq Scan) - LEAF
              Node 9378 (Index Scan) - LEAF
            Node 9379 (Hash)
              Node 9380 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 9370 | 9361, 9362, 9363, 9365, 9366, 9371, 9372, 9373, 9374 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 9361 | 9362, 9363, 9365, 9366, 9370, 9371, 9372, 9373, 9374 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 9365 | 9361, 9362, 9363, 9366, 9370, 9371, 9372, 9373, 9374 |
...
|------|------|--------|-----------|-----|--------|
| 9361 | Sort | 1058.25 | 2934.42 | 177.3% | pattern |
| 9364 | Aggregate | 1053.49 | 1128.74 | 7.1% | operator |
| 9365 | Sort | 1053.24 | 1835.96 | 74.3% | pattern |
| 9367 | Nested Loop | 1041.82 | 1188.57 | 14.1% | operator |
| 9379 | Hash | 2.50 | 18.67 | 647.7% | operator |
| 9368 | Hash Join | 213.33 | 253.07 | 18.6% | operator |
| 9378 | Index Scan | 0.07 | -0.22 | 405.6% | operator |
| 9380 | Seq Scan | 1.99 | 12.36 | 521.7% | operator |
| 9369 | Seq Scan | 169.23 | 159.81 | 5.6% | operator |
| 9370 | Hash | 30.10 | 46.85 | 55.6% | pattern |
| 9375 | Seq Scan | 0.01 | 11.81 | 131103.0% | operator |
| 9376 | Hash | 0.05 | 21.05 | 40387.0% | operator |
| 9377 | Seq Scan | 0.05 | 22.93 | 46702.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 9377 (Seq Scan) - LEAF
...
### Step 2: Node 9375 (Seq Scan) - LEAF
...
### Step 4: Node 9369 (Seq Scan) - LEAF
...
### Step 5: Node 9370 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 9361, 9362, 9363, 9365, 9366, 9371, 9372, 9373, 9374
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 9378 (Index Scan) - LEAF
...
### Step 8: Node 9380 (Seq Scan) - LEAF
...
### Step 11: Node 9365 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 9361, 9362, 9363, 9366, 9370, 9371, 9372, 9373, 9374
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 9361 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 9362, 9363, 9365, 9366, 9370, 9371, 9372, 9373, 9374
- **Input Features:**
