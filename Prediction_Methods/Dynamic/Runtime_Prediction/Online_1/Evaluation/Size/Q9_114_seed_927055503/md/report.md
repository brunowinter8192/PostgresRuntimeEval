...
```
Node 16923 (Sort) - ROOT
  Node 16924 (Aggregate)
    Node 16925 (Gather)
      Node 16926 (Aggregate)
        Node 16927 (Nested Loop)
          Node 16928 (Hash Join)
            Node 16929 (Seq Scan) - LEAF
            Node 16930 (Hash)
              Node 16931 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 16923 | Sort | 1198.58 | 1116.22 | 6.9% | operator |
| 16924 | Aggregate | 1198.44 | 901.35 | 24.8% | operator |
...
| 16928 | Hash Join | 979.66 | 631.63 | 35.5% | operator |
| 16940 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 16929 | Seq Scan | 701.51 | 509.93 | 27.3% | operator |
| 16930 | Hash | 183.99 | 46.85 | 74.5% | operator |
| 16931 | Hash Join | 180.34 | 923.84 | 412.3% | operator |
...
### Step 10: Node 16929 (Seq Scan) - LEAF
...
### Step 13: Node 16940 (Index Scan) - LEAF
...
### Step 14: Node 16927 (Nested Loop)
