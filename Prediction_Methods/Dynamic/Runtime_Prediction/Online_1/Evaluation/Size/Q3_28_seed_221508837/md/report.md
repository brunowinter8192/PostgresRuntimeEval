...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5051 | 5052, 5053, 5054 |
...
| 5055 | Nested Loop | 1149.45 | 1192.83 | 3.8% | operator |
| 5056 | Hash Join | 206.57 | 230.28 | 11.5% | operator |
| 5060 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5057 | Seq Scan | 152.81 | 163.20 | 6.8% | operator |
| 5058 | Hash | 29.08 | 17.75 | 39.0% | operator |
...
### Step 2: Node 5057 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37332.9400
- **Output:** st=27.11, rt=230.28

### Step 5: Node 5060 (Index Scan) - LEAF
...
- **Output:** st=121.51, rt=1192.83

### Step 7: Node 5051 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5052, 5053, 5054
- **Input Features:**
