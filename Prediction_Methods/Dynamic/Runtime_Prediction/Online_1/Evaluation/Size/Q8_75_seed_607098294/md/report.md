...
```
Node 16007 (Aggregate) - ROOT
  Node 16008 (Gather Merge)
    Node 16009 (Sort)
          ...
          Node 16012 (Hash Join)
            Node 16013 (Nested Loop)
              Node 16014 (Hash Join)
                ...
                Node 16016 (Hash)
                  Node 16017 (Hash Join)
                    Node 16018 (Seq Scan) - LEAF
                    Node 16019 (Hash)
                      Node 16020 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 16007 | Aggregate | 1209.81 | 1195.83 | 1.2% | operator |
| 16008 | Gather Merge | 1209.32 | 1097.15 | 9.3% | operator |
...
| 16014 | Hash Join | 205.91 | 251.17 | 22.0% | operator |
...
| 16016 | Hash | 31.72 | 20.62 | 35.0% | operator |
| 16017 | Hash Join | 31.12 | 132.26 | 325.0% | operator |
| 16018 | Seq Scan | 29.44 | 23.03 | 21.8% | operator |
| 16019 | Hash | 0.17 | 23.66 | 14065.3% | operator |
| 16020 | Hash Join | 0.16 | 306.84 | 186995.1% | operator |
...
### Step 5: Node 16018 (Seq Scan) - LEAF
...
### Step 8: Node 16015 (Seq Scan) - LEAF
...
### Step 11: Node 16024 (Index Scan) - LEAF
...
### Step 12: Node 16026 (Seq Scan) - LEAF
...
### Step 13: Node 16013 (Nested Loop)
...
### Step 16: Node 16027 (Index Scan) - LEAF
...
### Step 17: Node 16029 (Seq Scan) - LEAF
...
### Step 18: Node 16011 (Nested Loop)
...
### Step 22: Node 16008 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1044.9401
  - st2=0.0000
  - startup_cost=71539.0500
  - total_cost=71813.4000
- **Output:** st=1093.44, rt=1097.15

### Step 23: Node 16007 (Aggregate) - ROOT
