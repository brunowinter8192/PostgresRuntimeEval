...
**Test Query:** Q5_104_seed_845015193
...
```
Node 6981 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 6982 (Aggregate) [consumed]
    Node 6983 (Gather Merge) [consumed]
      Node 6984 (Aggregate)
        Node 6985 (Sort) [PATTERN: 3e2d5a00]
          Node 6986 (Hash Join) [consumed]
            Node 6987 (Nested Loop)
              Node 6988 (Hash Join)
                Node 6989 (Seq Scan) - LEAF
                Node 6990 (Hash) [PATTERN: 444761fb]
                  Node 6991 (Hash Join) [consumed]
                    Node 6992 (Seq Scan) [consumed] - LEAF
                    Node 6993 (Hash) [consumed]
                      Node 6994 (Hash Join) [consumed]
                        Node 6995 (Seq Scan) - LEAF
                        Node 6996 (Hash)
                          Node 6997 (Seq Scan) - LEAF
              Node 6998 (Index Scan) - LEAF
            Node 6999 (Hash)
              Node 7000 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 6990 | 6981, 6982, 6983, 6985, 6986, 6991, 6992, 6993, 6994 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 6981 | 6982, 6983, 6985, 6986, 6990, 6991, 6992, 6993, 6994 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 6985 | 6981, 6982, 6983, 6986, 6990, 6991, 6992, 6993, 6994 |
...
|------|------|--------|-----------|-----|--------|
| 6981 | Sort | 1073.51 | 2934.42 | 173.3% | pattern |
| 6984 | Aggregate | 1068.50 | 1128.79 | 5.6% | operator |
| 6985 | Sort | 1068.25 | 1835.90 | 71.9% | pattern |
| 6987 | Nested Loop | 1057.07 | 1188.37 | 12.4% | operator |
| 6999 | Hash | 2.51 | 18.67 | 644.5% | operator |
| 6988 | Hash Join | 216.46 | 253.07 | 16.9% | operator |
| 6998 | Index Scan | 0.07 | -0.22 | 401.4% | operator |
| 7000 | Seq Scan | 2.03 | 12.36 | 508.5% | operator |
| 6989 | Seq Scan | 166.39 | 159.81 | 4.0% | operator |
| 6990 | Hash | 37.23 | 46.85 | 25.8% | pattern |
| 6995 | Seq Scan | 0.01 | 11.81 | 84244.8% | operator |
| 6996 | Hash | 0.15 | 21.05 | 13750.8% | operator |
| 6997 | Seq Scan | 0.15 | 22.93 | 15291.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6997 (Seq Scan) - LEAF
...
### Step 2: Node 6995 (Seq Scan) - LEAF
...
### Step 4: Node 6989 (Seq Scan) - LEAF
...
### Step 5: Node 6990 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 6981, 6982, 6983, 6985, 6986, 6991, 6992, 6993, 6994
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 6998 (Index Scan) - LEAF
...
### Step 8: Node 7000 (Seq Scan) - LEAF
...
### Step 11: Node 6985 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 6981, 6982, 6983, 6986, 6990, 6991, 6992, 6993, 6994
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 6981 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 6982, 6983, 6985, 6986, 6990, 6991, 6992, 6993, 6994
- **Input Features:**
