...
```
Node 31612 (Aggregate) [PATTERN: efde8b38] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31612 | 31613, 31614, 31615 |
...
|------|------|--------|-----------|-----|--------|
| 31612 | Aggregate | 853.93 | 829.30 | 2.9% | pattern |
| 31616 | Seq Scan | 783.30 | 743.46 | 5.1% | operator |
| 31617 | Hash | 48.85 | 8.29 | 83.0% | operator |
| 31618 | Seq Scan | 48.73 | 23.76 | 51.2% | operator |
...
### Step 4: Node 31612 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31613, 31614, 31615
- **Input Features:**
