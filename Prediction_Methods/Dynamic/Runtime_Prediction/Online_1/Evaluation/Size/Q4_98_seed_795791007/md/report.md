...
**Test Query:** Q4_98_seed_795791007
...
```
Node 6880 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6881 (Gather Merge) [consumed]
    Node 6882 (Sort) [consumed]
      Node 6883 (Aggregate) [consumed]
        Node 6884 (Nested Loop)
          Node 6885 (Seq Scan) - LEAF
          Node 6886 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6880 | 6881, 6882, 6883 |
...
|------|------|--------|-----------|-----|--------|
| 6880 | Aggregate | 1064.42 | 952.19 | 10.5% | pattern |
| 6884 | Nested Loop | 1056.45 | 1255.45 | 18.8% | operator |
| 6885 | Seq Scan | 167.05 | 154.67 | 7.4% | operator |
| 6886 | Index Scan | 0.06 | 11.10 | 17526.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6885 (Seq Scan) - LEAF
...
### Step 2: Node 6886 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - Aggregate_total_cost=66756.9600
  ...
  - GatherMerge_Outer_total_cost=66756.8400
  - Sort_Outer_np=0
  - Sort_Outer_nt=5
  - Sort_Outer_nt1=5
  - Sort_Outer_nt2=0
  ...
  - Sort_Outer_startup_cost=65755.0200
  - Sort_Outer_total_cost=65755.0400
