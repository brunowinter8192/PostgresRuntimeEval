...
**Test Query:** Q7_142_seed_1156768371
...
```
Node 11329 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 11330 (Gather Merge) [consumed]
    Node 11331 (Sort)
      Node 11332 (Hash Join)
        Node 11333 (Nested Loop)
          Node 11334 (Hash Join) [PATTERN: 895c6e8c]
            Node 11335 (Seq Scan) [consumed] - LEAF
            Node 11336 (Hash) [consumed]
              Node 11337 (Hash Join) [PATTERN: f4cb205a]
                Node 11338 (Seq Scan) [consumed] - LEAF
                Node 11339 (Hash) [consumed]
                  Node 11340 (Seq Scan) [consumed] - LEAF
          Node 11341 (Index Scan) - LEAF
        Node 11342 (Hash)
          Node 11343 (Hash Join) [PATTERN: f4cb205a]
            Node 11344 (Seq Scan) [consumed] - LEAF
            Node 11345 (Hash) [consumed]
              Node 11346 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 11337 | 11329, 11330, 11334, 11335, 11336, 11338, 11339, 11340, 11343, 11344, 11345, 11346 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 11343 | 11329, 11330, 11334, 11335, 11336, 11337, 11338, 11339, 11340, 11344, 11345, 11346 |
| Aggregate -> Gather Merge (Out | 2724c080 | 11329 | 11330, 11334, 11335, 11336, 11337, 11338, 11339, 11340, 11343, 11344, 11345, 11346 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 11334 | 11329, 11330, 11335, 11336, 11337, 11338, 11339, 11340, 11343, 11344, 11345, 11346 |
...
|------|------|--------|-----------|-----|--------|
| 11329 | Aggregate | 1210.40 | 1163.13 | 3.9% | pattern |
| 11331 | Sort | 1201.85 | 1109.16 | 7.7% | operator |
| 11332 | Hash Join | 1201.19 | 843.11 | 29.8% | operator |
| 11333 | Nested Loop | 1193.23 | 1215.99 | 1.9% | operator |
| 11342 | Hash | 4.05 | 27.74 | 584.8% | operator |
| 11334 | Hash Join | 215.35 | 304.89 | 41.6% | pattern |
| 11341 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 11343 | Hash Join | 4.00 | 429.36 | 10628.7% | pattern |
| 11337 | Hash Join | 33.51 | 429.38 | 1181.3% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11337 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 11329, 11330, 11334, 11335, 11336, 11338, 11339, 11340, 11343, 11344, 11345, 11346
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5000
  - HashJoin_nt1=62500
...
### Step 2: Node 11334 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 11329, 11330, 11335, 11336, 11337, 11338, 11339, 11340, 11343, 11344, 11345, 11346
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=38710
  - HashJoin_nt1=483871
...
### Step 3: Node 11341 (Index Scan) - LEAF
...
### Step 4: Node 11343 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 11329, 11330, 11334, 11335, 11336, 11337, 11338, 11339, 11340, 11344, 11345, 11346
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=800
  - HashJoin_nt1=10000
...
### Step 9: Node 11329 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 11330, 11334, 11335, 11336, 11337, 11338, 11339, 11340, 11343, 11344, 11345, 11346
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
