...
```
Node 11329 (Aggregate) - ROOT
  Node 11330 (Gather Merge)
    Node 11331 (Sort)
      Node 11332 (Hash Join)
        Node 11333 (Nested Loop)
          Node 11334 (Hash Join)
            Node 11335 (Seq Scan) - LEAF
            Node 11336 (Hash)
              Node 11337 (Hash Join)
                Node 11338 (Seq Scan) - LEAF
                Node 11339 (Hash)
                  Node 11340 (Seq Scan) - LEAF
          Node 11341 (Index Scan) - LEAF
        Node 11342 (Hash)
          Node 11343 (Hash Join)
            Node 11344 (Seq Scan) - LEAF
            Node 11345 (Hash)
              Node 11346 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 11329 | Aggregate | 1210.40 | 1209.26 | 0.1% | operator |
| 11330 | Gather Merge | 1209.41 | 1142.98 | 5.5% | operator |
| 11331 | Sort | 1201.85 | 1109.13 | 7.7% | operator |
| 11332 | Hash Join | 1201.19 | 842.59 | 29.9% | operator |
| 11333 | Nested Loop | 1193.23 | 1216.16 | 1.9% | operator |
| 11342 | Hash | 4.05 | 17.53 | 332.7% | operator |
| 11334 | Hash Join | 215.35 | 384.47 | 78.5% | operator |
| 11341 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 11343 | Hash Join | 4.00 | 85.17 | 2028.3% | operator |
| 11335 | Seq Scan | 155.30 | 201.16 | 29.5% | operator |
| 11336 | Hash | 35.40 | 19.59 | 44.6% | operator |
| 11344 | Seq Scan | 3.67 | 11.47 | 212.3% | operator |
| 11345 | Hash | 0.02 | 16.89 | 105488.0% | operator |
| 11337 | Hash Join | 33.51 | 92.20 | 175.1% | operator |
| 11346 | Seq Scan | 0.01 | 45.79 | 416193.8% | operator |
| 11338 | Seq Scan | 32.12 | 21.86 | 32.0% | operator |
| 11339 | Hash | 0.01 | 16.89 | 140684.0% | operator |
| 11340 | Seq Scan | 0.01 | 45.79 | 572303.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11340 (Seq Scan) - LEAF
...
### Step 2: Node 11338 (Seq Scan) - LEAF
...
### Step 5: Node 11346 (Seq Scan) - LEAF
...
### Step 6: Node 11335 (Seq Scan) - LEAF
...
### Step 8: Node 11344 (Seq Scan) - LEAF
...
### Step 11: Node 11341 (Index Scan) - LEAF
...
### Step 13: Node 11333 (Nested Loop)
...
### Step 17: Node 11330 (Gather Merge)
...
### Step 18: Node 11329 (Aggregate) - ROOT
