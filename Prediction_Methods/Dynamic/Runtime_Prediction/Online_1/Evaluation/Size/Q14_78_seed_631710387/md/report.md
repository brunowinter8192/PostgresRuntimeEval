...
```
Node 27295 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27296 (Gather) [consumed]
    Node 27297 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27295 | 27296, 27297 |
...
|------|------|--------|-----------|-----|--------|
| 27295 | Aggregate | 814.73 | 848.39 | 4.1% | pattern |
| 27298 | Hash Join | 791.71 | 807.69 | 2.0% | operator |
| 27299 | Seq Scan | 740.97 | 758.52 | 2.4% | operator |
| 27300 | Hash | 42.36 | 9.38 | 77.9% | operator |
| 27301 | Seq Scan | 36.77 | 12.70 | 65.5% | operator |
...
### Step 5: Node 27295 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27296, 27297
- **Input Features:**
