...
```
Node 27295 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27296 (Gather) [consumed]
    Node 27297 (Aggregate) [consumed]
      Node 27298 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27295 | 27296, 27297, 27298 |
...
|------|------|--------|-----------|-----|--------|
| 27295 | Aggregate | 814.73 | 857.14 | 5.2% | pattern |
...
### Step 4: Node 27295 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27296, 27297, 27298
- **Input Features:**
