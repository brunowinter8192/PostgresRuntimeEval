...
**Test Query:** Q19_122_seed_992687751
...
```
Node 31388 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31389 (Gather) [consumed]
    Node 31390 (Aggregate) [consumed]
      Node 31391 (Hash Join) [consumed]
        Node 31392 (Seq Scan) - LEAF
        Node 31393 (Hash)
          Node 31394 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31388 | 31389, 31390, 31391 |
...
|------|------|--------|-----------|-----|--------|
| 31388 | Aggregate | 814.54 | 829.27 | 1.8% | pattern |
| 31392 | Seq Scan | 744.70 | 743.46 | 0.2% | operator |
| 31393 | Hash | 48.57 | 8.29 | 82.9% | operator |
| 31394 | Seq Scan | 48.45 | 23.76 | 51.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31394 (Seq Scan) - LEAF
...
### Step 2: Node 31392 (Seq Scan) - LEAF
...
### Step 4: Node 31388 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31389, 31390, 31391
- **Input Features:**
  ...
  - Aggregate_startup_cost=157339.1200
  - Aggregate_total_cost=157339.1300
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
