...
**Test Query:** Q4_143_seed_1164972402
...
```
Node 6180 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6181 (Gather Merge) [consumed]
    Node 6182 (Sort) [consumed]
      Node 6183 (Aggregate) [consumed]
        Node 6184 (Nested Loop)
          Node 6185 (Seq Scan) - LEAF
          Node 6186 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6180 | 6181, 6182, 6183 |
...
|------|------|--------|-----------|-----|--------|
| 6180 | Aggregate | 1053.43 | 952.19 | 9.6% | pattern |
| 6184 | Nested Loop | 1045.87 | 1255.45 | 20.0% | operator |
| 6185 | Seq Scan | 168.03 | 154.66 | 8.0% | operator |
| 6186 | Index Scan | 0.06 | 11.10 | 17810.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6185 (Seq Scan) - LEAF
...
### Step 2: Node 6186 (Index Scan) - LEAF
