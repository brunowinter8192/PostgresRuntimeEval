...
```
Node 31731 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31732 (Gather) [consumed]
    Node 31733 (Aggregate) [consumed]
      Node 31734 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31731 | 31732, 31733, 31734 |
...
|------|------|--------|-----------|-----|--------|
| 31731 | Aggregate | 847.41 | 829.30 | 2.1% | pattern |
| 31735 | Seq Scan | 779.03 | 743.46 | 4.6% | operator |
| 31736 | Hash | 44.64 | 8.29 | 81.4% | operator |
| 31737 | Seq Scan | 44.49 | 23.76 | 46.6% | operator |
...
### Step 4: Node 31731 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31732, 31733, 31734
- **Input Features:**
