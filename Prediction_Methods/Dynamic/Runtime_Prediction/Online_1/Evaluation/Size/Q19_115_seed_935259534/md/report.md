...
**Test Query:** Q19_115_seed_935259534
...
```
Node 31332 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31333 (Gather) [consumed]
    Node 31334 (Aggregate) [consumed]
      Node 31335 (Hash Join) [consumed]
        Node 31336 (Seq Scan) - LEAF
        Node 31337 (Hash)
          Node 31338 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31332 | 31333, 31334, 31335 |
...
|------|------|--------|-----------|-----|--------|
| 31332 | Aggregate | 810.72 | 829.30 | 2.3% | pattern |
| 31336 | Seq Scan | 743.83 | 743.46 | 0.1% | operator |
| 31337 | Hash | 45.47 | 8.29 | 81.8% | operator |
| 31338 | Seq Scan | 45.23 | 23.76 | 47.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31338 (Seq Scan) - LEAF
...
### Step 2: Node 31336 (Seq Scan) - LEAF
...
### Step 4: Node 31332 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31333, 31334, 31335
- **Input Features:**
  ...
  - Aggregate_Outer_startup_cost=156338.9000
  - Aggregate_Outer_total_cost=156338.9100
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=157339.4400
  - Aggregate_total_cost=157339.4500
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=157338.9000
  - Gather_Outer_total_cost=157339.4100
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=23
  - HashJoin_Outer_nt1=22568
  ...
  - HashJoin_Outer_total_cost=156338.7200
- **Output:** st=824.26, rt=829.30
