...
```
Node 31332 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31333 (Gather) [consumed]
    Node 31334 (Aggregate) [consumed]
      Node 31335 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31332 | 31333, 31334 |
...
|------|------|--------|-----------|-----|--------|
| 31332 | Aggregate | 810.72 | 831.20 | 2.5% | pattern |
| 31335 | Hash Join | 791.49 | 766.06 | 3.2% | operator |
...
- **Input Features:**
  ...
  - total_cost=156338.7200
- **Output:** st=60.26, rt=766.06

### Step 5: Node 31332 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31333, 31334
- **Input Features:**
