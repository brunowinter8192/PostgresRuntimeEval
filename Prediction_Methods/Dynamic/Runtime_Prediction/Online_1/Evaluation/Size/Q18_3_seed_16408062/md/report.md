...
**Test Query:** Q18_3_seed_16408062
...
```
Node 30148 (Limit) - ROOT
  Node 30149 (Sort)
    Node 30150 (Aggregate)
      Node 30151 (Gather Merge)
        Node 30152 (Incremental Sort)
          Node 30153 (Nested Loop)
            Node 30154 (Merge Join)
              Node 30155 (Sort)
                Node 30156 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30157 (Seq Scan) [consumed] - LEAF
                  Node 30158 (Hash) [consumed]
                    Node 30159 (Aggregate)
                      Node 30160 (Index Scan) - LEAF
              Node 30161 (Sort)
                Node 30162 (Seq Scan) - LEAF
            Node 30163 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30156 | 30157, 30158 |
...
|------|------|--------|-----------|-----|--------|
| 30148 | Limit | 3069.13 | 1175.21 | 61.7% | operator |
| 30149 | Sort | 2958.00 | 1127.81 | 61.9% | operator |
| 30150 | Aggregate | 2957.95 | 1073.15 | 63.7% | operator |
| 30151 | Gather Merge | 2957.94 | 1073.95 | 63.7% | operator |
| 30152 | Incremental Sort | 2923.53 | 0.00 | 100.0% | operator |
| 30153 | Nested Loop | 2923.48 | 1111.34 | 62.0% | operator |
| 30154 | Merge Join | 2923.43 | 0.00 | 100.0% | operator |
| 30163 | Index Scan | 0.02 | 0.05 | 137.6% | operator |
| 30155 | Sort | 2871.04 | 1095.58 | 61.8% | operator |
| 30161 | Sort | 67.13 | 1074.66 | 1500.9% | operator |
| 30156 | Hash Join | 2871.03 | 471.07 | 83.6% | pattern |
| 30162 | Seq Scan | 55.53 | 18.25 | 67.1% | operator |
| 30159 | Aggregate | 2645.46 | 1073.15 | 59.4% | operator |
| 30160 | Index Scan | 2143.32 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30160 (Index Scan) - LEAF
...
### Step 3: Node 30156 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30157, 30158
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30162 (Seq Scan) - LEAF
...
### Step 7: Node 30154 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30163 (Index Scan) - LEAF
...
### Step 10: Node 30152 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30151 (Gather Merge)
