        ...
        Node 30152 (Incremental Sort)
          Node 30153 (Nested Loop)
            Node 30154 (Merge Join)
              Node 30155 (Sort)
                Node 30156 (Hash Join)
                  Node 30157 (Seq Scan) - LEAF
                  Node 30158 (Hash)
...
| 30155 | Sort | 2871.04 | 1099.77 | 61.7% | operator |
| 30161 | Sort | 67.13 | 1074.66 | 1500.9% | operator |
| 30156 | Hash Join | 2871.03 | 686.33 | 76.1% | operator |
| 30162 | Seq Scan | 55.53 | 18.25 | 67.1% | operator |
| 30157 | Seq Scan | 194.26 | 170.37 | 12.3% | operator |
| 30158 | Hash | 2645.50 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30157 (Seq Scan) - LEAF
...
### Step 6: Node 30162 (Seq Scan) - LEAF
...
### Step 9: Node 30154 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30163 (Index Scan) - LEAF
...
### Step 11: Node 30153 (Nested Loop)
...
### Step 12: Node 30152 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30151 (Gather Merge)
