...
**Test Query:** Q13_26_seed_205100775
...
```
Node 25846 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25847 (Aggregate) [consumed]
    Node 25848 (Aggregate)
      Node 25849 (Hash Join) [PATTERN: 895c6e8c]
        Node 25850 (Seq Scan) [consumed] - LEAF
        Node 25851 (Hash) [consumed]
          Node 25852 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25846 | 25847, 25849, 25850, 25851 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25849 | 25846, 25847, 25850, 25851 |
...
|------|------|--------|-----------|-----|--------|
| 25846 | Sort | 912.88 | 1079.94 | 18.3% | pattern |
| 25848 | Aggregate | 906.83 | 999.76 | 10.2% | operator |
| 25849 | Hash Join | 695.28 | 470.31 | 32.4% | pattern |
| 25852 | Index Only Scan | 10.08 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25852 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25849 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25846, 25847, 25850, 25851
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 25846 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25847, 25849, 25850, 25851
- **Input Features:**
