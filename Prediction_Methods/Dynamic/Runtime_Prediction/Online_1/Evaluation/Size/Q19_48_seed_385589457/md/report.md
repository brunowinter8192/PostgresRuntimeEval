...
**Test Query:** Q19_48_seed_385589457
...
```
Node 31864 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31865 (Gather) [consumed]
    Node 31866 (Aggregate) [consumed]
      Node 31867 (Hash Join) [consumed]
        Node 31868 (Seq Scan) - LEAF
        Node 31869 (Hash)
          Node 31870 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31864 | 31865, 31866, 31867 |
...
|------|------|--------|-----------|-----|--------|
| 31864 | Aggregate | 847.04 | 829.27 | 2.1% | pattern |
| 31868 | Seq Scan | 777.42 | 743.46 | 4.4% | operator |
| 31869 | Hash | 46.67 | 8.29 | 82.2% | operator |
| 31870 | Seq Scan | 46.56 | 23.76 | 49.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31870 (Seq Scan) - LEAF
...
### Step 2: Node 31868 (Seq Scan) - LEAF
...
### Step 4: Node 31864 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31865, 31866, 31867
- **Input Features:**
