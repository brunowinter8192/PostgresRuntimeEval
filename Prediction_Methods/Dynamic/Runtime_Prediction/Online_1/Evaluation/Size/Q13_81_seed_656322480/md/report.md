...
```
Node 26273 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26274 (Aggregate) [consumed]
    Node 26275 (Aggregate)
      Node 26276 (Hash Join) [PATTERN: 895c6e8c]
        Node 26277 (Seq Scan) [consumed] - LEAF
        Node 26278 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26273 | 26274, 26276, 26277, 26278 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26276 | 26273, 26274, 26277, 26278 |
...
|------|------|--------|-----------|-----|--------|
| 26273 | Sort | 909.45 | 1079.92 | 18.7% | pattern |
| 26275 | Aggregate | 903.38 | 998.94 | 10.6% | operator |
| 26276 | Hash Join | 686.40 | 470.31 | 31.5% | pattern |
...
### Step 2: Node 26276 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26273, 26274, 26277, 26278
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1475952
...
### Step 4: Node 26273 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26274, 26276, 26277, 26278
- **Input Features:**
