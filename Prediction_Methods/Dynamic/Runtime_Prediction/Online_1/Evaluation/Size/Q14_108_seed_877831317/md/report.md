...
```
Node 26476 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26477 (Gather) [consumed]
    Node 26478 (Aggregate) [consumed]
      Node 26479 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26476 | 26477, 26478 |
...
|------|------|--------|-----------|-----|--------|
| 26476 | Aggregate | 797.32 | 848.37 | 6.4% | pattern |
| 26479 | Hash Join | 771.23 | 807.66 | 4.7% | operator |
...
### Step 5: Node 26476 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26477, 26478
- **Input Features:**
