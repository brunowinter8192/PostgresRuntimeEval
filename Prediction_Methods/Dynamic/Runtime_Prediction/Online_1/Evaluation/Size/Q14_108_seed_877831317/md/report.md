...
**Test Query:** Q14_108_seed_877831317
...
```
Node 26476 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26477 (Gather) [consumed]
    Node 26478 (Aggregate) [consumed]
      Node 26479 (Hash Join) [consumed]
        Node 26480 (Seq Scan) - LEAF
        Node 26481 (Hash)
          Node 26482 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26476 | 26477, 26478, 26479 |
...
|------|------|--------|-----------|-----|--------|
| 26476 | Aggregate | 797.32 | 857.13 | 7.5% | pattern |
| 26480 | Seq Scan | 721.88 | 758.50 | 5.1% | operator |
| 26481 | Hash | 41.09 | 9.38 | 77.2% | operator |
| 26482 | Seq Scan | 36.38 | 12.70 | 65.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26482 (Seq Scan) - LEAF
...
### Step 2: Node 26480 (Seq Scan) - LEAF
...
### Step 4: Node 26476 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26477, 26478, 26479
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=15510
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=64
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0001
  - Aggregate_Outer_startup_cost=136918.7800
  - Aggregate_Outer_total_cost=136918.7900
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=137919.3500
  - Aggregate_total_cost=137919.3600
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=137918.7800
  - Gather_Outer_total_cost=137919.2900
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=15510
  - HashJoin_Outer_nt1=15510
  ...
  - HashJoin_Outer_total_cost=136647.3500
