...
**Test Query:** Q14_147_seed_1197788526
...
```
Node 26777 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26778 (Gather) [consumed]
    Node 26779 (Aggregate) [consumed]
      Node 26780 (Hash Join)
        Node 26781 (Seq Scan) - LEAF
        Node 26782 (Hash)
          Node 26783 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26777 | 26778, 26779 |
...
|------|------|--------|-----------|-----|--------|
| 26777 | Aggregate | 809.25 | 848.38 | 4.8% | pattern |
| 26780 | Hash Join | 788.24 | 807.68 | 2.5% | operator |
| 26781 | Seq Scan | 739.43 | 758.51 | 2.6% | operator |
| 26782 | Hash | 41.40 | 9.38 | 77.3% | operator |
| 26783 | Seq Scan | 36.48 | 12.70 | 65.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26783 (Seq Scan) - LEAF
...
### Step 2: Node 26781 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=136648.4500
- **Output:** st=78.58, rt=807.68

### Step 5: Node 26777 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26778, 26779
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=15928
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=64
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0001
  - Aggregate_Outer_startup_cost=136927.2000
  - Aggregate_Outer_total_cost=136927.2100
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=137927.7600
  - Aggregate_total_cost=137927.7800
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=137927.2000
  - Gather_Outer_total_cost=137927.7100
