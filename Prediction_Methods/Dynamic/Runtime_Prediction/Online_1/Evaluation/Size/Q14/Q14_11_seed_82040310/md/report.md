...
```
Node 26567 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26568 (Gather) [consumed]
    Node 26569 (Aggregate) [consumed]
      Node 26570 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26567 | 26568, 26569 |
...
|------|------|--------|-----------|-----|--------|
| 26567 | Aggregate | 809.78 | 848.37 | 4.8% | pattern |
| 26570 | Hash Join | 788.55 | 807.66 | 2.4% | operator |
...
### Step 5: Node 26567 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26568, 26569
- **Input Features:**
