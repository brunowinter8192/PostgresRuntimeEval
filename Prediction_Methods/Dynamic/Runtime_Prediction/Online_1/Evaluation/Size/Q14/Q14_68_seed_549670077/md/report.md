...
**Test Query:** Q14_68_seed_549670077
...
```
Node 27218 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27219 (Gather) [consumed]
    Node 27220 (Aggregate) [consumed]
      Node 27221 (Hash Join)
        Node 27222 (Seq Scan) - LEAF
        Node 27223 (Hash)
          Node 27224 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27218 | 27219, 27220 |
...
|------|------|--------|-----------|-----|--------|
| 27218 | Aggregate | 821.30 | 848.34 | 3.3% | pattern |
| 27221 | Hash Join | 801.06 | 807.60 | 0.8% | operator |
| 27222 | Seq Scan | 749.97 | 758.45 | 1.1% | operator |
| 27223 | Hash | 43.23 | 9.38 | 78.3% | operator |
| 27224 | Seq Scan | 38.37 | 12.70 | 66.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27224 (Seq Scan) - LEAF
...
### Step 2: Node 27222 (Seq Scan) - LEAF
...
### Step 5: Node 27218 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27219, 27220
- **Input Features:**
