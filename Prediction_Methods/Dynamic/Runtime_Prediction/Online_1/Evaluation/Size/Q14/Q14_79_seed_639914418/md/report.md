...
```
Node 27302 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27303 (Gather) [consumed]
    Node 27304 (Aggregate) [consumed]
      Node 27305 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27302 | 27303, 27304 |
...
|------|------|--------|-----------|-----|--------|
| 27302 | Aggregate | 804.60 | 848.38 | 5.4% | pattern |
| 27305 | Hash Join | 781.69 | 807.67 | 3.3% | operator |
...
### Step 5: Node 27302 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27303, 27304
- **Input Features:**
