...
```
Node 27015 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27016 (Gather) [consumed]
    Node 27017 (Aggregate) [consumed]
      Node 27018 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27015 | 27016, 27017 |
...
|------|------|--------|-----------|-----|--------|
| 27015 | Aggregate | 779.34 | 848.37 | 8.9% | pattern |
| 27018 | Hash Join | 757.41 | 807.66 | 6.6% | operator |
...
### Step 5: Node 27015 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27016, 27017
- **Input Features:**
