...
```
Node 27029 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27030 (Gather) [consumed]
    Node 27031 (Aggregate) [consumed]
      Node 27032 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27029 | 27030, 27031 |
...
|------|------|--------|-----------|-----|--------|
| 27029 | Aggregate | 802.19 | 848.35 | 5.8% | pattern |
| 27032 | Hash Join | 781.23 | 807.63 | 3.4% | operator |
...
### Step 5: Node 27029 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27030, 27031
- **Input Features:**
