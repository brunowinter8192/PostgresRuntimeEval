...
**Test Query:** Q14_139_seed_1132156278
...
```
Node 26714 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26715 (Gather) [consumed]
    Node 26716 (Aggregate) [consumed]
      Node 26717 (Hash Join)
        Node 26718 (Seq Scan) - LEAF
        Node 26719 (Hash)
          Node 26720 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26714 | 26715, 26716 |
...
|------|------|--------|-----------|-----|--------|
| 26714 | Aggregate | 807.60 | 848.35 | 5.0% | pattern |
| 26717 | Hash Join | 785.71 | 807.62 | 2.8% | operator |
| 26718 | Seq Scan | 736.51 | 758.47 | 3.0% | operator |
| 26719 | Hash | 41.21 | 9.38 | 77.2% | operator |
| 26720 | Seq Scan | 35.76 | 12.70 | 64.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26720 (Seq Scan) - LEAF
...
### Step 2: Node 26718 (Seq Scan) - LEAF
...
### Step 5: Node 26714 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26715, 26716
- **Input Features:**
