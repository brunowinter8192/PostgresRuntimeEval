...
```
Node 26441 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26442 (Gather) [consumed]
    Node 26443 (Aggregate) [consumed]
      Node 26444 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26441 | 26442, 26443 |
...
|------|------|--------|-----------|-----|--------|
| 26441 | Aggregate | 822.03 | 848.36 | 3.2% | pattern |
| 26444 | Hash Join | 800.91 | 807.63 | 0.8% | operator |
...
### Step 5: Node 26441 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26442, 26443
- **Input Features:**
