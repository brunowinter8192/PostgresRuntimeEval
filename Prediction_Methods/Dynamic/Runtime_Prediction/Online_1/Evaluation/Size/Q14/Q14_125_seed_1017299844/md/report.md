...
```
Node 26609 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26610 (Gather) [consumed]
    Node 26611 (Aggregate) [consumed]
      Node 26612 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26609 | 26610, 26611 |
...
|------|------|--------|-----------|-----|--------|
| 26609 | Aggregate | 858.11 | 848.37 | 1.1% | pattern |
| 26612 | Hash Join | 835.22 | 807.65 | 3.3% | operator |
...
### Step 5: Node 26609 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26610, 26611
- **Input Features:**
