...
```
Node 26469 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26470 (Gather) [consumed]
    Node 26471 (Aggregate) [consumed]
      Node 26472 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26469 | 26470, 26471 |
...
|------|------|--------|-----------|-----|--------|
| 26469 | Aggregate | 818.33 | 848.37 | 3.7% | pattern |
| 26472 | Hash Join | 797.62 | 807.66 | 1.3% | operator |
...
### Step 5: Node 26469 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26470, 26471
- **Input Features:**
