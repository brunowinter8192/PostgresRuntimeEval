...
**Test Query:** Q14_69_seed_557874108
...
```
Node 27225 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27226 (Gather) [consumed]
    Node 27227 (Aggregate) [consumed]
      Node 27228 (Hash Join)
        Node 27229 (Seq Scan) - LEAF
        Node 27230 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27225 | 27226, 27227 |
...
|------|------|--------|-----------|-----|--------|
| 27225 | Aggregate | 818.71 | 848.38 | 3.6% | pattern |
| 27228 | Hash Join | 796.73 | 807.67 | 1.4% | operator |
| 27229 | Seq Scan | 745.34 | 758.51 | 1.8% | operator |
| 27230 | Hash | 42.96 | 9.38 | 78.2% | operator |
| 27231 | Seq Scan | 38.13 | 12.70 | 66.7% | operator |
...
### Step 2: Node 27229 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=136648.0800
- **Output:** st=78.58, rt=807.67

### Step 5: Node 27225 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27226, 27227
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=15788
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=64
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0001
  - Aggregate_Outer_startup_cost=136924.3800
  - Aggregate_Outer_total_cost=136924.3900
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=137924.9400
  - Aggregate_total_cost=137924.9600
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=137924.3800
  - Gather_Outer_total_cost=137924.8900
