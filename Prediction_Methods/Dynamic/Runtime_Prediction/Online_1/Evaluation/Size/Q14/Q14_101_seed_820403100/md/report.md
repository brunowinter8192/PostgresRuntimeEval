...
```
Node 26427 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26428 (Gather) [consumed]
    Node 26429 (Aggregate) [consumed]
      Node 26430 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26427 | 26428, 26429 |
...
|------|------|--------|-----------|-----|--------|
| 26427 | Aggregate | 823.69 | 848.37 | 3.0% | pattern |
| 26430 | Hash Join | 802.36 | 807.66 | 0.7% | operator |
...
### Step 5: Node 26427 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26428, 26429
- **Input Features:**
