...
```
Node 26987 (Aggregate) [PATTERN: a5f39f08] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26987 | 26988, 26989 |
...
|------|------|--------|-----------|-----|--------|
| 26987 | Aggregate | 802.60 | 848.38 | 5.7% | pattern |
| 26990 | Hash Join | 781.22 | 807.67 | 3.4% | operator |
...
### Step 5: Node 26987 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26988, 26989
- **Input Features:**
