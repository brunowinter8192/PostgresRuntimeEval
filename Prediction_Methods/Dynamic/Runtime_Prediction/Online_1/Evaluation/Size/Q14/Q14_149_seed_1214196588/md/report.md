...
**Test Query:** Q14_149_seed_1214196588
...
```
Node 26791 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26792 (Gather) [consumed]
    Node 26793 (Aggregate) [consumed]
      Node 26794 (Hash Join)
        Node 26795 (Seq Scan) - LEAF
        Node 26796 (Hash)
          Node 26797 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26791 | 26792, 26793 |
...
|------|------|--------|-----------|-----|--------|
| 26791 | Aggregate | 810.15 | 848.35 | 4.7% | pattern |
| 26794 | Hash Join | 788.43 | 807.62 | 2.4% | operator |
| 26795 | Seq Scan | 735.11 | 758.47 | 3.2% | operator |
| 26796 | Hash | 45.04 | 9.38 | 79.2% | operator |
| 26797 | Seq Scan | 39.07 | 12.70 | 67.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26797 (Seq Scan) - LEAF
...
### Step 2: Node 26795 (Seq Scan) - LEAF
...
### Step 5: Node 26791 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26792, 26793
- **Input Features:**
