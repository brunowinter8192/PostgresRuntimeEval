...
**Test Query:** Q14_39_seed_311753178
...
```
Node 26994 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26995 (Gather) [consumed]
    Node 26996 (Aggregate) [consumed]
      Node 26997 (Hash Join)
        Node 26998 (Seq Scan) - LEAF
        Node 26999 (Hash)
          Node 27000 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26994 | 26995, 26996 |
...
|------|------|--------|-----------|-----|--------|
| 26994 | Aggregate | 814.55 | 848.33 | 4.1% | pattern |
| 26997 | Hash Join | 791.57 | 807.56 | 2.0% | operator |
| 26998 | Seq Scan | 742.33 | 758.42 | 2.2% | operator |
| 26999 | Hash | 41.83 | 9.38 | 77.6% | operator |
| 27000 | Seq Scan | 35.79 | 12.70 | 64.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27000 (Seq Scan) - LEAF
...
### Step 2: Node 26998 (Seq Scan) - LEAF
...
- **Output:** st=6.82, rt=758.42

### Step 3: Node 26999 (Hash)
...
- **Output:** st=78.54, rt=807.56

### Step 5: Node 26994 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26995, 26996
- **Input Features:**
