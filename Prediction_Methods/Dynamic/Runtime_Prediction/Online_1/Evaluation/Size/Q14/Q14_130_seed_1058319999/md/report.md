...
```
Node 26651 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26652 (Gather) [consumed]
    Node 26653 (Aggregate) [consumed]
      Node 26654 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26651 | 26652, 26653 |
...
|------|------|--------|-----------|-----|--------|
| 26651 | Aggregate | 823.17 | 848.36 | 3.1% | pattern |
| 26654 | Hash Join | 800.57 | 807.64 | 0.9% | operator |
...
### Step 5: Node 26651 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26652, 26653
- **Input Features:**
