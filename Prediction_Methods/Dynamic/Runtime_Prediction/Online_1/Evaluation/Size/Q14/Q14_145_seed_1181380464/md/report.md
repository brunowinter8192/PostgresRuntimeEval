...
**Test Query:** Q14_145_seed_1181380464
**Timestamp:** 2025-12-21 18:13:16
...
```
Node 26763 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26764 (Gather) [consumed]
    Node 26765 (Aggregate) [consumed]
      Node 26766 (Hash Join)
        Node 26767 (Seq Scan) - LEAF
        Node 26768 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26763 | 26764, 26765 |
...
|------|------|--------|-----------|-----|--------|
| 26763 | Aggregate | 815.18 | 848.37 | 4.1% | pattern |
| 26766 | Hash Join | 794.50 | 807.66 | 1.7% | operator |
| 26767 | Seq Scan | 743.68 | 758.50 | 2.0% | operator |
| 26768 | Hash | 42.67 | 9.38 | 78.0% | operator |
| 26769 | Seq Scan | 38.09 | 12.70 | 66.7% | operator |
...
### Step 2: Node 26767 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=136647.6700
- **Output:** st=78.57, rt=807.66

### Step 5: Node 26763 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26764, 26765
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=15630
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=64
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0001
  - Aggregate_Outer_startup_cost=136921.2000
  - Aggregate_Outer_total_cost=136921.2100
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=137921.7600
  - Aggregate_total_cost=137921.7800
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=137921.2000
  - Gather_Outer_total_cost=137921.7100
- **Output:** st=842.88, rt=848.37
