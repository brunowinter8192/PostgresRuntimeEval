...
Node 27407 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27408 (Gather) [consumed]
    Node 27409 (Aggregate) [consumed]
      Node 27410 (Hash Join)
        Node 27411 (Seq Scan) - LEAF
        Node 27412 (Hash)
          Node 27413 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27407 | 27408, 27409 |
...
|------|------|--------|-----------|-----|--------|
| 27407 | Aggregate | 836.85 | 848.38 | 1.4% | pattern |
| 27410 | Hash Join | 814.77 | 807.67 | 0.9% | operator |
| 27411 | Seq Scan | 760.17 | 758.51 | 0.2% | operator |
| 27412 | Hash | 46.69 | 9.38 | 79.9% | operator |
| 27413 | Seq Scan | 40.49 | 12.70 | 68.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27413 (Seq Scan) - LEAF
...
### Step 2: Node 27411 (Seq Scan) - LEAF
...
### Step 5: Node 27407 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27408, 27409
- **Input Features:**
