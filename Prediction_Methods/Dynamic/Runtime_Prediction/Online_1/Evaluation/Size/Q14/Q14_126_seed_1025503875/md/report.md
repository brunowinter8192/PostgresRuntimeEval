...
**Test Query:** Q14_126_seed_1025503875
...
```
Node 26616 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26617 (Gather) [consumed]
    Node 26618 (Aggregate) [consumed]
      Node 26619 (Hash Join)
        Node 26620 (Seq Scan) - LEAF
        Node 26621 (Hash)
          Node 26622 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26616 | 26617, 26618 |
...
|------|------|--------|-----------|-----|--------|
| 26616 | Aggregate | 850.09 | 848.38 | 0.2% | pattern |
| 26619 | Hash Join | 827.78 | 807.67 | 2.4% | operator |
| 26620 | Seq Scan | 774.49 | 758.51 | 2.1% | operator |
| 26621 | Hash | 44.12 | 9.38 | 78.7% | operator |
| 26622 | Seq Scan | 39.40 | 12.70 | 67.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26622 (Seq Scan) - LEAF
...
### Step 2: Node 26620 (Seq Scan) - LEAF
...
### Step 5: Node 26616 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26617, 26618
- **Input Features:**
