...
**Test Query:** Q14_61_seed_492241860
...
```
Node 27169 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27170 (Gather) [consumed]
    Node 27171 (Aggregate) [consumed]
      Node 27172 (Hash Join)
        Node 27173 (Seq Scan) - LEAF
        Node 27174 (Hash)
          Node 27175 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27169 | 27170, 27171 |
...
|------|------|--------|-----------|-----|--------|
| 27169 | Aggregate | 824.20 | 848.38 | 2.9% | pattern |
| 27172 | Hash Join | 798.64 | 807.67 | 1.1% | operator |
| 27173 | Seq Scan | 748.37 | 758.51 | 1.4% | operator |
| 27174 | Hash | 42.02 | 9.38 | 77.7% | operator |
| 27175 | Seq Scan | 37.24 | 12.70 | 65.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27175 (Seq Scan) - LEAF
...
### Step 2: Node 27173 (Seq Scan) - LEAF
...
### Step 5: Node 27169 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27170, 27171
- **Input Features:**
