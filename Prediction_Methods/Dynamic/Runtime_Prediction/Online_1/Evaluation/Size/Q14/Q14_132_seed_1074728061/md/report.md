...
```
Node 26665 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26666 (Gather) [consumed]
    Node 26667 (Aggregate) [consumed]
      Node 26668 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26665 | 26666, 26667 |
...
|------|------|--------|-----------|-----|--------|
| 26665 | Aggregate | 818.36 | 848.37 | 3.7% | pattern |
| 26668 | Hash Join | 797.08 | 807.66 | 1.3% | operator |
...
### Step 5: Node 26665 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26666, 26667
- **Input Features:**
