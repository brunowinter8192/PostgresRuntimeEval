...
**Test Query:** Q14_131_seed_1066524030
...
```
Node 26658 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26659 (Gather) [consumed]
    Node 26660 (Aggregate) [consumed]
      Node 26661 (Hash Join)
        Node 26662 (Seq Scan) - LEAF
        Node 26663 (Hash)
          Node 26664 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26658 | 26659, 26660 |
...
|------|------|--------|-----------|-----|--------|
| 26658 | Aggregate | 811.90 | 848.37 | 4.5% | pattern |
| 26661 | Hash Join | 789.88 | 807.67 | 2.3% | operator |
| 26662 | Seq Scan | 740.20 | 758.50 | 2.5% | operator |
| 26663 | Hash | 42.36 | 9.38 | 77.9% | operator |
| 26664 | Seq Scan | 38.42 | 12.70 | 66.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26664 (Seq Scan) - LEAF
...
### Step 2: Node 26662 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=136647.7000
- **Output:** st=78.57, rt=807.67

### Step 5: Node 26658 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26659, 26660
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=15641
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=64
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0001
  - Aggregate_Outer_startup_cost=136921.4200
  - Aggregate_Outer_total_cost=136921.4300
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=137921.9900
  - Aggregate_total_cost=137922.0000
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=137921.4200
  - Gather_Outer_total_cost=137921.9300
