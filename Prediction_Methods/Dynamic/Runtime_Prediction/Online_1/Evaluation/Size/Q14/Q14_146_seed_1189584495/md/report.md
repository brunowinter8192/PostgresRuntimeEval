...
```
Node 26770 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26771 (Gather) [consumed]
    Node 26772 (Aggregate) [consumed]
      Node 26773 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26770 | 26771, 26772 |
...
|------|------|--------|-----------|-----|--------|
| 26770 | Aggregate | 807.69 | 848.37 | 5.0% | pattern |
| 26773 | Hash Join | 787.54 | 807.66 | 2.6% | operator |
...
- **Input Features:**
  ...
  - total_cost=136647.4400
- **Output:** st=78.57, rt=807.66

### Step 5: Node 26770 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26771, 26772
- **Input Features:**
