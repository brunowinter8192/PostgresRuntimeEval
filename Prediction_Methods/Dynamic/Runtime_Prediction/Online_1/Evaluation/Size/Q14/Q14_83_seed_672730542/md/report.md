...
Node 27337 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27338 (Gather) [consumed]
    Node 27339 (Aggregate) [consumed]
      Node 27340 (Hash Join)
        Node 27341 (Seq Scan) - LEAF
        Node 27342 (Hash)
          Node 27343 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27337 | 27338, 27339 |
...
|------|------|--------|-----------|-----|--------|
| 27337 | Aggregate | 815.22 | 848.38 | 4.1% | pattern |
| 27340 | Hash Join | 793.43 | 807.67 | 1.8% | operator |
| 27341 | Seq Scan | 740.11 | 758.51 | 2.5% | operator |
| 27342 | Hash | 44.45 | 9.38 | 78.9% | operator |
| 27343 | Seq Scan | 39.40 | 12.70 | 67.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27343 (Seq Scan) - LEAF
...
### Step 2: Node 27341 (Seq Scan) - LEAF
...
### Step 5: Node 27337 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27338, 27339
- **Input Features:**
