...
**Test Query:** Q14_28_seed_221508837
...
```
Node 26910 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26911 (Gather) [consumed]
    Node 26912 (Aggregate) [consumed]
      Node 26913 (Hash Join)
        Node 26914 (Seq Scan) - LEAF
        Node 26915 (Hash)
          Node 26916 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26910 | 26911, 26912 |
...
|------|------|--------|-----------|-----|--------|
| 26910 | Aggregate | 830.76 | 848.36 | 2.1% | pattern |
| 26913 | Hash Join | 808.57 | 807.64 | 0.1% | operator |
| 26914 | Seq Scan | 758.61 | 758.48 | 0.0% | operator |
| 26915 | Hash | 42.42 | 9.38 | 77.9% | operator |
| 26916 | Seq Scan | 37.25 | 12.70 | 65.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26916 (Seq Scan) - LEAF
...
### Step 2: Node 26914 (Seq Scan) - LEAF
...
### Step 5: Node 26910 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26911, 26912
- **Input Features:**
