...
Node 27435 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27436 (Gather) [consumed]
    Node 27437 (Aggregate) [consumed]
      Node 27438 (Hash Join)
        Node 27439 (Seq Scan) - LEAF
        Node 27440 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27435 | 27436, 27437 |
...
|------|------|--------|-----------|-----|--------|
| 27435 | Aggregate | 844.73 | 848.37 | 0.4% | pattern |
| 27438 | Hash Join | 822.67 | 807.65 | 1.8% | operator |
| 27439 | Seq Scan | 769.01 | 758.49 | 1.4% | operator |
| 27440 | Hash | 45.05 | 9.38 | 79.2% | operator |
| 27441 | Seq Scan | 39.11 | 12.70 | 67.5% | operator |
...
### Step 2: Node 27439 (Seq Scan) - LEAF
...
### Step 5: Node 27435 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27436, 27437
- **Input Features:**
