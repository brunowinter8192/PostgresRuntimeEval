...
```
Node 27106 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27107 (Gather) [consumed]
    Node 27108 (Aggregate) [consumed]
      Node 27109 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27106 | 27107, 27108 |
...
|------|------|--------|-----------|-----|--------|
| 27106 | Aggregate | 818.57 | 848.37 | 3.6% | pattern |
| 27109 | Hash Join | 794.47 | 807.66 | 1.7% | operator |
...
### Step 5: Node 27106 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27107, 27108
- **Input Features:**
