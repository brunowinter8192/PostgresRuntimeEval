...
**Test Query:** Q14_119_seed_968075658
...
```
Node 26560 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26561 (Gather) [consumed]
    Node 26562 (Aggregate) [consumed]
      Node 26563 (Hash Join)
        Node 26564 (Seq Scan) - LEAF
        Node 26565 (Hash)
          Node 26566 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26560 | 26561, 26562 |
...
|------|------|--------|-----------|-----|--------|
| 26560 | Aggregate | 792.65 | 848.38 | 7.0% | pattern |
| 26563 | Hash Join | 772.73 | 807.67 | 4.5% | operator |
| 26564 | Seq Scan | 720.07 | 758.51 | 5.3% | operator |
| 26565 | Hash | 44.36 | 9.38 | 78.9% | operator |
| 26566 | Seq Scan | 39.13 | 12.70 | 67.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26566 (Seq Scan) - LEAF
...
### Step 2: Node 26564 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=136648.1200
- **Output:** st=78.58, rt=807.67

### Step 5: Node 26560 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26561, 26562
- **Input Features:**
