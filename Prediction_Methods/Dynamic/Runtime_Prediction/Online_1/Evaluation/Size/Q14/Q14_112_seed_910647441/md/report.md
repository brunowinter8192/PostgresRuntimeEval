...
**Test Query:** Q14_112_seed_910647441
...
```
Node 26511 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26512 (Gather) [consumed]
    Node 26513 (Aggregate) [consumed]
      Node 26514 (Hash Join)
        Node 26515 (Seq Scan) - LEAF
        Node 26516 (Hash)
          Node 26517 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26511 | 26512, 26513 |
...
|------|------|--------|-----------|-----|--------|
| 26511 | Aggregate | 818.53 | 848.34 | 3.6% | pattern |
| 26514 | Hash Join | 797.68 | 807.60 | 1.2% | operator |
| 26515 | Seq Scan | 746.82 | 758.45 | 1.6% | operator |
| 26516 | Hash | 43.49 | 9.38 | 78.4% | operator |
| 26517 | Seq Scan | 38.21 | 12.70 | 66.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26517 (Seq Scan) - LEAF
...
### Step 2: Node 26515 (Seq Scan) - LEAF
...
- **Output:** st=6.82, rt=758.45

### Step 3: Node 26516 (Hash)
...
- **Input Features:**
  ...
  - total_cost=136644.2300
- **Output:** st=78.55, rt=807.60

### Step 5: Node 26511 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26512, 26513
- **Input Features:**
