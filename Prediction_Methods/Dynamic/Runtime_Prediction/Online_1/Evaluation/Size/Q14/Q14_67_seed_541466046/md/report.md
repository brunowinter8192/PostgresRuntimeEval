...
**Test Query:** Q14_67_seed_541466046
...
```
Node 27211 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27212 (Gather) [consumed]
    Node 27213 (Aggregate) [consumed]
      Node 27214 (Hash Join)
        Node 27215 (Seq Scan) - LEAF
        Node 27216 (Hash)
          Node 27217 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27211 | 27212, 27213 |
...
|------|------|--------|-----------|-----|--------|
| 27211 | Aggregate | 834.05 | 848.34 | 1.7% | pattern |
| 27214 | Hash Join | 810.28 | 807.60 | 0.3% | operator |
| 27215 | Seq Scan | 760.80 | 758.45 | 0.3% | operator |
| 27216 | Hash | 42.00 | 9.38 | 77.7% | operator |
| 27217 | Seq Scan | 37.76 | 12.70 | 66.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27217 (Seq Scan) - LEAF
...
### Step 2: Node 27215 (Seq Scan) - LEAF
...
### Step 5: Node 27211 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27212, 27213
- **Input Features:**
