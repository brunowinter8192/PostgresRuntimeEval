...
**Test Query:** Q14_137_seed_1115748216
...
```
Node 26700 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26701 (Gather) [consumed]
    Node 26702 (Aggregate) [consumed]
      Node 26703 (Hash Join)
        Node 26704 (Seq Scan) - LEAF
        Node 26705 (Hash)
          Node 26706 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26700 | 26701, 26702 |
...
|------|------|--------|-----------|-----|--------|
| 26700 | Aggregate | 810.31 | 848.38 | 4.7% | pattern |
| 26703 | Hash Join | 789.68 | 807.67 | 2.3% | operator |
| 26704 | Seq Scan | 737.34 | 758.51 | 2.9% | operator |
| 26705 | Hash | 43.35 | 9.38 | 78.4% | operator |
| 26706 | Seq Scan | 37.49 | 12.70 | 66.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26706 (Seq Scan) - LEAF
...
### Step 2: Node 26704 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=136647.9500
- **Output:** st=78.57, rt=807.67

### Step 5: Node 26700 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26701, 26702
- **Input Features:**
