...
```
Node 26847 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26848 (Gather) [consumed]
    Node 26849 (Aggregate) [consumed]
      Node 26850 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26847 | 26848, 26849 |
...
|------|------|--------|-----------|-----|--------|
| 26847 | Aggregate | 847.21 | 848.34 | 0.1% | pattern |
| 26850 | Hash Join | 822.60 | 807.60 | 1.8% | operator |
...
### Step 5: Node 26847 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26848, 26849
- **Input Features:**
