...
**Test Query:** Q14_14_seed_106652403
...
```
Node 26798 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26799 (Gather) [consumed]
    Node 26800 (Aggregate) [consumed]
      Node 26801 (Hash Join)
        Node 26802 (Seq Scan) - LEAF
        Node 26803 (Hash)
          Node 26804 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26798 | 26799, 26800 |
...
|------|------|--------|-----------|-----|--------|
| 26798 | Aggregate | 823.44 | 848.38 | 3.0% | pattern |
| 26801 | Hash Join | 800.79 | 807.67 | 0.9% | operator |
| 26802 | Seq Scan | 750.00 | 758.51 | 1.1% | operator |
| 26803 | Hash | 43.00 | 9.38 | 78.2% | operator |
| 26804 | Seq Scan | 38.08 | 12.70 | 66.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26804 (Seq Scan) - LEAF
...
### Step 2: Node 26802 (Seq Scan) - LEAF
...
### Step 5: Node 26798 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26799, 26800
- **Input Features:**
