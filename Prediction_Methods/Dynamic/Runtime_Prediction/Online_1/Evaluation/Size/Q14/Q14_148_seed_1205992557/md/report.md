...
**Test Query:** Q14_148_seed_1205992557
...
```
Node 26784 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26785 (Gather) [consumed]
    Node 26786 (Aggregate) [consumed]
      Node 26787 (Hash Join)
        Node 26788 (Seq Scan) - LEAF
        Node 26789 (Hash)
          Node 26790 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26784 | 26785, 26786 |
...
|------|------|--------|-----------|-----|--------|
| 26784 | Aggregate | 821.88 | 848.36 | 3.2% | pattern |
| 26787 | Hash Join | 793.37 | 807.63 | 1.8% | operator |
| 26788 | Seq Scan | 740.79 | 758.47 | 2.4% | operator |
| 26789 | Hash | 42.43 | 9.38 | 77.9% | operator |
| 26790 | Seq Scan | 37.13 | 12.70 | 65.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26790 (Seq Scan) - LEAF
...
### Step 2: Node 26788 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=136645.6700
- **Output:** st=78.56, rt=807.63

### Step 5: Node 26784 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26785, 26786
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=14870
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=64
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0001
  - Aggregate_Outer_startup_cost=136905.9000
  - Aggregate_Outer_total_cost=136905.9100
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=137906.4700
  - Aggregate_total_cost=137906.4800
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=137905.9000
  - Gather_Outer_total_cost=137906.4100
- **Output:** st=842.86, rt=848.36
