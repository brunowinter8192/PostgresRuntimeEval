...
```
Node 27113 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27114 (Gather) [consumed]
    Node 27115 (Aggregate) [consumed]
      Node 27116 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27113 | 27114, 27115 |
...
|------|------|--------|-----------|-----|--------|
| 27113 | Aggregate | 819.30 | 848.36 | 3.5% | pattern |
| 27116 | Hash Join | 794.45 | 807.63 | 1.7% | operator |
...
### Step 5: Node 27113 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27114, 27115
- **Input Features:**
