...
**Test Query:** Q14_122_seed_992687751
...
```
Node 26588 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26589 (Gather) [consumed]
    Node 26590 (Aggregate) [consumed]
      Node 26591 (Hash Join)
        Node 26592 (Seq Scan) - LEAF
        Node 26593 (Hash)
          Node 26594 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26588 | 26589, 26590 |
...
|------|------|--------|-----------|-----|--------|
| 26588 | Aggregate | 830.03 | 848.36 | 2.2% | pattern |
| 26591 | Hash Join | 808.63 | 807.64 | 0.1% | operator |
| 26592 | Seq Scan | 755.69 | 758.48 | 0.4% | operator |
| 26593 | Hash | 43.66 | 9.38 | 78.5% | operator |
| 26594 | Seq Scan | 36.57 | 12.70 | 65.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26594 (Seq Scan) - LEAF
...
### Step 2: Node 26592 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=136646.3800
- **Output:** st=78.57, rt=807.64

### Step 5: Node 26588 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26589, 26590
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=15138
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=64
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0001
  - Aggregate_Outer_startup_cost=136911.3000
  - Aggregate_Outer_total_cost=136911.3100
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=137911.8600
  - Aggregate_total_cost=137911.8800
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=137911.3000
  - Gather_Outer_total_cost=137911.8100
