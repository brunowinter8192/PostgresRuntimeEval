...
**Test Query:** Q14_37_seed_295345116
...
```
Node 26980 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26981 (Gather) [consumed]
    Node 26982 (Aggregate) [consumed]
      Node 26983 (Hash Join)
        Node 26984 (Seq Scan) - LEAF
        Node 26985 (Hash)
          Node 26986 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26980 | 26981, 26982 |
...
|------|------|--------|-----------|-----|--------|
| 26980 | Aggregate | 819.51 | 848.39 | 3.5% | pattern |
| 26983 | Hash Join | 797.69 | 807.69 | 1.3% | operator |
| 26984 | Seq Scan | 747.55 | 758.53 | 1.5% | operator |
| 26985 | Hash | 42.36 | 9.38 | 77.9% | operator |
| 26986 | Seq Scan | 36.83 | 12.70 | 65.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26986 (Seq Scan) - LEAF
...
### Step 2: Node 26984 (Seq Scan) - LEAF
...
- **Output:** st=6.82, rt=758.53

### Step 3: Node 26985 (Hash)
...
- **Input Features:**
  ...
  - total_cost=136649.3800
- **Output:** st=78.58, rt=807.69

### Step 5: Node 26980 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26981, 26982
- **Input Features:**
