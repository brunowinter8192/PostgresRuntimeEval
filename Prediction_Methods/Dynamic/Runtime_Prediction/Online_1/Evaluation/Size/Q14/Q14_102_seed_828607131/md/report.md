...
```
Node 26434 (Aggregate) [PATTERN: a5f39f08] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26434 | 26435, 26436 |
...
|------|------|--------|-----------|-----|--------|
| 26434 | Aggregate | 808.69 | 848.34 | 4.9% | pattern |
| 26437 | Hash Join | 787.92 | 807.59 | 2.5% | operator |
...
### Step 5: Node 26434 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26435, 26436
- **Input Features:**
