...
**Test Query:** Q14_89_seed_721954728
...
```
Node 27379 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27380 (Gather) [consumed]
    Node 27381 (Aggregate) [consumed]
      Node 27382 (Hash Join)
        Node 27383 (Seq Scan) - LEAF
        Node 27384 (Hash)
          Node 27385 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27379 | 27380, 27381 |
...
|------|------|--------|-----------|-----|--------|
| 27379 | Aggregate | 840.60 | 848.35 | 0.9% | pattern |
| 27382 | Hash Join | 818.39 | 807.62 | 1.3% | operator |
| 27383 | Seq Scan | 768.66 | 758.47 | 1.3% | operator |
| 27384 | Hash | 42.10 | 9.38 | 77.7% | operator |
| 27385 | Seq Scan | 36.30 | 12.70 | 65.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27385 (Seq Scan) - LEAF
...
### Step 2: Node 27383 (Seq Scan) - LEAF
...
### Step 5: Node 27379 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27380, 27381
- **Input Features:**
