...
**Test Query:** Q14_48_seed_385589457
...
```
Node 27064 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27065 (Gather) [consumed]
    Node 27066 (Aggregate) [consumed]
      Node 27067 (Hash Join)
        Node 27068 (Seq Scan) - LEAF
        Node 27069 (Hash)
          Node 27070 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27064 | 27065, 27066 |
...
|------|------|--------|-----------|-----|--------|
| 27064 | Aggregate | 815.23 | 848.32 | 4.1% | pattern |
| 27067 | Hash Join | 790.01 | 807.55 | 2.2% | operator |
| 27068 | Seq Scan | 739.26 | 758.41 | 2.6% | operator |
| 27069 | Hash | 43.66 | 9.38 | 78.5% | operator |
| 27070 | Seq Scan | 38.39 | 12.70 | 66.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27070 (Seq Scan) - LEAF
...
### Step 2: Node 27068 (Seq Scan) - LEAF
...
### Step 5: Node 27064 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27065, 27066
- **Input Features:**
