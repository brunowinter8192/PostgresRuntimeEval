...
**Test Query:** Q14_6_seed_41020155
...
```
Node 27232 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27233 (Gather) [consumed]
    Node 27234 (Aggregate) [consumed]
      Node 27235 (Hash Join)
        Node 27236 (Seq Scan) - LEAF
        Node 27237 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27232 | 27233, 27234 |
...
|------|------|--------|-----------|-----|--------|
| 27232 | Aggregate | 827.49 | 848.37 | 2.5% | pattern |
| 27235 | Hash Join | 806.44 | 807.65 | 0.2% | operator |
| 27236 | Seq Scan | 750.22 | 758.49 | 1.1% | operator |
| 27237 | Hash | 48.44 | 9.38 | 80.6% | operator |
| 27238 | Seq Scan | 41.74 | 12.70 | 69.6% | operator |
...
### Step 2: Node 27236 (Seq Scan) - LEAF
...
### Step 5: Node 27232 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27233, 27234
- **Input Features:**
