...
**Test Query:** Q14_140_seed_1140360309
**Timestamp:** 2025-12-21 18:13:17
...
```
Node 26728 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26729 (Gather) [consumed]
    Node 26730 (Aggregate) [consumed]
      Node 26731 (Hash Join)
        Node 26732 (Seq Scan) - LEAF
        Node 26733 (Hash)
          Node 26734 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26728 | 26729, 26730 |
...
|------|------|--------|-----------|-----|--------|
| 26728 | Aggregate | 827.04 | 848.35 | 2.6% | pattern |
| 26731 | Hash Join | 804.44 | 807.63 | 0.4% | operator |
| 26732 | Seq Scan | 754.12 | 758.47 | 0.6% | operator |
| 26733 | Hash | 42.75 | 9.38 | 78.1% | operator |
| 26734 | Seq Scan | 36.20 | 12.70 | 64.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26734 (Seq Scan) - LEAF
...
### Step 2: Node 26732 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=136645.5500
- **Output:** st=78.56, rt=807.63

### Step 5: Node 26728 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26729, 26730
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=14822
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=64
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0001
  - Aggregate_Outer_startup_cost=136904.9400
  - Aggregate_Outer_total_cost=136904.9500
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=137905.5000
  - Aggregate_total_cost=137905.5200
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=137904.9400
  - Gather_Outer_total_cost=137905.4500
- **Output:** st=842.86, rt=848.35
