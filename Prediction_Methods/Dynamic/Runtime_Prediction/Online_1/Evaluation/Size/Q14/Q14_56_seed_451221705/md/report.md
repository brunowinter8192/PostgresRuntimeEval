...
```
Node 27127 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27128 (Gather) [consumed]
    Node 27129 (Aggregate) [consumed]
      Node 27130 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27127 | 27128, 27129 |
...
|------|------|--------|-----------|-----|--------|
| 27127 | Aggregate | 751.20 | 848.37 | 12.9% | pattern |
| 27130 | Hash Join | 729.62 | 807.66 | 10.7% | operator |
...
### Step 5: Node 27127 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27128, 27129
- **Input Features:**
