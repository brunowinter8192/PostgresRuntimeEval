...
```
Node 27120 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27121 (Gather) [consumed]
    Node 27122 (Aggregate) [consumed]
      Node 27123 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27120 | 27121, 27122 |
...
|------|------|--------|-----------|-----|--------|
| 27120 | Aggregate | 813.76 | 848.37 | 4.3% | pattern |
| 27123 | Hash Join | 794.02 | 807.66 | 1.7% | operator |
...
### Step 5: Node 27120 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27121, 27122
- **Input Features:**
