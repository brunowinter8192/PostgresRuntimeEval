...
**Test Query:** Q14_47_seed_377385426
...
```
Node 27057 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27058 (Gather) [consumed]
    Node 27059 (Aggregate) [consumed]
      Node 27060 (Hash Join)
        Node 27061 (Seq Scan) - LEAF
        Node 27062 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27057 | 27058, 27059 |
...
|------|------|--------|-----------|-----|--------|
| 27057 | Aggregate | 821.21 | 848.38 | 3.3% | pattern |
| 27060 | Hash Join | 798.26 | 807.67 | 1.2% | operator |
| 27061 | Seq Scan | 747.61 | 758.51 | 1.5% | operator |
| 27062 | Hash | 42.57 | 9.38 | 78.0% | operator |
| 27063 | Seq Scan | 37.24 | 12.70 | 65.9% | operator |
...
### Step 2: Node 27061 (Seq Scan) - LEAF
...
### Step 5: Node 27057 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27058, 27059
- **Input Features:**
