...
**Test Query:** Q14_36_seed_287141085
**Timestamp:** 2025-12-21 18:16:10
...
```
Node 26973 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26974 (Gather) [consumed]
    Node 26975 (Aggregate) [consumed]
      Node 26976 (Hash Join)
        Node 26977 (Seq Scan) - LEAF
        Node 26978 (Hash)
          Node 26979 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26973 | 26974, 26975 |
...
|------|------|--------|-----------|-----|--------|
| 26973 | Aggregate | 809.40 | 848.36 | 4.8% | pattern |
| 26976 | Hash Join | 788.45 | 807.65 | 2.4% | operator |
| 26977 | Seq Scan | 731.92 | 758.49 | 3.6% | operator |
| 26978 | Hash | 48.83 | 9.38 | 80.8% | operator |
| 26979 | Seq Scan | 43.31 | 12.70 | 70.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26979 (Seq Scan) - LEAF
...
### Step 2: Node 26977 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=136646.6200
- **Output:** st=78.57, rt=807.65

### Step 5: Node 26973 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26974, 26975
- **Input Features:**
