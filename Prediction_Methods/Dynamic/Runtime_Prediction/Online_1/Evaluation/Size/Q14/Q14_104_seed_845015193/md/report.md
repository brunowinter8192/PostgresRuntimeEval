...
**Test Query:** Q14_104_seed_845015193
...
```
Node 26448 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26449 (Gather) [consumed]
    Node 26450 (Aggregate) [consumed]
      Node 26451 (Hash Join)
        Node 26452 (Seq Scan) - LEAF
        Node 26453 (Hash)
          Node 26454 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26448 | 26449, 26450 |
...
|------|------|--------|-----------|-----|--------|
| 26448 | Aggregate | 803.19 | 848.35 | 5.6% | pattern |
| 26451 | Hash Join | 782.53 | 807.62 | 3.2% | operator |
| 26452 | Seq Scan | 732.29 | 758.47 | 3.6% | operator |
| 26453 | Hash | 42.29 | 9.38 | 77.8% | operator |
| 26454 | Seq Scan | 36.85 | 12.70 | 65.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26454 (Seq Scan) - LEAF
...
### Step 2: Node 26452 (Seq Scan) - LEAF
...
### Step 5: Node 26448 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26449, 26450
- **Input Features:**
