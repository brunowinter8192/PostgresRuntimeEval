...
```
Node 27442 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27443 (Gather) [consumed]
    Node 27444 (Aggregate) [consumed]
      Node 27445 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27442 | 27443, 27444 |
...
|------|------|--------|-----------|-----|--------|
| 27442 | Aggregate | 856.64 | 848.37 | 1.0% | pattern |
| 27445 | Hash Join | 837.58 | 807.66 | 3.6% | operator |
...
### Step 5: Node 27442 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27443, 27444
- **Input Features:**
