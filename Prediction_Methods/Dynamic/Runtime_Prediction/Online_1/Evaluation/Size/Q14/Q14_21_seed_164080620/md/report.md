...
```
Node 26861 (Aggregate) [PATTERN: a5f39f08] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26861 | 26862, 26863 |
...
|------|------|--------|-----------|-----|--------|
| 26861 | Aggregate | 838.21 | 848.34 | 1.2% | pattern |
| 26864 | Hash Join | 816.88 | 807.60 | 1.1% | operator |
...
### Step 5: Node 26861 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26862, 26863
- **Input Features:**
