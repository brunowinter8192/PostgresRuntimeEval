...
```
Node 27323 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27324 (Gather) [consumed]
    Node 27325 (Aggregate) [consumed]
      Node 27326 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27323 | 27324, 27325 |
...
|------|------|--------|-----------|-----|--------|
| 27323 | Aggregate | 814.30 | 848.36 | 4.2% | pattern |
| 27326 | Hash Join | 793.61 | 807.65 | 1.8% | operator |
...
### Step 5: Node 27323 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27324, 27325
- **Input Features:**
