...
```
Node 26854 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26855 (Gather) [consumed]
    Node 26856 (Aggregate) [consumed]
      Node 26857 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26854 | 26855, 26856 |
...
|------|------|--------|-----------|-----|--------|
| 26854 | Aggregate | 835.78 | 848.37 | 1.5% | pattern |
| 26857 | Hash Join | 815.23 | 807.65 | 0.9% | operator |
...
### Step 5: Node 26854 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26855, 26856
- **Input Features:**
