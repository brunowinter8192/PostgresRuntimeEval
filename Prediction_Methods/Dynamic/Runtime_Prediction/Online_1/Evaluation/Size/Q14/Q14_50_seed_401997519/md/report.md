...
**Test Query:** Q14_50_seed_401997519
...
```
Node 27085 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27086 (Gather) [consumed]
    Node 27087 (Aggregate) [consumed]
      Node 27088 (Hash Join)
        Node 27089 (Seq Scan) - LEAF
        Node 27090 (Hash)
          Node 27091 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27085 | 27086, 27087 |
...
|------|------|--------|-----------|-----|--------|
| 27085 | Aggregate | 812.99 | 848.38 | 4.4% | pattern |
| 27088 | Hash Join | 790.92 | 807.68 | 2.1% | operator |
| 27089 | Seq Scan | 738.78 | 758.52 | 2.7% | operator |
| 27090 | Hash | 44.72 | 9.38 | 79.0% | operator |
| 27091 | Seq Scan | 39.16 | 12.70 | 67.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27091 (Seq Scan) - LEAF
...
### Step 2: Node 27089 (Seq Scan) - LEAF
...
### Step 5: Node 27085 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27086, 27087
- **Input Features:**
