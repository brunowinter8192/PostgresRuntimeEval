...
**Test Query:** Q14_106_seed_861423255
...
```
Node 26462 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26463 (Gather) [consumed]
    Node 26464 (Aggregate) [consumed]
      Node 26465 (Hash Join)
        Node 26466 (Seq Scan) - LEAF
        Node 26467 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26462 | 26463, 26464 |
...
|------|------|--------|-----------|-----|--------|
| 26462 | Aggregate | 814.07 | 848.38 | 4.2% | pattern |
| 26465 | Hash Join | 790.93 | 807.67 | 2.1% | operator |
| 26466 | Seq Scan | 740.29 | 758.51 | 2.5% | operator |
| 26467 | Hash | 41.96 | 9.38 | 77.6% | operator |
| 26468 | Seq Scan | 36.39 | 12.70 | 65.1% | operator |
...
### Step 2: Node 26466 (Seq Scan) - LEAF
...
### Step 5: Node 26462 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26463, 26464
- **Input Features:**
