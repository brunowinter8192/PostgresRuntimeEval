...
```
Node 26742 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26743 (Gather) [consumed]
    Node 26744 (Aggregate) [consumed]
      Node 26745 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26742 | 26743, 26744 |
...
|------|------|--------|-----------|-----|--------|
| 26742 | Aggregate | 827.80 | 848.37 | 2.5% | pattern |
| 26745 | Hash Join | 802.79 | 807.66 | 0.6% | operator |
...
### Step 5: Node 26742 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26743, 26744
- **Input Features:**
