...
```
Node 27421 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27422 (Gather) [consumed]
    Node 27423 (Aggregate) [consumed]
      Node 27424 (Hash Join)
        Node 27425 (Seq Scan) - LEAF
        Node 27426 (Hash)
          Node 27427 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27421 | 27422, 27423 |
...
|------|------|--------|-----------|-----|--------|
| 27421 | Aggregate | 849.73 | 848.35 | 0.2% | pattern |
| 27424 | Hash Join | 828.37 | 807.62 | 2.5% | operator |
| 27425 | Seq Scan | 778.38 | 758.47 | 2.6% | operator |
| 27426 | Hash | 42.06 | 9.38 | 77.7% | operator |
| 27427 | Seq Scan | 37.38 | 12.70 | 66.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27427 (Seq Scan) - LEAF
...
### Step 2: Node 27425 (Seq Scan) - LEAF
...
### Step 5: Node 27421 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27422, 27423
- **Input Features:**
