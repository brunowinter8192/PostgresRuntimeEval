...
**Test Query:** Q14_45_seed_360977364
...
```
Node 27043 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27044 (Gather) [consumed]
    Node 27045 (Aggregate) [consumed]
      Node 27046 (Hash Join)
        Node 27047 (Seq Scan) - LEAF
        Node 27048 (Hash)
          Node 27049 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27043 | 27044, 27045 |
...
|------|------|--------|-----------|-----|--------|
| 27043 | Aggregate | 841.15 | 848.35 | 0.9% | pattern |
| 27046 | Hash Join | 820.28 | 807.62 | 1.5% | operator |
| 27047 | Seq Scan | 767.22 | 758.47 | 1.1% | operator |
| 27048 | Hash | 45.77 | 9.38 | 79.5% | operator |
| 27049 | Seq Scan | 39.61 | 12.70 | 67.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27049 (Seq Scan) - LEAF
...
### Step 2: Node 27047 (Seq Scan) - LEAF
...
### Step 5: Node 27043 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27044, 27045
- **Input Features:**
