...
```
Node 26679 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26680 (Gather) [consumed]
    Node 26681 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26679 | 26680, 26681 |
...
|------|------|--------|-----------|-----|--------|
| 26679 | Aggregate | 820.14 | 848.35 | 3.4% | pattern |
| 26682 | Hash Join | 799.40 | 807.62 | 1.0% | operator |
| 26683 | Seq Scan | 744.39 | 758.47 | 1.9% | operator |
| 26684 | Hash | 46.67 | 9.38 | 79.9% | operator |
| 26685 | Seq Scan | 41.61 | 12.70 | 69.5% | operator |
...
### Step 5: Node 26679 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26680, 26681
- **Input Features:**
