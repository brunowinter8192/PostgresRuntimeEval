...
**Test Query:** Q14_72_seed_582486201
...
```
Node 27253 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27254 (Gather) [consumed]
    Node 27255 (Aggregate) [consumed]
      Node 27256 (Hash Join)
        Node 27257 (Seq Scan) - LEAF
        Node 27258 (Hash)
          Node 27259 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27253 | 27254, 27255 |
...
|------|------|--------|-----------|-----|--------|
| 27253 | Aggregate | 824.31 | 848.35 | 2.9% | pattern |
| 27256 | Hash Join | 802.26 | 807.62 | 0.7% | operator |
| 27257 | Seq Scan | 752.11 | 758.46 | 0.8% | operator |
| 27258 | Hash | 42.71 | 9.38 | 78.0% | operator |
| 27259 | Seq Scan | 37.78 | 12.70 | 66.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27259 (Seq Scan) - LEAF
...
### Step 2: Node 27257 (Seq Scan) - LEAF
...
- **Output:** st=6.82, rt=758.46

### Step 3: Node 27258 (Hash)
...
### Step 5: Node 27253 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27254, 27255
- **Input Features:**
