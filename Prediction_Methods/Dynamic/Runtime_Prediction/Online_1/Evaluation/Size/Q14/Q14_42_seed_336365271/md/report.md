...
**Test Query:** Q14_42_seed_336365271
...
```
Node 27022 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27023 (Gather) [consumed]
    Node 27024 (Aggregate) [consumed]
      Node 27025 (Hash Join)
        Node 27026 (Seq Scan) - LEAF
        Node 27027 (Hash)
          Node 27028 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27022 | 27023, 27024 |
...
|------|------|--------|-----------|-----|--------|
| 27022 | Aggregate | 838.50 | 848.38 | 1.2% | pattern |
| 27025 | Hash Join | 817.21 | 807.67 | 1.2% | operator |
| 27026 | Seq Scan | 763.78 | 758.51 | 0.7% | operator |
| 27027 | Hash | 44.32 | 9.38 | 78.8% | operator |
| 27028 | Seq Scan | 40.05 | 12.70 | 68.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27028 (Seq Scan) - LEAF
...
### Step 2: Node 27026 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=136648.1400
- **Output:** st=78.58, rt=807.67

### Step 5: Node 27022 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27023, 27024
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=15810
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=64
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0001
  - Aggregate_Outer_startup_cost=136924.8200
  - Aggregate_Outer_total_cost=136924.8300
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=137925.3900
  - Aggregate_total_cost=137925.4000
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=137924.8200
  - Gather_Outer_total_cost=137925.3300
