...
**Test Query:** Q14_91_seed_738362790
**Timestamp:** 2025-12-21 18:23:14
...
```
Node 27400 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27401 (Gather) [consumed]
    Node 27402 (Aggregate) [consumed]
      Node 27403 (Hash Join)
        Node 27404 (Seq Scan) - LEAF
        Node 27405 (Hash)
          Node 27406 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27400 | 27401, 27402 |
...
|------|------|--------|-----------|-----|--------|
| 27400 | Aggregate | 849.52 | 848.39 | 0.1% | pattern |
| 27403 | Hash Join | 826.54 | 807.69 | 2.3% | operator |
| 27404 | Seq Scan | 776.13 | 758.52 | 2.3% | operator |
| 27405 | Hash | 42.06 | 9.38 | 77.7% | operator |
| 27406 | Seq Scan | 37.18 | 12.70 | 65.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27406 (Seq Scan) - LEAF
...
### Step 2: Node 27404 (Seq Scan) - LEAF
...
- **Output:** st=6.82, rt=758.52

### Step 3: Node 27405 (Hash)
...
- **Input Features:**
  ...
  - total_cost=136648.9400
- **Output:** st=78.58, rt=807.69

### Step 5: Node 27400 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27401, 27402
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=16114
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=64
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0001
  - Aggregate_Outer_startup_cost=136930.9400
  - Aggregate_Outer_total_cost=136930.9500
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=137931.5100
  - Aggregate_total_cost=137931.5200
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=137930.9400
  - Gather_Outer_total_cost=137931.4500
- **Output:** st=842.89, rt=848.39
