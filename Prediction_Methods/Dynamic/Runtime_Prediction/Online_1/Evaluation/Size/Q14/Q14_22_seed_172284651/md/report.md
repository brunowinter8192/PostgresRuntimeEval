...
Node 26868 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26869 (Gather) [consumed]
    Node 26870 (Aggregate) [consumed]
      Node 26871 (Hash Join)
        Node 26872 (Seq Scan) - LEAF
        Node 26873 (Hash)
          Node 26874 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26868 | 26869, 26870 |
...
|------|------|--------|-----------|-----|--------|
| 26868 | Aggregate | 826.67 | 848.34 | 2.6% | pattern |
| 26871 | Hash Join | 804.96 | 807.60 | 0.3% | operator |
| 26872 | Seq Scan | 754.35 | 758.45 | 0.5% | operator |
| 26873 | Hash | 42.21 | 9.38 | 77.8% | operator |
| 26874 | Seq Scan | 36.02 | 12.70 | 64.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26874 (Seq Scan) - LEAF
...
### Step 2: Node 26872 (Seq Scan) - LEAF
...
### Step 5: Node 26868 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26869, 26870
- **Input Features:**
