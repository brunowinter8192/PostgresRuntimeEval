...
```
Node 27386 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27387 (Gather) [consumed]
    Node 27388 (Aggregate) [consumed]
      Node 27389 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27386 | 27387, 27388 |
...
|------|------|--------|-----------|-----|--------|
| 27386 | Aggregate | 815.32 | 848.37 | 4.1% | pattern |
| 27389 | Hash Join | 790.77 | 807.66 | 2.1% | operator |
...
### Step 5: Node 27386 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27387, 27388
- **Input Features:**
