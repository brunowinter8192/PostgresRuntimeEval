...
Node 27148 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27149 (Gather) [consumed]
    Node 27150 (Aggregate) [consumed]
      Node 27151 (Hash Join)
        Node 27152 (Seq Scan) - LEAF
        Node 27153 (Hash)
          Node 27154 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27148 | 27149, 27150 |
...
|------|------|--------|-----------|-----|--------|
| 27148 | Aggregate | 825.14 | 848.35 | 2.8% | pattern |
| 27151 | Hash Join | 803.71 | 807.62 | 0.5% | operator |
| 27152 | Seq Scan | 755.43 | 758.47 | 0.4% | operator |
| 27153 | Hash | 41.08 | 9.38 | 77.2% | operator |
| 27154 | Seq Scan | 36.43 | 12.70 | 65.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27154 (Seq Scan) - LEAF
...
### Step 2: Node 27152 (Seq Scan) - LEAF
...
### Step 5: Node 27148 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27149, 27150
- **Input Features:**
