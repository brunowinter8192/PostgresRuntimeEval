...
**Test Query:** Q14_70_seed_566078139
**Timestamp:** 2025-12-21 18:20:26
...
```
Node 27239 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27240 (Gather) [consumed]
    Node 27241 (Aggregate) [consumed]
      Node 27242 (Hash Join)
        Node 27243 (Seq Scan) - LEAF
        Node 27244 (Hash)
          Node 27245 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27239 | 27240, 27241 |
...
|------|------|--------|-----------|-----|--------|
| 27239 | Aggregate | 836.89 | 848.36 | 1.4% | pattern |
| 27242 | Hash Join | 814.20 | 807.63 | 0.8% | operator |
| 27243 | Seq Scan | 762.44 | 758.48 | 0.5% | operator |
| 27244 | Hash | 43.88 | 9.38 | 78.6% | operator |
| 27245 | Seq Scan | 38.27 | 12.70 | 66.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27245 (Seq Scan) - LEAF
...
### Step 2: Node 27243 (Seq Scan) - LEAF
...
### Step 5: Node 27239 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27240, 27241
- **Input Features:**
