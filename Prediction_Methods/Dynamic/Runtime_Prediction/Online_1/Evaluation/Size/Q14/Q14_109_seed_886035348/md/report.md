...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26483 | 26484, 26485 |
...
|------|------|--------|-----------|-----|--------|
| 26483 | Aggregate | 810.16 | 848.38 | 4.7% | pattern |
| 26486 | Hash Join | 788.86 | 807.67 | 2.4% | operator |
| 26487 | Seq Scan | 738.89 | 758.51 | 2.7% | operator |
| 26488 | Hash | 41.85 | 9.38 | 77.6% | operator |
| 26489 | Seq Scan | 36.39 | 12.70 | 65.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26489 (Seq Scan) - LEAF
...
### Step 2: Node 26487 (Seq Scan) - LEAF
...
### Step 5: Node 26483 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26484, 26485
- **Input Features:**
