...
**Test Query:** Q14_5_seed_32816124
...
```
Node 27155 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27156 (Gather) [consumed]
    Node 27157 (Aggregate) [consumed]
      Node 27158 (Hash Join)
        Node 27159 (Seq Scan) - LEAF
        Node 27160 (Hash)
          Node 27161 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27155 | 27156, 27157 |
...
|------|------|--------|-----------|-----|--------|
| 27155 | Aggregate | 822.48 | 848.38 | 3.1% | pattern |
| 27158 | Hash Join | 801.51 | 807.68 | 0.8% | operator |
| 27159 | Seq Scan | 749.88 | 758.52 | 1.2% | operator |
| 27160 | Hash | 44.10 | 9.38 | 78.7% | operator |
| 27161 | Seq Scan | 39.53 | 12.70 | 67.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27161 (Seq Scan) - LEAF
...
### Step 2: Node 27159 (Seq Scan) - LEAF
...
### Step 5: Node 27155 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27156, 27157
- **Input Features:**
