...
```
Node 26749 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26750 (Gather) [consumed]
    Node 26751 (Aggregate) [consumed]
      Node 26752 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26749 | 26750, 26751 |
...
|------|------|--------|-----------|-----|--------|
| 26749 | Aggregate | 814.81 | 848.37 | 4.1% | pattern |
| 26752 | Hash Join | 792.41 | 807.65 | 1.9% | operator |
...
- **Input Features:**
  ...
  - total_cost=136646.7700
- **Output:** st=78.57, rt=807.65

### Step 5: Node 26749 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26750, 26751
- **Input Features:**
