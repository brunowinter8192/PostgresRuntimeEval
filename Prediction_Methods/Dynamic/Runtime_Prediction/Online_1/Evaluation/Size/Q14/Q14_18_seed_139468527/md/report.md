...
```
Node 26833 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26834 (Gather) [consumed]
    Node 26835 (Aggregate) [consumed]
      Node 26836 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26833 | 26834, 26835 |
...
|------|------|--------|-----------|-----|--------|
| 26833 | Aggregate | 803.83 | 848.37 | 5.5% | pattern |
| 26836 | Hash Join | 781.67 | 807.65 | 3.3% | operator |
...
### Step 5: Node 26833 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26834, 26835
- **Input Features:**
