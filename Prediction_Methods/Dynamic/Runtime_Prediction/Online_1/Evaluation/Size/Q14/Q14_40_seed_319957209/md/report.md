...
**Test Query:** Q14_40_seed_319957209
...
```
Node 27008 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27009 (Gather) [consumed]
    Node 27010 (Aggregate) [consumed]
      Node 27011 (Hash Join)
        Node 27012 (Seq Scan) - LEAF
        Node 27013 (Hash)
          Node 27014 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27008 | 27009, 27010 |
...
|------|------|--------|-----------|-----|--------|
| 27008 | Aggregate | 818.02 | 848.36 | 3.7% | pattern |
| 27011 | Hash Join | 796.82 | 807.64 | 1.4% | operator |
| 27012 | Seq Scan | 746.59 | 758.48 | 1.6% | operator |
| 27013 | Hash | 42.61 | 9.38 | 78.0% | operator |
| 27014 | Seq Scan | 35.98 | 12.70 | 64.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27014 (Seq Scan) - LEAF
...
### Step 2: Node 27012 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=136646.0400
- **Output:** st=78.56, rt=807.64

### Step 5: Node 27008 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27009, 27010
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=15008
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=64
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0001
  - Aggregate_Outer_startup_cost=136908.6800
  - Aggregate_Outer_total_cost=136908.6900
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=137909.2500
  - Aggregate_total_cost=137909.2600
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=137908.6800
  - Gather_Outer_total_cost=137909.1900
