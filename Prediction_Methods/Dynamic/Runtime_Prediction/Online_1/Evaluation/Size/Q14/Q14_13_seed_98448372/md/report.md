...
```
Node 26721 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26722 (Gather) [consumed]
    Node 26723 (Aggregate) [consumed]
      Node 26724 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26721 | 26722, 26723 |
...
|------|------|--------|-----------|-----|--------|
| 26721 | Aggregate | 821.08 | 848.36 | 3.3% | pattern |
| 26724 | Hash Join | 798.98 | 807.63 | 1.1% | operator |
...
### Step 5: Node 26721 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26722, 26723
- **Input Features:**
