...
**Test Query:** Q14_138_seed_1123952247
...
```
Node 26707 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26708 (Gather) [consumed]
    Node 26709 (Aggregate) [consumed]
      Node 26710 (Hash Join)
        Node 26711 (Seq Scan) - LEAF
        Node 26712 (Hash)
          Node 26713 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26707 | 26708, 26709 |
...
|------|------|--------|-----------|-----|--------|
| 26707 | Aggregate | 833.02 | 848.38 | 1.8% | pattern |
| 26710 | Hash Join | 810.97 | 807.67 | 0.4% | operator |
| 26711 | Seq Scan | 758.54 | 758.51 | 0.0% | operator |
| 26712 | Hash | 43.42 | 9.38 | 78.4% | operator |
| 26713 | Seq Scan | 38.41 | 12.70 | 66.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26713 (Seq Scan) - LEAF
...
### Step 2: Node 26711 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=136648.0200
- **Output:** st=78.57, rt=807.67

### Step 5: Node 26707 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26708, 26709
- **Input Features:**
