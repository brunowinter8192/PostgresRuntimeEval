...
**Test Query:** Q3_145_seed_1181380464
...
```
Node 4841 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 4842 (Sort) [consumed]
    Node 4843 (Aggregate) [consumed]
      Node 4844 (Gather) [consumed]
        Node 4845 (Nested Loop)
          Node 4846 (Hash Join) [PATTERN: 895c6e8c]
            Node 4847 (Seq Scan) [consumed] - LEAF
            Node 4848 (Hash) [consumed]
              Node 4849 (Seq Scan) - LEAF
          Node 4850 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4841 | 4842, 4843, 4844, 4846, 4847, 4848 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4846 | 4841, 4842, 4843, 4844, 4847, 4848 |
...
|------|------|--------|-----------|-----|--------|
| 4841 | Limit | 1183.59 | 1151.18 | 2.7% | pattern |
| 4845 | Nested Loop | 1147.69 | 1192.97 | 3.9% | operator |
| 4846 | Hash Join | 206.54 | 242.47 | 17.4% | pattern |
| 4850 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4849 | Seq Scan | 28.08 | 38.53 | 37.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4849 (Seq Scan) - LEAF
...
### Step 2: Node 4846 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4841, 4842, 4843, 4844, 4847, 4848
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46792
  - HashJoin_nt1=232493
  ...
  - HashJoin_total_cost=37333.1900
  - Hash_Inner_np=0
  - Hash_Inner_nt=12579
...
- **Output:** st=29.79, rt=242.47

### Step 3: Node 4850 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=72870.3800
- **Output:** st=121.70, rt=1192.97

### Step 5: Node 4841 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4842, 4843, 4844, 4846, 4847, 4848
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=315570
  - Aggregate_Outer_nt1=315570
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110160.9300
  - Aggregate_Outer_total_cost=114105.5600
  - Gather_Outer_np=0
  - Gather_Outer_nt=315570
  - Gather_Outer_nt1=101797
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105427.3800
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=315570
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=120924.9100
  - Limit_total_cost=120924.9400
  - Sort_Outer_np=0
  - Sort_Outer_nt=315570
  - Sort_Outer_nt1=315570
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=120924.9100
  - Sort_Outer_total_cost=121713.8400
