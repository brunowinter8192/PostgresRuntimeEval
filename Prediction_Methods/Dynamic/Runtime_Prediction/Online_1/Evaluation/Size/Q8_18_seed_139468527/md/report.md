...
```
Node 14558 (Aggregate) - ROOT
  Node 14559 (Gather Merge)
    Node 14560 (Sort)
          ...
          Node 14563 (Hash Join)
            Node 14564 (Nested Loop)
              Node 14565 (Hash Join)
                ...
                Node 14567 (Hash)
                  Node 14568 (Hash Join)
                    Node 14569 (Seq Scan) - LEAF
                    Node 14570 (Hash)
                      Node 14571 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 14558 | Aggregate | 1229.54 | 1170.03 | 4.8% | operator |
| 14559 | Gather Merge | 1229.08 | 1097.15 | 10.7% | operator |
...
| 14565 | Hash Join | 214.84 | 251.17 | 16.9% | operator |
...
| 14567 | Hash | 34.45 | 20.62 | 40.2% | operator |
| 14568 | Hash Join | 33.80 | 132.26 | 291.3% | operator |
| 14569 | Seq Scan | 32.32 | 23.03 | 28.7% | operator |
| 14570 | Hash | 0.19 | 23.66 | 12618.3% | operator |
| 14571 | Hash Join | 0.18 | 306.84 | 168491.2% | operator |
...
### Step 5: Node 14569 (Seq Scan) - LEAF
...
### Step 8: Node 14566 (Seq Scan) - LEAF
...
### Step 11: Node 14575 (Index Scan) - LEAF
...
### Step 12: Node 14577 (Seq Scan) - LEAF
...
### Step 13: Node 14564 (Nested Loop)
...
### Step 16: Node 14578 (Index Scan) - LEAF
...
### Step 17: Node 14580 (Seq Scan) - LEAF
...
### Step 18: Node 14562 (Nested Loop)
...
### Step 22: Node 14559 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1044.9494
  - st2=0.0000
  - startup_cost=71583.7400
  - total_cost=71902.1100
- **Output:** st=1093.45, rt=1097.15

### Step 23: Node 14558 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=71583.7400
  - total_cost=72004.0500
- **Output:** st=1150.71, rt=1170.03
