...
```
Node 26700 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26701 (Gather) [consumed]
    Node 26702 (Aggregate) [consumed]
      Node 26703 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26700 | 26701, 26702, 26703 |
...
|------|------|--------|-----------|-----|--------|
| 26700 | Aggregate | 810.31 | 857.14 | 5.8% | pattern |
...
### Step 4: Node 26700 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26701, 26702, 26703
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=15738
  - HashJoin_Outer_nt1=15738
  ...
  - HashJoin_Outer_total_cost=136647.9500
