...
```
Node 9441 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 9442 (Aggregate) [consumed]
    Node 9443 (Gather Merge) [consumed]
      Node 9444 (Aggregate)
        Node 9445 (Sort) [PATTERN: 3e2d5a00]
          Node 9446 (Hash Join) [consumed]
            Node 9447 (Nested Loop)
              Node 9448 (Hash Join)
                Node 9449 (Seq Scan) - LEAF
                Node 9450 (Hash) [PATTERN: 444761fb]
                  Node 9451 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 9450 | 9441, 9442, 9443, 9445, 9446, 9451, 9452, 9453, 9454 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 9441 | 9442, 9443, 9445, 9446, 9450, 9451, 9452, 9453, 9454 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 9445 | 9441, 9442, 9443, 9446, 9450, 9451, 9452, 9453, 9454 |
...
|------|------|--------|-----------|-----|--------|
| 9441 | Sort | 1079.55 | 2934.42 | 171.8% | pattern |
| 9444 | Aggregate | 1074.39 | 1128.76 | 5.1% | operator |
| 9445 | Sort | 1074.14 | 1835.93 | 70.9% | pattern |
| 9447 | Nested Loop | 1059.02 | 1188.47 | 12.2% | operator |
| 9459 | Hash | 3.90 | 18.67 | 379.1% | operator |
| 9448 | Hash Join | 214.98 | 253.07 | 17.7% | operator |
| 9458 | Index Scan | 0.07 | -0.22 | 397.3% | operator |
| 9460 | Seq Scan | 3.39 | 12.36 | 264.5% | operator |
| 9449 | Seq Scan | 166.06 | 159.81 | 3.8% | operator |
| 9450 | Hash | 36.08 | 46.85 | 29.9% | pattern |
| 9455 | Seq Scan | 0.01 | 11.81 | 196704.5% | operator |
| 9456 | Hash | 0.05 | 21.05 | 38887.5% | operator |
| 9457 | Seq Scan | 0.05 | 22.93 | 44867.3% | operator |
...
### Step 4: Node 9449 (Seq Scan) - LEAF
...
### Step 5: Node 9450 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 9441, 9442, 9443, 9445, 9446, 9451, 9452, 9453, 9454
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 9458 (Index Scan) - LEAF
...
### Step 8: Node 9460 (Seq Scan) - LEAF
...
### Step 11: Node 9445 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 9441, 9442, 9443, 9446, 9450, 9451, 9452, 9453, 9454
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 9441 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 9442, 9443, 9445, 9446, 9450, 9451, 9452, 9453, 9454
- **Input Features:**
