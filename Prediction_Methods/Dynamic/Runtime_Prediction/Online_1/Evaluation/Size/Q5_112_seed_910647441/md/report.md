...
**Test Query:** Q5_112_seed_910647441
...
```
Node 7161 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 7162 (Aggregate) [consumed]
    Node 7163 (Gather Merge) [consumed]
      Node 7164 (Aggregate)
        Node 7165 (Sort) [PATTERN: 3e2d5a00]
          Node 7166 (Hash Join) [consumed]
            Node 7167 (Nested Loop)
              Node 7168 (Hash Join)
                Node 7169 (Seq Scan) - LEAF
                Node 7170 (Hash) [PATTERN: 444761fb]
                  Node 7171 (Hash Join) [consumed]
                    Node 7172 (Seq Scan) [consumed] - LEAF
                    Node 7173 (Hash) [consumed]
                      Node 7174 (Hash Join) [consumed]
                        Node 7175 (Seq Scan) - LEAF
                        Node 7176 (Hash)
                          Node 7177 (Seq Scan) - LEAF
              Node 7178 (Index Scan) - LEAF
            Node 7179 (Hash)
              Node 7180 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 7170 | 7161, 7162, 7163, 7165, 7166, 7171, 7172, 7173, 7174 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 7161 | 7162, 7163, 7165, 7166, 7170, 7171, 7172, 7173, 7174 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 7165 | 7161, 7162, 7163, 7166, 7170, 7171, 7172, 7173, 7174 |
...
|------|------|--------|-----------|-----|--------|
| 7161 | Sort | 1062.24 | 2934.42 | 176.2% | pattern |
| 7164 | Aggregate | 1057.34 | 1128.78 | 6.8% | operator |
| 7165 | Sort | 1057.09 | 1835.91 | 73.7% | pattern |
| 7167 | Nested Loop | 1043.74 | 1188.39 | 13.9% | operator |
| 7179 | Hash | 4.60 | 18.67 | 306.1% | operator |
| 7168 | Hash Join | 213.40 | 253.07 | 18.6% | operator |
| 7178 | Index Scan | 0.07 | -0.22 | 405.6% | operator |
| 7180 | Seq Scan | 4.07 | 12.36 | 203.5% | operator |
| 7169 | Seq Scan | 167.43 | 159.81 | 4.6% | operator |
| 7170 | Hash | 32.38 | 46.85 | 44.7% | pattern |
| 7175 | Seq Scan | 0.01 | 11.81 | 147503.4% | operator |
| 7176 | Hash | 0.06 | 21.05 | 38178.6% | operator |
| 7177 | Seq Scan | 0.05 | 22.93 | 44002.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 7177 (Seq Scan) - LEAF
...
### Step 2: Node 7175 (Seq Scan) - LEAF
...
### Step 4: Node 7169 (Seq Scan) - LEAF
...
### Step 5: Node 7170 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 7161, 7162, 7163, 7165, 7166, 7171, 7172, 7173, 7174
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 7178 (Index Scan) - LEAF
...
### Step 8: Node 7180 (Seq Scan) - LEAF
...
### Step 11: Node 7165 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 7161, 7162, 7163, 7166, 7170, 7171, 7172, 7173, 7174
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 7161 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 7162, 7163, 7165, 7166, 7170, 7171, 7172, 7173, 7174
- **Input Features:**
