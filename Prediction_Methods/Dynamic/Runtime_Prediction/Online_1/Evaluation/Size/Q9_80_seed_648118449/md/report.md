    ...
    Node 18973 (Gather)
      Node 18974 (Aggregate)
        Node 18975 (Nested Loop)
          Node 18976 (Hash Join) [PATTERN: bb930825]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18976 | 18971, 18972, 18977, 18978, 18979 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18971 | 18972, 18976, 18977, 18978, 18979 |
...
|------|------|--------|-----------|-----|--------|
| 18971 | Sort | 1192.38 | 1045.10 | 12.4% | pattern |
| 18973 | Gather | 1191.21 | 960.51 | 19.4% | operator |
| 18974 | Aggregate | 1172.61 | 1141.32 | 2.7% | operator |
| 18975 | Nested Loop | 1148.28 | 1252.17 | 9.0% | operator |
| 18976 | Hash Join | 975.51 | 134.80 | 86.2% | pattern |
| 18988 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18980 | Hash Join | 165.14 | 837.46 | 407.1% | operator |
| 18986 | Hash | 13.25 | 14.95 | 12.8% | operator |
| 18981 | Nested Loop | 157.26 | 1251.76 | 696.0% | operator |
| 18984 | Hash | 5.05 | 15.94 | 215.3% | operator |
| 18987 | Seq Scan | 13.24 | 2.94 | 77.8% | operator |
| 18982 | Seq Scan | 19.91 | 44.37 | 122.9% | operator |
| 18983 | Index Scan | 0.07 | -1.39 | 1951.3% | operator |
| 18985 | Seq Scan | 4.48 | 9.45 | 110.6% | operator |
...
### Step 9: Node 18976 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18971, 18972, 18977, 18978, 18979
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 11: Node 18975 (Nested Loop)
...
### Step 14: Node 18971 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18972, 18976, 18977, 18978, 18979
- **Input Features:**
