...
**Test Query:** Q12_103_seed_836811162
...
```
Node 24341 (Aggregate) - ROOT
  Node 24342 (Gather Merge)
    Node 24343 (Aggregate)
      Node 24344 (Sort)
        Node 24345 (Nested Loop)
          Node 24346 (Seq Scan) - LEAF
          Node 24347 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24341 | Aggregate | 996.27 | 919.06 | 7.8% | operator |
| 24342 | Gather Merge | 996.26 | 1111.84 | 11.6% | operator |
| 24343 | Aggregate | 976.95 | 895.30 | 8.4% | operator |
| 24344 | Sort | 976.34 | 1092.82 | 11.9% | operator |
| 24345 | Nested Loop | 975.30 | 1127.41 | 15.6% | operator |
| 24346 | Seq Scan | 828.38 | 745.19 | 10.0% | operator |
| 24347 | Index Scan | 0.03 | 0.07 | 156.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24346 (Seq Scan) - LEAF
...
### Step 2: Node 24347 (Index Scan) - LEAF
...
### Step 6: Node 24342 (Gather Merge)
...
### Step 7: Node 24341 (Aggregate) - ROOT
