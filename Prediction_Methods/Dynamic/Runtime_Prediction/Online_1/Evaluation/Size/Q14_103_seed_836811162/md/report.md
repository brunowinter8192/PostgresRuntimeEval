...
**Test Query:** Q14_103_seed_836811162
**Timestamp:** 2026-01-18 20:02:45
...
```
Node 26441 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26442 (Gather) [consumed]
    Node 26443 (Aggregate) [consumed]
      Node 26444 (Hash Join) [consumed]
        Node 26445 (Seq Scan) - LEAF
        Node 26446 (Hash)
          Node 26447 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26441 | 26442, 26443, 26444 |
...
|------|------|--------|-----------|-----|--------|
| 26441 | Aggregate | 822.03 | 857.12 | 4.3% | pattern |
| 26445 | Seq Scan | 750.96 | 758.47 | 1.0% | operator |
| 26446 | Hash | 42.73 | 9.38 | 78.1% | operator |
| 26447 | Seq Scan | 36.84 | 12.70 | 65.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26447 (Seq Scan) - LEAF
...
### Step 2: Node 26445 (Seq Scan) - LEAF
...
### Step 4: Node 26441 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26442, 26443, 26444
- **Input Features:**
