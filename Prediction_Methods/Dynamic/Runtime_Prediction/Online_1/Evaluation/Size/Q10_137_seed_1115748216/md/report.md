...
**Test Query:** Q10_137_seed_1115748216
...
```
Node 19890 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 19891 (Sort) [consumed]
    Node 19892 (Aggregate) [consumed]
      Node 19893 (Gather) [consumed]
        Node 19894 (Hash Join)
          Node 19895 (Hash Join) [PATTERN: 2e0f44ef]
            Node 19896 (Nested Loop) [consumed]
              Node 19897 (Seq Scan) - LEAF
              Node 19898 (Index Scan) - LEAF
            Node 19899 (Hash) [consumed]
              Node 19900 (Seq Scan) - LEAF
          Node 19901 (Hash)
            Node 19902 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19890 | 19891, 19892, 19893, 19895, 19896, 19899 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 19895 | 19890, 19891, 19892, 19893, 19896, 19899 |
...
|------|------|--------|-----------|-----|--------|
| 19890 | Limit | 1142.55 | 1199.47 | 5.0% | pattern |
| 19894 | Hash Join | 1097.52 | 1095.46 | 0.2% | operator |
| 19895 | Hash Join | 1094.61 | 1120.19 | 2.3% | pattern |
| 19901 | Hash | 0.02 | 15.71 | 71312.6% | operator |
| 19902 | Seq Scan | 0.02 | 6.98 | 43516.9% | operator |
| 19897 | Seq Scan | 162.76 | 159.74 | 1.9% | operator |
| 19898 | Index Scan | 0.06 | -0.52 | 935.9% | operator |
| 19900 | Seq Scan | 21.22 | 26.64 | 25.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 19897 (Seq Scan) - LEAF
...
### Step 2: Node 19898 (Index Scan) - LEAF
...
### Step 3: Node 19900 (Seq Scan) - LEAF
...
### Step 4: Node 19902 (Seq Scan) - LEAF
...
### Step 5: Node 19895 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 19890, 19891, 19892, 19893, 19896, 19899
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=17827
  - HashJoin_nt1=17827
  ...
  - HashJoin_total_cost=80469.6900
  - Hash_Inner_np=0
  - Hash_Inner_nt=62500
  ...
  - NestedLoop_Outer_nt=17827
  - NestedLoop_Outer_nt1=18012
  ...
  - NestedLoop_Outer_total_cost=75416.6500
- **Output:** st=51.86, rt=1120.19

### Step 6: Node 19901 (Hash)
...
- **Output:** st=54.18, rt=1095.46

### Step 8: Node 19890 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19891, 19892, 19893, 19895, 19896, 19899
- **Input Features:**
