...
**Test Query:** Q14_107_seed_869627286
...
```
Node 26469 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26470 (Gather) [consumed]
    Node 26471 (Aggregate) [consumed]
      Node 26472 (Hash Join) [consumed]
        Node 26473 (Seq Scan) - LEAF
        Node 26474 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26469 | 26470, 26471, 26472 |
...
|------|------|--------|-----------|-----|--------|
| 26469 | Aggregate | 818.33 | 857.14 | 4.7% | pattern |
| 26473 | Seq Scan | 747.79 | 758.50 | 1.4% | operator |
| 26474 | Hash | 41.79 | 9.38 | 77.6% | operator |
| 26475 | Seq Scan | 36.17 | 12.70 | 64.9% | operator |
...
### Step 2: Node 26473 (Seq Scan) - LEAF
...
### Step 4: Node 26469 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26470, 26471, 26472
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=15570
  - HashJoin_Outer_nt1=15570
