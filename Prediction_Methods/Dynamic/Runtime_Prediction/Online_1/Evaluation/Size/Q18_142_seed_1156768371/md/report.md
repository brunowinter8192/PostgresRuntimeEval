...
**Test Query:** Q18_142_seed_1156768371
...
```
Node 29556 (Limit) - ROOT
  Node 29557 (Sort)
    Node 29558 (Aggregate)
      Node 29559 (Gather Merge)
        Node 29560 (Incremental Sort)
          Node 29561 (Nested Loop)
            Node 29562 (Merge Join)
              Node 29563 (Sort)
                Node 29564 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29565 (Seq Scan) [consumed] - LEAF
                  Node 29566 (Hash) [consumed]
                    Node 29567 (Aggregate)
                      Node 29568 (Index Scan) - LEAF
              Node 29569 (Sort)
                Node 29570 (Seq Scan) - LEAF
            Node 29571 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29564 | 29565, 29566 |
...
|------|------|--------|-----------|-----|--------|
| 29556 | Limit | 3029.61 | 1175.21 | 61.2% | operator |
| 29557 | Sort | 2914.36 | 1127.81 | 61.3% | operator |
| 29558 | Aggregate | 2914.32 | 1073.15 | 63.2% | operator |
| 29559 | Gather Merge | 2914.29 | 1073.95 | 63.1% | operator |
| 29560 | Incremental Sort | 2894.23 | 0.00 | 100.0% | operator |
| 29561 | Nested Loop | 2894.17 | 1111.34 | 61.6% | operator |
| 29562 | Merge Join | 2894.10 | 0.00 | 100.0% | operator |
| 29571 | Index Scan | 0.03 | 0.05 | 80.5% | operator |
| 29563 | Sort | 2824.28 | 1095.58 | 61.2% | operator |
| 29569 | Sort | 67.15 | 1074.66 | 1500.4% | operator |
| 29564 | Hash Join | 2824.26 | 471.07 | 83.3% | pattern |
| 29570 | Seq Scan | 54.60 | 18.25 | 66.6% | operator |
| 29567 | Aggregate | 2602.23 | 1073.15 | 58.8% | operator |
| 29568 | Index Scan | 2100.50 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29568 (Index Scan) - LEAF
...
### Step 3: Node 29564 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29565, 29566
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29570 (Seq Scan) - LEAF
...
### Step 7: Node 29562 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29571 (Index Scan) - LEAF
...
### Step 10: Node 29560 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29559 (Gather Merge)
