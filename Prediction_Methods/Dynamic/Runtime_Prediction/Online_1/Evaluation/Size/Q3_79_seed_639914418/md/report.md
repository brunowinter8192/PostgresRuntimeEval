...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5611 | 5612, 5613, 5614 |
...
| 5615 | Nested Loop | 1166.84 | 1193.25 | 2.3% | operator |
| 5616 | Hash Join | 205.91 | 230.92 | 12.1% | operator |
| 5620 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5617 | Seq Scan | 153.63 | 163.43 | 6.4% | operator |
| 5618 | Hash | 28.78 | 17.75 | 38.3% | operator |
...
### Step 2: Node 5617 (Seq Scan) - LEAF
...
### Step 5: Node 5620 (Index Scan) - LEAF
...
### Step 7: Node 5611 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5612, 5613, 5614
- **Input Features:**
