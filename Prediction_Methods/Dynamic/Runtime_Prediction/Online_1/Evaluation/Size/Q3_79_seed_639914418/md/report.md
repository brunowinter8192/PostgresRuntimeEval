...
**Test Query:** Q3_79_seed_639914418
...
```
Node 5611 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5612 (Sort) [consumed]
    Node 5613 (Aggregate) [consumed]
      Node 5614 (Gather) [consumed]
        Node 5615 (Nested Loop)
          Node 5616 (Hash Join) [PATTERN: 895c6e8c]
            Node 5617 (Seq Scan) [consumed] - LEAF
            Node 5618 (Hash) [consumed]
              Node 5619 (Seq Scan) - LEAF
          Node 5620 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5611 | 5612, 5613, 5614, 5616, 5617, 5618 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5616 | 5611, 5612, 5613, 5614, 5617, 5618 |
...
|------|------|--------|-----------|-----|--------|
| 5611 | Limit | 1203.07 | 1151.18 | 4.3% | pattern |
| 5615 | Nested Loop | 1166.84 | 1193.34 | 2.3% | operator |
| 5616 | Hash Join | 205.91 | 242.53 | 17.8% | pattern |
| 5620 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5619 | Seq Scan | 28.03 | 38.54 | 37.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5619 (Seq Scan) - LEAF
...
### Step 2: Node 5616 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5611, 5612, 5613, 5614, 5617, 5618
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47366
  - HashJoin_nt1=235716
...
### Step 3: Node 5620 (Index Scan) - LEAF
...
### Step 5: Node 5611 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5612, 5613, 5614, 5616, 5617, 5618
- **Input Features:**
