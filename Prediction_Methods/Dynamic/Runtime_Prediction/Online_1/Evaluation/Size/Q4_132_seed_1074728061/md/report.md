...
**Test Query:** Q4_132_seed_1074728061
...
```
Node 6096 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6097 (Gather Merge) [consumed]
    Node 6098 (Sort) [consumed]
      Node 6099 (Aggregate) [consumed]
        Node 6100 (Nested Loop)
          Node 6101 (Seq Scan) - LEAF
          Node 6102 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6096 | 6097, 6098, 6099 |
...
|------|------|--------|-----------|-----|--------|
| 6096 | Aggregate | 1029.57 | 952.19 | 7.5% | pattern |
| 6100 | Nested Loop | 1023.63 | 1255.45 | 22.6% | operator |
| 6101 | Seq Scan | 166.74 | 154.67 | 7.2% | operator |
| 6102 | Index Scan | 0.06 | 11.10 | 17810.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6101 (Seq Scan) - LEAF
...
### Step 2: Node 6102 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - Aggregate_startup_cost=66782.9900
  - Aggregate_total_cost=66784.8900
  ...
  - GatherMerge_Outer_startup_cost=66782.9900
  - GatherMerge_Outer_total_cost=66784.7600
  - Sort_Outer_np=0
  - Sort_Outer_nt=5
  - Sort_Outer_nt1=5
  - Sort_Outer_nt2=0
  ...
  - Sort_Outer_startup_cost=65782.9500
  - Sort_Outer_total_cost=65782.9600
