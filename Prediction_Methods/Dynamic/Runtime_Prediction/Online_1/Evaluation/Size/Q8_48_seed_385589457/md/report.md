...
```
Node 15317 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 15318 (Gather Merge) [consumed]
    Node 15319 (Sort)
          ...
          Node 15322 (Hash Join)
            Node 15323 (Nested Loop)
              Node 15324 (Hash Join)
                ...
                Node 15326 (Hash) [PATTERN: 444761fb]
                  Node 15327 (Hash Join) [consumed]
                    Node 15328 (Seq Scan) [consumed] - LEAF
                    Node 15329 (Hash) [consumed]
                      Node 15330 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 15326 | 15317, 15318, 15327, 15328, 15329, 15330 |
| Aggregate -> Gather Merge (Out | 2724c080 | 15317 | 15318, 15326, 15327, 15328, 15329, 15330 |
...
|------|------|--------|-----------|-----|--------|
| 15317 | Aggregate | 1238.26 | 1133.68 | 8.4% | pattern |
...
| 15324 | Hash Join | 218.71 | 251.67 | 15.1% | operator |
...
| 15326 | Hash | 38.60 | 43.51 | 12.7% | pattern |
...
### Step 4: Node 15325 (Seq Scan) - LEAF
...
### Step 5: Node 15326 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 15317, 15318, 15327, 15328, 15329, 15330
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 15334 (Index Scan) - LEAF
...
### Step 8: Node 15336 (Seq Scan) - LEAF
...
### Step 12: Node 15337 (Index Scan) - LEAF
...
### Step 13: Node 15339 (Seq Scan) - LEAF
...
### Step 14: Node 15321 (Nested Loop)
...
### Step 18: Node 15317 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 15318, 15326, 15327, 15328, 15329, 15330
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2405
  - Aggregate_nt1=2405
