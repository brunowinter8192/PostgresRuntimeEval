...
**Test Query:** Q18_69_seed_557874108
...
```
Node 30660 (Limit) - ROOT
  Node 30661 (Sort)
    Node 30662 (Aggregate)
      Node 30663 (Gather Merge)
        Node 30664 (Incremental Sort)
          Node 30665 (Nested Loop)
            Node 30666 (Merge Join)
              Node 30667 (Sort)
                Node 30668 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30669 (Seq Scan) [consumed] - LEAF
                  Node 30670 (Hash) [consumed]
                    Node 30671 (Aggregate)
                      Node 30672 (Index Scan) - LEAF
              Node 30673 (Sort)
                Node 30674 (Seq Scan) - LEAF
            Node 30675 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30668 | 30669, 30670 |
...
|------|------|--------|-----------|-----|--------|
| 30660 | Limit | 3026.24 | 1175.21 | 61.2% | operator |
| 30661 | Sort | 2906.93 | 1127.81 | 61.2% | operator |
| 30662 | Aggregate | 2906.89 | 1073.15 | 63.1% | operator |
| 30663 | Gather Merge | 2906.88 | 1073.95 | 63.1% | operator |
| 30664 | Incremental Sort | 2871.23 | 0.00 | 100.0% | operator |
| 30665 | Nested Loop | 2871.10 | 1111.34 | 61.3% | operator |
| 30666 | Merge Join | 2871.05 | 0.00 | 100.0% | operator |
| 30675 | Index Scan | 0.02 | 0.05 | 150.8% | operator |
| 30667 | Sort | 2821.15 | 1095.58 | 61.2% | operator |
| 30673 | Sort | 63.57 | 1074.66 | 1590.5% | operator |
| 30668 | Hash Join | 2821.14 | 471.07 | 83.3% | pattern |
| 30674 | Seq Scan | 52.30 | 18.25 | 65.1% | operator |
| 30671 | Aggregate | 2594.49 | 1073.15 | 58.6% | operator |
| 30672 | Index Scan | 2095.24 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30672 (Index Scan) - LEAF
...
### Step 3: Node 30668 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30669, 30670
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30674 (Seq Scan) - LEAF
...
### Step 7: Node 30666 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30675 (Index Scan) - LEAF
...
### Step 10: Node 30664 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30663 (Gather Merge)
