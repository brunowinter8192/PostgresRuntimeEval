...
**Test Query:** Q3_67_seed_541466046
...
```
Node 5481 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5482 (Sort) [consumed]
    Node 5483 (Aggregate) [consumed]
      Node 5484 (Gather) [consumed]
        Node 5485 (Nested Loop)
          Node 5486 (Hash Join) [PATTERN: 895c6e8c]
            Node 5487 (Seq Scan) [consumed] - LEAF
            Node 5488 (Hash) [consumed]
              Node 5489 (Seq Scan) - LEAF
          Node 5490 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5481 | 5482, 5483, 5484, 5486, 5487, 5488 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5486 | 5481, 5482, 5483, 5484, 5487, 5488 |
...
|------|------|--------|-----------|-----|--------|
| 5481 | Limit | 1188.88 | 1151.18 | 3.2% | pattern |
| 5485 | Nested Loop | 1152.64 | 1193.00 | 3.5% | operator |
| 5486 | Hash Join | 207.57 | 242.47 | 16.8% | pattern |
| 5490 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5489 | Seq Scan | 27.92 | 38.57 | 38.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5489 (Seq Scan) - LEAF
...
### Step 2: Node 5486 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5481, 5482, 5483, 5484, 5487, 5488
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46840
  - HashJoin_nt1=234452
  ...
  - HashJoin_total_cost=37337.1800
  - Hash_Inner_np=0
  - Hash_Inner_nt=12487
...
### Step 3: Node 5490 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=72833.7400
- **Output:** st=121.75, rt=1193.00

### Step 5: Node 5481 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5482, 5483, 5484, 5486, 5487, 5488
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=313458
  - Aggregate_Outer_nt1=313458
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=109881.4100
  - Aggregate_Outer_total_cost=113799.6300
  - Gather_Outer_np=0
  - Gather_Outer_nt=313458
  - Gather_Outer_nt1=101115
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105179.5400
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=313458
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=120573.3500
  - Limit_total_cost=120573.3700
  - Sort_Outer_np=0
  - Sort_Outer_nt=313458
  - Sort_Outer_nt1=313458
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=120573.3500
  - Sort_Outer_total_cost=121356.9900
