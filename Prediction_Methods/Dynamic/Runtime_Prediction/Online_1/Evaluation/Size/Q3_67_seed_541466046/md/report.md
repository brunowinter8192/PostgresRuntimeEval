...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5481 | 5482, 5483, 5484 |
...
| 5485 | Nested Loop | 1152.64 | 1192.91 | 3.5% | operator |
| 5486 | Hash Join | 207.57 | 230.65 | 11.1% | operator |
| 5490 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5487 | Seq Scan | 155.93 | 163.34 | 4.8% | operator |
| 5488 | Hash | 28.67 | 17.75 | 38.1% | operator |
...
### Step 2: Node 5487 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37337.1800
- **Output:** st=27.18, rt=230.65

### Step 5: Node 5490 (Index Scan) - LEAF
...
- **Output:** st=121.61, rt=1192.91

### Step 7: Node 5481 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5482, 5483, 5484
- **Input Features:**
