...
**Test Query:** Q19_88_seed_713750697
...
```
Node 32172 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 32173 (Gather) [consumed]
    Node 32174 (Aggregate) [consumed]
      Node 32175 (Hash Join) [consumed]
        Node 32176 (Seq Scan) - LEAF
        Node 32177 (Hash)
          Node 32178 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 32172 | 32173, 32174, 32175 |
...
|------|------|--------|-----------|-----|--------|
| 32172 | Aggregate | 880.35 | 829.30 | 5.8% | pattern |
| 32176 | Seq Scan | 809.34 | 743.46 | 8.1% | operator |
| 32177 | Hash | 48.49 | 8.29 | 82.9% | operator |
| 32178 | Seq Scan | 48.32 | 23.76 | 50.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 32178 (Seq Scan) - LEAF
...
### Step 2: Node 32176 (Seq Scan) - LEAF
...
### Step 4: Node 32172 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 32173, 32174, 32175
- **Input Features:**
