...
**Test Query:** Q5_114_seed_927055503
...
```
Node 7201 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 7202 (Aggregate) [consumed]
    Node 7203 (Gather Merge) [consumed]
      Node 7204 (Aggregate)
        Node 7205 (Sort) [PATTERN: 3e2d5a00]
          Node 7206 (Hash Join) [consumed]
            Node 7207 (Nested Loop)
              Node 7208 (Hash Join)
                Node 7209 (Seq Scan) - LEAF
                Node 7210 (Hash) [PATTERN: 444761fb]
                  Node 7211 (Hash Join) [consumed]
                    Node 7212 (Seq Scan) [consumed] - LEAF
                    Node 7213 (Hash) [consumed]
                      Node 7214 (Hash Join) [consumed]
                        Node 7215 (Seq Scan) - LEAF
                        Node 7216 (Hash)
                          Node 7217 (Seq Scan) - LEAF
              Node 7218 (Index Scan) - LEAF
            Node 7219 (Hash)
              Node 7220 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 7210 | 7201, 7202, 7203, 7205, 7206, 7211, 7212, 7213, 7214 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 7201 | 7202, 7203, 7205, 7206, 7210, 7211, 7212, 7213, 7214 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 7205 | 7201, 7202, 7203, 7206, 7210, 7211, 7212, 7213, 7214 |
...
|------|------|--------|-----------|-----|--------|
| 7201 | Sort | 1084.29 | 2934.42 | 170.6% | pattern |
| 7204 | Aggregate | 1079.48 | 1128.78 | 4.6% | operator |
| 7205 | Sort | 1079.21 | 1835.91 | 70.1% | pattern |
| 7207 | Nested Loop | 1067.08 | 1188.39 | 11.4% | operator |
| 7219 | Hash | 3.14 | 18.67 | 495.4% | operator |
| 7208 | Hash Join | 213.48 | 253.07 | 18.5% | operator |
| 7218 | Index Scan | 0.07 | -0.22 | 397.3% | operator |
| 7220 | Seq Scan | 2.63 | 12.36 | 369.0% | operator |
| 7209 | Seq Scan | 167.76 | 159.81 | 4.7% | operator |
| 7210 | Hash | 32.62 | 46.85 | 43.6% | pattern |
| 7215 | Seq Scan | 0.10 | 11.81 | 11708.3% | operator |
| 7216 | Hash | 0.05 | 21.05 | 45667.9% | operator |
| 7217 | Seq Scan | 0.04 | 22.93 | 54503.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 7217 (Seq Scan) - LEAF
...
### Step 2: Node 7215 (Seq Scan) - LEAF
...
### Step 4: Node 7209 (Seq Scan) - LEAF
...
### Step 5: Node 7210 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 7201, 7202, 7203, 7205, 7206, 7211, 7212, 7213, 7214
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 7218 (Index Scan) - LEAF
...
### Step 8: Node 7220 (Seq Scan) - LEAF
...
### Step 11: Node 7205 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 7201, 7202, 7203, 7206, 7210, 7211, 7212, 7213, 7214
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 7201 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 7202, 7203, 7205, 7206, 7210, 7211, 7212, 7213, 7214
- **Input Features:**
