...
**Test Query:** Q8_60_seed_484037829
...
```
Node 15639 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 15640 (Gather Merge) [consumed]
    Node 15641 (Sort)
      Node 15642 (Hash Join)
        Node 15643 (Nested Loop)
          Node 15644 (Hash Join)
            Node 15645 (Nested Loop)
              Node 15646 (Hash Join)
                Node 15647 (Seq Scan) - LEAF
                Node 15648 (Hash) [PATTERN: 444761fb]
                  Node 15649 (Hash Join) [consumed]
                    Node 15650 (Seq Scan) [consumed] - LEAF
                    Node 15651 (Hash) [consumed]
                      Node 15652 (Hash Join) [consumed]
                        Node 15653 (Seq Scan) - LEAF
                        Node 15654 (Hash)
                          Node 15655 (Seq Scan) - LEAF
              Node 15656 (Index Scan) - LEAF
            Node 15657 (Hash)
              Node 15658 (Seq Scan) - LEAF
          Node 15659 (Index Scan) - LEAF
        Node 15660 (Hash)
          Node 15661 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 15648 | 15639, 15640, 15649, 15650, 15651, 15652 |
| Aggregate -> Gather Merge (Out | 2724c080 | 15639 | 15640, 15648, 15649, 15650, 15651, 15652 |
...
|------|------|--------|-----------|-----|--------|
| 15639 | Aggregate | 1215.43 | 1133.66 | 6.7% | pattern |
| 15641 | Sort | 1209.32 | 1046.21 | 13.5% | operator |
| 15642 | Hash Join | 1209.05 | 785.61 | 35.0% | operator |
| 15643 | Nested Loop | 1208.73 | 1198.29 | 0.9% | operator |
| 15660 | Hash | 0.02 | 13.72 | 85675.5% | operator |
| 15644 | Hash Join | 1205.15 | 785.60 | 34.8% | operator |
| 15659 | Index Scan | 0.01 | 12.42 | 206958.1% | operator |
| 15661 | Seq Scan | 0.01 | 6.51 | 54166.4% | operator |
| 15645 | Nested Loop | 1161.14 | 1198.29 | 3.2% | operator |
| 15657 | Hash | 39.73 | 19.97 | 49.7% | operator |
| 15646 | Hash Join | 214.51 | 251.67 | 17.3% | operator |
| 15656 | Index Scan | 0.04 | 2.88 | 6759.2% | operator |
| 15658 | Seq Scan | 39.67 | 48.88 | 23.2% | operator |
| 15647 | Seq Scan | 159.29 | 159.67 | 0.2% | operator |
| 15648 | Hash | 37.59 | 43.51 | 15.8% | pattern |
| 15653 | Seq Scan | 0.01 | 12.22 | 122149.4% | operator |
| 15654 | Hash | 0.18 | 18.14 | 10036.4% | operator |
| 15655 | Seq Scan | 0.17 | 23.36 | 13249.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 15655 (Seq Scan) - LEAF
...
### Step 2: Node 15653 (Seq Scan) - LEAF
...
### Step 4: Node 15647 (Seq Scan) - LEAF
...
### Step 5: Node 15648 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 15639, 15640, 15649, 15650, 15651, 15652
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 15656 (Index Scan) - LEAF
...
### Step 8: Node 15658 (Seq Scan) - LEAF
...
### Step 12: Node 15659 (Index Scan) - LEAF
...
### Step 13: Node 15661 (Seq Scan) - LEAF
...
### Step 14: Node 15643 (Nested Loop)
...
### Step 18: Node 15639 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 15640, 15648, 15649, 15650, 15651, 15652
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2347
  - Aggregate_nt1=2347
