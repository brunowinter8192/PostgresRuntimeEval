...
**Test Query:** Q12_72_seed_582486201
...
```
Node 25153 (Aggregate) - ROOT
  Node 25154 (Gather Merge)
    Node 25155 (Aggregate)
      Node 25156 (Sort)
        Node 25157 (Nested Loop)
          Node 25158 (Seq Scan) - LEAF
          Node 25159 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 25153 | Aggregate | 988.75 | 919.06 | 7.0% | operator |
| 25154 | Gather Merge | 988.73 | 1111.84 | 12.5% | operator |
| 25155 | Aggregate | 968.70 | 895.31 | 7.6% | operator |
| 25156 | Sort | 968.07 | 1092.81 | 12.9% | operator |
| 25157 | Nested Loop | 967.15 | 1127.41 | 16.6% | operator |
| 25158 | Seq Scan | 829.60 | 745.19 | 10.2% | operator |
| 25159 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25158 (Seq Scan) - LEAF
...
### Step 2: Node 25159 (Index Scan) - LEAF
...
### Step 6: Node 25154 (Gather Merge)
...
### Step 7: Node 25153 (Aggregate) - ROOT
