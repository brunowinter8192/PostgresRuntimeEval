...
```
Node 26861 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26862 (Gather) [consumed]
    Node 26863 (Aggregate) [consumed]
      Node 26864 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26861 | 26862, 26863, 26864 |
...
|------|------|--------|-----------|-----|--------|
| 26861 | Aggregate | 838.21 | 857.11 | 2.3% | pattern |
| 26865 | Seq Scan | 767.74 | 758.45 | 1.2% | operator |
| 26866 | Hash | 42.19 | 9.38 | 77.8% | operator |
| 26867 | Seq Scan | 37.90 | 12.70 | 66.5% | operator |
...
### Step 4: Node 26861 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26862, 26863, 26864
- **Input Features:**
