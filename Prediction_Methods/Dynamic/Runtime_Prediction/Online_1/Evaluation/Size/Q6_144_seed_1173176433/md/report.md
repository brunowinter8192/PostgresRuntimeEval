...
**Test Query:** Q6_144_seed_1173176433
...
```
Node 10093 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10094 (Gather) [consumed]
    Node 10095 (Aggregate) [consumed]
      Node 10096 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10093 | 10094, 10095 |
...
|------|------|--------|-----------|-----|--------|
| 10093 | Aggregate | 779.18 | 849.98 | 9.1% | pattern |
| 10096 | Seq Scan | 759.47 | 748.49 | 1.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10096 (Seq Scan) - LEAF
...
### Step 2: Node 10093 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10094, 10095
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=22594
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=32
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=139718.4400
  - Aggregate_Outer_total_cost=139718.4500
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=140718.9800
  - Aggregate_total_cost=140718.9900
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=140718.4400
  - Gather_Outer_total_cost=140718.9500
