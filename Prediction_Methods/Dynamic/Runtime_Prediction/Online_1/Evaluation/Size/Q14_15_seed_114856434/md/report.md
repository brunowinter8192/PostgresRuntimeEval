...
```
Node 26812 (Aggregate) [PATTERN: efde8b38] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26812 | 26813, 26814, 26815 |
...
|------|------|--------|-----------|-----|--------|
| 26812 | Aggregate | 819.00 | 857.13 | 4.7% | pattern |
| 26816 | Seq Scan | 743.62 | 758.50 | 2.0% | operator |
| 26817 | Hash | 44.09 | 9.38 | 78.7% | operator |
| 26818 | Seq Scan | 38.13 | 12.70 | 66.7% | operator |
...
### Step 4: Node 26812 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26813, 26814, 26815
- **Input Features:**
