...
```
Node 25573 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25574 (Aggregate) [consumed]
    Node 25575 (Aggregate)
      Node 25576 (Hash Join) [PATTERN: 895c6e8c]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25573 | 25574, 25576, 25577, 25578 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25576 | 25573, 25574, 25577, 25578 |
...
|------|------|--------|-----------|-----|--------|
| 25573 | Sort | 937.65 | 1079.94 | 15.2% | pattern |
| 25575 | Aggregate | 931.37 | 999.76 | 7.3% | operator |
| 25576 | Hash Join | 719.08 | 470.31 | 34.6% | pattern |
| 25579 | Index Only Scan | 10.29 | 0.00 | 100.0% | operator |
...
### Step 2: Node 25576 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25573, 25574, 25577, 25578
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 25573 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25574, 25576, 25577, 25578
- **Input Features:**
