    ...
    Node 18936 (Gather)
      Node 18937 (Aggregate)
        Node 18938 (Nested Loop)
          Node 18939 (Hash Join) [PATTERN: bb930825]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18939 | 18934, 18935, 18940, 18941, 18942 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18934 | 18935, 18939, 18940, 18941, 18942 |
...
|------|------|--------|-----------|-----|--------|
| 18934 | Sort | 1212.62 | 1049.52 | 13.5% | pattern |
...
| 18939 | Hash Join | 997.79 | 134.80 | 86.5% | pattern |
...
### Step 9: Node 18939 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18934, 18935, 18940, 18941, 18942
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18951 (Index Scan) - LEAF
...
### Step 11: Node 18938 (Nested Loop)
...
### Step 14: Node 18934 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18935, 18939, 18940, 18941, 18942
- **Input Features:**
