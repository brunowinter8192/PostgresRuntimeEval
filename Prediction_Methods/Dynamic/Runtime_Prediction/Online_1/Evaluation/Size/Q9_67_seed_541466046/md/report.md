...
**Test Query:** Q9_67_seed_541466046
...
```
Node 18697 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18698 (Aggregate) [consumed]
    Node 18699 (Gather)
      Node 18700 (Aggregate)
        Node 18701 (Nested Loop)
          Node 18702 (Hash Join) [PATTERN: bb930825]
            Node 18703 (Seq Scan) [consumed] - LEAF
            Node 18704 (Hash) [consumed]
              Node 18705 (Hash Join) [consumed]
                Node 18706 (Hash Join)
                  Node 18707 (Nested Loop)
                    Node 18708 (Seq Scan) - LEAF
                    Node 18709 (Index Scan) - LEAF
                  Node 18710 (Hash)
                    Node 18711 (Seq Scan) - LEAF
                Node 18712 (Hash)
                  Node 18713 (Seq Scan) - LEAF
          Node 18714 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18702 | 18697, 18698, 18703, 18704, 18705 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18697 | 18698, 18702, 18703, 18704, 18705 |
...
|------|------|--------|-----------|-----|--------|
| 18697 | Sort | 1196.21 | 1044.29 | 12.7% | pattern |
| 18699 | Gather | 1194.95 | 965.14 | 19.2% | operator |
| 18700 | Aggregate | 1172.61 | 1141.19 | 2.7% | operator |
| 18701 | Nested Loop | 1147.62 | 1252.17 | 9.1% | operator |
| 18702 | Hash Join | 977.87 | 134.80 | 86.2% | pattern |
| 18714 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18706 | Hash Join | 166.39 | 837.49 | 403.3% | operator |
| 18712 | Hash | 13.72 | 14.95 | 9.0% | operator |
| 18707 | Nested Loop | 159.23 | 1251.76 | 686.1% | operator |
| 18710 | Hash | 5.08 | 15.94 | 213.5% | operator |
| 18713 | Seq Scan | 13.71 | 2.94 | 78.6% | operator |
| 18708 | Seq Scan | 19.81 | 44.30 | 123.6% | operator |
| 18709 | Index Scan | 0.08 | -1.39 | 1903.2% | operator |
| 18711 | Seq Scan | 4.57 | 9.45 | 106.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 18708 (Seq Scan) - LEAF
...
### Step 2: Node 18709 (Index Scan) - LEAF
...
### Step 3: Node 18711 (Seq Scan) - LEAF
...
### Step 6: Node 18713 (Seq Scan) - LEAF
...
### Step 9: Node 18702 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18697, 18698, 18703, 18704, 18705
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18714 (Index Scan) - LEAF
...
### Step 11: Node 18701 (Nested Loop)
...
### Step 14: Node 18697 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18698, 18702, 18703, 18704, 18705
- **Input Features:**
