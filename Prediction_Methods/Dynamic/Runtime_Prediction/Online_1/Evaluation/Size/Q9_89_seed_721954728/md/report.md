...
```
Node 19135 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 19136 (Aggregate) [consumed]
    Node 19137 (Gather)
      Node 19138 (Aggregate)
        Node 19139 (Nested Loop)
          Node 19140 (Hash Join) [PATTERN: bb930825]
            Node 19141 (Seq Scan) [consumed] - LEAF
            Node 19142 (Hash) [consumed]
              Node 19143 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 19140 | 19135, 19136, 19141, 19142, 19143 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 19135 | 19136, 19140, 19141, 19142, 19143 |
...
|------|------|--------|-----------|-----|--------|
| 19135 | Sort | 1212.65 | 1044.79 | 13.8% | pattern |
...
| 19140 | Hash Join | 989.17 | 134.80 | 86.4% | pattern |
...
### Step 9: Node 19140 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 19135, 19136, 19141, 19142, 19143
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 19152 (Index Scan) - LEAF
...
### Step 11: Node 19139 (Nested Loop)
...
### Step 14: Node 19135 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 19136, 19140, 19141, 19142, 19143
- **Input Features:**
