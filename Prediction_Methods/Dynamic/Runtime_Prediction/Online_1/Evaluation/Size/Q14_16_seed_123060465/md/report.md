...
**Test Query:** Q14_16_seed_123060465
...
```
Node 26819 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26820 (Gather) [consumed]
    Node 26821 (Aggregate) [consumed]
      Node 26822 (Hash Join)
        Node 26823 (Seq Scan) - LEAF
        Node 26824 (Hash)
          Node 26825 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26819 | 26820, 26821 |
...
|------|------|--------|-----------|-----|--------|
| 26819 | Aggregate | 844.21 | 848.38 | 0.5% | pattern |
| 26822 | Hash Join | 822.48 | 807.67 | 1.8% | operator |
| 26823 | Seq Scan | 770.02 | 758.51 | 1.5% | operator |
| 26824 | Hash | 45.10 | 9.38 | 79.2% | operator |
| 26825 | Seq Scan | 39.82 | 12.70 | 68.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26825 (Seq Scan) - LEAF
...
### Step 2: Node 26823 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=136648.0400
- **Output:** st=78.58, rt=807.67

### Step 5: Node 26819 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26820, 26821
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=15770
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=64
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0001
  - Aggregate_Outer_startup_cost=136924.0200
  - Aggregate_Outer_total_cost=136924.0300
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=137924.5800
  - Aggregate_total_cost=137924.6000
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=137924.0200
  - Gather_Outer_total_cost=137924.5300
