...
```
Node 26819 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26820 (Gather) [consumed]
    Node 26821 (Aggregate) [consumed]
      Node 26822 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26819 | 26820, 26821, 26822 |
...
|------|------|--------|-----------|-----|--------|
| 26819 | Aggregate | 844.21 | 857.14 | 1.5% | pattern |
...
### Step 4: Node 26819 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26820, 26821, 26822
- **Input Features:**
