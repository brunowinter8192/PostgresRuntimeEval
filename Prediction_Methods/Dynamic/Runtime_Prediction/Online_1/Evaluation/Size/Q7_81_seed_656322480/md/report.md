...
```
Node 12823 (Aggregate) - ROOT
  Node 12824 (Gather Merge)
    Node 12825 (Sort)
      Node 12826 (Hash Join)
        Node 12827 (Nested Loop)
          Node 12828 (Hash Join)
            Node 12829 (Seq Scan) - LEAF
            Node 12830 (Hash)
              Node 12831 (Hash Join)
                Node 12832 (Seq Scan) - LEAF
                Node 12833 (Hash)
                  Node 12834 (Seq Scan) - LEAF
          Node 12835 (Index Scan) - LEAF
        Node 12836 (Hash)
          Node 12837 (Hash Join)
            Node 12838 (Seq Scan) - LEAF
            Node 12839 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 12823 | Aggregate | 1216.46 | 1209.26 | 0.6% | operator |
| 12824 | Gather Merge | 1215.48 | 1142.98 | 6.0% | operator |
| 12825 | Sort | 1209.22 | 1109.13 | 8.3% | operator |
| 12826 | Hash Join | 1208.63 | 842.59 | 30.3% | operator |
| 12827 | Nested Loop | 1201.45 | 1216.16 | 1.2% | operator |
| 12836 | Hash | 3.41 | 17.53 | 414.7% | operator |
| 12828 | Hash Join | 213.50 | 384.47 | 80.1% | operator |
| 12835 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 12837 | Hash Join | 3.36 | 85.17 | 2431.9% | operator |
| 12829 | Seq Scan | 150.62 | 201.16 | 33.6% | operator |
| 12830 | Hash | 37.02 | 19.59 | 47.1% | operator |
| 12838 | Seq Scan | 2.94 | 11.47 | 290.6% | operator |
| 12839 | Hash | 0.01 | 16.89 | 112527.2% | operator |
| 12831 | Hash Join | 36.64 | 92.20 | 151.7% | operator |
| 12840 | Seq Scan | 0.01 | 45.79 | 416193.8% | operator |
| 12832 | Seq Scan | 35.44 | 21.86 | 38.3% | operator |
| 12833 | Hash | 0.01 | 16.89 | 168840.8% | operator |
| 12834 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |
...
### Step 2: Node 12832 (Seq Scan) - LEAF
...
### Step 5: Node 12840 (Seq Scan) - LEAF
...
### Step 6: Node 12829 (Seq Scan) - LEAF
...
### Step 8: Node 12838 (Seq Scan) - LEAF
...
### Step 11: Node 12835 (Index Scan) - LEAF
...
### Step 13: Node 12827 (Nested Loop)
...
### Step 17: Node 12824 (Gather Merge)
...
### Step 18: Node 12823 (Aggregate) - ROOT
