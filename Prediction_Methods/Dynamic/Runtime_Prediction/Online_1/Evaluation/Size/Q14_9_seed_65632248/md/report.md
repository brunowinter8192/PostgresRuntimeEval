...
**Test Query:** Q14_9_seed_65632248
...
```
Node 27463 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27464 (Gather) [consumed]
    Node 27465 (Aggregate) [consumed]
      Node 27466 (Hash Join) [consumed]
        Node 27467 (Seq Scan) - LEAF
        Node 27468 (Hash)
          Node 27469 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27463 | 27464, 27465, 27466 |
...
|------|------|--------|-----------|-----|--------|
| 27463 | Aggregate | 821.51 | 857.13 | 4.3% | pattern |
| 27467 | Seq Scan | 751.11 | 758.48 | 1.0% | operator |
| 27468 | Hash | 41.46 | 9.38 | 77.4% | operator |
| 27469 | Seq Scan | 36.69 | 12.70 | 65.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27469 (Seq Scan) - LEAF
...
### Step 2: Node 27467 (Seq Scan) - LEAF
...
### Step 4: Node 27463 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27464, 27465, 27466
- **Input Features:**
