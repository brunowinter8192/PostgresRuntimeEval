...
```
Node 27463 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27464 (Gather) [consumed]
    Node 27465 (Aggregate) [consumed]
      Node 27466 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27463 | 27464, 27465 |
...
|------|------|--------|-----------|-----|--------|
| 27463 | Aggregate | 821.51 | 848.36 | 3.3% | pattern |
| 27466 | Hash Join | 800.07 | 807.63 | 0.9% | operator |
...
### Step 5: Node 27463 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27464, 27465
- **Input Features:**
