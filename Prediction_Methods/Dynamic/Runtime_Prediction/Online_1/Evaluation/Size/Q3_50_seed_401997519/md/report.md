...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5301 | 5302, 5303, 5304 |
...
| 5305 | Nested Loop | 1154.48 | 1192.83 | 3.3% | operator |
| 5306 | Hash Join | 209.19 | 230.82 | 10.3% | operator |
| 5310 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5307 | Seq Scan | 158.16 | 163.41 | 3.3% | operator |
| 5308 | Hash | 28.38 | 17.75 | 37.5% | operator |
...
### Step 2: Node 5307 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37338.7500
- **Output:** st=27.23, rt=230.82

### Step 5: Node 5310 (Index Scan) - LEAF
...
- **Output:** st=121.55, rt=1192.83

### Step 7: Node 5301 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5302, 5303, 5304
- **Input Features:**
