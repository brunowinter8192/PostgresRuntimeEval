...
**Test Query:** Q3_50_seed_401997519
...
```
Node 5301 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5302 (Sort) [consumed]
    Node 5303 (Aggregate) [consumed]
      Node 5304 (Gather) [consumed]
        Node 5305 (Nested Loop)
          Node 5306 (Hash Join) [PATTERN: 895c6e8c]
            Node 5307 (Seq Scan) [consumed] - LEAF
            Node 5308 (Hash) [consumed]
              Node 5309 (Seq Scan) - LEAF
          Node 5310 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5301 | 5302, 5303, 5304, 5306, 5307, 5308 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5306 | 5301, 5302, 5303, 5304, 5307, 5308 |
...
|------|------|--------|-----------|-----|--------|
| 5301 | Limit | 1194.05 | 1151.18 | 3.6% | pattern |
| 5305 | Nested Loop | 1154.48 | 1192.91 | 3.3% | operator |
| 5306 | Hash Join | 209.19 | 242.45 | 15.9% | pattern |
| 5310 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5309 | Seq Scan | 27.77 | 38.60 | 39.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5309 (Seq Scan) - LEAF
...
### Step 2: Node 5306 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5301, 5302, 5303, 5304, 5307, 5308
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46706
  - HashJoin_nt1=235479
...
- **Input Features:**
  ...
  - total_cost=72693.9700
- **Output:** st=121.69, rt=1192.91

### Step 5: Node 5301 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5302, 5303, 5304, 5306, 5307, 5308
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=311340
  - Aggregate_Outer_nt1=311340
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=109498.0700
  - Aggregate_Outer_total_cost=113389.8200
  - Gather_Outer_np=0
  - Gather_Outer_nt=311340
  - Gather_Outer_nt1=100432
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=104827.9700
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=311340
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=120117.7600
  - Limit_total_cost=120117.7900
  - Sort_Outer_np=0
  - Sort_Outer_nt=311340
  - Sort_Outer_nt1=311340
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=120117.7600
  - Sort_Outer_total_cost=120896.1100
