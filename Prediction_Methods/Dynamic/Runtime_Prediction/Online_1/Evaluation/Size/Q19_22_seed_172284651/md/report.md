...
```
Node 31668 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31669 (Gather) [consumed]
    Node 31670 (Aggregate) [consumed]
      Node 31671 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31668 | 31669, 31670, 31671 |
...
|------|------|--------|-----------|-----|--------|
| 31668 | Aggregate | 816.91 | 829.31 | 1.5% | pattern |
| 31672 | Seq Scan | 750.46 | 743.46 | 0.9% | operator |
| 31673 | Hash | 44.86 | 8.29 | 81.5% | operator |
| 31674 | Seq Scan | 44.77 | 23.76 | 46.9% | operator |
...
### Step 4: Node 31668 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31669, 31670, 31671
- **Input Features:**
