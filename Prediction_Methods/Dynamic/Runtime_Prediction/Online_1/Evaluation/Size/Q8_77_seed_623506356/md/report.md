...
```
Node 16053 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 16054 (Gather Merge) [consumed]
    Node 16055 (Sort)
          ...
          Node 16058 (Hash Join)
            Node 16059 (Nested Loop)
              Node 16060 (Hash Join)
                ...
                Node 16062 (Hash) [PATTERN: 444761fb]
                  Node 16063 (Hash Join) [consumed]
                    Node 16064 (Seq Scan) [consumed] - LEAF
                    Node 16065 (Hash) [consumed]
                      Node 16066 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 16062 | 16053, 16054, 16063, 16064, 16065, 16066 |
| Aggregate -> Gather Merge (Out | 2724c080 | 16053 | 16054, 16062, 16063, 16064, 16065, 16066 |
...
|------|------|--------|-----------|-----|--------|
| 16053 | Aggregate | 1233.61 | 1132.83 | 8.2% | pattern |
...
| 16060 | Hash Join | 216.20 | 251.67 | 16.4% | operator |
...
| 16062 | Hash | 36.94 | 43.51 | 17.8% | pattern |
...
### Step 4: Node 16061 (Seq Scan) - LEAF
...
### Step 5: Node 16062 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 16053, 16054, 16063, 16064, 16065, 16066
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 16070 (Index Scan) - LEAF
...
### Step 8: Node 16072 (Seq Scan) - LEAF
...
### Step 12: Node 16073 (Index Scan) - LEAF
...
### Step 13: Node 16075 (Seq Scan) - LEAF
...
### Step 14: Node 16057 (Nested Loop)
...
### Step 18: Node 16053 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 16054, 16062, 16063, 16064, 16065, 16066
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2422
