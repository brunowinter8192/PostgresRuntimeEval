...
**Test Query:** Q8_77_seed_623506356
...
```
Node 16053 (Aggregate) - ROOT
  Node 16054 (Gather Merge)
    Node 16055 (Sort)
      Node 16056 (Hash Join)
        Node 16057 (Nested Loop)
          Node 16058 (Hash Join)
            Node 16059 (Nested Loop)
              Node 16060 (Hash Join)
                Node 16061 (Seq Scan) - LEAF
                Node 16062 (Hash)
                  Node 16063 (Hash Join)
                    Node 16064 (Seq Scan) - LEAF
                    Node 16065 (Hash)
                      Node 16066 (Hash Join)
                        Node 16067 (Seq Scan) - LEAF
                        Node 16068 (Hash)
                          Node 16069 (Seq Scan) - LEAF
              Node 16070 (Index Scan) - LEAF
            Node 16071 (Hash)
              Node 16072 (Seq Scan) - LEAF
          Node 16073 (Index Scan) - LEAF
        Node 16074 (Hash)
          Node 16075 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 16053 | Aggregate | 1233.61 | 1194.33 | 3.2% | operator |
| 16054 | Gather Merge | 1233.20 | 1097.14 | 11.0% | operator |
| 16055 | Sort | 1228.89 | 1046.21 | 14.9% | operator |
| 16056 | Hash Join | 1227.38 | 785.61 | 36.0% | operator |
| 16057 | Nested Loop | 1227.06 | 1198.29 | 2.3% | operator |
| 16074 | Hash | 0.01 | 13.72 | 97929.2% | operator |
| 16058 | Hash Join | 1223.17 | 785.60 | 35.8% | operator |
| 16073 | Index Scan | 0.01 | 12.42 | 206958.1% | operator |
| 16075 | Seq Scan | 0.01 | 6.51 | 65019.6% | operator |
| 16059 | Nested Loop | 1171.42 | 1198.29 | 2.3% | operator |
| 16071 | Hash | 46.12 | 19.97 | 56.7% | operator |
| 16060 | Hash Join | 216.20 | 251.17 | 16.2% | operator |
| 16070 | Index Scan | 0.04 | 2.88 | 6759.2% | operator |
| 16072 | Seq Scan | 45.96 | 48.87 | 6.4% | operator |
| 16061 | Seq Scan | 161.64 | 159.67 | 1.2% | operator |
| 16062 | Hash | 36.94 | 20.62 | 44.2% | operator |
| 16063 | Hash Join | 36.40 | 132.26 | 263.3% | operator |
| 16064 | Seq Scan | 34.99 | 23.03 | 34.2% | operator |
| 16065 | Hash | 0.07 | 23.66 | 31441.5% | operator |
| 16066 | Hash Join | 0.07 | 306.84 | 426061.0% | operator |
| 16067 | Seq Scan | 0.01 | 12.22 | 135732.7% | operator |
| 16068 | Hash | 0.06 | 18.14 | 32889.4% | operator |
| 16069 | Seq Scan | 0.05 | 23.36 | 44827.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 16069 (Seq Scan) - LEAF
...
### Step 2: Node 16067 (Seq Scan) - LEAF
...
### Step 5: Node 16064 (Seq Scan) - LEAF
...
### Step 8: Node 16061 (Seq Scan) - LEAF
...
### Step 11: Node 16070 (Index Scan) - LEAF
...
### Step 12: Node 16072 (Seq Scan) - LEAF
...
### Step 13: Node 16059 (Nested Loop)
...
### Step 16: Node 16073 (Index Scan) - LEAF
...
### Step 17: Node 16075 (Seq Scan) - LEAF
...
### Step 18: Node 16057 (Nested Loop)
...
### Step 22: Node 16054 (Gather Merge)
...
### Step 23: Node 16053 (Aggregate) - ROOT
