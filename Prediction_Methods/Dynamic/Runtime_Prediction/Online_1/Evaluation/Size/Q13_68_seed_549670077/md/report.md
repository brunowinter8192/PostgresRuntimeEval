...
**Test Query:** Q13_68_seed_549670077
...
```
Node 26168 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26169 (Aggregate) [consumed]
    Node 26170 (Aggregate)
      Node 26171 (Hash Join) [PATTERN: 895c6e8c]
        Node 26172 (Seq Scan) [consumed] - LEAF
        Node 26173 (Hash) [consumed]
          Node 26174 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26168 | 26169, 26171, 26172, 26173 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26171 | 26168, 26169, 26172, 26173 |
...
|------|------|--------|-----------|-----|--------|
| 26168 | Sort | 921.63 | 1079.93 | 17.2% | pattern |
| 26170 | Aggregate | 915.54 | 999.55 | 9.2% | operator |
| 26171 | Hash Join | 696.88 | 470.31 | 32.5% | pattern |
| 26174 | Index Only Scan | 10.58 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26174 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26171 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26168, 26169, 26172, 26173
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1484970
...
### Step 4: Node 26168 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26169, 26171, 26172, 26173
- **Input Features:**
