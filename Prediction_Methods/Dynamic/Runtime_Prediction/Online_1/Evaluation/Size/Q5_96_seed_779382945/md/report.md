...
```
Node 9801 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 9802 (Aggregate) [consumed]
    Node 9803 (Gather Merge) [consumed]
      Node 9804 (Aggregate)
        Node 9805 (Sort) [PATTERN: 3e2d5a00]
          Node 9806 (Hash Join) [consumed]
            Node 9807 (Nested Loop)
              Node 9808 (Hash Join)
                Node 9809 (Seq Scan) - LEAF
                Node 9810 (Hash) [PATTERN: 444761fb]
                  Node 9811 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 9810 | 9801, 9802, 9803, 9805, 9806, 9811, 9812, 9813, 9814 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 9801 | 9802, 9803, 9805, 9806, 9810, 9811, 9812, 9813, 9814 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 9805 | 9801, 9802, 9803, 9806, 9810, 9811, 9812, 9813, 9814 |
...
|------|------|--------|-----------|-----|--------|
| 9801 | Sort | 1089.04 | 2934.42 | 169.4% | pattern |
| 9804 | Aggregate | 1083.57 | 1128.79 | 4.2% | operator |
| 9805 | Sort | 1083.32 | 1835.90 | 69.5% | pattern |
| 9807 | Nested Loop | 1071.24 | 1188.37 | 10.9% | operator |
| 9819 | Hash | 3.32 | 18.67 | 462.9% | operator |
| 9808 | Hash Join | 223.58 | 253.07 | 13.2% | operator |
| 9818 | Index Scan | 0.07 | -0.22 | 397.3% | operator |
| 9820 | Seq Scan | 1.93 | 12.36 | 540.4% | operator |
| 9809 | Seq Scan | 170.17 | 159.81 | 6.1% | operator |
| 9810 | Hash | 38.36 | 46.85 | 22.1% | pattern |
| 9815 | Seq Scan | 0.01 | 11.81 | 117982.7% | operator |
| 9816 | Hash | 0.06 | 21.05 | 38178.6% | operator |
| 9817 | Seq Scan | 0.05 | 22.93 | 44867.3% | operator |
...
### Step 4: Node 9809 (Seq Scan) - LEAF
...
### Step 5: Node 9810 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 9801, 9802, 9803, 9805, 9806, 9811, 9812, 9813, 9814
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 9818 (Index Scan) - LEAF
...
### Step 8: Node 9820 (Seq Scan) - LEAF
...
### Step 11: Node 9805 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 9801, 9802, 9803, 9806, 9810, 9811, 9812, 9813, 9814
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 9801 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 9802, 9803, 9805, 9806, 9810, 9811, 9812, 9813, 9814
- **Input Features:**
