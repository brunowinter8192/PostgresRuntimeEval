...
```
Node 17393 (Sort) - ROOT
  Node 17394 (Aggregate)
    Node 17395 (Gather)
      Node 17396 (Aggregate)
        Node 17397 (Nested Loop)
          Node 17398 (Hash Join)
            Node 17399 (Seq Scan) - LEAF
            Node 17400 (Hash)
              Node 17401 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 17393 | Sort | 1186.13 | 1119.81 | 5.6% | operator |
| 17394 | Aggregate | 1186.00 | 897.74 | 24.3% | operator |
...
| 17398 | Hash Join | 964.68 | 633.50 | 34.3% | operator |
| 17410 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17399 | Seq Scan | 697.62 | 509.93 | 26.9% | operator |
| 17400 | Hash | 172.56 | 48.03 | 72.2% | operator |
| 17401 | Hash Join | 170.52 | 924.48 | 442.2% | operator |
...
### Step 10: Node 17399 (Seq Scan) - LEAF
...
### Step 13: Node 17410 (Index Scan) - LEAF
...
### Step 14: Node 17397 (Nested Loop)
