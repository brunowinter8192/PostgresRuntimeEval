...
```
Node 32144 (Aggregate) [PATTERN: efde8b38] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 32144 | 32145, 32146, 32147 |
...
|------|------|--------|-----------|-----|--------|
| 32144 | Aggregate | 856.23 | 829.29 | 3.1% | pattern |
| 32148 | Seq Scan | 787.39 | 743.46 | 5.6% | operator |
| 32149 | Hash | 46.33 | 8.29 | 82.1% | operator |
| 32150 | Seq Scan | 46.14 | 23.76 | 48.5% | operator |
...
### Step 4: Node 32144 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 32145, 32146, 32147
- **Input Features:**
