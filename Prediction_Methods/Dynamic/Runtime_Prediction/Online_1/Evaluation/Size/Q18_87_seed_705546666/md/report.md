        ...
        Node 30984 (Incremental Sort)
          Node 30985 (Nested Loop)
            Node 30986 (Merge Join)
              Node 30987 (Sort)
                Node 30988 (Hash Join)
                  Node 30989 (Seq Scan) - LEAF
                  Node 30990 (Hash)
...
| 30987 | Sort | 2848.28 | 1099.77 | 61.4% | operator |
| 30993 | Sort | 69.48 | 1074.66 | 1446.7% | operator |
| 30988 | Hash Join | 2848.26 | 686.33 | 75.9% | operator |
| 30994 | Seq Scan | 57.63 | 18.25 | 68.3% | operator |
| 30989 | Seq Scan | 190.91 | 170.37 | 10.8% | operator |
| 30990 | Hash | 2628.07 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30989 (Seq Scan) - LEAF
...
### Step 6: Node 30994 (Seq Scan) - LEAF
...
### Step 9: Node 30986 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30995 (Index Scan) - LEAF
...
### Step 11: Node 30985 (Nested Loop)
...
### Step 12: Node 30984 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30983 (Gather Merge)
