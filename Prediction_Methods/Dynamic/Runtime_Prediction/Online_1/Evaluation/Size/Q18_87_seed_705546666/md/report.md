...
**Test Query:** Q18_87_seed_705546666
...
```
Node 30980 (Limit) - ROOT
  Node 30981 (Sort)
    Node 30982 (Aggregate)
      Node 30983 (Gather Merge)
        Node 30984 (Incremental Sort)
          Node 30985 (Nested Loop)
            Node 30986 (Merge Join)
              Node 30987 (Sort)
                Node 30988 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30989 (Seq Scan) [consumed] - LEAF
                  Node 30990 (Hash) [consumed]
                    Node 30991 (Aggregate)
                      Node 30992 (Index Scan) - LEAF
              Node 30993 (Sort)
                Node 30994 (Seq Scan) - LEAF
            Node 30995 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30988 | 30989, 30990 |
...
|------|------|--------|-----------|-----|--------|
| 30980 | Limit | 3059.30 | 1175.21 | 61.6% | operator |
| 30981 | Sort | 2943.38 | 1127.81 | 61.7% | operator |
| 30982 | Aggregate | 2943.34 | 1073.15 | 63.5% | operator |
| 30983 | Gather Merge | 2943.31 | 1073.95 | 63.5% | operator |
| 30984 | Incremental Sort | 2920.40 | 0.00 | 100.0% | operator |
| 30985 | Nested Loop | 2920.35 | 1111.34 | 61.9% | operator |
| 30986 | Merge Join | 2920.28 | 0.00 | 100.0% | operator |
| 30995 | Index Scan | 0.02 | 0.05 | 105.2% | operator |
| 30987 | Sort | 2848.28 | 1095.58 | 61.5% | operator |
| 30993 | Sort | 69.48 | 1074.66 | 1446.7% | operator |
| 30988 | Hash Join | 2848.26 | 471.07 | 83.5% | pattern |
| 30994 | Seq Scan | 57.63 | 18.25 | 68.3% | operator |
| 30991 | Aggregate | 2628.04 | 1073.15 | 59.2% | operator |
| 30992 | Index Scan | 2130.13 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30992 (Index Scan) - LEAF
...
### Step 3: Node 30988 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30989, 30990
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30994 (Seq Scan) - LEAF
...
### Step 7: Node 30986 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30995 (Index Scan) - LEAF
...
### Step 10: Node 30984 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30983 (Gather Merge)
