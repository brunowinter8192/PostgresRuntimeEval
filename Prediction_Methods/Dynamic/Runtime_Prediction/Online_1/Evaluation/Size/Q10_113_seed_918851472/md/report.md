    ...
    Node 19554 (Aggregate) [consumed]
      Node 19555 (Gather) [consumed]
        Node 19556 (Hash Join)
          Node 19557 (Hash Join)
            Node 19558 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19552 | 19553, 19554, 19555 |
...
| 19556 | Hash Join | 1107.46 | 1007.08 | 9.1% | operator |
| 19557 | Hash Join | 1104.52 | 1003.90 | 9.1% | operator |
| 19563 | Hash | 0.02 | 15.71 | 92316.3% | operator |
| 19558 | Nested Loop | 1058.04 | 1204.89 | 13.9% | operator |
| 19561 | Hash | 35.84 | 55.57 | 55.0% | operator |
...
### Step 6: Node 19564 (Seq Scan) - LEAF
...
### Step 10: Node 19552 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19553, 19554, 19555
- **Input Features:**
