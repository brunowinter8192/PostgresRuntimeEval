...
```
Node 26798 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26799 (Gather) [consumed]
    Node 26800 (Aggregate) [consumed]
      Node 26801 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26798 | 26799, 26800, 26801 |
...
|------|------|--------|-----------|-----|--------|
| 26798 | Aggregate | 823.44 | 857.14 | 4.1% | pattern |
...
### Step 4: Node 26798 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26799, 26800, 26801
- **Input Features:**
