...
```
Node 31633 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31634 (Gather) [consumed]
    Node 31635 (Aggregate) [consumed]
      Node 31636 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31633 | 31634, 31635 |
...
|------|------|--------|-----------|-----|--------|
| 31633 | Aggregate | 828.95 | 831.20 | 0.3% | pattern |
| 31636 | Hash Join | 809.62 | 766.06 | 5.4% | operator |
...
### Step 5: Node 31633 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31634, 31635
- **Input Features:**
