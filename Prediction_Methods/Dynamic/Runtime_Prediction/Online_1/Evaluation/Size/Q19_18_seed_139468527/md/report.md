...
**Test Query:** Q19_18_seed_139468527
...
```
Node 31633 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31634 (Gather) [consumed]
    Node 31635 (Aggregate) [consumed]
      Node 31636 (Hash Join) [consumed]
        Node 31637 (Seq Scan) - LEAF
        Node 31638 (Hash)
          Node 31639 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31633 | 31634, 31635, 31636 |
...
|------|------|--------|-----------|-----|--------|
| 31633 | Aggregate | 828.95 | 829.31 | 0.0% | pattern |
| 31637 | Seq Scan | 761.06 | 743.46 | 2.3% | operator |
| 31638 | Hash | 46.10 | 8.29 | 82.0% | operator |
| 31639 | Seq Scan | 45.96 | 23.76 | 48.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31639 (Seq Scan) - LEAF
...
### Step 2: Node 31637 (Seq Scan) - LEAF
...
### Step 4: Node 31633 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31634, 31635, 31636
- **Input Features:**
