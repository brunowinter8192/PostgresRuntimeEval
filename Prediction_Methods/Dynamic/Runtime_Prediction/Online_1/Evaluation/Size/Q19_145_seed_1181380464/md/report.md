...
**Test Query:** Q19_145_seed_1181380464
...
```
Node 31563 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31564 (Gather) [consumed]
    Node 31565 (Aggregate) [consumed]
      Node 31566 (Hash Join)
        Node 31567 (Seq Scan) - LEAF
        Node 31568 (Hash)
          Node 31569 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31563 | 31564, 31565 |
...
|------|------|--------|-----------|-----|--------|
| 31563 | Aggregate | 849.68 | 831.20 | 2.2% | pattern |
| 31566 | Hash Join | 829.50 | 766.05 | 7.6% | operator |
| 31567 | Seq Scan | 781.17 | 743.46 | 4.8% | operator |
| 31568 | Hash | 46.76 | 8.29 | 82.3% | operator |
| 31569 | Seq Scan | 46.66 | 23.76 | 49.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31569 (Seq Scan) - LEAF
...
### Step 2: Node 31567 (Seq Scan) - LEAF
...
### Step 5: Node 31563 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31564, 31565
- **Input Features:**
