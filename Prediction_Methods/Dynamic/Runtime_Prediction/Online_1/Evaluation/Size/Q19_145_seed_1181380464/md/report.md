...
```
Node 31563 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31564 (Gather) [consumed]
    Node 31565 (Aggregate) [consumed]
      Node 31566 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31563 | 31564, 31565, 31566 |
...
|------|------|--------|-----------|-----|--------|
| 31563 | Aggregate | 849.68 | 829.29 | 2.4% | pattern |
...
### Step 4: Node 31563 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31564, 31565, 31566
- **Input Features:**
