...
**Test Query:** Q1_120_seed_976279689
...
```
Node 111 (Aggregate) - ROOT
  Node 112 (Gather Merge)
    Node 113 (Sort) [PATTERN: 1d35fb97]
      Node 114 (Aggregate) [consumed]
        Node 115 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 113 | 114 |
...
|------|------|--------|-----------|-----|--------|
| 111 | Aggregate | 1147.72 | 1195.76 | 4.2% | operator |
| 112 | Gather Merge | 1147.65 | 1165.87 | 1.6% | operator |
| 113 | Sort | 1126.99 | 1200.01 | 6.5% | pattern |
| 115 | Seq Scan | 729.99 | 682.11 | 6.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 115 (Seq Scan) - LEAF
...
### Step 2: Node 113 (Sort) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=168633.4000
  - Sort_total_cost=168633.4200
- **Output:** st=1195.92, rt=1200.01

### Step 3: Node 112 (Gather Merge)
...
### Step 4: Node 111 (Aggregate) - ROOT
