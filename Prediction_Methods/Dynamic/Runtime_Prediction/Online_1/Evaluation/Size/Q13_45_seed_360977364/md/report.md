...
**Test Query:** Q13_45_seed_360977364
...
```
Node 25993 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25994 (Aggregate) [consumed]
    Node 25995 (Aggregate)
      Node 25996 (Hash Join) [PATTERN: 895c6e8c]
        Node 25997 (Seq Scan) [consumed] - LEAF
        Node 25998 (Hash) [consumed]
          Node 25999 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25993 | 25994, 25996, 25997, 25998 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25996 | 25993, 25994, 25997, 25998 |
...
|------|------|--------|-----------|-----|--------|
| 25993 | Sort | 890.34 | 1079.94 | 21.3% | pattern |
| 25995 | Aggregate | 884.43 | 999.76 | 13.0% | operator |
| 25996 | Hash Join | 673.94 | 470.31 | 30.2% | pattern |
| 25999 | Index Only Scan | 9.44 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25999 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25996 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25993, 25994, 25997, 25998
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 25993 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25994, 25996, 25997, 25998
- **Input Features:**
