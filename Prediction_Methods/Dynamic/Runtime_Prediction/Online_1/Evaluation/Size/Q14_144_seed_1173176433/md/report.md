...
**Test Query:** Q14_144_seed_1173176433
...
```
Node 26756 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26757 (Gather) [consumed]
    Node 26758 (Aggregate) [consumed]
      Node 26759 (Hash Join) [consumed]
        Node 26760 (Seq Scan) - LEAF
        Node 26761 (Hash)
          Node 26762 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26756 | 26757, 26758, 26759 |
...
|------|------|--------|-----------|-----|--------|
| 26756 | Aggregate | 840.81 | 857.13 | 1.9% | pattern |
| 26760 | Seq Scan | 764.79 | 758.49 | 0.8% | operator |
| 26761 | Hash | 47.03 | 9.38 | 80.1% | operator |
| 26762 | Seq Scan | 41.67 | 12.70 | 69.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26762 (Seq Scan) - LEAF
...
### Step 2: Node 26760 (Seq Scan) - LEAF
...
### Step 4: Node 26756 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26757, 26758, 26759
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=15351
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=64
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0001
  - Aggregate_Outer_startup_cost=136915.5800
  - Aggregate_Outer_total_cost=136915.5900
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=137916.1500
  - Aggregate_total_cost=137916.1600
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=137915.5800
  - Gather_Outer_total_cost=137916.0900
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=15351
  - HashJoin_Outer_nt1=15351
  ...
  - HashJoin_Outer_total_cost=136646.9400
