...
```
Node 26756 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26757 (Gather) [consumed]
    Node 26758 (Aggregate) [consumed]
      Node 26759 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26756 | 26757, 26758 |
...
|------|------|--------|-----------|-----|--------|
| 26756 | Aggregate | 840.81 | 848.37 | 0.9% | pattern |
| 26759 | Hash Join | 819.85 | 807.65 | 1.5% | operator |
...
- **Input Features:**
  ...
  - total_cost=136646.9400
- **Output:** st=78.57, rt=807.65

### Step 5: Node 26756 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26757, 26758
- **Input Features:**
