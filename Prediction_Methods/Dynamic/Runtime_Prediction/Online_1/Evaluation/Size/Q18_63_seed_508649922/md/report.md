...
**Test Query:** Q18_63_seed_508649922
...
```
Node 30564 (Limit) - ROOT
  Node 30565 (Sort)
    Node 30566 (Aggregate)
      Node 30567 (Gather Merge)
        Node 30568 (Incremental Sort)
          Node 30569 (Nested Loop)
            Node 30570 (Merge Join)
              Node 30571 (Sort)
                Node 30572 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30573 (Seq Scan) [consumed] - LEAF
                  Node 30574 (Hash) [consumed]
                    Node 30575 (Aggregate)
                      Node 30576 (Index Scan) - LEAF
              Node 30577 (Sort)
                Node 30578 (Seq Scan) - LEAF
            Node 30579 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30572 | 30573, 30574 |
...
|------|------|--------|-----------|-----|--------|
| 30564 | Limit | 3053.52 | 1175.21 | 61.5% | operator |
| 30565 | Sort | 2932.91 | 1127.81 | 61.5% | operator |
| 30566 | Aggregate | 2932.87 | 1073.15 | 63.4% | operator |
| 30567 | Gather Merge | 2932.85 | 1073.95 | 63.4% | operator |
| 30568 | Incremental Sort | 2909.20 | 0.00 | 100.0% | operator |
| 30569 | Nested Loop | 2909.15 | 1111.34 | 61.8% | operator |
| 30570 | Merge Join | 2909.09 | 0.00 | 100.0% | operator |
| 30579 | Index Scan | 0.02 | 0.05 | 88.1% | operator |
| 30571 | Sort | 2840.51 | 1095.58 | 61.4% | operator |
| 30577 | Sort | 65.56 | 1074.66 | 1539.2% | operator |
| 30572 | Hash Join | 2840.50 | 471.07 | 83.4% | pattern |
| 30578 | Seq Scan | 53.51 | 18.25 | 65.9% | operator |
| 30575 | Aggregate | 2619.11 | 1073.15 | 59.0% | operator |
| 30576 | Index Scan | 2117.15 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30576 (Index Scan) - LEAF
...
### Step 3: Node 30572 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30573, 30574
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30578 (Seq Scan) - LEAF
...
### Step 7: Node 30570 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30579 (Index Scan) - LEAF
...
### Step 10: Node 30568 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30567 (Gather Merge)
