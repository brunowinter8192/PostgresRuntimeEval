...
```
Node 30852 (Limit) - ROOT
  Node 30853 (Sort)
    Node 30854 (Aggregate)
      Node 30855 (Gather Merge)
        Node 30856 (Incremental Sort)
          Node 30857 (Nested Loop)
            Node 30858 (Merge Join)
              Node 30859 (Sort)
                Node 30860 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30861 (Seq Scan) [consumed] - LEAF
                  Node 30862 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30860 | 30861, 30862 |
...
|------|------|--------|-----------|-----|--------|
| 30852 | Limit | 3049.39 | 1175.21 | 61.5% | operator |
| 30853 | Sort | 2931.44 | 1127.81 | 61.5% | operator |
| 30854 | Aggregate | 2931.39 | 1073.15 | 63.4% | operator |
| 30855 | Gather Merge | 2931.37 | 1073.95 | 63.4% | operator |
| 30856 | Incremental Sort | 2910.47 | 0.00 | 100.0% | operator |
| 30857 | Nested Loop | 2910.42 | 1111.34 | 61.8% | operator |
| 30858 | Merge Join | 2910.36 | 0.00 | 100.0% | operator |
| 30867 | Index Scan | 0.02 | 0.05 | 114.9% | operator |
| 30859 | Sort | 2842.33 | 1095.58 | 61.5% | operator |
| 30865 | Sort | 65.11 | 1074.66 | 1550.6% | operator |
| 30860 | Hash Join | 2842.32 | 471.07 | 83.4% | pattern |
| 30866 | Seq Scan | 51.66 | 18.25 | 64.7% | operator |
| 30863 | Aggregate | 2614.09 | 1073.15 | 58.9% | operator |
| 30864 | Index Scan | 2110.60 | 0.00 | 100.0% | operator |
...
### Step 3: Node 30860 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30861, 30862
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30866 (Seq Scan) - LEAF
...
### Step 7: Node 30858 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30867 (Index Scan) - LEAF
...
### Step 10: Node 30856 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30855 (Gather Merge)
