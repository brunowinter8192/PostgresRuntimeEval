...
```
Node 26189 (Sort) - ROOT
  Node 26190 (Aggregate)
    Node 26191 (Aggregate)
      Node 26192 (Hash Join)
        Node 26193 (Seq Scan) - LEAF
        Node 26194 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 26189 | Sort | 936.60 | 1081.93 | 15.5% | operator |
| 26190 | Aggregate | 936.58 | 1000.33 | 6.8% | operator |
| 26191 | Aggregate | 930.50 | 1014.39 | 9.0% | operator |
| 26192 | Hash Join | 715.81 | 787.83 | 10.1% | operator |
| 26193 | Seq Scan | 500.51 | 264.19 | 47.2% | operator |
| 26194 | Hash | 15.18 | 80.15 | 428.1% | operator |
...
### Step 2: Node 26193 (Seq Scan) - LEAF
