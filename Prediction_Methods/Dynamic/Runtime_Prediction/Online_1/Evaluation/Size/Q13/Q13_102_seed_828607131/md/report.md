...
```
Node 25384 (Sort) - ROOT
  Node 25385 (Aggregate)
    Node 25386 (Aggregate)
      Node 25387 (Hash Join)
        Node 25388 (Seq Scan) - LEAF
        Node 25389 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 25384 | Sort | 898.12 | 1081.93 | 20.5% | operator |
| 25385 | Aggregate | 898.10 | 1000.33 | 11.4% | operator |
| 25386 | Aggregate | 892.04 | 1014.39 | 13.7% | operator |
| 25387 | Hash Join | 678.94 | 787.83 | 16.0% | operator |
| 25388 | Seq Scan | 466.84 | 264.19 | 43.4% | operator |
| 25389 | Hash | 16.17 | 80.15 | 395.6% | operator |
...
### Step 2: Node 25388 (Seq Scan) - LEAF
