...
```
Node 26224 (Sort) - ROOT
  Node 26225 (Aggregate)
    Node 26226 (Aggregate)
      Node 26227 (Hash Join)
        Node 26228 (Seq Scan) - LEAF
        Node 26229 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 26224 | Sort | 892.78 | 1081.93 | 21.2% | operator |
| 26225 | Aggregate | 892.76 | 1000.33 | 12.0% | operator |
| 26226 | Aggregate | 886.73 | 1014.39 | 14.4% | operator |
| 26227 | Hash Join | 676.20 | 787.83 | 16.5% | operator |
| 26228 | Seq Scan | 466.56 | 264.19 | 43.4% | operator |
| 26229 | Hash | 15.31 | 80.15 | 423.6% | operator |
...
### Step 2: Node 26228 (Seq Scan) - LEAF
