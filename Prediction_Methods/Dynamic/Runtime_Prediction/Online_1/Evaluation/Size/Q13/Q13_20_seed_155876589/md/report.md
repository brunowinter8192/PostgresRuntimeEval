...
```
Node 25804 (Sort) - ROOT
  Node 25805 (Aggregate)
    Node 25806 (Aggregate)
      Node 25807 (Hash Join)
        Node 25808 (Seq Scan) - LEAF
        Node 25809 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 25804 | Sort | 919.69 | 1081.93 | 17.6% | operator |
| 25805 | Aggregate | 919.67 | 1000.36 | 8.8% | operator |
| 25806 | Aggregate | 913.62 | 1013.77 | 11.0% | operator |
| 25807 | Hash Join | 698.48 | 787.83 | 12.8% | operator |
| 25808 | Seq Scan | 480.34 | 263.97 | 45.0% | operator |
| 25809 | Hash | 17.67 | 80.15 | 353.7% | operator |
...
### Step 2: Node 25808 (Seq Scan) - LEAF
