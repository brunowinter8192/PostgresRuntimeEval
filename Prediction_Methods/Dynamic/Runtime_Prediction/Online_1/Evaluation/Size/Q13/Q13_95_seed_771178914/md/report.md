...
```
Node 26378 (Sort) - ROOT
  Node 26379 (Aggregate)
    Node 26380 (Aggregate)
      Node 26381 (Hash Join)
        Node 26382 (Seq Scan) - LEAF
        Node 26383 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 26378 | Sort | 928.24 | 1081.93 | 16.6% | operator |
| 26379 | Aggregate | 928.21 | 1000.35 | 7.8% | operator |
| 26380 | Aggregate | 922.14 | 1013.97 | 10.0% | operator |
| 26381 | Hash Join | 703.91 | 787.83 | 11.9% | operator |
| 26382 | Seq Scan | 480.70 | 264.04 | 45.1% | operator |
| 26383 | Hash | 19.34 | 80.15 | 314.5% | operator |
...
### Step 2: Node 26382 (Seq Scan) - LEAF
