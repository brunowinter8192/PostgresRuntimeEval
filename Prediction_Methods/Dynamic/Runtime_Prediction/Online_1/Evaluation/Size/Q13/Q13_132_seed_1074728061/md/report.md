...
```
Node 25615 (Sort) - ROOT
  Node 25616 (Aggregate)
    Node 25617 (Aggregate)
      Node 25618 (Hash Join)
        Node 25619 (Seq Scan) - LEAF
        Node 25620 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 25615 | Sort | 910.74 | 1081.93 | 18.8% | operator |
| 25616 | Aggregate | 910.71 | 1000.33 | 9.8% | operator |
| 25617 | Aggregate | 904.39 | 1014.39 | 12.2% | operator |
| 25618 | Hash Join | 687.40 | 787.83 | 14.6% | operator |
| 25619 | Seq Scan | 473.21 | 264.19 | 44.2% | operator |
| 25620 | Hash | 15.76 | 80.15 | 408.5% | operator |
...
### Step 2: Node 25619 (Seq Scan) - LEAF
