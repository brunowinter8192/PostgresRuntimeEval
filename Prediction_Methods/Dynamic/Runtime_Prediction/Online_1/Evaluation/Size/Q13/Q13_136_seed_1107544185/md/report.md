...
```
Node 25643 (Sort) - ROOT
  Node 25644 (Aggregate)
    Node 25645 (Aggregate)
      Node 25646 (Hash Join)
        Node 25647 (Seq Scan) - LEAF
        Node 25648 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 25643 | Sort | 940.54 | 1081.93 | 15.0% | operator |
| 25644 | Aggregate | 940.51 | 1000.33 | 6.4% | operator |
| 25645 | Aggregate | 934.28 | 1014.39 | 8.6% | operator |
| 25646 | Hash Join | 719.11 | 787.83 | 9.6% | operator |
| 25647 | Seq Scan | 501.68 | 264.19 | 47.3% | operator |
| 25648 | Hash | 17.59 | 80.15 | 355.7% | operator |
...
### Step 2: Node 25647 (Seq Scan) - LEAF
