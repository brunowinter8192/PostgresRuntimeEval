...
```
Node 26406 (Sort) - ROOT
  Node 26407 (Aggregate)
    Node 26408 (Aggregate)
      Node 26409 (Hash Join)
        Node 26410 (Seq Scan) - LEAF
        Node 26411 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 26406 | Sort | 904.94 | 1081.93 | 19.6% | operator |
| 26407 | Aggregate | 904.92 | 1000.33 | 10.5% | operator |
| 26408 | Aggregate | 898.85 | 1014.39 | 12.9% | operator |
| 26409 | Hash Join | 683.16 | 787.83 | 15.3% | operator |
| 26410 | Seq Scan | 465.52 | 264.19 | 43.2% | operator |
| 26411 | Hash | 14.96 | 80.15 | 435.7% | operator |
...
### Step 2: Node 26410 (Seq Scan) - LEAF
