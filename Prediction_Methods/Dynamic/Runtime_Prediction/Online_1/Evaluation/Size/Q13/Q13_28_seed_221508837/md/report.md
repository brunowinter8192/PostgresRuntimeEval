...
```
Node 25860 (Sort) - ROOT
  Node 25861 (Aggregate)
    Node 25862 (Aggregate)
      Node 25863 (Hash Join)
        Node 25864 (Seq Scan) - LEAF
        Node 25865 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 25860 | Sort | 925.07 | 1081.93 | 17.0% | operator |
| 25861 | Aggregate | 925.03 | 1000.36 | 8.1% | operator |
| 25862 | Aggregate | 919.06 | 1013.77 | 10.3% | operator |
| 25863 | Hash Join | 710.75 | 787.83 | 10.8% | operator |
| 25864 | Seq Scan | 503.41 | 263.97 | 47.6% | operator |
| 25865 | Hash | 16.02 | 80.15 | 400.2% | operator |
...
### Step 2: Node 25864 (Seq Scan) - LEAF
