...
```
Node 26252 (Sort) - ROOT
  Node 26253 (Aggregate)
    Node 26254 (Aggregate)
      Node 26255 (Hash Join)
        Node 26256 (Seq Scan) - LEAF
        Node 26257 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 26252 | Sort | 929.03 | 1081.93 | 16.5% | operator |
| 26253 | Aggregate | 929.01 | 1000.33 | 7.7% | operator |
| 26254 | Aggregate | 922.96 | 1014.39 | 9.9% | operator |
| 26255 | Hash Join | 716.65 | 787.83 | 9.9% | operator |
| 26256 | Seq Scan | 511.18 | 264.19 | 48.3% | operator |
| 26257 | Hash | 15.73 | 80.15 | 409.5% | operator |
...
### Step 2: Node 26256 (Seq Scan) - LEAF
