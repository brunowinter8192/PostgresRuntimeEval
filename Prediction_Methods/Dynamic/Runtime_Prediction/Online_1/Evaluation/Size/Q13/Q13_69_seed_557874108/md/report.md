...
```
Node 26175 (Sort) - ROOT
  Node 26176 (Aggregate)
    Node 26177 (Aggregate)
      Node 26178 (Hash Join)
        Node 26179 (Seq Scan) - LEAF
        Node 26180 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 26175 | Sort | 884.98 | 1081.93 | 22.3% | operator |
| 26176 | Aggregate | 884.95 | 1000.37 | 13.0% | operator |
| 26177 | Aggregate | 878.95 | 1013.56 | 15.3% | operator |
| 26178 | Hash Join | 674.62 | 787.83 | 16.8% | operator |
| 26179 | Seq Scan | 468.84 | 263.89 | 43.7% | operator |
| 26180 | Hash | 16.01 | 80.15 | 400.6% | operator |
...
### Step 2: Node 26179 (Seq Scan) - LEAF
