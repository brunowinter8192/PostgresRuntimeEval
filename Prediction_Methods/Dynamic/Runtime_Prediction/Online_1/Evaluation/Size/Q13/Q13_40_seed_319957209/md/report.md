...
```
Node 25958 (Sort) - ROOT
  Node 25959 (Aggregate)
    Node 25960 (Aggregate)
      Node 25961 (Hash Join)
        Node 25962 (Seq Scan) - LEAF
        Node 25963 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 25958 | Sort | 945.00 | 1081.93 | 14.5% | operator |
| 25959 | Aggregate | 944.98 | 1000.36 | 5.9% | operator |
| 25960 | Aggregate | 938.86 | 1013.77 | 8.0% | operator |
| 25961 | Hash Join | 720.79 | 787.83 | 9.3% | operator |
| 25962 | Seq Scan | 503.62 | 263.97 | 47.6% | operator |
| 25963 | Hash | 14.93 | 80.15 | 436.7% | operator |
...
### Step 2: Node 25962 (Seq Scan) - LEAF
