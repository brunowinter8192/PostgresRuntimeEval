...
```
Node 26042 (Sort) - ROOT
  Node 26043 (Aggregate)
    Node 26044 (Aggregate)
      Node 26045 (Hash Join)
        Node 26046 (Seq Scan) - LEAF
        Node 26047 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 26042 | Sort | 913.66 | 1081.92 | 18.4% | operator |
| 26043 | Aggregate | 913.64 | 1000.40 | 9.5% | operator |
| 26044 | Aggregate | 907.74 | 1013.15 | 11.6% | operator |
| 26045 | Hash Join | 688.20 | 787.83 | 14.5% | operator |
| 26046 | Seq Scan | 465.91 | 263.74 | 43.4% | operator |
| 26047 | Hash | 15.65 | 80.15 | 412.2% | operator |
...
### Step 2: Node 26046 (Seq Scan) - LEAF
