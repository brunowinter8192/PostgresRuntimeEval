...
```
Node 25538 (Sort) - ROOT
  Node 25539 (Aggregate)
    Node 25540 (Aggregate)
      Node 25541 (Hash Join)
        Node 25542 (Seq Scan) - LEAF
        Node 25543 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 25538 | Sort | 894.79 | 1081.93 | 20.9% | operator |
| 25539 | Aggregate | 894.76 | 1000.36 | 11.8% | operator |
| 25540 | Aggregate | 888.43 | 1013.77 | 14.1% | operator |
| 25541 | Hash Join | 680.64 | 787.83 | 15.7% | operator |
| 25542 | Seq Scan | 474.92 | 263.97 | 44.4% | operator |
| 25543 | Hash | 15.34 | 80.15 | 422.4% | operator |
...
### Step 2: Node 25542 (Seq Scan) - LEAF
