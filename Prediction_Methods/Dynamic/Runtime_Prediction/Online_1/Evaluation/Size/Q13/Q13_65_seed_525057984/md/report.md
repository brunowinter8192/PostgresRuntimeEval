...
```
Node 26147 (Sort) - ROOT
  Node 26148 (Aggregate)
    Node 26149 (Aggregate)
      Node 26150 (Hash Join)
        Node 26151 (Seq Scan) - LEAF
        Node 26152 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 26147 | Sort | 928.58 | 1081.93 | 16.5% | operator |
| 26148 | Aggregate | 928.55 | 1000.36 | 7.7% | operator |
| 26149 | Aggregate | 922.51 | 1013.77 | 9.9% | operator |
| 26150 | Hash Join | 707.08 | 787.83 | 11.4% | operator |
| 26151 | Seq Scan | 481.64 | 263.97 | 45.2% | operator |
| 26152 | Hash | 17.02 | 80.15 | 371.0% | operator |
...
### Step 2: Node 26151 (Seq Scan) - LEAF
