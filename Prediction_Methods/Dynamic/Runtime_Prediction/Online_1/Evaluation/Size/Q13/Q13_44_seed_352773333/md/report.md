...
```
Node 25986 (Sort) - ROOT
  Node 25987 (Aggregate)
    Node 25988 (Aggregate)
      Node 25989 (Hash Join)
        Node 25990 (Seq Scan) - LEAF
        Node 25991 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 25986 | Sort | 929.35 | 1081.93 | 16.4% | operator |
| 25987 | Aggregate | 929.33 | 1000.34 | 7.6% | operator |
| 25988 | Aggregate | 923.38 | 1014.18 | 9.8% | operator |
| 25989 | Hash Join | 700.43 | 787.83 | 12.5% | operator |
| 25990 | Seq Scan | 478.84 | 264.12 | 44.8% | operator |
| 25991 | Hash | 15.13 | 80.15 | 429.8% | operator |
...
### Step 2: Node 25990 (Seq Scan) - LEAF
