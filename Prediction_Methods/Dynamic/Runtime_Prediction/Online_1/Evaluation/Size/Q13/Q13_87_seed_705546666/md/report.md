...
```
Node 26315 (Sort) - ROOT
  Node 26316 (Aggregate)
    Node 26317 (Aggregate)
      Node 26318 (Hash Join)
        Node 26319 (Seq Scan) - LEAF
        Node 26320 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 26315 | Sort | 907.18 | 1081.93 | 19.3% | operator |
| 26316 | Aggregate | 907.16 | 1000.33 | 10.3% | operator |
| 26317 | Aggregate | 901.04 | 1014.39 | 12.6% | operator |
| 26318 | Hash Join | 687.98 | 787.83 | 14.5% | operator |
| 26319 | Seq Scan | 473.17 | 264.19 | 44.2% | operator |
| 26320 | Hash | 15.35 | 80.15 | 422.0% | operator |
...
### Step 2: Node 26319 (Seq Scan) - LEAF
