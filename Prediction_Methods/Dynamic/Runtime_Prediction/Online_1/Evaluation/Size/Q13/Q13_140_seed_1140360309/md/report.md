...
```
Node 25678 (Sort) - ROOT
  Node 25679 (Aggregate)
    Node 25680 (Aggregate)
      Node 25681 (Hash Join)
        Node 25682 (Seq Scan) - LEAF
        Node 25683 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 25678 | Sort | 911.72 | 1081.93 | 18.7% | operator |
| 25679 | Aggregate | 911.70 | 1000.35 | 9.7% | operator |
| 25680 | Aggregate | 905.76 | 1013.97 | 11.9% | operator |
| 25681 | Hash Join | 695.12 | 787.83 | 13.3% | operator |
| 25682 | Seq Scan | 479.93 | 264.04 | 45.0% | operator |
| 25683 | Hash | 19.32 | 80.15 | 314.7% | operator |
...
### Step 2: Node 25682 (Seq Scan) - LEAF
