...
```
Node 26280 (Sort) - ROOT
  Node 26281 (Aggregate)
    Node 26282 (Aggregate)
      Node 26283 (Hash Join)
        Node 26284 (Seq Scan) - LEAF
        Node 26285 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 26280 | Sort | 922.04 | 1081.93 | 17.3% | operator |
| 26281 | Aggregate | 922.02 | 1000.33 | 8.5% | operator |
| 26282 | Aggregate | 915.87 | 1014.39 | 10.8% | operator |
| 26283 | Hash Join | 710.89 | 787.83 | 10.8% | operator |
| 26284 | Seq Scan | 504.04 | 264.19 | 47.6% | operator |
| 26285 | Hash | 15.01 | 80.15 | 433.9% | operator |
...
### Step 2: Node 26284 (Seq Scan) - LEAF
