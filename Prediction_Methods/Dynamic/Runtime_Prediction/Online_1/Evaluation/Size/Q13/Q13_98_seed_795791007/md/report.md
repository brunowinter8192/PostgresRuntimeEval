...
```
Node 26399 (Sort) - ROOT
  Node 26400 (Aggregate)
    Node 26401 (Aggregate)
      Node 26402 (Hash Join)
        Node 26403 (Seq Scan) - LEAF
        Node 26404 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 26399 | Sort | 904.43 | 1081.93 | 19.6% | operator |
| 26400 | Aggregate | 904.41 | 1000.36 | 10.6% | operator |
| 26401 | Aggregate | 898.33 | 1013.77 | 12.8% | operator |
| 26402 | Hash Join | 689.72 | 787.83 | 14.2% | operator |
| 26403 | Seq Scan | 479.25 | 263.97 | 44.9% | operator |
| 26404 | Hash | 16.29 | 80.15 | 391.9% | operator |
...
### Step 2: Node 26403 (Seq Scan) - LEAF
