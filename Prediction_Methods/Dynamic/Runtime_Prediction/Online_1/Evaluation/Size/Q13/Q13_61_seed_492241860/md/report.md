...
```
Node 26119 (Sort) - ROOT
  Node 26120 (Aggregate)
    Node 26121 (Aggregate)
      Node 26122 (Hash Join)
        Node 26123 (Seq Scan) - LEAF
        Node 26124 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 26119 | Sort | 952.44 | 1081.93 | 13.6% | operator |
| 26120 | Aggregate | 952.42 | 1000.36 | 5.0% | operator |
| 26121 | Aggregate | 946.46 | 1013.77 | 7.1% | operator |
| 26122 | Hash Join | 723.82 | 787.83 | 8.8% | operator |
| 26123 | Seq Scan | 504.22 | 263.97 | 47.6% | operator |
| 26124 | Hash | 15.46 | 80.15 | 418.3% | operator |
...
### Step 2: Node 26123 (Seq Scan) - LEAF
