...
```
Node 25398 (Sort) - ROOT
  Node 25399 (Aggregate)
    Node 25400 (Aggregate)
      Node 25401 (Hash Join)
        Node 25402 (Seq Scan) - LEAF
        Node 25403 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 25398 | Sort | 907.00 | 1081.93 | 19.3% | operator |
| 25399 | Aggregate | 906.98 | 1000.33 | 10.3% | operator |
| 25400 | Aggregate | 900.95 | 1014.39 | 12.6% | operator |
| 25401 | Hash Join | 691.02 | 787.83 | 14.0% | operator |
| 25402 | Seq Scan | 482.80 | 264.19 | 45.3% | operator |
| 25403 | Hash | 14.93 | 80.15 | 436.7% | operator |
...
### Step 2: Node 25402 (Seq Scan) - LEAF
