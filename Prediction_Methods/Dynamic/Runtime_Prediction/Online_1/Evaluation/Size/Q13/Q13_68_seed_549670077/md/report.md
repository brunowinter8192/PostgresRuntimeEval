...
```
Node 26168 (Sort) - ROOT
  Node 26169 (Aggregate)
    Node 26170 (Aggregate)
      Node 26171 (Hash Join)
        Node 26172 (Seq Scan) - LEAF
        Node 26173 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 26168 | Sort | 921.63 | 1081.93 | 17.4% | operator |
| 26169 | Aggregate | 921.60 | 1000.34 | 8.5% | operator |
| 26170 | Aggregate | 915.54 | 1014.18 | 10.8% | operator |
| 26171 | Hash Join | 696.88 | 787.83 | 13.1% | operator |
| 26172 | Seq Scan | 478.29 | 264.12 | 44.8% | operator |
| 26173 | Hash | 16.82 | 80.15 | 376.4% | operator |
...
### Step 2: Node 26172 (Seq Scan) - LEAF
