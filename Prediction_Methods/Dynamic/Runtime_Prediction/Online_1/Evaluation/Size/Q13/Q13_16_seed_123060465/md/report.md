...
```
Node 25769 (Sort) - ROOT
  Node 25770 (Aggregate)
    Node 25771 (Aggregate)
      Node 25772 (Hash Join)
        Node 25773 (Seq Scan) - LEAF
        Node 25774 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 25769 | Sort | 924.27 | 1081.93 | 17.1% | operator |
| 25770 | Aggregate | 924.26 | 1000.36 | 8.2% | operator |
| 25771 | Aggregate | 918.15 | 1013.77 | 10.4% | operator |
| 25772 | Hash Join | 710.88 | 787.83 | 10.8% | operator |
| 25773 | Seq Scan | 504.96 | 263.97 | 47.7% | operator |
| 25774 | Hash | 15.65 | 80.15 | 412.3% | operator |
...
### Step 2: Node 25773 (Seq Scan) - LEAF
