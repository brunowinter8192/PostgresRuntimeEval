...
```
Node 26133 (Sort) - ROOT
  Node 26134 (Aggregate)
    Node 26135 (Aggregate)
      Node 26136 (Hash Join)
        Node 26137 (Seq Scan) - LEAF
        Node 26138 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 26133 | Sort | 893.17 | 1081.93 | 21.1% | operator |
| 26134 | Aggregate | 893.14 | 1000.33 | 12.0% | operator |
| 26135 | Aggregate | 887.06 | 1014.39 | 14.4% | operator |
| 26136 | Hash Join | 676.20 | 787.83 | 16.5% | operator |
| 26137 | Seq Scan | 466.52 | 264.19 | 43.4% | operator |
| 26138 | Hash | 15.68 | 80.15 | 411.2% | operator |
...
### Step 2: Node 26137 (Seq Scan) - LEAF
