...
```
Node 25909 (Sort) - ROOT
  Node 25910 (Aggregate)
    Node 25911 (Aggregate)
      Node 25912 (Hash Join)
        Node 25913 (Seq Scan) - LEAF
        Node 25914 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 25909 | Sort | 946.94 | 1081.93 | 14.3% | operator |
| 25910 | Aggregate | 946.92 | 1000.33 | 5.6% | operator |
| 25911 | Aggregate | 941.02 | 1014.39 | 7.8% | operator |
| 25912 | Hash Join | 723.97 | 787.83 | 8.8% | operator |
| 25913 | Seq Scan | 506.73 | 264.19 | 47.9% | operator |
| 25914 | Hash | 14.87 | 80.15 | 439.1% | operator |
...
### Step 2: Node 25913 (Seq Scan) - LEAF
