...
```
Node 26308 (Sort) - ROOT
  Node 26309 (Aggregate)
    Node 26310 (Aggregate)
      Node 26311 (Hash Join)
        Node 26312 (Seq Scan) - LEAF
        Node 26313 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 26308 | Sort | 947.83 | 1081.93 | 14.1% | operator |
| 26309 | Aggregate | 947.79 | 1000.36 | 5.5% | operator |
| 26310 | Aggregate | 941.71 | 1013.77 | 7.7% | operator |
| 26311 | Hash Join | 727.14 | 787.83 | 8.3% | operator |
| 26312 | Seq Scan | 510.65 | 263.97 | 48.3% | operator |
| 26313 | Hash | 17.23 | 80.15 | 365.0% | operator |
...
### Step 2: Node 26312 (Seq Scan) - LEAF
