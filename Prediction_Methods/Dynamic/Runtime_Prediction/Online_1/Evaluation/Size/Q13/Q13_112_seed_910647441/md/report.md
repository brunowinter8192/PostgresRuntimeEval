...
```
Node 25461 (Sort) - ROOT
  Node 25462 (Aggregate)
    Node 25463 (Aggregate)
      Node 25464 (Hash Join)
        Node 25465 (Seq Scan) - LEAF
        Node 25466 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 25461 | Sort | 929.94 | 1081.93 | 16.3% | operator |
| 25462 | Aggregate | 929.93 | 1000.33 | 7.6% | operator |
| 25463 | Aggregate | 923.83 | 1014.39 | 9.8% | operator |
| 25464 | Hash Join | 713.59 | 787.83 | 10.4% | operator |
| 25465 | Seq Scan | 504.02 | 264.19 | 47.6% | operator |
| 25466 | Hash | 15.61 | 80.15 | 413.3% | operator |
...
### Step 2: Node 25465 (Seq Scan) - LEAF
