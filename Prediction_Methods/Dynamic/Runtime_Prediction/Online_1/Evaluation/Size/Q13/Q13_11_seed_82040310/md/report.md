...
```
Node 25517 (Sort) - ROOT
  Node 25518 (Aggregate)
    Node 25519 (Aggregate)
      Node 25520 (Hash Join)
        Node 25521 (Seq Scan) - LEAF
        Node 25522 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 25517 | Sort | 923.07 | 1081.93 | 17.2% | operator |
| 25518 | Aggregate | 923.04 | 1000.34 | 8.4% | operator |
| 25519 | Aggregate | 917.02 | 1014.18 | 10.6% | operator |
| 25520 | Hash Join | 711.27 | 787.83 | 10.8% | operator |
| 25521 | Seq Scan | 495.37 | 264.12 | 46.7% | operator |
| 25522 | Hash | 14.70 | 80.15 | 445.2% | operator |
...
### Step 2: Node 25521 (Seq Scan) - LEAF
