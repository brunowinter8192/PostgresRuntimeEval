...
```
Node 25566 (Sort) - ROOT
  Node 25567 (Aggregate)
    Node 25568 (Aggregate)
      Node 25569 (Hash Join)
        Node 25570 (Seq Scan) - LEAF
        Node 25571 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 25566 | Sort | 911.23 | 1081.93 | 18.7% | operator |
| 25567 | Aggregate | 911.21 | 1000.37 | 9.8% | operator |
| 25568 | Aggregate | 905.04 | 1013.56 | 12.0% | operator |
| 25569 | Hash Join | 687.96 | 787.83 | 14.5% | operator |
| 25570 | Seq Scan | 468.38 | 263.89 | 43.7% | operator |
| 25571 | Hash | 15.97 | 80.15 | 401.8% | operator |
...
### Step 2: Node 25570 (Seq Scan) - LEAF
