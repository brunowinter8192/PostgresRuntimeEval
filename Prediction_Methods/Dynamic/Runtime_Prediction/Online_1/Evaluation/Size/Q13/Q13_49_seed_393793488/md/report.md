...
```
Node 26021 (Sort) - ROOT
  Node 26022 (Aggregate)
    Node 26023 (Aggregate)
      Node 26024 (Hash Join)
        Node 26025 (Seq Scan) - LEAF
        Node 26026 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 26021 | Sort | 922.94 | 1081.93 | 17.2% | operator |
| 26022 | Aggregate | 922.92 | 1000.36 | 8.4% | operator |
| 26023 | Aggregate | 917.08 | 1013.77 | 10.5% | operator |
| 26024 | Hash Join | 708.81 | 787.83 | 11.1% | operator |
| 26025 | Seq Scan | 501.12 | 263.97 | 47.3% | operator |
| 26026 | Hash | 14.34 | 80.15 | 459.0% | operator |
...
### Step 2: Node 26025 (Seq Scan) - LEAF
