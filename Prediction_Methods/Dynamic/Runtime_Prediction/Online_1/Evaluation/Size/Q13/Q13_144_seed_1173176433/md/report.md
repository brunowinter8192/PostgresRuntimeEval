...
```
Node 25706 (Sort) - ROOT
  Node 25707 (Aggregate)
    Node 25708 (Aggregate)
      Node 25709 (Hash Join)
        Node 25710 (Seq Scan) - LEAF
        Node 25711 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 25706 | Sort | 910.04 | 1081.93 | 18.9% | operator |
| 25707 | Aggregate | 910.02 | 1000.33 | 9.9% | operator |
| 25708 | Aggregate | 904.00 | 1014.39 | 12.2% | operator |
| 25709 | Hash Join | 686.68 | 787.83 | 14.7% | operator |
| 25710 | Seq Scan | 468.42 | 264.19 | 43.6% | operator |
| 25711 | Hash | 15.20 | 80.15 | 427.3% | operator |
...
### Step 2: Node 25710 (Seq Scan) - LEAF
