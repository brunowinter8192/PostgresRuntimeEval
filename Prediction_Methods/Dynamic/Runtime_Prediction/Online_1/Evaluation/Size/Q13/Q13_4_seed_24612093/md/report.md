...
```
Node 26028 (Sort) - ROOT
  Node 26029 (Aggregate)
    Node 26030 (Aggregate)
      Node 26031 (Hash Join)
        Node 26032 (Seq Scan) - LEAF
        Node 26033 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 26028 | Sort | 911.44 | 1081.93 | 18.7% | operator |
| 26029 | Aggregate | 911.42 | 1000.36 | 9.8% | operator |
| 26030 | Aggregate | 905.50 | 1013.77 | 12.0% | operator |
| 26031 | Hash Join | 701.64 | 787.83 | 12.3% | operator |
| 26032 | Seq Scan | 499.87 | 263.97 | 47.2% | operator |
| 26033 | Hash | 14.71 | 80.15 | 444.7% | operator |
...
### Step 2: Node 26032 (Seq Scan) - LEAF
