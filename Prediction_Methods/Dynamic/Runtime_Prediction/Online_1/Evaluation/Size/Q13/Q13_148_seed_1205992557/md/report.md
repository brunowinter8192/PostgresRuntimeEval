...
```
Node 25734 (Sort) - ROOT
  Node 25735 (Aggregate)
    Node 25736 (Aggregate)
      Node 25737 (Hash Join)
        Node 25738 (Seq Scan) - LEAF
        Node 25739 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 25734 | Sort | 932.11 | 1081.93 | 16.1% | operator |
| 25735 | Aggregate | 932.09 | 1000.33 | 7.3% | operator |
| 25736 | Aggregate | 925.95 | 1014.39 | 9.6% | operator |
| 25737 | Hash Join | 711.46 | 787.83 | 10.7% | operator |
| 25738 | Seq Scan | 499.98 | 264.19 | 47.2% | operator |
| 25739 | Hash | 15.36 | 80.15 | 421.9% | operator |
...
### Step 2: Node 25738 (Seq Scan) - LEAF
