...
```
Node 25692 (Sort) - ROOT
  Node 25693 (Aggregate)
    Node 25694 (Aggregate)
      Node 25695 (Hash Join)
        Node 25696 (Seq Scan) - LEAF
        Node 25697 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 25692 | Sort | 945.14 | 1081.93 | 14.5% | operator |
| 25693 | Aggregate | 945.12 | 1000.34 | 5.8% | operator |
| 25694 | Aggregate | 939.02 | 1014.18 | 8.0% | operator |
| 25695 | Hash Join | 734.69 | 787.83 | 7.2% | operator |
| 25696 | Seq Scan | 530.62 | 264.12 | 50.2% | operator |
| 25697 | Hash | 15.80 | 80.15 | 407.3% | operator |
...
### Step 2: Node 25696 (Seq Scan) - LEAF
