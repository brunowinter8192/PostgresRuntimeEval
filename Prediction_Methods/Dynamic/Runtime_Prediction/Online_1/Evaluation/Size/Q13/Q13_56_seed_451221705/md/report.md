...
```
Node 26077 (Sort) - ROOT
  Node 26078 (Aggregate)
    Node 26079 (Aggregate)
      Node 26080 (Hash Join)
        Node 26081 (Seq Scan) - LEAF
        Node 26082 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 26077 | Sort | 910.45 | 1081.93 | 18.8% | operator |
| 26078 | Aggregate | 910.42 | 1000.34 | 9.9% | operator |
| 26079 | Aggregate | 904.41 | 1014.18 | 12.1% | operator |
| 26080 | Hash Join | 693.01 | 787.83 | 13.7% | operator |
| 26081 | Seq Scan | 482.20 | 264.12 | 45.2% | operator |
| 26082 | Hash | 15.24 | 80.15 | 425.8% | operator |
...
### Step 2: Node 26081 (Seq Scan) - LEAF
