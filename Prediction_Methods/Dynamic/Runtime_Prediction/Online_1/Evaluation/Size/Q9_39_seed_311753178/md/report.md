    ...
    Node 18139 (Gather)
      Node 18140 (Aggregate)
        Node 18141 (Nested Loop)
          Node 18142 (Hash Join) [PATTERN: bb930825]
            Node 18143 (Seq Scan) [consumed] - LEAF
            Node 18144 (Hash) [consumed]
              Node 18145 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18142 | 18137, 18138, 18143, 18144, 18145 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18137 | 18138, 18142, 18143, 18144, 18145 |
...
|------|------|--------|-----------|-----|--------|
| 18137 | Sort | 1185.09 | 1049.52 | 11.4% | pattern |
| 18139 | Gather | 1183.86 | 941.00 | 20.5% | operator |
| 18140 | Aggregate | 1163.14 | 1141.96 | 1.8% | operator |
| 18141 | Nested Loop | 1139.27 | 1252.17 | 9.9% | operator |
| 18142 | Hash Join | 965.31 | 134.80 | 86.0% | pattern |
| 18154 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18146 | Hash Join | 153.30 | 837.31 | 446.2% | operator |
| 18152 | Hash | 14.50 | 14.95 | 3.1% | operator |
| 18147 | Nested Loop | 147.93 | 1251.76 | 746.2% | operator |
| 18150 | Hash | 3.08 | 15.94 | 416.7% | operator |
| 18153 | Seq Scan | 14.48 | 2.94 | 79.7% | operator |
| 18148 | Seq Scan | 19.64 | 44.65 | 127.3% | operator |
| 18149 | Index Scan | 0.07 | -1.39 | 2055.5% | operator |
| 18151 | Seq Scan | 2.58 | 9.45 | 266.8% | operator |
...
### Step 9: Node 18142 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18137, 18138, 18143, 18144, 18145
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18154 (Index Scan) - LEAF
...
### Step 11: Node 18141 (Nested Loop)
...
### Step 14: Node 18137 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18138, 18142, 18143, 18144, 18145
- **Input Features:**
