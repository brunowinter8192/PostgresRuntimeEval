...
**Test Query:** Q18_77_seed_623506356
...
```
Node 30804 (Limit) - ROOT
  Node 30805 (Sort)
    Node 30806 (Aggregate)
      Node 30807 (Gather Merge)
        Node 30808 (Incremental Sort)
          Node 30809 (Nested Loop)
            Node 30810 (Merge Join)
              Node 30811 (Sort)
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30812 | 30813, 30814 |
...
|------|------|--------|-----------|-----|--------|
| 30804 | Limit | 3052.51 | 1175.21 | 61.5% | operator |
| 30805 | Sort | 2934.80 | 1127.81 | 61.6% | operator |
| 30806 | Aggregate | 2934.76 | 1073.15 | 63.4% | operator |
| 30807 | Gather Merge | 2934.74 | 1073.95 | 63.4% | operator |
| 30808 | Incremental Sort | 2912.94 | 0.00 | 100.0% | operator |
| 30809 | Nested Loop | 2912.89 | 1111.34 | 61.8% | operator |
| 30810 | Merge Join | 2912.81 | 0.00 | 100.0% | operator |
| 30819 | Index Scan | 0.02 | 0.05 | 88.1% | operator |
| 30811 | Sort | 2845.19 | 1095.58 | 61.5% | operator |
| 30817 | Sort | 64.57 | 1074.66 | 1564.2% | operator |
| 30812 | Hash Join | 2845.18 | 471.07 | 83.4% | pattern |
| 30818 | Seq Scan | 52.50 | 18.25 | 65.2% | operator |
| 30815 | Aggregate | 2614.41 | 1073.15 | 59.0% | operator |
| 30816 | Index Scan | 2122.69 | 0.00 | 100.0% | operator |
...
### Step 4: Node 30818 (Seq Scan) - LEAF
...
### Step 7: Node 30810 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30819 (Index Scan) - LEAF
...
### Step 10: Node 30808 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30807 (Gather Merge)
