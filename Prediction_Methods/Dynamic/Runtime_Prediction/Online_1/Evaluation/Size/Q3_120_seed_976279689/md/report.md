...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4571 | 4572, 4573, 4574 |
...
| 4575 | Nested Loop | 1142.91 | 1193.01 | 4.4% | operator |
| 4576 | Hash Join | 206.22 | 231.10 | 12.1% | operator |
| 4580 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4577 | Seq Scan | 154.49 | 163.51 | 5.8% | operator |
| 4578 | Hash | 28.74 | 17.75 | 38.2% | operator |
...
### Step 2: Node 4577 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37342.3600
- **Output:** st=27.28, rt=231.10

### Step 5: Node 4580 (Index Scan) - LEAF
...
- **Output:** st=121.72, rt=1193.01

### Step 7: Node 4571 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4572, 4573, 4574
- **Input Features:**
