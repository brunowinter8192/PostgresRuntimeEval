...
**Test Query:** Q3_120_seed_976279689
...
```
Node 4571 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 4572 (Sort) [consumed]
    Node 4573 (Aggregate) [consumed]
      Node 4574 (Gather) [consumed]
        Node 4575 (Nested Loop)
          Node 4576 (Hash Join) [PATTERN: 895c6e8c]
            Node 4577 (Seq Scan) [consumed] - LEAF
            Node 4578 (Hash) [consumed]
              Node 4579 (Seq Scan) - LEAF
          Node 4580 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4571 | 4572, 4573, 4574, 4576, 4577, 4578 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4576 | 4571, 4572, 4573, 4574, 4577, 4578 |
...
|------|------|--------|-----------|-----|--------|
| 4571 | Limit | 1177.71 | 1151.18 | 2.3% | pattern |
| 4575 | Nested Loop | 1142.91 | 1193.09 | 4.4% | operator |
| 4576 | Hash Join | 206.22 | 242.48 | 17.6% | pattern |
| 4580 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4579 | Seq Scan | 28.14 | 38.60 | 37.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4579 (Seq Scan) - LEAF
...
### Step 2: Node 4576 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4571, 4572, 4573, 4574, 4577, 4578
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46979
  - HashJoin_nt1=236853
...
- **Output:** st=29.70, rt=242.48

### Step 3: Node 4580 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=72851.2100
- **Output:** st=121.86, rt=1193.09

### Step 5: Node 4571 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4572, 4573, 4574, 4576, 4577, 4578
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=311556
  - Aggregate_Outer_nt1=311556
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=109680.1500
  - Aggregate_Outer_total_cost=113574.6000
  - Gather_Outer_np=0
  - Gather_Outer_nt=311556
  - Gather_Outer_nt1=100502
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105006.8100
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=311556
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=120307.2100
  - Limit_total_cost=120307.2400
  - Sort_Outer_np=0
  - Sort_Outer_nt=311556
  - Sort_Outer_nt1=311556
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=120307.2100
  - Sort_Outer_total_cost=121086.1000
