...
**Test Query:** Q9_77_seed_623506356
...
```
Node 18898 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18899 (Aggregate) [consumed]
    Node 18900 (Gather)
      Node 18901 (Aggregate)
        Node 18902 (Nested Loop)
          Node 18903 (Hash Join) [PATTERN: bb930825]
            Node 18904 (Seq Scan) [consumed] - LEAF
            Node 18905 (Hash) [consumed]
              Node 18906 (Hash Join) [consumed]
                Node 18907 (Hash Join)
                  Node 18908 (Nested Loop)
                    Node 18909 (Seq Scan) - LEAF
                    Node 18910 (Index Scan) - LEAF
                  Node 18911 (Hash)
                    Node 18912 (Seq Scan) - LEAF
                Node 18913 (Hash)
                  Node 18914 (Seq Scan) - LEAF
          Node 18915 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18903 | 18898, 18899, 18904, 18905, 18906 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18898 | 18899, 18903, 18904, 18905, 18906 |
...
|------|------|--------|-----------|-----|--------|
| 18898 | Sort | 1184.81 | 1046.01 | 11.7% | pattern |
| 18900 | Gather | 1183.82 | 955.76 | 19.3% | operator |
| 18901 | Aggregate | 1163.55 | 1141.46 | 1.9% | operator |
| 18902 | Nested Loop | 1138.54 | 1252.17 | 10.0% | operator |
| 18903 | Hash Join | 958.52 | 134.80 | 85.9% | pattern |
| 18915 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18907 | Hash Join | 162.31 | 837.43 | 416.0% | operator |
| 18913 | Hash | 13.14 | 14.95 | 13.8% | operator |
| 18908 | Nested Loop | 155.92 | 1251.76 | 702.8% | operator |
| 18911 | Hash | 3.90 | 15.94 | 309.3% | operator |
| 18914 | Seq Scan | 13.12 | 2.94 | 77.6% | operator |
| 18909 | Seq Scan | 19.21 | 44.44 | 131.3% | operator |
| 18910 | Index Scan | 0.07 | -1.39 | 1976.3% | operator |
| 18912 | Seq Scan | 3.22 | 9.45 | 193.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 18909 (Seq Scan) - LEAF
...
### Step 2: Node 18910 (Index Scan) - LEAF
...
### Step 3: Node 18912 (Seq Scan) - LEAF
...
### Step 6: Node 18914 (Seq Scan) - LEAF
...
### Step 9: Node 18903 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18898, 18899, 18904, 18905, 18906
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18915 (Index Scan) - LEAF
...
### Step 11: Node 18902 (Nested Loop)
...
### Step 14: Node 18898 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18899, 18903, 18904, 18905, 18906
- **Input Features:**
