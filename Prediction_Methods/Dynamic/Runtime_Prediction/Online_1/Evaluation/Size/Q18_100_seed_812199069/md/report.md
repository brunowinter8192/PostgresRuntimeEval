        ...
        Node 28824 (Incremental Sort)
          Node 28825 (Nested Loop)
            Node 28826 (Merge Join)
              Node 28827 (Sort)
                Node 28828 (Hash Join) [PATTERN: 895c6e8c]
                  Node 28829 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 28828 | 28829, 28830 |
...
| 28827 | Sort | 2816.49 | 1095.58 | 61.1% | operator |
| 28833 | Sort | 71.66 | 1074.66 | 1399.6% | operator |
| 28828 | Hash Join | 2816.48 | 471.07 | 83.3% | pattern |
...
### Step 3: Node 28828 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 28829, 28830
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 28834 (Seq Scan) - LEAF
...
### Step 7: Node 28826 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 28835 (Index Scan) - LEAF
...
### Step 10: Node 28824 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 28823 (Gather Merge)
