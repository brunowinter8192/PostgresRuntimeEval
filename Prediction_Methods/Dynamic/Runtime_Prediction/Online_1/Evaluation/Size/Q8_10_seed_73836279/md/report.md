...
```
Node 13431 (Aggregate) - ROOT
  Node 13432 (Gather Merge)
    Node 13433 (Sort)
          ...
          Node 13436 (Hash Join)
            Node 13437 (Nested Loop)
              Node 13438 (Hash Join)
                ...
                Node 13440 (Hash)
                  Node 13441 (Hash Join)
                    Node 13442 (Seq Scan) - LEAF
                    Node 13443 (Hash)
                      Node 13444 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 13431 | Aggregate | 1202.17 | 1194.14 | 0.7% | operator |
| 13432 | Gather Merge | 1201.72 | 1097.16 | 8.7% | operator |
...
| 13438 | Hash Join | 207.72 | 251.17 | 20.9% | operator |
...
| 13440 | Hash | 34.95 | 20.62 | 41.0% | operator |
| 13441 | Hash Join | 34.26 | 132.26 | 286.0% | operator |
| 13442 | Seq Scan | 32.80 | 23.03 | 29.8% | operator |
| 13443 | Hash | 0.16 | 23.66 | 14502.5% | operator |
| 13444 | Hash Join | 0.16 | 306.84 | 191672.5% | operator |
...
### Step 5: Node 13442 (Seq Scan) - LEAF
...
### Step 8: Node 13439 (Seq Scan) - LEAF
...
### Step 11: Node 13448 (Index Scan) - LEAF
...
### Step 12: Node 13450 (Seq Scan) - LEAF
...
### Step 13: Node 13437 (Nested Loop)
...
### Step 16: Node 13451 (Index Scan) - LEAF
...
### Step 17: Node 13453 (Seq Scan) - LEAF
...
### Step 18: Node 13435 (Nested Loop)
...
### Step 22: Node 13432 (Gather Merge)
...
### Step 23: Node 13431 (Aggregate) - ROOT
