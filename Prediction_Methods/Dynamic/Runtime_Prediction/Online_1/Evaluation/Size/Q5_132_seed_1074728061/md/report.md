...
**Test Query:** Q5_132_seed_1074728061
...
```
Node 7601 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 7602 (Aggregate) [consumed]
    Node 7603 (Gather Merge) [consumed]
      Node 7604 (Aggregate)
        Node 7605 (Sort) [PATTERN: 3e2d5a00]
          Node 7606 (Hash Join) [consumed]
            Node 7607 (Nested Loop)
              Node 7608 (Hash Join)
                Node 7609 (Seq Scan) - LEAF
                Node 7610 (Hash) [PATTERN: 444761fb]
                  Node 7611 (Hash Join) [consumed]
                    Node 7612 (Seq Scan) [consumed] - LEAF
                    Node 7613 (Hash) [consumed]
                      Node 7614 (Hash Join) [consumed]
                        Node 7615 (Seq Scan) - LEAF
                        Node 7616 (Hash)
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 7610 | 7601, 7602, 7603, 7605, 7606, 7611, 7612, 7613, 7614 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 7601 | 7602, 7603, 7605, 7606, 7610, 7611, 7612, 7613, 7614 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 7605 | 7601, 7602, 7603, 7606, 7610, 7611, 7612, 7613, 7614 |
...
|------|------|--------|-----------|-----|--------|
| 7601 | Sort | 1081.10 | 2934.42 | 171.4% | pattern |
| 7604 | Aggregate | 1075.52 | 1128.78 | 5.0% | operator |
| 7605 | Sort | 1075.26 | 1835.92 | 70.7% | pattern |
| 7607 | Nested Loop | 1063.64 | 1188.42 | 11.7% | operator |
| 7619 | Hash | 2.70 | 18.67 | 592.6% | operator |
| 7608 | Hash Join | 222.68 | 253.07 | 13.6% | operator |
| 7618 | Index Scan | 0.07 | -0.22 | 401.4% | operator |
| 7620 | Seq Scan | 2.14 | 12.36 | 478.6% | operator |
| 7609 | Seq Scan | 170.55 | 159.81 | 6.3% | operator |
| 7610 | Hash | 38.05 | 46.85 | 23.1% | pattern |
| 7615 | Seq Scan | 0.02 | 11.81 | 65501.5% | operator |
| 7616 | Hash | 0.15 | 21.05 | 13660.3% | operator |
| 7617 | Seq Scan | 0.15 | 22.93 | 15188.9% | operator |
...
### Step 2: Node 7615 (Seq Scan) - LEAF
...
### Step 4: Node 7609 (Seq Scan) - LEAF
...
### Step 5: Node 7610 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 7601, 7602, 7603, 7605, 7606, 7611, 7612, 7613, 7614
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 7618 (Index Scan) - LEAF
...
### Step 8: Node 7620 (Seq Scan) - LEAF
...
### Step 11: Node 7605 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 7601, 7602, 7603, 7606, 7610, 7611, 7612, 7613, 7614
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 7601 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 7602, 7603, 7605, 7606, 7610, 7611, 7612, 7613, 7614
- **Input Features:**
