...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20462 | 20463, 20464, 20465, 20467, 20468, 20471 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 20467 | 20462, 20463, 20464, 20465, 20468, 20471 |
...
|------|------|--------|-----------|-----|--------|
| 20462 | Limit | 1128.17 | 1199.47 | 6.3% | pattern |
| 20466 | Hash Join | 1077.73 | 1095.59 | 1.7% | operator |
| 20467 | Hash Join | 1074.79 | 1120.19 | 4.2% | pattern |
| 20473 | Hash | 0.02 | 15.71 | 82588.3% | operator |
| 20474 | Seq Scan | 0.01 | 6.98 | 58055.9% | operator |
| 20469 | Seq Scan | 160.20 | 159.74 | 0.3% | operator |
| 20470 | Index Scan | 0.06 | -0.52 | 963.7% | operator |
| 20472 | Seq Scan | 26.82 | 26.64 | 0.7% | operator |
...
### Step 4: Node 20474 (Seq Scan) - LEAF
...
- **Consumes:** Nodes 20462, 20463, 20464, 20465, 20468, 20471
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18337
  - HashJoin_nt1=18337
...
### Step 8: Node 20462 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20463, 20464, 20465, 20467, 20468, 20471
- **Input Features:**
