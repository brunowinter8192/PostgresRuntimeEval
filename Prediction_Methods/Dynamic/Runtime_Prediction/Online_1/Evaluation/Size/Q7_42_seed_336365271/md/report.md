...
```
Node 12049 (Aggregate) - ROOT
  Node 12050 (Gather Merge)
    Node 12051 (Sort)
      Node 12052 (Hash Join)
        Node 12053 (Nested Loop)
          Node 12054 (Hash Join)
            Node 12055 (Seq Scan) - LEAF
            Node 12056 (Hash)
              Node 12057 (Hash Join)
                Node 12058 (Seq Scan) - LEAF
                Node 12059 (Hash)
                  Node 12060 (Seq Scan) - LEAF
          Node 12061 (Index Scan) - LEAF
        Node 12062 (Hash)
          Node 12063 (Hash Join)
            Node 12064 (Seq Scan) - LEAF
            Node 12065 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 12049 | Aggregate | 1192.48 | 1209.26 | 1.4% | operator |
| 12050 | Gather Merge | 1191.34 | 1142.98 | 4.1% | operator |
| 12051 | Sort | 1184.39 | 1109.13 | 6.4% | operator |
| 12052 | Hash Join | 1183.80 | 842.59 | 28.8% | operator |
| 12053 | Nested Loop | 1176.32 | 1216.16 | 3.4% | operator |
| 12062 | Hash | 3.69 | 17.53 | 374.4% | operator |
| 12054 | Hash Join | 215.19 | 384.47 | 78.7% | operator |
| 12061 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 12063 | Hash Join | 3.65 | 85.17 | 2232.3% | operator |
| 12055 | Seq Scan | 151.79 | 201.16 | 32.5% | operator |
| 12056 | Hash | 37.98 | 19.59 | 48.4% | operator |
| 12064 | Seq Scan | 3.33 | 11.47 | 244.7% | operator |
| 12065 | Hash | 0.02 | 16.89 | 99277.0% | operator |
| 12057 | Hash Join | 37.64 | 92.20 | 145.0% | operator |
| 12066 | Seq Scan | 0.01 | 45.79 | 326988.0% | operator |
| 12058 | Seq Scan | 36.51 | 21.86 | 40.1% | operator |
| 12059 | Hash | 0.01 | 16.89 | 153482.6% | operator |
| 12060 | Seq Scan | 0.01 | 45.79 | 572303.9% | operator |
...
### Step 2: Node 12058 (Seq Scan) - LEAF
...
### Step 5: Node 12066 (Seq Scan) - LEAF
...
### Step 6: Node 12055 (Seq Scan) - LEAF
...
### Step 8: Node 12064 (Seq Scan) - LEAF
...
### Step 11: Node 12061 (Index Scan) - LEAF
...
### Step 13: Node 12053 (Nested Loop)
...
### Step 17: Node 12050 (Gather Merge)
...
### Step 18: Node 12049 (Aggregate) - ROOT
