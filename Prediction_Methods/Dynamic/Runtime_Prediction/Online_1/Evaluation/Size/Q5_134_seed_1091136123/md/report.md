...
**Test Query:** Q5_134_seed_1091136123
...
```
Node 7641 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 7642 (Aggregate) [consumed]
    Node 7643 (Gather Merge) [consumed]
      Node 7644 (Aggregate)
        Node 7645 (Sort) [PATTERN: 3e2d5a00]
          Node 7646 (Hash Join) [consumed]
            Node 7647 (Nested Loop)
              Node 7648 (Hash Join)
                Node 7649 (Seq Scan) - LEAF
                Node 7650 (Hash) [PATTERN: 444761fb]
                  Node 7651 (Hash Join) [consumed]
                    Node 7652 (Seq Scan) [consumed] - LEAF
                    Node 7653 (Hash) [consumed]
                      Node 7654 (Hash Join) [consumed]
                        Node 7655 (Seq Scan) - LEAF
                        Node 7656 (Hash)
                          Node 7657 (Seq Scan) - LEAF
              Node 7658 (Index Scan) - LEAF
            Node 7659 (Hash)
              Node 7660 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 7650 | 7641, 7642, 7643, 7645, 7646, 7651, 7652, 7653, 7654 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 7641 | 7642, 7643, 7645, 7646, 7650, 7651, 7652, 7653, 7654 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 7645 | 7641, 7642, 7643, 7646, 7650, 7651, 7652, 7653, 7654 |
...
|------|------|--------|-----------|-----|--------|
| 7641 | Sort | 1083.32 | 2934.42 | 170.9% | pattern |
| 7644 | Aggregate | 1077.11 | 1128.78 | 4.8% | operator |
| 7645 | Sort | 1076.83 | 1835.92 | 70.5% | pattern |
| 7647 | Nested Loop | 1062.38 | 1188.42 | 11.9% | operator |
| 7659 | Hash | 4.75 | 18.67 | 293.3% | operator |
| 7648 | Hash Join | 217.84 | 253.07 | 16.2% | operator |
| 7658 | Index Scan | 0.07 | -0.22 | 397.3% | operator |
| 7660 | Seq Scan | 4.20 | 12.36 | 194.3% | operator |
| 7649 | Seq Scan | 168.21 | 159.81 | 5.0% | operator |
| 7650 | Hash | 36.88 | 46.85 | 27.0% | pattern |
| 7655 | Seq Scan | 0.01 | 11.81 | 117982.7% | operator |
| 7656 | Hash | 0.05 | 21.05 | 42006.5% | operator |
| 7657 | Seq Scan | 0.05 | 22.93 | 48694.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 7657 (Seq Scan) - LEAF
...
### Step 2: Node 7655 (Seq Scan) - LEAF
...
### Step 4: Node 7649 (Seq Scan) - LEAF
...
### Step 5: Node 7650 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 7641, 7642, 7643, 7645, 7646, 7651, 7652, 7653, 7654
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 7658 (Index Scan) - LEAF
...
### Step 8: Node 7660 (Seq Scan) - LEAF
...
### Step 11: Node 7645 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 7641, 7642, 7643, 7646, 7650, 7651, 7652, 7653, 7654
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 7641 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 7642, 7643, 7645, 7646, 7650, 7651, 7652, 7653, 7654
- **Input Features:**
