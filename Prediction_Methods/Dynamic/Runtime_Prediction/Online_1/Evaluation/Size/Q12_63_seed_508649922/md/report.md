...
**Test Query:** Q12_63_seed_508649922
...
```
Node 25083 (Aggregate) - ROOT
  Node 25084 (Gather Merge)
    Node 25085 (Aggregate)
      Node 25086 (Sort)
        Node 25087 (Nested Loop)
          Node 25088 (Seq Scan) - LEAF
          Node 25089 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 25083 | Aggregate | 1007.14 | 919.04 | 8.7% | operator |
| 25084 | Gather Merge | 1007.11 | 1111.84 | 10.4% | operator |
| 25085 | Aggregate | 985.25 | 895.29 | 9.1% | operator |
| 25086 | Sort | 984.65 | 1092.83 | 11.0% | operator |
| 25087 | Nested Loop | 983.65 | 1127.42 | 14.6% | operator |
| 25088 | Seq Scan | 831.69 | 745.20 | 10.4% | operator |
| 25089 | Index Scan | 0.03 | 0.07 | 147.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25088 (Seq Scan) - LEAF
...
### Step 2: Node 25089 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - st2=0.1246
  - startup_cost=0.4300
  - total_cost=147217.2300
- **Output:** st=38.32, rt=1127.42

### Step 4: Node 25086 (Sort)
...
- **Input Features:**
  ...
  - st1=38.3198
  - st2=0.0000
  - startup_cost=147581.4600
  - total_cost=147596.0200
- **Output:** st=1092.42, rt=1092.83

### Step 5: Node 25085 (Aggregate)
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=147581.4600
  - total_cost=147698.0100
- **Output:** st=868.92, rt=895.29

### Step 6: Node 25084 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=868.9231
  - st2=0.0000
  - startup_cost=148581.5400
  - total_cost=148702.3000
- **Output:** st=1109.22, rt=1111.84

### Step 7: Node 25083 (Aggregate) - ROOT
