...
**Test Query:** Q13_120_seed_976279689
...
```
Node 25524 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25525 (Aggregate) [consumed]
    Node 25526 (Aggregate)
      Node 25527 (Hash Join) [PATTERN: 895c6e8c]
        Node 25528 (Seq Scan) [consumed] - LEAF
        Node 25529 (Hash) [consumed]
          Node 25530 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25524 | 25525, 25527, 25528, 25529 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25527 | 25524, 25525, 25528, 25529 |
...
|------|------|--------|-----------|-----|--------|
| 25524 | Sort | 901.41 | 1079.94 | 19.8% | pattern |
| 25526 | Aggregate | 895.36 | 999.76 | 11.7% | operator |
| 25527 | Hash Join | 683.21 | 470.31 | 31.2% | pattern |
| 25530 | Index Only Scan | 10.10 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25530 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25527 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25524, 25525, 25528, 25529
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 25524 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25525, 25527, 25528, 25529
- **Input Features:**
