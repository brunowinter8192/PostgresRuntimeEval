...
```
Node 17502 (Sort) - ROOT
  Node 17503 (Aggregate)
    Node 17504 (Gather)
      Node 17505 (Aggregate)
        Node 17506 (Nested Loop)
          Node 17507 (Hash Join)
            Node 17508 (Seq Scan) - LEAF
            Node 17509 (Hash)
              Node 17510 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 17502 | Sort | 1173.76 | 1119.21 | 4.6% | operator |
| 17503 | Aggregate | 1173.61 | 897.16 | 23.6% | operator |
...
| 17507 | Hash Join | 957.79 | 633.14 | 33.9% | operator |
| 17519 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17508 | Seq Scan | 681.40 | 509.93 | 25.2% | operator |
| 17509 | Hash | 180.26 | 47.79 | 73.5% | operator |
| 17510 | Hash Join | 178.54 | 924.37 | 417.7% | operator |
...
### Step 10: Node 17508 (Seq Scan) - LEAF
...
### Step 13: Node 17519 (Index Scan) - LEAF
...
### Step 14: Node 17506 (Nested Loop)
