...
**Test Query:** Q9_143_seed_1164972402
...
```
Node 17502 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 17503 (Aggregate) [consumed]
    Node 17504 (Gather)
      Node 17505 (Aggregate)
        Node 17506 (Nested Loop)
          Node 17507 (Hash Join) [PATTERN: bb930825]
            Node 17508 (Seq Scan) [consumed] - LEAF
            Node 17509 (Hash) [consumed]
              Node 17510 (Hash Join) [consumed]
                Node 17511 (Hash Join)
                  Node 17512 (Nested Loop)
                    Node 17513 (Seq Scan) - LEAF
                    Node 17514 (Index Scan) - LEAF
                  Node 17515 (Hash)
                    Node 17516 (Seq Scan) - LEAF
                Node 17517 (Hash)
                  Node 17518 (Seq Scan) - LEAF
          Node 17519 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17507 | 17502, 17503, 17508, 17509, 17510 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17502 | 17503, 17507, 17508, 17509, 17510 |
...
|------|------|--------|-----------|-----|--------|
| 17502 | Sort | 1173.76 | 1045.06 | 11.0% | pattern |
| 17504 | Gather | 1172.57 | 964.74 | 17.7% | operator |
| 17505 | Aggregate | 1152.59 | 1106.30 | 4.0% | operator |
| 17506 | Nested Loop | 1127.50 | 1252.17 | 11.1% | operator |
| 17507 | Hash Join | 957.79 | 134.80 | 85.9% | pattern |
| 17519 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17511 | Hash Join | 164.01 | 837.58 | 410.7% | operator |
| 17517 | Hash | 13.89 | 14.95 | 7.6% | operator |
| 17512 | Nested Loop | 157.09 | 1251.77 | 696.9% | operator |
| 17515 | Hash | 4.74 | 15.94 | 236.7% | operator |
| 17518 | Seq Scan | 13.88 | 2.94 | 78.8% | operator |
| 17513 | Seq Scan | 19.13 | 44.10 | 130.5% | operator |
| 17514 | Index Scan | 0.07 | -1.39 | 1951.3% | operator |
| 17516 | Seq Scan | 4.18 | 9.45 | 126.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 17513 (Seq Scan) - LEAF
...
### Step 2: Node 17514 (Index Scan) - LEAF
...
### Step 3: Node 17516 (Seq Scan) - LEAF
...
### Step 6: Node 17518 (Seq Scan) - LEAF
...
### Step 9: Node 17507 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17502, 17503, 17508, 17509, 17510
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17519 (Index Scan) - LEAF
...
### Step 11: Node 17506 (Nested Loop)
...
### Step 14: Node 17502 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17503, 17507, 17508, 17509, 17510
- **Input Features:**
