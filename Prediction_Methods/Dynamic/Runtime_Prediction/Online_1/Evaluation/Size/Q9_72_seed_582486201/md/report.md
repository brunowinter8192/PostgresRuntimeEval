    ...
    Node 18808 (Gather)
      Node 18809 (Aggregate)
        Node 18810 (Hash Join)
          ...
          Node 18812 (Hash) [PATTERN: 444761fb]
            Node 18813 (Hash Join) [consumed]
              Node 18814 (Seq Scan) [consumed] - LEAF
              Node 18815 (Hash) [consumed]
                Node 18816 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 18812 | 18806, 18807, 18813, 18814, 18815, 18816 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18806 | 18807, 18812, 18813, 18814, 18815, 18816 |
...
|------|------|--------|-----------|-----|--------|
| 18806 | Sort | 1275.83 | 1063.07 | 16.7% | pattern |
| 18808 | Gather | 1274.16 | 962.15 | 24.5% | operator |
| 18809 | Aggregate | 1255.76 | 926.41 | 26.2% | operator |
| 18810 | Hash Join | 1226.81 | 569.97 | 53.5% | operator |
| 18811 | Seq Scan | 125.88 | 193.40 | 53.6% | operator |
| 18812 | Hash | 1037.25 | 35.69 | 96.6% | pattern |
| 18817 | Hash Join | 188.62 | 837.71 | 344.1% | operator |
| 18823 | Hash | 17.54 | 14.95 | 14.8% | operator |
| 18818 | Nested Loop | 183.03 | 1251.77 | 583.9% | operator |
| 18821 | Hash | 2.83 | 15.94 | 463.1% | operator |
| 18824 | Seq Scan | 17.53 | 2.94 | 83.2% | operator |
| 18819 | Seq Scan | 27.11 | 43.76 | 61.4% | operator |
| 18820 | Index Scan | 0.06 | -1.39 | 2536.0% | operator |
| 18822 | Seq Scan | 2.36 | 9.45 | 300.6% | operator |
...
### Step 9: Node 18811 (Seq Scan) - LEAF
...
### Step 10: Node 18812 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 18806, 18807, 18813, 18814, 18815, 18816
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 14: Node 18806 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18807, 18812, 18813, 18814, 18815, 18816
- **Input Features:**
