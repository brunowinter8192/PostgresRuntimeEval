...
```
Node 26728 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26729 (Gather) [consumed]
    Node 26730 (Aggregate) [consumed]
      Node 26731 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26728 | 26729, 26730, 26731 |
...
|------|------|--------|-----------|-----|--------|
| 26728 | Aggregate | 827.04 | 857.12 | 3.6% | pattern |
...
### Step 4: Node 26728 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26729, 26730, 26731
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=14822
  - HashJoin_Outer_nt1=14822
  ...
  - HashJoin_Outer_total_cost=136645.5500
