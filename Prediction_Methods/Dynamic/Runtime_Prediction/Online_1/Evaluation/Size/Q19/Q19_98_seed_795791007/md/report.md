...
```
Node 32249 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 32250 (Gather) [consumed]
    Node 32251 (Aggregate) [consumed]
      Node 32252 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 32249 | 32250, 32251 |
...
|------|------|--------|-----------|-----|--------|
| 32249 | Aggregate | 856.53 | 831.20 | 3.0% | pattern |
| 32252 | Hash Join | 835.84 | 766.05 | 8.3% | operator |
...
### Step 5: Node 32249 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 32250, 32251
- **Input Features:**
