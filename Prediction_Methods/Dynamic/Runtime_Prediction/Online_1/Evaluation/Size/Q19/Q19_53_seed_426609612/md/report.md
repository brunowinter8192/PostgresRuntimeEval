...
```
Node 31906 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31907 (Gather) [consumed]
    Node 31908 (Aggregate) [consumed]
      Node 31909 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31906 | 31907, 31908 |
...
|------|------|--------|-----------|-----|--------|
| 31906 | Aggregate | 873.91 | 831.20 | 4.9% | pattern |
| 31909 | Hash Join | 853.24 | 766.06 | 10.2% | operator |
...
### Step 5: Node 31906 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31907, 31908
- **Input Features:**
