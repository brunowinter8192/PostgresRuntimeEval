...
```
Node 31598 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31599 (Gather) [consumed]
    Node 31600 (Aggregate) [consumed]
      Node 31601 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31598 | 31599, 31600 |
...
|------|------|--------|-----------|-----|--------|
| 31598 | Aggregate | 809.69 | 831.20 | 2.7% | pattern |
| 31601 | Hash Join | 789.72 | 766.06 | 3.0% | operator |
...
### Step 5: Node 31598 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31599, 31600
- **Input Features:**
