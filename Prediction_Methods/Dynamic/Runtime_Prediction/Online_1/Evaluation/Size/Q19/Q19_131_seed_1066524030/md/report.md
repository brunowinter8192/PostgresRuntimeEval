...
```
Node 31458 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31459 (Gather) [consumed]
    Node 31460 (Aggregate) [consumed]
      Node 31461 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31458 | 31459, 31460 |
...
|------|------|--------|-----------|-----|--------|
| 31458 | Aggregate | 850.21 | 831.20 | 2.2% | pattern |
| 31461 | Hash Join | 832.33 | 766.06 | 8.0% | operator |
...
- **Input Features:**
  ...
  - total_cost=156338.7500
- **Output:** st=60.26, rt=766.06

### Step 5: Node 31458 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31459, 31460
- **Input Features:**
