...
```
Node 32172 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 32173 (Gather) [consumed]
    Node 32174 (Aggregate) [consumed]
      Node 32175 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 32172 | 32173, 32174 |
...
|------|------|--------|-----------|-----|--------|
| 32172 | Aggregate | 880.35 | 831.20 | 5.6% | pattern |
| 32175 | Hash Join | 859.92 | 766.06 | 10.9% | operator |
...
### Step 5: Node 32172 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 32173, 32174
- **Input Features:**
