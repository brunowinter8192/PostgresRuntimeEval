...
```
Node 31892 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31893 (Gather) [consumed]
    Node 31894 (Aggregate) [consumed]
      Node 31895 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31892 | 31893, 31894 |
...
|------|------|--------|-----------|-----|--------|
| 31892 | Aggregate | 834.84 | 831.20 | 0.4% | pattern |
| 31895 | Hash Join | 813.02 | 766.06 | 5.8% | operator |
...
### Step 5: Node 31892 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31893, 31894
- **Input Features:**
