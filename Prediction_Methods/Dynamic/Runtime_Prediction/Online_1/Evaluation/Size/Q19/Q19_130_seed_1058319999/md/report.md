...
```
Node 31451 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31452 (Gather) [consumed]
    Node 31453 (Aggregate) [consumed]
      Node 31454 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31451 | 31452, 31453 |
...
|------|------|--------|-----------|-----|--------|
| 31451 | Aggregate | 806.11 | 831.20 | 3.1% | pattern |
| 31454 | Hash Join | 787.42 | 766.06 | 2.7% | operator |
...
### Step 5: Node 31451 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31452, 31453
- **Input Features:**
