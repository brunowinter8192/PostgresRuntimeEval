...
```
Node 32025 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 32026 (Gather) [consumed]
    Node 32027 (Aggregate) [consumed]
      Node 32028 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 32025 | 32026, 32027 |
...
|------|------|--------|-----------|-----|--------|
| 32025 | Aggregate | 872.40 | 831.20 | 4.7% | pattern |
| 32028 | Hash Join | 852.25 | 766.06 | 10.1% | operator |
...
### Step 5: Node 32025 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 32026, 32027
- **Input Features:**
