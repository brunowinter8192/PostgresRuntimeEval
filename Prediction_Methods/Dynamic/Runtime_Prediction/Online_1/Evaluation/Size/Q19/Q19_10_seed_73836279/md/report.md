...
```
Node 31290 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31291 (Gather) [consumed]
    Node 31292 (Aggregate) [consumed]
      Node 31293 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31290 | 31291, 31292 |
...
|------|------|--------|-----------|-----|--------|
| 31290 | Aggregate | 818.85 | 831.20 | 1.5% | pattern |
| 31293 | Hash Join | 796.58 | 766.06 | 3.8% | operator |
...
### Step 5: Node 31290 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31291, 31292
- **Input Features:**
