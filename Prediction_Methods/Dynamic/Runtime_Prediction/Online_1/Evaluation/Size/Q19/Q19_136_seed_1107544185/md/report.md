...
```
Node 31493 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31494 (Gather) [consumed]
    Node 31495 (Aggregate) [consumed]
      Node 31496 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31493 | 31494, 31495 |
...
|------|------|--------|-----------|-----|--------|
| 31493 | Aggregate | 864.95 | 831.20 | 3.9% | pattern |
| 31496 | Hash Join | 847.36 | 766.06 | 9.6% | operator |
...
### Step 5: Node 31493 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31494, 31495
- **Input Features:**
