...
**Test Query:** Q19_47_seed_377385426
...
```
Node 31857 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31858 (Gather) [consumed]
    Node 31859 (Aggregate) [consumed]
      Node 31860 (Hash Join)
        Node 31861 (Seq Scan) - LEAF
        Node 31862 (Hash)
          Node 31863 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31857 | 31858, 31859 |
...
|------|------|--------|-----------|-----|--------|
| 31857 | Aggregate | 881.74 | 831.20 | 5.7% | pattern |
| 31860 | Hash Join | 862.26 | 766.05 | 11.2% | operator |
| 31861 | Seq Scan | 812.67 | 743.46 | 8.5% | operator |
| 31862 | Hash | 46.66 | 8.29 | 82.2% | operator |
| 31863 | Seq Scan | 46.52 | 23.76 | 48.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31863 (Seq Scan) - LEAF
...
### Step 2: Node 31861 (Seq Scan) - LEAF
...
### Step 5: Node 31857 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31858, 31859
- **Input Features:**
