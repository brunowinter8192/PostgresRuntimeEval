...
```
Node 31962 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31963 (Gather) [consumed]
    Node 31964 (Aggregate) [consumed]
      Node 31965 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31962 | 31963, 31964 |
...
|------|------|--------|-----------|-----|--------|
| 31962 | Aggregate | 861.55 | 831.20 | 3.5% | pattern |
| 31965 | Hash Join | 839.20 | 766.06 | 8.7% | operator |
...
### Step 5: Node 31962 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31963, 31964
- **Input Features:**
