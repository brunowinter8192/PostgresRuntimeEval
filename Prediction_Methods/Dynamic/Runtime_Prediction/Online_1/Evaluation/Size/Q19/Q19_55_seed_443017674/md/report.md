...
```
Node 31920 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31921 (Gather) [consumed]
    Node 31922 (Aggregate) [consumed]
      Node 31923 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31920 | 31921, 31922 |
...
|------|------|--------|-----------|-----|--------|
| 31920 | Aggregate | 843.91 | 831.20 | 1.5% | pattern |
| 31923 | Hash Join | 825.76 | 766.06 | 7.2% | operator |
...
### Step 5: Node 31920 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31921, 31922
- **Input Features:**
