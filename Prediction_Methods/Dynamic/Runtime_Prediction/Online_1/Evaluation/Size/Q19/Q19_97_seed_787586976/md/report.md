...
```
Node 32242 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 32243 (Gather) [consumed]
    Node 32244 (Aggregate) [consumed]
      Node 32245 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 32242 | 32243, 32244 |
...
|------|------|--------|-----------|-----|--------|
| 32242 | Aggregate | 797.10 | 831.20 | 4.3% | pattern |
| 32245 | Hash Join | 777.28 | 766.06 | 1.4% | operator |
...
### Step 5: Node 32242 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 32243, 32244
- **Input Features:**
