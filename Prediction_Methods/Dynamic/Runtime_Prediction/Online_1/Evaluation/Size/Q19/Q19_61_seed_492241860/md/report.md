...
```
Node 31969 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31970 (Gather) [consumed]
    Node 31971 (Aggregate) [consumed]
      Node 31972 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31969 | 31970, 31971 |
...
|------|------|--------|-----------|-----|--------|
| 31969 | Aggregate | 838.84 | 831.20 | 0.9% | pattern |
| 31972 | Hash Join | 818.43 | 766.06 | 6.4% | operator |
...
### Step 5: Node 31969 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31970, 31971
- **Input Features:**
