...
```
Node 31367 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31368 (Gather) [consumed]
    Node 31369 (Aggregate) [consumed]
      Node 31370 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31367 | 31368, 31369 |
...
|------|------|--------|-----------|-----|--------|
| 31367 | Aggregate | 874.79 | 831.20 | 5.0% | pattern |
| 31370 | Hash Join | 855.20 | 766.05 | 10.4% | operator |
...
- **Input Features:**
  ...
  - total_cost=156338.4800
- **Output:** st=60.26, rt=766.05

### Step 5: Node 31367 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31368, 31369
- **Input Features:**
