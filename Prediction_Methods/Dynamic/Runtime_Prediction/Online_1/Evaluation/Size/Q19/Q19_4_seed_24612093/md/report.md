...
```
Node 31878 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31879 (Gather) [consumed]
    Node 31880 (Aggregate) [consumed]
      Node 31881 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31878 | 31879, 31880 |
...
|------|------|--------|-----------|-----|--------|
| 31878 | Aggregate | 802.11 | 831.20 | 3.6% | pattern |
| 31881 | Hash Join | 782.00 | 766.05 | 2.0% | operator |
...
### Step 5: Node 31878 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31879, 31880
- **Input Features:**
