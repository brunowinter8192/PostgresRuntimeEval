...
```
Node 31388 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31389 (Gather) [consumed]
    Node 31390 (Aggregate) [consumed]
      Node 31391 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31388 | 31389, 31390 |
...
|------|------|--------|-----------|-----|--------|
| 31388 | Aggregate | 814.54 | 831.20 | 2.0% | pattern |
| 31391 | Hash Join | 795.38 | 766.05 | 3.7% | operator |
...
### Step 5: Node 31388 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31389, 31390
- **Input Features:**
