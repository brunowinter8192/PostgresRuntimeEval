...
```
Node 31850 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31851 (Gather) [consumed]
    Node 31852 (Aggregate) [consumed]
      Node 31853 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31850 | 31851, 31852 |
...
|------|------|--------|-----------|-----|--------|
| 31850 | Aggregate | 839.26 | 831.20 | 1.0% | pattern |
| 31853 | Hash Join | 816.86 | 766.05 | 6.2% | operator |
...
### Step 5: Node 31850 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31851, 31852
- **Input Features:**
