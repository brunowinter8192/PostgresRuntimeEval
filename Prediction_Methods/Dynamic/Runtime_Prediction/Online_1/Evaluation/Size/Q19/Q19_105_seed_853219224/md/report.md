...
```
Node 31255 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31256 (Gather) [consumed]
    Node 31257 (Aggregate) [consumed]
      Node 31258 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31255 | 31256, 31257 |
...
|------|------|--------|-----------|-----|--------|
| 31255 | Aggregate | 910.11 | 831.20 | 8.7% | pattern |
| 31258 | Hash Join | 891.53 | 766.06 | 14.1% | operator |
...
### Step 5: Node 31255 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31256, 31257
- **Input Features:**
