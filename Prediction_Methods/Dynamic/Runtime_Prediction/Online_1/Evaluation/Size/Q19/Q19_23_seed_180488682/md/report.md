...
```
Node 31675 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31676 (Gather) [consumed]
    Node 31677 (Aggregate) [consumed]
      Node 31678 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31675 | 31676, 31677 |
...
|------|------|--------|-----------|-----|--------|
| 31675 | Aggregate | 844.03 | 831.20 | 1.5% | pattern |
| 31678 | Hash Join | 823.34 | 766.06 | 7.0% | operator |
...
### Step 5: Node 31675 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31676, 31677
- **Input Features:**
