...
```
Node 31934 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31935 (Gather) [consumed]
    Node 31936 (Aggregate) [consumed]
      Node 31937 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31934 | 31935, 31936 |
...
|------|------|--------|-----------|-----|--------|
| 31934 | Aggregate | 839.02 | 831.20 | 0.9% | pattern |
| 31937 | Hash Join | 818.20 | 766.06 | 6.4% | operator |
...
### Step 5: Node 31934 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31935, 31936
- **Input Features:**
