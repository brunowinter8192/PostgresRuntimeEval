...
```
Node 31395 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31396 (Gather) [consumed]
    Node 31397 (Aggregate) [consumed]
      Node 31398 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31395 | 31396, 31397 |
...
|------|------|--------|-----------|-----|--------|
| 31395 | Aggregate | 879.98 | 831.20 | 5.5% | pattern |
| 31398 | Hash Join | 859.31 | 766.05 | 10.9% | operator |
...
### Step 5: Node 31395 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31396, 31397
- **Input Features:**
