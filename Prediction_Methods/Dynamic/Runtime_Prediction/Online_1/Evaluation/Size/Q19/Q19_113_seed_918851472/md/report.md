...
```
Node 31318 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31319 (Gather) [consumed]
    Node 31320 (Aggregate) [consumed]
      Node 31321 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31318 | 31319, 31320 |
...
|------|------|--------|-----------|-----|--------|
| 31318 | Aggregate | 861.03 | 831.20 | 3.5% | pattern |
| 31321 | Hash Join | 842.61 | 766.05 | 9.1% | operator |
...
### Step 5: Node 31318 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31319, 31320
- **Input Features:**
