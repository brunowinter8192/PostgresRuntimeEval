...
```
Node 31654 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31655 (Gather) [consumed]
    Node 31656 (Aggregate) [consumed]
      Node 31657 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31654 | 31655, 31656 |
...
|------|------|--------|-----------|-----|--------|
| 31654 | Aggregate | 837.68 | 831.20 | 0.8% | pattern |
| 31657 | Hash Join | 817.12 | 766.06 | 6.2% | operator |
...
### Step 5: Node 31654 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31655, 31656
- **Input Features:**
