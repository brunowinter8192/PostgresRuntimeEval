...
```
Node 32032 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 32033 (Gather) [consumed]
    Node 32034 (Aggregate) [consumed]
      Node 32035 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 32032 | 32033, 32034 |
...
|------|------|--------|-----------|-----|--------|
| 32032 | Aggregate | 853.83 | 831.20 | 2.7% | pattern |
| 32035 | Hash Join | 832.06 | 766.05 | 7.9% | operator |
...
- **Input Features:**
  ...
  - total_cost=156338.3500
- **Output:** st=60.25, rt=766.05

### Step 5: Node 32032 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 32033, 32034
- **Input Features:**
