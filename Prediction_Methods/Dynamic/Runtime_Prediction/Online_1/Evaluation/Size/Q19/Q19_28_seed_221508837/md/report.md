...
```
Node 31710 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31711 (Gather) [consumed]
    Node 31712 (Aggregate) [consumed]
      Node 31713 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31710 | 31711, 31712 |
...
|------|------|--------|-----------|-----|--------|
| 31710 | Aggregate | 857.19 | 831.20 | 3.0% | pattern |
| 31713 | Hash Join | 835.61 | 766.06 | 8.3% | operator |
...
- **Input Features:**
  ...
  - total_cost=156338.7300
- **Output:** st=60.26, rt=766.06

### Step 5: Node 31710 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31711, 31712
- **Input Features:**
