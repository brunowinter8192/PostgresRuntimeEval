...
```
Node 32123 (Aggregate) [PATTERN: a5f39f08] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 32123 | 32124, 32125 |
...
|------|------|--------|-----------|-----|--------|
| 32123 | Aggregate | 835.41 | 831.20 | 0.5% | pattern |
| 32126 | Hash Join | 814.89 | 766.05 | 6.0% | operator |
...
### Step 5: Node 32123 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 32124, 32125
- **Input Features:**
