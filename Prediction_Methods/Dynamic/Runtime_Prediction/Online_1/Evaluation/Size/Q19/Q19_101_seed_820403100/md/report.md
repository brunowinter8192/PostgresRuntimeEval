...
```
Node 31227 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31228 (Gather) [consumed]
    Node 31229 (Aggregate) [consumed]
      Node 31230 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31227 | 31228, 31229 |
...
|------|------|--------|-----------|-----|--------|
| 31227 | Aggregate | 860.02 | 831.20 | 3.4% | pattern |
| 31230 | Hash Join | 839.64 | 766.06 | 8.8% | operator |
...
### Step 5: Node 31227 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31228, 31229
- **Input Features:**
