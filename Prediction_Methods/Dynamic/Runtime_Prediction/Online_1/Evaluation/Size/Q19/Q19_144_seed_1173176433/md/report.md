...
```
Node 31556 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31557 (Gather) [consumed]
    Node 31558 (Aggregate) [consumed]
      Node 31559 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31556 | 31557, 31558 |
...
|------|------|--------|-----------|-----|--------|
| 31556 | Aggregate | 840.54 | 831.20 | 1.1% | pattern |
| 31559 | Hash Join | 819.02 | 766.06 | 6.5% | operator |
...
### Step 5: Node 31556 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31557, 31558
- **Input Features:**
