...
```
Node 32256 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 32257 (Gather) [consumed]
    Node 32258 (Aggregate) [consumed]
      Node 32259 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 32256 | 32257, 32258 |
...
|------|------|--------|-----------|-----|--------|
| 32256 | Aggregate | 863.94 | 831.20 | 3.8% | pattern |
| 32259 | Hash Join | 845.12 | 766.06 | 9.4% | operator |
...
- **Input Features:**
  ...
  - total_cost=156338.7700
- **Output:** st=60.26, rt=766.06

### Step 5: Node 32256 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 32257, 32258
- **Input Features:**
