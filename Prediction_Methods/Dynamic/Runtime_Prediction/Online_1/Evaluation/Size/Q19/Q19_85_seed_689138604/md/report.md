...
```
Node 32151 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 32152 (Gather) [consumed]
    Node 32153 (Aggregate) [consumed]
      Node 32154 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 32151 | 32152, 32153 |
...
|------|------|--------|-----------|-----|--------|
| 32151 | Aggregate | 859.98 | 831.20 | 3.3% | pattern |
| 32154 | Hash Join | 838.22 | 766.06 | 8.6% | operator |
...
### Step 5: Node 32151 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 32152, 32153
- **Input Features:**
