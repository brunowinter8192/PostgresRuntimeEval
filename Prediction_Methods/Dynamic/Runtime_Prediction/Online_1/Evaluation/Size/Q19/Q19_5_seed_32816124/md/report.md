...
```
Node 31955 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31956 (Gather) [consumed]
    Node 31957 (Aggregate) [consumed]
      Node 31958 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31955 | 31956, 31957 |
...
|------|------|--------|-----------|-----|--------|
| 31955 | Aggregate | 832.84 | 831.20 | 0.2% | pattern |
| 31958 | Hash Join | 812.98 | 766.06 | 5.8% | operator |
...
### Step 5: Node 31955 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31956, 31957
- **Input Features:**
