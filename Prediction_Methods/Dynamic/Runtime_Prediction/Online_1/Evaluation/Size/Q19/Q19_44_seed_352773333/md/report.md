...
```
Node 31836 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31837 (Gather) [consumed]
    Node 31838 (Aggregate) [consumed]
      Node 31839 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31836 | 31837, 31838 |
...
|------|------|--------|-----------|-----|--------|
| 31836 | Aggregate | 821.36 | 831.20 | 1.2% | pattern |
| 31839 | Hash Join | 801.55 | 766.05 | 4.4% | operator |
...
### Step 5: Node 31836 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31837, 31838
- **Input Features:**
