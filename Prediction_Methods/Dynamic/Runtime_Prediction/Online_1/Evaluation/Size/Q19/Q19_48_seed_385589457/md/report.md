...
```
Node 31864 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31865 (Gather) [consumed]
    Node 31866 (Aggregate) [consumed]
      Node 31867 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31864 | 31865, 31866 |
...
|------|------|--------|-----------|-----|--------|
| 31864 | Aggregate | 847.04 | 831.20 | 1.9% | pattern |
| 31867 | Hash Join | 826.91 | 766.05 | 7.4% | operator |
...
### Step 5: Node 31864 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31865, 31866
- **Input Features:**
