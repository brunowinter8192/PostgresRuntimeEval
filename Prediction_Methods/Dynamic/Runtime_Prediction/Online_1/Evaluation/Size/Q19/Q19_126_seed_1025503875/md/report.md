...
```
Node 31416 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31417 (Gather) [consumed]
    Node 31418 (Aggregate) [consumed]
      Node 31419 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31416 | 31417, 31418 |
...
|------|------|--------|-----------|-----|--------|
| 31416 | Aggregate | 837.18 | 831.20 | 0.7% | pattern |
| 31419 | Hash Join | 817.91 | 766.06 | 6.3% | operator |
...
### Step 5: Node 31416 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31417, 31418
- **Input Features:**
