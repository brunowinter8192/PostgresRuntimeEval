...
```
Node 32186 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 32187 (Gather) [consumed]
    Node 32188 (Aggregate) [consumed]
      Node 32189 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 32186 | 32187, 32188 |
...
|------|------|--------|-----------|-----|--------|
| 32186 | Aggregate | 830.44 | 831.20 | 0.1% | pattern |
| 32189 | Hash Join | 808.89 | 766.05 | 5.3% | operator |
...
### Step 5: Node 32186 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 32187, 32188
- **Input Features:**
