...
```
Node 31759 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31760 (Gather) [consumed]
    Node 31761 (Aggregate) [consumed]
      Node 31762 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31759 | 31760, 31761 |
...
|------|------|--------|-----------|-----|--------|
| 31759 | Aggregate | 837.47 | 831.20 | 0.7% | pattern |
| 31762 | Hash Join | 815.94 | 766.06 | 6.1% | operator |
...
- **Input Features:**
  ...
  - st1=7.8285
  - st2=8.2847
  - startup_cost=7672.2400
  - total_cost=156338.7000
- **Output:** st=60.26, rt=766.06

### Step 5: Node 31759 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31760, 31761
- **Input Features:**
