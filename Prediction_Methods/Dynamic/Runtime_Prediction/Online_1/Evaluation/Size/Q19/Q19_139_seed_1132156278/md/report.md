...
```
Node 31514 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31515 (Gather) [consumed]
    Node 31516 (Aggregate) [consumed]
      Node 31517 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31514 | 31515, 31516 |
...
|------|------|--------|-----------|-----|--------|
| 31514 | Aggregate | 842.85 | 831.20 | 1.4% | pattern |
| 31517 | Hash Join | 822.49 | 766.05 | 6.9% | operator |
...
### Step 5: Node 31514 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31515, 31516
- **Input Features:**
