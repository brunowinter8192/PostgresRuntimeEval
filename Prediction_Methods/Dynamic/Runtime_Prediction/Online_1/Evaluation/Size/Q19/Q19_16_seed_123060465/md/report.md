...
```
Node 31619 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31620 (Gather) [consumed]
    Node 31621 (Aggregate) [consumed]
      Node 31622 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31619 | 31620, 31621 |
...
|------|------|--------|-----------|-----|--------|
| 31619 | Aggregate | 829.61 | 831.20 | 0.2% | pattern |
| 31622 | Hash Join | 807.82 | 766.06 | 5.2% | operator |
...
### Step 5: Node 31619 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31620, 31621
- **Input Features:**
