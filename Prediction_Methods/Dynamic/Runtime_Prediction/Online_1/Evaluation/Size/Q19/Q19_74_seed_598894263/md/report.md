...
```
Node 32067 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 32068 (Gather) [consumed]
    Node 32069 (Aggregate) [consumed]
      Node 32070 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 32067 | 32068, 32069 |
...
|------|------|--------|-----------|-----|--------|
| 32067 | Aggregate | 863.84 | 831.20 | 3.8% | pattern |
| 32070 | Hash Join | 843.00 | 766.06 | 9.1% | operator |
...
### Step 5: Node 32067 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 32068, 32069
- **Input Features:**
