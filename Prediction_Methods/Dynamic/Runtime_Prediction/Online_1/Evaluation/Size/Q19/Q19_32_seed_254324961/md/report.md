...
```
Node 31745 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31746 (Gather) [consumed]
    Node 31747 (Aggregate) [consumed]
      Node 31748 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31745 | 31746, 31747 |
...
|------|------|--------|-----------|-----|--------|
| 31745 | Aggregate | 864.71 | 831.20 | 3.9% | pattern |
| 31748 | Hash Join | 842.82 | 766.06 | 9.1% | operator |
...
### Step 5: Node 31745 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31746, 31747
- **Input Features:**
