...
```
Node 31465 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31466 (Gather) [consumed]
    Node 31467 (Aggregate) [consumed]
      Node 31468 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31465 | 31466, 31467 |
...
|------|------|--------|-----------|-----|--------|
| 31465 | Aggregate | 853.51 | 831.20 | 2.6% | pattern |
| 31468 | Hash Join | 835.07 | 766.06 | 8.3% | operator |
...
### Step 5: Node 31465 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31466, 31467
- **Input Features:**
