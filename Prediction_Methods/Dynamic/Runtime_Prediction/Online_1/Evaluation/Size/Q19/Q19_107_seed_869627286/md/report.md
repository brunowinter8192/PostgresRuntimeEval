...
**Test Query:** Q19_107_seed_869627286
...
```
Node 31269 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31270 (Gather) [consumed]
    Node 31271 (Aggregate) [consumed]
      Node 31272 (Hash Join)
        Node 31273 (Seq Scan) - LEAF
        Node 31274 (Hash)
          Node 31275 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31269 | 31270, 31271 |
...
|------|------|--------|-----------|-----|--------|
| 31269 | Aggregate | 853.39 | 831.20 | 2.6% | pattern |
| 31272 | Hash Join | 834.07 | 766.05 | 8.2% | operator |
| 31273 | Seq Scan | 786.82 | 743.46 | 5.5% | operator |
| 31274 | Hash | 45.48 | 8.29 | 81.8% | operator |
| 31275 | Seq Scan | 45.36 | 23.76 | 47.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31275 (Seq Scan) - LEAF
...
### Step 2: Node 31273 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=156338.5000
- **Output:** st=60.26, rt=766.05

### Step 5: Node 31269 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31270, 31271
- **Input Features:**
