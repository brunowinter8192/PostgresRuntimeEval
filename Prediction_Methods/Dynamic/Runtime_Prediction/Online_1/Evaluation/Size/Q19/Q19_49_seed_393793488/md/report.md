...
```
Node 31871 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31872 (Gather) [consumed]
    Node 31873 (Aggregate) [consumed]
      Node 31874 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31871 | 31872, 31873 |
...
|------|------|--------|-----------|-----|--------|
| 31871 | Aggregate | 842.59 | 831.20 | 1.4% | pattern |
| 31874 | Hash Join | 822.30 | 766.05 | 6.8% | operator |
...
### Step 5: Node 31871 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31872, 31873
- **Input Features:**
