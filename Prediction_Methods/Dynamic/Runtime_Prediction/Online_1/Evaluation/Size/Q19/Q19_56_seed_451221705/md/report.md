...
```
Node 31927 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31928 (Gather) [consumed]
    Node 31929 (Aggregate) [consumed]
      Node 31930 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31927 | 31928, 31929 |
...
|------|------|--------|-----------|-----|--------|
| 31927 | Aggregate | 845.13 | 831.20 | 1.6% | pattern |
| 31930 | Hash Join | 820.04 | 766.06 | 6.6% | operator |
...
### Step 5: Node 31927 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31928, 31929
- **Input Features:**
