...
**Test Query:** Q19_45_seed_360977364
...
```
Node 31843 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31844 (Gather) [consumed]
    Node 31845 (Aggregate) [consumed]
      Node 31846 (Hash Join)
        Node 31847 (Seq Scan) - LEAF
        Node 31848 (Hash)
          Node 31849 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31843 | 31844, 31845 |
...
|------|------|--------|-----------|-----|--------|
| 31843 | Aggregate | 860.85 | 831.20 | 3.4% | pattern |
| 31846 | Hash Join | 840.81 | 766.05 | 8.9% | operator |
| 31847 | Seq Scan | 793.58 | 743.46 | 6.3% | operator |
| 31848 | Hash | 45.56 | 8.29 | 81.8% | operator |
| 31849 | Seq Scan | 45.44 | 23.76 | 47.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31849 (Seq Scan) - LEAF
...
### Step 2: Node 31847 (Seq Scan) - LEAF
...
### Step 5: Node 31843 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31844, 31845
- **Input Features:**
