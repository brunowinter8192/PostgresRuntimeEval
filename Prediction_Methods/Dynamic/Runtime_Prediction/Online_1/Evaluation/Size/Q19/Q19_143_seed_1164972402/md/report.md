...
```
Node 31549 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31550 (Gather) [consumed]
    Node 31551 (Aggregate) [consumed]
      Node 31552 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31549 | 31550, 31551 |
...
|------|------|--------|-----------|-----|--------|
| 31549 | Aggregate | 867.36 | 831.20 | 4.2% | pattern |
| 31552 | Hash Join | 847.50 | 766.05 | 9.6% | operator |
...
### Step 5: Node 31549 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31550, 31551
- **Input Features:**
