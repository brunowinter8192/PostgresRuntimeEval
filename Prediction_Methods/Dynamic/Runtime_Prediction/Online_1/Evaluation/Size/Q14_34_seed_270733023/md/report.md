...
**Test Query:** Q14_34_seed_270733023
...
```
Node 26959 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26960 (Gather) [consumed]
    Node 26961 (Aggregate) [consumed]
      Node 26962 (Hash Join)
        Node 26963 (Seq Scan) - LEAF
        Node 26964 (Hash)
          Node 26965 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26959 | 26960, 26961 |
...
|------|------|--------|-----------|-----|--------|
| 26959 | Aggregate | 800.30 | 848.38 | 6.0% | pattern |
| 26962 | Hash Join | 779.61 | 807.67 | 3.6% | operator |
| 26963 | Seq Scan | 730.19 | 758.50 | 3.9% | operator |
| 26964 | Hash | 41.28 | 9.38 | 77.3% | operator |
| 26965 | Seq Scan | 36.56 | 12.70 | 65.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26965 (Seq Scan) - LEAF
...
### Step 2: Node 26963 (Seq Scan) - LEAF
...
### Step 5: Node 26959 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26960, 26961
- **Input Features:**
