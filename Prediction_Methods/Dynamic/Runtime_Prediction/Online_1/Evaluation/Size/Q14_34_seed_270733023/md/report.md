...
```
Node 26959 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26960 (Gather) [consumed]
    Node 26961 (Aggregate) [consumed]
      Node 26962 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26959 | 26960, 26961, 26962 |
...
|------|------|--------|-----------|-----|--------|
| 26959 | Aggregate | 800.30 | 857.14 | 7.1% | pattern |
...
### Step 4: Node 26959 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26960, 26961, 26962
- **Input Features:**
