...
**Test Query:** Q19_112_seed_910647441
...
```
Node 31311 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31312 (Gather) [consumed]
    Node 31313 (Aggregate) [consumed]
      Node 31314 (Hash Join) [consumed]
        Node 31315 (Seq Scan) - LEAF
        Node 31316 (Hash)
          Node 31317 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31311 | 31312, 31313, 31314 |
...
|------|------|--------|-----------|-----|--------|
| 31311 | Aggregate | 814.89 | 829.30 | 1.8% | pattern |
| 31315 | Seq Scan | 745.01 | 743.46 | 0.2% | operator |
| 31316 | Hash | 50.07 | 8.29 | 83.5% | operator |
| 31317 | Seq Scan | 49.91 | 23.76 | 52.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31317 (Seq Scan) - LEAF
...
### Step 2: Node 31315 (Seq Scan) - LEAF
...
### Step 4: Node 31311 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31312, 31313, 31314
- **Input Features:**
  ...
  - HashJoin_Outer_total_cost=156338.6600
