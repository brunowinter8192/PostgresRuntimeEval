...
```
Node 31311 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31312 (Gather) [consumed]
    Node 31313 (Aggregate) [consumed]
      Node 31314 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31311 | 31312, 31313 |
...
|------|------|--------|-----------|-----|--------|
| 31311 | Aggregate | 814.89 | 831.20 | 2.0% | pattern |
| 31314 | Hash Join | 797.00 | 766.06 | 3.9% | operator |
...
- **Input Features:**
  ...
  - total_cost=156338.6600
- **Output:** st=60.26, rt=766.06

### Step 5: Node 31311 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31312, 31313
- **Input Features:**
