    ...
    Node 20191 (Aggregate) [consumed]
      Node 20192 (Gather) [consumed]
        Node 20193 (Hash Join)
          Node 20194 (Hash Join)
            Node 20195 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20189 | 20190, 20191, 20192 |
...
| 20193 | Hash Join | 1129.92 | 1007.14 | 10.9% | operator |
| 20194 | Hash Join | 1127.02 | 1003.99 | 10.9% | operator |
| 20200 | Hash | 0.02 | 15.71 | 98092.3% | operator |
| 20195 | Nested Loop | 1081.48 | 1204.86 | 11.4% | operator |
| 20198 | Hash | 33.92 | 55.57 | 63.8% | operator |
...
### Step 6: Node 20201 (Seq Scan) - LEAF
...
### Step 10: Node 20189 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20190, 20191, 20192
- **Input Features:**
