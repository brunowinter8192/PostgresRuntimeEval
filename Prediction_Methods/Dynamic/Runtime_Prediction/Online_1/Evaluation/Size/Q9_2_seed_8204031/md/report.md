...
```
Node 17955 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 17956 (Aggregate) [consumed]
    Node 17957 (Gather)
      Node 17958 (Aggregate)
        Node 17959 (Nested Loop)
          Node 17960 (Hash Join) [PATTERN: bb930825]
            Node 17961 (Seq Scan) [consumed] - LEAF
            Node 17962 (Hash) [consumed]
              Node 17963 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17960 | 17955, 17956, 17961, 17962, 17963 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17955 | 17956, 17960, 17961, 17962, 17963 |
...
|------|------|--------|-----------|-----|--------|
| 17955 | Sort | 1187.57 | 1045.06 | 12.0% | pattern |
...
| 17960 | Hash Join | 973.14 | 134.80 | 86.1% | pattern |
...
### Step 9: Node 17960 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17955, 17956, 17961, 17962, 17963
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17972 (Index Scan) - LEAF
...
### Step 11: Node 17959 (Nested Loop)
...
### Step 14: Node 17955 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17956, 17960, 17961, 17962, 17963
- **Input Features:**
