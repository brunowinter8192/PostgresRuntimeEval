...
```
Node 32235 (Aggregate) [PATTERN: efde8b38] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 32235 | 32236, 32237, 32238 |
...
|------|------|--------|-----------|-----|--------|
| 32235 | Aggregate | 842.53 | 829.31 | 1.6% | pattern |
| 32239 | Seq Scan | 771.93 | 743.46 | 3.7% | operator |
| 32240 | Hash | 48.51 | 8.29 | 82.9% | operator |
| 32241 | Seq Scan | 48.34 | 23.76 | 50.8% | operator |
...
### Step 4: Node 32235 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 32236, 32237, 32238
- **Input Features:**
