...
**Test Query:** Q19_32_seed_254324961
...
```
Node 31745 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31746 (Gather) [consumed]
    Node 31747 (Aggregate) [consumed]
      Node 31748 (Hash Join) [consumed]
        Node 31749 (Seq Scan) - LEAF
        Node 31750 (Hash)
          Node 31751 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31745 | 31746, 31747, 31748 |
...
|------|------|--------|-----------|-----|--------|
| 31745 | Aggregate | 864.71 | 829.29 | 4.1% | pattern |
| 31749 | Seq Scan | 785.94 | 743.46 | 5.4% | operator |
| 31750 | Hash | 55.30 | 8.29 | 85.0% | operator |
| 31751 | Seq Scan | 55.21 | 23.76 | 57.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31751 (Seq Scan) - LEAF
...
### Step 2: Node 31749 (Seq Scan) - LEAF
...
### Step 4: Node 31745 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31746, 31747, 31748
- **Input Features:**
