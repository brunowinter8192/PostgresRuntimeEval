    ...
    Node 19227 (Gather)
      Node 19228 (Aggregate)
        Node 19229 (Nested Loop)
          Node 19230 (Hash Join) [PATTERN: bb930825]
            Node 19231 (Seq Scan) [consumed] - LEAF
            Node 19232 (Hash) [consumed]
              Node 19233 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 19230 | 19225, 19226, 19231, 19232, 19233 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 19225 | 19226, 19230, 19231, 19232, 19233 |
...
|------|------|--------|-----------|-----|--------|
| 19225 | Sort | 1175.51 | 1044.79 | 11.1% | pattern |
| 19227 | Gather | 1174.49 | 964.87 | 17.8% | operator |
| 19228 | Aggregate | 1155.26 | 1117.47 | 3.3% | operator |
| 19229 | Nested Loop | 1129.86 | 1252.17 | 10.8% | operator |
| 19230 | Hash Join | 963.45 | 134.80 | 86.0% | pattern |
| 19242 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 19234 | Hash Join | 161.81 | 837.55 | 417.6% | operator |
| 19240 | Hash | 14.05 | 14.95 | 6.4% | operator |
| 19235 | Nested Loop | 154.85 | 1251.76 | 708.4% | operator |
| 19238 | Hash | 4.30 | 15.94 | 270.5% | operator |
| 19241 | Seq Scan | 14.04 | 2.94 | 79.1% | operator |
| 19236 | Seq Scan | 20.68 | 44.17 | 113.5% | operator |
| 19237 | Index Scan | 0.07 | -1.39 | 1951.3% | operator |
| 19239 | Seq Scan | 3.74 | 9.45 | 152.3% | operator |
...
### Step 9: Node 19230 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 19225, 19226, 19231, 19232, 19233
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 19242 (Index Scan) - LEAF
...
### Step 11: Node 19229 (Nested Loop)
...
### Step 14: Node 19225 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 19226, 19230, 19231, 19232, 19233
- **Input Features:**
