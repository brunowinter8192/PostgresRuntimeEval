...
**Test Query:** Q18_98_seed_795791007
...
```
Node 31172 (Limit) - ROOT
  Node 31173 (Sort)
    Node 31174 (Aggregate)
      Node 31175 (Gather Merge)
        Node 31176 (Incremental Sort)
          Node 31177 (Nested Loop)
            Node 31178 (Merge Join)
              Node 31179 (Sort)
                Node 31180 (Hash Join) [PATTERN: 895c6e8c]
                  Node 31181 (Seq Scan) [consumed] - LEAF
                  Node 31182 (Hash) [consumed]
                    Node 31183 (Aggregate)
                      Node 31184 (Index Scan) - LEAF
              Node 31185 (Sort)
                Node 31186 (Seq Scan) - LEAF
            Node 31187 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 31180 | 31181, 31182 |
...
|------|------|--------|-----------|-----|--------|
| 31172 | Limit | 3064.15 | 1175.21 | 61.6% | operator |
| 31173 | Sort | 2946.27 | 1127.81 | 61.7% | operator |
| 31174 | Aggregate | 2946.24 | 1073.15 | 63.6% | operator |
| 31175 | Gather Merge | 2946.22 | 1073.95 | 63.5% | operator |
| 31176 | Incremental Sort | 2926.08 | 0.00 | 100.0% | operator |
| 31177 | Nested Loop | 2925.99 | 1111.34 | 62.0% | operator |
| 31178 | Merge Join | 2925.91 | 0.00 | 100.0% | operator |
| 31187 | Index Scan | 0.03 | 0.05 | 55.6% | operator |
| 31179 | Sort | 2857.80 | 1095.58 | 61.7% | operator |
| 31185 | Sort | 65.04 | 1074.66 | 1552.4% | operator |
| 31180 | Hash Join | 2857.79 | 471.07 | 83.5% | pattern |
| 31186 | Seq Scan | 53.23 | 18.25 | 65.7% | operator |
| 31183 | Aggregate | 2637.87 | 1073.15 | 59.3% | operator |
| 31184 | Index Scan | 2141.47 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31184 (Index Scan) - LEAF
...
### Step 3: Node 31180 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 31181, 31182
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 31186 (Seq Scan) - LEAF
...
### Step 7: Node 31178 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 31187 (Index Scan) - LEAF
...
### Step 10: Node 31176 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 31175 (Gather Merge)
