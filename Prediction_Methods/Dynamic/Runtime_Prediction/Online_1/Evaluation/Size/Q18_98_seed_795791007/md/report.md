        ...
        Node 31176 (Incremental Sort)
          Node 31177 (Nested Loop)
            Node 31178 (Merge Join)
              Node 31179 (Sort)
                Node 31180 (Hash Join)
                  Node 31181 (Seq Scan) - LEAF
                  Node 31182 (Hash)
...
| 31179 | Sort | 2857.80 | 1099.77 | 61.5% | operator |
| 31185 | Sort | 65.04 | 1074.66 | 1552.4% | operator |
| 31180 | Hash Join | 2857.79 | 686.33 | 76.0% | operator |
| 31186 | Seq Scan | 53.23 | 18.25 | 65.7% | operator |
| 31181 | Seq Scan | 191.15 | 170.37 | 10.9% | operator |
| 31182 | Hash | 2637.91 | 21.04 | 99.2% | operator |
...
### Step 3: Node 31181 (Seq Scan) - LEAF
...
### Step 6: Node 31186 (Seq Scan) - LEAF
...
### Step 9: Node 31178 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 31187 (Index Scan) - LEAF
...
### Step 11: Node 31177 (Nested Loop)
...
### Step 12: Node 31176 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 31175 (Gather Merge)
