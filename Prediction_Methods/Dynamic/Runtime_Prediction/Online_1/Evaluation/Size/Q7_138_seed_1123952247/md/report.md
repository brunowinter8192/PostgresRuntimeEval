...
```
Node 11239 (Aggregate) - ROOT
  Node 11240 (Gather Merge)
    Node 11241 (Sort)
      Node 11242 (Hash Join)
        Node 11243 (Nested Loop)
          Node 11244 (Hash Join)
            Node 11245 (Seq Scan) - LEAF
            Node 11246 (Hash)
              Node 11247 (Hash Join)
                Node 11248 (Seq Scan) - LEAF
                Node 11249 (Hash)
                  Node 11250 (Seq Scan) - LEAF
          Node 11251 (Index Scan) - LEAF
        Node 11252 (Hash)
          Node 11253 (Hash Join)
            Node 11254 (Seq Scan) - LEAF
            Node 11255 (Hash)
              Node 11256 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 11239 | Aggregate | 1226.43 | 1209.26 | 1.4% | operator |
| 11240 | Gather Merge | 1225.21 | 1142.98 | 6.7% | operator |
| 11241 | Sort | 1217.51 | 1109.13 | 8.9% | operator |
| 11242 | Hash Join | 1216.85 | 842.59 | 30.8% | operator |
| 11243 | Nested Loop | 1209.89 | 1216.16 | 0.5% | operator |
| 11252 | Hash | 3.20 | 17.53 | 447.6% | operator |
| 11244 | Hash Join | 213.45 | 384.47 | 80.1% | operator |
| 11251 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 11253 | Hash Join | 3.16 | 85.17 | 2598.8% | operator |
| 11245 | Seq Scan | 152.32 | 201.16 | 32.1% | operator |
| 11246 | Hash | 35.20 | 19.59 | 44.3% | operator |
| 11254 | Seq Scan | 2.85 | 11.47 | 302.1% | operator |
| 11255 | Hash | 0.01 | 16.89 | 129854.5% | operator |
| 11247 | Hash Join | 34.86 | 92.20 | 164.5% | operator |
| 11256 | Seq Scan | 0.01 | 45.79 | 457823.2% | operator |
| 11248 | Seq Scan | 33.62 | 21.86 | 35.0% | operator |
| 11249 | Hash | 0.01 | 16.89 | 112527.2% | operator |
| 11250 | Seq Scan | 0.01 | 45.79 | 457823.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11250 (Seq Scan) - LEAF
...
### Step 2: Node 11248 (Seq Scan) - LEAF
...
### Step 5: Node 11256 (Seq Scan) - LEAF
...
### Step 6: Node 11245 (Seq Scan) - LEAF
...
### Step 8: Node 11254 (Seq Scan) - LEAF
...
### Step 11: Node 11251 (Index Scan) - LEAF
...
### Step 13: Node 11243 (Nested Loop)
...
### Step 17: Node 11240 (Gather Merge)
...
### Step 18: Node 11239 (Aggregate) - ROOT
