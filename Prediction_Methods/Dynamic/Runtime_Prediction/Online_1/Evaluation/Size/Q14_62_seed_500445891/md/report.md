...
```
Node 27176 (Aggregate) [PATTERN: efde8b38] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27176 | 27177, 27178, 27179 |
...
|------|------|--------|-----------|-----|--------|
| 27176 | Aggregate | 810.40 | 857.14 | 5.8% | pattern |
| 27180 | Seq Scan | 734.93 | 758.50 | 3.2% | operator |
| 27181 | Hash | 43.26 | 9.38 | 78.3% | operator |
| 27182 | Seq Scan | 38.15 | 12.70 | 66.7% | operator |
...
### Step 4: Node 27176 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27177, 27178, 27179
- **Input Features:**
