...
**Test Query:** Q5_105_seed_853219224
...
```
Node 7001 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 7002 (Aggregate) [consumed]
    Node 7003 (Gather Merge) [consumed]
      Node 7004 (Aggregate)
        Node 7005 (Sort) [PATTERN: 3e2d5a00]
          Node 7006 (Hash Join) [consumed]
            Node 7007 (Nested Loop)
              Node 7008 (Hash Join)
                Node 7009 (Seq Scan) - LEAF
                Node 7010 (Hash) [PATTERN: 444761fb]
                  Node 7011 (Hash Join) [consumed]
                    Node 7012 (Seq Scan) [consumed] - LEAF
                    Node 7013 (Hash) [consumed]
                      Node 7014 (Hash Join) [consumed]
                        Node 7015 (Seq Scan) - LEAF
                        Node 7016 (Hash)
                          Node 7017 (Seq Scan) - LEAF
              Node 7018 (Index Scan) - LEAF
            Node 7019 (Hash)
              Node 7020 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 7010 | 7001, 7002, 7003, 7005, 7006, 7011, 7012, 7013, 7014 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 7001 | 7002, 7003, 7005, 7006, 7010, 7011, 7012, 7013, 7014 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 7005 | 7001, 7002, 7003, 7006, 7010, 7011, 7012, 7013, 7014 |
...
|------|------|--------|-----------|-----|--------|
| 7001 | Sort | 1068.91 | 2934.42 | 174.5% | pattern |
| 7004 | Aggregate | 1063.27 | 1128.76 | 6.2% | operator |
| 7005 | Sort | 1063.04 | 1835.93 | 72.7% | pattern |
| 7007 | Nested Loop | 1050.64 | 1188.47 | 13.1% | operator |
| 7019 | Hash | 3.77 | 18.67 | 395.0% | operator |
| 7008 | Hash Join | 217.05 | 253.07 | 16.6% | operator |
| 7018 | Index Scan | 0.07 | -0.22 | 401.4% | operator |
| 7020 | Seq Scan | 3.23 | 12.36 | 283.2% | operator |
| 7009 | Seq Scan | 169.94 | 159.81 | 6.0% | operator |
| 7010 | Hash | 34.09 | 46.85 | 37.4% | pattern |
| 7015 | Seq Scan | 0.01 | 11.81 | 117982.7% | operator |
| 7016 | Hash | 0.05 | 21.05 | 42865.8% | operator |
| 7017 | Seq Scan | 0.05 | 22.93 | 48694.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 7017 (Seq Scan) - LEAF
...
### Step 2: Node 7015 (Seq Scan) - LEAF
...
### Step 4: Node 7009 (Seq Scan) - LEAF
...
### Step 5: Node 7010 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 7001, 7002, 7003, 7005, 7006, 7011, 7012, 7013, 7014
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 7018 (Index Scan) - LEAF
...
### Step 8: Node 7020 (Seq Scan) - LEAF
...
### Step 11: Node 7005 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 7001, 7002, 7003, 7006, 7010, 7011, 7012, 7013, 7014
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 7001 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 7002, 7003, 7005, 7006, 7010, 7011, 7012, 7013, 7014
- **Input Features:**
