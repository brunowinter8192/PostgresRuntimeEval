...
**Test Query:** Q19_23_seed_180488682
...
```
Node 31675 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31676 (Gather) [consumed]
    Node 31677 (Aggregate) [consumed]
      Node 31678 (Hash Join) [consumed]
        Node 31679 (Seq Scan) - LEAF
        Node 31680 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31675 | 31676, 31677, 31678 |
...
|------|------|--------|-----------|-----|--------|
| 31675 | Aggregate | 844.03 | 829.28 | 1.7% | pattern |
| 31679 | Seq Scan | 777.26 | 743.46 | 4.3% | operator |
| 31680 | Hash | 44.43 | 8.29 | 81.4% | operator |
| 31681 | Seq Scan | 44.35 | 23.76 | 46.4% | operator |
...
### Step 2: Node 31679 (Seq Scan) - LEAF
...
### Step 4: Node 31675 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31676, 31677, 31678
- **Input Features:**
