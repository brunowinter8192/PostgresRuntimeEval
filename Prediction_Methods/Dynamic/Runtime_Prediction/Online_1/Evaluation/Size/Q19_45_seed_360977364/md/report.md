...
```
Node 31843 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31844 (Gather) [consumed]
    Node 31845 (Aggregate) [consumed]
      Node 31846 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31843 | 31844, 31845, 31846 |
...
|------|------|--------|-----------|-----|--------|
| 31843 | Aggregate | 860.85 | 829.29 | 3.7% | pattern |
...
### Step 4: Node 31843 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31844, 31845, 31846
- **Input Features:**
