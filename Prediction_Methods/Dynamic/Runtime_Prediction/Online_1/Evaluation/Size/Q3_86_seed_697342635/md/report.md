...
**Test Query:** Q3_86_seed_697342635
...
```
Node 5691 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5692 (Sort) [consumed]
    Node 5693 (Aggregate) [consumed]
      Node 5694 (Gather) [consumed]
        Node 5695 (Nested Loop)
          Node 5696 (Hash Join) [PATTERN: 895c6e8c]
            Node 5697 (Seq Scan) [consumed] - LEAF
            Node 5698 (Hash) [consumed]
              Node 5699 (Seq Scan) - LEAF
          Node 5700 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5691 | 5692, 5693, 5694, 5696, 5697, 5698 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5696 | 5691, 5692, 5693, 5694, 5697, 5698 |
...
|------|------|--------|-----------|-----|--------|
| 5691 | Limit | 1217.12 | 1151.18 | 5.4% | pattern |
| 5695 | Nested Loop | 1179.22 | 1192.77 | 1.1% | operator |
| 5696 | Hash Join | 211.41 | 242.42 | 14.7% | pattern |
| 5700 | Index Scan | 0.03 | -0.52 | 2018.8% | operator |
| 5699 | Seq Scan | 28.81 | 38.57 | 33.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5699 (Seq Scan) - LEAF
...
### Step 2: Node 5696 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5691, 5692, 5693, 5694, 5697, 5698
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46487
  - HashJoin_nt1=232682
...
### Step 3: Node 5700 (Index Scan) - LEAF
...
### Step 5: Node 5691 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5692, 5693, 5694, 5696, 5697, 5698
- **Input Features:**
