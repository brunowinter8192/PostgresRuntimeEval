...
**Test Query:** Q6_130_seed_1058319999
...
```
Node 10033 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10034 (Gather) [consumed]
    Node 10035 (Aggregate) [consumed]
      Node 10036 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10033 | 10034, 10035 |
...
|------|------|--------|-----------|-----|--------|
| 10033 | Aggregate | 771.85 | 850.05 | 10.1% | pattern |
| 10036 | Seq Scan | 751.33 | 748.53 | 0.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10036 (Seq Scan) - LEAF
...
### Step 2: Node 10033 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10034, 10035
- **Input Features:**
