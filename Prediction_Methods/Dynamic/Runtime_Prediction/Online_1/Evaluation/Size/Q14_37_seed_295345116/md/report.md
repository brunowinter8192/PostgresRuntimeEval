...
```
Node 26980 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26981 (Gather) [consumed]
    Node 26982 (Aggregate) [consumed]
      Node 26983 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26980 | 26981, 26982, 26983 |
...
|------|------|--------|-----------|-----|--------|
| 26980 | Aggregate | 819.51 | 857.15 | 4.6% | pattern |
...
### Step 4: Node 26980 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26981, 26982, 26983
- **Input Features:**
