...
```
Node 27379 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27380 (Gather) [consumed]
    Node 27381 (Aggregate) [consumed]
      Node 27382 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27379 | 27380, 27381, 27382 |
...
|------|------|--------|-----------|-----|--------|
| 27379 | Aggregate | 840.60 | 857.12 | 2.0% | pattern |
...
### Step 4: Node 27379 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27380, 27381, 27382
- **Input Features:**
