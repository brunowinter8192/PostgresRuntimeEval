...
```
Node 26903 (Aggregate) [PATTERN: efde8b38] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26903 | 26904, 26905, 26906 |
...
|------|------|--------|-----------|-----|--------|
| 26903 | Aggregate | 836.45 | 857.12 | 2.5% | pattern |
| 26907 | Seq Scan | 762.52 | 758.46 | 0.5% | operator |
| 26908 | Hash | 45.59 | 9.38 | 79.4% | operator |
| 26909 | Seq Scan | 39.88 | 12.70 | 68.1% | operator |
...
### Step 4: Node 26903 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26904, 26905, 26906
- **Input Features:**
