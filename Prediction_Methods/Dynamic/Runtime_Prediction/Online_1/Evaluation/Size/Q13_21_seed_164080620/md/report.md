...
```
Node 25811 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25812 (Aggregate) [consumed]
    Node 25813 (Aggregate)
      Node 25814 (Hash Join) [PATTERN: 895c6e8c]
        Node 25815 (Seq Scan) [consumed] - LEAF
        Node 25816 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25811 | 25812, 25814, 25815, 25816 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25814 | 25811, 25812, 25815, 25816 |
...
|------|------|--------|-----------|-----|--------|
| 25811 | Sort | 900.37 | 1079.94 | 19.9% | pattern |
| 25813 | Aggregate | 893.52 | 999.76 | 11.9% | operator |
| 25814 | Hash Join | 681.39 | 470.31 | 31.0% | pattern |
...
### Step 2: Node 25814 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25811, 25812, 25815, 25816
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 25811 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25812, 25814, 25815, 25816
- **Input Features:**
