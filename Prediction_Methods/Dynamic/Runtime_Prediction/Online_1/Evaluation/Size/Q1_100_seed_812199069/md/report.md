...
**Test Query:** Q1_100_seed_812199069
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 3 | 4 |
...
|------|------|--------|-----------|-----|--------|
| 1 | Aggregate | 935.76 | 1196.02 | 27.8% | operator |
| 2 | Gather Merge | 935.68 | 1165.94 | 24.6% | operator |
| 3 | Sort | 913.60 | 1201.02 | 31.5% | pattern |
| 5 | Seq Scan | 513.97 | 678.31 | 32.0% | operator |
...
- **Output:** st=0.85, rt=678.31

### Step 2: Node 3 (Sort) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=169311.0400
  - Sort_total_cost=169311.0500
- **Output:** st=1196.92, rt=1201.02

### Step 3: Node 2 (Gather Merge)
