...
```
Node 31444 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31445 (Gather) [consumed]
    Node 31446 (Aggregate) [consumed]
      Node 31447 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31444 | 31445, 31446 |
...
|------|------|--------|-----------|-----|--------|
| 31444 | Aggregate | 839.44 | 831.20 | 1.0% | pattern |
| 31447 | Hash Join | 818.32 | 766.06 | 6.4% | operator |
...
### Step 5: Node 31444 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31445, 31446
- **Input Features:**
