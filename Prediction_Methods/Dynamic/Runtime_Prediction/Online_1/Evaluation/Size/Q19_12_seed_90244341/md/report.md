...
**Test Query:** Q19_12_seed_90244341
...
```
Node 31444 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31445 (Gather) [consumed]
    Node 31446 (Aggregate) [consumed]
      Node 31447 (Hash Join) [consumed]
        Node 31448 (Seq Scan) - LEAF
        Node 31449 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31444 | 31445, 31446, 31447 |
...
|------|------|--------|-----------|-----|--------|
| 31444 | Aggregate | 839.44 | 829.29 | 1.2% | pattern |
| 31448 | Seq Scan | 769.74 | 743.46 | 3.4% | operator |
| 31449 | Hash | 46.33 | 8.29 | 82.1% | operator |
| 31450 | Seq Scan | 46.20 | 23.76 | 48.6% | operator |
...
### Step 2: Node 31448 (Seq Scan) - LEAF
...
### Step 4: Node 31444 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31445, 31446, 31447
- **Input Features:**
