...
```
Node 27057 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27058 (Gather) [consumed]
    Node 27059 (Aggregate) [consumed]
      Node 27060 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27057 | 27058, 27059, 27060 |
...
|------|------|--------|-----------|-----|--------|
| 27057 | Aggregate | 821.21 | 857.14 | 4.4% | pattern |
...
### Step 4: Node 27057 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27058, 27059, 27060
- **Input Features:**
