...
**Test Query:** Q3_72_seed_582486201
...
```
Node 5541 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5542 (Sort) [consumed]
    Node 5543 (Aggregate) [consumed]
      Node 5544 (Gather) [consumed]
        Node 5545 (Nested Loop)
          Node 5546 (Hash Join) [PATTERN: 895c6e8c]
            Node 5547 (Seq Scan) [consumed] - LEAF
            Node 5548 (Hash) [consumed]
              Node 5549 (Seq Scan) - LEAF
          Node 5550 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5541 | 5542, 5543, 5544, 5546, 5547, 5548 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5546 | 5541, 5542, 5543, 5544, 5547, 5548 |
...
|------|------|--------|-----------|-----|--------|
| 5541 | Limit | 1190.74 | 1151.18 | 3.3% | pattern |
| 5545 | Nested Loop | 1154.45 | 1192.73 | 3.3% | operator |
| 5546 | Hash Join | 209.48 | 242.42 | 15.7% | pattern |
| 5550 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5549 | Seq Scan | 28.86 | 38.57 | 33.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5549 (Seq Scan) - LEAF
...
### Step 2: Node 5546 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5541, 5542, 5543, 5544, 5547, 5548
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46419
  - HashJoin_nt1=232493
  ...
  - HashJoin_total_cost=37331.9400
  - Hash_Inner_np=0
  - Hash_Inner_nt=12479
...
### Step 3: Node 5550 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=72585.8500
- **Output:** st=121.49, rt=1192.73

### Step 5: Node 5541 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5542, 5543, 5544, 5546, 5547, 5548
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=313059
  - Aggregate_Outer_nt1=313059
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=109587.6300
  - Aggregate_Outer_total_cost=113500.8700
  - Gather_Outer_np=0
  - Gather_Outer_nt=313059
  - Gather_Outer_nt1=100987
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=104891.7500
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=313059
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=120265.9600
  - Limit_total_cost=120265.9900
  - Sort_Outer_np=0
  - Sort_Outer_nt=313059
  - Sort_Outer_nt1=313059
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=120265.9600
  - Sort_Outer_total_cost=121048.6100
