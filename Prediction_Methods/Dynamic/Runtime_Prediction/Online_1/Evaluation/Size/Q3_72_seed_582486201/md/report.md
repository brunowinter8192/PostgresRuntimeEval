...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5541 | 5542, 5543, 5544 |
...
| 5545 | Nested Loop | 1154.45 | 1192.64 | 3.3% | operator |
| 5546 | Hash Join | 209.48 | 230.26 | 9.9% | operator |
| 5550 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5547 | Seq Scan | 156.74 | 163.20 | 4.1% | operator |
| 5548 | Hash | 29.56 | 17.75 | 40.0% | operator |
...
### Step 2: Node 5547 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37331.9400
- **Output:** st=27.13, rt=230.26

### Step 5: Node 5550 (Index Scan) - LEAF
...
- **Output:** st=121.34, rt=1192.64

### Step 7: Node 5541 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5542, 5543, 5544
- **Input Features:**
