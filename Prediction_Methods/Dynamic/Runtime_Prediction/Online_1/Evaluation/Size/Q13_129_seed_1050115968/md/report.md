...
**Test Query:** Q13_129_seed_1050115968
...
```
Node 25587 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25588 (Aggregate) [consumed]
    Node 25589 (Aggregate)
      Node 25590 (Hash Join) [PATTERN: 895c6e8c]
        Node 25591 (Seq Scan) [consumed] - LEAF
        Node 25592 (Hash) [consumed]
          Node 25593 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25587 | 25588, 25590, 25591, 25592 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25590 | 25587, 25588, 25591, 25592 |
...
|------|------|--------|-----------|-----|--------|
| 25587 | Sort | 907.33 | 1079.91 | 19.0% | pattern |
| 25589 | Aggregate | 901.26 | 998.54 | 10.8% | operator |
| 25590 | Hash Join | 688.50 | 470.31 | 31.7% | pattern |
| 25593 | Index Only Scan | 10.40 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25593 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25590 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25587, 25588, 25591, 25592
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1469940
...
### Step 4: Node 25587 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25588, 25590, 25591, 25592
- **Input Features:**
