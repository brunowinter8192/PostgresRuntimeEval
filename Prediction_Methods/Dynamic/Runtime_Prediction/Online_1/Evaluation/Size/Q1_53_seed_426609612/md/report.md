...
Node 491 (Aggregate) - ROOT
  Node 492 (Gather Merge)
    Node 493 (Sort) [PATTERN: 1d35fb97]
      Node 494 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 493 | 494 |
...
|------|------|--------|-----------|-----|--------|
| 491 | Aggregate | 927.23 | 1195.81 | 29.0% | operator |
| 492 | Gather Merge | 927.20 | 1165.88 | 25.7% | operator |
| 493 | Sort | 909.59 | 1200.20 | 31.9% | pattern |
...
### Step 2: Node 493 (Sort) - PATTERN ROOT
...
### Step 4: Node 491 (Aggregate) - ROOT
