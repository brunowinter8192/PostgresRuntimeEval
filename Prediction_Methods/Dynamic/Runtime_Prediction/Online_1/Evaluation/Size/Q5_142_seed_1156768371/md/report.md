...
**Test Query:** Q5_142_seed_1156768371
...
```
Node 7821 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 7822 (Aggregate) [consumed]
    Node 7823 (Gather Merge) [consumed]
      Node 7824 (Aggregate)
        Node 7825 (Sort) [PATTERN: 3e2d5a00]
          Node 7826 (Hash Join) [consumed]
            Node 7827 (Nested Loop)
              Node 7828 (Hash Join)
                Node 7829 (Seq Scan) - LEAF
                Node 7830 (Hash) [PATTERN: 444761fb]
                  Node 7831 (Hash Join) [consumed]
                    Node 7832 (Seq Scan) [consumed] - LEAF
                    Node 7833 (Hash) [consumed]
                      Node 7834 (Hash Join) [consumed]
                        Node 7835 (Seq Scan) - LEAF
                        Node 7836 (Hash)
                          Node 7837 (Seq Scan) - LEAF
              Node 7838 (Index Scan) - LEAF
            Node 7839 (Hash)
              Node 7840 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 7830 | 7821, 7822, 7823, 7825, 7826, 7831, 7832, 7833, 7834 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 7821 | 7822, 7823, 7825, 7826, 7830, 7831, 7832, 7833, 7834 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 7825 | 7821, 7822, 7823, 7826, 7830, 7831, 7832, 7833, 7834 |
...
|------|------|--------|-----------|-----|--------|
| 7821 | Sort | 1075.52 | 2934.42 | 172.8% | pattern |
| 7824 | Aggregate | 1070.65 | 1128.78 | 5.4% | operator |
| 7825 | Sort | 1070.37 | 1835.92 | 71.5% | pattern |
| 7827 | Nested Loop | 1058.42 | 1188.42 | 12.3% | operator |
| 7839 | Hash | 3.45 | 18.67 | 441.5% | operator |
| 7828 | Hash Join | 219.00 | 253.07 | 15.6% | operator |
| 7838 | Index Scan | 0.07 | -0.22 | 397.3% | operator |
| 7840 | Seq Scan | 2.89 | 12.36 | 327.8% | operator |
| 7829 | Seq Scan | 167.37 | 159.81 | 4.5% | operator |
| 7830 | Hash | 37.79 | 46.85 | 24.0% | pattern |
| 7835 | Seq Scan | 0.01 | 11.81 | 168589.6% | operator |
| 7836 | Hash | 0.31 | 21.05 | 6691.4% | operator |
| 7837 | Seq Scan | 0.31 | 22.93 | 7370.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 7837 (Seq Scan) - LEAF
...
### Step 2: Node 7835 (Seq Scan) - LEAF
...
### Step 4: Node 7829 (Seq Scan) - LEAF
...
### Step 5: Node 7830 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 7821, 7822, 7823, 7825, 7826, 7831, 7832, 7833, 7834
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 7838 (Index Scan) - LEAF
...
### Step 8: Node 7840 (Seq Scan) - LEAF
...
### Step 11: Node 7825 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 7821, 7822, 7823, 7826, 7830, 7831, 7832, 7833, 7834
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 7821 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 7822, 7823, 7825, 7826, 7830, 7831, 7832, 7833, 7834
- **Input Features:**
