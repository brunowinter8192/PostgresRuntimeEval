    ...
    Node 18790 (Gather)
      Node 18791 (Aggregate)
        Node 18792 (Nested Loop)
          Node 18793 (Hash Join) [PATTERN: bb930825]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18793 | 18788, 18789, 18794, 18795, 18796 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18788 | 18789, 18793, 18794, 18795, 18796 |
...
|------|------|--------|-----------|-----|--------|
| 18788 | Sort | 1213.12 | 1047.04 | 13.7% | pattern |
...
| 18793 | Hash Join | 994.48 | 134.80 | 86.4% | pattern |
...
### Step 9: Node 18793 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18788, 18789, 18794, 18795, 18796
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 11: Node 18792 (Nested Loop)
...
### Step 14: Node 18788 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18789, 18793, 18794, 18795, 18796
- **Input Features:**
