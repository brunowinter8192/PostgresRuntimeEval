...
Node 411 (Aggregate) - ROOT
  Node 412 (Gather Merge)
    Node 413 (Sort) [PATTERN: 1d35fb97]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 413 | 414 |
...
|------|------|--------|-----------|-----|--------|
| 411 | Aggregate | 992.08 | 1195.90 | 20.5% | operator |
| 412 | Gather Merge | 992.03 | 1165.91 | 17.5% | operator |
| 413 | Sort | 972.09 | 1200.57 | 23.5% | pattern |
...
### Step 2: Node 413 (Sort) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=169010.3200
  - Sort_total_cost=169010.3300
- **Output:** st=1196.48, rt=1200.57

### Step 3: Node 412 (Gather Merge)
...
### Step 4: Node 411 (Aggregate) - ROOT
