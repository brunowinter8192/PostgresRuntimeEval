...
**Test Query:** Q3_82_seed_664526511
...
```
Node 5651 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5652 (Sort) [consumed]
    Node 5653 (Aggregate) [consumed]
      Node 5654 (Gather) [consumed]
        Node 5655 (Nested Loop)
          Node 5656 (Hash Join) [PATTERN: 895c6e8c]
            Node 5657 (Seq Scan) [consumed] - LEAF
            Node 5658 (Hash) [consumed]
              Node 5659 (Seq Scan) - LEAF
          Node 5660 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5651 | 5652, 5653, 5654, 5656, 5657, 5658 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5656 | 5651, 5652, 5653, 5654, 5657, 5658 |
...
|------|------|--------|-----------|-----|--------|
| 5651 | Limit | 1197.88 | 1151.18 | 3.9% | pattern |
| 5655 | Nested Loop | 1162.11 | 1192.98 | 2.7% | operator |
| 5656 | Hash Join | 207.25 | 242.46 | 17.0% | pattern |
| 5660 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5659 | Seq Scan | 28.80 | 38.57 | 33.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5659 (Seq Scan) - LEAF
...
### Step 2: Node 5656 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5651, 5652, 5653, 5654, 5657, 5658
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46811
  - HashJoin_nt1=234452
  ...
  - HashJoin_total_cost=37337.0800
  - Hash_Inner_np=0
  - Hash_Inner_nt=12479
...
### Step 3: Node 5660 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=72811.6600
- **Output:** st=121.74, rt=1192.98

### Step 5: Node 5651 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5652, 5653, 5654, 5656, 5657, 5658
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=313260
  - Aggregate_Outer_nt1=313260
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=109836.5600
  - Aggregate_Outer_total_cost=113752.3100
  - Gather_Outer_np=0
  - Gather_Outer_nt=313260
  - Gather_Outer_nt1=101052
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105137.6600
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=313260
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=120521.7500
  - Limit_total_cost=120521.7700
  - Sort_Outer_np=0
  - Sort_Outer_nt=313260
  - Sort_Outer_nt1=313260
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=120521.7500
  - Sort_Outer_total_cost=121304.9000
