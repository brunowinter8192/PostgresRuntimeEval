...
**Test Query:** Q4_99_seed_803995038
...
```
Node 6887 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6888 (Gather Merge) [consumed]
    Node 6889 (Sort) [consumed]
      Node 6890 (Aggregate) [consumed]
        Node 6891 (Nested Loop)
          Node 6892 (Seq Scan) - LEAF
          Node 6893 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6887 | 6888, 6889, 6890 |
...
|------|------|--------|-----------|-----|--------|
| 6887 | Aggregate | 1056.40 | 952.19 | 9.9% | pattern |
| 6891 | Nested Loop | 1049.53 | 1255.45 | 19.6% | operator |
| 6892 | Seq Scan | 165.94 | 154.66 | 6.8% | operator |
| 6893 | Index Scan | 0.06 | 11.10 | 17810.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6892 (Seq Scan) - LEAF
...
### Step 2: Node 6893 (Index Scan) - LEAF
