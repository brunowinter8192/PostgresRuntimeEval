...
**Test Query:** Q3_90_seed_730158759
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5741 | 5742, 5743, 5744, 5746, 5747, 5748 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5746 | 5741, 5742, 5743, 5744, 5747, 5748 |
...
|------|------|--------|-----------|-----|--------|
| 5741 | Limit | 1183.67 | 1151.18 | 2.7% | pattern |
| 5745 | Nested Loop | 1142.80 | 1193.14 | 4.4% | operator |
| 5746 | Hash Join | 210.90 | 242.49 | 15.0% | pattern |
| 5750 | Index Scan | 0.03 | -0.52 | 2172.3% | operator |
| 5749 | Seq Scan | 29.13 | 38.60 | 32.5% | operator |
...
- **Consumes:** Nodes 5741, 5742, 5743, 5744, 5747, 5748
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47054
  - HashJoin_nt1=237233
  ...
  - HashJoin_total_cost=37343.3600
  - Hash_Inner_np=0
  - Hash_Inner_nt=12397
...
### Step 3: Node 5750 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=72894.3500
- **Output:** st=121.91, rt=1193.14

### Step 5: Node 5741 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5742, 5743, 5744, 5746, 5747, 5748
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=311497
  - Aggregate_Outer_nt1=311497
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=109716.5000
  - Aggregate_Outer_total_cost=113610.2200
  - Gather_Outer_np=0
  - Gather_Outer_nt=311497
  - Gather_Outer_nt1=100483
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105044.0500
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=311497
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=120341.5500
  - Limit_total_cost=120341.5800
  - Sort_Outer_np=0
  - Sort_Outer_nt=311497
  - Sort_Outer_nt1=311497
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=120341.5500
  - Sort_Outer_total_cost=121120.3000
