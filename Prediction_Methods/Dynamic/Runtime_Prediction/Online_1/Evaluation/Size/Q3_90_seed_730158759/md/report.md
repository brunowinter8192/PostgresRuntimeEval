...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5741 | 5742, 5743, 5744 |
...
| 5745 | Nested Loop | 1142.80 | 1193.06 | 4.4% | operator |
| 5746 | Hash Join | 210.90 | 231.18 | 9.6% | operator |
| 5750 | Index Scan | 0.03 | -0.52 | 2172.3% | operator |
| 5747 | Seq Scan | 158.44 | 163.54 | 3.2% | operator |
| 5748 | Hash | 29.89 | 17.75 | 40.6% | operator |
...
### Step 2: Node 5747 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37343.3600
- **Output:** st=27.29, rt=231.18

### Step 5: Node 5750 (Index Scan) - LEAF
...
- **Output:** st=121.77, rt=1193.06

### Step 7: Node 5741 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5742, 5743, 5744
- **Input Features:**
