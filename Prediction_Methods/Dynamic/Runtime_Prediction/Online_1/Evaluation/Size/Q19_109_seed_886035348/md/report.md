...
**Test Query:** Q19_109_seed_886035348
...
```
Node 31283 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31284 (Gather) [consumed]
    Node 31285 (Aggregate) [consumed]
      Node 31286 (Hash Join) [consumed]
        Node 31287 (Seq Scan) - LEAF
        Node 31288 (Hash)
          Node 31289 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31283 | 31284, 31285, 31286 |
...
|------|------|--------|-----------|-----|--------|
| 31283 | Aggregate | 855.55 | 829.30 | 3.1% | pattern |
| 31287 | Seq Scan | 789.33 | 743.46 | 5.8% | operator |
| 31288 | Hash | 46.79 | 8.29 | 82.3% | operator |
| 31289 | Seq Scan | 46.70 | 23.76 | 49.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31289 (Seq Scan) - LEAF
...
### Step 2: Node 31287 (Seq Scan) - LEAF
...
### Step 4: Node 31283 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31284, 31285, 31286
- **Input Features:**
