...
```
Node 27001 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27002 (Gather) [consumed]
    Node 27003 (Aggregate) [consumed]
      Node 27004 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27001 | 27002, 27003, 27004 |
...
|------|------|--------|-----------|-----|--------|
| 27001 | Aggregate | 805.32 | 857.10 | 6.4% | pattern |
...
### Step 4: Node 27001 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27002, 27003, 27004
- **Input Features:**
