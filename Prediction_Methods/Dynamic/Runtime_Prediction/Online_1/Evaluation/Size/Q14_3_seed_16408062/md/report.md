...
**Test Query:** Q14_3_seed_16408062
...
```
Node 27001 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27002 (Gather) [consumed]
    Node 27003 (Aggregate) [consumed]
      Node 27004 (Hash Join)
        Node 27005 (Seq Scan) - LEAF
        Node 27006 (Hash)
          Node 27007 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27001 | 27002, 27003 |
...
|------|------|--------|-----------|-----|--------|
| 27001 | Aggregate | 805.32 | 848.32 | 5.3% | pattern |
| 27004 | Hash Join | 783.65 | 807.55 | 3.1% | operator |
| 27005 | Seq Scan | 733.17 | 758.41 | 3.4% | operator |
| 27006 | Hash | 42.82 | 9.38 | 78.1% | operator |
| 27007 | Seq Scan | 37.85 | 12.70 | 66.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27007 (Seq Scan) - LEAF
...
### Step 2: Node 27005 (Seq Scan) - LEAF
...
### Step 5: Node 27001 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27002, 27003
- **Input Features:**
