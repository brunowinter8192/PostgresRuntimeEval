...
**Test Query:** Q19_43_seed_344569302
...
```
Node 31829 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31830 (Gather) [consumed]
    Node 31831 (Aggregate) [consumed]
      Node 31832 (Hash Join) [consumed]
        Node 31833 (Seq Scan) - LEAF
        Node 31834 (Hash)
          Node 31835 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31829 | 31830, 31831, 31832 |
...
|------|------|--------|-----------|-----|--------|
| 31829 | Aggregate | 833.31 | 829.32 | 0.5% | pattern |
| 31833 | Seq Scan | 760.28 | 743.46 | 2.2% | operator |
| 31834 | Hash | 49.74 | 8.29 | 83.3% | operator |
| 31835 | Seq Scan | 49.63 | 23.76 | 52.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31835 (Seq Scan) - LEAF
...
### Step 2: Node 31833 (Seq Scan) - LEAF
...
### Step 4: Node 31829 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31830, 31831, 31832
- **Input Features:**
