...
```
Node 31829 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31830 (Gather) [consumed]
    Node 31831 (Aggregate) [consumed]
      Node 31832 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31829 | 31830, 31831 |
...
|------|------|--------|-----------|-----|--------|
| 31829 | Aggregate | 833.31 | 831.20 | 0.3% | pattern |
| 31832 | Hash Join | 812.21 | 766.06 | 5.7% | operator |
...
### Step 5: Node 31829 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31830, 31831
- **Input Features:**
