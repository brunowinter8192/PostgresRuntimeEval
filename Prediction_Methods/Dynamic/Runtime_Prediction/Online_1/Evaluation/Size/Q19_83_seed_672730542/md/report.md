...
```
Node 32137 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 32138 (Gather) [consumed]
    Node 32139 (Aggregate) [consumed]
      Node 32140 (Hash Join) [consumed]
        Node 32141 (Seq Scan) - LEAF
        Node 32142 (Hash)
          Node 32143 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 32137 | 32138, 32139, 32140 |
...
|------|------|--------|-----------|-----|--------|
| 32137 | Aggregate | 847.46 | 829.27 | 2.1% | pattern |
| 32141 | Seq Scan | 776.62 | 743.46 | 4.3% | operator |
| 32142 | Hash | 49.46 | 8.29 | 83.2% | operator |
| 32143 | Seq Scan | 49.31 | 23.76 | 51.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 32143 (Seq Scan) - LEAF
...
### Step 2: Node 32141 (Seq Scan) - LEAF
...
### Step 4: Node 32137 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 32138, 32139, 32140
- **Input Features:**
