...
```
Node 15409 (Aggregate) - ROOT
  Node 15410 (Gather Merge)
    Node 15411 (Sort)
          ...
          Node 15414 (Hash Join)
            Node 15415 (Nested Loop)
              Node 15416 (Hash Join)
                ...
                Node 15418 (Hash)
                  Node 15419 (Hash Join)
                    Node 15420 (Seq Scan) - LEAF
                    Node 15421 (Hash)
                      Node 15422 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 15409 | Aggregate | 1214.49 | 1178.29 | 3.0% | operator |
| 15410 | Gather Merge | 1214.01 | 1097.17 | 9.6% | operator |
...
| 15416 | Hash Join | 207.50 | 251.17 | 21.0% | operator |
...
| 15418 | Hash | 30.34 | 20.62 | 32.1% | operator |
| 15419 | Hash Join | 29.66 | 132.26 | 345.9% | operator |
| 15420 | Seq Scan | 28.11 | 23.03 | 18.1% | operator |
| 15421 | Hash | 0.21 | 23.66 | 11273.1% | operator |
| 15422 | Hash Join | 0.20 | 306.84 | 151050.7% | operator |
...
### Step 5: Node 15420 (Seq Scan) - LEAF
...
### Step 8: Node 15417 (Seq Scan) - LEAF
...
### Step 11: Node 15426 (Index Scan) - LEAF
...
### Step 12: Node 15428 (Seq Scan) - LEAF
...
### Step 13: Node 15415 (Nested Loop)
...
### Step 16: Node 15429 (Index Scan) - LEAF
...
### Step 17: Node 15431 (Seq Scan) - LEAF
...
### Step 18: Node 15413 (Nested Loop)
...
### Step 22: Node 15410 (Gather Merge)
...
### Step 23: Node 15409 (Aggregate) - ROOT
