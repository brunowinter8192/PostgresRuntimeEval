...
```
Node 18264 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18265 (Aggregate) [consumed]
    Node 18266 (Gather)
      Node 18267 (Aggregate)
        Node 18268 (Nested Loop)
          Node 18269 (Hash Join) [PATTERN: bb930825]
            Node 18270 (Seq Scan) [consumed] - LEAF
            Node 18271 (Hash) [consumed]
              Node 18272 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18269 | 18264, 18265, 18270, 18271, 18272 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18264 | 18265, 18269, 18270, 18271, 18272 |
...
|------|------|--------|-----------|-----|--------|
| 18264 | Sort | 1194.07 | 1045.32 | 12.5% | pattern |
...
| 18269 | Hash Join | 973.96 | 134.80 | 86.2% | pattern |
...
### Step 9: Node 18269 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18264, 18265, 18270, 18271, 18272
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18281 (Index Scan) - LEAF
...
### Step 11: Node 18268 (Nested Loop)
...
### Step 14: Node 18264 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18265, 18269, 18270, 18271, 18272
- **Input Features:**
