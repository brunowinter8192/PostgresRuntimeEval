...
**Test Query:** Q19_144_seed_1173176433
...
```
Node 31556 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31557 (Gather) [consumed]
    Node 31558 (Aggregate) [consumed]
      Node 31559 (Hash Join) [consumed]
        Node 31560 (Seq Scan) - LEAF
        Node 31561 (Hash)
          Node 31562 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31556 | 31557, 31558, 31559 |
...
|------|------|--------|-----------|-----|--------|
| 31556 | Aggregate | 840.54 | 829.32 | 1.3% | pattern |
| 31560 | Seq Scan | 769.94 | 743.46 | 3.4% | operator |
| 31561 | Hash | 45.41 | 8.29 | 81.8% | operator |
| 31562 | Seq Scan | 45.28 | 23.76 | 47.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31562 (Seq Scan) - LEAF
...
### Step 2: Node 31560 (Seq Scan) - LEAF
...
### Step 4: Node 31556 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31557, 31558, 31559
- **Input Features:**
  ...
  - HashJoin_Outer_total_cost=156338.6400
