...
**Test Query:** Q9_70_seed_566078139
...
```
Node 18770 (Sort) - ROOT
  Node 18771 (Aggregate)
    Node 18772 (Gather)
      Node 18773 (Aggregate)
        Node 18774 (Nested Loop)
          Node 18775 (Hash Join)
            Node 18776 (Seq Scan) - LEAF
            Node 18777 (Hash)
              Node 18778 (Hash Join)
                Node 18779 (Hash Join)
                  Node 18780 (Nested Loop)
                    Node 18781 (Seq Scan) - LEAF
                    Node 18782 (Index Scan) - LEAF
                  Node 18783 (Hash)
                    Node 18784 (Seq Scan) - LEAF
                Node 18785 (Hash)
                  Node 18786 (Seq Scan) - LEAF
          Node 18787 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 18770 | Sort | 1190.39 | 1119.51 | 6.0% | operator |
| 18771 | Aggregate | 1190.26 | 897.44 | 24.6% | operator |
| 18772 | Gather | 1189.28 | 964.64 | 18.9% | operator |
| 18773 | Aggregate | 1170.12 | 1095.61 | 6.4% | operator |
| 18774 | Nested Loop | 1144.74 | 1252.17 | 9.4% | operator |
| 18775 | Hash Join | 970.43 | 633.32 | 34.7% | operator |
| 18787 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18776 | Seq Scan | 701.88 | 509.93 | 27.3% | operator |
| 18777 | Hash | 174.70 | 47.91 | 72.6% | operator |
| 18778 | Hash Join | 172.66 | 924.43 | 435.4% | operator |
| 18779 | Hash Join | 158.74 | 837.61 | 427.6% | operator |
| 18785 | Hash | 13.28 | 14.95 | 12.6% | operator |
| 18780 | Nested Loop | 152.34 | 1251.77 | 721.7% | operator |
| 18783 | Hash | 4.39 | 15.94 | 263.0% | operator |
| 18786 | Seq Scan | 13.26 | 2.94 | 77.9% | operator |
| 18781 | Seq Scan | 20.27 | 44.03 | 117.2% | operator |
| 18782 | Index Scan | 0.07 | -1.39 | 2002.0% | operator |
| 18784 | Seq Scan | 3.93 | 9.45 | 140.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 18781 (Seq Scan) - LEAF
...
### Step 2: Node 18782 (Index Scan) - LEAF
...
### Step 3: Node 18784 (Seq Scan) - LEAF
...
### Step 6: Node 18786 (Seq Scan) - LEAF
...
### Step 10: Node 18776 (Seq Scan) - LEAF
...
### Step 13: Node 18787 (Index Scan) - LEAF
...
### Step 14: Node 18774 (Nested Loop)
