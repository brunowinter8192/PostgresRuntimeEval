...
```
Node 18770 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18771 (Aggregate) [consumed]
    Node 18772 (Gather)
      Node 18773 (Aggregate)
        Node 18774 (Nested Loop)
          Node 18775 (Hash Join) [PATTERN: bb930825]
            Node 18776 (Seq Scan) [consumed] - LEAF
            Node 18777 (Hash) [consumed]
              Node 18778 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18775 | 18770, 18771, 18776, 18777, 18778 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18770 | 18771, 18775, 18776, 18777, 18778 |
...
|------|------|--------|-----------|-----|--------|
| 18770 | Sort | 1190.39 | 1045.32 | 12.2% | pattern |
...
| 18775 | Hash Join | 970.43 | 134.80 | 86.1% | pattern |
...
### Step 9: Node 18775 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18770, 18771, 18776, 18777, 18778
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18787 (Index Scan) - LEAF
...
### Step 11: Node 18774 (Nested Loop)
...
### Step 14: Node 18770 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18771, 18775, 18776, 18777, 18778
- **Input Features:**
