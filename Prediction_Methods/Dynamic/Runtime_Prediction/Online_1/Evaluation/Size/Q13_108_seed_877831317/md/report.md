...
**Test Query:** Q13_108_seed_877831317
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25426 | 25427, 25429, 25430, 25431 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25429 | 25426, 25427, 25430, 25431 |
...
|------|------|--------|-----------|-----|--------|
| 25426 | Sort | 905.98 | 1079.91 | 19.2% | pattern |
| 25428 | Aggregate | 899.95 | 998.54 | 11.0% | operator |
| 25429 | Hash Join | 683.58 | 470.31 | 31.2% | pattern |
| 25432 | Index Only Scan | 9.87 | 0.00 | 100.0% | operator |
...
- **Consumes:** Nodes 25426, 25427, 25430, 25431
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1469940
...
### Step 4: Node 25426 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25427, 25429, 25430, 25431
- **Input Features:**
