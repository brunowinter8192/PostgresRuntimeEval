...
**Test Query:** Q19_55_seed_443017674
...
```
Node 31920 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31921 (Gather) [consumed]
    Node 31922 (Aggregate) [consumed]
      Node 31923 (Hash Join) [consumed]
        Node 31924 (Seq Scan) - LEAF
        Node 31925 (Hash)
          Node 31926 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31920 | 31921, 31922, 31923 |
...
|------|------|--------|-----------|-----|--------|
| 31920 | Aggregate | 843.91 | 829.30 | 1.7% | pattern |
| 31924 | Seq Scan | 774.98 | 743.46 | 4.1% | operator |
| 31925 | Hash | 49.01 | 8.29 | 83.1% | operator |
| 31926 | Seq Scan | 48.94 | 23.76 | 51.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31926 (Seq Scan) - LEAF
...
### Step 2: Node 31924 (Seq Scan) - LEAF
...
### Step 4: Node 31920 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31921, 31922, 31923
- **Input Features:**
  ...
  - Aggregate_Outer_startup_cost=156338.9100
  - Aggregate_Outer_total_cost=156338.9200
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Gather_Outer_startup_cost=157338.9100
  - Gather_Outer_total_cost=157339.4200
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=23
  - HashJoin_Outer_nt1=22578
  ...
  - HashJoin_Outer_total_cost=156338.7400
