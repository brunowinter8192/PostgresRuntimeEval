...
```
Node 31948 (Aggregate) [PATTERN: efde8b38] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31948 | 31949, 31950, 31951 |
...
|------|------|--------|-----------|-----|--------|
| 31948 | Aggregate | 851.89 | 829.32 | 2.6% | pattern |
| 31952 | Seq Scan | 778.90 | 743.46 | 4.6% | operator |
| 31953 | Hash | 48.12 | 8.29 | 82.8% | operator |
| 31954 | Seq Scan | 48.01 | 23.76 | 50.5% | operator |
...
### Step 4: Node 31948 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31949, 31950, 31951
- **Input Features:**
