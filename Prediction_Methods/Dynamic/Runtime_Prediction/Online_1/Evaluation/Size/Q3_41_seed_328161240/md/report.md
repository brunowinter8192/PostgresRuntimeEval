...
**Test Query:** Q3_41_seed_328161240
...
```
Node 5201 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5202 (Sort) [consumed]
    Node 5203 (Aggregate) [consumed]
      Node 5204 (Gather) [consumed]
        Node 5205 (Nested Loop)
          Node 5206 (Hash Join) [PATTERN: 895c6e8c]
            Node 5207 (Seq Scan) [consumed] - LEAF
            Node 5208 (Hash) [consumed]
              Node 5209 (Seq Scan) - LEAF
          Node 5210 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5201 | 5202, 5203, 5204, 5206, 5207, 5208 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5206 | 5201, 5202, 5203, 5204, 5207, 5208 |
...
|------|------|--------|-----------|-----|--------|
| 5201 | Limit | 1199.13 | 1151.18 | 4.0% | pattern |
| 5205 | Nested Loop | 1160.65 | 1192.64 | 2.8% | operator |
| 5206 | Hash Join | 208.03 | 242.40 | 16.5% | pattern |
| 5210 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5209 | Seq Scan | 27.33 | 38.60 | 41.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5209 (Seq Scan) - LEAF
...
### Step 2: Node 5206 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5201, 5202, 5203, 5204, 5207, 5208
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46283
  - HashJoin_nt1=233346
  ...
  - HashJoin_total_cost=37333.1600
  - Hash_Inner_np=0
  - Hash_Inner_nt=12397
...
- **Output:** st=29.78, rt=242.40

### Step 3: Node 5210 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=72450.4400
- **Output:** st=121.42, rt=1192.64

### Step 5: Node 5201 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5202, 5203, 5204, 5206, 5207, 5208
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=311100
  - Aggregate_Outer_nt1=311100
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=109226.9400
  - Aggregate_Outer_total_cost=113115.6900
  - Gather_Outer_np=0
  - Gather_Outer_nt=311100
  - Gather_Outer_nt1=100355
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=104560.4400
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=311100
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=119838.4500
  - Limit_total_cost=119838.4800
  - Sort_Outer_np=0
  - Sort_Outer_nt=311100
  - Sort_Outer_nt1=311100
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=119838.4500
  - Sort_Outer_total_cost=120616.2000
