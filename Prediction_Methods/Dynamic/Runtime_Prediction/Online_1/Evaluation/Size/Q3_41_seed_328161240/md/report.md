...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5201 | 5202, 5203, 5204 |
...
| 5205 | Nested Loop | 1160.65 | 1192.55 | 2.7% | operator |
| 5206 | Hash Join | 208.03 | 230.40 | 10.7% | operator |
| 5210 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5207 | Seq Scan | 156.28 | 163.26 | 4.5% | operator |
| 5208 | Hash | 28.15 | 17.75 | 36.9% | operator |
...
### Step 2: Node 5207 (Seq Scan) - LEAF
...
- **Output:** st=0.29, rt=163.26

### Step 3: Node 5208 (Hash)
...
- **Input Features:**
  ...
  - total_cost=37333.1600
- **Output:** st=27.17, rt=230.40

### Step 5: Node 5210 (Index Scan) - LEAF
...
- **Output:** st=121.27, rt=1192.55

### Step 7: Node 5201 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5202, 5203, 5204
- **Input Features:**
