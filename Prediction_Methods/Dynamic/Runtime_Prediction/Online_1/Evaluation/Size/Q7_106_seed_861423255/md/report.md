...
```
Node 10609 (Aggregate) - ROOT
  Node 10610 (Gather Merge)
    Node 10611 (Sort)
      Node 10612 (Hash Join)
        Node 10613 (Nested Loop)
          Node 10614 (Hash Join)
            Node 10615 (Seq Scan) - LEAF
            Node 10616 (Hash)
              Node 10617 (Hash Join)
                Node 10618 (Seq Scan) - LEAF
                Node 10619 (Hash)
                  Node 10620 (Seq Scan) - LEAF
          Node 10621 (Index Scan) - LEAF
        Node 10622 (Hash)
          Node 10623 (Hash Join)
            Node 10624 (Seq Scan) - LEAF
            Node 10625 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 10609 | Aggregate | 1207.67 | 1209.26 | 0.1% | operator |
| 10610 | Gather Merge | 1206.61 | 1142.98 | 5.3% | operator |
| 10611 | Sort | 1200.46 | 1109.13 | 7.6% | operator |
| 10612 | Hash Join | 1199.83 | 842.59 | 29.8% | operator |
| 10613 | Nested Loop | 1193.21 | 1216.16 | 1.9% | operator |
| 10622 | Hash | 2.75 | 17.53 | 538.4% | operator |
| 10614 | Hash Join | 211.07 | 384.47 | 82.2% | operator |
| 10621 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 10623 | Hash Join | 2.70 | 85.17 | 3053.4% | operator |
| 10615 | Seq Scan | 150.65 | 201.16 | 33.5% | operator |
| 10616 | Hash | 35.10 | 19.59 | 44.2% | operator |
| 10624 | Seq Scan | 2.37 | 11.47 | 383.6% | operator |
| 10625 | Hash | 0.01 | 16.89 | 129854.5% | operator |
| 10617 | Hash Join | 34.78 | 92.20 | 165.1% | operator |
| 10626 | Seq Scan | 0.01 | 45.79 | 457823.2% | operator |
| 10618 | Seq Scan | 33.62 | 21.86 | 35.0% | operator |
| 10619 | Hash | 0.01 | 16.89 | 168840.8% | operator |
| 10620 | Seq Scan | 0.01 | 45.79 | 763105.3% | operator |
...
### Step 2: Node 10618 (Seq Scan) - LEAF
...
### Step 5: Node 10626 (Seq Scan) - LEAF
...
### Step 6: Node 10615 (Seq Scan) - LEAF
...
### Step 8: Node 10624 (Seq Scan) - LEAF
...
### Step 11: Node 10621 (Index Scan) - LEAF
...
### Step 13: Node 10613 (Nested Loop)
...
### Step 17: Node 10610 (Gather Merge)
...
### Step 18: Node 10609 (Aggregate) - ROOT
