...
**Test Query:** Q10_130_seed_1058319999
...
```
Node 19799 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 19800 (Sort) [consumed]
    Node 19801 (Aggregate) [consumed]
      Node 19802 (Gather) [consumed]
        Node 19803 (Hash Join)
          Node 19804 (Hash Join) [PATTERN: 2e0f44ef]
            Node 19805 (Nested Loop) [consumed]
              Node 19806 (Seq Scan) - LEAF
              Node 19807 (Index Scan) - LEAF
            Node 19808 (Hash) [consumed]
              Node 19809 (Seq Scan) - LEAF
          Node 19810 (Hash)
            Node 19811 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19799 | 19800, 19801, 19802, 19804, 19805, 19808 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 19804 | 19799, 19800, 19801, 19802, 19805, 19808 |
...
|------|------|--------|-----------|-----|--------|
| 19799 | Limit | 1161.50 | 1199.47 | 3.3% | pattern |
| 19803 | Hash Join | 1107.14 | 1095.55 | 1.0% | operator |
| 19804 | Hash Join | 1104.29 | 1120.19 | 1.4% | pattern |
| 19810 | Hash | 0.01 | 15.71 | 112119.8% | operator |
| 19811 | Seq Scan | 0.01 | 6.98 | 69687.0% | operator |
| 19806 | Seq Scan | 163.14 | 159.74 | 2.1% | operator |
| 19807 | Index Scan | 0.06 | -0.52 | 922.6% | operator |
| 19809 | Seq Scan | 23.61 | 26.64 | 12.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 19806 (Seq Scan) - LEAF
...
### Step 2: Node 19807 (Index Scan) - LEAF
...
### Step 3: Node 19809 (Seq Scan) - LEAF
...
### Step 4: Node 19811 (Seq Scan) - LEAF
...
### Step 5: Node 19804 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 19799, 19800, 19801, 19802, 19805, 19808
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18184
  - HashJoin_nt1=18184
...
### Step 8: Node 19799 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19800, 19801, 19802, 19804, 19805, 19808
- **Input Features:**
