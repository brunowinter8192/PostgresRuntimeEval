        ...
        Node 29880 (Incremental Sort)
          Node 29881 (Nested Loop)
            Node 29882 (Merge Join)
              Node 29883 (Sort)
                Node 29884 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29885 (Seq Scan) [consumed] - LEAF
                  Node 29886 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29884 | 29885, 29886 |
...
| 29883 | Sort | 2835.34 | 1095.58 | 61.4% | operator |
| 29889 | Sort | 65.33 | 1074.66 | 1545.0% | operator |
| 29884 | Hash Join | 2835.33 | 471.07 | 83.4% | pattern |
...
### Step 3: Node 29884 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29885, 29886
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29890 (Seq Scan) - LEAF
...
### Step 7: Node 29882 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29891 (Index Scan) - LEAF
...
### Step 10: Node 29880 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29879 (Gather Merge)
