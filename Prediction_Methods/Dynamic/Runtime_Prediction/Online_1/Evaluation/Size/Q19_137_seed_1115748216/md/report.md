...
**Test Query:** Q19_137_seed_1115748216
...
```
Node 31500 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31501 (Gather) [consumed]
    Node 31502 (Aggregate) [consumed]
      Node 31503 (Hash Join) [consumed]
        Node 31504 (Seq Scan) - LEAF
        Node 31505 (Hash)
          Node 31506 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31500 | 31501, 31502, 31503 |
...
|------|------|--------|-----------|-----|--------|
| 31500 | Aggregate | 801.91 | 829.29 | 3.4% | pattern |
| 31504 | Seq Scan | 735.23 | 743.46 | 1.1% | operator |
| 31505 | Hash | 45.03 | 8.29 | 81.6% | operator |
| 31506 | Seq Scan | 44.88 | 23.76 | 47.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31506 (Seq Scan) - LEAF
...
### Step 2: Node 31504 (Seq Scan) - LEAF
...
### Step 4: Node 31500 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31501, 31502, 31503
- **Input Features:**
