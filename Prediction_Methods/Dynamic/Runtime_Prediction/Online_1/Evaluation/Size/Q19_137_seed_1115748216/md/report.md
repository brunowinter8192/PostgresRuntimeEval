...
```
Node 31500 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31501 (Gather) [consumed]
    Node 31502 (Aggregate) [consumed]
      Node 31503 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31500 | 31501, 31502 |
...
|------|------|--------|-----------|-----|--------|
| 31500 | Aggregate | 801.91 | 831.20 | 3.7% | pattern |
| 31503 | Hash Join | 782.01 | 766.06 | 2.0% | operator |
...
- **Input Features:**
  ...
  - total_cost=156338.6100
- **Output:** st=60.26, rt=766.06

### Step 5: Node 31500 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31501, 31502
- **Input Features:**
