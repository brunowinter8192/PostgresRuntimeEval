...
**Test Query:** Q1_97_seed_787586976
...
```
Node 731 (Aggregate) - ROOT
  Node 732 (Gather Merge)
    Node 733 (Sort) [PATTERN: 1d35fb97]
      Node 734 (Aggregate) [consumed]
        Node 735 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 733 | 734 |
...
|------|------|--------|-----------|-----|--------|
| 731 | Aggregate | 946.09 | 1195.80 | 26.4% | operator |
| 732 | Gather Merge | 946.05 | 1165.88 | 23.2% | operator |
| 733 | Sort | 928.30 | 1200.16 | 29.3% | pattern |
| 735 | Seq Scan | 515.67 | 681.57 | 32.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 735 (Seq Scan) - LEAF
...
### Step 2: Node 733 (Sort) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Aggregate_Outer_nt1=1175039
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=236
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=168729.4000
  - Aggregate_Outer_total_cost=168729.5400
  - Sort_np=0
  - Sort_nt=6
  - Sort_nt1=6
  - Sort_nt2=0
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=168729.6200
  - Sort_total_cost=168729.6300
- **Output:** st=1196.06, rt=1200.16

### Step 3: Node 732 (Gather Merge)
...
### Step 4: Node 731 (Aggregate) - ROOT
