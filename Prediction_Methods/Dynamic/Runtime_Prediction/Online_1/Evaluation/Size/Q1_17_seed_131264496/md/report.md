...
**Test Query:** Q1_17_seed_131264496
...
```
Node 291 (Aggregate) - ROOT
  Node 292 (Gather Merge)
    Node 293 (Sort) [PATTERN: 1d35fb97]
      Node 294 (Aggregate) [consumed]
        Node 295 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 293 | 294 |
...
|------|------|--------|-----------|-----|--------|
| 291 | Aggregate | 941.47 | 1195.91 | 27.0% | operator |
| 292 | Gather Merge | 941.41 | 1165.91 | 23.8% | operator |
| 293 | Sort | 921.53 | 1200.59 | 30.3% | pattern |
| 295 | Seq Scan | 518.99 | 679.93 | 31.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 295 (Seq Scan) - LEAF
...
### Step 2: Node 293 (Sort) - PATTERN ROOT
...
### Step 4: Node 291 (Aggregate) - ROOT
