...
**Test Query:** Q19_119_seed_968075658
...
```
Node 31360 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31361 (Gather) [consumed]
    Node 31362 (Aggregate) [consumed]
      Node 31363 (Hash Join) [consumed]
        Node 31364 (Seq Scan) - LEAF
        Node 31365 (Hash)
          Node 31366 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31360 | 31361, 31362, 31363 |
...
|------|------|--------|-----------|-----|--------|
| 31360 | Aggregate | 836.25 | 829.31 | 0.8% | pattern |
| 31364 | Seq Scan | 769.90 | 743.46 | 3.4% | operator |
| 31365 | Hash | 45.30 | 8.29 | 81.7% | operator |
| 31366 | Seq Scan | 45.13 | 23.76 | 47.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31366 (Seq Scan) - LEAF
...
### Step 2: Node 31364 (Seq Scan) - LEAF
...
### Step 4: Node 31360 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31361, 31362, 31363
- **Input Features:**
  ...
  - Aggregate_Outer_startup_cost=156338.6600
  - Aggregate_Outer_total_cost=156338.6700
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=157339.2000
  - Aggregate_total_cost=157339.2100
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=157338.6600
  - Gather_Outer_total_cost=157339.1700
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=23
  - HashJoin_Outer_nt1=22469
  ...
  - HashJoin_Outer_total_cost=156338.4900
- **Output:** st=824.27, rt=829.31
