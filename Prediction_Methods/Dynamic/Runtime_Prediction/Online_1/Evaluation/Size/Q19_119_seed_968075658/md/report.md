...
```
Node 31360 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31361 (Gather) [consumed]
    Node 31362 (Aggregate) [consumed]
      Node 31363 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31360 | 31361, 31362 |
...
|------|------|--------|-----------|-----|--------|
| 31360 | Aggregate | 836.25 | 831.20 | 0.6% | pattern |
| 31363 | Hash Join | 817.16 | 766.05 | 6.3% | operator |
...
- **Input Features:**
  ...
  - total_cost=156338.4900
- **Output:** st=60.26, rt=766.05

### Step 5: Node 31360 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31361, 31362
- **Input Features:**
