...
```
Node 26448 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26449 (Gather) [consumed]
    Node 26450 (Aggregate) [consumed]
      Node 26451 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26448 | 26449, 26450, 26451 |
...
|------|------|--------|-----------|-----|--------|
| 26448 | Aggregate | 803.19 | 857.12 | 6.7% | pattern |
...
### Step 4: Node 26448 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26449, 26450, 26451
- **Input Features:**
