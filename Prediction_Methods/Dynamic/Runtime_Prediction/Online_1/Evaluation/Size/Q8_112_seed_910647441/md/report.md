...
```
Node 13500 (Aggregate) - ROOT
  Node 13501 (Gather Merge)
    Node 13502 (Sort)
          ...
          Node 13505 (Hash Join)
            Node 13506 (Nested Loop)
              Node 13507 (Hash Join)
                ...
                Node 13509 (Hash)
                  Node 13510 (Hash Join)
                    Node 13511 (Seq Scan) - LEAF
                    Node 13512 (Hash)
                      Node 13513 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 13500 | Aggregate | 1260.42 | 1195.83 | 5.1% | operator |
| 13501 | Gather Merge | 1260.04 | 1097.18 | 12.9% | operator |
...
| 13507 | Hash Join | 222.59 | 251.17 | 12.8% | operator |
...
| 13509 | Hash | 42.23 | 20.62 | 51.2% | operator |
| 13510 | Hash Join | 41.56 | 132.26 | 218.2% | operator |
| 13511 | Seq Scan | 39.92 | 23.03 | 42.3% | operator |
| 13512 | Hash | 0.23 | 23.66 | 9966.4% | operator |
| 13513 | Hash Join | 0.23 | 306.84 | 132156.9% | operator |
...
### Step 5: Node 13511 (Seq Scan) - LEAF
...
### Step 8: Node 13508 (Seq Scan) - LEAF
...
### Step 11: Node 13517 (Index Scan) - LEAF
...
### Step 12: Node 13519 (Seq Scan) - LEAF
...
### Step 13: Node 13506 (Nested Loop)
...
### Step 16: Node 13520 (Index Scan) - LEAF
...
### Step 17: Node 13522 (Seq Scan) - LEAF
...
### Step 18: Node 13504 (Nested Loop)
...
### Step 22: Node 13501 (Gather Merge)
...
- **Input Features:**
  ...
  - total_cost=71815.4600
- **Output:** st=1093.48, rt=1097.18

### Step 23: Node 13500 (Aggregate) - ROOT
