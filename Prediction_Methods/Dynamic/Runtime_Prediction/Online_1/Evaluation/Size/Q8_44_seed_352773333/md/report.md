...
```
Node 15225 (Aggregate) - ROOT
  Node 15226 (Gather Merge)
    Node 15227 (Sort)
          ...
          Node 15230 (Hash Join)
            Node 15231 (Nested Loop)
              Node 15232 (Hash Join)
                ...
                Node 15234 (Hash)
                  Node 15235 (Hash Join)
                    Node 15236 (Seq Scan) - LEAF
                    Node 15237 (Hash)
                      Node 15238 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 15225 | Aggregate | 1224.36 | 1194.14 | 2.5% | operator |
| 15226 | Gather Merge | 1223.92 | 1097.16 | 10.4% | operator |
...
| 15232 | Hash Join | 210.89 | 251.17 | 19.1% | operator |
...
| 15234 | Hash | 32.46 | 20.62 | 36.5% | operator |
| 15235 | Hash Join | 31.71 | 132.26 | 317.1% | operator |
| 15236 | Seq Scan | 30.19 | 23.03 | 23.7% | operator |
| 15237 | Hash | 0.09 | 23.66 | 27730.7% | operator |
| 15238 | Hash Join | 0.08 | 306.84 | 374090.2% | operator |
...
### Step 5: Node 15236 (Seq Scan) - LEAF
...
### Step 8: Node 15233 (Seq Scan) - LEAF
...
### Step 11: Node 15242 (Index Scan) - LEAF
...
### Step 12: Node 15244 (Seq Scan) - LEAF
...
### Step 13: Node 15231 (Nested Loop)
...
### Step 16: Node 15245 (Index Scan) - LEAF
...
### Step 17: Node 15247 (Seq Scan) - LEAF
...
### Step 18: Node 15229 (Nested Loop)
...
### Step 22: Node 15226 (Gather Merge)
...
### Step 23: Node 15225 (Aggregate) - ROOT
