...
**Test Query:** Q8_44_seed_352773333
**Timestamp:** 2026-01-18 18:36:30
...
```
Node 15225 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 15226 (Gather Merge) [consumed]
    Node 15227 (Sort)
      Node 15228 (Hash Join)
        Node 15229 (Nested Loop)
          Node 15230 (Hash Join)
            Node 15231 (Nested Loop)
              Node 15232 (Hash Join)
                Node 15233 (Seq Scan) - LEAF
                Node 15234 (Hash) [PATTERN: 444761fb]
                  Node 15235 (Hash Join) [consumed]
                    Node 15236 (Seq Scan) [consumed] - LEAF
                    Node 15237 (Hash) [consumed]
                      Node 15238 (Hash Join) [consumed]
                        Node 15239 (Seq Scan) - LEAF
                        Node 15240 (Hash)
                          Node 15241 (Seq Scan) - LEAF
              Node 15242 (Index Scan) - LEAF
            Node 15243 (Hash)
              Node 15244 (Seq Scan) - LEAF
          Node 15245 (Index Scan) - LEAF
        Node 15246 (Hash)
          Node 15247 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 15234 | 15225, 15226, 15235, 15236, 15237, 15238 |
| Aggregate -> Gather Merge (Out | 2724c080 | 15225 | 15226, 15234, 15235, 15236, 15237, 15238 |
...
|------|------|--------|-----------|-----|--------|
| 15225 | Aggregate | 1224.36 | 1132.74 | 7.5% | pattern |
| 15227 | Sort | 1219.88 | 1046.21 | 14.2% | operator |
| 15228 | Hash Join | 1219.65 | 785.61 | 35.6% | operator |
| 15229 | Nested Loop | 1219.33 | 1198.29 | 1.7% | operator |
| 15246 | Hash | 0.02 | 13.72 | 80629.9% | operator |
| 15230 | Hash Join | 1215.43 | 785.60 | 35.4% | operator |
| 15245 | Index Scan | 0.01 | 12.42 | 206958.1% | operator |
| 15247 | Seq Scan | 0.01 | 6.51 | 49992.0% | operator |
| 15231 | Nested Loop | 1171.71 | 1198.29 | 2.3% | operator |
| 15243 | Hash | 39.28 | 19.97 | 49.2% | operator |
| 15232 | Hash Join | 210.89 | 251.67 | 19.3% | operator |
| 15242 | Index Scan | 0.04 | 2.88 | 6759.2% | operator |
| 15244 | Seq Scan | 39.20 | 48.87 | 24.7% | operator |
| 15233 | Seq Scan | 159.57 | 159.67 | 0.1% | operator |
| 15234 | Hash | 32.46 | 43.51 | 34.0% | pattern |
| 15239 | Seq Scan | 0.01 | 12.22 | 152711.8% | operator |
| 15240 | Hash | 0.07 | 18.14 | 27391.1% | operator |
| 15241 | Seq Scan | 0.06 | 23.36 | 37581.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 15241 (Seq Scan) - LEAF
...
### Step 2: Node 15239 (Seq Scan) - LEAF
...
### Step 4: Node 15233 (Seq Scan) - LEAF
...
### Step 5: Node 15234 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 15225, 15226, 15235, 15236, 15237, 15238
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 15242 (Index Scan) - LEAF
...
### Step 8: Node 15244 (Seq Scan) - LEAF
...
### Step 12: Node 15245 (Index Scan) - LEAF
...
### Step 13: Node 15247 (Seq Scan) - LEAF
...
### Step 14: Node 15229 (Nested Loop)
...
### Step 18: Node 15225 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 15226, 15234, 15235, 15236, 15237, 15238
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2424
