...
```
Node 12157 (Aggregate) - ROOT
  Node 12158 (Gather Merge)
    Node 12159 (Sort)
      Node 12160 (Hash Join)
        Node 12161 (Nested Loop)
          Node 12162 (Hash Join)
            Node 12163 (Seq Scan) - LEAF
            Node 12164 (Hash)
              Node 12165 (Hash Join)
                Node 12166 (Seq Scan) - LEAF
                Node 12167 (Hash)
                  Node 12168 (Seq Scan) - LEAF
          Node 12169 (Index Scan) - LEAF
        Node 12170 (Hash)
          Node 12171 (Hash Join)
            Node 12172 (Seq Scan) - LEAF
            Node 12173 (Hash)
              Node 12174 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12157 | Aggregate | 1217.62 | 1209.26 | 0.7% | operator |
| 12158 | Gather Merge | 1216.59 | 1142.98 | 6.1% | operator |
| 12159 | Sort | 1210.11 | 1109.13 | 8.3% | operator |
| 12160 | Hash Join | 1209.44 | 842.59 | 30.3% | operator |
| 12161 | Nested Loop | 1201.86 | 1216.16 | 1.2% | operator |
| 12170 | Hash | 3.80 | 17.53 | 360.9% | operator |
| 12162 | Hash Join | 215.40 | 384.47 | 78.5% | operator |
| 12169 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 12171 | Hash Join | 3.76 | 85.17 | 2166.5% | operator |
| 12163 | Seq Scan | 152.19 | 201.16 | 32.2% | operator |
| 12164 | Hash | 36.92 | 19.59 | 46.9% | operator |
| 12172 | Seq Scan | 3.42 | 11.47 | 235.0% | operator |
| 12173 | Hash | 0.01 | 16.89 | 120572.0% | operator |
| 12165 | Hash Join | 34.84 | 92.20 | 164.7% | operator |
| 12174 | Seq Scan | 0.01 | 45.79 | 457823.2% | operator |
| 12166 | Seq Scan | 33.73 | 21.86 | 35.2% | operator |
| 12167 | Hash | 0.01 | 16.89 | 168840.8% | operator |
| 12168 | Seq Scan | 0.01 | 45.79 | 763105.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12168 (Seq Scan) - LEAF
...
### Step 2: Node 12166 (Seq Scan) - LEAF
...
### Step 5: Node 12174 (Seq Scan) - LEAF
...
### Step 6: Node 12163 (Seq Scan) - LEAF
...
### Step 8: Node 12172 (Seq Scan) - LEAF
...
### Step 11: Node 12169 (Index Scan) - LEAF
...
### Step 13: Node 12161 (Nested Loop)
...
### Step 17: Node 12158 (Gather Merge)
...
### Step 18: Node 12157 (Aggregate) - ROOT
