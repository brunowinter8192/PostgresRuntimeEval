...
```
Node 12139 (Aggregate) - ROOT
  Node 12140 (Gather Merge)
    Node 12141 (Sort)
      Node 12142 (Hash Join)
        Node 12143 (Nested Loop)
          Node 12144 (Hash Join)
            Node 12145 (Seq Scan) - LEAF
            Node 12146 (Hash)
              Node 12147 (Hash Join)
                Node 12148 (Seq Scan) - LEAF
                Node 12149 (Hash)
                  Node 12150 (Seq Scan) - LEAF
          Node 12151 (Index Scan) - LEAF
        Node 12152 (Hash)
          Node 12153 (Hash Join)
            Node 12154 (Seq Scan) - LEAF
            Node 12155 (Hash)
              Node 12156 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12139 | Aggregate | 1202.46 | 1209.26 | 0.6% | operator |
| 12140 | Gather Merge | 1201.36 | 1142.98 | 4.9% | operator |
| 12141 | Sort | 1196.15 | 1109.13 | 7.3% | operator |
| 12142 | Hash Join | 1195.52 | 842.59 | 29.5% | operator |
| 12143 | Nested Loop | 1187.25 | 1216.16 | 2.4% | operator |
| 12152 | Hash | 3.45 | 17.53 | 408.0% | operator |
| 12144 | Hash Join | 209.83 | 384.47 | 83.2% | operator |
| 12151 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 12153 | Hash Join | 3.41 | 85.17 | 2400.7% | operator |
| 12145 | Seq Scan | 148.60 | 201.16 | 35.4% | operator |
| 12146 | Hash | 35.77 | 19.59 | 45.2% | operator |
| 12154 | Seq Scan | 3.05 | 11.47 | 275.8% | operator |
| 12155 | Hash | 0.01 | 16.89 | 112527.2% | operator |
| 12147 | Hash Join | 35.40 | 92.20 | 160.5% | operator |
| 12156 | Seq Scan | 0.01 | 45.79 | 381502.6% | operator |
| 12148 | Seq Scan | 34.29 | 21.86 | 36.3% | operator |
| 12149 | Hash | 0.01 | 16.89 | 187612.0% | operator |
| 12150 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12150 (Seq Scan) - LEAF
...
### Step 2: Node 12148 (Seq Scan) - LEAF
...
### Step 5: Node 12156 (Seq Scan) - LEAF
...
### Step 6: Node 12145 (Seq Scan) - LEAF
...
### Step 8: Node 12154 (Seq Scan) - LEAF
...
### Step 11: Node 12151 (Index Scan) - LEAF
...
### Step 13: Node 12143 (Nested Loop)
...
### Step 17: Node 12140 (Gather Merge)
...
### Step 18: Node 12139 (Aggregate) - ROOT
