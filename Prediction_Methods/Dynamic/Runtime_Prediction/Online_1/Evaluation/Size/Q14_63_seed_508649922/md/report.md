...
```
Node 27183 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27184 (Gather) [consumed]
    Node 27185 (Aggregate) [consumed]
      Node 27186 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27183 | 27184, 27185 |
...
|------|------|--------|-----------|-----|--------|
| 27183 | Aggregate | 834.93 | 848.37 | 1.6% | pattern |
| 27186 | Hash Join | 813.55 | 807.65 | 0.7% | operator |
...
### Step 5: Node 27183 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27184, 27185
- **Input Features:**
