...
**Test Query:** Q14_63_seed_508649922
...
```
Node 27183 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27184 (Gather) [consumed]
    Node 27185 (Aggregate) [consumed]
      Node 27186 (Hash Join) [consumed]
        Node 27187 (Seq Scan) - LEAF
        Node 27188 (Hash)
          Node 27189 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27183 | 27184, 27185, 27186 |
...
|------|------|--------|-----------|-----|--------|
| 27183 | Aggregate | 834.93 | 857.13 | 2.7% | pattern |
| 27187 | Seq Scan | 763.66 | 758.49 | 0.7% | operator |
| 27188 | Hash | 42.13 | 9.38 | 77.7% | operator |
| 27189 | Seq Scan | 38.06 | 12.70 | 66.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27189 (Seq Scan) - LEAF
...
### Step 2: Node 27187 (Seq Scan) - LEAF
...
### Step 4: Node 27183 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27184, 27185, 27186
- **Input Features:**
