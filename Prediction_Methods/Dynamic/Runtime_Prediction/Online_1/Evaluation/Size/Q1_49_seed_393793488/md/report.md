...
Node 466 (Aggregate) - ROOT
  Node 467 (Gather Merge)
    Node 468 (Sort) [PATTERN: 1d35fb97]
      Node 469 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 468 | 469 |
...
|------|------|--------|-----------|-----|--------|
| 466 | Aggregate | 1024.52 | 1195.93 | 16.7% | operator |
| 467 | Gather Merge | 1024.46 | 1165.92 | 13.8% | operator |
| 468 | Sort | 1003.93 | 1200.67 | 19.6% | pattern |
...
### Step 2: Node 468 (Sort) - PATTERN ROOT
...
### Step 4: Node 466 (Aggregate) - ROOT
