...
```
Node 31479 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31480 (Gather) [consumed]
    Node 31481 (Aggregate) [consumed]
      Node 31482 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31479 | 31480, 31481, 31482 |
...
|------|------|--------|-----------|-----|--------|
| 31479 | Aggregate | 850.18 | 829.29 | 2.5% | pattern |
...
### Step 4: Node 31479 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31480, 31481, 31482
- **Input Features:**
