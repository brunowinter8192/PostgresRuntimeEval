...
```
Node 31703 (Aggregate) [PATTERN: efde8b38] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31703 | 31704, 31705, 31706 |
...
|------|------|--------|-----------|-----|--------|
| 31703 | Aggregate | 858.25 | 829.30 | 3.4% | pattern |
| 31707 | Seq Scan | 789.11 | 743.46 | 5.8% | operator |
| 31708 | Hash | 47.03 | 8.29 | 82.4% | operator |
| 31709 | Seq Scan | 46.88 | 23.76 | 49.3% | operator |
...
### Step 4: Node 31703 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31704, 31705, 31706
- **Input Features:**
