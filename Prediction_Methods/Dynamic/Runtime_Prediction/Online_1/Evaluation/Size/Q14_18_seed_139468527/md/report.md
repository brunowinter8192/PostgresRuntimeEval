...
**Test Query:** Q14_18_seed_139468527
...
```
Node 26833 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26834 (Gather) [consumed]
    Node 26835 (Aggregate) [consumed]
      Node 26836 (Hash Join) [consumed]
        Node 26837 (Seq Scan) - LEAF
        Node 26838 (Hash)
          Node 26839 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26833 | 26834, 26835, 26836 |
...
|------|------|--------|-----------|-----|--------|
| 26833 | Aggregate | 803.83 | 857.13 | 6.6% | pattern |
| 26837 | Seq Scan | 726.19 | 758.49 | 4.4% | operator |
| 26838 | Hash | 46.47 | 9.38 | 79.8% | operator |
| 26839 | Seq Scan | 40.93 | 12.70 | 69.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26839 (Seq Scan) - LEAF
...
### Step 2: Node 26837 (Seq Scan) - LEAF
...
### Step 4: Node 26833 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26834, 26835, 26836
- **Input Features:**
