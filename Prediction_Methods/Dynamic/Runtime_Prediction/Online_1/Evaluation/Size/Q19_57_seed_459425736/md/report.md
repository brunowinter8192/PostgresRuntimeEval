...
**Test Query:** Q19_57_seed_459425736
...
```
Node 31934 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31935 (Gather) [consumed]
    Node 31936 (Aggregate) [consumed]
      Node 31937 (Hash Join) [consumed]
        Node 31938 (Seq Scan) - LEAF
        Node 31939 (Hash)
          Node 31940 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31934 | 31935, 31936, 31937 |
...
|------|------|--------|-----------|-----|--------|
| 31934 | Aggregate | 839.02 | 829.28 | 1.2% | pattern |
| 31938 | Seq Scan | 770.08 | 743.46 | 3.5% | operator |
| 31939 | Hash | 44.82 | 8.29 | 81.5% | operator |
| 31940 | Seq Scan | 44.71 | 23.76 | 46.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31940 (Seq Scan) - LEAF
...
### Step 2: Node 31938 (Seq Scan) - LEAF
...
### Step 4: Node 31934 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31935, 31936, 31937
- **Input Features:**
