...
```
Node 27071 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27072 (Gather) [consumed]
    Node 27073 (Aggregate) [consumed]
      Node 27074 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27071 | 27072, 27073, 27074 |
...
|------|------|--------|-----------|-----|--------|
| 27071 | Aggregate | 854.28 | 857.12 | 0.3% | pattern |
...
### Step 4: Node 27071 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27072, 27073, 27074
- **Input Features:**
