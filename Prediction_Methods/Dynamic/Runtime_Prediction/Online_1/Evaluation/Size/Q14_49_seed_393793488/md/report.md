...
**Test Query:** Q14_49_seed_393793488
...
```
Node 27071 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27072 (Gather) [consumed]
    Node 27073 (Aggregate) [consumed]
      Node 27074 (Hash Join)
        Node 27075 (Seq Scan) - LEAF
        Node 27076 (Hash)
          Node 27077 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27071 | 27072, 27073 |
...
|------|------|--------|-----------|-----|--------|
| 27071 | Aggregate | 854.28 | 848.35 | 0.7% | pattern |
| 27074 | Hash Join | 832.84 | 807.62 | 3.0% | operator |
| 27075 | Seq Scan | 782.97 | 758.47 | 3.1% | operator |
| 27076 | Hash | 41.72 | 9.38 | 77.5% | operator |
| 27077 | Seq Scan | 37.34 | 12.70 | 66.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27077 (Seq Scan) - LEAF
...
### Step 2: Node 27075 (Seq Scan) - LEAF
...
### Step 5: Node 27071 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27072, 27073
- **Input Features:**
