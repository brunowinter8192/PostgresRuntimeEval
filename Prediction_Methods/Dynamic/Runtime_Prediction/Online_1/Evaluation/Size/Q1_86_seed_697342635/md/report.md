...
Node 671 (Aggregate) - ROOT
  Node 672 (Gather Merge)
    Node 673 (Sort) [PATTERN: 1d35fb97]
      Node 674 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 673 | 674 |
...
|------|------|--------|-----------|-----|--------|
| 671 | Aggregate | 929.50 | 1195.80 | 28.7% | operator |
| 672 | Gather Merge | 929.46 | 1165.88 | 25.4% | operator |
| 673 | Sort | 913.23 | 1200.18 | 31.4% | pattern |
...
### Step 2: Node 673 (Sort) - PATTERN ROOT
...
### Step 4: Node 671 (Aggregate) - ROOT
