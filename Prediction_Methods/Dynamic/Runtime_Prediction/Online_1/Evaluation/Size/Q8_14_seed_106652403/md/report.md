...
```
Node 14443 (Aggregate) - ROOT
  Node 14444 (Gather Merge)
    Node 14445 (Sort)
          ...
          Node 14448 (Hash Join)
            Node 14449 (Nested Loop)
              Node 14450 (Hash Join)
                ...
                Node 14452 (Hash)
                  Node 14453 (Hash Join)
                    Node 14454 (Seq Scan) - LEAF
                    Node 14455 (Hash)
                      Node 14456 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 14443 | Aggregate | 1203.09 | 1192.27 | 0.9% | operator |
| 14444 | Gather Merge | 1202.69 | 1097.13 | 8.8% | operator |
...
| 14450 | Hash Join | 206.49 | 251.17 | 21.6% | operator |
...
| 14452 | Hash | 32.85 | 20.62 | 37.3% | operator |
| 14453 | Hash Join | 32.06 | 132.26 | 312.6% | operator |
| 14454 | Seq Scan | 30.58 | 23.03 | 24.7% | operator |
| 14455 | Hash | 0.15 | 23.66 | 16102.8% | operator |
| 14456 | Hash Join | 0.14 | 306.84 | 214470.6% | operator |
...
### Step 5: Node 14454 (Seq Scan) - LEAF
...
### Step 8: Node 14451 (Seq Scan) - LEAF
...
### Step 11: Node 14460 (Index Scan) - LEAF
...
### Step 12: Node 14462 (Seq Scan) - LEAF
...
### Step 13: Node 14449 (Nested Loop)
...
### Step 16: Node 14463 (Index Scan) - LEAF
...
### Step 17: Node 14465 (Seq Scan) - LEAF
...
### Step 18: Node 14447 (Nested Loop)
...
### Step 22: Node 14444 (Gather Merge)
...
### Step 23: Node 14443 (Aggregate) - ROOT
