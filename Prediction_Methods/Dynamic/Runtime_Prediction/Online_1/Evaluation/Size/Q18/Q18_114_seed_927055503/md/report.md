...
**Test Query:** Q18_114_seed_927055503
...
```
Node 29060 (Limit) - ROOT
  Node 29061 (Sort)
    Node 29062 (Aggregate)
      Node 29063 (Gather Merge)
        Node 29064 (Incremental Sort)
          Node 29065 (Nested Loop)
            Node 29066 (Merge Join)
              Node 29067 (Sort)
                Node 29068 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 29060 | Limit | 3040.40 | 1175.21 | 61.3% | operator |
| 29061 | Sort | 2922.96 | 1127.81 | 61.4% | operator |
| 29062 | Aggregate | 2922.91 | 1073.15 | 63.3% | operator |
| 29063 | Gather Merge | 2922.90 | 1073.95 | 63.3% | operator |
| 29064 | Incremental Sort | 2903.38 | 0.00 | 100.0% | operator |
| 29065 | Nested Loop | 2903.34 | 1111.34 | 61.7% | operator |
| 29066 | Merge Join | 2903.28 | 0.00 | 100.0% | operator |
| 29075 | Index Scan | 0.02 | 0.05 | 114.9% | operator |
| 29067 | Sort | 2831.94 | 1099.77 | 61.2% | operator |
| 29073 | Sort | 68.55 | 1074.66 | 1467.7% | operator |
| 29068 | Hash Join | 2831.93 | 686.33 | 75.8% | operator |
| 29074 | Seq Scan | 55.28 | 18.25 | 67.0% | operator |
| 29069 | Seq Scan | 199.44 | 170.37 | 14.6% | operator |
| 29070 | Hash | 2605.66 | 21.04 | 99.2% | operator |
| 29071 | Aggregate | 2605.62 | 1073.15 | 58.8% | operator |
| 29072 | Index Scan | 2110.16 | 0.00 | 100.0% | operator |
...
### Step 3: Node 29069 (Seq Scan) - LEAF
...
### Step 6: Node 29074 (Seq Scan) - LEAF
...
### Step 9: Node 29066 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29075 (Index Scan) - LEAF
...
### Step 11: Node 29065 (Nested Loop)
...
### Step 12: Node 29064 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29063 (Gather Merge)
