        ...
        Node 30632 (Incremental Sort)
          Node 30633 (Nested Loop)
            Node 30634 (Merge Join)
              Node 30635 (Sort)
                Node 30636 (Hash Join)
                  Node 30637 (Seq Scan) - LEAF
                  Node 30638 (Hash)
...
| 30635 | Sort | 2854.85 | 1099.77 | 61.5% | operator |
| 30641 | Sort | 64.72 | 1074.66 | 1560.6% | operator |
| 30636 | Hash Join | 2854.83 | 686.33 | 76.0% | operator |
| 30642 | Seq Scan | 52.65 | 18.25 | 65.3% | operator |
| 30637 | Seq Scan | 196.62 | 170.37 | 13.4% | operator |
| 30638 | Hash | 2628.48 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30637 (Seq Scan) - LEAF
...
### Step 6: Node 30642 (Seq Scan) - LEAF
...
### Step 9: Node 30634 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30643 (Index Scan) - LEAF
...
### Step 11: Node 30633 (Nested Loop)
...
### Step 12: Node 30632 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30631 (Gather Merge)
