        ...
        Node 29832 (Incremental Sort)
          Node 29833 (Nested Loop)
            Node 29834 (Merge Join)
              Node 29835 (Sort)
                Node 29836 (Hash Join)
                  Node 29837 (Seq Scan) - LEAF
                  Node 29838 (Hash)
...
| 29835 | Sort | 2829.25 | 1099.77 | 61.1% | operator |
| 29841 | Sort | 65.08 | 1074.66 | 1551.3% | operator |
| 29836 | Hash Join | 2829.24 | 686.33 | 75.7% | operator |
| 29842 | Seq Scan | 52.98 | 18.25 | 65.6% | operator |
| 29837 | Seq Scan | 197.74 | 170.37 | 13.8% | operator |
| 29838 | Hash | 2600.75 | 21.04 | 99.2% | operator |
...
### Step 3: Node 29837 (Seq Scan) - LEAF
...
### Step 6: Node 29842 (Seq Scan) - LEAF
...
### Step 9: Node 29834 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29843 (Index Scan) - LEAF
...
### Step 11: Node 29833 (Nested Loop)
...
### Step 12: Node 29832 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29831 (Gather Merge)
