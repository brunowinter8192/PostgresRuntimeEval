        ...
        Node 29816 (Incremental Sort)
          Node 29817 (Nested Loop)
            Node 29818 (Merge Join)
              Node 29819 (Sort)
                Node 29820 (Hash Join)
                  Node 29821 (Seq Scan) - LEAF
                  Node 29822 (Hash)
...
| 29819 | Sort | 2836.05 | 1099.77 | 61.2% | operator |
| 29825 | Sort | 64.79 | 1074.66 | 1558.6% | operator |
| 29820 | Hash Join | 2836.04 | 686.33 | 75.8% | operator |
| 29826 | Seq Scan | 52.79 | 18.25 | 65.4% | operator |
| 29821 | Seq Scan | 188.43 | 170.37 | 9.6% | operator |
| 29822 | Hash | 2618.36 | 21.04 | 99.2% | operator |
...
### Step 3: Node 29821 (Seq Scan) - LEAF
...
### Step 6: Node 29826 (Seq Scan) - LEAF
...
### Step 9: Node 29818 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29827 (Index Scan) - LEAF
...
### Step 11: Node 29817 (Nested Loop)
...
### Step 12: Node 29816 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29815 (Gather Merge)
