        ...
        Node 29352 (Incremental Sort)
          Node 29353 (Nested Loop)
            Node 29354 (Merge Join)
              Node 29355 (Sort)
                Node 29356 (Hash Join)
                  Node 29357 (Seq Scan) - LEAF
                  Node 29358 (Hash)
...
| 29355 | Sort | 2834.99 | 1099.77 | 61.2% | operator |
| 29361 | Sort | 64.12 | 1074.66 | 1575.9% | operator |
| 29356 | Hash Join | 2834.97 | 686.33 | 75.8% | operator |
| 29362 | Seq Scan | 52.40 | 18.25 | 65.2% | operator |
| 29357 | Seq Scan | 195.80 | 170.37 | 13.0% | operator |
| 29358 | Hash | 2611.04 | 21.04 | 99.2% | operator |
...
### Step 3: Node 29357 (Seq Scan) - LEAF
...
### Step 6: Node 29362 (Seq Scan) - LEAF
...
### Step 9: Node 29354 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29363 (Index Scan) - LEAF
...
### Step 11: Node 29353 (Nested Loop)
...
### Step 12: Node 29352 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29351 (Gather Merge)
