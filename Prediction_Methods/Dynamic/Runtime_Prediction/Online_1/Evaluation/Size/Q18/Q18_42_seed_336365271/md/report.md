        ...
        Node 30200 (Incremental Sort)
          Node 30201 (Nested Loop)
            Node 30202 (Merge Join)
              Node 30203 (Sort)
                Node 30204 (Hash Join)
                  Node 30205 (Seq Scan) - LEAF
                  Node 30206 (Hash)
...
| 30203 | Sort | 2819.95 | 1099.77 | 61.0% | operator |
| 30209 | Sort | 66.05 | 1074.66 | 1527.1% | operator |
| 30204 | Hash Join | 2819.94 | 686.33 | 75.7% | operator |
| 30210 | Seq Scan | 54.26 | 18.25 | 66.4% | operator |
| 30205 | Seq Scan | 191.62 | 170.37 | 11.1% | operator |
| 30206 | Hash | 2599.34 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30205 (Seq Scan) - LEAF
...
### Step 6: Node 30210 (Seq Scan) - LEAF
...
### Step 9: Node 30202 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30211 (Index Scan) - LEAF
...
### Step 11: Node 30201 (Nested Loop)
...
### Step 12: Node 30200 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30199 (Gather Merge)
