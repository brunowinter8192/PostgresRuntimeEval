...
**Test Query:** Q18_119_seed_968075658
...
```
Node 29140 (Limit) - ROOT
  Node 29141 (Sort)
    Node 29142 (Aggregate)
      Node 29143 (Gather Merge)
        Node 29144 (Incremental Sort)
          Node 29145 (Nested Loop)
            Node 29146 (Merge Join)
              Node 29147 (Sort)
                Node 29148 (Hash Join)
                  Node 29149 (Seq Scan) - LEAF
                  Node 29150 (Hash)
                    Node 29151 (Aggregate)
                      Node 29152 (Index Scan) - LEAF
              Node 29153 (Sort)
                Node 29154 (Seq Scan) - LEAF
            Node 29155 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 29140 | Limit | 3036.43 | 1175.21 | 61.3% | operator |
| 29141 | Sort | 2924.71 | 1127.81 | 61.4% | operator |
| 29142 | Aggregate | 2924.67 | 1073.15 | 63.3% | operator |
| 29143 | Gather Merge | 2924.64 | 1073.95 | 63.3% | operator |
| 29144 | Incremental Sort | 2886.52 | 0.00 | 100.0% | operator |
| 29145 | Nested Loop | 2886.46 | 1111.34 | 61.5% | operator |
| 29146 | Merge Join | 2886.40 | 0.00 | 100.0% | operator |
| 29155 | Index Scan | 0.02 | 0.05 | 105.2% | operator |
| 29147 | Sort | 2836.07 | 1099.77 | 61.2% | operator |
| 29153 | Sort | 64.26 | 1074.66 | 1572.3% | operator |
| 29148 | Hash Join | 2836.06 | 686.33 | 75.8% | operator |
| 29154 | Seq Scan | 51.30 | 18.25 | 64.4% | operator |
| 29149 | Seq Scan | 192.35 | 170.37 | 11.4% | operator |
| 29150 | Hash | 2612.72 | 21.04 | 99.2% | operator |
| 29151 | Aggregate | 2612.69 | 1073.15 | 58.9% | operator |
| 29152 | Index Scan | 2118.29 | 0.00 | 100.0% | operator |
...
### Step 3: Node 29149 (Seq Scan) - LEAF
...
### Step 6: Node 29154 (Seq Scan) - LEAF
...
### Step 9: Node 29146 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29155 (Index Scan) - LEAF
...
### Step 11: Node 29145 (Nested Loop)
...
### Step 12: Node 29144 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29143 (Gather Merge)
