        ...
        Node 30248 (Incremental Sort)
          Node 30249 (Nested Loop)
            Node 30250 (Merge Join)
              Node 30251 (Sort)
                Node 30252 (Hash Join)
                  Node 30253 (Seq Scan) - LEAF
                  Node 30254 (Hash)
...
| 30251 | Sort | 2850.97 | 1099.77 | 61.4% | operator |
| 30257 | Sort | 64.98 | 1074.66 | 1553.7% | operator |
| 30252 | Hash Join | 2850.95 | 686.33 | 75.9% | operator |
| 30258 | Seq Scan | 53.47 | 18.25 | 65.9% | operator |
| 30253 | Seq Scan | 202.10 | 170.37 | 15.7% | operator |
| 30254 | Hash | 2616.07 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30253 (Seq Scan) - LEAF
...
### Step 6: Node 30258 (Seq Scan) - LEAF
...
### Step 9: Node 30250 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30259 (Index Scan) - LEAF
...
### Step 11: Node 30249 (Nested Loop)
...
### Step 12: Node 30248 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30247 (Gather Merge)
