...
**Test Query:** Q18_12_seed_90244341
...
```
Node 29332 (Limit) - ROOT
  Node 29333 (Sort)
    Node 29334 (Aggregate)
      Node 29335 (Gather Merge)
        Node 29336 (Incremental Sort)
          Node 29337 (Nested Loop)
            Node 29338 (Merge Join)
              Node 29339 (Sort)
                Node 29340 (Hash Join)
                  Node 29341 (Seq Scan) - LEAF
                  Node 29342 (Hash)
                    Node 29343 (Aggregate)
                      Node 29344 (Index Scan) - LEAF
              Node 29345 (Sort)
                Node 29346 (Seq Scan) - LEAF
            Node 29347 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 29332 | Limit | 3033.85 | 1175.21 | 61.3% | operator |
| 29333 | Sort | 2916.67 | 1127.81 | 61.3% | operator |
| 29334 | Aggregate | 2916.63 | 1073.15 | 63.2% | operator |
| 29335 | Gather Merge | 2916.61 | 1073.95 | 63.2% | operator |
| 29336 | Incremental Sort | 2897.03 | 0.00 | 100.0% | operator |
| 29337 | Nested Loop | 2896.98 | 1111.34 | 61.6% | operator |
| 29338 | Merge Join | 2896.92 | 0.00 | 100.0% | operator |
| 29347 | Index Scan | 0.02 | 0.05 | 96.2% | operator |
| 29339 | Sort | 2827.68 | 1099.77 | 61.1% | operator |
| 29345 | Sort | 66.11 | 1074.66 | 1525.7% | operator |
| 29340 | Hash Join | 2827.66 | 686.33 | 75.7% | operator |
| 29346 | Seq Scan | 52.57 | 18.25 | 65.3% | operator |
| 29341 | Seq Scan | 193.80 | 170.37 | 12.1% | operator |
| 29342 | Hash | 2602.91 | 21.04 | 99.2% | operator |
| 29343 | Aggregate | 2602.89 | 1073.15 | 58.8% | operator |
| 29344 | Index Scan | 2110.04 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29344 (Index Scan) - LEAF
...
### Step 3: Node 29341 (Seq Scan) - LEAF
...
### Step 6: Node 29346 (Seq Scan) - LEAF
...
### Step 9: Node 29338 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29347 (Index Scan) - LEAF
...
### Step 11: Node 29337 (Nested Loop)
...
### Step 12: Node 29336 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29335 (Gather Merge)
