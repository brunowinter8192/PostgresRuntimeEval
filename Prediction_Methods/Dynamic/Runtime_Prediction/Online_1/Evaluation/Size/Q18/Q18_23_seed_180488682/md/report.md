        ...
        Node 29864 (Incremental Sort)
          Node 29865 (Nested Loop)
            Node 29866 (Merge Join)
              Node 29867 (Sort)
                Node 29868 (Hash Join)
                  Node 29869 (Seq Scan) - LEAF
                  Node 29870 (Hash)
...
| 29867 | Sort | 2838.78 | 1099.77 | 61.3% | operator |
| 29873 | Sort | 66.74 | 1074.66 | 1510.2% | operator |
| 29868 | Hash Join | 2838.77 | 686.33 | 75.8% | operator |
| 29874 | Seq Scan | 55.34 | 18.25 | 67.0% | operator |
| 29869 | Seq Scan | 188.21 | 170.37 | 9.5% | operator |
| 29870 | Hash | 2620.36 | 21.04 | 99.2% | operator |
...
### Step 3: Node 29869 (Seq Scan) - LEAF
...
### Step 6: Node 29874 (Seq Scan) - LEAF
...
### Step 9: Node 29866 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29875 (Index Scan) - LEAF
...
### Step 11: Node 29865 (Nested Loop)
...
### Step 12: Node 29864 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29863 (Gather Merge)
