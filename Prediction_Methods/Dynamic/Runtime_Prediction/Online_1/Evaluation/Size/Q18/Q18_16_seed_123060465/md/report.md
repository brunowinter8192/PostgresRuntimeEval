        ...
        Node 29736 (Incremental Sort)
          Node 29737 (Nested Loop)
            Node 29738 (Merge Join)
              Node 29739 (Sort)
                Node 29740 (Hash Join)
                  Node 29741 (Seq Scan) - LEAF
                  Node 29742 (Hash)
...
| 29739 | Sort | 2844.76 | 1099.77 | 61.3% | operator |
| 29745 | Sort | 66.12 | 1074.66 | 1525.3% | operator |
| 29740 | Hash Join | 2844.75 | 686.33 | 75.9% | operator |
| 29746 | Seq Scan | 54.55 | 18.25 | 66.6% | operator |
| 29741 | Seq Scan | 204.99 | 170.37 | 16.9% | operator |
| 29742 | Hash | 2609.00 | 21.04 | 99.2% | operator |
...
### Step 3: Node 29741 (Seq Scan) - LEAF
...
### Step 6: Node 29746 (Seq Scan) - LEAF
...
### Step 9: Node 29738 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29747 (Index Scan) - LEAF
...
### Step 11: Node 29737 (Nested Loop)
...
### Step 12: Node 29736 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29735 (Gather Merge)
