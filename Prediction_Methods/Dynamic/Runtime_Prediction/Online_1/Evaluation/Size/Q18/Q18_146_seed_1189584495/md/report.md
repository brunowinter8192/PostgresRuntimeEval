        ...
        Node 29624 (Incremental Sort)
          Node 29625 (Nested Loop)
            Node 29626 (Merge Join)
              Node 29627 (Sort)
                Node 29628 (Hash Join)
                  Node 29629 (Seq Scan) - LEAF
                  Node 29630 (Hash)
...
| 29627 | Sort | 2828.17 | 1099.77 | 61.1% | operator |
| 29633 | Sort | 65.55 | 1074.66 | 1539.4% | operator |
| 29628 | Hash Join | 2828.15 | 686.33 | 75.7% | operator |
| 29634 | Seq Scan | 54.04 | 18.25 | 66.2% | operator |
| 29629 | Seq Scan | 195.82 | 170.37 | 13.0% | operator |
| 29630 | Hash | 2602.73 | 21.04 | 99.2% | operator |
...
### Step 3: Node 29629 (Seq Scan) - LEAF
...
### Step 6: Node 29634 (Seq Scan) - LEAF
...
### Step 9: Node 29626 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29635 (Index Scan) - LEAF
...
### Step 11: Node 29625 (Nested Loop)
...
### Step 12: Node 29624 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29623 (Gather Merge)
