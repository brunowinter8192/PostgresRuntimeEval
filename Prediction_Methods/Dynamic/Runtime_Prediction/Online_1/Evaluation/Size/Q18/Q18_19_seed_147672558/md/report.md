        ...
        Node 29784 (Incremental Sort)
          Node 29785 (Nested Loop)
            Node 29786 (Merge Join)
              Node 29787 (Sort)
                Node 29788 (Hash Join)
                  Node 29789 (Seq Scan) - LEAF
                  Node 29790 (Hash)
...
| 29787 | Sort | 2841.95 | 1099.77 | 61.3% | operator |
| 29793 | Sort | 63.48 | 1074.66 | 1593.0% | operator |
| 29788 | Hash Join | 2841.94 | 686.33 | 75.8% | operator |
| 29794 | Seq Scan | 52.50 | 18.25 | 65.2% | operator |
| 29789 | Seq Scan | 192.88 | 170.37 | 11.7% | operator |
| 29790 | Hash | 2618.19 | 21.04 | 99.2% | operator |
...
### Step 3: Node 29789 (Seq Scan) - LEAF
...
### Step 6: Node 29794 (Seq Scan) - LEAF
...
### Step 9: Node 29786 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29795 (Index Scan) - LEAF
...
### Step 11: Node 29785 (Nested Loop)
...
### Step 12: Node 29784 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29783 (Gather Merge)
