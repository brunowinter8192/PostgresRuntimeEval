        ...
        Node 30952 (Incremental Sort)
          Node 30953 (Nested Loop)
            Node 30954 (Merge Join)
              Node 30955 (Sort)
                Node 30956 (Hash Join)
                  Node 30957 (Seq Scan) - LEAF
                  Node 30958 (Hash)
...
| 30955 | Sort | 2870.84 | 1099.77 | 61.7% | operator |
| 30961 | Sort | 64.29 | 1074.66 | 1571.6% | operator |
| 30956 | Hash Join | 2870.82 | 686.33 | 76.1% | operator |
| 30962 | Seq Scan | 51.51 | 18.25 | 64.6% | operator |
| 30957 | Seq Scan | 192.08 | 170.37 | 11.3% | operator |
| 30958 | Hash | 2648.43 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30957 (Seq Scan) - LEAF
...
### Step 6: Node 30962 (Seq Scan) - LEAF
...
### Step 9: Node 30954 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30963 (Index Scan) - LEAF
...
### Step 11: Node 30953 (Nested Loop)
...
### Step 12: Node 30952 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30951 (Gather Merge)
