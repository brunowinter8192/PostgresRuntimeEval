        ...
        Node 30232 (Incremental Sort)
          Node 30233 (Nested Loop)
            Node 30234 (Merge Join)
              Node 30235 (Sort)
                Node 30236 (Hash Join)
                  Node 30237 (Seq Scan) - LEAF
                  Node 30238 (Hash)
...
| 30235 | Sort | 2827.24 | 1099.77 | 61.1% | operator |
| 30241 | Sort | 75.17 | 1074.66 | 1329.7% | operator |
| 30236 | Hash Join | 2827.23 | 686.33 | 75.7% | operator |
| 30242 | Seq Scan | 59.57 | 18.25 | 69.4% | operator |
| 30237 | Seq Scan | 191.93 | 170.37 | 11.2% | operator |
| 30238 | Hash | 2605.86 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30237 (Seq Scan) - LEAF
...
### Step 6: Node 30242 (Seq Scan) - LEAF
...
### Step 9: Node 30234 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30243 (Index Scan) - LEAF
...
### Step 11: Node 30233 (Nested Loop)
...
### Step 12: Node 30232 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30231 (Gather Merge)
