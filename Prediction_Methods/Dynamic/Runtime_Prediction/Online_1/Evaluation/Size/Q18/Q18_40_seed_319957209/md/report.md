        ...
        Node 30168 (Incremental Sort)
          Node 30169 (Nested Loop)
            Node 30170 (Merge Join)
              Node 30171 (Sort)
                Node 30172 (Hash Join)
                  Node 30173 (Seq Scan) - LEAF
                  Node 30174 (Hash)
...
| 30171 | Sort | 2826.51 | 1099.77 | 61.1% | operator |
| 30177 | Sort | 63.81 | 1074.66 | 1584.1% | operator |
| 30172 | Hash Join | 2826.49 | 686.33 | 75.7% | operator |
| 30178 | Seq Scan | 52.66 | 18.25 | 65.4% | operator |
| 30173 | Seq Scan | 193.04 | 170.37 | 11.7% | operator |
| 30174 | Hash | 2603.69 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30173 (Seq Scan) - LEAF
...
### Step 6: Node 30178 (Seq Scan) - LEAF
...
### Step 9: Node 30170 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30179 (Index Scan) - LEAF
...
### Step 11: Node 30169 (Nested Loop)
...
### Step 12: Node 30168 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30167 (Gather Merge)
