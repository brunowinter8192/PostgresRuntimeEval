        ...
        Node 28840 (Incremental Sort)
          Node 28841 (Nested Loop)
            Node 28842 (Merge Join)
              Node 28843 (Sort)
                Node 28844 (Hash Join)
                  Node 28845 (Seq Scan) - LEAF
                  Node 28846 (Hash)
...
| 28843 | Sort | 2866.90 | 1099.77 | 61.6% | operator |
| 28849 | Sort | 66.23 | 1074.66 | 1522.6% | operator |
| 28844 | Hash Join | 2866.89 | 686.33 | 76.1% | operator |
| 28850 | Seq Scan | 54.53 | 18.25 | 66.5% | operator |
| 28845 | Seq Scan | 199.94 | 170.37 | 14.8% | operator |
| 28846 | Hash | 2636.80 | 21.04 | 99.2% | operator |
...
### Step 3: Node 28845 (Seq Scan) - LEAF
...
### Step 6: Node 28850 (Seq Scan) - LEAF
...
### Step 9: Node 28842 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 28851 (Index Scan) - LEAF
...
### Step 11: Node 28841 (Nested Loop)
...
### Step 12: Node 28840 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 28839 (Gather Merge)
