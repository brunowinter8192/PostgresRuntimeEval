        ...
        Node 30392 (Incremental Sort)
          Node 30393 (Nested Loop)
            Node 30394 (Merge Join)
              Node 30395 (Sort)
                Node 30396 (Hash Join)
                  Node 30397 (Seq Scan) - LEAF
                  Node 30398 (Hash)
...
| 30395 | Sort | 2837.32 | 1099.77 | 61.2% | operator |
| 30401 | Sort | 66.41 | 1074.66 | 1518.2% | operator |
| 30396 | Hash Join | 2837.30 | 686.33 | 75.8% | operator |
| 30402 | Seq Scan | 53.59 | 18.25 | 65.9% | operator |
| 30397 | Seq Scan | 190.96 | 170.37 | 10.8% | operator |
| 30398 | Hash | 2615.42 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30397 (Seq Scan) - LEAF
...
### Step 6: Node 30402 (Seq Scan) - LEAF
...
### Step 9: Node 30394 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30403 (Index Scan) - LEAF
...
### Step 11: Node 30393 (Nested Loop)
...
### Step 12: Node 30392 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30391 (Gather Merge)
