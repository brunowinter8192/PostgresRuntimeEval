        ...
        Node 30360 (Incremental Sort)
          Node 30361 (Nested Loop)
            Node 30362 (Merge Join)
              Node 30363 (Sort)
                Node 30364 (Hash Join)
                  Node 30365 (Seq Scan) - LEAF
                  Node 30366 (Hash)
...
| 30363 | Sort | 2906.51 | 1099.77 | 62.2% | operator |
| 30369 | Sort | 64.27 | 1074.66 | 1572.2% | operator |
| 30364 | Hash Join | 2906.50 | 686.33 | 76.4% | operator |
| 30370 | Seq Scan | 52.25 | 18.25 | 65.1% | operator |
| 30365 | Seq Scan | 203.31 | 170.37 | 16.2% | operator |
| 30366 | Hash | 2675.14 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30365 (Seq Scan) - LEAF
...
### Step 6: Node 30370 (Seq Scan) - LEAF
...
### Step 9: Node 30362 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30371 (Index Scan) - LEAF
...
### Step 11: Node 30361 (Nested Loop)
...
### Step 12: Node 30360 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30359 (Gather Merge)
