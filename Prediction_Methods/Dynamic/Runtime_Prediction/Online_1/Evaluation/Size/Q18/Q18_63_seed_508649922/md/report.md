        ...
        Node 30568 (Incremental Sort)
          Node 30569 (Nested Loop)
            Node 30570 (Merge Join)
              Node 30571 (Sort)
                Node 30572 (Hash Join)
                  Node 30573 (Seq Scan) - LEAF
                  Node 30574 (Hash)
...
| 30571 | Sort | 2840.51 | 1099.77 | 61.3% | operator |
| 30577 | Sort | 65.56 | 1074.66 | 1539.2% | operator |
| 30572 | Hash Join | 2840.50 | 686.33 | 75.8% | operator |
| 30578 | Seq Scan | 53.51 | 18.25 | 65.9% | operator |
| 30573 | Seq Scan | 186.19 | 170.37 | 8.5% | operator |
| 30574 | Hash | 2619.13 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30573 (Seq Scan) - LEAF
...
### Step 6: Node 30578 (Seq Scan) - LEAF
...
### Step 9: Node 30570 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30579 (Index Scan) - LEAF
...
### Step 11: Node 30569 (Nested Loop)
...
### Step 12: Node 30568 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30567 (Gather Merge)
