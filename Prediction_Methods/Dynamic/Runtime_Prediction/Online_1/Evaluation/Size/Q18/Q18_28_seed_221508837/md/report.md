        ...
        Node 29944 (Incremental Sort)
          Node 29945 (Nested Loop)
            Node 29946 (Merge Join)
              Node 29947 (Sort)
                Node 29948 (Hash Join)
                  Node 29949 (Seq Scan) - LEAF
                  Node 29950 (Hash)
...
| 29947 | Sort | 2866.92 | 1099.77 | 61.6% | operator |
| 29953 | Sort | 63.54 | 1074.66 | 1591.2% | operator |
| 29948 | Hash Join | 2866.91 | 686.33 | 76.1% | operator |
| 29954 | Seq Scan | 52.24 | 18.25 | 65.1% | operator |
| 29949 | Seq Scan | 202.59 | 170.37 | 15.9% | operator |
| 29950 | Hash | 2632.69 | 21.04 | 99.2% | operator |
...
### Step 3: Node 29949 (Seq Scan) - LEAF
...
### Step 6: Node 29954 (Seq Scan) - LEAF
...
### Step 9: Node 29946 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29955 (Index Scan) - LEAF
...
### Step 11: Node 29945 (Nested Loop)
...
### Step 12: Node 29944 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29943 (Gather Merge)
