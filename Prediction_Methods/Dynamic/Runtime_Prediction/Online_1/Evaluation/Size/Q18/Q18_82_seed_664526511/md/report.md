        ...
        Node 30904 (Incremental Sort)
          Node 30905 (Nested Loop)
            Node 30906 (Merge Join)
              Node 30907 (Sort)
                Node 30908 (Hash Join)
                  Node 30909 (Seq Scan) - LEAF
                  Node 30910 (Hash)
...
| 30907 | Sort | 2870.17 | 1099.77 | 61.7% | operator |
| 30913 | Sort | 64.40 | 1074.66 | 1568.6% | operator |
| 30908 | Hash Join | 2870.16 | 686.33 | 76.1% | operator |
| 30914 | Seq Scan | 53.01 | 18.25 | 65.6% | operator |
| 30909 | Seq Scan | 199.62 | 170.37 | 14.6% | operator |
| 30910 | Hash | 2638.99 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30909 (Seq Scan) - LEAF
...
### Step 6: Node 30914 (Seq Scan) - LEAF
...
### Step 9: Node 30906 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30915 (Index Scan) - LEAF
...
### Step 11: Node 30905 (Nested Loop)
...
### Step 12: Node 30904 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30903 (Gather Merge)
