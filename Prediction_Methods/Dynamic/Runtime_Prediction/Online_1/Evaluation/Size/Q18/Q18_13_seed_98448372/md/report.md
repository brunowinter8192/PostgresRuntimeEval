        ...
        Node 29512 (Incremental Sort)
          Node 29513 (Nested Loop)
            Node 29514 (Merge Join)
              Node 29515 (Sort)
                Node 29516 (Hash Join)
                  Node 29517 (Seq Scan) - LEAF
                  Node 29518 (Hash)
...
| 29515 | Sort | 2834.20 | 1099.77 | 61.2% | operator |
| 29521 | Sort | 65.60 | 1074.66 | 1538.1% | operator |
| 29516 | Hash Join | 2834.19 | 686.33 | 75.8% | operator |
| 29522 | Seq Scan | 53.83 | 18.25 | 66.1% | operator |
| 29517 | Seq Scan | 198.22 | 170.37 | 14.0% | operator |
| 29518 | Hash | 2605.93 | 21.04 | 99.2% | operator |
...
### Step 3: Node 29517 (Seq Scan) - LEAF
...
### Step 6: Node 29522 (Seq Scan) - LEAF
...
### Step 9: Node 29514 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29523 (Index Scan) - LEAF
...
### Step 11: Node 29513 (Nested Loop)
...
### Step 12: Node 29512 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29511 (Gather Merge)
