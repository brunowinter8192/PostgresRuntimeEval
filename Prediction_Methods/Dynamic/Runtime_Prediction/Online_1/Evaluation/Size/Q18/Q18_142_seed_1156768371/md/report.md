        ...
        Node 29560 (Incremental Sort)
          Node 29561 (Nested Loop)
            Node 29562 (Merge Join)
              Node 29563 (Sort)
                Node 29564 (Hash Join)
                  Node 29565 (Seq Scan) - LEAF
                  Node 29566 (Hash)
...
| 29563 | Sort | 2824.28 | 1099.77 | 61.1% | operator |
| 29569 | Sort | 67.15 | 1074.66 | 1500.4% | operator |
| 29564 | Hash Join | 2824.26 | 686.33 | 75.7% | operator |
| 29570 | Seq Scan | 54.60 | 18.25 | 66.6% | operator |
| 29565 | Seq Scan | 192.54 | 170.37 | 11.5% | operator |
| 29566 | Hash | 2602.27 | 21.04 | 99.2% | operator |
...
### Step 3: Node 29565 (Seq Scan) - LEAF
...
### Step 6: Node 29570 (Seq Scan) - LEAF
...
### Step 9: Node 29562 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29571 (Index Scan) - LEAF
...
### Step 11: Node 29561 (Nested Loop)
...
### Step 12: Node 29560 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29559 (Gather Merge)
