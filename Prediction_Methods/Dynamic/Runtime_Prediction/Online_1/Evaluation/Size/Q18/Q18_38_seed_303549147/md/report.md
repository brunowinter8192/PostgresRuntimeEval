        ...
        Node 30120 (Incremental Sort)
          Node 30121 (Nested Loop)
            Node 30122 (Merge Join)
              Node 30123 (Sort)
                Node 30124 (Hash Join)
                  Node 30125 (Seq Scan) - LEAF
                  Node 30126 (Hash)
...
| 30123 | Sort | 2868.36 | 1099.77 | 61.7% | operator |
| 30129 | Sort | 68.72 | 1074.66 | 1463.9% | operator |
| 30124 | Hash Join | 2868.34 | 686.33 | 76.1% | operator |
| 30130 | Seq Scan | 54.58 | 18.25 | 66.6% | operator |
| 30125 | Seq Scan | 200.40 | 170.37 | 15.0% | operator |
| 30126 | Hash | 2638.83 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30125 (Seq Scan) - LEAF
...
### Step 6: Node 30130 (Seq Scan) - LEAF
...
### Step 9: Node 30122 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30131 (Index Scan) - LEAF
...
### Step 11: Node 30121 (Nested Loop)
...
### Step 12: Node 30120 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30119 (Gather Merge)
