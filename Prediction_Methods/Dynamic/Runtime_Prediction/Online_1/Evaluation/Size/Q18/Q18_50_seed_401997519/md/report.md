        ...
        Node 30344 (Incremental Sort)
          Node 30345 (Nested Loop)
            Node 30346 (Merge Join)
              Node 30347 (Sort)
                Node 30348 (Hash Join)
                  Node 30349 (Seq Scan) - LEAF
                  Node 30350 (Hash)
...
| 30347 | Sort | 2847.45 | 1099.77 | 61.4% | operator |
| 30353 | Sort | 67.17 | 1074.66 | 1500.0% | operator |
| 30348 | Hash Join | 2847.44 | 686.33 | 75.9% | operator |
| 30354 | Seq Scan | 55.67 | 18.25 | 67.2% | operator |
| 30349 | Seq Scan | 191.31 | 170.37 | 10.9% | operator |
| 30350 | Hash | 2624.71 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30349 (Seq Scan) - LEAF
...
### Step 6: Node 30354 (Seq Scan) - LEAF
...
### Step 9: Node 30346 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30355 (Index Scan) - LEAF
...
### Step 11: Node 30345 (Nested Loop)
...
### Step 12: Node 30344 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30343 (Gather Merge)
