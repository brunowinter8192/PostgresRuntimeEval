        ...
        Node 31128 (Incremental Sort)
          Node 31129 (Nested Loop)
            Node 31130 (Merge Join)
              Node 31131 (Sort)
                Node 31132 (Hash Join)
                  Node 31133 (Seq Scan) - LEAF
                  Node 31134 (Hash)
...
| 31131 | Sort | 2880.63 | 1099.77 | 61.8% | operator |
| 31137 | Sort | 69.70 | 1074.66 | 1441.7% | operator |
| 31132 | Hash Join | 2880.62 | 686.33 | 76.2% | operator |
| 31138 | Seq Scan | 57.52 | 18.25 | 68.3% | operator |
| 31133 | Seq Scan | 191.86 | 170.37 | 11.2% | operator |
| 31134 | Hash | 2659.85 | 21.04 | 99.2% | operator |
...
### Step 3: Node 31133 (Seq Scan) - LEAF
...
### Step 6: Node 31138 (Seq Scan) - LEAF
...
### Step 9: Node 31130 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 31139 (Index Scan) - LEAF
...
### Step 11: Node 31129 (Nested Loop)
...
### Step 12: Node 31128 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 31127 (Gather Merge)
