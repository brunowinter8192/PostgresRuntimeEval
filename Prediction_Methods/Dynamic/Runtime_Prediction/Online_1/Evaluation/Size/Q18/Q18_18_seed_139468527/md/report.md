        ...
        Node 29768 (Incremental Sort)
          Node 29769 (Nested Loop)
            Node 29770 (Merge Join)
              Node 29771 (Sort)
                Node 29772 (Hash Join)
                  Node 29773 (Seq Scan) - LEAF
                  Node 29774 (Hash)
...
| 29771 | Sort | 2829.84 | 1099.77 | 61.1% | operator |
| 29777 | Sort | 71.46 | 1074.66 | 1403.8% | operator |
| 29772 | Hash Join | 2829.82 | 686.33 | 75.7% | operator |
| 29778 | Seq Scan | 59.31 | 18.25 | 69.2% | operator |
| 29773 | Seq Scan | 201.34 | 170.37 | 15.4% | operator |
| 29774 | Hash | 2600.83 | 21.04 | 99.2% | operator |
...
### Step 3: Node 29773 (Seq Scan) - LEAF
...
### Step 6: Node 29778 (Seq Scan) - LEAF
...
### Step 9: Node 29770 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29779 (Index Scan) - LEAF
...
### Step 11: Node 29769 (Nested Loop)
...
### Step 12: Node 29768 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29767 (Gather Merge)
