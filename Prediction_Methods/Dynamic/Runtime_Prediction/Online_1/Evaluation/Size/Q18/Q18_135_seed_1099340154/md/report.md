        ...
        Node 29432 (Incremental Sort)
          Node 29433 (Nested Loop)
            Node 29434 (Merge Join)
              Node 29435 (Sort)
                Node 29436 (Hash Join)
                  Node 29437 (Seq Scan) - LEAF
                  Node 29438 (Hash)
...
| 29435 | Sort | 2922.15 | 1099.77 | 62.4% | operator |
| 29441 | Sort | 69.07 | 1074.66 | 1455.8% | operator |
| 29436 | Hash Join | 2922.14 | 686.33 | 76.5% | operator |
| 29442 | Seq Scan | 57.05 | 18.25 | 68.0% | operator |
| 29437 | Seq Scan | 202.62 | 170.37 | 15.9% | operator |
| 29438 | Hash | 2690.08 | 21.04 | 99.2% | operator |
...
### Step 3: Node 29437 (Seq Scan) - LEAF
...
### Step 6: Node 29442 (Seq Scan) - LEAF
...
### Step 9: Node 29434 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29443 (Index Scan) - LEAF
...
### Step 11: Node 29433 (Nested Loop)
...
### Step 12: Node 29432 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29431 (Gather Merge)
