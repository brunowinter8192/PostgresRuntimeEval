        ...
        Node 29752 (Incremental Sort)
          Node 29753 (Nested Loop)
            Node 29754 (Merge Join)
              Node 29755 (Sort)
                Node 29756 (Hash Join)
                  Node 29757 (Seq Scan) - LEAF
                  Node 29758 (Hash)
...
| 29755 | Sort | 2807.76 | 1099.77 | 60.8% | operator |
| 29761 | Sort | 67.20 | 1074.66 | 1499.1% | operator |
| 29756 | Hash Join | 2807.74 | 686.33 | 75.6% | operator |
| 29762 | Seq Scan | 53.71 | 18.25 | 66.0% | operator |
| 29757 | Seq Scan | 189.31 | 170.37 | 10.0% | operator |
| 29758 | Hash | 2589.05 | 21.04 | 99.2% | operator |
...
### Step 3: Node 29757 (Seq Scan) - LEAF
...
### Step 6: Node 29762 (Seq Scan) - LEAF
...
### Step 9: Node 29754 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29763 (Index Scan) - LEAF
...
### Step 11: Node 29753 (Nested Loop)
...
### Step 12: Node 29752 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29751 (Gather Merge)
