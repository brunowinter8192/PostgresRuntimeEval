        ...
        Node 29080 (Incremental Sort)
          Node 29081 (Nested Loop)
            Node 29082 (Merge Join)
              Node 29083 (Sort)
                Node 29084 (Hash Join)
                  Node 29085 (Seq Scan) - LEAF
                  Node 29086 (Hash)
...
| 29083 | Sort | 2894.77 | 1099.77 | 62.0% | operator |
| 29089 | Sort | 63.19 | 1074.66 | 1600.7% | operator |
| 29084 | Hash Join | 2894.76 | 686.33 | 76.3% | operator |
| 29090 | Seq Scan | 51.49 | 18.25 | 64.6% | operator |
| 29085 | Seq Scan | 196.44 | 170.37 | 13.3% | operator |
| 29086 | Hash | 2670.27 | 21.04 | 99.2% | operator |
...
### Step 3: Node 29085 (Seq Scan) - LEAF
...
### Step 6: Node 29090 (Seq Scan) - LEAF
...
### Step 9: Node 29082 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29091 (Index Scan) - LEAF
...
### Step 11: Node 29081 (Nested Loop)
...
### Step 12: Node 29080 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29079 (Gather Merge)
