...
```
Node 29284 (Limit) - ROOT
  Node 29285 (Sort)
    Node 29286 (Aggregate)
      Node 29287 (Gather Merge)
        Node 29288 (Incremental Sort)
          Node 29289 (Nested Loop)
            Node 29290 (Merge Join)
              Node 29291 (Sort)
                Node 29292 (Hash Join)
                  Node 29293 (Seq Scan) - LEAF
                  Node 29294 (Hash)
                    Node 29295 (Aggregate)
                      Node 29296 (Index Scan) - LEAF
              Node 29297 (Sort)
                Node 29298 (Seq Scan) - LEAF
            Node 29299 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 29284 | Limit | 3064.92 | 1175.21 | 61.7% | operator |
| 29285 | Sort | 2950.88 | 1127.81 | 61.8% | operator |
| 29286 | Aggregate | 2950.83 | 1073.15 | 63.6% | operator |
| 29287 | Gather Merge | 2950.82 | 1073.95 | 63.6% | operator |
| 29288 | Incremental Sort | 2929.77 | 0.00 | 100.0% | operator |
| 29289 | Nested Loop | 2929.73 | 1111.34 | 62.1% | operator |
| 29290 | Merge Join | 2929.67 | 0.00 | 100.0% | operator |
| 29299 | Index Scan | 0.02 | 0.05 | 96.2% | operator |
| 29291 | Sort | 2862.89 | 1099.77 | 61.6% | operator |
| 29297 | Sort | 64.22 | 1074.66 | 1573.5% | operator |
| 29292 | Hash Join | 2862.88 | 686.33 | 76.0% | operator |
| 29298 | Seq Scan | 52.73 | 18.25 | 65.4% | operator |
| 29293 | Seq Scan | 204.12 | 170.37 | 16.5% | operator |
| 29294 | Hash | 2628.96 | 21.04 | 99.2% | operator |
| 29295 | Aggregate | 2628.93 | 1073.15 | 59.2% | operator |
| 29296 | Index Scan | 2130.98 | 0.00 | 100.0% | operator |
...
### Step 3: Node 29293 (Seq Scan) - LEAF
...
### Step 6: Node 29298 (Seq Scan) - LEAF
...
### Step 9: Node 29290 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29299 (Index Scan) - LEAF
...
### Step 11: Node 29289 (Nested Loop)
...
### Step 12: Node 29288 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29287 (Gather Merge)
