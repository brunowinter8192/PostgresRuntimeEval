        ...
        Node 29464 (Incremental Sort)
          Node 29465 (Nested Loop)
            Node 29466 (Merge Join)
              Node 29467 (Sort)
                Node 29468 (Hash Join)
                  Node 29469 (Seq Scan) - LEAF
                  Node 29470 (Hash)
...
| 29467 | Sort | 2832.34 | 1099.77 | 61.2% | operator |
| 29473 | Sort | 64.95 | 1074.66 | 1554.5% | operator |
| 29468 | Hash Join | 2832.33 | 686.33 | 75.8% | operator |
| 29474 | Seq Scan | 53.97 | 18.25 | 66.2% | operator |
| 29469 | Seq Scan | 187.95 | 170.37 | 9.3% | operator |
| 29470 | Hash | 2615.18 | 21.04 | 99.2% | operator |
...
### Step 3: Node 29469 (Seq Scan) - LEAF
...
### Step 6: Node 29474 (Seq Scan) - LEAF
...
### Step 9: Node 29466 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29475 (Index Scan) - LEAF
...
### Step 11: Node 29465 (Nested Loop)
...
### Step 12: Node 29464 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29463 (Gather Merge)
