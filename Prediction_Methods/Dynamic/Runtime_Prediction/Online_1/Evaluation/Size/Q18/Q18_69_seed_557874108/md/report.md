        ...
        Node 30664 (Incremental Sort)
          Node 30665 (Nested Loop)
            Node 30666 (Merge Join)
              Node 30667 (Sort)
                Node 30668 (Hash Join)
                  Node 30669 (Seq Scan) - LEAF
                  Node 30670 (Hash)
...
| 30667 | Sort | 2821.15 | 1099.77 | 61.0% | operator |
| 30673 | Sort | 63.57 | 1074.66 | 1590.5% | operator |
| 30668 | Hash Join | 2821.14 | 686.33 | 75.7% | operator |
| 30674 | Seq Scan | 52.30 | 18.25 | 65.1% | operator |
| 30669 | Seq Scan | 198.41 | 170.37 | 14.1% | operator |
| 30670 | Hash | 2594.52 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30669 (Seq Scan) - LEAF
...
### Step 6: Node 30674 (Seq Scan) - LEAF
...
### Step 9: Node 30666 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30675 (Index Scan) - LEAF
...
### Step 11: Node 30665 (Nested Loop)
...
### Step 12: Node 30664 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30663 (Gather Merge)
