        ...
        Node 29640 (Incremental Sort)
          Node 29641 (Nested Loop)
            Node 29642 (Merge Join)
              Node 29643 (Sort)
                Node 29644 (Hash Join)
                  Node 29645 (Seq Scan) - LEAF
                  Node 29646 (Hash)
...
| 29643 | Sort | 2848.46 | 1099.77 | 61.4% | operator |
| 29649 | Sort | 68.77 | 1074.66 | 1462.7% | operator |
| 29644 | Hash Join | 2848.45 | 686.33 | 75.9% | operator |
| 29650 | Seq Scan | 54.11 | 18.25 | 66.3% | operator |
| 29645 | Seq Scan | 193.93 | 170.37 | 12.1% | operator |
| 29646 | Hash | 2622.72 | 21.04 | 99.2% | operator |
...
### Step 3: Node 29645 (Seq Scan) - LEAF
...
### Step 6: Node 29650 (Seq Scan) - LEAF
...
### Step 9: Node 29642 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29651 (Index Scan) - LEAF
...
### Step 11: Node 29641 (Nested Loop)
...
### Step 12: Node 29640 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29639 (Gather Merge)
