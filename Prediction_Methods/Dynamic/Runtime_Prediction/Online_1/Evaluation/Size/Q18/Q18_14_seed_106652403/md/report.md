        ...
        Node 29688 (Incremental Sort)
          Node 29689 (Nested Loop)
            Node 29690 (Merge Join)
              Node 29691 (Sort)
                Node 29692 (Hash Join)
                  Node 29693 (Seq Scan) - LEAF
                  Node 29694 (Hash)
...
| 29691 | Sort | 2851.45 | 1099.77 | 61.4% | operator |
| 29697 | Sort | 65.57 | 1074.66 | 1539.0% | operator |
| 29692 | Hash Join | 2851.44 | 686.33 | 75.9% | operator |
| 29698 | Seq Scan | 54.03 | 18.25 | 66.2% | operator |
| 29693 | Seq Scan | 196.07 | 170.37 | 13.1% | operator |
| 29694 | Hash | 2627.82 | 21.04 | 99.2% | operator |
...
### Step 3: Node 29693 (Seq Scan) - LEAF
...
### Step 6: Node 29698 (Seq Scan) - LEAF
...
### Step 9: Node 29690 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29699 (Index Scan) - LEAF
...
### Step 11: Node 29689 (Nested Loop)
...
### Step 12: Node 29688 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29687 (Gather Merge)
