        ...
        Node 28904 (Incremental Sort)
          Node 28905 (Nested Loop)
            Node 28906 (Merge Join)
              Node 28907 (Sort)
                Node 28908 (Hash Join)
                  Node 28909 (Seq Scan) - LEAF
                  Node 28910 (Hash)
...
| 28907 | Sort | 2837.28 | 1099.77 | 61.2% | operator |
| 28913 | Sort | 63.72 | 1074.66 | 1586.6% | operator |
| 28908 | Hash Join | 2837.27 | 686.33 | 75.8% | operator |
| 28914 | Seq Scan | 52.19 | 18.25 | 65.0% | operator |
| 28909 | Seq Scan | 197.18 | 170.37 | 13.6% | operator |
| 28910 | Hash | 2610.13 | 21.04 | 99.2% | operator |
...
### Step 3: Node 28909 (Seq Scan) - LEAF
...
### Step 6: Node 28914 (Seq Scan) - LEAF
...
### Step 9: Node 28906 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 28915 (Index Scan) - LEAF
...
### Step 11: Node 28905 (Nested Loop)
...
### Step 12: Node 28904 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 28903 (Gather Merge)
