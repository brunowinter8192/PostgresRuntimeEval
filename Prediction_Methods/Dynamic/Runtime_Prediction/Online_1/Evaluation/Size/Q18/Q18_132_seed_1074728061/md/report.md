        ...
        Node 29384 (Incremental Sort)
          Node 29385 (Nested Loop)
            Node 29386 (Merge Join)
              Node 29387 (Sort)
                Node 29388 (Hash Join)
                  Node 29389 (Seq Scan) - LEAF
                  Node 29390 (Hash)
...
| 29387 | Sort | 2842.39 | 1099.77 | 61.3% | operator |
| 29393 | Sort | 64.89 | 1074.66 | 1556.3% | operator |
| 29388 | Hash Join | 2842.37 | 686.33 | 75.9% | operator |
| 29394 | Seq Scan | 53.74 | 18.25 | 66.1% | operator |
| 29389 | Seq Scan | 189.35 | 170.37 | 10.0% | operator |
| 29390 | Hash | 2622.14 | 21.04 | 99.2% | operator |
...
### Step 3: Node 29389 (Seq Scan) - LEAF
...
### Step 6: Node 29394 (Seq Scan) - LEAF
...
### Step 9: Node 29386 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29395 (Index Scan) - LEAF
...
### Step 11: Node 29385 (Nested Loop)
...
### Step 12: Node 29384 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29383 (Gather Merge)
