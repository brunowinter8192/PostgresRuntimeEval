        ...
        Node 30024 (Incremental Sort)
          Node 30025 (Nested Loop)
            Node 30026 (Merge Join)
              Node 30027 (Sort)
                Node 30028 (Hash Join)
                  Node 30029 (Seq Scan) - LEAF
                  Node 30030 (Hash)
...
| 30027 | Sort | 2845.51 | 1099.77 | 61.4% | operator |
| 30033 | Sort | 66.18 | 1074.66 | 1523.9% | operator |
| 30028 | Hash Join | 2845.49 | 686.33 | 75.9% | operator |
| 30034 | Seq Scan | 54.54 | 18.25 | 66.5% | operator |
| 30029 | Seq Scan | 196.38 | 170.37 | 13.2% | operator |
| 30030 | Hash | 2622.54 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30029 (Seq Scan) - LEAF
...
### Step 6: Node 30034 (Seq Scan) - LEAF
...
### Step 9: Node 30026 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30035 (Index Scan) - LEAF
...
### Step 11: Node 30025 (Nested Loop)
...
### Step 12: Node 30024 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30023 (Gather Merge)
