...
**Test Query:** Q18_122_seed_992687751
...
```
Node 29204 (Limit) - ROOT
  Node 29205 (Sort)
    Node 29206 (Aggregate)
      Node 29207 (Gather Merge)
        Node 29208 (Incremental Sort)
          Node 29209 (Nested Loop)
            Node 29210 (Merge Join)
              Node 29211 (Sort)
                Node 29212 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 29204 | Limit | 3036.05 | 1175.21 | 61.3% | operator |
| 29205 | Sort | 2914.96 | 1127.81 | 61.3% | operator |
| 29206 | Aggregate | 2914.92 | 1073.15 | 63.2% | operator |
| 29207 | Gather Merge | 2914.90 | 1073.95 | 63.2% | operator |
| 29208 | Incremental Sort | 2894.37 | 0.00 | 100.0% | operator |
| 29209 | Nested Loop | 2894.33 | 1111.34 | 61.6% | operator |
| 29210 | Merge Join | 2894.26 | 0.00 | 100.0% | operator |
| 29219 | Index Scan | 0.02 | 0.05 | 114.9% | operator |
| 29211 | Sort | 2825.67 | 1099.77 | 61.1% | operator |
| 29217 | Sort | 65.58 | 1074.66 | 1538.6% | operator |
| 29212 | Hash Join | 2825.66 | 686.33 | 75.7% | operator |
| 29218 | Seq Scan | 52.91 | 18.25 | 65.5% | operator |
| 29213 | Seq Scan | 198.30 | 170.37 | 14.1% | operator |
| 29214 | Hash | 2599.24 | 21.04 | 99.2% | operator |
| 29215 | Aggregate | 2599.20 | 1073.15 | 58.7% | operator |
| 29216 | Index Scan | 2114.26 | 0.00 | 100.0% | operator |
...
### Step 3: Node 29213 (Seq Scan) - LEAF
...
### Step 6: Node 29218 (Seq Scan) - LEAF
...
### Step 9: Node 29210 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29219 (Index Scan) - LEAF
...
### Step 11: Node 29209 (Nested Loop)
...
### Step 12: Node 29208 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29207 (Gather Merge)
