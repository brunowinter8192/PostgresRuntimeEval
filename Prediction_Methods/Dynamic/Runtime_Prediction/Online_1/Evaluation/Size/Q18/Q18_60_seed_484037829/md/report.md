        ...
        Node 30520 (Incremental Sort)
          Node 30521 (Nested Loop)
            Node 30522 (Merge Join)
              Node 30523 (Sort)
                Node 30524 (Hash Join)
                  Node 30525 (Seq Scan) - LEAF
                  Node 30526 (Hash)
...
| 30523 | Sort | 2800.54 | 1099.77 | 60.7% | operator |
| 30529 | Sort | 66.89 | 1074.66 | 1506.5% | operator |
| 30524 | Hash Join | 2800.53 | 686.33 | 75.5% | operator |
| 30530 | Seq Scan | 54.06 | 18.25 | 66.2% | operator |
| 30525 | Seq Scan | 198.48 | 170.37 | 14.2% | operator |
| 30526 | Hash | 2573.49 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30525 (Seq Scan) - LEAF
...
### Step 6: Node 30530 (Seq Scan) - LEAF
...
### Step 9: Node 30522 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30531 (Index Scan) - LEAF
...
### Step 11: Node 30521 (Nested Loop)
...
### Step 12: Node 30520 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30519 (Gather Merge)
