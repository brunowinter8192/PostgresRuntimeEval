        ...
        Node 28984 (Incremental Sort)
          Node 28985 (Nested Loop)
            Node 28986 (Merge Join)
              Node 28987 (Sort)
                Node 28988 (Hash Join)
                  Node 28989 (Seq Scan) - LEAF
                  Node 28990 (Hash)
...
| 28987 | Sort | 2836.12 | 1099.77 | 61.2% | operator |
| 28993 | Sort | 63.49 | 1074.66 | 1592.6% | operator |
| 28988 | Hash Join | 2836.11 | 686.33 | 75.8% | operator |
| 28994 | Seq Scan | 51.80 | 18.25 | 64.8% | operator |
| 28989 | Seq Scan | 209.23 | 170.37 | 18.6% | operator |
| 28990 | Hash | 2598.56 | 21.04 | 99.2% | operator |
...
### Step 3: Node 28989 (Seq Scan) - LEAF
...
### Step 6: Node 28994 (Seq Scan) - LEAF
...
### Step 9: Node 28986 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 28995 (Index Scan) - LEAF
...
### Step 11: Node 28985 (Nested Loop)
...
### Step 12: Node 28984 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 28983 (Gather Merge)
