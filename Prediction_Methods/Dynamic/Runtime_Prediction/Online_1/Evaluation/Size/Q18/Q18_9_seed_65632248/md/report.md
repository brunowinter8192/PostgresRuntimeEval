        ...
        Node 31208 (Incremental Sort)
          Node 31209 (Nested Loop)
            Node 31210 (Merge Join)
              Node 31211 (Sort)
                Node 31212 (Hash Join)
                  Node 31213 (Seq Scan) - LEAF
                  Node 31214 (Hash)
...
| 31211 | Sort | 2843.98 | 1099.77 | 61.3% | operator |
| 31217 | Sort | 67.38 | 1074.66 | 1494.9% | operator |
| 31212 | Hash Join | 2843.97 | 686.33 | 75.9% | operator |
| 31218 | Seq Scan | 54.51 | 18.25 | 66.5% | operator |
| 31213 | Seq Scan | 194.28 | 170.37 | 12.3% | operator |
| 31214 | Hash | 2619.31 | 21.04 | 99.2% | operator |
...
### Step 3: Node 31213 (Seq Scan) - LEAF
...
### Step 6: Node 31218 (Seq Scan) - LEAF
...
### Step 9: Node 31210 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 31219 (Index Scan) - LEAF
...
### Step 11: Node 31209 (Nested Loop)
...
### Step 12: Node 31208 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 31207 (Gather Merge)
