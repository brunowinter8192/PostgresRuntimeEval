        ...
        Node 30696 (Incremental Sort)
          Node 30697 (Nested Loop)
            Node 30698 (Merge Join)
              Node 30699 (Sort)
                Node 30700 (Hash Join)
                  Node 30701 (Seq Scan) - LEAF
                  Node 30702 (Hash)
...
| 30699 | Sort | 2850.79 | 1099.77 | 61.4% | operator |
| 30705 | Sort | 68.12 | 1074.66 | 1477.6% | operator |
| 30700 | Hash Join | 2850.78 | 686.33 | 75.9% | operator |
| 30706 | Seq Scan | 53.79 | 18.25 | 66.1% | operator |
| 30701 | Seq Scan | 199.25 | 170.37 | 14.5% | operator |
| 30702 | Hash | 2622.83 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30701 (Seq Scan) - LEAF
...
### Step 6: Node 30706 (Seq Scan) - LEAF
...
### Step 9: Node 30698 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30707 (Index Scan) - LEAF
...
### Step 11: Node 30697 (Nested Loop)
...
### Step 12: Node 30696 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30695 (Gather Merge)
