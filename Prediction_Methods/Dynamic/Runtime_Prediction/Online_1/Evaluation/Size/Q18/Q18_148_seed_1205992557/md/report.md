        ...
        Node 29656 (Incremental Sort)
          Node 29657 (Nested Loop)
            Node 29658 (Merge Join)
              Node 29659 (Sort)
                Node 29660 (Hash Join)
                  Node 29661 (Seq Scan) - LEAF
                  Node 29662 (Hash)
...
| 29659 | Sort | 2844.32 | 1099.77 | 61.3% | operator |
| 29665 | Sort | 64.85 | 1074.66 | 1557.2% | operator |
| 29660 | Hash Join | 2844.31 | 686.33 | 75.9% | operator |
| 29666 | Seq Scan | 53.34 | 18.25 | 65.8% | operator |
| 29661 | Seq Scan | 202.66 | 170.37 | 15.9% | operator |
| 29662 | Hash | 2613.06 | 21.04 | 99.2% | operator |
...
### Step 3: Node 29661 (Seq Scan) - LEAF
...
### Step 6: Node 29666 (Seq Scan) - LEAF
...
### Step 9: Node 29658 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29667 (Index Scan) - LEAF
...
### Step 11: Node 29657 (Nested Loop)
...
### Step 12: Node 29656 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29655 (Gather Merge)
