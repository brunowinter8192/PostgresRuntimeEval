...
**Test Query:** Q18_116_seed_943463565
...
```
Node 29092 (Limit) - ROOT
  Node 29093 (Sort)
    Node 29094 (Aggregate)
      Node 29095 (Gather Merge)
        Node 29096 (Incremental Sort)
          Node 29097 (Nested Loop)
            Node 29098 (Merge Join)
              Node 29099 (Sort)
                Node 29100 (Hash Join)
                  Node 29101 (Seq Scan) - LEAF
                  Node 29102 (Hash)
                    Node 29103 (Aggregate)
                      Node 29104 (Index Scan) - LEAF
              Node 29105 (Sort)
                Node 29106 (Seq Scan) - LEAF
            Node 29107 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 29092 | Limit | 3056.71 | 1175.21 | 61.6% | operator |
| 29093 | Sort | 2940.36 | 1127.81 | 61.6% | operator |
| 29094 | Aggregate | 2940.32 | 1073.15 | 63.5% | operator |
| 29095 | Gather Merge | 2940.31 | 1073.95 | 63.5% | operator |
| 29096 | Incremental Sort | 2916.83 | 0.00 | 100.0% | operator |
| 29097 | Nested Loop | 2916.79 | 1111.34 | 61.9% | operator |
| 29098 | Merge Join | 2915.65 | 0.00 | 100.0% | operator |
| 29107 | Index Scan | 0.50 | 0.05 | 91.0% | operator |
| 29099 | Sort | 2840.71 | 1099.77 | 61.3% | operator |
| 29105 | Sort | 71.75 | 1074.66 | 1397.9% | operator |
| 29100 | Hash Join | 2840.70 | 686.33 | 75.8% | operator |
| 29106 | Seq Scan | 58.23 | 18.25 | 68.7% | operator |
| 29101 | Seq Scan | 201.64 | 170.37 | 15.5% | operator |
| 29102 | Hash | 2609.60 | 21.04 | 99.2% | operator |
| 29103 | Aggregate | 2609.55 | 1073.15 | 58.9% | operator |
| 29104 | Index Scan | 2106.82 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29104 (Index Scan) - LEAF
...
### Step 3: Node 29101 (Seq Scan) - LEAF
...
### Step 6: Node 29106 (Seq Scan) - LEAF
...
### Step 9: Node 29098 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29107 (Index Scan) - LEAF
...
### Step 11: Node 29097 (Nested Loop)
...
### Step 12: Node 29096 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29095 (Gather Merge)
