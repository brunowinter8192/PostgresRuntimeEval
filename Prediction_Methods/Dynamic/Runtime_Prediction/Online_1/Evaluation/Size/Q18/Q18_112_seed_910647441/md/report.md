...
**Test Query:** Q18_112_seed_910647441
...
```
Node 29028 (Limit) - ROOT
  Node 29029 (Sort)
    Node 29030 (Aggregate)
      Node 29031 (Gather Merge)
        Node 29032 (Incremental Sort)
          Node 29033 (Nested Loop)
            Node 29034 (Merge Join)
              Node 29035 (Sort)
                Node 29036 (Hash Join)
                  Node 29037 (Seq Scan) - LEAF
                  Node 29038 (Hash)
                    Node 29039 (Aggregate)
                      Node 29040 (Index Scan) - LEAF
              Node 29041 (Sort)
                Node 29042 (Seq Scan) - LEAF
            Node 29043 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 29028 | Limit | 3014.18 | 1175.21 | 61.0% | operator |
| 29029 | Sort | 2897.97 | 1127.81 | 61.1% | operator |
| 29030 | Aggregate | 2897.92 | 1073.15 | 63.0% | operator |
| 29031 | Gather Merge | 2897.91 | 1073.95 | 62.9% | operator |
| 29032 | Incremental Sort | 2877.95 | 0.00 | 100.0% | operator |
| 29033 | Nested Loop | 2877.90 | 1111.34 | 61.4% | operator |
| 29034 | Merge Join | 2877.84 | 0.00 | 100.0% | operator |
| 29043 | Index Scan | 0.02 | 0.05 | 105.2% | operator |
| 29035 | Sort | 2805.69 | 1099.77 | 60.8% | operator |
| 29041 | Sort | 69.09 | 1074.66 | 1455.5% | operator |
| 29036 | Hash Join | 2805.68 | 686.33 | 75.5% | operator |
| 29042 | Seq Scan | 56.27 | 18.25 | 67.6% | operator |
| 29037 | Seq Scan | 183.26 | 170.37 | 7.0% | operator |
| 29038 | Hash | 2595.75 | 21.04 | 99.2% | operator |
| 29039 | Aggregate | 2595.73 | 1073.15 | 58.7% | operator |
| 29040 | Index Scan | 2097.54 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29040 (Index Scan) - LEAF
...
### Step 3: Node 29037 (Seq Scan) - LEAF
...
### Step 6: Node 29042 (Seq Scan) - LEAF
...
### Step 9: Node 29034 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29043 (Index Scan) - LEAF
...
### Step 11: Node 29033 (Nested Loop)
...
### Step 12: Node 29032 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29031 (Gather Merge)
