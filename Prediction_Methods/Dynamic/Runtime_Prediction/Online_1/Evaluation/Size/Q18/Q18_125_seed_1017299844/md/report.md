        ...
        Node 29256 (Incremental Sort)
          Node 29257 (Nested Loop)
            Node 29258 (Merge Join)
              Node 29259 (Sort)
                Node 29260 (Hash Join)
                  Node 29261 (Seq Scan) - LEAF
                  Node 29262 (Hash)
...
| 29259 | Sort | 2848.26 | 1099.77 | 61.4% | operator |
| 29265 | Sort | 67.38 | 1074.66 | 1495.0% | operator |
| 29260 | Hash Join | 2848.25 | 686.33 | 75.9% | operator |
| 29266 | Seq Scan | 53.65 | 18.25 | 66.0% | operator |
| 29261 | Seq Scan | 192.33 | 170.37 | 11.4% | operator |
| 29262 | Hash | 2627.51 | 21.04 | 99.2% | operator |
...
### Step 3: Node 29261 (Seq Scan) - LEAF
...
### Step 6: Node 29266 (Seq Scan) - LEAF
...
### Step 9: Node 29258 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29267 (Index Scan) - LEAF
...
### Step 11: Node 29257 (Nested Loop)
...
### Step 12: Node 29256 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29255 (Gather Merge)
