        ...
        Node 30648 (Incremental Sort)
          Node 30649 (Nested Loop)
            Node 30650 (Merge Join)
              Node 30651 (Sort)
                Node 30652 (Hash Join)
                  Node 30653 (Seq Scan) - LEAF
                  Node 30654 (Hash)
...
| 30651 | Sort | 2829.47 | 1099.77 | 61.1% | operator |
| 30657 | Sort | 64.61 | 1074.66 | 1563.4% | operator |
| 30652 | Hash Join | 2829.46 | 686.33 | 75.7% | operator |
| 30658 | Seq Scan | 52.74 | 18.25 | 65.4% | operator |
| 30653 | Seq Scan | 190.44 | 170.37 | 10.5% | operator |
| 30654 | Hash | 2609.95 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30653 (Seq Scan) - LEAF
...
### Step 6: Node 30658 (Seq Scan) - LEAF
...
### Step 9: Node 30650 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30659 (Index Scan) - LEAF
...
### Step 11: Node 30649 (Nested Loop)
...
### Step 12: Node 30648 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30647 (Gather Merge)
