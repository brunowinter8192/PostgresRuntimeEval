        ...
        Node 29272 (Incremental Sort)
          Node 29273 (Nested Loop)
            Node 29274 (Merge Join)
              Node 29275 (Sort)
                Node 29276 (Hash Join)
                  Node 29277 (Seq Scan) - LEAF
                  Node 29278 (Hash)
...
| 29275 | Sort | 2837.47 | 1099.77 | 61.2% | operator |
| 29281 | Sort | 65.74 | 1074.66 | 1534.6% | operator |
| 29276 | Hash Join | 2837.45 | 686.33 | 75.8% | operator |
| 29282 | Seq Scan | 53.74 | 18.25 | 66.0% | operator |
| 29277 | Seq Scan | 200.65 | 170.37 | 15.1% | operator |
| 29278 | Hash | 2605.12 | 21.04 | 99.2% | operator |
...
### Step 3: Node 29277 (Seq Scan) - LEAF
...
### Step 6: Node 29282 (Seq Scan) - LEAF
...
### Step 9: Node 29274 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29283 (Index Scan) - LEAF
...
### Step 11: Node 29273 (Nested Loop)
...
### Step 12: Node 29272 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29271 (Gather Merge)
