        ...
        Node 29576 (Incremental Sort)
          Node 29577 (Nested Loop)
            Node 29578 (Merge Join)
              Node 29579 (Sort)
                Node 29580 (Hash Join)
                  Node 29581 (Seq Scan) - LEAF
                  Node 29582 (Hash)
...
| 29579 | Sort | 2840.34 | 1099.77 | 61.3% | operator |
| 29585 | Sort | 68.29 | 1074.66 | 1473.7% | operator |
| 29580 | Hash Join | 2840.32 | 686.33 | 75.8% | operator |
| 29586 | Seq Scan | 55.27 | 18.25 | 67.0% | operator |
| 29581 | Seq Scan | 194.64 | 170.37 | 12.5% | operator |
| 29582 | Hash | 2616.98 | 21.04 | 99.2% | operator |
...
### Step 3: Node 29581 (Seq Scan) - LEAF
...
### Step 6: Node 29586 (Seq Scan) - LEAF
...
### Step 9: Node 29578 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29587 (Index Scan) - LEAF
...
### Step 11: Node 29577 (Nested Loop)
...
### Step 12: Node 29576 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29575 (Gather Merge)
