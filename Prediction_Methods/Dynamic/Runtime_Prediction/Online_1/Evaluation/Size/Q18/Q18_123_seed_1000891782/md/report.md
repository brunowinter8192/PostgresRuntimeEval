...
**Test Query:** Q18_123_seed_1000891782
...
```
Node 29220 (Limit) - ROOT
  Node 29221 (Sort)
    Node 29222 (Aggregate)
      Node 29223 (Gather Merge)
        Node 29224 (Incremental Sort)
          Node 29225 (Nested Loop)
            Node 29226 (Merge Join)
              Node 29227 (Sort)
                Node 29228 (Hash Join)
                  Node 29229 (Seq Scan) - LEAF
                  Node 29230 (Hash)
                    Node 29231 (Aggregate)
                      Node 29232 (Index Scan) - LEAF
              Node 29233 (Sort)
                Node 29234 (Seq Scan) - LEAF
            Node 29235 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 29220 | Limit | 3091.48 | 1175.21 | 62.0% | operator |
| 29221 | Sort | 2979.61 | 1127.81 | 62.1% | operator |
| 29222 | Aggregate | 2979.57 | 1073.15 | 64.0% | operator |
| 29223 | Gather Merge | 2979.55 | 1073.95 | 64.0% | operator |
| 29224 | Incremental Sort | 2958.77 | 0.00 | 100.0% | operator |
| 29225 | Nested Loop | 2958.72 | 1111.34 | 62.4% | operator |
| 29226 | Merge Join | 2958.66 | 0.00 | 100.0% | operator |
| 29235 | Index Scan | 0.03 | 0.05 | 80.5% | operator |
| 29227 | Sort | 2891.79 | 1099.77 | 62.0% | operator |
| 29233 | Sort | 63.91 | 1074.66 | 1581.4% | operator |
| 29228 | Hash Join | 2891.77 | 686.33 | 76.3% | operator |
| 29234 | Seq Scan | 51.80 | 18.25 | 64.8% | operator |
| 29229 | Seq Scan | 190.02 | 170.37 | 10.3% | operator |
| 29230 | Hash | 2671.80 | 21.04 | 99.2% | operator |
| 29231 | Aggregate | 2671.76 | 1073.15 | 59.8% | operator |
| 29232 | Index Scan | 2177.90 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29232 (Index Scan) - LEAF
...
### Step 3: Node 29229 (Seq Scan) - LEAF
...
### Step 6: Node 29234 (Seq Scan) - LEAF
...
### Step 9: Node 29226 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29235 (Index Scan) - LEAF
...
### Step 11: Node 29225 (Nested Loop)
...
### Step 12: Node 29224 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29223 (Gather Merge)
