        ...
        Node 30104 (Incremental Sort)
          Node 30105 (Nested Loop)
            Node 30106 (Merge Join)
              Node 30107 (Sort)
                Node 30108 (Hash Join)
                  Node 30109 (Seq Scan) - LEAF
                  Node 30110 (Hash)
...
| 30107 | Sort | 2858.14 | 1099.77 | 61.5% | operator |
| 30113 | Sort | 67.69 | 1074.66 | 1487.6% | operator |
| 30108 | Hash Join | 2858.13 | 686.33 | 76.0% | operator |
| 30114 | Seq Scan | 53.19 | 18.25 | 65.7% | operator |
| 30109 | Seq Scan | 198.83 | 170.37 | 14.3% | operator |
| 30110 | Hash | 2629.23 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30109 (Seq Scan) - LEAF
...
### Step 6: Node 30114 (Seq Scan) - LEAF
...
### Step 9: Node 30106 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30115 (Index Scan) - LEAF
...
### Step 11: Node 30105 (Nested Loop)
...
### Step 12: Node 30104 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30103 (Gather Merge)
