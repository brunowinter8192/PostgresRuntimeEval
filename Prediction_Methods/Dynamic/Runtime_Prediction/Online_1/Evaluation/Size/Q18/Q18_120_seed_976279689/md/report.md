...
**Test Query:** Q18_120_seed_976279689
...
```
Node 29172 (Limit) - ROOT
  Node 29173 (Sort)
    Node 29174 (Aggregate)
      Node 29175 (Gather Merge)
        Node 29176 (Incremental Sort)
          Node 29177 (Nested Loop)
            Node 29178 (Merge Join)
              Node 29179 (Sort)
                Node 29180 (Hash Join)
                  Node 29181 (Seq Scan) - LEAF
                  Node 29182 (Hash)
                    Node 29183 (Aggregate)
                      Node 29184 (Index Scan) - LEAF
              Node 29185 (Sort)
                Node 29186 (Seq Scan) - LEAF
            Node 29187 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 29172 | Limit | 3034.59 | 1175.21 | 61.3% | operator |
| 29173 | Sort | 2919.15 | 1127.81 | 61.4% | operator |
| 29174 | Aggregate | 2919.11 | 1073.15 | 63.2% | operator |
| 29175 | Gather Merge | 2919.09 | 1073.95 | 63.2% | operator |
| 29176 | Incremental Sort | 2896.50 | 0.00 | 100.0% | operator |
| 29177 | Nested Loop | 2896.46 | 1111.34 | 61.6% | operator |
| 29178 | Merge Join | 2896.40 | 0.00 | 100.0% | operator |
| 29187 | Index Scan | 0.02 | 0.05 | 105.2% | operator |
| 29179 | Sort | 2829.21 | 1099.77 | 61.1% | operator |
| 29185 | Sort | 64.81 | 1074.66 | 1558.2% | operator |
| 29180 | Hash Join | 2829.20 | 686.33 | 75.7% | operator |
| 29186 | Seq Scan | 53.37 | 18.25 | 65.8% | operator |
| 29181 | Seq Scan | 187.74 | 170.37 | 9.2% | operator |
| 29182 | Hash | 2612.63 | 21.04 | 99.2% | operator |
| 29183 | Aggregate | 2612.59 | 1073.15 | 58.9% | operator |
| 29184 | Index Scan | 2117.12 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29184 (Index Scan) - LEAF
...
### Step 3: Node 29181 (Seq Scan) - LEAF
...
### Step 6: Node 29186 (Seq Scan) - LEAF
...
### Step 9: Node 29178 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29187 (Index Scan) - LEAF
...
### Step 11: Node 29177 (Nested Loop)
...
### Step 12: Node 29176 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29175 (Gather Merge)
