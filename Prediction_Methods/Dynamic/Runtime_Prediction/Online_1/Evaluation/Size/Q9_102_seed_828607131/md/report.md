...
```
Node 16688 (Sort) - ROOT
  Node 16689 (Aggregate)
    Node 16690 (Gather)
      Node 16691 (Aggregate)
        Node 16692 (Nested Loop)
          Node 16693 (Hash Join)
            Node 16694 (Seq Scan) - LEAF
            Node 16695 (Hash)
              Node 16696 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 16688 | Sort | 1180.99 | 1120.12 | 5.2% | operator |
| 16689 | Aggregate | 1180.87 | 898.05 | 24.0% | operator |
...
| 16693 | Hash Join | 957.54 | 633.69 | 33.8% | operator |
| 16705 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 16694 | Seq Scan | 695.45 | 509.93 | 26.7% | operator |
| 16695 | Hash | 169.45 | 48.14 | 71.6% | operator |
| 16696 | Hash Join | 167.90 | 924.53 | 450.6% | operator |
...
### Step 10: Node 16694 (Seq Scan) - LEAF
...
### Step 13: Node 16705 (Index Scan) - LEAF
...
### Step 14: Node 16692 (Nested Loop)
