...
**Test Query:** Q9_102_seed_828607131
  ...
  Node 16689 (Aggregate) [consumed]
    Node 16690 (Gather)
      Node 16691 (Aggregate)
        Node 16692 (Nested Loop)
          Node 16693 (Hash Join) [PATTERN: bb930825]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 16693 | 16688, 16689, 16694, 16695, 16696 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 16688 | 16689, 16693, 16694, 16695, 16696 |
...
|------|------|--------|-----------|-----|--------|
| 16688 | Sort | 1180.99 | 1045.86 | 11.4% | pattern |
| 16690 | Gather | 1179.79 | 964.48 | 18.2% | operator |
| 16691 | Aggregate | 1159.13 | 1075.81 | 7.2% | operator |
| 16692 | Nested Loop | 1135.28 | 1252.17 | 10.3% | operator |
| 16693 | Hash Join | 957.54 | 134.80 | 85.9% | pattern |
| 16705 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 16697 | Hash Join | 153.53 | 837.66 | 445.6% | operator |
| 16703 | Hash | 13.76 | 14.95 | 8.6% | operator |
| 16698 | Nested Loop | 149.31 | 1251.77 | 738.4% | operator |
| 16701 | Hash | 2.16 | 15.94 | 638.0% | operator |
| 16704 | Seq Scan | 13.75 | 2.94 | 78.6% | operator |
| 16699 | Seq Scan | 19.83 | 43.89 | 121.4% | operator |
| 16700 | Index Scan | 0.07 | -1.39 | 2028.5% | operator |
| 16702 | Seq Scan | 1.71 | 9.45 | 452.7% | operator |
...
### Step 6: Node 16704 (Seq Scan) - LEAF
...
### Step 9: Node 16693 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 16688, 16689, 16694, 16695, 16696
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 16705 (Index Scan) - LEAF
...
### Step 11: Node 16692 (Nested Loop)
...
### Step 14: Node 16688 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 16689, 16693, 16694, 16695, 16696
- **Input Features:**
