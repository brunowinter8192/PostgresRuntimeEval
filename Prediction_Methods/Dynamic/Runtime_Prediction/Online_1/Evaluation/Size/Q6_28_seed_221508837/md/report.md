...
**Test Query:** Q6_28_seed_221508837
...
```
Node 10181 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10182 (Gather) [consumed]
    Node 10183 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10181 | 10182, 10183 |
...
|------|------|--------|-----------|-----|--------|
| 10181 | Aggregate | 809.50 | 850.05 | 5.0% | pattern |
| 10184 | Seq Scan | 789.29 | 748.53 | 5.2% | operator |
...
### Step 2: Node 10181 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10182, 10183
- **Input Features:**
