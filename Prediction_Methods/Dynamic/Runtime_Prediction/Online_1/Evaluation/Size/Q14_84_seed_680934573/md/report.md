...
```
Node 27344 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27345 (Gather) [consumed]
    Node 27346 (Aggregate) [consumed]
      Node 27347 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27344 | 27345, 27346, 27347 |
...
|------|------|--------|-----------|-----|--------|
| 27344 | Aggregate | 823.87 | 857.10 | 4.0% | pattern |
| 27348 | Seq Scan | 750.38 | 758.42 | 1.1% | operator |
| 27349 | Hash | 43.94 | 9.38 | 78.7% | operator |
| 27350 | Seq Scan | 38.46 | 12.70 | 67.0% | operator |
...
### Step 4: Node 27344 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27345, 27346, 27347
- **Input Features:**
