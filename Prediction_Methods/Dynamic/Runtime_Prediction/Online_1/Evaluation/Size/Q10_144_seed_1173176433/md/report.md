    ...
    Node 19996 (Aggregate) [consumed]
      Node 19997 (Gather) [consumed]
        Node 19998 (Hash Join)
          Node 19999 (Hash Join)
            Node 20000 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19994 | 19995, 19996, 19997 |
...
| 19998 | Hash Join | 1085.79 | 1007.14 | 7.2% | operator |
| 19999 | Hash Join | 1082.82 | 1004.00 | 7.3% | operator |
| 20005 | Hash | 0.01 | 15.71 | 104638.5% | operator |
| 20000 | Nested Loop | 1036.86 | 1204.86 | 16.2% | operator |
| 20003 | Hash | 35.42 | 55.57 | 56.9% | operator |
...
- **Output:** st=124.87, rt=1204.86

### Step 5: Node 20003 (Hash)
...
### Step 6: Node 20006 (Seq Scan) - LEAF
...
- **Output:** st=109.73, rt=1004.00

### Step 8: Node 20005 (Hash)
...
- **Output:** st=98.93, rt=1007.14

### Step 10: Node 19994 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19995, 19996, 19997
- **Input Features:**
