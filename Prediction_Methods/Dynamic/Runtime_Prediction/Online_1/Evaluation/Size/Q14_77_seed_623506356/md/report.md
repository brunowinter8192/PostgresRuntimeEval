...
**Test Query:** Q14_77_seed_623506356
...
```
Node 27288 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27289 (Gather) [consumed]
    Node 27290 (Aggregate) [consumed]
      Node 27291 (Hash Join)
        Node 27292 (Seq Scan) - LEAF
        Node 27293 (Hash)
          Node 27294 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27288 | 27289, 27290 |
...
|------|------|--------|-----------|-----|--------|
| 27288 | Aggregate | 844.33 | 848.36 | 0.5% | pattern |
| 27291 | Hash Join | 822.63 | 807.64 | 1.8% | operator |
| 27292 | Seq Scan | 768.98 | 758.48 | 1.4% | operator |
| 27293 | Hash | 45.75 | 9.38 | 79.5% | operator |
| 27294 | Seq Scan | 39.79 | 12.70 | 68.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27294 (Seq Scan) - LEAF
...
### Step 2: Node 27292 (Seq Scan) - LEAF
...
### Step 5: Node 27288 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27289, 27290
- **Input Features:**
