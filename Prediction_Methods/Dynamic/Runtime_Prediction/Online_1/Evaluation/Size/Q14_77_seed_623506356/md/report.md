...
```
Node 27288 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27289 (Gather) [consumed]
    Node 27290 (Aggregate) [consumed]
      Node 27291 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27288 | 27289, 27290, 27291 |
...
|------|------|--------|-----------|-----|--------|
| 27288 | Aggregate | 844.33 | 857.13 | 1.5% | pattern |
...
### Step 4: Node 27288 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27289, 27290, 27291
- **Input Features:**
