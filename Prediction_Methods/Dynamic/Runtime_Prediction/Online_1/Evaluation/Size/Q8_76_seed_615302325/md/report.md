...
```
Node 16030 (Aggregate) - ROOT
  Node 16031 (Gather Merge)
    Node 16032 (Sort)
          ...
          Node 16035 (Hash Join)
            Node 16036 (Nested Loop)
              Node 16037 (Hash Join)
                ...
                Node 16039 (Hash)
                  Node 16040 (Hash Join)
                    Node 16041 (Seq Scan) - LEAF
                    Node 16042 (Hash)
                      Node 16043 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 16030 | Aggregate | 1247.57 | 1195.83 | 4.1% | operator |
| 16031 | Gather Merge | 1247.14 | 1097.18 | 12.0% | operator |
...
| 16037 | Hash Join | 218.57 | 251.17 | 14.9% | operator |
...
| 16039 | Hash | 39.03 | 20.62 | 47.2% | operator |
| 16040 | Hash Join | 37.44 | 132.26 | 253.3% | operator |
| 16041 | Seq Scan | 35.95 | 23.03 | 35.9% | operator |
| 16042 | Hash | 0.14 | 23.66 | 17294.2% | operator |
| 16043 | Hash Join | 0.13 | 306.84 | 232351.5% | operator |
...
### Step 5: Node 16041 (Seq Scan) - LEAF
...
### Step 8: Node 16038 (Seq Scan) - LEAF
...
### Step 11: Node 16047 (Index Scan) - LEAF
...
### Step 12: Node 16049 (Seq Scan) - LEAF
...
### Step 13: Node 16036 (Nested Loop)
...
### Step 16: Node 16050 (Index Scan) - LEAF
...
### Step 17: Node 16052 (Seq Scan) - LEAF
...
### Step 18: Node 16034 (Nested Loop)
...
### Step 22: Node 16031 (Gather Merge)
...
### Step 23: Node 16030 (Aggregate) - ROOT
