...
**Test Query:** Q6_136_seed_1107544185
...
```
Node 10057 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10058 (Gather) [consumed]
    Node 10059 (Aggregate) [consumed]
      Node 10060 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10057 | 10058, 10059 |
...
|------|------|--------|-----------|-----|--------|
| 10057 | Aggregate | 798.72 | 849.98 | 6.4% | pattern |
| 10060 | Seq Scan | 778.87 | 748.49 | 3.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10060 (Seq Scan) - LEAF
...
### Step 2: Node 10057 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10058, 10059
- **Input Features:**
