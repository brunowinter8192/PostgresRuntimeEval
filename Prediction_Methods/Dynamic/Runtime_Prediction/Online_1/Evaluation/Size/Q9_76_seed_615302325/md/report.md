...
```
Node 18880 (Sort) - ROOT
  Node 18881 (Aggregate)
    Node 18882 (Gather)
      Node 18883 (Aggregate)
        Node 18884 (Nested Loop)
          Node 18885 (Hash Join)
            Node 18886 (Seq Scan) - LEAF
            Node 18887 (Hash)
              Node 18888 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 18880 | Sort | 1196.17 | 1116.97 | 6.6% | operator |
| 18881 | Aggregate | 1196.05 | 898.50 | 24.9% | operator |
...
| 18885 | Hash Join | 981.41 | 632.07 | 35.6% | operator |
| 18897 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18886 | Seq Scan | 703.26 | 509.93 | 27.5% | operator |
| 18887 | Hash | 184.61 | 47.12 | 74.5% | operator |
| 18888 | Hash Join | 180.94 | 924.03 | 410.7% | operator |
...
### Step 10: Node 18886 (Seq Scan) - LEAF
...
### Step 13: Node 18897 (Index Scan) - LEAF
...
### Step 14: Node 18884 (Nested Loop)
