    ...
    Node 19918 (Aggregate) [consumed]
      Node 19919 (Gather) [consumed]
        Node 19920 (Hash Join)
          Node 19921 (Hash Join)
            Node 19922 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19916 | 19917, 19918, 19919 |
...
| 19920 | Hash Join | 1105.69 | 1007.14 | 8.9% | operator |
| 19921 | Hash Join | 1102.78 | 1003.99 | 9.0% | operator |
| 19927 | Hash | 0.02 | 15.71 | 98092.3% | operator |
| 19922 | Nested Loop | 1057.31 | 1204.86 | 14.0% | operator |
| 19925 | Hash | 35.06 | 55.57 | 58.5% | operator |
...
### Step 6: Node 19928 (Seq Scan) - LEAF
...
- **Output:** st=109.73, rt=1003.99

### Step 8: Node 19927 (Hash)
...
### Step 10: Node 19916 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19917, 19918, 19919
- **Input Features:**
