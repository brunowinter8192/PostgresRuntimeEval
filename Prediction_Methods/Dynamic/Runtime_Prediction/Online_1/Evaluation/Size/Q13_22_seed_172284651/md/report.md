...
**Test Query:** Q13_22_seed_172284651
...
```
Node 25818 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25819 (Aggregate) [consumed]
    Node 25820 (Aggregate)
      Node 25821 (Hash Join) [PATTERN: 895c6e8c]
        Node 25822 (Seq Scan) [consumed] - LEAF
        Node 25823 (Hash) [consumed]
          Node 25824 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25818 | 25819, 25821, 25822, 25823 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25821 | 25818, 25819, 25822, 25823 |
...
|------|------|--------|-----------|-----|--------|
| 25818 | Sort | 932.74 | 1079.94 | 15.8% | pattern |
| 25820 | Aggregate | 926.70 | 999.76 | 7.9% | operator |
| 25821 | Hash Join | 713.94 | 470.31 | 34.1% | pattern |
| 25824 | Index Only Scan | 9.72 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25824 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25821 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25818, 25819, 25822, 25823
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 25818 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25819, 25821, 25822, 25823
- **Input Features:**
