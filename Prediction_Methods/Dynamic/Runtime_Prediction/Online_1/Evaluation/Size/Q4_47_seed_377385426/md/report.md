...
**Test Query:** Q4_47_seed_377385426
...
```
Node 6488 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6489 (Gather Merge) [consumed]
    Node 6490 (Sort) [consumed]
      Node 6491 (Aggregate) [consumed]
        Node 6492 (Nested Loop)
          Node 6493 (Seq Scan) - LEAF
          Node 6494 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6488 | 6489, 6490, 6491 |
...
|------|------|--------|-----------|-----|--------|
| 6488 | Aggregate | 1062.56 | 952.19 | 10.4% | pattern |
| 6492 | Nested Loop | 1054.56 | 1255.45 | 19.0% | operator |
| 6493 | Seq Scan | 162.02 | 154.67 | 4.5% | operator |
| 6494 | Index Scan | 0.06 | 11.10 | 17250.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6493 (Seq Scan) - LEAF
...
### Step 2: Node 6494 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - Aggregate_startup_cost=66564.8300
  - Aggregate_total_cost=66566.7300
  ...
  - GatherMerge_Outer_startup_cost=66564.8300
  - GatherMerge_Outer_total_cost=66566.6000
  - Sort_Outer_np=0
  - Sort_Outer_nt=5
  - Sort_Outer_nt1=5
  - Sort_Outer_nt2=0
  ...
  - Sort_Outer_startup_cost=65564.7900
  - Sort_Outer_total_cost=65564.8000
