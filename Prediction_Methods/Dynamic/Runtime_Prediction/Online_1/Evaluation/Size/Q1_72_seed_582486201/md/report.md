...
Node 596 (Aggregate) - ROOT
  Node 597 (Gather Merge)
    Node 598 (Sort) [PATTERN: 1d35fb97]
      Node 599 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 598 | 599 |
...
|------|------|--------|-----------|-----|--------|
| 596 | Aggregate | 930.16 | 1195.90 | 28.6% | operator |
| 597 | Gather Merge | 930.14 | 1165.91 | 25.3% | operator |
| 598 | Sort | 914.09 | 1200.55 | 31.3% | pattern |
...
### Step 2: Node 598 (Sort) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Aggregate_Outer_nt1=1182677
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=236
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=168996.7300
  - Aggregate_Outer_total_cost=168996.8700
  - Sort_np=0
  - Sort_nt=6
  - Sort_nt1=6
  - Sort_nt2=0
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=168996.9500
  - Sort_total_cost=168996.9600
- **Output:** st=1196.46, rt=1200.55

### Step 3: Node 597 (Gather Merge)
...
### Step 4: Node 596 (Aggregate) - ROOT
