...
**Test Query:** Q19_53_seed_426609612
...
```
Node 31906 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31907 (Gather) [consumed]
    Node 31908 (Aggregate) [consumed]
      Node 31909 (Hash Join) [consumed]
        Node 31910 (Seq Scan) - LEAF
        Node 31911 (Hash)
          Node 31912 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31906 | 31907, 31908, 31909 |
...
|------|------|--------|-----------|-----|--------|
| 31906 | Aggregate | 873.91 | 829.29 | 5.1% | pattern |
| 31910 | Seq Scan | 804.24 | 743.46 | 7.6% | operator |
| 31911 | Hash | 47.23 | 8.29 | 82.5% | operator |
| 31912 | Seq Scan | 47.11 | 23.76 | 49.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31912 (Seq Scan) - LEAF
...
### Step 2: Node 31910 (Seq Scan) - LEAF
...
### Step 4: Node 31906 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31907, 31908, 31909
- **Input Features:**
