...
**Test Query:** Q6_119_seed_968075658
...
```
Node 9981 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 9982 (Gather) [consumed]
    Node 9983 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 9981 | 9982, 9983 |
...
|------|------|--------|-----------|-----|--------|
| 9981 | Aggregate | 783.05 | 849.98 | 8.5% | pattern |
| 9984 | Seq Scan | 763.83 | 748.49 | 2.0% | operator |
...
### Step 2: Node 9981 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 9982, 9983
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=22604
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=32
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=139718.4900
  - Aggregate_Outer_total_cost=139718.5000
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=140719.0300
  - Aggregate_total_cost=140719.0400
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=140718.4900
  - Gather_Outer_total_cost=140719.0000
