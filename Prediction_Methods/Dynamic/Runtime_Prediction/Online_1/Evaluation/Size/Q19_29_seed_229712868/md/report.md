...
**Test Query:** Q19_29_seed_229712868
...
```
Node 31717 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31718 (Gather) [consumed]
    Node 31719 (Aggregate) [consumed]
      Node 31720 (Hash Join) [consumed]
        Node 31721 (Seq Scan) - LEAF
        Node 31722 (Hash)
          Node 31723 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31717 | 31718, 31719, 31720 |
...
|------|------|--------|-----------|-----|--------|
| 31717 | Aggregate | 845.86 | 829.30 | 2.0% | pattern |
| 31721 | Seq Scan | 777.51 | 743.46 | 4.4% | operator |
| 31722 | Hash | 45.85 | 8.29 | 81.9% | operator |
| 31723 | Seq Scan | 45.66 | 23.76 | 48.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31723 (Seq Scan) - LEAF
...
### Step 2: Node 31721 (Seq Scan) - LEAF
...
### Step 4: Node 31717 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31718, 31719, 31720
- **Input Features:**
