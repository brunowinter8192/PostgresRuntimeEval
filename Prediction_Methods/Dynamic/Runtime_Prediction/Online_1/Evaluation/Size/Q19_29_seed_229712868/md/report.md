...
```
Node 31717 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31718 (Gather) [consumed]
    Node 31719 (Aggregate) [consumed]
      Node 31720 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31717 | 31718, 31719 |
...
|------|------|--------|-----------|-----|--------|
| 31717 | Aggregate | 845.86 | 831.20 | 1.7% | pattern |
| 31720 | Hash Join | 825.60 | 766.06 | 7.2% | operator |
...
### Step 5: Node 31717 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31718, 31719
- **Input Features:**
