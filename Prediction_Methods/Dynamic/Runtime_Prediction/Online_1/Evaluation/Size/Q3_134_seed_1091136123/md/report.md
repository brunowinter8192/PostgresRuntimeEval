...
**Test Query:** Q3_134_seed_1091136123
...
```
Node 4721 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 4722 (Sort) [consumed]
    Node 4723 (Aggregate) [consumed]
      Node 4724 (Gather) [consumed]
        Node 4725 (Nested Loop)
          Node 4726 (Hash Join) [PATTERN: 895c6e8c]
            Node 4727 (Seq Scan) [consumed] - LEAF
            Node 4728 (Hash) [consumed]
              Node 4729 (Seq Scan) - LEAF
          Node 4730 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4721 | 4722, 4723, 4724, 4726, 4727, 4728 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4726 | 4721, 4722, 4723, 4724, 4727, 4728 |
...
|------|------|--------|-----------|-----|--------|
| 4721 | Limit | 1209.84 | 1151.18 | 4.8% | pattern |
| 4725 | Nested Loop | 1174.12 | 1193.56 | 1.7% | operator |
| 4726 | Hash Join | 211.21 | 242.58 | 14.8% | pattern |
| 4730 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4729 | Seq Scan | 30.42 | 38.53 | 26.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4729 (Seq Scan) - LEAF
...
### Step 2: Node 4726 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4721, 4722, 4723, 4724, 4727, 4728
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47707
  - HashJoin_nt1=237043
...
### Step 3: Node 4730 (Index Scan) - LEAF
...
### Step 5: Node 4721 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4722, 4723, 4724, 4726, 4727, 4728
- **Input Features:**
