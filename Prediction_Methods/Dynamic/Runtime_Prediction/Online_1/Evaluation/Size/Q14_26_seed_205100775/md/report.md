...
```
Node 26896 (Aggregate) [PATTERN: efde8b38] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26896 | 26897, 26898, 26899 |
...
|------|------|--------|-----------|-----|--------|
| 26896 | Aggregate | 811.96 | 857.13 | 5.6% | pattern |
| 26900 | Seq Scan | 738.37 | 758.48 | 2.7% | operator |
| 26901 | Hash | 42.78 | 9.38 | 78.1% | operator |
| 26902 | Seq Scan | 37.71 | 12.70 | 66.3% | operator |
...
### Step 4: Node 26896 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26897, 26898, 26899
- **Input Features:**
