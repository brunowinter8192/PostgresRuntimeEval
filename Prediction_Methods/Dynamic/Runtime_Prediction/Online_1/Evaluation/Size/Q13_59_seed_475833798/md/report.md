...
```
Node 26098 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26099 (Aggregate) [consumed]
    Node 26100 (Aggregate)
      Node 26101 (Hash Join) [PATTERN: 895c6e8c]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26098 | 26099, 26101, 26102, 26103 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26101 | 26098, 26099, 26102, 26103 |
...
|------|------|--------|-----------|-----|--------|
| 26098 | Sort | 912.93 | 1079.94 | 18.3% | pattern |
| 26100 | Aggregate | 906.92 | 999.76 | 10.2% | operator |
| 26101 | Hash Join | 692.08 | 470.31 | 32.0% | pattern |
| 26104 | Index Only Scan | 10.06 | 0.00 | 100.0% | operator |
...
### Step 2: Node 26101 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26098, 26099, 26102, 26103
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 26098 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26099, 26101, 26102, 26103
- **Input Features:**
