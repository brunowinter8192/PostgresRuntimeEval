...
**Test Query:** Q4_46_seed_369181395
...
```
Node 6481 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6482 (Gather Merge) [consumed]
    Node 6483 (Sort) [consumed]
      Node 6484 (Aggregate) [consumed]
        Node 6485 (Nested Loop)
          Node 6486 (Seq Scan) - LEAF
          Node 6487 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6481 | 6482, 6483, 6484 |
...
|------|------|--------|-----------|-----|--------|
| 6481 | Aggregate | 1047.20 | 952.19 | 9.1% | pattern |
| 6485 | Nested Loop | 1041.18 | 1255.45 | 20.6% | operator |
| 6486 | Seq Scan | 163.83 | 154.66 | 5.6% | operator |
| 6487 | Index Scan | 0.06 | 11.10 | 18103.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6486 (Seq Scan) - LEAF
...
### Step 2: Node 6487 (Index Scan) - LEAF
