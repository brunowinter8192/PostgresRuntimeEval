...
```
Node 27400 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27401 (Gather) [consumed]
    Node 27402 (Aggregate) [consumed]
      Node 27403 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27400 | 27401, 27402, 27403 |
...
|------|------|--------|-----------|-----|--------|
| 27400 | Aggregate | 849.52 | 857.15 | 0.9% | pattern |
...
### Step 4: Node 27400 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27401, 27402, 27403
- **Input Features:**
