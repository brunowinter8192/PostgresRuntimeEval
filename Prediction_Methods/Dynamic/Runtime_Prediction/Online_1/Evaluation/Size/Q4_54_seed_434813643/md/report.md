...
**Test Query:** Q4_54_seed_434813643
...
```
Node 6544 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6545 (Gather Merge) [consumed]
    Node 6546 (Sort) [consumed]
      Node 6547 (Aggregate) [consumed]
        Node 6548 (Nested Loop)
          Node 6549 (Seq Scan) - LEAF
          Node 6550 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6544 | 6545, 6546, 6547 |
...
|------|------|--------|-----------|-----|--------|
| 6544 | Aggregate | 1042.53 | 952.19 | 8.7% | pattern |
| 6548 | Nested Loop | 1036.09 | 1255.45 | 21.2% | operator |
| 6549 | Seq Scan | 161.13 | 154.66 | 4.0% | operator |
| 6550 | Index Scan | 0.06 | 11.10 | 18103.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6549 (Seq Scan) - LEAF
...
### Step 2: Node 6550 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - Sort_Outer_startup_cost=65983.7000
  - Sort_Outer_total_cost=65983.7100
