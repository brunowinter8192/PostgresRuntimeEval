...
```
Node 26259 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26260 (Aggregate) [consumed]
    Node 26261 (Aggregate)
      Node 26262 (Hash Join) [PATTERN: 895c6e8c]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26259 | 26260, 26262, 26263, 26264 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26262 | 26259, 26260, 26263, 26264 |
...
|------|------|--------|-----------|-----|--------|
| 26259 | Sort | 953.81 | 1079.93 | 13.2% | pattern |
| 26261 | Aggregate | 947.66 | 999.55 | 5.5% | operator |
| 26262 | Hash Join | 726.49 | 470.31 | 35.3% | pattern |
| 26265 | Index Only Scan | 9.91 | 0.00 | 100.0% | operator |
...
### Step 2: Node 26262 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26259, 26260, 26263, 26264
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1484970
...
### Step 4: Node 26259 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26260, 26262, 26263, 26264
- **Input Features:**
