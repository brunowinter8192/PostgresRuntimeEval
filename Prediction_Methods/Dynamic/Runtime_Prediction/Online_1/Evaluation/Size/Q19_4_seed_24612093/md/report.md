...
**Test Query:** Q19_4_seed_24612093
...
```
Node 31878 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31879 (Gather) [consumed]
    Node 31880 (Aggregate) [consumed]
      Node 31881 (Hash Join) [consumed]
        Node 31882 (Seq Scan) - LEAF
        Node 31883 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31878 | 31879, 31880, 31881 |
...
|------|------|--------|-----------|-----|--------|
| 31878 | Aggregate | 802.11 | 829.28 | 3.4% | pattern |
| 31882 | Seq Scan | 733.72 | 743.46 | 1.3% | operator |
| 31883 | Hash | 45.95 | 8.29 | 82.0% | operator |
| 31884 | Seq Scan | 45.82 | 23.76 | 48.1% | operator |
...
### Step 2: Node 31882 (Seq Scan) - LEAF
...
### Step 4: Node 31878 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31879, 31880, 31881
- **Input Features:**
