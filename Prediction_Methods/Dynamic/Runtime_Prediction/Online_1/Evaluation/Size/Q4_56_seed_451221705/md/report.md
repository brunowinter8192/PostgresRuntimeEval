...
**Test Query:** Q4_56_seed_451221705
...
```
Node 6558 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6559 (Gather Merge) [consumed]
    Node 6560 (Sort) [consumed]
      Node 6561 (Aggregate) [consumed]
        Node 6562 (Nested Loop)
          Node 6563 (Seq Scan) - LEAF
          Node 6564 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6558 | 6559, 6560, 6561 |
...
|------|------|--------|-----------|-----|--------|
| 6558 | Aggregate | 1072.20 | 952.19 | 11.2% | pattern |
| 6562 | Nested Loop | 1065.25 | 1255.45 | 17.9% | operator |
| 6563 | Seq Scan | 170.34 | 154.67 | 9.2% | operator |
| 6564 | Index Scan | 0.06 | 11.10 | 17250.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6563 (Seq Scan) - LEAF
...
### Step 2: Node 6564 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - Sort_Outer_startup_cost=65738.6000
  - Sort_Outer_total_cost=65738.6100
