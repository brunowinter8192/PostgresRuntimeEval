...
**Test Query:** Q18_37_seed_295345116
...
```
Node 30100 (Limit) - ROOT
  Node 30101 (Sort)
    Node 30102 (Aggregate)
      Node 30103 (Gather Merge)
        Node 30104 (Incremental Sort)
          Node 30105 (Nested Loop)
            Node 30106 (Merge Join)
              Node 30107 (Sort)
                Node 30108 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30109 (Seq Scan) [consumed] - LEAF
                  Node 30110 (Hash) [consumed]
                    Node 30111 (Aggregate)
                      Node 30112 (Index Scan) - LEAF
              Node 30113 (Sort)
                Node 30114 (Seq Scan) - LEAF
            Node 30115 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30108 | 30109, 30110 |
...
|------|------|--------|-----------|-----|--------|
| 30100 | Limit | 3064.74 | 1175.21 | 61.7% | operator |
| 30101 | Sort | 2948.06 | 1127.81 | 61.7% | operator |
| 30102 | Aggregate | 2948.01 | 1073.15 | 63.6% | operator |
| 30103 | Gather Merge | 2948.00 | 1073.95 | 63.6% | operator |
| 30104 | Incremental Sort | 2928.37 | 0.00 | 100.0% | operator |
| 30105 | Nested Loop | 2928.32 | 1111.34 | 62.0% | operator |
| 30106 | Merge Join | 2928.26 | 0.00 | 100.0% | operator |
| 30115 | Index Scan | 0.02 | 0.05 | 105.2% | operator |
| 30107 | Sort | 2858.14 | 1095.58 | 61.7% | operator |
| 30113 | Sort | 67.69 | 1074.66 | 1487.6% | operator |
| 30108 | Hash Join | 2858.13 | 471.07 | 83.5% | pattern |
| 30114 | Seq Scan | 53.19 | 18.25 | 65.7% | operator |
| 30111 | Aggregate | 2629.19 | 1073.15 | 59.2% | operator |
| 30112 | Index Scan | 2139.26 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30112 (Index Scan) - LEAF
...
### Step 3: Node 30108 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30109, 30110
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30114 (Seq Scan) - LEAF
...
### Step 7: Node 30106 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30115 (Index Scan) - LEAF
...
### Step 10: Node 30104 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30103 (Gather Merge)
