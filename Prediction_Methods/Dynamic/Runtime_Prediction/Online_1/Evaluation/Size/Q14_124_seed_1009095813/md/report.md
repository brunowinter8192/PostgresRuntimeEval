...
```
Node 26602 (Aggregate) [PATTERN: efde8b38] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26602 | 26603, 26604, 26605 |
...
|------|------|--------|-----------|-----|--------|
| 26602 | Aggregate | 841.29 | 857.14 | 1.9% | pattern |
| 26606 | Seq Scan | 765.60 | 758.50 | 0.9% | operator |
| 26607 | Hash | 43.79 | 9.38 | 78.6% | operator |
| 26608 | Seq Scan | 38.34 | 12.70 | 66.9% | operator |
...
### Step 4: Node 26602 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26603, 26604, 26605
- **Input Features:**
