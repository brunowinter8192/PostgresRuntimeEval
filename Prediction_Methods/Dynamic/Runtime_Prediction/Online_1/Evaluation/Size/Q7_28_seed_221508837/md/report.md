...
**Test Query:** Q7_28_seed_221508837
...
```
Node 11761 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 11762 (Gather Merge) [consumed]
    Node 11763 (Sort)
      Node 11764 (Hash Join)
        Node 11765 (Nested Loop)
          Node 11766 (Hash Join) [PATTERN: 895c6e8c]
            Node 11767 (Seq Scan) [consumed] - LEAF
            Node 11768 (Hash) [consumed]
              Node 11769 (Hash Join) [PATTERN: f4cb205a]
                Node 11770 (Seq Scan) [consumed] - LEAF
                Node 11771 (Hash) [consumed]
                  Node 11772 (Seq Scan) [consumed] - LEAF
          Node 11773 (Index Scan) - LEAF
        Node 11774 (Hash)
          Node 11775 (Hash Join) [PATTERN: f4cb205a]
            Node 11776 (Seq Scan) [consumed] - LEAF
            Node 11777 (Hash) [consumed]
              Node 11778 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 11769 | 11761, 11762, 11766, 11767, 11768, 11770, 11771, 11772, 11775, 11776, 11777, 11778 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 11775 | 11761, 11762, 11766, 11767, 11768, 11769, 11770, 11771, 11772, 11776, 11777, 11778 |
| Aggregate -> Gather Merge (Out | 2724c080 | 11761 | 11762, 11766, 11767, 11768, 11769, 11770, 11771, 11772, 11775, 11776, 11777, 11778 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 11766 | 11761, 11762, 11767, 11768, 11769, 11770, 11771, 11772, 11775, 11776, 11777, 11778 |
...
|------|------|--------|-----------|-----|--------|
| 11761 | Aggregate | 1206.47 | 1163.13 | 3.6% | pattern |
| 11763 | Sort | 1199.41 | 1109.16 | 7.5% | operator |
| 11764 | Hash Join | 1198.71 | 843.11 | 29.7% | operator |
| 11765 | Nested Loop | 1191.50 | 1215.99 | 2.1% | operator |
| 11774 | Hash | 3.46 | 27.74 | 701.6% | operator |
| 11766 | Hash Join | 214.62 | 304.89 | 42.1% | pattern |
| 11773 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 11775 | Hash Join | 3.42 | 429.36 | 12469.2% | pattern |
| 11769 | Hash Join | 37.09 | 429.38 | 1057.5% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11769 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 11761, 11762, 11766, 11767, 11768, 11770, 11771, 11772, 11775, 11776, 11777, 11778
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5000
  - HashJoin_nt1=62500
...
### Step 2: Node 11766 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 11761, 11762, 11767, 11768, 11769, 11770, 11771, 11772, 11775, 11776, 11777, 11778
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=38710
  - HashJoin_nt1=483871
...
### Step 3: Node 11773 (Index Scan) - LEAF
...
### Step 4: Node 11775 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 11761, 11762, 11766, 11767, 11768, 11769, 11770, 11771, 11772, 11776, 11777, 11778
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=800
  - HashJoin_nt1=10000
...
### Step 9: Node 11761 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 11762, 11766, 11767, 11768, 11769, 11770, 11771, 11772, 11775, 11776, 11777, 11778
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
