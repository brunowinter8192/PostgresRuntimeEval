...
**Test Query:** Q12_37_seed_295345116
...
```
Node 24880 (Aggregate) - ROOT
  Node 24881 (Gather Merge)
    Node 24882 (Aggregate)
      Node 24883 (Sort)
        Node 24884 (Nested Loop)
          Node 24885 (Seq Scan) - LEAF
          Node 24886 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24880 | Aggregate | 984.28 | 919.06 | 6.6% | operator |
| 24881 | Gather Merge | 984.24 | 1111.84 | 13.0% | operator |
| 24882 | Aggregate | 965.12 | 895.30 | 7.2% | operator |
| 24883 | Sort | 964.45 | 1092.82 | 13.3% | operator |
| 24884 | Nested Loop | 963.48 | 1127.41 | 17.0% | operator |
| 24885 | Seq Scan | 831.60 | 745.19 | 10.4% | operator |
| 24886 | Index Scan | 0.03 | 0.07 | 187.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24885 (Seq Scan) - LEAF
...
### Step 2: Node 24886 (Index Scan) - LEAF
...
### Step 6: Node 24881 (Gather Merge)
...
### Step 7: Node 24880 (Aggregate) - ROOT
