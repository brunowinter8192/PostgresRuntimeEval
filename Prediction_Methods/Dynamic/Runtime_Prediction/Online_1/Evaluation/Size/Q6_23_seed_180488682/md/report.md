...
**Test Query:** Q6_23_seed_180488682
...
```
Node 10161 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10162 (Gather) [consumed]
    Node 10163 (Aggregate) [consumed]
      Node 10164 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10161 | 10162, 10163 |
...
|------|------|--------|-----------|-----|--------|
| 10161 | Aggregate | 742.46 | 850.05 | 14.5% | pattern |
| 10164 | Seq Scan | 723.03 | 748.53 | 3.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10164 (Seq Scan) - LEAF
...
### Step 2: Node 10161 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10162, 10163
- **Input Features:**
