    ...
    Node 5353 (Aggregate) [consumed]
      Node 5354 (Gather) [consumed]
        Node 5355 (Nested Loop)
          Node 5356 (Hash Join) [PATTERN: 895c6e8c]
            Node 5357 (Seq Scan) [consumed] - LEAF
            Node 5358 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5351 | 5352, 5353, 5354, 5356, 5357, 5358 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5356 | 5351, 5352, 5353, 5354, 5357, 5358 |
...
| 5355 | Nested Loop | 1195.75 | 1193.11 | 0.2% | operator |
| 5356 | Hash Join | 210.04 | 242.49 | 15.5% | pattern |
...
### Step 2: Node 5356 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5351, 5352, 5353, 5354, 5357, 5358
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47011
  - HashJoin_nt1=233583
...
### Step 3: Node 5360 (Index Scan) - LEAF
...
### Step 5: Node 5351 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5352, 5353, 5354, 5356, 5357, 5358
- **Input Features:**
