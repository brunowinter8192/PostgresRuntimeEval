...
**Test Query:** Q13_144_seed_1173176433
...
```
Node 25706 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25707 (Aggregate) [consumed]
    Node 25708 (Aggregate)
      Node 25709 (Hash Join) [PATTERN: 895c6e8c]
        Node 25710 (Seq Scan) [consumed] - LEAF
        Node 25711 (Hash) [consumed]
          Node 25712 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25706 | 25707, 25709, 25710, 25711 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25709 | 25706, 25707, 25710, 25711 |
...
|------|------|--------|-----------|-----|--------|
| 25706 | Sort | 910.04 | 1079.94 | 18.7% | pattern |
| 25708 | Aggregate | 904.00 | 999.76 | 10.6% | operator |
| 25709 | Hash Join | 686.68 | 470.31 | 31.5% | pattern |
| 25712 | Index Only Scan | 9.85 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25712 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25709 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25706, 25707, 25710, 25711
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 25706 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25707, 25709, 25710, 25711
- **Input Features:**
