        ...
        Node 30456 (Incremental Sort)
          Node 30457 (Nested Loop)
            Node 30458 (Merge Join)
              Node 30459 (Sort)
                Node 30460 (Hash Join)
                  Node 30461 (Seq Scan) - LEAF
                  Node 30462 (Hash)
...
| 30459 | Sort | 2843.29 | 1099.77 | 61.3% | operator |
| 30465 | Sort | 64.67 | 1074.66 | 1561.7% | operator |
| 30460 | Hash Join | 2843.28 | 686.33 | 75.9% | operator |
| 30466 | Seq Scan | 52.70 | 18.25 | 65.4% | operator |
| 30461 | Seq Scan | 196.58 | 170.37 | 13.3% | operator |
| 30462 | Hash | 2616.70 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30461 (Seq Scan) - LEAF
...
### Step 6: Node 30466 (Seq Scan) - LEAF
...
### Step 9: Node 30458 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30467 (Index Scan) - LEAF
...
### Step 11: Node 30457 (Nested Loop)
...
### Step 12: Node 30456 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30455 (Gather Merge)
