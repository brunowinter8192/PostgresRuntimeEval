...
**Test Query:** Q18_57_seed_459425736
...
```
Node 30452 (Limit) - ROOT
  Node 30453 (Sort)
    Node 30454 (Aggregate)
      Node 30455 (Gather Merge)
        Node 30456 (Incremental Sort)
          Node 30457 (Nested Loop)
            Node 30458 (Merge Join)
              Node 30459 (Sort)
                Node 30460 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30461 (Seq Scan) [consumed] - LEAF
                  Node 30462 (Hash) [consumed]
                    Node 30463 (Aggregate)
                      Node 30464 (Index Scan) - LEAF
              Node 30465 (Sort)
                Node 30466 (Seq Scan) - LEAF
            Node 30467 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30460 | 30461, 30462 |
...
|------|------|--------|-----------|-----|--------|
| 30452 | Limit | 3045.58 | 1175.21 | 61.4% | operator |
| 30453 | Sort | 2931.92 | 1127.81 | 61.5% | operator |
| 30454 | Aggregate | 2931.88 | 1073.15 | 63.4% | operator |
| 30455 | Gather Merge | 2931.86 | 1073.95 | 63.4% | operator |
| 30456 | Incremental Sort | 2910.79 | 0.00 | 100.0% | operator |
| 30457 | Nested Loop | 2910.74 | 1111.34 | 61.8% | operator |
| 30458 | Merge Join | 2910.68 | 0.00 | 100.0% | operator |
| 30467 | Index Scan | 0.02 | 0.05 | 96.2% | operator |
| 30459 | Sort | 2843.29 | 1095.58 | 61.5% | operator |
| 30465 | Sort | 64.67 | 1074.66 | 1561.7% | operator |
| 30460 | Hash Join | 2843.28 | 471.07 | 83.4% | pattern |
| 30466 | Seq Scan | 52.70 | 18.25 | 65.4% | operator |
| 30463 | Aggregate | 2616.66 | 1073.15 | 59.0% | operator |
| 30464 | Index Scan | 2119.09 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30464 (Index Scan) - LEAF
...
### Step 3: Node 30460 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30461, 30462
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30466 (Seq Scan) - LEAF
...
### Step 7: Node 30458 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30467 (Index Scan) - LEAF
...
### Step 10: Node 30456 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30455 (Gather Merge)
