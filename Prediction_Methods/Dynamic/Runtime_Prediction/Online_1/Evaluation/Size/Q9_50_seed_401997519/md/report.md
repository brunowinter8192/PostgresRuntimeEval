...
**Test Query:** Q9_50_seed_401997519
...
```
Node 18372 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18373 (Aggregate) [consumed]
    Node 18374 (Gather)
      Node 18375 (Aggregate)
        Node 18376 (Nested Loop)
          Node 18377 (Hash Join) [PATTERN: bb930825]
            Node 18378 (Seq Scan) [consumed] - LEAF
            Node 18379 (Hash) [consumed]
              Node 18380 (Hash Join) [consumed]
                Node 18381 (Hash Join)
                  Node 18382 (Nested Loop)
                    Node 18383 (Seq Scan) - LEAF
                    Node 18384 (Index Scan) - LEAF
                  Node 18385 (Hash)
                    Node 18386 (Seq Scan) - LEAF
                Node 18387 (Hash)
                  Node 18388 (Seq Scan) - LEAF
          Node 18389 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18377 | 18372, 18373, 18378, 18379, 18380 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18372 | 18373, 18377, 18378, 18379, 18380 |
...
|------|------|--------|-----------|-----|--------|
| 18372 | Sort | 1197.71 | 1045.59 | 12.7% | pattern |
| 18374 | Gather | 1196.63 | 964.55 | 19.4% | operator |
| 18375 | Aggregate | 1177.25 | 1085.45 | 7.8% | operator |
| 18376 | Nested Loop | 1152.44 | 1252.17 | 8.7% | operator |
| 18377 | Hash Join | 978.86 | 134.80 | 86.2% | pattern |
| 18389 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18381 | Hash Join | 168.69 | 837.63 | 396.5% | operator |
| 18387 | Hash | 13.79 | 14.95 | 8.4% | operator |
| 18382 | Nested Loop | 163.11 | 1251.77 | 667.4% | operator |
| 18385 | Hash | 3.61 | 15.94 | 342.1% | operator |
| 18388 | Seq Scan | 13.77 | 2.94 | 78.7% | operator |
| 18383 | Seq Scan | 21.22 | 43.96 | 107.2% | operator |
| 18384 | Index Scan | 0.08 | -1.39 | 1880.1% | operator |
| 18386 | Seq Scan | 3.16 | 9.45 | 199.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 18383 (Seq Scan) - LEAF
...
### Step 2: Node 18384 (Index Scan) - LEAF
...
### Step 3: Node 18386 (Seq Scan) - LEAF
...
### Step 6: Node 18388 (Seq Scan) - LEAF
...
### Step 9: Node 18377 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18372, 18373, 18378, 18379, 18380
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18389 (Index Scan) - LEAF
...
### Step 11: Node 18376 (Nested Loop)
...
### Step 14: Node 18372 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18373, 18377, 18378, 18379, 18380
- **Input Features:**
