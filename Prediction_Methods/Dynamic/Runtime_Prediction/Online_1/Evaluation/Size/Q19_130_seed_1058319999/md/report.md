...
**Test Query:** Q19_130_seed_1058319999
**Timestamp:** 2026-01-18 20:29:17
...
```
Node 31451 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31452 (Gather) [consumed]
    Node 31453 (Aggregate) [consumed]
      Node 31454 (Hash Join) [consumed]
        Node 31455 (Seq Scan) - LEAF
        Node 31456 (Hash)
          Node 31457 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31451 | 31452, 31453, 31454 |
...
|------|------|--------|-----------|-----|--------|
| 31451 | Aggregate | 806.11 | 829.30 | 2.9% | pattern |
| 31455 | Seq Scan | 741.43 | 743.46 | 0.3% | operator |
| 31456 | Hash | 44.30 | 8.29 | 81.3% | operator |
| 31457 | Seq Scan | 44.19 | 23.76 | 46.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31457 (Seq Scan) - LEAF
...
### Step 2: Node 31455 (Seq Scan) - LEAF
...
### Step 4: Node 31451 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31452, 31453, 31454
- **Input Features:**
  ...
  - Aggregate_Outer_startup_cost=156338.7100
  - Aggregate_Outer_total_cost=156338.7200
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=157339.2500
  - Aggregate_total_cost=157339.2600
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=157338.7100
  - Gather_Outer_total_cost=157339.2200
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=23
  - HashJoin_Outer_nt1=22497
  ...
  - HashJoin_Outer_total_cost=156338.5400
