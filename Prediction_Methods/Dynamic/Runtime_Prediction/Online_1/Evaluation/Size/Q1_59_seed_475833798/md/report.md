...
Node 521 (Aggregate) - ROOT
  Node 522 (Gather Merge)
    Node 523 (Sort) [PATTERN: 1d35fb97]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 523 | 524 |
...
|------|------|--------|-----------|-----|--------|
| 521 | Aggregate | 926.45 | 1195.96 | 29.1% | operator |
| 522 | Gather Merge | 926.41 | 1165.93 | 25.9% | operator |
| 523 | Sort | 910.56 | 1200.77 | 31.9% | pattern |
...
### Step 2: Node 523 (Sort) - PATTERN ROOT
...
### Step 4: Node 521 (Aggregate) - ROOT
