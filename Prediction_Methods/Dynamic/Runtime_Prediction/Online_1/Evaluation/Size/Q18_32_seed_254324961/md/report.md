...
**Test Query:** Q18_32_seed_254324961
...
```
Node 30020 (Limit) - ROOT
  Node 30021 (Sort)
    Node 30022 (Aggregate)
      Node 30023 (Gather Merge)
        Node 30024 (Incremental Sort)
          Node 30025 (Nested Loop)
            Node 30026 (Merge Join)
              Node 30027 (Sort)
                Node 30028 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30029 (Seq Scan) [consumed] - LEAF
                  Node 30030 (Hash) [consumed]
                    Node 30031 (Aggregate)
                      Node 30032 (Index Scan) - LEAF
              Node 30033 (Sort)
                Node 30034 (Seq Scan) - LEAF
            Node 30035 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30028 | 30029, 30030 |
...
|------|------|--------|-----------|-----|--------|
| 30020 | Limit | 3053.43 | 1175.21 | 61.5% | operator |
| 30021 | Sort | 2932.93 | 1127.81 | 61.5% | operator |
| 30022 | Aggregate | 2932.88 | 1073.15 | 63.4% | operator |
| 30023 | Gather Merge | 2932.87 | 1073.95 | 63.4% | operator |
| 30024 | Incremental Sort | 2897.32 | 0.00 | 100.0% | operator |
| 30025 | Nested Loop | 2897.27 | 1111.34 | 61.6% | operator |
| 30026 | Merge Join | 2897.22 | 0.00 | 100.0% | operator |
| 30035 | Index Scan | 0.02 | 0.05 | 150.8% | operator |
| 30027 | Sort | 2845.51 | 1095.58 | 61.5% | operator |
| 30033 | Sort | 66.18 | 1074.66 | 1523.9% | operator |
| 30028 | Hash Join | 2845.49 | 471.07 | 83.4% | pattern |
| 30034 | Seq Scan | 54.54 | 18.25 | 66.5% | operator |
| 30031 | Aggregate | 2622.50 | 1073.15 | 59.1% | operator |
| 30032 | Index Scan | 2129.40 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30032 (Index Scan) - LEAF
...
### Step 3: Node 30028 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30029, 30030
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30034 (Seq Scan) - LEAF
...
### Step 7: Node 30026 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30035 (Index Scan) - LEAF
...
### Step 10: Node 30024 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30023 (Gather Merge)
