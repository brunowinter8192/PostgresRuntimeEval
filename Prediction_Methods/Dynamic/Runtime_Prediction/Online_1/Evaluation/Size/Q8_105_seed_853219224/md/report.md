...
```
Node 13316 (Aggregate) - ROOT
  Node 13317 (Gather Merge)
    Node 13318 (Sort)
          ...
          Node 13321 (Hash Join)
            Node 13322 (Nested Loop)
              Node 13323 (Hash Join)
                ...
                Node 13325 (Hash)
                  Node 13326 (Hash Join)
                    Node 13327 (Seq Scan) - LEAF
                    Node 13328 (Hash)
                      Node 13329 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 13316 | Aggregate | 1239.36 | 1194.14 | 3.6% | operator |
| 13317 | Gather Merge | 1238.99 | 1097.16 | 11.4% | operator |
...
| 13323 | Hash Join | 214.19 | 251.17 | 17.3% | operator |
...
| 13325 | Hash | 36.79 | 20.62 | 44.0% | operator |
| 13326 | Hash Join | 36.20 | 132.26 | 265.4% | operator |
| 13327 | Seq Scan | 34.68 | 23.03 | 33.6% | operator |
| 13328 | Hash | 0.18 | 23.66 | 13190.0% | operator |
| 13329 | Hash Join | 0.17 | 306.84 | 175234.8% | operator |
...
### Step 5: Node 13327 (Seq Scan) - LEAF
...
### Step 8: Node 13324 (Seq Scan) - LEAF
...
### Step 11: Node 13333 (Index Scan) - LEAF
...
### Step 12: Node 13335 (Seq Scan) - LEAF
...
### Step 13: Node 13322 (Nested Loop)
...
### Step 16: Node 13336 (Index Scan) - LEAF
...
### Step 17: Node 13338 (Seq Scan) - LEAF
...
### Step 18: Node 13320 (Nested Loop)
...
### Step 22: Node 13317 (Gather Merge)
...
### Step 23: Node 13316 (Aggregate) - ROOT
