...
**Test Query:** Q1_75_seed_607098294
...
```
Node 611 (Aggregate) - ROOT
  Node 612 (Gather Merge)
    Node 613 (Sort) [PATTERN: 1d35fb97]
      Node 614 (Aggregate) [consumed]
        Node 615 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 613 | 614 |
...
|------|------|--------|-----------|-----|--------|
| 611 | Aggregate | 941.77 | 1195.80 | 27.0% | operator |
| 612 | Gather Merge | 941.73 | 1165.88 | 23.8% | operator |
| 613 | Sort | 923.28 | 1200.18 | 30.0% | pattern |
| 615 | Seq Scan | 513.44 | 681.48 | 32.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 615 (Seq Scan) - LEAF
...
### Step 2: Node 613 (Sort) - PATTERN ROOT
...
### Step 4: Node 611 (Aggregate) - ROOT
