...
**Test Query:** Q12_44_seed_352773333
...
```
Node 24936 (Aggregate) - ROOT
  Node 24937 (Gather Merge)
    Node 24938 (Aggregate)
      Node 24939 (Sort)
        Node 24940 (Nested Loop)
          Node 24941 (Seq Scan) - LEAF
          Node 24942 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24936 | Aggregate | 986.81 | 919.08 | 6.9% | operator |
| 24937 | Gather Merge | 986.79 | 1111.84 | 12.7% | operator |
| 24938 | Aggregate | 967.46 | 895.33 | 7.5% | operator |
| 24939 | Sort | 966.83 | 1092.80 | 13.0% | operator |
| 24940 | Nested Loop | 965.87 | 1127.41 | 16.7% | operator |
| 24941 | Seq Scan | 826.24 | 745.19 | 9.8% | operator |
| 24942 | Index Scan | 0.03 | 0.07 | 166.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24941 (Seq Scan) - LEAF
...
### Step 2: Node 24942 (Index Scan) - LEAF
...
### Step 6: Node 24937 (Gather Merge)
...
### Step 7: Node 24936 (Aggregate) - ROOT
