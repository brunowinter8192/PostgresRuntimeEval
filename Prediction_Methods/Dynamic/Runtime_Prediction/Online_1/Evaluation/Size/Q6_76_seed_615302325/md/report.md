...
**Test Query:** Q6_76_seed_615302325
...
```
Node 10393 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10394 (Gather) [consumed]
    Node 10395 (Aggregate) [consumed]
      Node 10396 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10393 | 10394, 10395 |
...
|------|------|--------|-----------|-----|--------|
| 10393 | Aggregate | 825.77 | 850.06 | 2.9% | pattern |
| 10396 | Seq Scan | 805.44 | 748.54 | 7.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10396 (Seq Scan) - LEAF
...
### Step 2: Node 10393 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10394, 10395
- **Input Features:**
