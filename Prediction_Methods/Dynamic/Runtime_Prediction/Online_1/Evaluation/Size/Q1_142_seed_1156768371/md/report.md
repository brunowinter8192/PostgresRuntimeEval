...
Node 231 (Aggregate) - ROOT
  Node 232 (Gather Merge)
    Node 233 (Sort) [PATTERN: 1d35fb97]
      Node 234 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 233 | 234 |
...
|------|------|--------|-----------|-----|--------|
| 231 | Aggregate | 999.33 | 1195.75 | 19.7% | operator |
| 232 | Gather Merge | 999.25 | 1165.87 | 16.7% | operator |
| 233 | Sort | 979.95 | 1199.99 | 22.5% | pattern |
...
### Step 2: Node 233 (Sort) - PATTERN ROOT
...
### Step 4: Node 231 (Aggregate) - ROOT
