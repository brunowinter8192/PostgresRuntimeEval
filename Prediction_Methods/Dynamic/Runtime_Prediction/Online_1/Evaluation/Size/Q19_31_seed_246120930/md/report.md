...
**Test Query:** Q19_31_seed_246120930
...
```
Node 31738 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31739 (Gather) [consumed]
    Node 31740 (Aggregate) [consumed]
      Node 31741 (Hash Join)
        Node 31742 (Seq Scan) - LEAF
        Node 31743 (Hash)
          Node 31744 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31738 | 31739, 31740 |
...
|------|------|--------|-----------|-----|--------|
| 31738 | Aggregate | 871.35 | 831.20 | 4.6% | pattern |
| 31741 | Hash Join | 850.89 | 766.05 | 10.0% | operator |
| 31742 | Seq Scan | 800.75 | 743.46 | 7.2% | operator |
| 31743 | Hash | 47.57 | 8.29 | 82.6% | operator |
| 31744 | Seq Scan | 47.44 | 23.76 | 49.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31744 (Seq Scan) - LEAF
...
### Step 2: Node 31742 (Seq Scan) - LEAF
...
### Step 5: Node 31738 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31739, 31740
- **Input Features:**
