...
```
Node 31738 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31739 (Gather) [consumed]
    Node 31740 (Aggregate) [consumed]
      Node 31741 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31738 | 31739, 31740, 31741 |
...
|------|------|--------|-----------|-----|--------|
| 31738 | Aggregate | 871.35 | 829.29 | 4.8% | pattern |
...
### Step 4: Node 31738 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31739, 31740, 31741
- **Input Features:**
