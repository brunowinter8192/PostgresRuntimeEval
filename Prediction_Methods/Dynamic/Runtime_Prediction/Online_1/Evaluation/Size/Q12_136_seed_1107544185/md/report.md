...
**Test Query:** Q12_136_seed_1107544185
...
```
Node 24593 (Aggregate) - ROOT
  Node 24594 (Gather Merge)
    Node 24595 (Aggregate)
      Node 24596 (Sort)
        Node 24597 (Nested Loop)
          Node 24598 (Seq Scan) - LEAF
          Node 24599 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24593 | Aggregate | 985.87 | 919.08 | 6.8% | operator |
| 24594 | Gather Merge | 985.84 | 1111.84 | 12.8% | operator |
| 24595 | Aggregate | 964.70 | 895.32 | 7.2% | operator |
| 24596 | Sort | 964.12 | 1092.80 | 13.3% | operator |
| 24597 | Nested Loop | 963.15 | 1127.41 | 17.1% | operator |
| 24598 | Seq Scan | 821.48 | 745.19 | 9.3% | operator |
| 24599 | Index Scan | 0.03 | 0.07 | 166.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24598 (Seq Scan) - LEAF
...
### Step 2: Node 24599 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - st2=0.1246
  - startup_cost=0.4300
  - total_cost=147140.3900
- **Output:** st=38.33, rt=1127.41

### Step 4: Node 24596 (Sort)
...
- **Input Features:**
  ...
  - st1=38.3290
  - st2=0.0000
  - startup_cost=147498.6900
  - total_cost=147513.0400
- **Output:** st=1092.39, rt=1092.80

### Step 5: Node 24595 (Aggregate)
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=147498.6900
  - total_cost=147613.5400
- **Output:** st=868.98, rt=895.32

### Step 6: Node 24594 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=868.9803
  - st2=0.0000
  - startup_cost=148498.7700
  - total_cost=148617.8300
- **Output:** st=1109.22, rt=1111.84

### Step 7: Node 24593 (Aggregate) - ROOT
