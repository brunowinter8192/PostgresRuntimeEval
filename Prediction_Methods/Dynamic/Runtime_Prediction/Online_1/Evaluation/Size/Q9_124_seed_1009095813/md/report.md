...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17127 | 17122, 17123, 17128, 17129, 17130 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17122 | 17123, 17127, 17128, 17129, 17130 |
...
|------|------|--------|-----------|-----|--------|
| 17122 | Sort | 1195.21 | 1046.01 | 12.5% | pattern |
| 17124 | Gather | 1193.72 | 955.76 | 19.9% | operator |
| 17125 | Aggregate | 1175.52 | 1141.46 | 2.9% | operator |
| 17126 | Nested Loop | 1151.20 | 1252.17 | 8.8% | operator |
| 17127 | Hash Join | 979.04 | 134.80 | 86.2% | pattern |
| 17139 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17131 | Hash Join | 160.34 | 837.43 | 422.3% | operator |
| 17137 | Hash | 13.16 | 14.95 | 13.6% | operator |
| 17132 | Nested Loop | 152.84 | 1251.76 | 719.0% | operator |
| 17135 | Hash | 5.26 | 15.94 | 202.8% | operator |
| 17138 | Seq Scan | 13.15 | 2.94 | 77.7% | operator |
| 17133 | Seq Scan | 19.92 | 44.44 | 123.1% | operator |
| 17134 | Index Scan | 0.07 | -1.39 | 2002.0% | operator |
| 17136 | Seq Scan | 4.75 | 9.45 | 98.7% | operator |
...
### Step 6: Node 17138 (Seq Scan) - LEAF
...
### Step 9: Node 17127 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17122, 17123, 17128, 17129, 17130
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 11: Node 17126 (Nested Loop)
...
### Step 14: Node 17122 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17123, 17127, 17128, 17129, 17130
- **Input Features:**
