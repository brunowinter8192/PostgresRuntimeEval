...
```
Node 26294 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26295 (Aggregate) [consumed]
    Node 26296 (Aggregate)
      Node 26297 (Hash Join) [PATTERN: 895c6e8c]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26294 | 26295, 26297, 26298, 26299 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26297 | 26294, 26295, 26298, 26299 |
...
|------|------|--------|-----------|-----|--------|
| 26294 | Sort | 898.86 | 1079.91 | 20.1% | pattern |
| 26296 | Aggregate | 892.79 | 998.54 | 11.8% | operator |
| 26297 | Hash Join | 683.34 | 470.31 | 31.2% | pattern |
...
### Step 2: Node 26297 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26294, 26295, 26298, 26299
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1469940
...
### Step 4: Node 26294 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26295, 26297, 26298, 26299
- **Input Features:**
