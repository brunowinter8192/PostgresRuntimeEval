...
**Test Query:** Q18_9_seed_65632248
...
```
Node 31204 (Limit) - ROOT
  Node 31205 (Sort)
    Node 31206 (Aggregate)
      Node 31207 (Gather Merge)
        Node 31208 (Incremental Sort)
          Node 31209 (Nested Loop)
            Node 31210 (Merge Join)
              Node 31211 (Sort)
                Node 31212 (Hash Join) [PATTERN: 895c6e8c]
                  Node 31213 (Seq Scan) [consumed] - LEAF
                  Node 31214 (Hash) [consumed]
                    Node 31215 (Aggregate)
                      Node 31216 (Index Scan) - LEAF
              Node 31217 (Sort)
                Node 31218 (Seq Scan) - LEAF
            Node 31219 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 31212 | 31213, 31214 |
...
|------|------|--------|-----------|-----|--------|
| 31204 | Limit | 3049.78 | 1175.21 | 61.5% | operator |
| 31205 | Sort | 2934.08 | 1127.81 | 61.6% | operator |
| 31206 | Aggregate | 2934.04 | 1073.15 | 63.4% | operator |
| 31207 | Gather Merge | 2934.02 | 1073.95 | 63.4% | operator |
| 31208 | Incremental Sort | 2914.39 | 0.00 | 100.0% | operator |
| 31209 | Nested Loop | 2914.34 | 1111.34 | 61.9% | operator |
| 31210 | Merge Join | 2914.27 | 0.00 | 100.0% | operator |
| 31219 | Index Scan | 0.02 | 0.05 | 105.2% | operator |
| 31211 | Sort | 2843.98 | 1095.58 | 61.5% | operator |
| 31217 | Sort | 67.38 | 1074.66 | 1494.9% | operator |
| 31212 | Hash Join | 2843.97 | 471.07 | 83.4% | pattern |
| 31218 | Seq Scan | 54.51 | 18.25 | 66.5% | operator |
| 31215 | Aggregate | 2619.28 | 1073.15 | 59.0% | operator |
| 31216 | Index Scan | 2125.12 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31216 (Index Scan) - LEAF
...
### Step 3: Node 31212 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 31213, 31214
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 31218 (Seq Scan) - LEAF
...
### Step 7: Node 31210 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 31219 (Index Scan) - LEAF
...
### Step 10: Node 31208 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 31207 (Gather Merge)
