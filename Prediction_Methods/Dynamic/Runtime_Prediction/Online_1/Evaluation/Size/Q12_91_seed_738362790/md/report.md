...
**Test Query:** Q12_91_seed_738362790
...
```
Node 25300 (Aggregate) - ROOT
  Node 25301 (Gather Merge)
    Node 25302 (Aggregate)
      Node 25303 (Sort)
        Node 25304 (Nested Loop)
          Node 25305 (Seq Scan) - LEAF
          Node 25306 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 25300 | Aggregate | 990.57 | 919.08 | 7.2% | operator |
| 25301 | Gather Merge | 990.55 | 1111.84 | 12.2% | operator |
| 25302 | Aggregate | 969.12 | 895.32 | 7.6% | operator |
| 25303 | Sort | 968.55 | 1092.80 | 12.8% | operator |
| 25304 | Nested Loop | 967.63 | 1127.41 | 16.5% | operator |
| 25305 | Seq Scan | 833.47 | 745.19 | 10.6% | operator |
| 25306 | Index Scan | 0.03 | 0.07 | 187.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25305 (Seq Scan) - LEAF
...
### Step 2: Node 25306 (Index Scan) - LEAF
...
### Step 6: Node 25301 (Gather Merge)
...
### Step 7: Node 25300 (Aggregate) - ROOT
