        ...
        Node 30328 (Incremental Sort)
          Node 30329 (Nested Loop)
            Node 30330 (Merge Join)
              Node 30331 (Sort)
                Node 30332 (Hash Join)
                  Node 30333 (Seq Scan) - LEAF
                  Node 30334 (Hash)
...
| 30331 | Sort | 2834.33 | 1099.77 | 61.2% | operator |
| 30337 | Sort | 67.08 | 1074.66 | 1502.1% | operator |
| 30332 | Hash Join | 2834.32 | 686.33 | 75.8% | operator |
| 30338 | Seq Scan | 54.50 | 18.25 | 66.5% | operator |
| 30333 | Seq Scan | 191.74 | 170.37 | 11.1% | operator |
| 30334 | Hash | 2614.07 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30333 (Seq Scan) - LEAF
...
### Step 6: Node 30338 (Seq Scan) - LEAF
...
### Step 9: Node 30330 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30339 (Index Scan) - LEAF
...
### Step 11: Node 30329 (Nested Loop)
...
### Step 12: Node 30328 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30327 (Gather Merge)
