...
**Test Query:** Q18_4_seed_24612093
...
```
Node 30324 (Limit) - ROOT
  Node 30325 (Sort)
    Node 30326 (Aggregate)
      Node 30327 (Gather Merge)
        Node 30328 (Incremental Sort)
          Node 30329 (Nested Loop)
            Node 30330 (Merge Join)
              Node 30331 (Sort)
                Node 30332 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30333 (Seq Scan) [consumed] - LEAF
                  Node 30334 (Hash) [consumed]
                    Node 30335 (Aggregate)
                      Node 30336 (Index Scan) - LEAF
              Node 30337 (Sort)
                Node 30338 (Seq Scan) - LEAF
            Node 30339 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30332 | 30333, 30334 |
...
|------|------|--------|-----------|-----|--------|
| 30324 | Limit | 3041.23 | 1175.21 | 61.4% | operator |
| 30325 | Sort | 2925.82 | 1127.81 | 61.5% | operator |
| 30326 | Aggregate | 2925.78 | 1073.15 | 63.3% | operator |
| 30327 | Gather Merge | 2925.76 | 1073.95 | 63.3% | operator |
| 30328 | Incremental Sort | 2904.15 | 0.00 | 100.0% | operator |
| 30329 | Nested Loop | 2904.09 | 1111.34 | 61.7% | operator |
| 30330 | Merge Join | 2904.03 | 0.00 | 100.0% | operator |
| 30339 | Index Scan | 0.02 | 0.05 | 105.2% | operator |
| 30331 | Sort | 2834.33 | 1095.58 | 61.3% | operator |
| 30337 | Sort | 67.08 | 1074.66 | 1502.1% | operator |
| 30332 | Hash Join | 2834.32 | 471.07 | 83.4% | pattern |
| 30338 | Seq Scan | 54.50 | 18.25 | 66.5% | operator |
| 30335 | Aggregate | 2614.02 | 1073.15 | 58.9% | operator |
| 30336 | Index Scan | 2127.90 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30336 (Index Scan) - LEAF
...
### Step 3: Node 30332 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30333, 30334
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30338 (Seq Scan) - LEAF
...
### Step 7: Node 30330 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30339 (Index Scan) - LEAF
...
### Step 10: Node 30328 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30327 (Gather Merge)
