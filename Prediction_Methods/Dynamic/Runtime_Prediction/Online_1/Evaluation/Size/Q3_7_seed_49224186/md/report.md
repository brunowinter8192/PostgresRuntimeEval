    ...
    Node 5623 (Aggregate) [consumed]
      Node 5624 (Gather) [consumed]
        Node 5625 (Nested Loop)
          Node 5626 (Hash Join) [PATTERN: 895c6e8c]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5621 | 5622, 5623, 5624, 5626, 5627, 5628 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5626 | 5621, 5622, 5623, 5624, 5627, 5628 |
...
|------|------|--------|-----------|-----|--------|
| 5621 | Limit | 1202.66 | 1151.18 | 4.3% | pattern |
| 5625 | Nested Loop | 1164.81 | 1193.10 | 2.4% | operator |
| 5626 | Hash Join | 207.74 | 242.49 | 16.7% | pattern |
| 5630 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5629 | Seq Scan | 29.93 | 38.57 | 28.8% | operator |
...
### Step 2: Node 5626 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5621, 5622, 5623, 5624, 5627, 5628
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46998
  - HashJoin_nt1=235242
...
### Step 3: Node 5630 (Index Scan) - LEAF
...
### Step 5: Node 5621 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5622, 5623, 5624, 5626, 5627, 5628
- **Input Features:**
