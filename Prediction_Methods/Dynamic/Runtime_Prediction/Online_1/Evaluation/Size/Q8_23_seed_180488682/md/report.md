...
```
Node 14696 (Aggregate) - ROOT
  Node 14697 (Gather Merge)
    Node 14698 (Sort)
          ...
          Node 14701 (Hash Join)
            Node 14702 (Nested Loop)
              Node 14703 (Hash Join)
                ...
                Node 14705 (Hash)
                  Node 14706 (Hash Join)
                    Node 14707 (Seq Scan) - LEAF
                    Node 14708 (Hash)
                      Node 14709 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 14696 | Aggregate | 1208.48 | 1190.97 | 1.4% | operator |
| 14697 | Gather Merge | 1208.12 | 1097.16 | 9.2% | operator |
...
| 14703 | Hash Join | 213.68 | 251.17 | 17.5% | operator |
...
| 14705 | Hash | 37.74 | 20.62 | 45.4% | operator |
| 14706 | Hash Join | 37.10 | 132.26 | 256.5% | operator |
| 14707 | Seq Scan | 35.37 | 23.03 | 34.9% | operator |
| 14708 | Hash | 0.38 | 23.66 | 6158.2% | operator |
| 14709 | Hash Join | 0.38 | 306.84 | 81722.9% | operator |
...
### Step 5: Node 14707 (Seq Scan) - LEAF
...
### Step 8: Node 14704 (Seq Scan) - LEAF
...
### Step 11: Node 14713 (Index Scan) - LEAF
...
### Step 12: Node 14715 (Seq Scan) - LEAF
...
### Step 13: Node 14702 (Nested Loop)
...
### Step 16: Node 14716 (Index Scan) - LEAF
...
### Step 17: Node 14718 (Seq Scan) - LEAF
...
### Step 18: Node 14700 (Nested Loop)
...
### Step 22: Node 14697 (Gather Merge)
...
- **Input Features:**
  ...
  - total_cost=71846.5900
- **Output:** st=1093.46, rt=1097.16

### Step 23: Node 14696 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=71555.8000
  - total_cost=71943.8700
- **Output:** st=1162.01, rt=1190.97
