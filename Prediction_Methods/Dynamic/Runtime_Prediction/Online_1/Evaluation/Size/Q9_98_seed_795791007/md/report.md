...
```
Node 19316 (Sort) - ROOT
  Node 19317 (Aggregate)
    Node 19318 (Gather)
      Node 19319 (Aggregate)
        Node 19320 (Nested Loop)
          Node 19321 (Hash Join)
            Node 19322 (Seq Scan) - LEAF
            Node 19323 (Hash)
              Node 19324 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 19316 | Sort | 1209.26 | 1119.81 | 7.4% | operator |
| 19317 | Aggregate | 1209.11 | 897.74 | 25.8% | operator |
...
| 19321 | Hash Join | 985.57 | 633.50 | 35.7% | operator |
| 19333 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 19322 | Seq Scan | 713.03 | 509.93 | 28.5% | operator |
| 19323 | Hash | 177.98 | 48.03 | 73.0% | operator |
| 19324 | Hash Join | 176.12 | 924.48 | 424.9% | operator |
...
### Step 10: Node 19322 (Seq Scan) - LEAF
...
### Step 13: Node 19333 (Index Scan) - LEAF
...
### Step 14: Node 19320 (Nested Loop)
