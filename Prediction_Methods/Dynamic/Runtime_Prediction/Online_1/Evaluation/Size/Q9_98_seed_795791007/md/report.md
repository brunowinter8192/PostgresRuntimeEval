...
**Test Query:** Q9_98_seed_795791007
...
```
Node 19316 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 19317 (Aggregate) [consumed]
    Node 19318 (Gather)
      Node 19319 (Aggregate)
        Node 19320 (Nested Loop)
          Node 19321 (Hash Join) [PATTERN: bb930825]
            Node 19322 (Seq Scan) [consumed] - LEAF
            Node 19323 (Hash) [consumed]
              Node 19324 (Hash Join) [consumed]
                Node 19325 (Hash Join)
                  Node 19326 (Nested Loop)
                    Node 19327 (Seq Scan) - LEAF
                    Node 19328 (Index Scan) - LEAF
                  Node 19329 (Hash)
                    Node 19330 (Seq Scan) - LEAF
                Node 19331 (Hash)
                  Node 19332 (Seq Scan) - LEAF
          Node 19333 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 19321 | 19316, 19317, 19322, 19323, 19324 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 19316 | 19317, 19321, 19322, 19323, 19324 |
...
|------|------|--------|-----------|-----|--------|
| 19316 | Sort | 1209.26 | 1045.59 | 13.5% | pattern |
| 19318 | Gather | 1208.03 | 964.55 | 20.2% | operator |
| 19319 | Aggregate | 1187.68 | 1085.45 | 8.6% | operator |
| 19320 | Nested Loop | 1162.88 | 1252.17 | 7.7% | operator |
| 19321 | Hash Join | 985.57 | 134.80 | 86.3% | pattern |
| 19333 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 19325 | Hash Join | 161.62 | 837.63 | 418.3% | operator |
| 19331 | Hash | 13.87 | 14.95 | 7.8% | operator |
| 19326 | Nested Loop | 155.35 | 1251.77 | 705.8% | operator |
| 19329 | Hash | 3.94 | 15.94 | 304.2% | operator |
| 19332 | Seq Scan | 13.85 | 2.94 | 78.8% | operator |
| 19327 | Seq Scan | 19.70 | 43.96 | 123.2% | operator |
| 19328 | Index Scan | 0.07 | -1.39 | 1951.3% | operator |
| 19330 | Seq Scan | 3.50 | 9.45 | 169.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 19327 (Seq Scan) - LEAF
...
### Step 2: Node 19328 (Index Scan) - LEAF
...
### Step 3: Node 19330 (Seq Scan) - LEAF
...
### Step 6: Node 19332 (Seq Scan) - LEAF
...
### Step 9: Node 19321 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 19316, 19317, 19322, 19323, 19324
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 19333 (Index Scan) - LEAF
...
### Step 11: Node 19320 (Nested Loop)
...
### Step 14: Node 19316 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 19317, 19321, 19322, 19323, 19324
- **Input Features:**
