    ...
    Node 5763 (Aggregate) [consumed]
      Node 5764 (Gather) [consumed]
        Node 5765 (Nested Loop)
          Node 5766 (Hash Join) [PATTERN: 895c6e8c]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5761 | 5762, 5763, 5764, 5766, 5767, 5768 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5766 | 5761, 5762, 5763, 5764, 5767, 5768 |
...
|------|------|--------|-----------|-----|--------|
| 5761 | Limit | 1197.21 | 1151.18 | 3.8% | pattern |
| 5765 | Nested Loop | 1159.52 | 1193.22 | 2.9% | operator |
| 5766 | Hash Join | 213.40 | 242.51 | 13.6% | pattern |
| 5770 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5769 | Seq Scan | 31.55 | 38.57 | 22.3% | operator |
...
### Step 2: Node 5766 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5761, 5762, 5763, 5764, 5767, 5768
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47176
  - HashJoin_nt1=236285
...
### Step 3: Node 5770 (Index Scan) - LEAF
...
### Step 5: Node 5761 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5762, 5763, 5764, 5766, 5767, 5768
- **Input Features:**
