...
**Test Query:** Q19_13_seed_98448372
...
```
Node 31521 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31522 (Gather) [consumed]
    Node 31523 (Aggregate) [consumed]
      Node 31524 (Hash Join) [consumed]
        Node 31525 (Seq Scan) - LEAF
        Node 31526 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31521 | 31522, 31523, 31524 |
...
|------|------|--------|-----------|-----|--------|
| 31521 | Aggregate | 832.20 | 829.30 | 0.3% | pattern |
| 31525 | Seq Scan | 766.44 | 743.46 | 3.0% | operator |
| 31526 | Hash | 46.20 | 8.29 | 82.1% | operator |
| 31527 | Seq Scan | 46.02 | 23.76 | 48.4% | operator |
...
### Step 2: Node 31525 (Seq Scan) - LEAF
...
### Step 4: Node 31521 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31522, 31523, 31524
- **Input Features:**
