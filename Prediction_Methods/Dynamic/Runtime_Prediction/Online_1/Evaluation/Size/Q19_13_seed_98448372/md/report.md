...
```
Node 31521 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31522 (Gather) [consumed]
    Node 31523 (Aggregate) [consumed]
      Node 31524 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31521 | 31522, 31523 |
...
|------|------|--------|-----------|-----|--------|
| 31521 | Aggregate | 832.20 | 831.20 | 0.1% | pattern |
| 31524 | Hash Join | 814.62 | 766.06 | 6.0% | operator |
...
### Step 5: Node 31521 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31522, 31523
- **Input Features:**
