...
```
Node 11941 (Aggregate) - ROOT
  Node 11942 (Gather Merge)
    Node 11943 (Sort)
      Node 11944 (Hash Join)
        Node 11945 (Nested Loop)
          Node 11946 (Hash Join)
            Node 11947 (Seq Scan) - LEAF
            Node 11948 (Hash)
              Node 11949 (Hash Join)
                Node 11950 (Seq Scan) - LEAF
                Node 11951 (Hash)
                  Node 11952 (Seq Scan) - LEAF
          Node 11953 (Index Scan) - LEAF
        Node 11954 (Hash)
          Node 11955 (Hash Join)
            Node 11956 (Seq Scan) - LEAF
            Node 11957 (Hash)
              Node 11958 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 11941 | Aggregate | 1195.75 | 1209.26 | 1.1% | operator |
| 11942 | Gather Merge | 1194.80 | 1142.98 | 4.3% | operator |
| 11943 | Sort | 1189.08 | 1109.13 | 6.7% | operator |
| 11944 | Hash Join | 1188.50 | 842.59 | 29.1% | operator |
| 11945 | Nested Loop | 1180.92 | 1216.16 | 3.0% | operator |
| 11954 | Hash | 3.91 | 17.53 | 348.7% | operator |
| 11946 | Hash Join | 215.46 | 384.47 | 78.4% | operator |
| 11953 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 11955 | Hash Join | 3.86 | 85.17 | 2106.6% | operator |
| 11947 | Seq Scan | 152.31 | 201.16 | 32.1% | operator |
| 11948 | Hash | 35.77 | 19.59 | 45.2% | operator |
| 11956 | Seq Scan | 3.53 | 11.47 | 225.3% | operator |
| 11957 | Hash | 0.02 | 16.89 | 105488.0% | operator |
| 11949 | Hash Join | 35.43 | 92.20 | 160.2% | operator |
| 11958 | Seq Scan | 0.01 | 45.79 | 352148.6% | operator |
| 11950 | Seq Scan | 34.31 | 21.86 | 36.3% | operator |
| 11951 | Hash | 0.01 | 16.89 | 140684.0% | operator |
| 11952 | Seq Scan | 0.01 | 45.79 | 508703.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11952 (Seq Scan) - LEAF
...
### Step 2: Node 11950 (Seq Scan) - LEAF
...
### Step 5: Node 11958 (Seq Scan) - LEAF
...
### Step 6: Node 11947 (Seq Scan) - LEAF
...
### Step 8: Node 11956 (Seq Scan) - LEAF
...
### Step 11: Node 11953 (Index Scan) - LEAF
...
### Step 13: Node 11945 (Nested Loop)
...
### Step 17: Node 11942 (Gather Merge)
...
### Step 18: Node 11941 (Aggregate) - ROOT
