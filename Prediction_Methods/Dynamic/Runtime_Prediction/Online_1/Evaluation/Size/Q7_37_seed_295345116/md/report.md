...
**Test Query:** Q7_37_seed_295345116
...
```
Node 11941 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 11942 (Gather Merge) [consumed]
    Node 11943 (Sort)
      Node 11944 (Hash Join)
        Node 11945 (Nested Loop)
          Node 11946 (Hash Join) [PATTERN: 895c6e8c]
            Node 11947 (Seq Scan) [consumed] - LEAF
            Node 11948 (Hash) [consumed]
              Node 11949 (Hash Join) [PATTERN: f4cb205a]
                Node 11950 (Seq Scan) [consumed] - LEAF
                Node 11951 (Hash) [consumed]
                  Node 11952 (Seq Scan) [consumed] - LEAF
          Node 11953 (Index Scan) - LEAF
        Node 11954 (Hash)
          Node 11955 (Hash Join) [PATTERN: f4cb205a]
            Node 11956 (Seq Scan) [consumed] - LEAF
            Node 11957 (Hash) [consumed]
              Node 11958 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 11949 | 11941, 11942, 11946, 11947, 11948, 11950, 11951, 11952, 11955, 11956, 11957, 11958 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 11955 | 11941, 11942, 11946, 11947, 11948, 11949, 11950, 11951, 11952, 11956, 11957, 11958 |
| Aggregate -> Gather Merge (Out | 2724c080 | 11941 | 11942, 11946, 11947, 11948, 11949, 11950, 11951, 11952, 11955, 11956, 11957, 11958 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 11946 | 11941, 11942, 11947, 11948, 11949, 11950, 11951, 11952, 11955, 11956, 11957, 11958 |
...
|------|------|--------|-----------|-----|--------|
| 11941 | Aggregate | 1195.75 | 1163.13 | 2.7% | pattern |
| 11943 | Sort | 1189.08 | 1109.16 | 6.7% | operator |
| 11944 | Hash Join | 1188.50 | 843.11 | 29.1% | operator |
| 11945 | Nested Loop | 1180.92 | 1215.99 | 3.0% | operator |
| 11954 | Hash | 3.91 | 27.74 | 610.1% | operator |
| 11946 | Hash Join | 215.46 | 304.89 | 41.5% | pattern |
| 11953 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 11955 | Hash Join | 3.86 | 429.36 | 11023.4% | pattern |
| 11949 | Hash Join | 35.43 | 429.38 | 1111.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11949 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 11941, 11942, 11946, 11947, 11948, 11950, 11951, 11952, 11955, 11956, 11957, 11958
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5000
  - HashJoin_nt1=62500
...
### Step 2: Node 11946 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 11941, 11942, 11947, 11948, 11949, 11950, 11951, 11952, 11955, 11956, 11957, 11958
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=38710
  - HashJoin_nt1=483871
...
### Step 3: Node 11953 (Index Scan) - LEAF
...
### Step 4: Node 11955 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 11941, 11942, 11946, 11947, 11948, 11949, 11950, 11951, 11952, 11956, 11957, 11958
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=800
  - HashJoin_nt1=10000
...
### Step 9: Node 11941 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 11942, 11946, 11947, 11948, 11949, 11950, 11951, 11952, 11955, 11956, 11957, 11958
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
