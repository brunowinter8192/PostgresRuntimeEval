...
**Test Query:** Q12_69_seed_557874108
...
```
Node 25125 (Aggregate) - ROOT
  Node 25126 (Gather Merge)
    Node 25127 (Aggregate)
      Node 25128 (Sort)
        Node 25129 (Nested Loop)
          Node 25130 (Seq Scan) - LEAF
          Node 25131 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 25125 | Aggregate | 1005.51 | 919.04 | 8.6% | operator |
| 25126 | Gather Merge | 1005.49 | 1111.84 | 10.6% | operator |
| 25127 | Aggregate | 983.68 | 895.29 | 9.0% | operator |
| 25128 | Sort | 982.96 | 1092.83 | 11.2% | operator |
| 25129 | Nested Loop | 981.93 | 1127.41 | 14.8% | operator |
| 25130 | Seq Scan | 847.60 | 745.20 | 12.1% | operator |
| 25131 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25130 (Seq Scan) - LEAF
...
### Step 2: Node 25131 (Index Scan) - LEAF
...
### Step 6: Node 25126 (Gather Merge)
...
### Step 7: Node 25125 (Aggregate) - ROOT
