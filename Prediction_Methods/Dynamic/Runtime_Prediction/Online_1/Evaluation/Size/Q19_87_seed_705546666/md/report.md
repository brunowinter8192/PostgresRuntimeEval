...
**Test Query:** Q19_87_seed_705546666
...
```
Node 32165 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 32166 (Gather) [consumed]
    Node 32167 (Aggregate) [consumed]
      Node 32168 (Hash Join) [consumed]
        Node 32169 (Seq Scan) - LEAF
        Node 32170 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 32165 | 32166, 32167, 32168 |
...
|------|------|--------|-----------|-----|--------|
| 32165 | Aggregate | 829.63 | 829.29 | 0.0% | pattern |
| 32169 | Seq Scan | 761.85 | 743.46 | 2.4% | operator |
| 32170 | Hash | 45.80 | 8.29 | 81.9% | operator |
| 32171 | Seq Scan | 45.68 | 23.76 | 48.0% | operator |
...
### Step 2: Node 32169 (Seq Scan) - LEAF
...
### Step 4: Node 32165 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 32166, 32167, 32168
- **Input Features:**
