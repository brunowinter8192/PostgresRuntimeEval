...
```
Node 32165 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 32166 (Gather) [consumed]
    Node 32167 (Aggregate) [consumed]
      Node 32168 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 32165 | 32166, 32167 |
...
|------|------|--------|-----------|-----|--------|
| 32165 | Aggregate | 829.63 | 831.20 | 0.2% | pattern |
| 32168 | Hash Join | 809.55 | 766.05 | 5.4% | operator |
...
### Step 5: Node 32165 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 32166, 32167
- **Input Features:**
