...
```
Node 25454 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25455 (Aggregate) [consumed]
    Node 25456 (Aggregate)
      Node 25457 (Hash Join) [PATTERN: 895c6e8c]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25454 | 25455, 25457, 25458, 25459 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25457 | 25454, 25455, 25458, 25459 |
...
|------|------|--------|-----------|-----|--------|
| 25454 | Sort | 915.47 | 1079.94 | 18.0% | pattern |
| 25456 | Aggregate | 909.29 | 999.76 | 9.9% | operator |
| 25457 | Hash Join | 694.31 | 470.31 | 32.3% | pattern |
| 25460 | Index Only Scan | 9.60 | 0.00 | 100.0% | operator |
...
### Step 2: Node 25457 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25454, 25455, 25458, 25459
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 25454 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25455, 25457, 25458, 25459
- **Input Features:**
