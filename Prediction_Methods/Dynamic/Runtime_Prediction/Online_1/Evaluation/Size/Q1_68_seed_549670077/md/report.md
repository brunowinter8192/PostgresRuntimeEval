...
**Test Query:** Q1_68_seed_549670077
...
```
Node 571 (Aggregate) - ROOT
  Node 572 (Gather Merge)
    Node 573 (Sort) [PATTERN: 1d35fb97]
      Node 574 (Aggregate) [consumed]
        Node 575 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 573 | 574 |
...
|------|------|--------|-----------|-----|--------|
| 571 | Aggregate | 948.07 | 1196.00 | 26.2% | operator |
| 572 | Gather Merge | 948.02 | 1165.94 | 23.0% | operator |
| 573 | Sort | 932.43 | 1200.95 | 28.8% | pattern |
| 575 | Seq Scan | 511.97 | 678.55 | 32.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 575 (Seq Scan) - LEAF
...
### Step 2: Node 573 (Sort) - PATTERN ROOT
...
### Step 4: Node 571 (Aggregate) - ROOT
