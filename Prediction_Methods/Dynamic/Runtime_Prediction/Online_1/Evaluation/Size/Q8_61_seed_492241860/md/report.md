...
```
Node 15662 (Aggregate) - ROOT
  Node 15663 (Gather Merge)
    Node 15664 (Sort)
          ...
          Node 15667 (Hash Join)
            Node 15668 (Nested Loop)
              Node 15669 (Hash Join)
                ...
                Node 15671 (Hash)
                  Node 15672 (Hash Join)
                    Node 15673 (Seq Scan) - LEAF
                    Node 15674 (Hash)
                      Node 15675 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 15662 | Aggregate | 1208.69 | 1184.16 | 2.0% | operator |
| 15663 | Gather Merge | 1208.23 | 1097.17 | 9.2% | operator |
...
| 15669 | Hash Join | 215.19 | 251.17 | 16.7% | operator |
...
| 15671 | Hash | 38.46 | 20.62 | 46.4% | operator |
| 15672 | Hash Join | 37.74 | 132.26 | 250.5% | operator |
| 15673 | Seq Scan | 36.17 | 23.03 | 36.3% | operator |
| 15674 | Hash | 0.21 | 23.66 | 11058.5% | operator |
| 15675 | Hash Join | 0.21 | 306.84 | 146711.5% | operator |
...
### Step 5: Node 15673 (Seq Scan) - LEAF
...
### Step 8: Node 15670 (Seq Scan) - LEAF
...
### Step 11: Node 15679 (Index Scan) - LEAF
...
### Step 12: Node 15681 (Seq Scan) - LEAF
...
### Step 13: Node 15668 (Nested Loop)
...
### Step 16: Node 15682 (Index Scan) - LEAF
...
### Step 17: Node 15684 (Seq Scan) - LEAF
...
### Step 18: Node 15666 (Nested Loop)
...
### Step 22: Node 15663 (Gather Merge)
...
- **Input Features:**
  ...
  - total_cost=71864.2900
- **Output:** st=1093.46, rt=1097.17

### Step 23: Node 15662 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=71564.7300
  - total_cost=71963.0500
- **Output:** st=1158.56, rt=1184.16
