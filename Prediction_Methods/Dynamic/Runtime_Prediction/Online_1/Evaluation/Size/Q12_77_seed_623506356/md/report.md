...
**Test Query:** Q12_77_seed_623506356
...
```
Node 25188 (Aggregate) - ROOT
  Node 25189 (Gather Merge)
    Node 25190 (Aggregate)
      Node 25191 (Sort)
        Node 25192 (Nested Loop)
          Node 25193 (Seq Scan) - LEAF
          Node 25194 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 25188 | Aggregate | 1007.79 | 919.07 | 8.8% | operator |
| 25189 | Gather Merge | 1007.76 | 1111.84 | 10.3% | operator |
| 25190 | Aggregate | 987.14 | 895.31 | 9.3% | operator |
| 25191 | Sort | 986.49 | 1092.81 | 10.8% | operator |
| 25192 | Nested Loop | 985.52 | 1127.41 | 14.4% | operator |
| 25193 | Seq Scan | 848.26 | 745.19 | 12.2% | operator |
| 25194 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25193 (Seq Scan) - LEAF
...
### Step 2: Node 25194 (Index Scan) - LEAF
...
### Step 6: Node 25189 (Gather Merge)
...
### Step 7: Node 25188 (Aggregate) - ROOT
