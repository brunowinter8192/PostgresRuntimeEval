...
**Test Query:** Q7_31_seed_246120930
...
```
Node 11833 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 11834 (Gather Merge) [consumed]
    Node 11835 (Sort)
      Node 11836 (Hash Join)
        Node 11837 (Nested Loop)
          Node 11838 (Hash Join) [PATTERN: 895c6e8c]
            Node 11839 (Seq Scan) [consumed] - LEAF
            Node 11840 (Hash) [consumed]
              Node 11841 (Hash Join) [PATTERN: f4cb205a]
                Node 11842 (Seq Scan) [consumed] - LEAF
                Node 11843 (Hash) [consumed]
                  Node 11844 (Seq Scan) [consumed] - LEAF
          Node 11845 (Index Scan) - LEAF
        Node 11846 (Hash)
          Node 11847 (Hash Join) [PATTERN: f4cb205a]
            Node 11848 (Seq Scan) [consumed] - LEAF
            Node 11849 (Hash) [consumed]
              Node 11850 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 11841 | 11833, 11834, 11838, 11839, 11840, 11842, 11843, 11844, 11847, 11848, 11849, 11850 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 11847 | 11833, 11834, 11838, 11839, 11840, 11841, 11842, 11843, 11844, 11848, 11849, 11850 |
| Aggregate -> Gather Merge (Out | 2724c080 | 11833 | 11834, 11838, 11839, 11840, 11841, 11842, 11843, 11844, 11847, 11848, 11849, 11850 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 11838 | 11833, 11834, 11839, 11840, 11841, 11842, 11843, 11844, 11847, 11848, 11849, 11850 |
...
|------|------|--------|-----------|-----|--------|
| 11833 | Aggregate | 1221.80 | 1163.13 | 4.8% | pattern |
| 11835 | Sort | 1215.38 | 1109.16 | 8.7% | operator |
| 11836 | Hash Join | 1214.75 | 843.11 | 30.6% | operator |
| 11837 | Nested Loop | 1207.23 | 1215.99 | 0.7% | operator |
| 11846 | Hash | 3.48 | 27.74 | 696.8% | operator |
| 11838 | Hash Join | 217.42 | 304.89 | 40.2% | pattern |
| 11845 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 11847 | Hash Join | 3.40 | 429.36 | 12517.2% | pattern |
| 11841 | Hash Join | 38.75 | 429.38 | 1008.1% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11841 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 11833, 11834, 11838, 11839, 11840, 11842, 11843, 11844, 11847, 11848, 11849, 11850
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5000
  - HashJoin_nt1=62500
...
### Step 2: Node 11838 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 11833, 11834, 11839, 11840, 11841, 11842, 11843, 11844, 11847, 11848, 11849, 11850
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=38710
  - HashJoin_nt1=483871
...
### Step 3: Node 11845 (Index Scan) - LEAF
...
### Step 4: Node 11847 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 11833, 11834, 11838, 11839, 11840, 11841, 11842, 11843, 11844, 11848, 11849, 11850
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=800
  - HashJoin_nt1=10000
...
### Step 9: Node 11833 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 11834, 11838, 11839, 11840, 11841, 11842, 11843, 11844, 11847, 11848, 11849, 11850
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
