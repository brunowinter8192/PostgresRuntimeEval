...
```
Node 11833 (Aggregate) - ROOT
  Node 11834 (Gather Merge)
    Node 11835 (Sort)
      Node 11836 (Hash Join)
        Node 11837 (Nested Loop)
          Node 11838 (Hash Join)
            Node 11839 (Seq Scan) - LEAF
            Node 11840 (Hash)
              Node 11841 (Hash Join)
                Node 11842 (Seq Scan) - LEAF
                Node 11843 (Hash)
                  Node 11844 (Seq Scan) - LEAF
          Node 11845 (Index Scan) - LEAF
        Node 11846 (Hash)
          Node 11847 (Hash Join)
            Node 11848 (Seq Scan) - LEAF
            Node 11849 (Hash)
              Node 11850 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 11833 | Aggregate | 1221.80 | 1209.26 | 1.0% | operator |
| 11834 | Gather Merge | 1220.52 | 1142.98 | 6.4% | operator |
| 11835 | Sort | 1215.38 | 1109.13 | 8.7% | operator |
| 11836 | Hash Join | 1214.75 | 842.59 | 30.6% | operator |
| 11837 | Nested Loop | 1207.23 | 1216.16 | 0.7% | operator |
| 11846 | Hash | 3.48 | 17.53 | 403.4% | operator |
| 11838 | Hash Join | 217.42 | 384.47 | 76.8% | operator |
| 11845 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 11847 | Hash Join | 3.40 | 85.17 | 2402.9% | operator |
| 11839 | Seq Scan | 151.77 | 201.16 | 32.5% | operator |
| 11840 | Hash | 39.15 | 19.59 | 50.0% | operator |
| 11848 | Seq Scan | 3.00 | 11.47 | 282.6% | operator |
| 11849 | Hash | 0.02 | 16.89 | 99277.0% | operator |
| 11841 | Hash Join | 38.75 | 92.20 | 137.9% | operator |
| 11850 | Seq Scan | 0.01 | 45.79 | 381502.6% | operator |
| 11842 | Seq Scan | 37.56 | 21.86 | 41.8% | operator |
| 11843 | Hash | 0.01 | 16.89 | 129854.5% | operator |
| 11844 | Seq Scan | 0.01 | 45.79 | 416193.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11844 (Seq Scan) - LEAF
...
### Step 2: Node 11842 (Seq Scan) - LEAF
...
### Step 5: Node 11850 (Seq Scan) - LEAF
...
### Step 6: Node 11839 (Seq Scan) - LEAF
...
### Step 8: Node 11848 (Seq Scan) - LEAF
...
### Step 11: Node 11845 (Index Scan) - LEAF
...
### Step 13: Node 11837 (Nested Loop)
...
### Step 17: Node 11834 (Gather Merge)
...
### Step 18: Node 11833 (Aggregate) - ROOT
