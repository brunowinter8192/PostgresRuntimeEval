...
**Test Query:** Q5_29_seed_229712868
...
```
Node 8321 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 8322 (Aggregate) [consumed]
    Node 8323 (Gather Merge) [consumed]
      Node 8324 (Aggregate)
        Node 8325 (Sort) [PATTERN: 3e2d5a00]
          Node 8326 (Hash Join) [consumed]
            Node 8327 (Nested Loop)
              Node 8328 (Hash Join)
                Node 8329 (Seq Scan) - LEAF
                Node 8330 (Hash) [PATTERN: 444761fb]
                  Node 8331 (Hash Join) [consumed]
                    Node 8332 (Seq Scan) [consumed] - LEAF
                    Node 8333 (Hash) [consumed]
                      Node 8334 (Hash Join) [consumed]
                        Node 8335 (Seq Scan) - LEAF
                        Node 8336 (Hash)
                          Node 8337 (Seq Scan) - LEAF
              Node 8338 (Index Scan) - LEAF
            Node 8339 (Hash)
              Node 8340 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 8330 | 8321, 8322, 8323, 8325, 8326, 8331, 8332, 8333, 8334 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 8321 | 8322, 8323, 8325, 8326, 8330, 8331, 8332, 8333, 8334 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 8325 | 8321, 8322, 8323, 8326, 8330, 8331, 8332, 8333, 8334 |
...
|------|------|--------|-----------|-----|--------|
| 8321 | Sort | 1075.37 | 2934.42 | 172.9% | pattern |
| 8324 | Aggregate | 1070.11 | 1128.74 | 5.5% | operator |
| 8325 | Sort | 1069.83 | 1835.96 | 71.6% | pattern |
| 8327 | Nested Loop | 1056.85 | 1188.57 | 12.5% | operator |
| 8339 | Hash | 3.98 | 18.67 | 369.1% | operator |
| 8328 | Hash Join | 219.65 | 253.07 | 15.2% | operator |
| 8338 | Index Scan | 0.07 | -0.22 | 405.6% | operator |
| 8340 | Seq Scan | 3.44 | 12.36 | 258.9% | operator |
| 8329 | Seq Scan | 166.90 | 159.81 | 4.2% | operator |
| 8330 | Hash | 38.03 | 46.85 | 23.2% | pattern |
| 8335 | Seq Scan | 0.01 | 11.81 | 131103.0% | operator |
| 8336 | Hash | 0.20 | 21.05 | 10641.4% | operator |
| 8337 | Seq Scan | 0.19 | 22.93 | 11844.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 8337 (Seq Scan) - LEAF
...
### Step 2: Node 8335 (Seq Scan) - LEAF
...
### Step 4: Node 8329 (Seq Scan) - LEAF
...
### Step 5: Node 8330 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 8321, 8322, 8323, 8325, 8326, 8331, 8332, 8333, 8334
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 8338 (Index Scan) - LEAF
...
### Step 8: Node 8340 (Seq Scan) - LEAF
...
### Step 11: Node 8325 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 8321, 8322, 8323, 8326, 8330, 8331, 8332, 8333, 8334
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 8321 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 8322, 8323, 8325, 8326, 8330, 8331, 8332, 8333, 8334
- **Input Features:**
