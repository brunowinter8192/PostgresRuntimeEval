...
Node 591 (Aggregate) - ROOT
  Node 592 (Gather Merge)
    Node 593 (Sort) [PATTERN: 1d35fb97]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 593 | 594 |
...
|------|------|--------|-----------|-----|--------|
| 591 | Aggregate | 997.05 | 1195.93 | 19.9% | operator |
| 592 | Gather Merge | 997.01 | 1165.92 | 16.9% | operator |
| 593 | Sort | 978.85 | 1200.65 | 22.7% | pattern |
| 595 | Seq Scan | 571.66 | 679.70 | 18.9% | operator |
...
### Step 2: Node 593 (Sort) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=169063.7600
  - Sort_total_cost=169063.7800
- **Output:** st=1196.56, rt=1200.65

### Step 3: Node 592 (Gather Merge)
...
### Step 4: Node 591 (Aggregate) - ROOT
