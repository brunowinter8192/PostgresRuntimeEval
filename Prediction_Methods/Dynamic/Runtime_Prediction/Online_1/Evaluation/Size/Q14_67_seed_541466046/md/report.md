...
```
Node 27211 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27212 (Gather) [consumed]
    Node 27213 (Aggregate) [consumed]
      Node 27214 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27211 | 27212, 27213, 27214 |
...
|------|------|--------|-----------|-----|--------|
| 27211 | Aggregate | 834.05 | 857.11 | 2.8% | pattern |
...
### Step 4: Node 27211 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27212, 27213, 27214
- **Input Features:**
