...
```
Node 10221 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10222 (Gather) [consumed]
    Node 10223 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10221 | 10222, 10223 |
...
|------|------|--------|-----------|-----|--------|
| 10221 | Aggregate | 787.42 | 850.05 | 8.0% | pattern |
| 10224 | Seq Scan | 763.26 | 748.53 | 1.9% | operator |
...
### Step 2: Node 10221 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10222, 10223
- **Input Features:**
