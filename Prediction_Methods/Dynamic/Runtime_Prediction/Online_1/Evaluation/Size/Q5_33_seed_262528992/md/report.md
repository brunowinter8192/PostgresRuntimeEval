...
```
Node 8421 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 8422 (Aggregate) [consumed]
    Node 8423 (Gather Merge) [consumed]
      Node 8424 (Aggregate)
        Node 8425 (Sort) [PATTERN: 3e2d5a00]
          Node 8426 (Hash Join) [consumed]
            Node 8427 (Nested Loop)
              Node 8428 (Hash Join)
                Node 8429 (Seq Scan) - LEAF
                Node 8430 (Hash) [PATTERN: 444761fb]
                  Node 8431 (Hash Join) [consumed]
                    Node 8432 (Seq Scan) [consumed] - LEAF
                    Node 8433 (Hash) [consumed]
                      Node 8434 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 8430 | 8421, 8422, 8423, 8425, 8426, 8431, 8432, 8433, 8434 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 8421 | 8422, 8423, 8425, 8426, 8430, 8431, 8432, 8433, 8434 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 8425 | 8421, 8422, 8423, 8426, 8430, 8431, 8432, 8433, 8434 |
...
|------|------|--------|-----------|-----|--------|
| 8421 | Sort | 1078.40 | 2934.42 | 172.1% | pattern |
| 8424 | Aggregate | 1074.85 | 1128.74 | 5.0% | operator |
| 8425 | Sort | 1074.58 | 1835.96 | 70.9% | pattern |
| 8427 | Nested Loop | 1061.73 | 1188.57 | 11.9% | operator |
| 8439 | Hash | 4.18 | 18.67 | 347.1% | operator |
| 8428 | Hash Join | 217.61 | 253.07 | 16.3% | operator |
| 8438 | Index Scan | 0.07 | -0.22 | 401.4% | operator |
| 8440 | Seq Scan | 3.47 | 12.36 | 256.6% | operator |
| 8429 | Seq Scan | 169.53 | 159.81 | 5.7% | operator |
| 8430 | Hash | 35.24 | 46.85 | 33.0% | pattern |
| 8435 | Seq Scan | 0.01 | 11.81 | 147503.4% | operator |
| 8436 | Hash | 0.34 | 21.05 | 6038.0% | operator |
| 8437 | Seq Scan | 0.34 | 22.93 | 6625.3% | operator |
...
### Step 4: Node 8429 (Seq Scan) - LEAF
...
### Step 5: Node 8430 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 8421, 8422, 8423, 8425, 8426, 8431, 8432, 8433, 8434
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 8438 (Index Scan) - LEAF
...
### Step 8: Node 8440 (Seq Scan) - LEAF
...
### Step 11: Node 8425 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 8421, 8422, 8423, 8426, 8430, 8431, 8432, 8433, 8434
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 8421 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 8422, 8423, 8425, 8426, 8430, 8431, 8432, 8433, 8434
- **Input Features:**
