...
**Test Query:** Q12_75_seed_607098294
...
```
Node 25174 (Aggregate) - ROOT
  Node 25175 (Gather Merge)
    Node 25176 (Aggregate)
      Node 25177 (Sort)
        Node 25178 (Nested Loop)
          Node 25179 (Seq Scan) - LEAF
          Node 25180 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 25174 | Aggregate | 991.40 | 919.05 | 7.3% | operator |
| 25175 | Gather Merge | 991.38 | 1111.84 | 12.2% | operator |
| 25176 | Aggregate | 972.17 | 895.29 | 7.9% | operator |
| 25177 | Sort | 971.57 | 1092.82 | 12.5% | operator |
| 25178 | Nested Loop | 970.61 | 1127.41 | 16.2% | operator |
| 25179 | Seq Scan | 833.57 | 745.19 | 10.6% | operator |
| 25180 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25179 (Seq Scan) - LEAF
...
### Step 2: Node 25180 (Index Scan) - LEAF
...
### Step 6: Node 25175 (Gather Merge)
...
### Step 7: Node 25174 (Aggregate) - ROOT
