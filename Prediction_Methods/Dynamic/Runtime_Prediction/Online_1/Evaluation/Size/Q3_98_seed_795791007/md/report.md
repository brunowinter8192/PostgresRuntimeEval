...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5821 | 5822, 5823, 5824, 5826, 5827, 5828 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5826 | 5821, 5822, 5823, 5824, 5827, 5828 |
...
|------|------|--------|-----------|-----|--------|
| 5821 | Limit | 1194.23 | 1151.18 | 3.6% | pattern |
| 5825 | Nested Loop | 1159.14 | 1193.11 | 2.9% | operator |
| 5826 | Hash Join | 210.99 | 242.49 | 14.9% | pattern |
| 5830 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5829 | Seq Scan | 28.01 | 38.54 | 37.6% | operator |
...
- **Consumes:** Nodes 5821, 5822, 5823, 5824, 5827, 5828
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47017
  - HashJoin_nt1=233978
  ...
  - HashJoin_total_cost=37336.8400
  - Hash_Inner_np=0
  - Hash_Inner_nt=12559
...
- **Output:** st=121.85, rt=1193.11

### Step 5: Node 5821 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5822, 5823, 5824, 5826, 5827, 5828
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=315309
  - Aggregate_Outer_nt1=315309
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110246.6600
  - Aggregate_Outer_total_cost=114188.0300
  - Gather_Outer_np=0
