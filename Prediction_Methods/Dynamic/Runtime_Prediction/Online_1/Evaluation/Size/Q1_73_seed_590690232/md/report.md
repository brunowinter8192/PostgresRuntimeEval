...
**Test Query:** Q1_73_seed_590690232
...
```
Node 601 (Aggregate) - ROOT
  Node 602 (Gather Merge)
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 603 | 604 |
...
|------|------|--------|-----------|-----|--------|
| 601 | Aggregate | 961.02 | 1195.87 | 24.4% | operator |
| 602 | Gather Merge | 960.97 | 1165.90 | 21.3% | operator |
| 603 | Sort | 944.46 | 1200.43 | 27.1% | pattern |
| 605 | Seq Scan | 521.68 | 680.53 | 30.4% | operator |
...
- **Input Features:**
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=168916.7600
  - Sort_total_cost=168916.7800
- **Output:** st=1196.34, rt=1200.43

### Step 3: Node 602 (Gather Merge)
...
### Step 4: Node 601 (Aggregate) - ROOT
