...
**Test Query:** Q6_41_seed_328161240
...
```
Node 10241 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10242 (Gather) [consumed]
    Node 10243 (Aggregate) [consumed]
      Node 10244 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10241 | 10242, 10243 |
...
|------|------|--------|-----------|-----|--------|
| 10241 | Aggregate | 801.37 | 850.06 | 6.1% | pattern |
| 10244 | Seq Scan | 772.46 | 748.54 | 3.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10244 (Seq Scan) - LEAF
...
### Step 2: Node 10241 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10242, 10243
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=23753
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=32
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=139724.2400
  - Aggregate_Outer_total_cost=139724.2500
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=140724.7700
  - Aggregate_total_cost=140724.7800
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=140724.2400
  - Gather_Outer_total_cost=140724.7500
