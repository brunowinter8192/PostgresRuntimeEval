...
**Test Query:** Q18_140_seed_1140360309
...
```
Node 29524 (Limit) - ROOT
  Node 29525 (Sort)
    Node 29526 (Aggregate)
      Node 29527 (Gather Merge)
        Node 29528 (Incremental Sort)
          Node 29529 (Nested Loop)
            Node 29530 (Merge Join)
              Node 29531 (Sort)
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29532 | 29533, 29534 |
...
|------|------|--------|-----------|-----|--------|
| 29524 | Limit | 3044.14 | 1175.21 | 61.4% | operator |
| 29525 | Sort | 2929.47 | 1127.81 | 61.5% | operator |
| 29526 | Aggregate | 2929.43 | 1073.15 | 63.4% | operator |
| 29527 | Gather Merge | 2929.41 | 1073.95 | 63.3% | operator |
| 29528 | Incremental Sort | 2906.83 | 0.00 | 100.0% | operator |
| 29529 | Nested Loop | 2906.78 | 1111.34 | 61.8% | operator |
| 29530 | Merge Join | 2906.72 | 0.00 | 100.0% | operator |
| 29539 | Index Scan | 0.02 | 0.05 | 114.9% | operator |
| 29531 | Sort | 2839.11 | 1095.58 | 61.4% | operator |
| 29537 | Sort | 64.92 | 1074.66 | 1555.4% | operator |
| 29532 | Hash Join | 2839.10 | 471.07 | 83.4% | pattern |
| 29538 | Seq Scan | 52.80 | 18.25 | 65.4% | operator |
| 29535 | Aggregate | 2614.97 | 1073.15 | 59.0% | operator |
| 29536 | Index Scan | 2124.86 | 0.00 | 100.0% | operator |
...
### Step 4: Node 29538 (Seq Scan) - LEAF
...
### Step 7: Node 29530 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29539 (Index Scan) - LEAF
...
### Step 10: Node 29528 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29527 (Gather Merge)
