...
**Test Query:** Q1_36_seed_287141085
...
```
Node 396 (Aggregate) - ROOT
  Node 397 (Gather Merge)
    Node 398 (Sort) [PATTERN: 1d35fb97]
      Node 399 (Aggregate) [consumed]
        Node 400 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 398 | 399 |
...
|------|------|--------|-----------|-----|--------|
| 396 | Aggregate | 1003.73 | 1195.99 | 19.2% | operator |
| 397 | Gather Merge | 1003.67 | 1165.93 | 16.2% | operator |
| 398 | Sort | 983.42 | 1200.89 | 22.1% | pattern |
| 400 | Seq Scan | 575.48 | 678.81 | 18.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 400 (Seq Scan) - LEAF
...
### Step 2: Node 398 (Sort) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Aggregate_Outer_total_cost=169222.1600
  - Sort_np=0
  - Sort_nt=6
  - Sort_nt1=6
  - Sort_nt2=0
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=169222.2400
  - Sort_total_cost=169222.2600
- **Output:** st=1196.79, rt=1200.89

### Step 3: Node 397 (Gather Merge)
...
### Step 4: Node 396 (Aggregate) - ROOT
