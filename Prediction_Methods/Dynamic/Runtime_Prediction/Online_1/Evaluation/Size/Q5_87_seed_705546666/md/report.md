...
**Test Query:** Q5_87_seed_705546666
**Timestamp:** 2026-01-18 17:28:59
...
```
Node 9601 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 9602 (Aggregate) [consumed]
    Node 9603 (Gather Merge) [consumed]
      Node 9604 (Aggregate)
        Node 9605 (Sort) [PATTERN: 3e2d5a00]
          Node 9606 (Hash Join) [consumed]
            Node 9607 (Nested Loop)
              Node 9608 (Hash Join)
                Node 9609 (Seq Scan) - LEAF
                Node 9610 (Hash) [PATTERN: 444761fb]
                  Node 9611 (Hash Join) [consumed]
                    Node 9612 (Seq Scan) [consumed] - LEAF
                    Node 9613 (Hash) [consumed]
                      Node 9614 (Hash Join) [consumed]
                        Node 9615 (Seq Scan) - LEAF
                        Node 9616 (Hash)
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 9610 | 9601, 9602, 9603, 9605, 9606, 9611, 9612, 9613, 9614 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 9601 | 9602, 9603, 9605, 9606, 9610, 9611, 9612, 9613, 9614 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 9605 | 9601, 9602, 9603, 9606, 9610, 9611, 9612, 9613, 9614 |
...
|------|------|--------|-----------|-----|--------|
| 9601 | Sort | 1068.68 | 2934.42 | 174.6% | pattern |
| 9604 | Aggregate | 1063.22 | 1128.78 | 6.2% | operator |
| 9605 | Sort | 1062.95 | 1835.92 | 72.7% | pattern |
| 9607 | Nested Loop | 1049.97 | 1188.42 | 13.2% | operator |
| 9619 | Hash | 4.39 | 18.67 | 324.9% | operator |
| 9608 | Hash Join | 215.56 | 253.07 | 17.4% | operator |
| 9618 | Index Scan | 0.07 | -0.22 | 397.3% | operator |
| 9620 | Seq Scan | 3.79 | 12.36 | 226.0% | operator |
| 9609 | Seq Scan | 165.71 | 159.81 | 3.6% | operator |
| 9610 | Hash | 36.29 | 46.85 | 29.1% | pattern |
| 9615 | Seq Scan | 0.01 | 11.81 | 117982.7% | operator |
| 9616 | Hash | 0.09 | 21.05 | 24380.5% | operator |
| 9617 | Seq Scan | 0.08 | 22.93 | 28566.7% | operator |
...
### Step 2: Node 9615 (Seq Scan) - LEAF
...
### Step 4: Node 9609 (Seq Scan) - LEAF
...
### Step 5: Node 9610 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 9601, 9602, 9603, 9605, 9606, 9611, 9612, 9613, 9614
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 9618 (Index Scan) - LEAF
...
### Step 8: Node 9620 (Seq Scan) - LEAF
...
### Step 11: Node 9605 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 9601, 9602, 9603, 9606, 9610, 9611, 9612, 9613, 9614
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 9601 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 9602, 9603, 9605, 9606, 9610, 9611, 9612, 9613, 9614
- **Input Features:**
