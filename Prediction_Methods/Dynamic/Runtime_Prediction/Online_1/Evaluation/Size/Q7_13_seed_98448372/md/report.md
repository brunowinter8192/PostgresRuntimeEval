...
```
Node 11275 (Aggregate) - ROOT
  Node 11276 (Gather Merge)
    Node 11277 (Sort)
      Node 11278 (Hash Join)
        Node 11279 (Nested Loop)
          Node 11280 (Hash Join)
            Node 11281 (Seq Scan) - LEAF
            Node 11282 (Hash)
              Node 11283 (Hash Join)
                Node 11284 (Seq Scan) - LEAF
                Node 11285 (Hash)
                  Node 11286 (Seq Scan) - LEAF
          Node 11287 (Index Scan) - LEAF
        Node 11288 (Hash)
          Node 11289 (Hash Join)
            Node 11290 (Seq Scan) - LEAF
            Node 11291 (Hash)
              Node 11292 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 11275 | Aggregate | 1194.85 | 1209.26 | 1.2% | operator |
| 11276 | Gather Merge | 1193.71 | 1142.98 | 4.2% | operator |
| 11277 | Sort | 1188.08 | 1109.13 | 6.6% | operator |
| 11278 | Hash Join | 1187.46 | 842.59 | 29.0% | operator |
| 11279 | Nested Loop | 1181.51 | 1216.16 | 2.9% | operator |
| 11288 | Hash | 2.19 | 17.53 | 699.7% | operator |
| 11280 | Hash Join | 217.02 | 384.47 | 77.2% | operator |
| 11287 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 11289 | Hash Join | 2.15 | 85.17 | 3863.4% | operator |
| 11281 | Seq Scan | 153.60 | 201.16 | 31.0% | operator |
| 11282 | Hash | 37.46 | 19.59 | 47.7% | operator |
| 11290 | Seq Scan | 1.85 | 11.47 | 521.1% | operator |
| 11291 | Hash | 0.01 | 16.89 | 129854.5% | operator |
| 11283 | Hash Join | 37.07 | 92.20 | 148.7% | operator |
| 11292 | Seq Scan | 0.01 | 45.79 | 508703.5% | operator |
| 11284 | Seq Scan | 36.02 | 21.86 | 39.3% | operator |
| 11285 | Hash | 0.01 | 16.89 | 168840.8% | operator |
| 11286 | Seq Scan | 0.01 | 45.79 | 763105.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11286 (Seq Scan) - LEAF
...
### Step 2: Node 11284 (Seq Scan) - LEAF
...
### Step 5: Node 11292 (Seq Scan) - LEAF
...
### Step 6: Node 11281 (Seq Scan) - LEAF
...
### Step 8: Node 11290 (Seq Scan) - LEAF
...
### Step 11: Node 11287 (Index Scan) - LEAF
...
### Step 13: Node 11279 (Nested Loop)
...
### Step 17: Node 11276 (Gather Merge)
...
### Step 18: Node 11275 (Aggregate) - ROOT
