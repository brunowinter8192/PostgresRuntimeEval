...
**Test Query:** Q7_13_seed_98448372
...
```
Node 11275 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 11276 (Gather Merge) [consumed]
    Node 11277 (Sort)
      Node 11278 (Hash Join)
        Node 11279 (Nested Loop)
          Node 11280 (Hash Join) [PATTERN: 895c6e8c]
            Node 11281 (Seq Scan) [consumed] - LEAF
            Node 11282 (Hash) [consumed]
              Node 11283 (Hash Join) [PATTERN: f4cb205a]
                Node 11284 (Seq Scan) [consumed] - LEAF
                Node 11285 (Hash) [consumed]
                  Node 11286 (Seq Scan) [consumed] - LEAF
          Node 11287 (Index Scan) - LEAF
        Node 11288 (Hash)
          Node 11289 (Hash Join) [PATTERN: f4cb205a]
            Node 11290 (Seq Scan) [consumed] - LEAF
            Node 11291 (Hash) [consumed]
              Node 11292 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 11283 | 11275, 11276, 11280, 11281, 11282, 11284, 11285, 11286, 11289, 11290, 11291, 11292 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 11289 | 11275, 11276, 11280, 11281, 11282, 11283, 11284, 11285, 11286, 11290, 11291, 11292 |
| Aggregate -> Gather Merge (Out | 2724c080 | 11275 | 11276, 11280, 11281, 11282, 11283, 11284, 11285, 11286, 11289, 11290, 11291, 11292 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 11280 | 11275, 11276, 11281, 11282, 11283, 11284, 11285, 11286, 11289, 11290, 11291, 11292 |
...
|------|------|--------|-----------|-----|--------|
| 11275 | Aggregate | 1194.85 | 1163.13 | 2.7% | pattern |
| 11277 | Sort | 1188.08 | 1109.16 | 6.6% | operator |
| 11278 | Hash Join | 1187.46 | 843.11 | 29.0% | operator |
| 11279 | Nested Loop | 1181.51 | 1215.99 | 2.9% | operator |
| 11288 | Hash | 2.19 | 27.74 | 1165.7% | operator |
| 11280 | Hash Join | 217.02 | 304.89 | 40.5% | pattern |
| 11287 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 11289 | Hash Join | 2.15 | 429.36 | 19879.7% | pattern |
| 11283 | Hash Join | 37.07 | 429.38 | 1058.4% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11283 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 11275, 11276, 11280, 11281, 11282, 11284, 11285, 11286, 11289, 11290, 11291, 11292
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5000
  - HashJoin_nt1=62500
...
### Step 2: Node 11280 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 11275, 11276, 11281, 11282, 11283, 11284, 11285, 11286, 11289, 11290, 11291, 11292
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=38710
  - HashJoin_nt1=483871
...
### Step 3: Node 11287 (Index Scan) - LEAF
...
### Step 4: Node 11289 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 11275, 11276, 11280, 11281, 11282, 11283, 11284, 11285, 11286, 11290, 11291, 11292
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=800
  - HashJoin_nt1=10000
...
### Step 9: Node 11275 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 11276, 11280, 11281, 11282, 11283, 11284, 11285, 11286, 11289, 11290, 11291, 11292
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
