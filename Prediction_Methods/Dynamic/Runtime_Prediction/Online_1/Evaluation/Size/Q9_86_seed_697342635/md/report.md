...
**Test Query:** Q9_86_seed_697342635
...
```
Node 19080 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 19081 (Aggregate) [consumed]
    Node 19082 (Gather)
      Node 19083 (Aggregate)
        Node 19084 (Nested Loop)
          Node 19085 (Hash Join) [PATTERN: bb930825]
            Node 19086 (Seq Scan) [consumed] - LEAF
            Node 19087 (Hash) [consumed]
              Node 19088 (Hash Join) [consumed]
                Node 19089 (Hash Join)
                  Node 19090 (Nested Loop)
                    Node 19091 (Seq Scan) - LEAF
                    Node 19092 (Index Scan) - LEAF
                  Node 19093 (Hash)
                    Node 19094 (Seq Scan) - LEAF
                Node 19095 (Hash)
                  Node 19096 (Seq Scan) - LEAF
          Node 19097 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 19085 | 19080, 19081, 19086, 19087, 19088 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 19080 | 19081, 19085, 19086, 19087, 19088 |
...
|------|------|--------|-----------|-----|--------|
| 19080 | Sort | 1183.62 | 1048.20 | 11.4% | pattern |
| 19082 | Gather | 1182.45 | 945.99 | 20.0% | operator |
| 19083 | Aggregate | 1162.26 | 1141.78 | 1.8% | operator |
| 19084 | Nested Loop | 1137.79 | 1252.17 | 10.1% | operator |
| 19085 | Hash Join | 963.21 | 134.80 | 86.0% | pattern |
| 19097 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 19089 | Hash Join | 169.53 | 837.36 | 393.9% | operator |
| 19095 | Hash | 13.73 | 14.95 | 8.9% | operator |
| 19090 | Nested Loop | 162.20 | 1251.76 | 671.8% | operator |
| 19093 | Hash | 4.89 | 15.94 | 226.3% | operator |
| 19096 | Seq Scan | 13.72 | 2.94 | 78.6% | operator |
| 19091 | Seq Scan | 20.13 | 44.58 | 121.5% | operator |
| 19092 | Index Scan | 0.08 | -1.39 | 1857.5% | operator |
| 19094 | Seq Scan | 4.24 | 9.45 | 122.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 19091 (Seq Scan) - LEAF
...
### Step 2: Node 19092 (Index Scan) - LEAF
...
### Step 3: Node 19094 (Seq Scan) - LEAF
...
### Step 6: Node 19096 (Seq Scan) - LEAF
...
### Step 9: Node 19085 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 19080, 19081, 19086, 19087, 19088
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 19097 (Index Scan) - LEAF
...
### Step 11: Node 19084 (Nested Loop)
...
### Step 14: Node 19080 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 19081, 19085, 19086, 19087, 19088
- **Input Features:**
