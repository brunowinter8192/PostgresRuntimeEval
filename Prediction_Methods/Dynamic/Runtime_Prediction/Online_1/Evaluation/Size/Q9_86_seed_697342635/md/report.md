...
```
Node 19080 (Sort) - ROOT
  Node 19081 (Aggregate)
    Node 19082 (Gather)
      Node 19083 (Aggregate)
        Node 19084 (Nested Loop)
          Node 19085 (Hash Join)
            Node 19086 (Seq Scan) - LEAF
            Node 19087 (Hash)
              Node 19088 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 19080 | Sort | 1183.62 | 1116.58 | 5.7% | operator |
| 19081 | Aggregate | 1183.49 | 899.75 | 24.0% | operator |
...
| 19085 | Hash Join | 963.21 | 631.85 | 34.4% | operator |
| 19097 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 19086 | Seq Scan | 684.30 | 509.93 | 25.5% | operator |
| 19087 | Hash | 185.76 | 46.99 | 74.7% | operator |
| 19088 | Hash Join | 183.88 | 923.94 | 402.5% | operator |
...
### Step 10: Node 19086 (Seq Scan) - LEAF
...
### Step 13: Node 19097 (Index Scan) - LEAF
...
### Step 14: Node 19084 (Nested Loop)
