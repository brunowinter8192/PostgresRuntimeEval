...
**Test Query:** Q18_101_seed_820403100
**Timestamp:** 2026-01-18 20:20:09
...
```
Node 28836 (Limit) - ROOT
  Node 28837 (Sort)
    Node 28838 (Aggregate)
      Node 28839 (Gather Merge)
        Node 28840 (Incremental Sort)
          Node 28841 (Nested Loop)
            Node 28842 (Merge Join)
              Node 28843 (Sort)
                Node 28844 (Hash Join) [PATTERN: 895c6e8c]
                  Node 28845 (Seq Scan) [consumed] - LEAF
                  Node 28846 (Hash) [consumed]
                    Node 28847 (Aggregate)
                      Node 28848 (Index Scan) - LEAF
              Node 28849 (Sort)
                Node 28850 (Seq Scan) - LEAF
            Node 28851 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 28844 | 28845, 28846 |
...
|------|------|--------|-----------|-----|--------|
| 28836 | Limit | 3068.86 | 1175.21 | 61.7% | operator |
| 28837 | Sort | 2954.17 | 1127.81 | 61.8% | operator |
| 28838 | Aggregate | 2954.12 | 1073.15 | 63.7% | operator |
| 28839 | Gather Merge | 2954.10 | 1073.95 | 63.6% | operator |
| 28840 | Incremental Sort | 2918.85 | 0.00 | 100.0% | operator |
| 28841 | Nested Loop | 2918.80 | 1111.34 | 61.9% | operator |
| 28842 | Merge Join | 2918.74 | 0.00 | 100.0% | operator |
| 28851 | Index Scan | 0.02 | 0.05 | 137.6% | operator |
| 28843 | Sort | 2866.90 | 1095.58 | 61.8% | operator |
| 28849 | Sort | 66.23 | 1074.66 | 1522.6% | operator |
| 28844 | Hash Join | 2866.89 | 471.07 | 83.6% | pattern |
| 28850 | Seq Scan | 54.53 | 18.25 | 66.5% | operator |
| 28847 | Aggregate | 2636.76 | 1073.15 | 59.3% | operator |
| 28848 | Index Scan | 2132.13 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 28848 (Index Scan) - LEAF
...
### Step 3: Node 28844 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 28845, 28846
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 28850 (Seq Scan) - LEAF
...
### Step 7: Node 28842 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 28851 (Index Scan) - LEAF
...
### Step 10: Node 28840 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 28839 (Gather Merge)
