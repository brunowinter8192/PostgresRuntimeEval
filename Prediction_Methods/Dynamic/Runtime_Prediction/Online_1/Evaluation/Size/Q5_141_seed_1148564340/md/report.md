...
```
Node 7801 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 7802 (Aggregate) [consumed]
    Node 7803 (Gather Merge) [consumed]
      Node 7804 (Aggregate)
        Node 7805 (Sort) [PATTERN: 3e2d5a00]
          Node 7806 (Hash Join) [consumed]
            Node 7807 (Nested Loop)
              Node 7808 (Hash Join)
                Node 7809 (Seq Scan) - LEAF
                Node 7810 (Hash) [PATTERN: 444761fb]
                  Node 7811 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 7810 | 7801, 7802, 7803, 7805, 7806, 7811, 7812, 7813, 7814 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 7801 | 7802, 7803, 7805, 7806, 7810, 7811, 7812, 7813, 7814 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 7805 | 7801, 7802, 7803, 7806, 7810, 7811, 7812, 7813, 7814 |
...
|------|------|--------|-----------|-----|--------|
| 7801 | Sort | 1094.12 | 2934.42 | 168.2% | pattern |
| 7804 | Aggregate | 1089.04 | 1128.79 | 3.6% | operator |
| 7805 | Sort | 1088.77 | 1835.90 | 68.6% | pattern |
| 7807 | Nested Loop | 1077.30 | 1188.37 | 10.3% | operator |
| 7819 | Hash | 2.92 | 18.67 | 540.5% | operator |
| 7808 | Hash Join | 216.76 | 253.07 | 16.8% | operator |
| 7818 | Index Scan | 0.07 | -0.22 | 393.4% | operator |
| 7820 | Seq Scan | 2.30 | 12.36 | 437.4% | operator |
| 7809 | Seq Scan | 167.91 | 159.81 | 4.8% | operator |
| 7810 | Hash | 35.25 | 46.85 | 32.9% | pattern |
| 7815 | Seq Scan | 0.01 | 11.81 | 131103.0% | operator |
| 7816 | Hash | 0.05 | 21.05 | 42006.5% | operator |
| 7817 | Seq Scan | 0.05 | 22.93 | 48694.3% | operator |
...
### Step 4: Node 7809 (Seq Scan) - LEAF
...
### Step 5: Node 7810 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 7801, 7802, 7803, 7805, 7806, 7811, 7812, 7813, 7814
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 7818 (Index Scan) - LEAF
...
### Step 8: Node 7820 (Seq Scan) - LEAF
...
### Step 11: Node 7805 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 7801, 7802, 7803, 7806, 7810, 7811, 7812, 7813, 7814
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 7801 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 7802, 7803, 7805, 7806, 7810, 7811, 7812, 7813, 7814
- **Input Features:**
