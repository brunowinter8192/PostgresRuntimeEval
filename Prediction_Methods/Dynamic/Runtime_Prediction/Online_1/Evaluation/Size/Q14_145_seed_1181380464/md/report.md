...
```
Node 26763 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26764 (Gather) [consumed]
    Node 26765 (Aggregate) [consumed]
      Node 26766 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26763 | 26764, 26765, 26766 |
...
|------|------|--------|-----------|-----|--------|
| 26763 | Aggregate | 815.18 | 857.14 | 5.1% | pattern |
...
### Step 4: Node 26763 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26764, 26765, 26766
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=15630
  - HashJoin_Outer_nt1=15630
  ...
  - HashJoin_Outer_total_cost=136647.6700
