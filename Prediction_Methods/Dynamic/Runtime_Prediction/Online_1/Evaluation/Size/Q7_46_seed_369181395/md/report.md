...
```
Node 12121 (Aggregate) - ROOT
  Node 12122 (Gather Merge)
    Node 12123 (Sort)
      Node 12124 (Hash Join)
        Node 12125 (Nested Loop)
          Node 12126 (Hash Join)
            Node 12127 (Seq Scan) - LEAF
            Node 12128 (Hash)
              Node 12129 (Hash Join)
                Node 12130 (Seq Scan) - LEAF
                Node 12131 (Hash)
                  Node 12132 (Seq Scan) - LEAF
          Node 12133 (Index Scan) - LEAF
        Node 12134 (Hash)
          Node 12135 (Hash Join)
            Node 12136 (Seq Scan) - LEAF
            Node 12137 (Hash)
              Node 12138 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12121 | Aggregate | 1191.13 | 1209.26 | 1.5% | operator |
| 12122 | Gather Merge | 1189.94 | 1142.98 | 3.9% | operator |
| 12123 | Sort | 1181.72 | 1109.13 | 6.1% | operator |
| 12124 | Hash Join | 1181.01 | 842.59 | 28.7% | operator |
| 12125 | Nested Loop | 1174.42 | 1216.16 | 3.6% | operator |
| 12134 | Hash | 2.71 | 17.53 | 546.1% | operator |
| 12126 | Hash Join | 218.44 | 384.47 | 76.0% | operator |
| 12133 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 12135 | Hash Join | 2.67 | 85.17 | 3094.8% | operator |
| 12127 | Seq Scan | 152.75 | 201.16 | 31.7% | operator |
| 12128 | Hash | 37.25 | 19.59 | 47.4% | operator |
| 12136 | Seq Scan | 2.34 | 11.47 | 389.8% | operator |
| 12137 | Hash | 0.01 | 16.89 | 120572.0% | operator |
| 12129 | Hash Join | 36.66 | 92.20 | 151.5% | operator |
| 12138 | Seq Scan | 0.01 | 45.79 | 416193.8% | operator |
| 12130 | Seq Scan | 35.54 | 21.86 | 38.5% | operator |
| 12131 | Hash | 0.01 | 16.89 | 187612.0% | operator |
| 12132 | Seq Scan | 0.01 | 45.79 | 763105.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12132 (Seq Scan) - LEAF
...
### Step 2: Node 12130 (Seq Scan) - LEAF
...
### Step 5: Node 12138 (Seq Scan) - LEAF
...
### Step 6: Node 12127 (Seq Scan) - LEAF
...
### Step 8: Node 12136 (Seq Scan) - LEAF
...
### Step 11: Node 12133 (Index Scan) - LEAF
...
### Step 13: Node 12125 (Nested Loop)
...
### Step 17: Node 12122 (Gather Merge)
...
### Step 18: Node 12121 (Aggregate) - ROOT
