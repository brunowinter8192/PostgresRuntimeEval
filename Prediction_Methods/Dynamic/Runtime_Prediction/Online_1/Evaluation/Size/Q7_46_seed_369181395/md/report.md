...
**Test Query:** Q7_46_seed_369181395
...
```
Node 12121 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 12122 (Gather Merge) [consumed]
    Node 12123 (Sort)
      Node 12124 (Hash Join)
        Node 12125 (Nested Loop)
          Node 12126 (Hash Join) [PATTERN: 895c6e8c]
            Node 12127 (Seq Scan) [consumed] - LEAF
            Node 12128 (Hash) [consumed]
              Node 12129 (Hash Join) [PATTERN: f4cb205a]
                Node 12130 (Seq Scan) [consumed] - LEAF
                Node 12131 (Hash) [consumed]
                  Node 12132 (Seq Scan) [consumed] - LEAF
          Node 12133 (Index Scan) - LEAF
        Node 12134 (Hash)
          Node 12135 (Hash Join) [PATTERN: f4cb205a]
            Node 12136 (Seq Scan) [consumed] - LEAF
            Node 12137 (Hash) [consumed]
              Node 12138 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 12129 | 12121, 12122, 12126, 12127, 12128, 12130, 12131, 12132, 12135, 12136, 12137, 12138 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 12135 | 12121, 12122, 12126, 12127, 12128, 12129, 12130, 12131, 12132, 12136, 12137, 12138 |
| Aggregate -> Gather Merge (Out | 2724c080 | 12121 | 12122, 12126, 12127, 12128, 12129, 12130, 12131, 12132, 12135, 12136, 12137, 12138 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 12126 | 12121, 12122, 12127, 12128, 12129, 12130, 12131, 12132, 12135, 12136, 12137, 12138 |
...
|------|------|--------|-----------|-----|--------|
| 12121 | Aggregate | 1191.13 | 1163.13 | 2.4% | pattern |
| 12123 | Sort | 1181.72 | 1109.16 | 6.1% | operator |
| 12124 | Hash Join | 1181.01 | 843.11 | 28.6% | operator |
| 12125 | Nested Loop | 1174.42 | 1215.99 | 3.5% | operator |
| 12134 | Hash | 2.71 | 27.74 | 922.6% | operator |
| 12126 | Hash Join | 218.44 | 304.89 | 39.6% | pattern |
| 12133 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 12135 | Hash Join | 2.67 | 429.36 | 16005.1% | pattern |
| 12129 | Hash Join | 36.66 | 429.38 | 1071.2% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12129 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 12121, 12122, 12126, 12127, 12128, 12130, 12131, 12132, 12135, 12136, 12137, 12138
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5000
  - HashJoin_nt1=62500
...
### Step 2: Node 12126 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 12121, 12122, 12127, 12128, 12129, 12130, 12131, 12132, 12135, 12136, 12137, 12138
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=38710
  - HashJoin_nt1=483871
...
### Step 3: Node 12133 (Index Scan) - LEAF
...
### Step 4: Node 12135 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 12121, 12122, 12126, 12127, 12128, 12129, 12130, 12131, 12132, 12136, 12137, 12138
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=800
  - HashJoin_nt1=10000
...
### Step 9: Node 12121 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 12122, 12126, 12127, 12128, 12129, 12130, 12131, 12132, 12135, 12136, 12137, 12138
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
