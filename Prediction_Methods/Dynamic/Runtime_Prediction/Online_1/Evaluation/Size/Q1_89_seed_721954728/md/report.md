...
**Test Query:** Q1_89_seed_721954728
...
```
Node 686 (Aggregate) - ROOT
  Node 687 (Gather Merge)
    Node 688 (Sort) [PATTERN: 1d35fb97]
      Node 689 (Aggregate) [consumed]
        Node 690 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 688 | 689 |
...
|------|------|--------|-----------|-----|--------|
| 686 | Aggregate | 939.56 | 1196.03 | 27.3% | operator |
| 687 | Gather Merge | 939.52 | 1165.95 | 24.1% | operator |
| 688 | Sort | 923.15 | 1201.03 | 30.1% | pattern |
| 690 | Seq Scan | 513.07 | 678.25 | 32.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 690 (Seq Scan) - LEAF
...
### Step 2: Node 688 (Sort) - PATTERN ROOT
...
### Step 4: Node 686 (Aggregate) - ROOT
