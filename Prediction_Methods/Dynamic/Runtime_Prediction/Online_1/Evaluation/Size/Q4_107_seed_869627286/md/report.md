...
```
Node 5900 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 5901 (Gather Merge) [consumed]
    Node 5902 (Sort) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 5900 | 5901, 5902, 5903 |
...
|------|------|--------|-----------|-----|--------|
| 5900 | Aggregate | 1036.57 | 952.19 | 8.1% | pattern |
| 5904 | Nested Loop | 1029.99 | 1255.45 | 21.9% | operator |
| 5905 | Seq Scan | 162.12 | 154.66 | 4.6% | operator |
| 5906 | Index Scan | 0.06 | 11.10 | 18407.2% | operator |
