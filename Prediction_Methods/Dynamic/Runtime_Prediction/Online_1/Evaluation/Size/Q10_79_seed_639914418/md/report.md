...
**Test Query:** Q10_79_seed_639914418
...
```
Node 21008 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 21009 (Sort) [consumed]
    Node 21010 (Aggregate) [consumed]
      Node 21011 (Gather) [consumed]
        Node 21012 (Hash Join)
          Node 21013 (Hash Join) [PATTERN: 2e0f44ef]
            Node 21014 (Nested Loop) [consumed]
              Node 21015 (Seq Scan) - LEAF
              Node 21016 (Index Scan) - LEAF
            Node 21017 (Hash) [consumed]
              Node 21018 (Seq Scan) - LEAF
          Node 21019 (Hash)
            Node 21020 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 21008 | 21009, 21010, 21011, 21013, 21014, 21017 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 21013 | 21008, 21009, 21010, 21011, 21014, 21017 |
...
|------|------|--------|-----------|-----|--------|
| 21008 | Limit | 1135.91 | 1199.47 | 5.6% | pattern |
| 21012 | Hash Join | 1087.58 | 1095.51 | 0.7% | operator |
| 21013 | Hash Join | 1084.67 | 1120.19 | 3.3% | pattern |
| 21019 | Hash | 0.02 | 15.71 | 68207.7% | operator |
| 21020 | Seq Scan | 0.01 | 6.98 | 63342.8% | operator |
| 21015 | Seq Scan | 161.54 | 159.74 | 1.1% | operator |
| 21016 | Index Scan | 0.06 | -0.52 | 949.6% | operator |
| 21018 | Seq Scan | 28.50 | 26.64 | 6.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 21015 (Seq Scan) - LEAF
...
### Step 2: Node 21016 (Index Scan) - LEAF
...
### Step 3: Node 21018 (Seq Scan) - LEAF
...
### Step 4: Node 21020 (Seq Scan) - LEAF
...
### Step 5: Node 21013 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 21008, 21009, 21010, 21011, 21014, 21017
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18015
  - HashJoin_nt1=18015
...
### Step 8: Node 21008 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 21009, 21010, 21011, 21013, 21014, 21017
- **Input Features:**
