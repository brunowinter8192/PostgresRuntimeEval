...
```
Node 8261 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 8262 (Aggregate) [consumed]
    Node 8263 (Gather Merge) [consumed]
      Node 8264 (Aggregate)
        Node 8265 (Sort) [PATTERN: 3e2d5a00]
          Node 8266 (Hash Join) [consumed]
            Node 8267 (Nested Loop)
              Node 8268 (Hash Join)
                Node 8269 (Seq Scan) - LEAF
                Node 8270 (Hash) [PATTERN: 444761fb]
                  Node 8271 (Hash Join) [consumed]
                    Node 8272 (Seq Scan) [consumed] - LEAF
                    Node 8273 (Hash) [consumed]
                      Node 8274 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 8270 | 8261, 8262, 8263, 8265, 8266, 8271, 8272, 8273, 8274 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 8261 | 8262, 8263, 8265, 8266, 8270, 8271, 8272, 8273, 8274 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 8265 | 8261, 8262, 8263, 8266, 8270, 8271, 8272, 8273, 8274 |
...
|------|------|--------|-----------|-----|--------|
| 8261 | Sort | 1058.91 | 2934.42 | 177.1% | pattern |
| 8264 | Aggregate | 1054.20 | 1128.78 | 7.1% | operator |
| 8265 | Sort | 1053.94 | 1835.91 | 74.2% | pattern |
| 8267 | Nested Loop | 1039.10 | 1188.39 | 14.4% | operator |
| 8279 | Hash | 6.32 | 18.67 | 195.3% | operator |
| 8268 | Hash Join | 210.27 | 253.07 | 20.4% | operator |
| 8278 | Index Scan | 0.07 | -0.22 | 401.4% | operator |
| 8280 | Seq Scan | 5.81 | 12.36 | 112.7% | operator |
| 8269 | Seq Scan | 165.51 | 159.81 | 3.4% | operator |
| 8270 | Hash | 32.13 | 46.85 | 45.8% | pattern |
| 8275 | Seq Scan | 0.01 | 11.81 | 117982.7% | operator |
| 8276 | Hash | 0.06 | 21.05 | 36835.5% | operator |
| 8277 | Seq Scan | 0.05 | 22.93 | 42369.1% | operator |
...
### Step 4: Node 8269 (Seq Scan) - LEAF
...
### Step 5: Node 8270 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 8261, 8262, 8263, 8265, 8266, 8271, 8272, 8273, 8274
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 8278 (Index Scan) - LEAF
...
### Step 8: Node 8280 (Seq Scan) - LEAF
...
### Step 11: Node 8265 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 8261, 8262, 8263, 8266, 8270, 8271, 8272, 8273, 8274
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 8261 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 8262, 8263, 8265, 8266, 8270, 8271, 8272, 8273, 8274
- **Input Features:**
