...
**Test Query:** Q14_17_seed_131264496
...
```
Node 26826 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26827 (Gather) [consumed]
    Node 26828 (Aggregate) [consumed]
      Node 26829 (Hash Join)
        Node 26830 (Seq Scan) - LEAF
        Node 26831 (Hash)
          Node 26832 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26826 | 26827, 26828 |
...
|------|------|--------|-----------|-----|--------|
| 26826 | Aggregate | 791.71 | 848.35 | 7.2% | pattern |
| 26829 | Hash Join | 769.93 | 807.62 | 4.9% | operator |
| 26830 | Seq Scan | 717.21 | 758.47 | 5.8% | operator |
| 26831 | Hash | 45.21 | 9.38 | 79.3% | operator |
| 26832 | Seq Scan | 39.72 | 12.70 | 68.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26832 (Seq Scan) - LEAF
...
### Step 2: Node 26830 (Seq Scan) - LEAF
...
### Step 5: Node 26826 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26827, 26828
- **Input Features:**
