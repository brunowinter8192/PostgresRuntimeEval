...
```
Node 26826 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26827 (Gather) [consumed]
    Node 26828 (Aggregate) [consumed]
      Node 26829 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26826 | 26827, 26828, 26829 |
...
|------|------|--------|-----------|-----|--------|
| 26826 | Aggregate | 791.71 | 857.12 | 8.3% | pattern |
...
### Step 4: Node 26826 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26827, 26828, 26829
- **Input Features:**
