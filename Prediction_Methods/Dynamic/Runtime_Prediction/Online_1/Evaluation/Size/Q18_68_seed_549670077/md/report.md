...
**Test Query:** Q18_68_seed_549670077
...
```
Node 30644 (Limit) - ROOT
  Node 30645 (Sort)
    Node 30646 (Aggregate)
      Node 30647 (Gather Merge)
        Node 30648 (Incremental Sort)
          Node 30649 (Nested Loop)
            Node 30650 (Merge Join)
              Node 30651 (Sort)
                Node 30652 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30653 (Seq Scan) [consumed] - LEAF
                  Node 30654 (Hash) [consumed]
                    Node 30655 (Aggregate)
                      Node 30656 (Index Scan) - LEAF
              Node 30657 (Sort)
                Node 30658 (Seq Scan) - LEAF
            Node 30659 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30652 | 30653, 30654 |
...
|------|------|--------|-----------|-----|--------|
| 30644 | Limit | 3030.53 | 1175.21 | 61.2% | operator |
| 30645 | Sort | 2917.56 | 1127.81 | 61.3% | operator |
| 30646 | Aggregate | 2917.50 | 1073.15 | 63.2% | operator |
| 30647 | Gather Merge | 2917.49 | 1073.95 | 63.2% | operator |
| 30648 | Incremental Sort | 2897.31 | 0.00 | 100.0% | operator |
| 30649 | Nested Loop | 2897.26 | 1111.34 | 61.6% | operator |
| 30650 | Merge Join | 2897.20 | 0.00 | 100.0% | operator |
| 30659 | Index Scan | 0.02 | 0.05 | 105.2% | operator |
| 30651 | Sort | 2829.47 | 1095.58 | 61.3% | operator |
| 30657 | Sort | 64.61 | 1074.66 | 1563.4% | operator |
| 30652 | Hash Join | 2829.46 | 471.07 | 83.4% | pattern |
| 30658 | Seq Scan | 52.74 | 18.25 | 65.4% | operator |
| 30655 | Aggregate | 2609.91 | 1073.15 | 58.9% | operator |
| 30656 | Index Scan | 2113.20 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30656 (Index Scan) - LEAF
...
### Step 3: Node 30652 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30653, 30654
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30658 (Seq Scan) - LEAF
...
### Step 7: Node 30650 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30659 (Index Scan) - LEAF
...
### Step 10: Node 30648 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30647 (Gather Merge)
