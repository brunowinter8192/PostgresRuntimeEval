...
```
Node 26623 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26624 (Gather) [consumed]
    Node 26625 (Aggregate) [consumed]
      Node 26626 (Hash Join) [consumed]
        Node 26627 (Seq Scan) - LEAF
        Node 26628 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26623 | 26624, 26625, 26626 |
...
|------|------|--------|-----------|-----|--------|
| 26623 | Aggregate | 862.25 | 857.15 | 0.6% | pattern |
| 26627 | Seq Scan | 788.28 | 758.53 | 3.8% | operator |
| 26628 | Hash | 44.22 | 9.38 | 78.8% | operator |
| 26629 | Seq Scan | 40.09 | 12.70 | 68.3% | operator |
...
### Step 2: Node 26627 (Seq Scan) - LEAF
...
### Step 4: Node 26623 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26624, 26625, 26626
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=16281
  - HashJoin_Outer_nt1=16281
  ...
  - HashJoin_Outer_total_cost=136649.3800
- **Output:** st=850.79, rt=857.15
