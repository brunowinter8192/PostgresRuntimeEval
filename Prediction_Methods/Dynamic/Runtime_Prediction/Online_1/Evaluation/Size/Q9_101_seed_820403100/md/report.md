...
**Test Query:** Q9_101_seed_820403100
...
```
Node 16670 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 16671 (Aggregate) [consumed]
    Node 16672 (Gather)
      Node 16673 (Aggregate)
        Node 16674 (Nested Loop)
          Node 16675 (Hash Join) [PATTERN: bb930825]
            Node 16676 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 16675 | 16670, 16671, 16676, 16677, 16678 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 16670 | 16671, 16675, 16676, 16677, 16678 |
...
|------|------|--------|-----------|-----|--------|
| 16670 | Sort | 1185.67 | 1044.79 | 11.9% | pattern |
| 16672 | Gather | 1184.53 | 964.87 | 18.5% | operator |
| 16673 | Aggregate | 1166.04 | 1117.47 | 4.2% | operator |
| 16674 | Nested Loop | 1141.88 | 1252.17 | 9.7% | operator |
| 16675 | Hash Join | 973.23 | 134.80 | 86.1% | pattern |
| 16687 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 16679 | Hash Join | 164.96 | 837.55 | 407.7% | operator |
| 16685 | Hash | 13.06 | 14.95 | 14.4% | operator |
| 16680 | Nested Loop | 158.28 | 1251.76 | 690.9% | operator |
| 16683 | Hash | 4.22 | 15.94 | 277.3% | operator |
| 16686 | Seq Scan | 13.05 | 2.94 | 77.5% | operator |
| 16681 | Seq Scan | 21.08 | 44.17 | 109.5% | operator |
| 16682 | Index Scan | 0.07 | -1.39 | 1951.3% | operator |
| 16684 | Seq Scan | 3.62 | 9.45 | 161.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 16681 (Seq Scan) - LEAF
...
### Step 2: Node 16682 (Index Scan) - LEAF
...
### Step 3: Node 16684 (Seq Scan) - LEAF
...
### Step 6: Node 16686 (Seq Scan) - LEAF
...
### Step 9: Node 16675 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 16670, 16671, 16676, 16677, 16678
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 16687 (Index Scan) - LEAF
...
### Step 11: Node 16674 (Nested Loop)
...
### Step 14: Node 16670 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 16671, 16675, 16676, 16677, 16678
- **Input Features:**
