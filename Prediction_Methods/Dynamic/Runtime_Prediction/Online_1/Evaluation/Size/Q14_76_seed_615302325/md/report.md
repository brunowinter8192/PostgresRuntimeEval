...
```
Node 27281 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27282 (Gather) [consumed]
    Node 27283 (Aggregate) [consumed]
      Node 27284 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27281 | 27282, 27283, 27284 |
...
|------|------|--------|-----------|-----|--------|
| 27281 | Aggregate | 821.22 | 857.12 | 4.4% | pattern |
...
### Step 4: Node 27281 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27282, 27283, 27284
- **Input Features:**
