...
**Test Query:** Q14_76_seed_615302325
...
```
Node 27281 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27282 (Gather) [consumed]
    Node 27283 (Aggregate) [consumed]
      Node 27284 (Hash Join)
        Node 27285 (Seq Scan) - LEAF
        Node 27286 (Hash)
          Node 27287 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27281 | 27282, 27283 |
...
|------|------|--------|-----------|-----|--------|
| 27281 | Aggregate | 821.22 | 848.35 | 3.3% | pattern |
| 27284 | Hash Join | 796.94 | 807.62 | 1.3% | operator |
| 27285 | Seq Scan | 739.53 | 758.47 | 2.6% | operator |
| 27286 | Hash | 49.42 | 9.38 | 81.0% | operator |
| 27287 | Seq Scan | 44.37 | 12.70 | 71.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27287 (Seq Scan) - LEAF
...
### Step 2: Node 27285 (Seq Scan) - LEAF
...
### Step 5: Node 27281 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27282, 27283
- **Input Features:**
