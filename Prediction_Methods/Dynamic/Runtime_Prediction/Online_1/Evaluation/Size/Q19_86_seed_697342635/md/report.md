...
**Test Query:** Q19_86_seed_697342635
...
```
Node 32158 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 32159 (Gather) [consumed]
    Node 32160 (Aggregate) [consumed]
      Node 32161 (Hash Join)
        Node 32162 (Seq Scan) - LEAF
        Node 32163 (Hash)
          Node 32164 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 32158 | 32159, 32160 |
...
|------|------|--------|-----------|-----|--------|
| 32158 | Aggregate | 838.82 | 831.20 | 0.9% | pattern |
| 32161 | Hash Join | 817.22 | 766.05 | 6.3% | operator |
| 32162 | Seq Scan | 770.09 | 743.46 | 3.5% | operator |
| 32163 | Hash | 45.10 | 8.29 | 81.6% | operator |
| 32164 | Seq Scan | 44.98 | 23.76 | 47.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 32164 (Seq Scan) - LEAF
...
### Step 2: Node 32162 (Seq Scan) - LEAF
...
### Step 5: Node 32158 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 32159, 32160
- **Input Features:**
