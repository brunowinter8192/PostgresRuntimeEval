...
```
Node 32158 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 32159 (Gather) [consumed]
    Node 32160 (Aggregate) [consumed]
      Node 32161 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 32158 | 32159, 32160, 32161 |
...
|------|------|--------|-----------|-----|--------|
| 32158 | Aggregate | 838.82 | 829.29 | 1.1% | pattern |
...
### Step 4: Node 32158 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 32159, 32160, 32161
- **Input Features:**
