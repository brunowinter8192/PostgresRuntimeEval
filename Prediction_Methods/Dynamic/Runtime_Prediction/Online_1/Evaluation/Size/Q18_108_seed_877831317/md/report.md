...
**Test Query:** Q18_108_seed_877831317
...
```
Node 28948 (Limit) - ROOT
  Node 28949 (Sort)
    Node 28950 (Aggregate)
      Node 28951 (Gather Merge)
        Node 28952 (Incremental Sort)
          Node 28953 (Nested Loop)
            Node 28954 (Merge Join)
              Node 28955 (Sort)
                Node 28956 (Hash Join) [PATTERN: 895c6e8c]
                  Node 28957 (Seq Scan) [consumed] - LEAF
                  Node 28958 (Hash) [consumed]
                    Node 28959 (Aggregate)
                      Node 28960 (Index Scan) - LEAF
              Node 28961 (Sort)
                Node 28962 (Seq Scan) - LEAF
            Node 28963 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 28956 | 28957, 28958 |
...
|------|------|--------|-----------|-----|--------|
| 28948 | Limit | 3021.93 | 1175.21 | 61.1% | operator |
| 28949 | Sort | 2906.23 | 1127.81 | 61.2% | operator |
| 28950 | Aggregate | 2906.17 | 1073.15 | 63.1% | operator |
| 28951 | Gather Merge | 2906.16 | 1073.95 | 63.0% | operator |
| 28952 | Incremental Sort | 2888.08 | 0.00 | 100.0% | operator |
| 28953 | Nested Loop | 2888.04 | 1111.34 | 61.5% | operator |
| 28954 | Merge Join | 2887.97 | 0.00 | 100.0% | operator |
| 28963 | Index Scan | 0.03 | 0.05 | 80.5% | operator |
| 28955 | Sort | 2820.59 | 1095.58 | 61.2% | operator |
| 28961 | Sort | 65.09 | 1074.66 | 1551.1% | operator |
| 28956 | Hash Join | 2820.57 | 471.07 | 83.3% | pattern |
| 28962 | Seq Scan | 53.34 | 18.25 | 65.8% | operator |
| 28959 | Aggregate | 2602.42 | 1073.15 | 58.8% | operator |
| 28960 | Index Scan | 2113.70 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 28960 (Index Scan) - LEAF
...
### Step 3: Node 28956 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 28957, 28958
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 28962 (Seq Scan) - LEAF
...
### Step 7: Node 28954 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 28963 (Index Scan) - LEAF
...
### Step 10: Node 28952 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 28951 (Gather Merge)
