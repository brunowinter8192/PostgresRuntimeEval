        ...
        Node 28952 (Incremental Sort)
          Node 28953 (Nested Loop)
            Node 28954 (Merge Join)
              Node 28955 (Sort)
                Node 28956 (Hash Join)
                  Node 28957 (Seq Scan) - LEAF
                  Node 28958 (Hash)
...
| 28955 | Sort | 2820.59 | 1099.77 | 61.0% | operator |
| 28961 | Sort | 65.09 | 1074.66 | 1551.1% | operator |
| 28956 | Hash Join | 2820.57 | 686.33 | 75.7% | operator |
| 28962 | Seq Scan | 53.34 | 18.25 | 65.8% | operator |
| 28957 | Seq Scan | 188.13 | 170.37 | 9.4% | operator |
| 28958 | Hash | 2602.47 | 21.04 | 99.2% | operator |
...
### Step 3: Node 28957 (Seq Scan) - LEAF
...
### Step 6: Node 28962 (Seq Scan) - LEAF
...
### Step 9: Node 28954 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 28963 (Index Scan) - LEAF
...
### Step 11: Node 28953 (Nested Loop)
...
### Step 12: Node 28952 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 28951 (Gather Merge)
