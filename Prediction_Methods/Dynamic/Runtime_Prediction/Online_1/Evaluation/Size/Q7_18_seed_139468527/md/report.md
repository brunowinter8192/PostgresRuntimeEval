...
```
Node 11563 (Aggregate) - ROOT
  Node 11564 (Gather Merge)
    Node 11565 (Sort)
      Node 11566 (Hash Join)
        Node 11567 (Nested Loop)
          Node 11568 (Hash Join)
            Node 11569 (Seq Scan) - LEAF
            Node 11570 (Hash)
              Node 11571 (Hash Join)
                Node 11572 (Seq Scan) - LEAF
                Node 11573 (Hash)
                  Node 11574 (Seq Scan) - LEAF
          Node 11575 (Index Scan) - LEAF
        Node 11576 (Hash)
          Node 11577 (Hash Join)
            Node 11578 (Seq Scan) - LEAF
            Node 11579 (Hash)
              Node 11580 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 11563 | Aggregate | 1238.92 | 1209.26 | 2.4% | operator |
| 11564 | Gather Merge | 1237.86 | 1142.98 | 7.7% | operator |
| 11565 | Sort | 1232.30 | 1109.13 | 10.0% | operator |
| 11566 | Hash Join | 1231.61 | 842.59 | 31.6% | operator |
| 11567 | Nested Loop | 1223.83 | 1216.16 | 0.6% | operator |
| 11576 | Hash | 3.71 | 17.53 | 372.5% | operator |
| 11568 | Hash Join | 220.48 | 384.47 | 74.4% | operator |
| 11575 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 11577 | Hash Join | 3.66 | 85.17 | 2226.5% | operator |
| 11569 | Seq Scan | 151.32 | 201.16 | 32.9% | operator |
| 11570 | Hash | 41.72 | 19.59 | 53.0% | operator |
| 11578 | Seq Scan | 3.33 | 11.47 | 244.8% | operator |
| 11579 | Hash | 0.02 | 16.89 | 99277.0% | operator |
| 11571 | Hash Join | 41.34 | 92.20 | 123.0% | operator |
| 11580 | Seq Scan | 0.01 | 45.79 | 352148.6% | operator |
| 11572 | Seq Scan | 40.16 | 21.86 | 45.6% | operator |
| 11573 | Hash | 0.01 | 16.89 | 187612.0% | operator |
| 11574 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11574 (Seq Scan) - LEAF
...
### Step 2: Node 11572 (Seq Scan) - LEAF
...
### Step 5: Node 11580 (Seq Scan) - LEAF
...
### Step 6: Node 11569 (Seq Scan) - LEAF
...
### Step 8: Node 11578 (Seq Scan) - LEAF
...
### Step 11: Node 11575 (Index Scan) - LEAF
...
### Step 13: Node 11567 (Nested Loop)
...
### Step 17: Node 11564 (Gather Merge)
...
### Step 18: Node 11563 (Aggregate) - ROOT
