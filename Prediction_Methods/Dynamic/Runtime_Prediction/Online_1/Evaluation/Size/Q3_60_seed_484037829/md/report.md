...
**Test Query:** Q3_60_seed_484037829
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5411 | 5412, 5413, 5414, 5416, 5417, 5418 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5416 | 5411, 5412, 5413, 5414, 5417, 5418 |
...
|------|------|--------|-----------|-----|--------|
| 5411 | Limit | 1214.51 | 1151.18 | 5.2% | pattern |
| 5415 | Nested Loop | 1178.30 | 1193.16 | 1.3% | operator |
| 5416 | Hash Join | 211.25 | 242.49 | 14.8% | pattern |
| 5420 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5419 | Seq Scan | 29.91 | 38.60 | 29.1% | operator |
...
- **Consumes:** Nodes 5411, 5412, 5413, 5414, 5417, 5418
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47092
  - HashJoin_nt1=237422
...
### Step 3: Node 5420 (Index Scan) - LEAF
...
### Step 5: Node 5411 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5412, 5413, 5414, 5416, 5417, 5418
- **Input Features:**
