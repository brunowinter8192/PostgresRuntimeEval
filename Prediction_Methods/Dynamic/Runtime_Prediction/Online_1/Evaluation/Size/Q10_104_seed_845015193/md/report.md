    ...
    Node 19424 (Aggregate) [consumed]
      Node 19425 (Gather) [consumed]
        Node 19426 (Hash Join)
          Node 19427 (Hash Join)
            Node 19428 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19422 | 19423, 19424, 19425 |
...
| 19426 | Hash Join | 1087.37 | 1007.25 | 7.4% | operator |
| 19427 | Hash Join | 1084.59 | 1004.18 | 7.4% | operator |
| 19433 | Hash | 0.02 | 15.71 | 98092.3% | operator |
| 19428 | Nested Loop | 1036.62 | 1204.79 | 16.2% | operator |
| 19431 | Hash | 37.20 | 55.57 | 49.4% | operator |
...
### Step 6: Node 19434 (Seq Scan) - LEAF
...
### Step 10: Node 19422 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19423, 19424, 19425
- **Input Features:**
