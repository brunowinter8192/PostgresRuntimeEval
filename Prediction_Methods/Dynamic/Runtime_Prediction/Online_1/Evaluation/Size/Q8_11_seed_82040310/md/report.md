...
**Test Query:** Q8_11_seed_82040310
...
Node 13684 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 13685 (Gather Merge) [consumed]
    Node 13686 (Sort)
      Node 13687 (Hash Join)
        Node 13688 (Nested Loop)
          Node 13689 (Hash Join)
            Node 13690 (Nested Loop)
              Node 13691 (Hash Join)
                Node 13692 (Seq Scan) - LEAF
                Node 13693 (Hash) [PATTERN: 444761fb]
                  Node 13694 (Hash Join) [consumed]
                    Node 13695 (Seq Scan) [consumed] - LEAF
                    Node 13696 (Hash) [consumed]
                      Node 13697 (Hash Join) [consumed]
                        Node 13698 (Seq Scan) - LEAF
                        Node 13699 (Hash)
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 13693 | 13684, 13685, 13694, 13695, 13696, 13697 |
| Aggregate -> Gather Merge (Out | 2724c080 | 13684 | 13685, 13693, 13694, 13695, 13696, 13697 |
...
|------|------|--------|-----------|-----|--------|
| 13684 | Aggregate | 1208.58 | 1128.60 | 6.6% | pattern |
| 13686 | Sort | 1202.28 | 1046.21 | 13.0% | operator |
| 13687 | Hash Join | 1202.04 | 785.61 | 34.6% | operator |
| 13688 | Nested Loop | 1201.72 | 1198.29 | 0.3% | operator |
| 13705 | Hash | 0.01 | 13.72 | 105469.9% | operator |
| 13689 | Hash Join | 1197.89 | 785.60 | 34.4% | operator |
| 13704 | Index Scan | 0.01 | 12.42 | 206958.1% | operator |
| 13706 | Seq Scan | 0.01 | 6.51 | 65019.6% | operator |
| 13690 | Nested Loop | 1158.09 | 1198.29 | 3.5% | operator |
| 13702 | Hash | 35.36 | 19.97 | 43.5% | operator |
| 13691 | Hash Join | 206.48 | 251.67 | 21.9% | operator |
| 13701 | Index Scan | 0.04 | 2.88 | 6926.5% | operator |
| 13703 | Seq Scan | 35.24 | 48.87 | 38.6% | operator |
| 13692 | Seq Scan | 157.84 | 159.67 | 1.2% | operator |
| 13693 | Hash | 30.33 | 43.51 | 43.5% | pattern |
| 13698 | Seq Scan | 0.01 | 12.22 | 111035.8% | operator |
| 13699 | Hash | 0.28 | 18.14 | 6288.8% | operator |
| 13700 | Seq Scan | 0.28 | 23.36 | 8214.0% | operator |
...
### Step 2: Node 13698 (Seq Scan) - LEAF
...
### Step 4: Node 13692 (Seq Scan) - LEAF
...
### Step 5: Node 13693 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 13684, 13685, 13694, 13695, 13696, 13697
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 13701 (Index Scan) - LEAF
...
### Step 8: Node 13703 (Seq Scan) - LEAF
...
### Step 12: Node 13704 (Index Scan) - LEAF
...
### Step 13: Node 13706 (Seq Scan) - LEAF
...
### Step 14: Node 13688 (Nested Loop)
...
### Step 18: Node 13684 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 13685, 13693, 13694, 13695, 13696, 13697
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2508
