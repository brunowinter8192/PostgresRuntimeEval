...
```
Node 13684 (Aggregate) - ROOT
  Node 13685 (Gather Merge)
    Node 13686 (Sort)
          ...
          Node 13689 (Hash Join)
            Node 13690 (Nested Loop)
              Node 13691 (Hash Join)
                ...
                Node 13693 (Hash)
                  Node 13694 (Hash Join)
                    Node 13695 (Seq Scan) - LEAF
                    Node 13696 (Hash)
                      Node 13697 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 13684 | Aggregate | 1208.58 | 1186.35 | 1.8% | operator |
| 13685 | Gather Merge | 1208.16 | 1097.15 | 9.2% | operator |
...
| 13691 | Hash Join | 206.48 | 251.17 | 21.6% | operator |
...
| 13693 | Hash | 30.33 | 20.62 | 32.0% | operator |
| 13694 | Hash Join | 29.37 | 132.26 | 350.3% | operator |
| 13695 | Seq Scan | 27.71 | 23.03 | 16.9% | operator |
| 13696 | Hash | 0.30 | 23.66 | 7656.1% | operator |
| 13697 | Hash Join | 0.30 | 306.84 | 101501.3% | operator |
...
### Step 5: Node 13695 (Seq Scan) - LEAF
...
### Step 8: Node 13692 (Seq Scan) - LEAF
...
### Step 11: Node 13701 (Index Scan) - LEAF
...
### Step 12: Node 13703 (Seq Scan) - LEAF
...
### Step 13: Node 13690 (Nested Loop)
...
### Step 16: Node 13704 (Index Scan) - LEAF
...
### Step 17: Node 13706 (Seq Scan) - LEAF
...
### Step 18: Node 13688 (Nested Loop)
...
### Step 22: Node 13685 (Gather Merge)
...
### Step 23: Node 13684 (Aggregate) - ROOT
