...
**Test Query:** Q5_70_seed_566078139
...
```
Node 9241 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 9242 (Aggregate) [consumed]
    Node 9243 (Gather Merge) [consumed]
      Node 9244 (Aggregate)
        Node 9245 (Sort) [PATTERN: 3e2d5a00]
          Node 9246 (Hash Join) [consumed]
            Node 9247 (Nested Loop)
              Node 9248 (Hash Join)
                Node 9249 (Seq Scan) - LEAF
                Node 9250 (Hash) [PATTERN: 444761fb]
                  Node 9251 (Hash Join) [consumed]
                    Node 9252 (Seq Scan) [consumed] - LEAF
                    Node 9253 (Hash) [consumed]
                      Node 9254 (Hash Join) [consumed]
                        Node 9255 (Seq Scan) - LEAF
                        Node 9256 (Hash)
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 9250 | 9241, 9242, 9243, 9245, 9246, 9251, 9252, 9253, 9254 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 9241 | 9242, 9243, 9245, 9246, 9250, 9251, 9252, 9253, 9254 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 9245 | 9241, 9242, 9243, 9246, 9250, 9251, 9252, 9253, 9254 |
...
|------|------|--------|-----------|-----|--------|
| 9241 | Sort | 1080.49 | 2934.42 | 171.6% | pattern |
| 9244 | Aggregate | 1075.21 | 1128.74 | 5.0% | operator |
| 9245 | Sort | 1074.94 | 1835.96 | 70.8% | pattern |
| 9247 | Nested Loop | 1062.85 | 1188.57 | 11.8% | operator |
| 9259 | Hash | 3.20 | 18.67 | 484.2% | operator |
| 9248 | Hash Join | 215.85 | 253.07 | 17.2% | operator |
| 9258 | Index Scan | 0.07 | -0.22 | 401.4% | operator |
| 9260 | Seq Scan | 2.71 | 12.36 | 356.4% | operator |
| 9249 | Seq Scan | 168.90 | 159.81 | 5.4% | operator |
| 9250 | Hash | 32.69 | 46.85 | 43.3% | pattern |
| 9255 | Seq Scan | 0.02 | 11.81 | 65501.5% | operator |
| 9256 | Hash | 0.06 | 21.05 | 36835.5% | operator |
| 9257 | Seq Scan | 0.05 | 22.93 | 42369.1% | operator |
...
### Step 2: Node 9255 (Seq Scan) - LEAF
...
### Step 4: Node 9249 (Seq Scan) - LEAF
...
### Step 5: Node 9250 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 9241, 9242, 9243, 9245, 9246, 9251, 9252, 9253, 9254
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 9258 (Index Scan) - LEAF
...
### Step 8: Node 9260 (Seq Scan) - LEAF
...
### Step 11: Node 9245 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 9241, 9242, 9243, 9246, 9250, 9251, 9252, 9253, 9254
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 9241 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 9242, 9243, 9245, 9246, 9250, 9251, 9252, 9253, 9254
- **Input Features:**
