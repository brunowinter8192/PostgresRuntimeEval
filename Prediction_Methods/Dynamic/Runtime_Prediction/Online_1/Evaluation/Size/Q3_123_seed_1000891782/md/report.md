...
**Test Query:** Q3_123_seed_1000891782
...
```
Node 4601 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 4602 (Sort) [consumed]
    Node 4603 (Aggregate) [consumed]
      Node 4604 (Gather) [consumed]
        Node 4605 (Nested Loop)
          Node 4606 (Hash Join) [PATTERN: 895c6e8c]
            Node 4607 (Seq Scan) [consumed] - LEAF
            Node 4608 (Hash) [consumed]
              Node 4609 (Seq Scan) - LEAF
          Node 4610 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4601 | 4602, 4603, 4604, 4606, 4607, 4608 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4606 | 4601, 4602, 4603, 4604, 4607, 4608 |
...
|------|------|--------|-----------|-----|--------|
| 4601 | Limit | 1190.07 | 1151.18 | 3.3% | pattern |
| 4605 | Nested Loop | 1154.33 | 1193.11 | 3.4% | operator |
| 4606 | Hash Join | 207.97 | 242.49 | 16.6% | pattern |
| 4610 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4609 | Seq Scan | 28.45 | 38.57 | 35.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4609 (Seq Scan) - LEAF
...
### Step 2: Node 4606 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4601, 4602, 4603, 4604, 4607, 4608
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47016
  - HashJoin_nt1=235479
  ...
  - HashJoin_total_cost=37339.7800
  - Hash_Inner_np=0
  - Hash_Inner_nt=12479
...
### Step 3: Node 4610 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=72929.6600
- **Output:** st=121.87, rt=1193.11

### Step 5: Node 4601 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4602, 4603, 4604, 4606, 4607, 4608
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=313402
  - Aggregate_Outer_nt1=313402
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=109970.8900
  - Aggregate_Outer_total_cost=113888.4100
  - Gather_Outer_np=0
  - Gather_Outer_nt=313402
  - Gather_Outer_nt1=101097
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105269.8600
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=313402
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=120660.9100
  - Limit_total_cost=120660.9400
  - Sort_Outer_np=0
  - Sort_Outer_nt=313402
  - Sort_Outer_nt1=313402
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=120660.9100
  - Sort_Outer_total_cost=121444.4200
