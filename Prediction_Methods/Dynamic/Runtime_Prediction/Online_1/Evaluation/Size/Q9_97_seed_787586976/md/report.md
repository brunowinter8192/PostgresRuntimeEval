    ...
    Node 19300 (Gather)
      Node 19301 (Aggregate)
        Node 19302 (Nested Loop)
          Node 19303 (Hash Join) [PATTERN: bb930825]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 19303 | 19298, 19299, 19304, 19305, 19306 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 19298 | 19299, 19303, 19304, 19305, 19306 |
...
|------|------|--------|-----------|-----|--------|
| 19298 | Sort | 1193.91 | 1048.20 | 12.2% | pattern |
...
| 19303 | Hash Join | 971.60 | 134.80 | 86.1% | pattern |
...
### Step 9: Node 19303 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 19298, 19299, 19304, 19305, 19306
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 19315 (Index Scan) - LEAF
...
### Step 11: Node 19302 (Nested Loop)
...
### Step 14: Node 19298 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 19299, 19303, 19304, 19305, 19306
- **Input Features:**
