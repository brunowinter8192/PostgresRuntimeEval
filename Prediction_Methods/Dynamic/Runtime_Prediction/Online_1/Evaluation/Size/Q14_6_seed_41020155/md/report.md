...
```
Node 27232 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27233 (Gather) [consumed]
    Node 27234 (Aggregate) [consumed]
      Node 27235 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27232 | 27233, 27234, 27235 |
...
|------|------|--------|-----------|-----|--------|
| 27232 | Aggregate | 827.49 | 857.13 | 3.6% | pattern |
...
### Step 4: Node 27232 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27233, 27234, 27235
- **Input Features:**
