...
**Test Query:** Q12_21_seed_164080620
**Timestamp:** 2025-12-21 17:58:00
...
```
Node 24761 (Aggregate) - ROOT
  Node 24762 (Gather Merge)
    Node 24763 (Aggregate)
      Node 24764 (Sort)
        Node 24765 (Nested Loop)
          Node 24766 (Seq Scan) - LEAF
          Node 24767 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24761 | Aggregate | 1012.38 | 919.04 | 9.2% | operator |
| 24762 | Gather Merge | 1012.36 | 1111.84 | 9.8% | operator |
| 24763 | Aggregate | 991.48 | 895.29 | 9.7% | operator |
| 24764 | Sort | 990.87 | 1092.83 | 10.3% | operator |
| 24765 | Nested Loop | 989.80 | 1127.41 | 13.9% | operator |
| 24766 | Seq Scan | 850.00 | 745.20 | 12.3% | operator |
| 24767 | Index Scan | 0.03 | 0.07 | 166.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24766 (Seq Scan) - LEAF
...
### Step 2: Node 24767 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - st2=0.1246
  - startup_cost=0.4300
  - total_cost=147210.1500
- **Output:** st=38.32, rt=1127.41

### Step 4: Node 24764 (Sort)
...
- **Input Features:**
  ...
  - st1=38.3207
  - st2=0.0000
  - startup_cost=147573.8200
  - total_cost=147588.3600
- **Output:** st=1092.41, rt=1092.83

### Step 5: Node 24763 (Aggregate)
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=147573.8200
  - total_cost=147690.2100
- **Output:** st=868.93, rt=895.29

### Step 6: Node 24762 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=868.9283
  - st2=0.0000
  - startup_cost=148573.9000
  - total_cost=148694.5000
- **Output:** st=1109.22, rt=1111.84

### Step 7: Node 24761 (Aggregate) - ROOT
