...
```
Node 361 (Aggregate) - ROOT
  Node 362 (Gather Merge)
    Node 363 (Sort) [PATTERN: 1d35fb97]
      Node 364 (Aggregate) [consumed]
        Node 365 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 363 | 364 |
...
|------|------|--------|-----------|-----|--------|
| 361 | Aggregate | 1000.11 | 1196.02 | 19.6% | operator |
| 362 | Gather Merge | 1000.04 | 1165.94 | 16.6% | operator |
| 363 | Sort | 979.89 | 1201.00 | 22.6% | pattern |
| 365 | Seq Scan | 575.77 | 678.36 | 17.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 365 (Seq Scan) - LEAF
...
### Step 2: Node 363 (Sort) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=169300.9900
  - Sort_total_cost=169301.0100
- **Output:** st=1196.91, rt=1201.00

### Step 3: Node 362 (Gather Merge)
...
### Step 4: Node 361 (Aggregate) - ROOT
