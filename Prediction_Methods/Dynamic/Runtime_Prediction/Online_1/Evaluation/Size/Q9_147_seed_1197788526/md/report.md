...
**Test Query:** Q9_147_seed_1197788526
...
```
Node 17574 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 17575 (Aggregate) [consumed]
    Node 17576 (Gather)
      Node 17577 (Aggregate)
        Node 17578 (Nested Loop)
          Node 17579 (Hash Join) [PATTERN: bb930825]
            Node 17580 (Seq Scan) [consumed] - LEAF
            Node 17581 (Hash) [consumed]
              Node 17582 (Hash Join) [consumed]
                Node 17583 (Hash Join)
                  Node 17584 (Nested Loop)
                    Node 17585 (Seq Scan) - LEAF
                    Node 17586 (Index Scan) - LEAF
                  Node 17587 (Hash)
                    Node 17588 (Seq Scan) - LEAF
                Node 17589 (Hash)
                  Node 17590 (Seq Scan) - LEAF
          Node 17591 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17579 | 17574, 17575, 17580, 17581, 17582 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17574 | 17575, 17579, 17580, 17581, 17582 |
...
|------|------|--------|-----------|-----|--------|
| 17574 | Sort | 1207.02 | 1052.71 | 12.8% | pattern |
| 17576 | Gather | 1205.57 | 930.93 | 22.8% | operator |
| 17577 | Aggregate | 1187.31 | 1142.35 | 3.8% | operator |
| 17578 | Nested Loop | 1162.28 | 1252.17 | 7.7% | operator |
| 17579 | Hash Join | 992.35 | 134.80 | 86.4% | pattern |
| 17591 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17583 | Hash Join | 164.84 | 837.21 | 407.9% | operator |
| 17589 | Hash | 12.92 | 14.95 | 15.7% | operator |
| 17584 | Nested Loop | 158.21 | 1251.76 | 691.2% | operator |
| 17587 | Hash | 4.61 | 15.94 | 245.5% | operator |
| 17590 | Seq Scan | 12.91 | 2.94 | 77.2% | operator |
| 17585 | Seq Scan | 19.54 | 44.79 | 129.2% | operator |
| 17586 | Index Scan | 0.08 | -1.39 | 1926.9% | operator |
| 17588 | Seq Scan | 4.13 | 9.45 | 128.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 17585 (Seq Scan) - LEAF
...
### Step 2: Node 17586 (Index Scan) - LEAF
...
### Step 3: Node 17588 (Seq Scan) - LEAF
...
### Step 6: Node 17590 (Seq Scan) - LEAF
...
### Step 9: Node 17579 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17574, 17575, 17580, 17581, 17582
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=12023
  - HashJoin_Outer_nt1=12023
  ...
  - HashJoin_Outer_total_cost=13022.3700
  - HashJoin_np=0
  - HashJoin_nt=43293
  ...
  - HashJoin_sel=0.0000
  - HashJoin_startup_cost=13202.7100
  - HashJoin_total_cost=146807.0400
  - Hash_Inner_np=0
  - Hash_Inner_nt=12023
  - Hash_Inner_nt1=12023
  - Hash_Inner_nt2=0
  - Hash_Inner_parallel_workers=0
  - Hash_Inner_plan_width=126
  - Hash_Inner_reltuples=0.0000
  - Hash_Inner_sel=1.0000
  - Hash_Inner_startup_cost=13022.3700
  - Hash_Inner_total_cost=13022.3700
...
### Step 10: Node 17591 (Index Scan) - LEAF
...
### Step 11: Node 17578 (Nested Loop)
...
### Step 14: Node 17574 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17575, 17579, 17580, 17581, 17582
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=60150
  - Aggregate_Outer_nt1=216465
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=168
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.2779
  - Aggregate_Outer_startup_cost=192638.8900
  - Aggregate_Outer_total_cost=193541.1400
  - Sort_np=0
  - Sort_nt=60150
  - Sort_nt1=60150
  - Sort_nt2=0
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=198315.9300
  - Sort_total_cost=198466.3000
- **Output:** st=1051.81, rt=1052.71
