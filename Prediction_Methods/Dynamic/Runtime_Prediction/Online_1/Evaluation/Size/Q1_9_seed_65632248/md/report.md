...
```
Node 746 (Aggregate) - ROOT
  Node 747 (Gather Merge)
    Node 748 (Sort) [PATTERN: 1d35fb97]
      Node 749 (Aggregate) [consumed]
        Node 750 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 748 | 749 |
...
|------|------|--------|-----------|-----|--------|
| 746 | Aggregate | 1006.12 | 1195.82 | 18.9% | operator |
| 747 | Gather Merge | 1006.09 | 1165.89 | 15.9% | operator |
| 748 | Sort | 988.95 | 1200.25 | 21.4% | pattern |
| 750 | Seq Scan | 579.64 | 681.21 | 17.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 750 (Seq Scan) - LEAF
...
### Step 2: Node 748 (Sort) - PATTERN ROOT
...
### Step 4: Node 746 (Aggregate) - ROOT
