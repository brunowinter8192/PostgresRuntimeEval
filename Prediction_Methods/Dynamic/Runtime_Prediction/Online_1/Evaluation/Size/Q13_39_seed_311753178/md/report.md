...
**Test Query:** Q13_39_seed_311753178
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25944 | 25945, 25947, 25948, 25949 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25947 | 25944, 25945, 25948, 25949 |
...
|------|------|--------|-----------|-----|--------|
| 25944 | Sort | 967.86 | 1079.91 | 11.6% | pattern |
| 25946 | Aggregate | 961.82 | 998.54 | 3.8% | operator |
| 25947 | Hash Join | 720.41 | 470.31 | 34.7% | pattern |
| 25950 | Index Only Scan | 9.85 | 0.00 | 100.0% | operator |
...
- **Consumes:** Nodes 25944, 25945, 25948, 25949
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1469940
...
### Step 4: Node 25944 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25945, 25947, 25948, 25949
- **Input Features:**
