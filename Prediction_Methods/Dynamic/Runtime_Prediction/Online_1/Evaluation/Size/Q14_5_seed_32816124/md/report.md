...
```
Node 27155 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27156 (Gather) [consumed]
    Node 27157 (Aggregate) [consumed]
      Node 27158 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27155 | 27156, 27157, 27158 |
...
|------|------|--------|-----------|-----|--------|
| 27155 | Aggregate | 822.48 | 857.14 | 4.2% | pattern |
...
### Step 4: Node 27155 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27156, 27157, 27158
- **Input Features:**
