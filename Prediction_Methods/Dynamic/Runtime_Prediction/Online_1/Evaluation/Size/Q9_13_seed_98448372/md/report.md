...
**Test Query:** Q9_13_seed_98448372
...
```
Node 17429 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 17430 (Aggregate) [consumed]
    Node 17431 (Gather)
      Node 17432 (Aggregate)
        Node 17433 (Nested Loop)
          Node 17434 (Hash Join) [PATTERN: bb930825]
            Node 17435 (Seq Scan) [consumed] - LEAF
            Node 17436 (Hash) [consumed]
              Node 17437 (Hash Join) [consumed]
                Node 17438 (Hash Join)
                  Node 17439 (Nested Loop)
                    Node 17440 (Seq Scan) - LEAF
                    Node 17441 (Index Scan) - LEAF
                  Node 17442 (Hash)
                    Node 17443 (Seq Scan) - LEAF
                Node 17444 (Hash)
                  Node 17445 (Seq Scan) - LEAF
          Node 17446 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17434 | 17429, 17430, 17435, 17436, 17437 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17429 | 17430, 17434, 17435, 17436, 17437 |
...
|------|------|--------|-----------|-----|--------|
| 17429 | Sort | 1194.09 | 1044.79 | 12.5% | pattern |
| 17431 | Gather | 1193.25 | 964.87 | 19.1% | operator |
| 17432 | Aggregate | 1172.38 | 1117.47 | 4.7% | operator |
| 17433 | Nested Loop | 1147.59 | 1252.17 | 9.1% | operator |
| 17434 | Hash Join | 974.01 | 134.80 | 86.2% | pattern |
| 17446 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17438 | Hash Join | 170.90 | 837.55 | 390.1% | operator |
| 17444 | Hash | 12.59 | 14.95 | 18.7% | operator |
| 17439 | Nested Loop | 165.87 | 1251.76 | 654.7% | operator |
| 17442 | Hash | 2.87 | 15.94 | 455.8% | operator |
| 17445 | Seq Scan | 12.58 | 2.94 | 76.7% | operator |
| 17440 | Seq Scan | 20.57 | 44.17 | 114.7% | operator |
| 17441 | Index Scan | 0.08 | -1.39 | 1835.6% | operator |
| 17443 | Seq Scan | 2.35 | 9.45 | 302.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 17440 (Seq Scan) - LEAF
...
### Step 2: Node 17441 (Index Scan) - LEAF
...
### Step 3: Node 17443 (Seq Scan) - LEAF
...
### Step 6: Node 17445 (Seq Scan) - LEAF
...
### Step 9: Node 17434 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17429, 17430, 17435, 17436, 17437
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17446 (Index Scan) - LEAF
...
### Step 11: Node 17433 (Nested Loop)
...
### Step 14: Node 17429 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17430, 17434, 17435, 17436, 17437
- **Input Features:**
