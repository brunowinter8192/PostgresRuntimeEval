...
```
Node 17429 (Sort) - ROOT
  Node 17430 (Aggregate)
    Node 17431 (Gather)
      Node 17432 (Aggregate)
        Node 17433 (Nested Loop)
          Node 17434 (Hash Join)
            Node 17435 (Seq Scan) - LEAF
            Node 17436 (Hash)
              Node 17437 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 17429 | Sort | 1194.09 | 1118.92 | 6.3% | operator |
| 17430 | Aggregate | 1193.97 | 896.90 | 24.9% | operator |
...
| 17434 | Hash Join | 974.01 | 632.96 | 35.0% | operator |
| 17446 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17435 | Seq Scan | 693.63 | 509.93 | 26.5% | operator |
| 17436 | Hash | 185.64 | 47.68 | 74.3% | operator |
| 17437 | Hash Join | 184.10 | 924.32 | 402.1% | operator |
...
### Step 10: Node 17435 (Seq Scan) - LEAF
...
### Step 13: Node 17446 (Index Scan) - LEAF
...
### Step 14: Node 17433 (Nested Loop)
