...
```
Node 526 (Aggregate) - ROOT
  Node 527 (Gather Merge)
    Node 528 (Sort) [PATTERN: 1d35fb97]
      Node 529 (Aggregate) [consumed]
        Node 530 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 528 | 529 |
...
|------|------|--------|-----------|-----|--------|
| 526 | Aggregate | 917.54 | 1195.94 | 30.3% | operator |
| 527 | Gather Merge | 917.49 | 1165.92 | 27.1% | operator |
| 528 | Sort | 900.43 | 1200.71 | 33.3% | pattern |
| 530 | Seq Scan | 500.95 | 679.47 | 35.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 530 (Seq Scan) - LEAF
...
### Step 2: Node 528 (Sort) - PATTERN ROOT
...
### Step 4: Node 526 (Aggregate) - ROOT
