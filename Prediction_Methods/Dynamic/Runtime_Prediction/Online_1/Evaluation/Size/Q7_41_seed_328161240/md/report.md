...
**Test Query:** Q7_41_seed_328161240
**Timestamp:** 2026-01-18 17:58:47
...
```
Node 12031 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 12032 (Gather Merge) [consumed]
    Node 12033 (Sort)
      Node 12034 (Hash Join)
        Node 12035 (Nested Loop)
          Node 12036 (Hash Join) [PATTERN: 895c6e8c]
            Node 12037 (Seq Scan) [consumed] - LEAF
            Node 12038 (Hash) [consumed]
              Node 12039 (Hash Join) [PATTERN: f4cb205a]
                Node 12040 (Seq Scan) [consumed] - LEAF
                Node 12041 (Hash) [consumed]
                  Node 12042 (Seq Scan) [consumed] - LEAF
          Node 12043 (Index Scan) - LEAF
        Node 12044 (Hash)
          Node 12045 (Hash Join) [PATTERN: f4cb205a]
            Node 12046 (Seq Scan) [consumed] - LEAF
            Node 12047 (Hash) [consumed]
              Node 12048 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 12039 | 12031, 12032, 12036, 12037, 12038, 12040, 12041, 12042, 12045, 12046, 12047, 12048 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 12045 | 12031, 12032, 12036, 12037, 12038, 12039, 12040, 12041, 12042, 12046, 12047, 12048 |
| Aggregate -> Gather Merge (Out | 2724c080 | 12031 | 12032, 12036, 12037, 12038, 12039, 12040, 12041, 12042, 12045, 12046, 12047, 12048 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 12036 | 12031, 12032, 12037, 12038, 12039, 12040, 12041, 12042, 12045, 12046, 12047, 12048 |
...
|------|------|--------|-----------|-----|--------|
| 12031 | Aggregate | 1202.12 | 1163.13 | 3.2% | pattern |
| 12033 | Sort | 1195.38 | 1109.16 | 7.2% | operator |
| 12034 | Hash Join | 1194.21 | 843.11 | 29.4% | operator |
| 12035 | Nested Loop | 1187.92 | 1215.99 | 2.4% | operator |
| 12044 | Hash | 2.50 | 27.74 | 1011.1% | operator |
| 12036 | Hash Join | 216.09 | 304.89 | 41.1% | pattern |
| 12043 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 12045 | Hash Join | 2.45 | 429.36 | 17432.2% | pattern |
| 12039 | Hash Join | 36.46 | 429.38 | 1077.6% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12039 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 12031, 12032, 12036, 12037, 12038, 12040, 12041, 12042, 12045, 12046, 12047, 12048
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5000
  - HashJoin_nt1=62500
...
### Step 2: Node 12036 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 12031, 12032, 12037, 12038, 12039, 12040, 12041, 12042, 12045, 12046, 12047, 12048
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=38710
  - HashJoin_nt1=483871
...
### Step 3: Node 12043 (Index Scan) - LEAF
...
### Step 4: Node 12045 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 12031, 12032, 12036, 12037, 12038, 12039, 12040, 12041, 12042, 12046, 12047, 12048
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=800
  - HashJoin_nt1=10000
...
### Step 9: Node 12031 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 12032, 12036, 12037, 12038, 12039, 12040, 12041, 12042, 12045, 12046, 12047, 12048
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
