...
```
Node 12031 (Aggregate) - ROOT
  Node 12032 (Gather Merge)
    Node 12033 (Sort)
      Node 12034 (Hash Join)
        Node 12035 (Nested Loop)
          Node 12036 (Hash Join)
            Node 12037 (Seq Scan) - LEAF
            Node 12038 (Hash)
              Node 12039 (Hash Join)
                Node 12040 (Seq Scan) - LEAF
                Node 12041 (Hash)
                  Node 12042 (Seq Scan) - LEAF
          Node 12043 (Index Scan) - LEAF
        Node 12044 (Hash)
          Node 12045 (Hash Join)
            Node 12046 (Seq Scan) - LEAF
            Node 12047 (Hash)
              Node 12048 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12031 | Aggregate | 1202.12 | 1209.26 | 0.6% | operator |
| 12032 | Gather Merge | 1201.10 | 1142.98 | 4.8% | operator |
| 12033 | Sort | 1195.38 | 1109.13 | 7.2% | operator |
| 12034 | Hash Join | 1194.21 | 842.59 | 29.4% | operator |
| 12035 | Nested Loop | 1187.92 | 1216.16 | 2.4% | operator |
| 12044 | Hash | 2.50 | 17.53 | 602.0% | operator |
| 12036 | Hash Join | 216.09 | 384.47 | 77.9% | operator |
| 12043 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 12045 | Hash Join | 2.45 | 85.17 | 3377.9% | operator |
| 12037 | Seq Scan | 153.27 | 201.16 | 31.2% | operator |
| 12038 | Hash | 36.89 | 19.59 | 46.9% | operator |
| 12046 | Seq Scan | 2.14 | 11.47 | 435.8% | operator |
| 12047 | Hash | 0.01 | 16.89 | 112527.2% | operator |
| 12039 | Hash Join | 36.46 | 92.20 | 152.9% | operator |
| 12048 | Seq Scan | 0.01 | 45.79 | 416193.8% | operator |
| 12040 | Seq Scan | 35.36 | 21.86 | 38.2% | operator |
| 12041 | Hash | 0.01 | 16.89 | 187612.0% | operator |
| 12042 | Seq Scan | 0.01 | 45.79 | 763105.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12042 (Seq Scan) - LEAF
...
### Step 2: Node 12040 (Seq Scan) - LEAF
...
### Step 5: Node 12048 (Seq Scan) - LEAF
...
### Step 6: Node 12037 (Seq Scan) - LEAF
...
### Step 8: Node 12046 (Seq Scan) - LEAF
...
### Step 11: Node 12043 (Index Scan) - LEAF
...
### Step 13: Node 12035 (Nested Loop)
...
### Step 17: Node 12032 (Gather Merge)
...
### Step 18: Node 12031 (Aggregate) - ROOT
