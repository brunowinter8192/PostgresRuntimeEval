...
```
Node 29396 (Limit) - ROOT
  Node 29397 (Sort)
    Node 29398 (Aggregate)
      Node 29399 (Gather Merge)
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29404 | 29405, 29406 |
...
|------|------|--------|-----------|-----|--------|
| 29396 | Limit | 3040.06 | 1175.21 | 61.3% | operator |
| 29397 | Sort | 2928.81 | 1127.81 | 61.5% | operator |
| 29398 | Aggregate | 2928.76 | 1073.15 | 63.4% | operator |
| 29399 | Gather Merge | 2928.74 | 1073.95 | 63.3% | operator |
| 29400 | Incremental Sort | 2893.64 | 0.00 | 100.0% | operator |
| 29401 | Nested Loop | 2893.59 | 1111.34 | 61.6% | operator |
| 29402 | Merge Join | 2893.55 | 0.00 | 100.0% | operator |
| 29411 | Index Scan | 0.02 | 0.05 | 137.6% | operator |
| 29403 | Sort | 2841.99 | 1095.58 | 61.5% | operator |
| 29409 | Sort | 66.07 | 1074.66 | 1526.5% | operator |
| 29404 | Hash Join | 2841.97 | 471.07 | 83.4% | pattern |
| 29410 | Seq Scan | 54.21 | 18.25 | 66.3% | operator |
| 29407 | Aggregate | 2618.92 | 1073.15 | 59.0% | operator |
| 29408 | Index Scan | 2155.20 | 0.00 | 100.0% | operator |
...
### Step 10: Node 29400 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29399 (Gather Merge)
