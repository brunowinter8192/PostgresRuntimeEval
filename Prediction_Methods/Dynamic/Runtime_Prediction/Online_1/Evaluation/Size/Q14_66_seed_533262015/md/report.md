...
**Test Query:** Q14_66_seed_533262015
...
```
Node 27204 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27205 (Gather) [consumed]
    Node 27206 (Aggregate) [consumed]
      Node 27207 (Hash Join)
        Node 27208 (Seq Scan) - LEAF
        Node 27209 (Hash)
          Node 27210 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27204 | 27205, 27206 |
...
|------|------|--------|-----------|-----|--------|
| 27204 | Aggregate | 830.43 | 848.34 | 2.2% | pattern |
| 27207 | Hash Join | 808.52 | 807.60 | 0.1% | operator |
| 27208 | Seq Scan | 759.57 | 758.45 | 0.1% | operator |
| 27209 | Hash | 41.87 | 9.38 | 77.6% | operator |
| 27210 | Seq Scan | 35.69 | 12.70 | 64.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27210 (Seq Scan) - LEAF
...
### Step 2: Node 27208 (Seq Scan) - LEAF
...
### Step 5: Node 27204 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27205, 27206
- **Input Features:**
