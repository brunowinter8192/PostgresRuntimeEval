...
```
Node 27204 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27205 (Gather) [consumed]
    Node 27206 (Aggregate) [consumed]
      Node 27207 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27204 | 27205, 27206, 27207 |
...
|------|------|--------|-----------|-----|--------|
| 27204 | Aggregate | 830.43 | 857.11 | 3.2% | pattern |
...
### Step 4: Node 27204 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27205, 27206, 27207
- **Input Features:**
