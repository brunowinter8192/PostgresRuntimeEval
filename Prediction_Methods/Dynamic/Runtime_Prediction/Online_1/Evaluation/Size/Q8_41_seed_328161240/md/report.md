...
**Test Query:** Q8_41_seed_328161240
...
Node 15156 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 15157 (Gather Merge) [consumed]
    Node 15158 (Sort)
      Node 15159 (Hash Join)
        Node 15160 (Nested Loop)
          Node 15161 (Hash Join)
            Node 15162 (Nested Loop)
              Node 15163 (Hash Join)
                Node 15164 (Seq Scan) - LEAF
                Node 15165 (Hash) [PATTERN: 444761fb]
                  Node 15166 (Hash Join) [consumed]
                    Node 15167 (Seq Scan) [consumed] - LEAF
                    Node 15168 (Hash) [consumed]
                      Node 15169 (Hash Join) [consumed]
                        Node 15170 (Seq Scan) - LEAF
                        Node 15171 (Hash)
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 15165 | 15156, 15157, 15166, 15167, 15168, 15169 |
| Aggregate -> Gather Merge (Out | 2724c080 | 15156 | 15157, 15165, 15166, 15167, 15168, 15169 |
...
|------|------|--------|-----------|-----|--------|
| 15156 | Aggregate | 1223.66 | 1125.52 | 8.0% | pattern |
| 15158 | Sort | 1218.57 | 1046.22 | 14.1% | operator |
| 15159 | Hash Join | 1218.33 | 785.61 | 35.5% | operator |
| 15160 | Nested Loop | 1218.01 | 1198.29 | 1.6% | operator |
| 15177 | Hash | 0.01 | 13.72 | 91393.9% | operator |
| 15161 | Hash Join | 1214.04 | 785.60 | 35.3% | operator |
| 15176 | Index Scan | 0.01 | 12.42 | 206958.1% | operator |
| 15178 | Seq Scan | 0.01 | 6.51 | 54166.4% | operator |
| 15162 | Nested Loop | 1168.07 | 1198.29 | 2.6% | operator |
| 15174 | Hash | 41.48 | 19.97 | 51.9% | operator |
| 15163 | Hash Join | 213.02 | 251.67 | 18.1% | operator |
| 15173 | Index Scan | 0.04 | 2.88 | 6926.5% | operator |
| 15175 | Seq Scan | 41.39 | 48.86 | 18.0% | operator |
| 15164 | Seq Scan | 157.73 | 159.67 | 1.2% | operator |
| 15165 | Hash | 36.93 | 43.51 | 17.8% | pattern |
| 15170 | Seq Scan | 0.04 | 12.22 | 31246.0% | operator |
| 15171 | Hash | 0.19 | 18.14 | 9449.6% | operator |
| 15172 | Seq Scan | 0.19 | 23.36 | 12460.3% | operator |
...
### Step 2: Node 15170 (Seq Scan) - LEAF
...
### Step 4: Node 15164 (Seq Scan) - LEAF
...
### Step 5: Node 15165 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 15156, 15157, 15166, 15167, 15168, 15169
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 15173 (Index Scan) - LEAF
...
### Step 8: Node 15175 (Seq Scan) - LEAF
...
### Step 12: Node 15176 (Index Scan) - LEAF
...
### Step 13: Node 15178 (Seq Scan) - LEAF
...
### Step 14: Node 15160 (Nested Loop)
...
### Step 18: Node 15156 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 15157, 15165, 15166, 15167, 15168, 15169
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2574
