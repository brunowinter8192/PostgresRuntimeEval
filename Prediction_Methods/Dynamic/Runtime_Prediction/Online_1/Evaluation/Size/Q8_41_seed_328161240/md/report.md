...
```
Node 15156 (Aggregate) - ROOT
  Node 15157 (Gather Merge)
    Node 15158 (Sort)
          ...
          Node 15161 (Hash Join)
            Node 15162 (Nested Loop)
              Node 15163 (Hash Join)
                ...
                Node 15165 (Hash)
                  Node 15166 (Hash Join)
                    Node 15167 (Seq Scan) - LEAF
                    Node 15168 (Hash)
                      Node 15169 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 15156 | Aggregate | 1223.66 | 1180.35 | 3.5% | operator |
| 15157 | Gather Merge | 1223.14 | 1097.14 | 10.3% | operator |
...
| 15163 | Hash Join | 213.02 | 251.17 | 17.9% | operator |
...
| 15165 | Hash | 36.93 | 20.62 | 44.2% | operator |
| 15166 | Hash Join | 36.23 | 132.26 | 265.1% | operator |
| 15167 | Seq Scan | 34.34 | 23.03 | 32.9% | operator |
| 15168 | Hash | 0.24 | 23.66 | 9798.0% | operator |
| 15169 | Hash Join | 0.24 | 306.84 | 129915.2% | operator |
...
### Step 5: Node 15167 (Seq Scan) - LEAF
...
### Step 8: Node 15164 (Seq Scan) - LEAF
...
### Step 11: Node 15173 (Index Scan) - LEAF
...
### Step 12: Node 15175 (Seq Scan) - LEAF
...
### Step 13: Node 15162 (Nested Loop)
...
### Step 16: Node 15176 (Index Scan) - LEAF
...
### Step 17: Node 15178 (Seq Scan) - LEAF
...
### Step 18: Node 15160 (Nested Loop)
...
### Step 22: Node 15157 (Gather Merge)
...
### Step 23: Node 15156 (Aggregate) - ROOT
