...
**Test Query:** Q18_50_seed_401997519
...
```
Node 30340 (Limit) - ROOT
  Node 30341 (Sort)
    Node 30342 (Aggregate)
      Node 30343 (Gather Merge)
        Node 30344 (Incremental Sort)
          Node 30345 (Nested Loop)
            Node 30346 (Merge Join)
              Node 30347 (Sort)
                Node 30348 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30349 (Seq Scan) [consumed] - LEAF
                  Node 30350 (Hash) [consumed]
                    Node 30351 (Aggregate)
                      Node 30352 (Index Scan) - LEAF
              Node 30353 (Sort)
                Node 30354 (Seq Scan) - LEAF
            Node 30355 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30348 | 30349, 30350 |
...
|------|------|--------|-----------|-----|--------|
| 30340 | Limit | 3054.42 | 1175.21 | 61.5% | operator |
| 30341 | Sort | 2936.51 | 1127.81 | 61.6% | operator |
| 30342 | Aggregate | 2936.47 | 1073.15 | 63.5% | operator |
| 30343 | Gather Merge | 2936.46 | 1073.95 | 63.4% | operator |
| 30344 | Incremental Sort | 2917.27 | 0.00 | 100.0% | operator |
| 30345 | Nested Loop | 2917.22 | 1111.34 | 61.9% | operator |
| 30346 | Merge Join | 2917.15 | 0.00 | 100.0% | operator |
| 30355 | Index Scan | 0.03 | 0.05 | 73.6% | operator |
| 30347 | Sort | 2847.45 | 1095.58 | 61.5% | operator |
| 30353 | Sort | 67.17 | 1074.66 | 1500.0% | operator |
| 30348 | Hash Join | 2847.44 | 471.07 | 83.5% | pattern |
| 30354 | Seq Scan | 55.67 | 18.25 | 67.2% | operator |
| 30351 | Aggregate | 2624.67 | 1073.15 | 59.1% | operator |
| 30352 | Index Scan | 2112.89 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30352 (Index Scan) - LEAF
...
### Step 3: Node 30348 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30349, 30350
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30354 (Seq Scan) - LEAF
...
### Step 7: Node 30346 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30355 (Index Scan) - LEAF
...
### Step 10: Node 30344 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30343 (Gather Merge)
