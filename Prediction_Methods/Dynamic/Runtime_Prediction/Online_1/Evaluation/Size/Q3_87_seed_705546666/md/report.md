...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5701 | 5702, 5703, 5704 |
...
| 5705 | Nested Loop | 1139.49 | 1192.63 | 4.7% | operator |
| 5706 | Hash Join | 204.65 | 230.22 | 12.5% | operator |
| 5710 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5707 | Seq Scan | 153.24 | 163.19 | 6.5% | operator |
| 5708 | Hash | 27.86 | 17.75 | 36.3% | operator |
...
### Step 2: Node 5707 (Seq Scan) - LEAF
...
### Step 5: Node 5710 (Index Scan) - LEAF
...
### Step 7: Node 5701 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5702, 5703, 5704
- **Input Features:**
