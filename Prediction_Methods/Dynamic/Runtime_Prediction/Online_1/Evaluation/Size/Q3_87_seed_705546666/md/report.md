...
**Test Query:** Q3_87_seed_705546666
...
```
Node 5701 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5702 (Sort) [consumed]
    Node 5703 (Aggregate) [consumed]
      Node 5704 (Gather) [consumed]
        Node 5705 (Nested Loop)
          Node 5706 (Hash Join) [PATTERN: 895c6e8c]
            Node 5707 (Seq Scan) [consumed] - LEAF
            Node 5708 (Hash) [consumed]
              Node 5709 (Seq Scan) - LEAF
          Node 5710 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5701 | 5702, 5703, 5704, 5706, 5707, 5708 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5706 | 5701, 5702, 5703, 5704, 5707, 5708 |
...
|------|------|--------|-----------|-----|--------|
| 5701 | Limit | 1175.23 | 1151.18 | 2.0% | pattern |
| 5705 | Nested Loop | 1139.49 | 1192.72 | 4.7% | operator |
| 5706 | Hash Join | 204.65 | 242.42 | 18.5% | pattern |
| 5710 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5709 | Seq Scan | 27.09 | 38.57 | 42.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5709 (Seq Scan) - LEAF
...
### Step 2: Node 5706 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5701, 5702, 5703, 5704, 5707, 5708
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46411
  - HashJoin_nt1=232303
...
- **Output:** st=29.80, rt=242.42

### Step 3: Node 5710 (Index Scan) - LEAF
...
- **Output:** st=121.48, rt=1192.72

### Step 5: Node 5701 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5702, 5703, 5704, 5706, 5707, 5708
- **Input Features:**
