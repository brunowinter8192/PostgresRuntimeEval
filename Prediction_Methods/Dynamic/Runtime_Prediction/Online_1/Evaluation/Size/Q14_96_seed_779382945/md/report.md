...
```
Node 27435 (Aggregate) [PATTERN: efde8b38] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27435 | 27436, 27437, 27438 |
...
|------|------|--------|-----------|-----|--------|
| 27435 | Aggregate | 844.73 | 857.13 | 1.5% | pattern |
...
### Step 4: Node 27435 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27436, 27437, 27438
- **Input Features:**
