...
```
Node 8201 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 8202 (Aggregate) [consumed]
    Node 8203 (Gather Merge) [consumed]
      Node 8204 (Aggregate)
        Node 8205 (Sort) [PATTERN: 3e2d5a00]
          Node 8206 (Hash Join) [consumed]
            Node 8207 (Nested Loop)
              Node 8208 (Hash Join)
                Node 8209 (Seq Scan) - LEAF
                Node 8210 (Hash) [PATTERN: 444761fb]
                  Node 8211 (Hash Join) [consumed]
                    Node 8212 (Seq Scan) [consumed] - LEAF
                    Node 8213 (Hash) [consumed]
                      Node 8214 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 8210 | 8201, 8202, 8203, 8205, 8206, 8211, 8212, 8213, 8214 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 8201 | 8202, 8203, 8205, 8206, 8210, 8211, 8212, 8213, 8214 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 8205 | 8201, 8202, 8203, 8206, 8210, 8211, 8212, 8213, 8214 |
...
|------|------|--------|-----------|-----|--------|
| 8201 | Sort | 1081.19 | 2934.42 | 171.4% | pattern |
| 8204 | Aggregate | 1075.62 | 1128.74 | 4.9% | operator |
| 8205 | Sort | 1075.35 | 1835.96 | 70.7% | pattern |
| 8207 | Nested Loop | 1063.41 | 1188.57 | 11.8% | operator |
| 8219 | Hash | 3.38 | 18.67 | 451.8% | operator |
| 8208 | Hash Join | 208.15 | 253.07 | 21.6% | operator |
| 8218 | Index Scan | 0.07 | -0.22 | 393.4% | operator |
| 8220 | Seq Scan | 2.85 | 12.36 | 334.4% | operator |
| 8209 | Seq Scan | 163.28 | 159.81 | 2.1% | operator |
| 8210 | Hash | 32.13 | 46.85 | 45.8% | pattern |
...
### Step 4: Node 8209 (Seq Scan) - LEAF
...
### Step 5: Node 8210 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 8201, 8202, 8203, 8205, 8206, 8211, 8212, 8213, 8214
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 8218 (Index Scan) - LEAF
...
### Step 8: Node 8220 (Seq Scan) - LEAF
...
### Step 11: Node 8205 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 8201, 8202, 8203, 8206, 8210, 8211, 8212, 8213, 8214
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 8201 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 8202, 8203, 8205, 8206, 8210, 8211, 8212, 8213, 8214
- **Input Features:**
