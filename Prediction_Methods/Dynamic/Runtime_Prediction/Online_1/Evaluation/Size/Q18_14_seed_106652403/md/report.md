...
**Test Query:** Q18_14_seed_106652403
...
```
Node 29684 (Limit) - ROOT
  Node 29685 (Sort)
    Node 29686 (Aggregate)
      Node 29687 (Gather Merge)
        Node 29688 (Incremental Sort)
          Node 29689 (Nested Loop)
            Node 29690 (Merge Join)
              Node 29691 (Sort)
                Node 29692 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29693 (Seq Scan) [consumed] - LEAF
                  Node 29694 (Hash) [consumed]
                    Node 29695 (Aggregate)
                      Node 29696 (Index Scan) - LEAF
              Node 29697 (Sort)
                Node 29698 (Seq Scan) - LEAF
            Node 29699 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29692 | 29693, 29694 |
...
|------|------|--------|-----------|-----|--------|
| 29684 | Limit | 3051.08 | 1175.21 | 61.5% | operator |
| 29685 | Sort | 2938.35 | 1127.81 | 61.6% | operator |
| 29686 | Aggregate | 2938.31 | 1073.15 | 63.5% | operator |
| 29687 | Gather Merge | 2938.29 | 1073.95 | 63.4% | operator |
| 29688 | Incremental Sort | 2919.61 | 0.00 | 100.0% | operator |
| 29689 | Nested Loop | 2919.57 | 1111.34 | 61.9% | operator |
| 29690 | Merge Join | 2919.51 | 0.00 | 100.0% | operator |
| 29699 | Index Scan | 0.02 | 0.05 | 105.2% | operator |
| 29691 | Sort | 2851.45 | 1095.58 | 61.6% | operator |
| 29697 | Sort | 65.57 | 1074.66 | 1539.0% | operator |
| 29692 | Hash Join | 2851.44 | 471.07 | 83.5% | pattern |
| 29698 | Seq Scan | 54.03 | 18.25 | 66.2% | operator |
| 29695 | Aggregate | 2627.77 | 1073.15 | 59.2% | operator |
| 29696 | Index Scan | 2130.49 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29696 (Index Scan) - LEAF
...
### Step 3: Node 29692 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29693, 29694
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29698 (Seq Scan) - LEAF
...
### Step 7: Node 29690 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29699 (Index Scan) - LEAF
...
### Step 10: Node 29688 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29687 (Gather Merge)
