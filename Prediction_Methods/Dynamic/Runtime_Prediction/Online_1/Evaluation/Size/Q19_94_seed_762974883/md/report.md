...
```
Node 32221 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 32222 (Gather) [consumed]
    Node 32223 (Aggregate) [consumed]
      Node 32224 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 32221 | 32222, 32223, 32224 |
...
|------|------|--------|-----------|-----|--------|
| 32221 | Aggregate | 836.44 | 829.29 | 0.9% | pattern |
| 32225 | Seq Scan | 767.35 | 743.46 | 3.1% | operator |
| 32226 | Hash | 46.65 | 8.29 | 82.2% | operator |
| 32227 | Seq Scan | 46.47 | 23.76 | 48.9% | operator |
...
### Step 4: Node 32221 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 32222, 32223, 32224
- **Input Features:**
