...
**Test Query:** Q13_51_seed_410201550
...
```
Node 26042 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26043 (Aggregate) [consumed]
    Node 26044 (Aggregate)
      Node 26045 (Hash Join) [PATTERN: 895c6e8c]
        Node 26046 (Seq Scan) [consumed] - LEAF
        Node 26047 (Hash) [consumed]
          Node 26048 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26042 | 26043, 26045, 26046, 26047 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26045 | 26042, 26043, 26046, 26047 |
...
|------|------|--------|-----------|-----|--------|
| 26042 | Sort | 913.66 | 1079.91 | 18.2% | pattern |
| 26044 | Aggregate | 907.74 | 998.54 | 10.0% | operator |
| 26045 | Hash Join | 688.20 | 470.31 | 31.7% | pattern |
| 26048 | Index Only Scan | 10.20 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26048 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26045 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26042, 26043, 26046, 26047
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1469940
...
### Step 4: Node 26042 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26043, 26045, 26046, 26047
- **Input Features:**
