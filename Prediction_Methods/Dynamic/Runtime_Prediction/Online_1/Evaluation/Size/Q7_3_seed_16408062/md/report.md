...
```
Node 11995 (Aggregate) - ROOT
  Node 11996 (Gather Merge)
    Node 11997 (Sort)
      Node 11998 (Hash Join)
        Node 11999 (Nested Loop)
          Node 12000 (Hash Join)
            Node 12001 (Seq Scan) - LEAF
            Node 12002 (Hash)
              Node 12003 (Hash Join)
                Node 12004 (Seq Scan) - LEAF
                Node 12005 (Hash)
                  Node 12006 (Seq Scan) - LEAF
          Node 12007 (Index Scan) - LEAF
        Node 12008 (Hash)
          Node 12009 (Hash Join)
            Node 12010 (Seq Scan) - LEAF
            Node 12011 (Hash)
              Node 12012 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 11995 | Aggregate | 1198.00 | 1209.26 | 0.9% | operator |
| 11996 | Gather Merge | 1196.79 | 1142.98 | 4.5% | operator |
| 11997 | Sort | 1190.50 | 1109.13 | 6.8% | operator |
| 11998 | Hash Join | 1189.87 | 842.59 | 29.2% | operator |
| 11999 | Nested Loop | 1183.92 | 1216.16 | 2.7% | operator |
| 12008 | Hash | 2.23 | 17.53 | 686.4% | operator |
| 12000 | Hash Join | 214.22 | 384.47 | 79.5% | operator |
| 12007 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 12009 | Hash Join | 2.18 | 85.17 | 3803.5% | operator |
| 12001 | Seq Scan | 153.01 | 201.16 | 31.5% | operator |
| 12002 | Hash | 35.43 | 19.59 | 44.7% | operator |
| 12010 | Seq Scan | 1.86 | 11.47 | 515.1% | operator |
| 12011 | Hash | 0.01 | 16.89 | 120572.0% | operator |
| 12003 | Hash Join | 35.02 | 92.20 | 163.3% | operator |
| 12012 | Seq Scan | 0.01 | 45.79 | 416193.8% | operator |
| 12004 | Seq Scan | 33.91 | 21.86 | 35.5% | operator |
| 12005 | Hash | 0.01 | 16.89 | 168840.8% | operator |
| 12006 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12006 (Seq Scan) - LEAF
...
### Step 2: Node 12004 (Seq Scan) - LEAF
...
### Step 5: Node 12012 (Seq Scan) - LEAF
...
### Step 6: Node 12001 (Seq Scan) - LEAF
...
### Step 8: Node 12010 (Seq Scan) - LEAF
...
### Step 11: Node 12007 (Index Scan) - LEAF
...
### Step 13: Node 11999 (Nested Loop)
...
### Step 17: Node 11996 (Gather Merge)
...
### Step 18: Node 11995 (Aggregate) - ROOT
