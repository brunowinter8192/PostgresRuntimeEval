...
```
Node 11995 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 11996 (Gather Merge) [consumed]
    Node 11997 (Sort)
      Node 11998 (Hash Join)
        Node 11999 (Nested Loop)
          Node 12000 (Hash Join) [PATTERN: 895c6e8c]
            Node 12001 (Seq Scan) [consumed] - LEAF
            Node 12002 (Hash) [consumed]
              Node 12003 (Hash Join) [PATTERN: f4cb205a]
                Node 12004 (Seq Scan) [consumed] - LEAF
                Node 12005 (Hash) [consumed]
                  Node 12006 (Seq Scan) [consumed] - LEAF
          Node 12007 (Index Scan) - LEAF
        Node 12008 (Hash)
          Node 12009 (Hash Join) [PATTERN: f4cb205a]
            Node 12010 (Seq Scan) [consumed] - LEAF
            Node 12011 (Hash) [consumed]
              Node 12012 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 12003 | 11995, 11996, 12000, 12001, 12002, 12004, 12005, 12006, 12009, 12010, 12011, 12012 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 12009 | 11995, 11996, 12000, 12001, 12002, 12003, 12004, 12005, 12006, 12010, 12011, 12012 |
| Aggregate -> Gather Merge (Out | 2724c080 | 11995 | 11996, 12000, 12001, 12002, 12003, 12004, 12005, 12006, 12009, 12010, 12011, 12012 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 12000 | 11995, 11996, 12001, 12002, 12003, 12004, 12005, 12006, 12009, 12010, 12011, 12012 |
...
|------|------|--------|-----------|-----|--------|
| 11995 | Aggregate | 1198.00 | 1163.13 | 2.9% | pattern |
| 11997 | Sort | 1190.50 | 1109.16 | 6.8% | operator |
| 11998 | Hash Join | 1189.87 | 843.11 | 29.1% | operator |
| 11999 | Nested Loop | 1183.92 | 1215.99 | 2.7% | operator |
| 12008 | Hash | 2.23 | 27.74 | 1144.6% | operator |
| 12000 | Hash Join | 214.22 | 304.89 | 42.3% | pattern |
| 12007 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 12009 | Hash Join | 2.18 | 429.36 | 19577.5% | pattern |
| 12003 | Hash Join | 35.02 | 429.38 | 1126.2% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12003 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 11995, 11996, 12000, 12001, 12002, 12004, 12005, 12006, 12009, 12010, 12011, 12012
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5000
  - HashJoin_nt1=62500
...
### Step 2: Node 12000 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 11995, 11996, 12001, 12002, 12003, 12004, 12005, 12006, 12009, 12010, 12011, 12012
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=38710
  - HashJoin_nt1=483871
...
### Step 3: Node 12007 (Index Scan) - LEAF
...
### Step 4: Node 12009 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 11995, 11996, 12000, 12001, 12002, 12003, 12004, 12005, 12006, 12010, 12011, 12012
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=800
  - HashJoin_nt1=10000
...
### Step 9: Node 11995 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 11996, 12000, 12001, 12002, 12003, 12004, 12005, 12006, 12009, 12010, 12011, 12012
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
