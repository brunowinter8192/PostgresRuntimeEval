    ...
    Node 20828 (Aggregate) [consumed]
      Node 20829 (Gather) [consumed]
        Node 20830 (Hash Join)
          Node 20831 (Hash Join)
            Node 20832 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20826 | 20827, 20828, 20829 |
...
| 20830 | Hash Join | 1104.68 | 1007.14 | 8.8% | operator |
| 20831 | Hash Join | 1101.68 | 1003.99 | 8.9% | operator |
| 20837 | Hash | 0.02 | 15.71 | 82588.3% | operator |
| 20832 | Nested Loop | 1052.56 | 1204.86 | 14.5% | operator |
| 20835 | Hash | 37.41 | 55.57 | 48.5% | operator |
...
### Step 6: Node 20838 (Seq Scan) - LEAF
...
### Step 10: Node 20826 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20827, 20828, 20829
- **Input Features:**
