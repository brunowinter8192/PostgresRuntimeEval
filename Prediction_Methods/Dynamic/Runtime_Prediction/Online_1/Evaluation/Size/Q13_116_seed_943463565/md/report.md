...
**Test Query:** Q13_116_seed_943463565
...
```
Node 25489 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25490 (Aggregate) [consumed]
    Node 25491 (Aggregate)
      Node 25492 (Hash Join) [PATTERN: 895c6e8c]
        Node 25493 (Seq Scan) [consumed] - LEAF
        Node 25494 (Hash) [consumed]
          Node 25495 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25489 | 25490, 25492, 25493, 25494 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25492 | 25489, 25490, 25493, 25494 |
...
|------|------|--------|-----------|-----|--------|
| 25489 | Sort | 920.15 | 1079.94 | 17.4% | pattern |
| 25491 | Aggregate | 914.09 | 999.76 | 9.4% | operator |
| 25492 | Hash Join | 694.49 | 470.31 | 32.3% | pattern |
| 25495 | Index Only Scan | 9.53 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25495 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25492 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25489, 25490, 25493, 25494
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 25489 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25490, 25492, 25493, 25494
- **Input Features:**
