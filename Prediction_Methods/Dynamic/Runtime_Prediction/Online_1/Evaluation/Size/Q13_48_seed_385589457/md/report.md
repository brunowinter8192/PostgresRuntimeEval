...
**Test Query:** Q13_48_seed_385589457
...
```
Node 26014 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26015 (Aggregate) [consumed]
    Node 26016 (Aggregate)
      Node 26017 (Hash Join) [PATTERN: 895c6e8c]
        Node 26018 (Seq Scan) [consumed] - LEAF
        Node 26019 (Hash) [consumed]
          Node 26020 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26014 | 26015, 26017, 26018, 26019 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26017 | 26014, 26015, 26018, 26019 |
...
|------|------|--------|-----------|-----|--------|
| 26014 | Sort | 897.54 | 1079.92 | 20.3% | pattern |
| 26016 | Aggregate | 891.59 | 998.94 | 12.0% | operator |
| 26017 | Hash Join | 680.13 | 470.31 | 30.9% | pattern |
| 26020 | Index Only Scan | 10.07 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26020 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26017 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26014, 26015, 26018, 26019
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1475952
...
### Step 4: Node 26014 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26015, 26017, 26018, 26019
- **Input Features:**
