...
**Test Query:** Q18_132_seed_1074728061
...
```
Node 29380 (Limit) - ROOT
  Node 29381 (Sort)
    Node 29382 (Aggregate)
      Node 29383 (Gather Merge)
        Node 29384 (Incremental Sort)
          Node 29385 (Nested Loop)
            Node 29386 (Merge Join)
              Node 29387 (Sort)
                Node 29388 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29389 (Seq Scan) [consumed] - LEAF
                  Node 29390 (Hash) [consumed]
                    Node 29391 (Aggregate)
                      Node 29392 (Index Scan) - LEAF
              Node 29393 (Sort)
                Node 29394 (Seq Scan) - LEAF
            Node 29395 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29388 | 29389, 29390 |
...
|------|------|--------|-----------|-----|--------|
| 29380 | Limit | 3044.71 | 1175.21 | 61.4% | operator |
| 29381 | Sort | 2928.56 | 1127.81 | 61.5% | operator |
| 29382 | Aggregate | 2928.51 | 1073.15 | 63.4% | operator |
| 29383 | Gather Merge | 2928.49 | 1073.95 | 63.3% | operator |
| 29384 | Incremental Sort | 2892.89 | 0.00 | 100.0% | operator |
| 29385 | Nested Loop | 2892.84 | 1111.34 | 61.6% | operator |
| 29386 | Merge Join | 2892.78 | 0.00 | 100.0% | operator |
| 29395 | Index Scan | 0.02 | 0.05 | 125.7% | operator |
| 29387 | Sort | 2842.39 | 1095.58 | 61.5% | operator |
| 29393 | Sort | 64.89 | 1074.66 | 1556.3% | operator |
| 29388 | Hash Join | 2842.37 | 471.07 | 83.4% | pattern |
| 29394 | Seq Scan | 53.74 | 18.25 | 66.1% | operator |
| 29391 | Aggregate | 2622.10 | 1073.15 | 59.1% | operator |
| 29392 | Index Scan | 2124.23 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29392 (Index Scan) - LEAF
...
### Step 3: Node 29388 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29389, 29390
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29394 (Seq Scan) - LEAF
...
### Step 7: Node 29386 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29395 (Index Scan) - LEAF
...
### Step 10: Node 29384 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29383 (Gather Merge)
