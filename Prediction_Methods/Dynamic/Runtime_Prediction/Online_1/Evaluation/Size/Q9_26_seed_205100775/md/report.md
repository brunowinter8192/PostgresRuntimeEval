    ...
    Node 17885 (Gather)
      Node 17886 (Aggregate)
        Node 17887 (Nested Loop)
          Node 17888 (Hash Join) [PATTERN: bb930825]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17888 | 17883, 17884, 17889, 17890, 17891 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17883 | 17884, 17888, 17889, 17890, 17891 |
...
|------|------|--------|-----------|-----|--------|
| 17883 | Sort | 1259.70 | 1045.59 | 17.0% | pattern |
| 17885 | Gather | 1258.53 | 964.55 | 23.4% | operator |
| 17886 | Aggregate | 1239.55 | 1085.45 | 12.4% | operator |
| 17887 | Nested Loop | 1214.62 | 1252.17 | 3.1% | operator |
| 17888 | Hash Join | 1043.47 | 134.80 | 87.1% | pattern |
| 17900 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17892 | Hash Join | 174.33 | 837.63 | 380.5% | operator |
| 17898 | Hash | 13.05 | 14.95 | 14.6% | operator |
| 17893 | Nested Loop | 166.78 | 1251.77 | 650.5% | operator |
| 17896 | Hash | 5.42 | 15.94 | 194.0% | operator |
| 17899 | Seq Scan | 13.04 | 2.94 | 77.5% | operator |
| 17894 | Seq Scan | 19.85 | 43.96 | 121.4% | operator |
| 17895 | Index Scan | 0.08 | -1.39 | 1814.2% | operator |
| 17897 | Seq Scan | 4.91 | 9.45 | 92.3% | operator |
...
### Step 9: Node 17888 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17883, 17884, 17889, 17890, 17891
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17900 (Index Scan) - LEAF
...
### Step 11: Node 17887 (Nested Loop)
...
### Step 14: Node 17883 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17884, 17888, 17889, 17890, 17891
- **Input Features:**
