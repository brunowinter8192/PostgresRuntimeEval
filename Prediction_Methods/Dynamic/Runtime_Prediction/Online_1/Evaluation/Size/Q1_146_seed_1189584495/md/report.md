...
**Test Query:** Q1_146_seed_1189584495
...
```
Node 251 (Aggregate) - ROOT
  Node 252 (Gather Merge)
    Node 253 (Sort) [PATTERN: 1d35fb97]
      Node 254 (Aggregate) [consumed]
        Node 255 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 253 | 254 |
...
|------|------|--------|-----------|-----|--------|
| 251 | Aggregate | 931.06 | 1195.96 | 28.5% | operator |
| 252 | Gather Merge | 930.99 | 1165.93 | 25.2% | operator |
| 253 | Sort | 911.23 | 1200.80 | 31.8% | pattern |
| 255 | Seq Scan | 505.09 | 679.13 | 34.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 255 (Seq Scan) - LEAF
...
### Step 2: Node 253 (Sort) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=169164.9500
  - Sort_total_cost=169164.9600
- **Output:** st=1196.71, rt=1200.80

### Step 3: Node 252 (Gather Merge)
...
### Step 4: Node 251 (Aggregate) - ROOT
