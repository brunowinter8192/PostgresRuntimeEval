...
**Test Query:** Q12_32_seed_254324961
...
```
Node 24845 (Aggregate) - ROOT
  Node 24846 (Gather Merge)
    Node 24847 (Aggregate)
      Node 24848 (Sort)
        Node 24849 (Nested Loop)
          Node 24850 (Seq Scan) - LEAF
          Node 24851 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24845 | Aggregate | 987.67 | 919.06 | 6.9% | operator |
| 24846 | Gather Merge | 987.65 | 1111.84 | 12.6% | operator |
| 24847 | Aggregate | 966.90 | 895.30 | 7.4% | operator |
| 24848 | Sort | 966.28 | 1092.82 | 13.1% | operator |
| 24849 | Nested Loop | 965.34 | 1127.41 | 16.8% | operator |
| 24850 | Seq Scan | 833.43 | 745.19 | 10.6% | operator |
| 24851 | Index Scan | 0.03 | 0.07 | 187.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24850 (Seq Scan) - LEAF
...
### Step 2: Node 24851 (Index Scan) - LEAF
...
### Step 6: Node 24846 (Gather Merge)
...
### Step 7: Node 24845 (Aggregate) - ROOT
