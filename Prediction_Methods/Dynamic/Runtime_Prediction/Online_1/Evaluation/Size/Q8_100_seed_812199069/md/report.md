...
|------|------|--------|-----------|-----|--------|
| 13201 | Aggregate | 1233.98 | 1195.83 | 3.1% | operator |
| 13202 | Gather Merge | 1233.55 | 1097.15 | 11.1% | operator |
...
| 13208 | Hash Join | 212.40 | 251.17 | 18.3% | operator |
...
| 13210 | Hash | 34.23 | 20.62 | 39.8% | operator |
| 13211 | Hash Join | 33.56 | 132.26 | 294.1% | operator |
| 13212 | Seq Scan | 31.98 | 23.03 | 28.0% | operator |
| 13213 | Hash | 0.26 | 23.66 | 8998.5% | operator |
| 13214 | Hash Join | 0.26 | 306.84 | 119291.4% | operator |
...
### Step 5: Node 13212 (Seq Scan) - LEAF
...
### Step 8: Node 13209 (Seq Scan) - LEAF
...
### Step 11: Node 13218 (Index Scan) - LEAF
...
### Step 12: Node 13220 (Seq Scan) - LEAF
...
### Step 13: Node 13207 (Nested Loop)
...
### Step 16: Node 13221 (Index Scan) - LEAF
...
### Step 17: Node 13223 (Seq Scan) - LEAF
...
### Step 18: Node 13205 (Nested Loop)
...
- **Input Features:**
  ...
  - st1=1044.9414
  - st2=0.0000
  - startup_cost=71545.3700
  - total_cost=71825.9900
