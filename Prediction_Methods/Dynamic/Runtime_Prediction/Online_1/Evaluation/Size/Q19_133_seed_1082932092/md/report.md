...
```
Node 31472 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31473 (Gather) [consumed]
    Node 31474 (Aggregate) [consumed]
      Node 31475 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31472 | 31473, 31474, 31475 |
...
|------|------|--------|-----------|-----|--------|
| 31472 | Aggregate | 898.21 | 829.29 | 7.7% | pattern |
| 31476 | Seq Scan | 826.14 | 743.46 | 10.0% | operator |
| 31477 | Hash | 49.46 | 8.29 | 83.2% | operator |
| 31478 | Seq Scan | 49.28 | 23.76 | 51.8% | operator |
...
### Step 4: Node 31472 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31473, 31474, 31475
- **Input Features:**
