...
Node 636 (Aggregate) - ROOT
  Node 637 (Gather Merge)
    Node 638 (Sort) [PATTERN: 1d35fb97]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 638 | 639 |
...
|------|------|--------|-----------|-----|--------|
| 636 | Aggregate | 937.80 | 1195.88 | 27.5% | operator |
| 637 | Gather Merge | 937.77 | 1165.90 | 24.3% | operator |
| 638 | Sort | 920.87 | 1200.49 | 30.4% | pattern |
| 640 | Seq Scan | 510.47 | 680.30 | 33.3% | operator |
...
### Step 2: Node 638 (Sort) - PATTERN ROOT
...
### Step 4: Node 636 (Aggregate) - ROOT
