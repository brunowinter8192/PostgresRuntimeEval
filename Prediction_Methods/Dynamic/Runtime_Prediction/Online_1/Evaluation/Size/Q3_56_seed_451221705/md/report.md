...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5361 | 5362, 5363, 5364, 5366, 5367, 5368 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5366 | 5361, 5362, 5363, 5364, 5367, 5368 |
...
| 5365 | Nested Loop | 1189.69 | 1192.83 | 0.3% | operator |
| 5366 | Hash Join | 213.12 | 242.43 | 13.8% | pattern |
...
- **Consumes:** Nodes 5361, 5362, 5363, 5364, 5367, 5368
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46572
  - HashJoin_nt1=233109
  ...
  - HashJoin_total_cost=37333.6600
  - Hash_Inner_np=0
  - Hash_Inner_nt=12487
...
### Step 3: Node 5370 (Index Scan) - LEAF
...
- **Output:** st=121.58, rt=1192.83

### Step 5: Node 5361 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5362, 5363, 5364, 5366, 5367, 5368
- **Input Features:**
