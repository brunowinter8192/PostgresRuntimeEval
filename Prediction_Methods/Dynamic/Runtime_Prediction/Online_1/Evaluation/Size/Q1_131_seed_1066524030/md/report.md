...
**Test Query:** Q1_131_seed_1066524030
...
```
Node 171 (Aggregate) - ROOT
  Node 172 (Gather Merge)
    Node 173 (Sort) [PATTERN: 1d35fb97]
      Node 174 (Aggregate) [consumed]
        Node 175 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 173 | 174 |
...
|------|------|--------|-----------|-----|--------|
| 171 | Aggregate | 919.12 | 1195.75 | 30.1% | operator |
| 172 | Gather Merge | 919.08 | 1165.87 | 26.9% | operator |
| 173 | Sort | 897.44 | 1199.99 | 33.7% | pattern |
| 175 | Seq Scan | 506.50 | 682.20 | 34.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 175 (Seq Scan) - LEAF
...
### Step 2: Node 173 (Sort) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Aggregate_Outer_nt1=1171832
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=236
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=168617.1600
  - Aggregate_Outer_total_cost=168617.2900
  - Sort_np=0
  - Sort_nt=6
  - Sort_nt1=6
  - Sort_nt2=0
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=168617.3700
  - Sort_total_cost=168617.3900
- **Output:** st=1195.89, rt=1199.99

### Step 3: Node 172 (Gather Merge)
...
- **Output:** st=1161.74, rt=1165.87

### Step 4: Node 171 (Aggregate) - ROOT
