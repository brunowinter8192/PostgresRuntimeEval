...
**Test Query:** Q7_93_seed_754770852
**Timestamp:** 2026-01-18 18:08:35
...
```
Node 13057 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 13058 (Gather Merge) [consumed]
    Node 13059 (Sort)
      Node 13060 (Hash Join)
        Node 13061 (Nested Loop)
          Node 13062 (Hash Join) [PATTERN: 895c6e8c]
            Node 13063 (Seq Scan) [consumed] - LEAF
            Node 13064 (Hash) [consumed]
              Node 13065 (Hash Join) [PATTERN: f4cb205a]
                Node 13066 (Seq Scan) [consumed] - LEAF
                Node 13067 (Hash) [consumed]
                  Node 13068 (Seq Scan) [consumed] - LEAF
          Node 13069 (Index Scan) - LEAF
        Node 13070 (Hash)
          Node 13071 (Hash Join) [PATTERN: f4cb205a]
            Node 13072 (Seq Scan) [consumed] - LEAF
            Node 13073 (Hash) [consumed]
              Node 13074 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 13065 | 13057, 13058, 13062, 13063, 13064, 13066, 13067, 13068, 13071, 13072, 13073, 13074 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 13071 | 13057, 13058, 13062, 13063, 13064, 13065, 13066, 13067, 13068, 13072, 13073, 13074 |
| Aggregate -> Gather Merge (Out | 2724c080 | 13057 | 13058, 13062, 13063, 13064, 13065, 13066, 13067, 13068, 13071, 13072, 13073, 13074 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 13062 | 13057, 13058, 13063, 13064, 13065, 13066, 13067, 13068, 13071, 13072, 13073, 13074 |
...
|------|------|--------|-----------|-----|--------|
| 13057 | Aggregate | 1182.96 | 1163.13 | 1.7% | pattern |
| 13059 | Sort | 1175.94 | 1109.16 | 5.7% | operator |
| 13060 | Hash Join | 1175.30 | 843.11 | 28.3% | operator |
| 13061 | Nested Loop | 1169.15 | 1215.99 | 4.0% | operator |
| 13070 | Hash | 2.47 | 27.74 | 1023.7% | operator |
| 13062 | Hash Join | 210.51 | 304.89 | 44.8% | pattern |
| 13069 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 13071 | Hash Join | 2.42 | 429.36 | 17627.6% | pattern |
| 13065 | Hash Join | 35.01 | 429.38 | 1126.4% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 13065 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 13057, 13058, 13062, 13063, 13064, 13066, 13067, 13068, 13071, 13072, 13073, 13074
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5000
  - HashJoin_nt1=62500
...
### Step 2: Node 13062 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 13057, 13058, 13063, 13064, 13065, 13066, 13067, 13068, 13071, 13072, 13073, 13074
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=38710
  - HashJoin_nt1=483871
...
### Step 3: Node 13069 (Index Scan) - LEAF
...
### Step 4: Node 13071 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 13057, 13058, 13062, 13063, 13064, 13065, 13066, 13067, 13068, 13072, 13073, 13074
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=800
  - HashJoin_nt1=10000
...
### Step 9: Node 13057 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 13058, 13062, 13063, 13064, 13065, 13066, 13067, 13068, 13071, 13072, 13073, 13074
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
