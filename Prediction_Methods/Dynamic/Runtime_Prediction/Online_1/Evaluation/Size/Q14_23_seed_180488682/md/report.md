...
```
Node 26875 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26876 (Gather) [consumed]
    Node 26877 (Aggregate) [consumed]
      Node 26878 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26875 | 26876, 26877, 26878 |
...
|------|------|--------|-----------|-----|--------|
| 26875 | Aggregate | 834.38 | 857.14 | 2.7% | pattern |
...
### Step 4: Node 26875 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26876, 26877, 26878
- **Input Features:**
