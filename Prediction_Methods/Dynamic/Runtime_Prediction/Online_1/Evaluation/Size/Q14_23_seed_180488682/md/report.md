...
**Test Query:** Q14_23_seed_180488682
...
```
Node 26875 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26876 (Gather) [consumed]
    Node 26877 (Aggregate) [consumed]
      Node 26878 (Hash Join)
        Node 26879 (Seq Scan) - LEAF
        Node 26880 (Hash)
          Node 26881 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26875 | 26876, 26877 |
...
|------|------|--------|-----------|-----|--------|
| 26875 | Aggregate | 834.38 | 848.38 | 1.7% | pattern |
| 26878 | Hash Join | 812.16 | 807.68 | 0.6% | operator |
| 26879 | Seq Scan | 761.13 | 758.51 | 0.3% | operator |
| 26880 | Hash | 43.13 | 9.38 | 78.3% | operator |
| 26881 | Seq Scan | 37.78 | 12.70 | 66.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26881 (Seq Scan) - LEAF
...
### Step 2: Node 26879 (Seq Scan) - LEAF
...
### Step 5: Node 26875 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26876, 26877
- **Input Features:**
