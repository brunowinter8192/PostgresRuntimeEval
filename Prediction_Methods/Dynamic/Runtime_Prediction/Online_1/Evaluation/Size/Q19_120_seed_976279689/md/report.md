...
**Test Query:** Q19_120_seed_976279689
...
```
Node 31374 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31375 (Gather) [consumed]
    Node 31376 (Aggregate) [consumed]
      Node 31377 (Hash Join) [consumed]
        Node 31378 (Seq Scan) - LEAF
        Node 31379 (Hash)
          Node 31380 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31374 | 31375, 31376, 31377 |
...
|------|------|--------|-----------|-----|--------|
| 31374 | Aggregate | 799.59 | 829.31 | 3.7% | pattern |
| 31378 | Seq Scan | 732.19 | 743.46 | 1.5% | operator |
| 31379 | Hash | 46.40 | 8.29 | 82.1% | operator |
| 31380 | Seq Scan | 46.25 | 23.76 | 48.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31380 (Seq Scan) - LEAF
...
### Step 2: Node 31378 (Seq Scan) - LEAF
...
### Step 4: Node 31374 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31375, 31376, 31377
- **Input Features:**
  ...
  - HashJoin_Outer_total_cost=156338.5500
