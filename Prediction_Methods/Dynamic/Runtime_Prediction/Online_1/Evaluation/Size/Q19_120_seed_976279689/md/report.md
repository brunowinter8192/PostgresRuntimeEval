...
```
Node 31374 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31375 (Gather) [consumed]
    Node 31376 (Aggregate) [consumed]
      Node 31377 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31374 | 31375, 31376 |
...
|------|------|--------|-----------|-----|--------|
| 31374 | Aggregate | 799.59 | 831.20 | 4.0% | pattern |
| 31377 | Hash Join | 780.38 | 766.06 | 1.8% | operator |
...
### Step 5: Node 31374 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31375, 31376
- **Input Features:**
