...
**Test Query:** Q13_86_seed_697342635
**Timestamp:** 2026-01-18 20:01:20
...
```
Node 26308 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26309 (Aggregate) [consumed]
    Node 26310 (Aggregate)
      Node 26311 (Hash Join) [PATTERN: 895c6e8c]
        Node 26312 (Seq Scan) [consumed] - LEAF
        Node 26313 (Hash) [consumed]
          Node 26314 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26308 | 26309, 26311, 26312, 26313 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26311 | 26308, 26309, 26312, 26313 |
...
|------|------|--------|-----------|-----|--------|
| 26308 | Sort | 947.83 | 1079.93 | 13.9% | pattern |
| 26310 | Aggregate | 941.71 | 999.15 | 6.1% | operator |
| 26311 | Hash Join | 727.14 | 470.31 | 35.3% | pattern |
| 26314 | Index Only Scan | 10.29 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26314 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26311 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26308, 26309, 26312, 26313
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1478958
...
### Step 4: Node 26308 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26309, 26311, 26312, 26313
- **Input Features:**
