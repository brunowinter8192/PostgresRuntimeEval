...
**Test Query:** Q9_51_seed_410201550
...
```
Node 18390 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18391 (Aggregate) [consumed]
    Node 18392 (Gather)
      Node 18393 (Aggregate)
        Node 18394 (Nested Loop)
          Node 18395 (Hash Join) [PATTERN: bb930825]
            Node 18396 (Seq Scan) [consumed] - LEAF
            Node 18397 (Hash) [consumed]
              Node 18398 (Hash Join) [consumed]
                Node 18399 (Hash Join)
                  Node 18400 (Nested Loop)
                    Node 18401 (Seq Scan) - LEAF
                    Node 18402 (Index Scan) - LEAF
                  Node 18403 (Hash)
                    Node 18404 (Seq Scan) - LEAF
                Node 18405 (Hash)
                  Node 18406 (Seq Scan) - LEAF
          Node 18407 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18395 | 18390, 18391, 18396, 18397, 18398 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18390 | 18391, 18395, 18396, 18397, 18398 |
...
|------|------|--------|-----------|-----|--------|
| 18390 | Sort | 1201.58 | 1045.59 | 13.0% | pattern |
| 18392 | Gather | 1200.28 | 964.55 | 19.6% | operator |
| 18393 | Aggregate | 1180.15 | 1085.45 | 8.0% | operator |
| 18394 | Nested Loop | 1155.68 | 1252.17 | 8.3% | operator |
| 18395 | Hash Join | 976.88 | 134.80 | 86.2% | pattern |
| 18407 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18399 | Hash Join | 154.09 | 837.63 | 443.6% | operator |
| 18405 | Hash | 13.51 | 14.95 | 10.6% | operator |
| 18400 | Nested Loop | 147.84 | 1251.77 | 746.7% | operator |
| 18403 | Hash | 4.12 | 15.94 | 286.9% | operator |
| 18406 | Seq Scan | 13.50 | 2.94 | 78.2% | operator |
| 18401 | Seq Scan | 19.88 | 43.96 | 121.2% | operator |
| 18402 | Index Scan | 0.07 | -1.39 | 2055.6% | operator |
| 18404 | Seq Scan | 3.41 | 9.45 | 177.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 18401 (Seq Scan) - LEAF
...
### Step 2: Node 18402 (Index Scan) - LEAF
...
### Step 3: Node 18404 (Seq Scan) - LEAF
...
### Step 6: Node 18406 (Seq Scan) - LEAF
...
### Step 9: Node 18395 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18390, 18391, 18396, 18397, 18398
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18407 (Index Scan) - LEAF
...
### Step 11: Node 18394 (Nested Loop)
...
### Step 14: Node 18390 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18391, 18395, 18396, 18397, 18398
- **Input Features:**
