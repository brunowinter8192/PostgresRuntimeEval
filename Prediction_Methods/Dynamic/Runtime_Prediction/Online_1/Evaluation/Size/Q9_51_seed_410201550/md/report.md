...
```
Node 18390 (Sort) - ROOT
  Node 18391 (Aggregate)
    Node 18392 (Gather)
      Node 18393 (Aggregate)
        Node 18394 (Nested Loop)
          Node 18395 (Hash Join)
            Node 18396 (Seq Scan) - LEAF
            Node 18397 (Hash)
              Node 18398 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 18390 | Sort | 1201.58 | 1119.81 | 6.8% | operator |
| 18391 | Aggregate | 1201.43 | 897.74 | 25.3% | operator |
...
| 18395 | Hash Join | 976.88 | 633.50 | 35.2% | operator |
| 18407 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18396 | Seq Scan | 710.98 | 509.93 | 28.3% | operator |
| 18397 | Hash | 170.47 | 48.03 | 71.8% | operator |
| 18398 | Hash Join | 168.24 | 924.48 | 449.5% | operator |
...
### Step 10: Node 18396 (Seq Scan) - LEAF
...
### Step 13: Node 18407 (Index Scan) - LEAF
...
### Step 14: Node 18394 (Nested Loop)
