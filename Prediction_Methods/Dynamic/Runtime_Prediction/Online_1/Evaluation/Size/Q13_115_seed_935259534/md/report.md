...
```
Node 25482 (Sort) - ROOT
  Node 25483 (Aggregate)
    Node 25484 (Aggregate)
      Node 25485 (Hash Join)
        Node 25486 (Seq Scan) - LEAF
        Node 25487 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 25482 | Sort | 940.59 | 1081.93 | 15.0% | operator |
| 25483 | Aggregate | 940.57 | 1000.33 | 6.4% | operator |
| 25484 | Aggregate | 934.45 | 1014.39 | 8.6% | operator |
| 25485 | Hash Join | 720.38 | 787.83 | 9.4% | operator |
| 25486 | Seq Scan | 507.99 | 264.19 | 48.0% | operator |
| 25487 | Hash | 15.40 | 80.15 | 420.3% | operator |
...
### Step 2: Node 25486 (Seq Scan) - LEAF
