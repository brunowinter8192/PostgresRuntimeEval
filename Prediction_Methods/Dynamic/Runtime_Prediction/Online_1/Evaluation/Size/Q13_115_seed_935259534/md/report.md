...
**Test Query:** Q13_115_seed_935259534
...
```
Node 25482 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25483 (Aggregate) [consumed]
    Node 25484 (Aggregate)
      Node 25485 (Hash Join) [PATTERN: 895c6e8c]
        Node 25486 (Seq Scan) [consumed] - LEAF
        Node 25487 (Hash) [consumed]
          Node 25488 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25482 | 25483, 25485, 25486, 25487 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25485 | 25482, 25483, 25486, 25487 |
...
|------|------|--------|-----------|-----|--------|
| 25482 | Sort | 940.59 | 1079.94 | 14.8% | pattern |
| 25484 | Aggregate | 934.45 | 999.76 | 7.0% | operator |
| 25485 | Hash Join | 720.38 | 470.31 | 34.7% | pattern |
| 25488 | Index Only Scan | 10.11 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25488 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25485 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25482, 25483, 25486, 25487
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 25482 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25483, 25485, 25486, 25487
- **Input Features:**
