...
**Test Query:** Q13_110_seed_894239379
...
```
Node 25447 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25448 (Aggregate) [consumed]
    Node 25449 (Aggregate)
      Node 25450 (Hash Join) [PATTERN: 895c6e8c]
        Node 25451 (Seq Scan) [consumed] - LEAF
        Node 25452 (Hash) [consumed]
          Node 25453 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25447 | 25448, 25450, 25451, 25452 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25450 | 25447, 25448, 25451, 25452 |
...
|------|------|--------|-----------|-----|--------|
| 25447 | Sort | 925.68 | 1079.93 | 16.7% | pattern |
| 25449 | Aggregate | 919.56 | 999.15 | 8.7% | operator |
| 25450 | Hash Join | 711.26 | 470.31 | 33.9% | pattern |
| 25453 | Index Only Scan | 9.76 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25453 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25450 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25447, 25448, 25451, 25452
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1478958
...
### Step 4: Node 25447 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25448, 25450, 25451, 25452
- **Input Features:**
