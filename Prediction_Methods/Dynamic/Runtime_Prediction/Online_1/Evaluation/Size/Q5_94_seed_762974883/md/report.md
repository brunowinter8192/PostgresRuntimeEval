...
```
Node 9761 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 9762 (Aggregate) [consumed]
    Node 9763 (Gather Merge) [consumed]
      Node 9764 (Aggregate)
        Node 9765 (Sort) [PATTERN: 3e2d5a00]
          Node 9766 (Hash Join) [consumed]
            Node 9767 (Nested Loop)
              Node 9768 (Hash Join)
                Node 9769 (Seq Scan) - LEAF
                Node 9770 (Hash) [PATTERN: 444761fb]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 9770 | 9761, 9762, 9763, 9765, 9766, 9771, 9772, 9773, 9774 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 9761 | 9762, 9763, 9765, 9766, 9770, 9771, 9772, 9773, 9774 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 9765 | 9761, 9762, 9763, 9766, 9770, 9771, 9772, 9773, 9774 |
...
|------|------|--------|-----------|-----|--------|
| 9761 | Sort | 1074.29 | 2934.42 | 173.2% | pattern |
| 9764 | Aggregate | 1067.29 | 1128.79 | 5.8% | operator |
| 9765 | Sort | 1067.04 | 1835.90 | 72.1% | pattern |
| 9767 | Nested Loop | 1056.50 | 1188.37 | 12.5% | operator |
| 9779 | Hash | 1.85 | 18.67 | 908.7% | operator |
| 9768 | Hash Join | 216.38 | 253.07 | 17.0% | operator |
| 9778 | Index Scan | 0.07 | -0.22 | 401.4% | operator |
| 9780 | Seq Scan | 1.36 | 12.36 | 810.1% | operator |
| 9769 | Seq Scan | 169.37 | 159.81 | 5.6% | operator |
| 9770 | Hash | 33.47 | 46.85 | 40.0% | pattern |
| 9775 | Seq Scan | 0.01 | 11.81 | 147503.4% | operator |
| 9776 | Hash | 0.05 | 21.05 | 40387.0% | operator |
| 9777 | Seq Scan | 0.05 | 22.93 | 45766.7% | operator |
...
- **Consumes:** Nodes 9761, 9762, 9763, 9765, 9766, 9771, 9772, 9773, 9774
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 11: Node 9765 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 9761, 9762, 9763, 9766, 9770, 9771, 9772, 9773, 9774
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 9761 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 9762, 9763, 9765, 9766, 9770, 9771, 9772, 9773, 9774
- **Input Features:**
