...
**Test Query:** Q3_77_seed_623506356
...
```
Node 5591 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5592 (Sort) [consumed]
    Node 5593 (Aggregate) [consumed]
      Node 5594 (Gather) [consumed]
        Node 5595 (Nested Loop)
          Node 5596 (Hash Join) [PATTERN: 895c6e8c]
            Node 5597 (Seq Scan) [consumed] - LEAF
            Node 5598 (Hash) [consumed]
              Node 5599 (Seq Scan) - LEAF
          Node 5600 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5591 | 5592, 5593, 5594, 5596, 5597, 5598 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5596 | 5591, 5592, 5593, 5594, 5597, 5598 |
...
|------|------|--------|-----------|-----|--------|
| 5591 | Limit | 1188.34 | 1151.18 | 3.1% | pattern |
| 5595 | Nested Loop | 1152.45 | 1193.26 | 3.5% | operator |
| 5596 | Hash Join | 213.07 | 242.52 | 13.8% | pattern |
| 5600 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5599 | Seq Scan | 30.99 | 38.57 | 24.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5599 (Seq Scan) - LEAF
...
### Step 2: Node 5596 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5591, 5592, 5593, 5594, 5597, 5598
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47245
  - HashJoin_nt1=236474
  ...
  - HashJoin_total_cost=37342.4900
  - Hash_Inner_np=0
  - Hash_Inner_nt=12487
...
- **Output:** st=29.70, rt=242.52

### Step 3: Node 5600 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=73067.0400
- **Output:** st=122.01, rt=1193.26

### Step 5: Node 5591 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5592, 5593, 5594, 5596, 5597, 5598
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=313690
  - Aggregate_Outer_nt1=313690
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110141.3900
  - Aggregate_Outer_total_cost=114062.5100
  - Gather_Outer_np=0
  - Gather_Outer_nt=313690
  - Gather_Outer_nt1=101190
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105436.0400
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=313690
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=120841.2400
  - Limit_total_cost=120841.2600
  - Sort_Outer_np=0
  - Sort_Outer_nt=313690
  - Sort_Outer_nt1=313690
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=120841.2400
  - Sort_Outer_total_cost=121625.4600
