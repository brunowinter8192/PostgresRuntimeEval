...
```
Node 31990 (Aggregate) [PATTERN: efde8b38] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31990 | 31991, 31992, 31993 |
...
|------|------|--------|-----------|-----|--------|
| 31990 | Aggregate | 840.70 | 829.28 | 1.4% | pattern |
...
### Step 4: Node 31990 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31991, 31992, 31993
- **Input Features:**
