...
**Test Query:** Q1_116_seed_943463565
...
```
Node 86 (Aggregate) - ROOT
  Node 87 (Gather Merge)
    Node 88 (Sort) [PATTERN: 1d35fb97]
      Node 89 (Aggregate) [consumed]
        Node 90 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 88 | 89 |
...
|------|------|--------|-----------|-----|--------|
| 86 | Aggregate | 1000.00 | 1195.89 | 19.6% | operator |
| 87 | Gather Merge | 999.94 | 1165.91 | 16.6% | operator |
| 88 | Sort | 981.96 | 1200.51 | 22.3% | pattern |
| 90 | Seq Scan | 567.46 | 680.23 | 19.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 90 (Seq Scan) - LEAF
...
### Step 2: Node 88 (Sort) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Aggregate_Outer_nt1=1181913
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=236
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=168969.9900
  - Aggregate_Outer_total_cost=168970.1300
  - Sort_np=0
  - Sort_nt=6
  - Sort_nt1=6
  - Sort_nt2=0
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=168970.2100
  - Sort_total_cost=168970.2200
- **Output:** st=1196.42, rt=1200.51

### Step 3: Node 87 (Gather Merge)
...
- **Output:** st=1161.78, rt=1165.91

### Step 4: Node 86 (Aggregate) - ROOT
