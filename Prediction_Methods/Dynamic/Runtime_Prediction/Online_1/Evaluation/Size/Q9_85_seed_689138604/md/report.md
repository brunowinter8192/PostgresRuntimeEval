...
```
Node 19062 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 19063 (Aggregate) [consumed]
    Node 19064 (Gather)
      Node 19065 (Aggregate)
        Node 19066 (Nested Loop)
          Node 19067 (Hash Join) [PATTERN: bb930825]
            Node 19068 (Seq Scan) [consumed] - LEAF
            Node 19069 (Hash) [consumed]
              Node 19070 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 19067 | 19062, 19063, 19068, 19069, 19070 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 19062 | 19063, 19067, 19068, 19069, 19070 |
...
|------|------|--------|-----------|-----|--------|
| 19062 | Sort | 1251.73 | 1045.32 | 16.5% | pattern |
...
| 19067 | Hash Join | 1024.22 | 134.80 | 86.8% | pattern |
...
### Step 9: Node 19067 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 19062, 19063, 19068, 19069, 19070
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 19079 (Index Scan) - LEAF
...
### Step 11: Node 19066 (Nested Loop)
...
### Step 14: Node 19062 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 19063, 19067, 19068, 19069, 19070
- **Input Features:**
