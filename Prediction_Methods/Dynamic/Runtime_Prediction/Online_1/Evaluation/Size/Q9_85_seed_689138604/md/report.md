...
**Test Query:** Q9_85_seed_689138604
...
```
Node 19062 (Sort) - ROOT
  Node 19063 (Aggregate)
    Node 19064 (Gather)
      Node 19065 (Aggregate)
        Node 19066 (Nested Loop)
          Node 19067 (Hash Join)
            Node 19068 (Seq Scan) - LEAF
            Node 19069 (Hash)
              Node 19070 (Hash Join)
                Node 19071 (Hash Join)
                  Node 19072 (Nested Loop)
                    Node 19073 (Seq Scan) - LEAF
                    Node 19074 (Index Scan) - LEAF
                  Node 19075 (Hash)
                    Node 19076 (Seq Scan) - LEAF
                Node 19077 (Hash)
                  Node 19078 (Seq Scan) - LEAF
          Node 19079 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 19062 | Sort | 1251.73 | 1119.51 | 10.6% | operator |
| 19063 | Aggregate | 1251.59 | 897.44 | 28.3% | operator |
| 19064 | Gather | 1250.54 | 964.64 | 22.9% | operator |
| 19065 | Aggregate | 1230.40 | 1095.61 | 11.0% | operator |
| 19066 | Nested Loop | 1206.41 | 1252.17 | 3.8% | operator |
| 19067 | Hash Join | 1024.22 | 633.32 | 38.2% | operator |
| 19079 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 19068 | Seq Scan | 750.87 | 509.93 | 32.1% | operator |
| 19069 | Hash | 179.09 | 47.91 | 73.2% | operator |
| 19070 | Hash Join | 177.47 | 924.43 | 420.9% | operator |
| 19071 | Hash Join | 161.63 | 837.61 | 418.2% | operator |
| 19077 | Hash | 15.23 | 14.95 | 1.8% | operator |
| 19072 | Nested Loop | 156.34 | 1251.77 | 700.6% | operator |
| 19075 | Hash | 3.18 | 15.94 | 401.8% | operator |
| 19078 | Seq Scan | 15.21 | 2.94 | 80.7% | operator |
| 19073 | Seq Scan | 18.83 | 44.03 | 133.9% | operator |
| 19074 | Index Scan | 0.07 | -1.39 | 1951.3% | operator |
| 19076 | Seq Scan | 2.67 | 9.45 | 254.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 19073 (Seq Scan) - LEAF
...
### Step 2: Node 19074 (Index Scan) - LEAF
...
### Step 3: Node 19076 (Seq Scan) - LEAF
...
### Step 6: Node 19078 (Seq Scan) - LEAF
...
### Step 10: Node 19068 (Seq Scan) - LEAF
...
### Step 13: Node 19079 (Index Scan) - LEAF
...
### Step 14: Node 19066 (Nested Loop)
