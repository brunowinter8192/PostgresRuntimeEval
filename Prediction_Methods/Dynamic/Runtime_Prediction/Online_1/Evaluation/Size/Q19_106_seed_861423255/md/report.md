...
```
Node 31262 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31263 (Gather) [consumed]
    Node 31264 (Aggregate) [consumed]
      Node 31265 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31262 | 31263, 31264, 31265 |
...
|------|------|--------|-----------|-----|--------|
| 31262 | Aggregate | 843.01 | 829.28 | 1.6% | pattern |
...
### Step 4: Node 31262 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31263, 31264, 31265
- **Input Features:**
