...
**Test Query:** Q19_106_seed_861423255
...
```
Node 31262 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31263 (Gather) [consumed]
    Node 31264 (Aggregate) [consumed]
      Node 31265 (Hash Join)
        Node 31266 (Seq Scan) - LEAF
        Node 31267 (Hash)
          Node 31268 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31262 | 31263, 31264 |
...
|------|------|--------|-----------|-----|--------|
| 31262 | Aggregate | 843.01 | 831.20 | 1.4% | pattern |
| 31265 | Hash Join | 824.86 | 766.05 | 7.1% | operator |
| 31266 | Seq Scan | 776.15 | 743.46 | 4.2% | operator |
| 31267 | Hash | 46.97 | 8.29 | 82.4% | operator |
| 31268 | Seq Scan | 46.83 | 23.76 | 49.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31268 (Seq Scan) - LEAF
...
### Step 2: Node 31266 (Seq Scan) - LEAF
...
### Step 5: Node 31262 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31263, 31264
- **Input Features:**
