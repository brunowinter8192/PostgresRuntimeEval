...
**Test Query:** Q13_112_seed_910647441
...
```
Node 25461 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25462 (Aggregate) [consumed]
    Node 25463 (Aggregate)
      Node 25464 (Hash Join) [PATTERN: 895c6e8c]
        Node 25465 (Seq Scan) [consumed] - LEAF
        Node 25466 (Hash) [consumed]
          Node 25467 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25461 | 25462, 25464, 25465, 25466 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25464 | 25461, 25462, 25465, 25466 |
...
|------|------|--------|-----------|-----|--------|
| 25461 | Sort | 929.94 | 1079.94 | 16.1% | pattern |
| 25463 | Aggregate | 923.83 | 999.76 | 8.2% | operator |
| 25464 | Hash Join | 713.59 | 470.31 | 34.1% | pattern |
| 25467 | Index Only Scan | 10.18 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25467 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25464 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25461, 25462, 25465, 25466
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 25461 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25462, 25464, 25465, 25466
- **Input Features:**
