...
**Test Query:** Q12_120_seed_976279689
...
```
Node 24474 (Aggregate) - ROOT
  Node 24475 (Gather Merge)
    Node 24476 (Aggregate)
      Node 24477 (Sort)
        Node 24478 (Nested Loop)
          Node 24479 (Seq Scan) - LEAF
          Node 24480 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24474 | Aggregate | 984.09 | 919.05 | 6.6% | operator |
| 24475 | Gather Merge | 984.07 | 1111.84 | 13.0% | operator |
| 24476 | Aggregate | 964.82 | 895.30 | 7.2% | operator |
| 24477 | Sort | 964.20 | 1092.82 | 13.3% | operator |
| 24478 | Nested Loop | 963.26 | 1127.41 | 17.0% | operator |
| 24479 | Seq Scan | 824.12 | 745.19 | 9.6% | operator |
| 24480 | Index Scan | 0.03 | 0.07 | 166.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24479 (Seq Scan) - LEAF
...
### Step 2: Node 24480 (Index Scan) - LEAF
...
### Step 6: Node 24475 (Gather Merge)
...
### Step 7: Node 24474 (Aggregate) - ROOT
