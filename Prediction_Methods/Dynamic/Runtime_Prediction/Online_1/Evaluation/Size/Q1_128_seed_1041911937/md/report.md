...
Node 151 (Aggregate) - ROOT
  Node 152 (Gather Merge)
    Node 153 (Sort) [PATTERN: 1d35fb97]
      Node 154 (Aggregate) [consumed]
        Node 155 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 153 | 154 |
...
|------|------|--------|-----------|-----|--------|
| 151 | Aggregate | 936.63 | 1195.86 | 27.7% | operator |
| 152 | Gather Merge | 936.58 | 1165.90 | 24.5% | operator |
| 153 | Sort | 917.24 | 1200.39 | 30.9% | pattern |
| 155 | Seq Scan | 500.15 | 680.68 | 36.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 155 (Seq Scan) - LEAF
...
### Step 2: Node 153 (Sort) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=168890.0200
  - Sort_total_cost=168890.0400
- **Output:** st=1196.30, rt=1200.39

### Step 3: Node 152 (Gather Merge)
...
### Step 4: Node 151 (Aggregate) - ROOT
