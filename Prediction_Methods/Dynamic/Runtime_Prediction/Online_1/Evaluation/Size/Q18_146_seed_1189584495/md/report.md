...
**Test Query:** Q18_146_seed_1189584495
...
```
Node 29620 (Limit) - ROOT
  Node 29621 (Sort)
    Node 29622 (Aggregate)
      Node 29623 (Gather Merge)
        Node 29624 (Incremental Sort)
          Node 29625 (Nested Loop)
            Node 29626 (Merge Join)
              Node 29627 (Sort)
                Node 29628 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29629 (Seq Scan) [consumed] - LEAF
                  Node 29630 (Hash) [consumed]
                    Node 29631 (Aggregate)
                      Node 29632 (Index Scan) - LEAF
              Node 29633 (Sort)
                Node 29634 (Seq Scan) - LEAF
            Node 29635 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29628 | 29629, 29630 |
...
|------|------|--------|-----------|-----|--------|
| 29620 | Limit | 3026.86 | 1175.21 | 61.2% | operator |
| 29621 | Sort | 2915.16 | 1127.81 | 61.3% | operator |
| 29622 | Aggregate | 2915.11 | 1073.15 | 63.2% | operator |
| 29623 | Gather Merge | 2915.10 | 1073.95 | 63.2% | operator |
| 29624 | Incremental Sort | 2896.55 | 0.00 | 100.0% | operator |
| 29625 | Nested Loop | 2896.50 | 1111.34 | 61.6% | operator |
| 29626 | Merge Join | 2896.44 | 0.00 | 100.0% | operator |
| 29635 | Index Scan | 0.02 | 0.05 | 105.2% | operator |
| 29627 | Sort | 2828.17 | 1095.58 | 61.3% | operator |
| 29633 | Sort | 65.55 | 1074.66 | 1539.4% | operator |
| 29628 | Hash Join | 2828.15 | 471.07 | 83.3% | pattern |
| 29634 | Seq Scan | 54.04 | 18.25 | 66.2% | operator |
| 29631 | Aggregate | 2602.70 | 1073.15 | 58.8% | operator |
| 29632 | Index Scan | 2112.64 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29632 (Index Scan) - LEAF
...
### Step 3: Node 29628 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29629, 29630
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29634 (Seq Scan) - LEAF
...
### Step 7: Node 29626 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29635 (Index Scan) - LEAF
...
### Step 10: Node 29624 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29623 (Gather Merge)
