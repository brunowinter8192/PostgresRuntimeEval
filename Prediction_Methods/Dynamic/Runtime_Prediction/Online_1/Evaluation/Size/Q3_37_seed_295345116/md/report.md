...
**Test Query:** Q3_37_seed_295345116
...
```
Node 5151 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5152 (Sort) [consumed]
    Node 5153 (Aggregate) [consumed]
      Node 5154 (Gather) [consumed]
        Node 5155 (Nested Loop)
          Node 5156 (Hash Join) [PATTERN: 895c6e8c]
            Node 5157 (Seq Scan) [consumed] - LEAF
            Node 5158 (Hash) [consumed]
              Node 5159 (Seq Scan) - LEAF
          Node 5160 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5151 | 5152, 5153, 5154, 5156, 5157, 5158 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5156 | 5151, 5152, 5153, 5154, 5157, 5158 |
...
|------|------|--------|-----------|-----|--------|
| 5151 | Limit | 1182.98 | 1151.18 | 2.7% | pattern |
| 5155 | Nested Loop | 1141.66 | 1193.04 | 4.5% | operator |
| 5156 | Hash Join | 199.77 | 242.47 | 21.4% | pattern |
| 5160 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5159 | Seq Scan | 25.78 | 38.57 | 49.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5159 (Seq Scan) - LEAF
...
### Step 2: Node 5156 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5151, 5152, 5153, 5154, 5157, 5158
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46904
  - HashJoin_nt1=234768
  ...
  - HashJoin_total_cost=37338.0100
  - Hash_Inner_np=0
  - Hash_Inner_nt=12487
...
- **Input Features:**
  ...
  - total_cost=72870.7300
- **Output:** st=121.80, rt=1193.04

### Step 5: Node 5151 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5152, 5153, 5154, 5156, 5157, 5158
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=313209
  - Aggregate_Outer_nt1=313209
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=109889.7700
  - Aggregate_Outer_total_cost=113804.8800
  - Gather_Outer_np=0
  - Gather_Outer_nt=313209
  - Gather_Outer_nt1=101035
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105191.6300
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=313209
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=120573.2100
  - Limit_total_cost=120573.2400
  - Sort_Outer_np=0
  - Sort_Outer_nt=313209
  - Sort_Outer_nt1=313209
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=120573.2100
  - Sort_Outer_total_cost=121356.2400
