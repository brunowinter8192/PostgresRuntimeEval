...
**Test Query:** Q5_148_seed_1205992557
...
```
Node 7941 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 7942 (Aggregate) [consumed]
    Node 7943 (Gather Merge) [consumed]
      Node 7944 (Aggregate)
        Node 7945 (Sort) [PATTERN: 3e2d5a00]
          Node 7946 (Hash Join) [consumed]
            Node 7947 (Nested Loop)
              Node 7948 (Hash Join)
                Node 7949 (Seq Scan) - LEAF
                Node 7950 (Hash) [PATTERN: 444761fb]
                  Node 7951 (Hash Join) [consumed]
                    Node 7952 (Seq Scan) [consumed] - LEAF
                    Node 7953 (Hash) [consumed]
                      Node 7954 (Hash Join) [consumed]
                        Node 7955 (Seq Scan) - LEAF
                        Node 7956 (Hash)
                          Node 7957 (Seq Scan) - LEAF
              Node 7958 (Index Scan) - LEAF
            Node 7959 (Hash)
              Node 7960 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 7950 | 7941, 7942, 7943, 7945, 7946, 7951, 7952, 7953, 7954 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 7941 | 7942, 7943, 7945, 7946, 7950, 7951, 7952, 7953, 7954 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 7945 | 7941, 7942, 7943, 7946, 7950, 7951, 7952, 7953, 7954 |
...
|------|------|--------|-----------|-----|--------|
| 7941 | Sort | 1036.97 | 2934.42 | 183.0% | pattern |
| 7944 | Aggregate | 1030.43 | 1128.78 | 9.5% | operator |
| 7945 | Sort | 1030.16 | 1835.92 | 78.2% | pattern |
| 7947 | Nested Loop | 1017.94 | 1188.42 | 16.7% | operator |
| 7959 | Hash | 3.83 | 18.67 | 388.1% | operator |
| 7948 | Hash Join | 208.52 | 253.07 | 21.4% | operator |
| 7958 | Index Scan | 0.07 | -0.22 | 405.6% | operator |
| 7960 | Seq Scan | 2.89 | 12.36 | 327.1% | operator |
| 7949 | Seq Scan | 164.69 | 159.81 | 3.0% | operator |
| 7950 | Hash | 31.63 | 46.85 | 48.1% | pattern |
| 7955 | Seq Scan | 0.01 | 11.81 | 78621.8% | operator |
| 7956 | Hash | 0.06 | 21.05 | 35583.5% | operator |
| 7957 | Seq Scan | 0.05 | 22.93 | 42369.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 7957 (Seq Scan) - LEAF
...
### Step 2: Node 7955 (Seq Scan) - LEAF
...
### Step 4: Node 7949 (Seq Scan) - LEAF
...
### Step 5: Node 7950 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 7941, 7942, 7943, 7945, 7946, 7951, 7952, 7953, 7954
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 7958 (Index Scan) - LEAF
...
### Step 8: Node 7960 (Seq Scan) - LEAF
...
### Step 11: Node 7945 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 7941, 7942, 7943, 7946, 7950, 7951, 7952, 7953, 7954
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 7941 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 7942, 7943, 7945, 7946, 7950, 7951, 7952, 7953, 7954
- **Input Features:**
