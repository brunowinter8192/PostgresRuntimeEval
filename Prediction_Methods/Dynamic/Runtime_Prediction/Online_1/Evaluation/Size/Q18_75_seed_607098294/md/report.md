...
**Test Query:** Q18_75_seed_607098294
**Timestamp:** 2026-01-18 20:24:17
...
```
Node 30772 (Limit) - ROOT
  Node 30773 (Sort)
    Node 30774 (Aggregate)
      Node 30775 (Gather Merge)
        Node 30776 (Incremental Sort)
          Node 30777 (Nested Loop)
            Node 30778 (Merge Join)
              Node 30779 (Sort)
                Node 30780 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30781 (Seq Scan) [consumed] - LEAF
                  Node 30782 (Hash) [consumed]
                    Node 30783 (Aggregate)
                      Node 30784 (Index Scan) - LEAF
              Node 30785 (Sort)
                Node 30786 (Seq Scan) - LEAF
            Node 30787 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30780 | 30781, 30782 |
...
|------|------|--------|-----------|-----|--------|
| 30772 | Limit | 3065.36 | 1175.21 | 61.7% | operator |
| 30773 | Sort | 2944.78 | 1127.81 | 61.7% | operator |
| 30774 | Aggregate | 2944.74 | 1073.15 | 63.6% | operator |
| 30775 | Gather Merge | 2944.70 | 1073.95 | 63.5% | operator |
| 30776 | Incremental Sort | 2906.73 | 0.00 | 100.0% | operator |
| 30777 | Nested Loop | 2906.69 | 1111.34 | 61.8% | operator |
| 30778 | Merge Join | 2906.63 | 0.00 | 100.0% | operator |
| 30787 | Index Scan | 0.02 | 0.05 | 125.7% | operator |
| 30779 | Sort | 2855.80 | 1095.58 | 61.6% | operator |
| 30785 | Sort | 64.78 | 1074.66 | 1558.8% | operator |
| 30780 | Hash Join | 2855.78 | 471.07 | 83.5% | pattern |
| 30786 | Seq Scan | 52.63 | 18.25 | 65.3% | operator |
| 30783 | Aggregate | 2620.65 | 1073.15 | 59.1% | operator |
| 30784 | Index Scan | 2122.53 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30784 (Index Scan) - LEAF
...
### Step 3: Node 30780 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30781, 30782
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30786 (Seq Scan) - LEAF
...
### Step 7: Node 30778 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30787 (Index Scan) - LEAF
...
### Step 10: Node 30776 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30775 (Gather Merge)
