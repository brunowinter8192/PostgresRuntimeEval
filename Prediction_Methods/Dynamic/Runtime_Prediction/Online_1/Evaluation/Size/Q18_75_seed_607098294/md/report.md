        ...
        Node 30776 (Incremental Sort)
          Node 30777 (Nested Loop)
            Node 30778 (Merge Join)
              Node 30779 (Sort)
                Node 30780 (Hash Join)
                  Node 30781 (Seq Scan) - LEAF
                  Node 30782 (Hash)
...
| 30779 | Sort | 2855.80 | 1099.77 | 61.5% | operator |
| 30785 | Sort | 64.78 | 1074.66 | 1558.8% | operator |
| 30780 | Hash Join | 2855.78 | 686.33 | 76.0% | operator |
| 30786 | Seq Scan | 52.63 | 18.25 | 65.3% | operator |
| 30781 | Seq Scan | 206.08 | 170.37 | 17.3% | operator |
| 30782 | Hash | 2620.69 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30781 (Seq Scan) - LEAF
...
### Step 6: Node 30786 (Seq Scan) - LEAF
...
### Step 9: Node 30778 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30787 (Index Scan) - LEAF
...
### Step 11: Node 30777 (Nested Loop)
...
### Step 12: Node 30776 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30775 (Gather Merge)
