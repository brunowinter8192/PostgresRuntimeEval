...
**Test Query:** Q13_134_seed_1091136123
...
```
Node 25629 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25630 (Aggregate) [consumed]
    Node 25631 (Aggregate)
      Node 25632 (Hash Join) [PATTERN: 895c6e8c]
        Node 25633 (Seq Scan) [consumed] - LEAF
        Node 25634 (Hash) [consumed]
          Node 25635 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25629 | 25630, 25632, 25633, 25634 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25632 | 25629, 25630, 25633, 25634 |
...
|------|------|--------|-----------|-----|--------|
| 25629 | Sort | 905.57 | 1079.93 | 19.3% | pattern |
| 25631 | Aggregate | 899.27 | 999.55 | 11.2% | operator |
| 25632 | Hash Join | 687.08 | 470.31 | 31.5% | pattern |
| 25635 | Index Only Scan | 10.26 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25635 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25632 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25629, 25630, 25633, 25634
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1484970
...
### Step 4: Node 25629 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25630, 25632, 25633, 25634
- **Input Features:**
