...
```
Node 11437 (Aggregate) - ROOT
  Node 11438 (Gather Merge)
    Node 11439 (Sort)
      Node 11440 (Hash Join)
        Node 11441 (Nested Loop)
          Node 11442 (Hash Join)
            Node 11443 (Seq Scan) - LEAF
            Node 11444 (Hash)
              Node 11445 (Hash Join)
                Node 11446 (Seq Scan) - LEAF
                Node 11447 (Hash)
                  Node 11448 (Seq Scan) - LEAF
          Node 11449 (Index Scan) - LEAF
        Node 11450 (Hash)
          Node 11451 (Hash Join)
            Node 11452 (Seq Scan) - LEAF
            Node 11453 (Hash)
              Node 11454 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 11437 | Aggregate | 1221.31 | 1209.26 | 1.0% | operator |
| 11438 | Gather Merge | 1220.28 | 1142.98 | 6.3% | operator |
| 11439 | Sort | 1212.18 | 1109.13 | 8.5% | operator |
| 11440 | Hash Join | 1211.54 | 842.59 | 30.5% | operator |
| 11441 | Nested Loop | 1206.08 | 1216.16 | 0.8% | operator |
| 11450 | Hash | 1.74 | 17.53 | 908.0% | operator |
| 11442 | Hash Join | 214.08 | 384.47 | 79.6% | operator |
| 11449 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 11451 | Hash Join | 1.69 | 85.17 | 4928.0% | operator |
| 11443 | Seq Scan | 151.57 | 201.16 | 32.7% | operator |
| 11444 | Hash | 34.37 | 19.59 | 43.0% | operator |
| 11452 | Seq Scan | 1.37 | 11.47 | 736.7% | operator |
| 11453 | Hash | 0.01 | 16.89 | 112527.2% | operator |
| 11445 | Hash Join | 33.91 | 92.20 | 171.9% | operator |
| 11454 | Seq Scan | 0.01 | 45.79 | 381502.6% | operator |
| 11446 | Seq Scan | 32.80 | 21.86 | 33.4% | operator |
| 11447 | Hash | 0.02 | 16.89 | 73352.5% | operator |
| 11448 | Seq Scan | 0.02 | 45.79 | 240912.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11448 (Seq Scan) - LEAF
...
### Step 2: Node 11446 (Seq Scan) - LEAF
...
### Step 5: Node 11454 (Seq Scan) - LEAF
...
### Step 6: Node 11443 (Seq Scan) - LEAF
...
### Step 8: Node 11452 (Seq Scan) - LEAF
...
### Step 11: Node 11449 (Index Scan) - LEAF
...
### Step 13: Node 11441 (Nested Loop)
...
### Step 17: Node 11438 (Gather Merge)
...
### Step 18: Node 11437 (Aggregate) - ROOT
