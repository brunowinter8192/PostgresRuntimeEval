...
**Test Query:** Q7_148_seed_1205992557
**Timestamp:** 2026-01-18 17:51:24
...
```
Node 11437 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 11438 (Gather Merge) [consumed]
    Node 11439 (Sort)
      Node 11440 (Hash Join)
        Node 11441 (Nested Loop)
          Node 11442 (Hash Join) [PATTERN: 895c6e8c]
            Node 11443 (Seq Scan) [consumed] - LEAF
            Node 11444 (Hash) [consumed]
              Node 11445 (Hash Join) [PATTERN: f4cb205a]
                Node 11446 (Seq Scan) [consumed] - LEAF
                Node 11447 (Hash) [consumed]
                  Node 11448 (Seq Scan) [consumed] - LEAF
          Node 11449 (Index Scan) - LEAF
        Node 11450 (Hash)
          Node 11451 (Hash Join) [PATTERN: f4cb205a]
            Node 11452 (Seq Scan) [consumed] - LEAF
            Node 11453 (Hash) [consumed]
              Node 11454 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 11445 | 11437, 11438, 11442, 11443, 11444, 11446, 11447, 11448, 11451, 11452, 11453, 11454 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 11451 | 11437, 11438, 11442, 11443, 11444, 11445, 11446, 11447, 11448, 11452, 11453, 11454 |
| Aggregate -> Gather Merge (Out | 2724c080 | 11437 | 11438, 11442, 11443, 11444, 11445, 11446, 11447, 11448, 11451, 11452, 11453, 11454 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 11442 | 11437, 11438, 11443, 11444, 11445, 11446, 11447, 11448, 11451, 11452, 11453, 11454 |
...
|------|------|--------|-----------|-----|--------|
| 11437 | Aggregate | 1221.31 | 1163.13 | 4.8% | pattern |
| 11439 | Sort | 1212.18 | 1109.16 | 8.5% | operator |
| 11440 | Hash Join | 1211.54 | 843.11 | 30.4% | operator |
| 11441 | Nested Loop | 1206.08 | 1215.99 | 0.8% | operator |
| 11450 | Hash | 1.74 | 27.74 | 1495.4% | operator |
| 11442 | Hash Join | 214.08 | 304.89 | 42.4% | pattern |
| 11449 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 11451 | Hash Join | 1.69 | 429.36 | 25246.1% | pattern |
| 11445 | Hash Join | 33.91 | 429.38 | 1166.2% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11445 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 11437, 11438, 11442, 11443, 11444, 11446, 11447, 11448, 11451, 11452, 11453, 11454
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5000
  - HashJoin_nt1=62500
...
### Step 2: Node 11442 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 11437, 11438, 11443, 11444, 11445, 11446, 11447, 11448, 11451, 11452, 11453, 11454
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=38710
  - HashJoin_nt1=483871
...
### Step 3: Node 11449 (Index Scan) - LEAF
...
### Step 4: Node 11451 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 11437, 11438, 11442, 11443, 11444, 11445, 11446, 11447, 11448, 11452, 11453, 11454
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=800
  - HashJoin_nt1=10000
...
### Step 9: Node 11437 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 11438, 11442, 11443, 11444, 11445, 11446, 11447, 11448, 11451, 11452, 11453, 11454
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
