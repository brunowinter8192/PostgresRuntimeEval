...
**Test Query:** Q4_149_seed_1214196588
...
```
Node 6222 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6223 (Gather Merge) [consumed]
    Node 6224 (Sort) [consumed]
      Node 6225 (Aggregate) [consumed]
        Node 6226 (Nested Loop)
          Node 6227 (Seq Scan) - LEAF
          Node 6228 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6222 | 6223, 6224, 6225 |
...
|------|------|--------|-----------|-----|--------|
| 6222 | Aggregate | 1070.82 | 952.19 | 11.1% | pattern |
| 6226 | Nested Loop | 1063.58 | 1255.45 | 18.0% | operator |
| 6227 | Seq Scan | 162.44 | 154.66 | 4.8% | operator |
| 6228 | Index Scan | 0.06 | 11.10 | 17526.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6227 (Seq Scan) - LEAF
...
### Step 2: Node 6228 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - Aggregate_total_cost=66919.8500
  ...
  - GatherMerge_Outer_total_cost=66919.7300
  - Sort_Outer_np=0
  - Sort_Outer_nt=5
  - Sort_Outer_nt1=5
  - Sort_Outer_nt2=0
  ...
  - Sort_Outer_startup_cost=65917.9100
  - Sort_Outer_total_cost=65917.9300
