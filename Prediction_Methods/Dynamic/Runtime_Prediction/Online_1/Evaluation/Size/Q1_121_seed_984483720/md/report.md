...
**Test Query:** Q1_121_seed_984483720
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 118 | 119 |
...
|------|------|--------|-----------|-----|--------|
| 116 | Aggregate | 1050.73 | 1195.72 | 13.8% | operator |
| 117 | Gather Merge | 1050.65 | 1165.86 | 11.0% | operator |
| 118 | Sort | 1030.60 | 1199.87 | 16.4% | pattern |
| 120 | Seq Scan | 641.92 | 682.65 | 6.3% | operator |
...
- **Input Features:**
  ...
  - Aggregate_Outer_total_cost=168537.0700
  - Sort_np=0
  - Sort_nt=6
  - Sort_nt1=6
  - Sort_nt2=0
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=168537.1500
  - Sort_total_cost=168537.1700
- **Output:** st=1195.77, rt=1199.87

### Step 3: Node 117 (Gather Merge)
...
### Step 4: Node 116 (Aggregate) - ROOT
