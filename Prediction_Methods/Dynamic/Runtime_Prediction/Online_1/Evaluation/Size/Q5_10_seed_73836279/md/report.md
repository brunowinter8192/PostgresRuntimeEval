...
**Test Query:** Q5_10_seed_73836279
...
```
Node 7101 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 7102 (Aggregate) [consumed]
    Node 7103 (Gather Merge) [consumed]
      Node 7104 (Aggregate)
        Node 7105 (Sort) [PATTERN: 3e2d5a00]
          Node 7106 (Hash Join) [consumed]
            Node 7107 (Nested Loop)
              Node 7108 (Hash Join)
                Node 7109 (Seq Scan) - LEAF
                Node 7110 (Hash) [PATTERN: 444761fb]
                  Node 7111 (Hash Join) [consumed]
                    Node 7112 (Seq Scan) [consumed] - LEAF
                    Node 7113 (Hash) [consumed]
                      Node 7114 (Hash Join) [consumed]
                        Node 7115 (Seq Scan) - LEAF
                        Node 7116 (Hash)
                          Node 7117 (Seq Scan) - LEAF
              Node 7118 (Index Scan) - LEAF
            Node 7119 (Hash)
              Node 7120 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 7110 | 7101, 7102, 7103, 7105, 7106, 7111, 7112, 7113, 7114 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 7101 | 7102, 7103, 7105, 7106, 7110, 7111, 7112, 7113, 7114 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 7105 | 7101, 7102, 7103, 7106, 7110, 7111, 7112, 7113, 7114 |
...
|------|------|--------|-----------|-----|--------|
| 7101 | Sort | 1055.39 | 2934.42 | 178.0% | pattern |
| 7104 | Aggregate | 1051.04 | 1128.79 | 7.4% | operator |
| 7105 | Sort | 1050.74 | 1835.90 | 74.7% | pattern |
| 7107 | Nested Loop | 1037.95 | 1188.37 | 14.5% | operator |
| 7119 | Hash | 3.95 | 18.67 | 372.7% | operator |
| 7108 | Hash Join | 214.40 | 253.07 | 18.0% | operator |
| 7118 | Index Scan | 0.07 | -0.22 | 405.6% | operator |
| 7120 | Seq Scan | 3.34 | 12.36 | 270.2% | operator |
| 7109 | Seq Scan | 165.70 | 159.81 | 3.6% | operator |
| 7110 | Hash | 34.39 | 46.85 | 36.2% | pattern |
| 7115 | Seq Scan | 0.01 | 11.81 | 147503.4% | operator |
| 7116 | Hash | 0.06 | 21.05 | 37495.1% | operator |
| 7117 | Seq Scan | 0.05 | 22.93 | 44002.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 7117 (Seq Scan) - LEAF
...
### Step 2: Node 7115 (Seq Scan) - LEAF
...
### Step 4: Node 7109 (Seq Scan) - LEAF
...
### Step 5: Node 7110 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 7101, 7102, 7103, 7105, 7106, 7111, 7112, 7113, 7114
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 7118 (Index Scan) - LEAF
...
### Step 8: Node 7120 (Seq Scan) - LEAF
...
### Step 11: Node 7105 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 7101, 7102, 7103, 7106, 7110, 7111, 7112, 7113, 7114
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 7101 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 7102, 7103, 7105, 7106, 7110, 7111, 7112, 7113, 7114
- **Input Features:**
