...
**Test Query:** Q13_143_seed_1164972402
...
```
Node 25699 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25700 (Aggregate) [consumed]
    Node 25701 (Aggregate)
      Node 25702 (Hash Join) [PATTERN: 895c6e8c]
        Node 25703 (Seq Scan) [consumed] - LEAF
        Node 25704 (Hash) [consumed]
          Node 25705 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25699 | 25700, 25702, 25703, 25704 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25702 | 25699, 25700, 25703, 25704 |
...
|------|------|--------|-----------|-----|--------|
| 25699 | Sort | 930.26 | 1079.93 | 16.1% | pattern |
| 25701 | Aggregate | 924.13 | 999.15 | 8.1% | operator |
| 25702 | Hash Join | 703.64 | 470.31 | 33.2% | pattern |
| 25705 | Index Only Scan | 10.28 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25705 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25702 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25699, 25700, 25703, 25704
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1478958
...
### Step 4: Node 25699 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25700, 25702, 25703, 25704
- **Input Features:**
