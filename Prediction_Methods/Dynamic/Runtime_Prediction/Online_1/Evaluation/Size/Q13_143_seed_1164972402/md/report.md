...
```
Node 25699 (Sort) - ROOT
  Node 25700 (Aggregate)
    Node 25701 (Aggregate)
      Node 25702 (Hash Join)
        Node 25703 (Seq Scan) - LEAF
        Node 25704 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 25699 | Sort | 930.26 | 1081.93 | 16.3% | operator |
| 25700 | Aggregate | 930.22 | 1000.36 | 7.5% | operator |
| 25701 | Aggregate | 924.13 | 1013.77 | 9.7% | operator |
| 25702 | Hash Join | 703.64 | 787.83 | 12.0% | operator |
| 25703 | Seq Scan | 481.65 | 263.97 | 45.2% | operator |
| 25704 | Hash | 16.55 | 80.15 | 384.1% | operator |
...
### Step 2: Node 25703 (Seq Scan) - LEAF
