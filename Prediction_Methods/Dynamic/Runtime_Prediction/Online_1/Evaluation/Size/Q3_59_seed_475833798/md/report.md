...
**Test Query:** Q3_59_seed_475833798
**Timestamp:** 2026-01-18 16:20:39
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5391 | 5392, 5393, 5394, 5396, 5397, 5398 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5396 | 5391, 5392, 5393, 5394, 5397, 5398 |
...
|------|------|--------|-----------|-----|--------|
| 5391 | Limit | 1203.64 | 1151.18 | 4.4% | pattern |
| 5395 | Nested Loop | 1167.88 | 1192.83 | 2.1% | operator |
| 5396 | Hash Join | 209.31 | 242.44 | 15.8% | pattern |
| 5400 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5399 | Seq Scan | 28.82 | 38.54 | 33.7% | operator |
...
- **Consumes:** Nodes 5391, 5392, 5393, 5394, 5397, 5398
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46566
  - HashJoin_nt1=231734
...
- **Input Features:**
  ...
  - total_cost=72726.5200
- **Output:** st=121.57, rt=1192.83

### Step 5: Node 5391 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5392, 5393, 5394, 5396, 5397, 5398
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=314931
  - Aggregate_Outer_nt1=314931
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=109943.5800
  - Aggregate_Outer_total_cost=113880.2200
  - Gather_Outer_np=0
  - Gather_Outer_nt=314931
  - Gather_Outer_nt1=101591
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105219.6200
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=314931
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=120685.7700
  - Limit_total_cost=120685.7900
  - Sort_Outer_np=0
  - Sort_Outer_nt=314931
  - Sort_Outer_nt1=314931
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=120685.7700
  - Sort_Outer_total_cost=121473.0900
