...
Node 176 (Aggregate) - ROOT
  Node 177 (Gather Merge)
    Node 178 (Sort) [PATTERN: 1d35fb97]
      Node 179 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 178 | 179 |
...
|------|------|--------|-----------|-----|--------|
| 176 | Aggregate | 934.21 | 1195.72 | 28.0% | operator |
| 177 | Gather Merge | 934.15 | 1165.86 | 24.8% | operator |
| 178 | Sort | 914.90 | 1199.87 | 31.1% | pattern |
...
### Step 2: Node 178 (Sort) - PATTERN ROOT
...
### Step 4: Node 176 (Aggregate) - ROOT
