...
**Test Query:** Q6_126_seed_1025503875
...
```
Node 10013 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10014 (Gather) [consumed]
    Node 10015 (Aggregate) [consumed]
      Node 10016 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10013 | 10014, 10015 |
...
|------|------|--------|-----------|-----|--------|
| 10013 | Aggregate | 801.91 | 850.00 | 6.0% | pattern |
| 10016 | Seq Scan | 781.57 | 748.50 | 4.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10016 (Seq Scan) - LEAF
...
### Step 2: Node 10013 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10014, 10015
- **Input Features:**
