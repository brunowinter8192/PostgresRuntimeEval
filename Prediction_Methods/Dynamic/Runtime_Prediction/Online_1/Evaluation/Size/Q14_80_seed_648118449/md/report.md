...
```
Node 27316 (Aggregate) [PATTERN: efde8b38] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27316 | 27317, 27318, 27319 |
...
|------|------|--------|-----------|-----|--------|
| 27316 | Aggregate | 814.96 | 857.13 | 5.2% | pattern |
...
### Step 4: Node 27316 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27317, 27318, 27319
- **Input Features:**
