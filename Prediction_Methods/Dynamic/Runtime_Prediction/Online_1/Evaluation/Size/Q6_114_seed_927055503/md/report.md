...
**Test Query:** Q6_114_seed_927055503
...
```
Node 9961 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 9962 (Gather) [consumed]
    Node 9963 (Aggregate) [consumed]
      Node 9964 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 9961 | 9962, 9963 |
...
|------|------|--------|-----------|-----|--------|
| 9961 | Aggregate | 836.92 | 849.99 | 1.6% | pattern |
| 9964 | Seq Scan | 817.30 | 748.50 | 8.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 9964 (Seq Scan) - LEAF
...
### Step 2: Node 9961 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 9962, 9963
- **Input Features:**
