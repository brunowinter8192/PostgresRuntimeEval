...
**Test Query:** Q13_122_seed_992687751
...
```
Node 25538 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25539 (Aggregate) [consumed]
    Node 25540 (Aggregate)
      Node 25541 (Hash Join) [PATTERN: 895c6e8c]
        Node 25542 (Seq Scan) [consumed] - LEAF
        Node 25543 (Hash) [consumed]
          Node 25544 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25538 | 25539, 25541, 25542, 25543 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25541 | 25538, 25539, 25542, 25543 |
...
|------|------|--------|-----------|-----|--------|
| 25538 | Sort | 894.79 | 1079.93 | 20.7% | pattern |
| 25540 | Aggregate | 888.43 | 999.15 | 12.5% | operator |
| 25541 | Hash Join | 680.64 | 470.31 | 30.9% | pattern |
| 25544 | Index Only Scan | 9.95 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25544 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25541 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25538, 25539, 25542, 25543
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1478958
...
### Step 4: Node 25538 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25539, 25541, 25542, 25543
- **Input Features:**
