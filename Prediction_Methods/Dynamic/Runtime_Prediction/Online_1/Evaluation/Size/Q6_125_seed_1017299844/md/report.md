...
**Test Query:** Q6_125_seed_1017299844
...
```
Node 10009 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10010 (Gather) [consumed]
    Node 10011 (Aggregate) [consumed]
      Node 10012 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10009 | 10010, 10011 |
...
|------|------|--------|-----------|-----|--------|
| 10009 | Aggregate | 789.60 | 850.05 | 7.7% | pattern |
| 10012 | Seq Scan | 769.60 | 748.53 | 2.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10012 (Seq Scan) - LEAF
...
### Step 2: Node 10009 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10010, 10011
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=23674
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=32
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=139723.8400
  - Aggregate_Outer_total_cost=139723.8500
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
