...
**Test Query:** Q4_57_seed_459425736
...
```
Node 6565 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6566 (Gather Merge) [consumed]
    Node 6567 (Sort) [consumed]
      Node 6568 (Aggregate) [consumed]
        Node 6569 (Nested Loop)
          Node 6570 (Seq Scan) - LEAF
          Node 6571 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6565 | 6566, 6567, 6568 |
...
|------|------|--------|-----------|-----|--------|
| 6565 | Aggregate | 1046.60 | 952.19 | 9.0% | pattern |
| 6569 | Nested Loop | 1039.94 | 1255.45 | 20.7% | operator |
| 6570 | Seq Scan | 164.21 | 154.66 | 5.8% | operator |
| 6571 | Index Scan | 0.06 | 11.10 | 18103.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6570 (Seq Scan) - LEAF
...
### Step 2: Node 6571 (Index Scan) - LEAF
