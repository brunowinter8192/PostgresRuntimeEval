...
```
Node 18661 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18662 (Aggregate) [consumed]
    Node 18663 (Gather)
      Node 18664 (Aggregate)
        Node 18665 (Nested Loop)
          Node 18666 (Hash Join) [PATTERN: bb930825]
            Node 18667 (Seq Scan) [consumed] - LEAF
            Node 18668 (Hash) [consumed]
              Node 18669 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18666 | 18661, 18662, 18667, 18668, 18669 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18661 | 18662, 18666, 18667, 18668, 18669 |
...
|------|------|--------|-----------|-----|--------|
| 18661 | Sort | 1176.85 | 1046.01 | 11.1% | pattern |
...
| 18666 | Hash Join | 965.37 | 134.80 | 86.0% | pattern |
...
### Step 9: Node 18666 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18661, 18662, 18667, 18668, 18669
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18678 (Index Scan) - LEAF
...
### Step 11: Node 18665 (Nested Loop)
...
### Step 14: Node 18661 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18662, 18666, 18667, 18668, 18669
- **Input Features:**
