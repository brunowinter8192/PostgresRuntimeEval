...
**Test Query:** Q4_120_seed_976279689
...
```
Node 6005 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6006 (Gather Merge) [consumed]
    Node 6007 (Sort) [consumed]
      Node 6008 (Aggregate) [consumed]
        Node 6009 (Nested Loop)
          Node 6010 (Seq Scan) - LEAF
          Node 6011 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6005 | 6006, 6007, 6008 |
...
|------|------|--------|-----------|-----|--------|
| 6005 | Aggregate | 1042.29 | 952.19 | 8.6% | pattern |
| 6009 | Nested Loop | 1034.39 | 1255.45 | 21.4% | operator |
| 6010 | Seq Scan | 164.76 | 154.67 | 6.1% | operator |
| 6011 | Index Scan | 0.06 | 11.10 | 17526.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6010 (Seq Scan) - LEAF
...
### Step 2: Node 6011 (Index Scan) - LEAF
