...
**Test Query:** Q18_20_seed_155876589
...
```
Node 29812 (Limit) - ROOT
  Node 29813 (Sort)
    Node 29814 (Aggregate)
      Node 29815 (Gather Merge)
        Node 29816 (Incremental Sort)
          Node 29817 (Nested Loop)
            Node 29818 (Merge Join)
              Node 29819 (Sort)
                Node 29820 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29821 (Seq Scan) [consumed] - LEAF
                  Node 29822 (Hash) [consumed]
                    Node 29823 (Aggregate)
                      Node 29824 (Index Scan) - LEAF
              Node 29825 (Sort)
                Node 29826 (Seq Scan) - LEAF
            Node 29827 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29820 | 29821, 29822 |
...
|------|------|--------|-----------|-----|--------|
| 29812 | Limit | 3041.50 | 1175.21 | 61.4% | operator |
| 29813 | Sort | 2923.21 | 1127.81 | 61.4% | operator |
| 29814 | Aggregate | 2923.15 | 1073.15 | 63.3% | operator |
| 29815 | Gather Merge | 2923.14 | 1073.95 | 63.3% | operator |
| 29816 | Incremental Sort | 2903.85 | 0.00 | 100.0% | operator |
| 29817 | Nested Loop | 2903.81 | 1111.34 | 61.7% | operator |
| 29818 | Merge Join | 2903.74 | 0.00 | 100.0% | operator |
| 29827 | Index Scan | 0.02 | 0.05 | 88.1% | operator |
| 29819 | Sort | 2836.05 | 1095.58 | 61.4% | operator |
| 29825 | Sort | 64.79 | 1074.66 | 1558.6% | operator |
| 29820 | Hash Join | 2836.04 | 471.07 | 83.4% | pattern |
| 29826 | Seq Scan | 52.79 | 18.25 | 65.4% | operator |
| 29823 | Aggregate | 2618.28 | 1073.15 | 59.0% | operator |
| 29824 | Index Scan | 2119.11 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29824 (Index Scan) - LEAF
...
### Step 3: Node 29820 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29821, 29822
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29826 (Seq Scan) - LEAF
...
### Step 7: Node 29818 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29827 (Index Scan) - LEAF
...
### Step 10: Node 29816 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29815 (Gather Merge)
