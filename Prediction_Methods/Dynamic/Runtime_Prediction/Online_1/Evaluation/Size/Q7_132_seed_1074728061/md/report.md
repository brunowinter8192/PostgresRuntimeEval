...
```
Node 11131 (Aggregate) - ROOT
  Node 11132 (Gather Merge)
    Node 11133 (Sort)
      Node 11134 (Hash Join)
        Node 11135 (Nested Loop)
          Node 11136 (Hash Join)
            Node 11137 (Seq Scan) - LEAF
            Node 11138 (Hash)
              Node 11139 (Hash Join)
                Node 11140 (Seq Scan) - LEAF
                Node 11141 (Hash)
                  Node 11142 (Seq Scan) - LEAF
          Node 11143 (Index Scan) - LEAF
        Node 11144 (Hash)
          Node 11145 (Hash Join)
            Node 11146 (Seq Scan) - LEAF
            Node 11147 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 11131 | Aggregate | 1203.55 | 1209.26 | 0.5% | operator |
| 11132 | Gather Merge | 1202.59 | 1142.98 | 5.0% | operator |
| 11133 | Sort | 1197.05 | 1109.13 | 7.3% | operator |
| 11134 | Hash Join | 1196.43 | 842.59 | 29.6% | operator |
| 11135 | Nested Loop | 1187.87 | 1216.16 | 2.4% | operator |
| 11144 | Hash | 4.82 | 17.53 | 263.9% | operator |
| 11136 | Hash Join | 213.45 | 384.47 | 80.1% | operator |
| 11143 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 11145 | Hash Join | 4.77 | 85.17 | 1684.5% | operator |
| 11137 | Seq Scan | 152.82 | 201.16 | 31.6% | operator |
| 11138 | Hash | 34.78 | 19.59 | 43.7% | operator |
| 11146 | Seq Scan | 4.46 | 11.47 | 157.2% | operator |
| 11147 | Hash | 0.01 | 16.89 | 120572.0% | operator |
| 11139 | Hash Join | 34.50 | 92.20 | 167.2% | operator |
| 11148 | Seq Scan | 0.01 | 45.79 | 457823.2% | operator |
| 11140 | Seq Scan | 33.41 | 21.86 | 34.6% | operator |
| 11141 | Hash | 0.01 | 16.89 | 211076.0% | operator |
| 11142 | Seq Scan | 0.01 | 45.79 | 915746.3% | operator |
...
### Step 2: Node 11140 (Seq Scan) - LEAF
...
### Step 5: Node 11148 (Seq Scan) - LEAF
...
### Step 6: Node 11137 (Seq Scan) - LEAF
...
### Step 8: Node 11146 (Seq Scan) - LEAF
...
### Step 11: Node 11143 (Index Scan) - LEAF
...
### Step 13: Node 11135 (Nested Loop)
...
### Step 17: Node 11132 (Gather Merge)
...
### Step 18: Node 11131 (Aggregate) - ROOT
