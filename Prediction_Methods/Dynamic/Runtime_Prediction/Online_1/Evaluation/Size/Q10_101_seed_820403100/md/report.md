    ...
    Node 19385 (Aggregate) [consumed]
      Node 19386 (Gather) [consumed]
        Node 19387 (Hash Join)
          Node 19388 (Hash Join) [PATTERN: 2e0f44ef]
            Node 19389 (Nested Loop) [consumed]
              Node 19390 (Seq Scan) - LEAF
              Node 19391 (Index Scan) - LEAF
            Node 19392 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19383 | 19384, 19385, 19386, 19388, 19389, 19392 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 19388 | 19383, 19384, 19385, 19386, 19389, 19392 |
...
| 19387 | Hash Join | 1086.93 | 1095.57 | 0.8% | operator |
| 19388 | Hash Join | 1083.89 | 1120.19 | 3.3% | pattern |
...
### Step 4: Node 19395 (Seq Scan) - LEAF
...
### Step 5: Node 19388 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 19383, 19384, 19385, 19386, 19389, 19392
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18257
  - HashJoin_nt1=18257
...
### Step 8: Node 19383 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19384, 19385, 19386, 19388, 19389, 19392
- **Input Features:**
