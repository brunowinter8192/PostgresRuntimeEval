...
**Test Query:** Q10_45_seed_360977364
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20527 | 20528, 20529, 20530, 20532, 20533, 20536 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 20532 | 20527, 20528, 20529, 20530, 20533, 20536 |
...
|------|------|--------|-----------|-----|--------|
| 20527 | Limit | 1139.58 | 1199.47 | 5.3% | pattern |
| 20531 | Hash Join | 1089.03 | 1095.48 | 0.6% | operator |
| 20532 | Hash Join | 1086.14 | 1120.19 | 3.1% | pattern |
| 20538 | Hash | 0.02 | 15.71 | 98092.3% | operator |
| 20539 | Seq Scan | 0.01 | 6.98 | 53582.3% | operator |
| 20534 | Seq Scan | 161.73 | 159.74 | 1.2% | operator |
| 20535 | Index Scan | 0.06 | -0.52 | 922.6% | operator |
| 20537 | Seq Scan | 28.85 | 26.64 | 7.6% | operator |
...
### Step 4: Node 20539 (Seq Scan) - LEAF
...
- **Consumes:** Nodes 20527, 20528, 20529, 20530, 20533, 20536
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=17935
  - HashJoin_nt1=17935
...
### Step 8: Node 20527 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20528, 20529, 20530, 20532, 20533, 20536
- **Input Features:**
