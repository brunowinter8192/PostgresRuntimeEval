    ...
    Node 20932 (Aggregate) [consumed]
      Node 20933 (Gather) [consumed]
        Node 20934 (Hash Join)
          Node 20935 (Hash Join)
            Node 20936 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20930 | 20931, 20932, 20933 |
...
| 20934 | Hash Join | 1114.42 | 1007.24 | 9.6% | operator |
| 20935 | Hash Join | 1111.56 | 1004.16 | 9.7% | operator |
| 20941 | Hash | 0.01 | 15.71 | 104638.5% | operator |
| 20936 | Nested Loop | 1065.18 | 1204.80 | 13.1% | operator |
| 20939 | Hash | 36.05 | 55.57 | 54.1% | operator |
...
### Step 6: Node 20942 (Seq Scan) - LEAF
...
### Step 10: Node 20930 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20931, 20932, 20933
- **Input Features:**
