...
**Test Query:** Q18_25_seed_196896744
...
```
Node 29892 (Limit) - ROOT
  Node 29893 (Sort)
    Node 29894 (Aggregate)
      Node 29895 (Gather Merge)
        Node 29896 (Incremental Sort)
          Node 29897 (Nested Loop)
            Node 29898 (Merge Join)
              Node 29899 (Sort)
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29900 | 29901, 29902 |
...
|------|------|--------|-----------|-----|--------|
| 29892 | Limit | 3044.35 | 1175.21 | 61.4% | operator |
| 29893 | Sort | 2935.63 | 1127.81 | 61.6% | operator |
| 29894 | Aggregate | 2935.58 | 1073.15 | 63.4% | operator |
| 29895 | Gather Merge | 2935.56 | 1073.95 | 63.4% | operator |
| 29896 | Incremental Sort | 2899.74 | 0.00 | 100.0% | operator |
| 29897 | Nested Loop | 2899.69 | 1111.34 | 61.7% | operator |
| 29898 | Merge Join | 2899.62 | 0.00 | 100.0% | operator |
| 29907 | Index Scan | 0.02 | 0.05 | 88.1% | operator |
| 29899 | Sort | 2848.97 | 1095.58 | 61.5% | operator |
| 29905 | Sort | 64.55 | 1074.66 | 1564.9% | operator |
| 29900 | Hash Join | 2848.95 | 471.07 | 83.5% | pattern |
| 29906 | Seq Scan | 53.00 | 18.25 | 65.6% | operator |
| 29903 | Aggregate | 2626.08 | 1073.15 | 59.1% | operator |
| 29904 | Index Scan | 2134.16 | 0.00 | 100.0% | operator |
...
### Step 4: Node 29906 (Seq Scan) - LEAF
...
### Step 7: Node 29898 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29907 (Index Scan) - LEAF
...
### Step 10: Node 29896 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29895 (Gather Merge)
