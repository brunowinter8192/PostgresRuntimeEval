...
Node 26931 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26932 (Gather) [consumed]
    Node 26933 (Aggregate) [consumed]
      Node 26934 (Hash Join)
        Node 26935 (Seq Scan) - LEAF
        Node 26936 (Hash)
          Node 26937 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26931 | 26932, 26933 |
...
|------|------|--------|-----------|-----|--------|
| 26931 | Aggregate | 811.95 | 848.33 | 4.5% | pattern |
| 26934 | Hash Join | 790.76 | 807.58 | 2.1% | operator |
| 26935 | Seq Scan | 739.85 | 758.43 | 2.5% | operator |
| 26936 | Hash | 42.73 | 9.38 | 78.1% | operator |
| 26937 | Seq Scan | 37.18 | 12.70 | 65.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26937 (Seq Scan) - LEAF
...
### Step 2: Node 26935 (Seq Scan) - LEAF
...
- **Output:** st=6.82, rt=758.43

### Step 3: Node 26936 (Hash)
...
- **Input Features:**
  ...
  - total_cost=136642.7300
- **Output:** st=78.54, rt=807.58

### Step 5: Node 26931 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26932, 26933
- **Input Features:**
