...
```
Node 26931 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26932 (Gather) [consumed]
    Node 26933 (Aggregate) [consumed]
      Node 26934 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26931 | 26932, 26933, 26934 |
...
|------|------|--------|-----------|-----|--------|
| 26931 | Aggregate | 811.95 | 857.11 | 5.6% | pattern |
...
### Step 4: Node 26931 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26932, 26933, 26934
- **Input Features:**
