...
**Test Query:** Q14_99_seed_803995038
...
```
Node 27456 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27457 (Gather) [consumed]
    Node 27458 (Aggregate) [consumed]
      Node 27459 (Hash Join)
        Node 27460 (Seq Scan) - LEAF
        Node 27461 (Hash)
          Node 27462 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27456 | 27457, 27458 |
...
|------|------|--------|-----------|-----|--------|
| 27456 | Aggregate | 796.30 | 848.36 | 6.5% | pattern |
| 27459 | Hash Join | 774.39 | 807.63 | 4.3% | operator |
| 27460 | Seq Scan | 720.16 | 758.48 | 5.3% | operator |
| 27461 | Hash | 46.48 | 9.38 | 79.8% | operator |
| 27462 | Seq Scan | 40.49 | 12.70 | 68.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27462 (Seq Scan) - LEAF
...
### Step 2: Node 27460 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=136645.9300
- **Output:** st=78.56, rt=807.63

### Step 5: Node 27456 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27457, 27458
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=14968
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=64
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0001
  - Aggregate_Outer_startup_cost=136907.8800
  - Aggregate_Outer_total_cost=136907.8900
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=137908.4400
  - Aggregate_total_cost=137908.4600
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=137907.8800
  - Gather_Outer_total_cost=137908.3900
