...
```
Node 27456 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27457 (Gather) [consumed]
    Node 27458 (Aggregate) [consumed]
      Node 27459 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27456 | 27457, 27458, 27459 |
...
|------|------|--------|-----------|-----|--------|
| 27456 | Aggregate | 796.30 | 857.13 | 7.6% | pattern |
...
### Step 4: Node 27456 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27457, 27458, 27459
- **Input Features:**
