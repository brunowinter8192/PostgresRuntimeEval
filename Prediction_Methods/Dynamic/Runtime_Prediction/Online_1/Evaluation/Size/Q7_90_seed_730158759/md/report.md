...
```
Node 13003 (Aggregate) - ROOT
  Node 13004 (Gather Merge)
    Node 13005 (Sort)
      Node 13006 (Hash Join)
        Node 13007 (Nested Loop)
          Node 13008 (Hash Join)
            Node 13009 (Seq Scan) - LEAF
            Node 13010 (Hash)
              Node 13011 (Hash Join)
                Node 13012 (Seq Scan) - LEAF
                Node 13013 (Hash)
                  Node 13014 (Seq Scan) - LEAF
          Node 13015 (Index Scan) - LEAF
        Node 13016 (Hash)
          Node 13017 (Hash Join)
            Node 13018 (Seq Scan) - LEAF
            Node 13019 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 13003 | Aggregate | 1191.06 | 1209.26 | 1.5% | operator |
| 13004 | Gather Merge | 1189.90 | 1142.98 | 3.9% | operator |
| 13005 | Sort | 1184.28 | 1109.13 | 6.3% | operator |
| 13006 | Hash Join | 1183.64 | 842.59 | 28.8% | operator |
| 13007 | Nested Loop | 1176.53 | 1216.16 | 3.4% | operator |
| 13016 | Hash | 3.23 | 17.53 | 443.2% | operator |
| 13008 | Hash Join | 216.00 | 384.47 | 78.0% | operator |
| 13015 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 13017 | Hash Join | 3.18 | 85.17 | 2580.1% | operator |
| 13009 | Seq Scan | 154.13 | 201.16 | 30.5% | operator |
| 13010 | Hash | 36.28 | 19.59 | 46.0% | operator |
| 13018 | Seq Scan | 2.82 | 11.47 | 306.2% | operator |
| 13019 | Hash | 0.01 | 16.89 | 129854.5% | operator |
| 13011 | Hash Join | 36.02 | 92.20 | 156.0% | operator |
| 13020 | Seq Scan | 0.01 | 45.79 | 508703.5% | operator |
| 13012 | Seq Scan | 34.91 | 21.86 | 37.4% | operator |
| 13013 | Hash | 0.01 | 16.89 | 168840.8% | operator |
| 13014 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |
...
### Step 2: Node 13012 (Seq Scan) - LEAF
...
### Step 5: Node 13020 (Seq Scan) - LEAF
...
### Step 6: Node 13009 (Seq Scan) - LEAF
...
### Step 8: Node 13018 (Seq Scan) - LEAF
...
### Step 11: Node 13015 (Index Scan) - LEAF
...
### Step 13: Node 13007 (Nested Loop)
...
### Step 17: Node 13004 (Gather Merge)
...
### Step 18: Node 13003 (Aggregate) - ROOT
