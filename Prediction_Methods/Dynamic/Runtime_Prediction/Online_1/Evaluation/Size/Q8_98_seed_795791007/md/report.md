...
```
Node 16582 (Aggregate) - ROOT
  Node 16583 (Gather Merge)
    Node 16584 (Sort)
          ...
          Node 16587 (Hash Join)
            Node 16588 (Nested Loop)
              Node 16589 (Hash Join)
                ...
                Node 16591 (Hash)
                  Node 16592 (Hash Join)
                    Node 16593 (Seq Scan) - LEAF
                    Node 16594 (Hash)
                      Node 16595 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 16582 | Aggregate | 1229.29 | 1195.83 | 2.7% | operator |
| 16583 | Gather Merge | 1228.91 | 1097.17 | 10.7% | operator |
...
| 16589 | Hash Join | 213.47 | 251.17 | 17.7% | operator |
...
| 16591 | Hash | 36.69 | 20.62 | 43.8% | operator |
| 16592 | Hash Join | 35.88 | 132.26 | 268.7% | operator |
| 16593 | Seq Scan | 34.39 | 23.03 | 33.0% | operator |
| 16594 | Hash | 0.16 | 23.66 | 15064.2% | operator |
| 16595 | Hash Join | 0.15 | 306.84 | 200446.4% | operator |
...
### Step 5: Node 16593 (Seq Scan) - LEAF
...
### Step 8: Node 16590 (Seq Scan) - LEAF
...
### Step 11: Node 16599 (Index Scan) - LEAF
...
### Step 12: Node 16601 (Seq Scan) - LEAF
...
### Step 13: Node 16588 (Nested Loop)
...
### Step 16: Node 16602 (Index Scan) - LEAF
...
### Step 17: Node 16604 (Seq Scan) - LEAF
...
### Step 18: Node 16586 (Nested Loop)
...
### Step 22: Node 16583 (Gather Merge)
...
### Step 23: Node 16582 (Aggregate) - ROOT
