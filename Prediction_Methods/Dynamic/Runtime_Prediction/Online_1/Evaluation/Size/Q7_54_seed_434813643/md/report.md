...
```
Node 12283 (Aggregate) - ROOT
  Node 12284 (Gather Merge)
    Node 12285 (Sort)
      Node 12286 (Hash Join)
        Node 12287 (Nested Loop)
          Node 12288 (Hash Join)
            Node 12289 (Seq Scan) - LEAF
            Node 12290 (Hash)
              Node 12291 (Hash Join)
                Node 12292 (Seq Scan) - LEAF
                Node 12293 (Hash)
                  Node 12294 (Seq Scan) - LEAF
          Node 12295 (Index Scan) - LEAF
        Node 12296 (Hash)
          Node 12297 (Hash Join)
            Node 12298 (Seq Scan) - LEAF
            Node 12299 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 12283 | Aggregate | 1218.33 | 1209.26 | 0.7% | operator |
| 12284 | Gather Merge | 1217.18 | 1142.98 | 6.1% | operator |
| 12285 | Sort | 1211.52 | 1109.13 | 8.5% | operator |
| 12286 | Hash Join | 1210.86 | 842.59 | 30.4% | operator |
| 12287 | Nested Loop | 1204.32 | 1216.16 | 1.0% | operator |
| 12296 | Hash | 2.75 | 17.53 | 537.0% | operator |
| 12288 | Hash Join | 219.21 | 384.47 | 75.4% | operator |
| 12295 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 12297 | Hash Join | 2.71 | 85.17 | 3045.3% | operator |
| 12289 | Seq Scan | 157.27 | 201.16 | 27.9% | operator |
| 12290 | Hash | 36.81 | 19.59 | 46.8% | operator |
| 12298 | Seq Scan | 2.38 | 11.47 | 382.0% | operator |
| 12299 | Hash | 0.01 | 16.89 | 129854.5% | operator |
| 12291 | Hash Join | 36.34 | 92.20 | 153.7% | operator |
| 12300 | Seq Scan | 0.01 | 45.79 | 457823.2% | operator |
| 12292 | Seq Scan | 35.18 | 21.86 | 37.9% | operator |
| 12293 | Hash | 0.01 | 16.89 | 153482.6% | operator |
| 12294 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |
...
### Step 2: Node 12292 (Seq Scan) - LEAF
...
### Step 5: Node 12300 (Seq Scan) - LEAF
...
### Step 6: Node 12289 (Seq Scan) - LEAF
...
### Step 8: Node 12298 (Seq Scan) - LEAF
...
### Step 11: Node 12295 (Index Scan) - LEAF
...
### Step 13: Node 12287 (Nested Loop)
...
### Step 17: Node 12284 (Gather Merge)
...
### Step 18: Node 12283 (Aggregate) - ROOT
