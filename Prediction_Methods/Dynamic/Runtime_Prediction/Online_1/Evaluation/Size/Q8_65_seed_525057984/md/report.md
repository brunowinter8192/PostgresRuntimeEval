...
```
Node 15754 (Aggregate) - ROOT
  Node 15755 (Gather Merge)
    Node 15756 (Sort)
          ...
          Node 15759 (Hash Join)
            Node 15760 (Nested Loop)
              Node 15761 (Hash Join)
                ...
                Node 15763 (Hash)
                  Node 15764 (Hash Join)
                    Node 15765 (Seq Scan) - LEAF
                    Node 15766 (Hash)
                      Node 15767 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 15754 | Aggregate | 1245.53 | 1195.83 | 4.0% | operator |
| 15755 | Gather Merge | 1245.18 | 1097.13 | 11.9% | operator |
...
| 15761 | Hash Join | 215.27 | 251.17 | 16.7% | operator |
...
| 15763 | Hash | 38.19 | 20.62 | 46.0% | operator |
| 15764 | Hash Join | 37.53 | 132.26 | 252.4% | operator |
| 15765 | Seq Scan | 35.91 | 23.03 | 35.9% | operator |
| 15766 | Hash | 0.25 | 23.66 | 9438.8% | operator |
| 15767 | Hash Join | 0.24 | 306.84 | 125652.4% | operator |
...
### Step 5: Node 15765 (Seq Scan) - LEAF
...
### Step 8: Node 15762 (Seq Scan) - LEAF
...
### Step 11: Node 15771 (Index Scan) - LEAF
...
### Step 12: Node 15773 (Seq Scan) - LEAF
...
### Step 13: Node 15760 (Nested Loop)
...
### Step 16: Node 15774 (Index Scan) - LEAF
...
### Step 17: Node 15776 (Seq Scan) - LEAF
...
### Step 18: Node 15758 (Nested Loop)
...
### Step 22: Node 15755 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1044.9378
  - st2=0.0000
  - startup_cost=71528.2700
  - total_cost=71792.0900
- **Output:** st=1093.42, rt=1097.13

### Step 23: Node 15754 (Aggregate) - ROOT
