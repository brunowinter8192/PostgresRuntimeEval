...
**Test Query:** Q14_10_seed_73836279
...
```
Node 26490 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26491 (Gather) [consumed]
    Node 26492 (Aggregate) [consumed]
      Node 26493 (Hash Join) [consumed]
        Node 26494 (Seq Scan) - LEAF
        Node 26495 (Hash)
          Node 26496 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26490 | 26491, 26492, 26493 |
...
|------|------|--------|-----------|-----|--------|
| 26490 | Aggregate | 794.75 | 857.14 | 7.8% | pattern |
| 26494 | Seq Scan | 723.28 | 758.50 | 4.9% | operator |
| 26495 | Hash | 43.59 | 9.38 | 78.5% | operator |
| 26496 | Seq Scan | 38.30 | 12.70 | 66.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26496 (Seq Scan) - LEAF
...
### Step 2: Node 26494 (Seq Scan) - LEAF
...
### Step 4: Node 26490 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26491, 26492, 26493
- **Input Features:**
