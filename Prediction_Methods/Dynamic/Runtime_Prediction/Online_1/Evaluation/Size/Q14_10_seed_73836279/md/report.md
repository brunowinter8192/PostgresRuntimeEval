...
```
Node 26490 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26491 (Gather) [consumed]
    Node 26492 (Aggregate) [consumed]
      Node 26493 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26490 | 26491, 26492 |
...
|------|------|--------|-----------|-----|--------|
| 26490 | Aggregate | 794.75 | 848.37 | 6.7% | pattern |
| 26493 | Hash Join | 774.13 | 807.66 | 4.3% | operator |
...
### Step 5: Node 26490 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26491, 26492
- **Input Features:**
