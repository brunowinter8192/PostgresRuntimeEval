...
```
Node 29844 (Limit) - ROOT
  Node 29845 (Sort)
    Node 29846 (Aggregate)
      Node 29847 (Gather Merge)
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29852 | 29853, 29854 |
...
|------|------|--------|-----------|-----|--------|
| 29844 | Limit | 3028.50 | 1175.21 | 61.2% | operator |
| 29845 | Sort | 2919.19 | 1127.81 | 61.4% | operator |
| 29846 | Aggregate | 2919.15 | 1073.15 | 63.2% | operator |
| 29847 | Gather Merge | 2919.14 | 1073.95 | 63.2% | operator |
| 29848 | Incremental Sort | 2896.55 | 0.00 | 100.0% | operator |
| 29849 | Nested Loop | 2896.50 | 1111.34 | 61.6% | operator |
| 29850 | Merge Join | 2896.44 | 0.00 | 100.0% | operator |
| 29859 | Index Scan | 0.02 | 0.05 | 96.2% | operator |
| 29851 | Sort | 2827.16 | 1095.58 | 61.2% | operator |
| 29857 | Sort | 66.16 | 1074.66 | 1524.5% | operator |
| 29852 | Hash Join | 2827.15 | 471.07 | 83.3% | pattern |
| 29858 | Seq Scan | 54.13 | 18.25 | 66.3% | operator |
| 29855 | Aggregate | 2603.63 | 1073.15 | 58.8% | operator |
| 29856 | Index Scan | 2094.57 | 0.00 | 100.0% | operator |
...
### Step 10: Node 29848 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29847 (Gather Merge)
