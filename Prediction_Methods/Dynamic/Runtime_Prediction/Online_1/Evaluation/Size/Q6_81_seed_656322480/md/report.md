...
**Test Query:** Q6_81_seed_656322480
...
```
Node 10417 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10418 (Gather) [consumed]
    Node 10419 (Aggregate) [consumed]
      Node 10420 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10417 | 10418, 10419 |
...
|------|------|--------|-----------|-----|--------|
| 10417 | Aggregate | 780.95 | 850.05 | 8.8% | pattern |
| 10420 | Seq Scan | 759.63 | 748.53 | 1.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10420 (Seq Scan) - LEAF
...
### Step 2: Node 10417 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10418, 10419
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=23633
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=32
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=139723.6400
  - Aggregate_Outer_total_cost=139723.6500
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=140724.1700
  - Aggregate_total_cost=140724.1800
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=140723.6400
  - Gather_Outer_total_cost=140724.1500
