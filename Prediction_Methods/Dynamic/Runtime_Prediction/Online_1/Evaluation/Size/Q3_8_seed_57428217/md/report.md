    ...
    Node 5733 (Aggregate) [consumed]
      Node 5734 (Gather) [consumed]
        Node 5735 (Nested Loop)
          Node 5736 (Hash Join) [PATTERN: 895c6e8c]
            Node 5737 (Seq Scan) [consumed] - LEAF
            Node 5738 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5731 | 5732, 5733, 5734, 5736, 5737, 5738 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5736 | 5731, 5732, 5733, 5734, 5737, 5738 |
...
| 5735 | Nested Loop | 1178.70 | 1193.22 | 1.2% | operator |
| 5736 | Hash Join | 210.83 | 242.51 | 15.0% | pattern |
...
### Step 2: Node 5736 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5731, 5732, 5733, 5734, 5737, 5738
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47176
  - HashJoin_nt1=234768
  ...
  - HashJoin_total_cost=37338.9100
  - Hash_Inner_np=0
  - Hash_Inner_nt=12559
...
- **Output:** st=29.74, rt=242.51

### Step 3: Node 5740 (Index Scan) - LEAF
...
- **Output:** st=121.96, rt=1193.22

### Step 5: Node 5731 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5732, 5733, 5734, 5736, 5737, 5738
- **Input Features:**
