...
**Test Query:** Q6_20_seed_155876589
...
```
Node 10149 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10150 (Gather) [consumed]
    Node 10151 (Aggregate) [consumed]
      Node 10152 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10149 | 10150, 10151 |
...
|------|------|--------|-----------|-----|--------|
| 10149 | Aggregate | 790.50 | 850.06 | 7.5% | pattern |
| 10152 | Seq Scan | 771.00 | 748.54 | 2.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10152 (Seq Scan) - LEAF
...
### Step 2: Node 10149 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10150, 10151
- **Input Features:**
