...
```
Node 26483 (Aggregate) [PATTERN: efde8b38] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26483 | 26484, 26485, 26486 |
...
|------|------|--------|-----------|-----|--------|
| 26483 | Aggregate | 810.16 | 857.14 | 5.8% | pattern |
...
### Step 4: Node 26483 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26484, 26485, 26486
- **Input Features:**
