...
**Test Query:** Q12_66_seed_533262015
...
```
Node 25104 (Aggregate) - ROOT
  Node 25105 (Gather Merge)
    Node 25106 (Aggregate)
      Node 25107 (Sort)
        Node 25108 (Nested Loop)
          Node 25109 (Seq Scan) - LEAF
          Node 25110 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 25104 | Aggregate | 1000.48 | 919.06 | 8.1% | operator |
| 25105 | Gather Merge | 1000.31 | 1111.84 | 11.1% | operator |
| 25106 | Aggregate | 980.48 | 895.30 | 8.7% | operator |
| 25107 | Sort | 979.83 | 1092.82 | 11.5% | operator |
| 25108 | Nested Loop | 978.89 | 1127.41 | 15.2% | operator |
| 25109 | Seq Scan | 840.19 | 745.19 | 11.3% | operator |
| 25110 | Index Scan | 0.03 | 0.07 | 166.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25109 (Seq Scan) - LEAF
...
### Step 2: Node 25110 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - st2=0.1246
  - startup_cost=0.4300
  - total_cost=147181.2200
- **Output:** st=38.32, rt=1127.41

### Step 4: Node 25107 (Sort)
...
- **Input Features:**
  ...
  - st1=38.3241
  - st2=0.0000
  - startup_cost=147542.6600
  - total_cost=147557.1200
- **Output:** st=1092.40, rt=1092.82

### Step 5: Node 25106 (Aggregate)
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=147542.6600
  - total_cost=147658.4100
- **Output:** st=868.95, rt=895.30

### Step 6: Node 25105 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=868.9499
  - st2=0.0000
  - startup_cost=148542.7400
  - total_cost=148662.7000
- **Output:** st=1109.22, rt=1111.84

### Step 7: Node 25104 (Aggregate) - ROOT
