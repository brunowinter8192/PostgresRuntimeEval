...
**Test Query:** Q19_14_seed_106652403
...
```
Node 31598 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31599 (Gather) [consumed]
    Node 31600 (Aggregate) [consumed]
      Node 31601 (Hash Join) [consumed]
        Node 31602 (Seq Scan) - LEAF
        Node 31603 (Hash)
          Node 31604 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31598 | 31599, 31600, 31601 |
...
|------|------|--------|-----------|-----|--------|
| 31598 | Aggregate | 809.69 | 829.34 | 2.4% | pattern |
| 31602 | Seq Scan | 739.15 | 743.46 | 0.6% | operator |
| 31603 | Hash | 48.33 | 8.29 | 82.9% | operator |
| 31604 | Seq Scan | 48.17 | 23.76 | 50.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31604 (Seq Scan) - LEAF
...
### Step 2: Node 31602 (Seq Scan) - LEAF
...
### Step 4: Node 31598 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31599, 31600, 31601
- **Input Features:**
  ...
  - HashJoin_Outer_total_cost=156338.6700
