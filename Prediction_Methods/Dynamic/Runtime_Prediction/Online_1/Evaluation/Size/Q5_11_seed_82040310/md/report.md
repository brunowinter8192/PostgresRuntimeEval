...
**Test Query:** Q5_11_seed_82040310
...
```
Node 7321 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 7322 (Aggregate) [consumed]
    Node 7323 (Gather Merge) [consumed]
      Node 7324 (Aggregate)
        Node 7325 (Sort) [PATTERN: 3e2d5a00]
          Node 7326 (Hash Join) [consumed]
            Node 7327 (Nested Loop)
              Node 7328 (Hash Join)
                Node 7329 (Seq Scan) - LEAF
                Node 7330 (Hash) [PATTERN: 444761fb]
                  Node 7331 (Hash Join) [consumed]
                    Node 7332 (Seq Scan) [consumed] - LEAF
                    Node 7333 (Hash) [consumed]
                      Node 7334 (Hash Join) [consumed]
                        Node 7335 (Seq Scan) - LEAF
                        Node 7336 (Hash)
                          Node 7337 (Seq Scan) - LEAF
              Node 7338 (Index Scan) - LEAF
            Node 7339 (Hash)
              Node 7340 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 7330 | 7321, 7322, 7323, 7325, 7326, 7331, 7332, 7333, 7334 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 7321 | 7322, 7323, 7325, 7326, 7330, 7331, 7332, 7333, 7334 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 7325 | 7321, 7322, 7323, 7326, 7330, 7331, 7332, 7333, 7334 |
...
|------|------|--------|-----------|-----|--------|
| 7321 | Sort | 1070.34 | 2934.42 | 174.2% | pattern |
| 7324 | Aggregate | 1065.44 | 1128.76 | 5.9% | operator |
| 7325 | Sort | 1065.19 | 1835.93 | 72.4% | pattern |
| 7327 | Nested Loop | 1052.13 | 1188.47 | 13.0% | operator |
| 7339 | Hash | 4.49 | 18.67 | 316.0% | operator |
| 7328 | Hash Join | 218.74 | 253.07 | 15.7% | operator |
| 7338 | Index Scan | 0.07 | -0.22 | 405.6% | operator |
| 7340 | Seq Scan | 3.93 | 12.36 | 214.2% | operator |
| 7329 | Seq Scan | 168.15 | 159.81 | 5.0% | operator |
| 7330 | Hash | 37.01 | 46.85 | 26.6% | pattern |
| 7335 | Seq Scan | 0.01 | 11.81 | 131103.0% | operator |
| 7336 | Hash | 0.13 | 21.05 | 16477.4% | operator |
| 7337 | Seq Scan | 0.12 | 22.93 | 18394.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 7337 (Seq Scan) - LEAF
...
### Step 2: Node 7335 (Seq Scan) - LEAF
...
### Step 4: Node 7329 (Seq Scan) - LEAF
...
### Step 5: Node 7330 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 7321, 7322, 7323, 7325, 7326, 7331, 7332, 7333, 7334
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 7338 (Index Scan) - LEAF
...
### Step 8: Node 7340 (Seq Scan) - LEAF
...
### Step 11: Node 7325 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 7321, 7322, 7323, 7326, 7330, 7331, 7332, 7333, 7334
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 7321 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 7322, 7323, 7325, 7326, 7330, 7331, 7332, 7333, 7334
- **Input Features:**
