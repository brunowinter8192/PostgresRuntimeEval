...
```
Node 17339 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 17340 (Aggregate) [consumed]
    Node 17341 (Gather)
      Node 17342 (Aggregate)
        Node 17343 (Nested Loop)
          Node 17344 (Hash Join) [PATTERN: bb930825]
            Node 17345 (Seq Scan) [consumed] - LEAF
            Node 17346 (Hash) [consumed]
              Node 17347 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17344 | 17339, 17340, 17345, 17346, 17347 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17339 | 17340, 17344, 17345, 17346, 17347 |
...
|------|------|--------|-----------|-----|--------|
| 17339 | Sort | 1179.60 | 1045.32 | 11.4% | pattern |
...
| 17344 | Hash Join | 961.68 | 134.80 | 86.0% | pattern |
...
### Step 9: Node 17344 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17339, 17340, 17345, 17346, 17347
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17356 (Index Scan) - LEAF
...
### Step 11: Node 17343 (Nested Loop)
...
### Step 14: Node 17339 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17340, 17344, 17345, 17346, 17347
- **Input Features:**
