...
**Test Query:** Q13_100_seed_812199069
...
```
Node 25370 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25371 (Aggregate) [consumed]
    Node 25372 (Aggregate)
      Node 25373 (Hash Join) [PATTERN: 895c6e8c]
        Node 25374 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25370 | 25371, 25373, 25374, 25375 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25373 | 25370, 25371, 25374, 25375 |
...
|------|------|--------|-----------|-----|--------|
| 25370 | Sort | 930.73 | 1079.94 | 16.0% | pattern |
| 25372 | Aggregate | 924.43 | 999.76 | 8.1% | operator |
| 25373 | Hash Join | 716.07 | 470.31 | 34.3% | pattern |
| 25376 | Index Only Scan | 9.21 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25376 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25373 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25370, 25371, 25374, 25375
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 25370 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25371, 25373, 25374, 25375
- **Input Features:**
