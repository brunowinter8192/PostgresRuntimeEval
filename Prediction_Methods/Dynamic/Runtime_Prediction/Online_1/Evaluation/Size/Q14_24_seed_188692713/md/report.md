...
**Test Query:** Q14_24_seed_188692713
...
```
Node 26882 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26883 (Gather) [consumed]
    Node 26884 (Aggregate) [consumed]
      Node 26885 (Hash Join)
        Node 26886 (Seq Scan) - LEAF
        Node 26887 (Hash)
          Node 26888 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26882 | 26883, 26884 |
...
|------|------|--------|-----------|-----|--------|
| 26882 | Aggregate | 804.82 | 848.38 | 5.4% | pattern |
| 26885 | Hash Join | 782.07 | 807.67 | 3.3% | operator |
| 26886 | Seq Scan | 724.18 | 758.51 | 4.7% | operator |
| 26887 | Hash | 50.49 | 9.38 | 81.4% | operator |
| 26888 | Seq Scan | 44.20 | 12.70 | 71.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26888 (Seq Scan) - LEAF
...
### Step 2: Node 26886 (Seq Scan) - LEAF
...
### Step 5: Node 26882 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26883, 26884
- **Input Features:**
