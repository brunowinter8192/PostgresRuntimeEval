...
```
Node 26882 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26883 (Gather) [consumed]
    Node 26884 (Aggregate) [consumed]
      Node 26885 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26882 | 26883, 26884, 26885 |
...
|------|------|--------|-----------|-----|--------|
| 26882 | Aggregate | 804.82 | 857.14 | 6.5% | pattern |
...
### Step 4: Node 26882 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26883, 26884, 26885
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=15788
  - HashJoin_Outer_nt1=15788
  ...
  - HashJoin_Outer_total_cost=136648.0800
