    ...
    Node 19541 (Aggregate) [consumed]
      Node 19542 (Gather) [consumed]
        Node 19543 (Hash Join)
          Node 19544 (Hash Join)
            Node 19545 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19539 | 19540, 19541, 19542 |
...
| 19543 | Hash Join | 1103.69 | 1007.21 | 8.7% | operator |
| 19544 | Hash Join | 1100.86 | 1004.12 | 8.8% | operator |
| 19550 | Hash | 0.01 | 15.71 | 112119.8% | operator |
| 19545 | Nested Loop | 1054.31 | 1204.81 | 14.3% | operator |
| 19548 | Hash | 35.82 | 55.57 | 55.1% | operator |
...
### Step 6: Node 19551 (Seq Scan) - LEAF
...
- **Output:** st=109.71, rt=1004.12

### Step 8: Node 19550 (Hash)
...
- **Output:** st=98.91, rt=1007.21

### Step 10: Node 19539 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19540, 19541, 19542
- **Input Features:**
