    ...
    Node 4463 (Aggregate) [consumed]
      Node 4464 (Gather) [consumed]
        Node 4465 (Nested Loop)
          Node 4466 (Hash Join) [PATTERN: 895c6e8c]
            Node 4467 (Seq Scan) [consumed] - LEAF
            Node 4468 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4461 | 4462, 4463, 4464, 4466, 4467, 4468 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4466 | 4461, 4462, 4463, 4464, 4467, 4468 |
...
| 4465 | Nested Loop | 1152.79 | 1192.82 | 3.5% | operator |
| 4466 | Hash Join | 205.33 | 242.43 | 18.1% | pattern |
...
### Step 2: Node 4466 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4461, 4462, 4463, 4464, 4467, 4468
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46565
  - HashJoin_nt1=234768
...
### Step 3: Node 4470 (Index Scan) - LEAF
...
### Step 5: Node 4461 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4462, 4463, 4464, 4466, 4467, 4468
- **Input Features:**
