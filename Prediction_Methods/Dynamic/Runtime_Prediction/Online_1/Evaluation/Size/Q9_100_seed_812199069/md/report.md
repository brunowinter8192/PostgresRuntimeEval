    ...
    Node 16653 (Gather)
      Node 16654 (Aggregate)
        Node 16655 (Hash Join)
          ...
          Node 16657 (Hash) [PATTERN: 444761fb]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 16657 | 16651, 16652, 16658, 16659, 16660, 16661 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 16651 | 16652, 16657, 16658, 16659, 16660, 16661 |
...
|------|------|--------|-----------|-----|--------|
| 16651 | Sort | 1289.03 | 1063.40 | 17.5% | pattern |
| 16653 | Gather | 1288.13 | 962.35 | 25.3% | operator |
| 16654 | Aggregate | 1269.00 | 902.72 | 28.9% | operator |
| 16655 | Hash Join | 1239.63 | 580.10 | 53.2% | operator |
| 16656 | Seq Scan | 132.96 | 193.40 | 45.5% | operator |
| 16657 | Hash | 1042.87 | 35.69 | 96.6% | pattern |
| 16662 | Hash Join | 189.93 | 837.88 | 341.2% | operator |
| 16668 | Hash | 14.43 | 14.95 | 3.6% | operator |
| 16663 | Nested Loop | 184.94 | 1251.77 | 576.9% | operator |
| 16666 | Hash | 2.50 | 15.94 | 536.4% | operator |
| 16669 | Seq Scan | 14.41 | 2.94 | 79.6% | operator |
| 16664 | Seq Scan | 29.57 | 43.30 | 46.4% | operator |
| 16665 | Index Scan | 0.06 | -1.39 | 2536.0% | operator |
| 16667 | Seq Scan | 2.10 | 9.45 | 350.0% | operator |
...
### Step 9: Node 16656 (Seq Scan) - LEAF
...
### Step 10: Node 16657 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 16651, 16652, 16658, 16659, 16660, 16661
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=26720
  - HashJoin_Outer_nt1=26720
  ...
  - HashJoin_Outer_total_cost=16710.9900
  - Hash_Inner_np=0
  - Hash_Inner_nt=26720
  - Hash_Inner_nt1=26720
  - Hash_Inner_nt2=0
  - Hash_Inner_parallel_workers=0
  - Hash_Inner_plan_width=126
  - Hash_Inner_reltuples=0.0000
  - Hash_Inner_sel=1.0000
  - Hash_Inner_startup_cost=16710.9900
  - Hash_Inner_total_cost=16710.9900
  - Hash_np=0
  - Hash_nt=96211
  - Hash_nt1=96211
  - Hash_nt2=0
  ...
  - Hash_sel=1.0000
  - Hash_startup_cost=150716.2100
  - Hash_total_cost=150716.2100
...
- **Output:** st=81.18, rt=580.10

### Step 12: Node 16654 (Aggregate)
...
- **Output:** st=915.53, rt=902.72

### Step 13: Node 16653 (Gather)
...
### Step 14: Node 16651 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 16652, 16657, 16658, 16659, 16660, 16661
- **Input Features:**
