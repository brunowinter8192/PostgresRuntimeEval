...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4391 | 4392, 4393, 4394 |
...
| 4395 | Nested Loop | 1145.72 | 1193.53 | 4.2% | operator |
| 4396 | Hash Join | 211.26 | 231.28 | 9.5% | operator |
| 4400 | Index Scan | 0.03 | -0.52 | 2172.3% | operator |
| 4397 | Seq Scan | 158.07 | 163.55 | 3.5% | operator |
| 4398 | Hash | 29.84 | 17.75 | 40.5% | operator |
...
### Step 2: Node 4397 (Seq Scan) - LEAF
...
- **Output:** st=0.29, rt=163.55

### Step 3: Node 4398 (Hash)
...
- **Input Features:**
  ...
  - total_cost=37346.1300
- **Output:** st=27.26, rt=231.28

### Step 5: Node 4400 (Index Scan) - LEAF
...
- **Output:** st=122.20, rt=1193.53

### Step 7: Node 4391 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4392, 4393, 4394
- **Input Features:**
