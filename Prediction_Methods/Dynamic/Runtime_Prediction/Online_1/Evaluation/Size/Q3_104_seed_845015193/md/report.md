...
**Test Query:** Q3_104_seed_845015193
...
```
Node 4391 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 4392 (Sort) [consumed]
    Node 4393 (Aggregate) [consumed]
      Node 4394 (Gather) [consumed]
        Node 4395 (Nested Loop)
          Node 4396 (Hash Join) [PATTERN: 895c6e8c]
            Node 4397 (Seq Scan) [consumed] - LEAF
            Node 4398 (Hash) [consumed]
              Node 4399 (Seq Scan) - LEAF
          Node 4400 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4391 | 4392, 4393, 4394, 4396, 4397, 4398 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4396 | 4391, 4392, 4393, 4394, 4397, 4398 |
...
|------|------|--------|-----------|-----|--------|
| 4391 | Limit | 1181.77 | 1151.18 | 2.6% | pattern |
| 4395 | Nested Loop | 1145.72 | 1193.61 | 4.2% | operator |
| 4396 | Hash Join | 211.26 | 242.59 | 14.8% | pattern |
| 4400 | Index Scan | 0.03 | -0.52 | 2172.3% | operator |
| 4399 | Seq Scan | 29.14 | 38.53 | 32.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4399 (Seq Scan) - LEAF
...
### Step 2: Node 4396 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4391, 4392, 4393, 4394, 4397, 4398
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47784
  - HashJoin_nt1=237422
...
- **Output:** st=29.68, rt=242.59

### Step 3: Node 4400 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=73441.3000
- **Output:** st=122.34, rt=1193.61

### Step 5: Node 4391 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4392, 4393, 4394, 4396, 4397, 4398
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=316043
  - Aggregate_Outer_nt1=316043
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110786.2500
  - Aggregate_Outer_total_cost=114736.7900
  - Gather_Outer_np=0
  - Gather_Outer_nt=316043
  - Gather_Outer_nt1=101949
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=106045.6000
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=316043
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=121566.3600
  - Limit_total_cost=121566.3900
  - Sort_Outer_np=0
  - Sort_Outer_nt=316043
  - Sort_Outer_nt1=316043
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=121566.3600
  - Sort_Outer_total_cost=122356.4700
