...
**Test Query:** Q12_87_seed_705546666
...
```
Node 25265 (Aggregate) - ROOT
  Node 25266 (Gather Merge)
    Node 25267 (Aggregate)
      Node 25268 (Sort)
        Node 25269 (Nested Loop)
          Node 25270 (Seq Scan) - LEAF
          Node 25271 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 25265 | Aggregate | 987.65 | 919.05 | 6.9% | operator |
| 25266 | Gather Merge | 987.64 | 1111.84 | 12.6% | operator |
| 25267 | Aggregate | 969.04 | 895.30 | 7.6% | operator |
| 25268 | Sort | 968.44 | 1092.82 | 12.8% | operator |
| 25269 | Nested Loop | 967.45 | 1127.41 | 16.5% | operator |
| 25270 | Seq Scan | 832.60 | 745.19 | 10.5% | operator |
| 25271 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25270 (Seq Scan) - LEAF
...
### Step 2: Node 25271 (Index Scan) - LEAF
...
### Step 6: Node 25266 (Gather Merge)
...
### Step 7: Node 25265 (Aggregate) - ROOT
