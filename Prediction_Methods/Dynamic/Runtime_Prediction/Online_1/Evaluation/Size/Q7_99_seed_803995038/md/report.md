...
```
Node 13165 (Aggregate) - ROOT
  Node 13166 (Gather Merge)
    Node 13167 (Sort)
      Node 13168 (Hash Join)
        Node 13169 (Nested Loop)
          Node 13170 (Hash Join)
            Node 13171 (Seq Scan) - LEAF
            Node 13172 (Hash)
              Node 13173 (Hash Join)
                Node 13174 (Seq Scan) - LEAF
                Node 13175 (Hash)
                  Node 13176 (Seq Scan) - LEAF
          Node 13177 (Index Scan) - LEAF
        Node 13178 (Hash)
          Node 13179 (Hash Join)
            Node 13180 (Seq Scan) - LEAF
            Node 13181 (Hash)
              Node 13182 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 13165 | Aggregate | 1209.04 | 1209.26 | 0.0% | operator |
| 13166 | Gather Merge | 1208.08 | 1142.98 | 5.4% | operator |
| 13167 | Sort | 1199.75 | 1109.13 | 7.6% | operator |
| 13168 | Hash Join | 1199.15 | 842.59 | 29.7% | operator |
| 13169 | Nested Loop | 1190.12 | 1216.16 | 2.2% | operator |
| 13178 | Hash | 5.36 | 17.53 | 226.8% | operator |
| 13170 | Hash Join | 214.77 | 384.47 | 79.0% | operator |
| 13177 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 13179 | Hash Join | 5.33 | 85.17 | 1499.5% | operator |
| 13171 | Seq Scan | 154.80 | 201.16 | 30.0% | operator |
| 13172 | Hash | 34.46 | 19.59 | 43.2% | operator |
| 13180 | Seq Scan | 4.57 | 11.47 | 151.3% | operator |
| 13181 | Hash | 0.02 | 16.89 | 105488.0% | operator |
| 13173 | Hash Join | 34.23 | 92.20 | 169.4% | operator |
| 13182 | Seq Scan | 0.01 | 45.79 | 352148.6% | operator |
| 13174 | Seq Scan | 33.11 | 21.86 | 34.0% | operator |
| 13175 | Hash | 0.01 | 16.89 | 187612.0% | operator |
| 13176 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 13176 (Seq Scan) - LEAF
...
### Step 2: Node 13174 (Seq Scan) - LEAF
...
### Step 5: Node 13182 (Seq Scan) - LEAF
...
### Step 6: Node 13171 (Seq Scan) - LEAF
...
### Step 8: Node 13180 (Seq Scan) - LEAF
...
### Step 11: Node 13177 (Index Scan) - LEAF
...
### Step 13: Node 13169 (Nested Loop)
...
### Step 17: Node 13166 (Gather Merge)
...
### Step 18: Node 13165 (Aggregate) - ROOT
