...
**Test Query:** Q7_99_seed_803995038
...
```
Node 13165 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 13166 (Gather Merge) [consumed]
    Node 13167 (Sort)
      Node 13168 (Hash Join)
        Node 13169 (Nested Loop)
          Node 13170 (Hash Join) [PATTERN: 895c6e8c]
            Node 13171 (Seq Scan) [consumed] - LEAF
            Node 13172 (Hash) [consumed]
              Node 13173 (Hash Join) [PATTERN: f4cb205a]
                Node 13174 (Seq Scan) [consumed] - LEAF
                Node 13175 (Hash) [consumed]
                  Node 13176 (Seq Scan) [consumed] - LEAF
          Node 13177 (Index Scan) - LEAF
        Node 13178 (Hash)
          Node 13179 (Hash Join) [PATTERN: f4cb205a]
            Node 13180 (Seq Scan) [consumed] - LEAF
            Node 13181 (Hash) [consumed]
              Node 13182 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 13173 | 13165, 13166, 13170, 13171, 13172, 13174, 13175, 13176, 13179, 13180, 13181, 13182 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 13179 | 13165, 13166, 13170, 13171, 13172, 13173, 13174, 13175, 13176, 13180, 13181, 13182 |
| Aggregate -> Gather Merge (Out | 2724c080 | 13165 | 13166, 13170, 13171, 13172, 13173, 13174, 13175, 13176, 13179, 13180, 13181, 13182 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 13170 | 13165, 13166, 13171, 13172, 13173, 13174, 13175, 13176, 13179, 13180, 13181, 13182 |
...
|------|------|--------|-----------|-----|--------|
| 13165 | Aggregate | 1209.04 | 1163.13 | 3.8% | pattern |
| 13167 | Sort | 1199.75 | 1109.16 | 7.6% | operator |
| 13168 | Hash Join | 1199.15 | 843.11 | 29.7% | operator |
| 13169 | Nested Loop | 1190.12 | 1215.99 | 2.2% | operator |
| 13178 | Hash | 5.36 | 27.74 | 417.2% | operator |
| 13170 | Hash Join | 214.77 | 304.89 | 42.0% | pattern |
| 13177 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 13179 | Hash Join | 5.33 | 429.36 | 7963.2% | pattern |
| 13173 | Hash Join | 34.23 | 429.38 | 1154.6% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 13173 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 13165, 13166, 13170, 13171, 13172, 13174, 13175, 13176, 13179, 13180, 13181, 13182
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5000
  - HashJoin_nt1=62500
...
### Step 2: Node 13170 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 13165, 13166, 13171, 13172, 13173, 13174, 13175, 13176, 13179, 13180, 13181, 13182
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=38710
  - HashJoin_nt1=483871
...
### Step 3: Node 13177 (Index Scan) - LEAF
...
### Step 4: Node 13179 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 13165, 13166, 13170, 13171, 13172, 13173, 13174, 13175, 13176, 13180, 13181, 13182
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=800
  - HashJoin_nt1=10000
...
### Step 9: Node 13165 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 13166, 13170, 13171, 13172, 13173, 13174, 13175, 13176, 13179, 13180, 13181, 13182
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
