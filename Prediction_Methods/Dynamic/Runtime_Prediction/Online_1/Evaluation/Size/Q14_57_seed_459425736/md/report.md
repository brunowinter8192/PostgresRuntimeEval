...
```
Node 27134 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27135 (Gather) [consumed]
    Node 27136 (Aggregate) [consumed]
      Node 27137 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27134 | 27135, 27136, 27137 |
...
|------|------|--------|-----------|-----|--------|
| 27134 | Aggregate | 816.44 | 857.11 | 5.0% | pattern |
...
### Step 4: Node 27134 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27135, 27136, 27137
- **Input Features:**
