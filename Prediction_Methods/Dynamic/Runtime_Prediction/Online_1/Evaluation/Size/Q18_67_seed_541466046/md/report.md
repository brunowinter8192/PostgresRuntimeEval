...
**Test Query:** Q18_67_seed_541466046
...
```
Node 30628 (Limit) - ROOT
  Node 30629 (Sort)
    Node 30630 (Aggregate)
      Node 30631 (Gather Merge)
        Node 30632 (Incremental Sort)
          Node 30633 (Nested Loop)
            Node 30634 (Merge Join)
              Node 30635 (Sort)
                Node 30636 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30637 (Seq Scan) [consumed] - LEAF
                  Node 30638 (Hash) [consumed]
                    Node 30639 (Aggregate)
                      Node 30640 (Index Scan) - LEAF
              Node 30641 (Sort)
                Node 30642 (Seq Scan) - LEAF
            Node 30643 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30636 | 30637, 30638 |
...
|------|------|--------|-----------|-----|--------|
| 30628 | Limit | 3065.13 | 1175.21 | 61.7% | operator |
| 30629 | Sort | 2942.80 | 1127.81 | 61.7% | operator |
| 30630 | Aggregate | 2942.75 | 1073.15 | 63.5% | operator |
| 30631 | Gather Merge | 2942.74 | 1073.95 | 63.5% | operator |
| 30632 | Incremental Sort | 2922.78 | 0.00 | 100.0% | operator |
| 30633 | Nested Loop | 2922.73 | 1111.34 | 62.0% | operator |
| 30634 | Merge Join | 2922.66 | 0.00 | 100.0% | operator |
| 30643 | Index Scan | 0.03 | 0.05 | 80.5% | operator |
| 30635 | Sort | 2854.85 | 1095.58 | 61.6% | operator |
| 30641 | Sort | 64.72 | 1074.66 | 1560.6% | operator |
| 30636 | Hash Join | 2854.83 | 471.07 | 83.5% | pattern |
| 30642 | Seq Scan | 52.65 | 18.25 | 65.3% | operator |
| 30639 | Aggregate | 2628.44 | 1073.15 | 59.2% | operator |
| 30640 | Index Scan | 2112.00 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30640 (Index Scan) - LEAF
...
### Step 3: Node 30636 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30637, 30638
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30642 (Seq Scan) - LEAF
...
### Step 7: Node 30634 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30643 (Index Scan) - LEAF
...
### Step 10: Node 30632 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30631 (Gather Merge)
