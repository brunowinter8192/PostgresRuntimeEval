...
**Test Query:** Q12_3_seed_16408062
...
```
Node 24901 (Aggregate) - ROOT
  Node 24902 (Gather Merge)
    Node 24903 (Aggregate)
      Node 24904 (Sort)
        Node 24905 (Nested Loop)
          Node 24906 (Seq Scan) - LEAF
          Node 24907 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24901 | Aggregate | 1011.53 | 919.06 | 9.1% | operator |
| 24902 | Gather Merge | 1011.51 | 1111.84 | 9.9% | operator |
| 24903 | Aggregate | 993.45 | 895.30 | 9.9% | operator |
| 24904 | Sort | 992.87 | 1092.82 | 10.1% | operator |
| 24905 | Nested Loop | 991.98 | 1127.41 | 13.7% | operator |
| 24906 | Seq Scan | 852.57 | 745.19 | 12.6% | operator |
| 24907 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24906 (Seq Scan) - LEAF
...
### Step 2: Node 24907 (Index Scan) - LEAF
...
### Step 6: Node 24902 (Gather Merge)
...
### Step 7: Node 24901 (Aggregate) - ROOT
