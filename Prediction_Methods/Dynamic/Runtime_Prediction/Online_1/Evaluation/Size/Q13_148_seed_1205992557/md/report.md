...
**Test Query:** Q13_148_seed_1205992557
...
```
Node 25734 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25735 (Aggregate) [consumed]
    Node 25736 (Aggregate)
      Node 25737 (Hash Join) [PATTERN: 895c6e8c]
        Node 25738 (Seq Scan) [consumed] - LEAF
        Node 25739 (Hash) [consumed]
          Node 25740 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25734 | 25735, 25737, 25738, 25739 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25737 | 25734, 25735, 25738, 25739 |
...
|------|------|--------|-----------|-----|--------|
| 25734 | Sort | 932.11 | 1079.94 | 15.9% | pattern |
| 25736 | Aggregate | 925.95 | 999.76 | 8.0% | operator |
| 25737 | Hash Join | 711.46 | 470.31 | 33.9% | pattern |
| 25740 | Index Only Scan | 10.16 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25740 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25737 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25734, 25735, 25738, 25739
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 25734 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25735, 25737, 25738, 25739
- **Input Features:**
