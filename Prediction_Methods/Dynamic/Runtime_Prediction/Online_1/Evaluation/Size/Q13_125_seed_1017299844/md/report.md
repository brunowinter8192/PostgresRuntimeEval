...
**Test Query:** Q13_125_seed_1017299844
...
```
Node 25559 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 25560 (Aggregate) [consumed]
    Node 25561 (Aggregate)
      Node 25562 (Hash Join) [PATTERN: 895c6e8c]
        Node 25563 (Seq Scan) [consumed] - LEAF
        Node 25564 (Hash) [consumed]
          Node 25565 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 25559 | 25560, 25562, 25563, 25564 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25562 | 25559, 25560, 25563, 25564 |
...
|------|------|--------|-----------|-----|--------|
| 25559 | Sort | 903.87 | 1079.94 | 19.5% | pattern |
| 25561 | Aggregate | 897.74 | 999.76 | 11.4% | operator |
| 25562 | Hash Join | 689.65 | 470.31 | 31.8% | pattern |
| 25565 | Index Only Scan | 11.64 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25565 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 25562 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 25559, 25560, 25563, 25564
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 25559 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 25560, 25562, 25563, 25564
- **Input Features:**
