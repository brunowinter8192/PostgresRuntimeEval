...
```
Node 8481 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 8482 (Aggregate) [consumed]
    Node 8483 (Gather Merge) [consumed]
      Node 8484 (Aggregate)
          ...
          Node 8486 (Hash Join) [consumed]
            Node 8487 (Nested Loop)
              Node 8488 (Hash Join)
                ...
                Node 8490 (Hash) [PATTERN: 444761fb]
                  Node 8491 (Hash Join) [consumed]
                    Node 8492 (Seq Scan) [consumed] - LEAF
                    Node 8493 (Hash) [consumed]
                      Node 8494 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 8490 | 8481, 8482, 8483, 8485, 8486, 8491, 8492, 8493, 8494 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 8481 | 8482, 8483, 8485, 8486, 8490, 8491, 8492, 8493, 8494 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 8485 | 8481, 8482, 8483, 8486, 8490, 8491, 8492, 8493, 8494 |
...
|------|------|--------|-----------|-----|--------|
| 8481 | Sort | 1083.90 | 2934.42 | 170.7% | pattern |
| 8484 | Aggregate | 1079.10 | 1128.78 | 4.6% | operator |
| 8485 | Sort | 1078.84 | 1835.92 | 70.2% | pattern |
| 8487 | Nested Loop | 1065.91 | 1188.42 | 11.5% | operator |
| 8499 | Hash | 4.25 | 18.67 | 339.2% | operator |
| 8488 | Hash Join | 220.24 | 253.07 | 14.9% | operator |
| 8498 | Index Scan | 0.07 | -0.22 | 397.3% | operator |
| 8500 | Seq Scan | 3.45 | 12.36 | 258.2% | operator |
| 8489 | Seq Scan | 168.94 | 159.81 | 5.4% | operator |
| 8490 | Hash | 37.56 | 46.85 | 24.7% | pattern |
| 8495 | Seq Scan | 0.01 | 11.81 | 131103.0% | operator |
| 8496 | Hash | 0.95 | 21.05 | 2109.2% | operator |
| 8497 | Seq Scan | 0.95 | 22.93 | 2319.1% | operator |
...
### Step 4: Node 8489 (Seq Scan) - LEAF
...
### Step 5: Node 8490 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 8481, 8482, 8483, 8485, 8486, 8491, 8492, 8493, 8494
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 8498 (Index Scan) - LEAF
...
### Step 8: Node 8500 (Seq Scan) - LEAF
...
### Step 11: Node 8485 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 8481, 8482, 8483, 8486, 8490, 8491, 8492, 8493, 8494
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 8481 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 8482, 8483, 8485, 8486, 8490, 8491, 8492, 8493, 8494
- **Input Features:**
