...
```
Node 12409 (Aggregate) - ROOT
  Node 12410 (Gather Merge)
    Node 12411 (Sort)
      Node 12412 (Hash Join)
        Node 12413 (Nested Loop)
          Node 12414 (Hash Join)
            Node 12415 (Seq Scan) - LEAF
            Node 12416 (Hash)
              Node 12417 (Hash Join)
                Node 12418 (Seq Scan) - LEAF
                Node 12419 (Hash)
                  Node 12420 (Seq Scan) - LEAF
          Node 12421 (Index Scan) - LEAF
        Node 12422 (Hash)
          Node 12423 (Hash Join)
            Node 12424 (Seq Scan) - LEAF
            Node 12425 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 12409 | Aggregate | 1179.22 | 1209.26 | 2.5% | operator |
| 12410 | Gather Merge | 1178.27 | 1142.98 | 3.0% | operator |
| 12411 | Sort | 1172.72 | 1109.13 | 5.4% | operator |
| 12412 | Hash Join | 1172.10 | 842.59 | 28.1% | operator |
| 12413 | Nested Loop | 1165.07 | 1216.16 | 4.4% | operator |
| 12422 | Hash | 3.34 | 17.53 | 425.2% | operator |
| 12414 | Hash Join | 216.93 | 384.47 | 77.2% | operator |
| 12421 | Index Scan | 0.03 | 0.96 | 3006.0% | operator |
| 12423 | Hash Join | 3.30 | 85.17 | 2484.2% | operator |
| 12415 | Seq Scan | 152.97 | 201.16 | 31.5% | operator |
| 12416 | Hash | 37.90 | 19.59 | 48.3% | operator |
| 12424 | Seq Scan | 2.99 | 11.47 | 283.9% | operator |
| 12425 | Hash | 0.01 | 16.89 | 112527.2% | operator |
| 12417 | Hash Join | 36.37 | 92.20 | 153.5% | operator |
| 12426 | Seq Scan | 0.01 | 45.79 | 381502.6% | operator |
| 12418 | Seq Scan | 35.24 | 21.86 | 38.0% | operator |
| 12419 | Hash | 0.01 | 16.89 | 153482.6% | operator |
| 12420 | Seq Scan | 0.01 | 45.79 | 572303.9% | operator |
...
### Step 2: Node 12418 (Seq Scan) - LEAF
...
### Step 5: Node 12426 (Seq Scan) - LEAF
...
### Step 6: Node 12415 (Seq Scan) - LEAF
...
### Step 8: Node 12424 (Seq Scan) - LEAF
...
### Step 11: Node 12421 (Index Scan) - LEAF
...
### Step 13: Node 12413 (Nested Loop)
...
### Step 17: Node 12410 (Gather Merge)
...
### Step 18: Node 12409 (Aggregate) - ROOT
