...
**Test Query:** Q18_144_seed_1173176433
...
```
Node 29588 (Limit) - ROOT
  Node 29589 (Sort)
    Node 29590 (Aggregate)
      Node 29591 (Gather Merge)
        Node 29592 (Incremental Sort)
          Node 29593 (Nested Loop)
            Node 29594 (Merge Join)
              Node 29595 (Sort)
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29596 | 29597, 29598 |
...
|------|------|--------|-----------|-----|--------|
| 29588 | Limit | 3062.37 | 1175.21 | 61.6% | operator |
| 29589 | Sort | 2948.71 | 1127.81 | 61.8% | operator |
| 29590 | Aggregate | 2948.68 | 1073.15 | 63.6% | operator |
| 29591 | Gather Merge | 2948.66 | 1073.95 | 63.6% | operator |
| 29592 | Incremental Sort | 2927.61 | 0.00 | 100.0% | operator |
| 29593 | Nested Loop | 2927.56 | 1111.34 | 62.0% | operator |
| 29594 | Merge Join | 2927.50 | 0.00 | 100.0% | operator |
| 29603 | Index Scan | 0.02 | 0.05 | 96.2% | operator |
| 29595 | Sort | 2859.75 | 1095.58 | 61.7% | operator |
| 29601 | Sort | 65.28 | 1074.66 | 1546.1% | operator |
| 29596 | Hash Join | 2859.74 | 471.07 | 83.5% | pattern |
| 29602 | Seq Scan | 53.82 | 18.25 | 66.1% | operator |
| 29599 | Aggregate | 2641.78 | 1073.15 | 59.4% | operator |
| 29600 | Index Scan | 2145.51 | 0.00 | 100.0% | operator |
...
### Step 4: Node 29602 (Seq Scan) - LEAF
...
### Step 7: Node 29594 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29603 (Index Scan) - LEAF
...
### Step 10: Node 29592 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29591 (Gather Merge)
