...
**Test Query:** Q8_70_seed_566078139
...
```
Node 15892 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 15893 (Gather Merge) [consumed]
    Node 15894 (Sort)
      Node 15895 (Hash Join)
        Node 15896 (Nested Loop)
          Node 15897 (Hash Join)
            Node 15898 (Nested Loop)
              Node 15899 (Hash Join)
                Node 15900 (Seq Scan) - LEAF
                Node 15901 (Hash) [PATTERN: 444761fb]
                  Node 15902 (Hash Join) [consumed]
                    Node 15903 (Seq Scan) [consumed] - LEAF
                    Node 15904 (Hash) [consumed]
                      Node 15905 (Hash Join) [consumed]
                        Node 15906 (Seq Scan) - LEAF
                        Node 15907 (Hash)
                          Node 15908 (Seq Scan) - LEAF
              Node 15909 (Index Scan) - LEAF
            Node 15910 (Hash)
              Node 15911 (Seq Scan) - LEAF
          Node 15912 (Index Scan) - LEAF
        Node 15913 (Hash)
          Node 15914 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 15901 | 15892, 15893, 15902, 15903, 15904, 15905 |
| Aggregate -> Gather Merge (Out | 2724c080 | 15892 | 15893, 15901, 15902, 15903, 15904, 15905 |
...
|------|------|--------|-----------|-----|--------|
| 15892 | Aggregate | 1225.98 | 1127.83 | 8.0% | pattern |
| 15894 | Sort | 1220.22 | 1046.22 | 14.3% | operator |
| 15895 | Hash Join | 1219.96 | 785.61 | 35.6% | operator |
| 15896 | Nested Loop | 1219.66 | 1198.29 | 1.8% | operator |
| 15913 | Hash | 0.01 | 13.72 | 105469.9% | operator |
| 15897 | Hash Join | 1215.97 | 785.60 | 35.4% | operator |
| 15912 | Index Scan | 0.01 | 12.42 | 206958.1% | operator |
| 15914 | Seq Scan | 0.01 | 6.51 | 65019.6% | operator |
| 15898 | Nested Loop | 1174.80 | 1198.29 | 2.0% | operator |
| 15910 | Hash | 36.63 | 19.97 | 45.5% | operator |
| 15899 | Hash Join | 213.33 | 251.67 | 18.0% | operator |
| 15909 | Index Scan | 0.04 | 2.88 | 6926.5% | operator |
| 15911 | Seq Scan | 36.56 | 48.86 | 33.6% | operator |
| 15900 | Seq Scan | 160.84 | 159.67 | 0.7% | operator |
| 15901 | Hash | 34.70 | 43.51 | 25.4% | pattern |
| 15906 | Seq Scan | 0.01 | 12.22 | 81399.6% | operator |
| 15907 | Hash | 0.30 | 18.14 | 6009.1% | operator |
| 15908 | Seq Scan | 0.29 | 23.36 | 7873.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 15908 (Seq Scan) - LEAF
...
### Step 2: Node 15906 (Seq Scan) - LEAF
...
### Step 4: Node 15900 (Seq Scan) - LEAF
...
### Step 5: Node 15901 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 15892, 15893, 15902, 15903, 15904, 15905
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 15909 (Index Scan) - LEAF
...
### Step 8: Node 15911 (Seq Scan) - LEAF
...
### Step 12: Node 15912 (Index Scan) - LEAF
...
### Step 13: Node 15914 (Seq Scan) - LEAF
...
### Step 14: Node 15896 (Nested Loop)
...
### Step 18: Node 15892 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 15893, 15901, 15902, 15903, 15904, 15905
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2524
