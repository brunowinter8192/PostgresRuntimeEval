...
```
Node 15892 (Aggregate) - ROOT
  Node 15893 (Gather Merge)
    Node 15894 (Sort)
          ...
          Node 15897 (Hash Join)
            Node 15898 (Nested Loop)
              Node 15899 (Hash Join)
                ...
                Node 15901 (Hash)
                  Node 15902 (Hash Join)
                    Node 15903 (Seq Scan) - LEAF
                    Node 15904 (Hash)
                      Node 15905 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 15892 | Aggregate | 1225.98 | 1184.88 | 3.4% | operator |
| 15893 | Gather Merge | 1225.56 | 1097.14 | 10.5% | operator |
...
| 15899 | Hash Join | 213.33 | 251.17 | 17.7% | operator |
...
| 15901 | Hash | 34.70 | 20.62 | 40.6% | operator |
| 15902 | Hash Join | 34.00 | 132.26 | 289.0% | operator |
| 15903 | Seq Scan | 32.33 | 23.03 | 28.8% | operator |
| 15904 | Hash | 0.33 | 23.66 | 7112.2% | operator |
| 15905 | Hash Join | 0.33 | 306.84 | 94311.1% | operator |
...
### Step 5: Node 15903 (Seq Scan) - LEAF
...
### Step 8: Node 15900 (Seq Scan) - LEAF
...
### Step 11: Node 15909 (Index Scan) - LEAF
...
### Step 12: Node 15911 (Seq Scan) - LEAF
...
### Step 13: Node 15898 (Nested Loop)
...
### Step 16: Node 15912 (Index Scan) - LEAF
...
### Step 17: Node 15914 (Seq Scan) - LEAF
...
### Step 18: Node 15896 (Nested Loop)
...
### Step 22: Node 15893 (Gather Merge)
...
### Step 23: Node 15892 (Aggregate) - ROOT
