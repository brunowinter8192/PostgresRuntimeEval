...
```
Node 24397 (Aggregate) - ROOT
  Node 24398 (Gather Merge)
    Node 24399 (Aggregate)
      Node 24400 (Sort)
...
|------|------|--------|-----------|-----|--------|
| 24397 | Aggregate | 986.53 | 919.06 | 6.8% | operator |
| 24398 | Gather Merge | 986.51 | 1111.84 | 12.7% | operator |
| 24399 | Aggregate | 966.82 | 895.31 | 7.4% | operator |
| 24400 | Sort | 966.21 | 1092.81 | 13.1% | operator |
| 24401 | Nested Loop | 965.22 | 1127.41 | 16.8% | operator |
| 24402 | Seq Scan | 827.13 | 745.19 | 9.9% | operator |
| 24403 | Index Scan | 0.03 | 0.07 | 176.5% | operator |
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=147531.6400
  - total_cost=147647.1700
- **Output:** st=868.96, rt=895.31

### Step 6: Node 24398 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=868.9575
  - st2=0.0000
  - startup_cost=148531.7200
  - total_cost=148651.4600
- **Output:** st=1109.22, rt=1111.84

### Step 7: Node 24397 (Aggregate) - ROOT
