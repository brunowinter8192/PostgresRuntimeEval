...
**Test Query:** Q6_75_seed_607098294
...
```
Node 10389 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10390 (Gather) [consumed]
    Node 10391 (Aggregate) [consumed]
      Node 10392 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10389 | 10390, 10391 |
...
|------|------|--------|-----------|-----|--------|
| 10389 | Aggregate | 787.95 | 849.99 | 7.9% | pattern |
| 10392 | Seq Scan | 768.07 | 748.50 | 2.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10392 (Seq Scan) - LEAF
...
### Step 2: Node 10389 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10390, 10391
- **Input Features:**
