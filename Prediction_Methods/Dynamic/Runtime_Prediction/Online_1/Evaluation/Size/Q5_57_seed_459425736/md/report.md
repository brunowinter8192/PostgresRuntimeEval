...
**Test Query:** Q5_57_seed_459425736
...
```
Node 8941 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 8942 (Aggregate) [consumed]
    Node 8943 (Gather Merge) [consumed]
      Node 8944 (Aggregate)
        Node 8945 (Sort) [PATTERN: 3e2d5a00]
          Node 8946 (Hash Join) [consumed]
            Node 8947 (Nested Loop)
              Node 8948 (Hash Join)
                Node 8949 (Seq Scan) - LEAF
                Node 8950 (Hash) [PATTERN: 444761fb]
                  Node 8951 (Hash Join) [consumed]
                    Node 8952 (Seq Scan) [consumed] - LEAF
                    Node 8953 (Hash) [consumed]
                      Node 8954 (Hash Join) [consumed]
                        Node 8955 (Seq Scan) - LEAF
                        Node 8956 (Hash)
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 8950 | 8941, 8942, 8943, 8945, 8946, 8951, 8952, 8953, 8954 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 8941 | 8942, 8943, 8945, 8946, 8950, 8951, 8952, 8953, 8954 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 8945 | 8941, 8942, 8943, 8946, 8950, 8951, 8952, 8953, 8954 |
...
|------|------|--------|-----------|-----|--------|
| 8941 | Sort | 1088.27 | 2934.42 | 169.6% | pattern |
| 8944 | Aggregate | 1083.67 | 1128.79 | 4.2% | operator |
| 8945 | Sort | 1083.41 | 1835.90 | 69.5% | pattern |
| 8947 | Nested Loop | 1070.59 | 1188.37 | 11.0% | operator |
| 8959 | Hash | 4.26 | 18.67 | 338.5% | operator |
| 8948 | Hash Join | 219.07 | 253.07 | 15.5% | operator |
| 8958 | Index Scan | 0.07 | -0.22 | 397.3% | operator |
| 8960 | Seq Scan | 3.70 | 12.36 | 234.2% | operator |
| 8949 | Seq Scan | 168.36 | 159.81 | 5.1% | operator |
| 8950 | Hash | 37.58 | 46.85 | 24.7% | pattern |
| 8955 | Seq Scan | 0.01 | 11.81 | 147503.4% | operator |
| 8956 | Hash | 0.14 | 21.05 | 14831.4% | operator |
| 8957 | Seq Scan | 0.14 | 22.93 | 16639.7% | operator |
...
### Step 2: Node 8955 (Seq Scan) - LEAF
...
### Step 4: Node 8949 (Seq Scan) - LEAF
...
### Step 5: Node 8950 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 8941, 8942, 8943, 8945, 8946, 8951, 8952, 8953, 8954
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 8958 (Index Scan) - LEAF
...
### Step 8: Node 8960 (Seq Scan) - LEAF
...
### Step 11: Node 8945 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 8941, 8942, 8943, 8946, 8950, 8951, 8952, 8953, 8954
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 8941 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 8942, 8943, 8945, 8946, 8950, 8951, 8952, 8953, 8954
- **Input Features:**
