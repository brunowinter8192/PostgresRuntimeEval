...
```
Node 14075 (Aggregate) - ROOT
  Node 14076 (Gather Merge)
    Node 14077 (Sort)
          ...
          Node 14080 (Hash Join)
            Node 14081 (Nested Loop)
              Node 14082 (Hash Join)
                ...
                Node 14084 (Hash)
                  Node 14085 (Hash Join)
                    Node 14086 (Seq Scan) - LEAF
                    Node 14087 (Hash)
                      Node 14088 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 14075 | Aggregate | 1209.19 | 1195.55 | 1.1% | operator |
| 14076 | Gather Merge | 1208.81 | 1097.15 | 9.2% | operator |
...
| 14082 | Hash Join | 215.35 | 251.17 | 16.6% | operator |
...
| 14084 | Hash | 36.60 | 20.62 | 43.7% | operator |
| 14085 | Hash Join | 35.90 | 132.26 | 268.4% | operator |
| 14086 | Seq Scan | 34.43 | 23.03 | 33.1% | operator |
| 14087 | Hash | 0.15 | 23.66 | 15463.2% | operator |
| 14088 | Hash Join | 0.15 | 306.84 | 205830.2% | operator |
...
### Step 5: Node 14086 (Seq Scan) - LEAF
...
### Step 8: Node 14083 (Seq Scan) - LEAF
...
### Step 11: Node 14092 (Index Scan) - LEAF
...
### Step 12: Node 14094 (Seq Scan) - LEAF
...
### Step 13: Node 14081 (Nested Loop)
...
### Step 16: Node 14095 (Index Scan) - LEAF
...
### Step 17: Node 14097 (Seq Scan) - LEAF
...
### Step 18: Node 14079 (Nested Loop)
...
### Step 22: Node 14076 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1044.9423
  - st2=0.0000
  - startup_cost=71549.8400
  - total_cost=71834.8400
- **Output:** st=1093.44, rt=1097.15

### Step 23: Node 14075 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=71549.8400
  - total_cost=71931.1400
- **Output:** st=1164.20, rt=1195.55
