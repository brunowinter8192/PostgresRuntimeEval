...
**Test Query:** Q19_125_seed_1017299844
...
```
Node 31409 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31410 (Gather) [consumed]
    Node 31411 (Aggregate) [consumed]
      Node 31412 (Hash Join) [consumed]
        Node 31413 (Seq Scan) - LEAF
        Node 31414 (Hash)
          Node 31415 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31409 | 31410, 31411, 31412 |
...
|------|------|--------|-----------|-----|--------|
| 31409 | Aggregate | 856.55 | 829.28 | 3.2% | pattern |
| 31413 | Seq Scan | 790.19 | 743.46 | 5.9% | operator |
| 31414 | Hash | 45.36 | 8.29 | 81.7% | operator |
| 31415 | Seq Scan | 45.21 | 23.76 | 47.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31415 (Seq Scan) - LEAF
...
### Step 2: Node 31413 (Seq Scan) - LEAF
...
### Step 4: Node 31409 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31410, 31411, 31412
- **Input Features:**
  ...
  - Aggregate_startup_cost=157339.0800
  - Aggregate_total_cost=157339.0900
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - HashJoin_Outer_total_cost=156338.3700
- **Output:** st=824.24, rt=829.28
