...
```
Node 31409 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31410 (Gather) [consumed]
    Node 31411 (Aggregate) [consumed]
      Node 31412 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31409 | 31410, 31411 |
...
|------|------|--------|-----------|-----|--------|
| 31409 | Aggregate | 856.55 | 831.20 | 3.0% | pattern |
| 31412 | Hash Join | 837.85 | 766.05 | 8.6% | operator |
...
### Step 5: Node 31409 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31410, 31411
- **Input Features:**
