...
**Test Query:** Q18_79_seed_639914418
...
```
Node 30836 (Limit) - ROOT
  Node 30837 (Sort)
    Node 30838 (Aggregate)
      Node 30839 (Gather Merge)
        Node 30840 (Incremental Sort)
          Node 30841 (Nested Loop)
            Node 30842 (Merge Join)
              Node 30843 (Sort)
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30844 | 30845, 30846 |
...
|------|------|--------|-----------|-----|--------|
| 30836 | Limit | 3042.04 | 1175.21 | 61.4% | operator |
| 30837 | Sort | 2926.55 | 1127.81 | 61.5% | operator |
| 30838 | Aggregate | 2926.51 | 1073.15 | 63.3% | operator |
| 30839 | Gather Merge | 2926.49 | 1073.95 | 63.3% | operator |
| 30840 | Incremental Sort | 2904.26 | 0.00 | 100.0% | operator |
| 30841 | Nested Loop | 2904.21 | 1111.34 | 61.7% | operator |
| 30842 | Merge Join | 2904.14 | 0.00 | 100.0% | operator |
| 30851 | Index Scan | 0.03 | 0.05 | 73.6% | operator |
| 30843 | Sort | 2833.69 | 1095.58 | 61.3% | operator |
| 30849 | Sort | 67.33 | 1074.66 | 1496.2% | operator |
| 30844 | Hash Join | 2833.68 | 471.07 | 83.4% | pattern |
| 30850 | Seq Scan | 54.21 | 18.25 | 66.3% | operator |
| 30847 | Aggregate | 2609.52 | 1073.15 | 58.9% | operator |
| 30848 | Index Scan | 2114.91 | 0.00 | 100.0% | operator |
...
### Step 4: Node 30850 (Seq Scan) - LEAF
...
### Step 7: Node 30842 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30851 (Index Scan) - LEAF
...
### Step 10: Node 30840 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30839 (Gather Merge)
