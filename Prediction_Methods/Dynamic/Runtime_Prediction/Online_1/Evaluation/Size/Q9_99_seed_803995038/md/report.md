...
**Test Query:** Q9_99_seed_803995038
...
```
Node 19334 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 19335 (Aggregate) [consumed]
    Node 19336 (Gather)
      Node 19337 (Aggregate)
        Node 19338 (Nested Loop)
          Node 19339 (Hash Join) [PATTERN: bb930825]
            Node 19340 (Seq Scan) [consumed] - LEAF
            Node 19341 (Hash) [consumed]
              Node 19342 (Hash Join) [consumed]
                Node 19343 (Hash Join)
                  Node 19344 (Nested Loop)
                    Node 19345 (Seq Scan) - LEAF
                    Node 19346 (Index Scan) - LEAF
                  Node 19347 (Hash)
                    Node 19348 (Seq Scan) - LEAF
                Node 19349 (Hash)
                  Node 19350 (Seq Scan) - LEAF
          Node 19351 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 19339 | 19334, 19335, 19340, 19341, 19342 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 19334 | 19335, 19339, 19340, 19341, 19342 |
...
|------|------|--------|-----------|-----|--------|
| 19334 | Sort | 1253.11 | 1044.29 | 16.7% | pattern |
| 19336 | Gather | 1252.41 | 965.14 | 22.9% | operator |
| 19337 | Aggregate | 1234.06 | 1141.19 | 7.5% | operator |
| 19338 | Nested Loop | 1208.53 | 1252.17 | 3.6% | operator |
| 19339 | Hash Join | 1027.35 | 134.80 | 86.9% | pattern |
| 19351 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 19343 | Hash Join | 168.46 | 837.49 | 397.1% | operator |
| 19349 | Hash | 12.43 | 14.95 | 20.3% | operator |
| 19344 | Nested Loop | 161.65 | 1251.76 | 674.4% | operator |
| 19347 | Hash | 4.81 | 15.94 | 231.6% | operator |
| 19350 | Seq Scan | 12.42 | 2.94 | 76.4% | operator |
| 19345 | Seq Scan | 20.31 | 44.30 | 118.1% | operator |
| 19346 | Index Scan | 0.08 | -1.39 | 1903.2% | operator |
| 19348 | Seq Scan | 4.35 | 9.45 | 117.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 19345 (Seq Scan) - LEAF
...
### Step 2: Node 19346 (Index Scan) - LEAF
...
### Step 3: Node 19348 (Seq Scan) - LEAF
...
### Step 6: Node 19350 (Seq Scan) - LEAF
...
### Step 9: Node 19339 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 19334, 19335, 19340, 19341, 19342
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 19351 (Index Scan) - LEAF
...
### Step 11: Node 19338 (Nested Loop)
...
### Step 14: Node 19334 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 19335, 19339, 19340, 19341, 19342
- **Input Features:**
