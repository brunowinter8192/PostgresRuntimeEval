...
```
Node 19334 (Sort) - ROOT
  Node 19335 (Aggregate)
    Node 19336 (Gather)
      Node 19337 (Aggregate)
        Node 19338 (Nested Loop)
          Node 19339 (Hash Join)
            Node 19340 (Seq Scan) - LEAF
            Node 19341 (Hash)
              Node 19342 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 19334 | Sort | 1253.11 | 1118.33 | 10.8% | operator |
| 19335 | Aggregate | 1252.99 | 896.44 | 28.5% | operator |
...
| 19339 | Hash Join | 1027.35 | 632.60 | 38.4% | operator |
| 19351 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 19340 | Seq Scan | 748.89 | 509.93 | 31.9% | operator |
| 19341 | Hash | 183.74 | 47.45 | 74.2% | operator |
| 19342 | Hash Join | 181.50 | 924.21 | 409.2% | operator |
...
### Step 10: Node 19340 (Seq Scan) - LEAF
...
### Step 13: Node 19351 (Index Scan) - LEAF
...
### Step 14: Node 19338 (Nested Loop)
