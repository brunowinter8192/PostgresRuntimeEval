...
**Test Query:** Q12_60_seed_484037829
...
```
Node 25062 (Aggregate) - ROOT
  Node 25063 (Gather Merge)
    Node 25064 (Aggregate)
      Node 25065 (Sort)
        Node 25066 (Nested Loop)
          Node 25067 (Seq Scan) - LEAF
          Node 25068 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 25062 | Aggregate | 985.74 | 919.05 | 6.8% | operator |
| 25063 | Gather Merge | 985.72 | 1111.84 | 12.8% | operator |
| 25064 | Aggregate | 966.08 | 895.30 | 7.3% | operator |
| 25065 | Sort | 965.48 | 1092.82 | 13.2% | operator |
| 25066 | Nested Loop | 964.56 | 1127.41 | 16.9% | operator |
| 25067 | Seq Scan | 825.07 | 745.19 | 9.7% | operator |
| 25068 | Index Scan | 0.03 | 0.07 | 166.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25067 (Seq Scan) - LEAF
...
### Step 2: Node 25068 (Index Scan) - LEAF
...
### Step 6: Node 25063 (Gather Merge)
...
### Step 7: Node 25062 (Aggregate) - ROOT
