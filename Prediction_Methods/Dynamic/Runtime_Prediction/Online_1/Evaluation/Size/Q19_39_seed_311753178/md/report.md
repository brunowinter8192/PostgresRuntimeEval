...
```
Node 31794 (Aggregate) [PATTERN: efde8b38] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31794 | 31795, 31796, 31797 |
...
|------|------|--------|-----------|-----|--------|
| 31794 | Aggregate | 832.68 | 829.33 | 0.4% | pattern |
| 31798 | Seq Scan | 761.63 | 743.46 | 2.4% | operator |
| 31799 | Hash | 48.11 | 8.29 | 82.8% | operator |
| 31800 | Seq Scan | 47.98 | 23.76 | 50.5% | operator |
...
### Step 4: Node 31794 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31795, 31796, 31797
- **Input Features:**
