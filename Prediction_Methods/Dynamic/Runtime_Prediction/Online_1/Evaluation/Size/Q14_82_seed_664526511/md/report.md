...
```
Node 27330 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27331 (Gather) [consumed]
    Node 27332 (Aggregate) [consumed]
      Node 27333 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27330 | 27331, 27332 |
...
|------|------|--------|-----------|-----|--------|
| 27330 | Aggregate | 822.36 | 848.39 | 3.2% | pattern |
| 27333 | Hash Join | 798.57 | 807.69 | 1.1% | operator |
...
### Step 5: Node 27330 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27331, 27332
- **Input Features:**
