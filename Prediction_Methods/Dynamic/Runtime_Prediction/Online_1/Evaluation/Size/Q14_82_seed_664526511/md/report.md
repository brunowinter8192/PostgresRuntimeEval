...
**Test Query:** Q14_82_seed_664526511
**Timestamp:** 2026-01-18 20:17:14
...
```
Node 27330 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27331 (Gather) [consumed]
    Node 27332 (Aggregate) [consumed]
      Node 27333 (Hash Join) [consumed]
        Node 27334 (Seq Scan) - LEAF
        Node 27335 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27330 | 27331, 27332, 27333 |
...
|------|------|--------|-----------|-----|--------|
| 27330 | Aggregate | 822.36 | 857.15 | 4.2% | pattern |
| 27334 | Seq Scan | 745.98 | 758.53 | 1.7% | operator |
| 27335 | Hash | 44.57 | 9.38 | 79.0% | operator |
| 27336 | Seq Scan | 38.59 | 12.70 | 67.1% | operator |
...
### Step 2: Node 27334 (Seq Scan) - LEAF
...
### Step 4: Node 27330 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27331, 27332, 27333
- **Input Features:**
