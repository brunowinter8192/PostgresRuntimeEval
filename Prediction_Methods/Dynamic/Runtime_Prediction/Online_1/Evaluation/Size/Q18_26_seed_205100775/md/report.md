...
```
Node 29908 (Limit) - ROOT
  Node 29909 (Sort)
    Node 29910 (Aggregate)
      Node 29911 (Gather Merge)
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29916 | 29917, 29918 |
...
|------|------|--------|-----------|-----|--------|
| 29908 | Limit | 3021.51 | 1175.21 | 61.1% | operator |
| 29909 | Sort | 2902.74 | 1127.81 | 61.1% | operator |
| 29910 | Aggregate | 2902.70 | 1073.15 | 63.0% | operator |
| 29911 | Gather Merge | 2902.68 | 1073.95 | 63.0% | operator |
| 29912 | Incremental Sort | 2868.10 | 0.00 | 100.0% | operator |
| 29913 | Nested Loop | 2868.05 | 1111.34 | 61.3% | operator |
| 29914 | Merge Join | 2868.00 | 0.00 | 100.0% | operator |
| 29923 | Index Scan | 0.02 | 0.05 | 165.5% | operator |
| 29915 | Sort | 2818.31 | 1095.58 | 61.1% | operator |
| 29921 | Sort | 64.04 | 1074.66 | 1578.2% | operator |
| 29916 | Hash Join | 2818.29 | 471.07 | 83.3% | pattern |
| 29922 | Seq Scan | 53.18 | 18.25 | 65.7% | operator |
| 29919 | Aggregate | 2590.52 | 1073.15 | 58.6% | operator |
| 29920 | Index Scan | 2121.08 | 0.00 | 100.0% | operator |
...
### Step 10: Node 29912 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29911 (Gather Merge)
