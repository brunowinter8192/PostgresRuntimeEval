...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18034 | 18029, 18030, 18035, 18036, 18037 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18029 | 18030, 18034, 18035, 18036, 18037 |
...
|------|------|--------|-----------|-----|--------|
| 18029 | Sort | 1200.27 | 1049.52 | 12.6% | pattern |
| 18031 | Gather | 1199.14 | 941.00 | 21.5% | operator |
| 18032 | Aggregate | 1181.13 | 1141.96 | 3.3% | operator |
| 18033 | Nested Loop | 1157.20 | 1252.17 | 8.2% | operator |
| 18034 | Hash Join | 983.91 | 134.80 | 86.3% | pattern |
| 18046 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18038 | Hash Join | 163.71 | 837.31 | 411.5% | operator |
| 18044 | Hash | 13.75 | 14.95 | 8.7% | operator |
| 18039 | Nested Loop | 156.00 | 1251.76 | 702.4% | operator |
| 18042 | Hash | 5.30 | 15.94 | 200.8% | operator |
| 18045 | Seq Scan | 13.74 | 2.94 | 78.6% | operator |
| 18040 | Seq Scan | 19.74 | 44.65 | 126.2% | operator |
| 18041 | Index Scan | 0.07 | -1.39 | 1976.3% | operator |
| 18043 | Seq Scan | 4.57 | 9.45 | 106.5% | operator |
...
### Step 6: Node 18045 (Seq Scan) - LEAF
...
### Step 9: Node 18034 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18029, 18030, 18035, 18036, 18037
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 11: Node 18033 (Nested Loop)
...
### Step 14: Node 18029 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18030, 18034, 18035, 18036, 18037
- **Input Features:**
