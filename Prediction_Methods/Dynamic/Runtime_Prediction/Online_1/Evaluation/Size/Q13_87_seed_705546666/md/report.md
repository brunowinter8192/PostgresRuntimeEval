...
**Test Query:** Q13_87_seed_705546666
...
```
Node 26315 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26316 (Aggregate) [consumed]
    Node 26317 (Aggregate)
      Node 26318 (Hash Join) [PATTERN: 895c6e8c]
        Node 26319 (Seq Scan) [consumed] - LEAF
        Node 26320 (Hash) [consumed]
          Node 26321 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26315 | 26316, 26318, 26319, 26320 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26318 | 26315, 26316, 26319, 26320 |
...
|------|------|--------|-----------|-----|--------|
| 26315 | Sort | 907.18 | 1079.94 | 19.0% | pattern |
| 26317 | Aggregate | 901.04 | 999.76 | 11.0% | operator |
| 26318 | Hash Join | 687.98 | 470.31 | 31.6% | pattern |
| 26321 | Index Only Scan | 10.05 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26321 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26318 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26315, 26316, 26319, 26320
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 26315 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26316, 26318, 26319, 26320
- **Input Features:**
