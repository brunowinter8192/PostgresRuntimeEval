...
Node 131 (Aggregate) - ROOT
  Node 132 (Gather Merge)
    Node 133 (Sort) [PATTERN: 1d35fb97]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 133 | 134 |
...
|------|------|--------|-----------|-----|--------|
| 131 | Aggregate | 958.54 | 1195.97 | 24.8% | operator |
| 132 | Gather Merge | 958.46 | 1165.93 | 21.6% | operator |
| 133 | Sort | 938.63 | 1200.82 | 27.9% | pattern |
| 135 | Seq Scan | 533.67 | 679.07 | 27.2% | operator |
...
### Step 2: Node 133 (Sort) - PATTERN ROOT
...
### Step 4: Node 131 (Aggregate) - ROOT
