...
Node 156 (Aggregate) - ROOT
  Node 157 (Gather Merge)
    Node 158 (Sort) [PATTERN: 1d35fb97]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 158 | 159 |
...
|------|------|--------|-----------|-----|--------|
| 156 | Aggregate | 954.39 | 1195.82 | 25.3% | operator |
| 157 | Gather Merge | 954.33 | 1165.89 | 22.2% | operator |
| 158 | Sort | 934.53 | 1200.25 | 28.4% | pattern |
| 160 | Seq Scan | 519.83 | 681.21 | 31.0% | operator |
...
### Step 2: Node 158 (Sort) - PATTERN ROOT
...
### Step 4: Node 156 (Aggregate) - ROOT
