...
**Test Query:** Q12_126_seed_1025503875
...
```
Node 24516 (Aggregate) - ROOT
  Node 24517 (Gather Merge)
    Node 24518 (Aggregate)
      Node 24519 (Sort)
        Node 24520 (Nested Loop)
          Node 24521 (Seq Scan) - LEAF
          Node 24522 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24516 | Aggregate | 984.17 | 919.05 | 6.6% | operator |
| 24517 | Gather Merge | 984.16 | 1111.84 | 13.0% | operator |
| 24518 | Aggregate | 966.05 | 895.30 | 7.3% | operator |
| 24519 | Sort | 965.43 | 1092.82 | 13.2% | operator |
| 24520 | Nested Loop | 964.42 | 1127.41 | 16.9% | operator |
| 24521 | Seq Scan | 831.51 | 745.19 | 10.4% | operator |
| 24522 | Index Scan | 0.03 | 0.07 | 187.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24521 (Seq Scan) - LEAF
...
### Step 2: Node 24522 (Index Scan) - LEAF
...
### Step 6: Node 24517 (Gather Merge)
...
### Step 7: Node 24516 (Aggregate) - ROOT
