...
```
Node 27253 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27254 (Gather) [consumed]
    Node 27255 (Aggregate) [consumed]
      Node 27256 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27253 | 27254, 27255, 27256 |
...
|------|------|--------|-----------|-----|--------|
| 27253 | Aggregate | 824.31 | 857.12 | 4.0% | pattern |
...
### Step 4: Node 27253 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27254, 27255, 27256
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=14581
  - HashJoin_Outer_nt1=14581
  ...
  - HashJoin_Outer_total_cost=136644.9200
