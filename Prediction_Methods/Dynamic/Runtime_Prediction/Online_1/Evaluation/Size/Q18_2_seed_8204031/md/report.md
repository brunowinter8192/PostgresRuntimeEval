...
```
Node 29972 (Limit) - ROOT
  Node 29973 (Sort)
    Node 29974 (Aggregate)
      Node 29975 (Gather Merge)
        Node 29976 (Incremental Sort)
          Node 29977 (Nested Loop)
            Node 29978 (Merge Join)
              Node 29979 (Sort)
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29980 | 29981, 29982 |
...
|------|------|--------|-----------|-----|--------|
| 29972 | Limit | 3057.34 | 1175.21 | 61.6% | operator |
| 29973 | Sort | 2944.62 | 1127.81 | 61.7% | operator |
| 29974 | Aggregate | 2944.58 | 1073.15 | 63.6% | operator |
| 29975 | Gather Merge | 2944.56 | 1073.95 | 63.5% | operator |
| 29976 | Incremental Sort | 2908.81 | 0.00 | 100.0% | operator |
| 29977 | Nested Loop | 2908.76 | 1111.34 | 61.8% | operator |
| 29978 | Merge Join | 2908.72 | 0.00 | 100.0% | operator |
| 29987 | Index Scan | 0.02 | 0.05 | 137.6% | operator |
| 29979 | Sort | 2855.94 | 1095.58 | 61.6% | operator |
| 29985 | Sort | 65.98 | 1074.66 | 1528.8% | operator |
| 29980 | Hash Join | 2855.93 | 471.07 | 83.5% | pattern |
| 29986 | Seq Scan | 52.99 | 18.25 | 65.6% | operator |
| 29983 | Aggregate | 2627.82 | 1073.15 | 59.2% | operator |
| 29984 | Index Scan | 2129.45 | 0.00 | 100.0% | operator |
...
### Step 4: Node 29986 (Seq Scan) - LEAF
...
### Step 7: Node 29978 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29987 (Index Scan) - LEAF
...
### Step 10: Node 29976 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29975 (Gather Merge)
