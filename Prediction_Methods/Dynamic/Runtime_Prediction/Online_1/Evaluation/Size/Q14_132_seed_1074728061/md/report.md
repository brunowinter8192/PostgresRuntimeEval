...
**Test Query:** Q14_132_seed_1074728061
...
```
Node 26665 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26666 (Gather) [consumed]
    Node 26667 (Aggregate) [consumed]
      Node 26668 (Hash Join) [consumed]
        Node 26669 (Seq Scan) - LEAF
        Node 26670 (Hash)
          Node 26671 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26665 | 26666, 26667, 26668 |
...
|------|------|--------|-----------|-----|--------|
| 26665 | Aggregate | 818.36 | 857.13 | 4.7% | pattern |
| 26669 | Seq Scan | 746.58 | 758.50 | 1.6% | operator |
| 26670 | Hash | 43.06 | 9.38 | 78.2% | operator |
| 26671 | Seq Scan | 37.78 | 12.70 | 66.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26671 (Seq Scan) - LEAF
...
### Step 2: Node 26669 (Seq Scan) - LEAF
...
### Step 4: Node 26665 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26666, 26667, 26668
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=15517
  - HashJoin_Outer_nt1=15517
  ...
  - HashJoin_Outer_total_cost=136647.3700
