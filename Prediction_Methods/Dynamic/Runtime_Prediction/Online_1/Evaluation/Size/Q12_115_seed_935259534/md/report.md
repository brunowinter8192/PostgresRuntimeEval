...
**Test Query:** Q12_115_seed_935259534
...
```
Node 24432 (Aggregate) - ROOT
  Node 24433 (Gather Merge)
    Node 24434 (Aggregate)
      Node 24435 (Sort)
        Node 24436 (Nested Loop)
          Node 24437 (Seq Scan) - LEAF
          Node 24438 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24432 | Aggregate | 993.98 | 919.06 | 7.5% | operator |
| 24433 | Gather Merge | 993.96 | 1111.84 | 11.9% | operator |
| 24434 | Aggregate | 973.58 | 895.30 | 8.0% | operator |
| 24435 | Sort | 972.98 | 1092.82 | 12.3% | operator |
| 24436 | Nested Loop | 971.99 | 1127.41 | 16.0% | operator |
| 24437 | Seq Scan | 835.38 | 745.19 | 10.8% | operator |
| 24438 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24437 (Seq Scan) - LEAF
...
### Step 2: Node 24438 (Index Scan) - LEAF
...
### Step 6: Node 24433 (Gather Merge)
...
### Step 7: Node 24432 (Aggregate) - ROOT
