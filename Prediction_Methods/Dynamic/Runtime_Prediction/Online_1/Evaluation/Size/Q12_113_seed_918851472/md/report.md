...
**Test Query:** Q12_113_seed_918851472
...
```
Node 24418 (Aggregate) - ROOT
  Node 24419 (Gather Merge)
    Node 24420 (Aggregate)
      Node 24421 (Sort)
        Node 24422 (Nested Loop)
          Node 24423 (Seq Scan) - LEAF
          Node 24424 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24418 | Aggregate | 988.45 | 919.08 | 7.0% | operator |
| 24419 | Gather Merge | 988.43 | 1111.84 | 12.5% | operator |
| 24420 | Aggregate | 967.51 | 895.32 | 7.5% | operator |
| 24421 | Sort | 966.65 | 1092.80 | 13.1% | operator |
| 24422 | Nested Loop | 965.57 | 1127.41 | 16.8% | operator |
| 24423 | Seq Scan | 827.94 | 745.19 | 10.0% | operator |
| 24424 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24423 (Seq Scan) - LEAF
...
### Step 2: Node 24424 (Index Scan) - LEAF
...
### Step 6: Node 24419 (Gather Merge)
...
### Step 7: Node 24418 (Aggregate) - ROOT
