...
**Test Query:** Q12_81_seed_656322480
...
```
Node 25223 (Aggregate) - ROOT
  Node 25224 (Gather Merge)
    Node 25225 (Aggregate)
      Node 25226 (Sort)
        Node 25227 (Nested Loop)
          Node 25228 (Seq Scan) - LEAF
          Node 25229 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 25223 | Aggregate | 1003.75 | 919.05 | 8.4% | operator |
| 25224 | Gather Merge | 1003.73 | 1111.84 | 10.8% | operator |
| 25225 | Aggregate | 984.05 | 895.30 | 9.0% | operator |
| 25226 | Sort | 983.43 | 1092.82 | 11.1% | operator |
| 25227 | Nested Loop | 982.41 | 1127.41 | 14.8% | operator |
| 25228 | Seq Scan | 841.94 | 745.19 | 11.5% | operator |
| 25229 | Index Scan | 0.03 | 0.07 | 166.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25228 (Seq Scan) - LEAF
...
### Step 2: Node 25229 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - st2=0.1246
  - startup_cost=0.4300
  - total_cost=147193.5300
- **Output:** st=38.32, rt=1127.41

### Step 4: Node 25226 (Sort)
...
- **Input Features:**
  ...
  - st1=38.3226
  - st2=0.0000
  - startup_cost=147555.9500
  - total_cost=147570.4400
- **Output:** st=1092.41, rt=1092.82

### Step 5: Node 25225 (Aggregate)
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=147555.9500
  - total_cost=147671.9800
- **Output:** st=868.94, rt=895.30

### Step 6: Node 25224 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=868.9407
  - st2=0.0000
  - startup_cost=148556.0200
  - total_cost=148676.2700
- **Output:** st=1109.22, rt=1111.84

### Step 7: Node 25223 (Aggregate) - ROOT
