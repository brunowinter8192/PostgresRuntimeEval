...
**Test Query:** Q9_55_seed_443017674
...
```
Node 18462 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18463 (Aggregate) [consumed]
    Node 18464 (Gather)
      Node 18465 (Aggregate)
        Node 18466 (Nested Loop)
          Node 18467 (Hash Join) [PATTERN: bb930825]
            Node 18468 (Seq Scan) [consumed] - LEAF
            Node 18469 (Hash) [consumed]
              Node 18470 (Hash Join) [consumed]
                Node 18471 (Hash Join)
                  Node 18472 (Nested Loop)
                    Node 18473 (Seq Scan) - LEAF
                    Node 18474 (Index Scan) - LEAF
                  Node 18475 (Hash)
                    Node 18476 (Seq Scan) - LEAF
                Node 18477 (Hash)
                  Node 18478 (Seq Scan) - LEAF
          Node 18479 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18467 | 18462, 18463, 18468, 18469, 18470 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18462 | 18463, 18467, 18468, 18469, 18470 |
...
|------|------|--------|-----------|-----|--------|
| 18462 | Sort | 1176.84 | 1044.54 | 11.2% | pattern |
| 18464 | Gather | 1175.39 | 965.01 | 17.9% | operator |
| 18465 | Aggregate | 1155.47 | 1129.15 | 2.3% | operator |
| 18466 | Nested Loop | 1130.18 | 1252.17 | 10.8% | operator |
| 18467 | Hash Join | 955.17 | 134.80 | 85.9% | pattern |
| 18479 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18471 | Hash Join | 161.52 | 837.52 | 418.5% | operator |
| 18477 | Hash | 13.69 | 14.95 | 9.2% | operator |
| 18472 | Nested Loop | 154.92 | 1251.76 | 708.0% | operator |
| 18475 | Hash | 4.75 | 15.94 | 235.9% | operator |
| 18478 | Seq Scan | 13.68 | 2.94 | 78.5% | operator |
| 18473 | Seq Scan | 19.89 | 44.23 | 122.5% | operator |
| 18474 | Index Scan | 0.07 | -1.39 | 1976.3% | operator |
| 18476 | Seq Scan | 4.26 | 9.45 | 121.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 18473 (Seq Scan) - LEAF
...
### Step 2: Node 18474 (Index Scan) - LEAF
...
### Step 3: Node 18476 (Seq Scan) - LEAF
...
### Step 6: Node 18478 (Seq Scan) - LEAF
...
### Step 9: Node 18467 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18462, 18463, 18468, 18469, 18470
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18479 (Index Scan) - LEAF
...
### Step 11: Node 18466 (Nested Loop)
...
### Step 14: Node 18462 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18463, 18467, 18468, 18469, 18470
- **Input Features:**
