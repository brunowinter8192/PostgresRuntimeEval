...
```
Node 18462 (Sort) - ROOT
  Node 18463 (Aggregate)
    Node 18464 (Gather)
      Node 18465 (Aggregate)
        Node 18466 (Nested Loop)
          Node 18467 (Hash Join)
            Node 18468 (Seq Scan) - LEAF
            Node 18469 (Hash)
              Node 18470 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 18462 | Sort | 1176.84 | 1118.63 | 4.9% | operator |
| 18463 | Aggregate | 1176.71 | 896.66 | 23.8% | operator |
...
| 18467 | Hash Join | 955.17 | 632.78 | 33.8% | operator |
| 18479 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18468 | Seq Scan | 685.42 | 509.93 | 25.6% | operator |
| 18469 | Hash | 177.57 | 47.56 | 73.2% | operator |
| 18470 | Hash Join | 175.87 | 924.26 | 425.6% | operator |
...
### Step 10: Node 18468 (Seq Scan) - LEAF
...
### Step 13: Node 18479 (Index Scan) - LEAF
...
### Step 14: Node 18466 (Nested Loop)
