...
**Test Query:** Q8_106_seed_861423255
...
```
Node 13339 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 13340 (Gather Merge) [consumed]
    Node 13341 (Sort)
      Node 13342 (Hash Join)
        Node 13343 (Nested Loop)
          Node 13344 (Hash Join)
            Node 13345 (Nested Loop)
              Node 13346 (Hash Join)
                Node 13347 (Seq Scan) - LEAF
                Node 13348 (Hash) [PATTERN: 444761fb]
                  Node 13349 (Hash Join) [consumed]
                    Node 13350 (Seq Scan) [consumed] - LEAF
                    Node 13351 (Hash) [consumed]
                      Node 13352 (Hash Join) [consumed]
                        Node 13353 (Seq Scan) - LEAF
                        Node 13354 (Hash)
                          Node 13355 (Seq Scan) - LEAF
              Node 13356 (Index Scan) - LEAF
            Node 13357 (Hash)
              Node 13358 (Seq Scan) - LEAF
          Node 13359 (Index Scan) - LEAF
        Node 13360 (Hash)
          Node 13361 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 13348 | 13339, 13340, 13349, 13350, 13351, 13352 |
| Aggregate -> Gather Merge (Out | 2724c080 | 13339 | 13340, 13348, 13349, 13350, 13351, 13352 |
...
|------|------|--------|-----------|-----|--------|
| 13339 | Aggregate | 1180.90 | 1133.65 | 4.0% | pattern |
| 13341 | Sort | 1175.53 | 1046.21 | 11.0% | operator |
| 13342 | Hash Join | 1175.29 | 785.61 | 33.2% | operator |
| 13343 | Nested Loop | 1174.97 | 1198.29 | 2.0% | operator |
| 13360 | Hash | 0.02 | 13.72 | 85675.5% | operator |
| 13344 | Hash Join | 1171.46 | 785.60 | 32.9% | operator |
| 13359 | Index Scan | 0.01 | 12.42 | 206958.1% | operator |
| 13361 | Seq Scan | 0.01 | 6.51 | 54166.4% | operator |
| 13345 | Nested Loop | 1130.40 | 1198.29 | 6.0% | operator |
| 13357 | Hash | 36.70 | 19.97 | 45.6% | operator |
| 13346 | Hash Join | 204.48 | 251.67 | 23.1% | operator |
| 13356 | Index Scan | 0.04 | 2.88 | 7102.1% | operator |
| 13358 | Seq Scan | 36.57 | 48.89 | 33.7% | operator |
| 13347 | Seq Scan | 157.73 | 159.67 | 1.2% | operator |
| 13348 | Hash | 29.36 | 43.51 | 48.2% | pattern |
| 13353 | Seq Scan | 0.01 | 12.22 | 87221.0% | operator |
| 13354 | Hash | 0.18 | 18.14 | 9760.9% | operator |
| 13355 | Seq Scan | 0.18 | 23.36 | 12879.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 13355 (Seq Scan) - LEAF
...
### Step 2: Node 13353 (Seq Scan) - LEAF
...
### Step 4: Node 13347 (Seq Scan) - LEAF
...
### Step 5: Node 13348 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 13339, 13340, 13349, 13350, 13351, 13352
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 13356 (Index Scan) - LEAF
...
### Step 8: Node 13358 (Seq Scan) - LEAF
...
### Step 12: Node 13359 (Index Scan) - LEAF
...
### Step 13: Node 13361 (Seq Scan) - LEAF
...
### Step 14: Node 13343 (Nested Loop)
...
### Step 18: Node 13339 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 13340, 13348, 13349, 13350, 13351, 13352
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2329
  - Aggregate_nt1=2329
