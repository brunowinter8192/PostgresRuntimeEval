    ...
    Node 20568 (Aggregate) [consumed]
      Node 20569 (Gather) [consumed]
        Node 20570 (Hash Join)
          Node 20571 (Hash Join)
            Node 20572 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20566 | 20567, 20568, 20569 |
...
| 20570 | Hash Join | 1109.95 | 1007.26 | 9.3% | operator |
| 20571 | Hash Join | 1107.05 | 1004.20 | 9.3% | operator |
| 20577 | Hash | 0.02 | 15.71 | 78453.9% | operator |
| 20572 | Nested Loop | 1061.19 | 1204.78 | 13.5% | operator |
| 20575 | Hash | 35.70 | 55.57 | 55.7% | operator |
...
### Step 6: Node 20578 (Seq Scan) - LEAF
...
- **Output:** st=109.69, rt=1004.20

### Step 8: Node 20577 (Hash)
...
- **Output:** st=98.89, rt=1007.26

### Step 10: Node 20566 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20567, 20568, 20569
- **Input Features:**
