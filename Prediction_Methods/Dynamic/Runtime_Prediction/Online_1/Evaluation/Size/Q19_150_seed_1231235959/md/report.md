...
```
Node 31605 (Aggregate) [PATTERN: efde8b38] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31605 | 31606, 31607, 31608 |
...
|------|------|--------|-----------|-----|--------|
| 31605 | Aggregate | 825.38 | 829.30 | 0.5% | pattern |
...
### Step 4: Node 31605 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31606, 31607, 31608
- **Input Features:**
