...
**Test Query:** Q3_53_seed_426609612
...
```
Node 5331 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5332 (Sort) [consumed]
    Node 5333 (Aggregate) [consumed]
      Node 5334 (Gather) [consumed]
        Node 5335 (Nested Loop)
          Node 5336 (Hash Join) [PATTERN: 895c6e8c]
            Node 5337 (Seq Scan) [consumed] - LEAF
            Node 5338 (Hash) [consumed]
              Node 5339 (Seq Scan) - LEAF
          Node 5340 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5331 | 5332, 5333, 5334, 5336, 5337, 5338 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5336 | 5331, 5332, 5333, 5334, 5337, 5338 |
...
|------|------|--------|-----------|-----|--------|
| 5331 | Limit | 1211.73 | 1151.18 | 5.0% | pattern |
| 5335 | Nested Loop | 1172.37 | 1192.96 | 1.8% | operator |
| 5336 | Hash Join | 213.17 | 242.46 | 13.7% | pattern |
| 5340 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5339 | Seq Scan | 31.05 | 38.57 | 24.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5339 (Seq Scan) - LEAF
...
### Step 2: Node 5336 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5331, 5332, 5333, 5334, 5337, 5338
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46779
  - HashJoin_nt1=234294
  ...
  - HashJoin_total_cost=37336.6700
  - Hash_Inner_np=0
  - Hash_Inner_nt=12479
...
### Step 3: Node 5340 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=72793.1500
- **Output:** st=121.72, rt=1192.96

### Step 5: Node 5331 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5332, 5333, 5334, 5336, 5337, 5338
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=313270
  - Aggregate_Outer_nt1=313270
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=109819.2000
  - Aggregate_Outer_total_cost=113735.0700
  - Gather_Outer_np=0
  - Gather_Outer_nt=313270
  - Gather_Outer_nt1=101055
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105120.1500
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=313270
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=120504.7200
  - Limit_total_cost=120504.7500
  - Sort_Outer_np=0
  - Sort_Outer_nt=313270
  - Sort_Outer_nt1=313270
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=120504.7200
  - Sort_Outer_total_cost=121287.9000
