...
**Test Query:** Q19_68_seed_549670077
...
```
Node 32018 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 32019 (Gather) [consumed]
    Node 32020 (Aggregate) [consumed]
      Node 32021 (Hash Join)
        Node 32022 (Seq Scan) - LEAF
        Node 32023 (Hash)
          Node 32024 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 32018 | 32019, 32020 |
...
|------|------|--------|-----------|-----|--------|
| 32018 | Aggregate | 845.92 | 831.20 | 1.7% | pattern |
| 32021 | Hash Join | 825.21 | 766.05 | 7.2% | operator |
| 32022 | Seq Scan | 776.53 | 743.46 | 4.3% | operator |
| 32023 | Hash | 46.75 | 8.29 | 82.3% | operator |
| 32024 | Seq Scan | 46.59 | 23.76 | 49.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 32024 (Seq Scan) - LEAF
...
### Step 2: Node 32022 (Seq Scan) - LEAF
...
### Step 5: Node 32018 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 32019, 32020
- **Input Features:**
