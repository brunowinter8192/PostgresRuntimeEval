...
```
Node 32018 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 32019 (Gather) [consumed]
    Node 32020 (Aggregate) [consumed]
      Node 32021 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 32018 | 32019, 32020, 32021 |
...
|------|------|--------|-----------|-----|--------|
| 32018 | Aggregate | 845.92 | 829.29 | 2.0% | pattern |
...
### Step 4: Node 32018 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 32019, 32020, 32021
- **Input Features:**
