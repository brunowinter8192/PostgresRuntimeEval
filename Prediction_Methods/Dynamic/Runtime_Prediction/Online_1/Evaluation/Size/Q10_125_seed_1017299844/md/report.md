    ...
    Node 19723 (Aggregate) [consumed]
      Node 19724 (Gather) [consumed]
        Node 19725 (Hash Join)
          Node 19726 (Hash Join)
            Node 19727 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19721 | 19722, 19723, 19724 |
...
| 19725 | Hash Join | 1064.93 | 1007.14 | 5.4% | operator |
| 19726 | Hash Join | 1062.05 | 1003.99 | 5.5% | operator |
| 19732 | Hash | 0.02 | 15.71 | 98092.3% | operator |
| 19727 | Nested Loop | 1015.21 | 1204.86 | 18.7% | operator |
| 19730 | Hash | 36.30 | 55.57 | 53.1% | operator |
...
### Step 6: Node 19733 (Seq Scan) - LEAF
...
### Step 10: Node 19721 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19722, 19723, 19724
- **Input Features:**
