...
```
Node 8781 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 8782 (Aggregate) [consumed]
    Node 8783 (Gather Merge) [consumed]
      Node 8784 (Aggregate)
        Node 8785 (Sort) [PATTERN: 3e2d5a00]
          Node 8786 (Hash Join) [consumed]
            Node 8787 (Nested Loop)
              Node 8788 (Hash Join)
                Node 8789 (Seq Scan) - LEAF
                Node 8790 (Hash) [PATTERN: 444761fb]
                  Node 8791 (Hash Join) [consumed]
                    Node 8792 (Seq Scan) [consumed] - LEAF
                    Node 8793 (Hash) [consumed]
                      Node 8794 (Hash Join) [consumed]
                        Node 8795 (Seq Scan) - LEAF
                        Node 8796 (Hash)
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 8790 | 8781, 8782, 8783, 8785, 8786, 8791, 8792, 8793, 8794 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 8781 | 8782, 8783, 8785, 8786, 8790, 8791, 8792, 8793, 8794 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 8785 | 8781, 8782, 8783, 8786, 8790, 8791, 8792, 8793, 8794 |
...
|------|------|--------|-----------|-----|--------|
| 8781 | Sort | 1070.05 | 2934.42 | 174.2% | pattern |
| 8784 | Aggregate | 1065.55 | 1128.79 | 5.9% | operator |
| 8785 | Sort | 1065.28 | 1835.90 | 72.3% | pattern |
| 8787 | Nested Loop | 1048.82 | 1188.37 | 13.3% | operator |
| 8799 | Hash | 7.89 | 18.67 | 136.6% | operator |
| 8788 | Hash Join | 211.08 | 253.07 | 19.9% | operator |
| 8798 | Index Scan | 0.07 | -0.22 | 397.3% | operator |
| 8800 | Seq Scan | 7.39 | 12.36 | 67.3% | operator |
| 8789 | Seq Scan | 166.80 | 159.81 | 4.2% | operator |
| 8790 | Hash | 31.45 | 46.85 | 49.0% | pattern |
| 8795 | Seq Scan | 0.01 | 11.81 | 147503.4% | operator |
| 8796 | Hash | 0.06 | 21.05 | 36835.5% | operator |
| 8797 | Seq Scan | 0.06 | 22.93 | 41597.0% | operator |
...
### Step 2: Node 8795 (Seq Scan) - LEAF
...
### Step 4: Node 8789 (Seq Scan) - LEAF
...
### Step 5: Node 8790 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 8781, 8782, 8783, 8785, 8786, 8791, 8792, 8793, 8794
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 8798 (Index Scan) - LEAF
...
### Step 8: Node 8800 (Seq Scan) - LEAF
...
### Step 11: Node 8785 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 8781, 8782, 8783, 8786, 8790, 8791, 8792, 8793, 8794
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 8781 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 8782, 8783, 8785, 8786, 8790, 8791, 8792, 8793, 8794
- **Input Features:**
