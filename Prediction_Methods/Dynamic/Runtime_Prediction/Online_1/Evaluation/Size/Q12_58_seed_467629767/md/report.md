...
**Test Query:** Q12_58_seed_467629767
...
```
Node 25041 (Aggregate) - ROOT
  Node 25042 (Gather Merge)
    Node 25043 (Aggregate)
      Node 25044 (Sort)
        Node 25045 (Nested Loop)
          Node 25046 (Seq Scan) - LEAF
          Node 25047 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 25041 | Aggregate | 979.79 | 919.05 | 6.2% | operator |
| 25042 | Gather Merge | 979.77 | 1111.84 | 13.5% | operator |
| 25043 | Aggregate | 960.01 | 895.30 | 6.7% | operator |
| 25044 | Sort | 959.37 | 1092.82 | 13.9% | operator |
| 25045 | Nested Loop | 958.35 | 1127.41 | 17.6% | operator |
| 25046 | Seq Scan | 832.06 | 745.19 | 10.4% | operator |
| 25047 | Index Scan | 0.02 | 0.07 | 199.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25046 (Seq Scan) - LEAF
...
### Step 2: Node 25047 (Index Scan) - LEAF
...
### Step 6: Node 25042 (Gather Merge)
...
### Step 7: Node 25041 (Aggregate) - ROOT
