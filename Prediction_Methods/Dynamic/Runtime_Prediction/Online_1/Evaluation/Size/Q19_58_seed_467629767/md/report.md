...
**Test Query:** Q19_58_seed_467629767
**Timestamp:** 2026-01-18 20:38:07
...
```
Node 31941 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31942 (Gather) [consumed]
    Node 31943 (Aggregate) [consumed]
      Node 31944 (Hash Join) [consumed]
        Node 31945 (Seq Scan) - LEAF
        Node 31946 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31941 | 31942, 31943, 31944 |
...
|------|------|--------|-----------|-----|--------|
| 31941 | Aggregate | 830.55 | 829.28 | 0.2% | pattern |
| 31945 | Seq Scan | 761.95 | 743.46 | 2.4% | operator |
| 31946 | Hash | 46.07 | 8.29 | 82.0% | operator |
| 31947 | Seq Scan | 45.98 | 23.76 | 48.3% | operator |
...
### Step 2: Node 31945 (Seq Scan) - LEAF
...
### Step 4: Node 31941 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31942, 31943, 31944
- **Input Features:**
