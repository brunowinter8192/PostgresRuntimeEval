...
```
Node 31941 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31942 (Gather) [consumed]
    Node 31943 (Aggregate) [consumed]
      Node 31944 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31941 | 31942, 31943 |
...
|------|------|--------|-----------|-----|--------|
| 31941 | Aggregate | 830.55 | 831.20 | 0.1% | pattern |
| 31944 | Hash Join | 809.96 | 766.06 | 5.4% | operator |
...
### Step 5: Node 31941 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31942, 31943
- **Input Features:**
