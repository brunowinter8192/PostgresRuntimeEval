...
```
Node 8061 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 8062 (Aggregate) [consumed]
    Node 8063 (Gather Merge) [consumed]
      Node 8064 (Aggregate)
        Node 8065 (Sort) [PATTERN: 3e2d5a00]
          Node 8066 (Hash Join) [consumed]
            Node 8067 (Nested Loop)
              Node 8068 (Hash Join)
                Node 8069 (Seq Scan) - LEAF
                Node 8070 (Hash) [PATTERN: 444761fb]
                  Node 8071 (Hash Join) [consumed]
                    Node 8072 (Seq Scan) [consumed] - LEAF
                    Node 8073 (Hash) [consumed]
                      Node 8074 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 8070 | 8061, 8062, 8063, 8065, 8066, 8071, 8072, 8073, 8074 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 8061 | 8062, 8063, 8065, 8066, 8070, 8071, 8072, 8073, 8074 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 8065 | 8061, 8062, 8063, 8066, 8070, 8071, 8072, 8073, 8074 |
...
|------|------|--------|-----------|-----|--------|
| 8061 | Sort | 1070.91 | 2934.42 | 174.0% | pattern |
| 8064 | Aggregate | 1065.91 | 1128.76 | 5.9% | operator |
| 8065 | Sort | 1065.63 | 1835.93 | 72.3% | pattern |
| 8067 | Nested Loop | 1053.41 | 1188.47 | 12.8% | operator |
| 8079 | Hash | 3.69 | 18.67 | 406.7% | operator |
| 8068 | Hash Join | 219.78 | 253.07 | 15.1% | operator |
| 8078 | Index Scan | 0.07 | -0.22 | 401.4% | operator |
| 8080 | Seq Scan | 3.11 | 12.36 | 297.4% | operator |
| 8069 | Seq Scan | 169.11 | 159.81 | 5.5% | operator |
| 8070 | Hash | 37.36 | 46.85 | 25.4% | pattern |
| 8075 | Seq Scan | 0.01 | 11.81 | 131103.0% | operator |
| 8076 | Hash | 0.05 | 21.05 | 39623.1% | operator |
| 8077 | Seq Scan | 0.05 | 22.93 | 44867.3% | operator |
...
### Step 4: Node 8069 (Seq Scan) - LEAF
...
### Step 5: Node 8070 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 8061, 8062, 8063, 8065, 8066, 8071, 8072, 8073, 8074
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 8078 (Index Scan) - LEAF
...
### Step 8: Node 8080 (Seq Scan) - LEAF
...
### Step 11: Node 8065 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 8061, 8062, 8063, 8066, 8070, 8071, 8072, 8073, 8074
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 8061 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 8062, 8063, 8065, 8066, 8070, 8071, 8072, 8073, 8074
- **Input Features:**
