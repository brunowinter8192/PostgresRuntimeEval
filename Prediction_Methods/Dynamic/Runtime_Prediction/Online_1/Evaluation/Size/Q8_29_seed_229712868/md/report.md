...
```
Node 14834 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 14835 (Gather Merge) [consumed]
    Node 14836 (Sort)
          ...
          Node 14839 (Hash Join)
            Node 14840 (Nested Loop)
              Node 14841 (Hash Join)
                ...
                Node 14843 (Hash) [PATTERN: 444761fb]
                  Node 14844 (Hash Join) [consumed]
                    Node 14845 (Seq Scan) [consumed] - LEAF
                    Node 14846 (Hash) [consumed]
                      Node 14847 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 14843 | 14834, 14835, 14844, 14845, 14846, 14847 |
| Aggregate -> Gather Merge (Out | 2724c080 | 14834 | 14835, 14843, 14844, 14845, 14846, 14847 |
...
|------|------|--------|-----------|-----|--------|
| 14834 | Aggregate | 1195.43 | 1131.71 | 5.3% | pattern |
...
| 14841 | Hash Join | 205.86 | 251.67 | 22.3% | operator |
...
| 14843 | Hash | 30.75 | 43.51 | 41.5% | pattern |
...
### Step 4: Node 14842 (Seq Scan) - LEAF
...
### Step 5: Node 14843 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 14834, 14835, 14844, 14845, 14846, 14847
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 14851 (Index Scan) - LEAF
...
### Step 8: Node 14853 (Seq Scan) - LEAF
...
### Step 12: Node 14854 (Index Scan) - LEAF
...
### Step 13: Node 14856 (Seq Scan) - LEAF
...
### Step 14: Node 14838 (Nested Loop)
...
### Step 18: Node 14834 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 14835, 14843, 14844, 14845, 14846, 14847
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2444
