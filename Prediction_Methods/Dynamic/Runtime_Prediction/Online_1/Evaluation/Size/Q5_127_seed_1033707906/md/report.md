...
```
Node 7481 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 7482 (Aggregate) [consumed]
    Node 7483 (Gather Merge) [consumed]
      Node 7484 (Aggregate)
        Node 7485 (Sort) [PATTERN: 3e2d5a00]
          Node 7486 (Hash Join) [consumed]
            Node 7487 (Nested Loop)
              Node 7488 (Hash Join)
                Node 7489 (Seq Scan) - LEAF
                Node 7490 (Hash) [PATTERN: 444761fb]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 7490 | 7481, 7482, 7483, 7485, 7486, 7491, 7492, 7493, 7494 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 7481 | 7482, 7483, 7485, 7486, 7490, 7491, 7492, 7493, 7494 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 7485 | 7481, 7482, 7483, 7486, 7490, 7491, 7492, 7493, 7494 |
...
|------|------|--------|-----------|-----|--------|
| 7481 | Sort | 1066.07 | 2934.42 | 175.3% | pattern |
| 7484 | Aggregate | 1060.91 | 1128.74 | 6.4% | operator |
| 7485 | Sort | 1060.66 | 1835.96 | 73.1% | pattern |
| 7487 | Nested Loop | 1048.04 | 1188.57 | 13.4% | operator |
| 7499 | Hash | 3.59 | 18.67 | 420.2% | operator |
| 7488 | Hash Join | 220.12 | 253.07 | 15.0% | operator |
| 7498 | Index Scan | 0.07 | -0.22 | 401.4% | operator |
| 7500 | Seq Scan | 3.05 | 12.36 | 305.1% | operator |
| 7489 | Seq Scan | 170.26 | 159.81 | 6.1% | operator |
| 7490 | Hash | 36.63 | 46.85 | 27.9% | pattern |
...
- **Consumes:** Nodes 7481, 7482, 7483, 7485, 7486, 7491, 7492, 7493, 7494
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 11: Node 7485 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 7481, 7482, 7483, 7486, 7490, 7491, 7492, 7493, 7494
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 7481 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 7482, 7483, 7485, 7486, 7490, 7491, 7492, 7493, 7494
- **Input Features:**
