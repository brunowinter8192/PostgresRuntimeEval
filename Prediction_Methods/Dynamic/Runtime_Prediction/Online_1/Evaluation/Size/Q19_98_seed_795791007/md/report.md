...
**Test Query:** Q19_98_seed_795791007
...
```
Node 32249 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 32250 (Gather) [consumed]
    Node 32251 (Aggregate) [consumed]
      Node 32252 (Hash Join) [consumed]
        Node 32253 (Seq Scan) - LEAF
        Node 32254 (Hash)
          Node 32255 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 32249 | 32250, 32251, 32252 |
...
|------|------|--------|-----------|-----|--------|
| 32249 | Aggregate | 856.53 | 829.30 | 3.2% | pattern |
| 32253 | Seq Scan | 787.70 | 743.46 | 5.6% | operator |
| 32254 | Hash | 46.02 | 8.29 | 82.0% | operator |
| 32255 | Seq Scan | 45.88 | 23.76 | 48.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 32255 (Seq Scan) - LEAF
...
### Step 2: Node 32253 (Seq Scan) - LEAF
...
### Step 4: Node 32249 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 32250, 32251, 32252
- **Input Features:**
  ...
  - HashJoin_Outer_total_cost=156338.4700
