        ...
        Node 29608 (Incremental Sort)
          Node 29609 (Nested Loop)
            Node 29610 (Merge Join)
              Node 29611 (Sort)
                Node 29612 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29613 (Seq Scan) [consumed] - LEAF
                  Node 29614 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29612 | 29613, 29614 |
...
| 29611 | Sort | 2855.95 | 1095.58 | 61.6% | operator |
| 29617 | Sort | 64.69 | 1074.66 | 1561.3% | operator |
| 29612 | Hash Join | 2855.93 | 471.07 | 83.5% | pattern |
...
### Step 3: Node 29612 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29613, 29614
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29618 (Seq Scan) - LEAF
...
### Step 7: Node 29610 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29619 (Index Scan) - LEAF
...
### Step 10: Node 29608 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29607 (Gather Merge)
