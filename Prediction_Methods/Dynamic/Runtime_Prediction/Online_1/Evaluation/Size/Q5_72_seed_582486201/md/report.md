...
**Test Query:** Q5_72_seed_582486201
...
```
Node 9281 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 9282 (Aggregate) [consumed]
    Node 9283 (Gather Merge) [consumed]
      Node 9284 (Aggregate)
        Node 9285 (Sort) [PATTERN: 3e2d5a00]
          Node 9286 (Hash Join) [consumed]
            Node 9287 (Nested Loop)
              Node 9288 (Hash Join)
                Node 9289 (Seq Scan) - LEAF
                Node 9290 (Hash) [PATTERN: 444761fb]
                  Node 9291 (Hash Join) [consumed]
                    Node 9292 (Seq Scan) [consumed] - LEAF
                    Node 9293 (Hash) [consumed]
                      Node 9294 (Hash Join) [consumed]
                        Node 9295 (Seq Scan) - LEAF
                        Node 9296 (Hash)
                          Node 9297 (Seq Scan) - LEAF
              Node 9298 (Index Scan) - LEAF
            Node 9299 (Hash)
              Node 9300 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 9290 | 9281, 9282, 9283, 9285, 9286, 9291, 9292, 9293, 9294 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 9281 | 9282, 9283, 9285, 9286, 9290, 9291, 9292, 9293, 9294 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 9285 | 9281, 9282, 9283, 9286, 9290, 9291, 9292, 9293, 9294 |
...
|------|------|--------|-----------|-----|--------|
| 9281 | Sort | 1092.63 | 2934.42 | 168.6% | pattern |
| 9284 | Aggregate | 1087.87 | 1128.74 | 3.8% | operator |
| 9285 | Sort | 1087.62 | 1835.96 | 68.8% | pattern |
| 9287 | Nested Loop | 1072.78 | 1188.57 | 10.8% | operator |
| 9299 | Hash | 4.92 | 18.67 | 279.5% | operator |
| 9288 | Hash Join | 217.86 | 253.07 | 16.2% | operator |
| 9298 | Index Scan | 0.07 | -0.22 | 401.4% | operator |
| 9300 | Seq Scan | 4.38 | 12.36 | 181.9% | operator |
| 9289 | Seq Scan | 166.36 | 159.81 | 3.9% | operator |
| 9290 | Hash | 38.22 | 46.85 | 22.6% | pattern |
| 9295 | Seq Scan | 0.21 | 11.81 | 5523.0% | operator |
| 9296 | Hash | 0.06 | 21.05 | 37495.1% | operator |
| 9297 | Seq Scan | 0.05 | 22.93 | 43170.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 9297 (Seq Scan) - LEAF
...
### Step 2: Node 9295 (Seq Scan) - LEAF
...
### Step 4: Node 9289 (Seq Scan) - LEAF
...
### Step 5: Node 9290 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 9281, 9282, 9283, 9285, 9286, 9291, 9292, 9293, 9294
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 9298 (Index Scan) - LEAF
...
### Step 8: Node 9300 (Seq Scan) - LEAF
...
### Step 11: Node 9285 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 9281, 9282, 9283, 9286, 9290, 9291, 9292, 9293, 9294
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 9281 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 9282, 9283, 9285, 9286, 9290, 9291, 9292, 9293, 9294
- **Input Features:**
