...
```
Node 17629 (Sort) - ROOT
  Node 17630 (Aggregate)
    Node 17631 (Gather)
      Node 17632 (Aggregate)
        Node 17633 (Nested Loop)
          Node 17634 (Hash Join)
            Node 17635 (Seq Scan) - LEAF
            Node 17636 (Hash)
              Node 17637 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 17629 | Sort | 1193.69 | 1116.22 | 6.5% | operator |
| 17630 | Aggregate | 1193.55 | 901.35 | 24.5% | operator |
...
| 17634 | Hash Join | 976.33 | 631.63 | 35.3% | operator |
| 17646 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17635 | Seq Scan | 700.16 | 509.93 | 27.2% | operator |
| 17636 | Hash | 183.32 | 46.85 | 74.4% | operator |
| 17637 | Hash Join | 176.94 | 923.84 | 422.1% | operator |
...
### Step 10: Node 17635 (Seq Scan) - LEAF
...
### Step 13: Node 17646 (Index Scan) - LEAF
...
### Step 14: Node 17633 (Nested Loop)
