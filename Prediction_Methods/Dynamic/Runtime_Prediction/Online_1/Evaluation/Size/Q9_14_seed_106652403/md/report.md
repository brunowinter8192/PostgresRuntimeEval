...
**Test Query:** Q9_14_seed_106652403
...
```
Node 17629 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 17630 (Aggregate) [consumed]
    Node 17631 (Gather)
      Node 17632 (Aggregate)
        Node 17633 (Nested Loop)
          Node 17634 (Hash Join) [PATTERN: bb930825]
            Node 17635 (Seq Scan) [consumed] - LEAF
            Node 17636 (Hash) [consumed]
              Node 17637 (Hash Join) [consumed]
                Node 17638 (Hash Join)
                  Node 17639 (Nested Loop)
                    Node 17640 (Seq Scan) - LEAF
                    Node 17641 (Index Scan) - LEAF
                  Node 17642 (Hash)
                    Node 17643 (Seq Scan) - LEAF
                Node 17644 (Hash)
                  Node 17645 (Seq Scan) - LEAF
          Node 17646 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17634 | 17629, 17630, 17635, 17636, 17637 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17629 | 17630, 17634, 17635, 17636, 17637 |
...
|------|------|--------|-----------|-----|--------|
| 17629 | Sort | 1193.69 | 1049.52 | 12.1% | pattern |
| 17631 | Gather | 1192.34 | 941.00 | 21.1% | operator |
| 17632 | Aggregate | 1173.64 | 1141.96 | 2.7% | operator |
| 17633 | Nested Loop | 1150.83 | 1252.17 | 8.8% | operator |
| 17634 | Hash Join | 976.33 | 134.80 | 86.2% | pattern |
| 17646 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17638 | Hash Join | 162.45 | 837.31 | 415.4% | operator |
| 17644 | Hash | 13.88 | 14.95 | 7.7% | operator |
| 17639 | Nested Loop | 153.72 | 1251.76 | 714.3% | operator |
| 17642 | Hash | 6.31 | 15.94 | 152.5% | operator |
| 17645 | Seq Scan | 13.87 | 2.94 | 78.8% | operator |
| 17640 | Seq Scan | 20.06 | 44.65 | 122.5% | operator |
| 17641 | Index Scan | 0.07 | -1.39 | 1951.2% | operator |
| 17643 | Seq Scan | 5.61 | 9.45 | 68.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 17640 (Seq Scan) - LEAF
...
### Step 2: Node 17641 (Index Scan) - LEAF
...
### Step 3: Node 17643 (Seq Scan) - LEAF
...
### Step 6: Node 17645 (Seq Scan) - LEAF
...
### Step 9: Node 17634 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17629, 17630, 17635, 17636, 17637
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17646 (Index Scan) - LEAF
...
### Step 11: Node 17633 (Nested Loop)
...
### Step 14: Node 17629 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17630, 17634, 17635, 17636, 17637
- **Input Features:**
