...
**Test Query:** Q8_32_seed_254324961
...
```
Node 14926 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 14927 (Gather Merge) [consumed]
    Node 14928 (Sort)
      Node 14929 (Hash Join)
        Node 14930 (Nested Loop)
          Node 14931 (Hash Join)
            Node 14932 (Nested Loop)
              Node 14933 (Hash Join)
                Node 14934 (Seq Scan) - LEAF
                Node 14935 (Hash) [PATTERN: 444761fb]
                  Node 14936 (Hash Join) [consumed]
                    Node 14937 (Seq Scan) [consumed] - LEAF
                    Node 14938 (Hash) [consumed]
                      Node 14939 (Hash Join) [consumed]
                        Node 14940 (Seq Scan) - LEAF
                        Node 14941 (Hash)
                          Node 14942 (Seq Scan) - LEAF
              Node 14943 (Index Scan) - LEAF
            Node 14944 (Hash)
              Node 14945 (Seq Scan) - LEAF
          Node 14946 (Index Scan) - LEAF
        Node 14947 (Hash)
          Node 14948 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 14935 | 14926, 14927, 14936, 14937, 14938, 14939 |
| Aggregate -> Gather Merge (Out | 2724c080 | 14926 | 14927, 14935, 14936, 14937, 14938, 14939 |
...
|------|------|--------|-----------|-----|--------|
| 14926 | Aggregate | 1252.31 | 1129.23 | 9.8% | pattern |
| 14928 | Sort | 1246.72 | 1046.21 | 16.1% | operator |
| 14929 | Hash Join | 1246.47 | 785.61 | 37.0% | operator |
| 14930 | Nested Loop | 1246.14 | 1198.29 | 3.8% | operator |
| 14947 | Hash | 0.01 | 13.72 | 97929.2% | operator |
| 14931 | Hash Join | 1242.13 | 785.60 | 36.8% | operator |
| 14946 | Index Scan | 0.01 | 12.42 | 206958.1% | operator |
| 14948 | Seq Scan | 0.01 | 6.51 | 59099.7% | operator |
| 14932 | Nested Loop | 1195.98 | 1198.29 | 0.2% | operator |
| 14944 | Hash | 40.23 | 19.97 | 50.4% | operator |
| 14933 | Hash Join | 212.49 | 251.67 | 18.4% | operator |
| 14943 | Index Scan | 0.04 | 2.88 | 6759.2% | operator |
| 14945 | Seq Scan | 40.11 | 48.87 | 21.8% | operator |
| 14934 | Seq Scan | 160.95 | 159.67 | 0.8% | operator |
| 14935 | Hash | 33.51 | 43.51 | 29.9% | pattern |
| 14940 | Seq Scan | 0.01 | 12.22 | 111035.8% | operator |
| 14941 | Hash | 0.06 | 18.14 | 30140.2% | operator |
| 14942 | Seq Scan | 0.06 | 23.36 | 40886.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 14942 (Seq Scan) - LEAF
...
### Step 2: Node 14940 (Seq Scan) - LEAF
...
### Step 4: Node 14934 (Seq Scan) - LEAF
...
### Step 5: Node 14935 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 14926, 14927, 14936, 14937, 14938, 14939
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 14943 (Index Scan) - LEAF
...
### Step 8: Node 14945 (Seq Scan) - LEAF
...
### Step 12: Node 14946 (Index Scan) - LEAF
...
### Step 13: Node 14948 (Seq Scan) - LEAF
...
### Step 14: Node 14930 (Nested Loop)
...
### Step 18: Node 14926 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 14927, 14935, 14936, 14937, 14938, 14939
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2495
