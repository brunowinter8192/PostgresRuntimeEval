    ...
    Node 19671 (Aggregate) [consumed]
      Node 19672 (Gather) [consumed]
        Node 19673 (Hash Join)
          Node 19674 (Hash Join)
            Node 19675 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19669 | 19670, 19671, 19672 |
...
| 19673 | Hash Join | 1122.70 | 1007.16 | 10.3% | operator |
| 19674 | Hash Join | 1119.26 | 1004.03 | 10.3% | operator |
| 19680 | Hash | 0.02 | 15.71 | 92316.3% | operator |
| 19675 | Nested Loop | 1077.28 | 1204.85 | 11.8% | operator |
| 19678 | Hash | 31.71 | 55.57 | 75.2% | operator |
...
### Step 6: Node 19681 (Seq Scan) - LEAF
...
### Step 10: Node 19669 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19670, 19671, 19672
- **Input Features:**
