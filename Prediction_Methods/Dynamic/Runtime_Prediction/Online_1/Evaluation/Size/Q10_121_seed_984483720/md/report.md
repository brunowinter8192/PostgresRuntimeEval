...
**Test Query:** Q10_121_seed_984483720
...
```
Node 19669 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 19670 (Sort) [consumed]
    Node 19671 (Aggregate) [consumed]
      Node 19672 (Gather) [consumed]
        Node 19673 (Hash Join)
          Node 19674 (Hash Join) [PATTERN: 2e0f44ef]
            Node 19675 (Nested Loop) [consumed]
              Node 19676 (Seq Scan) - LEAF
              Node 19677 (Index Scan) - LEAF
            Node 19678 (Hash) [consumed]
              Node 19679 (Seq Scan) - LEAF
          Node 19680 (Hash)
            Node 19681 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19669 | 19670, 19671, 19672, 19674, 19675, 19678 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 19674 | 19669, 19670, 19671, 19672, 19675, 19678 |
...
|------|------|--------|-----------|-----|--------|
| 19669 | Limit | 1169.55 | 1199.47 | 2.6% | pattern |
| 19673 | Hash Join | 1122.70 | 1095.55 | 2.4% | operator |
| 19674 | Hash Join | 1119.26 | 1120.19 | 0.1% | pattern |
| 19680 | Hash | 0.02 | 15.71 | 92316.3% | operator |
| 19681 | Seq Scan | 0.01 | 6.98 | 58055.9% | operator |
| 19676 | Seq Scan | 167.26 | 159.74 | 4.5% | operator |
| 19677 | Index Scan | 0.06 | -0.52 | 922.6% | operator |
| 19679 | Seq Scan | 24.66 | 26.64 | 8.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 19676 (Seq Scan) - LEAF
...
### Step 2: Node 19677 (Index Scan) - LEAF
...
### Step 3: Node 19679 (Seq Scan) - LEAF
...
### Step 4: Node 19681 (Seq Scan) - LEAF
...
### Step 5: Node 19674 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 19669, 19670, 19671, 19672, 19675, 19678
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18183
  - HashJoin_nt1=18183
...
### Step 8: Node 19669 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19670, 19671, 19672, 19674, 19675, 19678
- **Input Features:**
