...
```
Node 17973 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 17974 (Aggregate) [consumed]
    Node 17975 (Gather)
      Node 17976 (Aggregate)
        Node 17977 (Hash Join)
          Node 17978 (Seq Scan) - LEAF
          Node 17979 (Hash) [PATTERN: 444761fb]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 17979 | 17973, 17974, 17980, 17981, 17982, 17983 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17973 | 17974, 17979, 17980, 17981, 17982, 17983 |
...
|------|------|--------|-----------|-----|--------|
| 17973 | Sort | 1303.38 | 1063.12 | 18.4% | pattern |
| 17975 | Gather | 1302.56 | 962.19 | 26.1% | operator |
| 17976 | Aggregate | 1284.90 | 922.12 | 28.2% | operator |
| 17977 | Hash Join | 1256.64 | 571.38 | 54.5% | operator |
| 17978 | Seq Scan | 154.21 | 193.40 | 25.4% | operator |
| 17979 | Hash | 1039.74 | 35.69 | 96.6% | pattern |
| 17984 | Hash Join | 186.83 | 837.74 | 348.4% | operator |
| 17990 | Hash | 14.97 | 14.95 | 0.2% | operator |
| 17985 | Nested Loop | 179.66 | 1251.77 | 596.7% | operator |
| 17988 | Hash | 4.54 | 15.94 | 250.7% | operator |
| 17991 | Seq Scan | 14.96 | 2.94 | 80.4% | operator |
| 17986 | Seq Scan | 27.27 | 43.69 | 60.3% | operator |
| 17987 | Index Scan | 0.06 | -1.39 | 2579.5% | operator |
| 17989 | Seq Scan | 4.08 | 9.45 | 131.3% | operator |
...
### Step 10: Node 17979 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 17973, 17974, 17980, 17981, 17982, 17983
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 14: Node 17973 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17974, 17979, 17980, 17981, 17982, 17983
- **Input Features:**
