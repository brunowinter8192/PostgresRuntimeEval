        ...
        Node 30680 (Incremental Sort)
          Node 30681 (Nested Loop)
            Node 30682 (Merge Join)
              Node 30683 (Sort)
                Node 30684 (Hash Join)
                  Node 30685 (Seq Scan) - LEAF
                  Node 30686 (Hash)
...
| 30683 | Sort | 2851.84 | 1099.77 | 61.4% | operator |
| 30689 | Sort | 65.43 | 1074.66 | 1542.5% | operator |
| 30684 | Hash Join | 2851.83 | 686.33 | 75.9% | operator |
| 30690 | Seq Scan | 53.82 | 18.25 | 66.1% | operator |
| 30685 | Seq Scan | 199.57 | 170.37 | 14.6% | operator |
| 30686 | Hash | 2623.53 | 21.04 | 99.2% | operator |
...
### Step 3: Node 30685 (Seq Scan) - LEAF
...
### Step 6: Node 30690 (Seq Scan) - LEAF
...
### Step 9: Node 30682 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 30691 (Index Scan) - LEAF
...
### Step 11: Node 30681 (Nested Loop)
...
### Step 12: Node 30680 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 30679 (Gather Merge)
