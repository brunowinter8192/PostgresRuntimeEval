...
**Test Query:** Q18_6_seed_41020155
...
```
Node 30676 (Limit) - ROOT
  Node 30677 (Sort)
    Node 30678 (Aggregate)
      Node 30679 (Gather Merge)
        Node 30680 (Incremental Sort)
          Node 30681 (Nested Loop)
            Node 30682 (Merge Join)
              Node 30683 (Sort)
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30684 | 30685, 30686 |
...
|------|------|--------|-----------|-----|--------|
| 30676 | Limit | 3057.75 | 1175.21 | 61.6% | operator |
| 30677 | Sort | 2937.62 | 1127.81 | 61.6% | operator |
| 30678 | Aggregate | 2937.58 | 1073.15 | 63.5% | operator |
| 30679 | Gather Merge | 2937.56 | 1073.95 | 63.4% | operator |
| 30680 | Incremental Sort | 2903.20 | 0.00 | 100.0% | operator |
| 30681 | Nested Loop | 2903.15 | 1111.34 | 61.7% | operator |
| 30682 | Merge Join | 2903.10 | 0.00 | 100.0% | operator |
| 30691 | Index Scan | 0.02 | 0.05 | 137.6% | operator |
| 30683 | Sort | 2851.84 | 1095.58 | 61.6% | operator |
| 30689 | Sort | 65.43 | 1074.66 | 1542.5% | operator |
| 30684 | Hash Join | 2851.83 | 471.07 | 83.5% | pattern |
| 30690 | Seq Scan | 53.82 | 18.25 | 66.1% | operator |
| 30687 | Aggregate | 2623.49 | 1073.15 | 59.1% | operator |
| 30688 | Index Scan | 2121.90 | 0.00 | 100.0% | operator |
...
### Step 4: Node 30690 (Seq Scan) - LEAF
...
### Step 7: Node 30682 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30691 (Index Scan) - LEAF
...
### Step 10: Node 30680 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30679 (Gather Merge)
