...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4431 | 4432, 4433, 4434 |
...
| 4435 | Nested Loop | 1169.65 | 1193.25 | 2.0% | operator |
| 4436 | Hash Join | 209.29 | 230.92 | 10.3% | operator |
| 4440 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4437 | Seq Scan | 155.87 | 163.43 | 4.8% | operator |
| 4438 | Hash | 30.42 | 17.75 | 41.7% | operator |
...
### Step 2: Node 4437 (Seq Scan) - LEAF
...
- **Output:** st=0.29, rt=163.43

### Step 3: Node 4438 (Hash)
...
- **Input Features:**
  ...
  - total_cost=37341.4000
- **Output:** st=27.21, rt=230.92

### Step 5: Node 4440 (Index Scan) - LEAF
...
- **Output:** st=121.93, rt=1193.25

### Step 7: Node 4431 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4432, 4433, 4434
- **Input Features:**
