...
**Test Query:** Q3_108_seed_877831317
**Timestamp:** 2026-01-18 16:07:11
...
```
Node 4431 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 4432 (Sort) [consumed]
    Node 4433 (Aggregate) [consumed]
      Node 4434 (Gather) [consumed]
        Node 4435 (Nested Loop)
          Node 4436 (Hash Join) [PATTERN: 895c6e8c]
            Node 4437 (Seq Scan) [consumed] - LEAF
            Node 4438 (Hash) [consumed]
              Node 4439 (Seq Scan) - LEAF
          Node 4440 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4431 | 4432, 4433, 4434, 4436, 4437, 4438 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4436 | 4431, 4432, 4433, 4434, 4437, 4438 |
...
|------|------|--------|-----------|-----|--------|
| 4431 | Limit | 1205.00 | 1151.18 | 4.5% | pattern |
| 4435 | Nested Loop | 1169.65 | 1193.34 | 2.0% | operator |
| 4436 | Hash Join | 209.29 | 242.53 | 15.9% | pattern |
| 4440 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4439 | Seq Scan | 28.50 | 38.54 | 35.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4439 (Seq Scan) - LEAF
...
### Step 2: Node 4436 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4431, 4432, 4433, 4434, 4437, 4438
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47366
  - HashJoin_nt1=235716
...
- **Input Features:**
  ...
  - total_cost=73186.9500
- **Output:** st=122.07, rt=1193.34

### Step 5: Node 4431 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4432, 4433, 4434, 4436, 4437, 4438
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=315552
  - Aggregate_Outer_nt1=315552
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110475.4300
  - Aggregate_Outer_total_cost=114419.8300
  - Gather_Outer_np=0
  - Gather_Outer_nt=315552
  - Gather_Outer_nt1=101791
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105742.1500
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=315552
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=121238.8000
  - Limit_total_cost=121238.8200
  - Sort_Outer_np=0
  - Sort_Outer_nt=315552
  - Sort_Outer_nt1=315552
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=121238.8000
  - Sort_Outer_total_cost=122027.6800
