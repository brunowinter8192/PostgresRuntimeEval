...
**Test Query:** Q3_58_seed_467629767
...
```
Node 5381 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5382 (Sort) [consumed]
    Node 5383 (Aggregate) [consumed]
      Node 5384 (Gather) [consumed]
        Node 5385 (Nested Loop)
          Node 5386 (Hash Join) [PATTERN: 895c6e8c]
            Node 5387 (Seq Scan) [consumed] - LEAF
            Node 5388 (Hash) [consumed]
              Node 5389 (Seq Scan) - LEAF
          Node 5390 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5381 | 5382, 5383, 5384, 5386, 5387, 5388 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5386 | 5381, 5382, 5383, 5384, 5387, 5388 |
...
|------|------|--------|-----------|-----|--------|
| 5381 | Limit | 1199.31 | 1151.18 | 4.0% | pattern |
| 5385 | Nested Loop | 1159.99 | 1192.87 | 2.8% | operator |
| 5386 | Hash Join | 210.64 | 242.45 | 15.1% | pattern |
| 5390 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5389 | Seq Scan | 29.68 | 38.54 | 29.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5389 (Seq Scan) - LEAF
...
### Step 2: Node 5386 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5381, 5382, 5383, 5384, 5387, 5388
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46643
  - HashJoin_nt1=232114
  ...
  - HashJoin_total_cost=37331.9500
  - Hash_Inner_np=0
  - Hash_Inner_nt=12559
...
- **Input Features:**
  ...
  - total_cost=72770.9800
- **Output:** st=121.61, rt=1192.87

### Step 5: Node 5381 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5382, 5383, 5384, 5386, 5387, 5388
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=315006
  - Aggregate_Outer_nt1=315006
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=109996.6700
  - Aggregate_Outer_total_cost=113934.2400
  - Gather_Outer_np=0
  - Gather_Outer_nt=315006
  - Gather_Outer_nt1=101615
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105271.5800
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=315006
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=120741.4100
  - Limit_total_cost=120741.4400
  - Sort_Outer_np=0
  - Sort_Outer_nt=315006
  - Sort_Outer_nt1=315006
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=120741.4100
  - Sort_Outer_total_cost=121528.9300
