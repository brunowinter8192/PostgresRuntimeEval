...
**Test Query:** Q18_29_seed_229712868
...
```
Node 29956 (Limit) - ROOT
  Node 29957 (Sort)
    Node 29958 (Aggregate)
      Node 29959 (Gather Merge)
        Node 29960 (Incremental Sort)
          Node 29961 (Nested Loop)
            Node 29962 (Merge Join)
              Node 29963 (Sort)
                Node 29964 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29965 (Seq Scan) [consumed] - LEAF
                  Node 29966 (Hash) [consumed]
                    Node 29967 (Aggregate)
                      Node 29968 (Index Scan) - LEAF
              Node 29969 (Sort)
                Node 29970 (Seq Scan) - LEAF
            Node 29971 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29964 | 29965, 29966 |
...
|------|------|--------|-----------|-----|--------|
| 29956 | Limit | 3068.06 | 1175.21 | 61.7% | operator |
| 29957 | Sort | 2949.39 | 1127.81 | 61.8% | operator |
| 29958 | Aggregate | 2949.35 | 1073.15 | 63.6% | operator |
| 29959 | Gather Merge | 2949.34 | 1073.95 | 63.6% | operator |
| 29960 | Incremental Sort | 2928.17 | 0.00 | 100.0% | operator |
| 29961 | Nested Loop | 2928.11 | 1111.34 | 62.0% | operator |
| 29962 | Merge Join | 2928.06 | 0.00 | 100.0% | operator |
| 29971 | Index Scan | 0.02 | 0.05 | 105.2% | operator |
| 29963 | Sort | 2859.05 | 1095.58 | 61.7% | operator |
| 29969 | Sort | 66.19 | 1074.66 | 1523.7% | operator |
| 29964 | Hash Join | 2859.04 | 471.07 | 83.5% | pattern |
| 29970 | Seq Scan | 54.33 | 18.25 | 66.4% | operator |
| 29967 | Aggregate | 2635.79 | 1073.15 | 59.3% | operator |
| 29968 | Index Scan | 2132.86 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29968 (Index Scan) - LEAF
...
### Step 3: Node 29964 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29965, 29966
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29970 (Seq Scan) - LEAF
...
### Step 7: Node 29962 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29971 (Index Scan) - LEAF
...
### Step 10: Node 29960 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29959 (Gather Merge)
