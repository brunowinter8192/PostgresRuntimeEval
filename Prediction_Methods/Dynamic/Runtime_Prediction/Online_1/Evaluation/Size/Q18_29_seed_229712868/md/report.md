        ...
        Node 29960 (Incremental Sort)
          Node 29961 (Nested Loop)
            Node 29962 (Merge Join)
              Node 29963 (Sort)
                Node 29964 (Hash Join)
                  Node 29965 (Seq Scan) - LEAF
                  Node 29966 (Hash)
...
| 29963 | Sort | 2859.05 | 1099.77 | 61.5% | operator |
| 29969 | Sort | 66.19 | 1074.66 | 1523.7% | operator |
| 29964 | Hash Join | 2859.04 | 686.33 | 76.0% | operator |
| 29970 | Seq Scan | 54.33 | 18.25 | 66.4% | operator |
| 29965 | Seq Scan | 192.33 | 170.37 | 11.4% | operator |
| 29966 | Hash | 2635.84 | 21.04 | 99.2% | operator |
...
### Step 3: Node 29965 (Seq Scan) - LEAF
...
### Step 6: Node 29970 (Seq Scan) - LEAF
...
### Step 9: Node 29962 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29971 (Index Scan) - LEAF
...
### Step 11: Node 29961 (Nested Loop)
...
### Step 12: Node 29960 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 29959 (Gather Merge)
