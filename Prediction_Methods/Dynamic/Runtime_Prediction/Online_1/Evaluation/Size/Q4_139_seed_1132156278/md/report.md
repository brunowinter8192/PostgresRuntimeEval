...
```
Node 6145 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6146 (Gather Merge) [consumed]
    Node 6147 (Sort) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6145 | 6146, 6147, 6148 |
...
|------|------|--------|-----------|-----|--------|
| 6145 | Aggregate | 1051.30 | 952.19 | 9.4% | pattern |
| 6149 | Nested Loop | 1044.46 | 1255.45 | 20.2% | operator |
| 6150 | Seq Scan | 163.24 | 154.67 | 5.3% | operator |
| 6151 | Index Scan | 0.06 | 11.10 | 18103.9% | operator |
...
- **Input Features:**
  ...
  - Aggregate_total_cost=66798.7700
  ...
  - GatherMerge_Outer_total_cost=66798.6500
  - Sort_Outer_np=0
  - Sort_Outer_nt=5
  - Sort_Outer_nt1=5
  - Sort_Outer_nt2=0
  ...
  - Sort_Outer_startup_cost=65796.8300
  - Sort_Outer_total_cost=65796.8400
