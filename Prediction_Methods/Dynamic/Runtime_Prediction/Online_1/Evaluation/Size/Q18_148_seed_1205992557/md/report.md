...
**Test Query:** Q18_148_seed_1205992557
...
```
Node 29652 (Limit) - ROOT
  Node 29653 (Sort)
    Node 29654 (Aggregate)
      Node 29655 (Gather Merge)
        Node 29656 (Incremental Sort)
          Node 29657 (Nested Loop)
            Node 29658 (Merge Join)
              Node 29659 (Sort)
                Node 29660 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29661 (Seq Scan) [consumed] - LEAF
                  Node 29662 (Hash) [consumed]
                    Node 29663 (Aggregate)
                      Node 29664 (Index Scan) - LEAF
              Node 29665 (Sort)
                Node 29666 (Seq Scan) - LEAF
            Node 29667 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29660 | 29661, 29662 |
...
|------|------|--------|-----------|-----|--------|
| 29652 | Limit | 3049.33 | 1175.21 | 61.5% | operator |
| 29653 | Sort | 2932.95 | 1127.81 | 61.5% | operator |
| 29654 | Aggregate | 2932.91 | 1073.15 | 63.4% | operator |
| 29655 | Gather Merge | 2932.89 | 1073.95 | 63.4% | operator |
| 29656 | Incremental Sort | 2912.23 | 0.00 | 100.0% | operator |
| 29657 | Nested Loop | 2912.17 | 1111.34 | 61.8% | operator |
| 29658 | Merge Join | 2912.09 | 0.00 | 100.0% | operator |
| 29667 | Index Scan | 0.02 | 0.05 | 125.7% | operator |
| 29659 | Sort | 2844.32 | 1095.58 | 61.5% | operator |
| 29665 | Sort | 64.85 | 1074.66 | 1557.2% | operator |
| 29660 | Hash Join | 2844.31 | 471.07 | 83.4% | pattern |
| 29666 | Seq Scan | 53.34 | 18.25 | 65.8% | operator |
| 29663 | Aggregate | 2613.01 | 1073.15 | 58.9% | operator |
| 29664 | Index Scan | 2118.36 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29664 (Index Scan) - LEAF
...
### Step 3: Node 29660 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29661, 29662
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29666 (Seq Scan) - LEAF
...
### Step 7: Node 29658 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29667 (Index Scan) - LEAF
...
### Step 10: Node 29656 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29655 (Gather Merge)
