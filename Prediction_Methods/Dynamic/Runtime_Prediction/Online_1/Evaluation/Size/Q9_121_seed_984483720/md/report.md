    ...
    Node 17070 (Gather)
      Node 17071 (Aggregate)
        Node 17072 (Nested Loop)
          Node 17073 (Hash Join) [PATTERN: bb930825]
            Node 17074 (Seq Scan) [consumed] - LEAF
            Node 17075 (Hash) [consumed]
              Node 17076 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17073 | 17068, 17069, 17074, 17075, 17076 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17068 | 17069, 17073, 17074, 17075, 17076 |
...
|------|------|--------|-----------|-----|--------|
| 17068 | Sort | 1188.85 | 1045.59 | 12.1% | pattern |
| 17070 | Gather | 1187.82 | 964.55 | 18.8% | operator |
| 17071 | Aggregate | 1169.33 | 1085.45 | 7.2% | operator |
| 17072 | Nested Loop | 1144.73 | 1252.17 | 9.4% | operator |
| 17073 | Hash Join | 972.30 | 134.80 | 86.1% | pattern |
| 17085 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17077 | Hash Join | 167.58 | 837.63 | 399.8% | operator |
| 17083 | Hash | 13.27 | 14.95 | 12.7% | operator |
| 17078 | Nested Loop | 160.62 | 1251.77 | 679.3% | operator |
| 17081 | Hash | 4.47 | 15.94 | 256.3% | operator |
| 17084 | Seq Scan | 13.25 | 2.94 | 77.8% | operator |
| 17079 | Seq Scan | 19.87 | 43.96 | 121.3% | operator |
| 17080 | Index Scan | 0.08 | -1.39 | 1903.2% | operator |
| 17082 | Seq Scan | 3.87 | 9.45 | 144.3% | operator |
...
### Step 9: Node 17073 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17068, 17069, 17074, 17075, 17076
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17085 (Index Scan) - LEAF
...
### Step 11: Node 17072 (Nested Loop)
...
### Step 14: Node 17068 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17069, 17073, 17074, 17075, 17076
- **Input Features:**
