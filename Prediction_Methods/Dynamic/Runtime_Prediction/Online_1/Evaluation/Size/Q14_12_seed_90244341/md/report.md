...
**Test Query:** Q14_12_seed_90244341
...
```
Node 26644 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26645 (Gather) [consumed]
    Node 26646 (Aggregate) [consumed]
      Node 26647 (Hash Join) [consumed]
        Node 26648 (Seq Scan) - LEAF
        Node 26649 (Hash)
          Node 26650 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26644 | 26645, 26646, 26647 |
...
|------|------|--------|-----------|-----|--------|
| 26644 | Aggregate | 812.60 | 857.11 | 5.5% | pattern |
| 26648 | Seq Scan | 740.95 | 758.44 | 2.4% | operator |
| 26649 | Hash | 42.37 | 9.38 | 77.9% | operator |
| 26650 | Seq Scan | 37.17 | 12.70 | 65.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26650 (Seq Scan) - LEAF
...
### Step 2: Node 26648 (Seq Scan) - LEAF
...
### Step 4: Node 26644 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26645, 26646, 26647
- **Input Features:**
