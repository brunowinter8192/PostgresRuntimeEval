...
```
Node 26644 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26645 (Gather) [consumed]
    Node 26646 (Aggregate) [consumed]
      Node 26647 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26644 | 26645, 26646 |
...
|------|------|--------|-----------|-----|--------|
| 26644 | Aggregate | 812.60 | 848.34 | 4.4% | pattern |
| 26647 | Hash Join | 791.36 | 807.59 | 2.1% | operator |
...
### Step 5: Node 26644 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26645, 26646
- **Input Features:**
