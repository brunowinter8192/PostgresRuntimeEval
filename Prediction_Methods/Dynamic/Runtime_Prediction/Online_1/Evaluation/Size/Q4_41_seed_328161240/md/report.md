...
**Test Query:** Q4_41_seed_328161240
...
```
Node 6446 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6447 (Gather Merge) [consumed]
    Node 6448 (Sort) [consumed]
      Node 6449 (Aggregate) [consumed]
        Node 6450 (Nested Loop)
          Node 6451 (Seq Scan) - LEAF
          Node 6452 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6446 | 6447, 6448, 6449 |
...
|------|------|--------|-----------|-----|--------|
| 6446 | Aggregate | 1088.56 | 952.19 | 12.5% | pattern |
| 6450 | Nested Loop | 1082.21 | 1255.45 | 16.0% | operator |
| 6451 | Seq Scan | 167.73 | 154.66 | 7.8% | operator |
| 6452 | Index Scan | 0.06 | 11.10 | 17250.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6451 (Seq Scan) - LEAF
...
### Step 2: Node 6452 (Index Scan) - LEAF
