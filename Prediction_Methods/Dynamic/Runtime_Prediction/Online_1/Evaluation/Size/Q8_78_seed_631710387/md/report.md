...
```
Node 16076 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 16077 (Gather Merge) [consumed]
    Node 16078 (Sort)
          ...
          Node 16081 (Hash Join)
            Node 16082 (Nested Loop)
              Node 16083 (Hash Join)
                ...
                Node 16085 (Hash) [PATTERN: 444761fb]
                  Node 16086 (Hash Join) [consumed]
                    Node 16087 (Seq Scan) [consumed] - LEAF
                    Node 16088 (Hash) [consumed]
                      Node 16089 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 16085 | 16076, 16077, 16086, 16087, 16088, 16089 |
| Aggregate -> Gather Merge (Out | 2724c080 | 16076 | 16077, 16085, 16086, 16087, 16088, 16089 |
...
|------|------|--------|-----------|-----|--------|
| 16076 | Aggregate | 1232.71 | 1128.60 | 8.4% | pattern |
...
| 16083 | Hash Join | 212.19 | 251.67 | 18.6% | operator |
...
| 16085 | Hash | 35.58 | 43.51 | 22.3% | pattern |
...
### Step 4: Node 16084 (Seq Scan) - LEAF
...
### Step 5: Node 16085 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 16076, 16077, 16086, 16087, 16088, 16089
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 16093 (Index Scan) - LEAF
...
### Step 8: Node 16095 (Seq Scan) - LEAF
...
### Step 12: Node 16096 (Index Scan) - LEAF
...
### Step 13: Node 16098 (Seq Scan) - LEAF
...
### Step 14: Node 16080 (Nested Loop)
...
### Step 18: Node 16076 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 16077, 16085, 16086, 16087, 16088, 16089
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2508
