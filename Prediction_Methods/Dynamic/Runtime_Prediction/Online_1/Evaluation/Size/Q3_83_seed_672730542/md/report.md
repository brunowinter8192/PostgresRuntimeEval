...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5661 | 5662, 5663, 5664, 5666, 5667, 5668 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5666 | 5661, 5662, 5663, 5664, 5667, 5668 |
...
|------|------|--------|-----------|-----|--------|
| 5661 | Limit | 1189.91 | 1151.18 | 3.3% | pattern |
| 5665 | Nested Loop | 1152.40 | 1192.92 | 3.5% | operator |
| 5666 | Hash Join | 206.82 | 242.45 | 17.2% | pattern |
| 5670 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5669 | Seq Scan | 29.85 | 38.57 | 29.2% | operator |
...
- **Consumes:** Nodes 5661, 5662, 5663, 5664, 5667, 5668
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46716
  - HashJoin_nt1=233978
...
### Step 3: Node 5670 (Index Scan) - LEAF
...
- **Output:** st=121.67, rt=1192.92

### Step 5: Node 5661 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5662, 5663, 5664, 5666, 5667, 5668
- **Input Features:**
