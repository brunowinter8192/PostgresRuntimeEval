    ...
    Node 18645 (Gather)
      Node 18646 (Aggregate)
        Node 18647 (Nested Loop)
          Node 18648 (Hash Join) [PATTERN: bb930825]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18648 | 18643, 18644, 18649, 18650, 18651 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18643 | 18644, 18648, 18649, 18650, 18651 |
...
|------|------|--------|-----------|-----|--------|
| 18643 | Sort | 1180.81 | 1044.29 | 11.6% | pattern |
...
| 18648 | Hash Join | 961.10 | 134.80 | 86.0% | pattern |
...
### Step 9: Node 18648 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18643, 18644, 18649, 18650, 18651
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 11: Node 18647 (Nested Loop)
...
### Step 14: Node 18643 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18644, 18648, 18649, 18650, 18651
- **Input Features:**
