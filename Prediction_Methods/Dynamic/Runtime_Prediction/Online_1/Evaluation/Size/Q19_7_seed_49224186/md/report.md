...
```
Node 32109 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 32110 (Gather) [consumed]
    Node 32111 (Aggregate) [consumed]
      Node 32112 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 32109 | 32110, 32111, 32112 |
...
|------|------|--------|-----------|-----|--------|
| 32109 | Aggregate | 806.57 | 829.29 | 2.8% | pattern |
...
### Step 4: Node 32109 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 32110, 32111, 32112
- **Input Features:**
