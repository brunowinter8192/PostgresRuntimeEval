...
**Test Query:** Q19_46_seed_369181395
...
```
Node 31850 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31851 (Gather) [consumed]
    Node 31852 (Aggregate) [consumed]
      Node 31853 (Hash Join) [consumed]
        Node 31854 (Seq Scan) - LEAF
        Node 31855 (Hash)
          Node 31856 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31850 | 31851, 31852, 31853 |
...
|------|------|--------|-----------|-----|--------|
| 31850 | Aggregate | 839.26 | 829.29 | 1.2% | pattern |
| 31854 | Seq Scan | 762.45 | 743.46 | 2.5% | operator |
| 31855 | Hash | 51.94 | 8.29 | 84.0% | operator |
| 31856 | Seq Scan | 51.83 | 23.76 | 54.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31856 (Seq Scan) - LEAF
...
### Step 2: Node 31854 (Seq Scan) - LEAF
...
### Step 4: Node 31850 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31851, 31852, 31853
- **Input Features:**
