...
**Test Query:** Q9_58_seed_467629767
...
```
Node 18516 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18517 (Aggregate) [consumed]
    Node 18518 (Gather)
      Node 18519 (Aggregate)
        Node 18520 (Nested Loop)
          Node 18521 (Hash Join) [PATTERN: bb930825]
            Node 18522 (Seq Scan) [consumed] - LEAF
            Node 18523 (Hash) [consumed]
              Node 18524 (Hash Join) [consumed]
                Node 18525 (Hash Join)
                  Node 18526 (Nested Loop)
                    Node 18527 (Seq Scan) - LEAF
                    Node 18528 (Index Scan) - LEAF
                  Node 18529 (Hash)
                    Node 18530 (Seq Scan) - LEAF
                Node 18531 (Hash)
                  Node 18532 (Seq Scan) - LEAF
          Node 18533 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18521 | 18516, 18517, 18522, 18523, 18524 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18516 | 18517, 18521, 18522, 18523, 18524 |
...
|------|------|--------|-----------|-----|--------|
| 18516 | Sort | 1200.43 | 1044.29 | 13.0% | pattern |
| 18518 | Gather | 1199.36 | 965.14 | 19.5% | operator |
| 18519 | Aggregate | 1180.66 | 1141.19 | 3.3% | operator |
| 18520 | Nested Loop | 1155.56 | 1252.17 | 8.4% | operator |
| 18521 | Hash Join | 978.50 | 134.80 | 86.2% | pattern |
| 18533 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18525 | Hash Join | 170.69 | 837.49 | 390.7% | operator |
| 18531 | Hash | 13.08 | 14.95 | 14.3% | operator |
| 18526 | Nested Loop | 163.88 | 1251.76 | 663.8% | operator |
| 18529 | Hash | 4.49 | 15.94 | 255.3% | operator |
| 18532 | Seq Scan | 13.07 | 2.94 | 77.5% | operator |
| 18527 | Seq Scan | 21.09 | 44.30 | 110.1% | operator |
| 18528 | Index Scan | 0.08 | -1.39 | 1857.5% | operator |
| 18530 | Seq Scan | 3.86 | 9.45 | 144.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 18527 (Seq Scan) - LEAF
...
### Step 2: Node 18528 (Index Scan) - LEAF
...
### Step 3: Node 18530 (Seq Scan) - LEAF
...
### Step 6: Node 18532 (Seq Scan) - LEAF
...
### Step 9: Node 18521 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18516, 18517, 18522, 18523, 18524
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18533 (Index Scan) - LEAF
...
### Step 11: Node 18520 (Nested Loop)
...
### Step 14: Node 18516 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18517, 18521, 18522, 18523, 18524
- **Input Features:**
