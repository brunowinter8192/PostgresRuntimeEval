...
```
Node 18516 (Sort) - ROOT
  Node 18517 (Aggregate)
    Node 18518 (Gather)
      Node 18519 (Aggregate)
        Node 18520 (Nested Loop)
          Node 18521 (Hash Join)
            Node 18522 (Seq Scan) - LEAF
            Node 18523 (Hash)
              Node 18524 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 18516 | Sort | 1200.43 | 1118.33 | 6.8% | operator |
| 18517 | Aggregate | 1200.32 | 896.44 | 25.3% | operator |
...
| 18521 | Hash Join | 978.50 | 632.60 | 35.4% | operator |
| 18533 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18522 | Seq Scan | 697.10 | 509.93 | 26.9% | operator |
| 18523 | Hash | 186.24 | 47.45 | 74.5% | operator |
| 18524 | Hash Join | 184.39 | 924.21 | 401.2% | operator |
...
### Step 10: Node 18522 (Seq Scan) - LEAF
...
### Step 13: Node 18533 (Index Scan) - LEAF
...
### Step 14: Node 18520 (Nested Loop)
