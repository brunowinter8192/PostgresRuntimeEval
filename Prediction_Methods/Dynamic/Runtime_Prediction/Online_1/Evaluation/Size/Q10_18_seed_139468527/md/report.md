...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20137 | 20138, 20139, 20140, 20142, 20143, 20146 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 20142 | 20137, 20138, 20139, 20140, 20143, 20146 |
...
|------|------|--------|-----------|-----|--------|
| 20137 | Limit | 1153.85 | 1199.47 | 4.0% | pattern |
| 20141 | Hash Join | 1099.20 | 1095.55 | 0.3% | operator |
| 20142 | Hash Join | 1096.29 | 1120.19 | 2.2% | pattern |
| 20148 | Hash | 0.02 | 15.71 | 92316.3% | operator |
| 20149 | Seq Scan | 0.01 | 6.98 | 58055.9% | operator |
| 20144 | Seq Scan | 161.53 | 159.74 | 1.1% | operator |
| 20145 | Index Scan | 0.06 | -0.52 | 935.9% | operator |
| 20147 | Seq Scan | 28.33 | 26.64 | 6.0% | operator |
...
### Step 4: Node 20149 (Seq Scan) - LEAF
...
- **Consumes:** Nodes 20137, 20138, 20139, 20140, 20143, 20146
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18183
  - HashJoin_nt1=18183
...
### Step 8: Node 20137 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20138, 20139, 20140, 20142, 20143, 20146
- **Input Features:**
