...
```
Node 7501 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 7502 (Aggregate) [consumed]
    Node 7503 (Gather Merge) [consumed]
      Node 7504 (Aggregate)
        Node 7505 (Sort) [PATTERN: 3e2d5a00]
          Node 7506 (Hash Join) [consumed]
            Node 7507 (Nested Loop)
              Node 7508 (Hash Join)
                Node 7509 (Seq Scan) - LEAF
                Node 7510 (Hash) [PATTERN: 444761fb]
                  Node 7511 (Hash Join) [consumed]
                    Node 7512 (Seq Scan) [consumed] - LEAF
                    Node 7513 (Hash) [consumed]
                      Node 7514 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 7510 | 7501, 7502, 7503, 7505, 7506, 7511, 7512, 7513, 7514 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 7501 | 7502, 7503, 7505, 7506, 7510, 7511, 7512, 7513, 7514 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 7505 | 7501, 7502, 7503, 7506, 7510, 7511, 7512, 7513, 7514 |
...
|------|------|--------|-----------|-----|--------|
| 7501 | Sort | 1073.80 | 2934.42 | 173.3% | pattern |
| 7504 | Aggregate | 1069.38 | 1128.78 | 5.6% | operator |
| 7505 | Sort | 1069.09 | 1835.91 | 71.7% | pattern |
| 7507 | Nested Loop | 1057.17 | 1188.39 | 12.4% | operator |
| 7519 | Hash | 3.56 | 18.67 | 424.6% | operator |
| 7508 | Hash Join | 216.95 | 253.07 | 16.6% | operator |
| 7518 | Index Scan | 0.07 | -0.22 | 397.3% | operator |
| 7520 | Seq Scan | 3.02 | 12.36 | 309.7% | operator |
| 7509 | Seq Scan | 166.82 | 159.81 | 4.2% | operator |
| 7510 | Hash | 37.59 | 46.85 | 24.6% | pattern |
| 7515 | Seq Scan | 0.12 | 11.81 | 9658.9% | operator |
| 7516 | Hash | 0.05 | 21.05 | 38887.5% | operator |
| 7517 | Seq Scan | 0.05 | 22.93 | 44002.6% | operator |
...
### Step 4: Node 7509 (Seq Scan) - LEAF
...
### Step 5: Node 7510 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 7501, 7502, 7503, 7505, 7506, 7511, 7512, 7513, 7514
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 7518 (Index Scan) - LEAF
...
### Step 8: Node 7520 (Seq Scan) - LEAF
...
### Step 11: Node 7505 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 7501, 7502, 7503, 7506, 7510, 7511, 7512, 7513, 7514
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 7501 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 7502, 7503, 7505, 7506, 7510, 7511, 7512, 7513, 7514
- **Input Features:**
