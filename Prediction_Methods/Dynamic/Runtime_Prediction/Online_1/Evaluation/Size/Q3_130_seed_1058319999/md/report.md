...
**Test Query:** Q3_130_seed_1058319999
...
```
Node 4681 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 4682 (Sort) [consumed]
    Node 4683 (Aggregate) [consumed]
      Node 4684 (Gather) [consumed]
        Node 4685 (Nested Loop)
          Node 4686 (Hash Join) [PATTERN: 895c6e8c]
            Node 4687 (Seq Scan) [consumed] - LEAF
            Node 4688 (Hash) [consumed]
              Node 4689 (Seq Scan) - LEAF
          Node 4690 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4681 | 4682, 4683, 4684, 4686, 4687, 4688 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4686 | 4681, 4682, 4683, 4684, 4687, 4688 |
...
|------|------|--------|-----------|-----|--------|
| 4681 | Limit | 1183.28 | 1151.18 | 2.7% | pattern |
| 4685 | Nested Loop | 1145.49 | 1192.56 | 4.1% | operator |
| 4686 | Hash Join | 207.67 | 242.38 | 16.7% | pattern |
| 4690 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4689 | Seq Scan | 30.43 | 38.60 | 26.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4689 (Seq Scan) - LEAF
...
### Step 2: Node 4686 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4681, 4682, 4683, 4684, 4687, 4688
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46152
  - HashJoin_nt1=232682
  ...
  - HashJoin_total_cost=37331.4100
  - Hash_Inner_np=0
  - Hash_Inner_nt=12397
...
- **Output:** st=29.79, rt=242.38

### Step 3: Node 4690 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=72375.1300
- **Output:** st=121.34, rt=1192.56

### Step 5: Node 4681 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4682, 4683, 4684, 4686, 4687, 4688
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=311035
  - Aggregate_Outer_nt1=311035
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=109144.1600
  - Aggregate_Outer_total_cost=113032.0900
  - Gather_Outer_np=0
  - Gather_Outer_nt=311035
  - Gather_Outer_nt1=100334
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=104478.6300
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=311035
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=119753.4500
  - Limit_total_cost=119753.4700
  - Sort_Outer_np=0
  - Sort_Outer_nt=311035
  - Sort_Outer_nt1=311035
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=119753.4500
  - Sort_Outer_total_cost=120531.0400
