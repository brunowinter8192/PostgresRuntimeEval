...
**Test Query:** Q7_21_seed_164080620
...
```
Node 11635 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 11636 (Gather Merge) [consumed]
    Node 11637 (Sort)
      Node 11638 (Hash Join)
        Node 11639 (Nested Loop)
          Node 11640 (Hash Join) [PATTERN: 895c6e8c]
            Node 11641 (Seq Scan) [consumed] - LEAF
            Node 11642 (Hash) [consumed]
              Node 11643 (Hash Join) [PATTERN: f4cb205a]
                Node 11644 (Seq Scan) [consumed] - LEAF
                Node 11645 (Hash) [consumed]
                  Node 11646 (Seq Scan) [consumed] - LEAF
          Node 11647 (Index Scan) - LEAF
        Node 11648 (Hash)
          Node 11649 (Hash Join) [PATTERN: f4cb205a]
            Node 11650 (Seq Scan) [consumed] - LEAF
            Node 11651 (Hash) [consumed]
              Node 11652 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 11643 | 11635, 11636, 11640, 11641, 11642, 11644, 11645, 11646, 11649, 11650, 11651, 11652 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 11649 | 11635, 11636, 11640, 11641, 11642, 11643, 11644, 11645, 11646, 11650, 11651, 11652 |
| Aggregate -> Gather Merge (Out | 2724c080 | 11635 | 11636, 11640, 11641, 11642, 11643, 11644, 11645, 11646, 11649, 11650, 11651, 11652 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 11640 | 11635, 11636, 11641, 11642, 11643, 11644, 11645, 11646, 11649, 11650, 11651, 11652 |
...
|------|------|--------|-----------|-----|--------|
| 11635 | Aggregate | 1210.15 | 1163.13 | 3.9% | pattern |
| 11637 | Sort | 1203.66 | 1109.16 | 7.9% | operator |
| 11638 | Hash Join | 1203.09 | 843.11 | 29.9% | operator |
| 11639 | Nested Loop | 1196.28 | 1215.99 | 1.6% | operator |
| 11648 | Hash | 2.83 | 27.74 | 882.1% | operator |
| 11640 | Hash Join | 210.19 | 304.89 | 45.1% | pattern |
| 11647 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 11649 | Hash Join | 2.78 | 429.36 | 15322.5% | pattern |
| 11643 | Hash Join | 34.10 | 429.38 | 1159.3% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11643 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 11635, 11636, 11640, 11641, 11642, 11644, 11645, 11646, 11649, 11650, 11651, 11652
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5000
  - HashJoin_nt1=62500
...
### Step 2: Node 11640 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 11635, 11636, 11641, 11642, 11643, 11644, 11645, 11646, 11649, 11650, 11651, 11652
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=38710
  - HashJoin_nt1=483871
...
### Step 3: Node 11647 (Index Scan) - LEAF
...
### Step 4: Node 11649 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 11635, 11636, 11640, 11641, 11642, 11643, 11644, 11645, 11646, 11650, 11651, 11652
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=800
  - HashJoin_nt1=10000
...
### Step 9: Node 11635 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 11636, 11640, 11641, 11642, 11643, 11644, 11645, 11646, 11649, 11650, 11651, 11652
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
