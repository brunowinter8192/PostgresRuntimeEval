...
```
Node 12247 (Aggregate) - ROOT
  Node 12248 (Gather Merge)
    Node 12249 (Sort)
      Node 12250 (Hash Join)
        Node 12251 (Nested Loop)
          Node 12252 (Hash Join)
            Node 12253 (Seq Scan) - LEAF
            Node 12254 (Hash)
              Node 12255 (Hash Join)
                Node 12256 (Seq Scan) - LEAF
                Node 12257 (Hash)
                  Node 12258 (Seq Scan) - LEAF
          Node 12259 (Index Scan) - LEAF
        Node 12260 (Hash)
          Node 12261 (Hash Join)
            Node 12262 (Seq Scan) - LEAF
            Node 12263 (Hash)
              Node 12264 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12247 | Aggregate | 1207.85 | 1209.26 | 0.1% | operator |
| 12248 | Gather Merge | 1206.74 | 1142.98 | 5.3% | operator |
| 12249 | Sort | 1200.79 | 1109.13 | 7.6% | operator |
| 12250 | Hash Join | 1200.16 | 842.59 | 29.8% | operator |
| 12251 | Nested Loop | 1193.98 | 1216.16 | 1.9% | operator |
| 12260 | Hash | 2.39 | 17.53 | 634.4% | operator |
| 12252 | Hash Join | 213.95 | 384.47 | 79.7% | operator |
| 12259 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 12261 | Hash Join | 2.32 | 85.17 | 3574.5% | operator |
| 12253 | Seq Scan | 149.69 | 201.16 | 34.4% | operator |
| 12254 | Hash | 37.87 | 19.59 | 48.3% | operator |
| 12262 | Seq Scan | 1.97 | 11.47 | 483.8% | operator |
| 12263 | Hash | 0.02 | 16.89 | 99277.0% | operator |
| 12255 | Hash Join | 37.49 | 92.20 | 145.9% | operator |
| 12264 | Seq Scan | 0.01 | 45.79 | 326988.0% | operator |
| 12256 | Seq Scan | 36.40 | 21.86 | 40.0% | operator |
| 12257 | Hash | 0.01 | 16.89 | 120572.0% | operator |
| 12258 | Seq Scan | 0.01 | 45.79 | 457823.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12258 (Seq Scan) - LEAF
...
### Step 2: Node 12256 (Seq Scan) - LEAF
...
### Step 5: Node 12264 (Seq Scan) - LEAF
...
### Step 6: Node 12253 (Seq Scan) - LEAF
...
### Step 8: Node 12262 (Seq Scan) - LEAF
...
### Step 11: Node 12259 (Index Scan) - LEAF
...
### Step 13: Node 12251 (Nested Loop)
...
### Step 17: Node 12248 (Gather Merge)
...
### Step 18: Node 12247 (Aggregate) - ROOT
