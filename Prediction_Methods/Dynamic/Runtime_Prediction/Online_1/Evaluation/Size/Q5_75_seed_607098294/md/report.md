...
**Test Query:** Q5_75_seed_607098294
...
```
Node 9341 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 9342 (Aggregate) [consumed]
    Node 9343 (Gather Merge) [consumed]
      Node 9344 (Aggregate)
        Node 9345 (Sort) [PATTERN: 3e2d5a00]
          Node 9346 (Hash Join) [consumed]
            Node 9347 (Nested Loop)
              Node 9348 (Hash Join)
                Node 9349 (Seq Scan) - LEAF
                Node 9350 (Hash) [PATTERN: 444761fb]
                  Node 9351 (Hash Join) [consumed]
                    Node 9352 (Seq Scan) [consumed] - LEAF
                    Node 9353 (Hash) [consumed]
                      Node 9354 (Hash Join) [consumed]
                        Node 9355 (Seq Scan) - LEAF
                        Node 9356 (Hash)
                          Node 9357 (Seq Scan) - LEAF
              Node 9358 (Index Scan) - LEAF
            Node 9359 (Hash)
              Node 9360 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 9350 | 9341, 9342, 9343, 9345, 9346, 9351, 9352, 9353, 9354 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 9341 | 9342, 9343, 9345, 9346, 9350, 9351, 9352, 9353, 9354 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 9345 | 9341, 9342, 9343, 9346, 9350, 9351, 9352, 9353, 9354 |
...
|------|------|--------|-----------|-----|--------|
| 9341 | Sort | 1064.43 | 2934.42 | 175.7% | pattern |
| 9344 | Aggregate | 1060.09 | 1128.78 | 6.5% | operator |
| 9345 | Sort | 1059.83 | 1835.91 | 73.2% | pattern |
| 9347 | Nested Loop | 1047.47 | 1188.39 | 13.5% | operator |
| 9359 | Hash | 3.69 | 18.67 | 406.5% | operator |
| 9348 | Hash Join | 217.70 | 253.07 | 16.2% | operator |
| 9358 | Index Scan | 0.07 | -0.22 | 405.6% | operator |
| 9360 | Seq Scan | 3.19 | 12.36 | 287.8% | operator |
| 9349 | Seq Scan | 168.42 | 159.81 | 5.1% | operator |
| 9350 | Hash | 33.30 | 46.85 | 40.7% | pattern |
| 9355 | Seq Scan | 0.01 | 11.81 | 147503.4% | operator |
| 9356 | Hash | 0.09 | 21.05 | 23292.5% | operator |
| 9357 | Seq Scan | 0.09 | 22.93 | 26566.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 9357 (Seq Scan) - LEAF
...
### Step 2: Node 9355 (Seq Scan) - LEAF
...
### Step 4: Node 9349 (Seq Scan) - LEAF
...
### Step 5: Node 9350 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 9341, 9342, 9343, 9345, 9346, 9351, 9352, 9353, 9354
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 9358 (Index Scan) - LEAF
...
### Step 8: Node 9360 (Seq Scan) - LEAF
...
### Step 11: Node 9345 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 9341, 9342, 9343, 9346, 9350, 9351, 9352, 9353, 9354
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 9341 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 9342, 9343, 9345, 9346, 9350, 9351, 9352, 9353, 9354
- **Input Features:**
