...
**Test Query:** Q10_103_seed_836811162
**Timestamp:** 2026-01-18 19:18:48
...
```
Node 19409 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 19410 (Sort) [consumed]
    Node 19411 (Aggregate) [consumed]
      Node 19412 (Gather) [consumed]
        Node 19413 (Hash Join)
          Node 19414 (Hash Join) [PATTERN: 2e0f44ef]
            Node 19415 (Nested Loop) [consumed]
              Node 19416 (Seq Scan) - LEAF
              Node 19417 (Index Scan) - LEAF
            Node 19418 (Hash) [consumed]
              Node 19419 (Seq Scan) - LEAF
          Node 19420 (Hash)
            Node 19421 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19409 | 19410, 19411, 19412, 19414, 19415, 19418 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 19414 | 19409, 19410, 19411, 19412, 19415, 19418 |
...
|------|------|--------|-----------|-----|--------|
| 19409 | Limit | 1101.41 | 1199.47 | 8.9% | pattern |
| 19413 | Hash Join | 1053.37 | 1095.50 | 4.0% | operator |
| 19414 | Hash Join | 1050.53 | 1120.19 | 6.6% | pattern |
| 19420 | Hash | 0.03 | 15.71 | 60326.1% | operator |
| 19421 | Seq Scan | 0.02 | 6.98 | 36630.0% | operator |
| 19416 | Seq Scan | 157.79 | 159.74 | 1.2% | operator |
| 19417 | Index Scan | 0.06 | -0.52 | 963.7% | operator |
| 19419 | Seq Scan | 22.89 | 26.64 | 16.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 19416 (Seq Scan) - LEAF
...
### Step 2: Node 19417 (Index Scan) - LEAF
...
### Step 3: Node 19419 (Seq Scan) - LEAF
...
### Step 4: Node 19421 (Seq Scan) - LEAF
...
### Step 5: Node 19414 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 19409, 19410, 19411, 19412, 19415, 19418
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=17978
  - HashJoin_nt1=17978
...
### Step 8: Node 19409 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19410, 19411, 19412, 19414, 19415, 19418
- **Input Features:**
