    ...
    Node 19411 (Aggregate) [consumed]
      Node 19412 (Gather) [consumed]
        Node 19413 (Hash Join)
          Node 19414 (Hash Join)
            Node 19415 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19409 | 19410, 19411, 19412 |
...
| 19413 | Hash Join | 1053.37 | 1007.24 | 4.4% | operator |
| 19414 | Hash Join | 1050.53 | 1004.16 | 4.4% | operator |
| 19420 | Hash | 0.03 | 15.71 | 60326.1% | operator |
| 19415 | Nested Loop | 1006.39 | 1204.80 | 19.7% | operator |
| 19418 | Hash | 34.34 | 55.57 | 61.8% | operator |
...
### Step 6: Node 19421 (Seq Scan) - LEAF
...
### Step 10: Node 19409 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19410, 19411, 19412
- **Input Features:**
