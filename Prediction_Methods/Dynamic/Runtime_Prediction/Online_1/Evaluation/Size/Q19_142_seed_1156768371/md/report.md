...
**Test Query:** Q19_142_seed_1156768371
...
```
Node 31542 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31543 (Gather) [consumed]
    Node 31544 (Aggregate) [consumed]
      Node 31545 (Hash Join) [consumed]
        Node 31546 (Seq Scan) - LEAF
        Node 31547 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31542 | 31543, 31544, 31545 |
...
|------|------|--------|-----------|-----|--------|
| 31542 | Aggregate | 837.76 | 829.28 | 1.0% | pattern |
| 31546 | Seq Scan | 769.07 | 743.46 | 3.3% | operator |
| 31547 | Hash | 47.78 | 8.29 | 82.7% | operator |
| 31548 | Seq Scan | 47.65 | 23.76 | 50.1% | operator |
...
### Step 2: Node 31546 (Seq Scan) - LEAF
...
### Step 4: Node 31542 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31543, 31544, 31545
- **Input Features:**
