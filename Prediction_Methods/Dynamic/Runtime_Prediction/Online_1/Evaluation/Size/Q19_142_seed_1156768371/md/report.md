...
```
Node 31542 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31543 (Gather) [consumed]
    Node 31544 (Aggregate) [consumed]
      Node 31545 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31542 | 31543, 31544 |
...
|------|------|--------|-----------|-----|--------|
| 31542 | Aggregate | 837.76 | 831.20 | 0.8% | pattern |
| 31545 | Hash Join | 818.87 | 766.06 | 6.4% | operator |
...
### Step 5: Node 31542 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31543, 31544
- **Input Features:**
