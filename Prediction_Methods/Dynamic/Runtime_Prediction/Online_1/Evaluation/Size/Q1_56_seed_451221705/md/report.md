...
**Test Query:** Q1_56_seed_451221705
...
```
Node 506 (Aggregate) - ROOT
  Node 507 (Gather Merge)
    Node 508 (Sort) [PATTERN: 1d35fb97]
      Node 509 (Aggregate) [consumed]
        Node 510 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 508 | 509 |
...
|------|------|--------|-----------|-----|--------|
| 506 | Aggregate | 929.72 | 1196.03 | 28.6% | operator |
| 507 | Gather Merge | 929.64 | 1165.95 | 25.4% | operator |
| 508 | Sort | 913.41 | 1201.05 | 31.5% | pattern |
| 510 | Seq Scan | 492.41 | 678.19 | 37.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 510 (Seq Scan) - LEAF
...
- **Output:** st=0.85, rt=678.19

### Step 2: Node 508 (Sort) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Aggregate_Outer_nt1=1192224
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=236
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=169330.8800
  - Aggregate_Outer_total_cost=169331.0100
  - Sort_np=0
  - Sort_nt=6
  - Sort_nt1=6
  - Sort_nt2=0
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=169331.0900
  - Sort_total_cost=169331.1100
- **Output:** st=1196.95, rt=1201.05

### Step 3: Node 507 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1196.9534
  - st2=0.0000
  - startup_cost=170331.1700
  - total_cost=170334.8000
- **Output:** st=1161.82, rt=1165.95

### Step 4: Node 506 (Aggregate) - ROOT
