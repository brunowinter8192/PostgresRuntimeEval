...
**Test Query:** Q12_10_seed_73836279
...
```
Node 24390 (Aggregate) - ROOT
  Node 24391 (Gather Merge)
    Node 24392 (Aggregate)
      Node 24393 (Sort)
        Node 24394 (Nested Loop)
          Node 24395 (Seq Scan) - LEAF
          Node 24396 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24390 | Aggregate | 986.22 | 919.06 | 6.8% | operator |
| 24391 | Gather Merge | 986.21 | 1111.84 | 12.7% | operator |
| 24392 | Aggregate | 966.69 | 895.30 | 7.4% | operator |
| 24393 | Sort | 966.07 | 1092.82 | 13.1% | operator |
| 24394 | Nested Loop | 965.04 | 1127.41 | 16.8% | operator |
| 24395 | Seq Scan | 817.19 | 745.19 | 8.8% | operator |
| 24396 | Index Scan | 0.03 | 0.07 | 156.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24395 (Seq Scan) - LEAF
...
### Step 2: Node 24396 (Index Scan) - LEAF
...
### Step 6: Node 24391 (Gather Merge)
...
### Step 7: Node 24390 (Aggregate) - ROOT
