    ...
    Node 20373 (Aggregate) [consumed]
      Node 20374 (Gather) [consumed]
        Node 20375 (Hash Join)
          Node 20376 (Hash Join)
            Node 20377 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20371 | 20372, 20373, 20374 |
...
| 20375 | Hash Join | 1102.10 | 1007.29 | 8.6% | operator |
| 20376 | Hash Join | 1099.14 | 1004.25 | 8.6% | operator |
| 20382 | Hash | 0.01 | 15.71 | 112119.8% | operator |
| 20377 | Nested Loop | 1051.69 | 1204.76 | 14.6% | operator |
| 20380 | Hash | 36.86 | 55.57 | 50.8% | operator |
...
### Step 6: Node 20383 (Seq Scan) - LEAF
...
### Step 10: Node 20371 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20372, 20373, 20374
- **Input Features:**
