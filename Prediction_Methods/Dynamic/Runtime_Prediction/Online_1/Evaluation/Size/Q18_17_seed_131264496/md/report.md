...
**Test Query:** Q18_17_seed_131264496
**Timestamp:** 2026-01-18 20:22:13
...
```
Node 29748 (Limit) - ROOT
  Node 29749 (Sort)
    Node 29750 (Aggregate)
      Node 29751 (Gather Merge)
        Node 29752 (Incremental Sort)
          Node 29753 (Nested Loop)
            Node 29754 (Merge Join)
              Node 29755 (Sort)
                Node 29756 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29757 (Seq Scan) [consumed] - LEAF
                  Node 29758 (Hash) [consumed]
                    Node 29759 (Aggregate)
                      Node 29760 (Index Scan) - LEAF
              Node 29761 (Sort)
                Node 29762 (Seq Scan) - LEAF
            Node 29763 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29756 | 29757, 29758 |
...
|------|------|--------|-----------|-----|--------|
| 29748 | Limit | 3012.09 | 1175.21 | 61.0% | operator |
| 29749 | Sort | 2897.57 | 1127.81 | 61.1% | operator |
| 29750 | Aggregate | 2897.52 | 1073.15 | 63.0% | operator |
| 29751 | Gather Merge | 2897.50 | 1073.95 | 62.9% | operator |
| 29752 | Incremental Sort | 2878.19 | 0.00 | 100.0% | operator |
| 29753 | Nested Loop | 2878.14 | 1111.34 | 61.4% | operator |
| 29754 | Merge Join | 2878.08 | 0.00 | 100.0% | operator |
| 29763 | Index Scan | 0.02 | 0.05 | 114.9% | operator |
| 29755 | Sort | 2807.76 | 1095.58 | 61.0% | operator |
| 29761 | Sort | 67.20 | 1074.66 | 1499.1% | operator |
| 29756 | Hash Join | 2807.74 | 471.07 | 83.2% | pattern |
| 29762 | Seq Scan | 53.71 | 18.25 | 66.0% | operator |
| 29759 | Aggregate | 2589.01 | 1073.15 | 58.5% | operator |
| 29760 | Index Scan | 2092.92 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29760 (Index Scan) - LEAF
...
### Step 3: Node 29756 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29757, 29758
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29762 (Seq Scan) - LEAF
...
### Step 7: Node 29754 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29763 (Index Scan) - LEAF
...
### Step 10: Node 29752 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29751 (Gather Merge)
