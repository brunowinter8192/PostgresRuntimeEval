...
**Test Query:** Q19_110_seed_894239379
...
```
Node 31297 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31298 (Gather) [consumed]
    Node 31299 (Aggregate) [consumed]
      Node 31300 (Hash Join) [consumed]
        Node 31301 (Seq Scan) - LEAF
        Node 31302 (Hash)
          Node 31303 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31297 | 31298, 31299, 31300 |
...
|------|------|--------|-----------|-----|--------|
| 31297 | Aggregate | 863.26 | 829.33 | 3.9% | pattern |
| 31301 | Seq Scan | 796.11 | 743.46 | 6.6% | operator |
| 31302 | Hash | 45.42 | 8.29 | 81.8% | operator |
| 31303 | Seq Scan | 45.33 | 23.76 | 47.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31303 (Seq Scan) - LEAF
...
### Step 2: Node 31301 (Seq Scan) - LEAF
...
### Step 4: Node 31297 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31298, 31299, 31300
- **Input Features:**
  ...
  - Aggregate_startup_cost=157339.4600
  - Aggregate_total_cost=157339.4700
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
