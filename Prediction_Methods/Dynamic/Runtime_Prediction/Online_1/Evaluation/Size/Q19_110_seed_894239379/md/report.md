...
```
Node 31297 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31298 (Gather) [consumed]
    Node 31299 (Aggregate) [consumed]
      Node 31300 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31297 | 31298, 31299 |
...
|------|------|--------|-----------|-----|--------|
| 31297 | Aggregate | 863.26 | 831.20 | 3.7% | pattern |
| 31300 | Hash Join | 843.16 | 766.06 | 9.1% | operator |
...
### Step 5: Node 31297 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31298, 31299
- **Input Features:**
