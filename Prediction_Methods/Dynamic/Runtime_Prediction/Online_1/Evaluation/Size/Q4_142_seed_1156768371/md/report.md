...
**Test Query:** Q4_142_seed_1156768371
**Timestamp:** 2026-01-18 16:32:10
...
```
Node 6173 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6174 (Gather Merge) [consumed]
    Node 6175 (Sort) [consumed]
      Node 6176 (Aggregate) [consumed]
        Node 6177 (Nested Loop)
          Node 6178 (Seq Scan) - LEAF
          Node 6179 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6173 | 6174, 6175, 6176 |
...
|------|------|--------|-----------|-----|--------|
| 6173 | Aggregate | 1089.02 | 952.19 | 12.6% | pattern |
| 6177 | Nested Loop | 1082.43 | 1255.45 | 16.0% | operator |
| 6178 | Seq Scan | 164.28 | 154.67 | 5.9% | operator |
| 6179 | Index Scan | 0.06 | 11.10 | 17250.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6178 (Seq Scan) - LEAF
...
### Step 2: Node 6179 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - Aggregate_startup_cost=66696.1600
  - Aggregate_total_cost=66698.0600
  ...
  - GatherMerge_Outer_startup_cost=66696.1600
  - GatherMerge_Outer_total_cost=66697.9400
  - Sort_Outer_np=0
  - Sort_Outer_nt=5
  - Sort_Outer_nt1=5
  - Sort_Outer_nt2=0
  ...
  - Sort_Outer_startup_cost=65696.1200
  - Sort_Outer_total_cost=65696.1300
