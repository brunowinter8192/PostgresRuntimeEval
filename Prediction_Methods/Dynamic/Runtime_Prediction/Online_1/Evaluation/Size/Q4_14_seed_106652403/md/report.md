...
```
Node 6229 (Aggregate) [PATTERN: f8231c4d] - ROOT
  Node 6230 (Gather Merge) [consumed]
    Node 6231 (Sort) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | f8231c4d | 6229 | 6230, 6231, 6232 |
...
|------|------|--------|-----------|-----|--------|
| 6229 | Aggregate | 1060.86 | 952.19 | 10.2% | pattern |
| 6233 | Nested Loop | 1053.52 | 1255.45 | 19.2% | operator |
| 6234 | Seq Scan | 162.43 | 154.66 | 4.8% | operator |
| 6235 | Index Scan | 0.06 | 11.10 | 17810.2% | operator |
