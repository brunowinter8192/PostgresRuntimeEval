        ...
        Node 29000 (Incremental Sort)
          Node 29001 (Nested Loop)
            Node 29002 (Merge Join)
              Node 29003 (Sort)
                Node 29004 (Hash Join)
                  Node 29005 (Seq Scan) - LEAF
                  Node 29006 (Hash)
...
| 29003 | Sort | 2842.14 | 1099.77 | 61.3% | operator |
| 29009 | Sort | 67.48 | 1074.66 | 1492.6% | operator |
| 29004 | Hash Join | 2842.12 | 686.33 | 75.9% | operator |
| 29010 | Seq Scan | 53.67 | 18.25 | 66.0% | operator |
| 29005 | Seq Scan | 194.42 | 170.37 | 12.4% | operator |
| 29006 | Hash | 2617.49 | 21.04 | 99.2% | operator |
...
### Step 3: Node 29005 (Seq Scan) - LEAF
...
### Step 6: Node 29010 (Seq Scan) - LEAF
...
### Step 9: Node 29002 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 10: Node 29011 (Index Scan) - LEAF
...
### Step 11: Node 29001 (Nested Loop)
...
### Step 12: Node 29000 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 13: Node 28999 (Gather Merge)
