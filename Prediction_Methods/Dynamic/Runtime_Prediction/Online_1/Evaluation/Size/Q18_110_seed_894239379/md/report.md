...
**Test Query:** Q18_110_seed_894239379
...
```
Node 28996 (Limit) - ROOT
  Node 28997 (Sort)
    Node 28998 (Aggregate)
      Node 28999 (Gather Merge)
        Node 29000 (Incremental Sort)
          Node 29001 (Nested Loop)
            Node 29002 (Merge Join)
              Node 29003 (Sort)
                Node 29004 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29005 (Seq Scan) [consumed] - LEAF
                  Node 29006 (Hash) [consumed]
                    Node 29007 (Aggregate)
                      Node 29008 (Index Scan) - LEAF
              Node 29009 (Sort)
                Node 29010 (Seq Scan) - LEAF
            Node 29011 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29004 | 29005, 29006 |
...
|------|------|--------|-----------|-----|--------|
| 28996 | Limit | 3049.42 | 1175.21 | 61.5% | operator |
| 28997 | Sort | 2932.40 | 1127.81 | 61.5% | operator |
| 28998 | Aggregate | 2932.35 | 1073.15 | 63.4% | operator |
| 28999 | Gather Merge | 2932.34 | 1073.95 | 63.4% | operator |
| 29000 | Incremental Sort | 2912.28 | 0.00 | 100.0% | operator |
| 29001 | Nested Loop | 2912.23 | 1111.34 | 61.8% | operator |
| 29002 | Merge Join | 2912.17 | 0.00 | 100.0% | operator |
| 29011 | Index Scan | 0.02 | 0.05 | 88.1% | operator |
| 29003 | Sort | 2842.14 | 1095.58 | 61.5% | operator |
| 29009 | Sort | 67.48 | 1074.66 | 1492.6% | operator |
| 29004 | Hash Join | 2842.12 | 471.07 | 83.4% | pattern |
| 29010 | Seq Scan | 53.67 | 18.25 | 66.0% | operator |
| 29007 | Aggregate | 2617.46 | 1073.15 | 59.0% | operator |
| 29008 | Index Scan | 2112.91 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29008 (Index Scan) - LEAF
...
### Step 3: Node 29004 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29005, 29006
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29010 (Seq Scan) - LEAF
...
### Step 7: Node 29002 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29011 (Index Scan) - LEAF
...
### Step 10: Node 29000 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 28999 (Gather Merge)
