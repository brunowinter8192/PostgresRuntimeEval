...
**Test Query:** Q13_94_seed_762974883
...
```
Node 26371 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26372 (Aggregate) [consumed]
    Node 26373 (Aggregate)
      Node 26374 (Hash Join) [PATTERN: 895c6e8c]
        Node 26375 (Seq Scan) [consumed] - LEAF
        Node 26376 (Hash) [consumed]
          Node 26377 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26371 | 26372, 26374, 26375, 26376 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26374 | 26371, 26372, 26375, 26376 |
...
|------|------|--------|-----------|-----|--------|
| 26371 | Sort | 938.47 | 1079.93 | 15.1% | pattern |
| 26373 | Aggregate | 932.37 | 999.15 | 7.2% | operator |
| 26374 | Hash Join | 720.21 | 470.31 | 34.7% | pattern |
| 26377 | Index Only Scan | 10.34 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26377 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26374 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26371, 26372, 26375, 26376
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1478958
...
### Step 4: Node 26371 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26372, 26374, 26375, 26376
- **Input Features:**
