...
**Test Query:** Q18_126_seed_1025503875
...
```
Node 29268 (Limit) - ROOT
  Node 29269 (Sort)
    Node 29270 (Aggregate)
      Node 29271 (Gather Merge)
        Node 29272 (Incremental Sort)
          Node 29273 (Nested Loop)
            Node 29274 (Merge Join)
              Node 29275 (Sort)
                Node 29276 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29277 (Seq Scan) [consumed] - LEAF
                  Node 29278 (Hash) [consumed]
                    Node 29279 (Aggregate)
                      Node 29280 (Index Scan) - LEAF
              Node 29281 (Sort)
                Node 29282 (Seq Scan) - LEAF
            Node 29283 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29276 | 29277, 29278 |
...
|------|------|--------|-----------|-----|--------|
| 29268 | Limit | 3043.42 | 1175.21 | 61.4% | operator |
| 29269 | Sort | 2925.17 | 1127.81 | 61.4% | operator |
| 29270 | Aggregate | 2925.13 | 1073.15 | 63.3% | operator |
| 29271 | Gather Merge | 2925.11 | 1073.95 | 63.3% | operator |
| 29272 | Incremental Sort | 2906.26 | 0.00 | 100.0% | operator |
| 29273 | Nested Loop | 2906.21 | 1111.34 | 61.8% | operator |
| 29274 | Merge Join | 2906.14 | 0.00 | 100.0% | operator |
| 29283 | Index Scan | 0.02 | 0.05 | 96.2% | operator |
| 29275 | Sort | 2837.47 | 1095.58 | 61.4% | operator |
| 29281 | Sort | 65.74 | 1074.66 | 1534.6% | operator |
| 29276 | Hash Join | 2837.45 | 471.07 | 83.4% | pattern |
| 29282 | Seq Scan | 53.74 | 18.25 | 66.0% | operator |
| 29279 | Aggregate | 2605.08 | 1073.15 | 58.8% | operator |
| 29280 | Index Scan | 2108.82 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29280 (Index Scan) - LEAF
...
### Step 3: Node 29276 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29277, 29278
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29282 (Seq Scan) - LEAF
...
### Step 7: Node 29274 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 29283 (Index Scan) - LEAF
...
### Step 10: Node 29272 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 29271 (Gather Merge)
