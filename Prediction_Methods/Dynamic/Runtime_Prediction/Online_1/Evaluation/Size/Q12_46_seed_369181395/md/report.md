...
**Test Query:** Q12_46_seed_369181395
...
```
Node 24950 (Aggregate) - ROOT
  Node 24951 (Gather Merge)
    Node 24952 (Aggregate)
      Node 24953 (Sort)
        Node 24954 (Nested Loop)
          Node 24955 (Seq Scan) - LEAF
          Node 24956 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24950 | Aggregate | 1004.36 | 919.09 | 8.5% | operator |
| 24951 | Gather Merge | 1004.35 | 1111.84 | 10.7% | operator |
| 24952 | Aggregate | 983.84 | 895.33 | 9.0% | operator |
| 24953 | Sort | 983.23 | 1092.79 | 11.1% | operator |
| 24954 | Nested Loop | 982.24 | 1127.41 | 14.8% | operator |
| 24955 | Seq Scan | 846.01 | 745.19 | 11.9% | operator |
| 24956 | Index Scan | 0.03 | 0.07 | 176.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24955 (Seq Scan) - LEAF
...
### Step 2: Node 24956 (Index Scan) - LEAF
...
### Step 6: Node 24951 (Gather Merge)
...
### Step 7: Node 24950 (Aggregate) - ROOT
