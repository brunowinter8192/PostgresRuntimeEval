...
```
Node 26588 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 26589 (Gather) [consumed]
    Node 26590 (Aggregate) [consumed]
      Node 26591 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 26588 | 26589, 26590, 26591 |
...
|------|------|--------|-----------|-----|--------|
| 26588 | Aggregate | 830.03 | 857.13 | 3.3% | pattern |
...
### Step 4: Node 26588 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 26589, 26590, 26591
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=15138
  - HashJoin_Outer_nt1=15138
  ...
  - HashJoin_Outer_total_cost=136646.3800
- **Output:** st=850.77, rt=857.13
