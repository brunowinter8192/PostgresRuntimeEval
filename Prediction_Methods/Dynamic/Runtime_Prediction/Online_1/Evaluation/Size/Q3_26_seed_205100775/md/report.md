...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5031 | 5032, 5033, 5034, 5036, 5037, 5038 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5036 | 5031, 5032, 5033, 5034, 5037, 5038 |
...
|------|------|--------|-----------|-----|--------|
| 5031 | Limit | 1230.86 | 1151.18 | 6.5% | pattern |
| 5035 | Nested Loop | 1195.10 | 1192.86 | 0.2% | operator |
| 5036 | Hash Join | 211.17 | 242.44 | 14.8% | pattern |
| 5040 | Index Scan | 0.03 | -0.52 | 2018.8% | operator |
| 5039 | Seq Scan | 30.37 | 38.57 | 27.0% | operator |
...
- **Consumes:** Nodes 5031, 5032, 5033, 5034, 5037, 5038
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46619
  - HashJoin_nt1=233346
  ...
  - HashJoin_total_cost=37334.2800
  - Hash_Inner_np=0
  - Hash_Inner_nt=12487
...
### Step 3: Node 5040 (Index Scan) - LEAF
...
- **Output:** st=121.61, rt=1192.86

### Step 5: Node 5031 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5032, 5033, 5034, 5036, 5037, 5038
- **Input Features:**
