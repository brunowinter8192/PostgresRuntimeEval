    ...
    Node 4443 (Aggregate) [consumed]
      Node 4444 (Gather) [consumed]
        Node 4445 (Nested Loop)
          Node 4446 (Hash Join) [PATTERN: 895c6e8c]
            Node 4447 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4441 | 4442, 4443, 4444, 4446, 4447, 4448 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4446 | 4441, 4442, 4443, 4444, 4447, 4448 |
...
|------|------|--------|-----------|-----|--------|
| 4441 | Limit | 1204.95 | 1151.18 | 4.5% | pattern |
| 4445 | Nested Loop | 1169.65 | 1193.28 | 2.0% | operator |
| 4446 | Hash Join | 211.27 | 242.52 | 14.8% | pattern |
| 4450 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4449 | Seq Scan | 28.62 | 38.54 | 34.6% | operator |
...
### Step 2: Node 4446 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4441, 4442, 4443, 4444, 4447, 4448
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47271
  - HashJoin_nt1=235242
...
- **Output:** st=122.01, rt=1193.28

### Step 5: Node 4441 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4442, 4443, 4444, 4446, 4447, 4448
- **Input Features:**
