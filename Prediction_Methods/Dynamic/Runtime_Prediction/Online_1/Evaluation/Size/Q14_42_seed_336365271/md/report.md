...
```
Node 27022 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27023 (Gather) [consumed]
    Node 27024 (Aggregate) [consumed]
      Node 27025 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27022 | 27023, 27024, 27025 |
...
|------|------|--------|-----------|-----|--------|
| 27022 | Aggregate | 838.50 | 857.14 | 2.2% | pattern |
...
### Step 4: Node 27022 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27023, 27024, 27025
- **Input Features:**
