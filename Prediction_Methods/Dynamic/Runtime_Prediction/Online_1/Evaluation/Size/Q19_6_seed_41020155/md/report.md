...
**Test Query:** Q19_6_seed_41020155
...
```
Node 32032 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 32033 (Gather) [consumed]
    Node 32034 (Aggregate) [consumed]
      Node 32035 (Hash Join) [consumed]
        Node 32036 (Seq Scan) - LEAF
        Node 32037 (Hash)
          Node 32038 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 32032 | 32033, 32034, 32035 |
...
|------|------|--------|-----------|-----|--------|
| 32032 | Aggregate | 853.83 | 829.29 | 2.9% | pattern |
| 32036 | Seq Scan | 785.45 | 743.46 | 5.3% | operator |
| 32037 | Hash | 44.29 | 8.29 | 81.3% | operator |
| 32038 | Seq Scan | 44.13 | 23.76 | 46.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 32038 (Seq Scan) - LEAF
...
### Step 2: Node 32036 (Seq Scan) - LEAF
...
### Step 4: Node 32032 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 32033, 32034, 32035
- **Input Features:**
  ...
  - Aggregate_Outer_startup_cost=156338.5200
  - Aggregate_Outer_total_cost=156338.5300
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=157339.0600
  - Aggregate_total_cost=157339.0700
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=157338.5200
  - Gather_Outer_total_cost=157339.0300
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=23
  - HashJoin_Outer_nt1=22425
  ...
  - HashJoin_Outer_total_cost=156338.3500
- **Output:** st=824.25, rt=829.29
