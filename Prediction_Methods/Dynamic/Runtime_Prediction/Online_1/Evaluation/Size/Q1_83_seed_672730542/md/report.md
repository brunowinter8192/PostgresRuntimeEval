...
Node 656 (Aggregate) - ROOT
  Node 657 (Gather Merge)
    Node 658 (Sort) [PATTERN: 1d35fb97]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 658 | 659 |
...
|------|------|--------|-----------|-----|--------|
| 656 | Aggregate | 995.76 | 1195.89 | 20.1% | operator |
| 657 | Gather Merge | 995.72 | 1165.91 | 17.1% | operator |
| 658 | Sort | 977.95 | 1200.53 | 22.8% | pattern |
| 660 | Seq Scan | 575.67 | 680.15 | 18.1% | operator |
...
### Step 2: Node 658 (Sort) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=168983.5800
  - Sort_total_cost=168983.5900
- **Output:** st=1196.44, rt=1200.53

### Step 3: Node 657 (Gather Merge)
...
### Step 4: Node 656 (Aggregate) - ROOT
