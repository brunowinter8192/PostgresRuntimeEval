...
**Test Query:** Q9_52_seed_418405581
...
```
Node 18408 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18409 (Aggregate) [consumed]
    Node 18410 (Gather)
      Node 18411 (Aggregate)
        Node 18412 (Nested Loop)
          Node 18413 (Hash Join) [PATTERN: bb930825]
            Node 18414 (Seq Scan) [consumed] - LEAF
            Node 18415 (Hash) [consumed]
              Node 18416 (Hash Join) [consumed]
                Node 18417 (Hash Join)
                  Node 18418 (Nested Loop)
                    Node 18419 (Seq Scan) - LEAF
                    Node 18420 (Index Scan) - LEAF
                  Node 18421 (Hash)
                    Node 18422 (Seq Scan) - LEAF
                Node 18423 (Hash)
                  Node 18424 (Seq Scan) - LEAF
          Node 18425 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18413 | 18408, 18409, 18414, 18415, 18416 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18408 | 18409, 18413, 18414, 18415, 18416 |
...
|------|------|--------|-----------|-----|--------|
| 18408 | Sort | 1200.78 | 1045.86 | 12.9% | pattern |
| 18410 | Gather | 1199.58 | 964.48 | 19.6% | operator |
| 18411 | Aggregate | 1180.99 | 1075.81 | 8.9% | operator |
| 18412 | Nested Loop | 1156.05 | 1252.17 | 8.3% | operator |
| 18413 | Hash Join | 975.42 | 134.80 | 86.2% | pattern |
| 18425 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18417 | Hash Join | 155.58 | 837.66 | 438.4% | operator |
| 18423 | Hash | 13.45 | 14.95 | 11.2% | operator |
| 18418 | Nested Loop | 148.54 | 1251.77 | 742.7% | operator |
| 18421 | Hash | 4.64 | 15.94 | 243.8% | operator |
| 18424 | Seq Scan | 13.44 | 2.94 | 78.1% | operator |
| 18419 | Seq Scan | 20.49 | 43.89 | 114.2% | operator |
| 18420 | Index Scan | 0.07 | -1.39 | 2083.6% | operator |
| 18422 | Seq Scan | 3.99 | 9.45 | 136.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 18419 (Seq Scan) - LEAF
...
### Step 2: Node 18420 (Index Scan) - LEAF
...
### Step 3: Node 18422 (Seq Scan) - LEAF
...
### Step 6: Node 18424 (Seq Scan) - LEAF
...
### Step 9: Node 18413 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18408, 18409, 18414, 18415, 18416
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18425 (Index Scan) - LEAF
...
### Step 11: Node 18412 (Nested Loop)
...
### Step 14: Node 18408 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18409, 18413, 18414, 18415, 18416
- **Input Features:**
