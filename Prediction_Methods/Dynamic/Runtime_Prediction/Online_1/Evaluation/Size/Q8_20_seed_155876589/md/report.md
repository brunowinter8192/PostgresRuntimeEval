...
```
Node 14627 (Aggregate) - ROOT
  Node 14628 (Gather Merge)
    Node 14629 (Sort)
          ...
          Node 14632 (Hash Join)
            Node 14633 (Nested Loop)
              Node 14634 (Hash Join)
                ...
                Node 14636 (Hash)
                  Node 14637 (Hash Join)
                    Node 14638 (Seq Scan) - LEAF
                    Node 14639 (Hash)
                      Node 14640 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 14627 | Aggregate | 1242.52 | 1191.43 | 4.1% | operator |
| 14628 | Gather Merge | 1242.01 | 1097.14 | 11.7% | operator |
...
| 14634 | Hash Join | 217.19 | 251.17 | 15.6% | operator |
...
| 14636 | Hash | 35.39 | 20.62 | 41.7% | operator |
| 14637 | Hash Join | 34.70 | 132.26 | 281.2% | operator |
| 14638 | Seq Scan | 33.12 | 23.03 | 30.5% | operator |
| 14639 | Hash | 0.22 | 23.66 | 10604.1% | operator |
| 14640 | Hash Join | 0.22 | 306.84 | 140650.4% | operator |
...
### Step 5: Node 14638 (Seq Scan) - LEAF
...
### Step 8: Node 14635 (Seq Scan) - LEAF
...
### Step 11: Node 14644 (Index Scan) - LEAF
...
### Step 12: Node 14646 (Seq Scan) - LEAF
...
### Step 13: Node 14633 (Nested Loop)
...
### Step 16: Node 14647 (Index Scan) - LEAF
...
### Step 17: Node 14649 (Seq Scan) - LEAF
...
### Step 18: Node 14631 (Nested Loop)
...
### Step 22: Node 14628 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1044.9434
  - st2=0.0000
  - startup_cost=71555.0600
  - total_cost=71845.2600
- **Output:** st=1093.43, rt=1097.14

### Step 23: Node 14627 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=71555.0600
  - total_cost=71942.4400
- **Output:** st=1162.24, rt=1191.43
