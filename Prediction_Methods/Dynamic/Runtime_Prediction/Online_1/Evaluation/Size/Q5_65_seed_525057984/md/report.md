...
**Test Query:** Q5_65_seed_525057984
...
```
Node 9121 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 9122 (Aggregate) [consumed]
    Node 9123 (Gather Merge) [consumed]
      Node 9124 (Aggregate)
        Node 9125 (Sort) [PATTERN: 3e2d5a00]
          Node 9126 (Hash Join) [consumed]
            Node 9127 (Nested Loop)
              Node 9128 (Hash Join)
                Node 9129 (Seq Scan) - LEAF
                Node 9130 (Hash) [PATTERN: 444761fb]
                  Node 9131 (Hash Join) [consumed]
                    Node 9132 (Seq Scan) [consumed] - LEAF
                    Node 9133 (Hash) [consumed]
                      Node 9134 (Hash Join) [consumed]
                        Node 9135 (Seq Scan) - LEAF
                        Node 9136 (Hash)
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 9130 | 9121, 9122, 9123, 9125, 9126, 9131, 9132, 9133, 9134 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 9121 | 9122, 9123, 9125, 9126, 9130, 9131, 9132, 9133, 9134 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 9125 | 9121, 9122, 9123, 9126, 9130, 9131, 9132, 9133, 9134 |
...
|------|------|--------|-----------|-----|--------|
| 9121 | Sort | 1083.63 | 2934.42 | 170.8% | pattern |
| 9124 | Aggregate | 1078.45 | 1128.78 | 4.7% | operator |
| 9125 | Sort | 1078.19 | 1835.91 | 70.3% | pattern |
| 9127 | Nested Loop | 1066.50 | 1188.39 | 11.4% | operator |
| 9139 | Hash | 3.23 | 18.67 | 477.5% | operator |
| 9128 | Hash Join | 222.39 | 253.07 | 13.8% | operator |
| 9138 | Index Scan | 0.07 | -0.22 | 393.4% | operator |
| 9140 | Seq Scan | 2.76 | 12.36 | 347.3% | operator |
| 9129 | Seq Scan | 170.11 | 159.81 | 6.1% | operator |
| 9130 | Hash | 39.68 | 46.85 | 18.1% | pattern |
| 9135 | Seq Scan | 0.01 | 11.81 | 147503.4% | operator |
| 9136 | Hash | 0.24 | 21.05 | 8672.2% | operator |
| 9137 | Seq Scan | 0.24 | 22.93 | 9576.5% | operator |
...
### Step 2: Node 9135 (Seq Scan) - LEAF
...
### Step 4: Node 9129 (Seq Scan) - LEAF
...
### Step 5: Node 9130 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 9121, 9122, 9123, 9125, 9126, 9131, 9132, 9133, 9134
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 9138 (Index Scan) - LEAF
...
### Step 8: Node 9140 (Seq Scan) - LEAF
...
### Step 11: Node 9125 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 9121, 9122, 9123, 9126, 9130, 9131, 9132, 9133, 9134
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 9121 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 9122, 9123, 9125, 9126, 9130, 9131, 9132, 9133, 9134
- **Input Features:**
