...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5491 | 5492, 5493, 5494 |
...
| 5495 | Nested Loop | 1157.12 | 1193.05 | 3.1% | operator |
| 5496 | Hash Join | 208.72 | 230.61 | 10.5% | operator |
| 5500 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5497 | Seq Scan | 155.04 | 163.32 | 5.3% | operator |
| 5498 | Hash | 31.02 | 17.75 | 42.8% | operator |
...
### Step 2: Node 5497 (Seq Scan) - LEAF
...
### Step 5: Node 5500 (Index Scan) - LEAF
...
### Step 7: Node 5491 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5492, 5493, 5494
- **Input Features:**
