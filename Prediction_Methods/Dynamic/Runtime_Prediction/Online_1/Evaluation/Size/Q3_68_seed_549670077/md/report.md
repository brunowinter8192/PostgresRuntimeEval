...
**Test Query:** Q3_68_seed_549670077
...
```
Node 5491 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5492 (Sort) [consumed]
    Node 5493 (Aggregate) [consumed]
      Node 5494 (Gather) [consumed]
        Node 5495 (Nested Loop)
          Node 5496 (Hash Join) [PATTERN: 895c6e8c]
            Node 5497 (Seq Scan) [consumed] - LEAF
            Node 5498 (Hash) [consumed]
              Node 5499 (Seq Scan) - LEAF
          Node 5500 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5491 | 5492, 5493, 5494, 5496, 5497, 5498 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5496 | 5491, 5492, 5493, 5494, 5497, 5498 |
...
|------|------|--------|-----------|-----|--------|
| 5491 | Limit | 1193.19 | 1151.18 | 3.5% | pattern |
| 5495 | Nested Loop | 1157.12 | 1193.13 | 3.1% | operator |
| 5496 | Hash Join | 208.72 | 242.50 | 16.2% | pattern |
| 5500 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5499 | Seq Scan | 30.24 | 38.54 | 27.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5499 (Seq Scan) - LEAF
...
### Step 2: Node 5496 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5491, 5492, 5493, 5494, 5497, 5498
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47049
  - HashJoin_nt1=234136
...
- **Output:** st=29.75, rt=242.50

### Step 3: Node 5500 (Index Scan) - LEAF
...
- **Output:** st=121.87, rt=1193.13

### Step 5: Node 5491 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5492, 5493, 5494, 5496, 5497, 5498
- **Input Features:**
