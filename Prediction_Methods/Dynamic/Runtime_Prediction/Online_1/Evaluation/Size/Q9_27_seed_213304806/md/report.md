    ...
    Node 17903 (Gather)
      Node 17904 (Aggregate)
        Node 17905 (Nested Loop)
          Node 17906 (Hash Join) [PATTERN: bb930825]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17906 | 17901, 17902, 17907, 17908, 17909 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17901 | 17902, 17906, 17907, 17908, 17909 |
...
|------|------|--------|-----------|-----|--------|
| 17901 | Sort | 1183.07 | 1045.32 | 11.6% | pattern |
...
| 17906 | Hash Join | 968.30 | 134.80 | 86.1% | pattern |
...
### Step 9: Node 17906 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17901, 17902, 17907, 17908, 17909
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 11: Node 17905 (Nested Loop)
...
### Step 14: Node 17901 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17902, 17906, 17907, 17908, 17909
- **Input Features:**
