...
**Test Query:** Q7_130_seed_1058319999
...
```
Node 11095 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 11096 (Gather Merge) [consumed]
    Node 11097 (Sort)
      Node 11098 (Hash Join)
        Node 11099 (Nested Loop)
          Node 11100 (Hash Join) [PATTERN: 895c6e8c]
            Node 11101 (Seq Scan) [consumed] - LEAF
            Node 11102 (Hash) [consumed]
              Node 11103 (Hash Join) [PATTERN: f4cb205a]
                Node 11104 (Seq Scan) [consumed] - LEAF
                Node 11105 (Hash) [consumed]
                  Node 11106 (Seq Scan) [consumed] - LEAF
          Node 11107 (Index Scan) - LEAF
        Node 11108 (Hash)
          Node 11109 (Hash Join) [PATTERN: f4cb205a]
            Node 11110 (Seq Scan) [consumed] - LEAF
            Node 11111 (Hash) [consumed]
              Node 11112 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 11103 | 11095, 11096, 11100, 11101, 11102, 11104, 11105, 11106, 11109, 11110, 11111, 11112 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 11109 | 11095, 11096, 11100, 11101, 11102, 11103, 11104, 11105, 11106, 11110, 11111, 11112 |
| Aggregate -> Gather Merge (Out | 2724c080 | 11095 | 11096, 11100, 11101, 11102, 11103, 11104, 11105, 11106, 11109, 11110, 11111, 11112 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 11100 | 11095, 11096, 11101, 11102, 11103, 11104, 11105, 11106, 11109, 11110, 11111, 11112 |
...
|------|------|--------|-----------|-----|--------|
| 11095 | Aggregate | 1188.61 | 1163.13 | 2.1% | pattern |
| 11097 | Sort | 1181.80 | 1109.16 | 6.1% | operator |
| 11098 | Hash Join | 1181.16 | 843.11 | 28.6% | operator |
| 11099 | Nested Loop | 1174.44 | 1215.99 | 3.5% | operator |
| 11108 | Hash | 3.01 | 27.74 | 820.5% | operator |
| 11100 | Hash Join | 216.39 | 304.89 | 40.9% | pattern |
| 11107 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 11109 | Hash Join | 2.97 | 429.36 | 14351.8% | pattern |
| 11103 | Hash Join | 36.65 | 429.38 | 1071.5% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11103 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 11095, 11096, 11100, 11101, 11102, 11104, 11105, 11106, 11109, 11110, 11111, 11112
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5000
  - HashJoin_nt1=62500
...
### Step 2: Node 11100 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 11095, 11096, 11101, 11102, 11103, 11104, 11105, 11106, 11109, 11110, 11111, 11112
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=38710
  - HashJoin_nt1=483871
...
### Step 3: Node 11107 (Index Scan) - LEAF
...
### Step 4: Node 11109 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 11095, 11096, 11100, 11101, 11102, 11103, 11104, 11105, 11106, 11110, 11111, 11112
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=800
  - HashJoin_nt1=10000
...
### Step 9: Node 11095 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 11096, 11100, 11101, 11102, 11103, 11104, 11105, 11106, 11109, 11110, 11111, 11112
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
