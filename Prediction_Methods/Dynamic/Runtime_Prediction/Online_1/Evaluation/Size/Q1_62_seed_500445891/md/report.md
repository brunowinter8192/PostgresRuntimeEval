...
Node 541 (Aggregate) - ROOT
  Node 542 (Gather Merge)
    Node 543 (Sort) [PATTERN: 1d35fb97]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 543 | 544 |
...
|------|------|--------|-----------|-----|--------|
| 541 | Aggregate | 995.78 | 1195.87 | 20.1% | operator |
| 542 | Gather Merge | 995.74 | 1165.90 | 17.1% | operator |
| 543 | Sort | 979.25 | 1200.45 | 22.6% | pattern |
...
### Step 2: Node 543 (Sort) - PATTERN ROOT
...
### Step 4: Node 541 (Aggregate) - ROOT
