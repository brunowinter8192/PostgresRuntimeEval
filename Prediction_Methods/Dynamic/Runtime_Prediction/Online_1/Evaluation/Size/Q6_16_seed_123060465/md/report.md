...
**Test Query:** Q6_16_seed_123060465
...
```
Node 10129 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10130 (Gather) [consumed]
    Node 10131 (Aggregate) [consumed]
      Node 10132 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10129 | 10130, 10131 |
...
|------|------|--------|-----------|-----|--------|
| 10129 | Aggregate | 797.58 | 850.07 | 6.6% | pattern |
| 10132 | Seq Scan | 776.92 | 748.54 | 3.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10132 (Seq Scan) - LEAF
...
### Step 2: Node 10129 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10130, 10131
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=23877
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=32
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=139724.8600
  - Aggregate_Outer_total_cost=139724.8700
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=140725.3900
  - Aggregate_total_cost=140725.4000
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=140724.8600
  - Gather_Outer_total_cost=140725.3700
