...
**Test Query:** Q8_21_seed_164080620
...
```
Node 14650 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 14651 (Gather Merge) [consumed]
    Node 14652 (Sort)
      Node 14653 (Hash Join)
        Node 14654 (Nested Loop)
          Node 14655 (Hash Join)
            Node 14656 (Nested Loop)
              Node 14657 (Hash Join)
                Node 14658 (Seq Scan) - LEAF
                Node 14659 (Hash) [PATTERN: 444761fb]
                  Node 14660 (Hash Join) [consumed]
                    Node 14661 (Seq Scan) [consumed] - LEAF
                    Node 14662 (Hash) [consumed]
                      Node 14663 (Hash Join) [consumed]
                        Node 14664 (Seq Scan) - LEAF
                        Node 14665 (Hash)
                          Node 14666 (Seq Scan) - LEAF
              Node 14667 (Index Scan) - LEAF
            Node 14668 (Hash)
              Node 14669 (Seq Scan) - LEAF
          Node 14670 (Index Scan) - LEAF
        Node 14671 (Hash)
          Node 14672 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 14659 | 14650, 14651, 14660, 14661, 14662, 14663 |
| Aggregate -> Gather Merge (Out | 2724c080 | 14650 | 14651, 14659, 14660, 14661, 14662, 14663 |
...
|------|------|--------|-----------|-----|--------|
| 14650 | Aggregate | 1224.07 | 1132.01 | 7.5% | pattern |
| 14652 | Sort | 1214.38 | 1046.21 | 13.8% | operator |
| 14653 | Hash Join | 1214.12 | 785.61 | 35.3% | operator |
| 14654 | Nested Loop | 1213.80 | 1198.29 | 1.3% | operator |
| 14671 | Hash | 0.02 | 13.72 | 80629.9% | operator |
| 14655 | Hash Join | 1209.85 | 785.60 | 35.1% | operator |
| 14670 | Index Scan | 0.01 | 12.42 | 206958.1% | operator |
| 14672 | Seq Scan | 0.01 | 6.51 | 54166.4% | operator |
| 14656 | Nested Loop | 1167.80 | 1198.29 | 2.6% | operator |
| 14668 | Hash | 37.71 | 19.97 | 47.0% | operator |
| 14657 | Hash Join | 211.46 | 251.67 | 19.0% | operator |
| 14667 | Index Scan | 0.04 | 2.88 | 6759.2% | operator |
| 14669 | Seq Scan | 37.63 | 48.87 | 29.9% | operator |
| 14658 | Seq Scan | 156.08 | 159.67 | 2.3% | operator |
| 14659 | Hash | 35.65 | 43.51 | 22.1% | pattern |
| 14664 | Seq Scan | 0.01 | 12.22 | 111035.8% | operator |
| 14665 | Hash | 0.20 | 18.14 | 9110.2% | operator |
| 14666 | Seq Scan | 0.19 | 23.36 | 11942.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 14666 (Seq Scan) - LEAF
...
### Step 2: Node 14664 (Seq Scan) - LEAF
...
### Step 4: Node 14658 (Seq Scan) - LEAF
...
### Step 5: Node 14659 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 14650, 14651, 14660, 14661, 14662, 14663
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 14667 (Index Scan) - LEAF
...
### Step 8: Node 14669 (Seq Scan) - LEAF
...
### Step 12: Node 14670 (Index Scan) - LEAF
...
### Step 13: Node 14672 (Seq Scan) - LEAF
...
### Step 14: Node 14654 (Nested Loop)
...
### Step 18: Node 14650 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 14651, 14659, 14660, 14661, 14662, 14663
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2438
