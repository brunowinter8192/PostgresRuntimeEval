...
```
Node 31899 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31900 (Gather) [consumed]
    Node 31901 (Aggregate) [consumed]
      Node 31902 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31899 | 31900, 31901, 31902 |
...
|------|------|--------|-----------|-----|--------|
| 31899 | Aggregate | 834.26 | 829.29 | 0.6% | pattern |
...
### Step 4: Node 31899 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31900, 31901, 31902
- **Input Features:**
