...
**Test Query:** Q19_52_seed_418405581
...
```
Node 31899 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31900 (Gather) [consumed]
    Node 31901 (Aggregate) [consumed]
      Node 31902 (Hash Join)
        Node 31903 (Seq Scan) - LEAF
        Node 31904 (Hash)
          Node 31905 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31899 | 31900, 31901 |
...
|------|------|--------|-----------|-----|--------|
| 31899 | Aggregate | 834.26 | 831.20 | 0.4% | pattern |
| 31902 | Hash Join | 817.02 | 766.05 | 6.2% | operator |
| 31903 | Seq Scan | 768.15 | 743.46 | 3.2% | operator |
| 31904 | Hash | 46.46 | 8.29 | 82.2% | operator |
| 31905 | Seq Scan | 46.30 | 23.76 | 48.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31905 (Seq Scan) - LEAF
...
### Step 2: Node 31903 (Seq Scan) - LEAF
...
### Step 5: Node 31899 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31900, 31901
- **Input Features:**
