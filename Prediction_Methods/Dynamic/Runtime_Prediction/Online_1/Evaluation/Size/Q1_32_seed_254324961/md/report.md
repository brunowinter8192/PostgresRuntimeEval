...
**Test Query:** Q1_32_seed_254324961
...
```
Node 376 (Aggregate) - ROOT
  Node 377 (Gather Merge)
    Node 378 (Sort) [PATTERN: 1d35fb97]
      Node 379 (Aggregate) [consumed]
        Node 380 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 378 | 379 |
...
|------|------|--------|-----------|-----|--------|
| 376 | Aggregate | 939.23 | 1195.78 | 27.3% | operator |
| 377 | Gather Merge | 939.17 | 1165.87 | 24.1% | operator |
| 378 | Sort | 920.25 | 1200.09 | 30.4% | pattern |
| 380 | Seq Scan | 514.74 | 681.84 | 32.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 380 (Seq Scan) - LEAF
...
- **Output:** st=0.85, rt=681.84

### Step 2: Node 378 (Sort) - PATTERN ROOT
...
- **Input Features:**
  ...
  - Aggregate_Outer_nt1=1173665
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=236
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=168681.3100
  - Aggregate_Outer_total_cost=168681.4500
  - Sort_np=0
  - Sort_nt=6
  - Sort_nt1=6
  - Sort_nt2=0
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=168681.5300
  - Sort_total_cost=168681.5400
- **Output:** st=1195.99, rt=1200.09

### Step 3: Node 377 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1195.9885
  - st2=0.0000
  - startup_cost=169681.6000
  - total_cost=169685.2300
- **Output:** st=1161.75, rt=1165.87

### Step 4: Node 376 (Aggregate) - ROOT
