...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5161 | 5162, 5163, 5164 |
...
| 5165 | Nested Loop | 1163.28 | 1193.09 | 2.6% | operator |
| 5166 | Hash Join | 208.12 | 230.67 | 10.8% | operator |
| 5170 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5167 | Seq Scan | 153.80 | 163.34 | 6.2% | operator |
| 5168 | Hash | 31.07 | 17.75 | 42.9% | operator |
...
### Step 2: Node 5167 (Seq Scan) - LEAF
...
- **Output:** st=0.29, rt=163.34

### Step 3: Node 5168 (Hash)
...
- **Output:** st=27.17, rt=230.67

### Step 5: Node 5170 (Index Scan) - LEAF
...
- **Output:** st=121.77, rt=1193.09

### Step 7: Node 5161 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5162, 5163, 5164
- **Input Features:**
