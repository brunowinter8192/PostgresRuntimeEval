...
**Test Query:** Q3_38_seed_303549147
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5161 | 5162, 5163, 5164, 5166, 5167, 5168 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5166 | 5161, 5162, 5163, 5164, 5167, 5168 |
...
|------|------|--------|-----------|-----|--------|
| 5161 | Limit | 1201.50 | 1151.18 | 4.2% | pattern |
| 5165 | Nested Loop | 1163.28 | 1193.18 | 2.6% | operator |
| 5166 | Hash Join | 208.12 | 242.50 | 16.5% | pattern |
| 5170 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 5169 | Seq Scan | 30.32 | 38.54 | 27.1% | operator |
...
- **Consumes:** Nodes 5161, 5162, 5163, 5164, 5167, 5168
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47112
  - HashJoin_nt1=234452
  ...
  - HashJoin_total_cost=37338.0800
  - Hash_Inner_np=0
  - Hash_Inner_nt=12559
...
- **Output:** st=29.74, rt=242.50

### Step 3: Node 5170 (Index Scan) - LEAF
...
- **Output:** st=121.91, rt=1193.18

### Step 5: Node 5161 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5162, 5163, 5164, 5166, 5167, 5168
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=315278
  - Aggregate_Outer_nt1=315278
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110297.7400
  - Aggregate_Outer_total_cost=114238.7100
  - Gather_Outer_np=0
