...
**Test Query:** Q12_130_seed_1058319999
...
```
Node 24551 (Aggregate) - ROOT
  Node 24552 (Gather Merge)
    Node 24553 (Aggregate)
      Node 24554 (Sort)
        Node 24555 (Nested Loop)
          Node 24556 (Seq Scan) - LEAF
          Node 24557 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 24551 | Aggregate | 993.94 | 919.04 | 7.5% | operator |
| 24552 | Gather Merge | 993.92 | 1111.84 | 11.9% | operator |
| 24553 | Aggregate | 974.75 | 895.29 | 8.2% | operator |
| 24554 | Sort | 974.16 | 1092.83 | 12.2% | operator |
| 24555 | Nested Loop | 973.30 | 1127.41 | 15.8% | operator |
| 24556 | Seq Scan | 844.48 | 745.20 | 11.8% | operator |
| 24557 | Index Scan | 0.02 | 0.07 | 199.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24556 (Seq Scan) - LEAF
...
### Step 2: Node 24557 (Index Scan) - LEAF
...
### Step 6: Node 24552 (Gather Merge)
...
### Step 7: Node 24551 (Aggregate) - ROOT
