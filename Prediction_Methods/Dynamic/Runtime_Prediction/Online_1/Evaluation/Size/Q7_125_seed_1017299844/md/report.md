...
**Test Query:** Q7_125_seed_1017299844
...
```
Node 10987 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 10988 (Gather Merge) [consumed]
    Node 10989 (Sort)
      Node 10990 (Hash Join)
        Node 10991 (Nested Loop)
          Node 10992 (Hash Join) [PATTERN: 895c6e8c]
            Node 10993 (Seq Scan) [consumed] - LEAF
            Node 10994 (Hash) [consumed]
              Node 10995 (Hash Join) [PATTERN: f4cb205a]
                Node 10996 (Seq Scan) [consumed] - LEAF
                Node 10997 (Hash) [consumed]
                  Node 10998 (Seq Scan) [consumed] - LEAF
          Node 10999 (Index Scan) - LEAF
        Node 11000 (Hash)
          Node 11001 (Hash Join) [PATTERN: f4cb205a]
            Node 11002 (Seq Scan) [consumed] - LEAF
            Node 11003 (Hash) [consumed]
              Node 11004 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 10995 | 10987, 10988, 10992, 10993, 10994, 10996, 10997, 10998, 11001, 11002, 11003, 11004 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 11001 | 10987, 10988, 10992, 10993, 10994, 10995, 10996, 10997, 10998, 11002, 11003, 11004 |
| Aggregate -> Gather Merge (Out | 2724c080 | 10987 | 10988, 10992, 10993, 10994, 10995, 10996, 10997, 10998, 11001, 11002, 11003, 11004 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 10992 | 10987, 10988, 10993, 10994, 10995, 10996, 10997, 10998, 11001, 11002, 11003, 11004 |
...
|------|------|--------|-----------|-----|--------|
| 10987 | Aggregate | 1170.38 | 1163.13 | 0.6% | pattern |
| 10989 | Sort | 1163.77 | 1109.16 | 4.7% | operator |
| 10990 | Hash Join | 1163.17 | 843.11 | 27.5% | operator |
| 10991 | Nested Loop | 1154.45 | 1215.99 | 5.3% | operator |
| 11000 | Hash | 5.00 | 27.74 | 455.4% | operator |
| 10992 | Hash Join | 209.85 | 304.89 | 45.3% | pattern |
| 10999 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 11001 | Hash Join | 4.94 | 429.36 | 8593.3% | pattern |
| 10995 | Hash Join | 34.09 | 429.38 | 1159.4% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10995 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 10987, 10988, 10992, 10993, 10994, 10996, 10997, 10998, 11001, 11002, 11003, 11004
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5000
  - HashJoin_nt1=62500
...
### Step 2: Node 10992 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 10987, 10988, 10993, 10994, 10995, 10996, 10997, 10998, 11001, 11002, 11003, 11004
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=38710
  - HashJoin_nt1=483871
...
### Step 3: Node 10999 (Index Scan) - LEAF
...
### Step 4: Node 11001 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 10987, 10988, 10992, 10993, 10994, 10995, 10996, 10997, 10998, 11002, 11003, 11004
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=800
  - HashJoin_nt1=10000
...
### Step 9: Node 10987 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 10988, 10992, 10993, 10994, 10995, 10996, 10997, 10998, 11001, 11002, 11003, 11004
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
