...
```
Node 10987 (Aggregate) - ROOT
  Node 10988 (Gather Merge)
    Node 10989 (Sort)
      Node 10990 (Hash Join)
        Node 10991 (Nested Loop)
          Node 10992 (Hash Join)
            Node 10993 (Seq Scan) - LEAF
            Node 10994 (Hash)
              Node 10995 (Hash Join)
                Node 10996 (Seq Scan) - LEAF
                Node 10997 (Hash)
                  Node 10998 (Seq Scan) - LEAF
          Node 10999 (Index Scan) - LEAF
        Node 11000 (Hash)
          Node 11001 (Hash Join)
            Node 11002 (Seq Scan) - LEAF
            Node 11003 (Hash)
              Node 11004 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 10987 | Aggregate | 1170.38 | 1209.26 | 3.3% | operator |
| 10988 | Gather Merge | 1169.35 | 1142.98 | 2.3% | operator |
| 10989 | Sort | 1163.77 | 1109.13 | 4.7% | operator |
| 10990 | Hash Join | 1163.17 | 842.59 | 27.6% | operator |
| 10991 | Nested Loop | 1154.45 | 1216.16 | 5.3% | operator |
| 11000 | Hash | 5.00 | 17.53 | 250.9% | operator |
| 10992 | Hash Join | 209.85 | 384.47 | 83.2% | operator |
| 10999 | Index Scan | 0.03 | 0.96 | 2908.9% | operator |
| 11001 | Hash Join | 4.94 | 85.17 | 1624.5% | operator |
| 10993 | Seq Scan | 148.84 | 201.16 | 35.2% | operator |
| 10994 | Hash | 34.64 | 19.59 | 43.4% | operator |
| 11002 | Seq Scan | 4.57 | 11.47 | 150.8% | operator |
| 11003 | Hash | 0.02 | 16.89 | 70292.0% | operator |
| 10995 | Hash Join | 34.09 | 92.20 | 170.4% | operator |
| 11004 | Seq Scan | 0.02 | 45.79 | 217958.6% | operator |
| 10996 | Seq Scan | 32.97 | 21.86 | 33.7% | operator |
| 10997 | Hash | 0.01 | 16.89 | 211076.0% | operator |
| 10998 | Seq Scan | 0.01 | 45.79 | 763105.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10998 (Seq Scan) - LEAF
...
### Step 2: Node 10996 (Seq Scan) - LEAF
...
### Step 5: Node 11004 (Seq Scan) - LEAF
...
### Step 6: Node 10993 (Seq Scan) - LEAF
...
### Step 8: Node 11002 (Seq Scan) - LEAF
...
### Step 11: Node 10999 (Index Scan) - LEAF
...
### Step 13: Node 10991 (Nested Loop)
...
### Step 17: Node 10988 (Gather Merge)
...
### Step 18: Node 10987 (Aggregate) - ROOT
