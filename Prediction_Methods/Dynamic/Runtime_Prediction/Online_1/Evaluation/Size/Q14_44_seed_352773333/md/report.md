...
```
Node 27036 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 27037 (Gather) [consumed]
    Node 27038 (Aggregate) [consumed]
      Node 27039 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 27036 | 27037, 27038, 27039 |
...
|------|------|--------|-----------|-----|--------|
| 27036 | Aggregate | 828.18 | 857.12 | 3.5% | pattern |
...
### Step 4: Node 27036 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 27037, 27038, 27039
- **Input Features:**
