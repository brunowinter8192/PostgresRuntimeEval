...
**Test Query:** Q14_44_seed_352773333
...
```
Node 27036 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27037 (Gather) [consumed]
    Node 27038 (Aggregate) [consumed]
      Node 27039 (Hash Join)
        Node 27040 (Seq Scan) - LEAF
        Node 27041 (Hash)
          Node 27042 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27036 | 27037, 27038 |
...
|------|------|--------|-----------|-----|--------|
| 27036 | Aggregate | 828.18 | 848.35 | 2.4% | pattern |
| 27039 | Hash Join | 807.19 | 807.62 | 0.1% | operator |
| 27040 | Seq Scan | 755.98 | 758.47 | 0.3% | operator |
| 27041 | Hash | 42.90 | 9.38 | 78.1% | operator |
| 27042 | Seq Scan | 36.41 | 12.70 | 65.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27042 (Seq Scan) - LEAF
...
### Step 2: Node 27040 (Seq Scan) - LEAF
...
### Step 5: Node 27036 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27037, 27038
- **Input Features:**
