...
```
Node 24796 (Aggregate) - ROOT
  Node 24797 (Gather Merge)
...
|------|------|--------|-----------|-----|--------|
| 24796 | Aggregate | 998.45 | 919.06 | 8.0% | operator |
| 24797 | Gather Merge | 998.39 | 1111.84 | 11.4% | operator |
| 24798 | Aggregate | 979.10 | 895.31 | 8.6% | operator |
| 24799 | Sort | 978.38 | 1092.81 | 11.7% | operator |
| 24800 | Nested Loop | 977.41 | 1127.41 | 15.3% | operator |
| 24801 | Seq Scan | 838.86 | 745.19 | 11.2% | operator |
| 24802 | Index Scan | 0.03 | 0.07 | 176.5% | operator |
...
### Step 6: Node 24797 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=868.9560
  - st2=0.0000
  - startup_cost=148533.8400
  - total_cost=148653.6300
- **Output:** st=1109.22, rt=1111.84

### Step 7: Node 24796 (Aggregate) - ROOT
