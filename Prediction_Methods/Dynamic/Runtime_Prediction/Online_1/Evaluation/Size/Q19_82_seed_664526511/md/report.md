...
**Test Query:** Q19_82_seed_664526511
...
```
Node 32130 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 32131 (Gather) [consumed]
    Node 32132 (Aggregate) [consumed]
      Node 32133 (Hash Join) [consumed]
        Node 32134 (Seq Scan) - LEAF
        Node 32135 (Hash)
          Node 32136 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 32130 | 32131, 32132, 32133 |
...
|------|------|--------|-----------|-----|--------|
| 32130 | Aggregate | 822.50 | 829.31 | 0.8% | pattern |
| 32134 | Seq Scan | 754.16 | 743.46 | 1.4% | operator |
| 32135 | Hash | 46.25 | 8.29 | 82.1% | operator |
| 32136 | Seq Scan | 46.07 | 23.76 | 48.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 32136 (Seq Scan) - LEAF
...
### Step 2: Node 32134 (Seq Scan) - LEAF
...
### Step 4: Node 32130 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 32131, 32132, 32133
- **Input Features:**
  ...
  - HashJoin_Outer_total_cost=156338.5900
