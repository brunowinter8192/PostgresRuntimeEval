...
```
Node 32130 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 32131 (Gather) [consumed]
    Node 32132 (Aggregate) [consumed]
      Node 32133 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 32130 | 32131, 32132 |
...
|------|------|--------|-----------|-----|--------|
| 32130 | Aggregate | 822.50 | 831.20 | 1.1% | pattern |
| 32133 | Hash Join | 802.49 | 766.06 | 4.5% | operator |
...
### Step 5: Node 32130 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 32131, 32132
- **Input Features:**
