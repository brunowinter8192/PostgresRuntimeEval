...
**Test Query:** Q19_44_seed_352773333
...
```
Node 31836 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31837 (Gather) [consumed]
    Node 31838 (Aggregate) [consumed]
      Node 31839 (Hash Join) [consumed]
        Node 31840 (Seq Scan) - LEAF
        Node 31841 (Hash)
          Node 31842 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31836 | 31837, 31838, 31839 |
...
|------|------|--------|-----------|-----|--------|
| 31836 | Aggregate | 821.36 | 829.28 | 1.0% | pattern |
| 31840 | Seq Scan | 755.75 | 743.46 | 1.6% | operator |
| 31841 | Hash | 44.03 | 8.29 | 81.2% | operator |
| 31842 | Seq Scan | 43.86 | 23.76 | 45.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31842 (Seq Scan) - LEAF
...
### Step 2: Node 31840 (Seq Scan) - LEAF
...
### Step 4: Node 31836 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31837, 31838, 31839
- **Input Features:**
