...
```
Node 31430 (Aggregate) [PATTERN: efde8b38] - ROOT
  Node 31431 (Gather) [consumed]
    Node 31432 (Aggregate) [consumed]
      Node 31433 (Hash Join) [consumed]
        Node 31434 (Seq Scan) - LEAF
        Node 31435 (Hash)
          Node 31436 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | efde8b38 | 31430 | 31431, 31432, 31433 |
...
|------|------|--------|-----------|-----|--------|
| 31430 | Aggregate | 843.80 | 829.33 | 1.7% | pattern |
| 31434 | Seq Scan | 772.06 | 743.46 | 3.7% | operator |
| 31435 | Hash | 48.11 | 8.29 | 82.8% | operator |
| 31436 | Seq Scan | 47.98 | 23.76 | 50.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31436 (Seq Scan) - LEAF
...
### Step 2: Node 31434 (Seq Scan) - LEAF
...
### Step 4: Node 31430 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** efde8b38 (Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31431, 31432, 31433
- **Input Features:**
