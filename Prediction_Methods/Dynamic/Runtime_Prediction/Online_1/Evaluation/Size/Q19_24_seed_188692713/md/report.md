...
```
Node 31682 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31683 (Gather) [consumed]
    Node 31684 (Aggregate) [consumed]
      Node 31685 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31682 | 31683, 31684 |
...
|------|------|--------|-----------|-----|--------|
| 31682 | Aggregate | 851.36 | 831.20 | 2.4% | pattern |
| 31685 | Hash Join | 831.48 | 766.05 | 7.9% | operator |
...
### Step 5: Node 31682 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31683, 31684
- **Input Features:**
