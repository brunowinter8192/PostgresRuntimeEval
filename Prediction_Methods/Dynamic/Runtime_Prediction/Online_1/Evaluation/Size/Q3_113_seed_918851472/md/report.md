...
**Test Query:** Q3_113_seed_918851472
...
```
Node 4491 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 4492 (Sort) [consumed]
    Node 4493 (Aggregate) [consumed]
      Node 4494 (Gather) [consumed]
        Node 4495 (Nested Loop)
          Node 4496 (Hash Join) [PATTERN: 895c6e8c]
            Node 4497 (Seq Scan) [consumed] - LEAF
            Node 4498 (Hash) [consumed]
              Node 4499 (Seq Scan) - LEAF
          Node 4500 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4491 | 4492, 4493, 4494, 4496, 4497, 4498 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4496 | 4491, 4492, 4493, 4494, 4497, 4498 |
...
|------|------|--------|-----------|-----|--------|
| 4491 | Limit | 1174.41 | 1151.18 | 2.0% | pattern |
| 4495 | Nested Loop | 1136.17 | 1192.90 | 5.0% | operator |
| 4496 | Hash Join | 207.83 | 242.45 | 16.7% | pattern |
| 4500 | Index Scan | 0.03 | -0.52 | 2092.6% | operator |
| 4499 | Seq Scan | 28.04 | 38.57 | 37.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4499 (Seq Scan) - LEAF
...
### Step 2: Node 4496 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4491, 4492, 4493, 4494, 4497, 4498
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46685
  - HashJoin_nt1=233820
...
### Step 3: Node 4500 (Index Scan) - LEAF
...
### Step 5: Node 4491 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4492, 4493, 4494, 4496, 4497, 4498
- **Input Features:**
