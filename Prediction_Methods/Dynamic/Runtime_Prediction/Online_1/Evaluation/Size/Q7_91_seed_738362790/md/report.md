...
```
Node 13021 (Aggregate) - ROOT
  Node 13022 (Gather Merge)
    Node 13023 (Sort)
      Node 13024 (Hash Join)
        Node 13025 (Nested Loop)
          Node 13026 (Hash Join)
            Node 13027 (Seq Scan) - LEAF
            Node 13028 (Hash)
              Node 13029 (Hash Join)
                Node 13030 (Seq Scan) - LEAF
                Node 13031 (Hash)
                  Node 13032 (Seq Scan) - LEAF
          Node 13033 (Index Scan) - LEAF
        Node 13034 (Hash)
          Node 13035 (Hash Join)
            Node 13036 (Seq Scan) - LEAF
            Node 13037 (Hash)
              Node 13038 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 13021 | Aggregate | 1226.24 | 1209.26 | 1.4% | operator |
| 13022 | Gather Merge | 1225.01 | 1142.98 | 6.7% | operator |
| 13023 | Sort | 1219.04 | 1109.13 | 9.0% | operator |
| 13024 | Hash Join | 1218.37 | 842.59 | 30.8% | operator |
| 13025 | Nested Loop | 1211.60 | 1216.16 | 0.4% | operator |
| 13034 | Hash | 2.85 | 17.53 | 516.2% | operator |
| 13026 | Hash Join | 219.82 | 384.47 | 74.9% | operator |
| 13033 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 13035 | Hash Join | 2.80 | 85.17 | 2943.0% | operator |
| 13027 | Seq Scan | 155.16 | 201.16 | 29.7% | operator |
| 13028 | Hash | 38.09 | 19.59 | 48.6% | operator |
| 13036 | Seq Scan | 2.47 | 11.47 | 364.4% | operator |
| 13037 | Hash | 0.01 | 16.89 | 129854.5% | operator |
| 13029 | Hash Join | 37.77 | 92.20 | 144.1% | operator |
| 13038 | Seq Scan | 0.01 | 45.79 | 416193.8% | operator |
| 13030 | Seq Scan | 36.66 | 21.86 | 40.4% | operator |
| 13031 | Hash | 0.01 | 16.89 | 168840.8% | operator |
| 13032 | Seq Scan | 0.01 | 45.79 | 654075.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 13032 (Seq Scan) - LEAF
...
### Step 2: Node 13030 (Seq Scan) - LEAF
...
### Step 5: Node 13038 (Seq Scan) - LEAF
...
### Step 6: Node 13027 (Seq Scan) - LEAF
...
### Step 8: Node 13036 (Seq Scan) - LEAF
...
### Step 11: Node 13033 (Index Scan) - LEAF
...
### Step 13: Node 13025 (Nested Loop)
...
### Step 17: Node 13022 (Gather Merge)
...
### Step 18: Node 13021 (Aggregate) - ROOT
