...
**Test Query:** Q7_91_seed_738362790
...
```
Node 13021 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 13022 (Gather Merge) [consumed]
    Node 13023 (Sort)
      Node 13024 (Hash Join)
        Node 13025 (Nested Loop)
          Node 13026 (Hash Join) [PATTERN: 895c6e8c]
            Node 13027 (Seq Scan) [consumed] - LEAF
            Node 13028 (Hash) [consumed]
              Node 13029 (Hash Join) [PATTERN: f4cb205a]
                Node 13030 (Seq Scan) [consumed] - LEAF
                Node 13031 (Hash) [consumed]
                  Node 13032 (Seq Scan) [consumed] - LEAF
          Node 13033 (Index Scan) - LEAF
        Node 13034 (Hash)
          Node 13035 (Hash Join) [PATTERN: f4cb205a]
            Node 13036 (Seq Scan) [consumed] - LEAF
            Node 13037 (Hash) [consumed]
              Node 13038 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 13029 | 13021, 13022, 13026, 13027, 13028, 13030, 13031, 13032, 13035, 13036, 13037, 13038 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 13035 | 13021, 13022, 13026, 13027, 13028, 13029, 13030, 13031, 13032, 13036, 13037, 13038 |
| Aggregate -> Gather Merge (Out | 2724c080 | 13021 | 13022, 13026, 13027, 13028, 13029, 13030, 13031, 13032, 13035, 13036, 13037, 13038 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 13026 | 13021, 13022, 13027, 13028, 13029, 13030, 13031, 13032, 13035, 13036, 13037, 13038 |
...
|------|------|--------|-----------|-----|--------|
| 13021 | Aggregate | 1226.24 | 1163.13 | 5.1% | pattern |
| 13023 | Sort | 1219.04 | 1109.16 | 9.0% | operator |
| 13024 | Hash Join | 1218.37 | 843.11 | 30.8% | operator |
| 13025 | Nested Loop | 1211.60 | 1215.99 | 0.4% | operator |
| 13034 | Hash | 2.85 | 27.74 | 875.2% | operator |
| 13026 | Hash Join | 219.82 | 304.89 | 38.7% | pattern |
| 13033 | Index Scan | 0.03 | 0.96 | 2817.7% | operator |
| 13035 | Hash Join | 2.80 | 429.36 | 15239.9% | pattern |
| 13029 | Hash Join | 37.77 | 429.38 | 1036.9% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 13029 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 13021, 13022, 13026, 13027, 13028, 13030, 13031, 13032, 13035, 13036, 13037, 13038
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5000
  - HashJoin_nt1=62500
...
### Step 2: Node 13026 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 13021, 13022, 13027, 13028, 13029, 13030, 13031, 13032, 13035, 13036, 13037, 13038
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=38710
  - HashJoin_nt1=483871
...
### Step 3: Node 13033 (Index Scan) - LEAF
...
### Step 4: Node 13035 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 13021, 13022, 13026, 13027, 13028, 13029, 13030, 13031, 13032, 13036, 13037, 13038
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=800
  - HashJoin_nt1=10000
...
### Step 9: Node 13021 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 13022, 13026, 13027, 13028, 13029, 13030, 13031, 13032, 13035, 13036, 13037, 13038
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
