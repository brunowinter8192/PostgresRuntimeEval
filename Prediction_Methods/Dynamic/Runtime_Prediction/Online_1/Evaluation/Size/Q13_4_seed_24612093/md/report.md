...
**Test Query:** Q13_4_seed_24612093
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26028 | 26029, 26031, 26032, 26033 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26031 | 26028, 26029, 26032, 26033 |
...
|------|------|--------|-----------|-----|--------|
| 26028 | Sort | 911.44 | 1079.93 | 18.5% | pattern |
| 26030 | Aggregate | 905.50 | 999.15 | 10.3% | operator |
| 26031 | Hash Join | 701.64 | 470.31 | 33.0% | pattern |
| 26034 | Index Only Scan | 9.79 | 0.00 | 100.0% | operator |
...
- **Consumes:** Nodes 26028, 26029, 26032, 26033
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1478958
...
### Step 4: Node 26028 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26029, 26031, 26032, 26033
- **Input Features:**
