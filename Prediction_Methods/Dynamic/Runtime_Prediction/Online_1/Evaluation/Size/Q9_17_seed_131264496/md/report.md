...
```
Node 17701 (Sort) - ROOT
  Node 17702 (Aggregate)
    Node 17703 (Gather)
      Node 17704 (Aggregate)
        Node 17705 (Nested Loop)
          Node 17706 (Hash Join)
            Node 17707 (Seq Scan) - LEAF
            Node 17708 (Hash)
              Node 17709 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 17701 | Sort | 1195.33 | 1119.81 | 6.3% | operator |
| 17702 | Aggregate | 1195.21 | 897.74 | 24.9% | operator |
...
| 17706 | Hash Join | 974.11 | 633.50 | 35.0% | operator |
| 17718 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17707 | Seq Scan | 697.25 | 509.93 | 26.9% | operator |
| 17708 | Hash | 182.65 | 48.03 | 73.7% | operator |
| 17709 | Hash Join | 180.76 | 924.48 | 411.4% | operator |
...
### Step 10: Node 17707 (Seq Scan) - LEAF
...
### Step 13: Node 17718 (Index Scan) - LEAF
...
### Step 14: Node 17705 (Nested Loop)
