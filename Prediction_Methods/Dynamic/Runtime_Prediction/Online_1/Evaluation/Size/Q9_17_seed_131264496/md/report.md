...
**Test Query:** Q9_17_seed_131264496
...
```
Node 17701 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 17702 (Aggregate) [consumed]
    Node 17703 (Gather)
      Node 17704 (Aggregate)
        Node 17705 (Nested Loop)
          Node 17706 (Hash Join) [PATTERN: bb930825]
            Node 17707 (Seq Scan) [consumed] - LEAF
            Node 17708 (Hash) [consumed]
              Node 17709 (Hash Join) [consumed]
                Node 17710 (Hash Join)
                  Node 17711 (Nested Loop)
                    Node 17712 (Seq Scan) - LEAF
                    Node 17713 (Index Scan) - LEAF
                  Node 17714 (Hash)
                    Node 17715 (Seq Scan) - LEAF
                Node 17716 (Hash)
                  Node 17717 (Seq Scan) - LEAF
          Node 17718 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 17706 | 17701, 17702, 17707, 17708, 17709 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17701 | 17702, 17706, 17707, 17708, 17709 |
...
|------|------|--------|-----------|-----|--------|
| 17701 | Sort | 1195.33 | 1045.59 | 12.5% | pattern |
| 17703 | Gather | 1194.13 | 964.55 | 19.2% | operator |
| 17704 | Aggregate | 1176.08 | 1085.45 | 7.7% | operator |
| 17705 | Nested Loop | 1150.96 | 1252.17 | 8.8% | operator |
| 17706 | Hash Join | 974.11 | 134.80 | 86.2% | pattern |
| 17718 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 17710 | Hash Join | 167.12 | 837.63 | 401.2% | operator |
| 17716 | Hash | 12.93 | 14.95 | 15.6% | operator |
| 17711 | Nested Loop | 160.83 | 1251.77 | 678.3% | operator |
| 17714 | Hash | 4.06 | 15.94 | 292.8% | operator |
| 17717 | Seq Scan | 12.92 | 2.94 | 77.3% | operator |
| 17712 | Seq Scan | 20.70 | 43.96 | 112.4% | operator |
| 17713 | Index Scan | 0.08 | -1.39 | 1903.2% | operator |
| 17715 | Seq Scan | 3.52 | 9.45 | 168.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 17712 (Seq Scan) - LEAF
...
### Step 2: Node 17713 (Index Scan) - LEAF
...
### Step 3: Node 17715 (Seq Scan) - LEAF
...
### Step 6: Node 17717 (Seq Scan) - LEAF
...
### Step 9: Node 17706 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 17701, 17702, 17707, 17708, 17709
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17718 (Index Scan) - LEAF
...
### Step 11: Node 17705 (Nested Loop)
...
### Step 14: Node 17701 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17702, 17706, 17707, 17708, 17709
- **Input Features:**
