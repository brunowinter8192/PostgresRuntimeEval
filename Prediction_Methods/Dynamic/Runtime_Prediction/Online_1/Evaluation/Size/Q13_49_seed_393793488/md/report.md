...
**Test Query:** Q13_49_seed_393793488
...
```
Node 26021 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26022 (Aggregate) [consumed]
    Node 26023 (Aggregate)
      Node 26024 (Hash Join) [PATTERN: 895c6e8c]
        Node 26025 (Seq Scan) [consumed] - LEAF
        Node 26026 (Hash) [consumed]
          Node 26027 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26021 | 26022, 26024, 26025, 26026 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26024 | 26021, 26022, 26025, 26026 |
...
|------|------|--------|-----------|-----|--------|
| 26021 | Sort | 922.94 | 1079.93 | 17.0% | pattern |
| 26023 | Aggregate | 917.08 | 999.15 | 8.9% | operator |
| 26024 | Hash Join | 708.81 | 470.31 | 33.6% | pattern |
| 26027 | Index Only Scan | 9.22 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26027 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26024 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26021, 26022, 26025, 26026
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1478958
...
### Step 4: Node 26021 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26022, 26024, 26025, 26026
- **Input Features:**
