...
**Test Query:** Q12_65_seed_525057984
...
```
Node 25097 (Aggregate) - ROOT
  Node 25098 (Gather Merge)
    Node 25099 (Aggregate)
      Node 25100 (Sort)
        Node 25101 (Nested Loop)
          Node 25102 (Seq Scan) - LEAF
          Node 25103 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 25097 | Aggregate | 1006.58 | 919.06 | 8.7% | operator |
| 25098 | Gather Merge | 1006.56 | 1111.84 | 10.5% | operator |
| 25099 | Aggregate | 987.00 | 895.31 | 9.3% | operator |
| 25100 | Sort | 986.40 | 1092.81 | 10.8% | operator |
| 25101 | Nested Loop | 985.42 | 1127.41 | 14.4% | operator |
| 25102 | Seq Scan | 845.71 | 745.19 | 11.9% | operator |
| 25103 | Index Scan | 0.03 | 0.07 | 166.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25102 (Seq Scan) - LEAF
...
### Step 2: Node 25103 (Index Scan) - LEAF
...
### Step 6: Node 25098 (Gather Merge)
...
### Step 7: Node 25097 (Aggregate) - ROOT
