...
```
Node 18625 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18626 (Aggregate) [consumed]
    Node 18627 (Gather)
      Node 18628 (Aggregate)
        Node 18629 (Nested Loop)
          Node 18630 (Hash Join) [PATTERN: bb930825]
            Node 18631 (Seq Scan) [consumed] - LEAF
            Node 18632 (Hash) [consumed]
              Node 18633 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | bb930825 | 18630 | 18625, 18626, 18631, 18632, 18633 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18625 | 18626, 18630, 18631, 18632, 18633 |
...
|------|------|--------|-----------|-----|--------|
| 18625 | Sort | 1205.55 | 1045.32 | 13.3% | pattern |
...
| 18630 | Hash Join | 987.35 | 134.80 | 86.3% | pattern |
...
### Step 9: Node 18630 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bb930825 (Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)])
- **Consumes:** Nodes 18625, 18626, 18631, 18632, 18633
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18642 (Index Scan) - LEAF
...
### Step 11: Node 18629 (Nested Loop)
...
### Step 14: Node 18625 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18626, 18630, 18631, 18632, 18633
- **Input Features:**
