...
**Test Query:** Q9_63_seed_508649922
...
```
Node 18625 (Sort) - ROOT
  Node 18626 (Aggregate)
    Node 18627 (Gather)
      Node 18628 (Aggregate)
        Node 18629 (Nested Loop)
          Node 18630 (Hash Join)
            Node 18631 (Seq Scan) - LEAF
            Node 18632 (Hash)
              Node 18633 (Hash Join)
                Node 18634 (Hash Join)
                  Node 18635 (Nested Loop)
                    Node 18636 (Seq Scan) - LEAF
                    Node 18637 (Index Scan) - LEAF
                  Node 18638 (Hash)
                    Node 18639 (Seq Scan) - LEAF
                Node 18640 (Hash)
                  Node 18641 (Seq Scan) - LEAF
          Node 18642 (Index Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 18625 | Sort | 1205.55 | 1119.51 | 7.1% | operator |
| 18626 | Aggregate | 1205.41 | 897.44 | 25.5% | operator |
| 18627 | Gather | 1204.42 | 964.64 | 19.9% | operator |
| 18628 | Aggregate | 1186.11 | 1095.61 | 7.6% | operator |
| 18629 | Nested Loop | 1161.95 | 1252.17 | 7.8% | operator |
| 18630 | Hash Join | 987.35 | 633.32 | 35.9% | operator |
| 18642 | Index Scan | 0.00 | -5.54 | 184812.7% | operator |
| 18631 | Seq Scan | 712.55 | 509.93 | 28.4% | operator |
| 18632 | Hash | 179.60 | 47.91 | 73.3% | operator |
| 18633 | Hash Join | 177.66 | 924.43 | 420.3% | operator |
| 18634 | Hash Join | 163.54 | 837.61 | 412.2% | operator |
| 18640 | Hash | 13.36 | 14.95 | 11.9% | operator |
| 18635 | Nested Loop | 155.81 | 1251.77 | 703.4% | operator |
| 18638 | Hash | 5.23 | 15.94 | 205.0% | operator |
| 18641 | Seq Scan | 13.35 | 2.94 | 78.0% | operator |
| 18636 | Seq Scan | 20.47 | 44.03 | 115.1% | operator |
| 18637 | Index Scan | 0.07 | -1.39 | 1976.3% | operator |
| 18639 | Seq Scan | 4.55 | 9.45 | 107.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 18636 (Seq Scan) - LEAF
...
### Step 2: Node 18637 (Index Scan) - LEAF
...
### Step 3: Node 18639 (Seq Scan) - LEAF
...
### Step 6: Node 18641 (Seq Scan) - LEAF
...
### Step 10: Node 18631 (Seq Scan) - LEAF
...
### Step 13: Node 18642 (Index Scan) - LEAF
...
### Step 14: Node 18629 (Nested Loop)
