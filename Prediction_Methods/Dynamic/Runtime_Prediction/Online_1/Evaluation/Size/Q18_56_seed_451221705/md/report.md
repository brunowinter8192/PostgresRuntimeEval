...
**Test Query:** Q18_56_seed_451221705
...
```
Node 30436 (Limit) - ROOT
  Node 30437 (Sort)
    Node 30438 (Aggregate)
      Node 30439 (Gather Merge)
        Node 30440 (Incremental Sort)
          Node 30441 (Nested Loop)
            Node 30442 (Merge Join)
              Node 30443 (Sort)
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30444 | 30445, 30446 |
...
|------|------|--------|-----------|-----|--------|
| 30436 | Limit | 3036.20 | 1175.21 | 61.3% | operator |
| 30437 | Sort | 2920.97 | 1127.81 | 61.4% | operator |
| 30438 | Aggregate | 2920.93 | 1073.15 | 63.3% | operator |
| 30439 | Gather Merge | 2920.91 | 1073.95 | 63.2% | operator |
| 30440 | Incremental Sort | 2886.87 | 0.00 | 100.0% | operator |
| 30441 | Nested Loop | 2886.83 | 1111.34 | 61.5% | operator |
| 30442 | Merge Join | 2886.77 | 0.00 | 100.0% | operator |
| 30451 | Index Scan | 0.02 | 0.05 | 114.9% | operator |
| 30443 | Sort | 2837.20 | 1095.58 | 61.4% | operator |
| 30449 | Sort | 63.67 | 1074.66 | 1587.9% | operator |
| 30444 | Hash Join | 2837.19 | 471.07 | 83.4% | pattern |
| 30450 | Seq Scan | 52.40 | 18.25 | 65.2% | operator |
| 30447 | Aggregate | 2614.50 | 1073.15 | 59.0% | operator |
| 30448 | Index Scan | 2135.19 | 0.00 | 100.0% | operator |
...
### Step 4: Node 30450 (Seq Scan) - LEAF
...
### Step 7: Node 30442 (Merge Join)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 8: Node 30451 (Index Scan) - LEAF
...
### Step 10: Node 30440 (Incremental Sort)

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 11: Node 30439 (Gather Merge)
