...
**Test Query:** Q6_26_seed_205100775
...
```
Node 10173 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10174 (Gather) [consumed]
    Node 10175 (Aggregate) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10173 | 10174, 10175 |
...
|------|------|--------|-----------|-----|--------|
| 10173 | Aggregate | 785.81 | 849.99 | 8.2% | pattern |
| 10176 | Seq Scan | 764.69 | 748.50 | 2.1% | operator |
...
### Step 2: Node 10173 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10174, 10175
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=22778
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=32
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=139719.3600
  - Aggregate_Outer_total_cost=139719.3700
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=140719.9000
  - Aggregate_total_cost=140719.9100
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=140719.3600
  - Gather_Outer_total_cost=140719.8700
