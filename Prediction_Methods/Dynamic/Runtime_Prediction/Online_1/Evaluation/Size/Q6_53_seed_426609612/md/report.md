...
**Test Query:** Q6_53_seed_426609612
...
```
Node 10293 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10294 (Gather) [consumed]
    Node 10295 (Aggregate) [consumed]
      Node 10296 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10293 | 10294, 10295 |
...
|------|------|--------|-----------|-----|--------|
| 10293 | Aggregate | 803.68 | 849.99 | 5.8% | pattern |
| 10296 | Seq Scan | 782.31 | 748.50 | 4.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10296 (Seq Scan) - LEAF
...
### Step 2: Node 10293 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10294, 10295
- **Input Features:**
