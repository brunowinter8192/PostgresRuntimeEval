...
**Test Query:** Q13_63_seed_508649922
...
```
Node 26133 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 26134 (Aggregate) [consumed]
    Node 26135 (Aggregate)
      Node 26136 (Hash Join) [PATTERN: 895c6e8c]
        Node 26137 (Seq Scan) [consumed] - LEAF
        Node 26138 (Hash) [consumed]
          Node 26139 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 26133 | 26134, 26136, 26137, 26138 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 26136 | 26133, 26134, 26137, 26138 |
...
|------|------|--------|-----------|-----|--------|
| 26133 | Sort | 893.17 | 1079.94 | 20.9% | pattern |
| 26135 | Aggregate | 887.06 | 999.76 | 12.7% | operator |
| 26136 | Hash Join | 676.20 | 470.31 | 30.4% | pattern |
| 26139 | Index Only Scan | 10.44 | 0.00 | 100.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26139 (Index Only Scan) - LEAF

- **Source:** operator
- **Output:** st=0.00, rt=0.00

### Step 2: Node 26136 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 26133, 26134, 26137, 26138
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1487976
...
### Step 4: Node 26133 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 26134, 26136, 26137, 26138
- **Input Features:**
