...
**Test Query:** Q5_53_seed_426609612
...
```
Node 8861 (Sort) [PATTERN: ddb1e0ca] - ROOT
  Node 8862 (Aggregate) [consumed]
    Node 8863 (Gather Merge) [consumed]
      Node 8864 (Aggregate)
        Node 8865 (Sort) [PATTERN: 3e2d5a00]
          Node 8866 (Hash Join) [consumed]
            Node 8867 (Nested Loop)
              Node 8868 (Hash Join)
                Node 8869 (Seq Scan) - LEAF
                Node 8870 (Hash) [PATTERN: 444761fb]
                  Node 8871 (Hash Join) [consumed]
                    Node 8872 (Seq Scan) [consumed] - LEAF
                    Node 8873 (Hash) [consumed]
                      Node 8874 (Hash Join) [consumed]
                        Node 8875 (Seq Scan) - LEAF
                        Node 8876 (Hash)
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 8870 | 8861, 8862, 8863, 8865, 8866, 8871, 8872, 8873, 8874 |
| Sort -> Aggregate -> Gather Me | ddb1e0ca | 8861 | 8862, 8863, 8865, 8866, 8870, 8871, 8872, 8873, 8874 |
| Sort -> Hash Join (Outer) | 3e2d5a00 | 8865 | 8861, 8862, 8863, 8866, 8870, 8871, 8872, 8873, 8874 |
...
|------|------|--------|-----------|-----|--------|
| 8861 | Sort | 1073.36 | 2934.42 | 173.4% | pattern |
| 8864 | Aggregate | 1068.63 | 1128.79 | 5.6% | operator |
| 8865 | Sort | 1068.38 | 1835.90 | 71.8% | pattern |
| 8867 | Nested Loop | 1055.20 | 1188.37 | 12.6% | operator |
| 8879 | Hash | 4.51 | 18.67 | 314.1% | operator |
| 8868 | Hash Join | 215.45 | 253.07 | 17.5% | operator |
| 8878 | Index Scan | 0.07 | -0.22 | 401.4% | operator |
| 8880 | Seq Scan | 3.95 | 12.36 | 213.0% | operator |
| 8869 | Seq Scan | 165.49 | 159.81 | 3.4% | operator |
| 8870 | Hash | 36.88 | 46.85 | 27.0% | pattern |
| 8875 | Seq Scan | 0.01 | 11.81 | 131103.0% | operator |
| 8876 | Hash | 0.05 | 21.05 | 38887.5% | operator |
| 8877 | Seq Scan | 0.05 | 22.93 | 45766.7% | operator |
...
### Step 2: Node 8875 (Seq Scan) - LEAF
...
### Step 4: Node 8869 (Seq Scan) - LEAF
...
### Step 5: Node 8870 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 8861, 8862, 8863, 8865, 8866, 8871, 8872, 8873, 8874
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 8878 (Index Scan) - LEAF
...
### Step 8: Node 8880 (Seq Scan) - LEAF
...
### Step 11: Node 8865 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3e2d5a00 (Sort -> Hash Join (Outer))
- **Consumes:** Nodes 8861, 8862, 8863, 8866, 8870, 8871, 8872, 8873, 8874
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 13: Node 8861 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** ddb1e0ca (Sort -> Aggregate -> Gather Merge (Outer) (Outer))
- **Consumes:** Nodes 8862, 8863, 8865, 8866, 8870, 8871, 8872, 8873, 8874
- **Input Features:**
