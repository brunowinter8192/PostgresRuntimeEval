...
**Input:** `./Prediction_Methods/Operator_Level/Datasets/Baseline/04_training.csv`

**Working Directory:** `Hybrid_4/Datasets/`

#### Step 1: Extract Patterns
```bash
cd ./Prediction_Methods/Hybrid_4/Datasets
python3 01_Extract_Patterns.py \
  ./Prediction_Methods/Operator_Level/Datasets/Baseline/04_training.csv \
  Baseline_SVM \
...
```bash
cd ./Prediction_Methods/Hybrid_4/Runtime_Prediction
...
python3 03_Predict_Queries.py \
  ./Prediction_Methods/Operator_Level/Datasets/Baseline/04_test.csv \
  Baseline_SVM/SVM/two_step_evaluation_overview.csv \
...
```bash
# Hybrid_3 Results
cat ./Prediction_Methods/Hybrid_3/Runtime_Prediction/Baseline_SVM/Evaluation/overall_mre.csv
cat ./Prediction_Methods/Hybrid_3/Runtime_Prediction/Baseline_SVM/Evaluation/template_mre.csv | grep Q18

# Hybrid_4 Results
cat ./Prediction_Methods/Hybrid_4/Runtime_Prediction/Baseline_SVM/Evaluation/overall_mre.csv
cat ./Prediction_Methods/Hybrid_4/Runtime_Prediction/Baseline_SVM/Evaluation/template_mre.csv | grep Q18
```
