...
```
Node 8461 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 8462 (Aggregate) [consumed]
    Node 8463 (Gather Merge)
      Node 8464 (Aggregate)
        Node 8465 (Sort)
          Node 8466 (Hash Join) [PATTERN: 2e0f44ef]
            Node 8467 (Nested Loop) [consumed]
              Node 8468 (Hash Join) [PATTERN: 895c6e8c]
                Node 8469 (Seq Scan) [consumed] - LEAF
                Node 8470 (Hash) [consumed]
                  Node 8471 (Hash Join) [PATTERN: 895c6e8c]
                    Node 8472 (Seq Scan) [consumed] - LEAF
                    Node 8473 (Hash) [consumed]
                      Node 8474 (Hash Join) [PATTERN: f4cb205a]
                        Node 8475 (Seq Scan) [consumed] - LEAF
                        Node 8476 (Hash) [consumed]
                          Node 8477 (Seq Scan) [consumed] - LEAF
              Node 8478 (Index Scan) - LEAF
            Node 8479 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 8474 | 8461, 8462, 8466, 8467, 8468, 8469, 8470, 8471, 8472, 8473, 8475, 8476, 8477, 8479 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 8468 | 8461, 8462, 8466, 8467, 8469, 8470, 8471, 8472, 8473, 8474, 8475, 8476, 8477, 8479 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 8471 | 8461, 8462, 8466, 8467, 8468, 8469, 8470, 8472, 8473, 8474, 8475, 8476, 8477, 8479 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 8461 | 8462, 8466, 8467, 8468, 8469, 8470, 8471, 8472, 8473, 8474, 8475, 8476, 8477, 8479 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 8466 | 8461, 8462, 8467, 8468, 8469, 8470, 8471, 8472, 8473, 8474, 8475, 8476, 8477, 8479 |
...
|------|------|--------|-----------|-----|--------|
| 8461 | Sort | 1075.76 | 1080.15 | 0.4% | pattern |
| 8463 | Gather Merge | 1075.73 | 1124.35 | 4.5% | operator |
| 8464 | Aggregate | 1071.33 | 1019.65 | 4.8% | operator |
| 8465 | Sort | 1071.06 | 1073.13 | 0.2% | operator |
| 8466 | Hash Join | 1070.57 | 1080.65 | 0.9% | pattern |
| 8468 | Hash Join | 216.72 | 259.80 | 19.9% | pattern |
| 8478 | Index Scan | 0.07 | -0.03 | 134.0% | operator |
| 8480 | Seq Scan | 2.99 | 10.62 | 254.6% | operator |
| 8471 | Hash Join | 35.20 | 84.97 | 141.4% | pattern |
| 8474 | Hash Join | 0.09 | 11.62 | 13406.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 8474 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 8461, 8462, 8466, 8467, 8468, 8469, 8470, 8471, 8472, 8473, 8475, 8476, 8477, 8479
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
### Step 2: Node 8471 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 8461, 8462, 8466, 8467, 8468, 8469, 8470, 8472, 8473, 8474, 8475, 8476, 8477, 8479
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=12500
  - HashJoin_nt1=62500
...
### Step 3: Node 8468 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 8461, 8462, 8466, 8467, 8469, 8470, 8471, 8472, 8473, 8474, 8475, 8476, 8477, 8479
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14884
  - HashJoin_nt1=74418
...
### Step 4: Node 8478 (Index Scan) - LEAF
...
### Step 5: Node 8480 (Seq Scan) - LEAF
...
### Step 6: Node 8466 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 8461, 8462, 8467, 8468, 8469, 8470, 8471, 8472, 8473, 8474, 8475, 8476, 8477, 8479
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=2382
  - HashJoin_nt1=59546
...
### Step 10: Node 8461 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 8462, 8466, 8467, 8468, 8469, 8470, 8471, 8472, 8473, 8474, 8475, 8476, 8477, 8479
- **Input Features:**
