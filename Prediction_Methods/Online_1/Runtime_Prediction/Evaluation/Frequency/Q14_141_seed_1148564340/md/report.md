...
```
Node 26735 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 26735 | 26736, 26737, 26738, 26739, 26740 |
...
|------|------|--------|-----------|-----|--------|
| 26735 | Aggregate | 823.02 | 825.94 | 0.4% | pattern |
...
- **Consumes:** Nodes 26736, 26737, 26738, 26739, 26740
- **Input Features:**
