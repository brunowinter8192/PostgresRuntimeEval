...
**Test Query:** Q18_33_seed_262528992
...
```
Node 30036 (Limit) [PATTERN: 6ce7e974] - ROOT
  Node 30037 (Sort) [consumed]
    Node 30038 (Aggregate) [consumed]
      Node 30039 (Gather Merge) [consumed]
        Node 30040 (Incremental Sort) [consumed]
          Node 30041 (Nested Loop)
            Node 30042 (Merge Join)
              Node 30043 (Sort)
                Node 30044 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30045 (Seq Scan) [consumed] - LEAF
                  Node 30046 (Hash) [consumed]
                    Node 30047 (Aggregate)
                      Node 30048 (Index Scan) - LEAF
              Node 30049 (Sort)
                Node 30050 (Seq Scan) - LEAF
            Node 30051 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 6ce7e974 | 30036 | 30037, 30038, 30039, 30040, 30044, 30045, 30046 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30044 | 30036, 30037, 30038, 30039, 30040, 30045, 30046 |
...
|------|------|--------|-----------|-----|--------|
| 30036 | Limit | 3054.59 | 3050.24 | 0.1% | pattern |
| 30041 | Nested Loop | 2922.30 | 1400.02 | 52.1% | operator |
| 30042 | Merge Join | 2922.20 | 2910.61 | 0.4% | operator |
| 30051 | Index Scan | 0.04 | 0.07 | 73.6% | operator |
| 30043 | Sort | 2854.66 | 1098.13 | 61.5% | operator |
| 30049 | Sort | 65.22 | 1014.60 | 1455.6% | operator |
| 30044 | Hash Join | 2854.65 | 688.83 | 75.9% | pattern |
| 30050 | Seq Scan | 52.21 | 25.47 | 51.2% | operator |
| 30047 | Aggregate | 2643.82 | 1300.21 | 50.8% | operator |
| 30048 | Index Scan | 2146.90 | 219.99 | 89.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30048 (Index Scan) - LEAF
...
### Step 3: Node 30044 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30036, 30037, 30038, 30039, 30040, 30045, 30046
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30050 (Seq Scan) - LEAF
...
### Step 8: Node 30051 (Index Scan) - LEAF
...
### Step 10: Node 30036 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 6ce7e974 (Limit -> Sort -> Aggregate -> Gather Merge -> Incremental Sort (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 30037, 30038, 30039, 30040, 30044, 30045, 30046
- **Input Features:**
