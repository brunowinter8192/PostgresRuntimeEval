...
**Test Query:** Q18_80_seed_648118449
...
```
Node 30868 (Limit) [PATTERN: 6ce7e974] - ROOT
  Node 30869 (Sort) [consumed]
    Node 30870 (Aggregate) [consumed]
      Node 30871 (Gather Merge) [consumed]
        Node 30872 (Incremental Sort) [consumed]
          Node 30873 (Nested Loop)
            Node 30874 (Merge Join)
              Node 30875 (Sort)
                Node 30876 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30877 (Seq Scan) [consumed] - LEAF
                  Node 30878 (Hash) [consumed]
                    Node 30879 (Aggregate)
                      Node 30880 (Index Scan) - LEAF
              Node 30881 (Sort)
                Node 30882 (Seq Scan) - LEAF
            Node 30883 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 6ce7e974 | 30868 | 30869, 30870, 30871, 30872, 30876, 30877, 30878 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30876 | 30868, 30869, 30870, 30871, 30872, 30877, 30878 |
...
|------|------|--------|-----------|-----|--------|
| 30868 | Limit | 3080.80 | 3050.24 | 1.0% | pattern |
| 30873 | Nested Loop | 2928.94 | 1400.02 | 52.2% | operator |
| 30874 | Merge Join | 2928.89 | 2910.61 | 0.6% | operator |
| 30883 | Index Scan | 0.02 | 0.07 | 229.9% | operator |
| 30875 | Sort | 2875.10 | 1098.13 | 61.8% | operator |
| 30881 | Sort | 68.88 | 1014.60 | 1372.9% | operator |
| 30876 | Hash Join | 2875.09 | 688.83 | 76.0% | pattern |
| 30882 | Seq Scan | 57.48 | 25.47 | 55.7% | operator |
| 30879 | Aggregate | 2643.02 | 1300.21 | 50.8% | operator |
| 30880 | Index Scan | 2146.93 | 219.99 | 89.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30880 (Index Scan) - LEAF
...
### Step 3: Node 30876 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30868, 30869, 30870, 30871, 30872, 30877, 30878
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30882 (Seq Scan) - LEAF
...
### Step 8: Node 30883 (Index Scan) - LEAF
...
### Step 10: Node 30868 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 6ce7e974 (Limit -> Sort -> Aggregate -> Gather Merge -> Incremental Sort (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 30869, 30870, 30871, 30872, 30876, 30877, 30878
- **Input Features:**
