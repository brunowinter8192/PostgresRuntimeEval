...
**Test Query:** Q18_22_seed_172284651
...
```
Node 29844 (Limit) [PATTERN: 6ce7e974] - ROOT
  Node 29845 (Sort) [consumed]
    Node 29846 (Aggregate) [consumed]
      Node 29847 (Gather Merge) [consumed]
        Node 29848 (Incremental Sort) [consumed]
          Node 29849 (Nested Loop)
            Node 29850 (Merge Join)
              Node 29851 (Sort)
                Node 29852 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29853 (Seq Scan) [consumed] - LEAF
                  Node 29854 (Hash) [consumed]
                    Node 29855 (Aggregate)
                      Node 29856 (Index Scan) - LEAF
              Node 29857 (Sort)
                Node 29858 (Seq Scan) - LEAF
            Node 29859 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 6ce7e974 | 29844 | 29845, 29846, 29847, 29848, 29852, 29853, 29854 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29852 | 29844, 29845, 29846, 29847, 29848, 29853, 29854 |
...
|------|------|--------|-----------|-----|--------|
| 29844 | Limit | 3028.50 | 3050.24 | 0.7% | pattern |
| 29849 | Nested Loop | 2896.50 | 1400.02 | 51.7% | operator |
| 29850 | Merge Join | 2896.44 | 2910.61 | 0.5% | operator |
| 29859 | Index Scan | 0.02 | 0.07 | 186.9% | operator |
| 29851 | Sort | 2827.16 | 1098.13 | 61.2% | operator |
| 29857 | Sort | 66.16 | 1014.60 | 1433.7% | operator |
| 29852 | Hash Join | 2827.15 | 688.83 | 75.6% | pattern |
| 29858 | Seq Scan | 54.13 | 25.47 | 52.9% | operator |
| 29855 | Aggregate | 2603.63 | 1300.21 | 50.1% | operator |
| 29856 | Index Scan | 2094.57 | 219.99 | 89.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29856 (Index Scan) - LEAF
...
### Step 3: Node 29852 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29844, 29845, 29846, 29847, 29848, 29853, 29854
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29858 (Seq Scan) - LEAF
...
### Step 8: Node 29859 (Index Scan) - LEAF
...
### Step 10: Node 29844 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 6ce7e974 (Limit -> Sort -> Aggregate -> Gather Merge -> Incremental Sort (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 29845, 29846, 29847, 29848, 29852, 29853, 29854
- **Input Features:**
