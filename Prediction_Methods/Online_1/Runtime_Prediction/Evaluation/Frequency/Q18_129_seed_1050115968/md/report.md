...
**Test Query:** Q18_129_seed_1050115968
**Timestamp:** 2026-01-11 18:13:47
...
| 2 | 2724c080 | 19.6008 | 0.0346% | ACCEPTED | 17.77% |
| 3 | 3e2d5a00 | 18.5586 | N/A | REJECTED | 17.77% |
| 4 | e296a71f | 40.3755 | N/A | REJECTED | 17.77% |
| 5 | 7bcfec22 | 40.3755 | 0.0394% | ACCEPTED | 17.73% |
| 6 | ddb1e0ca | 13.6847 | -5.5461% | REJECTED | 17.73% |
| 7 | 3e579ee9 | 22.1283 | N/A | REJECTED | 17.73% |
| 8 | 44ca42df | 13.0757 | N/A | REJECTED | 17.73% |
| 9 | 8a78742e | 0.1344 | N/A | SKIPPED_LOW_ERROR | 17.73% |
| 10 | a02337a9 | 12.5548 | N/A | REJECTED | 17.73% |
| 11 | be4808de | 349.7507 | N/A | REJECTED | 17.73% |
...
```
Node 29316 (Limit) [PATTERN: 6ce7e974] - ROOT
  Node 29317 (Sort) [consumed]
    Node 29318 (Aggregate) [consumed]
      Node 29319 (Gather Merge) [consumed]
        Node 29320 (Incremental Sort) [consumed]
          Node 29321 (Nested Loop)
            Node 29322 (Merge Join)
              Node 29323 (Sort)
                Node 29324 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29325 (Seq Scan) [consumed] - LEAF
                  Node 29326 (Hash) [consumed]
                    Node 29327 (Aggregate)
                      Node 29328 (Index Scan) - LEAF
              Node 29329 (Sort)
                Node 29330 (Seq Scan) - LEAF
            Node 29331 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 6ce7e974 | 29316 | 29317, 29318, 29319, 29320, 29324, 29325, 29326 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29324 | 29316, 29317, 29318, 29319, 29320, 29325, 29326 |
...
|------|------|--------|-----------|-----|--------|
| 29316 | Limit | 3046.27 | 3050.24 | 0.1% | pattern |
| 29321 | Nested Loop | 2888.03 | 1400.02 | 51.5% | operator |
| 29322 | Merge Join | 2887.97 | 2910.61 | 0.8% | operator |
| 29331 | Index Scan | 0.02 | 0.07 | 247.3% | operator |
| 29323 | Sort | 2837.18 | 1098.13 | 61.3% | operator |
| 29329 | Sort | 64.69 | 1014.60 | 1468.4% | operator |
| 29324 | Hash Join | 2837.16 | 688.83 | 75.7% | pattern |
| 29330 | Seq Scan | 53.02 | 25.47 | 52.0% | operator |
| 29327 | Aggregate | 2622.32 | 1300.21 | 50.4% | operator |
| 29328 | Index Scan | 2130.54 | 219.99 | 89.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29328 (Index Scan) - LEAF
...
### Step 3: Node 29324 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29316, 29317, 29318, 29319, 29320, 29325, 29326
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29330 (Seq Scan) - LEAF
...
### Step 8: Node 29331 (Index Scan) - LEAF
...
### Step 10: Node 29316 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 6ce7e974 (Limit -> Sort -> Aggregate -> Gather Merge -> Incremental Sort (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 29317, 29318, 29319, 29320, 29324, 29325, 29326
- **Input Features:**
