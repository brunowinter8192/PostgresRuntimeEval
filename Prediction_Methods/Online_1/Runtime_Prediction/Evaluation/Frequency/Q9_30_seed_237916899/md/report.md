...
```
Node 17973 (Sort) [PATTERN: 8951754f] - ROOT
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather -> | 8951754f | 17973 | 17974, 17975, 17976, 17977, 17979, 17980, 17981, 17982, 17984, 17985, 17988 |
| Hash -> Hash Join -> [Seq Scan | c0a8d3de | 17979 | 17973, 17974, 17975, 17976, 17977, 17980, 17981, 17982, 17984, 17985, 17988 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 17984 | 17973, 17974, 17975, 17976, 17977, 17979, 17980, 17981, 17982, 17985, 17988 |
...
| 17979 | Hash | 1039.74 | 44.21 | 95.7% | pattern |
| 17983 | Hash Join | 202.70 | 821.84 | 305.4% | operator |
| 17984 | Hash Join | 186.83 | 981.46 | 425.3% | pattern |
...
### Step 4: Node 17991 (Seq Scan) - LEAF
...
### Step 5: Node 17984 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 17973, 17974, 17975, 17976, 17977, 17979, 17980, 17981, 17982, 17985, 17988
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=22712
  - HashJoin_nt1=22712
...
### Step 8: Node 17978 (Seq Scan) - LEAF
...
### Step 9: Node 17979 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** c0a8d3de (Hash -> Hash Join -> [Seq Scan (Outer), Hash (Inner)] (Outer))
- **Consumes:** Nodes 17973, 17974, 17975, 17976, 17977, 17980, 17981, 17982, 17984, 17985, 17988
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17973 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 8951754f (Sort -> Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 17974, 17975, 17976, 17977, 17979, 17980, 17981, 17982, 17984, 17985, 17988
- **Input Features:**
