...
```
Node 6579 (Aggregate) [PATTERN: 2724c080] - ROOT
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 6581 | 6579, 6580, 6582 |
| Aggregate -> Gather Merge (Out | 2724c080 | 6579 | 6580, 6581, 6582 |
...
|------|------|--------|-----------|-----|--------|
| 6579 | Aggregate | 1032.37 | 1078.99 | 4.5% | pattern |
...
### Step 5: Node 6579 (Aggregate) - PATTERN ROOT
