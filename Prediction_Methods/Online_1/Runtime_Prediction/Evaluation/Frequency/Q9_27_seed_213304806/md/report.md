    ...
    Node 17903 (Gather) [consumed]
      Node 17904 (Aggregate) [consumed]
        Node 17905 (Nested Loop) [consumed]
          Node 17906 (Hash Join) [PATTERN: 895c6e8c]
            Node 17907 (Seq Scan) [consumed] - LEAF
            Node 17908 (Hash) [consumed]
              Node 17909 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 0405d50f | 17902 | 17903, 17904, 17905, 17906, 17907, 17908, 17910, 17911, 17914 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 17906 | 17902, 17903, 17904, 17905, 17907, 17908, 17910, 17911, 17914 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 17910 | 17902, 17903, 17904, 17905, 17906, 17907, 17908, 17911, 17914 |
...
| 17906 | Hash Join | 968.30 | 734.19 | 24.2% | pattern |
| 17918 | Index Scan | 0.00 | -0.04 | 1512.7% | operator |
| 17909 | Hash Join | 173.44 | 820.72 | 373.2% | operator |
...
- **Consumes:** Nodes 17902, 17903, 17904, 17905, 17906, 17907, 17908, 17911, 17914
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=19372
  - HashJoin_nt1=19372
...
### Step 8: Node 17906 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 17902, 17903, 17904, 17905, 17907, 17908, 17910, 17911, 17914
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=69752
...
### Step 9: Node 17918 (Index Scan) - LEAF
...
### Step 10: Node 17902 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 0405d50f (Aggregate -> Gather -> Aggregate -> Nested Loop (Outer) (Outer) (Outer))
- **Consumes:** Nodes 17903, 17904, 17905, 17906, 17907, 17908, 17910, 17911, 17914
- **Input Features:**
