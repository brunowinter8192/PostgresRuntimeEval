...
**Test Query:** Q18_64_seed_516853953
...
```
Node 30580 (Limit) [PATTERN: 6ce7e974] - ROOT
  Node 30581 (Sort) [consumed]
    Node 30582 (Aggregate) [consumed]
      Node 30583 (Gather Merge) [consumed]
        Node 30584 (Incremental Sort) [consumed]
          Node 30585 (Nested Loop)
            Node 30586 (Merge Join)
              Node 30587 (Sort)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 6ce7e974 | 30580 | 30581, 30582, 30583, 30584, 30588, 30589, 30590 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30588 | 30580, 30581, 30582, 30583, 30584, 30589, 30590 |
...
|------|------|--------|-----------|-----|--------|
| 30580 | Limit | 3036.74 | 3050.24 | 0.4% | pattern |
| 30585 | Nested Loop | 2901.95 | 1400.02 | 51.8% | operator |
| 30586 | Merge Join | 2901.89 | 2910.61 | 0.3% | operator |
| 30595 | Index Scan | 0.02 | 0.07 | 214.2% | operator |
| 30587 | Sort | 2834.54 | 1098.13 | 61.3% | operator |
| 30593 | Sort | 64.45 | 1014.60 | 1474.1% | operator |
| 30588 | Hash Join | 2834.53 | 688.83 | 75.7% | pattern |
| 30594 | Seq Scan | 52.75 | 25.47 | 51.7% | operator |
| 30591 | Aggregate | 2612.93 | 1300.21 | 50.2% | operator |
| 30592 | Index Scan | 2141.88 | 219.99 | 89.7% | operator |
...
- **Consumes:** Nodes 30580, 30581, 30582, 30583, 30584, 30589, 30590
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30594 (Seq Scan) - LEAF
...
### Step 8: Node 30595 (Index Scan) - LEAF
...
### Step 10: Node 30580 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 6ce7e974 (Limit -> Sort -> Aggregate -> Gather Merge -> Incremental Sort (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 30581, 30582, 30583, 30584, 30588, 30589, 30590
- **Input Features:**
