...
**Test Query:** Q18_94_seed_762974883
...
```
Node 31108 (Limit) [PATTERN: 6ce7e974] - ROOT
  Node 31109 (Sort) [consumed]
    Node 31110 (Aggregate) [consumed]
      Node 31111 (Gather Merge) [consumed]
        Node 31112 (Incremental Sort) [consumed]
          Node 31113 (Nested Loop)
            Node 31114 (Merge Join)
              Node 31115 (Sort)
                Node 31116 (Hash Join) [PATTERN: 895c6e8c]
                  Node 31117 (Seq Scan) [consumed] - LEAF
                  Node 31118 (Hash) [consumed]
                    Node 31119 (Aggregate)
                      Node 31120 (Index Scan) - LEAF
              Node 31121 (Sort)
                Node 31122 (Seq Scan) - LEAF
            Node 31123 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 6ce7e974 | 31108 | 31109, 31110, 31111, 31112, 31116, 31117, 31118 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 31116 | 31108, 31109, 31110, 31111, 31112, 31117, 31118 |
...
|------|------|--------|-----------|-----|--------|
| 31108 | Limit | 3089.97 | 3050.24 | 1.3% | pattern |
| 31113 | Nested Loop | 2959.21 | 1400.02 | 52.7% | operator |
| 31114 | Merge Join | 2959.14 | 2910.61 | 1.6% | operator |
| 31123 | Index Scan | 0.02 | 0.07 | 174.9% | operator |
| 31115 | Sort | 2890.97 | 1098.13 | 62.0% | operator |
| 31121 | Sort | 65.24 | 1014.60 | 1455.3% | operator |
| 31116 | Hash Join | 2890.95 | 688.83 | 76.2% | pattern |
| 31122 | Seq Scan | 53.13 | 25.47 | 52.1% | operator |
| 31119 | Aggregate | 2675.11 | 1300.21 | 51.4% | operator |
| 31120 | Index Scan | 2155.83 | 219.99 | 89.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31120 (Index Scan) - LEAF
...
### Step 3: Node 31116 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 31108, 31109, 31110, 31111, 31112, 31117, 31118
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 31122 (Seq Scan) - LEAF
...
### Step 8: Node 31123 (Index Scan) - LEAF
...
### Step 10: Node 31108 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 6ce7e974 (Limit -> Sort -> Aggregate -> Gather Merge -> Incremental Sort (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31109, 31110, 31111, 31112, 31116, 31117, 31118
- **Input Features:**
