...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge (Out | 2724c080 | 24523 | 24524, 24527, 24528, 24529 |
| Nested Loop -> [Seq Scan (Oute | c53c4396 | 24527 | 24523, 24524, 24528, 24529 |
...
|------|------|--------|-----------|-----|--------|
| 24523 | Aggregate | 1010.74 | 1027.05 | 1.6% | pattern |
| 24525 | Aggregate | 990.53 | 940.64 | 5.0% | operator |
| 24526 | Sort | 989.90 | 1050.80 | 6.2% | operator |
| 24527 | Nested Loop | 988.91 | 976.06 | 1.3% | pattern |
...
- **Consumes:** Nodes 24523, 24524, 24528, 24529
- **Input Features:**
...
### Step 4: Node 24523 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 24524, 24527, 24528, 24529
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=7
  - Aggregate_nt1=35
