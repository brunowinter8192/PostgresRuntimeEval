...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5391 | 5392, 5393, 5394 |
...
| 5395 | Nested Loop | 1167.88 | 1121.45 | 4.0% | operator |
| 5396 | Hash Join | 209.31 | 231.04 | 10.4% | operator |
| 5400 | Index Scan | 0.03 | -0.02 | 171.3% | operator |
| 5397 | Seq Scan | 157.16 | 162.06 | 3.1% | operator |
| 5398 | Hash | 29.50 | 17.51 | 40.6% | operator |
...
### Step 2: Node 5397 (Seq Scan) - LEAF
...
- **Output:** st=28.97, rt=231.04

### Step 5: Node 5400 (Index Scan) - LEAF
...
- **Output:** st=29.93, rt=1121.45

### Step 7: Node 5391 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5392, 5393, 5394
- **Input Features:**
