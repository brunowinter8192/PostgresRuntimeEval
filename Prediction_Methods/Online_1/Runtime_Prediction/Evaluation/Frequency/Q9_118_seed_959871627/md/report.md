          ...
          Node 17001 (Hash Join) [PATTERN: 895c6e8c]
            ...
            Node 17003 (Hash) [consumed]
              Node 17004 (Hash Join)
                Node 17005 (Hash Join) [PATTERN: 2e0f44ef]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 17001 | 16996, 16997, 17002, 17003, 17005, 17006, 17009 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 16996 | 16997, 17001, 17002, 17003, 17005, 17006, 17009 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 17005 | 16996, 16997, 17001, 17002, 17003, 17006, 17009 |
...
| 17004 | Hash Join | 191.41 | 820.78 | 328.8% | operator |
| 17005 | Hash Join | 177.33 | 981.11 | 453.3% | pattern |
...
### Step 4: Node 17012 (Seq Scan) - LEAF
...
### Step 5: Node 17005 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 16996, 16997, 17001, 17002, 17003, 17006, 17009
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18703
  - HashJoin_nt1=18703
...
### Step 8: Node 17001 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 16996, 16997, 17002, 17003, 17005, 17006, 17009
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=67346
...
### Step 9: Node 17013 (Index Scan) - LEAF
...
### Step 10: Node 17000 (Nested Loop)
...
### Step 13: Node 16996 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 16997, 17001, 17002, 17003, 17005, 17006, 17009
- **Input Features:**
