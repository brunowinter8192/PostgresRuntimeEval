...
**Test Query:** Q18_39_seed_311753178
...
```
Node 30132 (Limit) [PATTERN: 6ce7e974] - ROOT
  Node 30133 (Sort) [consumed]
    Node 30134 (Aggregate) [consumed]
      Node 30135 (Gather Merge) [consumed]
        Node 30136 (Incremental Sort) [consumed]
          Node 30137 (Nested Loop)
            Node 30138 (Merge Join)
              Node 30139 (Sort)
                Node 30140 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30141 (Seq Scan) [consumed] - LEAF
                  Node 30142 (Hash) [consumed]
                    Node 30143 (Aggregate)
                      Node 30144 (Index Scan) - LEAF
              Node 30145 (Sort)
                Node 30146 (Seq Scan) - LEAF
            Node 30147 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 6ce7e974 | 30132 | 30133, 30134, 30135, 30136, 30140, 30141, 30142 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30140 | 30132, 30133, 30134, 30135, 30136, 30141, 30142 |
...
|------|------|--------|-----------|-----|--------|
| 30132 | Limit | 3065.47 | 3050.24 | 0.5% | pattern |
| 30137 | Nested Loop | 2935.69 | 1400.02 | 52.3% | operator |
| 30138 | Merge Join | 2935.63 | 2910.61 | 0.9% | operator |
| 30147 | Index Scan | 0.03 | 0.07 | 163.9% | operator |
| 30139 | Sort | 2867.88 | 1098.13 | 61.7% | operator |
| 30145 | Sort | 65.27 | 1014.60 | 1454.4% | operator |
| 30140 | Hash Join | 2867.86 | 688.83 | 76.0% | pattern |
| 30146 | Seq Scan | 53.60 | 25.47 | 52.5% | operator |
| 30143 | Aggregate | 2629.95 | 1300.21 | 50.6% | operator |
| 30144 | Index Scan | 2131.25 | 219.99 | 89.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30144 (Index Scan) - LEAF
...
### Step 3: Node 30140 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30132, 30133, 30134, 30135, 30136, 30141, 30142
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30146 (Seq Scan) - LEAF
...
### Step 8: Node 30147 (Index Scan) - LEAF
...
### Step 10: Node 30132 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 6ce7e974 (Limit -> Sort -> Aggregate -> Gather Merge -> Incremental Sort (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 30133, 30134, 30135, 30136, 30140, 30141, 30142
- **Input Features:**
