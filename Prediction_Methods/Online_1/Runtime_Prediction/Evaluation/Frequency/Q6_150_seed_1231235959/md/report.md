...
```
Node 10121 (Aggregate) [PATTERN: dd3706ac] - ROOT
  Node 10122 (Gather) [consumed]
    Node 10123 (Aggregate) [consumed]
      Node 10124 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | dd3706ac | 10121 | 10122, 10123, 10124 |
...
|------|------|--------|-----------|-----|--------|
| 10121 | Aggregate | 741.75 | 791.27 | 6.7% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10121 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** dd3706ac (Aggregate -> Gather -> Aggregate -> Seq Scan (Outer) (Outer) (Outer))
- **Consumes:** Nodes 10122, 10123, 10124
- **Input Features:**
