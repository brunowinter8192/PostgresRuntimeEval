...
Node 19280 (Sort) - ROOT
  Node 19281 (Aggregate) [PATTERN: 0405d50f]
    Node 19282 (Gather) [consumed]
      Node 19283 (Aggregate) [consumed]
        Node 19284 (Nested Loop) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 0405d50f | 19281 | 19282, 19283, 19284, 19285, 19286, 19287, 19289, 19290, 19293 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 19285 | 19281, 19282, 19283, 19284, 19286, 19287, 19289, 19290, 19293 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 19289 | 19281, 19282, 19283, 19284, 19285, 19286, 19287, 19290, 19293 |
...
|------|------|--------|-----------|-----|--------|
| 19280 | Sort | 1204.29 | 1159.89 | 3.7% | operator |
| 19281 | Aggregate | 1204.17 | 1194.84 | 0.8% | pattern |
...
- **Consumes:** Nodes 19281, 19282, 19283, 19284, 19285, 19286, 19287, 19290, 19293
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=19372
  - HashJoin_nt1=19372
...
- **Consumes:** Nodes 19281, 19282, 19283, 19284, 19286, 19287, 19289, 19290, 19293
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=69752
...
### Step 10: Node 19281 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 0405d50f (Aggregate -> Gather -> Aggregate -> Nested Loop (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19282, 19283, 19284, 19285, 19286, 19287, 19289, 19290, 19293
- **Input Features:**
