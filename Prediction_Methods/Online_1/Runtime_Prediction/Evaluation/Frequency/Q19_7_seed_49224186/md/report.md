...
Node 32109 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 32110 (Gather) [consumed]
    Node 32111 (Aggregate) [consumed]
      Node 32112 (Hash Join)
        Node 32113 (Seq Scan) - LEAF
        Node 32114 (Hash)
          Node 32115 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 32109 | 32110, 32111 |
...
| 32112 | Hash Join | 787.51 | 782.38 | 0.7% | operator |
| 32113 | Seq Scan | 740.06 | 750.07 | 1.4% | operator |
| 32114 | Hash | 45.32 | 12.06 | 73.4% | operator |
| 32115 | Seq Scan | 45.17 | 31.60 | 30.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 32115 (Seq Scan) - LEAF
...
### Step 2: Node 32113 (Seq Scan) - LEAF
...
### Step 5: Node 32109 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 32110, 32111
- **Input Features:**
