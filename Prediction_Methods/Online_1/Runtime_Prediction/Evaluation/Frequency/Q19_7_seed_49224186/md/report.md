...
```
Node 32109 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 32109 | 32110, 32111, 32112, 32113, 32114 |
...
|------|------|--------|-----------|-----|--------|
| 32109 | Aggregate | 806.57 | 841.25 | 4.3% | pattern |
...
- **Consumes:** Nodes 32110, 32111, 32112, 32113, 32114
- **Input Features:**
