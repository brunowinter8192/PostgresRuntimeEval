...
```
Node 14673 (Aggregate) - ROOT
  Node 14674 (Gather Merge)
    Node 14675 (Sort)
...
|------|------|--------|-----------|-----|--------|
| 14673 | Aggregate | 1209.28 | 1196.51 | 1.1% | operator |
| 14674 | Gather Merge | 1208.79 | 1123.88 | 7.0% | operator |
...
| 14678 | Hash Join | 1200.56 | 1027.31 | 14.4% | operator |
...
| 14680 | Hash Join | 216.60 | 226.27 | 4.5% | operator |
...
| 14682 | Hash | 38.29 | 18.06 | 52.8% | operator |
| 14683 | Hash Join | 37.63 | 67.97 | 80.6% | operator |
| 14684 | Seq Scan | 35.83 | 24.87 | 30.6% | operator |
| 14685 | Hash | 0.51 | 17.93 | 3443.0% | operator |
| 14686 | Hash Join | 0.50 | 151.58 | 30156.2% | operator |
...
### Step 5: Node 14684 (Seq Scan) - LEAF
...
### Step 8: Node 14681 (Seq Scan) - LEAF
...
### Step 11: Node 14690 (Index Scan) - LEAF
...
### Step 12: Node 14692 (Seq Scan) - LEAF
...
### Step 13: Node 14679 (Nested Loop)
...
### Step 16: Node 14693 (Index Scan) - LEAF
...
### Step 17: Node 14695 (Seq Scan) - LEAF
...
### Step 18: Node 14677 (Nested Loop)
...
### Step 22: Node 14674 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1086.9206
  - st2=0.0000
  - startup_cost=71544.2500
  - total_cost=71823.6900
- **Output:** st=1120.80, rt=1123.88

### Step 23: Node 14673 (Aggregate) - ROOT
