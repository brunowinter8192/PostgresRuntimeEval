...
Node 7621 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 7622 (Aggregate) [consumed]
    Node 7623 (Gather Merge)
      Node 7624 (Aggregate)
        Node 7625 (Sort)
          Node 7626 (Hash Join) [PATTERN: 2e0f44ef]
            Node 7627 (Nested Loop) [consumed]
                ...
                Node 7630 (Hash) [consumed]
                  Node 7631 (Hash Join) [PATTERN: 895c6e8c]
                    ...
                    Node 7633 (Hash) [consumed]
                      Node 7634 (Hash Join) [PATTERN: f4cb205a]
                        Node 7635 (Seq Scan) [consumed] - LEAF
                        Node 7636 (Hash) [consumed]
                          Node 7637 (Seq Scan) [consumed] - LEAF
              Node 7638 (Index Scan) - LEAF
            Node 7639 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 7634 | 7621, 7622, 7626, 7627, 7628, 7629, 7630, 7631, 7632, 7633, 7635, 7636, 7637, 7639 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 7628 | 7621, 7622, 7626, 7627, 7629, 7630, 7631, 7632, 7633, 7634, 7635, 7636, 7637, 7639 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 7631 | 7621, 7622, 7626, 7627, 7628, 7629, 7630, 7632, 7633, 7634, 7635, 7636, 7637, 7639 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 7621 | 7622, 7626, 7627, 7628, 7629, 7630, 7631, 7632, 7633, 7634, 7635, 7636, 7637, 7639 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 7626 | 7621, 7622, 7627, 7628, 7629, 7630, 7631, 7632, 7633, 7634, 7635, 7636, 7637, 7639 |
...
|------|------|--------|-----------|-----|--------|
| 7621 | Sort | 1078.37 | 1080.15 | 0.2% | pattern |
| 7623 | Gather Merge | 1078.35 | 1124.35 | 4.3% | operator |
| 7624 | Aggregate | 1073.12 | 1019.65 | 5.0% | operator |
| 7625 | Sort | 1072.87 | 1073.13 | 0.0% | operator |
| 7626 | Hash Join | 1072.37 | 1080.65 | 0.8% | pattern |
| 7628 | Hash Join | 216.20 | 259.80 | 20.2% | pattern |
| 7638 | Index Scan | 0.07 | -0.03 | 134.9% | operator |
| 7640 | Seq Scan | 4.18 | 10.62 | 153.9% | operator |
| 7631 | Hash Join | 31.99 | 84.97 | 165.6% | pattern |
| 7634 | Hash Join | 0.07 | 11.62 | 16494.1% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 7634 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 7621, 7622, 7626, 7627, 7628, 7629, 7630, 7631, 7632, 7633, 7635, 7636, 7637, 7639
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
### Step 2: Node 7631 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 7621, 7622, 7626, 7627, 7628, 7629, 7630, 7632, 7633, 7634, 7635, 7636, 7637, 7639
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=12500
  - HashJoin_nt1=62500
...
### Step 3: Node 7628 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 7621, 7622, 7626, 7627, 7629, 7630, 7631, 7632, 7633, 7634, 7635, 7636, 7637, 7639
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14884
  - HashJoin_nt1=74418
...
### Step 4: Node 7638 (Index Scan) - LEAF
...
### Step 5: Node 7640 (Seq Scan) - LEAF
...
### Step 6: Node 7626 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 7621, 7622, 7627, 7628, 7629, 7630, 7631, 7632, 7633, 7634, 7635, 7636, 7637, 7639
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=2382
  - HashJoin_nt1=59546
...
### Step 10: Node 7621 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 7622, 7626, 7627, 7628, 7629, 7630, 7631, 7632, 7633, 7634, 7635, 7636, 7637, 7639
- **Input Features:**
