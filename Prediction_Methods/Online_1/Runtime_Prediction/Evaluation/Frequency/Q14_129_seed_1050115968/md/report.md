...
```
Node 26637 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 26637 | 26638, 26639, 26640, 26641, 26642 |
...
|------|------|--------|-----------|-----|--------|
| 26637 | Aggregate | 848.62 | 825.95 | 2.7% | pattern |
...
- **Consumes:** Nodes 26638, 26639, 26640, 26641, 26642
- **Input Features:**
