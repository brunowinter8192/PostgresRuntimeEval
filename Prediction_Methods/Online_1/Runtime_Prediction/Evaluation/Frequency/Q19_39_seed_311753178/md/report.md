...
Node 31794 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31795 (Gather) [consumed]
    Node 31796 (Aggregate) [consumed]
      Node 31797 (Hash Join) [PATTERN: f4cb205a]
        Node 31798 (Seq Scan) [consumed] - LEAF
        Node 31799 (Hash) [consumed]
          Node 31800 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 31797 | 31794, 31795, 31796, 31798, 31799, 31800 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31794 | 31795, 31796, 31797, 31798, 31799, 31800 |
...
| 31797 | Hash Join | 811.36 | 373.83 | 53.9% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31797 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 31794, 31795, 31796, 31798, 31799, 31800
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=23
  - HashJoin_nt1=22561
  ...
  - HashJoin_total_cost=156338.7400
  - Hash_Inner_np=0
  - Hash_Inner_nt=205
  - Hash_Inner_nt1=205
  - Hash_Inner_nt2=0
...
### Step 2: Node 31794 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31795, 31796, 31797, 31798, 31799, 31800
- **Input Features:**
