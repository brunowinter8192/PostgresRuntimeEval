...
```
Node 31794 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 31794 | 31795, 31796, 31797, 31798, 31799 |
...
|------|------|--------|-----------|-----|--------|
| 31794 | Aggregate | 832.68 | 841.28 | 1.0% | pattern |
...
- **Consumes:** Nodes 31795, 31796, 31797, 31798, 31799
- **Input Features:**
