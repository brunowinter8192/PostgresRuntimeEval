...
```
Node 27148 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 27148 | 27149, 27150, 27151, 27152, 27153 |
...
|------|------|--------|-----------|-----|--------|
| 27148 | Aggregate | 825.14 | 825.94 | 0.1% | pattern |
...
- **Consumes:** Nodes 27149, 27150, 27151, 27152, 27153
- **Input Features:**
