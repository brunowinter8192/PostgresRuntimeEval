...
```
Node 19043 (Sort) [PATTERN: 8951754f] - ROOT
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather -> | 8951754f | 19043 | 19044, 19045, 19046, 19047, 19049, 19050, 19051, 19052, 19054, 19055, 19058 |
| Hash -> Hash Join -> [Seq Scan | c0a8d3de | 19049 | 19043, 19044, 19045, 19046, 19047, 19050, 19051, 19052, 19054, 19055, 19058 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 19054 | 19043, 19044, 19045, 19046, 19047, 19049, 19050, 19051, 19052, 19055, 19058 |
...
| 19049 | Hash | 999.25 | 44.21 | 95.6% | pattern |
| 19053 | Hash Join | 209.91 | 821.84 | 291.5% | operator |
| 19054 | Hash Join | 194.16 | 981.46 | 405.5% | pattern |
...
### Step 4: Node 19061 (Seq Scan) - LEAF
...
### Step 5: Node 19054 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 19043, 19044, 19045, 19046, 19047, 19049, 19050, 19051, 19052, 19055, 19058
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=22712
  - HashJoin_nt1=22712
...
### Step 8: Node 19048 (Seq Scan) - LEAF
...
### Step 9: Node 19049 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** c0a8d3de (Hash -> Hash Join -> [Seq Scan (Outer), Hash (Inner)] (Outer))
- **Consumes:** Nodes 19043, 19044, 19045, 19046, 19047, 19050, 19051, 19052, 19054, 19055, 19058
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 19043 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 8951754f (Sort -> Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19044, 19045, 19046, 19047, 19049, 19050, 19051, 19052, 19054, 19055, 19058
- **Input Features:**
