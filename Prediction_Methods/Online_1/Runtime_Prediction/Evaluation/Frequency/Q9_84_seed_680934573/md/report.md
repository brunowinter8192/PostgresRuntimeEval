...
```
Node 19043 (Sort) [PATTERN: 5968661e] - ROOT
  Node 19044 (Aggregate) [consumed]
    Node 19045 (Gather) [consumed]
      Node 19046 (Aggregate) [consumed]
        Node 19047 (Hash Join) [consumed]
          Node 19048 (Seq Scan) [consumed] - LEAF
          Node 19049 (Hash) [consumed]
            Node 19050 (Hash Join) [consumed]
              Node 19051 (Seq Scan) [consumed] - LEAF
              Node 19052 (Hash) [consumed]
                Node 19053 (Hash Join) [consumed]
                  Node 19054 (Hash Join) [consumed]
                    Node 19055 (Nested Loop)
                      Node 19056 (Seq Scan) - LEAF
                      Node 19057 (Index Scan) - LEAF
                    Node 19058 (Hash)
                      Node 19059 (Seq Scan) - LEAF
                  Node 19060 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather -> | 5968661e | 19043 | 19044, 19045, 19046, 19047, 19048, 19049, 19050, 19051, 19052, 19053, 19054, 19060 |
...
|------|------|--------|-----------|-----|--------|
| 19043 | Sort | 1239.24 | 1278.10 | 3.1% | pattern |
...
### Step 7: Node 19043 (Sort) - PATTERN ROOT
...
- **Consumes:** Nodes 19044, 19045, 19046, 19047, 19048, 19049, 19050, 19051, 19052, 19053, 19054, 19060
- **Input Features:**
