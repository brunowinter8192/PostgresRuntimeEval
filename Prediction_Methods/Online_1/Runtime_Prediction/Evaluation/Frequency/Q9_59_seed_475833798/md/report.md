...
```
Node 18534 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18535 (Aggregate) [consumed]
    Node 18536 (Gather)
      Node 18537 (Aggregate)
        Node 18538 (Nested Loop)
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 18539 | 18534, 18535, 18540, 18541, 18543, 18544, 18547 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18534 | 18535, 18539, 18540, 18541, 18543, 18544, 18547 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 18543 | 18534, 18535, 18539, 18540, 18541, 18544, 18547 |
...
|------|------|--------|-----------|-----|--------|
| 18534 | Sort | 1188.18 | 1116.84 | 6.0% | pattern |
| 18536 | Gather | 1185.74 | 1135.48 | 4.2% | operator |
| 18537 | Aggregate | 1164.09 | 1135.57 | 2.5% | operator |
| 18538 | Nested Loop | 1139.03 | 1182.91 | 3.9% | operator |
...
- **Consumes:** Nodes 18534, 18535, 18539, 18540, 18541, 18544, 18547
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=19372
  - HashJoin_nt1=19372
...
- **Consumes:** Nodes 18534, 18535, 18540, 18541, 18543, 18544, 18547
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=69752
...
### Step 10: Node 18538 (Nested Loop)
...
- **Output:** st=131.07, rt=1182.91

### Step 11: Node 18537 (Aggregate)
...
- **Output:** st=1134.04, rt=1135.57

### Step 12: Node 18536 (Gather)
...
- **Output:** st=579.28, rt=1135.48

### Step 13: Node 18534 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18535, 18539, 18540, 18541, 18543, 18544, 18547
- **Input Features:**
