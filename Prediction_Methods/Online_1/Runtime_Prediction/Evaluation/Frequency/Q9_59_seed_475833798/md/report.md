    ...
    Node 18536 (Gather) [consumed]
      Node 18537 (Aggregate) [consumed]
        Node 18538 (Nested Loop) [consumed]
          Node 18539 (Hash Join) [PATTERN: 895c6e8c]
            Node 18540 (Seq Scan) [consumed] - LEAF
            Node 18541 (Hash) [consumed]
              Node 18542 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 0405d50f | 18535 | 18536, 18537, 18538, 18539, 18540, 18541, 18543, 18544, 18547 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 18539 | 18535, 18536, 18537, 18538, 18540, 18541, 18543, 18544, 18547 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 18543 | 18535, 18536, 18537, 18538, 18539, 18540, 18541, 18544, 18547 |
...
| 18539 | Hash Join | 961.09 | 734.19 | 23.6% | pattern |
| 18551 | Index Scan | 0.00 | -0.04 | 1512.7% | operator |
| 18542 | Hash Join | 178.89 | 820.72 | 358.8% | operator |
...
- **Consumes:** Nodes 18535, 18536, 18537, 18538, 18539, 18540, 18541, 18544, 18547
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=19372
  - HashJoin_nt1=19372
...
- **Output:** st=26.49, rt=820.72

### Step 8: Node 18539 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 18535, 18536, 18537, 18538, 18540, 18541, 18543, 18544, 18547
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=69752
...
- **Output:** st=176.15, rt=734.19

### Step 9: Node 18551 (Index Scan) - LEAF
...
### Step 10: Node 18535 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 0405d50f (Aggregate -> Gather -> Aggregate -> Nested Loop (Outer) (Outer) (Outer))
- **Consumes:** Nodes 18536, 18537, 18538, 18539, 18540, 18541, 18543, 18544, 18547
- **Input Features:**
