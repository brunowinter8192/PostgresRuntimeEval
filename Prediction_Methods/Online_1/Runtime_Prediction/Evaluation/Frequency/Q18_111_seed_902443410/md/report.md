...
**Test Query:** Q18_111_seed_902443410
...
```
Node 29012 (Limit) [PATTERN: 6ce7e974] - ROOT
  Node 29013 (Sort) [consumed]
    Node 29014 (Aggregate) [consumed]
      Node 29015 (Gather Merge) [consumed]
        Node 29016 (Incremental Sort) [consumed]
          Node 29017 (Nested Loop)
            Node 29018 (Merge Join)
              Node 29019 (Sort)
                Node 29020 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29021 (Seq Scan) [consumed] - LEAF
                  Node 29022 (Hash) [consumed]
                    Node 29023 (Aggregate)
                      Node 29024 (Index Scan) - LEAF
              Node 29025 (Sort)
                Node 29026 (Seq Scan) - LEAF
            Node 29027 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 6ce7e974 | 29012 | 29013, 29014, 29015, 29016, 29020, 29021, 29022 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29020 | 29012, 29013, 29014, 29015, 29016, 29021, 29022 |
...
|------|------|--------|-----------|-----|--------|
| 29012 | Limit | 3048.09 | 3050.24 | 0.1% | pattern |
| 29017 | Nested Loop | 2910.35 | 1400.02 | 51.9% | operator |
| 29018 | Merge Join | 2910.30 | 2910.61 | 0.0% | operator |
| 29027 | Index Scan | 0.02 | 0.07 | 214.2% | operator |
| 29019 | Sort | 2840.33 | 1098.13 | 61.3% | operator |
| 29025 | Sort | 67.01 | 1014.60 | 1414.1% | operator |
| 29020 | Hash Join | 2840.32 | 688.83 | 75.7% | pattern |
| 29026 | Seq Scan | 54.14 | 25.47 | 53.0% | operator |
| 29023 | Aggregate | 2613.21 | 1300.21 | 50.2% | operator |
| 29024 | Index Scan | 2110.34 | 219.99 | 89.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29024 (Index Scan) - LEAF
...
### Step 3: Node 29020 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29012, 29013, 29014, 29015, 29016, 29021, 29022
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29026 (Seq Scan) - LEAF
...
### Step 8: Node 29027 (Index Scan) - LEAF
...
### Step 10: Node 29012 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 6ce7e974 (Limit -> Sort -> Aggregate -> Gather Merge -> Incremental Sort (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 29013, 29014, 29015, 29016, 29020, 29021, 29022
- **Input Features:**
