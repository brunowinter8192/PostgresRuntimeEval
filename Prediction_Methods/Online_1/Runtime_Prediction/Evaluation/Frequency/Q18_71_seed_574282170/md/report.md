...
**Test Query:** Q18_71_seed_574282170
...
```
Node 30708 (Limit) [PATTERN: 6ce7e974] - ROOT
  Node 30709 (Sort) [consumed]
    Node 30710 (Aggregate) [consumed]
      Node 30711 (Gather Merge) [consumed]
        Node 30712 (Incremental Sort) [consumed]
          Node 30713 (Nested Loop)
            Node 30714 (Merge Join)
              Node 30715 (Sort)
                Node 30716 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30717 (Seq Scan) [consumed] - LEAF
                  Node 30718 (Hash) [consumed]
                    Node 30719 (Aggregate)
                      Node 30720 (Index Scan) - LEAF
              Node 30721 (Sort)
                Node 30722 (Seq Scan) - LEAF
            Node 30723 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 6ce7e974 | 30708 | 30709, 30710, 30711, 30712, 30716, 30717, 30718 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30716 | 30708, 30709, 30710, 30711, 30712, 30717, 30718 |
...
|------|------|--------|-----------|-----|--------|
| 30708 | Limit | 3060.10 | 3050.24 | 0.3% | pattern |
| 30713 | Nested Loop | 2921.78 | 1400.02 | 52.1% | operator |
| 30714 | Merge Join | 2921.69 | 2910.61 | 0.4% | operator |
| 30723 | Index Scan | 0.04 | 0.07 | 69.2% | operator |
| 30715 | Sort | 2851.72 | 1098.13 | 61.5% | operator |
| 30721 | Sort | 67.79 | 1014.60 | 1396.6% | operator |
| 30716 | Hash Join | 2851.71 | 688.83 | 75.8% | pattern |
| 30722 | Seq Scan | 54.68 | 25.47 | 53.4% | operator |
| 30719 | Aggregate | 2624.83 | 1300.21 | 50.5% | operator |
| 30720 | Index Scan | 2120.35 | 219.99 | 89.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30720 (Index Scan) - LEAF
...
### Step 3: Node 30716 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30708, 30709, 30710, 30711, 30712, 30717, 30718
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30722 (Seq Scan) - LEAF
...
### Step 8: Node 30723 (Index Scan) - LEAF
...
### Step 10: Node 30708 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 6ce7e974 (Limit -> Sort -> Aggregate -> Gather Merge -> Incremental Sort (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 30709, 30710, 30711, 30712, 30716, 30717, 30718
- **Input Features:**
