...
```
Node 31703 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 31703 | 31704, 31705, 31706, 31707, 31708 |
...
|------|------|--------|-----------|-----|--------|
| 31703 | Aggregate | 858.25 | 841.26 | 2.0% | pattern |
...
- **Consumes:** Nodes 31704, 31705, 31706, 31707, 31708
- **Input Features:**
