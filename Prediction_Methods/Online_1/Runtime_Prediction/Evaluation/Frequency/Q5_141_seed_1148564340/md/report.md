                ...
                Node 7810 (Hash) [consumed]
                  Node 7811 (Hash Join) [PATTERN: 895c6e8c]
                    ...
                    Node 7813 (Hash) [consumed]
                      Node 7814 (Hash Join) [PATTERN: f4cb205a]
                        Node 7815 (Seq Scan) [consumed] - LEAF
                        Node 7816 (Hash) [consumed]
                          Node 7817 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 7814 | 7801, 7802, 7806, 7807, 7808, 7809, 7810, 7811, 7812, 7813, 7815, 7816, 7817, 7819 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 7808 | 7801, 7802, 7806, 7807, 7809, 7810, 7811, 7812, 7813, 7814, 7815, 7816, 7817, 7819 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 7811 | 7801, 7802, 7806, 7807, 7808, 7809, 7810, 7812, 7813, 7814, 7815, 7816, 7817, 7819 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 7801 | 7802, 7806, 7807, 7808, 7809, 7810, 7811, 7812, 7813, 7814, 7815, 7816, 7817, 7819 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 7806 | 7801, 7802, 7807, 7808, 7809, 7810, 7811, 7812, 7813, 7814, 7815, 7816, 7817, 7819 |
...
|------|------|--------|-----------|-----|--------|
| 7801 | Sort | 1094.12 | 1080.12 | 1.3% | pattern |
| 7803 | Gather Merge | 1094.10 | 1124.38 | 2.8% | operator |
| 7804 | Aggregate | 1089.04 | 1019.77 | 6.4% | operator |
| 7805 | Sort | 1088.77 | 1073.09 | 1.4% | operator |
| 7806 | Hash Join | 1088.30 | 1080.06 | 0.8% | pattern |
| 7808 | Hash Join | 216.76 | 259.85 | 19.9% | pattern |
| 7818 | Index Scan | 0.07 | -0.03 | 133.5% | operator |
| 7820 | Seq Scan | 2.30 | 10.62 | 361.6% | operator |
| 7811 | Hash Join | 34.42 | 84.97 | 146.8% | pattern |
| 7814 | Hash Join | 0.07 | 11.62 | 17770.5% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 7814 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 7801, 7802, 7806, 7807, 7808, 7809, 7810, 7811, 7812, 7813, 7815, 7816, 7817, 7819
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
### Step 2: Node 7811 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 7801, 7802, 7806, 7807, 7808, 7809, 7810, 7812, 7813, 7814, 7815, 7816, 7817, 7819
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=12500
  - HashJoin_nt1=62500
...
### Step 3: Node 7808 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 7801, 7802, 7806, 7807, 7809, 7810, 7811, 7812, 7813, 7814, 7815, 7816, 7817, 7819
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14612
  - HashJoin_nt1=73059
...
### Step 4: Node 7818 (Index Scan) - LEAF
...
### Step 5: Node 7820 (Seq Scan) - LEAF
...
### Step 6: Node 7806 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 7801, 7802, 7807, 7808, 7809, 7810, 7811, 7812, 7813, 7814, 7815, 7816, 7817, 7819
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=2338
  - HashJoin_nt1=58459
...
### Step 10: Node 7801 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 7802, 7806, 7807, 7808, 7809, 7810, 7811, 7812, 7813, 7814, 7815, 7816, 7817, 7819
- **Input Features:**
