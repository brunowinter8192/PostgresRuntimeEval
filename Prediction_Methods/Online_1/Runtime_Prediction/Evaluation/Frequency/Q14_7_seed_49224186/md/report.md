...
Node 27309 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27310 (Gather) [consumed]
    Node 27311 (Aggregate) [consumed]
      Node 27312 (Hash Join) [PATTERN: f4cb205a]
        Node 27313 (Seq Scan) [consumed] - LEAF
        Node 27314 (Hash) [consumed]
          Node 27315 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 27312 | 27309, 27310, 27311, 27313, 27314, 27315 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27309 | 27310, 27311, 27312, 27313, 27314, 27315 |
...
| 27312 | Hash Join | 795.35 | 397.06 | 50.1% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27312 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 27309, 27310, 27311, 27313, 27314, 27315
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=15517
  - HashJoin_nt1=15517
  ...
  - HashJoin_total_cost=136647.3700
  - Hash_Inner_np=0
  - Hash_Inner_nt=83333
...
### Step 2: Node 27309 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27310, 27311, 27312, 27313, 27314, 27315
- **Input Features:**
