...
**Test Query:** Q18_62_seed_500445891
...
```
Node 30548 (Limit) [PATTERN: 6ce7e974] - ROOT
  Node 30549 (Sort) [consumed]
    Node 30550 (Aggregate) [consumed]
      Node 30551 (Gather Merge) [consumed]
        Node 30552 (Incremental Sort) [consumed]
          Node 30553 (Nested Loop)
            Node 30554 (Merge Join)
              Node 30555 (Sort)
                Node 30556 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30557 (Seq Scan) [consumed] - LEAF
                  Node 30558 (Hash) [consumed]
                    Node 30559 (Aggregate)
                      Node 30560 (Index Scan) - LEAF
              Node 30561 (Sort)
                Node 30562 (Seq Scan) - LEAF
            Node 30563 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 6ce7e974 | 30548 | 30549, 30550, 30551, 30552, 30556, 30557, 30558 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30556 | 30548, 30549, 30550, 30551, 30552, 30557, 30558 |
...
|------|------|--------|-----------|-----|--------|
| 30548 | Limit | 3031.48 | 3050.24 | 0.6% | pattern |
| 30553 | Nested Loop | 2879.26 | 1400.02 | 51.4% | operator |
| 30554 | Merge Join | 2879.22 | 2910.61 | 1.1% | operator |
| 30563 | Index Scan | 0.02 | 0.07 | 266.6% | operator |
| 30555 | Sort | 2828.89 | 1098.13 | 61.2% | operator |
| 30561 | Sort | 64.39 | 1014.60 | 1475.6% | operator |
| 30556 | Hash Join | 2828.88 | 688.83 | 75.6% | pattern |
| 30562 | Seq Scan | 53.01 | 25.47 | 52.0% | operator |
| 30559 | Aggregate | 2601.25 | 1300.21 | 50.0% | operator |
| 30560 | Index Scan | 2097.14 | 219.99 | 89.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30560 (Index Scan) - LEAF
...
### Step 3: Node 30556 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30548, 30549, 30550, 30551, 30552, 30557, 30558
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30562 (Seq Scan) - LEAF
...
### Step 8: Node 30563 (Index Scan) - LEAF
...
### Step 10: Node 30548 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 6ce7e974 (Limit -> Sort -> Aggregate -> Gather Merge -> Incremental Sort (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 30549, 30550, 30551, 30552, 30556, 30557, 30558
- **Input Features:**
