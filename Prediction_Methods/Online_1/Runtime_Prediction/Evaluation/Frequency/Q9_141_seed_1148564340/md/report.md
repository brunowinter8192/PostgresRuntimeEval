...
```
Node 17465 (Sort) [PATTERN: 5968661e] - ROOT
  Node 17466 (Aggregate) [consumed]
    Node 17467 (Gather) [consumed]
      Node 17468 (Aggregate) [consumed]
        Node 17469 (Hash Join) [consumed]
          Node 17470 (Seq Scan) [consumed] - LEAF
          Node 17471 (Hash) [consumed]
            Node 17472 (Hash Join) [consumed]
              Node 17473 (Seq Scan) [consumed] - LEAF
              Node 17474 (Hash) [consumed]
                Node 17475 (Hash Join) [consumed]
                  Node 17476 (Hash Join) [consumed]
                    Node 17477 (Nested Loop)
                      Node 17478 (Seq Scan) - LEAF
                      Node 17479 (Index Scan) - LEAF
                    Node 17480 (Hash)
                      Node 17481 (Seq Scan) - LEAF
                  Node 17482 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather -> | 5968661e | 17465 | 17466, 17467, 17468, 17469, 17470, 17471, 17472, 17473, 17474, 17475, 17476, 17482 |
...
|------|------|--------|-----------|-----|--------|
| 17465 | Sort | 1267.52 | 1278.10 | 0.8% | pattern |
...
### Step 7: Node 17465 (Sort) - PATTERN ROOT
...
- **Consumes:** Nodes 17466, 17467, 17468, 17469, 17470, 17471, 17472, 17473, 17474, 17475, 17476, 17482
- **Input Features:**
