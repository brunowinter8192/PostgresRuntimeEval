    ...
    Node 17214 (Gather) [consumed]
      Node 17215 (Aggregate) [consumed]
        Node 17216 (Hash Join) [consumed]
          ...
          Node 17218 (Hash) [PATTERN: c0a8d3de]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather -> | 8951754f | 17212 | 17213, 17214, 17215, 17216, 17218, 17219, 17220, 17221, 17223, 17224, 17227 |
| Hash -> Hash Join -> [Seq Scan | c0a8d3de | 17218 | 17212, 17213, 17214, 17215, 17216, 17219, 17220, 17221, 17223, 17224, 17227 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 17223 | 17212, 17213, 17214, 17215, 17216, 17218, 17219, 17220, 17221, 17224, 17227 |
...
| 17218 | Hash | 1037.26 | 44.21 | 95.7% | pattern |
...
- **Consumes:** Nodes 17212, 17213, 17214, 17215, 17216, 17218, 17219, 17220, 17221, 17224, 17227
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=22712
  - HashJoin_nt1=22712
...
### Step 8: Node 17217 (Seq Scan) - LEAF
...
### Step 9: Node 17218 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** c0a8d3de (Hash -> Hash Join -> [Seq Scan (Outer), Hash (Inner)] (Outer))
- **Consumes:** Nodes 17212, 17213, 17214, 17215, 17216, 17219, 17220, 17221, 17223, 17224, 17227
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17212 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 8951754f (Sort -> Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 17213, 17214, 17215, 17216, 17218, 17219, 17220, 17221, 17223, 17224, 17227
- **Input Features:**
