...
```
Node 7521 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 7522 (Aggregate) [consumed]
    Node 7523 (Gather Merge)
      Node 7524 (Aggregate)
        Node 7525 (Sort)
          Node 7526 (Hash Join) [PATTERN: 2e0f44ef]
            Node 7527 (Nested Loop) [consumed]
              Node 7528 (Hash Join) [PATTERN: 895c6e8c]
                Node 7529 (Seq Scan) [consumed] - LEAF
                Node 7530 (Hash) [consumed]
                  Node 7531 (Hash Join) [PATTERN: 895c6e8c]
                    Node 7532 (Seq Scan) [consumed] - LEAF
                    Node 7533 (Hash) [consumed]
                      Node 7534 (Hash Join) [PATTERN: f4cb205a]
                        Node 7535 (Seq Scan) [consumed] - LEAF
                        Node 7536 (Hash) [consumed]
                          Node 7537 (Seq Scan) [consumed] - LEAF
              Node 7538 (Index Scan) - LEAF
            Node 7539 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 7534 | 7521, 7522, 7526, 7527, 7528, 7529, 7530, 7531, 7532, 7533, 7535, 7536, 7537, 7539 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 7528 | 7521, 7522, 7526, 7527, 7529, 7530, 7531, 7532, 7533, 7534, 7535, 7536, 7537, 7539 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 7531 | 7521, 7522, 7526, 7527, 7528, 7529, 7530, 7532, 7533, 7534, 7535, 7536, 7537, 7539 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 7521 | 7522, 7526, 7527, 7528, 7529, 7530, 7531, 7532, 7533, 7534, 7535, 7536, 7537, 7539 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 7526 | 7521, 7522, 7527, 7528, 7529, 7530, 7531, 7532, 7533, 7534, 7535, 7536, 7537, 7539 |
...
|------|------|--------|-----------|-----|--------|
| 7521 | Sort | 1078.29 | 1080.15 | 0.2% | pattern |
| 7523 | Gather Merge | 1078.27 | 1124.35 | 4.3% | operator |
| 7524 | Aggregate | 1071.84 | 1019.65 | 4.9% | operator |
| 7525 | Sort | 1071.59 | 1073.13 | 0.1% | operator |
| 7526 | Hash Join | 1071.12 | 1080.65 | 0.9% | pattern |
| 7528 | Hash Join | 214.29 | 259.80 | 21.2% | pattern |
| 7538 | Index Scan | 0.07 | -0.03 | 133.5% | operator |
| 7540 | Seq Scan | 1.75 | 10.62 | 508.4% | operator |
| 7531 | Hash Join | 34.68 | 84.97 | 145.0% | pattern |
| 7534 | Hash Join | 0.20 | 11.62 | 5766.6% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 7534 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 7521, 7522, 7526, 7527, 7528, 7529, 7530, 7531, 7532, 7533, 7535, 7536, 7537, 7539
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
### Step 2: Node 7531 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 7521, 7522, 7526, 7527, 7528, 7529, 7530, 7532, 7533, 7534, 7535, 7536, 7537, 7539
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=12500
  - HashJoin_nt1=62500
...
### Step 3: Node 7528 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 7521, 7522, 7526, 7527, 7529, 7530, 7531, 7532, 7533, 7534, 7535, 7536, 7537, 7539
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14884
  - HashJoin_nt1=74418
...
### Step 4: Node 7538 (Index Scan) - LEAF
...
### Step 5: Node 7540 (Seq Scan) - LEAF
...
### Step 6: Node 7526 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 7521, 7522, 7527, 7528, 7529, 7530, 7531, 7532, 7533, 7534, 7535, 7536, 7537, 7539
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=2382
  - HashJoin_nt1=59546
...
### Step 10: Node 7521 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 7522, 7526, 7527, 7528, 7529, 7530, 7531, 7532, 7533, 7534, 7535, 7536, 7537, 7539
- **Input Features:**
