...
```
Node 31437 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 31437 | 31438, 31439, 31440, 31441, 31442 |
...
|------|------|--------|-----------|-----|--------|
| 31437 | Aggregate | 840.97 | 841.24 | 0.0% | pattern |
...
- **Consumes:** Nodes 31438, 31439, 31440, 31441, 31442
- **Input Features:**
