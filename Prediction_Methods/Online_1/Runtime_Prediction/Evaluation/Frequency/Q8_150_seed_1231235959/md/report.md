...
```
Node 14466 (Aggregate) - ROOT
  Node 14467 (Gather Merge)
    Node 14468 (Sort)
...
|------|------|--------|-----------|-----|--------|
| 14466 | Aggregate | 1209.69 | 1195.15 | 1.2% | operator |
| 14467 | Gather Merge | 1209.24 | 1123.86 | 7.1% | operator |
...
| 14471 | Hash Join | 1200.04 | 1027.31 | 14.4% | operator |
...
| 14473 | Hash Join | 210.45 | 226.27 | 7.5% | operator |
...
| 14475 | Hash | 33.10 | 18.06 | 45.4% | operator |
| 14476 | Hash Join | 32.44 | 67.97 | 109.6% | operator |
| 14477 | Seq Scan | 30.97 | 24.87 | 19.7% | operator |
| 14478 | Hash | 0.16 | 17.93 | 11175.3% | operator |
| 14479 | Hash Join | 0.16 | 151.58 | 97068.9% | operator |
...
### Step 5: Node 14477 (Seq Scan) - LEAF
...
### Step 8: Node 14474 (Seq Scan) - LEAF
...
### Step 11: Node 14483 (Index Scan) - LEAF
...
### Step 12: Node 14485 (Seq Scan) - LEAF
...
### Step 13: Node 14472 (Nested Loop)
...
### Step 16: Node 14486 (Index Scan) - LEAF
...
### Step 17: Node 14488 (Seq Scan) - LEAF
...
### Step 18: Node 14470 (Nested Loop)
...
### Step 22: Node 14467 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1086.9220
  - st2=0.0000
  - startup_cost=71551.3300
  - total_cost=71837.8700
- **Output:** st=1120.78, rt=1123.86

### Step 23: Node 14466 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=71551.3300
  - total_cost=71934.4300
- **Output:** st=1187.17, rt=1195.15
