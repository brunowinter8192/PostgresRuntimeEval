...
```
Node 32221 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 32221 | 32222, 32223, 32224, 32225, 32226 |
...
|------|------|--------|-----------|-----|--------|
| 32221 | Aggregate | 836.44 | 841.25 | 0.6% | pattern |
...
- **Consumes:** Nodes 32222, 32223, 32224, 32225, 32226
- **Input Features:**
