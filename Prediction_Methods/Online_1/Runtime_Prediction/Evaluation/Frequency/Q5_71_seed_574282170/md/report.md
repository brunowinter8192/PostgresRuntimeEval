...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 9274 | 9261, 9262, 9268, 9269, 9270, 9271, 9272, 9273, 9275, 9276, 9277 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 9268 | 9261, 9262, 9269, 9270, 9271, 9272, 9273, 9274, 9275, 9276, 9277 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 9271 | 9261, 9262, 9268, 9269, 9270, 9272, 9273, 9274, 9275, 9276, 9277 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 9261 | 9262, 9268, 9269, 9270, 9271, 9272, 9273, 9274, 9275, 9276, 9277 |
...
| 9265 | Sort | 1058.70 | 1074.67 | 1.5% | operator |
| 9266 | Hash Join | 1058.19 | 1107.39 | 4.6% | operator |
| 9267 | Nested Loop | 1047.16 | 1102.68 | 5.3% | operator |
...
- **Consumes:** Nodes 9261, 9262, 9268, 9269, 9270, 9271, 9272, 9273, 9275, 9276, 9277
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
- **Consumes:** Nodes 9261, 9262, 9268, 9269, 9270, 9272, 9273, 9274, 9275, 9276, 9277
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=12500
  - HashJoin_nt1=62500
...
- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 9261, 9262, 9269, 9270, 9271, 9272, 9273, 9274, 9275, 9276, 9277
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14646
  - HashJoin_nt1=73231
...
- **Output:** st=42.84, rt=1102.68

### Step 7: Node 9279 (Hash)
...
- **Output:** st=49.59, rt=1107.39

### Step 9: Node 9265 (Sort)
...
- **Output:** st=1073.74, rt=1074.67

### Step 10: Node 9264 (Aggregate)
...
- **Output:** st=1017.97, rt=1020.00

### Step 11: Node 9263 (Gather Merge)
...
### Step 12: Node 9261 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 9262, 9268, 9269, 9270, 9271, 9272, 9273, 9274, 9275, 9276, 9277
- **Input Features:**
