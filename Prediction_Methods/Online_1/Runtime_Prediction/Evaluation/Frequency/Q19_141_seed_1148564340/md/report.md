...
```
Node 31535 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 31535 | 31536, 31537, 31538, 31539, 31540 |
...
|------|------|--------|-----------|-----|--------|
| 31535 | Aggregate | 864.06 | 841.24 | 2.6% | pattern |
...
- **Consumes:** Nodes 31536, 31537, 31538, 31539, 31540
- **Input Features:**
