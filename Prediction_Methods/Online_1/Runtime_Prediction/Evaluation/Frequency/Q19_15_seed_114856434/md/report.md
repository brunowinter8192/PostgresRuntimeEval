...
```
Node 31612 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 31612 | 31613, 31614, 31615, 31616, 31617 |
...
|------|------|--------|-----------|-----|--------|
| 31612 | Aggregate | 853.93 | 841.26 | 1.5% | pattern |
...
- **Consumes:** Nodes 31613, 31614, 31615, 31616, 31617
- **Input Features:**
