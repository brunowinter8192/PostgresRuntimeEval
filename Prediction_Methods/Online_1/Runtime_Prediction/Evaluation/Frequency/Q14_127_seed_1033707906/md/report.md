...
```
Node 26623 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 26623 | 26624, 26625, 26626, 26627, 26628 |
...
|------|------|--------|-----------|-----|--------|
| 26623 | Aggregate | 862.25 | 825.95 | 4.2% | pattern |
...
- **Consumes:** Nodes 26624, 26625, 26626, 26627, 26628
- **Input Features:**
