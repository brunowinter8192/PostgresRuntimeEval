    ...
    Node 16870 (Gather) [consumed]
      Node 16871 (Aggregate) [consumed]
        Node 16872 (Hash Join) [consumed]
          ...
          Node 16874 (Hash) [PATTERN: c0a8d3de]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather -> | 8951754f | 16868 | 16869, 16870, 16871, 16872, 16874, 16875, 16876, 16877, 16879, 16880, 16883 |
| Hash -> Hash Join -> [Seq Scan | c0a8d3de | 16874 | 16868, 16869, 16870, 16871, 16872, 16875, 16876, 16877, 16879, 16880, 16883 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 16879 | 16868, 16869, 16870, 16871, 16872, 16874, 16875, 16876, 16877, 16880, 16883 |
...
| 16874 | Hash | 1039.26 | 44.21 | 95.7% | pattern |
...
- **Consumes:** Nodes 16868, 16869, 16870, 16871, 16872, 16874, 16875, 16876, 16877, 16880, 16883
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=22712
  - HashJoin_nt1=22712
...
### Step 8: Node 16873 (Seq Scan) - LEAF
...
### Step 9: Node 16874 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** c0a8d3de (Hash -> Hash Join -> [Seq Scan (Outer), Hash (Inner)] (Outer))
- **Consumes:** Nodes 16868, 16869, 16870, 16871, 16872, 16875, 16876, 16877, 16879, 16880, 16883
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 16868 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 8951754f (Sort -> Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 16869, 16870, 16871, 16872, 16874, 16875, 16876, 16877, 16879, 16880, 16883
- **Input Features:**
