...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19838 | 19839, 19840, 19841, 19843, 19844, 19847 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 19843 | 19838, 19839, 19840, 19841, 19844, 19847 |
...
|------|------|--------|-----------|-----|--------|
| 19838 | Limit | 1131.32 | 1154.80 | 2.1% | pattern |
| 19842 | Hash Join | 1091.05 | 1087.34 | 0.3% | operator |
...
- **Consumes:** Nodes 19838, 19839, 19840, 19841, 19844, 19847
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18186
  - HashJoin_nt1=18186
...
### Step 8: Node 19838 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19839, 19840, 19841, 19843, 19844, 19847
- **Input Features:**
