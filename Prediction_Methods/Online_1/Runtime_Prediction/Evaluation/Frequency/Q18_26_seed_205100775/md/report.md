...
**Test Query:** Q18_26_seed_205100775
...
```
Node 29908 (Limit) [PATTERN: 6ce7e974] - ROOT
  Node 29909 (Sort) [consumed]
    Node 29910 (Aggregate) [consumed]
      Node 29911 (Gather Merge) [consumed]
        Node 29912 (Incremental Sort) [consumed]
          Node 29913 (Nested Loop)
            Node 29914 (Merge Join)
              Node 29915 (Sort)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 6ce7e974 | 29908 | 29909, 29910, 29911, 29912, 29916, 29917, 29918 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29916 | 29908, 29909, 29910, 29911, 29912, 29917, 29918 |
...
|------|------|--------|-----------|-----|--------|
| 29908 | Limit | 3021.51 | 3050.24 | 1.0% | pattern |
| 29913 | Nested Loop | 2868.05 | 1400.02 | 51.2% | operator |
| 29914 | Merge Join | 2868.00 | 2910.61 | 1.5% | operator |
| 29923 | Index Scan | 0.02 | 0.07 | 288.2% | operator |
| 29915 | Sort | 2818.31 | 1098.13 | 61.0% | operator |
| 29921 | Sort | 64.04 | 1014.60 | 1484.4% | operator |
| 29916 | Hash Join | 2818.29 | 688.83 | 75.6% | pattern |
| 29922 | Seq Scan | 53.18 | 25.47 | 52.1% | operator |
| 29919 | Aggregate | 2590.52 | 1300.21 | 49.8% | operator |
| 29920 | Index Scan | 2121.08 | 219.99 | 89.6% | operator |
...
- **Consumes:** Nodes 29908, 29909, 29910, 29911, 29912, 29917, 29918
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29922 (Seq Scan) - LEAF
...
### Step 8: Node 29923 (Index Scan) - LEAF
...
### Step 10: Node 29908 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 6ce7e974 (Limit -> Sort -> Aggregate -> Gather Merge -> Incremental Sort (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 29909, 29910, 29911, 29912, 29916, 29917, 29918
- **Input Features:**
