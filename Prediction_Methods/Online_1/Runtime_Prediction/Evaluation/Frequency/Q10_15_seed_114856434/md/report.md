    ...
    Node 20100 (Aggregate) [consumed]
      Node 20101 (Gather) [consumed]
        Node 20102 (Hash Join)
          Node 20103 (Hash Join)
            Node 20104 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20098 | 20099, 20100, 20101 |
...
| 20102 | Hash Join | 1101.12 | 1062.30 | 3.5% | operator |
| 20103 | Hash Join | 1098.24 | 1044.48 | 4.9% | operator |
| 20109 | Hash | 0.01 | 14.54 | 96831.4% | operator |
| 20104 | Nested Loop | 1052.15 | 1098.06 | 4.4% | operator |
| 20107 | Hash | 34.96 | 45.64 | 30.5% | operator |
...
### Step 6: Node 20110 (Seq Scan) - LEAF
...
### Step 10: Node 20098 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20099, 20100, 20101
- **Input Features:**
