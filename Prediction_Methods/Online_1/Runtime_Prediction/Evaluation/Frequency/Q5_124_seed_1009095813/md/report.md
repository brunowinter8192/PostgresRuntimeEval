...
Node 7421 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 7422 (Aggregate) [consumed]
    Node 7423 (Gather Merge)
      Node 7424 (Aggregate)
        Node 7425 (Sort)
          Node 7426 (Hash Join) [PATTERN: 2e0f44ef]
            Node 7427 (Nested Loop) [consumed]
              Node 7428 (Hash Join) [PATTERN: 895c6e8c]
                Node 7429 (Seq Scan) [consumed] - LEAF
                Node 7430 (Hash) [consumed]
                  Node 7431 (Hash Join) [PATTERN: 895c6e8c]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 7434 | 7421, 7422, 7426, 7427, 7428, 7429, 7430, 7431, 7432, 7433, 7435, 7436, 7437, 7439 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 7428 | 7421, 7422, 7426, 7427, 7429, 7430, 7431, 7432, 7433, 7434, 7435, 7436, 7437, 7439 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 7431 | 7421, 7422, 7426, 7427, 7428, 7429, 7430, 7432, 7433, 7434, 7435, 7436, 7437, 7439 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 7421 | 7422, 7426, 7427, 7428, 7429, 7430, 7431, 7432, 7433, 7434, 7435, 7436, 7437, 7439 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 7426 | 7421, 7422, 7427, 7428, 7429, 7430, 7431, 7432, 7433, 7434, 7435, 7436, 7437, 7439 |
...
| 7424 | Aggregate | 1040.07 | 1019.75 | 2.0% | operator |
| 7425 | Sort | 1039.82 | 1073.09 | 3.2% | operator |
| 7426 | Hash Join | 1039.36 | 1080.14 | 3.9% | pattern |
| 7428 | Hash Join | 209.59 | 259.84 | 24.0% | pattern |
| 7438 | Index Scan | 0.07 | -0.03 | 134.9% | operator |
| 7440 | Seq Scan | 2.82 | 10.62 | 276.1% | operator |
| 7431 | Hash Join | 30.75 | 84.97 | 176.3% | pattern |
...
- **Consumes:** Nodes 7421, 7422, 7426, 7427, 7428, 7429, 7430, 7431, 7432, 7433, 7435, 7436, 7437, 7439
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
### Step 2: Node 7431 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 7421, 7422, 7426, 7427, 7428, 7429, 7430, 7432, 7433, 7434, 7435, 7436, 7437, 7439
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=12500
  - HashJoin_nt1=62500
...
### Step 3: Node 7428 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 7421, 7422, 7426, 7427, 7429, 7430, 7431, 7432, 7433, 7434, 7435, 7436, 7437, 7439
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14646
  - HashJoin_nt1=73231
...
### Step 4: Node 7438 (Index Scan) - LEAF
...
### Step 5: Node 7440 (Seq Scan) - LEAF
...
### Step 6: Node 7426 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 7421, 7422, 7427, 7428, 7429, 7430, 7431, 7432, 7433, 7434, 7435, 7436, 7437, 7439
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=2344
  - HashJoin_nt1=58597
...
### Step 10: Node 7421 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 7422, 7426, 7427, 7428, 7429, 7430, 7431, 7432, 7433, 7434, 7435, 7436, 7437, 7439
- **Input Features:**
