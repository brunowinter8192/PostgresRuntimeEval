...
```
Node 14788 (Aggregate) - ROOT
  Node 14789 (Gather Merge)
    Node 14790 (Sort)
          ...
          Node 14793 (Hash Join)
            Node 14794 (Nested Loop)
              Node 14795 (Hash Join)
                ...
                Node 14797 (Hash)
                  Node 14798 (Hash Join)
                    Node 14799 (Seq Scan) - LEAF
                    Node 14800 (Hash)
                      Node 14801 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 14788 | Aggregate | 1210.34 | 1194.56 | 1.3% | operator |
| 14789 | Gather Merge | 1209.87 | 1123.91 | 7.1% | operator |
...
| 14793 | Hash Join | 1199.40 | 1027.31 | 14.3% | operator |
...
| 14795 | Hash Join | 212.20 | 226.27 | 6.6% | operator |
...
| 14797 | Hash | 33.67 | 18.06 | 46.4% | operator |
| 14798 | Hash Join | 32.96 | 67.97 | 106.2% | operator |
| 14799 | Seq Scan | 30.97 | 24.87 | 19.7% | operator |
| 14800 | Hash | 0.23 | 17.93 | 7728.7% | operator |
| 14801 | Hash Join | 0.23 | 151.58 | 67270.4% | operator |
...
### Step 5: Node 14799 (Seq Scan) - LEAF
...
### Step 8: Node 14796 (Seq Scan) - LEAF
...
### Step 11: Node 14805 (Index Scan) - LEAF
...
### Step 12: Node 14807 (Seq Scan) - LEAF
...
### Step 13: Node 14794 (Nested Loop)
...
### Step 16: Node 14808 (Index Scan) - LEAF
...
### Step 17: Node 14810 (Seq Scan) - LEAF
...
### Step 18: Node 14792 (Nested Loop)
...
### Step 22: Node 14789 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1086.9222
  - st2=0.0000
  - startup_cost=71552.4300
  - total_cost=71839.8000
- **Output:** st=1120.83, rt=1123.91

### Step 23: Node 14788 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=71552.4300
  - total_cost=71936.5000
- **Output:** st=1186.83, rt=1194.56
