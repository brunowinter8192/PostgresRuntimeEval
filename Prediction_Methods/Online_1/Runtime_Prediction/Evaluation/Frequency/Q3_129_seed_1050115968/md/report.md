    ...
    Node 4663 (Aggregate) [consumed]
      Node 4664 (Gather) [consumed]
        Node 4665 (Nested Loop)
          Node 4666 (Hash Join) [PATTERN: f4cb205a]
            Node 4667 (Seq Scan) [consumed] - LEAF
            Node 4668 (Hash) [consumed]
              Node 4669 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4661 | 4662, 4663, 4664, 4666, 4667, 4668, 4669 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 4666 | 4661, 4662, 4663, 4664, 4667, 4668, 4669 |
...
| 4665 | Nested Loop | 1265.16 | 1121.77 | 11.3% | operator |
| 4666 | Hash Join | 226.36 | 219.51 | 3.0% | pattern |
| 4670 | Index Scan | 0.03 | -0.02 | 166.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4666 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 4661, 4662, 4663, 4664, 4667, 4668, 4669
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46842
  - HashJoin_nt1=233109
...
- **Output:** st=30.40, rt=219.51

### Step 2: Node 4670 (Index Scan) - LEAF
...
- **Output:** st=30.13, rt=1121.77

### Step 4: Node 4661 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4662, 4663, 4664, 4666, 4667, 4668, 4669
- **Input Features:**
