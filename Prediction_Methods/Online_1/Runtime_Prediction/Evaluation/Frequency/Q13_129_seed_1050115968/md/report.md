...
```
Node 25587 (Sort) [PATTERN: 35ffb644] - ROOT
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Aggregate | 35ffb644 | 25587 | 25588, 25589, 25590, 25591, 25592 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25590 | 25587, 25588, 25589, 25591, 25592 |
...
| 25590 | Hash Join | 688.50 | 598.51 | 13.1% | pattern |
| 25593 | Index Only Scan | 10.40 | 10.09 | 3.0% | operator |
...
- **Consumes:** Nodes 25587, 25588, 25589, 25591, 25592
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1469940
...
### Step 3: Node 25587 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 35ffb644 (Sort -> Aggregate -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 25588, 25589, 25590, 25591, 25592
- **Input Features:**
