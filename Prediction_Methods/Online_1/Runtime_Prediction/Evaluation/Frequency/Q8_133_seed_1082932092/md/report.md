...
```
Node 14029 (Aggregate) - ROOT
  Node 14030 (Gather Merge)
    Node 14031 (Sort)
...
|------|------|--------|-----------|-----|--------|
| 14029 | Aggregate | 1210.12 | 1193.12 | 1.4% | operator |
| 14030 | Gather Merge | 1209.66 | 1123.88 | 7.1% | operator |
| 14031 | Sort | 1204.60 | 1087.88 | 9.7% | operator |
| 14032 | Hash Join | 1204.37 | 1055.47 | 12.4% | operator |
| 14033 | Nested Loop | 1204.07 | 1105.66 | 8.2% | operator |
| 14050 | Hash | 0.01 | 14.54 | 111744.0% | operator |
| 14034 | Hash Join | 1200.42 | 1027.31 | 14.4% | operator |
...
| 14036 | Hash Join | 212.95 | 226.27 | 6.3% | operator |
...
| 14038 | Hash | 36.88 | 18.06 | 51.0% | operator |
| 14039 | Hash Join | 36.25 | 67.97 | 87.5% | operator |
| 14040 | Seq Scan | 34.70 | 24.87 | 28.3% | operator |
| 14041 | Hash | 0.20 | 17.93 | 8688.1% | operator |
| 14042 | Hash Join | 0.20 | 151.58 | 75314.6% | operator |
...
### Step 5: Node 14040 (Seq Scan) - LEAF
...
### Step 8: Node 14037 (Seq Scan) - LEAF
...
### Step 11: Node 14046 (Index Scan) - LEAF
...
### Step 12: Node 14048 (Seq Scan) - LEAF
...
### Step 13: Node 14035 (Nested Loop)
...
### Step 16: Node 14049 (Index Scan) - LEAF
...
### Step 17: Node 14051 (Seq Scan) - LEAF
...
### Step 18: Node 14033 (Nested Loop)
...
### Step 22: Node 14030 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1086.9226
  - st2=0.0000
  - startup_cost=71554.3100
  - total_cost=71843.6800
- **Output:** st=1120.80, rt=1123.88

### Step 23: Node 14029 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=71554.3100
  - total_cost=71940.7200
- **Output:** st=1185.99, rt=1193.12
