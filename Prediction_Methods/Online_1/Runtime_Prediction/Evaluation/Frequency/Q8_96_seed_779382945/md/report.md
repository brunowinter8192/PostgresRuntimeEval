...
```
Node 16536 (Aggregate) - ROOT
  Node 16537 (Gather Merge)
    Node 16538 (Sort)
          ...
          Node 16541 (Hash Join)
            Node 16542 (Nested Loop)
              Node 16543 (Hash Join)
                ...
                Node 16545 (Hash)
                  Node 16546 (Hash Join)
                    Node 16547 (Seq Scan) - LEAF
                    Node 16548 (Hash)
                      Node 16549 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 16536 | Aggregate | 1237.33 | 1190.26 | 3.8% | operator |
| 16537 | Gather Merge | 1236.94 | 1123.88 | 9.1% | operator |
...
| 16541 | Hash Join | 1228.08 | 1027.31 | 16.3% | operator |
...
| 16543 | Hash Join | 212.82 | 226.27 | 6.3% | operator |
...
| 16545 | Hash | 35.37 | 18.06 | 48.9% | operator |
| 16546 | Hash Join | 34.75 | 67.97 | 95.6% | operator |
| 16547 | Seq Scan | 33.30 | 24.87 | 25.3% | operator |
| 16548 | Hash | 0.10 | 17.93 | 17650.2% | operator |
| 16549 | Hash Join | 0.10 | 151.58 | 156171.6% | operator |
...
### Step 5: Node 16547 (Seq Scan) - LEAF
...
### Step 8: Node 16544 (Seq Scan) - LEAF
...
### Step 11: Node 16553 (Index Scan) - LEAF
...
### Step 12: Node 16555 (Seq Scan) - LEAF
...
### Step 13: Node 16542 (Nested Loop)
...
### Step 16: Node 16556 (Index Scan) - LEAF
...
### Step 17: Node 16558 (Seq Scan) - LEAF
...
### Step 18: Node 16540 (Nested Loop)
...
### Step 22: Node 16537 (Gather Merge)
...
### Step 23: Node 16536 (Aggregate) - ROOT
