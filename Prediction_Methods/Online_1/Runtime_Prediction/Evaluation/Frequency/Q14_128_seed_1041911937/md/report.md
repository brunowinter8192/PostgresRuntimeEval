...
```
Node 26630 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 26630 | 26631, 26632, 26633, 26634, 26635 |
...
|------|------|--------|-----------|-----|--------|
| 26630 | Aggregate | 823.66 | 825.95 | 0.3% | pattern |
...
- **Consumes:** Nodes 26631, 26632, 26633, 26634, 26635
- **Input Features:**
