...
```
Node 5984 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 5985 (Gather Merge) [consumed]
    Node 5986 (Sort) [PATTERN: 1d35fb97]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 5986 | 5984, 5985, 5987 |
| Aggregate -> Gather Merge (Out | 2724c080 | 5984 | 5985, 5986, 5987 |
...
|------|------|--------|-----------|-----|--------|
| 5984 | Aggregate | 1040.21 | 1078.88 | 3.7% | pattern |
| 5986 | Sort | 1035.28 | 1055.54 | 2.0% | pattern |
...
### Step 4: Node 5986 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 5984, 5985, 5987
- **Input Features:**
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=66325.8300
  - Sort_total_cost=66325.8400
- **Output:** st=1054.38, rt=1055.54

### Step 5: Node 5984 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 5985, 5986, 5987
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=5
  - Aggregate_nt1=15
