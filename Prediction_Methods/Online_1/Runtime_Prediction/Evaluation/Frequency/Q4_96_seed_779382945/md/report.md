...
```
Node 6866 (Aggregate) [PATTERN: 2724c080] - ROOT
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 6868 | 6866, 6867, 6869 |
| Aggregate -> Gather Merge (Out | 2724c080 | 6866 | 6867, 6868, 6869 |
...
|------|------|--------|-----------|-----|--------|
| 6866 | Aggregate | 1077.77 | 1078.93 | 0.1% | pattern |
...
### Step 5: Node 6866 (Aggregate) - PATTERN ROOT
