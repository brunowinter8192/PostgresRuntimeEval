...
```
Node 7141 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 7142 (Aggregate) [consumed]
    Node 7143 (Gather Merge)
      Node 7144 (Aggregate)
        Node 7145 (Sort)
          Node 7146 (Hash Join) [PATTERN: 2e0f44ef]
            Node 7147 (Nested Loop) [consumed]
              Node 7148 (Hash Join) [PATTERN: 895c6e8c]
                Node 7149 (Seq Scan) [consumed] - LEAF
                Node 7150 (Hash) [consumed]
                  Node 7151 (Hash Join) [PATTERN: 895c6e8c]
                    Node 7152 (Seq Scan) [consumed] - LEAF
                    Node 7153 (Hash) [consumed]
                      Node 7154 (Hash Join) [PATTERN: f4cb205a]
                        Node 7155 (Seq Scan) [consumed] - LEAF
                        Node 7156 (Hash) [consumed]
                          Node 7157 (Seq Scan) [consumed] - LEAF
              Node 7158 (Index Scan) - LEAF
            Node 7159 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 7154 | 7141, 7142, 7146, 7147, 7148, 7149, 7150, 7151, 7152, 7153, 7155, 7156, 7157, 7159 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 7148 | 7141, 7142, 7146, 7147, 7149, 7150, 7151, 7152, 7153, 7154, 7155, 7156, 7157, 7159 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 7151 | 7141, 7142, 7146, 7147, 7148, 7149, 7150, 7152, 7153, 7154, 7155, 7156, 7157, 7159 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 7141 | 7142, 7146, 7147, 7148, 7149, 7150, 7151, 7152, 7153, 7154, 7155, 7156, 7157, 7159 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 7146 | 7141, 7142, 7147, 7148, 7149, 7150, 7151, 7152, 7153, 7154, 7155, 7156, 7157, 7159 |
...
|------|------|--------|-----------|-----|--------|
| 7141 | Sort | 1114.51 | 1080.14 | 3.1% | pattern |
| 7143 | Gather Merge | 1114.49 | 1124.36 | 0.9% | operator |
| 7144 | Aggregate | 1109.87 | 1019.70 | 8.1% | operator |
| 7145 | Sort | 1109.62 | 1073.11 | 3.3% | operator |
| 7146 | Hash Join | 1109.13 | 1080.38 | 2.6% | pattern |
| 7148 | Hash Join | 219.83 | 259.82 | 18.2% | pattern |
| 7158 | Index Scan | 0.08 | -0.03 | 132.6% | operator |
| 7160 | Seq Scan | 2.45 | 10.62 | 332.8% | operator |
| 7151 | Hash Join | 30.70 | 84.97 | 176.7% | pattern |
| 7154 | Hash Join | 0.27 | 11.62 | 4283.3% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 7154 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 7141, 7142, 7146, 7147, 7148, 7149, 7150, 7151, 7152, 7153, 7155, 7156, 7157, 7159
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
### Step 2: Node 7151 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 7141, 7142, 7146, 7147, 7148, 7149, 7150, 7152, 7153, 7154, 7155, 7156, 7157, 7159
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=12500
  - HashJoin_nt1=62500
...
### Step 3: Node 7148 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 7141, 7142, 7146, 7147, 7149, 7150, 7151, 7152, 7153, 7154, 7155, 7156, 7157, 7159
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14756
  - HashJoin_nt1=73782
...
### Step 4: Node 7158 (Index Scan) - LEAF
...
### Step 5: Node 7160 (Seq Scan) - LEAF
...
### Step 6: Node 7146 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 7141, 7142, 7147, 7148, 7149, 7150, 7151, 7152, 7153, 7154, 7155, 7156, 7157, 7159
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=2362
  - HashJoin_nt1=59037
...
### Step 10: Node 7141 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 7142, 7146, 7147, 7148, 7149, 7150, 7151, 7152, 7153, 7154, 7155, 7156, 7157, 7159
- **Input Features:**
