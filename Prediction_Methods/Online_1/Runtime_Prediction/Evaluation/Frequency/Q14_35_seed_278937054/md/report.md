...
```
Node 26966 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 26966 | 26967, 26968, 26969, 26970, 26971 |
...
|------|------|--------|-----------|-----|--------|
| 26966 | Aggregate | 849.78 | 825.95 | 2.8% | pattern |
...
- **Consumes:** Nodes 26967, 26968, 26969, 26970, 26971
- **Input Features:**
