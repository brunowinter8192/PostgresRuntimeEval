...
```
Node 7281 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 7282 (Aggregate) [consumed]
    Node 7283 (Gather Merge)
      Node 7284 (Aggregate)
        Node 7285 (Sort)
          Node 7286 (Hash Join) [PATTERN: 2e0f44ef]
            Node 7287 (Nested Loop) [consumed]
              Node 7288 (Hash Join) [PATTERN: 895c6e8c]
                Node 7289 (Seq Scan) [consumed] - LEAF
                Node 7290 (Hash) [consumed]
                  Node 7291 (Hash Join) [PATTERN: 895c6e8c]
                    Node 7292 (Seq Scan) [consumed] - LEAF
                    Node 7293 (Hash) [consumed]
                      Node 7294 (Hash Join) [PATTERN: f4cb205a]
                        Node 7295 (Seq Scan) [consumed] - LEAF
                        Node 7296 (Hash) [consumed]
                          Node 7297 (Seq Scan) [consumed] - LEAF
              Node 7298 (Index Scan) - LEAF
            Node 7299 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 7294 | 7281, 7282, 7286, 7287, 7288, 7289, 7290, 7291, 7292, 7293, 7295, 7296, 7297, 7299 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 7288 | 7281, 7282, 7286, 7287, 7289, 7290, 7291, 7292, 7293, 7294, 7295, 7296, 7297, 7299 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 7291 | 7281, 7282, 7286, 7287, 7288, 7289, 7290, 7292, 7293, 7294, 7295, 7296, 7297, 7299 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 7281 | 7282, 7286, 7287, 7288, 7289, 7290, 7291, 7292, 7293, 7294, 7295, 7296, 7297, 7299 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 7286 | 7281, 7282, 7287, 7288, 7289, 7290, 7291, 7292, 7293, 7294, 7295, 7296, 7297, 7299 |
...
|------|------|--------|-----------|-----|--------|
| 7281 | Sort | 1057.52 | 1080.12 | 2.1% | pattern |
| 7283 | Gather Merge | 1057.50 | 1124.38 | 6.3% | operator |
| 7284 | Aggregate | 1052.41 | 1019.75 | 3.1% | operator |
| 7285 | Sort | 1052.15 | 1073.09 | 2.0% | operator |
| 7286 | Hash Join | 1051.66 | 1080.14 | 2.7% | pattern |
| 7288 | Hash Join | 215.00 | 259.84 | 20.9% | pattern |
| 7298 | Index Scan | 0.07 | -0.03 | 134.9% | operator |
| 7300 | Seq Scan | 2.20 | 10.62 | 381.9% | operator |
| 7291 | Hash Join | 34.33 | 84.97 | 147.5% | pattern |
| 7294 | Hash Join | 0.06 | 11.62 | 20642.6% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 7294 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 7281, 7282, 7286, 7287, 7288, 7289, 7290, 7291, 7292, 7293, 7295, 7296, 7297, 7299
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
### Step 2: Node 7291 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 7281, 7282, 7286, 7287, 7288, 7289, 7290, 7292, 7293, 7294, 7295, 7296, 7297, 7299
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=12500
  - HashJoin_nt1=62500
...
### Step 3: Node 7288 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 7281, 7282, 7286, 7287, 7289, 7290, 7291, 7292, 7293, 7294, 7295, 7296, 7297, 7299
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14646
  - HashJoin_nt1=73231
...
### Step 4: Node 7298 (Index Scan) - LEAF
...
### Step 5: Node 7300 (Seq Scan) - LEAF
...
### Step 6: Node 7286 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 7281, 7282, 7287, 7288, 7289, 7290, 7291, 7292, 7293, 7294, 7295, 7296, 7297, 7299
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=2344
  - HashJoin_nt1=58597
...
### Step 10: Node 7281 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 7282, 7286, 7287, 7288, 7289, 7290, 7291, 7292, 7293, 7294, 7295, 7296, 7297, 7299
- **Input Features:**
