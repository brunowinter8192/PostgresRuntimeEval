...
```
Node 31752 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31753 (Gather) [consumed]
    Node 31754 (Aggregate) [consumed]
      Node 31755 (Hash Join) [PATTERN: f4cb205a]
        Node 31756 (Seq Scan) [consumed] - LEAF
        Node 31757 (Hash) [consumed]
          Node 31758 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 31755 | 31752, 31753, 31754, 31756, 31757, 31758 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31752 | 31753, 31754, 31755, 31756, 31757, 31758 |
...
|------|------|--------|-----------|-----|--------|
| 31752 | Aggregate | 841.42 | 834.50 | 0.8% | pattern |
| 31755 | Hash Join | 820.45 | 373.83 | 54.4% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31755 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 31752, 31753, 31754, 31756, 31757, 31758
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=23
  - HashJoin_nt1=22461
  ...
  - HashJoin_total_cost=156338.4400
  - Hash_Inner_np=0
  - Hash_Inner_nt=202
  - Hash_Inner_nt1=202
  - Hash_Inner_nt2=0
...
### Step 2: Node 31752 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31753, 31754, 31755, 31756, 31757, 31758
- **Input Features:**
