    ...
    Node 19027 (Gather) [consumed]
      Node 19028 (Aggregate) [consumed]
        Node 19029 (Nested Loop) [consumed]
          Node 19030 (Hash Join) [PATTERN: 895c6e8c]
            Node 19031 (Seq Scan) [consumed] - LEAF
            Node 19032 (Hash) [consumed]
              Node 19033 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 0405d50f | 19026 | 19027, 19028, 19029, 19030, 19031, 19032, 19034, 19035, 19038 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 19030 | 19026, 19027, 19028, 19029, 19031, 19032, 19034, 19035, 19038 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 19034 | 19026, 19027, 19028, 19029, 19030, 19031, 19032, 19035, 19038 |
...
| 19030 | Hash Join | 929.37 | 734.01 | 21.0% | pattern |
| 19042 | Index Scan | 0.00 | -0.04 | 1512.7% | operator |
| 19033 | Hash Join | 181.21 | 820.78 | 352.9% | operator |
...
- **Consumes:** Nodes 19026, 19027, 19028, 19029, 19030, 19031, 19032, 19035, 19038
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18703
  - HashJoin_nt1=18703
...
- **Output:** st=26.46, rt=820.78

### Step 8: Node 19030 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 19026, 19027, 19028, 19029, 19031, 19032, 19034, 19035, 19038
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=67346
...
- **Output:** st=176.18, rt=734.01

### Step 9: Node 19042 (Index Scan) - LEAF
...
### Step 10: Node 19026 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 0405d50f (Aggregate -> Gather -> Aggregate -> Nested Loop (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19027, 19028, 19029, 19030, 19031, 19032, 19034, 19035, 19038
- **Input Features:**
