...
```
Node 29124 (Limit) [PATTERN: 6ce7e974] - ROOT
        ...
        Node 29128 (Incremental Sort) [consumed]
          Node 29129 (Nested Loop)
            Node 29130 (Merge Join)
              Node 29131 (Sort)
                Node 29132 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29133 (Seq Scan) [consumed] - LEAF
                  Node 29134 (Hash) [consumed]
                    Node 29135 (Aggregate)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 6ce7e974 | 29124 | 29125, 29126, 29127, 29128, 29132, 29133, 29134 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29132 | 29124, 29125, 29126, 29127, 29128, 29133, 29134 |
...
| 29131 | Sort | 2841.38 | 1098.13 | 61.4% | operator |
| 29137 | Sort | 63.85 | 1014.60 | 1488.9% | operator |
| 29132 | Hash Join | 2841.37 | 688.83 | 75.8% | pattern |
| 29138 | Seq Scan | 52.94 | 25.47 | 51.9% | operator |
| 29135 | Aggregate | 2615.68 | 1300.21 | 50.3% | operator |
| 29136 | Index Scan | 2128.35 | 219.99 | 89.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29136 (Index Scan) - LEAF
...
### Step 3: Node 29132 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29124, 29125, 29126, 29127, 29128, 29133, 29134
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29138 (Seq Scan) - LEAF
...
### Step 8: Node 29139 (Index Scan) - LEAF
...
### Step 10: Node 29124 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 6ce7e974 (Limit -> Sort -> Aggregate -> Gather Merge -> Incremental Sort (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 29125, 29126, 29127, 29128, 29132, 29133, 29134
- **Input Features:**
