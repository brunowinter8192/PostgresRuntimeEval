...
```
Node 31668 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31669 (Gather) [consumed]
    Node 31670 (Aggregate) [consumed]
      Node 31671 (Hash Join) [PATTERN: f4cb205a]
        Node 31672 (Seq Scan) [consumed] - LEAF
        Node 31673 (Hash) [consumed]
          Node 31674 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 31671 | 31668, 31669, 31670, 31672, 31673, 31674 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31668 | 31669, 31670, 31671, 31672, 31673, 31674 |
...
|------|------|--------|-----------|-----|--------|
| 31668 | Aggregate | 816.91 | 834.50 | 2.2% | pattern |
| 31671 | Hash Join | 797.02 | 373.83 | 53.1% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31671 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 31668, 31669, 31670, 31672, 31673, 31674
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=23
  - HashJoin_nt1=22489
...
### Step 2: Node 31668 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31669, 31670, 31671, 31672, 31673, 31674
- **Input Features:**
