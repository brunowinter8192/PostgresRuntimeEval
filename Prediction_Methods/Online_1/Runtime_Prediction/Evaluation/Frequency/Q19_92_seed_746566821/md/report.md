...
Node 32207 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 32208 (Gather) [consumed]
    Node 32209 (Aggregate) [consumed]
      Node 32210 (Hash Join) [PATTERN: f4cb205a]
        Node 32211 (Seq Scan) [consumed] - LEAF
        Node 32212 (Hash) [consumed]
          Node 32213 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 32210 | 32207, 32208, 32209, 32211, 32212, 32213 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 32207 | 32208, 32209, 32210, 32211, 32212, 32213 |
...
| 32210 | Hash Join | 824.30 | 373.83 | 54.6% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 32210 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 32207, 32208, 32209, 32211, 32212, 32213
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=23
  - HashJoin_nt1=22533
...
### Step 2: Node 32207 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 32208, 32209, 32210, 32211, 32212, 32213
- **Input Features:**
