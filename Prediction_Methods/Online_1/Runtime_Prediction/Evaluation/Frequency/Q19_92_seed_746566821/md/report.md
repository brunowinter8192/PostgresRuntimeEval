...
```
Node 32207 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 32207 | 32208, 32209, 32210, 32211, 32212 |
...
|------|------|--------|-----------|-----|--------|
| 32207 | Aggregate | 851.56 | 841.26 | 1.2% | pattern |
...
- **Consumes:** Nodes 32208, 32209, 32210, 32211, 32212
- **Input Features:**
