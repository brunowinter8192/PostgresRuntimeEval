...
**Test Query:** Q18_128_seed_1041911937
...
```
Node 29300 (Limit) [PATTERN: 6ce7e974] - ROOT
  Node 29301 (Sort) [consumed]
    Node 29302 (Aggregate) [consumed]
      Node 29303 (Gather Merge) [consumed]
        Node 29304 (Incremental Sort) [consumed]
          Node 29305 (Nested Loop)
            Node 29306 (Merge Join)
              Node 29307 (Sort)
                Node 29308 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29309 (Seq Scan) [consumed] - LEAF
                  Node 29310 (Hash) [consumed]
                    Node 29311 (Aggregate)
                      Node 29312 (Index Scan) - LEAF
              Node 29313 (Sort)
                Node 29314 (Seq Scan) - LEAF
            Node 29315 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 6ce7e974 | 29300 | 29301, 29302, 29303, 29304, 29308, 29309, 29310 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29308 | 29300, 29301, 29302, 29303, 29304, 29309, 29310 |
...
|------|------|--------|-----------|-----|--------|
| 29300 | Limit | 3032.24 | 3050.24 | 0.6% | pattern |
| 29305 | Nested Loop | 2902.54 | 1400.02 | 51.8% | operator |
| 29306 | Merge Join | 2902.48 | 2910.61 | 0.3% | operator |
| 29315 | Index Scan | 0.02 | 0.07 | 174.9% | operator |
| 29307 | Sort | 2835.36 | 1098.13 | 61.3% | operator |
| 29313 | Sort | 64.45 | 1014.60 | 1474.1% | operator |
| 29308 | Hash Join | 2835.34 | 688.83 | 75.7% | pattern |
| 29314 | Seq Scan | 52.74 | 25.47 | 51.7% | operator |
| 29311 | Aggregate | 2606.21 | 1300.21 | 50.1% | operator |
| 29312 | Index Scan | 2101.12 | 219.99 | 89.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29312 (Index Scan) - LEAF
...
### Step 3: Node 29308 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29300, 29301, 29302, 29303, 29304, 29309, 29310
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29314 (Seq Scan) - LEAF
...
### Step 8: Node 29315 (Index Scan) - LEAF
...
### Step 10: Node 29300 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 6ce7e974 (Limit -> Sort -> Aggregate -> Gather Merge -> Incremental Sort (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 29301, 29302, 29303, 29304, 29308, 29309, 29310
- **Input Features:**
