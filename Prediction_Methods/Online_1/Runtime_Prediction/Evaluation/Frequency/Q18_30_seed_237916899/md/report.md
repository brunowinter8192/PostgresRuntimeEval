...
**Test Query:** Q18_30_seed_237916899
...
```
Node 29988 (Limit) [PATTERN: 6ce7e974] - ROOT
  Node 29989 (Sort) [consumed]
    Node 29990 (Aggregate) [consumed]
      Node 29991 (Gather Merge) [consumed]
        Node 29992 (Incremental Sort) [consumed]
          Node 29993 (Nested Loop)
            Node 29994 (Merge Join)
              Node 29995 (Sort)
                Node 29996 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29997 (Seq Scan) [consumed] - LEAF
                  Node 29998 (Hash) [consumed]
                    Node 29999 (Aggregate)
                      Node 30000 (Index Scan) - LEAF
              Node 30001 (Sort)
                Node 30002 (Seq Scan) - LEAF
            Node 30003 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 6ce7e974 | 29988 | 29989, 29990, 29991, 29992, 29996, 29997, 29998 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29996 | 29988, 29989, 29990, 29991, 29992, 29997, 29998 |
...
|------|------|--------|-----------|-----|--------|
| 29988 | Limit | 3042.97 | 3050.24 | 0.2% | pattern |
| 29993 | Nested Loop | 2891.65 | 1400.02 | 51.6% | operator |
| 29994 | Merge Join | 2891.60 | 2910.61 | 0.7% | operator |
| 30003 | Index Scan | 0.02 | 0.07 | 247.3% | operator |
| 29995 | Sort | 2840.49 | 1098.13 | 61.3% | operator |
| 30001 | Sort | 65.96 | 1014.60 | 1438.2% | operator |
| 29996 | Hash Join | 2840.48 | 688.83 | 75.7% | pattern |
| 30002 | Seq Scan | 54.67 | 25.47 | 53.4% | operator |
| 29999 | Aggregate | 2608.79 | 1300.21 | 50.2% | operator |
| 30000 | Index Scan | 2120.14 | 219.99 | 89.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30000 (Index Scan) - LEAF
...
### Step 3: Node 29996 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29988, 29989, 29990, 29991, 29992, 29997, 29998
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30002 (Seq Scan) - LEAF
...
### Step 8: Node 30003 (Index Scan) - LEAF
...
### Step 10: Node 29988 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 6ce7e974 (Limit -> Sort -> Aggregate -> Gather Merge -> Incremental Sort (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 29989, 29990, 29991, 29992, 29996, 29997, 29998
- **Input Features:**
