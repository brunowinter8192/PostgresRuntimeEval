...
**Test Query:** Q12_59_seed_475833798
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge (Out | 2724c080 | 25048 | 25049, 25052, 25053, 25054 |
| Nested Loop -> [Seq Scan (Oute | c53c4396 | 25052 | 25048, 25049, 25053, 25054 |
...
|------|------|--------|-----------|-----|--------|
| 25048 | Aggregate | 1002.36 | 1027.05 | 2.5% | pattern |
| 25050 | Aggregate | 983.24 | 940.64 | 4.3% | operator |
| 25051 | Sort | 982.61 | 1050.80 | 6.9% | operator |
| 25052 | Nested Loop | 981.62 | 976.04 | 0.6% | pattern |
...
- **Consumes:** Nodes 25048, 25049, 25053, 25054
- **Input Features:**
  ...
  - NestedLoop_total_cost=147171.3100
...
- **Output:** st=10.43, rt=976.04

### Step 2: Node 25051 (Sort)
...
### Step 4: Node 25048 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 25049, 25052, 25053, 25054
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=7
  - Aggregate_nt1=35
  ...
  - Aggregate_startup_cost=148532.0600
  - Aggregate_total_cost=148652.1400
  ...
  - GatherMerge_Outer_startup_cost=148532.0600
  - GatherMerge_Outer_total_cost=148651.8100
