...
Node 27344 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27345 (Gather) [consumed]
    Node 27346 (Aggregate) [consumed]
      Node 27347 (Hash Join) [PATTERN: f4cb205a]
        Node 27348 (Seq Scan) [consumed] - LEAF
        Node 27349 (Hash) [consumed]
          Node 27350 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 27347 | 27344, 27345, 27346, 27348, 27349, 27350 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27344 | 27345, 27346, 27347, 27348, 27349, 27350 |
...
| 27347 | Hash Join | 801.41 | 397.38 | 50.4% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27347 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 27344, 27345, 27346, 27348, 27349, 27350
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=13479
  - HashJoin_nt1=13479
...
### Step 2: Node 27344 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27345, 27346, 27347, 27348, 27349, 27350
- **Input Features:**
