...
**Test Query:** Q18_35_seed_278937054
...
```
Node 30068 (Limit) [PATTERN: 6ce7e974] - ROOT
  Node 30069 (Sort) [consumed]
    Node 30070 (Aggregate) [consumed]
      Node 30071 (Gather Merge) [consumed]
        Node 30072 (Incremental Sort) [consumed]
          Node 30073 (Nested Loop)
            Node 30074 (Merge Join)
              Node 30075 (Sort)
                Node 30076 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30077 (Seq Scan) [consumed] - LEAF
                  Node 30078 (Hash) [consumed]
                    Node 30079 (Aggregate)
                      Node 30080 (Index Scan) - LEAF
              Node 30081 (Sort)
                Node 30082 (Seq Scan) - LEAF
            Node 30083 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 6ce7e974 | 30068 | 30069, 30070, 30071, 30072, 30076, 30077, 30078 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30076 | 30068, 30069, 30070, 30071, 30072, 30077, 30078 |
...
|------|------|--------|-----------|-----|--------|
| 30068 | Limit | 3022.57 | 3050.24 | 0.9% | pattern |
| 30073 | Nested Loop | 2887.62 | 1400.02 | 51.5% | operator |
| 30074 | Merge Join | 2887.55 | 2910.61 | 0.8% | operator |
| 30083 | Index Scan | 0.02 | 0.07 | 186.9% | operator |
| 30075 | Sort | 2813.63 | 1098.13 | 61.0% | operator |
| 30081 | Sort | 70.70 | 1014.60 | 1335.2% | operator |
| 30076 | Hash Join | 2813.62 | 688.83 | 75.5% | pattern |
| 30082 | Seq Scan | 57.97 | 25.47 | 56.1% | operator |
| 30079 | Aggregate | 2588.55 | 1300.21 | 49.8% | operator |
| 30080 | Index Scan | 2111.19 | 219.99 | 89.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30080 (Index Scan) - LEAF
...
### Step 3: Node 30076 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30068, 30069, 30070, 30071, 30072, 30077, 30078
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30082 (Seq Scan) - LEAF
...
### Step 8: Node 30083 (Index Scan) - LEAF
...
### Step 10: Node 30068 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 6ce7e974 (Limit -> Sort -> Aggregate -> Gather Merge -> Incremental Sort (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 30069, 30070, 30071, 30072, 30076, 30077, 30078
- **Input Features:**
