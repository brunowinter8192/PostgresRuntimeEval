...
```
Node 14765 (Aggregate) - ROOT
  Node 14766 (Gather Merge)
    Node 14767 (Sort)
...
|------|------|--------|-----------|-----|--------|
| 14765 | Aggregate | 1221.97 | 1191.95 | 2.5% | operator |
| 14766 | Gather Merge | 1221.53 | 1123.91 | 8.0% | operator |
...
| 14770 | Hash Join | 1210.95 | 1027.31 | 15.2% | operator |
...
| 14772 | Hash Join | 209.83 | 226.27 | 7.8% | operator |
...
| 14774 | Hash | 36.62 | 18.06 | 50.7% | operator |
| 14775 | Hash Join | 35.73 | 67.97 | 90.2% | operator |
| 14776 | Seq Scan | 34.20 | 24.87 | 27.3% | operator |
| 14777 | Hash | 0.15 | 17.93 | 11541.4% | operator |
| 14778 | Hash Join | 0.15 | 151.58 | 101633.8% | operator |
...
### Step 5: Node 14776 (Seq Scan) - LEAF
...
### Step 8: Node 14773 (Seq Scan) - LEAF
...
### Step 11: Node 14782 (Index Scan) - LEAF
...
### Step 12: Node 14784 (Seq Scan) - LEAF
...
### Step 13: Node 14771 (Nested Loop)
...
### Step 16: Node 14785 (Index Scan) - LEAF
...
### Step 17: Node 14787 (Seq Scan) - LEAF
...
### Step 18: Node 14769 (Nested Loop)
...
### Step 22: Node 14766 (Gather Merge)
...
### Step 23: Node 14765 (Aggregate) - ROOT
