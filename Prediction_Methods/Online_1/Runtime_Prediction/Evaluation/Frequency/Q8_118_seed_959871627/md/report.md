...
```
Node 13638 (Aggregate) - ROOT
  Node 13639 (Gather Merge)
    Node 13640 (Sort)
...
|------|------|--------|-----------|-----|--------|
| 13638 | Aggregate | 1245.30 | 1194.39 | 4.1% | operator |
| 13639 | Gather Merge | 1244.86 | 1123.87 | 9.7% | operator |
...
| 13643 | Hash Join | 1234.86 | 1027.31 | 16.8% | operator |
...
| 13645 | Hash Join | 220.42 | 226.27 | 2.7% | operator |
...
| 13647 | Hash | 39.90 | 18.06 | 54.7% | operator |
| 13648 | Hash Join | 39.15 | 67.97 | 73.6% | operator |
| 13649 | Seq Scan | 37.57 | 24.87 | 33.8% | operator |
| 13650 | Hash | 0.25 | 17.93 | 7128.9% | operator |
| 13651 | Hash Join | 0.24 | 151.58 | 61770.8% | operator |
...
### Step 5: Node 13649 (Seq Scan) - LEAF
...
### Step 8: Node 13646 (Seq Scan) - LEAF
...
### Step 11: Node 13655 (Index Scan) - LEAF
...
### Step 12: Node 13657 (Seq Scan) - LEAF
...
### Step 13: Node 13644 (Nested Loop)
...
### Step 16: Node 13658 (Index Scan) - LEAF
...
### Step 17: Node 13660 (Seq Scan) - LEAF
...
### Step 18: Node 13642 (Nested Loop)
...
### Step 22: Node 13639 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1086.9222
  - st2=0.0000
  - startup_cost=71552.4400
  - total_cost=71840.0400
- **Output:** st=1120.79, rt=1123.87

### Step 23: Node 13638 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=71552.4400
  - total_cost=71936.7800
- **Output:** st=1186.73, rt=1194.39
