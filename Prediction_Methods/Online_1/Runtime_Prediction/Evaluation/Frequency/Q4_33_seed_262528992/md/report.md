...
**Test Query:** Q4_33_seed_262528992
...
```
Node 6383 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 6384 (Gather Merge) [consumed]
    Node 6385 (Sort) [PATTERN: 1d35fb97]
      Node 6386 (Aggregate) [consumed]
        Node 6387 (Nested Loop)
          Node 6388 (Seq Scan) - LEAF
          Node 6389 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 6385 | 6383, 6384, 6386 |
| Aggregate -> Gather Merge (Out | 2724c080 | 6383 | 6384, 6385, 6386 |
...
|------|------|--------|-----------|-----|--------|
| 6383 | Aggregate | 1067.59 | 1078.94 | 1.1% | pattern |
| 6385 | Sort | 1062.68 | 1055.49 | 0.7% | pattern |
| 6387 | Nested Loop | 1060.72 | 1106.70 | 4.3% | operator |
| 6388 | Seq Scan | 165.52 | 157.02 | 5.1% | operator |
| 6389 | Index Scan | 0.06 | 0.38 | 513.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6388 (Seq Scan) - LEAF
...
### Step 2: Node 6389 (Index Scan) - LEAF
...
- **Output:** st=31.51, rt=1106.70

### Step 4: Node 6385 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 6383, 6384, 6386
- **Input Features:**
...
### Step 5: Node 6383 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 6384, 6385, 6386
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=5
  - Aggregate_nt1=15
  ...
  - Aggregate_total_cost=67001.6900
  ...
  - GatherMerge_Outer_total_cost=67001.5600
- **Output:** st=1076.41, rt=1078.94
