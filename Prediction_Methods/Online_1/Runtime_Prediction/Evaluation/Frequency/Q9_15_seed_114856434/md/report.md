          ...
          Node 17670 (Hash Join) [PATTERN: 895c6e8c]
            ...
            Node 17672 (Hash) [consumed]
              Node 17673 (Hash Join)
                Node 17674 (Hash Join) [PATTERN: 2e0f44ef]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 17670 | 17665, 17666, 17671, 17672, 17674, 17675, 17678 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17665 | 17666, 17670, 17671, 17672, 17674, 17675, 17678 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 17674 | 17665, 17666, 17670, 17671, 17672, 17675, 17678 |
...
| 17673 | Hash Join | 175.44 | 820.72 | 367.8% | operator |
| 17674 | Hash Join | 161.53 | 981.05 | 507.4% | pattern |
...
### Step 4: Node 17681 (Seq Scan) - LEAF
...
### Step 5: Node 17674 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 17665, 17666, 17670, 17671, 17672, 17675, 17678
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=19372
  - HashJoin_nt1=19372
...
### Step 8: Node 17670 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 17665, 17666, 17671, 17672, 17674, 17675, 17678
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=69752
...
### Step 9: Node 17682 (Index Scan) - LEAF
...
### Step 10: Node 17669 (Nested Loop)
...
### Step 13: Node 17665 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17666, 17670, 17671, 17672, 17674, 17675, 17678
- **Input Features:**
