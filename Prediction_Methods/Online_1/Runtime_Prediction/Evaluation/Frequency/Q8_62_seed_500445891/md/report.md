...
```
Node 15685 (Aggregate) - ROOT
  Node 15686 (Gather Merge)
    Node 15687 (Sort)
...
|------|------|--------|-----------|-----|--------|
| 15685 | Aggregate | 1253.53 | 1196.51 | 4.5% | operator |
| 15686 | Gather Merge | 1253.13 | 1123.89 | 10.3% | operator |
...
| 15690 | Hash Join | 1243.67 | 1027.31 | 17.4% | operator |
...
| 15692 | Hash Join | 223.25 | 226.27 | 1.4% | operator |
...
| 15694 | Hash | 40.44 | 18.06 | 55.3% | operator |
| 15695 | Hash Join | 39.72 | 67.97 | 71.1% | operator |
| 15696 | Seq Scan | 38.15 | 24.87 | 34.8% | operator |
| 15697 | Hash | 0.23 | 17.93 | 7797.7% | operator |
| 15698 | Hash Join | 0.22 | 151.58 | 67571.2% | operator |
...
### Step 5: Node 15696 (Seq Scan) - LEAF
...
### Step 8: Node 15693 (Seq Scan) - LEAF
...
### Step 11: Node 15702 (Index Scan) - LEAF
...
### Step 12: Node 15704 (Seq Scan) - LEAF
...
### Step 13: Node 15691 (Nested Loop)
...
### Step 16: Node 15705 (Index Scan) - LEAF
...
### Step 17: Node 15707 (Seq Scan) - LEAF
...
### Step 18: Node 15689 (Nested Loop)
...
### Step 22: Node 15686 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1086.9201
  - st2=0.0000
  - startup_cost=71541.6500
  - total_cost=71818.4800
- **Output:** st=1120.81, rt=1123.89

### Step 23: Node 15685 (Aggregate) - ROOT
