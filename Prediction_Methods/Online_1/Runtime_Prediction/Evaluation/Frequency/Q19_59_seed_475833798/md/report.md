...
Node 31948 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31949 (Gather) [consumed]
    Node 31950 (Aggregate) [consumed]
      Node 31951 (Hash Join) [PATTERN: f4cb205a]
        Node 31952 (Seq Scan) [consumed] - LEAF
        Node 31953 (Hash) [consumed]
          Node 31954 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 31951 | 31948, 31949, 31950, 31952, 31953, 31954 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31948 | 31949, 31950, 31951, 31952, 31953, 31954 |
...
| 31951 | Hash Join | 828.98 | 373.83 | 54.9% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31951 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 31948, 31949, 31950, 31952, 31953, 31954
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=23
  - HashJoin_nt1=22523
  ...
  - HashJoin_sel=0.0000
  - HashJoin_startup_cost=7672.2200
  - HashJoin_total_cost=156338.6300
  - Hash_Inner_np=0
  - Hash_Inner_nt=204
  - Hash_Inner_nt1=204
  - Hash_Inner_nt2=0
...
### Step 2: Node 31948 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31949, 31950, 31951, 31952, 31953, 31954
- **Input Features:**
