...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 9814 | 9801, 9802, 9808, 9809, 9810, 9811, 9812, 9813, 9815, 9816, 9817 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 9808 | 9801, 9802, 9809, 9810, 9811, 9812, 9813, 9814, 9815, 9816, 9817 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 9811 | 9801, 9802, 9808, 9809, 9810, 9812, 9813, 9814, 9815, 9816, 9817 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 9801 | 9802, 9808, 9809, 9810, 9811, 9812, 9813, 9814, 9815, 9816, 9817 |
...
| 9804 | Aggregate | 1083.57 | 1020.02 | 5.9% | operator |
| 9805 | Sort | 1083.32 | 1074.66 | 0.8% | operator |
| 9806 | Hash Join | 1082.83 | 1107.33 | 2.3% | operator |
| 9807 | Nested Loop | 1071.24 | 1102.65 | 2.9% | operator |
...
- **Consumes:** Nodes 9801, 9802, 9808, 9809, 9810, 9811, 9812, 9813, 9815, 9816, 9817
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
- **Consumes:** Nodes 9801, 9802, 9808, 9809, 9810, 9812, 9813, 9814, 9815, 9816, 9817
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=12500
  - HashJoin_nt1=62500
...
- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 9801, 9802, 9809, 9810, 9811, 9812, 9813, 9814, 9815, 9816, 9817
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14612
  - HashJoin_nt1=73059
...
### Step 11: Node 9803 (Gather Merge)
...
### Step 12: Node 9801 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 9802, 9808, 9809, 9810, 9811, 9812, 9813, 9814, 9815, 9816, 9817
- **Input Features:**
