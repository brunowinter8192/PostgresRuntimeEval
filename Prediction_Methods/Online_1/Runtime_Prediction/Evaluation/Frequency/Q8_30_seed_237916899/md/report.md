...
```
Node 14880 (Aggregate) - ROOT
  Node 14881 (Gather Merge)
    Node 14882 (Sort)
...
|------|------|--------|-----------|-----|--------|
| 14880 | Aggregate | 1247.63 | 1193.46 | 4.3% | operator |
| 14881 | Gather Merge | 1247.21 | 1123.89 | 9.9% | operator |
...
| 14885 | Hash Join | 1237.68 | 1027.31 | 17.0% | operator |
...
| 14887 | Hash Join | 218.36 | 226.27 | 3.6% | operator |
...
| 14889 | Hash | 38.60 | 18.06 | 53.2% | operator |
| 14890 | Hash Join | 37.99 | 67.97 | 78.9% | operator |
| 14891 | Seq Scan | 36.47 | 24.87 | 31.8% | operator |
| 14892 | Hash | 0.20 | 17.93 | 8908.9% | operator |
| 14893 | Hash Join | 0.20 | 151.58 | 77238.5% | operator |
...
### Step 5: Node 14891 (Seq Scan) - LEAF
...
### Step 8: Node 14888 (Seq Scan) - LEAF
...
### Step 11: Node 14897 (Index Scan) - LEAF
...
### Step 12: Node 14899 (Seq Scan) - LEAF
...
### Step 13: Node 14886 (Nested Loop)
...
### Step 16: Node 14900 (Index Scan) - LEAF
...
### Step 17: Node 14902 (Seq Scan) - LEAF
...
### Step 18: Node 14884 (Nested Loop)
...
### Step 22: Node 14881 (Gather Merge)
...
### Step 23: Node 14880 (Aggregate) - ROOT
