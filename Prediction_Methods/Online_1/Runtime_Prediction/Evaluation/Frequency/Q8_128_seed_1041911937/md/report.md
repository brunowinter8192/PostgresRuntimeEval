...
```
Node 13891 (Aggregate) - ROOT
  Node 13892 (Gather Merge)
    Node 13893 (Sort)
...
|------|------|--------|-----------|-----|--------|
| 13891 | Aggregate | 1215.95 | 1196.42 | 1.6% | operator |
| 13892 | Gather Merge | 1215.53 | 1123.85 | 7.5% | operator |
...
| 13896 | Hash Join | 1204.79 | 1027.31 | 14.7% | operator |
...
| 13898 | Hash Join | 213.11 | 226.27 | 6.2% | operator |
...
| 13900 | Hash | 33.74 | 18.06 | 46.5% | operator |
| 13901 | Hash Join | 32.99 | 67.97 | 106.0% | operator |
| 13902 | Seq Scan | 31.48 | 24.87 | 21.0% | operator |
| 13903 | Hash | 0.20 | 17.93 | 8731.4% | operator |
| 13904 | Hash Join | 0.20 | 151.58 | 76457.3% | operator |
...
### Step 5: Node 13902 (Seq Scan) - LEAF
...
### Step 8: Node 13899 (Seq Scan) - LEAF
...
### Step 11: Node 13908 (Index Scan) - LEAF
...
### Step 12: Node 13910 (Seq Scan) - LEAF
...
### Step 13: Node 13897 (Nested Loop)
...
### Step 16: Node 13911 (Index Scan) - LEAF
...
### Step 17: Node 13913 (Seq Scan) - LEAF
...
### Step 18: Node 13895 (Nested Loop)
...
### Step 22: Node 13892 (Gather Merge)
...
- **Input Features:**
  ...
  - total_cost=71834.2300
- **Output:** st=1120.77, rt=1123.85

### Step 23: Node 13891 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=71549.4600
  - total_cost=71930.4900
- **Output:** st=1187.89, rt=1196.42
