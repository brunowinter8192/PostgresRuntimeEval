...
**Test Query:** Q18_92_seed_746566821
**Timestamp:** 2026-01-11 18:21:44
...
```
Node 31076 (Limit) [PATTERN: 6ce7e974] - ROOT
  Node 31077 (Sort) [consumed]
    Node 31078 (Aggregate) [consumed]
      Node 31079 (Gather Merge) [consumed]
        Node 31080 (Incremental Sort) [consumed]
          Node 31081 (Nested Loop)
            Node 31082 (Merge Join)
              Node 31083 (Sort)
                Node 31084 (Hash Join) [PATTERN: 895c6e8c]
                  Node 31085 (Seq Scan) [consumed] - LEAF
                  Node 31086 (Hash) [consumed]
                    Node 31087 (Aggregate)
                      Node 31088 (Index Scan) - LEAF
              Node 31089 (Sort)
                Node 31090 (Seq Scan) - LEAF
            Node 31091 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 6ce7e974 | 31076 | 31077, 31078, 31079, 31080, 31084, 31085, 31086 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 31084 | 31076, 31077, 31078, 31079, 31080, 31085, 31086 |
...
|------|------|--------|-----------|-----|--------|
| 31076 | Limit | 3051.99 | 3050.24 | 0.1% | pattern |
| 31081 | Nested Loop | 2917.47 | 1400.02 | 52.0% | operator |
| 31082 | Merge Join | 2917.41 | 2910.61 | 0.2% | operator |
| 31091 | Index Scan | 0.02 | 0.07 | 186.9% | operator |
| 31083 | Sort | 2849.36 | 1098.13 | 61.5% | operator |
| 31089 | Sort | 65.42 | 1014.60 | 1450.8% | operator |
| 31084 | Hash Join | 2849.34 | 688.83 | 75.8% | pattern |
| 31090 | Seq Scan | 53.33 | 25.47 | 52.2% | operator |
| 31087 | Aggregate | 2620.70 | 1300.21 | 50.4% | operator |
| 31088 | Index Scan | 2125.50 | 219.99 | 89.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31088 (Index Scan) - LEAF
...
### Step 3: Node 31084 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 31076, 31077, 31078, 31079, 31080, 31085, 31086
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 31090 (Seq Scan) - LEAF
...
### Step 8: Node 31091 (Index Scan) - LEAF
...
### Step 10: Node 31076 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 6ce7e974 (Limit -> Sort -> Aggregate -> Gather Merge -> Incremental Sort (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31077, 31078, 31079, 31080, 31084, 31085, 31086
- **Input Features:**
