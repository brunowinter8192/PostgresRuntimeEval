          ...
          Node 18142 (Hash Join) [PATTERN: 895c6e8c]
            ...
            Node 18144 (Hash) [consumed]
              Node 18145 (Hash Join)
                Node 18146 (Hash Join) [PATTERN: 2e0f44ef]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 18142 | 18137, 18138, 18143, 18144, 18146, 18147, 18150 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18137 | 18138, 18142, 18143, 18144, 18146, 18147, 18150 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 18146 | 18137, 18138, 18142, 18143, 18144, 18147, 18150 |
...
| 18145 | Hash Join | 168.49 | 824.24 | 389.2% | operator |
| 18146 | Hash Join | 153.30 | 983.27 | 541.4% | pattern |
...
### Step 4: Node 18153 (Seq Scan) - LEAF
...
### Step 5: Node 18146 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 18137, 18138, 18142, 18143, 18144, 18147, 18150
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=13360
  - HashJoin_nt1=13360
...
### Step 8: Node 18142 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 18137, 18138, 18143, 18144, 18146, 18147, 18150
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=48106
...
### Step 9: Node 18154 (Index Scan) - LEAF
...
### Step 10: Node 18141 (Nested Loop)
...
### Step 13: Node 18137 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18138, 18142, 18143, 18144, 18146, 18147, 18150
- **Input Features:**
