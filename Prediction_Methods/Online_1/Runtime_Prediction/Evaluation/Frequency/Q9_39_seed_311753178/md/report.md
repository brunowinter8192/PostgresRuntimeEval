...
Node 18137 (Sort) - ROOT
  Node 18138 (Aggregate) [PATTERN: 0405d50f]
    Node 18139 (Gather) [consumed]
      Node 18140 (Aggregate) [consumed]
        Node 18141 (Nested Loop) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 0405d50f | 18138 | 18139, 18140, 18141, 18142, 18143, 18144, 18146, 18147, 18150 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 18142 | 18138, 18139, 18140, 18141, 18143, 18144, 18146, 18147, 18150 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 18146 | 18138, 18139, 18140, 18141, 18142, 18143, 18144, 18147, 18150 |
...
|------|------|--------|-----------|-----|--------|
| 18137 | Sort | 1185.09 | 1155.83 | 2.5% | operator |
| 18138 | Aggregate | 1184.93 | 1195.07 | 0.9% | pattern |
...
- **Consumes:** Nodes 18138, 18139, 18140, 18141, 18142, 18143, 18144, 18147, 18150
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=13360
  - HashJoin_nt1=13360
...
- **Consumes:** Nodes 18138, 18139, 18140, 18141, 18143, 18144, 18146, 18147, 18150
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=48106
...
### Step 10: Node 18138 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 0405d50f (Aggregate -> Gather -> Aggregate -> Nested Loop (Outer) (Outer) (Outer))
- **Consumes:** Nodes 18139, 18140, 18141, 18142, 18143, 18144, 18146, 18147, 18150
- **Input Features:**
