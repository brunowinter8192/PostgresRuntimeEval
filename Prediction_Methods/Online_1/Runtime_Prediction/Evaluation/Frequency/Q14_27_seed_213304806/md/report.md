...
```
Node 26903 (Aggregate) [PATTERN: 310134da] - ROOT
  Node 26904 (Gather) [consumed]
    Node 26905 (Aggregate) [consumed]
      Node 26906 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 26903 | 26904, 26905, 26906, 26907, 26908 |
...
|------|------|--------|-----------|-----|--------|
| 26903 | Aggregate | 836.45 | 825.94 | 1.3% | pattern |
...
- **Consumes:** Nodes 26904, 26905, 26906, 26907, 26908
- **Input Features:**
