...
```
Node 31346 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 31346 | 31347, 31348, 31349, 31350, 31351 |
...
|------|------|--------|-----------|-----|--------|
| 31346 | Aggregate | 832.92 | 841.25 | 1.0% | pattern |
...
- **Consumes:** Nodes 31347, 31348, 31349, 31350, 31351
- **Input Features:**
