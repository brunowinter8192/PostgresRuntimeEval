    ...
    Node 4543 (Aggregate) [consumed]
      Node 4544 (Gather) [consumed]
        Node 4545 (Nested Loop)
          Node 4546 (Hash Join) [PATTERN: f4cb205a]
            Node 4547 (Seq Scan) [consumed] - LEAF
            Node 4548 (Hash) [consumed]
              Node 4549 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4541 | 4542, 4543, 4544, 4546, 4547, 4548, 4549 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 4546 | 4541, 4542, 4543, 4544, 4547, 4548, 4549 |
...
| 4545 | Nested Loop | 1134.77 | 1123.20 | 1.0% | operator |
| 4546 | Hash Join | 205.02 | 218.59 | 6.6% | pattern |
| 4550 | Index Scan | 0.03 | -0.02 | 174.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4546 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 4541, 4542, 4543, 4544, 4547, 4548, 4549
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47747
  - HashJoin_nt1=237612
...
- **Output:** st=30.06, rt=218.59

### Step 2: Node 4550 (Index Scan) - LEAF
...
- **Output:** st=31.42, rt=1123.20

### Step 4: Node 4541 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4542, 4543, 4544, 4546, 4547, 4548, 4549
- **Input Features:**
