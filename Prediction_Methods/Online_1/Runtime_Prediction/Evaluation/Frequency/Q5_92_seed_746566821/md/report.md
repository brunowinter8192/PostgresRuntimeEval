...
```
Node 9721 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 9722 (Aggregate) [consumed]
    Node 9723 (Gather Merge)
      Node 9724 (Aggregate)
        Node 9725 (Sort)
          Node 9726 (Hash Join) [PATTERN: 2e0f44ef]
            Node 9727 (Nested Loop) [consumed]
              Node 9728 (Hash Join) [PATTERN: 895c6e8c]
                Node 9729 (Seq Scan) [consumed] - LEAF
                Node 9730 (Hash) [consumed]
                  Node 9731 (Hash Join) [PATTERN: 895c6e8c]
                    Node 9732 (Seq Scan) [consumed] - LEAF
                    Node 9733 (Hash) [consumed]
                      Node 9734 (Hash Join) [PATTERN: f4cb205a]
                        Node 9735 (Seq Scan) [consumed] - LEAF
                        Node 9736 (Hash) [consumed]
                          Node 9737 (Seq Scan) [consumed] - LEAF
              Node 9738 (Index Scan) - LEAF
            Node 9739 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 9734 | 9721, 9722, 9726, 9727, 9728, 9729, 9730, 9731, 9732, 9733, 9735, 9736, 9737, 9739 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 9728 | 9721, 9722, 9726, 9727, 9729, 9730, 9731, 9732, 9733, 9734, 9735, 9736, 9737, 9739 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 9731 | 9721, 9722, 9726, 9727, 9728, 9729, 9730, 9732, 9733, 9734, 9735, 9736, 9737, 9739 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 9721 | 9722, 9726, 9727, 9728, 9729, 9730, 9731, 9732, 9733, 9734, 9735, 9736, 9737, 9739 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 9726 | 9721, 9722, 9727, 9728, 9729, 9730, 9731, 9732, 9733, 9734, 9735, 9736, 9737, 9739 |
...
|------|------|--------|-----------|-----|--------|
| 9721 | Sort | 1055.46 | 1080.12 | 2.3% | pattern |
| 9723 | Gather Merge | 1055.43 | 1124.38 | 6.5% | operator |
| 9724 | Aggregate | 1050.71 | 1019.77 | 2.9% | operator |
| 9725 | Sort | 1050.45 | 1073.09 | 2.2% | operator |
| 9726 | Hash Join | 1049.93 | 1080.06 | 2.9% | pattern |
| 9728 | Hash Join | 217.04 | 259.85 | 19.7% | pattern |
| 9738 | Index Scan | 0.07 | -0.03 | 135.4% | operator |
| 9740 | Seq Scan | 2.22 | 10.62 | 378.0% | operator |
| 9731 | Hash Join | 32.64 | 84.97 | 160.3% | pattern |
| 9734 | Hash Join | 0.36 | 11.62 | 3108.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 9734 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 9721, 9722, 9726, 9727, 9728, 9729, 9730, 9731, 9732, 9733, 9735, 9736, 9737, 9739
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
### Step 2: Node 9731 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 9721, 9722, 9726, 9727, 9728, 9729, 9730, 9732, 9733, 9734, 9735, 9736, 9737, 9739
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=12500
  - HashJoin_nt1=62500
...
### Step 3: Node 9728 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 9721, 9722, 9726, 9727, 9729, 9730, 9731, 9732, 9733, 9734, 9735, 9736, 9737, 9739
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14612
  - HashJoin_nt1=73059
...
### Step 4: Node 9738 (Index Scan) - LEAF
...
### Step 5: Node 9740 (Seq Scan) - LEAF
...
### Step 6: Node 9726 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 9721, 9722, 9727, 9728, 9729, 9730, 9731, 9732, 9733, 9734, 9735, 9736, 9737, 9739
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=2338
  - HashJoin_nt1=58459
...
### Step 10: Node 9721 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 9722, 9726, 9727, 9728, 9729, 9730, 9731, 9732, 9733, 9734, 9735, 9736, 9737, 9739
- **Input Features:**
