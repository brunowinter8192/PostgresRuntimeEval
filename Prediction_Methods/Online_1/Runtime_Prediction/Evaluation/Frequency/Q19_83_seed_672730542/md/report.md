...
```
Node 32137 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 32137 | 32138, 32139, 32140, 32141, 32142 |
...
|------|------|--------|-----------|-----|--------|
| 32137 | Aggregate | 847.46 | 841.24 | 0.7% | pattern |
...
- **Consumes:** Nodes 32138, 32139, 32140, 32141, 32142
- **Input Features:**
