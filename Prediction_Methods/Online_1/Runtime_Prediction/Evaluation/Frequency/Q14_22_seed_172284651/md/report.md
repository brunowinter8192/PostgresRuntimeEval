...
```
Node 26868 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 26868 | 26869, 26870, 26871, 26872, 26873 |
...
|------|------|--------|-----------|-----|--------|
| 26868 | Aggregate | 826.67 | 825.94 | 0.1% | pattern |
...
- **Consumes:** Nodes 26869, 26870, 26871, 26872, 26873
- **Input Features:**
