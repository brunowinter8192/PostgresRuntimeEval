...
```
Node 8001 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 8002 (Aggregate) [consumed]
    Node 8003 (Gather Merge)
      Node 8004 (Aggregate)
        Node 8005 (Sort)
          Node 8006 (Hash Join) [PATTERN: 2e0f44ef]
            Node 8007 (Nested Loop) [consumed]
              Node 8008 (Hash Join) [PATTERN: 895c6e8c]
                Node 8009 (Seq Scan) [consumed] - LEAF
                Node 8010 (Hash) [consumed]
                  Node 8011 (Hash Join) [PATTERN: 895c6e8c]
                    Node 8012 (Seq Scan) [consumed] - LEAF
                    Node 8013 (Hash) [consumed]
                      Node 8014 (Hash Join) [PATTERN: f4cb205a]
                        Node 8015 (Seq Scan) [consumed] - LEAF
                        Node 8016 (Hash) [consumed]
                          Node 8017 (Seq Scan) [consumed] - LEAF
              Node 8018 (Index Scan) - LEAF
            Node 8019 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 8014 | 8001, 8002, 8006, 8007, 8008, 8009, 8010, 8011, 8012, 8013, 8015, 8016, 8017, 8019 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 8008 | 8001, 8002, 8006, 8007, 8009, 8010, 8011, 8012, 8013, 8014, 8015, 8016, 8017, 8019 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 8011 | 8001, 8002, 8006, 8007, 8008, 8009, 8010, 8012, 8013, 8014, 8015, 8016, 8017, 8019 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 8001 | 8002, 8006, 8007, 8008, 8009, 8010, 8011, 8012, 8013, 8014, 8015, 8016, 8017, 8019 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 8006 | 8001, 8002, 8007, 8008, 8009, 8010, 8011, 8012, 8013, 8014, 8015, 8016, 8017, 8019 |
...
|------|------|--------|-----------|-----|--------|
| 8001 | Sort | 1059.75 | 1080.13 | 1.9% | pattern |
| 8003 | Gather Merge | 1059.73 | 1124.37 | 6.1% | operator |
| 8004 | Aggregate | 1055.08 | 1019.74 | 3.4% | operator |
| 8005 | Sort | 1054.82 | 1073.10 | 1.7% | operator |
| 8006 | Hash Join | 1054.32 | 1080.22 | 2.5% | pattern |
| 8008 | Hash Join | 208.22 | 259.84 | 24.8% | pattern |
| 8018 | Index Scan | 0.07 | -0.03 | 134.4% | operator |
| 8020 | Seq Scan | 2.46 | 10.62 | 332.1% | operator |
| 8011 | Hash Join | 29.53 | 84.97 | 187.7% | pattern |
| 8014 | Hash Join | 0.16 | 11.62 | 7114.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 8014 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 8001, 8002, 8006, 8007, 8008, 8009, 8010, 8011, 8012, 8013, 8015, 8016, 8017, 8019
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
### Step 2: Node 8011 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 8001, 8002, 8006, 8007, 8008, 8009, 8010, 8012, 8013, 8014, 8015, 8016, 8017, 8019
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=12500
  - HashJoin_nt1=62500
...
### Step 3: Node 8008 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 8001, 8002, 8006, 8007, 8009, 8010, 8011, 8012, 8013, 8014, 8015, 8016, 8017, 8019
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14685
  - HashJoin_nt1=73423
  ...
  - HashJoin_total_cost=38473.6800
  - Hash_Inner_np=0
  - Hash_Inner_nt=12500
...
### Step 5: Node 8020 (Seq Scan) - LEAF
...
### Step 6: Node 8006 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 8001, 8002, 8007, 8008, 8009, 8010, 8011, 8012, 8013, 8014, 8015, 8016, 8017, 8019
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=2350
  - HashJoin_nt1=58750
  ...
  - NestedLoop_Outer_nt=58750
  - NestedLoop_Outer_nt1=14685
...
- **Output:** st=41.68, rt=1080.22

### Step 7: Node 8005 (Sort)
...
- **Output:** st=1072.19, rt=1073.10

### Step 8: Node 8004 (Aggregate)
...
- **Output:** st=1017.76, rt=1019.74

### Step 9: Node 8003 (Gather Merge)
...
### Step 10: Node 8001 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 8002, 8006, 8007, 8008, 8009, 8010, 8011, 8012, 8013, 8014, 8015, 8016, 8017, 8019
- **Input Features:**
