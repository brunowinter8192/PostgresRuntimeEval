...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 8014 | 8001, 8002, 8008, 8009, 8010, 8011, 8012, 8013, 8015, 8016, 8017 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 8008 | 8001, 8002, 8009, 8010, 8011, 8012, 8013, 8014, 8015, 8016, 8017 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 8011 | 8001, 8002, 8008, 8009, 8010, 8012, 8013, 8014, 8015, 8016, 8017 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 8001 | 8002, 8008, 8009, 8010, 8011, 8012, 8013, 8014, 8015, 8016, 8017 |
...
| 8004 | Aggregate | 1055.08 | 1019.99 | 3.3% | operator |
| 8005 | Sort | 1054.82 | 1074.67 | 1.9% | operator |
| 8006 | Hash Join | 1054.32 | 1107.47 | 5.0% | operator |
| 8007 | Nested Loop | 1043.32 | 1102.72 | 5.7% | operator |
...
- **Consumes:** Nodes 8001, 8002, 8008, 8009, 8010, 8011, 8012, 8013, 8015, 8016, 8017
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
- **Consumes:** Nodes 8001, 8002, 8008, 8009, 8010, 8012, 8013, 8014, 8015, 8016, 8017
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=12500
  - HashJoin_nt1=62500
...
- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 8001, 8002, 8009, 8010, 8011, 8012, 8013, 8014, 8015, 8016, 8017
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14685
  - HashJoin_nt1=73423
...
- **Output:** st=42.86, rt=1102.72

### Step 7: Node 8019 (Hash)
...
- **Output:** st=49.61, rt=1107.47

### Step 9: Node 8005 (Sort)
...
- **Output:** st=1073.75, rt=1074.67

### Step 10: Node 8004 (Aggregate)
...
- **Output:** st=1017.95, rt=1019.99

### Step 11: Node 8003 (Gather Merge)
...
### Step 12: Node 8001 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 8002, 8008, 8009, 8010, 8011, 8012, 8013, 8014, 8015, 8016, 8017
- **Input Features:**
