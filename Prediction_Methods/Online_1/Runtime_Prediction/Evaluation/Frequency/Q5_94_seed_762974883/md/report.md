...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 9774 | 9761, 9762, 9768, 9769, 9770, 9771, 9772, 9773, 9775, 9776, 9777 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 9768 | 9761, 9762, 9769, 9770, 9771, 9772, 9773, 9774, 9775, 9776, 9777 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 9771 | 9761, 9762, 9768, 9769, 9770, 9772, 9773, 9774, 9775, 9776, 9777 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 9761 | 9762, 9768, 9769, 9770, 9771, 9772, 9773, 9774, 9775, 9776, 9777 |
...
| 9764 | Aggregate | 1067.29 | 1020.02 | 4.4% | operator |
| 9765 | Sort | 1067.04 | 1074.66 | 0.7% | operator |
| 9766 | Hash Join | 1066.55 | 1107.33 | 3.8% | operator |
| 9767 | Nested Loop | 1056.50 | 1102.65 | 4.4% | operator |
...
- **Consumes:** Nodes 9761, 9762, 9768, 9769, 9770, 9771, 9772, 9773, 9775, 9776, 9777
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
- **Consumes:** Nodes 9761, 9762, 9768, 9769, 9770, 9772, 9773, 9774, 9775, 9776, 9777
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=12500
  - HashJoin_nt1=62500
...
- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 9761, 9762, 9769, 9770, 9771, 9772, 9773, 9774, 9775, 9776, 9777
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14612
  - HashJoin_nt1=73059
...
- **Output:** st=42.82, rt=1102.65

### Step 7: Node 9779 (Hash)
...
- **Output:** st=49.57, rt=1107.33

### Step 9: Node 9765 (Sort)
...
- **Output:** st=1017.98, rt=1020.02

### Step 11: Node 9763 (Gather Merge)
...
### Step 12: Node 9761 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 9762, 9768, 9769, 9770, 9771, 9772, 9773, 9774, 9775, 9776, 9777
- **Input Features:**
