...
```
Node 10081 (Aggregate) [PATTERN: dd3706ac] - ROOT
  Node 10082 (Gather) [consumed]
    Node 10083 (Aggregate) [consumed]
      Node 10084 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | dd3706ac | 10081 | 10082, 10083, 10084 |
...
|------|------|--------|-----------|-----|--------|
| 10081 | Aggregate | 782.18 | 791.26 | 1.2% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10081 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** dd3706ac (Aggregate -> Gather -> Aggregate -> Seq Scan (Outer) (Outer) (Outer))
- **Consumes:** Nodes 10082, 10083, 10084
- **Input Features:**
