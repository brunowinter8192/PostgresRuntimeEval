    ...
    Node 17124 (Gather) [consumed]
      Node 17125 (Aggregate) [consumed]
        Node 17126 (Nested Loop) [consumed]
          Node 17127 (Hash Join) [PATTERN: 895c6e8c]
            Node 17128 (Seq Scan) [consumed] - LEAF
            Node 17129 (Hash) [consumed]
              Node 17130 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 0405d50f | 17123 | 17124, 17125, 17126, 17127, 17128, 17129, 17131, 17132, 17135 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 17127 | 17123, 17124, 17125, 17126, 17128, 17129, 17131, 17132, 17135 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 17131 | 17123, 17124, 17125, 17126, 17127, 17128, 17129, 17132, 17135 |
...
| 17127 | Hash Join | 979.04 | 733.11 | 25.1% | pattern |
| 17139 | Index Scan | 0.00 | -0.04 | 1512.7% | operator |
| 17130 | Hash Join | 174.12 | 822.45 | 372.3% | operator |
...
- **Consumes:** Nodes 17123, 17124, 17125, 17126, 17127, 17128, 17129, 17132, 17135
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=15363
  - HashJoin_nt1=15363
...
### Step 8: Node 17127 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 17123, 17124, 17125, 17126, 17128, 17129, 17131, 17132, 17135
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=55319
...
### Step 9: Node 17139 (Index Scan) - LEAF
...
### Step 10: Node 17123 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 0405d50f (Aggregate -> Gather -> Aggregate -> Nested Loop (Outer) (Outer) (Outer))
- **Consumes:** Nodes 17124, 17125, 17126, 17127, 17128, 17129, 17131, 17132, 17135
- **Input Features:**
