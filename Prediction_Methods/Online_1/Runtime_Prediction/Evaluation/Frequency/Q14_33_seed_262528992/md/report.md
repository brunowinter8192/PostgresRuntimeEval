...
```
Node 26952 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 26952 | 26953, 26954, 26955, 26956, 26957 |
...
|------|------|--------|-----------|-----|--------|
| 26952 | Aggregate | 805.90 | 825.95 | 2.5% | pattern |
...
- **Consumes:** Nodes 26953, 26954, 26955, 26956, 26957
- **Input Features:**
