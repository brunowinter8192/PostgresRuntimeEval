...
Node 27176 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27177 (Gather) [consumed]
    Node 27178 (Aggregate) [consumed]
      Node 27179 (Hash Join) [PATTERN: f4cb205a]
        Node 27180 (Seq Scan) [consumed] - LEAF
        Node 27181 (Hash) [consumed]
          Node 27182 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 27179 | 27176, 27177, 27178, 27180, 27181, 27182 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27176 | 27177, 27178, 27179, 27180, 27181, 27182 |
...
| 27179 | Hash Join | 786.48 | 397.05 | 49.5% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27179 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 27176, 27177, 27178, 27180, 27181, 27182
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=15570
  - HashJoin_nt1=15570
  ...
  - HashJoin_total_cost=136647.5100
  - Hash_Inner_np=0
  - Hash_Inner_nt=83333
...
- **Output:** st=44.58, rt=397.05

### Step 2: Node 27176 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27177, 27178, 27179, 27180, 27181, 27182
- **Input Features:**
