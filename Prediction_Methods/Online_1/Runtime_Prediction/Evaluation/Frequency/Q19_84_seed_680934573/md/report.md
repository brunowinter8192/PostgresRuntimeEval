...
```
Node 32144 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 32144 | 32145, 32146, 32147, 32148, 32149 |
...
|------|------|--------|-----------|-----|--------|
| 32144 | Aggregate | 856.23 | 841.25 | 1.7% | pattern |
...
- **Consumes:** Nodes 32145, 32146, 32147, 32148, 32149
- **Input Features:**
