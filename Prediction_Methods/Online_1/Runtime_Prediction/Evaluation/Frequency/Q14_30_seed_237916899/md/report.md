...
```
Node 26931 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 26931 | 26932, 26933, 26934, 26935, 26936 |
...
|------|------|--------|-----------|-----|--------|
| 26931 | Aggregate | 811.95 | 825.94 | 1.7% | pattern |
...
- **Consumes:** Nodes 26932, 26933, 26934, 26935, 26936
- **Input Features:**
