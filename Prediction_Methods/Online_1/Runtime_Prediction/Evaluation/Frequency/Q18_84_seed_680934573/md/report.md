...
**Test Query:** Q18_84_seed_680934573
...
```
Node 30932 (Limit) [PATTERN: 6ce7e974] - ROOT
  Node 30933 (Sort) [consumed]
    Node 30934 (Aggregate) [consumed]
      Node 30935 (Gather Merge) [consumed]
        Node 30936 (Incremental Sort) [consumed]
          Node 30937 (Nested Loop)
            Node 30938 (Merge Join)
              Node 30939 (Sort)
                Node 30940 (Hash Join) [PATTERN: 895c6e8c]
                  Node 30941 (Seq Scan) [consumed] - LEAF
                  Node 30942 (Hash) [consumed]
                    Node 30943 (Aggregate)
                      Node 30944 (Index Scan) - LEAF
              Node 30945 (Sort)
                Node 30946 (Seq Scan) - LEAF
            Node 30947 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 6ce7e974 | 30932 | 30933, 30934, 30935, 30936, 30940, 30941, 30942 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30940 | 30932, 30933, 30934, 30935, 30936, 30941, 30942 |
...
|------|------|--------|-----------|-----|--------|
| 30932 | Limit | 3056.16 | 3050.24 | 0.2% | pattern |
| 30937 | Nested Loop | 2898.86 | 1400.02 | 51.7% | operator |
| 30938 | Merge Join | 2898.80 | 2910.61 | 0.4% | operator |
| 30947 | Index Scan | 0.02 | 0.07 | 214.2% | operator |
| 30939 | Sort | 2848.05 | 1098.13 | 61.4% | operator |
| 30945 | Sort | 64.93 | 1014.60 | 1462.6% | operator |
| 30940 | Hash Join | 2848.04 | 688.83 | 75.8% | pattern |
| 30946 | Seq Scan | 53.62 | 25.47 | 52.5% | operator |
| 30943 | Aggregate | 2622.84 | 1300.21 | 50.4% | operator |
| 30944 | Index Scan | 2121.74 | 219.99 | 89.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 30944 (Index Scan) - LEAF
...
### Step 3: Node 30940 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 30932, 30933, 30934, 30935, 30936, 30941, 30942
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30946 (Seq Scan) - LEAF
...
### Step 8: Node 30947 (Index Scan) - LEAF
...
### Step 10: Node 30932 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 6ce7e974 (Limit -> Sort -> Aggregate -> Gather Merge -> Incremental Sort (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 30933, 30934, 30935, 30936, 30940, 30941, 30942
- **Input Features:**
