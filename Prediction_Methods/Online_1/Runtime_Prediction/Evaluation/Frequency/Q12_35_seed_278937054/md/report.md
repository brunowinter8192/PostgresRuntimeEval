...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge (Out | 2724c080 | 24866 | 24867, 24870, 24871, 24872 |
| Nested Loop -> [Seq Scan (Oute | c53c4396 | 24870 | 24866, 24867, 24871, 24872 |
...
|------|------|--------|-----------|-----|--------|
| 24866 | Aggregate | 1008.63 | 1027.05 | 1.8% | pattern |
| 24868 | Aggregate | 984.54 | 940.64 | 4.5% | operator |
| 24869 | Sort | 983.92 | 1050.81 | 6.8% | operator |
| 24870 | Nested Loop | 982.98 | 976.06 | 0.7% | pattern |
...
- **Consumes:** Nodes 24866, 24867, 24871, 24872
- **Input Features:**
...
- **Output:** st=10.43, rt=976.06

### Step 2: Node 24869 (Sort)
...
- **Output:** st=1049.82, rt=1050.81

### Step 3: Node 24868 (Aggregate)
...
### Step 4: Node 24866 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 24867, 24870, 24871, 24872
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=7
  - Aggregate_nt1=35
