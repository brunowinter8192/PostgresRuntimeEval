...
```
Node 25622 (Sort) [PATTERN: 35ffb644] - ROOT
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Aggregate | 35ffb644 | 25622 | 25623, 25624, 25625, 25626, 25627 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 25625 | 25622, 25623, 25624, 25626, 25627 |
...
| 25625 | Hash Join | 711.27 | 600.63 | 15.6% | pattern |
| 25628 | Index Only Scan | 10.18 | 10.09 | 0.9% | operator |
...
- **Consumes:** Nodes 25622, 25623, 25624, 25626, 25627
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=1484970
...
- **Output:** st=17.15, rt=600.63

### Step 3: Node 25622 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 35ffb644 (Sort -> Aggregate -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 25623, 25624, 25625, 25626, 25627
- **Input Features:**
