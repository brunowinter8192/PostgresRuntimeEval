...
Node 26994 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26995 (Gather) [consumed]
    Node 26996 (Aggregate) [consumed]
      Node 26997 (Hash Join) [PATTERN: f4cb205a]
        Node 26998 (Seq Scan) [consumed] - LEAF
        Node 26999 (Hash) [consumed]
          Node 27000 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 26997 | 26994, 26995, 26996, 26998, 26999, 27000 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26994 | 26995, 26996, 26997, 26998, 26999, 27000 |
...
|------|------|--------|-----------|-----|--------|
| 26994 | Aggregate | 814.55 | 834.71 | 2.5% | pattern |
| 26997 | Hash Join | 791.57 | 397.38 | 49.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26997 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 26994, 26995, 26996, 26998, 26999, 27000
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=13479
  - HashJoin_nt1=13479
  ...
  - HashJoin_total_cost=136642.0200
  - Hash_Inner_np=0
  - Hash_Inner_nt=83333
...
- **Output:** st=44.77, rt=397.38

### Step 2: Node 26994 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26995, 26996, 26997, 26998, 26999, 27000
- **Input Features:**
