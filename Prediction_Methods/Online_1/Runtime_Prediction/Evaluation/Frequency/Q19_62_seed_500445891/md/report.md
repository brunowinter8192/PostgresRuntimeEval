...
```
Node 31976 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 31976 | 31977, 31978, 31979, 31980, 31981 |
...
|------|------|--------|-----------|-----|--------|
| 31976 | Aggregate | 844.40 | 841.24 | 0.4% | pattern |
...
- **Consumes:** Nodes 31977, 31978, 31979, 31980, 31981
- **Input Features:**
