...
Node 31976 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31977 (Gather) [consumed]
    Node 31978 (Aggregate) [consumed]
      Node 31979 (Hash Join) [PATTERN: f4cb205a]
        Node 31980 (Seq Scan) [consumed] - LEAF
        Node 31981 (Hash) [consumed]
          Node 31982 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 31979 | 31976, 31977, 31978, 31980, 31981, 31982 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31976 | 31977, 31978, 31979, 31980, 31981, 31982 |
...
| 31979 | Hash Join | 825.19 | 373.82 | 54.7% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31979 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 31976, 31977, 31978, 31980, 31981, 31982
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=23
  - HashJoin_nt1=22529
  ...
  - HashJoin_total_cost=156338.6000
  - Hash_Inner_np=0
  - Hash_Inner_nt=200
  - Hash_Inner_nt1=200
  - Hash_Inner_nt2=0
...
### Step 2: Node 31976 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31977, 31978, 31979, 31980, 31981, 31982
- **Input Features:**
