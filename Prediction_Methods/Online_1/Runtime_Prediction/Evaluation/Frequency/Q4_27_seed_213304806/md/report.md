...
```
Node 6334 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 6335 (Gather Merge) [consumed]
    Node 6336 (Sort) [PATTERN: 1d35fb97]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 6336 | 6334, 6335, 6337 |
| Aggregate -> Gather Merge (Out | 2724c080 | 6334 | 6335, 6336, 6337 |
...
|------|------|--------|-----------|-----|--------|
| 6334 | Aggregate | 1055.58 | 1078.97 | 2.2% | pattern |
| 6336 | Sort | 1051.05 | 1055.47 | 0.4% | pattern |
...
### Step 4: Node 6336 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 6334, 6335, 6337
- **Input Features:**
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=65870.9900
  - Sort_total_cost=65871.0000
- **Output:** st=1054.31, rt=1055.47

### Step 5: Node 6334 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 6335, 6336, 6337
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=5
  - Aggregate_nt1=15
