...
```
Node 32116 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 32116 | 32117, 32118, 32119, 32120, 32121 |
...
|------|------|--------|-----------|-----|--------|
| 32116 | Aggregate | 834.53 | 841.27 | 0.8% | pattern |
...
- **Consumes:** Nodes 32117, 32118, 32119, 32120, 32121
- **Input Features:**
