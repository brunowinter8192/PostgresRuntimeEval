...
```
Node 15593 (Aggregate) - ROOT
  Node 15594 (Gather Merge)
    Node 15595 (Sort)
          ...
          Node 15598 (Hash Join)
            Node 15599 (Nested Loop)
              Node 15600 (Hash Join)
                ...
                Node 15602 (Hash)
                  Node 15603 (Hash Join)
                    Node 15604 (Seq Scan) - LEAF
                    Node 15605 (Hash)
                      Node 15606 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 15593 | Aggregate | 1198.52 | 1194.39 | 0.3% | operator |
| 15594 | Gather Merge | 1198.14 | 1123.87 | 6.2% | operator |
...
| 15598 | Hash Join | 1188.61 | 1027.31 | 13.6% | operator |
...
| 15600 | Hash Join | 214.40 | 226.27 | 5.5% | operator |
...
| 15602 | Hash | 37.82 | 18.06 | 52.2% | operator |
| 15603 | Hash Join | 37.20 | 67.97 | 82.7% | operator |
| 15604 | Seq Scan | 35.48 | 24.87 | 29.9% | operator |
| 15605 | Hash | 0.25 | 17.93 | 7128.9% | operator |
| 15606 | Hash Join | 0.24 | 151.58 | 61770.8% | operator |
...
### Step 5: Node 15604 (Seq Scan) - LEAF
...
### Step 8: Node 15601 (Seq Scan) - LEAF
...
### Step 11: Node 15610 (Index Scan) - LEAF
...
### Step 12: Node 15612 (Seq Scan) - LEAF
...
### Step 13: Node 15599 (Nested Loop)
...
### Step 16: Node 15613 (Index Scan) - LEAF
...
### Step 17: Node 15615 (Seq Scan) - LEAF
...
### Step 18: Node 15597 (Nested Loop)
...
### Step 22: Node 15594 (Gather Merge)
...
### Step 23: Node 15593 (Aggregate) - ROOT
