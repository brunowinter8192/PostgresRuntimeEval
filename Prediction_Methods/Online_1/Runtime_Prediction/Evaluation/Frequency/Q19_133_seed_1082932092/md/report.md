...
Node 31472 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31473 (Gather) [consumed]
    Node 31474 (Aggregate) [consumed]
      Node 31475 (Hash Join)
        Node 31476 (Seq Scan) - LEAF
        Node 31477 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31472 | 31473, 31474 |
...
| 31475 | Hash Join | 877.76 | 782.38 | 10.9% | operator |
| 31476 | Seq Scan | 826.14 | 750.07 | 9.2% | operator |
| 31477 | Hash | 49.46 | 12.06 | 75.6% | operator |
| 31478 | Seq Scan | 49.28 | 31.60 | 35.9% | operator |
...
### Step 2: Node 31476 (Seq Scan) - LEAF
...
### Step 5: Node 31472 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31473, 31474
- **Input Features:**
