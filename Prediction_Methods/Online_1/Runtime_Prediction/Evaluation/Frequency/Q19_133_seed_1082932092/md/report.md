...
**Test Query:** Q19_133_seed_1082932092
**Timestamp:** 2026-01-01 19:12:29
...
```
Node 31472 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31473 (Gather) [consumed]
    Node 31474 (Aggregate) [consumed]
      Node 31475 (Hash Join) [PATTERN: f4cb205a]
        Node 31476 (Seq Scan) [consumed] - LEAF
        Node 31477 (Hash) [consumed]
          Node 31478 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 31475 | 31472, 31473, 31474, 31476, 31477, 31478 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31472 | 31473, 31474, 31475, 31476, 31477, 31478 |
...
|------|------|--------|-----------|-----|--------|
| 31472 | Aggregate | 898.21 | 834.50 | 7.1% | pattern |
| 31475 | Hash Join | 877.76 | 373.82 | 57.4% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31475 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 31472, 31473, 31474, 31476, 31477, 31478
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=23
  - HashJoin_nt1=22571
  ...
  - HashJoin_total_cost=156338.7100
  - Hash_Inner_np=0
  - Hash_Inner_nt=200
  - Hash_Inner_nt1=200
  - Hash_Inner_nt2=0
...
### Step 2: Node 31472 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31473, 31474, 31475, 31476, 31477, 31478
- **Input Features:**
  ...
  - Aggregate_Outer_startup_cost=156338.8800
  - Aggregate_Outer_total_cost=156338.8900
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=157339.4200
  - Aggregate_total_cost=157339.4300
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=157338.8800
  - Gather_Outer_total_cost=157339.3900
