...
```
Node 31472 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 31472 | 31473, 31474, 31475, 31476, 31477 |
...
|------|------|--------|-----------|-----|--------|
| 31472 | Aggregate | 898.21 | 841.25 | 6.3% | pattern |
...
- **Consumes:** Nodes 31473, 31474, 31475, 31476, 31477
- **Input Features:**
