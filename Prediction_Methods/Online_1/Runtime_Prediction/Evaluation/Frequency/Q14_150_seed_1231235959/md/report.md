...
```
Node 26805 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 26805 | 26806, 26807, 26808, 26809, 26810 |
...
|------|------|--------|-----------|-----|--------|
| 26805 | Aggregate | 831.59 | 825.95 | 0.7% | pattern |
...
- **Consumes:** Nodes 26806, 26807, 26808, 26809, 26810
- **Input Features:**
