...
```
Node 10333 (Aggregate) [PATTERN: dd3706ac] - ROOT
  Node 10334 (Gather) [consumed]
    Node 10335 (Aggregate) [consumed]
      Node 10336 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | dd3706ac | 10333 | 10334, 10335, 10336 |
...
|------|------|--------|-----------|-----|--------|
| 10333 | Aggregate | 787.15 | 791.26 | 0.5% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10333 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** dd3706ac (Aggregate -> Gather -> Aggregate -> Seq Scan (Outer) (Outer) (Outer))
- **Consumes:** Nodes 10334, 10335, 10336
- **Input Features:**
