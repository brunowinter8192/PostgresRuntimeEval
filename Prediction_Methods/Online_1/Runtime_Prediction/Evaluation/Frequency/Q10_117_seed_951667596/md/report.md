...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19604 | 19605, 19606, 19607, 19609, 19610, 19613 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 19609 | 19604, 19605, 19606, 19607, 19610, 19613 |
...
|------|------|--------|-----------|-----|--------|
| 19604 | Limit | 1192.97 | 1154.73 | 3.2% | pattern |
| 19608 | Hash Join | 1135.95 | 1087.23 | 4.3% | operator |
...
- **Consumes:** Nodes 19604, 19605, 19606, 19607, 19610, 19613
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=17964
  - HashJoin_nt1=17964
...
- **Output:** st=39.27, rt=1087.23

### Step 8: Node 19604 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19605, 19606, 19607, 19609, 19610, 19613
- **Input Features:**
