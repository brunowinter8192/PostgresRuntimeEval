...
```
Node 6677 (Aggregate) [PATTERN: 2724c080] - ROOT
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 6679 | 6677, 6678, 6680 |
| Aggregate -> Gather Merge (Out | 2724c080 | 6677 | 6678, 6679, 6680 |
...
|------|------|--------|-----------|-----|--------|
| 6677 | Aggregate | 1073.88 | 1079.02 | 0.5% | pattern |
...
### Step 5: Node 6677 (Aggregate) - PATTERN ROOT
