...
```
Node 6768 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 6769 (Gather Merge) [consumed]
    Node 6770 (Sort) [PATTERN: 1d35fb97]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 6770 | 6768, 6769, 6771 |
| Aggregate -> Gather Merge (Out | 2724c080 | 6768 | 6769, 6770, 6771 |
...
|------|------|--------|-----------|-----|--------|
| 6768 | Aggregate | 1061.99 | 1078.93 | 1.6% | pattern |
| 6770 | Sort | 1055.88 | 1055.50 | 0.0% | pattern |
...
### Step 4: Node 6770 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 6768, 6769, 6771
- **Input Features:**
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=66058.5200
  - Sort_total_cost=66058.5300
- **Output:** st=1054.34, rt=1055.50

### Step 5: Node 6768 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 6769, 6770, 6771
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=5
  - Aggregate_nt1=15
