...
```
Node 10157 (Aggregate) [PATTERN: dd3706ac] - ROOT
  Node 10158 (Gather) [consumed]
    Node 10159 (Aggregate) [consumed]
      Node 10160 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | dd3706ac | 10157 | 10158, 10159, 10160 |
...
|------|------|--------|-----------|-----|--------|
| 10157 | Aggregate | 786.68 | 791.26 | 0.6% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10157 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** dd3706ac (Aggregate -> Gather -> Aggregate -> Seq Scan (Outer) (Outer) (Outer))
- **Consumes:** Nodes 10158, 10159, 10160
- **Input Features:**
