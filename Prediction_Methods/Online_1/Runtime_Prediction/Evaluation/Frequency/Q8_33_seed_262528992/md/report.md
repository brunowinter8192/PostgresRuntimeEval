...
```
Node 14949 (Aggregate) - ROOT
  Node 14950 (Gather Merge)
    Node 14951 (Sort)
...
|------|------|--------|-----------|-----|--------|
| 14949 | Aggregate | 1237.31 | 1191.95 | 3.7% | operator |
| 14950 | Gather Merge | 1236.88 | 1123.91 | 9.1% | operator |
...
| 14954 | Hash Join | 1227.21 | 1027.31 | 16.3% | operator |
...
| 14956 | Hash Join | 215.26 | 226.27 | 5.1% | operator |
...
| 14958 | Hash | 36.25 | 18.06 | 50.2% | operator |
| 14959 | Hash Join | 35.54 | 67.97 | 91.2% | operator |
| 14960 | Seq Scan | 33.99 | 24.87 | 26.8% | operator |
| 14961 | Hash | 0.25 | 17.93 | 7158.2% | operator |
| 14962 | Hash Join | 0.24 | 151.58 | 62280.0% | operator |
...
### Step 5: Node 14960 (Seq Scan) - LEAF
...
### Step 8: Node 14957 (Seq Scan) - LEAF
...
### Step 11: Node 14966 (Index Scan) - LEAF
...
### Step 12: Node 14968 (Seq Scan) - LEAF
...
### Step 13: Node 14955 (Nested Loop)
...
### Step 16: Node 14969 (Index Scan) - LEAF
...
### Step 17: Node 14971 (Seq Scan) - LEAF
...
### Step 18: Node 14953 (Nested Loop)
...
### Step 22: Node 14950 (Gather Merge)
...
### Step 23: Node 14949 (Aggregate) - ROOT
