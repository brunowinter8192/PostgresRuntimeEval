...
**Test Query:** Q12_111_seed_902443410
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge (Out | 2724c080 | 24404 | 24405, 24408, 24409, 24410 |
| Nested Loop -> [Seq Scan (Oute | c53c4396 | 24408 | 24404, 24405, 24409, 24410 |
...
|------|------|--------|-----------|-----|--------|
| 24404 | Aggregate | 990.31 | 1027.05 | 3.7% | pattern |
| 24406 | Aggregate | 968.92 | 940.64 | 2.9% | operator |
| 24407 | Sort | 968.29 | 1050.81 | 8.5% | operator |
| 24408 | Nested Loop | 966.91 | 976.09 | 0.9% | pattern |
...
- **Consumes:** Nodes 24404, 24405, 24409, 24410
- **Input Features:**
  ...
  - NestedLoop_total_cost=147195.7700
...
- **Input Features:**
  ...
  - st1=10.4317
  - st2=0.0000
  - startup_cost=147558.3300
  - total_cost=147572.8300
- **Output:** st=1049.83, rt=1050.81

### Step 3: Node 24406 (Aggregate)
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=147558.3300
  - total_cost=147674.4000
- **Output:** st=925.95, rt=940.64

### Step 4: Node 24404 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 24405, 24408, 24409, 24410
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=7
  - Aggregate_nt1=35
  ...
  - Aggregate_startup_cost=148558.4000
  - Aggregate_total_cost=148679.0200
  ...
  - GatherMerge_Outer_startup_cost=148558.4000
  - GatherMerge_Outer_total_cost=148678.6900
