...
```
Node 26672 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 26672 | 26673, 26674, 26675, 26676, 26677 |
...
|------|------|--------|-----------|-----|--------|
| 26672 | Aggregate | 829.14 | 825.95 | 0.4% | pattern |
...
- **Consumes:** Nodes 26673, 26674, 26675, 26676, 26677
- **Input Features:**
