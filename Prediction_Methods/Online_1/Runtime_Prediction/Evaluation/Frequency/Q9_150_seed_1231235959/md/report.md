...
```
Node 17647 (Sort) - ROOT
  Node 17648 (Aggregate) [PATTERN: 0405d50f]
    Node 17649 (Gather) [consumed]
      Node 17650 (Aggregate) [consumed]
        Node 17651 (Nested Loop) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 0405d50f | 17648 | 17649, 17650, 17651, 17652, 17653, 17654, 17656, 17657, 17660 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 17652 | 17648, 17649, 17650, 17651, 17653, 17654, 17656, 17657, 17660 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 17656 | 17648, 17649, 17650, 17651, 17652, 17653, 17654, 17657, 17660 |
...
|------|------|--------|-----------|-----|--------|
| 17647 | Sort | 1160.90 | 1158.73 | 0.2% | operator |
| 17648 | Aggregate | 1160.76 | 1194.85 | 2.9% | pattern |
...
- **Consumes:** Nodes 17648, 17649, 17650, 17651, 17652, 17653, 17654, 17657, 17660
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=16700
  - HashJoin_nt1=16700
...
- **Consumes:** Nodes 17648, 17649, 17650, 17651, 17653, 17654, 17656, 17657, 17660
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=60132
...
### Step 10: Node 17648 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 0405d50f (Aggregate -> Gather -> Aggregate -> Nested Loop (Outer) (Outer) (Outer))
- **Consumes:** Nodes 17649, 17650, 17651, 17652, 17653, 17654, 17656, 17657, 17660
- **Input Features:**
  ...
  - NestedLoop_Outer_np=0
  - NestedLoop_Outer_nt=60132
  - NestedLoop_Outer_nt1=60132
  - NestedLoop_Outer_nt2=1
  - NestedLoop_Outer_parallel_workers=0
  - NestedLoop_Outer_plan_width=159
  - NestedLoop_Outer_reltuples=0.0000
  - NestedLoop_Outer_sel=1.0000
  - NestedLoop_Outer_startup_cost=14736.6300
  - NestedLoop_Outer_total_cost=175583.0600
- **Output:** st=1188.79, rt=1194.85

### Step 11: Node 17647 (Sort) - ROOT
