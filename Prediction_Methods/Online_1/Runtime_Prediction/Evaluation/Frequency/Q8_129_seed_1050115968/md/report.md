...
```
Node 13914 (Aggregate) - ROOT
  Node 13915 (Gather Merge)
    Node 13916 (Sort)
...
|------|------|--------|-----------|-----|--------|
| 13914 | Aggregate | 1247.85 | 1194.05 | 4.3% | operator |
| 13915 | Gather Merge | 1247.46 | 1123.85 | 9.9% | operator |
| 13916 | Sort | 1242.72 | 1087.88 | 12.5% | operator |
| 13917 | Hash Join | 1242.48 | 1055.47 | 15.1% | operator |
| 13918 | Nested Loop | 1242.18 | 1105.65 | 11.0% | operator |
| 13935 | Hash | 0.02 | 14.54 | 85427.7% | operator |
| 13919 | Hash Join | 1238.28 | 1027.31 | 17.0% | operator |
...
| 13921 | Hash Join | 218.26 | 226.27 | 3.7% | operator |
...
| 13923 | Hash | 36.32 | 18.06 | 50.3% | operator |
| 13924 | Hash Join | 35.19 | 67.97 | 93.1% | operator |
| 13925 | Seq Scan | 33.72 | 24.87 | 26.2% | operator |
| 13926 | Hash | 0.14 | 17.93 | 12264.0% | operator |
| 13927 | Hash Join | 0.14 | 151.58 | 106648.9% | operator |
...
### Step 5: Node 13925 (Seq Scan) - LEAF
...
### Step 8: Node 13922 (Seq Scan) - LEAF
...
### Step 11: Node 13931 (Index Scan) - LEAF
...
### Step 12: Node 13933 (Seq Scan) - LEAF
...
### Step 13: Node 13920 (Nested Loop)
...
### Step 16: Node 13934 (Index Scan) - LEAF
...
### Step 17: Node 13936 (Seq Scan) - LEAF
...
### Step 18: Node 13918 (Nested Loop)
...
### Step 22: Node 13915 (Gather Merge)
...
### Step 23: Node 13914 (Aggregate) - ROOT
