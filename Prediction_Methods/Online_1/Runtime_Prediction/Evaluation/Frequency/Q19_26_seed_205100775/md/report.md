...
**Test Query:** Q19_26_seed_205100775
...
```
Node 31696 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31697 (Gather) [consumed]
    Node 31698 (Aggregate) [consumed]
      Node 31699 (Hash Join) [PATTERN: f4cb205a]
        Node 31700 (Seq Scan) [consumed] - LEAF
        Node 31701 (Hash) [consumed]
          Node 31702 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 31699 | 31696, 31697, 31698, 31700, 31701, 31702 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31696 | 31697, 31698, 31699, 31700, 31701, 31702 |
...
|------|------|--------|-----------|-----|--------|
| 31696 | Aggregate | 847.54 | 834.50 | 1.5% | pattern |
| 31699 | Hash Join | 827.68 | 373.83 | 54.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31699 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 31696, 31697, 31698, 31700, 31701, 31702
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=23
  - HashJoin_nt1=22541
  ...
  - HashJoin_total_cost=156338.6500
  - Hash_Inner_np=0
  - Hash_Inner_nt=202
  - Hash_Inner_nt1=202
  - Hash_Inner_nt2=0
...
### Step 2: Node 31696 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31697, 31698, 31699, 31700, 31701, 31702
- **Input Features:**
  ...
  - Aggregate_Outer_startup_cost=156338.8300
  - Aggregate_Outer_total_cost=156338.8400
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Gather_Outer_startup_cost=157338.8300
  - Gather_Outer_total_cost=157339.3400
