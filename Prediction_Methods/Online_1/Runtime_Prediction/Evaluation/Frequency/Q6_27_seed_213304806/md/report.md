...
```
Node 10177 (Aggregate) [PATTERN: dd3706ac] - ROOT
  Node 10178 (Gather) [consumed]
    Node 10179 (Aggregate) [consumed]
      Node 10180 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | dd3706ac | 10177 | 10178, 10179, 10180 |
...
|------|------|--------|-----------|-----|--------|
| 10177 | Aggregate | 798.16 | 791.26 | 0.9% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10177 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** dd3706ac (Aggregate -> Gather -> Aggregate -> Seq Scan (Outer) (Outer) (Outer))
- **Consumes:** Nodes 10178, 10179, 10180
- **Input Features:**
