    ...
    Node 19209 (Gather) [consumed]
      Node 19210 (Aggregate) [consumed]
        Node 19211 (Nested Loop) [consumed]
          Node 19212 (Hash Join) [PATTERN: 895c6e8c]
            Node 19213 (Seq Scan) [consumed] - LEAF
            Node 19214 (Hash) [consumed]
              Node 19215 (Hash Join)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 0405d50f | 19208 | 19209, 19210, 19211, 19212, 19213, 19214, 19216, 19217, 19220 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 19212 | 19208, 19209, 19210, 19211, 19213, 19214, 19216, 19217, 19220 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 19216 | 19208, 19209, 19210, 19211, 19212, 19213, 19214, 19217, 19220 |
...
| 19212 | Hash Join | 977.87 | 733.84 | 25.0% | pattern |
| 19224 | Index Scan | 0.00 | -0.04 | 1512.7% | operator |
| 19215 | Hash Join | 179.07 | 820.92 | 358.4% | operator |
...
- **Consumes:** Nodes 19208, 19209, 19210, 19211, 19212, 19213, 19214, 19217, 19220
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18037
  - HashJoin_nt1=18037
...
### Step 8: Node 19212 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 19208, 19209, 19210, 19211, 19213, 19214, 19216, 19217, 19220
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=64945
...
### Step 9: Node 19224 (Index Scan) - LEAF
...
### Step 10: Node 19208 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 0405d50f (Aggregate -> Gather -> Aggregate -> Nested Loop (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19209, 19210, 19211, 19212, 19213, 19214, 19216, 19217, 19220
- **Input Features:**
