...
```
Node 7081 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 7082 (Aggregate) [consumed]
    Node 7083 (Gather Merge)
      Node 7084 (Aggregate)
        Node 7085 (Sort)
          Node 7086 (Hash Join) [PATTERN: 2e0f44ef]
            Node 7087 (Nested Loop) [consumed]
              Node 7088 (Hash Join) [PATTERN: 895c6e8c]
                Node 7089 (Seq Scan) [consumed] - LEAF
                Node 7090 (Hash) [consumed]
                  Node 7091 (Hash Join) [PATTERN: 895c6e8c]
                    Node 7092 (Seq Scan) [consumed] - LEAF
                    Node 7093 (Hash) [consumed]
                      Node 7094 (Hash Join) [PATTERN: f4cb205a]
                        Node 7095 (Seq Scan) [consumed] - LEAF
                        Node 7096 (Hash) [consumed]
                          Node 7097 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 7094 | 7081, 7082, 7086, 7087, 7088, 7089, 7090, 7091, 7092, 7093, 7095, 7096, 7097, 7099 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 7088 | 7081, 7082, 7086, 7087, 7089, 7090, 7091, 7092, 7093, 7094, 7095, 7096, 7097, 7099 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 7091 | 7081, 7082, 7086, 7087, 7088, 7089, 7090, 7092, 7093, 7094, 7095, 7096, 7097, 7099 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 7081 | 7082, 7086, 7087, 7088, 7089, 7090, 7091, 7092, 7093, 7094, 7095, 7096, 7097, 7099 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 7086 | 7081, 7082, 7087, 7088, 7089, 7090, 7091, 7092, 7093, 7094, 7095, 7096, 7097, 7099 |
...
|------|------|--------|-----------|-----|--------|
| 7081 | Sort | 1058.77 | 1080.14 | 2.0% | pattern |
| 7083 | Gather Merge | 1058.74 | 1124.36 | 6.2% | operator |
| 7084 | Aggregate | 1053.66 | 1019.70 | 3.2% | operator |
| 7085 | Sort | 1053.40 | 1073.11 | 1.9% | operator |
| 7086 | Hash Join | 1052.91 | 1080.38 | 2.6% | pattern |
| 7088 | Hash Join | 218.19 | 259.82 | 19.1% | pattern |
| 7098 | Index Scan | 0.07 | -0.03 | 134.4% | operator |
| 7100 | Seq Scan | 2.69 | 10.62 | 295.3% | operator |
| 7091 | Hash Join | 36.91 | 84.97 | 130.2% | pattern |
| 7094 | Hash Join | 0.08 | 11.62 | 14985.5% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 7094 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 7081, 7082, 7086, 7087, 7088, 7089, 7090, 7091, 7092, 7093, 7095, 7096, 7097, 7099
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
### Step 2: Node 7091 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 7081, 7082, 7086, 7087, 7088, 7089, 7090, 7092, 7093, 7094, 7095, 7096, 7097, 7099
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=12500
  - HashJoin_nt1=62500
...
### Step 3: Node 7088 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 7081, 7082, 7086, 7087, 7089, 7090, 7091, 7092, 7093, 7094, 7095, 7096, 7097, 7099
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14756
  - HashJoin_nt1=73782
...
### Step 4: Node 7098 (Index Scan) - LEAF
...
### Step 5: Node 7100 (Seq Scan) - LEAF
...
### Step 6: Node 7086 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 7081, 7082, 7087, 7088, 7089, 7090, 7091, 7092, 7093, 7094, 7095, 7096, 7097, 7099
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=2362
  - HashJoin_nt1=59037
...
### Step 10: Node 7081 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 7082, 7086, 7087, 7088, 7089, 7090, 7091, 7092, 7093, 7094, 7095, 7096, 7097, 7099
- **Input Features:**
