...
**Test Query:** Q18_117_seed_951667596
...
```
Node 29108 (Limit) [PATTERN: 6ce7e974] - ROOT
  Node 29109 (Sort) [consumed]
    Node 29110 (Aggregate) [consumed]
      Node 29111 (Gather Merge) [consumed]
        Node 29112 (Incremental Sort) [consumed]
          Node 29113 (Nested Loop)
            Node 29114 (Merge Join)
              Node 29115 (Sort)
                Node 29116 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29117 (Seq Scan) [consumed] - LEAF
                  Node 29118 (Hash) [consumed]
                    Node 29119 (Aggregate)
                      Node 29120 (Index Scan) - LEAF
              Node 29121 (Sort)
                Node 29122 (Seq Scan) - LEAF
            Node 29123 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 6ce7e974 | 29108 | 29109, 29110, 29111, 29112, 29116, 29117, 29118 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29116 | 29108, 29109, 29110, 29111, 29112, 29117, 29118 |
...
|------|------|--------|-----------|-----|--------|
| 29108 | Limit | 3028.62 | 3050.24 | 0.7% | pattern |
| 29113 | Nested Loop | 2867.72 | 1400.02 | 51.2% | operator |
| 29114 | Merge Join | 2867.68 | 2910.61 | 1.5% | operator |
| 29123 | Index Scan | 0.01 | 0.07 | 371.3% | operator |
| 29115 | Sort | 2835.15 | 1098.13 | 61.3% | operator |
| 29121 | Sort | 62.42 | 1014.60 | 1525.3% | operator |
| 29116 | Hash Join | 2835.14 | 688.83 | 75.7% | pattern |
| 29122 | Seq Scan | 51.26 | 25.47 | 50.3% | operator |
| 29119 | Aggregate | 2608.77 | 1300.21 | 50.2% | operator |
| 29120 | Index Scan | 2107.80 | 219.99 | 89.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29120 (Index Scan) - LEAF
...
### Step 3: Node 29116 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29108, 29109, 29110, 29111, 29112, 29117, 29118
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29122 (Seq Scan) - LEAF
...
### Step 8: Node 29123 (Index Scan) - LEAF
...
### Step 10: Node 29108 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 6ce7e974 (Limit -> Sort -> Aggregate -> Gather Merge -> Incremental Sort (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 29109, 29110, 29111, 29112, 29116, 29117, 29118
- **Input Features:**
