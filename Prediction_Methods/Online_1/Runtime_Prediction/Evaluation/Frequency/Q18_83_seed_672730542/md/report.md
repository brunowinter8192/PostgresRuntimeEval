...
**Test Query:** Q18_83_seed_672730542
...
```
Node 30916 (Limit) [PATTERN: 6ce7e974] - ROOT
  Node 30917 (Sort) [consumed]
    Node 30918 (Aggregate) [consumed]
      Node 30919 (Gather Merge) [consumed]
        Node 30920 (Incremental Sort) [consumed]
          Node 30921 (Nested Loop)
            Node 30922 (Merge Join)
              Node 30923 (Sort)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 6ce7e974 | 30916 | 30917, 30918, 30919, 30920, 30924, 30925, 30926 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30924 | 30916, 30917, 30918, 30919, 30920, 30925, 30926 |
...
|------|------|--------|-----------|-----|--------|
| 30916 | Limit | 3069.67 | 3050.24 | 0.6% | pattern |
| 30921 | Nested Loop | 2926.65 | 1400.02 | 52.2% | operator |
| 30922 | Merge Join | 2926.59 | 2910.61 | 0.5% | operator |
| 30931 | Index Scan | 0.02 | 0.07 | 199.9% | operator |
| 30923 | Sort | 2854.95 | 1098.13 | 61.5% | operator |
| 30929 | Sort | 68.75 | 1014.60 | 1375.7% | operator |
| 30924 | Hash Join | 2854.94 | 688.83 | 75.9% | pattern |
| 30930 | Seq Scan | 54.90 | 25.47 | 53.6% | operator |
| 30927 | Aggregate | 2625.01 | 1300.21 | 50.5% | operator |
| 30928 | Index Scan | 2124.18 | 219.99 | 89.6% | operator |
...
- **Consumes:** Nodes 30916, 30917, 30918, 30919, 30920, 30925, 30926
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 30930 (Seq Scan) - LEAF
...
### Step 8: Node 30931 (Index Scan) - LEAF
...
### Step 10: Node 30916 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 6ce7e974 (Limit -> Sort -> Aggregate -> Gather Merge -> Incremental Sort (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 30917, 30918, 30919, 30920, 30924, 30925, 30926
- **Input Features:**
