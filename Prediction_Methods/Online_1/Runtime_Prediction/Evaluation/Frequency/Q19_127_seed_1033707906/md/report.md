...
```
Node 31423 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 31423 | 31424, 31425, 31426, 31427, 31428 |
...
|------|------|--------|-----------|-----|--------|
| 31423 | Aggregate | 811.00 | 841.24 | 3.7% | pattern |
...
- **Consumes:** Nodes 31424, 31425, 31426, 31427, 31428
- **Input Features:**
