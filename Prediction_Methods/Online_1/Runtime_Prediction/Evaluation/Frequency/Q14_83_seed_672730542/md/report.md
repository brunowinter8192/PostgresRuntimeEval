...
**Test Query:** Q14_83_seed_672730542
...
```
Node 27337 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27338 (Gather) [consumed]
    Node 27339 (Aggregate) [consumed]
      Node 27340 (Hash Join) [PATTERN: f4cb205a]
        Node 27341 (Seq Scan) [consumed] - LEAF
        Node 27342 (Hash) [consumed]
          Node 27343 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 27340 | 27337, 27338, 27339, 27341, 27342, 27343 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27337 | 27338, 27339, 27340, 27341, 27342, 27343 |
...
|------|------|--------|-----------|-----|--------|
| 27337 | Aggregate | 815.22 | 834.74 | 2.4% | pattern |
| 27340 | Hash Join | 793.43 | 397.01 | 50.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27340 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 27337, 27338, 27339, 27341, 27342, 27343
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=15762
  - HashJoin_nt1=15762
...
### Step 2: Node 27337 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27338, 27339, 27340, 27341, 27342, 27343
- **Input Features:**
