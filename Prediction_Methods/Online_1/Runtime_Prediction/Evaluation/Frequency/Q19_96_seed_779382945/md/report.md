...
```
Node 32235 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 32235 | 32236, 32237, 32238, 32239, 32240 |
...
|------|------|--------|-----------|-----|--------|
| 32235 | Aggregate | 842.53 | 841.27 | 0.2% | pattern |
...
- **Consumes:** Nodes 32236, 32237, 32238, 32239, 32240
- **Input Features:**
