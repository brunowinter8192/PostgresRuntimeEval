...
```
Node 31304 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 31304 | 31305, 31306, 31307, 31308, 31309 |
...
|------|------|--------|-----------|-----|--------|
| 31304 | Aggregate | 873.83 | 841.26 | 3.7% | pattern |
...
- **Consumes:** Nodes 31305, 31306, 31307, 31308, 31309
- **Input Features:**
