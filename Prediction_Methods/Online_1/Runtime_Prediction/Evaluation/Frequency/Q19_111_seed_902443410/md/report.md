...
Node 31304 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31305 (Gather) [consumed]
    Node 31306 (Aggregate) [consumed]
      Node 31307 (Hash Join) [PATTERN: f4cb205a]
        Node 31308 (Seq Scan) [consumed] - LEAF
        Node 31309 (Hash) [consumed]
          Node 31310 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 31307 | 31304, 31305, 31306, 31308, 31309, 31310 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31304 | 31305, 31306, 31307, 31308, 31309, 31310 |
...
| 31307 | Hash Join | 854.69 | 373.83 | 56.3% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31307 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 31304, 31305, 31306, 31308, 31309, 31310
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=23
  - HashJoin_nt1=22504
  ...
  - HashJoin_total_cost=156338.5500
  - Hash_Inner_np=0
  - Hash_Inner_nt=202
  - Hash_Inner_nt1=202
  - Hash_Inner_nt2=0
...
### Step 2: Node 31304 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31305, 31306, 31307, 31308, 31309, 31310
- **Input Features:**
