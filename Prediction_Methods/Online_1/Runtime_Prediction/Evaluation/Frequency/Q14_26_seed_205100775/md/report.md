...
```
Node 26896 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 26896 | 26897, 26898, 26899, 26900, 26901 |
...
|------|------|--------|-----------|-----|--------|
| 26896 | Aggregate | 811.96 | 825.95 | 1.7% | pattern |
...
- **Consumes:** Nodes 26897, 26898, 26899, 26900, 26901
- **Input Features:**
