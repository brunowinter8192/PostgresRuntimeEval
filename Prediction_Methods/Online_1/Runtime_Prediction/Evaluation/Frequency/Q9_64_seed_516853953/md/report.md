...
Node 18643 (Sort) - ROOT
  Node 18644 (Aggregate) [PATTERN: 0405d50f]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 0405d50f | 18644 | 18645, 18646, 18647, 18648, 18649, 18650, 18652, 18653, 18656 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 18648 | 18644, 18645, 18646, 18647, 18649, 18650, 18652, 18653, 18656 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 18652 | 18644, 18645, 18646, 18647, 18648, 18649, 18650, 18653, 18656 |
...
|------|------|--------|-----------|-----|--------|
| 18643 | Sort | 1180.81 | 1158.73 | 1.9% | operator |
| 18644 | Aggregate | 1180.68 | 1194.85 | 1.2% | pattern |
...
- **Consumes:** Nodes 18644, 18645, 18646, 18647, 18648, 18649, 18650, 18653, 18656
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=16700
  - HashJoin_nt1=16700
...
- **Consumes:** Nodes 18644, 18645, 18646, 18647, 18649, 18650, 18652, 18653, 18656
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=60132
...
### Step 10: Node 18644 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 0405d50f (Aggregate -> Gather -> Aggregate -> Nested Loop (Outer) (Outer) (Outer))
- **Consumes:** Nodes 18645, 18646, 18647, 18648, 18649, 18650, 18652, 18653, 18656
- **Input Features:**
