...
```
Node 10229 (Aggregate) [PATTERN: dd3706ac] - ROOT
  Node 10230 (Gather) [consumed]
    Node 10231 (Aggregate) [consumed]
      Node 10232 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | dd3706ac | 10229 | 10230, 10231, 10232 |
...
|------|------|--------|-----------|-----|--------|
| 10229 | Aggregate | 781.66 | 791.26 | 1.2% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10229 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** dd3706ac (Aggregate -> Gather -> Aggregate -> Seq Scan (Outer) (Outer) (Outer))
- **Consumes:** Nodes 10230, 10231, 10232
- **Input Features:**
