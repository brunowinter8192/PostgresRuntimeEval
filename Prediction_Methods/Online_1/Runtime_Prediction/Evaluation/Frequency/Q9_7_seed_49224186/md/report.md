...
| 5 | c0a8d3de | 6113.5159 | 0.0000% | ACCEPTED | 17.81% |
| 6 | 4fc84c77 | 13.3894 | N/A | SKIPPED_LOW_ERROR | 17.81% |
| 7 | 2e0f44ef | 108.1438 | 0.0001% | ACCEPTED | 17.81% |
| 8 | 37515ad8 | 168.3286 | -0.0000% | REJECTED | 17.81% |
...
| 12 | 7524c54c | 5.2190 | N/A | SKIPPED_LOW_ERROR | 15.97% |
| 13 | 422ae017 | 5.2190 | N/A | SKIPPED_LOW_ERROR | 15.97% |
| 14 | b3a45093 | 2.9042 | N/A | SKIPPED_LOW_ERROR | 15.97% |
| 15 | 2e8f3f67 | 3.5252 | N/A | SKIPPED_LOW_ERROR | 15.97% |
| 16 | efde8b38 | 5.3353 | 0.0189% | ACCEPTED | 15.95% |
| 17 | 444761fb | 24.3176 | N/A | REJECTED | 15.95% |
| 18 | af27a52b | 3.5252 | N/A | SKIPPED_LOW_ERROR | 15.95% |
| 19 | 310134da | 5.3353 | 0.0002% | ACCEPTED | 15.95% |
| 20 | ec92bdaa | 15.1555 | N/A | REJECTED | 15.95% |
| 21 | 7d4e78be | 89.9904 | N/A | REJECTED | 15.95% |
| 22 | 2873b8c3 | 94.8003 | N/A | REJECTED | 15.95% |
| 23 | 30d6e09b | 89.9904 | N/A | REJECTED | 15.95% |
| 24 | 7a51ce50 | 89.9904 | N/A | REJECTED | 15.95% |
| 25 | 1a17c7f7 | 18.3606 | N/A | REJECTED | 15.95% |
| 26 | 6e659102 | 1.4968 | N/A | SKIPPED_LOW_ERROR | 15.95% |
| 27 | e941d0ad | 4.5998 | N/A | REJECTED | 15.95% |
| 28 | fee45978 | 18.3606 | N/A | REJECTED | 15.95% |
| 29 | 49ae7e42 | 4.5998 | N/A | REJECTED | 15.95% |
| 30 | 702e1a46 | 18.3606 | N/A | REJECTED | 15.95% |
| 31 | ed7f2e45 | 4.5998 | N/A | REJECTED | 15.95% |
| 32 | 7542faeb | 0.8805 | N/A | REJECTED | 15.95% |
| 33 | 8951754f | 0.4519 | N/A | REJECTED | 15.95% |
| 34 | 10ed8951 | 0.6347 | N/A | REJECTED | 15.95% |
| 35 | 06fbc794 | 3.5767 | N/A | REJECTED | 15.95% |
| 36 | 5891ae15 | 0.8805 | N/A | REJECTED | 15.95% |
| 37 | d0331b81 | 0.8883 | 0.0313% | ACCEPTED | 15.92% |
| 38 | e92539ee | 0.4519 | N/A | REJECTED | 15.92% |
| 39 | 4ecd02f7 | 0.6347 | N/A | REJECTED | 15.92% |
| 40 | c57cb4bb | 0.8805 | N/A | REJECTED | 15.92% |
| 41 | fa5db8b6 | 0.4519 | 0.1054% | ACCEPTED | 15.81% |
| 42 | 2bac8e6e | 0.8883 | N/A | REJECTED | 15.81% |
| 43 | 2eaabdb6 | 0.6347 | N/A | REJECTED | 15.81% |
| 44 | 9adbbadc | 1.9173 | N/A | REJECTED | 15.81% |
| 45 | 57d290cd | 0.4519 | -0.0000% | REJECTED | 15.81% |
| 46 | 59d2ec49 | 3.5767 | N/A | REJECTED | 15.81% |
| 47 | 6b3fb960 | 0.8805 | N/A | REJECTED | 15.81% |
| 48 | 8259bae3 | 0.8883 | -0.1054% | REJECTED | 15.81% |
| 49 | 6e9566a0 | 0.4519 | -0.0000% | REJECTED | 15.81% |
| 50 | eb55f880 | 0.6347 | -0.1398% | REJECTED | 15.81% |
| 51 | 4021e47f | 0.8883 | -0.1054% | REJECTED | 15.81% |
| 52 | 9a16eb41 | 1.9173 | N/A | REJECTED | 15.81% |
...
```
Node 18952 (Sort) [PATTERN: 5968661e] - ROOT
  Node 18953 (Aggregate) [consumed]
    Node 18954 (Gather) [consumed]
      Node 18955 (Aggregate) [consumed]
        Node 18956 (Hash Join) [consumed]
          Node 18957 (Seq Scan) [consumed] - LEAF
          Node 18958 (Hash) [consumed]
            Node 18959 (Hash Join) [consumed]
              Node 18960 (Seq Scan) [consumed] - LEAF
              Node 18961 (Hash) [consumed]
                Node 18962 (Hash Join) [consumed]
                  Node 18963 (Hash Join) [consumed]
                    Node 18964 (Nested Loop)
                      Node 18965 (Seq Scan) - LEAF
                      Node 18966 (Index Scan) - LEAF
                    Node 18967 (Hash)
                      Node 18968 (Seq Scan) - LEAF
                  Node 18969 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather -> | 5968661e | 18952 | 18953, 18954, 18955, 18956, 18957, 18958, 18959, 18960, 18961, 18962, 18963, 18969 |
...
|------|------|--------|-----------|-----|--------|
| 18952 | Sort | 1284.67 | 1278.10 | 0.5% | pattern |
...
### Step 7: Node 18952 (Sort) - PATTERN ROOT
...
- **Consumes:** Nodes 18953, 18954, 18955, 18956, 18957, 18958, 18959, 18960, 18961, 18962, 18963, 18969
- **Input Features:**
