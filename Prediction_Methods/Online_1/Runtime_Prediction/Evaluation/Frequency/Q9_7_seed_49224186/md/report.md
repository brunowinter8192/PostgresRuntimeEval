...
```
Node 18952 (Sort) [PATTERN: 8951754f] - ROOT
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather -> | 8951754f | 18952 | 18953, 18954, 18955, 18956, 18958, 18959, 18960, 18961, 18963, 18964, 18967 |
| Hash -> Hash Join -> [Seq Scan | c0a8d3de | 18958 | 18952, 18953, 18954, 18955, 18956, 18959, 18960, 18961, 18963, 18964, 18967 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 18963 | 18952, 18953, 18954, 18955, 18956, 18958, 18959, 18960, 18961, 18964, 18967 |
...
| 18958 | Hash | 1044.43 | 44.21 | 95.8% | pattern |
| 18962 | Hash Join | 210.91 | 821.84 | 289.7% | operator |
| 18963 | Hash Join | 195.40 | 981.46 | 402.3% | pattern |
...
### Step 4: Node 18970 (Seq Scan) - LEAF
...
### Step 5: Node 18963 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 18952, 18953, 18954, 18955, 18956, 18958, 18959, 18960, 18961, 18964, 18967
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=22712
  - HashJoin_nt1=22712
  ...
  - NestedLoop_Outer_nt=22712
  - NestedLoop_Outer_nt1=5678
...
- **Output:** st=5.41, rt=981.46

### Step 6: Node 18969 (Hash)
...
- **Output:** st=26.63, rt=821.84

### Step 8: Node 18957 (Seq Scan) - LEAF
...
### Step 9: Node 18958 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** c0a8d3de (Hash -> Hash Join -> [Seq Scan (Outer), Hash (Inner)] (Outer))
- **Consumes:** Nodes 18952, 18953, 18954, 18955, 18956, 18959, 18960, 18961, 18963, 18964, 18967
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=81779
  - HashJoin_Outer_nt1=1200243
  - HashJoin_Outer_nt2=22712
  - HashJoin_Outer_parallel_workers=0
  - HashJoin_Outer_plan_width=131
  - HashJoin_Outer_reltuples=0.0000
  - HashJoin_Outer_sel=0.0000
  - HashJoin_Outer_startup_cost=16186.0900
  - HashJoin_Outer_total_cost=149790.4800
  - Hash_Inner_np=0
  - Hash_Inner_nt=22712
...
- **Output:** st=44.21, rt=44.21

### Step 10: Node 18952 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 8951754f (Sort -> Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 18953, 18954, 18955, 18956, 18958, 18959, 18960, 18961, 18963, 18964, 18967
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=131901
  - HashJoin_Outer_nt1=483871
  - HashJoin_Outer_nt2=81779
  - HashJoin_Outer_parallel_workers=0
  - HashJoin_Outer_plan_width=159
  - HashJoin_Outer_reltuples=0.0000
  - HashJoin_Outer_sel=0.0000
  - HashJoin_Outer_startup_cost=150812.7200
  - HashJoin_Outer_total_cost=184195.5000
  - Sort_np=0
  - Sort_nt=60150
  - Sort_nt1=60150
  - Sort_nt2=0
