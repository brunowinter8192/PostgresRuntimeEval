...
```
Node 17194 (Sort) - ROOT
  Node 17195 (Aggregate) [PATTERN: 0405d50f]
    Node 17196 (Gather) [consumed]
      Node 17197 (Aggregate) [consumed]
        Node 17198 (Nested Loop) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 0405d50f | 17195 | 17196, 17197, 17198, 17199, 17200, 17201, 17203, 17204, 17207 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 17199 | 17195, 17196, 17197, 17198, 17200, 17201, 17203, 17204, 17207 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 17203 | 17195, 17196, 17197, 17198, 17199, 17200, 17201, 17204, 17207 |
...
|------|------|--------|-----------|-----|--------|
| 17194 | Sort | 1168.57 | 1155.83 | 1.1% | operator |
| 17195 | Aggregate | 1168.44 | 1195.07 | 2.3% | pattern |
...
- **Consumes:** Nodes 17195, 17196, 17197, 17198, 17199, 17200, 17201, 17204, 17207
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=13360
  - HashJoin_nt1=13360
...
- **Consumes:** Nodes 17195, 17196, 17197, 17198, 17200, 17201, 17203, 17204, 17207
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=48106
...
### Step 10: Node 17195 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 0405d50f (Aggregate -> Gather -> Aggregate -> Nested Loop (Outer) (Outer) (Outer))
- **Consumes:** Nodes 17196, 17197, 17198, 17199, 17200, 17201, 17203, 17204, 17207
- **Input Features:**
