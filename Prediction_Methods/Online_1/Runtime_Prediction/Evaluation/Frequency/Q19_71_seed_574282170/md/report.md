...
```
Node 32046 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 32046 | 32047, 32048, 32049, 32050, 32051 |
...
|------|------|--------|-----------|-----|--------|
| 32046 | Aggregate | 840.69 | 841.26 | 0.1% | pattern |
...
- **Consumes:** Nodes 32047, 32048, 32049, 32050, 32051
- **Input Features:**
