...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge (Out | 2724c080 | 24635 | 24636, 24639, 24640, 24641 |
| Nested Loop -> [Seq Scan (Oute | c53c4396 | 24639 | 24635, 24636, 24640, 24641 |
...
|------|------|--------|-----------|-----|--------|
| 24635 | Aggregate | 989.24 | 1027.05 | 3.8% | pattern |
| 24637 | Aggregate | 969.38 | 940.64 | 3.0% | operator |
| 24638 | Sort | 968.77 | 1050.81 | 8.5% | operator |
| 24639 | Nested Loop | 967.80 | 976.09 | 0.9% | pattern |
...
- **Consumes:** Nodes 24635, 24636, 24640, 24641
- **Input Features:**
...
### Step 4: Node 24635 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 24636, 24639, 24640, 24641
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=7
  - Aggregate_nt1=35
