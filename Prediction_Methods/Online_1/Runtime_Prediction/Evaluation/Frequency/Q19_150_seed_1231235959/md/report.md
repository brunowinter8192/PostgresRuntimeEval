...
```
Node 31605 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 31605 | 31606, 31607, 31608, 31609, 31610 |
...
|------|------|--------|-----------|-----|--------|
| 31605 | Aggregate | 825.38 | 841.26 | 1.9% | pattern |
...
- **Consumes:** Nodes 31606, 31607, 31608, 31609, 31610
- **Input Features:**
