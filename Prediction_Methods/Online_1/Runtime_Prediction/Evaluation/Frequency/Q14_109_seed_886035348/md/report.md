...
**Test Query:** Q14_109_seed_886035348
...
```
Node 26483 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26484 (Gather) [consumed]
    Node 26485 (Aggregate) [consumed]
      Node 26486 (Hash Join) [PATTERN: f4cb205a]
        Node 26487 (Seq Scan) [consumed] - LEAF
        Node 26488 (Hash) [consumed]
          Node 26489 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 26486 | 26483, 26484, 26485, 26487, 26488, 26489 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26483 | 26484, 26485, 26486, 26487, 26488, 26489 |
...
|------|------|--------|-----------|-----|--------|
| 26483 | Aggregate | 810.16 | 834.74 | 3.0% | pattern |
| 26486 | Hash Join | 788.86 | 397.00 | 49.7% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26486 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 26483, 26484, 26485, 26487, 26488, 26489
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=15778
  - HashJoin_nt1=15778
  ...
  - HashJoin_total_cost=136648.0600
  - Hash_Inner_np=0
  - Hash_Inner_nt=83333
...
- **Output:** st=44.56, rt=397.00

### Step 2: Node 26483 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26484, 26485, 26486, 26487, 26488, 26489
- **Input Features:**
