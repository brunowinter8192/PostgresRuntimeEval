...
**Test Query:** Q18_141_seed_1148564340
...
```
Node 29540 (Limit) [PATTERN: 6ce7e974] - ROOT
  Node 29541 (Sort) [consumed]
    Node 29542 (Aggregate) [consumed]
      Node 29543 (Gather Merge) [consumed]
        Node 29544 (Incremental Sort) [consumed]
          Node 29545 (Nested Loop)
            Node 29546 (Merge Join)
              Node 29547 (Sort)
                Node 29548 (Hash Join) [PATTERN: 895c6e8c]
                  Node 29549 (Seq Scan) [consumed] - LEAF
                  Node 29550 (Hash) [consumed]
                    Node 29551 (Aggregate)
                      Node 29552 (Index Scan) - LEAF
              Node 29553 (Sort)
                Node 29554 (Seq Scan) - LEAF
            Node 29555 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 6ce7e974 | 29540 | 29541, 29542, 29543, 29544, 29548, 29549, 29550 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29548 | 29540, 29541, 29542, 29543, 29544, 29549, 29550 |
...
|------|------|--------|-----------|-----|--------|
| 29540 | Limit | 3047.25 | 3050.24 | 0.1% | pattern |
| 29545 | Nested Loop | 2899.23 | 1400.02 | 51.7% | operator |
| 29546 | Merge Join | 2899.19 | 2910.61 | 0.4% | operator |
| 29555 | Index Scan | 0.02 | 0.07 | 312.4% | operator |
| 29547 | Sort | 2847.47 | 1098.13 | 61.4% | operator |
| 29553 | Sort | 67.49 | 1014.60 | 1403.3% | operator |
| 29548 | Hash Join | 2847.46 | 688.83 | 75.8% | pattern |
| 29554 | Seq Scan | 55.42 | 25.47 | 54.0% | operator |
| 29551 | Aggregate | 2626.92 | 1300.21 | 50.5% | operator |
| 29552 | Index Scan | 2114.32 | 219.99 | 89.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 29552 (Index Scan) - LEAF
...
### Step 3: Node 29548 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 29540, 29541, 29542, 29543, 29544, 29549, 29550
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 4: Node 29554 (Seq Scan) - LEAF
...
### Step 8: Node 29555 (Index Scan) - LEAF
...
### Step 10: Node 29540 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 6ce7e974 (Limit -> Sort -> Aggregate -> Gather Merge -> Incremental Sort (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 29541, 29542, 29543, 29544, 29548, 29549, 29550
- **Input Features:**
