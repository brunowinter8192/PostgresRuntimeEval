...
```
Node 6838 (Aggregate) [PATTERN: 2724c080] - ROOT
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 6840 | 6838, 6839, 6841 |
| Aggregate -> Gather Merge (Out | 2724c080 | 6838 | 6839, 6840, 6841 |
...
|------|------|--------|-----------|-----|--------|
| 6838 | Aggregate | 1032.96 | 1078.91 | 4.4% | pattern |
...
### Step 5: Node 6838 (Aggregate) - PATTERN ROOT
