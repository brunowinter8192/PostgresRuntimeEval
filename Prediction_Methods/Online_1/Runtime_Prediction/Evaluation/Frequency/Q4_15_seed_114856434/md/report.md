...
```
Node 6243 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 6244 (Gather Merge) [consumed]
    Node 6245 (Sort) [PATTERN: 1d35fb97]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 6245 | 6243, 6244, 6246 |
| Aggregate -> Gather Merge (Out | 2724c080 | 6243 | 6244, 6245, 6246 |
...
|------|------|--------|-----------|-----|--------|
| 6243 | Aggregate | 1057.68 | 1078.95 | 2.0% | pattern |
| 6245 | Sort | 1052.07 | 1055.49 | 0.3% | pattern |
...
### Step 4: Node 6245 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 6243, 6244, 6246
- **Input Features:**
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=65985.6100
  - Sort_total_cost=65985.6200
- **Output:** st=1054.33, rt=1055.49

### Step 5: Node 6243 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 6244, 6245, 6246
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=5
  - Aggregate_nt1=15
