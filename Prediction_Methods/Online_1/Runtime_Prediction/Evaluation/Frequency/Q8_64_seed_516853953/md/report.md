...
```
Node 15731 (Aggregate) - ROOT
  Node 15732 (Gather Merge)
    Node 15733 (Sort)
...
|------|------|--------|-----------|-----|--------|
| 15731 | Aggregate | 1263.19 | 1193.80 | 5.5% | operator |
| 15732 | Gather Merge | 1262.79 | 1123.85 | 11.0% | operator |
| 15733 | Sort | 1258.09 | 1087.88 | 13.5% | operator |
| 15734 | Hash Join | 1257.82 | 1055.47 | 16.1% | operator |
| 15735 | Nested Loop | 1257.50 | 1105.65 | 12.1% | operator |
| 15752 | Hash | 0.01 | 14.54 | 103755.1% | operator |
| 15736 | Hash Join | 1253.47 | 1027.31 | 18.0% | operator |
...
| 15738 | Hash Join | 216.88 | 226.27 | 4.3% | operator |
...
| 15740 | Hash | 35.07 | 18.06 | 48.5% | operator |
| 15741 | Hash Join | 34.38 | 67.97 | 97.7% | operator |
| 15742 | Seq Scan | 32.94 | 24.87 | 24.5% | operator |
| 15743 | Hash | 0.14 | 17.93 | 12436.9% | operator |
| 15744 | Hash Join | 0.14 | 151.58 | 108952.8% | operator |
...
### Step 5: Node 15742 (Seq Scan) - LEAF
...
### Step 8: Node 15739 (Seq Scan) - LEAF
...
### Step 11: Node 15748 (Index Scan) - LEAF
...
### Step 12: Node 15750 (Seq Scan) - LEAF
...
### Step 13: Node 15737 (Nested Loop)
...
### Step 16: Node 15751 (Index Scan) - LEAF
...
### Step 17: Node 15753 (Seq Scan) - LEAF
...
### Step 18: Node 15735 (Nested Loop)
...
### Step 22: Node 15732 (Gather Merge)
...
- **Input Features:**
  ...
  - st1=1086.9224
  - st2=0.0000
  - startup_cost=71553.1800
  - total_cost=71841.6100
- **Output:** st=1120.77, rt=1123.85

### Step 23: Node 15731 (Aggregate) - ROOT
...
- **Input Features:**
  ...
  - st2=0.0000
  - startup_cost=71553.1800
  - total_cost=71938.4900
- **Output:** st=1186.39, rt=1193.80
