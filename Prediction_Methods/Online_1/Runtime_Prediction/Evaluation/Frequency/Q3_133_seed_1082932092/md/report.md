    ...
    Node 4713 (Aggregate) [consumed]
      Node 4714 (Gather) [consumed]
        Node 4715 (Nested Loop)
          Node 4716 (Hash Join) [PATTERN: f4cb205a]
            Node 4717 (Seq Scan) [consumed] - LEAF
            Node 4718 (Hash) [consumed]
              Node 4719 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4711 | 4712, 4713, 4714, 4716, 4717, 4718, 4719 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 4716 | 4711, 4712, 4713, 4714, 4717, 4718, 4719 |
...
| 4715 | Nested Loop | 1138.83 | 1122.65 | 1.4% | operator |
| 4716 | Hash Join | 208.61 | 218.70 | 4.8% | pattern |
| 4720 | Index Scan | 0.03 | -0.02 | 174.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4716 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 4711, 4712, 4713, 4714, 4717, 4718, 4719
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47404
  - HashJoin_nt1=237422
...
- **Output:** st=30.14, rt=218.70

### Step 2: Node 4720 (Index Scan) - LEAF
...
- **Output:** st=30.93, rt=1122.65

### Step 4: Node 4711 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4712, 4713, 4714, 4716, 4717, 4718, 4719
- **Input Features:**
