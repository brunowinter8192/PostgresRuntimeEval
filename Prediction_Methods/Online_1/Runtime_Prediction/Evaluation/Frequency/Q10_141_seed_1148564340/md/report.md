...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19955 | 19956, 19957, 19958, 19960, 19961, 19964 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 19960 | 19955, 19956, 19957, 19958, 19961, 19964 |
...
|------|------|--------|-----------|-----|--------|
| 19955 | Limit | 1155.28 | 1154.70 | 0.0% | pattern |
| 19959 | Hash Join | 1110.80 | 1087.19 | 2.1% | operator |
...
- **Consumes:** Nodes 19955, 19956, 19957, 19958, 19961, 19964
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=17881
  - HashJoin_nt1=17881
...
- **Output:** st=39.26, rt=1087.19

### Step 8: Node 19955 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19956, 19957, 19958, 19960, 19961, 19964
- **Input Features:**
