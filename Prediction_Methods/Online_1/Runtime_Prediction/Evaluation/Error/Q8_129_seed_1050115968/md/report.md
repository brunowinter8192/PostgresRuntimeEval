...
Node 13914 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 13915 (Gather Merge) [consumed]
    Node 13916 (Sort)
      Node 13917 (Hash Join) [PATTERN: 2e0f44ef]
        Node 13918 (Nested Loop) [consumed]
          Node 13919 (Hash Join) [PATTERN: 2e0f44ef]
            Node 13920 (Nested Loop) [consumed]
              Node 13921 (Hash Join) [PATTERN: 895c6e8c]
                Node 13922 (Seq Scan) [consumed] - LEAF
                Node 13923 (Hash) [consumed]
                  Node 13924 (Hash Join)
                    Node 13925 (Seq Scan) - LEAF
                    Node 13926 (Hash) [PATTERN: a54055ce]
                      Node 13927 (Hash Join) [consumed]
                        Node 13928 (Seq Scan) [consumed] - LEAF
                        Node 13929 (Hash) [consumed]
                          Node 13930 (Seq Scan) [consumed] - LEAF
              Node 13931 (Index Scan) - LEAF
            Node 13932 (Hash) [consumed]
              Node 13933 (Seq Scan) - LEAF
          Node 13934 (Index Scan) - LEAF
        Node 13935 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 13926 | 13914, 13915, 13917, 13918, 13919, 13920, 13921, 13922, 13923, 13927, 13928, 13929, 13930, 13932, 13935 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 13921 | 13914, 13915, 13917, 13918, 13919, 13920, 13922, 13923, 13926, 13927, 13928, 13929, 13930, 13932, 13935 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 13917 | 13914, 13915, 13918, 13919, 13920, 13921, 13922, 13923, 13926, 13927, 13928, 13929, 13930, 13932, 13935 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 13919 | 13914, 13915, 13917, 13918, 13920, 13921, 13922, 13923, 13926, 13927, 13928, 13929, 13930, 13932, 13935 |
| Aggregate -> Gather Merge (Out | 2724c080 | 13914 | 13915, 13917, 13918, 13919, 13920, 13921, 13922, 13923, 13926, 13927, 13928, 13929, 13930, 13932, 13935 |
...
| 13916 | Sort | 1242.72 | 1096.02 | 11.8% | operator |
| 13917 | Hash Join | 1242.48 | 1199.17 | 3.5% | pattern |
| 13919 | Hash Join | 1238.28 | 1192.82 | 3.7% | pattern |
| 13934 | Index Scan | 0.01 | 0.05 | 753.5% | operator |
| 13936 | Seq Scan | 0.01 | 7.19 | 59854.0% | operator |
| 13921 | Hash Join | 218.26 | 260.30 | 19.3% | pattern |
| 13931 | Index Scan | 0.04 | 0.09 | 107.2% | operator |
| 13933 | Seq Scan | 38.23 | 44.48 | 16.4% | operator |
| 13924 | Hash Join | 35.19 | 67.79 | 92.6% | operator |
| 13925 | Seq Scan | 33.72 | 24.87 | 26.2% | operator |
| 13926 | Hash | 0.14 | 0.20 | 34.7% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 13925 (Seq Scan) - LEAF
...
### Step 2: Node 13926 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 13914, 13915, 13917, 13918, 13919, 13920, 13921, 13922, 13923, 13927, 13928, 13929, 13930, 13932, 13935
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 4: Node 13921 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 13914, 13915, 13917, 13918, 13919, 13920, 13922, 13923, 13926, 13927, 13928, 13929, 13930, 13932, 13935
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=29497
  - HashJoin_nt1=147487
...
### Step 5: Node 13931 (Index Scan) - LEAF
...
### Step 6: Node 13933 (Seq Scan) - LEAF
...
### Step 7: Node 13919 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 13914, 13915, 13917, 13918, 13920, 13921, 13922, 13923, 13926, 13927, 13928, 13929, 13930, 13932, 13935
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=785
  - HashJoin_nt1=118013
...
### Step 8: Node 13934 (Index Scan) - LEAF
...
### Step 9: Node 13936 (Seq Scan) - LEAF
...
### Step 10: Node 13917 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 13914, 13915, 13918, 13919, 13920, 13921, 13922, 13923, 13926, 13927, 13928, 13929, 13930, 13932, 13935
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=785
  - HashJoin_nt1=785
  ...
  - HashJoin_total_cost=70515.0300
  - Hash_Inner_np=0
  - Hash_Inner_nt=25
  - Hash_Inner_nt1=25
  - Hash_Inner_nt2=0
  ...
  - NestedLoop_Outer_np=0
  - NestedLoop_Outer_nt=785
  - NestedLoop_Outer_nt1=785
  ...
  - NestedLoop_Outer_total_cost=70509.1000
- **Output:** st=80.31, rt=1199.17

### Step 11: Node 13916 (Sort)
...
### Step 12: Node 13914 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 13915, 13917, 13918, 13919, 13920, 13921, 13922, 13923, 13926, 13927, 13928, 13929, 13930, 13932, 13935
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2435
