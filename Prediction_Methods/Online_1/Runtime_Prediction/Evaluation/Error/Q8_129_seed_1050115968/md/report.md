...
```
Node 13914 (Aggregate) [PATTERN: 53f9aa07] - ROOT
  Node 13915 (Gather Merge) [consumed]
    Node 13916 (Sort) [consumed]
      Node 13917 (Hash Join) [consumed]
        Node 13918 (Nested Loop) [consumed]
          Node 13919 (Hash Join)
            Node 13920 (Nested Loop) [PATTERN: bd9dfa7b]
              Node 13921 (Hash Join) [consumed]
              ...
              Node 13931 (Index Scan) [consumed] - LEAF
            Node 13932 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 53f9aa07 | 13914 | 13915, 13916, 13917, 13918, 13920, 13921, 13922, 13923, 13924, 13926, 13927, 13928, 13929, 13930, 13931, 13935 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 13926 | 13914, 13915, 13916, 13917, 13918, 13920, 13921, 13922, 13923, 13924, 13927, 13928, 13929, 13930, 13931, 13935 |
| Nested Loop -> [Hash Join -> [ | bd9dfa7b | 13920 | 13914, 13915, 13916, 13917, 13918, 13921, 13922, 13923, 13924, 13926, 13927, 13928, 13929, 13930, 13931, 13935 |
...
|------|------|--------|-----------|-----|--------|
| 13914 | Aggregate | 1247.85 | 1220.51 | 2.2% | pattern |
| 13919 | Hash Join | 1238.28 | 1042.87 | 15.8% | operator |
| 13934 | Index Scan | 0.01 | 0.05 | 753.5% | operator |
| 13936 | Seq Scan | 0.01 | 7.19 | 59854.0% | operator |
| 13920 | Nested Loop | 1195.39 | 1155.06 | 3.4% | pattern |
...
- **Consumes:** Nodes 13914, 13915, 13916, 13917, 13918, 13920, 13921, 13922, 13923, 13924, 13927, 13928, 13929, 13930, 13931, 13935
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 3: Node 13933 (Seq Scan) - LEAF
...
### Step 4: Node 13920 (Nested Loop) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bd9dfa7b (Nested Loop -> [Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer), Index Scan (Inner)])
- **Consumes:** Nodes 13914, 13915, 13916, 13917, 13918, 13921, 13922, 13923, 13924, 13926, 13927, 13928, 13929, 13930, 13931, 13935
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 7: Node 13934 (Index Scan) - LEAF
...
### Step 8: Node 13936 (Seq Scan) - LEAF
...
### Step 9: Node 13914 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 53f9aa07 (Aggregate -> Gather Merge -> Sort -> Hash Join -> [Nested Loop (Outer), Hash (Inner)] (Outer) (Outer) (Outer))
- **Consumes:** Nodes 13915, 13916, 13917, 13918, 13920, 13921, 13922, 13923, 13924, 13926, 13927, 13928, 13929, 13930, 13931, 13935
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2435
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=785
  - HashJoin_Outer_nt1=785
  ...
  - HashJoin_Outer_total_cost=70515.0300
  - Hash_Inner_np=0
  - Hash_Inner_nt=25
  - Hash_Inner_nt1=25
  - Hash_Inner_nt2=0
  ...
  - Sort_Outer_startup_cost=70552.7800
  - Sort_Outer_total_cost=70554.7400
