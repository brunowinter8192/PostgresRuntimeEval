...
```
Node 6677 (Aggregate) [PATTERN: 80bd802d] - ROOT
  Node 6678 (Gather Merge) [consumed]
    Node 6679 (Sort) [consumed]
      Node 6680 (Aggregate) [consumed]
        Node 6681 (Nested Loop) [consumed]
          Node 6682 (Seq Scan) [consumed] - LEAF
          Node 6683 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 80bd802d | 6677 | 6678, 6679, 6680, 6681, 6682, 6683 |
...
|------|------|--------|-----------|-----|--------|
| 6677 | Aggregate | 1073.88 | 1057.79 | 1.5% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6677 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 6678, 6679, 6680, 6681, 6682, 6683
- **Input Features:**
  ...
  - NestedLoop_Outer_total_cost=65569.1600
  - SeqScan_Outer_np=26136
  - SeqScan_Outer_nt=17945
  - SeqScan_Outer_nt1=0
  - SeqScan_Outer_nt2=0
