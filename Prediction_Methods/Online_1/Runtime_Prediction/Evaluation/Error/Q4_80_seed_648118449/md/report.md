...
```
Node 6747 (Aggregate) [PATTERN: 80bd802d] - ROOT
  Node 6748 (Gather Merge) [consumed]
    Node 6749 (Sort) [consumed]
      Node 6750 (Aggregate) [consumed]
        Node 6751 (Nested Loop) [consumed]
          Node 6752 (Seq Scan) [consumed] - LEAF
          Node 6753 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 80bd802d | 6747 | 6748, 6749, 6750, 6751, 6752, 6753 |
...
|------|------|--------|-----------|-----|--------|
| 6747 | Aggregate | 1039.52 | 1057.79 | 1.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6747 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 6748, 6749, 6750, 6751, 6752, 6753
- **Input Features:**
