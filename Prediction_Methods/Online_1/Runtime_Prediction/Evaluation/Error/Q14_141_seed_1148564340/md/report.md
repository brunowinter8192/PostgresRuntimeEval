...
```
Node 26735 (Aggregate) [PATTERN: f8295d8b] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 26735 | 26736, 26737, 26738, 26739, 26740, 26741 |
...
|------|------|--------|-----------|-----|--------|
| 26735 | Aggregate | 823.02 | 822.80 | 0.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26735 (Aggregate) - PATTERN ROOT
