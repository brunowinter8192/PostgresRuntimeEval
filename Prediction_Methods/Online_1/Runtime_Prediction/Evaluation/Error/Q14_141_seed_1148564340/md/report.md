...
Node 26735 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26736 (Gather) [consumed]
    Node 26737 (Aggregate) [consumed]
      Node 26738 (Hash Join) [PATTERN: f4cb205a]
        Node 26739 (Seq Scan) [consumed] - LEAF
        Node 26740 (Hash) [consumed]
          Node 26741 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 26738 | 26735, 26736, 26737, 26739, 26740, 26741 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26735 | 26736, 26737, 26738, 26739, 26740, 26741 |
...
| 26738 | Hash Join | 800.49 | 397.22 | 50.4% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26738 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 26735, 26736, 26737, 26739, 26740, 26741
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14664
  - HashJoin_nt1=14664
...
### Step 2: Node 26735 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26736, 26737, 26738, 26739, 26740, 26741
- **Input Features:**
