...
```
Node 24803 (Aggregate) [PATTERN: f9c97829] - ROOT
  Node 24804 (Gather Merge) [consumed]
    Node 24805 (Aggregate) [consumed]
      Node 24806 (Sort) [consumed]
        Node 24807 (Nested Loop) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> A | f9c97829 | 24803 | 24804, 24805, 24806, 24807, 24808, 24809 |
...
|------|------|--------|-----------|-----|--------|
| 24803 | Aggregate | 987.51 | 998.49 | 1.1% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24803 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 24804, 24805, 24806, 24807, 24808, 24809
- **Input Features:**
  ...
  - NestedLoop_Outer_total_cost=147181.8100
  ...
  - Sort_Outer_startup_cost=147543.3100
  - Sort_Outer_total_cost=147557.7800
