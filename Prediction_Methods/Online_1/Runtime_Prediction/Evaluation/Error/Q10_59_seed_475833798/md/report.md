    ...
    Node 20724 (Aggregate) [consumed]
      Node 20725 (Gather) [consumed]
        Node 20726 (Hash Join) [consumed]
          Node 20727 (Hash Join) [PATTERN: 2873b8c3]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 20722 | 20723, 20724, 20725, 20726, 20727, 20728, 20729, 20730, 20731, 20732 |
| Hash Join -> [Nested Loop -> [ | 2873b8c3 | 20727 | 20722, 20723, 20724, 20725, 20726, 20728, 20729, 20730, 20731, 20732 |
...
### Step 2: Node 20727 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2873b8c3 (Hash Join -> [Nested Loop -> [Seq Scan (Outer), Index Scan (Inner)] (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 20722, 20723, 20724, 20725, 20726, 20728, 20729, 20730, 20731, 20732
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18186
  - HashJoin_nt1=18186
...
### Step 4: Node 20722 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20723, 20724, 20725, 20726, 20727, 20728, 20729, 20730, 20731, 20732
- **Input Features:**
