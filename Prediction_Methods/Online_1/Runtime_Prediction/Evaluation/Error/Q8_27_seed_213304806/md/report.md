...
Node 14788 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 14789 (Gather Merge) [consumed]
    Node 14790 (Sort)
      Node 14791 (Hash Join) [PATTERN: 2e0f44ef]
        Node 14792 (Nested Loop) [consumed]
          Node 14793 (Hash Join) [PATTERN: 2e0f44ef]
            Node 14794 (Nested Loop) [consumed]
              Node 14795 (Hash Join) [PATTERN: 895c6e8c]
                Node 14796 (Seq Scan) [consumed] - LEAF
                Node 14797 (Hash) [consumed]
                  Node 14798 (Hash Join)
                    Node 14799 (Seq Scan) - LEAF
                    Node 14800 (Hash) [PATTERN: a54055ce]
                      Node 14801 (Hash Join) [consumed]
                        Node 14802 (Seq Scan) [consumed] - LEAF
                        Node 14803 (Hash) [consumed]
                          Node 14804 (Seq Scan) [consumed] - LEAF
              Node 14805 (Index Scan) - LEAF
            Node 14806 (Hash) [consumed]
              Node 14807 (Seq Scan) - LEAF
          Node 14808 (Index Scan) - LEAF
        Node 14809 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 14800 | 14788, 14789, 14791, 14792, 14793, 14794, 14795, 14796, 14797, 14801, 14802, 14803, 14804, 14806, 14809 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 14795 | 14788, 14789, 14791, 14792, 14793, 14794, 14796, 14797, 14800, 14801, 14802, 14803, 14804, 14806, 14809 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 14791 | 14788, 14789, 14792, 14793, 14794, 14795, 14796, 14797, 14800, 14801, 14802, 14803, 14804, 14806, 14809 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 14793 | 14788, 14789, 14791, 14792, 14794, 14795, 14796, 14797, 14800, 14801, 14802, 14803, 14804, 14806, 14809 |
| Aggregate -> Gather Merge (Out | 2724c080 | 14788 | 14789, 14791, 14792, 14793, 14794, 14795, 14796, 14797, 14800, 14801, 14802, 14803, 14804, 14806, 14809 |
...
| 14790 | Sort | 1203.82 | 1096.02 | 9.0% | operator |
| 14791 | Hash Join | 1203.56 | 1199.17 | 0.4% | pattern |
| 14793 | Hash Join | 1199.40 | 1192.82 | 0.5% | pattern |
| 14808 | Index Scan | 0.01 | 0.05 | 753.5% | operator |
| 14810 | Seq Scan | 0.01 | 7.19 | 71844.7% | operator |
| 14795 | Hash Join | 212.20 | 260.30 | 22.7% | pattern |
| 14805 | Index Scan | 0.04 | 0.09 | 112.3% | operator |
| 14807 | Seq Scan | 38.49 | 44.49 | 15.6% | operator |
| 14798 | Hash Join | 32.96 | 67.79 | 105.7% | operator |
| 14799 | Seq Scan | 30.97 | 24.87 | 19.7% | operator |
| 14800 | Hash | 0.23 | 0.20 | 14.7% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 14799 (Seq Scan) - LEAF
...
### Step 2: Node 14800 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 14788, 14789, 14791, 14792, 14793, 14794, 14795, 14796, 14797, 14801, 14802, 14803, 14804, 14806, 14809
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 4: Node 14795 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 14788, 14789, 14791, 14792, 14793, 14794, 14796, 14797, 14800, 14801, 14802, 14803, 14804, 14806, 14809
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=29497
  - HashJoin_nt1=147487
...
### Step 5: Node 14805 (Index Scan) - LEAF
...
### Step 6: Node 14807 (Seq Scan) - LEAF
...
### Step 7: Node 14793 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 14788, 14789, 14791, 14792, 14794, 14795, 14796, 14797, 14800, 14801, 14802, 14803, 14804, 14806, 14809
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=784
  - HashJoin_nt1=118013
  ...
  - HashJoin_reltuples=0.0000
  - HashJoin_sel=0.0000
  - HashJoin_startup_cost=9920.1000
  - HashJoin_total_cost=70271.5800
  - Hash_Inner_np=0
  - Hash_Inner_nt=553
  - Hash_Inner_nt1=553
  - Hash_Inner_nt2=0
...
### Step 8: Node 14808 (Index Scan) - LEAF
...
### Step 9: Node 14810 (Seq Scan) - LEAF
...
### Step 10: Node 14791 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 14788, 14789, 14792, 14793, 14794, 14795, 14796, 14797, 14800, 14801, 14802, 14803, 14804, 14806, 14809
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=784
  - HashJoin_nt1=784
  ...
  - HashJoin_reltuples=0.0000
  - HashJoin_sel=0.0400
  - HashJoin_startup_cost=9921.9500
  - HashJoin_total_cost=70514.7000
  - Hash_Inner_np=0
  - Hash_Inner_nt=25
  - Hash_Inner_nt1=25
  - Hash_Inner_nt2=0
  ...
  - NestedLoop_Outer_startup_cost=9920.3900
  - NestedLoop_Outer_total_cost=70508.7700
- **Output:** st=80.31, rt=1199.17

### Step 11: Node 14790 (Sort)
...
### Step 12: Node 14788 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 14789, 14791, 14792, 14793, 14794, 14795, 14796, 14797, 14800, 14801, 14802, 14803, 14804, 14806, 14809
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2429
