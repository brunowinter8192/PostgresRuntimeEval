...
```
Node 14788 (Aggregate) [PATTERN: 53f9aa07] - ROOT
  Node 14789 (Gather Merge) [consumed]
    Node 14790 (Sort) [consumed]
      Node 14791 (Hash Join) [consumed]
        Node 14792 (Nested Loop) [consumed]
          Node 14793 (Hash Join)
            Node 14794 (Nested Loop) [PATTERN: bd9dfa7b]
              Node 14795 (Hash Join) [consumed]
              ...
              Node 14805 (Index Scan) [consumed] - LEAF
            Node 14806 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 53f9aa07 | 14788 | 14789, 14790, 14791, 14792, 14794, 14795, 14796, 14797, 14798, 14800, 14801, 14802, 14803, 14804, 14805, 14809 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 14800 | 14788, 14789, 14790, 14791, 14792, 14794, 14795, 14796, 14797, 14798, 14801, 14802, 14803, 14804, 14805, 14809 |
| Nested Loop -> [Hash Join -> [ | bd9dfa7b | 14794 | 14788, 14789, 14790, 14791, 14792, 14795, 14796, 14797, 14798, 14800, 14801, 14802, 14803, 14804, 14805, 14809 |
...
|------|------|--------|-----------|-----|--------|
| 14788 | Aggregate | 1210.34 | 1220.51 | 0.8% | pattern |
| 14793 | Hash Join | 1199.40 | 1042.87 | 13.1% | operator |
| 14808 | Index Scan | 0.01 | 0.05 | 753.5% | operator |
| 14810 | Seq Scan | 0.01 | 7.19 | 71844.7% | operator |
| 14794 | Nested Loop | 1156.39 | 1155.06 | 0.1% | pattern |
...
- **Consumes:** Nodes 14788, 14789, 14790, 14791, 14792, 14794, 14795, 14796, 14797, 14798, 14801, 14802, 14803, 14804, 14805, 14809
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 3: Node 14807 (Seq Scan) - LEAF
...
### Step 4: Node 14794 (Nested Loop) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bd9dfa7b (Nested Loop -> [Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer), Index Scan (Inner)])
- **Consumes:** Nodes 14788, 14789, 14790, 14791, 14792, 14795, 14796, 14797, 14798, 14800, 14801, 14802, 14803, 14804, 14805, 14809
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 7: Node 14808 (Index Scan) - LEAF
...
### Step 8: Node 14810 (Seq Scan) - LEAF
...
### Step 9: Node 14788 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 53f9aa07 (Aggregate -> Gather Merge -> Sort -> Hash Join -> [Nested Loop (Outer), Hash (Inner)] (Outer) (Outer) (Outer))
- **Consumes:** Nodes 14789, 14790, 14791, 14792, 14794, 14795, 14796, 14797, 14798, 14800, 14801, 14802, 14803, 14804, 14805, 14809
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2429
  ...
  - HashJoin_Outer_reltuples=0.0000
  - HashJoin_Outer_sel=0.0400
  - HashJoin_Outer_startup_cost=9921.9500
  - HashJoin_Outer_total_cost=70514.7000
  - Hash_Inner_np=0
  - Hash_Inner_nt=25
  - Hash_Inner_nt1=25
  - Hash_Inner_nt2=0
  ...
  - Sort_Outer_startup_cost=70552.3900
  - Sort_Outer_total_cost=70554.3500
