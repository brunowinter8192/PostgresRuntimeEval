...
```
Node 26546 (Aggregate) [PATTERN: f8295d8b] - ROOT
  Node 26547 (Gather) [consumed]
    Node 26548 (Aggregate) [consumed]
      Node 26549 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 26546 | 26547, 26548, 26549, 26550, 26551, 26552 |
...
|------|------|--------|-----------|-----|--------|
| 26546 | Aggregate | 799.83 | 822.66 | 2.9% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26546 (Aggregate) - PATTERN ROOT
