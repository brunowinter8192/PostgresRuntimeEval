...
```
Node 25846 (Sort) [PATTERN: 35ffb644] - ROOT
  Node 25847 (Aggregate) [consumed]
    Node 25848 (Aggregate) [consumed]
      Node 25849 (Hash Join)
        Node 25850 (Seq Scan) - LEAF
        Node 25851 (Hash)
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Aggregate | 35ffb644 | 25846 | 25847, 25848 |
...
| 25849 | Hash Join | 695.28 | 705.85 | 1.5% | operator |
| 25850 | Seq Scan | 484.21 | 412.66 | 14.8% | operator |
| 25851 | Hash | 15.51 | 37.64 | 142.7% | operator |
| 25852 | Index Only Scan | 10.08 | 10.09 | 0.0% | operator |
...
### Step 2: Node 25850 (Seq Scan) - LEAF
...
### Step 5: Node 25846 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 35ffb644 (Sort -> Aggregate -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 25847, 25848
- **Input Features:**
