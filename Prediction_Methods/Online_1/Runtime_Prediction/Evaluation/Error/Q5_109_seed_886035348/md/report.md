              ...
              Node 7088 (Hash Join) [PATTERN: 895c6e8c]
                ...
                Node 7090 (Hash) [consumed]
                  Node 7091 (Hash Join)
                    ...
                    Node 7093 (Hash) [PATTERN: a54055ce]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 7093 | 7081, 7082, 7086, 7087, 7088, 7089, 7090, 7094, 7095, 7096, 7097, 7099 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 7088 | 7081, 7082, 7086, 7087, 7089, 7090, 7093, 7094, 7095, 7096, 7097, 7099 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 7086 | 7081, 7082, 7087, 7088, 7089, 7090, 7093, 7094, 7095, 7096, 7097, 7099 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 7081 | 7082, 7086, 7087, 7088, 7089, 7090, 7093, 7094, 7095, 7096, 7097, 7099 |
...
| 7091 | Hash Join | 36.91 | 62.70 | 69.8% | operator |
| 7092 | Seq Scan | 35.50 | 24.87 | 29.9% | operator |
| 7093 | Hash | 0.08 | 0.14 | 68.2% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 7092 (Seq Scan) - LEAF
...
### Step 2: Node 7093 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 7081, 7082, 7086, 7087, 7088, 7089, 7090, 7094, 7095, 7096, 7097, 7099
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 4: Node 7088 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 7081, 7082, 7086, 7087, 7089, 7090, 7093, 7094, 7095, 7096, 7097, 7099
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14756
  - HashJoin_nt1=73782
...
### Step 7: Node 7086 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 7081, 7082, 7087, 7088, 7089, 7090, 7093, 7094, 7095, 7096, 7097, 7099
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=2362
  - HashJoin_nt1=59037
...
### Step 10: Node 7083 (Gather Merge)
...
### Step 11: Node 7081 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 7082, 7086, 7087, 7088, 7089, 7090, 7093, 7094, 7095, 7096, 7097, 7099
- **Input Features:**
