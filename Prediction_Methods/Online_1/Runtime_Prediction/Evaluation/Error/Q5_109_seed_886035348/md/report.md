...
```
Node 7081 (Sort) [PATTERN: 255215ee] - ROOT
        ...
        Node 7085 (Sort) [consumed]
          Node 7086 (Hash Join) [consumed]
            Node 7087 (Nested Loop) [consumed]
              ...
              Node 7098 (Index Scan) [consumed] - LEAF
            Node 7099 (Hash) [consumed]
              Node 7100 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather Me | 255215ee | 7081 | 7082, 7083, 7084, 7085, 7086, 7087, 7088, 7089, 7090, 7091, 7092, 7093, 7094, 7098, 7099, 7100 |
...
|------|------|--------|-----------|-----|--------|
| 7081 | Sort | 1058.77 | 1070.44 | 1.1% | pattern |
...
### Step 4: Node 7081 (Sort) - PATTERN ROOT
...
- **Consumes:** Nodes 7082, 7083, 7084, 7085, 7086, 7087, 7088, 7089, 7090, 7091, 7092, 7093, 7094, 7098, 7099, 7100
- **Input Features:**
