...
Node 32116 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 32117 (Gather) [consumed]
    Node 32118 (Aggregate) [consumed]
      Node 32119 (Hash Join) [PATTERN: f4cb205a]
        Node 32120 (Seq Scan) [consumed] - LEAF
        Node 32121 (Hash) [consumed]
          Node 32122 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 32119 | 32116, 32117, 32118, 32120, 32121, 32122 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 32116 | 32117, 32118, 32119, 32120, 32121, 32122 |
...
| 32119 | Hash Join | 812.87 | 373.83 | 54.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 32119 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 32116, 32117, 32118, 32120, 32121, 32122
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=23
  - HashJoin_nt1=22461
  ...
  - HashJoin_total_cost=156338.4700
  - Hash_Inner_np=0
  - Hash_Inner_nt=204
  - Hash_Inner_nt1=204
  - Hash_Inner_nt2=0
...
### Step 2: Node 32116 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 32117, 32118, 32119, 32120, 32121, 32122
- **Input Features:**
