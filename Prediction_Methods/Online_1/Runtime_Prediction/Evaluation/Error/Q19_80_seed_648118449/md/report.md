...
```
Node 32116 (Aggregate) [PATTERN: f8295d8b] - ROOT
  Node 32117 (Gather) [consumed]
    Node 32118 (Aggregate) [consumed]
      Node 32119 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 32116 | 32117, 32118, 32119, 32120, 32121, 32122 |
...
|------|------|--------|-----------|-----|--------|
| 32116 | Aggregate | 834.53 | 841.17 | 0.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 32116 (Aggregate) - PATTERN ROOT
