...
```
Node 321 (Aggregate) [PATTERN: 3dfa6025] - ROOT
  Node 322 (Gather Merge) [consumed]
    Node 323 (Sort) [consumed]
      Node 324 (Aggregate) [consumed]
        Node 325 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 3dfa6025 | 321 | 322, 323, 324, 325 |
...
|------|------|--------|-----------|-----|--------|
| 321 | Aggregate | 937.30 | 953.98 | 1.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 321 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3dfa6025 (Aggregate -> Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 322, 323, 324, 325
- **Input Features:**
