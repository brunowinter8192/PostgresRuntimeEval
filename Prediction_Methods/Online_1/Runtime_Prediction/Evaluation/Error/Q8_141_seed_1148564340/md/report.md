...
Node 14236 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 14237 (Gather Merge) [consumed]
    Node 14238 (Sort)
      Node 14239 (Hash Join) [PATTERN: 2e0f44ef]
        Node 14240 (Nested Loop) [consumed]
          Node 14241 (Hash Join) [PATTERN: 2e0f44ef]
            Node 14242 (Nested Loop) [consumed]
              Node 14243 (Hash Join) [PATTERN: 895c6e8c]
                Node 14244 (Seq Scan) [consumed] - LEAF
                Node 14245 (Hash) [consumed]
                  Node 14246 (Hash Join)
                    Node 14247 (Seq Scan) - LEAF
                    Node 14248 (Hash) [PATTERN: a54055ce]
                      Node 14249 (Hash Join) [consumed]
                        Node 14250 (Seq Scan) [consumed] - LEAF
                        Node 14251 (Hash) [consumed]
                          Node 14252 (Seq Scan) [consumed] - LEAF
              Node 14253 (Index Scan) - LEAF
            Node 14254 (Hash) [consumed]
              Node 14255 (Seq Scan) - LEAF
          Node 14256 (Index Scan) - LEAF
        Node 14257 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 14248 | 14236, 14237, 14239, 14240, 14241, 14242, 14243, 14244, 14245, 14249, 14250, 14251, 14252, 14254, 14257 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 14243 | 14236, 14237, 14239, 14240, 14241, 14242, 14244, 14245, 14248, 14249, 14250, 14251, 14252, 14254, 14257 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 14239 | 14236, 14237, 14240, 14241, 14242, 14243, 14244, 14245, 14248, 14249, 14250, 14251, 14252, 14254, 14257 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 14241 | 14236, 14237, 14239, 14240, 14242, 14243, 14244, 14245, 14248, 14249, 14250, 14251, 14252, 14254, 14257 |
| Aggregate -> Gather Merge (Out | 2724c080 | 14236 | 14237, 14239, 14240, 14241, 14242, 14243, 14244, 14245, 14248, 14249, 14250, 14251, 14252, 14254, 14257 |
...
| 14238 | Sort | 1271.86 | 1096.01 | 13.8% | operator |
| 14239 | Hash Join | 1271.62 | 1199.17 | 5.7% | pattern |
| 14241 | Hash Join | 1267.44 | 1192.84 | 5.9% | pattern |
| 14256 | Index Scan | 0.01 | 0.05 | 753.5% | operator |
| 14258 | Seq Scan | 0.01 | 7.19 | 55242.1% | operator |
| 14243 | Hash Join | 230.14 | 260.30 | 13.1% | pattern |
| 14253 | Index Scan | 0.04 | 0.09 | 102.4% | operator |
| 14255 | Seq Scan | 40.79 | 44.49 | 9.1% | operator |
| 14246 | Hash Join | 35.11 | 67.79 | 93.1% | operator |
| 14247 | Seq Scan | 33.47 | 24.87 | 25.7% | operator |
| 14248 | Hash | 0.30 | 0.20 | 34.5% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 14247 (Seq Scan) - LEAF
...
### Step 2: Node 14248 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 14236, 14237, 14239, 14240, 14241, 14242, 14243, 14244, 14245, 14249, 14250, 14251, 14252, 14254, 14257
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 4: Node 14243 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 14236, 14237, 14239, 14240, 14241, 14242, 14244, 14245, 14248, 14249, 14250, 14251, 14252, 14254, 14257
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=29497
  - HashJoin_nt1=147487
...
### Step 5: Node 14253 (Index Scan) - LEAF
...
### Step 6: Node 14255 (Seq Scan) - LEAF
...
### Step 7: Node 14241 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 14236, 14237, 14239, 14240, 14242, 14243, 14244, 14245, 14248, 14249, 14250, 14251, 14252, 14254, 14257
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=757
  - HashJoin_nt1=118013
...
### Step 8: Node 14256 (Index Scan) - LEAF
...
### Step 9: Node 14258 (Seq Scan) - LEAF
...
### Step 10: Node 14239 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 14236, 14237, 14240, 14241, 14242, 14243, 14244, 14245, 14248, 14249, 14250, 14251, 14252, 14254, 14257
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=757
  - HashJoin_nt1=757
...
### Step 12: Node 14236 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 14237, 14239, 14240, 14241, 14242, 14243, 14244, 14245, 14248, 14249, 14250, 14251, 14252, 14254, 14257
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2347
  - Aggregate_nt1=2347
