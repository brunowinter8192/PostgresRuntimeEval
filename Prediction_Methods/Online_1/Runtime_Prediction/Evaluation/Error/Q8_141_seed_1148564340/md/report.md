...
```
Node 14236 (Aggregate) [PATTERN: 53f9aa07] - ROOT
  Node 14237 (Gather Merge) [consumed]
    Node 14238 (Sort) [consumed]
      Node 14239 (Hash Join) [consumed]
        Node 14240 (Nested Loop) [consumed]
          Node 14241 (Hash Join)
            Node 14242 (Nested Loop) [PATTERN: bd9dfa7b]
              Node 14243 (Hash Join) [consumed]
              ...
              Node 14253 (Index Scan) [consumed] - LEAF
            Node 14254 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 53f9aa07 | 14236 | 14237, 14238, 14239, 14240, 14242, 14243, 14244, 14245, 14246, 14248, 14249, 14250, 14251, 14252, 14253, 14257 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 14248 | 14236, 14237, 14238, 14239, 14240, 14242, 14243, 14244, 14245, 14246, 14249, 14250, 14251, 14252, 14253, 14257 |
| Nested Loop -> [Hash Join -> [ | bd9dfa7b | 14242 | 14236, 14237, 14238, 14239, 14240, 14243, 14244, 14245, 14246, 14248, 14249, 14250, 14251, 14252, 14253, 14257 |
...
|------|------|--------|-----------|-----|--------|
| 14236 | Aggregate | 1277.42 | 1220.56 | 4.5% | pattern |
| 14241 | Hash Join | 1267.44 | 1042.86 | 17.7% | operator |
| 14256 | Index Scan | 0.01 | 0.05 | 753.5% | operator |
| 14258 | Seq Scan | 0.01 | 7.19 | 55242.1% | operator |
| 14242 | Nested Loop | 1222.20 | 1155.06 | 5.5% | pattern |
...
- **Consumes:** Nodes 14236, 14237, 14238, 14239, 14240, 14242, 14243, 14244, 14245, 14246, 14249, 14250, 14251, 14252, 14253, 14257
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 3: Node 14255 (Seq Scan) - LEAF
...
### Step 4: Node 14242 (Nested Loop) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bd9dfa7b (Nested Loop -> [Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer), Index Scan (Inner)])
- **Consumes:** Nodes 14236, 14237, 14238, 14239, 14240, 14243, 14244, 14245, 14246, 14248, 14249, 14250, 14251, 14252, 14253, 14257
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 7: Node 14256 (Index Scan) - LEAF
...
### Step 8: Node 14258 (Seq Scan) - LEAF
...
### Step 9: Node 14236 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 53f9aa07 (Aggregate -> Gather Merge -> Sort -> Hash Join -> [Nested Loop (Outer), Hash (Inner)] (Outer) (Outer) (Outer))
- **Consumes:** Nodes 14237, 14238, 14239, 14240, 14242, 14243, 14244, 14245, 14246, 14248, 14249, 14250, 14251, 14252, 14253, 14257
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2347
  - Aggregate_nt1=2347
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=757
  - HashJoin_Outer_nt1=757
  - HashJoin_Outer_nt2=25
  - HashJoin_Outer_parallel_workers=0
  - HashJoin_Outer_plan_width=148
  - HashJoin_Outer_reltuples=0.0000
  - HashJoin_Outer_sel=0.0400
  - HashJoin_Outer_startup_cost=9921.7200
  - HashJoin_Outer_total_cost=70506.1600
  - Hash_Inner_np=0
  - Hash_Inner_nt=25
  - Hash_Inner_nt1=25
  - Hash_Inner_nt2=0
  ...
  - Sort_Outer_startup_cost=70542.3600
  - Sort_Outer_total_cost=70544.2500
