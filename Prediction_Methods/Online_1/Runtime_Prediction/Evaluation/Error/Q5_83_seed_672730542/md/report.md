              ...
              Node 9528 (Hash Join) [PATTERN: 895c6e8c]
                ...
                Node 9530 (Hash) [consumed]
                  Node 9531 (Hash Join)
                    ...
                    Node 9533 (Hash) [PATTERN: a54055ce]
                      Node 9534 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 9533 | 9521, 9522, 9526, 9527, 9528, 9529, 9530, 9534, 9535, 9536, 9537, 9539 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 9528 | 9521, 9522, 9526, 9527, 9529, 9530, 9533, 9534, 9535, 9536, 9537, 9539 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 9526 | 9521, 9522, 9527, 9528, 9529, 9530, 9533, 9534, 9535, 9536, 9537, 9539 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 9521 | 9522, 9526, 9527, 9528, 9529, 9530, 9533, 9534, 9535, 9536, 9537, 9539 |
...
| 9531 | Hash Join | 35.73 | 62.70 | 75.5% | operator |
| 9532 | Seq Scan | 34.27 | 24.87 | 27.4% | operator |
| 9533 | Hash | 0.10 | 0.14 | 43.4% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 9532 (Seq Scan) - LEAF
...
### Step 2: Node 9533 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 9521, 9522, 9526, 9527, 9528, 9529, 9530, 9534, 9535, 9536, 9537, 9539
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
- **Consumes:** Nodes 9521, 9522, 9526, 9527, 9529, 9530, 9533, 9534, 9535, 9536, 9537, 9539
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14685
  - HashJoin_nt1=73423
...
### Step 5: Node 9538 (Index Scan) - LEAF
...
### Step 6: Node 9540 (Seq Scan) - LEAF
...
### Step 7: Node 9526 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 9521, 9522, 9527, 9528, 9529, 9530, 9533, 9534, 9535, 9536, 9537, 9539
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=2350
  - HashJoin_nt1=58750
...
### Step 10: Node 9523 (Gather Merge)
...
### Step 11: Node 9521 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 9522, 9526, 9527, 9528, 9529, 9530, 9533, 9534, 9535, 9536, 9537, 9539
- **Input Features:**
