              ...
              Node 8008 (Hash Join) [PATTERN: 895c6e8c]
                ...
                Node 8010 (Hash) [consumed]
                  Node 8011 (Hash Join)
                    ...
                    Node 8013 (Hash) [PATTERN: a54055ce]
                      Node 8014 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 8013 | 8001, 8002, 8006, 8007, 8008, 8009, 8010, 8014, 8015, 8016, 8017, 8019 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 8008 | 8001, 8002, 8006, 8007, 8009, 8010, 8013, 8014, 8015, 8016, 8017, 8019 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 8006 | 8001, 8002, 8007, 8008, 8009, 8010, 8013, 8014, 8015, 8016, 8017, 8019 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 8001 | 8002, 8006, 8007, 8008, 8009, 8010, 8013, 8014, 8015, 8016, 8017, 8019 |
...
| 8011 | Hash Join | 29.53 | 62.70 | 112.3% | operator |
| 8012 | Seq Scan | 27.99 | 24.87 | 11.1% | operator |
| 8013 | Hash | 0.16 | 0.14 | 16.9% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 8012 (Seq Scan) - LEAF
...
### Step 2: Node 8013 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 8001, 8002, 8006, 8007, 8008, 8009, 8010, 8014, 8015, 8016, 8017, 8019
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 4: Node 8008 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 8001, 8002, 8006, 8007, 8009, 8010, 8013, 8014, 8015, 8016, 8017, 8019
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14685
  - HashJoin_nt1=73423
...
### Step 5: Node 8018 (Index Scan) - LEAF
...
### Step 6: Node 8020 (Seq Scan) - LEAF
...
### Step 7: Node 8006 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 8001, 8002, 8007, 8008, 8009, 8010, 8013, 8014, 8015, 8016, 8017, 8019
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=2350
  - HashJoin_nt1=58750
...
### Step 10: Node 8003 (Gather Merge)
...
### Step 11: Node 8001 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 8002, 8006, 8007, 8008, 8009, 8010, 8013, 8014, 8015, 8016, 8017, 8019
- **Input Features:**
