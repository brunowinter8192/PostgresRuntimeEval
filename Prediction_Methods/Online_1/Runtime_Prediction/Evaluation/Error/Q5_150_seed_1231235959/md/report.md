        ...
        Node 8005 (Sort) [consumed]
          Node 8006 (Hash Join) [consumed]
            Node 8007 (Nested Loop) [consumed]
              ...
              Node 8018 (Index Scan) [consumed] - LEAF
            Node 8019 (Hash) [consumed]
              Node 8020 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather Me | 255215ee | 8001 | 8002, 8003, 8004, 8005, 8006, 8007, 8008, 8009, 8010, 8011, 8012, 8013, 8014, 8018, 8019, 8020 |
...
|------|------|--------|-----------|-----|--------|
| 8001 | Sort | 1059.75 | 1070.44 | 1.0% | pattern |
...
### Step 4: Node 8001 (Sort) - PATTERN ROOT
...
- **Consumes:** Nodes 8002, 8003, 8004, 8005, 8006, 8007, 8008, 8009, 8010, 8011, 8012, 8013, 8014, 8018, 8019, 8020
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=25
  - Aggregate_Outer_nt1=2350
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=136
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0106
  - Aggregate_Outer_startup_cost=56916.2500
  - Aggregate_Outer_total_cost=56945.9400
  ...
  - Sort_Outer_startup_cost=56916.2500
  - Sort_Outer_total_cost=56922.1300
  - Sort_np=0
  - Sort_nt=25
  - Sort_nt1=25
  - Sort_nt2=0
