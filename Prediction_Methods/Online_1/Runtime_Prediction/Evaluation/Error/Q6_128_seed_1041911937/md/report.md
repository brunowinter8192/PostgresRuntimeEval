...
```
Node 10021 (Aggregate) [PATTERN: dd3706ac] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | dd3706ac | 10021 | 10022, 10023, 10024 |
...
|------|------|--------|-----------|-----|--------|
| 10021 | Aggregate | 811.01 | 791.26 | 2.4% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10021 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** dd3706ac (Aggregate -> Gather -> Aggregate -> Seq Scan (Outer) (Outer) (Outer))
- **Consumes:** Nodes 10022, 10023, 10024
- **Input Features:**
