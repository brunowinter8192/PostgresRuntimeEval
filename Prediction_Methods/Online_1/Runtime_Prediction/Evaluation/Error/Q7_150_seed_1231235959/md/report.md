...
```
Node 11491 (Aggregate) - ROOT
  Node 11492 (Gather Merge)
    Node 11493 (Sort)
      Node 11494 (Hash Join)
        Node 11495 (Nested Loop)
          Node 11496 (Hash Join)
            Node 11497 (Seq Scan) - LEAF
            Node 11498 (Hash)
              Node 11499 (Hash Join)
                Node 11500 (Seq Scan) - LEAF
                Node 11501 (Hash)
                  Node 11502 (Seq Scan) - LEAF
          Node 11503 (Index Scan) - LEAF
        Node 11504 (Hash)
          Node 11505 (Hash Join)
            Node 11506 (Seq Scan) - LEAF
            Node 11507 (Hash)
              Node 11508 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 11491 | Aggregate | 1252.37 | 1202.22 | 4.0% | operator |
| 11492 | Gather Merge | 1251.35 | 1148.45 | 8.2% | operator |
| 11493 | Sort | 1245.97 | 1149.87 | 7.7% | operator |
| 11494 | Hash Join | 1245.35 | 1130.50 | 9.2% | operator |
| 11495 | Nested Loop | 1236.38 | 1145.81 | 7.3% | operator |
| 11504 | Hash | 5.02 | 15.44 | 207.6% | operator |
| 11496 | Hash Join | 219.48 | 319.53 | 45.6% | operator |
| 11503 | Index Scan | 0.03 | 0.09 | 155.7% | operator |
| 11505 | Hash Join | 4.97 | 49.64 | 897.8% | operator |
| 11497 | Seq Scan | 155.26 | 192.19 | 23.8% | operator |
| 11498 | Hash | 38.25 | 17.27 | 54.9% | operator |
| 11506 | Seq Scan | 4.68 | 10.62 | 127.0% | operator |
| 11507 | Hash | 0.02 | 14.54 | 90757.3% | operator |
| 11499 | Hash Join | 37.86 | 54.15 | 43.0% | operator |
| 11508 | Seq Scan | 0.01 | 7.20 | 55253.4% | operator |
| 11500 | Seq Scan | 36.73 | 24.87 | 32.3% | operator |
| 11501 | Hash | 0.01 | 14.54 | 161424.0% | operator |
| 11502 | Seq Scan | 0.01 | 7.20 | 119832.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11502 (Seq Scan) - LEAF
...
### Step 2: Node 11500 (Seq Scan) - LEAF
...
### Step 5: Node 11508 (Seq Scan) - LEAF
...
### Step 6: Node 11497 (Seq Scan) - LEAF
...
### Step 8: Node 11506 (Seq Scan) - LEAF
...
### Step 11: Node 11503 (Index Scan) - LEAF
...
### Step 13: Node 11495 (Nested Loop)
...
### Step 17: Node 11492 (Gather Merge)
...
### Step 18: Node 11491 (Aggregate) - ROOT
