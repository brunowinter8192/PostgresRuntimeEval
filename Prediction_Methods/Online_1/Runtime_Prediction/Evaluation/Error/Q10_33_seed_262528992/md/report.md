  ...
  Node 20359 (Sort) [consumed]
    Node 20360 (Aggregate) [consumed]
      Node 20361 (Gather) [consumed]
        Node 20362 (Hash Join) [PATTERN: 7a51ce50]
          Node 20363 (Hash Join) [consumed]
          ...
          Node 20369 (Hash) [consumed]
            Node 20370 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Hash Join -> [Ne | 7a51ce50 | 20362 | 20358, 20359, 20360, 20361, 20363, 20364, 20365, 20366, 20367, 20368, 20369, 20370 |
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20358 | 20359, 20360, 20361, 20362, 20363, 20364, 20365, 20366, 20367, 20368, 20369, 20370 |
...
| 20362 | Hash Join | 1083.94 | 730.59 | 32.6% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 20362 (Hash Join) - PATTERN ROOT
...
- **Consumes:** Nodes 20358, 20359, 20360, 20361, 20363, 20364, 20365, 20366, 20367, 20368, 20369, 20370
- **Input Features:**
  - HashJoin_Outer_np=0
  ...
  - HashJoin_Outer_total_cost=80538.2700
  - HashJoin_np=0
  - HashJoin_nt=17901
  - HashJoin_nt1=17901
  - HashJoin_nt2=25
  ...
  - HashJoin_total_cost=80594.7900
  - Hash_Inner_np=0
  - Hash_Inner_nt=62500
...
- **Output:** st=37.22, rt=730.59

### Step 2: Node 20358 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20359, 20360, 20361, 20362, 20363, 20364, 20365, 20366, 20367, 20368, 20369, 20370
- **Input Features:**
