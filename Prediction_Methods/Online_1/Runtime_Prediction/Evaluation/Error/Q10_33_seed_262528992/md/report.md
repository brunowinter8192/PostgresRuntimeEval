    ...
    Node 20360 (Aggregate) [consumed]
      Node 20361 (Gather) [consumed]
        Node 20362 (Hash Join) [consumed]
          Node 20363 (Hash Join) [PATTERN: 2873b8c3]
            Node 20364 (Nested Loop) [consumed]
              Node 20365 (Seq Scan) [consumed] - LEAF
              Node 20366 (Index Scan) [consumed] - LEAF
            Node 20367 (Hash) [consumed]
              Node 20368 (Seq Scan) [consumed] - LEAF
          Node 20369 (Hash)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 20358 | 20359, 20360, 20361, 20362, 20363, 20364, 20365, 20366, 20367, 20368 |
| Hash Join -> [Nested Loop -> [ | 2873b8c3 | 20363 | 20358, 20359, 20360, 20361, 20362, 20364, 20365, 20366, 20367, 20368 |
...
### Step 2: Node 20363 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2873b8c3 (Hash Join -> [Nested Loop -> [Seq Scan (Outer), Index Scan (Inner)] (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 20358, 20359, 20360, 20361, 20362, 20364, 20365, 20366, 20367, 20368
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=17901
  - HashJoin_nt1=17901
...
### Step 4: Node 20358 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20359, 20360, 20361, 20362, 20363, 20364, 20365, 20366, 20367, 20368
- **Input Features:**
