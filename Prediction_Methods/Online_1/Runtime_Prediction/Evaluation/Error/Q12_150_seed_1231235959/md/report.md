...
```
Node 24705 (Aggregate) [PATTERN: f9c97829] - ROOT
  Node 24706 (Gather Merge) [consumed]
    Node 24707 (Aggregate) [consumed]
      Node 24708 (Sort) [consumed]
        Node 24709 (Nested Loop) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> A | f9c97829 | 24705 | 24706, 24707, 24708, 24709, 24710, 24711 |
...
|------|------|--------|-----------|-----|--------|
| 24705 | Aggregate | 982.81 | 998.49 | 1.6% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24705 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 24706, 24707, 24708, 24709, 24710, 24711
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=7
  - Aggregate_Outer_nt1=5795
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=27
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0012
  - Aggregate_Outer_startup_cost=147553.2100
  - Aggregate_Outer_total_cost=147669.1800
  - Aggregate_np=0
  - Aggregate_nt=7
  - Aggregate_nt1=35
  - Aggregate_nt2=0
  ...
  - NestedLoop_Outer_nt=5795
  - NestedLoop_Outer_nt1=5795
  ...
  - NestedLoop_Outer_total_cost=147191.0000
  ...
  - Sort_Outer_startup_cost=147553.2100
  - Sort_Outer_total_cost=147567.6900
