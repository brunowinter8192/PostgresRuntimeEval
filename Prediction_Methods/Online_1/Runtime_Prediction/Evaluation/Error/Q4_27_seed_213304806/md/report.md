...
```
Node 6334 (Aggregate) [PATTERN: 80bd802d] - ROOT
  Node 6335 (Gather Merge) [consumed]
    Node 6336 (Sort) [consumed]
      Node 6337 (Aggregate) [consumed]
        Node 6338 (Nested Loop) [consumed]
          Node 6339 (Seq Scan) [consumed] - LEAF
          Node 6340 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 80bd802d | 6334 | 6335, 6336, 6337, 6338, 6339, 6340 |
...
|------|------|--------|-----------|-----|--------|
| 6334 | Aggregate | 1055.58 | 1057.79 | 0.2% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6334 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 6335, 6336, 6337, 6338, 6339, 6340
- **Input Features:**
  ...
  - NestedLoop_Outer_total_cost=65796.5500
  - SeqScan_Outer_np=26136
  - SeqScan_Outer_nt=18230
  - SeqScan_Outer_nt1=0
  - SeqScan_Outer_nt2=0
