...
Node 13868 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 13869 (Gather Merge) [consumed]
    Node 13870 (Sort)
      Node 13871 (Hash Join) [PATTERN: 2e0f44ef]
        Node 13872 (Nested Loop) [consumed]
          Node 13873 (Hash Join) [PATTERN: 2e0f44ef]
            Node 13874 (Nested Loop) [consumed]
              Node 13875 (Hash Join) [PATTERN: 895c6e8c]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 13880 | 13868, 13869, 13871, 13872, 13873, 13874, 13875, 13876, 13877, 13881, 13882, 13883, 13884, 13886, 13889 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 13875 | 13868, 13869, 13871, 13872, 13873, 13874, 13876, 13877, 13880, 13881, 13882, 13883, 13884, 13886, 13889 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 13871 | 13868, 13869, 13872, 13873, 13874, 13875, 13876, 13877, 13880, 13881, 13882, 13883, 13884, 13886, 13889 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 13873 | 13868, 13869, 13871, 13872, 13874, 13875, 13876, 13877, 13880, 13881, 13882, 13883, 13884, 13886, 13889 |
| Aggregate -> Gather Merge (Out | 2724c080 | 13868 | 13869, 13871, 13872, 13873, 13874, 13875, 13876, 13877, 13880, 13881, 13882, 13883, 13884, 13886, 13889 |
...
| 13870 | Sort | 1213.65 | 1096.02 | 9.7% | operator |
| 13871 | Hash Join | 1213.40 | 1199.17 | 1.2% | pattern |
| 13873 | Hash Join | 1209.13 | 1192.78 | 1.4% | pattern |
| 13888 | Index Scan | 0.01 | 0.05 | 753.5% | operator |
| 13890 | Seq Scan | 0.01 | 7.19 | 71844.7% | operator |
| 13875 | Hash Join | 215.80 | 260.30 | 20.6% | pattern |
| 13885 | Index Scan | 0.04 | 0.09 | 112.3% | operator |
| 13887 | Seq Scan | 42.72 | 44.47 | 4.1% | operator |
| 13878 | Hash Join | 36.67 | 67.79 | 84.9% | operator |
...
- **Consumes:** Nodes 13868, 13869, 13871, 13872, 13873, 13874, 13875, 13876, 13877, 13881, 13882, 13883, 13884, 13886, 13889
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 4: Node 13875 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 13868, 13869, 13871, 13872, 13873, 13874, 13876, 13877, 13880, 13881, 13882, 13883, 13884, 13886, 13889
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=29497
  - HashJoin_nt1=147487
...
### Step 5: Node 13885 (Index Scan) - LEAF
...
### Step 6: Node 13887 (Seq Scan) - LEAF
...
### Step 7: Node 13873 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 13868, 13869, 13871, 13872, 13874, 13875, 13876, 13877, 13880, 13881, 13882, 13883, 13884, 13886, 13889
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=836
  - HashJoin_nt1=118013
  ...
  - HashJoin_reltuples=0.0000
  - HashJoin_sel=0.0000
  - HashJoin_startup_cost=9920.5600
  - HashJoin_total_cost=70272.0400
  - Hash_Inner_np=0
  - Hash_Inner_nt=590
  - Hash_Inner_nt1=590
  - Hash_Inner_nt2=0
...
- **Output:** st=80.08, rt=1192.78

### Step 8: Node 13888 (Index Scan) - LEAF
...
### Step 9: Node 13890 (Seq Scan) - LEAF
...
### Step 10: Node 13871 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 13868, 13869, 13872, 13873, 13874, 13875, 13876, 13877, 13880, 13881, 13882, 13883, 13884, 13886, 13889
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=836
  - HashJoin_nt1=836
  ...
  - HashJoin_reltuples=0.0000
  - HashJoin_sel=0.0400
  - HashJoin_startup_cost=9922.4100
  - HashJoin_total_cost=70531.1800
  - Hash_Inner_np=0
  - Hash_Inner_nt=25
  - Hash_Inner_nt1=25
  - Hash_Inner_nt2=0
...
### Step 12: Node 13868 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 13869, 13871, 13872, 13873, 13874, 13875, 13876, 13877, 13880, 13881, 13882, 13883, 13884, 13886, 13889
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2592
