...
```
Node 6362 (Aggregate) [PATTERN: 80bd802d] - ROOT
  Node 6363 (Gather Merge) [consumed]
    Node 6364 (Sort) [consumed]
      Node 6365 (Aggregate) [consumed]
        Node 6366 (Nested Loop) [consumed]
          Node 6367 (Seq Scan) [consumed] - LEAF
          Node 6368 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 80bd802d | 6362 | 6363, 6364, 6365, 6366, 6367, 6368 |
...
|------|------|--------|-----------|-----|--------|
| 6362 | Aggregate | 1052.29 | 1057.79 | 0.5% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6362 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 6363, 6364, 6365, 6366, 6367, 6368
- **Input Features:**
  ...
  - NestedLoop_Outer_nt=14912
  - NestedLoop_Outer_nt1=18286
  ...
  - NestedLoop_Outer_total_cost=65841.2000
  - SeqScan_Outer_np=26136
  - SeqScan_Outer_nt=18286
  - SeqScan_Outer_nt1=0
  - SeqScan_Outer_nt2=0
