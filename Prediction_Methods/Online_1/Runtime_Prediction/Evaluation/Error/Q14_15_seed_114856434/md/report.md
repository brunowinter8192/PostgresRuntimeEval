...
```
Node 26812 (Aggregate) [PATTERN: f8295d8b] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 26812 | 26813, 26814, 26815, 26816, 26817, 26818 |
...
|------|------|--------|-----------|-----|--------|
| 26812 | Aggregate | 819.00 | 822.68 | 0.4% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26812 (Aggregate) - PATTERN ROOT
