...
```
Node 31948 (Aggregate) [PATTERN: f8295d8b] - ROOT
  Node 31949 (Gather) [consumed]
    Node 31950 (Aggregate) [consumed]
      Node 31951 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 31948 | 31949, 31950, 31951, 31952, 31953, 31954 |
...
|------|------|--------|-----------|-----|--------|
| 31948 | Aggregate | 851.89 | 841.17 | 1.3% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31948 (Aggregate) - PATTERN ROOT
