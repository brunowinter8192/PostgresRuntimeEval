...
```
Node 10843 (Aggregate) - ROOT
  Node 10844 (Gather Merge)
    Node 10845 (Sort)
      Node 10846 (Hash Join)
        Node 10847 (Nested Loop)
          Node 10848 (Hash Join)
            Node 10849 (Seq Scan) - LEAF
            Node 10850 (Hash)
              Node 10851 (Hash Join)
                Node 10852 (Seq Scan) - LEAF
                Node 10853 (Hash)
                  Node 10854 (Seq Scan) - LEAF
          Node 10855 (Index Scan) - LEAF
        Node 10856 (Hash)
          Node 10857 (Hash Join)
            Node 10858 (Seq Scan) - LEAF
            Node 10859 (Hash)
              Node 10860 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 10843 | Aggregate | 1202.20 | 1202.22 | 0.0% | operator |
| 10844 | Gather Merge | 1201.02 | 1148.45 | 4.4% | operator |
| 10845 | Sort | 1193.58 | 1149.87 | 3.7% | operator |
| 10846 | Hash Join | 1192.95 | 1130.50 | 5.2% | operator |
| 10847 | Nested Loop | 1183.57 | 1145.81 | 3.2% | operator |
| 10856 | Hash | 5.60 | 15.44 | 175.6% | operator |
| 10848 | Hash Join | 212.73 | 319.53 | 50.2% | operator |
| 10855 | Index Scan | 0.03 | 0.09 | 171.7% | operator |
| 10857 | Hash Join | 5.55 | 49.64 | 793.7% | operator |
| 10849 | Seq Scan | 149.64 | 192.19 | 28.4% | operator |
| 10850 | Hash | 36.61 | 17.27 | 52.8% | operator |
| 10858 | Seq Scan | 5.23 | 10.62 | 103.1% | operator |
| 10859 | Hash | 0.01 | 14.54 | 96814.4% | operator |
| 10851 | Hash Join | 36.29 | 54.15 | 49.2% | operator |
| 10860 | Seq Scan | 0.01 | 7.20 | 65317.7% | operator |
| 10852 | Seq Scan | 35.23 | 24.87 | 29.4% | operator |
| 10853 | Hash | 0.01 | 14.54 | 132056.0% | operator |
| 10854 | Seq Scan | 0.01 | 7.20 | 119832.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10854 (Seq Scan) - LEAF
...
### Step 2: Node 10852 (Seq Scan) - LEAF
...
### Step 5: Node 10860 (Seq Scan) - LEAF
...
### Step 6: Node 10849 (Seq Scan) - LEAF
...
### Step 8: Node 10858 (Seq Scan) - LEAF
...
### Step 11: Node 10855 (Index Scan) - LEAF
...
### Step 13: Node 10847 (Nested Loop)
...
### Step 17: Node 10844 (Gather Merge)
...
### Step 18: Node 10843 (Aggregate) - ROOT
