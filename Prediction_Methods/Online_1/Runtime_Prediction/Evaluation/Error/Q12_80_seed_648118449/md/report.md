...
```
Node 25216 (Aggregate) [PATTERN: f9c97829] - ROOT
  Node 25217 (Gather Merge) [consumed]
    Node 25218 (Aggregate) [consumed]
      Node 25219 (Sort) [consumed]
        Node 25220 (Nested Loop) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> A | f9c97829 | 25216 | 25217, 25218, 25219, 25220, 25221, 25222 |
...
|------|------|--------|-----------|-----|--------|
| 25216 | Aggregate | 993.21 | 998.49 | 0.5% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25216 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 25217, 25218, 25219, 25220, 25221, 25222
- **Input Features:**
  ...
  - Aggregate_Outer_startup_cost=147536.9300
  - Aggregate_Outer_total_cost=147652.5600
  - Aggregate_np=0
  - Aggregate_nt=7
  - Aggregate_nt1=35
  - Aggregate_nt2=0
  ...
  - NestedLoop_Outer_nt=5778
  - NestedLoop_Outer_nt1=5778
  ...
  - NestedLoop_Outer_total_cost=147175.9100
  ...
  - Sort_Outer_startup_cost=147536.9300
  - Sort_Outer_total_cost=147551.3800
