...
```
Node 24572 (Aggregate) [PATTERN: f9c97829] - ROOT
  Node 24573 (Gather Merge) [consumed]
    Node 24574 (Aggregate) [consumed]
      Node 24575 (Sort) [consumed]
        Node 24576 (Nested Loop) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> A | f9c97829 | 24572 | 24573, 24574, 24575, 24576, 24577, 24578 |
...
|------|------|--------|-----------|-----|--------|
| 24572 | Aggregate | 998.09 | 998.49 | 0.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24572 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 24573, 24574, 24575, 24576, 24577, 24578
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=7
  - Aggregate_Outer_nt1=5758
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=27
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0012
  - Aggregate_Outer_startup_cost=147517.2200
  - Aggregate_Outer_total_cost=147632.4500
  - Aggregate_np=0
  - Aggregate_nt=7
  - Aggregate_nt1=35
  - Aggregate_nt2=0
  ...
  - NestedLoop_Outer_nt=5758
  - NestedLoop_Outer_nt1=5758
  ...
  - NestedLoop_Outer_total_cost=147157.6000
  ...
  - Sort_Outer_startup_cost=147517.2200
  - Sort_Outer_total_cost=147531.6200
