...
```
Node 276 (Aggregate) [PATTERN: 3dfa6025] - ROOT
  Node 277 (Gather Merge) [consumed]
    Node 278 (Sort) [consumed]
      Node 279 (Aggregate) [consumed]
        Node 280 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 3dfa6025 | 276 | 277, 278, 279, 280 |
...
|------|------|--------|-----------|-----|--------|
| 276 | Aggregate | 932.49 | 953.98 | 2.3% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 276 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3dfa6025 (Aggregate -> Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 277, 278, 279, 280
- **Input Features:**
  ...
  - Aggregate_startup_cost=169793.8500
  - Aggregate_total_cost=169798.6200
  ...
  - GatherMerge_Outer_startup_cost=169793.8500
  - GatherMerge_Outer_total_cost=169797.4800
