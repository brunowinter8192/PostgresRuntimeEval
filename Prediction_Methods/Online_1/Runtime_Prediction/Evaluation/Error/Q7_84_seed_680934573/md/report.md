...
```
Node 12877 (Aggregate) [PATTERN: 27c3eea9] - ROOT
  Node 12878 (Gather Merge) [consumed]
    Node 12879 (Sort) [consumed]
      Node 12880 (Hash Join) [consumed]
        Node 12881 (Nested Loop) [consumed]
          Node 12882 (Hash Join) [consumed]
          ...
          Node 12889 (Index Scan) [consumed] - LEAF
        Node 12890 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 27c3eea9 | 12877 | 12878, 12879, 12880, 12881, 12882, 12884, 12885, 12886, 12887, 12888, 12889, 12890, 12891 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 12884 | 12877, 12878, 12879, 12880, 12881, 12882, 12885, 12886, 12887, 12888, 12889, 12890, 12891 |
...
|------|------|--------|-----------|-----|--------|
| 12877 | Aggregate | 1299.85 | 1200.90 | 7.6% | pattern |
...
### Step 1: Node 12894 (Seq Scan) - LEAF
...
### Step 2: Node 12883 (Seq Scan) - LEAF
...
### Step 3: Node 12884 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 12877, 12878, 12879, 12880, 12881, 12882, 12885, 12886, 12887, 12888, 12889, 12890, 12891
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 12892 (Seq Scan) - LEAF
...
### Step 6: Node 12877 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 12878, 12879, 12880, 12881, 12882, 12884, 12885, 12886, 12887, 12888, 12889, 12890, 12891
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
