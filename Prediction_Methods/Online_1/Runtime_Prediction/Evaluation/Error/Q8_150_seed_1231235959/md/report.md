...
```
Node 14466 (Aggregate) [PATTERN: 53f9aa07] - ROOT
  Node 14467 (Gather Merge) [consumed]
    Node 14468 (Sort) [consumed]
      Node 14469 (Hash Join) [consumed]
        Node 14470 (Nested Loop) [consumed]
          Node 14471 (Hash Join)
            Node 14472 (Nested Loop) [PATTERN: bd9dfa7b]
              Node 14473 (Hash Join) [consumed]
              ...
              Node 14483 (Index Scan) [consumed] - LEAF
            Node 14484 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 53f9aa07 | 14466 | 14467, 14468, 14469, 14470, 14472, 14473, 14474, 14475, 14476, 14478, 14479, 14480, 14481, 14482, 14483, 14487 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 14478 | 14466, 14467, 14468, 14469, 14470, 14472, 14473, 14474, 14475, 14476, 14479, 14480, 14481, 14482, 14483, 14487 |
| Nested Loop -> [Hash Join -> [ | bd9dfa7b | 14472 | 14466, 14467, 14468, 14469, 14470, 14473, 14474, 14475, 14476, 14478, 14479, 14480, 14481, 14482, 14483, 14487 |
...
|------|------|--------|-----------|-----|--------|
| 14466 | Aggregate | 1209.69 | 1220.52 | 0.9% | pattern |
| 14471 | Hash Join | 1200.04 | 1042.87 | 13.1% | operator |
| 14486 | Index Scan | 0.01 | 0.05 | 753.5% | operator |
| 14488 | Seq Scan | 0.01 | 7.19 | 71844.7% | operator |
| 14472 | Nested Loop | 1157.98 | 1155.06 | 0.3% | pattern |
...
- **Consumes:** Nodes 14466, 14467, 14468, 14469, 14470, 14472, 14473, 14474, 14475, 14476, 14479, 14480, 14481, 14482, 14483, 14487
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 3: Node 14485 (Seq Scan) - LEAF
...
### Step 4: Node 14472 (Nested Loop) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bd9dfa7b (Nested Loop -> [Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer), Index Scan (Inner)])
- **Consumes:** Nodes 14466, 14467, 14468, 14469, 14470, 14473, 14474, 14475, 14476, 14478, 14479, 14480, 14481, 14482, 14483, 14487
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 7: Node 14486 (Index Scan) - LEAF
...
### Step 8: Node 14488 (Seq Scan) - LEAF
...
### Step 9: Node 14466 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 53f9aa07 (Aggregate -> Gather Merge -> Sort -> Hash Join -> [Nested Loop (Outer), Hash (Inner)] (Outer) (Outer) (Outer))
- **Consumes:** Nodes 14467, 14468, 14469, 14470, 14472, 14473, 14474, 14475, 14476, 14478, 14479, 14480, 14481, 14482, 14483, 14487
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2422
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=781
  - HashJoin_Outer_nt1=781
  - HashJoin_Outer_nt2=25
  - HashJoin_Outer_parallel_workers=0
  - HashJoin_Outer_plan_width=148
  - HashJoin_Outer_reltuples=0.0000
  - HashJoin_Outer_sel=0.0400
  - HashJoin_Outer_startup_cost=9921.9400
  - HashJoin_Outer_total_cost=70513.7600
  - Hash_Inner_np=0
  - Hash_Inner_nt=25
  - Hash_Inner_nt1=25
  - Hash_Inner_nt2=0
  ...
  - Sort_Outer_startup_cost=70551.2900
  - Sort_Outer_total_cost=70553.2400
- **Output:** st=1219.15, rt=1220.52
