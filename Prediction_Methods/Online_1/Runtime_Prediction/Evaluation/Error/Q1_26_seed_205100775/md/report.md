...
```
Node 341 (Aggregate) [PATTERN: 3dfa6025] - ROOT
  Node 342 (Gather Merge) [consumed]
    Node 343 (Sort) [consumed]
      Node 344 (Aggregate) [consumed]
        Node 345 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 3dfa6025 | 341 | 342, 343, 344, 345 |
...
|------|------|--------|-----------|-----|--------|
| 341 | Aggregate | 922.70 | 953.98 | 3.4% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 341 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3dfa6025 (Aggregate -> Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 342, 343, 344, 345
- **Input Features:**
