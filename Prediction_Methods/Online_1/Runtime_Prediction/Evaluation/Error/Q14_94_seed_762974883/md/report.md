...
Node 27421 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27422 (Gather) [consumed]
    Node 27423 (Aggregate) [consumed]
      Node 27424 (Hash Join) [PATTERN: f4cb205a]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 27424 | 27421, 27422, 27423, 27425, 27426, 27427 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27421 | 27422, 27423, 27424, 27425, 27426, 27427 |
...
| 27424 | Hash Join | 828.37 | 397.22 | 52.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27424 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 27421, 27422, 27423, 27425, 27426, 27427
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14664
  - HashJoin_nt1=14664
...
### Step 2: Node 27421 (Aggregate) - PATTERN ROOT
