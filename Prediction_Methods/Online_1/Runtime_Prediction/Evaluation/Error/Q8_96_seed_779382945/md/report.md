...
```
Node 16536 (Aggregate) [PATTERN: 53f9aa07] - ROOT
  Node 16537 (Gather Merge) [consumed]
    Node 16538 (Sort) [consumed]
      Node 16539 (Hash Join) [consumed]
        Node 16540 (Nested Loop) [consumed]
          Node 16541 (Hash Join)
            Node 16542 (Nested Loop) [PATTERN: bd9dfa7b]
              Node 16543 (Hash Join) [consumed]
              ...
              Node 16553 (Index Scan) [consumed] - LEAF
            Node 16554 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 53f9aa07 | 16536 | 16537, 16538, 16539, 16540, 16542, 16543, 16544, 16545, 16546, 16548, 16549, 16550, 16551, 16552, 16553, 16557 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 16548 | 16536, 16537, 16538, 16539, 16540, 16542, 16543, 16544, 16545, 16546, 16549, 16550, 16551, 16552, 16553, 16557 |
| Nested Loop -> [Hash Join -> [ | bd9dfa7b | 16542 | 16536, 16537, 16538, 16539, 16540, 16543, 16544, 16545, 16546, 16548, 16549, 16550, 16551, 16552, 16553, 16557 |
...
|------|------|--------|-----------|-----|--------|
| 16536 | Aggregate | 1237.33 | 1220.49 | 1.4% | pattern |
| 16541 | Hash Join | 1228.08 | 1042.87 | 15.1% | operator |
| 16556 | Index Scan | 0.01 | 0.05 | 753.5% | operator |
| 16558 | Seq Scan | 0.01 | 7.19 | 89830.9% | operator |
| 16542 | Nested Loop | 1181.30 | 1155.06 | 2.2% | pattern |
...
- **Consumes:** Nodes 16536, 16537, 16538, 16539, 16540, 16542, 16543, 16544, 16545, 16546, 16549, 16550, 16551, 16552, 16553, 16557
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 3: Node 16555 (Seq Scan) - LEAF
...
### Step 4: Node 16542 (Nested Loop) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bd9dfa7b (Nested Loop -> [Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer), Index Scan (Inner)])
- **Consumes:** Nodes 16536, 16537, 16538, 16539, 16540, 16543, 16544, 16545, 16546, 16548, 16549, 16550, 16551, 16552, 16553, 16557
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 7: Node 16556 (Index Scan) - LEAF
...
### Step 8: Node 16558 (Seq Scan) - LEAF
...
### Step 9: Node 16536 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 53f9aa07 (Aggregate -> Gather Merge -> Sort -> Hash Join -> [Nested Loop (Outer), Hash (Inner)] (Outer) (Outer) (Outer))
- **Consumes:** Nodes 16537, 16538, 16539, 16540, 16542, 16543, 16544, 16545, 16546, 16548, 16549, 16550, 16551, 16552, 16553, 16557
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2480
  ...
  - HashJoin_Outer_nt1=800
  - HashJoin_Outer_nt2=25
  - HashJoin_Outer_parallel_workers=0
  - HashJoin_Outer_plan_width=148
  - HashJoin_Outer_reltuples=0.0000
  - HashJoin_Outer_sel=0.0400
  - HashJoin_Outer_startup_cost=9922.1000
  - HashJoin_Outer_total_cost=70519.7800
  - Hash_Inner_np=0
  - Hash_Inner_nt=25
  - Hash_Inner_nt1=25
  - Hash_Inner_nt2=0
  ...
  - Sort_Outer_startup_cost=70558.3600
  - Sort_Outer_total_cost=70560.3600
- **Output:** st=1219.12, rt=1220.49
