...
Node 16536 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 16537 (Gather Merge) [consumed]
    Node 16538 (Sort)
      Node 16539 (Hash Join) [PATTERN: 2e0f44ef]
        Node 16540 (Nested Loop) [consumed]
          Node 16541 (Hash Join) [PATTERN: 2e0f44ef]
            Node 16542 (Nested Loop) [consumed]
              Node 16543 (Hash Join) [PATTERN: 895c6e8c]
                Node 16544 (Seq Scan) [consumed] - LEAF
                Node 16545 (Hash) [consumed]
                  Node 16546 (Hash Join)
                    Node 16547 (Seq Scan) - LEAF
                    Node 16548 (Hash) [PATTERN: a54055ce]
                      Node 16549 (Hash Join) [consumed]
                        Node 16550 (Seq Scan) [consumed] - LEAF
                        Node 16551 (Hash) [consumed]
                          Node 16552 (Seq Scan) [consumed] - LEAF
              Node 16553 (Index Scan) - LEAF
            Node 16554 (Hash) [consumed]
              Node 16555 (Seq Scan) - LEAF
          Node 16556 (Index Scan) - LEAF
        Node 16557 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 16548 | 16536, 16537, 16539, 16540, 16541, 16542, 16543, 16544, 16545, 16549, 16550, 16551, 16552, 16554, 16557 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 16543 | 16536, 16537, 16539, 16540, 16541, 16542, 16544, 16545, 16548, 16549, 16550, 16551, 16552, 16554, 16557 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 16539 | 16536, 16537, 16540, 16541, 16542, 16543, 16544, 16545, 16548, 16549, 16550, 16551, 16552, 16554, 16557 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 16541 | 16536, 16537, 16539, 16540, 16542, 16543, 16544, 16545, 16548, 16549, 16550, 16551, 16552, 16554, 16557 |
| Aggregate -> Gather Merge (Out | 2724c080 | 16536 | 16537, 16539, 16540, 16541, 16542, 16543, 16544, 16545, 16548, 16549, 16550, 16551, 16552, 16554, 16557 |
...
| 16538 | Sort | 1232.55 | 1096.02 | 11.1% | operator |
| 16539 | Hash Join | 1232.30 | 1199.17 | 2.7% | pattern |
| 16541 | Hash Join | 1228.08 | 1192.81 | 2.9% | pattern |
| 16556 | Index Scan | 0.01 | 0.05 | 753.5% | operator |
| 16558 | Seq Scan | 0.01 | 7.19 | 89830.9% | operator |
| 16543 | Hash Join | 212.82 | 260.30 | 22.3% | pattern |
| 16553 | Index Scan | 0.04 | 0.09 | 107.2% | operator |
| 16555 | Seq Scan | 41.93 | 44.48 | 6.1% | operator |
| 16546 | Hash Join | 34.75 | 67.79 | 95.1% | operator |
| 16547 | Seq Scan | 33.30 | 24.87 | 25.3% | operator |
| 16548 | Hash | 0.10 | 0.20 | 93.4% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 16547 (Seq Scan) - LEAF
...
### Step 2: Node 16548 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 16536, 16537, 16539, 16540, 16541, 16542, 16543, 16544, 16545, 16549, 16550, 16551, 16552, 16554, 16557
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 4: Node 16543 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 16536, 16537, 16539, 16540, 16541, 16542, 16544, 16545, 16548, 16549, 16550, 16551, 16552, 16554, 16557
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=29497
  - HashJoin_nt1=147487
...
### Step 5: Node 16553 (Index Scan) - LEAF
...
### Step 6: Node 16555 (Seq Scan) - LEAF
...
### Step 7: Node 16541 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 16536, 16537, 16539, 16540, 16542, 16543, 16544, 16545, 16548, 16549, 16550, 16551, 16552, 16554, 16557
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=800
  - HashJoin_nt1=118013
...
### Step 8: Node 16556 (Index Scan) - LEAF
...
### Step 9: Node 16558 (Seq Scan) - LEAF
...
### Step 10: Node 16539 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 16536, 16537, 16540, 16541, 16542, 16543, 16544, 16545, 16548, 16549, 16550, 16551, 16552, 16554, 16557
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=800
  - HashJoin_nt1=800
...
### Step 12: Node 16536 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 16537, 16539, 16540, 16541, 16542, 16543, 16544, 16545, 16548, 16549, 16550, 16551, 16552, 16554, 16557
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2480
