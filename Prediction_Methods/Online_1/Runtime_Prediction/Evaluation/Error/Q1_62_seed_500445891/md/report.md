...
```
Node 541 (Aggregate) [PATTERN: 3dfa6025] - ROOT
  Node 542 (Gather Merge) [consumed]
    Node 543 (Sort) [consumed]
      Node 544 (Aggregate) [consumed]
        Node 545 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 3dfa6025 | 541 | 542, 543, 544, 545 |
...
|------|------|--------|-----------|-----|--------|
| 541 | Aggregate | 995.78 | 953.98 | 4.2% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 541 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3dfa6025 (Aggregate -> Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 542, 543, 544, 545
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=6
  - Aggregate_Outer_nt1=1180767
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=236
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=168929.8800
  - Aggregate_Outer_total_cost=168930.0200
  - Aggregate_np=0
  - Aggregate_nt=6
  - Aggregate_nt1=30
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=169930.1700
  - Aggregate_total_cost=169934.9400
  ...
  - GatherMerge_Outer_startup_cost=169930.1700
  - GatherMerge_Outer_total_cost=169933.8000
  - SeqScan_Outer_np=112600
  - SeqScan_Outer_nt=1180767
  - SeqScan_Outer_nt1=0
  - SeqScan_Outer_nt2=0
  - SeqScan_Outer_parallel_workers=0
  - SeqScan_Outer_plan_width=25
  - SeqScan_Outer_reltuples=6001215.0000
  - SeqScan_Outer_sel=0.1968
  ...
  - Sort_Outer_startup_cost=168930.1000
  - Sort_Outer_total_cost=168930.1100
