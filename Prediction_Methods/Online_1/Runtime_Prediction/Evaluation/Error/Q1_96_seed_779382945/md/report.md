...
```
Node 726 (Aggregate) [PATTERN: 3dfa6025] - ROOT
  Node 727 (Gather Merge) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 3dfa6025 | 726 | 727, 728, 729, 730 |
...
|------|------|--------|-----------|-----|--------|
| 726 | Aggregate | 933.13 | 953.98 | 2.2% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 726 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3dfa6025 (Aggregate -> Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 727, 728, 729, 730
- **Input Features:**
  ...
  - Aggregate_startup_cost=169825.9400
  - Aggregate_total_cost=169830.7100
  ...
  - GatherMerge_Outer_startup_cost=169825.9400
  - GatherMerge_Outer_total_cost=169829.5700
