...
```
Node 19043 (Sort) [PATTERN: 57d290cd] - ROOT
          ...
          Node 19049 (Hash) [consumed]
            Node 19050 (Hash Join) [consumed]
              ...
              Node 19052 (Hash) [consumed]
                Node 19053 (Hash Join) [PATTERN: 7a51ce50]
                  Node 19054 (Hash Join) [consumed]
                    Node 19055 (Nested Loop) [consumed]
                      Node 19056 (Seq Scan) [consumed] - LEAF
                      Node 19057 (Index Scan) [consumed] - LEAF
                    Node 19058 (Hash) [consumed]
                      Node 19059 (Seq Scan) [consumed] - LEAF
                  Node 19060 (Hash) [consumed]
                    Node 19061 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather -> | 57d290cd | 19043 | 19044, 19045, 19046, 19047, 19048, 19049, 19050, 19051, 19052, 19053, 19054, 19055, 19056, 19057, 19058, 19059, 19060, 19061 |
| Hash Join -> [Hash Join -> [Ne | 7a51ce50 | 19053 | 19043, 19044, 19045, 19046, 19047, 19048, 19049, 19050, 19051, 19052, 19054, 19055, 19056, 19057, 19058, 19059, 19060, 19061 |
...
| 19053 | Hash Join | 209.91 | 548.04 | 161.1% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 19053 (Hash Join) - PATTERN ROOT
...
- **Consumes:** Nodes 19043, 19044, 19045, 19046, 19047, 19048, 19049, 19050, 19051, 19052, 19054, 19055, 19056, 19057, 19058, 19059, 19060, 19061
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 2: Node 19043 (Sort) - PATTERN ROOT
...
- **Consumes:** Nodes 19044, 19045, 19046, 19047, 19048, 19049, 19050, 19051, 19052, 19053, 19054, 19055, 19056, 19057, 19058, 19059, 19060, 19061
- **Input Features:**
