        ...
        Node 8545 (Sort) [consumed]
          Node 8546 (Hash Join) [consumed]
            Node 8547 (Nested Loop) [consumed]
              ...
              Node 8558 (Index Scan) [consumed] - LEAF
            Node 8559 (Hash) [consumed]
              Node 8560 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather Me | 255215ee | 8541 | 8542, 8543, 8544, 8545, 8546, 8547, 8548, 8549, 8550, 8551, 8552, 8553, 8554, 8558, 8559, 8560 |
...
|------|------|--------|-----------|-----|--------|
| 8541 | Sort | 1062.91 | 1070.44 | 0.7% | pattern |
...
### Step 4: Node 8541 (Sort) - PATTERN ROOT
...
- **Consumes:** Nodes 8542, 8543, 8544, 8545, 8546, 8547, 8548, 8549, 8550, 8551, 8552, 8553, 8554, 8558, 8559, 8560
- **Input Features:**
