...
```
Node 26357 (Sort) [PATTERN: 35ffb644] - ROOT
  Node 26358 (Aggregate) [consumed]
    Node 26359 (Aggregate) [consumed]
      Node 26360 (Hash Join)
        Node 26361 (Seq Scan) - LEAF
        Node 26362 (Hash)
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Aggregate | 35ffb644 | 26357 | 26358, 26359 |
...
| 26360 | Hash Join | 689.61 | 705.85 | 2.4% | operator |
| 26361 | Seq Scan | 479.36 | 412.66 | 13.9% | operator |
| 26362 | Hash | 15.13 | 37.64 | 148.7% | operator |
...
### Step 2: Node 26361 (Seq Scan) - LEAF
...
### Step 5: Node 26357 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 35ffb644 (Sort -> Aggregate -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26358, 26359
- **Input Features:**
