            ...
            Node 14886 (Nested Loop) [consumed]
              Node 14887 (Hash Join) [PATTERN: 895c6e8c]
                ...
                Node 14889 (Hash) [consumed]
                  Node 14890 (Hash Join)
                    Node 14891 (Seq Scan) - LEAF
                    Node 14892 (Hash) [PATTERN: a54055ce]
                      Node 14893 (Hash Join) [consumed]
                        Node 14894 (Seq Scan) [consumed] - LEAF
                        Node 14895 (Hash) [consumed]
                          Node 14896 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 14892 | 14880, 14881, 14883, 14884, 14885, 14886, 14887, 14888, 14889, 14893, 14894, 14895, 14896, 14898, 14901 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 14887 | 14880, 14881, 14883, 14884, 14885, 14886, 14888, 14889, 14892, 14893, 14894, 14895, 14896, 14898, 14901 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 14883 | 14880, 14881, 14884, 14885, 14886, 14887, 14888, 14889, 14892, 14893, 14894, 14895, 14896, 14898, 14901 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 14885 | 14880, 14881, 14883, 14884, 14886, 14887, 14888, 14889, 14892, 14893, 14894, 14895, 14896, 14898, 14901 |
| Aggregate -> Gather Merge (Out | 2724c080 | 14880 | 14881, 14883, 14884, 14885, 14886, 14887, 14888, 14889, 14892, 14893, 14894, 14895, 14896, 14898, 14901 |
...
| 14882 | Sort | 1242.26 | 1096.02 | 11.8% | operator |
| 14883 | Hash Join | 1241.97 | 1199.17 | 3.4% | pattern |
| 14885 | Hash Join | 1237.68 | 1192.82 | 3.6% | pattern |
| 14900 | Index Scan | 0.01 | 0.05 | 753.5% | operator |
| 14902 | Seq Scan | 0.01 | 7.19 | 71844.7% | operator |
| 14887 | Hash Join | 218.36 | 260.30 | 19.2% | pattern |
| 14897 | Index Scan | 0.04 | 0.09 | 107.2% | operator |
| 14899 | Seq Scan | 41.44 | 44.48 | 7.4% | operator |
| 14890 | Hash Join | 37.99 | 67.79 | 78.4% | operator |
| 14891 | Seq Scan | 36.47 | 24.87 | 31.8% | operator |
| 14892 | Hash | 0.20 | 0.20 | 1.9% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 14891 (Seq Scan) - LEAF
...
### Step 2: Node 14892 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 14880, 14881, 14883, 14884, 14885, 14886, 14887, 14888, 14889, 14893, 14894, 14895, 14896, 14898, 14901
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
- **Consumes:** Nodes 14880, 14881, 14883, 14884, 14885, 14886, 14888, 14889, 14892, 14893, 14894, 14895, 14896, 14898, 14901
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=29497
  - HashJoin_nt1=147487
...
### Step 5: Node 14897 (Index Scan) - LEAF
...
### Step 6: Node 14899 (Seq Scan) - LEAF
...
- **Consumes:** Nodes 14880, 14881, 14883, 14884, 14886, 14887, 14888, 14889, 14892, 14893, 14894, 14895, 14896, 14898, 14901
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=788
  - HashJoin_nt1=118013
...
### Step 8: Node 14900 (Index Scan) - LEAF
...
### Step 9: Node 14902 (Seq Scan) - LEAF
...
- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 14880, 14881, 14884, 14885, 14886, 14887, 14888, 14889, 14892, 14893, 14894, 14895, 14896, 14898, 14901
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=788
  - HashJoin_nt1=788
...
### Step 12: Node 14880 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 14881, 14883, 14884, 14885, 14886, 14887, 14888, 14889, 14892, 14893, 14894, 14895, 14896, 14898, 14901
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2442
