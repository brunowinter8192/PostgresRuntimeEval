...
```
Node 14880 (Aggregate) [PATTERN: 53f9aa07] - ROOT
  Node 14881 (Gather Merge) [consumed]
    Node 14882 (Sort) [consumed]
      Node 14883 (Hash Join) [consumed]
        Node 14884 (Nested Loop) [consumed]
          Node 14885 (Hash Join)
            Node 14886 (Nested Loop) [PATTERN: bd9dfa7b]
              Node 14887 (Hash Join) [consumed]
              ...
              Node 14897 (Index Scan) [consumed] - LEAF
            Node 14898 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 53f9aa07 | 14880 | 14881, 14882, 14883, 14884, 14886, 14887, 14888, 14889, 14890, 14892, 14893, 14894, 14895, 14896, 14897, 14901 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 14892 | 14880, 14881, 14882, 14883, 14884, 14886, 14887, 14888, 14889, 14890, 14893, 14894, 14895, 14896, 14897, 14901 |
| Nested Loop -> [Hash Join -> [ | bd9dfa7b | 14886 | 14880, 14881, 14882, 14883, 14884, 14887, 14888, 14889, 14890, 14892, 14893, 14894, 14895, 14896, 14897, 14901 |
...
|------|------|--------|-----------|-----|--------|
| 14880 | Aggregate | 1247.63 | 1220.51 | 2.2% | pattern |
| 14885 | Hash Join | 1237.68 | 1042.87 | 15.7% | operator |
| 14900 | Index Scan | 0.01 | 0.05 | 753.5% | operator |
| 14902 | Seq Scan | 0.01 | 7.19 | 71844.7% | operator |
| 14886 | Nested Loop | 1191.65 | 1155.06 | 3.1% | pattern |
...
- **Consumes:** Nodes 14880, 14881, 14882, 14883, 14884, 14886, 14887, 14888, 14889, 14890, 14893, 14894, 14895, 14896, 14897, 14901
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 3: Node 14899 (Seq Scan) - LEAF
...
### Step 4: Node 14886 (Nested Loop) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bd9dfa7b (Nested Loop -> [Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer), Index Scan (Inner)])
- **Consumes:** Nodes 14880, 14881, 14882, 14883, 14884, 14887, 14888, 14889, 14890, 14892, 14893, 14894, 14895, 14896, 14897, 14901
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 7: Node 14900 (Index Scan) - LEAF
...
### Step 8: Node 14902 (Seq Scan) - LEAF
...
### Step 9: Node 14880 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 53f9aa07 (Aggregate -> Gather Merge -> Sort -> Hash Join -> [Nested Loop (Outer), Hash (Inner)] (Outer) (Outer) (Outer))
- **Consumes:** Nodes 14881, 14882, 14883, 14884, 14886, 14887, 14888, 14889, 14890, 14892, 14893, 14894, 14895, 14896, 14897, 14901
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2442
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=788
  - HashJoin_Outer_nt1=788
  - HashJoin_Outer_nt2=25
  - HashJoin_Outer_parallel_workers=0
  - HashJoin_Outer_plan_width=148
  - HashJoin_Outer_reltuples=0.0000
  - HashJoin_Outer_sel=0.0400
  - HashJoin_Outer_startup_cost=9921.9900
  - HashJoin_Outer_total_cost=70515.9800
  - Hash_Inner_np=0
  - Hash_Inner_nt=25
  - Hash_Inner_nt1=25
  - Hash_Inner_nt2=0
  ...
  - Sort_Outer_startup_cost=70553.8900
  - Sort_Outer_total_cost=70555.8600
