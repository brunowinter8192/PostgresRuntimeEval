...
```
Node 181 (Aggregate) [PATTERN: 3dfa6025] - ROOT
  Node 182 (Gather Merge) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 3dfa6025 | 181 | 182, 183, 184, 185 |
...
|------|------|--------|-----------|-----|--------|
| 181 | Aggregate | 923.90 | 953.98 | 3.3% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 181 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3dfa6025 (Aggregate -> Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 182, 183, 184, 185
- **Input Features:**
  ...
  - Aggregate_startup_cost=170301.0700
  - Aggregate_total_cost=170305.8400
  ...
  - GatherMerge_Outer_startup_cost=170301.0700
  - GatherMerge_Outer_total_cost=170304.7000
