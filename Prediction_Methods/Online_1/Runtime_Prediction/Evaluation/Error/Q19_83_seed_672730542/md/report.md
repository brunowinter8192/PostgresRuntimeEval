...
**Test Query:** Q19_83_seed_672730542
...
```
Node 32137 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 32138 (Gather) [consumed]
    Node 32139 (Aggregate) [consumed]
      Node 32140 (Hash Join) [PATTERN: f4cb205a]
        Node 32141 (Seq Scan) [consumed] - LEAF
        Node 32142 (Hash) [consumed]
          Node 32143 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 32140 | 32137, 32138, 32139, 32141, 32142, 32143 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 32137 | 32138, 32139, 32140, 32141, 32142, 32143 |
...
|------|------|--------|-----------|-----|--------|
| 32137 | Aggregate | 847.46 | 834.50 | 1.5% | pattern |
| 32140 | Hash Join | 827.80 | 373.82 | 54.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 32140 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 32137, 32138, 32139, 32141, 32142, 32143
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=23
  - HashJoin_nt1=22530
  ...
  - HashJoin_sel=0.0000
  - HashJoin_startup_cost=7672.1500
...
### Step 2: Node 32137 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 32138, 32139, 32140, 32141, 32142, 32143
- **Input Features:**
