...
```
Node 32137 (Aggregate) [PATTERN: f8295d8b] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 32137 | 32138, 32139, 32140, 32141, 32142, 32143 |
...
|------|------|--------|-----------|-----|--------|
| 32137 | Aggregate | 847.46 | 841.17 | 0.7% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 32137 (Aggregate) - PATTERN ROOT
