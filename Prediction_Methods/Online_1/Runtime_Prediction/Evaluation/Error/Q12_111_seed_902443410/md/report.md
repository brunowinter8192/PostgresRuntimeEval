...
Node 24404 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 24405 (Gather Merge) [consumed]
    Node 24406 (Aggregate)
      Node 24407 (Sort)
        Node 24408 (Nested Loop)
          Node 24409 (Seq Scan) - LEAF
          Node 24410 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge (Out | 2724c080 | 24404 | 24405 |
...
| 24406 | Aggregate | 968.92 | 941.96 | 2.8% | operator |
| 24407 | Sort | 968.29 | 1058.11 | 9.3% | operator |
| 24408 | Nested Loop | 966.91 | 1101.32 | 13.9% | operator |
| 24409 | Seq Scan | 835.05 | 750.46 | 10.1% | operator |
| 24410 | Index Scan | 0.03 | -0.02 | 165.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24409 (Seq Scan) - LEAF
...
### Step 2: Node 24410 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - st2=0.0258
  - startup_cost=0.4300
  - total_cost=147195.7700
- **Output:** st=21.29, rt=1101.32

### Step 4: Node 24407 (Sort)
...
### Step 6: Node 24404 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 24405
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=7
  - Aggregate_nt1=35
