...
```
Node 24404 (Aggregate) [PATTERN: f9c97829] - ROOT
  Node 24405 (Gather Merge) [consumed]
    Node 24406 (Aggregate) [consumed]
      Node 24407 (Sort) [consumed]
        Node 24408 (Nested Loop) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> A | f9c97829 | 24404 | 24405, 24406, 24407, 24408, 24409, 24410 |
...
|------|------|--------|-----------|-----|--------|
| 24404 | Aggregate | 990.31 | 998.49 | 0.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24404 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 24405, 24406, 24407, 24408, 24409, 24410
- **Input Features:**
  ...
  - Aggregate_Outer_startup_cost=147558.3300
  - Aggregate_Outer_total_cost=147674.4000
  - Aggregate_np=0
  - Aggregate_nt=7
  - Aggregate_nt1=35
  - Aggregate_nt2=0
  ...
  - NestedLoop_Outer_total_cost=147195.7700
  ...
  - Sort_Outer_startup_cost=147558.3300
  - Sort_Outer_total_cost=147572.8300
