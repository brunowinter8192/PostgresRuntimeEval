    ...
    Node 20386 (Aggregate) [consumed]
      Node 20387 (Gather) [consumed]
        Node 20388 (Hash Join) [consumed]
          Node 20389 (Hash Join) [PATTERN: 2873b8c3]
            Node 20390 (Nested Loop) [consumed]
              Node 20391 (Seq Scan) [consumed] - LEAF
              Node 20392 (Index Scan) [consumed] - LEAF
            Node 20393 (Hash) [consumed]
              Node 20394 (Seq Scan) [consumed] - LEAF
          Node 20395 (Hash)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 20384 | 20385, 20386, 20387, 20388, 20389, 20390, 20391, 20392, 20393, 20394 |
| Hash Join -> [Nested Loop -> [ | 2873b8c3 | 20389 | 20384, 20385, 20386, 20387, 20388, 20390, 20391, 20392, 20393, 20394 |
...
### Step 2: Node 20389 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2873b8c3 (Hash Join -> [Nested Loop -> [Seq Scan (Outer), Index Scan (Inner)] (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 20384, 20385, 20386, 20387, 20388, 20390, 20391, 20392, 20393, 20394
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18130
  - HashJoin_nt1=18130
...
### Step 4: Node 20384 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20385, 20386, 20387, 20388, 20389, 20390, 20391, 20392, 20393, 20394
- **Input Features:**
