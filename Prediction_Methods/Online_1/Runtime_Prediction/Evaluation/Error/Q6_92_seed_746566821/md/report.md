...
```
Node 10465 (Aggregate) [PATTERN: dd3706ac] - ROOT
  Node 10466 (Gather) [consumed]
    Node 10467 (Aggregate) [consumed]
      Node 10468 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | dd3706ac | 10465 | 10466, 10467, 10468 |
...
|------|------|--------|-----------|-----|--------|
| 10465 | Aggregate | 795.67 | 791.26 | 0.6% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10465 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** dd3706ac (Aggregate -> Gather -> Aggregate -> Seq Scan (Outer) (Outer) (Outer))
- **Consumes:** Nodes 10466, 10467, 10468
- **Input Features:**
