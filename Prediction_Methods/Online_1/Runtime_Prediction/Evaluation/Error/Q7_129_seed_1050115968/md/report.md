  ...
  Node 11060 (Gather Merge) [consumed]
    Node 11061 (Sort)
      Node 11062 (Hash Join)
        ...
        Node 11072 (Hash) [PATTERN: a54055ce]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 11066 | 11059, 11060, 11067, 11068, 11069, 11070, 11072, 11073, 11074, 11075, 11076 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 11072 | 11059, 11060, 11066, 11067, 11068, 11069, 11070, 11073, 11074, 11075, 11076 |
| Aggregate -> Gather Merge (Out | 2724c080 | 11059 | 11060, 11066, 11067, 11068, 11069, 11070, 11072, 11073, 11074, 11075, 11076 |
...
| 11062 | Hash Join | 1174.59 | 1130.43 | 3.8% | operator |
| 11063 | Nested Loop | 1168.60 | 1145.81 | 1.9% | operator |
| 11072 | Hash | 2.24 | 3.42 | 52.6% | pattern |
| 11064 | Hash Join | 215.00 | 319.90 | 48.8% | operator |
...
### Step 1: Node 11065 (Seq Scan) - LEAF
...
### Step 2: Node 11066 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 11059, 11060, 11067, 11068, 11069, 11070, 11072, 11073, 11074, 11075, 11076
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 11071 (Index Scan) - LEAF
...
### Step 6: Node 11072 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 11059, 11060, 11066, 11067, 11068, 11069, 11070, 11073, 11074, 11075, 11076
- **Input Features:**
  - HashJoin_Outer_np=0
...
- **Consumes:** Nodes 11060, 11066, 11067, 11068, 11069, 11070, 11072, 11073, 11074, 11075, 11076
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
