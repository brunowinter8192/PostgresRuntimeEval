...
```
Node 11059 (Aggregate) - ROOT
  Node 11060 (Gather Merge)
    Node 11061 (Sort)
      Node 11062 (Hash Join)
        Node 11063 (Nested Loop)
          Node 11064 (Hash Join)
            Node 11065 (Seq Scan) - LEAF
            Node 11066 (Hash)
              Node 11067 (Hash Join)
                Node 11068 (Seq Scan) - LEAF
                Node 11069 (Hash)
                  Node 11070 (Seq Scan) - LEAF
          Node 11071 (Index Scan) - LEAF
        Node 11072 (Hash)
          Node 11073 (Hash Join)
...
|------|------|--------|-----------|-----|--------|
| 11059 | Aggregate | 1182.61 | 1202.22 | 1.7% | operator |
| 11060 | Gather Merge | 1181.51 | 1148.45 | 2.8% | operator |
| 11061 | Sort | 1175.16 | 1149.87 | 2.2% | operator |
| 11062 | Hash Join | 1174.59 | 1130.50 | 3.8% | operator |
| 11063 | Nested Loop | 1168.60 | 1145.81 | 2.0% | operator |
| 11072 | Hash | 2.24 | 15.44 | 588.5% | operator |
| 11064 | Hash Join | 215.00 | 319.53 | 48.6% | operator |
| 11071 | Index Scan | 0.03 | 0.09 | 180.5% | operator |
| 11073 | Hash Join | 2.20 | 49.64 | 2158.3% | operator |
| 11065 | Seq Scan | 151.45 | 192.19 | 26.9% | operator |
| 11066 | Hash | 37.01 | 17.27 | 53.3% | operator |
| 11074 | Seq Scan | 1.85 | 10.62 | 474.8% | operator |
| 11075 | Hash | 0.01 | 14.54 | 111724.3% | operator |
| 11067 | Hash Join | 36.65 | 54.15 | 47.8% | operator |
| 11076 | Seq Scan | 0.01 | 7.20 | 65317.7% | operator |
| 11068 | Seq Scan | 35.49 | 24.87 | 29.9% | operator |
| 11069 | Hash | 0.01 | 14.54 | 161424.0% | operator |
| 11070 | Seq Scan | 0.01 | 7.20 | 102699.2% | operator |
...
### Step 2: Node 11068 (Seq Scan) - LEAF
...
### Step 5: Node 11076 (Seq Scan) - LEAF
...
### Step 6: Node 11065 (Seq Scan) - LEAF
...
### Step 8: Node 11074 (Seq Scan) - LEAF
...
### Step 11: Node 11071 (Index Scan) - LEAF
...
### Step 13: Node 11063 (Nested Loop)
...
### Step 17: Node 11060 (Gather Merge)
...
### Step 18: Node 11059 (Aggregate) - ROOT
