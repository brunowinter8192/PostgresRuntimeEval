    ...
    Node 19489 (Aggregate) [consumed]
      Node 19490 (Gather) [consumed]
        Node 19491 (Hash Join) [consumed]
          Node 19492 (Hash Join) [PATTERN: 2873b8c3]
            Node 19493 (Nested Loop) [consumed]
              Node 19494 (Seq Scan) [consumed] - LEAF
              Node 19495 (Index Scan) [consumed] - LEAF
            Node 19496 (Hash) [consumed]
              Node 19497 (Seq Scan) [consumed] - LEAF
          Node 19498 (Hash)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 19487 | 19488, 19489, 19490, 19491, 19492, 19493, 19494, 19495, 19496, 19497 |
| Hash Join -> [Nested Loop -> [ | 2873b8c3 | 19492 | 19487, 19488, 19489, 19490, 19491, 19493, 19494, 19495, 19496, 19497 |
...
### Step 2: Node 19492 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2873b8c3 (Hash Join -> [Nested Loop -> [Seq Scan (Outer), Index Scan (Inner)] (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 19487, 19488, 19489, 19490, 19491, 19493, 19494, 19495, 19496, 19497
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18130
  - HashJoin_nt1=18130
...
- **Output:** st=36.97, rt=725.11

### Step 3: Node 19498 (Hash)
...
### Step 4: Node 19487 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19488, 19489, 19490, 19491, 19492, 19493, 19494, 19495, 19496, 19497
- **Input Features:**
