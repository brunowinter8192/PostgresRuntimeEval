...
```
Node 6327 (Aggregate) [PATTERN: 80bd802d] - ROOT
  Node 6328 (Gather Merge) [consumed]
    Node 6329 (Sort) [consumed]
      Node 6330 (Aggregate) [consumed]
        Node 6331 (Nested Loop) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 80bd802d | 6327 | 6328, 6329, 6330, 6331, 6332, 6333 |
...
|------|------|--------|-----------|-----|--------|
| 6327 | Aggregate | 1068.77 | 1057.79 | 1.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6327 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 6328, 6329, 6330, 6331, 6332, 6333
- **Input Features:**
  ...
  - NestedLoop_Outer_total_cost=65954.5700
  - SeqScan_Outer_np=26136
  - SeqScan_Outer_nt=18429
  - SeqScan_Outer_nt1=0
  - SeqScan_Outer_nt2=0
