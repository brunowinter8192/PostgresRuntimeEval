...
```
Node 10373 (Aggregate) [PATTERN: dd3706ac] - ROOT
  Node 10374 (Gather) [consumed]
    Node 10375 (Aggregate) [consumed]
      Node 10376 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | dd3706ac | 10373 | 10374, 10375, 10376 |
...
|------|------|--------|-----------|-----|--------|
| 10373 | Aggregate | 792.40 | 791.26 | 0.1% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10373 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** dd3706ac (Aggregate -> Gather -> Aggregate -> Seq Scan (Outer) (Outer) (Outer))
- **Consumes:** Nodes 10374, 10375, 10376
- **Input Features:**
