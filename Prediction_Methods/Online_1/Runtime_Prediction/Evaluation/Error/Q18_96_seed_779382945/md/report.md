...
```
Node 31140 (Limit) [PATTERN: 0aa5463f] - ROOT
    ...
    Node 31142 (Aggregate) [consumed]
      Node 31143 (Gather Merge) [consumed]
        Node 31144 (Incremental Sort) [consumed]
          Node 31145 (Nested Loop) [consumed]
            Node 31146 (Merge Join) [consumed]
              Node 31147 (Sort)
            ...
            Node 31155 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 0aa5463f | 31140 | 31141, 31142, 31143, 31144, 31145, 31146, 31148, 31149, 31150, 31155 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 31148 | 31140, 31141, 31142, 31143, 31144, 31145, 31146, 31149, 31150, 31155 |
...
- **Consumes:** Nodes 31140, 31141, 31142, 31143, 31144, 31145, 31146, 31149, 31150, 31155
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 7: Node 31140 (Limit) - PATTERN ROOT
...
- **Consumes:** Nodes 31141, 31142, 31143, 31144, 31145, 31146, 31148, 31149, 31150, 31155
- **Input Features:**
