...
```
Node 26994 (Aggregate) [PATTERN: f8295d8b] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 26994 | 26995, 26996, 26997, 26998, 26999, 27000 |
...
|------|------|--------|-----------|-----|--------|
| 26994 | Aggregate | 814.55 | 822.99 | 1.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26994 (Aggregate) - PATTERN ROOT
