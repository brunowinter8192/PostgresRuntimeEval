...
```
Node 6299 (Aggregate) [PATTERN: 80bd802d] - ROOT
  Node 6300 (Gather Merge) [consumed]
    Node 6301 (Sort) [consumed]
      Node 6302 (Aggregate) [consumed]
        Node 6303 (Nested Loop) [consumed]
          Node 6304 (Seq Scan) [consumed] - LEAF
          Node 6305 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 80bd802d | 6299 | 6300, 6301, 6302, 6303, 6304, 6305 |
...
|------|------|--------|-----------|-----|--------|
| 6299 | Aggregate | 1052.31 | 1057.79 | 0.5% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6299 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 6300, 6301, 6302, 6303, 6304, 6305
- **Input Features:**
  ...
  - NestedLoop_Outer_nt=14572
  - NestedLoop_Outer_nt1=17869
  ...
  - NestedLoop_Outer_total_cost=65507.8400
  - SeqScan_Outer_np=26136
  - SeqScan_Outer_nt=17869
  - SeqScan_Outer_nt1=0
  - SeqScan_Outer_nt2=0
