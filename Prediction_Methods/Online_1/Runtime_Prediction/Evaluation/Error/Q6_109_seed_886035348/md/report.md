...
```
Node 9937 (Aggregate) [PATTERN: dd3706ac] - ROOT
  Node 9938 (Gather) [consumed]
    Node 9939 (Aggregate) [consumed]
      Node 9940 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | dd3706ac | 9937 | 9938, 9939, 9940 |
...
|------|------|--------|-----------|-----|--------|
| 9937 | Aggregate | 806.28 | 791.26 | 1.9% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 9937 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** dd3706ac (Aggregate -> Gather -> Aggregate -> Seq Scan (Outer) (Outer) (Outer))
- **Consumes:** Nodes 9938, 9939, 9940
- **Input Features:**
