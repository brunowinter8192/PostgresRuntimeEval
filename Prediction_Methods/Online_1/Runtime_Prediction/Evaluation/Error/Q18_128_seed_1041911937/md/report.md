...
```
Node 29300 (Limit) [PATTERN: 0aa5463f] - ROOT
    ...
    Node 29302 (Aggregate) [consumed]
      Node 29303 (Gather Merge) [consumed]
        Node 29304 (Incremental Sort) [consumed]
          Node 29305 (Nested Loop) [consumed]
            Node 29306 (Merge Join) [consumed]
              Node 29307 (Sort)
            ...
            Node 29315 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 0aa5463f | 29300 | 29301, 29302, 29303, 29304, 29305, 29306, 29308, 29309, 29310, 29315 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29308 | 29300, 29301, 29302, 29303, 29304, 29305, 29306, 29309, 29310, 29315 |
...
- **Consumes:** Nodes 29300, 29301, 29302, 29303, 29304, 29305, 29306, 29309, 29310, 29315
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 7: Node 29300 (Limit) - PATTERN ROOT
...
- **Consumes:** Nodes 29301, 29302, 29303, 29304, 29305, 29306, 29308, 29309, 29310, 29315
- **Input Features:**
