...
```
Node 14029 (Aggregate) [PATTERN: 53f9aa07] - ROOT
  Node 14030 (Gather Merge) [consumed]
    Node 14031 (Sort) [consumed]
      Node 14032 (Hash Join) [consumed]
        Node 14033 (Nested Loop) [consumed]
          Node 14034 (Hash Join)
            Node 14035 (Nested Loop) [PATTERN: bd9dfa7b]
              Node 14036 (Hash Join) [consumed]
              ...
              Node 14046 (Index Scan) [consumed] - LEAF
            Node 14047 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 53f9aa07 | 14029 | 14030, 14031, 14032, 14033, 14035, 14036, 14037, 14038, 14039, 14041, 14042, 14043, 14044, 14045, 14046, 14050 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 14041 | 14029, 14030, 14031, 14032, 14033, 14035, 14036, 14037, 14038, 14039, 14042, 14043, 14044, 14045, 14046, 14050 |
| Nested Loop -> [Hash Join -> [ | bd9dfa7b | 14035 | 14029, 14030, 14031, 14032, 14033, 14036, 14037, 14038, 14039, 14041, 14042, 14043, 14044, 14045, 14046, 14050 |
...
|------|------|--------|-----------|-----|--------|
| 14029 | Aggregate | 1210.12 | 1220.51 | 0.9% | pattern |
| 14034 | Hash Join | 1200.42 | 1042.87 | 13.1% | operator |
| 14049 | Index Scan | 0.01 | 0.05 | 753.5% | operator |
| 14051 | Seq Scan | 0.01 | 7.19 | 79838.6% | operator |
| 14035 | Nested Loop | 1155.56 | 1155.06 | 0.0% | pattern |
...
- **Consumes:** Nodes 14029, 14030, 14031, 14032, 14033, 14035, 14036, 14037, 14038, 14039, 14042, 14043, 14044, 14045, 14046, 14050
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 3: Node 14048 (Seq Scan) - LEAF
...
### Step 4: Node 14035 (Nested Loop) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bd9dfa7b (Nested Loop -> [Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer), Index Scan (Inner)])
- **Consumes:** Nodes 14029, 14030, 14031, 14032, 14033, 14036, 14037, 14038, 14039, 14041, 14042, 14043, 14044, 14045, 14046, 14050
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 7: Node 14049 (Index Scan) - LEAF
...
### Step 8: Node 14051 (Seq Scan) - LEAF
...
### Step 9: Node 14029 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 53f9aa07 (Aggregate -> Gather Merge -> Sort -> Hash Join -> [Nested Loop (Outer), Hash (Inner)] (Outer) (Outer) (Outer))
- **Consumes:** Nodes 14030, 14031, 14032, 14033, 14035, 14036, 14037, 14038, 14039, 14041, 14042, 14043, 14044, 14045, 14046, 14050
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2446
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=789
  - HashJoin_Outer_nt1=789
  - HashJoin_Outer_nt2=25
  - HashJoin_Outer_parallel_workers=0
  - HashJoin_Outer_plan_width=148
  - HashJoin_Outer_reltuples=0.0000
  - HashJoin_Outer_sel=0.0400
  - HashJoin_Outer_startup_cost=9922.0000
  - HashJoin_Outer_total_cost=70516.3000
  - Hash_Inner_np=0
  - Hash_Inner_nt=25
  - Hash_Inner_nt1=25
  - Hash_Inner_nt2=0
  ...
  - Sort_Outer_startup_cost=70554.2700
  - Sort_Outer_total_cost=70556.2400
- **Output:** st=1219.14, rt=1220.51
