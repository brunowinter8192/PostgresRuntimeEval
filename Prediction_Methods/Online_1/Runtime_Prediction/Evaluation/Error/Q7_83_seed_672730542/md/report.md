...
```
Node 12859 (Aggregate) - ROOT
  Node 12860 (Gather Merge)
    Node 12861 (Sort)
      Node 12862 (Hash Join)
        Node 12863 (Nested Loop)
          Node 12864 (Hash Join)
            Node 12865 (Seq Scan) - LEAF
            Node 12866 (Hash)
              Node 12867 (Hash Join)
                Node 12868 (Seq Scan) - LEAF
                Node 12869 (Hash)
                  Node 12870 (Seq Scan) - LEAF
          Node 12871 (Index Scan) - LEAF
        Node 12872 (Hash)
          Node 12873 (Hash Join)
            Node 12874 (Seq Scan) - LEAF
            Node 12875 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 12859 | Aggregate | 1220.66 | 1202.22 | 1.5% | operator |
| 12860 | Gather Merge | 1219.62 | 1148.45 | 5.8% | operator |
| 12861 | Sort | 1211.69 | 1149.87 | 5.1% | operator |
| 12862 | Hash Join | 1211.07 | 1130.50 | 6.7% | operator |
| 12863 | Nested Loop | 1205.25 | 1145.81 | 4.9% | operator |
| 12872 | Hash | 2.00 | 15.44 | 671.1% | operator |
| 12864 | Hash Join | 214.29 | 319.53 | 49.1% | operator |
| 12871 | Index Scan | 0.03 | 0.09 | 163.5% | operator |
| 12873 | Hash Join | 1.96 | 49.64 | 2433.9% | operator |
| 12865 | Seq Scan | 151.80 | 192.19 | 26.6% | operator |
| 12866 | Hash | 36.20 | 17.27 | 52.3% | operator |
| 12874 | Seq Scan | 1.65 | 10.62 | 545.4% | operator |
| 12875 | Hash | 0.01 | 14.54 | 111724.3% | operator |
| 12867 | Hash Join | 35.85 | 54.15 | 51.0% | operator |
| 12876 | Seq Scan | 0.01 | 7.20 | 71859.5% | operator |
| 12868 | Seq Scan | 34.71 | 24.87 | 28.3% | operator |
| 12869 | Hash | 0.01 | 14.54 | 161424.0% | operator |
| 12870 | Seq Scan | 0.01 | 7.20 | 102699.2% | operator |
...
### Step 2: Node 12868 (Seq Scan) - LEAF
...
### Step 5: Node 12876 (Seq Scan) - LEAF
...
### Step 6: Node 12865 (Seq Scan) - LEAF
...
### Step 8: Node 12874 (Seq Scan) - LEAF
...
### Step 11: Node 12871 (Index Scan) - LEAF
...
### Step 13: Node 12863 (Nested Loop)
...
### Step 17: Node 12860 (Gather Merge)
...
### Step 18: Node 12859 (Aggregate) - ROOT
