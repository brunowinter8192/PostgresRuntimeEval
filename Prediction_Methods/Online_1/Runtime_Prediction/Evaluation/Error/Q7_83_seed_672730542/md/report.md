      ...
      Node 12862 (Hash Join)
        Node 12863 (Nested Loop)
          Node 12864 (Hash Join)
            ...
            Node 12866 (Hash) [PATTERN: a54055ce]
              Node 12867 (Hash Join) [consumed]
                Node 12868 (Seq Scan) [consumed] - LEAF
                Node 12869 (Hash) [consumed]
                  Node 12870 (Seq Scan) [consumed] - LEAF
          Node 12871 (Index Scan) - LEAF
        Node 12872 (Hash) [PATTERN: a54055ce]
          Node 12873 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 12866 | 12859, 12860, 12867, 12868, 12869, 12870, 12872, 12873, 12874, 12875, 12876 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 12872 | 12859, 12860, 12866, 12867, 12868, 12869, 12870, 12873, 12874, 12875, 12876 |
| Aggregate -> Gather Merge (Out | 2724c080 | 12859 | 12860, 12866, 12867, 12868, 12869, 12870, 12872, 12873, 12874, 12875, 12876 |
...
| 12862 | Hash Join | 1211.07 | 1130.43 | 6.7% | operator |
| 12863 | Nested Loop | 1205.25 | 1145.81 | 4.9% | operator |
| 12872 | Hash | 2.00 | 3.42 | 70.8% | pattern |
| 12864 | Hash Join | 214.29 | 319.90 | 49.3% | operator |
| 12871 | Index Scan | 0.03 | 0.09 | 163.5% | operator |
| 12865 | Seq Scan | 151.80 | 192.19 | 26.6% | operator |
| 12866 | Hash | 36.20 | 35.59 | 1.7% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12865 (Seq Scan) - LEAF
...
### Step 2: Node 12866 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 12859, 12860, 12867, 12868, 12869, 12870, 12872, 12873, 12874, 12875, 12876
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 12871 (Index Scan) - LEAF
...
### Step 6: Node 12872 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 12859, 12860, 12866, 12867, 12868, 12869, 12870, 12873, 12874, 12875, 12876
- **Input Features:**
  - HashJoin_Outer_np=0
...
- **Consumes:** Nodes 12860, 12866, 12867, 12868, 12869, 12870, 12872, 12873, 12874, 12875, 12876
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
