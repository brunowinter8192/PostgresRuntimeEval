...
```
Node 12859 (Aggregate) [PATTERN: 27c3eea9] - ROOT
  Node 12860 (Gather Merge) [consumed]
    Node 12861 (Sort) [consumed]
      Node 12862 (Hash Join) [consumed]
        Node 12863 (Nested Loop) [consumed]
          Node 12864 (Hash Join) [consumed]
          ...
          Node 12871 (Index Scan) [consumed] - LEAF
        Node 12872 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 27c3eea9 | 12859 | 12860, 12861, 12862, 12863, 12864, 12866, 12867, 12868, 12869, 12870, 12871, 12872, 12873 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 12866 | 12859, 12860, 12861, 12862, 12863, 12864, 12867, 12868, 12869, 12870, 12871, 12872, 12873 |
...
|------|------|--------|-----------|-----|--------|
| 12859 | Aggregate | 1220.66 | 1200.90 | 1.6% | pattern |
...
### Step 1: Node 12876 (Seq Scan) - LEAF
...
### Step 2: Node 12865 (Seq Scan) - LEAF
...
### Step 3: Node 12866 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 12859, 12860, 12861, 12862, 12863, 12864, 12867, 12868, 12869, 12870, 12871, 12872, 12873
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 12874 (Seq Scan) - LEAF
...
### Step 6: Node 12859 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 12860, 12861, 12862, 12863, 12864, 12866, 12867, 12868, 12869, 12870, 12871, 12872, 12873
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
