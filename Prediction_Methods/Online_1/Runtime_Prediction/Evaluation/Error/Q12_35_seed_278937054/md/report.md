...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> A | f9c97829 | 24866 | 24867, 24868, 24869, 24870, 24871, 24872 |
...
|------|------|--------|-----------|-----|--------|
| 24866 | Aggregate | 1008.63 | 998.49 | 1.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24866 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 24867, 24868, 24869, 24870, 24871, 24872
- **Input Features:**
  ...
  - NestedLoop_Outer_nt=5782
  - NestedLoop_Outer_nt1=5782
  ...
  - NestedLoop_Outer_total_cost=147179.4500
  ...
  - Sort_Outer_startup_cost=147540.7500
  - Sort_Outer_total_cost=147555.2000
