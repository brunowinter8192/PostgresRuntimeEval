...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge (Out | 2724c080 | 24866 | 24867 |
...
| 24868 | Aggregate | 984.54 | 941.96 | 4.3% | operator |
| 24869 | Sort | 983.92 | 1058.10 | 7.5% | operator |
| 24870 | Nested Loop | 982.98 | 1101.31 | 12.0% | operator |
| 24871 | Seq Scan | 846.06 | 750.46 | 11.3% | operator |
| 24872 | Index Scan | 0.03 | -0.02 | 163.4% | operator |
...
### Step 6: Node 24866 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 24867
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=7
  - Aggregate_nt1=35
