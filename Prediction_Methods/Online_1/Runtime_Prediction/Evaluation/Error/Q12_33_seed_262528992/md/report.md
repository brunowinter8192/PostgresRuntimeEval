...
```
Node 24852 (Aggregate) [PATTERN: f9c97829] - ROOT
  Node 24853 (Gather Merge) [consumed]
    Node 24854 (Aggregate) [consumed]
      Node 24855 (Sort) [consumed]
        Node 24856 (Nested Loop) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> A | f9c97829 | 24852 | 24853, 24854, 24855, 24856, 24857, 24858 |
...
|------|------|--------|-----------|-----|--------|
| 24852 | Aggregate | 989.96 | 998.49 | 0.9% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24852 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 24853, 24854, 24855, 24856, 24857, 24858
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=7
  - Aggregate_Outer_nt1=5735
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=27
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0012
  - Aggregate_Outer_startup_cost=147495.0500
  - Aggregate_Outer_total_cost=147609.8200
  - Aggregate_np=0
  - Aggregate_nt=7
  - Aggregate_nt1=35
  - Aggregate_nt2=0
  ...
  - NestedLoop_Outer_nt=5735
  - NestedLoop_Outer_nt1=5735
  ...
  - NestedLoop_Outer_total_cost=147137.0200
  ...
  - Sort_Outer_startup_cost=147495.0500
  - Sort_Outer_total_cost=147509.3800
