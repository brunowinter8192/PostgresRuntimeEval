...
```
Node 5984 (Aggregate) [PATTERN: 80bd802d] - ROOT
  Node 5985 (Gather Merge) [consumed]
    Node 5986 (Sort) [consumed]
      Node 5987 (Aggregate) [consumed]
        Node 5988 (Nested Loop) [consumed]
          Node 5989 (Seq Scan) [consumed] - LEAF
          Node 5990 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 80bd802d | 5984 | 5985, 5986, 5987, 5988, 5989, 5990 |
...
|------|------|--------|-----------|-----|--------|
| 5984 | Aggregate | 1040.21 | 1057.79 | 1.7% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5984 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 5985, 5986, 5987, 5988, 5989, 5990
- **Input Features:**
  ...
  - IndexScan_Inner_total_cost=2.2600
  - NestedLoop_Outer_np=0
  - NestedLoop_Outer_nt=15330
  - NestedLoop_Outer_nt1=18799
