        ...
        Node 18069 (Nested Loop)
          Node 18070 (Hash Join) [PATTERN: 895c6e8c]
            ...
            Node 18072 (Hash) [consumed]
              Node 18073 (Hash Join) [PATTERN: 7a51ce50]
                Node 18074 (Hash Join) [consumed]
                  Node 18075 (Nested Loop) [consumed]
                    Node 18076 (Seq Scan) [consumed] - LEAF
                    Node 18077 (Index Scan) [consumed] - LEAF
                  Node 18078 (Hash) [consumed]
                    Node 18079 (Seq Scan) [consumed] - LEAF
                Node 18080 (Hash) [consumed]
                  Node 18081 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Hash Join -> [Hash Join -> [Ne | 7a51ce50 | 18073 | 18065, 18066, 18070, 18071, 18072, 18074, 18075, 18076, 18077, 18078, 18079, 18080, 18081 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 18070 | 18065, 18066, 18071, 18072, 18073, 18074, 18075, 18076, 18077, 18078, 18079, 18080, 18081 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18065 | 18066, 18070, 18071, 18072, 18073, 18074, 18075, 18076, 18077, 18078, 18079, 18080, 18081 |
...
| 18073 | Hash Join | 164.43 | 546.02 | 232.1% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 18073 (Hash Join) - PATTERN ROOT
...
- **Consumes:** Nodes 18065, 18066, 18070, 18071, 18072, 18074, 18075, 18076, 18077, 18078, 18079, 18080, 18081
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 2: Node 18070 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 18065, 18066, 18071, 18072, 18073, 18074, 18075, 18076, 18077, 18078, 18079, 18080, 18081
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=57726
...
### Step 3: Node 18082 (Index Scan) - LEAF
...
### Step 7: Node 18065 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18066, 18070, 18071, 18072, 18073, 18074, 18075, 18076, 18077, 18078, 18079, 18080, 18081
- **Input Features:**
