    ...
    Node 18067 (Gather) [consumed]
      Node 18068 (Aggregate) [consumed]
        Node 18069 (Nested Loop) [consumed]
          ...
          Node 18082 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather -> | 76ab422a | 18065 | 18066, 18067, 18068, 18069, 18070, 18071, 18072, 18073, 18074, 18075, 18078, 18080, 18081, 18082 |
...
|------|------|--------|-----------|-----|--------|
| 18065 | Sort | 1163.70 | 1194.98 | 2.7% | pattern |
...
### Step 4: Node 18065 (Sort) - PATTERN ROOT
...
- **Consumes:** Nodes 18066, 18067, 18068, 18069, 18070, 18071, 18072, 18073, 18074, 18075, 18078, 18080, 18081, 18082
- **Input Features:**
