    ...
    Node 4903 (Aggregate) [consumed]
      Node 4904 (Gather) [consumed]
        Node 4905 (Nested Loop)
          Node 4906 (Hash Join) [PATTERN: f4cb205a]
            Node 4907 (Seq Scan) [consumed] - LEAF
            Node 4908 (Hash) [consumed]
              Node 4909 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4901 | 4902, 4903, 4904, 4906, 4907, 4908, 4909 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 4906 | 4901, 4902, 4903, 4904, 4907, 4908, 4909 |
...
| 4905 | Nested Loop | 1148.23 | 1121.22 | 2.4% | operator |
| 4906 | Hash Join | 206.81 | 219.36 | 6.1% | pattern |
| 4910 | Index Scan | 0.03 | -0.02 | 171.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4906 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 4901, 4902, 4903, 4904, 4907, 4908, 4909
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46503
  - HashJoin_nt1=234452
...
### Step 2: Node 4910 (Index Scan) - LEAF
...
### Step 4: Node 4901 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4902, 4903, 4904, 4906, 4907, 4908, 4909
- **Input Features:**
