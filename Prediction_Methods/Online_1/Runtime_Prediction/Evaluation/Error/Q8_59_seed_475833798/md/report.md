...
Node 15593 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 15594 (Gather Merge) [consumed]
    Node 15595 (Sort)
      Node 15596 (Hash Join) [PATTERN: 2e0f44ef]
        Node 15597 (Nested Loop) [consumed]
          Node 15598 (Hash Join) [PATTERN: 2e0f44ef]
            Node 15599 (Nested Loop) [consumed]
              Node 15600 (Hash Join) [PATTERN: 895c6e8c]
                Node 15601 (Seq Scan) [consumed] - LEAF
                Node 15602 (Hash) [consumed]
                  Node 15603 (Hash Join)
                    Node 15604 (Seq Scan) - LEAF
                    Node 15605 (Hash) [PATTERN: a54055ce]
                      Node 15606 (Hash Join) [consumed]
                        Node 15607 (Seq Scan) [consumed] - LEAF
                        Node 15608 (Hash) [consumed]
                          Node 15609 (Seq Scan) [consumed] - LEAF
              Node 15610 (Index Scan) - LEAF
            Node 15611 (Hash) [consumed]
              Node 15612 (Seq Scan) - LEAF
          Node 15613 (Index Scan) - LEAF
        Node 15614 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 15605 | 15593, 15594, 15596, 15597, 15598, 15599, 15600, 15601, 15602, 15606, 15607, 15608, 15609, 15611, 15614 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 15600 | 15593, 15594, 15596, 15597, 15598, 15599, 15601, 15602, 15605, 15606, 15607, 15608, 15609, 15611, 15614 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 15596 | 15593, 15594, 15597, 15598, 15599, 15600, 15601, 15602, 15605, 15606, 15607, 15608, 15609, 15611, 15614 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 15598 | 15593, 15594, 15596, 15597, 15599, 15600, 15601, 15602, 15605, 15606, 15607, 15608, 15609, 15611, 15614 |
| Aggregate -> Gather Merge (Out | 2724c080 | 15593 | 15594, 15596, 15597, 15598, 15599, 15600, 15601, 15602, 15605, 15606, 15607, 15608, 15609, 15611, 15614 |
...
| 15595 | Sort | 1193.10 | 1096.02 | 8.1% | operator |
| 15596 | Hash Join | 1192.86 | 1199.17 | 0.5% | pattern |
| 15598 | Hash Join | 1188.61 | 1192.82 | 0.4% | pattern |
| 15613 | Index Scan | 0.01 | 0.05 | 753.5% | operator |
| 15615 | Seq Scan | 0.02 | 7.19 | 44865.5% | operator |
| 15600 | Hash Join | 214.40 | 260.30 | 21.4% | pattern |
| 15610 | Index Scan | 0.04 | 0.09 | 117.6% | operator |
| 15612 | Seq Scan | 39.83 | 44.48 | 11.7% | operator |
| 15603 | Hash Join | 37.20 | 67.79 | 82.3% | operator |
| 15604 | Seq Scan | 35.48 | 24.87 | 29.9% | operator |
| 15605 | Hash | 0.25 | 0.20 | 21.3% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 15604 (Seq Scan) - LEAF
...
### Step 2: Node 15605 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 15593, 15594, 15596, 15597, 15598, 15599, 15600, 15601, 15602, 15606, 15607, 15608, 15609, 15611, 15614
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 4: Node 15600 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 15593, 15594, 15596, 15597, 15598, 15599, 15601, 15602, 15605, 15606, 15607, 15608, 15609, 15611, 15614
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=29497
  - HashJoin_nt1=147487
...
### Step 5: Node 15610 (Index Scan) - LEAF
...
### Step 6: Node 15612 (Seq Scan) - LEAF
...
### Step 7: Node 15598 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 15593, 15594, 15596, 15597, 15599, 15600, 15601, 15602, 15605, 15606, 15607, 15608, 15609, 15611, 15614
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=784
  - HashJoin_nt1=118013
...
### Step 8: Node 15613 (Index Scan) - LEAF
...
### Step 9: Node 15615 (Seq Scan) - LEAF
...
### Step 10: Node 15596 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 15593, 15594, 15597, 15598, 15599, 15600, 15601, 15602, 15605, 15606, 15607, 15608, 15609, 15611, 15614
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=784
  - HashJoin_nt1=784
...
### Step 12: Node 15593 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 15594, 15596, 15597, 15598, 15599, 15600, 15601, 15602, 15605, 15606, 15607, 15608, 15609, 15611, 15614
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2431
