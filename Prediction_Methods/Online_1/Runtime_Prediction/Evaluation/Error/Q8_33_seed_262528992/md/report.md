...
Node 14949 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 14950 (Gather Merge) [consumed]
    Node 14951 (Sort)
      Node 14952 (Hash Join) [PATTERN: 2e0f44ef]
        Node 14953 (Nested Loop) [consumed]
          Node 14954 (Hash Join) [PATTERN: 2e0f44ef]
            Node 14955 (Nested Loop) [consumed]
              Node 14956 (Hash Join) [PATTERN: 895c6e8c]
                Node 14957 (Seq Scan) [consumed] - LEAF
                Node 14958 (Hash) [consumed]
                  Node 14959 (Hash Join)
                    Node 14960 (Seq Scan) - LEAF
                    Node 14961 (Hash) [PATTERN: a54055ce]
                      Node 14962 (Hash Join) [consumed]
                        Node 14963 (Seq Scan) [consumed] - LEAF
                        Node 14964 (Hash) [consumed]
                          Node 14965 (Seq Scan) [consumed] - LEAF
              Node 14966 (Index Scan) - LEAF
            Node 14967 (Hash) [consumed]
              Node 14968 (Seq Scan) - LEAF
          Node 14969 (Index Scan) - LEAF
        Node 14970 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 14961 | 14949, 14950, 14952, 14953, 14954, 14955, 14956, 14957, 14958, 14962, 14963, 14964, 14965, 14967, 14970 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 14956 | 14949, 14950, 14952, 14953, 14954, 14955, 14957, 14958, 14961, 14962, 14963, 14964, 14965, 14967, 14970 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 14952 | 14949, 14950, 14953, 14954, 14955, 14956, 14957, 14958, 14961, 14962, 14963, 14964, 14965, 14967, 14970 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 14954 | 14949, 14950, 14952, 14953, 14955, 14956, 14957, 14958, 14961, 14962, 14963, 14964, 14965, 14967, 14970 |
| Aggregate -> Gather Merge (Out | 2724c080 | 14949 | 14950, 14952, 14953, 14954, 14955, 14956, 14957, 14958, 14961, 14962, 14963, 14964, 14965, 14967, 14970 |
...
| 14951 | Sort | 1231.65 | 1096.02 | 11.0% | operator |
| 14952 | Hash Join | 1231.41 | 1199.17 | 2.6% | pattern |
| 14954 | Hash Join | 1227.21 | 1192.81 | 2.8% | pattern |
| 14969 | Index Scan | 0.01 | 0.05 | 753.5% | operator |
| 14971 | Seq Scan | 0.01 | 7.19 | 79838.6% | operator |
| 14956 | Hash Join | 215.26 | 260.30 | 20.9% | pattern |
| 14966 | Index Scan | 0.04 | 0.09 | 107.2% | operator |
| 14968 | Seq Scan | 42.12 | 44.48 | 5.6% | operator |
| 14959 | Hash Join | 35.54 | 67.79 | 90.7% | operator |
| 14960 | Seq Scan | 33.99 | 24.87 | 26.8% | operator |
| 14961 | Hash | 0.25 | 0.20 | 20.9% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 14960 (Seq Scan) - LEAF
...
### Step 2: Node 14961 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 14949, 14950, 14952, 14953, 14954, 14955, 14956, 14957, 14958, 14962, 14963, 14964, 14965, 14967, 14970
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 4: Node 14956 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 14949, 14950, 14952, 14953, 14954, 14955, 14957, 14958, 14961, 14962, 14963, 14964, 14965, 14967, 14970
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=29497
  - HashJoin_nt1=147487
...
### Step 5: Node 14966 (Index Scan) - LEAF
...
### Step 6: Node 14968 (Seq Scan) - LEAF
...
### Step 7: Node 14954 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 14949, 14950, 14952, 14953, 14955, 14956, 14957, 14958, 14961, 14962, 14963, 14964, 14965, 14967, 14970
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=794
  - HashJoin_nt1=118013
...
### Step 8: Node 14969 (Index Scan) - LEAF
...
### Step 9: Node 14971 (Seq Scan) - LEAF
...
### Step 10: Node 14952 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 14949, 14950, 14953, 14954, 14955, 14956, 14957, 14958, 14961, 14962, 14963, 14964, 14965, 14967, 14970
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=794
  - HashJoin_nt1=794
...
### Step 12: Node 14949 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 14950, 14952, 14953, 14954, 14955, 14956, 14957, 14958, 14961, 14962, 14963, 14964, 14965, 14967, 14970
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2460
