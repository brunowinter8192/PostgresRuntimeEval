...
```
Node 14949 (Aggregate) [PATTERN: 53f9aa07] - ROOT
  Node 14950 (Gather Merge) [consumed]
    Node 14951 (Sort) [consumed]
      Node 14952 (Hash Join) [consumed]
        Node 14953 (Nested Loop) [consumed]
          Node 14954 (Hash Join)
            Node 14955 (Nested Loop) [PATTERN: bd9dfa7b]
              Node 14956 (Hash Join) [consumed]
              ...
              Node 14966 (Index Scan) [consumed] - LEAF
            Node 14967 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 53f9aa07 | 14949 | 14950, 14951, 14952, 14953, 14955, 14956, 14957, 14958, 14959, 14961, 14962, 14963, 14964, 14965, 14966, 14970 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 14961 | 14949, 14950, 14951, 14952, 14953, 14955, 14956, 14957, 14958, 14959, 14962, 14963, 14964, 14965, 14966, 14970 |
| Nested Loop -> [Hash Join -> [ | bd9dfa7b | 14955 | 14949, 14950, 14951, 14952, 14953, 14956, 14957, 14958, 14959, 14961, 14962, 14963, 14964, 14965, 14966, 14970 |
...
|------|------|--------|-----------|-----|--------|
| 14949 | Aggregate | 1237.31 | 1220.50 | 1.4% | pattern |
| 14954 | Hash Join | 1227.21 | 1042.87 | 15.0% | operator |
| 14969 | Index Scan | 0.01 | 0.05 | 753.5% | operator |
| 14971 | Seq Scan | 0.01 | 7.19 | 79838.6% | operator |
| 14955 | Nested Loop | 1180.69 | 1155.06 | 2.2% | pattern |
...
- **Consumes:** Nodes 14949, 14950, 14951, 14952, 14953, 14955, 14956, 14957, 14958, 14959, 14962, 14963, 14964, 14965, 14966, 14970
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 3: Node 14968 (Seq Scan) - LEAF
...
### Step 4: Node 14955 (Nested Loop) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bd9dfa7b (Nested Loop -> [Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer), Index Scan (Inner)])
- **Consumes:** Nodes 14949, 14950, 14951, 14952, 14953, 14956, 14957, 14958, 14959, 14961, 14962, 14963, 14964, 14965, 14966, 14970
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 7: Node 14969 (Index Scan) - LEAF
...
### Step 8: Node 14971 (Seq Scan) - LEAF
...
### Step 9: Node 14949 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 53f9aa07 (Aggregate -> Gather Merge -> Sort -> Hash Join -> [Nested Loop (Outer), Hash (Inner)] (Outer) (Outer) (Outer))
- **Consumes:** Nodes 14950, 14951, 14952, 14953, 14955, 14956, 14957, 14958, 14959, 14961, 14962, 14963, 14964, 14965, 14966, 14970
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2460
