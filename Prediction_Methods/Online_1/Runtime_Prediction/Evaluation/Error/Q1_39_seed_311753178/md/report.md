...
```
Node 411 (Aggregate) [PATTERN: 3dfa6025] - ROOT
  Node 412 (Gather Merge) [consumed]
    Node 413 (Sort) [consumed]
      Node 414 (Aggregate) [consumed]
        Node 415 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 3dfa6025 | 411 | 412, 413, 414, 415 |
...
|------|------|--------|-----------|-----|--------|
| 411 | Aggregate | 992.08 | 953.98 | 3.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 411 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3dfa6025 (Aggregate -> Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 412, 413, 414, 415
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=6
  - Aggregate_Outer_nt1=1183059
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=236
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=169010.1000
  - Aggregate_Outer_total_cost=169010.2400
  - Aggregate_np=0
  - Aggregate_nt=6
  - Aggregate_nt1=30
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=170010.3900
  - Aggregate_total_cost=170015.1600
  ...
  - GatherMerge_Outer_startup_cost=170010.3900
  - GatherMerge_Outer_total_cost=170014.0200
  - SeqScan_Outer_np=112600
  - SeqScan_Outer_nt=1183059
  - SeqScan_Outer_nt1=0
  - SeqScan_Outer_nt2=0
  - SeqScan_Outer_parallel_workers=0
  - SeqScan_Outer_plan_width=25
  - SeqScan_Outer_reltuples=6001215.0000
  - SeqScan_Outer_sel=0.1971
  ...
  - Sort_Outer_startup_cost=169010.3200
  - Sort_Outer_total_cost=169010.3300
