...
```
Node 10409 (Aggregate) [PATTERN: a5f39f08] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10409 | 10410, 10411 |
...
|------|------|--------|-----------|-----|--------|
| 10409 | Aggregate | 795.85 | 830.13 | 4.3% | pattern |
...
### Step 2: Node 10409 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10410, 10411
- **Input Features:**
