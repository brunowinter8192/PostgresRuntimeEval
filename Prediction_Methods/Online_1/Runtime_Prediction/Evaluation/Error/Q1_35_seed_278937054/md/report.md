...
```
Node 391 (Aggregate) [PATTERN: 3dfa6025] - ROOT
  Node 392 (Gather Merge) [consumed]
    Node 393 (Sort) [consumed]
      Node 394 (Aggregate) [consumed]
        Node 395 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 3dfa6025 | 391 | 392, 393, 394, 395 |
...
|------|------|--------|-----------|-----|--------|
| 391 | Aggregate | 946.72 | 953.98 | 0.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 391 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3dfa6025 (Aggregate -> Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 392, 393, 394, 395
- **Input Features:**
  ...
  - Aggregate_total_cost=170295.8300
  ...
  - GatherMerge_Outer_total_cost=170294.6900
  - SeqScan_Outer_np=112600
  - SeqScan_Outer_nt=1191078
  - SeqScan_Outer_nt1=0
  - SeqScan_Outer_nt2=0
  ...
  - Sort_Outer_startup_cost=169290.9800
  - Sort_Outer_total_cost=169291.0000
