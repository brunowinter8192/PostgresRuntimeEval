        ...
        Node 8265 (Sort) [consumed]
          Node 8266 (Hash Join) [consumed]
            Node 8267 (Nested Loop) [consumed]
              ...
              Node 8278 (Index Scan) [consumed] - LEAF
            Node 8279 (Hash) [consumed]
              Node 8280 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather Me | 255215ee | 8261 | 8262, 8263, 8264, 8265, 8266, 8267, 8268, 8269, 8270, 8271, 8272, 8273, 8274, 8278, 8279, 8280 |
...
|------|------|--------|-----------|-----|--------|
| 8261 | Sort | 1058.91 | 1070.44 | 1.1% | pattern |
...
### Step 4: Node 8261 (Sort) - PATTERN ROOT
...
- **Consumes:** Nodes 8262, 8263, 8264, 8265, 8266, 8267, 8268, 8269, 8270, 8271, 8272, 8273, 8274, 8278, 8279, 8280
- **Input Features:**
