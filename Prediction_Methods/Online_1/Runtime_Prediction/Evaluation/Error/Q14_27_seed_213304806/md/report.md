...
```
Node 26903 (Aggregate) [PATTERN: f8295d8b] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 26903 | 26904, 26905, 26906, 26907, 26908, 26909 |
...
|------|------|--------|-----------|-----|--------|
| 26903 | Aggregate | 836.45 | 822.81 | 1.6% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26903 (Aggregate) - PATTERN ROOT
