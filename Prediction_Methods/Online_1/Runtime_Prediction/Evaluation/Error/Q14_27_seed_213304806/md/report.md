...
Node 26903 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26904 (Gather) [consumed]
    Node 26905 (Aggregate) [consumed]
      Node 26906 (Hash Join) [PATTERN: f4cb205a]
        Node 26907 (Seq Scan) [consumed] - LEAF
        Node 26908 (Hash) [consumed]
          Node 26909 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 26906 | 26903, 26904, 26905, 26907, 26908, 26909 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26903 | 26904, 26905, 26906, 26907, 26908, 26909 |
...
| 26906 | Hash Join | 815.47 | 397.23 | 51.3% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26906 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 26903, 26904, 26905, 26907, 26908, 26909
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14581
  - HashJoin_nt1=14581
  ...
  - HashJoin_total_cost=136644.9200
  - Hash_Inner_np=0
  - Hash_Inner_nt=83333
...
- **Output:** st=44.67, rt=397.23

### Step 2: Node 26903 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26904, 26905, 26906, 26907, 26908, 26909
- **Input Features:**
