...
```
Node 11905 (Aggregate) [PATTERN: 27c3eea9] - ROOT
  Node 11906 (Gather Merge) [consumed]
    Node 11907 (Sort) [consumed]
      Node 11908 (Hash Join) [consumed]
        Node 11909 (Nested Loop) [consumed]
          Node 11910 (Hash Join) [consumed]
          ...
          Node 11917 (Index Scan) [consumed] - LEAF
        Node 11918 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 27c3eea9 | 11905 | 11906, 11907, 11908, 11909, 11910, 11912, 11913, 11914, 11915, 11916, 11917, 11918, 11919 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 11912 | 11905, 11906, 11907, 11908, 11909, 11910, 11913, 11914, 11915, 11916, 11917, 11918, 11919 |
...
|------|------|--------|-----------|-----|--------|
| 11905 | Aggregate | 1205.05 | 1200.90 | 0.3% | pattern |
...
### Step 1: Node 11922 (Seq Scan) - LEAF
...
### Step 2: Node 11911 (Seq Scan) - LEAF
...
### Step 3: Node 11912 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 11905, 11906, 11907, 11908, 11909, 11910, 11913, 11914, 11915, 11916, 11917, 11918, 11919
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 11920 (Seq Scan) - LEAF
...
### Step 6: Node 11905 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 11906, 11907, 11908, 11909, 11910, 11912, 11913, 11914, 11915, 11916, 11917, 11918, 11919
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
