      ...
      Node 11908 (Hash Join)
        Node 11909 (Nested Loop)
          Node 11910 (Hash Join)
            ...
            Node 11912 (Hash) [PATTERN: a54055ce]
              Node 11913 (Hash Join) [consumed]
                Node 11914 (Seq Scan) [consumed] - LEAF
                Node 11915 (Hash) [consumed]
                  Node 11916 (Seq Scan) [consumed] - LEAF
          Node 11917 (Index Scan) - LEAF
        Node 11918 (Hash) [PATTERN: a54055ce]
          Node 11919 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 11912 | 11905, 11906, 11913, 11914, 11915, 11916, 11918, 11919, 11920, 11921, 11922 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 11918 | 11905, 11906, 11912, 11913, 11914, 11915, 11916, 11919, 11920, 11921, 11922 |
| Aggregate -> Gather Merge (Out | 2724c080 | 11905 | 11906, 11912, 11913, 11914, 11915, 11916, 11918, 11919, 11920, 11921, 11922 |
...
| 11908 | Hash Join | 1197.96 | 1130.43 | 5.6% | operator |
| 11909 | Nested Loop | 1187.21 | 1145.81 | 3.5% | operator |
| 11918 | Hash | 6.92 | 3.42 | 50.6% | pattern |
| 11910 | Hash Join | 210.88 | 319.90 | 51.7% | operator |
| 11917 | Index Scan | 0.03 | 0.09 | 163.5% | operator |
| 11911 | Seq Scan | 151.63 | 192.19 | 26.7% | operator |
| 11912 | Hash | 32.07 | 35.59 | 11.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11911 (Seq Scan) - LEAF
...
### Step 2: Node 11912 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 11905, 11906, 11913, 11914, 11915, 11916, 11918, 11919, 11920, 11921, 11922
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 11917 (Index Scan) - LEAF
...
### Step 6: Node 11918 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 11905, 11906, 11912, 11913, 11914, 11915, 11916, 11919, 11920, 11921, 11922
- **Input Features:**
  - HashJoin_Outer_np=0
...
- **Consumes:** Nodes 11906, 11912, 11913, 11914, 11915, 11916, 11918, 11919, 11920, 11921, 11922
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
