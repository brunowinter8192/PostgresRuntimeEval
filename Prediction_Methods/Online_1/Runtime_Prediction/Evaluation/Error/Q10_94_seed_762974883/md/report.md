    ...
    Node 21231 (Aggregate) [consumed]
      Node 21232 (Gather) [consumed]
        Node 21233 (Hash Join) [consumed]
          Node 21234 (Hash Join) [PATTERN: 2873b8c3]
            Node 21235 (Nested Loop) [consumed]
              Node 21236 (Seq Scan) [consumed] - LEAF
              Node 21237 (Index Scan) [consumed] - LEAF
            Node 21238 (Hash) [consumed]
              Node 21239 (Seq Scan) [consumed] - LEAF
          Node 21240 (Hash)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 21229 | 21230, 21231, 21232, 21233, 21234, 21235, 21236, 21237, 21238, 21239 |
| Hash Join -> [Nested Loop -> [ | 2873b8c3 | 21234 | 21229, 21230, 21231, 21232, 21233, 21235, 21236, 21237, 21238, 21239 |
...
### Step 2: Node 21234 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2873b8c3 (Hash Join -> [Nested Loop -> [Seq Scan (Outer), Index Scan (Inner)] (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 21229, 21230, 21231, 21232, 21233, 21235, 21236, 21237, 21238, 21239
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18130
  - HashJoin_nt1=18130
...
### Step 4: Node 21229 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 21230, 21231, 21232, 21233, 21234, 21235, 21236, 21237, 21238, 21239
- **Input Features:**
