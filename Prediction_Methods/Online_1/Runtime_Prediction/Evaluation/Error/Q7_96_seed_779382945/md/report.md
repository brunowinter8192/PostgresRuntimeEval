...
```
Node 13111 (Aggregate) - ROOT
  Node 13112 (Gather Merge)
    Node 13113 (Sort)
      Node 13114 (Hash Join)
        Node 13115 (Nested Loop)
          Node 13116 (Hash Join)
            Node 13117 (Seq Scan) - LEAF
            Node 13118 (Hash)
              Node 13119 (Hash Join)
                Node 13120 (Seq Scan) - LEAF
                Node 13121 (Hash)
                  Node 13122 (Seq Scan) - LEAF
          Node 13123 (Index Scan) - LEAF
        Node 13124 (Hash)
          Node 13125 (Hash Join)
            Node 13126 (Seq Scan) - LEAF
            Node 13127 (Hash)
              Node 13128 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 13111 | Aggregate | 1206.73 | 1202.22 | 0.4% | operator |
| 13112 | Gather Merge | 1205.53 | 1148.45 | 4.7% | operator |
| 13113 | Sort | 1199.81 | 1149.87 | 4.2% | operator |
| 13114 | Hash Join | 1199.18 | 1130.50 | 5.7% | operator |
| 13115 | Nested Loop | 1190.49 | 1145.81 | 3.8% | operator |
| 13124 | Hash | 4.89 | 15.44 | 215.7% | operator |
| 13116 | Hash Join | 213.75 | 319.53 | 49.5% | operator |
| 13123 | Index Scan | 0.03 | 0.09 | 171.7% | operator |
| 13125 | Hash Join | 4.85 | 49.64 | 924.1% | operator |
| 13117 | Seq Scan | 152.74 | 192.19 | 25.8% | operator |
| 13118 | Hash | 35.41 | 17.27 | 51.2% | operator |
| 13126 | Seq Scan | 4.53 | 10.62 | 134.4% | operator |
| 13127 | Hash | 0.01 | 14.54 | 103736.9% | operator |
| 13119 | Hash Join | 34.78 | 54.15 | 55.7% | operator |
| 13128 | Seq Scan | 0.01 | 7.20 | 71859.5% | operator |
| 13120 | Seq Scan | 33.69 | 24.87 | 26.2% | operator |
| 13121 | Hash | 0.01 | 14.54 | 145271.6% | operator |
| 13122 | Seq Scan | 0.01 | 7.20 | 102699.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 13122 (Seq Scan) - LEAF
...
### Step 2: Node 13120 (Seq Scan) - LEAF
...
### Step 5: Node 13128 (Seq Scan) - LEAF
...
### Step 6: Node 13117 (Seq Scan) - LEAF
...
### Step 8: Node 13126 (Seq Scan) - LEAF
...
### Step 11: Node 13123 (Index Scan) - LEAF
...
### Step 13: Node 13115 (Nested Loop)
...
### Step 17: Node 13112 (Gather Merge)
...
### Step 18: Node 13111 (Aggregate) - ROOT
