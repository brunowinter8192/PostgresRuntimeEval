...
```
Node 13111 (Aggregate) [PATTERN: 27c3eea9] - ROOT
  Node 13112 (Gather Merge) [consumed]
    Node 13113 (Sort) [consumed]
      Node 13114 (Hash Join) [consumed]
        Node 13115 (Nested Loop) [consumed]
          Node 13116 (Hash Join) [consumed]
          ...
          Node 13123 (Index Scan) [consumed] - LEAF
        Node 13124 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 27c3eea9 | 13111 | 13112, 13113, 13114, 13115, 13116, 13118, 13119, 13120, 13121, 13122, 13123, 13124, 13125 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 13118 | 13111, 13112, 13113, 13114, 13115, 13116, 13119, 13120, 13121, 13122, 13123, 13124, 13125 |
...
|------|------|--------|-----------|-----|--------|
| 13111 | Aggregate | 1206.73 | 1200.90 | 0.5% | pattern |
...
### Step 1: Node 13128 (Seq Scan) - LEAF
...
### Step 2: Node 13117 (Seq Scan) - LEAF
...
### Step 3: Node 13118 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 13111, 13112, 13113, 13114, 13115, 13116, 13119, 13120, 13121, 13122, 13123, 13124, 13125
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 13126 (Seq Scan) - LEAF
...
### Step 6: Node 13111 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 13112, 13113, 13114, 13115, 13116, 13118, 13119, 13120, 13121, 13122, 13123, 13124, 13125
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
