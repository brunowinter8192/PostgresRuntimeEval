...
```
Node 10825 (Aggregate) - ROOT
  Node 10826 (Gather Merge)
    Node 10827 (Sort)
      Node 10828 (Hash Join)
        Node 10829 (Nested Loop)
          Node 10830 (Hash Join)
            Node 10831 (Seq Scan) - LEAF
            Node 10832 (Hash)
              Node 10833 (Hash Join)
                Node 10834 (Seq Scan) - LEAF
                Node 10835 (Hash)
                  Node 10836 (Seq Scan) - LEAF
          Node 10837 (Index Scan) - LEAF
        Node 10838 (Hash)
          Node 10839 (Hash Join)
            Node 10840 (Seq Scan) - LEAF
            Node 10841 (Hash)
              Node 10842 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 10825 | Aggregate | 1194.23 | 1202.22 | 0.7% | operator |
| 10826 | Gather Merge | 1193.11 | 1148.45 | 3.7% | operator |
| 10827 | Sort | 1185.73 | 1149.87 | 3.0% | operator |
| 10828 | Hash Join | 1185.14 | 1130.50 | 4.6% | operator |
| 10829 | Nested Loop | 1178.54 | 1145.81 | 2.8% | operator |
| 10838 | Hash | 2.92 | 15.44 | 429.0% | operator |
| 10830 | Hash Join | 205.65 | 319.53 | 55.4% | operator |
| 10837 | Index Scan | 0.03 | 0.09 | 171.7% | operator |
| 10839 | Hash Join | 2.88 | 49.64 | 1625.3% | operator |
| 10831 | Seq Scan | 148.02 | 192.19 | 29.8% | operator |
| 10832 | Hash | 31.86 | 17.27 | 45.8% | operator |
| 10840 | Seq Scan | 2.56 | 10.62 | 315.4% | operator |
| 10841 | Hash | 0.01 | 14.54 | 96814.4% | operator |
| 10833 | Hash Join | 31.51 | 54.15 | 71.8% | operator |
| 10842 | Seq Scan | 0.01 | 7.20 | 59866.2% | operator |
| 10834 | Seq Scan | 30.36 | 24.87 | 18.1% | operator |
| 10835 | Hash | 0.01 | 14.54 | 145271.6% | operator |
| 10836 | Seq Scan | 0.01 | 7.20 | 102699.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10836 (Seq Scan) - LEAF
...
### Step 2: Node 10834 (Seq Scan) - LEAF
...
### Step 5: Node 10842 (Seq Scan) - LEAF
...
### Step 6: Node 10831 (Seq Scan) - LEAF
...
### Step 8: Node 10840 (Seq Scan) - LEAF
...
### Step 11: Node 10837 (Index Scan) - LEAF
...
### Step 13: Node 10829 (Nested Loop)
...
### Step 17: Node 10826 (Gather Merge)
...
### Step 18: Node 10825 (Aggregate) - ROOT
