      ...
      Node 10828 (Hash Join)
        Node 10829 (Nested Loop)
          Node 10830 (Hash Join)
            ...
            Node 10832 (Hash) [PATTERN: a54055ce]
              Node 10833 (Hash Join) [consumed]
                Node 10834 (Seq Scan) [consumed] - LEAF
                Node 10835 (Hash) [consumed]
                  Node 10836 (Seq Scan) [consumed] - LEAF
          Node 10837 (Index Scan) - LEAF
        Node 10838 (Hash) [PATTERN: a54055ce]
          Node 10839 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 10832 | 10825, 10826, 10833, 10834, 10835, 10836, 10838, 10839, 10840, 10841, 10842 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 10838 | 10825, 10826, 10832, 10833, 10834, 10835, 10836, 10839, 10840, 10841, 10842 |
| Aggregate -> Gather Merge (Out | 2724c080 | 10825 | 10826, 10832, 10833, 10834, 10835, 10836, 10838, 10839, 10840, 10841, 10842 |
...
| 10828 | Hash Join | 1185.14 | 1130.43 | 4.6% | operator |
| 10829 | Nested Loop | 1178.54 | 1145.81 | 2.8% | operator |
| 10838 | Hash | 2.92 | 3.42 | 17.2% | pattern |
| 10830 | Hash Join | 205.65 | 319.90 | 55.6% | operator |
| 10837 | Index Scan | 0.03 | 0.09 | 171.7% | operator |
| 10831 | Seq Scan | 148.02 | 192.19 | 29.8% | operator |
| 10832 | Hash | 31.86 | 35.59 | 11.7% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10831 (Seq Scan) - LEAF
...
### Step 2: Node 10832 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 10825, 10826, 10833, 10834, 10835, 10836, 10838, 10839, 10840, 10841, 10842
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 10837 (Index Scan) - LEAF
...
### Step 6: Node 10838 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 10825, 10826, 10832, 10833, 10834, 10835, 10836, 10839, 10840, 10841, 10842
- **Input Features:**
  - HashJoin_Outer_np=0
...
- **Consumes:** Nodes 10826, 10832, 10833, 10834, 10835, 10836, 10838, 10839, 10840, 10841, 10842
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
