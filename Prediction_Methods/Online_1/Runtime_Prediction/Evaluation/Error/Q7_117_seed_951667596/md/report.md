...
```
Node 10825 (Aggregate) [PATTERN: 27c3eea9] - ROOT
  Node 10826 (Gather Merge) [consumed]
    Node 10827 (Sort) [consumed]
      Node 10828 (Hash Join) [consumed]
        Node 10829 (Nested Loop) [consumed]
          Node 10830 (Hash Join) [consumed]
          ...
          Node 10837 (Index Scan) [consumed] - LEAF
        Node 10838 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 27c3eea9 | 10825 | 10826, 10827, 10828, 10829, 10830, 10832, 10833, 10834, 10835, 10836, 10837, 10838, 10839 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 10832 | 10825, 10826, 10827, 10828, 10829, 10830, 10833, 10834, 10835, 10836, 10837, 10838, 10839 |
...
|------|------|--------|-----------|-----|--------|
| 10825 | Aggregate | 1194.23 | 1200.90 | 0.6% | pattern |
...
### Step 1: Node 10842 (Seq Scan) - LEAF
...
### Step 2: Node 10831 (Seq Scan) - LEAF
...
### Step 3: Node 10832 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 10825, 10826, 10827, 10828, 10829, 10830, 10833, 10834, 10835, 10836, 10837, 10838, 10839
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 10840 (Seq Scan) - LEAF
...
### Step 6: Node 10825 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 10826, 10827, 10828, 10829, 10830, 10832, 10833, 10834, 10835, 10836, 10837, 10838, 10839
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
