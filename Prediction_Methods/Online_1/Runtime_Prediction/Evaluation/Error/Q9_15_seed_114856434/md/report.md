...
```
Node 17665 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 17666 (Aggregate) [consumed]
    Node 17667 (Gather)
      Node 17668 (Aggregate)
        Node 17669 (Nested Loop)
          Node 17670 (Hash Join) [PATTERN: 895c6e8c]
            Node 17671 (Seq Scan) [consumed] - LEAF
            Node 17672 (Hash) [consumed]
              Node 17673 (Hash Join) [PATTERN: 7a51ce50]
                Node 17674 (Hash Join) [consumed]
                  Node 17675 (Nested Loop) [consumed]
                    Node 17676 (Seq Scan) [consumed] - LEAF
                    Node 17677 (Index Scan) [consumed] - LEAF
                  Node 17678 (Hash) [consumed]
                    Node 17679 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Hash Join -> [Hash Join -> [Ne | 7a51ce50 | 17673 | 17665, 17666, 17670, 17671, 17672, 17674, 17675, 17676, 17677, 17678, 17679, 17680, 17681 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 17670 | 17665, 17666, 17671, 17672, 17673, 17674, 17675, 17676, 17677, 17678, 17679, 17680, 17681 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17665 | 17666, 17670, 17671, 17672, 17673, 17674, 17675, 17676, 17677, 17678, 17679, 17680, 17681 |
...
|------|------|--------|-----------|-----|--------|
| 17665 | Sort | 1186.48 | 1116.84 | 5.9% | pattern |
| 17667 | Gather | 1185.30 | 1135.48 | 4.2% | operator |
| 17668 | Aggregate | 1163.36 | 1135.57 | 2.4% | operator |
| 17669 | Nested Loop | 1138.62 | 1182.91 | 3.9% | operator |
| 17670 | Hash Join | 966.95 | 734.19 | 24.1% | pattern |
| 17682 | Index Scan | 0.00 | -0.04 | 1512.7% | operator |
| 17673 | Hash Join | 175.44 | 546.39 | 211.4% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 17673 (Hash Join) - PATTERN ROOT
...
- **Consumes:** Nodes 17665, 17666, 17670, 17671, 17672, 17674, 17675, 17676, 17677, 17678, 17679, 17680, 17681
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 2: Node 17670 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 17665, 17666, 17671, 17672, 17673, 17674, 17675, 17676, 17677, 17678, 17679, 17680, 17681
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=69752
...
### Step 3: Node 17682 (Index Scan) - LEAF
...
### Step 7: Node 17665 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17666, 17670, 17671, 17672, 17673, 17674, 17675, 17676, 17677, 17678, 17679, 17680, 17681
- **Input Features:**
