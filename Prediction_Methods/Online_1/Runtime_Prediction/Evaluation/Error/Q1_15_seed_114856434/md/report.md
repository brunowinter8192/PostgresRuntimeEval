...
```
Node 281 (Aggregate) [PATTERN: 3dfa6025] - ROOT
  Node 282 (Gather Merge) [consumed]
    Node 283 (Sort) [consumed]
      Node 284 (Aggregate) [consumed]
        Node 285 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 3dfa6025 | 281 | 282, 283, 284, 285 |
...
|------|------|--------|-----------|-----|--------|
| 281 | Aggregate | 991.02 | 953.98 | 3.7% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 281 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3dfa6025 (Aggregate -> Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 282, 283, 284, 285
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=6
  - Aggregate_Outer_nt1=1187477
  ...
  - Aggregate_Outer_total_cost=169164.8700
  - Aggregate_np=0
  - Aggregate_nt=6
  - Aggregate_nt1=30
  - Aggregate_nt2=0
  ...
  - Aggregate_total_cost=170169.7900
  ...
  - Sort_Outer_startup_cost=169164.9500
  - Sort_Outer_total_cost=169164.9600
