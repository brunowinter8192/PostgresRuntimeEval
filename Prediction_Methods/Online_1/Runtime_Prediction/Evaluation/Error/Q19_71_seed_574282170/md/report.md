...
```
Node 32046 (Aggregate) [PATTERN: f8295d8b] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 32046 | 32047, 32048, 32049, 32050, 32051, 32052 |
...
|------|------|--------|-----------|-----|--------|
| 32046 | Aggregate | 840.69 | 841.17 | 0.1% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 32046 (Aggregate) - PATTERN ROOT
