...
Node 17647 (Sort) - ROOT
  Node 17648 (Aggregate) [PATTERN: a5f39f08]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 17648 | 17649, 17650 |
...
|------|------|--------|-----------|-----|--------|
| 17647 | Sort | 1160.90 | 1150.49 | 0.9% | operator |
| 17648 | Aggregate | 1160.76 | 1114.40 | 4.0% | pattern |
| 17651 | Nested Loop | 1116.94 | 1176.96 | 5.4% | operator |
| 17652 | Hash Join | 949.90 | 831.23 | 12.5% | operator |
| 17664 | Index Scan | 0.00 | -0.04 | 1512.7% | operator |
| 17653 | Seq Scan | 677.53 | 565.06 | 16.6% | operator |
| 17654 | Hash | 177.32 | 51.71 | 70.8% | operator |
| 17655 | Hash Join | 175.51 | 910.38 | 418.7% | operator |
| 17656 | Hash Join | 161.77 | 850.40 | 425.7% | operator |
| 17662 | Hash | 13.12 | 14.54 | 10.8% | operator |
| 17657 | Nested Loop | 155.93 | 1066.06 | 583.7% | operator |
| 17660 | Hash | 3.85 | 14.79 | 283.6% | operator |
...
### Step 10: Node 17653 (Seq Scan) - LEAF
...
### Step 13: Node 17664 (Index Scan) - LEAF
...
### Step 14: Node 17651 (Nested Loop)
...
### Step 15: Node 17648 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 17649, 17650
- **Input Features:**
