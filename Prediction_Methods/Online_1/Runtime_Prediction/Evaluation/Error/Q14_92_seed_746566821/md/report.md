...
```
Node 27407 (Aggregate) [PATTERN: f8295d8b] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 27407 | 27408, 27409, 27410, 27411, 27412, 27413 |
...
|------|------|--------|-----------|-----|--------|
| 27407 | Aggregate | 836.85 | 822.65 | 1.7% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27407 (Aggregate) - PATTERN ROOT
