...
```
Node 24712 (Aggregate) [PATTERN: f9c97829] - ROOT
  Node 24713 (Gather Merge) [consumed]
    Node 24714 (Aggregate) [consumed]
      Node 24715 (Sort) [consumed]
        Node 24716 (Nested Loop) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> A | f9c97829 | 24712 | 24713, 24714, 24715, 24716, 24717, 24718 |
...
|------|------|--------|-----------|-----|--------|
| 24712 | Aggregate | 1018.95 | 998.49 | 2.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24712 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 24713, 24714, 24715, 24716, 24717, 24718
- **Input Features:**
