    ...
    Node 19710 (Aggregate) [consumed]
      Node 19711 (Gather) [consumed]
        Node 19712 (Hash Join) [consumed]
          Node 19713 (Hash Join) [PATTERN: 2873b8c3]
            Node 19714 (Nested Loop) [consumed]
              Node 19715 (Seq Scan) [consumed] - LEAF
              Node 19716 (Index Scan) [consumed] - LEAF
            Node 19717 (Hash) [consumed]
              Node 19718 (Seq Scan) [consumed] - LEAF
          Node 19719 (Hash)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 19708 | 19709, 19710, 19711, 19712, 19713, 19714, 19715, 19716, 19717, 19718 |
| Hash Join -> [Nested Loop -> [ | 2873b8c3 | 19713 | 19708, 19709, 19710, 19711, 19712, 19714, 19715, 19716, 19717, 19718 |
...
### Step 2: Node 19713 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2873b8c3 (Hash Join -> [Nested Loop -> [Seq Scan (Outer), Index Scan (Inner)] (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 19708, 19709, 19710, 19711, 19712, 19714, 19715, 19716, 19717, 19718
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18130
  - HashJoin_nt1=18130
...
### Step 4: Node 19708 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19709, 19710, 19711, 19712, 19713, 19714, 19715, 19716, 19717, 19718
- **Input Features:**
