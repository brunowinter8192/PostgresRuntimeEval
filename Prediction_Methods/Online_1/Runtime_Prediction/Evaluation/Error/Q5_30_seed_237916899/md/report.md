        ...
        Node 8365 (Sort) [consumed]
          Node 8366 (Hash Join) [consumed]
            Node 8367 (Nested Loop) [consumed]
              ...
              Node 8378 (Index Scan) [consumed] - LEAF
            Node 8379 (Hash) [consumed]
              Node 8380 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather Me | 255215ee | 8361 | 8362, 8363, 8364, 8365, 8366, 8367, 8368, 8369, 8370, 8371, 8372, 8373, 8374, 8378, 8379, 8380 |
...
|------|------|--------|-----------|-----|--------|
| 8361 | Sort | 1093.97 | 1070.44 | 2.2% | pattern |
...
### Step 4: Node 8361 (Sort) - PATTERN ROOT
...
- **Consumes:** Nodes 8362, 8363, 8364, 8365, 8366, 8367, 8368, 8369, 8370, 8371, 8372, 8373, 8374, 8378, 8379, 8380
- **Input Features:**
