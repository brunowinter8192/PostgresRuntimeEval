              ...
              Node 8368 (Hash Join) [PATTERN: 895c6e8c]
                ...
                Node 8370 (Hash) [consumed]
                  Node 8371 (Hash Join)
                    ...
                    Node 8373 (Hash) [PATTERN: a54055ce]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 8373 | 8361, 8362, 8366, 8367, 8368, 8369, 8370, 8374, 8375, 8376, 8377, 8379 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 8368 | 8361, 8362, 8366, 8367, 8369, 8370, 8373, 8374, 8375, 8376, 8377, 8379 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 8366 | 8361, 8362, 8367, 8368, 8369, 8370, 8373, 8374, 8375, 8376, 8377, 8379 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 8361 | 8362, 8366, 8367, 8368, 8369, 8370, 8373, 8374, 8375, 8376, 8377, 8379 |
...
| 8371 | Hash Join | 31.44 | 62.70 | 99.4% | operator |
| 8372 | Seq Scan | 30.03 | 24.87 | 17.2% | operator |
| 8373 | Hash | 0.08 | 0.14 | 76.9% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 8372 (Seq Scan) - LEAF
...
### Step 2: Node 8373 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 8361, 8362, 8366, 8367, 8368, 8369, 8370, 8374, 8375, 8376, 8377, 8379
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 4: Node 8368 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 8361, 8362, 8366, 8367, 8369, 8370, 8373, 8374, 8375, 8376, 8377, 8379
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14646
  - HashJoin_nt1=73231
...
### Step 5: Node 8378 (Index Scan) - LEAF
...
### Step 6: Node 8380 (Seq Scan) - LEAF
...
### Step 7: Node 8366 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 8361, 8362, 8367, 8368, 8369, 8370, 8373, 8374, 8375, 8376, 8377, 8379
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=2344
  - HashJoin_nt1=58597
...
### Step 10: Node 8363 (Gather Merge)
...
### Step 11: Node 8361 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 8362, 8366, 8367, 8368, 8369, 8370, 8373, 8374, 8375, 8376, 8377, 8379
- **Input Features:**
