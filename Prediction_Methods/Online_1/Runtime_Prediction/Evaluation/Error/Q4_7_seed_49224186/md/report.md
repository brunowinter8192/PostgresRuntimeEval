...
```
Node 6740 (Aggregate) [PATTERN: 80bd802d] - ROOT
  Node 6741 (Gather Merge) [consumed]
    Node 6742 (Sort) [consumed]
      Node 6743 (Aggregate) [consumed]
        Node 6744 (Nested Loop) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 80bd802d | 6740 | 6741, 6742, 6743, 6744, 6745, 6746 |
...
|------|------|--------|-----------|-----|--------|
| 6740 | Aggregate | 1043.65 | 1057.79 | 1.4% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6740 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 6741, 6742, 6743, 6744, 6745, 6746
- **Input Features:**
  ...
  - NestedLoop_Outer_nt=15120
  - NestedLoop_Outer_nt1=18542
  ...
  - NestedLoop_Outer_total_cost=66044.8400
  - SeqScan_Outer_np=26136
  - SeqScan_Outer_nt=18542
  - SeqScan_Outer_nt1=0
  - SeqScan_Outer_nt2=0
  ...
  - Sort_Outer_startup_cost=66120.5400
  - Sort_Outer_total_cost=66120.5600
