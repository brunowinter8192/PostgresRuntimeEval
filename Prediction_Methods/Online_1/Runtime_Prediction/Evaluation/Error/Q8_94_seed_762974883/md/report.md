...
Node 16490 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 16491 (Gather Merge) [consumed]
    Node 16492 (Sort)
      Node 16493 (Hash Join) [PATTERN: 2e0f44ef]
        Node 16494 (Nested Loop) [consumed]
          Node 16495 (Hash Join) [PATTERN: 2e0f44ef]
            Node 16496 (Nested Loop) [consumed]
              Node 16497 (Hash Join) [PATTERN: 895c6e8c]
                Node 16498 (Seq Scan) [consumed] - LEAF
                Node 16499 (Hash) [consumed]
                  Node 16500 (Hash Join)
                    Node 16501 (Seq Scan) - LEAF
                    Node 16502 (Hash) [PATTERN: a54055ce]
                      Node 16503 (Hash Join) [consumed]
                        Node 16504 (Seq Scan) [consumed] - LEAF
                        Node 16505 (Hash) [consumed]
                          Node 16506 (Seq Scan) [consumed] - LEAF
              Node 16507 (Index Scan) - LEAF
            Node 16508 (Hash) [consumed]
              Node 16509 (Seq Scan) - LEAF
          Node 16510 (Index Scan) - LEAF
        Node 16511 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 16502 | 16490, 16491, 16493, 16494, 16495, 16496, 16497, 16498, 16499, 16503, 16504, 16505, 16506, 16508, 16511 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 16497 | 16490, 16491, 16493, 16494, 16495, 16496, 16498, 16499, 16502, 16503, 16504, 16505, 16506, 16508, 16511 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 16493 | 16490, 16491, 16494, 16495, 16496, 16497, 16498, 16499, 16502, 16503, 16504, 16505, 16506, 16508, 16511 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 16495 | 16490, 16491, 16493, 16494, 16496, 16497, 16498, 16499, 16502, 16503, 16504, 16505, 16506, 16508, 16511 |
| Aggregate -> Gather Merge (Out | 2724c080 | 16490 | 16491, 16493, 16494, 16495, 16496, 16497, 16498, 16499, 16502, 16503, 16504, 16505, 16506, 16508, 16511 |
...
| 16492 | Sort | 1227.88 | 1096.01 | 10.7% | operator |
| 16493 | Hash Join | 1227.64 | 1199.17 | 2.3% | pattern |
| 16495 | Hash Join | 1223.53 | 1192.84 | 2.5% | pattern |
| 16510 | Index Scan | 0.01 | 0.05 | 753.5% | operator |
| 16512 | Seq Scan | 0.01 | 7.19 | 55242.1% | operator |
| 16497 | Hash Join | 214.61 | 260.30 | 21.3% | pattern |
| 16507 | Index Scan | 0.04 | 0.09 | 112.3% | operator |
| 16509 | Seq Scan | 40.74 | 44.49 | 9.2% | operator |
| 16500 | Hash Join | 34.04 | 67.79 | 99.2% | operator |
| 16501 | Seq Scan | 32.63 | 24.87 | 23.8% | operator |
| 16502 | Hash | 0.09 | 0.20 | 129.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 16501 (Seq Scan) - LEAF
...
### Step 2: Node 16502 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 16490, 16491, 16493, 16494, 16495, 16496, 16497, 16498, 16499, 16503, 16504, 16505, 16506, 16508, 16511
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 4: Node 16497 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 16490, 16491, 16493, 16494, 16495, 16496, 16498, 16499, 16502, 16503, 16504, 16505, 16506, 16508, 16511
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=29497
  - HashJoin_nt1=147487
...
### Step 5: Node 16507 (Index Scan) - LEAF
...
### Step 6: Node 16509 (Seq Scan) - LEAF
...
### Step 7: Node 16495 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 16490, 16491, 16493, 16494, 16496, 16497, 16498, 16499, 16502, 16503, 16504, 16505, 16506, 16508, 16511
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=756
  - HashJoin_nt1=118013
  ...
  - HashJoin_reltuples=0.0000
  - HashJoin_sel=0.0000
  - HashJoin_startup_cost=9919.8600
  - HashJoin_total_cost=70271.3400
  - Hash_Inner_np=0
  - Hash_Inner_nt=534
  - Hash_Inner_nt1=534
  - Hash_Inner_nt2=0
...
### Step 8: Node 16510 (Index Scan) - LEAF
...
### Step 9: Node 16512 (Seq Scan) - LEAF
...
### Step 10: Node 16493 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 16490, 16491, 16494, 16495, 16496, 16497, 16498, 16499, 16502, 16503, 16504, 16505, 16506, 16508, 16511
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=756
  - HashJoin_nt1=756
  ...
  - HashJoin_reltuples=0.0000
  - HashJoin_sel=0.0400
  - HashJoin_startup_cost=9921.7100
  - HashJoin_total_cost=70505.8400
  - Hash_Inner_np=0
  - Hash_Inner_nt=25
  - Hash_Inner_nt1=25
  - Hash_Inner_nt2=0
  ...
  - NestedLoop_Outer_np=0
  - NestedLoop_Outer_nt=756
  - NestedLoop_Outer_nt1=756
  - NestedLoop_Outer_nt2=1
  - NestedLoop_Outer_parallel_workers=0
  - NestedLoop_Outer_plan_width=20
  - NestedLoop_Outer_reltuples=0.0000
  - NestedLoop_Outer_sel=1.0000
  - NestedLoop_Outer_startup_cost=9920.1500
  - NestedLoop_Outer_total_cost=70500.0700
- **Output:** st=80.32, rt=1199.17

### Step 11: Node 16492 (Sort)
...
### Step 12: Node 16490 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 16491, 16493, 16494, 16495, 16496, 16497, 16498, 16499, 16502, 16503, 16504, 16505, 16506, 16508, 16511
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2343
  - Aggregate_nt1=2343
