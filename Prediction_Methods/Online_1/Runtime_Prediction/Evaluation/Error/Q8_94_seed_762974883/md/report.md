...
```
Node 16490 (Aggregate) [PATTERN: 53f9aa07] - ROOT
  Node 16491 (Gather Merge) [consumed]
    Node 16492 (Sort) [consumed]
      Node 16493 (Hash Join) [consumed]
        Node 16494 (Nested Loop) [consumed]
          Node 16495 (Hash Join)
            Node 16496 (Nested Loop) [PATTERN: bd9dfa7b]
              Node 16497 (Hash Join) [consumed]
              ...
              Node 16507 (Index Scan) [consumed] - LEAF
            Node 16508 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 53f9aa07 | 16490 | 16491, 16492, 16493, 16494, 16496, 16497, 16498, 16499, 16500, 16502, 16503, 16504, 16505, 16506, 16507, 16511 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 16502 | 16490, 16491, 16492, 16493, 16494, 16496, 16497, 16498, 16499, 16500, 16503, 16504, 16505, 16506, 16507, 16511 |
| Nested Loop -> [Hash Join -> [ | bd9dfa7b | 16496 | 16490, 16491, 16492, 16493, 16494, 16497, 16498, 16499, 16500, 16502, 16503, 16504, 16505, 16506, 16507, 16511 |
...
|------|------|--------|-----------|-----|--------|
| 16490 | Aggregate | 1233.58 | 1220.56 | 1.1% | pattern |
| 16495 | Hash Join | 1223.53 | 1042.86 | 14.8% | operator |
| 16510 | Index Scan | 0.01 | 0.05 | 753.5% | operator |
| 16512 | Seq Scan | 0.01 | 7.19 | 55242.1% | operator |
| 16496 | Nested Loop | 1178.38 | 1155.06 | 2.0% | pattern |
...
- **Consumes:** Nodes 16490, 16491, 16492, 16493, 16494, 16496, 16497, 16498, 16499, 16500, 16503, 16504, 16505, 16506, 16507, 16511
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 3: Node 16509 (Seq Scan) - LEAF
...
### Step 4: Node 16496 (Nested Loop) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bd9dfa7b (Nested Loop -> [Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer), Index Scan (Inner)])
- **Consumes:** Nodes 16490, 16491, 16492, 16493, 16494, 16497, 16498, 16499, 16500, 16502, 16503, 16504, 16505, 16506, 16507, 16511
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 7: Node 16510 (Index Scan) - LEAF
...
### Step 8: Node 16512 (Seq Scan) - LEAF
...
### Step 9: Node 16490 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 53f9aa07 (Aggregate -> Gather Merge -> Sort -> Hash Join -> [Nested Loop (Outer), Hash (Inner)] (Outer) (Outer) (Outer))
- **Consumes:** Nodes 16491, 16492, 16493, 16494, 16496, 16497, 16498, 16499, 16500, 16502, 16503, 16504, 16505, 16506, 16507, 16511
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2343
  - Aggregate_nt1=2343
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=756
  - HashJoin_Outer_nt1=756
  - HashJoin_Outer_nt2=25
  - HashJoin_Outer_parallel_workers=0
  - HashJoin_Outer_plan_width=148
  - HashJoin_Outer_reltuples=0.0000
  - HashJoin_Outer_sel=0.0400
  - HashJoin_Outer_startup_cost=9921.7100
  - HashJoin_Outer_total_cost=70505.8400
  - Hash_Inner_np=0
  - Hash_Inner_nt=25
  - Hash_Inner_nt1=25
  - Hash_Inner_nt2=0
  ...
  - Sort_Outer_startup_cost=70541.9800
  - Sort_Outer_total_cost=70543.8700
