...
```
Node 27435 (Aggregate) [PATTERN: f8295d8b] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 27435 | 27436, 27437, 27438, 27439, 27440, 27441 |
...
|------|------|--------|-----------|-----|--------|
| 27435 | Aggregate | 844.73 | 822.70 | 2.6% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27435 (Aggregate) - PATTERN ROOT
