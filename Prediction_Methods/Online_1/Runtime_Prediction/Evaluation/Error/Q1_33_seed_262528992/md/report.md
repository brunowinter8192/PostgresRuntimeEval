...
```
Node 381 (Aggregate) [PATTERN: 3dfa6025] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 3dfa6025 | 381 | 382, 383, 384, 385 |
...
|------|------|--------|-----------|-----|--------|
| 381 | Aggregate | 953.73 | 953.98 | 0.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 381 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3dfa6025 (Aggregate -> Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 382, 383, 384, 385
- **Input Features:**
  ...
  - Aggregate_total_cost=169606.1500
  ...
  - GatherMerge_Outer_total_cost=169605.0100
