...
```
Node 31976 (Aggregate) [PATTERN: f8295d8b] - ROOT
  Node 31977 (Gather) [consumed]
    Node 31978 (Aggregate) [consumed]
      Node 31979 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 31976 | 31977, 31978, 31979, 31980, 31981, 31982 |
...
|------|------|--------|-----------|-----|--------|
| 31976 | Aggregate | 844.40 | 841.17 | 0.4% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31976 (Aggregate) - PATTERN ROOT
