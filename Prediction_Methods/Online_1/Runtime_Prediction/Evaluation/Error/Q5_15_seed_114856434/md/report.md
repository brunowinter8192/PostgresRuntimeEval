        ...
        Node 8025 (Sort) [consumed]
          Node 8026 (Hash Join) [consumed]
            Node 8027 (Nested Loop) [consumed]
              ...
              Node 8038 (Index Scan) [consumed] - LEAF
            Node 8039 (Hash) [consumed]
              Node 8040 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather Me | 255215ee | 8021 | 8022, 8023, 8024, 8025, 8026, 8027, 8028, 8029, 8030, 8031, 8032, 8033, 8034, 8038, 8039, 8040 |
...
|------|------|--------|-----------|-----|--------|
| 8021 | Sort | 1088.03 | 1070.44 | 1.6% | pattern |
...
### Step 4: Node 8021 (Sort) - PATTERN ROOT
...
- **Consumes:** Nodes 8022, 8023, 8024, 8025, 8026, 8027, 8028, 8029, 8030, 8031, 8032, 8033, 8034, 8038, 8039, 8040
- **Input Features:**
