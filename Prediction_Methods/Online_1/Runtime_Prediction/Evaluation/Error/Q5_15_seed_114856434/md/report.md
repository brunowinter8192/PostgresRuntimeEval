              ...
              Node 8028 (Hash Join) [PATTERN: 895c6e8c]
                ...
                Node 8030 (Hash) [consumed]
                  Node 8031 (Hash Join)
                    ...
                    Node 8033 (Hash) [PATTERN: a54055ce]
                      Node 8034 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 8033 | 8021, 8022, 8026, 8027, 8028, 8029, 8030, 8034, 8035, 8036, 8037, 8039 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 8028 | 8021, 8022, 8026, 8027, 8029, 8030, 8033, 8034, 8035, 8036, 8037, 8039 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 8026 | 8021, 8022, 8027, 8028, 8029, 8030, 8033, 8034, 8035, 8036, 8037, 8039 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 8021 | 8022, 8026, 8027, 8028, 8029, 8030, 8033, 8034, 8035, 8036, 8037, 8039 |
...
| 8031 | Hash Join | 37.60 | 62.70 | 66.7% | operator |
| 8032 | Seq Scan | 35.82 | 24.87 | 30.6% | operator |
| 8033 | Hash | 0.37 | 0.14 | 62.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 8032 (Seq Scan) - LEAF
...
### Step 2: Node 8033 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 8021, 8022, 8026, 8027, 8028, 8029, 8030, 8034, 8035, 8036, 8037, 8039
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 4: Node 8028 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 8021, 8022, 8026, 8027, 8029, 8030, 8033, 8034, 8035, 8036, 8037, 8039
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14756
  - HashJoin_nt1=73782
...
### Step 5: Node 8038 (Index Scan) - LEAF
...
### Step 6: Node 8040 (Seq Scan) - LEAF
...
### Step 7: Node 8026 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 8021, 8022, 8027, 8028, 8029, 8030, 8033, 8034, 8035, 8036, 8037, 8039
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=2362
  - HashJoin_nt1=59037
...
### Step 10: Node 8023 (Gather Merge)
...
### Step 11: Node 8021 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 8022, 8026, 8027, 8028, 8029, 8030, 8033, 8034, 8035, 8036, 8037, 8039
- **Input Features:**
