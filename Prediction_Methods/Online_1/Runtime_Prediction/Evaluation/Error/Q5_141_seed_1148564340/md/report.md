              ...
              Node 7808 (Hash Join) [PATTERN: 895c6e8c]
                ...
                Node 7810 (Hash) [consumed]
                  Node 7811 (Hash Join)
                    ...
                    Node 7813 (Hash) [PATTERN: a54055ce]
                      Node 7814 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 7813 | 7801, 7802, 7806, 7807, 7808, 7809, 7810, 7814, 7815, 7816, 7817, 7819 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 7808 | 7801, 7802, 7806, 7807, 7809, 7810, 7813, 7814, 7815, 7816, 7817, 7819 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 7806 | 7801, 7802, 7807, 7808, 7809, 7810, 7813, 7814, 7815, 7816, 7817, 7819 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 7801 | 7802, 7806, 7807, 7808, 7809, 7810, 7813, 7814, 7815, 7816, 7817, 7819 |
...
| 7811 | Hash Join | 34.42 | 62.70 | 82.1% | operator |
| 7812 | Seq Scan | 32.97 | 24.87 | 24.5% | operator |
| 7813 | Hash | 0.07 | 0.14 | 97.4% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 7812 (Seq Scan) - LEAF
...
### Step 2: Node 7813 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 7801, 7802, 7806, 7807, 7808, 7809, 7810, 7814, 7815, 7816, 7817, 7819
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
- **Consumes:** Nodes 7801, 7802, 7806, 7807, 7809, 7810, 7813, 7814, 7815, 7816, 7817, 7819
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14612
  - HashJoin_nt1=73059
...
### Step 5: Node 7818 (Index Scan) - LEAF
...
### Step 6: Node 7820 (Seq Scan) - LEAF
...
- **Consumes:** Nodes 7801, 7802, 7807, 7808, 7809, 7810, 7813, 7814, 7815, 7816, 7817, 7819
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=2338
  - HashJoin_nt1=58459
...
### Step 11: Node 7801 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 7802, 7806, 7807, 7808, 7809, 7810, 7813, 7814, 7815, 7816, 7817, 7819
- **Input Features:**
