...
```
Node 11743 (Aggregate) [PATTERN: 27c3eea9] - ROOT
  Node 11744 (Gather Merge) [consumed]
    Node 11745 (Sort) [consumed]
      Node 11746 (Hash Join) [consumed]
        Node 11747 (Nested Loop) [consumed]
          Node 11748 (Hash Join) [consumed]
          ...
          Node 11755 (Index Scan) [consumed] - LEAF
        Node 11756 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 27c3eea9 | 11743 | 11744, 11745, 11746, 11747, 11748, 11750, 11751, 11752, 11753, 11754, 11755, 11756, 11757 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 11750 | 11743, 11744, 11745, 11746, 11747, 11748, 11751, 11752, 11753, 11754, 11755, 11756, 11757 |
...
|------|------|--------|-----------|-----|--------|
| 11743 | Aggregate | 1174.88 | 1200.90 | 2.2% | pattern |
...
### Step 1: Node 11760 (Seq Scan) - LEAF
...
### Step 2: Node 11749 (Seq Scan) - LEAF
...
### Step 3: Node 11750 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 11743, 11744, 11745, 11746, 11747, 11748, 11751, 11752, 11753, 11754, 11755, 11756, 11757
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 11758 (Seq Scan) - LEAF
...
### Step 6: Node 11743 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 11744, 11745, 11746, 11747, 11748, 11750, 11751, 11752, 11753, 11754, 11755, 11756, 11757
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
