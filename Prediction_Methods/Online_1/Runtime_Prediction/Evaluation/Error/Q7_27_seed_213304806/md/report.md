      ...
      Node 11746 (Hash Join)
        Node 11747 (Nested Loop)
          Node 11748 (Hash Join)
            ...
            Node 11750 (Hash) [PATTERN: a54055ce]
              Node 11751 (Hash Join) [consumed]
                Node 11752 (Seq Scan) [consumed] - LEAF
                Node 11753 (Hash) [consumed]
                  Node 11754 (Seq Scan) [consumed] - LEAF
          Node 11755 (Index Scan) - LEAF
        Node 11756 (Hash) [PATTERN: a54055ce]
          Node 11757 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 11750 | 11743, 11744, 11751, 11752, 11753, 11754, 11756, 11757, 11758, 11759, 11760 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 11756 | 11743, 11744, 11750, 11751, 11752, 11753, 11754, 11757, 11758, 11759, 11760 |
| Aggregate -> Gather Merge (Out | 2724c080 | 11743 | 11744, 11750, 11751, 11752, 11753, 11754, 11756, 11757, 11758, 11759, 11760 |
...
| 11746 | Hash Join | 1167.38 | 1130.43 | 3.2% | operator |
| 11747 | Nested Loop | 1161.00 | 1145.81 | 1.3% | operator |
| 11756 | Hash | 2.53 | 3.42 | 35.0% | pattern |
| 11748 | Hash Join | 211.57 | 319.90 | 51.2% | operator |
| 11755 | Index Scan | 0.03 | 0.09 | 180.5% | operator |
| 11749 | Seq Scan | 150.22 | 192.19 | 27.9% | operator |
| 11750 | Hash | 35.53 | 35.59 | 0.2% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11749 (Seq Scan) - LEAF
...
### Step 2: Node 11750 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 11743, 11744, 11751, 11752, 11753, 11754, 11756, 11757, 11758, 11759, 11760
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 11755 (Index Scan) - LEAF
...
### Step 6: Node 11756 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 11743, 11744, 11750, 11751, 11752, 11753, 11754, 11757, 11758, 11759, 11760
- **Input Features:**
  - HashJoin_Outer_np=0
...
- **Consumes:** Nodes 11744, 11750, 11751, 11752, 11753, 11754, 11756, 11757, 11758, 11759, 11760
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
