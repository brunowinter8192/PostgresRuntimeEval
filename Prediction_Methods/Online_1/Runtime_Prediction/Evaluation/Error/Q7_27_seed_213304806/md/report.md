...
```
Node 11743 (Aggregate) - ROOT
  Node 11744 (Gather Merge)
    Node 11745 (Sort)
      Node 11746 (Hash Join)
        Node 11747 (Nested Loop)
          Node 11748 (Hash Join)
            Node 11749 (Seq Scan) - LEAF
            Node 11750 (Hash)
              Node 11751 (Hash Join)
                Node 11752 (Seq Scan) - LEAF
                Node 11753 (Hash)
                  Node 11754 (Seq Scan) - LEAF
          Node 11755 (Index Scan) - LEAF
        Node 11756 (Hash)
          Node 11757 (Hash Join)
            Node 11758 (Seq Scan) - LEAF
            Node 11759 (Hash)
              Node 11760 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 11743 | Aggregate | 1174.88 | 1202.22 | 2.3% | operator |
| 11744 | Gather Merge | 1173.73 | 1148.45 | 2.2% | operator |
| 11745 | Sort | 1168.03 | 1149.87 | 1.6% | operator |
| 11746 | Hash Join | 1167.38 | 1130.50 | 3.2% | operator |
| 11747 | Nested Loop | 1161.00 | 1145.81 | 1.3% | operator |
| 11756 | Hash | 2.53 | 15.44 | 509.4% | operator |
| 11748 | Hash Join | 211.57 | 319.53 | 51.0% | operator |
| 11755 | Index Scan | 0.03 | 0.09 | 180.5% | operator |
| 11757 | Hash Join | 2.49 | 49.64 | 1895.1% | operator |
| 11749 | Seq Scan | 150.22 | 192.19 | 27.9% | operator |
| 11750 | Hash | 35.53 | 17.27 | 51.4% | operator |
| 11758 | Seq Scan | 2.16 | 10.62 | 391.1% | operator |
| 11759 | Hash | 0.02 | 14.54 | 90757.3% | operator |
| 11751 | Hash Join | 35.07 | 54.15 | 54.4% | operator |
| 11760 | Seq Scan | 0.01 | 7.20 | 59866.2% | operator |
| 11752 | Seq Scan | 33.96 | 24.87 | 26.8% | operator |
| 11753 | Hash | 0.01 | 14.54 | 161424.0% | operator |
| 11754 | Seq Scan | 0.01 | 7.20 | 119832.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11754 (Seq Scan) - LEAF
...
### Step 2: Node 11752 (Seq Scan) - LEAF
...
### Step 5: Node 11760 (Seq Scan) - LEAF
...
### Step 6: Node 11749 (Seq Scan) - LEAF
...
### Step 8: Node 11758 (Seq Scan) - LEAF
...
### Step 11: Node 11755 (Index Scan) - LEAF
...
### Step 13: Node 11747 (Nested Loop)
...
### Step 17: Node 11744 (Gather Merge)
...
### Step 18: Node 11743 (Aggregate) - ROOT
