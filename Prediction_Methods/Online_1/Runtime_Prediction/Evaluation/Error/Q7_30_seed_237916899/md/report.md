...
```
Node 11815 (Aggregate) [PATTERN: 27c3eea9] - ROOT
  Node 11816 (Gather Merge) [consumed]
    Node 11817 (Sort) [consumed]
      Node 11818 (Hash Join) [consumed]
        Node 11819 (Nested Loop) [consumed]
          Node 11820 (Hash Join) [consumed]
          ...
          Node 11827 (Index Scan) [consumed] - LEAF
        Node 11828 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 27c3eea9 | 11815 | 11816, 11817, 11818, 11819, 11820, 11822, 11823, 11824, 11825, 11826, 11827, 11828, 11829 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 11822 | 11815, 11816, 11817, 11818, 11819, 11820, 11823, 11824, 11825, 11826, 11827, 11828, 11829 |
...
|------|------|--------|-----------|-----|--------|
| 11815 | Aggregate | 1213.30 | 1200.90 | 1.0% | pattern |
...
### Step 1: Node 11832 (Seq Scan) - LEAF
...
### Step 2: Node 11821 (Seq Scan) - LEAF
...
### Step 3: Node 11822 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 11815, 11816, 11817, 11818, 11819, 11820, 11823, 11824, 11825, 11826, 11827, 11828, 11829
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 11830 (Seq Scan) - LEAF
...
### Step 6: Node 11815 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 11816, 11817, 11818, 11819, 11820, 11822, 11823, 11824, 11825, 11826, 11827, 11828, 11829
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
