      ...
      Node 11818 (Hash Join)
        Node 11819 (Nested Loop)
          Node 11820 (Hash Join)
            ...
            Node 11822 (Hash) [PATTERN: a54055ce]
              Node 11823 (Hash Join) [consumed]
                Node 11824 (Seq Scan) [consumed] - LEAF
                Node 11825 (Hash) [consumed]
                  Node 11826 (Seq Scan) [consumed] - LEAF
          Node 11827 (Index Scan) - LEAF
        Node 11828 (Hash) [PATTERN: a54055ce]
          Node 11829 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 11822 | 11815, 11816, 11823, 11824, 11825, 11826, 11828, 11829, 11830, 11831, 11832 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 11828 | 11815, 11816, 11822, 11823, 11824, 11825, 11826, 11829, 11830, 11831, 11832 |
| Aggregate -> Gather Merge (Out | 2724c080 | 11815 | 11816, 11822, 11823, 11824, 11825, 11826, 11828, 11829, 11830, 11831, 11832 |
...
| 11818 | Hash Join | 1205.66 | 1130.43 | 6.2% | operator |
| 11819 | Nested Loop | 1199.02 | 1145.81 | 4.4% | operator |
| 11828 | Hash | 2.80 | 3.42 | 22.0% | pattern |
| 11820 | Hash Join | 214.63 | 319.90 | 49.0% | operator |
| 11827 | Index Scan | 0.03 | 0.09 | 171.7% | operator |
| 11821 | Seq Scan | 150.70 | 192.19 | 27.5% | operator |
| 11822 | Hash | 37.01 | 35.59 | 3.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11821 (Seq Scan) - LEAF
...
### Step 2: Node 11822 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 11815, 11816, 11823, 11824, 11825, 11826, 11828, 11829, 11830, 11831, 11832
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 11827 (Index Scan) - LEAF
...
### Step 6: Node 11828 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 11815, 11816, 11822, 11823, 11824, 11825, 11826, 11829, 11830, 11831, 11832
- **Input Features:**
  - HashJoin_Outer_np=0
...
- **Consumes:** Nodes 11816, 11822, 11823, 11824, 11825, 11826, 11828, 11829, 11830, 11831, 11832
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
