...
```
Node 11815 (Aggregate) - ROOT
  Node 11816 (Gather Merge)
    Node 11817 (Sort)
      Node 11818 (Hash Join)
        Node 11819 (Nested Loop)
          Node 11820 (Hash Join)
            Node 11821 (Seq Scan) - LEAF
            Node 11822 (Hash)
              Node 11823 (Hash Join)
                Node 11824 (Seq Scan) - LEAF
                Node 11825 (Hash)
                  Node 11826 (Seq Scan) - LEAF
          Node 11827 (Index Scan) - LEAF
        Node 11828 (Hash)
          Node 11829 (Hash Join)
            Node 11830 (Seq Scan) - LEAF
            Node 11831 (Hash)
              Node 11832 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 11815 | Aggregate | 1213.30 | 1202.22 | 0.9% | operator |
| 11816 | Gather Merge | 1212.06 | 1148.45 | 5.2% | operator |
| 11817 | Sort | 1206.32 | 1149.87 | 4.7% | operator |
| 11818 | Hash Join | 1205.66 | 1130.50 | 6.2% | operator |
| 11819 | Nested Loop | 1199.02 | 1145.81 | 4.4% | operator |
| 11828 | Hash | 2.80 | 15.44 | 450.5% | operator |
| 11820 | Hash Join | 214.63 | 319.53 | 48.9% | operator |
| 11827 | Index Scan | 0.03 | 0.09 | 171.7% | operator |
| 11829 | Hash Join | 2.76 | 49.64 | 1696.5% | operator |
| 11821 | Seq Scan | 150.70 | 192.19 | 27.5% | operator |
| 11822 | Hash | 37.01 | 17.27 | 53.4% | operator |
| 11830 | Seq Scan | 2.45 | 10.62 | 334.0% | operator |
| 11831 | Hash | 0.01 | 14.54 | 111724.3% | operator |
| 11823 | Hash Join | 36.60 | 54.15 | 47.9% | operator |
| 11832 | Seq Scan | 0.01 | 7.20 | 71859.5% | operator |
| 11824 | Seq Scan | 35.47 | 24.87 | 29.9% | operator |
| 11825 | Hash | 0.01 | 14.54 | 145271.6% | operator |
| 11826 | Seq Scan | 0.01 | 7.20 | 102699.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11826 (Seq Scan) - LEAF
...
### Step 2: Node 11824 (Seq Scan) - LEAF
...
### Step 5: Node 11832 (Seq Scan) - LEAF
...
### Step 6: Node 11821 (Seq Scan) - LEAF
...
### Step 8: Node 11830 (Seq Scan) - LEAF
...
### Step 11: Node 11827 (Index Scan) - LEAF
...
### Step 13: Node 11819 (Nested Loop)
...
### Step 17: Node 11816 (Gather Merge)
...
### Step 18: Node 11815 (Aggregate) - ROOT
