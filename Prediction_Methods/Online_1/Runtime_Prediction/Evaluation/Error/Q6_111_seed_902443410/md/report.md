...
```
Node 9949 (Aggregate) [PATTERN: dd3706ac] - ROOT
  Node 9950 (Gather) [consumed]
    Node 9951 (Aggregate) [consumed]
      Node 9952 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | dd3706ac | 9949 | 9950, 9951, 9952 |
...
|------|------|--------|-----------|-----|--------|
| 9949 | Aggregate | 761.22 | 791.27 | 3.9% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 9949 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** dd3706ac (Aggregate -> Gather -> Aggregate -> Seq Scan (Outer) (Outer) (Outer))
- **Consumes:** Nodes 9950, 9951, 9952
- **Input Features:**
