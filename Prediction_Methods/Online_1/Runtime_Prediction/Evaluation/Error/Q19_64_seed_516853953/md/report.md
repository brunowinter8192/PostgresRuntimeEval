...
```
Node 31990 (Aggregate) [PATTERN: f8295d8b] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 31990 | 31991, 31992, 31993, 31994, 31995, 31996 |
...
|------|------|--------|-----------|-----|--------|
| 31990 | Aggregate | 840.70 | 841.17 | 0.1% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31990 (Aggregate) - PATTERN ROOT
