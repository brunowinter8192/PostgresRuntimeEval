...
```
Node 636 (Aggregate) [PATTERN: 3dfa6025] - ROOT
  Node 637 (Gather Merge) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 3dfa6025 | 636 | 637, 638, 639, 640 |
...
|------|------|--------|-----------|-----|--------|
| 636 | Aggregate | 937.80 | 953.98 | 1.7% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 636 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3dfa6025 (Aggregate -> Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 637, 638, 639, 640
- **Input Features:**
