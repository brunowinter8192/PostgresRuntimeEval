    ...
    Node 20087 (Aggregate) [consumed]
      Node 20088 (Gather) [consumed]
        Node 20089 (Hash Join) [consumed]
          Node 20090 (Hash Join) [PATTERN: 2873b8c3]
            Node 20091 (Nested Loop) [consumed]
              Node 20092 (Seq Scan) [consumed] - LEAF
              Node 20093 (Index Scan) [consumed] - LEAF
            Node 20094 (Hash) [consumed]
              Node 20095 (Seq Scan) [consumed] - LEAF
          Node 20096 (Hash)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 20085 | 20086, 20087, 20088, 20089, 20090, 20091, 20092, 20093, 20094, 20095 |
| Hash Join -> [Nested Loop -> [ | 2873b8c3 | 20090 | 20085, 20086, 20087, 20088, 20089, 20091, 20092, 20093, 20094, 20095 |
...
### Step 2: Node 20090 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2873b8c3 (Hash Join -> [Nested Loop -> [Seq Scan (Outer), Index Scan (Inner)] (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 20085, 20086, 20087, 20088, 20089, 20091, 20092, 20093, 20094, 20095
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=17964
  - HashJoin_nt1=17964
...
### Step 4: Node 20085 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20086, 20087, 20088, 20089, 20090, 20091, 20092, 20093, 20094, 20095
- **Input Features:**
