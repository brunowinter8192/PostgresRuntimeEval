...
```
Node 26483 (Aggregate) [PATTERN: f8295d8b] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 26483 | 26484, 26485, 26486, 26487, 26488, 26489 |
...
|------|------|--------|-----------|-----|--------|
| 26483 | Aggregate | 810.16 | 822.64 | 1.5% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26483 (Aggregate) - PATTERN ROOT
