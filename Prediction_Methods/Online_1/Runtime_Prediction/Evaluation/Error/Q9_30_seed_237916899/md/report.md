...
```
Node 17973 (Sort) [PATTERN: 57d290cd] - ROOT
          ...
          Node 17979 (Hash) [consumed]
            Node 17980 (Hash Join) [consumed]
              ...
              Node 17982 (Hash) [consumed]
                Node 17983 (Hash Join) [PATTERN: 7a51ce50]
                  Node 17984 (Hash Join) [consumed]
                    Node 17985 (Nested Loop) [consumed]
                      Node 17986 (Seq Scan) [consumed] - LEAF
                      Node 17987 (Index Scan) [consumed] - LEAF
                    Node 17988 (Hash) [consumed]
                      Node 17989 (Seq Scan) [consumed] - LEAF
                  Node 17990 (Hash) [consumed]
                    Node 17991 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather -> | 57d290cd | 17973 | 17974, 17975, 17976, 17977, 17978, 17979, 17980, 17981, 17982, 17983, 17984, 17985, 17986, 17987, 17988, 17989, 17990, 17991 |
| Hash Join -> [Hash Join -> [Ne | 7a51ce50 | 17983 | 17973, 17974, 17975, 17976, 17977, 17978, 17979, 17980, 17981, 17982, 17984, 17985, 17986, 17987, 17988, 17989, 17990, 17991 |
...
| 17983 | Hash Join | 202.70 | 548.04 | 170.4% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 17983 (Hash Join) - PATTERN ROOT
...
- **Consumes:** Nodes 17973, 17974, 17975, 17976, 17977, 17978, 17979, 17980, 17981, 17982, 17984, 17985, 17986, 17987, 17988, 17989, 17990, 17991
- **Input Features:**
  - HashJoin_Outer_np=0
  ...
  - HashJoin_total_cost=15845.4100
  - Hash_Inner_np=0
  - Hash_Inner_nt=10000
  ...
  - IndexScan_Inner_total_cost=1.7400
...
- **Output:** st=18.71, rt=548.04

### Step 2: Node 17973 (Sort) - PATTERN ROOT
...
- **Consumes:** Nodes 17974, 17975, 17976, 17977, 17978, 17979, 17980, 17981, 17982, 17983, 17984, 17985, 17986, 17987, 17988, 17989, 17990, 17991
- **Input Features:**
