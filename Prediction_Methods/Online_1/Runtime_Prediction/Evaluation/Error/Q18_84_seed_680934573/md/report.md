...
```
Node 30932 (Limit) [PATTERN: 0aa5463f] - ROOT
    ...
    Node 30934 (Aggregate) [consumed]
      Node 30935 (Gather Merge) [consumed]
        Node 30936 (Incremental Sort) [consumed]
          Node 30937 (Nested Loop) [consumed]
            Node 30938 (Merge Join) [consumed]
              Node 30939 (Sort)
            ...
            Node 30947 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 0aa5463f | 30932 | 30933, 30934, 30935, 30936, 30937, 30938, 30940, 30941, 30942, 30947 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30940 | 30932, 30933, 30934, 30935, 30936, 30937, 30938, 30941, 30942, 30947 |
...
- **Consumes:** Nodes 30932, 30933, 30934, 30935, 30936, 30937, 30938, 30941, 30942, 30947
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 7: Node 30932 (Limit) - PATTERN ROOT
...
- **Consumes:** Nodes 30933, 30934, 30935, 30936, 30937, 30938, 30940, 30941, 30942, 30947
- **Input Features:**
