...
```
Node 26868 (Aggregate) [PATTERN: f8295d8b] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 26868 | 26869, 26870, 26871, 26872, 26873, 26874 |
...
|------|------|--------|-----------|-----|--------|
| 26868 | Aggregate | 826.67 | 822.85 | 0.5% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26868 (Aggregate) - PATTERN ROOT
