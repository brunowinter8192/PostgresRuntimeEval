...
```
Node 6397 (Aggregate) [PATTERN: 80bd802d] - ROOT
  Node 6398 (Gather Merge) [consumed]
    Node 6399 (Sort) [consumed]
      Node 6400 (Aggregate) [consumed]
        Node 6401 (Nested Loop) [consumed]
          Node 6402 (Seq Scan) [consumed] - LEAF
          Node 6403 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 80bd802d | 6397 | 6398, 6399, 6400, 6401, 6402, 6403 |
...
|------|------|--------|-----------|-----|--------|
| 6397 | Aggregate | 1060.88 | 1057.79 | 0.3% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6397 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 6398, 6399, 6400, 6401, 6402, 6403
- **Input Features:**
  ...
  - NestedLoop_Outer_total_cost=65947.0500
  - SeqScan_Outer_np=26136
  - SeqScan_Outer_nt=18419
  - SeqScan_Outer_nt1=0
  - SeqScan_Outer_nt2=0
