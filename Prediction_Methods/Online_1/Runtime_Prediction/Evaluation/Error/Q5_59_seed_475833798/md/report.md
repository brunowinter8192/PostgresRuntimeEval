        ...
        Node 8985 (Sort) [consumed]
          Node 8986 (Hash Join) [consumed]
            Node 8987 (Nested Loop) [consumed]
              ...
              Node 8998 (Index Scan) [consumed] - LEAF
            Node 8999 (Hash) [consumed]
              Node 9000 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather Me | 255215ee | 8981 | 8982, 8983, 8984, 8985, 8986, 8987, 8988, 8989, 8990, 8991, 8992, 8993, 8994, 8998, 8999, 9000 |
...
|------|------|--------|-----------|-----|--------|
| 8981 | Sort | 1058.80 | 1070.44 | 1.1% | pattern |
...
### Step 4: Node 8981 (Sort) - PATTERN ROOT
...
- **Consumes:** Nodes 8982, 8983, 8984, 8985, 8986, 8987, 8988, 8989, 8990, 8991, 8992, 8993, 8994, 8998, 8999, 9000
- **Input Features:**
