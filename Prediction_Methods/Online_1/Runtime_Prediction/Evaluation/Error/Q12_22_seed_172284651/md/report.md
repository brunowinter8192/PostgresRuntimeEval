...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> A | f9c97829 | 24768 | 24769, 24770, 24771, 24772, 24773, 24774 |
...
|------|------|--------|-----------|-----|--------|
| 24768 | Aggregate | 1005.60 | 998.49 | 0.7% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24768 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 24769, 24770, 24771, 24772, 24773, 24774
- **Input Features:**
  ...
  - NestedLoop_Outer_nt=5717
  - NestedLoop_Outer_nt1=5717
  ...
  - NestedLoop_Outer_total_cost=147120.7800
  ...
  - Sort_Outer_startup_cost=147477.5500
  - Sort_Outer_total_cost=147491.8400
