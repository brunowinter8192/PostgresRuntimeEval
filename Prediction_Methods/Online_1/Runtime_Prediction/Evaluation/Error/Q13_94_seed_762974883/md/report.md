...
```
Node 26371 (Sort) [PATTERN: 35ffb644] - ROOT
  Node 26372 (Aggregate) [consumed]
    Node 26373 (Aggregate) [consumed]
      Node 26374 (Hash Join)
        Node 26375 (Seq Scan) - LEAF
        Node 26376 (Hash)
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Aggregate | 35ffb644 | 26371 | 26372, 26373 |
...
|------|------|--------|-----------|-----|--------|
| 26371 | Sort | 938.47 | 915.33 | 2.5% | pattern |
| 26374 | Hash Join | 720.21 | 705.63 | 2.0% | operator |
| 26375 | Seq Scan | 505.17 | 411.72 | 18.5% | operator |
| 26376 | Hash | 15.55 | 37.64 | 142.1% | operator |
| 26377 | Index Only Scan | 10.34 | 10.09 | 2.5% | operator |
...
### Step 2: Node 26375 (Seq Scan) - LEAF
...
- **Output:** st=0.24, rt=411.72

### Step 3: Node 26376 (Hash)
...
- **Output:** st=17.84, rt=705.63

### Step 5: Node 26371 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 35ffb644 (Sort -> Aggregate -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26372, 26373
- **Input Features:**
