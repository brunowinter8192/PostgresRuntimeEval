    ...
    Node 19027 (Gather) [consumed]
      Node 19028 (Aggregate) [consumed]
        Node 19029 (Nested Loop) [consumed]
          ...
          Node 19042 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather -> | 76ab422a | 19025 | 19026, 19027, 19028, 19029, 19030, 19031, 19032, 19033, 19034, 19035, 19038, 19040, 19041, 19042 |
...
|------|------|--------|-----------|-----|--------|
| 19025 | Sort | 1154.17 | 1194.95 | 3.5% | pattern |
...
### Step 4: Node 19025 (Sort) - PATTERN ROOT
...
- **Consumes:** Nodes 19026, 19027, 19028, 19029, 19030, 19031, 19032, 19033, 19034, 19035, 19038, 19040, 19041, 19042
- **Input Features:**
