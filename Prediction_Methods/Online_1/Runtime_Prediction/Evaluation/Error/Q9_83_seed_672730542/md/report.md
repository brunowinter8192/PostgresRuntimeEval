        ...
        Node 19029 (Nested Loop)
          Node 19030 (Hash Join) [PATTERN: 895c6e8c]
            ...
            Node 19032 (Hash) [consumed]
              Node 19033 (Hash Join) [PATTERN: 7a51ce50]
                Node 19034 (Hash Join) [consumed]
                  Node 19035 (Nested Loop) [consumed]
                    Node 19036 (Seq Scan) [consumed] - LEAF
                    Node 19037 (Index Scan) [consumed] - LEAF
                  Node 19038 (Hash) [consumed]
                    Node 19039 (Seq Scan) [consumed] - LEAF
                Node 19040 (Hash) [consumed]
                  Node 19041 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Hash Join -> [Hash Join -> [Ne | 7a51ce50 | 19033 | 19025, 19026, 19030, 19031, 19032, 19034, 19035, 19036, 19037, 19038, 19039, 19040, 19041 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 19030 | 19025, 19026, 19031, 19032, 19033, 19034, 19035, 19036, 19037, 19038, 19039, 19040, 19041 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 19025 | 19026, 19030, 19031, 19032, 19033, 19034, 19035, 19036, 19037, 19038, 19039, 19040, 19041 |
...
| 19033 | Hash Join | 181.21 | 546.21 | 201.4% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 19033 (Hash Join) - PATTERN ROOT
...
- **Consumes:** Nodes 19025, 19026, 19030, 19031, 19032, 19034, 19035, 19036, 19037, 19038, 19039, 19040, 19041
- **Input Features:**
  - HashJoin_Outer_np=0
  ...
  - HashJoin_Outer_total_cost=14889.1800
  - HashJoin_np=0
  - HashJoin_nt=18703
  - HashJoin_nt1=18703
  - HashJoin_nt2=25
  ...
  - HashJoin_total_cost=14948.1600
  - Hash_Inner_np=0
  - Hash_Inner_nt=10000
  ...
  - IndexScan_Inner_total_cost=1.9300
...
- **Output:** st=18.55, rt=546.21

### Step 2: Node 19030 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 19025, 19026, 19031, 19032, 19033, 19034, 19035, 19036, 19037, 19038, 19039, 19040, 19041
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=67346
...
### Step 3: Node 19042 (Index Scan) - LEAF
...
### Step 7: Node 19025 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 19026, 19030, 19031, 19032, 19033, 19034, 19035, 19036, 19037, 19038, 19039, 19040, 19041
- **Input Features:**
