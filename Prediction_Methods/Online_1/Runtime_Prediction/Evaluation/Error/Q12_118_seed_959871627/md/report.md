...
```
Node 24453 (Aggregate) [PATTERN: f9c97829] - ROOT
  Node 24454 (Gather Merge) [consumed]
    Node 24455 (Aggregate) [consumed]
      Node 24456 (Sort) [consumed]
        Node 24457 (Nested Loop) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> A | f9c97829 | 24453 | 24454, 24455, 24456, 24457, 24458, 24459 |
...
|------|------|--------|-----------|-----|--------|
| 24453 | Aggregate | 995.35 | 998.49 | 0.3% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24453 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 24454, 24455, 24456, 24457, 24458, 24459
- **Input Features:**
  ...
  - NestedLoop_Outer_nt=5780
  - NestedLoop_Outer_nt1=5780
  ...
  - NestedLoop_Outer_total_cost=147177.5500
  ...
  - Sort_Outer_startup_cost=147538.7100
  - Sort_Outer_total_cost=147553.1600
