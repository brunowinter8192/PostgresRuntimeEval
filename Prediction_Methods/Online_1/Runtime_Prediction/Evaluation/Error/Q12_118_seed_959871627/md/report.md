...
Node 24453 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 24454 (Gather Merge) [consumed]
    Node 24455 (Aggregate)
      Node 24456 (Sort)
        Node 24457 (Nested Loop)
          Node 24458 (Seq Scan) - LEAF
          Node 24459 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge (Out | 2724c080 | 24453 | 24454 |
...
| 24455 | Aggregate | 976.08 | 941.96 | 3.5% | operator |
| 24456 | Sort | 975.44 | 1058.10 | 8.5% | operator |
| 24457 | Nested Loop | 974.40 | 1101.31 | 13.0% | operator |
| 24458 | Seq Scan | 841.62 | 750.46 | 10.8% | operator |
| 24459 | Index Scan | 0.03 | -0.02 | 165.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24458 (Seq Scan) - LEAF
...
### Step 2: Node 24459 (Index Scan) - LEAF
...
### Step 6: Node 24453 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 24454
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=7
  - Aggregate_nt1=35
