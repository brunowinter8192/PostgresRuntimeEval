...
```
Node 16868 (Sort) [PATTERN: 57d290cd] - ROOT
          ...
          Node 16874 (Hash) [consumed]
            Node 16875 (Hash Join) [consumed]
              ...
              Node 16877 (Hash) [consumed]
                Node 16878 (Hash Join) [PATTERN: 7a51ce50]
                  Node 16879 (Hash Join) [consumed]
                    Node 16880 (Nested Loop) [consumed]
                      Node 16881 (Seq Scan) [consumed] - LEAF
                      Node 16882 (Index Scan) [consumed] - LEAF
                    Node 16883 (Hash) [consumed]
                      Node 16884 (Seq Scan) [consumed] - LEAF
                  Node 16885 (Hash) [consumed]
                    Node 16886 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather -> | 57d290cd | 16868 | 16869, 16870, 16871, 16872, 16873, 16874, 16875, 16876, 16877, 16878, 16879, 16880, 16881, 16882, 16883, 16884, 16885, 16886 |
| Hash Join -> [Hash Join -> [Ne | 7a51ce50 | 16878 | 16868, 16869, 16870, 16871, 16872, 16873, 16874, 16875, 16876, 16877, 16879, 16880, 16881, 16882, 16883, 16884, 16885, 16886 |
...
| 16878 | Hash Join | 215.08 | 548.04 | 154.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 16878 (Hash Join) - PATTERN ROOT
...
- **Consumes:** Nodes 16868, 16869, 16870, 16871, 16872, 16873, 16874, 16875, 16876, 16877, 16879, 16880, 16881, 16882, 16883, 16884, 16885, 16886
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 2: Node 16868 (Sort) - PATTERN ROOT
...
- **Consumes:** Nodes 16869, 16870, 16871, 16872, 16873, 16874, 16875, 16876, 16877, 16878, 16879, 16880, 16881, 16882, 16883, 16884, 16885, 16886
- **Input Features:**
