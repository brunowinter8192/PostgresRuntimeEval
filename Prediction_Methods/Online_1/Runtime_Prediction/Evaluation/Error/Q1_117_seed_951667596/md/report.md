...
```
Node 91 (Aggregate) [PATTERN: 3dfa6025] - ROOT
  Node 92 (Gather Merge) [consumed]
    Node 93 (Sort) [consumed]
      Node 94 (Aggregate) [consumed]
        Node 95 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 3dfa6025 | 91 | 92, 93, 94, 95 |
...
|------|------|--------|-----------|-----|--------|
| 91 | Aggregate | 944.72 | 953.98 | 1.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 91 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3dfa6025 (Aggregate -> Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 92, 93, 94, 95
- **Input Features:**
