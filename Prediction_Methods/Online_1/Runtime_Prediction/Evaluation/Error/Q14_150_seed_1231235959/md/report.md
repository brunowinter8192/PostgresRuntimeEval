...
**Test Query:** Q14_150_seed_1231235959
...
```
Node 26805 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26806 (Gather) [consumed]
    Node 26807 (Aggregate) [consumed]
      Node 26808 (Hash Join) [PATTERN: f4cb205a]
        Node 26809 (Seq Scan) [consumed] - LEAF
        Node 26810 (Hash) [consumed]
          Node 26811 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 26808 | 26805, 26806, 26807, 26809, 26810, 26811 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26805 | 26806, 26807, 26808, 26809, 26810, 26811 |
...
|------|------|--------|-----------|-----|--------|
| 26805 | Aggregate | 831.59 | 834.73 | 0.4% | pattern |
| 26808 | Hash Join | 810.15 | 397.10 | 51.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26808 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 26805, 26806, 26807, 26809, 26810, 26811
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=15280
  - HashJoin_nt1=15280
  ...
  - HashJoin_total_cost=136646.7500
  - Hash_Inner_np=0
  - Hash_Inner_nt=83333
...
- **Output:** st=44.61, rt=397.10

### Step 2: Node 26805 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26806, 26807, 26808, 26809, 26810, 26811
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=15280
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=64
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0001
  - Aggregate_Outer_startup_cost=136914.1600
  - Aggregate_Outer_total_cost=136914.1700
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=137914.7200
  - Aggregate_total_cost=137914.7400
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=137914.1600
  - Gather_Outer_total_cost=137914.6700
