...
```
Node 26805 (Aggregate) [PATTERN: f8295d8b] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 26805 | 26806, 26807, 26808, 26809, 26810, 26811 |
...
|------|------|--------|-----------|-----|--------|
| 26805 | Aggregate | 831.59 | 822.71 | 1.1% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26805 (Aggregate) - PATTERN ROOT
