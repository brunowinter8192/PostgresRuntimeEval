...
```
Node 31752 (Aggregate) [PATTERN: f8295d8b] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 31752 | 31753, 31754, 31755, 31756, 31757, 31758 |
...
|------|------|--------|-----------|-----|--------|
| 31752 | Aggregate | 841.42 | 841.17 | 0.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31752 (Aggregate) - PATTERN ROOT
