...
```
Node 11149 (Aggregate) [PATTERN: 27c3eea9] - ROOT
  Node 11150 (Gather Merge) [consumed]
    Node 11151 (Sort) [consumed]
      Node 11152 (Hash Join) [consumed]
        Node 11153 (Nested Loop) [consumed]
          Node 11154 (Hash Join) [consumed]
          ...
          Node 11161 (Index Scan) [consumed] - LEAF
        Node 11162 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 27c3eea9 | 11149 | 11150, 11151, 11152, 11153, 11154, 11156, 11157, 11158, 11159, 11160, 11161, 11162, 11163 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 11156 | 11149, 11150, 11151, 11152, 11153, 11154, 11157, 11158, 11159, 11160, 11161, 11162, 11163 |
...
|------|------|--------|-----------|-----|--------|
| 11149 | Aggregate | 1235.41 | 1200.90 | 2.8% | pattern |
...
### Step 1: Node 11166 (Seq Scan) - LEAF
...
### Step 2: Node 11155 (Seq Scan) - LEAF
...
### Step 3: Node 11156 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 11149, 11150, 11151, 11152, 11153, 11154, 11157, 11158, 11159, 11160, 11161, 11162, 11163
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 11164 (Seq Scan) - LEAF
...
### Step 6: Node 11149 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 11150, 11151, 11152, 11153, 11154, 11156, 11157, 11158, 11159, 11160, 11161, 11162, 11163
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
