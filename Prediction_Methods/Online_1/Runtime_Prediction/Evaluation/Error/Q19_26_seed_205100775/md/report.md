...
```
Node 31696 (Aggregate) [PATTERN: f8295d8b] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 31696 | 31697, 31698, 31699, 31700, 31701, 31702 |
...
|------|------|--------|-----------|-----|--------|
| 31696 | Aggregate | 847.54 | 841.17 | 0.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31696 (Aggregate) - PATTERN ROOT
