  ...
  Node 19527 (Sort) [consumed]
    Node 19528 (Aggregate) [consumed]
      Node 19529 (Gather) [consumed]
        Node 19530 (Hash Join) [PATTERN: 7a51ce50]
          Node 19531 (Hash Join) [consumed]
          ...
          Node 19537 (Hash) [consumed]
            Node 19538 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Hash Join -> [Ne | 7a51ce50 | 19530 | 19526, 19527, 19528, 19529, 19531, 19532, 19533, 19534, 19535, 19536, 19537, 19538 |
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19526 | 19527, 19528, 19529, 19530, 19531, 19532, 19533, 19534, 19535, 19536, 19537, 19538 |
...
| 19530 | Hash Join | 1101.85 | 730.80 | 33.7% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 19530 (Hash Join) - PATTERN ROOT
...
- **Consumes:** Nodes 19526, 19527, 19528, 19529, 19531, 19532, 19533, 19534, 19535, 19536, 19537, 19538
- **Input Features:**
  - HashJoin_Outer_np=0
  ...
  - HashJoin_Outer_total_cost=81349.3600
  - HashJoin_np=0
  - HashJoin_nt=18756
  - HashJoin_nt1=18756
  - HashJoin_nt2=25
  ...
  - HashJoin_total_cost=81408.5000
  - Hash_Inner_np=0
  - Hash_Inner_nt=62500
...
- **Output:** st=37.24, rt=730.80

### Step 2: Node 19526 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19527, 19528, 19529, 19530, 19531, 19532, 19533, 19534, 19535, 19536, 19537, 19538
- **Input Features:**
