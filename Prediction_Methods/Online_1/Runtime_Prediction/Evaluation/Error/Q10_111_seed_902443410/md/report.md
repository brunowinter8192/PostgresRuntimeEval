    ...
    Node 19528 (Aggregate) [consumed]
      Node 19529 (Gather) [consumed]
        Node 19530 (Hash Join) [consumed]
          Node 19531 (Hash Join) [PATTERN: 2873b8c3]
            Node 19532 (Nested Loop) [consumed]
              Node 19533 (Seq Scan) [consumed] - LEAF
              Node 19534 (Index Scan) [consumed] - LEAF
            Node 19535 (Hash) [consumed]
              Node 19536 (Seq Scan) [consumed] - LEAF
          Node 19537 (Hash)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 19526 | 19527, 19528, 19529, 19530, 19531, 19532, 19533, 19534, 19535, 19536 |
| Hash Join -> [Nested Loop -> [ | 2873b8c3 | 19531 | 19526, 19527, 19528, 19529, 19530, 19532, 19533, 19534, 19535, 19536 |
...
### Step 2: Node 19531 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2873b8c3 (Hash Join -> [Nested Loop -> [Seq Scan (Outer), Index Scan (Inner)] (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 19526, 19527, 19528, 19529, 19530, 19532, 19533, 19534, 19535, 19536
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18756
  - HashJoin_nt1=18756
  ...
  - IndexScan_Inner_total_cost=2.2500
...
- **Output:** st=36.98, rt=725.23

### Step 3: Node 19537 (Hash)
...
### Step 4: Node 19526 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19527, 19528, 19529, 19530, 19531, 19532, 19533, 19534, 19535, 19536
- **Input Features:**
