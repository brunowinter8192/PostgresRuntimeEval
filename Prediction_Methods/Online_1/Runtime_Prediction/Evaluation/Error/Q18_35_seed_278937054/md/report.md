...
```
Node 30068 (Limit) [PATTERN: 0aa5463f] - ROOT
    ...
    Node 30070 (Aggregate) [consumed]
      Node 30071 (Gather Merge) [consumed]
        Node 30072 (Incremental Sort) [consumed]
          Node 30073 (Nested Loop) [consumed]
            Node 30074 (Merge Join) [consumed]
              Node 30075 (Sort)
            ...
            Node 30083 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 0aa5463f | 30068 | 30069, 30070, 30071, 30072, 30073, 30074, 30076, 30077, 30078, 30083 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30076 | 30068, 30069, 30070, 30071, 30072, 30073, 30074, 30077, 30078, 30083 |
...
- **Consumes:** Nodes 30068, 30069, 30070, 30071, 30072, 30073, 30074, 30077, 30078, 30083
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 7: Node 30068 (Limit) - PATTERN ROOT
...
- **Consumes:** Nodes 30069, 30070, 30071, 30072, 30073, 30074, 30076, 30077, 30078, 30083
- **Input Features:**
