...
Node 26896 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26897 (Gather) [consumed]
    Node 26898 (Aggregate) [consumed]
      Node 26899 (Hash Join) [PATTERN: f4cb205a]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 26899 | 26896, 26897, 26898, 26900, 26901, 26902 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26896 | 26897, 26898, 26899, 26900, 26901, 26902 |
...
| 26899 | Hash Join | 789.64 | 397.13 | 49.7% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26899 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 26896, 26897, 26898, 26900, 26901, 26902
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=15122
  - HashJoin_nt1=15122
  ...
  - HashJoin_total_cost=136646.3400
  - Hash_Inner_np=0
  - Hash_Inner_nt=83333
...
### Step 2: Node 26896 (Aggregate) - PATTERN ROOT
