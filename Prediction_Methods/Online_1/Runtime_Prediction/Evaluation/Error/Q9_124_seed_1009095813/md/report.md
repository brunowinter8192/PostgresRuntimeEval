...
```
Node 17122 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 17123 (Aggregate) [consumed]
    Node 17124 (Gather)
      Node 17125 (Aggregate)
        Node 17126 (Nested Loop)
          Node 17127 (Hash Join) [PATTERN: 895c6e8c]
            Node 17128 (Seq Scan) [consumed] - LEAF
            Node 17129 (Hash) [consumed]
              Node 17130 (Hash Join) [PATTERN: 7a51ce50]
                Node 17131 (Hash Join) [consumed]
                  Node 17132 (Nested Loop) [consumed]
                    Node 17133 (Seq Scan) [consumed] - LEAF
                    Node 17134 (Index Scan) [consumed] - LEAF
                  Node 17135 (Hash) [consumed]
                    Node 17136 (Seq Scan) [consumed] - LEAF
                Node 17137 (Hash) [consumed]
                  Node 17138 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Hash Join -> [Hash Join -> [Ne | 7a51ce50 | 17130 | 17122, 17123, 17127, 17128, 17129, 17131, 17132, 17133, 17134, 17135, 17136, 17137, 17138 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 17127 | 17122, 17123, 17128, 17129, 17130, 17131, 17132, 17133, 17134, 17135, 17136, 17137, 17138 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17122 | 17123, 17127, 17128, 17129, 17130, 17131, 17132, 17133, 17134, 17135, 17136, 17137, 17138 |
...
|------|------|--------|-----------|-----|--------|
| 17122 | Sort | 1195.21 | 1114.56 | 6.7% | pattern |
| 17124 | Gather | 1193.72 | 1122.53 | 6.0% | operator |
| 17125 | Aggregate | 1175.52 | 1170.41 | 0.4% | operator |
| 17126 | Nested Loop | 1151.20 | 1172.96 | 1.9% | operator |
| 17127 | Hash Join | 979.04 | 733.11 | 25.1% | pattern |
| 17139 | Index Scan | 0.00 | -0.04 | 1512.7% | operator |
| 17130 | Hash Join | 174.12 | 546.11 | 213.6% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 17130 (Hash Join) - PATTERN ROOT
...
- **Consumes:** Nodes 17122, 17123, 17127, 17128, 17129, 17131, 17132, 17133, 17134, 17135, 17136, 17137, 17138
- **Input Features:**
  - HashJoin_Outer_np=0
  ...
  - HashJoin_Outer_total_cost=14123.6000
  - HashJoin_np=0
  - HashJoin_nt=15363
  - HashJoin_nt1=15363
  - HashJoin_nt2=25
  ...
  - HashJoin_total_cost=14172.3300
  - Hash_Inner_np=0
  - Hash_Inner_nt=10000
  ...
  - IndexScan_Inner_total_cost=2.1600
...
- **Output:** st=18.57, rt=546.11

### Step 2: Node 17127 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 17122, 17123, 17128, 17129, 17130, 17131, 17132, 17133, 17134, 17135, 17136, 17137, 17138
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=55319
...
### Step 3: Node 17139 (Index Scan) - LEAF
...
### Step 7: Node 17122 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17123, 17127, 17128, 17129, 17130, 17131, 17132, 17133, 17134, 17135, 17136, 17137, 17138
- **Input Features:**
