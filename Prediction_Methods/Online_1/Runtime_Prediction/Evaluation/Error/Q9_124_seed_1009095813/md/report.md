    ...
    Node 17124 (Gather) [consumed]
      Node 17125 (Aggregate) [consumed]
        Node 17126 (Nested Loop) [consumed]
          ...
          Node 17139 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather -> | 76ab422a | 17122 | 17123, 17124, 17125, 17126, 17127, 17128, 17129, 17130, 17131, 17132, 17135, 17137, 17138, 17139 |
...
|------|------|--------|-----------|-----|--------|
| 17122 | Sort | 1195.21 | 1195.00 | 0.0% | pattern |
...
### Step 4: Node 17122 (Sort) - PATTERN ROOT
...
- **Consumes:** Nodes 17123, 17124, 17125, 17126, 17127, 17128, 17129, 17130, 17131, 17132, 17135, 17137, 17138, 17139
- **Input Features:**
