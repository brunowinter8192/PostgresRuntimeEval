...
Node 17194 (Sort) - ROOT
  Node 17195 (Aggregate) [PATTERN: a5f39f08]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 17195 | 17196, 17197 |
...
|------|------|--------|-----------|-----|--------|
| 17194 | Sort | 1168.57 | 1145.93 | 1.9% | operator |
| 17195 | Aggregate | 1168.44 | 1097.88 | 6.0% | pattern |
| 17198 | Nested Loop | 1126.25 | 1168.97 | 3.8% | operator |
| 17199 | Hash Join | 954.86 | 830.46 | 13.0% | operator |
| 17211 | Index Scan | 0.00 | -0.04 | 1512.7% | operator |
| 17200 | Seq Scan | 685.77 | 565.06 | 17.6% | operator |
| 17201 | Hash | 174.41 | 50.75 | 70.9% | operator |
| 17202 | Hash Join | 167.07 | 907.83 | 443.4% | operator |
| 17203 | Hash Join | 153.76 | 848.99 | 452.2% | operator |
| 17209 | Hash | 12.70 | 14.54 | 14.5% | operator |
| 17204 | Nested Loop | 147.88 | 1065.44 | 620.5% | operator |
| 17207 | Hash | 3.62 | 14.79 | 308.9% | operator |
...
### Step 10: Node 17200 (Seq Scan) - LEAF
...
### Step 13: Node 17211 (Index Scan) - LEAF
...
### Step 14: Node 17198 (Nested Loop)
...
### Step 15: Node 17195 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 17196, 17197
- **Input Features:**
