...
Node 15915 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 15916 (Gather Merge) [consumed]
    Node 15917 (Sort)
      Node 15918 (Hash Join) [PATTERN: 2e0f44ef]
        Node 15919 (Nested Loop) [consumed]
          Node 15920 (Hash Join) [PATTERN: 2e0f44ef]
            Node 15921 (Nested Loop) [consumed]
              Node 15922 (Hash Join) [PATTERN: 895c6e8c]
                Node 15923 (Seq Scan) [consumed] - LEAF
                Node 15924 (Hash) [consumed]
                  Node 15925 (Hash Join)
                    Node 15926 (Seq Scan) - LEAF
                    Node 15927 (Hash) [PATTERN: a54055ce]
                      Node 15928 (Hash Join) [consumed]
                        Node 15929 (Seq Scan) [consumed] - LEAF
                        Node 15930 (Hash) [consumed]
                          Node 15931 (Seq Scan) [consumed] - LEAF
              Node 15932 (Index Scan) - LEAF
            Node 15933 (Hash) [consumed]
              Node 15934 (Seq Scan) - LEAF
          Node 15935 (Index Scan) - LEAF
        Node 15936 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 15927 | 15915, 15916, 15918, 15919, 15920, 15921, 15922, 15923, 15924, 15928, 15929, 15930, 15931, 15933, 15936 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 15922 | 15915, 15916, 15918, 15919, 15920, 15921, 15923, 15924, 15927, 15928, 15929, 15930, 15931, 15933, 15936 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 15918 | 15915, 15916, 15919, 15920, 15921, 15922, 15923, 15924, 15927, 15928, 15929, 15930, 15931, 15933, 15936 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 15920 | 15915, 15916, 15918, 15919, 15921, 15922, 15923, 15924, 15927, 15928, 15929, 15930, 15931, 15933, 15936 |
| Aggregate -> Gather Merge (Out | 2724c080 | 15915 | 15916, 15918, 15919, 15920, 15921, 15922, 15923, 15924, 15927, 15928, 15929, 15930, 15931, 15933, 15936 |
...
| 15917 | Sort | 1219.78 | 1096.02 | 10.1% | operator |
| 15918 | Hash Join | 1219.55 | 1199.17 | 1.7% | pattern |
| 15920 | Hash Join | 1215.19 | 1192.81 | 1.8% | pattern |
| 15935 | Index Scan | 0.01 | 0.05 | 753.5% | operator |
| 15937 | Seq Scan | 0.01 | 7.19 | 59854.0% | operator |
| 15922 | Hash Join | 214.27 | 260.30 | 21.5% | pattern |
| 15932 | Index Scan | 0.04 | 0.09 | 107.2% | operator |
| 15934 | Seq Scan | 41.35 | 44.48 | 7.6% | operator |
| 15925 | Hash Join | 35.94 | 67.79 | 88.6% | operator |
| 15926 | Seq Scan | 34.30 | 24.87 | 27.5% | operator |
| 15927 | Hash | 0.29 | 0.20 | 32.4% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 15926 (Seq Scan) - LEAF
...
### Step 2: Node 15927 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 15915, 15916, 15918, 15919, 15920, 15921, 15922, 15923, 15924, 15928, 15929, 15930, 15931, 15933, 15936
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 4: Node 15922 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 15915, 15916, 15918, 15919, 15920, 15921, 15923, 15924, 15927, 15928, 15929, 15930, 15931, 15933, 15936
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=29497
  - HashJoin_nt1=147487
...
### Step 5: Node 15932 (Index Scan) - LEAF
...
### Step 6: Node 15934 (Seq Scan) - LEAF
...
### Step 7: Node 15920 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 15915, 15916, 15918, 15919, 15921, 15922, 15923, 15924, 15927, 15928, 15929, 15930, 15931, 15933, 15936
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=794
  - HashJoin_nt1=118013
...
### Step 8: Node 15935 (Index Scan) - LEAF
...
### Step 9: Node 15937 (Seq Scan) - LEAF
...
### Step 10: Node 15918 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 15915, 15916, 15919, 15920, 15921, 15922, 15923, 15924, 15927, 15928, 15929, 15930, 15931, 15933, 15936
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=794
  - HashJoin_nt1=794
...
### Step 12: Node 15915 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 15916, 15918, 15919, 15920, 15921, 15922, 15923, 15924, 15927, 15928, 15929, 15930, 15931, 15933, 15936
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2460
