...
```
Node 32207 (Aggregate) [PATTERN: f8295d8b] - ROOT
  Node 32208 (Gather) [consumed]
    Node 32209 (Aggregate) [consumed]
      Node 32210 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 32207 | 32208, 32209, 32210, 32211, 32212, 32213 |
...
|------|------|--------|-----------|-----|--------|
| 32207 | Aggregate | 851.56 | 841.17 | 1.2% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 32207 (Aggregate) - PATTERN ROOT
