...
```
Node 13075 (Aggregate) [PATTERN: 27c3eea9] - ROOT
  Node 13076 (Gather Merge) [consumed]
    Node 13077 (Sort) [consumed]
      Node 13078 (Hash Join) [consumed]
        Node 13079 (Nested Loop) [consumed]
          Node 13080 (Hash Join) [consumed]
          ...
          Node 13087 (Index Scan) [consumed] - LEAF
        Node 13088 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 27c3eea9 | 13075 | 13076, 13077, 13078, 13079, 13080, 13082, 13083, 13084, 13085, 13086, 13087, 13088, 13089 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 13082 | 13075, 13076, 13077, 13078, 13079, 13080, 13083, 13084, 13085, 13086, 13087, 13088, 13089 |
...
|------|------|--------|-----------|-----|--------|
| 13075 | Aggregate | 1196.87 | 1200.90 | 0.3% | pattern |
...
### Step 1: Node 13092 (Seq Scan) - LEAF
...
### Step 2: Node 13081 (Seq Scan) - LEAF
...
### Step 3: Node 13082 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 13075, 13076, 13077, 13078, 13079, 13080, 13083, 13084, 13085, 13086, 13087, 13088, 13089
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 13090 (Seq Scan) - LEAF
...
### Step 6: Node 13075 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 13076, 13077, 13078, 13079, 13080, 13082, 13083, 13084, 13085, 13086, 13087, 13088, 13089
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
