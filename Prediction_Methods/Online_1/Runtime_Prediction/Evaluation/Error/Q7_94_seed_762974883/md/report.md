      ...
      Node 13078 (Hash Join)
        Node 13079 (Nested Loop)
          Node 13080 (Hash Join)
            ...
            Node 13082 (Hash) [PATTERN: a54055ce]
              Node 13083 (Hash Join) [consumed]
                Node 13084 (Seq Scan) [consumed] - LEAF
                Node 13085 (Hash) [consumed]
                  Node 13086 (Seq Scan) [consumed] - LEAF
          Node 13087 (Index Scan) - LEAF
        Node 13088 (Hash) [PATTERN: a54055ce]
          Node 13089 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 13082 | 13075, 13076, 13083, 13084, 13085, 13086, 13088, 13089, 13090, 13091, 13092 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 13088 | 13075, 13076, 13082, 13083, 13084, 13085, 13086, 13089, 13090, 13091, 13092 |
| Aggregate -> Gather Merge (Out | 2724c080 | 13075 | 13076, 13082, 13083, 13084, 13085, 13086, 13088, 13089, 13090, 13091, 13092 |
...
| 13078 | Hash Join | 1187.09 | 1130.43 | 4.8% | operator |
| 13079 | Nested Loop | 1178.47 | 1145.81 | 2.8% | operator |
| 13088 | Hash | 4.14 | 3.42 | 17.4% | pattern |
| 13080 | Hash Join | 213.24 | 319.90 | 50.0% | operator |
| 13087 | Index Scan | 0.03 | 0.09 | 171.7% | operator |
| 13081 | Seq Scan | 152.55 | 192.19 | 26.0% | operator |
| 13082 | Hash | 35.32 | 35.59 | 0.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 13081 (Seq Scan) - LEAF
...
### Step 2: Node 13082 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 13075, 13076, 13083, 13084, 13085, 13086, 13088, 13089, 13090, 13091, 13092
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 13087 (Index Scan) - LEAF
...
### Step 6: Node 13088 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 13075, 13076, 13082, 13083, 13084, 13085, 13086, 13089, 13090, 13091, 13092
- **Input Features:**
  - HashJoin_Outer_np=0
...
- **Consumes:** Nodes 13076, 13082, 13083, 13084, 13085, 13086, 13088, 13089, 13090, 13091, 13092
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
