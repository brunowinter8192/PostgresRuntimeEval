...
```
Node 32221 (Aggregate) [PATTERN: f8295d8b] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 32221 | 32222, 32223, 32224, 32225, 32226, 32227 |
...
|------|------|--------|-----------|-----|--------|
| 32221 | Aggregate | 836.44 | 841.17 | 0.6% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 32221 (Aggregate) - PATTERN ROOT
