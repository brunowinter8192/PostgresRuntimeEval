    ...
    Node 4443 (Aggregate) [consumed]
      Node 4444 (Gather) [consumed]
        Node 4445 (Nested Loop)
          Node 4446 (Hash Join) [PATTERN: f4cb205a]
            Node 4447 (Seq Scan) [consumed] - LEAF
            Node 4448 (Hash) [consumed]
              Node 4449 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4441 | 4442, 4443, 4444, 4446, 4447, 4448, 4449 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 4446 | 4441, 4442, 4443, 4444, 4447, 4448, 4449 |
...
| 4445 | Nested Loop | 1169.65 | 1122.45 | 4.0% | operator |
| 4446 | Hash Join | 211.27 | 219.07 | 3.7% | pattern |
| 4450 | Index Scan | 0.03 | -0.02 | 171.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4446 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 4441, 4442, 4443, 4444, 4447, 4448, 4449
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47271
  - HashJoin_nt1=235242
...
- **Output:** st=30.24, rt=219.07

### Step 2: Node 4450 (Index Scan) - LEAF
...
- **Output:** st=30.74, rt=1122.45

### Step 4: Node 4441 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4442, 4443, 4444, 4446, 4447, 4448, 4449
- **Input Features:**
