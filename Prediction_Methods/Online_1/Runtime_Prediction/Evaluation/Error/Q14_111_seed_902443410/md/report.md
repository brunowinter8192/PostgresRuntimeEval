...
```
Node 26504 (Aggregate) [PATTERN: f8295d8b] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 26504 | 26505, 26506, 26507, 26508, 26509, 26510 |
...
|------|------|--------|-----------|-----|--------|
| 26504 | Aggregate | 821.06 | 822.65 | 0.2% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26504 (Aggregate) - PATTERN ROOT
