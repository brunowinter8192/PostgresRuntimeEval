...
```
Node 31402 (Aggregate) [PATTERN: f8295d8b] - ROOT
  Node 31403 (Gather) [consumed]
    Node 31404 (Aggregate) [consumed]
      Node 31405 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 31402 | 31403, 31404, 31405, 31406, 31407, 31408 |
...
|------|------|--------|-----------|-----|--------|
| 31402 | Aggregate | 848.21 | 841.17 | 0.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31402 (Aggregate) - PATTERN ROOT
