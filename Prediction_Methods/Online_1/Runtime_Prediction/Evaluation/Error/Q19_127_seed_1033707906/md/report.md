...
```
Node 31423 (Aggregate) [PATTERN: f8295d8b] - ROOT
  Node 31424 (Gather) [consumed]
    Node 31425 (Aggregate) [consumed]
      Node 31426 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 31423 | 31424, 31425, 31426, 31427, 31428, 31429 |
...
|------|------|--------|-----------|-----|--------|
| 31423 | Aggregate | 811.00 | 841.17 | 3.7% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31423 (Aggregate) - PATTERN ROOT
