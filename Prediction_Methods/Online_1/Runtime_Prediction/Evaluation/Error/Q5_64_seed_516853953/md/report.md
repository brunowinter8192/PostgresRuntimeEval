        ...
        Node 9105 (Sort) [consumed]
          Node 9106 (Hash Join) [consumed]
            Node 9107 (Nested Loop) [consumed]
              ...
              Node 9118 (Index Scan) [consumed] - LEAF
            Node 9119 (Hash) [consumed]
              Node 9120 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather Me | 255215ee | 9101 | 9102, 9103, 9104, 9105, 9106, 9107, 9108, 9109, 9110, 9111, 9112, 9113, 9114, 9118, 9119, 9120 |
...
|------|------|--------|-----------|-----|--------|
| 9101 | Sort | 1052.03 | 1070.44 | 1.7% | pattern |
...
### Step 4: Node 9101 (Sort) - PATTERN ROOT
...
- **Consumes:** Nodes 9102, 9103, 9104, 9105, 9106, 9107, 9108, 9109, 9110, 9111, 9112, 9113, 9114, 9118, 9119, 9120
- **Input Features:**
