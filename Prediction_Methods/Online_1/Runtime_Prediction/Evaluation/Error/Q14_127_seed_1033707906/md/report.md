...
```
Node 26623 (Aggregate) [PATTERN: f8295d8b] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 26623 | 26624, 26625, 26626, 26627, 26628, 26629 |
...
|------|------|--------|-----------|-----|--------|
| 26623 | Aggregate | 862.25 | 822.58 | 4.6% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26623 (Aggregate) - PATTERN ROOT
