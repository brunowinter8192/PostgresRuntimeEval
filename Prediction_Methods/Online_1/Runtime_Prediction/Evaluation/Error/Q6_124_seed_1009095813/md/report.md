...
```
Node 10005 (Aggregate) [PATTERN: dd3706ac] - ROOT
  Node 10006 (Gather) [consumed]
    Node 10007 (Aggregate) [consumed]
      Node 10008 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | dd3706ac | 10005 | 10006, 10007, 10008 |
...
|------|------|--------|-----------|-----|--------|
| 10005 | Aggregate | 771.39 | 791.27 | 2.6% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10005 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** dd3706ac (Aggregate -> Gather -> Aggregate -> Seq Scan (Outer) (Outer) (Outer))
- **Consumes:** Nodes 10006, 10007, 10008
- **Input Features:**
