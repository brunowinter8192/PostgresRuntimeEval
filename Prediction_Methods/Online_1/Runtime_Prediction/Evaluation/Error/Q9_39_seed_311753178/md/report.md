...
```
Node 18137 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18138 (Aggregate) [consumed]
    Node 18139 (Gather)
      Node 18140 (Aggregate)
        Node 18141 (Nested Loop)
          Node 18142 (Hash Join) [PATTERN: 895c6e8c]
            Node 18143 (Seq Scan) [consumed] - LEAF
            Node 18144 (Hash) [consumed]
              Node 18145 (Hash Join) [PATTERN: 7a51ce50]
                Node 18146 (Hash Join) [consumed]
                  Node 18147 (Nested Loop) [consumed]
                    Node 18148 (Seq Scan) [consumed] - LEAF
                    Node 18149 (Index Scan) [consumed] - LEAF
                  Node 18150 (Hash) [consumed]
                    Node 18151 (Seq Scan) [consumed] - LEAF
                Node 18152 (Hash) [consumed]
                  Node 18153 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Hash Join -> [Hash Join -> [Ne | 7a51ce50 | 18145 | 18137, 18138, 18142, 18143, 18144, 18146, 18147, 18148, 18149, 18150, 18151, 18152, 18153 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 18142 | 18137, 18138, 18143, 18144, 18145, 18146, 18147, 18148, 18149, 18150, 18151, 18152, 18153 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18137 | 18138, 18142, 18143, 18144, 18145, 18146, 18147, 18148, 18149, 18150, 18151, 18152, 18153 |
...
|------|------|--------|-----------|-----|--------|
| 18137 | Sort | 1185.09 | 1114.71 | 5.9% | pattern |
| 18139 | Gather | 1183.86 | 1098.11 | 7.2% | operator |
| 18140 | Aggregate | 1163.14 | 1169.71 | 0.6% | operator |
| 18141 | Nested Loop | 1139.27 | 1168.16 | 2.5% | operator |
| 18142 | Hash Join | 965.31 | 732.52 | 24.1% | pattern |
| 18154 | Index Scan | 0.00 | -0.04 | 1512.7% | operator |
| 18145 | Hash Join | 168.49 | 546.70 | 224.5% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 18145 (Hash Join) - PATTERN ROOT
...
- **Consumes:** Nodes 18137, 18138, 18142, 18143, 18144, 18146, 18147, 18148, 18149, 18150, 18151, 18152, 18153
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 2: Node 18142 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 18137, 18138, 18143, 18144, 18145, 18146, 18147, 18148, 18149, 18150, 18151, 18152, 18153
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=48106
...
### Step 3: Node 18154 (Index Scan) - LEAF
...
### Step 7: Node 18137 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18138, 18142, 18143, 18144, 18145, 18146, 18147, 18148, 18149, 18150, 18151, 18152, 18153
- **Input Features:**
