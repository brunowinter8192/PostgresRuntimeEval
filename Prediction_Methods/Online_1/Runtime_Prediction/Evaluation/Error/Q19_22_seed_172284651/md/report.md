...
```
Node 31668 (Aggregate) [PATTERN: f8295d8b] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 31668 | 31669, 31670, 31671, 31672, 31673, 31674 |
...
|------|------|--------|-----------|-----|--------|
| 31668 | Aggregate | 816.91 | 841.17 | 3.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31668 (Aggregate) - PATTERN ROOT
