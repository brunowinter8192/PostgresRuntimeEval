      ...
      Node 11512 (Hash Join)
        Node 11513 (Nested Loop)
          Node 11514 (Hash Join)
            ...
            Node 11516 (Hash) [PATTERN: a54055ce]
              Node 11517 (Hash Join) [consumed]
                Node 11518 (Seq Scan) [consumed] - LEAF
                Node 11519 (Hash) [consumed]
                  Node 11520 (Seq Scan) [consumed] - LEAF
          Node 11521 (Index Scan) - LEAF
        Node 11522 (Hash) [PATTERN: a54055ce]
          Node 11523 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 11516 | 11509, 11510, 11517, 11518, 11519, 11520, 11522, 11523, 11524, 11525, 11526 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 11522 | 11509, 11510, 11516, 11517, 11518, 11519, 11520, 11523, 11524, 11525, 11526 |
| Aggregate -> Gather Merge (Out | 2724c080 | 11509 | 11510, 11516, 11517, 11518, 11519, 11520, 11522, 11523, 11524, 11525, 11526 |
...
| 11512 | Hash Join | 1190.73 | 1130.43 | 5.1% | operator |
| 11513 | Nested Loop | 1183.83 | 1145.81 | 3.2% | operator |
| 11522 | Hash | 3.16 | 3.42 | 8.1% | pattern |
| 11514 | Hash Join | 210.80 | 319.90 | 51.8% | operator |
| 11521 | Index Scan | 0.03 | 0.09 | 163.5% | operator |
| 11515 | Seq Scan | 149.36 | 192.19 | 28.7% | operator |
| 11516 | Hash | 36.73 | 35.59 | 3.1% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11515 (Seq Scan) - LEAF
...
### Step 2: Node 11516 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 11509, 11510, 11517, 11518, 11519, 11520, 11522, 11523, 11524, 11525, 11526
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 11521 (Index Scan) - LEAF
...
### Step 6: Node 11522 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 11509, 11510, 11516, 11517, 11518, 11519, 11520, 11523, 11524, 11525, 11526
- **Input Features:**
  - HashJoin_Outer_np=0
...
- **Consumes:** Nodes 11510, 11516, 11517, 11518, 11519, 11520, 11522, 11523, 11524, 11525, 11526
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
