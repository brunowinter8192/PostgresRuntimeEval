...
```
Node 11509 (Aggregate) [PATTERN: 27c3eea9] - ROOT
  Node 11510 (Gather Merge) [consumed]
    Node 11511 (Sort) [consumed]
      Node 11512 (Hash Join) [consumed]
        Node 11513 (Nested Loop) [consumed]
          Node 11514 (Hash Join) [consumed]
          ...
          Node 11521 (Index Scan) [consumed] - LEAF
        Node 11522 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 27c3eea9 | 11509 | 11510, 11511, 11512, 11513, 11514, 11516, 11517, 11518, 11519, 11520, 11521, 11522, 11523 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 11516 | 11509, 11510, 11511, 11512, 11513, 11514, 11517, 11518, 11519, 11520, 11521, 11522, 11523 |
...
|------|------|--------|-----------|-----|--------|
| 11509 | Aggregate | 1199.43 | 1200.90 | 0.1% | pattern |
...
### Step 1: Node 11526 (Seq Scan) - LEAF
...
### Step 2: Node 11515 (Seq Scan) - LEAF
...
### Step 3: Node 11516 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 11509, 11510, 11511, 11512, 11513, 11514, 11517, 11518, 11519, 11520, 11521, 11522, 11523
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 11524 (Seq Scan) - LEAF
...
### Step 6: Node 11509 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 11510, 11511, 11512, 11513, 11514, 11516, 11517, 11518, 11519, 11520, 11521, 11522, 11523
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
