  ...
  Node 20437 (Sort) [consumed]
    Node 20438 (Aggregate) [consumed]
      Node 20439 (Gather) [consumed]
        Node 20440 (Hash Join) [PATTERN: 7a51ce50]
          Node 20441 (Hash Join) [consumed]
          ...
          Node 20447 (Hash) [consumed]
            Node 20448 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Hash Join -> [Ne | 7a51ce50 | 20440 | 20436, 20437, 20438, 20439, 20441, 20442, 20443, 20444, 20445, 20446, 20447, 20448 |
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20436 | 20437, 20438, 20439, 20440, 20441, 20442, 20443, 20444, 20445, 20446, 20447, 20448 |
...
| 20440 | Hash Join | 1094.28 | 730.54 | 33.2% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 20440 (Hash Join) - PATTERN ROOT
...
- **Consumes:** Nodes 20436, 20437, 20438, 20439, 20441, 20442, 20443, 20444, 20445, 20446, 20447, 20448
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 2: Node 20436 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20437, 20438, 20439, 20440, 20441, 20442, 20443, 20444, 20445, 20446, 20447, 20448
- **Input Features:**
