...
```
Node 25818 (Sort) [PATTERN: 35ffb644] - ROOT
  Node 25819 (Aggregate) [consumed]
    Node 25820 (Aggregate) [consumed]
      Node 25821 (Hash Join)
        Node 25822 (Seq Scan) - LEAF
        Node 25823 (Hash)
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Aggregate | 35ffb644 | 25818 | 25819, 25820 |
...
| 25821 | Hash Join | 713.94 | 705.85 | 1.1% | operator |
| 25822 | Seq Scan | 505.97 | 412.66 | 18.4% | operator |
| 25823 | Hash | 14.92 | 37.64 | 152.2% | operator |
| 25824 | Index Only Scan | 9.72 | 10.09 | 3.8% | operator |
...
### Step 2: Node 25822 (Seq Scan) - LEAF
...
### Step 5: Node 25818 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 35ffb644 (Sort -> Aggregate -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 25819, 25820
- **Input Features:**
