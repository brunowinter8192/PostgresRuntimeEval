...
```
Node 26196 (Sort) [PATTERN: 35ffb644] - ROOT
  Node 26197 (Aggregate) [consumed]
    Node 26198 (Aggregate) [consumed]
      Node 26199 (Hash Join)
        Node 26200 (Seq Scan) - LEAF
        Node 26201 (Hash)
          Node 26202 (Index Only Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Aggregate | 35ffb644 | 26196 | 26197, 26198 |
...
| 26199 | Hash Join | 689.96 | 705.85 | 2.3% | operator |
| 26200 | Seq Scan | 479.77 | 412.66 | 14.0% | operator |
| 26201 | Hash | 15.09 | 37.64 | 149.5% | operator |
| 26202 | Index Only Scan | 9.74 | 10.09 | 3.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26202 (Index Only Scan) - LEAF
...
### Step 2: Node 26200 (Seq Scan) - LEAF
...
### Step 5: Node 26196 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 35ffb644 (Sort -> Aggregate -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26197, 26198
- **Input Features:**
