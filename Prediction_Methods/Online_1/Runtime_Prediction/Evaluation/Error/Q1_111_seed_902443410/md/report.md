...
```
Node 61 (Aggregate) [PATTERN: 3dfa6025] - ROOT
  Node 62 (Gather Merge) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 3dfa6025 | 61 | 62, 63, 64, 65 |
...
|------|------|--------|-----------|-----|--------|
| 61 | Aggregate | 933.05 | 953.98 | 2.2% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 61 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3dfa6025 (Aggregate -> Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 62, 63, 64, 65
- **Input Features:**
  ...
  - Aggregate_startup_cost=170311.1100
  - Aggregate_total_cost=170315.8800
  ...
  - GatherMerge_Outer_startup_cost=170311.1100
  - GatherMerge_Outer_total_cost=170314.7400
