...
```
Node 9973 (Aggregate) [PATTERN: dd3706ac] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | dd3706ac | 9973 | 9974, 9975, 9976 |
...
|------|------|--------|-----------|-----|--------|
| 9973 | Aggregate | 811.82 | 791.27 | 2.5% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 9973 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** dd3706ac (Aggregate -> Gather -> Aggregate -> Seq Scan (Outer) (Outer) (Outer))
- **Consumes:** Nodes 9974, 9975, 9976
- **Input Features:**
