...
```
Node 32109 (Aggregate) [PATTERN: f8295d8b] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 32109 | 32110, 32111, 32112, 32113, 32114, 32115 |
...
|------|------|--------|-----------|-----|--------|
| 32109 | Aggregate | 806.57 | 841.17 | 4.3% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 32109 (Aggregate) - PATTERN ROOT
