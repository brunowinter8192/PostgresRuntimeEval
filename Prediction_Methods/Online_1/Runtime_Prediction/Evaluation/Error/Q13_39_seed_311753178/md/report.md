...
```
Node 25944 (Sort) [PATTERN: 35ffb644] - ROOT
  Node 25945 (Aggregate) [consumed]
    Node 25946 (Aggregate) [consumed]
      Node 25947 (Hash Join)
        Node 25948 (Seq Scan) - LEAF
        Node 25949 (Hash)
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Aggregate | 35ffb644 | 25944 | 25945, 25946 |
...
| 25947 | Hash Join | 720.41 | 705.41 | 2.1% | operator |
| 25948 | Seq Scan | 480.80 | 410.74 | 14.6% | operator |
| 25949 | Hash | 15.97 | 37.64 | 135.6% | operator |
...
### Step 2: Node 25948 (Seq Scan) - LEAF
...
### Step 5: Node 25944 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 35ffb644 (Sort -> Aggregate -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 25945, 25946
- **Input Features:**
