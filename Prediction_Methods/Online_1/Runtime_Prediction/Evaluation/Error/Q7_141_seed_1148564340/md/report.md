...
```
Node 11311 (Aggregate) [PATTERN: 27c3eea9] - ROOT
  Node 11312 (Gather Merge) [consumed]
    Node 11313 (Sort) [consumed]
      Node 11314 (Hash Join) [consumed]
        Node 11315 (Nested Loop) [consumed]
          Node 11316 (Hash Join) [consumed]
          ...
          Node 11323 (Index Scan) [consumed] - LEAF
        Node 11324 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 27c3eea9 | 11311 | 11312, 11313, 11314, 11315, 11316, 11318, 11319, 11320, 11321, 11322, 11323, 11324, 11325 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 11318 | 11311, 11312, 11313, 11314, 11315, 11316, 11319, 11320, 11321, 11322, 11323, 11324, 11325 |
...
|------|------|--------|-----------|-----|--------|
| 11311 | Aggregate | 1208.55 | 1200.90 | 0.6% | pattern |
...
### Step 1: Node 11328 (Seq Scan) - LEAF
...
### Step 2: Node 11317 (Seq Scan) - LEAF
...
### Step 3: Node 11318 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 11311, 11312, 11313, 11314, 11315, 11316, 11319, 11320, 11321, 11322, 11323, 11324, 11325
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 11326 (Seq Scan) - LEAF
...
### Step 6: Node 11311 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 11312, 11313, 11314, 11315, 11316, 11318, 11319, 11320, 11321, 11322, 11323, 11324, 11325
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
