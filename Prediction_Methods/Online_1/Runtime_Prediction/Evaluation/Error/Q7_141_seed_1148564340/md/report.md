...
```
Node 11311 (Aggregate) - ROOT
  Node 11312 (Gather Merge)
    Node 11313 (Sort)
      Node 11314 (Hash Join)
        Node 11315 (Nested Loop)
          Node 11316 (Hash Join)
            Node 11317 (Seq Scan) - LEAF
            Node 11318 (Hash)
              Node 11319 (Hash Join)
                Node 11320 (Seq Scan) - LEAF
                Node 11321 (Hash)
                  Node 11322 (Seq Scan) - LEAF
          Node 11323 (Index Scan) - LEAF
        Node 11324 (Hash)
          Node 11325 (Hash Join)
            Node 11326 (Seq Scan) - LEAF
            Node 11327 (Hash)
              Node 11328 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 11311 | Aggregate | 1208.55 | 1202.22 | 0.5% | operator |
| 11312 | Gather Merge | 1207.35 | 1148.45 | 4.9% | operator |
| 11313 | Sort | 1202.50 | 1149.87 | 4.4% | operator |
| 11314 | Hash Join | 1201.81 | 1130.50 | 5.9% | operator |
| 11315 | Nested Loop | 1194.40 | 1145.81 | 4.1% | operator |
| 11324 | Hash | 3.43 | 15.44 | 349.5% | operator |
| 11316 | Hash Join | 217.52 | 319.53 | 46.9% | operator |
| 11323 | Index Scan | 0.03 | 0.09 | 163.5% | operator |
| 11325 | Hash Join | 3.39 | 49.64 | 1365.6% | operator |
| 11317 | Seq Scan | 154.59 | 192.19 | 24.3% | operator |
| 11318 | Hash | 36.64 | 17.27 | 52.9% | operator |
| 11326 | Seq Scan | 3.06 | 10.62 | 246.5% | operator |
| 11327 | Hash | 0.01 | 14.54 | 96814.4% | operator |
| 11319 | Hash Join | 36.22 | 54.15 | 49.5% | operator |
| 11328 | Seq Scan | 0.01 | 7.20 | 59866.2% | operator |
| 11320 | Seq Scan | 35.13 | 24.87 | 29.2% | operator |
| 11321 | Hash | 0.01 | 14.54 | 132056.0% | operator |
| 11322 | Seq Scan | 0.01 | 7.20 | 102699.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11322 (Seq Scan) - LEAF
...
### Step 2: Node 11320 (Seq Scan) - LEAF
...
### Step 5: Node 11328 (Seq Scan) - LEAF
...
### Step 6: Node 11317 (Seq Scan) - LEAF
...
### Step 8: Node 11326 (Seq Scan) - LEAF
...
### Step 11: Node 11323 (Index Scan) - LEAF
...
### Step 13: Node 11315 (Nested Loop)
...
### Step 17: Node 11312 (Gather Merge)
...
### Step 18: Node 11311 (Aggregate) - ROOT
