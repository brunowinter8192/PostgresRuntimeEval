      ...
      Node 11314 (Hash Join)
        Node 11315 (Nested Loop)
          Node 11316 (Hash Join)
            ...
            Node 11318 (Hash) [PATTERN: a54055ce]
              Node 11319 (Hash Join) [consumed]
                Node 11320 (Seq Scan) [consumed] - LEAF
                Node 11321 (Hash) [consumed]
                  Node 11322 (Seq Scan) [consumed] - LEAF
          Node 11323 (Index Scan) - LEAF
        Node 11324 (Hash) [PATTERN: a54055ce]
          Node 11325 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 11318 | 11311, 11312, 11319, 11320, 11321, 11322, 11324, 11325, 11326, 11327, 11328 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 11324 | 11311, 11312, 11318, 11319, 11320, 11321, 11322, 11325, 11326, 11327, 11328 |
| Aggregate -> Gather Merge (Out | 2724c080 | 11311 | 11312, 11318, 11319, 11320, 11321, 11322, 11324, 11325, 11326, 11327, 11328 |
...
| 11314 | Hash Join | 1201.81 | 1130.43 | 5.9% | operator |
| 11315 | Nested Loop | 1194.40 | 1145.81 | 4.1% | operator |
| 11324 | Hash | 3.43 | 3.42 | 0.4% | pattern |
| 11316 | Hash Join | 217.52 | 319.90 | 47.1% | operator |
| 11323 | Index Scan | 0.03 | 0.09 | 163.5% | operator |
| 11317 | Seq Scan | 154.59 | 192.19 | 24.3% | operator |
| 11318 | Hash | 36.64 | 35.59 | 2.9% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11317 (Seq Scan) - LEAF
...
### Step 2: Node 11318 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 11311, 11312, 11319, 11320, 11321, 11322, 11324, 11325, 11326, 11327, 11328
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 11323 (Index Scan) - LEAF
...
### Step 6: Node 11324 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 11311, 11312, 11318, 11319, 11320, 11321, 11322, 11325, 11326, 11327, 11328
- **Input Features:**
  - HashJoin_Outer_np=0
...
- **Consumes:** Nodes 11312, 11318, 11319, 11320, 11321, 11322, 11324, 11325, 11326, 11327, 11328
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
