...
Node 15685 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 15686 (Gather Merge) [consumed]
    Node 15687 (Sort)
      Node 15688 (Hash Join) [PATTERN: 2e0f44ef]
        Node 15689 (Nested Loop) [consumed]
          Node 15690 (Hash Join) [PATTERN: 2e0f44ef]
            Node 15691 (Nested Loop) [consumed]
              Node 15692 (Hash Join) [PATTERN: 895c6e8c]
                Node 15693 (Seq Scan) [consumed] - LEAF
                Node 15694 (Hash) [consumed]
                  Node 15695 (Hash Join)
                    Node 15696 (Seq Scan) - LEAF
                    Node 15697 (Hash) [PATTERN: a54055ce]
                      Node 15698 (Hash Join) [consumed]
                        Node 15699 (Seq Scan) [consumed] - LEAF
                        Node 15700 (Hash) [consumed]
                          Node 15701 (Seq Scan) [consumed] - LEAF
              Node 15702 (Index Scan) - LEAF
            Node 15703 (Hash) [consumed]
              Node 15704 (Seq Scan) - LEAF
          Node 15705 (Index Scan) - LEAF
        Node 15706 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 15697 | 15685, 15686, 15688, 15689, 15690, 15691, 15692, 15693, 15694, 15698, 15699, 15700, 15701, 15703, 15706 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 15692 | 15685, 15686, 15688, 15689, 15690, 15691, 15693, 15694, 15697, 15698, 15699, 15700, 15701, 15703, 15706 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 15688 | 15685, 15686, 15689, 15690, 15691, 15692, 15693, 15694, 15697, 15698, 15699, 15700, 15701, 15703, 15706 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 15690 | 15685, 15686, 15688, 15689, 15691, 15692, 15693, 15694, 15697, 15698, 15699, 15700, 15701, 15703, 15706 |
| Aggregate -> Gather Merge (Out | 2724c080 | 15685 | 15686, 15688, 15689, 15690, 15691, 15692, 15693, 15694, 15697, 15698, 15699, 15700, 15701, 15703, 15706 |
...
| 15687 | Sort | 1248.00 | 1096.01 | 12.2% | operator |
| 15688 | Hash Join | 1247.74 | 1199.17 | 3.9% | pattern |
| 15690 | Hash Join | 1243.67 | 1192.84 | 4.1% | pattern |
| 15705 | Index Scan | 0.01 | 0.05 | 753.5% | operator |
| 15707 | Seq Scan | 0.01 | 7.19 | 71844.7% | operator |
| 15692 | Hash Join | 223.25 | 260.30 | 16.6% | pattern |
| 15702 | Index Scan | 0.04 | 0.09 | 102.4% | operator |
| 15704 | Seq Scan | 38.19 | 44.49 | 16.5% | operator |
| 15695 | Hash Join | 39.72 | 67.79 | 70.7% | operator |
| 15696 | Seq Scan | 38.15 | 24.87 | 34.8% | operator |
| 15697 | Hash | 0.23 | 0.20 | 14.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 15696 (Seq Scan) - LEAF
...
### Step 2: Node 15697 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 15685, 15686, 15688, 15689, 15690, 15691, 15692, 15693, 15694, 15698, 15699, 15700, 15701, 15703, 15706
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 4: Node 15692 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 15685, 15686, 15688, 15689, 15690, 15691, 15693, 15694, 15697, 15698, 15699, 15700, 15701, 15703, 15706
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=29497
  - HashJoin_nt1=147487
...
### Step 5: Node 15702 (Index Scan) - LEAF
...
### Step 6: Node 15704 (Seq Scan) - LEAF
...
### Step 7: Node 15690 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 15685, 15686, 15688, 15689, 15691, 15692, 15693, 15694, 15697, 15698, 15699, 15700, 15701, 15703, 15706
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=755
  - HashJoin_nt1=118013
  ...
  - HashJoin_reltuples=0.0000
  - HashJoin_sel=0.0000
  - HashJoin_startup_cost=9919.8500
  - HashJoin_total_cost=70271.3300
  - Hash_Inner_np=0
  - Hash_Inner_nt=533
  - Hash_Inner_nt1=533
  - Hash_Inner_nt2=0
...
- **Output:** st=80.10, rt=1192.84

### Step 8: Node 15705 (Index Scan) - LEAF
...
### Step 9: Node 15707 (Seq Scan) - LEAF
...
### Step 10: Node 15688 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 15685, 15686, 15689, 15690, 15691, 15692, 15693, 15694, 15697, 15698, 15699, 15700, 15701, 15703, 15706
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=755
  - HashJoin_nt1=755
  ...
  - HashJoin_reltuples=0.0000
  - HashJoin_sel=0.0400
  - HashJoin_startup_cost=9921.7000
  - HashJoin_total_cost=70505.5200
  - Hash_Inner_np=0
  - Hash_Inner_nt=25
  - Hash_Inner_nt1=25
  - Hash_Inner_nt2=0
  ...
  - NestedLoop_Outer_np=0
  - NestedLoop_Outer_nt=755
  - NestedLoop_Outer_nt1=755
  - NestedLoop_Outer_nt2=1
  - NestedLoop_Outer_parallel_workers=0
  - NestedLoop_Outer_plan_width=20
  - NestedLoop_Outer_reltuples=0.0000
  - NestedLoop_Outer_sel=1.0000
  - NestedLoop_Outer_startup_cost=9920.1400
  - NestedLoop_Outer_total_cost=70499.7500
- **Output:** st=80.32, rt=1199.17

### Step 11: Node 15687 (Sort)
...
### Step 12: Node 15685 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 15686, 15688, 15689, 15690, 15691, 15692, 15693, 15694, 15697, 15698, 15699, 15700, 15701, 15703, 15706
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2340
  - Aggregate_nt1=2340
