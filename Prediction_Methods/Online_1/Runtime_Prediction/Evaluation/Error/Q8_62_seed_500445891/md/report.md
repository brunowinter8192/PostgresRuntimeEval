...
```
Node 15685 (Aggregate) [PATTERN: 53f9aa07] - ROOT
  Node 15686 (Gather Merge) [consumed]
    Node 15687 (Sort) [consumed]
      Node 15688 (Hash Join) [consumed]
        Node 15689 (Nested Loop) [consumed]
          Node 15690 (Hash Join)
            Node 15691 (Nested Loop) [PATTERN: bd9dfa7b]
              Node 15692 (Hash Join) [consumed]
              ...
              Node 15702 (Index Scan) [consumed] - LEAF
            Node 15703 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 53f9aa07 | 15685 | 15686, 15687, 15688, 15689, 15691, 15692, 15693, 15694, 15695, 15697, 15698, 15699, 15700, 15701, 15702, 15706 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 15697 | 15685, 15686, 15687, 15688, 15689, 15691, 15692, 15693, 15694, 15695, 15698, 15699, 15700, 15701, 15702, 15706 |
| Nested Loop -> [Hash Join -> [ | bd9dfa7b | 15691 | 15685, 15686, 15687, 15688, 15689, 15692, 15693, 15694, 15695, 15697, 15698, 15699, 15700, 15701, 15702, 15706 |
...
|------|------|--------|-----------|-----|--------|
| 15685 | Aggregate | 1253.53 | 1220.56 | 2.6% | pattern |
| 15690 | Hash Join | 1243.67 | 1042.86 | 16.1% | operator |
| 15705 | Index Scan | 0.01 | 0.05 | 753.5% | operator |
| 15707 | Seq Scan | 0.01 | 7.19 | 71844.7% | operator |
| 15691 | Nested Loop | 1200.90 | 1155.06 | 3.8% | pattern |
...
- **Consumes:** Nodes 15685, 15686, 15687, 15688, 15689, 15691, 15692, 15693, 15694, 15695, 15698, 15699, 15700, 15701, 15702, 15706
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 3: Node 15704 (Seq Scan) - LEAF
...
### Step 4: Node 15691 (Nested Loop) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bd9dfa7b (Nested Loop -> [Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer), Index Scan (Inner)])
- **Consumes:** Nodes 15685, 15686, 15687, 15688, 15689, 15692, 15693, 15694, 15695, 15697, 15698, 15699, 15700, 15701, 15702, 15706
- **Input Features:**
  - HashJoin_Outer_np=0
...
- **Output:** st=78.67, rt=1042.86

### Step 7: Node 15705 (Index Scan) - LEAF
...
### Step 8: Node 15707 (Seq Scan) - LEAF
...
### Step 9: Node 15685 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 53f9aa07 (Aggregate -> Gather Merge -> Sort -> Hash Join -> [Nested Loop (Outer), Hash (Inner)] (Outer) (Outer) (Outer))
- **Consumes:** Nodes 15686, 15687, 15688, 15689, 15691, 15692, 15693, 15694, 15695, 15697, 15698, 15699, 15700, 15701, 15702, 15706
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2340
  - Aggregate_nt1=2340
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=755
  - HashJoin_Outer_nt1=755
  - HashJoin_Outer_nt2=25
  - HashJoin_Outer_parallel_workers=0
  - HashJoin_Outer_plan_width=148
  - HashJoin_Outer_reltuples=0.0000
  - HashJoin_Outer_sel=0.0400
  - HashJoin_Outer_startup_cost=9921.7000
  - HashJoin_Outer_total_cost=70505.5200
  - Hash_Inner_np=0
  - Hash_Inner_nt=25
  - Hash_Inner_nt1=25
  - Hash_Inner_nt2=0
  ...
  - Sort_Outer_startup_cost=70541.6100
  - Sort_Outer_total_cost=70543.4900
- **Output:** st=1219.20, rt=1220.56
