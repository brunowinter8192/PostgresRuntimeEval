...
```
Node 6768 (Aggregate) [PATTERN: 80bd802d] - ROOT
  Node 6769 (Gather Merge) [consumed]
    Node 6770 (Sort) [consumed]
      Node 6771 (Aggregate) [consumed]
        Node 6772 (Nested Loop) [consumed]
          Node 6773 (Seq Scan) [consumed] - LEAF
          Node 6774 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 80bd802d | 6768 | 6769, 6770, 6771, 6772, 6773, 6774 |
...
|------|------|--------|-----------|-----|--------|
| 6768 | Aggregate | 1061.99 | 1057.79 | 0.4% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6768 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 6769, 6770, 6771, 6772, 6773, 6774
- **Input Features:**
  ...
  - NestedLoop_Outer_total_cost=65983.1200
  - SeqScan_Outer_np=26136
  - SeqScan_Outer_nt=18465
  - SeqScan_Outer_nt1=0
  - SeqScan_Outer_nt2=0
