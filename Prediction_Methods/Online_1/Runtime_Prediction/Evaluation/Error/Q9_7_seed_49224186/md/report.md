...
```
Node 18952 (Sort) [PATTERN: 57d290cd] - ROOT
          ...
          Node 18958 (Hash) [consumed]
            Node 18959 (Hash Join) [consumed]
              ...
              Node 18961 (Hash) [consumed]
                Node 18962 (Hash Join) [PATTERN: 7a51ce50]
                  Node 18963 (Hash Join) [consumed]
                    Node 18964 (Nested Loop) [consumed]
                      Node 18965 (Seq Scan) [consumed] - LEAF
                      Node 18966 (Index Scan) [consumed] - LEAF
                    Node 18967 (Hash) [consumed]
                      Node 18968 (Seq Scan) [consumed] - LEAF
                  Node 18969 (Hash) [consumed]
                    Node 18970 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather -> | 57d290cd | 18952 | 18953, 18954, 18955, 18956, 18957, 18958, 18959, 18960, 18961, 18962, 18963, 18964, 18965, 18966, 18967, 18968, 18969, 18970 |
| Hash Join -> [Hash Join -> [Ne | 7a51ce50 | 18962 | 18952, 18953, 18954, 18955, 18956, 18957, 18958, 18959, 18960, 18961, 18963, 18964, 18965, 18966, 18967, 18968, 18969, 18970 |
...
| 18962 | Hash Join | 210.91 | 548.04 | 159.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 18962 (Hash Join) - PATTERN ROOT
...
- **Consumes:** Nodes 18952, 18953, 18954, 18955, 18956, 18957, 18958, 18959, 18960, 18961, 18963, 18964, 18965, 18966, 18967, 18968, 18969, 18970
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 2: Node 18952 (Sort) - PATTERN ROOT
...
- **Consumes:** Nodes 18953, 18954, 18955, 18956, 18957, 18958, 18959, 18960, 18961, 18962, 18963, 18964, 18965, 18966, 18967, 18968, 18969, 18970
- **Input Features:**
