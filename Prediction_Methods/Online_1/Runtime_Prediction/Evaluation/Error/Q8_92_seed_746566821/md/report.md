...
Node 16444 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 16445 (Gather Merge) [consumed]
    Node 16446 (Sort)
      Node 16447 (Hash Join) [PATTERN: 2e0f44ef]
        Node 16448 (Nested Loop) [consumed]
          Node 16449 (Hash Join) [PATTERN: 2e0f44ef]
            Node 16450 (Nested Loop) [consumed]
              Node 16451 (Hash Join) [PATTERN: 895c6e8c]
                Node 16452 (Seq Scan) [consumed] - LEAF
                Node 16453 (Hash) [consumed]
                  Node 16454 (Hash Join)
                    Node 16455 (Seq Scan) - LEAF
                    Node 16456 (Hash) [PATTERN: a54055ce]
                      Node 16457 (Hash Join) [consumed]
                        Node 16458 (Seq Scan) [consumed] - LEAF
                        Node 16459 (Hash) [consumed]
                          Node 16460 (Seq Scan) [consumed] - LEAF
              Node 16461 (Index Scan) - LEAF
            Node 16462 (Hash) [consumed]
              Node 16463 (Seq Scan) - LEAF
          Node 16464 (Index Scan) - LEAF
        Node 16465 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 16456 | 16444, 16445, 16447, 16448, 16449, 16450, 16451, 16452, 16453, 16457, 16458, 16459, 16460, 16462, 16465 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 16451 | 16444, 16445, 16447, 16448, 16449, 16450, 16452, 16453, 16456, 16457, 16458, 16459, 16460, 16462, 16465 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 16447 | 16444, 16445, 16448, 16449, 16450, 16451, 16452, 16453, 16456, 16457, 16458, 16459, 16460, 16462, 16465 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 16449 | 16444, 16445, 16447, 16448, 16450, 16451, 16452, 16453, 16456, 16457, 16458, 16459, 16460, 16462, 16465 |
| Aggregate -> Gather Merge (Out | 2724c080 | 16444 | 16445, 16447, 16448, 16449, 16450, 16451, 16452, 16453, 16456, 16457, 16458, 16459, 16460, 16462, 16465 |
...
| 16446 | Sort | 1223.46 | 1096.02 | 10.4% | operator |
| 16447 | Hash Join | 1223.21 | 1199.17 | 2.0% | pattern |
| 16449 | Hash Join | 1219.09 | 1192.80 | 2.2% | pattern |
| 16464 | Index Scan | 0.01 | 0.05 | 753.5% | operator |
| 16466 | Seq Scan | 0.01 | 7.19 | 59854.0% | operator |
| 16451 | Hash Join | 210.79 | 260.30 | 23.5% | pattern |
| 16461 | Index Scan | 0.04 | 0.09 | 107.2% | operator |
| 16463 | Seq Scan | 41.05 | 44.48 | 8.4% | operator |
| 16454 | Hash Join | 35.20 | 67.79 | 92.6% | operator |
| 16455 | Seq Scan | 33.73 | 24.87 | 26.3% | operator |
| 16456 | Hash | 0.20 | 0.20 | 0.4% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 16455 (Seq Scan) - LEAF
...
### Step 2: Node 16456 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 16444, 16445, 16447, 16448, 16449, 16450, 16451, 16452, 16453, 16457, 16458, 16459, 16460, 16462, 16465
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 4: Node 16451 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 16444, 16445, 16447, 16448, 16449, 16450, 16452, 16453, 16456, 16457, 16458, 16459, 16460, 16462, 16465
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=29497
  - HashJoin_nt1=147487
...
### Step 5: Node 16461 (Index Scan) - LEAF
...
### Step 6: Node 16463 (Seq Scan) - LEAF
...
### Step 7: Node 16449 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 16444, 16445, 16447, 16448, 16450, 16451, 16452, 16453, 16456, 16457, 16458, 16459, 16460, 16462, 16465
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=809
  - HashJoin_nt1=118013
...
- **Output:** st=80.09, rt=1192.80

### Step 8: Node 16464 (Index Scan) - LEAF
...
### Step 9: Node 16466 (Seq Scan) - LEAF
...
### Step 10: Node 16447 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 16444, 16445, 16448, 16449, 16450, 16451, 16452, 16453, 16456, 16457, 16458, 16459, 16460, 16462, 16465
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=809
  - HashJoin_nt1=809
...
### Step 12: Node 16444 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 16445, 16447, 16448, 16449, 16450, 16451, 16452, 16453, 16456, 16457, 16458, 16459, 16460, 16462, 16465
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2508
