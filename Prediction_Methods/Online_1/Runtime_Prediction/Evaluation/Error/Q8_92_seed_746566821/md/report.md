...
```
Node 16444 (Aggregate) [PATTERN: 53f9aa07] - ROOT
  Node 16445 (Gather Merge) [consumed]
    Node 16446 (Sort) [consumed]
      Node 16447 (Hash Join) [consumed]
        Node 16448 (Nested Loop) [consumed]
          Node 16449 (Hash Join)
            Node 16450 (Nested Loop) [PATTERN: bd9dfa7b]
              Node 16451 (Hash Join) [consumed]
              ...
              Node 16461 (Index Scan) [consumed] - LEAF
            Node 16462 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 53f9aa07 | 16444 | 16445, 16446, 16447, 16448, 16450, 16451, 16452, 16453, 16454, 16456, 16457, 16458, 16459, 16460, 16461, 16465 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 16456 | 16444, 16445, 16446, 16447, 16448, 16450, 16451, 16452, 16453, 16454, 16457, 16458, 16459, 16460, 16461, 16465 |
| Nested Loop -> [Hash Join -> [ | bd9dfa7b | 16450 | 16444, 16445, 16446, 16447, 16448, 16451, 16452, 16453, 16454, 16456, 16457, 16458, 16459, 16460, 16461, 16465 |
...
|------|------|--------|-----------|-----|--------|
| 16444 | Aggregate | 1228.15 | 1220.47 | 0.6% | pattern |
| 16449 | Hash Join | 1219.09 | 1042.87 | 14.5% | operator |
| 16464 | Index Scan | 0.01 | 0.05 | 753.5% | operator |
| 16466 | Seq Scan | 0.01 | 7.19 | 59854.0% | operator |
| 16450 | Nested Loop | 1173.54 | 1155.06 | 1.6% | pattern |
...
- **Consumes:** Nodes 16444, 16445, 16446, 16447, 16448, 16450, 16451, 16452, 16453, 16454, 16457, 16458, 16459, 16460, 16461, 16465
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 3: Node 16463 (Seq Scan) - LEAF
...
### Step 4: Node 16450 (Nested Loop) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bd9dfa7b (Nested Loop -> [Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer), Index Scan (Inner)])
- **Consumes:** Nodes 16444, 16445, 16446, 16447, 16448, 16451, 16452, 16453, 16454, 16456, 16457, 16458, 16459, 16460, 16461, 16465
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 7: Node 16464 (Index Scan) - LEAF
...
### Step 8: Node 16466 (Seq Scan) - LEAF
...
### Step 9: Node 16444 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 53f9aa07 (Aggregate -> Gather Merge -> Sort -> Hash Join -> [Nested Loop (Outer), Hash (Inner)] (Outer) (Outer) (Outer))
- **Consumes:** Nodes 16445, 16446, 16447, 16448, 16450, 16451, 16452, 16453, 16454, 16456, 16457, 16458, 16459, 16460, 16461, 16465
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2508
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=809
  - HashJoin_Outer_nt1=809
  - HashJoin_Outer_nt2=25
  - HashJoin_Outer_parallel_workers=0
  - HashJoin_Outer_plan_width=148
  - HashJoin_Outer_reltuples=0.0000
  - HashJoin_Outer_sel=0.0400
  - HashJoin_Outer_startup_cost=9922.1700
  - HashJoin_Outer_total_cost=70522.6300
  - Hash_Inner_np=0
  - Hash_Inner_nt=25
  - Hash_Inner_nt1=25
  - Hash_Inner_nt2=0
  ...
  - Sort_Outer_startup_cost=70561.7000
  - Sort_Outer_total_cost=70563.7200
- **Output:** st=1219.10, rt=1220.47
