...
```
Node 131 (Aggregate) [PATTERN: 3dfa6025] - ROOT
  Node 132 (Gather Merge) [consumed]
    Node 133 (Sort) [consumed]
      Node 134 (Aggregate) [consumed]
        Node 135 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 3dfa6025 | 131 | 132, 133, 134, 135 |
...
|------|------|--------|-----------|-----|--------|
| 131 | Aggregate | 958.54 | 953.98 | 0.5% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 131 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3dfa6025 (Aggregate -> Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 132, 133, 134, 135
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=6
  - Aggregate_Outer_nt1=1187805
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=236
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=169176.2100
  - Aggregate_Outer_total_cost=169176.3500
  - Aggregate_np=0
  - Aggregate_nt=6
  - Aggregate_nt1=30
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=170176.5000
  - Aggregate_total_cost=170181.2700
  ...
  - GatherMerge_Outer_startup_cost=170176.5000
  - GatherMerge_Outer_total_cost=170180.1300
  - SeqScan_Outer_np=112600
  - SeqScan_Outer_nt=1187805
  - SeqScan_Outer_nt1=0
  - SeqScan_Outer_nt2=0
  ...
  - Sort_Outer_startup_cost=169176.4300
  - Sort_Outer_total_cost=169176.4400
