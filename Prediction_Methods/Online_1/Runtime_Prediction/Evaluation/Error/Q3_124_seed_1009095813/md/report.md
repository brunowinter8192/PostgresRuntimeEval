    ...
    Node 4613 (Aggregate) [consumed]
      Node 4614 (Gather) [consumed]
        Node 4615 (Nested Loop)
          Node 4616 (Hash Join) [PATTERN: f4cb205a]
            Node 4617 (Seq Scan) [consumed] - LEAF
            Node 4618 (Hash) [consumed]
              Node 4619 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4611 | 4612, 4613, 4614, 4616, 4617, 4618, 4619 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 4616 | 4611, 4612, 4613, 4614, 4617, 4618, 4619 |
...
| 4615 | Nested Loop | 1159.22 | 1122.49 | 3.2% | operator |
| 4616 | Hash Join | 207.09 | 219.11 | 5.8% | pattern |
| 4620 | Index Scan | 0.03 | -0.02 | 171.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4616 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 4611, 4612, 4613, 4614, 4617, 4618, 4619
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47297
  - HashJoin_nt1=235005
...
- **Output:** st=30.24, rt=219.11

### Step 2: Node 4620 (Index Scan) - LEAF
...
- **Output:** st=30.77, rt=1122.49

### Step 4: Node 4611 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4612, 4613, 4614, 4616, 4617, 4618, 4619
- **Input Features:**
