  ...
  Node 20801 (Sort) [consumed]
    Node 20802 (Aggregate) [consumed]
      Node 20803 (Gather) [consumed]
        Node 20804 (Hash Join) [PATTERN: 7a51ce50]
          Node 20805 (Hash Join) [consumed]
          ...
          Node 20811 (Hash) [consumed]
            Node 20812 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Hash Join -> [Ne | 7a51ce50 | 20804 | 20800, 20801, 20802, 20803, 20805, 20806, 20807, 20808, 20809, 20810, 20811, 20812 |
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20800 | 20801, 20802, 20803, 20804, 20805, 20806, 20807, 20808, 20809, 20810, 20811, 20812 |
...
| 20804 | Hash Join | 1117.76 | 730.63 | 34.6% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 20804 (Hash Join) - PATTERN ROOT
...
- **Consumes:** Nodes 20800, 20801, 20802, 20803, 20805, 20806, 20807, 20808, 20809, 20810, 20811, 20812
- **Input Features:**
  - HashJoin_Outer_np=0
  ...
  - HashJoin_Outer_total_cost=80647.1300
  - HashJoin_np=0
  - HashJoin_nt=18015
  - HashJoin_nt1=18015
  - HashJoin_nt2=25
  ...
  - HashJoin_total_cost=80704.0100
  - Hash_Inner_np=0
  - Hash_Inner_nt=62500
...
### Step 2: Node 20800 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20801, 20802, 20803, 20804, 20805, 20806, 20807, 20808, 20809, 20810, 20811, 20812
- **Input Features:**
