    ...
    Node 20802 (Aggregate) [consumed]
      Node 20803 (Gather) [consumed]
        Node 20804 (Hash Join) [consumed]
          Node 20805 (Hash Join) [PATTERN: 2873b8c3]
            Node 20806 (Nested Loop) [consumed]
              Node 20807 (Seq Scan) [consumed] - LEAF
              Node 20808 (Index Scan) [consumed] - LEAF
            Node 20809 (Hash) [consumed]
              Node 20810 (Seq Scan) [consumed] - LEAF
          Node 20811 (Hash)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 20800 | 20801, 20802, 20803, 20804, 20805, 20806, 20807, 20808, 20809, 20810 |
| Hash Join -> [Nested Loop -> [ | 2873b8c3 | 20805 | 20800, 20801, 20802, 20803, 20804, 20806, 20807, 20808, 20809, 20810 |
...
### Step 2: Node 20805 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2873b8c3 (Hash Join -> [Nested Loop -> [Seq Scan (Outer), Index Scan (Inner)] (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 20800, 20801, 20802, 20803, 20804, 20806, 20807, 20808, 20809, 20810
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18015
  - HashJoin_nt1=18015
...
- **Output:** st=36.97, rt=725.08

### Step 3: Node 20811 (Hash)
...
### Step 4: Node 20800 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20801, 20802, 20803, 20804, 20805, 20806, 20807, 20808, 20809, 20810
- **Input Features:**
