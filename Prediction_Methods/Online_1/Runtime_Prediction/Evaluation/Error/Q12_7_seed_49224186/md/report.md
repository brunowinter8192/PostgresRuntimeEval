...
```
Node 25209 (Aggregate) [PATTERN: f9c97829] - ROOT
  Node 25210 (Gather Merge) [consumed]
    Node 25211 (Aggregate) [consumed]
      Node 25212 (Sort) [consumed]
        Node 25213 (Nested Loop) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> A | f9c97829 | 25209 | 25210, 25211, 25212, 25213, 25214, 25215 |
...
|------|------|--------|-----------|-----|--------|
| 25209 | Aggregate | 995.28 | 998.49 | 0.3% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25209 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 25210, 25211, 25212, 25213, 25214, 25215
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=7
  - Aggregate_Outer_nt1=5802
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=27
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0012
  - Aggregate_Outer_startup_cost=147559.7600
  - Aggregate_Outer_total_cost=147675.8700
  - Aggregate_np=0
  - Aggregate_nt=7
  - Aggregate_nt1=35
  - Aggregate_nt2=0
  ...
  - NestedLoop_Outer_nt=5802
  - NestedLoop_Outer_nt1=5802
  ...
  - NestedLoop_Outer_total_cost=147197.0700
  ...
  - Sort_Outer_startup_cost=147559.7600
  - Sort_Outer_total_cost=147574.2700
