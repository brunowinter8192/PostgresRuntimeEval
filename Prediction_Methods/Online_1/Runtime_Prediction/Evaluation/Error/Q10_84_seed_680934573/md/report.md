    ...
    Node 21088 (Aggregate) [consumed]
      Node 21089 (Gather) [consumed]
        Node 21090 (Hash Join) [consumed]
          Node 21091 (Hash Join) [PATTERN: 2873b8c3]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 21086 | 21087, 21088, 21089, 21090, 21091, 21092, 21093, 21094, 21095, 21096 |
| Hash Join -> [Nested Loop -> [ | 2873b8c3 | 21091 | 21086, 21087, 21088, 21089, 21090, 21092, 21093, 21094, 21095, 21096 |
...
### Step 2: Node 21091 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2873b8c3 (Hash Join -> [Nested Loop -> [Seq Scan (Outer), Index Scan (Inner)] (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 21086, 21087, 21088, 21089, 21090, 21092, 21093, 21094, 21095, 21096
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18384
  - HashJoin_nt1=18384
...
### Step 4: Node 21086 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 21087, 21088, 21089, 21090, 21091, 21092, 21093, 21094, 21095, 21096
- **Input Features:**
