  ...
  Node 21087 (Sort) [consumed]
    Node 21088 (Aggregate) [consumed]
      Node 21089 (Gather) [consumed]
        Node 21090 (Hash Join) [PATTERN: 7a51ce50]
          Node 21091 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Hash Join -> [Ne | 7a51ce50 | 21090 | 21086, 21087, 21088, 21089, 21091, 21092, 21093, 21094, 21095, 21096, 21097, 21098 |
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 21086 | 21087, 21088, 21089, 21090, 21091, 21092, 21093, 21094, 21095, 21096, 21097, 21098 |
...
| 21090 | Hash Join | 1120.62 | 730.72 | 34.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 21090 (Hash Join) - PATTERN ROOT
...
- **Consumes:** Nodes 21086, 21087, 21088, 21089, 21091, 21092, 21093, 21094, 21095, 21096, 21097, 21098
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 2: Node 21086 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 21087, 21088, 21089, 21090, 21091, 21092, 21093, 21094, 21095, 21096, 21097, 21098
- **Input Features:**
