...
```
Node 156 (Aggregate) [PATTERN: 3dfa6025] - ROOT
  Node 157 (Gather Merge) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 3dfa6025 | 156 | 157, 158, 159, 160 |
...
|------|------|--------|-----------|-----|--------|
| 156 | Aggregate | 954.39 | 953.98 | 0.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 156 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3dfa6025 (Aggregate -> Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 157, 158, 159, 160
- **Input Features:**
