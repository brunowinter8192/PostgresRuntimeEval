      ...
      Node 12448 (Hash Join)
        Node 12449 (Nested Loop)
          Node 12450 (Hash Join)
            ...
            Node 12452 (Hash) [PATTERN: a54055ce]
              Node 12453 (Hash Join) [consumed]
                Node 12454 (Seq Scan) [consumed] - LEAF
                Node 12455 (Hash) [consumed]
                  Node 12456 (Seq Scan) [consumed] - LEAF
          Node 12457 (Index Scan) - LEAF
        Node 12458 (Hash) [PATTERN: a54055ce]
          Node 12459 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 12452 | 12445, 12446, 12453, 12454, 12455, 12456, 12458, 12459, 12460, 12461, 12462 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 12458 | 12445, 12446, 12452, 12453, 12454, 12455, 12456, 12459, 12460, 12461, 12462 |
| Aggregate -> Gather Merge (Out | 2724c080 | 12445 | 12446, 12452, 12453, 12454, 12455, 12456, 12458, 12459, 12460, 12461, 12462 |
...
| 12448 | Hash Join | 1189.76 | 1130.43 | 5.0% | operator |
| 12449 | Nested Loop | 1180.19 | 1145.81 | 2.9% | operator |
| 12458 | Hash | 5.83 | 3.42 | 41.3% | pattern |
| 12450 | Hash Join | 213.33 | 319.90 | 50.0% | operator |
| 12457 | Index Scan | 0.03 | 0.09 | 171.7% | operator |
| 12451 | Seq Scan | 150.83 | 192.19 | 27.4% | operator |
| 12452 | Hash | 36.00 | 35.59 | 1.1% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12451 (Seq Scan) - LEAF
...
### Step 2: Node 12452 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 12445, 12446, 12453, 12454, 12455, 12456, 12458, 12459, 12460, 12461, 12462
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 12457 (Index Scan) - LEAF
...
### Step 6: Node 12458 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 12445, 12446, 12452, 12453, 12454, 12455, 12456, 12459, 12460, 12461, 12462
- **Input Features:**
  - HashJoin_Outer_np=0
...
- **Consumes:** Nodes 12446, 12452, 12453, 12454, 12455, 12456, 12458, 12459, 12460, 12461, 12462
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
