...
```
Node 12445 (Aggregate) [PATTERN: 27c3eea9] - ROOT
  Node 12446 (Gather Merge) [consumed]
    Node 12447 (Sort) [consumed]
      Node 12448 (Hash Join) [consumed]
        Node 12449 (Nested Loop) [consumed]
          Node 12450 (Hash Join) [consumed]
          ...
          Node 12457 (Index Scan) [consumed] - LEAF
        Node 12458 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 27c3eea9 | 12445 | 12446, 12447, 12448, 12449, 12450, 12452, 12453, 12454, 12455, 12456, 12457, 12458, 12459 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 12452 | 12445, 12446, 12447, 12448, 12449, 12450, 12453, 12454, 12455, 12456, 12457, 12458, 12459 |
...
|------|------|--------|-----------|-----|--------|
| 12445 | Aggregate | 1197.62 | 1200.90 | 0.3% | pattern |
...
### Step 1: Node 12462 (Seq Scan) - LEAF
...
### Step 2: Node 12451 (Seq Scan) - LEAF
...
### Step 3: Node 12452 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 12445, 12446, 12447, 12448, 12449, 12450, 12453, 12454, 12455, 12456, 12457, 12458, 12459
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 12460 (Seq Scan) - LEAF
...
### Step 6: Node 12445 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 12446, 12447, 12448, 12449, 12450, 12452, 12453, 12454, 12455, 12456, 12457, 12458, 12459
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
