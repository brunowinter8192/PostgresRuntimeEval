...
```
Node 12445 (Aggregate) - ROOT
  Node 12446 (Gather Merge)
    Node 12447 (Sort)
      Node 12448 (Hash Join)
        Node 12449 (Nested Loop)
          Node 12450 (Hash Join)
            Node 12451 (Seq Scan) - LEAF
            Node 12452 (Hash)
              Node 12453 (Hash Join)
                Node 12454 (Seq Scan) - LEAF
                Node 12455 (Hash)
                  Node 12456 (Seq Scan) - LEAF
          Node 12457 (Index Scan) - LEAF
        Node 12458 (Hash)
          Node 12459 (Hash Join)
            Node 12460 (Seq Scan) - LEAF
            Node 12461 (Hash)
              Node 12462 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12445 | Aggregate | 1197.62 | 1202.22 | 0.4% | operator |
| 12446 | Gather Merge | 1196.49 | 1148.45 | 4.0% | operator |
| 12447 | Sort | 1190.38 | 1149.87 | 3.4% | operator |
| 12448 | Hash Join | 1189.76 | 1130.50 | 5.0% | operator |
| 12449 | Nested Loop | 1180.19 | 1145.81 | 2.9% | operator |
| 12458 | Hash | 5.83 | 15.44 | 165.0% | operator |
| 12450 | Hash Join | 213.33 | 319.53 | 49.8% | operator |
| 12457 | Index Scan | 0.03 | 0.09 | 171.7% | operator |
| 12459 | Hash Join | 5.78 | 49.64 | 759.4% | operator |
| 12451 | Seq Scan | 150.83 | 192.19 | 27.4% | operator |
| 12452 | Hash | 36.00 | 17.27 | 52.0% | operator |
| 12460 | Seq Scan | 5.45 | 10.62 | 94.9% | operator |
| 12461 | Hash | 0.01 | 14.54 | 103736.9% | operator |
| 12453 | Hash Join | 35.61 | 54.15 | 52.0% | operator |
| 12462 | Seq Scan | 0.01 | 7.20 | 65317.7% | operator |
| 12454 | Seq Scan | 34.46 | 24.87 | 27.8% | operator |
| 12455 | Hash | 0.01 | 14.54 | 181614.5% | operator |
| 12456 | Seq Scan | 0.01 | 7.20 | 119832.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12456 (Seq Scan) - LEAF
...
### Step 2: Node 12454 (Seq Scan) - LEAF
...
### Step 5: Node 12462 (Seq Scan) - LEAF
...
### Step 6: Node 12451 (Seq Scan) - LEAF
...
### Step 8: Node 12460 (Seq Scan) - LEAF
...
### Step 11: Node 12457 (Index Scan) - LEAF
...
### Step 13: Node 12449 (Nested Loop)
...
### Step 17: Node 12446 (Gather Merge)
...
### Step 18: Node 12445 (Aggregate) - ROOT
