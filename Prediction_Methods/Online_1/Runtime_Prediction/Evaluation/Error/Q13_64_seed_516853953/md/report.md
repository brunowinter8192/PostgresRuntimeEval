...
Node 26140 (Sort) [PATTERN: 35ffb644] - ROOT
  Node 26141 (Aggregate) [consumed]
    Node 26142 (Aggregate) [consumed]
      Node 26143 (Hash Join)
        Node 26144 (Seq Scan) - LEAF
        Node 26145 (Hash)
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Aggregate | 35ffb644 | 26140 | 26141, 26142 |
...
| 26143 | Hash Join | 712.58 | 705.78 | 1.0% | operator |
| 26144 | Seq Scan | 504.93 | 412.35 | 18.3% | operator |
| 26145 | Hash | 17.47 | 37.64 | 115.5% | operator |
...
### Step 2: Node 26144 (Seq Scan) - LEAF
...
### Step 5: Node 26140 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 35ffb644 (Sort -> Aggregate -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26141, 26142
- **Input Features:**
