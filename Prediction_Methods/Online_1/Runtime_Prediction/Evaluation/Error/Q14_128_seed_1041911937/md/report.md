...
```
Node 26630 (Aggregate) [PATTERN: f8295d8b] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 26630 | 26631, 26632, 26633, 26634, 26635, 26636 |
...
|------|------|--------|-----------|-----|--------|
| 26630 | Aggregate | 823.66 | 822.65 | 0.1% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26630 (Aggregate) - PATTERN ROOT
