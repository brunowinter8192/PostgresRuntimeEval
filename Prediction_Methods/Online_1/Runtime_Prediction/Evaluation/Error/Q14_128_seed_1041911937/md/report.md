...
**Test Query:** Q14_128_seed_1041911937
**Timestamp:** 2026-01-01 20:04:59
...
```
Node 26630 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26631 (Gather) [consumed]
    Node 26632 (Aggregate) [consumed]
      Node 26633 (Hash Join) [PATTERN: f4cb205a]
        Node 26634 (Seq Scan) [consumed] - LEAF
        Node 26635 (Hash) [consumed]
          Node 26636 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 26633 | 26630, 26631, 26632, 26634, 26635, 26636 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26630 | 26631, 26632, 26633, 26634, 26635, 26636 |
...
|------|------|--------|-----------|-----|--------|
| 26630 | Aggregate | 823.66 | 834.74 | 1.3% | pattern |
| 26633 | Hash Join | 799.15 | 397.01 | 50.3% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26633 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 26630, 26631, 26632, 26634, 26635, 26636
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=15762
  - HashJoin_nt1=15762
  ...
  - HashJoin_total_cost=136648.0200
  - Hash_Inner_np=0
  - Hash_Inner_nt=83333
...
- **Output:** st=44.56, rt=397.01

### Step 2: Node 26630 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26631, 26632, 26633, 26634, 26635, 26636
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=15762
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=64
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0001
  - Aggregate_Outer_startup_cost=136923.8600
  - Aggregate_Outer_total_cost=136923.8700
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=137924.4200
  - Aggregate_total_cost=137924.4400
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=137923.8600
  - Gather_Outer_total_cost=137924.3700
