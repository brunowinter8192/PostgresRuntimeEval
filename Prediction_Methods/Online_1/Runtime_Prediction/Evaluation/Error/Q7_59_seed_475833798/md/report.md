...
```
Node 12373 (Aggregate) [PATTERN: 27c3eea9] - ROOT
  Node 12374 (Gather Merge) [consumed]
    Node 12375 (Sort) [consumed]
      Node 12376 (Hash Join) [consumed]
        Node 12377 (Nested Loop) [consumed]
          Node 12378 (Hash Join) [consumed]
          ...
          Node 12385 (Index Scan) [consumed] - LEAF
        Node 12386 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 27c3eea9 | 12373 | 12374, 12375, 12376, 12377, 12378, 12380, 12381, 12382, 12383, 12384, 12385, 12386, 12387 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 12380 | 12373, 12374, 12375, 12376, 12377, 12378, 12381, 12382, 12383, 12384, 12385, 12386, 12387 |
...
|------|------|--------|-----------|-----|--------|
| 12373 | Aggregate | 1185.19 | 1200.90 | 1.3% | pattern |
...
### Step 1: Node 12390 (Seq Scan) - LEAF
...
### Step 2: Node 12379 (Seq Scan) - LEAF
...
### Step 3: Node 12380 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 12373, 12374, 12375, 12376, 12377, 12378, 12381, 12382, 12383, 12384, 12385, 12386, 12387
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 12388 (Seq Scan) - LEAF
...
### Step 6: Node 12373 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 12374, 12375, 12376, 12377, 12378, 12380, 12381, 12382, 12383, 12384, 12385, 12386, 12387
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
