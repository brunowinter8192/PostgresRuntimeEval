      ...
      Node 12376 (Hash Join)
        Node 12377 (Nested Loop)
          Node 12378 (Hash Join)
            ...
            Node 12380 (Hash) [PATTERN: a54055ce]
              Node 12381 (Hash Join) [consumed]
                Node 12382 (Seq Scan) [consumed] - LEAF
                Node 12383 (Hash) [consumed]
                  Node 12384 (Seq Scan) [consumed] - LEAF
          Node 12385 (Index Scan) - LEAF
        Node 12386 (Hash) [PATTERN: a54055ce]
          Node 12387 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 12380 | 12373, 12374, 12381, 12382, 12383, 12384, 12386, 12387, 12388, 12389, 12390 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 12386 | 12373, 12374, 12380, 12381, 12382, 12383, 12384, 12387, 12388, 12389, 12390 |
| Aggregate -> Gather Merge (Out | 2724c080 | 12373 | 12374, 12380, 12381, 12382, 12383, 12384, 12386, 12387, 12388, 12389, 12390 |
...
| 12376 | Hash Join | 1177.57 | 1130.43 | 4.0% | operator |
| 12377 | Nested Loop | 1171.33 | 1145.81 | 2.2% | operator |
| 12386 | Hash | 2.45 | 3.42 | 39.8% | pattern |
| 12378 | Hash Join | 213.02 | 319.90 | 50.2% | operator |
| 12385 | Index Scan | 0.03 | 0.09 | 180.5% | operator |
| 12379 | Seq Scan | 151.13 | 192.19 | 27.2% | operator |
| 12380 | Hash | 35.95 | 35.59 | 1.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12379 (Seq Scan) - LEAF
...
### Step 2: Node 12380 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 12373, 12374, 12381, 12382, 12383, 12384, 12386, 12387, 12388, 12389, 12390
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 12385 (Index Scan) - LEAF
...
### Step 6: Node 12386 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 12373, 12374, 12380, 12381, 12382, 12383, 12384, 12387, 12388, 12389, 12390
- **Input Features:**
  - HashJoin_Outer_np=0
...
- **Consumes:** Nodes 12374, 12380, 12381, 12382, 12383, 12384, 12386, 12387, 12388, 12389, 12390
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
