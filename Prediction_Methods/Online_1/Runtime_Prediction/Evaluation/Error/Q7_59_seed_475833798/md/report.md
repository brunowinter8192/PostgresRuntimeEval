...
```
Node 12373 (Aggregate) - ROOT
  Node 12374 (Gather Merge)
    Node 12375 (Sort)
      Node 12376 (Hash Join)
        Node 12377 (Nested Loop)
          Node 12378 (Hash Join)
            Node 12379 (Seq Scan) - LEAF
            Node 12380 (Hash)
              Node 12381 (Hash Join)
                Node 12382 (Seq Scan) - LEAF
                Node 12383 (Hash)
                  Node 12384 (Seq Scan) - LEAF
          Node 12385 (Index Scan) - LEAF
        Node 12386 (Hash)
          Node 12387 (Hash Join)
            Node 12388 (Seq Scan) - LEAF
            Node 12389 (Hash)
              Node 12390 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12373 | Aggregate | 1185.19 | 1202.22 | 1.4% | operator |
| 12374 | Gather Merge | 1184.02 | 1148.45 | 3.0% | operator |
| 12375 | Sort | 1178.20 | 1149.87 | 2.4% | operator |
| 12376 | Hash Join | 1177.57 | 1130.50 | 4.0% | operator |
| 12377 | Nested Loop | 1171.33 | 1145.81 | 2.2% | operator |
| 12386 | Hash | 2.45 | 15.44 | 531.1% | operator |
| 12378 | Hash Join | 213.02 | 319.53 | 50.0% | operator |
| 12385 | Index Scan | 0.03 | 0.09 | 180.5% | operator |
| 12387 | Hash Join | 2.40 | 49.64 | 1967.4% | operator |
| 12379 | Seq Scan | 151.13 | 192.19 | 27.2% | operator |
| 12380 | Hash | 35.95 | 17.27 | 52.0% | operator |
| 12388 | Seq Scan | 2.04 | 10.62 | 420.7% | operator |
| 12389 | Hash | 0.01 | 14.54 | 111724.3% | operator |
| 12381 | Hash Join | 35.46 | 54.15 | 52.7% | operator |
| 12390 | Seq Scan | 0.01 | 7.20 | 71859.5% | operator |
| 12382 | Seq Scan | 34.35 | 24.87 | 27.6% | operator |
| 12383 | Hash | 0.01 | 14.54 | 145271.6% | operator |
| 12384 | Seq Scan | 0.01 | 7.20 | 102699.2% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12384 (Seq Scan) - LEAF
...
### Step 2: Node 12382 (Seq Scan) - LEAF
...
### Step 5: Node 12390 (Seq Scan) - LEAF
...
### Step 6: Node 12379 (Seq Scan) - LEAF
...
### Step 8: Node 12388 (Seq Scan) - LEAF
...
### Step 11: Node 12385 (Index Scan) - LEAF
...
### Step 13: Node 12377 (Nested Loop)
...
### Step 17: Node 12374 (Gather Merge)
...
### Step 18: Node 12373 (Aggregate) - ROOT
