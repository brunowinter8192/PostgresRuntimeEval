  ...
  Node 19956 (Sort) [consumed]
    Node 19957 (Aggregate) [consumed]
      Node 19958 (Gather) [consumed]
        Node 19959 (Hash Join) [PATTERN: 7a51ce50]
          Node 19960 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Hash Join -> [Ne | 7a51ce50 | 19959 | 19955, 19956, 19957, 19958, 19960, 19961, 19962, 19963, 19964, 19965, 19966, 19967 |
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19955 | 19956, 19957, 19958, 19959, 19960, 19961, 19962, 19963, 19964, 19965, 19966, 19967 |
...
| 19959 | Hash Join | 1110.80 | 730.58 | 34.2% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 19959 (Hash Join) - PATTERN ROOT
...
- **Consumes:** Nodes 19955, 19956, 19957, 19958, 19960, 19961, 19962, 19963, 19964, 19965, 19966, 19967
- **Input Features:**
  - HashJoin_Outer_np=0
  ...
  - HashJoin_Outer_total_cost=80519.3900
  - HashJoin_np=0
  - HashJoin_nt=17881
  - HashJoin_nt1=17881
  - HashJoin_nt2=25
  ...
  - HashJoin_total_cost=80575.8400
  - Hash_Inner_np=0
  - Hash_Inner_nt=62500
...
- **Output:** st=37.22, rt=730.58

### Step 2: Node 19955 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19956, 19957, 19958, 19959, 19960, 19961, 19962, 19963, 19964, 19965, 19966, 19967
- **Input Features:**
