    ...
    Node 19957 (Aggregate) [consumed]
      Node 19958 (Gather) [consumed]
        Node 19959 (Hash Join) [consumed]
          Node 19960 (Hash Join) [PATTERN: 2873b8c3]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 19955 | 19956, 19957, 19958, 19959, 19960, 19961, 19962, 19963, 19964, 19965 |
| Hash Join -> [Nested Loop -> [ | 2873b8c3 | 19960 | 19955, 19956, 19957, 19958, 19959, 19961, 19962, 19963, 19964, 19965 |
...
### Step 2: Node 19960 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2873b8c3 (Hash Join -> [Nested Loop -> [Seq Scan (Outer), Index Scan (Inner)] (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 19955, 19956, 19957, 19958, 19959, 19961, 19962, 19963, 19964, 19965
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=17881
  - HashJoin_nt1=17881
  ...
  - IndexScan_Inner_total_cost=2.3200
...
- **Output:** st=36.97, rt=725.05

### Step 3: Node 19966 (Hash)
...
### Step 4: Node 19955 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19956, 19957, 19958, 19959, 19960, 19961, 19962, 19963, 19964, 19965
- **Input Features:**
