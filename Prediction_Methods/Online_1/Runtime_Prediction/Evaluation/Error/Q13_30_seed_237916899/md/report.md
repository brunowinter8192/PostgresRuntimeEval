...
```
Node 25881 (Sort) [PATTERN: 35ffb644] - ROOT
  Node 25882 (Aggregate) [consumed]
    Node 25883 (Aggregate) [consumed]
      Node 25884 (Hash Join)
        Node 25885 (Seq Scan) - LEAF
        Node 25886 (Hash)
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Aggregate | 35ffb644 | 25881 | 25882, 25883 |
...
| 25884 | Hash Join | 673.39 | 705.85 | 4.8% | operator |
| 25885 | Seq Scan | 469.95 | 412.66 | 12.2% | operator |
| 25886 | Hash | 15.04 | 37.64 | 150.3% | operator |
| 25887 | Index Only Scan | 9.94 | 10.09 | 1.4% | operator |
...
### Step 2: Node 25885 (Seq Scan) - LEAF
...
### Step 5: Node 25881 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 35ffb644 (Sort -> Aggregate -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 25882, 25883
- **Input Features:**
