...
```
Node 151 (Aggregate) [PATTERN: 3dfa6025] - ROOT
  Node 152 (Gather Merge) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 3dfa6025 | 151 | 152, 153, 154, 155 |
...
|------|------|--------|-----------|-----|--------|
| 151 | Aggregate | 936.63 | 953.98 | 1.9% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 151 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3dfa6025 (Aggregate -> Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 152, 153, 154, 155
- **Input Features:**
  ...
  - Aggregate_startup_cost=169890.1000
  - Aggregate_total_cost=169894.8700
  ...
  - GatherMerge_Outer_startup_cost=169890.1000
  - GatherMerge_Outer_total_cost=169893.7300
