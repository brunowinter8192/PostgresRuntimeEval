...
```
Node 24537 (Aggregate) [PATTERN: f9c97829] - ROOT
  Node 24538 (Gather Merge) [consumed]
    Node 24539 (Aggregate) [consumed]
      Node 24540 (Sort) [consumed]
        Node 24541 (Nested Loop) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> A | f9c97829 | 24537 | 24538, 24539, 24540, 24541, 24542, 24543 |
...
|------|------|--------|-----------|-----|--------|
| 24537 | Aggregate | 1003.12 | 998.49 | 0.5% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24537 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 24538, 24539, 24540, 24541, 24542, 24543
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=7
  - Aggregate_Outer_nt1=5799
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=27
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0012
  - Aggregate_Outer_startup_cost=147557.2000
  - Aggregate_Outer_total_cost=147673.2500
  - Aggregate_np=0
  - Aggregate_nt=7
  - Aggregate_nt1=35
  - Aggregate_nt2=0
  ...
  - Aggregate_total_cost=148677.8700
  ...
  - GatherMerge_Outer_total_cost=148677.5400
  ...
  - NestedLoop_Outer_nt=5799
  - NestedLoop_Outer_nt1=5799
  ...
  - NestedLoop_Outer_total_cost=147194.7200
  - SeqScan_Outer_np=112600
  - SeqScan_Outer_nt=5799
  - SeqScan_Outer_nt1=0
  - SeqScan_Outer_nt2=0
  ...
  - Sort_Outer_startup_cost=147557.2000
  - Sort_Outer_total_cost=147571.7000
