...
```
Node 10663 (Aggregate) [PATTERN: 27c3eea9] - ROOT
    ...
    Node 10665 (Sort) [consumed]
      Node 10666 (Hash Join) [consumed]
        Node 10667 (Nested Loop) [consumed]
          ...
          Node 10675 (Index Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 27c3eea9 | 10663 | 10664, 10665, 10666, 10667, 10668, 10670, 10671, 10672, 10673, 10674, 10675, 10676, 10677 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 10670 | 10663, 10664, 10665, 10666, 10667, 10668, 10671, 10672, 10673, 10674, 10675, 10676, 10677 |
...
|------|------|--------|-----------|-----|--------|
| 10663 | Aggregate | 1186.80 | 1200.90 | 1.2% | pattern |
...
### Step 1: Node 10680 (Seq Scan) - LEAF
...
### Step 2: Node 10669 (Seq Scan) - LEAF
...
### Step 3: Node 10670 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 10663, 10664, 10665, 10666, 10667, 10668, 10671, 10672, 10673, 10674, 10675, 10676, 10677
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 10678 (Seq Scan) - LEAF
...
### Step 6: Node 10663 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 10664, 10665, 10666, 10667, 10668, 10670, 10671, 10672, 10673, 10674, 10675, 10676, 10677
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
