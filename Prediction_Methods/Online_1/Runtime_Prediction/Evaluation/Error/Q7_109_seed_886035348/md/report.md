      ...
      Node 10666 (Hash Join)
        Node 10667 (Nested Loop)
          Node 10668 (Hash Join)
            ...
            Node 10670 (Hash) [PATTERN: a54055ce]
        ...
        Node 10676 (Hash) [PATTERN: a54055ce]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 10670 | 10663, 10664, 10671, 10672, 10673, 10674, 10676, 10677, 10678, 10679, 10680 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 10676 | 10663, 10664, 10670, 10671, 10672, 10673, 10674, 10677, 10678, 10679, 10680 |
| Aggregate -> Gather Merge (Out | 2724c080 | 10663 | 10664, 10670, 10671, 10672, 10673, 10674, 10676, 10677, 10678, 10679, 10680 |
...
| 10666 | Hash Join | 1179.62 | 1130.43 | 4.2% | operator |
| 10667 | Nested Loop | 1171.62 | 1145.81 | 2.2% | operator |
| 10676 | Hash | 4.18 | 3.42 | 18.1% | pattern |
| 10668 | Hash Join | 207.73 | 319.90 | 54.0% | operator |
| 10675 | Index Scan | 0.03 | 0.09 | 171.7% | operator |
| 10669 | Seq Scan | 150.36 | 192.19 | 27.8% | operator |
| 10670 | Hash | 31.52 | 35.59 | 12.9% | pattern |
...
### Step 2: Node 10670 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 10663, 10664, 10671, 10672, 10673, 10674, 10676, 10677, 10678, 10679, 10680
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 6: Node 10676 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 10663, 10664, 10670, 10671, 10672, 10673, 10674, 10677, 10678, 10679, 10680
- **Input Features:**
  - HashJoin_Outer_np=0
...
- **Consumes:** Nodes 10664, 10670, 10671, 10672, 10673, 10674, 10676, 10677, 10678, 10679, 10680
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
