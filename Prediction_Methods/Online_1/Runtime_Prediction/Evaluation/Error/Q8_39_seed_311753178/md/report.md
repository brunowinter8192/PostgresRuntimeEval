...
Node 15087 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 15088 (Gather Merge) [consumed]
    Node 15089 (Sort)
      Node 15090 (Hash Join) [PATTERN: 2e0f44ef]
        Node 15091 (Nested Loop) [consumed]
          Node 15092 (Hash Join) [PATTERN: 2e0f44ef]
            Node 15093 (Nested Loop) [consumed]
              Node 15094 (Hash Join) [PATTERN: 895c6e8c]
                Node 15095 (Seq Scan) [consumed] - LEAF
                Node 15096 (Hash) [consumed]
                  Node 15097 (Hash Join)
                    Node 15098 (Seq Scan) - LEAF
                    Node 15099 (Hash) [PATTERN: a54055ce]
                      Node 15100 (Hash Join) [consumed]
                        Node 15101 (Seq Scan) [consumed] - LEAF
                        Node 15102 (Hash) [consumed]
                          Node 15103 (Seq Scan) [consumed] - LEAF
              Node 15104 (Index Scan) - LEAF
            Node 15105 (Hash) [consumed]
              Node 15106 (Seq Scan) - LEAF
          Node 15107 (Index Scan) - LEAF
        Node 15108 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 15099 | 15087, 15088, 15090, 15091, 15092, 15093, 15094, 15095, 15096, 15100, 15101, 15102, 15103, 15105, 15108 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 15094 | 15087, 15088, 15090, 15091, 15092, 15093, 15095, 15096, 15099, 15100, 15101, 15102, 15103, 15105, 15108 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 15090 | 15087, 15088, 15091, 15092, 15093, 15094, 15095, 15096, 15099, 15100, 15101, 15102, 15103, 15105, 15108 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 15092 | 15087, 15088, 15090, 15091, 15093, 15094, 15095, 15096, 15099, 15100, 15101, 15102, 15103, 15105, 15108 |
| Aggregate -> Gather Merge (Out | 2724c080 | 15087 | 15088, 15090, 15091, 15092, 15093, 15094, 15095, 15096, 15099, 15100, 15101, 15102, 15103, 15105, 15108 |
...
| 15089 | Sort | 1225.25 | 1096.02 | 10.5% | operator |
| 15090 | Hash Join | 1225.02 | 1199.17 | 2.1% | pattern |
| 15092 | Hash Join | 1221.07 | 1192.82 | 2.3% | pattern |
| 15107 | Index Scan | 0.01 | 0.05 | 753.5% | operator |
| 15109 | Seq Scan | 0.01 | 7.19 | 79838.6% | operator |
| 15094 | Hash Join | 218.88 | 260.30 | 18.9% | pattern |
| 15104 | Index Scan | 0.04 | 0.09 | 107.2% | operator |
| 15106 | Seq Scan | 39.63 | 44.48 | 12.2% | operator |
| 15097 | Hash Join | 39.66 | 67.79 | 70.9% | operator |
| 15098 | Seq Scan | 38.17 | 24.87 | 34.8% | operator |
| 15099 | Hash | 0.18 | 0.20 | 6.1% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 15098 (Seq Scan) - LEAF
...
### Step 2: Node 15099 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 15087, 15088, 15090, 15091, 15092, 15093, 15094, 15095, 15096, 15100, 15101, 15102, 15103, 15105, 15108
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 4: Node 15094 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 15087, 15088, 15090, 15091, 15092, 15093, 15095, 15096, 15099, 15100, 15101, 15102, 15103, 15105, 15108
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=29497
  - HashJoin_nt1=147487
...
### Step 5: Node 15104 (Index Scan) - LEAF
...
### Step 6: Node 15106 (Seq Scan) - LEAF
...
### Step 7: Node 15092 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 15087, 15088, 15090, 15091, 15093, 15094, 15095, 15096, 15099, 15100, 15101, 15102, 15103, 15105, 15108
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=785
  - HashJoin_nt1=118013
...
### Step 8: Node 15107 (Index Scan) - LEAF
...
### Step 9: Node 15109 (Seq Scan) - LEAF
...
### Step 10: Node 15090 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 15087, 15088, 15091, 15092, 15093, 15094, 15095, 15096, 15099, 15100, 15101, 15102, 15103, 15105, 15108
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=785
  - HashJoin_nt1=785
...
### Step 12: Node 15087 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 15088, 15090, 15091, 15092, 15093, 15094, 15095, 15096, 15099, 15100, 15101, 15102, 15103, 15105, 15108
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2435
