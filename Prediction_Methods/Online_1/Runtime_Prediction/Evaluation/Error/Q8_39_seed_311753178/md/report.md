...
```
Node 15087 (Aggregate) [PATTERN: 53f9aa07] - ROOT
  Node 15088 (Gather Merge) [consumed]
    Node 15089 (Sort) [consumed]
      Node 15090 (Hash Join) [consumed]
        Node 15091 (Nested Loop) [consumed]
          Node 15092 (Hash Join)
            Node 15093 (Nested Loop) [PATTERN: bd9dfa7b]
              Node 15094 (Hash Join) [consumed]
              ...
              Node 15104 (Index Scan) [consumed] - LEAF
            Node 15105 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 53f9aa07 | 15087 | 15088, 15089, 15090, 15091, 15093, 15094, 15095, 15096, 15097, 15099, 15100, 15101, 15102, 15103, 15104, 15108 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 15099 | 15087, 15088, 15089, 15090, 15091, 15093, 15094, 15095, 15096, 15097, 15100, 15101, 15102, 15103, 15104, 15108 |
| Nested Loop -> [Hash Join -> [ | bd9dfa7b | 15093 | 15087, 15088, 15089, 15090, 15091, 15094, 15095, 15096, 15097, 15099, 15100, 15101, 15102, 15103, 15104, 15108 |
...
|------|------|--------|-----------|-----|--------|
| 15087 | Aggregate | 1230.50 | 1220.51 | 0.8% | pattern |
| 15092 | Hash Join | 1221.07 | 1042.87 | 14.6% | operator |
| 15107 | Index Scan | 0.01 | 0.05 | 753.5% | operator |
| 15109 | Seq Scan | 0.01 | 7.19 | 79838.6% | operator |
| 15093 | Nested Loop | 1176.86 | 1155.06 | 1.9% | pattern |
...
- **Consumes:** Nodes 15087, 15088, 15089, 15090, 15091, 15093, 15094, 15095, 15096, 15097, 15100, 15101, 15102, 15103, 15104, 15108
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 3: Node 15106 (Seq Scan) - LEAF
...
### Step 4: Node 15093 (Nested Loop) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bd9dfa7b (Nested Loop -> [Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer), Index Scan (Inner)])
- **Consumes:** Nodes 15087, 15088, 15089, 15090, 15091, 15094, 15095, 15096, 15097, 15099, 15100, 15101, 15102, 15103, 15104, 15108
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 7: Node 15107 (Index Scan) - LEAF
...
### Step 8: Node 15109 (Seq Scan) - LEAF
...
### Step 9: Node 15087 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 53f9aa07 (Aggregate -> Gather Merge -> Sort -> Hash Join -> [Nested Loop (Outer), Hash (Inner)] (Outer) (Outer) (Outer))
- **Consumes:** Nodes 15088, 15089, 15090, 15091, 15093, 15094, 15095, 15096, 15097, 15099, 15100, 15101, 15102, 15103, 15104, 15108
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2435
