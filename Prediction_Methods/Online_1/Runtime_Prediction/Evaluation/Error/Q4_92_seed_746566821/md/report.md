...
```
Node 6838 (Aggregate) [PATTERN: 80bd802d] - ROOT
  Node 6839 (Gather Merge) [consumed]
    Node 6840 (Sort) [consumed]
      Node 6841 (Aggregate) [consumed]
        Node 6842 (Nested Loop) [consumed]
          Node 6843 (Seq Scan) [consumed] - LEAF
          Node 6844 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 80bd802d | 6838 | 6839, 6840, 6841, 6842, 6843, 6844 |
...
|------|------|--------|-----------|-----|--------|
| 6838 | Aggregate | 1032.96 | 1057.79 | 2.4% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6838 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 6839, 6840, 6841, 6842, 6843, 6844
- **Input Features:**
  ...
  - NestedLoop_Outer_nt=15152
  - NestedLoop_Outer_nt1=18580
  ...
  - NestedLoop_Outer_total_cost=66074.3500
  - SeqScan_Outer_np=26136
  - SeqScan_Outer_nt=18580
  - SeqScan_Outer_nt1=0
  - SeqScan_Outer_nt2=0
