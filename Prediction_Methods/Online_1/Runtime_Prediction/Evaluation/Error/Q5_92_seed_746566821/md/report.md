        ...
        Node 9725 (Sort) [consumed]
          Node 9726 (Hash Join) [consumed]
            Node 9727 (Nested Loop) [consumed]
              ...
              Node 9738 (Index Scan) [consumed] - LEAF
            Node 9739 (Hash) [consumed]
              Node 9740 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather Me | 255215ee | 9721 | 9722, 9723, 9724, 9725, 9726, 9727, 9728, 9729, 9730, 9731, 9732, 9733, 9734, 9738, 9739, 9740 |
...
|------|------|--------|-----------|-----|--------|
| 9721 | Sort | 1055.46 | 1070.44 | 1.4% | pattern |
...
### Step 4: Node 9721 (Sort) - PATTERN ROOT
...
- **Consumes:** Nodes 9722, 9723, 9724, 9725, 9726, 9727, 9728, 9729, 9730, 9731, 9732, 9733, 9734, 9738, 9739, 9740
- **Input Features:**
