              ...
              Node 9728 (Hash Join) [PATTERN: 895c6e8c]
                ...
                Node 9730 (Hash) [consumed]
                  Node 9731 (Hash Join)
                    ...
                    Node 9733 (Hash) [PATTERN: a54055ce]
                      Node 9734 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 9733 | 9721, 9722, 9726, 9727, 9728, 9729, 9730, 9734, 9735, 9736, 9737, 9739 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 9728 | 9721, 9722, 9726, 9727, 9729, 9730, 9733, 9734, 9735, 9736, 9737, 9739 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 9726 | 9721, 9722, 9727, 9728, 9729, 9730, 9733, 9734, 9735, 9736, 9737, 9739 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 9721 | 9722, 9726, 9727, 9728, 9729, 9730, 9733, 9734, 9735, 9736, 9737, 9739 |
...
| 9731 | Hash Join | 32.64 | 62.70 | 92.1% | operator |
| 9732 | Seq Scan | 30.88 | 24.87 | 19.5% | operator |
| 9733 | Hash | 0.36 | 0.14 | 62.7% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 9732 (Seq Scan) - LEAF
...
### Step 2: Node 9733 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 9721, 9722, 9726, 9727, 9728, 9729, 9730, 9734, 9735, 9736, 9737, 9739
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 4: Node 9728 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 9721, 9722, 9726, 9727, 9729, 9730, 9733, 9734, 9735, 9736, 9737, 9739
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14612
  - HashJoin_nt1=73059
...
### Step 5: Node 9738 (Index Scan) - LEAF
...
### Step 6: Node 9740 (Seq Scan) - LEAF
...
### Step 7: Node 9726 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 9721, 9722, 9727, 9728, 9729, 9730, 9733, 9734, 9735, 9736, 9737, 9739
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=2338
  - HashJoin_nt1=58459
...
### Step 10: Node 9723 (Gather Merge)
...
### Step 11: Node 9721 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 9722, 9726, 9727, 9728, 9729, 9730, 9733, 9734, 9735, 9736, 9737, 9739
- **Input Features:**
