...
Node 16237 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 16238 (Gather Merge) [consumed]
    Node 16239 (Sort)
      Node 16240 (Hash Join) [PATTERN: 2e0f44ef]
        Node 16241 (Nested Loop) [consumed]
          Node 16242 (Hash Join) [PATTERN: 2e0f44ef]
            Node 16243 (Nested Loop) [consumed]
              Node 16244 (Hash Join) [PATTERN: 895c6e8c]
                Node 16245 (Seq Scan) [consumed] - LEAF
                Node 16246 (Hash) [consumed]
                  Node 16247 (Hash Join)
                    Node 16248 (Seq Scan) - LEAF
                    Node 16249 (Hash) [PATTERN: a54055ce]
                      Node 16250 (Hash Join) [consumed]
                        Node 16251 (Seq Scan) [consumed] - LEAF
                        Node 16252 (Hash) [consumed]
                          Node 16253 (Seq Scan) [consumed] - LEAF
              Node 16254 (Index Scan) - LEAF
            Node 16255 (Hash) [consumed]
              Node 16256 (Seq Scan) - LEAF
          Node 16257 (Index Scan) - LEAF
        Node 16258 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 16249 | 16237, 16238, 16240, 16241, 16242, 16243, 16244, 16245, 16246, 16250, 16251, 16252, 16253, 16255, 16258 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 16244 | 16237, 16238, 16240, 16241, 16242, 16243, 16245, 16246, 16249, 16250, 16251, 16252, 16253, 16255, 16258 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 16240 | 16237, 16238, 16241, 16242, 16243, 16244, 16245, 16246, 16249, 16250, 16251, 16252, 16253, 16255, 16258 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 16242 | 16237, 16238, 16240, 16241, 16243, 16244, 16245, 16246, 16249, 16250, 16251, 16252, 16253, 16255, 16258 |
| Aggregate -> Gather Merge (Out | 2724c080 | 16237 | 16238, 16240, 16241, 16242, 16243, 16244, 16245, 16246, 16249, 16250, 16251, 16252, 16253, 16255, 16258 |
...
| 16239 | Sort | 1191.23 | 1096.02 | 8.0% | operator |
| 16240 | Hash Join | 1190.96 | 1199.17 | 0.7% | pattern |
| 16242 | Hash Join | 1187.04 | 1192.79 | 0.5% | pattern |
| 16257 | Index Scan | 0.01 | 0.05 | 924.2% | operator |
| 16259 | Seq Scan | 0.01 | 7.19 | 51289.1% | operator |
| 16244 | Hash Join | 207.51 | 260.30 | 25.4% | pattern |
| 16254 | Index Scan | 0.04 | 0.09 | 112.3% | operator |
| 16256 | Seq Scan | 35.39 | 44.47 | 25.7% | operator |
| 16247 | Hash Join | 31.48 | 67.79 | 115.3% | operator |
| 16248 | Seq Scan | 29.99 | 24.87 | 17.1% | operator |
| 16249 | Hash | 0.19 | 0.20 | 5.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 16248 (Seq Scan) - LEAF
...
### Step 2: Node 16249 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 16237, 16238, 16240, 16241, 16242, 16243, 16244, 16245, 16246, 16250, 16251, 16252, 16253, 16255, 16258
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 4: Node 16244 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 16237, 16238, 16240, 16241, 16242, 16243, 16245, 16246, 16249, 16250, 16251, 16252, 16253, 16255, 16258
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=29497
  - HashJoin_nt1=147487
...
### Step 5: Node 16254 (Index Scan) - LEAF
...
### Step 6: Node 16256 (Seq Scan) - LEAF
...
### Step 7: Node 16242 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 16237, 16238, 16240, 16241, 16243, 16244, 16245, 16246, 16249, 16250, 16251, 16252, 16253, 16255, 16258
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=824
  - HashJoin_nt1=118013
  ...
  - HashJoin_reltuples=0.0000
  - HashJoin_sel=0.0000
  - HashJoin_startup_cost=9920.4600
  - HashJoin_total_cost=70271.9400
  - Hash_Inner_np=0
  - Hash_Inner_nt=582
  - Hash_Inner_nt1=582
  - Hash_Inner_nt2=0
...
- **Output:** st=80.08, rt=1192.79

### Step 8: Node 16257 (Index Scan) - LEAF
...
### Step 9: Node 16259 (Seq Scan) - LEAF
...
### Step 10: Node 16240 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 16237, 16238, 16241, 16242, 16243, 16244, 16245, 16246, 16249, 16250, 16251, 16252, 16253, 16255, 16258
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=824
  - HashJoin_nt1=824
  ...
  - HashJoin_reltuples=0.0000
  - HashJoin_sel=0.0400
  - HashJoin_startup_cost=9922.3100
  - HashJoin_total_cost=70527.3900
  - Hash_Inner_np=0
  - Hash_Inner_nt=25
  - Hash_Inner_nt1=25
  - Hash_Inner_nt2=0
  ...
  - NestedLoop_Outer_np=0
  - NestedLoop_Outer_nt=824
  - NestedLoop_Outer_nt1=824
  - NestedLoop_Outer_nt2=1
  - NestedLoop_Outer_parallel_workers=0
  - NestedLoop_Outer_plan_width=20
  - NestedLoop_Outer_reltuples=0.0000
  - NestedLoop_Outer_sel=1.0000
  - NestedLoop_Outer_startup_cost=9920.7500
  - NestedLoop_Outer_total_cost=70521.2400
- **Output:** st=80.31, rt=1199.17

### Step 11: Node 16239 (Sort)
...
### Step 12: Node 16237 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 16238, 16240, 16241, 16242, 16243, 16244, 16245, 16246, 16249, 16250, 16251, 16252, 16253, 16255, 16258
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2554
