...
```
Node 16237 (Aggregate) [PATTERN: 53f9aa07] - ROOT
  Node 16238 (Gather Merge) [consumed]
    Node 16239 (Sort) [consumed]
      Node 16240 (Hash Join) [consumed]
        Node 16241 (Nested Loop) [consumed]
          Node 16242 (Hash Join)
            Node 16243 (Nested Loop) [PATTERN: bd9dfa7b]
              Node 16244 (Hash Join) [consumed]
              ...
              Node 16254 (Index Scan) [consumed] - LEAF
            Node 16255 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 53f9aa07 | 16237 | 16238, 16239, 16240, 16241, 16243, 16244, 16245, 16246, 16247, 16249, 16250, 16251, 16252, 16253, 16254, 16258 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 16249 | 16237, 16238, 16239, 16240, 16241, 16243, 16244, 16245, 16246, 16247, 16250, 16251, 16252, 16253, 16254, 16258 |
| Nested Loop -> [Hash Join -> [ | bd9dfa7b | 16243 | 16237, 16238, 16239, 16240, 16241, 16244, 16245, 16246, 16247, 16249, 16250, 16251, 16252, 16253, 16254, 16258 |
...
|------|------|--------|-----------|-----|--------|
| 16237 | Aggregate | 1197.68 | 1220.45 | 1.9% | pattern |
| 16242 | Hash Join | 1187.04 | 1042.87 | 12.1% | operator |
| 16257 | Index Scan | 0.01 | 0.05 | 924.2% | operator |
| 16259 | Seq Scan | 0.01 | 7.19 | 51289.1% | operator |
| 16243 | Nested Loop | 1146.95 | 1155.06 | 0.7% | pattern |
...
- **Consumes:** Nodes 16237, 16238, 16239, 16240, 16241, 16243, 16244, 16245, 16246, 16247, 16250, 16251, 16252, 16253, 16254, 16258
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 3: Node 16256 (Seq Scan) - LEAF
...
### Step 4: Node 16243 (Nested Loop) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bd9dfa7b (Nested Loop -> [Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer), Index Scan (Inner)])
- **Consumes:** Nodes 16237, 16238, 16239, 16240, 16241, 16244, 16245, 16246, 16247, 16249, 16250, 16251, 16252, 16253, 16254, 16258
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 7: Node 16257 (Index Scan) - LEAF
...
### Step 8: Node 16259 (Seq Scan) - LEAF
...
### Step 9: Node 16237 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 53f9aa07 (Aggregate -> Gather Merge -> Sort -> Hash Join -> [Nested Loop (Outer), Hash (Inner)] (Outer) (Outer) (Outer))
- **Consumes:** Nodes 16238, 16239, 16240, 16241, 16243, 16244, 16245, 16246, 16247, 16249, 16250, 16251, 16252, 16253, 16254, 16258
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2554
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=824
  - HashJoin_Outer_nt1=824
  - HashJoin_Outer_nt2=25
  - HashJoin_Outer_parallel_workers=0
  - HashJoin_Outer_plan_width=148
  - HashJoin_Outer_reltuples=0.0000
  - HashJoin_Outer_sel=0.0400
  - HashJoin_Outer_startup_cost=9922.3100
  - HashJoin_Outer_total_cost=70527.3900
  - Hash_Inner_np=0
  - Hash_Inner_nt=25
  - Hash_Inner_nt1=25
  - Hash_Inner_nt2=0
  ...
  - Sort_Outer_startup_cost=70567.3000
  - Sort_Outer_total_cost=70569.3600
- **Output:** st=1219.08, rt=1220.45
