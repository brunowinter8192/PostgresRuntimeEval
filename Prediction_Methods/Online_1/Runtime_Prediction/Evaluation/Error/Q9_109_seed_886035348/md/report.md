...
```
Node 16814 (Sort) [PATTERN: 76ab422a] - ROOT
    ...
    Node 16816 (Gather) [consumed]
      Node 16817 (Aggregate) [consumed]
        Node 16818 (Nested Loop) [consumed]
          ...
          Node 16831 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather -> | 76ab422a | 16814 | 16815, 16816, 16817, 16818, 16819, 16820, 16821, 16822, 16823, 16824, 16827, 16829, 16830, 16831 |
...
|------|------|--------|-----------|-----|--------|
| 16814 | Sort | 1253.92 | 1195.01 | 4.7% | pattern |
...
### Step 4: Node 16814 (Sort) - PATTERN ROOT
...
- **Consumes:** Nodes 16815, 16816, 16817, 16818, 16819, 16820, 16821, 16822, 16823, 16824, 16827, 16829, 16830, 16831
- **Input Features:**
