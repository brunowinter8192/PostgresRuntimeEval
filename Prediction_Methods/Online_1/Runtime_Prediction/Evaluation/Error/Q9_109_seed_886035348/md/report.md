...
```
Node 16814 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 16815 (Aggregate) [consumed]
    Node 16816 (Gather)
      Node 16817 (Aggregate)
        Node 16818 (Nested Loop)
          Node 16819 (Hash Join) [PATTERN: 895c6e8c]
            Node 16820 (Seq Scan) [consumed] - LEAF
            Node 16821 (Hash) [consumed]
              Node 16822 (Hash Join) [PATTERN: 7a51ce50]
                Node 16823 (Hash Join) [consumed]
                  Node 16824 (Nested Loop) [consumed]
                    Node 16825 (Seq Scan) [consumed] - LEAF
                    Node 16826 (Index Scan) [consumed] - LEAF
                  Node 16827 (Hash) [consumed]
                    Node 16828 (Seq Scan) [consumed] - LEAF
                Node 16829 (Hash) [consumed]
                  Node 16830 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Hash Join -> [Hash Join -> [Ne | 7a51ce50 | 16822 | 16814, 16815, 16819, 16820, 16821, 16823, 16824, 16825, 16826, 16827, 16828, 16829, 16830 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 16819 | 16814, 16815, 16820, 16821, 16822, 16823, 16824, 16825, 16826, 16827, 16828, 16829, 16830 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 16814 | 16815, 16819, 16820, 16821, 16822, 16823, 16824, 16825, 16826, 16827, 16828, 16829, 16830 |
...
|------|------|--------|-----------|-----|--------|
| 16814 | Sort | 1253.92 | 1114.54 | 11.1% | pattern |
| 16816 | Gather | 1252.76 | 1114.85 | 11.0% | operator |
| 16817 | Aggregate | 1232.77 | 1170.17 | 5.1% | operator |
| 16818 | Nested Loop | 1209.01 | 1171.35 | 3.1% | operator |
| 16819 | Hash Join | 1039.55 | 732.93 | 29.5% | pattern |
| 16831 | Index Scan | 0.00 | -0.04 | 1512.7% | operator |
| 16822 | Hash Join | 171.80 | 546.27 | 218.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 16822 (Hash Join) - PATTERN ROOT
...
- **Consumes:** Nodes 16814, 16815, 16819, 16820, 16821, 16823, 16824, 16825, 16826, 16827, 16828, 16829, 16830
- **Input Features:**
  - HashJoin_Outer_np=0
  ...
  - HashJoin_Outer_total_cost=13966.7100
  - HashJoin_np=0
  - HashJoin_nt=14697
  - HashJoin_nt1=14697
  - HashJoin_nt2=25
  ...
  - HashJoin_total_cost=14013.3900
  - Hash_Inner_np=0
  - Hash_Inner_nt=10000
  ...
  - IndexScan_Inner_total_cost=2.2200
...
- **Output:** st=18.59, rt=546.27

### Step 2: Node 16819 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 16814, 16815, 16820, 16821, 16822, 16823, 16824, 16825, 16826, 16827, 16828, 16829, 16830
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=52919
...
### Step 3: Node 16831 (Index Scan) - LEAF
...
### Step 7: Node 16814 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 16815, 16819, 16820, 16821, 16822, 16823, 16824, 16825, 16826, 16827, 16828, 16829, 16830
- **Input Features:**
