...
```
Node 30868 (Limit) [PATTERN: 0aa5463f] - ROOT
    ...
    Node 30870 (Aggregate) [consumed]
      Node 30871 (Gather Merge) [consumed]
        Node 30872 (Incremental Sort) [consumed]
          Node 30873 (Nested Loop) [consumed]
            Node 30874 (Merge Join) [consumed]
              Node 30875 (Sort)
            ...
            Node 30883 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 0aa5463f | 30868 | 30869, 30870, 30871, 30872, 30873, 30874, 30876, 30877, 30878, 30883 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30876 | 30868, 30869, 30870, 30871, 30872, 30873, 30874, 30877, 30878, 30883 |
...
- **Consumes:** Nodes 30868, 30869, 30870, 30871, 30872, 30873, 30874, 30877, 30878, 30883
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 7: Node 30868 (Limit) - PATTERN ROOT
...
- **Consumes:** Nodes 30869, 30870, 30871, 30872, 30873, 30874, 30876, 30877, 30878, 30883
- **Input Features:**
