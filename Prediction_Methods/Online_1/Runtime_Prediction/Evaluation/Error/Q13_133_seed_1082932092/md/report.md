...
Node 25622 (Sort) [PATTERN: 35ffb644] - ROOT
  Node 25623 (Aggregate) [consumed]
    Node 25624 (Aggregate) [consumed]
      Node 25625 (Hash Join)
        Node 25626 (Seq Scan) - LEAF
        Node 25627 (Hash)
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Aggregate | 35ffb644 | 25622 | 25623, 25624 |
...
| 25625 | Hash Join | 711.27 | 705.78 | 0.8% | operator |
| 25626 | Seq Scan | 503.64 | 412.35 | 18.1% | operator |
| 25627 | Hash | 15.38 | 37.64 | 144.7% | operator |
...
### Step 2: Node 25626 (Seq Scan) - LEAF
...
### Step 5: Node 25622 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 35ffb644 (Sort -> Aggregate -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 25623, 25624
- **Input Features:**
