              ...
              Node 9548 (Hash Join) [PATTERN: 895c6e8c]
                ...
                Node 9550 (Hash) [consumed]
                  Node 9551 (Hash Join)
                    ...
                    Node 9553 (Hash) [PATTERN: a54055ce]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 9553 | 9541, 9542, 9546, 9547, 9548, 9549, 9550, 9554, 9555, 9556, 9557, 9559 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 9548 | 9541, 9542, 9546, 9547, 9549, 9550, 9553, 9554, 9555, 9556, 9557, 9559 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 9546 | 9541, 9542, 9547, 9548, 9549, 9550, 9553, 9554, 9555, 9556, 9557, 9559 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 9541 | 9542, 9546, 9547, 9548, 9549, 9550, 9553, 9554, 9555, 9556, 9557, 9559 |
...
| 9551 | Hash Join | 37.32 | 62.70 | 68.0% | operator |
| 9552 | Seq Scan | 35.82 | 24.87 | 30.6% | operator |
| 9553 | Hash | 0.14 | 0.14 | 5.4% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 9552 (Seq Scan) - LEAF
...
### Step 2: Node 9553 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 9541, 9542, 9546, 9547, 9548, 9549, 9550, 9554, 9555, 9556, 9557, 9559
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 4: Node 9548 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 9541, 9542, 9546, 9547, 9549, 9550, 9553, 9554, 9555, 9556, 9557, 9559
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14884
  - HashJoin_nt1=74418
...
### Step 5: Node 9558 (Index Scan) - LEAF
...
### Step 6: Node 9560 (Seq Scan) - LEAF
...
### Step 7: Node 9546 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 9541, 9542, 9547, 9548, 9549, 9550, 9553, 9554, 9555, 9556, 9557, 9559
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=2382
  - HashJoin_nt1=59546
...
### Step 10: Node 9543 (Gather Merge)
...
### Step 11: Node 9541 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 9542, 9546, 9547, 9548, 9549, 9550, 9553, 9554, 9555, 9556, 9557, 9559
- **Input Features:**
