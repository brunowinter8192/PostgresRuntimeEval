...
Node 27316 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27317 (Gather) [consumed]
    Node 27318 (Aggregate) [consumed]
      Node 27319 (Hash Join) [PATTERN: f4cb205a]
        Node 27320 (Seq Scan) [consumed] - LEAF
        Node 27321 (Hash) [consumed]
          Node 27322 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 27319 | 27316, 27317, 27318, 27320, 27321, 27322 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27316 | 27317, 27318, 27319, 27320, 27321, 27322 |
...
| 27319 | Hash Join | 791.32 | 397.11 | 49.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27319 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 27316, 27317, 27318, 27320, 27321, 27322
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=15275
  - HashJoin_nt1=15275
  ...
  - HashJoin_total_cost=136646.7400
  - Hash_Inner_np=0
  - Hash_Inner_nt=83333
...
- **Output:** st=44.61, rt=397.11

### Step 2: Node 27316 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27317, 27318, 27319, 27320, 27321, 27322
- **Input Features:**
