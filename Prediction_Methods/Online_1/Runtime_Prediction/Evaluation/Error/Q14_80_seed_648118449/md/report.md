...
```
Node 27316 (Aggregate) [PATTERN: f8295d8b] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 27316 | 27317, 27318, 27319, 27320, 27321, 27322 |
...
|------|------|--------|-----------|-----|--------|
| 27316 | Aggregate | 814.96 | 822.71 | 1.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27316 (Aggregate) - PATTERN ROOT
