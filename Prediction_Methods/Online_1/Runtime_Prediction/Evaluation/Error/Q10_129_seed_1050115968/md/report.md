  ...
  Node 19774 (Sort) [consumed]
    Node 19775 (Aggregate) [consumed]
      Node 19776 (Gather) [consumed]
        Node 19777 (Hash Join) [PATTERN: 7a51ce50]
          Node 19778 (Hash Join) [consumed]
            Node 19779 (Nested Loop) [consumed]
              Node 19780 (Seq Scan) [consumed] - LEAF
              Node 19781 (Index Scan) [consumed] - LEAF
            Node 19782 (Hash) [consumed]
              Node 19783 (Seq Scan) [consumed] - LEAF
          Node 19784 (Hash) [consumed]
            Node 19785 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Hash Join -> [Ne | 7a51ce50 | 19777 | 19773, 19774, 19775, 19776, 19778, 19779, 19780, 19781, 19782, 19783, 19784, 19785 |
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19773 | 19774, 19775, 19776, 19777, 19778, 19779, 19780, 19781, 19782, 19783, 19784, 19785 |
...
| 19777 | Hash Join | 1090.15 | 730.68 | 33.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 19777 (Hash Join) - PATTERN ROOT
...
- **Consumes:** Nodes 19773, 19774, 19775, 19776, 19778, 19779, 19780, 19781, 19782, 19783, 19784, 19785
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 2: Node 19773 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19774, 19775, 19776, 19777, 19778, 19779, 19780, 19781, 19782, 19783, 19784, 19785
- **Input Features:**
