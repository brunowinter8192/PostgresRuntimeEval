...
```
Node 26952 (Aggregate) [PATTERN: f8295d8b] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 26952 | 26953, 26954, 26955, 26956, 26957, 26958 |
...
|------|------|--------|-----------|-----|--------|
| 26952 | Aggregate | 805.90 | 822.60 | 2.1% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26952 (Aggregate) - PATTERN ROOT
