...
Node 26952 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26953 (Gather) [consumed]
    Node 26954 (Aggregate) [consumed]
      Node 26955 (Hash Join) [PATTERN: f4cb205a]
        Node 26956 (Seq Scan) [consumed] - LEAF
        Node 26957 (Hash) [consumed]
          Node 26958 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 26955 | 26952, 26953, 26954, 26956, 26957, 26958 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26952 | 26953, 26954, 26955, 26956, 26957, 26958 |
...
|------|------|--------|-----------|-----|--------|
| 26952 | Aggregate | 805.90 | 834.74 | 3.6% | pattern |
| 26955 | Hash Join | 783.69 | 396.93 | 49.4% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26955 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 26952, 26953, 26954, 26956, 26957, 26958
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=16090
  - HashJoin_nt1=16090
  ...
  - HashJoin_total_cost=136648.8800
  - Hash_Inner_np=0
  - Hash_Inner_nt=83333
...
- **Output:** st=44.53, rt=396.93

### Step 2: Node 26952 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26953, 26954, 26955, 26956, 26957, 26958
- **Input Features:**
