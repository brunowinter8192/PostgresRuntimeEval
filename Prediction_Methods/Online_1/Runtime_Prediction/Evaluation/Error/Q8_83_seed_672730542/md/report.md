...
```
Node 16214 (Aggregate) [PATTERN: 53f9aa07] - ROOT
  Node 16215 (Gather Merge) [consumed]
    Node 16216 (Sort) [consumed]
      Node 16217 (Hash Join) [consumed]
        Node 16218 (Nested Loop) [consumed]
          Node 16219 (Hash Join)
            Node 16220 (Nested Loop) [PATTERN: bd9dfa7b]
              Node 16221 (Hash Join) [consumed]
              ...
              Node 16231 (Index Scan) [consumed] - LEAF
            Node 16232 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 53f9aa07 | 16214 | 16215, 16216, 16217, 16218, 16220, 16221, 16222, 16223, 16224, 16226, 16227, 16228, 16229, 16230, 16231, 16235 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 16226 | 16214, 16215, 16216, 16217, 16218, 16220, 16221, 16222, 16223, 16224, 16227, 16228, 16229, 16230, 16231, 16235 |
| Nested Loop -> [Hash Join -> [ | bd9dfa7b | 16220 | 16214, 16215, 16216, 16217, 16218, 16221, 16222, 16223, 16224, 16226, 16227, 16228, 16229, 16230, 16231, 16235 |
...
|------|------|--------|-----------|-----|--------|
| 16214 | Aggregate | 1237.48 | 1220.60 | 1.4% | pattern |
| 16219 | Hash Join | 1225.29 | 1042.86 | 14.9% | operator |
| 16234 | Index Scan | 0.01 | 0.05 | 753.5% | operator |
| 16236 | Seq Scan | 0.02 | 7.19 | 44865.5% | operator |
| 16220 | Nested Loop | 1182.66 | 1155.06 | 2.3% | pattern |
...
- **Consumes:** Nodes 16214, 16215, 16216, 16217, 16218, 16220, 16221, 16222, 16223, 16224, 16227, 16228, 16229, 16230, 16231, 16235
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 3: Node 16233 (Seq Scan) - LEAF
...
### Step 4: Node 16220 (Nested Loop) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bd9dfa7b (Nested Loop -> [Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer), Index Scan (Inner)])
- **Consumes:** Nodes 16214, 16215, 16216, 16217, 16218, 16221, 16222, 16223, 16224, 16226, 16227, 16228, 16229, 16230, 16231, 16235
- **Input Features:**
  - HashJoin_Outer_np=0
...
- **Output:** st=78.68, rt=1042.86

### Step 7: Node 16234 (Index Scan) - LEAF
...
### Step 8: Node 16236 (Seq Scan) - LEAF
...
### Step 9: Node 16214 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 53f9aa07 (Aggregate -> Gather Merge -> Sort -> Hash Join -> [Nested Loop (Outer), Hash (Inner)] (Outer) (Outer) (Outer))
- **Consumes:** Nodes 16215, 16216, 16217, 16218, 16220, 16221, 16222, 16223, 16224, 16226, 16227, 16228, 16229, 16230, 16231, 16235
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2268
  - Aggregate_nt1=2268
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=732
  - HashJoin_Outer_nt1=732
  - HashJoin_Outer_nt2=25
  - HashJoin_Outer_parallel_workers=0
  - HashJoin_Outer_plan_width=148
  - HashJoin_Outer_reltuples=0.0000
  - HashJoin_Outer_sel=0.0400
  - HashJoin_Outer_startup_cost=9921.5000
  - HashJoin_Outer_total_cost=70498.2300
  - Hash_Inner_np=0
  - Hash_Inner_nt=25
  - Hash_Inner_nt1=25
  - Hash_Inner_nt2=0
  ...
  - Sort_Outer_startup_cost=70533.0600
  - Sort_Outer_total_cost=70534.8900
- **Output:** st=1219.25, rt=1220.60
