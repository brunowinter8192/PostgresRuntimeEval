...
```
Node 656 (Aggregate) [PATTERN: 3dfa6025] - ROOT
  Node 657 (Gather Merge) [consumed]
    Node 658 (Sort) [consumed]
      Node 659 (Aggregate) [consumed]
        Node 660 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 3dfa6025 | 656 | 657, 658, 659, 660 |
...
|------|------|--------|-----------|-----|--------|
| 656 | Aggregate | 995.76 | 953.98 | 4.2% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 656 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3dfa6025 (Aggregate -> Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 657, 658, 659, 660
- **Input Features:**
