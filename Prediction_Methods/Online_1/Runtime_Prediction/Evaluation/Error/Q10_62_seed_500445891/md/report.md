  ...
  Node 20775 (Sort) [consumed]
    Node 20776 (Aggregate) [consumed]
      Node 20777 (Gather) [consumed]
        Node 20778 (Hash Join) [PATTERN: 7a51ce50]
          Node 20779 (Hash Join) [consumed]
            Node 20780 (Nested Loop) [consumed]
              Node 20781 (Seq Scan) [consumed] - LEAF
              Node 20782 (Index Scan) [consumed] - LEAF
            Node 20783 (Hash) [consumed]
              Node 20784 (Seq Scan) [consumed] - LEAF
          Node 20785 (Hash) [consumed]
            Node 20786 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Hash Join -> [Ne | 7a51ce50 | 20778 | 20774, 20775, 20776, 20777, 20779, 20780, 20781, 20782, 20783, 20784, 20785, 20786 |
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20774 | 20775, 20776, 20777, 20778, 20779, 20780, 20781, 20782, 20783, 20784, 20785, 20786 |
...
| 20778 | Hash Join | 1116.31 | 730.67 | 34.5% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 20778 (Hash Join) - PATTERN ROOT
...
- **Consumes:** Nodes 20774, 20775, 20776, 20777, 20779, 20780, 20781, 20782, 20783, 20784, 20785, 20786
- **Input Features:**
  - HashJoin_Outer_np=0
  ...
  - HashJoin_Outer_total_cost=80807.0600
  - HashJoin_np=0
  - HashJoin_nt=18183
  - HashJoin_nt1=18183
  - HashJoin_nt2=25
  ...
  - HashJoin_total_cost=80864.4400
  - Hash_Inner_np=0
  - Hash_Inner_nt=62500
...
### Step 2: Node 20774 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20775, 20776, 20777, 20778, 20779, 20780, 20781, 20782, 20783, 20784, 20785, 20786
- **Input Features:**
