    ...
    Node 20776 (Aggregate) [consumed]
      Node 20777 (Gather) [consumed]
        Node 20778 (Hash Join) [consumed]
          Node 20779 (Hash Join) [PATTERN: 2873b8c3]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 20774 | 20775, 20776, 20777, 20778, 20779, 20780, 20781, 20782, 20783, 20784 |
| Hash Join -> [Nested Loop -> [ | 2873b8c3 | 20779 | 20774, 20775, 20776, 20777, 20778, 20780, 20781, 20782, 20783, 20784 |
...
### Step 2: Node 20779 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2873b8c3 (Hash Join -> [Nested Loop -> [Seq Scan (Outer), Index Scan (Inner)] (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 20774, 20775, 20776, 20777, 20778, 20780, 20781, 20782, 20783, 20784
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18183
  - HashJoin_nt1=18183
...
### Step 4: Node 20774 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20775, 20776, 20777, 20778, 20779, 20780, 20781, 20782, 20783, 20784
- **Input Features:**
