...
Node 25587 (Sort) [PATTERN: 35ffb644] - ROOT
  Node 25588 (Aggregate) [consumed]
    Node 25589 (Aggregate) [consumed]
      Node 25590 (Hash Join)
        Node 25591 (Seq Scan) - LEAF
        Node 25592 (Hash)
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Aggregate | 35ffb644 | 25587 | 25588, 25589 |
...
| 25590 | Hash Join | 688.50 | 705.41 | 2.5% | operator |
| 25591 | Seq Scan | 471.31 | 410.74 | 12.9% | operator |
| 25592 | Hash | 17.46 | 37.64 | 115.5% | operator |
...
### Step 2: Node 25591 (Seq Scan) - LEAF
...
### Step 5: Node 25587 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 35ffb644 (Sort -> Aggregate -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 25588, 25589
- **Input Features:**
