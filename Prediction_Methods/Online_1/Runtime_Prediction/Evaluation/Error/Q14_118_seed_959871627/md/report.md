...
```
Node 26553 (Aggregate) [PATTERN: f8295d8b] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 26553 | 26554, 26555, 26556, 26557, 26558, 26559 |
...
|------|------|--------|-----------|-----|--------|
| 26553 | Aggregate | 823.10 | 822.75 | 0.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26553 (Aggregate) - PATTERN ROOT
