...
Node 26966 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26967 (Gather) [consumed]
    Node 26968 (Aggregate) [consumed]
      Node 26969 (Hash Join) [PATTERN: f4cb205a]
        Node 26970 (Seq Scan) [consumed] - LEAF
        Node 26971 (Hash) [consumed]
          Node 26972 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 26969 | 26966, 26967, 26968, 26970, 26971, 26972 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26966 | 26967, 26968, 26969, 26970, 26971, 26972 |
...
| 26969 | Hash Join | 828.30 | 397.13 | 52.1% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26969 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 26966, 26967, 26968, 26970, 26971, 26972
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=15135
  - HashJoin_nt1=15135
  ...
  - HashJoin_total_cost=136646.3700
  - Hash_Inner_np=0
  - Hash_Inner_nt=83333
...
- **Output:** st=44.62, rt=397.13

### Step 2: Node 26966 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26967, 26968, 26969, 26970, 26971, 26972
- **Input Features:**
