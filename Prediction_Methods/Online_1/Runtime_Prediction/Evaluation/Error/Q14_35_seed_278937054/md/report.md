...
```
Node 26966 (Aggregate) [PATTERN: f8295d8b] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 26966 | 26967, 26968, 26969, 26970, 26971, 26972 |
...
|------|------|--------|-----------|-----|--------|
| 26966 | Aggregate | 849.78 | 822.73 | 3.2% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26966 (Aggregate) - PATTERN ROOT
