...
```
Node 6033 (Aggregate) [PATTERN: 80bd802d] - ROOT
  Node 6034 (Gather Merge) [consumed]
    Node 6035 (Sort) [consumed]
      Node 6036 (Aggregate) [consumed]
        Node 6037 (Nested Loop) [consumed]
          Node 6038 (Seq Scan) [consumed] - LEAF
          Node 6039 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 80bd802d | 6033 | 6034, 6035, 6036, 6037, 6038, 6039 |
...
|------|------|--------|-----------|-----|--------|
| 6033 | Aggregate | 1053.25 | 1057.79 | 0.4% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6033 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 6034, 6035, 6036, 6037, 6038, 6039
- **Input Features:**
  ...
  - NestedLoop_Outer_nt=15068
  - NestedLoop_Outer_nt1=18478
  ...
  - NestedLoop_Outer_total_cost=65993.2000
  - SeqScan_Outer_np=26136
  - SeqScan_Outer_nt=18478
  - SeqScan_Outer_nt1=0
  - SeqScan_Outer_nt2=0
