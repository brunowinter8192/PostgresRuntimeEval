...
```
Node 30036 (Limit) [PATTERN: 0aa5463f] - ROOT
    ...
    Node 30038 (Aggregate) [consumed]
      Node 30039 (Gather Merge) [consumed]
        Node 30040 (Incremental Sort) [consumed]
          Node 30041 (Nested Loop) [consumed]
            Node 30042 (Merge Join) [consumed]
              Node 30043 (Sort)
            ...
            Node 30051 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 0aa5463f | 30036 | 30037, 30038, 30039, 30040, 30041, 30042, 30044, 30045, 30046, 30051 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30044 | 30036, 30037, 30038, 30039, 30040, 30041, 30042, 30045, 30046, 30051 |
...
- **Consumes:** Nodes 30036, 30037, 30038, 30039, 30040, 30041, 30042, 30045, 30046, 30051
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 7: Node 30036 (Limit) - PATTERN ROOT
...
- **Consumes:** Nodes 30037, 30038, 30039, 30040, 30041, 30042, 30044, 30045, 30046, 30051
- **Input Features:**
