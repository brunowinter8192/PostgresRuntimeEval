...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4531 | 4532, 4533, 4534 |
...
| 4535 | Nested Loop | 1156.59 | 1121.08 | 3.1% | operator |
| 4536 | Hash Join | 205.18 | 231.05 | 12.6% | operator |
| 4540 | Index Scan | 0.03 | -0.02 | 171.3% | operator |
| 4537 | Seq Scan | 153.23 | 162.08 | 5.8% | operator |
| 4538 | Hash | 28.96 | 17.51 | 39.5% | operator |
...
### Step 2: Node 4537 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=37330.5500
- **Output:** st=28.99, rt=231.05

### Step 5: Node 4540 (Index Scan) - LEAF
...
- **Output:** st=29.61, rt=1121.08

### Step 7: Node 4531 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4532, 4533, 4534
- **Input Features:**
