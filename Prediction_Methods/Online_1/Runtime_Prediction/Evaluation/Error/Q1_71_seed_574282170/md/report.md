...
```
Node 591 (Aggregate) [PATTERN: 3dfa6025] - ROOT
  Node 592 (Gather Merge) [consumed]
    Node 593 (Sort) [consumed]
      Node 594 (Aggregate) [consumed]
        Node 595 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 3dfa6025 | 591 | 592, 593, 594, 595 |
...
|------|------|--------|-----------|-----|--------|
| 591 | Aggregate | 997.05 | 953.98 | 4.3% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 591 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3dfa6025 (Aggregate -> Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 592, 593, 594, 595
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=6
  - Aggregate_Outer_nt1=1184586
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=236
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=169063.5500
  - Aggregate_Outer_total_cost=169063.6800
  - Aggregate_np=0
  - Aggregate_nt=6
  - Aggregate_nt1=30
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=170063.8400
  - Aggregate_total_cost=170068.6100
  ...
  - GatherMerge_Outer_startup_cost=170063.8400
  - GatherMerge_Outer_total_cost=170067.4700
  - SeqScan_Outer_np=112600
  - SeqScan_Outer_nt=1184586
  - SeqScan_Outer_nt1=0
  - SeqScan_Outer_nt2=0
  - SeqScan_Outer_parallel_workers=0
  - SeqScan_Outer_plan_width=25
  - SeqScan_Outer_reltuples=6001215.0000
  - SeqScan_Outer_sel=0.1974
  ...
  - Sort_Outer_startup_cost=169063.7600
  - Sort_Outer_total_cost=169063.7800
