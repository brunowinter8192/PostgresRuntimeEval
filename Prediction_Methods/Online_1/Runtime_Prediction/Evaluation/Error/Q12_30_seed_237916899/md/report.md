...
```
Node 24831 (Aggregate) [PATTERN: f9c97829] - ROOT
  Node 24832 (Gather Merge) [consumed]
    Node 24833 (Aggregate) [consumed]
      Node 24834 (Sort) [consumed]
        Node 24835 (Nested Loop) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> A | f9c97829 | 24831 | 24832, 24833, 24834, 24835, 24836, 24837 |
...
|------|------|--------|-----------|-----|--------|
| 24831 | Aggregate | 1001.15 | 998.49 | 0.3% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24831 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 24832, 24833, 24834, 24835, 24836, 24837
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=7
  - Aggregate_Outer_nt1=5840
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=27
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0012
  - Aggregate_Outer_startup_cost=147596.9600
  - Aggregate_Outer_total_cost=147713.8300
  - Aggregate_np=0
  - Aggregate_nt=7
  - Aggregate_nt1=35
  - Aggregate_nt2=0
  ...
  - NestedLoop_Outer_nt=5840
  - NestedLoop_Outer_nt1=5840
  ...
  - NestedLoop_Outer_total_cost=147231.6100
  ...
  - Sort_Outer_startup_cost=147596.9600
  - Sort_Outer_total_cost=147611.5600
