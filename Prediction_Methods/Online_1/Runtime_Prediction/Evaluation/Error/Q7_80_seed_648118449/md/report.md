...
```
Node 12805 (Aggregate) - ROOT
  Node 12806 (Gather Merge)
    Node 12807 (Sort)
      Node 12808 (Hash Join)
        Node 12809 (Nested Loop)
          Node 12810 (Hash Join)
            Node 12811 (Seq Scan) - LEAF
            Node 12812 (Hash)
              Node 12813 (Hash Join)
                Node 12814 (Seq Scan) - LEAF
                Node 12815 (Hash)
                  Node 12816 (Seq Scan) - LEAF
          Node 12817 (Index Scan) - LEAF
        Node 12818 (Hash)
          Node 12819 (Hash Join)
            Node 12820 (Seq Scan) - LEAF
            Node 12821 (Hash)
              Node 12822 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12805 | Aggregate | 1212.40 | 1202.22 | 0.8% | operator |
| 12806 | Gather Merge | 1211.38 | 1148.45 | 5.2% | operator |
| 12807 | Sort | 1204.64 | 1149.87 | 4.5% | operator |
| 12808 | Hash Join | 1204.02 | 1130.50 | 6.1% | operator |
| 12809 | Nested Loop | 1195.68 | 1145.81 | 4.2% | operator |
| 12818 | Hash | 4.34 | 15.44 | 255.4% | operator |
| 12810 | Hash Join | 214.40 | 319.53 | 49.0% | operator |
| 12817 | Index Scan | 0.03 | 0.09 | 171.7% | operator |
| 12819 | Hash Join | 4.29 | 49.64 | 1056.0% | operator |
| 12811 | Seq Scan | 152.35 | 192.19 | 26.2% | operator |
| 12812 | Hash | 34.66 | 17.27 | 50.2% | operator |
| 12820 | Seq Scan | 3.96 | 10.62 | 168.3% | operator |
| 12821 | Hash | 0.01 | 14.54 | 111724.3% | operator |
| 12813 | Hash Join | 33.77 | 54.15 | 60.3% | operator |
| 12822 | Seq Scan | 0.01 | 7.20 | 65317.7% | operator |
| 12814 | Seq Scan | 32.66 | 24.87 | 23.8% | operator |
| 12815 | Hash | 0.01 | 14.54 | 132056.0% | operator |
| 12816 | Seq Scan | 0.01 | 7.20 | 79855.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12816 (Seq Scan) - LEAF
...
### Step 2: Node 12814 (Seq Scan) - LEAF
...
### Step 5: Node 12822 (Seq Scan) - LEAF
...
### Step 6: Node 12811 (Seq Scan) - LEAF
...
### Step 8: Node 12820 (Seq Scan) - LEAF
...
### Step 11: Node 12817 (Index Scan) - LEAF
...
### Step 13: Node 12809 (Nested Loop)
...
### Step 17: Node 12806 (Gather Merge)
...
### Step 18: Node 12805 (Aggregate) - ROOT
