...
```
Node 30852 (Limit) [PATTERN: 0aa5463f] - ROOT
    ...
    Node 30854 (Aggregate) [consumed]
      Node 30855 (Gather Merge) [consumed]
        Node 30856 (Incremental Sort) [consumed]
          Node 30857 (Nested Loop) [consumed]
            Node 30858 (Merge Join) [consumed]
              Node 30859 (Sort)
            ...
            Node 30867 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 0aa5463f | 30852 | 30853, 30854, 30855, 30856, 30857, 30858, 30860, 30861, 30862, 30867 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30860 | 30852, 30853, 30854, 30855, 30856, 30857, 30858, 30861, 30862, 30867 |
...
- **Consumes:** Nodes 30852, 30853, 30854, 30855, 30856, 30857, 30858, 30861, 30862, 30867
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 7: Node 30852 (Limit) - PATTERN ROOT
...
- **Consumes:** Nodes 30853, 30854, 30855, 30856, 30857, 30858, 30860, 30861, 30862, 30867
- **Input Features:**
