...
```
Node 6166 (Aggregate) [PATTERN: 80bd802d] - ROOT
  Node 6167 (Gather Merge) [consumed]
    Node 6168 (Sort) [consumed]
      Node 6169 (Aggregate) [consumed]
        Node 6170 (Nested Loop) [consumed]
          Node 6171 (Seq Scan) [consumed] - LEAF
          Node 6172 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 80bd802d | 6166 | 6167, 6168, 6169, 6170, 6171, 6172 |
...
|------|------|--------|-----------|-----|--------|
| 6166 | Aggregate | 1087.77 | 1057.79 | 2.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6166 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 6167, 6168, 6169, 6170, 6171, 6172
- **Input Features:**
