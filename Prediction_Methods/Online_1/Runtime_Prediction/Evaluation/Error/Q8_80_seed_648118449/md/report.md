...
```
Node 16145 (Aggregate) [PATTERN: 53f9aa07] - ROOT
  Node 16146 (Gather Merge) [consumed]
    Node 16147 (Sort) [consumed]
      Node 16148 (Hash Join) [consumed]
        Node 16149 (Nested Loop) [consumed]
          Node 16150 (Hash Join)
            Node 16151 (Nested Loop) [PATTERN: bd9dfa7b]
              Node 16152 (Hash Join) [consumed]
              ...
              Node 16162 (Index Scan) [consumed] - LEAF
            Node 16163 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 53f9aa07 | 16145 | 16146, 16147, 16148, 16149, 16151, 16152, 16153, 16154, 16155, 16157, 16158, 16159, 16160, 16161, 16162, 16166 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 16157 | 16145, 16146, 16147, 16148, 16149, 16151, 16152, 16153, 16154, 16155, 16158, 16159, 16160, 16161, 16162, 16166 |
| Nested Loop -> [Hash Join -> [ | bd9dfa7b | 16151 | 16145, 16146, 16147, 16148, 16149, 16152, 16153, 16154, 16155, 16157, 16158, 16159, 16160, 16161, 16162, 16166 |
...
|------|------|--------|-----------|-----|--------|
| 16145 | Aggregate | 1199.43 | 1220.54 | 1.8% | pattern |
| 16150 | Hash Join | 1189.13 | 1042.86 | 12.3% | operator |
| 16165 | Index Scan | 0.01 | 0.05 | 753.5% | operator |
| 16167 | Seq Scan | 0.01 | 7.19 | 55242.1% | operator |
| 16151 | Nested Loop | 1142.03 | 1155.06 | 1.1% | pattern |
...
- **Consumes:** Nodes 16145, 16146, 16147, 16148, 16149, 16151, 16152, 16153, 16154, 16155, 16158, 16159, 16160, 16161, 16162, 16166
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 3: Node 16164 (Seq Scan) - LEAF
...
### Step 4: Node 16151 (Nested Loop) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bd9dfa7b (Nested Loop -> [Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer), Index Scan (Inner)])
- **Consumes:** Nodes 16145, 16146, 16147, 16148, 16149, 16152, 16153, 16154, 16155, 16157, 16158, 16159, 16160, 16161, 16162, 16166
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 7: Node 16165 (Index Scan) - LEAF
...
### Step 8: Node 16167 (Seq Scan) - LEAF
...
### Step 9: Node 16145 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 53f9aa07 (Aggregate -> Gather Merge -> Sort -> Hash Join -> [Nested Loop (Outer), Hash (Inner)] (Outer) (Outer) (Outer))
- **Consumes:** Nodes 16146, 16147, 16148, 16149, 16151, 16152, 16153, 16154, 16155, 16157, 16158, 16159, 16160, 16161, 16162, 16166
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2383
  - Aggregate_nt1=2383
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=769
  - HashJoin_Outer_nt1=769
  - HashJoin_Outer_nt2=25
  - HashJoin_Outer_parallel_workers=0
  - HashJoin_Outer_plan_width=148
  - HashJoin_Outer_reltuples=0.0000
  - HashJoin_Outer_sel=0.0400
  - HashJoin_Outer_startup_cost=9921.8200
  - HashJoin_Outer_total_cost=70509.9600
  - Hash_Inner_np=0
  - Hash_Inner_nt=25
  - Hash_Inner_nt1=25
  - Hash_Inner_nt2=0
  ...
  - Sort_Outer_startup_cost=70546.8200
  - Sort_Outer_total_cost=70548.7400
- **Output:** st=1219.18, rt=1220.54
