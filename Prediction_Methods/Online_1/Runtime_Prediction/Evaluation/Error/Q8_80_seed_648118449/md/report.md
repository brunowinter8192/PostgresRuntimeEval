...
Node 16145 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 16146 (Gather Merge) [consumed]
    Node 16147 (Sort)
      Node 16148 (Hash Join) [PATTERN: 2e0f44ef]
        Node 16149 (Nested Loop) [consumed]
          Node 16150 (Hash Join) [PATTERN: 2e0f44ef]
            Node 16151 (Nested Loop) [consumed]
              Node 16152 (Hash Join) [PATTERN: 895c6e8c]
                Node 16153 (Seq Scan) [consumed] - LEAF
                Node 16154 (Hash) [consumed]
                  Node 16155 (Hash Join)
                    Node 16156 (Seq Scan) - LEAF
                    Node 16157 (Hash) [PATTERN: a54055ce]
                      Node 16158 (Hash Join) [consumed]
                        Node 16159 (Seq Scan) [consumed] - LEAF
                        Node 16160 (Hash) [consumed]
                          Node 16161 (Seq Scan) [consumed] - LEAF
              Node 16162 (Index Scan) - LEAF
            Node 16163 (Hash) [consumed]
              Node 16164 (Seq Scan) - LEAF
          Node 16165 (Index Scan) - LEAF
        Node 16166 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 16157 | 16145, 16146, 16148, 16149, 16150, 16151, 16152, 16153, 16154, 16158, 16159, 16160, 16161, 16163, 16166 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 16152 | 16145, 16146, 16148, 16149, 16150, 16151, 16153, 16154, 16157, 16158, 16159, 16160, 16161, 16163, 16166 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 16148 | 16145, 16146, 16149, 16150, 16151, 16152, 16153, 16154, 16157, 16158, 16159, 16160, 16161, 16163, 16166 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 16150 | 16145, 16146, 16148, 16149, 16151, 16152, 16153, 16154, 16157, 16158, 16159, 16160, 16161, 16163, 16166 |
| Aggregate -> Gather Merge (Out | 2724c080 | 16145 | 16146, 16148, 16149, 16150, 16151, 16152, 16153, 16154, 16157, 16158, 16159, 16160, 16161, 16163, 16166 |
...
| 16147 | Sort | 1193.39 | 1096.01 | 8.2% | operator |
| 16148 | Hash Join | 1193.16 | 1199.17 | 0.5% | pattern |
| 16150 | Hash Join | 1189.13 | 1192.83 | 0.3% | pattern |
| 16165 | Index Scan | 0.01 | 0.05 | 753.5% | operator |
| 16167 | Seq Scan | 0.01 | 7.19 | 55242.1% | operator |
| 16152 | Hash Join | 208.37 | 260.30 | 24.9% | pattern |
| 16162 | Index Scan | 0.04 | 0.09 | 112.3% | operator |
| 16164 | Seq Scan | 42.65 | 44.49 | 4.3% | operator |
| 16155 | Hash Join | 32.46 | 67.79 | 108.9% | operator |
| 16156 | Seq Scan | 30.90 | 24.87 | 19.5% | operator |
| 16157 | Hash | 0.24 | 0.20 | 18.3% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 16156 (Seq Scan) - LEAF
...
### Step 2: Node 16157 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 16145, 16146, 16148, 16149, 16150, 16151, 16152, 16153, 16154, 16158, 16159, 16160, 16161, 16163, 16166
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 4: Node 16152 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 16145, 16146, 16148, 16149, 16150, 16151, 16153, 16154, 16157, 16158, 16159, 16160, 16161, 16163, 16166
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=29497
  - HashJoin_nt1=147487
...
### Step 5: Node 16162 (Index Scan) - LEAF
...
### Step 6: Node 16164 (Seq Scan) - LEAF
...
### Step 7: Node 16150 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 16145, 16146, 16148, 16149, 16151, 16152, 16153, 16154, 16157, 16158, 16159, 16160, 16161, 16163, 16166
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=769
  - HashJoin_nt1=118013
  ...
  - HashJoin_reltuples=0.0000
  - HashJoin_sel=0.0000
  - HashJoin_startup_cost=9919.9800
  - HashJoin_total_cost=70271.4500
  - Hash_Inner_np=0
  - Hash_Inner_nt=543
  - Hash_Inner_nt1=543
  - Hash_Inner_nt2=0
...
### Step 8: Node 16165 (Index Scan) - LEAF
...
### Step 9: Node 16167 (Seq Scan) - LEAF
...
### Step 10: Node 16148 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 16145, 16146, 16149, 16150, 16151, 16152, 16153, 16154, 16157, 16158, 16159, 16160, 16161, 16163, 16166
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=769
  - HashJoin_nt1=769
  ...
  - HashJoin_reltuples=0.0000
  - HashJoin_sel=0.0400
  - HashJoin_startup_cost=9921.8200
  - HashJoin_total_cost=70509.9600
  - Hash_Inner_np=0
  - Hash_Inner_nt=25
  - Hash_Inner_nt1=25
  - Hash_Inner_nt2=0
  ...
  - NestedLoop_Outer_np=0
  - NestedLoop_Outer_nt=769
  - NestedLoop_Outer_nt1=769
  - NestedLoop_Outer_nt2=1
  - NestedLoop_Outer_parallel_workers=0
  - NestedLoop_Outer_plan_width=20
  - NestedLoop_Outer_reltuples=0.0000
  - NestedLoop_Outer_sel=1.0000
  - NestedLoop_Outer_startup_cost=9920.2600
  - NestedLoop_Outer_total_cost=70504.1100
- **Output:** st=80.32, rt=1199.17

### Step 11: Node 16147 (Sort)
...
### Step 12: Node 16145 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 16146, 16148, 16149, 16150, 16151, 16152, 16153, 16154, 16157, 16158, 16159, 16160, 16161, 16163, 16166
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2383
  - Aggregate_nt1=2383
