...
```
Node 19207 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 19208 (Aggregate) [consumed]
    Node 19209 (Gather)
      Node 19210 (Aggregate)
        Node 19211 (Nested Loop)
          Node 19212 (Hash Join) [PATTERN: 895c6e8c]
            Node 19213 (Seq Scan) [consumed] - LEAF
            Node 19214 (Hash) [consumed]
              Node 19215 (Hash Join) [PATTERN: 7a51ce50]
                Node 19216 (Hash Join) [consumed]
                  Node 19217 (Nested Loop) [consumed]
                    Node 19218 (Seq Scan) [consumed] - LEAF
                    Node 19219 (Index Scan) [consumed] - LEAF
                  Node 19220 (Hash) [consumed]
                    Node 19221 (Seq Scan) [consumed] - LEAF
                Node 19222 (Hash) [consumed]
                  Node 19223 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Hash Join -> [Hash Join -> [Ne | 7a51ce50 | 19215 | 19207, 19208, 19212, 19213, 19214, 19216, 19217, 19218, 19219, 19220, 19221, 19222, 19223 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 19212 | 19207, 19208, 19213, 19214, 19215, 19216, 19217, 19218, 19219, 19220, 19221, 19222, 19223 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 19207 | 19208, 19212, 19213, 19214, 19215, 19216, 19217, 19218, 19219, 19220, 19221, 19222, 19223 |
...
|------|------|--------|-----------|-----|--------|
| 19207 | Sort | 1195.21 | 1115.82 | 6.6% | pattern |
| 19209 | Gather | 1193.74 | 1135.98 | 4.8% | operator |
| 19210 | Aggregate | 1174.77 | 1152.73 | 1.9% | operator |
| 19211 | Nested Loop | 1150.11 | 1179.58 | 2.6% | operator |
| 19212 | Hash Join | 977.87 | 733.84 | 25.0% | pattern |
| 19224 | Index Scan | 0.00 | -0.04 | 1512.7% | operator |
| 19215 | Hash Join | 179.07 | 546.08 | 205.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 19215 (Hash Join) - PATTERN ROOT
...
- **Consumes:** Nodes 19207, 19208, 19212, 19213, 19214, 19216, 19217, 19218, 19219, 19220, 19221, 19222, 19223
- **Input Features:**
  - HashJoin_Outer_np=0
  ...
  - HashJoin_Outer_total_cost=14737.7900
  - HashJoin_np=0
  - HashJoin_nt=18037
  - HashJoin_nt1=18037
  - HashJoin_nt2=25
  ...
  - HashJoin_total_cost=14794.7200
  - Hash_Inner_np=0
  - Hash_Inner_nt=10000
  ...
  - IndexScan_Inner_total_cost=1.9700
...
- **Output:** st=18.54, rt=546.08

### Step 2: Node 19212 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 19207, 19208, 19213, 19214, 19215, 19216, 19217, 19218, 19219, 19220, 19221, 19222, 19223
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=64945
...
### Step 3: Node 19224 (Index Scan) - LEAF
...
### Step 7: Node 19207 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 19208, 19212, 19213, 19214, 19215, 19216, 19217, 19218, 19219, 19220, 19221, 19222, 19223
- **Input Features:**
