    ...
    Node 20269 (Aggregate) [consumed]
      Node 20270 (Gather) [consumed]
        Node 20271 (Hash Join) [consumed]
          Node 20272 (Hash Join) [PATTERN: 2873b8c3]
            Node 20273 (Nested Loop) [consumed]
              Node 20274 (Seq Scan) [consumed] - LEAF
              Node 20275 (Index Scan) [consumed] - LEAF
            Node 20276 (Hash) [consumed]
              Node 20277 (Seq Scan) [consumed] - LEAF
          Node 20278 (Hash)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 20267 | 20268, 20269, 20270, 20271, 20272, 20273, 20274, 20275, 20276, 20277 |
| Hash Join -> [Nested Loop -> [ | 2873b8c3 | 20272 | 20267, 20268, 20269, 20270, 20271, 20273, 20274, 20275, 20276, 20277 |
...
### Step 2: Node 20272 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2873b8c3 (Hash Join -> [Nested Loop -> [Seq Scan (Outer), Index Scan (Inner)] (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 20267, 20268, 20269, 20270, 20271, 20273, 20274, 20275, 20276, 20277
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18257
  - HashJoin_nt1=18257
...
### Step 4: Node 20267 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20268, 20269, 20270, 20271, 20272, 20273, 20274, 20275, 20276, 20277
- **Input Features:**
