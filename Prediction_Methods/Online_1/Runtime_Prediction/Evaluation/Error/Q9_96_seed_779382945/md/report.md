    ...
    Node 19282 (Gather) [consumed]
      Node 19283 (Aggregate) [consumed]
        Node 19284 (Nested Loop) [consumed]
          ...
          Node 19297 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather -> | 76ab422a | 19280 | 19281, 19282, 19283, 19284, 19285, 19286, 19287, 19288, 19289, 19290, 19293, 19295, 19296, 19297 |
...
|------|------|--------|-----------|-----|--------|
| 19280 | Sort | 1204.29 | 1194.95 | 0.8% | pattern |
...
### Step 4: Node 19280 (Sort) - PATTERN ROOT
...
- **Consumes:** Nodes 19281, 19282, 19283, 19284, 19285, 19286, 19287, 19288, 19289, 19290, 19293, 19295, 19296, 19297
- **Input Features:**
