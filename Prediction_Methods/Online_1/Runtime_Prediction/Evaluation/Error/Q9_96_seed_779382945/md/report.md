...
```
Node 19280 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 19281 (Aggregate) [consumed]
    Node 19282 (Gather)
      Node 19283 (Aggregate)
        Node 19284 (Nested Loop)
          Node 19285 (Hash Join) [PATTERN: 895c6e8c]
            Node 19286 (Seq Scan) [consumed] - LEAF
            Node 19287 (Hash) [consumed]
              Node 19288 (Hash Join) [PATTERN: 7a51ce50]
                Node 19289 (Hash Join) [consumed]
                  Node 19290 (Nested Loop) [consumed]
                    Node 19291 (Seq Scan) [consumed] - LEAF
                    Node 19292 (Index Scan) [consumed] - LEAF
                  Node 19293 (Hash) [consumed]
                    Node 19294 (Seq Scan) [consumed] - LEAF
                Node 19295 (Hash) [consumed]
                  Node 19296 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Hash Join -> [Hash Join -> [Ne | 7a51ce50 | 19288 | 19280, 19281, 19285, 19286, 19287, 19289, 19290, 19291, 19292, 19293, 19294, 19295, 19296 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 19285 | 19280, 19281, 19286, 19287, 19288, 19289, 19290, 19291, 19292, 19293, 19294, 19295, 19296 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 19280 | 19281, 19285, 19286, 19287, 19288, 19289, 19290, 19291, 19292, 19293, 19294, 19295, 19296 |
...
|------|------|--------|-----------|-----|--------|
| 19280 | Sort | 1204.29 | 1116.84 | 7.3% | pattern |
| 19282 | Gather | 1203.39 | 1135.48 | 5.6% | operator |
| 19283 | Aggregate | 1183.68 | 1135.57 | 4.1% | operator |
| 19284 | Nested Loop | 1159.81 | 1182.91 | 2.0% | operator |
| 19285 | Hash Join | 985.00 | 734.19 | 25.5% | pattern |
| 19297 | Index Scan | 0.00 | -0.04 | 1512.7% | operator |
| 19288 | Hash Join | 171.91 | 546.39 | 217.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 19288 (Hash Join) - PATTERN ROOT
...
- **Consumes:** Nodes 19280, 19281, 19285, 19286, 19287, 19289, 19290, 19291, 19292, 19293, 19294, 19295, 19296
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 2: Node 19285 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 19280, 19281, 19286, 19287, 19288, 19289, 19290, 19291, 19292, 19293, 19294, 19295, 19296
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=69752
...
### Step 3: Node 19297 (Index Scan) - LEAF
...
### Step 7: Node 19280 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 19281, 19285, 19286, 19287, 19288, 19289, 19290, 19291, 19292, 19293, 19294, 19295, 19296
- **Input Features:**
