...
```
Node 30708 (Limit) [PATTERN: 0aa5463f] - ROOT
    ...
    Node 30710 (Aggregate) [consumed]
      Node 30711 (Gather Merge) [consumed]
        Node 30712 (Incremental Sort) [consumed]
          Node 30713 (Nested Loop) [consumed]
            Node 30714 (Merge Join) [consumed]
              Node 30715 (Sort)
            ...
            Node 30723 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 0aa5463f | 30708 | 30709, 30710, 30711, 30712, 30713, 30714, 30716, 30717, 30718, 30723 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30716 | 30708, 30709, 30710, 30711, 30712, 30713, 30714, 30717, 30718, 30723 |
...
- **Consumes:** Nodes 30708, 30709, 30710, 30711, 30712, 30713, 30714, 30717, 30718, 30723
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 7: Node 30708 (Limit) - PATTERN ROOT
...
- **Consumes:** Nodes 30709, 30710, 30711, 30712, 30713, 30714, 30716, 30717, 30718, 30723
- **Input Features:**
