...
```
Node 24635 (Aggregate) [PATTERN: f9c97829] - ROOT
  Node 24636 (Gather Merge) [consumed]
    Node 24637 (Aggregate) [consumed]
      Node 24638 (Sort) [consumed]
        Node 24639 (Nested Loop) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> A | f9c97829 | 24635 | 24636, 24637, 24638, 24639, 24640, 24641 |
...
|------|------|--------|-----------|-----|--------|
| 24635 | Aggregate | 989.24 | 998.49 | 0.9% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24635 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 24636, 24637, 24638, 24639, 24640, 24641
- **Input Features:**
  ...
  - Aggregate_Outer_startup_cost=147559.1600
  - Aggregate_Outer_total_cost=147675.2500
  - Aggregate_np=0
  - Aggregate_nt=7
  - Aggregate_nt1=35
  - Aggregate_nt2=0
  ...
  - NestedLoop_Outer_nt=5801
  - NestedLoop_Outer_nt1=5801
  ...
  - NestedLoop_Outer_total_cost=147196.5300
  ...
  - Sort_Outer_startup_cost=147559.1600
  - Sort_Outer_total_cost=147573.6600
