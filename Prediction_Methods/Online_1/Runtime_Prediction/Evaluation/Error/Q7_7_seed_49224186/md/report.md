      ...
      Node 12790 (Hash Join)
        Node 12791 (Nested Loop)
          Node 12792 (Hash Join)
            ...
            Node 12794 (Hash) [PATTERN: a54055ce]
              Node 12795 (Hash Join) [consumed]
                Node 12796 (Seq Scan) [consumed] - LEAF
                Node 12797 (Hash) [consumed]
                  Node 12798 (Seq Scan) [consumed] - LEAF
          Node 12799 (Index Scan) - LEAF
        Node 12800 (Hash) [PATTERN: a54055ce]
          Node 12801 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 12794 | 12787, 12788, 12795, 12796, 12797, 12798, 12800, 12801, 12802, 12803, 12804 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 12800 | 12787, 12788, 12794, 12795, 12796, 12797, 12798, 12801, 12802, 12803, 12804 |
| Aggregate -> Gather Merge (Out | 2724c080 | 12787 | 12788, 12794, 12795, 12796, 12797, 12798, 12800, 12801, 12802, 12803, 12804 |
...
| 12790 | Hash Join | 1194.89 | 1130.43 | 5.4% | operator |
| 12791 | Nested Loop | 1188.82 | 1145.81 | 3.6% | operator |
| 12800 | Hash | 2.42 | 3.42 | 41.6% | pattern |
| 12792 | Hash Join | 212.34 | 319.90 | 50.7% | operator |
| 12799 | Index Scan | 0.03 | 0.09 | 163.5% | operator |
| 12793 | Seq Scan | 150.55 | 192.19 | 27.7% | operator |
| 12794 | Hash | 35.59 | 35.59 | 0.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12793 (Seq Scan) - LEAF
...
### Step 2: Node 12794 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 12787, 12788, 12795, 12796, 12797, 12798, 12800, 12801, 12802, 12803, 12804
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 12799 (Index Scan) - LEAF
...
### Step 6: Node 12800 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 12787, 12788, 12794, 12795, 12796, 12797, 12798, 12801, 12802, 12803, 12804
- **Input Features:**
  - HashJoin_Outer_np=0
...
- **Consumes:** Nodes 12788, 12794, 12795, 12796, 12797, 12798, 12800, 12801, 12802, 12803, 12804
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
