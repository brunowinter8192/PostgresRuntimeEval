...
```
Node 12787 (Aggregate) - ROOT
  Node 12788 (Gather Merge)
    Node 12789 (Sort)
      Node 12790 (Hash Join)
        Node 12791 (Nested Loop)
          Node 12792 (Hash Join)
            Node 12793 (Seq Scan) - LEAF
            Node 12794 (Hash)
              Node 12795 (Hash Join)
                Node 12796 (Seq Scan) - LEAF
                Node 12797 (Hash)
                  Node 12798 (Seq Scan) - LEAF
          Node 12799 (Index Scan) - LEAF
        Node 12800 (Hash)
          Node 12801 (Hash Join)
            Node 12802 (Seq Scan) - LEAF
            Node 12803 (Hash)
              Node 12804 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12787 | Aggregate | 1206.96 | 1202.22 | 0.4% | operator |
| 12788 | Gather Merge | 1205.88 | 1148.45 | 4.8% | operator |
| 12789 | Sort | 1195.51 | 1149.87 | 3.8% | operator |
| 12790 | Hash Join | 1194.89 | 1130.50 | 5.4% | operator |
| 12791 | Nested Loop | 1188.82 | 1145.81 | 3.6% | operator |
| 12800 | Hash | 2.42 | 15.44 | 538.9% | operator |
| 12792 | Hash Join | 212.34 | 319.53 | 50.5% | operator |
| 12799 | Index Scan | 0.03 | 0.09 | 163.5% | operator |
| 12801 | Hash Join | 2.37 | 49.64 | 1990.9% | operator |
| 12793 | Seq Scan | 150.55 | 192.19 | 27.7% | operator |
| 12794 | Hash | 35.59 | 17.27 | 51.5% | operator |
| 12802 | Seq Scan | 2.04 | 10.62 | 419.2% | operator |
| 12803 | Hash | 0.01 | 14.54 | 111724.3% | operator |
| 12795 | Hash Join | 35.29 | 54.15 | 53.5% | operator |
| 12804 | Seq Scan | 0.01 | 7.20 | 65317.7% | operator |
| 12796 | Seq Scan | 34.19 | 24.87 | 27.2% | operator |
| 12797 | Hash | 0.01 | 14.54 | 145271.6% | operator |
| 12798 | Seq Scan | 0.01 | 7.20 | 89849.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12798 (Seq Scan) - LEAF
...
### Step 2: Node 12796 (Seq Scan) - LEAF
...
### Step 5: Node 12804 (Seq Scan) - LEAF
...
### Step 6: Node 12793 (Seq Scan) - LEAF
...
### Step 8: Node 12802 (Seq Scan) - LEAF
...
### Step 11: Node 12799 (Index Scan) - LEAF
...
### Step 13: Node 12791 (Nested Loop)
...
### Step 17: Node 12788 (Gather Merge)
...
### Step 18: Node 12787 (Aggregate) - ROOT
