...
```
Node 12787 (Aggregate) [PATTERN: 27c3eea9] - ROOT
  Node 12788 (Gather Merge) [consumed]
    Node 12789 (Sort) [consumed]
      Node 12790 (Hash Join) [consumed]
        Node 12791 (Nested Loop) [consumed]
          Node 12792 (Hash Join) [consumed]
          ...
          Node 12799 (Index Scan) [consumed] - LEAF
        Node 12800 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 27c3eea9 | 12787 | 12788, 12789, 12790, 12791, 12792, 12794, 12795, 12796, 12797, 12798, 12799, 12800, 12801 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 12794 | 12787, 12788, 12789, 12790, 12791, 12792, 12795, 12796, 12797, 12798, 12799, 12800, 12801 |
...
|------|------|--------|-----------|-----|--------|
| 12787 | Aggregate | 1206.96 | 1200.90 | 0.5% | pattern |
...
### Step 1: Node 12804 (Seq Scan) - LEAF
...
### Step 2: Node 12793 (Seq Scan) - LEAF
...
### Step 3: Node 12794 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 12787, 12788, 12789, 12790, 12791, 12792, 12795, 12796, 12797, 12798, 12799, 12800, 12801
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 12802 (Seq Scan) - LEAF
...
### Step 6: Node 12787 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 12788, 12789, 12790, 12791, 12792, 12794, 12795, 12796, 12797, 12798, 12799, 12800, 12801
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
