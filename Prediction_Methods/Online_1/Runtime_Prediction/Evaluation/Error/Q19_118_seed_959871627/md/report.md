...
```
Node 31353 (Aggregate) [PATTERN: f8295d8b] - ROOT
  Node 31354 (Gather) [consumed]
    Node 31355 (Aggregate) [consumed]
      Node 31356 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 31353 | 31354, 31355, 31356, 31357, 31358, 31359 |
...
|------|------|--------|-----------|-----|--------|
| 31353 | Aggregate | 835.45 | 841.17 | 0.7% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31353 (Aggregate) - PATTERN ROOT
