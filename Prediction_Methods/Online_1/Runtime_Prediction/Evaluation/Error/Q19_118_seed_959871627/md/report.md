...
Node 31353 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31354 (Gather) [consumed]
    Node 31355 (Aggregate) [consumed]
      Node 31356 (Hash Join) [PATTERN: f4cb205a]
        Node 31357 (Seq Scan) [consumed] - LEAF
        Node 31358 (Hash) [consumed]
          Node 31359 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 31356 | 31353, 31354, 31355, 31357, 31358, 31359 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31353 | 31354, 31355, 31356, 31357, 31358, 31359 |
...
|------|------|--------|-----------|-----|--------|
| 31353 | Aggregate | 835.45 | 834.50 | 0.1% | pattern |
| 31356 | Hash Join | 816.92 | 373.83 | 54.2% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31356 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 31353, 31354, 31355, 31357, 31358, 31359
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=23
  - HashJoin_nt1=22451
  ...
  - HashJoin_total_cost=156338.3900
  - Hash_Inner_np=0
  - Hash_Inner_nt=200
  - Hash_Inner_nt1=200
  - Hash_Inner_nt2=0
...
### Step 2: Node 31353 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31354, 31355, 31356, 31357, 31358, 31359
- **Input Features:**
