      ...
      Node 12484 (Hash Join)
        Node 12485 (Nested Loop)
          Node 12486 (Hash Join)
            ...
            Node 12488 (Hash) [PATTERN: a54055ce]
              Node 12489 (Hash Join) [consumed]
                Node 12490 (Seq Scan) [consumed] - LEAF
                Node 12491 (Hash) [consumed]
                  Node 12492 (Seq Scan) [consumed] - LEAF
          Node 12493 (Index Scan) - LEAF
        Node 12494 (Hash) [PATTERN: a54055ce]
          Node 12495 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 12488 | 12481, 12482, 12489, 12490, 12491, 12492, 12494, 12495, 12496, 12497, 12498 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 12494 | 12481, 12482, 12488, 12489, 12490, 12491, 12492, 12495, 12496, 12497, 12498 |
| Aggregate -> Gather Merge (Out | 2724c080 | 12481 | 12482, 12488, 12489, 12490, 12491, 12492, 12494, 12495, 12496, 12497, 12498 |
...
| 12484 | Hash Join | 1185.46 | 1130.43 | 4.6% | operator |
| 12485 | Nested Loop | 1178.57 | 1145.81 | 2.8% | operator |
| 12494 | Hash | 2.95 | 3.42 | 16.1% | pattern |
| 12486 | Hash Join | 211.49 | 319.90 | 51.3% | operator |
| 12493 | Index Scan | 0.03 | 0.09 | 163.5% | operator |
| 12487 | Seq Scan | 151.22 | 192.19 | 27.1% | operator |
| 12488 | Hash | 34.60 | 35.59 | 2.9% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12487 (Seq Scan) - LEAF
...
### Step 2: Node 12488 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 12481, 12482, 12489, 12490, 12491, 12492, 12494, 12495, 12496, 12497, 12498
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 12493 (Index Scan) - LEAF
...
### Step 6: Node 12494 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 12481, 12482, 12488, 12489, 12490, 12491, 12492, 12495, 12496, 12497, 12498
- **Input Features:**
  - HashJoin_Outer_np=0
...
- **Consumes:** Nodes 12482, 12488, 12489, 12490, 12491, 12492, 12494, 12495, 12496, 12497, 12498
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
