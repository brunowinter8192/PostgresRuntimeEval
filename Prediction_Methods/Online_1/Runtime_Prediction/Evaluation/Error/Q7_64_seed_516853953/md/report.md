...
```
Node 12481 (Aggregate) [PATTERN: 27c3eea9] - ROOT
  Node 12482 (Gather Merge) [consumed]
    Node 12483 (Sort) [consumed]
      Node 12484 (Hash Join) [consumed]
        Node 12485 (Nested Loop) [consumed]
          Node 12486 (Hash Join) [consumed]
          ...
          Node 12493 (Index Scan) [consumed] - LEAF
        Node 12494 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 27c3eea9 | 12481 | 12482, 12483, 12484, 12485, 12486, 12488, 12489, 12490, 12491, 12492, 12493, 12494, 12495 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 12488 | 12481, 12482, 12483, 12484, 12485, 12486, 12489, 12490, 12491, 12492, 12493, 12494, 12495 |
...
|------|------|--------|-----------|-----|--------|
| 12481 | Aggregate | 1194.50 | 1200.90 | 0.5% | pattern |
...
### Step 1: Node 12498 (Seq Scan) - LEAF
...
### Step 2: Node 12487 (Seq Scan) - LEAF
...
### Step 3: Node 12488 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 12481, 12482, 12483, 12484, 12485, 12486, 12489, 12490, 12491, 12492, 12493, 12494, 12495
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 12496 (Seq Scan) - LEAF
...
### Step 6: Node 12481 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 12482, 12483, 12484, 12485, 12486, 12488, 12489, 12490, 12491, 12492, 12493, 12494, 12495
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
