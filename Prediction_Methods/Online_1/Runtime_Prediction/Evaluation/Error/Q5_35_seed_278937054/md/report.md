        ...
        Node 8465 (Sort) [consumed]
          Node 8466 (Hash Join) [consumed]
            Node 8467 (Nested Loop) [consumed]
              ...
              Node 8478 (Index Scan) [consumed] - LEAF
            Node 8479 (Hash) [consumed]
              Node 8480 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather Me | 255215ee | 8461 | 8462, 8463, 8464, 8465, 8466, 8467, 8468, 8469, 8470, 8471, 8472, 8473, 8474, 8478, 8479, 8480 |
...
|------|------|--------|-----------|-----|--------|
| 8461 | Sort | 1075.76 | 1070.44 | 0.5% | pattern |
...
### Step 4: Node 8461 (Sort) - PATTERN ROOT
...
- **Consumes:** Nodes 8462, 8463, 8464, 8465, 8466, 8467, 8468, 8469, 8470, 8471, 8472, 8473, 8474, 8478, 8479, 8480
- **Input Features:**
