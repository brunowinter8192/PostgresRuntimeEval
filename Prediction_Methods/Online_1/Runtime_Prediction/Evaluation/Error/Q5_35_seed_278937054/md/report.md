              ...
              Node 8468 (Hash Join) [PATTERN: 895c6e8c]
                ...
                Node 8470 (Hash) [consumed]
                  Node 8471 (Hash Join)
                    ...
                    Node 8473 (Hash) [PATTERN: a54055ce]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 8473 | 8461, 8462, 8466, 8467, 8468, 8469, 8470, 8474, 8475, 8476, 8477, 8479 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 8468 | 8461, 8462, 8466, 8467, 8469, 8470, 8473, 8474, 8475, 8476, 8477, 8479 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 8466 | 8461, 8462, 8467, 8468, 8469, 8470, 8473, 8474, 8475, 8476, 8477, 8479 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 8461 | 8462, 8466, 8467, 8468, 8469, 8470, 8473, 8474, 8475, 8476, 8477, 8479 |
...
| 8471 | Hash Join | 35.20 | 62.70 | 78.1% | operator |
| 8472 | Seq Scan | 33.76 | 24.87 | 26.3% | operator |
| 8473 | Hash | 0.09 | 0.14 | 51.4% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 8472 (Seq Scan) - LEAF
...
### Step 2: Node 8473 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 8461, 8462, 8466, 8467, 8468, 8469, 8470, 8474, 8475, 8476, 8477, 8479
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 4: Node 8468 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 8461, 8462, 8466, 8467, 8469, 8470, 8473, 8474, 8475, 8476, 8477, 8479
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14884
  - HashJoin_nt1=74418
...
### Step 5: Node 8478 (Index Scan) - LEAF
...
### Step 6: Node 8480 (Seq Scan) - LEAF
...
### Step 7: Node 8466 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 8461, 8462, 8467, 8468, 8469, 8470, 8473, 8474, 8475, 8476, 8477, 8479
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=2382
  - HashJoin_nt1=59546
...
### Step 10: Node 8463 (Gather Merge)
...
### Step 11: Node 8461 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 8462, 8466, 8467, 8468, 8469, 8470, 8473, 8474, 8475, 8476, 8477, 8479
- **Input Features:**
