...
```
Node 661 (Aggregate) [PATTERN: 3dfa6025] - ROOT
  Node 662 (Gather Merge) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 3dfa6025 | 661 | 662, 663, 664, 665 |
...
|------|------|--------|-----------|-----|--------|
| 661 | Aggregate | 944.38 | 953.98 | 1.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 661 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3dfa6025 (Aggregate -> Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 662, 663, 664, 665
- **Input Features:**
  ...
  - Aggregate_total_cost=169921.6100
  ...
  - GatherMerge_Outer_total_cost=169920.4700
