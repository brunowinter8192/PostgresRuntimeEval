...
```
Node 25503 (Sort) [PATTERN: 35ffb644] - ROOT
  Node 25504 (Aggregate) [consumed]
    Node 25505 (Aggregate) [consumed]
      Node 25506 (Hash Join)
        Node 25507 (Seq Scan) - LEAF
        Node 25508 (Hash)
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Aggregate | 35ffb644 | 25503 | 25504, 25505 |
...
|------|------|--------|-----------|-----|--------|
| 25503 | Sort | 934.94 | 915.33 | 2.1% | pattern |
| 25506 | Hash Join | 714.94 | 705.63 | 1.3% | operator |
| 25507 | Seq Scan | 504.58 | 411.72 | 18.4% | operator |
| 25508 | Hash | 14.96 | 37.64 | 151.6% | operator |
| 25509 | Index Only Scan | 9.46 | 10.09 | 6.6% | operator |
...
### Step 2: Node 25507 (Seq Scan) - LEAF
...
### Step 5: Node 25503 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 35ffb644 (Sort -> Aggregate -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 25504, 25505
- **Input Features:**
