...
```
Node 31794 (Aggregate) [PATTERN: f8295d8b] - ROOT
  Node 31795 (Gather) [consumed]
    Node 31796 (Aggregate) [consumed]
      Node 31797 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 31794 | 31795, 31796, 31797, 31798, 31799, 31800 |
...
|------|------|--------|-----------|-----|--------|
| 31794 | Aggregate | 832.68 | 841.18 | 1.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31794 (Aggregate) - PATTERN ROOT
