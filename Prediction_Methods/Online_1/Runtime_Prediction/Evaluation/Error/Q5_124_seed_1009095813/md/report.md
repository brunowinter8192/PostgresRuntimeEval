              ...
              Node 7428 (Hash Join) [PATTERN: 895c6e8c]
                ...
                Node 7430 (Hash) [consumed]
                  Node 7431 (Hash Join)
                    ...
                    Node 7433 (Hash) [PATTERN: a54055ce]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 7433 | 7421, 7422, 7426, 7427, 7428, 7429, 7430, 7434, 7435, 7436, 7437, 7439 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 7428 | 7421, 7422, 7426, 7427, 7429, 7430, 7433, 7434, 7435, 7436, 7437, 7439 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 7426 | 7421, 7422, 7427, 7428, 7429, 7430, 7433, 7434, 7435, 7436, 7437, 7439 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 7421 | 7422, 7426, 7427, 7428, 7429, 7430, 7433, 7434, 7435, 7436, 7437, 7439 |
...
| 7431 | Hash Join | 30.75 | 62.70 | 103.9% | operator |
| 7432 | Seq Scan | 29.26 | 24.87 | 15.0% | operator |
| 7433 | Hash | 0.15 | 0.14 | 11.5% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 7432 (Seq Scan) - LEAF
...
### Step 2: Node 7433 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 7421, 7422, 7426, 7427, 7428, 7429, 7430, 7434, 7435, 7436, 7437, 7439
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 4: Node 7428 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 7421, 7422, 7426, 7427, 7429, 7430, 7433, 7434, 7435, 7436, 7437, 7439
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14646
  - HashJoin_nt1=73231
...
### Step 5: Node 7438 (Index Scan) - LEAF
...
### Step 6: Node 7440 (Seq Scan) - LEAF
...
### Step 7: Node 7426 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 7421, 7422, 7427, 7428, 7429, 7430, 7433, 7434, 7435, 7436, 7437, 7439
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=2344
  - HashJoin_nt1=58597
...
### Step 10: Node 7423 (Gather Merge)
...
### Step 11: Node 7421 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 7422, 7426, 7427, 7428, 7429, 7430, 7433, 7434, 7435, 7436, 7437, 7439
- **Input Features:**
