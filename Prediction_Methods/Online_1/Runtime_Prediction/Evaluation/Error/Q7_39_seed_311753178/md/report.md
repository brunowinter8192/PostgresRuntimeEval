      ...
      Node 11980 (Hash Join)
        Node 11981 (Nested Loop)
          Node 11982 (Hash Join)
            ...
            Node 11984 (Hash) [PATTERN: a54055ce]
              Node 11985 (Hash Join) [consumed]
                Node 11986 (Seq Scan) [consumed] - LEAF
                Node 11987 (Hash) [consumed]
                  Node 11988 (Seq Scan) [consumed] - LEAF
          Node 11989 (Index Scan) - LEAF
        Node 11990 (Hash) [PATTERN: a54055ce]
          Node 11991 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 11984 | 11977, 11978, 11985, 11986, 11987, 11988, 11990, 11991, 11992, 11993, 11994 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 11990 | 11977, 11978, 11984, 11985, 11986, 11987, 11988, 11991, 11992, 11993, 11994 |
| Aggregate -> Gather Merge (Out | 2724c080 | 11977 | 11978, 11984, 11985, 11986, 11987, 11988, 11990, 11991, 11992, 11993, 11994 |
...
| 11980 | Hash Join | 1194.52 | 1130.43 | 5.4% | operator |
| 11981 | Nested Loop | 1188.31 | 1145.81 | 3.6% | operator |
| 11990 | Hash | 2.41 | 3.42 | 41.9% | pattern |
| 11982 | Hash Join | 213.65 | 319.90 | 49.7% | operator |
| 11989 | Index Scan | 0.03 | 0.09 | 171.7% | operator |
| 11983 | Seq Scan | 152.32 | 192.19 | 26.2% | operator |
| 11984 | Hash | 35.28 | 35.59 | 0.9% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11983 (Seq Scan) - LEAF
...
### Step 2: Node 11984 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 11977, 11978, 11985, 11986, 11987, 11988, 11990, 11991, 11992, 11993, 11994
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 11989 (Index Scan) - LEAF
...
### Step 6: Node 11990 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 11977, 11978, 11984, 11985, 11986, 11987, 11988, 11991, 11992, 11993, 11994
- **Input Features:**
  - HashJoin_Outer_np=0
...
- **Consumes:** Nodes 11978, 11984, 11985, 11986, 11987, 11988, 11990, 11991, 11992, 11993, 11994
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
