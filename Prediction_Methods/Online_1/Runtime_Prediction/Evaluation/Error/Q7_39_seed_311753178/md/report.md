...
```
Node 11977 (Aggregate) [PATTERN: 27c3eea9] - ROOT
  Node 11978 (Gather Merge) [consumed]
    Node 11979 (Sort) [consumed]
      Node 11980 (Hash Join) [consumed]
        Node 11981 (Nested Loop) [consumed]
          Node 11982 (Hash Join) [consumed]
          ...
          Node 11989 (Index Scan) [consumed] - LEAF
        Node 11990 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 27c3eea9 | 11977 | 11978, 11979, 11980, 11981, 11982, 11984, 11985, 11986, 11987, 11988, 11989, 11990, 11991 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 11984 | 11977, 11978, 11979, 11980, 11981, 11982, 11985, 11986, 11987, 11988, 11989, 11990, 11991 |
...
|------|------|--------|-----------|-----|--------|
| 11977 | Aggregate | 1202.59 | 1200.90 | 0.1% | pattern |
...
### Step 1: Node 11994 (Seq Scan) - LEAF
...
### Step 2: Node 11983 (Seq Scan) - LEAF
...
### Step 3: Node 11984 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 11977, 11978, 11979, 11980, 11981, 11982, 11985, 11986, 11987, 11988, 11989, 11990, 11991
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 11992 (Seq Scan) - LEAF
...
### Step 6: Node 11977 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 11978, 11979, 11980, 11981, 11982, 11984, 11985, 11986, 11987, 11988, 11989, 11990, 11991
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
