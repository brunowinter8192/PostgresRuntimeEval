...
```
Node 10025 (Aggregate) [PATTERN: dd3706ac] - ROOT
  Node 10026 (Gather) [consumed]
    Node 10027 (Aggregate) [consumed]
      Node 10028 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | dd3706ac | 10025 | 10026, 10027, 10028 |
...
|------|------|--------|-----------|-----|--------|
| 10025 | Aggregate | 790.57 | 791.27 | 0.1% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10025 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** dd3706ac (Aggregate -> Gather -> Aggregate -> Seq Scan (Outer) (Outer) (Outer))
- **Consumes:** Nodes 10026, 10027, 10028
- **Input Features:**
