...
```
Node 6068 (Aggregate) [PATTERN: 80bd802d] - ROOT
  Node 6069 (Gather Merge) [consumed]
    Node 6070 (Sort) [consumed]
      Node 6071 (Aggregate) [consumed]
        Node 6072 (Nested Loop) [consumed]
          Node 6073 (Seq Scan) [consumed] - LEAF
          Node 6074 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 80bd802d | 6068 | 6069, 6070, 6071, 6072, 6073, 6074 |
...
|------|------|--------|-----------|-----|--------|
| 6068 | Aggregate | 1042.80 | 1057.79 | 1.4% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6068 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 6069, 6070, 6071, 6072, 6073, 6074
- **Input Features:**
