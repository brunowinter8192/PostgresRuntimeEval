...
```
Node 706 (Aggregate) [PATTERN: 3dfa6025] - ROOT
  Node 707 (Gather Merge) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 3dfa6025 | 706 | 707, 708, 709, 710 |
...
|------|------|--------|-----------|-----|--------|
| 706 | Aggregate | 927.11 | 953.98 | 2.9% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 706 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3dfa6025 (Aggregate -> Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 707, 708, 709, 710
- **Input Features:**
  ...
  - Aggregate_startup_cost=170130.6900
  - Aggregate_total_cost=170135.4600
  ...
  - GatherMerge_Outer_startup_cost=170130.6900
  - GatherMerge_Outer_total_cost=170134.3200
