...
```
Node 31430 (Aggregate) [PATTERN: f8295d8b] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 31430 | 31431, 31432, 31433, 31434, 31435, 31436 |
...
|------|------|--------|-----------|-----|--------|
| 31430 | Aggregate | 843.80 | 841.18 | 0.3% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31430 (Aggregate) - PATTERN ROOT
