...
**Test Query:** Q19_128_seed_1041911937
...
```
Node 31430 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31431 (Gather) [consumed]
    Node 31432 (Aggregate) [consumed]
      Node 31433 (Hash Join) [PATTERN: f4cb205a]
        Node 31434 (Seq Scan) [consumed] - LEAF
        Node 31435 (Hash) [consumed]
          Node 31436 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 31433 | 31430, 31431, 31432, 31434, 31435, 31436 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31430 | 31431, 31432, 31433, 31434, 31435, 31436 |
...
|------|------|--------|-----------|-----|--------|
| 31430 | Aggregate | 843.80 | 834.50 | 1.1% | pattern |
| 31433 | Hash Join | 822.46 | 373.83 | 54.5% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31433 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 31430, 31431, 31432, 31434, 31435, 31436
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=23
  - HashJoin_nt1=22538
  ...
  - HashJoin_sel=0.0000
  - HashJoin_startup_cost=7672.2300
  - HashJoin_total_cost=156338.6800
  - Hash_Inner_np=0
  - Hash_Inner_nt=205
  - Hash_Inner_nt1=205
  - Hash_Inner_nt2=0
...
### Step 2: Node 31430 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31431, 31432, 31433, 31434, 31435, 31436
- **Input Features:**
  ...
  - Aggregate_Outer_startup_cost=156338.8600
  - Aggregate_Outer_total_cost=156338.8700
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=157339.3900
  - Aggregate_total_cost=157339.4000
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=157338.8600
  - Gather_Outer_total_cost=157339.3700
