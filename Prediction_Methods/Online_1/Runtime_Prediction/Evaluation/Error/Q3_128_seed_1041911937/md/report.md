    ...
    Node 4653 (Aggregate) [consumed]
      Node 4654 (Gather) [consumed]
        Node 4655 (Nested Loop)
          Node 4656 (Hash Join) [PATTERN: f4cb205a]
            Node 4657 (Seq Scan) [consumed] - LEAF
            Node 4658 (Hash) [consumed]
              Node 4659 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4651 | 4652, 4653, 4654, 4656, 4657, 4658, 4659 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 4656 | 4651, 4652, 4653, 4654, 4657, 4658, 4659 |
...
| 4655 | Nested Loop | 1158.07 | 1121.92 | 3.1% | operator |
| 4656 | Hash Join | 204.30 | 219.41 | 7.4% | pattern |
| 4660 | Index Scan | 0.03 | -0.02 | 171.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4656 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 4651, 4652, 4653, 4654, 4657, 4658, 4659
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46938
  - HashJoin_nt1=233583
...
- **Output:** st=30.37, rt=219.41

### Step 2: Node 4660 (Index Scan) - LEAF
...
- **Output:** st=30.27, rt=1121.92

### Step 4: Node 4651 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4652, 4653, 4654, 4656, 4657, 4658, 4659
- **Input Features:**
