...
```
Node 10413 (Aggregate) [PATTERN: dd3706ac] - ROOT
  Node 10414 (Gather) [consumed]
    Node 10415 (Aggregate) [consumed]
      Node 10416 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | dd3706ac | 10413 | 10414, 10415, 10416 |
...
|------|------|--------|-----------|-----|--------|
| 10413 | Aggregate | 756.75 | 791.27 | 4.6% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10413 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** dd3706ac (Aggregate -> Gather -> Aggregate -> Seq Scan (Outer) (Outer) (Outer))
- **Consumes:** Nodes 10414, 10415, 10416
- **Input Features:**
