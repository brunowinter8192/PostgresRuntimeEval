      ...
      Node 11872 (Hash Join)
        Node 11873 (Nested Loop)
          Node 11874 (Hash Join)
            ...
            Node 11876 (Hash) [PATTERN: a54055ce]
              Node 11877 (Hash Join) [consumed]
                Node 11878 (Seq Scan) [consumed] - LEAF
                Node 11879 (Hash) [consumed]
                  Node 11880 (Seq Scan) [consumed] - LEAF
          Node 11881 (Index Scan) - LEAF
        Node 11882 (Hash) [PATTERN: a54055ce]
          Node 11883 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 11876 | 11869, 11870, 11877, 11878, 11879, 11880, 11882, 11883, 11884, 11885, 11886 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 11882 | 11869, 11870, 11876, 11877, 11878, 11879, 11880, 11883, 11884, 11885, 11886 |
| Aggregate -> Gather Merge (Out | 2724c080 | 11869 | 11870, 11876, 11877, 11878, 11879, 11880, 11882, 11883, 11884, 11885, 11886 |
...
| 11872 | Hash Join | 1186.50 | 1130.43 | 4.7% | operator |
| 11873 | Nested Loop | 1180.13 | 1145.81 | 2.9% | operator |
| 11882 | Hash | 2.50 | 3.42 | 36.5% | pattern |
| 11874 | Hash Join | 214.00 | 319.90 | 49.5% | operator |
| 11881 | Index Scan | 0.03 | 0.09 | 163.5% | operator |
| 11875 | Seq Scan | 152.90 | 192.19 | 25.7% | operator |
| 11876 | Hash | 36.01 | 35.59 | 1.2% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11875 (Seq Scan) - LEAF
...
### Step 2: Node 11876 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 11869, 11870, 11877, 11878, 11879, 11880, 11882, 11883, 11884, 11885, 11886
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 11881 (Index Scan) - LEAF
...
### Step 6: Node 11882 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 11869, 11870, 11876, 11877, 11878, 11879, 11880, 11883, 11884, 11885, 11886
- **Input Features:**
  - HashJoin_Outer_np=0
...
- **Consumes:** Nodes 11870, 11876, 11877, 11878, 11879, 11880, 11882, 11883, 11884, 11885, 11886
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
