...
```
Node 11869 (Aggregate) [PATTERN: 27c3eea9] - ROOT
  Node 11870 (Gather Merge) [consumed]
    Node 11871 (Sort) [consumed]
      Node 11872 (Hash Join) [consumed]
        Node 11873 (Nested Loop) [consumed]
          Node 11874 (Hash Join) [consumed]
          ...
          Node 11881 (Index Scan) [consumed] - LEAF
        Node 11882 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 27c3eea9 | 11869 | 11870, 11871, 11872, 11873, 11874, 11876, 11877, 11878, 11879, 11880, 11881, 11882, 11883 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 11876 | 11869, 11870, 11871, 11872, 11873, 11874, 11877, 11878, 11879, 11880, 11881, 11882, 11883 |
...
|------|------|--------|-----------|-----|--------|
| 11869 | Aggregate | 1194.35 | 1200.90 | 0.5% | pattern |
...
### Step 1: Node 11886 (Seq Scan) - LEAF
...
### Step 2: Node 11875 (Seq Scan) - LEAF
...
### Step 3: Node 11876 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 11869, 11870, 11871, 11872, 11873, 11874, 11877, 11878, 11879, 11880, 11881, 11882, 11883
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 11884 (Seq Scan) - LEAF
...
### Step 6: Node 11869 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 11870, 11871, 11872, 11873, 11874, 11876, 11877, 11878, 11879, 11880, 11881, 11882, 11883
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
