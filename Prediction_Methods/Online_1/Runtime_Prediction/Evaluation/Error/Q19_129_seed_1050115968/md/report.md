...
```
Node 31437 (Aggregate) [PATTERN: f8295d8b] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 31437 | 31438, 31439, 31440, 31441, 31442, 31443 |
...
|------|------|--------|-----------|-----|--------|
| 31437 | Aggregate | 840.97 | 841.17 | 0.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31437 (Aggregate) - PATTERN ROOT
