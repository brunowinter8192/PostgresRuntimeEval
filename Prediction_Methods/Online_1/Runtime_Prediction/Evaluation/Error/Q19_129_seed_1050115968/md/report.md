...
Node 31437 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31438 (Gather) [consumed]
    Node 31439 (Aggregate) [consumed]
      Node 31440 (Hash Join)
        Node 31441 (Seq Scan) - LEAF
        Node 31442 (Hash)
          Node 31443 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31437 | 31438, 31439 |
...
| 31440 | Hash Join | 823.15 | 782.38 | 5.0% | operator |
| 31441 | Seq Scan | 774.35 | 750.07 | 3.1% | operator |
| 31442 | Hash | 46.28 | 12.06 | 74.0% | operator |
| 31443 | Seq Scan | 46.15 | 31.60 | 31.5% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31443 (Seq Scan) - LEAF
...
### Step 2: Node 31441 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=156338.5100
- **Output:** st=77.20, rt=782.38

### Step 5: Node 31437 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31438, 31439
- **Input Features:**
