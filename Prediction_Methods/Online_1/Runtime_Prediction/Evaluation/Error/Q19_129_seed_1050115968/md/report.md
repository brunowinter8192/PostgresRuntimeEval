...
**Test Query:** Q19_129_seed_1050115968
**Timestamp:** 2026-01-01 20:16:55
...
```
Node 31437 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31438 (Gather) [consumed]
    Node 31439 (Aggregate) [consumed]
      Node 31440 (Hash Join) [PATTERN: f4cb205a]
        Node 31441 (Seq Scan) [consumed] - LEAF
        Node 31442 (Hash) [consumed]
          Node 31443 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 31440 | 31437, 31438, 31439, 31441, 31442, 31443 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31437 | 31438, 31439, 31440, 31441, 31442, 31443 |
...
|------|------|--------|-----------|-----|--------|
| 31437 | Aggregate | 840.97 | 834.50 | 0.8% | pattern |
| 31440 | Hash Join | 823.15 | 373.82 | 54.6% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31440 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 31437, 31438, 31439, 31441, 31442, 31443
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=23
  - HashJoin_nt1=22495
  ...
  - HashJoin_sel=0.0000
  - HashJoin_startup_cost=7672.1700
  - HashJoin_total_cost=156338.5100
  - Hash_Inner_np=0
  - Hash_Inner_nt=200
  - Hash_Inner_nt1=200
  - Hash_Inner_nt2=0
...
- **Output:** st=84.58, rt=373.82

### Step 2: Node 31437 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31438, 31439, 31440, 31441, 31442, 31443
- **Input Features:**
  ...
  - Aggregate_Outer_startup_cost=156338.6800
  - Aggregate_Outer_total_cost=156338.6900
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=157339.2200
  - Aggregate_total_cost=157339.2300
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=157338.6800
  - Gather_Outer_total_cost=157339.1900
