...
```
Node 27176 (Aggregate) [PATTERN: f8295d8b] - ROOT
  Node 27177 (Gather) [consumed]
    Node 27178 (Aggregate) [consumed]
      Node 27179 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 27176 | 27177, 27178, 27179, 27180, 27181, 27182 |
...
|------|------|--------|-----------|-----|--------|
| 27176 | Aggregate | 810.40 | 822.67 | 1.5% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27176 (Aggregate) - PATTERN ROOT
