    ...
    Node 20100 (Aggregate) [consumed]
      Node 20101 (Gather) [consumed]
        Node 20102 (Hash Join) [consumed]
          Node 20103 (Hash Join) [PATTERN: 2873b8c3]
            Node 20104 (Nested Loop) [consumed]
              Node 20105 (Seq Scan) [consumed] - LEAF
              Node 20106 (Index Scan) [consumed] - LEAF
            Node 20107 (Hash) [consumed]
              Node 20108 (Seq Scan) [consumed] - LEAF
          Node 20109 (Hash)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 20098 | 20099, 20100, 20101, 20102, 20103, 20104, 20105, 20106, 20107, 20108 |
| Hash Join -> [Nested Loop -> [ | 2873b8c3 | 20103 | 20098, 20099, 20100, 20101, 20102, 20104, 20105, 20106, 20107, 20108 |
...
### Step 2: Node 20103 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2873b8c3 (Hash Join -> [Nested Loop -> [Seq Scan (Outer), Index Scan (Inner)] (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 20098, 20099, 20100, 20101, 20102, 20104, 20105, 20106, 20107, 20108
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18186
  - HashJoin_nt1=18186
...
### Step 4: Node 20098 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20099, 20100, 20101, 20102, 20103, 20104, 20105, 20106, 20107, 20108
- **Input Features:**
