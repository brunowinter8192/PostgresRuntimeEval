              ...
              Node 9768 (Hash Join) [PATTERN: 895c6e8c]
                ...
                Node 9770 (Hash) [consumed]
                  Node 9771 (Hash Join)
                    ...
                    Node 9773 (Hash) [PATTERN: a54055ce]
                      Node 9774 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 9773 | 9761, 9762, 9766, 9767, 9768, 9769, 9770, 9774, 9775, 9776, 9777, 9779 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 9768 | 9761, 9762, 9766, 9767, 9769, 9770, 9773, 9774, 9775, 9776, 9777, 9779 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 9766 | 9761, 9762, 9767, 9768, 9769, 9770, 9773, 9774, 9775, 9776, 9777, 9779 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 9761 | 9762, 9766, 9767, 9768, 9769, 9770, 9773, 9774, 9775, 9776, 9777, 9779 |
...
| 9771 | Hash Join | 32.57 | 62.70 | 92.5% | operator |
| 9772 | Seq Scan | 31.15 | 24.87 | 20.1% | operator |
| 9773 | Hash | 0.07 | 0.14 | 94.6% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 9772 (Seq Scan) - LEAF
...
### Step 2: Node 9773 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 9761, 9762, 9766, 9767, 9768, 9769, 9770, 9774, 9775, 9776, 9777, 9779
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 4: Node 9768 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 9761, 9762, 9766, 9767, 9769, 9770, 9773, 9774, 9775, 9776, 9777, 9779
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14612
  - HashJoin_nt1=73059
...
### Step 5: Node 9778 (Index Scan) - LEAF
...
### Step 6: Node 9780 (Seq Scan) - LEAF
...
### Step 7: Node 9766 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 9761, 9762, 9767, 9768, 9769, 9770, 9773, 9774, 9775, 9776, 9777, 9779
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=2338
  - HashJoin_nt1=58459
...
### Step 10: Node 9763 (Gather Merge)
...
### Step 11: Node 9761 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 9762, 9766, 9767, 9768, 9769, 9770, 9773, 9774, 9775, 9776, 9777, 9779
- **Input Features:**
