        ...
        Node 9765 (Sort) [consumed]
          Node 9766 (Hash Join) [consumed]
            Node 9767 (Nested Loop) [consumed]
              ...
              Node 9778 (Index Scan) [consumed] - LEAF
            Node 9779 (Hash) [consumed]
              Node 9780 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather Me | 255215ee | 9761 | 9762, 9763, 9764, 9765, 9766, 9767, 9768, 9769, 9770, 9771, 9772, 9773, 9774, 9778, 9779, 9780 |
...
|------|------|--------|-----------|-----|--------|
| 9761 | Sort | 1074.29 | 1070.44 | 0.4% | pattern |
...
### Step 4: Node 9761 (Sort) - PATTERN ROOT
...
- **Consumes:** Nodes 9762, 9763, 9764, 9765, 9766, 9767, 9768, 9769, 9770, 9771, 9772, 9773, 9774, 9778, 9779, 9780
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=25
  - Aggregate_Outer_nt1=2338
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=136
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0107
  - Aggregate_Outer_startup_cost=56870.6200
  - Aggregate_Outer_total_cost=56900.1600
  ...
  - Sort_Outer_startup_cost=56870.6200
  - Sort_Outer_total_cost=56876.4700
  - Sort_np=0
  - Sort_nt=25
  - Sort_nt1=25
  - Sort_nt2=0
