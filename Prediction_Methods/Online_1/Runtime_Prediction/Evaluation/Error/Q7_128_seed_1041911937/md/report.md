      ...
      Node 11044 (Hash Join)
        Node 11045 (Nested Loop)
          Node 11046 (Hash Join)
            ...
            Node 11048 (Hash) [PATTERN: a54055ce]
              Node 11049 (Hash Join) [consumed]
                Node 11050 (Seq Scan) [consumed] - LEAF
                Node 11051 (Hash) [consumed]
                  Node 11052 (Seq Scan) [consumed] - LEAF
          Node 11053 (Index Scan) - LEAF
        Node 11054 (Hash) [PATTERN: a54055ce]
          Node 11055 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 11048 | 11041, 11042, 11049, 11050, 11051, 11052, 11054, 11055, 11056, 11057, 11058 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 11054 | 11041, 11042, 11048, 11049, 11050, 11051, 11052, 11055, 11056, 11057, 11058 |
| Aggregate -> Gather Merge (Out | 2724c080 | 11041 | 11042, 11048, 11049, 11050, 11051, 11052, 11054, 11055, 11056, 11057, 11058 |
...
| 11044 | Hash Join | 1177.80 | 1130.43 | 4.0% | operator |
| 11045 | Nested Loop | 1167.89 | 1145.81 | 1.9% | operator |
| 11054 | Hash | 6.05 | 3.42 | 43.4% | pattern |
| 11046 | Hash Join | 209.35 | 319.90 | 52.8% | operator |
| 11053 | Index Scan | 0.03 | 0.09 | 171.7% | operator |
| 11047 | Seq Scan | 150.71 | 192.19 | 27.5% | operator |
| 11048 | Hash | 33.25 | 35.59 | 7.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11047 (Seq Scan) - LEAF
...
### Step 2: Node 11048 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 11041, 11042, 11049, 11050, 11051, 11052, 11054, 11055, 11056, 11057, 11058
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 11053 (Index Scan) - LEAF
...
### Step 6: Node 11054 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 11041, 11042, 11048, 11049, 11050, 11051, 11052, 11055, 11056, 11057, 11058
- **Input Features:**
  - HashJoin_Outer_np=0
...
- **Consumes:** Nodes 11042, 11048, 11049, 11050, 11051, 11052, 11054, 11055, 11056, 11057, 11058
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
