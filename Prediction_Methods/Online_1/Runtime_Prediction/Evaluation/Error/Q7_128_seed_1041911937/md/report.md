...
```
Node 11041 (Aggregate) [PATTERN: 27c3eea9] - ROOT
  Node 11042 (Gather Merge) [consumed]
    Node 11043 (Sort) [consumed]
      Node 11044 (Hash Join) [consumed]
        Node 11045 (Nested Loop) [consumed]
          Node 11046 (Hash Join) [consumed]
          ...
          Node 11053 (Index Scan) [consumed] - LEAF
        Node 11054 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 27c3eea9 | 11041 | 11042, 11043, 11044, 11045, 11046, 11048, 11049, 11050, 11051, 11052, 11053, 11054, 11055 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 11048 | 11041, 11042, 11043, 11044, 11045, 11046, 11049, 11050, 11051, 11052, 11053, 11054, 11055 |
...
|------|------|--------|-----------|-----|--------|
| 11041 | Aggregate | 1185.18 | 1200.90 | 1.3% | pattern |
...
### Step 1: Node 11058 (Seq Scan) - LEAF
...
### Step 2: Node 11047 (Seq Scan) - LEAF
...
### Step 3: Node 11048 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 11041, 11042, 11043, 11044, 11045, 11046, 11049, 11050, 11051, 11052, 11053, 11054, 11055
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 11056 (Seq Scan) - LEAF
...
### Step 6: Node 11041 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 11042, 11043, 11044, 11045, 11046, 11048, 11049, 11050, 11051, 11052, 11053, 11054, 11055
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
