...
Node 14489 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 14490 (Gather Merge) [consumed]
    Node 14491 (Sort)
      Node 14492 (Hash Join) [PATTERN: 2e0f44ef]
        Node 14493 (Nested Loop) [consumed]
          Node 14494 (Hash Join) [PATTERN: 2e0f44ef]
            Node 14495 (Nested Loop) [consumed]
              Node 14496 (Hash Join) [PATTERN: 895c6e8c]
                Node 14497 (Seq Scan) [consumed] - LEAF
                Node 14498 (Hash) [consumed]
                  Node 14499 (Hash Join)
                    Node 14500 (Seq Scan) - LEAF
                    Node 14501 (Hash) [PATTERN: a54055ce]
                      Node 14502 (Hash Join) [consumed]
                        Node 14503 (Seq Scan) [consumed] - LEAF
                        Node 14504 (Hash) [consumed]
                          Node 14505 (Seq Scan) [consumed] - LEAF
              Node 14506 (Index Scan) - LEAF
            Node 14507 (Hash) [consumed]
              Node 14508 (Seq Scan) - LEAF
          Node 14509 (Index Scan) - LEAF
        Node 14510 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 14501 | 14489, 14490, 14492, 14493, 14494, 14495, 14496, 14497, 14498, 14502, 14503, 14504, 14505, 14507, 14510 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 14496 | 14489, 14490, 14492, 14493, 14494, 14495, 14497, 14498, 14501, 14502, 14503, 14504, 14505, 14507, 14510 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 14492 | 14489, 14490, 14493, 14494, 14495, 14496, 14497, 14498, 14501, 14502, 14503, 14504, 14505, 14507, 14510 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 14494 | 14489, 14490, 14492, 14493, 14495, 14496, 14497, 14498, 14501, 14502, 14503, 14504, 14505, 14507, 14510 |
| Aggregate -> Gather Merge (Out | 2724c080 | 14489 | 14490, 14492, 14493, 14494, 14495, 14496, 14497, 14498, 14501, 14502, 14503, 14504, 14505, 14507, 14510 |
...
| 14491 | Sort | 1221.68 | 1096.02 | 10.3% | operator |
| 14492 | Hash Join | 1221.43 | 1199.17 | 1.8% | pattern |
| 14494 | Hash Join | 1217.22 | 1192.81 | 2.0% | pattern |
| 14509 | Index Scan | 0.01 | 0.05 | 753.5% | operator |
| 14511 | Seq Scan | 0.01 | 7.19 | 65304.3% | operator |
| 14496 | Hash Join | 214.50 | 260.30 | 21.4% | pattern |
| 14506 | Index Scan | 0.04 | 0.09 | 107.2% | operator |
| 14508 | Seq Scan | 41.16 | 44.48 | 8.1% | operator |
| 14499 | Hash Join | 35.40 | 67.79 | 91.5% | operator |
| 14500 | Seq Scan | 33.83 | 24.87 | 26.5% | operator |
| 14501 | Hash | 0.21 | 0.20 | 8.7% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 14500 (Seq Scan) - LEAF
...
### Step 2: Node 14501 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 14489, 14490, 14492, 14493, 14494, 14495, 14496, 14497, 14498, 14502, 14503, 14504, 14505, 14507, 14510
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 4: Node 14496 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 14489, 14490, 14492, 14493, 14494, 14495, 14497, 14498, 14501, 14502, 14503, 14504, 14505, 14507, 14510
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=29497
  - HashJoin_nt1=147487
...
### Step 5: Node 14506 (Index Scan) - LEAF
...
### Step 6: Node 14508 (Seq Scan) - LEAF
...
### Step 7: Node 14494 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 14489, 14490, 14492, 14493, 14495, 14496, 14497, 14498, 14501, 14502, 14503, 14504, 14505, 14507, 14510
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=800
  - HashJoin_nt1=118013
...
### Step 8: Node 14509 (Index Scan) - LEAF
...
### Step 9: Node 14511 (Seq Scan) - LEAF
...
### Step 10: Node 14492 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 14489, 14490, 14493, 14494, 14495, 14496, 14497, 14498, 14501, 14502, 14503, 14504, 14505, 14507, 14510
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=800
  - HashJoin_nt1=800
...
### Step 12: Node 14489 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 14490, 14492, 14493, 14494, 14495, 14496, 14497, 14498, 14501, 14502, 14503, 14504, 14505, 14507, 14510
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2480
