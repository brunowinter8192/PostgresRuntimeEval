...
```
Node 14489 (Aggregate) [PATTERN: 53f9aa07] - ROOT
  Node 14490 (Gather Merge) [consumed]
    Node 14491 (Sort) [consumed]
      Node 14492 (Hash Join) [consumed]
        Node 14493 (Nested Loop) [consumed]
          Node 14494 (Hash Join)
            Node 14495 (Nested Loop) [PATTERN: bd9dfa7b]
              Node 14496 (Hash Join) [consumed]
              ...
              Node 14506 (Index Scan) [consumed] - LEAF
            Node 14507 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 53f9aa07 | 14489 | 14490, 14491, 14492, 14493, 14495, 14496, 14497, 14498, 14499, 14501, 14502, 14503, 14504, 14505, 14506, 14510 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 14501 | 14489, 14490, 14491, 14492, 14493, 14495, 14496, 14497, 14498, 14499, 14502, 14503, 14504, 14505, 14506, 14510 |
| Nested Loop -> [Hash Join -> [ | bd9dfa7b | 14495 | 14489, 14490, 14491, 14492, 14493, 14496, 14497, 14498, 14499, 14501, 14502, 14503, 14504, 14505, 14506, 14510 |
...
|------|------|--------|-----------|-----|--------|
| 14489 | Aggregate | 1227.16 | 1220.49 | 0.5% | pattern |
| 14494 | Hash Join | 1217.22 | 1042.87 | 14.3% | operator |
| 14509 | Index Scan | 0.01 | 0.05 | 753.5% | operator |
| 14511 | Seq Scan | 0.01 | 7.19 | 65304.3% | operator |
| 14495 | Nested Loop | 1171.35 | 1155.06 | 1.4% | pattern |
...
- **Consumes:** Nodes 14489, 14490, 14491, 14492, 14493, 14495, 14496, 14497, 14498, 14499, 14502, 14503, 14504, 14505, 14506, 14510
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 3: Node 14508 (Seq Scan) - LEAF
...
### Step 4: Node 14495 (Nested Loop) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bd9dfa7b (Nested Loop -> [Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer), Index Scan (Inner)])
- **Consumes:** Nodes 14489, 14490, 14491, 14492, 14493, 14496, 14497, 14498, 14499, 14501, 14502, 14503, 14504, 14505, 14506, 14510
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 7: Node 14509 (Index Scan) - LEAF
...
### Step 8: Node 14511 (Seq Scan) - LEAF
...
### Step 9: Node 14489 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 53f9aa07 (Aggregate -> Gather Merge -> Sort -> Hash Join -> [Nested Loop (Outer), Hash (Inner)] (Outer) (Outer) (Outer))
- **Consumes:** Nodes 14490, 14491, 14492, 14493, 14495, 14496, 14497, 14498, 14499, 14501, 14502, 14503, 14504, 14505, 14506, 14510
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2480
