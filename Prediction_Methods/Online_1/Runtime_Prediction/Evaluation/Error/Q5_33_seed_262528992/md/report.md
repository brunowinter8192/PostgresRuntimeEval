        ...
        Node 8425 (Sort) [consumed]
          Node 8426 (Hash Join) [consumed]
            Node 8427 (Nested Loop) [consumed]
              ...
              Node 8438 (Index Scan) [consumed] - LEAF
            Node 8439 (Hash) [consumed]
              Node 8440 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather Me | 255215ee | 8421 | 8422, 8423, 8424, 8425, 8426, 8427, 8428, 8429, 8430, 8431, 8432, 8433, 8434, 8438, 8439, 8440 |
...
|------|------|--------|-----------|-----|--------|
| 8421 | Sort | 1078.40 | 1070.44 | 0.7% | pattern |
...
### Step 4: Node 8421 (Sort) - PATTERN ROOT
...
- **Consumes:** Nodes 8422, 8423, 8424, 8425, 8426, 8427, 8428, 8429, 8430, 8431, 8432, 8433, 8434, 8438, 8439, 8440
- **Input Features:**
