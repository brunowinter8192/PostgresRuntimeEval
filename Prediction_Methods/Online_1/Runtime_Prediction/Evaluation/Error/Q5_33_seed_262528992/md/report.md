              ...
              Node 8428 (Hash Join) [PATTERN: 895c6e8c]
                ...
                Node 8430 (Hash) [consumed]
                  Node 8431 (Hash Join)
                    ...
                    Node 8433 (Hash) [PATTERN: a54055ce]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 8433 | 8421, 8422, 8426, 8427, 8428, 8429, 8430, 8434, 8435, 8436, 8437, 8439 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 8428 | 8421, 8422, 8426, 8427, 8429, 8430, 8433, 8434, 8435, 8436, 8437, 8439 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 8426 | 8421, 8422, 8427, 8428, 8429, 8430, 8433, 8434, 8435, 8436, 8437, 8439 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 8421 | 8422, 8426, 8427, 8428, 8429, 8430, 8433, 8434, 8435, 8436, 8437, 8439 |
...
| 8431 | Hash Join | 34.59 | 62.70 | 81.3% | operator |
| 8432 | Seq Scan | 32.85 | 24.87 | 24.3% | operator |
| 8433 | Hash | 0.36 | 0.14 | 62.2% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 8432 (Seq Scan) - LEAF
...
### Step 2: Node 8433 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 8421, 8422, 8426, 8427, 8428, 8429, 8430, 8434, 8435, 8436, 8437, 8439
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 4: Node 8428 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 8421, 8422, 8426, 8427, 8429, 8430, 8433, 8434, 8435, 8436, 8437, 8439
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14884
  - HashJoin_nt1=74418
...
### Step 5: Node 8438 (Index Scan) - LEAF
...
### Step 6: Node 8440 (Seq Scan) - LEAF
...
### Step 7: Node 8426 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 8421, 8422, 8427, 8428, 8429, 8430, 8433, 8434, 8435, 8436, 8437, 8439
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=2382
  - HashJoin_nt1=59546
...
### Step 10: Node 8423 (Gather Merge)
...
### Step 11: Node 8421 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 8422, 8426, 8427, 8428, 8429, 8430, 8433, 8434, 8435, 8436, 8437, 8439
- **Input Features:**
