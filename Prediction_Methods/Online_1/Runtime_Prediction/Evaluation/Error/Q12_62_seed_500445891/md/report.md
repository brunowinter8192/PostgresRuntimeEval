...
```
Node 25076 (Aggregate) [PATTERN: f9c97829] - ROOT
  Node 25077 (Gather Merge) [consumed]
    Node 25078 (Aggregate) [consumed]
      Node 25079 (Sort) [consumed]
        Node 25080 (Nested Loop) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> A | f9c97829 | 25076 | 25077, 25078, 25079, 25080, 25081, 25082 |
...
|------|------|--------|-----------|-----|--------|
| 25076 | Aggregate | 1018.89 | 998.49 | 2.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25076 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 25077, 25078, 25079, 25080, 25081, 25082
- **Input Features:**
  ...
  - Aggregate_Outer_startup_cost=147554.9900
  - Aggregate_Outer_total_cost=147671.0000
  - Aggregate_np=0
  - Aggregate_nt=7
  - Aggregate_nt1=35
  - Aggregate_nt2=0
  ...
  - NestedLoop_Outer_nt=5797
  - NestedLoop_Outer_nt1=5797
  ...
  - NestedLoop_Outer_total_cost=147192.6500
  ...
  - Sort_Outer_startup_cost=147554.9900
  - Sort_Outer_total_cost=147569.4800
