    ...
    Node 20204 (Aggregate) [consumed]
      Node 20205 (Gather) [consumed]
        Node 20206 (Hash Join) [consumed]
          Node 20207 (Hash Join) [PATTERN: 2873b8c3]
            Node 20208 (Nested Loop) [consumed]
              Node 20209 (Seq Scan) [consumed] - LEAF
              Node 20210 (Index Scan) [consumed] - LEAF
            Node 20211 (Hash) [consumed]
              Node 20212 (Seq Scan) [consumed] - LEAF
          Node 20213 (Hash)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 20202 | 20203, 20204, 20205, 20206, 20207, 20208, 20209, 20210, 20211, 20212 |
| Hash Join -> [Nested Loop -> [ | 2873b8c3 | 20207 | 20202, 20203, 20204, 20205, 20206, 20208, 20209, 20210, 20211, 20212 |
...
### Step 2: Node 20207 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2873b8c3 (Hash Join -> [Nested Loop -> [Seq Scan (Outer), Index Scan (Inner)] (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 20202, 20203, 20204, 20205, 20206, 20208, 20209, 20210, 20211, 20212
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18756
  - HashJoin_nt1=18756
...
### Step 4: Node 20202 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20203, 20204, 20205, 20206, 20207, 20208, 20209, 20210, 20211, 20212
- **Input Features:**
