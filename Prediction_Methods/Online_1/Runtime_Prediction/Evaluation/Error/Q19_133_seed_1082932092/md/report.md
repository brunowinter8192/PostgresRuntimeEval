...
```
Node 31472 (Aggregate) [PATTERN: f8295d8b] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 31472 | 31473, 31474, 31475, 31476, 31477, 31478 |
...
|------|------|--------|-----------|-----|--------|
| 31472 | Aggregate | 898.21 | 841.17 | 6.4% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31472 (Aggregate) - PATTERN ROOT
