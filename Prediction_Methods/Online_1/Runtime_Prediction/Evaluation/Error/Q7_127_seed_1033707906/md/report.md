...
```
Node 11023 (Aggregate) [PATTERN: 27c3eea9] - ROOT
  Node 11024 (Gather Merge) [consumed]
    Node 11025 (Sort) [consumed]
      Node 11026 (Hash Join) [consumed]
        Node 11027 (Nested Loop) [consumed]
          Node 11028 (Hash Join) [consumed]
          ...
          Node 11035 (Index Scan) [consumed] - LEAF
        Node 11036 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 27c3eea9 | 11023 | 11024, 11025, 11026, 11027, 11028, 11030, 11031, 11032, 11033, 11034, 11035, 11036, 11037 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 11030 | 11023, 11024, 11025, 11026, 11027, 11028, 11031, 11032, 11033, 11034, 11035, 11036, 11037 |
...
|------|------|--------|-----------|-----|--------|
| 11023 | Aggregate | 1212.60 | 1200.90 | 1.0% | pattern |
...
### Step 1: Node 11040 (Seq Scan) - LEAF
...
### Step 2: Node 11029 (Seq Scan) - LEAF
...
### Step 3: Node 11030 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 11023, 11024, 11025, 11026, 11027, 11028, 11031, 11032, 11033, 11034, 11035, 11036, 11037
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 11038 (Seq Scan) - LEAF
...
### Step 6: Node 11023 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 11024, 11025, 11026, 11027, 11028, 11030, 11031, 11032, 11033, 11034, 11035, 11036, 11037
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
