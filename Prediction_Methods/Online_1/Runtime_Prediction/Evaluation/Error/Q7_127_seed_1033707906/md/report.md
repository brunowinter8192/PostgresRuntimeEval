      ...
      Node 11026 (Hash Join)
        Node 11027 (Nested Loop)
          Node 11028 (Hash Join)
            ...
            Node 11030 (Hash) [PATTERN: a54055ce]
              Node 11031 (Hash Join) [consumed]
                Node 11032 (Seq Scan) [consumed] - LEAF
                Node 11033 (Hash) [consumed]
                  Node 11034 (Seq Scan) [consumed] - LEAF
          Node 11035 (Index Scan) - LEAF
        Node 11036 (Hash) [PATTERN: a54055ce]
          Node 11037 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 11030 | 11023, 11024, 11031, 11032, 11033, 11034, 11036, 11037, 11038, 11039, 11040 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 11036 | 11023, 11024, 11030, 11031, 11032, 11033, 11034, 11037, 11038, 11039, 11040 |
| Aggregate -> Gather Merge (Out | 2724c080 | 11023 | 11024, 11030, 11031, 11032, 11033, 11034, 11036, 11037, 11038, 11039, 11040 |
...
| 11026 | Hash Join | 1205.13 | 1130.43 | 6.2% | operator |
| 11027 | Nested Loop | 1197.82 | 1145.81 | 4.3% | operator |
| 11036 | Hash | 3.66 | 3.42 | 6.5% | pattern |
| 11028 | Hash Join | 215.88 | 319.90 | 48.2% | operator |
| 11035 | Index Scan | 0.03 | 0.09 | 163.5% | operator |
| 11029 | Seq Scan | 155.88 | 192.19 | 23.3% | operator |
| 11030 | Hash | 35.02 | 35.59 | 1.6% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11029 (Seq Scan) - LEAF
...
### Step 2: Node 11030 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 11023, 11024, 11031, 11032, 11033, 11034, 11036, 11037, 11038, 11039, 11040
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 11035 (Index Scan) - LEAF
...
### Step 6: Node 11036 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 11023, 11024, 11030, 11031, 11032, 11033, 11034, 11037, 11038, 11039, 11040
- **Input Features:**
  - HashJoin_Outer_np=0
...
- **Consumes:** Nodes 11024, 11030, 11031, 11032, 11033, 11034, 11036, 11037, 11038, 11039, 11040
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
