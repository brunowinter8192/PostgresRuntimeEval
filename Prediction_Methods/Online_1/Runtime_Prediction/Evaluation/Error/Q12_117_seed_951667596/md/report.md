...
```
Node 24446 (Aggregate) [PATTERN: f9c97829] - ROOT
  Node 24447 (Gather Merge) [consumed]
    Node 24448 (Aggregate) [consumed]
      Node 24449 (Sort) [consumed]
        Node 24450 (Nested Loop) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> A | f9c97829 | 24446 | 24447, 24448, 24449, 24450, 24451, 24452 |
...
|------|------|--------|-----------|-----|--------|
| 24446 | Aggregate | 984.71 | 998.49 | 1.4% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24446 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 24447, 24448, 24449, 24450, 24451, 24452
- **Input Features:**
