        ...
        Node 7625 (Sort) [consumed]
          Node 7626 (Hash Join) [consumed]
            Node 7627 (Nested Loop) [consumed]
              ...
              Node 7638 (Index Scan) [consumed] - LEAF
            Node 7639 (Hash) [consumed]
              Node 7640 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather Me | 255215ee | 7621 | 7622, 7623, 7624, 7625, 7626, 7627, 7628, 7629, 7630, 7631, 7632, 7633, 7634, 7638, 7639, 7640 |
...
|------|------|--------|-----------|-----|--------|
| 7621 | Sort | 1078.37 | 1070.44 | 0.7% | pattern |
...
### Step 4: Node 7621 (Sort) - PATTERN ROOT
...
- **Consumes:** Nodes 7622, 7623, 7624, 7625, 7626, 7627, 7628, 7629, 7630, 7631, 7632, 7633, 7634, 7638, 7639, 7640
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=25
  - Aggregate_Outer_nt1=2382
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=136
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0105
  - Aggregate_Outer_startup_cost=57040.5100
  - Aggregate_Outer_total_cost=57070.5900
  ...
  - Sort_Outer_startup_cost=57040.5100
  - Sort_Outer_total_cost=57046.4600
  - Sort_np=0
  - Sort_nt=25
  - Sort_nt1=25
  - Sort_nt2=0
