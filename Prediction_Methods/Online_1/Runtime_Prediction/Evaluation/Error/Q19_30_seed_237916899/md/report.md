...
```
Node 31731 (Aggregate) [PATTERN: f8295d8b] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 31731 | 31732, 31733, 31734, 31735, 31736, 31737 |
...
|------|------|--------|-----------|-----|--------|
| 31731 | Aggregate | 847.41 | 841.17 | 0.7% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31731 (Aggregate) - PATTERN ROOT
