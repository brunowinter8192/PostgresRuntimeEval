...
```
Node 27344 (Aggregate) [PATTERN: f8295d8b] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 27344 | 27345, 27346, 27347, 27348, 27349, 27350 |
...
|------|------|--------|-----------|-----|--------|
| 27344 | Aggregate | 823.87 | 822.99 | 0.1% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27344 (Aggregate) - PATTERN ROOT
