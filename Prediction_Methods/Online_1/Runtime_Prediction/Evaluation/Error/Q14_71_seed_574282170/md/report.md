...
```
Node 27246 (Aggregate) [PATTERN: f8295d8b] - ROOT
  Node 27247 (Gather) [consumed]
    Node 27248 (Aggregate) [consumed]
      Node 27249 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 27246 | 27247, 27248, 27249, 27250, 27251, 27252 |
...
|------|------|--------|-----------|-----|--------|
| 27246 | Aggregate | 830.86 | 822.70 | 1.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27246 (Aggregate) - PATTERN ROOT
