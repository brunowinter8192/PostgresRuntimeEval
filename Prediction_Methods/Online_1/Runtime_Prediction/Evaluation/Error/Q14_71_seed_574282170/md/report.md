...
Node 27246 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 27247 (Gather) [consumed]
    Node 27248 (Aggregate) [consumed]
      Node 27249 (Hash Join) [PATTERN: f4cb205a]
        Node 27250 (Seq Scan) [consumed] - LEAF
        Node 27251 (Hash) [consumed]
          Node 27252 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 27249 | 27246, 27247, 27248, 27250, 27251, 27252 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 27246 | 27247, 27248, 27249, 27250, 27251, 27252 |
...
| 27249 | Hash Join | 808.81 | 397.08 | 50.9% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27249 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 27246, 27247, 27248, 27250, 27251, 27252
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=15403
  - HashJoin_nt1=15403
  ...
  - HashJoin_total_cost=136647.0700
  - Hash_Inner_np=0
  - Hash_Inner_nt=83333
...
### Step 2: Node 27246 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 27247, 27248, 27249, 27250, 27251, 27252
- **Input Features:**
