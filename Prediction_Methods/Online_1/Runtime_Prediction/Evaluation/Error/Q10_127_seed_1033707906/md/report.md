  ...
  Node 19748 (Sort) [consumed]
    Node 19749 (Aggregate) [consumed]
      Node 19750 (Gather) [consumed]
        Node 19751 (Hash Join) [PATTERN: 7a51ce50]
          Node 19752 (Hash Join) [consumed]
          ...
          Node 19758 (Hash) [consumed]
            Node 19759 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Hash Join -> [Ne | 7a51ce50 | 19751 | 19747, 19748, 19749, 19750, 19752, 19753, 19754, 19755, 19756, 19757, 19758, 19759 |
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19747 | 19748, 19749, 19750, 19751, 19752, 19753, 19754, 19755, 19756, 19757, 19758, 19759 |
...
| 19751 | Hash Join | 1074.09 | 730.63 | 32.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 19751 (Hash Join) - PATTERN ROOT
...
- **Consumes:** Nodes 19747, 19748, 19749, 19750, 19752, 19753, 19754, 19755, 19756, 19757, 19758, 19759
- **Input Features:**
  - HashJoin_Outer_np=0
  ...
  - HashJoin_Outer_total_cost=80674.8300
  - HashJoin_np=0
  - HashJoin_nt=18043
  - HashJoin_nt1=18043
  - HashJoin_nt2=25
  ...
  - HashJoin_total_cost=80731.7900
  - Hash_Inner_np=0
  - Hash_Inner_nt=62500
...
- **Output:** st=37.23, rt=730.63

### Step 2: Node 19747 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19748, 19749, 19750, 19751, 19752, 19753, 19754, 19755, 19756, 19757, 19758, 19759
- **Input Features:**
