    ...
    Node 19749 (Aggregate) [consumed]
      Node 19750 (Gather) [consumed]
        Node 19751 (Hash Join) [consumed]
          Node 19752 (Hash Join) [PATTERN: 2873b8c3]
            Node 19753 (Nested Loop) [consumed]
              Node 19754 (Seq Scan) [consumed] - LEAF
              Node 19755 (Index Scan) [consumed] - LEAF
            Node 19756 (Hash) [consumed]
              Node 19757 (Seq Scan) [consumed] - LEAF
          Node 19758 (Hash)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 19747 | 19748, 19749, 19750, 19751, 19752, 19753, 19754, 19755, 19756, 19757 |
| Hash Join -> [Nested Loop -> [ | 2873b8c3 | 19752 | 19747, 19748, 19749, 19750, 19751, 19753, 19754, 19755, 19756, 19757 |
...
### Step 2: Node 19752 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2873b8c3 (Hash Join -> [Nested Loop -> [Seq Scan (Outer), Index Scan (Inner)] (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 19747, 19748, 19749, 19750, 19751, 19753, 19754, 19755, 19756, 19757
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18043
  - HashJoin_nt1=18043
...
- **Output:** st=36.97, rt=725.09

### Step 3: Node 19758 (Hash)
...
### Step 4: Node 19747 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19748, 19749, 19750, 19751, 19752, 19753, 19754, 19755, 19756, 19757
- **Input Features:**
