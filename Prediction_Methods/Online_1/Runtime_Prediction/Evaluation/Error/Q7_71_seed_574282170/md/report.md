...
```
Node 12625 (Aggregate) - ROOT
  Node 12626 (Gather Merge)
    Node 12627 (Sort)
      Node 12628 (Hash Join)
        Node 12629 (Nested Loop)
          Node 12630 (Hash Join)
            Node 12631 (Seq Scan) - LEAF
            Node 12632 (Hash)
              Node 12633 (Hash Join)
                Node 12634 (Seq Scan) - LEAF
                Node 12635 (Hash)
                  Node 12636 (Seq Scan) - LEAF
          Node 12637 (Index Scan) - LEAF
        Node 12638 (Hash)
          Node 12639 (Hash Join)
            Node 12640 (Seq Scan) - LEAF
            Node 12641 (Hash)
              Node 12642 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 12625 | Aggregate | 1202.99 | 1202.22 | 0.1% | operator |
| 12626 | Gather Merge | 1201.88 | 1148.45 | 4.4% | operator |
| 12627 | Sort | 1194.69 | 1149.87 | 3.8% | operator |
| 12628 | Hash Join | 1194.05 | 1130.50 | 5.3% | operator |
| 12629 | Nested Loop | 1187.40 | 1145.81 | 3.5% | operator |
| 12638 | Hash | 2.88 | 15.44 | 435.2% | operator |
| 12630 | Hash Join | 214.79 | 319.53 | 48.8% | operator |
| 12637 | Index Scan | 0.03 | 0.09 | 171.7% | operator |
| 12639 | Hash Join | 2.84 | 49.64 | 1648.4% | operator |
| 12631 | Seq Scan | 152.48 | 192.19 | 26.0% | operator |
| 12632 | Hash | 36.32 | 17.27 | 52.5% | operator |
| 12640 | Seq Scan | 2.49 | 10.62 | 326.0% | operator |
| 12641 | Hash | 0.01 | 14.54 | 96814.4% | operator |
| 12633 | Hash Join | 35.98 | 54.15 | 50.5% | operator |
| 12642 | Seq Scan | 0.01 | 7.20 | 59866.2% | operator |
| 12634 | Seq Scan | 34.84 | 24.87 | 28.6% | operator |
| 12635 | Hash | 0.01 | 14.54 | 145271.6% | operator |
| 12636 | Seq Scan | 0.01 | 7.20 | 119832.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12636 (Seq Scan) - LEAF
...
### Step 2: Node 12634 (Seq Scan) - LEAF
...
### Step 5: Node 12642 (Seq Scan) - LEAF
...
### Step 6: Node 12631 (Seq Scan) - LEAF
...
### Step 8: Node 12640 (Seq Scan) - LEAF
...
### Step 11: Node 12637 (Index Scan) - LEAF
...
### Step 13: Node 12629 (Nested Loop)
...
### Step 17: Node 12626 (Gather Merge)
...
### Step 18: Node 12625 (Aggregate) - ROOT
