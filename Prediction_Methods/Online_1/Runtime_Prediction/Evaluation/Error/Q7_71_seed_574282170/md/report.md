      ...
      Node 12628 (Hash Join)
        Node 12629 (Nested Loop)
          Node 12630 (Hash Join)
            ...
            Node 12632 (Hash) [PATTERN: a54055ce]
              Node 12633 (Hash Join) [consumed]
                Node 12634 (Seq Scan) [consumed] - LEAF
                Node 12635 (Hash) [consumed]
                  Node 12636 (Seq Scan) [consumed] - LEAF
          Node 12637 (Index Scan) - LEAF
        Node 12638 (Hash) [PATTERN: a54055ce]
          Node 12639 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 12632 | 12625, 12626, 12633, 12634, 12635, 12636, 12638, 12639, 12640, 12641, 12642 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 12638 | 12625, 12626, 12632, 12633, 12634, 12635, 12636, 12639, 12640, 12641, 12642 |
| Aggregate -> Gather Merge (Out | 2724c080 | 12625 | 12626, 12632, 12633, 12634, 12635, 12636, 12638, 12639, 12640, 12641, 12642 |
...
| 12628 | Hash Join | 1194.05 | 1130.43 | 5.3% | operator |
| 12629 | Nested Loop | 1187.40 | 1145.81 | 3.5% | operator |
| 12638 | Hash | 2.88 | 3.42 | 18.6% | pattern |
| 12630 | Hash Join | 214.79 | 319.90 | 48.9% | operator |
| 12637 | Index Scan | 0.03 | 0.09 | 171.7% | operator |
| 12631 | Seq Scan | 152.48 | 192.19 | 26.0% | operator |
| 12632 | Hash | 36.32 | 35.59 | 2.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 12631 (Seq Scan) - LEAF
...
### Step 2: Node 12632 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 12625, 12626, 12633, 12634, 12635, 12636, 12638, 12639, 12640, 12641, 12642
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 12637 (Index Scan) - LEAF
...
### Step 6: Node 12638 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 12625, 12626, 12632, 12633, 12634, 12635, 12636, 12639, 12640, 12641, 12642
- **Input Features:**
  - HashJoin_Outer_np=0
...
- **Consumes:** Nodes 12626, 12632, 12633, 12634, 12635, 12636, 12638, 12639, 12640, 12641, 12642
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
