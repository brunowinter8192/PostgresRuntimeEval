...
```
Node 12625 (Aggregate) [PATTERN: 27c3eea9] - ROOT
  Node 12626 (Gather Merge) [consumed]
    Node 12627 (Sort) [consumed]
      Node 12628 (Hash Join) [consumed]
        Node 12629 (Nested Loop) [consumed]
          Node 12630 (Hash Join) [consumed]
          ...
          Node 12637 (Index Scan) [consumed] - LEAF
        Node 12638 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 27c3eea9 | 12625 | 12626, 12627, 12628, 12629, 12630, 12632, 12633, 12634, 12635, 12636, 12637, 12638, 12639 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 12632 | 12625, 12626, 12627, 12628, 12629, 12630, 12633, 12634, 12635, 12636, 12637, 12638, 12639 |
...
|------|------|--------|-----------|-----|--------|
| 12625 | Aggregate | 1202.99 | 1200.90 | 0.2% | pattern |
...
### Step 1: Node 12642 (Seq Scan) - LEAF
...
### Step 2: Node 12631 (Seq Scan) - LEAF
...
### Step 3: Node 12632 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 12625, 12626, 12627, 12628, 12629, 12630, 12633, 12634, 12635, 12636, 12637, 12638, 12639
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 12640 (Seq Scan) - LEAF
...
### Step 6: Node 12625 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 12626, 12627, 12628, 12629, 12630, 12632, 12633, 12634, 12635, 12636, 12637, 12638, 12639
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
