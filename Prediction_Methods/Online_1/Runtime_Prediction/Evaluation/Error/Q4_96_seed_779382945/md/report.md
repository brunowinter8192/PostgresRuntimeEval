...
```
Node 6866 (Aggregate) [PATTERN: 80bd802d] - ROOT
  Node 6867 (Gather Merge) [consumed]
    Node 6868 (Sort) [consumed]
      Node 6869 (Aggregate) [consumed]
        Node 6870 (Nested Loop) [consumed]
          Node 6871 (Seq Scan) [consumed] - LEAF
          Node 6872 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 80bd802d | 6866 | 6867, 6868, 6869, 6870, 6871, 6872 |
...
|------|------|--------|-----------|-----|--------|
| 6866 | Aggregate | 1077.77 | 1057.79 | 1.9% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6866 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 6867, 6868, 6869, 6870, 6871, 6872
- **Input Features:**
  ...
  - NestedLoop_Outer_nt=15055
  - NestedLoop_Outer_nt1=18462
  ...
  - NestedLoop_Outer_total_cost=65980.7300
  - SeqScan_Outer_np=26136
  - SeqScan_Outer_nt=18462
  - SeqScan_Outer_nt1=0
  - SeqScan_Outer_nt2=0
