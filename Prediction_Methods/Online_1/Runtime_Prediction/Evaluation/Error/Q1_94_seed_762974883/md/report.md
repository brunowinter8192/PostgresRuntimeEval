...
```
Node 716 (Aggregate) [PATTERN: 3dfa6025] - ROOT
  Node 717 (Gather Merge) [consumed]
    Node 718 (Sort) [consumed]
      Node 719 (Aggregate) [consumed]
        Node 720 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 3dfa6025 | 716 | 717, 718, 719, 720 |
...
|------|------|--------|-----------|-----|--------|
| 716 | Aggregate | 944.34 | 953.98 | 1.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 716 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3dfa6025 (Aggregate -> Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 717, 718, 719, 720
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=6
  - Aggregate_Outer_nt1=1182295
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=236
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=168983.3600
  - Aggregate_Outer_total_cost=168983.5000
  - Aggregate_np=0
  - Aggregate_nt=6
  - Aggregate_nt1=30
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=169983.6500
  - Aggregate_total_cost=169988.4200
  ...
  - GatherMerge_Outer_startup_cost=169983.6500
  - GatherMerge_Outer_total_cost=169987.2800
  - SeqScan_Outer_np=112600
  - SeqScan_Outer_nt=1182295
  - SeqScan_Outer_nt1=0
  - SeqScan_Outer_nt2=0
  - SeqScan_Outer_parallel_workers=0
  - SeqScan_Outer_plan_width=25
  - SeqScan_Outer_reltuples=6001215.0000
  - SeqScan_Outer_sel=0.1970
  ...
  - Sort_Outer_startup_cost=168983.5800
  - Sort_Outer_total_cost=168983.5900
