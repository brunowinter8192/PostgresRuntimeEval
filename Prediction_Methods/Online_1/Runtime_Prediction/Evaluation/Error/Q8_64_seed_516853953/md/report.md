...
Node 15731 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 15732 (Gather Merge) [consumed]
    Node 15733 (Sort)
      Node 15734 (Hash Join) [PATTERN: 2e0f44ef]
        Node 15735 (Nested Loop) [consumed]
          Node 15736 (Hash Join) [PATTERN: 2e0f44ef]
            Node 15737 (Nested Loop) [consumed]
              Node 15738 (Hash Join) [PATTERN: 895c6e8c]
                Node 15739 (Seq Scan) [consumed] - LEAF
                Node 15740 (Hash) [consumed]
                  Node 15741 (Hash Join)
                    Node 15742 (Seq Scan) - LEAF
                    Node 15743 (Hash) [PATTERN: a54055ce]
                      Node 15744 (Hash Join) [consumed]
                        Node 15745 (Seq Scan) [consumed] - LEAF
                        Node 15746 (Hash) [consumed]
                          Node 15747 (Seq Scan) [consumed] - LEAF
              Node 15748 (Index Scan) - LEAF
            Node 15749 (Hash) [consumed]
              Node 15750 (Seq Scan) - LEAF
          Node 15751 (Index Scan) - LEAF
        Node 15752 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 15743 | 15731, 15732, 15734, 15735, 15736, 15737, 15738, 15739, 15740, 15744, 15745, 15746, 15747, 15749, 15752 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 15738 | 15731, 15732, 15734, 15735, 15736, 15737, 15739, 15740, 15743, 15744, 15745, 15746, 15747, 15749, 15752 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 15734 | 15731, 15732, 15735, 15736, 15737, 15738, 15739, 15740, 15743, 15744, 15745, 15746, 15747, 15749, 15752 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 15736 | 15731, 15732, 15734, 15735, 15737, 15738, 15739, 15740, 15743, 15744, 15745, 15746, 15747, 15749, 15752 |
| Aggregate -> Gather Merge (Out | 2724c080 | 15731 | 15732, 15734, 15735, 15736, 15737, 15738, 15739, 15740, 15743, 15744, 15745, 15746, 15747, 15749, 15752 |
...
| 15733 | Sort | 1258.09 | 1096.02 | 12.9% | operator |
| 15734 | Hash Join | 1257.82 | 1199.17 | 4.7% | pattern |
| 15736 | Hash Join | 1253.47 | 1192.82 | 4.8% | pattern |
| 15751 | Index Scan | 0.01 | 0.05 | 753.5% | operator |
| 15753 | Seq Scan | 0.01 | 7.19 | 71844.7% | operator |
| 15738 | Hash Join | 216.88 | 260.30 | 20.0% | pattern |
| 15748 | Index Scan | 0.04 | 0.09 | 102.4% | operator |
| 15750 | Seq Scan | 39.14 | 44.48 | 13.7% | operator |
| 15741 | Hash Join | 34.38 | 67.79 | 97.2% | operator |
| 15742 | Seq Scan | 32.94 | 24.87 | 24.5% | operator |
| 15743 | Hash | 0.14 | 0.20 | 36.6% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 15742 (Seq Scan) - LEAF
...
### Step 2: Node 15743 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 15731, 15732, 15734, 15735, 15736, 15737, 15738, 15739, 15740, 15744, 15745, 15746, 15747, 15749, 15752
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 4: Node 15738 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 15731, 15732, 15734, 15735, 15736, 15737, 15739, 15740, 15743, 15744, 15745, 15746, 15747, 15749, 15752
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=29497
  - HashJoin_nt1=147487
...
### Step 5: Node 15748 (Index Scan) - LEAF
...
### Step 6: Node 15750 (Seq Scan) - LEAF
...
### Step 7: Node 15736 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 15731, 15732, 15734, 15735, 15737, 15738, 15739, 15740, 15743, 15744, 15745, 15746, 15747, 15749, 15752
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=786
  - HashJoin_nt1=118013
  ...
  - HashJoin_reltuples=0.0000
  - HashJoin_sel=0.0000
  - HashJoin_startup_cost=9920.1300
  - HashJoin_total_cost=70271.6000
  - Hash_Inner_np=0
  - Hash_Inner_nt=555
  - Hash_Inner_nt1=555
  - Hash_Inner_nt2=0
...
### Step 8: Node 15751 (Index Scan) - LEAF
...
### Step 9: Node 15753 (Seq Scan) - LEAF
...
### Step 10: Node 15734 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 15731, 15732, 15735, 15736, 15737, 15738, 15739, 15740, 15743, 15744, 15745, 15746, 15747, 15749, 15752
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=786
  - HashJoin_nt1=786
  ...
  - HashJoin_reltuples=0.0000
  - HashJoin_sel=0.0400
  - HashJoin_startup_cost=9921.9700
  - HashJoin_total_cost=70515.3400
  - Hash_Inner_np=0
  - Hash_Inner_nt=25
  - Hash_Inner_nt1=25
  - Hash_Inner_nt2=0
  ...
  - NestedLoop_Outer_np=0
  - NestedLoop_Outer_nt=786
  - NestedLoop_Outer_nt1=786
  - NestedLoop_Outer_nt2=1
  - NestedLoop_Outer_parallel_workers=0
  - NestedLoop_Outer_plan_width=20
  - NestedLoop_Outer_reltuples=0.0000
  - NestedLoop_Outer_sel=1.0000
  - NestedLoop_Outer_startup_cost=9920.4100
  - NestedLoop_Outer_total_cost=70509.4000
- **Output:** st=80.31, rt=1199.17

### Step 11: Node 15733 (Sort)
...
### Step 12: Node 15731 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 15732, 15734, 15735, 15736, 15737, 15738, 15739, 15740, 15743, 15744, 15745, 15746, 15747, 15749, 15752
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2438
