...
Node 14673 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 14674 (Gather Merge) [consumed]
    Node 14675 (Sort)
      Node 14676 (Hash Join) [PATTERN: 2e0f44ef]
        Node 14677 (Nested Loop) [consumed]
          Node 14678 (Hash Join) [PATTERN: 2e0f44ef]
            Node 14679 (Nested Loop) [consumed]
              Node 14680 (Hash Join) [PATTERN: 895c6e8c]
                Node 14681 (Seq Scan) [consumed] - LEAF
                Node 14682 (Hash) [consumed]
                  Node 14683 (Hash Join)
                    Node 14684 (Seq Scan) - LEAF
                    Node 14685 (Hash) [PATTERN: a54055ce]
                      Node 14686 (Hash Join) [consumed]
                        Node 14687 (Seq Scan) [consumed] - LEAF
                        Node 14688 (Hash) [consumed]
                          Node 14689 (Seq Scan) [consumed] - LEAF
              Node 14690 (Index Scan) - LEAF
            Node 14691 (Hash) [consumed]
              Node 14692 (Seq Scan) - LEAF
          Node 14693 (Index Scan) - LEAF
        Node 14694 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 14685 | 14673, 14674, 14676, 14677, 14678, 14679, 14680, 14681, 14682, 14686, 14687, 14688, 14689, 14691, 14694 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 14680 | 14673, 14674, 14676, 14677, 14678, 14679, 14681, 14682, 14685, 14686, 14687, 14688, 14689, 14691, 14694 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 14676 | 14673, 14674, 14677, 14678, 14679, 14680, 14681, 14682, 14685, 14686, 14687, 14688, 14689, 14691, 14694 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 14678 | 14673, 14674, 14676, 14677, 14679, 14680, 14681, 14682, 14685, 14686, 14687, 14688, 14689, 14691, 14694 |
| Aggregate -> Gather Merge (Out | 2724c080 | 14673 | 14674, 14676, 14677, 14678, 14679, 14680, 14681, 14682, 14685, 14686, 14687, 14688, 14689, 14691, 14694 |
...
| 14675 | Sort | 1204.97 | 1096.01 | 9.0% | operator |
| 14676 | Hash Join | 1204.72 | 1199.17 | 0.5% | pattern |
| 14678 | Hash Join | 1200.56 | 1192.84 | 0.6% | pattern |
| 14693 | Index Scan | 0.01 | 0.05 | 753.5% | operator |
| 14695 | Seq Scan | 0.01 | 7.19 | 65304.3% | operator |
| 14680 | Hash Join | 216.60 | 260.30 | 20.2% | pattern |
| 14690 | Index Scan | 0.04 | 0.09 | 112.3% | operator |
| 14692 | Seq Scan | 41.46 | 44.49 | 7.3% | operator |
| 14683 | Hash Join | 37.63 | 67.79 | 80.2% | operator |
| 14684 | Seq Scan | 35.83 | 24.87 | 30.6% | operator |
| 14685 | Hash | 0.51 | 0.20 | 61.4% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 14684 (Seq Scan) - LEAF
...
### Step 2: Node 14685 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 14673, 14674, 14676, 14677, 14678, 14679, 14680, 14681, 14682, 14686, 14687, 14688, 14689, 14691, 14694
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 4: Node 14680 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 14673, 14674, 14676, 14677, 14678, 14679, 14681, 14682, 14685, 14686, 14687, 14688, 14689, 14691, 14694
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=29497
  - HashJoin_nt1=147487
...
### Step 5: Node 14690 (Index Scan) - LEAF
...
### Step 6: Node 14692 (Seq Scan) - LEAF
...
### Step 7: Node 14678 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 14673, 14674, 14676, 14677, 14679, 14680, 14681, 14682, 14685, 14686, 14687, 14688, 14689, 14691, 14694
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=762
  - HashJoin_nt1=118013
  ...
  - HashJoin_reltuples=0.0000
  - HashJoin_sel=0.0000
  - HashJoin_startup_cost=9919.9100
  - HashJoin_total_cost=70271.3900
  - Hash_Inner_np=0
  - Hash_Inner_nt=538
  - Hash_Inner_nt1=538
  - Hash_Inner_nt2=0
...
### Step 8: Node 14693 (Index Scan) - LEAF
...
### Step 9: Node 14695 (Seq Scan) - LEAF
...
### Step 10: Node 14676 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 14673, 14674, 14677, 14678, 14679, 14680, 14681, 14682, 14685, 14686, 14687, 14688, 14689, 14691, 14694
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=762
  - HashJoin_nt1=762
  ...
  - HashJoin_reltuples=0.0000
  - HashJoin_sel=0.0400
  - HashJoin_startup_cost=9921.7600
  - HashJoin_total_cost=70507.7300
  - Hash_Inner_np=0
  - Hash_Inner_nt=25
  - Hash_Inner_nt1=25
  - Hash_Inner_nt2=0
  ...
  - NestedLoop_Outer_np=0
  - NestedLoop_Outer_nt=762
  - NestedLoop_Outer_nt1=762
  - NestedLoop_Outer_nt2=1
  - NestedLoop_Outer_parallel_workers=0
  - NestedLoop_Outer_plan_width=20
  - NestedLoop_Outer_reltuples=0.0000
  - NestedLoop_Outer_sel=1.0000
  - NestedLoop_Outer_startup_cost=9920.2000
  - NestedLoop_Outer_total_cost=70501.9300
- **Output:** st=80.32, rt=1199.17

### Step 11: Node 14675 (Sort)
...
### Step 12: Node 14673 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 14674, 14676, 14677, 14678, 14679, 14680, 14681, 14682, 14685, 14686, 14687, 14688, 14689, 14691, 14694
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2362
  - Aggregate_nt1=2362
