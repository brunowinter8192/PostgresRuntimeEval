...
```
Node 14673 (Aggregate) [PATTERN: 53f9aa07] - ROOT
  Node 14674 (Gather Merge) [consumed]
    Node 14675 (Sort) [consumed]
      Node 14676 (Hash Join) [consumed]
        Node 14677 (Nested Loop) [consumed]
          Node 14678 (Hash Join)
            Node 14679 (Nested Loop) [PATTERN: bd9dfa7b]
              Node 14680 (Hash Join) [consumed]
              ...
              Node 14690 (Index Scan) [consumed] - LEAF
            Node 14691 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 53f9aa07 | 14673 | 14674, 14675, 14676, 14677, 14679, 14680, 14681, 14682, 14683, 14685, 14686, 14687, 14688, 14689, 14690, 14694 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 14685 | 14673, 14674, 14675, 14676, 14677, 14679, 14680, 14681, 14682, 14683, 14686, 14687, 14688, 14689, 14690, 14694 |
| Nested Loop -> [Hash Join -> [ | bd9dfa7b | 14679 | 14673, 14674, 14675, 14676, 14677, 14680, 14681, 14682, 14683, 14685, 14686, 14687, 14688, 14689, 14690, 14694 |
...
|------|------|--------|-----------|-----|--------|
| 14673 | Aggregate | 1209.28 | 1220.55 | 0.9% | pattern |
| 14678 | Hash Join | 1200.56 | 1042.86 | 13.1% | operator |
| 14693 | Index Scan | 0.01 | 0.05 | 753.5% | operator |
| 14695 | Seq Scan | 0.01 | 7.19 | 65304.3% | operator |
| 14679 | Nested Loop | 1154.64 | 1155.06 | 0.0% | pattern |
...
- **Consumes:** Nodes 14673, 14674, 14675, 14676, 14677, 14679, 14680, 14681, 14682, 14683, 14686, 14687, 14688, 14689, 14690, 14694
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 3: Node 14692 (Seq Scan) - LEAF
...
### Step 4: Node 14679 (Nested Loop) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bd9dfa7b (Nested Loop -> [Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer), Index Scan (Inner)])
- **Consumes:** Nodes 14673, 14674, 14675, 14676, 14677, 14680, 14681, 14682, 14683, 14685, 14686, 14687, 14688, 14689, 14690, 14694
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 7: Node 14693 (Index Scan) - LEAF
...
### Step 8: Node 14695 (Seq Scan) - LEAF
...
### Step 9: Node 14673 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 53f9aa07 (Aggregate -> Gather Merge -> Sort -> Hash Join -> [Nested Loop (Outer), Hash (Inner)] (Outer) (Outer) (Outer))
- **Consumes:** Nodes 14674, 14675, 14676, 14677, 14679, 14680, 14681, 14682, 14683, 14685, 14686, 14687, 14688, 14689, 14690, 14694
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2362
  - Aggregate_nt1=2362
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=762
  - HashJoin_Outer_nt1=762
  - HashJoin_Outer_nt2=25
  - HashJoin_Outer_parallel_workers=0
  - HashJoin_Outer_plan_width=148
  - HashJoin_Outer_reltuples=0.0000
  - HashJoin_Outer_sel=0.0400
  - HashJoin_Outer_startup_cost=9921.7600
  - HashJoin_Outer_total_cost=70507.7300
  - Hash_Inner_np=0
  - Hash_Inner_nt=25
  - Hash_Inner_nt1=25
  - Hash_Inner_nt2=0
  ...
  - Sort_Outer_startup_cost=70544.2100
  - Sort_Outer_total_cost=70546.1100
- **Output:** st=1219.19, rt=1220.55
