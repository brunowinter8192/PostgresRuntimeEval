    ...
    Node 18536 (Gather) [consumed]
      Node 18537 (Aggregate) [consumed]
        Node 18538 (Nested Loop) [consumed]
          ...
          Node 18551 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather -> | 76ab422a | 18534 | 18535, 18536, 18537, 18538, 18539, 18540, 18541, 18542, 18543, 18544, 18547, 18549, 18550, 18551 |
...
|------|------|--------|-----------|-----|--------|
| 18534 | Sort | 1188.18 | 1194.95 | 0.6% | pattern |
...
### Step 4: Node 18534 (Sort) - PATTERN ROOT
...
- **Consumes:** Nodes 18535, 18536, 18537, 18538, 18539, 18540, 18541, 18542, 18543, 18544, 18547, 18549, 18550, 18551
- **Input Features:**
