        ...
        Node 18538 (Nested Loop)
          Node 18539 (Hash Join) [PATTERN: 895c6e8c]
            ...
            Node 18541 (Hash) [consumed]
              Node 18542 (Hash Join) [PATTERN: 7a51ce50]
                Node 18543 (Hash Join) [consumed]
                  Node 18544 (Nested Loop) [consumed]
                    Node 18545 (Seq Scan) [consumed] - LEAF
                    Node 18546 (Index Scan) [consumed] - LEAF
                  Node 18547 (Hash) [consumed]
                    Node 18548 (Seq Scan) [consumed] - LEAF
                Node 18549 (Hash) [consumed]
                  Node 18550 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Hash Join -> [Hash Join -> [Ne | 7a51ce50 | 18542 | 18534, 18535, 18539, 18540, 18541, 18543, 18544, 18545, 18546, 18547, 18548, 18549, 18550 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 18539 | 18534, 18535, 18540, 18541, 18542, 18543, 18544, 18545, 18546, 18547, 18548, 18549, 18550 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18534 | 18535, 18539, 18540, 18541, 18542, 18543, 18544, 18545, 18546, 18547, 18548, 18549, 18550 |
...
| 18542 | Hash Join | 178.89 | 546.39 | 205.4% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 18542 (Hash Join) - PATTERN ROOT
...
- **Consumes:** Nodes 18534, 18535, 18539, 18540, 18541, 18543, 18544, 18545, 18546, 18547, 18548, 18549, 18550
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 2: Node 18539 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 18534, 18535, 18540, 18541, 18542, 18543, 18544, 18545, 18546, 18547, 18548, 18549, 18550
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=69752
...
### Step 3: Node 18551 (Index Scan) - LEAF
...
### Step 7: Node 18534 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18535, 18539, 18540, 18541, 18542, 18543, 18544, 18545, 18546, 18547, 18548, 18549, 18550
- **Input Features:**
