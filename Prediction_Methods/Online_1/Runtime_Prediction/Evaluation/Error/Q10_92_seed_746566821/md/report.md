    ...
    Node 21205 (Aggregate) [consumed]
      Node 21206 (Gather) [consumed]
        Node 21207 (Hash Join) [consumed]
          Node 21208 (Hash Join) [PATTERN: 2873b8c3]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 21203 | 21204, 21205, 21206, 21207, 21208, 21209, 21210, 21211, 21212, 21213 |
| Hash Join -> [Nested Loop -> [ | 2873b8c3 | 21208 | 21203, 21204, 21205, 21206, 21207, 21209, 21210, 21211, 21212, 21213 |
...
### Step 2: Node 21208 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2873b8c3 (Hash Join -> [Nested Loop -> [Seq Scan (Outer), Index Scan (Inner)] (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 21203, 21204, 21205, 21206, 21207, 21209, 21210, 21211, 21212, 21213
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18183
  - HashJoin_nt1=18183
...
### Step 4: Node 21203 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 21204, 21205, 21206, 21207, 21208, 21209, 21210, 21211, 21212, 21213
- **Input Features:**
