...
Node 24796 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 24797 (Gather Merge) [consumed]
    Node 24798 (Aggregate)
      Node 24799 (Sort)
        Node 24800 (Nested Loop)
          Node 24801 (Seq Scan) - LEAF
          Node 24802 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge (Out | 2724c080 | 24796 | 24797 |
...
| 24798 | Aggregate | 979.10 | 941.96 | 3.8% | operator |
| 24799 | Sort | 978.38 | 1058.10 | 8.1% | operator |
| 24800 | Nested Loop | 977.41 | 1101.31 | 12.7% | operator |
| 24801 | Seq Scan | 838.86 | 750.46 | 10.5% | operator |
| 24802 | Index Scan | 0.03 | -0.02 | 163.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24801 (Seq Scan) - LEAF
...
### Step 2: Node 24802 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - st2=0.0258
  - startup_cost=0.4300
  - total_cost=147172.9600
- **Output:** st=21.28, rt=1101.31

### Step 4: Node 24799 (Sort)
...
### Step 6: Node 24796 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 24797
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=7
  - Aggregate_nt1=35
