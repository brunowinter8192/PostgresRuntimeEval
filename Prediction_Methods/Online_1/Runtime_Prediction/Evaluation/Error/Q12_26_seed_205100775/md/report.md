...
```
Node 24796 (Aggregate) [PATTERN: f9c97829] - ROOT
  Node 24797 (Gather Merge) [consumed]
    Node 24798 (Aggregate) [consumed]
      Node 24799 (Sort) [consumed]
        Node 24800 (Nested Loop) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> A | f9c97829 | 24796 | 24797, 24798, 24799, 24800, 24801, 24802 |
...
|------|------|--------|-----------|-----|--------|
| 24796 | Aggregate | 998.45 | 998.49 | 0.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 24796 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 24797, 24798, 24799, 24800, 24801, 24802
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=7
  - Aggregate_Outer_nt1=5775
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=27
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0012
  - Aggregate_Outer_startup_cost=147533.7700
  - Aggregate_Outer_total_cost=147649.3400
  - Aggregate_np=0
  - Aggregate_nt=7
  - Aggregate_nt1=35
  - Aggregate_nt2=0
  ...
  - NestedLoop_Outer_nt=5775
  - NestedLoop_Outer_nt1=5775
  ...
  - NestedLoop_Outer_total_cost=147172.9600
  ...
  - Sort_Outer_startup_cost=147533.7700
  - Sort_Outer_total_cost=147548.2000
