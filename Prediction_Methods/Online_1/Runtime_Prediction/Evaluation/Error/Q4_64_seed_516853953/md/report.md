...
```
Node 6621 (Aggregate) [PATTERN: 80bd802d] - ROOT
  Node 6622 (Gather Merge) [consumed]
    Node 6623 (Sort) [consumed]
      Node 6624 (Aggregate) [consumed]
        Node 6625 (Nested Loop) [consumed]
          Node 6626 (Seq Scan) [consumed] - LEAF
          Node 6627 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 80bd802d | 6621 | 6622, 6623, 6624, 6625, 6626, 6627 |
...
|------|------|--------|-----------|-----|--------|
| 6621 | Aggregate | 1060.67 | 1057.79 | 0.3% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6621 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 6622, 6623, 6624, 6625, 6626, 6627
- **Input Features:**
  ...
  - NestedLoop_Outer_nt=15110
  - NestedLoop_Outer_nt1=18529
