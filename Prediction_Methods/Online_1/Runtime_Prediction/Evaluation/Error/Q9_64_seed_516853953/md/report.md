        ...
        Node 18647 (Nested Loop)
          Node 18648 (Hash Join) [PATTERN: 895c6e8c]
            ...
            Node 18650 (Hash) [consumed]
              Node 18651 (Hash Join) [PATTERN: 7a51ce50]
                Node 18652 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Hash Join -> [Ne | 7a51ce50 | 18651 | 18643, 18644, 18648, 18649, 18650, 18652, 18653, 18654, 18655, 18656, 18657, 18658, 18659 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 18648 | 18643, 18644, 18649, 18650, 18651, 18652, 18653, 18654, 18655, 18656, 18657, 18658, 18659 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18643 | 18644, 18648, 18649, 18650, 18651, 18652, 18653, 18654, 18655, 18656, 18657, 18658, 18659 |
...
|------|------|--------|-----------|-----|--------|
| 18643 | Sort | 1180.81 | 1114.80 | 5.6% | pattern |
| 18645 | Gather | 1179.53 | 1136.42 | 3.7% | operator |
| 18646 | Aggregate | 1157.97 | 1170.90 | 1.1% | operator |
| 18647 | Nested Loop | 1133.99 | 1176.25 | 3.7% | operator |
| 18648 | Hash Join | 961.10 | 733.48 | 23.7% | pattern |
| 18660 | Index Scan | 0.00 | -0.04 | 1512.7% | operator |
| 18651 | Hash Join | 172.83 | 545.98 | 215.9% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 18651 (Hash Join) - PATTERN ROOT
...
- **Consumes:** Nodes 18643, 18644, 18648, 18649, 18650, 18652, 18653, 18654, 18655, 18656, 18657, 18658, 18659
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 2: Node 18648 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 18643, 18644, 18649, 18650, 18651, 18652, 18653, 18654, 18655, 18656, 18657, 18658, 18659
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=60132
...
### Step 3: Node 18660 (Index Scan) - LEAF
...
### Step 7: Node 18643 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18644, 18648, 18649, 18650, 18651, 18652, 18653, 18654, 18655, 18656, 18657, 18658, 18659
- **Input Features:**
