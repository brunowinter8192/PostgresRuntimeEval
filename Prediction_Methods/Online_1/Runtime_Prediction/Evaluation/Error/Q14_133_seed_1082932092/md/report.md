...
```
Node 26672 (Aggregate) [PATTERN: f8295d8b] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 26672 | 26673, 26674, 26675, 26676, 26677, 26678 |
...
|------|------|--------|-----------|-----|--------|
| 26672 | Aggregate | 829.14 | 822.78 | 0.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26672 (Aggregate) - PATTERN ROOT
