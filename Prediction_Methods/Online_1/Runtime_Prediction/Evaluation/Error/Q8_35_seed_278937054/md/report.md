...
```
Node 14995 (Aggregate) [PATTERN: 53f9aa07] - ROOT
  Node 14996 (Gather Merge) [consumed]
    Node 14997 (Sort) [consumed]
      Node 14998 (Hash Join) [consumed]
        Node 14999 (Nested Loop) [consumed]
          Node 15000 (Hash Join)
            Node 15001 (Nested Loop) [PATTERN: bd9dfa7b]
              Node 15002 (Hash Join) [consumed]
              ...
              Node 15012 (Index Scan) [consumed] - LEAF
            Node 15013 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 53f9aa07 | 14995 | 14996, 14997, 14998, 14999, 15001, 15002, 15003, 15004, 15005, 15007, 15008, 15009, 15010, 15011, 15012, 15016 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 15007 | 14995, 14996, 14997, 14998, 14999, 15001, 15002, 15003, 15004, 15005, 15008, 15009, 15010, 15011, 15012, 15016 |
| Nested Loop -> [Hash Join -> [ | bd9dfa7b | 15001 | 14995, 14996, 14997, 14998, 14999, 15002, 15003, 15004, 15005, 15007, 15008, 15009, 15010, 15011, 15012, 15016 |
...
|------|------|--------|-----------|-----|--------|
| 14995 | Aggregate | 1249.83 | 1220.49 | 2.3% | pattern |
| 15000 | Hash Join | 1239.91 | 1042.87 | 15.9% | operator |
| 15015 | Index Scan | 0.01 | 0.05 | 753.5% | operator |
| 15017 | Seq Scan | 0.01 | 7.19 | 71844.7% | operator |
| 15001 | Nested Loop | 1193.43 | 1155.06 | 3.2% | pattern |
...
- **Consumes:** Nodes 14995, 14996, 14997, 14998, 14999, 15001, 15002, 15003, 15004, 15005, 15008, 15009, 15010, 15011, 15012, 15016
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 3: Node 15014 (Seq Scan) - LEAF
...
### Step 4: Node 15001 (Nested Loop) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bd9dfa7b (Nested Loop -> [Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer), Index Scan (Inner)])
- **Consumes:** Nodes 14995, 14996, 14997, 14998, 14999, 15002, 15003, 15004, 15005, 15007, 15008, 15009, 15010, 15011, 15012, 15016
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 7: Node 15015 (Index Scan) - LEAF
...
### Step 8: Node 15017 (Seq Scan) - LEAF
...
### Step 9: Node 14995 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 53f9aa07 (Aggregate -> Gather Merge -> Sort -> Hash Join -> [Nested Loop (Outer), Hash (Inner)] (Outer) (Outer) (Outer))
- **Consumes:** Nodes 14996, 14997, 14998, 14999, 15001, 15002, 15003, 15004, 15005, 15007, 15008, 15009, 15010, 15011, 15012, 15016
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2479
