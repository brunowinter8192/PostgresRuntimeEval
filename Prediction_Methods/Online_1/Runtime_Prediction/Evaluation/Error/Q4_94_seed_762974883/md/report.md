...
```
Node 6852 (Aggregate) [PATTERN: 80bd802d] - ROOT
  Node 6853 (Gather Merge) [consumed]
    Node 6854 (Sort) [consumed]
      Node 6855 (Aggregate) [consumed]
        Node 6856 (Nested Loop) [consumed]
          Node 6857 (Seq Scan) [consumed] - LEAF
          Node 6858 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 80bd802d | 6852 | 6853, 6854, 6855, 6856, 6857, 6858 |
...
|------|------|--------|-----------|-----|--------|
| 6852 | Aggregate | 1071.80 | 1057.79 | 1.3% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6852 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 6853, 6854, 6855, 6856, 6857, 6858
- **Input Features:**
  ...
  - NestedLoop_Outer_nt=14935
  - NestedLoop_Outer_nt1=18315
  ...
  - NestedLoop_Outer_total_cost=65864.0300
  - SeqScan_Outer_np=26136
  - SeqScan_Outer_nt=18315
  - SeqScan_Outer_nt1=0
  - SeqScan_Outer_nt2=0
