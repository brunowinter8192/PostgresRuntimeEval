...
```
Node 5977 (Aggregate) [PATTERN: 80bd802d] - ROOT
  Node 5978 (Gather Merge) [consumed]
    Node 5979 (Sort) [consumed]
      Node 5980 (Aggregate) [consumed]
        Node 5981 (Nested Loop) [consumed]
          Node 5982 (Seq Scan) [consumed] - LEAF
          Node 5983 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 80bd802d | 5977 | 5978, 5979, 5980, 5981, 5982, 5983 |
...
|------|------|--------|-----------|-----|--------|
| 5977 | Aggregate | 1038.30 | 1057.79 | 1.9% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5977 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 5978, 5979, 5980, 5981, 5982, 5983
- **Input Features:**
  ...
  - NestedLoop_Outer_total_cost=65744.9100
  - SeqScan_Outer_np=26136
  - SeqScan_Outer_nt=18165
  - SeqScan_Outer_nt1=0
  - SeqScan_Outer_nt2=0
