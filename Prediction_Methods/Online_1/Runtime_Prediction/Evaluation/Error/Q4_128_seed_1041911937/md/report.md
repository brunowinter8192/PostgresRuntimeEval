...
```
Node 6061 (Aggregate) [PATTERN: 80bd802d] - ROOT
  Node 6062 (Gather Merge) [consumed]
    Node 6063 (Sort) [consumed]
      Node 6064 (Aggregate) [consumed]
        Node 6065 (Nested Loop) [consumed]
          Node 6066 (Seq Scan) [consumed] - LEAF
          Node 6067 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 80bd802d | 6061 | 6062, 6063, 6064, 6065, 6066, 6067 |
...
|------|------|--------|-----------|-----|--------|
| 6061 | Aggregate | 1054.60 | 1057.79 | 0.3% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6061 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 6062, 6063, 6064, 6065, 6066, 6067
- **Input Features:**
  ...
  - NestedLoop_Outer_total_cost=65865.2300
  - SeqScan_Outer_np=26136
  - SeqScan_Outer_nt=18317
  - SeqScan_Outer_nt1=0
  - SeqScan_Outer_nt2=0
