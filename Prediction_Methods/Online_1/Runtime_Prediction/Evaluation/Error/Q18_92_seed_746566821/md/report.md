...
```
Node 31076 (Limit) [PATTERN: 0aa5463f] - ROOT
    ...
    Node 31078 (Aggregate) [consumed]
      Node 31079 (Gather Merge) [consumed]
        Node 31080 (Incremental Sort) [consumed]
          Node 31081 (Nested Loop) [consumed]
            Node 31082 (Merge Join) [consumed]
              Node 31083 (Sort)
            ...
            Node 31091 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 0aa5463f | 31076 | 31077, 31078, 31079, 31080, 31081, 31082, 31084, 31085, 31086, 31091 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 31084 | 31076, 31077, 31078, 31079, 31080, 31081, 31082, 31085, 31086, 31091 |
...
- **Consumes:** Nodes 31076, 31077, 31078, 31079, 31080, 31081, 31082, 31085, 31086, 31091
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 7: Node 31076 (Limit) - PATTERN ROOT
...
- **Consumes:** Nodes 31077, 31078, 31079, 31080, 31081, 31082, 31084, 31085, 31086, 31091
- **Input Features:**
