...
```
Node 10425 (Aggregate) [PATTERN: dd3706ac] - ROOT
  Node 10426 (Gather) [consumed]
    Node 10427 (Aggregate) [consumed]
      Node 10428 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | dd3706ac | 10425 | 10426, 10427, 10428 |
...
|------|------|--------|-----------|-----|--------|
| 10425 | Aggregate | 762.61 | 791.26 | 3.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10425 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** dd3706ac (Aggregate -> Gather -> Aggregate -> Seq Scan (Outer) (Outer) (Outer))
- **Consumes:** Nodes 10426, 10427, 10428
- **Input Features:**
