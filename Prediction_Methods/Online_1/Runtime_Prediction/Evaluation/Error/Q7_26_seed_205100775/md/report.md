      ...
      Node 11728 (Hash Join)
        Node 11729 (Nested Loop)
          Node 11730 (Hash Join)
            ...
            Node 11732 (Hash) [PATTERN: a54055ce]
              Node 11733 (Hash Join) [consumed]
                Node 11734 (Seq Scan) [consumed] - LEAF
                Node 11735 (Hash) [consumed]
                  Node 11736 (Seq Scan) [consumed] - LEAF
          Node 11737 (Index Scan) - LEAF
        Node 11738 (Hash) [PATTERN: a54055ce]
          Node 11739 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 11732 | 11725, 11726, 11733, 11734, 11735, 11736, 11738, 11739, 11740, 11741, 11742 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 11738 | 11725, 11726, 11732, 11733, 11734, 11735, 11736, 11739, 11740, 11741, 11742 |
| Aggregate -> Gather Merge (Out | 2724c080 | 11725 | 11726, 11732, 11733, 11734, 11735, 11736, 11738, 11739, 11740, 11741, 11742 |
...
| 11728 | Hash Join | 1186.99 | 1130.43 | 4.8% | operator |
| 11729 | Nested Loop | 1179.63 | 1145.81 | 2.9% | operator |
| 11738 | Hash | 3.68 | 3.42 | 7.0% | pattern |
| 11730 | Hash Join | 209.12 | 319.90 | 53.0% | operator |
| 11737 | Index Scan | 0.03 | 0.09 | 171.7% | operator |
| 11731 | Seq Scan | 147.59 | 192.19 | 30.2% | operator |
| 11732 | Hash | 32.98 | 35.59 | 7.9% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11731 (Seq Scan) - LEAF
...
### Step 2: Node 11732 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 11725, 11726, 11733, 11734, 11735, 11736, 11738, 11739, 11740, 11741, 11742
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 11737 (Index Scan) - LEAF
...
### Step 6: Node 11738 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 11725, 11726, 11732, 11733, 11734, 11735, 11736, 11739, 11740, 11741, 11742
- **Input Features:**
  - HashJoin_Outer_np=0
...
- **Consumes:** Nodes 11726, 11732, 11733, 11734, 11735, 11736, 11738, 11739, 11740, 11741, 11742
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
