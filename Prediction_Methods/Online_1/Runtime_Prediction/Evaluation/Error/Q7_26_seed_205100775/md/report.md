...
```
Node 11725 (Aggregate) [PATTERN: 27c3eea9] - ROOT
  Node 11726 (Gather Merge) [consumed]
    Node 11727 (Sort) [consumed]
      Node 11728 (Hash Join) [consumed]
        Node 11729 (Nested Loop) [consumed]
          Node 11730 (Hash Join) [consumed]
          ...
          Node 11737 (Index Scan) [consumed] - LEAF
        Node 11738 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 27c3eea9 | 11725 | 11726, 11727, 11728, 11729, 11730, 11732, 11733, 11734, 11735, 11736, 11737, 11738, 11739 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 11732 | 11725, 11726, 11727, 11728, 11729, 11730, 11733, 11734, 11735, 11736, 11737, 11738, 11739 |
...
|------|------|--------|-----------|-----|--------|
| 11725 | Aggregate | 1194.12 | 1200.90 | 0.6% | pattern |
...
### Step 1: Node 11742 (Seq Scan) - LEAF
...
### Step 2: Node 11731 (Seq Scan) - LEAF
...
### Step 3: Node 11732 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 11725, 11726, 11727, 11728, 11729, 11730, 11733, 11734, 11735, 11736, 11737, 11738, 11739
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 11740 (Seq Scan) - LEAF
...
### Step 6: Node 11725 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 11726, 11727, 11728, 11729, 11730, 11732, 11733, 11734, 11735, 11736, 11737, 11738, 11739
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
