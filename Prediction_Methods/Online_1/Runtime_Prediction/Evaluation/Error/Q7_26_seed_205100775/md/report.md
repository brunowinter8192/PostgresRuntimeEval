...
```
Node 11725 (Aggregate) - ROOT
  Node 11726 (Gather Merge)
    Node 11727 (Sort)
      Node 11728 (Hash Join)
        Node 11729 (Nested Loop)
          Node 11730 (Hash Join)
            Node 11731 (Seq Scan) - LEAF
            Node 11732 (Hash)
              Node 11733 (Hash Join)
                Node 11734 (Seq Scan) - LEAF
                Node 11735 (Hash)
                  Node 11736 (Seq Scan) - LEAF
          Node 11737 (Index Scan) - LEAF
        Node 11738 (Hash)
          Node 11739 (Hash Join)
            Node 11740 (Seq Scan) - LEAF
            Node 11741 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 11725 | Aggregate | 1194.12 | 1202.22 | 0.7% | operator |
| 11726 | Gather Merge | 1193.13 | 1148.45 | 3.7% | operator |
| 11727 | Sort | 1187.59 | 1149.87 | 3.2% | operator |
| 11728 | Hash Join | 1186.99 | 1130.50 | 4.8% | operator |
| 11729 | Nested Loop | 1179.63 | 1145.81 | 2.9% | operator |
| 11738 | Hash | 3.68 | 15.44 | 319.6% | operator |
| 11730 | Hash Join | 209.12 | 319.53 | 52.8% | operator |
| 11737 | Index Scan | 0.03 | 0.09 | 171.7% | operator |
| 11739 | Hash Join | 3.63 | 49.64 | 1265.9% | operator |
| 11731 | Seq Scan | 147.59 | 192.19 | 30.2% | operator |
| 11732 | Hash | 32.98 | 17.27 | 47.7% | operator |
| 11740 | Seq Scan | 3.30 | 10.62 | 222.0% | operator |
| 11741 | Hash | 0.01 | 14.54 | 103736.9% | operator |
| 11733 | Hash Join | 32.60 | 54.15 | 66.1% | operator |
| 11742 | Seq Scan | 0.01 | 7.20 | 65317.7% | operator |
| 11734 | Seq Scan | 31.47 | 24.87 | 21.0% | operator |
| 11735 | Hash | 0.01 | 14.54 | 161424.0% | operator |
| 11736 | Seq Scan | 0.01 | 7.20 | 119832.4% | operator |
...
### Step 2: Node 11734 (Seq Scan) - LEAF
...
### Step 5: Node 11742 (Seq Scan) - LEAF
...
### Step 6: Node 11731 (Seq Scan) - LEAF
...
### Step 8: Node 11740 (Seq Scan) - LEAF
...
### Step 11: Node 11737 (Index Scan) - LEAF
...
### Step 13: Node 11729 (Nested Loop)
...
### Step 17: Node 11726 (Gather Merge)
...
### Step 18: Node 11725 (Aggregate) - ROOT
