...
```
Node 46 (Aggregate) [PATTERN: 3dfa6025] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 3dfa6025 | 46 | 47, 48, 49, 50 |
...
|------|------|--------|-----------|-----|--------|
| 46 | Aggregate | 921.20 | 953.98 | 3.6% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 46 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3dfa6025 (Aggregate -> Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 47, 48, 49, 50
- **Input Features:**
  ...
  - Aggregate_startup_cost=169633.4800
  - Aggregate_total_cost=169638.2500
  ...
  - GatherMerge_Outer_startup_cost=169633.4800
  - GatherMerge_Outer_total_cost=169637.1100
