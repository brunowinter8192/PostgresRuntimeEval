...
```
Node 26602 (Aggregate) [PATTERN: f8295d8b] - ROOT
  Node 26603 (Gather) [consumed]
    Node 26604 (Aggregate) [consumed]
      Node 26605 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 26602 | 26603, 26604, 26605, 26606, 26607, 26608 |
...
|------|------|--------|-----------|-----|--------|
| 26602 | Aggregate | 841.29 | 822.66 | 2.2% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26602 (Aggregate) - PATTERN ROOT
