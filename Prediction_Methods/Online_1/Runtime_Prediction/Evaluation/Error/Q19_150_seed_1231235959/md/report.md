...
Node 31605 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31606 (Gather) [consumed]
    Node 31607 (Aggregate) [consumed]
      Node 31608 (Hash Join) [PATTERN: f4cb205a]
        Node 31609 (Seq Scan) [consumed] - LEAF
        Node 31610 (Hash) [consumed]
          Node 31611 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 31608 | 31605, 31606, 31607, 31609, 31610, 31611 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31605 | 31606, 31607, 31608, 31609, 31610, 31611 |
...
| 31608 | Hash Join | 804.55 | 373.83 | 53.5% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31608 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 31605, 31606, 31607, 31609, 31610, 31611
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=23
  - HashJoin_nt1=22527
  ...
  - HashJoin_total_cost=156338.6200
  - Hash_Inner_np=0
  - Hash_Inner_nt=202
  - Hash_Inner_nt1=202
  - Hash_Inner_nt2=0
...
### Step 2: Node 31605 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31606, 31607, 31608, 31609, 31610, 31611
- **Input Features:**
