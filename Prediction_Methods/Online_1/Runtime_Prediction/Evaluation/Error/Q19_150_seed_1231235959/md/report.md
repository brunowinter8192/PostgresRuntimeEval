...
```
Node 31605 (Aggregate) [PATTERN: f8295d8b] - ROOT
  Node 31606 (Gather) [consumed]
    Node 31607 (Aggregate) [consumed]
      Node 31608 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 31605 | 31606, 31607, 31608, 31609, 31610, 31611 |
...
|------|------|--------|-----------|-----|--------|
| 31605 | Aggregate | 825.38 | 841.17 | 1.9% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31605 (Aggregate) - PATTERN ROOT
