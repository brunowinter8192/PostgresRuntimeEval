...
Node 13477 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 13478 (Gather Merge) [consumed]
    Node 13479 (Sort)
      Node 13480 (Hash Join) [PATTERN: 2e0f44ef]
        Node 13481 (Nested Loop) [consumed]
          Node 13482 (Hash Join) [PATTERN: 2e0f44ef]
            Node 13483 (Nested Loop) [consumed]
              Node 13484 (Hash Join) [PATTERN: 895c6e8c]
                Node 13485 (Seq Scan) [consumed] - LEAF
                Node 13486 (Hash) [consumed]
                  Node 13487 (Hash Join)
                    Node 13488 (Seq Scan) - LEAF
                    Node 13489 (Hash) [PATTERN: a54055ce]
                      Node 13490 (Hash Join) [consumed]
                        Node 13491 (Seq Scan) [consumed] - LEAF
                        Node 13492 (Hash) [consumed]
                          Node 13493 (Seq Scan) [consumed] - LEAF
              Node 13494 (Index Scan) - LEAF
            Node 13495 (Hash) [consumed]
              Node 13496 (Seq Scan) - LEAF
          Node 13497 (Index Scan) - LEAF
        Node 13498 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 13489 | 13477, 13478, 13480, 13481, 13482, 13483, 13484, 13485, 13486, 13490, 13491, 13492, 13493, 13495, 13498 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 13484 | 13477, 13478, 13480, 13481, 13482, 13483, 13485, 13486, 13489, 13490, 13491, 13492, 13493, 13495, 13498 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 13480 | 13477, 13478, 13481, 13482, 13483, 13484, 13485, 13486, 13489, 13490, 13491, 13492, 13493, 13495, 13498 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 13482 | 13477, 13478, 13480, 13481, 13483, 13484, 13485, 13486, 13489, 13490, 13491, 13492, 13493, 13495, 13498 |
| Aggregate -> Gather Merge (Out | 2724c080 | 13477 | 13478, 13480, 13481, 13482, 13483, 13484, 13485, 13486, 13489, 13490, 13491, 13492, 13493, 13495, 13498 |
...
| 13479 | Sort | 1235.17 | 1096.02 | 11.3% | operator |
| 13480 | Hash Join | 1234.88 | 1199.17 | 2.9% | pattern |
| 13482 | Hash Join | 1229.76 | 1192.82 | 3.0% | pattern |
| 13497 | Index Scan | 0.01 | 0.05 | 631.6% | operator |
| 13499 | Seq Scan | 0.01 | 7.19 | 59854.0% | operator |
| 13484 | Hash Join | 213.78 | 260.30 | 21.8% | pattern |
| 13494 | Index Scan | 0.04 | 0.09 | 107.2% | operator |
| 13496 | Seq Scan | 39.50 | 44.48 | 12.6% | operator |
| 13487 | Hash Join | 34.38 | 67.79 | 97.2% | operator |
| 13488 | Seq Scan | 33.04 | 24.87 | 24.7% | operator |
| 13489 | Hash | 0.09 | 0.20 | 110.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 13488 (Seq Scan) - LEAF
...
### Step 2: Node 13489 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 13477, 13478, 13480, 13481, 13482, 13483, 13484, 13485, 13486, 13490, 13491, 13492, 13493, 13495, 13498
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 4: Node 13484 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 13477, 13478, 13480, 13481, 13482, 13483, 13485, 13486, 13489, 13490, 13491, 13492, 13493, 13495, 13498
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=29497
  - HashJoin_nt1=147487
...
### Step 5: Node 13494 (Index Scan) - LEAF
...
### Step 6: Node 13496 (Seq Scan) - LEAF
...
### Step 7: Node 13482 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 13477, 13478, 13480, 13481, 13483, 13484, 13485, 13486, 13489, 13490, 13491, 13492, 13493, 13495, 13498
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=788
  - HashJoin_nt1=118013
...
### Step 8: Node 13497 (Index Scan) - LEAF
...
### Step 9: Node 13499 (Seq Scan) - LEAF
...
### Step 10: Node 13480 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 13477, 13478, 13481, 13482, 13483, 13484, 13485, 13486, 13489, 13490, 13491, 13492, 13493, 13495, 13498
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=788
  - HashJoin_nt1=788
...
### Step 12: Node 13477 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 13478, 13480, 13481, 13482, 13483, 13484, 13485, 13486, 13489, 13490, 13491, 13492, 13493, 13495, 13498
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2442
