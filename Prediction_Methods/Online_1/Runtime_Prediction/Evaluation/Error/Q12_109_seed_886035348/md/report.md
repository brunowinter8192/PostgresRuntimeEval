...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge (Out | 2724c080 | 24383 | 24384 |
...
| 24385 | Aggregate | 968.21 | 941.96 | 2.7% | operator |
| 24386 | Sort | 967.57 | 1058.10 | 9.4% | operator |
| 24387 | Nested Loop | 966.61 | 1101.31 | 13.9% | operator |
| 24388 | Seq Scan | 828.03 | 750.46 | 9.4% | operator |
| 24389 | Index Scan | 0.03 | -0.02 | 161.0% | operator |
...
### Step 6: Node 24383 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 24384
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=7
  - Aggregate_nt1=35
