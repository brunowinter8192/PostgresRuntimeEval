...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31283 | 31284, 31285 |
...
| 31286 | Hash Join | 837.73 | 782.38 | 6.6% | operator |
| 31287 | Seq Scan | 789.33 | 750.07 | 5.0% | operator |
| 31288 | Hash | 46.79 | 12.06 | 74.2% | operator |
...
- **Input Features:**
  ...
  - total_cost=156338.6400
- **Output:** st=77.20, rt=782.38

### Step 5: Node 31283 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31284, 31285
- **Input Features:**
