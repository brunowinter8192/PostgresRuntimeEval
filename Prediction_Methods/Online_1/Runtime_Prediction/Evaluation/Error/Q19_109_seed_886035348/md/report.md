...
```
Node 31283 (Aggregate) [PATTERN: f8295d8b] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 31283 | 31284, 31285, 31286, 31287, 31288, 31289 |
...
|------|------|--------|-----------|-----|--------|
| 31283 | Aggregate | 855.55 | 841.17 | 1.7% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31283 (Aggregate) - PATTERN ROOT
