    ...
    Node 19762 (Aggregate) [consumed]
      Node 19763 (Gather) [consumed]
        Node 19764 (Hash Join) [consumed]
          Node 19765 (Hash Join) [PATTERN: 2873b8c3]
            Node 19766 (Nested Loop) [consumed]
              Node 19767 (Seq Scan) [consumed] - LEAF
              Node 19768 (Index Scan) [consumed] - LEAF
            Node 19769 (Hash) [consumed]
              Node 19770 (Seq Scan) [consumed] - LEAF
          Node 19771 (Hash)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 19760 | 19761, 19762, 19763, 19764, 19765, 19766, 19767, 19768, 19769, 19770 |
| Hash Join -> [Nested Loop -> [ | 2873b8c3 | 19765 | 19760, 19761, 19762, 19763, 19764, 19766, 19767, 19768, 19769, 19770 |
...
### Step 2: Node 19765 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2873b8c3 (Hash Join -> [Nested Loop -> [Seq Scan (Outer), Index Scan (Inner)] (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 19760, 19761, 19762, 19763, 19764, 19766, 19767, 19768, 19769, 19770
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18384
  - HashJoin_nt1=18384
  ...
  - IndexScan_Inner_total_cost=2.2800
...
- **Output:** st=36.98, rt=725.17

### Step 3: Node 19771 (Hash)
...
### Step 4: Node 19760 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19761, 19762, 19763, 19764, 19765, 19766, 19767, 19768, 19769, 19770
- **Input Features:**
