  ...
  Node 19761 (Sort) [consumed]
    Node 19762 (Aggregate) [consumed]
      Node 19763 (Gather) [consumed]
        Node 19764 (Hash Join) [PATTERN: 7a51ce50]
          Node 19765 (Hash Join) [consumed]
          ...
          Node 19771 (Hash) [consumed]
            Node 19772 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Hash Join -> [Ne | 7a51ce50 | 19764 | 19760, 19761, 19762, 19763, 19765, 19766, 19767, 19768, 19769, 19770, 19771, 19772 |
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19760 | 19761, 19762, 19763, 19764, 19765, 19766, 19767, 19768, 19769, 19770, 19771, 19772 |
...
| 19764 | Hash Join | 1116.41 | 730.72 | 34.5% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 19764 (Hash Join) - PATTERN ROOT
...
- **Consumes:** Nodes 19760, 19761, 19762, 19763, 19765, 19766, 19767, 19768, 19769, 19770, 19771, 19772
- **Input Features:**
  - HashJoin_Outer_np=0
  ...
  - HashJoin_Outer_total_cost=80999.0900
  - HashJoin_np=0
  - HashJoin_nt=18384
  - HashJoin_nt1=18384
  - HashJoin_nt2=25
  ...
  - HashJoin_total_cost=81057.0900
  - Hash_Inner_np=0
  - Hash_Inner_nt=62500
...
- **Output:** st=37.23, rt=730.72

### Step 2: Node 19760 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19761, 19762, 19763, 19764, 19765, 19766, 19767, 19768, 19769, 19770, 19771, 19772
- **Input Features:**
