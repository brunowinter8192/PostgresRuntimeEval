...
```
Node 13039 (Aggregate) [PATTERN: 27c3eea9] - ROOT
  Node 13040 (Gather Merge) [consumed]
    Node 13041 (Sort) [consumed]
      Node 13042 (Hash Join) [consumed]
        Node 13043 (Nested Loop) [consumed]
          Node 13044 (Hash Join) [consumed]
          ...
          Node 13051 (Index Scan) [consumed] - LEAF
        Node 13052 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 27c3eea9 | 13039 | 13040, 13041, 13042, 13043, 13044, 13046, 13047, 13048, 13049, 13050, 13051, 13052, 13053 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 13046 | 13039, 13040, 13041, 13042, 13043, 13044, 13047, 13048, 13049, 13050, 13051, 13052, 13053 |
...
|------|------|--------|-----------|-----|--------|
| 13039 | Aggregate | 1204.69 | 1200.90 | 0.3% | pattern |
...
### Step 1: Node 13056 (Seq Scan) - LEAF
...
### Step 2: Node 13045 (Seq Scan) - LEAF
...
### Step 3: Node 13046 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 13039, 13040, 13041, 13042, 13043, 13044, 13047, 13048, 13049, 13050, 13051, 13052, 13053
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 13054 (Seq Scan) - LEAF
...
### Step 6: Node 13039 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 13040, 13041, 13042, 13043, 13044, 13046, 13047, 13048, 13049, 13050, 13051, 13052, 13053
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
