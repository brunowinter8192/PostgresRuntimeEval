      ...
      Node 13042 (Hash Join)
        Node 13043 (Nested Loop)
          Node 13044 (Hash Join)
            ...
            Node 13046 (Hash) [PATTERN: a54055ce]
              Node 13047 (Hash Join) [consumed]
                Node 13048 (Seq Scan) [consumed] - LEAF
                Node 13049 (Hash) [consumed]
                  Node 13050 (Seq Scan) [consumed] - LEAF
          Node 13051 (Index Scan) - LEAF
        Node 13052 (Hash) [PATTERN: a54055ce]
          Node 13053 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 13046 | 13039, 13040, 13047, 13048, 13049, 13050, 13052, 13053, 13054, 13055, 13056 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 13052 | 13039, 13040, 13046, 13047, 13048, 13049, 13050, 13053, 13054, 13055, 13056 |
| Aggregate -> Gather Merge (Out | 2724c080 | 13039 | 13040, 13046, 13047, 13048, 13049, 13050, 13052, 13053, 13054, 13055, 13056 |
...
| 13042 | Hash Join | 1197.85 | 1130.43 | 5.6% | operator |
| 13043 | Nested Loop | 1190.02 | 1145.81 | 3.7% | operator |
| 13052 | Hash | 4.13 | 3.42 | 17.2% | pattern |
| 13044 | Hash Join | 216.20 | 319.90 | 48.0% | operator |
| 13051 | Index Scan | 0.03 | 0.09 | 163.5% | operator |
| 13045 | Seq Scan | 152.35 | 192.19 | 26.2% | operator |
| 13046 | Hash | 38.70 | 35.59 | 8.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 13045 (Seq Scan) - LEAF
...
### Step 2: Node 13046 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 13039, 13040, 13047, 13048, 13049, 13050, 13052, 13053, 13054, 13055, 13056
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 13051 (Index Scan) - LEAF
...
### Step 6: Node 13052 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 13039, 13040, 13046, 13047, 13048, 13049, 13050, 13053, 13054, 13055, 13056
- **Input Features:**
  - HashJoin_Outer_np=0
...
- **Consumes:** Nodes 13040, 13046, 13047, 13048, 13049, 13050, 13052, 13053, 13054, 13055, 13056
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
