...
```
Node 26931 (Aggregate) [PATTERN: f8295d8b] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 26931 | 26932, 26933, 26934, 26935, 26936, 26937 |
...
|------|------|--------|-----------|-----|--------|
| 26931 | Aggregate | 811.95 | 822.94 | 1.4% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26931 (Aggregate) - PATTERN ROOT
