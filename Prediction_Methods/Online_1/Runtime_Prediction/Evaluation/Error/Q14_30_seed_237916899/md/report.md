...
**Test Query:** Q14_30_seed_237916899
...
```
Node 26931 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26932 (Gather) [consumed]
    Node 26933 (Aggregate) [consumed]
      Node 26934 (Hash Join) [PATTERN: f4cb205a]
        Node 26935 (Seq Scan) [consumed] - LEAF
        Node 26936 (Hash) [consumed]
          Node 26937 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 26934 | 26931, 26932, 26933, 26935, 26936, 26937 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26931 | 26932, 26933, 26934, 26935, 26936, 26937 |
...
|------|------|--------|-----------|-----|--------|
| 26931 | Aggregate | 811.95 | 834.72 | 2.8% | pattern |
| 26934 | Hash Join | 790.76 | 397.35 | 49.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26934 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 26931, 26932, 26933, 26935, 26936, 26937
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=13747
  - HashJoin_nt1=13747
  ...
  - HashJoin_total_cost=136642.7300
  - Hash_Inner_np=0
  - Hash_Inner_nt=83333
...
- **Output:** st=44.74, rt=397.35

### Step 2: Node 26931 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26932, 26933, 26934, 26935, 26936, 26937
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=13747
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=64
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0001
  - Aggregate_Outer_startup_cost=136883.3000
  - Aggregate_Outer_total_cost=136883.3100
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=137883.8700
  - Aggregate_total_cost=137883.8800
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=137883.3000
  - Gather_Outer_total_cost=137883.8100
