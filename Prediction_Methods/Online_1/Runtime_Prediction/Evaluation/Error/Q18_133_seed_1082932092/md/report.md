...
```
Node 29396 (Limit) [PATTERN: 0aa5463f] - ROOT
    ...
    Node 29398 (Aggregate) [consumed]
      Node 29399 (Gather Merge) [consumed]
        Node 29400 (Incremental Sort) [consumed]
          Node 29401 (Nested Loop) [consumed]
            Node 29402 (Merge Join) [consumed]
              Node 29403 (Sort)
            ...
            Node 29411 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 0aa5463f | 29396 | 29397, 29398, 29399, 29400, 29401, 29402, 29404, 29405, 29406, 29411 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 29404 | 29396, 29397, 29398, 29399, 29400, 29401, 29402, 29405, 29406, 29411 |
...
- **Consumes:** Nodes 29396, 29397, 29398, 29399, 29400, 29401, 29402, 29405, 29406, 29411
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 7: Node 29396 (Limit) - PATTERN ROOT
...
- **Consumes:** Nodes 29397, 29398, 29399, 29400, 29401, 29402, 29404, 29405, 29406, 29411
- **Input Features:**
