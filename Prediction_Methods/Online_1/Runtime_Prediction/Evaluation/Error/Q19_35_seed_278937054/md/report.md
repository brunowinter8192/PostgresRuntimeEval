...
```
Node 31766 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 31767 (Gather) [consumed]
    Node 31768 (Aggregate) [consumed]
      Node 31769 (Hash Join) [PATTERN: f4cb205a]
        Node 31770 (Seq Scan) [consumed] - LEAF
        Node 31771 (Hash) [consumed]
          Node 31772 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 31769 | 31766, 31767, 31768, 31770, 31771, 31772 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31766 | 31767, 31768, 31769, 31770, 31771, 31772 |
...
|------|------|--------|-----------|-----|--------|
| 31766 | Aggregate | 858.27 | 834.50 | 2.8% | pattern |
| 31769 | Hash Join | 837.23 | 373.83 | 55.3% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31769 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 31766, 31767, 31768, 31770, 31771, 31772
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=23
  - HashJoin_nt1=22537
...
### Step 2: Node 31766 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31767, 31768, 31769, 31770, 31771, 31772
- **Input Features:**
