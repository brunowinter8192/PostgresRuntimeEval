...
```
Node 31766 (Aggregate) [PATTERN: f8295d8b] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 31766 | 31767, 31768, 31769, 31770, 31771, 31772 |
...
|------|------|--------|-----------|-----|--------|
| 31766 | Aggregate | 858.27 | 841.17 | 2.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31766 (Aggregate) - PATTERN ROOT
