...
```
Node 146 (Aggregate) [PATTERN: 3dfa6025] - ROOT
  Node 147 (Gather Merge) [consumed]
    Node 148 (Sort) [consumed]
      Node 149 (Aggregate) [consumed]
        Node 150 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 3dfa6025 | 146 | 147, 148, 149, 150 |
...
|------|------|--------|-----------|-----|--------|
| 146 | Aggregate | 1000.04 | 953.98 | 4.6% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 146 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3dfa6025 (Aggregate -> Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 147, 148, 149, 150
- **Input Features:**
  ...
  - Aggregate_total_cost=169961.6800
  ...
  - GatherMerge_Outer_total_cost=169960.5400
