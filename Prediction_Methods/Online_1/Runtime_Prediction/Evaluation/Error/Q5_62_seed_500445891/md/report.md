              ...
              Node 9068 (Hash Join) [PATTERN: 895c6e8c]
                ...
                Node 9070 (Hash) [consumed]
                  Node 9071 (Hash Join)
                    ...
                    Node 9073 (Hash) [PATTERN: a54055ce]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 9073 | 9061, 9062, 9066, 9067, 9068, 9069, 9070, 9074, 9075, 9076, 9077, 9079 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 9068 | 9061, 9062, 9066, 9067, 9069, 9070, 9073, 9074, 9075, 9076, 9077, 9079 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 9066 | 9061, 9062, 9067, 9068, 9069, 9070, 9073, 9074, 9075, 9076, 9077, 9079 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 9061 | 9062, 9066, 9067, 9068, 9069, 9070, 9073, 9074, 9075, 9076, 9077, 9079 |
...
| 9071 | Hash Join | 41.96 | 62.70 | 49.4% | operator |
| 9072 | Seq Scan | 40.48 | 24.87 | 38.6% | operator |
| 9073 | Hash | 0.14 | 0.14 | 2.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 9072 (Seq Scan) - LEAF
...
### Step 2: Node 9073 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 9061, 9062, 9066, 9067, 9068, 9069, 9070, 9074, 9075, 9076, 9077, 9079
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 4: Node 9068 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 9061, 9062, 9066, 9067, 9069, 9070, 9073, 9074, 9075, 9076, 9077, 9079
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14756
  - HashJoin_nt1=73782
...
### Step 5: Node 9078 (Index Scan) - LEAF
...
### Step 6: Node 9080 (Seq Scan) - LEAF
...
### Step 7: Node 9066 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 9061, 9062, 9067, 9068, 9069, 9070, 9073, 9074, 9075, 9076, 9077, 9079
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=2362
  - HashJoin_nt1=59037
...
### Step 10: Node 9063 (Gather Merge)
...
### Step 11: Node 9061 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 9062, 9066, 9067, 9068, 9069, 9070, 9073, 9074, 9075, 9076, 9077, 9079
- **Input Features:**
