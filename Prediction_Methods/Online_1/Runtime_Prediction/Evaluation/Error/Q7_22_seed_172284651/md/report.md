      ...
      Node 11656 (Hash Join)
        Node 11657 (Nested Loop)
          Node 11658 (Hash Join)
            ...
            Node 11660 (Hash) [PATTERN: a54055ce]
              Node 11661 (Hash Join) [consumed]
                Node 11662 (Seq Scan) [consumed] - LEAF
                Node 11663 (Hash) [consumed]
                  Node 11664 (Seq Scan) [consumed] - LEAF
          Node 11665 (Index Scan) - LEAF
        Node 11666 (Hash) [PATTERN: a54055ce]
          Node 11667 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 11660 | 11653, 11654, 11661, 11662, 11663, 11664, 11666, 11667, 11668, 11669, 11670 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 11666 | 11653, 11654, 11660, 11661, 11662, 11663, 11664, 11667, 11668, 11669, 11670 |
| Aggregate -> Gather Merge (Out | 2724c080 | 11653 | 11654, 11660, 11661, 11662, 11663, 11664, 11666, 11667, 11668, 11669, 11670 |
...
| 11656 | Hash Join | 1180.57 | 1130.43 | 4.2% | operator |
| 11657 | Nested Loop | 1173.76 | 1145.81 | 2.4% | operator |
| 11666 | Hash | 3.14 | 3.42 | 9.0% | pattern |
| 11658 | Hash Join | 208.31 | 319.90 | 53.6% | operator |
| 11665 | Index Scan | 0.03 | 0.09 | 163.5% | operator |
| 11659 | Seq Scan | 151.23 | 192.19 | 27.1% | operator |
| 11660 | Hash | 32.56 | 35.59 | 9.3% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 11659 (Seq Scan) - LEAF
...
### Step 2: Node 11660 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 11653, 11654, 11661, 11662, 11663, 11664, 11666, 11667, 11668, 11669, 11670
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 11665 (Index Scan) - LEAF
...
### Step 6: Node 11666 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 11653, 11654, 11660, 11661, 11662, 11663, 11664, 11667, 11668, 11669, 11670
- **Input Features:**
  - HashJoin_Outer_np=0
...
- **Consumes:** Nodes 11654, 11660, 11661, 11662, 11663, 11664, 11666, 11667, 11668, 11669, 11670
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
