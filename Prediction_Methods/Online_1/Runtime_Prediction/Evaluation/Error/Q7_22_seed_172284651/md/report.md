...
```
Node 11653 (Aggregate) [PATTERN: 27c3eea9] - ROOT
  Node 11654 (Gather Merge) [consumed]
    Node 11655 (Sort) [consumed]
      Node 11656 (Hash Join) [consumed]
        Node 11657 (Nested Loop) [consumed]
          Node 11658 (Hash Join) [consumed]
          ...
          Node 11665 (Index Scan) [consumed] - LEAF
        Node 11666 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 27c3eea9 | 11653 | 11654, 11655, 11656, 11657, 11658, 11660, 11661, 11662, 11663, 11664, 11665, 11666, 11667 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 11660 | 11653, 11654, 11655, 11656, 11657, 11658, 11661, 11662, 11663, 11664, 11665, 11666, 11667 |
...
|------|------|--------|-----------|-----|--------|
| 11653 | Aggregate | 1188.18 | 1200.90 | 1.1% | pattern |
...
### Step 1: Node 11670 (Seq Scan) - LEAF
...
### Step 2: Node 11659 (Seq Scan) - LEAF
...
### Step 3: Node 11660 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 11653, 11654, 11655, 11656, 11657, 11658, 11661, 11662, 11663, 11664, 11665, 11666, 11667
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 11668 (Seq Scan) - LEAF
...
### Step 6: Node 11653 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 11654, 11655, 11656, 11657, 11658, 11660, 11661, 11662, 11663, 11664, 11665, 11666, 11667
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
