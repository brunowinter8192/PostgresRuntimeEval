...
```
Node 30132 (Limit) [PATTERN: 0aa5463f] - ROOT
    ...
    Node 30134 (Aggregate) [consumed]
      Node 30135 (Gather Merge) [consumed]
        Node 30136 (Incremental Sort) [consumed]
          Node 30137 (Nested Loop) [consumed]
            Node 30138 (Merge Join) [consumed]
              Node 30139 (Sort)
            ...
            Node 30147 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 0aa5463f | 30132 | 30133, 30134, 30135, 30136, 30137, 30138, 30140, 30141, 30142, 30147 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 30140 | 30132, 30133, 30134, 30135, 30136, 30137, 30138, 30141, 30142, 30147 |
...
- **Consumes:** Nodes 30132, 30133, 30134, 30135, 30136, 30137, 30138, 30141, 30142, 30147
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 7: Node 30132 (Limit) - PATTERN ROOT
...
- **Consumes:** Nodes 30133, 30134, 30135, 30136, 30137, 30138, 30140, 30141, 30142, 30147
- **Input Features:**
