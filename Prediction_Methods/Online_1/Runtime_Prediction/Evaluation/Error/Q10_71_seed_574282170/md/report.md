  ...
  Node 20905 (Sort) [consumed]
    Node 20906 (Aggregate) [consumed]
      Node 20907 (Gather) [consumed]
        Node 20908 (Hash Join) [PATTERN: 7a51ce50]
          Node 20909 (Hash Join) [consumed]
            Node 20910 (Nested Loop) [consumed]
              Node 20911 (Seq Scan) [consumed] - LEAF
              Node 20912 (Index Scan) [consumed] - LEAF
            Node 20913 (Hash) [consumed]
              Node 20914 (Seq Scan) [consumed] - LEAF
          Node 20915 (Hash) [consumed]
            Node 20916 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Hash Join -> [Ne | 7a51ce50 | 20908 | 20904, 20905, 20906, 20907, 20909, 20910, 20911, 20912, 20913, 20914, 20915, 20916 |
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 20904 | 20905, 20906, 20907, 20908, 20909, 20910, 20911, 20912, 20913, 20914, 20915, 20916 |
...
| 20908 | Hash Join | 1106.30 | 730.67 | 34.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 20908 (Hash Join) - PATTERN ROOT
...
- **Consumes:** Nodes 20904, 20905, 20906, 20907, 20909, 20910, 20911, 20912, 20913, 20914, 20915, 20916
- **Input Features:**
  - HashJoin_Outer_np=0
  ...
  - HashJoin_Outer_total_cost=80807.8600
  - HashJoin_np=0
  - HashJoin_nt=18184
  - HashJoin_nt1=18184
  - HashJoin_nt2=25
  ...
  - HashJoin_total_cost=80865.2500
  - Hash_Inner_np=0
  - Hash_Inner_nt=62500
...
### Step 2: Node 20904 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20905, 20906, 20907, 20908, 20909, 20910, 20911, 20912, 20913, 20914, 20915, 20916
- **Input Features:**
