...
```
Node 226 (Aggregate) [PATTERN: 3dfa6025] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 3dfa6025 | 226 | 227, 228, 229, 230 |
...
|------|------|--------|-----------|-----|--------|
| 226 | Aggregate | 937.95 | 953.98 | 1.7% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 226 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3dfa6025 (Aggregate -> Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 227, 228, 229, 230
- **Input Features:**
  ...
  - Aggregate_total_cost=169702.4000
  ...
  - GatherMerge_Outer_total_cost=169701.2600
