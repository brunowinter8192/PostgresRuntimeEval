...
```
Node 27309 (Aggregate) [PATTERN: f8295d8b] - ROOT
  Node 27310 (Gather) [consumed]
    Node 27311 (Aggregate) [consumed]
      Node 27312 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 27309 | 27310, 27311, 27312, 27313, 27314, 27315 |
...
|------|------|--------|-----------|-----|--------|
| 27309 | Aggregate | 818.96 | 822.68 | 0.5% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27309 (Aggregate) - PATTERN ROOT
