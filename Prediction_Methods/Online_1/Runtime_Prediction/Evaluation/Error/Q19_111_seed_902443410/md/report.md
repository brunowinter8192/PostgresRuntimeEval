...
```
Node 31304 (Aggregate) [PATTERN: f8295d8b] - ROOT
  Node 31305 (Gather) [consumed]
    Node 31306 (Aggregate) [consumed]
      Node 31307 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 31304 | 31305, 31306, 31307, 31308, 31309, 31310 |
...
|------|------|--------|-----------|-----|--------|
| 31304 | Aggregate | 873.83 | 841.17 | 3.7% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 31304 (Aggregate) - PATTERN ROOT
