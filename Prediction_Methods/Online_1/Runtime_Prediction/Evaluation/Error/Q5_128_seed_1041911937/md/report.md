        ...
        Node 7505 (Sort) [consumed]
          Node 7506 (Hash Join) [consumed]
            Node 7507 (Nested Loop) [consumed]
              ...
              Node 7518 (Index Scan) [consumed] - LEAF
            Node 7519 (Hash) [consumed]
              Node 7520 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather Me | 255215ee | 7501 | 7502, 7503, 7504, 7505, 7506, 7507, 7508, 7509, 7510, 7511, 7512, 7513, 7514, 7518, 7519, 7520 |
...
|------|------|--------|-----------|-----|--------|
| 7501 | Sort | 1073.80 | 1070.44 | 0.3% | pattern |
...
### Step 4: Node 7501 (Sort) - PATTERN ROOT
...
- **Consumes:** Nodes 7502, 7503, 7504, 7505, 7506, 7507, 7508, 7509, 7510, 7511, 7512, 7513, 7514, 7518, 7519, 7520
- **Input Features:**
