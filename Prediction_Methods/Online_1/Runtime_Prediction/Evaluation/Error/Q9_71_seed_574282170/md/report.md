        ...
        Node 18792 (Nested Loop)
          Node 18793 (Hash Join) [PATTERN: 895c6e8c]
            ...
            Node 18795 (Hash) [consumed]
              Node 18796 (Hash Join) [PATTERN: 7a51ce50]
                Node 18797 (Hash Join) [consumed]
                  Node 18798 (Nested Loop) [consumed]
                    Node 18799 (Seq Scan) [consumed] - LEAF
                    Node 18800 (Index Scan) [consumed] - LEAF
                  Node 18801 (Hash) [consumed]
                    Node 18802 (Seq Scan) [consumed] - LEAF
                Node 18803 (Hash) [consumed]
                  Node 18804 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Hash Join -> [Hash Join -> [Ne | 7a51ce50 | 18796 | 18788, 18789, 18793, 18794, 18795, 18797, 18798, 18799, 18800, 18801, 18802, 18803, 18804 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 18793 | 18788, 18789, 18794, 18795, 18796, 18797, 18798, 18799, 18800, 18801, 18802, 18803, 18804 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18788 | 18789, 18793, 18794, 18795, 18796, 18797, 18798, 18799, 18800, 18801, 18802, 18803, 18804 |
...
| 18796 | Hash Join | 186.92 | 546.27 | 192.2% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 18796 (Hash Join) - PATTERN ROOT
...
- **Consumes:** Nodes 18788, 18789, 18793, 18794, 18795, 18797, 18798, 18799, 18800, 18801, 18802, 18803, 18804
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 2: Node 18793 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 18788, 18789, 18794, 18795, 18796, 18797, 18798, 18799, 18800, 18801, 18802, 18803, 18804
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=52919
...
### Step 3: Node 18805 (Index Scan) - LEAF
...
### Step 7: Node 18788 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18789, 18793, 18794, 18795, 18796, 18797, 18798, 18799, 18800, 18801, 18802, 18803, 18804
- **Input Features:**
