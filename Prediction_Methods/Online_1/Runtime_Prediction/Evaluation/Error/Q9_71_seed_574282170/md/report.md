    ...
    Node 18790 (Gather) [consumed]
      Node 18791 (Aggregate) [consumed]
        Node 18792 (Nested Loop) [consumed]
          ...
          Node 18805 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather -> | 76ab422a | 18788 | 18789, 18790, 18791, 18792, 18793, 18794, 18795, 18796, 18797, 18798, 18801, 18803, 18804, 18805 |
...
|------|------|--------|-----------|-----|--------|
| 18788 | Sort | 1213.12 | 1195.01 | 1.5% | pattern |
...
### Step 4: Node 18788 (Sort) - PATTERN ROOT
...
- **Consumes:** Nodes 18789, 18790, 18791, 18792, 18793, 18794, 18795, 18796, 18797, 18798, 18801, 18803, 18804, 18805
- **Input Features:**
