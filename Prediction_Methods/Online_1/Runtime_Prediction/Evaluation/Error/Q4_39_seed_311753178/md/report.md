...
```
Node 6425 (Aggregate) [PATTERN: 80bd802d] - ROOT
  Node 6426 (Gather Merge) [consumed]
    Node 6427 (Sort) [consumed]
      Node 6428 (Aggregate) [consumed]
        Node 6429 (Nested Loop) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 80bd802d | 6425 | 6426, 6427, 6428, 6429, 6430, 6431 |
...
|------|------|--------|-----------|-----|--------|
| 6425 | Aggregate | 1052.97 | 1057.79 | 0.5% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6425 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 6426, 6427, 6428, 6429, 6430, 6431
- **Input Features:**
  ...
  - NestedLoop_Outer_total_cost=65470.4400
  - SeqScan_Outer_np=26136
  - SeqScan_Outer_nt=17822
  - SeqScan_Outer_nt1=0
  - SeqScan_Outer_nt2=0
