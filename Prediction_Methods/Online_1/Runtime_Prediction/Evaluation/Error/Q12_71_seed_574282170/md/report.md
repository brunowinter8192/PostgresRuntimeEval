...
```
Node 25146 (Aggregate) [PATTERN: f9c97829] - ROOT
  Node 25147 (Gather Merge) [consumed]
    Node 25148 (Aggregate) [consumed]
      Node 25149 (Sort) [consumed]
        Node 25150 (Nested Loop) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> A | f9c97829 | 25146 | 25147, 25148, 25149, 25150, 25151, 25152 |
...
|------|------|--------|-----------|-----|--------|
| 25146 | Aggregate | 988.96 | 998.49 | 1.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25146 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 25147, 25148, 25149, 25150, 25151, 25152
- **Input Features:**
  ...
  - NestedLoop_Outer_nt=5791
  - NestedLoop_Outer_nt1=5791
  ...
  - NestedLoop_Outer_total_cost=147187.3400
  ...
  - Sort_Outer_startup_cost=147549.2600
  - Sort_Outer_total_cost=147563.7400
