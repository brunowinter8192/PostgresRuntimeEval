...
Node 25146 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 25147 (Gather Merge) [consumed]
    Node 25148 (Aggregate)
      Node 25149 (Sort)
        Node 25150 (Nested Loop)
          Node 25151 (Seq Scan) - LEAF
          Node 25152 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge (Out | 2724c080 | 25146 | 25147 |
...
| 25148 | Aggregate | 969.57 | 941.96 | 2.8% | operator |
| 25149 | Sort | 968.94 | 1058.11 | 9.2% | operator |
| 25150 | Nested Loop | 967.93 | 1101.31 | 13.8% | operator |
| 25151 | Seq Scan | 835.37 | 750.46 | 10.2% | operator |
| 25152 | Index Scan | 0.03 | -0.02 | 165.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25151 (Seq Scan) - LEAF
...
### Step 2: Node 25152 (Index Scan) - LEAF
...
### Step 6: Node 25146 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 25147
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=7
  - Aggregate_nt1=35
