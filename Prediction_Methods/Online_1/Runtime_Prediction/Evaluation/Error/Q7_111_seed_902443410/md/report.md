...
```
Node 10717 (Aggregate) [PATTERN: 27c3eea9] - ROOT
  Node 10718 (Gather Merge) [consumed]
    Node 10719 (Sort) [consumed]
      Node 10720 (Hash Join) [consumed]
        Node 10721 (Nested Loop) [consumed]
          Node 10722 (Hash Join) [consumed]
          ...
          Node 10729 (Index Scan) [consumed] - LEAF
        Node 10730 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 27c3eea9 | 10717 | 10718, 10719, 10720, 10721, 10722, 10724, 10725, 10726, 10727, 10728, 10729, 10730, 10731 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 10724 | 10717, 10718, 10719, 10720, 10721, 10722, 10725, 10726, 10727, 10728, 10729, 10730, 10731 |
...
|------|------|--------|-----------|-----|--------|
| 10717 | Aggregate | 1242.21 | 1200.90 | 3.3% | pattern |
...
### Step 1: Node 10734 (Seq Scan) - LEAF
...
### Step 2: Node 10723 (Seq Scan) - LEAF
...
### Step 3: Node 10724 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 10717, 10718, 10719, 10720, 10721, 10722, 10725, 10726, 10727, 10728, 10729, 10730, 10731
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 10732 (Seq Scan) - LEAF
...
### Step 6: Node 10717 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 10718, 10719, 10720, 10721, 10722, 10724, 10725, 10726, 10727, 10728, 10729, 10730, 10731
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
