      ...
      Node 10720 (Hash Join)
        Node 10721 (Nested Loop)
          Node 10722 (Hash Join)
            ...
            Node 10724 (Hash) [PATTERN: a54055ce]
              Node 10725 (Hash Join) [consumed]
                Node 10726 (Seq Scan) [consumed] - LEAF
                Node 10727 (Hash) [consumed]
                  Node 10728 (Seq Scan) [consumed] - LEAF
          Node 10729 (Index Scan) - LEAF
        Node 10730 (Hash) [PATTERN: a54055ce]
          Node 10731 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 10724 | 10717, 10718, 10725, 10726, 10727, 10728, 10730, 10731, 10732, 10733, 10734 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 10730 | 10717, 10718, 10724, 10725, 10726, 10727, 10728, 10731, 10732, 10733, 10734 |
| Aggregate -> Gather Merge (Out | 2724c080 | 10717 | 10718, 10724, 10725, 10726, 10727, 10728, 10730, 10731, 10732, 10733, 10734 |
...
| 10720 | Hash Join | 1233.31 | 1130.43 | 8.3% | operator |
| 10721 | Nested Loop | 1226.34 | 1145.81 | 6.6% | operator |
| 10730 | Hash | 3.17 | 3.42 | 7.8% | pattern |
| 10722 | Hash Join | 219.33 | 319.90 | 45.9% | operator |
| 10729 | Index Scan | 0.03 | 0.09 | 163.5% | operator |
| 10723 | Seq Scan | 156.40 | 192.19 | 22.9% | operator |
| 10724 | Hash | 37.94 | 35.59 | 6.2% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10723 (Seq Scan) - LEAF
...
### Step 2: Node 10724 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 10717, 10718, 10725, 10726, 10727, 10728, 10730, 10731, 10732, 10733, 10734
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 10729 (Index Scan) - LEAF
...
### Step 6: Node 10730 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 10717, 10718, 10724, 10725, 10726, 10727, 10728, 10731, 10732, 10733, 10734
- **Input Features:**
  - HashJoin_Outer_np=0
...
- **Consumes:** Nodes 10718, 10724, 10725, 10726, 10727, 10728, 10730, 10731, 10732, 10733, 10734
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
