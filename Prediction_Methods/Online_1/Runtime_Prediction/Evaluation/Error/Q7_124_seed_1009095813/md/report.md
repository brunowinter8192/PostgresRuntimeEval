...
```
Node 10969 (Aggregate) [PATTERN: 27c3eea9] - ROOT
  Node 10970 (Gather Merge) [consumed]
    Node 10971 (Sort) [consumed]
      Node 10972 (Hash Join) [consumed]
        Node 10973 (Nested Loop) [consumed]
          Node 10974 (Hash Join) [consumed]
          ...
          Node 10981 (Index Scan) [consumed] - LEAF
        Node 10982 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 27c3eea9 | 10969 | 10970, 10971, 10972, 10973, 10974, 10976, 10977, 10978, 10979, 10980, 10981, 10982, 10983 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 10976 | 10969, 10970, 10971, 10972, 10973, 10974, 10977, 10978, 10979, 10980, 10981, 10982, 10983 |
...
|------|------|--------|-----------|-----|--------|
| 10969 | Aggregate | 1213.65 | 1200.90 | 1.1% | pattern |
...
### Step 1: Node 10986 (Seq Scan) - LEAF
...
### Step 2: Node 10975 (Seq Scan) - LEAF
...
### Step 3: Node 10976 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 10969, 10970, 10971, 10972, 10973, 10974, 10977, 10978, 10979, 10980, 10981, 10982, 10983
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 10984 (Seq Scan) - LEAF
...
### Step 6: Node 10969 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 10970, 10971, 10972, 10973, 10974, 10976, 10977, 10978, 10979, 10980, 10981, 10982, 10983
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
