      ...
      Node 10972 (Hash Join)
        Node 10973 (Nested Loop)
          Node 10974 (Hash Join)
            ...
            Node 10976 (Hash) [PATTERN: a54055ce]
              Node 10977 (Hash Join) [consumed]
                Node 10978 (Seq Scan) [consumed] - LEAF
                Node 10979 (Hash) [consumed]
                  Node 10980 (Seq Scan) [consumed] - LEAF
          Node 10981 (Index Scan) - LEAF
        Node 10982 (Hash) [PATTERN: a54055ce]
          Node 10983 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 10976 | 10969, 10970, 10977, 10978, 10979, 10980, 10982, 10983, 10984, 10985, 10986 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 10982 | 10969, 10970, 10976, 10977, 10978, 10979, 10980, 10983, 10984, 10985, 10986 |
| Aggregate -> Gather Merge (Out | 2724c080 | 10969 | 10970, 10976, 10977, 10978, 10979, 10980, 10982, 10983, 10984, 10985, 10986 |
...
| 10972 | Hash Join | 1204.09 | 1130.43 | 6.1% | operator |
| 10973 | Nested Loop | 1197.44 | 1145.81 | 4.3% | operator |
| 10982 | Hash | 2.75 | 3.42 | 24.2% | pattern |
| 10974 | Hash Join | 216.04 | 319.90 | 48.1% | operator |
| 10981 | Index Scan | 0.03 | 0.09 | 171.7% | operator |
| 10975 | Seq Scan | 152.96 | 192.19 | 25.7% | operator |
| 10976 | Hash | 36.83 | 35.59 | 3.4% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10975 (Seq Scan) - LEAF
...
### Step 2: Node 10976 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 10969, 10970, 10977, 10978, 10979, 10980, 10982, 10983, 10984, 10985, 10986
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 4: Node 10981 (Index Scan) - LEAF
...
### Step 6: Node 10982 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 10969, 10970, 10976, 10977, 10978, 10979, 10980, 10983, 10984, 10985, 10986
- **Input Features:**
  - HashJoin_Outer_np=0
...
- **Consumes:** Nodes 10970, 10976, 10977, 10978, 10979, 10980, 10982, 10983, 10984, 10985, 10986
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=6078
  - Aggregate_nt1=6078
