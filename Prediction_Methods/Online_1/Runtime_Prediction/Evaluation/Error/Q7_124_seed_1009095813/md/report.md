...
```
Node 10969 (Aggregate) - ROOT
  Node 10970 (Gather Merge)
    Node 10971 (Sort)
      Node 10972 (Hash Join)
        Node 10973 (Nested Loop)
          Node 10974 (Hash Join)
            Node 10975 (Seq Scan) - LEAF
            Node 10976 (Hash)
              Node 10977 (Hash Join)
                Node 10978 (Seq Scan) - LEAF
                Node 10979 (Hash)
                  Node 10980 (Seq Scan) - LEAF
          Node 10981 (Index Scan) - LEAF
        Node 10982 (Hash)
          Node 10983 (Hash Join)
            Node 10984 (Seq Scan) - LEAF
            Node 10985 (Hash)
              Node 10986 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 10969 | Aggregate | 1213.65 | 1202.22 | 0.9% | operator |
| 10970 | Gather Merge | 1212.58 | 1148.45 | 5.3% | operator |
| 10971 | Sort | 1204.71 | 1149.87 | 4.6% | operator |
| 10972 | Hash Join | 1204.09 | 1130.50 | 6.1% | operator |
| 10973 | Nested Loop | 1197.44 | 1145.81 | 4.3% | operator |
| 10982 | Hash | 2.75 | 15.44 | 460.7% | operator |
| 10974 | Hash Join | 216.04 | 319.53 | 47.9% | operator |
| 10981 | Index Scan | 0.03 | 0.09 | 171.7% | operator |
| 10983 | Hash Join | 2.70 | 49.64 | 1739.1% | operator |
| 10975 | Seq Scan | 152.96 | 192.19 | 25.7% | operator |
| 10976 | Hash | 36.83 | 17.27 | 53.1% | operator |
| 10984 | Seq Scan | 2.37 | 10.62 | 348.7% | operator |
| 10985 | Hash | 0.01 | 14.54 | 96814.4% | operator |
| 10977 | Hash Join | 36.52 | 54.15 | 48.3% | operator |
| 10986 | Seq Scan | 0.01 | 7.20 | 59866.2% | operator |
| 10978 | Seq Scan | 35.38 | 24.87 | 29.7% | operator |
| 10979 | Hash | 0.01 | 14.54 | 132056.0% | operator |
| 10980 | Seq Scan | 0.01 | 7.20 | 79855.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10980 (Seq Scan) - LEAF
...
### Step 2: Node 10978 (Seq Scan) - LEAF
...
### Step 5: Node 10986 (Seq Scan) - LEAF
...
### Step 6: Node 10975 (Seq Scan) - LEAF
...
### Step 8: Node 10984 (Seq Scan) - LEAF
...
### Step 11: Node 10981 (Index Scan) - LEAF
...
### Step 13: Node 10973 (Nested Loop)
...
### Step 17: Node 10970 (Gather Merge)
...
### Step 18: Node 10969 (Aggregate) - ROOT
