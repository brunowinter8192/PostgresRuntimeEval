...
```
Node 29700 (Limit) [PATTERN: 0aa5463f] - ROOT
    ...
    Node 29702 (Aggregate) [consumed]
      Node 29703 (Gather Merge) [consumed]
        Node 29704 (Incremental Sort) [consumed]
          Node 29705 (Nested Loop) [consumed]
            Node 29706 (Merge Join) [consumed]
              Node 29707 (Sort)
            ...
            Node 29715 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 0aa5463f | 29700 | 29701, 29702, 29703, 29704, 29705, 29706, 29715 |
...
| 29707 | Sort | 2873.37 | 1098.75 | 61.8% | operator |
| 29713 | Sort | 64.43 | 1014.60 | 1474.8% | operator |
| 29708 | Hash Join | 2873.36 | 773.67 | 73.1% | operator |
| 29714 | Seq Scan | 52.26 | 25.47 | 51.3% | operator |
| 29709 | Seq Scan | 196.40 | 187.11 | 4.7% | operator |
| 29710 | Hash | 2645.38 | 255.35 | 90.3% | operator |
...
### Step 9: Node 29700 (Limit) - PATTERN ROOT
...
- **Consumes:** Nodes 29701, 29702, 29703, 29704, 29705, 29706, 29715
- **Input Features:**
