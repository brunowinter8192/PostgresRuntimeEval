...
```
Node 32235 (Aggregate) [PATTERN: f8295d8b] - ROOT
  Node 32236 (Gather) [consumed]
    Node 32237 (Aggregate) [consumed]
      Node 32238 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 32235 | 32236, 32237, 32238, 32239, 32240, 32241 |
...
|------|------|--------|-----------|-----|--------|
| 32235 | Aggregate | 842.53 | 841.17 | 0.2% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 32235 (Aggregate) - PATTERN ROOT
