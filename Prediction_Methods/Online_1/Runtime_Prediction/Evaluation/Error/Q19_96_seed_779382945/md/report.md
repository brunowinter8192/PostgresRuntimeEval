...
Node 32235 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 32236 (Gather) [consumed]
    Node 32237 (Aggregate) [consumed]
      Node 32238 (Hash Join) [PATTERN: f4cb205a]
        Node 32239 (Seq Scan) [consumed] - LEAF
        Node 32240 (Hash) [consumed]
          Node 32241 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 32238 | 32235, 32236, 32237, 32239, 32240, 32241 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 32235 | 32236, 32237, 32238, 32239, 32240, 32241 |
...
| 32238 | Hash Join | 822.63 | 373.83 | 54.6% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 32238 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 32235, 32236, 32237, 32239, 32240, 32241
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=23
  - HashJoin_nt1=22534
...
### Step 2: Node 32235 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 32236, 32237, 32238, 32239, 32240, 32241
- **Input Features:**
