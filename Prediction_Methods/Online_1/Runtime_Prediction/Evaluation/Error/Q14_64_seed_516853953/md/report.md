...
```
Node 27190 (Aggregate) [PATTERN: f8295d8b] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | f8295d8b | 27190 | 27191, 27192, 27193, 27194, 27195, 27196 |
...
|------|------|--------|-----------|-----|--------|
| 27190 | Aggregate | 791.02 | 822.64 | 4.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 27190 (Aggregate) - PATTERN ROOT
