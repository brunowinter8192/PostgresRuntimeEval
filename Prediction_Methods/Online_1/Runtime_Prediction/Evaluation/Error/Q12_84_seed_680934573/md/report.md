...
```
Node 25244 (Aggregate) [PATTERN: f9c97829] - ROOT
  Node 25245 (Gather Merge) [consumed]
    Node 25246 (Aggregate) [consumed]
      Node 25247 (Sort) [consumed]
        Node 25248 (Nested Loop) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> A | f9c97829 | 25244 | 25245, 25246, 25247, 25248, 25249, 25250 |
...
|------|------|--------|-----------|-----|--------|
| 25244 | Aggregate | 996.84 | 998.49 | 0.2% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25244 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 25245, 25246, 25247, 25248, 25249, 25250
- **Input Features:**
