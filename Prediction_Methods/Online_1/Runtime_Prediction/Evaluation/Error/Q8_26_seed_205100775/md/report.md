...
Node 14765 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 14766 (Gather Merge) [consumed]
    Node 14767 (Sort)
      Node 14768 (Hash Join) [PATTERN: 2e0f44ef]
        Node 14769 (Nested Loop) [consumed]
          Node 14770 (Hash Join) [PATTERN: 2e0f44ef]
            Node 14771 (Nested Loop) [consumed]
              Node 14772 (Hash Join) [PATTERN: 895c6e8c]
                Node 14773 (Seq Scan) [consumed] - LEAF
                Node 14774 (Hash) [consumed]
                  Node 14775 (Hash Join)
                    Node 14776 (Seq Scan) - LEAF
                    Node 14777 (Hash) [PATTERN: a54055ce]
                      Node 14778 (Hash Join) [consumed]
                        Node 14779 (Seq Scan) [consumed] - LEAF
                        Node 14780 (Hash) [consumed]
                          Node 14781 (Seq Scan) [consumed] - LEAF
              Node 14782 (Index Scan) - LEAF
            Node 14783 (Hash) [consumed]
              Node 14784 (Seq Scan) - LEAF
          Node 14785 (Index Scan) - LEAF
        Node 14786 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | a54055ce | 14777 | 14765, 14766, 14768, 14769, 14770, 14771, 14772, 14773, 14774, 14778, 14779, 14780, 14781, 14783, 14786 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 14772 | 14765, 14766, 14768, 14769, 14770, 14771, 14773, 14774, 14777, 14778, 14779, 14780, 14781, 14783, 14786 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 14768 | 14765, 14766, 14769, 14770, 14771, 14772, 14773, 14774, 14777, 14778, 14779, 14780, 14781, 14783, 14786 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 14770 | 14765, 14766, 14768, 14769, 14771, 14772, 14773, 14774, 14777, 14778, 14779, 14780, 14781, 14783, 14786 |
| Aggregate -> Gather Merge (Out | 2724c080 | 14765 | 14766, 14768, 14769, 14770, 14771, 14772, 14773, 14774, 14777, 14778, 14779, 14780, 14781, 14783, 14786 |
...
| 14767 | Sort | 1215.31 | 1096.02 | 9.8% | operator |
| 14768 | Hash Join | 1215.05 | 1199.17 | 1.3% | pattern |
| 14770 | Hash Join | 1210.95 | 1192.81 | 1.5% | pattern |
| 14785 | Index Scan | 0.01 | 0.05 | 753.5% | operator |
| 14787 | Seq Scan | 0.01 | 7.19 | 55242.1% | operator |
| 14772 | Hash Join | 209.83 | 260.30 | 24.1% | pattern |
| 14782 | Index Scan | 0.04 | 0.09 | 112.3% | operator |
| 14784 | Seq Scan | 39.17 | 44.48 | 13.6% | operator |
| 14775 | Hash Join | 35.73 | 67.79 | 89.7% | operator |
| 14776 | Seq Scan | 34.20 | 24.87 | 27.3% | operator |
| 14777 | Hash | 0.15 | 0.20 | 26.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 14776 (Seq Scan) - LEAF
...
### Step 2: Node 14777 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a54055ce (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 14765, 14766, 14768, 14769, 14770, 14771, 14772, 14773, 14774, 14778, 14779, 14780, 14781, 14783, 14786
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 4: Node 14772 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 14765, 14766, 14768, 14769, 14770, 14771, 14773, 14774, 14777, 14778, 14779, 14780, 14781, 14783, 14786
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=29497
  - HashJoin_nt1=147487
...
### Step 5: Node 14782 (Index Scan) - LEAF
...
### Step 6: Node 14784 (Seq Scan) - LEAF
...
### Step 7: Node 14770 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 14765, 14766, 14768, 14769, 14771, 14772, 14773, 14774, 14777, 14778, 14779, 14780, 14781, 14783, 14786
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=794
  - HashJoin_nt1=118013
...
### Step 8: Node 14785 (Index Scan) - LEAF
...
### Step 9: Node 14787 (Seq Scan) - LEAF
...
### Step 10: Node 14768 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 14765, 14766, 14769, 14770, 14771, 14772, 14773, 14774, 14777, 14778, 14779, 14780, 14781, 14783, 14786
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=794
  - HashJoin_nt1=794
  ...
  - HashJoin_total_cost=70517.8800
  - Hash_Inner_np=0
  - Hash_Inner_nt=25
  - Hash_Inner_nt1=25
  - Hash_Inner_nt2=0
  ...
  - NestedLoop_Outer_np=0
  - NestedLoop_Outer_nt=794
  - NestedLoop_Outer_nt1=794
  - NestedLoop_Outer_nt2=1
  - NestedLoop_Outer_parallel_workers=0
  - NestedLoop_Outer_plan_width=20
  - NestedLoop_Outer_reltuples=0.0000
  - NestedLoop_Outer_sel=1.0000
  - NestedLoop_Outer_startup_cost=9920.4700
  - NestedLoop_Outer_total_cost=70511.8900
- **Output:** st=80.31, rt=1199.17

### Step 11: Node 14767 (Sort)
...
### Step 12: Node 14765 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 14766, 14768, 14769, 14770, 14771, 14772, 14773, 14774, 14777, 14778, 14779, 14780, 14781, 14783, 14786
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2460
