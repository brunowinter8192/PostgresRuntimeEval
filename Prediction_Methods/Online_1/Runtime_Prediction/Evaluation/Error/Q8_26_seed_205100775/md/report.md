...
```
Node 14765 (Aggregate) [PATTERN: 53f9aa07] - ROOT
  Node 14766 (Gather Merge) [consumed]
    Node 14767 (Sort) [consumed]
      Node 14768 (Hash Join) [consumed]
        Node 14769 (Nested Loop) [consumed]
          Node 14770 (Hash Join)
            Node 14771 (Nested Loop) [PATTERN: bd9dfa7b]
              Node 14772 (Hash Join) [consumed]
              ...
              Node 14782 (Index Scan) [consumed] - LEAF
            Node 14783 (Hash)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 53f9aa07 | 14765 | 14766, 14767, 14768, 14769, 14771, 14772, 14773, 14774, 14775, 14777, 14778, 14779, 14780, 14781, 14782, 14786 |
| Hash -> Hash Join -> [Seq Scan | a54055ce | 14777 | 14765, 14766, 14767, 14768, 14769, 14771, 14772, 14773, 14774, 14775, 14778, 14779, 14780, 14781, 14782, 14786 |
| Nested Loop -> [Hash Join -> [ | bd9dfa7b | 14771 | 14765, 14766, 14767, 14768, 14769, 14772, 14773, 14774, 14775, 14777, 14778, 14779, 14780, 14781, 14782, 14786 |
...
|------|------|--------|-----------|-----|--------|
| 14765 | Aggregate | 1221.97 | 1220.50 | 0.1% | pattern |
| 14770 | Hash Join | 1210.95 | 1042.87 | 13.9% | operator |
| 14785 | Index Scan | 0.01 | 0.05 | 753.5% | operator |
| 14787 | Seq Scan | 0.01 | 7.19 | 55242.1% | operator |
| 14771 | Nested Loop | 1167.06 | 1155.06 | 1.0% | pattern |
...
- **Consumes:** Nodes 14765, 14766, 14767, 14768, 14769, 14771, 14772, 14773, 14774, 14775, 14778, 14779, 14780, 14781, 14782, 14786
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 3: Node 14784 (Seq Scan) - LEAF
...
### Step 4: Node 14771 (Nested Loop) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** bd9dfa7b (Nested Loop -> [Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer), Index Scan (Inner)])
- **Consumes:** Nodes 14765, 14766, 14767, 14768, 14769, 14772, 14773, 14774, 14775, 14777, 14778, 14779, 14780, 14781, 14782, 14786
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 7: Node 14785 (Index Scan) - LEAF
...
### Step 8: Node 14787 (Seq Scan) - LEAF
...
### Step 9: Node 14765 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 53f9aa07 (Aggregate -> Gather Merge -> Sort -> Hash Join -> [Nested Loop (Outer), Hash (Inner)] (Outer) (Outer) (Outer))
- **Consumes:** Nodes 14766, 14767, 14768, 14769, 14771, 14772, 14773, 14774, 14775, 14777, 14778, 14779, 14780, 14781, 14782, 14786
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2460
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=794
  - HashJoin_Outer_nt1=794
  - HashJoin_Outer_nt2=25
  - HashJoin_Outer_parallel_workers=0
  - HashJoin_Outer_plan_width=148
  - HashJoin_Outer_reltuples=0.0000
  - HashJoin_Outer_sel=0.0400
  - HashJoin_Outer_startup_cost=9922.0400
  - HashJoin_Outer_total_cost=70517.8800
  - Hash_Inner_np=0
  - Hash_Inner_nt=25
  - Hash_Inner_nt1=25
  - Hash_Inner_nt2=0
  ...
  - Sort_Outer_startup_cost=70556.1200
  - Sort_Outer_total_cost=70558.1000
- **Output:** st=1219.13, rt=1220.50
