...
```
Node 6383 (Aggregate) [PATTERN: 80bd802d] - ROOT
  Node 6384 (Gather Merge) [consumed]
    Node 6385 (Sort) [consumed]
      Node 6386 (Aggregate) [consumed]
        Node 6387 (Nested Loop) [consumed]
          Node 6388 (Seq Scan) [consumed] - LEAF
          Node 6389 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 80bd802d | 6383 | 6384, 6385, 6386, 6387, 6388, 6389 |
...
|------|------|--------|-----------|-----|--------|
| 6383 | Aggregate | 1067.59 | 1057.79 | 0.9% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6383 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 6384, 6385, 6386, 6387, 6388, 6389
- **Input Features:**
  ...
  - NestedLoop_Outer_nt=14997
  - NestedLoop_Outer_nt1=18391
