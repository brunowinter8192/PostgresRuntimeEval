        ...
        Node 17307 (Nested Loop)
          Node 17308 (Hash Join) [PATTERN: 895c6e8c]
            ...
            Node 17310 (Hash) [consumed]
              Node 17311 (Hash Join) [PATTERN: 7a51ce50]
                Node 17312 (Hash Join) [consumed]
                  Node 17313 (Nested Loop) [consumed]
                    Node 17314 (Seq Scan) [consumed] - LEAF
                    Node 17315 (Index Scan) [consumed] - LEAF
                  Node 17316 (Hash) [consumed]
                    Node 17317 (Seq Scan) [consumed] - LEAF
                Node 17318 (Hash) [consumed]
                  Node 17319 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Hash Join -> [Hash Join -> [Ne | 7a51ce50 | 17311 | 17303, 17304, 17308, 17309, 17310, 17312, 17313, 17314, 17315, 17316, 17317, 17318, 17319 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 17308 | 17303, 17304, 17309, 17310, 17311, 17312, 17313, 17314, 17315, 17316, 17317, 17318, 17319 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 17303 | 17304, 17308, 17309, 17310, 17311, 17312, 17313, 17314, 17315, 17316, 17317, 17318, 17319 |
...
| 17311 | Hash Join | 169.66 | 546.90 | 222.4% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 17311 (Hash Join) - PATTERN ROOT
...
- **Consumes:** Nodes 17303, 17304, 17308, 17309, 17310, 17312, 17313, 17314, 17315, 17316, 17317, 17318, 17319
- **Input Features:**
  - HashJoin_Outer_np=0
  ...
  - HashJoin_Outer_total_cost=15335.6200
  - HashJoin_np=0
  - HashJoin_nt=20708
  - HashJoin_nt1=20708
  - HashJoin_nt2=25
  ...
  - HashJoin_total_cost=15400.7600
  - Hash_Inner_np=0
  - Hash_Inner_nt=10000
  ...
  - IndexScan_Inner_total_cost=1.8300
...
- **Output:** st=18.61, rt=546.90

### Step 2: Node 17308 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 17303, 17304, 17309, 17310, 17311, 17312, 17313, 17314, 17315, 17316, 17317, 17318, 17319
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=74565
...
### Step 3: Node 17320 (Index Scan) - LEAF
...
### Step 7: Node 17303 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 17304, 17308, 17309, 17310, 17311, 17312, 17313, 17314, 17315, 17316, 17317, 17318, 17319
- **Input Features:**
