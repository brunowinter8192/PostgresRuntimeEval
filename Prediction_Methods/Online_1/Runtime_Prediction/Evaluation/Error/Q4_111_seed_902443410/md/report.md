...
```
Node 5935 (Aggregate) [PATTERN: 80bd802d] - ROOT
  Node 5936 (Gather Merge) [consumed]
    Node 5937 (Sort) [consumed]
      Node 5938 (Aggregate) [consumed]
        Node 5939 (Nested Loop) [consumed]
          Node 5940 (Seq Scan) [consumed] - LEAF
          Node 5941 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 80bd802d | 5935 | 5936, 5937, 5938, 5939, 5940, 5941 |
...
|------|------|--------|-----------|-----|--------|
| 5935 | Aggregate | 1057.16 | 1057.79 | 0.1% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5935 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 5936, 5937, 5938, 5939, 5940, 5941
- **Input Features:**
