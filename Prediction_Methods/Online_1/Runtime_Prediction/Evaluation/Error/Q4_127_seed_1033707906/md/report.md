...
```
Node 6054 (Aggregate) [PATTERN: 80bd802d] - ROOT
  Node 6055 (Gather Merge) [consumed]
    Node 6056 (Sort) [consumed]
      Node 6057 (Aggregate) [consumed]
        Node 6058 (Nested Loop) [consumed]
          Node 6059 (Seq Scan) [consumed] - LEAF
          Node 6060 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 80bd802d | 6054 | 6055, 6056, 6057, 6058, 6059, 6060 |
...
|------|------|--------|-----------|-----|--------|
| 6054 | Aggregate | 1052.89 | 1057.79 | 0.5% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6054 (Aggregate) - PATTERN ROOT
...
- **Consumes:** Nodes 6055, 6056, 6057, 6058, 6059, 6060
- **Input Features:**
  ...
  - NestedLoop_Outer_total_cost=65908.6900
  - SeqScan_Outer_np=26136
  - SeqScan_Outer_nt=18371
  - SeqScan_Outer_nt1=0
  - SeqScan_Outer_nt2=0
