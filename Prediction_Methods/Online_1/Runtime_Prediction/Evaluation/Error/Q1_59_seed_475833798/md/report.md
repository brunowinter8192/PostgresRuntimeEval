...
```
Node 521 (Aggregate) [PATTERN: 3dfa6025] - ROOT
  Node 522 (Gather Merge) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge -> S | 3dfa6025 | 521 | 522, 523, 524, 525 |
...
|------|------|--------|-----------|-----|--------|
| 521 | Aggregate | 926.45 | 953.98 | 3.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 521 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 3dfa6025 (Aggregate -> Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 522, 523, 524, 525
- **Input Features:**
  ...
  - Aggregate_startup_cost=170142.1300
  - Aggregate_total_cost=170146.9000
  ...
  - GatherMerge_Outer_startup_cost=170142.1300
  - GatherMerge_Outer_total_cost=170145.7600
