...
```
Node 26385 (Sort) [PATTERN: 35ffb644] - ROOT
  Node 26386 (Aggregate) [consumed]
    Node 26387 (Aggregate) [consumed]
      Node 26388 (Hash Join)
        Node 26389 (Seq Scan) - LEAF
        Node 26390 (Hash)
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Aggregate | 35ffb644 | 26385 | 26386, 26387 |
...
| 26388 | Hash Join | 683.76 | 705.41 | 3.2% | operator |
| 26389 | Seq Scan | 468.04 | 410.74 | 12.2% | operator |
| 26390 | Hash | 18.76 | 37.64 | 100.6% | operator |
| 26391 | Index Only Scan | 11.31 | 10.09 | 10.8% | operator |
...
### Step 2: Node 26389 (Seq Scan) - LEAF
...
### Step 5: Node 26385 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 35ffb644 (Sort -> Aggregate -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26386, 26387
- **Input Features:**
