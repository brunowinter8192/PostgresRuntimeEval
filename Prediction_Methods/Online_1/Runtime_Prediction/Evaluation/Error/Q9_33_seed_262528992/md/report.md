    ...
    Node 18031 (Gather) [consumed]
      Node 18032 (Aggregate) [consumed]
        Node 18033 (Nested Loop) [consumed]
          ...
          Node 18046 (Index Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather -> | 76ab422a | 18029 | 18030, 18031, 18032, 18033, 18034, 18035, 18036, 18037, 18038, 18039, 18042, 18044, 18045, 18046 |
...
|------|------|--------|-----------|-----|--------|
| 18029 | Sort | 1200.27 | 1195.05 | 0.4% | pattern |
...
### Step 4: Node 18029 (Sort) - PATTERN ROOT
...
- **Consumes:** Nodes 18030, 18031, 18032, 18033, 18034, 18035, 18036, 18037, 18038, 18039, 18042, 18044, 18045, 18046
- **Input Features:**
