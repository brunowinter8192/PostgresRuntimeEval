...
```
Node 18029 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 18030 (Aggregate) [consumed]
    Node 18031 (Gather)
      Node 18032 (Aggregate)
        Node 18033 (Nested Loop)
          Node 18034 (Hash Join) [PATTERN: 895c6e8c]
            Node 18035 (Seq Scan) [consumed] - LEAF
            Node 18036 (Hash) [consumed]
              Node 18037 (Hash Join) [PATTERN: 7a51ce50]
                Node 18038 (Hash Join) [consumed]
                  Node 18039 (Nested Loop) [consumed]
                    Node 18040 (Seq Scan) [consumed] - LEAF
                    Node 18041 (Index Scan) [consumed] - LEAF
                  Node 18042 (Hash) [consumed]
                    Node 18043 (Seq Scan) [consumed] - LEAF
                Node 18044 (Hash) [consumed]
                  Node 18045 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Hash Join -> [Hash Join -> [Ne | 7a51ce50 | 18037 | 18029, 18030, 18034, 18035, 18036, 18038, 18039, 18040, 18041, 18042, 18043, 18044, 18045 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 18034 | 18029, 18030, 18035, 18036, 18037, 18038, 18039, 18040, 18041, 18042, 18043, 18044, 18045 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 18029 | 18030, 18034, 18035, 18036, 18037, 18038, 18039, 18040, 18041, 18042, 18043, 18044, 18045 |
...
|------|------|--------|-----------|-----|--------|
| 18029 | Sort | 1200.27 | 1114.71 | 7.1% | pattern |
| 18031 | Gather | 1199.14 | 1098.11 | 8.4% | operator |
| 18032 | Aggregate | 1181.13 | 1169.71 | 1.0% | operator |
| 18033 | Nested Loop | 1157.20 | 1168.16 | 0.9% | operator |
| 18034 | Hash Join | 983.91 | 732.52 | 25.6% | pattern |
| 18046 | Index Scan | 0.00 | -0.04 | 1512.7% | operator |
| 18037 | Hash Join | 178.10 | 546.70 | 207.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 18037 (Hash Join) - PATTERN ROOT
...
- **Consumes:** Nodes 18029, 18030, 18034, 18035, 18036, 18038, 18039, 18040, 18041, 18042, 18043, 18044, 18045
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 2: Node 18034 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 18029, 18030, 18035, 18036, 18037, 18038, 18039, 18040, 18041, 18042, 18043, 18044, 18045
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=48106
...
### Step 3: Node 18046 (Index Scan) - LEAF
...
### Step 7: Node 18029 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 18030, 18034, 18035, 18036, 18037, 18038, 18039, 18040, 18041, 18042, 18043, 18044, 18045
- **Input Features:**
