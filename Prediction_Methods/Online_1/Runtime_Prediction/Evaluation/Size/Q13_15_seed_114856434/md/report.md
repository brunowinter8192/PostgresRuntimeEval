...
**Test Query:** Q13_15_seed_114856434
**Timestamp:** 2026-01-11 16:27:09
...
| 1 | 7524c54c | 5.2190 | N/A | SKIPPED_LOW_ERROR | 17.81% |
| 2 | 3d5edd2b | 1.0091 | N/A | SKIPPED_LOW_ERROR | 17.81% |
| 3 | deb558a9 | 30.2295 | N/A | REJECTED | 17.81% |
| 4 | 895c6e8c | 75736.1626 | 0.0001% | ACCEPTED | 17.81% |
| 5 | 35ffb644 | 4.0145 | 0.9450% | ACCEPTED | 16.86% |
| 6 | 57bf6442 | 1.0091 | N/A | SKIPPED_LOW_ERROR | 16.86% |
| 7 | 422ae017 | 5.2190 | N/A | SKIPPED_LOW_ERROR | 16.86% |
...
```
Node 25762 (Sort) [PATTERN: f592ee11] - ROOT
  Node 25763 (Aggregate) [consumed]
    Node 25764 (Aggregate) [consumed]
      Node 25765 (Hash Join) [consumed]
        Node 25766 (Seq Scan) [consumed] - LEAF
        Node 25767 (Hash) [consumed]
          Node 25768 (Index Only Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Aggregate | f592ee11 | 25762 | 25763, 25764, 25765, 25766, 25767, 25768 |
...
|------|------|--------|-----------|-----|--------|
| 25762 | Sort | 900.00 | 915.33 | 1.7% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 25762 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f592ee11 (Sort -> Aggregate -> Aggregate -> Hash Join -> [Seq Scan (Outer), Hash -> Index Only Scan (Outer) (Inner)] (Outer) (Outer) (Outer))
- **Consumes:** Nodes 25763, 25764, 25765, 25766, 25767, 25768
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=150000
  - Aggregate_Outer_nt1=1475952
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=12
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.1016
  - Aggregate_Outer_startup_cost=60728.1700
  - Aggregate_Outer_total_cost=62228.1700
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=1475952
  - HashJoin_Outer_nt1=1475952
  ...
  - HashJoin_Outer_total_cost=53348.4100
  - Hash_Inner_np=0
