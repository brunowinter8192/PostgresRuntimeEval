...
```
Node 6621 (Aggregate) [PATTERN: 2724c080] - ROOT
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 6623 | 6621, 6622, 6624 |
| Aggregate -> Gather Merge (Out | 2724c080 | 6621 | 6622, 6623, 6624 |
...
|------|------|--------|-----------|-----|--------|
| 6621 | Aggregate | 1060.67 | 1078.92 | 1.7% | pattern |
...
### Step 5: Node 6621 (Aggregate) - PATTERN ROOT
