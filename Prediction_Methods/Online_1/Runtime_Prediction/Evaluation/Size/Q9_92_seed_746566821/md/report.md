...
Node 19207 (Sort) - ROOT
  Node 19208 (Aggregate) [PATTERN: a5f39f08]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 19208 | 19209, 19210 |
...
|------|------|--------|-----------|-----|--------|
| 19207 | Sort | 1195.21 | 1151.06 | 3.7% | operator |
| 19208 | Aggregate | 1195.09 | 1114.29 | 6.8% | pattern |
| 19211 | Nested Loop | 1150.11 | 1180.24 | 2.6% | operator |
| 19212 | Hash Join | 977.87 | 831.48 | 15.0% | operator |
| 19224 | Index Scan | 0.00 | -0.04 | 1512.7% | operator |
| 19213 | Seq Scan | 701.58 | 565.06 | 19.5% | operator |
| 19214 | Hash | 181.10 | 52.07 | 71.2% | operator |
| 19215 | Hash Join | 179.07 | 911.29 | 408.9% | operator |
| 19216 | Hash Join | 165.13 | 850.93 | 415.3% | operator |
| 19222 | Hash | 13.30 | 14.54 | 9.3% | operator |
| 19217 | Nested Loop | 159.55 | 1066.32 | 568.3% | operator |
| 19220 | Hash | 3.40 | 14.79 | 334.7% | operator |
...
### Step 10: Node 19213 (Seq Scan) - LEAF
...
### Step 13: Node 19224 (Index Scan) - LEAF
...
### Step 14: Node 19211 (Nested Loop)
...
### Step 15: Node 19208 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 19209, 19210
- **Input Features:**
