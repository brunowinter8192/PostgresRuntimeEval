...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 20904 | 20905, 20906, 20907, 20908, 20909, 20910, 20913 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 20909 | 20904, 20905, 20906, 20907, 20908, 20910, 20913 |
...
|------|------|--------|-----------|-----|--------|
| 20904 | Limit | 1155.84 | 1151.16 | 0.4% | pattern |
...
- **Consumes:** Nodes 20904, 20905, 20906, 20907, 20908, 20910, 20913
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18184
  - HashJoin_nt1=18184
...
### Step 7: Node 20904 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20905, 20906, 20907, 20908, 20909, 20910, 20913
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=18184
  - HashJoin_Outer_nt1=18184
  ...
  - HashJoin_Outer_total_cost=80865.2500
  - Limit_np=0
  - Limit_nt=20
  - Limit_nt1=56369
  - Limit_nt2=0
