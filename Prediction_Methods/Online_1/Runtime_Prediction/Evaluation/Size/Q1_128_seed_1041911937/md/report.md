...
**Test Query:** Q1_128_seed_1041911937
**Timestamp:** 2026-01-11 16:16:31
...
```
Node 151 (Aggregate) - ROOT
  Node 152 (Gather Merge) [PATTERN: 52c5ec81]
    Node 153 (Sort) [consumed]
      Node 154 (Aggregate) [consumed]
        Node 155 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Gather Merge -> Sort -> Aggreg | 52c5ec81 | 152 | 153, 154, 155 |
...
|------|------|--------|-----------|-----|--------|
| 151 | Aggregate | 936.63 | 1035.17 | 10.5% | operator |
| 152 | Gather Merge | 936.58 | 953.93 | 1.9% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 152 (Gather Merge) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 52c5ec81 (Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer))
- **Consumes:** Nodes 153, 154, 155
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=6
  - Aggregate_Outer_nt1=1179622
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=236
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0000
  - Aggregate_Outer_startup_cost=168889.8100
  - Aggregate_Outer_total_cost=168889.9400
  - GatherMerge_np=0
  - GatherMerge_nt=30
  - GatherMerge_nt1=6
  - GatherMerge_nt2=0
  ...
  - GatherMerge_startup_cost=169890.1000
  - GatherMerge_total_cost=169893.7300
  - SeqScan_Outer_np=112600
  - SeqScan_Outer_nt=1179622
  - SeqScan_Outer_nt1=0
  - SeqScan_Outer_nt2=0
  - SeqScan_Outer_parallel_workers=0
  - SeqScan_Outer_plan_width=25
  - SeqScan_Outer_reltuples=6001215.0000
  - SeqScan_Outer_sel=0.1966
  ...
  - Sort_Outer_startup_cost=168890.0200
  - Sort_Outer_total_cost=168890.0400
- **Output:** st=949.34, rt=953.93

### Step 2: Node 151 (Aggregate) - ROOT
