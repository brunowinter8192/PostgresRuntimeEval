...
```
Node 19838 (Limit) [PATTERN: 04a01b61] - ROOT
  Node 19839 (Sort) [consumed]
    Node 19840 (Aggregate) [consumed]
      Node 19841 (Gather) [consumed]
        Node 19842 (Hash Join) [consumed]
          Node 19843 (Hash Join) [PATTERN: 2e0f44ef]
            Node 19844 (Nested Loop) [consumed]
              Node 19845 (Seq Scan) - LEAF
              Node 19846 (Index Scan) - LEAF
            Node 19847 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 19838 | 19839, 19840, 19841, 19842, 19843, 19844, 19847 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 19843 | 19838, 19839, 19840, 19841, 19842, 19844, 19847 |
...
|------|------|--------|-----------|-----|--------|
| 19838 | Limit | 1131.32 | 1151.16 | 1.8% | pattern |
| 19843 | Hash Join | 1088.20 | 1101.74 | 1.2% | pattern |
| 19849 | Hash | 0.02 | 14.54 | 85427.7% | operator |
| 19850 | Seq Scan | 0.01 | 7.19 | 65304.3% | operator |
| 19845 | Seq Scan | 161.88 | 162.03 | 0.1% | operator |
| 19846 | Index Scan | 0.06 | -0.02 | 129.5% | operator |
| 19848 | Seq Scan | 24.22 | 29.69 | 22.6% | operator |
...
### Step 4: Node 19850 (Seq Scan) - LEAF
...
### Step 5: Node 19843 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 19838, 19839, 19840, 19841, 19842, 19844, 19847
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18186
  - HashJoin_nt1=18186
...
### Step 7: Node 19838 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19839, 19840, 19841, 19842, 19843, 19844, 19847
- **Input Features:**
