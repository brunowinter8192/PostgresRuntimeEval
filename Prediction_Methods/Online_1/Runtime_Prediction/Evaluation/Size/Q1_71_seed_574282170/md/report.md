...
Node 591 (Aggregate) - ROOT
  Node 592 (Gather Merge) [PATTERN: 52c5ec81]
...
|---------|------|-----------|----------------|
| Gather Merge -> Sort -> Aggreg | 52c5ec81 | 592 | 593, 594, 595 |
...
|------|------|--------|-----------|-----|--------|
| 591 | Aggregate | 997.05 | 1035.17 | 3.8% | operator |
| 592 | Gather Merge | 997.01 | 953.93 | 4.3% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 592 (Gather Merge) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 52c5ec81 (Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer))
- **Consumes:** Nodes 593, 594, 595
- **Input Features:**
  ...
  - GatherMerge_startup_cost=170063.8400
  - GatherMerge_total_cost=170067.4700
...
### Step 2: Node 591 (Aggregate) - ROOT
