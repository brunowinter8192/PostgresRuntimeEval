    ...
    Node 17196 (Gather) [consumed]
      Node 17197 (Aggregate) [consumed]
        Node 17198 (Nested Loop) [consumed]
          Node 17199 (Hash Join)
            Node 17200 (Seq Scan) - LEAF
            Node 17201 (Hash) [PATTERN: 7df893ad]
              Node 17202 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 0405d50f | 17195 | 17196, 17197, 17198, 17201, 17202, 17203, 17204, 17207 |
| Hash -> Hash Join (Outer) | 7df893ad | 17201 | 17195, 17196, 17197, 17198, 17202, 17203, 17204, 17207 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 17203 | 17195, 17196, 17197, 17198, 17201, 17202, 17204, 17207 |
...
| 17199 | Hash Join | 954.86 | 830.34 | 13.0% | operator |
| 17211 | Index Scan | 0.00 | -0.04 | 1512.7% | operator |
| 17200 | Seq Scan | 685.77 | 565.06 | 17.6% | operator |
| 17201 | Hash | 174.41 | 44.91 | 74.3% | pattern |
...
- **Consumes:** Nodes 17195, 17196, 17197, 17198, 17201, 17202, 17204, 17207
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=13360
  - HashJoin_nt1=13360
...
### Step 7: Node 17200 (Seq Scan) - LEAF
...
### Step 8: Node 17201 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 7df893ad (Hash -> Hash Join (Outer))
- **Consumes:** Nodes 17195, 17196, 17197, 17198, 17202, 17203, 17204, 17207
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17211 (Index Scan) - LEAF
...
### Step 11: Node 17195 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 0405d50f (Aggregate -> Gather -> Aggregate -> Nested Loop (Outer) (Outer) (Outer))
- **Consumes:** Nodes 17196, 17197, 17198, 17201, 17202, 17203, 17204, 17207
- **Input Features:**
