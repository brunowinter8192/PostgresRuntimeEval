...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | fd858367 | 30548 | 30549, 30550, 30551 |
...
| 30552 | Incremental Sort | 2879.32 | 2910.23 | 1.1% | operator |
...
| 30555 | Sort | 2828.89 | 1098.75 | 61.2% | operator |
| 30561 | Sort | 64.39 | 1014.60 | 1475.6% | operator |
| 30556 | Hash Join | 2828.88 | 773.67 | 72.7% | operator |
| 30562 | Seq Scan | 53.01 | 25.47 | 52.0% | operator |
| 30557 | Seq Scan | 196.60 | 187.11 | 4.8% | operator |
| 30558 | Hash | 2601.27 | 255.35 | 90.2% | operator |
...
### Step 3: Node 30557 (Seq Scan) - LEAF
...
### Step 6: Node 30562 (Seq Scan) - LEAF
...
### Step 10: Node 30563 (Index Scan) - LEAF
...
### Step 11: Node 30553 (Nested Loop)
...
### Step 12: Node 30552 (Incremental Sort)
...
### Step 13: Node 30548 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** fd858367 (Limit -> Sort -> Aggregate -> Gather Merge (Outer) (Outer) (Outer))
- **Consumes:** Nodes 30549, 30550, 30551
- **Input Features:**
