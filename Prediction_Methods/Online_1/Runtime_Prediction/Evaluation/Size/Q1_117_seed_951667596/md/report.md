...
Node 91 (Aggregate) - ROOT
  Node 92 (Gather Merge) [PATTERN: 52c5ec81]
...
|---------|------|-----------|----------------|
| Gather Merge -> Sort -> Aggreg | 52c5ec81 | 92 | 93, 94, 95 |
...
|------|------|--------|-----------|-----|--------|
| 91 | Aggregate | 944.72 | 1035.17 | 9.6% | operator |
| 92 | Gather Merge | 944.67 | 953.93 | 1.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 92 (Gather Merge) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 52c5ec81 (Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer))
- **Consumes:** Nodes 93, 94, 95
- **Input Features:**
