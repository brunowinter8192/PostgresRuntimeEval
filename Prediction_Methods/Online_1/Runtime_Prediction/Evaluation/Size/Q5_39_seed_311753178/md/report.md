          ...
          Node 8546 (Hash Join)
            Node 8547 (Nested Loop)
              Node 8548 (Hash Join)
                ...
                Node 8550 (Hash) [PATTERN: 7df893ad]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 8554 | 8541, 8542, 8550, 8551, 8555, 8556, 8557 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 8541 | 8542, 8550, 8551, 8554, 8555, 8556, 8557 |
| Hash -> Hash Join (Outer) | 7df893ad | 8550 | 8541, 8542, 8551, 8554, 8555, 8556, 8557 |
...
- **Consumes:** Nodes 8541, 8542, 8550, 8551, 8555, 8556, 8557
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
### Step 2: Node 8552 (Seq Scan) - LEAF
...
- **Consumes:** Nodes 8541, 8542, 8551, 8554, 8555, 8556, 8557
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 14: Node 8543 (Gather Merge)
...
### Step 15: Node 8541 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 8542, 8550, 8551, 8554, 8555, 8556, 8557
- **Input Features:**
