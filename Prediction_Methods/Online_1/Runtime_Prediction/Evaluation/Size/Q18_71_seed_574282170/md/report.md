...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | fd858367 | 30708 | 30709, 30710, 30711 |
...
| 30712 | Incremental Sort | 2921.84 | 2910.23 | 0.4% | operator |
...
| 30715 | Sort | 2851.72 | 1098.75 | 61.5% | operator |
| 30721 | Sort | 67.79 | 1014.60 | 1396.6% | operator |
| 30716 | Hash Join | 2851.71 | 773.67 | 72.9% | operator |
| 30722 | Seq Scan | 54.68 | 25.47 | 53.4% | operator |
| 30717 | Seq Scan | 198.33 | 187.11 | 5.7% | operator |
| 30718 | Hash | 2624.86 | 255.35 | 90.3% | operator |
...
### Step 3: Node 30717 (Seq Scan) - LEAF
...
### Step 6: Node 30722 (Seq Scan) - LEAF
...
### Step 10: Node 30723 (Index Scan) - LEAF
...
### Step 11: Node 30713 (Nested Loop)
...
### Step 12: Node 30712 (Incremental Sort)
...
### Step 13: Node 30708 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** fd858367 (Limit -> Sort -> Aggregate -> Gather Merge (Outer) (Outer) (Outer))
- **Consumes:** Nodes 30709, 30710, 30711
- **Input Features:**
