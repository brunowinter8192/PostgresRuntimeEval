...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | fd858367 | 29316 | 29317, 29318, 29319 |
...
| 29320 | Incremental Sort | 2888.07 | 2910.23 | 0.8% | operator |
...
| 29323 | Sort | 2837.18 | 1098.75 | 61.3% | operator |
| 29329 | Sort | 64.69 | 1014.60 | 1468.4% | operator |
| 29324 | Hash Join | 2837.16 | 773.67 | 72.7% | operator |
| 29330 | Seq Scan | 53.02 | 25.47 | 52.0% | operator |
| 29325 | Seq Scan | 184.69 | 187.11 | 1.3% | operator |
| 29326 | Hash | 2622.35 | 255.35 | 90.3% | operator |
...
### Step 3: Node 29325 (Seq Scan) - LEAF
...
### Step 6: Node 29330 (Seq Scan) - LEAF
...
### Step 10: Node 29331 (Index Scan) - LEAF
...
### Step 11: Node 29321 (Nested Loop)
...
### Step 12: Node 29320 (Incremental Sort)
...
### Step 13: Node 29316 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** fd858367 (Limit -> Sort -> Aggregate -> Gather Merge (Outer) (Outer) (Outer))
- **Consumes:** Nodes 29317, 29318, 29319
- **Input Features:**
