...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | fd858367 | 31108 | 31109, 31110, 31111 |
...
| 31112 | Incremental Sort | 2959.25 | 2910.23 | 1.7% | operator |
...
| 31115 | Sort | 2890.97 | 1098.75 | 62.0% | operator |
| 31121 | Sort | 65.24 | 1014.60 | 1455.3% | operator |
| 31116 | Hash Join | 2890.95 | 773.67 | 73.2% | operator |
| 31122 | Seq Scan | 53.13 | 25.47 | 52.1% | operator |
| 31117 | Seq Scan | 187.54 | 187.11 | 0.2% | operator |
| 31118 | Hash | 2675.15 | 255.35 | 90.5% | operator |
...
### Step 3: Node 31117 (Seq Scan) - LEAF
...
### Step 6: Node 31122 (Seq Scan) - LEAF
...
### Step 10: Node 31123 (Index Scan) - LEAF
...
### Step 11: Node 31113 (Nested Loop)
...
### Step 12: Node 31112 (Incremental Sort)
...
### Step 13: Node 31108 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** fd858367 (Limit -> Sort -> Aggregate -> Gather Merge (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31109, 31110, 31111
- **Input Features:**
