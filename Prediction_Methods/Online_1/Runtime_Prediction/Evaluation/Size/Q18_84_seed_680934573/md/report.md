...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | fd858367 | 30932 | 30933, 30934, 30935 |
...
| 30936 | Incremental Sort | 2898.90 | 2910.23 | 0.4% | operator |
...
| 30939 | Sort | 2848.05 | 1098.75 | 61.4% | operator |
| 30945 | Sort | 64.93 | 1014.60 | 1462.6% | operator |
| 30940 | Hash Join | 2848.04 | 773.67 | 72.8% | operator |
| 30946 | Seq Scan | 53.62 | 25.47 | 52.5% | operator |
| 30941 | Seq Scan | 194.44 | 187.11 | 3.8% | operator |
| 30942 | Hash | 2622.88 | 255.35 | 90.3% | operator |
...
### Step 3: Node 30941 (Seq Scan) - LEAF
...
### Step 6: Node 30946 (Seq Scan) - LEAF
...
### Step 10: Node 30947 (Index Scan) - LEAF
...
### Step 11: Node 30937 (Nested Loop)
...
### Step 12: Node 30936 (Incremental Sort)
...
### Step 13: Node 30932 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** fd858367 (Limit -> Sort -> Aggregate -> Gather Merge (Outer) (Outer) (Outer))
- **Consumes:** Nodes 30933, 30934, 30935
- **Input Features:**
