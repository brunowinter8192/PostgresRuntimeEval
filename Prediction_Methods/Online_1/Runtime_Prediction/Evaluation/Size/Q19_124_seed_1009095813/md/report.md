...
```
Node 31402 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 31402 | 31403, 31404, 31405, 31406, 31407 |
...
|------|------|--------|-----------|-----|--------|
| 31402 | Aggregate | 848.21 | 841.27 | 0.8% | pattern |
...
- **Consumes:** Nodes 31403, 31404, 31405, 31406, 31407
- **Input Features:**
