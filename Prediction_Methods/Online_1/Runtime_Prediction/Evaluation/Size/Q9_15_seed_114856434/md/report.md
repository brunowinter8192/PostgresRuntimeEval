...
Node 17665 (Sort) - ROOT
  Node 17666 (Aggregate) [PATTERN: 0405d50f]
      ...
      Node 17668 (Aggregate) [consumed]
        Node 17669 (Nested Loop) [consumed]
          Node 17670 (Hash Join)
            ...
            Node 17672 (Hash) [PATTERN: 7df893ad]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 0405d50f | 17666 | 17667, 17668, 17669, 17672, 17673, 17674, 17675, 17678 |
| Hash -> Hash Join (Outer) | 7df893ad | 17672 | 17666, 17667, 17668, 17669, 17673, 17674, 17675, 17678 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 17674 | 17666, 17667, 17668, 17669, 17672, 17673, 17675, 17678 |
...
|------|------|--------|-----------|-----|--------|
| 17665 | Sort | 1186.48 | 1159.89 | 2.2% | operator |
| 17666 | Aggregate | 1186.35 | 1194.84 | 0.7% | pattern |
| 17670 | Hash Join | 966.95 | 831.67 | 14.0% | operator |
| 17682 | Index Scan | 0.00 | -0.04 | 1512.7% | operator |
| 17671 | Seq Scan | 695.60 | 565.06 | 18.8% | operator |
| 17672 | Hash | 177.38 | 49.93 | 71.9% | pattern |
...
- **Consumes:** Nodes 17666, 17667, 17668, 17669, 17672, 17673, 17675, 17678
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=19372
  - HashJoin_nt1=19372
...
### Step 7: Node 17671 (Seq Scan) - LEAF
...
### Step 8: Node 17672 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 7df893ad (Hash -> Hash Join (Outer))
- **Consumes:** Nodes 17666, 17667, 17668, 17669, 17673, 17674, 17675, 17678
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17682 (Index Scan) - LEAF
...
### Step 11: Node 17666 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 0405d50f (Aggregate -> Gather -> Aggregate -> Nested Loop (Outer) (Outer) (Outer))
- **Consumes:** Nodes 17667, 17668, 17669, 17672, 17673, 17674, 17675, 17678
- **Input Features:**
