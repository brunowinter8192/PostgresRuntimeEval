...
| 6 | 8a78742e | 0.1344 | N/A | SKIPPED_LOW_ERROR | 17.92% |
| 7 | 4b856d44 | 12.8846 | 0.0000% | REJECTED | 17.92% |
| 8 | 56dc70e5 | 0.1353 | N/A | SKIPPED_LOW_ERROR | 17.92% |
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | fd858367 | 29300 | 29301, 29302, 29303 |
...
| 29304 | Incremental Sort | 2902.59 | 2910.23 | 0.3% | operator |
...
| 29307 | Sort | 2835.36 | 1098.75 | 61.2% | operator |
| 29313 | Sort | 64.45 | 1014.60 | 1474.1% | operator |
| 29308 | Hash Join | 2835.34 | 773.67 | 72.7% | operator |
| 29314 | Seq Scan | 52.74 | 25.47 | 51.7% | operator |
| 29309 | Seq Scan | 198.58 | 187.11 | 5.8% | operator |
| 29310 | Hash | 2606.25 | 255.35 | 90.2% | operator |
...
### Step 3: Node 29309 (Seq Scan) - LEAF
...
### Step 6: Node 29314 (Seq Scan) - LEAF
...
### Step 10: Node 29315 (Index Scan) - LEAF
...
### Step 11: Node 29305 (Nested Loop)
...
### Step 12: Node 29304 (Incremental Sort)
...
### Step 13: Node 29300 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** fd858367 (Limit -> Sort -> Aggregate -> Gather Merge (Outer) (Outer) (Outer))
- **Consumes:** Nodes 29301, 29302, 29303
- **Input Features:**
