...
Node 641 (Aggregate) - ROOT
  Node 642 (Gather Merge) [PATTERN: 52c5ec81]
...
|---------|------|-----------|----------------|
| Gather Merge -> Sort -> Aggreg | 52c5ec81 | 642 | 643, 644, 645 |
...
|------|------|--------|-----------|-----|--------|
| 641 | Aggregate | 955.18 | 1035.18 | 8.4% | operator |
| 642 | Gather Merge | 955.14 | 953.93 | 0.1% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 642 (Gather Merge) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 52c5ec81 (Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer))
- **Consumes:** Nodes 643, 644, 645
- **Input Features:**
  ...
  - GatherMerge_startup_cost=170199.3900
  - GatherMerge_total_cost=170203.0200
...
### Step 2: Node 641 (Aggregate) - ROOT
