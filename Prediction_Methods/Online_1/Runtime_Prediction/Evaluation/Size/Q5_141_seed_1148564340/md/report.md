          ...
          Node 7806 (Hash Join)
            Node 7807 (Nested Loop)
              Node 7808 (Hash Join)
                ...
                Node 7810 (Hash) [PATTERN: 7df893ad]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 7814 | 7801, 7802, 7810, 7811, 7815, 7816, 7817 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 7801 | 7802, 7810, 7811, 7814, 7815, 7816, 7817 |
| Hash -> Hash Join (Outer) | 7df893ad | 7810 | 7801, 7802, 7811, 7814, 7815, 7816, 7817 |
...
| 7806 | Hash Join | 1088.30 | 1106.63 | 1.7% | operator |
| 7807 | Nested Loop | 1077.30 | 1102.44 | 2.3% | operator |
| 7819 | Hash | 2.92 | 14.79 | 407.3% | operator |
| 7808 | Hash Join | 216.76 | 234.53 | 8.2% | operator |
| 7818 | Index Scan | 0.07 | -0.03 | 133.5% | operator |
| 7820 | Seq Scan | 2.30 | 10.62 | 361.6% | operator |
| 7809 | Seq Scan | 167.91 | 161.94 | 3.6% | operator |
| 7810 | Hash | 35.25 | 39.26 | 11.4% | pattern |
| 7812 | Seq Scan | 32.97 | 24.87 | 24.5% | operator |
| 7813 | Hash | 0.07 | 14.60 | 21065.0% | operator |
...
- **Consumes:** Nodes 7801, 7802, 7810, 7811, 7815, 7816, 7817
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
### Step 2: Node 7812 (Seq Scan) - LEAF
...
- **Consumes:** Nodes 7801, 7802, 7811, 7814, 7815, 7816, 7817
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 14: Node 7803 (Gather Merge)
...
### Step 15: Node 7801 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 7802, 7810, 7811, 7814, 7815, 7816, 7817
- **Input Features:**
