...
**Test Query:** Q10_109_seed_886035348
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 19487 | 19488, 19489, 19490, 19491, 19492, 19493, 19496 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 19492 | 19487, 19488, 19489, 19490, 19491, 19493, 19496 |
...
|------|------|--------|-----------|-----|--------|
| 19487 | Limit | 1147.10 | 1151.16 | 0.4% | pattern |
| 19492 | Hash Join | 1094.78 | 1101.72 | 0.6% | pattern |
| 19498 | Hash | 0.02 | 14.54 | 80676.2% | operator |
| 19499 | Seq Scan | 0.01 | 7.19 | 51289.1% | operator |
| 19494 | Seq Scan | 163.74 | 162.03 | 1.0% | operator |
| 19495 | Index Scan | 0.06 | -0.02 | 130.0% | operator |
| 19497 | Seq Scan | 27.80 | 29.69 | 6.8% | operator |
...
### Step 5: Node 19492 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 19487, 19488, 19489, 19490, 19491, 19493, 19496
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18130
  - HashJoin_nt1=18130
  ...
  - HashJoin_total_cost=80755.6700
  - Hash_Inner_np=0
  - Hash_Inner_nt=62500
  ...
  - NestedLoop_Outer_nt=18130
  - NestedLoop_Outer_nt1=18317
  ...
  - NestedLoop_Outer_total_cost=75701.8300
- **Output:** st=37.52, rt=1101.72

### Step 6: Node 19498 (Hash)
...
### Step 7: Node 19487 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19488, 19489, 19490, 19491, 19492, 19493, 19496
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=18130
  - HashJoin_Outer_nt1=18130
  ...
  - HashJoin_Outer_total_cost=80812.8900
  - Limit_np=0
  - Limit_nt=20
  - Limit_nt1=56202
  - Limit_nt2=0
