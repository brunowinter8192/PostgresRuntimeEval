...
```
Node 19487 (Limit) [PATTERN: 25df29b5] - ROOT
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19487 | 19488, 19489, 19490, 19492, 19493, 19496 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 19492 | 19487, 19488, 19489, 19490, 19493, 19496 |
...
|------|------|--------|-----------|-----|--------|
| 19487 | Limit | 1147.10 | 1154.78 | 0.7% | pattern |
| 19491 | Hash Join | 1097.74 | 1087.31 | 0.9% | operator |
...
- **Consumes:** Nodes 19487, 19488, 19489, 19490, 19493, 19496
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18130
  - HashJoin_nt1=18130
...
- **Output:** st=39.29, rt=1087.31

### Step 8: Node 19487 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19488, 19489, 19490, 19492, 19493, 19496
- **Input Features:**
