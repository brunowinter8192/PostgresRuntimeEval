...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | fd858367 | 29108 | 29109, 29110, 29111 |
...
| 29112 | Incremental Sort | 2867.76 | 2910.23 | 1.5% | operator |
...
| 29115 | Sort | 2835.15 | 1098.75 | 61.2% | operator |
| 29121 | Sort | 62.42 | 1014.60 | 1525.3% | operator |
| 29116 | Hash Join | 2835.14 | 773.67 | 72.7% | operator |
| 29122 | Seq Scan | 51.26 | 25.47 | 50.3% | operator |
| 29117 | Seq Scan | 198.03 | 187.11 | 5.5% | operator |
| 29118 | Hash | 2608.80 | 255.35 | 90.2% | operator |
...
### Step 3: Node 29117 (Seq Scan) - LEAF
...
### Step 6: Node 29122 (Seq Scan) - LEAF
...
### Step 10: Node 29123 (Index Scan) - LEAF
...
### Step 11: Node 29113 (Nested Loop)
...
### Step 12: Node 29112 (Incremental Sort)
...
### Step 13: Node 29108 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** fd858367 (Limit -> Sort -> Aggregate -> Gather Merge (Outer) (Outer) (Outer))
- **Consumes:** Nodes 29109, 29110, 29111
- **Input Features:**
