...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 21086 | 21087, 21088, 21089, 21090, 21091, 21092, 21095 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 21091 | 21086, 21087, 21088, 21089, 21090, 21092, 21095 |
...
|------|------|--------|-----------|-----|--------|
| 21086 | Limit | 1172.87 | 1151.17 | 1.8% | pattern |
| 21091 | Hash Join | 1117.72 | 1101.80 | 1.4% | pattern |
...
### Step 4: Node 21098 (Seq Scan) - LEAF
...
- **Consumes:** Nodes 21086, 21087, 21088, 21089, 21090, 21092, 21095
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18384
  - HashJoin_nt1=18384
...
### Step 7: Node 21086 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 21087, 21088, 21089, 21090, 21091, 21092, 21095
- **Input Features:**
