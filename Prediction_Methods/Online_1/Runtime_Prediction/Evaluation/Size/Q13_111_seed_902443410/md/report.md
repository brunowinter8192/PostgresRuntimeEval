...
```
Node 25454 (Sort) [PATTERN: f592ee11] - ROOT
  Node 25455 (Aggregate) [consumed]
    Node 25456 (Aggregate) [consumed]
      Node 25457 (Hash Join) [consumed]
        Node 25458 (Seq Scan) [consumed] - LEAF
        Node 25459 (Hash) [consumed]
          Node 25460 (Index Only Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Aggregate | f592ee11 | 25454 | 25455, 25456, 25457, 25458, 25459, 25460 |
