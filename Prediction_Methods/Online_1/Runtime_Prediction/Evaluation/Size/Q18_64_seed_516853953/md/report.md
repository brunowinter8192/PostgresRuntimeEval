  ...
  Node 30581 (Sort) [consumed]
    Node 30582 (Aggregate) [consumed]
      Node 30583 (Gather Merge) [consumed]
        Node 30584 (Incremental Sort)
          Node 30585 (Nested Loop)
            Node 30586 (Merge Join)
              Node 30587 (Sort)
                Node 30588 (Hash Join)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | fd858367 | 30580 | 30581, 30582, 30583 |
...
| 30584 | Incremental Sort | 2902.00 | 2910.23 | 0.3% | operator |
...
| 30587 | Sort | 2834.54 | 1098.75 | 61.2% | operator |
| 30593 | Sort | 64.45 | 1014.60 | 1474.1% | operator |
| 30588 | Hash Join | 2834.53 | 773.67 | 72.7% | operator |
| 30594 | Seq Scan | 52.75 | 25.47 | 51.7% | operator |
| 30589 | Seq Scan | 192.81 | 187.11 | 3.0% | operator |
| 30590 | Hash | 2612.97 | 255.35 | 90.2% | operator |
...
### Step 3: Node 30589 (Seq Scan) - LEAF
...
### Step 6: Node 30594 (Seq Scan) - LEAF
...
### Step 10: Node 30595 (Index Scan) - LEAF
...
### Step 11: Node 30585 (Nested Loop)
...
### Step 12: Node 30584 (Incremental Sort)
...
### Step 13: Node 30580 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** fd858367 (Limit -> Sort -> Aggregate -> Gather Merge (Outer) (Outer) (Outer))
- **Consumes:** Nodes 30581, 30582, 30583
- **Input Features:**
