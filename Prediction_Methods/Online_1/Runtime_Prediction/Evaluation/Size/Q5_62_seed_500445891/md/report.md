...
```
Node 9061 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 9062 (Aggregate) [consumed]
    Node 9063 (Gather Merge)
      Node 9064 (Aggregate)
        Node 9065 (Sort)
          Node 9066 (Hash Join) [PATTERN: 2e0f44ef]
            Node 9067 (Nested Loop) [consumed]
              Node 9068 (Hash Join) [PATTERN: 895c6e8c]
                Node 9069 (Seq Scan) [consumed] - LEAF
                Node 9070 (Hash) [consumed]
                  Node 9071 (Hash Join) [PATTERN: 895c6e8c]
                    Node 9072 (Seq Scan) [consumed] - LEAF
                    Node 9073 (Hash) [consumed]
                      Node 9074 (Hash Join) [PATTERN: f4cb205a]
                        Node 9075 (Seq Scan) [consumed] - LEAF
                        Node 9076 (Hash) [consumed]
                          Node 9077 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 9074 | 9061, 9062, 9066, 9067, 9068, 9069, 9070, 9071, 9072, 9073, 9075, 9076, 9077, 9079 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 9068 | 9061, 9062, 9066, 9067, 9069, 9070, 9071, 9072, 9073, 9074, 9075, 9076, 9077, 9079 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 9071 | 9061, 9062, 9066, 9067, 9068, 9069, 9070, 9072, 9073, 9074, 9075, 9076, 9077, 9079 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 9061 | 9062, 9066, 9067, 9068, 9069, 9070, 9071, 9072, 9073, 9074, 9075, 9076, 9077, 9079 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 9066 | 9061, 9062, 9067, 9068, 9069, 9070, 9071, 9072, 9073, 9074, 9075, 9076, 9077, 9079 |
...
|------|------|--------|-----------|-----|--------|
| 9061 | Sort | 1061.84 | 1080.14 | 1.7% | pattern |
| 9063 | Gather Merge | 1061.83 | 1124.36 | 5.9% | operator |
| 9064 | Aggregate | 1057.49 | 1019.70 | 3.6% | operator |
| 9065 | Sort | 1057.24 | 1073.11 | 1.5% | operator |
| 9066 | Hash Join | 1056.77 | 1080.38 | 2.2% | pattern |
| 9068 | Hash Join | 221.76 | 259.82 | 17.2% | pattern |
| 9078 | Index Scan | 0.07 | -0.03 | 134.9% | operator |
| 9080 | Seq Scan | 3.27 | 10.62 | 224.8% | operator |
| 9071 | Hash Join | 41.96 | 84.97 | 102.5% | pattern |
| 9074 | Hash Join | 0.14 | 11.62 | 8441.1% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 9074 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 9061, 9062, 9066, 9067, 9068, 9069, 9070, 9071, 9072, 9073, 9075, 9076, 9077, 9079
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
### Step 2: Node 9071 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 9061, 9062, 9066, 9067, 9068, 9069, 9070, 9072, 9073, 9074, 9075, 9076, 9077, 9079
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=12500
  - HashJoin_nt1=62500
...
### Step 3: Node 9068 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 9061, 9062, 9066, 9067, 9069, 9070, 9071, 9072, 9073, 9074, 9075, 9076, 9077, 9079
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14756
  - HashJoin_nt1=73782
...
### Step 4: Node 9078 (Index Scan) - LEAF
...
### Step 5: Node 9080 (Seq Scan) - LEAF
...
### Step 6: Node 9066 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 9061, 9062, 9067, 9068, 9069, 9070, 9071, 9072, 9073, 9074, 9075, 9076, 9077, 9079
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=2362
  - HashJoin_nt1=59037
...
### Step 10: Node 9061 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 9062, 9066, 9067, 9068, 9069, 9070, 9071, 9072, 9073, 9074, 9075, 9076, 9077, 9079
- **Input Features:**
