          ...
          Node 9066 (Hash Join)
            Node 9067 (Nested Loop)
              Node 9068 (Hash Join)
                ...
                Node 9070 (Hash) [PATTERN: 7df893ad]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 9074 | 9061, 9062, 9070, 9071, 9075, 9076, 9077 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 9061 | 9062, 9070, 9071, 9074, 9075, 9076, 9077 |
| Hash -> Hash Join (Outer) | 7df893ad | 9070 | 9061, 9062, 9071, 9074, 9075, 9076, 9077 |
...
- **Consumes:** Nodes 9061, 9062, 9070, 9071, 9075, 9076, 9077
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
### Step 2: Node 9072 (Seq Scan) - LEAF
...
### Step 4: Node 9069 (Seq Scan) - LEAF
...
### Step 5: Node 9070 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 7df893ad (Hash -> Hash Join (Outer))
- **Consumes:** Nodes 9061, 9062, 9071, 9074, 9075, 9076, 9077
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 7: Node 9078 (Index Scan) - LEAF
...
### Step 8: Node 9080 (Seq Scan) - LEAF
...
### Step 14: Node 9063 (Gather Merge)
...
### Step 15: Node 9061 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 9062, 9070, 9071, 9074, 9075, 9076, 9077
- **Input Features:**
