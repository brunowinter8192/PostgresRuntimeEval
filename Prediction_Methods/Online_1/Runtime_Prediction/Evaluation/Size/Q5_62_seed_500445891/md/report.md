...
Node 9061 (Sort) - ROOT
  Node 9062 (Aggregate)
    Node 9063 (Gather Merge)
      Node 9064 (Aggregate)
        Node 9065 (Sort)
          Node 9066 (Hash Join)
            Node 9067 (Nested Loop)
              Node 9068 (Hash Join)
                Node 9069 (Seq Scan) - LEAF
                Node 9070 (Hash)
                  Node 9071 (Hash Join)
                    Node 9072 (Seq Scan) - LEAF
                    Node 9073 (Hash)
                      Node 9074 (Hash Join)
                        Node 9075 (Seq Scan) - LEAF
                        Node 9076 (Hash)
                          Node 9077 (Seq Scan) - LEAF
              Node 9078 (Index Scan) - LEAF
            Node 9079 (Hash)
              Node 9080 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 9061 | Sort | 1061.84 | 1104.24 | 4.0% | operator |
| 9062 | Aggregate | 1061.83 | 1057.92 | 0.4% | operator |
| 9063 | Gather Merge | 1061.83 | 1124.37 | 5.9% | operator |
| 9064 | Aggregate | 1057.49 | 1019.95 | 3.5% | operator |
| 9065 | Sort | 1057.24 | 1074.64 | 1.6% | operator |
| 9066 | Hash Join | 1056.77 | 1106.89 | 4.7% | operator |
| 9067 | Nested Loop | 1044.97 | 1102.57 | 5.5% | operator |
| 9079 | Hash | 3.83 | 14.79 | 285.7% | operator |
| 9068 | Hash Join | 221.76 | 234.18 | 5.6% | operator |
| 9078 | Index Scan | 0.07 | -0.03 | 134.9% | operator |
| 9080 | Seq Scan | 3.27 | 10.62 | 224.8% | operator |
| 9069 | Seq Scan | 166.65 | 161.95 | 2.8% | operator |
| 9070 | Hash | 42.78 | 21.31 | 50.2% | operator |
| 9071 | Hash Join | 41.96 | 62.87 | 49.8% | operator |
| 9072 | Seq Scan | 40.48 | 24.87 | 38.6% | operator |
| 9073 | Hash | 0.14 | 16.80 | 11983.8% | operator |
| 9074 | Hash Join | 0.14 | 142.84 | 104932.3% | operator |
...
### Step 5: Node 9072 (Seq Scan) - LEAF
...
### Step 8: Node 9069 (Seq Scan) - LEAF
...
### Step 11: Node 9078 (Index Scan) - LEAF
...
### Step 12: Node 9080 (Seq Scan) - LEAF
...
### Step 18: Node 9063 (Gather Merge)
