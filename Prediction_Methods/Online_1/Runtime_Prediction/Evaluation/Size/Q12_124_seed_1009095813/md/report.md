...
|---------|------|-----------|----------------|
| Aggregate -> Gather Merge (Out | 2724c080 | 24502 | 24503, 24506, 24507, 24508 |
| Nested Loop -> [Seq Scan (Oute | c53c4396 | 24506 | 24502, 24503, 24507, 24508 |
...
|------|------|--------|-----------|-----|--------|
| 24502 | Aggregate | 987.38 | 1027.05 | 4.0% | pattern |
| 24504 | Aggregate | 967.66 | 940.64 | 2.8% | operator |
| 24505 | Sort | 967.04 | 1050.79 | 8.7% | operator |
| 24506 | Nested Loop | 966.13 | 975.98 | 1.0% | pattern |
...
- **Consumes:** Nodes 24502, 24503, 24507, 24508
- **Input Features:**
...
### Step 4: Node 24502 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 24503, 24506, 24507, 24508
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=7
  - Aggregate_nt1=35
  ...
  - Aggregate_total_cost=148618.2100
  ...
  - GatherMerge_Outer_total_cost=148617.8800
