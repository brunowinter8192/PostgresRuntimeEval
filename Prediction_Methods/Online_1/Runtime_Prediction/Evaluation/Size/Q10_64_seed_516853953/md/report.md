...
```
Node 20800 (Limit) [PATTERN: 04a01b61] - ROOT
  Node 20801 (Sort) [consumed]
    Node 20802 (Aggregate) [consumed]
      Node 20803 (Gather) [consumed]
        Node 20804 (Hash Join) [consumed]
          Node 20805 (Hash Join) [PATTERN: 2e0f44ef]
            Node 20806 (Nested Loop) [consumed]
              Node 20807 (Seq Scan) - LEAF
              Node 20808 (Index Scan) - LEAF
            Node 20809 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 20800 | 20801, 20802, 20803, 20804, 20805, 20806, 20809 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 20805 | 20800, 20801, 20802, 20803, 20804, 20806, 20809 |
...
|------|------|--------|-----------|-----|--------|
| 20800 | Limit | 1166.99 | 1151.15 | 1.4% | pattern |
| 20805 | Hash Join | 1114.88 | 1101.69 | 1.2% | pattern |
...
### Step 4: Node 20812 (Seq Scan) - LEAF
...
### Step 5: Node 20805 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 20800, 20801, 20802, 20803, 20804, 20806, 20809
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18015
  - HashJoin_nt1=18015
...
- **Output:** st=37.51, rt=1101.69

### Step 6: Node 20811 (Hash)
...
### Step 7: Node 20800 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20801, 20802, 20803, 20804, 20805, 20806, 20809
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=18015
  - HashJoin_Outer_nt1=18015
  ...
  - HashJoin_Outer_total_cost=80704.0100
  - Limit_np=0
  - Limit_nt=20
  - Limit_nt1=55845
  - Limit_nt2=0
