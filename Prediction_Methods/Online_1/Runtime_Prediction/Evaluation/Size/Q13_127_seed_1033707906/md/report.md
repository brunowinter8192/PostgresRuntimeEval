...
```
Node 25573 (Sort) [PATTERN: f592ee11] - ROOT
  Node 25574 (Aggregate) [consumed]
    Node 25575 (Aggregate) [consumed]
      Node 25576 (Hash Join) [consumed]
        Node 25577 (Seq Scan) [consumed] - LEAF
        Node 25578 (Hash) [consumed]
          Node 25579 (Index Only Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Aggregate | f592ee11 | 25573 | 25574, 25575, 25576, 25577, 25578, 25579 |
