...
Node 656 (Aggregate) - ROOT
  Node 657 (Gather Merge) [PATTERN: 52c5ec81]
...
|---------|------|-----------|----------------|
| Gather Merge -> Sort -> Aggreg | 52c5ec81 | 657 | 658, 659, 660 |
...
|------|------|--------|-----------|-----|--------|
| 656 | Aggregate | 995.76 | 1035.17 | 4.0% | operator |
| 657 | Gather Merge | 995.72 | 953.93 | 4.2% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 657 (Gather Merge) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 52c5ec81 (Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer))
- **Consumes:** Nodes 658, 659, 660
- **Input Features:**
...
### Step 2: Node 656 (Aggregate) - ROOT
