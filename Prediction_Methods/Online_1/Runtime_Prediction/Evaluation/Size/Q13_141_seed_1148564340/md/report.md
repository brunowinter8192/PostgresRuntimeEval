...
```
Node 25685 (Sort) [PATTERN: f592ee11] - ROOT
  Node 25686 (Aggregate) [consumed]
    Node 25687 (Aggregate) [consumed]
      Node 25688 (Hash Join) [consumed]
        Node 25689 (Seq Scan) [consumed] - LEAF
        Node 25690 (Hash) [consumed]
          Node 25691 (Index Only Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Aggregate | f592ee11 | 25685 | 25686, 25687, 25688, 25689, 25690, 25691 |
