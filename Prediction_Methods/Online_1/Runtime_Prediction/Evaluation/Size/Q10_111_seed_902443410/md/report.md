...
**Test Query:** Q10_111_seed_902443410
...
```
Node 19526 (Limit) [PATTERN: 04a01b61] - ROOT
  Node 19527 (Sort) [consumed]
    Node 19528 (Aggregate) [consumed]
      Node 19529 (Gather) [consumed]
        Node 19530 (Hash Join) [consumed]
          Node 19531 (Hash Join) [PATTERN: 2e0f44ef]
            Node 19532 (Nested Loop) [consumed]
              Node 19533 (Seq Scan) - LEAF
              Node 19534 (Index Scan) - LEAF
            Node 19535 (Hash) [consumed]
              Node 19536 (Seq Scan) - LEAF
          Node 19537 (Hash)
            Node 19538 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 19526 | 19527, 19528, 19529, 19530, 19531, 19532, 19535 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 19531 | 19526, 19527, 19528, 19529, 19530, 19532, 19535 |
...
|------|------|--------|-----------|-----|--------|
| 19526 | Limit | 1156.23 | 1151.19 | 0.4% | pattern |
| 19531 | Hash Join | 1098.96 | 1101.91 | 0.3% | pattern |
| 19537 | Hash | 0.01 | 14.54 | 111744.0% | operator |
| 19538 | Seq Scan | 0.01 | 7.19 | 79838.6% | operator |
| 19533 | Seq Scan | 160.23 | 162.02 | 1.1% | operator |
| 19534 | Index Scan | 0.06 | -0.02 | 129.5% | operator |
| 19536 | Seq Scan | 27.14 | 29.69 | 9.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 19533 (Seq Scan) - LEAF
...
### Step 2: Node 19534 (Index Scan) - LEAF
...
### Step 3: Node 19536 (Seq Scan) - LEAF
...
### Step 4: Node 19538 (Seq Scan) - LEAF
...
### Step 5: Node 19531 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 19526, 19527, 19528, 19529, 19530, 19532, 19535
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18756
  - HashJoin_nt1=18756
...
### Step 7: Node 19526 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19527, 19528, 19529, 19530, 19531, 19532, 19535
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=18756
  - HashJoin_Outer_nt1=18756
  ...
  - HashJoin_Outer_total_cost=81408.5000
  - Limit_np=0
  - Limit_nt=20
  - Limit_nt1=58143
  - Limit_nt2=0
