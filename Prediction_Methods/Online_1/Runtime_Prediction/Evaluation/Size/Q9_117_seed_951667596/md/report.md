...
Node 16978 (Sort) - ROOT
  Node 16979 (Aggregate) [PATTERN: 0405d50f]
      ...
      Node 16981 (Aggregate) [consumed]
        Node 16982 (Nested Loop) [consumed]
          Node 16983 (Hash Join)
            ...
            Node 16985 (Hash) [PATTERN: 7df893ad]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 0405d50f | 16979 | 16980, 16981, 16982, 16985, 16986, 16987, 16988, 16991 |
| Hash -> Hash Join (Outer) | 7df893ad | 16985 | 16979, 16980, 16981, 16982, 16986, 16987, 16988, 16991 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 16987 | 16979, 16980, 16981, 16982, 16985, 16986, 16988, 16991 |
...
|------|------|--------|-----------|-----|--------|
| 16978 | Sort | 1172.38 | 1159.31 | 1.1% | operator |
| 16979 | Aggregate | 1172.23 | 1194.84 | 1.9% | pattern |
| 16983 | Hash Join | 951.17 | 831.42 | 12.6% | operator |
| 16995 | Index Scan | 0.00 | -0.04 | 1512.7% | operator |
| 16984 | Seq Scan | 669.56 | 565.06 | 15.6% | operator |
| 16985 | Hash | 186.38 | 48.85 | 73.8% | pattern |
...
- **Consumes:** Nodes 16979, 16980, 16981, 16982, 16985, 16986, 16988, 16991
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18037
  - HashJoin_nt1=18037
...
### Step 7: Node 16984 (Seq Scan) - LEAF
...
### Step 8: Node 16985 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 7df893ad (Hash -> Hash Join (Outer))
- **Consumes:** Nodes 16979, 16980, 16981, 16982, 16986, 16987, 16988, 16991
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 16995 (Index Scan) - LEAF
...
### Step 11: Node 16979 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 0405d50f (Aggregate -> Gather -> Aggregate -> Nested Loop (Outer) (Outer) (Outer))
- **Consumes:** Nodes 16980, 16981, 16982, 16985, 16986, 16987, 16988, 16991
- **Input Features:**
