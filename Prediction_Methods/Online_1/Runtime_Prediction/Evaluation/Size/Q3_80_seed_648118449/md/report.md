    ...
    Node 5633 (Aggregate) [consumed]
      Node 5634 (Gather) [consumed]
        Node 5635 (Nested Loop)
          Node 5636 (Hash Join) [PATTERN: f4cb205a]
            Node 5637 (Seq Scan) [consumed] - LEAF
            Node 5638 (Hash) [consumed]
              Node 5639 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5631 | 5632, 5633, 5634, 5636, 5637, 5638, 5639 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 5636 | 5631, 5632, 5633, 5634, 5637, 5638, 5639 |
...
| 5635 | Nested Loop | 1154.86 | 1121.47 | 2.9% | operator |
| 5636 | Hash Join | 210.24 | 219.20 | 4.3% | pattern |
| 5640 | Index Scan | 0.03 | -0.02 | 171.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5636 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 5631, 5632, 5633, 5634, 5637, 5638, 5639
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46659
  - HashJoin_nt1=235242
...
- **Output:** st=30.38, rt=219.20

### Step 2: Node 5640 (Index Scan) - LEAF
...
- **Output:** st=29.88, rt=1121.47

### Step 4: Node 5631 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5632, 5633, 5634, 5636, 5637, 5638, 5639
- **Input Features:**
