...
```
Node 10481 (Aggregate) [PATTERN: dd3706ac] - ROOT
  Node 10482 (Gather) [consumed]
    Node 10483 (Aggregate) [consumed]
      Node 10484 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | dd3706ac | 10481 | 10482, 10483, 10484 |
...
|------|------|--------|-----------|-----|--------|
| 10481 | Aggregate | 800.96 | 791.26 | 1.2% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10481 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** dd3706ac (Aggregate -> Gather -> Aggregate -> Seq Scan (Outer) (Outer) (Outer))
- **Consumes:** Nodes 10482, 10483, 10484
- **Input Features:**
