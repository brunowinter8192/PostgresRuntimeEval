    ...
    Node 4993 (Aggregate) [consumed]
      Node 4994 (Gather) [consumed]
        Node 4995 (Nested Loop)
          Node 4996 (Hash Join) [PATTERN: 895c6e8c]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4991 | 4992, 4993, 4994, 4996, 4997, 4998 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4996 | 4991, 4992, 4993, 4994, 4997, 4998 |
...
| 4995 | Nested Loop | 1182.42 | 1122.31 | 5.1% | operator |
| 4996 | Hash Join | 210.34 | 256.36 | 21.9% | pattern |
...
### Step 2: Node 4996 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4991, 4992, 4993, 4994, 4997, 4998
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46921
  - HashJoin_nt1=235005
...
### Step 3: Node 5000 (Index Scan) - LEAF
...
- **Output:** st=30.91, rt=1122.31

### Step 5: Node 4991 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4992, 4993, 4994, 4996, 4997, 4998
- **Input Features:**
