...
```
Node 10205 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 10206 (Gather) [consumed]
    Node 10207 (Aggregate) [consumed]
      Node 10208 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 10205 | 10206, 10207 |
...
|------|------|--------|-----------|-----|--------|
| 10205 | Aggregate | 789.63 | 830.13 | 5.1% | pattern |
| 10208 | Seq Scan | 768.93 | 750.63 | 2.4% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10208 (Seq Scan) - LEAF
...
### Step 2: Node 10205 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 10206, 10207
- **Input Features:**
