...
Node 131 (Aggregate) - ROOT
  Node 132 (Gather Merge) [PATTERN: 52c5ec81]
...
|---------|------|-----------|----------------|
| Gather Merge -> Sort -> Aggreg | 52c5ec81 | 132 | 133, 134, 135 |
...
|------|------|--------|-----------|-----|--------|
| 131 | Aggregate | 958.54 | 1035.18 | 8.0% | operator |
| 132 | Gather Merge | 958.46 | 953.93 | 0.5% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 132 (Gather Merge) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 52c5ec81 (Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer))
- **Consumes:** Nodes 133, 134, 135
- **Input Features:**
  ...
  - GatherMerge_startup_cost=170176.5000
  - GatherMerge_total_cost=170180.1300
...
### Step 2: Node 131 (Aggregate) - ROOT
