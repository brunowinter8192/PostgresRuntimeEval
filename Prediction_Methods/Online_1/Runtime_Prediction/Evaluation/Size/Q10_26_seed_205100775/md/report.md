...
**Test Query:** Q10_26_seed_205100775
...
```
Node 20254 (Limit) [PATTERN: 04a01b61] - ROOT
  Node 20255 (Sort) [consumed]
    Node 20256 (Aggregate) [consumed]
      Node 20257 (Gather) [consumed]
        Node 20258 (Hash Join) [consumed]
          Node 20259 (Hash Join) [PATTERN: 2e0f44ef]
            Node 20260 (Nested Loop) [consumed]
              Node 20261 (Seq Scan) - LEAF
              Node 20262 (Index Scan) - LEAF
            Node 20263 (Hash) [consumed]
              Node 20264 (Seq Scan) - LEAF
          Node 20265 (Hash)
            Node 20266 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 20254 | 20255, 20256, 20257, 20258, 20259, 20260, 20263 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 20259 | 20254, 20255, 20256, 20257, 20258, 20260, 20263 |
...
|------|------|--------|-----------|-----|--------|
| 20254 | Limit | 1143.38 | 1151.16 | 0.7% | pattern |
| 20259 | Hash Join | 1094.87 | 1101.75 | 0.6% | pattern |
| 20265 | Hash | 0.01 | 14.54 | 96831.4% | operator |
| 20266 | Seq Scan | 0.01 | 7.19 | 59854.0% | operator |
| 20261 | Seq Scan | 160.96 | 162.03 | 0.7% | operator |
| 20262 | Index Scan | 0.06 | -0.02 | 129.0% | operator |
| 20264 | Seq Scan | 27.33 | 29.69 | 8.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 20261 (Seq Scan) - LEAF
...
### Step 2: Node 20262 (Index Scan) - LEAF
...
### Step 3: Node 20264 (Seq Scan) - LEAF
...
### Step 4: Node 20266 (Seq Scan) - LEAF
...
### Step 5: Node 20259 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 20254, 20255, 20256, 20257, 20258, 20260, 20263
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18231
  - HashJoin_nt1=18231
  ...
  - NestedLoop_Outer_nt=18231
  - NestedLoop_Outer_nt1=18419
...
### Step 7: Node 20254 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20255, 20256, 20257, 20258, 20259, 20260, 20263
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=18231
  - HashJoin_Outer_nt1=18231
  ...
  - HashJoin_Outer_total_cost=80909.0400
  - Limit_np=0
  - Limit_nt=20
  - Limit_nt1=56515
  - Limit_nt2=0
