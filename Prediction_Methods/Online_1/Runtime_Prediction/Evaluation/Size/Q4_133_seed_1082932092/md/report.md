...
```
Node 6103 (Aggregate) [PATTERN: 2724c080] - ROOT
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 6105 | 6103, 6104, 6106 |
| Aggregate -> Gather Merge (Out | 2724c080 | 6103 | 6104, 6105, 6106 |
...
|------|------|--------|-----------|-----|--------|
| 6103 | Aggregate | 1037.06 | 1078.88 | 4.0% | pattern |
...
### Step 5: Node 6103 (Aggregate) - PATTERN ROOT
