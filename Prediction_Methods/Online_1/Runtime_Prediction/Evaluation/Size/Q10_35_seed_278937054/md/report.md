...
**Test Query:** Q10_35_seed_278937054
**Timestamp:** 2026-01-11 16:20:43
...
```
Node 20384 (Limit) [PATTERN: 04a01b61] - ROOT
  Node 20385 (Sort) [consumed]
    Node 20386 (Aggregate) [consumed]
      Node 20387 (Gather) [consumed]
        Node 20388 (Hash Join) [consumed]
          Node 20389 (Hash Join) [PATTERN: 2e0f44ef]
            Node 20390 (Nested Loop) [consumed]
              Node 20391 (Seq Scan) - LEAF
              Node 20392 (Index Scan) - LEAF
            Node 20393 (Hash) [consumed]
              Node 20394 (Seq Scan) - LEAF
          Node 20395 (Hash)
            Node 20396 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 20384 | 20385, 20386, 20387, 20388, 20389, 20390, 20393 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 20389 | 20384, 20385, 20386, 20387, 20388, 20390, 20393 |
...
|------|------|--------|-----------|-----|--------|
| 20384 | Limit | 1168.32 | 1151.16 | 1.5% | pattern |
| 20389 | Hash Join | 1112.48 | 1101.72 | 1.0% | pattern |
| 20395 | Hash | 0.02 | 14.54 | 72598.6% | operator |
| 20396 | Seq Scan | 0.01 | 7.19 | 47863.2% | operator |
| 20391 | Seq Scan | 164.62 | 162.03 | 1.6% | operator |
| 20392 | Index Scan | 0.06 | -0.02 | 129.5% | operator |
| 20394 | Seq Scan | 26.59 | 29.69 | 11.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 20391 (Seq Scan) - LEAF
...
### Step 2: Node 20392 (Index Scan) - LEAF
...
### Step 3: Node 20394 (Seq Scan) - LEAF
...
### Step 4: Node 20396 (Seq Scan) - LEAF
...
### Step 5: Node 20389 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 20384, 20385, 20386, 20387, 20388, 20390, 20393
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18130
  - HashJoin_nt1=18130
...
### Step 7: Node 20384 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20385, 20386, 20387, 20388, 20389, 20390, 20393
- **Input Features:**
