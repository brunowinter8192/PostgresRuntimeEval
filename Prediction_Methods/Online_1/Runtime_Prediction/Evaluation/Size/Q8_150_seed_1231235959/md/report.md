...
Node 14466 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 14467 (Gather Merge) [consumed]
    Node 14468 (Sort)
      Node 14469 (Hash Join)
        Node 14470 (Nested Loop)
          Node 14471 (Hash Join)
            Node 14472 (Nested Loop)
              Node 14473 (Hash Join)
                Node 14474 (Seq Scan) - LEAF
                Node 14475 (Hash) [PATTERN: 444761fb]
                  Node 14476 (Hash Join) [consumed]
                    Node 14477 (Seq Scan) [consumed] - LEAF
                    Node 14478 (Hash) [consumed]
                      Node 14479 (Hash Join) [consumed]
                        Node 14480 (Seq Scan) - LEAF
                        Node 14481 (Hash)
                          Node 14482 (Seq Scan) - LEAF
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 14475 | 14466, 14467, 14476, 14477, 14478, 14479 |
| Aggregate -> Gather Merge (Out | 2724c080 | 14466 | 14467, 14475, 14476, 14477, 14478, 14479 |
...
| 14468 | Sort | 1204.48 | 1087.88 | 9.7% | operator |
| 14469 | Hash Join | 1204.23 | 1055.47 | 12.4% | operator |
| 14470 | Nested Loop | 1203.91 | 1105.65 | 8.2% | operator |
| 14487 | Hash | 0.01 | 14.54 | 103755.1% | operator |
| 14471 | Hash Join | 1200.04 | 1027.32 | 14.4% | operator |
| 14486 | Index Scan | 0.01 | 0.05 | 753.5% | operator |
| 14488 | Seq Scan | 0.01 | 7.19 | 71844.7% | operator |
| 14472 | Nested Loop | 1157.98 | 1119.20 | 3.3% | operator |
| 14484 | Hash | 37.54 | 17.76 | 52.7% | operator |
| 14473 | Hash Join | 210.45 | 226.59 | 7.7% | operator |
| 14483 | Index Scan | 0.04 | 0.09 | 112.3% | operator |
| 14485 | Seq Scan | 37.41 | 44.49 | 18.9% | operator |
| 14474 | Seq Scan | 159.66 | 161.81 | 1.3% | operator |
| 14475 | Hash | 33.10 | 36.08 | 9.0% | pattern |
| 14480 | Seq Scan | 0.02 | 9.26 | 43998.2% | operator |
| 14481 | Hash | 0.12 | 16.01 | 12815.3% | operator |
| 14482 | Seq Scan | 0.12 | 21.39 | 17577.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 14482 (Seq Scan) - LEAF
...
### Step 2: Node 14480 (Seq Scan) - LEAF
...
### Step 4: Node 14474 (Seq Scan) - LEAF
...
### Step 5: Node 14475 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 14466, 14467, 14476, 14477, 14478, 14479
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 14483 (Index Scan) - LEAF
...
### Step 8: Node 14485 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - st1=37.2434
  - st2=17.7648
  - startup_cost=9920.0900
  - total_cost=70271.5700
- **Output:** st=77.18, rt=1027.32

### Step 12: Node 14486 (Index Scan) - LEAF
...
### Step 13: Node 14488 (Seq Scan) - LEAF
...
### Step 14: Node 14470 (Nested Loop)
...
- **Input Features:**
  ...
  - st1=77.1763
  - st2=0.0060
  - startup_cost=9920.3700
  - total_cost=70507.8500
- **Output:** st=27.01, rt=1105.65

### Step 15: Node 14487 (Hash)
...
- **Input Features:**
  ...
  - st1=27.0070
  - st2=14.5393
  - startup_cost=9921.9400
  - total_cost=70513.7600
- **Output:** st=35.78, rt=1055.47

### Step 17: Node 14468 (Sort)
...
### Step 18: Node 14466 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 14467, 14475, 14476, 14477, 14478, 14479
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2422
