...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | fd858367 | 29988 | 29989, 29990, 29991 |
...
| 29992 | Incremental Sort | 2891.70 | 2910.23 | 0.6% | operator |
...
| 29995 | Sort | 2840.49 | 1098.75 | 61.3% | operator |
| 30001 | Sort | 65.96 | 1014.60 | 1438.2% | operator |
| 29996 | Hash Join | 2840.48 | 773.67 | 72.8% | operator |
| 30002 | Seq Scan | 54.67 | 25.47 | 53.4% | operator |
| 29997 | Seq Scan | 200.53 | 187.11 | 6.7% | operator |
| 29998 | Hash | 2608.89 | 255.35 | 90.2% | operator |
...
### Step 3: Node 29997 (Seq Scan) - LEAF
...
### Step 6: Node 30002 (Seq Scan) - LEAF
...
### Step 10: Node 30003 (Index Scan) - LEAF
...
### Step 11: Node 29993 (Nested Loop)
...
### Step 12: Node 29992 (Incremental Sort)
...
### Step 13: Node 29988 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** fd858367 (Limit -> Sort -> Aggregate -> Gather Merge (Outer) (Outer) (Outer))
- **Consumes:** Nodes 29989, 29990, 29991
- **Input Features:**
