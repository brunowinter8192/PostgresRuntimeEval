    ...
    Node 4643 (Aggregate) [consumed]
      Node 4644 (Gather) [consumed]
        Node 4645 (Nested Loop)
          Node 4646 (Hash Join) [PATTERN: f4cb205a]
            Node 4647 (Seq Scan) [consumed] - LEAF
            Node 4648 (Hash) [consumed]
              Node 4649 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4641 | 4642, 4643, 4644, 4646, 4647, 4648, 4649 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 4646 | 4641, 4642, 4643, 4644, 4647, 4648, 4649 |
...
| 4645 | Nested Loop | 1151.35 | 1121.61 | 2.6% | operator |
| 4646 | Hash Join | 211.02 | 219.39 | 4.0% | pattern |
| 4650 | Index Scan | 0.03 | -0.02 | 171.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4646 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 4641, 4642, 4643, 4644, 4647, 4648, 4649
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46745
  - HashJoin_nt1=233978
...
- **Output:** st=30.40, rt=219.39

### Step 2: Node 4650 (Index Scan) - LEAF
...
- **Output:** st=30.00, rt=1121.61

### Step 4: Node 4641 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4642, 4643, 4644, 4646, 4647, 4648, 4649
- **Input Features:**
