...
**Test Query:** Q3_39_seed_311753178
...
```
Node 5171 (Limit) [PATTERN: 25df29b5] - ROOT
  Node 5172 (Sort) [consumed]
    Node 5173 (Aggregate) [consumed]
      Node 5174 (Gather) [consumed]
        Node 5175 (Nested Loop)
          Node 5176 (Hash Join) [PATTERN: 895c6e8c]
            Node 5177 (Seq Scan) [consumed] - LEAF
            Node 5178 (Hash) [consumed]
              Node 5179 (Seq Scan) - LEAF
          Node 5180 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5171 | 5172, 5173, 5174, 5176, 5177, 5178 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 5176 | 5171, 5172, 5173, 5174, 5177, 5178 |
...
|------|------|--------|-----------|-----|--------|
| 5171 | Limit | 1201.62 | 1196.01 | 0.5% | pattern |
| 5175 | Nested Loop | 1166.50 | 1122.52 | 3.8% | operator |
| 5176 | Hash Join | 210.17 | 256.38 | 22.0% | pattern |
| 5180 | Index Scan | 0.03 | -0.02 | 171.3% | operator |
| 5179 | Seq Scan | 28.35 | 36.66 | 29.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5179 (Seq Scan) - LEAF
...
### Step 2: Node 5176 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 5171, 5172, 5173, 5174, 5177, 5178
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47049
  - HashJoin_nt1=234136
  ...
  - HashJoin_total_cost=37337.2500
  - Hash_Inner_np=0
  - Hash_Inner_nt=12559
...
- **Input Features:**
  ...
  - total_cost=73004.5900
- **Output:** st=31.08, rt=1122.52

### Step 5: Node 5171 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5172, 5173, 5174, 5176, 5177, 5178
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=315298
  - Aggregate_Outer_nt1=315298
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=44
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=110263.8600
  - Aggregate_Outer_total_cost=114205.0800
  - Gather_Outer_np=0
  - Gather_Outer_nt=315298
  - Gather_Outer_nt1=101709
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_total_cost=105534.3900
  - Limit_np=0
  - Limit_nt=10
  - Limit_nt1=315298
  - Limit_nt2=0
  ...
  - Limit_sel=0.0000
  - Limit_startup_cost=121018.5600
  - Limit_total_cost=121018.5900
  - Sort_Outer_np=0
  - Sort_Outer_nt=315298
  - Sort_Outer_nt1=315298
  - Sort_Outer_nt2=0
  - Sort_Outer_parallel_workers=0
  - Sort_Outer_plan_width=44
  - Sort_Outer_reltuples=0.0000
  - Sort_Outer_sel=1.0000
  - Sort_Outer_startup_cost=121018.5600
  - Sort_Outer_total_cost=121806.8100
- **Output:** st=1194.12, rt=1196.01
