...
**Test Query:** Q10_141_seed_1148564340
**Timestamp:** 2026-01-11 16:18:21
...
| 4 | 5437ac31 | 0.9438 | N/A | SKIPPED_LOW_ERROR | 17.81% |
| 5 | 2e0f44ef | 108.1438 | 0.0001% | ACCEPTED | 17.81% |
| 6 | c53c4396 | 141.6847 | -0.0000% | REJECTED | 17.81% |
| 7 | 7bcfec22 | 40.3755 | 0.0394% | ACCEPTED | 17.77% |
| 8 | b3a45093 | 2.9042 | N/A | SKIPPED_LOW_ERROR | 17.77% |
| 9 | 7d4e78be | 89.9904 | N/A | REJECTED | 17.77% |
| 10 | 284f5967 | 0.6204 | N/A | SKIPPED_LOW_ERROR | 17.77% |
| 11 | 25df29b5 | 33.4481 | 9.8522% | ACCEPTED | 7.92% |
| 12 | 6abf8d66 | 0.5062 | N/A | SKIPPED_LOW_ERROR | 7.92% |
| 13 | f4d53e95 | 0.9438 | N/A | SKIPPED_LOW_ERROR | 7.92% |
| 14 | 04a01b61 | 17.0668 | 0.0045% | ACCEPTED | 7.91% |
| 15 | 183d8335 | 0.6204 | N/A | SKIPPED_LOW_ERROR | 7.91% |
| 16 | 2873b8c3 | 94.8003 | N/A | REJECTED | 7.91% |
| 17 | 30d6e09b | 89.9904 | N/A | REJECTED | 7.91% |
| 18 | 41017f66 | 0.5062 | N/A | SKIPPED_LOW_ERROR | 7.91% |
| 19 | 4cf43b83 | 17.0668 | -0.0000% | REJECTED | 7.91% |
| 20 | dd59eb74 | 0.9438 | N/A | SKIPPED_LOW_ERROR | 7.91% |
| 21 | 95d67a9e | 0.6204 | N/A | SKIPPED_LOW_ERROR | 7.91% |
| 22 | 7a51ce50 | 89.9904 | N/A | REJECTED | 7.91% |
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 19955 | 19956, 19957, 19958, 19959, 19960, 19961, 19964 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 19960 | 19955, 19956, 19957, 19958, 19959, 19961, 19964 |
...
|------|------|--------|-----------|-----|--------|
| 19955 | Limit | 1155.28 | 1151.14 | 0.4% | pattern |
| 19960 | Hash Join | 1108.01 | 1101.65 | 0.6% | pattern |
| 19966 | Hash | 0.02 | 14.54 | 85427.7% | operator |
| 19967 | Seq Scan | 0.01 | 7.19 | 59854.0% | operator |
| 19962 | Seq Scan | 165.97 | 162.03 | 2.4% | operator |
| 19963 | Index Scan | 0.06 | -0.02 | 128.6% | operator |
| 19965 | Seq Scan | 28.72 | 29.69 | 3.4% | operator |
...
### Step 4: Node 19967 (Seq Scan) - LEAF
...
- **Consumes:** Nodes 19955, 19956, 19957, 19958, 19959, 19961, 19964
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=17881
  - HashJoin_nt1=17881
  ...
  - NestedLoop_Outer_nt=17881
  - NestedLoop_Outer_nt1=18066
...
- **Output:** st=37.51, rt=1101.65

### Step 6: Node 19966 (Hash)
...
### Step 7: Node 19955 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19956, 19957, 19958, 19959, 19960, 19961, 19964
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=55432
  - Aggregate_Outer_nt1=55432
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=280
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=1.0000
  - Aggregate_Outer_startup_cost=87811.9400
  - Aggregate_Outer_total_cost=88504.8400
  - Gather_Outer_np=0
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=17881
  - HashJoin_Outer_nt1=17881
  ...
  - HashJoin_Outer_total_cost=80575.8400
  - Limit_np=0
  - Limit_nt=20
  - Limit_nt1=55432
  - Limit_nt2=0
