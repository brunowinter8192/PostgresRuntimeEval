    ...
    Node 19957 (Aggregate) [consumed]
      Node 19958 (Gather) [consumed]
        Node 19959 (Hash Join)
          Node 19960 (Hash Join)
            Node 19961 (Nested Loop)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 19955 | 19956, 19957, 19958 |
...
| 19959 | Hash Join | 1110.80 | 1061.85 | 4.4% | operator |
| 19960 | Hash Join | 1108.01 | 1043.72 | 5.8% | operator |
| 19966 | Hash | 0.02 | 14.54 | 85427.7% | operator |
| 19961 | Nested Loop | 1060.47 | 1097.87 | 3.5% | operator |
| 19964 | Hash | 36.79 | 45.64 | 24.0% | operator |
...
- **Output:** st=8.33, rt=1097.87

### Step 5: Node 19964 (Hash)
...
### Step 6: Node 19967 (Seq Scan) - LEAF
...
- **Output:** st=34.84, rt=1043.72

### Step 8: Node 19966 (Hash)
...
- **Output:** st=38.04, rt=1061.85

### Step 10: Node 19955 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19956, 19957, 19958
- **Input Features:**
