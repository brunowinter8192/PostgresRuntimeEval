...
```
Node 17212 (Sort) [PATTERN: 8951754f] - ROOT
    ...
    Node 17214 (Gather) [consumed]
      Node 17215 (Aggregate) [consumed]
        Node 17216 (Hash Join) [consumed]
          ...
          Node 17218 (Hash)
            Node 17219 (Hash Join) [PATTERN: 895c6e8c]
              Node 17220 (Seq Scan) [consumed] - LEAF
              Node 17221 (Hash) [consumed]
                Node 17222 (Hash Join)
                  Node 17223 (Hash Join) [PATTERN: 2e0f44ef]
                    Node 17224 (Nested Loop) [consumed]
                      Node 17225 (Seq Scan) - LEAF
                      Node 17226 (Index Scan) - LEAF
                    Node 17227 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather -> | 8951754f | 17212 | 17213, 17214, 17215, 17216, 17219, 17220, 17221, 17223, 17224, 17227 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 17219 | 17212, 17213, 17214, 17215, 17216, 17220, 17221, 17223, 17224, 17227 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 17223 | 17212, 17213, 17214, 17215, 17216, 17219, 17220, 17221, 17224, 17227 |
...
| 17218 | Hash | 1037.26 | 133.45 | 87.1% | operator |
| 17219 | Hash Join | 1019.95 | 735.03 | 27.9% | pattern |
| 17222 | Hash Join | 214.69 | 821.84 | 282.8% | operator |
| 17223 | Hash Join | 199.61 | 981.46 | 391.7% | pattern |
...
### Step 4: Node 17230 (Seq Scan) - LEAF
...
### Step 5: Node 17223 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 17212, 17213, 17214, 17215, 17216, 17219, 17220, 17221, 17224, 17227
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=22712
  - HashJoin_nt1=22712
...
### Step 8: Node 17219 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 17212, 17213, 17214, 17215, 17216, 17220, 17221, 17223, 17224, 17227
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=81779
...
### Step 9: Node 17217 (Seq Scan) - LEAF
...
### Step 11: Node 17212 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 8951754f (Sort -> Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 17213, 17214, 17215, 17216, 17219, 17220, 17221, 17223, 17224, 17227
- **Input Features:**
