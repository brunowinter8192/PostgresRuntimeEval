...
```
Node 21229 (Limit) [PATTERN: 04a01b61] - ROOT
  Node 21230 (Sort) [consumed]
    Node 21231 (Aggregate) [consumed]
      Node 21232 (Gather) [consumed]
        Node 21233 (Hash Join) [consumed]
          Node 21234 (Hash Join) [PATTERN: 2e0f44ef]
            Node 21235 (Nested Loop) [consumed]
              Node 21236 (Seq Scan) - LEAF
              Node 21237 (Index Scan) - LEAF
            Node 21238 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 21229 | 21230, 21231, 21232, 21233, 21234, 21235, 21238 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 21234 | 21229, 21230, 21231, 21232, 21233, 21235, 21238 |
...
|------|------|--------|-----------|-----|--------|
| 21229 | Limit | 1130.55 | 1151.16 | 1.8% | pattern |
| 21234 | Hash Join | 1076.81 | 1101.72 | 2.3% | pattern |
...
### Step 4: Node 21241 (Seq Scan) - LEAF
...
### Step 5: Node 21234 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 21229, 21230, 21231, 21232, 21233, 21235, 21238
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18130
  - HashJoin_nt1=18130
...
### Step 7: Node 21229 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 21230, 21231, 21232, 21233, 21234, 21235, 21238
- **Input Features:**
