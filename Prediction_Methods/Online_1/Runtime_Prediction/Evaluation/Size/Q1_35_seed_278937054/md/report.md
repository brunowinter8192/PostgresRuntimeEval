...
Node 391 (Aggregate) - ROOT
  Node 392 (Gather Merge) [PATTERN: 52c5ec81]
...
|---------|------|-----------|----------------|
| Gather Merge -> Sort -> Aggreg | 52c5ec81 | 392 | 393, 394, 395 |
...
|------|------|--------|-----------|-----|--------|
| 391 | Aggregate | 946.72 | 1035.18 | 9.3% | operator |
| 392 | Gather Merge | 946.66 | 953.93 | 0.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 392 (Gather Merge) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 52c5ec81 (Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer))
- **Consumes:** Nodes 393, 394, 395
- **Input Features:**
  ...
  - GatherMerge_startup_cost=170291.0600
  - GatherMerge_total_cost=170294.6900
...
### Step 2: Node 391 (Aggregate) - ROOT
