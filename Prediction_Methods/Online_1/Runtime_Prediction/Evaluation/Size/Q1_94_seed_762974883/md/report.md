...
Node 716 (Aggregate) - ROOT
  Node 717 (Gather Merge) [PATTERN: 52c5ec81]
...
|---------|------|-----------|----------------|
| Gather Merge -> Sort -> Aggreg | 52c5ec81 | 717 | 718, 719, 720 |
...
|------|------|--------|-----------|-----|--------|
| 716 | Aggregate | 944.34 | 1035.17 | 9.6% | operator |
| 717 | Gather Merge | 944.31 | 953.93 | 1.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 717 (Gather Merge) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 52c5ec81 (Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer))
- **Consumes:** Nodes 718, 719, 720
- **Input Features:**
  ...
  - GatherMerge_startup_cost=169983.6500
  - GatherMerge_total_cost=169987.2800
...
### Step 2: Node 716 (Aggregate) - ROOT
