...
**Test Query:** Q14_127_seed_1033707906
**Timestamp:** 2026-01-01 18:00:31
...
```
Node 26623 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26624 (Gather) [consumed]
    Node 26625 (Aggregate) [consumed]
      Node 26626 (Hash Join) [PATTERN: f4cb205a]
        Node 26627 (Seq Scan) [consumed] - LEAF
        Node 26628 (Hash) [consumed]
          Node 26629 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 26626 | 26623, 26624, 26625, 26627, 26628, 26629 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26623 | 26624, 26625, 26626, 26627, 26628, 26629 |
...
|------|------|--------|-----------|-----|--------|
| 26623 | Aggregate | 862.25 | 834.74 | 3.2% | pattern |
| 26626 | Hash Join | 840.00 | 396.89 | 52.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26626 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 26623, 26624, 26625, 26627, 26628, 26629
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=16281
  - HashJoin_nt1=16281
  ...
  - HashJoin_total_cost=136649.3800
  - Hash_Inner_np=0
  - Hash_Inner_nt=83333
...
- **Output:** st=44.51, rt=396.89

### Step 2: Node 26623 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26624, 26625, 26626, 26627, 26628, 26629
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=16281
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=64
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0001
  - Aggregate_Outer_startup_cost=136934.3000
  - Aggregate_Outer_total_cost=136934.3100
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=137934.8700
  - Aggregate_total_cost=137934.8800
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=137934.3000
  - Gather_Outer_total_cost=137934.8100
