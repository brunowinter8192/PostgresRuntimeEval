...
```
Node 16868 (Sort) [PATTERN: 8951754f] - ROOT
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather -> | 8951754f | 16868 | 16869, 16870, 16871, 16872, 16875, 16876, 16877, 16879, 16880, 16883 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 16875 | 16868, 16869, 16870, 16871, 16872, 16876, 16877, 16879, 16880, 16883 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 16879 | 16868, 16869, 16870, 16871, 16872, 16875, 16876, 16877, 16880, 16883 |
...
| 16874 | Hash | 1039.26 | 133.45 | 87.2% | operator |
| 16875 | Hash Join | 1021.61 | 735.03 | 28.1% | pattern |
| 16878 | Hash Join | 215.08 | 821.84 | 282.1% | operator |
| 16879 | Hash Join | 199.50 | 981.46 | 392.0% | pattern |
...
### Step 4: Node 16886 (Seq Scan) - LEAF
...
### Step 5: Node 16879 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 16868, 16869, 16870, 16871, 16872, 16875, 16876, 16877, 16880, 16883
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=22712
  - HashJoin_nt1=22712
...
### Step 8: Node 16875 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 16868, 16869, 16870, 16871, 16872, 16876, 16877, 16879, 16880, 16883
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=81779
...
### Step 9: Node 16873 (Seq Scan) - LEAF
...
### Step 11: Node 16868 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 8951754f (Sort -> Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 16869, 16870, 16871, 16872, 16875, 16876, 16877, 16879, 16880, 16883
- **Input Features:**
