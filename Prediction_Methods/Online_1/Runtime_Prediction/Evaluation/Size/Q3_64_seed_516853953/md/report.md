    ...
    Node 5453 (Aggregate) [consumed]
      Node 5454 (Gather) [consumed]
        Node 5455 (Nested Loop)
          Node 5456 (Hash Join) [PATTERN: f4cb205a]
            Node 5457 (Seq Scan) [consumed] - LEAF
            Node 5458 (Hash) [consumed]
              Node 5459 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5451 | 5452, 5453, 5454, 5456, 5457, 5458, 5459 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 5456 | 5451, 5452, 5453, 5454, 5457, 5458, 5459 |
...
| 5455 | Nested Loop | 1172.25 | 1122.78 | 4.2% | operator |
| 5456 | Hash Join | 210.94 | 218.92 | 3.8% | pattern |
| 5460 | Index Scan | 0.03 | -0.02 | 171.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5456 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 5451, 5452, 5453, 5454, 5457, 5458, 5459
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47478
  - HashJoin_nt1=235905
...
- **Output:** st=30.18, rt=218.92

### Step 2: Node 5460 (Index Scan) - LEAF
...
- **Output:** st=31.03, rt=1122.78

### Step 4: Node 5451 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5452, 5453, 5454, 5456, 5457, 5458, 5459
- **Input Features:**
