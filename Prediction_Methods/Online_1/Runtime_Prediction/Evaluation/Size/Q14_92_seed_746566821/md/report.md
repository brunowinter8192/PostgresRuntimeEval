...
```
Node 27407 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 27407 | 27408, 27409, 27410, 27411, 27412 |
...
|------|------|--------|-----------|-----|--------|
| 27407 | Aggregate | 836.85 | 825.95 | 1.3% | pattern |
...
- **Consumes:** Nodes 27408, 27409, 27410, 27411, 27412
- **Input Features:**
