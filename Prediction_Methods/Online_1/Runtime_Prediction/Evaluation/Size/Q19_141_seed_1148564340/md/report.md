...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 31535 | 31536, 31537 |
...
| 31538 | Hash Join | 844.94 | 782.38 | 7.4% | operator |
| 31539 | Seq Scan | 791.49 | 750.07 | 5.2% | operator |
| 31540 | Hash | 47.49 | 12.06 | 74.6% | operator |
| 31541 | Seq Scan | 47.33 | 31.60 | 33.2% | operator |
...
- **Input Features:**
  ...
  - total_cost=156338.3700
- **Output:** st=77.19, rt=782.38

### Step 5: Node 31535 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 31536, 31537
- **Input Features:**
