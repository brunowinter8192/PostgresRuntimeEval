...
```
Node 13477 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 13478 (Gather Merge) [consumed]
    Node 13479 (Sort)
          ...
          Node 13482 (Hash Join)
            Node 13483 (Nested Loop)
              Node 13484 (Hash Join)
                ...
                Node 13486 (Hash) [PATTERN: 444761fb]
                  Node 13487 (Hash Join) [consumed]
                    Node 13488 (Seq Scan) [consumed] - LEAF
                    Node 13489 (Hash) [consumed]
                      Node 13490 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 13486 | 13477, 13478, 13487, 13488, 13489, 13490 |
| Aggregate -> Gather Merge (Out | 2724c080 | 13477 | 13478, 13486, 13487, 13488, 13489, 13490 |
...
|------|------|--------|-----------|-----|--------|
| 13477 | Aggregate | 1241.46 | 1178.44 | 5.1% | pattern |
...
| 13482 | Hash Join | 1229.76 | 1027.32 | 16.5% | operator |
...
| 13484 | Hash Join | 213.78 | 226.59 | 6.0% | operator |
...
| 13486 | Hash | 36.05 | 36.08 | 0.1% | pattern |
...
### Step 4: Node 13485 (Seq Scan) - LEAF
...
### Step 5: Node 13486 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 13477, 13478, 13487, 13488, 13489, 13490
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 13494 (Index Scan) - LEAF
...
### Step 8: Node 13496 (Seq Scan) - LEAF
...
### Step 12: Node 13497 (Index Scan) - LEAF
...
### Step 13: Node 13499 (Seq Scan) - LEAF
...
### Step 14: Node 13481 (Nested Loop)
...
### Step 18: Node 13477 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 13478, 13486, 13487, 13488, 13489, 13490
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2442
