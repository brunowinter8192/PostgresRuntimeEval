...
Node 18788 (Sort) - ROOT
  Node 18789 (Aggregate) [PATTERN: 0405d50f]
    Node 18790 (Gather) [consumed]
      Node 18791 (Aggregate) [consumed]
        Node 18792 (Nested Loop) [consumed]
          Node 18793 (Hash Join)
            Node 18794 (Seq Scan) - LEAF
            Node 18795 (Hash) [PATTERN: 7df893ad]
              Node 18796 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 0405d50f | 18789 | 18790, 18791, 18792, 18795, 18796, 18797, 18798, 18801 |
| Hash -> Hash Join (Outer) | 7df893ad | 18795 | 18789, 18790, 18791, 18792, 18796, 18797, 18798, 18801 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 18797 | 18789, 18790, 18791, 18792, 18795, 18796, 18798, 18801 |
...
|------|------|--------|-----------|-----|--------|
| 18788 | Sort | 1213.12 | 1157.00 | 4.6% | operator |
| 18789 | Aggregate | 1212.99 | 1194.97 | 1.5% | pattern |
| 18793 | Hash Join | 994.48 | 830.73 | 16.5% | operator |
| 18805 | Index Scan | 0.00 | -0.04 | 1512.7% | operator |
| 18794 | Seq Scan | 709.78 | 565.06 | 20.4% | operator |
| 18795 | Hash | 188.90 | 46.09 | 75.6% | pattern |
...
- **Consumes:** Nodes 18789, 18790, 18791, 18792, 18795, 18796, 18798, 18801
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14697
  - HashJoin_nt1=14697
...
### Step 7: Node 18794 (Seq Scan) - LEAF
...
### Step 8: Node 18795 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 7df893ad (Hash -> Hash Join (Outer))
- **Consumes:** Nodes 18789, 18790, 18791, 18792, 18796, 18797, 18798, 18801
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18805 (Index Scan) - LEAF
...
### Step 11: Node 18789 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 0405d50f (Aggregate -> Gather -> Aggregate -> Nested Loop (Outer) (Outer) (Outer))
- **Consumes:** Nodes 18790, 18791, 18792, 18795, 18796, 18797, 18798, 18801
- **Input Features:**
