          ...
          Node 8466 (Hash Join)
            Node 8467 (Nested Loop)
              Node 8468 (Hash Join)
                ...
                Node 8470 (Hash) [PATTERN: 7df893ad]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 8474 | 8461, 8462, 8470, 8471, 8475, 8476, 8477 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 8461 | 8462, 8470, 8471, 8474, 8475, 8476, 8477 |
| Hash -> Hash Join (Outer) | 7df893ad | 8470 | 8461, 8462, 8471, 8474, 8475, 8476, 8477 |
...
- **Consumes:** Nodes 8461, 8462, 8470, 8471, 8475, 8476, 8477
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
### Step 2: Node 8472 (Seq Scan) - LEAF
...
- **Consumes:** Nodes 8461, 8462, 8471, 8474, 8475, 8476, 8477
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 14: Node 8463 (Gather Merge)
...
### Step 15: Node 8461 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 8462, 8470, 8471, 8474, 8475, 8476, 8477
- **Input Features:**
