...
**Test Query:** Q5_35_seed_278937054
...
Node 8461 (Sort) - ROOT
  Node 8462 (Aggregate)
    Node 8463 (Gather Merge)
      Node 8464 (Aggregate)
        Node 8465 (Sort)
          Node 8466 (Hash Join)
            Node 8467 (Nested Loop)
              Node 8468 (Hash Join)
                Node 8469 (Seq Scan) - LEAF
                Node 8470 (Hash)
                  Node 8471 (Hash Join)
                    Node 8472 (Seq Scan) - LEAF
                    Node 8473 (Hash)
                      Node 8474 (Hash Join)
                        Node 8475 (Seq Scan) - LEAF
                        Node 8476 (Hash)
                          Node 8477 (Seq Scan) - LEAF
              Node 8478 (Index Scan) - LEAF
            Node 8479 (Hash)
              Node 8480 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 8461 | Sort | 1075.76 | 1104.24 | 2.6% | operator |
| 8462 | Aggregate | 1075.74 | 1057.87 | 1.7% | operator |
| 8463 | Gather Merge | 1075.73 | 1124.35 | 4.5% | operator |
| 8464 | Aggregate | 1071.33 | 1019.89 | 4.8% | operator |
| 8465 | Sort | 1071.06 | 1074.66 | 0.3% | operator |
| 8466 | Hash Join | 1070.57 | 1107.14 | 3.4% | operator |
| 8467 | Nested Loop | 1059.01 | 1102.69 | 4.1% | operator |
| 8479 | Hash | 3.53 | 14.79 | 318.6% | operator |
| 8468 | Hash Join | 216.72 | 234.18 | 8.1% | operator |
| 8478 | Index Scan | 0.07 | -0.03 | 134.0% | operator |
| 8480 | Seq Scan | 2.99 | 10.62 | 254.6% | operator |
| 8469 | Seq Scan | 165.80 | 161.95 | 2.3% | operator |
| 8470 | Hash | 37.03 | 21.31 | 42.4% | operator |
| 8471 | Hash Join | 35.20 | 62.87 | 78.6% | operator |
| 8472 | Seq Scan | 33.76 | 24.87 | 26.3% | operator |
| 8473 | Hash | 0.09 | 16.80 | 18562.8% | operator |
| 8474 | Hash Join | 0.09 | 142.84 | 165997.6% | operator |
| 8475 | Seq Scan | 0.01 | 10.49 | 131084.1% | operator |
| 8476 | Hash | 0.07 | 16.01 | 22456.2% | operator |
| 8477 | Seq Scan | 0.07 | 21.39 | 31355.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 8477 (Seq Scan) - LEAF
...
### Step 2: Node 8475 (Seq Scan) - LEAF
...
### Step 5: Node 8472 (Seq Scan) - LEAF
...
### Step 8: Node 8469 (Seq Scan) - LEAF
...
### Step 11: Node 8478 (Index Scan) - LEAF
...
### Step 12: Node 8480 (Seq Scan) - LEAF
...
### Step 18: Node 8463 (Gather Merge)
