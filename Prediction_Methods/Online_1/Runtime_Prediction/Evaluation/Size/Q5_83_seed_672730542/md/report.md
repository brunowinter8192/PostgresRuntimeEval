...
Node 9521 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 9522 (Aggregate) [consumed]
    Node 9523 (Gather Merge)
      Node 9524 (Aggregate)
        Node 9525 (Sort)
          Node 9526 (Hash Join) [PATTERN: 2e0f44ef]
            Node 9527 (Nested Loop) [consumed]
                ...
                Node 9530 (Hash) [consumed]
                  Node 9531 (Hash Join) [PATTERN: 895c6e8c]
                    ...
                    Node 9533 (Hash) [consumed]
                      Node 9534 (Hash Join) [PATTERN: f4cb205a]
                        Node 9535 (Seq Scan) [consumed] - LEAF
                        Node 9536 (Hash) [consumed]
                          Node 9537 (Seq Scan) [consumed] - LEAF
              Node 9538 (Index Scan) - LEAF
            Node 9539 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 9534 | 9521, 9522, 9526, 9527, 9528, 9529, 9530, 9531, 9532, 9533, 9535, 9536, 9537, 9539 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 9528 | 9521, 9522, 9526, 9527, 9529, 9530, 9531, 9532, 9533, 9534, 9535, 9536, 9537, 9539 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 9531 | 9521, 9522, 9526, 9527, 9528, 9529, 9530, 9532, 9533, 9534, 9535, 9536, 9537, 9539 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 9521 | 9522, 9526, 9527, 9528, 9529, 9530, 9531, 9532, 9533, 9534, 9535, 9536, 9537, 9539 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 9526 | 9521, 9522, 9527, 9528, 9529, 9530, 9531, 9532, 9533, 9534, 9535, 9536, 9537, 9539 |
...
|------|------|--------|-----------|-----|--------|
| 9521 | Sort | 1067.21 | 1080.13 | 1.2% | pattern |
| 9523 | Gather Merge | 1067.19 | 1124.37 | 5.4% | operator |
| 9524 | Aggregate | 1062.25 | 1019.74 | 4.0% | operator |
| 9525 | Sort | 1062.00 | 1073.10 | 1.0% | operator |
| 9526 | Hash Join | 1061.51 | 1080.22 | 1.8% | pattern |
| 9528 | Hash Join | 217.72 | 259.84 | 19.3% | pattern |
| 9538 | Index Scan | 0.07 | -0.03 | 134.4% | operator |
| 9540 | Seq Scan | 3.00 | 10.62 | 254.5% | operator |
| 9531 | Hash Join | 35.73 | 84.97 | 137.8% | pattern |
| 9534 | Hash Join | 0.09 | 11.62 | 12664.7% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 9534 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 9521, 9522, 9526, 9527, 9528, 9529, 9530, 9531, 9532, 9533, 9535, 9536, 9537, 9539
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
### Step 2: Node 9531 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 9521, 9522, 9526, 9527, 9528, 9529, 9530, 9532, 9533, 9534, 9535, 9536, 9537, 9539
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=12500
  - HashJoin_nt1=62500
...
### Step 3: Node 9528 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 9521, 9522, 9526, 9527, 9529, 9530, 9531, 9532, 9533, 9534, 9535, 9536, 9537, 9539
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14685
  - HashJoin_nt1=73423
...
### Step 4: Node 9538 (Index Scan) - LEAF
...
### Step 5: Node 9540 (Seq Scan) - LEAF
...
### Step 6: Node 9526 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 9521, 9522, 9527, 9528, 9529, 9530, 9531, 9532, 9533, 9534, 9535, 9536, 9537, 9539
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=2350
  - HashJoin_nt1=58750
...
### Step 10: Node 9521 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 9522, 9526, 9527, 9528, 9529, 9530, 9531, 9532, 9533, 9534, 9535, 9536, 9537, 9539
- **Input Features:**
