          ...
          Node 9526 (Hash Join)
            Node 9527 (Nested Loop)
              Node 9528 (Hash Join)
                ...
                Node 9530 (Hash) [PATTERN: 7df893ad]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 9534 | 9521, 9522, 9530, 9531, 9535, 9536, 9537 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 9521 | 9522, 9530, 9531, 9534, 9535, 9536, 9537 |
| Hash -> Hash Join (Outer) | 7df893ad | 9530 | 9521, 9522, 9531, 9534, 9535, 9536, 9537 |
...
- **Consumes:** Nodes 9521, 9522, 9530, 9531, 9535, 9536, 9537
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
### Step 2: Node 9532 (Seq Scan) - LEAF
...
- **Consumes:** Nodes 9521, 9522, 9531, 9534, 9535, 9536, 9537
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 14: Node 9523 (Gather Merge)
...
### Step 15: Node 9521 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 9522, 9530, 9531, 9534, 9535, 9536, 9537
- **Input Features:**
