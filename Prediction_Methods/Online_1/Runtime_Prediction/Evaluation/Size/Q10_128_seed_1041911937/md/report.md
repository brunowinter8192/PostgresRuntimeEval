...
**Test Query:** Q10_128_seed_1041911937
...
```
Node 19760 (Limit) [PATTERN: 04a01b61] - ROOT
  Node 19761 (Sort) [consumed]
    Node 19762 (Aggregate) [consumed]
      Node 19763 (Gather) [consumed]
        Node 19764 (Hash Join) [consumed]
          Node 19765 (Hash Join) [PATTERN: 2e0f44ef]
            Node 19766 (Nested Loop) [consumed]
              Node 19767 (Seq Scan) - LEAF
              Node 19768 (Index Scan) - LEAF
            Node 19769 (Hash) [consumed]
              Node 19770 (Seq Scan) - LEAF
          Node 19771 (Hash)
            Node 19772 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 19760 | 19761, 19762, 19763, 19764, 19765, 19766, 19769 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 19765 | 19760, 19761, 19762, 19763, 19764, 19766, 19769 |
...
|------|------|--------|-----------|-----|--------|
| 19760 | Limit | 1175.61 | 1151.17 | 2.1% | pattern |
| 19765 | Hash Join | 1113.56 | 1101.80 | 1.1% | pattern |
| 19771 | Hash | 0.01 | 14.54 | 96831.4% | operator |
| 19772 | Seq Scan | 0.01 | 7.19 | 65304.3% | operator |
| 19767 | Seq Scan | 164.22 | 162.03 | 1.3% | operator |
| 19768 | Index Scan | 0.06 | -0.02 | 129.0% | operator |
| 19770 | Seq Scan | 24.74 | 29.69 | 20.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 19767 (Seq Scan) - LEAF
...
### Step 2: Node 19768 (Index Scan) - LEAF
...
### Step 3: Node 19770 (Seq Scan) - LEAF
...
### Step 4: Node 19772 (Seq Scan) - LEAF
...
### Step 5: Node 19765 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 19760, 19761, 19762, 19763, 19764, 19766, 19769
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18384
  - HashJoin_nt1=18384
  ...
  - NestedLoop_Outer_nt=18384
  - NestedLoop_Outer_nt1=18575
...
- **Output:** st=37.52, rt=1101.80

### Step 6: Node 19771 (Hash)
...
### Step 7: Node 19760 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19761, 19762, 19763, 19764, 19765, 19766, 19769
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=18384
  - HashJoin_Outer_nt1=18384
  ...
  - HashJoin_Outer_total_cost=81057.0900
  - Limit_np=0
  - Limit_nt=20
  - Limit_nt1=56991
  - Limit_nt2=0
