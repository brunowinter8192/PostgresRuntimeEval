...
```
Node 19747 (Limit) [PATTERN: 04a01b61] - ROOT
  Node 19748 (Sort) [consumed]
    Node 19749 (Aggregate) [consumed]
      Node 19750 (Gather) [consumed]
        Node 19751 (Hash Join) [consumed]
          Node 19752 (Hash Join) [PATTERN: 2e0f44ef]
            Node 19753 (Nested Loop) [consumed]
              Node 19754 (Seq Scan) - LEAF
              Node 19755 (Index Scan) - LEAF
            Node 19756 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 19747 | 19748, 19749, 19750, 19751, 19752, 19753, 19756 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 19752 | 19747, 19748, 19749, 19750, 19751, 19753, 19756 |
...
|------|------|--------|-----------|-----|--------|
| 19747 | Limit | 1134.97 | 1151.15 | 1.4% | pattern |
| 19752 | Hash Join | 1071.18 | 1101.70 | 2.8% | pattern |
...
### Step 4: Node 19759 (Seq Scan) - LEAF
...
### Step 5: Node 19752 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 19747, 19748, 19749, 19750, 19751, 19753, 19756
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18043
  - HashJoin_nt1=18043
  ...
  - HashJoin_total_cost=80674.8300
  - Hash_Inner_np=0
  - Hash_Inner_nt=62500
  ...
  - NestedLoop_Outer_nt=18043
  - NestedLoop_Outer_nt1=18230
  ...
  - NestedLoop_Outer_total_cost=75621.2200
- **Output:** st=37.51, rt=1101.70

### Step 6: Node 19758 (Hash)
...
### Step 7: Node 19747 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19748, 19749, 19750, 19751, 19752, 19753, 19756
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=18043
  - HashJoin_Outer_nt1=18043
  ...
  - HashJoin_Outer_total_cost=80731.7900
  - Limit_np=0
  - Limit_nt=20
  - Limit_nt1=55933
  - Limit_nt2=0
