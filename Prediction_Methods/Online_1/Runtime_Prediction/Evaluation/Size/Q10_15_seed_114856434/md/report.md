...
**Test Query:** Q10_15_seed_114856434
...
```
Node 20098 (Limit) [PATTERN: 04a01b61] - ROOT
  Node 20099 (Sort) [consumed]
    Node 20100 (Aggregate) [consumed]
      Node 20101 (Gather) [consumed]
        Node 20102 (Hash Join) [consumed]
          Node 20103 (Hash Join) [PATTERN: 2e0f44ef]
            Node 20104 (Nested Loop) [consumed]
              Node 20105 (Seq Scan) - LEAF
              Node 20106 (Index Scan) - LEAF
            Node 20107 (Hash) [consumed]
              Node 20108 (Seq Scan) - LEAF
          Node 20109 (Hash)
            Node 20110 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 20098 | 20099, 20100, 20101, 20102, 20103, 20104, 20107 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 20103 | 20098, 20099, 20100, 20101, 20102, 20104, 20107 |
...
|------|------|--------|-----------|-----|--------|
| 20098 | Limit | 1148.94 | 1151.16 | 0.2% | pattern |
| 20103 | Hash Join | 1098.24 | 1101.74 | 0.3% | pattern |
| 20109 | Hash | 0.01 | 14.54 | 96831.4% | operator |
| 20110 | Seq Scan | 0.01 | 7.19 | 71844.7% | operator |
| 20105 | Seq Scan | 157.57 | 162.03 | 2.8% | operator |
| 20106 | Index Scan | 0.06 | -0.02 | 129.0% | operator |
| 20108 | Seq Scan | 22.82 | 29.69 | 30.1% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 20105 (Seq Scan) - LEAF
...
### Step 2: Node 20106 (Index Scan) - LEAF
...
### Step 3: Node 20108 (Seq Scan) - LEAF
...
### Step 4: Node 20110 (Seq Scan) - LEAF
...
### Step 5: Node 20103 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 20098, 20099, 20100, 20101, 20102, 20104, 20107
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18186
  - HashJoin_nt1=18186
...
### Step 7: Node 20098 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20099, 20100, 20101, 20102, 20103, 20104, 20107
- **Input Features:**
