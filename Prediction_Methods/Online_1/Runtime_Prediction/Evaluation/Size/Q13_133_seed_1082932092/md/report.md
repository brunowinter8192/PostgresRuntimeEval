...
**Test Query:** Q13_133_seed_1082932092
...
```
Node 25622 (Sort) [PATTERN: f592ee11] - ROOT
  Node 25623 (Aggregate) [consumed]
    Node 25624 (Aggregate) [consumed]
      Node 25625 (Hash Join) [consumed]
        Node 25626 (Seq Scan) [consumed] - LEAF
        Node 25627 (Hash) [consumed]
          Node 25628 (Index Only Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Aggregate | f592ee11 | 25622 | 25623, 25624, 25625, 25626, 25627, 25628 |
...
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=1484970
  - HashJoin_Outer_nt1=1484970
  ...
  - HashJoin_Outer_total_cost=53372.0800
  - Hash_Inner_np=0
