          ...
          Node 7086 (Hash Join)
            Node 7087 (Nested Loop)
              Node 7088 (Hash Join)
                ...
                Node 7090 (Hash) [PATTERN: 7df893ad]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 7094 | 7081, 7082, 7090, 7091, 7095, 7096, 7097 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 7081 | 7082, 7090, 7091, 7094, 7095, 7096, 7097 |
| Hash -> Hash Join (Outer) | 7df893ad | 7090 | 7081, 7082, 7091, 7094, 7095, 7096, 7097 |
...
- **Consumes:** Nodes 7081, 7082, 7090, 7091, 7095, 7096, 7097
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
### Step 4: Node 7089 (Seq Scan) - LEAF
...
### Step 5: Node 7090 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 7df893ad (Hash -> Hash Join (Outer))
- **Consumes:** Nodes 7081, 7082, 7091, 7094, 7095, 7096, 7097
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 7: Node 7098 (Index Scan) - LEAF
...
### Step 8: Node 7100 (Seq Scan) - LEAF
...
### Step 14: Node 7083 (Gather Merge)
...
### Step 15: Node 7081 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 7082, 7090, 7091, 7094, 7095, 7096, 7097
- **Input Features:**
