          ...
          Node 9266 (Hash Join)
            Node 9267 (Nested Loop)
              Node 9268 (Hash Join)
                ...
                Node 9270 (Hash) [PATTERN: 7df893ad]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 9274 | 9261, 9262, 9270, 9271, 9275, 9276, 9277 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 9261 | 9262, 9270, 9271, 9274, 9275, 9276, 9277 |
| Hash -> Hash Join (Outer) | 7df893ad | 9270 | 9261, 9262, 9271, 9274, 9275, 9276, 9277 |
...
- **Consumes:** Nodes 9261, 9262, 9270, 9271, 9275, 9276, 9277
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
### Step 2: Node 9272 (Seq Scan) - LEAF
...
- **Consumes:** Nodes 9261, 9262, 9271, 9274, 9275, 9276, 9277
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 14: Node 9263 (Gather Merge)
...
### Step 15: Node 9261 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 9262, 9270, 9271, 9274, 9275, 9276, 9277
- **Input Features:**
