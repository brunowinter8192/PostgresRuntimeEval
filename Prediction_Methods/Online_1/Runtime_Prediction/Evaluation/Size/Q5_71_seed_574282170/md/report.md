...
```
Node 9261 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 9262 (Aggregate) [consumed]
    Node 9263 (Gather Merge)
      Node 9264 (Aggregate)
        Node 9265 (Sort)
          Node 9266 (Hash Join) [PATTERN: 2e0f44ef]
            Node 9267 (Nested Loop) [consumed]
              Node 9268 (Hash Join) [PATTERN: 895c6e8c]
                Node 9269 (Seq Scan) [consumed] - LEAF
                Node 9270 (Hash) [consumed]
                  Node 9271 (Hash Join) [PATTERN: 895c6e8c]
                    Node 9272 (Seq Scan) [consumed] - LEAF
                    Node 9273 (Hash) [consumed]
                      Node 9274 (Hash Join) [PATTERN: f4cb205a]
                        Node 9275 (Seq Scan) [consumed] - LEAF
                        Node 9276 (Hash) [consumed]
                          Node 9277 (Seq Scan) [consumed] - LEAF
              Node 9278 (Index Scan) - LEAF
            Node 9279 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 9274 | 9261, 9262, 9266, 9267, 9268, 9269, 9270, 9271, 9272, 9273, 9275, 9276, 9277, 9279 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 9268 | 9261, 9262, 9266, 9267, 9269, 9270, 9271, 9272, 9273, 9274, 9275, 9276, 9277, 9279 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 9271 | 9261, 9262, 9266, 9267, 9268, 9269, 9270, 9272, 9273, 9274, 9275, 9276, 9277, 9279 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 9261 | 9262, 9266, 9267, 9268, 9269, 9270, 9271, 9272, 9273, 9274, 9275, 9276, 9277, 9279 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 9266 | 9261, 9262, 9267, 9268, 9269, 9270, 9271, 9272, 9273, 9274, 9275, 9276, 9277, 9279 |
...
|------|------|--------|-----------|-----|--------|
| 9261 | Sort | 1064.45 | 1080.12 | 1.5% | pattern |
| 9263 | Gather Merge | 1064.42 | 1124.38 | 5.6% | operator |
| 9264 | Aggregate | 1058.95 | 1019.75 | 3.7% | operator |
| 9265 | Sort | 1058.70 | 1073.09 | 1.4% | operator |
| 9266 | Hash Join | 1058.19 | 1080.14 | 2.1% | pattern |
| 9268 | Hash Join | 215.28 | 259.84 | 20.7% | pattern |
| 9278 | Index Scan | 0.07 | -0.03 | 134.9% | operator |
| 9280 | Seq Scan | 2.47 | 10.62 | 329.7% | operator |
| 9271 | Hash Join | 35.54 | 84.97 | 139.1% | pattern |
| 9274 | Hash Join | 0.10 | 11.62 | 11400.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 9274 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 9261, 9262, 9266, 9267, 9268, 9269, 9270, 9271, 9272, 9273, 9275, 9276, 9277, 9279
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
### Step 2: Node 9271 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 9261, 9262, 9266, 9267, 9268, 9269, 9270, 9272, 9273, 9274, 9275, 9276, 9277, 9279
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=12500
  - HashJoin_nt1=62500
...
### Step 3: Node 9268 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 9261, 9262, 9266, 9267, 9269, 9270, 9271, 9272, 9273, 9274, 9275, 9276, 9277, 9279
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14646
  - HashJoin_nt1=73231
...
### Step 4: Node 9278 (Index Scan) - LEAF
...
### Step 5: Node 9280 (Seq Scan) - LEAF
...
### Step 6: Node 9266 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 9261, 9262, 9267, 9268, 9269, 9270, 9271, 9272, 9273, 9274, 9275, 9276, 9277, 9279
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=2344
  - HashJoin_nt1=58597
...
### Step 10: Node 9261 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 9262, 9266, 9267, 9268, 9269, 9270, 9271, 9272, 9273, 9274, 9275, 9276, 9277, 9279
- **Input Features:**
