...
**Test Query:** Q5_71_seed_574282170
...
Node 9261 (Sort) - ROOT
  Node 9262 (Aggregate)
    Node 9263 (Gather Merge)
      Node 9264 (Aggregate)
        Node 9265 (Sort)
          Node 9266 (Hash Join)
            Node 9267 (Nested Loop)
              Node 9268 (Hash Join)
                Node 9269 (Seq Scan) - LEAF
                Node 9270 (Hash)
                  Node 9271 (Hash Join)
                    Node 9272 (Seq Scan) - LEAF
                    Node 9273 (Hash)
                      Node 9274 (Hash Join)
                        Node 9275 (Seq Scan) - LEAF
                        Node 9276 (Hash)
                          Node 9277 (Seq Scan) - LEAF
              Node 9278 (Index Scan) - LEAF
            Node 9279 (Hash)
              Node 9280 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 9261 | Sort | 1064.45 | 1104.24 | 3.7% | operator |
| 9262 | Aggregate | 1064.43 | 1057.96 | 0.6% | operator |
| 9263 | Gather Merge | 1064.42 | 1124.38 | 5.6% | operator |
| 9264 | Aggregate | 1058.95 | 1020.00 | 3.7% | operator |
| 9265 | Sort | 1058.70 | 1074.63 | 1.5% | operator |
| 9266 | Hash Join | 1058.19 | 1106.69 | 4.6% | operator |
| 9267 | Nested Loop | 1047.16 | 1102.47 | 5.3% | operator |
| 9279 | Hash | 2.99 | 14.79 | 394.6% | operator |
| 9268 | Hash Join | 215.28 | 234.19 | 8.8% | operator |
| 9278 | Index Scan | 0.07 | -0.03 | 134.9% | operator |
| 9280 | Seq Scan | 2.47 | 10.62 | 329.7% | operator |
| 9269 | Seq Scan | 166.20 | 161.95 | 2.6% | operator |
| 9270 | Hash | 36.22 | 21.31 | 41.2% | operator |
| 9271 | Hash Join | 35.54 | 62.87 | 76.9% | operator |
| 9272 | Seq Scan | 34.04 | 24.87 | 26.9% | operator |
| 9273 | Hash | 0.10 | 16.80 | 16050.5% | operator |
| 9274 | Hash Join | 0.10 | 142.84 | 141329.6% | operator |
| 9275 | Seq Scan | 0.01 | 10.49 | 104847.3% | operator |
| 9276 | Hash | 0.09 | 16.01 | 18741.1% | operator |
| 9277 | Seq Scan | 0.08 | 21.39 | 25671.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 9277 (Seq Scan) - LEAF
...
### Step 2: Node 9275 (Seq Scan) - LEAF
...
### Step 5: Node 9272 (Seq Scan) - LEAF
...
### Step 8: Node 9269 (Seq Scan) - LEAF
...
### Step 11: Node 9278 (Index Scan) - LEAF
...
### Step 12: Node 9280 (Seq Scan) - LEAF
...
### Step 18: Node 9263 (Gather Merge)
