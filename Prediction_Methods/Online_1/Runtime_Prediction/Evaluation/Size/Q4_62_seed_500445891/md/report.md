...
```
Node 6607 (Aggregate) [PATTERN: 2724c080] - ROOT
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 6609 | 6607, 6608, 6610 |
| Aggregate -> Gather Merge (Out | 2724c080 | 6607 | 6608, 6609, 6610 |
...
|------|------|--------|-----------|-----|--------|
| 6607 | Aggregate | 1046.62 | 1079.04 | 3.1% | pattern |
...
### Step 5: Node 6607 (Aggregate) - PATTERN ROOT
