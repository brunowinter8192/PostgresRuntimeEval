...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | fd858367 | 29844 | 29845, 29846, 29847 |
...
| 29848 | Incremental Sort | 2896.55 | 2910.23 | 0.5% | operator |
...
| 29851 | Sort | 2827.16 | 1098.75 | 61.1% | operator |
| 29857 | Sort | 66.16 | 1014.60 | 1433.7% | operator |
| 29852 | Hash Join | 2827.15 | 773.67 | 72.6% | operator |
| 29858 | Seq Scan | 54.13 | 25.47 | 52.9% | operator |
| 29853 | Seq Scan | 195.01 | 187.11 | 4.1% | operator |
| 29854 | Hash | 2603.68 | 255.35 | 90.2% | operator |
...
### Step 3: Node 29853 (Seq Scan) - LEAF
...
### Step 6: Node 29858 (Seq Scan) - LEAF
...
### Step 10: Node 29859 (Index Scan) - LEAF
...
### Step 11: Node 29849 (Nested Loop)
...
### Step 12: Node 29848 (Incremental Sort)
...
### Step 13: Node 29844 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** fd858367 (Limit -> Sort -> Aggregate -> Gather Merge (Outer) (Outer) (Outer))
- **Consumes:** Nodes 29845, 29846, 29847
- **Input Features:**
