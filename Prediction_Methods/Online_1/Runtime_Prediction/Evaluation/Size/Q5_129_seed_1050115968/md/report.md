...
**Test Query:** Q5_129_seed_1050115968
...
Node 7521 (Sort) - ROOT
  Node 7522 (Aggregate)
    Node 7523 (Gather Merge)
      Node 7524 (Aggregate)
        Node 7525 (Sort)
          Node 7526 (Hash Join)
            Node 7527 (Nested Loop)
              Node 7528 (Hash Join)
                Node 7529 (Seq Scan) - LEAF
                Node 7530 (Hash)
                  Node 7531 (Hash Join)
                    Node 7532 (Seq Scan) - LEAF
                    Node 7533 (Hash)
                      Node 7534 (Hash Join)
                        Node 7535 (Seq Scan) - LEAF
                        Node 7536 (Hash)
                          Node 7537 (Seq Scan) - LEAF
              Node 7538 (Index Scan) - LEAF
            Node 7539 (Hash)
              Node 7540 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 7521 | Sort | 1078.29 | 1104.24 | 2.4% | operator |
| 7522 | Aggregate | 1078.28 | 1057.87 | 1.9% | operator |
| 7523 | Gather Merge | 1078.27 | 1124.35 | 4.3% | operator |
| 7524 | Aggregate | 1071.84 | 1019.89 | 4.8% | operator |
| 7525 | Sort | 1071.59 | 1074.66 | 0.3% | operator |
| 7526 | Hash Join | 1071.12 | 1107.14 | 3.4% | operator |
| 7527 | Nested Loop | 1060.76 | 1102.69 | 4.0% | operator |
| 7539 | Hash | 2.24 | 14.79 | 559.9% | operator |
| 7528 | Hash Join | 214.29 | 234.18 | 9.3% | operator |
| 7538 | Index Scan | 0.07 | -0.03 | 133.5% | operator |
| 7540 | Seq Scan | 1.75 | 10.62 | 508.4% | operator |
| 7529 | Seq Scan | 165.97 | 161.95 | 2.4% | operator |
| 7530 | Hash | 35.37 | 21.31 | 39.7% | operator |
| 7531 | Hash Join | 34.68 | 62.87 | 81.3% | operator |
| 7532 | Seq Scan | 33.14 | 24.87 | 24.9% | operator |
| 7533 | Hash | 0.20 | 16.80 | 8256.5% | operator |
| 7534 | Hash Join | 0.20 | 142.84 | 72043.4% | operator |
| 7535 | Seq Scan | 0.02 | 10.49 | 47603.3% | operator |
| 7536 | Hash | 0.17 | 16.01 | 9432.7% | operator |
| 7537 | Seq Scan | 0.17 | 21.39 | 12863.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 7537 (Seq Scan) - LEAF
...
### Step 2: Node 7535 (Seq Scan) - LEAF
...
### Step 5: Node 7532 (Seq Scan) - LEAF
...
### Step 8: Node 7529 (Seq Scan) - LEAF
...
### Step 11: Node 7538 (Index Scan) - LEAF
...
### Step 12: Node 7540 (Seq Scan) - LEAF
...
### Step 18: Node 7523 (Gather Merge)
