    ...
    Node 5533 (Aggregate) [consumed]
      Node 5534 (Gather) [consumed]
        Node 5535 (Nested Loop)
          Node 5536 (Hash Join) [PATTERN: f4cb205a]
            Node 5537 (Seq Scan) [consumed] - LEAF
            Node 5538 (Hash) [consumed]
              Node 5539 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5531 | 5532, 5533, 5534, 5536, 5537, 5538, 5539 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 5536 | 5531, 5532, 5533, 5534, 5537, 5538, 5539 |
...
| 5535 | Nested Loop | 1150.80 | 1120.73 | 2.6% | operator |
| 5536 | Hash Join | 206.25 | 219.69 | 6.5% | pattern |
| 5540 | Index Scan | 0.03 | -0.02 | 171.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5536 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 5531, 5532, 5533, 5534, 5537, 5538, 5539
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46189
  - HashJoin_nt1=232872
...
- **Output:** st=30.56, rt=219.69

### Step 2: Node 5540 (Index Scan) - LEAF
...
- **Output:** st=29.22, rt=1120.73

### Step 4: Node 5531 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5532, 5533, 5534, 5536, 5537, 5538, 5539
- **Input Features:**
