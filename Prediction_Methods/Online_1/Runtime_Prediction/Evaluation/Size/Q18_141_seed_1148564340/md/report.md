...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | fd858367 | 29540 | 29541, 29542, 29543 |
...
| 29544 | Incremental Sort | 2899.29 | 2910.23 | 0.4% | operator |
...
| 29547 | Sort | 2847.47 | 1098.75 | 61.4% | operator |
| 29553 | Sort | 67.49 | 1014.60 | 1403.3% | operator |
| 29548 | Hash Join | 2847.46 | 773.67 | 72.8% | operator |
| 29554 | Seq Scan | 55.42 | 25.47 | 54.0% | operator |
| 29549 | Seq Scan | 191.20 | 187.11 | 2.1% | operator |
| 29550 | Hash | 2626.96 | 255.35 | 90.3% | operator |
...
### Step 3: Node 29549 (Seq Scan) - LEAF
...
### Step 6: Node 29554 (Seq Scan) - LEAF
...
### Step 10: Node 29555 (Index Scan) - LEAF
...
### Step 11: Node 29545 (Nested Loop)
...
### Step 12: Node 29544 (Incremental Sort)
...
### Step 13: Node 29540 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** fd858367 (Limit -> Sort -> Aggregate -> Gather Merge (Outer) (Outer) (Outer))
- **Consumes:** Nodes 29541, 29542, 29543
- **Input Features:**
