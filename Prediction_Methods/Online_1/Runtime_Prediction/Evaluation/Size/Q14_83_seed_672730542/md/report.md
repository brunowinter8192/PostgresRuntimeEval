...
```
Node 27337 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 27337 | 27338, 27339, 27340, 27341, 27342 |
...
|------|------|--------|-----------|-----|--------|
| 27337 | Aggregate | 815.22 | 825.95 | 1.3% | pattern |
...
- **Consumes:** Nodes 27338, 27339, 27340, 27341, 27342
- **Input Features:**
