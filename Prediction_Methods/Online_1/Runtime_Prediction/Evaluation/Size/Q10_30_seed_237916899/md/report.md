...
```
Node 20319 (Limit) [PATTERN: 04a01b61] - ROOT
  Node 20320 (Sort) [consumed]
    Node 20321 (Aggregate) [consumed]
      Node 20322 (Gather) [consumed]
        Node 20323 (Hash Join) [consumed]
          Node 20324 (Hash Join) [PATTERN: 2e0f44ef]
            Node 20325 (Nested Loop) [consumed]
              Node 20326 (Seq Scan) - LEAF
              Node 20327 (Index Scan) - LEAF
            Node 20328 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 20319 | 20320, 20321, 20322, 20323, 20324, 20325, 20328 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 20324 | 20319, 20320, 20321, 20322, 20323, 20325, 20328 |
...
|------|------|--------|-----------|-----|--------|
| 20319 | Limit | 1140.86 | 1151.15 | 0.9% | pattern |
| 20324 | Hash Join | 1093.08 | 1101.66 | 0.8% | pattern |
...
### Step 4: Node 20331 (Seq Scan) - LEAF
...
### Step 5: Node 20324 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 20319, 20320, 20321, 20322, 20323, 20325, 20328
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=17935
  - HashJoin_nt1=17935
  ...
  - NestedLoop_Outer_nt=17935
  - NestedLoop_Outer_nt1=18121
...
- **Output:** st=37.51, rt=1101.66

### Step 6: Node 20330 (Hash)
...
### Step 7: Node 20319 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20320, 20321, 20322, 20323, 20324, 20325, 20328
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=17935
  - HashJoin_Outer_nt1=17935
  ...
  - HashJoin_Outer_total_cost=80628.0300
  - Limit_np=0
  - Limit_nt=20
  - Limit_nt1=55600
  - Limit_nt2=0
