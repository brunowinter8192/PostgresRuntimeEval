...
```
Node 14489 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 14490 (Gather Merge) [consumed]
    Node 14491 (Sort)
          ...
          Node 14494 (Hash Join)
            Node 14495 (Nested Loop)
              Node 14496 (Hash Join)
                ...
                Node 14498 (Hash) [PATTERN: 444761fb]
                  Node 14499 (Hash Join) [consumed]
                    Node 14500 (Seq Scan) [consumed] - LEAF
                    Node 14501 (Hash) [consumed]
                      Node 14502 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 14498 | 14489, 14490, 14499, 14500, 14501, 14502 |
| Aggregate -> Gather Merge (Out | 2724c080 | 14489 | 14490, 14498, 14499, 14500, 14501, 14502 |
...
|------|------|--------|-----------|-----|--------|
| 14489 | Aggregate | 1227.16 | 1176.20 | 4.2% | pattern |
...
| 14494 | Hash Join | 1217.22 | 1027.33 | 15.6% | operator |
...
| 14496 | Hash Join | 214.50 | 226.59 | 5.6% | operator |
...
| 14498 | Hash | 36.02 | 36.08 | 0.2% | pattern |
...
### Step 4: Node 14497 (Seq Scan) - LEAF
...
### Step 5: Node 14498 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 14489, 14490, 14499, 14500, 14501, 14502
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 14506 (Index Scan) - LEAF
...
### Step 8: Node 14508 (Seq Scan) - LEAF
...
### Step 12: Node 14509 (Index Scan) - LEAF
...
### Step 13: Node 14511 (Seq Scan) - LEAF
...
### Step 14: Node 14493 (Nested Loop)
...
### Step 18: Node 14489 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 14490, 14498, 14499, 14500, 14501, 14502
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2480
