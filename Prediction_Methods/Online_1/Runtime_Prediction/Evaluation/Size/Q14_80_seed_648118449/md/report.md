...
```
Node 27316 (Aggregate) [PATTERN: 310134da] - ROOT
  Node 27317 (Gather) [consumed]
    Node 27318 (Aggregate) [consumed]
      Node 27319 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 27316 | 27317, 27318, 27319, 27320, 27321 |
...
|------|------|--------|-----------|-----|--------|
| 27316 | Aggregate | 814.96 | 825.95 | 1.3% | pattern |
...
- **Consumes:** Nodes 27317, 27318, 27319, 27320, 27321
- **Input Features:**
