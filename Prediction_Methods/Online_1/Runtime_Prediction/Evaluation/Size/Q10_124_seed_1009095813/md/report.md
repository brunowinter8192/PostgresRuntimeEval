...
```
Node 19708 (Limit) [PATTERN: 04a01b61] - ROOT
  Node 19709 (Sort) [consumed]
    Node 19710 (Aggregate) [consumed]
      Node 19711 (Gather) [consumed]
        Node 19712 (Hash Join) [consumed]
          Node 19713 (Hash Join) [PATTERN: 2e0f44ef]
            Node 19714 (Nested Loop) [consumed]
              Node 19715 (Seq Scan) - LEAF
              Node 19716 (Index Scan) - LEAF
            Node 19717 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 19708 | 19709, 19710, 19711, 19712, 19713, 19714, 19717 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 19713 | 19708, 19709, 19710, 19711, 19712, 19714, 19717 |
...
|------|------|--------|-----------|-----|--------|
| 19708 | Limit | 1143.60 | 1151.16 | 0.7% | pattern |
| 19713 | Hash Join | 1084.45 | 1101.72 | 1.6% | pattern |
...
### Step 4: Node 19720 (Seq Scan) - LEAF
...
### Step 5: Node 19713 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 19708, 19709, 19710, 19711, 19712, 19714, 19717
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18130
  - HashJoin_nt1=18130
...
### Step 7: Node 19708 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19709, 19710, 19711, 19712, 19713, 19714, 19717
- **Input Features:**
