...
```
Node 20774 (Limit) [PATTERN: 04a01b61] - ROOT
  Node 20775 (Sort) [consumed]
    Node 20776 (Aggregate) [consumed]
      Node 20777 (Gather) [consumed]
        Node 20778 (Hash Join) [consumed]
          Node 20779 (Hash Join) [PATTERN: 2e0f44ef]
            Node 20780 (Nested Loop) [consumed]
              Node 20781 (Seq Scan) - LEAF
              Node 20782 (Index Scan) - LEAF
            Node 20783 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 20774 | 20775, 20776, 20777, 20778, 20779, 20780, 20783 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 20779 | 20774, 20775, 20776, 20777, 20778, 20780, 20783 |
...
|------|------|--------|-----------|-----|--------|
| 20774 | Limit | 1171.46 | 1151.16 | 1.7% | pattern |
| 20779 | Hash Join | 1113.36 | 1101.74 | 1.0% | pattern |
...
### Step 4: Node 20786 (Seq Scan) - LEAF
...
### Step 5: Node 20779 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 20774, 20775, 20776, 20777, 20778, 20780, 20783
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18183
  - HashJoin_nt1=18183
...
### Step 7: Node 20774 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20775, 20776, 20777, 20778, 20779, 20780, 20783
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=18183
  - HashJoin_Outer_nt1=18183
  ...
  - HashJoin_Outer_total_cost=80864.4400
  - Limit_np=0
  - Limit_nt=20
  - Limit_nt1=56366
  - Limit_nt2=0
