...
```
Node 26546 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 26546 | 26547, 26548, 26549, 26550, 26551 |
...
|------|------|--------|-----------|-----|--------|
| 26546 | Aggregate | 799.83 | 825.95 | 3.3% | pattern |
...
- **Consumes:** Nodes 26547, 26548, 26549, 26550, 26551
- **Input Features:**
