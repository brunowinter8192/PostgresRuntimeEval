...
Node 26546 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26547 (Gather) [consumed]
    Node 26548 (Aggregate) [consumed]
      Node 26549 (Hash Join) [PATTERN: f4cb205a]
        Node 26550 (Seq Scan) [consumed] - LEAF
        Node 26551 (Hash) [consumed]
          Node 26552 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 26549 | 26546, 26547, 26548, 26550, 26551, 26552 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26546 | 26547, 26548, 26549, 26550, 26551, 26552 |
...
| 26549 | Hash Join | 778.16 | 397.03 | 49.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26549 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 26546, 26547, 26548, 26550, 26551, 26552
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=15665
  - HashJoin_nt1=15665
  ...
  - HashJoin_total_cost=136647.7600
  - Hash_Inner_np=0
  - Hash_Inner_nt=83333
...
- **Output:** st=44.57, rt=397.03

### Step 2: Node 26546 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26547, 26548, 26549, 26550, 26551, 26552
- **Input Features:**
