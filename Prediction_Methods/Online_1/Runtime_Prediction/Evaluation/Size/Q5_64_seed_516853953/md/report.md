          ...
          Node 9106 (Hash Join)
            Node 9107 (Nested Loop)
              Node 9108 (Hash Join)
                ...
                Node 9110 (Hash) [PATTERN: 7df893ad]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 9114 | 9101, 9102, 9110, 9111, 9115, 9116, 9117 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 9101 | 9102, 9110, 9111, 9114, 9115, 9116, 9117 |
| Hash -> Hash Join (Outer) | 7df893ad | 9110 | 9101, 9102, 9111, 9114, 9115, 9116, 9117 |
...
- **Consumes:** Nodes 9101, 9102, 9110, 9111, 9115, 9116, 9117
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
### Step 2: Node 9112 (Seq Scan) - LEAF
...
- **Consumes:** Nodes 9101, 9102, 9111, 9114, 9115, 9116, 9117
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 14: Node 9103 (Gather Merge)
...
### Step 15: Node 9101 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 9102, 9110, 9111, 9114, 9115, 9116, 9117
- **Input Features:**
