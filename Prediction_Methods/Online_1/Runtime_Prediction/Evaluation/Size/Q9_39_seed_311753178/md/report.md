      ...
      Node 18140 (Aggregate) [consumed]
        Node 18141 (Nested Loop) [consumed]
          Node 18142 (Hash Join)
            ...
            Node 18144 (Hash) [PATTERN: 7df893ad]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 0405d50f | 18138 | 18139, 18140, 18141, 18144, 18145, 18146, 18147, 18150 |
| Hash -> Hash Join (Outer) | 7df893ad | 18144 | 18138, 18139, 18140, 18141, 18145, 18146, 18147, 18150 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 18146 | 18138, 18139, 18140, 18141, 18144, 18145, 18147, 18150 |
...
- **Consumes:** Nodes 18138, 18139, 18140, 18141, 18144, 18145, 18147, 18150
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=13360
  - HashJoin_nt1=13360
...
### Step 7: Node 18143 (Seq Scan) - LEAF
...
### Step 8: Node 18144 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 7df893ad (Hash -> Hash Join (Outer))
- **Consumes:** Nodes 18138, 18139, 18140, 18141, 18145, 18146, 18147, 18150
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 11: Node 18138 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 0405d50f (Aggregate -> Gather -> Aggregate -> Nested Loop (Outer) (Outer) (Outer))
- **Consumes:** Nodes 18139, 18140, 18141, 18144, 18145, 18146, 18147, 18150
- **Input Features:**
