...
**Test Query:** Q5_133_seed_1082932092
        ...
        Node 7625 (Sort)
          Node 7626 (Hash Join)
            Node 7627 (Nested Loop)
              Node 7628 (Hash Join)
                Node 7629 (Seq Scan) - LEAF
                Node 7630 (Hash)
                  Node 7631 (Hash Join)
                    Node 7632 (Seq Scan) - LEAF
                    Node 7633 (Hash)
                      Node 7634 (Hash Join)
                        Node 7635 (Seq Scan) - LEAF
                        Node 7636 (Hash)
...
|------|------|--------|-----------|-----|--------|
| 7621 | Sort | 1078.37 | 1104.24 | 2.4% | operator |
| 7622 | Aggregate | 1078.36 | 1057.87 | 1.9% | operator |
| 7623 | Gather Merge | 1078.35 | 1124.35 | 4.3% | operator |
| 7624 | Aggregate | 1073.12 | 1019.89 | 5.0% | operator |
| 7625 | Sort | 1072.87 | 1074.66 | 0.2% | operator |
| 7626 | Hash Join | 1072.37 | 1107.14 | 3.2% | operator |
| 7627 | Nested Loop | 1059.73 | 1102.69 | 4.1% | operator |
| 7639 | Hash | 4.69 | 14.79 | 215.5% | operator |
| 7628 | Hash Join | 216.20 | 234.18 | 8.3% | operator |
| 7638 | Index Scan | 0.07 | -0.03 | 134.9% | operator |
| 7640 | Seq Scan | 4.18 | 10.62 | 153.9% | operator |
| 7629 | Seq Scan | 170.89 | 161.95 | 5.2% | operator |
| 7630 | Hash | 32.66 | 21.31 | 34.7% | operator |
| 7631 | Hash Join | 31.99 | 62.87 | 96.5% | operator |
| 7632 | Seq Scan | 30.56 | 24.87 | 18.6% | operator |
| 7633 | Hash | 0.07 | 16.80 | 23228.5% | operator |
| 7634 | Hash Join | 0.07 | 142.84 | 203962.7% | operator |
| 7635 | Seq Scan | 0.01 | 10.49 | 131084.1% | operator |
| 7636 | Hash | 0.06 | 16.01 | 28498.1% | operator |
| 7637 | Seq Scan | 0.05 | 21.39 | 39511.0% | operator |
...
### Step 2: Node 7635 (Seq Scan) - LEAF
...
### Step 5: Node 7632 (Seq Scan) - LEAF
...
### Step 8: Node 7629 (Seq Scan) - LEAF
...
### Step 11: Node 7638 (Index Scan) - LEAF
...
### Step 12: Node 7640 (Seq Scan) - LEAF
...
### Step 18: Node 7623 (Gather Merge)
