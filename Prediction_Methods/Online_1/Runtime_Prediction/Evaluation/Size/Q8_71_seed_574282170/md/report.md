...
```
Node 15915 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 15916 (Gather Merge) [consumed]
    Node 15917 (Sort)
          ...
          Node 15920 (Hash Join)
            Node 15921 (Nested Loop)
              Node 15922 (Hash Join)
                ...
                Node 15924 (Hash) [PATTERN: 444761fb]
                  Node 15925 (Hash Join) [consumed]
                    Node 15926 (Seq Scan) [consumed] - LEAF
                    Node 15927 (Hash) [consumed]
                      Node 15928 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 15924 | 15915, 15916, 15925, 15926, 15927, 15928 |
| Aggregate -> Gather Merge (Out | 2724c080 | 15915 | 15916, 15924, 15925, 15926, 15927, 15928 |
...
|------|------|--------|-----------|-----|--------|
| 15915 | Aggregate | 1224.53 | 1177.38 | 3.9% | pattern |
...
| 15920 | Hash Join | 1215.19 | 1027.32 | 15.5% | operator |
...
| 15922 | Hash Join | 214.27 | 226.59 | 5.8% | operator |
...
| 15924 | Hash | 36.57 | 36.08 | 1.3% | pattern |
...
### Step 4: Node 15923 (Seq Scan) - LEAF
...
### Step 5: Node 15924 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 15915, 15916, 15925, 15926, 15927, 15928
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 15932 (Index Scan) - LEAF
...
### Step 8: Node 15934 (Seq Scan) - LEAF
...
### Step 12: Node 15935 (Index Scan) - LEAF
...
### Step 13: Node 15937 (Seq Scan) - LEAF
...
### Step 14: Node 15919 (Nested Loop)
...
### Step 18: Node 15915 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 15916, 15924, 15925, 15926, 15927, 15928
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2460
