...
Node 276 (Aggregate) - ROOT
  Node 277 (Gather Merge) [PATTERN: 52c5ec81]
...
|---------|------|-----------|----------------|
| Gather Merge -> Sort -> Aggreg | 52c5ec81 | 277 | 278, 279, 280 |
...
|------|------|--------|-----------|-----|--------|
| 276 | Aggregate | 932.49 | 1035.16 | 11.0% | operator |
| 277 | Gather Merge | 932.44 | 953.93 | 2.3% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 277 (Gather Merge) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 52c5ec81 (Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer))
- **Consumes:** Nodes 278, 279, 280
- **Input Features:**
...
### Step 2: Node 276 (Aggregate) - ROOT
