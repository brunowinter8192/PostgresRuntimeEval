...
```
Node 19773 (Limit) [PATTERN: 04a01b61] - ROOT
  Node 19774 (Sort) [consumed]
    Node 19775 (Aggregate) [consumed]
      Node 19776 (Gather) [consumed]
        Node 19777 (Hash Join) [consumed]
          Node 19778 (Hash Join) [PATTERN: 2e0f44ef]
            Node 19779 (Nested Loop) [consumed]
              Node 19780 (Seq Scan) - LEAF
              Node 19781 (Index Scan) - LEAF
            Node 19782 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 19773 | 19774, 19775, 19776, 19777, 19778, 19779, 19782 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 19778 | 19773, 19774, 19775, 19776, 19777, 19779, 19782 |
...
|------|------|--------|-----------|-----|--------|
| 19773 | Limit | 1138.65 | 1151.16 | 1.1% | pattern |
| 19778 | Hash Join | 1087.25 | 1101.75 | 1.3% | pattern |
...
### Step 4: Node 19785 (Seq Scan) - LEAF
...
### Step 5: Node 19778 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 19773, 19774, 19775, 19776, 19777, 19779, 19782
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18231
  - HashJoin_nt1=18231
...
### Step 7: Node 19773 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19774, 19775, 19776, 19777, 19778, 19779, 19782
- **Input Features:**
