...
Node 18971 (Sort) - ROOT
  Node 18972 (Aggregate) [PATTERN: 0405d50f]
      ...
      Node 18974 (Aggregate) [consumed]
        Node 18975 (Nested Loop) [consumed]
          Node 18976 (Hash Join)
            ...
            Node 18978 (Hash) [PATTERN: 7df893ad]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 0405d50f | 18972 | 18973, 18974, 18975, 18978, 18979, 18980, 18981, 18984 |
| Hash -> Hash Join (Outer) | 7df893ad | 18978 | 18972, 18973, 18974, 18975, 18979, 18980, 18981, 18984 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 18980 | 18972, 18973, 18974, 18975, 18978, 18979, 18981, 18984 |
...
|------|------|--------|-----------|-----|--------|
| 18971 | Sort | 1192.38 | 1158.15 | 2.9% | operator |
| 18972 | Aggregate | 1192.25 | 1194.89 | 0.2% | pattern |
| 18976 | Hash Join | 975.51 | 831.01 | 14.8% | operator |
| 18988 | Index Scan | 0.00 | -0.04 | 1512.7% | operator |
| 18977 | Seq Scan | 700.40 | 565.06 | 19.3% | operator |
| 18978 | Hash | 181.11 | 47.20 | 73.9% | pattern |
| 18980 | Hash Join | 165.14 | 981.83 | 494.5% | pattern |
...
### Step 4: Node 18987 (Seq Scan) - LEAF
...
- **Consumes:** Nodes 18972, 18973, 18974, 18975, 18978, 18979, 18981, 18984
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=16032
  - HashJoin_nt1=16032
...
### Step 7: Node 18977 (Seq Scan) - LEAF
...
### Step 8: Node 18978 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 7df893ad (Hash -> Hash Join (Outer))
- **Consumes:** Nodes 18972, 18973, 18974, 18975, 18979, 18980, 18981, 18984
- **Input Features:**
  - HashJoin_Outer_np=0
  ...
  - Hash_sel=1.0000
  - Hash_startup_cost=14329.5300
  - Hash_total_cost=14329.5300
- **Output:** st=47.20, rt=47.20

### Step 9: Node 18976 (Hash Join)
...
- **Output:** st=168.81, rt=831.01

### Step 10: Node 18988 (Index Scan) - LEAF
...
### Step 11: Node 18972 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 0405d50f (Aggregate -> Gather -> Aggregate -> Nested Loop (Outer) (Outer) (Outer))
- **Consumes:** Nodes 18973, 18974, 18975, 18978, 18979, 18980, 18981, 18984
- **Input Features:**
  ...
  - NestedLoop_Outer_np=0
  - NestedLoop_Outer_nt=57726
  - NestedLoop_Outer_nt1=57726
  - NestedLoop_Outer_nt2=1
  - NestedLoop_Outer_parallel_workers=0
  - NestedLoop_Outer_plan_width=159
  - NestedLoop_Outer_reltuples=0.0000
  - NestedLoop_Outer_sel=1.0000
  - NestedLoop_Outer_startup_cost=14570.4300
  - NestedLoop_Outer_total_cost=174326.8400
- **Output:** st=1188.83, rt=1194.89

### Step 12: Node 18971 (Sort) - ROOT
