...
**Test Query:** Q10_117_seed_951667596
...
```
Node 19604 (Limit) [PATTERN: 04a01b61] - ROOT
  Node 19605 (Sort) [consumed]
    Node 19606 (Aggregate) [consumed]
      Node 19607 (Gather) [consumed]
        Node 19608 (Hash Join) [consumed]
          Node 19609 (Hash Join) [PATTERN: 2e0f44ef]
            Node 19610 (Nested Loop) [consumed]
              Node 19611 (Seq Scan) - LEAF
              Node 19612 (Index Scan) - LEAF
            Node 19613 (Hash) [consumed]
              Node 19614 (Seq Scan) - LEAF
          Node 19615 (Hash)
            Node 19616 (Seq Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 19604 | 19605, 19606, 19607, 19608, 19609, 19610, 19613 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 19609 | 19604, 19605, 19606, 19607, 19608, 19610, 19613 |
...
|------|------|--------|-----------|-----|--------|
| 19604 | Limit | 1192.97 | 1151.15 | 3.5% | pattern |
| 19609 | Hash Join | 1132.95 | 1101.67 | 2.8% | pattern |
| 19615 | Hash | 0.02 | 14.54 | 90773.2% | operator |
| 19616 | Seq Scan | 0.01 | 7.19 | 59854.0% | operator |
| 19611 | Seq Scan | 164.67 | 162.03 | 1.6% | operator |
| 19612 | Index Scan | 0.06 | -0.02 | 128.6% | operator |
| 19614 | Seq Scan | 31.86 | 29.69 | 6.8% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 19611 (Seq Scan) - LEAF
...
### Step 2: Node 19612 (Index Scan) - LEAF
...
### Step 3: Node 19614 (Seq Scan) - LEAF
...
### Step 4: Node 19616 (Seq Scan) - LEAF
...
### Step 5: Node 19609 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 19604, 19605, 19606, 19607, 19608, 19610, 19613
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=17964
  - HashJoin_nt1=17964
  ...
  - NestedLoop_Outer_nt=17964
  - NestedLoop_Outer_nt1=18150
...
- **Output:** st=37.51, rt=1101.67

### Step 6: Node 19615 (Hash)
...
### Step 7: Node 19604 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19605, 19606, 19607, 19608, 19609, 19610, 19613
- **Input Features:**
  ...
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=17964
  - HashJoin_Outer_nt1=17964
  ...
  - HashJoin_Outer_total_cost=80656.2100
  - Limit_np=0
  - Limit_nt=20
  - Limit_nt1=55687
  - Limit_nt2=0
