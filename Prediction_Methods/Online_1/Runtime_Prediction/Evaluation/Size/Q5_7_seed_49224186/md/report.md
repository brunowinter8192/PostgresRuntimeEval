          ...
          Node 9446 (Hash Join)
            Node 9447 (Nested Loop)
              Node 9448 (Hash Join)
                ...
                Node 9450 (Hash) [PATTERN: 7df893ad]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 9454 | 9441, 9442, 9450, 9451, 9455, 9456, 9457 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 9441 | 9442, 9450, 9451, 9454, 9455, 9456, 9457 |
| Hash -> Hash Join (Outer) | 7df893ad | 9450 | 9441, 9442, 9451, 9454, 9455, 9456, 9457 |
...
- **Consumes:** Nodes 9441, 9442, 9450, 9451, 9455, 9456, 9457
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
### Step 2: Node 9452 (Seq Scan) - LEAF
...
- **Consumes:** Nodes 9441, 9442, 9451, 9454, 9455, 9456, 9457
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 14: Node 9443 (Gather Merge)
...
### Step 15: Node 9441 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 9442, 9450, 9451, 9454, 9455, 9456, 9457
- **Input Features:**
