...
```
Node 6166 (Aggregate) [PATTERN: 2724c080] - ROOT
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 6168 | 6166, 6167, 6169 |
| Aggregate -> Gather Merge (Out | 2724c080 | 6166 | 6167, 6168, 6169 |
...
|------|------|--------|-----------|-----|--------|
| 6166 | Aggregate | 1087.77 | 1079.04 | 0.8% | pattern |
...
### Step 5: Node 6166 (Aggregate) - PATTERN ROOT
