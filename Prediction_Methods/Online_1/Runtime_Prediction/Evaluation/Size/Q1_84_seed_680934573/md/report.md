...
Node 661 (Aggregate) - ROOT
  Node 662 (Gather Merge) [PATTERN: 52c5ec81]
    Node 663 (Sort) [consumed]
      Node 664 (Aggregate) [consumed]
        Node 665 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Gather Merge -> Sort -> Aggreg | 52c5ec81 | 662 | 663, 664, 665 |
...
|------|------|--------|-----------|-----|--------|
| 661 | Aggregate | 944.38 | 1035.17 | 9.6% | operator |
| 662 | Gather Merge | 944.33 | 953.93 | 1.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 662 (Gather Merge) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 52c5ec81 (Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer))
- **Consumes:** Nodes 663, 664, 665
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=6
  - Aggregate_Outer_nt1=1180386
  ...
  - Aggregate_Outer_total_cost=168916.6800
  - GatherMerge_np=0
  - GatherMerge_nt=30
  - GatherMerge_nt1=6
  - GatherMerge_nt2=0
  ...
  - GatherMerge_startup_cost=169916.8400
  - GatherMerge_total_cost=169920.4700
  - SeqScan_Outer_np=112600
  - SeqScan_Outer_nt=1180386
  - SeqScan_Outer_nt1=0
  - SeqScan_Outer_nt2=0
  - SeqScan_Outer_parallel_workers=0
  - SeqScan_Outer_plan_width=25
  - SeqScan_Outer_reltuples=6001215.0000
  - SeqScan_Outer_sel=0.1967
  ...
  - Sort_Outer_startup_cost=168916.7600
  - Sort_Outer_total_cost=168916.7800
- **Output:** st=949.34, rt=953.93

### Step 2: Node 661 (Aggregate) - ROOT
