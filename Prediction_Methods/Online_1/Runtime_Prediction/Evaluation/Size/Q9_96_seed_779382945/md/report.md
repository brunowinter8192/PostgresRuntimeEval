          ...
          Node 19285 (Hash Join) [PATTERN: 895c6e8c]
            ...
            Node 19287 (Hash) [consumed]
              Node 19288 (Hash Join)
                Node 19289 (Hash Join) [PATTERN: 2e0f44ef]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 19285 | 19280, 19281, 19286, 19287, 19289, 19290, 19293 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 19280 | 19281, 19285, 19286, 19287, 19289, 19290, 19293 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 19289 | 19280, 19281, 19285, 19286, 19287, 19290, 19293 |
...
| 19288 | Hash Join | 171.91 | 820.72 | 377.4% | operator |
| 19289 | Hash Join | 158.60 | 981.05 | 518.6% | pattern |
...
### Step 4: Node 19296 (Seq Scan) - LEAF
...
### Step 5: Node 19289 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 19280, 19281, 19285, 19286, 19287, 19290, 19293
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=19372
  - HashJoin_nt1=19372
...
### Step 8: Node 19285 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 19280, 19281, 19286, 19287, 19289, 19290, 19293
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=69752
...
### Step 9: Node 19297 (Index Scan) - LEAF
...
### Step 10: Node 19284 (Nested Loop)
...
### Step 13: Node 19280 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 19281, 19285, 19286, 19287, 19289, 19290, 19293
- **Input Features:**
