      ...
      Node 19283 (Aggregate) [consumed]
        Node 19284 (Nested Loop) [consumed]
          Node 19285 (Hash Join)
            ...
            Node 19287 (Hash) [PATTERN: 7df893ad]
              Node 19288 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 0405d50f | 19281 | 19282, 19283, 19284, 19287, 19288, 19289, 19290, 19293 |
| Hash -> Hash Join (Outer) | 7df893ad | 19287 | 19281, 19282, 19283, 19284, 19288, 19289, 19290, 19293 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 19289 | 19281, 19282, 19283, 19284, 19287, 19288, 19290, 19293 |
...
- **Consumes:** Nodes 19281, 19282, 19283, 19284, 19287, 19288, 19290, 19293
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=19372
  - HashJoin_nt1=19372
...
### Step 7: Node 19286 (Seq Scan) - LEAF
...
### Step 8: Node 19287 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 7df893ad (Hash -> Hash Join (Outer))
- **Consumes:** Nodes 19281, 19282, 19283, 19284, 19288, 19289, 19290, 19293
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 19297 (Index Scan) - LEAF
...
### Step 11: Node 19281 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 0405d50f (Aggregate -> Gather -> Aggregate -> Nested Loop (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19282, 19283, 19284, 19287, 19288, 19289, 19290, 19293
- **Input Features:**
