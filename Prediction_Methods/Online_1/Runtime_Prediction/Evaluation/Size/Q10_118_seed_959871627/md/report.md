    ...
    Node 19619 (Aggregate) [consumed]
      Node 19620 (Gather) [consumed]
        Node 19621 (Hash Join) [consumed]
          Node 19622 (Hash Join) [PATTERN: 2e0f44ef]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 19617 | 19618, 19619, 19620, 19621, 19622, 19623, 19626 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 19622 | 19617, 19618, 19619, 19620, 19621, 19623, 19626 |
...
| 19622 | Hash Join | 1114.10 | 1101.74 | 1.1% | pattern |
...
### Step 4: Node 19629 (Seq Scan) - LEAF
...
### Step 5: Node 19622 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 19617, 19618, 19619, 19620, 19621, 19623, 19626
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18186
  - HashJoin_nt1=18186
...
### Step 7: Node 19617 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19618, 19619, 19620, 19621, 19622, 19623, 19626
- **Input Features:**
