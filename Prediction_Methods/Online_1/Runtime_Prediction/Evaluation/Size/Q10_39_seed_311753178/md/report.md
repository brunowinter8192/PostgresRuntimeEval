    ...
    Node 20438 (Aggregate) [consumed]
      Node 20439 (Gather) [consumed]
        Node 20440 (Hash Join) [consumed]
          Node 20441 (Hash Join) [PATTERN: 2e0f44ef]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 20436 | 20437, 20438, 20439, 20440, 20441, 20442, 20445 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 20441 | 20436, 20437, 20438, 20439, 20440, 20442, 20445 |
...
| 20441 | Hash Join | 1091.48 | 1101.61 | 0.9% | pattern |
...
### Step 4: Node 20448 (Seq Scan) - LEAF
...
### Step 5: Node 20441 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 20436, 20437, 20438, 20439, 20440, 20442, 20445
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=17761
  - HashJoin_nt1=17761
...
### Step 7: Node 20436 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20437, 20438, 20439, 20440, 20441, 20442, 20445
- **Input Features:**
