...
```
Node 6033 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 6034 (Gather Merge) [consumed]
    Node 6035 (Sort) [PATTERN: 1d35fb97]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 6035 | 6033, 6034, 6036 |
| Aggregate -> Gather Merge (Out | 2724c080 | 6033 | 6034, 6035, 6036 |
...
|------|------|--------|-----------|-----|--------|
| 6033 | Aggregate | 1053.25 | 1078.93 | 2.4% | pattern |
| 6035 | Sort | 1048.73 | 1055.50 | 0.6% | pattern |
...
### Step 4: Node 6035 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 6033, 6034, 6036
- **Input Features:**
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=66068.6500
  - Sort_total_cost=66068.6600
- **Output:** st=1054.34, rt=1055.50

### Step 5: Node 6033 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 6034, 6035, 6036
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=5
  - Aggregate_nt1=15
