...
**Test Query:** Q5_118_seed_959871627
...
Node 7281 (Sort) - ROOT
  Node 7282 (Aggregate)
    Node 7283 (Gather Merge)
      Node 7284 (Aggregate)
        Node 7285 (Sort)
          Node 7286 (Hash Join)
            Node 7287 (Nested Loop)
              Node 7288 (Hash Join)
                Node 7289 (Seq Scan) - LEAF
                Node 7290 (Hash)
                  Node 7291 (Hash Join)
                    Node 7292 (Seq Scan) - LEAF
                    Node 7293 (Hash)
                      Node 7294 (Hash Join)
                        Node 7295 (Seq Scan) - LEAF
                        Node 7296 (Hash)
                          Node 7297 (Seq Scan) - LEAF
              Node 7298 (Index Scan) - LEAF
            Node 7299 (Hash)
              Node 7300 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 7281 | Sort | 1057.52 | 1104.24 | 4.4% | operator |
| 7282 | Aggregate | 1057.51 | 1057.96 | 0.0% | operator |
| 7283 | Gather Merge | 1057.50 | 1124.38 | 6.3% | operator |
| 7284 | Aggregate | 1052.41 | 1020.00 | 3.1% | operator |
| 7285 | Sort | 1052.15 | 1074.63 | 2.1% | operator |
| 7286 | Hash Join | 1051.66 | 1106.69 | 5.2% | operator |
| 7287 | Nested Loop | 1040.87 | 1102.47 | 5.9% | operator |
| 7299 | Hash | 2.73 | 14.79 | 441.9% | operator |
| 7288 | Hash Join | 215.00 | 234.19 | 8.9% | operator |
| 7298 | Index Scan | 0.07 | -0.03 | 134.9% | operator |
| 7300 | Seq Scan | 2.20 | 10.62 | 381.9% | operator |
| 7289 | Seq Scan | 167.22 | 161.95 | 3.2% | operator |
| 7290 | Hash | 35.00 | 21.31 | 39.1% | operator |
| 7291 | Hash Join | 34.33 | 62.87 | 83.1% | operator |
| 7292 | Seq Scan | 32.79 | 24.87 | 24.1% | operator |
| 7293 | Hash | 0.06 | 16.80 | 27894.2% | operator |
| 7294 | Hash Join | 0.06 | 142.84 | 254978.4% | operator |
| 7295 | Seq Scan | 0.01 | 10.49 | 116508.1% | operator |
| 7296 | Hash | 0.04 | 16.01 | 38960.8% | operator |
| 7297 | Seq Scan | 0.04 | 21.39 | 54746.0% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 7297 (Seq Scan) - LEAF
...
### Step 2: Node 7295 (Seq Scan) - LEAF
...
### Step 5: Node 7292 (Seq Scan) - LEAF
...
### Step 8: Node 7289 (Seq Scan) - LEAF
...
### Step 11: Node 7298 (Index Scan) - LEAF
...
### Step 12: Node 7300 (Seq Scan) - LEAF
...
### Step 18: Node 7283 (Gather Merge)
