          ...
          Node 7286 (Hash Join)
            Node 7287 (Nested Loop)
              Node 7288 (Hash Join)
                ...
                Node 7290 (Hash) [PATTERN: 7df893ad]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 7294 | 7281, 7282, 7290, 7291, 7295, 7296, 7297 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 7281 | 7282, 7290, 7291, 7294, 7295, 7296, 7297 |
| Hash -> Hash Join (Outer) | 7df893ad | 7290 | 7281, 7282, 7291, 7294, 7295, 7296, 7297 |
...
- **Consumes:** Nodes 7281, 7282, 7290, 7291, 7295, 7296, 7297
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
### Step 2: Node 7292 (Seq Scan) - LEAF
...
- **Consumes:** Nodes 7281, 7282, 7291, 7294, 7295, 7296, 7297
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 14: Node 7283 (Gather Merge)
...
### Step 15: Node 7281 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 7282, 7290, 7291, 7294, 7295, 7296, 7297
- **Input Features:**
