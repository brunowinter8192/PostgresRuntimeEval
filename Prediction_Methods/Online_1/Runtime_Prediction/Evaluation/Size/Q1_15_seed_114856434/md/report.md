...
Node 281 (Aggregate) - ROOT
  Node 282 (Gather Merge) [PATTERN: 52c5ec81]
...
|---------|------|-----------|----------------|
| Gather Merge -> Sort -> Aggreg | 52c5ec81 | 282 | 283, 284, 285 |
...
|------|------|--------|-----------|-----|--------|
| 281 | Aggregate | 991.02 | 1035.18 | 4.5% | operator |
| 282 | Gather Merge | 990.96 | 953.93 | 3.7% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 282 (Gather Merge) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 52c5ec81 (Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer))
- **Consumes:** Nodes 283, 284, 285
- **Input Features:**
  ...
  - GatherMerge_startup_cost=170165.0200
  - GatherMerge_total_cost=170168.6500
...
### Step 2: Node 281 (Aggregate) - ROOT
