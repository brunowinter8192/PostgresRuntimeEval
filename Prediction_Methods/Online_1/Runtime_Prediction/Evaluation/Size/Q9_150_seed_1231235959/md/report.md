    ...
    Node 17649 (Gather) [consumed]
      Node 17650 (Aggregate) [consumed]
        Node 17651 (Nested Loop) [consumed]
          Node 17652 (Hash Join)
            Node 17653 (Seq Scan) - LEAF
            Node 17654 (Hash) [PATTERN: 7df893ad]
              Node 17655 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 0405d50f | 17648 | 17649, 17650, 17651, 17654, 17655, 17656, 17657, 17660 |
| Hash -> Hash Join (Outer) | 7df893ad | 17654 | 17648, 17649, 17650, 17651, 17655, 17656, 17657, 17660 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 17656 | 17648, 17649, 17650, 17651, 17654, 17655, 17657, 17660 |
...
| 17652 | Hash Join | 949.90 | 831.15 | 12.5% | operator |
| 17664 | Index Scan | 0.00 | -0.04 | 1512.7% | operator |
| 17653 | Seq Scan | 677.53 | 565.06 | 16.6% | operator |
| 17654 | Hash | 177.32 | 47.76 | 73.1% | pattern |
...
- **Consumes:** Nodes 17648, 17649, 17650, 17651, 17654, 17655, 17657, 17660
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=16700
  - HashJoin_nt1=16700
...
### Step 7: Node 17653 (Seq Scan) - LEAF
...
### Step 8: Node 17654 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 7df893ad (Hash -> Hash Join (Outer))
- **Consumes:** Nodes 17648, 17649, 17650, 17651, 17655, 17656, 17657, 17660
- **Input Features:**
  - HashJoin_Outer_np=0
  ...
  - HashJoin_Outer_total_cost=14485.7000
  - Hash_np=0
  - Hash_nt=16700
  - Hash_nt1=16700
  - Hash_nt2=0
  ...
  - Hash_sel=1.0000
  - Hash_startup_cost=14485.7000
  - Hash_total_cost=14485.7000
- **Output:** st=47.76, rt=47.76

### Step 9: Node 17652 (Hash Join)
...
- **Output:** st=168.74, rt=831.15

### Step 10: Node 17664 (Index Scan) - LEAF
...
### Step 11: Node 17648 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 0405d50f (Aggregate -> Gather -> Aggregate -> Nested Loop (Outer) (Outer) (Outer))
- **Consumes:** Nodes 17649, 17650, 17651, 17654, 17655, 17656, 17657, 17660
- **Input Features:**
