...
Node 321 (Aggregate) - ROOT
  Node 322 (Gather Merge) [PATTERN: 52c5ec81]
...
|---------|------|-----------|----------------|
| Gather Merge -> Sort -> Aggreg | 52c5ec81 | 322 | 323, 324, 325 |
...
|------|------|--------|-----------|-----|--------|
| 321 | Aggregate | 937.30 | 1035.16 | 10.4% | operator |
| 322 | Gather Merge | 937.22 | 953.93 | 1.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 322 (Gather Merge) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 52c5ec81 (Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer))
- **Consumes:** Nodes 323, 324, 325
- **Input Features:**
...
### Step 2: Node 321 (Aggregate) - ROOT
