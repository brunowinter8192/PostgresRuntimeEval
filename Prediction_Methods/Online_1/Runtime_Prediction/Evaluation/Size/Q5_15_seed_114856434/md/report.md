          ...
          Node 8026 (Hash Join)
            Node 8027 (Nested Loop)
              Node 8028 (Hash Join)
                ...
                Node 8030 (Hash) [PATTERN: 7df893ad]
                  Node 8031 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 8034 | 8021, 8022, 8030, 8031, 8035, 8036, 8037 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 8021 | 8022, 8030, 8031, 8034, 8035, 8036, 8037 |
| Hash -> Hash Join (Outer) | 7df893ad | 8030 | 8021, 8022, 8031, 8034, 8035, 8036, 8037 |
...
- **Consumes:** Nodes 8021, 8022, 8030, 8031, 8035, 8036, 8037
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
### Step 2: Node 8032 (Seq Scan) - LEAF
...
### Step 4: Node 8029 (Seq Scan) - LEAF
...
### Step 5: Node 8030 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 7df893ad (Hash -> Hash Join (Outer))
- **Consumes:** Nodes 8021, 8022, 8031, 8034, 8035, 8036, 8037
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 7: Node 8038 (Index Scan) - LEAF
...
### Step 8: Node 8040 (Seq Scan) - LEAF
...
- **Output:** st=42.57, rt=1102.57

### Step 10: Node 8039 (Hash)
...
- **Output:** st=49.44, rt=1106.90

### Step 12: Node 8025 (Sort)
...
### Step 14: Node 8023 (Gather Merge)
...
### Step 15: Node 8021 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 8022, 8030, 8031, 8034, 8035, 8036, 8037
- **Input Features:**
