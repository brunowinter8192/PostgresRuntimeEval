          ...
          Node 7266 (Hash Join)
            Node 7267 (Nested Loop)
              Node 7268 (Hash Join)
                ...
                Node 7270 (Hash) [PATTERN: 7df893ad]
                  Node 7271 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 7274 | 7261, 7262, 7270, 7271, 7275, 7276, 7277 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 7261 | 7262, 7270, 7271, 7274, 7275, 7276, 7277 |
| Hash -> Hash Join (Outer) | 7df893ad | 7270 | 7261, 7262, 7271, 7274, 7275, 7276, 7277 |
...
- **Consumes:** Nodes 7261, 7262, 7270, 7271, 7275, 7276, 7277
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
### Step 2: Node 7272 (Seq Scan) - LEAF
...
### Step 4: Node 7269 (Seq Scan) - LEAF
...
### Step 5: Node 7270 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 7df893ad (Hash -> Hash Join (Outer))
- **Consumes:** Nodes 7261, 7262, 7271, 7274, 7275, 7276, 7277
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 7: Node 7278 (Index Scan) - LEAF
...
### Step 8: Node 7280 (Seq Scan) - LEAF
...
### Step 14: Node 7263 (Gather Merge)
...
### Step 15: Node 7261 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 7262, 7270, 7271, 7274, 7275, 7276, 7277
- **Input Features:**
