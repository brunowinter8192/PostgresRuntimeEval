...
**Test Query:** Q5_117_seed_951667596
...
Node 7261 (Sort) - ROOT
  Node 7262 (Aggregate)
    Node 7263 (Gather Merge)
      Node 7264 (Aggregate)
        Node 7265 (Sort)
          Node 7266 (Hash Join)
            Node 7267 (Nested Loop)
              Node 7268 (Hash Join)
                Node 7269 (Seq Scan) - LEAF
                Node 7270 (Hash)
                  Node 7271 (Hash Join)
                    Node 7272 (Seq Scan) - LEAF
                    Node 7273 (Hash)
                      Node 7274 (Hash Join)
                        Node 7275 (Seq Scan) - LEAF
                        Node 7276 (Hash)
                          Node 7277 (Seq Scan) - LEAF
              Node 7278 (Index Scan) - LEAF
            Node 7279 (Hash)
              Node 7280 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 7261 | Sort | 1068.38 | 1104.24 | 3.4% | operator |
| 7262 | Aggregate | 1068.36 | 1057.92 | 1.0% | operator |
| 7263 | Gather Merge | 1068.36 | 1124.37 | 5.2% | operator |
| 7264 | Aggregate | 1060.77 | 1019.95 | 3.8% | operator |
| 7265 | Sort | 1060.51 | 1074.64 | 1.3% | operator |
| 7266 | Hash Join | 1060.03 | 1106.89 | 4.4% | operator |
| 7267 | Nested Loop | 1049.32 | 1102.57 | 5.1% | operator |
| 7279 | Hash | 2.65 | 14.79 | 457.6% | operator |
| 7268 | Hash Join | 216.37 | 234.18 | 8.2% | operator |
| 7278 | Index Scan | 0.07 | -0.03 | 134.9% | operator |
| 7280 | Seq Scan | 1.82 | 10.62 | 482.7% | operator |
| 7269 | Seq Scan | 166.06 | 161.95 | 2.5% | operator |
| 7270 | Hash | 37.85 | 21.31 | 43.7% | operator |
| 7271 | Hash Join | 37.13 | 62.87 | 69.3% | operator |
| 7272 | Seq Scan | 35.11 | 24.87 | 29.2% | operator |
| 7273 | Hash | 0.43 | 16.80 | 3815.3% | operator |
| 7274 | Hash Join | 0.43 | 142.84 | 33431.4% | operator |
| 7275 | Seq Scan | 0.01 | 10.49 | 116508.1% | operator |
| 7276 | Hash | 0.41 | 16.01 | 3806.1% | operator |
| 7277 | Seq Scan | 0.41 | 21.39 | 5142.6% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 7277 (Seq Scan) - LEAF
...
### Step 2: Node 7275 (Seq Scan) - LEAF
...
### Step 5: Node 7272 (Seq Scan) - LEAF
...
### Step 8: Node 7269 (Seq Scan) - LEAF
...
### Step 11: Node 7278 (Index Scan) - LEAF
...
### Step 12: Node 7280 (Seq Scan) - LEAF
...
### Step 18: Node 7263 (Gather Merge)
