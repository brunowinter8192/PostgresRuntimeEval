...
```
Node 17303 (Sort) - ROOT
  Node 17304 (Aggregate) [PATTERN: 0405d50f]
    Node 17305 (Gather) [consumed]
      Node 17306 (Aggregate) [consumed]
        Node 17307 (Nested Loop) [consumed]
          Node 17308 (Hash Join)
            Node 17309 (Seq Scan) - LEAF
            Node 17310 (Hash) [PATTERN: 7df893ad]
              Node 17311 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 0405d50f | 17304 | 17305, 17306, 17307, 17310, 17311, 17312, 17313, 17316 |
| Hash -> Hash Join (Outer) | 7df893ad | 17310 | 17304, 17305, 17306, 17307, 17311, 17312, 17313, 17316 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 17312 | 17304, 17305, 17306, 17307, 17310, 17311, 17313, 17316 |
...
|------|------|--------|-----------|-----|--------|
| 17303 | Sort | 1188.08 | 1160.47 | 2.3% | operator |
| 17304 | Aggregate | 1187.96 | 1194.83 | 0.6% | pattern |
| 17308 | Hash Join | 968.30 | 831.92 | 14.1% | operator |
| 17320 | Index Scan | 0.00 | -0.04 | 1512.7% | operator |
| 17309 | Seq Scan | 702.14 | 565.06 | 19.5% | operator |
| 17310 | Hash | 171.51 | 51.00 | 70.3% | pattern |
...
- **Consumes:** Nodes 17304, 17305, 17306, 17307, 17310, 17311, 17313, 17316
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=20708
  - HashJoin_nt1=20708
...
### Step 7: Node 17309 (Seq Scan) - LEAF
...
### Step 8: Node 17310 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 7df893ad (Hash -> Hash Join (Outer))
- **Consumes:** Nodes 17304, 17305, 17306, 17307, 17311, 17312, 17313, 17316
- **Input Features:**
  - HashJoin_Outer_np=0
  ...
  - Hash_sel=1.0000
  - Hash_startup_cost=15400.7600
  - Hash_total_cost=15400.7600
- **Output:** st=50.99, rt=51.00

### Step 9: Node 17308 (Hash Join)
...
- **Output:** st=168.28, rt=831.92

### Step 10: Node 17320 (Index Scan) - LEAF
...
### Step 11: Node 17304 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 0405d50f (Aggregate -> Gather -> Aggregate -> Nested Loop (Outer) (Outer) (Outer))
- **Consumes:** Nodes 17305, 17306, 17307, 17310, 17311, 17312, 17313, 17316
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=60150
  - Aggregate_Outer_nt1=74565
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=168
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.8067
  - Aggregate_Outer_startup_cost=184401.9400
  - Aggregate_Outer_total_cost=185304.1900
  - Aggregate_np=0
  - Aggregate_nt=60150
  ...
  - Aggregate_startup_cost=219386.6900
  - Aggregate_total_cost=220288.9400
  - Gather_Outer_np=0
  ...
  - Gather_Outer_startup_cost=185401.9400
  - Gather_Outer_total_cost=216379.1900
  - NestedLoop_Outer_np=0
  - NestedLoop_Outer_nt=74565
  - NestedLoop_Outer_nt1=74565
  - NestedLoop_Outer_nt2=1
  - NestedLoop_Outer_parallel_workers=0
  - NestedLoop_Outer_plan_width=159
  - NestedLoop_Outer_reltuples=0.0000
  - NestedLoop_Outer_sel=1.0000
  - NestedLoop_Outer_startup_cost=15711.8000
  - NestedLoop_Outer_total_cost=183097.0600
- **Output:** st=1188.78, rt=1194.83

### Step 12: Node 17303 (Sort) - ROOT
