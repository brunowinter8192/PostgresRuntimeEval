...
Node 17303 (Sort) - ROOT
  Node 17304 (Aggregate) [PATTERN: a5f39f08]
          ...
          Node 17308 (Hash Join)
            ...
            Node 17310 (Hash)
              Node 17311 (Hash Join)
                Node 17312 (Hash Join)
                  Node 17313 (Nested Loop)
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 17304 | 17305, 17306 |
...
|------|------|--------|-----------|-----|--------|
| 17303 | Sort | 1188.08 | 1152.12 | 3.0% | operator |
| 17304 | Aggregate | 1187.96 | 1113.27 | 6.3% | pattern |
| 17307 | Nested Loop | 1142.22 | 1186.80 | 3.9% | operator |
| 17308 | Hash Join | 968.30 | 831.95 | 14.1% | operator |
| 17320 | Index Scan | 0.00 | -0.04 | 1512.7% | operator |
| 17309 | Seq Scan | 702.14 | 565.06 | 19.5% | operator |
| 17310 | Hash | 171.51 | 52.80 | 69.2% | operator |
| 17311 | Hash Join | 169.66 | 913.10 | 438.2% | operator |
| 17312 | Hash Join | 156.10 | 852.03 | 445.8% | operator |
| 17318 | Hash | 12.92 | 14.54 | 12.5% | operator |
| 17313 | Nested Loop | 149.66 | 1066.85 | 612.9% | operator |
| 17316 | Hash | 4.19 | 14.79 | 253.2% | operator |
...
- **Output:** st=3.76, rt=1066.85

### Step 5: Node 17316 (Hash)
...
### Step 6: Node 17319 (Seq Scan) - LEAF
...
- **Output:** st=52.51, rt=852.03

### Step 8: Node 17318 (Hash)
...
- **Output:** st=40.57, rt=913.10

### Step 10: Node 17309 (Seq Scan) - LEAF
...
- **Input Features:**
  ...
  - total_cost=15400.7600
- **Output:** st=52.80, rt=52.80

### Step 12: Node 17308 (Hash Join)
...
- **Output:** st=168.31, rt=831.95

### Step 13: Node 17320 (Index Scan) - LEAF
...
### Step 14: Node 17307 (Nested Loop)
...
- **Output:** st=139.12, rt=1186.80

### Step 15: Node 17304 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 17305, 17306
- **Input Features:**
...
- **Output:** st=1107.80, rt=1113.27

### Step 16: Node 17303 (Sort) - ROOT
