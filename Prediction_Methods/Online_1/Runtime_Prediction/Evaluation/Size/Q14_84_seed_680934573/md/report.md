...
```
Node 27344 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 27344 | 27345, 27346, 27347, 27348, 27349 |
...
|------|------|--------|-----------|-----|--------|
| 27344 | Aggregate | 823.87 | 825.94 | 0.3% | pattern |
...
- **Consumes:** Nodes 27345, 27346, 27347, 27348, 27349
- **Input Features:**
