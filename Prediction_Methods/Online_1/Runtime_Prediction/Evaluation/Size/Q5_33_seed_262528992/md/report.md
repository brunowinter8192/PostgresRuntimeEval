          ...
          Node 8426 (Hash Join)
            Node 8427 (Nested Loop)
              Node 8428 (Hash Join)
                ...
                Node 8430 (Hash) [PATTERN: 7df893ad]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 8434 | 8421, 8422, 8430, 8431, 8435, 8436, 8437 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 8421 | 8422, 8430, 8431, 8434, 8435, 8436, 8437 |
| Hash -> Hash Join (Outer) | 7df893ad | 8430 | 8421, 8422, 8431, 8434, 8435, 8436, 8437 |
...
- **Consumes:** Nodes 8421, 8422, 8430, 8431, 8435, 8436, 8437
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
### Step 2: Node 8432 (Seq Scan) - LEAF
...
- **Consumes:** Nodes 8421, 8422, 8431, 8434, 8435, 8436, 8437
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 14: Node 8423 (Gather Merge)
...
### Step 15: Node 8421 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 8422, 8430, 8431, 8434, 8435, 8436, 8437
- **Input Features:**
