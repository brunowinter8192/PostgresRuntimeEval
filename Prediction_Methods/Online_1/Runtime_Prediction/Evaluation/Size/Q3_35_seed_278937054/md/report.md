    ...
    Node 5133 (Aggregate) [consumed]
      Node 5134 (Gather) [consumed]
        Node 5135 (Nested Loop)
          Node 5136 (Hash Join) [PATTERN: f4cb205a]
            Node 5137 (Seq Scan) [consumed] - LEAF
            Node 5138 (Hash) [consumed]
              Node 5139 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5131 | 5132, 5133, 5134, 5136, 5137, 5138, 5139 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 5136 | 5131, 5132, 5133, 5134, 5137, 5138, 5139 |
...
| 5135 | Nested Loop | 1187.22 | 1122.72 | 5.4% | operator |
| 5136 | Hash Join | 210.88 | 218.96 | 3.8% | pattern |
| 5140 | Index Scan | 0.03 | -0.02 | 168.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5136 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 5131, 5132, 5133, 5134, 5137, 5138, 5139
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=47440
  - HashJoin_nt1=235716
...
- **Output:** st=30.19, rt=218.96

### Step 2: Node 5140 (Index Scan) - LEAF
...
- **Output:** st=30.98, rt=1122.72

### Step 4: Node 5131 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5132, 5133, 5134, 5136, 5137, 5138, 5139
- **Input Features:**
