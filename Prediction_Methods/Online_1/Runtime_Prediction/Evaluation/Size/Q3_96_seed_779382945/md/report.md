    ...
    Node 5803 (Aggregate) [consumed]
      Node 5804 (Gather) [consumed]
        Node 5805 (Nested Loop)
          Node 5806 (Hash Join) [PATTERN: f4cb205a]
            Node 5807 (Seq Scan) [consumed] - LEAF
            Node 5808 (Hash) [consumed]
              Node 5809 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5801 | 5802, 5803, 5804, 5806, 5807, 5808, 5809 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 5806 | 5801, 5802, 5803, 5804, 5807, 5808, 5809 |
...
| 5805 | Nested Loop | 1178.49 | 1121.81 | 4.8% | operator |
| 5806 | Hash Join | 205.48 | 219.26 | 6.7% | pattern |
| 5810 | Index Scan | 0.03 | -0.02 | 168.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5806 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 5801, 5802, 5803, 5804, 5807, 5808, 5809
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46872
  - HashJoin_nt1=234610
...
- **Output:** st=30.35, rt=219.26

### Step 2: Node 5810 (Index Scan) - LEAF
...
- **Output:** st=30.18, rt=1121.81

### Step 4: Node 5801 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5802, 5803, 5804, 5806, 5807, 5808, 5809
- **Input Features:**
