          ...
          Node 8986 (Hash Join)
            Node 8987 (Nested Loop)
              Node 8988 (Hash Join)
                ...
                Node 8990 (Hash) [PATTERN: 7df893ad]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 8994 | 8981, 8982, 8990, 8991, 8995, 8996, 8997 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 8981 | 8982, 8990, 8991, 8994, 8995, 8996, 8997 |
| Hash -> Hash Join (Outer) | 7df893ad | 8990 | 8981, 8982, 8991, 8994, 8995, 8996, 8997 |
...
| 8986 | Hash Join | 1052.13 | 1106.63 | 5.2% | operator |
| 8987 | Nested Loop | 1041.57 | 1102.44 | 5.8% | operator |
| 8999 | Hash | 2.35 | 14.79 | 528.8% | operator |
| 8988 | Hash Join | 220.33 | 234.53 | 6.4% | operator |
| 8998 | Index Scan | 0.07 | -0.03 | 134.9% | operator |
| 9000 | Seq Scan | 1.75 | 10.62 | 505.3% | operator |
| 8989 | Seq Scan | 169.23 | 161.94 | 4.3% | operator |
| 8990 | Hash | 37.94 | 39.26 | 3.5% | pattern |
| 8992 | Seq Scan | 35.54 | 24.87 | 30.0% | operator |
| 8993 | Hash | 0.08 | 14.60 | 18866.1% | operator |
...
- **Consumes:** Nodes 8981, 8982, 8990, 8991, 8995, 8996, 8997
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
### Step 2: Node 8992 (Seq Scan) - LEAF
...
- **Consumes:** Nodes 8981, 8982, 8991, 8994, 8995, 8996, 8997
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 14: Node 8983 (Gather Merge)
...
### Step 15: Node 8981 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 8982, 8990, 8991, 8994, 8995, 8996, 8997
- **Input Features:**
