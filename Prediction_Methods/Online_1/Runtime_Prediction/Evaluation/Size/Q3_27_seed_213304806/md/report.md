    ...
    Node 5043 (Aggregate) [consumed]
      Node 5044 (Gather) [consumed]
        Node 5045 (Nested Loop)
          Node 5046 (Hash Join) [PATTERN: f4cb205a]
            Node 5047 (Seq Scan) [consumed] - LEAF
            Node 5048 (Hash) [consumed]
              Node 5049 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5041 | 5042, 5043, 5044, 5046, 5047, 5048, 5049 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 5046 | 5041, 5042, 5043, 5044, 5047, 5048, 5049 |
...
| 5045 | Nested Loop | 1158.14 | 1121.26 | 3.2% | operator |
| 5046 | Hash Join | 210.69 | 219.62 | 4.2% | pattern |
| 5050 | Index Scan | 0.03 | -0.02 | 171.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5046 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 5041, 5042, 5043, 5044, 5047, 5048, 5049
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46525
  - HashJoin_nt1=232872
...
- **Output:** st=30.48, rt=219.62

### Step 2: Node 5050 (Index Scan) - LEAF
...
- **Output:** st=29.69, rt=1121.26

### Step 4: Node 5041 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5042, 5043, 5044, 5046, 5047, 5048, 5049
- **Input Features:**
