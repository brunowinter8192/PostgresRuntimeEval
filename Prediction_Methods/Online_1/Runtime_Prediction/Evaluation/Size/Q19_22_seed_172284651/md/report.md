...
```
Node 31668 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 31668 | 31669, 31670, 31671, 31672, 31673 |
...
|------|------|--------|-----------|-----|--------|
| 31668 | Aggregate | 816.91 | 841.26 | 3.0% | pattern |
...
- **Consumes:** Nodes 31669, 31670, 31671, 31672, 31673
- **Input Features:**
