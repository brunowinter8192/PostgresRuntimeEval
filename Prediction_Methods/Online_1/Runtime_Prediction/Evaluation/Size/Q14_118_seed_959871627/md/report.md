...
```
Node 26553 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 26553 | 26554, 26555, 26556, 26557, 26558 |
...
|------|------|--------|-----------|-----|--------|
| 26553 | Aggregate | 823.10 | 825.95 | 0.3% | pattern |
...
- **Consumes:** Nodes 26554, 26555, 26556, 26557, 26558
- **Input Features:**
