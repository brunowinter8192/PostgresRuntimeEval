          ...
          Node 15000 (Hash Join)
            Node 15001 (Nested Loop)
              Node 15002 (Hash Join)
                ...
                Node 15004 (Hash) [PATTERN: 444761fb]
                  Node 15005 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 15004 | 14995, 14996, 15005, 15006, 15007, 15008 |
| Aggregate -> Gather Merge (Out | 2724c080 | 14995 | 14996, 15004, 15005, 15006, 15007, 15008 |
...
| 15000 | Hash Join | 1239.91 | 1027.33 | 17.1% | operator |
...
| 15002 | Hash Join | 216.03 | 226.59 | 4.9% | operator |
...
| 15004 | Hash | 35.58 | 36.08 | 1.4% | pattern |
...
### Step 4: Node 15003 (Seq Scan) - LEAF
...
### Step 5: Node 15004 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 14995, 14996, 15005, 15006, 15007, 15008
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 15012 (Index Scan) - LEAF
...
### Step 8: Node 15014 (Seq Scan) - LEAF
...
### Step 12: Node 15015 (Index Scan) - LEAF
...
### Step 13: Node 15017 (Seq Scan) - LEAF
...
### Step 14: Node 14999 (Nested Loop)
...
### Step 18: Node 14995 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 14996, 15004, 15005, 15006, 15007, 15008
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2479
