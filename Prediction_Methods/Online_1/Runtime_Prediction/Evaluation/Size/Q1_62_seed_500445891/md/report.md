...
Node 541 (Aggregate) - ROOT
  Node 542 (Gather Merge) [PATTERN: 52c5ec81]
...
|---------|------|-----------|----------------|
| Gather Merge -> Sort -> Aggreg | 52c5ec81 | 542 | 543, 544, 545 |
...
|------|------|--------|-----------|-----|--------|
| 541 | Aggregate | 995.78 | 1035.17 | 4.0% | operator |
| 542 | Gather Merge | 995.74 | 953.93 | 4.2% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 542 (Gather Merge) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 52c5ec81 (Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer))
- **Consumes:** Nodes 543, 544, 545
- **Input Features:**
  ...
  - GatherMerge_startup_cost=169930.1700
  - GatherMerge_total_cost=169933.8000
...
### Step 2: Node 541 (Aggregate) - ROOT
