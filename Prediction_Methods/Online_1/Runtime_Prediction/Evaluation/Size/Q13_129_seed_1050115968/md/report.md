...
```
Node 25587 (Sort) [PATTERN: f592ee11] - ROOT
  Node 25588 (Aggregate) [consumed]
    Node 25589 (Aggregate) [consumed]
      Node 25590 (Hash Join) [consumed]
        Node 25591 (Seq Scan) [consumed] - LEAF
        Node 25592 (Hash) [consumed]
          Node 25593 (Index Only Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Aggregate | f592ee11 | 25587 | 25588, 25589, 25590, 25591, 25592, 25593 |
