...
```
Node 26266 (Sort) [PATTERN: f592ee11] - ROOT
  Node 26267 (Aggregate) [consumed]
    Node 26268 (Aggregate) [consumed]
      Node 26269 (Hash Join) [consumed]
        Node 26270 (Seq Scan) [consumed] - LEAF
        Node 26271 (Hash) [consumed]
          Node 26272 (Index Only Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Aggregate | f592ee11 | 26266 | 26267, 26268, 26269, 26270, 26271, 26272 |
