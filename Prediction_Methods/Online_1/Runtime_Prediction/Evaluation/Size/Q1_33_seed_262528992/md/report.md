...
Node 381 (Aggregate) - ROOT
  Node 382 (Gather Merge) [PATTERN: 52c5ec81]
    Node 383 (Sort) [consumed]
      Node 384 (Aggregate) [consumed]
        Node 385 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Gather Merge -> Sort -> Aggreg | 52c5ec81 | 382 | 383, 384, 385 |
...
|------|------|--------|-----------|-----|--------|
| 381 | Aggregate | 953.73 | 1035.16 | 8.5% | operator |
| 382 | Gather Merge | 953.70 | 953.93 | 0.0% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 382 (Gather Merge) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 52c5ec81 (Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer))
- **Consumes:** Nodes 383, 384, 385
- **Input Features:**
  ...
  - GatherMerge_startup_cost=169601.3800
  - GatherMerge_total_cost=169605.0100
  - SeqScan_Outer_np=112600
  - SeqScan_Outer_nt=1171373
  - SeqScan_Outer_nt1=0
  - SeqScan_Outer_nt2=0
  - SeqScan_Outer_parallel_workers=0
  - SeqScan_Outer_plan_width=25
  - SeqScan_Outer_reltuples=6001215.0000
  - SeqScan_Outer_sel=0.1952
  ...
  - Sort_Outer_startup_cost=168601.3100
  - Sort_Outer_total_cost=168601.3200
- **Output:** st=949.34, rt=953.93

### Step 2: Node 381 (Aggregate) - ROOT
