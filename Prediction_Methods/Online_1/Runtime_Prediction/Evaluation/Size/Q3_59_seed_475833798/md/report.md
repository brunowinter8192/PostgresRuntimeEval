    ...
    Node 5393 (Aggregate) [consumed]
      Node 5394 (Gather) [consumed]
        Node 5395 (Nested Loop)
          Node 5396 (Hash Join) [PATTERN: f4cb205a]
            Node 5397 (Seq Scan) [consumed] - LEAF
            Node 5398 (Hash) [consumed]
              Node 5399 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5391 | 5392, 5393, 5394, 5396, 5397, 5398, 5399 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 5396 | 5391, 5392, 5393, 5394, 5397, 5398, 5399 |
...
| 5395 | Nested Loop | 1167.88 | 1121.33 | 4.0% | operator |
| 5396 | Hash Join | 209.31 | 219.79 | 5.0% | pattern |
| 5400 | Index Scan | 0.03 | -0.02 | 171.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5396 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 5391, 5392, 5393, 5394, 5397, 5398, 5399
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46566
  - HashJoin_nt1=231734
...
- **Output:** st=30.51, rt=219.79

### Step 2: Node 5400 (Index Scan) - LEAF
...
- **Output:** st=29.74, rt=1121.33

### Step 4: Node 5391 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5392, 5393, 5394, 5396, 5397, 5398, 5399
- **Input Features:**
