...
Node 26672 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26673 (Gather) [consumed]
    Node 26674 (Aggregate) [consumed]
      Node 26675 (Hash Join) [PATTERN: f4cb205a]
        Node 26676 (Seq Scan) [consumed] - LEAF
        Node 26677 (Hash) [consumed]
          Node 26678 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 26675 | 26672, 26673, 26674, 26676, 26677, 26678 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26672 | 26673, 26674, 26675, 26676, 26677, 26678 |
...
| 26675 | Hash Join | 806.47 | 397.20 | 50.7% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26675 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 26672, 26673, 26674, 26676, 26677, 26678
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14779
  - HashJoin_nt1=14779
  ...
  - HashJoin_total_cost=136645.4400
  - Hash_Inner_np=0
  - Hash_Inner_nt=83333
...
- **Output:** st=44.65, rt=397.20

### Step 2: Node 26672 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26673, 26674, 26675, 26676, 26677, 26678
- **Input Features:**
