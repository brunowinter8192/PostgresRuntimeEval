...
```
Node 25902 (Sort) [PATTERN: f592ee11] - ROOT
  Node 25903 (Aggregate) [consumed]
    Node 25904 (Aggregate) [consumed]
      Node 25905 (Hash Join) [consumed]
        Node 25906 (Seq Scan) [consumed] - LEAF
        Node 25907 (Hash) [consumed]
          Node 25908 (Index Only Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Aggregate | f592ee11 | 25902 | 25903, 25904, 25905, 25906, 25907, 25908 |
