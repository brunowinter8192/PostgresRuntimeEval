...
```
Node 6362 (Aggregate) [PATTERN: 2724c080] - ROOT
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 6364 | 6362, 6363, 6365 |
| Aggregate -> Gather Merge (Out | 2724c080 | 6362 | 6363, 6364, 6365 |
...
|------|------|--------|-----------|-----|--------|
| 6362 | Aggregate | 1052.29 | 1078.96 | 2.5% | pattern |
...
### Step 5: Node 6362 (Aggregate) - PATTERN ROOT
