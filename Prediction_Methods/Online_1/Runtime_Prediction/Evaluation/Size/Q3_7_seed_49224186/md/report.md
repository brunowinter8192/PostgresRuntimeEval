    ...
    Node 5623 (Aggregate) [consumed]
      Node 5624 (Gather) [consumed]
        Node 5625 (Nested Loop)
          Node 5626 (Hash Join) [PATTERN: f4cb205a]
            Node 5627 (Seq Scan) [consumed] - LEAF
            Node 5628 (Hash) [consumed]
              Node 5629 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 5621 | 5622, 5623, 5624, 5626, 5627, 5628, 5629 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 5626 | 5621, 5622, 5623, 5624, 5627, 5628, 5629 |
...
| 5625 | Nested Loop | 1164.81 | 1122.01 | 3.7% | operator |
| 5626 | Hash Join | 207.74 | 219.13 | 5.5% | pattern |
| 5630 | Index Scan | 0.03 | -0.02 | 171.3% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 5626 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 5621, 5622, 5623, 5624, 5627, 5628, 5629
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46998
  - HashJoin_nt1=235242
...
- **Output:** st=30.30, rt=219.13

### Step 2: Node 5630 (Index Scan) - LEAF
...
- **Output:** st=30.36, rt=1122.01

### Step 4: Node 5621 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 5622, 5623, 5624, 5626, 5627, 5628, 5629
- **Input Features:**
