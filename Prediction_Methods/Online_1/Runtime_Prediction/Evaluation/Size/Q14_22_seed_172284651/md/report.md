...
**Test Query:** Q14_22_seed_172284651
**Timestamp:** 2026-01-01 18:01:26
...
```
Node 26868 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26869 (Gather) [consumed]
    Node 26870 (Aggregate) [consumed]
      Node 26871 (Hash Join) [PATTERN: f4cb205a]
        Node 26872 (Seq Scan) [consumed] - LEAF
        Node 26873 (Hash) [consumed]
          Node 26874 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 26871 | 26868, 26869, 26870, 26872, 26873, 26874 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26868 | 26869, 26870, 26871, 26872, 26873, 26874 |
...
|------|------|--------|-----------|-----|--------|
| 26868 | Aggregate | 826.67 | 834.72 | 1.0% | pattern |
| 26871 | Hash Join | 804.96 | 397.27 | 50.6% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26871 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 26868, 26869, 26870, 26872, 26873, 26874
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14320
  - HashJoin_nt1=14320
  ...
  - HashJoin_total_cost=136644.2300
  - Hash_Inner_np=0
  - Hash_Inner_nt=83333
...
- **Output:** st=44.69, rt=397.27

### Step 2: Node 26868 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26869, 26870, 26871, 26872, 26873, 26874
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=1
  - Aggregate_Outer_nt1=14320
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=64
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0001
  - Aggregate_Outer_startup_cost=136894.8400
  - Aggregate_Outer_total_cost=136894.8500
  - Aggregate_np=0
  - Aggregate_nt=1
  - Aggregate_nt1=5
  - Aggregate_nt2=0
  ...
  - Aggregate_startup_cost=137895.4000
  - Aggregate_total_cost=137895.4200
  - Gather_Outer_np=0
  - Gather_Outer_nt=5
  - Gather_Outer_nt1=1
  - Gather_Outer_nt2=0
  ...
  - Gather_Outer_startup_cost=137894.8400
  - Gather_Outer_total_cost=137895.3500
