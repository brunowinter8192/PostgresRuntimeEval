...
```
Node 14236 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 14237 (Gather Merge) [consumed]
    Node 14238 (Sort)
          ...
          Node 14241 (Hash Join)
            Node 14242 (Nested Loop)
              Node 14243 (Hash Join)
                ...
                Node 14245 (Hash) [PATTERN: 444761fb]
                  Node 14246 (Hash Join) [consumed]
                    Node 14247 (Seq Scan) [consumed] - LEAF
                    Node 14248 (Hash) [consumed]
                      Node 14249 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 14245 | 14236, 14237, 14246, 14247, 14248, 14249 |
| Aggregate -> Gather Merge (Out | 2724c080 | 14236 | 14237, 14245, 14246, 14247, 14248, 14249 |
...
|------|------|--------|-----------|-----|--------|
| 14236 | Aggregate | 1277.42 | 1180.59 | 7.6% | pattern |
| 14238 | Sort | 1271.86 | 1087.88 | 14.5% | operator |
| 14239 | Hash Join | 1271.62 | 1055.47 | 17.0% | operator |
| 14240 | Nested Loop | 1271.31 | 1105.65 | 13.0% | operator |
| 14257 | Hash | 0.02 | 14.54 | 85427.7% | operator |
| 14241 | Hash Join | 1267.44 | 1027.32 | 18.9% | operator |
...
| 14243 | Hash Join | 230.14 | 226.59 | 1.5% | operator |
...
| 14245 | Hash | 35.95 | 36.08 | 0.4% | pattern |
...
### Step 4: Node 14244 (Seq Scan) - LEAF
...
### Step 5: Node 14245 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 14236, 14237, 14246, 14247, 14248, 14249
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 14253 (Index Scan) - LEAF
...
### Step 8: Node 14255 (Seq Scan) - LEAF
...
### Step 12: Node 14256 (Index Scan) - LEAF
...
### Step 13: Node 14258 (Seq Scan) - LEAF
...
### Step 14: Node 14240 (Nested Loop)
...
### Step 18: Node 14236 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 14237, 14245, 14246, 14247, 14248, 14249
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2347
  - Aggregate_nt1=2347
  ...
  - Aggregate_total_cost=71913.9400
  - GatherMerge_Outer_np=0
  - GatherMerge_Outer_nt=2347
  - GatherMerge_Outer_nt1=757
  ...
  - GatherMerge_Outer_sel=3.1004
  - GatherMerge_Outer_startup_cost=71542.4000
  - GatherMerge_Outer_total_cost=71820.0600
- **Output:** st=1178.10, rt=1180.59
