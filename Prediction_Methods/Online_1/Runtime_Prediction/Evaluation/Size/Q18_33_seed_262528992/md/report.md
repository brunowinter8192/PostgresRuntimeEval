...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | fd858367 | 30036 | 30037, 30038, 30039 |
...
| 30040 | Incremental Sort | 2922.34 | 2910.23 | 0.4% | operator |
...
| 30043 | Sort | 2854.66 | 1098.75 | 61.5% | operator |
| 30049 | Sort | 65.22 | 1014.60 | 1455.6% | operator |
| 30044 | Hash Join | 2854.65 | 773.67 | 72.9% | operator |
| 30050 | Seq Scan | 52.21 | 25.47 | 51.2% | operator |
| 30045 | Seq Scan | 183.12 | 187.11 | 2.2% | operator |
| 30046 | Hash | 2643.85 | 255.35 | 90.3% | operator |
...
### Step 3: Node 30045 (Seq Scan) - LEAF
...
### Step 6: Node 30050 (Seq Scan) - LEAF
...
### Step 10: Node 30051 (Index Scan) - LEAF
...
### Step 11: Node 30041 (Nested Loop)
...
### Step 12: Node 30040 (Incremental Sort)
...
### Step 13: Node 30036 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** fd858367 (Limit -> Sort -> Aggregate -> Gather Merge (Outer) (Outer) (Outer))
- **Consumes:** Nodes 30037, 30038, 30039
- **Input Features:**
