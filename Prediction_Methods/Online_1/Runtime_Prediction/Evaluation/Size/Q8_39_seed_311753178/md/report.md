...
```
Node 15087 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 15088 (Gather Merge) [consumed]
    Node 15089 (Sort)
          ...
          Node 15092 (Hash Join)
            Node 15093 (Nested Loop)
              Node 15094 (Hash Join)
                ...
                Node 15096 (Hash) [PATTERN: 444761fb]
                  Node 15097 (Hash Join) [consumed]
                    Node 15098 (Seq Scan) [consumed] - LEAF
                    Node 15099 (Hash) [consumed]
                      Node 15100 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 15096 | 15087, 15088, 15097, 15098, 15099, 15100 |
| Aggregate -> Gather Merge (Out | 2724c080 | 15087 | 15088, 15096, 15097, 15098, 15099, 15100 |
...
|------|------|--------|-----------|-----|--------|
| 15087 | Aggregate | 1230.50 | 1178.83 | 4.2% | pattern |
| 15089 | Sort | 1225.25 | 1087.88 | 11.2% | operator |
| 15090 | Hash Join | 1225.02 | 1055.47 | 13.8% | operator |
| 15091 | Nested Loop | 1224.72 | 1105.66 | 9.7% | operator |
| 15108 | Hash | 0.01 | 14.54 | 111744.0% | operator |
| 15092 | Hash Join | 1221.07 | 1027.32 | 15.9% | operator |
...
| 15094 | Hash Join | 218.88 | 226.59 | 3.5% | operator |
...
| 15096 | Hash | 40.28 | 36.08 | 10.4% | pattern |
...
### Step 4: Node 15095 (Seq Scan) - LEAF
...
### Step 5: Node 15096 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 15087, 15088, 15097, 15098, 15099, 15100
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 15104 (Index Scan) - LEAF
...
### Step 8: Node 15106 (Seq Scan) - LEAF
...
### Step 12: Node 15107 (Index Scan) - LEAF
...
### Step 13: Node 15109 (Seq Scan) - LEAF
...
### Step 14: Node 15091 (Nested Loop)
...
### Step 18: Node 15087 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 15088, 15096, 15097, 15098, 15099, 15100
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2435
