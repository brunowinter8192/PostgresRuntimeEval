          ...
          Node 8006 (Hash Join)
            Node 8007 (Nested Loop)
              Node 8008 (Hash Join)
                ...
                Node 8010 (Hash) [PATTERN: 7df893ad]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 8014 | 8001, 8002, 8010, 8011, 8015, 8016, 8017 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 8001 | 8002, 8010, 8011, 8014, 8015, 8016, 8017 |
| Hash -> Hash Join (Outer) | 7df893ad | 8010 | 8001, 8002, 8011, 8014, 8015, 8016, 8017 |
...
- **Consumes:** Nodes 8001, 8002, 8010, 8011, 8015, 8016, 8017
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
### Step 2: Node 8012 (Seq Scan) - LEAF
...
- **Consumes:** Nodes 8001, 8002, 8011, 8014, 8015, 8016, 8017
- **Input Features:**
  - HashJoin_Outer_np=0
...
- **Output:** st=49.41, rt=1106.77

### Step 12: Node 8005 (Sort)
...
### Step 14: Node 8003 (Gather Merge)
...
### Step 15: Node 8001 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 8002, 8010, 8011, 8014, 8015, 8016, 8017
- **Input Features:**
