...
Node 411 (Aggregate) - ROOT
  Node 412 (Gather Merge) [PATTERN: 52c5ec81]
...
|---------|------|-----------|----------------|
| Gather Merge -> Sort -> Aggreg | 52c5ec81 | 412 | 413, 414, 415 |
...
|------|------|--------|-----------|-----|--------|
| 411 | Aggregate | 992.08 | 1035.17 | 4.3% | operator |
| 412 | Gather Merge | 992.03 | 953.93 | 3.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 412 (Gather Merge) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 52c5ec81 (Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer))
- **Consumes:** Nodes 413, 414, 415
- **Input Features:**
  ...
  - GatherMerge_startup_cost=170010.3900
  - GatherMerge_total_cost=170014.0200
...
### Step 2: Node 411 (Aggregate) - ROOT
