                ...
                Node 8290 (Hash) [consumed]
                  Node 8291 (Hash Join) [PATTERN: 895c6e8c]
                    ...
                    Node 8293 (Hash) [consumed]
                      Node 8294 (Hash Join) [PATTERN: f4cb205a]
                        Node 8295 (Seq Scan) [consumed] - LEAF
                        Node 8296 (Hash) [consumed]
                          Node 8297 (Seq Scan) [consumed] - LEAF
              Node 8298 (Index Scan) - LEAF
            Node 8299 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 8294 | 8281, 8282, 8286, 8287, 8288, 8289, 8290, 8291, 8292, 8293, 8295, 8296, 8297, 8299 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 8288 | 8281, 8282, 8286, 8287, 8289, 8290, 8291, 8292, 8293, 8294, 8295, 8296, 8297, 8299 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 8291 | 8281, 8282, 8286, 8287, 8288, 8289, 8290, 8292, 8293, 8294, 8295, 8296, 8297, 8299 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 8281 | 8282, 8286, 8287, 8288, 8289, 8290, 8291, 8292, 8293, 8294, 8295, 8296, 8297, 8299 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 8286 | 8281, 8282, 8287, 8288, 8289, 8290, 8291, 8292, 8293, 8294, 8295, 8296, 8297, 8299 |
...
|------|------|--------|-----------|-----|--------|
| 8281 | Sort | 1085.22 | 1080.15 | 0.5% | pattern |
| 8283 | Gather Merge | 1085.20 | 1124.35 | 3.6% | operator |
| 8284 | Aggregate | 1079.81 | 1019.65 | 5.6% | operator |
| 8285 | Sort | 1079.54 | 1073.13 | 0.6% | operator |
| 8286 | Hash Join | 1079.04 | 1080.65 | 0.1% | pattern |
| 8288 | Hash Join | 212.86 | 259.80 | 22.1% | pattern |
| 8298 | Index Scan | 0.07 | -0.03 | 134.4% | operator |
| 8300 | Seq Scan | 3.17 | 10.62 | 234.6% | operator |
| 8291 | Hash Join | 33.03 | 84.97 | 157.3% | pattern |
| 8294 | Hash Join | 0.06 | 11.62 | 18049.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 8294 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 8281, 8282, 8286, 8287, 8288, 8289, 8290, 8291, 8292, 8293, 8295, 8296, 8297, 8299
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
### Step 2: Node 8291 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 8281, 8282, 8286, 8287, 8288, 8289, 8290, 8292, 8293, 8294, 8295, 8296, 8297, 8299
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=12500
  - HashJoin_nt1=62500
...
### Step 3: Node 8288 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 8281, 8282, 8286, 8287, 8289, 8290, 8291, 8292, 8293, 8294, 8295, 8296, 8297, 8299
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14884
  - HashJoin_nt1=74418
...
### Step 4: Node 8298 (Index Scan) - LEAF
...
### Step 5: Node 8300 (Seq Scan) - LEAF
...
### Step 6: Node 8286 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 8281, 8282, 8287, 8288, 8289, 8290, 8291, 8292, 8293, 8294, 8295, 8296, 8297, 8299
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=2382
  - HashJoin_nt1=59546
...
### Step 10: Node 8281 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 8282, 8286, 8287, 8288, 8289, 8290, 8291, 8292, 8293, 8294, 8295, 8296, 8297, 8299
- **Input Features:**
