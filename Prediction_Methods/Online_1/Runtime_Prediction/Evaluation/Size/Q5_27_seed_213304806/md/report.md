...
**Test Query:** Q5_27_seed_213304806
  ...
  Node 8282 (Aggregate)
    Node 8283 (Gather Merge)
      Node 8284 (Aggregate)
        Node 8285 (Sort)
          Node 8286 (Hash Join)
            Node 8287 (Nested Loop)
              Node 8288 (Hash Join)
                Node 8289 (Seq Scan) - LEAF
                Node 8290 (Hash)
                  Node 8291 (Hash Join)
                    Node 8292 (Seq Scan) - LEAF
                    Node 8293 (Hash)
                      Node 8294 (Hash Join)
                        Node 8295 (Seq Scan) - LEAF
                        Node 8296 (Hash)
                          Node 8297 (Seq Scan) - LEAF
              Node 8298 (Index Scan) - LEAF
            Node 8299 (Hash)
              Node 8300 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 8281 | Sort | 1085.22 | 1104.24 | 1.8% | operator |
| 8282 | Aggregate | 1085.21 | 1057.87 | 2.5% | operator |
| 8283 | Gather Merge | 1085.20 | 1124.35 | 3.6% | operator |
| 8284 | Aggregate | 1079.81 | 1019.89 | 5.5% | operator |
| 8285 | Sort | 1079.54 | 1074.66 | 0.5% | operator |
| 8286 | Hash Join | 1079.04 | 1107.14 | 2.6% | operator |
| 8287 | Nested Loop | 1067.24 | 1102.69 | 3.3% | operator |
| 8299 | Hash | 3.65 | 14.79 | 305.4% | operator |
| 8288 | Hash Join | 212.86 | 234.18 | 10.0% | operator |
| 8298 | Index Scan | 0.07 | -0.03 | 134.4% | operator |
| 8300 | Seq Scan | 3.17 | 10.62 | 234.6% | operator |
| 8289 | Seq Scan | 166.19 | 161.95 | 2.5% | operator |
| 8290 | Hash | 33.84 | 21.31 | 37.0% | operator |
| 8291 | Hash Join | 33.03 | 62.87 | 90.4% | operator |
| 8292 | Seq Scan | 31.59 | 24.87 | 21.3% | operator |
| 8293 | Hash | 0.07 | 16.80 | 24969.5% | operator |
| 8294 | Hash Join | 0.06 | 142.84 | 223093.6% | operator |
| 8295 | Seq Scan | 0.01 | 10.49 | 149824.7% | operator |
| 8296 | Hash | 0.05 | 16.01 | 31301.8% | operator |
| 8297 | Seq Scan | 0.05 | 21.39 | 44462.4% | operator |
...
### Step 2: Node 8295 (Seq Scan) - LEAF
...
### Step 5: Node 8292 (Seq Scan) - LEAF
...
### Step 8: Node 8289 (Seq Scan) - LEAF
...
### Step 11: Node 8298 (Index Scan) - LEAF
...
### Step 12: Node 8300 (Seq Scan) - LEAF
...
### Step 18: Node 8283 (Gather Merge)
