          ...
          Node 8286 (Hash Join)
            Node 8287 (Nested Loop)
              Node 8288 (Hash Join)
                ...
                Node 8290 (Hash) [PATTERN: 7df893ad]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 8294 | 8281, 8282, 8290, 8291, 8295, 8296, 8297 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 8281 | 8282, 8290, 8291, 8294, 8295, 8296, 8297 |
| Hash -> Hash Join (Outer) | 7df893ad | 8290 | 8281, 8282, 8291, 8294, 8295, 8296, 8297 |
...
- **Consumes:** Nodes 8281, 8282, 8290, 8291, 8295, 8296, 8297
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
### Step 2: Node 8292 (Seq Scan) - LEAF
...
- **Consumes:** Nodes 8281, 8282, 8291, 8294, 8295, 8296, 8297
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 14: Node 8283 (Gather Merge)
...
### Step 15: Node 8281 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 8282, 8290, 8291, 8294, 8295, 8296, 8297
- **Input Features:**
