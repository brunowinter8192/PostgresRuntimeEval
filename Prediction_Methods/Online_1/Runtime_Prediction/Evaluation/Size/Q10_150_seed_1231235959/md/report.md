...
```
Node 20085 (Limit) [PATTERN: 04a01b61] - ROOT
  Node 20086 (Sort) [consumed]
    Node 20087 (Aggregate) [consumed]
      Node 20088 (Gather) [consumed]
        Node 20089 (Hash Join) [consumed]
          Node 20090 (Hash Join) [PATTERN: 2e0f44ef]
            Node 20091 (Nested Loop) [consumed]
              Node 20092 (Seq Scan) - LEAF
              Node 20093 (Index Scan) - LEAF
            Node 20094 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 20085 | 20086, 20087, 20088, 20089, 20090, 20091, 20094 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 20090 | 20085, 20086, 20087, 20088, 20089, 20091, 20094 |
...
|------|------|--------|-----------|-----|--------|
| 20085 | Limit | 1162.61 | 1151.15 | 1.0% | pattern |
| 20090 | Hash Join | 1102.09 | 1101.67 | 0.0% | pattern |
...
### Step 4: Node 20097 (Seq Scan) - LEAF
...
### Step 5: Node 20090 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 20085, 20086, 20087, 20088, 20089, 20091, 20094
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=17964
  - HashJoin_nt1=17964
...
### Step 7: Node 20085 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 20086, 20087, 20088, 20089, 20090, 20091, 20094
- **Input Features:**
