...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | fd858367 | 30868 | 30869, 30870, 30871 |
...
| 30872 | Incremental Sort | 2928.99 | 2910.23 | 0.6% | operator |
...
| 30875 | Sort | 2875.10 | 1098.75 | 61.8% | operator |
| 30881 | Sort | 68.88 | 1014.60 | 1372.9% | operator |
| 30876 | Hash Join | 2875.09 | 773.67 | 73.1% | operator |
| 30882 | Seq Scan | 57.48 | 25.47 | 55.7% | operator |
| 30877 | Seq Scan | 201.92 | 187.11 | 7.3% | operator |
| 30878 | Hash | 2643.06 | 255.35 | 90.3% | operator |
...
### Step 3: Node 30877 (Seq Scan) - LEAF
...
### Step 6: Node 30882 (Seq Scan) - LEAF
...
### Step 10: Node 30883 (Index Scan) - LEAF
...
### Step 11: Node 30873 (Nested Loop)
...
### Step 12: Node 30872 (Incremental Sort)
...
### Step 13: Node 30868 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** fd858367 (Limit -> Sort -> Aggregate -> Gather Merge (Outer) (Outer) (Outer))
- **Consumes:** Nodes 30869, 30870, 30871
- **Input Features:**
