...
Node 26602 (Aggregate) [PATTERN: a5f39f08] - ROOT
  Node 26603 (Gather) [consumed]
    Node 26604 (Aggregate) [consumed]
      Node 26605 (Hash Join) [PATTERN: f4cb205a]
        Node 26606 (Seq Scan) [consumed] - LEAF
        Node 26607 (Hash) [consumed]
          Node 26608 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 26605 | 26602, 26603, 26604, 26606, 26607, 26608 |
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26602 | 26603, 26604, 26605, 26606, 26607, 26608 |
...
| 26605 | Hash Join | 818.66 | 397.02 | 51.5% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 26605 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 26602, 26603, 26604, 26606, 26607, 26608
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=15692
  - HashJoin_nt1=15692
  ...
  - HashJoin_total_cost=136647.8300
  - Hash_Inner_np=0
  - Hash_Inner_nt=83333
...
- **Output:** st=44.57, rt=397.02

### Step 2: Node 26602 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26603, 26604, 26605, 26606, 26607, 26608
- **Input Features:**
