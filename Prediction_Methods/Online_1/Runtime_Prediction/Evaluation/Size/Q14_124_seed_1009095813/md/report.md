...
```
Node 26602 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 26602 | 26603, 26604, 26605, 26606, 26607 |
...
|------|------|--------|-----------|-----|--------|
| 26602 | Aggregate | 841.29 | 825.95 | 1.8% | pattern |
...
- **Consumes:** Nodes 26603, 26604, 26605, 26606, 26607
- **Input Features:**
