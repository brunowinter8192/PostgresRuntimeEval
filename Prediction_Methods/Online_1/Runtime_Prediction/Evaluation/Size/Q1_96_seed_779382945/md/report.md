...
Node 726 (Aggregate) - ROOT
  Node 727 (Gather Merge) [PATTERN: 52c5ec81]
    Node 728 (Sort) [consumed]
      Node 729 (Aggregate) [consumed]
        Node 730 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Gather Merge -> Sort -> Aggreg | 52c5ec81 | 727 | 728, 729, 730 |
...
|------|------|--------|-----------|-----|--------|
| 726 | Aggregate | 933.13 | 1035.16 | 10.9% | operator |
| 727 | Gather Merge | 933.09 | 953.93 | 2.2% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 727 (Gather Merge) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 52c5ec81 (Gather Merge -> Sort -> Aggregate -> Seq Scan (Outer) (Outer) (Outer))
- **Consumes:** Nodes 728, 729, 730
- **Input Features:**
  ...
  - GatherMerge_startup_cost=169825.9400
  - GatherMerge_total_cost=169829.5700
  - SeqScan_Outer_np=112600
  - SeqScan_Outer_nt=1177789
  - SeqScan_Outer_nt1=0
  - SeqScan_Outer_nt2=0
  - SeqScan_Outer_parallel_workers=0
  - SeqScan_Outer_plan_width=25
  - SeqScan_Outer_reltuples=6001215.0000
  - SeqScan_Outer_sel=0.1963
  ...
  - Sort_Outer_startup_cost=168825.8700
  - Sort_Outer_total_cost=168825.8800
- **Output:** st=949.34, rt=953.93

### Step 2: Node 726 (Aggregate) - ROOT
