...
```
Node 26483 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 26483 | 26484, 26485, 26486, 26487, 26488 |
...
|------|------|--------|-----------|-----|--------|
| 26483 | Aggregate | 810.16 | 825.95 | 1.9% | pattern |
...
- **Consumes:** Nodes 26484, 26485, 26486, 26487, 26488
- **Input Features:**
