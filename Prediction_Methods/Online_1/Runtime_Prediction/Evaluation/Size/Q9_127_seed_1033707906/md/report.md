...
Node 17176 (Sort) - ROOT
  Node 17177 (Aggregate) [PATTERN: 0405d50f]
    Node 17178 (Gather) [consumed]
      Node 17179 (Aggregate) [consumed]
        Node 17180 (Nested Loop) [consumed]
          Node 17181 (Hash Join)
            Node 17182 (Seq Scan) - LEAF
            Node 17183 (Hash) [PATTERN: 7df893ad]
              Node 17184 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 0405d50f | 17177 | 17178, 17179, 17180, 17183, 17184, 17185, 17186, 17189 |
| Hash -> Hash Join (Outer) | 7df893ad | 17183 | 17177, 17178, 17179, 17180, 17184, 17185, 17186, 17189 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 17185 | 17177, 17178, 17179, 17180, 17183, 17184, 17186, 17189 |
...
|------|------|--------|-----------|-----|--------|
| 17176 | Sort | 1192.85 | 1159.31 | 2.8% | operator |
| 17177 | Aggregate | 1192.71 | 1194.84 | 0.2% | pattern |
| 17181 | Hash Join | 969.26 | 831.42 | 14.2% | operator |
| 17193 | Index Scan | 0.00 | -0.04 | 1512.7% | operator |
| 17182 | Seq Scan | 688.93 | 565.06 | 18.0% | operator |
| 17183 | Hash | 182.35 | 48.85 | 73.2% | pattern |
...
- **Consumes:** Nodes 17177, 17178, 17179, 17180, 17183, 17184, 17186, 17189
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18037
  - HashJoin_nt1=18037
...
### Step 7: Node 17182 (Seq Scan) - LEAF
...
### Step 8: Node 17183 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 7df893ad (Hash -> Hash Join (Outer))
- **Consumes:** Nodes 17177, 17178, 17179, 17180, 17184, 17185, 17186, 17189
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17193 (Index Scan) - LEAF
...
### Step 11: Node 17177 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 0405d50f (Aggregate -> Gather -> Aggregate -> Nested Loop (Outer) (Outer) (Outer))
- **Consumes:** Nodes 17178, 17179, 17180, 17183, 17184, 17185, 17186, 17189
- **Input Features:**
