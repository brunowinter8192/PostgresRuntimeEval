...
```
Node 26504 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 26504 | 26505, 26506, 26507, 26508, 26509 |
...
|------|------|--------|-----------|-----|--------|
| 26504 | Aggregate | 821.06 | 825.95 | 0.6% | pattern |
...
- **Consumes:** Nodes 26505, 26506, 26507, 26508, 26509
- **Input Features:**
