...
```
Node 9761 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 9762 (Aggregate) [consumed]
    Node 9763 (Gather Merge)
      Node 9764 (Aggregate)
        Node 9765 (Sort)
          Node 9766 (Hash Join) [PATTERN: 2e0f44ef]
            Node 9767 (Nested Loop) [consumed]
              Node 9768 (Hash Join) [PATTERN: 895c6e8c]
                Node 9769 (Seq Scan) [consumed] - LEAF
                Node 9770 (Hash) [consumed]
                  Node 9771 (Hash Join) [PATTERN: 895c6e8c]
                    Node 9772 (Seq Scan) [consumed] - LEAF
                    Node 9773 (Hash) [consumed]
                      Node 9774 (Hash Join) [PATTERN: f4cb205a]
                        Node 9775 (Seq Scan) [consumed] - LEAF
                        Node 9776 (Hash) [consumed]
                          Node 9777 (Seq Scan) [consumed] - LEAF
              Node 9778 (Index Scan) - LEAF
            Node 9779 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 9774 | 9761, 9762, 9766, 9767, 9768, 9769, 9770, 9771, 9772, 9773, 9775, 9776, 9777, 9779 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 9768 | 9761, 9762, 9766, 9767, 9769, 9770, 9771, 9772, 9773, 9774, 9775, 9776, 9777, 9779 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 9771 | 9761, 9762, 9766, 9767, 9768, 9769, 9770, 9772, 9773, 9774, 9775, 9776, 9777, 9779 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 9761 | 9762, 9766, 9767, 9768, 9769, 9770, 9771, 9772, 9773, 9774, 9775, 9776, 9777, 9779 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 9766 | 9761, 9762, 9767, 9768, 9769, 9770, 9771, 9772, 9773, 9774, 9775, 9776, 9777, 9779 |
...
|------|------|--------|-----------|-----|--------|
| 9761 | Sort | 1074.29 | 1080.12 | 0.5% | pattern |
| 9763 | Gather Merge | 1074.27 | 1124.38 | 4.7% | operator |
| 9764 | Aggregate | 1067.29 | 1019.77 | 4.5% | operator |
| 9765 | Sort | 1067.04 | 1073.09 | 0.6% | operator |
| 9766 | Hash Join | 1066.55 | 1080.06 | 1.3% | pattern |
| 9768 | Hash Join | 216.38 | 259.85 | 20.1% | pattern |
| 9778 | Index Scan | 0.07 | -0.03 | 134.4% | operator |
| 9780 | Seq Scan | 1.36 | 10.62 | 681.8% | operator |
| 9771 | Hash Join | 32.57 | 84.97 | 160.9% | pattern |
| 9774 | Hash Join | 0.07 | 11.62 | 16982.1% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 9774 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 9761, 9762, 9766, 9767, 9768, 9769, 9770, 9771, 9772, 9773, 9775, 9776, 9777, 9779
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
### Step 2: Node 9771 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 9761, 9762, 9766, 9767, 9768, 9769, 9770, 9772, 9773, 9774, 9775, 9776, 9777, 9779
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=12500
  - HashJoin_nt1=62500
...
### Step 3: Node 9768 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 9761, 9762, 9766, 9767, 9769, 9770, 9771, 9772, 9773, 9774, 9775, 9776, 9777, 9779
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14612
  - HashJoin_nt1=73059
  ...
  - HashJoin_total_cost=38472.0100
  - Hash_Inner_np=0
  - Hash_Inner_nt=12500
  ...
  - SeqScan_Outer_nt=73059
  - SeqScan_Outer_nt1=0
  - SeqScan_Outer_nt2=0
  - SeqScan_Outer_parallel_workers=0
  - SeqScan_Outer_plan_width=8
  - SeqScan_Outer_reltuples=1500000.0000
  - SeqScan_Outer_sel=0.0487
  - SeqScan_Outer_startup_cost=0.0000
  - SeqScan_Outer_total_cost=33394.0600
- **Output:** st=36.18, rt=259.85

### Step 4: Node 9778 (Index Scan) - LEAF
...
### Step 5: Node 9780 (Seq Scan) - LEAF
...
### Step 6: Node 9766 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 9761, 9762, 9767, 9768, 9769, 9770, 9771, 9772, 9773, 9774, 9775, 9776, 9777, 9779
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=2338
  - HashJoin_nt1=58459
  ...
  - NestedLoop_Outer_nt=58459
  - NestedLoop_Outer_nt1=14612
...
- **Output:** st=41.64, rt=1080.06

### Step 7: Node 9765 (Sort)
...
- **Output:** st=1072.17, rt=1073.09

### Step 8: Node 9764 (Aggregate)
...
- **Output:** st=1017.79, rt=1019.77

### Step 9: Node 9763 (Gather Merge)
...
### Step 10: Node 9761 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 9762, 9766, 9767, 9768, 9769, 9770, 9771, 9772, 9773, 9774, 9775, 9776, 9777, 9779
- **Input Features:**
