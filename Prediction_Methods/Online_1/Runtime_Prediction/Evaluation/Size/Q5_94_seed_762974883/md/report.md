          ...
          Node 9766 (Hash Join)
            Node 9767 (Nested Loop)
              Node 9768 (Hash Join)
                ...
                Node 9770 (Hash) [PATTERN: 7df893ad]
                  Node 9771 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 9774 | 9761, 9762, 9770, 9771, 9775, 9776, 9777 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 9761 | 9762, 9770, 9771, 9774, 9775, 9776, 9777 |
| Hash -> Hash Join (Outer) | 7df893ad | 9770 | 9761, 9762, 9771, 9774, 9775, 9776, 9777 |
...
| 9766 | Hash Join | 1066.55 | 1106.63 | 3.8% | operator |
| 9767 | Nested Loop | 1056.50 | 1102.44 | 4.3% | operator |
| 9779 | Hash | 1.85 | 14.79 | 698.9% | operator |
| 9768 | Hash Join | 216.38 | 234.53 | 8.4% | operator |
| 9778 | Index Scan | 0.07 | -0.03 | 134.4% | operator |
| 9780 | Seq Scan | 1.36 | 10.62 | 681.8% | operator |
| 9769 | Seq Scan | 169.37 | 161.94 | 4.4% | operator |
| 9770 | Hash | 33.47 | 39.26 | 17.3% | pattern |
| 9772 | Seq Scan | 31.15 | 24.87 | 20.1% | operator |
| 9773 | Hash | 0.07 | 14.60 | 20762.7% | operator |
...
- **Consumes:** Nodes 9761, 9762, 9770, 9771, 9775, 9776, 9777
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
### Step 2: Node 9772 (Seq Scan) - LEAF
...
### Step 4: Node 9769 (Seq Scan) - LEAF
...
### Step 5: Node 9770 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 7df893ad (Hash -> Hash Join (Outer))
- **Consumes:** Nodes 9761, 9762, 9771, 9774, 9775, 9776, 9777
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 7: Node 9778 (Index Scan) - LEAF
...
### Step 8: Node 9780 (Seq Scan) - LEAF
...
- **Output:** st=42.49, rt=1102.44

### Step 10: Node 9779 (Hash)
...
- **Output:** st=49.37, rt=1106.63

### Step 12: Node 9765 (Sort)
...
### Step 14: Node 9763 (Gather Merge)
...
### Step 15: Node 9761 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 9762, 9770, 9771, 9774, 9775, 9776, 9777
- **Input Features:**
