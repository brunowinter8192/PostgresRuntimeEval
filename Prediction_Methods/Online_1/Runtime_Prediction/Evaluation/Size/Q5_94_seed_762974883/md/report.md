...
**Test Query:** Q5_94_seed_762974883
**Timestamp:** 2025-12-22 05:29:00
...
Node 9761 (Sort) - ROOT
  Node 9762 (Aggregate)
    Node 9763 (Gather Merge)
      Node 9764 (Aggregate)
        Node 9765 (Sort)
          Node 9766 (Hash Join)
            Node 9767 (Nested Loop)
              Node 9768 (Hash Join)
                Node 9769 (Seq Scan) - LEAF
                Node 9770 (Hash)
                  Node 9771 (Hash Join)
                    Node 9772 (Seq Scan) - LEAF
                    Node 9773 (Hash)
                      Node 9774 (Hash Join)
                        Node 9775 (Seq Scan) - LEAF
                        Node 9776 (Hash)
                          Node 9777 (Seq Scan) - LEAF
              Node 9778 (Index Scan) - LEAF
            Node 9779 (Hash)
              Node 9780 (Seq Scan) - LEAF
```
...
|------|------|--------|-----------|-----|--------|
| 9761 | Sort | 1074.29 | 1104.23 | 2.8% | operator |
| 9762 | Aggregate | 1074.28 | 1057.98 | 1.5% | operator |
| 9763 | Gather Merge | 1074.27 | 1124.38 | 4.7% | operator |
| 9764 | Aggregate | 1067.29 | 1020.01 | 4.4% | operator |
| 9765 | Sort | 1067.04 | 1074.62 | 0.7% | operator |
| 9766 | Hash Join | 1066.55 | 1106.62 | 3.8% | operator |
| 9767 | Nested Loop | 1056.50 | 1102.43 | 4.3% | operator |
| 9779 | Hash | 1.85 | 14.79 | 698.9% | operator |
| 9768 | Hash Join | 216.38 | 234.19 | 8.2% | operator |
| 9778 | Index Scan | 0.07 | -0.03 | 134.4% | operator |
| 9780 | Seq Scan | 1.36 | 10.62 | 681.8% | operator |
| 9769 | Seq Scan | 169.37 | 161.94 | 4.4% | operator |
| 9770 | Hash | 33.47 | 21.31 | 36.3% | operator |
| 9771 | Hash Join | 32.57 | 62.87 | 93.0% | operator |
| 9772 | Seq Scan | 31.15 | 24.87 | 20.1% | operator |
| 9773 | Hash | 0.07 | 16.80 | 23895.1% | operator |
| 9774 | Hash Join | 0.07 | 142.84 | 209964.6% | operator |
| 9775 | Seq Scan | 0.01 | 10.49 | 131084.1% | operator |
| 9776 | Hash | 0.05 | 16.01 | 30697.9% | operator |
| 9777 | Seq Scan | 0.05 | 21.39 | 42679.9% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 9777 (Seq Scan) - LEAF
...
### Step 2: Node 9775 (Seq Scan) - LEAF
...
### Step 5: Node 9772 (Seq Scan) - LEAF
...
### Step 8: Node 9769 (Seq Scan) - LEAF
...
### Step 11: Node 9778 (Index Scan) - LEAF
...
### Step 12: Node 9780 (Seq Scan) - LEAF
...
### Step 18: Node 9763 (Gather Merge)
