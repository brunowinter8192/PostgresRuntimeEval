          ...
          Node 7146 (Hash Join)
            Node 7147 (Nested Loop)
              Node 7148 (Hash Join)
                ...
                Node 7150 (Hash) [PATTERN: 7df893ad]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 7154 | 7141, 7142, 7150, 7151, 7155, 7156, 7157 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 7141 | 7142, 7150, 7151, 7154, 7155, 7156, 7157 |
| Hash -> Hash Join (Outer) | 7df893ad | 7150 | 7141, 7142, 7151, 7154, 7155, 7156, 7157 |
...
- **Consumes:** Nodes 7141, 7142, 7150, 7151, 7155, 7156, 7157
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
### Step 2: Node 7152 (Seq Scan) - LEAF
...
- **Consumes:** Nodes 7141, 7142, 7151, 7154, 7155, 7156, 7157
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 14: Node 7143 (Gather Merge)
...
### Step 15: Node 7141 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 7142, 7150, 7151, 7154, 7155, 7156, 7157
- **Input Features:**
