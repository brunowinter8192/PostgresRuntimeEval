...
```
Node 31731 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 31731 | 31732, 31733, 31734, 31735, 31736 |
...
|------|------|--------|-----------|-----|--------|
| 31731 | Aggregate | 847.41 | 841.26 | 0.7% | pattern |
...
- **Consumes:** Nodes 31732, 31733, 31734, 31735, 31736
- **Input Features:**
