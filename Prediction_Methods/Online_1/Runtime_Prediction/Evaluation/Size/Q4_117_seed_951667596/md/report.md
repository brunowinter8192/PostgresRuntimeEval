...
```
Node 5977 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 5978 (Gather Merge) [consumed]
    Node 5979 (Sort) [PATTERN: 1d35fb97]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 5979 | 5977, 5978, 5980 |
| Aggregate -> Gather Merge (Out | 2724c080 | 5977 | 5978, 5979, 5980 |
...
|------|------|--------|-----------|-----|--------|
| 5977 | Aggregate | 1038.30 | 1078.98 | 3.9% | pattern |
| 5979 | Sort | 1033.53 | 1055.47 | 2.1% | pattern |
...
### Step 4: Node 5979 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 5977, 5978, 5980
- **Input Features:**
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=65819.0800
  - Sort_total_cost=65819.0900
- **Output:** st=1054.30, rt=1055.47

### Step 5: Node 5977 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 5978, 5979, 5980
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=5
  - Aggregate_nt1=15
