...
```
Node 16444 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 16445 (Gather Merge) [consumed]
    Node 16446 (Sort)
          ...
          Node 16449 (Hash Join)
            Node 16450 (Nested Loop)
              Node 16451 (Hash Join)
                ...
                Node 16453 (Hash) [PATTERN: 444761fb]
                  Node 16454 (Hash Join) [consumed]
                    Node 16455 (Seq Scan) [consumed] - LEAF
                    Node 16456 (Hash) [consumed]
                      Node 16457 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 16453 | 16444, 16445, 16454, 16455, 16456, 16457 |
| Aggregate -> Gather Merge (Out | 2724c080 | 16444 | 16445, 16453, 16454, 16455, 16456, 16457 |
...
|------|------|--------|-----------|-----|--------|
| 16444 | Aggregate | 1228.15 | 1174.59 | 4.4% | pattern |
...
| 16449 | Hash Join | 1219.09 | 1027.33 | 15.7% | operator |
...
| 16451 | Hash Join | 210.79 | 226.59 | 7.5% | operator |
...
| 16453 | Hash | 36.12 | 36.08 | 0.1% | pattern |
...
### Step 4: Node 16452 (Seq Scan) - LEAF
...
### Step 5: Node 16453 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 16444, 16445, 16454, 16455, 16456, 16457
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 16461 (Index Scan) - LEAF
...
### Step 8: Node 16463 (Seq Scan) - LEAF
...
### Step 12: Node 16464 (Index Scan) - LEAF
...
### Step 13: Node 16466 (Seq Scan) - LEAF
...
### Step 14: Node 16448 (Nested Loop)
...
### Step 18: Node 16444 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 16445, 16453, 16454, 16455, 16456, 16457
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2406
  - Aggregate_nt1=2508
  ...
  - Aggregate_total_cost=71956.7300
  - GatherMerge_Outer_np=0
  - GatherMerge_Outer_nt=2508
  - GatherMerge_Outer_nt1=809
  ...
  - GatherMerge_Outer_total_cost=71858.4500
- **Output:** st=1172.12, rt=1174.59
