...
Node 16996 (Sort) - ROOT
  Node 16997 (Aggregate) [PATTERN: 0405d50f]
    Node 16998 (Gather) [consumed]
      Node 16999 (Aggregate) [consumed]
        Node 17000 (Nested Loop) [consumed]
          Node 17001 (Hash Join)
            Node 17002 (Seq Scan) - LEAF
            Node 17003 (Hash) [PATTERN: 7df893ad]
              Node 17004 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 0405d50f | 16997 | 16998, 16999, 17000, 17003, 17004, 17005, 17006, 17009 |
| Hash -> Hash Join (Outer) | 7df893ad | 17003 | 16997, 16998, 16999, 17000, 17004, 17005, 17006, 17009 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 17005 | 16997, 16998, 16999, 17000, 17003, 17004, 17006, 17009 |
...
|------|------|--------|-----------|-----|--------|
| 16996 | Sort | 1243.15 | 1159.60 | 6.7% | operator |
| 16997 | Aggregate | 1243.02 | 1194.84 | 3.9% | pattern |
| 17001 | Hash Join | 1024.52 | 831.54 | 18.8% | operator |
| 17013 | Index Scan | 0.00 | -0.04 | 1512.7% | operator |
| 17002 | Seq Scan | 736.80 | 565.06 | 23.3% | operator |
| 17003 | Hash | 193.99 | 49.39 | 74.5% | pattern |
...
- **Consumes:** Nodes 16997, 16998, 16999, 17000, 17003, 17004, 17006, 17009
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18703
  - HashJoin_nt1=18703
...
### Step 7: Node 17002 (Seq Scan) - LEAF
...
### Step 8: Node 17003 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 7df893ad (Hash -> Hash Join (Outer))
- **Consumes:** Nodes 16997, 16998, 16999, 17000, 17004, 17005, 17006, 17009
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17013 (Index Scan) - LEAF
...
### Step 11: Node 16997 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 0405d50f (Aggregate -> Gather -> Aggregate -> Nested Loop (Outer) (Outer) (Outer))
- **Consumes:** Nodes 16998, 16999, 17000, 17003, 17004, 17005, 17006, 17009
- **Input Features:**
