...
```
Node 18065 (Sort) - ROOT
  Node 18066 (Aggregate) [PATTERN: 0405d50f]
    Node 18067 (Gather) [consumed]
      Node 18068 (Aggregate) [consumed]
        Node 18069 (Nested Loop) [consumed]
          Node 18070 (Hash Join)
            Node 18071 (Seq Scan) - LEAF
            Node 18072 (Hash) [PATTERN: 7df893ad]
              Node 18073 (Hash Join) [consumed]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 0405d50f | 18066 | 18067, 18068, 18069, 18072, 18073, 18074, 18075, 18078 |
| Hash -> Hash Join (Outer) | 7df893ad | 18072 | 18066, 18067, 18068, 18069, 18073, 18074, 18075, 18078 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 18074 | 18066, 18067, 18068, 18069, 18072, 18073, 18075, 18078 |
...
|------|------|--------|-----------|-----|--------|
| 18065 | Sort | 1163.70 | 1158.15 | 0.5% | operator |
| 18066 | Aggregate | 1163.57 | 1194.89 | 2.7% | pattern |
| 18070 | Hash Join | 944.29 | 831.01 | 12.0% | operator |
| 18082 | Index Scan | 0.00 | -0.04 | 1512.7% | operator |
| 18071 | Seq Scan | 683.76 | 565.06 | 17.4% | operator |
| 18072 | Hash | 166.26 | 47.20 | 71.6% | pattern |
...
- **Consumes:** Nodes 18066, 18067, 18068, 18069, 18072, 18073, 18075, 18078
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=16032
  - HashJoin_nt1=16032
...
### Step 7: Node 18071 (Seq Scan) - LEAF
...
### Step 8: Node 18072 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 7df893ad (Hash -> Hash Join (Outer))
- **Consumes:** Nodes 18066, 18067, 18068, 18069, 18073, 18074, 18075, 18078
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 18082 (Index Scan) - LEAF
...
### Step 11: Node 18066 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 0405d50f (Aggregate -> Gather -> Aggregate -> Nested Loop (Outer) (Outer) (Outer))
- **Consumes:** Nodes 18067, 18068, 18069, 18072, 18073, 18074, 18075, 18078
- **Input Features:**
