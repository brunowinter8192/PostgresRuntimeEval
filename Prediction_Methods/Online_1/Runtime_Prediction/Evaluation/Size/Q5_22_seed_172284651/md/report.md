          ...
          Node 8186 (Hash Join)
            Node 8187 (Nested Loop)
              Node 8188 (Hash Join)
                ...
                Node 8190 (Hash) [PATTERN: 7df893ad]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 8194 | 8181, 8182, 8190, 8191, 8195, 8196, 8197 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 8181 | 8182, 8190, 8191, 8194, 8195, 8196, 8197 |
| Hash -> Hash Join (Outer) | 7df893ad | 8190 | 8181, 8182, 8191, 8194, 8195, 8196, 8197 |
...
- **Consumes:** Nodes 8181, 8182, 8190, 8191, 8195, 8196, 8197
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
### Step 2: Node 8192 (Seq Scan) - LEAF
...
- **Consumes:** Nodes 8181, 8182, 8191, 8194, 8195, 8196, 8197
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 14: Node 8183 (Gather Merge)
...
### Step 15: Node 8181 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 8182, 8190, 8191, 8194, 8195, 8196, 8197
- **Input Features:**
