    ...
    Node 4803 (Aggregate) [consumed]
      Node 4804 (Gather) [consumed]
        Node 4805 (Nested Loop)
          Node 4806 (Hash Join) [PATTERN: f4cb205a]
            Node 4807 (Seq Scan) [consumed] - LEAF
            Node 4808 (Hash) [consumed]
              Node 4809 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4801 | 4802, 4803, 4804, 4806, 4807, 4808, 4809 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 4806 | 4801, 4802, 4803, 4804, 4807, 4808, 4809 |
...
| 4805 | Nested Loop | 1184.30 | 1121.12 | 5.3% | operator |
| 4806 | Hash Join | 217.08 | 219.43 | 1.1% | pattern |
| 4810 | Index Scan | 0.03 | -0.02 | 168.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4806 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 4801, 4802, 4803, 4804, 4807, 4808, 4809
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46440
  - HashJoin_nt1=234136
...
- **Output:** st=30.46, rt=219.43

### Step 2: Node 4810 (Index Scan) - LEAF
...
- **Output:** st=29.57, rt=1121.12

### Step 4: Node 4801 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4802, 4803, 4804, 4806, 4807, 4808, 4809
- **Input Features:**
