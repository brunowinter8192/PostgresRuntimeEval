    ...
    Node 21023 (Aggregate) [consumed]
      Node 21024 (Gather) [consumed]
        Node 21025 (Hash Join) [consumed]
          Node 21026 (Hash Join) [PATTERN: 2e0f44ef]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 04a01b61 | 21021 | 21022, 21023, 21024, 21025, 21026, 21027, 21030 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 21026 | 21021, 21022, 21023, 21024, 21025, 21027, 21030 |
...
| 21026 | Hash Join | 1085.75 | 1101.75 | 1.5% | pattern |
...
### Step 4: Node 21033 (Seq Scan) - LEAF
...
### Step 5: Node 21026 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 21021, 21022, 21023, 21024, 21025, 21027, 21030
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=18240
  - HashJoin_nt1=18240
...
### Step 7: Node 21021 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 04a01b61 (Limit -> Sort -> Aggregate -> Gather -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 21022, 21023, 21024, 21025, 21026, 21027, 21030
- **Input Features:**
