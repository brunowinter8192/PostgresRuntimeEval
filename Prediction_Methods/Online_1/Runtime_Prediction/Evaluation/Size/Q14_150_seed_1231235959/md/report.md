...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | a5f39f08 | 26805 | 26806, 26807 |
...
| 26808 | Hash Join | 810.15 | 788.24 | 2.7% | operator |
| 26809 | Seq Scan | 754.71 | 747.90 | 0.9% | operator |
| 26810 | Hash | 47.31 | 21.25 | 55.1% | operator |
| 26811 | Seq Scan | 42.46 | 16.56 | 61.0% | operator |
...
- **Input Features:**
  ...
  - total_cost=136646.7500
- **Output:** st=49.30, rt=788.24

### Step 5: Node 26805 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** a5f39f08 (Aggregate -> Gather -> Aggregate (Outer) (Outer))
- **Consumes:** Nodes 26806, 26807
- **Input Features:**
