...
```
Node 10429 (Aggregate) [PATTERN: dd3706ac] - ROOT
  Node 10430 (Gather) [consumed]
    Node 10431 (Aggregate) [consumed]
      Node 10432 (Seq Scan) [consumed] - LEAF
```
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | dd3706ac | 10429 | 10430, 10431, 10432 |
...
|------|------|--------|-----------|-----|--------|
| 10429 | Aggregate | 788.66 | 791.26 | 0.3% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 10429 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** dd3706ac (Aggregate -> Gather -> Aggregate -> Seq Scan (Outer) (Outer) (Outer))
- **Consumes:** Nodes 10430, 10431, 10432
- **Input Features:**
