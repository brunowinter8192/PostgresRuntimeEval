...
```
Node 27421 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 27421 | 27422, 27423, 27424, 27425, 27426 |
...
|------|------|--------|-----------|-----|--------|
| 27421 | Aggregate | 849.73 | 825.94 | 2.8% | pattern |
...
- **Consumes:** Nodes 27422, 27423, 27424, 27425, 27426
- **Input Features:**
