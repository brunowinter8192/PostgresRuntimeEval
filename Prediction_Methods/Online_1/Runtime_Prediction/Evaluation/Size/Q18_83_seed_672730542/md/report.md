  ...
  Node 30917 (Sort) [consumed]
    Node 30918 (Aggregate) [consumed]
      Node 30919 (Gather Merge) [consumed]
        Node 30920 (Incremental Sort)
          Node 30921 (Nested Loop)
            Node 30922 (Merge Join)
              Node 30923 (Sort)
                Node 30924 (Hash Join)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | fd858367 | 30916 | 30917, 30918, 30919 |
...
| 30920 | Incremental Sort | 2926.70 | 2910.23 | 0.6% | operator |
...
| 30923 | Sort | 2854.95 | 1098.75 | 61.5% | operator |
| 30929 | Sort | 68.75 | 1014.60 | 1375.7% | operator |
| 30924 | Hash Join | 2854.94 | 773.67 | 72.9% | operator |
| 30930 | Seq Scan | 54.90 | 25.47 | 53.6% | operator |
| 30925 | Seq Scan | 200.10 | 187.11 | 6.5% | operator |
| 30926 | Hash | 2625.07 | 255.35 | 90.3% | operator |
...
### Step 3: Node 30925 (Seq Scan) - LEAF
...
### Step 6: Node 30930 (Seq Scan) - LEAF
...
### Step 10: Node 30931 (Index Scan) - LEAF
...
### Step 11: Node 30921 (Nested Loop)
...
### Step 12: Node 30920 (Incremental Sort)
...
### Step 13: Node 30916 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** fd858367 (Limit -> Sort -> Aggregate -> Gather Merge (Outer) (Outer) (Outer))
- **Consumes:** Nodes 30917, 30918, 30919
- **Input Features:**
