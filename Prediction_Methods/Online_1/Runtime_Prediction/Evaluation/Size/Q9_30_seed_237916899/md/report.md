    ...
    Node 17975 (Gather) [consumed]
      Node 17976 (Aggregate) [consumed]
        Node 17977 (Hash Join) [consumed]
          ...
          Node 17979 (Hash)
            Node 17980 (Hash Join) [PATTERN: 895c6e8c]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather -> | 8951754f | 17973 | 17974, 17975, 17976, 17977, 17980, 17981, 17982, 17984, 17985, 17988 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 17980 | 17973, 17974, 17975, 17976, 17977, 17981, 17982, 17984, 17985, 17988 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 17984 | 17973, 17974, 17975, 17976, 17977, 17980, 17981, 17982, 17985, 17988 |
...
| 17979 | Hash | 1039.74 | 133.45 | 87.2% | operator |
| 17980 | Hash Join | 1022.10 | 735.03 | 28.1% | pattern |
...
- **Consumes:** Nodes 17973, 17974, 17975, 17976, 17977, 17980, 17981, 17982, 17985, 17988
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=22712
  - HashJoin_nt1=22712
...
### Step 8: Node 17980 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 17973, 17974, 17975, 17976, 17977, 17981, 17982, 17984, 17985, 17988
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=81779
  ...
  - HashJoin_reltuples=0.0000
  - HashJoin_sel=0.0000
  - HashJoin_startup_cost=16186.0900
  - HashJoin_total_cost=149790.4800
  - Hash_Inner_np=0
  - Hash_Inner_nt=22712
...
- **Output:** st=176.02, rt=735.03

### Step 9: Node 17978 (Seq Scan) - LEAF
...
- **Output:** st=133.45, rt=133.45

### Step 11: Node 17973 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 8951754f (Sort -> Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 17974, 17975, 17976, 17977, 17980, 17981, 17982, 17984, 17985, 17988
- **Input Features:**
