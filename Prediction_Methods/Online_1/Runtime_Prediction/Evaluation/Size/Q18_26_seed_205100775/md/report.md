  ...
  Node 29909 (Sort) [consumed]
    Node 29910 (Aggregate) [consumed]
      Node 29911 (Gather Merge) [consumed]
        Node 29912 (Incremental Sort)
          Node 29913 (Nested Loop)
            Node 29914 (Merge Join)
              Node 29915 (Sort)
                Node 29916 (Hash Join)
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | fd858367 | 29908 | 29909, 29910, 29911 |
...
| 29912 | Incremental Sort | 2868.10 | 2910.23 | 1.5% | operator |
...
| 29915 | Sort | 2818.31 | 1098.75 | 61.0% | operator |
| 29921 | Sort | 64.04 | 1014.60 | 1484.4% | operator |
| 29916 | Hash Join | 2818.29 | 773.67 | 72.5% | operator |
| 29922 | Seq Scan | 53.18 | 25.47 | 52.1% | operator |
| 29917 | Seq Scan | 199.21 | 187.11 | 6.1% | operator |
| 29918 | Hash | 2590.56 | 255.35 | 90.1% | operator |
...
### Step 3: Node 29917 (Seq Scan) - LEAF
...
### Step 6: Node 29922 (Seq Scan) - LEAF
...
### Step 10: Node 29923 (Index Scan) - LEAF
...
### Step 11: Node 29913 (Nested Loop)
...
### Step 12: Node 29912 (Incremental Sort)
...
### Step 13: Node 29908 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** fd858367 (Limit -> Sort -> Aggregate -> Gather Merge (Outer) (Outer) (Outer))
- **Consumes:** Nodes 29909, 29910, 29911
- **Input Features:**
