...
Node 17811 (Sort) - ROOT
  Node 17812 (Aggregate) [PATTERN: 0405d50f]
      ...
      Node 17814 (Aggregate) [consumed]
        Node 17815 (Nested Loop) [consumed]
          Node 17816 (Hash Join)
            ...
            Node 17818 (Hash) [PATTERN: 7df893ad]
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 0405d50f | 17812 | 17813, 17814, 17815, 17818, 17819, 17820, 17821, 17824 |
| Hash -> Hash Join (Outer) | 7df893ad | 17818 | 17812, 17813, 17814, 17815, 17819, 17820, 17821, 17824 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 17820 | 17812, 17813, 17814, 17815, 17818, 17819, 17821, 17824 |
...
|------|------|--------|-----------|-----|--------|
| 17811 | Sort | 1193.64 | 1157.57 | 3.0% | operator |
| 17812 | Aggregate | 1193.50 | 1194.93 | 0.1% | pattern |
| 17816 | Hash Join | 979.98 | 830.87 | 15.2% | operator |
| 17828 | Index Scan | 0.00 | -0.04 | 1512.7% | operator |
| 17817 | Seq Scan | 702.61 | 565.06 | 19.6% | operator |
| 17818 | Hash | 182.72 | 46.65 | 74.5% | pattern |
...
- **Consumes:** Nodes 17812, 17813, 17814, 17815, 17818, 17819, 17821, 17824
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=15363
  - HashJoin_nt1=15363
...
### Step 7: Node 17817 (Seq Scan) - LEAF
...
### Step 8: Node 17818 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 7df893ad (Hash -> Hash Join (Outer))
- **Consumes:** Nodes 17812, 17813, 17814, 17815, 17819, 17820, 17821, 17824
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 10: Node 17828 (Index Scan) - LEAF
...
### Step 11: Node 17812 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 0405d50f (Aggregate -> Gather -> Aggregate -> Nested Loop (Outer) (Outer) (Outer))
- **Consumes:** Nodes 17813, 17814, 17815, 17818, 17819, 17820, 17821, 17824
- **Input Features:**
