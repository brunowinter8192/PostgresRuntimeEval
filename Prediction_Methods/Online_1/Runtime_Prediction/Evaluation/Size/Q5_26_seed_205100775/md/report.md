...
```
Node 8261 (Sort) [PATTERN: 1d35fb97] - ROOT
  Node 8262 (Aggregate) [consumed]
    Node 8263 (Gather Merge)
      Node 8264 (Aggregate)
        Node 8265 (Sort)
          Node 8266 (Hash Join) [PATTERN: 2e0f44ef]
            Node 8267 (Nested Loop) [consumed]
              Node 8268 (Hash Join) [PATTERN: 895c6e8c]
                Node 8269 (Seq Scan) [consumed] - LEAF
                Node 8270 (Hash) [consumed]
                  Node 8271 (Hash Join) [PATTERN: 895c6e8c]
                    Node 8272 (Seq Scan) [consumed] - LEAF
                    Node 8273 (Hash) [consumed]
                      Node 8274 (Hash Join) [PATTERN: f4cb205a]
                        Node 8275 (Seq Scan) [consumed] - LEAF
                        Node 8276 (Hash) [consumed]
                          Node 8277 (Seq Scan) [consumed] - LEAF
              Node 8278 (Index Scan) - LEAF
            Node 8279 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 8274 | 8261, 8262, 8266, 8267, 8268, 8269, 8270, 8271, 8272, 8273, 8275, 8276, 8277, 8279 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 8268 | 8261, 8262, 8266, 8267, 8269, 8270, 8271, 8272, 8273, 8274, 8275, 8276, 8277, 8279 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 8271 | 8261, 8262, 8266, 8267, 8268, 8269, 8270, 8272, 8273, 8274, 8275, 8276, 8277, 8279 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 8261 | 8262, 8266, 8267, 8268, 8269, 8270, 8271, 8272, 8273, 8274, 8275, 8276, 8277, 8279 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 8266 | 8261, 8262, 8267, 8268, 8269, 8270, 8271, 8272, 8273, 8274, 8275, 8276, 8277, 8279 |
...
|------|------|--------|-----------|-----|--------|
| 8261 | Sort | 1058.91 | 1080.12 | 2.0% | pattern |
| 8263 | Gather Merge | 1058.89 | 1124.38 | 6.2% | operator |
| 8264 | Aggregate | 1054.20 | 1019.75 | 3.3% | operator |
| 8265 | Sort | 1053.94 | 1073.09 | 1.8% | operator |
| 8266 | Hash Join | 1053.45 | 1080.14 | 2.5% | pattern |
| 8268 | Hash Join | 210.27 | 259.84 | 23.6% | pattern |
| 8278 | Index Scan | 0.07 | -0.03 | 134.4% | operator |
| 8280 | Seq Scan | 5.81 | 10.62 | 82.7% | operator |
| 8271 | Hash Join | 29.50 | 84.97 | 188.0% | pattern |
| 8274 | Hash Join | 0.07 | 11.62 | 15387.8% | pattern |

## Prediction Chain (Bottom-Up)

### Step 1: Node 8274 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 8261, 8262, 8266, 8267, 8268, 8269, 8270, 8271, 8272, 8273, 8275, 8276, 8277, 8279
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
### Step 2: Node 8271 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 8261, 8262, 8266, 8267, 8268, 8269, 8270, 8272, 8273, 8274, 8275, 8276, 8277, 8279
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=12500
  - HashJoin_nt1=62500
...
### Step 3: Node 8268 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 8261, 8262, 8266, 8267, 8269, 8270, 8271, 8272, 8273, 8274, 8275, 8276, 8277, 8279
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=14646
  - HashJoin_nt1=73231
...
### Step 4: Node 8278 (Index Scan) - LEAF
...
### Step 5: Node 8280 (Seq Scan) - LEAF
...
### Step 6: Node 8266 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 8261, 8262, 8267, 8268, 8269, 8270, 8271, 8272, 8273, 8274, 8275, 8276, 8277, 8279
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=2344
  - HashJoin_nt1=58597
...
### Step 10: Node 8261 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 8262, 8266, 8267, 8268, 8269, 8270, 8271, 8272, 8273, 8274, 8275, 8276, 8277, 8279
- **Input Features:**
