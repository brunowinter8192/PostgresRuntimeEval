...
```
Node 17465 (Sort) [PATTERN: 8951754f] - ROOT
    ...
    Node 17467 (Gather) [consumed]
      Node 17468 (Aggregate) [consumed]
        Node 17469 (Hash Join) [consumed]
          ...
          Node 17471 (Hash)
            Node 17472 (Hash Join) [PATTERN: 895c6e8c]
              Node 17473 (Seq Scan) [consumed] - LEAF
              Node 17474 (Hash) [consumed]
                Node 17475 (Hash Join)
                  Node 17476 (Hash Join) [PATTERN: 2e0f44ef]
                    Node 17477 (Nested Loop) [consumed]
                      Node 17478 (Seq Scan) - LEAF
                      Node 17479 (Index Scan) - LEAF
                    Node 17480 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather -> | 8951754f | 17465 | 17466, 17467, 17468, 17469, 17472, 17473, 17474, 17476, 17477, 17480 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 17472 | 17465, 17466, 17467, 17468, 17469, 17473, 17474, 17476, 17477, 17480 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 17476 | 17465, 17466, 17467, 17468, 17469, 17472, 17473, 17474, 17477, 17480 |
...
| 17471 | Hash | 1027.13 | 132.90 | 87.1% | operator |
| 17472 | Hash Join | 1009.45 | 734.87 | 27.2% | pattern |
| 17475 | Hash Join | 203.95 | 821.43 | 302.8% | operator |
| 17476 | Hash Join | 188.01 | 981.29 | 421.9% | pattern |
...
### Step 4: Node 17483 (Seq Scan) - LEAF
...
### Step 5: Node 17476 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2e0f44ef (Hash Join -> [Nested Loop (Outer), Hash (Inner)])
- **Consumes:** Nodes 17465, 17466, 17467, 17468, 17469, 17472, 17473, 17474, 17477, 17480
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=22043
  - HashJoin_nt1=22043
...
### Step 8: Node 17472 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 17465, 17466, 17467, 17468, 17469, 17473, 17474, 17476, 17477, 17480
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=79372
  ...
  - HashJoin_reltuples=0.0000
  - HashJoin_sel=0.0000
  - HashJoin_startup_cost=16028.8800
  - HashJoin_total_cost=149633.2600
  - Hash_Inner_np=0
  - Hash_Inner_nt=22043
...
- **Output:** st=176.05, rt=734.87

### Step 9: Node 17470 (Seq Scan) - LEAF
...
- **Output:** st=132.90, rt=132.90

### Step 11: Node 17465 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 8951754f (Sort -> Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 17466, 17467, 17468, 17469, 17472, 17473, 17474, 17476, 17477, 17480
- **Input Features:**
