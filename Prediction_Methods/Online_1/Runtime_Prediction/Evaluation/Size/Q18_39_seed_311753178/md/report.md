...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | fd858367 | 30132 | 30133, 30134, 30135 |
...
| 30136 | Incremental Sort | 2935.74 | 2910.23 | 0.9% | operator |
...
| 30139 | Sort | 2867.88 | 1098.75 | 61.7% | operator |
| 30145 | Sort | 65.27 | 1014.60 | 1454.4% | operator |
| 30140 | Hash Join | 2867.86 | 773.67 | 73.0% | operator |
| 30146 | Seq Scan | 53.60 | 25.47 | 52.5% | operator |
| 30141 | Seq Scan | 208.99 | 187.11 | 10.5% | operator |
| 30142 | Hash | 2629.99 | 255.35 | 90.3% | operator |
...
### Step 3: Node 30141 (Seq Scan) - LEAF
...
### Step 6: Node 30146 (Seq Scan) - LEAF
...
### Step 10: Node 30147 (Index Scan) - LEAF
...
### Step 11: Node 30137 (Nested Loop)
...
### Step 12: Node 30136 (Incremental Sort)
...
### Step 13: Node 30132 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** fd858367 (Limit -> Sort -> Aggregate -> Gather Merge (Outer) (Outer) (Outer))
- **Consumes:** Nodes 30133, 30134, 30135
- **Input Features:**
