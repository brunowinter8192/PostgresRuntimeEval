          ...
          Node 9726 (Hash Join)
            Node 9727 (Nested Loop)
              Node 9728 (Hash Join)
                ...
                Node 9730 (Hash) [PATTERN: 7df893ad]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 9734 | 9721, 9722, 9730, 9731, 9735, 9736, 9737 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 9721 | 9722, 9730, 9731, 9734, 9735, 9736, 9737 |
| Hash -> Hash Join (Outer) | 7df893ad | 9730 | 9721, 9722, 9731, 9734, 9735, 9736, 9737 |
...
| 9726 | Hash Join | 1049.93 | 1106.63 | 5.4% | operator |
| 9727 | Nested Loop | 1038.23 | 1102.44 | 6.2% | operator |
| 9739 | Hash | 2.74 | 14.79 | 439.3% | operator |
| 9728 | Hash Join | 217.04 | 234.53 | 8.1% | operator |
| 9738 | Index Scan | 0.07 | -0.03 | 135.4% | operator |
| 9740 | Seq Scan | 2.22 | 10.62 | 378.0% | operator |
| 9729 | Seq Scan | 168.39 | 161.94 | 3.8% | operator |
| 9730 | Hash | 33.42 | 39.26 | 17.4% | pattern |
| 9732 | Seq Scan | 30.88 | 24.87 | 19.5% | operator |
| 9733 | Hash | 0.36 | 14.60 | 3901.1% | operator |
...
- **Consumes:** Nodes 9721, 9722, 9730, 9731, 9735, 9736, 9737
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
### Step 2: Node 9732 (Seq Scan) - LEAF
...
- **Consumes:** Nodes 9721, 9722, 9731, 9734, 9735, 9736, 9737
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 14: Node 9723 (Gather Merge)
...
### Step 15: Node 9721 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 9722, 9730, 9731, 9734, 9735, 9736, 9737
- **Input Features:**
