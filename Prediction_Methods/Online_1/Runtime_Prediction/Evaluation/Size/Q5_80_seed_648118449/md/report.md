          ...
          Node 9466 (Hash Join)
            Node 9467 (Nested Loop)
              Node 9468 (Hash Join)
                ...
                Node 9470 (Hash) [PATTERN: 7df893ad]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 9474 | 9461, 9462, 9470, 9471, 9475, 9476, 9477 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 9461 | 9462, 9470, 9471, 9474, 9475, 9476, 9477 |
| Hash -> Hash Join (Outer) | 7df893ad | 9470 | 9461, 9462, 9471, 9474, 9475, 9476, 9477 |
...
- **Consumes:** Nodes 9461, 9462, 9470, 9471, 9475, 9476, 9477
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
### Step 2: Node 9472 (Seq Scan) - LEAF
...
- **Consumes:** Nodes 9461, 9462, 9471, 9474, 9475, 9476, 9477
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 14: Node 9463 (Gather Merge)
...
### Step 15: Node 9461 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 9462, 9470, 9471, 9474, 9475, 9476, 9477
- **Input Features:**
