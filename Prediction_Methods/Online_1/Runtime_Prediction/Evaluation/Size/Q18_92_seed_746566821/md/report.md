...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | fd858367 | 31076 | 31077, 31078, 31079 |
...
| 31080 | Incremental Sort | 2917.52 | 2910.23 | 0.2% | operator |
...
| 31083 | Sort | 2849.36 | 1098.75 | 61.4% | operator |
| 31089 | Sort | 65.42 | 1014.60 | 1450.8% | operator |
| 31084 | Hash Join | 2849.34 | 773.67 | 72.8% | operator |
| 31090 | Seq Scan | 53.33 | 25.47 | 52.2% | operator |
| 31085 | Seq Scan | 200.59 | 187.11 | 6.7% | operator |
| 31086 | Hash | 2620.73 | 255.35 | 90.3% | operator |
...
### Step 3: Node 31085 (Seq Scan) - LEAF
...
### Step 6: Node 31090 (Seq Scan) - LEAF
...
### Step 10: Node 31091 (Index Scan) - LEAF
...
### Step 11: Node 31081 (Nested Loop)
...
### Step 12: Node 31080 (Incremental Sort)
...
### Step 13: Node 31076 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** fd858367 (Limit -> Sort -> Aggregate -> Gather Merge (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31077, 31078, 31079
- **Input Features:**
