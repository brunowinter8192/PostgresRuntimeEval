...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | fd858367 | 31076 | 31077, 31078, 31079, 31084, 31085, 31086 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 31084 | 31076, 31077, 31078, 31079, 31085, 31086 |
...
- **Consumes:** Nodes 31076, 31077, 31078, 31079, 31085, 31086
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=131527
  - HashJoin_nt1=483871
...
### Step 10: Node 31080 (Incremental Sort)
...
### Step 11: Node 31076 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** fd858367 (Limit -> Sort -> Aggregate -> Gather Merge (Outer) (Outer) (Outer))
- **Consumes:** Nodes 31077, 31078, 31079, 31084, 31085, 31086
- **Input Features:**
