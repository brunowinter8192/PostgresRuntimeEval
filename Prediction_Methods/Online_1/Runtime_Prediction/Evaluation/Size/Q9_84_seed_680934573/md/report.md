    ...
    Node 19045 (Gather) [consumed]
      Node 19046 (Aggregate) [consumed]
        Node 19047 (Hash Join) [consumed]
          ...
          Node 19049 (Hash)
            Node 19050 (Hash Join) [PATTERN: 895c6e8c]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate -> Gather -> | 8951754f | 19043 | 19044, 19045, 19046, 19047, 19050, 19051, 19052, 19054, 19055, 19058 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 19050 | 19043, 19044, 19045, 19046, 19047, 19051, 19052, 19054, 19055, 19058 |
| Hash Join -> [Nested Loop (Out | 2e0f44ef | 19054 | 19043, 19044, 19045, 19046, 19047, 19050, 19051, 19052, 19055, 19058 |
...
| 19049 | Hash | 999.25 | 133.45 | 86.6% | operator |
| 19050 | Hash Join | 981.43 | 735.03 | 25.1% | pattern |
...
- **Consumes:** Nodes 19043, 19044, 19045, 19046, 19047, 19050, 19051, 19052, 19055, 19058
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=22712
  - HashJoin_nt1=22712
...
### Step 8: Node 19050 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 19043, 19044, 19045, 19046, 19047, 19051, 19052, 19054, 19055, 19058
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=81779
...
### Step 9: Node 19048 (Seq Scan) - LEAF
...
### Step 11: Node 19043 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 8951754f (Sort -> Aggregate -> Gather -> Aggregate -> Hash Join (Outer) (Outer) (Outer) (Outer))
- **Consumes:** Nodes 19044, 19045, 19046, 19047, 19050, 19051, 19052, 19054, 19055, 19058
- **Input Features:**
