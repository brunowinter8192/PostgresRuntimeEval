          ...
          Node 16219 (Hash Join)
            Node 16220 (Nested Loop)
              Node 16221 (Hash Join)
                ...
                Node 16223 (Hash) [PATTERN: 444761fb]
                  Node 16224 (Hash Join) [consumed]
                    Node 16225 (Seq Scan) [consumed] - LEAF
                    Node 16226 (Hash) [consumed]
...
|---------|------|-----------|----------------|
| Hash -> Hash Join -> [Seq Scan | 444761fb | 16223 | 16214, 16215, 16224, 16225, 16226, 16227 |
| Aggregate -> Gather Merge (Out | 2724c080 | 16214 | 16215, 16223, 16224, 16225, 16226, 16227 |
...
| 16219 | Hash Join | 1225.29 | 1027.31 | 16.2% | operator |
...
| 16221 | Hash Join | 218.70 | 226.59 | 3.6% | operator |
...
| 16223 | Hash | 39.01 | 36.08 | 7.5% | pattern |
...
### Step 4: Node 16222 (Seq Scan) - LEAF
...
### Step 5: Node 16223 (Hash) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 444761fb (Hash -> Hash Join -> [Seq Scan (Outer), Hash -> Hash Join (Outer) (Inner)] (Outer))
- **Consumes:** Nodes 16214, 16215, 16224, 16225, 16226, 16227
- **Input Features:**
  - HashJoin_Outer_np=0
  - HashJoin_Outer_nt=5
...
### Step 7: Node 16231 (Index Scan) - LEAF
...
### Step 8: Node 16233 (Seq Scan) - LEAF
...
### Step 12: Node 16234 (Index Scan) - LEAF
...
### Step 13: Node 16236 (Seq Scan) - LEAF
...
### Step 14: Node 16218 (Nested Loop)
...
### Step 18: Node 16214 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 16215, 16223, 16224, 16225, 16226, 16227
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=2268
  - Aggregate_nt1=2268
