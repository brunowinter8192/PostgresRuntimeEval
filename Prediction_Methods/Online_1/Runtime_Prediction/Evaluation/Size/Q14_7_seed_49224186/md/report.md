...
```
Node 27309 (Aggregate) [PATTERN: 310134da] - ROOT
...
|---------|------|-----------|----------------|
| Aggregate -> Gather -> Aggrega | 310134da | 27309 | 27310, 27311, 27312, 27313, 27314 |
...
|------|------|--------|-----------|-----|--------|
| 27309 | Aggregate | 818.96 | 825.95 | 0.9% | pattern |
...
- **Consumes:** Nodes 27310, 27311, 27312, 27313, 27314
- **Input Features:**
