          ...
          Node 9546 (Hash Join)
            Node 9547 (Nested Loop)
              Node 9548 (Hash Join)
                ...
                Node 9550 (Hash) [PATTERN: 7df893ad]
...
|---------|------|-----------|----------------|
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 9554 | 9541, 9542, 9550, 9551, 9555, 9556, 9557 |
| Sort -> Aggregate (Outer) | 1d35fb97 | 9541 | 9542, 9550, 9551, 9554, 9555, 9556, 9557 |
| Hash -> Hash Join (Outer) | 7df893ad | 9550 | 9541, 9542, 9551, 9554, 9555, 9556, 9557 |
...
- **Consumes:** Nodes 9541, 9542, 9550, 9551, 9555, 9556, 9557
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=5
  - HashJoin_nt1=25
...
### Step 2: Node 9552 (Seq Scan) - LEAF
...
- **Consumes:** Nodes 9541, 9542, 9551, 9554, 9555, 9556, 9557
- **Input Features:**
  - HashJoin_Outer_np=0
...
### Step 14: Node 9543 (Gather Merge)
...
### Step 15: Node 9541 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 9542, 9550, 9551, 9554, 9555, 9556, 9557
- **Input Features:**
