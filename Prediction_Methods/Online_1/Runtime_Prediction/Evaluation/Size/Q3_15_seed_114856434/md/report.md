    ...
    Node 4913 (Aggregate) [consumed]
      Node 4914 (Gather) [consumed]
        Node 4915 (Nested Loop)
          Node 4916 (Hash Join) [PATTERN: 895c6e8c]
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4911 | 4912, 4913, 4914, 4916, 4917, 4918 |
| Hash Join -> [Seq Scan (Outer) | 895c6e8c | 4916 | 4911, 4912, 4913, 4914, 4917, 4918 |
...
| 4915 | Nested Loop | 1187.84 | 1121.93 | 5.5% | operator |
| 4916 | Hash Join | 210.32 | 256.35 | 21.9% | pattern |
...
### Step 2: Node 4916 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 895c6e8c (Hash Join -> [Seq Scan (Outer), Hash (Inner)])
- **Consumes:** Nodes 4911, 4912, 4913, 4914, 4917, 4918
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46677
  - HashJoin_nt1=231924
...
- **Output:** st=30.01, rt=256.35

### Step 3: Node 4920 (Index Scan) - LEAF
...
- **Output:** st=30.55, rt=1121.93

### Step 5: Node 4911 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4912, 4913, 4914, 4916, 4917, 4918
- **Input Features:**
