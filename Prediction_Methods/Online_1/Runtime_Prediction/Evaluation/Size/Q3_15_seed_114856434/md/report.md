    ...
    Node 4913 (Aggregate) [consumed]
      Node 4914 (Gather) [consumed]
        Node 4915 (Nested Loop)
          Node 4916 (Hash Join) [PATTERN: f4cb205a]
            Node 4917 (Seq Scan) [consumed] - LEAF
            Node 4918 (Hash) [consumed]
              Node 4919 (Seq Scan) [consumed] - LEAF
...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | 25df29b5 | 4911 | 4912, 4913, 4914, 4916, 4917, 4918, 4919 |
| Hash Join -> [Seq Scan (Outer) | f4cb205a | 4916 | 4911, 4912, 4913, 4914, 4917, 4918, 4919 |
...
| 4915 | Nested Loop | 1187.84 | 1121.51 | 5.6% | operator |
| 4916 | Hash Join | 210.32 | 219.74 | 4.5% | pattern |
| 4920 | Index Scan | 0.03 | -0.02 | 168.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 4916 (Hash Join) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** f4cb205a (Hash Join -> [Seq Scan (Outer), Hash -> Seq Scan (Outer) (Inner)])
- **Consumes:** Nodes 4911, 4912, 4913, 4914, 4917, 4918, 4919
- **Input Features:**
  - HashJoin_np=0
  - HashJoin_nt=46677
  - HashJoin_nt1=231924
...
- **Output:** st=30.48, rt=219.74

### Step 2: Node 4920 (Index Scan) - LEAF
...
- **Output:** st=29.90, rt=1121.51

### Step 4: Node 4911 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 25df29b5 (Limit -> Sort -> Aggregate -> Gather (Outer) (Outer) (Outer))
- **Consumes:** Nodes 4912, 4913, 4914, 4916, 4917, 4918, 4919
- **Input Features:**
