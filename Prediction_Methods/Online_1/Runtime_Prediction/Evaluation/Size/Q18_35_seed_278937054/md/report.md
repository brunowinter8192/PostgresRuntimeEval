...
|---------|------|-----------|----------------|
| Limit -> Sort -> Aggregate ->  | fd858367 | 30068 | 30069, 30070, 30071 |
...
| 30072 | Incremental Sort | 2887.70 | 2910.23 | 0.8% | operator |
...
| 30075 | Sort | 2813.63 | 1098.75 | 60.9% | operator |
| 30081 | Sort | 70.70 | 1014.60 | 1335.2% | operator |
| 30076 | Hash Join | 2813.62 | 773.67 | 72.5% | operator |
| 30082 | Seq Scan | 57.97 | 25.47 | 56.1% | operator |
| 30077 | Seq Scan | 196.10 | 187.11 | 4.6% | operator |
| 30078 | Hash | 2588.59 | 255.35 | 90.1% | operator |
...
### Step 3: Node 30077 (Seq Scan) - LEAF
...
### Step 6: Node 30082 (Seq Scan) - LEAF
...
### Step 10: Node 30083 (Index Scan) - LEAF
...
### Step 11: Node 30073 (Nested Loop)
...
### Step 12: Node 30072 (Incremental Sort)
...
### Step 13: Node 30068 (Limit) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** fd858367 (Limit -> Sort -> Aggregate -> Gather Merge (Outer) (Outer) (Outer))
- **Consumes:** Nodes 30069, 30070, 30071
- **Input Features:**
