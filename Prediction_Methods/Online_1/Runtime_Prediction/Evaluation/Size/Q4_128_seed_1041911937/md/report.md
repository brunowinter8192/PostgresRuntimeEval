...
**Test Query:** Q4_128_seed_1041911937
...
```
Node 6061 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 6062 (Gather Merge) [consumed]
    Node 6063 (Sort) [PATTERN: 1d35fb97]
      Node 6064 (Aggregate) [consumed]
        Node 6065 (Nested Loop)
          Node 6066 (Seq Scan) - LEAF
          Node 6067 (Index Scan) - LEAF
```
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 6063 | 6061, 6062, 6064 |
| Aggregate -> Gather Merge (Out | 2724c080 | 6061 | 6062, 6063, 6064 |
...
|------|------|--------|-----------|-----|--------|
| 6061 | Aggregate | 1054.60 | 1078.96 | 2.3% | pattern |
| 6063 | Sort | 1050.00 | 1055.48 | 0.5% | pattern |
| 6065 | Nested Loop | 1047.96 | 1106.65 | 5.6% | operator |
| 6066 | Seq Scan | 164.99 | 157.03 | 4.8% | operator |
| 6067 | Index Scan | 0.06 | 0.38 | 523.7% | operator |

## Prediction Chain (Bottom-Up)

### Step 1: Node 6066 (Seq Scan) - LEAF
...
### Step 2: Node 6067 (Index Scan) - LEAF
...
- **Input Features:**
  ...
  - st2=0.0614
  - startup_cost=0.4300
  - total_cost=65865.2300
- **Output:** st=31.48, rt=1106.65

### Step 4: Node 6063 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 6061, 6062, 6064
- **Input Features:**
  - Aggregate_Outer_np=0
  - Aggregate_Outer_nt=5
  - Aggregate_Outer_nt1=14937
  - Aggregate_Outer_nt2=0
  - Aggregate_Outer_parallel_workers=0
  - Aggregate_Outer_plan_width=24
  - Aggregate_Outer_reltuples=0.0000
  - Aggregate_Outer_sel=0.0003
  - Aggregate_Outer_startup_cost=65939.9100
  - Aggregate_Outer_total_cost=65939.9600
  - Sort_np=0
  - Sort_nt=5
  - Sort_nt1=5
  - Sort_nt2=0
  ...
  - Sort_sel=1.0000
  - Sort_startup_cost=65940.0200
  - Sort_total_cost=65940.0400
- **Output:** st=1054.32, rt=1055.48

### Step 5: Node 6061 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 6062, 6063, 6064
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=5
  - Aggregate_nt1=15
  ...
  - Aggregate_startup_cost=66940.0600
  - Aggregate_total_cost=66941.9600
  ...
  - GatherMerge_Outer_startup_cost=66940.0600
  - GatherMerge_Outer_total_cost=66941.8400
- **Output:** st=1076.42, rt=1078.96
