...
```
Node 6397 (Aggregate) [PATTERN: 2724c080] - ROOT
  Node 6398 (Gather Merge) [consumed]
    Node 6399 (Sort) [PATTERN: 1d35fb97]
...
|---------|------|-----------|----------------|
| Sort -> Aggregate (Outer) | 1d35fb97 | 6399 | 6397, 6398, 6400 |
| Aggregate -> Gather Merge (Out | 2724c080 | 6397 | 6398, 6399, 6400 |
...
|------|------|--------|-----------|-----|--------|
| 6397 | Aggregate | 1060.88 | 1078.94 | 1.7% | pattern |
| 6399 | Sort | 1055.23 | 1055.50 | 0.0% | pattern |
...
### Step 4: Node 6399 (Sort) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 1d35fb97 (Sort -> Aggregate (Outer))
- **Consumes:** Nodes 6397, 6398, 6400
- **Input Features:**
...
### Step 5: Node 6397 (Aggregate) - PATTERN ROOT

- **Source:** pattern
- **Pattern:** 2724c080 (Aggregate -> Gather Merge (Outer))
- **Consumes:** Nodes 6398, 6399, 6400
- **Input Features:**
  - Aggregate_np=0
  - Aggregate_nt=5
  - Aggregate_nt1=15
