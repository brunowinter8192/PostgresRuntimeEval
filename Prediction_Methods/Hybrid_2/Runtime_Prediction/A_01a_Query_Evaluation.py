...
from plot_config import STRATEGY_COLORS, STRATEGY_COLORS_EPSILON, DPI, BAR_FIGSIZE, BAR_WIDTH, BAR_ALPHA, BAR_EDGECOLOR, BAR_LINEWIDTH, BAR_LABEL_FONTSIZE, GRID_AXIS, GRID_ALPHA, GRID_LINESTYLE, apply_top_margin, HYBRID_2_MRE_Y_SCALE, HYBRID_2_MRE_Y_STEP
